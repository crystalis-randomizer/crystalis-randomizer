    ...
    write(loc, availableFlags) {
        ...
        for (let y = 0; y < this.height; y++) {
            ...
            for (let x = 0; x < this.width; x++) {
                ...
                if (spec.flag)
                    loc.flags.push(Flag.of({ screen: pos, flag: 0x2ef }));
                if (spec.wall) {
