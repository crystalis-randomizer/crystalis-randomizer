...
[50,105,94,"windmill guard","windmill key"],[51,64,198,"sabre north","key 2 prison"],[52,83,71,"zebu","key 2 styx"],[53,345,140,"fog lamp back","fog lamp"],[54,301,119,"dolphin","shell flute"],[55,233,118,"clark","eye glasses"],[56,234,88,"sabera 1","broken statue"],[57,295,92,"lighthouse","glowing lamp"],[59,274,117,"channel","love pendant"],[60,338,226,"kirisa meadow","kirisa plant"],[61,23,17,"karmine","ivory statue"],[62,206,241,"aryllis","bow of moon"],[63,101,6,"hydra summit","bow of sun"],
[64,207,110,"draygon","bow of truth"],[65,92,117,"windmill","refresh"],[66,279,126,"sabre summit","paralysis"],[67,202,138,"stom","telepathy"],[68,124,202,"tornel","teleport"],[69,304,128,"asina","recover"],[70,248,35,"whirlpool","barrier"],[71,277,3,"swan","change"],[72,15,25,"slime","flight"],[80,82,107,"sealed cave front"],[82,134,219,"sabre west"],[83,59,219,"sabre north"],[84,52,55,"mado 2 upper"],[85,241,97,"sabera fortress right"],[86,123,23,"hydra front"],[116,115,3,"hydra back"],[87,70,9,
"styx left"],[117,84,9,"styx left"],[88,32,38,"karmine basement"],[121,32,16,"karmine basement"],[122,40,16,"karmine basement"],[123,40,38,"karmine basement"],[90,161,97,"fortress exit"],[16,327,123,"waterfall cave"],[92,256,79,"evil spirit island"],[93,36,139,"sabera 2 level"],[94,14,229,"sabre north"],[95,345,225,"kirisa cave"],[96,18,94,"mado 2 upper"],[97,234,96,"vampire 2"],[98,18,118,"sabera 2 level"],[99,36,54,"mado 2 upper"],[100,175,97,"oasis cave"],[101,139,40,"hydra back"],[102,66,160,
"sabera 2 level"],[105,131,201,"sabre west"],[106,76,226,"sabre west"],[107,18,100,"mado 2 upper"],[108,193,103,"pyramid"],[120,199,103,"crypt"],[109,205,103,"crypt"],[115,256,67,"evil spirit island"],[110,24,38,"karmine basement"],[111,44,97,"mado 2 lower"]],KEY$$module$js$tracker=new Set([16,18,35,38,97]),BOSSES$$module$js$tracker=new Map([[-257,46],[-258,7],[-259,8],[-260,9],[-261,56],[-262,11],[-263,38],[-264,35],[-265,18],[-266,61],[-267,28],[-269,97]]),TRADES$$module$js$tracker=new Set([41,
62,68,71,72]);
class Graph$$module$js$tracker{constructor(a,b,c){this.rom=a;this.world=b;this.flags=c;this.slots=new Map;this.items=new Map;this.slotElts=new Map;this.has=Bits$$module$js$bits.of();this.tracks=new Map;this.marks=new Map;this.voice=!1;window.GRAPH=this;this.grid=document.getElementsByClassName("grid")[0];this.map=document.getElementsByClassName("map")[0];c=Bits$$module$js$bits.of();for(var d of b.graph.slots){const {item:a,index:b}=d;null!=a&&this.slots.set(a,b)}for(const e of b.graph.items){const {item:b,index:g}=
...
b,c,...d){const e=this.slots.get(a);if(null==e){debugger;throw Error();}const f=document.createElement("div");var g=this.rom.itemGets[a];if((g=g&&this.rom.items[g.itemId])&&g.unique||KEY$$module$js$tracker.has(a))f.classList.add("key"),b--,c--;b--;c--;f.dataset.index=String(e);f.style.left=b+"px";f.style.top=c+"px";b=document.createElement("div");f.appendChild(b);b.textContent=d[0];this.flags.randomizeTrades()&&TRADES$$module$js$tracker.has(a)&&f.classList.add("boss");this.slotElts.set(e,f);for(const b of d)a=
this.marks.get(b),null==a&&this.marks.set(b,a=[]),a.push(f);this.map.appendChild(f)}addItem(a,b,...c){b=Number.parseInt(b.substring(1),16);const d=document.getElementsByClassName(a)[0];var e=document.createElement("div");d.appendChild(e);e=this.items.get(b);null==e&&this.items.set(b,e=this.unusedItems++);d.dataset.index=String(e);d.dataset.item=String(e);this.tracks.set(a.replace(/-/g," "),d);for(const a of c)this.tracks.set(a.replace(/-/g," "),d)}addExtraFlags(){var a=this.world.graph;for(const b of a.slots.slice(a.fixed))if(a=
(a=BOSSES$$module$js$tracker.get(b.condition))&&this.slots.get(a),null!=a){a=this.slotElts.get(a);if(null==a)throw Error("expected");this.slotElts.delete(Number(a.dataset.index));this.slotElts.set(b.index,a);a.classList.add("boss");a.dataset.index=String(b.index);a.dataset.item=String(b.index)}}update(){for(var a of this.slotElts.values())a.dataset.state=a.classList.contains("got")?"":"blocked";for(const b of traverse$$module$js$graph$shuffle(this.world.graph,newFill$$module$js$graph$shuffle(),this.has))(a=
this.slotElts.get(b))&&!a.classList.contains("got")&&(a.dataset.state="available")}addVoiceRecognition(a){try{const b=this.recognition=new SpeechRecognition,c=new SpeechGrammarList;c.addFromString(`
          #JSGF V1.0;
          grammar command;
...
d.addExtraFlags();d.update();document.getElementById("toggle-map").addEventListener("click",()=>{d.map.classList.toggle("hidden")});document.getElementById("clear-all").addEventListener("click",()=>{for(const a of d.grid.querySelectorAll(".got"))a.classList.remove("got");d.has=d.always;d.update()});const e=document.getElementById("voice");e.addEventListener("click",()=>{d.voice?(d.stopVoice(),e.textContent="enable voice"):d.startVoice(()=>e.textContent="enable voice")?e.textContent="disable voice":
e.textContent="voice recognition failed"});window.graph=d})}main$$module$js$tracker();var module$js$tracker={};
}).call(this)
