...
const main = () => {
  ...
  const setSeed = (seed) => {
    ...
    document.getElementById('play').href=`https://shicks.github.io/jsnesx/#patch=crystalis-randomizer/${patch.BUILD_HASH}/patch&init=crystalis-randomizer/${patch.BUILD_HASH}/debug`;
  };
