...
e=32;for(;d;){const b=Math.clz32(d)+1;e-=b;d<<=b;32==b&&(d=0);a.push(c|e)}b>>=THIRTY_TWO$$module$bits_bigint;c+=32}return a},clone:(b)=>b,empty:(b)=>!b},BIGINT_OK$$module$bits_bigint="function"===typeof BigInt&&"bigint"===typeof BigInt(0),ZERO$$module$bits_bigint=BIGINT_OK$$module$bits_bigint&&BigInt(0),ONE$$module$bits_bigint=BIGINT_OK$$module$bits_bigint&&BigInt(1),MAX_UINT32$$module$bits_bigint=BIGINT_OK$$module$bits_bigint&&BigInt(4294967295),THIRTY_TWO$$module$bits_bigint=BIGINT_OK$$module$bits_bigint&&
BigInt(32);var module$bits_bigint={BIGINT_OK:BIGINT_OK$$module$bits_bigint};const Bits$$module$bits_array={of:(...b)=>{let a=[];for(const c of b)a[c>>>5]=(a[c>>>5]||0)|1<<c;return a},from:(b)=>{let a=[];for(const c of b)a[c>>>5]=(a[c>>>5]||0)|1<<c;return a},containsAll:(b,a)=>{for(let c=Math.max(b.length,a.length)-1;0<=c;c--)if((a[c]||0)&~(b[c]||0))return!1;return!0},with:(b,a)=>{b[a>>>5]=(b[a>>>5]||0)|1<<a;return b},without:(b,a)=>{b[a>>>5]=(b[a>>>5]||0)&~(1<<a);return b},has:(b,a)=>!!((b[a>>>5]||0)&1<<a),bits:(b)=>{const a=[];for(let c=0;c<b.length;c++){let d=b[c],e=32;
for(;d;){const b=Math.clz32(d)+1;e-=b;d<<=b;32==b&&(d=0);a.push(c<<5|e)}}return a},clone:(b)=>[...b],empty:(b)=>b.every((a)=>!a)};var module$bits_array={};const b$$module$bits=BIGINT_OK$$module$bits_bigint?module$bits_bigint.Bits:module$bits_array.Bits;class Bits$$module$bits{}Bits$$module$bits.of=b$$module$bits.of;Bits$$module$bits.from=b$$module$bits.from;Bits$$module$bits.containsAll=b$$module$bits.containsAll;Bits$$module$bits.with=b$$module$bits.with;Bits$$module$bits.without=b$$module$bits.without;Bits$$module$bits.has=b$$module$bits.has;Bits$$module$bits.bits=b$$module$bits.bits;Bits$$module$bits.clone=b$$module$bits.clone;
...
RNMX$$module$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$random={};module$random.Random=Random$$module$random;const STATUS$$module$version="unstable",VERSION$$module$version="assumed",LABEL$$module$version="assumed 8e84ede",HASH$$module$version="8e84ededb89b965037dcb0ad612bb821bfd2889a",DATE$$module$version=new Date(155118144E4);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c;a.seed||(a.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+a.seed);c=a.flags?new FlagSet$$module$flagset(a.flags):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$patch(b,parseSeed$$module$patch(a.seed),c)})}};
