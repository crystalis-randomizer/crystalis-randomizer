...
var module$js$flagset={};module$js$flagset.FlagSet=FlagSet$$module$js$flagset;const generate$$module$js$depgraph=(b)=>{const a=new WorldGraph$$module$js$nodes,c=(b,c)=>new Option$$module$js$nodes(a,b,void 0===c?!0:c),d=(b,c)=>new Item$$module$js$nodes(a,b,c,b,null),e=(b,c,...d)=>new Boss$$module$js$nodes(a,b,c,...d),f=(a,c)=>{if(!b)return c;(c=a.startsWith("!"))&&(a=a.substring(1));return b.check(a)^c},g=c("Leather Boots grant speed",f("Ts",!0)),h=c("Assume ghetto flight",f("Gf",!0)),k=c("Assume talk glitch",f("Gt",!0)),p=c("Assume rabbit skip",f("Gr",!1)),m=c("Sword magic optional",
f("Hw",!1)),q=c("Matching sword optional",f("Hs",!1)),n=c("Gas mask optional",f("Hg",!1)),u=c("Healed dolphin optional",f("!Rd",!0)),l=c("Calmed sea not required",f("!Rl",!1)),y=c("Sword of Thunder teleports to Shyron",f("Rt",!0)),z=c("Barrier magic optional",f("Hb",!0)),ja=c("Refresh magic optional",f("!Er",!0)),kb=c("Early flight route",f("Rf",!1)),Ba=c("Lime Tree connects to Leaf",f("Rp",!0)),Gd=c("Assume wild warp",f("Gw",!1)),Hd=c("Allow wild warp",f("!Tw",!1)),Id=c("Assume sword charge glitch",
f("Gs",!1));c("Tracker only",f("Dt",!1));const lb=new TrackerNode$$module$js$nodes(a,"Off-route"),Ca=new TrackerNode$$module$js$nodes(a,"Glitch"),G=new TrackerNode$$module$js$nodes(a,"Hard"),M=d(0,"Sword of Wind").weight(5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),S=d(1,"Sword of Fire").weight(5).fromPerson("Oak elder",29).dialog(29,null,3).key(),N=d(2,"Sword of Water").weight(10).chest().key(),K=d(3,"Sword of Thunder").weight(15).chest().key(),mb=d(4,"Crystalis").fixed(),
Ka=d(5,"Ball of Wind").chest().key(),Da=d(6,"Tornado Bracelet").chest().key(),La=d(7,"Ball of Fire").bossDrop("Insect",1).dialog(30,null,0).dialog(32,null,0).dialog(33,null,0).dialog(34,null,0).dialog(96,30,0).dialog(29,null,2).dialog(31,null,0).npcSpawn(193).key(),Ma=d(8,"Flame Bracelet").bossDrop("Kelbesque 1",2).npcSpawn(194).key(),Ea=d(9,"Ball of Water").weight(5).direct("Rage",250679).npcSpawn(195).key(),Na=d(10,"Blizzard Bracelet").weight(5).chest().key(),Oa=d(11,"Ball of Thunder").bossDrop("Mado 1",
5).trigger(154,1).key(),Pa=d(12,"Storm Bracelet").chest().key();d(13,"Carapace Shield");d(14,"Bronze Shield");d(15,"Platinum Shield");d(16,"Mirrored Shield");d(17,"Ceramic Shield");const Jd=d(18,"Sacred Shield").bossDrop("Mado 2",8).npcSpawn(199).bonus();d(19,"Battle Shield");const Kd=d(20,"Psycho Shield");d(21,"Tanned Hide");d(22,"Leather Armor");d(23,"Bronze Armor");d(24,"Platinmum Armor");d(25,"Soldier Suit");d(26,"Ceramic Suit");const Ld=d(27,"Battle Suit"),Md=d(28,"Psycho Armor").bossDrop("Draygon 1",
10).npcSpawn(203).trigger(159).npcSpawn(131).key(),X=d(29,"Medical Herb"),Qa=d(30,"Antidote"),nb=d(31,"Lysis Plant"),Nd=d(32,"Fruit of Lime"),Fa=d(33,"Fruit of Power"),Y=d(34,"Magic Ring"),Sb=d(35,"Fruit of Repun").bossDrop("Sabera 2",7).npcSpawn(198).key(),ob=d(36,"Warp Boots"),Tb=d(37,"Statue of Onyx").chest("Cordel grass").invisible(254882).key(),pb=d(38,"Opel Statue").bossDrop("Kelbesque 2",6).npcSpawn(197).key(),Ub=d(39,"Insect Flute").fromPerson("Oak mother",30).dialog(30,null,1).key(),Ra=d(40,
"Flute of Lime").fromPerson("Portoa queen",56).direct(39161).dialog(56,null,4).dialog(56,null,5,0).key(),Sa=d(41,"Gas Mask").direct("Akahana in Brynmaer",251902).npcSpawn(22,24).key(),Od=d(42,"Power Ring").chest().bonus(),Pd=d(43,"Warrior Ring").fromPerson("Akahana's friend",84).dialog(84,null,2).bonus(),Qd=d(44,"Iron Necklace").chest().bonus(),Rd=d(45,"Deo's Pendant").fromPerson("Deo",90).dialog(90,null,0).bonus(),Vb=d(46,"Rabbit Boots").bossDrop("Vampire 1",0).npcSpawn(192).key(),Wb=d(47,f("Ts",
!0)?"Speed Boots":"Leather Boots").chest().bonus(),Xb=d(48,"Shield Ring").direct("Akahana in waterfall cave",250543).npcSpawn(22,87,2).bonus(),qb=d(49,"Alarm Flute").fixed(),Yb=d(50,"Windmill Key").fromPerson("Windmill guard",20).dialog(20,14,0).npcSpawn(20,14,1).key(),Zb=d(51,"Key to Prison").chest().key(),$b=d(52,"Key to Styx").fromPerson("Zebu in Shyron",94,1).trigger(128,2).dialog(94,242,0).dialog(98,242,0).key(),ac=d(53,"Fog Lamp").chest().key(),rb=d(54,"Shell Flute").fromPerson("Dolphin",99,
1).npcSpawn(99).key(),bc=d(55,"Eye Glasses").fromPerson("Clark",68).dialog(68,233,1).key(),cc=d(56,"Broken Statue").bossDrop("Sabera 1",4).npcSpawn(127,101).npcSpawn(70).npcSpawn(71).npcSpawn(106).npcSpawn(132).npcSpawn(142).dialog(61).dialog(62).dialog(63).dialog(64).dialog(65).dialog(66).dialog(67).dialog(68,233).trigger(182).key(),dc=d(57,"Glowing Lamp").direct("Kensu in lighthouse",250638).npcSpawn(126,98,1).key(),ec=d(59,"Love Pendant").chest("Underground channel").invisible(254890).key(),fc=
d(60,"Kirisa Plant").chest("Kirisa meadow").invisible(254886).key(),sb=d(61,"Ivory Statue").bossDrop("Karmine",9).npcSpawn(200).key(),gc=d(62,"Bow of Moon").fromPerson("Aryllis",35).direct(251624).dialog(35,null,1).key(),hc=d(63,"Bow of Sun").chest().key(),ic=d(64,"Bow of Truth").fromPerson("Azteca",131).npcSpawn(131,156,1).dialog(131,null,0).key(),tb=(new Magic$$module$js$nodes(a,65,"Refresh",65,null)).fromPerson("Zebu at windmill",94).direct(251665).dialog(94,16,3).trigger(180,1),Ta=(new Magic$$module$js$nodes(a,
66,"Paralysis",66,null)).direct("Zebu at Mt. Sabre summit",251477).trigger(141).trigger(178),Z=(new Magic$$module$js$nodes(a,67,"Telepathy",67,null)).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),jc=(new Magic$$module$js$nodes(a,68,"Teleport",68,null)).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),Sd=(new Magic$$module$js$nodes(a,69,"Recover",69,null)).direct("Asina in Portoa",250361),kc=(new Magic$$module$js$nodes(a,70,"Barrier",70,null)).direct("Asina on Angry sea",
251609).trigger(132,0),pa=(new Magic$$module$js$nodes(a,71,"Change",71,null)).direct("Kensu in Swan",251614).npcSpawn(116,241,1),D=(new Magic$$module$js$nodes(a,72,"Flight",72,null)).weight(15).direct("Kensu in Draygonia Fortress",250255),ub=d(40,"Flute of Lime").chest(void 0,91).key(),Td=Fa.bossDrop("Vampire 2",12,97).npcSpawn(204).key(),H=d(112,"Mimic"),lc=(new Trigger$$module$js$nodes(a,"Talked to Leaf Elder")).get(M),mc=new Trigger$$module$js$nodes(a,"Talked to Leaf Student"),nc=(new Trigger$$module$js$nodes(a,
"Buy alarm flute")).get(qb),vb=new Trigger$$module$js$nodes(a,"Talked to Zebu in cave"),Ud=(new Trigger$$module$js$nodes(a,"Woke up Windmill Guard")).get(Yb),Ua=new Trigger$$module$js$nodes(a,"Started Windmill"),oc=(new Trigger$$module$js$nodes(a,"Learned Refresh")).get(tb),Vd=(new Trigger$$module$js$nodes(a,"Gave Statue to Akahana")).get(Sa),Wd=(new Trigger$$module$js$nodes(a,"Fought Stom")).get(Z),pc=new Trigger$$module$js$nodes(a,"Visited Oak"),qc=new Trigger$$module$js$nodes(a,"Talked to Oak Mother"),
wb=new Trigger$$module$js$nodes(a,"Rescued Oak Child"),Xd=(new Trigger$$module$js$nodes(a,"Talked to Oak Mother Again")).get(Ub),Yd=(new Trigger$$module$js$nodes(a,"Talked to Oak Elder")).get(S),Zd=(new Trigger$$module$js$nodes(a,"Talked to Tornel on Mt Sabre")).get(jc),rc=new Trigger$$module$js$nodes(a,"Villagers Abducted"),sc=new Trigger$$module$js$nodes(a,"Talked to Rabbit in Leaf"),$d=(new Trigger$$module$js$nodes(a,"Learned Paralysis")).get(Ta),tc=new Trigger$$module$js$nodes(a,"Talked to Portoa Queen"),
uc=new Trigger$$module$js$nodes(a,"Talked to Fortune Teller"),vc=new Trigger$$module$js$nodes(a,"Visited Underground Channel"),ae=(new Trigger$$module$js$nodes(a,"Sent to Waterfall Cave")).get(Ra),be=(new Trigger$$module$js$nodes(a,"Cured Akahana")).get(Xb),wc=(new Trigger$$module$js$nodes(a,"Talked to Rage")).get(Ea),xc=new Trigger$$module$js$nodes(a,"Mesia recording played"),ce=(new Trigger$$module$js$nodes(a,"Talked to Asina")).get(Sd),yc=(new Trigger$$module$js$nodes(a,"Healed Dolphin")).get(rb),
xb=new Trigger$$module$js$nodes(a,"Returned Fog Lamp"),zc=new Trigger$$module$js$nodes(a,"Talked to Kensu in Cabin"),Ac=new Trigger$$module$js$nodes(a,"Talked to Joel Elder"),de=(new Trigger$$module$js$nodes(a,"Talked to Clark")).get(bc),ee=(new Trigger$$module$js$nodes(a,"Talked to Kensu in Lighthouse")).get(dc),yb=new Trigger$$module$js$nodes(a,"Calmed the Angry Sea"),fe=(new Trigger$$module$js$nodes(a,"Learned Barrier")).get(kc),Bc=new Trigger$$module$js$nodes(a,"Talked to Stom in Swan Hut"),Cc=
new Trigger$$module$js$nodes(a,"Talked to Kensu in Swan tavern"),Dc=new Trigger$$module$js$nodes(a,"Talked to Kensu at Swan dance"),ge=(new Trigger$$module$js$nodes(a,"Returned Kensu's love pendant")).get(pa),he=(new Trigger$$module$js$nodes(a,"Talked to Amazones Queen")).get(gc),zb=new Trigger$$module$js$nodes(a,"Entered Shyron"),ie=(new Trigger$$module$js$nodes(a,"Talked to Zebu in Shyron")).get($b),Ec=new Trigger$$module$js$nodes(a,"Shyron Massacre"),je=(new Trigger$$module$js$nodes(a,"Saved Kensu")).get(D),
ke=(new Trigger$$module$js$nodes(a,"Talked to Deo")).get(Rd),le=(new Trigger$$module$js$nodes(a,"Talked to Akahana's Friend")).get(Pd),me=(new Trigger$$module$js$nodes(a,"Get Bow of Truth")).get(ic),ne=(new Trigger$$module$js$nodes(a,"Forged Crystalis")).get(mb),oe=new Trigger$$module$js$nodes(a,"Win"),Va=(new Condition$$module$js$nodes(a,"Early flight")).option(kb).option(lb),Wa=(new Condition$$module$js$nodes(a,"Sword charge glitch")).option(Id).option(Ca),pe=(new Condition$$module$js$nodes(a,"Rabbit skip")).option(p).option(Ca),
Ab=(new Condition$$module$js$nodes(a,"Talk glitch")).option(k).option(Ca),qe=(new Condition$$module$js$nodes(a,"Ghetto flight")).option(h).option(Ca),re=(new Condition$$module$js$nodes(a,"Wild warp")).option(Gd).option(Ca,Hd),Xa=(new Condition$$module$js$nodes(a,"Any level 2 sword")).option(M,Ka).option(M,Da).option(S,La).option(S,Ma).option(N,Ea).option(N,Na).option(K,Oa).option(K,Pa),v=(new Condition$$module$js$nodes(a,"Destroy stone")).option(M,Ka).option(M,Da).option(Wa,M,Xa),w=(new Condition$$module$js$nodes(a,
"Destroy ice")).option(S,La).option(S,Ma).option(Wa,S,Xa),r=(new Condition$$module$js$nodes(a,"Cross rivers")).option(N,Ea).option(N,Na).option(D,Va).option(Wa,N,Xa),qa=(new Condition$$module$js$nodes(a,"Destroy iron")).option(K,Oa).option(K,Pa).option(Wa,K,Xa),I=(new Condition$$module$js$nodes(a,"Any sword")).option(M).option(S).option(N).option(K),se=(new Condition$$module$js$nodes(a,"Match insect sword (fire/water/thunder)")).option(S).option(N).option(K).option(Sa,q,M).option(Sa,G,M),te=(new Condition$$module$js$nodes(a,
"Speed boots")).option(Wb,g),Fc=(new Condition$$module$js$nodes(a,"Climb slopes")).option(Vb).option(D,Va).option(te),ue=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North")).option(sc).option(pe),Gc=(new Condition$$module$js$nodes(a,"Asina in her room")).option(xc),ve=(new Condition$$module$js$nodes(a,"Paralysis or Ball of Water")).option(Ta).option(Gc).option(Ab),we=(new Condition$$module$js$nodes(a,"Ride dolphin")).option(rb,zc),T=(new Condition$$module$js$nodes(a,"Cross sea")).option(we).option(D,
Va),xe=(new Condition$$module$js$nodes(a,"Cross whirlpool")).option(yb).option(D,Va).option(qe),U=(new Condition$$module$js$nodes(a,"Refresh if needed")).option(G).option(ja).option(tb),Hc=(new Condition$$module$js$nodes(a,"Wind magic")).option(G).option(m,U).option(Ka,Da,U),Ic=(new Condition$$module$js$nodes(a,"Fire magic")).option(G).option(m,U).option(La,Ma,U),Jc=(new Condition$$module$js$nodes(a,"Water magic")).option(G).option(m,U).option(Ea,Na,U),ye=(new Condition$$module$js$nodes(a,"Thunder magic")).option(G).option(m,
U).option(Oa,U).option(Pa,U),ze=(new Condition$$module$js$nodes(a,"Flute of lime or glitch")).option(Ra).option(Ab).option(lb,ub),Ae=(new Condition$$module$js$nodes(a,"Second flute of lime")).option(ub).option(lb,Ra),Kc=(new Condition$$module$js$nodes(a,"Change or glitch")).option(pa).option(Ab),Bb=(new Condition$$module$js$nodes(a,"Pass shooting statues")).option(kc).option(tb,Xb).option(G).option(z),Be=(new Condition$$module$js$nodes(a,"Healed dolphin if required")).option(yc).option(u),Lc=(new Condition$$module$js$nodes(a,
"Match sword of wind")).option(M).option(G,I).option(q,I),Mc=(new Condition$$module$js$nodes(a,"Match sword of fire")).option(S).option(G,I).option(q,I),Nc=(new Condition$$module$js$nodes(a,"Match sword of water")).option(N).option(G,I).option(q,I),Ce=(new Condition$$module$js$nodes(a,"Match sword of thunder")).option(K).option(G,I).option(q,I),Ya=(new Condition$$module$js$nodes(a,"Travel swamp")).option(Sa).option(n).option(G),De=(new Condition$$module$js$nodes(a,"Calmed sea if required")).option(yb).option(l),
Ee=e(0,"Vampire 1",I).get(Vb),Fe=e(1,"Insect",Ub,se).get(La),Ge=e(2,"Kelbesque 1",Lc,Hc).get(Ma),He=e(12,"Vampire 2",I).get(Td),Oc=e(4,"Sabera 1",Mc,Ic).get(cc),Ie=e(5,"Mado 1",Nc,Jc).get(Oa),Je=e(6,"Kelbesque 2",Lc,Hc).get(pb),Ke=e(7,"Sabera 2",Mc,Ic).get(Sb),Le=e(8,"Mado 2",Nc,Jc).get(Jd),Me=e(9,"Karmine",Ce,ye).get(sb),Ne=e(10,"Draygon 1",I).get(Md),Oe=e(null,"Statues",hc,gc),Pe=e(11,"Draygon 2",I,ic),Qe=e(13,"Dyna",mb),O=new Area$$module$js$nodes(a,"Leaf"),ra=new Area$$module$js$nodes(a,"Valley of Wind"),
L=new Area$$module$js$nodes(a,"Sealed Cave"),ka=new Area$$module$js$nodes(a,"Cordel Plain"),sa=new Area$$module$js$nodes(a,"Brynmaer"),ta=new Area$$module$js$nodes(a,"Amazones"),B=new Area$$module$js$nodes(a,"Mt Sabre West"),t=new Area$$module$js$nodes(a,"Mt Sabre North"),Za=new Area$$module$js$nodes(a,"Nadare's"),Ga=new Area$$module$js$nodes(a,"Oak"),aa=new Area$$module$js$nodes(a,"Waterfall Valley"),A=new Area$$module$js$nodes(a,"Portoa"),ba=new Area$$module$js$nodes(a,"Waterfall Cave"),C=new Area$$module$js$nodes(a,
"Fog Lamp Cave"),ca=new Area$$module$js$nodes(a,"Kirisa Plant Cave"),la=new Area$$module$js$nodes(a,"Angry Sea"),da=new Area$$module$js$nodes(a,"Joel"),F=new Area$$module$js$nodes(a,"Evil Spirit Island"),ea=new Area$$module$js$nodes(a,"Sabera's Castle"),P=new Area$$module$js$nodes(a,"Swan"),x=new Area$$module$js$nodes(a,"Mt Hydra"),fa=new Area$$module$js$nodes(a,"Shyron"),ma=new Area$$module$js$nodes(a,"Styx"),na=new Area$$module$js$nodes(a,"Goa"),$a=new Area$$module$js$nodes(a,"Draygonia Fortress 1"),
Q=new Area$$module$js$nodes(a,"Draygonia Fortress 2"),ua=new Area$$module$js$nodes(a,"Draygonia Fortress 3"),J=new Area$$module$js$nodes(a,"Draygonia Fortress 4"),E=new Area$$module$js$nodes(a,"Oasis Cave");new Area$$module$js$nodes(a,"Desert");const R=new Area$$module$js$nodes(a,"Sahara"),va=new Area$$module$js$nodes(a,"Pyramid Front"),V=new Area$$module$js$nodes(a,"Pyramid Back"),ha=new Area$$module$js$nodes(a,"Tower"),Cb=(new Location$$module$js$nodes(a,0,O,"Start")).overworld().start(),Re=(new Location$$module$js$nodes(a,
0,O,"Mezame Shrine")).overworld().from(Cb),Se=(new Location$$module$js$nodes(a,1,O,"Outside Start")).overworld().connect(Re),ia=(new Location$$module$js$nodes(a,2,O,"Town")).town().connect(Se),Ha=(new Location$$module$js$nodes(a,3,ra,"Main")).overworld().connect(ia).trigger(oc,Ua),Pc=(new Location$$module$js$nodes(a,3,ra,"Outside Windmill")).overworld(),Qc=(new Location$$module$js$nodes(a,4,L,"Tunnel 1 (entrance)")).cave().from(Ha,Ua),Te=(new Location$$module$js$nodes(a,5,L,"Tunnel 2 (over bridge)")).cave().connect(Qc),
Ue=(new Location$$module$js$nodes(a,6,L,"Tunnel 6 (herb dead end)")).cave().chest(X,15),Rc=(new Location$$module$js$nodes(a,7,L,"Tunnel 4a (ball corridor)")).cave().chest(X,20,80).chest(Ka,21);(new Location$$module$js$nodes(a,7,L,"Tunnel 4b (antidote dead end)")).cave().connect(Rc,v).chest(Qa,19);const Ve=(new Location$$module$js$nodes(a,8,L,"Tunnel 5 (warp boots dead end)")).cave().chest(ob,14),We=(new Location$$module$js$nodes(a,9,L,"Tunnel 3a (branch, front)")).cave().connect(Te).connectTo(Rc).connectTo(Ve),
Xe=(new Location$$module$js$nodes(a,9,L,"Tunnel 3b (branch, back)")).cave().connect(We,v).connectTo(Ue),Ye=(new Location$$module$js$nodes(a,10,L,"Tunnel 7 (boss)")).cave().connect(Xe).boss(Ee),Ze=(new Location$$module$js$nodes(a,12,L,"Tunnel 8a (exit, above wall)")).cave().connect(Ye),$e=(new Location$$module$js$nodes(a,12,L,"Tunnel 8b (exit, below wall")).cave().connect(Ze,v);(new Location$$module$js$nodes(a,14,ra,"Windmill Cave")).cave().connect(Ha).connectTo(Pc).trigger(Ud,qb,vb);(new Location$$module$js$nodes(a,
15,ra,"Windmill")).misc().connect(Pc).trigger(Ua,Yb);const af=(new Location$$module$js$nodes(a,16,ra,"Zebu's Cave Front")).cave().connect(Ha).trigger(vb,lc,mc).trigger(oc,Ua,vb),bf=(new Location$$module$js$nodes(a,16,ra,"Zebu's Cave Back")).cave().trigger(rc).connect(af,w),cf=(new Location$$module$js$nodes(a,17,B,"Tunnel 1 (to Zebu)")).cave().connect(bf),wa=(new Location$$module$js$nodes(a,20,ka,"West")).overworld().connect($e),df=(new Location$$module$js$nodes(a,20,ka,"South")).overworld().connect(wa,
r),Sc=(new Location$$module$js$nodes(a,21,ka,"East")).overworld().connect(wa).chest(Tb,24),Ia=(new Location$$module$js$nodes(a,24,sa,"Town")).town().connect(wa).trigger(Vd,Tb),ef=(new Location$$module$js$nodes(a,25,ka,"Outside Stom's House")).town().connect(wa),Db=(new Location$$module$js$nodes(a,26,ka,"Swamp")).overworld().connect(Sc,Ya).trigger(wb,qc,Ya);(new Location$$module$js$nodes(a,26,ka,"Swamp Insect Area")).overworld().connect(Db,Ya).boss(Fe);const ab=(new Location$$module$js$nodes(a,27,
ta,"Town")).town().connect(df),bb=(new Location$$module$js$nodes(a,28,Ga,"Town")).town().connect(Db,Ya).trigger(pc);(new Location$$module$js$nodes(a,30,ka,"Stom's House")).house().connect(ef).trigger(Wd,pc);const xa=(new Location$$module$js$nodes(a,32,B,"Entrance")).overworld().connect(wa).connect(cf),ff=(new Location$$module$js$nodes(a,32,B,"Up Slope")).overworld().from(xa,Fc).to(xa),gf=(new Location$$module$js$nodes(a,32,B,"Dead End (warp boots)")).overworld().chest(ob,24,106),Tc=(new Location$$module$js$nodes(a,
33,B,"Upper")).overworld().from(xa,D).to(xa),hf=(new Location$$module$js$nodes(a,33,B,"Tornel Dead End")).overworld().trigger(Zd,Da).chest(Y,23,105),Uc=(new Location$$module$js$nodes(a,34,B,"Tunnel 2a (fork at start)")).cave().connect(xa);(new Location$$module$js$nodes(a,34,B,"Tunnel 2b (left branch to dead end)")).cave().connect(Uc,w).connectTo(gf);const jf=(new Location$$module$js$nodes(a,34,B,"Tunnel 2c (right branch to upper)")).cave().connect(Uc,w),kf=(new Location$$module$js$nodes(a,35,B,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(jf).chest(X,
23,82),lf=(new Location$$module$js$nodes(a,35,B,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(kf,w).connectTo(Tc),Vc=(new Location$$module$js$nodes(a,36,B,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(lf);(new Location$$module$js$nodes(a,36,B,"Tunnel 4b (out to upper)")).cave().connect(Vc,w).connectTo(Tc);const mf=(new Location$$module$js$nodes(a,37,B,"Tunnel 5 (tiny connector)")).cave().connect(Vc),nf=(new Location$$module$js$nodes(a,38,B,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(mf);
(new Location$$module$js$nodes(a,38,B,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(nf,w).connectTo(hf);const of=(new Location$$module$js$nodes(a,39,B,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(ff),pf=(new Location$$module$js$nodes(a,39,B,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(of,w);(new Location$$module$js$nodes(a,39,B,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(pf,w).chest(Da,25);const cb=(new Location$$module$js$nodes(a,40,t,"Entrance")).overworld().connect(Sc,
jc,ue),db=(new Location$$module$js$nodes(a,40,t,"Upper")).overworld().from(cb,D).to(cb),Eb=(new Location$$module$js$nodes(a,40,t,"Summit (boss)")).overworld().from(db,D).to(db).boss(Ge),Wc=(new Location$$module$js$nodes(a,41,t,"Connector")).overworld(),Fb=(new Location$$module$js$nodes(a,41,t,"Middle Left")).overworld(),qf=(new Location$$module$js$nodes(a,41,t,"Middle Right")).overworld().from(Fb,Fc).to(Fb),Xc=(new Location$$module$js$nodes(a,42,t,"Tunnel 2a (from entrance to connector)")).cave().connectTo(Wc);
(new Location$$module$js$nodes(a,42,t,"Tunnel 2b (under bridge, to antidote)")).cave().connect(Xc,w).chest(Qa,23,94);const Yc=(new Location$$module$js$nodes(a,43,t,"Tunnel 3a (branch after connector)")).cave().connect(Wc),rf=(new Location$$module$js$nodes(a,43,t,"Tunnel 3b (right branch)")).cave().connect(Yc,w),sf=(new Location$$module$js$nodes(a,43,t,"Tunnel 3c (upper branch)")).cave().connect(Yc,w);(new Location$$module$js$nodes(a,44,t,"Tunnel 4 (over bridge, to middle)")).cave().connect(sf).connectTo(Fb);
const Zc=(new Location$$module$js$nodes(a,45,t,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(rf).connectTo(qf);(new Location$$module$js$nodes(a,45,t,"Tunnel 5b (dead-end with herb)")).cave().connect(Zc,w).chest(X,22,83);const tf=(new Location$$module$js$nodes(a,46,t,"Tunne; 6a (S-shaped hall, right)")).cave().connect(Zc),uf=(new Location$$module$js$nodes(a,46,t,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(tf,w),vf=(new Location$$module$js$nodes(a,46,t,"Tunnel 6c (S-shaped hall, left)")).cave().connect(uf,
w),$c=(new Location$$module$js$nodes(a,47,t,"Prison (hallway)")).cave().connect(db),wf=(new Location$$module$js$nodes(a,48,t,"Left Cell (shopkeepers)")).cave().from($c,w);(new Location$$module$js$nodes(a,49,t,"Left Cell 2 (back, with prison key)")).cave().from(wf,w).chest(Zb,13);const xf=(new Location$$module$js$nodes(a,50,t,"Right Cell (villagers)")).cave().from($c,w),yf=(new Location$$module$js$nodes(a,51,t,"Tunnel 8 (behind right cell, toward summit)")).cave().from(xf,w);(new Location$$module$js$nodes(a,
52,t,"Tunnel 9 (connector to summit)")).cave().connect(yf).connectTo(Eb);const zf=(new Location$$module$js$nodes(a,53,t,"Tunnel 10a (summit cave, front)")).cave().from(Eb,Zb).to(Eb),Af=(new Location$$module$js$nodes(a,53,t,"Tunnel 10b (summit cave, behind ice)")).cave().connect(zf,w).trigger($d);(new Location$$module$js$nodes(a,56,t,"Tunnel 1 (leads from main entrance)")).cave().connect(cb).connectTo(Xc);(new Location$$module$js$nodes(a,57,t,"Tunnel 7 (to upper)")).cave().connect(vf).connectTo(db);
const Bf=(new Location$$module$js$nodes(a,60,Za,"Inn")).town(),Cf=(new Location$$module$js$nodes(a,61,Za,"Tool Shop")).house(),Df=(new Location$$module$js$nodes(a,62,Za,"Back Room")).house(),Gb=(new Location$$module$js$nodes(a,64,aa,"Summit")).overworld().connect(Af),eb=(new Location$$module$js$nodes(a,64,aa,"Northwest")).overworld().from(Gb).to(Gb,D),Ef=(new Location$$module$js$nodes(a,64,aa,"Northeast")).overworld().connect(eb,r),ad=(new Location$$module$js$nodes(a,65,aa,"Southwest")).overworld().connect(eb),
Ff=(new Location$$module$js$nodes(a,65,aa,"Southeast")).overworld().connect(ad,r),bd=(new Location$$module$js$nodes(a,66,aa,"Lime Tree Valley")).overworld().connect(ad).connect(Ha,Ba),Gf=(new Location$$module$js$nodes(a,67,aa,"Lime Tree Lake (Rage)")).cave().connect(bd).trigger(wc,N),Hf=(new Location$$module$js$nodes(a,68,ca,"Tunnel 1a (entrance)")).cave().connect(Ff),If=(new Location$$module$js$nodes(a,68,ca,"Tunnel 1b (behind wall)")).cave().connect(Hf,v),cd=(new Location$$module$js$nodes(a,69,
ca,"Tunnel 2a (main path, before wall)")).cave().connect(If);(new Location$$module$js$nodes(a,69,ca,"Tunnel 2b (dead end, antidote)")).cave().connect(cd,v).chest(Qa,25,95);const Jf=(new Location$$module$js$nodes(a,69,ca,"Tunnel 2c (main path, after wall)")).cave().connect(cd,v),Kf=(new Location$$module$js$nodes(a,70,ca,"Tunnel 3a (last room, before wall)")).cave().connect(Jf),Lf=(new Location$$module$js$nodes(a,70,ca,"Tunnel 3b (last room, after wall)")).cave().connect(Kf,v);(new Location$$module$js$nodes(a,
71,ca,"Meadow")).overworld().connect(Lf).chest(fc,14);const Mf=(new Location$$module$js$nodes(a,72,C,"Tunnel 1a (entrance)")).cave().connect(Ef),dd=(new Location$$module$js$nodes(a,72,C,"Tunnel 1b (past wall)")).cave().connect(Mf,v);(new Location$$module$js$nodes(a,72,C,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(dd,v).chest(nb,24);const Nf=(new Location$$module$js$nodes(a,73,C,"Tunnel 2 (tiny connector)")).cave().connect(dd),ed=(new Location$$module$js$nodes(a,74,C,"Tunnel 3a (upper branch)")).cave().connect(Nf);
(new Location$$module$js$nodes(a,74,C,"Tunnel 3b (dead end, mimic)")).cave().connect(ed,v).chest(H,21);const fd=(new Location$$module$js$nodes(a,74,C,"Tunnel 3c (short passage with mimic)")).cave().connect(ed,v).chest(H,22),Of=(new Location$$module$js$nodes(a,74,C,"Tunnel 3d (lower branch)")).cave().connect(fd,v);(new Location$$module$js$nodes(a,75,C,"Tunnel 4 (dead end loop)")).cave().connect(Of);const gd=(new Location$$module$js$nodes(a,76,C,"Tunnel 5a (right branch over bridge)")).cave().connect(fd),
Pf=(new Location$$module$js$nodes(a,76,C,"Tunnel 5b (past wall over bridge)")).cave().connect(gd,v),Qf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6a (from left branch)")).cave().connect(gd),Rf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6b (reconvergence)")).cave().connect(Qf,v).connect(Pf),Sf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6c (between walls)")).cave().connect(Rf,v),Tf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6d (under bridge)")).cave().connect(Sf,v),Uf=(new Location$$module$js$nodes(a,
78,C,"Tunnel 7a (over second bridge)")).cave().connect(Tf),Vf=(new Location$$module$js$nodes(a,78,C,"Tunnel 7b (past wall)")).cave().connect(Uf,v),Wf=(new Location$$module$js$nodes(a,79,C,"Tunnel 8a (under second bridge)")).cave().connect(Vf);(new Location$$module$js$nodes(a,79,C,"Tunnel 8b (fog lamp)")).cave().connect(Wf,v).chest(ac,19);const oa=(new Location$$module$js$nodes(a,80,A,"Town")).town().connect(eb),hd=(new Location$$module$js$nodes(a,81,A,"Fishherman Island")).town().connect(oa);(new Location$$module$js$nodes(a,
82,aa,"Mesia Shrine")).cave().trigger(xc).connect(Gf,r,wc);const id=(new Location$$module$js$nodes(a,84,ba,"Tunnel 1a (entrance)")).cave().connect(eb);(new Location$$module$js$nodes(a,84,ba,"Tunnel 1b (dead end, mimic)")).cave().connect(id,w).chest(H,19);const Xf=(new Location$$module$js$nodes(a,84,ba,"Tunnel 1c (past ice)")).cave().connect(id,w),jd=(new Location$$module$js$nodes(a,85,ba,"Tunnel 2 (stoned pair)")).cave().connect(Xf),Hb=(new Location$$module$js$nodes(a,86,ba,"Tunnel 3 (wide medusa hallways)")).cave().from(jd,
ze).to(jd,Ra),Yf=(new Location$$module$js$nodes(a,87,ba,"Tunnel 4a (left entrance)")).cave().from(Hb,w).chest(ub,25).trigger(be,Ae);(new Location$$module$js$nodes(a,87,ba,"Tunnel 4b (right entrance)")).cave().from(Hb,w).connect(Yf,D);(new Location$$module$js$nodes(a,87,ba,"Tunnel 4c (sword of water)")).cave().connect(Hb,w).chest(N,24);const kd=(new Location$$module$js$nodes(a,88,ha,"Entrance")).misc(),Zf=(new Location$$module$js$nodes(a,89,ha,"Level 1")).misc().from(kd),$f=(new Location$$module$js$nodes(a,
90,ha,"Level 2")).misc().from(Zf),ag=(new Location$$module$js$nodes(a,91,ha,"Level 3")).misc().from($f),ld=(new Location$$module$js$nodes(a,92,ha,"Outside Mesia Room")).misc().from(ag),bg=(new Location$$module$js$nodes(a,93,ha,"Outside Dyna Room")).misc().from(ld,mb);(new Location$$module$js$nodes(a,94,ha,"Mesia")).misc().connect(ld).trigger(ne);(new Location$$module$js$nodes(a,95,ha,"Dyna")).misc().from(bg).boss(Qe).trigger(oe);const Ib=(new Location$$module$js$nodes(a,96,la,"Cabin Beach")).sea().from(hd,
xb),ya=(new Location$$module$js$nodes(a,96,la,"South")).sea().connect(Ib,T),cg=(new Location$$module$js$nodes(a,96,la,"Joel Beach")).sea().connect(ya,T),md=(new Location$$module$js$nodes(a,96,da,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(a,96,la,"Altar")).sea().connect(ya,T).trigger(yb,dc,cc);const dg=(new Location$$module$js$nodes(a,96,la,"North")).sea().to(ya,T).from(ya,T,xe).trigger(fe,De),eg=(new Location$$module$js$nodes(a,96,la,"Swan Beach")).sea().connect(dg,T);(new Location$$module$js$nodes(a,
97,la,"Cabin")).misc().connect(Ib).trigger(zc,xb);(new Location$$module$js$nodes(a,98,da,"Lighthouse")).misc().connect(md).trigger(ee,qb);const fb=(new Location$$module$js$nodes(a,100,A,"Underground Channel 1 (from throne room)")).sea().trigger(vc),fg=(new Location$$module$js$nodes(a,100,A,"Underground Channel 2 (to fortune teller)")).sea().connect(fb,r),nd=(new Location$$module$js$nodes(a,100,A,"Underground Channel 3 (from fortune teller)")).sea().connect(fb,D),od=(new Location$$module$js$nodes(a,
100,A,"Underground Channel 4 (asina)")).sea().connect(nd,r),gg=(new Location$$module$js$nodes(a,100,A,"Underground Channel 5 (dolphin)")).sea().connect(od,r).trigger(yc,X,Ea);(new Location$$module$js$nodes(a,100,A,"Underground Channel 6 (water)")).sea().connect(gg,T).connectTo(ya,T).chest(ec,17);const Jb=(new Location$$module$js$nodes(a,101,F,"Zombie Town")).town(),hg=(new Location$$module$js$nodes(a,104,F,"Tunnel 1 (entrance)")).sea().connect(ya,Ac,T),pd=(new Location$$module$js$nodes(a,105,F,"Tunnel 2a (start)")).cave().connect(hg);
(new Location$$module$js$nodes(a,105,F,"Tunnel 2b (dead end to left)")).cave().connect(pd,r);const ig=(new Location$$module$js$nodes(a,105,F,"Tunnel 2c (across first river)")).cave().connect(pd,r),qd=(new Location$$module$js$nodes(a,105,F,"Tunnel 2d (across second river)")).cave().connect(ig,r);(new Location$$module$js$nodes(a,105,F,"Tunnel 2e (dead end, magic ring)")).cave().connect(qd,v).chest(Y,29);const jg=(new Location$$module$js$nodes(a,105,F,"Tunnel 2f (stair down)")).cave().connect(qd,v),
kg=(new Location$$module$js$nodes(a,106,F,"Tunnel 3a (main area)")).cave().connect(jg).connectTo(Jb).chest(nb,25,92),lg=(new Location$$module$js$nodes(a,106,F,"Tunnel 3b (left area toward items)")).cave().connect(kg,v),mg=(new Location$$module$js$nodes(a,107,F,"Tunnel 4a (right side, mimic)")).cave().connect(lg).chest(H,14);(new Location$$module$js$nodes(a,107,F,"Tunnel 4b (left side, iron necklace)")).cave().connect(mg,r).chest(Qd,15);const Kb=(new Location$$module$js$nodes(a,108,ea,"Floor 1")).fortress().connect(Jb),
ng=(new Location$$module$js$nodes(a,108,ea,"Miniboss")).fortress().boss(He).connect(Kb);(new Location$$module$js$nodes(a,109,ea,"Floor 2a (left stair)")).fortress().connect(Kb).chest(Fa,19);const og=(new Location$$module$js$nodes(a,109,ea,"Floor 2b (right stair)")).fortress().connect(ng).chest(X,30,85),pg=(new Location$$module$js$nodes(a,110,ea,"Floor 3a (toward boss)")).fortress().connect(og),rd=(new Location$$module$js$nodes(a,110,ea,"Floor 3b (boss room)")).fortress().connect(pg);(new Location$$module$js$nodes(a,
110,ea,"Boss")).fortress().boss(Oc).connect(rd);(new Location$$module$js$nodes(a,110,ea,"Floor 3c (back room trap)")).fortress().from(rd).to(Kb);const qg=(new Location$$module$js$nodes(a,112,da,"Secret Passage")).cave().connectTo(md),gb=(new Location$$module$js$nodes(a,113,da,"Town")).town().connect(cg),W=(new Location$$module$js$nodes(a,114,P,"Town")).town().connect(eg),rg=(new Location$$module$js$nodes(a,115,P,"Inside Gate")).overworld().connect(W),sg=(new Location$$module$js$nodes(a,115,P,"Outside Gate")).overworld().from(rg,
pa),hb=(new Location$$module$js$nodes(a,120,na,"Valley")).overworld().connect(sg),Lb=(new Location$$module$js$nodes(a,124,x,"Entrance")).overworld().connect(hb),tg=(new Location$$module$js$nodes(a,124,x,"Over first river toward Shyron")).overworld().connect(Lb,r),sd=(new Location$$module$js$nodes(a,124,x,"After first tunnel")).overworld(),td=(new Location$$module$js$nodes(a,124,x,"Door to Styx")).overworld().connect(sd,r),ug=(new Location$$module$js$nodes(a,124,x,"Dead end (no item)")).overworld(),
vg=(new Location$$module$js$nodes(a,124,x,"Dead end (fruit of lime)")).overworld().chest(Nd,26),wg=(new Location$$module$js$nodes(a,124,x,"Dead end (magic ring)")).overworld().chest(Y,25,101),ud=(new Location$$module$js$nodes(a,124,x,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(a,124,x,"Floating island (bow of sun)")).overworld().connect(ud,D).chest(hc,24);const xg=(new Location$$module$js$nodes(a,125,x,"Tunnel 1 (to Shyron)")).cave().connect(tg),yg=(new Location$$module$js$nodes(a,
126,x,"Outside Shyron")).overworld().connect(xg);(new Location$$module$js$nodes(a,127,x,"Tunnel 2 (fork)")).cave().connect(Lb).connectTo(vg).connectTo(sd);const vd=(new Location$$module$js$nodes(a,128,x,"Tunnel 3 (caves)")).cave().connect(td).connect(ug),wd=(new Location$$module$js$nodes(a,129,x,"Tunnel 4 (left branch of cave)")).cave().connect(vd);(new Location$$module$js$nodes(a,130,x,"Tunnel 5 (dead end, medical herb)")).cave().connect(wd).chest(X,15,86);const zg=(new Location$$module$js$nodes(a,
131,x,"Tunnel 6a (left-then-right)")).cave().connect(wd),Ag=(new Location$$module$js$nodes(a,131,x,"Tunnel 6b (past wall)")).cave().connect(zg,v),Bg=(new Location$$module$js$nodes(a,132,x,"Tunnel 7 (wide hall)")).cave().connect(Ag);(new Location$$module$js$nodes(a,133,x,"Tunnel 8 (red slimes)")).cave().from(Bg,v).connectTo(ud).chest(H,23);const Cg=(new Location$$module$js$nodes(a,134,x,"Tunnel 9 (right branch, infinite loop)")).cave().connect(vd),Dg=(new Location$$module$js$nodes(a,135,x,"Tunnel 10a (toward magic ring)")).cave().connect(Cg);
(new Location$$module$js$nodes(a,135,x,"Tunnel 10b (past wall)")).cave().connect(Dg,v).connectTo(wg);const xd=(new Location$$module$js$nodes(a,136,ma,"Entrance")).fortress().from(td,$b,Bb),Eg=(new Location$$module$js$nodes(a,137,ma,"Left branch")).fortress().connect(xd).chest(H,19),Fg=(new Location$$module$js$nodes(a,137,ma,"Left branch, past one bridge")).fortress().connect(Eg,r),Gg=(new Location$$module$js$nodes(a,137,ma,"Left branch, past two bridges")).fortress().connect(Fg,r).chest(X,29,87),
Hg=(new Location$$module$js$nodes(a,137,ma,"Right branch")).fortress().connect(xd);(new Location$$module$js$nodes(a,137,ma,"Right branch, across water")).fortress().connect(Hg,D).chest(H,20).chest(H,21).chest(Kd,28);(new Location$$module$js$nodes(a,138,ma,"Upper floor")).fortress().connect(Gg).chest(K,27);const za=(new Location$$module$js$nodes(a,140,fa,"Town")).town().connect(yg,Kc).trigger(zb),Ja=(new Location$$module$js$nodes(a,142,na,"Town")).town().connect(hb),yd=(new Location$$module$js$nodes(a,
143,E,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(a,143,E,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(yd,qa).chest(Od,15);const Mb=(new Location$$module$js$nodes(a,144,na,"Desert 1")).overworld().connect(hb),ib=(new Location$$module$js$nodes(a,145,E,"Area 1 (from entrance)")).cave().chest(Wb,26),zd=(new Location$$module$js$nodes(a,145,E,"Area 2 (across top bridge)")).cave().connect(ib,r);(new Location$$module$js$nodes(a,145,E,"Area 3 (dead-end across top-right bridge)")).cave().connect(zd,
r);const Ig=(new Location$$module$js$nodes(a,145,E,"Area 4 (left across middle-right bridge)")).cave().connect(zd,r),Jg=(new Location$$module$js$nodes(a,145,E,"Area 5 (bottom edge)")).cave().connect(Ig,r),Kg=(new Location$$module$js$nodes(a,145,E,"Area 6 (bottom island)")).cave().connect(Jg,r),Lg=(new Location$$module$js$nodes(a,145,E,"Area 7 (bottom inner ring)")).cave().connect(Kg,r),Mg=(new Location$$module$js$nodes(a,145,E,"Area 8 (left outer ring)")).cave().connect(Lg,r).connect(ib,r).chest(Fa,
27,100),Ng=(new Location$$module$js$nodes(a,145,E,"Area 9 (top left inner ring)")).cave().connect(Mg,r),Og=(new Location$$module$js$nodes(a,145,E,"Area 10 (top right inner ring)")).cave().connect(Ng,r);(new Location$$module$js$nodes(a,145,E,"Area 11 (center)")).cave().connect(Og,r).connectTo(yd);(new Location$$module$js$nodes(a,145,E,"Area 12 (top center islands)")).cave().connect(ib,D).chest(Ld,28);const Pg=(new Location$$module$js$nodes(a,146,R,"Desert Cave 1")).cave().connect(Mb,D),Aa=(new Location$$module$js$nodes(a,
147,R,"Town")).town(),Qg=(new Location$$module$js$nodes(a,148,R,"Outside Cave")).overworld().connect(Aa),Rg=(new Location$$module$js$nodes(a,149,R,"Desert Cave 2")).cave().connect(Qg);(new Location$$module$js$nodes(a,150,R,"Meadow")).overworld().connect(Pg).connectTo(Aa).trigger(ke,pa,Z);const Nb=(new Location$$module$js$nodes(a,152,R,"Desert 2")).overworld().connect(Rg),Sg=(new Location$$module$js$nodes(a,156,va,"Entrance")).fortress().connect(Nb,D),Tg=(new Location$$module$js$nodes(a,156,va,"Azteca")).fortress().trigger(me),
Ug=(new Location$$module$js$nodes(a,157,va,"Fork")).fortress().connect(Sg),Ad=(new Location$$module$js$nodes(a,158,va,"Main")).fortress().connect(Ug);(new Location$$module$js$nodes(a,158,va,"Treasure Chest (magic ring)")).fortress().connect(Ad).chest(Y,27,108);(new Location$$module$js$nodes(a,159,va,"Draygon")).fortress().connect(Ad).to(Tg).boss(Ne);const Vg=(new Location$$module$js$nodes(a,160,V,"Entrance")).fortress().connect(Nb,D),Wg=(new Location$$module$js$nodes(a,160,V,"Statues")).fortress().connect(Vg).boss(Oe),
Xg=(new Location$$module$js$nodes(a,161,V,"Hall 1")).fortress().connect(Wg),Ob=(new Location$$module$js$nodes(a,162,V,"Branch")).fortress().connect(Xg);(new Location$$module$js$nodes(a,163,V,"Left Dead End")).fortress().connect(Ob).chest(H,13);(new Location$$module$js$nodes(a,164,V,"Right Dead End")).fortress().connect(Ob);const Yg=(new Location$$module$js$nodes(a,165,V,"Hall 2")).fortress().connect(Ob).chest(pb,26,109),Zg=(new Location$$module$js$nodes(a,166,V,"Draygon 2")).fortress().connect(Yg).boss(Pe);
(new Location$$module$js$nodes(a,167,V,"Teleporter")).fortress().from(Zg).to(kd);const Bd=(new Location$$module$js$nodes(a,168,$a,"Entrance")).fortress().connect(Ja,Bb).trigger(Ec,K),$g=(new Location$$module$js$nodes(a,169,$a,"Main")).fortress().from(Bd,qa),ah=(new Location$$module$js$nodes(a,169,$a,"Boss")).fortress().connect($g).boss(Je),bh=(new Location$$module$js$nodes(a,170,$a,"Zebu")).fortress().connect(ah),jb=(new Location$$module$js$nodes(a,171,Q,"Entrance")).fortress().connect(bh);(new Location$$module$js$nodes(a,
171,Q,"Dead End Behind Iron (fruit of power)")).fortress().connect(jb,qa).chest(Fa,28,98);(new Location$$module$js$nodes(a,171,Q,"Dead End Loop Across Closer Bridges")).fortress().connect(jb,r).connect(jb,r);const ch=(new Location$$module$js$nodes(a,171,Q,"Across First Bridge (fruit of repun)")).fortress().connect(jb,r).chest(Sb,30,102),Pb=(new Location$$module$js$nodes(a,171,Q,"Across Second Bridge")).fortress().connect(ch,r);(new Location$$module$js$nodes(a,171,Q,"Dead End Across Two Bridges ()")).fortress().connect(Pb,
r).connect(Pb,r).chest(nb,29,93);const dh=(new Location$$module$js$nodes(a,171,Q,"Across Third Bridge")).fortress().connect(Pb,r),eh=(new Location$$module$js$nodes(a,171,Q,"Exit Behind Iron Door")).fortress().connect(dh,qa),fh=(new Location$$module$js$nodes(a,172,Q,"Boss")).fortress().connect(eh).boss(Ke),gh=(new Location$$module$js$nodes(a,172,Q,"Tornel")).fortress().connect(fh),Cd=(new Location$$module$js$nodes(a,173,ua,"Lower")).fortress().connect(gh).chest(pb,26,99).chest(Y,27,111),hh=(new Location$$module$js$nodes(a,
174,ua,"Upper Loop")).fortress().connect(Cd).chest(Qa,22,96);(new Location$$module$js$nodes(a,174,ua,"Upper Loop Behind Wall (magic ring)")).fortress().connect(hh,qa).chest(Y,23,107);const ih=(new Location$$module$js$nodes(a,175,ua,"Upper Passage (toward Mado)")).fortress().connect(Cd).chest(Y,27,84),Qb=(new Location$$module$js$nodes(a,176,J,"Initial Fork")).fortress(),jh=(new Location$$module$js$nodes(a,177,J,"Left Branch")).fortress().connect(Qb),Dd=(new Location$$module$js$nodes(a,178,J,"Main Area (right branch, over bridges)")).fortress().connect(Qb),
kh=(new Location$$module$js$nodes(a,179,J,"U-shaped Passage (between floors)")).fortress().connect(Dd),lh=(new Location$$module$js$nodes(a,180,J,"Main Area Lower (under bridge)")).fortress().connect(jh).connect(Dd).connect(kh),Ed=(new Location$$module$js$nodes(a,180,J,"Behind Iron Wall")).fortress().connect(lh,qa),mh=(new Location$$module$js$nodes(a,181,J,"Lower")).fortress().connect(Ed).chest(H,13).chest(H,14).chest(H,15).chest(Y,23,88).chest(ob,24,110),nh=(new Location$$module$js$nodes(a,182,J,
"Boss Corridor")).fortress().connect(mh),oh=(new Location$$module$js$nodes(a,182,J,"Boss")).fortress().connect(nh,Bb).boss(Me);(new Location$$module$js$nodes(a,182,J,"Behind Boss (stormBracelet)")).fortress().connect(oh).chest(Pa,18);const Fd=(new Location$$module$js$nodes(a,183,J,"Exit Stairs")).fortress(),ph=(new Location$$module$js$nodes(a,184,E,"Entrance Back (behind river)")).cave().connect(Fd).chest(Fa,13,90);(new Location$$module$js$nodes(a,184,E,"Entrance Front")).cave().connect(ph,D).connectTo(Mb).connectTo(ib);
const qh=(new Location$$module$js$nodes(a,185,ua,"Boss")).fortress().connect(ih).boss(Le);(new Location$$module$js$nodes(a,185,ua,"Asina")).fortress().connect(qh).connectTo(Qb);(new Location$$module$js$nodes(a,186,J,"Kensu")).fortress().connect(Ed).connectTo(Fd).trigger(je,sb);(new Location$$module$js$nodes(a,187,na,"House")).house().connect(Ja).trigger(le,pa,sb);(new Location$$module$js$nodes(a,188,na,"Inn")).shop().connect(Ja,zb);(new Location$$module$js$nodes(a,190,na,"Tool Shop")).shop().connect(Ja,
zb);(new Location$$module$js$nodes(a,191,na,"Tavern")).shop().connect(Ja);(new Location$$module$js$nodes(a,192,O,"Elder House")).house().connect(ia).trigger(lc);(new Location$$module$js$nodes(a,193,O,"Rabbit Hut")).house().connect(ia).trigger(sc,rc,Z);(new Location$$module$js$nodes(a,194,O,"Inn")).shop().connect(ia);(new Location$$module$js$nodes(a,195,O,"Tool Shop")).shop().connect(ia).trigger(nc);(new Location$$module$js$nodes(a,196,O,"Armor Shop")).shop().connect(ia);(new Location$$module$js$nodes(a,
197,O,"Student House")).house().connect(ia).trigger(mc);(new Location$$module$js$nodes(a,198,sa,"Tavern")).house().connect(Ia);(new Location$$module$js$nodes(a,199,sa,"Pawn Shop")).shop().connect(Ia);(new Location$$module$js$nodes(a,200,sa,"Inn")).shop().connect(Ia);(new Location$$module$js$nodes(a,201,sa,"Armor Shop")).shop().connect(Ia);(new Location$$module$js$nodes(a,203,sa,"Tool Shop")).shop().connect(Ia);(new Location$$module$js$nodes(a,205,Ga,"Elder House")).house().from(bb,Z).trigger(Yd,wb);
(new Location$$module$js$nodes(a,206,Ga,"Mother's House")).house().from(bb,Z).trigger(qc,Z).trigger(Xd,wb);(new Location$$module$js$nodes(a,207,Ga,"Tool Shop")).shop().from(bb,Z);(new Location$$module$js$nodes(a,208,Ga,"Inn")).shop().from(bb,Z);(new Location$$module$js$nodes(a,209,ta,"Inn")).shop().connect(ab);(new Location$$module$js$nodes(a,210,ta,"Tool Shop")).shop().connect(ab);(new Location$$module$js$nodes(a,211,ta,"Armor Shop")).shop().connect(ab);const rh=(new Location$$module$js$nodes(a,
212,ta,"Queen's House")).house().from(ab,Kc).trigger(he,pa,fc);(new Location$$module$js$nodes(a,213,Za,"Nadare's")).house().connect(cb).connectTo(Bf).connectTo(Cf).connectTo(Df);(new Location$$module$js$nodes(a,214,A,"Fisherman's House")).house().connect(hd).trigger(xb,ac,rb,Be);const Rb=(new Location$$module$js$nodes(a,215,A,"Palace Entrance")).house().connect(oa);(new Location$$module$js$nodes(a,216,A,"Fortune Teller Front")).house().connect(oa).trigger(uc,tc);(new Location$$module$js$nodes(a,216,
A,"Fortune Teller Back")).house().connect(fg).connect(nd);(new Location$$module$js$nodes(a,217,A,"Pawn Shop")).shop().connect(oa);(new Location$$module$js$nodes(a,218,A,"Armor Shop")).shop().connect(oa);(new Location$$module$js$nodes(a,220,A,"Inn")).shop().connect(oa);(new Location$$module$js$nodes(a,221,A,"Tool Shop")).shop().connect(oa);(new Location$$module$js$nodes(a,222,A,"Palace Left")).house().connect(Rb);(new Location$$module$js$nodes(a,223,A,"Palace Throne Room")).house().connect(Rb).to(fb,
ve).from(fb).trigger(tc).trigger(ae,uc,vc);(new Location$$module$js$nodes(a,224,A,"Palace Right")).house().connect(Rb);(new Location$$module$js$nodes(a,225,A,"Asina's Room")).house().connect(od).trigger(ce,Gc);(new Location$$module$js$nodes(a,226,ta,"Queen Downstairs")).house().connect(rh).chest(Na,13);(new Location$$module$js$nodes(a,227,da,"Elder's House")).house().connect(gb).trigger(Ac);(new Location$$module$js$nodes(a,228,da,"Shed")).house().connect(gb).to(qg,bc);(new Location$$module$js$nodes(a,
229,da,"Tool Shop")).shop().connect(gb).trigger(nc);(new Location$$module$js$nodes(a,231,da,"Inn")).shop().connect(gb);const sh=(new Location$$module$js$nodes(a,232,F,"Zombie Town House")).house().connect(Jb);(new Location$$module$js$nodes(a,233,F,"Zombie Town Basement")).house().connect(sh).trigger(de,Oc);(new Location$$module$js$nodes(a,235,P,"Tool Shop")).shop().connect(W);(new Location$$module$js$nodes(a,236,P,"Stom's Hut")).house().connect(W).trigger(Bc);(new Location$$module$js$nodes(a,237,
P,"Inn")).shop().connect(W);(new Location$$module$js$nodes(a,238,P,"Armor Shop")).shop().connect(W);(new Location$$module$js$nodes(a,239,P,"Tavern")).house().connect(W).trigger(Cc,Bc,Ta);(new Location$$module$js$nodes(a,240,P,"Pawn Shop")).shop().connect(W);(new Location$$module$js$nodes(a,241,P,"Dance Hall")).house().connect(W).trigger(Dc,Cc,Ta).trigger(ge,Dc,ec);const th=(new Location$$module$js$nodes(a,242,fa,"Temple (pre-massacre)")).fortress().connect(za).from(Cb,K,y).trigger(ie);(new Location$$module$js$nodes(a,
242,fa,"Temple (post-massacre)")).fortress().from(th,Ec).boss(Ie);(new Location$$module$js$nodes(a,243,fa,"Training Hall")).house().connect(za);(new Location$$module$js$nodes(a,244,fa,"Hospital")).house().connect(za);(new Location$$module$js$nodes(a,245,fa,"Armor Shop")).shop().connect(za);(new Location$$module$js$nodes(a,246,fa,"Tool Shop")).shop().connect(za);(new Location$$module$js$nodes(a,247,fa,"Inn")).shop().connect(za);(new Location$$module$js$nodes(a,248,R,"Inn")).shop().connect(Aa);(new Location$$module$js$nodes(a,
249,R,"Tool Shop")).shop().connect(Aa);(new Location$$module$js$nodes(a,250,R,"Elder's House")).house().connect(Aa);(new Location$$module$js$nodes(a,251,R,"Pawn Shop")).house().connect(Aa);const uh=[ia,Ha,Qc,wa,Db,xa,Gb,bd,Ib,W,hb,Lb,Mb,Bd,Nb];for(const a of uh)a.from(Cb,re);return a},shuffle$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes);d||(d=new FlagSet$$module$js$flagset("Sbkm Sct"));
var g={};for(var h of f.nodes)if(h instanceof Slot$$module$js$nodes&&h.slots){var k=h.slotType?h.slotType[0]:"c";(g[k]=g[k]||[]).push(h)}h=[];k=[];var p={};for(var m of d.flags.S){var q=[];for(var n of m){p[n]=!0;for(var u of g[n])q.push(u),k.push([u,h.length])}h.push(q)}for(var l of"bc")if(p[l])for(m=g[l],n=m.map((a)=>[a.item,a.itemIndex]),a.shuffle(n),u=0;u<m.length;u++)m[u].set(...n[u]);q=(a)=>f.nodes.find((b)=>b instanceof Slot$$module$js$nodes&&b.name===a);g=q("Sword of Wind");l=q("Sword of Fire");
m=q("Ball of Wind");n=q("Ball of Fire");u=q("Statue of Onyx");q=q("Gas Mask");p.k&&a.nextInt(2)&&(l.swap(g),n.swap(m));p.k&&!a.nextInt(3)&&u.swap(q);p=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];g=[];e&&e.addTasks(10);for(l=0;1E3>l;l++){e&&0==l%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));a.shuffle(k);for(var y of h)a.shuffle(y);m=h.map(()=>-1);n=p[a.nextInt(p.length)];u=[];const b=(a)=>(a instanceof Chest$$module$js$nodes||a instanceof BossDrop$$module$js$nodes)&&9!==a.origIndex,c=(a)=>13<=
a&&36>=a||38===a||40===a||49===a||72<a;q=(a,d)=>a.itemIndex===d.itemIndex||!(112!==a.itemIndex||d instanceof Chest$$module$js$nodes&&!d.isInvisible)||!(112!==d.itemIndex||a instanceof Chest$$module$js$nodes&&!a.isInvisible)||c(a.itemIndex)&&!b(d)||c(d.itemIndex)&&!b(a)?!1:!0;for(let a=0;a<n;a++){const [b,c]=k[a],d=h[c][++m[c]];q(b,d)&&(b.swap(d),u.push([b,d]))}if(!u.length)continue;const {win:d,path:Ba}=f.traverse();if(d)g=Ba;else for(;u.length;){const [a,b]=u.pop();a.swap(b)}}for(const a of f.nodes)a instanceof
Slot$$module$js$nodes&&a.write(b);if(c){c.items=[];c.route=[];for(const a of g){const [b,d]=a;c.route.push(d);null!=b.slotName&&(y=b.slotName,0>y.indexOf(b.orig)&&(y+=` (normally ${b.orig})`),c.items.push({slotIndex:b.slotIndex,itemIndex:b.itemIndex,origName:b.vanillaItemName,slotName:b.slotName,itemName:b.item.name,text:`${b.item.name}: ${y}`}))}}}),shuffle2$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d),g=f.integrate();
e&&e.addTasks(1E3);for(let h=0;1E3>h;h++){try{yield shuffle3$$module$js$depgraph(f,g,b,a,c,d,e)}catch(k){e&&(e.addCompleted(1),0===h%50&&(yield new Promise(requestAnimationFrame)));continue}console.log(`success after ${h} attempts`);return}throw Error("failed");}),shuffle3$$module$js$depgraph=(b,a,c,d,e,f,g)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){var g=b.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName),k=new Map(d.shuffle(g.map((a)=>[a,[a.item,a.itemIndex]])));
const p=new Set(d.shuffle(g)),m=new Map,q={};f||(f=new FlagSet$$module$js$flagset("Sbkm Sct"));f.flags.S.forEach((a,b)=>{for(const c of a)q[c]=b});for(var n of p)m.set(n.item,n);const u=(a)=>13<=a&&36>=a||38===a||40===a||49===a||72<a&&91!=a,l=(a,b)=>q[a.slotType?a.slotType[0]:"c"]==q[b.slotType?b.slotType[0]:"c"]&&(112!==b.itemIndex||a instanceof Chest$$module$js$nodes&&!a.isInvisible)&&(!u(b.itemIndex)||(a instanceof Chest$$module$js$nodes||a instanceof BossDrop$$module$js$nodes)&&9!==a.origIndex)?
!0:!1;n=a.assumedFill(d,(a,b)=>l(a,m.get(b)));if(null==n)throw Error("Could not fill!");const y=new Map;for(let b=0;b<n.length;b++){var z=n[b];if(null!=z){var ja=m.get(a.item(z));z=k.get(ja);k.delete(ja);ja=a.location(b);y.set(ja,z);p.delete(ja)}}n=(a,b)=>{for(const c of p)if(l(c,a)){y.set(c,b);p.delete(c);return}throw Error("Could not fill extra items");};for(const a of k){const [b,c]=a;112===b.itemIndex&&(n(b,c),k.delete(b))}for(const a of k){const [b,c]=a;u(b.itemIndex)&&(n(b,c),k.delete(b))}for(const a of k){const [b,
c]=a;n(b,c)}for(const a of y){const [b,c]=a;b.set(...c)}const {win:kb,path:Ba}=b.traverse({wanted:g,dfs:!1});if(!kb)throw Error("FAIL");for(const a of b.nodes)a instanceof Slot$$module$js$nodes&&a.write(c);if(e){e.items=[];e.route=[];for(const a of Ba){const [c,d]=a;e.route.push(d);g=b.nodes[c];null!=g.slotName&&(k=g.slotName,0>k.indexOf(g.orig)&&(k+=` (normally ${g.vanillaItemName})`),e.items.push({slotIndex:g.slotIndex,itemIndex:g.itemIndex,origName:g.vanillaItemName,slotName:g.slotName,itemName:g.item.name,
text:`${g.item.name}: ${k}`}))}}});var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;module$js$depgraph.shuffle=shuffle$$module$js$depgraph;module$js$depgraph.shuffle2=shuffle2$$module$js$depgraph;module$js$depgraph.shuffle3=shuffle3$$module$js$depgraph;class Deque$$module$js$util{constructor(){this.buffer=Array(16);this.mask=15;this.size=this.end=this.start=0}get length(){return this.size}upsize(b){for(;this.mask<b;)this.end<=this.start&&(this.start+=this.mask+1),this.mask=this.mask<<1|1,this.buffer=this.buffer.concat(this.buffer);this.size=b}push(...b){this.upsize(this.size+b.length);for(const a of b)this.buffer[this.end]=a,this.end=this.end+1&this.mask}pop(){if(this.size)return this.end=this.end-1&this.mask,this.size--,this.buffer[this.end]}peek(){if(this.size)return this.buffer[this.end-
...
module$js$graph.SparseDependencyGraph=SparseDependencyGraph$$module$js$graph;class TrackerNode$$module$js$nodes extends Node$$module$js$graph{constructor(b,a){super(b,a)}get nodeType(){return"Tracker"}}class Option$$module$js$nodes extends Node$$module$js$graph{constructor(b,a,c){super(b,a);this.value=c}get nodeType(){return"Option"}edges(){return this.value?[Edge$$module$js$graph.of(this)]:[]}}
class Slot$$module$js$nodes extends Node$$module$js$graph{constructor(b,a,c,d,e=[]){super(b,a);this.slotName=a;this.slotIndex=d;this.slotType=c instanceof Magic$$module$js$nodes?"magic":null;this.vanillaItemName=c.name;this.slots=e;this.item=c;this.itemIndex=d}get nodeType(){return"Slot"}toString(){return`${super.toString()} [${this.vanillaItemName} $${this.slotIndex.toString(16).padStart(2,0)}]`}edges(){return null!=this.item&&null!=this.itemIndex?[Edge$$module$js$graph.of(this.item,this)]:[]}get name2(){return this.item==
this.vanilla?this.name:`${this.item.name} [${this.vanillaItemName}]`}set(b,a){this.item=b;this.itemIndex=a}write(b){if(this.slots)for(const a of this.slots)a(b.subarray(16),this)}swap(b){const a=this.item,c=this.itemIndex;this.set(b.item,b.itemIndex);b.set(a,c)}key(){this.slotType="key";return this}bonus(){this.slotType="bonus";return this}direct(b){this.slots.push((a,c)=>{a[b]=c.itemIndex});return this}npcSpawn(b,a=null,c=0){this.slots.push((d,e)=>{let f=addr$$module$js$nodes(d,116192,81920,b);for(;null!=
a&&d[f]!=a;){for(f++;!(d[f]&128);)f+=2,checkBounds$$module$js$nodes(f,d,this.name2,a);f+=2;checkBounds$$module$js$nodes(f,d,this.name2,a)}f+=2*c+1;d[f]&=-2;d[f]|=2;d[f+1]=e.itemIndex});return this}dialog(b,a=null,c=0,d=null){this.slots.push((e,f)=>{let g=addr$$module$js$nodes(e,117085,81920,b);for(;e[g]&128;)g+=4,checkBounds$$module$js$nodes(g,e,this.name2);let h=0;for(;255!=e[g];)null!=a&&e[g]==a&&(h=e[g+1]),g+=2,checkBounds$$module$js$nodes(g,e,a);for(g+=h+1;c;){if(e[g]&64){for(g+=5;!(e[g]&64);)g+=
2,checkBounds$$module$js$nodes(g,e,this.name2);g+=2}else g+=5;--c}if(null!=d)for(g+=5;d;)g+=2,--d;e[g]&=-2;e[g]|=2;e[g+1]=f.itemIndex});return this}trigger(b,a=0,c=null){this.slots.push((d,e)=>{let f=addr$$module$js$nodes(d,123258,81920,b&127);if(null==c)f+=2*a;else{for(;!(d[f]&128);)f+=2,checkBounds$$module$js$nodes(f,d,this.name2);f=f+4+2*c}d[f]&=-2;d[f]|=2;d[f+1]=e.itemIndex});return this}}class BossDrop$$module$js$nodes extends Slot$$module$js$nodes{get nodeType(){return"BossDrop"}}
...
class Location$$module$js$nodes extends Node$$module$js$graph{constructor(b,a,c,d){super(b,c.name+": "+d);this.simpleName=d;this.id=a;this.area=c;this.connections=[];this.chests=[];this.type=this.bossNode=null;this.isStart=!1}get nodeType(){return"Location"}toString(){return`Location ${this.id.toString(16).padStart(2,0)} ${this.name}`}edges(){const b=[];for(const a of this.connections)b.push(Edge$$module$js$graph.of(a.to,a.from,...a.deps,...a.from.bossNode?[a.from.bossNode]:[])),a.bidi&&b.push(Edge$$module$js$graph.of(a.from,
a.to,...a.deps,...a.to.bossNode?[a.to.bossNode]:[]));for(const a of this.chests)b.push(Edge$$module$js$graph.of(a,this));this.isStart&&b.push(Edge$$module$js$graph.of(this));return b}addConnection(b){b.from.connections.push(b);b.to.connections.push(b);return this}from(b,...a){return this.addConnection(new Connection$$module$js$nodes(b,this,!1,a))}to(b,...a){return this.addConnection(new Connection$$module$js$nodes(this,b,!1,a))}connect(b,...a){return this.addConnection(new Connection$$module$js$nodes(b,
...
class WorldGraph$$module$js$nodes extends Graph$$module$js$graph{integrate(b={}){const {removeConditions:a=!0,removeTriggers:c=!0,removeOptions:d=!0,removeTrackers:e=!0}=b,f=new SparseDependencyGraph$$module$js$graph(this.nodes.length),g=[],h=new Set,k=new Map;var p=[],m=[];const q=[];var n=[];const u=[];b=new Set;for(var l of this.nodes)if(l instanceof Location$$module$js$nodes){if(l.isStart){const [a]=f.addRoute([l.uid]);k.set(a.label,a)}g[l.uid]=[];for(var y of l.connections)h.has(y)||(h.add(y),
y.bidi&&h.add(y.reverse()));for(const a of l.chests)f.addRoute([a.uid,l.uid])}else if(l instanceof Slot$$module$js$nodes&&"Alarm Flute"===l.item.name)f.addRoute([l.item.uid]),f.finalize(l.item.uid);else if(!(l instanceof Slot$$module$js$nodes&&null==l.slotName))if(l instanceof ItemGet$$module$js$nodes&&"Medical Herb"===l.name&&(f.addRoute([l.uid]),f.finalize(l.uid)),l instanceof Option$$module$js$nodes)p.push(l);else if(l instanceof TrackerNode$$module$js$nodes)m.push(l);else if(l instanceof Condition$$module$js$nodes)q.push(l);
else if(l instanceof Trigger$$module$js$nodes)n.push(l);else if(l instanceof ItemGet$$module$js$nodes)u.push(l);else if(l instanceof Slot$$module$js$nodes)b.add(l);else if(!(l instanceof Area$$module$js$nodes))throw Error(`Unknown node type: ${l.nodeType}`);for(const a of h)g[a.from.uid].push(a);l=(a)=>{for(const b of a){for(const a of b.edges())f.addRoute(a);f.finalize(b.uid)}};d&&l(p);e&&l(m);c&&l(n);for(p=k.values();!(m=p.next()).done;){m=m.value;n=m.target;for(var z of g[n]){n=[z.to.uid,...m.deps];
for(y=z.deps.length-1;0<=y;y--)n.push(z.deps[y].uid);z.from.bossNode&&n.push(z.from.bossNode.uid);for(const a of f.addRoute(n))k.has(a.label)||k.set(a.label,a)}}a&&l(q);for(z=0;z<this.nodes.length;z++)this.nodes[z]instanceof ItemGet$$module$js$nodes||f.finalize(z);z=new LocationList$$module$js$nodes(this);for(const a of b)for(const b of f.nodes[a.uid].values())z.addRoute([a.uid,...b]);return z}}
class LocationList$$module$js$nodes{constructor(b){this.worldGraph=b;this.uidToLocation=[];this.locationToUid=[];this.uidToItem=[];this.itemToUid=[];this.routes=[];this.unlocks=[]}item(b){return this.worldGraph.nodes[this.itemToUid[b]]}location(b){return this.worldGraph.nodes[this.locationToUid[b]]}addRoute(b){let a=Bits$$module$js$bits.of(),c;const d=[];for(let e=b.length-1;0<=e;e--){const f=e?this.uidToItem:this.uidToLocation,g=e?this.itemToUid:this.locationToUid,h=b[e];let k=f[h];null==k&&(k=g.length,
g.push(h),f[h]=k);e?(a=Bits$$module$js$bits.with(a,k),d.push(this.unlocks[k]||(this.unlocks[k]=new Set))):c=k}(this.routes[c]||(this.routes[c]=[])).push(a);for(const a of d)a.add(c)}canReach(b,a){b=this.uidToLocation(b.uid);b=this.routes[b];for(let c=0;c<b.length;c++)if(Bits$$module$js$bits.containsAll(a,b[c]))return!0;return!1}traverse(b,a){b=Bits$$module$js$bits.clone(b);const c=new Set;let d=new Set;for(var e=0;e<this.locationToUid.length;e++)d.add(e);e=d[Symbol.iterator]();for(var f;!(f=e.next()).done;){f=
f.value;d.delete(f);if(c.has(f))continue;const e=this.routes[f];for(let g=0;g<e.length;g++)if(Bits$$module$js$bits.containsAll(b,e[g])){c.add(f);if(a[f]){b=Bits$$module$js$bits.with(b,a[f]);for(let b of this.unlocks[a[f]])d.add(b)}break}}return c}toString(){const b=[];for(let a=0;a<this.routes.length;a++){const c=this.worldGraph.nodes[this.locationToUid[a]],d=this.routes[a],e=[];for(let a=0;a<d.length;a++){const b=[];for(const c of Bits$$module$js$bits.bits(d[a]))b.push(this.worldGraph.nodes[this.itemToUid[c]]);
e.push("("+b.join(" & ")+")")}b.push(`${c}: ${e.join(" | ")}`)}return b.join("\n")}assumedFill(b,a=(a,b)=>!0){const c=[];for(var d=this.itemToUid.length-1;0<=d;d--){var {shufflePriority:e=1}=this.worldGraph.nodes[this.itemToUid[d]];for(var f=0;f<e;f++)c.push(d)}b.shuffle(c);d=Bits$$module$js$bits.from(c);const g=Array(this.locationToUid.length).fill(null);for(;c.length;){e=c.pop();if(!Bits$$module$js$bits.has(d,e))continue;d=Bits$$module$js$bits.without(d,e);f=[...this.traverse(d,g)].filter((a)=>
null==g[a]);b.shuffle(f);let h=!1;for(let b=f.length-1;0<=b;b--){const c=f[b];if(null==g[c]&&a(this.worldGraph.nodes[this.locationToUid[c]],this.worldGraph.nodes[this.itemToUid[e]])){g[c]=e;h=!0;break}}if(!h)return null}return g}}var module$js$nodes={};module$js$nodes.TrackerNode=TrackerNode$$module$js$nodes;module$js$nodes.Option=Option$$module$js$nodes;module$js$nodes.Slot=Slot$$module$js$nodes;module$js$nodes.BossDrop=BossDrop$$module$js$nodes;module$js$nodes.Chest=Chest$$module$js$nodes;
module$js$nodes.ItemGet=ItemGet$$module$js$nodes;module$js$nodes.Item=Item$$module$js$nodes;module$js$nodes.Magic=Magic$$module$js$nodes;module$js$nodes.Trigger=Trigger$$module$js$nodes;module$js$nodes.Condition=Condition$$module$js$nodes;module$js$nodes.Boss=Boss$$module$js$nodes;module$js$nodes.Area=Area$$module$js$nodes;module$js$nodes.Connection=Connection$$module$js$nodes;module$js$nodes.Location=Location$$module$js$nodes;module$js$nodes.WorldGraph=WorldGraph$$module$js$nodes;
module$js$nodes.LocationList=LocationList$$module$js$nodes;const seq$$module$js$rom=(b,a)=>{a=void 0===a?(a)=>a:a;return Array(b).fill(0).map((b,d)=>a(d))},slice$$module$js$rom=(b,a,c)=>b.slice(a,a+c),signed$$module$js$rom=(b)=>128>b?b:b-256,varSlice$$module$js$rom=(b,a,c,d,e)=>{e=void 0===e?Infinity:e;const f=[];for(;a+c<=e&&b[a]!=d;)f.push(b.slice(a,a+c)),a+=c;return f},addr$$module$js$rom=(b,a,c)=>(b[a]|b[a+1]<<8)+(void 0===c?0:c),group$$module$js$rom=(b,a)=>seq$$module$js$rom(Math.max(0,Math.floor(a.length/b)),(c)=>slice$$module$js$rom(a,c*b,b)),reverseBits$$module$js$rom=
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="assumed",LABEL$$module$js$version="assumed 956f677",HASH$$module$js$version="956f677e0672325716f60bd5e8c257b611fe9edd",DATE$$module$js$version=new Date(1551217271E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c;a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);c=a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$js$patch(b,parseSeed$$module$js$patch(a.seed),c)})}};
...
7).padStart(7,0).toUpperCase():VERSION$$module$js$version;a=a.toString(16).padStart(8,0).toUpperCase();const f=(a,c)=>{for(let d=0;d<c.length;d++)b[a+16+d]=c.charCodeAt(d)},g=(a,b)=>{const c=[];for(let d=0;d<a.length||d<b.length;d++)c.push(a[d]||" "),c.push(b[d]||" ");return c.join("")};f(161743,g("  VERSION     SEED      ",`  ${e}     ${a}`));a=String(c);let h;if(46<a.length){if(92<a.length)throw Error("Flag string way too long!");h=a.substring(46,92).padEnd(46," ");a=a.substring(0,46)}a=a.padEnd(46,
" ");f(161791,g(a.substring(0,23),a.substring(23)));h&&f(161839,g(h.substring(0,23),h.substring(23)));f(161925,g(d.substring(0,4),d.substring(4)));f(153366,"RANDOMIZER");f(153404,"BETA");return d},watchForFlag0$$module$js$patch=buildRomPatch$$module$js$6502(assemble$$module$js$6502("\n.bank $3c000 $c000:$4000\n\n;;;; TODO - REMOVE THIS ONCE IT'S SOLVED\n.org $3cb62 ; main game mode jump 08\n  jsr CheckFlag0\n.org $3fe80\nReadControllersWithDirections:\n.org $3d347\nInitiateDialog:\n\n.org $3fdd0 ; !!! - note itemLib (I think) uses this space, too\nCheckFlag0:\n  lda $6480\n  lsr\n  bcc +\n   asl\n   sta $6480\n   lda #$00\n   sta $20\n   sta $21\n   ldx #$0c\n-   lda $6140,x\n    eor #$ff\n    sta $6140,x\n    dex\n   bpl -\n   jsr InitiateDialog\n+ jmp ReadControllersWithDirections\n\n",
...
a[3]+80;if(h in UNTOUCHED_MONSTERS$$module$js$patch||!SCALED_MONSTERS$$module$js$patch.has(h)||"m"!=SCALED_MONSTERS$$module$js$patch.get(h).type)continue;var f=b.rom.objects[h];if(!f)continue;const p=a[2]&128?1:0,m=b.spritePatterns[p];var g=f.palettes(!0);f=g.includes(2)?b.spritePalettes[0]:null;g=g.includes(3)?b.spritePalettes[1]:null;d.push({id:h,pat:m,pal2:f,pal3:g,patBank:p});(this.report[`start-${h.toString(16)}`]=this.report[`start-${h.toString(16)}`]||[]).push("$"+b.id.toString(16));c.push(e)}d.length&&
...
this.report["$"+d.id.toString(16).padStart(2,0)]=[];const {maxFlyers:g,nonFlyers:h={},fixedSlots:k={}}=MONSTER_ADJUSTMENTS$$module$js$patch[d.id]||{};let p=k.pat0||null,m=k.pat1||null,q=k.pal2||null,n=k.pal3||null,u=g,l=!1;for(const b of d.objects||[])if(2==(b[2]&7)&&(l=!0),!(b[2]&7)){var a=b[3]+80;126==a||127==a||159==a?m=98:143==a&&(p=97)}if(21==d.id||71==d.id)l=!1;f.push(`Initial pass: ${[l,p,m,q,n].join(", ")}`);a=(a)=>{var b=FLYERS$$module$js$patch.has(a.id),c=MOTHS_AND_BATS$$module$js$patch.has(a.id);
if(b){if(!u)return!1;--u}if(null!=q&&null!=a.pal2&&q!=a.pal2||null!=n&&null!=a.pal3&&n!=a.pal3)return!1;var g=!l||TREASURE_CHEST_BANKS$$module$js$patch.has(a.pat);let k;if(d.rom.objects[a.id].child||RETAIN_SLOTS$$module$js$patch.has(a.id)){const b=(k=a.patSlot?128:0)?m:p;if(null!=b&&b!=a.pat)return!1;if(k)m=a.pat;else if(g)p=a.pat;else return!1;f.push(`  Adding ${a.id.toString(16)}: pat(${k}) <-  ${a.pat.toString(16)}`)}else if(null==p&&g||p==a.pat)p=a.pat,k=0,f.push(`  Adding ${a.id.toString(16)}: pat0 <-  ${a.pat.toString(16)}`);
...
this.used.push(a);c--}for(c=0;c<this.used.length&&e.length;c++)a(this.used[c])&&(this.used.push(...this.used.splice(c,1)),c--);null!=p&&(d.spritePatterns[0]=p);null!=m&&(d.spritePatterns[1]=m);null!=q&&(d.spritePalettes[0]=q);null!=n&&(d.spritePalettes[1]=n);if(e.length){f.push(`Failed to fill location ${d.id.toString(16)}: ${e.length} remaining`);for(const b of e)a=d.objects[b-13],a[0]=a[1]=0}}}}
