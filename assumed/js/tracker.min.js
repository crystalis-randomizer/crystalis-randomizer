...
MAX_UINT32$$module$js$bits_bigint),e=32;for(;d;){const b=Math.clz32(d)+1;e-=b;d<<=b;32==b&&(d=0);a.push(c|e)}b>>=THIRTY_TWO$$module$js$bits_bigint;c+=32}return a},clone:(b)=>b,empty:(b)=>!b},BIGINT_OK$$module$js$bits_bigint="function"===typeof BigInt&&"bigint"===typeof BigInt(0),ZERO$$module$js$bits_bigint=BIGINT_OK$$module$js$bits_bigint&&BigInt(0),ONE$$module$js$bits_bigint=BIGINT_OK$$module$js$bits_bigint&&BigInt(1),MAX_UINT32$$module$js$bits_bigint=BIGINT_OK$$module$js$bits_bigint&&BigInt(4294967295),
THIRTY_TWO$$module$js$bits_bigint=BIGINT_OK$$module$js$bits_bigint&&BigInt(32);var module$js$bits_bigint={BIGINT_OK:BIGINT_OK$$module$js$bits_bigint};const Bits$$module$js$bits_array={of:(...b)=>{let a=[];for(const c of b)a[c>>>5]=(a[c>>>5]||0)|1<<c;return a},from:(b)=>{let a=[];for(const c of b)a[c>>>5]=(a[c>>>5]||0)|1<<c;return a},containsAll:(b,a)=>{for(let c=Math.max(b.length,a.length)-1;0<=c;c--)if((a[c]||0)&~(b[c]||0))return!1;return!0},with:(b,a)=>{b[a>>>5]=(b[a>>>5]||0)|1<<a;return b},without:(b,a)=>{b[a>>>5]=(b[a>>>5]||0)&~(1<<a);return b},has:(b,a)=>!!((b[a>>>5]||0)&1<<a),bits:(b)=>{const a=[];for(let c=0;c<b.length;c++){let d=b[c],e=
32;for(;d;){const b=Math.clz32(d)+1;e-=b;d<<=b;32==b&&(d=0);a.push(c<<5|e)}}return a},clone:(b)=>[...b],empty:(b)=>b.every((a)=>!a)};var module$js$bits_array={};const b$$module$js$bits=BIGINT_OK$$module$js$bits_bigint?module$js$bits_bigint.Bits:module$js$bits_array.Bits;class Bits$$module$js$bits{}Bits$$module$js$bits.of=b$$module$js$bits.of;Bits$$module$js$bits.from=b$$module$js$bits.from;Bits$$module$js$bits.containsAll=b$$module$js$bits.containsAll;Bits$$module$js$bits.with=b$$module$js$bits.with;Bits$$module$js$bits.without=b$$module$js$bits.without;Bits$$module$js$bits.has=b$$module$js$bits.has;Bits$$module$js$bits.bits=b$$module$js$bits.bits;
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="assumed",LABEL$$module$js$version="assumed 8e84ede",HASH$$module$js$version="8e84ededb89b965037dcb0ad612bb821bfd2889a",DATE$$module$js$version=new Date(155118144E4);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c;a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);c=a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$js$patch(b,parseSeed$$module$js$patch(a.seed),c)})}};
