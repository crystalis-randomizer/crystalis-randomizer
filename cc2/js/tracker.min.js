...
,b]]=e.pop(),c=f.splice(f.length-b,b);if(c.length!==b)throw Error("shunting parse failed?");f.push(ra({op:a,args:c}))}b=void 0===b?0:b;const e=[],f=[];for(var g=!0,h=b;h<a.length;h++){var k=a[h];if(g)if("cs"===k.token||"op"===k.token){var u=ta.get(k.str);if(u=ua.get(null!==u&&void 0!==u?u:k.str))e.push([k.str,u]);else if("cs"===k.token){g=k.str;if(!wa.has(g))throw Error(`No such function: ${m.nameAt(k)}`);u=a[h+1];if("lp"!==(null===u||void 0===u?void 0:u.token))throw Error(`Bad funcall: ${m.nameAt(null!==
u&&void 0!==u?u:k)}`);k=m.findBalanced(a,h+1);if(0>k)throw Error(`Never closed: ${m.nameAt(u)}`);u=[];for(const b of m.parseArgList(a,h+2,k))u.push(d(b));h=k;f.push(ra({op:g,args:u}));g=!1}else if(m.eq(k,m.STAR))f.push({op:"sym",sym:"*"}),g=!1;else throw Error(`Unknown prefix operator: ${m.nameAt(k)}`);}else if("lp"===k.token){g=m.findBalanced(a,h);if(0>g)throw Error(`No close paren: ${m.nameAt(k)}`);h=d(a.slice(h+1,g));f.push(h);h=g;g=!1}else if("ident"===k.token)f.push({op:"sym",sym:k.str}),g=!1;
else if("num"===k.token)k=k.num,f.push({op:"num",num:k,meta:xa(k)}),g=!1;else throw Error(`Bad expression token: ${m.nameAt(k)}`);else{if(m.eq(k,m.COMMA))break;if("cs"===k.token||"op"===k.token){g=ta.get(k.str);g=ya.get(null!==g&&void 0!==g?g:k.str);if(!g)break;for(;e.length;){u=e[e.length-1];const a=za(u[1],g);if(0>a)break;if(0===a)throw Error(`Mixing ${u[0]} and ${k.str} needs explicit parens.${m.at(k)}`);c()}e.push([k.str,g]);g=!0}else break}}for(;e.length;)c();if(1!==f.length)throw Error("shunting parse failed?");
a[b].source&&(f[0].source=a[b].source);return[f[0],h]}function f(a){if(null!=a)return{op:"num",num:a,meta:xa(a)}}function g(a,b){const c=a.args[0];if(!q(c))return a;a=b(c.num);return{op:"num",num:a,meta:xa(a)}}function h(a,b){const [c,d]=a.args;if(!q(c)||!q(d))return a;a=b(c.num,d.num);return{op:"num",num:a,meta:xa(a)}}function k(a){var b,c,d,e,f,g;const [h,k]=a.args;if("num"!==h.op||"num"!==k.op)return a;const u={op:"num",num:h.num+k.num};if(h.meta||k.meta){if((null===(b=h.meta)||void 0===b?0:b.rel)&&
(null===(c=k.meta)||void 0===c?0:c.rel))return a;if(null===(d=h.meta)||void 0===d?0:d.rel)u.meta=h.meta;else if(null===(e=k.meta)||void 0===e?0:e.rel)u.meta=k.meta}null!==(f=u.meta)&&void 0!==f&&f.rel||null!=(null===(g=u.meta)||void 0===g?void 0:g.size)||((u.meta||(u.meta={})).size=xa(u.num).size);return u}function p(a){var b,c,d,e,f;const [g,h]=a.args;if("num"!==g.op||"num"!==h.op)return a;const k={op:"num",num:g.num-h.num};if(null===(b=h.meta)||void 0===b?0:b.rel)return(null===(c=g.meta)||void 0===
...
const ya=new Map([["*",[5,4,2]],["/",[5,4,2]],[".mod",[5,3,2]],["&",[5,2,2]],["^",[5,1,2]],["<<",[5,0,2]],[">>",[5,0,2]],["+",[4,2,2]],["-",[4,2,2]],["|",[4,1,2]],["<",[3,0,2]],["<=",[3,0,2]],[">",[3,0,2]],[">=",[3,0,2]],["=",[3,0,2]],["<>",[3,0,2]],["&&",[2,3,2]],[".xor",[2,2,2]],["||",[2,1,2]]]),ua=new Map([["+",[9,-1,1]],["-",[9,-1,1]],["~",[9,-1,1]],["<",[9,-1,1]],[">",[9,-1,1]],["^",[9,-1,1]],["!",[2,-1,1]]]),wa=new Set([".byteat",".wordat",".max",".min"]),ta=new Map([[".bitand","&"],[".bitxor",
...
for(let a=0;a<c;a++)d[a]=b&255,b>>=8;this.writeBytes(a,d)}}function Za(a,b,c){a=Object.assign({},a);a.expr=$a(a.expr,b,c);return a}function $a(a,b,c){var d;a=Object.assign({},a);a.meta&&(a.meta=Object.assign({},a.meta));a.args&&(a.args=a.args.map(a=>$a(a,b,c)));null!=(null===(d=a.meta)||void 0===d?void 0:d.chunk)&&(a.meta.chunk+=b);"sym"===a.op&&null!=a.num&&(a.num+=c);return a}function ab(a,b,c){a=Object.assign({},a);a.expr&&(a.expr=$a(a.expr,b,c));return a}
class Ua{constructor(){this.data=new Pa;this.orig=new Pa;this.exports=new Map;this.chunks=[];this.symbols=[];this.free=new Qa;this.rawSegments=new Map;this.segments=new Map;this.resolvedChunks=[];this.unresolvedChunks=new Set;this.watches=[];this.placed=[];this.initialReport=""}insertResolved(a){La(this.resolvedChunks,a=>a.size,a)}base(a,b){b=void 0===b?0:b;this.data.set(b,a);this.orig.set(b,a)}readFile(a){const b=this.chunks.length,c=this.symbols.length;for(var d of a.segments||[])this.addRawSegment(d);
for(const e of a.chunks||[])d=new Ya(this,this.chunks.length,e,b,c),this.chunks.push(d);for(const d of a.symbols||[])this.symbols.push(ab(d,b,c))}resolveLink(a){var b,c,d;if(".orig"===a.op&&1===(null===(b=a.args)||void 0===b?void 0:b.length)){var e=a.args[0];var f=null===(c=e.meta)||void 0===c?void 0:c.offset;if(null!=f&&(e=this.orig.get(f+e.num),null!=e))return{op:"num",num:e}}else"num"===a.op&&null!=(null===(d=a.meta)||void 0===d?void 0:d.chunk)&&(c=a.meta,b=this.chunks[c.chunk],b.org!==c.org||
...
else{[f]=this.unresolvedChunks;for(var h of f.deps)f=this.chunks[h],null==f.org&&this.placeChunk(f)}f=this.resolvedChunks.length+2*this.unresolvedChunks.size;if(f===g)throw console.error(this.resolvedChunks,this.unresolvedChunks),Error("Not making progress");g=f}h=new Pa;for(var k of this.chunks){for(const a of k.asserts)if(!this.resolveExpr(a))throw k=m.at(a),Error(`Assertion failed${k}`);k.overlaps||h.set(k.offset,...this.data.slice(k.offset,k.offset+k.size))}return h}placeChunk(a){if(null==a.org){var b=
...
class ob{constructor(){this.presets=new Map;this.Casual=new nb(this,"Casual","\n      Basic flags for a relatively easy playthrough.  This is a good\n      place to start.",[n.PreserveUniqueChecks,n.NoShuffleMimics,n.DecreaseEnemyDamage,n.GuaranteeRefresh,n.GuaranteeStartingSword,n.ExperienceScalesFaster,n.NoCommunityJokes,r.NoThunderSwordWarp,qb.Shops,qb.Dyna,[qb.Maps,"!"],[qb.WildWarp,"!"],rb.SpoilerLog]);this.Classic=new nb(this,"Classic","\n      Provides a relatively quick playthough with a reasonable amount of\n      challenge.  Similar to older versions.",
[n.GuaranteeStartingSword,n.NoCommunityJokes,t.StatueGlitch,[r.NoThunderSwordWarp,"!"],[qb.Maps,"!"],rb.SpoilerLog]);this.Standard=new nb(this,"Standard","\n      Well-balanced, standard race flags.",[sb.RandomizeWeaknesses,r.StoryMode,rb.SpoilerLog]);this.NoBowMode=new nb(this,"No Bow Mode","\n      The tower is open from the start, as soon as you're ready for it.",[sb.RandomizeWeaknesses,sb.TowerRobots,tb.MaxScalingInTower,r.NoBowMode,rb.SpoilerLog]);this.Advanced=new nb(this,"Advanced","\n      A balanced randomization with quite a bit more difficulty.",
[t.GhettoFlight,t.MtSabreRequirementSkip,t.StatueGlitch,[t.SwordChargeGlitch,"!"],ub.Barrier,ub.BattleMagic,ub.GasMask,tb.MaxScalingInTower,sb.RandomizeWeaknesses,sb.TowerRobots,r.OrbsNotRequired,r.StoryMode,v.RandomizeMaps,v.ShuffleAreas,v.ShuffleHouses,v.RandomizeTrades,v.RandomizeWallElements,v.UnidentifiedKeyItems,rb.SpoilerLog]);this.WildWarp=new nb(this,"Wild Warp","\n      Significantly opens up the game right from the start with wild\n      warp in logic.",[n.GuaranteeRefresh,v.RandomizeWildWarp,
sb.RandomizeWeaknesses,sb.TowerRobots,r.OrbsNotRequired,r.StoryMode,rb.SpoilerLog]);this.Mystery=new nb(this,"Mystery","\n      Even the options are random.",[[v.ShuffleAreas,"?"],[v.ShuffleHouses,"?"],[v.RandomizeMaps,"?"],[v.RandomizeTrades,"?"],[v.UnidentifiedKeyItems,"?"],[v.RandomizeWallElements,"?"],[v.ShuffleGoaFloors,"?"],[v.RandomizeSpriteColors,"?"],[v.RandomizeWildWarp,"?"],[r.OrbsNotRequired,"?"],[r.NoBowMode,"?"],[r.StoryMode,"?"],[r.VanillaDolphin,"?"],[r.NoThunderSwordWarp,"?"],[t.RageSkip,
"?"],[t.TriggerSkip,"?"],[t.StatueGlitch,"?"],[t.GhettoFlight,"?"],[t.SwordChargeGlitch,"?"],[t.MtSabreRequirementSkip,"?"],[vb.RandomizeMusic,"?"],[vb.RandomizeMapColors,"?"],[sb.RandomizeWeaknesses,"?"],[sb.TowerRobots,"?"],[n.NoShuffleMimics,"?"],[n.PreserveUniqueChecks,"?"],[ub.Barrier,"?"],[ub.BattleMagic,"?"],[ub.GasMask,"?"],[qb.Dyna,"?"],[qb.BonusItems,"?"],[qb.Maps,"?"],rb.SpoilerLog]);this.Hardcore=new nb(this,"Hardcore","\n      Not for the faint of heart.  Good luck.",[ub.Barrier,ub.BattleMagic,
tb.ExperienceScalesSlower,tb.MaxScalingInTower,tb.Permadeath,r.OrbsNotRequired,r.StoryMode,v.RandomizeMaps,v.ShuffleAreas,v.ShuffleHouses,v.RandomizeTrades,v.RandomizeWallElements,v.UnidentifiedKeyItems]);this.FullStupid=new nb(this,"The Full Stupid","\n      Only a few noble fools have ever completed this.  Be sure to record this\n      because pics or it didn't happen.",[ub.Barrier,ub.BattleMagic,tb.Blackout,tb.ExperienceScalesSlower,tb.MaxScalingInTower,tb.Permadeath,sb.RandomizeWeaknesses,sb.TowerRobots,
r.OrbsNotRequired,r.StoryMode,v.RandomizeMaps,v.ShuffleAreas,v.ShuffleHouses,v.RandomizeTrades,v.RandomizeWallElements,v.ShuffleGoaFloors,v.UnidentifiedKeyItems]);this.Tournament2022Early=new nb(this,"Tournament 2022 Early Rounds","\n      Lots of potential complexity, but within reason.  Requires all swords and\n      bosses, as well as a few glitches, but guarantees a starting sword.",[n.GuaranteeStartingSword,t.StatueGlitch,t.StatueGauntletSkip,[sb.RandomizeWeaknesses,"?"],r.OrbsNotRequired,r.StoryMode,
[r.VanillaDolphin,"?"],[r.NoThunderSwordWarp,"?"],[v.RandomizeWallElements,"?"],[v.ShuffleGoaFloors,"?"],[v.RandomizeSpriteColors,"?"],[v.RandomizeTrades,"?"],[v.UnidentifiedKeyItems,"?"]]);this.Tournament2022Mid=new nb(this,"Tournament 2022 Mid Rounds","\n      Some additional challenges compared to the early rounds: some additional\n      mystery flags and glitches, as well as max difficulty scaling in the\n      tower.",[[n.GuaranteeStartingSword,"?"],[t.GhettoFlight,"?"],[t.StatueGlitch,"?"],
[t.MtSabreRequirementSkip,"?"],[t.StatueGauntletSkip,"?"],tb.MaxScalingInTower,[tb.NoBuffMedicalHerb,"?"],[sb.RandomizeWeaknesses,"?"],[sb.TowerRobots,"?"],[ub.Barrier,"?"],[ub.BattleMagic,"?"],r.StoryMode,[r.VanillaDolphin,"?"],[r.OrbsNotRequired,"?"],[r.NoThunderSwordWarp,"?"],[v.RandomizeWallElements,"?"],[v.ShuffleGoaFloors,"?"],[v.RandomizeSpriteColors,"?"],[v.RandomizeTrades,"?"],[v.UnidentifiedKeyItems,"?"]]);this.Tournament2022Finals=new nb(this,"Tournament 2022 Finals Round","\n      Many of the more difficult mystery flags from the mid rounds are now\n      always on, plus entrance shuffle.",
[[n.GuaranteeStartingSword,"?"],t.GhettoFlight,t.StatueGlitch,t.MtSabreRequirementSkip,t.StatueGauntletSkip,tb.NoBuffMedicalHerb,tb.MaxScalingInTower,[sb.RandomizeWeaknesses,"?"],[sb.TowerRobots,"?"],ub.Barrier,ub.BattleMagic,r.StoryMode,[r.VanillaDolphin,"?"],[r.OrbsNotRequired,"?"],[r.NoThunderSwordWarp,"?"],v.ShuffleHouses,[v.RandomizeWallElements,"?"],[v.ShuffleGoaFloors,"?"],[v.RandomizeSpriteColors,"?"],[v.RandomizeTrades,"?"],[v.UnidentifiedKeyItems,"?"]])}static get(a){this.instance||(this.instance=
new ob);return this.instance.presets.get(a.toLowerCase().replace(/[^a-z]/g,""))}}class zb{constructor(){this.flags=new Map}static all(){return[...this.sections]}static flag(a,b){zb.sections.add(this.instance||(this.instance=new this));const c=new lb(a,b);if(!a.startsWith(this.instance.prefix))throw Error(`bad flag ${a} ${b}`);this.instance.flags.set(a,c);return c}}zb.sections=new Set;class v extends zb{constructor(){super(...arguments);this.prefix="W";this.name="World"}}
...
class ub extends zb{constructor(){super(...arguments);this.prefix="N";this.name="No guarantees";this.description="\n      Removes various guarantees from the logic."}}ub.BattleMagic=ub.flag("Nw",{name:"Battle magic not guaranteed",text:"Normally, the logic will guarantee that level 3 sword charges are\n           available before fighting the tetrarchs (with the exception of Karmine,\n           who only requires level 2).  This disables that check.",hard:!0});
...
ub.GasMask=ub.flag("Ng",{name:"Gas mask not guaranteed",text:"The logic will not guarantee gas mask before needing to enter the swamp,\n           nor will leather boots (or hazmat suit) be guaranteed to cross long\n           stretches of spikes.  Gas mask is still guaranteed to kill the insect.",hard:!0});class tb extends zb{constructor(){super(...arguments);this.prefix="H";this.name="Hard mode"}}
tb.NoBuffMedicalHerb=tb.flag("Hm",{name:"Don't buff medical herb or fruit of power",text:"Medical Herb is not buffed to heal 80 damage, which is helpful to make\n           up for cases where Refresh is unavailable early.  Fruit of Power is not\n           buffed to restore 56 MP.",hard:!0});tb.MaxScalingInTower=tb.flag("Ht",{name:"Max scaling level in tower",text:"Enemies in the tower spawn at max scaling level.",hard:!0});
tb.ExperienceScalesSlower=tb.flag("Hx",{name:"Experience scales slower",text:'More grinding will be required to "keep up" with the difficulty.',excludes:["Ex"],hard:!0});tb.ChargeShotsOnly=tb.flag("Hc",{name:"Charge shots only",text:"Stabbing is completely ineffective.  Only charged shots work.",hard:!0});tb.Blackout=tb.flag("Hz",{name:"Blackout",text:"All caves and fortresses are permanently dark.",hard:!0});
tb.Permadeath=tb.flag("Hh",{name:"Permadeath",text:"Hardcore mode: checkpoints and saves are removed.",hard:!0});class qb extends zb{constructor(){super(...arguments);this.name="Vanilla";this.prefix="V";this.description="\n      Options to restore vanilla behavior changed by default."}}qb.Dyna=qb.flag("Vd",{name:"Don't buff Dyna",text:"By default, we makes the Dyna fight a bit more of a challenge.\n           Side pods will fire significantly more.  The safe spot has been\n           removed.  The revenge beams pass through barrier.  Side pods can\n           now be killed.  This flag prevents that change."});
...
[])this.flags.delete(lb.flags.get(a))}else console.error(`Bad flag: ${a}`)}check(a,...b){a=a instanceof lb?a:lb.flags.get(a);b.length||b.push(!0);return b.includes(a&&this.flags.get(a)||!1)}get(a){return(a=a instanceof lb?a:lb.flags.get(a))&&this.flags.get(a)||!1}preserveUniqueChecks(){return this.check(n.PreserveUniqueChecks)}shuffleMimics(){return this.check(n.NoShuffleMimics,!1)}buffDeosPendant(){return this.check(qb.BonusItems,!1)}changeGasMaskToHazmatSuit(){return this.check(qb.BonusItems,!1)}slowDownTornado(){return this.check(qb.BonusItems,
!1)}leatherBootsGiveSpeed(){return this.check(qb.BonusItems,!1)}rabbitBootsChargeWhileWalking(){return this.check(qb.BonusItems,!1)}shuffleSpritePalettes(){return this.check(v.RandomizeSpriteColors)}shuffleMonsters(){return!0}shuffleShops(){return this.check(qb.Shops,!1)}bargainHunting(){return this.shuffleShops()}shuffleTowerMonsters(){return this.check(sb.TowerRobots)}shuffleMonsterElements(){return this.check(sb.RandomizeWeaknesses)}shuffleBossElements(){return this.shuffleMonsterElements()}buffMedicalHerb(){return this.check(tb.NoBuffMedicalHerb,
!1)}decreaseEnemyDamage(){return this.check(n.DecreaseEnemyDamage)}trainer(){return this.check(rb.TrainerMode)}neverDie(){return this.check(rb.NeverDie)}noShuffle(){return this.check(rb.NoShuffle)}chargeShotsOnly(){return this.check(tb.ChargeShotsOnly)}barrierRequiresCalmSea(){return!0}connectLimeTreeToLeaf(){return this.check(qb.Maps,"!")}addEastCave(){return this.check(qb.Maps,!1)}zebuStudentGivesItem(){return!this.shuffleAreas()&&!this.shuffleHouses()}fogLampNotRequired(){return this.check(r.VanillaDolphin,
!1)}storyMode(){return this.check(r.StoryMode)}noBowMode(){return this.check(r.NoBowMode)}requireHealedDolphinToRide(){return this.check(r.VanillaDolphin)}saharaRabbitsRequireTelepathy(){return!0}teleportOnThunderSword(){return this.check(r.NoThunderSwordWarp,!1,"!")}randomizeThunderTeleport(){return this.check(r.NoThunderSwordWarp,!1)}orbsOptional(){return this.check(r.OrbsNotRequired)}shuffleGoaFloors(){return this.check(v.ShuffleGoaFloors)}shuffleHouses(){return this.check(v.ShuffleHouses)}shuffleAreas(){return this.check(v.ShuffleAreas)}randomizeMaps(){return this.check(v.RandomizeMaps)}randomizeTrades(){return this.check(v.RandomizeTrades)}unidentifiedItems(){return this.check(v.UnidentifiedKeyItems)}randomizeWalls(){return this.check(v.RandomizeWallElements)}guaranteeSword(){return this.check(n.GuaranteeStartingSword)}guaranteeSwordMagic(){return this.check(ub.BattleMagic,
!1)}guaranteeMatchingSword(){return this.check(ub.MatchingSword,!1)}guaranteeGasMask(){return this.check(ub.GasMask,!1)}guaranteeBarrier(){return this.check(ub.Barrier,!1)}guaranteeRefresh(){return this.check(n.GuaranteeRefresh)}communityJokes(){return this.check(n.NoCommunityJokes,!1)}disableSwordChargeGlitch(){return this.check(t.SwordChargeGlitch,!1)}disableTeleportSkip(){return this.check(t.MtSabreRequirementSkip,!1)}disableRabbitSkip(){return this.check(t.MtSabreRequirementSkip,!1)}disableShopGlitch(){return this.check(qb.Shops,
!1)}disableStatueGlitch(){return this.check(t.StatueGlitch,!1)}disableRageSkip(){return this.check(t.RageSkip,!1)}disableTriggerGlitch(){return this.check(t.TriggerSkip,!1)}disableFlightStatueSkip(){return this.check(t.StatueGauntletSkip,!1)}assumeSwordChargeGlitch(){return this.check(t.SwordChargeGlitch)}assumeGhettoFlight(){return this.check(t.GhettoFlight)}assumeTeleportSkip(){return this.check(t.MtSabreRequirementSkip)}assumeRabbitSkip(){return this.check(t.MtSabreRequirementSkip)}assumeStatueGlitch(){return this.check(t.StatueGlitch)}assumeTriggerGlitch(){return this.check(t.TriggerSkip)}assumeFlightStatueSkip(){return this.check(t.StatueGauntletSkip)}assumeWildWarp(){return this.check(qb.WildWarp,
!0)||this.check(v.RandomizeWildWarp)}assumeRageSkip(){return this.check(t.RageSkip)}nerfWildWarp(){return this.check(qb.WildWarp,!1)&&this.check(v.RandomizeWildWarp,!1)}allowWildWarp(){return!this.nerfWildWarp()}randomizeWildWarp(){return this.check(v.RandomizeWildWarp,!0)}blackoutMode(){return this.check(tb.Blackout)}hardcoreMode(){return this.check(tb.Permadeath)}buffDyna(){return!this.check(qb.Dyna)}maxScalingInTower(){return this.check(tb.MaxScalingInTower)}expScalingFactor(){return this.check(tb.ExperienceScalesSlower)?
.25:this.check(n.ExperienceScalesFaster)?2.5:1}autoEquipBracelet(a){return"early"===a||this.check(Bb.NoAutoEquip,!1)}controllerShortcuts(a){return"early"===a||this.check(Bb.NoControllerShortcuts,!1)}randomizeMusic(a){return this.check(vb.RandomizeMusic,"early"===a?"!":!0)}shuffleTilePalettes(a){return this.check(vb.RandomizeMapColors,"early"===a?"!":!0)}noMusic(a){return"late"===a&&this.check(vb.NoMusic)}audibleWallCues(a){return"late"===a&&this.check(Bb.AudibleWallCues)}shouldColorSwordElements(){return!0}shouldUpdateHud(){return this.check(qb.Hud,
...
let h=!1;null!=g.mirrored&&(g=this.rom.metasprites[g.mirrored],h=!0);if(g&&g.used){f&=g.frameMask;for(let [k,p,q,u]of g.sprites[f]){if(128==k)break;k=128>k?k:k-256;p=128>p?p:p-256;u=u+e&255;f=d[q&3]+176&255;g=c[u>>6]<<6|u&63;h&&(k=-8-k,q^=64);this.tile(a+p,b+k,g,f<<2|q>>6)}}}text(a,b,c,d=18){for(let e=0;e<c.length;e++)this.tile(a,b+8*e,c.charCodeAt(e)|3840,d<<2)}}
...
this.addExtraChecks();this.unionNeighbors();this.recordExits();this.buildNeighbors();this.addAllRoutes();this.consolidateChecks();this.buildRequirementMap()}addExtraChecks(){const {locations:{Leaf_ToolShop:a,MezameShrine:b,Oak:c,Shyron_ToolShop:d},flags:{AbleToRideDolphin:e,BallOfFire:f,BallOfThunder:g,BallOfWater:h,BallOfWind:k,Barrier:p,BlizzardBracelet:q,BowOfMoon:u,BowOfSun:B,BreakStone:D,BreakIce:x,BreakIron:G,BrokenStatue:R,BuyHealing:U,BuyWarp:X,ClimbWaterfall:S,ClimbSlope8:Va,ClimbSlope9:va,
ClimbSlope10:Tb,CrossPain:mb,CurrentlyRidingDolphin:eb,Flight:Ra,FlameBracelet:Jb,FormBridge:wb,GasMask:fb,GlowingLamp:gb,InjuredDolphin:ac,LeadingChild:pc,LeatherBoots:qc,Money:hb,OpenedCrypt:jd,RabbitBoots:ib,Refresh:rc,RepairedStatue:Kb,RescuedChild:Nc,ShellFlute:sc,ShieldRing:Oc,ShootingStatue:tc,ShootingStatueSouth:uc,StormBracelet:kd,Sword:xb,SwordOfFire:vc,SwordOfThunder:wc,SwordOfWater:xc,SwordOfWind:bc,TornadoBracelet:ld,TravelSwamp:Pc,TriggerSkip:Lb,WildWarp:L},items:{MedicalHerb:Sa,WarpBoots:yb}}=
this.rom,sa=this.entrance(b);var jb=this.entrance(c);this.addCheck([sa],Td(u,B),[jd.id]);this.addCheck([sa],Td(e,sc),[eb.id]);this.addCheck([jb],Td(pc),[Nc.id]);this.addItemCheck([sa],Td(gb,R),Kb.id,{lossy:!0,unique:!0});for(var Ha of this.rom.shops)if(Ha.location!==a.id&&Ha.location!==d.id&&Ha.used&&Ha.type===ad.TOOL){jb=[ic(Ha.location<<16|136)];for(var Ab of Ha.contents)Ab===Sa.id?this.addCheck(jb,hb.r,[U.id]):Ab===yb.id&&this.addCheck(jb,hb.r,[X.id])}Ha=bc.r;Ab=vc.r;jb=xc.r;let yc=wc.r;if(!this.flagset.orbsOptional()){var cc=
Ud(k,ld);const a=Ud(f,Jb),b=Ud(h,q),c=Ud(g,kd);Ha=C.meet(Ha,cc);Ab=C.meet(Ab,a);jb=C.meet(jb,b);yc=C.meet(yc,c);if(this.flagset.assumeSwordChargeGlitch()){cc=function(b){return a.map(a=>a[0]===b.c?a:[b.c,...a])};const a=C.or(Ha,Ab,jb,yc);Ha=cc(bc);Ab=cc(vc);jb=cc(xc);yc=cc(wc)}}this.addCheck([sa],Ha,[D.id]);this.addCheck([sa],Ab,[x.id]);this.addCheck([sa],jb,[wb.id]);this.addCheck([sa],yc,[G.id]);this.addCheck([sa],Ud(bc,vc,xc,wc),[xb.id]);this.addCheck([sa],Ra.r,[S.id,Tb.id]);this.addCheck([sa],
Ud(Ra,ib),[Va.id]);this.addCheck([sa],Ud(Ra,ib),[va.id]);this.addCheck([sa],p.r,[tc.id,uc.id]);this.addCheck([sa],fb.r,[Pc.id]);Ha=this.flagset.changeGasMaskToHazmatSuit()?fb:qc;this.addCheck([sa],Ud(Ra,ib,Ha),[mb.id]);this.flagset.leatherBootsGiveSpeed()&&this.addCheck([sa],qc.r,[Va.id]);this.flagset.assumeGhettoFlight()&&this.addCheck([sa],Td(eb,ib),[S.id]);this.flagset.fogLampNotRequired()&&(Ha=this.flagset.requireHealedDolphinToRide(),this.addCheck([sa],Ha?ac.r:[[]],[e.id]));this.flagset.guaranteeBarrier()||
this.addCheck([sa],[[hb.c,U.c],[hb.c,Oc.c],[hb.c,rc.c]],[tc.id,uc.id]);this.flagset.assumeFlightStatueSkip()&&this.addCheck([sa],[[hb.c,Ra.c]],[tc.id]);this.flagset.guaranteeGasMask()||this.addCheck([sa],[[hb.c,U.c],[hb.c,rc.c]],[Pc.id,mb.id]);this.flagset.assumeWildWarp()&&this.addCheck([sa],C.OPEN,[L.id]);this.flagset.assumeTriggerGlitch()&&(this.addCheck([sa],C.OPEN,[Lb.id]),this.addCheck([sa],Lb.r,[mb.id,Va.id,va.id]))}addExtraRoutes(){var a;const {flags:{BuyWarp:b,SwordOfThunder:c,Teleport:d,
...
1<<c));this.seamlessExits.has(a)||(a=c^2,d=Mc.of(d,e),this.neighbors.set(d,this.neighbors.get(d)|1<<a))}processLocationTiles(a){var b,c,d,e=new Map;const f=new Set,g=88===(a.id&248);for(var h of a.spawns)if(h.isWall())e.set(nc.from(a,h),h.id&3);else if(h.isMonster()&&63===h.id){var k=ic(nc.from(a,h)<<8|h.yt<<4);for(var p=4;11>=p;p++)for(var q=-3;3>=q;q++)f.add(ic.add(k,q,p))}h=this.rom.tilesets[a.tileset];const u=this.rom.tileEffects[a.tileEffects-179],B=b=>u.effects[this.rom.screens[a.screens[(b&
61440)>>>12][(b&3840)>>>8]].tiles[b&255]];k=(b,c,d)=>{b&=Hc.BITS;26===a.id&&(b|=Hc.SWAMP);if(96===a.id||104===a.id)b|=Hc.DOLPHIN;100===a.id&&4144>(c&61680)&&(b|=Hc.DOLPHIN);d&&(b|=Hc.BARRIER);if(!(b&Hc.DOLPHIN)&&b&Hc.SLOPE){d=c;let a=0;for(;B(d)&Hc.SLOPE;)d=ic.add(d,1,0),a++;6>a?b&=~Hc.SLOPE:9>a?b|=Hc.SLOPE8:10>a&&(b|=Hc.SLOPE9)}if(b&Hc.PAIN)for(const a of[[0,1],[1,0],[0,-1],[-1,0]])if(!(B(ic.add(c,...a))&(Hc.PAIN|Hc.FLY))){b&=~Hc.PAIN;break}return this.terrainFactory.tile(b)};for(let B=0,X=a.height;B<
X;B++){p=a.screens[B];q=a.id<<8|B<<4;for(let B=0,U=a.width;B<U;B++){const U=this.rom.screens[p[B]],S=nc(q|B),X=S&255;var D=e.get(S);D=g?this.rom.flags.AlwaysTrue.id:null!=D?this.wallCapability(D):null===(b=a.flags.find(a=>a.screen===X))||void 0===b?void 0:b.flag;var x=a.pits.find(a=>a.fromScreen===S);x&&this.exits.set(ic(S<<8|136),ic(x.toScreen<<8|136));x=null!==(d=null===(c=this.rom.flags[D])||void 0===c?void 0:c.logic)&&void 0!==d?d:{};for(let b=0;240>b;b++){const c=ic(S<<8|b);var G=U.tiles[b];
x.assumeTrue&&32>G&&(G=h.alternates[G]);var R=a.isShop()?0:u.effects[G];const d=f.has(c);R=k(R,c,d);32>G&&h.alternates[G]!==G&&null!=D&&!x.assumeTrue&&!x.assumeFalse&&(G=k(u.effects[h.alternates[G]],c,d))&&(R=this.terrainFactory.flag(R,x.track?D:-1,G));R&&this.terrains.set(c,R)}}}for(const f of a.exits){const {dest:g,entrance:h}=f;b=ic.from(a,f);f.isSeamless()?(c=ic(b&65535|g<<16),d=ic.from(a,f),this.seamlessExits.add(d),(e=this.terrains.get(d))&&this.terrains.set(d,this.terrainFactory.seamless(e))):
...
p.tileset.id&&b.add(p);b.delete(169===a.id?c:d);for(var q of new Set(ca.concat(...a.screens)))for(var u of b)if(u.getMetascreens(q).length||b.delete(u),!b.size)throw Error(`No tileset for ${y(q)} in ${a}`);if(1!==b.size)throw Error(`Non-unique tileset for ${a}: [${Array.from(b,a=>a.name).join(", ")}]`);b=[...b][0]}const B=a.reachableTiles(!0);p=new Set;for(var D of B.keys())p.add(D>>>8);for(var x of a.entrances)x.used&&p.add(x.screen);for(var G of a.exits)p.add(G.screen),G.isSeamless()&&(D=G.tile>>>
4,0===D?B.set(G.screen-16<<8|136,1):14===D&&B.set(G.screen<<8|136,1));G=Array(k<<4).fill(b.empty);for(let c=0;c<k;c++)for(let d=0;d<h;d++){D=c<<4|d;var R=b.getMetascreens(a.screens[c][d]);x=void 0;if(1===R.length)x=R[0];else if(R.length){q=a.flags.find(a=>a.screen===(c<<4|d));u=[];var U=[];for(var X of R)X.data.match?u.push(X):"always"===X.flag&&766===(null===q||void 0===q?void 0:q.flag)||!X.flag&&!X.data.wall&&!q?U.unshift(X):U.push(X);if(u.length){R=function(a,b){b=(d<<8)+b;a=(c<<8)+a;return B.has(a<<
4&61440|b&3840|a&240|b>>4&15)};for(var S of u)if(S.data.match(R,null!=q)){x=S;break}}x||(x=U[0])}else throw Error("impossible");if(!x)throw Error("impossible");G[D]=x}X=new ka;let Va;for(const b of a.exits){if(255===b.dest)continue;S=b.screen;x=b.tile;!b.isSeamless()||b.yt&15||88===(a.id&88)||(S-=16,x|=240);if(!p.has(S))throw Error("impossible?");D=G[S];u=D.findExitType(x,1===k,!!(b.entrance&32));x=null===u||void 0===u?void 0:u.type;if(!x){if(ce.has(a.id<<16|S<<8|b.tile))continue;x=null===(d=D.data.exits)||
void 0===d?void 0:d.map(a=>a.type+": "+a.exits.map(y).join(", ")).join("\n  ");console.warn(`Unknown exit ${y(b.tile)}: ${D.name} in ${a} @ ${y(S)}:\n  ${x}`);continue}if(X.has(S,x))continue;q=g.locations[b.dest];if(x.startsWith("seamless")){D="seamless:down"===x;X.set(S,x,[q.id<<8|S+(0>u.exits[0]+(D?-16:16)?-16:0),D?"seamless:up":"seamless:down"]);continue}R=q.entrances[b.entrance&31];u=R.screen;U=R.coord;"door"===x&&0===(R.y&240)&&(u-=16,U+=65536);R=q.screens[u>>4][u&15];const f=c(q,R,U);if(f)X.set(S,
x,[q.id<<8|u,f]),a.entrances[0].screen===S&&(S=a.entrances[0].coord,D=D.findExitByType(x),1024>=Math.pow((D.entrance&255)-(S&255),2)+Math.pow((D.entrance>>>8)-(S>>>8),2)&&(Va=x));else{S=[];for(const a of g.metascreens.getById(R,q.tileset))for(const b of null!==(e=a.data.exits)&&void 0!==e?e:[])b.type.startsWith("seamless")||S.push(`  ${a.name} ${b.type}: ${y(b.entrance)}`);console.warn(`Bad entrance ${y(U)}: raw ${y(R)} in ${q} @ ${y(u)}\n${S.join("\n")}`)}}d=new Map;for(var va of a.pits)d.set(va.fromScreen,
va.dest<<8|va.toScreen);va=new be(a.id,b,k,h);va._screens=G;va._exits=X;va._entrance0=Va;va._pits=d;for(const b of a.flags)a=va._screens[b.screen],(null===(f=a.flag)||void 0===f?0:f.startsWith("custom"))?va.customFlags.set(b.screen,g.flags[b.flag]):a.flag||va.freeFlags.add(g.flags[b.flag]);return va}getUid(a){return this._screens[a].uid}get(a){return this._screens[a]}get width(){return this._width}set width(a){this._width=a;this._pos=void 0}get height(){return this._height}set height(a){this._height>
...
for(const a of k.allPos())e=k.get(a),e.hasFeature("river")||e.hasFeature("empty")||(g=(e.data.edges||"").split("").map(a=>" "===a?"":a),g[0]&&g[2]&&h[0].push(a),(g[1]&&g[3]||e.hasFeature("spikes"))&&h[1].push(a),e.hasFeature("spikes")&&b.set(a,[...g].filter(a=>"s"===a).length));g=[0,0];for(const f of q){const [p,q]=f;e=this.get(p).data.edges||"";c="c"===e[1]&&"c"===e[3]?1:0;e=[-1,Infinity,0];g=fe(q,g[0],g[1],k);for(const f of h[c])c=null!==(a=b.get(f))&&void 0!==a?a:0,c<e[2]||(d=ee(g,f),d<e[1]&&(e=
[f,d,c]));e=e[0];if(0>e)throw Error("no eligible dest");g=[e,g];this._pits.set(p,k.id<<8|e)}}}}transferExits(a,b){var c;const d=new ba(()=>[]),e=new ba(()=>new Set);for(var f of this.allPos()){var g=this._screens[f];for(var h of null!==(c=g.data.exits)&&void 0!==c?c:[])({type:g}=h),"edge:top"===g&&f>>>4||"edge:left"===g&&f&15||"edge:bottom"===g&&f>>>4<this.height-1||"edge:right"===g&&(f&15)<this.width-1||d.get(g).push(f)}for(var k of d.values())b.shuffle(k);for(const g of a._exits){const [p,u,B]=
g;if(!e.get(u).has(p)){f=d.get(u).pop();if(null==f)throw Error(`Could not transfer exit ${u} in ${this.rom.locations[this.id]}: no eligible screen\n${this.show()}`);h=this.rom.locations[B[0]>>>8].meta;b=B[0]&255;c=B[1];if(h===a){h=d.get(c).pop();if(null==h)throw Error("Impossible");this._exits.set(f,u,[this.id<<8|h,c]);this._exits.set(h,c,[this.id<<8|f,u]);e.get(c).add(b)}else{k=h._exits.get(b,c);if(!k)throw a=this.rom.locations[B[0]>>>8],console.log(h),Error(`No exit for ${a} at ${y(b)} ${c}\n${h.show()}\n${this.rom.locations[this.id]} at ${y(p)} ${u}\n${this.show()}`);
k[0]>>>8===this.id&&(k[0]&255)===p&&k[1]===u&&h._exits.set(b,c,[this.id<<8|f,u]);this._exits.set(f,u,B)}}}}transferSpawns(a,b){var c,d,e,f=new Map;const g=new Map,h=[],k=[],p=[],q=[];var u=[];for(var B of[this,a]){for(const a of B.allPos()){const b=B._screens[a],d=a&240,e=(a&15)<<4;if(b.hasFeature("pit")&&B===this)g.set(a,5===b.edgeIndex("c")?0:1);else if((null===(c=b.data.statues)||void 0===c?0:c.length)&&B===this)for(var D=0;D<b.data.statues.length;D++)h.push([a,b.data.statues[D]<<12|((a&15^a>>>
4^D)&1?80:160)]);if(B===this&&b.hasFeature("wall")){if(null==b.data.wall)throw Error("Missing wall prop");D=[d|b.data.wall>>4,e|b.data.wall&15];p.push(D);b.data.tilesets.lime&&p.push([D[0]-1,D[1]])}else if(B===this&&b.hasFeature("bridge")){if(null==b.data.wall)throw Error("Missing wall prop");q.push([d|b.data.wall>>4,e|b.data.wall&15])}if(b.hasFeature("arena"))if(B===this)u.push([d|8,e|8]);else{const [a,b]=u.pop();k.push([d|8,e|8,a,b,144,"arena"])}}B===this&&(b.shuffle(u),b.shuffle(h))}for(const b of[this,
a])for(const e of b._exits){const [g,h,p]=e;c=b._screens[g];a=null===(d=c.data.exits)||void 0===d?void 0:d.find(a=>a.type===h);if(!a)throw Error(`Invalid exit: ${c.name} ${h}`);c=g&15;u=g>>>4;B=a.exits[0]&15;a=a.exits[0]>>>4;if(b===this)f.set(p,[u<<4|a,c<<4|B]);else if(p[0]>>>8!==this.id){const [b,d]=f.get(p);k.push([u<<4|a,c<<4|B,b,d,25,"exit"])}}d=[[],[],[],[],[],[]];for(var x of this.allPos()){f=this._screens[x];for(var G of null!==(e=f.data.poi)&&void 0!==e?e:[]){const [a,b=112,c=120]=G;d[a].push([((x&
...
c]=a;if(c===this._entrance0){a=this._screens[b].findExitByType(c);this.rom.locations[this.id].entrances[0]=Vd.of({screen:b,coord:a.entrance});break}}}write(){var a,b,c,d,e,f,g,h,k,p,q,u;const B=this.rom.locations[this.id],D=new Set;for(var x of this._exits){const [c,d,[e,f]]=x;{var G=this._screens[c],R=e>>8,U=e&255;const g=this.rom.locations[R],h=g.meta._screens[e&255],k=null===(a=G.data.exits)||void 0===a?void 0:a.find(a=>a.type===d);var X=null===(b=h.data.exits)||void 0===b?void 0:b.find(a=>a.type===
f);if(!k||!X)throw Error(`Missing ${k?"dest":"source"} exit:
  From: ${B} @ ${y(c)}:${d} ${G.name}
  To:   ${g} @ ${y(U)}:${f} ${h.name}`);G=32;X.type.startsWith("seamless")?D.add(c):(X=X.entrance,61439<X&&(U+=16,X-=65536),G=g.findOrAddEntrance(U,X));for(let a of k.exits)U=c,240===(a&240)&&(U+=16,a&=15),B.exits.push(Wd.of({screen:U,tile:a,dest:R,entrance:G}))}}B.width=this._width;B.height=this._height;B.screens=[];for(a=0;a<this._height;a++)for(b=[],B.screens.push(b),x=0;x<this._width;x++)b.push(this._screens[a<<4|x].sid);B.tileset=this.tileset.tilesetId;B.tileEffects=this.tileset.effects().id;
a=new hd;for(const g of this.allPos())D.has(g)||(b=this._screens[g],x=g+16,R=g+1,D.has(x)||" "===(null!==(d=null===(c=b.data.edges)||void 0===c?void 0:c[2])&&void 0!==d?d:" ")||a.union([g,x]),D.has(R)||" "===(null!==(f=null===(e=b.data.edges)||void 0===e?void 0:e[3])&&void 0!==f?f:" ")||a.union([g,R]),a.union([g]));d=a.map();c=new Set;for(var S of this._exits){[e]=S;for(const a of null!==(g=d.get(e))&&void 0!==g?g:[])c.add(a)}B.flags=[];g=[...this.freeFlags];for(const a of this.allPos()){S=this._screens[a];
let b;null!=S.data.wall&&c.has(a)?b=null!==(k=null===(h=g.pop())||void 0===h?void 0:h.id)&&void 0!==k?k:this.rom.flags.alloc(512):"always"===S.flag?b=this.rom.flags.AlwaysTrue.id:"calm"===S.flag?b=this.rom.flags.CalmedAngrySea.id:"custom:false"===S.flag?b=null===(p=this.customFlags.get(a))||void 0===p?void 0:p.id:"custom:true"===S.flag&&(b=null!==(u=null===(q=this.customFlags.get(a))||void 0===q?void 0:q.id)&&void 0!==u?u:this.rom.flags.AlwaysTrue.id);null!=b&&B.flags.push(Xd.of({screen:a,flag:b}))}B.pits=
[];for(const a of this._pits){const [b,c]=a;B.pits.push(Yd.of({fromScreen:b,toScreen:c&255,dest:c>>>8}))}}replaceMonsters(a){if(104!==this.id){var b=this.rom.locations[this.id];a=b.monsterPlacer(a);for(const c of b.spawns){if(!c.used)continue;if(!c.isMonster())continue;const d=b.rom.objects[c.monsterId];if(!(d instanceof F))continue;const e=a(d);null==e?(console.error(`no valid location for ${y(d.id)} ${d.name} in ${b}`),c.used=!1):d.isBird()?(c.y=4048,c.x=2032,c.timed=!0):(c.screen=e>>>8,c.tile=
...
d.messageName="Hazmat Suit"));for(d=5;12>d;d+=2)a.items[d].menuName=a.items[d].menuName.replace("Ball","Orb"),a.items[d].messageName=a.items[d].messageName.replace("Ball","Orb");{const {items:{AlarmFlute:c},flags:{TalkedToZebuStudent:g,ZebuStudent:h},locations:{MezameShrine:u,Leaf_StudentHouse:B,WaterfallCave4:D,ZebuCave:x},npcs:{WindmillGuard:G,Zebu:R}}=a;a.itemGets[49].inventoryRowStart=32;c.unique=!0;c.basePrice=0;b.zebuStudentGivesItem()?G.data[1]=49:(G.data[1]=255,d=G.dialog(B)[0],d.condition=
~g.id,d.flags.push(g.id),jf(R.spawns(x),h.id,g.id),u.spawns.push(Zd.of({screen:0,tile:155,type:2,id:49})),u.spawns.push(Zd.of({screen:0,tile:149,type:2,id:73})),a.itemGets[73].itemId=a.items.MedicalHerb.id);d=[[33,.72],[31,.9]];e=0;for(var f of a.shops)if(f.type===ad.TOOL)for(let b=0,c=f.contents.length;b<c;b++){if(49!==f.contents[b])continue;const [c,g]=d[e++%d.length];f.contents[b]=c;a.shopDataTablesAddress&&(f.prices[b]=Math.round(f.prices[b]*g))}a.itemGets[91].itemId=29;D.spawn(25).id=16}{const {flags:{Karmine:b,
...
if(b.fogLampNotRequired()){{const {flags:{AlwaysTrue:c,InjuredDolphin:d,FogLamp:e,KensuInCabin:g,ReturnedFogLamp:h},items:{ShellFlute:D},locations:{BoatHouse:x,Portoa_FishermanHouse:G},npcs:R}=a;f=b.requireHealedDolphinToRide();D.itemUseData[0].want=f?d.id:c.id;R.KensuInCabin.data[0]=103;R.KensuInCabin.localDialogs.get(-1)[0].message.action=10;R.KensuInCabin.localDialogs.get(-1)[0].flags=[];R.KensuInCabin.spawnConditions.set(x.id,[h.id,~g.id]);R.Fisherman.spawnConditions.set(G.id,[e.id]);a.itemGets[100].flags=
...
134===b.id&&1856===b.x&&(b.x+=16,b.y+=16);b.disableFlightStatueSkip()&&(g=a.hitboxes[a.objects.guardianStatueMissile.hitbox],h=a.hitboxes[6],a.objects.guardianStatueMissile.hitbox=h.id,h.x0=g.x0-6,h.w=g.w+12,h.y0=g.y0-2,h.h=g.h+4);kf(a,b);for(const b in[4,5,8,9])a.tileEffects[9].effects[b]=24,a.tileEffects[2].effects[b]=24;if(b.chargeShotsOnly()){for(const b of[8,9,39])a.objects[b].collisionPlane=0;a.npcs.Brokahana.data[0]=a.items.FruitOfLime.id}if(b.orbsOptional())for(const b of[16,20,24,29])a.objects[b].terrainSusceptibility&=
-5,a.objects[b].level=2;if(b.noBowMode()){{const {flags:{UsedBowOfTruth:b},locations:{Crypt_Draygon2:c,MezameShrine:d}}=a;let e;for(const b of d.spawns)b.isTrigger()&&136===b.tile&&(e=a.trigger(b.id));if(!e)throw Error("Could not find start trigger");e.flags.push(b.id);a.tileEffects[6].effects[88]=0;d.meta.setExit(0,"door",[c.meta.id<<8|16,"edge:bottom"])}}a.messages.parts[32][15].text+="\nItem: [:ITEM:]";if(b.hardcoreMode())for(const b of a.locations)b.checkpoint=b.saveable=!1;b.shouldUpdateHud()&&
(a.patterns.set(3584,0,af.HUD_LF),a.patterns.set(3584,1,af.HUD_PW),a.patterns.set(3584,2,af.HUD_EY),a.patterns.set(3584,3,af.HUD_LV),a.patterns.set(3584,4,af.HUD_DL),a.patterns.set(3584,5,af.HUD_MP),a.patterns.set(3584,6,af.HUD_EX),a.patterns.set(3584,26,af.HUD_CLOSE_LEFT),a.patterns.set(3584,27,af.HUD_CLOSE_RIGHT),a.writeMonsterNames=!0);b.shouldColorSwordElements()&&lf(a)}
function lf(a){function b(b,d){for(let c=0;10>=c;c++){if(8===c)continue;const e=a.patterns.get(c|b),g=[...e.pixels];for(let a=0;a<e.pixels.length;a++)e.pixels[a]=g[a^8],a>>>3===d&&(e.pixels[a]|=g[a])}}b(4240);b(4304);b(4368);b(4432);b(4496)}function gf(a){const b=new Set([129,139,144,153,166,167,168,169,170,171,172,a.allocatedTriggers.get("zombie warp")]);for(const c of a.locations)c.used&&(c.spawns=c.spawns.filter(a=>!a.isTrigger()||!b.has(a.id)))}
...
function hf(a,b){function c(a,b){const c=a.indexOf(b);if(0>c)throw Error(`Could not find element ${b} in ${a}`);a.splice(c,1)}function d(a){a.reverse();for(let b=0;b<a.length;b++){const c=a[b+1];a[b].condition=c?~c.condition:-1}}const {locations:{BoatHouse:e,Brynmaer:f,Crypt_Draygon2:g,Joel_Shed:h,Leaf_ElderHouse:k,MtSabreNorth_SummitCave:p,MtSabreWest_Upper:q,PortoaPalace_ThroneRoom:u,Portoa_PalaceEntrance:B,Portoa_AsinaRoom:D,Portoa_FortuneTeller:x,Shyron_Temple:G,StomHouse:R,Swan_DanceHall:U,Swan_Tavern:X,
WindmillCave:S,WaterfallCave4:Va,WaterfallValleyNorth:va,ZebuCave:Tb,ZombieTown_HouseBasement:mb},items:{GlowingLamp:eb,KeyToPrison:Ra,LovePendant:Jb,StatueOfOnyx:wb},npcs:{Akahana:fb,AkahanaInBrynmaer:gb,Asina:ac,AztecaInShyron:pc,Clark:qc,Draygon:hb,FortuneTeller:jd,Kensu:ib,KensuInCabin:rc,KensuInSwan:Kb,LeafElder:Nc,LeafRabbit:sc,OakChild:Oc,OakElder:tc,OakMother:uc,PortoaPalaceFrontGuard:kd,PortoaQueen:xb,PortoaThroneRoomBackDoorGuard:vc,Rage:wc,Stom:xc,StonedAkahana:bc,Tornel:ld,WindmillGuard:Pc,
Zebu:Lb},flags:L}=a;ib.localDialogs.delete(X.id);Kb.link(ib.id);Kb.used=!0;Kb.data=[...ib.data];ib.data[0]=eb.id;U.spawns.find(a=>a.isNpc()&&a.id===ib.id).id=Kb.id;Jb.itemUseData[0].want=256|Kb.id;bc.linkDialog(fb.id);gb.used=!0;gb.link(fb.id);gb.data=[...fb.data];f.spawns.find(a=>a.isNpc()&&a.id===fb.id).id=gb.id;wb.itemUseData[0].want=256|gb.id;Nc.dialog(k).splice(0,0,...Nc.dialog(k).splice(2,1));sc.dialog()[2].condition=L.RescuedLeafElder.id;sc.dialog()[2].flags.push(L.TalkedToLeafRabbit.id);sc.dialog()[3].flags.push(L.TalkedToLeafRabbit.id);
Pc.spawns(S)[1]=~L.WindmillGuardAlarmFluteTradein.id;c(fb.spawns(Va),~L.BehindWhirlpool.id);c(bc.spawns(Va),~L.BehindWhirlpool.id);for(var Sa=0;4>Sa;Sa++){var yb=tc.dialog()[Sa];yb.condition!==a.flags.OakElder.id&&(yb.message.action=3)}(()=>{const [a,b,c,d]=uc.dialog();d.condition=~L.RescuedChild.id;b.condition=-1;uc.dialog().splice(0,4,d,c,a,b)})();for(const b of[32,33,34,124,125])d(a.npcs[b].dialog());Oc.dialog().unshift(...Oc.dialog().splice(1,1));vc.spawnConditions.set(u.id,[~L.QueenNotInThroneRoom.id,
~L.MesiaRecording.id]);kd.dialog()[1].condition=L.MesiaRecording.id;xb.dialog()[3].condition=L.SwordOfWater.id;xb.dialog()[3].message.action=3;xb.dialog()[4].flags.push(L.PortoaQueenGoingAway.id);xb.spawns(u)[1]=~L.MesiaRecording.id;xb.spawns(D)[0]=L.MesiaRecording.id;xb.dialog()[1].condition=L.MesiaRecording.id;jd.spawns(x)[1]=~L.MesiaRecording.id;qc.spawnConditions.set(mb.id,[~L.Clark.id]);qc.spawnConditions.set(h.id,[L.Clark.id]);Lb.localDialogs.set(Tb.id,[Re.of(~L.TalkedToZebuInCave.id,[0,26],
[L.TalkedToZebuInCave.id]),Re.of(L.LeafVillagersRescued.id,[0,29]),Re.of(L.LeafAbduction.id,[0,28]),Re.of(L.ZebuAtWindmill.id,[0,29]),Re.of(L.UsedWindmillKey.id,[0,27,3]),Re.of(-1,[0,29])]);c(Lb.spawns(Tb),~L.BehindWhirlpool.id);ld.spawnConditions.delete(q.id);xc.spawnConditions.delete(R.id);c(ac.spawns(D),~L.CalmedAngrySea.id);Sa=a.npcs[52];Sa.spawnConditions.set(u.id,[L.MesiaRecording.id,~L.PortoaQueen.id]);Sa.localDialogs.set(B.id,Sa.localDialogs.get(-1));Sa.data[0]=a.items.FluteOfLime.id;yb=a.messages.alloc();
yb.text="The queen left this for you.";Sa.localDialogs.set(u.id,[Re.of(~L.PortoaQueen.id,[yb.part,yb.id,3]),Re.of(-1,[10,14])]);u.spawns.push(Zd.of({yt:3,xt:12,type:1,patternBank:1,id:Sa.id}));rc.spawnConditions.set(e.id,[~L.AbleToRideDolphin.id,L.ReturnedFogLamp.id]);rc.dialog()[0].message.action=2;pc.spawns(G).push(~L.ShyronMassacre.id);a.trigger(130).conditions.push(~L.ShyronMassacre.id);wc.dialog()[0].condition=L.SwordOfWater.id;hb.spawnConditions.set(g.id,[~L.Draygon2.id]);Lb.dialog(G).unshift(...Lb.dialog(G).splice(1,
1));a.trigger(128).conditions=[~L.ShyronMassacre.id,L.TalkedToZebuInShyron.id,L.SwordOfThunder.id];a.trigger(129).conditions=[];b.barrierRequiresCalmSea()&&a.trigger(132).conditions.push(L.CalmedAngrySea.id);a.trigger(140).conditions.push(L.TalkedToZebuInCave.id);a.trigger(141).used=!1;for(const a of p.spawns)a.isTrigger()&&141===a.id&&(a.id=178);(function(a,b){b=a.findIndex(b);if(0>b)throw Error(`Could not find element in ${a}`);a.splice(b,1)})(va.spawns,a=>a.isTrigger()&&141===a.id);a.trigger(178).conditions.push(L.Kelbesque1.id);
a.trigger(178).flags.push(~L.LeafVillagersCurrentlyAbducted.id,~L.LeafElderCurrentlyAbducted.id,L.LeafVillagersRescued.id);a.trigger(140).conditions.push(~L.Kelbesque1.id);a.trigger(134).conditions.push(~L.Kelbesque1.id);c(Ra.itemUseData[0].flags,~L.LeafVillagersCurrentlyAbducted.id);jf(a.trigger(187).conditions,~L.Rage.id,~L.MesiaRecording.id)}function jf(a,b,c){for(let d=0;d<a.length;d++)if(a[d]===b){a[d]=c;return}throw Error(`Could not find ${b} in ${a.join(",")}`);};const {$0e:mf,$0f:nf,$10:of,$1a:pf}=z,qf=A.of(mf,33689),rf=A.of(mf,39906),sf=A.of(of,36848),tf=A.of(of,36923),uf=A.of(of,36998),vf=A.of(pf,35776),wf=A.of(pf,35785),xf=[["Sword","\n\x0B\f"],[" of ","\\]"],["Bracelet","<=>["],["Shield","\r\u000e\u000f"],["Armor","{\u0011\u0012"],["Magic","#%("],["Power","\u0013\u0014\u0015"],["Item","\u0016\u0017^"]];
...
var c=xf.reduce((a,[b,c])=>a.replace(b,c),this.menuName);a.segment(of);a.reloc(`ItemMenuName_${y(this.id)}`);const d=a.pc();a.byte(c,255);this.menuNamePointer.loc(a,`ItemMenuName_${b}`);a.word(d);if(this.itemUseJump){this.itemUseJumpPointer.loc(a,`ItemUseJump_${b}_Ptr`);a.word(this.itemUseJump.org);c=[];for(var e of this.itemUseData)c.push(...e.bytes());a.segment(mf.name,nf.name);a.reloc(`ItemUseData_${b}`);e=a.pc();a.byte(...c);this.itemUseDataPointer.loc(a,`ItemUseData_${b}_Ptr`);a.word(e)}this.valueAddr&&
...
"p","mado shuriken",,,,36,,,],[253,"p","guardian statue missile",,,,23,,,],[254,"p","demon wall fire",,,,23,,,]].map(([a,b,c,d=0,e=0,f=0,g=0,h=0,k=0])=>[a,{id:a,type:b,name:c,sdef:d,swrd:e,hits:f,satk:g,dgld:h,sexp:k}]));new Map([["stair:up","C"],["edge:top","N"],["edge:left","W"],["edge:right","E"],["cave","C"],["door","C"],["door2","C"],["door3","C"],["fortress","F"]]);new Map([["N","S"],["S","N"],["E","W"],["W","E"],["C","X"],["X","C"],["F","O"],["O","F"]]);new Map([["pawn",54],["inn",55],["armor",56],["tool",57],["tavern",59]]);const Df=new Set(["inn","armor","tool","pawn"]);new Set([...Df,"house","tavern"]);new Set([182]);new Set([89,92,110,111,129,138,163,196]);new Set([85,93,124,188,193]);function Ef(a,b){if(b.eastCave){{b=b.eastCave;const {locations:{EastCave1:d,EastCave2:e,EastCave3:f,SealedCave1:g,ValleyOfWind:h},metascreens:{boundaryE_cave:k,branchNSE:p,branchNWE:q,branchNWSE:u,branchNWS:B,branchWSE:D,caveEmpty:x,deadEndE:G,deadEndE_downStair:R,deadEndE_upStair:U,deadEndN_stairs:X,deadEndS:S,deadEndS_stairs:Va,deadEndW:va,deadEndW_downStair:Tb,hallNE:mb,hallNS:eb,hallNW:Ra,hallSE:Jb,hallWS:wb,hallWE:fb,hallNS_entrance:gb,hallNS_ramp:ac,hallNS_wall:pc}}=a;a.locations.allocate(d);
a.locations.allocate(e);b.exit2&&a.locations.allocate(f);for(var c of[d,e,f])c.bgm=c.originalBgm=23,c.entrances=[],c.exits=[],c.pits=[],c.spawns=[],c.flags=[],c.width=c.height=1,c.screens=[[128]],c.tilePalettes=[26,27,5],c.originalTilePalettes=[26,27,5],c.tileset=136,c.tileEffects=181,c.tilePatterns=[20,2],c.spritePatterns=[...g.spritePatterns],c.spritePalettes=[...g.spritePalettes];d.meta=new be(d.id,a.metatilesets.cave,5,5);d.meta.set2d(0,[[G,wb,x,Jb,va],[x,eb,Jb,Ra,x],[Jb,u,B,x,x],[eb,ac,mb,fb,
wb],[gb,mb,va,U,Ra]]);e.meta=new be(e.id,a.metatilesets.cave,5,5);e.meta.set2d(0,[[G,wb,S,x,S],[x,eb,eb,x,eb],[x,p,q,D,Ra],[x,ac,x,mb,wb],[G,Ra,x,x,X]]);h.meta.set2d(51,[[k]]);a.tileEffects[0].effects[192]=0;d.meta.attach(67,e.meta,68);d.meta.attach(64,h.meta,51);b.exit1&&(d.meta.set2d(4,[[Tb]]),Ff(d,4,b.exit1));b.exit2&&(f.meta=new be(f.id,a.metatilesets.cave,3,1),f.meta.set2d(0,[[Va],[pc],[gb]]),f.spawns.push(Zd.from([24,7,35,0])),f.flags.push(Xd.of({screen:16,flag:a.flags.alloc(512)})),e.meta.set2d(64,
[[R]]),e.meta.attach(64,f.meta,0),Ff(f,32,b.exit2));d.spawns.push(Zd.of({screen:33,tile:135,timed:!0,id:2}),Zd.of({screen:18,tile:136,timed:!1,id:2}),Zd.of({screen:19,tile:137,timed:!0,id:2}),Zd.of({screen:50,tile:104,timed:!1,id:2}),Zd.of({screen:65,tile:136,timed:!0,id:2}),Zd.of({screen:51,tile:152,timed:!0,id:2}),Zd.of({screen:3,tile:136,timed:!0,id:2}));e.spawns.push(Zd.of({screen:1,tile:136,timed:!0,id:2}),Zd.of({screen:17,tile:72,timed:!1,id:2}),Zd.of({screen:18,tile:119,timed:!0,id:2}),Zd.of({screen:20,
...
function Ff(a,b,c){const {locations:{CordelPlainEast:d,CordelPlainWest:e,Desert2:f,GoaValley:g,LimeTreeValley:h},metascreens:{bendNE:k,bendSE:p,boundaryN_trees:q,boundaryW_cave:u,cornerNE:B,cornerNW:D,cornerSE:x,cornerSE_cave:G,cornerSW:R}}=a.rom;let U,X;switch(c){case "lime":U=h;X=16;U.resizeScreens(0,1,0,0);U.meta.spliceColumns(0,1,2,[[D,q],[u,p],[R,x]]);break;case "cordel":c=[[u,p],[R,x]];U=d;X=85;U.meta.set2d(85,c);e.meta.set2d(85,c);break;case "goa":U=g;X=17;U.meta.set2d(1,[[D,B],[u,k]]);break;
case "desert":U=f,X=83,U.meta.set2d(83,[[G]])}a.meta.attach(b,U.meta,X)}
...
sg.get(f);h&&(b.push(h[0]),b.push(d.toString(16).padStart(2,"0")),b.push(":"));b.push(e(d,f));h&&b.push(h[1]);vg[String.fromCharCode(a[c+1])]||b.push(" ")}else if(128<=f)b.push(e(f,0)),vg[String.fromCharCode(a[c+1])]||b.push(" ");else if(32<=f)b.push(String.fromCharCode(f));else throw Error(`Non-exhaustive switch: ${f} at ${c.toString(16)}`);}this.text=b.join("")}get mid(){return`${y(this.part)}:${y(this.id)}`}fixText(){function a(a,b=a.length){28<f+b&&c();" "===a?(d.push(...h," "),h=[]):/^[[{]:/.test(a)?
h.push({toString:()=>a,length:b}):h.push(a);f+=b;g=a.endsWith(" ")}function b(b){b=b.split(/\s+/);for(let c=0;c<b.length;c++)c&&(g||a(" "),g=!0),a(b[c])}function c(){f=1+h.reduce((a,b)=>a+b.length,0);2<++e?(d.push("#\n "),e=0):d.push("\n ");g=!0}if(!this.checkText()){var d=[],e=0,f=0,g=!1,h=[],k=new Map;for(var p=0;p<this.text.length;p++){var q=this.text[p],u=this.text[p+1];/[\s\n#]/.test(q)?(g||a(" "),g=!0):"{"===q?(":"===u?a("{:HERO:}",6):(q=this.text.indexOf(":",p),q=Number.parseInt(this.text.substring(p+
1,q),16),u=this.messages.extraWords[6][q],k.set(u,`{${q.toString(16)}:${u}}`),b(u)),p=this.text.indexOf("}",p)):"["===q?(":"===u?a("[:ITEM:]",Math.max(...this.messages.rom.items.map(a=>a.messageName.length))):(q=this.text.indexOf(":",p),q=Number.parseInt(this.text.substring(p+1,q),16),u=this.messages.rom.items[q].messageName,k.set(u,`[${q.toString(16)}:${u}]`),b(u)),p=this.text.indexOf("]",p)):a(q)}d.push(...h);p=d.join("");for(const [a,b]of k)p.includes(a)&&(p=p.split(a).join(b));this.text=p}}checkText(){let a=
...
fc(b,og,34182,34195);fc(b,og,35072,37888);fc(b,og,38533,38662);fc(b,og,40576,40960);fc(b,pg,40960,49152);fc(b,qg,40960,49152);fc(b,rg,40960,48128);b.assign("LevelDownMessagePart",1);b.assign("LevelDownMessageId",2);b.export("LevelDownMessagePart","LevelDownMessageId");var c=w(this.partCount,()=>[]);for(var d=0;d<this.partCount;d++){var e=c[d];const a=this.parts[d];b.segment(Fg[this.banks[d]].name);for(const c of a)b.reloc(`Message_${c.mid}`),e.push(b.pc()),b.byte(...c.bytes,0)}d=[];b.segment(og.name);
b.reloc("MessagesTable");for(e=0;e<this.partCount;e++)d.push(b.pc()),b.word(...c[e]);c=b.pc();b.byte(...this.banks);b.reloc("MessageParts");e=b.pc();b.word(...d);a(Cg,c);a(Dg,c);a(Eg,e,5);c=[["CommonWords",this.commonWords,[xg]],["UncommonWords",this.uncommonWords,[yg]],["PersonNames",this.personNames,[zg]],["ItemNames",this.itemNames,[Ag,Bg]]];for(const [e,g,h]of c){c=[];d=0;for(const a of g)a?(b.reloc(`${e}_${y(d++)}`),c.push(b.pc()),b.byte(a,0)):c.push(0);b.reloc(e);d=b.pc();b.word(...c);for(const b of h)a(b,
d,5)}return[b.module()]}}ug.CONTINUED="#";const wg={"{":"}","[":"]"},Gg=new Set("20:1d 1b:0f 1b:10 1b:11 1b:12 1b:05 1b:06 1b:07 1f:00 13:00 0b:01 20:0c 20:0f 1c:11 0e:05 16:00 16:02 16:04 16:06 20:11 21:00 21:02 21:01 06:00 18:00 18:02 18:04 18:08 1b:03 1b:00 1b:00 1b:04 06:01 10:13 19:05 20:14 20:15 20:17 20:02 20:0d 20:19 20:1a 20:1b 03:01 03:02 10:10 10:11 10:12 0c:04 0c:05 03:03 20:0e 20:13 01:02".split(" "));const Hg={empty:1,pit:2,arena:4,spikes:8,wide:16,river:32,bridge:64,wall:128,ramp:256,overpass:512,underpass:1024,whirlpool:2048,deadend:4096,"stair:up":65536,"stair:down":131072,portoa1:117440512,portoa2:184549376,portoa3:218103808,lake:234881024,lighthouse:318767104,cabin:352321536,windmill:369098752,altar:419430400,pyramid:436207616,crypt:469762048,manual:1073741824,consolidate:2147483648};
...
const Xg={"edge:top":0,"edge:left":1,"edge:bottom":2,"edge:right":3},Tg=["|:","|:=-","|","|="],Ug=new Set(["|",":","-","="]),Yg=new Set("arena portoa1 portoa2 portoa3 lake overpass underpass lighthouse cabin windmill altar pyramid crypt".split(" ")),Zg=new Set("pit spikes bridge wall ramp whirlpool".split(" ")),Vg=[...Yg].map(a=>Hg[a]).reduce((a,b)=>a|b),Wg=[...Zg].map(a=>Hg[a]).reduce((a,b)=>a|b);class $g{constructor(a){this.rom=a;this.length=0;this.screensByFix=new ba(()=>[]);this.screensById=new ba(()=>[]);this.registeredFixes=new Set;this.overworldEmpty=this.metascreen({id:0,icon:V`
      ...
      |\u2588\u258c |
      |\u2588\u258c^|
      |\u2588\u258c |`,tile:" oo| oo| oo",tilesets:{grass:{},river:{},desert:{requires:[H.DesertRocks]},sea:{requires:[H.SeaTrees]}},edges:"> >o"});this.boundaryW=this.metascreen({id:2,icon:V`
      |\u2588\u258c |
      |\u2588\u258c |
      |\u2588\u258c |`,tile:" oo| oo| oo",tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"> >o"});this.boundaryE_rocks=this.metascreen({id:3,icon:V`
      |.\u2590\u2588|
      | \u2590\u2588|
      |.\u2590\u2588|`,tile:"oo |oo |oo ",tilesets:{grass:{},river:{},desert:{requires:[H.DesertRocks]},sea:{requires:[H.SeaRocks]}},edges:"<o< "});this.boundaryE=this.metascreen({id:4,icon:V`
      | \u2590\u2588|
      | \u2590\u2588|
      | \u2590\u2588|`,tile:"oo |oo |oo ",tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"<o< "});this.longGrassS=this.metascreen({id:5,icon:V`
      |vv |
      | vv|
      |   |`,tile:"olo|ooo|   ",tilesets:{river:{},grass:{requires:[H.GrassLongGrass]}},edges:"looo"});this.longGrassN=this.metascreen({id:6,icon:V`
      |   |
      | vv|
      |vv |`,tile:"   |ooo|olo",tilesets:{river:{},grass:{requires:[H.GrassLongGrass]}},edges:"oolo"});this.boundaryS_rocks=this.metascreen({id:7,icon:V`
      | . |
      |\u2584\u2584\u2584|
      |\u2588\u2588\u2588|`,tile:"ooo|ooo|   ",tilesets:{grass:{},river:{},desert:{requires:[H.DesertRocks]},sea:{requires:[H.SeaRocks]}},edges:"o^ ^"});this.fortressTownEntrance=this.metascreen({id:8,icon:V`
      |\u2588\u2588\u2588|
      |\u2588\u2229\u2588|
      ...
      |\u2588\u2229\u2588|
      |  \u2588|
      |\u2588\u2588\u2588|`,tile:["   |o< |   ","   |x< |   "],tilesets:{grass:{},river:{},desert:{},sea:{requires:[H.SeaCaveEntrance]}},edges:" n  ",exits:[Lg(72),Og({top:6})]});this.bendNE_grassRocks=this.metascreen({id:11,icon:V`\u259d
      |.\u2590\u2588|
      |  \u2580|
      |;;;|`,tile:"oo |ooo|ogo",tilesets:{grass:{},river:{requires:[H.RiverShortGrass]},desert:{requires:[H.DesertShortGrass,H.DesertRocks]}},edges:"<osv"});this.cornerNW=this.metascreen({id:12,icon:V`\u259b
      |\u2588\u2588\u2588|
      |\u2588 \u2580|
      ...
      | \u2590\u2588|
      |   |
      | \u2590\u2588|`,tile:["oo |ooo|oo ","oo |oox|oo "],tilesets:{grass:{},river:{},desert:{requires:[H.DesertRocks]}},edges:"<o<n",exits:[Pg({top:6})]});this.boundaryN_trees=this.metascreen({id:17,icon:V`
      |\u2588\u2588\u2588|
      |\u2580\u2580\u2580|
      | ^ |`,tile:"   |ooo|ooo",tilesets:{grass:{},river:{},desert:{},sea:{requires:[H.SeaTrees]}},edges:" vov"});this.bridgeToPortoa=this.metascreen({id:18,icon:V`\u2574
      |\u2550  |
      |\u255e\u2550\u2550|
      ...
      |\u2588\u258c |
      |\u2588\u2229 |
      |\u2588\u258c |`,tile:" oo| <o| oo",tilesets:{grass:{},river:{},desert:{},sea:{requires:[H.SeaCaveEntrance]}},edges:"> >o",exits:[Lg(137)]});this.exitN=this.metascreen({id:22,icon:V`\u2575
      |\u2588 \u2588|
      |\u2580 \u2580|
      ...
      | \u2590\u2588|
      |v\u2229\u2588|
      |v\u2590\u2588|`,tile:"oo |o< |oo ",tilesets:{river:{},grass:{requires:[H.GrassLongGrass]},desert:{requires:[H.DesertLongGrass]}},edges:"<o< ",exits:[Lg(88)]});this.exitW_southwest=this.metascreen({id:26,icon:V`\u2574
      |\u2588\u258c |
      |\u2580 \u2584|
      |\u2584\u2588\u2588|`,tile:" oo|Boo|   ",tilesets:{grass:{},river:{},desert:{requires:[H.DesertRocks]},sea:{requires:[H.SeaRocks]}},edges:">* ^",exits:[Og({top:11})]});this.nadare=this.metascreen({id:27,tilesets:{house:{}},exits:[Ng(),W(35),W(37,"door2"),W(42,"door3")]});this.townExitW=this.metascreen({id:28,icon:V`\u2574
      |\u2588\u258c |
      |\u2580 ^|
      ...
      |;;;|
      | v |
      |   |`,tile:"ogo|ooo|ooo",tilesets:{grass:{},river:{requires:[H.RiverShortGrass,H.GrassLongGrassRemapping]}},edges:"sooo"});this.townExitS=this.metascreen({id:30,icon:V`\u2577
      | ^ |
      |\u2584 \u2584|
      |\u2588 \u2588|`,tile:["ooo|ooo| o ","ooo|ooo| x "],tilesets:{grass:{},river:{},desert:{requires:[H.DesertRocks,H.DesertTownEntrance]}},edges:"o^n^",exits:[Mg()]});this.swanGate=this.metascreen({id:31,tilesets:{town:{}},exits:[Og({top:3}),Pg({top:9})],flag:"custom:false"});this.riverBranchNSE=this.metascreen({id:32,icon:V`
      | \u2551 |
      | \u2560\u2550|
      ...
      |\u2588\u258c |
      |\u2580 ^|
      | ^^|`,tile:" oo|ooo|ooo",tilesets:{grass:{},river:{},desert:{requires:[H.DesertRocks,H.DesertTrees]},sea:{requires:[H.SeaRocks,H.SeaTrees]}},edges:">voo"});this.shortGrassSW=this.metascreen({id:39,icon:V`
      |;;;|
      |  ;|
      |^ ;|`,tile:"ogo|oog|ooo",tilesets:{grass:{},river:{requires:[H.RiverShortGrass]}},edges:"soos"});this.riverBranchNWS=this.metascreen({id:40,icon:V`
      | \u2551 |
      |\u2550\u2563 |
      | \u2551 |`,tile:"oro|rro|oro",tilesets:{river:{}},edges:"rrro"});this.shortGrassNW=this.metascreen({id:41,icon:V`
      |  ;|
      | v;|
      |;;;|`,tile:"ooo|oog|ogo",tilesets:{grass:{},river:{requires:[H.RiverShortGrass,H.GrassLongGrassRemapping]}},edges:"ooss"});this.valleyBridge=this.metascreen({id:42,icon:V` |
      |\u259b\u2551\u259c|
      | \u2551 |
      ...
      |\u2588\u2229\u2588|
      |\u258c \u2590|
      |\u2588 \u2588|`,tile:["   | < | o ","   | < | x "],tilesets:{grass:{},river:{},desert:{},sea:{requires:[H.SeaCaveEntrance]}},edges:"  n ",exits:[Lg(103),Mg()]});this.outsideWindmill=this.metascreen({id:44,icon:V`\u2573
      |\u2588\u2588\u2573|
      |\u2588\u2229\u2588|
      ...
      | ^ |
      |^ ^|
      | ^ |`,tile:"ooo|ooo|ooo",tilesets:{grass:{},river:{},desert:{requires:[H.DesertTrees,H.DesertRocks]}},edges:"oooo"});this.exitS=this.metascreen({id:51,icon:V`\u2577
      | w |
      |\u2584 \u2584|
      |\u2588 \u2588|`,tile:["ooo|ooo| o ","ooo|ooo| x |"],tilesets:{grass:{},river:{},desert:{requires:[H.DesertMarsh]},sea:{requires:[H.SeaMarsh]}},edges:"o^n^",exits:[Mg()]});this.bendNW=this.metascreen({id:52,icon:V`\u2598
      |\u2588\u258c |
      |\u2580\u2580 |
...
this.oakSW=this.metascreen({id:110,tilesets:{town:{type:"square"}},exits:[W(124)]});this.oakSE=this.metascreen({id:111,tilesets:{town:{type:"square"}},exits:[Mg({left:0,shift:.5}),W(151)]});this.temple=this.metascreen({id:112,tilesets:{house:{}},exits:[Ng()]});this.wideDeadEndN=this.metascreen({id:113,icon:V`
      ...
      |\u2502\u2503\u2502|
      |\u2502\u2503 |
      |\u2502\u2503\u2502|`,placement:"mod",tile:" w | w | w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[157]}},edges:"w w ",connect:"19|2a|3|b"});this.goaWideHallNS_blockedLeft=this.metascreen({id:114,icon:V`
      |\u2502\u2503\u2502|
      | \u2503\u2502|
      |\u2502\u2503\u2502|`,placement:"mod",tile:" w | w | w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[81]}},edges:"w w ",connect:"1|9|2a|3b"});this.goaWideArena=this.metascreen({id:115,icon:V`<
      |\u257b<\u257b|
      |\u2521\u2501\u2529|
      ...
      | \u2229 |
      | \u2576\u2500|
      |   |`,tile:"   | <c|   ",tilesets:{swamp:{requires:[H.SwampDoors]}},feature:["consolidate"],flag:"always",edges:"   s",connect:"e",exits:[Lg(92,"swamp")]});this.swampNWSE=this.metascreen({id:119,icon:V`
      | \u2502 |
      |\u2500\u253c\u2500|
      ...
      | \u2229 |
      |\u2500\u252c\u2500|
      | \u2502 |`,tile:"   |c<c| c ",tilesets:{swamp:{requires:[H.SwampDoors]}},feature:["consolidate"],flag:"always",edges:" sss",connect:"6ae",exits:[Lg(86,"swamp")]});this.swampW=this.metascreen({id:123,icon:V`
      |   |
      |\u2500\u2574 |
      |   |`,tile:"   |cc |   ",tilesets:{swamp:{}},feature:["consolidate"],edges:" s  ",connect:"6",poi:[[0]]});this.swampW_door=this.metascreen({id:123,icon:V`\u2229
      | \u2229 |
      |\u2500\u2574 |
      |   |`,tile:"   |c< |   ",tilesets:{swamp:{requires:[H.SwampDoors]}},feature:["consolidate"],flag:"always",edges:" s  ",connect:"6",exits:[Lg(84,"swamp")]});this.swampArena=this.metascreen({id:124,icon:V`
      |   |
      |\u2517\u252f\u251b|
      ...
      |   |
      |\u2500\u2510 |
      | \u2502 |`,tile:"   |cc | c ",tilesets:{swamp:{requires:[H.SwampDoors]}},feature:["consolidate"],update:[[H.SwampDoors,(a,c,d)=>{d.metascreens.swampWS_door.flag="always";return!0}]],edges:" ss ",connect:"6a",exits:[Og({top:7,height:4}),Mg({left:6,width:4})],poi:[[2]]});this.swampWS_door=this.metascreen({id:126,icon:V`\u2229
      | \u2229 |
      |\u2500\u2510 |
...
[".",200]))});this.swampWE_door=this.metascreen({id:-116,icon:V`\u2229
      | \u2229 |
      |\u2500\u2500\u2500|
      |   |`,tile:"   |c<c|   ",tilesets:{swamp:{requires:[H.SwampDoors]}},feature:["consolidate"],flag:"always",edges:" s s",connect:"6e",exits:[Lg(86,"swamp")]});this.swampSE=this.metascreen({id:-117,icon:V`
      |   |
      | \u250c\u2500|
...
[".",200]))});this.swampSE_door=this.metascreen({id:-117,icon:V`\u2229
      | \u2229 |
      | \u250c\u2500|
      | \u2502 |`,tile:"   | <c| c ",tilesets:{swamp:{requires:[H.SwampDoors]}},feature:["consolidate"],flag:"always",edges:"  ss",connect:"ae",exits:[Lg(90,"swamp")]});this.swampNSE=this.metascreen({id:-118,icon:V`
      | \u2502 |
      | \u251c\u2500|
...
[".",200]))});this.caveEmpty=this.metascreen({id:128,icon:V`
      ...
      |\u2588\u2588\u2588|
      |\u2580\u2229\u2580|
      |   |`,tile:"   |o<o|ooo",tilesets:{grass:{},sea:{},desert:{},river:{requires:[H.SeaCaveEntrance]}},edges:" vov",exits:[Lg(73)]});this.cornerSE_cave=this.metascreen({id:194,icon:V`
      | \u2590\u2588|
      |\u2584\u2229\u2588|
      ...
      |\u2597\u2584\u2596|
      |\u259c\u2229\u259b|
      | \u2573 |`,tile:"ooo|o<o|ooo",tilesets:{desert:{},sea:{requires:[H.SeaCaveEntrance]}},edges:"oooo",exits:[Lg(167)]});this.oasisCave=this.metascreen({id:207,icon:V`
      | vv|
      |\u2584\u2229v|
      ...
      |\u2502\u2503\u2514|
      | \u2517\u2501|
      |\u2514\u2500\u2500|`,tile:" w | ww|   ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[97]}},edges:"w  w",connect:"1|f|2e|3d"});this.goaWideHallNE_blockedRight=this.metascreen({id:224,icon:V`
      |\u2502\u2503 |
      |\u2502\u2517\u2501|
      |\u2514\u2500\u2500|`,tile:" w | ww|   ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[13]}},edges:"w  w",connect:"1f|2e|3|d"});this.wideHallNW=this.metascreen({id:225,icon:V`
      | \u2503 |
      |\u2501\u251b |
      ...
      |\u2518\u2503\u2502|
      |\u2501\u251b\u2502|
      |\u2500\u2500\u2518|`,tile:" w |ww |   ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],removeWall:109}},edges:"ww  ",connect:"15|26|37"});this.goaWideHallNW_blockedRight=this.metascreen({id:225,icon:V`
      |\u2518\u2503\u2502|
      |\u2501\u251b |
      |\u2500\u2500\u2518|`,tile:" w |ww |   ",tilesets:{labyrinth:{}},edges:"ww  ",connect:"15|26|3|7"});this.goaWideHallNW_blockedLeft=this.metascreen({id:225,icon:V`
      | \u2503\u2502|
      |\u2501\u251b\u2502|
      |\u2500\u2500\u2518|`,tile:" w |ww |   ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[1],removeWall:109}},edges:"ww  ",connect:"1|5|26|37"});this.wideHallSE=this.metascreen({id:226,icon:V`
      |   |
      | \u250f\u2501|
      ...
      |\u250c\u2500\u2500|
      | \u250f\u2501|
      |\u2502\u2503\u250c|`,tile:"   | ww| w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[97]}},edges:"  ww",connect:"9|d|ae|bf"});this.goaWideHallSE_blockedRight=this.metascreen({id:226,icon:V`
      |\u250c\u2500\u2500|
      |\u2502\u250f\u2501|
      |\u2502\u2503 |`,tile:"   | ww| w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[221]}},edges:"  ww",connect:"9d|ae|b|f"});this.wideHallWS=this.metascreen({id:227,icon:V`
      |   |
      |\u2501\u2513 |
      ...
      |\u2500\u2500\u2510|
      |\u2501\u2513\u2502|
      |\u2510\u2503\u2502|`,tile:"   |ww | w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],removeWall:157}},edges:" ww ",connect:"5b|6a|79"});this.goaWideHallWS_blockedRight=this.metascreen({id:227,icon:V`
      |\u2500\u2500\u2510|
      |\u2501\u2513 |
      |\u2510\u2503\u2502|`,tile:"   |ww | w ",tilesets:{labyrinth:{}},edges:" ww ",connect:"5|b|6a|79"});this.goaWideHallWS_blockedLeft=this.metascreen({id:227,icon:V`
      |\u2500\u2500\u2510|
      |\u2501\u2513\u2502|
      | \u2503\u2502|`,tile:"   |ww | w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[209],removeWall:157}},edges:" ww ",connect:"5b|6a|7|9"});this.goaWideHallNS_stairs=this.metascreen({id:228,icon:V`
      |\u251c\u2528\u2502|
      |\u2502\u2503\u2502|
      |\u2502\u2520\u2524|`,tile:" w | H | w ",tilesets:{labyrinth:{}},edges:"w w ",connect:"1239ab"});this.goaWideHallNS_stairsBlocked13=this.metascreen({id:228,icon:V`
      |\u2514\u2528\u2502|
      |\u2577\u2503\u2575|
      |\u2502\u2520\u2510|`,tile:" w | H | w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[65,141]}},edges:"w w ",connect:"12ab|3|9"});this.goaWideHallNS_stairsBlocked24=this.metascreen({id:228,icon:V`
      |\u250c\u2528\u2502|
      |\u2502\u2503\u2502|
      |\u2502\u2520\u2518|`,tile:" w | H | w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[1,205]}},edges:"w w ",connect:"1|239a|b"});this.wideHallNS_deadEnds=this.metascreen({id:229,icon:V`
      | \u2579 |
      |   |
      ...
      |\u2575\u2579\u2502|
      |\u250c\u2500\u2518|
      |\u2502\u257b\u2577|`,tile:" w | = | w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[97,173]}},edges:"w w ",connect:"1|2|39|a|b"});this.goaWideHallNS_deadEndBlocked13=this.metascreen({id:229,icon:V`
      |\u2502\u2579\u2575|
      |\u2514\u2500\u2510|
      |\u2577\u257b\u2502|`,tile:" w | = | w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[109,161]}},edges:"w w ",connect:"1b|2|3|9|a"});this.wideHallNWSE=this.metascreen({id:230,icon:V`
      | \u2503 |
      |\u2501\u254b\u2501|
      ...
      |\u2518\u2503 |
      |\u2501\u254b\u2501|
      | \u2503\u250c|`,tile:" w |www| w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[13,209]}},edges:"wwww",connect:"26ae|15|3|d|7|9|bf"});this.goaWideHallNWSE_blocked24=this.metascreen({id:230,icon:V`
      | \u2503\u2514|
      |\u2501\u254b\u2501|
      |\u2510\u2503 |`,tile:" w |www| w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[1,221]}},edges:"wwww",connect:"26ae|1|5|3d|79|b|f"});this.wideHallNWE=this.metascreen({id:231,icon:V`
      | \u2503 |
      |\u2501\u253b\u2501|
      ...
      | \u2503 |
      |\u2501\u253b\u2501|
      |\u2500\u2500\u2500|`,tile:" w |www|   ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[1,13]}},edges:"ww w",connect:"26e|1|5|3|d|7f"});this.wideHallWSE=this.metascreen({id:232,icon:V`
      |   |
      |\u2501\u2533\u2501|
      ...
      |\u2500\u2500\u2500|
      |\u2501\u2533\u2501|
      | \u2503 |`,tile:"   |www| w ",tilesets:{labyrinth:{requires:[H.LabyrinthParapets],addWall:[209,221]}},edges:" www",connect:"6ae|5d|7|9|b|f"});this.wideHallNS_wallTop=this.metascreen({id:233,icon:V`
      | \u2506 |
      | \u2503 |
...
class mh{constructor(a){this.address=a}get(a){return a[this.address]<<16|a[this.address+1]<<8|a[this.address+2]}set(a,b){a[this.address]=b>>>16&255;a[this.address+1]=b>>>8&255;a[this.address+2]=b&255}};class nh extends Xc{constructor(a,b){super(a,b);this.base=(b&3)<<2|(b&252)<<6|16624;this.colors=Eb(a.prg,this.base,4)}color(a){return this.colors[a]&63}};class oh{constructor(a){this.rom=a;this.values=Eb(a.prg,ph.offset,64)}write(){const a=this.rom.assembler();ph.loc(a);a.byte(...this.values);return[a.module()]}}const ph=A.of(z.$1a,38884);const {$0d:qh,$fe:rh,$ff:sh}=z;
...
class vh extends Array{constructor(a){super(259);this.rom=a;this.unallocated=[];for(let b=0;259>b;b++)this[b]=new uh(a,b)}getScreen(a){const b=0>a?this.unallocated:this,c=0>a?~a:a;return b[c]||(b[c]=new uh(this.rom,a))}setScreen(a,b){(0>a?this.unallocated:this)[0>a?~a:a]=b}deleteScreen(a){delete (0>a?this.unallocated:this)[0>a?~a:a]}write(){const a=this.rom.assembler();for(const b of this)(null===b||void 0===b?0:b.used)&&b.assemble(a);return[a.module()]}};const {$0e:wh}=z;class xh extends Array{constructor(a){super(128);this.rom=a;for(a=0;128>a;a++)this[a]=a}swap(a,b){if(a!==b){var c=this[a];this[a]=this[b];this[b]=c}}write(){const a=this.rom.assembler();gc(a,[wh],"CheckToItemGetMap");a.byte(...this);return[a.module()]}};const {$0e:yh,$fe:zh,$ff:Ah}=z;var Bh,Ch=Bh||(Bh={});Ch[Ch.TORNEL=0]="TORNEL";Ch[Ch.ZEBU=1]="ZEBU";Ch[Ch.ASINA=2]="ASINA";Ch[Ch.KENSU=3]="KENSU";var Dh,Eh=Dh||(Dh={});Eh[Eh.INSUFFICIENT_MAGIC=0]="INSUFFICIENT_MAGIC";Eh[Eh.FREE_MAGIC=1]="FREE_MAGIC";Eh[Eh.IGNORED=2]="IGNORED";Eh[Eh.DEFAULT=3]="DEFAULT";
...
;class Rh{constructor(a){this.rom=a;this.locations=Eb(a.prg,Sh.offset,16)}write(){const a=this.rom.assembler();Sh.loc(a);a.label("WildWarpLocations");a.byte(...this.locations);a.org(52185);a.instruction("lda","WildWarpLocations,y");return[a.module()]}}const Sh=A.of(z.$fe,52204);const {$0e:Th,$0f:Uh,$10:Vh}=z;
...
d.push(...this.itemGets.write());d.push(...this.slots.write());d.push(...this.items.write());d.push(...this.shops.write());c(this.bossKills);c(this.patterns);d.push(...this.wildWarp.write());d.push(...this.townWarp.write());d.push(...this.coinDrops.write());d.push(...this.scaling.write());d.push(...this.bosses.write());d.push(...this.randomNumbers.write());d.push(...this.telepathy.write());d.push(...this.messages.write());d.push(...this.screens.write());c=new Ta;c.base(this.prg,0);for(const a of d)c.read(a);
...
b[a].sets().map(a=>[...a].map(y).join(" ")).join(" | "),console.log(`Tile ${y(a)}: ${d}`)}swapMetatiles(a,...b){var c=new Map,d=w(256);const e=new Map,f=a=>Array.isArray(a)?a[0]:0>a?~a:a;for(var g of b){for(var h=0;h<g.length-1;h++)if(Array.isArray(g[h])){var k=g[h];e.set(k[0],k[1]);g[h]=k[0]}for(h=0;h<g.length-1;h++){k=g[h];const a=g[h+1];0>k||0>a||(c.set(a,k),d[a]=k)}}g=new Set;c=new Set;a=new Set(a);for(var p of this.locations)if(p.used&&a.has(p.tileset)){c.add(p.tileEffects);for(var q of p.allScreens())g.add(q)}for(var u of g)for(let a=
0,b=u.tiles.length;a<b;a++)u.tiles[a]=d[u.tiles[a]];for(var B of a){d=this.tilesets[B];for(var D of b)for(p=0;p<D.length-1;p++){q=f(D[p]);u=f(D[p+1]);for(a=0;4>a;a++)d.tiles[a][q]=d.tiles[a][u];d.attrs[q]=d.attrs[u];if(32>u&&d.alternates[u]!==u){if(32<=q)throw Error(`Cannot unflag: ${B} ${q} ${u} ${d.alternates[u]}`);d.alternates[q]=d.alternates[u]}}for(var x of e){const [a,b]=x;d.alternates[a]=b}}for(const a of c){B=this.tileEffects[a-179];for(const a of b)for(D=0;D<a.length-1;D++)x=f(a[D]),d=f(a[D+
1]),B.effects[x]=B.effects[d];for(const a of e.keys())B.effects[a]|=8}}moveFlag(a,b){function c(c){for(let d=0;d<c.length;d++)c[d]===a&&(c[d]=b),c[d]===~a&&(c[d]=~b)}for(const a of this.triggers)c(a.conditions),c(a.flags);for(const d of this.npcs){for(const a of d.spawnConditions.values())c(a);for(const c of[d.globalDialogs,...d.localDialogs.values()])for(const d of c)d.condition===a&&(d.condition=b),d.condition===~a&&(d.condition=~b)}if(512===(a&-256)&&512===(b&-256))for(const c of this.locations)for(const d of c.flags)d.flag===
