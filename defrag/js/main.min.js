...
n);c.shuffleMonsters()&&shuffleMonsters$$module$patch(a,n,g);identifyKeyItemsForDifficultyBuffs$$module$patch(n);c.doubleBuffMedicalHerb?(a[115996]*=2,a[115962]*=3):c.singleBuffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$patch(n);addCordelWestTriggers$$module$patch(n,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$patch(n);c.storyMode()&&storyMode$$module$patch(n);c.chargeShotsOnly()&&disableStabs$$module$patch(n);c.orbsOptional()&&orbsOptional$$module$patch(n);
