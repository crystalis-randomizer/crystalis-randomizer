...
module$nodes.Trigger=Trigger$$module$nodes;module$nodes.Condition=Condition$$module$nodes;module$nodes.Boss=Boss$$module$nodes;module$nodes.Area=Area$$module$nodes;module$nodes.Connection=Connection$$module$nodes;module$nodes.Location=Location$$module$nodes;module$nodes.WorldGraph=WorldGraph$$module$nodes;module$nodes.LocationList=LocationList$$module$nodes;module$nodes.FillStrategy=FillStrategy$$module$nodes;module$nodes.Filling=Filling$$module$nodes;function seq$$module$rom$util(a,b=(a)=>a){return Array(a).fill(0).map((a,d)=>b(d))}function slice$$module$rom$util(a,b,c){return a.slice(b,b+c)}function tuple$$module$rom$util(a,b,c){return Array.from(a.slice(b,b+c))}function signed$$module$rom$util(a){return 128>a?a:a-256}function varSlice$$module$rom$util(a,b,c,d,e=Infinity,g){g||(g=(a)=>a);const f=[];for(;b+c<=e&&a[b]!=d;)f.push(g(a.slice(b,b+c))),b+=c;return f}function addr$$module$rom$util(a,b,c=0){return(a[b]|a[b+1]<<8)+c}
function group$$module$rom$util(a,b,c){c||(c=(a)=>a);return seq$$module$rom$util(Math.max(0,Math.floor(b.length/a)),(d)=>c(slice$$module$rom$util(b,d*a,a)))}function reverseBits$$module$rom$util(a){return 65793*(2050*a&139536|32800*a&558144)>>>16&255}function countBits$$module$rom$util(a){a-=a>>1&85;a=(a&51)+(a>>2&51);return a+(a>>4)&15}function hex$$module$rom$util(a){return a.toString(16).padStart(2,"0")}function hex4$$module$rom$util(a){return a.toString(16).padStart(4,"0")}
function concatIterables$$module$rom$util(a){const b=[];for(const c of a)for(const a of c)b.push(a);return b}
class DataTuple$$module$rom$util{constructor(a){this.data=a}[Symbol.iterator](){return this.data[Symbol.iterator]()}hex(){return Array.from(this.data,hex$$module$rom$util).join(" ")}clone(){return new this.constructor(this.data)}static make(a,b){const c=class extends DataTuple$$module$rom$util{constructor(b=Array(a).fill(0)){super(b)}static of(a){const b=new c;for(const c in a)b[c]=a[c];return b}},d={};for(const a in b)d[a]="function"===typeof b[a]?{value:b[a]}:b[a];Object.defineProperties(c.prototype,
d);return c}static prop(...a){return{get(){let b=0;for(const [c,d=255,e=0]of a)b|=(this.data[c]&d)>>>(0>e?0:e)<<(0>e?-e:0);return b},set(b){for(const [c,d=255,e=0]of a)this.data[c]=this.data[c]&~d|b>>>(0>e?-e:0)<<(0>e?0:e)&d}}}static booleanProp(a){const b=DataTuple$$module$rom$util.prop(a);return{get(){return!!b.get.call(this)},set(a){b.set.call(this,+a)}}}}var module$rom$util={};module$rom$util.seq=seq$$module$rom$util;module$rom$util.slice=slice$$module$rom$util;module$rom$util.tuple=tuple$$module$rom$util;
module$rom$util.signed=signed$$module$rom$util;module$rom$util.varSlice=varSlice$$module$rom$util;module$rom$util.addr=addr$$module$rom$util;module$rom$util.group=group$$module$rom$util;module$rom$util.reverseBits=reverseBits$$module$rom$util;module$rom$util.countBits=countBits$$module$rom$util;module$rom$util.hex=hex$$module$rom$util;module$rom$util.hex4=hex4$$module$rom$util;module$rom$util.concatIterables=concatIterables$$module$rom$util;module$rom$util.DataTuple=DataTuple$$module$rom$util;class Entity$$module$rom$entity{constructor(a,b){this.rom=a;this.id=b}toString(){return`${this.constructor.name} $${hex$$module$rom$util(this.id)}`}}var module$rom$entity={};module$rom$entity.Entity=Entity$$module$rom$entity;class Location$$module$rom$location extends Entity$$module$rom$entity{constructor(a,b){super(a,b);const c=LOCATIONS$$module$rom$location[b]||{name:""};this.mapDataPointer=82688+(b<<1);this.mapDataBase=addr$$module$rom$util(a.prg,this.mapDataPointer,49152);this.name=c.name||"";this.valid=49152<this.mapDataBase&&!!this.name;this.layoutBase=addr$$module$rom$util(a.prg,this.mapDataBase,49152);this.graphicsBase=addr$$module$rom$util(a.prg,this.mapDataBase+2,49152);this.entrancesBase=addr$$module$rom$util(a.prg,
...
a.startPage||b.page>a.endPage||b.free()<a.data.length)){this.rom.subarray(b.pos,b.pos+a.data.length).set(a.data);a.resolve(b.pos);b.pos+=a.data.length;return}throw Error("Could not find sufficient chunk to write");}}var module$rom$writer={};module$rom$writer.Writer=Writer$$module$rom$writer;class Screen$$module$rom extends Entity$$module$rom$entity{constructor(a,b){super(a,b);this.base=(255<b?64+b:b)<<8;this.tiles=seq$$module$rom$util(15,(b)=>slice$$module$rom$util(a.prg,this.base|b<<4,16))}metatile(a,b){return this.rom.metatiles[this.tiles[a][b]]}allTilesSet(){const a=new Set;for(const b of this.tiles)for(const c of b)a.add(c);return a}write(a){a=void 0===a?this.rom:a;let b=this.base;for(const c of this.tiles)for(const d of c)a[b++]=d}}
class Tileset$$module$rom extends Entity$$module$rom$entity{constructor(a,b){super(a,b);b&=63;this.tileBase=65536|b<<8;this.attrBase=77824|b<<4;this.alternatesBase=81408|b<<3;this.tiles=seq$$module$rom$util(4,(b)=>slice$$module$rom$util(a.prg,this.tileBase|b<<8,256));this.attrs=seq$$module$rom$util(256,(b)=>a.prg[this.attrBase|b>>2]>>((b&3)<<1)&3);this.alternates=slice$$module$rom$util(a.prg,this.alternatesBase,32)}write(a){a=void 0===a?this.rom:a;for(var b=0;256>b;b++){32>b&&(a[this.alternatesBase+
b]=this.alternates[b]);for(var c=0;4>c;c++)a[this.tileBase+(c<<8)+b]=this.tiles[c][b]}for(b=0;64>b;b++)c=b<<2,a[this.attrBase+b]=this.attrs[c]&3|(this.attrs[c+1]&3)<<2|(this.attrs[c+2]&3)<<4|(this.attrs[c+3]&3)<<6}makeFlagTiles(a){}}class TileEffects$$module$rom extends Entity$$module$rom$entity{constructor(a,b){super(a,b);this.base=b<<8&8191|73728;this.effects=slice$$module$rom$util(a.prg,this.base,256)}write(a){a=void 0===a?this.rom:a;for(let b=0;256>b;b++)a[this.base+b]=this.effects[b]}}
class Palette$$module$rom extends Entity$$module$rom$entity{constructor(a,b){super(a,b);this.base=(b&3)<<2|(b&252)<<6|16624;this.colors=slice$$module$rom$util(a.prg,this.base,4)}color(a){return this.colors[a]&63}}
class Pattern$$module$rom extends Entity$$module$rom$entity{constructor(a,b,c){super(a,b);this.pixels=c||slice$$module$rom$util(a.chr,b<<4,16)}pixelAt(a,b){return(this.pixels[a|8]>>b&1)<<1|this.pixels[a]>>b&1}flipH(){return new Pattern$$module$rom(this.rom,-1,this.pixels.map(reverseBits$$module$rom$util))}flipV(){return new Pattern$$module$rom(this.rom,-1,seq$$module$rom$util(16,(a)=>this.pixels[a&8|~a&7]))}flip(a){let b=this;a&64&&(b=b.flipH());a&128&&(b=b.flipV());return b}}
class TileAnimation$$module$rom extends Entity$$module$rom$entity{constructor(a,b){super(a,b);this.base=255865+(b<<3);this.pages=slice$$module$rom$util(a.prg,this.base,8)}}
class Hitbox$$module$rom extends Entity$$module$rom$entity{constructor(a,b){super(a,b);this.base=218769+(b<<2);this.coordinates=slice$$module$rom$util(a.prg,this.base,4)}get w(){return this.coordinates[1]}get x0(){return signed$$module$rom$util(this.coordinates[0])}get x1(){return this.x0+this.w}get h(){return this.coordinates[3]}get y0(){return signed$$module$rom$util(this.coordinates[2])}get y1(){return this.y0+this.h}}
const UNUSED_TRIGGERS$$module$rom=new Set([135,136,137,143,147,150,152,155,156,157,158,159,160,181,185,190,192]);
class Trigger$$module$rom extends Entity$$module$rom$entity{constructor(a,b){super(a,b);this.used=!UNUSED_TRIGGERS$$module$rom.has(b);this.pointer=123258+((b&127)<<1);this.base=addr$$module$rom$util(a.prg,this.pointer,81920);this.conditions=[];this.message=null;this.flags=[];let c=this.base;do{b=a.prg[c]<<8|a.prg[c+1];var d=b&4095;this.conditions.push(b&8192?~d:d);c+=2}while(!(b&32768));this.message=MessageId$$module$rom.from(a.prg,c);do c+=2,b=a.prg[c]<<8|a.prg[c+1],d=b&4095,this.flags.push(b&32768?
~d:d);while(!(b&16384))}bytes(){const a=[];for(var b=0;b<this.conditions.length;b++){var c=this.conditions[b];0>c&&(c=~c|8192);b===this.conditions.length-1&&(c|=32768);a.push(c>>>8,c&255)}a.push(...this.message.bytes());for(b=0;b<this.flags.length;b++)c=this.flags[b],0>c&&(c=~c|32768),b===this.flags.length-1&&(c|=16384),a.push(c>>>8,c&255);return a}write(a,b){b=void 0===b?123258:b;const c=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const d=yield a.write(c.bytes(),122880,131071);
a.rom[b+2*(c.id&127)]=d&255;a.rom[b+2*(c.id&127)+1]=(d>>>8)-64})}}class MessageId$$module$rom{constructor(a,b,c){this.action=a;this.part=b;this.index=c}static from(a,b){a=a[b]<<8|a[b+1];return new MessageId$$module$rom(a>>>11&31,a>>>5&63,a&31)}bytes(){const a=(this.action&31)<<11|(this.part&63)<<5|this.index&31;return[a>>>8,a&255]}}const UNUSED_NPCS$$module$rom=new Set([60,106,115,130,134,135,137,138,139,140,141]);
class Npc$$module$rom extends Entity$$module$rom$entity{constructor(a,b){super(a,b);this.used=!UNUSED_NPCS$$module$rom.has(b)&&(143>b||192<=b);this.dataBase=33008|(b&252)<<6|(b&3)<<2;this.data=slice$$module$rom$util(a.prg,this.dataBase,4);this.spawnPointer=116192+(b<<1);this.spawnBase=addr$$module$rom$util(a.prg,this.spawnPointer,81920);this.spawnConditions={};b=this.spawnBase;let c;for(;this.used&&255!=(c=a.prg[b++]);){this.spawnConditions[c]=[];let d;do{d=a.prg[b]<<8|a.prg[b+1];const e=d&4095;this.spawnConditions[c].push(d&
8192?~e:e);b+=2}while(!(d&32768))}}spawnConditionsBytes(){const a=[];for(let b in this.spawnConditions){b=Number(b);a.push(b);for(let c=0;c<this.spawnConditions[b].length;c++){let d=this.spawnConditions[b][c];0>d&&(d=~d|8192);c===this.spawnConditions[b].length-1&&(d|=32768);a.push(d>>>8,d&255)}}a.push(255);return a}write(a,b){var {spawnConditionsBase:c=116192}=void 0===b?{}:b;const d=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const b=yield a.write(d.spawnConditionsBytes(),
114688,122879);a.rom[c+2*d.id]=b&255;a.rom[c+2*d.id+1]=(b>>>8)-64})}}class AdHocSpawn$$module$rom extends Entity$$module$rom$entity{constructor(a,b){super(a,b);this.base=(b<<2)+171008;this.lowerSlot=a.prg[this.base];this.upperSlot=a.prg[this.base+1];this.object=a.prg[this.base+2];this.count=a.prg[this.base+3]}}
...
class Messages$$module$rom{constructor(a){this.rom=a;const b=(b)=>readString$$module$rom(a.prg,b);this.basicWords=new AddressTable$$module$rom(a,166144,128,131072,b);this.extraWords={5:new AddressTable$$module$rom(a,166400,10,131072,b),6:new AddressTable$$module$rom(a,166420,36,131072,b),7:new AddressTable$$module$rom(a,166492,74,131072,b)};this.banks=new DataTable$$module$rom(a,164862,36,1);this.parts=new AddressTable$$module$rom(a,164898,34,131072,(b,d,e)=>new AddressTable$$module$rom(a,b,33==d?
3:e[d+1]-b>>>1,(this.banks[d]<<13)-40960,(a,b)=>new Message$$module$rom(this,d,b,a)))}}
class Rom$$module$rom{constructor(a){this.prg=a.subarray(16,262160);this.chr=a.subarray(262160);this.screens=seq$$module$rom$util(259,(a)=>new Screen$$module$rom(this,a));this.tilesets=seq$$module$rom$util(12,(a)=>new Tileset$$module$rom(this,a<<2|128));this.tileEffects=seq$$module$rom$util(11,(a)=>new TileEffects$$module$rom(this,a+179));this.triggers=seq$$module$rom$util(67,(a)=>new Trigger$$module$rom(this,128|a));this.patterns=seq$$module$rom$util(this.chr.length>>4,(a)=>new Pattern$$module$rom(this,
a));this.palettes=seq$$module$rom$util(256,(a)=>new Palette$$module$rom(this,a));this.locations=seq$$module$rom$util(256,(a)=>new Location$$module$rom$location(this,a));this.tileAnimations=seq$$module$rom$util(4,(a)=>new TileAnimation$$module$rom(this,a));this.hitboxes=seq$$module$rom$util(24,(a)=>new Hitbox$$module$rom(this,a));this.objects=seq$$module$rom$util(256,(a)=>new ObjectData$$module$rom(this,a));this.adHocSpawns=seq$$module$rom$util(96,(a)=>new AdHocSpawn$$module$rom(this,a));this.metasprites=
seq$$module$rom$util(256,(a)=>new Metasprite$$module$rom(this,a));this.messages=new Messages$$module$rom(this);this.itemGets=seq$$module$rom$util(113,(a)=>new ItemGet$$module$rom(this,a));this.npcs=seq$$module$rom$util(205,(a)=>new Npc$$module$rom(this,a))}get monsters(){let a=new Set;for(const b of this.locations)if(b.valid&&b.hasSpawns)for(const c of b.spawns)0==(c[2]&7)&&a.add(this.objects[c[3]+80&255]);a=[...a];a.sort((a,c)=>a.id-c.id);return a}get projectiles(){let a=new Set;for(const b of this.monsters)b.child&&
a.add(this.objects[this.adHocSpawns[b.child].object]);a=[...a];a.sort((a,c)=>a.id-c.id);return a}get monsterGraphics(){const a={};for(const b of this.locations)if(b.valid&&b.hasSpawns)for(const c of b.spawns)if(!(c[2]&7)){const d=c[2]&128?1:0,e=(c[3]+80).toString(16).padStart(2,0);(a[e]=a[e]||{})[`${d}:${b.spritePatterns[d].toString(16)}:${b.spritePalettes[d].toString(16)}`]={slot:d,pat:b.spritePatterns[d],pal:b.spritePalettes[d]}}return a}get locationMonsters(){const a={};for(const b of this.locations){if(!b.valid||
!b.hasSpawns)continue;const c=a["$"+b.id.toString(16).padStart(2,0)]={};for(const a of b.spawns)if(!(a[2]&7)){const b=a[2]&128?1:0,d=a[3]+80;c[`${b}:${d.toString(16)}`]=(c[`${b}:${d.toString(16)}`]||0)+1}}return a}static load(a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const b=yield pickFile$$module$rom();a&&(yield a(b));return new Rom$$module$rom(b)})}writeData(){const a=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const b=new Writer$$module$rom$writer(a.prg);
b.alloc(83192,97792);b.alloc(103417,113408);b.alloc(123392,123888);b.alloc(116602,117085);a.prg[246387]=a.prg[246392]=190;a.prg[246399]=a.prg[246404]=191;const c=[];for(const d of a.locations)d.valid&&c.push(d.write(b));for(const c of a.objects)c.write(b,114176);for(const d of a.triggers)d.used&&c.push(d.write(b));for(const d of a.npcs)d.used&&c.push(d.write(b));for(const b of a.tilesets)b.write(a.prg);for(const b of a.tileEffects)b.write(a.prg);for(const b of a.screens)b.write(a.prg);c.push(b.commit());
...
console.log(`Tile ${a.toString(16).padStart(2,0)}: ${e}`)}swapMetatiles(a,...b){var c=new Map,d=seq$$module$rom$util(256);const e=new Map,g=(a)=>Array.isArray(a)?a[0]:0>a?~a:a;for(var f of b){for(var k=0;k<f.length-1;k++)Array.isArray(f[k])&&(e.set(f[k][0],f[k][1]),f[k]=f[k][0]);for(k=0;k<f.length-1;k++){let a=f[k],b=f[k+1];0>a||0>b||(c.set(b,a),d[b]=a)}}f=new Set;c=new Set;a=new Set(a);for(var h of this.locations)if(h.valid&&a.has(h.tileset)){c.add(h.tileEffects);for(const a of h.allScreens())f.add(a)}for(var n of f)for(var m of n.tiles)for(h=
0;h<m.length;h++)m[h]=d[m[h]];for(var q of a){a=this.tilesets[(q&127)>>>2];for(var p of b)for(d=0;d<p.length-1;d++){n=g(p[d]);m=g(p[d+1]);for(h=0;4>h;h++)a.tiles[h][n]=a.tiles[h][m];a.attrs[n]=a.attrs[m];if(32>m&&a.alternates[m]!=m){if(32<=n)throw Error(`Cannot unflag: ${q} ${n} ${m} ${a.alternates[m]}`);a.alternates[n]=a.alternates[m]}}for(var l of e){const [b,c]=l;a.alternates[b]=c}}for(const d of c){q=this.tileEffects[d-179];for(const c of b)for(p=0;p<c.length-1;p++)l=g(c[p]),a=g(c[p+1]),q.effects[l]=
q.effects[a];for(const a of e.keys())q.effects[a]|=8}}}
const readString$$module$rom=(a,b)=>{const c=[];for(;a[b];)c.push(a[b++]);return String.fromCharCode(...c)},pickFile$$module$rom=()=>new Promise((a,b)=>{if("#reset"!=window.location.hash){const b=window.localStorage.getItem("rom");if(b)return a(Uint8Array.from(Array(b.length/2).fill(0).map((a,c)=>Number.parseInt(b[2*c]+b[2*c+1],16))))}const c=document.createElement("input");document.body.appendChild(c);c.type="file";c.addEventListener("change",()=>{const b=c.files[0],e=new FileReader;e.addEventListener("loadend",
()=>{const b=new Uint8Array(e.result),d=Array.from(b,(a)=>a.toString(16).padStart(2,0)).join("");window.localStorage.setItem("rom",d);c.remove();a(b)});e.readAsArrayBuffer(b)})}),EXPECTED_CRC32$$module$rom=466849842;var module$rom={};module$rom.Rom=Rom$$module$rom;module$rom.EXPECTED_CRC32=EXPECTED_CRC32$$module$rom;const IM1$$module$random=2147483563,IM2$$module$random=2147483399,AM$$module$random=1/IM1$$module$random,IMM1$$module$random=IM1$$module$random-1,IA1$$module$random=40014,IA2$$module$random=40692,IQ1$$module$random=53668,IQ2$$module$random=52774,IR1$$module$random=12211,IR2$$module$random=3791,NTAB$$module$random=32,NDIV$$module$random=1+Math.floor(IMM1$$module$random/NTAB$$module$random),EPS$$module$random=1.2E-7,RNMX$$module$random=1-EPS$$module$random;
...
RNMX$$module$random)}nextInt(a){return Math.floor(this.next()*a)}shuffle(a){for(let b=a.length;b;){const c=this.nextInt(b--);[a[b],a[c]]=[a[c],a[b]]}return a}}var module$random={};module$random.Random=Random$$module$random;const STATUS$$module$version="unstable",VERSION$$module$version="defrag",LABEL$$module$version="defrag 1c562bb",HASH$$module$version="1c562bb82a6d963346ab739e87d5c6d745542dcb",DATE$$module$version=new Date(1555839827E3);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$flagset(b.flags):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$patch(a,parseSeed$$module$patch(b.seed),d,new FetchReader$$module$fetchreader(c))})}};
...
module$patch.stampVersionSeedAndHash=stampVersionSeedAndHash$$module$patch;class ProgressTracker$$module$progress{constructor(){this.completed=this.tasks=0}addTasks(a){this.tasks+=a}addCompleted(a){this.completed+=a}value(){return this.tasks&&this.completed/this.tasks}}var module$progress={};module$progress.ProgressTracker=ProgressTracker$$module$progress;const renderPresets$$module$render=(a)=>{for(const {title:c,flags:d,descr:e,default:g}of PRESETS$$module$flagset){var b=document.createElement("h2");b.textContent=c;a.appendChild(b);b=document.createElement("p");b.innerHTML=e;a.appendChild(b);b=document.createElement("a");b.textContent=d;b.classList.add("button");b.classList.add("preset-flags");b.dataset.flags=d;g&&(b.dataset.defaultPreset="true");a.appendChild(b)}},renderOptions$$module$render=(a)=>{for(const {section:c,text:d,flags:e}of FLAGS$$module$flagset){var b=
