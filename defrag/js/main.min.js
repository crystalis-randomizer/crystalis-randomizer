...
return Math.min(AM$$module$random*this.iy,RNMX$$module$random)}nextInt(a){return Math.floor(this.next()*a)}shuffle(a){for(let b=a.length;b;){const c=this.nextInt(b--);[a[b],a[c]]=[a[c],a[b]]}return a}}var module$random={};module$random.Random=Random$$module$random;const STATUS$$module$version="unstable",VERSION$$module$version="defrag",LABEL$$module$version="defrag 08203a1",HASH$$module$version="08203a170827c097efa6c752d52205619ca83871",DATE$$module$version=new Date(1556734647E3);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$flagset(b.flags):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$patch(a,parseSeed$$module$patch(b.seed),d,new FetchReader$$module$fetchreader(c))})}};
...
8;a.locations[170].spawns.splice(1,1);a.locations[172].spawns.splice(2,1);a.locations[185].spawns.splice(2,1)},alarmFluteIsKeyItem$$module$patch=(a)=>{a.npcs[20].data[1]=49;a.itemGets[49].inventoryRowStart=32;a.prg[135201]=67},reversibleSwanGate$$module$patch=(a)=>{a.locations[115].spawns.push(Spawn$$module$rom$location.of({xt:10,yt:2,type:1,id:45}),Spawn$$module$rom$location.of({xt:11,yt:2,type:1,id:45}),Spawn$$module$rom$location.of({xt:14,yt:10,type:2,id:179}))},fixQueenDialog$$module$patch=(a)=>
{},preventNpcDespawns$$module$patch=(a)=>{a.npcs[68].spawnConditions.set(233,[-142]);a.npcs[68].spawnConditions.set(228,[141]);a.npcs[203].spawnConditions.set(166,[-654])},addCordelWestTriggers$$module$patch=(a,b)=>{for(const c of a.locations[21].spawns)(c.isChest()||b.disableTeleportSkip()&&c.isTrigger())&&a.locations[20].spawns.push(c.clone())},fixRabbitSkip$$module$patch=(a)=>{for(const b of a.locations[40].spawns)b.isTrigger()&&134===b.id&&1856===b.x&&(b.x+=16,b.y+=16)},storyMode$$module$patch=
(a)=>{const b=a.npcs[203].spawnConditions.get(166);b.push(~a.npcs[194].spawnConditions.get(40)[0]);b.push(~a.npcs[132].spawnConditions.get(110)[0]);b.push(~a.triggers[26].conditions[1]);b.push(~a.npcs[197].spawnConditions.get(169)[0]);b.push(~a.npcs[198].spawnConditions.get(172)[0]);b.push(~a.npcs[199].spawnConditions.get(185)[0]);b.push(~a.npcs[200].spawnConditions.get(182)[0]);b.push(~a.npcs[203].spawnConditions.get(159)[0]);b.push(512);b.push(513);b.push(514);b.push(515)},disableStabs$$module$patch=
(a)=>{for(const b of[8,9,39])a.objects[b].collisionPlane=0},orbsOptional$$module$patch=(a)=>{for(const b of[16,20,24,29])a.objects[b].terrainSusceptibility&=-5,a.objects[b].level=2},connectLimeTreeToLeaf$$module$patch=(a)=>{const b=a.locations[3];a=a.locations[66];b.screens[5][4]=16;a.screens[1][0]=26;a.screens[2][0]=12;const c=b.entrances.push(Entrance$$module$rom$location.of({x:1263,y:1400}))-1,d=a.entrances.push(Entrance$$module$rom$location.of({x:16,y:448}))-1;b.exits.push(Exit$$module$rom$location.of({x:1264,
y:1376,dest:66,entrance:d}),Exit$$module$rom$location.of({x:1264,y:1392,dest:66,entrance:d}));a.exits.push(Exit$$module$rom$location.of({x:0,y:432,dest:3,entrance:c}),Exit$$module$rom$location.of({x:0,y:448,dest:3,entrance:c}))},stampVersionSeedAndHash$$module$patch=(a,b,c)=>{const d=crc32$$module$crc32(a),e=d.toString(16).padStart(8,0).toUpperCase(),f="unstable"==STATUS$$module$version?HASH$$module$version.substring(0,7).padStart(7,0).toUpperCase()+"     ":VERSION$$module$version.substring(0,12).padEnd(12,
" ");b=b.toString(16).padStart(8,0).toUpperCase();const g=(b,c)=>{for(let d=0;d<c.length;d++)a[b+16+d]=c.charCodeAt(d)},h=(a,b)=>{const c=[];for(let d=0;d<a.length||d<b.length;d++)c.push(a[d]||" "),c.push(b[d]||" ");return c.join("")};g(161743,h("  VERSION     SEED      ",`  ${f}${b}`));b=String(c);let k;if(46<b.length){if(92<b.length)throw Error("Flag string way too long!");k=b.substring(46,92).padEnd(46," ");b=b.substring(0,46)}b=b.padEnd(46," ");g(161791,h(b.substring(0,23),b.substring(23)));k&&
g(161839,h(k.substring(0,23),k.substring(23)));g(161925,h(e.substring(0,4),e.substring(4)));g(153366,"RANDOMIZER");"unstable"==STATUS$$module$version&&g(153404,"BETA");return d},patchBytes$$module$patch=(a,b,c)=>{for(let d=0;d<c.length;d++)a[b+16+d]=c[d]},patchWords$$module$patch=(a,b,c)=>{for(let d=0;d<2*c.length;d+=2)a[b+16+d]=c[d>>>1]&255,a[b+17+d]=c[d>>>1]>>>8},updateCoinDrops$$module$patch=(a,b)=>{b.disableShopGlitch()?patchWords$$module$patch(a,216030,[0,5,10,15,25,40,65,105,170,275,445,600,
700,800,900,1E3]):patchWords$$module$patch(a,216030,[0,1,2,4,8,16,30,50,100,200,300,400,500,600,700,800])},updateDifficultyScalingTables$$module$patch=(a,b,c)=>{const d=Array(48).fill(0).map((a,b)=>b);patchBytes$$module$patch(a,c.expand("DiffAtk"),d.map((a)=>Math.round(40+15*a/4)));patchBytes$$module$patch(a,c.expand("DiffDef"),d.map((a)=>4*a));const e=b.decreaseEnemyDamage()?16:48,f=b.decreaseEnemyDamage()?6:5.5;patchBytes$$module$patch(a,c.expand("DiffHP"),d.map((a)=>Math.min(255,e+Math.round(a*
f))));const g=b.expScalingFactor();patchBytes$$module$patch(a,c.expand("DiffExp"),d.map((a)=>{a=Math.floor(4*Math.pow(2,(16+9*a)/32)*g);return 128>a?a:Math.min(255,128+(a>>4))}));patchBytes$$module$patch(a,216E3,[0,2,6,10,14,18,32,24,20,0,2,6,10,14,18,16,32,20])},rescaleShops$$module$patch=(a,b,c)=>{const d=b.expand("BasePrices");var e=b.expand("InnPrices");const f={prices:138836,items:138792},g={prices:138704,items:138660},h=Array(48).fill(0).map((a,b)=>b);patchBytes$$module$patch(a,b.expand("ToolShopScaling"),
h.map((a)=>Math.round(8*Math.pow(2,a/10))));patchBytes$$module$patch(a,b.expand("ArmorShopScaling"),h.map((a)=>Math.round(8*Math.pow(2,(47-a)/12))));for(var k of[f,g]){const {prices:d,items:e}=k;for(b=0;44>b;b++)a[d+b+16]=BASE_PRICES$$module$patch[a[e+b+16]]?c?c.nextInt(32)+17:32:0}for(k=0;11>k;k++)a[e+k+16]=c?c.nextInt(40)+13:32;c=(b,c)=>{a[d+2*(b-13)+16]=c&255;a[d+2*(b-13)+17]=c>>>8};for(e=13;39>e;e++)c(e,BASE_PRICES$$module$patch[e]);c(39,20)},BASE_PRICES$$module$patch={13:4,14:16,15:50,16:325,
17:1E3,18:2E3,19:4E3,21:6,22:20,23:75,24:250,25:1E3,26:4800,29:25,30:30,31:45,32:40,33:36,34:200,35:150,36:80,38:300},rescaleMonsters$$module$patch=(a,b)=>{for(var c of SCALED_MONSTERS$$module$patch.keys())for(const a in b.objects){if(SCALED_MONSTERS$$module$patch.has(a))return;b.objects[c].objectDataBase==b.objects[a].objectDataBase&&(SCALED_MONSTERS$$module$patch[a]=SCALED_MONSTERS$$module$patch[c])}for(const d of SCALED_MONSTERS$$module$patch){const [e,{sdef:f,swrd:g,hits:h,satk:k,dgld:l,sexp:m}]=
d;a=b.objects[e].data;c=[87,94,104,125,136,151,155,158].includes(e)?1:0;a[2]|=128;a[6]=h;a[7]=k;a[8]=f|g<<4;a[9]=a[9]&224|c;a[16]=a[16]&15|l<<4;a[17]=m}b.objects[125].elements|=8},shuffleMonsters$$module$patch=(a,b,c,d)=>{a=new MonsterPool$$module$patch({});for(const c of b.locations)c.used&&a.populate(c);a.shuffle(c)},identifyKeyItemsForDifficultyBuffs$$module$patch=(a)=>{for(const b of a.itemGets)(a=ITEMS$$module$patch.get(b.item))&&a.key&&(b.key=!0)},SCALED_MONSTERS$$module$patch=new Map([[63,
