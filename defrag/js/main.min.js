...
BIGINT_OK$$module$bits_bigint&&BigInt(32);var module$bits_bigint={};module$bits_bigint.BitsBigInt=BitsBigInt$$module$bits_bigint;module$bits_bigint.BIGINT_OK=BIGINT_OK$$module$bits_bigint;const Bits$$module$bits=BIGINT_OK$$module$bits_bigint?BitsBigInt$$module$bits_bigint:BitsArray$$module$bits_array;var module$bits={};module$bits.Bits=Bits$$module$bits;let table$$module$crc32;const buildTable$$module$crc32=()=>{let a;const b=Array(256);for(let c=0;256>c;c++){a=c;for(let b=0;8>b;b++)a=a&1?3988292384^a>>>1:a>>>1;b[c]=a}return b},crc32$$module$crc32=(a)=>{table$$module$crc32||(table$$module$crc32=buildTable$$module$crc32());let b=-1;for(let c=0;c<a.length;c++)b=b>>>8^table$$module$crc32[(b^a[c])&255];return(b^-1)>>>0};var module$crc32={};module$crc32.crc32=crc32$$module$crc32;class Deque$$module$util{constructor(){this.buffer=Array(16);this.mask=15;this.size=this.end=this.start=0}get length(){return this.size}upsize(a){for(;this.mask<a;)this.end<=this.start&&(this.start+=this.mask+1),this.mask=this.mask<<1|1,this.buffer=this.buffer.concat(this.buffer);this.size=a}push(...a){this.upsize(this.size+a.length);for(const b of a)this.buffer[this.end]=b,this.end=this.end+1&this.mask}pop(){if(this.size)return this.end=this.end-1&this.mask,this.size--,this.buffer[this.end]}peek(){if(this.size)return this.buffer[this.end-
...
ye=(new Trigger$$module$nodes(b,"Talked to Amazones Queen")).get(pc),Eb=new Trigger$$module$nodes(b,"Entered Shyron"),ze=(new Trigger$$module$nodes(b,"Talked to Zebu in Shyron")).get(ic),Nc=new Trigger$$module$nodes(b,"Shyron Massacre"),Ae=(new Trigger$$module$nodes(b,"Saved Kensu")).get(A),Be=(new Trigger$$module$nodes(b,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$nodes(b,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$nodes(b,"Get Bow of Truth")).get(rc),Ee=(new Trigger$$module$nodes(b,
"Forged Crystalis")).get(pb),$a=(new Condition$$module$nodes(b,"Sword charge glitch")).option(D,U),Fe=(new Condition$$module$nodes(b,"Rabbit skip")).option(p,y),Ge=(new Condition$$module$nodes(b,"Teleport skip")).option(q,m),ab=(new Condition$$module$nodes(b,"Statue glitch")).option(n,r),He=(new Condition$$module$nodes(b,"Wild warp")).option(va,oa),bb=(new Condition$$module$nodes(b,"Any level 2 sword")).option(P,Ra).option(P,Ia).option(Q,Sa).option(Q,Ta).option(L,Ua).option(L,Va).option(J,Wa).option(J,
Xa),v=(new Condition$$module$nodes(b,"Destroy stone")).option(P,Qa).option(P,Ra).option(P,Ia).option($a,P,bb),w=(new Condition$$module$nodes(b,"Destroy ice")).option(Q,Qa).option(Q,Sa).option(Q,Ta).option($a,Q,bb),t=(new Condition$$module$nodes(b,"Cross rivers")).option(L,Qa).option(L,Ua).option(L,Va).option(A).option($a,L,bb),xa=(new Condition$$module$nodes(b,"Destroy iron")).option(J,Qa).option(J,Wa).option(J,Xa).option($a,J,bb),aa=(new Condition$$module$nodes(b,"Any sword")).option(P).option(Q).option(L).option(J),
Ie=(new Condition$$module$nodes(b,"Match insect sword (fire/water/thunder)")).option(Q).option(L).option(J).option(Ya,H.value?H:g,P),Je=(new Condition$$module$nodes(b,"Match vampire 2 sword (wind/water/thunder)")).option(P).option(L).option(J).option(H.value?H:g,Q),Oc=(new Condition$$module$nodes(b,"Speed boots")).option(fc,k),Pc=(new Condition$$module$nodes(b,"Climb slopes")).option(vb).option(A).option(Oc),Ke=(new Condition$$module$nodes(b,"Enter Mt Sabre North (rabbit)")).option(Ac).option(Fe),
Le=(new Condition$$module$nodes(b,"Enter Mt Sabre North (Teleport)")).option(sc).option(Ge,A),Qc=(new Condition$$module$nodes(b,"Asina in her room")).option(Fc),Me=(new Condition$$module$nodes(b,"Paralysis or Asina revealed")).option(Ja).option(Qc).option(ab),Rc=(new Condition$$module$nodes(b,"Ride dolphin")).option(yb,Ic),Ne=(new Condition$$module$nodes(b,"Ghetto flight")).option(l,Rc,vb),ba=(new Condition$$module$nodes(b,"Cross sea")).option(Rc).option(A),Oe=(new Condition$$module$nodes(b,"Cross whirlpool")).option(Db).option(A).option(Ne),
S=(new Condition$$module$nodes(b,"Refresh if needed")).option(Xb.value?Xb:g).option(Za),Sc=(new Condition$$module$nodes(b,"Wind magic")).option(F.value?F:g,S).option(Ra,Ia,S),Tc=(new Condition$$module$nodes(b,"Fire magic")).option(F.value?F:g,S).option(Sa,Ta,S),Uc=(new Condition$$module$nodes(b,"Water magic")).option(F.value?F:g,S).option(F,S).option(Ua,Va,S),Pe=(new Condition$$module$nodes(b,"Thunder magic")).option(F.value?F:g,S).option(F,S).option(Wa,S).option(Xa,S),Qe=(new Condition$$module$nodes(b,
"Flute of lime or glitch")).option(ub).option(ab),Re=(new Condition$$module$nodes(b,"Change or glitch")).option(pa).option(ab),Se=(new Condition$$module$nodes(b,"Change or glitch or paralysis")).option(pa).option(ab).option(Ja),Fb=(new Condition$$module$nodes(b,"Pass shooting statues")).option(tc).option(aa,Wb.value?Wb:g).option(Za,gc),Te=(new Condition$$module$nodes(b,"Healed dolphin if required")).option(Hc).option(Pd),Vc=(new Condition$$module$nodes(b,"Match sword of wind")).option(P).option(H.value?
H:g,aa),Wc=(new Condition$$module$nodes(b,"Match sword of fire")).option(Q).option(H.value?H:g,aa),Xc=(new Condition$$module$nodes(b,"Match sword of water")).option(L).option(H.value?H:g,aa),Ue=(new Condition$$module$nodes(b,"Match sword of thunder")).option(J).option(H.value?H:g,aa),Ve=(new Condition$$module$nodes(b,"Swamp run possible")).option(aa).option(Oc).option(Wd).option(Za),We=(new Condition$$module$nodes(b,"Insect possible to kill")).option(Ya),cb=(new Condition$$module$nodes(b,"Travel swamp")).option(Ya).option(Pa.value?
Pa:g,Ve),Xe=(new Condition$$module$nodes(b,"Calmed sea if required")).option(Db).option(Qd),Ye=(new Condition$$module$nodes(b,"Started windmill if required")).option(Ka).option(Sd),Ze=(new Condition$$module$nodes(b,"Telepathy if required for Deo")).option(fa).option(Ud),$e=e(0,"Vampire 1",aa).get(vb),af=e(1,"Insect",ec,Ie,We).get(Sa),bf=e(2,"Kelbesque 1",Vc,Sc).get(Ta),cf=e(12,"Vampire 2",Je).get(ke),Yc=e(4,"Sabera 1",Wc,Tc).get(lc),df=e(5,"Mado 1",Xc,Uc).get(Wa),ef=e(6,"Kelbesque 2",Vc,Sc).get(tb),
...
"Amazones"),B=new Area$$module$nodes(b,"Mt Sabre West"),u=new Area$$module$nodes(b,"Mt Sabre North"),db=new Area$$module$nodes(b,"Nadare's"),La=new Area$$module$nodes(b,"Oak"),ha=new Area$$module$nodes(b,"Waterfall Valley"),z=new Area$$module$nodes(b,"Portoa"),ia=new Area$$module$nodes(b,"Waterfall Cave"),C=new Area$$module$nodes(b,"Fog Lamp Cave"),ja=new Area$$module$nodes(b,"Kirisa Plant Cave"),ra=new Area$$module$nodes(b,"Angry Sea"),ka=new Area$$module$nodes(b,"Joel"),I=new Area$$module$nodes(b,
"Evil Spirit Island"),la=new Area$$module$nodes(b,"Sabera's Castle"),X=new Area$$module$nodes(b,"Swan"),x=new Area$$module$nodes(b,"Mt Hydra"),ma=new Area$$module$nodes(b,"Shyron"),sa=new Area$$module$nodes(b,"Styx"),ta=new Area$$module$nodes(b,"Goa"),eb=new Area$$module$nodes(b,"Draygonia Fortress 1"),Y=new Area$$module$nodes(b,"Draygonia Fortress 2"),Ba=new Area$$module$nodes(b,"Draygonia Fortress 3"),O=new Area$$module$nodes(b,"Draygonia Fortress 4"),G=new Area$$module$nodes(b,"Oasis Cave");new Area$$module$nodes(b,
...
w),Af=(new Location$$module$nodes(b,17,B,"Tunnel 1 (to Zebu)")).cave().connect(zf),Da=(new Location$$module$nodes(b,20,qa,"West")).overworld().connect(xf,Ye),Bf=(new Location$$module$nodes(b,20,qa,"South")).overworld().connect(Da,t),bd=(new Location$$module$nodes(b,21,qa,"East")).overworld().connect(Da).chest(dc,24),Na=(new Location$$module$nodes(b,24,za,"Town")).town().connect(Da).trigger(me,dc),Cf=(new Location$$module$nodes(b,25,qa,"Outside Stom's House")).town().connect(Da),Hb=(new Location$$module$nodes(b,
26,qa,"Swamp")).overworld().connect(bd,cb).trigger(Bb,yc,cb);(new Location$$module$nodes(b,26,qa,"Swamp Insect Area")).overworld().connect(Hb,cb).boss(af);const fb=(new Location$$module$nodes(b,27,Aa,"Town")).town().connect(Bf),gb=(new Location$$module$nodes(b,28,La,"Town")).town().connect(Hb,cb).trigger(xc);(new Location$$module$nodes(b,30,qa,"Stom's House")).house().connect(Cf).trigger(ne,xc);const Ea=(new Location$$module$nodes(b,32,B,"Entrance")).overworld().connect(Da).connect(Af),Df=(new Location$$module$nodes(b,
32,B,"Up Slope")).overworld().from(Ea,Pc).to(Ea),Ef=(new Location$$module$nodes(b,32,B,"Dead End (warp boots)")).overworld().chest(R,24,106),cd=(new Location$$module$nodes(b,33,B,"Upper")).overworld().from(Ea,A).to(Ea),Ff=(new Location$$module$nodes(b,33,B,"Tornel Dead End")).overworld().trigger(qe,Ia).chest(V,23,105),dd=(new Location$$module$nodes(b,34,B,"Tunnel 2a (fork at start)")).cave().connect(Ea);(new Location$$module$nodes(b,34,B,"Tunnel 2b (left branch to dead end)")).cave().connect(dd,w).connectTo(Ef);
const Gf=(new Location$$module$nodes(b,34,B,"Tunnel 2c (right branch to upper)")).cave().connect(dd,w),Hf=(new Location$$module$nodes(b,35,B,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(E,23,82),If=(new Location$$module$nodes(b,35,B,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,w).connectTo(cd),ed=(new Location$$module$nodes(b,36,B,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$nodes(b,36,B,"Tunnel 4b (out to upper)")).cave().connect(ed,
w).connectTo(cd);const Jf=(new Location$$module$nodes(b,37,B,"Tunnel 5 (tiny connector)")).cave().connect(ed),Kf=(new Location$$module$nodes(b,38,B,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);(new Location$$module$nodes(b,38,B,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,w).connectTo(Ff);const Lf=(new Location$$module$nodes(b,39,B,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$nodes(b,39,B,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,
w);(new Location$$module$nodes(b,39,B,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,w).chest(Ia,25);const hb=(new Location$$module$nodes(b,40,u,"Entrance")).overworld().connect(bd,Le,Ke),ib=(new Location$$module$nodes(b,40,u,"Upper")).overworld().from(hb,A).to(hb),Ib=(new Location$$module$nodes(b,40,u,"Summit (boss)")).overworld().from(ib,A).to(ib).boss(bf),fd=(new Location$$module$nodes(b,41,u,"Connector")).overworld(),Jb=(new Location$$module$nodes(b,41,u,"Middle Left")).overworld(),
...
(new Location$$module$nodes(b,57,u,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(ib);const Yf=(new Location$$module$nodes(b,60,db,"Inn")).shop(),Zf=(new Location$$module$nodes(b,61,db,"Tool Shop")).shop(E,K,M,R),$f=(new Location$$module$nodes(b,62,db,"Back Room")).house(),Kb=(new Location$$module$nodes(b,64,ha,"Summit")).overworld().connect(Xf,nf),jb=(new Location$$module$nodes(b,64,ha,"Northwest")).overworld().from(Kb).to(Kb,A),ag=(new Location$$module$nodes(b,64,ha,"Northeast")).overworld().connect(jb,
...
v);(new Location$$module$nodes(b,71,ja,"Meadow")).overworld().connect(hg).chest(oc,14);const ig=(new Location$$module$nodes(b,72,C,"Tunnel 1a (entrance)")).cave().connect(ag),nd=(new Location$$module$nodes(b,72,C,"Tunnel 1b (past wall)")).cave().connect(ig,v);(new Location$$module$nodes(b,72,C,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(nd,v).chest(wa,24);const jg=(new Location$$module$nodes(b,73,C,"Tunnel 2 (tiny connector)")).cave().connect(nd),od=(new Location$$module$nodes(b,74,C,"Tunnel 3a (upper branch)")).cave().connect(jg);
(new Location$$module$nodes(b,74,C,"Tunnel 3b (dead end, mimic)")).cave().connect(od,v).chest(N,21,112);const pd=(new Location$$module$nodes(b,74,C,"Tunnel 3c (short passage with mimic)")).cave().connect(od,v).chest(N,22,113),kg=(new Location$$module$nodes(b,74,C,"Tunnel 3d (lower branch)")).cave().connect(pd,v);(new Location$$module$nodes(b,75,C,"Dead end loop")).cave().connect(kg);const qd=(new Location$$module$nodes(b,76,C,"Tunnel 4a (right branch over bridge)")).cave().connect(pd),lg=(new Location$$module$nodes(b,
76,C,"Tunnel 4b (past wall over bridge)")).cave().connect(qd,v),mg=(new Location$$module$nodes(b,77,C,"Tunnel 5a (from left branch)")).cave().connect(qd),ng=(new Location$$module$nodes(b,77,C,"Tunnel 5b (reconvergence)")).cave().connect(mg,v).connect(lg),og=(new Location$$module$nodes(b,77,C,"Tunnel 5c (between walls)")).cave().connect(ng,v),pg=(new Location$$module$nodes(b,77,C,"Tunnel 5d (under bridge)")).cave().connect(og,v),qg=(new Location$$module$nodes(b,78,C,"Tunnel 6a (over second bridge)")).cave().connect(pg),
rg=(new Location$$module$nodes(b,78,C,"Tunnel 6b (past wall)")).cave().connect(qg,v),sg=(new Location$$module$nodes(b,79,C,"Tunnel 7a (under second bridge)")).cave().connect(rg);(new Location$$module$nodes(b,79,C,"Tunnel 7b (fog lamp)")).cave().connect(sg,v).chest(jc,19);const ua=(new Location$$module$nodes(b,80,z,"Town")).town().connect(jb),rd=(new Location$$module$nodes(b,81,z,"Fishherman Island")).town().connect(ua);(new Location$$module$nodes(b,82,ha,"Mesia Shrine")).cave().trigger(Fc).connect(cg,
...
Cb);(new Location$$module$nodes(b,98,ka,"Lighthouse")).misc().connect(vd).trigger(ve,wb);const kb=(new Location$$module$nodes(b,100,z,"Underground Channel 1 (from throne room)")).sea().trigger(Dc),Eg=(new Location$$module$nodes(b,100,z,"Underground Channel 2 (to fortune teller)")).sea().connect(kb,t),wd=(new Location$$module$nodes(b,100,z,"Underground Channel 3 (from fortune teller)")).sea().connect(kb,A),xd=(new Location$$module$nodes(b,100,z,"Underground Channel 4 (asina)")).sea().connect(wd,t),
Fg=(new Location$$module$nodes(b,100,z,"Underground Channel 5 (dolphin)")).sea().connect(xd,t).trigger(Hc,E,Gc);(new Location$$module$nodes(b,100,z,"Underground Channel 6 (water)")).sea().connect(Fg,ba).connectTo(Fa,ba).chest(nc,17);const Nb=(new Location$$module$nodes(b,101,I,"Zombie Town")).town(),Gg=(new Location$$module$nodes(b,104,I,"Tunnel 1 (entrance)")).sea().connect(Fa,Jc,ba),yd=(new Location$$module$nodes(b,105,I,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$nodes(b,105,
I,"Tunnel 2b (dead end to left)")).cave().connect(yd,t);const Hg=(new Location$$module$nodes(b,105,I,"Tunnel 2c (across first river)")).cave().connect(yd,t),zd=(new Location$$module$nodes(b,105,I,"Tunnel 2d (across second river)")).cave().connect(Hg,t);(new Location$$module$nodes(b,105,I,"Tunnel 2e (dead end, magic ring)")).cave().connect(zd,v).chest(V,29);const Ig=(new Location$$module$nodes(b,105,I,"Tunnel 2f (stair down)")).cave().connect(zd,v),Jg=(new Location$$module$nodes(b,106,I,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(Nb).chest(wa,
25,92),Kg=(new Location$$module$nodes(b,106,I,"Tunnel 3b (left area toward items)")).cave().connect(Jg,v),Lg=(new Location$$module$nodes(b,107,I,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(N,14,115);(new Location$$module$nodes(b,107,I,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,t).chest(he,15);const Ob=(new Location$$module$nodes(b,108,la,"Floor 1")).fortress().connect(Nb),Mg=(new Location$$module$nodes(b,108,la,"Miniboss")).fortress().boss(cf).connect(Ob);(new Location$$module$nodes(b,
109,la,"Floor 2a (left stair)")).fortress().connect(Ob).chest(M,19);const Ng=(new Location$$module$nodes(b,109,la,"Floor 2b (right stair)")).fortress().connect(Mg).chest(E,30,85),Og=(new Location$$module$nodes(b,110,la,"Floor 3a (toward boss)")).fortress().connect(Ng),Ad=(new Location$$module$nodes(b,110,la,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$nodes(b,110,la,"Boss")).fortress().boss(Yc).connect(Ad);(new Location$$module$nodes(b,110,la,"Floor 3c (back room trap)")).fortress().from(Ad).to(Ob);
...
183,O,"Exit Stairs")).fortress(),Oh=(new Location$$module$nodes(b,184,G,"Entrance Back (behind river)")).cave().connect(Od).chest(M,13,90);(new Location$$module$nodes(b,184,G,"Entrance Front")).cave().connect(Oh,A).connectTo(Qb).connectTo(nb);const Ph=(new Location$$module$nodes(b,185,Ba,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$nodes(b,185,Ba,"Asina")).fortress().connect(Ph).connectTo(Ub);(new Location$$module$nodes(b,186,O,"Kensu")).fortress().connect(Nd).connectTo(Od).trigger(Ae,
zb);(new Location$$module$nodes(b,187,ta,"House")).house().connect(Oa).trigger(Ce,pa,zb);(new Location$$module$nodes(b,188,ta,"Inn")).shop().connect(Oa,Eb);(new Location$$module$nodes(b,190,ta,"Tool Shop")).shop(E,K,R,M).connect(Oa,Eb);(new Location$$module$nodes(b,191,ta,"Tavern")).shop().connect(Oa);(new Location$$module$nodes(b,192,W,"Elder House")).house().connect(na).trigger(uc);(new Location$$module$nodes(b,193,W,"Rabbit Hut")).house().connect(na).trigger(Ac,zc,fa);(new Location$$module$nodes(b,
194,W,"Inn")).shop().connect(na);(new Location$$module$nodes(b,195,W,"Tool Shop")).shop(E,K,R,M).connect(na);(new Location$$module$nodes(b,196,W,"Armor Shop")).shop($d,Yb).connect(na);(new Location$$module$nodes(b,197,W,"Student House")).house().connect(na).trigger(vc);(new Location$$module$nodes(b,198,za,"Tavern")).house().connect(Na);(new Location$$module$nodes(b,199,za,"Pawn Shop")).shop().connect(Na);(new Location$$module$nodes(b,200,za,"Inn")).shop().connect(Na);(new Location$$module$nodes(b,
201,za,"Armor Shop")).shop(ae,Yb,Xd).connect(Na);(new Location$$module$nodes(b,203,za,"Tool Shop")).shop(E,K,R).connect(Na);(new Location$$module$nodes(b,205,La,"Elder House")).house().from(gb,fa).trigger(pe,Bb);(new Location$$module$nodes(b,206,La,"Mother's House")).house().from(gb,fa).trigger(yc,fa).trigger(oe,Bb);(new Location$$module$nodes(b,207,La,"Tool Shop")).shop(E,K,M).from(gb,fa);(new Location$$module$nodes(b,208,La,"Inn")).shop().from(gb,fa);(new Location$$module$nodes(b,209,Aa,"Inn")).shop().connect(fb);
(new Location$$module$nodes(b,210,Aa,"Tool Shop")).shop(R,M,wa).connect(fb);(new Location$$module$nodes(b,211,Aa,"Armor Shop")).shop(bc,Zb,$b,qb).connect(fb);const Qh=(new Location$$module$nodes(b,212,Aa,"Queen's House")).house().from(fb,Se).trigger(ye,pa,oc);(new Location$$module$nodes(b,213,db,"Nadare's")).house().connect(hb).connectTo(Yf).connectTo(Zf).connectTo($f);(new Location$$module$nodes(b,214,z,"Fisherman's House")).house().connect(rd).trigger(Cb,jc,yb,Te);const Vb=(new Location$$module$nodes(b,
215,z,"Palace Entrance")).house().connect(ua);(new Location$$module$nodes(b,216,z,"Fortune Teller Front")).house().connect(ua).trigger(Cc,Bc);(new Location$$module$nodes(b,216,z,"Fortune Teller Back")).house().connect(Eg).connect(wd);(new Location$$module$nodes(b,217,z,"Pawn Shop")).shop().connect(ua);(new Location$$module$nodes(b,218,z,"Armor Shop")).shop(be,bc,Zb).connect(ua);(new Location$$module$nodes(b,220,z,"Inn")).shop().connect(ua);(new Location$$module$nodes(b,221,z,"Tool Shop")).shop(E,
wa,rb,R).connect(ua);(new Location$$module$nodes(b,222,z,"Palace Left")).house().connect(Vb);(new Location$$module$nodes(b,223,z,"Palace Throne Room")).house().connect(Vb).to(kb,Me).from(kb).trigger(Bc).trigger(se,Cc,Dc);(new Location$$module$nodes(b,224,z,"Palace Right")).house().connect(Vb);(new Location$$module$nodes(b,225,z,"Asina's Room")).house().connect(xd).trigger(Gc,Qc);(new Location$$module$nodes(b,226,Aa,"Queen Downstairs")).house().connect(Qh).chest(Va,13);(new Location$$module$nodes(b,
227,ka,"Elder's House")).house().connect(lb).trigger(Jc);(new Location$$module$nodes(b,228,ka,"Shed")).house().connect(lb).to(Pg,kc);(new Location$$module$nodes(b,229,ka,"Tool Shop")).shop(E,K,M,wa).connect(lb);(new Location$$module$nodes(b,231,ka,"Inn")).shop().connect(lb);const Rh=(new Location$$module$nodes(b,232,I,"Zombie Town House")).house().connect(Nb);(new Location$$module$nodes(b,233,I,"Zombie Town Basement")).house().connect(Rh).trigger(ue,Yc);(new Location$$module$nodes(b,235,X,"Tool Shop")).shop(E,
...
$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$depgraph(d);d.shuffleShops()&&f.shuffleShops(b);const g=f.nodes.filter((a)=>a instanceof Slot$$module$nodes&&a.slots&&a.slotName);d||(d=new FlagSet$$module$flagset("Sbkm Sct"));var h={};for(var k of g)if(k instanceof Slot$$module$nodes&&k.slots){var l=k.slotType[0];(h[l]=h[l]||[]).push(k)}k=[];l=[];var n={};for(var r of d.flags.S||[]){var q=[];for(var m of r){n[m]=!0;for(var p of h[m])q.push(p),l.push([p,k.length])}k.push(q)}for(var y of"bc")if(n[y])for(r=
h[y],m=r.map((a)=>[a.item,a.itemIndex]),b.shuffle(m),p=0;p<r.length;p++)r[p].set(...m[p]);q=(a)=>g.find((b)=>b.vanillaItemName===a);h=q("Sword of Wind");y=q("Sword of Fire");r=q("Ball of Wind");m=q("Ball of Fire");p=q("Statue of Onyx");q=q("Gas Mask");n.k&&b.nextInt(2)&&(y.swap(h),m.swap(r));n.k&&!b.nextInt(3)&&p.swap(q);n=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(y=0;1E3>y;y++){e&&0==y%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));b.shuffle(l);for(var D of k)b.shuffle(D);
r=k.map(()=>-1);m=n[b.nextInt(n.length)];p=[];q=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<m;a++){const [b,c]=l[a],d=k[c][++r[c]];q(b,d)&&(b.swap(d),p.push([b,d]))}if(!p.length)continue;const {win:a,path:c}=f.traverse({wanted:g,dfs:!1});if(a)h=c;else for(;p.length;){const [a,b]=p.pop();a.swap(b)}}a&&f.write(a);if(c){c.items=[];c.route=[];for(const a of h){const [b,
d]=a;c.route.push(d);D=f.nodes[b];null!=D.slotName&&(k=D.slotName,0>k.indexOf(D.orig)&&(k+=` (normally ${D.vanillaItemName})`),c.items.push({slotIndex:D.slotIndex,itemIndex:D.itemIndex,origName:D.vanillaItemName,slotName:D.slotName,itemName:D.item.name,text:`${D.item.name}: ${k}`}))}}}),shuffle2$$module$depgraph=(a,b,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$depgraph(d);d.shuffleShops()&&f.shuffleShops(b);const g=f.integrate();e&&e.addTasks(1E3);for(let h=
0;1E3>h;h++){if(yield shuffle3$$module$depgraph(f,g,a,b,c,d,e)){console.log(`success after ${h} attempts`);return}e&&(e.addCompleted(1),0===h%50&&(yield new Promise(requestAnimationFrame)))}return shuffle$$module$depgraph(a,b,c,d,e)}),shuffle3$$module$depgraph=(a,b,c,d,e,f,g)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const g=e&&e.stats;var k=a.nodes.filter((a)=>a instanceof Slot$$module$nodes&&a.slots&&a.slotName);const l=new Map(d.shuffle(k.map((a)=>[a,[a.item,a.itemIndex]]))),n=
new Set(d.shuffle(k)),r=new Map,q={};g&&g.seeds++;f||(f=new FlagSet$$module$flagset("Sbkm Sct"));(f.flags.S||[]).forEach((a,b)=>{for(const c of a)q[c]=b});for(var m of n)r.set(m.item,m);let p=new Set;const y=(a,b)=>{if(null==q[a.slotType?a.slotType[0]:"c"])return a==b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!=b.item.inventoryRow&&a.requiresUnique||"armor"==b.item.inventoryRow&&!a.isChest())return!1;if(f.guaranteeSword()){if(0===a.slotIndex)return 4>b.item.id;if(4>b.item.id&&(p.add(b),4===p.size))return 0===
a.slotIndex}return q[a.slotType?a.slotType[0]:"c"]==q[b.slotType?b.slotType[0]:"c"]};m=b.assumedFill(d,(a,b)=>y(a,r.get(b)));if(null==m){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const D=new Map;for(var U=0;U<m.length;U++){var va=m[U];if(null!=va){var oa=r.get(b.item(va));va=l.get(oa);l.delete(oa);oa=b.location(U);D.set(oa,va);n.delete(oa)}}U=(a,b,c)=>{c=void 0===c?"":c;for(const c of n)if(y(c,a))return D.set(c,b),n.delete(c),l.delete(a),!0;g&&("traps"==c?g.endState.traps++:"chest"==
c?g.endState.chest++:g.endState.misc++);return!1};for(var F of l){const [a,b]=F;if(a.isMimic()&&!U(a,b,"traps"))return!1}for(const a of l){const [b,c]=a;if(b.needsChest()&&!U(b,c,"chest"))return!1}for(const a of l){const [b,c]=a;if(!U(b,c))return!1}for(const a of D){const [b,c]=a;b.set(...c)}const {win:H,path:Pa}=a.traverse({wanted:k,dfs:!1});if(!H)return g&&g.endState.no_win++,!1;c&&a.write(c);if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,m));e.items=[];e.route=[];for(const b of Pa){const [c,
d]=b;e.route.push(d);k=a.nodes[c];null!=k.slotName&&(F=k.slotName,0>F.indexOf(k.orig)&&(F+=` (normally ${k.vanillaItemName})`),e.items.push({slotIndex:k.slotIndex,itemIndex:k.itemIndex,origName:k.vanillaItemName,slotName:k.slotName,itemName:k.item.name,text:`${k.item.name}: ${F}`}))}return!0});var module$depgraph={};module$depgraph.generate=generate$$module$depgraph;module$depgraph.shuffle=shuffle$$module$depgraph;module$depgraph.shuffle2=shuffle2$$module$depgraph;module$depgraph.shuffle3=shuffle3$$module$depgraph;class FetchReader$$module$fetchreader{constructor(a){this.path=void 0===a?"js/":a}read(a){const b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){return yield(yield fetch(b.path+a)).text()})}}var module$fetchreader={};module$fetchreader.FetchReader=FetchReader$$module$fetchreader;const Edge$$module$graph={},EdgeT$$module$graph={};Edge$$module$graph.of=(...a)=>a.map((a)=>a.uid);class Node$$module$graph{constructor(a,b){this.graph=a;this.name=b;this.uid=a.nodes.length;a.nodes.push(this)}get nodeType(){return"Node"}toString(){return`${this.nodeType} ${this.name}`}edges(a){return[]}write(a){}}
class Graph$$module$graph{constructor(){this.nodes=[]}traverse(a={}){const {wanted:b=void 0,dfs:c=!1}=a;a=new Deque$$module$util;const d=new Map,e=new Map;for(var f of this.nodes)for(var g of f.edges()){var h=g.join(" ");for(var k=1;k<g.length;k++){const a=g[k];e.has(a)||e.set(a,new Map);e.get(a).set(h,g)}1==g.length&&(h=g[0],d.has(h)||(a.push(h),d.set(h,g)))}f=new Set((b||this.nodes).map((a)=>a instanceof Node$$module$graph?a.uid:a));for(g=new Map;f.size&&a.length;){h=c?a.pop():a.shift();f.delete(h);
a:for(const b of(e.get(h)||g).values())if(h=b[0],!d.has(h)){for(k=1;k<b.length;k++)if(!d.has(b[k]))continue a;d.set(h,b);a.push(h)}}return{win:!f.size,seen:d,path:[...d.values()].map(([a,...b])=>{const c=(a)=>[this.nodes[a]];return[a,[...c(a)," (",b.map((a)=>c(a).join("").replace(/\s+\(.*\)/,"")).join(", "),")"].join("")]})}}}
...
for(var e of a.values())for(var f of this.addRoute([b,...c,...e]))d.set(f.label,f);return[...d.values()]}}if(!a)break}e=[...c].sort();c=new Set(e);e=e.join(" ");f=this.nodes[b];if(f.has(e))return[];for(const [a,b]of f){if(containsAll$$module$graph(c,b))return[];containsAll$$module$graph(b,c)&&f.delete(a)}f.set(e,c);return[new SparseRoute$$module$graph(b,c,`${b}:${e}`)]}finalize(a){if(!this.finalized[a]){this.finalized[a]=!0;for(let b=0;b<this.nodes.length;b++){const c=this.nodes[b];if(c.size)for(const [d,
...
this)}swap(a){const b=this.item,c=this.itemIndex;this.set(a.item,a.itemIndex);a.set(b,c)}key(){this.slotType="key";return this}bonus(){this.slotType="bonus";return this}direct(a){this.slots.push((b,c)=>{write$$module$nodes(b,a,c.itemIndex)});return this}npcSpawn(a,b=null,c=0){this.slots.push((d,e)=>{let f=addr$$module$nodes(d,116192,81920,a);for(;null!=b&&d[f]!=b;){for(f++;!(d[f]&128);)f+=2,checkBounds$$module$nodes(f,d,this.name2,b);f+=2;checkBounds$$module$nodes(f,d,this.name2,b)}f+=2*c+1;d[f]&=
-2;d[f]|=2;write$$module$nodes(d,f+1,e.itemIndex)});return this}dialog(a,b=null,c=0,d=null){this.slots.push((e,f)=>{let g=addr$$module$nodes(e,117085,81920,a);for(;!(e[g]&128);)g+=4,checkBounds$$module$nodes(g,e,this.name2);g+=4;let h=0;for(;255!=e[g];)null!=b&&e[g]==b&&(h=e[g+1]),g+=2,checkBounds$$module$nodes(g,e,b);for(g+=h+1;c;){if(e[g]&64){for(g+=5;!(e[g]&64);)g+=2,checkBounds$$module$nodes(g,e,this.name2);g+=2}else g+=5;--c}if(null!=d)for(g+=5;d;)g+=2,--d;e[g]&=-2;e[g]|=2;write$$module$nodes(e,
g+1,f.itemIndex)});return this}trigger(a,b=0,c=null){this.slots.push((d,e)=>{let f=addr$$module$nodes(d,123258,81920,a&127);if(null==c)f+=2*b;else{for(;!(d[f]&128);)f+=2,checkBounds$$module$nodes(f,d,this.name2);f=f+4+2*c}d[f]&=-2;d[f]|=2;write$$module$nodes(d,f+1,e.itemIndex)});return this}}class BossDrop$$module$nodes extends Slot$$module$nodes{get nodeType(){return"BossDrop"}}
...
4<=e.sells.length?g.push(d):e.sells.push(d));for(const {shops:a}of[b,c])for(const b of a)b.sells.sort((a,b)=>a.id-b.id)}integrate(a={}){const {tracker:b=!1}=a;var c=!b;const d=new SparseDependencyGraph$$module$graph(this.nodes.length),e=[],f=[],g=new Set,h=new Map;var k=[],l=[];const n=[];var r=[];const q=[];a=new Set;for(var m of this.nodes)if(m instanceof Location$$module$nodes){if(m.isStart){const [a]=d.addRoute([m.uid]);h.set(a.label,a)}e[m.uid]=[];f[m.uid]=[];for(const a of m.connections)g.has(a)||
(g.add(a),a.bidi&&g.add(a.reverse()));for(const a of m.chests)d.addRoute([a.uid,m.uid])}else if(m instanceof ItemGet$$module$nodes&&"Medical Herb"===m.name&&(d.addRoute([m.uid]),d.finalize(m.uid)),m instanceof Option$$module$nodes)k.push(m);else if(m instanceof TrackerNode$$module$nodes)l.push(m);else if(m instanceof Condition$$module$nodes)n.push(m);else if(m instanceof Trigger$$module$nodes)r.push(m);else if(m instanceof ItemGet$$module$nodes)q.push(m);else if(m instanceof Slot$$module$nodes)a.add(m);
else if(!(m instanceof Area$$module$nodes))throw Error(`Unknown node type: ${m.nodeType}`);for(const a of g)e[a.from.uid].push(a),f[a.to.uid].push(a);m=(a)=>{for(const c of a){for(const a of c.edges({tracker:b}))d.addRoute(a);d.finalize(c.uid)}};m(k);c&&m(l);m(r);for(c=h.values();!(k=c.next()).done;){k=k.value;l=k.target;for(var p of e[l]){l=[p.to.uid,...k.deps];for(r=p.deps.length-1;0<=r;r--)l.push(p.deps[r].uid);p.from.bossNode&&l.push(p.from.bossNode.uid);for(const a of d.addRoute(l))h.has(a.label)||
h.set(a.label,a)}}m(n);for(p=0;p<this.nodes.length;p++)this.nodes[p]instanceof ItemGet$$module$nodes||this.nodes[p]instanceof TrackerNode$$module$nodes||d.finalize(p);p=new LocationList$$module$nodes(this);for(const b of a)for(const a of d.nodes[b.uid].values())p.addRoute([b.uid,...a]);return p}}
class LocationList$$module$nodes{constructor(a){this.worldGraph=a;this.uidToLocation=[];this.locationToUid=[];this.uidToItem=[];this.itemToUid=[];this.routes=[];this.unlocks=[];this.win=null}item(a){return this.worldGraph.nodes[this.itemToUid[a]]}location(a){return this.worldGraph.nodes[this.locationToUid[a]]}addRoute(a){let b=Bits$$module$bits.of(),c;const d=[];for(let e=a.length-1;0<=e;e--){const f=e?this.uidToItem:this.uidToLocation,g=e?this.itemToUid:this.locationToUid,h=a[e];let k=f[h];null==
k&&(k=g.length,g.push(h),f[h]=k,e||null!=this.worldGraph.nodes[h].slotName||(this.win=k));e?(b=Bits$$module$bits.with(b,k),d.push(this.unlocks[k]||(this.unlocks[k]=new Set))):c=k}(this.routes[c]||(this.routes[c]=[])).push(b);for(const a of d)a.add(c)}canReach(a,b){a=this.uidToLocation(a.uid);a=this.routes[a];for(let c=0;c<a.length;c++)if(Bits$$module$bits.containsAll(b,a[c]))return!0;return!1}traverse(a=Bits$$module$bits.of(),b=[]){a=Bits$$module$bits.clone(a);const c=new Set;let d=new Set;for(var e=
0;e<this.locationToUid.length;e++)d.add(e);e=d[Symbol.iterator]();for(var f;!(f=e.next()).done;){f=f.value;d.delete(f);if(c.has(f))continue;const e=this.routes[f];for(let g=0;g<e.length;g++)if(Bits$$module$bits.containsAll(a,e[g])){c.add(f);if(b[f]){a=Bits$$module$bits.with(a,b[f]);for(let a of this.unlocks[b[f]])d.add(a)}break}}return c}traverseDepths(a){let b=Bits$$module$bits.of(),c=0;const d=[],e={};let f=new Set;for(var g=0;g<this.locationToUid.length;g++)f.add(g);f.add(e);g=f[Symbol.iterator]();
for(var h;!(h=g.next()).done;){h=h.value;f.delete(h);if(h===e){f.size&&f.add(e);c++;continue}if(null!=d[h])continue;const g=this.routes[h];for(let e=0;e<g.length;e++)if(Bits$$module$bits.containsAll(b,g[e])){d[h]=c;if(a[h]){b=Bits$$module$bits.with(b,a[h]);for(let b of this.unlocks[a[h]])f.add(b)}break}}return d}toString(){const a=[];for(let b=0;b<this.routes.length;b++){const c=this.worldGraph.nodes[this.locationToUid[b]],d=this.routes[b],e=[];for(let a=0;a<d.length;a++){const b=[];for(const c of Bits$$module$bits.bits(d[a]))b.push(this.worldGraph.nodes[this.itemToUid[c]]);
e.push("("+b.join(" & ")+")")}a.push(`${c}: ${e.join(" | ")}`)}return a.join("\n")}assumedFill(a,b=(a,b)=>!0,c=FillStrategy$$module$nodes){const d=c.shuffleItems(this.itemToUid.map((a)=>this.worldGraph.nodes[a]),a);let e=Bits$$module$bits.from(d);const f=Array(this.locationToUid.length).fill(null);for(;d.length;){const g=d.pop();if(!Bits$$module$bits.has(e,g))continue;const h=this.worldGraph.nodes[this.itemToUid[g]];e=Bits$$module$bits.without(e,g);const k=[...this.traverse(e,f)].filter((a)=>null==
f[a]);c.shuffleSlots(h,k,a);let l=!1;for(const a of k)if(null==f[a]&&a!=this.win&&b(this.worldGraph.nodes[this.locationToUid[a]],h)){if(100<a)throw Error("WTF");f[a]=g;l=!0;break}if(!l)return null}return f}}class FillStrategy$$module$nodes{shuffleSlots(a,b,c){}static shuffleSlots(a,b,c){c.shuffle(b)}shuffleItems(a,b){}static shuffleItems(a,b){const c=[];for(let b=0;b<a.length;b++){const {shufflePriority:d=1}=a[b];for(let a=0;a<d;a++)c.push(b)}b.shuffle(c);return c}}
...
g=concatIterables$$module$rom$util(b.entrances),h=[...concatIterables$$module$rom$util(b.exits),255],k=[...concatIterables$$module$rom$util(b.flags),255],l=concatIterables$$module$rom$util(b.pits),[n,r,q,m,p,y]=yield Promise.all([d(e,"Layout"),d(f,"Graphics"),d(g,"Entrances"),d(h,"Exits"),d(k,"Flags"),...l.length?[d(l,"Pits")]:[]]);e=[n&255,(n>>>8)-192,r&255,(r>>>8)-192,q&255,(q>>>8)-192,m&255,(m>>>8)-192,p&255,(p>>>8)-192,...y?[y&255,(y>>8)-192]:[]];d=yield d(e,"MapData");writeLittleEndian$$module$rom$util(a.rom,
...
console.log(`Tile ${hex$$module$rom$util(a)}: ${e}`)}swapMetatiles(a,...b){var c=new Map,d=seq$$module$rom$util(256);const e=new Map,f=(a)=>Array.isArray(a)?a[0]:0>a?~a:a;for(var g of b){for(var h=0;h<g.length-1;h++)if(Array.isArray(g[h])){var k=g[h];e.set(k[0],k[1]);g[h]=k[0]}for(h=0;h<g.length-1;h++){k=g[h];const a=g[h+1];0>k||0>a||(c.set(a,k),d[a]=k)}}g=new Set;c=new Set;a=new Set(a);for(var l of this.locations)if(l.used&&a.has(l.tileset)){c.add(l.tileEffects);for(var n of l.allScreens())g.add(n)}for(var r of g)for(var q of r.tiles)for(l=
0;l<q.length;l++)q[l]=d[q[l]];for(var m of a){d=this.tilesets[(m&127)>>>2];for(var p of b)for(r=0;r<p.length-1;r++){q=f(p[r]);l=f(p[r+1]);for(n=0;4>n;n++)d.tiles[n][q]=d.tiles[n][l];d.attrs[q]=d.attrs[l];if(32>l&&d.alternates[l]!==l){if(32<=q)throw Error(`Cannot unflag: ${m} ${q} ${l} ${d.alternates[l]}`);d.alternates[q]=d.alternates[l]}}for(var y of e){const [a,b]=y;d.alternates[a]=b}}for(const a of c){m=this.tileEffects[a-179];for(const a of b)for(p=0;p<a.length-1;p++)y=f(a[p]),d=f(a[p+1]),m.effects[y]=
m.effects[d];for(const a of e.keys())m.effects[a]|=8}}}
...
return Math.min(AM$$module$random*this.iy,RNMX$$module$random)}nextInt(a){return Math.floor(this.next()*a)}shuffle(a){for(let b=a.length;b;){const c=this.nextInt(b--);[a[b],a[c]]=[a[c],a[b]]}return a}}var module$random={};module$random.Random=Random$$module$random;const STATUS$$module$version="unstable",VERSION$$module$version="defrag",LABEL$$module$version="defrag abecaea",HASH$$module$version="abecaeabacc09ce4c3add8ab59fc6ad6984d8dd7",DATE$$module$version=new Date(1556602512E3);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$flagset(b.flags):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$patch(a,parseSeed$$module$patch(b.seed),d,new FetchReader$$module$fetchreader(c))})}};
...
_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword()},k=new Assembler$$module$6502,l=(b)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){k.assemble(yield d.read(b),b);k.patchRom(a)});var n=Object.keys(h).filter((a)=>h[a]).map((a)=>`define ${a} 1\n`).join("");k.assemble(n,"flags.s");yield l("preshuffle.s");g=new Random$$module$random(g);yield shuffle2$$module$depgraph(a,g,e,c,f);rescaleShops$$module$patch(a,k,c.bargainHunting()?g:null);n=new Rom$$module$rom(a);rescaleMonsters$$module$patch(a,
n);c.shuffleMonsters()&&shuffleMonsters$$module$patch(a,n,g);identifyKeyItemsForDifficultyBuffs$$module$patch(n);c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$patch(n);addCordelWestTriggers$$module$patch(n,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$patch(n);c.storyMode()&&storyMode$$module$patch(n);c.chargeShotsOnly()&&disableStabs$$module$patch(n);c.orbsOptional()&&orbsOptional$$module$patch(n);
closeCaveEntrances$$module$patch(n,c);misc$$module$patch(n,c);yield n.writeData();return yield postParsedShuffle$$module$patch(a,g,b,c,k,l)}),postParsedShuffle$$module$patch=(a,b,c,d,e,f)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){yield f("postshuffle.s");updateDifficultyScalingTables$$module$patch(a,d,e);updateCoinDrops$$module$patch(a,d);shuffleRandomNumbers$$module$patch(a,b);return stampVersionSeedAndHash$$module$patch(a,c,d)}),misc$$module$patch=(a,b)=>{},closeCaveEntrances$$module$patch=
...
{sdef:f,swrd:g,hits:h,satk:k,dgld:l,sexp:n}]=d;a=b.objects[e].data;c=[87,94,104,125,136,151,155,158].includes(e)?1:0;a[2]|=128;a[6]=h;a[7]=k;a[8]=f|g<<4;a[9]=a[9]&224|c;a[16]=a[16]&15|l<<4;a[17]=n}b.objects[125].elements|=8},shuffleMonsters$$module$patch=(a,b,c,d)=>{a=new MonsterPool$$module$patch({});for(const c of b.locations)c.valid&&a.populate(c);a.shuffle(c)},identifyKeyItemsForDifficultyBuffs$$module$patch=(a)=>{for(const b of a.itemGets)(a=ITEMS$$module$patch.get(b.item))&&a.key&&(b.key=!0)},
...
d.id.toString(16).padStart(2,0)]=[];const {maxFlyers:g,nonFlyers:h={},fixedSlots:k={}}=MONSTER_ADJUSTMENTS$$module$patch[d.id]||{};let l=k.pat0||null,n=k.pat1||null,r=k.pal2||null,q=k.pal3||null,m=g,p=!1;for(const a of d.spawns)if(a.isChest()&&(p=!0),a.isMonster()){var b=a.monsterId;126==b||127==b||159==b?n=98:143==b&&(l=97)}if(21==d.id||71==d.id)p=!1;f.push(`Initial pass: ${[p,l,n,r,q].join(", ")}`);b=(a)=>{var b=FLYERS$$module$patch.has(a.id),c=MOTHS_AND_BATS$$module$patch.has(a.id);if(b){if(!m)return!1;
--m}if(null!=r&&null!=a.pal2&&r!=a.pal2||null!=q&&null!=a.pal3&&q!=a.pal3)return!1;var g=!p||TREASURE_CHEST_BANKS$$module$patch.has(a.pat);let k;if(d.rom.objects[a.id].child||RETAIN_SLOTS$$module$patch.has(a.id)){const b=(k=a.patBank)?n:l;if(null!=b&&b!=a.pat)return!1;if(k)n=a.pat;else if(g)l=a.pat;else return!1;f.push(`  Adding ${a.id.toString(16)}: pat(${k}) <-  ${a.pat.toString(16)}`)}else if(null==l&&g||l==a.pat)l=a.pat,k=0,f.push(`  Adding ${a.id.toString(16)}: pat0 <-  ${a.pat.toString(16)}`);
