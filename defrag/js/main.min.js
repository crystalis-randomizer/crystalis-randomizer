...
Ie=(new Condition$$module$nodes(b,"Match insect sword (fire/water/thunder)")).option(Q).option(L).option(J).option(Ya,G.value?G:g,P),Je=(new Condition$$module$nodes(b,"Match vampire 2 sword (wind/water/thunder)")).option(P).option(L).option(J).option(G.value?G:g,Q),Oc=(new Condition$$module$nodes(b,"Speed boots")).option(fc,h),Pc=(new Condition$$module$nodes(b,"Climb slopes")).option(vb).option(z).option(Oc),Ke=(new Condition$$module$nodes(b,"Enter Mt Sabre North (rabbit)")).option(Ac).option(Fe),
...
S=(new Condition$$module$nodes(b,"Refresh if needed")).option(Xb.value?Xb:g).option(Za),Sc=(new Condition$$module$nodes(b,"Wind magic")).option(E.value?E:g,S).option(Ra,Ia,S),Tc=(new Condition$$module$nodes(b,"Fire magic")).option(E.value?E:g,S).option(Sa,Ta,S),Uc=(new Condition$$module$nodes(b,"Water magic")).option(E.value?E:g,S).option(E,S).option(Ua,Va,S),Pe=(new Condition$$module$nodes(b,"Thunder magic")).option(E.value?E:g,S).option(E,S).option(Wa,S).option(Xa,S),Qe=(new Condition$$module$nodes(b,
"Flute of lime or glitch")).option(ub).option(ab),Re=(new Condition$$module$nodes(b,"Change or glitch")).option(pa).option(ab),Se=(new Condition$$module$nodes(b,"Change or glitch or paralysis")).option(pa).option(ab).option(Ja),Fb=(new Condition$$module$nodes(b,"Pass shooting statues")).option(tc).option(aa,Wb.value?Wb:g).option(Za,gc),Te=(new Condition$$module$nodes(b,"Healed dolphin if required")).option(Hc).option(Pd),Vc=(new Condition$$module$nodes(b,"Match sword of wind")).option(P).option(G.value?
G:g,aa),Wc=(new Condition$$module$nodes(b,"Match sword of fire")).option(Q).option(G.value?G:g,aa),Xc=(new Condition$$module$nodes(b,"Match sword of water")).option(L).option(G.value?G:g,aa),Ue=(new Condition$$module$nodes(b,"Match sword of thunder")).option(J).option(G.value?G:g,aa),Ve=(new Condition$$module$nodes(b,"Swamp run possible")).option(aa).option(Oc).option(Wd).option(Za),We=(new Condition$$module$nodes(b,"Insect possible to kill")).option(Ya),cb=(new Condition$$module$nodes(b,"Travel swamp")).option(Ya).option(Pa.value?
...
$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$depgraph(d);d.shuffleShops()&&f.shuffleShops(b);const g=f.nodes.filter((a)=>a instanceof Slot$$module$nodes&&a.slots&&a.slotName);d||(d=new FlagSet$$module$flagset("Sbkm Sct"));var k={};for(var h of g)if(h instanceof Slot$$module$nodes&&h.slots){var n=h.slotType[0];(k[n]=k[n]||[]).push(h)}h=[];n=[];var m={};for(var q of d.flags.S||[]){var p=[];for(var l of q){m[l]=!0;for(var r of k[l])p.push(r),n.push([r,h.length])}h.push(p)}for(var I of"bc")if(m[I])for(q=
k[I],l=q.map((a)=>[a.item,a.itemIndex]),b.shuffle(l),r=0;r<q.length;r++)q[r].set(...l[r]);p=(a)=>g.find((b)=>b.vanillaItemName===a);k=p("Sword of Wind");I=p("Sword of Fire");q=p("Ball of Wind");l=p("Ball of Fire");r=p("Statue of Onyx");p=p("Gas Mask");m.k&&b.nextInt(2)&&(I.swap(k),l.swap(q));m.k&&!b.nextInt(3)&&r.swap(p);m=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];k=[];e&&e.addTasks(10);for(I=0;1E3>I;I++){e&&0==I%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));b.shuffle(n);for(var C of h)b.shuffle(C);
q=h.map(()=>-1);l=m[b.nextInt(m.length)];r=[];p=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<l;a++){const [b,c]=n[a],d=h[c][++q[c]];p(b,d)&&(b.swap(d),r.push([b,d]))}if(!r.length)continue;const {win:a,path:c}=f.traverse({wanted:g,dfs:!1});if(a)k=c;else for(;r.length;){const [a,b]=r.pop();a.swap(b)}}a&&f.write(a);if(c){c.items=[];c.route=[];for(const a of k){const [b,
...
0;1E3>k;k++){if(yield shuffle3$$module$depgraph(f,g,a,b,c,d,e)){console.log(`success after ${k} attempts`);return}e&&(e.addCompleted(1),0===k%50&&(yield new Promise(requestAnimationFrame)))}return shuffle$$module$depgraph(a,b,c,d,e)}),shuffle3$$module$depgraph=(a,b,c,d,e,f,g)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const g=e&&e.stats;var h=a.nodes.filter((a)=>a instanceof Slot$$module$nodes&&a.slots&&a.slotName);const n=new Map(d.shuffle(h.map((a)=>[a,[a.item,a.itemIndex]]))),m=
...
a.slotIndex}return p[a.slotType?a.slotType[0]:"c"]==p[b.slotType?b.slotType[0]:"c"]};l=b.assumedFill(d,(a,b)=>I(a,q.get(b)));if(null==l){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const C=new Map;for(var U=0;U<l.length;U++){var va=l[U];if(null!=va){var oa=q.get(b.item(va));va=n.get(oa);n.delete(oa);oa=b.location(U);C.set(oa,va);m.delete(oa)}}U=(a,b,c)=>{c=void 0===c?"":c;for(const c of m)if(I(c,a))return C.set(c,b),m.delete(c),n.delete(a),!0;g&&("traps"==c?g.endState.traps++:"chest"==
c?g.endState.chest++:g.endState.misc++);return!1};for(var E of n){const [a,b]=E;if(a.isMimic()&&!U(a,b,"traps"))return!1}for(const a of n){const [b,c]=a;if(b.needsChest()&&!U(b,c,"chest"))return!1}for(const a of n){const [b,c]=a;if(!U(b,c))return!1}for(const a of C){const [b,c]=a;b.set(...c)}const {win:G,path:Pa}=a.traverse({wanted:h,dfs:!1});if(!G)return g&&g.endState.no_win++,!1;c&&a.write(c);if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,l));e.items=[];e.route=[];for(const b of Pa){const [c,
...
class Graph$$module$graph{constructor(){this.nodes=[]}traverse(a={}){const {wanted:b=void 0,dfs:c=!1}=a;a=new Deque$$module$util;const d=new Map,e=new Map;for(var f of this.nodes)for(var g of f.edges()){var k=g.join(" ");for(var h=1;h<g.length;h++){const a=g[h];e.has(a)||e.set(a,new Map);e.get(a).set(k,g)}1==g.length&&(k=g[0],d.has(k)||(a.push(k),d.set(k,g)))}f=new Set((b||this.nodes).map((a)=>a instanceof Node$$module$graph?a.uid:a));for(g=new Map;f.size&&a.length;){k=c?a.pop():a.shift();f.delete(k);
a:for(const b of(e.get(k)||g).values())if(k=b[0],!d.has(k)){for(h=1;h<b.length;h++)if(!d.has(b[h]))continue a;d.set(k,b);a.push(k)}}return{win:!f.size,seen:d,path:[...d.values()].map(([a,...b])=>{const c=(a)=>[this.nodes[a]];return[a,[...c(a)," (",b.map((a)=>c(a).join("").replace(/\s+\(.*\)/,"")).join(", "),")"].join("")]})}}}
...
4<=e.sells.length?g.push(d):e.sells.push(d));for(const {shops:a}of[b,c])for(const b of a)b.sells.sort((a,b)=>a.id-b.id)}integrate(a={}){const {tracker:b=!1}=a;var c=!b;const d=new SparseDependencyGraph$$module$graph(this.nodes.length),e=[],f=[],g=new Set,k=new Map;var h=[],n=[];const m=[];var q=[];const p=[];a=new Set;for(var l of this.nodes)if(l instanceof Location$$module$nodes){if(l.isStart){const [a]=d.addRoute([l.uid]);k.set(a.label,a)}e[l.uid]=[];f[l.uid]=[];for(const a of l.connections)g.has(a)||
...
else if(!(l instanceof Area$$module$nodes))throw Error(`Unknown node type: ${l.nodeType}`);for(const a of g)e[a.from.uid].push(a),f[a.to.uid].push(a);l=(a)=>{for(const c of a){for(const a of c.edges({tracker:b}))d.addRoute(a);d.finalize(c.uid)}};l(h);c&&l(n);l(q);for(c=k.values();!(h=c.next()).done;){h=h.value;n=h.target;for(var r of e[n]){n=[r.to.uid,...h.deps];for(q=r.deps.length-1;0<=q;q--)n.push(r.deps[q].uid);r.from.bossNode&&n.push(r.from.bossNode.uid);for(const a of d.addRoute(n))k.has(a.label)||
...
class LocationList$$module$nodes{constructor(a){this.worldGraph=a;this.uidToLocation=[];this.locationToUid=[];this.uidToItem=[];this.itemToUid=[];this.routes=[];this.unlocks=[];this.win=null}item(a){return this.worldGraph.nodes[this.itemToUid[a]]}location(a){return this.worldGraph.nodes[this.locationToUid[a]]}addRoute(a){let b=Bits$$module$bits.of(),c;const d=[];for(let e=a.length-1;0<=e;e--){const f=e?this.uidToItem:this.uidToLocation,g=e?this.itemToUid:this.locationToUid,k=a[e];let h=f[k];null==
...
for(var k;!(k=g.next()).done;){k=k.value;f.delete(k);if(k===e){f.size&&f.add(e);c++;continue}if(null!=d[k])continue;const g=this.routes[k];for(let e=0;e<g.length;e++)if(Bits$$module$bits.containsAll(b,g[e])){d[k]=c;if(a[k]){b=Bits$$module$bits.with(b,a[k]);for(let b of this.unlocks[a[k]])f.add(b)}break}}return d}toString(){const a=[];for(let b=0;b<this.routes.length;b++){const c=this.worldGraph.nodes[this.locationToUid[b]],d=this.routes[b],e=[];for(let a=0;a<d.length;a++){const b=[];for(const c of Bits$$module$bits.bits(d[a]))b.push(this.worldGraph.nodes[this.itemToUid[c]]);
e.push("("+b.join(" & ")+")")}a.push(`${c}: ${e.join(" | ")}`)}return a.join("\n")}assumedFill(a,b=(a,b)=>!0,c=FillStrategy$$module$nodes){const d=c.shuffleItems(this.itemToUid.map((a)=>this.worldGraph.nodes[a]),a);let e=Bits$$module$bits.from(d);const f=Array(this.locationToUid.length).fill(null);for(;d.length;){const g=d.pop();if(!Bits$$module$bits.has(e,g))continue;const k=this.worldGraph.nodes[this.itemToUid[g]];e=Bits$$module$bits.without(e,g);const h=[...this.traverse(e,f)].filter((a)=>null==
f[a]);c.shuffleSlots(k,h,a);let n=!1;for(const a of h)if(null==f[a]&&a!=this.win&&b(this.worldGraph.nodes[this.locationToUid[a]],k)){if(100<a)throw Error("WTF");f[a]=g;n=!0;break}if(!n)return null}return f}}class FillStrategy$$module$nodes{shuffleSlots(a,b,c){}static shuffleSlots(a,b,c){c.shuffle(b)}shuffleItems(a,b){}static shuffleItems(a,b){const c=[];for(let b=0;b<a.length;b++){const {shufflePriority:d=1}=a[b];for(let a=0;a<d;a++)c.push(b)}b.shuffle(c);return c}}
...
b.length;a++)e=b[a].sets().map((a)=>[...a].map((a)=>a.toString(16)).join(" ")).join(" | "),console.log(`Tile ${a.toString(16).padStart(2,0)}: ${e}`)}swapMetatiles(a,...b){var c=new Map,d=seq$$module$rom$util(256);const e=new Map,f=(a)=>Array.isArray(a)?a[0]:0>a?~a:a;for(var g of b){for(var k=0;k<g.length-1;k++)Array.isArray(g[k])&&(e.set(g[k][0],g[k][1]),g[k]=g[k][0]);for(k=0;k<g.length-1;k++){let a=g[k],b=g[k+1];0>a||0>b||(c.set(b,a),d[b]=a)}}g=new Set;c=new Set;a=new Set(a);for(var h of this.locations)if(h.valid&&
a.has(h.tileset)){c.add(h.tileEffects);for(const a of h.allScreens())g.add(a)}for(var n of g)for(var m of n.tiles)for(h=0;h<m.length;h++)m[h]=d[m[h]];for(var q of a){a=this.tilesets[(q&127)>>>2];for(var p of b)for(d=0;d<p.length-1;d++){n=f(p[d]);m=f(p[d+1]);for(h=0;4>h;h++)a.tiles[h][n]=a.tiles[h][m];a.attrs[n]=a.attrs[m];if(32>m&&a.alternates[m]!=m){if(32<=n)throw Error(`Cannot unflag: ${q} ${n} ${m} ${a.alternates[m]}`);a.alternates[n]=a.alternates[m]}}for(var l of e){const [b,c]=l;a.alternates[b]=
c}}for(const d of c){q=this.tileEffects[d-179];for(const c of b)for(p=0;p<c.length-1;p++)l=f(c[p]),a=f(c[p+1]),q.effects[l]=q.effects[a];for(const a of e.keys())q.effects[a]|=8}}}
...
RNMX$$module$random)}nextInt(a){return Math.floor(this.next()*a)}shuffle(a){for(let b=a.length;b;){const c=this.nextInt(b--);[a[b],a[c]]=[a[c],a[b]]}return a}}var module$random={};module$random.Random=Random$$module$random;const STATUS$$module$version="unstable",VERSION$$module$version="defrag",LABEL$$module$version="defrag 937b422",HASH$$module$version="937b4220750cc7af0ed2dd7c1cf19fe1671f914b",DATE$$module$version=new Date(1556266255E3);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$flagset(b.flags):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$patch(a,parseSeed$$module$patch(b.seed),d,new FetchReader$$module$fetchreader(c))})}};
...
0,b),a.locations[64].spawns.push(c))},eastCave$$module$patch=(a)=>{},addCordelWestTriggers$$module$patch=(a,b)=>{for(const c of a.locations[21].spawns)(c.isChest()||b.disableTeleportSkip()&&c.isTrigger())&&a.locations[20].spawns.push(c.clone())},fixRabbitSkip$$module$patch=(a)=>{for(const b of a.locations[40].spawns)b.isTrigger()&&134===b.id&&1856===b.x&&(b.x+=16,b.y+=16)},storyMode$$module$patch=(a)=>{const b=a.npcs[203].spawnConditions.get(166);b.push(~a.npcs[194].spawnConditions.get(40)[0]);b.push(~a.npcs[132].spawnConditions.get(110)[0]);
b.push(~a.triggers[26].conditions[1]);b.push(~a.npcs[197].spawnConditions.get(169)[0]);b.push(~a.npcs[198].spawnConditions.get(172)[0]);b.push(~a.npcs[199].spawnConditions.get(185)[0]);b.push(~a.npcs[200].spawnConditions.get(182)[0]);b.push(~a.npcs[203].spawnConditions.get(159)[0]);b.push(512);b.push(513);b.push(514);b.push(515)},disableStabs$$module$patch=(a)=>{for(const b of[8,9,39])a.objects[b].collisionPlane=0},orbsOptional$$module$patch=(a)=>{for(const b of[16,20,24,29])a.objects[b].terrainSusceptibility&=
-5,a.objects[b].level=2},connectLimeTreeToLeaf$$module$patch=(a)=>{const b=a.locations[3];a=a.locations[66];b.screens[5][4]=16;a.screens[1][0]=26;a.screens[2][0]=12;const c=b.entrances.push(Entrance$$module$rom$location.of({x:1263,y:1400}))-1,d=a.entrances.push(Entrance$$module$rom$location.of({x:16,y:448}))-1;b.exits.push(Exit$$module$rom$location.of({x:1264,y:1376,dest:66,entrance:d}),Exit$$module$rom$location.of({x:1264,y:1392,dest:66,entrance:d}));a.exits.push(Exit$$module$rom$location.of({x:0,
y:432,dest:3,entrance:c}),Exit$$module$rom$location.of({x:0,y:448,dest:3,entrance:c}))},stampVersionSeedAndHash$$module$patch=(a,b,c)=>{const d=crc32$$module$crc32(a),e=d.toString(16).padStart(8,0).toUpperCase(),f="unstable"==STATUS$$module$version?HASH$$module$version.substring(0,7).padStart(7,0).toUpperCase()+"     ":VERSION$$module$version.substring(0,12).padEnd(12," ");b=b.toString(16).padStart(8,0).toUpperCase();const g=(b,c)=>{for(let d=0;d<c.length;d++)a[b+16+d]=c.charCodeAt(d)},k=(a,b)=>{const c=
[];for(let d=0;d<a.length||d<b.length;d++)c.push(a[d]||" "),c.push(b[d]||" ");return c.join("")};g(161743,k("  VERSION     SEED      ",`  ${f}${b}`));b=String(c);let h;if(46<b.length){if(92<b.length)throw Error("Flag string way too long!");h=b.substring(46,92).padEnd(46," ");b=b.substring(0,46)}b=b.padEnd(46," ");g(161791,k(b.substring(0,23),b.substring(23)));h&&g(161839,k(h.substring(0,23),h.substring(23)));g(161925,k(e.substring(0,4),e.substring(4)));g(153366,"RANDOMIZER");"unstable"==STATUS$$module$version&&
g(153404,"BETA");return d},patchBytes$$module$patch=(a,b,c)=>{for(let d=0;d<c.length;d++)a[b+16+d]=c[d]},patchWords$$module$patch=(a,b,c)=>{for(let d=0;d<2*c.length;d+=2)a[b+16+d]=c[d>>>1]&255,a[b+17+d]=c[d>>>1]>>>8},updateCoinDrops$$module$patch=(a,b)=>{b.disableShopGlitch()?patchWords$$module$patch(a,216030,[0,5,10,15,25,40,65,105,170,275,445,600,700,800,900,1E3]):patchWords$$module$patch(a,216030,[0,1,2,4,8,16,30,50,100,200,300,400,500,600,700,800])},updateDifficultyScalingTables$$module$patch=
(a,b,c)=>{const d=Array(48).fill(0).map((a,b)=>b);patchBytes$$module$patch(a,c.expand("DiffAtk"),d.map((a)=>Math.round(40+15*a/4)));patchBytes$$module$patch(a,c.expand("DiffDef"),d.map((a)=>4*a));const e=b.decreaseEnemyDamage()?16:48,f=b.decreaseEnemyDamage()?6:5.5;patchBytes$$module$patch(a,c.expand("DiffHP"),d.map((a)=>Math.min(255,e+Math.round(a*f))));const g=b.expScalingFactor();patchBytes$$module$patch(a,c.expand("DiffExp"),d.map((a)=>{a=Math.floor(4*Math.pow(2,(16+9*a)/32)*g);return 128>a?a:
Math.min(255,128+(a>>4))}));patchBytes$$module$patch(a,216E3,[0,2,6,10,14,18,32,24,20,0,2,6,10,14,18,16,32,20])},rescaleShops$$module$patch=(a,b,c)=>{const d=b.expand("BasePrices");var e=b.expand("InnPrices");const f={prices:138836,items:138792},g={prices:138704,items:138660},k=Array(48).fill(0).map((a,b)=>b);patchBytes$$module$patch(a,b.expand("ToolShopScaling"),k.map((a)=>Math.round(8*Math.pow(2,a/10))));patchBytes$$module$patch(a,b.expand("ArmorShopScaling"),k.map((a)=>Math.round(8*Math.pow(2,
(47-a)/12))));for(var h of[f,g]){const {prices:d,items:e}=h;for(b=0;44>b;b++)a[d+b+16]=BASE_PRICES$$module$patch[a[e+b+16]]?c?c.nextInt(32)+17:32:0}for(h=0;11>h;h++)a[e+h+16]=c?c.nextInt(40)+13:32;c=(b,c)=>{a[d+2*(b-13)+16]=c&255;a[d+2*(b-13)+17]=c>>>8};for(e=13;39>e;e++)c(e,BASE_PRICES$$module$patch[e]);c(39,20)},BASE_PRICES$$module$patch={13:4,14:16,15:50,16:325,17:1E3,18:2E3,19:4E3,21:6,22:20,23:75,24:250,25:1E3,26:4800,29:25,30:30,31:45,32:40,33:36,34:200,35:150,36:80,38:300},rescaleMonsters$$module$patch=
(a,b)=>{for(var c of SCALED_MONSTERS$$module$patch.keys())for(const a in b.objects){if(SCALED_MONSTERS$$module$patch.has(a))return;b.objects[c].objectDataBase==b.objects[a].objectDataBase&&(SCALED_MONSTERS$$module$patch[a]=SCALED_MONSTERS$$module$patch[c])}for(const d of SCALED_MONSTERS$$module$patch){const [e,{sdef:f,swrd:g,hits:k,satk:h,dgld:n,sexp:m}]=d;a=b.objects[e].objectData;c=[87,94,104,125,136,151,155,158].includes(e)?1:0;a[2]|=128;a[6]=k;a[7]=h;a[8]=f|g<<4;a[9]=a[9]&224|c;a[16]=a[16]&15|
n<<4;a[17]=m}b.objects[125].objectData[16]|=8},shuffleMonsters$$module$patch=(a,b,c,d)=>{a=new MonsterPool$$module$patch({});for(const c of b.locations)c.valid&&a.populate(c);a.shuffle(c)},identifyKeyItemsForDifficultyBuffs$$module$patch=(a)=>{for(const b of a.itemGets){const c=ITEMS$$module$patch.get(b.item);if(c&&c.key){if(!b.table)throw Error(`No table for ${c.name}`);if(255==b.table[b.table.length-1])b.table[b.table.length-1]=254;else throw Error(`Expected FF at end of ItemGet table: ${b.id.toString(16)}: ${Array.from(b.table).map((a)=>
a.toString(16).padStart(2,0)).join(" ")}`);b.write(a)}}},SCALED_MONSTERS$$module$patch=new Map([[63,"p","Sorceror shot",,,,19,,,],[75,"m","wraith??",2,,2,22,4,61],[79,"m","wraith",1,,2,20,4,61],[80,"m","Blue Slime",,,1,16,2,32],[81,"m","Weretiger",,,1,21,4,40],[82,"m","Green Jelly",4,,3,16,4,36],[83,"m","Red Slime",6,,4,16,4,48],[84,"m","Rock Golem",6,,11,24,6,85],[85,"m","Blue Bat",,,,4,,32],[86,"m","Green Wyvern",4,,4,24,6,52],[87,"b","Vampire",3,,12,18,,,],[88,"m","Orc",3,,4,21,4,57],[89,"m","Red Flying Swamp Insect",
...
"p","lizardman flail",,,,21,,,],[252,"p","mado shuriken",,,,36,,,],[253,"p","guardian statue missile",,,,23,,,],[254,"p","demon wall fire",,,,23,,,]].map((a)=>{var [b,c,d,e=0,f=0,g=0,k=0,h=0,n=0]=a;return[b,{id:b,type:c,name:d,sdef:e,swrd:f,hits:g,satk:k,dgld:h,sexp:n}]}));
...
if(h in UNTOUCHED_MONSTERS$$module$patch||!SCALED_MONSTERS$$module$patch.has(h)||"m"!=SCALED_MONSTERS$$module$patch.get(h).type)continue;var f=a.rom.objects[h];if(!f)continue;const k=b.patternBank,m=a.spritePatterns[k];var g=f.palettes(!0);f=g.includes(2)?a.spritePalettes[0]:null;g=g.includes(3)?a.spritePalettes[1]:null;d.push({id:h,pat:m,pal2:f,pal3:g,patBank:k});(this.report[`start-${h.toString(16)}`]=this.report[`start-${h.toString(16)}`]||[]).push("$"+a.id.toString(16));c.push(e)}d.length&&(b||
...
d.id.toString(16).padStart(2,0)]=[];const {maxFlyers:g,nonFlyers:k={},fixedSlots:h={}}=MONSTER_ADJUSTMENTS$$module$patch[d.id]||{};let n=h.pat0||null,m=h.pat1||null,q=h.pal2||null,p=h.pal3||null,l=g,r=!1;for(const a of d.spawns)if(a.isChest()&&(r=!0),a.isMonster()){var b=a.monsterId;126==b||127==b||159==b?m=98:143==b&&(n=97)}if(21==d.id||71==d.id)r=!1;f.push(`Initial pass: ${[r,n,m,q,p].join(", ")}`);b=(a)=>{var b=FLYERS$$module$patch.has(a.id),c=MOTHS_AND_BATS$$module$patch.has(a.id);if(b){if(!l)return!1;
--l}if(null!=q&&null!=a.pal2&&q!=a.pal2||null!=p&&null!=a.pal3&&p!=a.pal3)return!1;var g=!r||TREASURE_CHEST_BANKS$$module$patch.has(a.pat);let h;if(d.rom.objects[a.id].child||RETAIN_SLOTS$$module$patch.has(a.id)){const b=(h=a.patBank)?m:n;if(null!=b&&b!=a.pat)return!1;if(h)m=a.pat;else if(g)n=a.pat;else return!1;f.push(`  Adding ${a.id.toString(16)}: pat(${h}) <-  ${a.pat.toString(16)}`)}else if(null==n&&g||n==a.pat)n=a.pat,h=0,f.push(`  Adding ${a.id.toString(16)}: pat0 <-  ${a.pat.toString(16)}`);
else if(null==m||m==a.pat)m=a.pat,h=1,f.push(`  Adding ${a.id.toString(16)}: pat1 <-  ${a.pat.toString(16)}`);else return!1;null!=a.pal2&&(q=a.pal2);null!=a.pal3&&(p=a.pal3);f.push(`    ${Object.keys(a).map((b)=>`${b}: ${a[b]&&a[b].toString(16)}`).join(", ")}`);f.push(`    pal: ${(a.pal2||0).toString(16)} ${(a.pal3||0).toString(16)}`);g=0;if(b||c)for(b=0;b<e.length;b++){if(e[b]in k){g=b;break}}else for(b=0;b<e.length;b++)if(!(e[b]in k)){g=b;break}(this.report[`mon-${a.id.toString(16)}`]=this.report[`mon-${a.id.toString(16)}`]||
[]).push("$"+d.id.toString(16));b=e[g];c=d.spawns[b-13];b in k&&(c.y+=16*k[b][0],c.x+=16*k[b][1]);c.patternBank=h;c.monsterId=a.id;f.push(`    slot ${b.toString(16)}: ${c}`);e.splice(g,1);return!0};if(l)for(var c=0;c<Math.min(40,this.monsters.length);c++)FLYERS$$module$patch.has(this.monsters[c].id)&&b(this.monsters[c])&&this.monsters.splice(c,1),a.shuffle(this.monsters);for(c=0;c<this.monsters.length&&e.length;c++)if(b(this.monsters[c])){const [a]=this.monsters.splice(c,1);FLYERS$$module$patch.has(a.id)||
...
(a,b)=>{for(const {section:c,text:d,flags:e}of FLAGS$$module$flagset){let f=!1;const g=document.createElement("h2");g.textContent=c;const k=d?document.createElement("p"):null;d&&(k.innerHTML=d);const h=document.createElement("div");h.classList.add("flag-list");for(const {flag:a,hard:c,name:d,text:g}of e){if(!b.check(a))continue;f=!0;const e=document.createElement("div");e.textContent=`${a}: ${d}`;e.classList.add("checkbox");c&&e.classList.add("hard");if(g){const a=document.createElement("div");a.classList.add("flag-body");
a.innerHTML=g;e.appendChild(a)}h.appendChild(e)}f&&(a.appendChild(g),k&&a.appendChild(k),a.appendChild(h))}};var module$render={};module$render.renderPresets=renderPresets$$module$render;module$render.renderOptions=renderOptions$$module$render;module$render.renderRaceFlags=renderRaceFlags$$module$render;let flags$$module$main,seed$$module$main,rom$$module$main,romName$$module$main,race$$module$main=!1;
...
(a)=>{const b=a.getElementsByClassName("flag-body")[0];b&&b.remove();const [c,d]=a.textContent.split(/:\s*/),e=document.createElement("input");e.type="checkbox";e.id=`flag-${c}`;e.dataset.flag=c;a.parentElement.insertBefore(e,a);const f=document.createElement("label");f.textContent=c;f.htmlFor=e.id;a.parentElement.insertBefore(f,a);const g=document.createElement("div");a.parentElement.insertBefore(g,a);const k=document.createElement("label");k.textContent=d;k.htmlFor=e.id;g.appendChild(k);b&&g.appendChild(b);
a.classList.contains("hard")&&(f.classList.add("hard"),k.classList.add("hard"),k.textContent+=" *");a.remove();e.addEventListener("change",()=>{window.FLAGS=flags$$module$main;flags$$module$main.set(c,e.checked);updateDom$$module$main()})},updateDom$$module$main=()=>{for(var a of document.querySelectorAll("input[data-flag]"))a.checked=flags$$module$main.check(a.dataset.flag);a=String(flags$$module$main).replace(/ /g,"");document.getElementById("seed").value=seed$$module$main||"";var b=["#flags=",
