...
f("!Fc",!1)),na=k(c("Assume wild warp",f("Gw",!1))),oa=c("Allow wild warp",f("!Tw",!1)),I=c("Sword magic optional",f("Hw",!1)),J=c("Matching sword optional",f("Hs",!1)),Ub=c("Gas mask optional",f("Hg",!1)),Qd=c("Healed dolphin optional",f("!Rd",!0)),Rd=c("Calmed sea not required",f("!Rl",!1)),Sd=c("Sword of Thunder teleports to Shyron",f("Rt",!0)),Vb=c("Barrier magic optional",f("Hb",!0)),Wb=c("Refresh magic optional",f("!Er",!0)),Td=c("Lime Tree connects to Leaf",f("Rp",!0)),Ud=c("Buffed medical herb",
f("!Hm",!0)),Y=d(0,"Sword of Wind").weight(b.check("Es")?10:5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),Z=d(1,"Sword of Fire").weight(b.check("Es")?10:5).fromPerson("Oak elder",29).dialog(29,null,3).key(),S=d(2,"Sword of Water").weight(10).chest().key(),N=d(3,"Sword of Thunder").weight(15).chest().key(),nb=d(4,"Crystalis").fixed(),Oa=d(5,"Ball of Wind").chest().key(),Ja=d(6,"Tornado Bracelet").chest().key(),Pa=d(7,"Ball of Fire").bossDrop("Insect",1).dialog(30,null,0).dialog(32,
null,0).dialog(33,null,0).dialog(34,null,0).dialog(96,30,0).dialog(29,null,2).dialog(31,null,0).npcSpawn(193).key(),Qa=d(8,"Flame Bracelet").bossDrop("Kelbesque 1",2).npcSpawn(194).key(),Ra=d(9,"Ball of Water").weight(5).direct("Rage",250679).npcSpawn(195).key(),Sa=d(10,"Blizzard Bracelet").weight(5).chest().key(),Ta=d(11,"Ball of Thunder").bossDrop("Mado 1",5).trigger(154,1).key(),Ua=d(12,"Storm Bracelet").chest().key(),Xb=d(13,"Carapace Shield").armor(),Vd=d(14,"Bronze Shield").armor(),Yb=d(15,
"Platinum Shield").armor(),Zb=d(16,"Mirrored Shield").armor(),Wd=d(17,"Ceramic Shield").armor(),ob=d(18,"Sacred Shield").armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),$b=d(19,"Battle Shield").armor(),Xd=d(20,"Psycho Shield").armor(),Yd=d(21,"Tanned Hide").armor(),Zd=d(22,"Leather Armor").armor(),$d=d(23,"Bronze Armor").armor(),ac=d(24,"Platinmum Armor").armor(),ae=d(25,"Soldier Suit").armor(),bc=d(26,"Ceramic Suit").armor(),be=d(27,"Battle Suit").armor(),ce=d(28,"Psycho Armor").armor().bossDrop("Draygon 1",
10).npcSpawn(203).trigger(159).npcSpawn(131).key(),D=d(29,"Medical Herb").consumable(),H=d(30,"Antidote").consumable(),wa=d(31,"Lysis Plant").consumable(),pb=d(32,"Fruit of Lime").consumable(),K=d(33,"Fruit of Power").consumable(),T=d(34,"Magic Ring").consumable(),qb=d(35,"Fruit of Repun").consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),O=d(36,"Warp Boots").consumable(),cc=d(37,"Statue of Onyx").chest("Cordel grass").invisible(254882).key(),rb=d(38,"Opel Statue").consumable().bossDrop("Kelbesque 2",
6).npcSpawn(197).key(),dc=d(39,"Insect Flute").fromPerson("Oak mother",30).dialog(30,null,1).key(),sb=d(40,"Flute of Lime").fromPerson("Portoa queen",56).direct(39161).dialog(56,null,4).key(),Va=d(41,"Gas Mask").direct("Akahana in Brynmaer",251902).npcSpawn(22,24).key(),de=d(42,"Power Ring").chest().bonus(),ee=d(43,"Warrior Ring").fromPerson("Akahana's friend",84).dialog(84,null,2).bonus(),fe=d(44,"Iron Necklace").chest().bonus(),ge=d(45,"Deo's Pendant").fromPerson("Deo",90).dialog(90,null,0).bonus(),
tb=d(46,"Rabbit Boots").bossDrop("Vampire 1",0).npcSpawn(192).key(),ec=d(47,f("Ts",!0)?"Speed Boots":"Leather Boots").chest().bonus(),fc=d(48,"Shield Ring").direct("Akahana in waterfall cave",250543).npcSpawn(22,87,2).bonus(),ub=d(49,"Alarm Flute").fromPerson("Zebu's student",20,1).key(),gc=d(50,"Windmill Key").fromPerson("Windmill guard",20).dialog(20,14,0).npcSpawn(20,14,1).key(),hc=d(51,"Key to Prison").chest().key(),ic=d(52,"Key to Styx").fromPerson("Zebu in Shyron",94,1).trigger(128,2).dialog(94,
242,0).dialog(98,242,0).key(),jc=d(53,"Fog Lamp").chest().key(),vb=d(54,"Shell Flute").fromPerson("Dolphin",99,1).npcSpawn(99).key(),kc=d(55,"Eye Glasses").fromPerson("Clark",68).dialog(68,233,1).key(),lc=d(56,"Broken Statue").bossDrop("Sabera 1",4).npcSpawn(127,101).npcSpawn(70).npcSpawn(71).npcSpawn(106).npcSpawn(132).npcSpawn(142).dialog(61).dialog(62).dialog(63).dialog(64).dialog(65).dialog(66).dialog(67).dialog(68,233).trigger(182).key(),mc=d(57,"Glowing Lamp").direct("Kensu in lighthouse",250638).npcSpawn(126,
98,1).key(),nc=d(59,"Love Pendant").chest("Underground channel").invisible(254890).key(),oc=d(60,"Kirisa Plant").chest("Kirisa meadow").invisible(254886).key(),wb=d(61,"Ivory Statue").bossDrop("Karmine",9).npcSpawn(200).key(),pc=d(62,"Bow of Moon").fromPerson("Aryllis",35).direct(251624).dialog(35,null,1).key(),qc=d(63,"Bow of Sun").chest().key(),rc=d(64,"Bow of Truth").fromPerson("Azteca",131).npcSpawn(131,156,1).dialog(131,null,0).key(),Wa=(new Magic$$module$js$nodes(a,65,"Refresh",65,null)).fromPerson("Zebu at windmill",
94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),Xa=(new Magic$$module$js$nodes(a,66,"Paralysis",66,null)).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),pa=(new Magic$$module$js$nodes(a,67,"Telepathy",67,null)).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),sc=(new Magic$$module$js$nodes(a,68,"Teleport",68,null)).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),he=(new Magic$$module$js$nodes(a,69,"Recover",69,null)).direct("Asina in Portoa",
250361),tc=(new Magic$$module$js$nodes(a,70,"Barrier",70,null)).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),xa=(new Magic$$module$js$nodes(a,71,"Change",71,null)).direct("Kensu in Swan",251614).npcSpawn(116,241,1),z=(new Magic$$module$js$nodes(a,72,"Flight",72,null)).weight(15).direct("Kensu in Draygonia Fortress",250255),ie=K.bossDrop("Vampire 2",12,97).npcSpawn(204).key(),L=d(112,"Mimic"),uc=(new Trigger$$module$js$nodes(a,"Talked to Leaf Elder")).get(Y),vc=(new Trigger$$module$js$nodes(a,
"Talked to Leaf Student")).get(ub),xb=new Trigger$$module$js$nodes(a,"Talked to Zebu in cave"),je=(new Trigger$$module$js$nodes(a,"Woke up Windmill Guard")).get(gc),Ya=new Trigger$$module$js$nodes(a,"Started Windmill"),wc=(new Trigger$$module$js$nodes(a,"Learned Refresh")).get(Wa),ke=(new Trigger$$module$js$nodes(a,"Gave Statue to Akahana")).get(Va),le=(new Trigger$$module$js$nodes(a,"Fought Stom")).get(pa),xc=new Trigger$$module$js$nodes(a,"Visited Oak"),yc=new Trigger$$module$js$nodes(a,"Talked to Oak Mother"),
yb=new Trigger$$module$js$nodes(a,"Rescued Oak Child"),me=(new Trigger$$module$js$nodes(a,"Talked to Oak Mother Again")).get(dc),ne=(new Trigger$$module$js$nodes(a,"Talked to Oak Elder")).get(Z),oe=(new Trigger$$module$js$nodes(a,"Talked to Tornel on Mt Sabre")).get(sc),zc=new Trigger$$module$js$nodes(a,"Villagers Abducted"),Ac=new Trigger$$module$js$nodes(a,"Talked to Rabbit in Leaf"),pe=(new Trigger$$module$js$nodes(a,"Learned Paralysis")).get(Xa),Bc=new Trigger$$module$js$nodes(a,"Talked to Portoa Queen"),
Cc=new Trigger$$module$js$nodes(a,"Talked to Fortune Teller"),Dc=new Trigger$$module$js$nodes(a,"Visited Underground Channel"),qe=(new Trigger$$module$js$nodes(a,"Sent to Waterfall Cave")).get(sb),re=(new Trigger$$module$js$nodes(a,"Cured Akahana")).get(fc),Ec=(new Trigger$$module$js$nodes(a,"Talked to Rage")).get(Ra),Fc=new Trigger$$module$js$nodes(a,"Mesia recording played"),Gc=(new Trigger$$module$js$nodes(a,"Talked to Asina")).get(he),Hc=(new Trigger$$module$js$nodes(a,"Healed Dolphin")).get(vb),
zb=new Trigger$$module$js$nodes(a,"Returned Fog Lamp"),Ic=new Trigger$$module$js$nodes(a,"Talked to Kensu in Cabin"),Jc=new Trigger$$module$js$nodes(a,"Talked to Joel Elder"),se=(new Trigger$$module$js$nodes(a,"Talked to Clark")).get(kc),te=(new Trigger$$module$js$nodes(a,"Talked to Kensu in Lighthouse")).get(mc),Ab=new Trigger$$module$js$nodes(a,"Calmed the Angry Sea"),ue=(new Trigger$$module$js$nodes(a,"Learned Barrier")).get(tc),Kc=new Trigger$$module$js$nodes(a,"Talked to Stom in Swan Hut"),Lc=
new Trigger$$module$js$nodes(a,"Talked to Kensu in Swan tavern"),Mc=new Trigger$$module$js$nodes(a,"Talked to Kensu at Swan dance"),ve=(new Trigger$$module$js$nodes(a,"Returned Kensu's love pendant")).get(xa),we=(new Trigger$$module$js$nodes(a,"Talked to Amazones Queen")).get(pc),Bb=new Trigger$$module$js$nodes(a,"Entered Shyron"),xe=(new Trigger$$module$js$nodes(a,"Talked to Zebu in Shyron")).get(ic),Nc=new Trigger$$module$js$nodes(a,"Shyron Massacre"),ye=(new Trigger$$module$js$nodes(a,"Saved Kensu")).get(z),
ze=(new Trigger$$module$js$nodes(a,"Talked to Deo")).get(ge),Ae=(new Trigger$$module$js$nodes(a,"Talked to Akahana's Friend")).get(ee),Be=(new Trigger$$module$js$nodes(a,"Get Bow of Truth")).get(rc),Ce=(new Trigger$$module$js$nodes(a,"Forged Crystalis")).get(nb),Za=(new Condition$$module$js$nodes(a,"Sword charge glitch")).option(R,va),De=(new Condition$$module$js$nodes(a,"Rabbit skip")).option(G,C),Ee=(new Condition$$module$js$nodes(a,"Teleport skip")).option(l,n),Cb=(new Condition$$module$js$nodes(a,
"Statue glitch")).option(q,t),Fe=(new Condition$$module$js$nodes(a,"Wild warp")).option(na,oa),$a=(new Condition$$module$js$nodes(a,"Any level 2 sword")).option(Y,Oa).option(Y,Ja).option(Z,Pa).option(Z,Qa).option(S,Ra).option(S,Sa).option(N,Ta).option(N,Ua),v=(new Condition$$module$js$nodes(a,"Destroy stone")).option(Y,Oa).option(Y,Ja).option(Za,Y,$a),w=(new Condition$$module$js$nodes(a,"Destroy ice")).option(Z,Pa).option(Z,Qa).option(Za,Z,$a),r=(new Condition$$module$js$nodes(a,"Cross rivers")).option(S,
Ra).option(S,Sa).option(z).option(Za,S,$a),ya=(new Condition$$module$js$nodes(a,"Destroy iron")).option(N,Ta).option(N,Ua).option(Za,N,$a),aa=(new Condition$$module$js$nodes(a,"Any sword")).option(Y).option(Z).option(S).option(N),Ge=(new Condition$$module$js$nodes(a,"Match insect sword (fire/water/thunder)")).option(Z).option(S).option(N).option(Va,J.value?J:h,Y),Oc=(new Condition$$module$js$nodes(a,"Speed boots")).option(ec,m),Pc=(new Condition$$module$js$nodes(a,"Climb slopes")).option(tb).option(z).option(Oc),
He=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (rabbit)")).option(Ac).option(De),Ie=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (Teleport)")).option(sc).option(Ee,z),Qc=(new Condition$$module$js$nodes(a,"Asina in her room")).option(Fc),Je=(new Condition$$module$js$nodes(a,"Paralysis or Asina revealed")).option(Xa).option(Qc).option(Cb),Rc=(new Condition$$module$js$nodes(a,"Ride dolphin")).option(vb,Ic),Ke=(new Condition$$module$js$nodes(a,"Ghetto flight")).option(p,Rc,tb),
ba=(new Condition$$module$js$nodes(a,"Cross sea")).option(Rc).option(z),Le=(new Condition$$module$js$nodes(a,"Cross whirlpool")).option(Ab).option(z).option(Ke),P=(new Condition$$module$js$nodes(a,"Refresh if needed")).option(Wb.value?Wb:h).option(Wa),Sc=(new Condition$$module$js$nodes(a,"Wind magic")).option(I.value?I:h,P).option(Oa,Ja,P),Tc=(new Condition$$module$js$nodes(a,"Fire magic")).option(I.value?I:h,P).option(Pa,Qa,P),Uc=(new Condition$$module$js$nodes(a,"Water magic")).option(I.value?I:
h,P).option(I,P).option(Ra,Sa,P),Me=(new Condition$$module$js$nodes(a,"Thunder magic")).option(I.value?I:h,P).option(I,P).option(Ta,P).option(Ua,P),Ne=(new Condition$$module$js$nodes(a,"Flute of lime or glitch")).option(sb).option(Cb),Vc=(new Condition$$module$js$nodes(a,"Change or glitch")).option(xa).option(Cb),Db=(new Condition$$module$js$nodes(a,"Pass shooting statues")).option(tc).option(Vb.value?Vb:h).option(Wa,fc),Oe=(new Condition$$module$js$nodes(a,"Healed dolphin if required")).option(Hc).option(Qd),
Wc=(new Condition$$module$js$nodes(a,"Match sword of wind")).option(Y).option(J.value?J:h,aa),Xc=(new Condition$$module$js$nodes(a,"Match sword of fire")).option(Z).option(J.value?J:h,aa),Yc=(new Condition$$module$js$nodes(a,"Match sword of water")).option(S).option(J.value?J:h,aa),Pe=(new Condition$$module$js$nodes(a,"Match sword of thunder")).option(N).option(J.value?J:h,aa),Qe=(new Condition$$module$js$nodes(a,"Swamp run possible")).option(aa).option(Oc).option(Ud).option(Wa),Re=(new Condition$$module$js$nodes(a,
"Insect possible to kill")).option(Va),ab=(new Condition$$module$js$nodes(a,"Travel swamp")).option(Va).option(Ub.value?Ub:h,Qe),Se=(new Condition$$module$js$nodes(a,"Calmed sea if required")).option(Ab).option(Rd),Te=e(0,"Vampire 1",aa).get(tb),Ue=e(1,"Insect",dc,Ge,Re).get(Pa),Ve=e(2,"Kelbesque 1",Wc,Sc).get(Qa),We=e(12,"Vampire 2",aa).get(ie),Zc=e(4,"Sabera 1",Xc,Tc).get(lc),Xe=e(5,"Mado 1",Yc,Uc).get(Ta),Ye=e(6,"Kelbesque 2",Wc,Sc).get(rb),Ze=e(7,"Sabera 2",Xc,Tc).get(qb),$e=e(8,"Mado 2",Yc,Uc).get(ob),
af=e(9,"Karmine",Pe,Me).get(wb),bf=e(10,"Draygon 1",aa).get(ce),cf=e(null,"Statues",qc,pc),df=e(11,"Draygon 2",aa,rc),ef=e(13,"Dyna",nb),U=new Area$$module$js$nodes(a,"Leaf"),za=new Area$$module$js$nodes(a,"Valley of Wind"),Q=new Area$$module$js$nodes(a,"Sealed Cave"),qa=new Area$$module$js$nodes(a,"Cordel Plain"),Aa=new Area$$module$js$nodes(a,"Brynmaer"),Ba=new Area$$module$js$nodes(a,"Amazones"),A=new Area$$module$js$nodes(a,"Mt Sabre West"),u=new Area$$module$js$nodes(a,"Mt Sabre North"),bb=new Area$$module$js$nodes(a,
"Nadare's"),Ka=new Area$$module$js$nodes(a,"Oak"),fa=new Area$$module$js$nodes(a,"Waterfall Valley"),y=new Area$$module$js$nodes(a,"Portoa"),ha=new Area$$module$js$nodes(a,"Waterfall Cave"),B=new Area$$module$js$nodes(a,"Fog Lamp Cave"),ia=new Area$$module$js$nodes(a,"Kirisa Plant Cave"),ra=new Area$$module$js$nodes(a,"Angry Sea"),ja=new Area$$module$js$nodes(a,"Joel"),F=new Area$$module$js$nodes(a,"Evil Spirit Island"),ka=new Area$$module$js$nodes(a,"Sabera's Castle"),V=new Area$$module$js$nodes(a,
"Swan"),x=new Area$$module$js$nodes(a,"Mt Hydra"),la=new Area$$module$js$nodes(a,"Shyron"),sa=new Area$$module$js$nodes(a,"Styx"),ta=new Area$$module$js$nodes(a,"Goa"),cb=new Area$$module$js$nodes(a,"Draygonia Fortress 1"),W=new Area$$module$js$nodes(a,"Draygonia Fortress 2"),Ca=new Area$$module$js$nodes(a,"Draygonia Fortress 3"),M=new Area$$module$js$nodes(a,"Draygonia Fortress 4"),E=new Area$$module$js$nodes(a,"Oasis Cave");new Area$$module$js$nodes(a,"Desert");const X=new Area$$module$js$nodes(a,
"Sahara"),Da=new Area$$module$js$nodes(a,"Pyramid Front"),ca=new Area$$module$js$nodes(a,"Pyramid Back"),da=new Area$$module$js$nodes(a,"Tower"),Eb=(new Location$$module$js$nodes(a,0,U,"Start")).overworld().start(),ff=(new Location$$module$js$nodes(a,0,U,"Mezame Shrine")).overworld().from(Eb),gf=(new Location$$module$js$nodes(a,1,U,"Outside Start")).overworld().connect(ff),ma=(new Location$$module$js$nodes(a,2,U,"Town")).town().connect(gf),La=(new Location$$module$js$nodes(a,3,za,"Main")).overworld().connect(ma).trigger(wc,
Ya),$c=(new Location$$module$js$nodes(a,3,za,"Outside Windmill")).overworld(),ad=(new Location$$module$js$nodes(a,4,Q,"Tunnel 1 (entrance)")).cave().from(La,Ya),hf=(new Location$$module$js$nodes(a,5,Q,"Tunnel 2 (over bridge)")).cave().connect(ad),jf=(new Location$$module$js$nodes(a,6,Q,"Tunnel 6 (herb dead end)")).cave().chest(D,15),bd=(new Location$$module$js$nodes(a,7,Q,"Tunnel 4a (ball corridor)")).cave().chest(D,20,80).chest(Oa,21);(new Location$$module$js$nodes(a,7,Q,"Tunnel 4b (antidote dead end)")).cave().connect(bd,
v).chest(H,19);const kf=(new Location$$module$js$nodes(a,8,Q,"Tunnel 5 (warp boots dead end)")).cave().chest(O,14),lf=(new Location$$module$js$nodes(a,9,Q,"Tunnel 3a (branch, front)")).cave().connect(hf).connectTo(bd).connectTo(kf),mf=(new Location$$module$js$nodes(a,9,Q,"Tunnel 3b (branch, back)")).cave().connect(lf,v).connectTo(jf),nf=(new Location$$module$js$nodes(a,10,Q,"Tunnel 7 (boss)")).cave().connect(mf).boss(Te),of=(new Location$$module$js$nodes(a,12,Q,"Tunnel 8a (exit, above wall)")).cave().connect(nf),
pf=(new Location$$module$js$nodes(a,12,Q,"Tunnel 8b (exit, below wall")).cave().connect(of,v);(new Location$$module$js$nodes(a,14,za,"Windmill Cave")).cave().connect(La).connectTo($c).trigger(je,ub,xb);(new Location$$module$js$nodes(a,15,za,"Windmill")).misc().connect($c).trigger(Ya,gc);const qf=(new Location$$module$js$nodes(a,16,za,"Zebu's Cave Front")).cave().connect(La).trigger(xb,uc,vc).trigger(wc,Ya,xb),rf=(new Location$$module$js$nodes(a,16,za,"Zebu's Cave Back")).cave().trigger(zc).connect(qf,
w),sf=(new Location$$module$js$nodes(a,17,A,"Tunnel 1 (to Zebu)")).cave().connect(rf),Ea=(new Location$$module$js$nodes(a,20,qa,"West")).overworld().connect(pf),tf=(new Location$$module$js$nodes(a,20,qa,"South")).overworld().connect(Ea,r),cd=(new Location$$module$js$nodes(a,21,qa,"East")).overworld().connect(Ea).chest(cc,24),Ma=(new Location$$module$js$nodes(a,24,Aa,"Town")).town().connect(Ea).trigger(ke,cc),uf=(new Location$$module$js$nodes(a,25,qa,"Outside Stom's House")).town().connect(Ea),Fb=
(new Location$$module$js$nodes(a,26,qa,"Swamp")).overworld().connect(cd,ab).trigger(yb,yc,ab);(new Location$$module$js$nodes(a,26,qa,"Swamp Insect Area")).overworld().connect(Fb,ab).boss(Ue);const db=(new Location$$module$js$nodes(a,27,Ba,"Town")).town().connect(tf),eb=(new Location$$module$js$nodes(a,28,Ka,"Town")).town().connect(Fb,ab).trigger(xc);(new Location$$module$js$nodes(a,30,qa,"Stom's House")).house().connect(uf).trigger(le,xc);const Fa=(new Location$$module$js$nodes(a,32,A,"Entrance")).overworld().connect(Ea).connect(sf),
vf=(new Location$$module$js$nodes(a,32,A,"Up Slope")).overworld().from(Fa,Pc).to(Fa),wf=(new Location$$module$js$nodes(a,32,A,"Dead End (warp boots)")).overworld().chest(O,24,106),dd=(new Location$$module$js$nodes(a,33,A,"Upper")).overworld().from(Fa,z).to(Fa),xf=(new Location$$module$js$nodes(a,33,A,"Tornel Dead End")).overworld().trigger(oe,Ja).chest(T,23,105),ed=(new Location$$module$js$nodes(a,34,A,"Tunnel 2a (fork at start)")).cave().connect(Fa);(new Location$$module$js$nodes(a,34,A,"Tunnel 2b (left branch to dead end)")).cave().connect(ed,
w).connectTo(wf);const yf=(new Location$$module$js$nodes(a,34,A,"Tunnel 2c (right branch to upper)")).cave().connect(ed,w),zf=(new Location$$module$js$nodes(a,35,A,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(yf).chest(D,23,82),Af=(new Location$$module$js$nodes(a,35,A,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(zf,w).connectTo(dd),fd=(new Location$$module$js$nodes(a,36,A,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(Af);(new Location$$module$js$nodes(a,
36,A,"Tunnel 4b (out to upper)")).cave().connect(fd,w).connectTo(dd);const Bf=(new Location$$module$js$nodes(a,37,A,"Tunnel 5 (tiny connector)")).cave().connect(fd),Cf=(new Location$$module$js$nodes(a,38,A,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Bf);(new Location$$module$js$nodes(a,38,A,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Cf,w).connectTo(xf);const Df=(new Location$$module$js$nodes(a,39,A,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(vf),Ef=(new Location$$module$js$nodes(a,
39,A,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Df,w);(new Location$$module$js$nodes(a,39,A,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Ef,w).chest(Ja,25);const fb=(new Location$$module$js$nodes(a,40,u,"Entrance")).overworld().connect(cd,Ie,He),gb=(new Location$$module$js$nodes(a,40,u,"Upper")).overworld().from(fb,z).to(fb),Gb=(new Location$$module$js$nodes(a,40,u,"Summit (boss)")).overworld().from(gb,z).to(gb).boss(Ve),gd=(new Location$$module$js$nodes(a,41,u,"Connector")).overworld(),
Hb=(new Location$$module$js$nodes(a,41,u,"Middle Left")).overworld(),Ff=(new Location$$module$js$nodes(a,41,u,"Middle Right")).overworld().from(Hb,Pc).to(Hb),hd=(new Location$$module$js$nodes(a,42,u,"Tunnel 2a (from entrance to connector)")).cave().connectTo(gd);(new Location$$module$js$nodes(a,42,u,"Tunnel 2b (under bridge, to antidote)")).cave().connect(hd,w).chest(H,23,94);const id=(new Location$$module$js$nodes(a,43,u,"Tunnel 3a (branch after connector)")).cave().connect(gd),Gf=(new Location$$module$js$nodes(a,
43,u,"Tunnel 3b (right branch)")).cave().connect(id,w),Hf=(new Location$$module$js$nodes(a,43,u,"Tunnel 3c (upper branch)")).cave().connect(id,w);(new Location$$module$js$nodes(a,44,u,"Tunnel 4 (over bridge, to middle)")).cave().connect(Hf).connectTo(Hb);const jd=(new Location$$module$js$nodes(a,45,u,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Gf).connectTo(Ff);(new Location$$module$js$nodes(a,45,u,"Tunnel 5b (dead-end with herb)")).cave().connect(jd,w).chest(D,22,83);const If=(new Location$$module$js$nodes(a,
46,u,"Tunne; 6a (S-shaped hall, right)")).cave().connect(jd),Jf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(If,w),Kf=(new Location$$module$js$nodes(a,46,u,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Jf,w),kd=(new Location$$module$js$nodes(a,47,u,"Prison (hallway)")).cave().connect(gb),Lf=(new Location$$module$js$nodes(a,48,u,"Left Cell (shopkeepers)")).cave().from(kd,w);(new Location$$module$js$nodes(a,49,u,"Left Cell 2 (back, with prison key)")).cave().from(Lf,
w).chest(hc,13);const Mf=(new Location$$module$js$nodes(a,50,u,"Right Cell (villagers)")).cave().from(kd,w),Nf=(new Location$$module$js$nodes(a,51,u,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Mf,w);(new Location$$module$js$nodes(a,52,u,"Tunnel 9 (connector to summit)")).cave().connect(Nf).connectTo(Gb);const Of=(new Location$$module$js$nodes(a,53,u,"Tunnel 10a (summit cave, front)")).cave().from(Gb,hc).to(Gb),Pf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10b (summit cave, behind ice)")).cave().connect(Of,
w).trigger(pe);(new Location$$module$js$nodes(a,56,u,"Tunnel 1 (leads from main entrance)")).cave().connect(fb).connectTo(hd);(new Location$$module$js$nodes(a,57,u,"Tunnel 7 (to upper)")).cave().connect(Kf).connectTo(gb);const Qf=(new Location$$module$js$nodes(a,60,bb,"Inn")).shop(),Rf=(new Location$$module$js$nodes(a,61,bb,"Tool Shop")).shop(D,H,K,O),Sf=(new Location$$module$js$nodes(a,62,bb,"Back Room")).house(),Ib=(new Location$$module$js$nodes(a,64,fa,"Summit")).overworld().connect(Pf),hb=(new Location$$module$js$nodes(a,
64,fa,"Northwest")).overworld().from(Ib).to(Ib,z),Tf=(new Location$$module$js$nodes(a,64,fa,"Northeast")).overworld().connect(hb,r),ld=(new Location$$module$js$nodes(a,65,fa,"Southwest")).overworld().connect(hb),Uf=(new Location$$module$js$nodes(a,65,fa,"Southeast")).overworld().connect(ld,r),md=(new Location$$module$js$nodes(a,66,fa,"Lime Tree Valley")).overworld().connect(ld).connect(La,Td),Vf=(new Location$$module$js$nodes(a,67,fa,"Lime Tree Lake (Rage)")).cave().connect(md).trigger(Ec,S),Wf=(new Location$$module$js$nodes(a,
68,ia,"Tunnel 1a (entrance)")).cave().connect(Uf),Xf=(new Location$$module$js$nodes(a,68,ia,"Tunnel 1b (behind wall)")).cave().connect(Wf,v),nd=(new Location$$module$js$nodes(a,69,ia,"Tunnel 2a (main path, before wall)")).cave().connect(Xf);(new Location$$module$js$nodes(a,69,ia,"Tunnel 2b (dead end, antidote)")).cave().connect(nd,v).chest(H,25,95);const Yf=(new Location$$module$js$nodes(a,69,ia,"Tunnel 2c (main path, after wall)")).cave().connect(nd,v),Zf=(new Location$$module$js$nodes(a,70,ia,"Tunnel 3a (last room, before wall)")).cave().connect(Yf),
$f=(new Location$$module$js$nodes(a,70,ia,"Tunnel 3b (last room, after wall)")).cave().connect(Zf,v);(new Location$$module$js$nodes(a,71,ia,"Meadow")).overworld().connect($f).chest(oc,14);const ag=(new Location$$module$js$nodes(a,72,B,"Tunnel 1a (entrance)")).cave().connect(Tf),od=(new Location$$module$js$nodes(a,72,B,"Tunnel 1b (past wall)")).cave().connect(ag,v);(new Location$$module$js$nodes(a,72,B,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(od,v).chest(wa,24);const bg=(new Location$$module$js$nodes(a,
73,B,"Tunnel 2 (tiny connector)")).cave().connect(od),pd=(new Location$$module$js$nodes(a,74,B,"Tunnel 3a (upper branch)")).cave().connect(bg);(new Location$$module$js$nodes(a,74,B,"Tunnel 3b (dead end, mimic)")).cave().connect(pd,v).chest(L,21,112);const qd=(new Location$$module$js$nodes(a,74,B,"Tunnel 3c (short passage with mimic)")).cave().connect(pd,v).chest(L,22,113),cg=(new Location$$module$js$nodes(a,74,B,"Tunnel 3d (lower branch)")).cave().connect(qd,v);(new Location$$module$js$nodes(a,75,
B,"Tunnel 4 (dead end loop)")).cave().connect(cg);const rd=(new Location$$module$js$nodes(a,76,B,"Tunnel 5a (right branch over bridge)")).cave().connect(qd),dg=(new Location$$module$js$nodes(a,76,B,"Tunnel 5b (past wall over bridge)")).cave().connect(rd,v),eg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6a (from left branch)")).cave().connect(rd),fg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6b (reconvergence)")).cave().connect(eg,v).connect(dg),gg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6c (between walls)")).cave().connect(fg,
v),hg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6d (under bridge)")).cave().connect(gg,v),ig=(new Location$$module$js$nodes(a,78,B,"Tunnel 7a (over second bridge)")).cave().connect(hg),jg=(new Location$$module$js$nodes(a,78,B,"Tunnel 7b (past wall)")).cave().connect(ig,v),kg=(new Location$$module$js$nodes(a,79,B,"Tunnel 8a (under second bridge)")).cave().connect(jg);(new Location$$module$js$nodes(a,79,B,"Tunnel 8b (fog lamp)")).cave().connect(kg,v).chest(jc,19);const ua=(new Location$$module$js$nodes(a,
80,y,"Town")).town().connect(hb),sd=(new Location$$module$js$nodes(a,81,y,"Fishherman Island")).town().connect(ua);(new Location$$module$js$nodes(a,82,fa,"Mesia Shrine")).cave().trigger(Fc).connect(Vf,r,Ec);const td=(new Location$$module$js$nodes(a,84,ha,"Tunnel 1a (entrance)")).cave().connect(hb);(new Location$$module$js$nodes(a,84,ha,"Tunnel 1b (dead end, mimic)")).cave().connect(td,w).chest(L,19,114);const lg=(new Location$$module$js$nodes(a,84,ha,"Tunnel 1c (past ice)")).cave().connect(td,w),
mg=(new Location$$module$js$nodes(a,85,ha,"Tunnel 2 (stoned pair)")).cave().connect(lg),Jb=(new Location$$module$js$nodes(a,86,ha,"Tunnel 3 (wide medusa hallways)")).cave().connect(mg,Ne),ng=(new Location$$module$js$nodes(a,87,ha,"Tunnel 4a (left entrance)")).cave().from(Jb,w).chest(Zb.chest().bonus(),25).trigger(re,sb);(new Location$$module$js$nodes(a,87,ha,"Tunnel 4b (right entrance)")).cave().from(Jb,w).connect(ng,z);(new Location$$module$js$nodes(a,87,ha,"Tunnel 4c (sword of water)")).cave().connect(Jb,
w).chest(S,24);const ud=(new Location$$module$js$nodes(a,88,da,"Entrance")).misc(),og=(new Location$$module$js$nodes(a,89,da,"Level 1")).misc().from(ud),pg=(new Location$$module$js$nodes(a,90,da,"Level 2")).misc().from(og),qg=(new Location$$module$js$nodes(a,91,da,"Level 3")).misc().from(pg),vd=(new Location$$module$js$nodes(a,92,da,"Outside Mesia Room")).misc().from(qg),rg=(new Location$$module$js$nodes(a,93,da,"Outside Dyna Room")).misc().from(vd,nb);(new Location$$module$js$nodes(a,94,da,"Mesia")).misc().connect(vd).trigger(Ce);
const sg=(new Location$$module$js$nodes(a,95,da,"Dyna")).misc().from(rg).boss(ef);(new Location$$module$js$nodes(a,95,da,"Win")).misc().from(sg).end();const Kb=(new Location$$module$js$nodes(a,96,ra,"Cabin Beach")).sea().from(sd,zb),Ga=(new Location$$module$js$nodes(a,96,ra,"South")).sea().connect(Kb,ba),tg=(new Location$$module$js$nodes(a,96,ra,"Joel Beach")).sea().connect(Ga,ba),wd=(new Location$$module$js$nodes(a,96,ja,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(a,96,ra,"Altar")).sea().connect(Ga,
ba).trigger(Ab,mc,lc);const ug=(new Location$$module$js$nodes(a,96,ra,"North")).sea().to(Ga,ba).from(Ga,ba,Le).trigger(ue,Se),vg=(new Location$$module$js$nodes(a,96,ra,"Swan Beach")).sea().connect(ug,ba);(new Location$$module$js$nodes(a,97,ra,"Cabin")).misc().connect(Kb).trigger(Ic,zb);(new Location$$module$js$nodes(a,98,ja,"Lighthouse")).misc().connect(wd).trigger(te,ub);const ib=(new Location$$module$js$nodes(a,100,y,"Underground Channel 1 (from throne room)")).sea().trigger(Dc),wg=(new Location$$module$js$nodes(a,
100,y,"Underground Channel 2 (to fortune teller)")).sea().connect(ib,r),xd=(new Location$$module$js$nodes(a,100,y,"Underground Channel 3 (from fortune teller)")).sea().connect(ib,z),yd=(new Location$$module$js$nodes(a,100,y,"Underground Channel 4 (asina)")).sea().connect(xd,r),xg=(new Location$$module$js$nodes(a,100,y,"Underground Channel 5 (dolphin)")).sea().connect(yd,r).trigger(Hc,D,Gc);(new Location$$module$js$nodes(a,100,y,"Underground Channel 6 (water)")).sea().connect(xg,ba).connectTo(Ga,ba).chest(nc,
17);const Lb=(new Location$$module$js$nodes(a,101,F,"Zombie Town")).town(),yg=(new Location$$module$js$nodes(a,104,F,"Tunnel 1 (entrance)")).sea().connect(Ga,Jc,ba),zd=(new Location$$module$js$nodes(a,105,F,"Tunnel 2a (start)")).cave().connect(yg);(new Location$$module$js$nodes(a,105,F,"Tunnel 2b (dead end to left)")).cave().connect(zd,r);const zg=(new Location$$module$js$nodes(a,105,F,"Tunnel 2c (across first river)")).cave().connect(zd,r),Ad=(new Location$$module$js$nodes(a,105,F,"Tunnel 2d (across second river)")).cave().connect(zg,
r);(new Location$$module$js$nodes(a,105,F,"Tunnel 2e (dead end, magic ring)")).cave().connect(Ad,v).chest(T,29);const Ag=(new Location$$module$js$nodes(a,105,F,"Tunnel 2f (stair down)")).cave().connect(Ad,v),Bg=(new Location$$module$js$nodes(a,106,F,"Tunnel 3a (main area)")).cave().connect(Ag).connectTo(Lb).chest(wa,25,92),Cg=(new Location$$module$js$nodes(a,106,F,"Tunnel 3b (left area toward items)")).cave().connect(Bg,v),Dg=(new Location$$module$js$nodes(a,107,F,"Tunnel 4a (right side, mimic)")).cave().connect(Cg).chest(L,
14,115);(new Location$$module$js$nodes(a,107,F,"Tunnel 4b (left side, iron necklace)")).cave().connect(Dg,r).chest(fe,15);const Mb=(new Location$$module$js$nodes(a,108,ka,"Floor 1")).fortress().connect(Lb),Eg=(new Location$$module$js$nodes(a,108,ka,"Miniboss")).fortress().boss(We).connect(Mb);(new Location$$module$js$nodes(a,109,ka,"Floor 2a (left stair)")).fortress().connect(Mb).chest(K,19);const Fg=(new Location$$module$js$nodes(a,109,ka,"Floor 2b (right stair)")).fortress().connect(Eg).chest(D,
30,85),Gg=(new Location$$module$js$nodes(a,110,ka,"Floor 3a (toward boss)")).fortress().connect(Fg),Bd=(new Location$$module$js$nodes(a,110,ka,"Floor 3b (boss room)")).fortress().connect(Gg);(new Location$$module$js$nodes(a,110,ka,"Boss")).fortress().boss(Zc).connect(Bd);(new Location$$module$js$nodes(a,110,ka,"Floor 3c (back room trap)")).fortress().from(Bd).to(Mb);const Hg=(new Location$$module$js$nodes(a,112,ja,"Secret Passage")).cave().connectTo(wd),jb=(new Location$$module$js$nodes(a,113,ja,
"Town")).town().connect(tg),ea=(new Location$$module$js$nodes(a,114,V,"Town")).town().connect(vg),Ig=(new Location$$module$js$nodes(a,115,V,"Inside Gate")).overworld().connect(ea),Jg=(new Location$$module$js$nodes(a,115,V,"Outside Gate")).overworld().from(Ig,xa),kb=(new Location$$module$js$nodes(a,120,ta,"Valley")).overworld().connect(Jg),Nb=(new Location$$module$js$nodes(a,124,x,"Entrance")).overworld().connect(kb),Kg=(new Location$$module$js$nodes(a,124,x,"Over first river toward Shyron")).overworld().connect(Nb,
r),Cd=(new Location$$module$js$nodes(a,124,x,"After first tunnel")).overworld(),Dd=(new Location$$module$js$nodes(a,124,x,"Door to Styx")).overworld().connect(Cd,r),Lg=(new Location$$module$js$nodes(a,124,x,"Dead end (no item)")).overworld(),Mg=(new Location$$module$js$nodes(a,124,x,"Dead end (fruit of lime)")).overworld().chest(pb,26),Ng=(new Location$$module$js$nodes(a,124,x,"Dead end (magic ring)")).overworld().chest(T,25,101),Ed=(new Location$$module$js$nodes(a,124,x,"Outside tunnel to bow")).overworld();
(new Location$$module$js$nodes(a,124,x,"Floating island (bow of sun)")).overworld().connect(Ed,z).chest(qc,24);const Og=(new Location$$module$js$nodes(a,125,x,"Tunnel 1 (to Shyron)")).cave().connect(Kg),Pg=(new Location$$module$js$nodes(a,126,x,"Outside Shyron")).overworld().connect(Og);(new Location$$module$js$nodes(a,127,x,"Tunnel 2 (fork)")).cave().connect(Nb).connectTo(Mg).connectTo(Cd);const Fd=(new Location$$module$js$nodes(a,128,x,"Tunnel 3 (caves)")).cave().connect(Dd).connect(Lg),Gd=(new Location$$module$js$nodes(a,
129,x,"Tunnel 4 (left branch of cave)")).cave().connect(Fd);(new Location$$module$js$nodes(a,130,x,"Tunnel 5 (dead end, medical herb)")).cave().connect(Gd).chest(D,15,86);const Qg=(new Location$$module$js$nodes(a,131,x,"Tunnel 6a (left-then-right)")).cave().connect(Gd),Rg=(new Location$$module$js$nodes(a,131,x,"Tunnel 6b (past wall)")).cave().connect(Qg,v),Sg=(new Location$$module$js$nodes(a,132,x,"Tunnel 7 (wide hall)")).cave().connect(Rg);(new Location$$module$js$nodes(a,133,x,"Tunnel 8 (red slimes)")).cave().from(Sg,
v).connectTo(Ed).chest(L,23,116);const Tg=(new Location$$module$js$nodes(a,134,x,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Fd),Ug=(new Location$$module$js$nodes(a,135,x,"Tunnel 10a (toward magic ring)")).cave().connect(Tg);(new Location$$module$js$nodes(a,135,x,"Tunnel 10b (past wall)")).cave().connect(Ug,v).connectTo(Ng);const Hd=(new Location$$module$js$nodes(a,136,sa,"Entrance")).fortress().from(Dd,ic,Db),Vg=(new Location$$module$js$nodes(a,137,sa,"Left branch")).fortress().connect(Hd).chest(L,
19,117),Wg=(new Location$$module$js$nodes(a,137,sa,"Left branch, past one bridge")).fortress().connect(Vg,r),Xg=(new Location$$module$js$nodes(a,137,sa,"Left branch, past two bridges")).fortress().connect(Wg,r).chest(D,29,87),Yg=(new Location$$module$js$nodes(a,137,sa,"Right branch")).fortress().connect(Hd);(new Location$$module$js$nodes(a,137,sa,"Right branch, across water")).fortress().connect(Yg,z).chest(L,20,118).chest(L,21,119).chest(Xd,28);(new Location$$module$js$nodes(a,138,sa,"Upper floor")).fortress().connect(Xg).chest(N,
27);const Ha=(new Location$$module$js$nodes(a,140,la,"Town")).town().connect(Pg,Vc).trigger(Bb),Na=(new Location$$module$js$nodes(a,142,ta,"Town")).town().connect(kb),Id=(new Location$$module$js$nodes(a,143,E,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(a,143,E,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Id,ya).chest(de,15);const Ob=(new Location$$module$js$nodes(a,144,ta,"Desert 1")).overworld().connect(kb),lb=(new Location$$module$js$nodes(a,
145,E,"Area 1 (from entrance)")).cave().chest(ec,26),Jd=(new Location$$module$js$nodes(a,145,E,"Area 2 (across top bridge)")).cave().connect(lb,r);(new Location$$module$js$nodes(a,145,E,"Area 3 (dead-end across top-right bridge)")).cave().connect(Jd,r);const Zg=(new Location$$module$js$nodes(a,145,E,"Area 4 (left across middle-right bridge)")).cave().connect(Jd,r),$g=(new Location$$module$js$nodes(a,145,E,"Area 5 (bottom edge)")).cave().connect(Zg,r),ah=(new Location$$module$js$nodes(a,145,E,"Area 6 (bottom island)")).cave().connect($g,
r),bh=(new Location$$module$js$nodes(a,145,E,"Area 7 (bottom inner ring)")).cave().connect(ah,r),ch=(new Location$$module$js$nodes(a,145,E,"Area 8 (left outer ring)")).cave().connect(bh,r).connect(lb,r).chest(K,27,100),dh=(new Location$$module$js$nodes(a,145,E,"Area 9 (top left inner ring)")).cave().connect(ch,r),eh=(new Location$$module$js$nodes(a,145,E,"Area 10 (top right inner ring)")).cave().connect(dh,r);(new Location$$module$js$nodes(a,145,E,"Area 11 (center)")).cave().connect(eh,r).connectTo(Id);
(new Location$$module$js$nodes(a,145,E,"Area 12 (top center islands)")).cave().connect(lb,z).chest(be,28);const fh=(new Location$$module$js$nodes(a,146,X,"Desert Cave 1")).cave().connect(Ob,z),Ia=(new Location$$module$js$nodes(a,147,X,"Town")).town(),gh=(new Location$$module$js$nodes(a,148,X,"Outside Cave")).overworld().connect(Ia),hh=(new Location$$module$js$nodes(a,149,X,"Desert Cave 2")).cave().connect(gh);(new Location$$module$js$nodes(a,150,X,"Meadow")).overworld().connect(fh).connectTo(Ia).trigger(ze,
xa);const Pb=(new Location$$module$js$nodes(a,152,X,"Desert 2")).overworld().connect(hh),ih=(new Location$$module$js$nodes(a,156,Da,"Entrance")).fortress().connect(Pb,z),jh=(new Location$$module$js$nodes(a,156,Da,"Azteca")).fortress().trigger(Be),kh=(new Location$$module$js$nodes(a,157,Da,"Fork")).fortress().connect(ih),Kd=(new Location$$module$js$nodes(a,158,Da,"Main")).fortress().connect(kh);(new Location$$module$js$nodes(a,158,Da,"Treasure Chest (magic ring)")).fortress().connect(Kd).chest(T,27,
108);(new Location$$module$js$nodes(a,159,Da,"Draygon")).fortress().connect(Kd).to(jh).boss(bf);const lh=(new Location$$module$js$nodes(a,160,ca,"Entrance")).fortress().connect(Pb,z),mh=(new Location$$module$js$nodes(a,160,ca,"Statues")).fortress().connect(lh).boss(cf),nh=(new Location$$module$js$nodes(a,161,ca,"Hall 1")).fortress().connect(mh),Qb=(new Location$$module$js$nodes(a,162,ca,"Branch")).fortress().connect(nh);(new Location$$module$js$nodes(a,163,ca,"Left Dead End")).fortress().connect(Qb).chest(L,
13,120);(new Location$$module$js$nodes(a,164,ca,"Right Dead End")).fortress().connect(Qb);const oh=(new Location$$module$js$nodes(a,165,ca,"Hall 2")).fortress().connect(Qb).chest(rb,26,109),ph=(new Location$$module$js$nodes(a,166,ca,"Draygon 2")).fortress().connect(oh).boss(df);(new Location$$module$js$nodes(a,167,ca,"Teleporter")).fortress().from(ph).to(ud);const Ld=(new Location$$module$js$nodes(a,168,cb,"Entrance")).fortress().connect(Na,Db).trigger(Nc,N),qh=(new Location$$module$js$nodes(a,169,
cb,"Main")).fortress().from(Ld,ya),rh=(new Location$$module$js$nodes(a,169,cb,"Boss")).fortress().connect(qh).boss(Ye),sh=(new Location$$module$js$nodes(a,170,cb,"Zebu")).fortress().connect(rh),mb=(new Location$$module$js$nodes(a,171,W,"Entrance")).fortress().connect(sh);(new Location$$module$js$nodes(a,171,W,"Dead End Behind Iron (fruit of power)")).fortress().connect(mb,ya).chest(K,28,98);(new Location$$module$js$nodes(a,171,W,"Dead End Loop Across Closer Bridges")).fortress().connect(mb,r).connect(mb,
r);const th=(new Location$$module$js$nodes(a,171,W,"Across First Bridge (fruit of repun)")).fortress().connect(mb,r).chest(qb,30,102),Rb=(new Location$$module$js$nodes(a,171,W,"Across Second Bridge")).fortress().connect(th,r);(new Location$$module$js$nodes(a,171,W,"Dead End Across Two Bridges ()")).fortress().connect(Rb,r).connect(Rb,r).chest(wa,29,93);const uh=(new Location$$module$js$nodes(a,171,W,"Across Third Bridge")).fortress().connect(Rb,r),vh=(new Location$$module$js$nodes(a,171,W,"Exit Behind Iron Door")).fortress().connect(uh,
ya),wh=(new Location$$module$js$nodes(a,172,W,"Boss")).fortress().connect(vh).boss(Ze),xh=(new Location$$module$js$nodes(a,172,W,"Tornel")).fortress().connect(wh),Md=(new Location$$module$js$nodes(a,173,Ca,"Lower")).fortress().connect(xh).chest(rb,26,99).chest(T,27,111),yh=(new Location$$module$js$nodes(a,174,Ca,"Upper Loop")).fortress().connect(Md).chest(H,22,96);(new Location$$module$js$nodes(a,174,Ca,"Upper Loop Behind Wall (magic ring)")).fortress().connect(yh,ya).chest(T,23,107);const zh=(new Location$$module$js$nodes(a,
175,Ca,"Upper Passage (toward Mado)")).fortress().connect(Md).chest(T,27,84),Sb=(new Location$$module$js$nodes(a,176,M,"Initial Fork")).fortress(),Ah=(new Location$$module$js$nodes(a,177,M,"Left Branch")).fortress().connect(Sb),Nd=(new Location$$module$js$nodes(a,178,M,"Main Area (right branch, over bridges)")).fortress().connect(Sb),Bh=(new Location$$module$js$nodes(a,179,M,"U-shaped Passage (between floors)")).fortress().connect(Nd),Ch=(new Location$$module$js$nodes(a,180,M,"Main Area Lower (under bridge)")).fortress().connect(Ah).connect(Nd).connect(Bh),
Od=(new Location$$module$js$nodes(a,180,M,"Behind Iron Wall")).fortress().connect(Ch,ya),Dh=(new Location$$module$js$nodes(a,181,M,"Lower")).fortress().connect(Od).chest(L,13,121).chest(L,14,122).chest(L,15,123).chest(T,23,88).chest(O,24,110),Eh=(new Location$$module$js$nodes(a,182,M,"Boss Corridor")).fortress().connect(Dh),Fh=(new Location$$module$js$nodes(a,182,M,"Boss")).fortress().connect(Eh,Db).boss(af);(new Location$$module$js$nodes(a,182,M,"Behind Boss (stormBracelet)")).fortress().connect(Fh).chest(Ua,
18);const Pd=(new Location$$module$js$nodes(a,183,M,"Exit Stairs")).fortress(),Gh=(new Location$$module$js$nodes(a,184,E,"Entrance Back (behind river)")).cave().connect(Pd).chest(K,13,90);(new Location$$module$js$nodes(a,184,E,"Entrance Front")).cave().connect(Gh,z).connectTo(Ob).connectTo(lb);const Hh=(new Location$$module$js$nodes(a,185,Ca,"Boss")).fortress().connect(zh).boss($e);(new Location$$module$js$nodes(a,185,Ca,"Asina")).fortress().connect(Hh).connectTo(Sb);(new Location$$module$js$nodes(a,
186,M,"Kensu")).fortress().connect(Od).connectTo(Pd).trigger(ye,wb);(new Location$$module$js$nodes(a,187,ta,"House")).house().connect(Na).trigger(Ae,xa,wb);(new Location$$module$js$nodes(a,188,ta,"Inn")).shop().connect(Na,Bb);(new Location$$module$js$nodes(a,190,ta,"Tool Shop")).shop(D,H,O,K).connect(Na,Bb);(new Location$$module$js$nodes(a,191,ta,"Tavern")).shop().connect(Na);(new Location$$module$js$nodes(a,192,U,"Elder House")).house().connect(ma).trigger(uc);(new Location$$module$js$nodes(a,193,
U,"Rabbit Hut")).house().connect(ma).trigger(Ac,zc,pa);(new Location$$module$js$nodes(a,194,U,"Inn")).shop().connect(ma);(new Location$$module$js$nodes(a,195,U,"Tool Shop")).shop(D,H,O,K).connect(ma);(new Location$$module$js$nodes(a,196,U,"Armor Shop")).shop(Yd,Xb).connect(ma);(new Location$$module$js$nodes(a,197,U,"Student House")).house().connect(ma).trigger(vc);(new Location$$module$js$nodes(a,198,Aa,"Tavern")).house().connect(Ma);(new Location$$module$js$nodes(a,199,Aa,"Pawn Shop")).shop().connect(Ma);
(new Location$$module$js$nodes(a,200,Aa,"Inn")).shop().connect(Ma);(new Location$$module$js$nodes(a,201,Aa,"Armor Shop")).shop(Zd,Xb,Vd).connect(Ma);(new Location$$module$js$nodes(a,203,Aa,"Tool Shop")).shop(D,H,O).connect(Ma);(new Location$$module$js$nodes(a,205,Ka,"Elder House")).house().from(eb,pa).trigger(ne,yb);(new Location$$module$js$nodes(a,206,Ka,"Mother's House")).house().from(eb,pa).trigger(yc,pa).trigger(me,yb);(new Location$$module$js$nodes(a,207,Ka,"Tool Shop")).shop(D,H,K).from(eb,
pa);(new Location$$module$js$nodes(a,208,Ka,"Inn")).shop().from(eb,pa);(new Location$$module$js$nodes(a,209,Ba,"Inn")).shop().connect(db);(new Location$$module$js$nodes(a,210,Ba,"Tool Shop")).shop(O,K,wa).connect(db);(new Location$$module$js$nodes(a,211,Ba,"Armor Shop")).shop(ac,Yb,Zb,ob).connect(db);const Ih=(new Location$$module$js$nodes(a,212,Ba,"Queen's House")).house().from(db,Vc).trigger(we,xa,oc);(new Location$$module$js$nodes(a,213,bb,"Nadare's")).house().connect(fb).connectTo(Qf).connectTo(Rf).connectTo(Sf);
(new Location$$module$js$nodes(a,214,y,"Fisherman's House")).house().connect(sd).trigger(zb,jc,vb,Oe);const Tb=(new Location$$module$js$nodes(a,215,y,"Palace Entrance")).house().connect(ua);(new Location$$module$js$nodes(a,216,y,"Fortune Teller Front")).house().connect(ua).trigger(Cc,Bc);(new Location$$module$js$nodes(a,216,y,"Fortune Teller Back")).house().connect(wg).connect(xd);(new Location$$module$js$nodes(a,217,y,"Pawn Shop")).shop().connect(ua);(new Location$$module$js$nodes(a,218,y,"Armor Shop")).shop($d,
ac,Yb).connect(ua);(new Location$$module$js$nodes(a,220,y,"Inn")).shop().connect(ua);(new Location$$module$js$nodes(a,221,y,"Tool Shop")).shop(D,wa,pb,O).connect(ua);(new Location$$module$js$nodes(a,222,y,"Palace Left")).house().connect(Tb);(new Location$$module$js$nodes(a,223,y,"Palace Throne Room")).house().connect(Tb).to(ib,Je).from(ib).trigger(Bc).trigger(qe,Cc,Dc);(new Location$$module$js$nodes(a,224,y,"Palace Right")).house().connect(Tb);(new Location$$module$js$nodes(a,225,y,"Asina's Room")).house().connect(yd).trigger(Gc,
Qc);(new Location$$module$js$nodes(a,226,Ba,"Queen Downstairs")).house().connect(Ih).chest(Sa,13);(new Location$$module$js$nodes(a,227,ja,"Elder's House")).house().connect(jb).trigger(Jc);(new Location$$module$js$nodes(a,228,ja,"Shed")).house().connect(jb).to(Hg,kc);(new Location$$module$js$nodes(a,229,ja,"Tool Shop")).shop(D,H,K,wa).connect(jb);(new Location$$module$js$nodes(a,231,ja,"Inn")).shop().connect(jb);const Jh=(new Location$$module$js$nodes(a,232,F,"Zombie Town House")).house().connect(Lb);
(new Location$$module$js$nodes(a,233,F,"Zombie Town Basement")).house().connect(Jh).trigger(se,Zc);(new Location$$module$js$nodes(a,235,V,"Tool Shop")).shop(D,H,K,O).connect(ea);(new Location$$module$js$nodes(a,236,V,"Stom's Hut")).house().connect(ea).trigger(Kc);(new Location$$module$js$nodes(a,237,V,"Inn")).shop().connect(ea);(new Location$$module$js$nodes(a,238,V,"Armor Shop")).shop(ae,bc,Wd,$b).connect(ea);(new Location$$module$js$nodes(a,239,V,"Tavern")).house().connect(ea).trigger(Lc,Kc,Xa);
(new Location$$module$js$nodes(a,240,V,"Pawn Shop")).shop().connect(ea);(new Location$$module$js$nodes(a,241,V,"Dance Hall")).house().connect(ea).trigger(Mc,Lc,Xa).trigger(ve,Mc,nc);const Kh=(new Location$$module$js$nodes(a,242,la,"Temple (pre-massacre)")).fortress().connect(Ha).from(Eb,N,Sd).trigger(xe);(new Location$$module$js$nodes(a,242,la,"Temple (post-massacre)")).fortress().from(Kh,Nc).boss(Xe);(new Location$$module$js$nodes(a,243,la,"Training Hall")).house().connect(Ha);(new Location$$module$js$nodes(a,
244,la,"Hospital")).house().connect(Ha);(new Location$$module$js$nodes(a,245,la,"Armor Shop")).shop(bc,ob,$b).connect(Ha);(new Location$$module$js$nodes(a,246,la,"Tool Shop")).shop(D,H,pb,T).connect(Ha);(new Location$$module$js$nodes(a,247,la,"Inn")).shop().connect(Ha);(new Location$$module$js$nodes(a,248,X,"Inn")).shop().connect(Ia);(new Location$$module$js$nodes(a,249,X,"Tool Shop")).shop(H,O,qb,T).connect(Ia);(new Location$$module$js$nodes(a,250,X,"Elder's House")).house().connect(Ia);(new Location$$module$js$nodes(a,
251,X,"Pawn Shop")).house().connect(Ia);const Lh=[ma,La,ad,Ea,Fb,Fa,Ib,md,Kb,ea,kb,Nb,Ob,Ld,Pb];for(const a of Lh)a.from(Eb,Fe);return a},shuffle$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);d.check("Ps")&&f.shuffleShops(a);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);d||(d=new FlagSet$$module$js$flagset("Sbkm Sct"));var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&
k.slots){var m=k.slotType[0];(h[m]=h[m]||[]).push(k)}k=[];m=[];var p={};for(var q of d.flags.S||[]){var t=[];for(var l of q){p[l]=!0;for(var n of h[l])t.push(n),m.push([n,k.length])}k.push(t)}for(var G of"bc")if(p[G])for(q=h[G],l=q.map((a)=>[a.item,a.itemIndex]),a.shuffle(l),n=0;n<q.length;n++)q[n].set(...l[n]);t=(a)=>g.find((b)=>b.vanillaItemName===a);h=t("Sword of Wind");G=t("Sword of Fire");q=t("Ball of Wind");l=t("Ball of Fire");n=t("Statue of Onyx");t=t("Gas Mask");p.k&&a.nextInt(2)&&(G.swap(h),
l.swap(q));p.k&&!a.nextInt(3)&&n.swap(t);p=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(G=0;1E3>G;G++){e&&0==G%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));a.shuffle(m);for(var C of k)a.shuffle(C);q=k.map(()=>-1);l=p[a.nextInt(p.length)];n=[];t=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<l;a++){const [b,c]=m[a],d=k[c][++q[c]];t(b,d)&&
(b.swap(d),n.push([b,d]))}if(!n.length)continue;const {win:b,path:c}=f.traverse({wanted:g,dfs:!1});if(b)h=c;else for(;n.length;){const [a,b]=n.pop();a.swap(b)}}b&&f.write(b);if(c){c.items=[];c.route=[];for(const a of h){const [b,d]=a;c.route.push(d);C=f.nodes[b];null!=C.slotName&&(k=C.slotName,0>k.indexOf(C.orig)&&(k+=` (normally ${C.vanillaItemName})`),c.items.push({slotIndex:C.slotIndex,itemIndex:C.itemIndex,origName:C.vanillaItemName,slotName:C.slotName,itemName:C.item.name,text:`${C.item.name}: ${k}`}))}}}),
...
e,f,g)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const h=e&&e.stats;var g=b.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);const m=new Map(d.shuffle(g.map((a)=>[a,[a.item,a.itemIndex]]))),p=new Set(d.shuffle(g)),q=new Map,t={};h&&h.seeds++;f||(f=new FlagSet$$module$js$flagset("Sbkm Sct"));(f.flags.S||[]).forEach((a,b)=>{for(const c of a)t[c]=b});for(var l of p)q.set(l.item,l);let n=new Set;const G=(a,b)=>{if(null==t[a.slotType?a.slotType[0]:"c"])return a==
b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!=b.item.inventoryRow&&a.requiresUnique||"armor"==b.item.inventoryRow&&!a.isChest())return!1;if(f.check("Es")){if(0===a.slotIndex)return 4>b.item.id;if(4>b.item.id&&(n.add(b),4===n.size))return 0===a.slotIndex}return t[a.slotType?a.slotType[0]:"c"]==t[b.slotType?b.slotType[0]:"c"]};l=a.assumedFill(d,(a,b)=>G(a,q.get(b)));if(null==l){h&&h.endState.key++;return!1;throw Error("Could not fill!");}const C=new Map;for(var R=0;R<l.length;R++){var va=l[R];if(null!=
va){var na=q.get(a.item(va));va=m.get(na);m.delete(na);na=a.location(R);C.set(na,va);p.delete(na)}}R=(a,b,c)=>{c=void 0===c?"":c;for(const c of p)if(G(c,a))return C.set(c,b),p.delete(c),m.delete(a),!0;h&&("traps"==c?h.endState.traps++:"chest"==c?h.endState.chest++:h.endState.misc++);return!1};for(var oa of m){const [a,b]=oa;if(a.isMimic()&&!R(a,b,"traps"))return!1}for(const a of m){const [b,c]=a;if(b.needsChest()&&!R(b,c,"chest"))return!1}for(const a of m){const [b,c]=a;if(!R(b,c))return!1}for(const a of C){const [b,
c]=a;b.set(...c)}const {win:I,path:J}=b.traverse({wanted:g,dfs:!1});if(!I)return h&&h.endState.no_win++,!1;c&&b.write(c);if(!e)return!0;h&&(h.endState.success++,h.analyze(b,a,l));e.items=[];e.route=[];for(const a of J){const [c,d]=a;e.route.push(d);g=b.nodes[c];null!=g.slotName&&(oa=g.slotName,0>oa.indexOf(g.orig)&&(oa+=` (normally ${g.vanillaItemName})`),e.items.push({slotIndex:g.slotIndex,itemIndex:g.itemIndex,origName:g.vanillaItemName,slotName:g.slotName,itemName:g.item.name,text:`${g.item.name}: ${oa}`}))}return!0});
...
4<=e.sells.length?g.push(d):e.sells.push(d));for(const {shops:b}of[a,c])for(const a of b)a.sells.sort((a,b)=>a.id-b.id)}integrate(b={}){const {tracker:a=!1}=b;var c=!a;const d=new SparseDependencyGraph$$module$js$graph(this.nodes.length),e=[],f=[],g=new Set,h=new Map;var k=[],m=[];const p=[];var q=[];const t=[];b=new Set;for(var l of this.nodes)if(l instanceof Location$$module$js$nodes){if(l.isStart){const [a]=d.addRoute([l.uid]);h.set(a.label,a)}e[l.uid]=[];f[l.uid]=[];for(const a of l.connections)g.has(a)||
(g.add(a),a.bidi&&g.add(a.reverse()));for(const a of l.chests)d.addRoute([a.uid,l.uid])}else if(l instanceof ItemGet$$module$js$nodes&&"Medical Herb"===l.name&&(d.addRoute([l.uid]),d.finalize(l.uid)),l instanceof Option$$module$js$nodes)k.push(l);else if(l instanceof TrackerNode$$module$js$nodes)m.push(l);else if(l instanceof Condition$$module$js$nodes)p.push(l);else if(l instanceof Trigger$$module$js$nodes)q.push(l);else if(l instanceof ItemGet$$module$js$nodes)t.push(l);else if(l instanceof Slot$$module$js$nodes)b.add(l);
else if(!(l instanceof Area$$module$js$nodes))throw Error(`Unknown node type: ${l.nodeType}`);for(const a of g)e[a.from.uid].push(a),f[a.to.uid].push(a);l=(b)=>{for(const c of b){for(const b of c.edges({tracker:a}))d.addRoute(b);d.finalize(c.uid)}};l(k);c&&l(m);l(q);for(c=h.values();!(k=c.next()).done;){k=k.value;m=k.target;for(var n of e[m]){m=[n.to.uid,...k.deps];for(q=n.deps.length-1;0<=q;q--)m.push(n.deps[q].uid);n.from.bossNode&&m.push(n.from.bossNode.uid);for(const a of d.addRoute(m))h.has(a.label)||
...
new Set;for(var e=0;e<this.locationToUid.length;e++)d.add(e);e=d[Symbol.iterator]();for(var f;!(f=e.next()).done;){f=f.value;d.delete(f);if(c.has(f))continue;const e=this.routes[f];for(let h=0;h<e.length;h++)if(Bits$$module$js$bits.containsAll(b,e[h])){c.add(f);if(a[f]){b=Bits$$module$js$bits.with(b,a[f]);for(let b of this.unlocks[a[f]])d.add(b)}break}}return c}traverseDepths(b){let a=Bits$$module$js$bits.of(),c=0;const d=[],e={};let f=new Set;for(var g=0;g<this.locationToUid.length;g++)f.add(g);
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="defrag",LABEL$$module$js$version="defrag ca6a933",HASH$$module$js$version="ca6a9338b72b3c1745b83b584ee990f9dcebbed9",DATE$$module$js$version=new Date(1554546504E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);d=a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$js$patch(b,parseSeed$$module$js$patch(a.seed),d,new FetchReader$$module$js$fetchreader(c))})}};
...
m=new Assembler$$module$js$6502,p=(a)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){m.assemble(yield d.read(a),a);m.patchRom(b)}),q=Object.keys(k).filter((a)=>k[a]).map((a)=>`define ${a} 1\n`).join("");m.assemble(q,"flags.s");yield p("preshuffle.s");g=new Random$$module$js$random(g);yield shuffle2$$module$js$depgraph(b,g,e,c,f);h&&rescaleShops$$module$js$patch(b,m,c.check("Pb")?g:null);h=new Rom$$module$js$rom(b);rescaleMonsters$$module$js$patch(b,h);c.check("Mr")&&shuffleMonsters$$module$js$patch(b,
h,g);identifyKeyItemsForDifficultyBuffs$$module$js$patch(h);c.check("Em")?(b[115996]*=2,b[115962]*=3):c.check("Hm")||(b[115996]+=16,b[115962]*=2);c.check("Rp")&&connectLimeTreeToLeaf$$module$js$patch(h);addCordelWestTriggers$$module$js$patch(h,c);c.check("Fr")&&fixRabbitSkip$$module$js$patch(h);c.check("Rs")&&storyMode$$module$js$patch(h);misc$$module$js$patch(h);yield p("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(b,c,m);updateCoinDrops$$module$js$patch(b,c);shuffleRandomNumbers$$module$js$patch(b,
g);yield h.writeData();return stampVersionSeedAndHash$$module$js$patch(b,a,c)}),misc$$module$js$patch=(b)=>{},eastCave$$module$js$patch=(b)=>{},addCordelWestTriggers$$module$js$patch=(b,a)=>{for(const c of b.locations[21].objects)2===c[2]&&(128>c[3]||a.check("Fp"))&&b.locations[20].objects.push([...c])},fixRabbitSkip$$module$js$patch=(b)=>{for(const a of b.locations[40].objects)2===a[2]&&134===a[3]&&(116===a[1]&&a[1]++,a[0]++)},storyMode$$module$js$patch=(b)=>{const a=b.npcSpawns[203].conditions[166];
...
this.report["$"+d.id.toString(16).padStart(2,0)]=[];const {maxFlyers:g,nonFlyers:h={},fixedSlots:k={}}=MONSTER_ADJUSTMENTS$$module$js$patch[d.id]||{};let m=k.pat0||null,p=k.pat1||null,q=k.pal2||null,t=k.pal3||null,l=g,n=!1;for(const b of d.objects||[])if(2==(b[2]&7)&&(n=!0),!(b[2]&7)){var a=b[3]+80;126==a||127==a||159==a?p=98:143==a&&(m=97)}if(21==d.id||71==d.id)n=!1;f.push(`Initial pass: ${[n,m,p,q,t].join(", ")}`);a=(a)=>{var b=FLYERS$$module$js$patch.has(a.id),c=MOTHS_AND_BATS$$module$js$patch.has(a.id);
