...
h=new TrackerNode$$module$js$nodes(a,TrackerNode$$module$js$nodes.HARD,"Hard"),k=(a)=>a.value?a:g,m=c("Leather Boots grant speed",f("Ts",!0)),p=k(c("Assume ghetto flight",f("Gf",!0))),q=k(c("Assume statue glitch",f("Gt",!0))),t=k(c("Assume teleport skip",f("Gp",!1))),l=k(c("Assume rabbit skip",f("Gr",!1))),n=c("Sword magic optional",f("Hw",!1)),x=c("Matching sword optional",f("Hs",!1)),A=c("Gas mask optional",f("Hg",!1)),P=c("Healed dolphin optional",f("!Rd",!0)),ta=c("Calmed sea not required",f("!Rl",
!1)),ma=c("Sword of Thunder teleports to Shyron",f("Rt",!0)),da=c("Barrier magic optional",f("Hb",!0)),Ma=c("Refresh magic optional",f("!Er",!0)),mb=c("Lime Tree connects to Leaf",f("Rp",!0)),Nd=k(c("Assume wild warp",f("Gw",!1))),Od=c("Allow wild warp",f("!Tw",!1)),Pd=c("Allow statue glitch",f("!Ft",!1)),Qd=k(c("Assume sword charge glitch",f("Gc",!1))),Rd=c("Allow sword charge glitch",f("!Fc",!1)),Sd=c("Buffed medical herb",f("!Hm",!0)),W=d(0,"Sword of Wind").weight(b.check("Es")?10:5).fromPerson("Leaf elder",
13).npcSpawn(94,16,1).dialog(13,192,2).key(),X=d(1,"Sword of Fire").weight(b.check("Es")?10:5).fromPerson("Oak elder",29).dialog(29,null,3).key(),Q=d(2,"Sword of Water").weight(10).chest().key(),L=d(3,"Sword of Thunder").weight(15).chest().key(),nb=d(4,"Crystalis").fixed(),Na=d(5,"Ball of Wind").chest().key(),Ha=d(6,"Tornado Bracelet").chest().key(),Oa=d(7,"Ball of Fire").bossDrop("Insect",1).dialog(30,null,0).dialog(32,null,0).dialog(33,null,0).dialog(34,null,0).dialog(96,30,0).dialog(29,null,2).dialog(31,
null,0).npcSpawn(193).key(),Pa=d(8,"Flame Bracelet").bossDrop("Kelbesque 1",2).npcSpawn(194).key(),Qa=d(9,"Ball of Water").weight(5).direct("Rage",250679).npcSpawn(195).key(),Ra=d(10,"Blizzard Bracelet").weight(5).chest().key(),Sa=d(11,"Ball of Thunder").bossDrop("Mado 1",5).trigger(154,1).key(),Ta=d(12,"Storm Bracelet").chest().key(),Ub=d(13,"Carapace Shield").armor(),Td=d(14,"Bronze Shield").armor(),Vb=d(15,"Platinum Shield").armor(),Wb=d(16,"Mirrored Shield").armor(),Ud=d(17,"Ceramic Shield").armor(),
ob=d(18,"Sacred Shield").armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),Xb=d(19,"Battle Shield").armor(),Vd=d(20,"Psycho Shield").armor(),Wd=d(21,"Tanned Hide").armor(),Xd=d(22,"Leather Armor").armor(),Yd=d(23,"Bronze Armor").armor(),Yb=d(24,"Platinmum Armor").armor(),Zd=d(25,"Soldier Suit").armor(),Zb=d(26,"Ceramic Suit").armor(),$d=d(27,"Battle Suit").armor(),ae=d(28,"Psycho Armor").armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),E=d(29,"Medical Herb").consumable(),
H=d(30,"Antidote").consumable(),ua=d(31,"Lysis Plant").consumable(),pb=d(32,"Fruit of Lime").consumable(),I=d(33,"Fruit of Power").consumable(),R=d(34,"Magic Ring").consumable(),qb=d(35,"Fruit of Repun").consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),M=d(36,"Warp Boots").consumable(),$b=d(37,"Statue of Onyx").chest("Cordel grass").invisible(254882).key(),rb=d(38,"Opel Statue").consumable().bossDrop("Kelbesque 2",6).npcSpawn(197).key(),ac=d(39,"Insect Flute").fromPerson("Oak mother",30).dialog(30,
null,1).key(),sb=d(40,"Flute of Lime").fromPerson("Portoa queen",56).direct(39161).dialog(56,null,4).key(),Ua=d(41,"Gas Mask").direct("Akahana in Brynmaer",251902).npcSpawn(22,24).key(),be=d(42,"Power Ring").chest().bonus(),ce=d(43,"Warrior Ring").fromPerson("Akahana's friend",84).dialog(84,null,2).bonus(),de=d(44,"Iron Necklace").chest().bonus(),ee=d(45,"Deo's Pendant").fromPerson("Deo",90).dialog(90,null,0).bonus(),tb=d(46,"Rabbit Boots").bossDrop("Vampire 1",0).npcSpawn(192).key(),bc=d(47,f("Ts",
!0)?"Speed Boots":"Leather Boots").chest().bonus(),cc=d(48,"Shield Ring").direct("Akahana in waterfall cave",250543).npcSpawn(22,87,2).bonus(),ub=d(49,"Alarm Flute").fromPerson("Zebu's student",20,1).key(),dc=d(50,"Windmill Key").fromPerson("Windmill guard",20).dialog(20,14,0).npcSpawn(20,14,1).key(),ec=d(51,"Key to Prison").chest().key(),fc=d(52,"Key to Styx").fromPerson("Zebu in Shyron",94,1).trigger(128,2).dialog(94,242,0).dialog(98,242,0).key(),gc=d(53,"Fog Lamp").chest().key(),vb=d(54,"Shell Flute").fromPerson("Dolphin",
99,1).npcSpawn(99).key(),hc=d(55,"Eye Glasses").fromPerson("Clark",68).dialog(68,233,1).key(),ic=d(56,"Broken Statue").bossDrop("Sabera 1",4).npcSpawn(127,101).npcSpawn(70).npcSpawn(71).npcSpawn(106).npcSpawn(132).npcSpawn(142).dialog(61).dialog(62).dialog(63).dialog(64).dialog(65).dialog(66).dialog(67).dialog(68,233).trigger(182).key(),jc=d(57,"Glowing Lamp").direct("Kensu in lighthouse",250638).npcSpawn(126,98,1).key(),kc=d(59,"Love Pendant").chest("Underground channel").invisible(254890).key(),
lc=d(60,"Kirisa Plant").chest("Kirisa meadow").invisible(254886).key(),wb=d(61,"Ivory Statue").bossDrop("Karmine",9).npcSpawn(200).key(),mc=d(62,"Bow of Moon").fromPerson("Aryllis",35).direct(251624).dialog(35,null,1).key(),nc=d(63,"Bow of Sun").chest().key(),oc=d(64,"Bow of Truth").fromPerson("Azteca",131).npcSpawn(131,156,1).dialog(131,null,0).key(),Va=(new Magic$$module$js$nodes(a,65,"Refresh",65,null)).fromPerson("Zebu at windmill",94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,
1),Wa=(new Magic$$module$js$nodes(a,66,"Paralysis",66,null)).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),na=(new Magic$$module$js$nodes(a,67,"Telepathy",67,null)).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),pc=(new Magic$$module$js$nodes(a,68,"Teleport",68,null)).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),fe=(new Magic$$module$js$nodes(a,69,"Recover",69,null)).direct("Asina in Portoa",250361),qc=(new Magic$$module$js$nodes(a,
70,"Barrier",70,null)).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),va=(new Magic$$module$js$nodes(a,71,"Change",71,null)).direct("Kensu in Swan",251614).npcSpawn(116,241,1),B=(new Magic$$module$js$nodes(a,72,"Flight",72,null)).weight(15).direct("Kensu in Draygonia Fortress",250255),ge=I.bossDrop("Vampire 2",12,97).npcSpawn(204).key(),J=d(112,"Mimic"),rc=(new Trigger$$module$js$nodes(a,"Talked to Leaf Elder")).get(W),sc=(new Trigger$$module$js$nodes(a,"Talked to Leaf Student")).get(ub),
xb=new Trigger$$module$js$nodes(a,"Talked to Zebu in cave"),he=(new Trigger$$module$js$nodes(a,"Woke up Windmill Guard")).get(dc),Xa=new Trigger$$module$js$nodes(a,"Started Windmill"),tc=(new Trigger$$module$js$nodes(a,"Learned Refresh")).get(Va),ie=(new Trigger$$module$js$nodes(a,"Gave Statue to Akahana")).get(Ua),je=(new Trigger$$module$js$nodes(a,"Fought Stom")).get(na),uc=new Trigger$$module$js$nodes(a,"Visited Oak"),vc=new Trigger$$module$js$nodes(a,"Talked to Oak Mother"),yb=new Trigger$$module$js$nodes(a,
"Rescued Oak Child"),ke=(new Trigger$$module$js$nodes(a,"Talked to Oak Mother Again")).get(ac),le=(new Trigger$$module$js$nodes(a,"Talked to Oak Elder")).get(X),me=(new Trigger$$module$js$nodes(a,"Talked to Tornel on Mt Sabre")).get(pc),wc=new Trigger$$module$js$nodes(a,"Villagers Abducted"),xc=new Trigger$$module$js$nodes(a,"Talked to Rabbit in Leaf"),ne=(new Trigger$$module$js$nodes(a,"Learned Paralysis")).get(Wa),yc=new Trigger$$module$js$nodes(a,"Talked to Portoa Queen"),zc=new Trigger$$module$js$nodes(a,
"Talked to Fortune Teller"),Ac=new Trigger$$module$js$nodes(a,"Visited Underground Channel"),oe=(new Trigger$$module$js$nodes(a,"Sent to Waterfall Cave")).get(sb),pe=(new Trigger$$module$js$nodes(a,"Cured Akahana")).get(cc),Bc=(new Trigger$$module$js$nodes(a,"Talked to Rage")).get(Qa),Cc=new Trigger$$module$js$nodes(a,"Mesia recording played"),Dc=(new Trigger$$module$js$nodes(a,"Talked to Asina")).get(fe),Ec=(new Trigger$$module$js$nodes(a,"Healed Dolphin")).get(vb),zb=new Trigger$$module$js$nodes(a,
"Returned Fog Lamp"),Fc=new Trigger$$module$js$nodes(a,"Talked to Kensu in Cabin"),Gc=new Trigger$$module$js$nodes(a,"Talked to Joel Elder"),qe=(new Trigger$$module$js$nodes(a,"Talked to Clark")).get(hc),re=(new Trigger$$module$js$nodes(a,"Talked to Kensu in Lighthouse")).get(jc),Ab=new Trigger$$module$js$nodes(a,"Calmed the Angry Sea"),se=(new Trigger$$module$js$nodes(a,"Learned Barrier")).get(qc),Hc=new Trigger$$module$js$nodes(a,"Talked to Stom in Swan Hut"),Ic=new Trigger$$module$js$nodes(a,"Talked to Kensu in Swan tavern"),
Jc=new Trigger$$module$js$nodes(a,"Talked to Kensu at Swan dance"),te=(new Trigger$$module$js$nodes(a,"Returned Kensu's love pendant")).get(va),ue=(new Trigger$$module$js$nodes(a,"Talked to Amazones Queen")).get(mc),Bb=new Trigger$$module$js$nodes(a,"Entered Shyron"),ve=(new Trigger$$module$js$nodes(a,"Talked to Zebu in Shyron")).get(fc),Kc=new Trigger$$module$js$nodes(a,"Shyron Massacre"),we=(new Trigger$$module$js$nodes(a,"Saved Kensu")).get(B),xe=(new Trigger$$module$js$nodes(a,"Talked to Deo")).get(ee),
ye=(new Trigger$$module$js$nodes(a,"Talked to Akahana's Friend")).get(ce),ze=(new Trigger$$module$js$nodes(a,"Get Bow of Truth")).get(oc),Ae=(new Trigger$$module$js$nodes(a,"Forged Crystalis")).get(nb),Ya=(new Condition$$module$js$nodes(a,"Sword charge glitch")).option(Qd,Rd),Be=(new Condition$$module$js$nodes(a,"Rabbit skip")).option(l),Ce=(new Condition$$module$js$nodes(a,"Teleport skip")).option(t),Cb=(new Condition$$module$js$nodes(a,"Statue glitch")).option(q,Pd),De=(new Condition$$module$js$nodes(a,
"Wild warp")).option(Nd,Od),Za=(new Condition$$module$js$nodes(a,"Any level 2 sword")).option(W,Na).option(W,Ha).option(X,Oa).option(X,Pa).option(Q,Qa).option(Q,Ra).option(L,Sa).option(L,Ta),v=(new Condition$$module$js$nodes(a,"Destroy stone")).option(W,Na).option(W,Ha).option(Ya,W,Za),w=(new Condition$$module$js$nodes(a,"Destroy ice")).option(X,Oa).option(X,Pa).option(Ya,X,Za),r=(new Condition$$module$js$nodes(a,"Cross rivers")).option(Q,Qa).option(Q,Ra).option(B).option(Ya,Q,Za),wa=(new Condition$$module$js$nodes(a,
"Destroy iron")).option(L,Sa).option(L,Ta).option(Ya,L,Za),Y=(new Condition$$module$js$nodes(a,"Any sword")).option(W).option(X).option(Q).option(L),Ee=(new Condition$$module$js$nodes(a,"Match insect sword (fire/water/thunder)")).option(X).option(Q).option(L).option(Ua,x.value?x:h,W),Lc=(new Condition$$module$js$nodes(a,"Speed boots")).option(bc,m),Mc=(new Condition$$module$js$nodes(a,"Climb slopes")).option(tb).option(B).option(Lc),Fe=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (rabbit)")).option(xc).option(Be),
Ge=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (Teleport)")).option(pc).option(Ce,B),Nc=(new Condition$$module$js$nodes(a,"Asina in her room")).option(Cc),He=(new Condition$$module$js$nodes(a,"Paralysis or Asina revealed")).option(Wa).option(Nc).option(Cb),Oc=(new Condition$$module$js$nodes(a,"Ride dolphin")).option(vb,Fc),Ie=(new Condition$$module$js$nodes(a,"Ghetto flight")).option(p,Oc,tb),Z=(new Condition$$module$js$nodes(a,"Cross sea")).option(Oc).option(B),Je=(new Condition$$module$js$nodes(a,
"Cross whirlpool")).option(Ab).option(B).option(Ie),N=(new Condition$$module$js$nodes(a,"Refresh if needed")).option(Ma.value?Ma:h).option(Va),Pc=(new Condition$$module$js$nodes(a,"Wind magic")).option(n.value?n:h,N).option(Na,Ha,N),Qc=(new Condition$$module$js$nodes(a,"Fire magic")).option(n.value?n:h,N).option(Oa,Pa,N),Rc=(new Condition$$module$js$nodes(a,"Water magic")).option(n.value?n:h,N).option(n,N).option(Qa,Ra,N),Ke=(new Condition$$module$js$nodes(a,"Thunder magic")).option(n.value?n:h,N).option(n,
N).option(Sa,N).option(Ta,N),Le=(new Condition$$module$js$nodes(a,"Flute of lime or glitch")).option(sb).option(Cb),Sc=(new Condition$$module$js$nodes(a,"Change or glitch")).option(va).option(Cb),Db=(new Condition$$module$js$nodes(a,"Pass shooting statues")).option(qc).option(da.value?da:h).option(Va,cc),Me=(new Condition$$module$js$nodes(a,"Healed dolphin if required")).option(Ec).option(P),Tc=(new Condition$$module$js$nodes(a,"Match sword of wind")).option(W).option(x.value?x:h,Y),Uc=(new Condition$$module$js$nodes(a,
"Match sword of fire")).option(X).option(x.value?x:h,Y),Vc=(new Condition$$module$js$nodes(a,"Match sword of water")).option(Q).option(x.value?x:h,Y),Ne=(new Condition$$module$js$nodes(a,"Match sword of thunder")).option(L).option(x.value?x:h,Y),Oe=(new Condition$$module$js$nodes(a,"Swamp run possible")).option(Y).option(Lc).option(Sd).option(Va),Pe=(new Condition$$module$js$nodes(a,"Insect possible to kill")).option(Ua),$a=(new Condition$$module$js$nodes(a,"Travel swamp")).option(Ua).option(A.value?
A:h,Oe),Qe=(new Condition$$module$js$nodes(a,"Calmed sea if required")).option(Ab).option(ta),Re=e(0,"Vampire 1",Y).get(tb),Se=e(1,"Insect",ac,Ee,Pe).get(Oa),Te=e(2,"Kelbesque 1",Tc,Pc).get(Pa),Ue=e(12,"Vampire 2",Y).get(ge),Wc=e(4,"Sabera 1",Uc,Qc).get(ic),Ve=e(5,"Mado 1",Vc,Rc).get(Sa),We=e(6,"Kelbesque 2",Tc,Pc).get(rb),Xe=e(7,"Sabera 2",Uc,Qc).get(qb),Ye=e(8,"Mado 2",Vc,Rc).get(ob),Ze=e(9,"Karmine",Ne,Ke).get(wb),$e=e(10,"Draygon 1",Y).get(ae),af=e(null,"Statues",nc,mc),bf=e(11,"Draygon 2",Y,
oc),cf=e(13,"Dyna",nb),S=new Area$$module$js$nodes(a,"Leaf"),xa=new Area$$module$js$nodes(a,"Valley of Wind"),O=new Area$$module$js$nodes(a,"Sealed Cave"),oa=new Area$$module$js$nodes(a,"Cordel Plain"),ya=new Area$$module$js$nodes(a,"Brynmaer"),za=new Area$$module$js$nodes(a,"Amazones"),C=new Area$$module$js$nodes(a,"Mt Sabre West"),u=new Area$$module$js$nodes(a,"Mt Sabre North"),ab=new Area$$module$js$nodes(a,"Nadare's"),Ia=new Area$$module$js$nodes(a,"Oak"),ea=new Area$$module$js$nodes(a,"Waterfall Valley"),
z=new Area$$module$js$nodes(a,"Portoa"),fa=new Area$$module$js$nodes(a,"Waterfall Cave"),D=new Area$$module$js$nodes(a,"Fog Lamp Cave"),ha=new Area$$module$js$nodes(a,"Kirisa Plant Cave"),pa=new Area$$module$js$nodes(a,"Angry Sea"),ia=new Area$$module$js$nodes(a,"Joel"),G=new Area$$module$js$nodes(a,"Evil Spirit Island"),ja=new Area$$module$js$nodes(a,"Sabera's Castle"),T=new Area$$module$js$nodes(a,"Swan"),y=new Area$$module$js$nodes(a,"Mt Hydra"),ka=new Area$$module$js$nodes(a,"Shyron"),qa=new Area$$module$js$nodes(a,
"Styx"),ra=new Area$$module$js$nodes(a,"Goa"),bb=new Area$$module$js$nodes(a,"Draygonia Fortress 1"),U=new Area$$module$js$nodes(a,"Draygonia Fortress 2"),Aa=new Area$$module$js$nodes(a,"Draygonia Fortress 3"),K=new Area$$module$js$nodes(a,"Draygonia Fortress 4"),F=new Area$$module$js$nodes(a,"Oasis Cave");new Area$$module$js$nodes(a,"Desert");const V=new Area$$module$js$nodes(a,"Sahara"),Ba=new Area$$module$js$nodes(a,"Pyramid Front"),aa=new Area$$module$js$nodes(a,"Pyramid Back"),ba=new Area$$module$js$nodes(a,
"Tower"),Eb=(new Location$$module$js$nodes(a,0,S,"Start")).overworld().start(),df=(new Location$$module$js$nodes(a,0,S,"Mezame Shrine")).overworld().from(Eb),ef=(new Location$$module$js$nodes(a,1,S,"Outside Start")).overworld().connect(df),la=(new Location$$module$js$nodes(a,2,S,"Town")).town().connect(ef),Ja=(new Location$$module$js$nodes(a,3,xa,"Main")).overworld().connect(la).trigger(tc,Xa),Xc=(new Location$$module$js$nodes(a,3,xa,"Outside Windmill")).overworld(),Yc=(new Location$$module$js$nodes(a,
4,O,"Tunnel 1 (entrance)")).cave().from(Ja,Xa),ff=(new Location$$module$js$nodes(a,5,O,"Tunnel 2 (over bridge)")).cave().connect(Yc),gf=(new Location$$module$js$nodes(a,6,O,"Tunnel 6 (herb dead end)")).cave().chest(E,15),Zc=(new Location$$module$js$nodes(a,7,O,"Tunnel 4a (ball corridor)")).cave().chest(E,20,80).chest(Na,21);(new Location$$module$js$nodes(a,7,O,"Tunnel 4b (antidote dead end)")).cave().connect(Zc,v).chest(H,19);const hf=(new Location$$module$js$nodes(a,8,O,"Tunnel 5 (warp boots dead end)")).cave().chest(M,
14),jf=(new Location$$module$js$nodes(a,9,O,"Tunnel 3a (branch, front)")).cave().connect(ff).connectTo(Zc).connectTo(hf),kf=(new Location$$module$js$nodes(a,9,O,"Tunnel 3b (branch, back)")).cave().connect(jf,v).connectTo(gf),lf=(new Location$$module$js$nodes(a,10,O,"Tunnel 7 (boss)")).cave().connect(kf).boss(Re),mf=(new Location$$module$js$nodes(a,12,O,"Tunnel 8a (exit, above wall)")).cave().connect(lf),nf=(new Location$$module$js$nodes(a,12,O,"Tunnel 8b (exit, below wall")).cave().connect(mf,v);
(new Location$$module$js$nodes(a,14,xa,"Windmill Cave")).cave().connect(Ja).connectTo(Xc).trigger(he,ub,xb);(new Location$$module$js$nodes(a,15,xa,"Windmill")).misc().connect(Xc).trigger(Xa,dc);const of=(new Location$$module$js$nodes(a,16,xa,"Zebu's Cave Front")).cave().connect(Ja).trigger(xb,rc,sc).trigger(tc,Xa,xb),pf=(new Location$$module$js$nodes(a,16,xa,"Zebu's Cave Back")).cave().trigger(wc).connect(of,w),qf=(new Location$$module$js$nodes(a,17,C,"Tunnel 1 (to Zebu)")).cave().connect(pf),Ca=
(new Location$$module$js$nodes(a,20,oa,"West")).overworld().connect(nf),rf=(new Location$$module$js$nodes(a,20,oa,"South")).overworld().connect(Ca,r),$c=(new Location$$module$js$nodes(a,21,oa,"East")).overworld().connect(Ca).chest($b,24),Ka=(new Location$$module$js$nodes(a,24,ya,"Town")).town().connect(Ca).trigger(ie,$b),sf=(new Location$$module$js$nodes(a,25,oa,"Outside Stom's House")).town().connect(Ca),Fb=(new Location$$module$js$nodes(a,26,oa,"Swamp")).overworld().connect($c,$a).trigger(yb,vc,
$a);(new Location$$module$js$nodes(a,26,oa,"Swamp Insect Area")).overworld().connect(Fb,$a).boss(Se);const cb=(new Location$$module$js$nodes(a,27,za,"Town")).town().connect(rf),db=(new Location$$module$js$nodes(a,28,Ia,"Town")).town().connect(Fb,$a).trigger(uc);(new Location$$module$js$nodes(a,30,oa,"Stom's House")).house().connect(sf).trigger(je,uc);const Da=(new Location$$module$js$nodes(a,32,C,"Entrance")).overworld().connect(Ca).connect(qf),tf=(new Location$$module$js$nodes(a,32,C,"Up Slope")).overworld().from(Da,
Mc).to(Da),uf=(new Location$$module$js$nodes(a,32,C,"Dead End (warp boots)")).overworld().chest(M,24,106),ad=(new Location$$module$js$nodes(a,33,C,"Upper")).overworld().from(Da,B).to(Da),vf=(new Location$$module$js$nodes(a,33,C,"Tornel Dead End")).overworld().trigger(me,Ha).chest(R,23,105),bd=(new Location$$module$js$nodes(a,34,C,"Tunnel 2a (fork at start)")).cave().connect(Da);(new Location$$module$js$nodes(a,34,C,"Tunnel 2b (left branch to dead end)")).cave().connect(bd,w).connectTo(uf);const wf=
(new Location$$module$js$nodes(a,34,C,"Tunnel 2c (right branch to upper)")).cave().connect(bd,w),xf=(new Location$$module$js$nodes(a,35,C,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(wf).chest(E,23,82),yf=(new Location$$module$js$nodes(a,35,C,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(xf,w).connectTo(ad),cd=(new Location$$module$js$nodes(a,36,C,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(yf);(new Location$$module$js$nodes(a,36,C,"Tunnel 4b (out to upper)")).cave().connect(cd,
w).connectTo(ad);const zf=(new Location$$module$js$nodes(a,37,C,"Tunnel 5 (tiny connector)")).cave().connect(cd),Af=(new Location$$module$js$nodes(a,38,C,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(zf);(new Location$$module$js$nodes(a,38,C,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Af,w).connectTo(vf);const Bf=(new Location$$module$js$nodes(a,39,C,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(tf),Cf=(new Location$$module$js$nodes(a,39,C,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Bf,
w);(new Location$$module$js$nodes(a,39,C,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Cf,w).chest(Ha,25);const eb=(new Location$$module$js$nodes(a,40,u,"Entrance")).overworld().connect($c,Ge,Fe),fb=(new Location$$module$js$nodes(a,40,u,"Upper")).overworld().from(eb,B).to(eb),Gb=(new Location$$module$js$nodes(a,40,u,"Summit (boss)")).overworld().from(fb,B).to(fb).boss(Te),dd=(new Location$$module$js$nodes(a,41,u,"Connector")).overworld(),Hb=(new Location$$module$js$nodes(a,41,u,"Middle Left")).overworld(),
Df=(new Location$$module$js$nodes(a,41,u,"Middle Right")).overworld().from(Hb,Mc).to(Hb),ed=(new Location$$module$js$nodes(a,42,u,"Tunnel 2a (from entrance to connector)")).cave().connectTo(dd);(new Location$$module$js$nodes(a,42,u,"Tunnel 2b (under bridge, to antidote)")).cave().connect(ed,w).chest(H,23,94);const fd=(new Location$$module$js$nodes(a,43,u,"Tunnel 3a (branch after connector)")).cave().connect(dd),Ef=(new Location$$module$js$nodes(a,43,u,"Tunnel 3b (right branch)")).cave().connect(fd,
w),Ff=(new Location$$module$js$nodes(a,43,u,"Tunnel 3c (upper branch)")).cave().connect(fd,w);(new Location$$module$js$nodes(a,44,u,"Tunnel 4 (over bridge, to middle)")).cave().connect(Ff).connectTo(Hb);const gd=(new Location$$module$js$nodes(a,45,u,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Ef).connectTo(Df);(new Location$$module$js$nodes(a,45,u,"Tunnel 5b (dead-end with herb)")).cave().connect(gd,w).chest(E,22,83);const Gf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6a (S-shaped hall, right)")).cave().connect(gd),
Hf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Gf,w),If=(new Location$$module$js$nodes(a,46,u,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Hf,w),hd=(new Location$$module$js$nodes(a,47,u,"Prison (hallway)")).cave().connect(fb),Jf=(new Location$$module$js$nodes(a,48,u,"Left Cell (shopkeepers)")).cave().from(hd,w);(new Location$$module$js$nodes(a,49,u,"Left Cell 2 (back, with prison key)")).cave().from(Jf,w).chest(ec,13);const Kf=(new Location$$module$js$nodes(a,
50,u,"Right Cell (villagers)")).cave().from(hd,w),Lf=(new Location$$module$js$nodes(a,51,u,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Kf,w);(new Location$$module$js$nodes(a,52,u,"Tunnel 9 (connector to summit)")).cave().connect(Lf).connectTo(Gb);const Mf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10a (summit cave, front)")).cave().from(Gb,ec).to(Gb),Nf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10b (summit cave, behind ice)")).cave().connect(Mf,w).trigger(ne);(new Location$$module$js$nodes(a,
56,u,"Tunnel 1 (leads from main entrance)")).cave().connect(eb).connectTo(ed);(new Location$$module$js$nodes(a,57,u,"Tunnel 7 (to upper)")).cave().connect(If).connectTo(fb);const Of=(new Location$$module$js$nodes(a,60,ab,"Inn")).shop(),Pf=(new Location$$module$js$nodes(a,61,ab,"Tool Shop")).shop(E,H,I,M),Qf=(new Location$$module$js$nodes(a,62,ab,"Back Room")).house(),Ib=(new Location$$module$js$nodes(a,64,ea,"Summit")).overworld().connect(Nf),gb=(new Location$$module$js$nodes(a,64,ea,"Northwest")).overworld().from(Ib).to(Ib,
B),Rf=(new Location$$module$js$nodes(a,64,ea,"Northeast")).overworld().connect(gb,r),id=(new Location$$module$js$nodes(a,65,ea,"Southwest")).overworld().connect(gb),Sf=(new Location$$module$js$nodes(a,65,ea,"Southeast")).overworld().connect(id,r),jd=(new Location$$module$js$nodes(a,66,ea,"Lime Tree Valley")).overworld().connect(id).connect(Ja,mb),Tf=(new Location$$module$js$nodes(a,67,ea,"Lime Tree Lake (Rage)")).cave().connect(jd).trigger(Bc,Q),Uf=(new Location$$module$js$nodes(a,68,ha,"Tunnel 1a (entrance)")).cave().connect(Sf),
Vf=(new Location$$module$js$nodes(a,68,ha,"Tunnel 1b (behind wall)")).cave().connect(Uf,v),kd=(new Location$$module$js$nodes(a,69,ha,"Tunnel 2a (main path, before wall)")).cave().connect(Vf);(new Location$$module$js$nodes(a,69,ha,"Tunnel 2b (dead end, antidote)")).cave().connect(kd,v).chest(H,25,95);const Wf=(new Location$$module$js$nodes(a,69,ha,"Tunnel 2c (main path, after wall)")).cave().connect(kd,v),Xf=(new Location$$module$js$nodes(a,70,ha,"Tunnel 3a (last room, before wall)")).cave().connect(Wf),
Yf=(new Location$$module$js$nodes(a,70,ha,"Tunnel 3b (last room, after wall)")).cave().connect(Xf,v);(new Location$$module$js$nodes(a,71,ha,"Meadow")).overworld().connect(Yf).chest(lc,14);const Zf=(new Location$$module$js$nodes(a,72,D,"Tunnel 1a (entrance)")).cave().connect(Rf),ld=(new Location$$module$js$nodes(a,72,D,"Tunnel 1b (past wall)")).cave().connect(Zf,v);(new Location$$module$js$nodes(a,72,D,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(ld,v).chest(ua,24);const $f=(new Location$$module$js$nodes(a,
73,D,"Tunnel 2 (tiny connector)")).cave().connect(ld),md=(new Location$$module$js$nodes(a,74,D,"Tunnel 3a (upper branch)")).cave().connect($f);(new Location$$module$js$nodes(a,74,D,"Tunnel 3b (dead end, mimic)")).cave().connect(md,v).chest(J,21,112);const nd=(new Location$$module$js$nodes(a,74,D,"Tunnel 3c (short passage with mimic)")).cave().connect(md,v).chest(J,22,113),ag=(new Location$$module$js$nodes(a,74,D,"Tunnel 3d (lower branch)")).cave().connect(nd,v);(new Location$$module$js$nodes(a,75,
D,"Tunnel 4 (dead end loop)")).cave().connect(ag);const od=(new Location$$module$js$nodes(a,76,D,"Tunnel 5a (right branch over bridge)")).cave().connect(nd),bg=(new Location$$module$js$nodes(a,76,D,"Tunnel 5b (past wall over bridge)")).cave().connect(od,v),cg=(new Location$$module$js$nodes(a,77,D,"Tunnel 6a (from left branch)")).cave().connect(od),dg=(new Location$$module$js$nodes(a,77,D,"Tunnel 6b (reconvergence)")).cave().connect(cg,v).connect(bg),eg=(new Location$$module$js$nodes(a,77,D,"Tunnel 6c (between walls)")).cave().connect(dg,
v),fg=(new Location$$module$js$nodes(a,77,D,"Tunnel 6d (under bridge)")).cave().connect(eg,v),gg=(new Location$$module$js$nodes(a,78,D,"Tunnel 7a (over second bridge)")).cave().connect(fg),hg=(new Location$$module$js$nodes(a,78,D,"Tunnel 7b (past wall)")).cave().connect(gg,v),ig=(new Location$$module$js$nodes(a,79,D,"Tunnel 8a (under second bridge)")).cave().connect(hg);(new Location$$module$js$nodes(a,79,D,"Tunnel 8b (fog lamp)")).cave().connect(ig,v).chest(gc,19);const sa=(new Location$$module$js$nodes(a,
80,z,"Town")).town().connect(gb),pd=(new Location$$module$js$nodes(a,81,z,"Fishherman Island")).town().connect(sa);(new Location$$module$js$nodes(a,82,ea,"Mesia Shrine")).cave().trigger(Cc).connect(Tf,r,Bc);const qd=(new Location$$module$js$nodes(a,84,fa,"Tunnel 1a (entrance)")).cave().connect(gb);(new Location$$module$js$nodes(a,84,fa,"Tunnel 1b (dead end, mimic)")).cave().connect(qd,w).chest(J,19,114);const jg=(new Location$$module$js$nodes(a,84,fa,"Tunnel 1c (past ice)")).cave().connect(qd,w),
kg=(new Location$$module$js$nodes(a,85,fa,"Tunnel 2 (stoned pair)")).cave().connect(jg),Jb=(new Location$$module$js$nodes(a,86,fa,"Tunnel 3 (wide medusa hallways)")).cave().connect(kg,Le),lg=(new Location$$module$js$nodes(a,87,fa,"Tunnel 4a (left entrance)")).cave().from(Jb,w).chest(Wb.chest().bonus(),25).trigger(pe,sb);(new Location$$module$js$nodes(a,87,fa,"Tunnel 4b (right entrance)")).cave().from(Jb,w).connect(lg,B);(new Location$$module$js$nodes(a,87,fa,"Tunnel 4c (sword of water)")).cave().connect(Jb,
w).chest(Q,24);const rd=(new Location$$module$js$nodes(a,88,ba,"Entrance")).misc(),mg=(new Location$$module$js$nodes(a,89,ba,"Level 1")).misc().from(rd),ng=(new Location$$module$js$nodes(a,90,ba,"Level 2")).misc().from(mg),og=(new Location$$module$js$nodes(a,91,ba,"Level 3")).misc().from(ng),sd=(new Location$$module$js$nodes(a,92,ba,"Outside Mesia Room")).misc().from(og),pg=(new Location$$module$js$nodes(a,93,ba,"Outside Dyna Room")).misc().from(sd,nb);(new Location$$module$js$nodes(a,94,ba,"Mesia")).misc().connect(sd).trigger(Ae);
const qg=(new Location$$module$js$nodes(a,95,ba,"Dyna")).misc().from(pg).boss(cf);(new Location$$module$js$nodes(a,95,ba,"Win")).misc().from(qg).end();const Kb=(new Location$$module$js$nodes(a,96,pa,"Cabin Beach")).sea().from(pd,zb),Ea=(new Location$$module$js$nodes(a,96,pa,"South")).sea().connect(Kb,Z),rg=(new Location$$module$js$nodes(a,96,pa,"Joel Beach")).sea().connect(Ea,Z),td=(new Location$$module$js$nodes(a,96,ia,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(a,96,pa,"Altar")).sea().connect(Ea,
Z).trigger(Ab,jc,ic);const sg=(new Location$$module$js$nodes(a,96,pa,"North")).sea().to(Ea,Z).from(Ea,Z,Je).trigger(se,Qe),tg=(new Location$$module$js$nodes(a,96,pa,"Swan Beach")).sea().connect(sg,Z);(new Location$$module$js$nodes(a,97,pa,"Cabin")).misc().connect(Kb).trigger(Fc,zb);(new Location$$module$js$nodes(a,98,ia,"Lighthouse")).misc().connect(td).trigger(re,ub);const hb=(new Location$$module$js$nodes(a,100,z,"Underground Channel 1 (from throne room)")).sea().trigger(Ac),ug=(new Location$$module$js$nodes(a,
100,z,"Underground Channel 2 (to fortune teller)")).sea().connect(hb,r),ud=(new Location$$module$js$nodes(a,100,z,"Underground Channel 3 (from fortune teller)")).sea().connect(hb,B),vd=(new Location$$module$js$nodes(a,100,z,"Underground Channel 4 (asina)")).sea().connect(ud,r),vg=(new Location$$module$js$nodes(a,100,z,"Underground Channel 5 (dolphin)")).sea().connect(vd,r).trigger(Ec,E,Dc);(new Location$$module$js$nodes(a,100,z,"Underground Channel 6 (water)")).sea().connect(vg,Z).connectTo(Ea,Z).chest(kc,
17);const Lb=(new Location$$module$js$nodes(a,101,G,"Zombie Town")).town(),wg=(new Location$$module$js$nodes(a,104,G,"Tunnel 1 (entrance)")).sea().connect(Ea,Gc,Z),wd=(new Location$$module$js$nodes(a,105,G,"Tunnel 2a (start)")).cave().connect(wg);(new Location$$module$js$nodes(a,105,G,"Tunnel 2b (dead end to left)")).cave().connect(wd,r);const xg=(new Location$$module$js$nodes(a,105,G,"Tunnel 2c (across first river)")).cave().connect(wd,r),xd=(new Location$$module$js$nodes(a,105,G,"Tunnel 2d (across second river)")).cave().connect(xg,
r);(new Location$$module$js$nodes(a,105,G,"Tunnel 2e (dead end, magic ring)")).cave().connect(xd,v).chest(R,29);const yg=(new Location$$module$js$nodes(a,105,G,"Tunnel 2f (stair down)")).cave().connect(xd,v),zg=(new Location$$module$js$nodes(a,106,G,"Tunnel 3a (main area)")).cave().connect(yg).connectTo(Lb).chest(ua,25,92),Ag=(new Location$$module$js$nodes(a,106,G,"Tunnel 3b (left area toward items)")).cave().connect(zg,v),Bg=(new Location$$module$js$nodes(a,107,G,"Tunnel 4a (right side, mimic)")).cave().connect(Ag).chest(J,
14,115);(new Location$$module$js$nodes(a,107,G,"Tunnel 4b (left side, iron necklace)")).cave().connect(Bg,r).chest(de,15);const Mb=(new Location$$module$js$nodes(a,108,ja,"Floor 1")).fortress().connect(Lb),Cg=(new Location$$module$js$nodes(a,108,ja,"Miniboss")).fortress().boss(Ue).connect(Mb);(new Location$$module$js$nodes(a,109,ja,"Floor 2a (left stair)")).fortress().connect(Mb).chest(I,19);const Dg=(new Location$$module$js$nodes(a,109,ja,"Floor 2b (right stair)")).fortress().connect(Cg).chest(E,
30,85),Eg=(new Location$$module$js$nodes(a,110,ja,"Floor 3a (toward boss)")).fortress().connect(Dg),yd=(new Location$$module$js$nodes(a,110,ja,"Floor 3b (boss room)")).fortress().connect(Eg);(new Location$$module$js$nodes(a,110,ja,"Boss")).fortress().boss(Wc).connect(yd);(new Location$$module$js$nodes(a,110,ja,"Floor 3c (back room trap)")).fortress().from(yd).to(Mb);const Fg=(new Location$$module$js$nodes(a,112,ia,"Secret Passage")).cave().connectTo(td),ib=(new Location$$module$js$nodes(a,113,ia,
"Town")).town().connect(rg),ca=(new Location$$module$js$nodes(a,114,T,"Town")).town().connect(tg),Gg=(new Location$$module$js$nodes(a,115,T,"Inside Gate")).overworld().connect(ca),Hg=(new Location$$module$js$nodes(a,115,T,"Outside Gate")).overworld().from(Gg,va),jb=(new Location$$module$js$nodes(a,120,ra,"Valley")).overworld().connect(Hg),Nb=(new Location$$module$js$nodes(a,124,y,"Entrance")).overworld().connect(jb),Ig=(new Location$$module$js$nodes(a,124,y,"Over first river toward Shyron")).overworld().connect(Nb,
r),zd=(new Location$$module$js$nodes(a,124,y,"After first tunnel")).overworld(),Ad=(new Location$$module$js$nodes(a,124,y,"Door to Styx")).overworld().connect(zd,r),Jg=(new Location$$module$js$nodes(a,124,y,"Dead end (no item)")).overworld(),Kg=(new Location$$module$js$nodes(a,124,y,"Dead end (fruit of lime)")).overworld().chest(pb,26),Lg=(new Location$$module$js$nodes(a,124,y,"Dead end (magic ring)")).overworld().chest(R,25,101),Bd=(new Location$$module$js$nodes(a,124,y,"Outside tunnel to bow")).overworld();
(new Location$$module$js$nodes(a,124,y,"Floating island (bow of sun)")).overworld().connect(Bd,B).chest(nc,24);const Mg=(new Location$$module$js$nodes(a,125,y,"Tunnel 1 (to Shyron)")).cave().connect(Ig),Ng=(new Location$$module$js$nodes(a,126,y,"Outside Shyron")).overworld().connect(Mg);(new Location$$module$js$nodes(a,127,y,"Tunnel 2 (fork)")).cave().connect(Nb).connectTo(Kg).connectTo(zd);const Cd=(new Location$$module$js$nodes(a,128,y,"Tunnel 3 (caves)")).cave().connect(Ad).connect(Jg),Dd=(new Location$$module$js$nodes(a,
129,y,"Tunnel 4 (left branch of cave)")).cave().connect(Cd);(new Location$$module$js$nodes(a,130,y,"Tunnel 5 (dead end, medical herb)")).cave().connect(Dd).chest(E,15,86);const Og=(new Location$$module$js$nodes(a,131,y,"Tunnel 6a (left-then-right)")).cave().connect(Dd),Pg=(new Location$$module$js$nodes(a,131,y,"Tunnel 6b (past wall)")).cave().connect(Og,v),Qg=(new Location$$module$js$nodes(a,132,y,"Tunnel 7 (wide hall)")).cave().connect(Pg);(new Location$$module$js$nodes(a,133,y,"Tunnel 8 (red slimes)")).cave().from(Qg,
v).connectTo(Bd).chest(J,23,116);const Rg=(new Location$$module$js$nodes(a,134,y,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Cd),Sg=(new Location$$module$js$nodes(a,135,y,"Tunnel 10a (toward magic ring)")).cave().connect(Rg);(new Location$$module$js$nodes(a,135,y,"Tunnel 10b (past wall)")).cave().connect(Sg,v).connectTo(Lg);const Ed=(new Location$$module$js$nodes(a,136,qa,"Entrance")).fortress().from(Ad,fc,Db),Tg=(new Location$$module$js$nodes(a,137,qa,"Left branch")).fortress().connect(Ed).chest(J,
19,117),Ug=(new Location$$module$js$nodes(a,137,qa,"Left branch, past one bridge")).fortress().connect(Tg,r),Vg=(new Location$$module$js$nodes(a,137,qa,"Left branch, past two bridges")).fortress().connect(Ug,r).chest(E,29,87),Wg=(new Location$$module$js$nodes(a,137,qa,"Right branch")).fortress().connect(Ed);(new Location$$module$js$nodes(a,137,qa,"Right branch, across water")).fortress().connect(Wg,B).chest(J,20,118).chest(J,21,119).chest(Vd,28);(new Location$$module$js$nodes(a,138,qa,"Upper floor")).fortress().connect(Vg).chest(L,
27);const Fa=(new Location$$module$js$nodes(a,140,ka,"Town")).town().connect(Ng,Sc).trigger(Bb),La=(new Location$$module$js$nodes(a,142,ra,"Town")).town().connect(jb),Fd=(new Location$$module$js$nodes(a,143,F,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(a,143,F,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Fd,wa).chest(be,15);const Ob=(new Location$$module$js$nodes(a,144,ra,"Desert 1")).overworld().connect(jb),kb=(new Location$$module$js$nodes(a,
145,F,"Area 1 (from entrance)")).cave().chest(bc,26),Gd=(new Location$$module$js$nodes(a,145,F,"Area 2 (across top bridge)")).cave().connect(kb,r);(new Location$$module$js$nodes(a,145,F,"Area 3 (dead-end across top-right bridge)")).cave().connect(Gd,r);const Xg=(new Location$$module$js$nodes(a,145,F,"Area 4 (left across middle-right bridge)")).cave().connect(Gd,r),Yg=(new Location$$module$js$nodes(a,145,F,"Area 5 (bottom edge)")).cave().connect(Xg,r),Zg=(new Location$$module$js$nodes(a,145,F,"Area 6 (bottom island)")).cave().connect(Yg,
r),$g=(new Location$$module$js$nodes(a,145,F,"Area 7 (bottom inner ring)")).cave().connect(Zg,r),ah=(new Location$$module$js$nodes(a,145,F,"Area 8 (left outer ring)")).cave().connect($g,r).connect(kb,r).chest(I,27,100),bh=(new Location$$module$js$nodes(a,145,F,"Area 9 (top left inner ring)")).cave().connect(ah,r),ch=(new Location$$module$js$nodes(a,145,F,"Area 10 (top right inner ring)")).cave().connect(bh,r);(new Location$$module$js$nodes(a,145,F,"Area 11 (center)")).cave().connect(ch,r).connectTo(Fd);
(new Location$$module$js$nodes(a,145,F,"Area 12 (top center islands)")).cave().connect(kb,B).chest($d,28);const dh=(new Location$$module$js$nodes(a,146,V,"Desert Cave 1")).cave().connect(Ob,B),Ga=(new Location$$module$js$nodes(a,147,V,"Town")).town(),eh=(new Location$$module$js$nodes(a,148,V,"Outside Cave")).overworld().connect(Ga),fh=(new Location$$module$js$nodes(a,149,V,"Desert Cave 2")).cave().connect(eh);(new Location$$module$js$nodes(a,150,V,"Meadow")).overworld().connect(dh).connectTo(Ga).trigger(xe,
va);const Pb=(new Location$$module$js$nodes(a,152,V,"Desert 2")).overworld().connect(fh),gh=(new Location$$module$js$nodes(a,156,Ba,"Entrance")).fortress().connect(Pb,B),hh=(new Location$$module$js$nodes(a,156,Ba,"Azteca")).fortress().trigger(ze),ih=(new Location$$module$js$nodes(a,157,Ba,"Fork")).fortress().connect(gh),Hd=(new Location$$module$js$nodes(a,158,Ba,"Main")).fortress().connect(ih);(new Location$$module$js$nodes(a,158,Ba,"Treasure Chest (magic ring)")).fortress().connect(Hd).chest(R,27,
108);(new Location$$module$js$nodes(a,159,Ba,"Draygon")).fortress().connect(Hd).to(hh).boss($e);const jh=(new Location$$module$js$nodes(a,160,aa,"Entrance")).fortress().connect(Pb,B),kh=(new Location$$module$js$nodes(a,160,aa,"Statues")).fortress().connect(jh).boss(af),lh=(new Location$$module$js$nodes(a,161,aa,"Hall 1")).fortress().connect(kh),Qb=(new Location$$module$js$nodes(a,162,aa,"Branch")).fortress().connect(lh);(new Location$$module$js$nodes(a,163,aa,"Left Dead End")).fortress().connect(Qb).chest(J,
13,120);(new Location$$module$js$nodes(a,164,aa,"Right Dead End")).fortress().connect(Qb);const mh=(new Location$$module$js$nodes(a,165,aa,"Hall 2")).fortress().connect(Qb).chest(rb,26,109),nh=(new Location$$module$js$nodes(a,166,aa,"Draygon 2")).fortress().connect(mh).boss(bf);(new Location$$module$js$nodes(a,167,aa,"Teleporter")).fortress().from(nh).to(rd);const Id=(new Location$$module$js$nodes(a,168,bb,"Entrance")).fortress().connect(La,Db).trigger(Kc,L),oh=(new Location$$module$js$nodes(a,169,
bb,"Main")).fortress().from(Id,wa),ph=(new Location$$module$js$nodes(a,169,bb,"Boss")).fortress().connect(oh).boss(We),qh=(new Location$$module$js$nodes(a,170,bb,"Zebu")).fortress().connect(ph),lb=(new Location$$module$js$nodes(a,171,U,"Entrance")).fortress().connect(qh);(new Location$$module$js$nodes(a,171,U,"Dead End Behind Iron (fruit of power)")).fortress().connect(lb,wa).chest(I,28,98);(new Location$$module$js$nodes(a,171,U,"Dead End Loop Across Closer Bridges")).fortress().connect(lb,r).connect(lb,
r);const rh=(new Location$$module$js$nodes(a,171,U,"Across First Bridge (fruit of repun)")).fortress().connect(lb,r).chest(qb,30,102),Rb=(new Location$$module$js$nodes(a,171,U,"Across Second Bridge")).fortress().connect(rh,r);(new Location$$module$js$nodes(a,171,U,"Dead End Across Two Bridges ()")).fortress().connect(Rb,r).connect(Rb,r).chest(ua,29,93);const sh=(new Location$$module$js$nodes(a,171,U,"Across Third Bridge")).fortress().connect(Rb,r),th=(new Location$$module$js$nodes(a,171,U,"Exit Behind Iron Door")).fortress().connect(sh,
wa),uh=(new Location$$module$js$nodes(a,172,U,"Boss")).fortress().connect(th).boss(Xe),vh=(new Location$$module$js$nodes(a,172,U,"Tornel")).fortress().connect(uh),Jd=(new Location$$module$js$nodes(a,173,Aa,"Lower")).fortress().connect(vh).chest(rb,26,99).chest(R,27,111),wh=(new Location$$module$js$nodes(a,174,Aa,"Upper Loop")).fortress().connect(Jd).chest(H,22,96);(new Location$$module$js$nodes(a,174,Aa,"Upper Loop Behind Wall (magic ring)")).fortress().connect(wh,wa).chest(R,23,107);const xh=(new Location$$module$js$nodes(a,
175,Aa,"Upper Passage (toward Mado)")).fortress().connect(Jd).chest(R,27,84),Sb=(new Location$$module$js$nodes(a,176,K,"Initial Fork")).fortress(),yh=(new Location$$module$js$nodes(a,177,K,"Left Branch")).fortress().connect(Sb),Kd=(new Location$$module$js$nodes(a,178,K,"Main Area (right branch, over bridges)")).fortress().connect(Sb),zh=(new Location$$module$js$nodes(a,179,K,"U-shaped Passage (between floors)")).fortress().connect(Kd),Ah=(new Location$$module$js$nodes(a,180,K,"Main Area Lower (under bridge)")).fortress().connect(yh).connect(Kd).connect(zh),
Ld=(new Location$$module$js$nodes(a,180,K,"Behind Iron Wall")).fortress().connect(Ah,wa),Bh=(new Location$$module$js$nodes(a,181,K,"Lower")).fortress().connect(Ld).chest(J,13,121).chest(J,14,122).chest(J,15,123).chest(R,23,88).chest(M,24,110),Ch=(new Location$$module$js$nodes(a,182,K,"Boss Corridor")).fortress().connect(Bh),Dh=(new Location$$module$js$nodes(a,182,K,"Boss")).fortress().connect(Ch,Db).boss(Ze);(new Location$$module$js$nodes(a,182,K,"Behind Boss (stormBracelet)")).fortress().connect(Dh).chest(Ta,
18);const Md=(new Location$$module$js$nodes(a,183,K,"Exit Stairs")).fortress(),Eh=(new Location$$module$js$nodes(a,184,F,"Entrance Back (behind river)")).cave().connect(Md).chest(I,13,90);(new Location$$module$js$nodes(a,184,F,"Entrance Front")).cave().connect(Eh,B).connectTo(Ob).connectTo(kb);const Fh=(new Location$$module$js$nodes(a,185,Aa,"Boss")).fortress().connect(xh).boss(Ye);(new Location$$module$js$nodes(a,185,Aa,"Asina")).fortress().connect(Fh).connectTo(Sb);(new Location$$module$js$nodes(a,
186,K,"Kensu")).fortress().connect(Ld).connectTo(Md).trigger(we,wb);(new Location$$module$js$nodes(a,187,ra,"House")).house().connect(La).trigger(ye,va,wb);(new Location$$module$js$nodes(a,188,ra,"Inn")).shop().connect(La,Bb);(new Location$$module$js$nodes(a,190,ra,"Tool Shop")).shop(E,H,M,I).connect(La,Bb);(new Location$$module$js$nodes(a,191,ra,"Tavern")).shop().connect(La);(new Location$$module$js$nodes(a,192,S,"Elder House")).house().connect(la).trigger(rc);(new Location$$module$js$nodes(a,193,
S,"Rabbit Hut")).house().connect(la).trigger(xc,wc,na);(new Location$$module$js$nodes(a,194,S,"Inn")).shop().connect(la);(new Location$$module$js$nodes(a,195,S,"Tool Shop")).shop(E,H,M,I).connect(la);(new Location$$module$js$nodes(a,196,S,"Armor Shop")).shop(Wd,Ub).connect(la);(new Location$$module$js$nodes(a,197,S,"Student House")).house().connect(la).trigger(sc);(new Location$$module$js$nodes(a,198,ya,"Tavern")).house().connect(Ka);(new Location$$module$js$nodes(a,199,ya,"Pawn Shop")).shop().connect(Ka);
(new Location$$module$js$nodes(a,200,ya,"Inn")).shop().connect(Ka);(new Location$$module$js$nodes(a,201,ya,"Armor Shop")).shop(Xd,Ub,Td).connect(Ka);(new Location$$module$js$nodes(a,203,ya,"Tool Shop")).shop(E,H,M).connect(Ka);(new Location$$module$js$nodes(a,205,Ia,"Elder House")).house().from(db,na).trigger(le,yb);(new Location$$module$js$nodes(a,206,Ia,"Mother's House")).house().from(db,na).trigger(vc,na).trigger(ke,yb);(new Location$$module$js$nodes(a,207,Ia,"Tool Shop")).shop(E,H,I).from(db,
na);(new Location$$module$js$nodes(a,208,Ia,"Inn")).shop().from(db,na);(new Location$$module$js$nodes(a,209,za,"Inn")).shop().connect(cb);(new Location$$module$js$nodes(a,210,za,"Tool Shop")).shop(M,I,ua).connect(cb);(new Location$$module$js$nodes(a,211,za,"Armor Shop")).shop(Yb,Vb,Wb,ob).connect(cb);const Gh=(new Location$$module$js$nodes(a,212,za,"Queen's House")).house().from(cb,Sc).trigger(ue,va,lc);(new Location$$module$js$nodes(a,213,ab,"Nadare's")).house().connect(eb).connectTo(Of).connectTo(Pf).connectTo(Qf);
(new Location$$module$js$nodes(a,214,z,"Fisherman's House")).house().connect(pd).trigger(zb,gc,vb,Me);const Tb=(new Location$$module$js$nodes(a,215,z,"Palace Entrance")).house().connect(sa);(new Location$$module$js$nodes(a,216,z,"Fortune Teller Front")).house().connect(sa).trigger(zc,yc);(new Location$$module$js$nodes(a,216,z,"Fortune Teller Back")).house().connect(ug).connect(ud);(new Location$$module$js$nodes(a,217,z,"Pawn Shop")).shop().connect(sa);(new Location$$module$js$nodes(a,218,z,"Armor Shop")).shop(Yd,
Yb,Vb).connect(sa);(new Location$$module$js$nodes(a,220,z,"Inn")).shop().connect(sa);(new Location$$module$js$nodes(a,221,z,"Tool Shop")).shop(E,ua,pb,M).connect(sa);(new Location$$module$js$nodes(a,222,z,"Palace Left")).house().connect(Tb);(new Location$$module$js$nodes(a,223,z,"Palace Throne Room")).house().connect(Tb).to(hb,He).from(hb).trigger(yc).trigger(oe,zc,Ac);(new Location$$module$js$nodes(a,224,z,"Palace Right")).house().connect(Tb);(new Location$$module$js$nodes(a,225,z,"Asina's Room")).house().connect(vd).trigger(Dc,
Nc);(new Location$$module$js$nodes(a,226,za,"Queen Downstairs")).house().connect(Gh).chest(Ra,13);(new Location$$module$js$nodes(a,227,ia,"Elder's House")).house().connect(ib).trigger(Gc);(new Location$$module$js$nodes(a,228,ia,"Shed")).house().connect(ib).to(Fg,hc);(new Location$$module$js$nodes(a,229,ia,"Tool Shop")).shop(E,H,I,ua).connect(ib);(new Location$$module$js$nodes(a,231,ia,"Inn")).shop().connect(ib);const Hh=(new Location$$module$js$nodes(a,232,G,"Zombie Town House")).house().connect(Lb);
(new Location$$module$js$nodes(a,233,G,"Zombie Town Basement")).house().connect(Hh).trigger(qe,Wc);(new Location$$module$js$nodes(a,235,T,"Tool Shop")).shop(E,H,I,M).connect(ca);(new Location$$module$js$nodes(a,236,T,"Stom's Hut")).house().connect(ca).trigger(Hc);(new Location$$module$js$nodes(a,237,T,"Inn")).shop().connect(ca);(new Location$$module$js$nodes(a,238,T,"Armor Shop")).shop(Zd,Zb,Ud,Xb).connect(ca);(new Location$$module$js$nodes(a,239,T,"Tavern")).house().connect(ca).trigger(Ic,Hc,Wa);
(new Location$$module$js$nodes(a,240,T,"Pawn Shop")).shop().connect(ca);(new Location$$module$js$nodes(a,241,T,"Dance Hall")).house().connect(ca).trigger(Jc,Ic,Wa).trigger(te,Jc,kc);const Ih=(new Location$$module$js$nodes(a,242,ka,"Temple (pre-massacre)")).fortress().connect(Fa).from(Eb,L,ma).trigger(ve);(new Location$$module$js$nodes(a,242,ka,"Temple (post-massacre)")).fortress().from(Ih,Kc).boss(Ve);(new Location$$module$js$nodes(a,243,ka,"Training Hall")).house().connect(Fa);(new Location$$module$js$nodes(a,
244,ka,"Hospital")).house().connect(Fa);(new Location$$module$js$nodes(a,245,ka,"Armor Shop")).shop(Zb,ob,Xb).connect(Fa);(new Location$$module$js$nodes(a,246,ka,"Tool Shop")).shop(E,H,pb,R).connect(Fa);(new Location$$module$js$nodes(a,247,ka,"Inn")).shop().connect(Fa);(new Location$$module$js$nodes(a,248,V,"Inn")).shop().connect(Ga);(new Location$$module$js$nodes(a,249,V,"Tool Shop")).shop(H,M,qb,R).connect(Ga);(new Location$$module$js$nodes(a,250,V,"Elder's House")).house().connect(Ga);(new Location$$module$js$nodes(a,
251,V,"Pawn Shop")).house().connect(Ga);const Jh=[la,Ja,Yc,Ca,Fb,Da,Ib,jd,Kb,ca,jb,Nb,Ob,Id,Pb];for(const a of Jh)a.from(Eb,De);return a},shuffle$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);d.check("Ps")&&f.shuffleShops(a);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);d||(d=new FlagSet$$module$js$flagset("Sbkm Sct"));var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&
k.slots){var m=k.slotType[0];(h[m]=h[m]||[]).push(k)}k=[];m=[];var p={};for(var q of d.flags.S||[]){var t=[];for(var l of q){p[l]=!0;for(var n of h[l])t.push(n),m.push([n,k.length])}k.push(t)}for(var x of"bc")if(p[x])for(q=h[x],l=q.map((a)=>[a.item,a.itemIndex]),a.shuffle(l),n=0;n<q.length;n++)q[n].set(...l[n]);t=(a)=>g.find((b)=>b.vanillaItemName===a);h=t("Sword of Wind");x=t("Sword of Fire");q=t("Ball of Wind");l=t("Ball of Fire");n=t("Statue of Onyx");t=t("Gas Mask");p.k&&a.nextInt(2)&&(x.swap(h),
...
e,f,g)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const h=e&&e.stats;var g=b.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);const m=new Map(d.shuffle(g.map((a)=>[a,[a.item,a.itemIndex]]))),p=new Set(d.shuffle(g)),q=new Map,t={};h&&h.seeds++;f||(f=new FlagSet$$module$js$flagset("Sbkm Sct"));(f.flags.S||[]).forEach((a,b)=>{for(const c of a)t[c]=b});for(var l of p)q.set(l.item,l);let n=new Set;const x=(a,b)=>{if(null==t[a.slotType?a.slotType[0]:"c"])return a==
b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!=b.item.inventoryRow&&a.requiresUnique||"armor"==b.item.inventoryRow&&!a.isChest())return!1;if(f.check("Es")){if(0===a.slotIndex)return 4>b.item.id;if(4>b.item.id&&(n.add(b),4===n.size))return 0===a.slotIndex}return t[a.slotType?a.slotType[0]:"c"]==t[b.slotType?b.slotType[0]:"c"]};l=a.assumedFill(d,(a,b)=>x(a,q.get(b)));if(null==l){h&&h.endState.key++;return!1;throw Error("Could not fill!");}const A=new Map;for(var P=0;P<l.length;P++){var ta=l[P];if(null!=
ta){var ma=q.get(a.item(ta));ta=m.get(ma);m.delete(ma);ma=a.location(P);A.set(ma,ta);p.delete(ma)}}P=(a,b,c)=>{c=void 0===c?"":c;for(const c of p)if(x(c,a))return A.set(c,b),p.delete(c),m.delete(a),!0;h&&("traps"==c?h.endState.traps++:"chest"==c?h.endState.chest++:h.endState.misc++);return!1};for(var da of m){const [a,b]=da;if(a.isMimic()&&!P(a,b,"traps"))return!1}for(const a of m){const [b,c]=a;if(b.needsChest()&&!P(b,c,"chest"))return!1}for(const a of m){const [b,c]=a;if(!P(b,c))return!1}for(const a of A){const [b,
c]=a;b.set(...c)}const {win:Ma,path:mb}=b.traverse({wanted:g,dfs:!1});if(!Ma)return h&&h.endState.no_win++,!1;c&&b.write(c);if(!e)return!0;h&&(h.endState.success++,h.analyze(b,a,l));e.items=[];e.route=[];for(const a of mb){const [c,d]=a;e.route.push(d);g=b.nodes[c];null!=g.slotName&&(da=g.slotName,0>da.indexOf(g.orig)&&(da+=` (normally ${g.vanillaItemName})`),e.items.push({slotIndex:g.slotIndex,itemIndex:g.itemIndex,origName:g.vanillaItemName,slotName:g.slotName,itemName:g.item.name,text:`${g.item.name}: ${da}`}))}return!0});
...
110080;const a={};for(const c of this.objects){const d=c.serialize(),e=d.join(" ");e in a?c.objectDataBase=a[e]:(c.objectDataBase=b,a[e]=b,b+=d.length);c.write()}return b}writeData(){const b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){b.prg[246387]=b.prg[246392]=190;b.prg[246399]=b.prg[246404]=191;var a=new Writer$$module$js$rom(b.prg,83192,97792);const c=new Writer$$module$js$rom(b.prg,103415,113408),d=[];for(const e of b.locations)e&&(d.push(e.writeMapData(a)),d.push(e.writeNpcData(c)));
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="defrag",LABEL$$module$js$version="defrag 186b5f1",HASH$$module$js$version="186b5f10a6bd9c7f34d9e89dd762d9473ec27442",DATE$$module$js$version=new Date(1554372018E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1)})}};
