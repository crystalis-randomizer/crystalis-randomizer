...
flags:[{flag:"Ds",name:"Generate a spoiler log"},{flag:"Di",name:"Player never dies"}]}],exclusiveFlags$$module$js$flagset=(b)=>b.startsWith("S")?new RegExp(`S.*[${b.substring(1)}]`):FLAG_CONFLICTS$$module$js$flagset[b],FLAG_CONFLICTS$$module$js$flagset={Hm:/Em/,Hx:/Ex/,Em:/Hm/,Ex:/Hx/,Tw:/Gw/,Gw:/Tw/,Ft:/Gt/,Gt:/Ft/,Fc:/Gc/,Gc:/Fc/,Fp:/Gp/,Gp:/Fp/,Fr:/Gr/,Gr:/Fr/};
...
h=new TrackerNode$$module$js$nodes(a,TrackerNode$$module$js$nodes.HARD,"Hard"),k=(a)=>a.value?a:g,m=c("Leather Boots grant speed",f("Ts",!0)),n=k(c("Assume ghetto flight",f("Gf",!0))),p=k(c("Assume statue glitch",f("Gt",!0))),q=c("Allow statue glitch",f("!Ft",!0)),l=k(c("Assume teleport skip",f("Gp",!1))),r=c("Allow teleport skip",f("!Fp",!1)),G=k(c("Assume rabbit skip",f("Gr",!1))),C=k(c("Allow rabbit skip",f("!Fr",!1))),R=k(c("Assume sword charge glitch",f("Gc",!1))),va=c("Allow sword charge glitch",
f("!Fc",!1)),na=k(c("Assume wild warp",f("Gw",!1))),oa=c("Allow wild warp",f("!Tw",!1)),I=c("Sword magic optional",f("Hw",!1)),J=c("Matching sword optional",f("Hs",!1)),Wb=c("Gas mask optional",f("Hg",!1)),Rd=c("Healed dolphin optional",f("!Rd",!0)),nb=c("Free lunch",f("!Rl",!1)),Sd=c("Sword of Thunder teleports to Shyron",f("Rt",!0)),Xb=c("Barrier magic optional",f("Hb",!0)),Yb=c("Refresh magic optional",f("!Er",!0)),Td=c("Lime Tree connects to Leaf",f("Rp",!0)),Ud=c("Buffed medical herb",f("!Hm",
!0)),Y=d(0,"Sword of Wind").weight(b.check("Es")?10:5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),Z=d(1,"Sword of Fire").weight(b.check("Es")?10:5).fromPerson("Oak elder",29).dialog(29,null,3).key(),S=d(2,"Sword of Water").weight(10).chest().key(),N=d(3,"Sword of Thunder").weight(15).chest().key(),ob=d(4,"Crystalis").fixed(),Pa=d(5,"Ball of Wind").chest().key(),Ja=d(6,"Tornado Bracelet").chest().key(),Qa=d(7,"Ball of Fire").bossDrop("Insect",1).dialog(30,null,0).dialog(32,
null,0).dialog(33,null,0).dialog(34,null,0).dialog(96,30,0).dialog(29,null,2).dialog(31,null,0).npcSpawn(193).key(),Ra=d(8,"Flame Bracelet").bossDrop("Kelbesque 1",2).npcSpawn(194).key(),Sa=d(9,"Ball of Water").weight(5).direct("Rage",250679).npcSpawn(195).key(),Ta=d(10,"Blizzard Bracelet").weight(5).chest().key(),Ua=d(11,"Ball of Thunder").bossDrop("Mado 1",5).trigger(154,1).key(),Va=d(12,"Storm Bracelet").chest().key(),Zb=d(13,"Carapace Shield").armor(),Vd=d(14,"Bronze Shield").armor(),$b=d(15,
"Platinum Shield").armor(),ac=d(16,"Mirrored Shield").armor(),Wd=d(17,"Ceramic Shield").armor(),pb=d(18,"Sacred Shield").armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),bc=d(19,"Battle Shield").armor(),Xd=d(20,"Psycho Shield").armor(),Yd=d(21,"Tanned Hide").armor(),Zd=d(22,"Leather Armor").armor(),$d=d(23,"Bronze Armor").armor(),cc=d(24,"Platinmum Armor").armor(),ae=d(25,"Soldier Suit").armor(),dc=d(26,"Ceramic Suit").armor(),be=d(27,"Battle Suit").armor(),ce=d(28,"Psycho Armor").armor().bossDrop("Draygon 1",
10).npcSpawn(203).trigger(159).npcSpawn(131).key(),D=d(29,"Medical Herb").consumable(),H=d(30,"Antidote").consumable(),wa=d(31,"Lysis Plant").consumable(),qb=d(32,"Fruit of Lime").consumable(),K=d(33,"Fruit of Power").consumable(),T=d(34,"Magic Ring").consumable(),rb=d(35,"Fruit of Repun").consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),O=d(36,"Warp Boots").consumable(),ec=d(37,"Statue of Onyx").chest("Cordel grass").invisible(254882).key(),sb=d(38,"Opel Statue").consumable().bossDrop("Kelbesque 2",
6).npcSpawn(197).key(),fc=d(39,"Insect Flute").fromPerson("Oak mother",30).dialog(30,null,1).key(),tb=d(40,"Flute of Lime").fromPerson("Portoa queen",56).direct(39161).dialog(56,null,4).key(),Wa=d(41,"Gas Mask").direct("Akahana in Brynmaer",251902).npcSpawn(22,24).key(),de=d(42,"Power Ring").chest().bonus(),ee=d(43,"Warrior Ring").fromPerson("Akahana's friend",84).dialog(84,null,2).bonus(),fe=d(44,"Iron Necklace").chest().bonus(),ge=d(45,"Deo's Pendant").fromPerson("Deo",90).dialog(90,null,0).bonus(),
ub=d(46,"Rabbit Boots").bossDrop("Vampire 1",0).npcSpawn(192).key(),gc=d(47,f("Ts",!0)?"Speed Boots":"Leather Boots").chest().bonus(),hc=d(48,"Shield Ring").direct("Akahana in waterfall cave",250543).npcSpawn(22,87,2).bonus(),vb=d(49,"Alarm Flute").fromPerson("Zebu's student",20,1).key(),ic=d(50,"Windmill Key").fromPerson("Windmill guard",20).dialog(20,14,0).npcSpawn(20,14,1).key(),wb=d(51,"Key to Prison").chest().key(),jc=d(52,"Key to Styx").fromPerson("Zebu in Shyron",94,1).trigger(128,2).dialog(94,
242,0).dialog(98,242,0).key(),kc=d(53,"Fog Lamp").chest().key(),xb=d(54,"Shell Flute").fromPerson("Dolphin",99,1).npcSpawn(99).key(),lc=d(55,"Eye Glasses").fromPerson("Clark",68).dialog(68,233,1).key(),mc=d(56,"Broken Statue").bossDrop("Sabera 1",4).npcSpawn(127,101).npcSpawn(70).npcSpawn(71).npcSpawn(106).npcSpawn(132).npcSpawn(142).dialog(61).dialog(62).dialog(63).dialog(64).dialog(65).dialog(66).dialog(67).dialog(68,233).trigger(182).key(),nc=d(57,"Glowing Lamp").direct("Kensu in lighthouse",250638).npcSpawn(126,
98,1).key(),oc=d(59,"Love Pendant").chest("Underground channel").invisible(254890).key(),pc=d(60,"Kirisa Plant").chest("Kirisa meadow").invisible(254886).key(),yb=d(61,"Ivory Statue").bossDrop("Karmine",9).npcSpawn(200).key(),qc=d(62,"Bow of Moon").fromPerson("Aryllis",35).direct(251624).dialog(35,null,1).key(),rc=d(63,"Bow of Sun").chest().key(),sc=d(64,"Bow of Truth").fromPerson("Azteca",131).npcSpawn(131,156,1).dialog(131,null,0).key(),Xa=(new Magic$$module$js$nodes(a,65,"Refresh",65,null)).fromPerson("Zebu at windmill",
94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),Ya=(new Magic$$module$js$nodes(a,66,"Paralysis",66,null)).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),pa=(new Magic$$module$js$nodes(a,67,"Telepathy",67,null)).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),tc=(new Magic$$module$js$nodes(a,68,"Teleport",68,null)).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),he=(new Magic$$module$js$nodes(a,69,"Recover",69,null)).direct("Asina in Portoa",
250361),uc=(new Magic$$module$js$nodes(a,70,"Barrier",70,null)).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),xa=(new Magic$$module$js$nodes(a,71,"Change",71,null)).direct("Kensu in Swan",251614).npcSpawn(116,241,1),z=(new Magic$$module$js$nodes(a,72,"Flight",72,null)).weight(15).direct("Kensu in Draygonia Fortress",250255),ie=K.bossDrop("Vampire 2",12,97).npcSpawn(204).key(),L=d(112,"Mimic"),vc=(new Trigger$$module$js$nodes(a,"Talked to Leaf Elder")).get(Y),wc=(new Trigger$$module$js$nodes(a,
"Talked to Leaf Student")).get(vb),zb=new Trigger$$module$js$nodes(a,"Talked to Zebu in cave"),je=(new Trigger$$module$js$nodes(a,"Woke up Windmill Guard")).get(ic),Ka=new Trigger$$module$js$nodes(a,"Started Windmill"),xc=(new Trigger$$module$js$nodes(a,"Learned Refresh")).get(Xa),ke=(new Trigger$$module$js$nodes(a,"Gave Statue to Akahana")).get(Wa),le=(new Trigger$$module$js$nodes(a,"Fought Stom")).get(pa),yc=new Trigger$$module$js$nodes(a,"Visited Oak"),zc=new Trigger$$module$js$nodes(a,"Talked to Oak Mother"),
Ab=new Trigger$$module$js$nodes(a,"Rescued Oak Child"),me=(new Trigger$$module$js$nodes(a,"Talked to Oak Mother Again")).get(fc),ne=(new Trigger$$module$js$nodes(a,"Talked to Oak Elder")).get(Z),oe=(new Trigger$$module$js$nodes(a,"Talked to Tornel on Mt Sabre")).get(tc),Ac=new Trigger$$module$js$nodes(a,"Villagers Abducted"),Bc=new Trigger$$module$js$nodes(a,"Talked to Rabbit in Leaf"),pe=(new Trigger$$module$js$nodes(a,"Learned Paralysis")).get(Ya),Cc=new Trigger$$module$js$nodes(a,"Talked to Portoa Queen"),
Dc=new Trigger$$module$js$nodes(a,"Talked to Fortune Teller"),Ec=new Trigger$$module$js$nodes(a,"Visited Underground Channel"),qe=(new Trigger$$module$js$nodes(a,"Sent to Waterfall Cave")).get(tb),re=(new Trigger$$module$js$nodes(a,"Cured Akahana")).get(hc),Fc=(new Trigger$$module$js$nodes(a,"Talked to Rage")).get(Sa),Gc=new Trigger$$module$js$nodes(a,"Mesia recording played"),Hc=(new Trigger$$module$js$nodes(a,"Talked to Asina")).get(he),Ic=(new Trigger$$module$js$nodes(a,"Healed Dolphin")).get(xb),
Bb=new Trigger$$module$js$nodes(a,"Returned Fog Lamp"),Jc=new Trigger$$module$js$nodes(a,"Talked to Kensu in Cabin"),Kc=new Trigger$$module$js$nodes(a,"Talked to Joel Elder"),se=(new Trigger$$module$js$nodes(a,"Talked to Clark")).get(lc),te=(new Trigger$$module$js$nodes(a,"Talked to Kensu in Lighthouse")).get(nc),Cb=new Trigger$$module$js$nodes(a,"Calmed the Angry Sea"),ue=(new Trigger$$module$js$nodes(a,"Learned Barrier")).get(uc),Lc=new Trigger$$module$js$nodes(a,"Talked to Stom in Swan Hut"),Mc=
new Trigger$$module$js$nodes(a,"Talked to Kensu in Swan tavern"),Nc=new Trigger$$module$js$nodes(a,"Talked to Kensu at Swan dance"),ve=(new Trigger$$module$js$nodes(a,"Returned Kensu's love pendant")).get(xa),we=(new Trigger$$module$js$nodes(a,"Talked to Amazones Queen")).get(qc),Db=new Trigger$$module$js$nodes(a,"Entered Shyron"),xe=(new Trigger$$module$js$nodes(a,"Talked to Zebu in Shyron")).get(jc),Oc=new Trigger$$module$js$nodes(a,"Shyron Massacre"),ye=(new Trigger$$module$js$nodes(a,"Saved Kensu")).get(z),
ze=(new Trigger$$module$js$nodes(a,"Talked to Deo")).get(ge),Ae=(new Trigger$$module$js$nodes(a,"Talked to Akahana's Friend")).get(ee),Be=(new Trigger$$module$js$nodes(a,"Get Bow of Truth")).get(sc),Ce=(new Trigger$$module$js$nodes(a,"Forged Crystalis")).get(ob),Za=(new Condition$$module$js$nodes(a,"Sword charge glitch")).option(R,va),De=(new Condition$$module$js$nodes(a,"Rabbit skip")).option(G,C),Ee=(new Condition$$module$js$nodes(a,"Teleport skip")).option(l,r),Eb=(new Condition$$module$js$nodes(a,
"Statue glitch")).option(p,q),Fe=(new Condition$$module$js$nodes(a,"Wild warp")).option(na,oa),$a=(new Condition$$module$js$nodes(a,"Any level 2 sword")).option(Y,Pa).option(Y,Ja).option(Z,Qa).option(Z,Ra).option(S,Sa).option(S,Ta).option(N,Ua).option(N,Va),v=(new Condition$$module$js$nodes(a,"Destroy stone")).option(Y,Pa).option(Y,Ja).option(Za,Y,$a),w=(new Condition$$module$js$nodes(a,"Destroy ice")).option(Z,Qa).option(Z,Ra).option(Za,Z,$a),t=(new Condition$$module$js$nodes(a,"Cross rivers")).option(S,
Sa).option(S,Ta).option(z).option(Za,S,$a),ya=(new Condition$$module$js$nodes(a,"Destroy iron")).option(N,Ua).option(N,Va).option(Za,N,$a),aa=(new Condition$$module$js$nodes(a,"Any sword")).option(Y).option(Z).option(S).option(N),Ge=(new Condition$$module$js$nodes(a,"Match insect sword (fire/water/thunder)")).option(Z).option(S).option(N).option(Wa,J.value?J:h,Y),Pc=(new Condition$$module$js$nodes(a,"Speed boots")).option(gc,m),Qc=(new Condition$$module$js$nodes(a,"Climb slopes")).option(ub).option(z).option(Pc),
He=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (rabbit)")).option(Bc).option(De),Ie=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (Teleport)")).option(tc).option(Ee,z),Rc=(new Condition$$module$js$nodes(a,"Asina in her room")).option(Gc),Je=(new Condition$$module$js$nodes(a,"Paralysis or Asina revealed")).option(Ya).option(Rc).option(Eb),Sc=(new Condition$$module$js$nodes(a,"Ride dolphin")).option(xb,Jc),Ke=(new Condition$$module$js$nodes(a,"Ghetto flight")).option(n,Sc,ub),
ba=(new Condition$$module$js$nodes(a,"Cross sea")).option(Sc).option(z),Le=(new Condition$$module$js$nodes(a,"Cross whirlpool")).option(Cb).option(z).option(Ke),P=(new Condition$$module$js$nodes(a,"Refresh if needed")).option(Yb.value?Yb:h).option(Xa),Tc=(new Condition$$module$js$nodes(a,"Wind magic")).option(I.value?I:h,P).option(Pa,Ja,P),Uc=(new Condition$$module$js$nodes(a,"Fire magic")).option(I.value?I:h,P).option(Qa,Ra,P),Vc=(new Condition$$module$js$nodes(a,"Water magic")).option(I.value?I:
h,P).option(I,P).option(Sa,Ta,P),Me=(new Condition$$module$js$nodes(a,"Thunder magic")).option(I.value?I:h,P).option(I,P).option(Ua,P).option(Va,P),Ne=(new Condition$$module$js$nodes(a,"Flute of lime or glitch")).option(tb).option(Eb),Wc=(new Condition$$module$js$nodes(a,"Change or glitch")).option(xa).option(Eb),Fb=(new Condition$$module$js$nodes(a,"Pass shooting statues")).option(uc).option(Xb.value?Xb:h).option(Xa,hc),Oe=(new Condition$$module$js$nodes(a,"Healed dolphin if required")).option(Ic).option(Rd),
Xc=(new Condition$$module$js$nodes(a,"Match sword of wind")).option(Y).option(J.value?J:h,aa),Yc=(new Condition$$module$js$nodes(a,"Match sword of fire")).option(Z).option(J.value?J:h,aa),Zc=(new Condition$$module$js$nodes(a,"Match sword of water")).option(S).option(J.value?J:h,aa),Pe=(new Condition$$module$js$nodes(a,"Match sword of thunder")).option(N).option(J.value?J:h,aa),Qe=(new Condition$$module$js$nodes(a,"Swamp run possible")).option(aa).option(Pc).option(Ud).option(Xa),Re=(new Condition$$module$js$nodes(a,
"Insect possible to kill")).option(Wa),ab=(new Condition$$module$js$nodes(a,"Travel swamp")).option(Wa).option(Wb.value?Wb:h,Qe),Se=(new Condition$$module$js$nodes(a,"Calmed sea if required")).option(Cb).option(nb),Te=(new Condition$$module$js$nodes(a,"Started windmill if required")).option(Ka).option(nb),Ue=e(0,"Vampire 1",aa).get(ub),Ve=e(1,"Insect",fc,Ge,Re).get(Qa),We=e(2,"Kelbesque 1",Xc,Tc).get(Ra),Xe=e(12,"Vampire 2",aa).get(ie),$c=e(4,"Sabera 1",Yc,Uc).get(mc),Ye=e(5,"Mado 1",Zc,Vc).get(Ua),
Ze=e(6,"Kelbesque 2",Xc,Tc).get(sb),$e=e(7,"Sabera 2",Yc,Uc).get(rb),af=e(8,"Mado 2",Zc,Vc).get(pb),bf=e(9,"Karmine",Pe,Me).get(yb),cf=e(10,"Draygon 1",aa).get(ce),df=e(null,"Statues",rc,qc),ef=e(11,"Draygon 2",aa,sc),ff=e(13,"Dyna",ob),gf=(new Condition$$module$js$nodes(a,"Opened prison if required")).option(wb).option(nb),U=new Area$$module$js$nodes(a,"Leaf"),za=new Area$$module$js$nodes(a,"Valley of Wind"),Q=new Area$$module$js$nodes(a,"Sealed Cave"),qa=new Area$$module$js$nodes(a,"Cordel Plain"),
Aa=new Area$$module$js$nodes(a,"Brynmaer"),Ba=new Area$$module$js$nodes(a,"Amazones"),A=new Area$$module$js$nodes(a,"Mt Sabre West"),u=new Area$$module$js$nodes(a,"Mt Sabre North"),bb=new Area$$module$js$nodes(a,"Nadare's"),La=new Area$$module$js$nodes(a,"Oak"),fa=new Area$$module$js$nodes(a,"Waterfall Valley"),y=new Area$$module$js$nodes(a,"Portoa"),ha=new Area$$module$js$nodes(a,"Waterfall Cave"),B=new Area$$module$js$nodes(a,"Fog Lamp Cave"),ia=new Area$$module$js$nodes(a,"Kirisa Plant Cave"),
ra=new Area$$module$js$nodes(a,"Angry Sea"),ja=new Area$$module$js$nodes(a,"Joel"),F=new Area$$module$js$nodes(a,"Evil Spirit Island"),ka=new Area$$module$js$nodes(a,"Sabera's Castle"),V=new Area$$module$js$nodes(a,"Swan"),x=new Area$$module$js$nodes(a,"Mt Hydra"),la=new Area$$module$js$nodes(a,"Shyron"),sa=new Area$$module$js$nodes(a,"Styx"),ta=new Area$$module$js$nodes(a,"Goa"),cb=new Area$$module$js$nodes(a,"Draygonia Fortress 1"),W=new Area$$module$js$nodes(a,"Draygonia Fortress 2"),Ca=new Area$$module$js$nodes(a,
"Draygonia Fortress 3"),M=new Area$$module$js$nodes(a,"Draygonia Fortress 4"),E=new Area$$module$js$nodes(a,"Oasis Cave");new Area$$module$js$nodes(a,"Desert");const X=new Area$$module$js$nodes(a,"Sahara"),Da=new Area$$module$js$nodes(a,"Pyramid Front"),ca=new Area$$module$js$nodes(a,"Pyramid Back"),da=new Area$$module$js$nodes(a,"Tower"),Gb=(new Location$$module$js$nodes(a,0,U,"Start")).overworld().start(),hf=(new Location$$module$js$nodes(a,0,U,"Mezame Shrine")).overworld().from(Gb),jf=(new Location$$module$js$nodes(a,
1,U,"Outside Start")).overworld().connect(hf),ma=(new Location$$module$js$nodes(a,2,U,"Town")).town().connect(jf),Ma=(new Location$$module$js$nodes(a,3,za,"Main")).overworld().connect(ma).trigger(xc,Ka),ad=(new Location$$module$js$nodes(a,3,za,"Outside Windmill")).overworld(),bd=(new Location$$module$js$nodes(a,4,Q,"Tunnel 1 (entrance)")).cave().from(Ma,Ka),kf=(new Location$$module$js$nodes(a,5,Q,"Tunnel 2 (over bridge)")).cave().connect(bd),lf=(new Location$$module$js$nodes(a,6,Q,"Tunnel 6 (herb dead end)")).cave().chest(D,
15),cd=(new Location$$module$js$nodes(a,7,Q,"Tunnel 4a (ball corridor)")).cave().chest(D,20,80).chest(Pa,21);(new Location$$module$js$nodes(a,7,Q,"Tunnel 4b (antidote dead end)")).cave().connect(cd,v).chest(H,19);const mf=(new Location$$module$js$nodes(a,8,Q,"Tunnel 5 (warp boots dead end)")).cave().chest(O,14),nf=(new Location$$module$js$nodes(a,9,Q,"Tunnel 3a (branch, front)")).cave().connect(kf).connectTo(cd).connectTo(mf),of=(new Location$$module$js$nodes(a,9,Q,"Tunnel 3b (branch, back)")).cave().connect(nf,
v).connectTo(lf),pf=(new Location$$module$js$nodes(a,10,Q,"Tunnel 7 (boss)")).cave().connect(of).boss(Ue),qf=(new Location$$module$js$nodes(a,12,Q,"Tunnel 8a (exit, above wall)")).cave().connect(pf),rf=(new Location$$module$js$nodes(a,12,Q,"Tunnel 8b (exit, below wall")).cave().connect(qf,v);(new Location$$module$js$nodes(a,14,za,"Windmill Cave")).cave().connect(Ma).connectTo(ad).trigger(je,vb,zb);(new Location$$module$js$nodes(a,15,za,"Windmill")).misc().connect(ad).trigger(Ka,ic);const sf=(new Location$$module$js$nodes(a,
16,za,"Zebu's Cave Front")).cave().connect(Ma).trigger(zb,vc,wc).trigger(xc,Ka,zb),tf=(new Location$$module$js$nodes(a,16,za,"Zebu's Cave Back")).cave().trigger(Ac).connect(sf,w),uf=(new Location$$module$js$nodes(a,17,A,"Tunnel 1 (to Zebu)")).cave().connect(tf),Ea=(new Location$$module$js$nodes(a,20,qa,"West")).overworld().connect(rf,Te),vf=(new Location$$module$js$nodes(a,20,qa,"South")).overworld().connect(Ea,t),dd=(new Location$$module$js$nodes(a,21,qa,"East")).overworld().connect(Ea).chest(ec,
24),Na=(new Location$$module$js$nodes(a,24,Aa,"Town")).town().connect(Ea).trigger(ke,ec),wf=(new Location$$module$js$nodes(a,25,qa,"Outside Stom's House")).town().connect(Ea),Hb=(new Location$$module$js$nodes(a,26,qa,"Swamp")).overworld().connect(dd,ab).trigger(Ab,zc,ab);(new Location$$module$js$nodes(a,26,qa,"Swamp Insect Area")).overworld().connect(Hb,ab).boss(Ve);const db=(new Location$$module$js$nodes(a,27,Ba,"Town")).town().connect(vf),eb=(new Location$$module$js$nodes(a,28,La,"Town")).town().connect(Hb,
ab).trigger(yc);(new Location$$module$js$nodes(a,30,qa,"Stom's House")).house().connect(wf).trigger(le,yc);const Fa=(new Location$$module$js$nodes(a,32,A,"Entrance")).overworld().connect(Ea).connect(uf),xf=(new Location$$module$js$nodes(a,32,A,"Up Slope")).overworld().from(Fa,Qc).to(Fa),yf=(new Location$$module$js$nodes(a,32,A,"Dead End (warp boots)")).overworld().chest(O,24,106),ed=(new Location$$module$js$nodes(a,33,A,"Upper")).overworld().from(Fa,z).to(Fa),zf=(new Location$$module$js$nodes(a,33,
A,"Tornel Dead End")).overworld().trigger(oe,Ja).chest(T,23,105),fd=(new Location$$module$js$nodes(a,34,A,"Tunnel 2a (fork at start)")).cave().connect(Fa);(new Location$$module$js$nodes(a,34,A,"Tunnel 2b (left branch to dead end)")).cave().connect(fd,w).connectTo(yf);const Af=(new Location$$module$js$nodes(a,34,A,"Tunnel 2c (right branch to upper)")).cave().connect(fd,w),Bf=(new Location$$module$js$nodes(a,35,A,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Af).chest(D,23,82),Cf=
(new Location$$module$js$nodes(a,35,A,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Bf,w).connectTo(ed),gd=(new Location$$module$js$nodes(a,36,A,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(Cf);(new Location$$module$js$nodes(a,36,A,"Tunnel 4b (out to upper)")).cave().connect(gd,w).connectTo(ed);const Df=(new Location$$module$js$nodes(a,37,A,"Tunnel 5 (tiny connector)")).cave().connect(gd),Ef=(new Location$$module$js$nodes(a,38,A,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Df);
(new Location$$module$js$nodes(a,38,A,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Ef,w).connectTo(zf);const Ff=(new Location$$module$js$nodes(a,39,A,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(xf),Gf=(new Location$$module$js$nodes(a,39,A,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Ff,w);(new Location$$module$js$nodes(a,39,A,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Gf,w).chest(Ja,25);const fb=(new Location$$module$js$nodes(a,40,u,"Entrance")).overworld().connect(dd,
Ie,He),gb=(new Location$$module$js$nodes(a,40,u,"Upper")).overworld().from(fb,z).to(fb),Ib=(new Location$$module$js$nodes(a,40,u,"Summit (boss)")).overworld().from(gb,z).to(gb).boss(We),hd=(new Location$$module$js$nodes(a,41,u,"Connector")).overworld(),Jb=(new Location$$module$js$nodes(a,41,u,"Middle Left")).overworld(),Hf=(new Location$$module$js$nodes(a,41,u,"Middle Right")).overworld().from(Jb,Qc).to(Jb),id=(new Location$$module$js$nodes(a,42,u,"Tunnel 2a (from entrance to connector)")).cave().connectTo(hd);
(new Location$$module$js$nodes(a,42,u,"Tunnel 2b (under bridge, to antidote)")).cave().connect(id,w).chest(H,23,94);const jd=(new Location$$module$js$nodes(a,43,u,"Tunnel 3a (branch after connector)")).cave().connect(hd),If=(new Location$$module$js$nodes(a,43,u,"Tunnel 3b (right branch)")).cave().connect(jd,w),Jf=(new Location$$module$js$nodes(a,43,u,"Tunnel 3c (upper branch)")).cave().connect(jd,w);(new Location$$module$js$nodes(a,44,u,"Tunnel 4 (over bridge, to middle)")).cave().connect(Jf).connectTo(Jb);
const kd=(new Location$$module$js$nodes(a,45,u,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(If).connectTo(Hf);(new Location$$module$js$nodes(a,45,u,"Tunnel 5b (dead-end with herb)")).cave().connect(kd,w).chest(D,22,83);const Kf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6a (S-shaped hall, right)")).cave().connect(kd),Lf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Kf,w),Mf=(new Location$$module$js$nodes(a,46,u,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Lf,
w),ld=(new Location$$module$js$nodes(a,47,u,"Prison (hallway)")).cave().connect(gb),Nf=(new Location$$module$js$nodes(a,48,u,"Left Cell (shopkeepers)")).cave().from(ld,w);(new Location$$module$js$nodes(a,49,u,"Left Cell 2 (back, with prison key)")).cave().from(Nf,w).chest(wb,13);const Of=(new Location$$module$js$nodes(a,50,u,"Right Cell (villagers)")).cave().from(ld,w),Pf=(new Location$$module$js$nodes(a,51,u,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Of,w);(new Location$$module$js$nodes(a,
52,u,"Tunnel 9 (connector to summit)")).cave().connect(Pf).connectTo(Ib);const Qf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10a (summit cave, front)")).cave().from(Ib,wb).to(Ib),Rf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10b (summit cave, behind ice)")).cave().connect(Qf,w).trigger(pe);(new Location$$module$js$nodes(a,56,u,"Tunnel 1 (leads from main entrance)")).cave().connect(fb).connectTo(id);(new Location$$module$js$nodes(a,57,u,"Tunnel 7 (to upper)")).cave().connect(Mf).connectTo(gb);
const Sf=(new Location$$module$js$nodes(a,60,bb,"Inn")).shop(),Tf=(new Location$$module$js$nodes(a,61,bb,"Tool Shop")).shop(D,H,K,O),Uf=(new Location$$module$js$nodes(a,62,bb,"Back Room")).house(),Kb=(new Location$$module$js$nodes(a,64,fa,"Summit")).overworld().connect(Rf,gf),hb=(new Location$$module$js$nodes(a,64,fa,"Northwest")).overworld().from(Kb).to(Kb,z),Vf=(new Location$$module$js$nodes(a,64,fa,"Northeast")).overworld().connect(hb,t),md=(new Location$$module$js$nodes(a,65,fa,"Southwest")).overworld().connect(hb),
Wf=(new Location$$module$js$nodes(a,65,fa,"Southeast")).overworld().connect(md,t),nd=(new Location$$module$js$nodes(a,66,fa,"Lime Tree Valley")).overworld().connect(md).connect(Ma,Td),Xf=(new Location$$module$js$nodes(a,67,fa,"Lime Tree Lake (Rage)")).cave().connect(nd).trigger(Fc,S),Yf=(new Location$$module$js$nodes(a,68,ia,"Tunnel 1a (entrance)")).cave().connect(Wf),Zf=(new Location$$module$js$nodes(a,68,ia,"Tunnel 1b (behind wall)")).cave().connect(Yf,v),od=(new Location$$module$js$nodes(a,69,
ia,"Tunnel 2a (main path, before wall)")).cave().connect(Zf);(new Location$$module$js$nodes(a,69,ia,"Tunnel 2b (dead end, antidote)")).cave().connect(od,v).chest(H,25,95);const $f=(new Location$$module$js$nodes(a,69,ia,"Tunnel 2c (main path, after wall)")).cave().connect(od,v),ag=(new Location$$module$js$nodes(a,70,ia,"Tunnel 3a (last room, before wall)")).cave().connect($f),bg=(new Location$$module$js$nodes(a,70,ia,"Tunnel 3b (last room, after wall)")).cave().connect(ag,v);(new Location$$module$js$nodes(a,
71,ia,"Meadow")).overworld().connect(bg).chest(pc,14);const cg=(new Location$$module$js$nodes(a,72,B,"Tunnel 1a (entrance)")).cave().connect(Vf),pd=(new Location$$module$js$nodes(a,72,B,"Tunnel 1b (past wall)")).cave().connect(cg,v);(new Location$$module$js$nodes(a,72,B,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(pd,v).chest(wa,24);const dg=(new Location$$module$js$nodes(a,73,B,"Tunnel 2 (tiny connector)")).cave().connect(pd),qd=(new Location$$module$js$nodes(a,74,B,"Tunnel 3a (upper branch)")).cave().connect(dg);
(new Location$$module$js$nodes(a,74,B,"Tunnel 3b (dead end, mimic)")).cave().connect(qd,v).chest(L,21,112);const rd=(new Location$$module$js$nodes(a,74,B,"Tunnel 3c (short passage with mimic)")).cave().connect(qd,v).chest(L,22,113),eg=(new Location$$module$js$nodes(a,74,B,"Tunnel 3d (lower branch)")).cave().connect(rd,v);(new Location$$module$js$nodes(a,75,B,"Tunnel 4 (dead end loop)")).cave().connect(eg);const sd=(new Location$$module$js$nodes(a,76,B,"Tunnel 5a (right branch over bridge)")).cave().connect(rd),
fg=(new Location$$module$js$nodes(a,76,B,"Tunnel 5b (past wall over bridge)")).cave().connect(sd,v),gg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6a (from left branch)")).cave().connect(sd),hg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6b (reconvergence)")).cave().connect(gg,v).connect(fg),ig=(new Location$$module$js$nodes(a,77,B,"Tunnel 6c (between walls)")).cave().connect(hg,v),jg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6d (under bridge)")).cave().connect(ig,v),kg=(new Location$$module$js$nodes(a,
78,B,"Tunnel 7a (over second bridge)")).cave().connect(jg),lg=(new Location$$module$js$nodes(a,78,B,"Tunnel 7b (past wall)")).cave().connect(kg,v),mg=(new Location$$module$js$nodes(a,79,B,"Tunnel 8a (under second bridge)")).cave().connect(lg);(new Location$$module$js$nodes(a,79,B,"Tunnel 8b (fog lamp)")).cave().connect(mg,v).chest(kc,19);const ua=(new Location$$module$js$nodes(a,80,y,"Town")).town().connect(hb),td=(new Location$$module$js$nodes(a,81,y,"Fishherman Island")).town().connect(ua);(new Location$$module$js$nodes(a,
82,fa,"Mesia Shrine")).cave().trigger(Gc).connect(Xf,t,Fc);const ud=(new Location$$module$js$nodes(a,84,ha,"Tunnel 1a (entrance)")).cave().connect(hb);(new Location$$module$js$nodes(a,84,ha,"Tunnel 1b (dead end, mimic)")).cave().connect(ud,w).chest(L,19,114);const ng=(new Location$$module$js$nodes(a,84,ha,"Tunnel 1c (past ice)")).cave().connect(ud,w),og=(new Location$$module$js$nodes(a,85,ha,"Tunnel 2 (stoned pair)")).cave().connect(ng),Lb=(new Location$$module$js$nodes(a,86,ha,"Tunnel 3 (wide medusa hallways)")).cave().connect(og,
Ne),pg=(new Location$$module$js$nodes(a,87,ha,"Tunnel 4a (left entrance)")).cave().from(Lb,w).chest(ac.chest().bonus(),25).trigger(re,tb);(new Location$$module$js$nodes(a,87,ha,"Tunnel 4b (right entrance)")).cave().from(Lb,w).connect(pg,z);(new Location$$module$js$nodes(a,87,ha,"Tunnel 4c (sword of water)")).cave().connect(Lb,w).chest(S,24);const vd=(new Location$$module$js$nodes(a,88,da,"Entrance")).misc(),qg=(new Location$$module$js$nodes(a,89,da,"Level 1")).misc().from(vd),rg=(new Location$$module$js$nodes(a,
90,da,"Level 2")).misc().from(qg),sg=(new Location$$module$js$nodes(a,91,da,"Level 3")).misc().from(rg),wd=(new Location$$module$js$nodes(a,92,da,"Outside Mesia Room")).misc().from(sg),tg=(new Location$$module$js$nodes(a,93,da,"Outside Dyna Room")).misc().from(wd,ob);(new Location$$module$js$nodes(a,94,da,"Mesia")).misc().connect(wd).trigger(Ce);const ug=(new Location$$module$js$nodes(a,95,da,"Dyna")).misc().from(tg).boss(ff);(new Location$$module$js$nodes(a,95,da,"Win")).misc().from(ug).end();const Mb=
(new Location$$module$js$nodes(a,96,ra,"Cabin Beach")).sea().from(td,Bb),Ga=(new Location$$module$js$nodes(a,96,ra,"South")).sea().connect(Mb,ba),vg=(new Location$$module$js$nodes(a,96,ra,"Joel Beach")).sea().connect(Ga,ba),xd=(new Location$$module$js$nodes(a,96,ja,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(a,96,ra,"Altar")).sea().connect(Ga,ba).trigger(Cb,nc,mc);const wg=(new Location$$module$js$nodes(a,96,ra,"North")).sea().to(Ga,ba).from(Ga,ba,Le).trigger(ue,Se),xg=(new Location$$module$js$nodes(a,
96,ra,"Swan Beach")).sea().connect(wg,ba);(new Location$$module$js$nodes(a,97,ra,"Cabin")).misc().connect(Mb).trigger(Jc,Bb);(new Location$$module$js$nodes(a,98,ja,"Lighthouse")).misc().connect(xd).trigger(te,vb);const ib=(new Location$$module$js$nodes(a,100,y,"Underground Channel 1 (from throne room)")).sea().trigger(Ec),yg=(new Location$$module$js$nodes(a,100,y,"Underground Channel 2 (to fortune teller)")).sea().connect(ib,t),yd=(new Location$$module$js$nodes(a,100,y,"Underground Channel 3 (from fortune teller)")).sea().connect(ib,
z),zd=(new Location$$module$js$nodes(a,100,y,"Underground Channel 4 (asina)")).sea().connect(yd,t),zg=(new Location$$module$js$nodes(a,100,y,"Underground Channel 5 (dolphin)")).sea().connect(zd,t).trigger(Ic,D,Hc);(new Location$$module$js$nodes(a,100,y,"Underground Channel 6 (water)")).sea().connect(zg,ba).connectTo(Ga,ba).chest(oc,17);const Nb=(new Location$$module$js$nodes(a,101,F,"Zombie Town")).town(),Ag=(new Location$$module$js$nodes(a,104,F,"Tunnel 1 (entrance)")).sea().connect(Ga,Kc,ba),Ad=
(new Location$$module$js$nodes(a,105,F,"Tunnel 2a (start)")).cave().connect(Ag);(new Location$$module$js$nodes(a,105,F,"Tunnel 2b (dead end to left)")).cave().connect(Ad,t);const Bg=(new Location$$module$js$nodes(a,105,F,"Tunnel 2c (across first river)")).cave().connect(Ad,t),Bd=(new Location$$module$js$nodes(a,105,F,"Tunnel 2d (across second river)")).cave().connect(Bg,t);(new Location$$module$js$nodes(a,105,F,"Tunnel 2e (dead end, magic ring)")).cave().connect(Bd,v).chest(T,29);const Cg=(new Location$$module$js$nodes(a,
105,F,"Tunnel 2f (stair down)")).cave().connect(Bd,v),Dg=(new Location$$module$js$nodes(a,106,F,"Tunnel 3a (main area)")).cave().connect(Cg).connectTo(Nb).chest(wa,25,92),Eg=(new Location$$module$js$nodes(a,106,F,"Tunnel 3b (left area toward items)")).cave().connect(Dg,v),Fg=(new Location$$module$js$nodes(a,107,F,"Tunnel 4a (right side, mimic)")).cave().connect(Eg).chest(L,14,115);(new Location$$module$js$nodes(a,107,F,"Tunnel 4b (left side, iron necklace)")).cave().connect(Fg,t).chest(fe,15);const Ob=
(new Location$$module$js$nodes(a,108,ka,"Floor 1")).fortress().connect(Nb),Gg=(new Location$$module$js$nodes(a,108,ka,"Miniboss")).fortress().boss(Xe).connect(Ob);(new Location$$module$js$nodes(a,109,ka,"Floor 2a (left stair)")).fortress().connect(Ob).chest(K,19);const Hg=(new Location$$module$js$nodes(a,109,ka,"Floor 2b (right stair)")).fortress().connect(Gg).chest(D,30,85),Ig=(new Location$$module$js$nodes(a,110,ka,"Floor 3a (toward boss)")).fortress().connect(Hg),Cd=(new Location$$module$js$nodes(a,
110,ka,"Floor 3b (boss room)")).fortress().connect(Ig);(new Location$$module$js$nodes(a,110,ka,"Boss")).fortress().boss($c).connect(Cd);(new Location$$module$js$nodes(a,110,ka,"Floor 3c (back room trap)")).fortress().from(Cd).to(Ob);const Jg=(new Location$$module$js$nodes(a,112,ja,"Secret Passage")).cave().connectTo(xd),jb=(new Location$$module$js$nodes(a,113,ja,"Town")).town().connect(vg),ea=(new Location$$module$js$nodes(a,114,V,"Town")).town().connect(xg),Kg=(new Location$$module$js$nodes(a,115,
V,"Inside Gate")).overworld().connect(ea),Lg=(new Location$$module$js$nodes(a,115,V,"Outside Gate")).overworld().from(Kg,xa),kb=(new Location$$module$js$nodes(a,120,ta,"Valley")).overworld().connect(Lg),Pb=(new Location$$module$js$nodes(a,124,x,"Entrance")).overworld().connect(kb),Mg=(new Location$$module$js$nodes(a,124,x,"Over first river toward Shyron")).overworld().connect(Pb,t),Dd=(new Location$$module$js$nodes(a,124,x,"After first tunnel")).overworld(),Ed=(new Location$$module$js$nodes(a,124,
x,"Door to Styx")).overworld().connect(Dd,t),Ng=(new Location$$module$js$nodes(a,124,x,"Dead end (no item)")).overworld(),Og=(new Location$$module$js$nodes(a,124,x,"Dead end (fruit of lime)")).overworld().chest(qb,26),Pg=(new Location$$module$js$nodes(a,124,x,"Dead end (magic ring)")).overworld().chest(T,25,101),Fd=(new Location$$module$js$nodes(a,124,x,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(a,124,x,"Floating island (bow of sun)")).overworld().connect(Fd,z).chest(rc,
24);const Qg=(new Location$$module$js$nodes(a,125,x,"Tunnel 1 (to Shyron)")).cave().connect(Mg),Rg=(new Location$$module$js$nodes(a,126,x,"Outside Shyron")).overworld().connect(Qg);(new Location$$module$js$nodes(a,127,x,"Tunnel 2 (fork)")).cave().connect(Pb).connectTo(Og).connectTo(Dd);const Gd=(new Location$$module$js$nodes(a,128,x,"Tunnel 3 (caves)")).cave().connect(Ed).connect(Ng),Hd=(new Location$$module$js$nodes(a,129,x,"Tunnel 4 (left branch of cave)")).cave().connect(Gd);(new Location$$module$js$nodes(a,
130,x,"Tunnel 5 (dead end, medical herb)")).cave().connect(Hd).chest(D,15,86);const Sg=(new Location$$module$js$nodes(a,131,x,"Tunnel 6a (left-then-right)")).cave().connect(Hd),Tg=(new Location$$module$js$nodes(a,131,x,"Tunnel 6b (past wall)")).cave().connect(Sg,v),Ug=(new Location$$module$js$nodes(a,132,x,"Tunnel 7 (wide hall)")).cave().connect(Tg);(new Location$$module$js$nodes(a,133,x,"Tunnel 8 (red slimes)")).cave().from(Ug,v).connectTo(Fd).chest(L,23,116);const Vg=(new Location$$module$js$nodes(a,
134,x,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Gd),Wg=(new Location$$module$js$nodes(a,135,x,"Tunnel 10a (toward magic ring)")).cave().connect(Vg);(new Location$$module$js$nodes(a,135,x,"Tunnel 10b (past wall)")).cave().connect(Wg,v).connectTo(Pg);const Id=(new Location$$module$js$nodes(a,136,sa,"Entrance")).fortress().from(Ed,jc,Fb),Xg=(new Location$$module$js$nodes(a,137,sa,"Left branch")).fortress().connect(Id).chest(L,19,117),Yg=(new Location$$module$js$nodes(a,137,sa,"Left branch, past one bridge")).fortress().connect(Xg,
t),Zg=(new Location$$module$js$nodes(a,137,sa,"Left branch, past two bridges")).fortress().connect(Yg,t).chest(D,29,87),$g=(new Location$$module$js$nodes(a,137,sa,"Right branch")).fortress().connect(Id);(new Location$$module$js$nodes(a,137,sa,"Right branch, across water")).fortress().connect($g,z).chest(L,20,118).chest(L,21,119).chest(Xd,28);(new Location$$module$js$nodes(a,138,sa,"Upper floor")).fortress().connect(Zg).chest(N,27);const Ha=(new Location$$module$js$nodes(a,140,la,"Town")).town().connect(Rg,
Wc).trigger(Db),Oa=(new Location$$module$js$nodes(a,142,ta,"Town")).town().connect(kb),Jd=(new Location$$module$js$nodes(a,143,E,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(a,143,E,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Jd,ya).chest(de,15);const Qb=(new Location$$module$js$nodes(a,144,ta,"Desert 1")).overworld().connect(kb),lb=(new Location$$module$js$nodes(a,145,E,"Area 1 (from entrance)")).cave().chest(gc,26),Kd=(new Location$$module$js$nodes(a,
145,E,"Area 2 (across top bridge)")).cave().connect(lb,t);(new Location$$module$js$nodes(a,145,E,"Area 3 (dead-end across top-right bridge)")).cave().connect(Kd,t);const ah=(new Location$$module$js$nodes(a,145,E,"Area 4 (left across middle-right bridge)")).cave().connect(Kd,t),bh=(new Location$$module$js$nodes(a,145,E,"Area 5 (bottom edge)")).cave().connect(ah,t),ch=(new Location$$module$js$nodes(a,145,E,"Area 6 (bottom island)")).cave().connect(bh,t),dh=(new Location$$module$js$nodes(a,145,E,"Area 7 (bottom inner ring)")).cave().connect(ch,
t),eh=(new Location$$module$js$nodes(a,145,E,"Area 8 (left outer ring)")).cave().connect(dh,t).connect(lb,t).chest(K,27,100),fh=(new Location$$module$js$nodes(a,145,E,"Area 9 (top left inner ring)")).cave().connect(eh,t),gh=(new Location$$module$js$nodes(a,145,E,"Area 10 (top right inner ring)")).cave().connect(fh,t);(new Location$$module$js$nodes(a,145,E,"Area 11 (center)")).cave().connect(gh,t).connectTo(Jd);(new Location$$module$js$nodes(a,145,E,"Area 12 (top center islands)")).cave().connect(lb,
z).chest(be,28);const hh=(new Location$$module$js$nodes(a,146,X,"Desert Cave 1")).cave().connect(Qb,z),Ia=(new Location$$module$js$nodes(a,147,X,"Town")).town(),ih=(new Location$$module$js$nodes(a,148,X,"Outside Cave")).overworld().connect(Ia),jh=(new Location$$module$js$nodes(a,149,X,"Desert Cave 2")).cave().connect(ih);(new Location$$module$js$nodes(a,150,X,"Meadow")).overworld().connect(hh).connectTo(Ia).trigger(ze,xa);const Rb=(new Location$$module$js$nodes(a,152,X,"Desert 2")).overworld().connect(jh),
kh=(new Location$$module$js$nodes(a,156,Da,"Entrance")).fortress().connect(Rb,z),lh=(new Location$$module$js$nodes(a,156,Da,"Azteca")).fortress().trigger(Be),mh=(new Location$$module$js$nodes(a,157,Da,"Fork")).fortress().connect(kh),Ld=(new Location$$module$js$nodes(a,158,Da,"Main")).fortress().connect(mh);(new Location$$module$js$nodes(a,158,Da,"Treasure Chest (magic ring)")).fortress().connect(Ld).chest(T,27,108);(new Location$$module$js$nodes(a,159,Da,"Draygon")).fortress().connect(Ld).to(lh).boss(cf);
const nh=(new Location$$module$js$nodes(a,160,ca,"Entrance")).fortress().connect(Rb,z),oh=(new Location$$module$js$nodes(a,160,ca,"Statues")).fortress().connect(nh).boss(df),ph=(new Location$$module$js$nodes(a,161,ca,"Hall 1")).fortress().connect(oh),Sb=(new Location$$module$js$nodes(a,162,ca,"Branch")).fortress().connect(ph);(new Location$$module$js$nodes(a,163,ca,"Left Dead End")).fortress().connect(Sb).chest(L,13,120);(new Location$$module$js$nodes(a,164,ca,"Right Dead End")).fortress().connect(Sb);
const qh=(new Location$$module$js$nodes(a,165,ca,"Hall 2")).fortress().connect(Sb).chest(sb,26,109),rh=(new Location$$module$js$nodes(a,166,ca,"Draygon 2")).fortress().connect(qh).boss(ef);(new Location$$module$js$nodes(a,167,ca,"Teleporter")).fortress().from(rh).to(vd);const Md=(new Location$$module$js$nodes(a,168,cb,"Entrance")).fortress().connect(Oa,Fb).trigger(Oc,N),sh=(new Location$$module$js$nodes(a,169,cb,"Main")).fortress().from(Md,ya),th=(new Location$$module$js$nodes(a,169,cb,"Boss")).fortress().connect(sh).boss(Ze),
uh=(new Location$$module$js$nodes(a,170,cb,"Zebu")).fortress().connect(th),mb=(new Location$$module$js$nodes(a,171,W,"Entrance")).fortress().connect(uh);(new Location$$module$js$nodes(a,171,W,"Dead End Behind Iron (fruit of power)")).fortress().connect(mb,ya).chest(K,28,98);(new Location$$module$js$nodes(a,171,W,"Dead End Loop Across Closer Bridges")).fortress().connect(mb,t).connect(mb,t);const vh=(new Location$$module$js$nodes(a,171,W,"Across First Bridge (fruit of repun)")).fortress().connect(mb,
t).chest(rb,30,102),Tb=(new Location$$module$js$nodes(a,171,W,"Across Second Bridge")).fortress().connect(vh,t);(new Location$$module$js$nodes(a,171,W,"Dead End Across Two Bridges ()")).fortress().connect(Tb,t).connect(Tb,t).chest(wa,29,93);const wh=(new Location$$module$js$nodes(a,171,W,"Across Third Bridge")).fortress().connect(Tb,t),xh=(new Location$$module$js$nodes(a,171,W,"Exit Behind Iron Door")).fortress().connect(wh,ya),yh=(new Location$$module$js$nodes(a,172,W,"Boss")).fortress().connect(xh).boss($e),
zh=(new Location$$module$js$nodes(a,172,W,"Tornel")).fortress().connect(yh),Nd=(new Location$$module$js$nodes(a,173,Ca,"Lower")).fortress().connect(zh).chest(sb,26,99).chest(T,27,111),Ah=(new Location$$module$js$nodes(a,174,Ca,"Upper Loop")).fortress().connect(Nd).chest(H,22,96);(new Location$$module$js$nodes(a,174,Ca,"Upper Loop Behind Wall (magic ring)")).fortress().connect(Ah,ya).chest(T,23,107);const Bh=(new Location$$module$js$nodes(a,175,Ca,"Upper Passage (toward Mado)")).fortress().connect(Nd).chest(T,
27,84),Ub=(new Location$$module$js$nodes(a,176,M,"Initial Fork")).fortress(),Ch=(new Location$$module$js$nodes(a,177,M,"Left Branch")).fortress().connect(Ub),Od=(new Location$$module$js$nodes(a,178,M,"Main Area (right branch, over bridges)")).fortress().connect(Ub),Dh=(new Location$$module$js$nodes(a,179,M,"U-shaped Passage (between floors)")).fortress().connect(Od),Eh=(new Location$$module$js$nodes(a,180,M,"Main Area Lower (under bridge)")).fortress().connect(Ch).connect(Od).connect(Dh),Pd=(new Location$$module$js$nodes(a,
180,M,"Behind Iron Wall")).fortress().connect(Eh,ya),Fh=(new Location$$module$js$nodes(a,181,M,"Lower")).fortress().connect(Pd).chest(L,13,121).chest(L,14,122).chest(L,15,123).chest(T,23,88).chest(O,24,110),Gh=(new Location$$module$js$nodes(a,182,M,"Boss Corridor")).fortress().connect(Fh),Hh=(new Location$$module$js$nodes(a,182,M,"Boss")).fortress().connect(Gh,Fb).boss(bf);(new Location$$module$js$nodes(a,182,M,"Behind Boss (stormBracelet)")).fortress().connect(Hh).chest(Va,18);const Qd=(new Location$$module$js$nodes(a,
183,M,"Exit Stairs")).fortress(),Ih=(new Location$$module$js$nodes(a,184,E,"Entrance Back (behind river)")).cave().connect(Qd).chest(K,13,90);(new Location$$module$js$nodes(a,184,E,"Entrance Front")).cave().connect(Ih,z).connectTo(Qb).connectTo(lb);const Jh=(new Location$$module$js$nodes(a,185,Ca,"Boss")).fortress().connect(Bh).boss(af);(new Location$$module$js$nodes(a,185,Ca,"Asina")).fortress().connect(Jh).connectTo(Ub);(new Location$$module$js$nodes(a,186,M,"Kensu")).fortress().connect(Pd).connectTo(Qd).trigger(ye,
yb);(new Location$$module$js$nodes(a,187,ta,"House")).house().connect(Oa).trigger(Ae,xa,yb);(new Location$$module$js$nodes(a,188,ta,"Inn")).shop().connect(Oa,Db);(new Location$$module$js$nodes(a,190,ta,"Tool Shop")).shop(D,H,O,K).connect(Oa,Db);(new Location$$module$js$nodes(a,191,ta,"Tavern")).shop().connect(Oa);(new Location$$module$js$nodes(a,192,U,"Elder House")).house().connect(ma).trigger(vc);(new Location$$module$js$nodes(a,193,U,"Rabbit Hut")).house().connect(ma).trigger(Bc,Ac,pa);(new Location$$module$js$nodes(a,
194,U,"Inn")).shop().connect(ma);(new Location$$module$js$nodes(a,195,U,"Tool Shop")).shop(D,H,O,K).connect(ma);(new Location$$module$js$nodes(a,196,U,"Armor Shop")).shop(Yd,Zb).connect(ma);(new Location$$module$js$nodes(a,197,U,"Student House")).house().connect(ma).trigger(wc);(new Location$$module$js$nodes(a,198,Aa,"Tavern")).house().connect(Na);(new Location$$module$js$nodes(a,199,Aa,"Pawn Shop")).shop().connect(Na);(new Location$$module$js$nodes(a,200,Aa,"Inn")).shop().connect(Na);(new Location$$module$js$nodes(a,
201,Aa,"Armor Shop")).shop(Zd,Zb,Vd).connect(Na);(new Location$$module$js$nodes(a,203,Aa,"Tool Shop")).shop(D,H,O).connect(Na);(new Location$$module$js$nodes(a,205,La,"Elder House")).house().from(eb,pa).trigger(ne,Ab);(new Location$$module$js$nodes(a,206,La,"Mother's House")).house().from(eb,pa).trigger(zc,pa).trigger(me,Ab);(new Location$$module$js$nodes(a,207,La,"Tool Shop")).shop(D,H,K).from(eb,pa);(new Location$$module$js$nodes(a,208,La,"Inn")).shop().from(eb,pa);(new Location$$module$js$nodes(a,
209,Ba,"Inn")).shop().connect(db);(new Location$$module$js$nodes(a,210,Ba,"Tool Shop")).shop(O,K,wa).connect(db);(new Location$$module$js$nodes(a,211,Ba,"Armor Shop")).shop(cc,$b,ac,pb).connect(db);const Kh=(new Location$$module$js$nodes(a,212,Ba,"Queen's House")).house().from(db,Wc).trigger(we,xa,pc);(new Location$$module$js$nodes(a,213,bb,"Nadare's")).house().connect(fb).connectTo(Sf).connectTo(Tf).connectTo(Uf);(new Location$$module$js$nodes(a,214,y,"Fisherman's House")).house().connect(td).trigger(Bb,
kc,xb,Oe);const Vb=(new Location$$module$js$nodes(a,215,y,"Palace Entrance")).house().connect(ua);(new Location$$module$js$nodes(a,216,y,"Fortune Teller Front")).house().connect(ua).trigger(Dc,Cc);(new Location$$module$js$nodes(a,216,y,"Fortune Teller Back")).house().connect(yg).connect(yd);(new Location$$module$js$nodes(a,217,y,"Pawn Shop")).shop().connect(ua);(new Location$$module$js$nodes(a,218,y,"Armor Shop")).shop($d,cc,$b).connect(ua);(new Location$$module$js$nodes(a,220,y,"Inn")).shop().connect(ua);
(new Location$$module$js$nodes(a,221,y,"Tool Shop")).shop(D,wa,qb,O).connect(ua);(new Location$$module$js$nodes(a,222,y,"Palace Left")).house().connect(Vb);(new Location$$module$js$nodes(a,223,y,"Palace Throne Room")).house().connect(Vb).to(ib,Je).from(ib).trigger(Cc).trigger(qe,Dc,Ec);(new Location$$module$js$nodes(a,224,y,"Palace Right")).house().connect(Vb);(new Location$$module$js$nodes(a,225,y,"Asina's Room")).house().connect(zd).trigger(Hc,Rc);(new Location$$module$js$nodes(a,226,Ba,"Queen Downstairs")).house().connect(Kh).chest(Ta,
13);(new Location$$module$js$nodes(a,227,ja,"Elder's House")).house().connect(jb).trigger(Kc);(new Location$$module$js$nodes(a,228,ja,"Shed")).house().connect(jb).to(Jg,lc);(new Location$$module$js$nodes(a,229,ja,"Tool Shop")).shop(D,H,K,wa).connect(jb);(new Location$$module$js$nodes(a,231,ja,"Inn")).shop().connect(jb);const Lh=(new Location$$module$js$nodes(a,232,F,"Zombie Town House")).house().connect(Nb);(new Location$$module$js$nodes(a,233,F,"Zombie Town Basement")).house().connect(Lh).trigger(se,
$c);(new Location$$module$js$nodes(a,235,V,"Tool Shop")).shop(D,H,K,O).connect(ea);(new Location$$module$js$nodes(a,236,V,"Stom's Hut")).house().connect(ea).trigger(Lc);(new Location$$module$js$nodes(a,237,V,"Inn")).shop().connect(ea);(new Location$$module$js$nodes(a,238,V,"Armor Shop")).shop(ae,dc,Wd,bc).connect(ea);(new Location$$module$js$nodes(a,239,V,"Tavern")).house().connect(ea).trigger(Mc,Lc,Ya);(new Location$$module$js$nodes(a,240,V,"Pawn Shop")).shop().connect(ea);(new Location$$module$js$nodes(a,
241,V,"Dance Hall")).house().connect(ea).trigger(Nc,Mc,Ya).trigger(ve,Nc,oc);const Mh=(new Location$$module$js$nodes(a,242,la,"Temple (pre-massacre)")).fortress().connect(Ha).from(Gb,N,Sd).trigger(xe);(new Location$$module$js$nodes(a,242,la,"Temple (post-massacre)")).fortress().from(Mh,Oc).boss(Ye);(new Location$$module$js$nodes(a,243,la,"Training Hall")).house().connect(Ha);(new Location$$module$js$nodes(a,244,la,"Hospital")).house().connect(Ha);(new Location$$module$js$nodes(a,245,la,"Armor Shop")).shop(dc,
pb,bc).connect(Ha);(new Location$$module$js$nodes(a,246,la,"Tool Shop")).shop(D,H,qb,T).connect(Ha);(new Location$$module$js$nodes(a,247,la,"Inn")).shop().connect(Ha);(new Location$$module$js$nodes(a,248,X,"Inn")).shop().connect(Ia);(new Location$$module$js$nodes(a,249,X,"Tool Shop")).shop(H,O,rb,T).connect(Ia);(new Location$$module$js$nodes(a,250,X,"Elder's House")).house().connect(Ia);(new Location$$module$js$nodes(a,251,X,"Pawn Shop")).house().connect(Ia);const Nh=[ma,Ma,bd,Ea,Hb,Fa,Kb,nd,Mb,ea,
kb,Pb,Qb,Md,Rb];for(const a of Nh)a.from(Gb,Fe);return a},shuffle$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);d.check("Ps")&&f.shuffleShops(a);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);d||(d=new FlagSet$$module$js$flagset("Sbkm Sct"));var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&k.slots){var m=k.slotType[0];(h[m]=h[m]||[]).push(k)}k=[];m=[];var n={};for(var p of d.flags.S||
[]){var q=[];for(var l of p){n[l]=!0;for(var r of h[l])q.push(r),m.push([r,k.length])}k.push(q)}for(var G of"bc")if(n[G])for(p=h[G],l=p.map((a)=>[a.item,a.itemIndex]),a.shuffle(l),r=0;r<p.length;r++)p[r].set(...l[r]);q=(a)=>g.find((b)=>b.vanillaItemName===a);h=q("Sword of Wind");G=q("Sword of Fire");p=q("Ball of Wind");l=q("Ball of Fire");r=q("Statue of Onyx");q=q("Gas Mask");n.k&&a.nextInt(2)&&(G.swap(h),l.swap(p));n.k&&!a.nextInt(3)&&r.swap(q);n=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);
for(G=0;1E3>G;G++){e&&0==G%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));a.shuffle(m);for(var C of k)a.shuffle(C);p=k.map(()=>-1);l=n[a.nextInt(n.length)];r=[];q=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<l;a++){const [b,c]=m[a],d=k[c][++p[c]];q(b,d)&&(b.swap(d),r.push([b,d]))}if(!r.length)continue;const {win:b,path:c}=f.traverse({wanted:g,dfs:!1});
if(b)h=c;else for(;r.length;){const [a,b]=r.pop();a.swap(b)}}b&&f.write(b);if(c){c.items=[];c.route=[];for(const a of h){const [b,d]=a;c.route.push(d);C=f.nodes[b];null!=C.slotName&&(k=C.slotName,0>k.indexOf(C.orig)&&(k+=` (normally ${C.vanillaItemName})`),c.items.push({slotIndex:C.slotIndex,itemIndex:C.itemIndex,origName:C.vanillaItemName,slotName:C.slotName,itemName:C.item.name,text:`${C.item.name}: ${k}`}))}}}),shuffle2$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=
generate$$module$js$depgraph(d);d.check("Ps")&&f.shuffleShops(a);const g=f.integrate();e&&e.addTasks(1E3);for(let h=0;1E3>h;h++){if(yield shuffle3$$module$js$depgraph(f,g,b,a,c,d,e)){console.log(`success after ${h} attempts`);return}e&&(e.addCompleted(1),0===h%50&&(yield new Promise(requestAnimationFrame)))}return shuffle$$module$js$depgraph(b,a,c,d,e)}),shuffle3$$module$js$depgraph=(b,a,c,d,e,f,g)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const h=e&&e.stats;var g=b.nodes.filter((a)=>
a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);const m=new Map(d.shuffle(g.map((a)=>[a,[a.item,a.itemIndex]]))),n=new Set(d.shuffle(g)),p=new Map,q={};h&&h.seeds++;f||(f=new FlagSet$$module$js$flagset("Sbkm Sct"));(f.flags.S||[]).forEach((a,b)=>{for(const c of a)q[c]=b});for(var l of n)p.set(l.item,l);let r=new Set;const G=(a,b)=>{if(null==q[a.slotType?a.slotType[0]:"c"])return a==b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!=b.item.inventoryRow&&a.requiresUnique||"armor"==b.item.inventoryRow&&
!a.isChest())return!1;if(f.check("Es")){if(0===a.slotIndex)return 4>b.item.id;if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return q[a.slotType?a.slotType[0]:"c"]==q[b.slotType?b.slotType[0]:"c"]};l=a.assumedFill(d,(a,b)=>G(a,p.get(b)));if(null==l){h&&h.endState.key++;return!1;throw Error("Could not fill!");}const C=new Map;for(var R=0;R<l.length;R++){var va=l[R];if(null!=va){var na=p.get(a.item(va));va=m.get(na);m.delete(na);na=a.location(R);C.set(na,va);n.delete(na)}}R=(a,b,c)=>{c=
void 0===c?"":c;for(const c of n)if(G(c,a))return C.set(c,b),n.delete(c),m.delete(a),!0;h&&("traps"==c?h.endState.traps++:"chest"==c?h.endState.chest++:h.endState.misc++);return!1};for(var oa of m){const [a,b]=oa;if(a.isMimic()&&!R(a,b,"traps"))return!1}for(const a of m){const [b,c]=a;if(b.needsChest()&&!R(b,c,"chest"))return!1}for(const a of m){const [b,c]=a;if(!R(b,c))return!1}for(const a of C){const [b,c]=a;b.set(...c)}const {win:I,path:J}=b.traverse({wanted:g,dfs:!1});if(!I)return h&&h.endState.no_win++,
!1;c&&b.write(c);if(!e)return!0;h&&(h.endState.success++,h.analyze(b,a,l));e.items=[];e.route=[];for(const a of J){const [c,d]=a;e.route.push(d);g=b.nodes[c];null!=g.slotName&&(oa=g.slotName,0>oa.indexOf(g.orig)&&(oa+=` (normally ${g.vanillaItemName})`),e.items.push({slotIndex:g.slotIndex,itemIndex:g.itemIndex,origName:g.vanillaItemName,slotName:g.slotName,itemName:g.item.name,text:`${g.item.name}: ${oa}`}))}return!0});var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;
...
4<=e.sells.length?g.push(d):e.sells.push(d));for(const {shops:b}of[a,c])for(const a of b)a.sells.sort((a,b)=>a.id-b.id)}integrate(b={}){const {tracker:a=!1}=b;var c=!a;const d=new SparseDependencyGraph$$module$js$graph(this.nodes.length),e=[],f=[],g=new Set,h=new Map;var k=[],m=[];const n=[];var p=[];const q=[];b=new Set;for(var l of this.nodes)if(l instanceof Location$$module$js$nodes){if(l.isStart){const [a]=d.addRoute([l.uid]);h.set(a.label,a)}e[l.uid]=[];f[l.uid]=[];for(const a of l.connections)g.has(a)||
(g.add(a),a.bidi&&g.add(a.reverse()));for(const a of l.chests)d.addRoute([a.uid,l.uid])}else if(l instanceof ItemGet$$module$js$nodes&&"Medical Herb"===l.name&&(d.addRoute([l.uid]),d.finalize(l.uid)),l instanceof Option$$module$js$nodes)k.push(l);else if(l instanceof TrackerNode$$module$js$nodes)m.push(l);else if(l instanceof Condition$$module$js$nodes)n.push(l);else if(l instanceof Trigger$$module$js$nodes)p.push(l);else if(l instanceof ItemGet$$module$js$nodes)q.push(l);else if(l instanceof Slot$$module$js$nodes)b.add(l);
else if(!(l instanceof Area$$module$js$nodes))throw Error(`Unknown node type: ${l.nodeType}`);for(const a of g)e[a.from.uid].push(a),f[a.to.uid].push(a);l=(b)=>{for(const c of b){for(const b of c.edges({tracker:a}))d.addRoute(b);d.finalize(c.uid)}};l(k);c&&l(m);l(p);for(c=h.values();!(k=c.next()).done;){k=k.value;m=k.target;for(var r of e[m]){m=[r.to.uid,...k.deps];for(p=r.deps.length-1;0<=p;p--)m.push(r.deps[p].uid);r.from.bossNode&&m.push(r.from.bossNode.uid);for(const a of d.addRoute(m))h.has(a.label)||
h.set(a.label,a)}}l(n);for(r=0;r<this.nodes.length;r++)this.nodes[r]instanceof ItemGet$$module$js$nodes||this.nodes[r]instanceof TrackerNode$$module$js$nodes||d.finalize(r);r=new LocationList$$module$js$nodes(this);for(const a of b)for(const b of d.nodes[a.uid].values())r.addRoute([a.uid,...b]);return r}}
...
0)}: ${e}`)}swapMetatiles(b,...a){var c=new Map,d=seq$$module$js$rom(256);const e=new Map,f=(a)=>Array.isArray(a)?a[0]:0>a?~a:a;for(var g of a){for(var h=0;h<g.length-1;h++)Array.isArray(g[h])&&(e.set(g[h][0],g[h][1]),g[h]=g[h][0]);for(h=0;h<g.length-1;h++){let a=g[h],b=g[h+1];0>a||0>b||(c.set(b,a),d[b]=a)}}g=new Set;c=new Set;b=new Set(b);for(var k of this.locations)if(k&&b.has(k.tileset)){c.add(k.tileEffects);for(const a of k.allScreens())g.add(a)}for(var m of g)for(var n of m.tiles)for(k=0;k<n.length;k++)n[k]=
d[n[k]];for(var p of b){b=this.tilesets[(p&127)>>>2];for(var q of a)for(d=0;d<q.length-1;d++){m=f(q[d]);n=f(q[d+1]);for(k=0;4>k;k++)b.tiles[k][m]=b.tiles[k][n];b.attrs[m]=b.attrs[n];if(32>n&&b.alternates[n]!=n){if(32<=m)throw Error(`Cannot unflag: ${p} ${m} ${n} ${b.alternates[n]}`);b.alternates[m]=b.alternates[n]}}for(var l of e){const [a,c]=l;b.alternates[a]=c}}for(const d of c){p=this.tileEffects[d-179];for(const c of a)for(q=0;q<c.length-1;q++)l=f(c[q]),b=f(c[q+1]),p.effects[l]=p.effects[b];for(const a of e.keys())p.effects[a]|=
8}}}
const TILE_EFFECTS_BY_TILESET$$module$js$rom={128:179,132:180,136:181,140:182,144:183,148:184,152:185,156:186,160:187,164:188,168:181,172:189},readString$$module$js$rom=(b,a)=>{const c=[];for(;b[a];)c.push(b[a++]);return String.fromCharCode(...c)},pickFile$$module$js$rom=()=>new Promise((b,a)=>{if("#reset"!=window.location.hash){const a=window.localStorage.getItem("rom");if(a)return b(Uint8Array.from(Array(a.length/2).fill(0).map((b,c)=>Number.parseInt(a[2*c]+a[2*c+1],16))))}const c=document.createElement("input");document.body.appendChild(c);
c.type="file";c.addEventListener("change",()=>{const a=c.files[0],e=new FileReader;e.addEventListener("loadend",()=>{const a=new Uint8Array(e.result),d=Array.from(a,(a)=>a.toString(16).padStart(2,0)).join("");window.localStorage.setItem("rom",d);c.remove();b(a)});e.readAsArrayBuffer(a)})});
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="defrag",LABEL$$module$js$version="defrag b307345",HASH$$module$js$version="b30734589461f53a901f2fed9b55acc116790919",DATE$$module$js$version=new Date(155489692E4);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);d=a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$js$patch(b,parseSeed$$module$js$patch(a.seed),d,new FetchReader$$module$js$fetchreader(c))})}};
...
m=new Assembler$$module$js$6502,n=(a)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){m.assemble(yield d.read(a),a);m.patchRom(b)}),p=Object.keys(k).filter((a)=>k[a]).map((a)=>`define ${a} 1\n`).join("");m.assemble(p,"flags.s");yield n("preshuffle.s");g=new Random$$module$js$random(g);yield shuffle2$$module$js$depgraph(b,g,e,c,f);h&&rescaleShops$$module$js$patch(b,m,c.check("Pb")?g:null);h=new Rom$$module$js$rom(b);rescaleMonsters$$module$js$patch(b,h);c.check("Mr")&&shuffleMonsters$$module$js$patch(b,
h,g);identifyKeyItemsForDifficultyBuffs$$module$js$patch(h);c.check("Em")?(b[115996]*=2,b[115962]*=3):c.check("Hm")||(b[115996]+=16,b[115962]*=2);c.check("Rp")&&connectLimeTreeToLeaf$$module$js$patch(h);addCordelWestTriggers$$module$js$patch(h,c);c.check("Fr")&&fixRabbitSkip$$module$js$patch(h);c.check("Rs")&&storyMode$$module$js$patch(h);closeCaveEntrances$$module$js$patch(h,c);misc$$module$js$patch(h,c);yield n("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(b,c,m);updateCoinDrops$$module$js$patch(b,
c);shuffleRandomNumbers$$module$js$patch(b,g);yield h.writeData();return stampVersionSeedAndHash$$module$js$patch(b,a,c)}),misc$$module$js$patch=(b,a)=>{},closeCaveEntrances$$module$js$patch=(b,a)=>{b.swapMetatiles([144],[7,[1,0],-194],[14,[2,0],-194],[32,[3,10],-216],[33,[4,10],-216]);b.swapMetatiles([148,156],[104,[1,0],-194],[131,[2,0],-194],[136,[3,10],-216],[137,[4,10],-216]);b.screens[10].tiles[3][8]=1;b.screens[10].tiles[3][9]=2;b.screens[10].tiles[4][8]=3;b.screens[10].tiles[4][9]=4;b.screens[21].tiles[7][9]=
...
c){d[0]=f;return}throw Error(`Could not find flag to replace at ${a}:${c}`);};a.check("Rl")&&(c(20,48,238),c(21,48,238),c(64,0,216),b.locations[64].objects.splice(1,0,[6,6,4,44]),b.locations[64].objects.push([7,7,2,173]))},eastCave$$module$js$patch=(b)=>{},addCordelWestTriggers$$module$js$patch=(b,a)=>{for(const c of b.locations[21].objects)2===c[2]&&(128>c[3]||a.check("Fp"))&&b.locations[20].objects.push([...c])},fixRabbitSkip$$module$js$patch=(b)=>{for(const a of b.locations[40].objects)2===a[2]&&
134===a[3]&&(116===a[1]&&a[1]++,a[0]++)},storyMode$$module$js$patch=(b)=>{const a=b.npcSpawns[203].conditions[166];a.push(~b.npcSpawns[194].conditions[40][0]);a.push(~b.npcSpawns[132].conditions[110][0]);a.push(~b.triggers[26].conditions[1]);a.push(~b.npcSpawns[197].conditions[169][0]);a.push(~b.npcSpawns[198].conditions[172][0]);a.push(~b.npcSpawns[199].conditions[185][0]);a.push(~b.npcSpawns[200].conditions[182][0]);a.push(~b.npcSpawns[203].conditions[159][0]);a.push(512);a.push(513);a.push(514);
a.push(515)},connectLimeTreeToLeaf$$module$js$patch=(b)=>{const a=b.locations[3];b=b.locations[66];a.screens[5][4]=16;b.screens[1][0]=26;b.screens[2][0]=12;const c=a.entrances.push([239,4,120,5])-1,d=b.entrances.push([16,0,192,1])-1;a.exits.push([79,86,66,d],[79,87,66,d]);b.exits.push([0,27,3,c],[0,28,3,c])},stampVersionSeedAndHash$$module$js$patch=(b,a,c)=>{const d=crc32$$module$js$crc32(b),e=d.toString(16).padStart(8,0).toUpperCase(),f="unstable"==STATUS$$module$js$version?HASH$$module$js$version.substring(0,
7).padStart(7,0).toUpperCase()+"     ":VERSION$$module$js$version.substring(0,12).padEnd(12," ");a=a.toString(16).padStart(8,0).toUpperCase();const g=(a,c)=>{for(let d=0;d<c.length;d++)b[a+16+d]=c.charCodeAt(d)},h=(a,b)=>{const c=[];for(let d=0;d<a.length||d<b.length;d++)c.push(a[d]||" "),c.push(b[d]||" ");return c.join("")};g(161743,h("  VERSION     SEED      ",`  ${f}${a}`));a=String(c);let k;if(46<a.length){if(92<a.length)throw Error("Flag string way too long!");k=a.substring(46,92).padEnd(46,
" ");a=a.substring(0,46)}a=a.padEnd(46," ");g(161791,h(a.substring(0,23),a.substring(23)));k&&g(161839,h(k.substring(0,23),k.substring(23)));g(161925,h(e.substring(0,4),e.substring(4)));g(153366,"RANDOMIZER");"unstable"==STATUS$$module$js$version&&g(153404,"BETA");return d},patchBytes$$module$js$patch=(b,a,c)=>{for(let d=0;d<c.length;d++)b[a+16+d]=c[d]},patchWords$$module$js$patch=(b,a,c)=>{for(let d=0;d<2*c.length;d+=2)b[a+16+d]=c[d>>>1]&255,b[a+17+d]=c[d>>>1]>>>8},updateCoinDrops$$module$js$patch=
(b,a)=>{a.check("Fs")?patchWords$$module$js$patch(b,216030,[0,5,10,15,25,40,65,105,170,275,445,600,700,800,900,1E3]):patchWords$$module$js$patch(b,216030,[0,1,2,4,8,16,30,50,100,200,300,400,500,600,700,800])},updateDifficultyScalingTables$$module$js$patch=(b,a,c)=>{const d=Array(48).fill(0).map((a,b)=>b);patchBytes$$module$js$patch(b,c.expand("DiffAtk"),d.map((a)=>Math.round(40+15*a/4)));patchBytes$$module$js$patch(b,c.expand("DiffDef"),d.map((a)=>4*a));patchBytes$$module$js$patch(b,c.expand("DiffHP"),
d.map((a)=>Math.min(255,48+Math.round(11*a/2))));const e=a.check("Hx")?.25:a.check("Ex")?2.5:1;patchBytes$$module$js$patch(b,c.expand("DiffExp"),d.map((a)=>{a=Math.floor(4*Math.pow(2,(16+9*a)/32)*e);return 128>a?a:Math.min(255,128+(a>>4))}));patchBytes$$module$js$patch(b,216E3,[0,2,6,10,14,18,32,24,20,0,2,6,10,14,18,16,32,20])},rescaleShops$$module$js$patch=(b,a,c)=>{const d=a.expand("BasePrices");var e=a.expand("InnPrices");const f={prices:138836,items:138792},g={prices:138704,items:138660},h=Array(48).fill(0).map((a,
b)=>b);patchBytes$$module$js$patch(b,a.expand("ToolShopScaling"),h.map((a)=>Math.round(8*Math.pow(2,a/10))));patchBytes$$module$js$patch(b,a.expand("ArmorShopScaling"),h.map((a)=>Math.round(8*Math.pow(2,(47-a)/12))));for(var k of[f,g]){const {prices:d,items:e}=k;for(a=0;44>a;a++)b[d+a+16]=BASE_PRICES$$module$js$patch[b[e+a+16]]?c?c.nextInt(32)+17:32:0}for(k=0;11>k;k++)b[e+k+16]=c?c.nextInt(40)+13:32;c=(a,c)=>{b[d+2*(a-13)+16]=c&255;b[d+2*(a-13)+17]=c>>>8};for(e=13;39>e;e++)c(e,BASE_PRICES$$module$js$patch[e]);
c(39,20)},BASE_PRICES$$module$js$patch={13:4,14:16,15:50,16:325,17:1E3,18:2E3,19:4E3,21:6,22:20,23:75,24:250,25:1E3,26:4800,29:25,30:30,31:45,32:40,33:36,34:200,35:150,36:80,38:300},rescaleMonsters$$module$js$patch=(b,a)=>{for(var c of SCALED_MONSTERS$$module$js$patch.keys())for(const b in a.objects){if(SCALED_MONSTERS$$module$js$patch.has(b))return;a.objects[c].objectDataBase==a.objects[b].objectDataBase&&(SCALED_MONSTERS$$module$js$patch[b]=SCALED_MONSTERS$$module$js$patch[c])}for(const d of SCALED_MONSTERS$$module$js$patch){const [e,
{sdef:f,swrd:g,hits:h,satk:k,dgld:m,sexp:n}]=d;b=a.objects[e].objectData;c=[87,94,104,125,136,151,155,158].includes(e)?1:0;b[2]|=128;b[6]=h;b[7]=k;b[8]=f|g<<4;b[9]=b[9]&224|c;b[16]=b[16]&15|m<<4;b[17]=n}a.objects[125].objectData[16]|=8},shuffleMonsters$$module$js$patch=(b,a,c,d)=>{b=new MonsterPool$$module$js$patch({});for(const c of a.locations)c&&b.populate(c);b.shuffle(c)},identifyKeyItemsForDifficultyBuffs$$module$js$patch=(b)=>{for(const a of b.itemGets){const c=ITEMS$$module$js$patch.get(a.item);
...
"m","Green Jelly",4,,3,16,4,36],[83,"m","Red Slime",6,,4,16,4,48],[84,"m","Rock Golem",6,,11,24,6,85],[85,"m","Blue Bat",,,,4,,32],[86,"m","Green Wyvern",4,,4,24,6,52],[87,"b","Vampire",3,,12,18,,,],[88,"m","Orc",3,,4,21,4,57],[89,"m","Red Flying Swamp Insect",3,,1,21,4,57],[90,"m","Blue Mushroom",2,,1,21,4,44],[91,"m","Swamp Tomato",3,,2,35,4,52],[92,"m","Flying Meadow Insect",3,,3,23,4,81],[93,"m","Swamp Plant",,,,,,36],[94,"b","Insect",,1,8,6,,,],[95,"m","Large Blue Slime",5,,3,20,4,52],[96,"m",
"Ice Zombie",5,,7,14,4,57],[97,"m","Green Living Rock",,,1,9,4,28],[98,"m","Green Spider",4,,4,22,4,44],[99,"m","Red/Purple Wyvern",3,,4,30,4,65],[100,"m","Draygonia Soldier",6,,11,36,4,89],[101,"m","Ice Entity",3,,2,24,4,52],[102,"m","Red Living Rock",,,1,13,4,40],[103,"m","Ice Golem",7,2,11,28,4,81],[104,"b","Kelbesque",4,6,12,29,,,],[105,"m","Giant Red Slime",7,,40,90,4,102],[106,"m","Troll",2,,3,24,4,65],[107,"m","Red Jelly",2,,2,14,4,44],[108,"m","Medusa",3,,4,36,8,77],[109,"m","Red Crab",2,
,1,21,4,44],[110,"m","Medusa Head",,,1,29,4,36],[111,"m","Evil Bird",,,2,30,6,65],[113,"m","Red/Purple Mushroom",3,,5,19,6,69],[114,"m","Violet Earth Entity",3,,3,18,6,61],[115,"m","Mimic",,,3,26,15,73],[116,"m","Red Spider",3,,4,22,6,48],[117,"m","Fishman",4,,6,19,5,61],[118,"m","Jellyfish",,,3,14,3,48],[119,"m","Kraken",5,,11,25,7,73],[120,"m","Dark Green Wyvern",4,,5,21,5,61],[121,"m","Sand Monster",5,,8,6,4,57],[123,"m","Wraith Shadow 1",,,,9,7,44],[124,"m","Killer Moth",,,2,35,,77],[125,"b",
"Sabera",3,7,13,24,,,],[128,"m","Draygonia Archer",1,,3,20,6,61],[129,"m","Evil Bomber Bird",,,1,19,4,65],[130,"m","Lavaman/blob",3,,3,24,6,85],[132,"m","Lizardman (w/ flail(",2,,3,30,6,81],[133,"m","Giant Eye",3,,5,33,4,81],[134,"m","Salamander",2,,4,29,8,77],[135,"m","Sorceror",2,,5,31,6,65],[136,"b","Mado",4,8,10,30,,,],[137,"m","Draygonia Knight",2,,3,24,4,77],[138,"m","Devil",,,1,18,4,52],[139,"b","Kelbesque 2",4,6,11,27,,,],[140,"m","Wraith Shadow 2",,,,17,4,48],[144,"b","Sabera 2",5,7,21,27,
,,],[145,"m","Tarantula",3,,3,21,6,73],[146,"m","Skeleton",,,4,30,6,69],[147,"b","Mado 2",4,8,11,25,,,],[148,"m","Purple Giant Eye",4,,10,23,6,102],[149,"m","Black Knight (w/ flail)",3,,7,26,6,89],[150,"m","Scorpion",3,,5,29,2,73],[151,"b","Karmine",4,,14,26,,,],[152,"m","Sandman/blob",3,,5,36,6,98],[153,"m","Mummy",5,,19,36,6,110],[154,"m","Tomb Guardian",7,,60,37,6,106],[155,"b","Draygon",5,6,16,41,,,],[158,"b","Draygon 2",7,6,28,40,,,],[160,"m","Ground Sentry (1)",4,,12,26,,],[161,"m","Tower Defense Mech (2)",
5,,16,36,,],[162,"m","Tower Sentinel",,,2,,,],[163,"m","Air Sentry",3,,4,26,,],[164,"b","Dyna",6,5,16,,,,],[165,"b","Vampire 2",3,,12,27,,,],[180,"b","dyna pod",15,,255,26,,,],[184,"p","dyna counter",,,,26,,,],[185,"p","dyna laser",,,,26,,,],[186,"p","dyna bubble",,,,36,,,],[188,"m","vamp2 bat",,,,16,,15],[191,"p","draygon2 fireball",,,,26,,,],[193,"m","vamp1 bat",,,,16,,15],[195,"p","giant insect spit",,,,35,,,],[196,"m","summoned insect",4,,2,42,,98],[197,"p","kelby1 rock",,,,22,,,],[198,"p","sabera1 balls",
...
this.report["$"+d.id.toString(16).padStart(2,0)]=[];const {maxFlyers:g,nonFlyers:h={},fixedSlots:k={}}=MONSTER_ADJUSTMENTS$$module$js$patch[d.id]||{};let m=k.pat0||null,n=k.pat1||null,p=k.pal2||null,q=k.pal3||null,l=g,r=!1;for(const b of d.objects||[])if(2==(b[2]&7)&&(r=!0),!(b[2]&7)){var a=b[3]+80;126==a||127==a||159==a?n=98:143==a&&(m=97)}if(21==d.id||71==d.id)r=!1;f.push(`Initial pass: ${[r,m,n,p,q].join(", ")}`);a=(a)=>{var b=FLYERS$$module$js$patch.has(a.id),c=MOTHS_AND_BATS$$module$js$patch.has(a.id);
if(b){if(!l)return!1;--l}if(null!=p&&null!=a.pal2&&p!=a.pal2||null!=q&&null!=a.pal3&&q!=a.pal3)return!1;var g=!r||TREASURE_CHEST_BANKS$$module$js$patch.has(a.pat);let k;if(d.rom.objects[a.id].child||RETAIN_SLOTS$$module$js$patch.has(a.id)){const b=(k=a.patSlot?128:0)?n:m;if(null!=b&&b!=a.pat)return!1;if(k)n=a.pat;else if(g)m=a.pat;else return!1;f.push(`  Adding ${a.id.toString(16)}: pat(${k}) <-  ${a.pat.toString(16)}`)}else if(null==m&&g||m==a.pat)m=a.pat,k=0,f.push(`  Adding ${a.id.toString(16)}: pat0 <-  ${a.pat.toString(16)}`);
