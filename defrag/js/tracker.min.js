...
f("!Fc",!1)),na=k(c("Assume wild warp",f("Gw",!1))),oa=c("Allow wild warp",f("!Tw",!1)),I=c("Sword magic optional",f("Hw",!1)),J=c("Matching sword optional",f("Hs",!1)),Wb=c("Gas mask optional",f("Hg",!1)),Sd=c("Healed dolphin optional",f("!Rd",!0)),nb=c("Free lunch",f("!Rl",!1)),Td=c("Sword of Thunder teleports to Shyron",f("Rt",!0)),Xb=c("Barrier magic optional",f("Hb",!0)),Yb=c("Refresh magic optional",f("!Er",!0)),Ud=c("Lime Tree connects to Leaf",f("Rp",!0)),Vd=c("Buffed medical herb",f("!Hm",
...
94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),Ya=(new Magic$$module$js$nodes(a,66,"Paralysis",66,null)).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),pa=(new Magic$$module$js$nodes(a,67,"Telepathy",67,null)).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),tc=(new Magic$$module$js$nodes(a,68,"Teleport",68,null)).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),ie=(new Magic$$module$js$nodes(a,69,"Recover",69,null)).direct("Asina in Portoa",
250361),uc=(new Magic$$module$js$nodes(a,70,"Barrier",70,null)).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),xa=(new Magic$$module$js$nodes(a,71,"Change",71,null)).direct("Kensu in Swan",251614).npcSpawn(116,241,1),z=(new Magic$$module$js$nodes(a,72,"Flight",72,null)).weight(15).direct("Kensu in Draygonia Fortress",250255),je=K.bossDrop("Vampire 2",12,97).npcSpawn(204).key(),L=d(112,"Mimic"),vc=(new Trigger$$module$js$nodes(a,"Talked to Leaf Elder")).get(Y),wc=(new Trigger$$module$js$nodes(a,
"Talked to Leaf Student")).get(vb),zb=new Trigger$$module$js$nodes(a,"Talked to Zebu in cave"),ke=(new Trigger$$module$js$nodes(a,"Woke up Windmill Guard")).get(ic),Ka=new Trigger$$module$js$nodes(a,"Started Windmill"),xc=(new Trigger$$module$js$nodes(a,"Learned Refresh")).get(Xa),le=(new Trigger$$module$js$nodes(a,"Gave Statue to Akahana")).get(Wa),me=(new Trigger$$module$js$nodes(a,"Fought Stom")).get(pa),yc=new Trigger$$module$js$nodes(a,"Visited Oak"),zc=new Trigger$$module$js$nodes(a,"Talked to Oak Mother"),
Ab=new Trigger$$module$js$nodes(a,"Rescued Oak Child"),ne=(new Trigger$$module$js$nodes(a,"Talked to Oak Mother Again")).get(fc),oe=(new Trigger$$module$js$nodes(a,"Talked to Oak Elder")).get(Z),pe=(new Trigger$$module$js$nodes(a,"Talked to Tornel on Mt Sabre")).get(tc),Ac=new Trigger$$module$js$nodes(a,"Villagers Abducted"),Bc=new Trigger$$module$js$nodes(a,"Talked to Rabbit in Leaf"),qe=(new Trigger$$module$js$nodes(a,"Learned Paralysis")).get(Ya),Cc=new Trigger$$module$js$nodes(a,"Talked to Portoa Queen"),
Dc=new Trigger$$module$js$nodes(a,"Talked to Fortune Teller"),Ec=new Trigger$$module$js$nodes(a,"Visited Underground Channel"),re=(new Trigger$$module$js$nodes(a,"Sent to Waterfall Cave")).get(tb),se=(new Trigger$$module$js$nodes(a,"Cured Akahana")).get(hc),Fc=(new Trigger$$module$js$nodes(a,"Talked to Rage")).get(Sa),Gc=new Trigger$$module$js$nodes(a,"Mesia recording played"),Hc=(new Trigger$$module$js$nodes(a,"Talked to Asina")).get(ie),Ic=(new Trigger$$module$js$nodes(a,"Healed Dolphin")).get(xb),
Bb=new Trigger$$module$js$nodes(a,"Returned Fog Lamp"),Jc=new Trigger$$module$js$nodes(a,"Talked to Kensu in Cabin"),Kc=new Trigger$$module$js$nodes(a,"Talked to Joel Elder"),te=(new Trigger$$module$js$nodes(a,"Talked to Clark")).get(lc),ue=(new Trigger$$module$js$nodes(a,"Talked to Kensu in Lighthouse")).get(nc),Cb=new Trigger$$module$js$nodes(a,"Calmed the Angry Sea"),ve=(new Trigger$$module$js$nodes(a,"Learned Barrier")).get(uc),Lc=new Trigger$$module$js$nodes(a,"Talked to Stom in Swan Hut"),Mc=
new Trigger$$module$js$nodes(a,"Talked to Kensu in Swan tavern"),Nc=new Trigger$$module$js$nodes(a,"Talked to Kensu at Swan dance"),we=(new Trigger$$module$js$nodes(a,"Returned Kensu's love pendant")).get(xa),xe=(new Trigger$$module$js$nodes(a,"Talked to Amazones Queen")).get(qc),Db=new Trigger$$module$js$nodes(a,"Entered Shyron"),ye=(new Trigger$$module$js$nodes(a,"Talked to Zebu in Shyron")).get(jc),Oc=new Trigger$$module$js$nodes(a,"Shyron Massacre"),ze=(new Trigger$$module$js$nodes(a,"Saved Kensu")).get(z),
Ae=(new Trigger$$module$js$nodes(a,"Talked to Deo")).get(he),Be=(new Trigger$$module$js$nodes(a,"Talked to Akahana's Friend")).get(fe),Ce=(new Trigger$$module$js$nodes(a,"Get Bow of Truth")).get(sc),De=(new Trigger$$module$js$nodes(a,"Forged Crystalis")).get(ob),Za=(new Condition$$module$js$nodes(a,"Sword charge glitch")).option(R,va),Ee=(new Condition$$module$js$nodes(a,"Rabbit skip")).option(G,C),Fe=(new Condition$$module$js$nodes(a,"Teleport skip")).option(l,r),Eb=(new Condition$$module$js$nodes(a,
"Statue glitch")).option(p,q),Ge=(new Condition$$module$js$nodes(a,"Wild warp")).option(na,oa),$a=(new Condition$$module$js$nodes(a,"Any level 2 sword")).option(Y,Pa).option(Y,Ja).option(Z,Qa).option(Z,Ra).option(S,Sa).option(S,Ta).option(N,Ua).option(N,Va),v=(new Condition$$module$js$nodes(a,"Destroy stone")).option(Y,Pa).option(Y,Ja).option(Za,Y,$a),w=(new Condition$$module$js$nodes(a,"Destroy ice")).option(Z,Qa).option(Z,Ra).option(Za,Z,$a),t=(new Condition$$module$js$nodes(a,"Cross rivers")).option(S,
Sa).option(S,Ta).option(z).option(Za,S,$a),ya=(new Condition$$module$js$nodes(a,"Destroy iron")).option(N,Ua).option(N,Va).option(Za,N,$a),aa=(new Condition$$module$js$nodes(a,"Any sword")).option(Y).option(Z).option(S).option(N),He=(new Condition$$module$js$nodes(a,"Match insect sword (fire/water/thunder)")).option(Z).option(S).option(N).option(Wa,J.value?J:h,Y),Pc=(new Condition$$module$js$nodes(a,"Speed boots")).option(gc,m),Qc=(new Condition$$module$js$nodes(a,"Climb slopes")).option(ub).option(z).option(Pc),
Ie=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (rabbit)")).option(Bc).option(Ee),Je=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (Teleport)")).option(tc).option(Fe,z),Rc=(new Condition$$module$js$nodes(a,"Asina in her room")).option(Gc),Ke=(new Condition$$module$js$nodes(a,"Paralysis or Asina revealed")).option(Ya).option(Rc).option(Eb),Sc=(new Condition$$module$js$nodes(a,"Ride dolphin")).option(xb,Jc),Le=(new Condition$$module$js$nodes(a,"Ghetto flight")).option(n,Sc,ub),
ba=(new Condition$$module$js$nodes(a,"Cross sea")).option(Sc).option(z),Me=(new Condition$$module$js$nodes(a,"Cross whirlpool")).option(Cb).option(z).option(Le),P=(new Condition$$module$js$nodes(a,"Refresh if needed")).option(Yb.value?Yb:h).option(Xa),Tc=(new Condition$$module$js$nodes(a,"Wind magic")).option(I.value?I:h,P).option(Pa,Ja,P),Uc=(new Condition$$module$js$nodes(a,"Fire magic")).option(I.value?I:h,P).option(Qa,Ra,P),Vc=(new Condition$$module$js$nodes(a,"Water magic")).option(I.value?I:
h,P).option(I,P).option(Sa,Ta,P),Ne=(new Condition$$module$js$nodes(a,"Thunder magic")).option(I.value?I:h,P).option(I,P).option(Ua,P).option(Va,P),Oe=(new Condition$$module$js$nodes(a,"Flute of lime or glitch")).option(tb).option(Eb),Wc=(new Condition$$module$js$nodes(a,"Change or glitch")).option(xa).option(Eb),Fb=(new Condition$$module$js$nodes(a,"Pass shooting statues")).option(uc).option(Xb.value?Xb:h).option(Xa,hc),Pe=(new Condition$$module$js$nodes(a,"Healed dolphin if required")).option(Ic).option(Sd),
Xc=(new Condition$$module$js$nodes(a,"Match sword of wind")).option(Y).option(J.value?J:h,aa),Yc=(new Condition$$module$js$nodes(a,"Match sword of fire")).option(Z).option(J.value?J:h,aa),Zc=(new Condition$$module$js$nodes(a,"Match sword of water")).option(S).option(J.value?J:h,aa),Qe=(new Condition$$module$js$nodes(a,"Match sword of thunder")).option(N).option(J.value?J:h,aa),Re=(new Condition$$module$js$nodes(a,"Swamp run possible")).option(aa).option(Pc).option(Vd).option(Xa),Se=(new Condition$$module$js$nodes(a,
"Insect possible to kill")).option(Wa),ab=(new Condition$$module$js$nodes(a,"Travel swamp")).option(Wa).option(Wb.value?Wb:h,Re),Te=(new Condition$$module$js$nodes(a,"Calmed sea if required")).option(Cb).option(nb),Ue=(new Condition$$module$js$nodes(a,"Started windmill if required")).option(Ka).option(nb),Ve=e(0,"Vampire 1",aa).get(ub),We=e(1,"Insect",fc,He,Se).get(Qa),$c=e(2,"Kelbesque 1",Xc,Tc).get(Ra),Xe=e(12,"Vampire 2",aa).get(je),ad=e(4,"Sabera 1",Yc,Uc).get(mc),Ye=e(5,"Mado 1",Zc,Vc).get(Ua),
Ze=e(6,"Kelbesque 2",Xc,Tc).get(sb),$e=e(7,"Sabera 2",Yc,Uc).get(rb),af=e(8,"Mado 2",Zc,Vc).get(pb),bf=e(9,"Karmine",Qe,Ne).get(yb),cf=e(10,"Draygon 1",aa).get(de),df=e(null,"Statues",rc,qc),ef=e(11,"Draygon 2",aa,sc),ff=e(13,"Dyna",ob),gf=(new Condition$$module$js$nodes(a,"Opened prison if required")).option($c,wb).option(nb),U=new Area$$module$js$nodes(a,"Leaf"),za=new Area$$module$js$nodes(a,"Valley of Wind"),Q=new Area$$module$js$nodes(a,"Sealed Cave"),qa=new Area$$module$js$nodes(a,"Cordel Plain"),
...
1,U,"Outside Start")).overworld().connect(hf),ma=(new Location$$module$js$nodes(a,2,U,"Town")).town().connect(jf),Ma=(new Location$$module$js$nodes(a,3,za,"Main")).overworld().connect(ma).trigger(xc,Ka),bd=(new Location$$module$js$nodes(a,3,za,"Outside Windmill")).overworld(),cd=(new Location$$module$js$nodes(a,4,Q,"Tunnel 1 (entrance)")).cave().from(Ma,Ka),kf=(new Location$$module$js$nodes(a,5,Q,"Tunnel 2 (over bridge)")).cave().connect(cd),lf=(new Location$$module$js$nodes(a,6,Q,"Tunnel 6 (herb dead end)")).cave().chest(D,
15),dd=(new Location$$module$js$nodes(a,7,Q,"Tunnel 4a (ball corridor)")).cave().chest(D,20,80).chest(Pa,21);(new Location$$module$js$nodes(a,7,Q,"Tunnel 4b (antidote dead end)")).cave().connect(dd,v).chest(H,19);const mf=(new Location$$module$js$nodes(a,8,Q,"Tunnel 5 (warp boots dead end)")).cave().chest(O,14),nf=(new Location$$module$js$nodes(a,9,Q,"Tunnel 3a (branch, front)")).cave().connect(kf).connectTo(dd).connectTo(mf),of=(new Location$$module$js$nodes(a,9,Q,"Tunnel 3b (branch, back)")).cave().connect(nf,
v).connectTo(lf),pf=(new Location$$module$js$nodes(a,10,Q,"Tunnel 7 (boss)")).cave().connect(of).boss(Ve),qf=(new Location$$module$js$nodes(a,12,Q,"Tunnel 8a (exit, above wall)")).cave().connect(pf),rf=(new Location$$module$js$nodes(a,12,Q,"Tunnel 8b (exit, below wall")).cave().connect(qf,v);(new Location$$module$js$nodes(a,14,za,"Windmill Cave")).cave().connect(Ma).connectTo(bd).trigger(ke,vb,zb);(new Location$$module$js$nodes(a,15,za,"Windmill")).misc().connect(bd).trigger(Ka,ic);const sf=(new Location$$module$js$nodes(a,
16,za,"Zebu's Cave Front")).cave().connect(Ma).trigger(zb,vc,wc).trigger(xc,Ka,zb),tf=(new Location$$module$js$nodes(a,16,za,"Zebu's Cave Back")).cave().trigger(Ac).connect(sf,w),uf=(new Location$$module$js$nodes(a,17,A,"Tunnel 1 (to Zebu)")).cave().connect(tf),Ea=(new Location$$module$js$nodes(a,20,qa,"West")).overworld().connect(rf,Ue),vf=(new Location$$module$js$nodes(a,20,qa,"South")).overworld().connect(Ea,t),ed=(new Location$$module$js$nodes(a,21,qa,"East")).overworld().connect(Ea).chest(ec,
24),Na=(new Location$$module$js$nodes(a,24,Aa,"Town")).town().connect(Ea).trigger(le,ec),wf=(new Location$$module$js$nodes(a,25,qa,"Outside Stom's House")).town().connect(Ea),Hb=(new Location$$module$js$nodes(a,26,qa,"Swamp")).overworld().connect(ed,ab).trigger(Ab,zc,ab);(new Location$$module$js$nodes(a,26,qa,"Swamp Insect Area")).overworld().connect(Hb,ab).boss(We);const db=(new Location$$module$js$nodes(a,27,Ba,"Town")).town().connect(vf),eb=(new Location$$module$js$nodes(a,28,La,"Town")).town().connect(Hb,
ab).trigger(yc);(new Location$$module$js$nodes(a,30,qa,"Stom's House")).house().connect(wf).trigger(me,yc);const Fa=(new Location$$module$js$nodes(a,32,A,"Entrance")).overworld().connect(Ea).connect(uf),xf=(new Location$$module$js$nodes(a,32,A,"Up Slope")).overworld().from(Fa,Qc).to(Fa),yf=(new Location$$module$js$nodes(a,32,A,"Dead End (warp boots)")).overworld().chest(O,24,106),fd=(new Location$$module$js$nodes(a,33,A,"Upper")).overworld().from(Fa,z).to(Fa),zf=(new Location$$module$js$nodes(a,33,
A,"Tornel Dead End")).overworld().trigger(pe,Ja).chest(T,23,105),gd=(new Location$$module$js$nodes(a,34,A,"Tunnel 2a (fork at start)")).cave().connect(Fa);(new Location$$module$js$nodes(a,34,A,"Tunnel 2b (left branch to dead end)")).cave().connect(gd,w).connectTo(yf);const Af=(new Location$$module$js$nodes(a,34,A,"Tunnel 2c (right branch to upper)")).cave().connect(gd,w),Bf=(new Location$$module$js$nodes(a,35,A,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Af).chest(D,23,82),Cf=
(new Location$$module$js$nodes(a,35,A,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Bf,w).connectTo(fd),hd=(new Location$$module$js$nodes(a,36,A,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(Cf);(new Location$$module$js$nodes(a,36,A,"Tunnel 4b (out to upper)")).cave().connect(hd,w).connectTo(fd);const Df=(new Location$$module$js$nodes(a,37,A,"Tunnel 5 (tiny connector)")).cave().connect(hd),Ef=(new Location$$module$js$nodes(a,38,A,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Df);
(new Location$$module$js$nodes(a,38,A,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Ef,w).connectTo(zf);const Ff=(new Location$$module$js$nodes(a,39,A,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(xf),Gf=(new Location$$module$js$nodes(a,39,A,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Ff,w);(new Location$$module$js$nodes(a,39,A,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Gf,w).chest(Ja,25);const fb=(new Location$$module$js$nodes(a,40,u,"Entrance")).overworld().connect(ed,
Je,Ie),gb=(new Location$$module$js$nodes(a,40,u,"Upper")).overworld().from(fb,z).to(fb),Ib=(new Location$$module$js$nodes(a,40,u,"Summit (boss)")).overworld().from(gb,z).to(gb).boss($c),id=(new Location$$module$js$nodes(a,41,u,"Connector")).overworld(),Jb=(new Location$$module$js$nodes(a,41,u,"Middle Left")).overworld(),Hf=(new Location$$module$js$nodes(a,41,u,"Middle Right")).overworld().from(Jb,Qc).to(Jb),jd=(new Location$$module$js$nodes(a,42,u,"Tunnel 2a (from entrance to connector)")).cave().connectTo(id);
(new Location$$module$js$nodes(a,42,u,"Tunnel 2b (under bridge, to antidote)")).cave().connect(jd,w).chest(H,23,94);const kd=(new Location$$module$js$nodes(a,43,u,"Tunnel 3a (branch after connector)")).cave().connect(id),If=(new Location$$module$js$nodes(a,43,u,"Tunnel 3b (right branch)")).cave().connect(kd,w),Jf=(new Location$$module$js$nodes(a,43,u,"Tunnel 3c (upper branch)")).cave().connect(kd,w);(new Location$$module$js$nodes(a,44,u,"Tunnel 4 (over bridge, to middle)")).cave().connect(Jf).connectTo(Jb);
const ld=(new Location$$module$js$nodes(a,45,u,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(If).connectTo(Hf);(new Location$$module$js$nodes(a,45,u,"Tunnel 5b (dead-end with herb)")).cave().connect(ld,w).chest(D,22,83);const Kf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6a (S-shaped hall, right)")).cave().connect(ld),Lf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Kf,w),Mf=(new Location$$module$js$nodes(a,46,u,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Lf,
w),md=(new Location$$module$js$nodes(a,47,u,"Prison (hallway)")).cave().connect(gb),Nf=(new Location$$module$js$nodes(a,48,u,"Left Cell (shopkeepers)")).cave().from(md,w);(new Location$$module$js$nodes(a,49,u,"Left Cell 2 (back, with prison key)")).cave().from(Nf,w).chest(wb,13);const Of=(new Location$$module$js$nodes(a,50,u,"Right Cell (villagers)")).cave().from(md,w),Pf=(new Location$$module$js$nodes(a,51,u,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Of,w);(new Location$$module$js$nodes(a,
52,u,"Tunnel 9 (connector to summit)")).cave().connect(Pf).connectTo(Ib);const Qf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10a (summit cave, front)")).cave().from(Ib,wb).to(Ib),Rf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10b (summit cave, behind ice)")).cave().connect(Qf,w).trigger(qe);(new Location$$module$js$nodes(a,56,u,"Tunnel 1 (leads from main entrance)")).cave().connect(fb).connectTo(jd);(new Location$$module$js$nodes(a,57,u,"Tunnel 7 (to upper)")).cave().connect(Mf).connectTo(gb);
const Sf=(new Location$$module$js$nodes(a,60,bb,"Inn")).shop(),Tf=(new Location$$module$js$nodes(a,61,bb,"Tool Shop")).shop(D,H,K,O),Uf=(new Location$$module$js$nodes(a,62,bb,"Back Room")).house(),Kb=(new Location$$module$js$nodes(a,64,fa,"Summit")).overworld().connect(Rf,gf),hb=(new Location$$module$js$nodes(a,64,fa,"Northwest")).overworld().from(Kb).to(Kb,z),Vf=(new Location$$module$js$nodes(a,64,fa,"Northeast")).overworld().connect(hb,t),nd=(new Location$$module$js$nodes(a,65,fa,"Southwest")).overworld().connect(hb),
Wf=(new Location$$module$js$nodes(a,65,fa,"Southeast")).overworld().connect(nd,t),od=(new Location$$module$js$nodes(a,66,fa,"Lime Tree Valley")).overworld().connect(nd).connect(Ma,Ud),Xf=(new Location$$module$js$nodes(a,67,fa,"Lime Tree Lake (Rage)")).cave().connect(od).trigger(Fc,S),Yf=(new Location$$module$js$nodes(a,68,ia,"Tunnel 1a (entrance)")).cave().connect(Wf),Zf=(new Location$$module$js$nodes(a,68,ia,"Tunnel 1b (behind wall)")).cave().connect(Yf,v),pd=(new Location$$module$js$nodes(a,69,
ia,"Tunnel 2a (main path, before wall)")).cave().connect(Zf);(new Location$$module$js$nodes(a,69,ia,"Tunnel 2b (dead end, antidote)")).cave().connect(pd,v).chest(H,25,95);const $f=(new Location$$module$js$nodes(a,69,ia,"Tunnel 2c (main path, after wall)")).cave().connect(pd,v),ag=(new Location$$module$js$nodes(a,70,ia,"Tunnel 3a (last room, before wall)")).cave().connect($f),bg=(new Location$$module$js$nodes(a,70,ia,"Tunnel 3b (last room, after wall)")).cave().connect(ag,v);(new Location$$module$js$nodes(a,
71,ia,"Meadow")).overworld().connect(bg).chest(pc,14);const cg=(new Location$$module$js$nodes(a,72,B,"Tunnel 1a (entrance)")).cave().connect(Vf),qd=(new Location$$module$js$nodes(a,72,B,"Tunnel 1b (past wall)")).cave().connect(cg,v);(new Location$$module$js$nodes(a,72,B,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(qd,v).chest(wa,24);const dg=(new Location$$module$js$nodes(a,73,B,"Tunnel 2 (tiny connector)")).cave().connect(qd),rd=(new Location$$module$js$nodes(a,74,B,"Tunnel 3a (upper branch)")).cave().connect(dg);
(new Location$$module$js$nodes(a,74,B,"Tunnel 3b (dead end, mimic)")).cave().connect(rd,v).chest(L,21,112);const sd=(new Location$$module$js$nodes(a,74,B,"Tunnel 3c (short passage with mimic)")).cave().connect(rd,v).chest(L,22,113),eg=(new Location$$module$js$nodes(a,74,B,"Tunnel 3d (lower branch)")).cave().connect(sd,v);(new Location$$module$js$nodes(a,75,B,"Tunnel 4 (dead end loop)")).cave().connect(eg);const td=(new Location$$module$js$nodes(a,76,B,"Tunnel 5a (right branch over bridge)")).cave().connect(sd),
fg=(new Location$$module$js$nodes(a,76,B,"Tunnel 5b (past wall over bridge)")).cave().connect(td,v),gg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6a (from left branch)")).cave().connect(td),hg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6b (reconvergence)")).cave().connect(gg,v).connect(fg),ig=(new Location$$module$js$nodes(a,77,B,"Tunnel 6c (between walls)")).cave().connect(hg,v),jg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6d (under bridge)")).cave().connect(ig,v),kg=(new Location$$module$js$nodes(a,
78,B,"Tunnel 7a (over second bridge)")).cave().connect(jg),lg=(new Location$$module$js$nodes(a,78,B,"Tunnel 7b (past wall)")).cave().connect(kg,v),mg=(new Location$$module$js$nodes(a,79,B,"Tunnel 8a (under second bridge)")).cave().connect(lg);(new Location$$module$js$nodes(a,79,B,"Tunnel 8b (fog lamp)")).cave().connect(mg,v).chest(kc,19);const ua=(new Location$$module$js$nodes(a,80,y,"Town")).town().connect(hb),ud=(new Location$$module$js$nodes(a,81,y,"Fishherman Island")).town().connect(ua);(new Location$$module$js$nodes(a,
82,fa,"Mesia Shrine")).cave().trigger(Gc).connect(Xf,t,Fc);const vd=(new Location$$module$js$nodes(a,84,ha,"Tunnel 1a (entrance)")).cave().connect(hb);(new Location$$module$js$nodes(a,84,ha,"Tunnel 1b (dead end, mimic)")).cave().connect(vd,w).chest(L,19,114);const ng=(new Location$$module$js$nodes(a,84,ha,"Tunnel 1c (past ice)")).cave().connect(vd,w),og=(new Location$$module$js$nodes(a,85,ha,"Tunnel 2 (stoned pair)")).cave().connect(ng),Lb=(new Location$$module$js$nodes(a,86,ha,"Tunnel 3 (wide medusa hallways)")).cave().connect(og,
Oe),pg=(new Location$$module$js$nodes(a,87,ha,"Tunnel 4a (left entrance)")).cave().from(Lb,w).chest(ac.chest().bonus(),25).trigger(se,tb);(new Location$$module$js$nodes(a,87,ha,"Tunnel 4b (right entrance)")).cave().from(Lb,w).connect(pg,z);(new Location$$module$js$nodes(a,87,ha,"Tunnel 4c (sword of water)")).cave().connect(Lb,w).chest(S,24);const wd=(new Location$$module$js$nodes(a,88,da,"Entrance")).misc(),qg=(new Location$$module$js$nodes(a,89,da,"Level 1")).misc().from(wd),rg=(new Location$$module$js$nodes(a,
90,da,"Level 2")).misc().from(qg),sg=(new Location$$module$js$nodes(a,91,da,"Level 3")).misc().from(rg),xd=(new Location$$module$js$nodes(a,92,da,"Outside Mesia Room")).misc().from(sg),tg=(new Location$$module$js$nodes(a,93,da,"Outside Dyna Room")).misc().from(xd,ob);(new Location$$module$js$nodes(a,94,da,"Mesia")).misc().connect(xd).trigger(De);const ug=(new Location$$module$js$nodes(a,95,da,"Dyna")).misc().from(tg).boss(ff);(new Location$$module$js$nodes(a,95,da,"Win")).misc().from(ug).end();const Mb=
(new Location$$module$js$nodes(a,96,ra,"Cabin Beach")).sea().from(ud,Bb),Ga=(new Location$$module$js$nodes(a,96,ra,"South")).sea().connect(Mb,ba),vg=(new Location$$module$js$nodes(a,96,ra,"Joel Beach")).sea().connect(Ga,ba),yd=(new Location$$module$js$nodes(a,96,ja,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(a,96,ra,"Altar")).sea().connect(Ga,ba).trigger(Cb,nc,mc);const wg=(new Location$$module$js$nodes(a,96,ra,"North")).sea().to(Ga,ba).from(Ga,ba,Me).trigger(ve,Te),xg=(new Location$$module$js$nodes(a,
96,ra,"Swan Beach")).sea().connect(wg,ba);(new Location$$module$js$nodes(a,97,ra,"Cabin")).misc().connect(Mb).trigger(Jc,Bb);(new Location$$module$js$nodes(a,98,ja,"Lighthouse")).misc().connect(yd).trigger(ue,vb);const ib=(new Location$$module$js$nodes(a,100,y,"Underground Channel 1 (from throne room)")).sea().trigger(Ec),yg=(new Location$$module$js$nodes(a,100,y,"Underground Channel 2 (to fortune teller)")).sea().connect(ib,t),zd=(new Location$$module$js$nodes(a,100,y,"Underground Channel 3 (from fortune teller)")).sea().connect(ib,
z),Ad=(new Location$$module$js$nodes(a,100,y,"Underground Channel 4 (asina)")).sea().connect(zd,t),zg=(new Location$$module$js$nodes(a,100,y,"Underground Channel 5 (dolphin)")).sea().connect(Ad,t).trigger(Ic,D,Hc);(new Location$$module$js$nodes(a,100,y,"Underground Channel 6 (water)")).sea().connect(zg,ba).connectTo(Ga,ba).chest(oc,17);const Nb=(new Location$$module$js$nodes(a,101,F,"Zombie Town")).town(),Ag=(new Location$$module$js$nodes(a,104,F,"Tunnel 1 (entrance)")).sea().connect(Ga,Kc,ba),Bd=
(new Location$$module$js$nodes(a,105,F,"Tunnel 2a (start)")).cave().connect(Ag);(new Location$$module$js$nodes(a,105,F,"Tunnel 2b (dead end to left)")).cave().connect(Bd,t);const Bg=(new Location$$module$js$nodes(a,105,F,"Tunnel 2c (across first river)")).cave().connect(Bd,t),Cd=(new Location$$module$js$nodes(a,105,F,"Tunnel 2d (across second river)")).cave().connect(Bg,t);(new Location$$module$js$nodes(a,105,F,"Tunnel 2e (dead end, magic ring)")).cave().connect(Cd,v).chest(T,29);const Cg=(new Location$$module$js$nodes(a,
105,F,"Tunnel 2f (stair down)")).cave().connect(Cd,v),Dg=(new Location$$module$js$nodes(a,106,F,"Tunnel 3a (main area)")).cave().connect(Cg).connectTo(Nb).chest(wa,25,92),Eg=(new Location$$module$js$nodes(a,106,F,"Tunnel 3b (left area toward items)")).cave().connect(Dg,v),Fg=(new Location$$module$js$nodes(a,107,F,"Tunnel 4a (right side, mimic)")).cave().connect(Eg).chest(L,14,115);(new Location$$module$js$nodes(a,107,F,"Tunnel 4b (left side, iron necklace)")).cave().connect(Fg,t).chest(ge,15);const Ob=
(new Location$$module$js$nodes(a,108,ka,"Floor 1")).fortress().connect(Nb),Gg=(new Location$$module$js$nodes(a,108,ka,"Miniboss")).fortress().boss(Xe).connect(Ob);(new Location$$module$js$nodes(a,109,ka,"Floor 2a (left stair)")).fortress().connect(Ob).chest(K,19);const Hg=(new Location$$module$js$nodes(a,109,ka,"Floor 2b (right stair)")).fortress().connect(Gg).chest(D,30,85),Ig=(new Location$$module$js$nodes(a,110,ka,"Floor 3a (toward boss)")).fortress().connect(Hg),Dd=(new Location$$module$js$nodes(a,
110,ka,"Floor 3b (boss room)")).fortress().connect(Ig);(new Location$$module$js$nodes(a,110,ka,"Boss")).fortress().boss(ad).connect(Dd);(new Location$$module$js$nodes(a,110,ka,"Floor 3c (back room trap)")).fortress().from(Dd).to(Ob);const Jg=(new Location$$module$js$nodes(a,112,ja,"Secret Passage")).cave().connectTo(yd),jb=(new Location$$module$js$nodes(a,113,ja,"Town")).town().connect(vg),ea=(new Location$$module$js$nodes(a,114,V,"Town")).town().connect(xg),Kg=(new Location$$module$js$nodes(a,115,
V,"Inside Gate")).overworld().connect(ea),Lg=(new Location$$module$js$nodes(a,115,V,"Outside Gate")).overworld().from(Kg,xa),kb=(new Location$$module$js$nodes(a,120,ta,"Valley")).overworld().connect(Lg),Pb=(new Location$$module$js$nodes(a,124,x,"Entrance")).overworld().connect(kb),Mg=(new Location$$module$js$nodes(a,124,x,"Over first river toward Shyron")).overworld().connect(Pb,t),Ed=(new Location$$module$js$nodes(a,124,x,"After first tunnel")).overworld(),Fd=(new Location$$module$js$nodes(a,124,
x,"Door to Styx")).overworld().connect(Ed,t),Ng=(new Location$$module$js$nodes(a,124,x,"Dead end (no item)")).overworld(),Og=(new Location$$module$js$nodes(a,124,x,"Dead end (fruit of lime)")).overworld().chest(qb,26),Pg=(new Location$$module$js$nodes(a,124,x,"Dead end (magic ring)")).overworld().chest(T,25,101),Gd=(new Location$$module$js$nodes(a,124,x,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(a,124,x,"Floating island (bow of sun)")).overworld().connect(Gd,z).chest(rc,
24);const Qg=(new Location$$module$js$nodes(a,125,x,"Tunnel 1 (to Shyron)")).cave().connect(Mg),Rg=(new Location$$module$js$nodes(a,126,x,"Outside Shyron")).overworld().connect(Qg);(new Location$$module$js$nodes(a,127,x,"Tunnel 2 (fork)")).cave().connect(Pb).connectTo(Og).connectTo(Ed);const Hd=(new Location$$module$js$nodes(a,128,x,"Tunnel 3 (caves)")).cave().connect(Fd).connect(Ng),Id=(new Location$$module$js$nodes(a,129,x,"Tunnel 4 (left branch of cave)")).cave().connect(Hd);(new Location$$module$js$nodes(a,
130,x,"Tunnel 5 (dead end, medical herb)")).cave().connect(Id).chest(D,15,86);const Sg=(new Location$$module$js$nodes(a,131,x,"Tunnel 6a (left-then-right)")).cave().connect(Id),Tg=(new Location$$module$js$nodes(a,131,x,"Tunnel 6b (past wall)")).cave().connect(Sg,v),Ug=(new Location$$module$js$nodes(a,132,x,"Tunnel 7 (wide hall)")).cave().connect(Tg);(new Location$$module$js$nodes(a,133,x,"Tunnel 8 (red slimes)")).cave().from(Ug,v).connectTo(Gd).chest(L,23,116);const Vg=(new Location$$module$js$nodes(a,
134,x,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Hd),Wg=(new Location$$module$js$nodes(a,135,x,"Tunnel 10a (toward magic ring)")).cave().connect(Vg);(new Location$$module$js$nodes(a,135,x,"Tunnel 10b (past wall)")).cave().connect(Wg,v).connectTo(Pg);const Jd=(new Location$$module$js$nodes(a,136,sa,"Entrance")).fortress().from(Fd,jc,Fb),Xg=(new Location$$module$js$nodes(a,137,sa,"Left branch")).fortress().connect(Jd).chest(L,19,117),Yg=(new Location$$module$js$nodes(a,137,sa,"Left branch, past one bridge")).fortress().connect(Xg,
t),Zg=(new Location$$module$js$nodes(a,137,sa,"Left branch, past two bridges")).fortress().connect(Yg,t).chest(D,29,87),$g=(new Location$$module$js$nodes(a,137,sa,"Right branch")).fortress().connect(Jd);(new Location$$module$js$nodes(a,137,sa,"Right branch, across water")).fortress().connect($g,z).chest(L,20,118).chest(L,21,119).chest(Yd,28);(new Location$$module$js$nodes(a,138,sa,"Upper floor")).fortress().connect(Zg).chest(N,27);const Ha=(new Location$$module$js$nodes(a,140,la,"Town")).town().connect(Rg,
Wc).trigger(Db),Oa=(new Location$$module$js$nodes(a,142,ta,"Town")).town().connect(kb),Kd=(new Location$$module$js$nodes(a,143,E,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(a,143,E,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Kd,ya).chest(ee,15);const Qb=(new Location$$module$js$nodes(a,144,ta,"Desert 1")).overworld().connect(kb),lb=(new Location$$module$js$nodes(a,145,E,"Area 1 (from entrance)")).cave().chest(gc,26),Ld=(new Location$$module$js$nodes(a,
145,E,"Area 2 (across top bridge)")).cave().connect(lb,t);(new Location$$module$js$nodes(a,145,E,"Area 3 (dead-end across top-right bridge)")).cave().connect(Ld,t);const ah=(new Location$$module$js$nodes(a,145,E,"Area 4 (left across middle-right bridge)")).cave().connect(Ld,t),bh=(new Location$$module$js$nodes(a,145,E,"Area 5 (bottom edge)")).cave().connect(ah,t),ch=(new Location$$module$js$nodes(a,145,E,"Area 6 (bottom island)")).cave().connect(bh,t),dh=(new Location$$module$js$nodes(a,145,E,"Area 7 (bottom inner ring)")).cave().connect(ch,
t),eh=(new Location$$module$js$nodes(a,145,E,"Area 8 (left outer ring)")).cave().connect(dh,t).connect(lb,t).chest(K,27,100),fh=(new Location$$module$js$nodes(a,145,E,"Area 9 (top left inner ring)")).cave().connect(eh,t),gh=(new Location$$module$js$nodes(a,145,E,"Area 10 (top right inner ring)")).cave().connect(fh,t);(new Location$$module$js$nodes(a,145,E,"Area 11 (center)")).cave().connect(gh,t).connectTo(Kd);(new Location$$module$js$nodes(a,145,E,"Area 12 (top center islands)")).cave().connect(lb,
z).chest(ce,28);const hh=(new Location$$module$js$nodes(a,146,X,"Desert Cave 1")).cave().connect(Qb,z),Ia=(new Location$$module$js$nodes(a,147,X,"Town")).town(),ih=(new Location$$module$js$nodes(a,148,X,"Outside Cave")).overworld().connect(Ia),jh=(new Location$$module$js$nodes(a,149,X,"Desert Cave 2")).cave().connect(ih);(new Location$$module$js$nodes(a,150,X,"Meadow")).overworld().connect(hh).connectTo(Ia).trigger(Ae,xa);const Rb=(new Location$$module$js$nodes(a,152,X,"Desert 2")).overworld().connect(jh),
kh=(new Location$$module$js$nodes(a,156,Da,"Entrance")).fortress().connect(Rb,z),lh=(new Location$$module$js$nodes(a,156,Da,"Azteca")).fortress().trigger(Ce),mh=(new Location$$module$js$nodes(a,157,Da,"Fork")).fortress().connect(kh),Md=(new Location$$module$js$nodes(a,158,Da,"Main")).fortress().connect(mh);(new Location$$module$js$nodes(a,158,Da,"Treasure Chest (magic ring)")).fortress().connect(Md).chest(T,27,108);(new Location$$module$js$nodes(a,159,Da,"Draygon")).fortress().connect(Md).to(lh).boss(cf);
...
const qh=(new Location$$module$js$nodes(a,165,ca,"Hall 2")).fortress().connect(Sb).chest(sb,26,109),rh=(new Location$$module$js$nodes(a,166,ca,"Draygon 2")).fortress().connect(qh).boss(ef);(new Location$$module$js$nodes(a,167,ca,"Teleporter")).fortress().from(rh).to(wd);const Nd=(new Location$$module$js$nodes(a,168,cb,"Entrance")).fortress().connect(Oa,Fb).trigger(Oc,N),sh=(new Location$$module$js$nodes(a,169,cb,"Main")).fortress().from(Nd,ya),th=(new Location$$module$js$nodes(a,169,cb,"Boss")).fortress().connect(sh).boss(Ze),
...
zh=(new Location$$module$js$nodes(a,172,W,"Tornel")).fortress().connect(yh),Od=(new Location$$module$js$nodes(a,173,Ca,"Lower")).fortress().connect(zh).chest(sb,26,99).chest(T,27,111),Ah=(new Location$$module$js$nodes(a,174,Ca,"Upper Loop")).fortress().connect(Od).chest(H,22,96);(new Location$$module$js$nodes(a,174,Ca,"Upper Loop Behind Wall (magic ring)")).fortress().connect(Ah,ya).chest(T,23,107);const Bh=(new Location$$module$js$nodes(a,175,Ca,"Upper Passage (toward Mado)")).fortress().connect(Od).chest(T,
27,84),Ub=(new Location$$module$js$nodes(a,176,M,"Initial Fork")).fortress(),Ch=(new Location$$module$js$nodes(a,177,M,"Left Branch")).fortress().connect(Ub),Pd=(new Location$$module$js$nodes(a,178,M,"Main Area (right branch, over bridges)")).fortress().connect(Ub),Dh=(new Location$$module$js$nodes(a,179,M,"U-shaped Passage (between floors)")).fortress().connect(Pd),Eh=(new Location$$module$js$nodes(a,180,M,"Main Area Lower (under bridge)")).fortress().connect(Ch).connect(Pd).connect(Dh),Qd=(new Location$$module$js$nodes(a,
180,M,"Behind Iron Wall")).fortress().connect(Eh,ya),Fh=(new Location$$module$js$nodes(a,181,M,"Lower")).fortress().connect(Qd).chest(L,13,121).chest(L,14,122).chest(L,15,123).chest(T,23,88).chest(O,24,110),Gh=(new Location$$module$js$nodes(a,182,M,"Boss Corridor")).fortress().connect(Fh),Hh=(new Location$$module$js$nodes(a,182,M,"Boss")).fortress().connect(Gh,Fb).boss(bf);(new Location$$module$js$nodes(a,182,M,"Behind Boss (stormBracelet)")).fortress().connect(Hh).chest(Va,18);const Rd=(new Location$$module$js$nodes(a,
183,M,"Exit Stairs")).fortress(),Ih=(new Location$$module$js$nodes(a,184,E,"Entrance Back (behind river)")).cave().connect(Rd).chest(K,13,90);(new Location$$module$js$nodes(a,184,E,"Entrance Front")).cave().connect(Ih,z).connectTo(Qb).connectTo(lb);const Jh=(new Location$$module$js$nodes(a,185,Ca,"Boss")).fortress().connect(Bh).boss(af);(new Location$$module$js$nodes(a,185,Ca,"Asina")).fortress().connect(Jh).connectTo(Ub);(new Location$$module$js$nodes(a,186,M,"Kensu")).fortress().connect(Qd).connectTo(Rd).trigger(ze,
yb);(new Location$$module$js$nodes(a,187,ta,"House")).house().connect(Oa).trigger(Be,xa,yb);(new Location$$module$js$nodes(a,188,ta,"Inn")).shop().connect(Oa,Db);(new Location$$module$js$nodes(a,190,ta,"Tool Shop")).shop(D,H,O,K).connect(Oa,Db);(new Location$$module$js$nodes(a,191,ta,"Tavern")).shop().connect(Oa);(new Location$$module$js$nodes(a,192,U,"Elder House")).house().connect(ma).trigger(vc);(new Location$$module$js$nodes(a,193,U,"Rabbit Hut")).house().connect(ma).trigger(Bc,Ac,pa);(new Location$$module$js$nodes(a,
194,U,"Inn")).shop().connect(ma);(new Location$$module$js$nodes(a,195,U,"Tool Shop")).shop(D,H,O,K).connect(ma);(new Location$$module$js$nodes(a,196,U,"Armor Shop")).shop(Zd,Zb).connect(ma);(new Location$$module$js$nodes(a,197,U,"Student House")).house().connect(ma).trigger(wc);(new Location$$module$js$nodes(a,198,Aa,"Tavern")).house().connect(Na);(new Location$$module$js$nodes(a,199,Aa,"Pawn Shop")).shop().connect(Na);(new Location$$module$js$nodes(a,200,Aa,"Inn")).shop().connect(Na);(new Location$$module$js$nodes(a,
201,Aa,"Armor Shop")).shop($d,Zb,Wd).connect(Na);(new Location$$module$js$nodes(a,203,Aa,"Tool Shop")).shop(D,H,O).connect(Na);(new Location$$module$js$nodes(a,205,La,"Elder House")).house().from(eb,pa).trigger(oe,Ab);(new Location$$module$js$nodes(a,206,La,"Mother's House")).house().from(eb,pa).trigger(zc,pa).trigger(ne,Ab);(new Location$$module$js$nodes(a,207,La,"Tool Shop")).shop(D,H,K).from(eb,pa);(new Location$$module$js$nodes(a,208,La,"Inn")).shop().from(eb,pa);(new Location$$module$js$nodes(a,
209,Ba,"Inn")).shop().connect(db);(new Location$$module$js$nodes(a,210,Ba,"Tool Shop")).shop(O,K,wa).connect(db);(new Location$$module$js$nodes(a,211,Ba,"Armor Shop")).shop(cc,$b,ac,pb).connect(db);const Kh=(new Location$$module$js$nodes(a,212,Ba,"Queen's House")).house().from(db,Wc).trigger(xe,xa,pc);(new Location$$module$js$nodes(a,213,bb,"Nadare's")).house().connect(fb).connectTo(Sf).connectTo(Tf).connectTo(Uf);(new Location$$module$js$nodes(a,214,y,"Fisherman's House")).house().connect(ud).trigger(Bb,
kc,xb,Pe);const Vb=(new Location$$module$js$nodes(a,215,y,"Palace Entrance")).house().connect(ua);(new Location$$module$js$nodes(a,216,y,"Fortune Teller Front")).house().connect(ua).trigger(Dc,Cc);(new Location$$module$js$nodes(a,216,y,"Fortune Teller Back")).house().connect(yg).connect(zd);(new Location$$module$js$nodes(a,217,y,"Pawn Shop")).shop().connect(ua);(new Location$$module$js$nodes(a,218,y,"Armor Shop")).shop(ae,cc,$b).connect(ua);(new Location$$module$js$nodes(a,220,y,"Inn")).shop().connect(ua);
(new Location$$module$js$nodes(a,221,y,"Tool Shop")).shop(D,wa,qb,O).connect(ua);(new Location$$module$js$nodes(a,222,y,"Palace Left")).house().connect(Vb);(new Location$$module$js$nodes(a,223,y,"Palace Throne Room")).house().connect(Vb).to(ib,Ke).from(ib).trigger(Cc).trigger(re,Dc,Ec);(new Location$$module$js$nodes(a,224,y,"Palace Right")).house().connect(Vb);(new Location$$module$js$nodes(a,225,y,"Asina's Room")).house().connect(Ad).trigger(Hc,Rc);(new Location$$module$js$nodes(a,226,Ba,"Queen Downstairs")).house().connect(Kh).chest(Ta,
13);(new Location$$module$js$nodes(a,227,ja,"Elder's House")).house().connect(jb).trigger(Kc);(new Location$$module$js$nodes(a,228,ja,"Shed")).house().connect(jb).to(Jg,lc);(new Location$$module$js$nodes(a,229,ja,"Tool Shop")).shop(D,H,K,wa).connect(jb);(new Location$$module$js$nodes(a,231,ja,"Inn")).shop().connect(jb);const Lh=(new Location$$module$js$nodes(a,232,F,"Zombie Town House")).house().connect(Nb);(new Location$$module$js$nodes(a,233,F,"Zombie Town Basement")).house().connect(Lh).trigger(te,
ad);(new Location$$module$js$nodes(a,235,V,"Tool Shop")).shop(D,H,K,O).connect(ea);(new Location$$module$js$nodes(a,236,V,"Stom's Hut")).house().connect(ea).trigger(Lc);(new Location$$module$js$nodes(a,237,V,"Inn")).shop().connect(ea);(new Location$$module$js$nodes(a,238,V,"Armor Shop")).shop(be,dc,Xd,bc).connect(ea);(new Location$$module$js$nodes(a,239,V,"Tavern")).house().connect(ea).trigger(Mc,Lc,Ya);(new Location$$module$js$nodes(a,240,V,"Pawn Shop")).shop().connect(ea);(new Location$$module$js$nodes(a,
241,V,"Dance Hall")).house().connect(ea).trigger(Nc,Mc,Ya).trigger(we,Nc,oc);const Mh=(new Location$$module$js$nodes(a,242,la,"Temple (pre-massacre)")).fortress().connect(Ha).from(Gb,N,Td).trigger(ye);(new Location$$module$js$nodes(a,242,la,"Temple (post-massacre)")).fortress().from(Mh,Oc).boss(Ye);(new Location$$module$js$nodes(a,243,la,"Training Hall")).house().connect(Ha);(new Location$$module$js$nodes(a,244,la,"Hospital")).house().connect(Ha);(new Location$$module$js$nodes(a,245,la,"Armor Shop")).shop(dc,
pb,bc).connect(Ha);(new Location$$module$js$nodes(a,246,la,"Tool Shop")).shop(D,H,qb,T).connect(Ha);(new Location$$module$js$nodes(a,247,la,"Inn")).shop().connect(Ha);(new Location$$module$js$nodes(a,248,X,"Inn")).shop().connect(Ia);(new Location$$module$js$nodes(a,249,X,"Tool Shop")).shop(H,O,rb,T).connect(Ia);(new Location$$module$js$nodes(a,250,X,"Elder's House")).house().connect(Ia);(new Location$$module$js$nodes(a,251,X,"Pawn Shop")).house().connect(Ia);const Nh=[ma,Ma,cd,Ea,Hb,Fa,Kb,od,Mb,ea,
kb,Pb,Qb,Nd,Rb];for(const a of Nh)a.from(Gb,Ge);return a},shuffle$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);d.check("Ps")&&f.shuffleShops(a);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);d||(d=new FlagSet$$module$js$flagset("Sbkm Sct"));var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&k.slots){var m=k.slotType[0];(h[m]=h[m]||[]).push(k)}k=[];m=[];var n={};for(var p of d.flags.S||
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="defrag",LABEL$$module$js$version="defrag b006a8a",HASH$$module$js$version="b006a8aff2cf68a0b3544d885d3f36a59fd87646",DATE$$module$js$version=new Date(1554891035E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);d=a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$js$patch(b,parseSeed$$module$js$patch(a.seed),d,new FetchReader$$module$js$fetchreader(c))})}};
...
c){d[0]=f;return}throw Error(`Could not find flag to replace at ${a}:${c}`);};a.check("Rl")&&(c(20,48,238),c(21,48,238),c(64,0,216))},eastCave$$module$js$patch=(b)=>{},addCordelWestTriggers$$module$js$patch=(b,a)=>{for(const c of b.locations[21].objects)2===c[2]&&(128>c[3]||a.check("Fp"))&&b.locations[20].objects.push([...c])},fixRabbitSkip$$module$js$patch=(b)=>{for(const a of b.locations[40].objects)2===a[2]&&134===a[3]&&(116===a[1]&&a[1]++,a[0]++)},storyMode$$module$js$patch=(b)=>{const a=b.npcSpawns[203].conditions[166];
a.push(~b.npcSpawns[194].conditions[40][0]);a.push(~b.npcSpawns[132].conditions[110][0]);a.push(~b.triggers[26].conditions[1]);a.push(~b.npcSpawns[197].conditions[169][0]);a.push(~b.npcSpawns[198].conditions[172][0]);a.push(~b.npcSpawns[199].conditions[185][0]);a.push(~b.npcSpawns[200].conditions[182][0]);a.push(~b.npcSpawns[203].conditions[159][0]);a.push(512);a.push(513);a.push(514);a.push(515)},connectLimeTreeToLeaf$$module$js$patch=(b)=>{const a=b.locations[3];b=b.locations[66];a.screens[5][4]=
