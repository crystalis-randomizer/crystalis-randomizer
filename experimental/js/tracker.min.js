...
this.bytesInternal.length;b++)"string"===typeof this.bytesInternal[b]&&(this.bytesInternal[b]=a.map(this.bytesInternal[b]))}}
...
text:'Player may be required to fight bosses with the wrong sword, which\n             may require using "tink strats" dealing 1 damage per hit.'},{flag:"Ht",hard:!0,name:"Max scaling level in tower",text:"Enemies in the tower spawn at max scaling level."},{flag:"Hx",hard:!0,name:"Experience scales slower",text:'More grinding will be required to "keep up" with the difficulty.',conflict:/Ex/},{flag:"Hc",hard:!0,name:"Charge shots only",text:"Stabbing is completely ineffective.  Only charged shots work."},
{flag:"Hd",hard:!0,name:"Buff Dyna",text:"Makes the Dyna fight a bit more of a challenge.  Side pods will fire\n             significantly more.  The safe spot has been removed.  The counter\n             attacks pass through barrier.  Side pods can now be killed."},{flag:"Hz",hard:!0,name:"Blackout mode",text:"All caves and fortresses are permanently dark."},{flag:"Hh",hard:!0,name:"Hardcore mode",text:"Checkpoints and saves are removed."}]};var module$js$flags$hard_mode={};
module$js$flags$hard_mode.HARD_MODE_FLAGS=HARD_MODE_FLAGS$$module$js$flags$hard_mode;const MONSTER_FLAGS$$module$js$flags$monsters={section:"Monsters",text:"Monster stats are always normalized by scaling level.",prefix:"M",flags:[{flag:"Mr",name:"Randomize monsters",text:"Monster locations are shuffled, with the exception of sea creatures\n             and tower robots."},{flag:"Me",name:"Shuffle monster weaknesses",text:"Monster and boss elemental weaknesses are shuffled."},{flag:"Mt",hard:!0,name:"Shuffle tower robots",text:"Tower robots will be shuffled into the normal pool.  At some\n             point, normal monsters may be shuffled into the tower as well."}]};
...
var module$js$flags$world={};module$js$flags$world.WORLD_FLAGS=WORLD_FLAGS$$module$js$flags$world;const EXPERIMENTAL_FLAGS$$module$js$flags$experimental={section:"Experimental",prefix:"X",flags:[{flag:"Xb",name:"Remove one early wall",text:"Remove either the wall in East Cave or the wall behind Zebu."},{flag:"Xc",name:"Extra checks",text:"Add two extra checks in the initial area.  This requires Re and\n             results in an item on the student, as well as two chests in the\n             East Cave."},{flag:"Xe",name:"East Cave (GBC)",text:'Add the "East Cave" from the GBC version.  If this is selected\n             then the initial Alarm Flute will be found in a chest on the\n             second floor of this cave.  If Rp is also selected, then there\n             will be a second exit from this cave leading to Lime Tree Valley.'},
{flag:"Xf",name:"Fog Lamp not required for dolphin",text:"Can summon dolphin immediately with only shell flute.  Fog lamp\n             provides one point of access to the sea, which comes with an item\n             under Kensu.  Talking to Kensu is not required for dolphin."},{flag:"Xg",name:"Goa passage",text:'Add a passage between East Cave and Goa Valley.  There will be an\n             "ember wall" (requires water) blocking the exit.  Requires Xe'},{flag:"Xw",name:"Random thunder warp",text:'Randomize warp location for Sword of Thunder.  Instead of warping\n             to Shyron, the player may instead be warped to any of the 12 towns,\n             chosen randomly when the seed is rolled.  Access to that town will\n             be considered "in-logic" once Sword of Thunder is acquired.'}]};
var module$js$flags$experimental={};module$js$flags$experimental.EXPERIMENTAL_FLAGS=EXPERIMENTAL_FLAGS$$module$js$flags$experimental;class Deque$$module$js$util{constructor(){this.buffer=Array(16);this.mask=15;this.size=this.end=this.start=0}get length(){return this.size}upsize(a){for(;this.mask<a;)this.end<=this.start&&(this.start+=this.mask+1),this.mask=this.mask<<1|1,this.buffer=this.buffer.concat(this.buffer);this.size=a}push(...a){this.upsize(this.size+a.length);for(const b of a)this.buffer[this.end]=b,this.end=this.end+1&this.mask}pop(){if(this.size)return this.end=this.end-1&this.mask,this.size--,this.buffer[this.end]}peek(){if(this.size)return this.buffer[this.end-
...
return b}set(a,b){if(this._fwd[a])throw Error(`already has key ${a}`);if(this._rev[b])throw Error(`already has value ${b}`);this._fwd[a]=b;this._rev[b]=a}replace(a,b){var c=this._rev[b];null!=c&&delete this._fwd[c];c=this._fwd[a];null!=c&&delete this._rev[c];this._fwd[a]=b;this._rev[b]=a;return c}}var module$js$util={};module$js$util.Deque=Deque$$module$js$util;module$js$util.breakLines=breakLines$$module$js$util;module$js$util.UsageError=UsageError$$module$js$util;module$js$util.SuffixTrie=SuffixTrie$$module$js$util;
module$js$util.DefaultMap=DefaultMap$$module$js$util;module$js$util.IndexedSet=IndexedSet$$module$js$util;module$js$util.iters=iters$$module$js$util;module$js$util.spread=spread$$module$js$util;module$js$util.LabeledSet=LabeledSet$$module$js$util;module$js$util.SetMultimap=SetMultimap$$module$js$util;module$js$util.Multiset=Multiset$$module$js$util;module$js$util.assertNever=assertNever$$module$js$util;module$js$util.assert=assert$$module$js$util;module$js$util.isNonNull=isNonNull$$module$js$util;
module$js$util.memoize=memoize$$module$js$util;module$js$util.strcmp=strcmp$$module$js$util;module$js$util.Keyed=Keyed$$module$js$util;module$js$util.ArrayMap=ArrayMap$$module$js$util;module$js$util.MutableArrayBiMap=MutableArrayBiMap$$module$js$util;const PRESETS$$module$js$flagset=[{title:"Casual",descr:"Basic flags for a relatively easy playthrough.",flags:"Ds Edmrstux Fw Mr Rp Tab"},{title:"Intermediate",descr:"Slightly more challenge than Casual but still approachable.",flags:"Ds Edmsu Fsw Gt Mr Ps Rpt Tab",default:!0},{title:"Full Shuffle",descr:"Slightly harder than intermediate, with full shuffle and no spoiler log.",flags:"Em Fsw Gt Mert Ps Rprt Tabmp Wmtuw Xegw"},{title:"Glitchless",descr:"Full shuffle but with no glitches.",flags:"Em Fcpstw Mert Ps Rprt Tab Wmtuw Xcegw"},
{title:"Advanced",descr:"A balanced randomization with quite a bit more difficulty.",flags:"Fsw Gfprt Hbdgtw Mert Ps Roprst Tabmp Wmtuw Xcegw"},{title:"Ludicrous",descr:"Pulls out all the stops, may require superhuman feats.",flags:"Fs Gcfprtw Hbdgmstwxz Mert Ps Roprst Tabmp Wmtuw Xcegw"},{title:"Mattrick",descr:"Not for the faint of heart. Good luck...",flags:"Fcprsw Gt Hbdhtwx Mert Ps Ropst Tabmp Wmtuw"},{title:"The Full Stupid",descr:"Nobody has ever completed this.",flags:"Fcprsw Hbdhmwtxz Mert Ps Ropst Sckmt Tab Wmtuw Xcegw"},
{title:"No Bow Mode",descr:"The tower is open from the start, for whoever is ready for it.",flags:"Fcprstw Ht Mert Ps Rbt Sckmt Tab Xcegw"},{title:"Tournament: Swiss Round",descr:"Quick-paced full-shuffle flags for Swiss round of 2019 Tournament",flags:"Es Fcprsw Gt Hd Mr Ps Rpt Tab"},{title:"Tournament: Elimination Round",descr:"More thorough flags for the first elimination rounds of the 2019 Tournament",flags:"Em Fprsw Gft Hbd Mer Ps Rprst Tab Wt"},{title:"Tournament: Semifinals",descr:"Advanced flags for semifinal round of the 2019 Tournament",
flags:"Em Fsw Gft Hbd Mert Ps Roprst Tab Wt"},{title:"Tournament: Finals",descr:"Expert flags for finals round of the 2019 Tournament",flags:"Fsw Gfprt Hbdw Mert Ps Roprst Tab Wmtw"}],PRESETS_BY_KEY$$module$js$flagset={};for(const {title:a,flags:b}of PRESETS$$module$js$flagset)PRESETS_BY_KEY$$module$js$flagset[`@${a.replace(/ /g,"").toLowerCase()}`]=b;
const FLAGS$$module$js$flagset=[WORLD_FLAGS$$module$js$flags$world,EASY_MODE_FLAGS$$module$js$flags$easy_mode,MONSTER_FLAGS$$module$js$flags$monsters,SHOP_FLAGS$$module$js$flags$shops,HARD_MODE_FLAGS$$module$js$flags$hard_mode,TWEAK_FLAGS$$module$js$flags$tweaks,ROUTING_FLAGS$$module$js$flags$routing,GLITCH_FLAGS$$module$js$flags$glitches,GLITCH_FIX_FLAGS$$module$js$flags$glitch_fixes,EXPERIMENTAL_FLAGS$$module$js$flags$experimental,DEBUG_MODE_FLAGS$$module$js$flags$debug_mode];
class FlagSet$$module$js$flagset{constructor(a="RtGftTab"){if(a.startsWith("@")){var b=PRESETS_BY_KEY$$module$js$flagset[a.toLowerCase()];if(!b)throw new UsageError$$module$js$util(`Unknown preset: ${a}`);a=b}this.flags={};a=a.replace(/[^A-Za-z0-9!]/g,"");b=/([A-Z])([a-z0-9!]+)/g;let c;for(;c=b.exec(a);){const [,a,b]=c;for(const c of b)this.set(a+c,!0)}}get(a){return this.flags[a]||[]}set(a,b){const c=a[0],d=a.substring(1);b?(this.removeConflicts(a),a=(this.flags[c]||[]).filter((a)=>a!==d),a.push(d),
a.sort(),this.flags[c]=a):(a=(this.flags[c]||[]).filter((a)=>a!==d),a.length?this.flags[c]=a:delete this.flags[c])}check(a){const b=this.flags[a[0]];return!!(b&&0<=b.indexOf(a.substring(1)))}preserveUniqueChecks(){return this.check("Eu")}shuffleMimics(){return!this.check("Et")}autoEquipBracelet(){return this.check("Ta")}buffDeosPendant(){return this.check("Tb")}changeGasMaskToHazmatSuit(){return this.check("Tb")}slowDownTornado(){return this.check("Tb")}leatherBootsGiveSpeed(){return this.check("Tb")}rabbitBootsChargeWhileWalking(){return this.check("Tb")}controllerShortcuts(){return!this.check("Tc")}randomizeMusic(){return this.check("Tm")}shuffleSpritePalettes(){return this.check("Tp")}shuffleMonsters(){return this.check("Mr")}shuffleShops(){return this.check("Ps")}bargainHunting(){return this.shuffleShops()}shuffleTowerMonsters(){return this.check("Mt")}shuffleMonsterElements(){return this.check("Me")}shuffleBossElements(){return this.shuffleMonsterElements()}doubleBuffMedicalHerb(){return this.check("Em")}buffMedicalHerb(){return!this.check("Hm")}decreaseEnemyDamage(){return this.check("Ed")}trainer(){return this.check("Dt")}neverDie(){return this.check("Di")}chargeShotsOnly(){return this.check("Hc")}barrierRequiresCalmSea(){return!0}paralysisRequiresPrisonKey(){return!0}sealedCaveRequiresWindmill(){return!0}connectLimeTreeToLeaf(){return this.check("Rp")}connectGoaToLeaf(){return this.check("Xe")&&
this.check("Xg")}removeEarlyWall(){return this.check("Xb")}zebuStudentGivesItem(){return!this.check("Xe")||this.check("Xc")}addEastCave(){return this.check("Xe")}addExtraChecksToEastCave(){return this.check("Xe")&&this.check("Xc")}fogLampNotRequired(){return this.check("Xf")}storyMode(){return this.check("Rs")}noBowMode(){return this.check("Rb")}requireHealedDolphinToRide(){return this.check("Rd")}saharaRabbitsRequireTelepathy(){return this.check("Rr")}teleportOnThunderSword(){return this.check("Rt")}randomizeThunderTeleport(){return this.check("Xw")}orbsOptional(){return this.check("Ro")}randomizeMaps(){return this.check("Wm")}randomizeTrades(){return this.check("Wt")}unidentifiedItems(){return this.check("Wu")}randomizeWalls(){return this.check("Ww")}guaranteeSword(){return this.check("Es")}guaranteeSwordMagic(){return!this.check("Hw")}guaranteeMatchingSword(){return!this.check("Hs")}guaranteeGasMask(){return!this.check("Hg")}guaranteeBarrier(){return!this.check("Hb")}guaranteeRefresh(){return this.check("Er")}disableSwordChargeGlitch(){return this.check("Fc")}disableTeleportSkip(){return this.check("Fp")}disableRabbitSkip(){return this.check("Fr")}disableShopGlitch(){return this.check("Fs")}disableStatueGlitch(){return this.check("Ft")}disableFlightStatueSkip(){return!1}assumeSwordChargeGlitch(){return this.check("Gc")}assumeGhettoFlight(){return this.check("Gf")}assumeTeleportSkip(){return this.check("Gp")}assumeRabbitSkip(){return this.check("Gr")}assumeStatueGlitch(){return this.check("Gt")}assumeTriggerGlitch(){return!1}assumeFlightStatueSkip(){return!1}assumeWildWarp(){return this.check("Gw")}assumeRageSkip(){return!1}nerfWildWarp(){return this.check("Fw")}allowWildWarp(){return!this.nerfWildWarp()}randomizeWildWarp(){return this.check("Tw")}blackoutMode(){return this.check("Hz")}hardcoreMode(){return this.check("Hh")}buffDyna(){return this.check("Hd")}maxScalingInTower(){return this.check("Ht")}expScalingFactor(){return this.check("Hx")?
.25:this.check("Ex")?2.5:1}removeConflicts(a){const b=this.exclusiveFlags(a);if(b)for(const c in this.flags)this.flags.hasOwnProperty(c)&&(a=this.flags[c].filter((a)=>!b.test(c+a)),a.length?this.flags[c]=a:delete this.flags[c])}toStringKey(a){return a+[...this.flags[a]].sort().join("")}exclusiveFlags(a){const b=this.getFlagForName(a);if(null==b)throw Error(`Unknown flag: ${a}`);return b.conflict}getFlagForName(a){const b=FLAGS$$module$js$flagset.find((b)=>a.startsWith(b.prefix));if(b)return b.flags.find((b)=>
b.flag===a)}toString(){const a=Object.keys(this.flags);a.sort();return a.map((a)=>this.toStringKey(a)).join(" ")}}var module$js$flagset={};module$js$flagset.PRESETS=PRESETS$$module$js$flagset;module$js$flagset.FLAGS=FLAGS$$module$js$flagset;module$js$flagset.FlagSet=FlagSet$$module$js$flagset;const Edge$$module$js$graph={of:(...a)=>a.map((a)=>a.uid)};class Node$$module$js$graph{constructor(a,b){this.graph=a;this.name=b;this.uid=a.nodes.length;a.nodes.push(this)}get nodeType(){return"Node"}toString(){return`${this.nodeType} ${this.name}`}edges(a){return[]}write(){}}
...
module$js$rom$util.countBits=countBits$$module$js$rom$util;module$js$rom$util.hex=hex$$module$js$rom$util;module$js$rom$util.hex3=hex3$$module$js$rom$util;module$js$rom$util.hex4=hex4$$module$js$rom$util;module$js$rom$util.hex5=hex5$$module$js$rom$util;module$js$rom$util.concatIterables=concatIterables$$module$js$rom$util;module$js$rom$util.readBigEndian=readBigEndian$$module$js$rom$util;module$js$rom$util.readLittleEndian=readLittleEndian$$module$js$rom$util;module$js$rom$util.readString=readString$$module$js$rom$util;
module$js$rom$util.writeLittleEndian=writeLittleEndian$$module$js$rom$util;module$js$rom$util.writeString=writeString$$module$js$rom$util;module$js$rom$util.write=write$$module$js$rom$util;module$js$rom$util.FlagListType=FlagListType$$module$js$rom$util;module$js$rom$util.DIALOG_FLAGS=DIALOG_FLAGS$$module$js$rom$util;module$js$rom$util.ITEM_GET_FLAGS=ITEM_GET_FLAGS$$module$js$rom$util;module$js$rom$util.ITEM_USE_FLAGS=ITEM_USE_FLAGS$$module$js$rom$util;module$js$rom$util.ITEM_CONDITION_FLAGS=ITEM_CONDITION_FLAGS$$module$js$rom$util;
module$js$rom$util.SPAWN_CONDITION_FLAGS=SPAWN_CONDITION_FLAGS$$module$js$rom$util;module$js$rom$util.initializer=initializer$$module$js$rom$util;module$js$rom$util.DataTuple=DataTuple$$module$js$rom$util;module$js$rom$util.watchArray=watchArray$$module$js$rom$util;class TrackerNode$$module$js$nodes extends Node$$module$js$graph{constructor(a,b,c){super(a,c);this.type=b}get nodeType(){return"Tracker"}edges({}={}){return[]}}TrackerNode$$module$js$nodes.OFF_ROUTE=1;TrackerNode$$module$js$nodes.GLITCH=2;TrackerNode$$module$js$nodes.HARD=3;class Option$$module$js$nodes extends Node$$module$js$graph{constructor(a,b,c){super(a,b);this.value=c}get nodeType(){return"Option"}edges(){return this.value?[Edge$$module$js$graph.of(this)]:[]}}
...
a.assumeGhettoFlight())),l=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),p=h(d("Assume teleport skip",a.assumeTeleportSkip())),q=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),x=h(d("Allow rabbit skip",!a.disableRabbitSkip())),v=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),y=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),C=h(d("Assume wild warp",a.assumeWildWarp())),
B=d("Allow wild warp",a.allowWildWarp()),u=d("Sword magic optional",!a.guaranteeSwordMagic()),t=d("Matching sword optional",!a.guaranteeMatchingSword()),T=d("Gas mask optional",!a.guaranteeGasMask()),N=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),ib=d("Calm sea optional",!a.barrierRequiresCalmSea()),U=d("Prison key optional",!a.paralysisRequiresPrisonKey()),va=d("Windmill optional",!a.sealedCaveRequiresWindmill()),Aa=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
Wa=d("Barrier magic optional",!a.guaranteeBarrier()),Oa=d("Refresh magic optional",!a.guaranteeRefresh()),jb=d("Telepathy optional for Deo",!a.saharaRabbitsRequireTelepathy()),Y=d("Lime Tree connects to Leaf",a.connectLimeTreeToLeaf()),Ba=d("Buffed medical herb",a.buffMedicalHerb()),da=d("Orbs optional",a.orbsOptional()),H=(new Item$$module$js$nodes(c,0,"Sword of Wind")).weight(a.guaranteeSword()?10:5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),O=(new Item$$module$js$nodes(c,
1,"Sword of Fire")).weight(a.guaranteeSword()?10:5).fromPerson("Oak elder",29).dialog(29,void 0,3).key(),P=(new Item$$module$js$nodes(c,2,"Sword of Water")).weight(10).chest().key(),I=(new Item$$module$js$nodes(c,3,"Sword of Thunder")).weight(15).chest().key(),Ca=(new Item$$module$js$nodes(c,4,"Crystalis")).fixed(),ea=(new Item$$module$js$nodes(c,5,"Ball of Wind")).chest().key(),V=(new Item$$module$js$nodes(c,6,"Tornado Bracelet")).chest().key(),Da=(new Item$$module$js$nodes(c,7,"Ball of Fire")).bossDrop("Insect",
1).dialog(30,void 0,2).dialog(32,void 0,0).dialog(33,void 0,0).dialog(34,void 0,0).dialog(96,30,0).dialog(29,void 0,2).dialog(31,void 0,1).npcSpawn(193).key(),la=(new Item$$module$js$nodes(c,8,"Flame Bracelet")).bossDrop("Kelbesque 1",2).npcSpawn(194).key(),ma=(new Item$$module$js$nodes(c,9,"Ball of Water")).weight(5).direct("Rage",250679).npcSpawn(195).key(),fa=(new Item$$module$js$nodes(c,10,"Blizzard Bracelet")).weight(5).chest().key(),na=(new Item$$module$js$nodes(c,11,"Ball of Thunder")).bossDrop("Mado 1",
5).trigger(154,1).key(),Ea=(new Item$$module$js$nodes(c,12,"Storm Bracelet")).chest().key(),oa=(new Item$$module$js$nodes(c,13,"Carapace Shield")).armor(),w=(new Item$$module$js$nodes(c,14,"Bronze Shield")).armor(),qb=(new Item$$module$js$nodes(c,15,"Platinum Shield")).armor(),rb=(new Item$$module$js$nodes(c,16,"Mirrored Shield")).armor(),F=(new Item$$module$js$nodes(c,17,"Ceramic Shield")).armor(),W=(new Item$$module$js$nodes(c,18,"Sacred Shield")).armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),
Q=(new Item$$module$js$nodes(c,19,"Battle Shield")).armor(),pa=(new Item$$module$js$nodes(c,20,"Psycho Shield")).armor(),Pa=(new Item$$module$js$nodes(c,21,"Tanned Hide")).armor(),Fa=(new Item$$module$js$nodes(c,22,"Leather Armor")).armor(),be=(new Item$$module$js$nodes(c,23,"Bronze Armor")).armor(),oc=(new Item$$module$js$nodes(c,24,"Platinmum Armor")).armor(),ce=(new Item$$module$js$nodes(c,25,"Soldier Suit")).armor(),pc=(new Item$$module$js$nodes(c,26,"Ceramic Suit")).armor(),de=(new Item$$module$js$nodes(c,
27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),R=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),Z=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),Xa=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),Kb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),aa=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),qa=(new Item$$module$js$nodes(c,
34,"Magic Ring")).consumable(),Lb=(new Item$$module$js$nodes(c,35,"Fruit of Repun")).consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),ha=(new Item$$module$js$nodes(c,36,"Warp Boots")).consumable(),qc=(new Item$$module$js$nodes(c,37,"Statue of Onyx")).chest("Cordel grass").invisible(254882).key(),Mb=(new Item$$module$js$nodes(c,38,"Opel Statue")).consumable().bossDrop("Kelbesque 2",6).npcSpawn(197).key(),rc=(new Item$$module$js$nodes(c,39,"Insect Flute")).fromPerson("Oak mother",30).dialog(30,
void 0,1).key(),Nb=(new Item$$module$js$nodes(c,40,"Flute of Lime")).fromPerson("Portoa queen",56).fromPerson("Asina secondary",98,1).dialog(56,void 0,4).key(),sb=(new Item$$module$js$nodes(c,41,"Gas Mask")).direct("Akahana in Brynmaer",251902).npcSpawn(22,24).key(),fe=(new Item$$module$js$nodes(c,42,"Power Ring")).chest().bonus(),ge=(new Item$$module$js$nodes(c,43,"Warrior Ring")).fromPerson("Akahana's friend",84).dialog(84,void 0,2).bonus(),he=(new Item$$module$js$nodes(c,44,"Iron Necklace")).chest().bonus(),
ie=(new Item$$module$js$nodes(c,45,"Deo's Pendant")).fromPerson("Deo",90).dialog(90,void 0,0).bonus(),Ob=(new Item$$module$js$nodes(c,46,"Rabbit Boots")).bossDrop("Vampire 1",0).npcSpawn(192).key(),sc=((a,b)=>new Item$$module$js$nodes(c,a,b))(47,a.leatherBootsGiveSpeed()?"Speed Boots":"Leather Boots").chest().bonus(),tc=(new Item$$module$js$nodes(c,48,"Shield Ring")).direct("Akahana in waterfall cave",250543).bonus(),Pb=(new Item$$module$js$nodes(c,49,"Alarm Flute")).fromPerson("Zebu's student",20,
1).key(),uc=(new Item$$module$js$nodes(c,50,"Windmill Key")).fromPerson("Windmill guard",20).dialog(20,14,0).npcSpawn(20,14,1).key(),Qb=(new Item$$module$js$nodes(c,51,"Key to Prison")).chest().key(),vc=(new Item$$module$js$nodes(c,52,"Key to Styx")).fromPerson("Zebu in Shyron",94,1).trigger(128,2).dialog(94,242,0).dialog(98,242,0).key(),wc=(new Item$$module$js$nodes(c,53,"Fog Lamp")).chest().key(),Rb=(new Item$$module$js$nodes(c,54,"Shell Flute")).fromPerson("Dolphin",99,1).npcSpawn(99).key(),xc=
(new Item$$module$js$nodes(c,55,"Eye Glasses")).fromPerson("Clark",68).dialog(68,233,1).key(),yc=(new Item$$module$js$nodes(c,56,"Broken Statue")).bossDrop("Sabera 1",4).npcSpawn(127,101).npcSpawn(9).npcSpawn(10).npcSpawn(69).npcSpawn(70).npcSpawn(71).npcSpawn(132).npcSpawn(142).dialog(61).dialog(62).dialog(63).dialog(64).dialog(65).dialog(66).dialog(67).dialog(68,233).trigger(182).key(),zc=(new Item$$module$js$nodes(c,57,"Glowing Lamp")).direct("Kensu in lighthouse",250638).npcSpawn(126,98,1).key(),
Ac=(new Item$$module$js$nodes(c,59,"Love Pendant")).chest("Underground channel").invisible(254890).key(),Bc=(new Item$$module$js$nodes(c,60,"Kirisa Plant")).chest("Kirisa meadow").invisible(254886).key(),Sb=(new Item$$module$js$nodes(c,61,"Ivory Statue")).bossDrop("Karmine",9).npcSpawn(200).key(),Cc=(new Item$$module$js$nodes(c,62,"Bow of Moon")).fromPerson("Aryllis",35).direct(251624).dialog(35,void 0,1).key(),Dc=(new Item$$module$js$nodes(c,63,"Bow of Sun")).chest().key(),Ec=(new Item$$module$js$nodes(c,
64,"Bow of Truth")).fromPerson("Azteca",131).npcSpawn(131,156,1).dialog(131,void 0,0).key(),tb=(new Magic$$module$js$nodes(c,65,"Refresh")).fromPerson("Zebu at windmill",94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),kb=(new Magic$$module$js$nodes(c,66,"Paralysis")).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),Ga=(new Magic$$module$js$nodes(c,67,"Telepathy")).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),Fc=(new Magic$$module$js$nodes(c,
68,"Teleport")).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),je=(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),Gc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),Qa=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),K=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=aa.bossDrop("Vampire 2",
12,97).npcSpawn(204).key(),ba=new Item$$module$js$nodes(c,112,"Mimic"),Hc=(new Trigger$$module$js$nodes(c,"Talked to Leaf Elder")).get(H),Ic=(new Trigger$$module$js$nodes(c,"Talked to Leaf Student")).get(Pb),Tb=new Trigger$$module$js$nodes(c,"Talked to Zebu in cave"),le=(new Trigger$$module$js$nodes(c,"Woke up Windmill Guard")).get(uc),lb=new Trigger$$module$js$nodes(c,"Started Windmill"),Jc=(new Trigger$$module$js$nodes(c,"Learned Refresh")).get(tb),me=(new Trigger$$module$js$nodes(c,"Gave Statue to Akahana")).get(sb),
ne=(new Trigger$$module$js$nodes(c,"Fought Stom")).get(Ga),Kc=new Trigger$$module$js$nodes(c,"Visited Oak"),Lc=new Trigger$$module$js$nodes(c,"Talked to Oak Mother"),Ub=new Trigger$$module$js$nodes(c,"Rescued Oak Child"),oe=(new Trigger$$module$js$nodes(c,"Talked to Oak Mother Again")).get(rc),pe=(new Trigger$$module$js$nodes(c,"Talked to Oak Elder")).get(O),qe=(new Trigger$$module$js$nodes(c,"Talked to Tornel on Mt Sabre")).get(Fc),Mc=new Trigger$$module$js$nodes(c,"Villagers Abducted"),Nc=new Trigger$$module$js$nodes(c,
"Talked to Rabbit in Leaf"),re=(new Trigger$$module$js$nodes(c,"Learned Paralysis")).get(kb),Oc=new Trigger$$module$js$nodes(c,"Talked to Portoa Queen"),Pc=new Trigger$$module$js$nodes(c,"Talked to Fortune Teller"),Qc=new Trigger$$module$js$nodes(c,"Visited Underground Channel"),se=(new Trigger$$module$js$nodes(c,"Sent to Waterfall Cave")).get(Nb),te=(new Trigger$$module$js$nodes(c,"Cured Akahana")).get(tc),Rc=(new Trigger$$module$js$nodes(c,"Talked to Rage")).get(ma),Sc=new Trigger$$module$js$nodes(c,
"Mesia recording played"),Tc=(new Trigger$$module$js$nodes(c,"Talked to Asina")).get(je),Uc=(new Trigger$$module$js$nodes(c,"Healed Dolphin")).get(Rb),Vb=new Trigger$$module$js$nodes(c,"Returned Fog Lamp"),Vc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Cabin"),Wc=new Trigger$$module$js$nodes(c,"Talked to Joel Elder"),ue=(new Trigger$$module$js$nodes(c,"Talked to Clark")).get(xc),ve=(new Trigger$$module$js$nodes(c,"Talked to Kensu in Lighthouse")).get(zc),Wb=new Trigger$$module$js$nodes(c,"Calmed the Angry Sea"),
we=(new Trigger$$module$js$nodes(c,"Learned Barrier")).get(Gc),Xc=new Trigger$$module$js$nodes(c,"Talked to Stom in Swan Hut"),Yc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Swan tavern"),Zc=new Trigger$$module$js$nodes(c,"Talked to Kensu at Swan dance"),xe=(new Trigger$$module$js$nodes(c,"Returned Kensu's love pendant")).get(Qa),ye=(new Trigger$$module$js$nodes(c,"Talked to Amazones Queen")).get(Cc),Xb=new Trigger$$module$js$nodes(c,"Entered Shyron"),ze=(new Trigger$$module$js$nodes(c,"Talked to Zebu in Shyron")).get(vc),
$c=new Trigger$$module$js$nodes(c,"Shyron Massacre"),Ae=(new Trigger$$module$js$nodes(c,"Saved Kensu")).get(K),Be=(new Trigger$$module$js$nodes(c,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$js$nodes(c,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(c,"Get Bow of Truth")).get(Ec),Ee=(new Trigger$$module$js$nodes(c,"Forged Crystalis")).get(Ca),ub=(new Condition$$module$js$nodes(c,"Sword charge glitch")).option(v,y),Fe=(new Condition$$module$js$nodes(c,"Rabbit skip")).option(r,
x),Ge=(new Condition$$module$js$nodes(c,"Teleport skip")).option(p,q),vb=(new Condition$$module$js$nodes(c,"Statue glitch")).option(l,n),He=(new Condition$$module$js$nodes(c,"Wild warp")).option(C,B),wb=(new Condition$$module$js$nodes(c,"Any level 2 sword")).option(H,ea).option(H,V).option(O,Da).option(O,la).option(P,ma).option(P,fa).option(I,na).option(I,Ea),D=(new Condition$$module$js$nodes(c,"Destroy stone")).option(H,da).option(H,ea).option(H,V).option(ub,H,wb),E=(new Condition$$module$js$nodes(c,
"Destroy ice")).option(O,da).option(O,Da).option(O,la).option(ub,O,wb),z=(new Condition$$module$js$nodes(c,"Cross rivers")).option(P,da).option(P,ma).option(P,fa).option(K).option(ub,P,wb),Ya=(new Condition$$module$js$nodes(c,"Destroy iron")).option(I,da).option(I,na).option(I,Ea).option(ub,I,wb),ia=(new Condition$$module$js$nodes(c,"Any sword")).option(H).option(O).option(P).option(I),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(O).option(P).option(I).option(sb,
t.value?t:g,H),Je=(new Condition$$module$js$nodes(c,"Match vampire 2 sword (wind/water/thunder)")).option(H).option(P).option(I).option(t.value?t:g,O),ad=(new Condition$$module$js$nodes(c,"Speed boots")).option(sc,k),bd=(new Condition$$module$js$nodes(c,"Climb slopes")).option(Ob).option(K).option(ad),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Nc).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(Fc).option(Ge,K),cd=(new Condition$$module$js$nodes(c,
"Asina in her room")).option(Sc),Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(kb).option(cd).option(vb),dd=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(Rb,Vc),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(m,dd,Ob),wa=(new Condition$$module$js$nodes(c,"Cross sea")).option(dd).option(K),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Wb).option(K).option(Ne),ja=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(Oa.value?
Oa:g).option(tb),ed=(new Condition$$module$js$nodes(c,"Wind magic")).option(u.value?u:g,ja).option(ea,V,ja),fd=(new Condition$$module$js$nodes(c,"Fire magic")).option(u.value?u:g,ja).option(Da,la,ja),gd=(new Condition$$module$js$nodes(c,"Water magic")).option(u.value?u:g,ja).option(u,ja).option(ma,fa,ja),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(u.value?u:g,ja).option(u,ja).option(na,ja).option(Ea,ja),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(Nb).option(vb),
Re=(new Condition$$module$js$nodes(c,"Change or glitch")).option(Qa).option(vb),Se=(new Condition$$module$js$nodes(c,"Change or glitch or paralysis")).option(Qa).option(vb).option(kb),Yb=(new Condition$$module$js$nodes(c,"Pass shooting statues")).option(Gc).option(ia,Wa.value?Wa:g).option(tb,tc),Te=(new Condition$$module$js$nodes(c,"Healed dolphin if required")).option(Uc).option(N),hd=(new Condition$$module$js$nodes(c,"Match sword of wind")).option(H).option(t.value?t:g,ia),id=(new Condition$$module$js$nodes(c,
"Match sword of fire")).option(O).option(t.value?t:g,ia),jd=(new Condition$$module$js$nodes(c,"Match sword of water")).option(P).option(t.value?t:g,ia),Ue=(new Condition$$module$js$nodes(c,"Match sword of thunder")).option(I).option(t.value?t:g,ia),Ve=(new Condition$$module$js$nodes(c,"Swamp run possible")).option(ia,ad).option(ia,Ba).option(ia,tb),We=(new Condition$$module$js$nodes(c,"Insect possible to kill")).option(sb),xb=(new Condition$$module$js$nodes(c,"Travel swamp")).option(sb).option(T.value?
T:g,Ve),Xe=(new Condition$$module$js$nodes(c,"Calmed sea if required")).option(Wb).option(ib),Ye=(new Condition$$module$js$nodes(c,"Started windmill if required")).option(lb).option(va),Ze=(new Condition$$module$js$nodes(c,"Telepathy if required for Deo")).option(Ga).option(jb),$e=e(0,"Vampire 1",ia).get(Ob),af=e(1,"Insect",rc,Ie,We).get(Da),bf=e(2,"Kelbesque 1",hd,ed).get(la),cf=e(12,"Vampire 2",Je).get(ke),kd=e(4,"Sabera 1",id,fd).get(yc),df=e(5,"Mado 1",jd,gd).get(na),ef=e(6,"Kelbesque 2",hd,ed).get(Mb),
ff=e(7,"Sabera 2",id,fd).get(Lb),gf=e(8,"Mado 2",jd,gd).get(W),hf=e(9,"Karmine",Ue,Pe).get(Sb),jf=e(10,"Draygon 1",ia).get(ee),kf=e(-1,"Statues",Dc,Cc),lf=e(11,"Draygon 2",ia,Ec),mf=e(13,"Dyna",Ca),nf=(new Condition$$module$js$nodes(c,"Opened prison if required")).option(Qb).option(U),ra=new Area$$module$js$nodes(c,"Leaf"),Za=new Area$$module$js$nodes(c,"Valley of Wind"),ka=new Area$$module$js$nodes(c,"Sealed Cave"),Ra=new Area$$module$js$nodes(c,"Cordel Plain"),$a=new Area$$module$js$nodes(c,"Brynmaer"),
ab=new Area$$module$js$nodes(c,"Amazones"),L=new Area$$module$js$nodes(c,"Mt Sabre West"),A=new Area$$module$js$nodes(c,"Mt Sabre North"),yb=new Area$$module$js$nodes(c,"Nadare's"),mb=new Area$$module$js$nodes(c,"Oak"),Ha=new Area$$module$js$nodes(c,"Waterfall Valley"),J=new Area$$module$js$nodes(c,"Portoa"),Ia=new Area$$module$js$nodes(c,"Waterfall Cave"),M=new Area$$module$js$nodes(c,"Fog Lamp Cave"),Ja=new Area$$module$js$nodes(c,"Kirisa Plant Cave"),Sa=new Area$$module$js$nodes(c,"Angry Sea"),
Ka=new Area$$module$js$nodes(c,"Joel"),X=new Area$$module$js$nodes(c,"Evil Spirit Island"),La=new Area$$module$js$nodes(c,"Sabera's Castle"),sa=new Area$$module$js$nodes(c,"Swan"),G=new Area$$module$js$nodes(c,"Mt Hydra"),Ma=new Area$$module$js$nodes(c,"Shyron"),Ta=new Area$$module$js$nodes(c,"Styx"),Ua=new Area$$module$js$nodes(c,"Goa"),zb=new Area$$module$js$nodes(c,"Draygonia Fortress 1"),ta=new Area$$module$js$nodes(c,"Draygonia Fortress 2"),bb=new Area$$module$js$nodes(c,"Draygonia Fortress 3"),
ca=new Area$$module$js$nodes(c,"Draygonia Fortress 4"),S=new Area$$module$js$nodes(c,"Oasis Cave"),ua=new Area$$module$js$nodes(c,"Sahara"),cb=new Area$$module$js$nodes(c,"Pyramid Front"),xa=new Area$$module$js$nodes(c,"Pyramid Back"),ya=new Area$$module$js$nodes(c,"Tower"),Zb=(new Location$$module$js$nodes(c,0,ra,"Start")).overworld().start(),of=(new Location$$module$js$nodes(c,0,ra,"Mezame Shrine")).overworld().from(Zb),pf=(new Location$$module$js$nodes(c,1,ra,"Outside Start")).overworld().connect(of),
Na=(new Location$$module$js$nodes(c,2,ra,"Town")).town().connect(pf),nb=(new Location$$module$js$nodes(c,3,Za,"Main")).overworld().connect(Na).trigger(Jc,lb),ld=(new Location$$module$js$nodes(c,3,Za,"Outside Windmill")).overworld(),md=(new Location$$module$js$nodes(c,4,ka,"Tunnel 1 (entrance)")).cave().from(nb,lb),qf=(new Location$$module$js$nodes(c,5,ka,"Tunnel 2 (over bridge)")).cave().connect(md),rf=(new Location$$module$js$nodes(c,6,ka,"Tunnel 6 (herb dead end)")).cave().chest(R,15),nd=(new Location$$module$js$nodes(c,
7,ka,"Tunnel 4a (ball corridor)")).cave().chest(R,20,80).chest(ea,21);(new Location$$module$js$nodes(c,7,ka,"Tunnel 4b (antidote dead end)")).cave().connect(nd,D).chest(Z,19);const sf=(new Location$$module$js$nodes(c,8,ka,"Tunnel 5 (warp boots dead end)")).cave().chest(ha,14),tf=(new Location$$module$js$nodes(c,9,ka,"Tunnel 3a (branch, front)")).cave().connect(qf).connectTo(nd).connectTo(sf),uf=(new Location$$module$js$nodes(c,9,ka,"Tunnel 3b (branch, back)")).cave().connect(tf,D).connectTo(rf),vf=
(new Location$$module$js$nodes(c,10,ka,"Tunnel 7 (boss)")).cave().connect(uf).boss($e),wf=(new Location$$module$js$nodes(c,12,ka,"Tunnel 8a (exit, above wall)")).cave().connect(vf),xf=(new Location$$module$js$nodes(c,12,ka,"Tunnel 8b (exit, below wall")).cave().connect(wf,D);(new Location$$module$js$nodes(c,14,Za,"Windmill Cave")).cave().connect(nb).connectTo(ld).trigger(le,Pb,Tb);(new Location$$module$js$nodes(c,15,Za,"Windmill")).misc().connect(ld).trigger(lb,uc);const yf=(new Location$$module$js$nodes(c,
16,Za,"Zebu's Cave Front")).cave().connect(nb).trigger(Tb,Hc,Ic).trigger(Jc,lb,Tb),zf=(new Location$$module$js$nodes(c,16,Za,"Zebu's Cave Back")).cave().trigger(Mc).connect(yf,E),Af=(new Location$$module$js$nodes(c,17,L,"Tunnel 1 (to Zebu)")).cave().connect(zf),db=(new Location$$module$js$nodes(c,20,Ra,"West")).overworld().connect(xf,Ye),Bf=(new Location$$module$js$nodes(c,20,Ra,"South")).overworld().connect(db,z),od=(new Location$$module$js$nodes(c,21,Ra,"East")).overworld().connect(db).chest(qc,
24),ob=(new Location$$module$js$nodes(c,24,$a,"Town")).town().connect(db).trigger(me,qc),Cf=(new Location$$module$js$nodes(c,25,Ra,"Outside Stom's House")).town().connect(db),$b=(new Location$$module$js$nodes(c,26,Ra,"Swamp")).overworld().connect(od,xb).trigger(Ub,Lc,xb);(new Location$$module$js$nodes(c,26,Ra,"Swamp Insect Area")).overworld().connect($b,xb).boss(af);const Ab=(new Location$$module$js$nodes(c,27,ab,"Town")).town().connect(Bf),Bb=(new Location$$module$js$nodes(c,28,mb,"Town")).town().connect($b,
xb).trigger(Kc);(new Location$$module$js$nodes(c,30,Ra,"Stom's House")).house().connect(Cf).trigger(ne,Kc);const eb=(new Location$$module$js$nodes(c,32,L,"Entrance")).overworld().connect(db).connect(Af),Df=(new Location$$module$js$nodes(c,32,L,"Up Slope")).overworld().from(eb,bd).to(eb),Ef=(new Location$$module$js$nodes(c,32,L,"Dead End (warp boots)")).overworld().chest(ha,24,106),pd=(new Location$$module$js$nodes(c,33,L,"Upper")).overworld().from(eb,K).to(eb),Ff=(new Location$$module$js$nodes(c,
33,L,"Tornel Dead End")).overworld().trigger(qe,ea,V).chest(qa,23,105),qd=(new Location$$module$js$nodes(c,34,L,"Tunnel 2a (fork at start)")).cave().connect(eb);(new Location$$module$js$nodes(c,34,L,"Tunnel 2b (left branch to dead end)")).cave().connect(qd,E).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,L,"Tunnel 2c (right branch to upper)")).cave().connect(qd,E),Hf=(new Location$$module$js$nodes(c,35,L,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(R,23,82),
If=(new Location$$module$js$nodes(c,35,L,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,E).connectTo(pd),rd=(new Location$$module$js$nodes(c,36,L,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,L,"Tunnel 4b (out to upper)")).cave().connect(rd,E).connectTo(pd);const Jf=(new Location$$module$js$nodes(c,37,L,"Tunnel 5 (tiny connector)")).cave().connect(rd),Kf=(new Location$$module$js$nodes(c,38,L,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);
(new Location$$module$js$nodes(c,38,L,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,E).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,L,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,L,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,E);(new Location$$module$js$nodes(c,39,L,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,E).chest(V,25);const Cb=(new Location$$module$js$nodes(c,40,A,"Entrance")).overworld().connect(od,
Le,Ke),Db=(new Location$$module$js$nodes(c,40,A,"Upper")).overworld().from(Cb,K).to(Cb),ac=(new Location$$module$js$nodes(c,40,A,"Summit (boss)")).overworld().from(Db,K).to(Db).boss(bf),sd=(new Location$$module$js$nodes(c,41,A,"Connector")).overworld(),bc=(new Location$$module$js$nodes(c,41,A,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,A,"Middle Right")).overworld().from(bc,bd).to(bc),td=(new Location$$module$js$nodes(c,42,A,"Tunnel 2a (from entrance to connector)")).cave().connectTo(sd);
(new Location$$module$js$nodes(c,42,A,"Tunnel 2b (under bridge, to antidote)")).cave().connect(td,E).chest(Z,23,94);const ud=(new Location$$module$js$nodes(c,43,A,"Tunnel 3a (branch after connector)")).cave().connect(sd),Of=(new Location$$module$js$nodes(c,43,A,"Tunnel 3b (right branch)")).cave().connect(ud,E),Pf=(new Location$$module$js$nodes(c,43,A,"Tunnel 3c (upper branch)")).cave().connect(ud,E);(new Location$$module$js$nodes(c,44,A,"Tunnel 4 (over bridge, to middle)")).cave().connect(Pf).connectTo(bc);
const vd=(new Location$$module$js$nodes(c,45,A,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Of).connectTo(Nf);(new Location$$module$js$nodes(c,45,A,"Tunnel 5b (dead-end with herb)")).cave().connect(vd,E).chest(R,22,83);const Qf=(new Location$$module$js$nodes(c,46,A,"Tunne; 6a (S-shaped hall, right)")).cave().connect(vd),Rf=(new Location$$module$js$nodes(c,46,A,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Qf,E),Sf=(new Location$$module$js$nodes(c,46,A,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Rf,
E),wd=(new Location$$module$js$nodes(c,47,A,"Prison (hallway)")).cave().connect(Db),Tf=(new Location$$module$js$nodes(c,48,A,"Left Cell (shopkeepers)")).cave().from(wd,E);(new Location$$module$js$nodes(c,49,A,"Left Cell 2 (back, with prison key)")).cave().from(Tf,E).chest(Qb,13);const Uf=(new Location$$module$js$nodes(c,50,A,"Right Cell (villagers)")).cave().from(wd,E),Vf=(new Location$$module$js$nodes(c,51,A,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Uf,E);(new Location$$module$js$nodes(c,
52,A,"Tunnel 9 (connector to summit)")).cave().connect(Vf).connectTo(ac);const Wf=(new Location$$module$js$nodes(c,53,A,"Summit Cave (front)")).cave().from(ac,Qb).to(ac),Xf=(new Location$$module$js$nodes(c,53,A,"Summit Cave (behind ice)")).cave().connect(Wf,E).trigger(re);(new Location$$module$js$nodes(c,56,A,"Tunnel 1 (leads from main entrance)")).cave().connect(Cb).connectTo(td);(new Location$$module$js$nodes(c,57,A,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(Db);const Yf=(new Location$$module$js$nodes(c,
60,yb,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,yb,"Tool Shop")).shop(R,Z,aa,ha),$f=(new Location$$module$js$nodes(c,62,yb,"Back Room")).house(),cc=(new Location$$module$js$nodes(c,64,Ha,"Summit")).overworld().connect(Xf,nf),Eb=(new Location$$module$js$nodes(c,64,Ha,"Northwest")).overworld().from(cc).to(cc,K),ag=(new Location$$module$js$nodes(c,64,Ha,"Northeast")).overworld().connect(Eb,z),xd=(new Location$$module$js$nodes(c,65,Ha,"Southwest")).overworld().connect(Eb),bg=(new Location$$module$js$nodes(c,
65,Ha,"Southeast")).overworld().connect(xd,z),yd=(new Location$$module$js$nodes(c,66,Ha,"Lime Tree Valley")).overworld().connect(xd).connect(nb,Y),cg=(new Location$$module$js$nodes(c,67,Ha,"Lime Tree Lake (Rage)")).cave().connect(yd).trigger(Rc,P),dg=(new Location$$module$js$nodes(c,68,Ja,"Tunnel 1a (entrance)")).cave().connect(bg),eg=(new Location$$module$js$nodes(c,68,Ja,"Tunnel 1b (behind wall)")).cave().connect(dg,D),zd=(new Location$$module$js$nodes(c,69,Ja,"Tunnel 2a (main path, before wall)")).cave().connect(eg);
(new Location$$module$js$nodes(c,69,Ja,"Tunnel 2b (dead end, antidote)")).cave().connect(zd,D).chest(Z,25,95);const fg=(new Location$$module$js$nodes(c,69,Ja,"Tunnel 2c (main path, after wall)")).cave().connect(zd,D),gg=(new Location$$module$js$nodes(c,70,Ja,"Tunnel 3a (last room, before wall)")).cave().connect(fg),hg=(new Location$$module$js$nodes(c,70,Ja,"Tunnel 3b (last room, after wall)")).cave().connect(gg,D);(new Location$$module$js$nodes(c,71,Ja,"Meadow")).overworld().connect(hg).chest(Bc,
14);const ig=(new Location$$module$js$nodes(c,72,M,"Tunnel 1a (entrance)")).cave().connect(ag),Ad=(new Location$$module$js$nodes(c,72,M,"Tunnel 1b (past wall)")).cave().connect(ig,D);(new Location$$module$js$nodes(c,72,M,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(Ad,D).chest(Xa,24);const jg=(new Location$$module$js$nodes(c,73,M,"Tunnel 2 (tiny connector)")).cave().connect(Ad),Bd=(new Location$$module$js$nodes(c,74,M,"Tunnel 3a (upper branch)")).cave().connect(jg);(new Location$$module$js$nodes(c,
74,M,"Tunnel 3b (dead end, mimic)")).cave().connect(Bd,D).chest(ba,21,112);const Cd=(new Location$$module$js$nodes(c,74,M,"Tunnel 3c (short passage with mimic)")).cave().connect(Bd,D).chest(ba,22,113),kg=(new Location$$module$js$nodes(c,74,M,"Tunnel 3d (lower branch)")).cave().connect(Cd,D);(new Location$$module$js$nodes(c,75,M,"Dead end loop")).cave().connect(kg);const Dd=(new Location$$module$js$nodes(c,76,M,"Tunnel 4a (right branch over bridge)")).cave().connect(Cd),lg=(new Location$$module$js$nodes(c,
76,M,"Tunnel 4b (past wall over bridge)")).cave().connect(Dd,D),mg=(new Location$$module$js$nodes(c,77,M,"Tunnel 5a (from left branch)")).cave().connect(Dd),ng=(new Location$$module$js$nodes(c,77,M,"Tunnel 5b (reconvergence)")).cave().connect(mg,D).connect(lg),og=(new Location$$module$js$nodes(c,77,M,"Tunnel 5c (between walls)")).cave().connect(ng,D),pg=(new Location$$module$js$nodes(c,77,M,"Tunnel 5d (under bridge)")).cave().connect(og,D),qg=(new Location$$module$js$nodes(c,78,M,"Tunnel 6a (over second bridge)")).cave().connect(pg),
rg=(new Location$$module$js$nodes(c,78,M,"Tunnel 6b (past wall)")).cave().connect(qg,D),sg=(new Location$$module$js$nodes(c,79,M,"Tunnel 7a (under second bridge)")).cave().connect(rg);(new Location$$module$js$nodes(c,79,M,"Tunnel 7b (fog lamp)")).cave().connect(sg,D).chest(wc,19);const Va=(new Location$$module$js$nodes(c,80,J,"Town")).town().connect(Eb),Ed=(new Location$$module$js$nodes(c,81,J,"Fishherman Island")).town().connect(Va);(new Location$$module$js$nodes(c,82,Ha,"Mesia Shrine")).cave().trigger(Sc).connect(cg,
z,Rc);const Fd=(new Location$$module$js$nodes(c,84,Ia,"Tunnel 1a (entrance)")).cave().connect(Eb);(new Location$$module$js$nodes(c,84,Ia,"Tunnel 1b (dead end, mimic)")).cave().connect(Fd,E).chest(ba,19,114);const tg=(new Location$$module$js$nodes(c,84,Ia,"Tunnel 1c (past ice)")).cave().connect(Fd,E),ug=(new Location$$module$js$nodes(c,85,Ia,"Tunnel 2 (stoned pair)")).cave().connect(tg),dc=(new Location$$module$js$nodes(c,86,Ia,"Tunnel 3 (wide medusa hallways)")).cave().connect(ug,Qe),vg=(new Location$$module$js$nodes(c,
87,Ia,"Tunnel 4a (left entrance)")).cave().from(dc,E).chest(rb.chest().bonus(),25).trigger(te,Nb);(new Location$$module$js$nodes(c,87,Ia,"Tunnel 4b (right entrance)")).cave().from(dc,E).connect(vg,K);(new Location$$module$js$nodes(c,87,Ia,"Tunnel 4c (sword of water)")).cave().connect(dc,E).chest(P,24);const Gd=(new Location$$module$js$nodes(c,88,ya,"Entrance")).misc(),wg=(new Location$$module$js$nodes(c,89,ya,"Level 1")).misc().from(Gd),xg=(new Location$$module$js$nodes(c,90,ya,"Level 2")).misc().from(wg),
yg=(new Location$$module$js$nodes(c,91,ya,"Level 3")).misc().from(xg),Hd=(new Location$$module$js$nodes(c,92,ya,"Outside Mesia Room")).misc().from(yg),zg=(new Location$$module$js$nodes(c,93,ya,"Outside Dyna Room")).misc().from(Hd,Ca);(new Location$$module$js$nodes(c,94,ya,"Mesia")).misc().connect(Hd).trigger(Ee);const Ag=(new Location$$module$js$nodes(c,95,ya,"Dyna")).misc().from(zg).boss(mf);(new Location$$module$js$nodes(c,95,ya,"Win")).misc().from(Ag).end();const ec=(new Location$$module$js$nodes(c,
96,Sa,"Cabin Beach")).sea().from(Ed,Vb),fb=(new Location$$module$js$nodes(c,96,Sa,"South")).sea().connect(ec,wa),Bg=(new Location$$module$js$nodes(c,96,Sa,"Joel Beach")).sea().connect(fb,wa),Id=(new Location$$module$js$nodes(c,96,Ka,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(c,96,Sa,"Altar")).sea().connect(fb,wa).trigger(Wb,zc,yc);const Cg=(new Location$$module$js$nodes(c,96,Sa,"North")).sea().to(fb,wa).from(fb,wa,Oe).trigger(we,Xe),Dg=(new Location$$module$js$nodes(c,96,Sa,"Swan Beach")).sea().connect(Cg,
wa);(new Location$$module$js$nodes(c,97,Sa,"Cabin")).misc().connect(ec).trigger(Vc,Vb);(new Location$$module$js$nodes(c,98,Ka,"Lighthouse")).misc().connect(Id).trigger(ve,Pb);const Fb=(new Location$$module$js$nodes(c,100,J,"Underground Channel 1 (from throne room)")).sea().trigger(Qc),Eg=(new Location$$module$js$nodes(c,100,J,"Underground Channel 2 (to fortune teller)")).sea().connect(Fb,z),Jd=(new Location$$module$js$nodes(c,100,J,"Underground Channel 3 (from fortune teller)")).sea().connect(Fb,
K),Kd=(new Location$$module$js$nodes(c,100,J,"Underground Channel 4 (asina)")).sea().connect(Jd,z),Fg=(new Location$$module$js$nodes(c,100,J,"Underground Channel 5 (dolphin)")).sea().connect(Kd,z).trigger(Uc,R,Tc);(new Location$$module$js$nodes(c,100,J,"Underground Channel 6 (water)")).sea().connect(Fg,wa).connectTo(fb,wa).chest(Ac,17);const fc=(new Location$$module$js$nodes(c,101,X,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,X,"Tunnel 1 (entrance)")).sea().connect(fb,Wc,wa),Ld=
(new Location$$module$js$nodes(c,105,X,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,X,"Tunnel 2b (dead end to left)")).cave().connect(Ld,z);const Hg=(new Location$$module$js$nodes(c,105,X,"Tunnel 2c (across first river)")).cave().connect(Ld,z),Md=(new Location$$module$js$nodes(c,105,X,"Tunnel 2d (across second river)")).cave().connect(Hg,z);(new Location$$module$js$nodes(c,105,X,"Tunnel 2e (dead end, magic ring)")).cave().connect(Md,D).chest(qa,29);const Ig=(new Location$$module$js$nodes(c,
105,X,"Tunnel 2f (stair down)")).cave().connect(Md,D),Jg=(new Location$$module$js$nodes(c,106,X,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(fc).chest(Xa,25,92),Kg=(new Location$$module$js$nodes(c,106,X,"Tunnel 3b (left area toward items)")).cave().connect(Jg,D),Lg=(new Location$$module$js$nodes(c,107,X,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(ba,14,115);(new Location$$module$js$nodes(c,107,X,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,z).chest(he,15);const gc=
(new Location$$module$js$nodes(c,108,La,"Floor 1")).fortress().connect(fc),Mg=(new Location$$module$js$nodes(c,108,La,"Miniboss")).fortress().boss(cf).connect(gc);(new Location$$module$js$nodes(c,109,La,"Floor 2a (left stair)")).fortress().connect(gc).chest(aa,19);const Ng=(new Location$$module$js$nodes(c,109,La,"Floor 2b (right stair)")).fortress().connect(Mg).chest(R,30,85),Og=(new Location$$module$js$nodes(c,110,La,"Floor 3a (toward boss)")).fortress().connect(Ng),Nd=(new Location$$module$js$nodes(c,
110,La,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$js$nodes(c,110,La,"Boss")).fortress().boss(kd).connect(Nd);(new Location$$module$js$nodes(c,110,La,"Floor 3c (back room trap)")).fortress().from(Nd).to(gc);const Pg=(new Location$$module$js$nodes(c,112,Ka,"Secret Passage")).cave().connectTo(Id),Gb=(new Location$$module$js$nodes(c,113,Ka,"Town")).town().connect(Bg),za=(new Location$$module$js$nodes(c,114,sa,"Town")).town().connect(Dg),Qg=(new Location$$module$js$nodes(c,115,
sa,"Inside Gate")).overworld().connect(za),Rg=(new Location$$module$js$nodes(c,115,sa,"Outside Gate")).overworld().from(Qg,Qa),Hb=(new Location$$module$js$nodes(c,120,Ua,"Valley")).overworld().connect(Rg),hc=(new Location$$module$js$nodes(c,124,G,"Entrance")).overworld().connect(Hb),Sg=(new Location$$module$js$nodes(c,124,G,"Over first river toward Shyron")).overworld().connect(hc,z),Od=(new Location$$module$js$nodes(c,124,G,"After first tunnel")).overworld(),Pd=(new Location$$module$js$nodes(c,124,
G,"Door to Styx")).overworld().connect(Od,z),Tg=(new Location$$module$js$nodes(c,124,G,"Dead end (no item)")).overworld(),Ug=(new Location$$module$js$nodes(c,124,G,"Dead end (fruit of lime)")).overworld().chest(Kb,26),Vg=(new Location$$module$js$nodes(c,124,G,"Dead end (magic ring)")).overworld().chest(qa,25,101),Qd=(new Location$$module$js$nodes(c,124,G,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(c,124,G,"Floating island (bow of sun)")).overworld().connect(Qd,K).chest(Dc,
24);const Wg=(new Location$$module$js$nodes(c,125,G,"Tunnel 1 (to Shyron)")).cave().connect(Sg),Xg=(new Location$$module$js$nodes(c,126,G,"Outside Shyron")).overworld().connect(Wg);(new Location$$module$js$nodes(c,127,G,"Tunnel 2 (fork)")).cave().connect(hc).connectTo(Ug).connectTo(Od);const Rd=(new Location$$module$js$nodes(c,128,G,"Tunnel 3 (caves)")).cave().connect(Pd).connect(Tg),Sd=(new Location$$module$js$nodes(c,129,G,"Tunnel 4 (left branch of cave)")).cave().connect(Rd);(new Location$$module$js$nodes(c,
130,G,"Tunnel 5 (dead end, medical herb)")).cave().connect(Sd).chest(R,15,86);const Yg=(new Location$$module$js$nodes(c,131,G,"Tunnel 6a (left-then-right)")).cave().connect(Sd),Zg=(new Location$$module$js$nodes(c,131,G,"Tunnel 6b (past wall)")).cave().connect(Yg,D),$g=(new Location$$module$js$nodes(c,132,G,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,G,"Tunnel 8 (red slimes)")).cave().from($g,D).connectTo(Qd).chest(ba,23,116);const ah=(new Location$$module$js$nodes(c,
134,G,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Rd),bh=(new Location$$module$js$nodes(c,135,G,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,135,G,"Tunnel 10b (past wall)")).cave().connect(bh,D).connectTo(Vg);const Td=(new Location$$module$js$nodes(c,136,Ta,"Entrance")).fortress().from(Pd,vc,Yb),ch=(new Location$$module$js$nodes(c,137,Ta,"Left branch")).fortress().connect(Td).chest(ba,19,117),dh=(new Location$$module$js$nodes(c,137,Ta,"Left branch, past one bridge")).fortress().connect(ch,
z),eh=(new Location$$module$js$nodes(c,137,Ta,"Left branch, past two bridges")).fortress().connect(dh,z).chest(R,29,87),fh=(new Location$$module$js$nodes(c,137,Ta,"Right branch")).fortress().connect(Td);(new Location$$module$js$nodes(c,137,Ta,"Right branch, across water")).fortress().connect(fh,K).chest(ba,20,118).chest(ba,21,119).chest(pa,28);(new Location$$module$js$nodes(c,138,Ta,"Upper floor")).fortress().connect(eh).chest(I,27);const gb=(new Location$$module$js$nodes(c,140,Ma,"Town")).town().connect(Xg,
Re).trigger(Xb),pb=(new Location$$module$js$nodes(c,142,Ua,"Town")).town().connect(Hb),Ud=(new Location$$module$js$nodes(c,143,S,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,S,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Ud,Ya).chest(fe,15);const ic=(new Location$$module$js$nodes(c,144,Ua,"Desert 1")).overworld().connect(Hb),Ib=(new Location$$module$js$nodes(c,145,S,"Area 1 (from entrance)")).cave().chest(sc,26),Vd=(new Location$$module$js$nodes(c,
145,S,"Area 2 (across top bridge)")).cave().connect(Ib,z);(new Location$$module$js$nodes(c,145,S,"Area 3 (dead-end across top-right bridge)")).cave().connect(Vd,z);const gh=(new Location$$module$js$nodes(c,145,S,"Area 4 (left across middle-right bridge)")).cave().connect(Vd,z),hh=(new Location$$module$js$nodes(c,145,S,"Area 5 (bottom edge)")).cave().connect(gh,z),ih=(new Location$$module$js$nodes(c,145,S,"Area 6 (bottom island)")).cave().connect(hh,z),jh=(new Location$$module$js$nodes(c,145,S,"Area 7 (bottom inner ring)")).cave().connect(ih,
z),kh=(new Location$$module$js$nodes(c,145,S,"Area 8 (left outer ring)")).cave().connect(jh,z).connect(Ib,z).chest(aa,27,100),lh=(new Location$$module$js$nodes(c,145,S,"Area 9 (top left inner ring)")).cave().connect(kh,z),mh=(new Location$$module$js$nodes(c,145,S,"Area 10 (top right inner ring)")).cave().connect(lh,z);(new Location$$module$js$nodes(c,145,S,"Area 11 (center)")).cave().connect(mh,z).connectTo(Ud);(new Location$$module$js$nodes(c,145,S,"Area 12 (top center islands)")).cave().connect(Ib,
K).chest(de,28);const nh=(new Location$$module$js$nodes(c,146,ua,"Desert Cave 1")).cave().connect(ic,K),hb=(new Location$$module$js$nodes(c,147,ua,"Town")).town(),oh=(new Location$$module$js$nodes(c,148,ua,"Outside Cave")).overworld().connect(hb),ph=(new Location$$module$js$nodes(c,149,ua,"Desert Cave 2")).cave().connect(oh);(new Location$$module$js$nodes(c,150,ua,"Meadow")).overworld().connect(nh).connectTo(hb).trigger(Be,Qa,Ze);const jc=(new Location$$module$js$nodes(c,152,ua,"Desert 2")).overworld().connect(ph),
qh=(new Location$$module$js$nodes(c,156,cb,"Entrance")).fortress().connect(jc,K),rh=(new Location$$module$js$nodes(c,156,cb,"Azteca")).fortress().trigger(De),sh=(new Location$$module$js$nodes(c,157,cb,"Fork")).fortress().connect(qh),Wd=(new Location$$module$js$nodes(c,158,cb,"Main")).fortress().connect(sh);(new Location$$module$js$nodes(c,158,cb,"Treasure Chest (magic ring)")).fortress().connect(Wd).chest(qa,27,108);(new Location$$module$js$nodes(c,159,cb,"Draygon")).fortress().connect(Wd).to(rh).boss(jf);
const th=(new Location$$module$js$nodes(c,160,xa,"Entrance")).fortress().connect(jc,K),uh=(new Location$$module$js$nodes(c,160,xa,"Statues")).fortress().connect(th).boss(kf),vh=(new Location$$module$js$nodes(c,161,xa,"Hall 1")).fortress().connect(uh),kc=(new Location$$module$js$nodes(c,162,xa,"Branch")).fortress().connect(vh);(new Location$$module$js$nodes(c,163,xa,"Left Dead End")).fortress().connect(kc).chest(ba,13,120);(new Location$$module$js$nodes(c,164,xa,"Right Dead End")).fortress().connect(kc);
const wh=(new Location$$module$js$nodes(c,165,xa,"Hall 2")).fortress().connect(kc).chest(Mb,26,109),xh=(new Location$$module$js$nodes(c,166,xa,"Draygon 2")).fortress().connect(wh).boss(lf);(new Location$$module$js$nodes(c,167,xa,"Teleporter")).fortress().from(xh).to(Gd);const Xd=(new Location$$module$js$nodes(c,168,zb,"Entrance")).fortress().connect(pb,Yb).trigger($c,I),yh=(new Location$$module$js$nodes(c,169,zb,"Main")).fortress().from(Xd,Ya),zh=(new Location$$module$js$nodes(c,169,zb,"Boss")).fortress().connect(yh).boss(ef),
Ah=(new Location$$module$js$nodes(c,170,zb,"Zebu")).fortress().connect(zh),Jb=(new Location$$module$js$nodes(c,171,ta,"Entrance")).fortress().connect(Ah);(new Location$$module$js$nodes(c,171,ta,"Dead End Behind Iron (fruit of power)")).fortress().connect(Jb,Ya).chest(aa,28,98);(new Location$$module$js$nodes(c,171,ta,"Dead End Loop Across Closer Bridges")).fortress().connect(Jb,z).connect(Jb,z);const Bh=(new Location$$module$js$nodes(c,171,ta,"Across First Bridge (fruit of repun)")).fortress().connect(Jb,
z).chest(Lb,30,102),lc=(new Location$$module$js$nodes(c,171,ta,"Across Second Bridge")).fortress().connect(Bh,z);(new Location$$module$js$nodes(c,171,ta,"Dead End Across Two Bridges ()")).fortress().connect(lc,z).connect(lc,z).chest(Xa,29,93);const Ch=(new Location$$module$js$nodes(c,171,ta,"Across Third Bridge")).fortress().connect(lc,z),Dh=(new Location$$module$js$nodes(c,171,ta,"Exit Behind Iron Door")).fortress().connect(Ch,Ya),Eh=(new Location$$module$js$nodes(c,172,ta,"Boss")).fortress().connect(Dh).boss(ff),
Fh=(new Location$$module$js$nodes(c,172,ta,"Tornel")).fortress().connect(Eh),Yd=(new Location$$module$js$nodes(c,173,bb,"Lower")).fortress().connect(Fh).chest(Mb,26,99).chest(qa,27,111),Gh=(new Location$$module$js$nodes(c,174,bb,"Upper Loop")).fortress().connect(Yd).chest(Z,22,96);(new Location$$module$js$nodes(c,174,bb,"Upper Loop Behind Wall (magic ring)")).fortress().connect(Gh,Ya).chest(qa,23,107);const Hh=(new Location$$module$js$nodes(c,175,bb,"Upper Passage (toward Mado)")).fortress().connect(Yd).chest(qa,
27,84),mc=(new Location$$module$js$nodes(c,176,ca,"Initial Fork")).fortress(),Ih=(new Location$$module$js$nodes(c,177,ca,"Left Branch")).fortress().connect(mc),Zd=(new Location$$module$js$nodes(c,178,ca,"Main Area (right branch, over bridges)")).fortress().connect(mc),Jh=(new Location$$module$js$nodes(c,179,ca,"U-shaped Passage (between floors)")).fortress().connect(Zd),Kh=(new Location$$module$js$nodes(c,180,ca,"Main Area Lower (under bridge)")).fortress().connect(Ih).connect(Zd).connect(Jh),$d=
(new Location$$module$js$nodes(c,180,ca,"Behind Iron Wall")).fortress().connect(Kh,Ya),Lh=(new Location$$module$js$nodes(c,181,ca,"Lower")).fortress().connect($d).chest(ba,13,121).chest(ba,14,122).chest(ba,15,123).chest(qa,23,88).chest(ha,24,110),Mh=(new Location$$module$js$nodes(c,182,ca,"Boss Corridor")).fortress().connect(Lh),Nh=(new Location$$module$js$nodes(c,182,ca,"Boss")).fortress().connect(Mh,Yb).boss(hf);(new Location$$module$js$nodes(c,182,ca,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(Ea,
18);const ae=(new Location$$module$js$nodes(c,183,ca,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,184,S,"Entrance Back (behind river)")).cave().connect(ae).chest(aa,13,90);(new Location$$module$js$nodes(c,184,S,"Entrance Front")).cave().connect(Oh,K).connectTo(ic).connectTo(Ib);const Ph=(new Location$$module$js$nodes(c,185,bb,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$js$nodes(c,185,bb,"Asina")).fortress().connect(Ph).connectTo(mc);(new Location$$module$js$nodes(c,
186,ca,"Kensu")).fortress().connect($d).connectTo(ae).trigger(Ae,Sb);(new Location$$module$js$nodes(c,187,Ua,"House")).house().connect(pb).trigger(Ce,Qa,Sb);(new Location$$module$js$nodes(c,188,Ua,"Inn")).shop().connect(pb,Xb);(new Location$$module$js$nodes(c,190,Ua,"Tool Shop")).shop(R,Z,ha,aa).connect(pb,Xb);(new Location$$module$js$nodes(c,191,Ua,"Tavern")).shop().connect(pb);(new Location$$module$js$nodes(c,192,ra,"Elder House")).house().connect(Na).trigger(Hc);(new Location$$module$js$nodes(c,
193,ra,"Rabbit Hut")).house().connect(Na).trigger(Nc,Mc,Ga);(new Location$$module$js$nodes(c,194,ra,"Inn")).shop().connect(Na);(new Location$$module$js$nodes(c,195,ra,"Tool Shop")).shop(R,Z,ha,aa).connect(Na);(new Location$$module$js$nodes(c,196,ra,"Armor Shop")).shop(Pa,oa).connect(Na);(new Location$$module$js$nodes(c,197,ra,"Student House")).house().connect(Na).trigger(Ic);(new Location$$module$js$nodes(c,198,$a,"Tavern")).house().connect(ob);(new Location$$module$js$nodes(c,199,$a,"Pawn Shop")).shop().connect(ob);
(new Location$$module$js$nodes(c,200,$a,"Inn")).shop().connect(ob);(new Location$$module$js$nodes(c,201,$a,"Armor Shop")).shop(Fa,oa,w).connect(ob);(new Location$$module$js$nodes(c,203,$a,"Tool Shop")).shop(R,Z,ha).connect(ob);(new Location$$module$js$nodes(c,205,mb,"Elder House")).house().from(Bb,Ga).trigger(pe,Ub);(new Location$$module$js$nodes(c,206,mb,"Mother's House")).house().from(Bb,Ga).trigger(Lc,Ga).trigger(oe,Ub);(new Location$$module$js$nodes(c,207,mb,"Tool Shop")).shop(R,Z,aa).from(Bb,
Ga);(new Location$$module$js$nodes(c,208,mb,"Inn")).shop().from(Bb,Ga);(new Location$$module$js$nodes(c,209,ab,"Inn")).shop().connect(Ab);(new Location$$module$js$nodes(c,210,ab,"Tool Shop")).shop(ha,aa,Xa).connect(Ab);(new Location$$module$js$nodes(c,211,ab,"Armor Shop")).shop(oc,qb,rb,W).connect(Ab);const Qh=(new Location$$module$js$nodes(c,212,ab,"Queen's House")).house().from(Ab,Se).trigger(ye,Qa,Bc);(new Location$$module$js$nodes(c,213,yb,"Nadare's")).house().connect(Cb).connectTo(Yf).connectTo(Zf).connectTo($f);
(new Location$$module$js$nodes(c,214,J,"Fisherman's House")).house().connect(Ed).trigger(Vb,wc,Rb,Te);const nc=(new Location$$module$js$nodes(c,215,J,"Palace Entrance")).house().connect(Va);(new Location$$module$js$nodes(c,216,J,"Fortune Teller Front")).house().connect(Va).trigger(Pc,Oc);(new Location$$module$js$nodes(c,216,J,"Fortune Teller Back")).house().connect(Eg).connect(Jd);(new Location$$module$js$nodes(c,217,J,"Pawn Shop")).shop().connect(Va);(new Location$$module$js$nodes(c,218,J,"Armor Shop")).shop(be,
oc,qb).connect(Va);(new Location$$module$js$nodes(c,220,J,"Inn")).shop().connect(Va);(new Location$$module$js$nodes(c,221,J,"Tool Shop")).shop(R,Xa,Kb,ha).connect(Va);(new Location$$module$js$nodes(c,222,J,"Palace Left")).house().connect(nc);(new Location$$module$js$nodes(c,223,J,"Palace Throne Room")).house().connect(nc).to(Fb,Me).from(Fb).trigger(Oc).trigger(se,Pc,Qc);(new Location$$module$js$nodes(c,224,J,"Palace Right")).house().connect(nc);(new Location$$module$js$nodes(c,225,J,"Asina's Room")).house().connect(Kd).trigger(Tc,
cd);(new Location$$module$js$nodes(c,226,ab,"Queen Downstairs")).house().connect(Qh).chest(fa,13);(new Location$$module$js$nodes(c,227,Ka,"Elder's House")).house().connect(Gb).trigger(Wc);(new Location$$module$js$nodes(c,228,Ka,"Shed")).house().connect(Gb).to(Pg,xc);(new Location$$module$js$nodes(c,229,Ka,"Tool Shop")).shop(R,Z,aa,Xa).connect(Gb);(new Location$$module$js$nodes(c,231,Ka,"Inn")).shop().connect(Gb);const Rh=(new Location$$module$js$nodes(c,232,X,"Zombie Town House")).house().connect(fc);
(new Location$$module$js$nodes(c,233,X,"Zombie Town Basement")).house().connect(Rh).trigger(ue,kd);(new Location$$module$js$nodes(c,235,sa,"Tool Shop")).shop(R,Z,aa,ha).connect(za);(new Location$$module$js$nodes(c,236,sa,"Stom's Hut")).house().connect(za).trigger(Xc);(new Location$$module$js$nodes(c,237,sa,"Inn")).shop().connect(za);(new Location$$module$js$nodes(c,238,sa,"Armor Shop")).shop(ce,pc,F,Q).connect(za);(new Location$$module$js$nodes(c,239,sa,"Tavern")).house().connect(za).trigger(Yc,Xc,
kb);(new Location$$module$js$nodes(c,240,sa,"Pawn Shop")).shop().connect(za);(new Location$$module$js$nodes(c,241,sa,"Dance Hall")).house().connect(za).trigger(Zc,Yc,kb).trigger(xe,Zc,Ac);const Sh=(new Location$$module$js$nodes(c,242,Ma,"Temple (pre-massacre)")).fortress().connect(gb).from(Zb,I,Aa).trigger(ze);(new Location$$module$js$nodes(c,242,Ma,"Temple (post-massacre)")).fortress().from(Sh,$c).boss(df);(new Location$$module$js$nodes(c,243,Ma,"Training Hall")).house().connect(gb);(new Location$$module$js$nodes(c,
244,Ma,"Hospital")).house().connect(gb);(new Location$$module$js$nodes(c,245,Ma,"Armor Shop")).shop(pc,W,Q).connect(gb);(new Location$$module$js$nodes(c,246,Ma,"Tool Shop")).shop(R,Z,Kb,qa).connect(gb);(new Location$$module$js$nodes(c,247,Ma,"Inn")).shop().connect(gb);(new Location$$module$js$nodes(c,248,ua,"Inn")).shop().connect(hb);(new Location$$module$js$nodes(c,249,ua,"Tool Shop")).shop(Z,ha,Lb,qa).connect(hb);(new Location$$module$js$nodes(c,250,ua,"Elder's House")).house().connect(hb);(new Location$$module$js$nodes(c,
251,ua,"Pawn Shop")).house().connect(hb);const Th=[Na,nb,md,db,$b,eb,cc,yd,ec,za,Hb,hc,ic,Xd,jc];for(const a of Th)a.from(Zb,He);return c},shuffle$$module$js$depgraph=(a,b,c,d,e)=>{d=void 0===d?new FlagSet$$module$js$flagset("Sbkm Sct"):d;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d,a);d.shuffleShops()&&f.shuffleShops(b);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);var h={};for(var k of g)if(k instanceof
Slot$$module$js$nodes&&k.slots){var m=k.slotType[0];(h[m]=h[m]||[]).push(k)}k=[];m=[];var l={};for(var n of d.get("S")){var p=[];for(var q of n){l[q]=!0;for(var r of h[q])p.push(r),m.push([r,k.length])}k.push(p)}for(var x of"bc")if(l[x])for(n=h[x],q=n.map((a)=>[a.item,a.itemIndex]),b.shuffle(q),r=0;r<n.length;r++)n[r].set(q[r][0],q[r][1]);p=(a)=>g.find((b)=>b.vanillaItemName===a);h=p("Sword of Wind");x=p("Sword of Fire");n=p("Ball of Wind");q=p("Ball of Fire");r=p("Statue of Onyx");p=p("Gas Mask");
l.k&&b.nextInt(2)&&(x.swap(h),q.swap(n));l.k&&!b.nextInt(3)&&r.swap(p);l=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(x=0;1E3>x;x++){e&&0===x%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));b.shuffle(m);for(var v of k)b.shuffle(v);n=k.map(()=>-1);q=l[b.nextInt(l.length)];r=[];p=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<q;a++){const [b,
c]=m[a],d=k[c][++n[c]];p(b,d)&&(b.swap(d),r.push([b,d]))}if(!r.length)continue;const {win:a,path:c}=f.traverse({wanted:g,dfs:!1});if(a)h=c;else for(;r.length;){const [a,b]=r.pop();a.swap(b)}}a&&f.write();if(c){c.items=[];c.route=[];for(const a of h){const [b,d]=a;c.route.push(d);v=f.nodes[b];v instanceof Slot$$module$js$nodes&&!v.isFixed()&&null!=v.slotName&&(k=v.slotName,0>k.indexOf(v.vanillaItemName)&&(k+=` (normally ${v.vanillaItemName})`),c.items.push({itemIndex:v.itemIndex,itemName:v.item.name,
origName:v.vanillaItemName,slotIndex:v.slotIndex,slotName:v.slotName,text:`${v.item.name}: ${k}`}))}}})},shuffle2$$module$js$depgraph=(a,b,c,d,e)=>{d=void 0===d?new FlagSet$$module$js$flagset("Sbkm Sct"):d;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d,a);d.shuffleShops()&&f.shuffleShops(b);const g=f.integrate();e&&e.addTasks(1E3);for(let h=0;1E3>h;h++){if(yield shuffle3$$module$js$depgraph(f,g,a,b,c,d,e)){console.log(`success after ${h} attempts`);
return}e&&(e.addCompleted(1),0===h%50&&(yield new Promise(requestAnimationFrame)))}return shuffle$$module$js$depgraph(a,b,c,d,e)})},shuffle3$$module$js$depgraph=(a,b,c,d,e,f,g)=>{f=void 0===f?new FlagSet$$module$js$flagset("Sbkm Sct"):f;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const g=e&&e.stats;var k=a.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&!a.isFixed());const m=new Map(d.shuffle(k.map((a)=>[a,[a.item,a.itemIndex]]))),l=new Set(d.shuffle(k)),n=new Map,
p={};g&&g.seeds++;f.get("S").forEach((a,b)=>{for(const c of a)p[c]=b});for(var q of l)n.set(q.item,q);const r=new Set,x=(a,b)=>{if(null==p[a.slotType?a.slotType[0]:"c"])return a===b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!==b.item.inventoryRow&&a.requiresUnique||"armor"===b.item.inventoryRow&&!a.isChest())return!1;if(f.guaranteeSword()){if(0===a.slotIndex)return 4>b.item.id;if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return p[a.slotType?a.slotType[0]:"c"]===p[b.slotType?b.slotType[0]:
"c"]};q=b.assumedFill(d,(a,b)=>x(a,n.get(b)));if(null==q){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const v=new Map;for(var y=0;y<q.length;y++){var C=q[y];if(null!=C){var B=n.get(b.item(C));C=m.get(B);m.delete(B);B=b.location(y);v.set(B,C);l.delete(B)}}y=(a,b,c)=>{c=void 0===c?"":c;for(const c of l)if(x(c,a))return v.set(c,b),l.delete(c),m.delete(a),!0;g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var u of m){const [a,b]=u;if(a.isMimic()&&
!y(a,b,"traps"))return!1}for(const a of m){const [b,c]=a;if(b.needsChest()&&!y(b,c,"chest"))return!1}for(const a of m){const [b,c]=a;if(!y(b,c))return!1}for(const a of v){const [b,c]=a;b.set(...c)}const {win:t,path:T}=a.traverse({wanted:k,dfs:!1});if(!t)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,q));e.items=[];e.route=[];for(const b of T){const [c,d]=b;e.route.push(d);k=a.nodes[c];k instanceof Slot$$module$js$nodes&&!k.isFixed()&&(u=k.slotName,
0>u.indexOf(k.vanillaItemName)&&(u+=` (normally ${k.vanillaItemName})`),e.items.push({itemIndex:k.itemIndex,itemName:k.item.name,origName:k.vanillaItemName,slotIndex:k.slotIndex,slotName:k.slotName,text:`${k.item.name}: ${u}`}))}return!0})};var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;module$js$depgraph.shuffle=shuffle$$module$js$depgraph;module$js$depgraph.shuffle2=shuffle2$$module$js$depgraph;module$js$depgraph.shuffle3=shuffle3$$module$js$depgraph;class FetchReader$$module$js$fetchreader{constructor(a){this.path=void 0===a?"js/":a}read(a){const b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){return a in STATIC$$module$js$fetchreader?STATIC$$module$js$fetchreader[a]:yield(yield fetch(b.path+a)).text()})}}const STATIC$$module$js$fetchreader={};var module$js$fetchreader={};module$js$fetchreader.FetchReader=FetchReader$$module$js$fetchreader;var Dir$$module$js$logic$dir;(function(a){a.name=function(a){switch(a){case 0:return"N";case 1:return"W";case 2:return"S";case 3:return"E"}throw Error(`Bad direction: ${a}`);};a.all=function(){return[0,1,2,3]};a.North=0;a.West=1;a.South=2;a.East=3})(Dir$$module$js$logic$dir||(Dir$$module$js$logic$dir={}));var module$js$logic$dir={};module$js$logic$dir.Dir=Dir$$module$js$logic$dir;class Graph$$module$js$logic$graph{constructor(a){var b;this.worlds=a;var c=new Set,d=new Set,e=new Map,f=new Map;for(var g=0;g<a.length;g++){const b=a[g],h=g<<24;for(const a of b.requirements){const [b,e]=a;c.add(h|b);for(const a of e)for(const b of a)d.add(h|b)}for(const a of b.items){const [b,c]=a;f.set(h|b,c)}for(const a of b.slots){const [b,c]=a;e.set(h|b,c)}}this.itemInfos=new Map(f);this.slotInfos=new Map(e);this.progression=new Set(d);for(const a of f.keys())d.add(a);e=new Set;f=new Set;g=
...
a&&c.overlayArea(d.tiles,4294901760);c.overlayArea(a.tiles,4278255615,0);c.render();return c.element}}var module$js$spoiler$area={};module$js$spoiler$area.Area=Area$$module$js$spoiler$area;class Entity$$module$js$rom$entity{constructor(a,b){this.rom=a;this.id=b}write(a){}toString(){return`${this.constructor.name} $${hex$$module$js$rom$util(this.id)}`}}class EntityArray$$module$js$rom$entity extends Array{static get [Symbol.species](){return Array}}var module$js$rom$entity={};module$js$rom$entity.Entity=Entity$$module$js$rom$entity;module$js$rom$entity.EntityArray=EntityArray$$module$js$rom$entity;var ShopType$$module$js$rom$shop;(function(a){a[a.ARMOR=0]="ARMOR";a[a.TOOL=1]="TOOL";a[a.INN=2]="INN";a[a.PAWN=3]="PAWN"})(ShopType$$module$js$rom$shop||(ShopType$$module$js$rom$shop={}));
...
Oak:c,Shyron_ToolShop:d},flags:{AbleToRideDolphin:e,BallOfFire:f,BallOfThunder:g,BallOfWater:h,BallOfWind:k,Barrier:m,BlizzardBracelet:l,BowOfMoon:n,BowOfSun:p,BreakStone:q,BreakIce:r,BreakIron:x,BrokenStatue:v,BuyHealing:y,BuyWarp:C,ClimbWaterfall:B,ClimbSlope8:u,ClimbSlope9:t,CurrentlyRidingDolphin:T,Flight:N,FlameBracelet:ib,FormBridge:U,GasMask:va,GlowingLamp:Aa,InjuredDolphin:Wa,LeadingChild:Oa,LeatherBoots:jb,Money:Y,OpenedCrypt:Ba,RabbitBoots:da,Refresh:H,RepairedStatue:O,RescuedChild:P,ShellFlute:I,
ShieldRing:Ca,ShootingStatue:ea,StormBracelet:V,Sword:Da,SwordOfFire:la,SwordOfThunder:ma,SwordOfWater:fa,SwordOfWind:na,TornadoBracelet:Ea,TravelSwamp:oa,WildWarp:w},items:{MedicalHerb:qb,WarpBoots:rb}}=this.rom,F=this.entrance(b);var W=this.entrance(c);this.addCheck([F],and$$module$js$logic$world(n,p),[Ba.id]);this.addCheck([F],and$$module$js$logic$world(e,I),[T.id]);this.addCheck([W],and$$module$js$logic$world(Oa),[P.id]);this.addItemCheck([F],and$$module$js$logic$world(Aa,v),O.id,{lossy:!0,unique:!0});
for(var Q of this.rom.shops)if(Q.location!==a.id&&Q.location!==d.id&&Q.used&&Q.type===module$js$rom$shop.ShopType.TOOL){W=[module$js$logic$tileid.TileId(Q.location<<16|136)];for(var pa of Q.contents)pa===qb.id?this.addCheck(W,Y.r,[y.id]):pa===rb.id&&this.addCheck(W,Y.r,[C.id])}Q=na.r;pa=la.r;W=fa.r;let Pa=ma.r;if(!this.flagset.orbsOptional()){var Fa=or$$module$js$logic$world(k,Ea);const a=or$$module$js$logic$world(f,ib),b=or$$module$js$logic$world(h,l),c=or$$module$js$logic$world(g,V);Q=module$js$logic$requirement.Requirement.meet(Q,
Fa);pa=module$js$logic$requirement.Requirement.meet(pa,a);W=module$js$logic$requirement.Requirement.meet(W,b);Pa=module$js$logic$requirement.Requirement.meet(Pa,c);if(this.flagset.assumeSwordChargeGlitch()){Fa=function(b){return a.map((a)=>a[0]===b.c?a:[b.c,...a])};const a=module$js$logic$requirement.Requirement.or(Q,pa,W,Pa);Q=Fa(na);pa=Fa(la);W=Fa(fa);Pa=Fa(ma)}}this.addCheck([F],Q,[q.id]);this.addCheck([F],pa,[r.id]);this.addCheck([F],W,[U.id]);this.addCheck([F],Pa,[x.id]);this.addCheck([F],or$$module$js$logic$world(na,
la,fa,ma),[Da.id,Y.id]);this.addCheck([F],N.r,[B.id]);this.addCheck([F],or$$module$js$logic$world(N,da),[u.id]);this.addCheck([F],or$$module$js$logic$world(N,da),[t.id]);this.addCheck([F],m.r,[ea.id]);this.addCheck([F],va.r,[oa.id]);this.flagset.leatherBootsGiveSpeed()&&this.addCheck([F],jb.r,[u.id]);this.flagset.assumeGhettoFlight()&&this.addCheck([F],and$$module$js$logic$world(T,da),[B.id]);this.flagset.fogLampNotRequired()&&(Q=this.flagset.requireHealedDolphinToRide(),this.addCheck([F],Q?Wa.r:
[[]],[e.id]));this.flagset.guaranteeBarrier()||this.addCheck([F],[[Y.c,y.c],[Y.c,Ca.c],[Y.c,H.c]],[ea.id]);this.flagset.assumeFlightStatueSkip()||this.addCheck([F],[[Y.c,N.c]],[ea.id]);this.flagset.guaranteeGasMask()||this.addCheck([F],[[Y.c,y.c],[Y.c,H.c]],[oa.id]);this.flagset.assumeWildWarp()&&this.addCheck([F],module$js$logic$requirement.Requirement.OPEN,[w.id])}addExtraRoutes(){const {flags:{BuyWarp:a,SwordOfThunder:b,Teleport:c,WildWarp:d},locations:{MezameShrine:e}}=this.rom;this.addRoute(new Route$$module$js$logic$requirement(this.entrance(e),
[]));if(this.flagset.teleportOnThunderSword()){const d=this.rom.townWarp.thunderSwordWarp;this.addRoute(new Route$$module$js$logic$requirement(this.entrance(d[0],d[1]&31),[b.c,a.c]));this.addRoute(new Route$$module$js$logic$requirement(this.entrance(d[0],d[1]&31),[b.c,c.c]))}if(this.flagset.assumeWildWarp())for(const a of this.rom.wildWarp.locations)a!==this.rom.locations.UndergroundChannel.id&&this.addRoute(new Route$$module$js$logic$requirement(this.entrance(a),[d.c]))}consolidateChecks(){for(const [a,
b]of this.checks){const c=this.tiles.find(a);if(a!==c){for(const a of b)this.checks.get(c).add(a);this.checks.delete(a)}}}buildRequirementMap(){for(const [c,d]of this.checks)for(const {checks:e,requirement:f}of d)for(var a of e){var b=this.requirementMap.get(a);for(const a of f)for(const d of this.routes.get(c)||[])b.addList([...a,...d])}if(DEBUG$$module$js$logic$world){a=[];for(const [c,d]of this.requirementMap){b=(a)=>this.rom.flags[a].name;for(const e of d)a.push(`${b(c)}: ${[...e].map(b).join(" & ")}\n`)}a.sort((a,
b)=>a<b?-1:a>b?1:0);console.log(a.join(""))}}getLocationList(a="Crystalis"){const b=DEBUG$$module$js$logic$world?(a)=>a.debug:(a)=>a.name;return{worldName:a,requirements:this.requirementMap,items:this.items,slots:this.slots,checkName:(a)=>b(this.rom.flags[a]),prefill:(a)=>{const {Crystalis:b,MesiaInTower:c,LeafElder:f}=this.rom.flags,g=new Map([[c.id,b.id]]);this.flagset.guaranteeSword()&&g.set(f.id,512|a.nextInt(4));return g}}}processLocation(a){a.used&&(this.processLocationTiles(a),this.processLocationSpawns(a),
this.processLocationItemUses(a))}unionNeighbors(){for(const [b,c]of this.terrains){var a=module$js$logic$tileid.TileId.add(b,0,1);this.terrains.get(a)===c&&this.tiles.union([b,a]);a=module$js$logic$tileid.TileId.add(b,1,0);this.terrains.get(a)===c&&this.tiles.union([b,a])}}addAllRoutes(){this.addExtraRoutes();for(const [b,c]of this.neighbors){const [d,e]=module$js$logic$tilepair.TilePair.split(b);var a=this.terrains.get(d);const f=this.terrains.get(e);if(!a||!f)throw Error(`missing terrain ${hex$$module$js$rom$util(a?
d:e)}`);for(const [b,h]of a.exit)if(b&c)for(const a of h)for(const b of f.enter)this.addRoute(new Route$$module$js$logic$requirement(e,[...a,...b]),d)}"object"===typeof document&&(a=document.getElementById("debug"))&&a.appendChild((new Area$$module$js$spoiler$area(this.rom,this.getWorldData())).element)}getWorldData(){var a=0;const b=new DefaultMap$$module$js$util(()=>({})),c=seq$$module$js$rom$util(256,()=>({areas:new Set,tiles:new Set})),d=[];for(var e of this.tiles.sets()){var f=this.tiles.find(module$js$util.iters.first(e)),
g=this.terrains.get(f);if(g&&(f=this.routes.has(f)?module$js$logic$requirement.Requirement.freeze(this.routes.get(f)):[],f.length)){g={checks:[],id:a++,locations:new Set,routes:f,terrain:g,tiles:new Set};d.push(g);for(const a of e)f=a>>>16,g.locations.add(f),g.tiles.add(a),c[f].areas.add(g),c[f].tiles.add(a),b.get(a).area=g}}for(const [a,c]of this.exits)b.has(a)&&(b.get(a).exit=c);for(const [c,d]of this.checks)if(a=b.get(c).area)for(const {checks:b,requirement:c}of d)for(const d of b)e=this.rom.flags[d]||
die$$module$js$assert(),a.checks.push([e,c]);return{tiles:b,areas:d,locations:c}}addRoute(a,b){if(null!=b){this.routeEdges.get(b).add(a);for(var c of this.routes.get(b))this.addRoute(new Route$$module$js$logic$requirement(a.target,[...c,...a.deps]))}else for(b=new LabeledSet$$module$js$util,c=new LabeledSet$$module$js$util,b.add(a),a=b[Symbol.iterator]();;){const {value:d,done:e}=a.next();if(e)break;c.add(d);b.delete(d);const f=new LabeledSet$$module$js$util,g=d.target;if(this.routes.get(g).addRoute(d))for(const a of this.routeEdges.get(g))f.add(new Route$$module$js$logic$requirement(a.target,
[...d.deps,...a.deps]));for(const a of f)c.has(a)||(b.delete(a),b.add(a))}}recordExits(){for(const [a,b]of this.exits)this.exitSet.add(module$js$logic$tilepair.TilePair.of(this.tiles.find(a),this.tiles.find(b)));for(const a of this.exitSet){const [b,c]=module$js$logic$tilepair.TilePair.split(a);if(this.terrains.get(b)!==this.terrains.get(c))continue;const d=module$js$logic$tilepair.TilePair.of(c,b);this.exitSet.has(d)&&(this.tiles.union([b,c]),this.exitSet.delete(a),this.exitSet.delete(d))}}buildNeighbors(){for(const [c,
d]of this.terrains)if(d){var a=module$js$logic$tileid.TileId.add(c,1,0),b=this.terrains.get(a);b&&b!==d&&this.handleAdjacentNeighbors(c,a,module$js$logic$dir.Dir.North);a=module$js$logic$tileid.TileId.add(c,0,1);(b=this.terrains.get(a))&&b!==d&&this.handleAdjacentNeighbors(c,a,module$js$logic$dir.Dir.West)}for(const b of this.exitSet){const [c,e]=module$js$logic$tilepair.TilePair.split(b);this.terrains.has(c)&&this.terrains.has(e)&&(a=module$js$logic$tilepair.TilePair.of(this.tiles.find(c),this.tiles.find(e)),
this.neighbors.set(a,this.neighbors.get(a)|1))}}handleAdjacentNeighbors(a,b,c){var d=this.tiles.find(a);const e=this.tiles.find(b);this.seamlessExits.has(b)||(b=module$js$logic$tilepair.TilePair.of(e,d),this.neighbors.set(b,this.neighbors.get(b)|1<<c));this.seamlessExits.has(a)||(a=c^2,d=module$js$logic$tilepair.TilePair.of(d,e),this.neighbors.set(d,this.neighbors.get(d)|1<<a))}processLocationTiles(a){var b,c,d,e=new Map;const f=new Set,g=88===(a.id&248);for(var h of a.spawns)h.isWall()?e.set(module$js$logic$screenid.ScreenId.from(a,
h),h.id&3):h.isMonster()&&63===h.id&&f.add(module$js$logic$screenid.ScreenId.from(a,h));const k=a.screenPage;h=this.rom.tileset(a.tileset);const m=this.rom.tileEffects[a.tileEffects-179],l=(b)=>m.effects[this.rom.screens[a.screens[(b&61440)>>>12][(b&3840)>>>8]|k].tiles[b&255]],n=(b,c,d)=>{b&=module$js$logic$terrain.Terrain.BITS;26===a.id&&(b|=module$js$logic$terrain.Terrain.SWAMP);if(96===a.id||104===a.id)b|=module$js$logic$terrain.Terrain.DOLPHIN;100===a.id&&4144>(c&61680)&&(b|=module$js$logic$terrain.Terrain.DOLPHIN);
d&&(b|=module$js$logic$terrain.Terrain.BARRIER);if(!(b&module$js$logic$terrain.Terrain.DOLPHIN)&&b&module$js$logic$terrain.Terrain.SLOPE){for(d=0;l(c)&module$js$logic$terrain.Terrain.SLOPE;)c=module$js$logic$tileid.TileId.add(c,1,0),d++;6>d?b&=~module$js$logic$terrain.Terrain.SLOPE:9>d?b|=module$js$logic$terrain.Terrain.SLOPE8:10>d&&(b|=module$js$logic$terrain.Terrain.SLOPE9)}return this.terrainFactory.tile(b)};for(let l=0,v=a.height;l<v;l++){const v=a.screens[l],x=a.id<<8|l<<4;for(let l=0,y=a.width;l<
y;l++){const y=this.rom.screens[v[l]|k],u=module$js$logic$screenid.ScreenId(x|l),C=f.has(u),B=u&255;var p=e.get(u);p=g?this.rom.flags.AlwaysTrue.id:null!=p?this.wallCapability(p):null===(b=a.flags.find((a)=>a.yx===B))||void 0===b?void 0:b.flag;const U=(d=null===(c=this.rom.flags[p])||void 0===c?void 0:c.logic,null!==d&&void 0!==d?d:{});for(let b=0;240>b;b++){const c=module$js$logic$tileid.TileId(u<<8|b);var q=y.tiles[b];U.assumeTrue&&32>q&&(q=h.alternates[q]);var r=a.isShop()?0:m.effects[q]&38;r=
n(r,c,C);32>q&&h.alternates[q]!==q&&null!=p&&!U.assumeTrue&&!U.assumeFalse&&(q=n(m.effects[h.alternates[q]],c,C))&&(r=this.terrainFactory.flag(r,U.track?p:-1,q));r&&this.terrains.set(c,r)}}}for(const f of a.exits){const {dest:g,entrance:h}=f;b=module$js$logic$tileid.TileId.from(a,f);f.isSeamless()?(c=module$js$logic$tileid.TileId(b&65535|g<<16),d=module$js$logic$tileid.TileId.from(a,f),this.seamlessExits.add(d),(e=this.terrains.get(d))&&this.terrains.set(d,this.terrainFactory.seamless(e))):c=this.entrance(this.rom.locations[g],
h&31);this.exits.set(b,c)}}processLocationSpawns(a){for(const b of a.spawns){b.isTrigger()?this.processTrigger(a,b):b.isNpc()?this.processNpc(a,b):b.isBoss()?this.processBoss(a,b):b.isChest()?this.processChest(a,b):b.isMonster()?this.processMonster(a,b):3===b.type&&224===b.id&&this.processKeyUse(module$js$logic$hitbox.Hitbox.screen(module$js$logic$tileid.TileId.from(a,b)),this.rom.flags.UsedWindmillKey.r);for(const [c,d]of this.itemUses.get(b.type<<8|b.id))this.processItemUse([module$js$logic$tileid.TileId.from(a,
b)],c,d)}}processTrigger(a,b){var c;const d=this.rom.trigger(b.id);if(!d)throw Error(`Missing trigger ${b.id.toString(16)}`);const e=this.filterRequirements(d.conditions);let f=this.filterAntiRequirements(d.conditions);const g=module$js$logic$tileid.TileId.from(a,b);b=module$js$logic$hitbox.Hitbox.trigger(a,b);const h=[];for(const a of d.flags){const b=this.flag(a);(null===(c=b)||void 0===c?0:c.logic.track)&&h.push(b.id)}h.length&&this.addCheck(b,e,h);switch(d.message.action){case 25:134!==d.id||
this.flagset.assumeRabbitSkip()?186!==d.id||this.flagset.assumeTeleportSkip()||this.flagset.disableTeleportSkip()||(b=module$js$logic$hitbox.Hitbox.atLocation(b,this.rom.locations.CordelPlainEast,this.rom.locations.CordelPlainWest)):b=module$js$logic$hitbox.Hitbox.adjust(b,[0,-1],[0,1]);this.addTerrain(b,this.terrainFactory.statue(f));break;case 29:this.addBossCheck(b,this.rom.bosses.Mado1,e);break;case 8:case 11:case 12:case 13:case 15:this.addItemGrantChecks(b,e,d.id);break;case 24:a=this.flagset.chargeShotsOnly()?
module$js$logic$requirement.Requirement.meet(e,and$$module$js$logic$world(this.rom.flags.WarpBoots)):e;this.addItemCheck(b,a,this.rom.flags.StomFightReward.id,{lossy:!0,unique:!0});break;case 30:this.addItemCheck(b,e,this.rom.flags.MesiaInTower.id,{lossy:!0,unique:!0});break;case 31:this.handleBoat(g,a,e);break;case 27:a===this.rom.locations.PortoaPalace_Entrance&&(b=module$js$logic$hitbox.Hitbox.adjust(b,[-2,0]),f=this.rom.flags.TalkedToFortuneTeller.r),this.handleMovingGuard(b,a,f)}}processNpc(a,
b){var c,d,e,f,g,h;const k=this.rom.npcs[b.id];if(!k||!k.used)throw Error(`Unknown npc: ${hex$$module$js$rom$util(b.id)}`);const m=k.spawnConditions.get(a.id)||[];var l=this.filterRequirements(m);b=module$js$logic$tileid.TileId.from(a,b);b=[this.terrains.has(b)?b:(c=this.walkableNeighbor(b),null!==c&&void 0!==c?c:b)];k===this.rom.npcs.SaberaDisguisedAsMesia&&this.addBossCheck(b,this.rom.bosses.Sabera1,l);k.data[2]&4&&!this.flagset.assumeStatueGlitch()&&(c=this.filterAntiRequirements(m),k===this.rom.npcs.Rage?
(b=module$js$logic$hitbox.Hitbox.adjust(b,[2,-1],[2,0],[2,1],[2,2]),b=module$js$logic$hitbox.Hitbox.adjust(b,[0,-6],[0,-2],[0,2],[0,6]),this.flagset.assumeRageSkip()&&(c=void 0)):k===this.rom.npcs.PortoaThroneRoomBackDoorGuard&&(c=or$$module$js$logic$world(this.rom.flags.MesiaRecording,this.rom.flags.Paralysis)),c&&this.addTerrain(b,this.terrainFactory.statue(c)));k===this.rom.npcs.FortuneTeller&&(b=module$js$logic$hitbox.Hitbox.adjust(b,[0,0],[2,0]));if(!module$js$logic$requirement.Requirement.isClosed(l)){[[...l]]=
l;for(const a of k.globalDialogs)c=this.flag(~a.condition),null!==(d=c)&&void 0!==d&&d.logic.track&&l.push(c.id);a=(f=(e=k.localDialogs.get(a.id),null!==e&&void 0!==e?e:k.localDialogs.get(-1)),null!==f&&void 0!==f?f:[]);for(const c of a)e=[...l],f=this.flag(c.condition),(null===(g=f)||void 0===g?0:g.logic.track)&&e.push(f.id),this.processDialog(b,k,e,c),e=this.flag(~c.condition),(null===(h=e)||void 0===h?0:h.logic.track)&&l.push(e.id)}}processDialog(a,b,c,d){this.addCheckFromFlags(a,[c],d.flags);
const e={lossy:!0,unique:!0};switch(d.message.action){case 8:this.processKeyUse(a,[c]);break;case 20:this.addItemCheck(a,[c],this.rom.flags.SlimedKensu.id,e);break;case 16:this.addItemCheck(a,[c],this.rom.flags.AsinaInBackRoom.id,e);break;case 17:this.addItemCheck(a,[c],256|b.data[1],e);break;case 3:case 10:this.addItemCheck(a,[c],256|b.data[0],e);break;case 9:b=b.data[1];255!==b&&this.addItemCheck(a,[c],256|b,e);break;case 25:this.addItemCheck(a,[c],this.rom.flags.AkahanaFluteOfLimeTradein.id,e);
break;case 26:this.addItemCheck(a,[c],this.rom.flags.Rage.id,e)}}processLocationItemUses(a){for(const [b,c]of this.itemUses.get(~a.id))this.processItemUse([this.entrance(a)],b,c)}handleMovingGuard(a,b,c){if(!this.flagset.assumeStatueGlitch()){var d=[];for(const a of b.spawns.slice(0,2))if(a.isNpc()&&this.rom.npcs[a.id].isParalyzable()){d.push([this.rom.flags.Paralysis.id]);break}this.addTerrain(a,this.terrainFactory.statue([...c,...d].map(spread$$module$js$util)))}}handleBoat(a,b,c){const d=this.walkableNeighbor(a);
if(null==d)throw Error("Could not find walkable neighbor.");const e=a>>8&240|a>>4&15;a=a>>4&240|a&15;var f;for(const c of b.exits)c.yt===e&&c.xt<a&&(f=c);if(!f)throw Error("Could not find boat exit");b=this.rom.locations[f.dest];if(!b)throw Error("Bad destination");for(b=module$js$logic$tileid.TileId.from(b,b.entrances[f.entrance]);;)if(b=module$js$logic$tileid.TileId.add(b,0,-1),f=this.walkableNeighbor(b),null!=f){c={enter:module$js$logic$requirement.Requirement.freeze(c),exit:[[15,module$js$logic$requirement.Requirement.OPEN]]};
this.addTerrain([d],c);this.exits.set(d,f);this.exitSet.add(module$js$logic$tilepair.TilePair.of(d,f));break}}addItemGrantChecks(a,b,c){const d=this.itemGrant(c),e=256|d;if(null==d)throw Error(`missing item grant for ${c.toString(16)}`);this.addItemCheck(a,b,e,{lossy:!0,unique:!0,preventLoss:128<=c})}addTerrain(a,b){for(const c of a)a=this.terrains.get(c),null!=a&&this.terrains.set(c,this.terrainFactory.meet(a,b))}addCheck(a,b,c){if(!module$js$logic$requirement.Requirement.isClosed(b)){b={requirement:module$js$logic$requirement.Requirement.freeze(b),
...
8|(a.entrance&61440)>>8|(a.entrance&240)>>4,a.dir),this.stairScreens.set(b.edges,[a.dir,{entrance:a.entrance,exits:[a.exit,a.exit+1]}]);b.wall&&this.walls.set(b.tile,b.wall.type);128!=b.tile&&b.fixed&&(this.fixedTiles.has(b.tile)||this.fixedTiles.set(b.tile,b));b.deadEnd&&this.deadEndTiles.add(b.tile)}}survey(a){let b=0,c=0,d=0,e=0,f=0,g=0,h=!0,k=!1;const m=new Map,l=new Map,n=new Map,p=new Multiset$$module$js$util,q=[];this.empty&&q.push(this.empty);var r=new Set([].concat(...a.screens));for(var x of this.specSets)for(var v of x)if(128!==
v.tile&&r.has(v.tile)){q.push(...x);break}if(164===a.tileset)for(r=q.length-1;0<=r;r--)69648===q[r].edges&&q.splice(r,1);r=new Set([...a.reachableTiles(!0).keys()].map((a)=>a>>>8));if(!r.size)throw Error("No reachable tiles");x=new Map(a.entrances.map((b,c)=>{for(const d of a.exits)if(20>Math.abs(d.x-b.x)&&20>Math.abs(d.y-b.y))return[c,d.dest<<8|d.entrance];return null}).filter(isNonNull$$module$js$util));for(v=0;v<a.entrances.length;v++){var y=a.entrances[v],C=this.stairsByTile.get(a.screens[y.screen>>>
4][y.screen&15]<<8|y.tile);if(null!=C){var B=x.get(v);if(null==B)throw Error("Could not find exit");m.set(y.screen,{entrance:v,exit:B,dir:C})}}for(v=0;v<a.height;v++)for(y=0,v||(y|=1),v===a.height-1&&(y|=4),C=0;C<a.width;C++){B=v<<4|C;if(!r.has(B))continue;y&=-11;C||(y|=8);C===a.width-1&&(y|=2);var u=a.screens[v][C];p.add(u);if(128===u)continue;WIDE_SET$$module$js$maze$spec.has(u)?k=!0:h=!1;b++;RIVER_TILES$$module$js$maze$spec.has(u)&&g++;let q=this.edgesByTile.get(u);if(null==q)throw Error(`Bad tile: ${hex$$module$js$rom$util(u)}`);
var t=BITCOUNT$$module$js$maze$spec[q]+(m.has(B)?1:0);154===u&&(t=2);if(155===u||156==u||240==u||241==u)t=1;1===t&&c++;2<t&&(d+=t-2);t=this.walls.get(u);"wall"===t&&e++;"bridge"===t&&f++;t=this.fixedTiles.get(u);this.deadEndTiles.has(u)&&(q=0);for(var T of module$js$maze$types.Dir.ALL)if(q&y&1<<T){u=null;for(var N=0;N<a.entrances.length;N++)if(a.entrances[N].screen===B&&matchesDir$$module$js$maze$spec(a.entrances[N].tile,T)){u=N;break}if(null!=u){N=x.get(u);if(null==N)throw Error("Could not find exit");
l.set(B,{entrance:u,exit:N,dir:T})}}null!=t&&n.set(B,t)}if(g)for(const [a,b]of n)29046===b.edges&&(T=q.find((a)=>459009===a.edges))&&n.set(a,T);if(h!=k)throw Error("Found inconsistent use of wide tiles");return{size:b,rivers:g,deadEnds:c,branches:d,walls:e,bridges:f,stairs:m,edges:l,fixed:n,tiles:p,wide:h,specs:q,specSet:this}}}SpecSet$$module$js$maze$spec.CAVE=new SpecSet$$module$js$maze$spec(ALL_CAVE_SCREENS$$module$js$maze$spec,EMPTY_CAVE_SCREEN$$module$js$maze$spec);
...
module$js$maze$spec.GOA1_SCREENS=GOA1_SCREENS$$module$js$maze$spec;module$js$maze$spec.SpecSet=SpecSet$$module$js$maze$spec;module$js$maze$spec.readScreen=readScreen$$module$js$maze$spec;module$js$maze$spec.write2d=write2d$$module$js$maze$spec;const CAVE$$module$js$rom$location={subArea:"cave",music:(a)=>`${a.name}-Cave`,palette:(a)=>`${a.name}-Cave`},HOUSE$$module$js$rom$location={subArea:"house",palette:()=>Symbol()},FORTUNE_TELLER$$module$js$rom$location={subArea:"house",palette:()=>Symbol(),music:(a)=>`${a.name}-FortuneTeller`},MESIA$$module$js$rom$location={name:"mesia",music:(a)=>`${a.name}-Mesia`,palette:(a)=>"Tower"===a.name?a.name:`${a.name}-Mesia`},DYNA$$module$js$rom$location={name:"dyna",music:(a)=>`${a.name}-Dyna`,palette:(a)=>
...
KARMINE_UPPER$$module$js$rom$location,{palette:"goa 4 lower"}),$$$module$js$rom$location=(()=>{function a(a,e){e=void 0===e?{}:e;e=Object.assign({},e);c=e.area=e.area||c;return b(a,e)}const b=initializer$$module$js$rom$util();let c;a.commit=(a)=>{const c=a.rom.areas;b.commit(a,(b,d,e)=>{b=upperCamelToSpaces$$module$js$rom$util(b);const f=e.area(c),g="function"===typeof e.music?e.music(f):null!=e.music?e.music:f.name,h="function"===typeof e.palette?e.palette(f):e.palette||f.name;b={area:f,name:b,music:g,
palette:h};null!=e.subArea&&(b.subArea=e.subArea);null!=e.bossScreen&&(b.bossScreen=e.bossScreen);e=new Location$$module$js$rom$location(a.rom,d,b);0<=d&&(a[d]=e);return e})};return a})();
...
name:"",music:"",palette:""}))}allocate(a){for(const b of this)if(!b.used)return a.id=b.id,a.used=!0,this[b.id]=a;throw Error("No unused location");}}
...
[b.bgm,b.layoutWidth,b.layoutHeight,b.animation,b.extended,...concatIterables$$module$js$rom$util(b.screens)],f=[...b.tilePalettes,b.tileset,b.tileEffects,...b.tilePatterns];if(1===b.height){for(var g of b.entrances)g.used&&191<g.y&&(g.y=191);for(var h of b.exits)12<h.yt&&(h.yt=12)}g=concatIterables$$module$js$rom$util(b.entrances);h=[...concatIterables$$module$js$rom$util(b.exits),128|(b.pits.length?64:0)|b.entrances.length];var k=[...concatIterables$$module$js$rom$util(b.flags),255],m=concatIterables$$module$js$rom$util(b.pits),
[l,n,p,q,r,x]=yield Promise.all([d(e,"Layout"),d(f,"Graphics"),d(g,"Entrances"),d(h,"Exits"),d(k,"Flags"),...m.length?[d(m,"Pits")]:[]]);e=[l&255,(l>>>8)-192,n&255,(n>>>8)-192,p&255,(p>>>8)-192,q&255,(q>>>8)-192,r&255,(r>>>8)-192,...x?[x&255,(x>>8)-192]:[]];d=yield d(e,"MapData");writeLittleEndian$$module$js$rom$util(a.rom,b.mapDataPointer,d-49152);yield Promise.all(c);c=b.bossId();if(null!=c&&95!==b.id){d=readLittleEndian$$module$js$rom$util(a.rom,129387+2*c)+81920;e=[,,,166===b.id?0:b.bgm,,...b.tilePalettes,
...
a.screen<<8|a.tile));var c=new UnionFind$$module$js$unionfind;const d=this.rom.tileset(this.tileset),e=this.rom.tileEffects[this.tileEffects-179];var f=new Set;for(let c=0;c<this.height;c++){const h=this.screens[c];for(let k=0;k<this.width;k++){const l=this.rom.screens[h[k]|this.screenPage],m=c<<4|k,q=this.flags.find((a)=>a.screen===m);for(let c=0;240>c;c++){const h=m<<8|c;if(b.has(h))continue;let k=l.tiles[c];var g=e.effects[k];g=a?g&4:g&6;q&&g&&32>k&&d.alternates[k]!=k&&(k=d.alternates[k],g=e.effects[k],
...
this.entrances);for(const c of b)a.get(c.screen).push(c);return(b,d)=>{for(const c of a.get(b))c.screen=d}}moveScreen(a,b){const c=module$js$util.iters.concat(this.spawns,this.exits,this.entrances);for(const d of c)d.screen===a&&(d.screen=b)}monsterPlacer(a){const b=this.data.bossScreen,c=this.reachableTiles(!1),d=new Map([...c.keys()].map((a)=>[a,0])),e=[],f=[],g=[],h=[],k=[],m=this.hasDolphin()?37:39;for(const a of d){const [k,l]=a;{const a=this.screens[k>>>12][k>>>8&15];if(a!==b){for(const a of neighbors$$module$js$rom$location(k,
this.width,this.height))d.has(a)||d.set(a,l+1);l||c.get(k)&m||e.push(k);26===this.id?240===this.rom.screens[a].tiles[k&255]&&h.push(k):2<=l&&4>=l&&h.push(k);3<=l&&7>=l&&f.push(k);12<=l&&g.push(k)}}}return(b)=>{var c=b.placement();c=[..."normal"===c?e:"moth"===c?f:"bird"===c?g:"plant"===c?h:assertNever$$module$js$util(c)];a:for(;c.length;){var d=a.nextInt(c.length),[l]=c.splice(d,1);d=(l&3840)>>>4|l&15;l=(l&61440)>>>8|(l&240)>>>4;const e=b.clearance();for(const a of k){const [,b,c,f]=a;if(Math.pow(l-
c,2)+Math.pow(d-b,2)<Math.pow(e+f,2))continue a}for(const a of this.entrances){const {x:b,y:c,used:f}=a;if(f&&Math.pow(l-(c>>4),2)+Math.pow(d-(b>>4),2)<Math.pow(e+1,2))continue a}k.push([b,d,l,e]);return(l&240|(d&240)>>>4)<<8|(l&15)<<4|d&15}}}resizeScreens(a,b,c,d,e){e=void 0===e?0:e;const f=this.width+b+d;c=this.height+a+c;d=Array.from({length:c},(c,d)=>{d-=a;return Array.from({length:f},(a,c)=>{c-=b;return 0>d||0>c||d>=this.height||c>=this.width?e:this.screens[d][c]})});this.width=f;this.height=
c;this.screens=d;for(const c of this.flags)c.xs+=b,c.ys+=a;for(const c of this.pits)c.fromXs+=b,c.fromYs+=a;for(const c of[...this.spawns,...this.exits])c.xt+=16*b,c.yt+=16*a;for(const c of this.entrances)c.used&&(c.x+=256*b,c.y+=256*a)}writeScreens2d(a,b){const c=a&15;a>>>=4;for(let d=0;d<b.length;d++){const e=b[d];for(let b=0;b<e.length;b++){const f=e[b];null!=f&&(this.screens[a+d][c+b]=f)}}}connect(a,b,c){var d=0>a?256:0,e=0>c?256:0;a=0>a?~a:a;c=0>c?~c:c;const f=a>>>4,g=a&15,h=c>>>4,k=c&15,[m,
l]=screenExits$$module$js$rom$location[d|this.screens[f][g]],[n,p]=screenExits$$module$js$rom$location[e|b.screens[h][k]];d=this.entrances.length;e=b.entrances.length;this.entrances.push(Entrance$$module$js$rom$location.of({y:f<<8|m>>>8,x:g<<8|m&255}));b.entrances.push(Entrance$$module$js$rom$location.of({y:h<<8|n>>>8,x:k<<8|n&255}));for(const c of l)this.exits.push(Exit$$module$js$rom$location.of({screen:a,tile:c,dest:b.id,entrance:e}));for(const a of p)b.exits.push(Exit$$module$js$rom$location.of({screen:c,
tile:a,dest:this.id,entrance:d}))}neighborForEntrance(a){const b=this.entrances[a];if(!b)throw Error(`no entrance ${hex$$module$js$rom$util(this.id)}:${a}`);for(const a of this.exits){if(a.screen!==b.screen)continue;const c=Math.abs(a.y-b.y);if(24>Math.abs(a.x-b.x)&&24>c)return this.rom.locations[a.dest]}throw Error(`no exit found near ${hex$$module$js$rom$util(this.id)}:${a}`);}}
...
(m=b);a=l&m;n=[];k=Infinity;p=c?module$js$util.iters.map(c,(a)=>[a,this.screens.get(a)]):this.screens;for(const c of p){const [f,v]=c;if(!v)throw Error("Bad Scr in 'allowed'!");if(!(v.fixed||d&&v.edges&-65536||null!=h&&!v.stairs.some((a)=>a.dir===h)||null==h&&v.stairs.length||(f&m)!==a||e&&module$js$maze$types.Scr.numExits(f)>e))if(g){p=0;q=f&b^l;for(const a of module$js$maze$types.Dir.ALL)q&15<<module$js$maze$types.Dir.shift(a)&&p++;p<k?(k=p,n=[f]):p===k&&n.push(f)}else yield f}g&&(yield*n)}fill(a,
...
b,{force:!0})};const l=new Maze$$module$js$maze$maze(b,f,e,GOA1_SCREENS$$module$js$maze$spec),m=f-1<<4|b.nextInt(e),p=b.nextInt(e),q=m<<8|2,r=[p+32<<8|1,p+32<<8|3];k(m,61681);k(m-1,240);k(m+1,61440);k(p,65520);k(p-1,4080);k(p+1,65280);k(p+16,61951);k(p+15,255);k(p+17,61455);if(!l.connect(m,module$js$maze$types.Dir.UP,p+16,module$js$maze$types.Dir.DOWN))continue a;if(257===l.get(p+32)||257===l.get(m-16))continue a;for(k=0;10>k&&.65>l.density();k++)l.addLoop()&&(k=0);if(.45>l.density())continue a;if(!h())continue a;
...
e=module$js$maze$types.Pos.plus(a,c);!d.isFixed(a)&&!d.isFixed(e)&&d.get(a)&module$js$maze$types.Dir.edgeMask(c)?d.saveExcursion(()=>d.replaceEdge(a,c,0)?!!(d.get(a)&&d.get(e)&&f()):!1):p++}if(!d.consolidate(e,f,a))return!1;const [q,r]=b.pick([...d.alternates()]);if(65536!=r)throw Error(`unexpected alt: ${hex$$module$js$rom$util(r)}`);d.replace(q,d.get(q)|r);c.moveScreen(48,m);c.moveScreen(4,k);d.write(c,new Set);e=[];n=[];for(const [a,b]of d)a!==k&&a!==q&&(1!==b&&16!==b&&256!==b&&4096!==b||e.push(a),
17!==b&&272!==b&&4352!==b&&4097!==b||n.push(a));var x=a.screens[c.screens[q>>4][q&15]].tiles;p=0;for(let a=0;240>a;a++)if(3===x[a]){p=a;break}c.entrances[1].screen=q;c.entrances[1].tile=p+17;for(x=0;2>x;x++)c.exits[5+x].screen=q,c.exits[5+x].tile=p+x;e=b.pick(e.length?e:n);c.spawns[1].screen=e;e=c.monsterPlacer(b);for(const b of c.spawns)b.isMonster()&&(n=a.objects[b.monsterId],n instanceof Monster$$module$js$rom$monster&&(p=e(n),null==p?(console.error(`no valid location for ${hex$$module$js$rom$util(n.id)} in ${hex$$module$js$rom$util(c.id)}`),
...
nonzero(){return!(!this.part&&!this.index)}});var module$js$rom$messageid={};module$js$rom$messageid.MessageId=MessageId$$module$js$rom$messageid;class Npcs$$module$js$rom$npc extends EntityArray$$module$js$rom$entity{constructor(a){super(205);this.rom=a;this.GoaSoldier=new Npc$$module$js$rom$npc(this,11);this.LeafElder=new Npc$$module$js$rom$npc(this,13);this.LeafElderDaughter=new Npc$$module$js$rom$npc(this,17);this.LeafRabbit=new Npc$$module$js$rom$npc(this,19);this.WindmillGuard=new Npc$$module$js$rom$npc(this,20);this.SleepingWindmillGuard=new Npc$$module$js$rom$npc(this,21);this.Akahana=new Npc$$module$js$rom$npc(this,22);this.OakElder=
...
class Npc$$module$js$rom$npc extends Entity$$module$js$rom$entity{constructor(a,b){super(a.rom,b);this.npcs=a;this.spawnConditions=new Map;this.localDialogs=new Map;a=a.rom;if(204<b)throw Error(`Unavailable: ${b}`);this._used=!UNUSED_NPCS$$module$js$rom$npc.has(b)&&(143>b||192<=b);var c=addr$$module$js$rom$util(a.prg,this.dialogPointer,81920),d=196>b&&117561!==c;this.dataBase=33008|(b&252)<<6|(b&3)<<2;this.data=tuple$$module$js$rom$util(a.prg,this.dataBase,4);this.spawnPointer=116192+(b<<1);b=this.spawnBase=
readLittleEndian$$module$js$rom$util(a.prg,this.spawnPointer)+81920;for(var e;this.used&&255!==(e=a.prg[b++]);){const c=SPAWN_CONDITION_FLAGS$$module$js$rom$util.read(a.prg,b);b+=2*c.length;this.spawnConditions.set(e,c)}this.globalDialogs=[];if(d){for(e=c;;){const [b,c]=GlobalDialog$$module$js$rom$npc.parse(a.prg,e);e+=4;b.condition&&this.globalDialogs.push(b);if(c)break}for(c=[];;){d=a.prg[e++];if(255===d)break;c.push([d,a.prg[e++]])}c.length||c.push([-1,0]);d=e;for(const b of c){const [f,h]=b;c=
[];this.localDialogs.set(f,c);for(e=d+h;;){const [b,d]=LocalDialog$$module$js$rom$npc.parse(a.prg,e);e+=b.byteLength();c.push(b);if(d)break}}}}get dialogPointer(){return 117085+(this.id<<1)}get used(){return this._used}set used(a){if(a&&136<this.id&&192>this.id&&142!==this.id)throw Error(`invalid: ${this.id}`);this._used=a}spawnConditionsBytes(){const a=[];for(const b of this.spawnConditions){const [c,d]=b;a.push(c,...SPAWN_CONDITION_FLAGS$$module$js$rom$util.bytes(d))}a.push(255);return a}dialog(a){a=
a?a.id:-1;const b=this.localDialogs.get(a);if(b)return b;throw Error(`No local dialog for NPC ${hex$$module$js$rom$util(this.id)} at ${hex$$module$js$rom$util(a)}`);}spawns(a){const b=a.id;if(a=this.spawnConditions.get(a.id))return a;throw Error(`No spawn condition for NPC ${hex$$module$js$rom$util(this.id)} at ${hex$$module$js$rom$util(b)}`);}hasDialog(){const a=!(!this.globalDialogs.length&&!this.localDialogs.size);if(142<this.id&&195!==this.id&&a)throw Error(`invalid: ${this.id}`);return a}*allDialogs(){yield*this.globalDialogs;
...
const UNUSED_NPCS$$module$js$rom$npc=new Set([49,59,60,102,103,106,115,116,130,134,135,137,138,139,140,141,196]);class PortoaQueen$$module$js$rom$npc extends Npc$$module$js$rom$npc{constructor(){super(...arguments);this.id=56;this.name="Portoa Queen"}get expectedSword(){return this.localDialog(3).condition&255}set expectedSword(a){this.localDialog(3).condition=512|a}}var module$js$rom$npc={};module$js$rom$npc.Npcs=Npcs$$module$js$rom$npc;module$js$rom$npc.Npc=Npc$$module$js$rom$npc;
module$js$rom$npc.GlobalDialog=GlobalDialog$$module$js$rom$npc;module$js$rom$npc.LocalDialog=LocalDialog$$module$js$rom$npc;module$js$rom$npc.PortoaQueen=PortoaQueen$$module$js$rom$npc;function write$$module$js$pass$deterministic(a,b,...c){for(let d=0;d<c.length;d++)a[b+d]=c[d]}
function deterministicPreParse$$module$js$pass$deterministic(a){a[107924]=255;a[118213]=168;a[108620]=255;a[122987]&=7;a[122991]&=7;a[122995]&=7;a[122999]&=7;a[123003]&=7;a[123012]&=7;a[123035]&=7;a[123065]&=7;a[123141]=47;a[105393]=112;a[105397]=113;a[105079]=114;a[105963]=115;a[106565]=116;a[106721]=117;a[106725]=118;a[106729]=119;a[108037]=120;a[107457]=121;a[107461]=122;a[107465]=123;write$$module$js$pass$deterministic(a,123063,192,0);write$$module$js$pass$deterministic(a,116749,162,179);a[109190]=
254}
function deterministic$$module$js$pass$deterministic(a,b){addZombieWarp$$module$js$pass$deterministic(a);consolidateItemGrants$$module$js$pass$deterministic(a);addMezameTrigger$$module$js$pass$deterministic(a);normalizeSwords$$module$js$pass$deterministic(a,b);fixCoinSprites$$module$js$pass$deterministic(a);fixChests$$module$js$pass$deterministic(a);autoBowOfTruth$$module$js$pass$deterministic(a);makeBraceletsProgressive$$module$js$pass$deterministic(a);addTowerExit$$module$js$pass$deterministic(a);reversibleSwanGate$$module$js$pass$deterministic(a);
...
b.teleportOnThunderSword()?(teleportOnThunderSword$$module$js$pass$deterministic(a),a.townWarp.thunderSwordWarp=[a.locations.Shyron.id,65]):noTeleportOnThunderSword$$module$js$pass$deterministic(a);undergroundChannelLandBridge$$module$js$pass$deterministic(a);b.fogLampNotRequired()&&fogLampNotRequired$$module$js$pass$deterministic(a,b);b.addEastCave()?(eastCave$$module$js$pass$deterministic(a,b),b.connectGoaToLeaf()&&connectGoaToLeaf$$module$js$pass$deterministic(a)):b.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$pass$deterministic(a);
evilSpiritIslandRequiresDolphin$$module$js$pass$deterministic(a);simplifyInvisibleChests$$module$js$pass$deterministic(a);addCordelWestTriggers$$module$js$pass$deterministic(a,b);b.disableRabbitSkip()&&fixRabbitSkip$$module$js$pass$deterministic(a);patchLimeTreeLake$$module$js$pass$deterministic(a);closeCaveEntrances$$module$js$pass$deterministic(a,b);fixReverseWalls$$module$js$pass$deterministic(a);b.chargeShotsOnly()&&disableStabs$$module$js$pass$deterministic(a);b.orbsOptional()&&orbsOptional$$module$js$pass$deterministic(a);
b.noBowMode()&&noBowMode$$module$js$pass$deterministic(a);patchTooManyItemsMessage$$module$js$pass$deterministic(a)}function consolidateItemGrants$$module$js$pass$deterministic(a){a.items.GlowingLamp.itemUseData[0].message.action=11}
...
function autoBowOfTruth$$module$js$pass$deterministic(a){a=a.trigger(160);a.used=!0;a.conditions=[];a.flags=[];a.message=MessageId$$module$js$rom$messageid.of({part:0,index:0,action:21})}function fixCoinSprites$$module$js$pass$deterministic(a){for(const b of[96,100,101,102,103,104,105,106,107,108,109,111])for(const c of[0,1,2])a.patterns[b<<6|c].pixels=a.patterns[6016|c].pixels;a.objects[12].metasprite=169}
function fixReverseWalls$$module$js$pass$deterministic(a){for(const b in[4,5,8,9])a.tileEffects[9].effects[b]=24,a.tileEffects[2].effects[b]=24}function undergroundChannelLandBridge$$module$js$pass$deterministic(a){({tiles:a}=a.screens[161]);a[40]=159;a[55]=35;a[56]=35;a[57]=33;a[71]=141;a[72]=143;a[86]=153;a[87]=154;a[88]=140}
function fogLampNotRequired$$module$js$pass$deterministic(a,b){const {flags:{AlwaysTrue:c,InjuredDolphin:d,FogLamp:e,KensuInCabin:f,ReturnedFogLamp:g},items:{ShellFlute:h},locations:{BoatHouse:k,Portoa_FishermanHouse:m},npcs:l}=a;b=b.requireHealedDolphinToRide();h.itemUseData[0].want=b?c.id:d.id;l.KensuInCabin.data[0]=103;l.KensuInCabin.localDialogs.get(-1)[0].message.action=10;l.KensuInCabin.localDialogs.get(-1)[0].flags=[];l.KensuInCabin.spawnConditions.set(k.id,[g.id,~f.id]);l.Fisherman.spawnConditions.set(m.id,
...
function alarmFluteIsKeyItem$$module$js$pass$deterministic(a,b){const {items:{AlarmFlute:c},flags:{TalkedToZebuStudent:d,ZebuStudent:e},locations:{Leaf_StudentHouse:f,WaterfallCave4:g,ZebuCave:h},npcs:{WindmillGuard:k,Zebu:m}}=a;a.itemGets[49].inventoryRowStart=32;c.unique=!0;c.basePrice=0;b.zebuStudentGivesItem()?k.data[1]=49:(k.data[1]=255,b=k.dialog(f)[0],b.condition=~d.id,b.flags.push(d.id),replace$$module$js$pass$deterministic(m.spawns(h),e.id,d.id));b=[[33,.72],[31,.9]];let l=0;for(const c of a.shops)if(c.type===
module$js$rom$shop.ShopType.TOOL)for(let d=0,e=c.contents.length;d<e;d++){if(49!==c.contents[d])continue;const [e,f]=b[l++%b.length];c.contents[d]=e;a.shopDataTablesAddress&&(c.prices[d]=Math.round(c.prices[d]*f))}a.itemGets[91].itemId=29;g.spawn(25).id=16}
function brokahanaWantsMado1$$module$js$pass$deterministic(a){const {flags:{Karmine:b,Mado1:c},npcs:{Brokahana:d}}=a;a=assert$$module$js$util(d.localDialogs.get(-1))[0];if(a.condition!==~b.id)throw Error(`Bad brokahana condition: ${a.condition}`);a.condition=~c.id}
...
function closeCaveEntrances$$module$js$pass$deterministic(a,b){function c(a,b,c){for(const d of a.flags)if(d.yx===b){d.flag=c;return}throw Error(`Could not find flag to replace at ${a}:${b}`);}const {flags:{AlwaysTrue:d},locations:{CordelPlainEast:e,CordelPlainWest:f,Desert2:g,GoaValley:h,KirisaMeadow:k,LimeTreeValley:m,SaharaOutsideCave:l,ValleyOfWind:n,WaterfallValleyNorth:p,WaterfallValleySouth:q}}=a;n.entrances[1].y+=16;a.swapMetatiles([144],[7,[1,0],-194],[14,[2,0],-194],[32,[3,10],-216],[33,
[4,10],-216]);a.swapMetatiles([148,156],[104,[1,0],-194],[131,[2,0],-194],[136,[3,10],-216],[137,[4,10],-216]);a.screens[10].tiles[56]=1;a.screens[10].tiles[57]=2;a.screens[10].tiles[72]=3;a.screens[10].tiles[73]=4;a.screens[21].tiles[121]=1;a.screens[21].tiles[122]=2;a.screens[21].tiles[137]=3;a.screens[21].tiles[138]=4;a.screens[25].tiles[72]=1;a.screens[25].tiles[73]=2;a.screens[25].tiles[88]=3;a.screens[25].tiles[89]=4;a.screens[62].tiles[86]=1;a.screens[62].tiles[87]=2;a.screens[62].tiles[102]=
3;a.screens[62].tiles[103]=4;a=[[n,48],[f,48],[e,48],[p,0],[p,20],[q,116],[k,16],[l,0],[g,65]];b.addEastCave()&&b.connectLimeTreeToLeaf()&&a.push([m,16]);b.connectGoaToLeaf()&&a.push([h,1]);for(const [b,c]of a)b.flags.push(Flag$$module$js$rom$location.of({yx:c,flag:d.id}));b.paralysisRequiresPrisonKey()&&(c(f,48,750),c(e,48,750),c(p,0,728),b=Spawn$$module$js$rom$location.of({y:96,x:96,type:4,id:44}),a=Spawn$$module$js$rom$location.of({y:112,x:112,type:2,id:173}),p.spawns.splice(1,0,b),p.spawns.push(a))}
function eastCave$$module$js$pass$deterministic(a,b){const {ValleyOfWind:c,LimeTreeValley:d,SealedCave1:e}=a.locations,f=a.locations.allocate(a.locations.EastCave1),g=a.locations.allocate(a.locations.EastCave2),h=a.locations.EastCave3;f.screens=[[156,132,128,131,156],[128,129,131,134,128],[131,136,137,128,128],[129,140,133,130,132],[158,133,156,152,134]];g.screens=[[156,132,155,128,155],[128,129,129,128,129],[128,135,139,138,134],[128,140,128,133,132],[156,134,128,128,154]];for(const a of[f,g,h])a.bgm=
23,a.entrances=[],a.exits=[],a.pits=[],a.spawns=[],a.flags=[],a.height=a.screens.length,a.width=a.screens[0].length,a.extended=0,a.tilePalettes=[26,27,5],a.tileset=136,a.tileEffects=181,a.tilePatterns=[20,2],a.spritePatterns=[...e.spritePatterns],a.spritePalettes=[...e.spritePalettes];c.writeScreens2d(35,[[17,13],[9,194]]);a.tileEffects[0].effects[192]=0;f.connect(67,g,68);f.connect(64,c,52);b.connectLimeTreeToLeaf()&&(d.resizeScreens(0,1,0,0),d.writeScreens2d(0,[[12,17],[21,54],[14,15]]),f.screens[0][4]=
151,f.connect(4,d,16));f.spawns.push(Spawn$$module$js$rom$location.of({screen:33,tile:135,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:18,tile:136,timed:!1,id:2}),Spawn$$module$js$rom$location.of({screen:19,tile:137,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:50,tile:104,timed:!1,id:2}),Spawn$$module$js$rom$location.of({screen:65,tile:136,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:51,tile:152,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:3,tile:136,
timed:!0,id:2}));g.spawns.push(Spawn$$module$js$rom$location.of({screen:1,tile:136,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:17,tile:72,timed:!1,id:2}),Spawn$$module$js$rom$location.of({screen:18,tile:119,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:20,tile:40,timed:!1,id:2}),Spawn$$module$js$rom$location.of({screen:35,tile:133,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:49,tile:136,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:51,tile:138,timed:!1,
id:2}),Spawn$$module$js$rom$location.of({screen:52,tile:152,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:65,tile:130,timed:!0,id:2}));b.zebuStudentGivesItem()||g.spawns.push(Spawn$$module$js$rom$location.of({y:272,x:1144,type:2,id:49}));b.addExtraChecksToEastCave()&&(g.spawns.push(Spawn$$module$js$rom$location.of({y:272,x:1144,type:2,id:89})),g.spawns.push(Spawn$$module$js$rom$location.of({y:112,x:264,type:2,id:112})))}
function connectGoaToLeaf$$module$js$pass$deterministic(a){const {GoaValley:b,EastCave2:c,EastCave3:d}=a.locations;b.writeScreens2d(0,[[12,193,13],[14,55,53]]);a.locations.allocate(d);d.screens=[[154],[143],[158]];d.height=3;d.width=1;d.spawns.push(Spawn$$module$js$rom$location.from([24,7,35,0]));d.flags.push(Flag$$module$js$rom$location.of({screen:16,flag:a.flags.alloc(512)}));c.screens[4][0]=153;c.connect(64,d,-1);d.connect(32,b,1)}
...
function preventNpcDespawns$$module$js$pass$deterministic(a,b){function c(a,b){const c=a.indexOf(b);if(0>c)throw Error(`Could not find element ${b} in ${a}`);a.splice(c,1)}function d(a){a.reverse();for(let b=0;b<a.length;b++){const c=a[b+1];a[b].condition=c?~c.condition:-1}}const {locations:{BoatHouse:e,Brynmaer:f,Crypt_Draygon2:g,Joel_Shed:h,MtSabreNorth_SummitCave:k,MtSabreWest_Upper:m,PortoaPalace_ThroneRoom:l,Portoa_AsinaRoom:n,Portoa_FortuneTeller:p,Shyron_Temple:q,StomHouse:r,Swan_DanceHall:x,
WindmillCave:v,WaterfallCave4:y,WaterfallValleyNorth:C,ZebuCave:B,ZombieTown_HouseBasement:u},items:{GlowingLamp:t,KeyToPrison:T,LovePendant:N,StatueOfOnyx:ib},npcs:{Akahana:U,AkahanaInBrynmaer:va,Asina:Aa,AztecaInShyron:Wa,Clark:Oa,Draygon:jb,FortuneTeller:Y,Kensu:Ba,KensuInCabin:da,KensuInSwan:H,LeafRabbit:O,OakChild:P,OakElder:I,OakMother:Ca,PortoaPalaceFrontGuard:ea,PortoaQueen:V,PortoaThroneRoomBackDoorGuard:Da,Rage:la,Stom:ma,StonedAkahana:fa,Tornel:na,WindmillGuard:Ea,Zebu:oa},flags:w}=a;H.link(Ba.id);
H.used=!0;H.data=[...Ba.data];Ba.data[0]=t.id;x.spawns.find((a)=>a.isNpc()&&a.id===Ba.id).id=H.id;N.itemUseData[0].want=256|H.id;fa.linkDialog(U.id);va.used=!0;va.link(U.id);va.data=[...U.data];f.spawns.find((a)=>a.isNpc()&&a.id===U.id).id=va.id;ib.itemUseData[0].want=256|va.id;O.dialog()[2].condition=w.RescuedLeafElder.id;O.dialog()[2].flags.push(w.TalkedToLeafRabbit.id);O.dialog()[3].flags.push(w.TalkedToLeafRabbit.id);Ea.spawns(v)[1]=~w.WindmillGuardAlarmFluteTradein.id;c(U.spawns(y),~w.BehindWhirlpool.id);
c(fa.spawns(y),~w.BehindWhirlpool.id);I.dialog()[0].message.action=3;I.dialog()[1].message.action=3;I.dialog()[2].message.action=3;I.dialog()[3].message.action=3;(()=>{const [a,b,c,d]=Ca.dialog();d.condition=~w.RescuedChild.id;b.condition=-1;Ca.dialog().splice(0,4,d,c,a,b)})();for(const b of[32,33,34,124,125])d(a.npcs[b].dialog());P.dialog().unshift(...P.dialog().splice(1,1));Da.spawnConditions.set(l.id,[~w.QueenNotInThroneRoom.id,~w.MesiaRecording.id]);ea.dialog()[1].condition=w.MesiaRecording.id;
V.dialog()[3].condition=w.SwordOfWater.id;V.dialog()[3].message.action=3;V.dialog()[4].flags.push(w.PortoaQueenGoingAway.id);V.spawns(l)[1]=~w.MesiaRecording.id;V.spawns(n)[0]=w.MesiaRecording.id;V.dialog()[1].condition=w.MesiaRecording.id;Y.spawns(p)[1]=~w.MesiaRecording.id;Oa.spawnConditions.set(u.id,[~w.Clark.id]);Oa.spawnConditions.set(h.id,[w.Clark.id]);oa.localDialogs.set(B.id,[LocalDialog$$module$js$rom$npc.of(~w.TalkedToZebuInCave.id,[0,26],[w.TalkedToZebuInCave.id]),LocalDialog$$module$js$rom$npc.of(w.LeafVillagersRescued.id,
[0,29]),LocalDialog$$module$js$rom$npc.of(w.LeafAbduction.id,[0,28]),LocalDialog$$module$js$rom$npc.of(w.ZebuAtWindmill.id,[0,29]),LocalDialog$$module$js$rom$npc.of(w.UsedWindmillKey.id,[0,27,3]),LocalDialog$$module$js$rom$npc.of(-1,[0,29])]);c(oa.spawns(B),~w.BehindWhirlpool.id);na.spawnConditions.delete(m.id);ma.spawnConditions.delete(r.id);Aa.data[1]=a.items.FluteOfLime.id;Aa.dialog(n)[0].message.action=17;Aa.dialog(n)[2].message.action=17;c(Aa.spawns(n),~w.CalmedAngrySea.id);da.spawnConditions.set(e.id,
[~w.AbleToRideDolphin.id,w.ReturnedFogLamp.id]);da.dialog()[0].message.action=2;Wa.spawns(q).push(~w.ShyronMassacre.id);a.trigger(130).conditions.push(~w.ShyronMassacre.id);la.dialog()[0].condition=w.SwordOfWater.id;jb.spawnConditions.set(g.id,[~w.Draygon2.id]);oa.dialog(q).unshift(...oa.dialog(q).splice(1,1));a.trigger(128).conditions=[~w.ShyronMassacre.id,w.TalkedToZebuInShyron.id,w.SwordOfThunder.id];a.trigger(129).conditions=[];b.barrierRequiresCalmSea()&&a.trigger(132).conditions.push(w.CalmedAngrySea.id);
a.trigger(140).conditions.push(w.TalkedToZebuInCave.id);a.trigger(141).used=!1;for(const a of k.spawns)a.isTrigger()&&141===a.id&&(a.id=178);(function(a,b){b=a.findIndex(b);if(0>b)throw Error(`Could not find element in ${a}`);a.splice(b,1)})(C.spawns,(a)=>a.isTrigger()&&141===a.id);a.trigger(178).conditions.push(w.Kelbesque1.id);a.trigger(178).flags.push(~w.LeafVillagersCurrentlyAbducted.id,~w.LeafElderCurrentlyAbducted.id,w.LeafVillagersRescued.id);a.trigger(140).conditions.push(~w.Kelbesque1.id);
a.trigger(134).conditions.push(~w.Kelbesque1.id);c(T.itemUseData[0].flags,~w.LeafVillagersCurrentlyAbducted.id);a.trigger(186).conditions[0]=~w.Teleport.id;a.trigger(187).conditions[1]=~w.MesiaRecording.id}function disableStabs$$module$js$pass$deterministic(a){for(const b of[8,9,39])a.objects[b].collisionPlane=0;a.npcs.Brokahana.data[0]=a.items.FruitOfLime.id}
...
(a.dest=e.id,a.entrance=0)}function replace$$module$js$pass$deterministic(a,b,c){for(let d=0;d<a.length;d++)if(a[d]===b){a[d]=c;return}throw Error(`Could not find ${b} in ${a.join(",")}`);}var module$js$pass$deterministic={};module$js$pass$deterministic.deterministicPreParse=deterministicPreParse$$module$js$pass$deterministic;module$js$pass$deterministic.deterministic=deterministic$$module$js$pass$deterministic;const ITEM_USE_JUMP_TABLE$$module$js$rom$item=115609,ITEM_USE_DATA_TABLE$$module$js$rom$item=121826,ITEM_DATA_TABLE$$module$js$rom$item=135152,SELECTED_ITEM_TABLE$$module$js$rom$item=135227,VANILLA_PAWN_PRICE_TABLE$$module$js$rom$item=138946,MENU_NAME_TABLE$$module$js$rom$item=135302,MESSAGE_NAME_TABLE$$module$js$rom$item=166492,MENU_NAME_ENCODE$$module$js$rom$item=[["Sword","\n\x0B\f"],[" of ","\\]"],["Bracelet","<=>["],["Shield","\r\u000e\u000f"],["Armor","{\u0011\u0012"],["Magic","#%("],["Power",
"\u0013\u0014\u0015"],["Item","\u0016\u0017^"]];
class Item$$module$js$rom$item extends Entity$$module$js$rom$entity{constructor(a,b,c){c=void 0===c?{}:c;super(a.rom,b);this.itemUseJump=0;const d=this.rom;a[b]=this;this.itemUseData=[];this.trades=c.trades||[];this.use=c.use||!1;this.weight=c.weight||1;if(this.use){this.itemUseJump=readLittleEndian$$module$js$rom$util(d.prg,this.itemUseJumpPointer)+81920;c=a.itemUseJumps[this.itemUseJump];if(!c)throw Error(`Bad ItemUseJump: ${this.itemUseJump}`);a=readLittleEndian$$module$js$rom$util(d.prg,this.itemUseDataPointer)+
81920;for(var e of c)c=ItemUse$$module$js$rom$item.from(e,d.prg,a),this.itemUseData.push(c),a+=c.length}this.itemDataValue=d.prg[this.itemDataPointer];this.selectedItemValue=d.prg[this.selectedItemPointer];null!=d.shopDataTablesAddress?(e=d.shopDataTablesAddress+21*d.shopCount+2*d.scalingLevels+2*(b-13),this.basePrice=13<=b&&39>b?readLittleEndian$$module$js$rom$util(d.prg,e):0):this.basePrice=2*readLittleEndian$$module$js$rom$util(d.prg,VANILLA_PAWN_PRICE_TABLE$$module$js$rom$item+2*b);b=readLittleEndian$$module$js$rom$util(d.prg,
this.messageNamePointer)+131072;this.messageName=readString$$module$js$rom$util(d.prg,b);b=readLittleEndian$$module$js$rom$util(d.prg,this.menuNamePointer)+98304;this.menuName=MENU_NAME_ENCODE$$module$js$rom$item.reduce((a,b)=>{var [c,d]=b;return a.replace(d,c)},readString$$module$js$rom$util(d.prg,b,255))}get itemUseJumpPointer(){return ITEM_USE_JUMP_TABLE$$module$js$rom$item+2*this.id}get itemUseDataPointer(){return ITEM_USE_DATA_TABLE$$module$js$rom$item+2*this.id}get itemDataPointer(){return ITEM_DATA_TABLE$$module$js$rom$item+
this.id}get selectedItemPointer(){return SELECTED_ITEM_TABLE$$module$js$rom$item+this.id}get messageNamePointer(){return MESSAGE_NAME_TABLE$$module$js$rom$item+2*this.id}get menuNamePointer(){return MENU_NAME_TABLE$$module$js$rom$item+2*this.id}itemUseMessages(){const a=new Map;for(const b of this.itemUseData){const {message:c}=b;a.set(c.mid(),c)}return[...a.values()]}setName(a){this.messageName=this.menuName=a}get palette(){return this.itemDataValue&3}set palette(a){this.itemDataValue=this.itemDataValue&
...
return a}tradeNpc(){return"expect"!==this.kind||1!==this.want>>>8?null:this.want&255}get length(){return 2*(1+Math.max(1,this.flags.length))+("empty"===this.kind?0:"location"===this.kind?1:2)}}
...
new Item$$module$js$rom$item(this,6);this.BallOfFire=new Item$$module$js$rom$item(this,7);this.FlameBracelet=new Item$$module$js$rom$item(this,8);this.BallOfWater=new Item$$module$js$rom$item(this,9);this.BlizzardBracelet=new Item$$module$js$rom$item(this,10);this.BallOfThunder=new Item$$module$js$rom$item(this,11);this.StormBracelet=new Item$$module$js$rom$item(this,12);this.CarapaceShield=new Item$$module$js$rom$item(this,13);this.BronzeShield=new Item$$module$js$rom$item(this,14);this.PlatinumShield=
new Item$$module$js$rom$item(this,15);this.MirroredShield=new Item$$module$js$rom$item(this,16);this.CeramicShield=new Item$$module$js$rom$item(this,17);this.SacredShield=new Item$$module$js$rom$item(this,18);this.BattleShield=new Item$$module$js$rom$item(this,19);this.PsychoShield=new Item$$module$js$rom$item(this,20);this.TannedHide=new Item$$module$js$rom$item(this,21);this.LeatherArmor=new Item$$module$js$rom$item(this,22);this.BronzeArmor=new Item$$module$js$rom$item(this,23);this.PlatinumArmor=
new Item$$module$js$rom$item(this,24);this.SoldierSuit=new Item$$module$js$rom$item(this,25);this.CeramicSuit=new Item$$module$js$rom$item(this,26);this.BattleArmor=new Item$$module$js$rom$item(this,27);this.PsychoArmor=new Item$$module$js$rom$item(this,28);this.MedicalHerb=new Item$$module$js$rom$item(this,29,{use:!0,trades:[0]});this.Antidote=new Item$$module$js$rom$item(this,30,{use:!0});this.LysisPlant=new Item$$module$js$rom$item(this,31,{use:!0});this.FruitOfLime=new Item$$module$js$rom$item(this,
32,{use:!0});this.FruitOfPower=new Item$$module$js$rom$item(this,33,{use:!0});this.MagicRing=new Item$$module$js$rom$item(this,34,{use:!0});this.FruitOfRepun=new Item$$module$js$rom$item(this,35,{use:!0});this.WarpBoots=new Item$$module$js$rom$item(this,36,{use:!0});this.StatueOfOnyx=new Item$$module$js$rom$item(this,37,{use:!0,trades:[0]});this.OpelStatue=new Item$$module$js$rom$item(this,38,{use:!0});this.InsectFlute=new Item$$module$js$rom$item(this,39,{use:!0});this.FluteOfLime=new Item$$module$js$rom$item(this,
40,{use:!0,trades:[0,1,2,3]});this.GasMask=new Item$$module$js$rom$item(this,41);this.PowerRing=new Item$$module$js$rom$item(this,42);this.WarriorRing=new Item$$module$js$rom$item(this,43);this.IronNecklace=new Item$$module$js$rom$item(this,44);this.DeosPendant=new Item$$module$js$rom$item(this,45);this.RabbitBoots=new Item$$module$js$rom$item(this,46);this.LeatherBoots=new Item$$module$js$rom$item(this,47);this.ShieldRing=new Item$$module$js$rom$item(this,48);this.AlarmFlute=new Item$$module$js$rom$item(this,
49,{use:!0,trades:[0,1]});this.WindmillKey=new Item$$module$js$rom$item(this,50,{use:!0});this.KeyToPrison=new Item$$module$js$rom$item(this,51,{use:!0});this.KeyToStyx=new Item$$module$js$rom$item(this,52,{use:!0});this.FogLamp=new Item$$module$js$rom$item(this,53,{use:!0,trades:[0]});this.ShellFlute=new Item$$module$js$rom$item(this,54,{use:!0});this.EyeGlasses=new Item$$module$js$rom$item(this,55,{use:!0});this.BrokenStatue=new Item$$module$js$rom$item(this,56,{use:!0});this.GlowingLamp=new Item$$module$js$rom$item(this,
57,{use:!0});this.StatueOfGold=new Item$$module$js$rom$item(this,58,{use:!0});this.LovePendant=new Item$$module$js$rom$item(this,59,{use:!0,trades:[0]});this.KirisaPlant=new Item$$module$js$rom$item(this,60,{use:!0,trades:[0]});this.IvoryStatue=new Item$$module$js$rom$item(this,61,{use:!0,trades:[0]});this.BowOfMoon=new Item$$module$js$rom$item(this,62,{use:!0});this.BowOfSun=new Item$$module$js$rom$item(this,63,{use:!0});this.BowOfTruth=new Item$$module$js$rom$item(this,64,{use:!0});this.Refresh=
new Item$$module$js$rom$item(this,65);this.Paralysis=new Item$$module$js$rom$item(this,66);this.Telepathy=new Item$$module$js$rom$item(this,67);this.Teleport=new Item$$module$js$rom$item(this,68);this.Recover=new Item$$module$js$rom$item(this,69);this.Barrier=new Item$$module$js$rom$item(this,70);this.Change=new Item$$module$js$rom$item(this,71);this.Flight=new Item$$module$js$rom$item(this,72)}write(a){const b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const c=[];for(const d of b)c.push(d.write(a));
yield Promise.all(c)})}}const DEFAULT_ITEM_USE_JUMPS$$module$js$rom$item={115769:["expect"],115778:["screen"],115792:["empty"],115793:["screen"],115807:["location"],115857:["expect"],115881:["expect","expect"],115891:["location"],115920:["expect"],115931:[],115936:["expect","empty"],115975:["empty"],115997:["empty"],116004:["empty"],116015:["empty"],116026:["empty"],116042:["empty"],116068:["empty"],116069:["expect"],116075:["flag"],116101:["empty"],116126:["expect","expect","expect","expect"]};
var module$js$rom$item={};module$js$rom$item.Item=Item$$module$js$rom$item;module$js$rom$item.ItemUse=ItemUse$$module$js$rom$item;module$js$rom$item.Items=Items$$module$js$rom$item;function shuffleTrades$$module$js$pass$shuffletrades(a,b,c){if(b.randomizeTrades()){var {StatueOfOnyx:d,FogLamp:e,LovePendant:f,KirisaPlant:g,IvoryStatue:h}=a.items,k=new Map,m=[[d,0,"Akahana"],[e,0,"Fisherman"],[f,0,"Kensu"],[g,0,"Aryllis"],[h,0,"Slimed Kensu"]],l=m.map(([a,b,c])=>{if(0>a.trades.indexOf(b)||b>=a.itemUseData.length)throw Error(`not a trade: ${a} ${b}`);return[a.itemUseData[b],a.id,c]});c.shuffle(l);for(const [c,d]of m){const [e,f,g]=l.pop();c.itemUseData[d]=e;a.spoiler&&a.spoiler.addTrade(c.id,
...
module$js$pass$shuffletrades.buildTradeInMap=buildTradeInMap$$module$js$pass$shuffletrades;function fixDialog$$module$js$pass$fixdialog(a){function b(b){const c=u.get(b.id);if(!c)throw Error(`No trade-in for ${b.name}`);return a.items[c]}function c(a){e(a,/teach\s+you\s+the\s+magic\s+of/,"bestow upon you the")}function d(b){"number"===typeof b?b=a.items[a.itemGets[b&255].itemId]:b instanceof Item$$module$js$rom$item||(b=b.item);return`[${hex$$module$js$rom$util(b.id)}:${b.messageName}]`}function e(b,c,d){const [e,f]=b.split(":").map((a)=>parseInt(a,16));b=a.messages.parts[e][f];b.text=
b.text.replace(c,d)}const {flags:{AkahanaStatueOfOnyxTradein:f,AsinaInBackRoom:g,BehindWhirlpool:h,KensuInSwan:k,MtSabreNorthSummit:m,MtSabreWestTornel:l,PortoaQueen:n,Rage:p,RepairedStatue:q,SlimedKensu:r,StomFightReward:x,ZebuAtWindmill:v},npcs:{AkahanaInBrynmaer:y,Aryllis:C,Fisherman:B}}=a;e("03:06",",","");const u=buildTradeInMap$$module$js$pass$shuffletrades(a);v.item.isMagic()||c("00:1b");e("00:1b","[41:Refresh]",d(v.item));var t=b(y);e("02:01","an unusual statue",vague$$module$js$pass$fixdialog(t));
e("02:02","a statue",`the ${commonNoun$$module$js$pass$fixdialog(t)}`);e("02:02","[29:Gas Mask]",d(f));x.item.isMagic()||c("03:01");e("03:01","[43:Telepathy]",d(x));t=findTornelTradeIn$$module$js$pass$fixdialog(a);e("03:01","[06:Tornado Bracelet]",d(t));e("05:0a","[06:Tornado Bracelet]",d(t));e("05:0a","[44:Teleport]",d(l));t=b(B);e("09:01","[35:Fog Lamp]",d(t));e("09:04","[35:Fog Lamp]",d(t));e("09:05","[35:Fog Lamp]",d(t));e("09:06","lamp",commonNoun$$module$js$pass$fixdialog(t));t=a.npcs.PortoaQueen.dialog()[3].condition;
...
e[0];a=[new Set,new Set];for(d=0;2>d;d++)a[d]=new Set([...b[d].get(c.tilePatterns[0]),...b[d].get(c.tilePatterns[1])]);c=this.random.pick([...a[0]]);a=this.random.pick([...a[1]]);for(const b of e)b.tilePalettes[0]=c,b.tilePalettes[1]=a}}}shuffleBackgrounds2(){if(this.flags.shuffleSpritePalettes()){var a=[new Set,new Set];for(var b of this.rom.locations)if(b.used){var c=paletteTypes$$module$js$rom$tileset(this.rom.tilesets[(b.tileset&127)>>2].id,b.id);for(var d=0;3>d;d++)for(var e=0;e<c[e];e++)a[e].add(b.tilePalettes[e])}b=
...
module$js$pass$shufflepalettes.shufflePalettes=shufflePalettes$$module$js$pass$shufflepalettes;function toggleMaps$$module$js$pass$togglemaps(a,b,c){removeEarlyWall$$module$js$pass$togglemaps(a,b,c)}function removeEarlyWall$$module$js$pass$togglemaps(a,b,c){b.removeEarlyWall()&&(!b.addEastCave()||!b.connectGoaToLeaf()||1>c.nextInt(2)?({ZebuCave:b}=a.locations,b.screens[2][1]=145,b.spawns[0]=b.spawns.pop(),a.flags.free(b.flags.pop().flag)):({EastCave3:a}=a.locations,a.screens[1][0]=129,a.spawns.pop(),a.flags.pop()))}var module$js$pass$togglemaps={};module$js$pass$togglemaps.toggleMaps=toggleMaps$$module$js$pass$togglemaps;const KEY_NAMES$$module$js$pass$unidentifieditems="Curious Key;Bronze Key;Silver Key;Ancient Key;Small Key;Shiny Key;Mysterious Key;Magic Key;Piano Key".split(";"),FLUTE_NAMES$$module$js$pass$unidentifieditems="Wooden Flute;Metal Flute;Horn of Plenty;Ocarina;Pan Pipes;Bugle;Bagpipes;Kazoo;Magic Whistle;Dog Whistle;Recorder;Accordion;Harmonica;Sousaphone;Trombone;Violin;Cello".split(";"),LAMP_NAMES$$module$js$pass$unidentifieditems="Bronze Lamp;Magic Lamp;Dull Lamp;Shimmering Lamp;Oil Lamp;Broken Lamp;Frog Lamp;Smog Lamp".split(";"),
...
this.base+4).set(this.data)}}var module$js$rom$adhocspawn={};module$js$rom$adhocspawn.AdHocSpawn=AdHocSpawn$$module$js$rom$adhocspawn;const area$$module$js$rom$area=initializer$$module$js$rom$util();
...
module$js$rom$bosses.Bosses=Bosses$$module$js$rom$bosses;module$js$rom$bosses.Boss=Boss$$module$js$rom$bosses;const FLAG$$module$js$rom$flags=Symbol(),FALSE$$module$js$rom$flags={assumeFalse:!0},TRUE$$module$js$rom$flags={assumeTrue:!0},TRACK$$module$js$rom$flags={track:!0},IGNORE$$module$js$rom$flags={};
...
movable$$module$js$rom$flags(27,TRACK$$module$js$rom$flags);this.TalkedToFortuneTeller=movable$$module$js$rom$flags(29,TRACK$$module$js$rom$flags);this.QueenRevealed=movable$$module$js$rom$flags(30,TRACK$$module$js$rom$flags);this[31]=obsolete$$module$js$rom$flags(521);this.QueenNotInThroneRoom=movable$$module$js$rom$flags(32);this.ReturnedFogLamp=movable$$module$js$rom$flags(33,TRACK$$module$js$rom$flags);this[34]=dialogProgression$$module$js$rom$flags("Sahara elder");this[35]=dialogProgression$$module$js$rom$flags("Sahara elder daughter");
this[36]=obsolete$$module$js$rom$flags(317);this[37]=obsolete$$module$js$rom$flags(310);this[38]=obsolete$$module$js$rom$flags(765);this.ShyronMassacre=fixed$$module$js$rom$flags(39,TRACK$$module$js$rom$flags);this.ChangeWoman=fixed$$module$js$rom$flags(40);this.ChangeAkahana=fixed$$module$js$rom$flags(41);this.ChangeSoldier=fixed$$module$js$rom$flags(42);this.ChangeStom=fixed$$module$js$rom$flags(43);this[45]=dialogProgression$$module$js$rom$flags("Shyron sages");this[46]=obsolete$$module$js$rom$flags(301);
this.UsedBowOfTruth=fixed$$module$js$rom$flags(47);this[49]=dialogProgression$$module$js$rom$flags("Zombie town");this[50]=obsolete$$module$js$rom$flags(311);this[52]=dialogProgression$$module$js$rom$flags("Akahana in waterfall cave");this.CuredAkahana=movable$$module$js$rom$flags(53,TRACK$$module$js$rom$flags);this[54]=dialogProgression$$module$js$rom$flags("Akahana Shyron");this[55]=obsolete$$module$js$rom$flags(322);this.LeafAbduction=movable$$module$js$rom$flags(56,TRACK$$module$js$rom$flags);
this[57]=obsolete$$module$js$rom$flags(321);this.TalkedToZebuInCave=movable$$module$js$rom$flags(58,TRACK$$module$js$rom$flags);this.TalkedToZebuInShyron=movable$$module$js$rom$flags(59,TRACK$$module$js$rom$flags);this[60]=obsolete$$module$js$rom$flags(315);this[61]=dialogProgression$$module$js$rom$flags("Asina in Shyron temple");this.FoundKensuInDanceHall=movable$$module$js$rom$flags(62,TRACK$$module$js$rom$flags);this[63]=obsolete$$module$js$rom$flags((a)=>{var b;return 186===(null===(b=a.trigger)||
void 0===b?void 0:b.id)?580:324});this[64]=dialogProgression$$module$js$rom$flags("Tornel in Shyron temple");this[65]=obsolete$$module$js$rom$flags(263);this[68]=obsolete$$module$js$rom$flags(263);this.RescuedChild=fixed$$module$js$rom$flags(69,TRACK$$module$js$rom$flags);this.RescuedLeafElder=movable$$module$js$rom$flags(71);this[72]=dialogProgression$$module$js$rom$flags("Treasure hunter embarked");this[73]=obsolete$$module$js$rom$flags(257);this[74]=dialogProgression$$module$js$rom$flags("Boat owner");
this[75]=dialogToggle$$module$js$rom$flags("Shyron sick men");this[76]=dialogToggle$$module$js$rom$flags("Shyron training men 1");this[77]=dialogToggle$$module$js$rom$flags("Shyron training men 2");this[78]=obsolete$$module$js$rom$flags(262);this[79]=obsolete$$module$js$rom$flags(299);this.GivenStatueToAkahana=movable$$module$js$rom$flags(80);this[81]=obsolete$$module$js$rom$flags(326);this.TalkedToDwarfMother=movable$$module$js$rom$flags(82,TRACK$$module$js$rom$flags);this.LeadingChild=fixed$$module$js$rom$flags(83,
TRACK$$module$js$rom$flags);this[85]=dialogProgression$$module$js$rom$flags("Zebu rescued");this[86]=dialogProgression$$module$js$rom$flags("Tornel rescued");this[87]=dialogProgression$$module$js$rom$flags("Asina rescued");this.MtSabreGuardsDespawned=movable$$module$js$rom$flags(91,TRUE$$module$js$rom$flags);this[94]=obsolete$$module$js$rom$flags(653);this[95]=obsolete$$module$js$rom$flags(515);this.TalkedToStomInSwan=movable$$module$js$rom$flags(97,TRACK$$module$js$rom$flags);this[99]=obsolete$$module$js$rom$flags(327);
this.CuredKensu=movable$$module$js$rom$flags(101);this[103]=obsolete$$module$js$rom$flags(267);this[104]=obsolete$$module$js$rom$flags(260);this.StonedPeopleCured=movable$$module$js$rom$flags(106,TRACK$$module$js$rom$flags);this[108]=obsolete$$module$js$rom$flags(284);this.CurrentlyRidingDolphin=fixed$$module$js$rom$flags(-111,TRACK$$module$js$rom$flags);this.ParalyzedKensuInTavern=fixed$$module$js$rom$flags(112);this.ParalyzedKensuInDanceHall=fixed$$module$js$rom$flags(113);this.FoundKensuInTavern=
movable$$module$js$rom$flags(114,TRACK$$module$js$rom$flags);this[115]=dialogProgression$$module$js$rom$flags("Startled man in Leaf");this[117]=obsolete$$module$js$rom$flags(313);this[118]=dialogProgression$$module$js$rom$flags("Kensu in Goa");this[119]=obsolete$$module$js$rom$flags(264);this[120]=obsolete$$module$js$rom$flags(268);this[121]=obsolete$$module$js$rom$flags(320);this[122]=obsolete$$module$js$rom$flags(266);this[125]=obsolete$$module$js$rom$flags(319);this[126]=dialogProgression$$module$js$rom$flags("Mt Sabre guards 1");
this[127]=dialogProgression$$module$js$rom$flags("Mt Sabre guards 2");this.AlarmFluteUsedOnce=fixed$$module$js$rom$flags(118);this.FluteOfLimeUsedOnce=fixed$$module$js$rom$flags(119);this[130]=obsolete$$module$js$rom$flags(320);this[131]=dialogProgression$$module$js$rom$flags("Rescued Leaf elder");this.LeafVillagersCurrentlyAbducted=movable$$module$js$rom$flags(132);this.LeafElderCurrentlyAbducted=movable$$module$js$rom$flags(133);this[135]=obsolete$$module$js$rom$flags(261);this[136]=obsolete$$module$js$rom$flags(306);
this[137]=dialogProgression$$module$js$rom$flags("Dead Stom's girlfriend");this[138]=dialogProgression$$module$js$rom$flags("Dead Stom");this[139]=obsolete$$module$js$rom$flags(566);this[141]=obsolete$$module$js$rom$flags(311);this[143]=obsolete$$module$js$rom$flags(643);this[144]=dialogProgression$$module$js$rom$flags("Stoned people gone");this[146]=obsolete$$module$js$rom$flags(296);this[150]=dialogToggle$$module$js$rom$flags("Leaf elder daughter");this[151]=dialogToggle$$module$js$rom$flags("Leaf villager");
this[152]=dialogProgression$$module$js$rom$flags("Nadare villager");this.AbleToRideDolphin=movable$$module$js$rom$flags(155,TRACK$$module$js$rom$flags);this.PortoaQueenGoingAway=movable$$module$js$rom$flags(156);this[160]=obsolete$$module$js$rom$flags(295);this[163]=dialogToggle$$module$js$rom$flags("Portoa queen/fortune teller");this.WokeKensuInLighthouse=movable$$module$js$rom$flags(164,TRACK$$module$js$rom$flags);this[165]=obsolete$$module$js$rom$flags(305);this[166]=dialogProgression$$module$js$rom$flags("Oak elder 1");
this[167]=dialogToggle$$module$js$rom$flags("Swan dancer");this[168]=dialogProgression$$module$js$rom$flags("Oak elder 2");this.TalkedToLeafRabbit=movable$$module$js$rom$flags(169,TRACK$$module$js$rom$flags);this[170]=obsolete$$module$js$rom$flags(285);this[171]=obsolete$$module$js$rom$flags(336);this[173]=obsolete$$module$js$rom$flags(338);this[174]=obsolete$$module$js$rom$flags(339);this[175]=obsolete$$module$js$rom$flags(340);this[176]=obsolete$$module$js$rom$flags(341);this[177]=obsolete$$module$js$rom$flags(342);
this[178]=obsolete$$module$js$rom$flags(343);this[179]=obsolete$$module$js$rom$flags(344);this[180]=obsolete$$module$js$rom$flags(345);this[181]=obsolete$$module$js$rom$flags(346);this[182]=obsolete$$module$js$rom$flags(287);this[183]=obsolete$$module$js$rom$flags(348);this[184]=obsolete$$module$js$rom$flags(349);this[185]=obsolete$$module$js$rom$flags(286);this[186]=obsolete$$module$js$rom$flags(350);this[187]=obsolete$$module$js$rom$flags(351);this[188]=obsolete$$module$js$rom$flags(352);this[189]=
obsolete$$module$js$rom$flags(288);this[190]=obsolete$$module$js$rom$flags(289);this[191]=obsolete$$module$js$rom$flags(354);this[192]=obsolete$$module$js$rom$flags(355);this[193]=obsolete$$module$js$rom$flags(356);this[194]=obsolete$$module$js$rom$flags(290);this[195]=obsolete$$module$js$rom$flags(357);this[196]=obsolete$$module$js$rom$flags(358);this[197]=obsolete$$module$js$rom$flags(363);this[198]=obsolete$$module$js$rom$flags(364);this[199]=obsolete$$module$js$rom$flags(291);this[200]=obsolete$$module$js$rom$flags(292);
this[201]=obsolete$$module$js$rom$flags(362);this[202]=obsolete$$module$js$rom$flags(317);this[203]=obsolete$$module$js$rom$flags(298);this[204]=obsolete$$module$js$rom$flags(284);this[205]=obsolete$$module$js$rom$flags(276);this[206]=obsolete$$module$js$rom$flags(293);this[207]=obsolete$$module$js$rom$flags(307);this[208]=obsolete$$module$js$rom$flags(296);this[209]=obsolete$$module$js$rom$flags(309);this[210]=obsolete$$module$js$rom$flags(361);this[211]=obsolete$$module$js$rom$flags(294);this[212]=
obsolete$$module$js$rom$flags(347);this[213]=dialogToggle$$module$js$rom$flags("Portoa queen 1");this[214]=dialogToggle$$module$js$rom$flags("Portoa queen 2");this[215]=dialogToggle$$module$js$rom$flags("Portoa queen 3");this[216]=dialogProgression$$module$js$rom$flags("Kensu rescued");this[217]=dialogToggle$$module$js$rom$flags("Stoned pair");this[218]=dialogProgression$$module$js$rom$flags("Kensu gone from tavern");this[219]=dialogToggle$$module$js$rom$flags("In Sabera's trap");this[220]=obsolete$$module$js$rom$flags(367);
this[222]=obsolete$$module$js$rom$flags(300);this[223]=obsolete$$module$js$rom$flags(283);this[224]=dialogProgression$$module$js$rom$flags("Dead Akahana");this[228]=obsolete$$module$js$rom$flags(316);this[229]=obsolete$$module$js$rom$flags(366);this[230]=obsolete$$module$js$rom$flags(365);this[231]=obsolete$$module$js$rom$flags(303);this[232]=dialogProgression$$module$js$rom$flags("Dead Shyron villager");this[233]=dialogProgression$$module$js$rom$flags("Dead Shyron guard");this[234]=dialogProgression$$module$js$rom$flags("Tower message 1");
this[235]=dialogProgression$$module$js$rom$flags("Tower message 2");this[236]=dialogProgression$$module$js$rom$flags("Tower message 3");this[237]=dialogProgression$$module$js$rom$flags("Mesia");this.TalkedToZebuStudent=movable$$module$js$rom$flags(238,TRACK$$module$js$rom$flags);this[256]=obsolete$$module$js$rom$flags(302);this[257]=obsolete$$module$js$rom$flags(263);this[258]=obsolete$$module$js$rom$flags(264);this[259]=obsolete$$module$js$rom$flags(265);this[261]=obsolete$$module$js$rom$flags(294);
this[262]=obsolete$$module$js$rom$flags(291);this[263]=obsolete$$module$js$rom$flags(274);this[264]=obsolete$$module$js$rom$flags(317);this.UsedBowOfMoon=movable$$module$js$rom$flags(265);this.UsedBowOfSun=movable$$module$js$rom$flags(266);this[267]=obsolete$$module$js$rom$flags(284);this[268]=obsolete$$module$js$rom$flags(353);this.LeafElder=tracked$$module$js$rom$flags(-257);this.OakElder=tracked$$module$js$rom$flags(-258);this.WaterfallCaveSwordOfWaterChest=tracked$$module$js$rom$flags(-259);this.StxyLeftUpperSwordOfThunderChest=
tracked$$module$js$rom$flags(-260);this.MesiaInTower=tracked$$module$js$rom$flags(260);this.SealedCaveBallOfWindChest=tracked$$module$js$rom$flags(-262);this.MtSabreWestTornadoBraceletChest=tracked$$module$js$rom$flags(-263);this.GiantInsect=tracked$$module$js$rom$flags(-264);this.Kelbesque1=tracked$$module$js$rom$flags(-265);this.Rage=tracked$$module$js$rom$flags(-266);this.AryllisBasementChest=tracked$$module$js$rom$flags(-267);this.Mado1=tracked$$module$js$rom$flags(-268);this.StormBraceletChest=
tracked$$module$js$rom$flags(-269);this.WaterfallCaveRiverLeftChest=tracked$$module$js$rom$flags(272);this.Mado2=tracked$$module$js$rom$flags(274);this.StxyRightMiddleChest=tracked$$module$js$rom$flags(276);this.BattleArmorChest=tracked$$module$js$rom$flags(283);this.Draygon1=tracked$$module$js$rom$flags(284);this.SealedCaveSmallRoomBackChest=tracked$$module$js$rom$flags(285);this.SealedCaveBigRoomNortheastChest=tracked$$module$js$rom$flags(286);this.FogLampCaveFrontChest=tracked$$module$js$rom$flags(287);
this.MtHydraRightChest=tracked$$module$js$rom$flags(288);this.SaberaUpstairsLeftChest=tracked$$module$js$rom$flags(289);this.EvilSpiritIslandLowerChest=tracked$$module$js$rom$flags(290);this.Sabera2=tracked$$module$js$rom$flags(291);this.SealedCaveSmallRoomFrontChest=tracked$$module$js$rom$flags(292);this.CordelGrass=tracked$$module$js$rom$flags(293);this.Kelbesque2=tracked$$module$js$rom$flags(294);this.OakMother=tracked$$module$js$rom$flags(295);this.PortoaQueen=tracked$$module$js$rom$flags(296);
this.AkahanaStatueOfOnyxTradein=tracked$$module$js$rom$flags(297);this.OasisCaveFortressBasementChest=tracked$$module$js$rom$flags(298);this.Brokahana=tracked$$module$js$rom$flags(299);this.EvilSpiritIslandRiverLeftChest=tracked$$module$js$rom$flags(300);this.Deo=tracked$$module$js$rom$flags(301);this.Vampire1=tracked$$module$js$rom$flags(302);this.OasisCaveNorthwestChest=tracked$$module$js$rom$flags(303);this.AkahanaFluteOfLimeTradein=tracked$$module$js$rom$flags(304);this.ZebuStudent=tracked$$module$js$rom$flags(305);
this.WindmillGuardAlarmFluteTradein=tracked$$module$js$rom$flags(306);this.MtSabreNorthBackOfPrisonChest=tracked$$module$js$rom$flags(307);this.ZebuInShyron=tracked$$module$js$rom$flags(308);this.FogLampCaveBackChest=tracked$$module$js$rom$flags(309);this.InjuredDolphin=tracked$$module$js$rom$flags(310);this.Clark=tracked$$module$js$rom$flags(311);this.Sabera1=tracked$$module$js$rom$flags(312);this.KensuInLighthouse=tracked$$module$js$rom$flags(313);this.RepairedStatue=tracked$$module$js$rom$flags(314);
this.UndergroundChannelUnderwaterChest=tracked$$module$js$rom$flags(315);this.KirisaMeadow=tracked$$module$js$rom$flags(316);this.Karmine=tracked$$module$js$rom$flags(317);this.Aryllis=tracked$$module$js$rom$flags(318);this.MtHydraSummitChest=tracked$$module$js$rom$flags(319);this.AztecaInPyramid=tracked$$module$js$rom$flags(320);this.ZebuAtWindmill=tracked$$module$js$rom$flags(321);this.MtSabreNorthSummit=tracked$$module$js$rom$flags(322);this.StomFightReward=tracked$$module$js$rom$flags(323);this.MtSabreWestTornel=
tracked$$module$js$rom$flags(324);this.AsinaInBackRoom=tracked$$module$js$rom$flags(325);this.BehindWhirlpool=tracked$$module$js$rom$flags(326);this.KensuInSwan=tracked$$module$js$rom$flags(327);this.SlimedKensu=tracked$$module$js$rom$flags(328);this.SealedCaveBigRoomSouthwestChest=tracked$$module$js$rom$flags(336);this.MtSabreWestRightChest=tracked$$module$js$rom$flags(338);this.MtSabreNorthMiddleChest=tracked$$module$js$rom$flags(339);this.FortressMadoHellwayChest=tracked$$module$js$rom$flags(340);
this.SaberaUpstairsRightChest=tracked$$module$js$rom$flags(341);this.MtHydraFarLeftChest=tracked$$module$js$rom$flags(342);this.StxyLeftLowerChest=tracked$$module$js$rom$flags(343);this.KarmineBasementLowerMiddleChest=tracked$$module$js$rom$flags(344);this.EastCaveNortheastChest=tracked$$module$js$rom$flags(345);this.OasisCaveEntranceAcrossRiverChest=tracked$$module$js$rom$flags(346);this.EvilSpiritIslandExitChest=tracked$$module$js$rom$flags(348);this.FortressSaberaMiddleChest=tracked$$module$js$rom$flags(349);
this.MtSabreNorthUnderBridgeChest=tracked$$module$js$rom$flags(350);this.KirisaPlantCaveChest=tracked$$module$js$rom$flags(351);this.FortressMadoUpperNorthChest=tracked$$module$js$rom$flags(352);this.Vampire2=tracked$$module$js$rom$flags(353);this.FortressSaberaNorthwestChest=tracked$$module$js$rom$flags(354);this.FortressMadoLowerCenterNorthChest=tracked$$module$js$rom$flags(355);this.OasisCaveNearEntranceChest=tracked$$module$js$rom$flags(356);this.MtHydraLeftRightChest=tracked$$module$js$rom$flags(357);
this.FortressSaberaSoutheastChest=tracked$$module$js$rom$flags(358);this.KensuInCabin=tracked$$module$js$rom$flags(359);this.MtSabreWestNearKensuChest=tracked$$module$js$rom$flags(361);this.MtSabreWestLeftChest=tracked$$module$js$rom$flags(362);this.FortressMadoUpperBehindWallChest=tracked$$module$js$rom$flags(363);this.PyramidChest=tracked$$module$js$rom$flags(364);this.CryptRightChest=tracked$$module$js$rom$flags(365);this.KarmineBasementLowerLeftChest=tracked$$module$js$rom$flags(366);this.FortressMadoLowerSoutheastChest=
tracked$$module$js$rom$flags(367);this.FogLampCaveMiddleNorthMimic=tracked$$module$js$rom$flags(368);this.FogLampCaveMiddleSouthwestMimic=tracked$$module$js$rom$flags(369);this.WaterfallCaveFrontMimic=tracked$$module$js$rom$flags(370);this.EvilSpiritIslandRiverRightMimic=tracked$$module$js$rom$flags(371);this.MtHydraFinalCaveMimic=tracked$$module$js$rom$flags(372);this.StxyLeftNorthMimic=tracked$$module$js$rom$flags(373);this.StxyRightNorthMimic=tracked$$module$js$rom$flags(374);this.StxyRightSouthMimic=
tracked$$module$js$rom$flags(375);this.CryptLeftPitMimic=tracked$$module$js$rom$flags(376);this.KarmineBasementUpperMiddleMimic=tracked$$module$js$rom$flags(377);this.KarmineBasementUpperRightMimic=tracked$$module$js$rom$flags(378);this.KarmineBasementLowerRightMimic=tracked$$module$js$rom$flags(379);this.SwordOfWind=tracked$$module$js$rom$flags(512);this.SwordOfFire=tracked$$module$js$rom$flags(513);this.SwordOfWater=tracked$$module$js$rom$flags(514);this.SwordOfThunder=tracked$$module$js$rom$flags(515);
this.Crystalis=tracked$$module$js$rom$flags(516);this.BallOfWind=tracked$$module$js$rom$flags(517);this.TornadoBracelet=tracked$$module$js$rom$flags(518);this.BallOfFire=tracked$$module$js$rom$flags(519);this.FlameBracelet=tracked$$module$js$rom$flags(520);this.BallOfWater=tracked$$module$js$rom$flags(521);this.BlizzardBracelet=tracked$$module$js$rom$flags(522);this.BallOfThunder=tracked$$module$js$rom$flags(523);this.StormBracelet=tracked$$module$js$rom$flags(524);this.CarapaceShield=tracked$$module$js$rom$flags(525);
this.BronzeShield=tracked$$module$js$rom$flags(526);this.PlatinumShield=tracked$$module$js$rom$flags(527);this.MirroredShield=tracked$$module$js$rom$flags(528);this.CeramicShield=tracked$$module$js$rom$flags(529);this.SacredShield=tracked$$module$js$rom$flags(530);this.BattleShield=tracked$$module$js$rom$flags(531);this.PsychoShield=tracked$$module$js$rom$flags(532);this.TannedHide=tracked$$module$js$rom$flags(533);this.LeatherArmor=tracked$$module$js$rom$flags(534);this.BronzeArmor=tracked$$module$js$rom$flags(535);
this.PlatinumArmor=tracked$$module$js$rom$flags(536);this.SoldierSuit=tracked$$module$js$rom$flags(537);this.CeramicSuit=tracked$$module$js$rom$flags(538);this.BattleArmor=tracked$$module$js$rom$flags(539);this.PsychoArmor=tracked$$module$js$rom$flags(540);this.MedicalHerb=tracked$$module$js$rom$flags(541);this.Antidote=tracked$$module$js$rom$flags(542);this.LysisPlant=tracked$$module$js$rom$flags(543);this.FruitOfLime=tracked$$module$js$rom$flags(544);this.FruitOfPower=tracked$$module$js$rom$flags(545);
this.MagicRing=tracked$$module$js$rom$flags(546);this.FruitOfRepun=tracked$$module$js$rom$flags(547);this.WarpBoots=tracked$$module$js$rom$flags(548);this.StatueOfOnyx=tracked$$module$js$rom$flags(549);this.OpelStatue=tracked$$module$js$rom$flags(550);this.InsectFlute=tracked$$module$js$rom$flags(551);this.FluteOfLime=tracked$$module$js$rom$flags(552);this.GasMask=tracked$$module$js$rom$flags(553);this.PowerRing=tracked$$module$js$rom$flags(554);this.WarriorRing=tracked$$module$js$rom$flags(555);
this.IronNecklace=tracked$$module$js$rom$flags(556);this.DeosPendant=tracked$$module$js$rom$flags(557);this.RabbitBoots=tracked$$module$js$rom$flags(558);this.LeatherBoots=tracked$$module$js$rom$flags(559);this.ShieldRing=tracked$$module$js$rom$flags(560);this.AlarmFlute=tracked$$module$js$rom$flags(561);this.WindmillKey=tracked$$module$js$rom$flags(562);this.KeyToPrison=tracked$$module$js$rom$flags(563);this.KeyToStxy=tracked$$module$js$rom$flags(564);this.FogLamp=tracked$$module$js$rom$flags(565);
this.ShellFlute=tracked$$module$js$rom$flags(566);this.EyeGlasses=tracked$$module$js$rom$flags(567);this.BrokenStatue=tracked$$module$js$rom$flags(568);this.GlowingLamp=tracked$$module$js$rom$flags(569);this.StatueOfGold=tracked$$module$js$rom$flags(570);this.LovePendant=tracked$$module$js$rom$flags(571);this.KirisaPlant=tracked$$module$js$rom$flags(572);this.IvoryStatue=tracked$$module$js$rom$flags(573);this.BowOfMoon=tracked$$module$js$rom$flags(574);this.BowOfSun=tracked$$module$js$rom$flags(575);
this.BowOfTruth=tracked$$module$js$rom$flags(576);this.Refresh=tracked$$module$js$rom$flags(577);this.Paralysis=tracked$$module$js$rom$flags(578);this.Telepathy=tracked$$module$js$rom$flags(579);this.Teleport=tracked$$module$js$rom$flags(580);this.Recover=tracked$$module$js$rom$flags(581);this.Barrier=tracked$$module$js$rom$flags(582);this.Change=tracked$$module$js$rom$flags(583);this.Flight=tracked$$module$js$rom$flags(584);this.CalmedAngrySea=tracked$$module$js$rom$flags(643);this.OpenedJoelShed=
tracked$$module$js$rom$flags(647);this.Draygon2=tracked$$module$js$rom$flags(653);this.OpenedCrypt=tracked$$module$js$rom$flags(654);this.OpenedStxy=tracked$$module$js$rom$flags(688);this.OpenedSwanGate=tracked$$module$js$rom$flags(691);this.OpenedPrison=tracked$$module$js$rom$flags(728);this.OpenedSealedCave=tracked$$module$js$rom$flags(750);this.AlwaysTrue=fixed$$module$js$rom$flags(752,TRUE$$module$js$rom$flags);this.WarpLeaf=tracked$$module$js$rom$flags(757);this.WarpBrynmaer=tracked$$module$js$rom$flags(758);
this.WarpOak=tracked$$module$js$rom$flags(759);this.WarpNadare=tracked$$module$js$rom$flags(760);this.WarpPortoa=tracked$$module$js$rom$flags(761);this.WarpAmazones=tracked$$module$js$rom$flags(762);this.WarpJoel=tracked$$module$js$rom$flags(763);this.WarpZombie=tracked$$module$js$rom$flags(-764);this.WarpSwan=tracked$$module$js$rom$flags(764);this.WarpShyron=tracked$$module$js$rom$flags(765);this.WarpGoa=tracked$$module$js$rom$flags(766);this.WarpSahara=tracked$$module$js$rom$flags(767);this.Sword=
pseudo$$module$js$rom$flags(this);this.Money=pseudo$$module$js$rom$flags(this);this.BreakStone=pseudo$$module$js$rom$flags(this);this.BreakIce=pseudo$$module$js$rom$flags(this);this.FormBridge=pseudo$$module$js$rom$flags(this);this.BreakIron=pseudo$$module$js$rom$flags(this);this.TravelSwamp=pseudo$$module$js$rom$flags(this);this.ClimbWaterfall=pseudo$$module$js$rom$flags(this);this.BuyHealing=pseudo$$module$js$rom$flags(this);this.BuyWarp=pseudo$$module$js$rom$flags(this);this.ShootingStatue=pseudo$$module$js$rom$flags(this);
...
d,a,c);this[b]=c;0>c.id?this.unallocated.set(~c.id,c):this[c.id]||(this[c.id]=c)}for(b=256;384>b;b++)c=`Check ${hex$$module$js$rom$util(b&255)}`,this[b]?this[b].fixed||this.unallocated.has(b)||this.unallocated.set(b,new Flag$$module$js$rom$flags(this,c,~b,{fixed:!0})):this[b]=new Flag$$module$js$rom$flags(this,c,b,{fixed:!0});for(b=384;640>b;b++)this[b]||(this[b]=new Flag$$module$js$rom$flags(this,(512>b?"Buffer ":"Item ")+hex$$module$js$rom$util(b),b,{fixed:!0}));for(const b of a.locations)for(const a of b.flags)this[a.flag]||
(this[a.flag]=wallFlag$$module$js$rom$flags(this,a.flag))}defrag(){function a(a){return()=>a}var b,c=new Map;for(var d=0;768>d;d++){const a=this[d],e=null===(b=a)||void 0===b?void 0:b.obsolete;e&&(c.set(d,(b)=>b.set?-1:e.call(a,b)),delete this[d])}b=0;for(d=767;b<d;){if(this[b]||this.unallocated.has(b)){b++;continue}const e=this[d];e&&!e.fixed&&(c.set(d,a(b)),e.id=b,this[b]=e,delete this[d],b++);d--}this.remapFlags(c);for(var e of this.unallocated){const [a,b]=e;this[a]||(this.unallocated.delete(a),
(this[a]=b).id=a)}c=[];for(e=0;768>e;e++)this[e]||c.push(hex3$$module$js$rom$util(e));console.log(`Free flags: ${c.join(" ")}`)}insertZombieWarpFlag(){const a=new Map;if(this[756])throw Error("No space to insert warp flag");const b=~this.WarpZombie.id;if(0>b)throw Error("Bad WarpZombie id");for(let c=756;c<b;c++)this[c]=this[c+1],this[c].id=c,a.set(c+1,()=>c);this.WarpZombie.id=b;this[b]=this.WarpZombie;this.remapFlags(a)}remap(a,b){this.remapFlags(new Map([[a,()=>b]]))}remapFlags(a){function b(b,
c){for(let e=b.length-1;0<=e;e--){var d=b[e];0>d&&(d=~d);d=a.get(d);null!=d&&(d=d(Object.assign({},c,{index:e})),0<=d?b[e]=0>b[e]?~d:d:b.splice(e,1))}}function c(b,c){const d=a.get(0>b?~b:b);if(null==d)return b;c=d(c);if(0>c)throw Error("Bad flag delete");return 0>b?~c:c}for(var d of this.rom.locations)for(const a of d.flags)a.flag=c(a.flag,{location:d});for(const a of this.rom.npcs){for(const c of a.spawnConditions){const [d,e]=c;b(e,{npc:a,spawn:d})}for(const b of a.globalDialogs)b.condition=c(b.condition,
{npc:a,dialog:!0});for(const e of a.localDialogs){[,d]=e;for(const e of d)e.condition=c(e.condition,{npc:a,dialog:!0}),b(e.flags,{npc:a,dialog:!0,set:!0})}}for(const a of this.rom.triggers)b(a.conditions,{trigger:a}),b(a.flags,{trigger:a,set:!0});for(const a of this.rom.itemGets)b(a.flags,{set:!0});for(const a of this.rom.items)for(const d of a.itemUseData)"flag"===d.kind&&(d.want=c(d.want,{})),b(d.flags,{set:!0})}alloc(a){if(512!==(void 0===a?0:a))throw Error("Cannot allocate outside 2xx");for(a=
640;768>a;)return this[a]||(this[a]=wallFlag$$module$js$rom$flags(this,a)),a;throw Error("No free flags.");}free(a){delete this[a]}}function flagName$$module$js$rom$flags(a){return"Flag "+hex3$$module$js$rom$util(a)}function wallFlag$$module$js$rom$flags(a,b){return new Flag$$module$js$rom$flags(a,"Wall "+hex$$module$js$rom$util(b&255),b,{fixed:!0})}var module$js$rom$flags={};module$js$rom$flags.Flag=Flag$$module$js$rom$flags;module$js$rom$flags.Flags=Flags$$module$js$rom$flags;class Hitbox$$module$js$rom$hitbox extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.base=218769+(b<<2);this.coordinates=tuple$$module$js$rom$util(a.prg,this.base,4)}get w(){return this.coordinates[1]}set w(a){this.coordinates[1]=a}get x0(){return signed$$module$js$rom$util(this.coordinates[0])}set x0(a){this.coordinates[0]=unsigned$$module$js$rom$util(a)}get x1(){return this.x0+this.w}get h(){return this.coordinates[3]}set h(a){this.coordinates[3]=a}get y0(){return signed$$module$js$rom$util(this.coordinates[2])}set y0(a){this.coordinates[2]=
unsigned$$module$js$rom$util(a)}get y1(){return this.y0+this.h}write(a){a.rom.subarray(this.base,this.base+4).set(this.coordinates)}}var module$js$rom$hitbox={};module$js$rom$hitbox.Hitbox=Hitbox$$module$js$rom$hitbox;const GRANT_ITEM_TABLE$$module$js$rom$itemget=251605,GET_TO_ITEM_BASE$$module$js$rom$itemget=122214,GET_TO_ITEM_THRESHOLD$$module$js$rom$itemget=73;
class ItemGets$$module$js$rom$itemget extends EntityArray$$module$js$rom$entity{constructor(a){super(113);this.rom=a;this.actionGrants=new Map;for(var b=0;113>b;b++)this[b]=new ItemGet$$module$js$rom$itemget(a,b);for(b=GRANT_ITEM_TABLE$$module$js$rom$itemget;255!==a.prg[b];){const c=a.prg[b++],d=a.prg[b++];this.actionGrants.set(c,d)}}write(a){const b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){var c=[];for(const d of b)c.push(d.write(a));yield Promise.all(c);c=GRANT_ITEM_TABLE$$module$js$rom$itemget;
for(const d of b.actionGrants){const [b,f]=d;a.rom[c++]=b;a.rom[c++]=f}})}}
class ItemGet$$module$js$rom$itemget extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.itemPointer=GET_TO_ITEM_BASE$$module$js$rom$itemget+b;this._itemId=a.prg[this.itemPointer];this.tablePointer=121600+2*b;let c=this.tableBase=readLittleEndian$$module$js$rom$util(a.prg,this.tablePointer)+81920;this.inventoryRowStart=a.prg[c++];this.inventoryRowLength=a.prg[c++];this.acquisitionAction=MessageId$$module$js$rom$messageid.from(a.prg,c);this.flags=ITEM_GET_FLAGS$$module$js$rom$util.read(a.prg,
c+2);this.key=254===a.prg[c+2+2*this.flags.length+1];0!==b&&this.tableBase===readLittleEndian$$module$js$rom$util(a.prg,122214)+81920&&(this.key=!1,this.flags=[])}get itemId(){return this._itemId}set itemId(a){if(this.id<GET_TO_ITEM_THRESHOLD$$module$js$rom$itemget)throw Error(`${this.id}`);this._itemId=a}isLosable(){return LOSABLE_ROWS$$module$js$rom$itemget.has(this.inventoryRowStart)}copyFrom(a){this.inventoryRowStart=a.inventoryRowStart;this.inventoryRowLength=a.inventoryRowLength;this.acquisitionAction=
a.acquisitionAction;this.flags=[...a.flags];this.key=a.key}write(a){const b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){a.rom[b.itemPointer]=b.itemId;var c=[b.inventoryRowStart,b.inventoryRowLength,...b.acquisitionAction.data,...ITEM_GET_FLAGS$$module$js$rom$util.bytes(b.flags),b.key?254:255];c=yield a.write(c,114688,131071,`ItemGetData ${hex$$module$js$rom$util(b.id)}`);writeLittleEndian$$module$js$rom$util(a.rom,b.tablePointer,c-81920)})}}
const LOSABLE_ROWS$$module$js$rom$itemget=new Set([4,8,16]);var module$js$rom$itemget={};module$js$rom$itemget.ItemGets=ItemGets$$module$js$rom$itemget;module$js$rom$itemget.ItemGet=ItemGet$$module$js$rom$itemget;class DataTable$$module$js$rom$messages extends Array{constructor(a,b,c,d,e){e=void 0===e?1<d?(...a)=>a:(a)=>a:e;super(c);this.rom=a;this.base=b;this.count=c;this.width=d;for(let f=0;f<c;f++)this[f]=e(...slice$$module$js$rom$util(a.prg,b+f*d,d))}}
...
f=0,g=!1,h=[],k=new Map;for(var m=0;m<this.text.length;m++){var l=this.text[m],n=this.text[m+1];/[\s\n#]/.test(l)?(g||a(" "),g=!0):"{"===l?(":"===n?a("{:HERO:}",6):(l=this.text.indexOf(":",m),l=Number.parseInt(this.text.substring(m+1,l),16),n=this.messages.extraWords[6][l],k.set(n,`{${l.toString(16)}:${n}}`),b(n)),m=this.text.indexOf("}",m)):"["===l?(":"===n?a("[:ITEM:]",Math.max(...this.messages.rom.items.map((a)=>a.messageName.length))):(l=this.text.indexOf(":",m),l=Number.parseInt(this.text.substring(m+
1,l),16),n=this.messages.rom.items[l].messageName,k.set(n,`[${l.toString(16)}:${n}]`),b(n)),m=this.text.indexOf("]",m)):a(l)}d.push(...h);m=d.join("");for(const a of k){const [b,c]=a;m.includes(b)&&(m=m.split(b).join(c))}this.text=m}}checkText(){let a=0,b=0;for(let d=0;d<this.text.length;d++){const e=this.text[d];var c=this.text[d+1];if("\n"===e){if(a++,b=1,3<a)return!1}else if("#"===e)"\n"===c&&d++,a=b=0;else if("{"===e||"["===e){if(":"===c){if(b="{"===e?b+6:b+Math.max(...this.messages.rom.items.map((a)=>
...
const d=new Map;for(var e of this.messages(a)){e.fixText();a=e.mid();var f=c.get(e.addr);if(f=null!=f&&d.get(f))f.push(a);else{c.set(e.addr,a);d.set(a,[]);f=e.text;var g=[];for(let c=0,d=f.length;c<=d;c++){var h=f[c],k=CLOSERS$$module$js$rom$messages[h];if(PUNCTUATION$$module$js$rom$messages[h]||k||c===d){var m=f[c+1];k&&(c=Math.max(c,f.indexOf(k,c)));if(g.length){k=" "!==h&&"'"!==h||!m||PUNCTUATION$$module$js$rom$messages[m]?"":h;m=g.join("");var l=b.length;h=m.length+(" "===h?1:0);g=[];b.push({str:m,
id:l,chain:k,bytes:h,used:0,suffixes:new Set,mid:a})}}else g.push(h)}}}c=new Map;for(e=b.length-1;0<=e;e--)for(a=b[e],f=a.bytes-2;0<=f;f--)for(g=a.str.substring(f),h=0,k=a,m=a.bytes-f-1;;){(l=c.get(g))||c.set(g,l={chains:h,missing:f,saving:-g.length,str:g,words:new Set});l.words.add(e);l.saving+=m;for(let a=h;0<=a;a--)b[e+a].suffixes.add(l);if(!k.chain)break;g+=k.chain;k=b[e+ ++h];g+=k.str;m+=k.bytes}e=new Set;a=[];f=(a,b)=>{({saving:a}=a);({saving:b}=b);return b-a};g=[...c.values()].sort(f);for(h=
0;g.length&&h<MAX_TABLE_LENGTH$$module$js$rom$messages;){e.has(g[0].str)&&(g.sort(f),e.clear());const {str:n,saving:p,missing:q,words:r,chains:x}=g.shift();if(0>=p)break;h+=n.length+3;k=a.length;m=new Set;for(const a of r){l=b[a];for(const a of[l.mid,...d.get(l.mid)||[]])m.add(a)}a.push({bytes:128>k?[k+128]:[5,k-128],mids:m,str:n});for(const a of r)for(k=0;k<=x;k++){m=b[a+k];l=m.bytes-(k?0:q);for(const a of m.suffixes)a.saving-=l-m.used,e.add(a.str);m.used=l}if(128===a.length){for(const a of c.values())a.saving-=
...
f.set(m,e=[]),e.push(k);for(var l of f.values())l.sort((a,b)=>{({str:{length:a}}=a);({str:{length:b}}=b);return b-a});k=seq$$module$js$rom$util(b.parts.length,()=>[]);for(var n of b.messages(d)){m=n.text;m=m.replace(/([\[{])([^\]}]*)[\]}](.|$)/g,(a,b,c,d)=>{if(d&&!PUNCTUATION$$module$js$rom$messages[d])return a;" "===d&&(d="");if("["===b&&":ITEM:"===c)return`[8]${d}`;if("{"===b&&":HERO:"===c)return`[4]${d}`;c=/^([0-9a-f]+):/.exec(c);if(!c)throw Error(`Bad message text: ${a}`);a=Number.parseInt(c[1],
16);return`[${"{"===b?6:7}][${a}]${d}`});for(var p of f.get(n.mid())||[]){const {str:a,bytes:b}=p;m=m.replace(new RegExp(a+"( [ &0-9]|.|$)","g"),(a,c)=>{if(c&&!PUNCTUATION$$module$js$rom$messages[c])return a;" "===c&&(c="");return b.map((a)=>`[${a}]`).join("")+c})}l=["[01]"];d=[];d.push(1);for(let a=0,b=m.length;a<b;a++)if(e=m[a],e===Messages$$module$js$rom$messages.CONTINUED)d.push(3,1),l.push("[03][01]"),"\n"===m[a+1]&&a++;else if("\n"===e)d.push(2)," "===m[a+1]&&a++,l.push("[02]");else if("["===
e){e=m.indexOf("]",a);if(0>=e)throw Error(`bad text: ${m}`);g=Number(m.substring(a+1,e));if(isNaN(g))throw Error(`bad text: ${m}`);d.push(g);l.push(`[${hex$$module$js$rom$util(g)}]`);a=e}else if(" "===e&&" "===m[a+1]){for(e=a+2;" "===m[e];)e++;d.push(9,e-a);l.push(`[09][${hex$$module$js$rom$util(e-a)}]`);a=e-1}else d.push(e.charCodeAt(0)),l.push(e);d.push(0);l.push("[0]");n.bytes=d;n.hex=l.join("");m=b.banks[n.part]<<13;const c=m-40960;k[n.part][n.id]=a.write(d,m,m+8192,`Message ${n.mid()}`).then((a)=>
...
class Writer$$module$js$rom$writer{constructor(a,b){this.rom=a;this.chr=b;this.chunks=[];this.writes=[];this.promises=[];this.free=[]}report(){for(const a of this.chunks){const b=a.free();b&&console.log(`Free: ${b} bytes ${hex$$module$js$rom$util(a.pos)}..${hex$$module$js$rom$util(a.end)}`)}}alloc(a,b){for(;page$$module$js$rom$writer(b-1)>page$$module$js$rom$writer(a);){const b=page$$module$js$rom$writer(a)+1<<13;this.addChunk(new Chunk$$module$js$rom$writer(a,b-1));a=b}this.addChunk(new Chunk$$module$js$rom$writer(a,
b))}addChunk(a){this.chunks.push(a);this.free[a.page]=(this.free[a.page]||0)+a.free()}write(a,b,c,d){const e=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=page$$module$js$rom$writer(b),g=page$$module$js$rom$writer(c-1),h=new Promise((b,c)=>{e.writes.push({data:a,resolve:b,reject:c,startPage:f,endPage:g,name:d})});e.promises.push(h.catch(()=>{}));return h})}commit(){const a=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){for(;a.writes.length;){var b=
a.writes;a.writes=[];const c=a.promises;a.promises=[];b.sort((a,b)=>a.endPage-a.startPage-(b.endPage-b.startPage)||b.data.length-a.data.length);for(const c of b)b=a.find(c),0<=b?c.resolve(b):a.writeOne(c);yield Promise.all(c);yield 0;yield 0;yield 0}})}find(a){var {data:b,startPage:c,endPage:d}=a;for(const e of this.chunks)if(!(e.page<c||e.page>d)&&(a=e.find(b,this.rom),0<=a))return a;return-1}writeOne(a){for(const b of this.chunks)if(!(b.page<a.startPage||b.page>a.endPage||b.free()<a.data.length)){this.rom.subarray(b.pos,
b.pos+a.data.length).set(a.data);a.resolve(b.pos);this.free[b.page]-=a.data.length;DEBUG$$module$js$rom$writer&&DEBUG_PAGE$$module$js$rom$writer.has(b.page)&&console.log(`${a.name}: writing ${a.data.length} bytes at ${hex$$module$js$rom$util(b.pos)}: ${Array.from(a.data,hex$$module$js$rom$util).join(" ")} | FREE ${this.free.map((a,b)=>`${hex$$module$js$rom$util(2*b)}:${a}`).join("/")}`);b.pos+=a.data.length;return}if(DEBUG$$module$js$rom$writer){console.log(`LOOKING FOR CHUNK: ${a.data.length} bytes in ${hex$$module$js$rom$util(a.startPage)}..${hex$$module$js$rom$util(a.endPage)}`);
for(const b of this.chunks)b.page<a.startPage||b.page>a.endPage?console.log(`wrong page: ${hex$$module$js$rom$util(b.pos)}..${hex$$module$js$rom$util(b.end)} -> ${hex$$module$js$rom$util(b.page)}`):b.free()<a.data.length&&console.log(`not enough free: ${hex$$module$js$rom$util(b.pos)}..${hex$$module$js$rom$util(b.end)} -> ${b.free()}`);console.log(this.chunks)}console.log(`${a.name}: WRITE FAILED ${a.data.length} bytes: ${Array.from(a.data,hex$$module$js$rom$util).join(" ")}`);a.reject(Error(`Could not find sufficient chunk in ${hex$$module$js$rom$util(a.startPage)}..${hex$$module$js$rom$util(a.endPage)} to write ${a.name}: ${a.data}`))}}
const DEBUG$$module$js$rom$writer=!1,DEBUG_PAGE$$module$js$rom$writer=new Set([14,15]);var module$js$rom$writer={};module$js$rom$writer.Writer=Writer$$module$js$rom$writer;class Rom$$module$js$rom{constructor(a){const b=16+(a[6]&4?512:0),c=b+16384*a[4];this.prg=a.subarray(b,c);this.chr=a.subarray(c);this.shopCount=Rom$$module$js$rom.SHOP_COUNT.get(a);this.scalingLevels=Rom$$module$js$rom.SCALING_LEVELS.get(a);this.uniqueItemTableAddress=Rom$$module$js$rom.UNIQUE_ITEM_TABLE.get(a);this.shopDataTablesAddress=Rom$$module$js$rom.SHOP_DATA_TABLES.get(a);this.telepathyTablesAddress=Rom$$module$js$rom.TELEPATHY_TABLES.get(a);this.omitItemGetDataSuffix=Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX.get(a);
...
this.items=new Items$$module$js$rom$item(this);this.shops=seq$$module$js$rom$util(44,(a)=>new Shop$$module$js$rom$shop(this,a));this.slots=new Slots$$module$js$rom$slots(this);this.npcs=new Npcs$$module$js$rom$npc(this);this.bossKills=seq$$module$js$rom$util(14,(a)=>new BossKill$$module$js$rom$bosskill(this,a));this.wildWarp=new WildWarp$$module$js$rom$wildwarp(this);this.townWarp=new TownWarp$$module$js$rom$townwarp(this);this.flags=new Flags$$module$js$rom$flags(this);this.bosses=new Bosses$$module$js$rom$bosses(this)}trigger(a){if(128>
...
b.hasSpawns)for(const c of b.spawns)if(!(c.data[2]&7)){const d=c.data[2]&128?1:0,e=hex$$module$js$rom$util(c.data[3]+80);(a[e]=a[e]||{})[`${d}:${b.spritePatterns[d].toString(16)}:${b.spritePalettes[d].toString(16)}`]={pal:b.spritePalettes[d],pat:b.spritePatterns[d],slot:d}}return a}get locationMonsters(){const a={};for(const b of this.locations){if(!b.used||!b.hasSpawns)continue;const c=a["$"+hex$$module$js$rom$util(b.id)]={};for(const a of b.spawns)if(!(a.data[2]&7)){const b=a.data[2]&128?1:0,d=
a.data[3]+80;c[`${b}:${d.toString(16)}`]=(c[`${b}:${d.toString(16)}`]||0)+1}}return a}writeData(){const a=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){Rom$$module$js$rom.SHOP_COUNT.set(a.prg,a.shopCount);Rom$$module$js$rom.SCALING_LEVELS.set(a.prg,a.scalingLevels);Rom$$module$js$rom.UNIQUE_ITEM_TABLE.set(a.prg,a.uniqueItemTableAddress);Rom$$module$js$rom.SHOP_DATA_TABLES.set(a.prg,a.shopDataTablesAddress);Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX.set(a.prg,a.omitItemGetDataSuffix);
Rom$$module$js$rom.OMIT_LOCAL_DIALOG_SUFFIX.set(a.prg,a.omitLocalDialogSuffix);Rom$$module$js$rom.COMPRESSED_MAPDATA.set(a.prg,a.compressedMapData);const b=new Writer$$module$js$rom$writer(a.prg,a.chr);b.alloc(83192,97792);b.alloc(103417,109568);b.alloc(110080,113920);b.alloc(116602,117085);b.alloc(117477,121076);b.alloc(122342,123142);b.alloc(123392,123840);b.alloc(135450,136296);b.alloc(172032,195584);a.telepathyTablesAddress?b.alloc(121076,121600):b.alloc(121420,121600);const c=[],d=(a)=>{for(const d of a)c.push(d.write(b))};
d(a.locations);d(a.objects);d(a.hitboxes);d(a.triggers);d(a.npcs);d(a.tilesets);d(a.tileEffects);d(a.screens);d(a.adHocSpawns);a.itemGets.write(b);a.slots.write(b);a.items.write(b);d(a.shops);d(a.bossKills);d(a.patterns);a.wildWarp.write(b);a.townWarp.write(b);c.push(a.telepathy.write(b));c.push(a.messages.write(b));c.push(b.commit());yield Promise.all(c).then(()=>{});b.report()})}analyzeTiles(){}disjointTilesets(){var a=[];for(var b of this.locations){if(!b.used)continue;var c=b.tileset;const d=
b.extended?256:0;for(const e of b.screens)for(const b of e)(a[b+d]||(a[b+d]=new Set)).add(c)}b=seq$$module$js$rom$util(256,()=>new UnionFind$$module$js$unionfind);for(c=0;c<a.length;c++)if(a[c])for(var d of this.screens[c].allTilesSet())b[d].union([...a[c]]);for(a=0;a<b.length;a++)d=b[a].sets().map((a)=>[...a].map(hex$$module$js$rom$util).join(" ")).join(" | "),console.log(`Tile ${hex$$module$js$rom$util(a)}: ${d}`)}swapMetatiles(a,...b){var c=new Map,d=seq$$module$js$rom$util(256);const e=new Map,
f=(a)=>Array.isArray(a)?a[0]:0>a?~a:a;for(var g of b){for(var h=0;h<g.length-1;h++)if(Array.isArray(g[h])){var k=g[h];e.set(k[0],k[1]);g[h]=k[0]}for(h=0;h<g.length-1;h++){k=g[h];const a=g[h+1];0>k||0>a||(c.set(a,k),d[a]=k)}}g=new Set;c=new Set;a=new Set(a);for(var m of this.locations)if(m.used&&a.has(m.tileset)){c.add(m.tileEffects);for(var l of m.allScreens())g.add(l)}for(var n of g)for(let a=0,b=n.tiles.length;a<b;a++)n.tiles[a]=d[n.tiles[a]];for(var p of a){d=this.tilesets[(p&127)>>>2];for(var q of b)for(m=
0;m<q.length-1;m++){l=f(q[m]);n=f(q[m+1]);for(a=0;4>a;a++)d.tiles[a][l]=d.tiles[a][n];d.attrs[l]=d.attrs[n];if(32>n&&d.alternates[n]!==n){if(32<=l)throw Error(`Cannot unflag: ${p} ${l} ${n} ${d.alternates[n]}`);d.alternates[l]=d.alternates[n]}}for(var r of e){const [a,b]=r;d.alternates[a]=b}}for(const a of c){p=this.tileEffects[a-179];for(const a of b)for(q=0;q<a.length-1;q++)r=f(a[q]),d=f(a[q+1]),p.effects[r]=p.effects[d];for(const a of e.keys())p.effects[a]|=8}}moveFlag(a,b){function c(c){for(let d=
0;d<c.length;d++)c[d]===a&&(c[d]=b),c[d]===~a&&(c[d]=~b)}for(const a of this.triggers)c(a.conditions),c(a.flags);for(const d of this.npcs){for(const a of d.spawnConditions.values())c(a);for(const c of[d.globalDialogs,...d.localDialogs.values()])for(const d of c)d.condition===a&&(d.condition=b),d.condition===~a&&(d.condition=~b)}if(512===(a&-256)&&512===(b&-256))for(const c of this.locations)for(const d of c.flags)d.flag===a&&(d.flag=b)}nextFreeTrigger(){for(const a of this.triggers)if(!a.used)return a;
throw Error("Could not find an unused trigger.");}static load(a,b){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const c=yield pickFile$$module$js$rom(b);a&&(yield a(c));return new Rom$$module$js$rom(c)})}}Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX=module$js$rom$option.RomOption.bit(82624,0);Rom$$module$js$rom.OMIT_LOCAL_DIALOG_SUFFIX=module$js$rom$option.RomOption.bit(82624,1);Rom$$module$js$rom.COMPRESSED_MAPDATA=module$js$rom$option.RomOption.bit(82624,2);
...
const EXPECTED_CRC32$$module$js$rom=466849842,ADJUSTMENTS$$module$js$rom=[[79430,2,6],[83306,0,255],[84715,9,255],[85433,8,128],[87133,255,0],[88093,0,255],[88142,219,255],[89007,240,128],[89014,223,128],[89015,150,128],[89920,2,255],[89953,141,255],[89957,141,255],[91391,11,10],[96298,16,1],[96343,16,1],[106242,64,128],[106243,51,50],[106976,64,192],[106977,61,52],[118533,71,72],[119569,32,160],[119570,48,0],[118777,96,224],[182928,2,0],[193907,2,0],[195300,95,0]];var module$js$rom={};
...
function shuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){function g(b){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){m.assemble(yield d.read(b),b);m.patchRom(a)})}if(EXPAND_PRG$$module$js$patch&&524288>a.length){var h=new Uint8Array(a.length+262144);h.subarray(0,262160).set(a.subarray(0,262160));h.subarray(524304).set(a.subarray(262160));h[4]<<=1;a=h}if("number"!==typeof b)throw Error("Bad seed");h=crc32$$module$js$crc32(b.toString(16).padStart(8,
...
_DISABLE_TRIGGER_SKIP:!0,_DISABLE_WARP_BOOTS_REUSE:c.disableShopGlitch(),_DISABLE_WILD_WARP:!1,_DISPLAY_DIFFICULTY:!0,_EXTRA_PITY_MP:!0,_FIX_COIN_SPRITES:!0,_FIX_OPEL_STATUE:!0,_FIX_SHAKING:!0,_FIX_VAMPIRE:!0,_HARDCORE_MODE:c.hardcoreMode(),_HAZMAT_SUIT:c.changeGasMaskToHazmatSuit(),_LEATHER_BOOTS_GIVE_SPEED:c.leatherBootsGiveSpeed(),_MAX_SCALING_IN_TOWER:c.maxScalingInTower(),_NERF_FLIGHT:!0,_NERF_MADO:!0,_NERF_WILD_WARP:c.nerfWildWarp(),_NEVER_DIE:c.neverDie(),_NORMALIZE_SHOP_PRICES:!0,_PITY_HP_AND_MP:!0,
_PROGRESSIVE_BRACELET:!0,_RABBIT_BOOTS_CHARGE_WHILE_WALKING:c.rabbitBootsChargeWhileWalking(),_REQUIRE_HEALED_DOLPHIN_TO_RIDE:c.requireHealedDolphinToRide(),_REVERSIBLE_SWAN_GATE:!0,_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_SIMPLIFY_INVISIBLE_CHESTS:!0,_SOFT_RESET_SHORTCUT:!0,_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword(),_TRAINER:c.trainer(),_TWELVTH_WARP_POINT:!0,_UNIDENTIFIED_ITEMS:c.unidentifiedItems(),_ZEBU_STUDENT_GIVES_ITEM:c.zebuStudentGivesItem()},m=new Assembler$$module$js$6502;
deterministicPreParse$$module$js$pass$deterministic(a.subarray(16));var l=Object.keys(k).filter((a)=>k[a]).map((a)=>`define ${a} 1\n`).join("");m.assemble(l,"flags.s");yield g("preshuffle.s");h=new Random$$module$js$random(h);l=new Rom$$module$js$rom(a);l.flags.defrag();"object"==typeof window&&(window.rom=l);l.spoiler=new Spoiler$$module$js$rom$spoiler(l);e&&(e.spoiler=l.spoiler);deterministic$$module$js$pass$deterministic(l,c);toggleMaps$$module$js$pass$togglemaps(l,c,h);yield g("postparse.s");
l.scalingLevels=48;l.uniqueItemTableAddress=m.expand("KeyItemData");c.shuffleShops()&&shuffleShops$$module$js$patch(l,c,h);shuffleGoa$$module$js$pass$shufflegoa(l,h);randomizeWalls$$module$js$patch(l,c,h);crumblingPlatforms$$module$js$pass$crumblingplatforms(l,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(l,c,h);c.randomizeThunderTeleport()&&randomizeThunderWarp$$module$js$pass$randomizethunderwarp(l,h);rescaleMonsters$$module$js$pass$rescalemonsters(l,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(l,
c,h);shuffleTrades$$module$js$pass$shuffletrades(l,c,h);c.randomizeMaps()&&shuffleMazes$$module$js$pass$shufflemazes(l,c,h);c.shuffleMimics()&&shuffleMimics$$module$js$pass$shufflemimics(l,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$pass$shufflemonsters(l,c,h);var n=new World$$module$js$logic$world(l,c);if(n=yield(new Graph$$module$js$logic$graph([n.getLocationList()])).shuffle(c,h,void 0,f,l.spoiler))for(var p of n){const [a,b]=p;l.slots[a&255]=b&255}else return[a,-1];rescaleShops$$module$js$patch(l,
m,c.bargainHunting()?h:void 0);identifyKeyItemsForDifficultyBuffs$$module$js$patch(l);c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(l);shuffleMusic$$module$js$patch(l,c,h);shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);c.blackoutMode()&&blackoutMode$$module$js$patch(l);misc$$module$js$patch(l,c,h);fixDialog$$module$js$pass$fixdialog(l);c.buffDyna()&&buffDyna$$module$js$patch(l,c);c.trainer()&&
(l.wildWarp.locations=[10,26,53,72,109,110,140,170,172,176,182,159,166,88,92,0]);yield l.writeData();buffDyna$$module$js$patch(l,c);p=yield postParsedShuffle$$module$js$patch(a,h,b,c,m,g);EXPAND_PRG$$module$js$patch&&(h=a.subarray(16),h.subarray(507904,524288).set(h.subarray(245760,262144)));return[a,p]})}
...
function shuffleMusic$$module$js$patch(a,b,c){if(b.randomizeMusic()){class m{constructor(a){this.addr=a}get bgm(){return a.prg[this.addr]}set bgm(b){a.prg[this.addr]=b}}var d=[124088,124560,125339,126129,126479,126851,127367,127761,228400];b=[];var e=new DefaultMap$$module$js$util(()=>[]),f=new Set;for(var g of a.locations){if(95===g.id||0===g.id||!g.used)continue;const a=g.data.music;f.add(g.bgm);"number"===typeof a?b.push(g):e.get(a).push(g)}for(var h of d)g=new m(h),e.set(g,[g]),f.add(g.bgm);f=
...
123],[114,320,130],[50,105,94],[51,64,198],[52,83,71],[53,345,140],[54,301,119],[55,233,118],[56,234,88],[57,295,92],[58,234,49],[59,274,117],[60,338,226],[61,23,17],[62,206,241],[63,101,6],[64,207,110],[65,92,117],[66,279,126],[67,202,138],[68,124,202],[69,304,128],[70,248,35],[71,277,3],[72,15,25],[80,82,107],[82,134,219],[83,59,219],[84,52,55],[85,241,97],[86,123,23],[116,115,3],[87,70,9],[117,84,9],[88,32,38],[121,32,16],[122,40,16],[123,40,38],[90,161,97],[16,327,123],[92,256,79],[93,36,139],
[94,14,229],[95,345,225],[96,18,94],[97,234,96],[98,18,118],[99,36,54],[100,175,97],[101,139,40],[102,66,160],[105,131,201],[106,76,226],[107,18,100],[108,193,103],[120,199,103],[109,205,103],[115,256,67],[110,24,38],[111,44,97]],KEY$$module$js$tracker=new Set([16,18,35,38,97]),TRADES$$module$js$tracker=new Set([41,62,68,71,72]);
class Graph$$module$js$tracker{constructor(a,b,c){this.rom=a;this.world=b;this.flags=c;this.slots=new Map;this.items=new Map;this.slotElts=new Map;this.has=new Set;this.names=new Map;window.GRAPH=this;this.graph=b.getLocationList();this.grid=document.getElementsByClassName("grid")[0];this.map=document.getElementsByClassName("map")[0];a=new DefaultMap$$module$js$util(()=>new Set);for(const b of this.graph.requirements){const [c,d]=b;for(const b of d)for(const d of b)a.get(d).add(c)}this.unlocks=new Map([...a].map((a)=>
{var [b,c]=a;return[b,[...c]]}));this.grid.addEventListener("click",(a)=>{let b=a.target;for(;b&&!b.dataset.slot;)b=b.parentElement;b&&(this.toggle(b),a.preventDefault())})}toggle(a,b){const c=Number(a.dataset.slot);b=a.classList.toggle("got",b);a.dataset.item&&(b?this.has.add(c):this.has.delete(c));this.update()}addSlot(a,b,c){const d=document.createElement("div"),e=this.rom.itemGets[a],f=e&&this.rom.items[e.itemId];if(f&&f.unique||KEY$$module$js$tracker.has(a))d.classList.add("key"),b--,c--;b--;
c--;d.dataset.slot=String(a);d.style.left=b+"px";d.style.top=c+"px";b=document.createElement("div");d.appendChild(b);b.textContent=112<=a?"Mimic":this.rom.items[e.itemId].messageName.replace(" ","\u00a0");this.flags.randomizeTrades()&&TRADES$$module$js$tracker.has(a)&&d.classList.add("boss");this.slotElts.set(a,d);this.map.appendChild(d)}addItem(a,b,...c){b=Number.parseInt(b.substring(1),16);const d=document.getElementsByClassName(a)[0],e=document.createElement("div");d.appendChild(e);d.dataset.slot=
String(b);d.dataset.item=String(b);this.names.set(a.replace(/-/g," "),d);for(const a of c)this.names.set(a.replace(/-/g," "),d)}addExtraFlags(){}update(){for(var a of this.slotElts.values())a.dataset.state=a.classList.contains("got")?"":"blocked";a=this.traverse();for(const b of a)256===(b&-128)&&(a=this.slotElts.get(b&255))&&!a.classList.contains("got")&&(a.dataset.state="available")}traverse(){const a=new Set([...this.has].map((a)=>a|512)),b=new Set,c=new Set,d=new Set(this.graph.requirements.keys());
for(const f of d)if(d.delete(f),!b.has(f)){var e=this.graph.requirements.get(f);for(const g of e)if(containsAll$$module$js$tracker(a,g)){b.add(f);e=[];256===(f&-128)?c.add(f&255):(isItem$$module$js$tracker(f)&&e.push(f&255),a.add(f));for(const b of a)for(const a of this.unlocks.get(b)||[]){if(!this.graph.requirements.has(a))throw console.dir(this),Error(`Adding bad node ${a} from unlock ${b}`);d.add(a)}break}}return b}addVoiceRecognition(){try{let a=!1;const b=this.recognition=new SpeechRecognition,
c=new SpeechGrammarList;c.addFromString(`
          #JSGF V1.0;
          grammar command;
          public <item> = ${[...this.names.keys()].join(" | ")};
          public <command> = track <item> | untrack <item>;
      `,1);b.lang="en-US";b.grammars=c;b.interimResults=!1;b.maxAlternatives=10;b.onstart=()=>{a=!1};b.onresult=(c)=>{c=c.results[c.results.length-1];if(c.isFinal){var d=!1;for(const b of c){var f=b.transcript.toLowerCase().replace(/[^a-z ]/g,"");"stop listening"===f&&(d=a=!0);f=/([auo][nm] ?)?tr[au]c?k?(?:ed)? ?(.+)/.exec(f);if(!f)continue;const c=this.names.get(f[2]);if(c){this.toggle(c,!f[1]);d=!0;break}}d||console.log(`No match: ${[...c].map((a)=>a.transcript).join(", ")}`);b.stop()}};b.onend=
()=>{a||b.start()};b.start();return!0}catch(a){return console.error(a),!1}}}function polyfill$$module$js$tracker(...a){const b=window;for(let c of a)if("function"===typeof b[c]){b[a[0]]=b[c];return}console.error(`Could not polyfill ${a[0]}`)}polyfill$$module$js$tracker("SpeechRecognition","webkitSpeechRecognition");polyfill$$module$js$tracker("SpeechGrammarList","webkitSpeechGrammarList");function isItem$$module$js$tracker(a){return 512===(a&-128)}
function containsAll$$module$js$tracker(a,b){for(const c of b)if(!a.has(c))return!1;return!0}let voice$$module$js$tracker=!1,flags$$module$js$tracker="@Casual";for(const a of location.hash.substring(1).split("&")){const [b,c]=a.split("=");"flags"===b&&(flags$$module$js$tracker=decodeURIComponent(c));"voice"===b&&(voice$$module$js$tracker=!0)}function initItemGrants$$module$js$tracker(a){a.itemGets.actionGrants=new Map([[37,41],[57,58],[59,71],[60,62],[132,70],[178,66],[180,65]])}
