...
a.assumeGhettoFlight())),l=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),p=h(d("Assume teleport skip",a.assumeTeleportSkip())),q=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),x=h(d("Allow rabbit skip",!a.disableRabbitSkip())),v=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),y=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),B=h(d("Assume wild warp",a.assumeWildWarp())),
C=d("Allow wild warp",a.allowWildWarp()),u=d("Sword magic optional",!a.guaranteeSwordMagic()),t=d("Matching sword optional",!a.guaranteeMatchingSword()),T=d("Gas mask optional",!a.guaranteeGasMask()),O=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),jb=d("Calm sea optional",!a.barrierRequiresCalmSea()),ka=d("Prison key optional",!a.paralysisRequiresPrisonKey()),va=d("Windmill optional",!a.sealedCaveRequiresWindmill()),wa=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
xa=d("Barrier magic optional",!a.guaranteeBarrier()),Wa=d("Refresh magic optional",!a.guaranteeRefresh()),Xa=d("Telepathy optional for Deo",!a.saharaRabbitsRequireTelepathy()),X=d("Lime Tree connects to Leaf",a.connectLimeTreeToLeaf()),kb=d("Buffed medical herb",a.buffMedicalHerb()),U=d("Orbs optional",a.orbsOptional()),P=(new Item$$module$js$nodes(c,0,"Sword of Wind")).weight(a.guaranteeSword()?10:5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),I=(new Item$$module$js$nodes(c,
1,"Sword of Fire")).weight(a.guaranteeSword()?10:5).fromPerson("Oak elder",29).dialog(29,void 0,3).key(),M=(new Item$$module$js$nodes(c,2,"Sword of Water")).weight(10).chest().key(),N=(new Item$$module$js$nodes(c,3,"Sword of Thunder")).weight(15).chest().key(),la=(new Item$$module$js$nodes(c,4,"Crystalis")).fixed(),aa=(new Item$$module$js$nodes(c,5,"Ball of Wind")).chest().key(),ya=(new Item$$module$js$nodes(c,6,"Tornado Bracelet")).chest().key(),Y=(new Item$$module$js$nodes(c,7,"Ball of Fire")).bossDrop("Insect",
1).dialog(30,void 0,2).dialog(32,void 0,0).dialog(33,void 0,0).dialog(34,void 0,0).dialog(96,30,0).dialog(29,void 0,2).dialog(31,void 0,1).npcSpawn(193).key(),ma=(new Item$$module$js$nodes(c,8,"Flame Bracelet")).bossDrop("Kelbesque 1",2).npcSpawn(194).key(),na=(new Item$$module$js$nodes(c,9,"Ball of Water")).weight(5).direct("Rage",250679).npcSpawn(195).key(),oa=(new Item$$module$js$nodes(c,10,"Blizzard Bracelet")).weight(5).chest().key(),ea=(new Item$$module$js$nodes(c,11,"Ball of Thunder")).bossDrop("Mado 1",
5).trigger(154,1).key(),Da=(new Item$$module$js$nodes(c,12,"Storm Bracelet")).chest().key(),Oa=(new Item$$module$js$nodes(c,13,"Carapace Shield")).armor(),Ea=(new Item$$module$js$nodes(c,14,"Bronze Shield")).armor(),w=(new Item$$module$js$nodes(c,15,"Platinum Shield")).armor(),rb=(new Item$$module$js$nodes(c,16,"Mirrored Shield")).armor(),F=(new Item$$module$js$nodes(c,17,"Ceramic Shield")).armor(),V=(new Item$$module$js$nodes(c,18,"Sacred Shield")).armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),
...
27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),R=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),Z=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),Ya=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),Kb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),ba=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),qa=(new Item$$module$js$nodes(c,
34,"Magic Ring")).consumable(),Lb=(new Item$$module$js$nodes(c,35,"Fruit of Repun")).consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),fa=(new Item$$module$js$nodes(c,36,"Warp Boots")).consumable(),qc=(new Item$$module$js$nodes(c,37,"Statue of Onyx")).chest("Cordel grass").invisible(254882).key(),Mb=(new Item$$module$js$nodes(c,38,"Opel Statue")).consumable().bossDrop("Kelbesque 2",6).npcSpawn(197).key(),rc=(new Item$$module$js$nodes(c,39,"Insect Flute")).fromPerson("Oak mother",30).dialog(30,
...
68,"Teleport")).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),je=(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),Gc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),Qa=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),J=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=ba.bossDrop("Vampire 2",
12,97).npcSpawn(204).key(),ca=new Item$$module$js$nodes(c,112,"Mimic"),Hc=(new Trigger$$module$js$nodes(c,"Talked to Leaf Elder")).get(P),Ic=(new Trigger$$module$js$nodes(c,"Talked to Leaf Student")).get(Pb),Tb=new Trigger$$module$js$nodes(c,"Talked to Zebu in cave"),le=(new Trigger$$module$js$nodes(c,"Woke up Windmill Guard")).get(uc),mb=new Trigger$$module$js$nodes(c,"Started Windmill"),Jc=(new Trigger$$module$js$nodes(c,"Learned Refresh")).get(tb),me=(new Trigger$$module$js$nodes(c,"Gave Statue to Akahana")).get(sb),
ne=(new Trigger$$module$js$nodes(c,"Fought Stom")).get(Ga),Kc=new Trigger$$module$js$nodes(c,"Visited Oak"),Lc=new Trigger$$module$js$nodes(c,"Talked to Oak Mother"),Ub=new Trigger$$module$js$nodes(c,"Rescued Oak Child"),oe=(new Trigger$$module$js$nodes(c,"Talked to Oak Mother Again")).get(rc),pe=(new Trigger$$module$js$nodes(c,"Talked to Oak Elder")).get(I),qe=(new Trigger$$module$js$nodes(c,"Talked to Tornel on Mt Sabre")).get(Fc),Mc=new Trigger$$module$js$nodes(c,"Villagers Abducted"),Nc=new Trigger$$module$js$nodes(c,
"Talked to Rabbit in Leaf"),re=(new Trigger$$module$js$nodes(c,"Learned Paralysis")).get(lb),Oc=new Trigger$$module$js$nodes(c,"Talked to Portoa Queen"),Pc=new Trigger$$module$js$nodes(c,"Talked to Fortune Teller"),Qc=new Trigger$$module$js$nodes(c,"Visited Underground Channel"),se=(new Trigger$$module$js$nodes(c,"Sent to Waterfall Cave")).get(Nb),te=(new Trigger$$module$js$nodes(c,"Cured Akahana")).get(tc),Rc=(new Trigger$$module$js$nodes(c,"Talked to Rage")).get(na),Sc=new Trigger$$module$js$nodes(c,
...
$c=new Trigger$$module$js$nodes(c,"Shyron Massacre"),Ae=(new Trigger$$module$js$nodes(c,"Saved Kensu")).get(J),Be=(new Trigger$$module$js$nodes(c,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$js$nodes(c,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(c,"Get Bow of Truth")).get(Ec),Ee=(new Trigger$$module$js$nodes(c,"Forged Crystalis")).get(la),ub=(new Condition$$module$js$nodes(c,"Sword charge glitch")).option(v,y),Fe=(new Condition$$module$js$nodes(c,"Rabbit skip")).option(r,
x),Ge=(new Condition$$module$js$nodes(c,"Teleport skip")).option(p,q),vb=(new Condition$$module$js$nodes(c,"Statue glitch")).option(l,n),He=(new Condition$$module$js$nodes(c,"Wild warp")).option(B,C),wb=(new Condition$$module$js$nodes(c,"Any level 2 sword")).option(P,aa).option(P,ya).option(I,Y).option(I,ma).option(M,na).option(M,oa).option(N,ea).option(N,Da),D=(new Condition$$module$js$nodes(c,"Destroy stone")).option(P,U).option(P,aa).option(P,ya).option(ub,P,wb),E=(new Condition$$module$js$nodes(c,
"Destroy ice")).option(I,U).option(I,Y).option(I,ma).option(ub,I,wb),z=(new Condition$$module$js$nodes(c,"Cross rivers")).option(M,U).option(M,na).option(M,oa).option(J).option(ub,M,wb),Za=(new Condition$$module$js$nodes(c,"Destroy iron")).option(N,U).option(N,ea).option(N,Da).option(ub,N,wb),ha=(new Condition$$module$js$nodes(c,"Any sword")).option(P).option(I).option(M).option(N),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(I).option(M).option(N).option(sb,
t.value?t:g,P),Je=(new Condition$$module$js$nodes(c,"Match vampire 2 sword (wind/water/thunder)")).option(P).option(M).option(N).option(t.value?t:g,I),ad=(new Condition$$module$js$nodes(c,"Speed boots")).option(sc,k),bd=(new Condition$$module$js$nodes(c,"Climb slopes")).option(Ob).option(J).option(ad),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Nc).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(Fc).option(Ge,J),cd=(new Condition$$module$js$nodes(c,
"Asina in her room")).option(Sc),Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(lb).option(cd).option(vb),dd=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(Rb,Vc),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(m,dd,Ob),za=(new Condition$$module$js$nodes(c,"Cross sea")).option(dd).option(J),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Wb).option(J).option(Ne),ia=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(Wa.value?
Wa:g).option(tb),ed=(new Condition$$module$js$nodes(c,"Wind magic")).option(u.value?u:g,ia).option(aa,ya,ia),fd=(new Condition$$module$js$nodes(c,"Fire magic")).option(u.value?u:g,ia).option(Y,ma,ia),gd=(new Condition$$module$js$nodes(c,"Water magic")).option(u.value?u:g,ia).option(u,ia).option(na,oa,ia),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(u.value?u:g,ia).option(u,ia).option(ea,ia).option(Da,ia),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(Nb).option(vb),
Re=(new Condition$$module$js$nodes(c,"Change or glitch")).option(Qa).option(vb),Se=(new Condition$$module$js$nodes(c,"Change or glitch or paralysis")).option(Qa).option(vb).option(lb),Yb=(new Condition$$module$js$nodes(c,"Pass shooting statues")).option(Gc).option(ha,xa.value?xa:g).option(tb,tc),Te=(new Condition$$module$js$nodes(c,"Healed dolphin if required")).option(Uc).option(O),hd=(new Condition$$module$js$nodes(c,"Match sword of wind")).option(P).option(t.value?t:g,ha),id=(new Condition$$module$js$nodes(c,
"Match sword of fire")).option(I).option(t.value?t:g,ha),jd=(new Condition$$module$js$nodes(c,"Match sword of water")).option(M).option(t.value?t:g,ha),Ue=(new Condition$$module$js$nodes(c,"Match sword of thunder")).option(N).option(t.value?t:g,ha),Ve=(new Condition$$module$js$nodes(c,"Swamp run possible")).option(ha,ad).option(ha,kb).option(ha,tb),We=(new Condition$$module$js$nodes(c,"Insect possible to kill")).option(sb),xb=(new Condition$$module$js$nodes(c,"Travel swamp")).option(sb).option(T.value?
T:g,Ve),Xe=(new Condition$$module$js$nodes(c,"Calmed sea if required")).option(Wb).option(jb),Ye=(new Condition$$module$js$nodes(c,"Started windmill if required")).option(mb).option(va),Ze=(new Condition$$module$js$nodes(c,"Telepathy if required for Deo")).option(Ga).option(Xa),$e=e(0,"Vampire 1",ha).get(Ob),af=e(1,"Insect",rc,Ie,We).get(Y),bf=e(2,"Kelbesque 1",hd,ed).get(ma),cf=e(12,"Vampire 2",Je).get(ke),kd=e(4,"Sabera 1",id,fd).get(yc),df=e(5,"Mado 1",jd,gd).get(ea),ef=e(6,"Kelbesque 2",hd,ed).get(Mb),
ff=e(7,"Sabera 2",id,fd).get(Lb),gf=e(8,"Mado 2",jd,gd).get(V),hf=e(9,"Karmine",Ue,Pe).get(Sb),jf=e(10,"Draygon 1",ha).get(ee),kf=e(-1,"Statues",Dc,Cc),lf=e(11,"Draygon 2",ha,Ec),mf=e(13,"Dyna",la),nf=(new Condition$$module$js$nodes(c,"Opened prison if required")).option(Qb).option(ka),ra=new Area$$module$js$nodes(c,"Leaf"),$a=new Area$$module$js$nodes(c,"Valley of Wind"),ja=new Area$$module$js$nodes(c,"Sealed Cave"),Ra=new Area$$module$js$nodes(c,"Cordel Plain"),ab=new Area$$module$js$nodes(c,"Brynmaer"),
bb=new Area$$module$js$nodes(c,"Amazones"),K=new Area$$module$js$nodes(c,"Mt Sabre West"),A=new Area$$module$js$nodes(c,"Mt Sabre North"),yb=new Area$$module$js$nodes(c,"Nadare's"),nb=new Area$$module$js$nodes(c,"Oak"),Ha=new Area$$module$js$nodes(c,"Waterfall Valley"),H=new Area$$module$js$nodes(c,"Portoa"),Ia=new Area$$module$js$nodes(c,"Waterfall Cave"),L=new Area$$module$js$nodes(c,"Fog Lamp Cave"),Ja=new Area$$module$js$nodes(c,"Kirisa Plant Cave"),Sa=new Area$$module$js$nodes(c,"Angry Sea"),
...
da=new Area$$module$js$nodes(c,"Draygonia Fortress 4"),S=new Area$$module$js$nodes(c,"Oasis Cave"),ua=new Area$$module$js$nodes(c,"Sahara"),db=new Area$$module$js$nodes(c,"Pyramid Front"),Aa=new Area$$module$js$nodes(c,"Pyramid Back"),Ba=new Area$$module$js$nodes(c,"Tower"),Zb=(new Location$$module$js$nodes(c,0,ra,"Start")).overworld().start(),of=(new Location$$module$js$nodes(c,0,ra,"Mezame Shrine")).overworld().from(Zb),pf=(new Location$$module$js$nodes(c,1,ra,"Outside Start")).overworld().connect(of),
Na=(new Location$$module$js$nodes(c,2,ra,"Town")).town().connect(pf),ob=(new Location$$module$js$nodes(c,3,$a,"Main")).overworld().connect(Na).trigger(Jc,mb),ld=(new Location$$module$js$nodes(c,3,$a,"Outside Windmill")).overworld(),md=(new Location$$module$js$nodes(c,4,ja,"Tunnel 1 (entrance)")).cave().from(ob,mb),qf=(new Location$$module$js$nodes(c,5,ja,"Tunnel 2 (over bridge)")).cave().connect(md),rf=(new Location$$module$js$nodes(c,6,ja,"Tunnel 6 (herb dead end)")).cave().chest(R,15),nd=(new Location$$module$js$nodes(c,
7,ja,"Tunnel 4a (ball corridor)")).cave().chest(R,20,80).chest(aa,21);(new Location$$module$js$nodes(c,7,ja,"Tunnel 4b (antidote dead end)")).cave().connect(nd,D).chest(Z,19);const sf=(new Location$$module$js$nodes(c,8,ja,"Tunnel 5 (warp boots dead end)")).cave().chest(fa,14),tf=(new Location$$module$js$nodes(c,9,ja,"Tunnel 3a (branch, front)")).cave().connect(qf).connectTo(nd).connectTo(sf),uf=(new Location$$module$js$nodes(c,9,ja,"Tunnel 3b (branch, back)")).cave().connect(tf,D).connectTo(rf),vf=
(new Location$$module$js$nodes(c,10,ja,"Tunnel 7 (boss)")).cave().connect(uf).boss($e),wf=(new Location$$module$js$nodes(c,12,ja,"Tunnel 8a (exit, above wall)")).cave().connect(vf),xf=(new Location$$module$js$nodes(c,12,ja,"Tunnel 8b (exit, below wall")).cave().connect(wf,D);(new Location$$module$js$nodes(c,14,$a,"Windmill Cave")).cave().connect(ob).connectTo(ld).trigger(le,Pb,Tb);(new Location$$module$js$nodes(c,15,$a,"Windmill")).misc().connect(ld).trigger(mb,uc);const yf=(new Location$$module$js$nodes(c,
16,$a,"Zebu's Cave Front")).cave().connect(ob).trigger(Tb,Hc,Ic).trigger(Jc,mb,Tb),zf=(new Location$$module$js$nodes(c,16,$a,"Zebu's Cave Back")).cave().trigger(Mc).connect(yf,E),Af=(new Location$$module$js$nodes(c,17,K,"Tunnel 1 (to Zebu)")).cave().connect(zf),eb=(new Location$$module$js$nodes(c,20,Ra,"West")).overworld().connect(xf,Ye),Bf=(new Location$$module$js$nodes(c,20,Ra,"South")).overworld().connect(eb,z),od=(new Location$$module$js$nodes(c,21,Ra,"East")).overworld().connect(eb).chest(qc,
24),pb=(new Location$$module$js$nodes(c,24,ab,"Town")).town().connect(eb).trigger(me,qc),Cf=(new Location$$module$js$nodes(c,25,Ra,"Outside Stom's House")).town().connect(eb),$b=(new Location$$module$js$nodes(c,26,Ra,"Swamp")).overworld().connect(od,xb).trigger(Ub,Lc,xb);(new Location$$module$js$nodes(c,26,Ra,"Swamp Insect Area")).overworld().connect($b,xb).boss(af);const Ab=(new Location$$module$js$nodes(c,27,bb,"Town")).town().connect(Bf),Bb=(new Location$$module$js$nodes(c,28,nb,"Town")).town().connect($b,
xb).trigger(Kc);(new Location$$module$js$nodes(c,30,Ra,"Stom's House")).house().connect(Cf).trigger(ne,Kc);const fb=(new Location$$module$js$nodes(c,32,K,"Entrance")).overworld().connect(eb).connect(Af),Df=(new Location$$module$js$nodes(c,32,K,"Up Slope")).overworld().from(fb,bd).to(fb),Ef=(new Location$$module$js$nodes(c,32,K,"Dead End (warp boots)")).overworld().chest(fa,24,106),pd=(new Location$$module$js$nodes(c,33,K,"Upper")).overworld().from(fb,J).to(fb),Ff=(new Location$$module$js$nodes(c,
33,K,"Tornel Dead End")).overworld().trigger(qe,aa,ya).chest(qa,23,105),qd=(new Location$$module$js$nodes(c,34,K,"Tunnel 2a (fork at start)")).cave().connect(fb);(new Location$$module$js$nodes(c,34,K,"Tunnel 2b (left branch to dead end)")).cave().connect(qd,E).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,K,"Tunnel 2c (right branch to upper)")).cave().connect(qd,E),Hf=(new Location$$module$js$nodes(c,35,K,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(R,23,
82),If=(new Location$$module$js$nodes(c,35,K,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,E).connectTo(pd),rd=(new Location$$module$js$nodes(c,36,K,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,K,"Tunnel 4b (out to upper)")).cave().connect(rd,E).connectTo(pd);const Jf=(new Location$$module$js$nodes(c,37,K,"Tunnel 5 (tiny connector)")).cave().connect(rd),Kf=(new Location$$module$js$nodes(c,38,K,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);
(new Location$$module$js$nodes(c,38,K,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,E).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,K,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,K,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,E);(new Location$$module$js$nodes(c,39,K,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,E).chest(ya,25);const Cb=(new Location$$module$js$nodes(c,40,A,"Entrance")).overworld().connect(od,
Le,Ke),Db=(new Location$$module$js$nodes(c,40,A,"Upper")).overworld().from(Cb,J).to(Cb),ac=(new Location$$module$js$nodes(c,40,A,"Summit (boss)")).overworld().from(Db,J).to(Db).boss(bf),sd=(new Location$$module$js$nodes(c,41,A,"Connector")).overworld(),bc=(new Location$$module$js$nodes(c,41,A,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,A,"Middle Right")).overworld().from(bc,bd).to(bc),td=(new Location$$module$js$nodes(c,42,A,"Tunnel 2a (from entrance to connector)")).cave().connectTo(sd);
...
60,yb,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,yb,"Tool Shop")).shop(R,Z,ba,fa),$f=(new Location$$module$js$nodes(c,62,yb,"Back Room")).house(),cc=(new Location$$module$js$nodes(c,64,Ha,"Summit")).overworld().connect(Xf,nf),Eb=(new Location$$module$js$nodes(c,64,Ha,"Northwest")).overworld().from(cc).to(cc,J),ag=(new Location$$module$js$nodes(c,64,Ha,"Northeast")).overworld().connect(Eb,z),xd=(new Location$$module$js$nodes(c,65,Ha,"Southwest")).overworld().connect(Eb),bg=(new Location$$module$js$nodes(c,
65,Ha,"Southeast")).overworld().connect(xd,z),yd=(new Location$$module$js$nodes(c,66,Ha,"Lime Tree Valley")).overworld().connect(xd).connect(ob,X),cg=(new Location$$module$js$nodes(c,67,Ha,"Lime Tree Lake (Rage)")).cave().connect(yd).trigger(Rc,M),dg=(new Location$$module$js$nodes(c,68,Ja,"Tunnel 1a (entrance)")).cave().connect(bg),eg=(new Location$$module$js$nodes(c,68,Ja,"Tunnel 1b (behind wall)")).cave().connect(dg,D),zd=(new Location$$module$js$nodes(c,69,Ja,"Tunnel 2a (main path, before wall)")).cave().connect(eg);
...
14);const ig=(new Location$$module$js$nodes(c,72,L,"Tunnel 1a (entrance)")).cave().connect(ag),Ad=(new Location$$module$js$nodes(c,72,L,"Tunnel 1b (past wall)")).cave().connect(ig,D);(new Location$$module$js$nodes(c,72,L,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(Ad,D).chest(Ya,24);const jg=(new Location$$module$js$nodes(c,73,L,"Tunnel 2 (tiny connector)")).cave().connect(Ad),Bd=(new Location$$module$js$nodes(c,74,L,"Tunnel 3a (upper branch)")).cave().connect(jg);(new Location$$module$js$nodes(c,
74,L,"Tunnel 3b (dead end, mimic)")).cave().connect(Bd,D).chest(ca,21,112);const Cd=(new Location$$module$js$nodes(c,74,L,"Tunnel 3c (short passage with mimic)")).cave().connect(Bd,D).chest(ca,22,113),kg=(new Location$$module$js$nodes(c,74,L,"Tunnel 3d (lower branch)")).cave().connect(Cd,D);(new Location$$module$js$nodes(c,75,L,"Dead end loop")).cave().connect(kg);const Dd=(new Location$$module$js$nodes(c,76,L,"Tunnel 4a (right branch over bridge)")).cave().connect(Cd),lg=(new Location$$module$js$nodes(c,
76,L,"Tunnel 4b (past wall over bridge)")).cave().connect(Dd,D),mg=(new Location$$module$js$nodes(c,77,L,"Tunnel 5a (from left branch)")).cave().connect(Dd),ng=(new Location$$module$js$nodes(c,77,L,"Tunnel 5b (reconvergence)")).cave().connect(mg,D).connect(lg),og=(new Location$$module$js$nodes(c,77,L,"Tunnel 5c (between walls)")).cave().connect(ng,D),pg=(new Location$$module$js$nodes(c,77,L,"Tunnel 5d (under bridge)")).cave().connect(og,D),qg=(new Location$$module$js$nodes(c,78,L,"Tunnel 6a (over second bridge)")).cave().connect(pg),
rg=(new Location$$module$js$nodes(c,78,L,"Tunnel 6b (past wall)")).cave().connect(qg,D),sg=(new Location$$module$js$nodes(c,79,L,"Tunnel 7a (under second bridge)")).cave().connect(rg);(new Location$$module$js$nodes(c,79,L,"Tunnel 7b (fog lamp)")).cave().connect(sg,D).chest(wc,19);const Va=(new Location$$module$js$nodes(c,80,H,"Town")).town().connect(Eb),Ed=(new Location$$module$js$nodes(c,81,H,"Fishherman Island")).town().connect(Va);(new Location$$module$js$nodes(c,82,Ha,"Mesia Shrine")).cave().trigger(Sc).connect(cg,
z,Rc);const Fd=(new Location$$module$js$nodes(c,84,Ia,"Tunnel 1a (entrance)")).cave().connect(Eb);(new Location$$module$js$nodes(c,84,Ia,"Tunnel 1b (dead end, mimic)")).cave().connect(Fd,E).chest(ca,19,114);const tg=(new Location$$module$js$nodes(c,84,Ia,"Tunnel 1c (past ice)")).cave().connect(Fd,E),ug=(new Location$$module$js$nodes(c,85,Ia,"Tunnel 2 (stoned pair)")).cave().connect(tg),dc=(new Location$$module$js$nodes(c,86,Ia,"Tunnel 3 (wide medusa hallways)")).cave().connect(ug,Qe),vg=(new Location$$module$js$nodes(c,
87,Ia,"Tunnel 4a (left entrance)")).cave().from(dc,E).chest(rb.chest().bonus(),25).trigger(te,Nb);(new Location$$module$js$nodes(c,87,Ia,"Tunnel 4b (right entrance)")).cave().from(dc,E).connect(vg,J);(new Location$$module$js$nodes(c,87,Ia,"Tunnel 4c (sword of water)")).cave().connect(dc,E).chest(M,24);const Gd=(new Location$$module$js$nodes(c,88,Ba,"Entrance")).misc(),wg=(new Location$$module$js$nodes(c,89,Ba,"Level 1")).misc().from(Gd),xg=(new Location$$module$js$nodes(c,90,Ba,"Level 2")).misc().from(wg),
yg=(new Location$$module$js$nodes(c,91,Ba,"Level 3")).misc().from(xg),Hd=(new Location$$module$js$nodes(c,92,Ba,"Outside Mesia Room")).misc().from(yg),zg=(new Location$$module$js$nodes(c,93,Ba,"Outside Dyna Room")).misc().from(Hd,la);(new Location$$module$js$nodes(c,94,Ba,"Mesia")).misc().connect(Hd).trigger(Ee);const Ag=(new Location$$module$js$nodes(c,95,Ba,"Dyna")).misc().from(zg).boss(mf);(new Location$$module$js$nodes(c,95,Ba,"Win")).misc().from(Ag).end();const ec=(new Location$$module$js$nodes(c,
96,Sa,"Cabin Beach")).sea().from(Ed,Vb),gb=(new Location$$module$js$nodes(c,96,Sa,"South")).sea().connect(ec,za),Bg=(new Location$$module$js$nodes(c,96,Sa,"Joel Beach")).sea().connect(gb,za),Id=(new Location$$module$js$nodes(c,96,Ka,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(c,96,Sa,"Altar")).sea().connect(gb,za).trigger(Wb,zc,yc);const Cg=(new Location$$module$js$nodes(c,96,Sa,"North")).sea().to(gb,za).from(gb,za,Oe).trigger(we,Xe),Dg=(new Location$$module$js$nodes(c,96,Sa,"Swan Beach")).sea().connect(Cg,
za);(new Location$$module$js$nodes(c,97,Sa,"Cabin")).misc().connect(ec).trigger(Vc,Vb);(new Location$$module$js$nodes(c,98,Ka,"Lighthouse")).misc().connect(Id).trigger(ve,Pb);const Fb=(new Location$$module$js$nodes(c,100,H,"Underground Channel 1 (from throne room)")).sea().trigger(Qc),Eg=(new Location$$module$js$nodes(c,100,H,"Underground Channel 2 (to fortune teller)")).sea().connect(Fb,z),Jd=(new Location$$module$js$nodes(c,100,H,"Underground Channel 3 (from fortune teller)")).sea().connect(Fb,
J),Kd=(new Location$$module$js$nodes(c,100,H,"Underground Channel 4 (asina)")).sea().connect(Jd,z),Fg=(new Location$$module$js$nodes(c,100,H,"Underground Channel 5 (dolphin)")).sea().connect(Kd,z).trigger(Uc,R,Tc);(new Location$$module$js$nodes(c,100,H,"Underground Channel 6 (water)")).sea().connect(Fg,za).connectTo(gb,za).chest(Ac,17);const fc=(new Location$$module$js$nodes(c,101,W,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,W,"Tunnel 1 (entrance)")).sea().connect(gb,Wc,za),Ld=
(new Location$$module$js$nodes(c,105,W,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,W,"Tunnel 2b (dead end to left)")).cave().connect(Ld,z);const Hg=(new Location$$module$js$nodes(c,105,W,"Tunnel 2c (across first river)")).cave().connect(Ld,z),Md=(new Location$$module$js$nodes(c,105,W,"Tunnel 2d (across second river)")).cave().connect(Hg,z);(new Location$$module$js$nodes(c,105,W,"Tunnel 2e (dead end, magic ring)")).cave().connect(Md,D).chest(qa,29);const Ig=(new Location$$module$js$nodes(c,
105,W,"Tunnel 2f (stair down)")).cave().connect(Md,D),Jg=(new Location$$module$js$nodes(c,106,W,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(fc).chest(Ya,25,92),Kg=(new Location$$module$js$nodes(c,106,W,"Tunnel 3b (left area toward items)")).cave().connect(Jg,D),Lg=(new Location$$module$js$nodes(c,107,W,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(ca,14,115);(new Location$$module$js$nodes(c,107,W,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,z).chest(he,15);const gc=
(new Location$$module$js$nodes(c,108,La,"Floor 1")).fortress().connect(fc),Mg=(new Location$$module$js$nodes(c,108,La,"Miniboss")).fortress().boss(cf).connect(gc);(new Location$$module$js$nodes(c,109,La,"Floor 2a (left stair)")).fortress().connect(gc).chest(ba,19);const Ng=(new Location$$module$js$nodes(c,109,La,"Floor 2b (right stair)")).fortress().connect(Mg).chest(R,30,85),Og=(new Location$$module$js$nodes(c,110,La,"Floor 3a (toward boss)")).fortress().connect(Ng),Nd=(new Location$$module$js$nodes(c,
110,La,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$js$nodes(c,110,La,"Boss")).fortress().boss(kd).connect(Nd);(new Location$$module$js$nodes(c,110,La,"Floor 3c (back room trap)")).fortress().from(Nd).to(gc);const Pg=(new Location$$module$js$nodes(c,112,Ka,"Secret Passage")).cave().connectTo(Id),Gb=(new Location$$module$js$nodes(c,113,Ka,"Town")).town().connect(Bg),Ca=(new Location$$module$js$nodes(c,114,sa,"Town")).town().connect(Dg),Qg=(new Location$$module$js$nodes(c,115,
...
z),eh=(new Location$$module$js$nodes(c,137,Ta,"Left branch, past two bridges")).fortress().connect(dh,z).chest(R,29,87),fh=(new Location$$module$js$nodes(c,137,Ta,"Right branch")).fortress().connect(Td);(new Location$$module$js$nodes(c,137,Ta,"Right branch, across water")).fortress().connect(fh,J).chest(ca,20,118).chest(ca,21,119).chest(pa,28);(new Location$$module$js$nodes(c,138,Ta,"Upper floor")).fortress().connect(eh).chest(N,27);const hb=(new Location$$module$js$nodes(c,140,Ma,"Town")).town().connect(Xg,
Re).trigger(Xb),qb=(new Location$$module$js$nodes(c,142,Ua,"Town")).town().connect(Hb),Ud=(new Location$$module$js$nodes(c,143,S,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,S,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Ud,Za).chest(fe,15);const ic=(new Location$$module$js$nodes(c,144,Ua,"Desert 1")).overworld().connect(Hb),Ib=(new Location$$module$js$nodes(c,145,S,"Area 1 (from entrance)")).cave().chest(sc,26),Vd=(new Location$$module$js$nodes(c,
...
z),kh=(new Location$$module$js$nodes(c,145,S,"Area 8 (left outer ring)")).cave().connect(jh,z).connect(Ib,z).chest(ba,27,100),lh=(new Location$$module$js$nodes(c,145,S,"Area 9 (top left inner ring)")).cave().connect(kh,z),mh=(new Location$$module$js$nodes(c,145,S,"Area 10 (top right inner ring)")).cave().connect(lh,z);(new Location$$module$js$nodes(c,145,S,"Area 11 (center)")).cave().connect(mh,z).connectTo(Ud);(new Location$$module$js$nodes(c,145,S,"Area 12 (top center islands)")).cave().connect(Ib,
J).chest(de,28);const nh=(new Location$$module$js$nodes(c,146,ua,"Desert Cave 1")).cave().connect(ic,J),ib=(new Location$$module$js$nodes(c,147,ua,"Town")).town(),oh=(new Location$$module$js$nodes(c,148,ua,"Outside Cave")).overworld().connect(ib),ph=(new Location$$module$js$nodes(c,149,ua,"Desert Cave 2")).cave().connect(oh);(new Location$$module$js$nodes(c,150,ua,"Meadow")).overworld().connect(nh).connectTo(ib).trigger(Be,Qa,Ze);const jc=(new Location$$module$js$nodes(c,152,ua,"Desert 2")).overworld().connect(ph),
qh=(new Location$$module$js$nodes(c,156,db,"Entrance")).fortress().connect(jc,J),rh=(new Location$$module$js$nodes(c,156,db,"Azteca")).fortress().trigger(De),sh=(new Location$$module$js$nodes(c,157,db,"Fork")).fortress().connect(qh),Wd=(new Location$$module$js$nodes(c,158,db,"Main")).fortress().connect(sh);(new Location$$module$js$nodes(c,158,db,"Treasure Chest (magic ring)")).fortress().connect(Wd).chest(qa,27,108);(new Location$$module$js$nodes(c,159,db,"Draygon")).fortress().connect(Wd).to(rh).boss(jf);
const th=(new Location$$module$js$nodes(c,160,Aa,"Entrance")).fortress().connect(jc,J),uh=(new Location$$module$js$nodes(c,160,Aa,"Statues")).fortress().connect(th).boss(kf),vh=(new Location$$module$js$nodes(c,161,Aa,"Hall 1")).fortress().connect(uh),kc=(new Location$$module$js$nodes(c,162,Aa,"Branch")).fortress().connect(vh);(new Location$$module$js$nodes(c,163,Aa,"Left Dead End")).fortress().connect(kc).chest(ca,13,120);(new Location$$module$js$nodes(c,164,Aa,"Right Dead End")).fortress().connect(kc);
const wh=(new Location$$module$js$nodes(c,165,Aa,"Hall 2")).fortress().connect(kc).chest(Mb,26,109),xh=(new Location$$module$js$nodes(c,166,Aa,"Draygon 2")).fortress().connect(wh).boss(lf);(new Location$$module$js$nodes(c,167,Aa,"Teleporter")).fortress().from(xh).to(Gd);const Xd=(new Location$$module$js$nodes(c,168,zb,"Entrance")).fortress().connect(qb,Yb).trigger($c,N),yh=(new Location$$module$js$nodes(c,169,zb,"Main")).fortress().from(Xd,Za),zh=(new Location$$module$js$nodes(c,169,zb,"Boss")).fortress().connect(yh).boss(ef),
Ah=(new Location$$module$js$nodes(c,170,zb,"Zebu")).fortress().connect(zh),Jb=(new Location$$module$js$nodes(c,171,ta,"Entrance")).fortress().connect(Ah);(new Location$$module$js$nodes(c,171,ta,"Dead End Behind Iron (fruit of power)")).fortress().connect(Jb,Za).chest(ba,28,98);(new Location$$module$js$nodes(c,171,ta,"Dead End Loop Across Closer Bridges")).fortress().connect(Jb,z).connect(Jb,z);const Bh=(new Location$$module$js$nodes(c,171,ta,"Across First Bridge (fruit of repun)")).fortress().connect(Jb,
z).chest(Lb,30,102),lc=(new Location$$module$js$nodes(c,171,ta,"Across Second Bridge")).fortress().connect(Bh,z);(new Location$$module$js$nodes(c,171,ta,"Dead End Across Two Bridges ()")).fortress().connect(lc,z).connect(lc,z).chest(Ya,29,93);const Ch=(new Location$$module$js$nodes(c,171,ta,"Across Third Bridge")).fortress().connect(lc,z),Dh=(new Location$$module$js$nodes(c,171,ta,"Exit Behind Iron Door")).fortress().connect(Ch,Za),Eh=(new Location$$module$js$nodes(c,172,ta,"Boss")).fortress().connect(Dh).boss(ff),
Fh=(new Location$$module$js$nodes(c,172,ta,"Tornel")).fortress().connect(Eh),Yd=(new Location$$module$js$nodes(c,173,cb,"Lower")).fortress().connect(Fh).chest(Mb,26,99).chest(qa,27,111),Gh=(new Location$$module$js$nodes(c,174,cb,"Upper Loop")).fortress().connect(Yd).chest(Z,22,96);(new Location$$module$js$nodes(c,174,cb,"Upper Loop Behind Wall (magic ring)")).fortress().connect(Gh,Za).chest(qa,23,107);const Hh=(new Location$$module$js$nodes(c,175,cb,"Upper Passage (toward Mado)")).fortress().connect(Yd).chest(qa,
27,84),mc=(new Location$$module$js$nodes(c,176,da,"Initial Fork")).fortress(),Ih=(new Location$$module$js$nodes(c,177,da,"Left Branch")).fortress().connect(mc),Zd=(new Location$$module$js$nodes(c,178,da,"Main Area (right branch, over bridges)")).fortress().connect(mc),Jh=(new Location$$module$js$nodes(c,179,da,"U-shaped Passage (between floors)")).fortress().connect(Zd),Kh=(new Location$$module$js$nodes(c,180,da,"Main Area Lower (under bridge)")).fortress().connect(Ih).connect(Zd).connect(Jh),$d=
(new Location$$module$js$nodes(c,180,da,"Behind Iron Wall")).fortress().connect(Kh,Za),Lh=(new Location$$module$js$nodes(c,181,da,"Lower")).fortress().connect($d).chest(ca,13,121).chest(ca,14,122).chest(ca,15,123).chest(qa,23,88).chest(fa,24,110),Mh=(new Location$$module$js$nodes(c,182,da,"Boss Corridor")).fortress().connect(Lh),Nh=(new Location$$module$js$nodes(c,182,da,"Boss")).fortress().connect(Mh,Yb).boss(hf);(new Location$$module$js$nodes(c,182,da,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(Da,
18);const ae=(new Location$$module$js$nodes(c,183,da,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,184,S,"Entrance Back (behind river)")).cave().connect(ae).chest(ba,13,90);(new Location$$module$js$nodes(c,184,S,"Entrance Front")).cave().connect(Oh,J).connectTo(ic).connectTo(Ib);const Ph=(new Location$$module$js$nodes(c,185,cb,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$js$nodes(c,185,cb,"Asina")).fortress().connect(Ph).connectTo(mc);(new Location$$module$js$nodes(c,
186,da,"Kensu")).fortress().connect($d).connectTo(ae).trigger(Ae,Sb);(new Location$$module$js$nodes(c,187,Ua,"House")).house().connect(qb).trigger(Ce,Qa,Sb);(new Location$$module$js$nodes(c,188,Ua,"Inn")).shop().connect(qb,Xb);(new Location$$module$js$nodes(c,190,Ua,"Tool Shop")).shop(R,Z,fa,ba).connect(qb,Xb);(new Location$$module$js$nodes(c,191,Ua,"Tavern")).shop().connect(qb);(new Location$$module$js$nodes(c,192,ra,"Elder House")).house().connect(Na).trigger(Hc);(new Location$$module$js$nodes(c,
193,ra,"Rabbit Hut")).house().connect(Na).trigger(Nc,Mc,Ga);(new Location$$module$js$nodes(c,194,ra,"Inn")).shop().connect(Na);(new Location$$module$js$nodes(c,195,ra,"Tool Shop")).shop(R,Z,fa,ba).connect(Na);(new Location$$module$js$nodes(c,196,ra,"Armor Shop")).shop(Pa,Oa).connect(Na);(new Location$$module$js$nodes(c,197,ra,"Student House")).house().connect(Na).trigger(Ic);(new Location$$module$js$nodes(c,198,ab,"Tavern")).house().connect(pb);(new Location$$module$js$nodes(c,199,ab,"Pawn Shop")).shop().connect(pb);
(new Location$$module$js$nodes(c,200,ab,"Inn")).shop().connect(pb);(new Location$$module$js$nodes(c,201,ab,"Armor Shop")).shop(Fa,Oa,Ea).connect(pb);(new Location$$module$js$nodes(c,203,ab,"Tool Shop")).shop(R,Z,fa).connect(pb);(new Location$$module$js$nodes(c,205,nb,"Elder House")).house().from(Bb,Ga).trigger(pe,Ub);(new Location$$module$js$nodes(c,206,nb,"Mother's House")).house().from(Bb,Ga).trigger(Lc,Ga).trigger(oe,Ub);(new Location$$module$js$nodes(c,207,nb,"Tool Shop")).shop(R,Z,ba).from(Bb,
Ga);(new Location$$module$js$nodes(c,208,nb,"Inn")).shop().from(Bb,Ga);(new Location$$module$js$nodes(c,209,bb,"Inn")).shop().connect(Ab);(new Location$$module$js$nodes(c,210,bb,"Tool Shop")).shop(fa,ba,Ya).connect(Ab);(new Location$$module$js$nodes(c,211,bb,"Armor Shop")).shop(oc,w,rb,V).connect(Ab);const Qh=(new Location$$module$js$nodes(c,212,bb,"Queen's House")).house().from(Ab,Se).trigger(ye,Qa,Bc);(new Location$$module$js$nodes(c,213,yb,"Nadare's")).house().connect(Cb).connectTo(Yf).connectTo(Zf).connectTo($f);
(new Location$$module$js$nodes(c,214,H,"Fisherman's House")).house().connect(Ed).trigger(Vb,wc,Rb,Te);const nc=(new Location$$module$js$nodes(c,215,H,"Palace Entrance")).house().connect(Va);(new Location$$module$js$nodes(c,216,H,"Fortune Teller Front")).house().connect(Va).trigger(Pc,Oc);(new Location$$module$js$nodes(c,216,H,"Fortune Teller Back")).house().connect(Eg).connect(Jd);(new Location$$module$js$nodes(c,217,H,"Pawn Shop")).shop().connect(Va);(new Location$$module$js$nodes(c,218,H,"Armor Shop")).shop(be,
oc,w).connect(Va);(new Location$$module$js$nodes(c,220,H,"Inn")).shop().connect(Va);(new Location$$module$js$nodes(c,221,H,"Tool Shop")).shop(R,Ya,Kb,fa).connect(Va);(new Location$$module$js$nodes(c,222,H,"Palace Left")).house().connect(nc);(new Location$$module$js$nodes(c,223,H,"Palace Throne Room")).house().connect(nc).to(Fb,Me).from(Fb).trigger(Oc).trigger(se,Pc,Qc);(new Location$$module$js$nodes(c,224,H,"Palace Right")).house().connect(nc);(new Location$$module$js$nodes(c,225,H,"Asina's Room")).house().connect(Kd).trigger(Tc,
cd);(new Location$$module$js$nodes(c,226,bb,"Queen Downstairs")).house().connect(Qh).chest(oa,13);(new Location$$module$js$nodes(c,227,Ka,"Elder's House")).house().connect(Gb).trigger(Wc);(new Location$$module$js$nodes(c,228,Ka,"Shed")).house().connect(Gb).to(Pg,xc);(new Location$$module$js$nodes(c,229,Ka,"Tool Shop")).shop(R,Z,ba,Ya).connect(Gb);(new Location$$module$js$nodes(c,231,Ka,"Inn")).shop().connect(Gb);const Rh=(new Location$$module$js$nodes(c,232,W,"Zombie Town House")).house().connect(fc);
(new Location$$module$js$nodes(c,233,W,"Zombie Town Basement")).house().connect(Rh).trigger(ue,kd);(new Location$$module$js$nodes(c,235,sa,"Tool Shop")).shop(R,Z,ba,fa).connect(Ca);(new Location$$module$js$nodes(c,236,sa,"Stom's Hut")).house().connect(Ca).trigger(Xc);(new Location$$module$js$nodes(c,237,sa,"Inn")).shop().connect(Ca);(new Location$$module$js$nodes(c,238,sa,"Armor Shop")).shop(ce,pc,F,Q).connect(Ca);(new Location$$module$js$nodes(c,239,sa,"Tavern")).house().connect(Ca).trigger(Yc,Xc,
lb);(new Location$$module$js$nodes(c,240,sa,"Pawn Shop")).shop().connect(Ca);(new Location$$module$js$nodes(c,241,sa,"Dance Hall")).house().connect(Ca).trigger(Zc,Yc,lb).trigger(xe,Zc,Ac);const Sh=(new Location$$module$js$nodes(c,242,Ma,"Temple (pre-massacre)")).fortress().connect(hb).from(Zb,N,wa).trigger(ze);(new Location$$module$js$nodes(c,242,Ma,"Temple (post-massacre)")).fortress().from(Sh,$c).boss(df);(new Location$$module$js$nodes(c,243,Ma,"Training Hall")).house().connect(hb);(new Location$$module$js$nodes(c,
244,Ma,"Hospital")).house().connect(hb);(new Location$$module$js$nodes(c,245,Ma,"Armor Shop")).shop(pc,V,Q).connect(hb);(new Location$$module$js$nodes(c,246,Ma,"Tool Shop")).shop(R,Z,Kb,qa).connect(hb);(new Location$$module$js$nodes(c,247,Ma,"Inn")).shop().connect(hb);(new Location$$module$js$nodes(c,248,ua,"Inn")).shop().connect(ib);(new Location$$module$js$nodes(c,249,ua,"Tool Shop")).shop(Z,fa,Lb,qa).connect(ib);(new Location$$module$js$nodes(c,250,ua,"Elder's House")).house().connect(ib);(new Location$$module$js$nodes(c,
251,ua,"Pawn Shop")).house().connect(ib);const Th=[Na,ob,md,eb,$b,fb,cc,yd,ec,Ca,Hb,hc,ic,Xd,jc];for(const a of Th)a.from(Zb,He);return c},shuffle$$module$js$depgraph=(a,b,c,d,e)=>{d=void 0===d?new FlagSet$$module$js$flagset("Sbkm Sct"):d;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d,a);d.shuffleShops()&&f.shuffleShops(b);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);var h={};for(var k of g)if(k instanceof
...
"c"]};q=b.assumedFill(d,(a,b)=>x(a,n.get(b)));if(null==q){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const v=new Map;for(var y=0;y<q.length;y++){var B=q[y];if(null!=B){var C=n.get(b.item(B));B=m.get(C);m.delete(C);C=b.location(y);v.set(C,B);l.delete(C)}}y=(a,b,c)=>{c=void 0===c?"":c;for(const c of l)if(x(c,a))return v.set(c,b),l.delete(c),m.delete(a),!0;g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var u of m){const [a,b]=u;if(a.isMimic()&&
...
Oak:c,Shyron_ToolShop:d},flags:{AbleToRideDolphin:e,BallOfFire:f,BallOfThunder:g,BallOfWater:h,BallOfWind:k,Barrier:m,BlizzardBracelet:l,BowOfMoon:n,BowOfSun:p,BreakStone:q,BreakIce:r,BreakIron:x,BrokenStatue:v,BuyHealing:y,BuyWarp:B,ClimbWaterfall:C,ClimbSlope8:u,ClimbSlope9:t,CurrentlyRidingDolphin:T,Flight:O,FlameBracelet:jb,FormBridge:ka,GasMask:va,GlowingLamp:wa,InjuredDolphin:xa,LeadingChild:Wa,LeatherBoots:Xa,Money:X,OpenedCrypt:kb,RabbitBoots:U,Refresh:P,RepairedStatue:I,RescuedChild:M,ShellFlute:N,
ShieldRing:la,ShootingStatue:aa,StormBracelet:ya,Sword:Y,SwordOfFire:ma,SwordOfThunder:na,SwordOfWater:oa,SwordOfWind:ea,TornadoBracelet:Da,TravelSwamp:Oa,WildWarp:Ea},items:{MedicalHerb:w,WarpBoots:rb}}=this.rom,F=this.entrance(b);var V=this.entrance(c);this.addCheck([F],and$$module$js$logic$world(n,p),[kb.id]);this.addCheck([F],and$$module$js$logic$world(e,N),[T.id]);this.addCheck([V],and$$module$js$logic$world(Wa),[M.id]);this.addItemCheck([F],and$$module$js$logic$world(wa,v),I.id,{lossy:!0,unique:!0});
for(var Q of this.rom.shops)if(Q.location!==a.id&&Q.location!==d.id&&Q.used&&Q.type===module$js$rom$shop.ShopType.TOOL){V=[module$js$logic$tileid.TileId(Q.location<<16|136)];for(var pa of Q.contents)pa===w.id?this.addCheck(V,X.r,[y.id]):pa===rb.id&&this.addCheck(V,X.r,[B.id])}Q=ea.r;pa=ma.r;V=oa.r;let Pa=na.r;if(!this.flagset.orbsOptional()){var Fa=or$$module$js$logic$world(k,Da);const a=or$$module$js$logic$world(f,jb),b=or$$module$js$logic$world(h,l),c=or$$module$js$logic$world(g,ya);Q=module$js$logic$requirement.Requirement.meet(Q,
Fa);pa=module$js$logic$requirement.Requirement.meet(pa,a);V=module$js$logic$requirement.Requirement.meet(V,b);Pa=module$js$logic$requirement.Requirement.meet(Pa,c);if(this.flagset.assumeSwordChargeGlitch()){Fa=function(b){return a.map((a)=>a[0]===b.c?a:[b.c,...a])};const a=module$js$logic$requirement.Requirement.or(Q,pa,V,Pa);Q=Fa(ea);pa=Fa(ma);V=Fa(oa);Pa=Fa(na)}}this.addCheck([F],Q,[q.id]);this.addCheck([F],pa,[r.id]);this.addCheck([F],V,[ka.id]);this.addCheck([F],Pa,[x.id]);this.addCheck([F],or$$module$js$logic$world(ea,
ma,oa,na),[Y.id,X.id]);this.addCheck([F],O.r,[C.id]);this.addCheck([F],or$$module$js$logic$world(O,U),[u.id]);this.addCheck([F],or$$module$js$logic$world(O,U),[t.id]);this.addCheck([F],m.r,[aa.id]);this.addCheck([F],va.r,[Oa.id]);this.flagset.leatherBootsGiveSpeed()&&this.addCheck([F],Xa.r,[u.id]);this.flagset.assumeGhettoFlight()&&this.addCheck([F],and$$module$js$logic$world(T,U),[C.id]);this.flagset.fogLampNotRequired()&&(Q=this.flagset.requireHealedDolphinToRide(),this.addCheck([F],Q?xa.r:[[]],
[e.id]));this.flagset.guaranteeBarrier()||this.addCheck([F],[[X.c,y.c],[X.c,la.c],[X.c,P.c]],[aa.id]);this.flagset.assumeFlightStatueSkip()||this.addCheck([F],[[X.c,O.c]],[aa.id]);this.flagset.guaranteeGasMask()||this.addCheck([F],[[X.c,y.c],[X.c,P.c]],[Oa.id]);this.flagset.assumeWildWarp()&&this.addCheck([F],module$js$logic$requirement.Requirement.OPEN,[Ea.id])}addExtraRoutes(){var a;const {flags:{BuyWarp:b,SwordOfThunder:c,Teleport:d,WildWarp:e},locations:{MezameShrine:f}}=this.rom;this.addRoute(new Route$$module$js$logic$requirement(this.entrance(f),
...
module$js$logic$tileid.TileId.add(c,1,0),d++;6>d?b&=~module$js$logic$terrain.Terrain.SLOPE:9>d?b|=module$js$logic$terrain.Terrain.SLOPE8:10>d&&(b|=module$js$logic$terrain.Terrain.SLOPE9)}return this.terrainFactory.tile(b)};for(let l=0,v=a.height;l<v;l++){const v=a.screens[l],x=a.id<<8|l<<4;for(let l=0,y=a.width;l<y;l++){const y=this.rom.screens[v[l]|k],u=module$js$logic$screenid.ScreenId(x|l),B=f.has(u),C=u&255;var p=e.get(u);p=g?this.rom.flags.AlwaysTrue.id:null!=p?this.wallCapability(p):null===
(b=a.flags.find((a)=>a.yx===C))||void 0===b?void 0:b.flag;const ka=(d=null===(c=this.rom.flags[p])||void 0===c?void 0:c.logic,null!==d&&void 0!==d?d:{});for(let b=0;240>b;b++){const c=module$js$logic$tileid.TileId(u<<8|b);var q=y.tiles[b];ka.assumeTrue&&32>q&&(q=h.alternates[q]);var r=a.isShop()?0:m.effects[q]&38;r=n(r,c,B);32>q&&h.alternates[q]!==q&&null!=p&&!ka.assumeTrue&&!ka.assumeFalse&&(q=n(m.effects[h.alternates[q]],c,B))&&(r=this.terrainFactory.flag(r,ka.track?p:-1,q));r&&this.terrains.set(c,
r)}}}for(const f of a.exits){const {dest:g,entrance:h}=f;b=module$js$logic$tileid.TileId.from(a,f);f.isSeamless()?(c=module$js$logic$tileid.TileId(b&65535|g<<16),d=module$js$logic$tileid.TileId.from(a,f),this.seamlessExits.add(d),(e=this.terrains.get(d))&&this.terrains.set(d,this.terrainFactory.seamless(e))):c=this.entrance(this.rom.locations[g],h&31);this.exits.set(b,c)}}processLocationSpawns(a){for(const b of a.spawns){b.isTrigger()?this.processTrigger(a,b):b.isNpc()?this.processNpc(a,b):b.isBoss()?
this.processBoss(a,b):b.isChest()?this.processChest(a,b):b.isMonster()?this.processMonster(a,b):3===b.type&&224===b.id&&this.processKeyUse(module$js$logic$hitbox.Hitbox.screen(module$js$logic$tileid.TileId.from(a,b)),this.rom.flags.UsedWindmillKey.r);for(const [c,d]of this.itemUses.get(b.type<<8|b.id))this.processItemUse([module$js$logic$tileid.TileId.from(a,b)],c,d)}}processTrigger(a,b){var c;const d=this.rom.trigger(b.id);if(!d)throw Error(`Missing trigger ${b.id.toString(16)}`);const e=this.filterRequirements(d.conditions);
let f=this.filterAntiRequirements(d.conditions);const g=module$js$logic$tileid.TileId.from(a,b);b=module$js$logic$hitbox.Hitbox.trigger(a,b);const h=[];for(const a of d.flags){const b=this.flag(a);(null===(c=b)||void 0===c?0:c.logic.track)&&h.push(b.id)}h.length&&this.addCheck(b,e,h);switch(d.message.action){case 25:134!==d.id||this.flagset.assumeRabbitSkip()?186!==d.id||this.flagset.assumeTeleportSkip()||this.flagset.disableTeleportSkip()||(b=module$js$logic$hitbox.Hitbox.atLocation(b,this.rom.locations.CordelPlainEast,
this.rom.locations.CordelPlainWest)):b=module$js$logic$hitbox.Hitbox.adjust(b,[0,-1],[0,1]);this.addTerrain(b,this.terrainFactory.statue(f));break;case 29:this.addBossCheck(b,this.rom.bosses.Mado1,e);break;case 8:case 11:case 12:case 13:case 15:this.addItemGrantChecks(b,e,d.id);break;case 24:a=this.flagset.chargeShotsOnly()?module$js$logic$requirement.Requirement.meet(e,and$$module$js$logic$world(this.rom.flags.WarpBoots)):e;this.addItemCheck(b,a,this.rom.flags.StomFightReward.id,{lossy:!0,unique:!0});
break;case 30:this.addItemCheck(b,e,this.rom.flags.MesiaInTower.id,{lossy:!0,unique:!0});break;case 31:this.handleBoat(g,a,e);break;case 27:a===this.rom.locations.PortoaPalace_Entrance&&(b=module$js$logic$hitbox.Hitbox.adjust(b,[-2,0]),f=this.rom.flags.TalkedToFortuneTeller.r),this.handleMovingGuard(b,a,f)}}processNpc(a,b){var c,d,e,f,g,h;const k=this.rom.npcs[b.id];if(!k||!k.used)throw Error(`Unknown npc: ${hex$$module$js$rom$util(b.id)}`);const m=k.spawnConditions.get(a.id)||[];var l=this.filterRequirements(m);
b=module$js$logic$tileid.TileId.from(a,b);b=[this.terrains.has(b)?b:(c=this.walkableNeighbor(b),null!==c&&void 0!==c?c:b)];k===this.rom.npcs.SaberaDisguisedAsMesia&&this.addBossCheck(b,this.rom.bosses.Sabera1,l);k.data[2]&4&&!this.flagset.assumeStatueGlitch()&&(c=this.filterAntiRequirements(m),k===this.rom.npcs.Rage?(b=module$js$logic$hitbox.Hitbox.adjust(b,[2,-1],[2,0],[2,1],[2,2]),b=module$js$logic$hitbox.Hitbox.adjust(b,[0,-6],[0,-2],[0,2],[0,6]),this.flagset.assumeRageSkip()&&(c=void 0)):k===
this.rom.npcs.PortoaThroneRoomBackDoorGuard&&(c=or$$module$js$logic$world(this.rom.flags.MesiaRecording,this.rom.flags.Paralysis)),c&&this.addTerrain(b,this.terrainFactory.statue(c)));k===this.rom.npcs.FortuneTeller&&(b=module$js$logic$hitbox.Hitbox.adjust(b,[0,0],[2,0]));if(!module$js$logic$requirement.Requirement.isClosed(l)){[[...l]]=l;for(const a of k.globalDialogs)c=this.flag(~a.condition),null!==(d=c)&&void 0!==d&&d.logic.track&&l.push(c.id);a=(f=(e=k.localDialogs.get(a.id),null!==e&&void 0!==
e?e:k.localDialogs.get(-1)),null!==f&&void 0!==f?f:[]);for(const c of a)e=[...l],f=this.flag(c.condition),(null===(g=f)||void 0===g?0:g.logic.track)&&e.push(f.id),this.processDialog(b,k,e,c),e=this.flag(~c.condition),(null===(h=e)||void 0===h?0:h.logic.track)&&l.push(e.id)}}processDialog(a,b,c,d){this.addCheckFromFlags(a,[c],d.flags);const e={lossy:!0,unique:!0};switch(d.message.action){case 8:this.processKeyUse(a,[c]);break;case 20:this.addItemCheck(a,[c],this.rom.flags.SlimedKensu.id,e);break;case 16:this.addItemCheck(a,
[c],this.rom.flags.AsinaInBackRoom.id,e);break;case 17:this.addItemCheck(a,[c],256|b.data[1],e);break;case 3:case 10:this.addItemCheck(a,[c],256|b.data[0],e);break;case 9:b=b.data[1];255!==b&&this.addItemCheck(a,[c],256|b,e);break;case 25:this.addItemCheck(a,[c],this.rom.flags.AkahanaFluteOfLimeTradein.id,e);break;case 26:this.addItemCheck(a,[c],this.rom.flags.Rage.id,e)}}processLocationItemUses(a){for(const [b,c]of this.itemUses.get(~a.id))this.processItemUse([this.entrance(a)],b,c)}handleMovingGuard(a,
b,c){if(!this.flagset.assumeStatueGlitch()){var d=[];for(const a of b.spawns.slice(0,2))if(a.isNpc()&&this.rom.npcs[a.id].isParalyzable()){d.push([this.rom.flags.Paralysis.id]);break}this.addTerrain(a,this.terrainFactory.statue([...c,...d].map(spread$$module$js$util)))}}handleBoat(a,b,c){const d=this.walkableNeighbor(a);if(null==d)throw Error("Could not find walkable neighbor.");const e=a>>8&240|a>>4&15;a=a>>4&240|a&15;var f;for(const c of b.exits)c.yt===e&&c.xt<a&&(f=c);if(!f)throw Error("Could not find boat exit");
...
v.tile&&r.has(v.tile)){q.push(...x);break}if(164===a.tileset)for(r=q.length-1;0<=r;r--)69648===q[r].edges&&q.splice(r,1);r=new Set([...a.reachableTiles(!0).keys()].map((a)=>a>>>8));if(!r.size)throw Error("No reachable tiles");x=new Map(a.entrances.map((b,c)=>{for(const d of a.exits)if(20>Math.abs(d.x-b.x)&&20>Math.abs(d.y-b.y))return[c,d.dest<<8|d.entrance];return null}).filter(isNonNull$$module$js$util));for(v=0;v<a.entrances.length;v++){var y=a.entrances[v],B=this.stairsByTile.get(a.screens[y.screen>>>
4][y.screen&15]<<8|y.tile);if(null!=B){var C=x.get(v);if(null==C)throw Error("Could not find exit");m.set(y.screen,{entrance:v,exit:C,dir:B})}}for(v=0;v<a.height;v++)for(y=0,v||(y|=1),v===a.height-1&&(y|=4),B=0;B<a.width;B++){C=v<<4|B;if(!r.has(C))continue;y&=-11;B||(y|=8);B===a.width-1&&(y|=2);var u=a.screens[v][B];p.add(u);if(128===u)continue;WIDE_SET$$module$js$maze$spec.has(u)?k=!0:h=!1;b++;RIVER_TILES$$module$js$maze$spec.has(u)&&g++;let q=this.edgesByTile.get(u);if(null==q)throw Error(`Bad tile: ${hex$$module$js$rom$util(u)}`);
var t=BITCOUNT$$module$js$maze$spec[q]+(m.has(C)?1:0);154===u&&(t=2);if(155===u||156==u||240==u||241==u)t=1;1===t&&c++;2<t&&(d+=t-2);t=this.walls.get(u);"wall"===t&&e++;"bridge"===t&&f++;t=this.fixedTiles.get(u);this.deadEndTiles.has(u)&&(q=0);for(var T of module$js$maze$types.Dir.ALL)if(q&y&1<<T){u=null;for(var O=0;O<a.entrances.length;O++)if(a.entrances[O].screen===C&&matchesDir$$module$js$maze$spec(a.entrances[O].tile,T)){u=O;break}if(null!=u){O=x.get(u);if(null==O)throw Error("Could not find exit");
l.set(C,{entrance:u,exit:O,dir:T})}}null!=t&&n.set(C,t)}if(g)for(const [a,b]of n)29046===b.edges&&(T=q.find((a)=>459009===a.edges))&&n.set(a,T);if(h!=k)throw Error("Found inconsistent use of wide tiles");return{size:b,rivers:g,deadEnds:c,branches:d,walls:e,bridges:f,stairs:m,edges:l,fixed:n,tiles:p,wide:h,specs:q,specSet:this}}}SpecSet$$module$js$maze$spec.CAVE=new SpecSet$$module$js$maze$spec(ALL_CAVE_SCREENS$$module$js$maze$spec,EMPTY_CAVE_SCREEN$$module$js$maze$spec);
...
function deterministicPreParse$$module$js$pass$deterministic(a){a[107924]=255;a[118213]=168;a[108620]=255;a[120899]=160;a[122987]&=7;a[122991]&=7;a[122995]&=7;a[122999]&=7;a[123003]&=7;a[123012]&=7;a[123035]&=7;a[123065]&=7;a[123141]=47;a[105393]=112;a[105397]=113;a[105079]=114;a[105963]=115;a[106565]=116;a[106721]=117;a[106725]=118;a[106729]=119;a[108037]=120;a[107457]=121;a[107461]=122;a[107465]=123;write$$module$js$pass$deterministic(a,123063,192,0);write$$module$js$pass$deterministic(a,116749,
162,179);a[109190]=254}
...
Swan_Tavern:v,WindmillCave:y,WaterfallCave4:B,WaterfallValleyNorth:C,ZebuCave:u,ZombieTown_HouseBasement:t},items:{GlowingLamp:T,KeyToPrison:O,LovePendant:jb,StatueOfOnyx:ka},npcs:{Akahana:va,AkahanaInBrynmaer:wa,Asina:xa,AztecaInShyron:Wa,Clark:Xa,Draygon:X,FortuneTeller:kb,Kensu:U,KensuInCabin:P,KensuInSwan:I,LeafRabbit:M,OakChild:N,OakElder:la,OakMother:aa,PortoaPalaceFrontGuard:ya,PortoaQueen:Y,PortoaThroneRoomBackDoorGuard:ma,Rage:na,Stom:oa,StonedAkahana:ea,Tornel:Da,WindmillGuard:Oa,Zebu:Ea},
flags:w}=a;U.localDialogs.delete(v.id);I.link(U.id);I.used=!0;I.data=[...U.data];U.data[0]=T.id;x.spawns.find((a)=>a.isNpc()&&a.id===U.id).id=I.id;jb.itemUseData[0].want=256|I.id;ea.linkDialog(va.id);wa.used=!0;wa.link(va.id);wa.data=[...va.data];f.spawns.find((a)=>a.isNpc()&&a.id===va.id).id=wa.id;ka.itemUseData[0].want=256|wa.id;M.dialog()[2].condition=w.RescuedLeafElder.id;M.dialog()[2].flags.push(w.TalkedToLeafRabbit.id);M.dialog()[3].flags.push(w.TalkedToLeafRabbit.id);Oa.spawns(y)[1]=~w.WindmillGuardAlarmFluteTradein.id;
c(va.spawns(B),~w.BehindWhirlpool.id);c(ea.spawns(B),~w.BehindWhirlpool.id);la.dialog()[0].message.action=3;la.dialog()[1].message.action=3;la.dialog()[2].message.action=3;la.dialog()[3].message.action=3;(()=>{const [a,b,c,d]=aa.dialog();d.condition=~w.RescuedChild.id;b.condition=-1;aa.dialog().splice(0,4,d,c,a,b)})();for(const b of[32,33,34,124,125])d(a.npcs[b].dialog());N.dialog().unshift(...N.dialog().splice(1,1));ma.spawnConditions.set(l.id,[~w.QueenNotInThroneRoom.id,~w.MesiaRecording.id]);ya.dialog()[1].condition=
w.MesiaRecording.id;Y.dialog()[3].condition=w.SwordOfWater.id;Y.dialog()[3].message.action=3;Y.dialog()[4].flags.push(w.PortoaQueenGoingAway.id);Y.spawns(l)[1]=~w.MesiaRecording.id;Y.spawns(n)[0]=w.MesiaRecording.id;Y.dialog()[1].condition=w.MesiaRecording.id;kb.spawns(p)[1]=~w.MesiaRecording.id;Xa.spawnConditions.set(t.id,[~w.Clark.id]);Xa.spawnConditions.set(h.id,[w.Clark.id]);Ea.localDialogs.set(u.id,[LocalDialog$$module$js$rom$npc.of(~w.TalkedToZebuInCave.id,[0,26],[w.TalkedToZebuInCave.id]),
LocalDialog$$module$js$rom$npc.of(w.LeafVillagersRescued.id,[0,29]),LocalDialog$$module$js$rom$npc.of(w.LeafAbduction.id,[0,28]),LocalDialog$$module$js$rom$npc.of(w.ZebuAtWindmill.id,[0,29]),LocalDialog$$module$js$rom$npc.of(w.UsedWindmillKey.id,[0,27,3]),LocalDialog$$module$js$rom$npc.of(-1,[0,29])]);c(Ea.spawns(u),~w.BehindWhirlpool.id);Da.spawnConditions.delete(m.id);oa.spawnConditions.delete(r.id);xa.data[1]=a.items.FluteOfLime.id;xa.dialog(n)[0].message.action=17;xa.dialog(n)[2].message.action=
17;c(xa.spawns(n),~w.CalmedAngrySea.id);P.spawnConditions.set(e.id,[~w.AbleToRideDolphin.id,w.ReturnedFogLamp.id]);P.dialog()[0].message.action=2;Wa.spawns(q).push(~w.ShyronMassacre.id);a.trigger(130).conditions.push(~w.ShyronMassacre.id);na.dialog()[0].condition=w.SwordOfWater.id;X.spawnConditions.set(g.id,[~w.Draygon2.id]);Ea.dialog(q).unshift(...Ea.dialog(q).splice(1,1));a.trigger(128).conditions=[~w.ShyronMassacre.id,w.TalkedToZebuInShyron.id,w.SwordOfThunder.id];a.trigger(129).conditions=[];
b.barrierRequiresCalmSea()&&a.trigger(132).conditions.push(w.CalmedAngrySea.id);a.trigger(140).conditions.push(w.TalkedToZebuInCave.id);a.trigger(141).used=!1;for(const a of k.spawns)a.isTrigger()&&141===a.id&&(a.id=178);(function(a,b){b=a.findIndex(b);if(0>b)throw Error(`Could not find element in ${a}`);a.splice(b,1)})(C.spawns,(a)=>a.isTrigger()&&141===a.id);a.trigger(178).conditions.push(w.Kelbesque1.id);a.trigger(178).flags.push(~w.LeafVillagersCurrentlyAbducted.id,~w.LeafElderCurrentlyAbducted.id,
w.LeafVillagersRescued.id);a.trigger(140).conditions.push(~w.Kelbesque1.id);a.trigger(134).conditions.push(~w.Kelbesque1.id);c(O.itemUseData[0].flags,~w.LeafVillagersCurrentlyAbducted.id);a.trigger(186).conditions[0]=~w.Teleport.id;a.trigger(187).conditions[1]=~w.MesiaRecording.id}function disableStabs$$module$js$pass$deterministic(a){for(const b of[8,9,39])a.objects[b].collisionPlane=0;a.npcs.Brokahana.data[0]=a.items.FruitOfLime.id}
...
b.text.replace(c,d)}const {flags:{AkahanaStatueOfOnyxTradein:f,AsinaInBackRoom:g,BehindWhirlpool:h,KensuInSwan:k,MtSabreNorthSummit:m,MtSabreWestTornel:l,PortoaQueen:n,Rage:p,RepairedStatue:q,SlimedKensu:r,StomFightReward:x,ZebuAtWindmill:v},npcs:{AkahanaInBrynmaer:y,Aryllis:B,Fisherman:C}}=a;e("03:06",",","");const u=buildTradeInMap$$module$js$pass$shuffletrades(a);v.item.isMagic()||c("00:1b");e("00:1b","[41:Refresh]",d(v.item));var t=b(y);e("02:01","an unusual statue",vague$$module$js$pass$fixdialog(t));
e("02:02","a statue",`the ${commonNoun$$module$js$pass$fixdialog(t)}`);e("02:02","[29:Gas Mask]",d(f));x.item.isMagic()||c("03:01");e("03:01","[43:Telepathy]",d(x));t=findTornelTradeIn$$module$js$pass$fixdialog(a);e("03:01","[06:Tornado Bracelet]",d(t));e("05:0a","[06:Tornado Bracelet]",d(t));e("05:0a","[44:Teleport]",d(l));t=b(C);e("09:01","[35:Fog Lamp]",d(t));e("09:04","[35:Fog Lamp]",d(t));e("09:05","[35:Fog Lamp]",d(t));e("09:06","lamp",commonNoun$$module$js$pass$fixdialog(t));t=a.npcs.PortoaQueen.dialog()[3].condition;
