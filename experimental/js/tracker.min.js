...
{title:"Tournament: Swiss Round",descr:"Quick-paced full-shuffle flags for Swiss round of 2019 Tournament",flags:"Es Fcprsw Gt Hd Mr Ps Rpt Tab"},{title:"Tournament: Elimination Round",descr:"More thorough flags for the first elimination rounds of the 2019 Tournament",flags:"Em Fprsw Gft Hbd Mer Ps Rprst Tab Wt"},{title:"Tournament: Semifinals",descr:"Advanced flags for semifinal round of the 2019 Tournament",flags:"Em Fsw Gft Hbd Mert Ps Roprst Tab Wt"},{title:"Tournament: Finals",descr:"Expert flags for finals round of the 2019 Tournament",
flags:"Fsw Gfprt Hbdw Mert Ps Roprst Tab Wmtw"}],PRESETS_BY_KEY$$module$js$flagset={};for(const {title:a,flags:b}of PRESETS$$module$js$flagset)PRESETS_BY_KEY$$module$js$flagset[`@${a.replace(/ /g,"").toLowerCase()}`]=b;
...
function deterministicPreParse$$module$js$pass$deterministic(a){a[107924]=255;a[118213]=168;a[108620]=255;a[122987]&=7;a[122991]&=7;a[122995]&=7;a[122999]&=7;a[123003]&=7;a[123012]&=7;a[123035]&=7;a[123065]&=7;a[105393]=112;a[105397]=113;a[105079]=114;a[105963]=115;a[106565]=116;a[106721]=117;a[106725]=118;a[106729]=119;a[108037]=120;a[107457]=121;a[107461]=122;a[107465]=123;write$$module$js$pass$deterministic(a,123063,192,0);write$$module$js$pass$deterministic(a,116749,162,179);a[109190]=254}
function deterministic$$module$js$pass$deterministic(a,b){addZombieWarp$$module$js$pass$deterministic(a);consolidateItemGrants$$module$js$pass$deterministic(a);addMezameTrigger$$module$js$pass$deterministic(a);normalizeSwords$$module$js$pass$deterministic(a,b);fixCoinSprites$$module$js$pass$deterministic(a);fixChests$$module$js$pass$deterministic(a);makeBraceletsProgressive$$module$js$pass$deterministic(a);addTowerExit$$module$js$pass$deterministic(a);reversibleSwanGate$$module$js$pass$deterministic(a);
...
this[49]=dialogProgression$$module$js$rom$flags("Zombie town");this[50]=obsolete$$module$js$rom$flags(311);this[52]=dialogProgression$$module$js$rom$flags("Akahana in waterfall cave");this.CuredAkahana=movable$$module$js$rom$flags(53,TRACK$$module$js$rom$flags);this[54]=dialogProgression$$module$js$rom$flags("Akahana Shyron");this[55]=obsolete$$module$js$rom$flags(322);this.LeafAbduction=movable$$module$js$rom$flags(56,TRACK$$module$js$rom$flags);this[57]=obsolete$$module$js$rom$flags(321);this.TalkedToZebuInCave=
movable$$module$js$rom$flags(58,TRACK$$module$js$rom$flags);this.TalkedToZebuInShyron=movable$$module$js$rom$flags(59,TRACK$$module$js$rom$flags);this[60]=obsolete$$module$js$rom$flags(315);this[61]=dialogProgression$$module$js$rom$flags("Asina in Shyron temple");this.FoundKensuInDanceHall=movable$$module$js$rom$flags(62,TRACK$$module$js$rom$flags);this[63]=obsolete$$module$js$rom$flags((a)=>{var b;return 186===(null===(b=a.trigger)||void 0===b?void 0:b.id)?580:324});this[64]=dialogProgression$$module$js$rom$flags("Tornel in Shyron temple");
this[65]=obsolete$$module$js$rom$flags(263);this[68]=obsolete$$module$js$rom$flags(263);this.RescuedChild=fixed$$module$js$rom$flags(69,TRACK$$module$js$rom$flags);this.RescuedLeafElder=movable$$module$js$rom$flags(71);this[72]=dialogProgression$$module$js$rom$flags("Treasure hunter embarked");this[73]=obsolete$$module$js$rom$flags(257);this[74]=dialogProgression$$module$js$rom$flags("Boat owner");this[75]=dialogToggle$$module$js$rom$flags("Shyron sick men");this[76]=dialogToggle$$module$js$rom$flags("Shyron training men 1");
this[77]=dialogToggle$$module$js$rom$flags("Shyron training men 2");this[78]=obsolete$$module$js$rom$flags(262);this[79]=obsolete$$module$js$rom$flags(299);this.GivenStatueToAkahana=movable$$module$js$rom$flags(80);this[81]=obsolete$$module$js$rom$flags(326);this.TalkedToDwarfMother=movable$$module$js$rom$flags(82,TRACK$$module$js$rom$flags);this.LeadingChild=fixed$$module$js$rom$flags(83,TRACK$$module$js$rom$flags);this[85]=dialogProgression$$module$js$rom$flags("Zebu rescued");this[86]=dialogProgression$$module$js$rom$flags("Tornel rescued");
this[87]=dialogProgression$$module$js$rom$flags("Asina rescued");this.MtSabreGuardsDespawned=movable$$module$js$rom$flags(91,TRUE$$module$js$rom$flags);this[94]=obsolete$$module$js$rom$flags(653);this[95]=obsolete$$module$js$rom$flags(515);this.TalkedToStomInSwan=movable$$module$js$rom$flags(97,TRACK$$module$js$rom$flags);this[99]=obsolete$$module$js$rom$flags(327);this.CuredKensu=movable$$module$js$rom$flags(101);this[103]=obsolete$$module$js$rom$flags(267);this[104]=obsolete$$module$js$rom$flags(260);
this.StonedPeopleCured=movable$$module$js$rom$flags(106,TRACK$$module$js$rom$flags);this[108]=obsolete$$module$js$rom$flags(284);this.CurrentlyRidingDolphin=fixed$$module$js$rom$flags(-111,TRACK$$module$js$rom$flags);this.ParalyzedKensuInTavern=fixed$$module$js$rom$flags(112);this.ParalyzedKensuInDanceHall=fixed$$module$js$rom$flags(113);this.FoundKensuInTavern=movable$$module$js$rom$flags(114,TRACK$$module$js$rom$flags);this[115]=dialogProgression$$module$js$rom$flags("Startled man in Leaf");this[117]=
obsolete$$module$js$rom$flags(313);this[118]=dialogProgression$$module$js$rom$flags("Kensu in Goa");this[119]=obsolete$$module$js$rom$flags(264);this[120]=obsolete$$module$js$rom$flags(268);this[121]=obsolete$$module$js$rom$flags(320);this[122]=obsolete$$module$js$rom$flags(266);this[125]=obsolete$$module$js$rom$flags(319);this[126]=dialogProgression$$module$js$rom$flags("Mt Sabre guards 1");this[127]=dialogProgression$$module$js$rom$flags("Mt Sabre guards 2");this.AlarmFluteUsedOnce=fixed$$module$js$rom$flags(118);
this.FluteOfLimeUsedOnce=fixed$$module$js$rom$flags(119);this[130]=obsolete$$module$js$rom$flags(320);this[131]=dialogProgression$$module$js$rom$flags("Rescued Leaf elder");this.LeafVillagersCurrentlyAbducted=movable$$module$js$rom$flags(132);this.LeafElderCurrentlyAbducted=movable$$module$js$rom$flags(133);this.UsedBowOfTruth=movable$$module$js$rom$flags(134);this[135]=obsolete$$module$js$rom$flags(261);this[136]=obsolete$$module$js$rom$flags(306);this[137]=dialogProgression$$module$js$rom$flags("Dead Stom's girlfriend");
this[138]=dialogProgression$$module$js$rom$flags("Dead Stom");this[139]=obsolete$$module$js$rom$flags(566);this[141]=obsolete$$module$js$rom$flags(311);this[143]=obsolete$$module$js$rom$flags(643);this[144]=dialogProgression$$module$js$rom$flags("Stoned people gone");this[146]=obsolete$$module$js$rom$flags(296);this[150]=dialogToggle$$module$js$rom$flags("Leaf elder daughter");this[151]=dialogToggle$$module$js$rom$flags("Leaf villager");this[152]=dialogProgression$$module$js$rom$flags("Nadare villager");
this.AbleToRideDolphin=movable$$module$js$rom$flags(155,TRACK$$module$js$rom$flags);this.PortoaQueenGoingAway=movable$$module$js$rom$flags(156);this[160]=obsolete$$module$js$rom$flags(295);this[163]=dialogToggle$$module$js$rom$flags("Portoa queen/fortune teller");this.WokeKensuInLighthouse=movable$$module$js$rom$flags(164,TRACK$$module$js$rom$flags);this[165]=obsolete$$module$js$rom$flags(305);this[166]=dialogProgression$$module$js$rom$flags("Oak elder 1");this[167]=dialogToggle$$module$js$rom$flags("Swan dancer");
this[168]=dialogProgression$$module$js$rom$flags("Oak elder 2");this.TalkedToLeafRabbit=movable$$module$js$rom$flags(169,TRACK$$module$js$rom$flags);this[170]=obsolete$$module$js$rom$flags(285);this[171]=obsolete$$module$js$rom$flags(336);this[173]=obsolete$$module$js$rom$flags(338);this[174]=obsolete$$module$js$rom$flags(339);this[175]=obsolete$$module$js$rom$flags(340);this[176]=obsolete$$module$js$rom$flags(341);this[177]=obsolete$$module$js$rom$flags(342);this[178]=obsolete$$module$js$rom$flags(343);
this[179]=obsolete$$module$js$rom$flags(344);this[180]=obsolete$$module$js$rom$flags(345);this[181]=obsolete$$module$js$rom$flags(346);this[182]=obsolete$$module$js$rom$flags(287);this[183]=obsolete$$module$js$rom$flags(348);this[184]=obsolete$$module$js$rom$flags(349);this[185]=obsolete$$module$js$rom$flags(286);this[186]=obsolete$$module$js$rom$flags(350);this[187]=obsolete$$module$js$rom$flags(351);this[188]=obsolete$$module$js$rom$flags(352);this[189]=obsolete$$module$js$rom$flags(288);this[190]=
obsolete$$module$js$rom$flags(289);this[191]=obsolete$$module$js$rom$flags(354);this[192]=obsolete$$module$js$rom$flags(355);this[193]=obsolete$$module$js$rom$flags(356);this[194]=obsolete$$module$js$rom$flags(290);this[195]=obsolete$$module$js$rom$flags(357);this[196]=obsolete$$module$js$rom$flags(358);this[197]=obsolete$$module$js$rom$flags(363);this[198]=obsolete$$module$js$rom$flags(364);this[199]=obsolete$$module$js$rom$flags(291);this[200]=obsolete$$module$js$rom$flags(292);this[201]=obsolete$$module$js$rom$flags(362);
this[202]=obsolete$$module$js$rom$flags(317);this[203]=obsolete$$module$js$rom$flags(298);this[204]=obsolete$$module$js$rom$flags(284);this[205]=obsolete$$module$js$rom$flags(276);this[206]=obsolete$$module$js$rom$flags(293);this[207]=obsolete$$module$js$rom$flags(307);this[208]=obsolete$$module$js$rom$flags(296);this[209]=obsolete$$module$js$rom$flags(309);this[210]=obsolete$$module$js$rom$flags(361);this[211]=obsolete$$module$js$rom$flags(294);this[212]=obsolete$$module$js$rom$flags(347);this[213]=
dialogToggle$$module$js$rom$flags("Portoa queen 1");this[214]=dialogToggle$$module$js$rom$flags("Portoa queen 2");this[215]=dialogToggle$$module$js$rom$flags("Portoa queen 3");this[216]=dialogProgression$$module$js$rom$flags("Kensu rescued");this[217]=dialogToggle$$module$js$rom$flags("Stoned pair");this[218]=dialogProgression$$module$js$rom$flags("Kensu gone from tavern");this[219]=dialogToggle$$module$js$rom$flags("In Sabera's trap");this[220]=obsolete$$module$js$rom$flags(367);this[222]=obsolete$$module$js$rom$flags(300);
this[223]=obsolete$$module$js$rom$flags(283);this[224]=dialogProgression$$module$js$rom$flags("Dead Akahana");this[228]=obsolete$$module$js$rom$flags(316);this[229]=obsolete$$module$js$rom$flags(366);this[230]=obsolete$$module$js$rom$flags(365);this[231]=obsolete$$module$js$rom$flags(303);this[232]=dialogProgression$$module$js$rom$flags("Dead Shyron villager");this[233]=dialogProgression$$module$js$rom$flags("Dead Shyron guard");this[234]=dialogProgression$$module$js$rom$flags("Tower message 1");
...
var module$js$rom$townwarp={};module$js$rom$townwarp.TownWarp=TownWarp$$module$js$rom$townwarp;const UNUSED_TRIGGERS$$module$js$rom$trigger=new Set([135,136,137,143,147,150,152,155,156,157,158,159,160,179,181,185,190,192]);
