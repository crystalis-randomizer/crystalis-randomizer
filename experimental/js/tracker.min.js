...
!1)),la=c("Sword of Thunder teleports to Shyron",f("Rt",!0)),La=c("Barrier magic optional",f("Hb",!0)),Ma=c("Refresh magic optional",f("!Er",!0)),Md=c("Lime Tree connects to Leaf",f("Rp",!0)),Nd=k(c("Assume wild warp",f("Gw",!1))),Od=c("Allow wild warp",f("!Tw",!1)),Pd=k(c("Assume sword charge glitch",f("Gc",!1))),Qd=c("Buffed medical herb",f("!Hm",!0)),V=d(0,"Sword of Wind").weight(5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),W=d(1,"Sword of Fire").weight(5).fromPerson("Oak elder",
29).dialog(29,null,3).key(),P=d(2,"Sword of Water").weight(10).chest().key(),K=d(3,"Sword of Thunder").weight(15).chest().key(),mb=d(4,"Crystalis").fixed(),Na=d(5,"Ball of Wind").chest().key(),Ga=d(6,"Tornado Bracelet").chest().key(),Oa=d(7,"Ball of Fire").bossDrop("Insect",1).dialog(30,null,0).dialog(32,null,0).dialog(33,null,0).dialog(34,null,0).dialog(96,30,0).dialog(29,null,2).dialog(31,null,0).npcSpawn(193).key(),Pa=d(8,"Flame Bracelet").bossDrop("Kelbesque 1",2).npcSpawn(194).key(),Qa=d(9,"Ball of Water").weight(5).direct("Rage",
250679).npcSpawn(195).key(),Ra=d(10,"Blizzard Bracelet").weight(5).chest().key(),Sa=d(11,"Ball of Thunder").bossDrop("Mado 1",5).trigger(154,1).key(),Ta=d(12,"Storm Bracelet").chest().key(),Tb=d(13,"Carapace Shield").armor(),Rd=d(14,"Bronze Shield").armor(),Ub=d(15,"Platinum Shield").armor(),Vb=d(16,"Mirrored Shield").armor(),Sd=d(17,"Ceramic Shield").armor(),nb=d(18,"Sacred Shield").armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),Wb=d(19,"Battle Shield").armor(),Td=d(20,"Psycho Shield").armor(),
Ud=d(21,"Tanned Hide").armor(),Vd=d(22,"Leather Armor").armor(),Wd=d(23,"Bronze Armor").armor(),Xb=d(24,"Platinmum Armor").armor(),Xd=d(25,"Soldier Suit").armor(),Yb=d(26,"Ceramic Suit").armor(),Yd=d(27,"Battle Suit").armor(),Zd=d(28,"Psycho Armor").armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),E=d(29,"Medical Herb").consumable(),H=d(30,"Antidote").consumable(),ma=d(31,"Lysis Plant").consumable(),ob=d(32,"Fruit of Lime").consumable(),L=d(33,"Fruit of Power").consumable(),
...
156,1).dialog(131,null,0).key(),Va=(new Magic$$module$js$nodes(a,65,"Refresh",65,null)).fromPerson("Zebu at windmill",94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),Wa=(new Magic$$module$js$nodes(a,66,"Paralysis",66,null)).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),na=(new Magic$$module$js$nodes(a,67,"Telepathy",67,null)).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),oc=(new Magic$$module$js$nodes(a,68,"Teleport",
68,null)).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),de=(new Magic$$module$js$nodes(a,69,"Recover",69,null)).direct("Asina in Portoa",250361),pc=(new Magic$$module$js$nodes(a,70,"Barrier",70,null)).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),ua=(new Magic$$module$js$nodes(a,71,"Change",71,null)).direct("Kensu in Swan",251614).npcSpawn(116,241,1),B=(new Magic$$module$js$nodes(a,72,"Flight",72,null)).weight(15).direct("Kensu in Draygonia Fortress",250255),ee=L.bossDrop("Vampire 2",
12,97).npcSpawn(204).key(),I=d(112,"Mimic"),qc=(new Trigger$$module$js$nodes(a,"Talked to Leaf Elder")).get(V),rc=(new Trigger$$module$js$nodes(a,"Talked to Leaf Student")).get(tb),wb=new Trigger$$module$js$nodes(a,"Talked to Zebu in cave"),fe=(new Trigger$$module$js$nodes(a,"Woke up Windmill Guard")).get(cc),Xa=new Trigger$$module$js$nodes(a,"Started Windmill"),sc=(new Trigger$$module$js$nodes(a,"Learned Refresh")).get(Va),ge=(new Trigger$$module$js$nodes(a,"Gave Statue to Akahana")).get(Ua),he=
(new Trigger$$module$js$nodes(a,"Fought Stom")).get(na),tc=new Trigger$$module$js$nodes(a,"Visited Oak"),uc=new Trigger$$module$js$nodes(a,"Talked to Oak Mother"),xb=new Trigger$$module$js$nodes(a,"Rescued Oak Child"),ie=(new Trigger$$module$js$nodes(a,"Talked to Oak Mother Again")).get($b),je=(new Trigger$$module$js$nodes(a,"Talked to Oak Elder")).get(W),ke=(new Trigger$$module$js$nodes(a,"Talked to Tornel on Mt Sabre")).get(oc),vc=new Trigger$$module$js$nodes(a,"Villagers Abducted"),wc=new Trigger$$module$js$nodes(a,
"Talked to Rabbit in Leaf"),le=(new Trigger$$module$js$nodes(a,"Learned Paralysis")).get(Wa),xc=new Trigger$$module$js$nodes(a,"Talked to Portoa Queen"),yc=new Trigger$$module$js$nodes(a,"Talked to Fortune Teller"),zc=new Trigger$$module$js$nodes(a,"Visited Underground Channel"),me=(new Trigger$$module$js$nodes(a,"Sent to Waterfall Cave")).get(rb),ne=(new Trigger$$module$js$nodes(a,"Cured Akahana")).get(bc),Ac=(new Trigger$$module$js$nodes(a,"Talked to Rage")).get(Qa),Bc=new Trigger$$module$js$nodes(a,
"Mesia recording played"),Cc=(new Trigger$$module$js$nodes(a,"Talked to Asina")).get(de),Dc=(new Trigger$$module$js$nodes(a,"Healed Dolphin")).get(ub),yb=new Trigger$$module$js$nodes(a,"Returned Fog Lamp"),Ec=new Trigger$$module$js$nodes(a,"Talked to Kensu in Cabin"),Fc=new Trigger$$module$js$nodes(a,"Talked to Joel Elder"),oe=(new Trigger$$module$js$nodes(a,"Talked to Clark")).get(gc),pe=(new Trigger$$module$js$nodes(a,"Talked to Kensu in Lighthouse")).get(ic),zb=new Trigger$$module$js$nodes(a,"Calmed the Angry Sea"),
qe=(new Trigger$$module$js$nodes(a,"Learned Barrier")).get(pc),Gc=new Trigger$$module$js$nodes(a,"Talked to Stom in Swan Hut"),Hc=new Trigger$$module$js$nodes(a,"Talked to Kensu in Swan tavern"),Ic=new Trigger$$module$js$nodes(a,"Talked to Kensu at Swan dance"),re=(new Trigger$$module$js$nodes(a,"Returned Kensu's love pendant")).get(ua),se=(new Trigger$$module$js$nodes(a,"Talked to Amazones Queen")).get(lc),Ab=new Trigger$$module$js$nodes(a,"Entered Shyron"),te=(new Trigger$$module$js$nodes(a,"Talked to Zebu in Shyron")).get(ec),
Jc=new Trigger$$module$js$nodes(a,"Shyron Massacre"),ue=(new Trigger$$module$js$nodes(a,"Saved Kensu")).get(B),ve=(new Trigger$$module$js$nodes(a,"Talked to Deo")).get(ce),we=(new Trigger$$module$js$nodes(a,"Talked to Akahana's Friend")).get(ae),xe=(new Trigger$$module$js$nodes(a,"Get Bow of Truth")).get(nc),ye=(new Trigger$$module$js$nodes(a,"Forged Crystalis")).get(mb),Ya=(new Condition$$module$js$nodes(a,"Sword charge glitch")).option(Pd),ze=(new Condition$$module$js$nodes(a,"Rabbit skip")).option(l),
Ae=(new Condition$$module$js$nodes(a,"Teleport skip")).option(t),Bb=(new Condition$$module$js$nodes(a,"Statue glitch")).option(r),Be=(new Condition$$module$js$nodes(a,"Wild warp")).option(Nd,Od),Za=(new Condition$$module$js$nodes(a,"Any level 2 sword")).option(V,Na).option(V,Ga).option(W,Oa).option(W,Pa).option(P,Qa).option(P,Ra).option(K,Sa).option(K,Ta),w=(new Condition$$module$js$nodes(a,"Destroy stone")).option(V,Na).option(V,Ga).option(Ya,V,Za),x=(new Condition$$module$js$nodes(a,"Destroy ice")).option(W,
Oa).option(W,Pa).option(Ya,W,Za),q=(new Condition$$module$js$nodes(a,"Cross rivers")).option(P,Qa).option(P,Ra).option(B).option(Ya,P,Za),va=(new Condition$$module$js$nodes(a,"Destroy iron")).option(K,Sa).option(K,Ta).option(Ya,K,Za),X=(new Condition$$module$js$nodes(a,"Any sword")).option(V).option(W).option(P).option(K),Ce=(new Condition$$module$js$nodes(a,"Match insect sword (fire/water/thunder)")).option(W).option(P).option(K).option(Ua,y.value?y:h,V),Kc=(new Condition$$module$js$nodes(a,"Speed boots")).option(ac,
n),Lc=(new Condition$$module$js$nodes(a,"Climb slopes")).option(sb).option(B).option(Kc),De=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (rabbit)")).option(wc).option(ze),Ee=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (Teleport)")).option(oc).option(Ae,B),Mc=(new Condition$$module$js$nodes(a,"Asina in her room")).option(Bc),Fe=(new Condition$$module$js$nodes(a,"Paralysis or Ball of Water")).option(Wa).option(Mc).option(Bb),Nc=(new Condition$$module$js$nodes(a,"Ride dolphin")).option(ub,
Ec),Ge=(new Condition$$module$js$nodes(a,"Ghetto flight")).option(p,Nc,sb),Y=(new Condition$$module$js$nodes(a,"Cross sea")).option(Nc).option(B),He=(new Condition$$module$js$nodes(a,"Cross whirlpool")).option(zb).option(B).option(Ge),N=(new Condition$$module$js$nodes(a,"Refresh if needed")).option(Ma.value?Ma:h).option(Va),Oc=(new Condition$$module$js$nodes(a,"Wind magic")).option(m.value?m:h,N).option(Na,Ga,N),Pc=(new Condition$$module$js$nodes(a,"Fire magic")).option(m.value?m:h,N).option(Oa,Pa,
N),Qc=(new Condition$$module$js$nodes(a,"Water magic")).option(m.value?m:h,N).option(m,N).option(Qa,Ra,N),Ie=(new Condition$$module$js$nodes(a,"Thunder magic")).option(m.value?m:h,N).option(m,N).option(Sa,N).option(Ta,N),Je=(new Condition$$module$js$nodes(a,"Flute of lime or glitch")).option(rb).option(Bb),Rc=(new Condition$$module$js$nodes(a,"Change or glitch")).option(ua).option(Bb),Cb=(new Condition$$module$js$nodes(a,"Pass shooting statues")).option(pc).option(La.value?La:h).option(Va,bc),Ke=
(new Condition$$module$js$nodes(a,"Healed dolphin if required")).option(Dc).option(ta),Sc=(new Condition$$module$js$nodes(a,"Match sword of wind")).option(V).option(y.value?y:h,X),Tc=(new Condition$$module$js$nodes(a,"Match sword of fire")).option(W).option(y.value?y:h,X),Uc=(new Condition$$module$js$nodes(a,"Match sword of water")).option(P).option(y.value?y:h,X),Le=(new Condition$$module$js$nodes(a,"Match sword of thunder")).option(K).option(y.value?y:h,X),Me=(new Condition$$module$js$nodes(a,"Swamp run possible")).option(X).option(Kc).option(Qd).option(Va),
Ne=(new Condition$$module$js$nodes(a,"Insect possible to kill")).option(Ua),$a=(new Condition$$module$js$nodes(a,"Travel swamp")).option(Ua).option(v.value?v:h,Me),Oe=(new Condition$$module$js$nodes(a,"Calmed sea if required")).option(zb).option(ka),Pe=e(0,"Vampire 1",X).get(sb),Qe=e(1,"Insect",$b,Ce,Ne).get(Oa),Re=e(2,"Kelbesque 1",Sc,Oc).get(Pa),Se=e(12,"Vampire 2",X).get(ee),Vc=e(4,"Sabera 1",Tc,Pc).get(hc),Te=e(5,"Mado 1",Uc,Qc).get(Sa),Ue=e(6,"Kelbesque 2",Sc,Oc).get(qb),Ve=e(7,"Sabera 2",Tc,
Pc).get(pb),We=e(8,"Mado 2",Uc,Qc).get(nb),Xe=e(9,"Karmine",Le,Ie).get(vb),Ye=e(10,"Draygon 1",X).get(Zd),Ze=e(null,"Statues",mc,lc),$e=e(11,"Draygon 2",X,nc),af=e(13,"Dyna",mb),R=new Area$$module$js$nodes(a,"Leaf"),wa=new Area$$module$js$nodes(a,"Valley of Wind"),O=new Area$$module$js$nodes(a,"Sealed Cave"),oa=new Area$$module$js$nodes(a,"Cordel Plain"),xa=new Area$$module$js$nodes(a,"Brynmaer"),ya=new Area$$module$js$nodes(a,"Amazones"),C=new Area$$module$js$nodes(a,"Mt Sabre West"),u=new Area$$module$js$nodes(a,
"Mt Sabre North"),ab=new Area$$module$js$nodes(a,"Nadare's"),Ha=new Area$$module$js$nodes(a,"Oak"),ca=new Area$$module$js$nodes(a,"Waterfall Valley"),A=new Area$$module$js$nodes(a,"Portoa"),da=new Area$$module$js$nodes(a,"Waterfall Cave"),D=new Area$$module$js$nodes(a,"Fog Lamp Cave"),ea=new Area$$module$js$nodes(a,"Kirisa Plant Cave"),pa=new Area$$module$js$nodes(a,"Angry Sea"),fa=new Area$$module$js$nodes(a,"Joel"),G=new Area$$module$js$nodes(a,"Evil Spirit Island"),ha=new Area$$module$js$nodes(a,
"Sabera's Castle"),S=new Area$$module$js$nodes(a,"Swan"),z=new Area$$module$js$nodes(a,"Mt Hydra"),ia=new Area$$module$js$nodes(a,"Shyron"),qa=new Area$$module$js$nodes(a,"Styx"),ra=new Area$$module$js$nodes(a,"Goa"),bb=new Area$$module$js$nodes(a,"Draygonia Fortress 1"),T=new Area$$module$js$nodes(a,"Draygonia Fortress 2"),za=new Area$$module$js$nodes(a,"Draygonia Fortress 3"),J=new Area$$module$js$nodes(a,"Draygonia Fortress 4"),F=new Area$$module$js$nodes(a,"Oasis Cave");new Area$$module$js$nodes(a,
"Desert");const U=new Area$$module$js$nodes(a,"Sahara"),Aa=new Area$$module$js$nodes(a,"Pyramid Front"),Z=new Area$$module$js$nodes(a,"Pyramid Back"),aa=new Area$$module$js$nodes(a,"Tower"),Db=(new Location$$module$js$nodes(a,0,R,"Start")).overworld().start(),bf=(new Location$$module$js$nodes(a,0,R,"Mezame Shrine")).overworld().from(Db),cf=(new Location$$module$js$nodes(a,1,R,"Outside Start")).overworld().connect(bf),ja=(new Location$$module$js$nodes(a,2,R,"Town")).town().connect(cf),Ia=(new Location$$module$js$nodes(a,
3,wa,"Main")).overworld().connect(ja).trigger(sc,Xa),Wc=(new Location$$module$js$nodes(a,3,wa,"Outside Windmill")).overworld(),Xc=(new Location$$module$js$nodes(a,4,O,"Tunnel 1 (entrance)")).cave().from(Ia,Xa),df=(new Location$$module$js$nodes(a,5,O,"Tunnel 2 (over bridge)")).cave().connect(Xc),ef=(new Location$$module$js$nodes(a,6,O,"Tunnel 6 (herb dead end)")).cave().chest(E,15),Yc=(new Location$$module$js$nodes(a,7,O,"Tunnel 4a (ball corridor)")).cave().chest(E,20,80).chest(Na,21);(new Location$$module$js$nodes(a,
7,O,"Tunnel 4b (antidote dead end)")).cave().connect(Yc,w).chest(H,19);const ff=(new Location$$module$js$nodes(a,8,O,"Tunnel 5 (warp boots dead end)")).cave().chest(M,14),gf=(new Location$$module$js$nodes(a,9,O,"Tunnel 3a (branch, front)")).cave().connect(df).connectTo(Yc).connectTo(ff),hf=(new Location$$module$js$nodes(a,9,O,"Tunnel 3b (branch, back)")).cave().connect(gf,w).connectTo(ef),jf=(new Location$$module$js$nodes(a,10,O,"Tunnel 7 (boss)")).cave().connect(hf).boss(Pe),kf=(new Location$$module$js$nodes(a,
12,O,"Tunnel 8a (exit, above wall)")).cave().connect(jf),lf=(new Location$$module$js$nodes(a,12,O,"Tunnel 8b (exit, below wall")).cave().connect(kf,w);(new Location$$module$js$nodes(a,14,wa,"Windmill Cave")).cave().connect(Ia).connectTo(Wc).trigger(fe,tb,wb);(new Location$$module$js$nodes(a,15,wa,"Windmill")).misc().connect(Wc).trigger(Xa,cc);const mf=(new Location$$module$js$nodes(a,16,wa,"Zebu's Cave Front")).cave().connect(Ia).trigger(wb,qc,rc).trigger(sc,Xa,wb),nf=(new Location$$module$js$nodes(a,
16,wa,"Zebu's Cave Back")).cave().trigger(vc).connect(mf,x),of=(new Location$$module$js$nodes(a,17,C,"Tunnel 1 (to Zebu)")).cave().connect(nf),Ba=(new Location$$module$js$nodes(a,20,oa,"West")).overworld().connect(lf),pf=(new Location$$module$js$nodes(a,20,oa,"South")).overworld().connect(Ba,q),Zc=(new Location$$module$js$nodes(a,21,oa,"East")).overworld().connect(Ba).chest(Zb,24),Ja=(new Location$$module$js$nodes(a,24,xa,"Town")).town().connect(Ba).trigger(ge,Zb),qf=(new Location$$module$js$nodes(a,
25,oa,"Outside Stom's House")).town().connect(Ba),Eb=(new Location$$module$js$nodes(a,26,oa,"Swamp")).overworld().connect(Zc,$a).trigger(xb,uc,$a);(new Location$$module$js$nodes(a,26,oa,"Swamp Insect Area")).overworld().connect(Eb,$a).boss(Qe);const cb=(new Location$$module$js$nodes(a,27,ya,"Town")).town().connect(pf),db=(new Location$$module$js$nodes(a,28,Ha,"Town")).town().connect(Eb,$a).trigger(tc);(new Location$$module$js$nodes(a,30,oa,"Stom's House")).house().connect(qf).trigger(he,tc);const Ca=
(new Location$$module$js$nodes(a,32,C,"Entrance")).overworld().connect(Ba).connect(of),rf=(new Location$$module$js$nodes(a,32,C,"Up Slope")).overworld().from(Ca,Lc).to(Ca),sf=(new Location$$module$js$nodes(a,32,C,"Dead End (warp boots)")).overworld().chest(M,24,106),$c=(new Location$$module$js$nodes(a,33,C,"Upper")).overworld().from(Ca,B).to(Ca),tf=(new Location$$module$js$nodes(a,33,C,"Tornel Dead End")).overworld().trigger(ke,Ga).chest(Q,23,105),ad=(new Location$$module$js$nodes(a,34,C,"Tunnel 2a (fork at start)")).cave().connect(Ca);
(new Location$$module$js$nodes(a,34,C,"Tunnel 2b (left branch to dead end)")).cave().connect(ad,x).connectTo(sf);const uf=(new Location$$module$js$nodes(a,34,C,"Tunnel 2c (right branch to upper)")).cave().connect(ad,x),vf=(new Location$$module$js$nodes(a,35,C,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(uf).chest(E,23,82),wf=(new Location$$module$js$nodes(a,35,C,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(vf,x).connectTo($c),bd=(new Location$$module$js$nodes(a,
36,C,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(wf);(new Location$$module$js$nodes(a,36,C,"Tunnel 4b (out to upper)")).cave().connect(bd,x).connectTo($c);const xf=(new Location$$module$js$nodes(a,37,C,"Tunnel 5 (tiny connector)")).cave().connect(bd),yf=(new Location$$module$js$nodes(a,38,C,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(xf);(new Location$$module$js$nodes(a,38,C,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(yf,x).connectTo(tf);const zf=(new Location$$module$js$nodes(a,
39,C,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(rf),Af=(new Location$$module$js$nodes(a,39,C,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(zf,x);(new Location$$module$js$nodes(a,39,C,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Af,x).chest(Ga,25);const eb=(new Location$$module$js$nodes(a,40,u,"Entrance")).overworld().connect(Zc,Ee,De),fb=(new Location$$module$js$nodes(a,40,u,"Upper")).overworld().from(eb,B).to(eb),Fb=(new Location$$module$js$nodes(a,40,u,"Summit (boss)")).overworld().from(fb,
B).to(fb).boss(Re),cd=(new Location$$module$js$nodes(a,41,u,"Connector")).overworld(),Gb=(new Location$$module$js$nodes(a,41,u,"Middle Left")).overworld(),Bf=(new Location$$module$js$nodes(a,41,u,"Middle Right")).overworld().from(Gb,Lc).to(Gb),dd=(new Location$$module$js$nodes(a,42,u,"Tunnel 2a (from entrance to connector)")).cave().connectTo(cd);(new Location$$module$js$nodes(a,42,u,"Tunnel 2b (under bridge, to antidote)")).cave().connect(dd,x).chest(H,23,94);const ed=(new Location$$module$js$nodes(a,
43,u,"Tunnel 3a (branch after connector)")).cave().connect(cd),Cf=(new Location$$module$js$nodes(a,43,u,"Tunnel 3b (right branch)")).cave().connect(ed,x),Df=(new Location$$module$js$nodes(a,43,u,"Tunnel 3c (upper branch)")).cave().connect(ed,x);(new Location$$module$js$nodes(a,44,u,"Tunnel 4 (over bridge, to middle)")).cave().connect(Df).connectTo(Gb);const fd=(new Location$$module$js$nodes(a,45,u,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Cf).connectTo(Bf);(new Location$$module$js$nodes(a,
45,u,"Tunnel 5b (dead-end with herb)")).cave().connect(fd,x).chest(E,22,83);const Ef=(new Location$$module$js$nodes(a,46,u,"Tunne; 6a (S-shaped hall, right)")).cave().connect(fd),Ff=(new Location$$module$js$nodes(a,46,u,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Ef,x),Gf=(new Location$$module$js$nodes(a,46,u,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Ff,x),gd=(new Location$$module$js$nodes(a,47,u,"Prison (hallway)")).cave().connect(fb),Hf=(new Location$$module$js$nodes(a,48,u,"Left Cell (shopkeepers)")).cave().from(gd,
x);(new Location$$module$js$nodes(a,49,u,"Left Cell 2 (back, with prison key)")).cave().from(Hf,x).chest(dc,13);const If=(new Location$$module$js$nodes(a,50,u,"Right Cell (villagers)")).cave().from(gd,x),Jf=(new Location$$module$js$nodes(a,51,u,"Tunnel 8 (behind right cell, toward summit)")).cave().from(If,x);(new Location$$module$js$nodes(a,52,u,"Tunnel 9 (connector to summit)")).cave().connect(Jf).connectTo(Fb);const Kf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10a (summit cave, front)")).cave().from(Fb,
dc).to(Fb),Lf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10b (summit cave, behind ice)")).cave().connect(Kf,x).trigger(le);(new Location$$module$js$nodes(a,56,u,"Tunnel 1 (leads from main entrance)")).cave().connect(eb).connectTo(dd);(new Location$$module$js$nodes(a,57,u,"Tunnel 7 (to upper)")).cave().connect(Gf).connectTo(fb);const Mf=(new Location$$module$js$nodes(a,60,ab,"Inn")).shop(),Nf=(new Location$$module$js$nodes(a,61,ab,"Tool Shop")).shop(E,H,L,M),Of=(new Location$$module$js$nodes(a,
62,ab,"Back Room")).house(),Hb=(new Location$$module$js$nodes(a,64,ca,"Summit")).overworld().connect(Lf),gb=(new Location$$module$js$nodes(a,64,ca,"Northwest")).overworld().from(Hb).to(Hb,B),Pf=(new Location$$module$js$nodes(a,64,ca,"Northeast")).overworld().connect(gb,q),hd=(new Location$$module$js$nodes(a,65,ca,"Southwest")).overworld().connect(gb),Qf=(new Location$$module$js$nodes(a,65,ca,"Southeast")).overworld().connect(hd,q),id=(new Location$$module$js$nodes(a,66,ca,"Lime Tree Valley")).overworld().connect(hd).connect(Ia,
Md),Rf=(new Location$$module$js$nodes(a,67,ca,"Lime Tree Lake (Rage)")).cave().connect(id).trigger(Ac,P),Sf=(new Location$$module$js$nodes(a,68,ea,"Tunnel 1a (entrance)")).cave().connect(Qf),Tf=(new Location$$module$js$nodes(a,68,ea,"Tunnel 1b (behind wall)")).cave().connect(Sf,w),jd=(new Location$$module$js$nodes(a,69,ea,"Tunnel 2a (main path, before wall)")).cave().connect(Tf);(new Location$$module$js$nodes(a,69,ea,"Tunnel 2b (dead end, antidote)")).cave().connect(jd,w).chest(H,25,95);const Uf=
(new Location$$module$js$nodes(a,69,ea,"Tunnel 2c (main path, after wall)")).cave().connect(jd,w),Vf=(new Location$$module$js$nodes(a,70,ea,"Tunnel 3a (last room, before wall)")).cave().connect(Uf),Wf=(new Location$$module$js$nodes(a,70,ea,"Tunnel 3b (last room, after wall)")).cave().connect(Vf,w);(new Location$$module$js$nodes(a,71,ea,"Meadow")).overworld().connect(Wf).chest(kc,14);const Xf=(new Location$$module$js$nodes(a,72,D,"Tunnel 1a (entrance)")).cave().connect(Pf),kd=(new Location$$module$js$nodes(a,
72,D,"Tunnel 1b (past wall)")).cave().connect(Xf,w);(new Location$$module$js$nodes(a,72,D,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(kd,w).chest(ma,24);const Yf=(new Location$$module$js$nodes(a,73,D,"Tunnel 2 (tiny connector)")).cave().connect(kd),ld=(new Location$$module$js$nodes(a,74,D,"Tunnel 3a (upper branch)")).cave().connect(Yf);(new Location$$module$js$nodes(a,74,D,"Tunnel 3b (dead end, mimic)")).cave().connect(ld,w).chest(I,21,112);const md=(new Location$$module$js$nodes(a,74,D,"Tunnel 3c (short passage with mimic)")).cave().connect(ld,
w).chest(I,22,113),Zf=(new Location$$module$js$nodes(a,74,D,"Tunnel 3d (lower branch)")).cave().connect(md,w);(new Location$$module$js$nodes(a,75,D,"Tunnel 4 (dead end loop)")).cave().connect(Zf);const nd=(new Location$$module$js$nodes(a,76,D,"Tunnel 5a (right branch over bridge)")).cave().connect(md),$f=(new Location$$module$js$nodes(a,76,D,"Tunnel 5b (past wall over bridge)")).cave().connect(nd,w),ag=(new Location$$module$js$nodes(a,77,D,"Tunnel 6a (from left branch)")).cave().connect(nd),bg=(new Location$$module$js$nodes(a,
77,D,"Tunnel 6b (reconvergence)")).cave().connect(ag,w).connect($f),cg=(new Location$$module$js$nodes(a,77,D,"Tunnel 6c (between walls)")).cave().connect(bg,w),dg=(new Location$$module$js$nodes(a,77,D,"Tunnel 6d (under bridge)")).cave().connect(cg,w),eg=(new Location$$module$js$nodes(a,78,D,"Tunnel 7a (over second bridge)")).cave().connect(dg),fg=(new Location$$module$js$nodes(a,78,D,"Tunnel 7b (past wall)")).cave().connect(eg,w),gg=(new Location$$module$js$nodes(a,79,D,"Tunnel 8a (under second bridge)")).cave().connect(fg);
(new Location$$module$js$nodes(a,79,D,"Tunnel 8b (fog lamp)")).cave().connect(gg,w).chest(fc,19);const sa=(new Location$$module$js$nodes(a,80,A,"Town")).town().connect(gb),od=(new Location$$module$js$nodes(a,81,A,"Fishherman Island")).town().connect(sa);(new Location$$module$js$nodes(a,82,ca,"Mesia Shrine")).cave().trigger(Bc).connect(Rf,q,Ac);const pd=(new Location$$module$js$nodes(a,84,da,"Tunnel 1a (entrance)")).cave().connect(gb);(new Location$$module$js$nodes(a,84,da,"Tunnel 1b (dead end, mimic)")).cave().connect(pd,
x).chest(I,19,114);const hg=(new Location$$module$js$nodes(a,84,da,"Tunnel 1c (past ice)")).cave().connect(pd,x),ig=(new Location$$module$js$nodes(a,85,da,"Tunnel 2 (stoned pair)")).cave().connect(hg),Ib=(new Location$$module$js$nodes(a,86,da,"Tunnel 3 (wide medusa hallways)")).cave().connect(ig,Je),jg=(new Location$$module$js$nodes(a,87,da,"Tunnel 4a (left entrance)")).cave().from(Ib,x).chest(Vb,25).trigger(ne,rb);(new Location$$module$js$nodes(a,87,da,"Tunnel 4b (right entrance)")).cave().from(Ib,
x).connect(jg,B);(new Location$$module$js$nodes(a,87,da,"Tunnel 4c (sword of water)")).cave().connect(Ib,x).chest(P,24);const qd=(new Location$$module$js$nodes(a,88,aa,"Entrance")).misc(),kg=(new Location$$module$js$nodes(a,89,aa,"Level 1")).misc().from(qd),lg=(new Location$$module$js$nodes(a,90,aa,"Level 2")).misc().from(kg),mg=(new Location$$module$js$nodes(a,91,aa,"Level 3")).misc().from(lg),rd=(new Location$$module$js$nodes(a,92,aa,"Outside Mesia Room")).misc().from(mg),ng=(new Location$$module$js$nodes(a,
93,aa,"Outside Dyna Room")).misc().from(rd,mb);(new Location$$module$js$nodes(a,94,aa,"Mesia")).misc().connect(rd).trigger(ye);const og=(new Location$$module$js$nodes(a,95,aa,"Dyna")).misc().from(ng).boss(af);(new Location$$module$js$nodes(a,95,aa,"Win")).misc().from(og).end();const Jb=(new Location$$module$js$nodes(a,96,pa,"Cabin Beach")).sea().from(od,yb),Da=(new Location$$module$js$nodes(a,96,pa,"South")).sea().connect(Jb,Y),pg=(new Location$$module$js$nodes(a,96,pa,"Joel Beach")).sea().connect(Da,
Y),sd=(new Location$$module$js$nodes(a,96,fa,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(a,96,pa,"Altar")).sea().connect(Da,Y).trigger(zb,ic,hc);const qg=(new Location$$module$js$nodes(a,96,pa,"North")).sea().to(Da,Y).from(Da,Y,He).trigger(qe,Oe),rg=(new Location$$module$js$nodes(a,96,pa,"Swan Beach")).sea().connect(qg,Y);(new Location$$module$js$nodes(a,97,pa,"Cabin")).misc().connect(Jb).trigger(Ec,yb);(new Location$$module$js$nodes(a,98,fa,"Lighthouse")).misc().connect(sd).trigger(pe,
tb);const hb=(new Location$$module$js$nodes(a,100,A,"Underground Channel 1 (from throne room)")).sea().trigger(zc),sg=(new Location$$module$js$nodes(a,100,A,"Underground Channel 2 (to fortune teller)")).sea().connect(hb,q),td=(new Location$$module$js$nodes(a,100,A,"Underground Channel 3 (from fortune teller)")).sea().connect(hb,B),ud=(new Location$$module$js$nodes(a,100,A,"Underground Channel 4 (asina)")).sea().connect(td,q),tg=(new Location$$module$js$nodes(a,100,A,"Underground Channel 5 (dolphin)")).sea().connect(ud,
q).trigger(Dc,E,Cc);(new Location$$module$js$nodes(a,100,A,"Underground Channel 6 (water)")).sea().connect(tg,Y).connectTo(Da,Y).chest(jc,17);const Kb=(new Location$$module$js$nodes(a,101,G,"Zombie Town")).town(),ug=(new Location$$module$js$nodes(a,104,G,"Tunnel 1 (entrance)")).sea().connect(Da,Fc,Y),vd=(new Location$$module$js$nodes(a,105,G,"Tunnel 2a (start)")).cave().connect(ug);(new Location$$module$js$nodes(a,105,G,"Tunnel 2b (dead end to left)")).cave().connect(vd,q);const vg=(new Location$$module$js$nodes(a,
105,G,"Tunnel 2c (across first river)")).cave().connect(vd,q),wd=(new Location$$module$js$nodes(a,105,G,"Tunnel 2d (across second river)")).cave().connect(vg,q);(new Location$$module$js$nodes(a,105,G,"Tunnel 2e (dead end, magic ring)")).cave().connect(wd,w).chest(Q,29);const wg=(new Location$$module$js$nodes(a,105,G,"Tunnel 2f (stair down)")).cave().connect(wd,w),xg=(new Location$$module$js$nodes(a,106,G,"Tunnel 3a (main area)")).cave().connect(wg).connectTo(Kb).chest(ma,25,92),yg=(new Location$$module$js$nodes(a,
106,G,"Tunnel 3b (left area toward items)")).cave().connect(xg,w),zg=(new Location$$module$js$nodes(a,107,G,"Tunnel 4a (right side, mimic)")).cave().connect(yg).chest(I,14,115);(new Location$$module$js$nodes(a,107,G,"Tunnel 4b (left side, iron necklace)")).cave().connect(zg,q).chest(be,15);const Lb=(new Location$$module$js$nodes(a,108,ha,"Floor 1")).fortress().connect(Kb),Ag=(new Location$$module$js$nodes(a,108,ha,"Miniboss")).fortress().boss(Se).connect(Lb);(new Location$$module$js$nodes(a,109,ha,
"Floor 2a (left stair)")).fortress().connect(Lb).chest(L,19);const Bg=(new Location$$module$js$nodes(a,109,ha,"Floor 2b (right stair)")).fortress().connect(Ag).chest(E,30,85),Cg=(new Location$$module$js$nodes(a,110,ha,"Floor 3a (toward boss)")).fortress().connect(Bg),xd=(new Location$$module$js$nodes(a,110,ha,"Floor 3b (boss room)")).fortress().connect(Cg);(new Location$$module$js$nodes(a,110,ha,"Boss")).fortress().boss(Vc).connect(xd);(new Location$$module$js$nodes(a,110,ha,"Floor 3c (back room trap)")).fortress().from(xd).to(Lb);
const Dg=(new Location$$module$js$nodes(a,112,fa,"Secret Passage")).cave().connectTo(sd),ib=(new Location$$module$js$nodes(a,113,fa,"Town")).town().connect(pg),ba=(new Location$$module$js$nodes(a,114,S,"Town")).town().connect(rg),Eg=(new Location$$module$js$nodes(a,115,S,"Inside Gate")).overworld().connect(ba),Fg=(new Location$$module$js$nodes(a,115,S,"Outside Gate")).overworld().from(Eg,ua),jb=(new Location$$module$js$nodes(a,120,ra,"Valley")).overworld().connect(Fg),Mb=(new Location$$module$js$nodes(a,
124,z,"Entrance")).overworld().connect(jb),Gg=(new Location$$module$js$nodes(a,124,z,"Over first river toward Shyron")).overworld().connect(Mb,q),yd=(new Location$$module$js$nodes(a,124,z,"After first tunnel")).overworld(),zd=(new Location$$module$js$nodes(a,124,z,"Door to Styx")).overworld().connect(yd,q),Hg=(new Location$$module$js$nodes(a,124,z,"Dead end (no item)")).overworld(),Ig=(new Location$$module$js$nodes(a,124,z,"Dead end (fruit of lime)")).overworld().chest(ob,26),Jg=(new Location$$module$js$nodes(a,
124,z,"Dead end (magic ring)")).overworld().chest(Q,25,101),Ad=(new Location$$module$js$nodes(a,124,z,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(a,124,z,"Floating island (bow of sun)")).overworld().connect(Ad,B).chest(mc,24);const Kg=(new Location$$module$js$nodes(a,125,z,"Tunnel 1 (to Shyron)")).cave().connect(Gg),Lg=(new Location$$module$js$nodes(a,126,z,"Outside Shyron")).overworld().connect(Kg);(new Location$$module$js$nodes(a,127,z,"Tunnel 2 (fork)")).cave().connect(Mb).connectTo(Ig).connectTo(yd);
const Bd=(new Location$$module$js$nodes(a,128,z,"Tunnel 3 (caves)")).cave().connect(zd).connect(Hg),Cd=(new Location$$module$js$nodes(a,129,z,"Tunnel 4 (left branch of cave)")).cave().connect(Bd);(new Location$$module$js$nodes(a,130,z,"Tunnel 5 (dead end, medical herb)")).cave().connect(Cd).chest(E,15,86);const Mg=(new Location$$module$js$nodes(a,131,z,"Tunnel 6a (left-then-right)")).cave().connect(Cd),Ng=(new Location$$module$js$nodes(a,131,z,"Tunnel 6b (past wall)")).cave().connect(Mg,w),Og=(new Location$$module$js$nodes(a,
132,z,"Tunnel 7 (wide hall)")).cave().connect(Ng);(new Location$$module$js$nodes(a,133,z,"Tunnel 8 (red slimes)")).cave().from(Og,w).connectTo(Ad).chest(I,23,116);const Pg=(new Location$$module$js$nodes(a,134,z,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Bd),Qg=(new Location$$module$js$nodes(a,135,z,"Tunnel 10a (toward magic ring)")).cave().connect(Pg);(new Location$$module$js$nodes(a,135,z,"Tunnel 10b (past wall)")).cave().connect(Qg,w).connectTo(Jg);const Dd=(new Location$$module$js$nodes(a,
136,qa,"Entrance")).fortress().from(zd,ec,Cb),Rg=(new Location$$module$js$nodes(a,137,qa,"Left branch")).fortress().connect(Dd).chest(I,19,117),Sg=(new Location$$module$js$nodes(a,137,qa,"Left branch, past one bridge")).fortress().connect(Rg,q),Tg=(new Location$$module$js$nodes(a,137,qa,"Left branch, past two bridges")).fortress().connect(Sg,q).chest(E,29,87),Ug=(new Location$$module$js$nodes(a,137,qa,"Right branch")).fortress().connect(Dd);(new Location$$module$js$nodes(a,137,qa,"Right branch, across water")).fortress().connect(Ug,
B).chest(I,20,118).chest(I,21,119).chest(Td,28);(new Location$$module$js$nodes(a,138,qa,"Upper floor")).fortress().connect(Tg).chest(K,27);const Ea=(new Location$$module$js$nodes(a,140,ia,"Town")).town().connect(Lg,Rc).trigger(Ab),Ka=(new Location$$module$js$nodes(a,142,ra,"Town")).town().connect(jb),Ed=(new Location$$module$js$nodes(a,143,F,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(a,143,F,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Ed,
va).chest($d,15);const Nb=(new Location$$module$js$nodes(a,144,ra,"Desert 1")).overworld().connect(jb),kb=(new Location$$module$js$nodes(a,145,F,"Area 1 (from entrance)")).cave().chest(ac,26),Fd=(new Location$$module$js$nodes(a,145,F,"Area 2 (across top bridge)")).cave().connect(kb,q);(new Location$$module$js$nodes(a,145,F,"Area 3 (dead-end across top-right bridge)")).cave().connect(Fd,q);const Vg=(new Location$$module$js$nodes(a,145,F,"Area 4 (left across middle-right bridge)")).cave().connect(Fd,
q),Wg=(new Location$$module$js$nodes(a,145,F,"Area 5 (bottom edge)")).cave().connect(Vg,q),Xg=(new Location$$module$js$nodes(a,145,F,"Area 6 (bottom island)")).cave().connect(Wg,q),Yg=(new Location$$module$js$nodes(a,145,F,"Area 7 (bottom inner ring)")).cave().connect(Xg,q),Zg=(new Location$$module$js$nodes(a,145,F,"Area 8 (left outer ring)")).cave().connect(Yg,q).connect(kb,q).chest(L,27,100),$g=(new Location$$module$js$nodes(a,145,F,"Area 9 (top left inner ring)")).cave().connect(Zg,q),ah=(new Location$$module$js$nodes(a,
145,F,"Area 10 (top right inner ring)")).cave().connect($g,q);(new Location$$module$js$nodes(a,145,F,"Area 11 (center)")).cave().connect(ah,q).connectTo(Ed);(new Location$$module$js$nodes(a,145,F,"Area 12 (top center islands)")).cave().connect(kb,B).chest(Yd,28);const bh=(new Location$$module$js$nodes(a,146,U,"Desert Cave 1")).cave().connect(Nb,B),Fa=(new Location$$module$js$nodes(a,147,U,"Town")).town(),ch=(new Location$$module$js$nodes(a,148,U,"Outside Cave")).overworld().connect(Fa),dh=(new Location$$module$js$nodes(a,
149,U,"Desert Cave 2")).cave().connect(ch);(new Location$$module$js$nodes(a,150,U,"Meadow")).overworld().connect(bh).connectTo(Fa).trigger(ve,ua);const Ob=(new Location$$module$js$nodes(a,152,U,"Desert 2")).overworld().connect(dh),eh=(new Location$$module$js$nodes(a,156,Aa,"Entrance")).fortress().connect(Ob,B),fh=(new Location$$module$js$nodes(a,156,Aa,"Azteca")).fortress().trigger(xe),gh=(new Location$$module$js$nodes(a,157,Aa,"Fork")).fortress().connect(eh),Gd=(new Location$$module$js$nodes(a,158,
Aa,"Main")).fortress().connect(gh);(new Location$$module$js$nodes(a,158,Aa,"Treasure Chest (magic ring)")).fortress().connect(Gd).chest(Q,27,108);(new Location$$module$js$nodes(a,159,Aa,"Draygon")).fortress().connect(Gd).to(fh).boss(Ye);const hh=(new Location$$module$js$nodes(a,160,Z,"Entrance")).fortress().connect(Ob,B),ih=(new Location$$module$js$nodes(a,160,Z,"Statues")).fortress().connect(hh).boss(Ze),jh=(new Location$$module$js$nodes(a,161,Z,"Hall 1")).fortress().connect(ih),Pb=(new Location$$module$js$nodes(a,
162,Z,"Branch")).fortress().connect(jh);(new Location$$module$js$nodes(a,163,Z,"Left Dead End")).fortress().connect(Pb).chest(I,13,120);(new Location$$module$js$nodes(a,164,Z,"Right Dead End")).fortress().connect(Pb);const kh=(new Location$$module$js$nodes(a,165,Z,"Hall 2")).fortress().connect(Pb).chest(qb,26,109),lh=(new Location$$module$js$nodes(a,166,Z,"Draygon 2")).fortress().connect(kh).boss($e);(new Location$$module$js$nodes(a,167,Z,"Teleporter")).fortress().from(lh).to(qd);const Hd=(new Location$$module$js$nodes(a,
168,bb,"Entrance")).fortress().connect(Ka,Cb).trigger(Jc,K),mh=(new Location$$module$js$nodes(a,169,bb,"Main")).fortress().from(Hd,va),nh=(new Location$$module$js$nodes(a,169,bb,"Boss")).fortress().connect(mh).boss(Ue),oh=(new Location$$module$js$nodes(a,170,bb,"Zebu")).fortress().connect(nh),lb=(new Location$$module$js$nodes(a,171,T,"Entrance")).fortress().connect(oh);(new Location$$module$js$nodes(a,171,T,"Dead End Behind Iron (fruit of power)")).fortress().connect(lb,va).chest(L,28,98);(new Location$$module$js$nodes(a,
171,T,"Dead End Loop Across Closer Bridges")).fortress().connect(lb,q).connect(lb,q);const ph=(new Location$$module$js$nodes(a,171,T,"Across First Bridge (fruit of repun)")).fortress().connect(lb,q).chest(pb,30,102),Qb=(new Location$$module$js$nodes(a,171,T,"Across Second Bridge")).fortress().connect(ph,q);(new Location$$module$js$nodes(a,171,T,"Dead End Across Two Bridges ()")).fortress().connect(Qb,q).connect(Qb,q).chest(ma,29,93);const qh=(new Location$$module$js$nodes(a,171,T,"Across Third Bridge")).fortress().connect(Qb,
q),rh=(new Location$$module$js$nodes(a,171,T,"Exit Behind Iron Door")).fortress().connect(qh,va),sh=(new Location$$module$js$nodes(a,172,T,"Boss")).fortress().connect(rh).boss(Ve),th=(new Location$$module$js$nodes(a,172,T,"Tornel")).fortress().connect(sh),Id=(new Location$$module$js$nodes(a,173,za,"Lower")).fortress().connect(th).chest(qb,26,99).chest(Q,27,111),uh=(new Location$$module$js$nodes(a,174,za,"Upper Loop")).fortress().connect(Id).chest(H,22,96);(new Location$$module$js$nodes(a,174,za,"Upper Loop Behind Wall (magic ring)")).fortress().connect(uh,
va).chest(Q,23,107);const vh=(new Location$$module$js$nodes(a,175,za,"Upper Passage (toward Mado)")).fortress().connect(Id).chest(Q,27,84),Rb=(new Location$$module$js$nodes(a,176,J,"Initial Fork")).fortress(),wh=(new Location$$module$js$nodes(a,177,J,"Left Branch")).fortress().connect(Rb),Jd=(new Location$$module$js$nodes(a,178,J,"Main Area (right branch, over bridges)")).fortress().connect(Rb),xh=(new Location$$module$js$nodes(a,179,J,"U-shaped Passage (between floors)")).fortress().connect(Jd),
yh=(new Location$$module$js$nodes(a,180,J,"Main Area Lower (under bridge)")).fortress().connect(wh).connect(Jd).connect(xh),Kd=(new Location$$module$js$nodes(a,180,J,"Behind Iron Wall")).fortress().connect(yh,va),zh=(new Location$$module$js$nodes(a,181,J,"Lower")).fortress().connect(Kd).chest(I,13,121).chest(I,14,122).chest(I,15,123).chest(Q,23,88).chest(M,24,110),Ah=(new Location$$module$js$nodes(a,182,J,"Boss Corridor")).fortress().connect(zh),Bh=(new Location$$module$js$nodes(a,182,J,"Boss")).fortress().connect(Ah,
Cb).boss(Xe);(new Location$$module$js$nodes(a,182,J,"Behind Boss (stormBracelet)")).fortress().connect(Bh).chest(Ta,18);const Ld=(new Location$$module$js$nodes(a,183,J,"Exit Stairs")).fortress(),Ch=(new Location$$module$js$nodes(a,184,F,"Entrance Back (behind river)")).cave().connect(Ld).chest(L,13,90);(new Location$$module$js$nodes(a,184,F,"Entrance Front")).cave().connect(Ch,B).connectTo(Nb).connectTo(kb);const Dh=(new Location$$module$js$nodes(a,185,za,"Boss")).fortress().connect(vh).boss(We);
(new Location$$module$js$nodes(a,185,za,"Asina")).fortress().connect(Dh).connectTo(Rb);(new Location$$module$js$nodes(a,186,J,"Kensu")).fortress().connect(Kd).connectTo(Ld).trigger(ue,vb);(new Location$$module$js$nodes(a,187,ra,"House")).house().connect(Ka).trigger(we,ua,vb);(new Location$$module$js$nodes(a,188,ra,"Inn")).shop().connect(Ka,Ab);(new Location$$module$js$nodes(a,190,ra,"Tool Shop")).shop(E,H,M,ma).connect(Ka,Ab);(new Location$$module$js$nodes(a,191,ra,"Tavern")).shop().connect(Ka);(new Location$$module$js$nodes(a,
192,R,"Elder House")).house().connect(ja).trigger(qc);(new Location$$module$js$nodes(a,193,R,"Rabbit Hut")).house().connect(ja).trigger(wc,vc,na);(new Location$$module$js$nodes(a,194,R,"Inn")).shop().connect(ja);(new Location$$module$js$nodes(a,195,R,"Tool Shop")).shop(E,H,M,L).connect(ja);(new Location$$module$js$nodes(a,196,R,"Armor Shop")).shop(Ud,Tb).connect(ja);(new Location$$module$js$nodes(a,197,R,"Student House")).house().connect(ja).trigger(rc);(new Location$$module$js$nodes(a,198,xa,"Tavern")).house().connect(Ja);
(new Location$$module$js$nodes(a,199,xa,"Pawn Shop")).shop().connect(Ja);(new Location$$module$js$nodes(a,200,xa,"Inn")).shop().connect(Ja);(new Location$$module$js$nodes(a,201,xa,"Armor Shop")).shop(Vd,Tb,Rd).connect(Ja);(new Location$$module$js$nodes(a,203,xa,"Tool Shop")).shop(E,H,M).connect(Ja);(new Location$$module$js$nodes(a,205,Ha,"Elder House")).house().from(db,na).trigger(je,xb);(new Location$$module$js$nodes(a,206,Ha,"Mother's House")).house().from(db,na).trigger(uc,na).trigger(ie,xb);(new Location$$module$js$nodes(a,
207,Ha,"Tool Shop")).shop(E,H,L).from(db,na);(new Location$$module$js$nodes(a,208,Ha,"Inn")).shop().from(db,na);(new Location$$module$js$nodes(a,209,ya,"Inn")).shop().connect(cb);(new Location$$module$js$nodes(a,210,ya,"Tool Shop")).shop(M,L,ma).connect(cb);(new Location$$module$js$nodes(a,211,ya,"Armor Shop")).shop(Xb,Ub,Vb,nb).connect(cb);const Eh=(new Location$$module$js$nodes(a,212,ya,"Queen's House")).house().from(cb,Rc).trigger(se,ua,kc);(new Location$$module$js$nodes(a,213,ab,"Nadare's")).house().connect(eb).connectTo(Mf).connectTo(Nf).connectTo(Of);
(new Location$$module$js$nodes(a,214,A,"Fisherman's House")).house().connect(od).trigger(yb,fc,ub,Ke);const Sb=(new Location$$module$js$nodes(a,215,A,"Palace Entrance")).house().connect(sa);(new Location$$module$js$nodes(a,216,A,"Fortune Teller Front")).house().connect(sa).trigger(yc,xc);(new Location$$module$js$nodes(a,216,A,"Fortune Teller Back")).house().connect(sg).connect(td);(new Location$$module$js$nodes(a,217,A,"Pawn Shop")).shop().connect(sa);(new Location$$module$js$nodes(a,218,A,"Armor Shop")).shop(Wd,
Xb,Ub).connect(sa);(new Location$$module$js$nodes(a,220,A,"Inn")).shop().connect(sa);(new Location$$module$js$nodes(a,221,A,"Tool Shop")).shop(E,ma,ob,M).connect(sa);(new Location$$module$js$nodes(a,222,A,"Palace Left")).house().connect(Sb);(new Location$$module$js$nodes(a,223,A,"Palace Throne Room")).house().connect(Sb).to(hb,Fe).from(hb).trigger(xc).trigger(me,yc,zc);(new Location$$module$js$nodes(a,224,A,"Palace Right")).house().connect(Sb);(new Location$$module$js$nodes(a,225,A,"Asina's Room")).house().connect(ud).trigger(Cc,
Mc);(new Location$$module$js$nodes(a,226,ya,"Queen Downstairs")).house().connect(Eh).chest(Ra,13);(new Location$$module$js$nodes(a,227,fa,"Elder's House")).house().connect(ib).trigger(Fc);(new Location$$module$js$nodes(a,228,fa,"Shed")).house().connect(ib).to(Dg,gc);(new Location$$module$js$nodes(a,229,fa,"Tool Shop")).shop(E,H,L,ma).connect(ib);(new Location$$module$js$nodes(a,231,fa,"Inn")).shop().connect(ib);const Fh=(new Location$$module$js$nodes(a,232,G,"Zombie Town House")).house().connect(Kb);
(new Location$$module$js$nodes(a,233,G,"Zombie Town Basement")).house().connect(Fh).trigger(oe,Vc);(new Location$$module$js$nodes(a,235,S,"Tool Shop")).shop(E,H,L,M).connect(ba);(new Location$$module$js$nodes(a,236,S,"Stom's Hut")).house().connect(ba).trigger(Gc);(new Location$$module$js$nodes(a,237,S,"Inn")).shop().connect(ba);(new Location$$module$js$nodes(a,238,S,"Armor Shop")).shop(Xd,Yb,Sd,Wb).connect(ba);(new Location$$module$js$nodes(a,239,S,"Tavern")).house().connect(ba).trigger(Hc,Gc,Wa);
(new Location$$module$js$nodes(a,240,S,"Pawn Shop")).shop().connect(ba);(new Location$$module$js$nodes(a,241,S,"Dance Hall")).house().connect(ba).trigger(Ic,Hc,Wa).trigger(re,Ic,jc);const Gh=(new Location$$module$js$nodes(a,242,ia,"Temple (pre-massacre)")).fortress().connect(Ea).from(Db,K,la).trigger(te);(new Location$$module$js$nodes(a,242,ia,"Temple (post-massacre)")).fortress().from(Gh,Jc).boss(Te);(new Location$$module$js$nodes(a,243,ia,"Training Hall")).house().connect(Ea);(new Location$$module$js$nodes(a,
244,ia,"Hospital")).house().connect(Ea);(new Location$$module$js$nodes(a,245,ia,"Armor Shop")).shop(Yb,nb,Wb).connect(Ea);(new Location$$module$js$nodes(a,246,ia,"Tool Shop")).shop(E,H,ob,Q).connect(Ea);(new Location$$module$js$nodes(a,247,ia,"Inn")).shop().connect(Ea);(new Location$$module$js$nodes(a,248,U,"Inn")).shop().connect(Fa);(new Location$$module$js$nodes(a,249,U,"Tool Shop")).shop(H,M,pb,Q).connect(Fa);(new Location$$module$js$nodes(a,250,U,"Elder's House")).house().connect(Fa);(new Location$$module$js$nodes(a,
251,U,"Pawn Shop")).house().connect(Fa);const Hh=[ja,Ia,Xc,Ba,Eb,Ca,Hb,id,Jb,ba,jb,Mb,Nb,Hd,Ob];for(const a of Hh)a.from(Db,Be);return a},shuffle$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);d.check("Br")&&f.shuffleShops(a);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);d||(d=new FlagSet$$module$js$flagset("Sbkm Sct"));var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&
k.slots){var n=k.slotType[0];(h[n]=h[n]||[]).push(k)}k=[];n=[];var p={};for(var r of d.flags.S||[]){var t=[];for(var l of r){p[l]=!0;for(var m of h[l])t.push(m),n.push([m,k.length])}k.push(t)}for(var y of"bc")if(p[y])for(r=h[y],l=r.map((a)=>[a.item,a.itemIndex]),a.shuffle(l),m=0;m<r.length;m++)r[m].set(...l[m]);t=(a)=>g.find((b)=>b.vanillaItemName===a);h=t("Sword of Wind");y=t("Sword of Fire");r=t("Ball of Wind");l=t("Ball of Fire");m=t("Statue of Onyx");t=t("Gas Mask");p.k&&a.nextInt(2)&&(y.swap(h),
l.swap(r));p.k&&!a.nextInt(3)&&m.swap(t);p=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(y=0;1E3>y;y++){e&&0==y%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));a.shuffle(n);for(var v of k)a.shuffle(v);r=k.map(()=>-1);l=p[a.nextInt(p.length)];m=[];t=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<l;a++){const [b,c]=n[a],d=k[c][++r[c]];t(b,d)&&
(b.swap(d),m.push([b,d]))}if(!m.length)continue;const {win:b,path:c}=f.traverse({wanted:g,dfs:!1});if(b)h=c;else for(;m.length;){const [a,b]=m.pop();a.swap(b)}}b&&f.write(b);if(c){c.items=[];c.route=[];for(const a of h){const [b,d]=a;c.route.push(d);v=f.nodes[b];null!=v.slotName&&(k=v.slotName,0>k.indexOf(v.orig)&&(k+=` (normally ${v.vanillaItemName})`),c.items.push({slotIndex:v.slotIndex,itemIndex:v.itemIndex,origName:v.vanillaItemName,slotName:v.slotName,itemName:v.item.name,text:`${v.item.name}: ${k}`}))}}}),
shuffle2$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);d.check("Br")&&f.shuffleShops(a);const g=f.integrate();e&&e.addTasks(1E3);for(let h=0;1E3>h;h++){if(yield shuffle3$$module$js$depgraph(f,g,b,a,c,d,e)){console.log(`success after ${h} attempts`);return}e&&(e.addCompleted(1),0===h%50&&(yield new Promise(requestAnimationFrame)))}return shuffle$$module$js$depgraph(b,a,c,d,e)}),shuffle3$$module$js$depgraph=(b,a,c,d,
e,f,g)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const h=e&&e.stats;var g=b.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);const n=new Map(d.shuffle(g.map((a)=>[a,[a.item,a.itemIndex]]))),p=new Set(d.shuffle(g)),r=new Map,t={};h&&h.seeds++;f||(f=new FlagSet$$module$js$flagset("Sbkm Sct"));(f.flags.S||[]).forEach((a,b)=>{for(const c of a)t[c]=b});for(var l of p)r.set(l.item,l);const m=(a,b)=>null==t[a.slotType?a.slotType[0]:"c"]?a==b:b.isMimic()&&!a.canHoldMimic()||
"unique"!=b.item.inventoryRow&&a.requiresUnique||"armor"==b.item.inventoryRow&&!a.isChest()?!1:t[a.slotType?a.slotType[0]:"c"]==t[b.slotType?b.slotType[0]:"c"];l=a.assumedFill(d,(a,b)=>m(a,r.get(b)));if(null==l){h&&h.endState.key++;return!1;throw Error("Could not fill!");}const y=new Map;for(var v=0;v<l.length;v++){var ta=l[v];if(null!=ta){var ka=r.get(a.item(ta));ta=n.get(ka);n.delete(ka);ka=a.location(v);y.set(ka,ta);p.delete(ka)}}v=(a,b,c)=>{c=void 0===c?"":c;for(const c of p)if(m(c,a))return y.set(c,
b),p.delete(c),n.delete(a),!0;h&&("traps"==c?h.endState.traps++:"chest"==c?h.endState.chest++:h.endState.misc++);return!1};for(var la of n){const [a,b]=la;if(a.isMimic()&&!v(a,b,"traps"))return!1}for(const a of n){const [b,c]=a;if(b.needsChest()&&!v(b,c,"chest"))return!1}for(const a of n){const [b,c]=a;if(!v(b,c))return!1}for(const a of y){const [b,c]=a;b.set(...c)}const {win:La,path:Ma}=b.traverse({wanted:g,dfs:!1});if(!La)return h&&h.endState.no_win++,!1;c&&b.write(c);if(!e)return!0;h&&(h.endState.success++,
h.analyze(b,a,l));e.items=[];e.route=[];for(const a of Ma){const [c,d]=a;e.route.push(d);g=b.nodes[c];null!=g.slotName&&(la=g.slotName,0>la.indexOf(g.orig)&&(la+=` (normally ${g.vanillaItemName})`),e.items.push({slotIndex:g.slotIndex,itemIndex:g.itemIndex,origName:g.vanillaItemName,slotName:g.slotName,itemName:g.item.name,text:`${g.item.name}: ${la}`}))}return!0});var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;module$js$depgraph.shuffle=shuffle$$module$js$depgraph;
module$js$depgraph.shuffle2=shuffle2$$module$js$depgraph;module$js$depgraph.shuffle3=shuffle3$$module$js$depgraph;class Deque$$module$js$util{constructor(){this.buffer=Array(16);this.mask=15;this.size=this.end=this.start=0}get length(){return this.size}upsize(b){for(;this.mask<b;)this.end<=this.start&&(this.start+=this.mask+1),this.mask=this.mask<<1|1,this.buffer=this.buffer.concat(this.buffer);this.size=b}push(...b){this.upsize(this.size+b.length);for(const a of b)this.buffer[this.end]=a,this.end=this.end+1&this.mask}pop(){if(this.size)return this.end=this.end-1&this.mask,this.size--,this.buffer[this.end]}peek(){if(this.size)return this.buffer[this.end-
...
a&&(0<=c.sells.indexOf(a)||4<=c.sells.length?e.push(a):c.sells.push(a))}integrate(b={}){const {tracker:a=!1}=b;var c=!a;const d=new SparseDependencyGraph$$module$js$graph(this.nodes.length),e=[],f=[],g=new Set,h=new Map;var k=[],n=[];const p=[];var r=[];const t=[];b=new Set;for(var l of this.nodes)if(l instanceof Location$$module$js$nodes){if(l.isStart){const [a]=d.addRoute([l.uid]);h.set(a.label,a)}e[l.uid]=[];f[l.uid]=[];for(const a of l.connections)g.has(a)||(g.add(a),a.bidi&&g.add(a.reverse()));
for(const a of l.chests)d.addRoute([a.uid,l.uid])}else if(l instanceof ItemGet$$module$js$nodes&&"Medical Herb"===l.name&&(d.addRoute([l.uid]),d.finalize(l.uid)),l instanceof Option$$module$js$nodes)k.push(l);else if(l instanceof TrackerNode$$module$js$nodes)n.push(l);else if(l instanceof Condition$$module$js$nodes)p.push(l);else if(l instanceof Trigger$$module$js$nodes)r.push(l);else if(l instanceof ItemGet$$module$js$nodes)t.push(l);else if(l instanceof Slot$$module$js$nodes)b.add(l);else if(!(l instanceof
Area$$module$js$nodes))throw Error(`Unknown node type: ${l.nodeType}`);for(const a of g)e[a.from.uid].push(a),f[a.to.uid].push(a);l=(b)=>{for(const c of b){for(const b of c.edges({tracker:a}))d.addRoute(b);d.finalize(c.uid)}};l(k);c&&l(n);l(r);for(c=h.values();!(k=c.next()).done;){k=k.value;n=k.target;for(var m of e[n]){n=[m.to.uid,...k.deps];for(r=m.deps.length-1;0<=r;r--)n.push(m.deps[r].uid);m.from.bossNode&&n.push(m.from.bossNode.uid);for(const a of d.addRoute(n))h.has(a.label)||h.set(a.label,
a)}}l(p);for(m=0;m<this.nodes.length;m++)this.nodes[m]instanceof ItemGet$$module$js$nodes||this.nodes[m]instanceof TrackerNode$$module$js$nodes||d.finalize(m);m=new LocationList$$module$js$nodes(this);for(const a of b)for(const b of d.nodes[a.uid].values())m.addRoute([a.uid,...b]);return m}}
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="experimental",LABEL$$module$js$version="experimental 6726720",HASH$$module$js$version="67267203ed2c84261888a8b20c33ec09cc68a587",DATE$$module$js$version=new Date(1553729656E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1)})}};
...
_EXTRA_PITY_MP:!0,_FIX_OPEL_STATUE:!0,_FIX_SHAKING:!0,_FIX_VAMPIRE:!0,_LEATHER_BOOTS_GIVE_SPEED:c.check("Ts"),_NERF_WILD_WARP:c.check("Tw"),_NEVER_DIE:c.check("Di"),_NORMALIZE_SHOP_PRICES:!0,_PITY_HP_AND_MP:!0,_PROGRESSIVE_BRACELET:!0,_REVERSIBLE_SWAN_GATE:!0,_REQUIRE_HEALED_DOLPHIN_TO_RIDE:c.check("Rd"),_SAHARA_RABBITS_REQUIRE_TELEPATHY:!1,_TELEPORT_ON_THUNDER_SWORD:c.check("Rt")},k=new Assembler$$module$js$6502,n=(a)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){k.assemble(yield d.read(a),
a);k.patchRom(b)});var p=Object.keys(h).filter((a)=>h[a]).map((a)=>`define ${a} 1\n`).join("");k.assemble(p,"flags.s");yield n("preshuffle.s");g=new Random$$module$js$random(g);yield shuffle2$$module$js$depgraph(b,g,e,c,f);c.check("Br")&&rescaleShops$$module$js$patch(b,k,g);p=new Rom$$module$js$rom(b);rescaleMonsters$$module$js$patch(b,p);c.check("Mr")&&shuffleMonsters$$module$js$patch(b,p,g);identifyKeyItemsForDifficultyBuffs$$module$js$patch(p);c.check("Em")?(b[115996]*=2,b[115962]*=3):c.check("Hm")||
(b[115996]+=8,b[115962]*=2);yield n("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(b,c,k);updateCoinDrops$$module$js$patch(b,c);return stampVersionSeedAndHash$$module$js$patch(b,a,c)}),stampVersionSeedAndHash$$module$js$patch=(b,a,c)=>{const d=crc32$$module$js$crc32(b),e=d.toString(16).padStart(8,0).toUpperCase(),f="unstable"==STATUS$$module$js$version?HASH$$module$js$version.substring(0,7).padStart(7,0).toUpperCase()+"     ":VERSION$$module$js$version.substring(0,12).padEnd(12," ");
a=a.toString(16).padStart(8,0).toUpperCase();const g=(a,c)=>{for(let d=0;d<c.length;d++)b[a+16+d]=c.charCodeAt(d)},h=(a,b)=>{const c=[];for(let d=0;d<a.length||d<b.length;d++)c.push(a[d]||" "),c.push(b[d]||" ");return c.join("")};g(161743,h("  VERSION     SEED      ",`  ${f}${a}`));a=String(c);let k;if(46<a.length){if(92<a.length)throw Error("Flag string way too long!");k=a.substring(46,92).padEnd(46," ");a=a.substring(0,46)}a=a.padEnd(46," ");g(161791,h(a.substring(0,23),a.substring(23)));k&&g(161839,
h(k.substring(0,23),k.substring(23)));g(161925,h(e.substring(0,4),e.substring(4)));g(153366,"RANDOMIZER");"unstable"==STATUS$$module$js$version&&g(153404,"BETA");return d},patchBytes$$module$js$patch=(b,a,c)=>{for(let d=0;d<c.length;d++)b[a+16+d]=c[d]},patchWords$$module$js$patch=(b,a,c)=>{for(let d=0;d<2*c.length;d+=2)b[a+16+d]=c[d>>>1]&255,b[a+17+d]=c[d>>>1]>>>8},updateCoinDrops$$module$js$patch=(b,a)=>{a.check("Fs")?patchWords$$module$js$patch(b,216030,[0,5,10,15,25,40,65,105,170,275,445,600,700,
800,900,1E3]):patchWords$$module$js$patch(b,216030,[0,1,2,4,8,16,30,50,100,200,300,400,500,600,700,800])},updateDifficultyScalingTables$$module$js$patch=(b,a,c)=>{const d=Array(48).fill(0).map((a,b)=>b);patchBytes$$module$js$patch(b,c.expand("DiffAtk"),d.map((a)=>Math.round(40+15*a/4)));patchBytes$$module$js$patch(b,c.expand("DiffDef"),d.map((a)=>8+2*a));patchBytes$$module$js$patch(b,c.expand("DiffHP"),d.map((a)=>Math.min(255,48+Math.round(11*a/2))));const e=a.check("Hx")?.25:a.check("Ex")?2.5:1;
patchBytes$$module$js$patch(b,c.expand("DiffExp"),d.map((a)=>{a=Math.floor(4*Math.pow(2,(16+9*a)/32)*e);return 128>a?a:Math.min(255,128+(a>>4))}));patchBytes$$module$js$patch(b,216E3,[0,1,3,5,7,9,12,10,16,0,1,3,4,6,9,8,12,16])},rescaleShops$$module$js$patch=(b,a,c)=>{const d=a.expand("BasePrices");var e=a.expand("InnPrices");const f={prices:138836,items:138792},g={prices:138704,items:138660},h=Array(48).fill(0).map((a,b)=>b);patchBytes$$module$js$patch(b,a.expand("ToolShopScaling"),h.map((a)=>Math.round(8*
Math.pow(2,a/10))));patchBytes$$module$js$patch(b,a.expand("ArmorShopScaling"),h.map((a)=>Math.round(8*Math.pow(2,(47-a)/12))));for(var k of[f,g]){const {prices:d,items:e}=k;for(a=0;44>a;a++)b[d+a+16]=BASE_PRICES$$module$js$patch[b[e+a+16]]?c?c.nextInt(32)+17:32:0}for(k=0;11>k;k++)b[e+k+16]=c?c.nextInt(40)+13:32;c=(a,c)=>{b[d+2*(a-13)+16]=c&255;b[d+2*(a-13)+17]=c>>>8};for(e=13;39>e;e++)c(e,BASE_PRICES$$module$js$patch[e]);c(39,20)},BASE_PRICES$$module$js$patch={13:6,14:22,15:325,16:475,17:1150,18:2750,
19:2750,21:8,22:14,23:125,24:425,25:1400,26:2900,29:25,30:30,31:45,32:40,33:36,34:200,35:150,36:80,38:300},rescaleMonsters$$module$js$patch=(b,a)=>{for(var c of SCALED_MONSTERS$$module$js$patch.keys())for(const b in a.objects){if(SCALED_MONSTERS$$module$js$patch.has(b))return;a.objects[c].objectDataBase==a.objects[b].objectDataBase&&(SCALED_MONSTERS$$module$js$patch[b]=SCALED_MONSTERS$$module$js$patch[c])}for(const d of SCALED_MONSTERS$$module$js$patch){const [e,{sdef:f,swrd:g,hits:h,satk:k,dgld:n,
sexp:p}]=d;b=a.objects[e].objectData;c=[87,94,104,125,136,151,155,158].includes(e)?1:0;b[2]|=128;b[6]=h;b[7]=k;b[8]=f|g<<4;b[9]=b[9]&224|c;b[16]=b[16]&15|n<<4;b[17]=p}a.objects[125].objectData[16]|=8;a.writeObjectData()},shuffleMonsters$$module$js$patch=(b,a,c,d)=>{b=new MonsterPool$$module$js$patch({});for(const c of a.locations)c&&b.populate(c);b.shuffle(c);a.writeNpcData()},identifyKeyItemsForDifficultyBuffs$$module$js$patch=(b)=>{for(const a of b.itemGets){const c=ITEMS$$module$js$patch.get(a.item);
...
"m","Green Jelly",4,,3,16,4,36],[83,"m","Red Slime",6,,4,16,4,48],[84,"m","Rock Golem",6,,11,24,6,85],[85,"m","Blue Bat",,,,4,,32],[86,"m","Green Wyvern",4,,4,24,6,52],[87,"b","Vampire",3,,13,18,,,],[88,"m","Orc",3,,4,21,4,57],[89,"m","Red Flying Swamp Insect",3,,1,21,4,57],[90,"m","Blue Mushroom",2,,1,21,4,44],[91,"m","Swamp Tomato",3,,2,35,4,52],[92,"m","Flying Meadow Insect",3,,3,23,4,81],[93,"m","Swamp Plant",,,,,,36],[94,"b","Insect",,1,8,6,,,],[95,"m","Large Blue Slime",5,,3,20,4,52],[96,"m",
...
a[3]+80;if(h in UNTOUCHED_MONSTERS$$module$js$patch||!SCALED_MONSTERS$$module$js$patch.has(h)||"m"!=SCALED_MONSTERS$$module$js$patch.get(h).type)continue;var f=b.rom.objects[h];if(!f)continue;const n=a[2]&128?1:0,p=b.spritePatterns[n];var g=f.palettes(!0);f=g.includes(2)?b.spritePalettes[0]:null;g=g.includes(3)?b.spritePalettes[1]:null;d.push({id:h,pat:p,pal2:f,pal3:g,patBank:n});(this.report[`start-${h.toString(16)}`]=this.report[`start-${h.toString(16)}`]||[]).push("$"+b.id.toString(16));c.push(e)}d.length&&
...
this.report["$"+d.id.toString(16).padStart(2,0)]=[];const {maxFlyers:g,nonFlyers:h={},fixedSlots:k={}}=MONSTER_ADJUSTMENTS$$module$js$patch[d.id]||{};let n=k.pat0||null,p=k.pat1||null,r=k.pal2||null,t=k.pal3||null,l=g,m=!1;for(const b of d.objects||[])if(2==(b[2]&7)&&(m=!0),!(b[2]&7)){var a=b[3]+80;126==a||127==a||159==a?p=98:143==a&&(n=97)}if(21==d.id||71==d.id)m=!1;f.push(`Initial pass: ${[m,n,p,r,t].join(", ")}`);a=(a)=>{var b=FLYERS$$module$js$patch.has(a.id),c=MOTHS_AND_BATS$$module$js$patch.has(a.id);
if(b){if(!l)return!1;--l}if(null!=r&&null!=a.pal2&&r!=a.pal2||null!=t&&null!=a.pal3&&t!=a.pal3)return!1;var g=!m||TREASURE_CHEST_BANKS$$module$js$patch.has(a.pat);let k;if(d.rom.objects[a.id].child||RETAIN_SLOTS$$module$js$patch.has(a.id)){const b=(k=a.patSlot?128:0)?p:n;if(null!=b&&b!=a.pat)return!1;if(k)p=a.pat;else if(g)n=a.pat;else return!1;f.push(`  Adding ${a.id.toString(16)}: pat(${k}) <-  ${a.pat.toString(16)}`)}else if(null==n&&g||n==a.pat)n=a.pat,k=0,f.push(`  Adding ${a.id.toString(16)}: pat0 <-  ${a.pat.toString(16)}`);
