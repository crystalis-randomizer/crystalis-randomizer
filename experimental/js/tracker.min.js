...
b?void 0:b.chunk))return[c,d];this.fail("Expected a constant offset",a[1][0])}fail(a,b){if(null===b||void 0===b?0:b.source)throw Error(a+module$js$asm$token.Token.at(b));throw Error(a+module$js$asm$token.Token.at({source:this._source}));}writeNumber(a,b,c){var d=b<<3;null!=c&&(c<-1<<d||c>=1<<d)&&this.fail(`Not a ${["byte","word","farword","dword"][b-1]}: $${c.toString(16)}`);for(d=0;d<b;d++)a.push(null!=c?c&255:255),null!=c&&(c>>=8)}}
function writeString$$module$js$asm$assembler(a,b){for(let c=0;c<b.length;c++)a.push(b.charCodeAt(c))}var module$js$asm$assembler={};module$js$asm$assembler.Assembler=Assembler$$module$js$asm$assembler;const DEBUG$$module$js$asm$define=!1;
...
b;a=this._offset=a+b.delta;for(var d of this.linker.watches)if(d>=a&&d<a+this.size)debugger;d=this.linker.data;b=(c=this._data,null!==c&&void 0!==c?c:fail$$module$js$asm$linker("No data"));this._data=void 0;if(this.subs.size){d.splice(a,b.length);c=new SparseByteArray$$module$js$asm$util;c.set(0,b);for(const a of this.subs)c.splice(a.offset,a.size);for(const b of c.chunks()){const [c,e]=b;d.set(a+c,...e)}}else d.set(a,b);for(const a of this.follow){const [b,c]=a;c.resolveSub(b,!1)}this.linker.free.delete(this.offset,
this.offset+this.size)}resolveSubs(a){a=void 0===a?!1:a;for(const b of this.selfSubs)this.resolveSub(b,a);for(const b of this.subs)this.resolveSub(b,a)}addDep(a,b){b===this.index&&this.subs.delete(a)&&this.selfSubs.add(a);this.linker.chunks[b].follow.set(a,this);this.deps.add(b)}resolveSub(a,b){var c,d;if(this.subs.has(a)||this.selfSubs.has(a)){a.expr=module$js$asm$expr.Expr.traverse(a.expr,(c,d,e)=>{var f;if(b&&"^"===(null===e||void 0===e?void 0:e.op)&&1===e.args.length&&c.meta)return null==c.meta.bank&&
this.addDep(a,c.meta.chunk),c;c=this.linker.resolveLink(module$js$asm$expr.Expr.evaluate(d(c)));b&&(null===(f=c.meta)||void 0===f?0:f.rel)&&this.addDep(a,c.meta.chunk);return c});var e=!1;if("num"===a.expr.op&&(null===(c=a.expr.meta)||void 0===c||!c.rel))this.writeValue(a.offset,a.expr.num,a.size),e=!0;else if(".move"===a.expr.op){if(1!==a.expr.args.length)throw Error("bad .move");c=a.expr.args[0];"num"===c.op&&null!=(null===(d=c.meta)||void 0===d?void 0:d.offset)&&(d=c.meta.offset+c.num,d=this.linker.orig.slice(d,
d+a.size),this.writeBytes(a.offset,Uint8Array.from(d)),e=!0)}e&&(this.subs.delete(a)||this.selfSubs.delete(a),this.subs.size||this.linker.unresolvedChunks.delete(this)&&this.linker.insertResolved(this))}}writeBytes(a,b){if(this._data)this._data.subarray(a,a+b.length).set(b);else if(null!=this._offset)this.linker.data.set(this._offset+a,b);else throw Error("Impossible");}writeValue(a,b,c){var d=c<<3;if(null!=b&&(b<-1<<d||b>=1<<d))throw Error(`Not a ${["byte","word","farword","dword"][c-1]}: $${b.toString(16)}`);
d=new Uint8Array(c);for(let a=0;a<c;a++)d[a]=b&255,b>>=8;this.writeBytes(a,d)}}function translateSub$$module$js$asm$linker(a,b,c){a=Object.assign({},a);a.expr=translateExpr$$module$js$asm$linker(a.expr,b,c);return a}
...
(d=a.prices[c],null!==d&&void 0!==d?d:0)));m("InnPrices");for(const a of this.inns())k.byte(Math.round(32*(e=a.prices[0],null!==e&&void 0!==e?e:0)));m("ShopLocations");for(const a of this)k.byte(a.location);m("ToolShopScaling");k.byte(...this.toolShopScaling);m("ArmorShopScaling");k.byte(...this.armorShopScaling);m("BasePrices");k.word(...this.basePrices.slice(13,39).map((a)=>null!==a&&void 0!==a?a:0));m("InnBasePrice");k.word(this.innBasePrice)}else{k.segment("10","fe","ff");k.reloc("ShopData");
