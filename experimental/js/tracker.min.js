...
(d=a.prices[c],null!==d&&void 0!==d?d:0)));m("InnPrices");for(const a of this.inns())k.byte(Math.round(32*(e=a.prices[0],null!==e&&void 0!==e?e:0)));m("ShopLocations");for(const a of this)k.byte(a.location);m("ToolShopScaling");k.byte(...this.toolShopScaling);m("ArmorShopScaling");k.byte(...this.armorShopScaling);m("BasePrices");k.word(...this.basePrices.slice(13,39).map((a)=>null!==a&&void 0!==a?a:0));m("InnBasePrice");k.word(this.innBasePrice)}else{k.segment("10","fe","ff");k.org(40356,"ShopData");
...
c);module$js$pass$standardmapedits.standardMapEdits(l,module$js$pass$standardmapedits.standardMapEdits.generateOptions(c,h));toggleMaps$$module$js$pass$togglemaps(l,c,h);l.scalingLevels=48;c.shuffleShops()&&shuffleShops$$module$js$patch(l,c,h);shuffleGoa$$module$js$pass$shufflegoa(l,h);randomizeWalls$$module$js$patch(l,c,h);crumblingPlatforms$$module$js$pass$crumblingplatforms(l,h);c.nerfWildWarp()&&l.wildWarp.locations.fill(0);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(l,c,h);c.randomizeThunderTeleport()&&
randomizeThunderWarp$$module$js$pass$randomizethunderwarp(l,h);rescaleMonsters$$module$js$pass$rescalemonsters(l,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(l,c,h);shuffleTrades$$module$js$pass$shuffletrades(l,c,h);c.randomizeMaps()&&shuffleMazes$$module$js$pass$shufflemazes(l,c,h);c.shuffleMimics()&&shuffleMimics$$module$js$pass$shufflemimics(l,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$pass$shufflemonsters(l,c,h);m=new World$$module$js$logic$world(l,c);if(m=yield(new Graph$$module$js$logic$graph([m.getLocationList()])).shuffle(c,
h,void 0,f,l.spoiler))for(var n of m){const [a,b]=n;l.slots[a&255]=b&255}else return[a,-1];c.shuffleShops()&&rescaleShops$$module$js$patch(l,c.bargainHunting()?h:void 0);c.buffMedicalHerb()&&(l.items.MedicalHerb.value=80,l.items.FruitOfPower.value=56);c.storyMode()&&storyMode$$module$js$patch(l);c.blackoutMode()&&blackoutMode$$module$js$patch(l);misc$$module$js$patch(l,c,h);fixDialog$$module$js$pass$fixdialog(l);c.buffDyna()&&buffDyna$$module$js$patch(l,c);c.trainer()&&(l.wildWarp.locations=[10,26,
53,72,109,110,140,170,172,176,182,159,166,88,92,0]);c.randomizeMusic("early")&&shuffleMusic$$module$js$patch(l,c,h);c.shuffleTilePalettes("early")&&shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);updateTablesPreCommit$$module$js$patch(l,c);h.shuffle(l.randomNumbers.values);l.messages.compress();n=a.slice(16);l.modules.push(yield g("early"));l.writeData(n);l.modules.pop();l.modules.push(yield g("late"));n=stampVersionSeedAndHash$$module$js$patch(a,b,k,n);c.randomizeMusic("late")&&shuffleMusic$$module$js$patch(l,
c,h);c.noMusic("late")&&noMusic$$module$js$patch(l);c.shuffleTilePalettes("late")&&shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);l.writeData();EXPAND_PRG$$module$js$patch&&(h=a.subarray(16),h.subarray(507904,524288).set(h.subarray(245760,262144)));return[a,n]})}
