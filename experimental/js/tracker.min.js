...
B=d("Allow wild warp",a.allowWildWarp()),u=d("Sword magic optional",!a.guaranteeSwordMagic()),t=d("Matching sword optional",!a.guaranteeMatchingSword()),T=d("Gas mask optional",!a.guaranteeGasMask()),O=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),ib=d("Calm sea optional",!a.barrierRequiresCalmSea()),U=d("Prison key optional",!a.paralysisRequiresPrisonKey()),va=d("Windmill optional",!a.sealedCaveRequiresWindmill()),Da=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
Wa=d("Barrier magic optional",!a.guaranteeBarrier()),Oa=d("Refresh magic optional",!a.guaranteeRefresh()),X=d("Telepathy optional for Deo",!a.saharaRabbitsRequireTelepathy()),jb=d("Lime Tree connects to Leaf",a.connectLimeTreeToLeaf()),ka=d("Buffed medical herb",a.buffMedicalHerb()),la=d("Orbs optional",a.orbsOptional()),J=(new Item$$module$js$nodes(c,0,"Sword of Wind")).weight(a.guaranteeSword()?10:5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),P=(new Item$$module$js$nodes(c,
1,"Sword of Fire")).weight(a.guaranteeSword()?10:5).fromPerson("Oak elder",29).dialog(29,void 0,3).key(),N=(new Item$$module$js$nodes(c,2,"Sword of Water")).weight(10).chest().key(),H=(new Item$$module$js$nodes(c,3,"Sword of Thunder")).weight(15).chest().key(),ma=(new Item$$module$js$nodes(c,4,"Crystalis")).fixed(),wa=(new Item$$module$js$nodes(c,5,"Ball of Wind")).chest().key(),V=(new Item$$module$js$nodes(c,6,"Tornado Bracelet")).chest().key(),na=(new Item$$module$js$nodes(c,7,"Ball of Fire")).bossDrop("Insect",
1).dialog(30,void 0,2).dialog(32,void 0,0).dialog(33,void 0,0).dialog(34,void 0,0).dialog(96,30,0).dialog(29,void 0,2).dialog(31,void 0,1).npcSpawn(193).key(),oa=(new Item$$module$js$nodes(c,8,"Flame Bracelet")).bossDrop("Kelbesque 1",2).npcSpawn(194).key(),pa=(new Item$$module$js$nodes(c,9,"Ball of Water")).weight(5).direct("Rage",250679).npcSpawn(195).key(),da=(new Item$$module$js$nodes(c,10,"Blizzard Bracelet")).weight(5).chest().key(),Ea=(new Item$$module$js$nodes(c,11,"Ball of Thunder")).bossDrop("Mado 1",
5).trigger(154,1).key(),xa=(new Item$$module$js$nodes(c,12,"Storm Bracelet")).chest().key(),ya=(new Item$$module$js$nodes(c,13,"Carapace Shield")).armor(),w=(new Item$$module$js$nodes(c,14,"Bronze Shield")).armor(),qb=(new Item$$module$js$nodes(c,15,"Platinum Shield")).armor(),F=(new Item$$module$js$nodes(c,16,"Mirrored Shield")).armor(),Z=(new Item$$module$js$nodes(c,17,"Ceramic Shield")).armor(),R=(new Item$$module$js$nodes(c,18,"Sacred Shield")).armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),
ea=(new Item$$module$js$nodes(c,19,"Battle Shield")).armor(),Pa=(new Item$$module$js$nodes(c,20,"Psycho Shield")).armor(),Fa=(new Item$$module$js$nodes(c,21,"Tanned Hide")).armor(),ae=(new Item$$module$js$nodes(c,22,"Leather Armor")).armor(),be=(new Item$$module$js$nodes(c,23,"Bronze Armor")).armor(),nc=(new Item$$module$js$nodes(c,24,"Platinmum Armor")).armor(),ce=(new Item$$module$js$nodes(c,25,"Soldier Suit")).armor(),oc=(new Item$$module$js$nodes(c,26,"Ceramic Suit")).armor(),de=(new Item$$module$js$nodes(c,
27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),Q=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),Y=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),Xa=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),Jb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),aa=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),qa=(new Item$$module$js$nodes(c,
34,"Magic Ring")).consumable(),Kb=(new Item$$module$js$nodes(c,35,"Fruit of Repun")).consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),fa=(new Item$$module$js$nodes(c,36,"Warp Boots")).consumable(),pc=(new Item$$module$js$nodes(c,37,"Statue of Onyx")).chest("Cordel grass").invisible(254882).key(),Lb=(new Item$$module$js$nodes(c,38,"Opel Statue")).consumable().bossDrop("Kelbesque 2",6).npcSpawn(197).key(),qc=(new Item$$module$js$nodes(c,39,"Insect Flute")).fromPerson("Oak mother",30).dialog(30,
void 0,1).key(),Mb=(new Item$$module$js$nodes(c,40,"Flute of Lime")).fromPerson("Portoa queen",56).fromPerson("Asina secondary",98,1).dialog(56,void 0,4).key(),rb=(new Item$$module$js$nodes(c,41,"Gas Mask")).direct("Akahana in Brynmaer",251902).npcSpawn(22,24).key(),fe=(new Item$$module$js$nodes(c,42,"Power Ring")).chest().bonus(),ge=(new Item$$module$js$nodes(c,43,"Warrior Ring")).fromPerson("Akahana's friend",84).dialog(84,void 0,2).bonus(),he=(new Item$$module$js$nodes(c,44,"Iron Necklace")).chest().bonus(),
ie=(new Item$$module$js$nodes(c,45,"Deo's Pendant")).fromPerson("Deo",90).dialog(90,void 0,0).bonus(),Nb=(new Item$$module$js$nodes(c,46,"Rabbit Boots")).bossDrop("Vampire 1",0).npcSpawn(192).key(),rc=((a,b)=>new Item$$module$js$nodes(c,a,b))(47,a.leatherBootsGiveSpeed()?"Speed Boots":"Leather Boots").chest().bonus(),sc=(new Item$$module$js$nodes(c,48,"Shield Ring")).direct("Akahana in waterfall cave",250543).bonus(),Ob=(new Item$$module$js$nodes(c,49,"Alarm Flute")).fromPerson("Zebu's student",20,
1).key(),tc=(new Item$$module$js$nodes(c,50,"Windmill Key")).fromPerson("Windmill guard",20).dialog(20,14,0).npcSpawn(20,14,1).key(),Pb=(new Item$$module$js$nodes(c,51,"Key to Prison")).chest().key(),uc=(new Item$$module$js$nodes(c,52,"Key to Styx")).fromPerson("Zebu in Shyron",94,1).trigger(128,2).dialog(94,242,0).dialog(98,242,0).key(),vc=(new Item$$module$js$nodes(c,53,"Fog Lamp")).chest().key(),Qb=(new Item$$module$js$nodes(c,54,"Shell Flute")).fromPerson("Dolphin",99,1).npcSpawn(99).key(),wc=
(new Item$$module$js$nodes(c,55,"Eye Glasses")).fromPerson("Clark",68).dialog(68,233,1).key(),xc=(new Item$$module$js$nodes(c,56,"Broken Statue")).bossDrop("Sabera 1",4).npcSpawn(127,101).npcSpawn(9).npcSpawn(10).npcSpawn(69).npcSpawn(70).npcSpawn(71).npcSpawn(132).npcSpawn(142).dialog(61).dialog(62).dialog(63).dialog(64).dialog(65).dialog(66).dialog(67).dialog(68,233).trigger(182).key(),yc=(new Item$$module$js$nodes(c,57,"Glowing Lamp")).direct("Kensu in lighthouse",250638).npcSpawn(126,98,1).key(),
zc=(new Item$$module$js$nodes(c,59,"Love Pendant")).chest("Underground channel").invisible(254890).key(),Ac=(new Item$$module$js$nodes(c,60,"Kirisa Plant")).chest("Kirisa meadow").invisible(254886).key(),Rb=(new Item$$module$js$nodes(c,61,"Ivory Statue")).bossDrop("Karmine",9).npcSpawn(200).key(),Bc=(new Item$$module$js$nodes(c,62,"Bow of Moon")).fromPerson("Aryllis",35).direct(251624).dialog(35,void 0,1).key(),Cc=(new Item$$module$js$nodes(c,63,"Bow of Sun")).chest().key(),Dc=(new Item$$module$js$nodes(c,
64,"Bow of Truth")).fromPerson("Azteca",131).npcSpawn(131,156,1).dialog(131,void 0,0).key(),sb=(new Magic$$module$js$nodes(c,65,"Refresh")).fromPerson("Zebu at windmill",94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),kb=(new Magic$$module$js$nodes(c,66,"Paralysis")).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),Ga=(new Magic$$module$js$nodes(c,67,"Telepathy")).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),Ec=(new Magic$$module$js$nodes(c,
68,"Teleport")).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),je=(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),Fc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),Qa=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),K=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=aa.bossDrop("Vampire 2",
12,97).npcSpawn(204).key(),ba=new Item$$module$js$nodes(c,112,"Mimic"),Gc=(new Trigger$$module$js$nodes(c,"Talked to Leaf Elder")).get(J),Hc=(new Trigger$$module$js$nodes(c,"Talked to Leaf Student")).get(Ob),Sb=new Trigger$$module$js$nodes(c,"Talked to Zebu in cave"),le=(new Trigger$$module$js$nodes(c,"Woke up Windmill Guard")).get(tc),lb=new Trigger$$module$js$nodes(c,"Started Windmill"),Ic=(new Trigger$$module$js$nodes(c,"Learned Refresh")).get(sb),me=(new Trigger$$module$js$nodes(c,"Gave Statue to Akahana")).get(rb),
ne=(new Trigger$$module$js$nodes(c,"Fought Stom")).get(Ga),Jc=new Trigger$$module$js$nodes(c,"Visited Oak"),Kc=new Trigger$$module$js$nodes(c,"Talked to Oak Mother"),Tb=new Trigger$$module$js$nodes(c,"Rescued Oak Child"),oe=(new Trigger$$module$js$nodes(c,"Talked to Oak Mother Again")).get(qc),pe=(new Trigger$$module$js$nodes(c,"Talked to Oak Elder")).get(P),qe=(new Trigger$$module$js$nodes(c,"Talked to Tornel on Mt Sabre")).get(Ec),Lc=new Trigger$$module$js$nodes(c,"Villagers Abducted"),Mc=new Trigger$$module$js$nodes(c,
"Talked to Rabbit in Leaf"),re=(new Trigger$$module$js$nodes(c,"Learned Paralysis")).get(kb),Nc=new Trigger$$module$js$nodes(c,"Talked to Portoa Queen"),Oc=new Trigger$$module$js$nodes(c,"Talked to Fortune Teller"),Pc=new Trigger$$module$js$nodes(c,"Visited Underground Channel"),se=(new Trigger$$module$js$nodes(c,"Sent to Waterfall Cave")).get(Mb),te=(new Trigger$$module$js$nodes(c,"Cured Akahana")).get(sc),Qc=(new Trigger$$module$js$nodes(c,"Talked to Rage")).get(pa),Rc=new Trigger$$module$js$nodes(c,
"Mesia recording played"),Sc=(new Trigger$$module$js$nodes(c,"Talked to Asina")).get(je),Tc=(new Trigger$$module$js$nodes(c,"Healed Dolphin")).get(Qb),Ub=new Trigger$$module$js$nodes(c,"Returned Fog Lamp"),Uc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Cabin"),Vc=new Trigger$$module$js$nodes(c,"Talked to Joel Elder"),ue=(new Trigger$$module$js$nodes(c,"Talked to Clark")).get(wc),ve=(new Trigger$$module$js$nodes(c,"Talked to Kensu in Lighthouse")).get(yc),Vb=new Trigger$$module$js$nodes(c,"Calmed the Angry Sea"),
we=(new Trigger$$module$js$nodes(c,"Learned Barrier")).get(Fc),Wc=new Trigger$$module$js$nodes(c,"Talked to Stom in Swan Hut"),Xc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Swan tavern"),Yc=new Trigger$$module$js$nodes(c,"Talked to Kensu at Swan dance"),xe=(new Trigger$$module$js$nodes(c,"Returned Kensu's love pendant")).get(Qa),ye=(new Trigger$$module$js$nodes(c,"Talked to Amazones Queen")).get(Bc),Wb=new Trigger$$module$js$nodes(c,"Entered Shyron"),ze=(new Trigger$$module$js$nodes(c,"Talked to Zebu in Shyron")).get(uc),
Zc=new Trigger$$module$js$nodes(c,"Shyron Massacre"),Ae=(new Trigger$$module$js$nodes(c,"Saved Kensu")).get(K),Be=(new Trigger$$module$js$nodes(c,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$js$nodes(c,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(c,"Get Bow of Truth")).get(Dc),Ee=(new Trigger$$module$js$nodes(c,"Forged Crystalis")).get(ma),tb=(new Condition$$module$js$nodes(c,"Sword charge glitch")).option(v,y),Fe=(new Condition$$module$js$nodes(c,"Rabbit skip")).option(r,
x),Ge=(new Condition$$module$js$nodes(c,"Teleport skip")).option(p,q),ub=(new Condition$$module$js$nodes(c,"Statue glitch")).option(l,n),He=(new Condition$$module$js$nodes(c,"Wild warp")).option(C,B),vb=(new Condition$$module$js$nodes(c,"Any level 2 sword")).option(J,wa).option(J,V).option(P,na).option(P,oa).option(N,pa).option(N,da).option(H,Ea).option(H,xa),D=(new Condition$$module$js$nodes(c,"Destroy stone")).option(J,la).option(J,wa).option(J,V).option(tb,J,vb),E=(new Condition$$module$js$nodes(c,
"Destroy ice")).option(P,la).option(P,na).option(P,oa).option(tb,P,vb),z=(new Condition$$module$js$nodes(c,"Cross rivers")).option(N,la).option(N,pa).option(N,da).option(K).option(tb,N,vb),Ya=(new Condition$$module$js$nodes(c,"Destroy iron")).option(H,la).option(H,Ea).option(H,xa).option(tb,H,vb),ha=(new Condition$$module$js$nodes(c,"Any sword")).option(J).option(P).option(N).option(H),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(P).option(N).option(H).option(rb,
t.value?t:g,J),Je=(new Condition$$module$js$nodes(c,"Match vampire 2 sword (wind/water/thunder)")).option(J).option(N).option(H).option(t.value?t:g,P),$c=(new Condition$$module$js$nodes(c,"Speed boots")).option(rc,k),ad=(new Condition$$module$js$nodes(c,"Climb slopes")).option(Nb).option(K).option($c),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Mc).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(Ec).option(Ge,K),bd=(new Condition$$module$js$nodes(c,
"Asina in her room")).option(Rc),Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(kb).option(bd).option(ub),cd=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(Qb,Uc),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(m,cd,Nb),za=(new Condition$$module$js$nodes(c,"Cross sea")).option(cd).option(K),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Vb).option(K).option(Ne),ia=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(Oa.value?
Oa:g).option(sb),dd=(new Condition$$module$js$nodes(c,"Wind magic")).option(u.value?u:g,ia).option(wa,V,ia),ed=(new Condition$$module$js$nodes(c,"Fire magic")).option(u.value?u:g,ia).option(na,oa,ia),fd=(new Condition$$module$js$nodes(c,"Water magic")).option(u.value?u:g,ia).option(u,ia).option(pa,da,ia),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(u.value?u:g,ia).option(u,ia).option(Ea,ia).option(xa,ia),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(Mb).option(ub),
Re=(new Condition$$module$js$nodes(c,"Change or glitch")).option(Qa).option(ub),Se=(new Condition$$module$js$nodes(c,"Change or glitch or paralysis")).option(Qa).option(ub).option(kb),Xb=(new Condition$$module$js$nodes(c,"Pass shooting statues")).option(Fc).option(ha,Wa.value?Wa:g).option(sb,sc),Te=(new Condition$$module$js$nodes(c,"Healed dolphin if required")).option(Tc).option(O),gd=(new Condition$$module$js$nodes(c,"Match sword of wind")).option(J).option(t.value?t:g,ha),hd=(new Condition$$module$js$nodes(c,
"Match sword of fire")).option(P).option(t.value?t:g,ha),id=(new Condition$$module$js$nodes(c,"Match sword of water")).option(N).option(t.value?t:g,ha),Ue=(new Condition$$module$js$nodes(c,"Match sword of thunder")).option(H).option(t.value?t:g,ha),Ve=(new Condition$$module$js$nodes(c,"Swamp run possible")).option(ha,$c).option(ha,ka).option(ha,sb),We=(new Condition$$module$js$nodes(c,"Insect possible to kill")).option(rb),wb=(new Condition$$module$js$nodes(c,"Travel swamp")).option(rb).option(T.value?
T:g,Ve),Xe=(new Condition$$module$js$nodes(c,"Calmed sea if required")).option(Vb).option(ib),Ye=(new Condition$$module$js$nodes(c,"Started windmill if required")).option(lb).option(va),Ze=(new Condition$$module$js$nodes(c,"Telepathy if required for Deo")).option(Ga).option(X),$e=e(0,"Vampire 1",ha).get(Nb),af=e(1,"Insect",qc,Ie,We).get(na),bf=e(2,"Kelbesque 1",gd,dd).get(oa),cf=e(12,"Vampire 2",Je).get(ke),jd=e(4,"Sabera 1",hd,ed).get(xc),df=e(5,"Mado 1",id,fd).get(Ea),ef=e(6,"Kelbesque 2",gd,dd).get(Lb),
ff=e(7,"Sabera 2",hd,ed).get(Kb),gf=e(8,"Mado 2",id,fd).get(R),hf=e(9,"Karmine",Ue,Pe).get(Rb),jf=e(10,"Draygon 1",ha).get(ee),kf=e(-1,"Statues",Cc,Bc),lf=e(11,"Draygon 2",ha,Dc),mf=e(13,"Dyna",ma),nf=(new Condition$$module$js$nodes(c,"Opened prison if required")).option(Pb).option(U),ra=new Area$$module$js$nodes(c,"Leaf"),Za=new Area$$module$js$nodes(c,"Valley of Wind"),ja=new Area$$module$js$nodes(c,"Sealed Cave"),Ra=new Area$$module$js$nodes(c,"Cordel Plain"),$a=new Area$$module$js$nodes(c,"Brynmaer"),
ab=new Area$$module$js$nodes(c,"Amazones"),L=new Area$$module$js$nodes(c,"Mt Sabre West"),A=new Area$$module$js$nodes(c,"Mt Sabre North"),xb=new Area$$module$js$nodes(c,"Nadare's"),mb=new Area$$module$js$nodes(c,"Oak"),Ha=new Area$$module$js$nodes(c,"Waterfall Valley"),I=new Area$$module$js$nodes(c,"Portoa"),Ia=new Area$$module$js$nodes(c,"Waterfall Cave"),M=new Area$$module$js$nodes(c,"Fog Lamp Cave"),Ja=new Area$$module$js$nodes(c,"Kirisa Plant Cave"),Sa=new Area$$module$js$nodes(c,"Angry Sea"),
Ka=new Area$$module$js$nodes(c,"Joel"),W=new Area$$module$js$nodes(c,"Evil Spirit Island"),La=new Area$$module$js$nodes(c,"Sabera's Castle"),sa=new Area$$module$js$nodes(c,"Swan"),G=new Area$$module$js$nodes(c,"Mt Hydra"),Ma=new Area$$module$js$nodes(c,"Shyron"),Ta=new Area$$module$js$nodes(c,"Styx"),Ua=new Area$$module$js$nodes(c,"Goa"),yb=new Area$$module$js$nodes(c,"Draygonia Fortress 1"),ta=new Area$$module$js$nodes(c,"Draygonia Fortress 2"),bb=new Area$$module$js$nodes(c,"Draygonia Fortress 3"),
ca=new Area$$module$js$nodes(c,"Draygonia Fortress 4"),S=new Area$$module$js$nodes(c,"Oasis Cave"),ua=new Area$$module$js$nodes(c,"Sahara"),cb=new Area$$module$js$nodes(c,"Pyramid Front"),Aa=new Area$$module$js$nodes(c,"Pyramid Back"),Ba=new Area$$module$js$nodes(c,"Tower"),Yb=(new Location$$module$js$nodes(c,0,ra,"Start")).overworld().start(),of=(new Location$$module$js$nodes(c,0,ra,"Mezame Shrine")).overworld().from(Yb),pf=(new Location$$module$js$nodes(c,1,ra,"Outside Start")).overworld().connect(of),
Na=(new Location$$module$js$nodes(c,2,ra,"Town")).town().connect(pf),nb=(new Location$$module$js$nodes(c,3,Za,"Main")).overworld().connect(Na).trigger(Ic,lb),kd=(new Location$$module$js$nodes(c,3,Za,"Outside Windmill")).overworld(),ld=(new Location$$module$js$nodes(c,4,ja,"Tunnel 1 (entrance)")).cave().from(nb,lb),qf=(new Location$$module$js$nodes(c,5,ja,"Tunnel 2 (over bridge)")).cave().connect(ld),rf=(new Location$$module$js$nodes(c,6,ja,"Tunnel 6 (herb dead end)")).cave().chest(Q,15),md=(new Location$$module$js$nodes(c,
7,ja,"Tunnel 4a (ball corridor)")).cave().chest(Q,20,80).chest(wa,21);(new Location$$module$js$nodes(c,7,ja,"Tunnel 4b (antidote dead end)")).cave().connect(md,D).chest(Y,19);const sf=(new Location$$module$js$nodes(c,8,ja,"Tunnel 5 (warp boots dead end)")).cave().chest(fa,14),tf=(new Location$$module$js$nodes(c,9,ja,"Tunnel 3a (branch, front)")).cave().connect(qf).connectTo(md).connectTo(sf),uf=(new Location$$module$js$nodes(c,9,ja,"Tunnel 3b (branch, back)")).cave().connect(tf,D).connectTo(rf),vf=
(new Location$$module$js$nodes(c,10,ja,"Tunnel 7 (boss)")).cave().connect(uf).boss($e),wf=(new Location$$module$js$nodes(c,12,ja,"Tunnel 8a (exit, above wall)")).cave().connect(vf),xf=(new Location$$module$js$nodes(c,12,ja,"Tunnel 8b (exit, below wall")).cave().connect(wf,D);(new Location$$module$js$nodes(c,14,Za,"Windmill Cave")).cave().connect(nb).connectTo(kd).trigger(le,Ob,Sb);(new Location$$module$js$nodes(c,15,Za,"Windmill")).misc().connect(kd).trigger(lb,tc);const yf=(new Location$$module$js$nodes(c,
16,Za,"Zebu's Cave Front")).cave().connect(nb).trigger(Sb,Gc,Hc).trigger(Ic,lb,Sb),zf=(new Location$$module$js$nodes(c,16,Za,"Zebu's Cave Back")).cave().trigger(Lc).connect(yf,E),Af=(new Location$$module$js$nodes(c,17,L,"Tunnel 1 (to Zebu)")).cave().connect(zf),db=(new Location$$module$js$nodes(c,20,Ra,"West")).overworld().connect(xf,Ye),Bf=(new Location$$module$js$nodes(c,20,Ra,"South")).overworld().connect(db,z),nd=(new Location$$module$js$nodes(c,21,Ra,"East")).overworld().connect(db).chest(pc,
24),ob=(new Location$$module$js$nodes(c,24,$a,"Town")).town().connect(db).trigger(me,pc),Cf=(new Location$$module$js$nodes(c,25,Ra,"Outside Stom's House")).town().connect(db),Zb=(new Location$$module$js$nodes(c,26,Ra,"Swamp")).overworld().connect(nd,wb).trigger(Tb,Kc,wb);(new Location$$module$js$nodes(c,26,Ra,"Swamp Insect Area")).overworld().connect(Zb,wb).boss(af);const zb=(new Location$$module$js$nodes(c,27,ab,"Town")).town().connect(Bf),Ab=(new Location$$module$js$nodes(c,28,mb,"Town")).town().connect(Zb,
wb).trigger(Jc);(new Location$$module$js$nodes(c,30,Ra,"Stom's House")).house().connect(Cf).trigger(ne,Jc);const eb=(new Location$$module$js$nodes(c,32,L,"Entrance")).overworld().connect(db).connect(Af),Df=(new Location$$module$js$nodes(c,32,L,"Up Slope")).overworld().from(eb,ad).to(eb),Ef=(new Location$$module$js$nodes(c,32,L,"Dead End (warp boots)")).overworld().chest(fa,24,106),od=(new Location$$module$js$nodes(c,33,L,"Upper")).overworld().from(eb,K).to(eb),Ff=(new Location$$module$js$nodes(c,
33,L,"Tornel Dead End")).overworld().trigger(qe,wa,V).chest(qa,23,105),pd=(new Location$$module$js$nodes(c,34,L,"Tunnel 2a (fork at start)")).cave().connect(eb);(new Location$$module$js$nodes(c,34,L,"Tunnel 2b (left branch to dead end)")).cave().connect(pd,E).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,L,"Tunnel 2c (right branch to upper)")).cave().connect(pd,E),Hf=(new Location$$module$js$nodes(c,35,L,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(Q,23,82),
If=(new Location$$module$js$nodes(c,35,L,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,E).connectTo(od),qd=(new Location$$module$js$nodes(c,36,L,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,L,"Tunnel 4b (out to upper)")).cave().connect(qd,E).connectTo(od);const Jf=(new Location$$module$js$nodes(c,37,L,"Tunnel 5 (tiny connector)")).cave().connect(qd),Kf=(new Location$$module$js$nodes(c,38,L,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);
(new Location$$module$js$nodes(c,38,L,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,E).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,L,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,L,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,E);(new Location$$module$js$nodes(c,39,L,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,E).chest(V,25);const Bb=(new Location$$module$js$nodes(c,40,A,"Entrance")).overworld().connect(nd,
Le,Ke),Cb=(new Location$$module$js$nodes(c,40,A,"Upper")).overworld().from(Bb,K).to(Bb),$b=(new Location$$module$js$nodes(c,40,A,"Summit (boss)")).overworld().from(Cb,K).to(Cb).boss(bf),rd=(new Location$$module$js$nodes(c,41,A,"Connector")).overworld(),ac=(new Location$$module$js$nodes(c,41,A,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,A,"Middle Right")).overworld().from(ac,ad).to(ac),sd=(new Location$$module$js$nodes(c,42,A,"Tunnel 2a (from entrance to connector)")).cave().connectTo(rd);
(new Location$$module$js$nodes(c,42,A,"Tunnel 2b (under bridge, to antidote)")).cave().connect(sd,E).chest(Y,23,94);const td=(new Location$$module$js$nodes(c,43,A,"Tunnel 3a (branch after connector)")).cave().connect(rd),Of=(new Location$$module$js$nodes(c,43,A,"Tunnel 3b (right branch)")).cave().connect(td,E),Pf=(new Location$$module$js$nodes(c,43,A,"Tunnel 3c (upper branch)")).cave().connect(td,E);(new Location$$module$js$nodes(c,44,A,"Tunnel 4 (over bridge, to middle)")).cave().connect(Pf).connectTo(ac);
const ud=(new Location$$module$js$nodes(c,45,A,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Of).connectTo(Nf);(new Location$$module$js$nodes(c,45,A,"Tunnel 5b (dead-end with herb)")).cave().connect(ud,E).chest(Q,22,83);const Qf=(new Location$$module$js$nodes(c,46,A,"Tunne; 6a (S-shaped hall, right)")).cave().connect(ud),Rf=(new Location$$module$js$nodes(c,46,A,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Qf,E),Sf=(new Location$$module$js$nodes(c,46,A,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Rf,
E),vd=(new Location$$module$js$nodes(c,47,A,"Prison (hallway)")).cave().connect(Cb),Tf=(new Location$$module$js$nodes(c,48,A,"Left Cell (shopkeepers)")).cave().from(vd,E);(new Location$$module$js$nodes(c,49,A,"Left Cell 2 (back, with prison key)")).cave().from(Tf,E).chest(Pb,13);const Uf=(new Location$$module$js$nodes(c,50,A,"Right Cell (villagers)")).cave().from(vd,E),Vf=(new Location$$module$js$nodes(c,51,A,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Uf,E);(new Location$$module$js$nodes(c,
52,A,"Tunnel 9 (connector to summit)")).cave().connect(Vf).connectTo($b);const Wf=(new Location$$module$js$nodes(c,53,A,"Summit Cave (front)")).cave().from($b,Pb).to($b),Xf=(new Location$$module$js$nodes(c,53,A,"Summit Cave (behind ice)")).cave().connect(Wf,E).trigger(re);(new Location$$module$js$nodes(c,56,A,"Tunnel 1 (leads from main entrance)")).cave().connect(Bb).connectTo(sd);(new Location$$module$js$nodes(c,57,A,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(Cb);const Yf=(new Location$$module$js$nodes(c,
60,xb,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,xb,"Tool Shop")).shop(Q,Y,aa,fa),$f=(new Location$$module$js$nodes(c,62,xb,"Back Room")).house(),bc=(new Location$$module$js$nodes(c,64,Ha,"Summit")).overworld().connect(Xf,nf),Db=(new Location$$module$js$nodes(c,64,Ha,"Northwest")).overworld().from(bc).to(bc,K),ag=(new Location$$module$js$nodes(c,64,Ha,"Northeast")).overworld().connect(Db,z),wd=(new Location$$module$js$nodes(c,65,Ha,"Southwest")).overworld().connect(Db),bg=(new Location$$module$js$nodes(c,
65,Ha,"Southeast")).overworld().connect(wd,z),xd=(new Location$$module$js$nodes(c,66,Ha,"Lime Tree Valley")).overworld().connect(wd).connect(nb,jb),cg=(new Location$$module$js$nodes(c,67,Ha,"Lime Tree Lake (Rage)")).cave().connect(xd).trigger(Qc,N),dg=(new Location$$module$js$nodes(c,68,Ja,"Tunnel 1a (entrance)")).cave().connect(bg),eg=(new Location$$module$js$nodes(c,68,Ja,"Tunnel 1b (behind wall)")).cave().connect(dg,D),yd=(new Location$$module$js$nodes(c,69,Ja,"Tunnel 2a (main path, before wall)")).cave().connect(eg);
(new Location$$module$js$nodes(c,69,Ja,"Tunnel 2b (dead end, antidote)")).cave().connect(yd,D).chest(Y,25,95);const fg=(new Location$$module$js$nodes(c,69,Ja,"Tunnel 2c (main path, after wall)")).cave().connect(yd,D),gg=(new Location$$module$js$nodes(c,70,Ja,"Tunnel 3a (last room, before wall)")).cave().connect(fg),hg=(new Location$$module$js$nodes(c,70,Ja,"Tunnel 3b (last room, after wall)")).cave().connect(gg,D);(new Location$$module$js$nodes(c,71,Ja,"Meadow")).overworld().connect(hg).chest(Ac,
14);const ig=(new Location$$module$js$nodes(c,72,M,"Tunnel 1a (entrance)")).cave().connect(ag),zd=(new Location$$module$js$nodes(c,72,M,"Tunnel 1b (past wall)")).cave().connect(ig,D);(new Location$$module$js$nodes(c,72,M,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(zd,D).chest(Xa,24);const jg=(new Location$$module$js$nodes(c,73,M,"Tunnel 2 (tiny connector)")).cave().connect(zd),Ad=(new Location$$module$js$nodes(c,74,M,"Tunnel 3a (upper branch)")).cave().connect(jg);(new Location$$module$js$nodes(c,
74,M,"Tunnel 3b (dead end, mimic)")).cave().connect(Ad,D).chest(ba,21,112);const Bd=(new Location$$module$js$nodes(c,74,M,"Tunnel 3c (short passage with mimic)")).cave().connect(Ad,D).chest(ba,22,113),kg=(new Location$$module$js$nodes(c,74,M,"Tunnel 3d (lower branch)")).cave().connect(Bd,D);(new Location$$module$js$nodes(c,75,M,"Dead end loop")).cave().connect(kg);const Cd=(new Location$$module$js$nodes(c,76,M,"Tunnel 4a (right branch over bridge)")).cave().connect(Bd),lg=(new Location$$module$js$nodes(c,
76,M,"Tunnel 4b (past wall over bridge)")).cave().connect(Cd,D),mg=(new Location$$module$js$nodes(c,77,M,"Tunnel 5a (from left branch)")).cave().connect(Cd),ng=(new Location$$module$js$nodes(c,77,M,"Tunnel 5b (reconvergence)")).cave().connect(mg,D).connect(lg),og=(new Location$$module$js$nodes(c,77,M,"Tunnel 5c (between walls)")).cave().connect(ng,D),pg=(new Location$$module$js$nodes(c,77,M,"Tunnel 5d (under bridge)")).cave().connect(og,D),qg=(new Location$$module$js$nodes(c,78,M,"Tunnel 6a (over second bridge)")).cave().connect(pg),
rg=(new Location$$module$js$nodes(c,78,M,"Tunnel 6b (past wall)")).cave().connect(qg,D),sg=(new Location$$module$js$nodes(c,79,M,"Tunnel 7a (under second bridge)")).cave().connect(rg);(new Location$$module$js$nodes(c,79,M,"Tunnel 7b (fog lamp)")).cave().connect(sg,D).chest(vc,19);const Va=(new Location$$module$js$nodes(c,80,I,"Town")).town().connect(Db),Dd=(new Location$$module$js$nodes(c,81,I,"Fishherman Island")).town().connect(Va);(new Location$$module$js$nodes(c,82,Ha,"Mesia Shrine")).cave().trigger(Rc).connect(cg,
z,Qc);const Ed=(new Location$$module$js$nodes(c,84,Ia,"Tunnel 1a (entrance)")).cave().connect(Db);(new Location$$module$js$nodes(c,84,Ia,"Tunnel 1b (dead end, mimic)")).cave().connect(Ed,E).chest(ba,19,114);const tg=(new Location$$module$js$nodes(c,84,Ia,"Tunnel 1c (past ice)")).cave().connect(Ed,E),ug=(new Location$$module$js$nodes(c,85,Ia,"Tunnel 2 (stoned pair)")).cave().connect(tg),cc=(new Location$$module$js$nodes(c,86,Ia,"Tunnel 3 (wide medusa hallways)")).cave().connect(ug,Qe),vg=(new Location$$module$js$nodes(c,
87,Ia,"Tunnel 4a (left entrance)")).cave().from(cc,E).chest(F.chest().bonus(),25).trigger(te,Mb);(new Location$$module$js$nodes(c,87,Ia,"Tunnel 4b (right entrance)")).cave().from(cc,E).connect(vg,K);(new Location$$module$js$nodes(c,87,Ia,"Tunnel 4c (sword of water)")).cave().connect(cc,E).chest(N,24);const Fd=(new Location$$module$js$nodes(c,88,Ba,"Entrance")).misc(),wg=(new Location$$module$js$nodes(c,89,Ba,"Level 1")).misc().from(Fd),xg=(new Location$$module$js$nodes(c,90,Ba,"Level 2")).misc().from(wg),
yg=(new Location$$module$js$nodes(c,91,Ba,"Level 3")).misc().from(xg),Gd=(new Location$$module$js$nodes(c,92,Ba,"Outside Mesia Room")).misc().from(yg),zg=(new Location$$module$js$nodes(c,93,Ba,"Outside Dyna Room")).misc().from(Gd,ma);(new Location$$module$js$nodes(c,94,Ba,"Mesia")).misc().connect(Gd).trigger(Ee);const Ag=(new Location$$module$js$nodes(c,95,Ba,"Dyna")).misc().from(zg).boss(mf);(new Location$$module$js$nodes(c,95,Ba,"Win")).misc().from(Ag).end();const dc=(new Location$$module$js$nodes(c,
96,Sa,"Cabin Beach")).sea().from(Dd,Ub),fb=(new Location$$module$js$nodes(c,96,Sa,"South")).sea().connect(dc,za),Bg=(new Location$$module$js$nodes(c,96,Sa,"Joel Beach")).sea().connect(fb,za),Hd=(new Location$$module$js$nodes(c,96,Ka,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(c,96,Sa,"Altar")).sea().connect(fb,za).trigger(Vb,yc,xc);const Cg=(new Location$$module$js$nodes(c,96,Sa,"North")).sea().to(fb,za).from(fb,za,Oe).trigger(we,Xe),Dg=(new Location$$module$js$nodes(c,96,Sa,"Swan Beach")).sea().connect(Cg,
za);(new Location$$module$js$nodes(c,97,Sa,"Cabin")).misc().connect(dc).trigger(Uc,Ub);(new Location$$module$js$nodes(c,98,Ka,"Lighthouse")).misc().connect(Hd).trigger(ve,Ob);const Eb=(new Location$$module$js$nodes(c,100,I,"Underground Channel 1 (from throne room)")).sea().trigger(Pc),Eg=(new Location$$module$js$nodes(c,100,I,"Underground Channel 2 (to fortune teller)")).sea().connect(Eb,z),Id=(new Location$$module$js$nodes(c,100,I,"Underground Channel 3 (from fortune teller)")).sea().connect(Eb,
K),Jd=(new Location$$module$js$nodes(c,100,I,"Underground Channel 4 (asina)")).sea().connect(Id,z),Fg=(new Location$$module$js$nodes(c,100,I,"Underground Channel 5 (dolphin)")).sea().connect(Jd,z).trigger(Tc,Q,Sc);(new Location$$module$js$nodes(c,100,I,"Underground Channel 6 (water)")).sea().connect(Fg,za).connectTo(fb,za).chest(zc,17);const ec=(new Location$$module$js$nodes(c,101,W,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,W,"Tunnel 1 (entrance)")).sea().connect(fb,Vc,za),Kd=
(new Location$$module$js$nodes(c,105,W,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,W,"Tunnel 2b (dead end to left)")).cave().connect(Kd,z);const Hg=(new Location$$module$js$nodes(c,105,W,"Tunnel 2c (across first river)")).cave().connect(Kd,z),Ld=(new Location$$module$js$nodes(c,105,W,"Tunnel 2d (across second river)")).cave().connect(Hg,z);(new Location$$module$js$nodes(c,105,W,"Tunnel 2e (dead end, magic ring)")).cave().connect(Ld,D).chest(qa,29);const Ig=(new Location$$module$js$nodes(c,
105,W,"Tunnel 2f (stair down)")).cave().connect(Ld,D),Jg=(new Location$$module$js$nodes(c,106,W,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(ec).chest(Xa,25,92),Kg=(new Location$$module$js$nodes(c,106,W,"Tunnel 3b (left area toward items)")).cave().connect(Jg,D),Lg=(new Location$$module$js$nodes(c,107,W,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(ba,14,115);(new Location$$module$js$nodes(c,107,W,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,z).chest(he,15);const fc=
(new Location$$module$js$nodes(c,108,La,"Floor 1")).fortress().connect(ec),Mg=(new Location$$module$js$nodes(c,108,La,"Miniboss")).fortress().boss(cf).connect(fc);(new Location$$module$js$nodes(c,109,La,"Floor 2a (left stair)")).fortress().connect(fc).chest(aa,19);const Ng=(new Location$$module$js$nodes(c,109,La,"Floor 2b (right stair)")).fortress().connect(Mg).chest(Q,30,85),Og=(new Location$$module$js$nodes(c,110,La,"Floor 3a (toward boss)")).fortress().connect(Ng),Md=(new Location$$module$js$nodes(c,
110,La,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$js$nodes(c,110,La,"Boss")).fortress().boss(jd).connect(Md);(new Location$$module$js$nodes(c,110,La,"Floor 3c (back room trap)")).fortress().from(Md).to(fc);const Pg=(new Location$$module$js$nodes(c,112,Ka,"Secret Passage")).cave().connectTo(Hd),Fb=(new Location$$module$js$nodes(c,113,Ka,"Town")).town().connect(Bg),Ca=(new Location$$module$js$nodes(c,114,sa,"Town")).town().connect(Dg),Qg=(new Location$$module$js$nodes(c,115,
sa,"Inside Gate")).overworld().connect(Ca),Rg=(new Location$$module$js$nodes(c,115,sa,"Outside Gate")).overworld().from(Qg,Qa),Gb=(new Location$$module$js$nodes(c,120,Ua,"Valley")).overworld().connect(Rg),gc=(new Location$$module$js$nodes(c,124,G,"Entrance")).overworld().connect(Gb),Sg=(new Location$$module$js$nodes(c,124,G,"Over first river toward Shyron")).overworld().connect(gc,z),Nd=(new Location$$module$js$nodes(c,124,G,"After first tunnel")).overworld(),Od=(new Location$$module$js$nodes(c,124,
G,"Door to Styx")).overworld().connect(Nd,z),Tg=(new Location$$module$js$nodes(c,124,G,"Dead end (no item)")).overworld(),Ug=(new Location$$module$js$nodes(c,124,G,"Dead end (fruit of lime)")).overworld().chest(Jb,26),Vg=(new Location$$module$js$nodes(c,124,G,"Dead end (magic ring)")).overworld().chest(qa,25,101),Pd=(new Location$$module$js$nodes(c,124,G,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(c,124,G,"Floating island (bow of sun)")).overworld().connect(Pd,K).chest(Cc,
24);const Wg=(new Location$$module$js$nodes(c,125,G,"Tunnel 1 (to Shyron)")).cave().connect(Sg),Xg=(new Location$$module$js$nodes(c,126,G,"Outside Shyron")).overworld().connect(Wg);(new Location$$module$js$nodes(c,127,G,"Tunnel 2 (fork)")).cave().connect(gc).connectTo(Ug).connectTo(Nd);const Qd=(new Location$$module$js$nodes(c,128,G,"Tunnel 3 (caves)")).cave().connect(Od).connect(Tg),Rd=(new Location$$module$js$nodes(c,129,G,"Tunnel 4 (left branch of cave)")).cave().connect(Qd);(new Location$$module$js$nodes(c,
130,G,"Tunnel 5 (dead end, medical herb)")).cave().connect(Rd).chest(Q,15,86);const Yg=(new Location$$module$js$nodes(c,131,G,"Tunnel 6a (left-then-right)")).cave().connect(Rd),Zg=(new Location$$module$js$nodes(c,131,G,"Tunnel 6b (past wall)")).cave().connect(Yg,D),$g=(new Location$$module$js$nodes(c,132,G,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,G,"Tunnel 8 (red slimes)")).cave().from($g,D).connectTo(Pd).chest(ba,23,116);const ah=(new Location$$module$js$nodes(c,
134,G,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Qd),bh=(new Location$$module$js$nodes(c,135,G,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,135,G,"Tunnel 10b (past wall)")).cave().connect(bh,D).connectTo(Vg);const Sd=(new Location$$module$js$nodes(c,136,Ta,"Entrance")).fortress().from(Od,uc,Xb),ch=(new Location$$module$js$nodes(c,137,Ta,"Left branch")).fortress().connect(Sd).chest(ba,19,117),dh=(new Location$$module$js$nodes(c,137,Ta,"Left branch, past one bridge")).fortress().connect(ch,
z),eh=(new Location$$module$js$nodes(c,137,Ta,"Left branch, past two bridges")).fortress().connect(dh,z).chest(Q,29,87),fh=(new Location$$module$js$nodes(c,137,Ta,"Right branch")).fortress().connect(Sd);(new Location$$module$js$nodes(c,137,Ta,"Right branch, across water")).fortress().connect(fh,K).chest(ba,20,118).chest(ba,21,119).chest(Pa,28);(new Location$$module$js$nodes(c,138,Ta,"Upper floor")).fortress().connect(eh).chest(H,27);const gb=(new Location$$module$js$nodes(c,140,Ma,"Town")).town().connect(Xg,
Re).trigger(Wb),pb=(new Location$$module$js$nodes(c,142,Ua,"Town")).town().connect(Gb),Td=(new Location$$module$js$nodes(c,143,S,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,S,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Td,Ya).chest(fe,15);const hc=(new Location$$module$js$nodes(c,144,Ua,"Desert 1")).overworld().connect(Gb),Hb=(new Location$$module$js$nodes(c,145,S,"Area 1 (from entrance)")).cave().chest(rc,26),Ud=(new Location$$module$js$nodes(c,
145,S,"Area 2 (across top bridge)")).cave().connect(Hb,z);(new Location$$module$js$nodes(c,145,S,"Area 3 (dead-end across top-right bridge)")).cave().connect(Ud,z);const gh=(new Location$$module$js$nodes(c,145,S,"Area 4 (left across middle-right bridge)")).cave().connect(Ud,z),hh=(new Location$$module$js$nodes(c,145,S,"Area 5 (bottom edge)")).cave().connect(gh,z),ih=(new Location$$module$js$nodes(c,145,S,"Area 6 (bottom island)")).cave().connect(hh,z),jh=(new Location$$module$js$nodes(c,145,S,"Area 7 (bottom inner ring)")).cave().connect(ih,
z),kh=(new Location$$module$js$nodes(c,145,S,"Area 8 (left outer ring)")).cave().connect(jh,z).connect(Hb,z).chest(aa,27,100),lh=(new Location$$module$js$nodes(c,145,S,"Area 9 (top left inner ring)")).cave().connect(kh,z),mh=(new Location$$module$js$nodes(c,145,S,"Area 10 (top right inner ring)")).cave().connect(lh,z);(new Location$$module$js$nodes(c,145,S,"Area 11 (center)")).cave().connect(mh,z).connectTo(Td);(new Location$$module$js$nodes(c,145,S,"Area 12 (top center islands)")).cave().connect(Hb,
K).chest(de,28);const nh=(new Location$$module$js$nodes(c,146,ua,"Desert Cave 1")).cave().connect(hc,K),hb=(new Location$$module$js$nodes(c,147,ua,"Town")).town(),oh=(new Location$$module$js$nodes(c,148,ua,"Outside Cave")).overworld().connect(hb),ph=(new Location$$module$js$nodes(c,149,ua,"Desert Cave 2")).cave().connect(oh);(new Location$$module$js$nodes(c,150,ua,"Meadow")).overworld().connect(nh).connectTo(hb).trigger(Be,Qa,Ze);const ic=(new Location$$module$js$nodes(c,152,ua,"Desert 2")).overworld().connect(ph),
qh=(new Location$$module$js$nodes(c,156,cb,"Entrance")).fortress().connect(ic,K),rh=(new Location$$module$js$nodes(c,156,cb,"Azteca")).fortress().trigger(De),sh=(new Location$$module$js$nodes(c,157,cb,"Fork")).fortress().connect(qh),Vd=(new Location$$module$js$nodes(c,158,cb,"Main")).fortress().connect(sh);(new Location$$module$js$nodes(c,158,cb,"Treasure Chest (magic ring)")).fortress().connect(Vd).chest(qa,27,108);(new Location$$module$js$nodes(c,159,cb,"Draygon")).fortress().connect(Vd).to(rh).boss(jf);
const th=(new Location$$module$js$nodes(c,160,Aa,"Entrance")).fortress().connect(ic,K),uh=(new Location$$module$js$nodes(c,160,Aa,"Statues")).fortress().connect(th).boss(kf),vh=(new Location$$module$js$nodes(c,161,Aa,"Hall 1")).fortress().connect(uh),jc=(new Location$$module$js$nodes(c,162,Aa,"Branch")).fortress().connect(vh);(new Location$$module$js$nodes(c,163,Aa,"Left Dead End")).fortress().connect(jc).chest(ba,13,120);(new Location$$module$js$nodes(c,164,Aa,"Right Dead End")).fortress().connect(jc);
const wh=(new Location$$module$js$nodes(c,165,Aa,"Hall 2")).fortress().connect(jc).chest(Lb,26,109),xh=(new Location$$module$js$nodes(c,166,Aa,"Draygon 2")).fortress().connect(wh).boss(lf);(new Location$$module$js$nodes(c,167,Aa,"Teleporter")).fortress().from(xh).to(Fd);const Wd=(new Location$$module$js$nodes(c,168,yb,"Entrance")).fortress().connect(pb,Xb).trigger(Zc,H),yh=(new Location$$module$js$nodes(c,169,yb,"Main")).fortress().from(Wd,Ya),zh=(new Location$$module$js$nodes(c,169,yb,"Boss")).fortress().connect(yh).boss(ef),
Ah=(new Location$$module$js$nodes(c,170,yb,"Zebu")).fortress().connect(zh),Ib=(new Location$$module$js$nodes(c,171,ta,"Entrance")).fortress().connect(Ah);(new Location$$module$js$nodes(c,171,ta,"Dead End Behind Iron (fruit of power)")).fortress().connect(Ib,Ya).chest(aa,28,98);(new Location$$module$js$nodes(c,171,ta,"Dead End Loop Across Closer Bridges")).fortress().connect(Ib,z).connect(Ib,z);const Bh=(new Location$$module$js$nodes(c,171,ta,"Across First Bridge (fruit of repun)")).fortress().connect(Ib,
z).chest(Kb,30,102),kc=(new Location$$module$js$nodes(c,171,ta,"Across Second Bridge")).fortress().connect(Bh,z);(new Location$$module$js$nodes(c,171,ta,"Dead End Across Two Bridges ()")).fortress().connect(kc,z).connect(kc,z).chest(Xa,29,93);const Ch=(new Location$$module$js$nodes(c,171,ta,"Across Third Bridge")).fortress().connect(kc,z),Dh=(new Location$$module$js$nodes(c,171,ta,"Exit Behind Iron Door")).fortress().connect(Ch,Ya),Eh=(new Location$$module$js$nodes(c,172,ta,"Boss")).fortress().connect(Dh).boss(ff),
Fh=(new Location$$module$js$nodes(c,172,ta,"Tornel")).fortress().connect(Eh),Xd=(new Location$$module$js$nodes(c,173,bb,"Lower")).fortress().connect(Fh).chest(Lb,26,99).chest(qa,27,111),Gh=(new Location$$module$js$nodes(c,174,bb,"Upper Loop")).fortress().connect(Xd).chest(Y,22,96);(new Location$$module$js$nodes(c,174,bb,"Upper Loop Behind Wall (magic ring)")).fortress().connect(Gh,Ya).chest(qa,23,107);const Hh=(new Location$$module$js$nodes(c,175,bb,"Upper Passage (toward Mado)")).fortress().connect(Xd).chest(qa,
27,84),lc=(new Location$$module$js$nodes(c,176,ca,"Initial Fork")).fortress(),Ih=(new Location$$module$js$nodes(c,177,ca,"Left Branch")).fortress().connect(lc),Yd=(new Location$$module$js$nodes(c,178,ca,"Main Area (right branch, over bridges)")).fortress().connect(lc),Jh=(new Location$$module$js$nodes(c,179,ca,"U-shaped Passage (between floors)")).fortress().connect(Yd),Kh=(new Location$$module$js$nodes(c,180,ca,"Main Area Lower (under bridge)")).fortress().connect(Ih).connect(Yd).connect(Jh),Zd=
(new Location$$module$js$nodes(c,180,ca,"Behind Iron Wall")).fortress().connect(Kh,Ya),Lh=(new Location$$module$js$nodes(c,181,ca,"Lower")).fortress().connect(Zd).chest(ba,13,121).chest(ba,14,122).chest(ba,15,123).chest(qa,23,88).chest(fa,24,110),Mh=(new Location$$module$js$nodes(c,182,ca,"Boss Corridor")).fortress().connect(Lh),Nh=(new Location$$module$js$nodes(c,182,ca,"Boss")).fortress().connect(Mh,Xb).boss(hf);(new Location$$module$js$nodes(c,182,ca,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(xa,
18);const $d=(new Location$$module$js$nodes(c,183,ca,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,184,S,"Entrance Back (behind river)")).cave().connect($d).chest(aa,13,90);(new Location$$module$js$nodes(c,184,S,"Entrance Front")).cave().connect(Oh,K).connectTo(hc).connectTo(Hb);const Ph=(new Location$$module$js$nodes(c,185,bb,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$js$nodes(c,185,bb,"Asina")).fortress().connect(Ph).connectTo(lc);(new Location$$module$js$nodes(c,
186,ca,"Kensu")).fortress().connect(Zd).connectTo($d).trigger(Ae,Rb);(new Location$$module$js$nodes(c,187,Ua,"House")).house().connect(pb).trigger(Ce,Qa,Rb);(new Location$$module$js$nodes(c,188,Ua,"Inn")).shop().connect(pb,Wb);(new Location$$module$js$nodes(c,190,Ua,"Tool Shop")).shop(Q,Y,fa,aa).connect(pb,Wb);(new Location$$module$js$nodes(c,191,Ua,"Tavern")).shop().connect(pb);(new Location$$module$js$nodes(c,192,ra,"Elder House")).house().connect(Na).trigger(Gc);(new Location$$module$js$nodes(c,
193,ra,"Rabbit Hut")).house().connect(Na).trigger(Mc,Lc,Ga);(new Location$$module$js$nodes(c,194,ra,"Inn")).shop().connect(Na);(new Location$$module$js$nodes(c,195,ra,"Tool Shop")).shop(Q,Y,fa,aa).connect(Na);(new Location$$module$js$nodes(c,196,ra,"Armor Shop")).shop(Fa,ya).connect(Na);(new Location$$module$js$nodes(c,197,ra,"Student House")).house().connect(Na).trigger(Hc);(new Location$$module$js$nodes(c,198,$a,"Tavern")).house().connect(ob);(new Location$$module$js$nodes(c,199,$a,"Pawn Shop")).shop().connect(ob);
(new Location$$module$js$nodes(c,200,$a,"Inn")).shop().connect(ob);(new Location$$module$js$nodes(c,201,$a,"Armor Shop")).shop(ae,ya,w).connect(ob);(new Location$$module$js$nodes(c,203,$a,"Tool Shop")).shop(Q,Y,fa).connect(ob);(new Location$$module$js$nodes(c,205,mb,"Elder House")).house().from(Ab,Ga).trigger(pe,Tb);(new Location$$module$js$nodes(c,206,mb,"Mother's House")).house().from(Ab,Ga).trigger(Kc,Ga).trigger(oe,Tb);(new Location$$module$js$nodes(c,207,mb,"Tool Shop")).shop(Q,Y,aa).from(Ab,
Ga);(new Location$$module$js$nodes(c,208,mb,"Inn")).shop().from(Ab,Ga);(new Location$$module$js$nodes(c,209,ab,"Inn")).shop().connect(zb);(new Location$$module$js$nodes(c,210,ab,"Tool Shop")).shop(fa,aa,Xa).connect(zb);(new Location$$module$js$nodes(c,211,ab,"Armor Shop")).shop(nc,qb,F,R).connect(zb);const Qh=(new Location$$module$js$nodes(c,212,ab,"Queen's House")).house().from(zb,Se).trigger(ye,Qa,Ac);(new Location$$module$js$nodes(c,213,xb,"Nadare's")).house().connect(Bb).connectTo(Yf).connectTo(Zf).connectTo($f);
(new Location$$module$js$nodes(c,214,I,"Fisherman's House")).house().connect(Dd).trigger(Ub,vc,Qb,Te);const mc=(new Location$$module$js$nodes(c,215,I,"Palace Entrance")).house().connect(Va);(new Location$$module$js$nodes(c,216,I,"Fortune Teller Front")).house().connect(Va).trigger(Oc,Nc);(new Location$$module$js$nodes(c,216,I,"Fortune Teller Back")).house().connect(Eg).connect(Id);(new Location$$module$js$nodes(c,217,I,"Pawn Shop")).shop().connect(Va);(new Location$$module$js$nodes(c,218,I,"Armor Shop")).shop(be,
nc,qb).connect(Va);(new Location$$module$js$nodes(c,220,I,"Inn")).shop().connect(Va);(new Location$$module$js$nodes(c,221,I,"Tool Shop")).shop(Q,Xa,Jb,fa).connect(Va);(new Location$$module$js$nodes(c,222,I,"Palace Left")).house().connect(mc);(new Location$$module$js$nodes(c,223,I,"Palace Throne Room")).house().connect(mc).to(Eb,Me).from(Eb).trigger(Nc).trigger(se,Oc,Pc);(new Location$$module$js$nodes(c,224,I,"Palace Right")).house().connect(mc);(new Location$$module$js$nodes(c,225,I,"Asina's Room")).house().connect(Jd).trigger(Sc,
bd);(new Location$$module$js$nodes(c,226,ab,"Queen Downstairs")).house().connect(Qh).chest(da,13);(new Location$$module$js$nodes(c,227,Ka,"Elder's House")).house().connect(Fb).trigger(Vc);(new Location$$module$js$nodes(c,228,Ka,"Shed")).house().connect(Fb).to(Pg,wc);(new Location$$module$js$nodes(c,229,Ka,"Tool Shop")).shop(Q,Y,aa,Xa).connect(Fb);(new Location$$module$js$nodes(c,231,Ka,"Inn")).shop().connect(Fb);const Rh=(new Location$$module$js$nodes(c,232,W,"Zombie Town House")).house().connect(ec);
(new Location$$module$js$nodes(c,233,W,"Zombie Town Basement")).house().connect(Rh).trigger(ue,jd);(new Location$$module$js$nodes(c,235,sa,"Tool Shop")).shop(Q,Y,aa,fa).connect(Ca);(new Location$$module$js$nodes(c,236,sa,"Stom's Hut")).house().connect(Ca).trigger(Wc);(new Location$$module$js$nodes(c,237,sa,"Inn")).shop().connect(Ca);(new Location$$module$js$nodes(c,238,sa,"Armor Shop")).shop(ce,oc,Z,ea).connect(Ca);(new Location$$module$js$nodes(c,239,sa,"Tavern")).house().connect(Ca).trigger(Xc,
Wc,kb);(new Location$$module$js$nodes(c,240,sa,"Pawn Shop")).shop().connect(Ca);(new Location$$module$js$nodes(c,241,sa,"Dance Hall")).house().connect(Ca).trigger(Yc,Xc,kb).trigger(xe,Yc,zc);const Sh=(new Location$$module$js$nodes(c,242,Ma,"Temple (pre-massacre)")).fortress().connect(gb).from(Yb,H,Da).trigger(ze);(new Location$$module$js$nodes(c,242,Ma,"Temple (post-massacre)")).fortress().from(Sh,Zc).boss(df);(new Location$$module$js$nodes(c,243,Ma,"Training Hall")).house().connect(gb);(new Location$$module$js$nodes(c,
244,Ma,"Hospital")).house().connect(gb);(new Location$$module$js$nodes(c,245,Ma,"Armor Shop")).shop(oc,R,ea).connect(gb);(new Location$$module$js$nodes(c,246,Ma,"Tool Shop")).shop(Q,Y,Jb,qa).connect(gb);(new Location$$module$js$nodes(c,247,Ma,"Inn")).shop().connect(gb);(new Location$$module$js$nodes(c,248,ua,"Inn")).shop().connect(hb);(new Location$$module$js$nodes(c,249,ua,"Tool Shop")).shop(Y,fa,Kb,qa).connect(hb);(new Location$$module$js$nodes(c,250,ua,"Elder's House")).house().connect(hb);(new Location$$module$js$nodes(c,
251,ua,"Pawn Shop")).house().connect(hb);const Th=[Na,nb,ld,db,Zb,eb,bc,xd,dc,Ca,Gb,gc,hc,Wd,ic];for(const a of Th)a.from(Yb,He);return c},shuffle$$module$js$depgraph=(a,b,c,d,e)=>{d=void 0===d?new FlagSet$$module$js$flagset("Sbkm Sct"):d;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d,a);d.shuffleShops()&&f.shuffleShops(b);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);var h={};for(var k of g)if(k instanceof
...
Oak:c,Shyron_ToolShop:d},flags:{AbleToRideDolphin:e,BallOfFire:f,BallOfThunder:g,BallOfWater:h,BallOfWind:k,Barrier:m,BlizzardBracelet:l,BowOfMoon:n,BowOfSun:p,BreakStone:q,BreakIce:r,BreakIron:x,BrokenStatue:v,BuyHealing:y,BuyWarp:C,ClimbWaterfall:B,ClimbSlope8:u,ClimbSlope9:t,CurrentlyRidingDolphin:T,Flight:O,FlameBracelet:ib,FormBridge:U,GasMask:va,GlowingLamp:Da,LeadingChild:Wa,LeatherBoots:Oa,Money:X,OpenedCrypt:jb,RabbitBoots:ka,Refresh:la,RepairedStatue:J,RescuedChild:P,ShellFlute:N,ShieldRing:H,
ShootingStatue:ma,StormBracelet:wa,Sword:V,SwordOfFire:na,SwordOfThunder:oa,SwordOfWater:pa,SwordOfWind:da,TornadoBracelet:Ea,TravelSwamp:xa,WildWarp:ya},items:{MedicalHerb:w,WarpBoots:qb}}=this.rom,F=this.entrance(b);var Z=this.entrance(c);this.addCheck([F],and$$module$js$logic$world(n,p),[jb.id]);this.addCheck([F],and$$module$js$logic$world(e,N),[T.id]);this.addCheck([Z],and$$module$js$logic$world(Wa),[P.id]);this.addItemCheck([F],and$$module$js$logic$world(Da,v),J.id,{lossy:!0,unique:!0});for(var R of this.rom.shops)if(R.location!==
a.id&&R.location!==d.id&&R.used&&R.type===module$js$rom$shop.ShopType.TOOL){Z=[module$js$logic$tileid.TileId(R.location<<16|136)];for(var ea of R.contents)ea===w.id?this.addCheck(Z,X.r,[y.id]):ea===qb.id&&this.addCheck(Z,X.r,[C.id])}R=da.r;ea=na.r;Z=pa.r;let Pa=oa.r;if(!this.flagset.orbsOptional()){var Fa=or$$module$js$logic$world(k,Ea);const a=or$$module$js$logic$world(f,ib),b=or$$module$js$logic$world(h,l),c=or$$module$js$logic$world(g,wa);R=module$js$logic$requirement.Requirement.meet(R,Fa);ea=
module$js$logic$requirement.Requirement.meet(ea,a);Z=module$js$logic$requirement.Requirement.meet(Z,b);Pa=module$js$logic$requirement.Requirement.meet(Pa,c);if(this.flagset.assumeSwordChargeGlitch()){Fa=function(b){return a.map((a)=>a[0]===b.c?a:[b.c,...a])};const a=module$js$logic$requirement.Requirement.or(R,ea,Z,Pa);R=Fa(da);ea=Fa(na);Z=Fa(pa);Pa=Fa(oa)}}this.addCheck([F],R,[q.id]);this.addCheck([F],ea,[r.id]);this.addCheck([F],Z,[U.id]);this.addCheck([F],Pa,[x.id]);this.addCheck([F],or$$module$js$logic$world(da,
na,pa,oa),[V.id,X.id]);this.addCheck([F],O.r,[B.id]);this.addCheck([F],or$$module$js$logic$world(O,ka),[u.id]);this.addCheck([F],or$$module$js$logic$world(O,ka),[t.id]);this.addCheck([F],m.r,[ma.id]);this.addCheck([F],va.r,[xa.id]);this.flagset.leatherBootsGiveSpeed()&&this.addCheck([F],Oa.r,[u.id]);this.flagset.assumeGhettoFlight()&&this.addCheck([F],and$$module$js$logic$world(T,ka),[B.id]);this.flagset.fogLampNotRequired()&&this.addCheck([F],N.r,[e.id]);this.flagset.guaranteeBarrier()||this.addCheck([F],
[[X.c,y.c],[X.c,H.c],[X.c,la.c]],[ma.id]);this.flagset.assumeFlightStatueSkip()||this.addCheck([F],[[X.c,O.c]],[ma.id]);this.flagset.guaranteeGasMask()||this.addCheck([F],[[X.c,y.c],[X.c,la.c]],[xa.id]);this.flagset.assumeWildWarp()&&this.addCheck([F],module$js$logic$requirement.Requirement.OPEN,[ya.id])}addExtraRoutes(){const {flags:{BuyWarp:a,SwordOfThunder:b,Teleport:c,WildWarp:d},locations:{MezameShrine:e}}=this.rom;this.addRoute(new Route$$module$js$logic$requirement(this.entrance(e),[]));if(this.flagset.teleportOnThunderSword()){const d=
this.rom.townWarp.thunderSwordWarp;this.addRoute(new Route$$module$js$logic$requirement(this.entrance(d[0],d[1]&31),[b.c,a.c]));this.addRoute(new Route$$module$js$logic$requirement(this.entrance(d[0],d[1]&31),[b.c,c.c]))}if(this.flagset.assumeWildWarp())for(const a of this.rom.wildWarp.locations)a!==this.rom.locations.UndergroundChannel.id&&this.addRoute(new Route$$module$js$logic$requirement(this.entrance(a),[d.c]))}consolidateChecks(){for(const [a,b]of this.checks){const c=this.tiles.find(a);if(a!==
c){for(const a of b)this.checks.get(c).add(a);this.checks.delete(a)}}}buildRequirementMap(){for(const [c,d]of this.checks)for(const {checks:e,requirement:f}of d)for(var a of e){var b=this.requirementMap.get(a);for(const a of f)for(const d of this.routes.get(c)||[])b.addList([...a,...d])}if(DEBUG$$module$js$logic$world){a=[];for(const [c,d]of this.requirementMap){b=(a)=>this.rom.flags[a].name;for(const e of d)a.push(`${b(c)}: ${[...e].map(b).join(" & ")}\n`)}a.sort((a,b)=>a<b?-1:a>b?1:0);console.log(a.join(""))}}getLocationList(a=
"Crystalis"){const b=DEBUG$$module$js$logic$world?(a)=>a.debug:(a)=>a.name;return{worldName:a,requirements:this.requirementMap,items:this.items,slots:this.slots,checkName:(a)=>b(this.rom.flags[a]),prefill:(a)=>{const {Crystalis:b,MesiaInTower:c,LeafElder:f}=this.rom.flags,g=new Map([[c.id,b.id]]);this.flagset.guaranteeSword()&&g.set(f.id,512|a.nextInt(4));return g}}}processLocation(a){a.used&&(this.processLocationTiles(a),this.processLocationSpawns(a),this.processLocationItemUses(a))}unionNeighbors(){for(const [b,
c]of this.terrains){var a=module$js$logic$tileid.TileId.add(b,0,1);this.terrains.get(a)===c&&this.tiles.union([b,a]);a=module$js$logic$tileid.TileId.add(b,1,0);this.terrains.get(a)===c&&this.tiles.union([b,a])}}addAllRoutes(){this.addExtraRoutes();for(const [b,c]of this.neighbors){const [d,e]=module$js$logic$tilepair.TilePair.split(b);var a=this.terrains.get(d);const f=this.terrains.get(e);if(!a||!f)throw Error(`missing terrain ${hex$$module$js$rom$util(a?d:e)}`);for(const [b,h]of a.exit)if(b&c)for(const a of h)for(const b of f.enter)this.addRoute(new Route$$module$js$logic$requirement(e,
[...a,...b]),d)}"object"===typeof document&&(a=document.getElementById("debug"))&&a.appendChild((new Area$$module$js$spoiler$area(this.rom,this.getWorldData())).element)}getWorldData(){var a=0;const b=new DefaultMap$$module$js$util(()=>({})),c=seq$$module$js$rom$util(256,()=>({areas:new Set,tiles:new Set})),d=[];for(var e of this.tiles.sets()){var f=this.tiles.find(module$js$util.iters.first(e)),g=this.terrains.get(f);if(g&&(f=this.routes.has(f)?module$js$logic$requirement.Requirement.freeze(this.routes.get(f)):
[],f.length)){g={checks:[],id:a++,locations:new Set,routes:f,terrain:g,tiles:new Set};d.push(g);for(const a of e)f=a>>>16,g.locations.add(f),g.tiles.add(a),c[f].areas.add(g),c[f].tiles.add(a),b.get(a).area=g}}for(const [a,c]of this.exits)b.has(a)&&(b.get(a).exit=c);for(const [c,d]of this.checks)if(a=b.get(c).area)for(const {checks:b,requirement:c}of d)for(const d of b)e=this.rom.flags[d]||die$$module$js$assert(),a.checks.push([e,c]);return{tiles:b,areas:d,locations:c}}addRoute(a,b){if(null!=b){this.routeEdges.get(b).add(a);
for(var c of this.routes.get(b))this.addRoute(new Route$$module$js$logic$requirement(a.target,[...c,...a.deps]))}else for(b=new LabeledSet$$module$js$util,c=new LabeledSet$$module$js$util,b.add(a),a=b[Symbol.iterator]();;){const {value:d,done:e}=a.next();if(e)break;c.add(d);b.delete(d);const f=new LabeledSet$$module$js$util,g=d.target;if(this.routes.get(g).addRoute(d))for(const a of this.routeEdges.get(g))f.add(new Route$$module$js$logic$requirement(a.target,[...d.deps,...a.deps]));for(const a of f)c.has(a)||
...
var t=BITCOUNT$$module$js$maze$spec[q]+(m.has(B)?1:0);154===u&&(t=2);if(155===u||156==u||240==u||241==u)t=1;1===t&&c++;2<t&&(d+=t-2);t=this.walls.get(u);"wall"===t&&e++;"bridge"===t&&f++;t=this.fixedTiles.get(u);this.deadEndTiles.has(u)&&(q=0);for(var T of module$js$maze$types.Dir.ALL)if(q&y&1<<T){u=null;for(var O=0;O<a.entrances.length;O++)if(a.entrances[O].screen===B&&matchesDir$$module$js$maze$spec(a.entrances[O].tile,T)){u=O;break}if(null!=u){O=x.get(u);if(null==O)throw Error("Could not find exit");
l.set(B,{entrance:u,exit:O,dir:T})}}null!=t&&n.set(B,t)}if(g)for(const [a,b]of n)29046===b.edges&&(T=q.find((a)=>459009===a.edges))&&n.set(a,T);if(h!=k)throw Error("Found inconsistent use of wide tiles");return{size:b,rivers:g,deadEnds:c,branches:d,walls:e,bridges:f,stairs:m,edges:l,fixed:n,tiles:p,wide:h,specs:q,specSet:this}}}SpecSet$$module$js$maze$spec.CAVE=new SpecSet$$module$js$maze$spec(ALL_CAVE_SCREENS$$module$js$maze$spec,EMPTY_CAVE_SCREEN$$module$js$maze$spec);
...
b.teleportOnThunderSword()?(teleportOnThunderSword$$module$js$pass$deterministic(a),a.townWarp.thunderSwordWarp=[a.locations.Shyron.id,65]):noTeleportOnThunderSword$$module$js$pass$deterministic(a);undergroundChannelLandBridge$$module$js$pass$deterministic(a);b.fogLampNotRequired()&&fogLampNotRequired$$module$js$pass$deterministic(a);b.addEastCave()?(eastCave$$module$js$pass$deterministic(a,b),b.connectGoaToLeaf()&&connectGoaToLeaf$$module$js$pass$deterministic(a)):b.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$pass$deterministic(a);
...
function fogLampNotRequired$$module$js$pass$deterministic(a){const {flags:{AlwaysTrue:b,FogLamp:c,KensuInCabin:d,ReturnedFogLamp:e},items:{ShellFlute:f},locations:{BoatHouse:g,Portoa_FishermanHouse:h},npcs:k}=a;f.itemUseData[0].want=b.id;k.KensuInCabin.data[0]=103;k.KensuInCabin.localDialogs.get(-1)[0].message.action=10;k.KensuInCabin.localDialogs.get(-1)[0].flags=[];k.KensuInCabin.spawnConditions.set(g.id,[e.id,~d.id]);k.Fisherman.spawnConditions.set(h.id,[c.id]);a.itemGets[100].flags=[];a.itemGets[103].copyFrom(a.itemGets[100])}
function fixChests$$module$js$pass$deterministic(a){for(const b of a.locations)for(const a of b.spawns)a.isChest()&&(a.timed=!1)}function adjustGoaFortressTriggers$$module$js$pass$deterministic(a){a=a.locations;a.GoaFortress_Kelbesque.spawns[0].x-=16;a.GoaFortress_Zebu.spawns.splice(1,1);a.GoaFortress_Tornel.spawns.splice(2,1);a.GoaFortress_Asina.spawns.splice(2,1);a.GoaFortress_Kensu.spawns.splice(3,1);a.GoaFortress_Kensu.spawns.splice(1,1)}
...
function requireHealedDolphin$$module$js$pass$deterministic(a){const {flags:{HealedDolphin:b,ShellFlute:c},npcs:{Fisherman:d,FishermanDaughter:e}}=a;d.spawnConditions.set(214,[c.id,b.id]);a=e.localDialogs.get(-1);a.unshift(a[0].clone());a[0].condition=~b.id;a[1].condition=~c.id}
...
WindmillCave:v,WaterfallCave4:y,WaterfallValleyNorth:C,ZebuCave:B,ZombieTown_HouseBasement:u},items:{GlowingLamp:t,KeyToPrison:T,LovePendant:O,StatueOfOnyx:ib},npcs:{Akahana:U,AkahanaInBrynmaer:va,Asina:Da,AztecaInShyron:Wa,Clark:Oa,Draygon:X,FortuneTeller:jb,Kensu:ka,KensuInCabin:la,KensuInSwan:J,LeafRabbit:P,OakChild:N,OakElder:H,OakMother:ma,PortoaPalaceFrontGuard:wa,PortoaQueen:V,PortoaThroneRoomBackDoorGuard:na,Rage:oa,Stom:pa,StonedAkahana:da,Tornel:Ea,WindmillGuard:xa,Zebu:ya},flags:w}=a;J.link(ka.id);
J.used=!0;J.data=[...ka.data];ka.data[0]=t.id;x.spawns.find((a)=>a.isNpc()&&a.id===ka.id).id=J.id;O.itemUseData[0].want=256|J.id;da.linkDialog(U.id);va.used=!0;va.link(U.id);va.data=[...U.data];f.spawns.find((a)=>a.isNpc()&&a.id===U.id).id=va.id;ib.itemUseData[0].want=256|va.id;P.dialog()[2].condition=w.RescuedLeafElder.id;P.dialog()[2].flags.push(w.TalkedToLeafRabbit.id);P.dialog()[3].flags.push(w.TalkedToLeafRabbit.id);xa.spawns(v)[1]=~w.WindmillGuardAlarmFluteTradein.id;c(U.spawns(y),~w.BehindWhirlpool.id);
c(da.spawns(y),~w.BehindWhirlpool.id);H.dialog()[0].message.action=3;H.dialog()[1].message.action=3;H.dialog()[2].message.action=3;H.dialog()[3].message.action=3;(()=>{const [a,b,c,d]=ma.dialog();d.condition=~w.RescuedChild.id;b.condition=-1;ma.dialog().splice(0,4,d,c,a,b)})();for(const b of[32,33,34,124,125])d(a.npcs[b].dialog());N.dialog().unshift(...N.dialog().splice(1,1));na.spawnConditions.set(l.id,[~w.QueenNotInThroneRoom.id,~w.MesiaRecording.id]);wa.dialog()[1].condition=w.MesiaRecording.id;
V.dialog()[3].condition=w.SwordOfWater.id;V.dialog()[3].message.action=3;V.dialog()[4].flags.push(w.PortoaQueenGoingAway.id);V.spawns(l)[1]=~w.MesiaRecording.id;V.spawns(n)[0]=w.MesiaRecording.id;V.dialog()[1].condition=w.MesiaRecording.id;jb.spawns(p)[1]=~w.MesiaRecording.id;Oa.spawnConditions.set(u.id,[~w.Clark.id]);Oa.spawnConditions.set(h.id,[w.Clark.id]);ya.localDialogs.set(B.id,[LocalDialog$$module$js$rom$npc.of(~w.TalkedToZebuInCave.id,[0,26],[w.TalkedToZebuInCave.id]),LocalDialog$$module$js$rom$npc.of(w.LeafVillagersRescued.id,
[0,29]),LocalDialog$$module$js$rom$npc.of(w.LeafAbduction.id,[0,28]),LocalDialog$$module$js$rom$npc.of(w.ZebuAtWindmill.id,[0,29]),LocalDialog$$module$js$rom$npc.of(w.UsedWindmillKey.id,[0,27,3]),LocalDialog$$module$js$rom$npc.of(-1,[0,29])]);c(ya.spawns(B),~w.BehindWhirlpool.id);Ea.spawnConditions.delete(m.id);pa.spawnConditions.delete(r.id);Da.data[1]=a.items.FluteOfLime.id;Da.dialog(n)[0].message.action=17;Da.dialog(n)[2].message.action=17;c(Da.spawns(n),~w.CalmedAngrySea.id);la.spawnConditions.set(e.id,
[~w.AbleToRideDolphin.id,w.ReturnedFogLamp.id]);la.dialog()[0].message.action=2;Wa.spawns(q).push(~w.ShyronMassacre.id);a.trigger(130).conditions.push(~w.ShyronMassacre.id);oa.dialog()[0].condition=w.SwordOfWater.id;X.spawnConditions.set(g.id,[~w.Draygon2.id]);ya.dialog(q).unshift(...ya.dialog(q).splice(1,1));a.trigger(128).conditions=[~w.ShyronMassacre.id,w.TalkedToZebuInShyron.id,w.SwordOfThunder.id];a.trigger(129).conditions=[];b.barrierRequiresCalmSea()&&a.trigger(132).conditions.push(w.CalmedAngrySea.id);
...
var module$js$rom$item={};module$js$rom$item.Item=Item$$module$js$rom$item;module$js$rom$item.ItemUse=ItemUse$$module$js$rom$item;module$js$rom$item.Items=Items$$module$js$rom$item;function shuffleTrades$$module$js$pass$shuffletrades(a,b,c){if(b.randomizeTrades()){var {StatueOfOnyx:d,FogLamp:e,LovePendant:f,KirisaPlant:g,IvoryStatue:h}=a.items,k=new Map;b=[[d,0,"Akahana"],[e,0,"Fisherman"],[f,0,"Kensu"],[g,0,"Aryllis"],[h,0,"Slimed Kensu"]];var m=b.map(([a,b,c])=>{if(0>a.trades.indexOf(b)||b>=a.itemUseData.length)throw Error(`not a trade: ${a} ${b}`);return[a.itemUseData[b],a.id,c]});c.shuffle(m);for(const [c,d]of b){const [b,e,f]=m.pop();c.itemUseData[d]=b;a.spoiler&&a.spoiler.addTrade(c.id,
c.messageName,f);291===b.want?a.prg[251061]=c.id-28:356===b.want&&([...a.npcs[100].spawnConditions.values()][0][0]=512|c.id);k.set(e,c.id)}a.itemGets.actionGrants=new Map([...a.itemGets.actionGrants].map(([a,b])=>{var c;return[(c=k.get(a),null!==c&&void 0!==c?c:a),b]}));b=a.items[c.nextInt(4)];a.npcs[195].localDialogs.get(-1)[0].condition=512|b.id;a.spoiler&&a.spoiler.addTrade(b.id,b.messageName,"Rage");a.npcs[56].localDialogs.get(-1)[3].condition=512|b.id;c=a.items[2*c.nextInt(4)+6];for(const d of a.npcs[95].localDialogs.values())for(b=
2;b<d.length;b++)if(3===d[b].message.action){d[b-2].condition=~(512|c.id-1);d[b-1].condition=~(512|c.id);a.spoiler&&a.spoiler.addTrade(c.id,c.messageName,"Tornel");break}}}function buildTradeInMap$$module$js$pass$shuffletrades(a){const b=new Map;for(const c of a.items)for(const a of c.trades)b.set(c.itemUseData[a].want&255,c.id);return b}var module$js$pass$shuffletrades={};module$js$pass$shuffletrades.shuffleTrades=shuffleTrades$$module$js$pass$shuffletrades;
