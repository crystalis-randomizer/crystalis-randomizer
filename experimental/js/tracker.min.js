...
descr:"Full shuffle but with no glitches.",flags:"Em Fcpstw Mert Ps Rprt Sckmt Tab Wmtuw"},{title:"Advanced",descr:"A balanced randomization with quite a bit more difficulty.",flags:"Fsw Gfprt Hbdgw Mert Ps Roprst Sckt Sm Tabmp Wmtuw"},{title:"Ludicrous",descr:"Pulls out all the stops, may require superhuman feats.",flags:"Fs Gcfprtw Hbdgmswxz Mert Ps Roprst Sckmt Tabmp Wmtuw"}],PRESETS_BY_KEY$$module$js$flagset={};
...
a.assumeGhettoFlight())),m=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),r=h(d("Assume teleport skip",a.assumeTeleportSkip())),p=d("Allow teleport skip",!a.disableTeleportSkip()),q=h(d("Assume rabbit skip",a.assumeRabbitSkip())),u=h(d("Allow rabbit skip",!a.disableRabbitSkip())),t=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),z=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),y=h(d("Assume wild warp",a.assumeWildWarp())),
v=d("Allow wild warp",a.allowWildWarp()),w=d("Sword magic optional",!a.guaranteeSwordMagic()),K=d("Matching sword optional",!a.guaranteeMatchingSword()),Qa=d("Gas mask optional",!a.guaranteeGasMask()),Pd=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),Qd=d("Calm sea optional",!a.barrierRequiresCalmSea()),Rd=d("Prison key optional",!a.paralysisRequiresPrisonKey()),Sd=d("Windmill optional",!a.sealedCaveRequiresWindmill()),Td=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
...
27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),I=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),N=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),wa=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),rb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),P=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),Y=(new Item$$module$js$nodes(c,
...
68,"Teleport")).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),je=(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),tc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),qa=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),F=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=P.bossDrop("Vampire 2",
...
Nc=new Trigger$$module$js$nodes(c,"Shyron Massacre"),Ae=(new Trigger$$module$js$nodes(c,"Saved Kensu")).get(F),Be=(new Trigger$$module$js$nodes(c,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$js$nodes(c,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(c,"Get Bow of Truth")).get(rc),Ee=(new Trigger$$module$js$nodes(c,"Forged Crystalis")).get(pb),$a=(new Condition$$module$js$nodes(c,"Sword charge glitch")).option(t,z),Fe=(new Condition$$module$js$nodes(c,"Rabbit skip")).option(q,
u),Ge=(new Condition$$module$js$nodes(c,"Teleport skip")).option(r,p),ab=(new Condition$$module$js$nodes(c,"Statue glitch")).option(m,n),He=(new Condition$$module$js$nodes(c,"Wild warp")).option(y,v),bb=(new Condition$$module$js$nodes(c,"Any level 2 sword")).option(S,Ia).option(S,Ja).option(T,Sa).option(T,Ta).option(O,Ua).option(O,Va).option(M,Wa).option(M,Xa),B=(new Condition$$module$js$nodes(c,"Destroy stone")).option(S,Ra).option(S,Ia).option(S,Ja).option($a,S,bb),C=(new Condition$$module$js$nodes(c,
"Destroy ice")).option(T,Ra).option(T,Sa).option(T,Ta).option($a,T,bb),x=(new Condition$$module$js$nodes(c,"Cross rivers")).option(O,Ra).option(O,Ua).option(O,Va).option(F).option($a,O,bb),xa=(new Condition$$module$js$nodes(c,"Destroy iron")).option(M,Ra).option(M,Wa).option(M,Xa).option($a,M,bb),V=(new Condition$$module$js$nodes(c,"Any sword")).option(S).option(T).option(O).option(M),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(T).option(O).option(M).option(Ya,
K.value?K:g,S),Je=(new Condition$$module$js$nodes(c,"Match vampire 2 sword (wind/water/thunder)")).option(S).option(O).option(M).option(K.value?K:g,T),Oc=(new Condition$$module$js$nodes(c,"Speed boots")).option(fc,k),Pc=(new Condition$$module$js$nodes(c,"Climb slopes")).option(vb).option(F).option(Oc),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Ac).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(sc).option(Ge,F),Qc=(new Condition$$module$js$nodes(c,
"Asina in her room")).option(Fc),Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(Ka).option(Qc).option(ab),Rc=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(yb,Ic),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(l,Rc,vb),da=(new Condition$$module$js$nodes(c,"Cross sea")).option(Rc).option(F),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Db).option(F).option(Ne),W=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(Xb.value?
...
xc);const Ea=(new Location$$module$js$nodes(c,32,G,"Entrance")).overworld().connect(Da).connect(Af),Df=(new Location$$module$js$nodes(c,32,G,"Up Slope")).overworld().from(Ea,Pc).to(Ea),Ef=(new Location$$module$js$nodes(c,32,G,"Dead End (warp boots)")).overworld().chest(U,24,106),cd=(new Location$$module$js$nodes(c,33,G,"Upper")).overworld().from(Ea,F).to(Ea),Ff=(new Location$$module$js$nodes(c,33,G,"Tornel Dead End")).overworld().trigger(qe,Ia,Ja).chest(Y,23,105),dd=(new Location$$module$js$nodes(c,
34,G,"Tunnel 2a (fork at start)")).cave().connect(Ea);(new Location$$module$js$nodes(c,34,G,"Tunnel 2b (left branch to dead end)")).cave().connect(dd,C).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,G,"Tunnel 2c (right branch to upper)")).cave().connect(dd,C),Hf=(new Location$$module$js$nodes(c,35,G,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(I,23,82),If=(new Location$$module$js$nodes(c,35,G,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,
C).connectTo(cd),ed=(new Location$$module$js$nodes(c,36,G,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,G,"Tunnel 4b (out to upper)")).cave().connect(ed,C).connectTo(cd);const Jf=(new Location$$module$js$nodes(c,37,G,"Tunnel 5 (tiny connector)")).cave().connect(ed),Kf=(new Location$$module$js$nodes(c,38,G,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);(new Location$$module$js$nodes(c,38,G,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,
C).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,G,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,G,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,C);(new Location$$module$js$nodes(c,39,G,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,C).chest(Ja,25);const hb=(new Location$$module$js$nodes(c,40,A,"Entrance")).overworld().connect(bd,Le,Ke),ib=(new Location$$module$js$nodes(c,40,A,"Upper")).overworld().from(hb,F).to(hb),
Ib=(new Location$$module$js$nodes(c,40,A,"Summit (boss)")).overworld().from(ib,F).to(ib).boss(bf),fd=(new Location$$module$js$nodes(c,41,A,"Connector")).overworld(),Jb=(new Location$$module$js$nodes(c,41,A,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,A,"Middle Right")).overworld().from(Jb,Pc).to(Jb),gd=(new Location$$module$js$nodes(c,42,A,"Tunnel 2a (from entrance to connector)")).cave().connectTo(fd);(new Location$$module$js$nodes(c,42,A,"Tunnel 2b (under bridge, to antidote)")).cave().connect(gd,
C).chest(N,23,94);const hd=(new Location$$module$js$nodes(c,43,A,"Tunnel 3a (branch after connector)")).cave().connect(fd),Of=(new Location$$module$js$nodes(c,43,A,"Tunnel 3b (right branch)")).cave().connect(hd,C),Pf=(new Location$$module$js$nodes(c,43,A,"Tunnel 3c (upper branch)")).cave().connect(hd,C);(new Location$$module$js$nodes(c,44,A,"Tunnel 4 (over bridge, to middle)")).cave().connect(Pf).connectTo(Jb);const id=(new Location$$module$js$nodes(c,45,A,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Of).connectTo(Nf);
(new Location$$module$js$nodes(c,45,A,"Tunnel 5b (dead-end with herb)")).cave().connect(id,C).chest(I,22,83);const Qf=(new Location$$module$js$nodes(c,46,A,"Tunne; 6a (S-shaped hall, right)")).cave().connect(id),Rf=(new Location$$module$js$nodes(c,46,A,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Qf,C),Sf=(new Location$$module$js$nodes(c,46,A,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Rf,C),jd=(new Location$$module$js$nodes(c,47,A,"Prison (hallway)")).cave().connect(ib),Tf=(new Location$$module$js$nodes(c,
48,A,"Left Cell (shopkeepers)")).cave().from(jd,C);(new Location$$module$js$nodes(c,49,A,"Left Cell 2 (back, with prison key)")).cave().from(Tf,C).chest(xb,13);const Uf=(new Location$$module$js$nodes(c,50,A,"Right Cell (villagers)")).cave().from(jd,C),Vf=(new Location$$module$js$nodes(c,51,A,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Uf,C);(new Location$$module$js$nodes(c,52,A,"Tunnel 9 (connector to summit)")).cave().connect(Vf).connectTo(Ib);const Wf=(new Location$$module$js$nodes(c,
53,A,"Summit Cave (front)")).cave().from(Ib,xb).to(Ib),Xf=(new Location$$module$js$nodes(c,53,A,"Summit Cave (behind ice)")).cave().connect(Wf,C).trigger(re);(new Location$$module$js$nodes(c,56,A,"Tunnel 1 (leads from main entrance)")).cave().connect(hb).connectTo(gd);(new Location$$module$js$nodes(c,57,A,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(ib);const Yf=(new Location$$module$js$nodes(c,60,db,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,db,"Tool Shop")).shop(I,N,P,U),$f=(new Location$$module$js$nodes(c,
62,db,"Back Room")).house(),Kb=(new Location$$module$js$nodes(c,64,ja,"Summit")).overworld().connect(Xf,nf),jb=(new Location$$module$js$nodes(c,64,ja,"Northwest")).overworld().from(Kb).to(Kb,F),ag=(new Location$$module$js$nodes(c,64,ja,"Northeast")).overworld().connect(jb,x),kd=(new Location$$module$js$nodes(c,65,ja,"Southwest")).overworld().connect(jb),bg=(new Location$$module$js$nodes(c,65,ja,"Southeast")).overworld().connect(kd,x),ld=(new Location$$module$js$nodes(c,66,ja,"Lime Tree Valley")).overworld().connect(kd).connect(Na,
Vd),cg=(new Location$$module$js$nodes(c,67,ja,"Lime Tree Lake (Rage)")).cave().connect(ld).trigger(Ec,O),dg=(new Location$$module$js$nodes(c,68,la,"Tunnel 1a (entrance)")).cave().connect(bg),eg=(new Location$$module$js$nodes(c,68,la,"Tunnel 1b (behind wall)")).cave().connect(dg,B),md=(new Location$$module$js$nodes(c,69,la,"Tunnel 2a (main path, before wall)")).cave().connect(eg);(new Location$$module$js$nodes(c,69,la,"Tunnel 2b (dead end, antidote)")).cave().connect(md,B).chest(N,25,95);const fg=
(new Location$$module$js$nodes(c,69,la,"Tunnel 2c (main path, after wall)")).cave().connect(md,B),gg=(new Location$$module$js$nodes(c,70,la,"Tunnel 3a (last room, before wall)")).cave().connect(fg),hg=(new Location$$module$js$nodes(c,70,la,"Tunnel 3b (last room, after wall)")).cave().connect(gg,B);(new Location$$module$js$nodes(c,71,la,"Meadow")).overworld().connect(hg).chest(oc,14);const ig=(new Location$$module$js$nodes(c,72,H,"Tunnel 1a (entrance)")).cave().connect(ag),nd=(new Location$$module$js$nodes(c,
72,H,"Tunnel 1b (past wall)")).cave().connect(ig,B);(new Location$$module$js$nodes(c,72,H,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(nd,B).chest(wa,24);const jg=(new Location$$module$js$nodes(c,73,H,"Tunnel 2 (tiny connector)")).cave().connect(nd),od=(new Location$$module$js$nodes(c,74,H,"Tunnel 3a (upper branch)")).cave().connect(jg);(new Location$$module$js$nodes(c,74,H,"Tunnel 3b (dead end, mimic)")).cave().connect(od,B).chest(Q,21,112);const pd=(new Location$$module$js$nodes(c,74,H,"Tunnel 3c (short passage with mimic)")).cave().connect(od,
B).chest(Q,22,113),kg=(new Location$$module$js$nodes(c,74,H,"Tunnel 3d (lower branch)")).cave().connect(pd,B);(new Location$$module$js$nodes(c,75,H,"Dead end loop")).cave().connect(kg);const qd=(new Location$$module$js$nodes(c,76,H,"Tunnel 4a (right branch over bridge)")).cave().connect(pd),lg=(new Location$$module$js$nodes(c,76,H,"Tunnel 4b (past wall over bridge)")).cave().connect(qd,B),mg=(new Location$$module$js$nodes(c,77,H,"Tunnel 5a (from left branch)")).cave().connect(qd),ng=(new Location$$module$js$nodes(c,
77,H,"Tunnel 5b (reconvergence)")).cave().connect(mg,B).connect(lg),og=(new Location$$module$js$nodes(c,77,H,"Tunnel 5c (between walls)")).cave().connect(ng,B),pg=(new Location$$module$js$nodes(c,77,H,"Tunnel 5d (under bridge)")).cave().connect(og,B),qg=(new Location$$module$js$nodes(c,78,H,"Tunnel 6a (over second bridge)")).cave().connect(pg),rg=(new Location$$module$js$nodes(c,78,H,"Tunnel 6b (past wall)")).cave().connect(qg,B),sg=(new Location$$module$js$nodes(c,79,H,"Tunnel 7a (under second bridge)")).cave().connect(rg);
(new Location$$module$js$nodes(c,79,H,"Tunnel 7b (fog lamp)")).cave().connect(sg,B).chest(jc,19);const va=(new Location$$module$js$nodes(c,80,E,"Town")).town().connect(jb),rd=(new Location$$module$js$nodes(c,81,E,"Fishherman Island")).town().connect(va);(new Location$$module$js$nodes(c,82,ja,"Mesia Shrine")).cave().trigger(Fc).connect(cg,x,Ec);const sd=(new Location$$module$js$nodes(c,84,ka,"Tunnel 1a (entrance)")).cave().connect(jb);(new Location$$module$js$nodes(c,84,ka,"Tunnel 1b (dead end, mimic)")).cave().connect(sd,
C).chest(Q,19,114);const tg=(new Location$$module$js$nodes(c,84,ka,"Tunnel 1c (past ice)")).cave().connect(sd,C),ug=(new Location$$module$js$nodes(c,85,ka,"Tunnel 2 (stoned pair)")).cave().connect(tg),Lb=(new Location$$module$js$nodes(c,86,ka,"Tunnel 3 (wide medusa hallways)")).cave().connect(ug,Qe),vg=(new Location$$module$js$nodes(c,87,ka,"Tunnel 4a (left entrance)")).cave().from(Lb,C).chest($b.chest().bonus(),25).trigger(te,ub);(new Location$$module$js$nodes(c,87,ka,"Tunnel 4b (right entrance)")).cave().from(Lb,
C).connect(vg,F);(new Location$$module$js$nodes(c,87,ka,"Tunnel 4c (sword of water)")).cave().connect(Lb,C).chest(O,24);const td=(new Location$$module$js$nodes(c,88,fa,"Entrance")).misc(),wg=(new Location$$module$js$nodes(c,89,fa,"Level 1")).misc().from(td),xg=(new Location$$module$js$nodes(c,90,fa,"Level 2")).misc().from(wg),yg=(new Location$$module$js$nodes(c,91,fa,"Level 3")).misc().from(xg),ud=(new Location$$module$js$nodes(c,92,fa,"Outside Mesia Room")).misc().from(yg),zg=(new Location$$module$js$nodes(c,
...
wb);const kb=(new Location$$module$js$nodes(c,100,E,"Underground Channel 1 (from throne room)")).sea().trigger(Dc),Eg=(new Location$$module$js$nodes(c,100,E,"Underground Channel 2 (to fortune teller)")).sea().connect(kb,x),wd=(new Location$$module$js$nodes(c,100,E,"Underground Channel 3 (from fortune teller)")).sea().connect(kb,F),xd=(new Location$$module$js$nodes(c,100,E,"Underground Channel 4 (asina)")).sea().connect(wd,x),Fg=(new Location$$module$js$nodes(c,100,E,"Underground Channel 5 (dolphin)")).sea().connect(xd,
x).trigger(Hc,I,Gc);(new Location$$module$js$nodes(c,100,E,"Underground Channel 6 (water)")).sea().connect(Fg,da).connectTo(Fa,da).chest(nc,17);const Nb=(new Location$$module$js$nodes(c,101,L,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,L,"Tunnel 1 (entrance)")).sea().connect(Fa,Jc,da),yd=(new Location$$module$js$nodes(c,105,L,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,L,"Tunnel 2b (dead end to left)")).cave().connect(yd,x);const Hg=(new Location$$module$js$nodes(c,
105,L,"Tunnel 2c (across first river)")).cave().connect(yd,x),zd=(new Location$$module$js$nodes(c,105,L,"Tunnel 2d (across second river)")).cave().connect(Hg,x);(new Location$$module$js$nodes(c,105,L,"Tunnel 2e (dead end, magic ring)")).cave().connect(zd,B).chest(Y,29);const Ig=(new Location$$module$js$nodes(c,105,L,"Tunnel 2f (stair down)")).cave().connect(zd,B),Jg=(new Location$$module$js$nodes(c,106,L,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(Nb).chest(wa,25,92),Kg=(new Location$$module$js$nodes(c,
106,L,"Tunnel 3b (left area toward items)")).cave().connect(Jg,B),Lg=(new Location$$module$js$nodes(c,107,L,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(Q,14,115);(new Location$$module$js$nodes(c,107,L,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,x).chest(he,15);const Ob=(new Location$$module$js$nodes(c,108,na,"Floor 1")).fortress().connect(Nb),Mg=(new Location$$module$js$nodes(c,108,na,"Miniboss")).fortress().boss(cf).connect(Ob);(new Location$$module$js$nodes(c,109,na,
"Floor 2a (left stair)")).fortress().connect(Ob).chest(P,19);const Ng=(new Location$$module$js$nodes(c,109,na,"Floor 2b (right stair)")).fortress().connect(Mg).chest(I,30,85),Og=(new Location$$module$js$nodes(c,110,na,"Floor 3a (toward boss)")).fortress().connect(Ng),Ad=(new Location$$module$js$nodes(c,110,na,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$js$nodes(c,110,na,"Boss")).fortress().boss(Yc).connect(Ad);(new Location$$module$js$nodes(c,110,na,"Floor 3c (back room trap)")).fortress().from(Ad).to(Ob);
...
124,D,"Entrance")).overworld().connect(mb),Sg=(new Location$$module$js$nodes(c,124,D,"Over first river toward Shyron")).overworld().connect(Pb,x),Bd=(new Location$$module$js$nodes(c,124,D,"After first tunnel")).overworld(),Cd=(new Location$$module$js$nodes(c,124,D,"Door to Styx")).overworld().connect(Bd,x),Tg=(new Location$$module$js$nodes(c,124,D,"Dead end (no item)")).overworld(),Ug=(new Location$$module$js$nodes(c,124,D,"Dead end (fruit of lime)")).overworld().chest(rb,26),Vg=(new Location$$module$js$nodes(c,
124,D,"Dead end (magic ring)")).overworld().chest(Y,25,101),Dd=(new Location$$module$js$nodes(c,124,D,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(c,124,D,"Floating island (bow of sun)")).overworld().connect(Dd,F).chest(qc,24);const Wg=(new Location$$module$js$nodes(c,125,D,"Tunnel 1 (to Shyron)")).cave().connect(Sg),Xg=(new Location$$module$js$nodes(c,126,D,"Outside Shyron")).overworld().connect(Wg);(new Location$$module$js$nodes(c,127,D,"Tunnel 2 (fork)")).cave().connect(Pb).connectTo(Ug).connectTo(Bd);
const Ed=(new Location$$module$js$nodes(c,128,D,"Tunnel 3 (caves)")).cave().connect(Cd).connect(Tg),Fd=(new Location$$module$js$nodes(c,129,D,"Tunnel 4 (left branch of cave)")).cave().connect(Ed);(new Location$$module$js$nodes(c,130,D,"Tunnel 5 (dead end, medical herb)")).cave().connect(Fd).chest(I,15,86);const Yg=(new Location$$module$js$nodes(c,131,D,"Tunnel 6a (left-then-right)")).cave().connect(Fd),Zg=(new Location$$module$js$nodes(c,131,D,"Tunnel 6b (past wall)")).cave().connect(Yg,B),$g=(new Location$$module$js$nodes(c,
132,D,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,D,"Tunnel 8 (red slimes)")).cave().from($g,B).connectTo(Dd).chest(Q,23,116);const ah=(new Location$$module$js$nodes(c,134,D,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Ed),bh=(new Location$$module$js$nodes(c,135,D,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,135,D,"Tunnel 10b (past wall)")).cave().connect(bh,B).connectTo(Vg);const Gd=(new Location$$module$js$nodes(c,
136,ta,"Entrance")).fortress().from(Cd,ic,Fb),ch=(new Location$$module$js$nodes(c,137,ta,"Left branch")).fortress().connect(Gd).chest(Q,19,117),dh=(new Location$$module$js$nodes(c,137,ta,"Left branch, past one bridge")).fortress().connect(ch,x),eh=(new Location$$module$js$nodes(c,137,ta,"Left branch, past two bridges")).fortress().connect(dh,x).chest(I,29,87),fh=(new Location$$module$js$nodes(c,137,ta,"Right branch")).fortress().connect(Gd);(new Location$$module$js$nodes(c,137,ta,"Right branch, across water")).fortress().connect(fh,
F).chest(Q,20,118).chest(Q,21,119).chest(Zd,28);(new Location$$module$js$nodes(c,138,ta,"Upper floor")).fortress().connect(eh).chest(M,27);const Ga=(new Location$$module$js$nodes(c,140,oa,"Town")).town().connect(Xg,Re).trigger(Eb),Pa=(new Location$$module$js$nodes(c,142,ua,"Town")).town().connect(mb),Hd=(new Location$$module$js$nodes(c,143,J,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,J,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Hd,
xa).chest(fe,15);const Qb=(new Location$$module$js$nodes(c,144,ua,"Desert 1")).overworld().connect(mb),nb=(new Location$$module$js$nodes(c,145,J,"Area 1 (from entrance)")).cave().chest(fc,26),Id=(new Location$$module$js$nodes(c,145,J,"Area 2 (across top bridge)")).cave().connect(nb,x);(new Location$$module$js$nodes(c,145,J,"Area 3 (dead-end across top-right bridge)")).cave().connect(Id,x);const gh=(new Location$$module$js$nodes(c,145,J,"Area 4 (left across middle-right bridge)")).cave().connect(Id,
x),hh=(new Location$$module$js$nodes(c,145,J,"Area 5 (bottom edge)")).cave().connect(gh,x),ih=(new Location$$module$js$nodes(c,145,J,"Area 6 (bottom island)")).cave().connect(hh,x),jh=(new Location$$module$js$nodes(c,145,J,"Area 7 (bottom inner ring)")).cave().connect(ih,x),kh=(new Location$$module$js$nodes(c,145,J,"Area 8 (left outer ring)")).cave().connect(jh,x).connect(nb,x).chest(P,27,100),lh=(new Location$$module$js$nodes(c,145,J,"Area 9 (top left inner ring)")).cave().connect(kh,x),mh=(new Location$$module$js$nodes(c,
145,J,"Area 10 (top right inner ring)")).cave().connect(lh,x);(new Location$$module$js$nodes(c,145,J,"Area 11 (center)")).cave().connect(mh,x).connectTo(Hd);(new Location$$module$js$nodes(c,145,J,"Area 12 (top center islands)")).cave().connect(nb,F).chest(de,28);const nh=(new Location$$module$js$nodes(c,146,ca,"Desert Cave 1")).cave().connect(Qb,F),Ha=(new Location$$module$js$nodes(c,147,ca,"Town")).town(),oh=(new Location$$module$js$nodes(c,148,ca,"Outside Cave")).overworld().connect(Ha),ph=(new Location$$module$js$nodes(c,
149,ca,"Desert Cave 2")).cave().connect(oh);(new Location$$module$js$nodes(c,150,ca,"Meadow")).overworld().connect(nh).connectTo(Ha).trigger(Be,qa,Ze);const Rb=(new Location$$module$js$nodes(c,152,ca,"Desert 2")).overworld().connect(ph),qh=(new Location$$module$js$nodes(c,156,Ca,"Entrance")).fortress().connect(Rb,F),rh=(new Location$$module$js$nodes(c,156,Ca,"Azteca")).fortress().trigger(De),sh=(new Location$$module$js$nodes(c,157,Ca,"Fork")).fortress().connect(qh),Jd=(new Location$$module$js$nodes(c,
158,Ca,"Main")).fortress().connect(sh);(new Location$$module$js$nodes(c,158,Ca,"Treasure Chest (magic ring)")).fortress().connect(Jd).chest(Y,27,108);(new Location$$module$js$nodes(c,159,Ca,"Draygon")).fortress().connect(Jd).to(rh).boss(jf);const th=(new Location$$module$js$nodes(c,160,ea,"Entrance")).fortress().connect(Rb,F),uh=(new Location$$module$js$nodes(c,160,ea,"Statues")).fortress().connect(th).boss(kf),vh=(new Location$$module$js$nodes(c,161,ea,"Hall 1")).fortress().connect(uh),Sb=(new Location$$module$js$nodes(c,
...
171,ba,"Dead End Loop Across Closer Bridges")).fortress().connect(ob,x).connect(ob,x);const Bh=(new Location$$module$js$nodes(c,171,ba,"Across First Bridge (fruit of repun)")).fortress().connect(ob,x).chest(sb,30,102),Tb=(new Location$$module$js$nodes(c,171,ba,"Across Second Bridge")).fortress().connect(Bh,x);(new Location$$module$js$nodes(c,171,ba,"Dead End Across Two Bridges ()")).fortress().connect(Tb,x).connect(Tb,x).chest(wa,29,93);const Ch=(new Location$$module$js$nodes(c,171,ba,"Across Third Bridge")).fortress().connect(Tb,
x),Dh=(new Location$$module$js$nodes(c,171,ba,"Exit Behind Iron Door")).fortress().connect(Ch,xa),Eh=(new Location$$module$js$nodes(c,172,ba,"Boss")).fortress().connect(Dh).boss(ff),Fh=(new Location$$module$js$nodes(c,172,ba,"Tornel")).fortress().connect(Eh),Ld=(new Location$$module$js$nodes(c,173,Ba,"Lower")).fortress().connect(Fh).chest(tb,26,99).chest(Y,27,111),Gh=(new Location$$module$js$nodes(c,174,Ba,"Upper Loop")).fortress().connect(Ld).chest(N,22,96);(new Location$$module$js$nodes(c,174,Ba,
...
Nh=(new Location$$module$js$nodes(c,182,R,"Boss")).fortress().connect(Mh,Fb).boss(hf);(new Location$$module$js$nodes(c,182,R,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(Xa,18);const Od=(new Location$$module$js$nodes(c,183,R,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,184,J,"Entrance Back (behind river)")).cave().connect(Od).chest(P,13,90);(new Location$$module$js$nodes(c,184,J,"Entrance Front")).cave().connect(Oh,F).connectTo(Qb).connectTo(nb);const Ph=(new Location$$module$js$nodes(c,
185,Ba,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$js$nodes(c,185,Ba,"Asina")).fortress().connect(Ph).connectTo(Ub);(new Location$$module$js$nodes(c,186,R,"Kensu")).fortress().connect(Nd).connectTo(Od).trigger(Ae,zb);(new Location$$module$js$nodes(c,187,ua,"House")).house().connect(Pa).trigger(Ce,qa,zb);(new Location$$module$js$nodes(c,188,ua,"Inn")).shop().connect(Pa,Eb);(new Location$$module$js$nodes(c,190,ua,"Tool Shop")).shop(I,N,U,P).connect(Pa,Eb);(new Location$$module$js$nodes(c,
191,ua,"Tavern")).shop().connect(Pa);(new Location$$module$js$nodes(c,192,Z,"Elder House")).house().connect(pa).trigger(uc);(new Location$$module$js$nodes(c,193,Z,"Rabbit Hut")).house().connect(pa).trigger(Ac,zc,ia);(new Location$$module$js$nodes(c,194,Z,"Inn")).shop().connect(pa);(new Location$$module$js$nodes(c,195,Z,"Tool Shop")).shop(I,N,U,P).connect(pa);(new Location$$module$js$nodes(c,196,Z,"Armor Shop")).shop($d,Yb).connect(pa);(new Location$$module$js$nodes(c,197,Z,"Student House")).house().connect(pa).trigger(vc);
(new Location$$module$js$nodes(c,198,za,"Tavern")).house().connect(Oa);(new Location$$module$js$nodes(c,199,za,"Pawn Shop")).shop().connect(Oa);(new Location$$module$js$nodes(c,200,za,"Inn")).shop().connect(Oa);(new Location$$module$js$nodes(c,201,za,"Armor Shop")).shop(ae,Yb,Xd).connect(Oa);(new Location$$module$js$nodes(c,203,za,"Tool Shop")).shop(I,N,U).connect(Oa);(new Location$$module$js$nodes(c,205,Ma,"Elder House")).house().from(gb,ia).trigger(pe,Bb);(new Location$$module$js$nodes(c,206,Ma,
"Mother's House")).house().from(gb,ia).trigger(yc,ia).trigger(oe,Bb);(new Location$$module$js$nodes(c,207,Ma,"Tool Shop")).shop(I,N,P).from(gb,ia);(new Location$$module$js$nodes(c,208,Ma,"Inn")).shop().from(gb,ia);(new Location$$module$js$nodes(c,209,Aa,"Inn")).shop().connect(fb);(new Location$$module$js$nodes(c,210,Aa,"Tool Shop")).shop(U,P,wa).connect(fb);(new Location$$module$js$nodes(c,211,Aa,"Armor Shop")).shop(bc,Zb,$b,qb).connect(fb);const Qh=(new Location$$module$js$nodes(c,212,Aa,"Queen's House")).house().from(fb,
Se).trigger(ye,qa,oc);(new Location$$module$js$nodes(c,213,db,"Nadare's")).house().connect(hb).connectTo(Yf).connectTo(Zf).connectTo($f);(new Location$$module$js$nodes(c,214,E,"Fisherman's House")).house().connect(rd).trigger(Cb,jc,yb,Te);const Vb=(new Location$$module$js$nodes(c,215,E,"Palace Entrance")).house().connect(va);(new Location$$module$js$nodes(c,216,E,"Fortune Teller Front")).house().connect(va).trigger(Cc,Bc);(new Location$$module$js$nodes(c,216,E,"Fortune Teller Back")).house().connect(Eg).connect(wd);
(new Location$$module$js$nodes(c,217,E,"Pawn Shop")).shop().connect(va);(new Location$$module$js$nodes(c,218,E,"Armor Shop")).shop(be,bc,Zb).connect(va);(new Location$$module$js$nodes(c,220,E,"Inn")).shop().connect(va);(new Location$$module$js$nodes(c,221,E,"Tool Shop")).shop(I,wa,rb,U).connect(va);(new Location$$module$js$nodes(c,222,E,"Palace Left")).house().connect(Vb);(new Location$$module$js$nodes(c,223,E,"Palace Throne Room")).house().connect(Vb).to(kb,Me).from(kb).trigger(Bc).trigger(se,Cc,
Dc);(new Location$$module$js$nodes(c,224,E,"Palace Right")).house().connect(Vb);(new Location$$module$js$nodes(c,225,E,"Asina's Room")).house().connect(xd).trigger(Gc,Qc);(new Location$$module$js$nodes(c,226,Aa,"Queen Downstairs")).house().connect(Qh).chest(Va,13);(new Location$$module$js$nodes(c,227,ma,"Elder's House")).house().connect(lb).trigger(Jc);(new Location$$module$js$nodes(c,228,ma,"Shed")).house().connect(lb).to(Pg,kc);(new Location$$module$js$nodes(c,229,ma,"Tool Shop")).shop(I,N,P,wa).connect(lb);
(new Location$$module$js$nodes(c,231,ma,"Inn")).shop().connect(lb);const Rh=(new Location$$module$js$nodes(c,232,L,"Zombie Town House")).house().connect(Nb);(new Location$$module$js$nodes(c,233,L,"Zombie Town Basement")).house().connect(Rh).trigger(ue,Yc);(new Location$$module$js$nodes(c,235,aa,"Tool Shop")).shop(I,N,P,U).connect(ha);(new Location$$module$js$nodes(c,236,aa,"Stom's Hut")).house().connect(ha).trigger(Kc);(new Location$$module$js$nodes(c,237,aa,"Inn")).shop().connect(ha);(new Location$$module$js$nodes(c,
...
Nc).boss(df);(new Location$$module$js$nodes(c,243,oa,"Training Hall")).house().connect(Ga);(new Location$$module$js$nodes(c,244,oa,"Hospital")).house().connect(Ga);(new Location$$module$js$nodes(c,245,oa,"Armor Shop")).shop(cc,qb,ac).connect(Ga);(new Location$$module$js$nodes(c,246,oa,"Tool Shop")).shop(I,N,rb,Y).connect(Ga);(new Location$$module$js$nodes(c,247,oa,"Inn")).shop().connect(Ga);(new Location$$module$js$nodes(c,248,ca,"Inn")).shop().connect(Ha);(new Location$$module$js$nodes(c,249,ca,
...
f.shuffleShops(b);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&k.slots){var l=k.slotType[0];(h[l]=h[l]||[]).push(k)}k=[];l=[];var m={};for(var n of d.get("S")){var r=[];for(var p of n){m[p]=!0;for(var q of h[p])r.push(q),l.push([q,k.length])}k.push(r)}for(var u of"bc")if(m[u])for(n=h[u],p=n.map((a)=>[a.item,a.itemIndex]),b.shuffle(p),q=0;q<n.length;q++)n[q].set(p[q][0],p[q][1]);r=(a)=>g.find((b)=>
b.vanillaItemName===a);h=r("Sword of Wind");u=r("Sword of Fire");n=r("Ball of Wind");p=r("Ball of Fire");q=r("Statue of Onyx");r=r("Gas Mask");m.k&&b.nextInt(2)&&(u.swap(h),p.swap(n));m.k&&!b.nextInt(3)&&q.swap(r);m=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(u=0;1E3>u;u++){e&&0===u%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));b.shuffle(l);for(var t of k)b.shuffle(t);n=k.map(()=>-1);p=m[b.nextInt(m.length)];q=[];r=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||
b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<p;a++){const [b,c]=l[a],d=k[c][++n[c]];r(b,d)&&(b.swap(d),q.push([b,d]))}if(!q.length)continue;const {win:a,path:c}=f.traverse({wanted:g,dfs:!1});if(a)h=c;else for(;q.length;){const [a,b]=q.pop();a.swap(b)}}a&&f.write();if(c){c.items=[];c.route=[];for(const a of h){const [b,d]=a;c.route.push(d);t=f.nodes[b];t instanceof Slot$$module$js$nodes&&!t.isFixed()&&null!=t.slotName&&(k=t.slotName,
...
a.slots&&!a.isFixed());const l=new Map(d.shuffle(k.map((a)=>[a,[a.item,a.itemIndex]]))),m=new Set(d.shuffle(k)),n=new Map,r={};g&&g.seeds++;f.get("S").forEach((a,b)=>{for(const c of a)r[c]=b});for(var p of m)n.set(p.item,p);const q=new Set,u=(a,b)=>{if(null==r[a.slotType?a.slotType[0]:"c"])return a===b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!==b.item.inventoryRow&&a.requiresUnique||"armor"===b.item.inventoryRow&&!a.isChest())return!1;if(f.guaranteeSword()){if(0===a.slotIndex)return 4>b.item.id;
if(4>b.item.id&&(q.add(b),4===q.size))return 0===a.slotIndex}return r[a.slotType?a.slotType[0]:"c"]===r[b.slotType?b.slotType[0]:"c"]};p=b.assumedFill(d,(a,b)=>u(a,n.get(b)));if(null==p){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const t=new Map;for(var z=0;z<p.length;z++){var y=p[z];if(null!=y){var v=n.get(b.item(y));y=l.get(v);l.delete(v);v=b.location(z);t.set(v,y);m.delete(v)}}z=(a,b,c)=>{c=void 0===c?"":c;for(const c of m)if(u(c,a))return t.set(c,b),m.delete(c),l.delete(a),!0;
g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var w of l){const [a,b]=w;if(a.isMimic()&&!z(a,b,"traps"))return!1}for(const a of l){const [b,c]=a;if(b.needsChest()&&!z(b,c,"chest"))return!1}for(const a of l){const [b,c]=a;if(!z(b,c))return!1}for(const a of t){const [b,c]=a;b.set(...c)}const {win:K,path:Qa}=a.traverse({wanted:k,dfs:!1});if(!K)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,p));e.items=
...
function build$$module$js$graph$world(a,b,c){b=void 0===b?new FlagSet$$module$js$flagset("@FullShuffle"):b;c=void 0===c?!1:c;const d=new Overlay$$module$js$graph$overlay(a,b,c),e=new Map,f=new Map,g=new Map,h=new Map,k=new DefaultMap$$module$js$util(()=>new Set),l=new Map,m=new Set;for(const b of a.locations){var n=function(a,b){const c=e.get(a);c&&e.set(a,module$js$graph$condition.Terrain.meet(c,b))};if(!b.used)continue;const c=b.extended?256:0,q=a.tilesets[(b.tileset&127)>>2],t=a.tileEffects[b.tileEffects-
179];for(const a of b.spawns)a.isWall()&&f.set(module$js$graph$geometry.ScreenId.from(b,a),a.id&3);for(let g=0,h=b.height;g<h;g++){const h=b.screens[g],k=b.id<<8|g<<4;for(let g=0,l=b.width;g<l;g++){var r=function(a,b){if(!u)throw Error("flag expected");return b?a?z(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(u.flag)},b):a};const l=a.screens[h[g]|c],m=module$js$graph$geometry.ScreenId(k|g),n=m&255,p=f.get(m),u=null!=p?d.wallCapability(p):b.flags.find((a)=>
a.yx===n),z=memoize2$$module$js$graph$condition((a,b)=>{if(!u)throw Error("flag expected");b=Object.assign({},b,{enter:meet$$module$js$graph$condition(b.enter||[[]],module$js$graph$condition.Condition(u.flag))});return module$js$graph$condition.Terrain.join(a,b)});for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(m<<8|a);let f=l.tiles[a];u&&751===u.flag&&32>f&&(f=q.alternates[f]);let g=d.makeTerrain(c?0:t.effects[f]&38,b);if(32>f&&q.alternates[f]!=f&&u&&751!==u.flag){const a=d.makeTerrain(t.effects[q.alternates[f]],
...
b);q.has(d)&&(p.union([b,c]),q.delete(a),q.delete(d))}const u=new Neighbors$$module$js$graph$geometry(p,m);for(const a of e){const [b,c]=a;{const a=module$js$graph$geometry.TileId.add(b,0,1),d=e.get(a);d&&d!==c&&u.addAdjacent(b,a,!1);const f=module$js$graph$geometry.TileId.add(b,1,0),g=e.get(f);g&&g!==c&&u.addAdjacent(b,f,!0)}}for(const a of q){const [b,c]=module$js$graph$geometry.TilePair.split(a);e.has(b)&&e.has(c)&&u.addExit(b,c)}const t=new Routes$$module$js$graph$routes;for(const a of d.extraRoutes())for(const b of a.condition||
[[]])t.addRoute(p.find(a.tile),b);for(const a of d.extraEdges()){const {from:b,to:c,condition:d}=a;for(const a of d||[[]])t.addEdge(p.find(c),p.find(b),a)}for(const a of u){const {from:b,to:c,south:d}=a;{const a=e.get(b),f=e.get(c);if(!a||!f)throw Error(`missing terrain ${a?c:b}`);for(const e of(d?a.exitSouth:a.exit)||[[]])for(const a of f.enter||[[]])t.addEdge(c,b,[...a,...e])}}const z=new DefaultMap$$module$js$util(()=>new MutableRequirement$$module$js$graph$condition);for(const a of d.capabilities()){const {condition:b=
[[]],capability:c}=a;z.get(module$js$graph$condition.Slot(c)).addAll(b)}for(const a of k){const [b,c]=a;{const a=p.find(b);if(b!==a){for(const b of c)k.get(a).add(b);k.delete(b)}}}for(const a of k){const [b,c]=a;for(const a of c){const {slot:c,condition:d=[[]]}=a;{const a=z.get(c);for(const c of d)for(const d of t.routes.get(b)||[])a.addList([...c,...d])}}}if(DEBUG$$module$js$graph$world&&"undefined"!==typeof window){var y=function(a,b){b=void 0===b?v:b;a=[...a];return a.length?"("+a.map((a)=>[...a].map(b).join(" & ")).join(") |\n     (")+
")":"no route"},v=function(a){return 0>a?"~"+(~a).toString(16).padStart(2,"0"):a.toString(16).padStart(3,"0")};const b=window;console.log(b.roots=(b.tiles=p).roots());console.log([...b.neighbors=u]);console.log(b.ll=t);b.area=(a,b)=>{b=void 0===b?v:b;const c=[...p.sets().filter((b)=>b.has(a))[0]].map((a)=>a.toString(16).padStart(6,"0")),d=y(t.routes.get(p.find(a)),b),e=[],f=p.find(a);for(const a of(t.edges.get(f)||new Map).values())e.push(`\nto ${a.target.toString(16)} if (${[...a.deps].map(b).join(" & ")})`);
...
{var [c,d]=a;return`${b.whatFlag(c)}: ${y(d,b.whatFlag)}`}).join("\n"));b.reqs.check=(a,b)=>{b=void 0===b?v:b;return`${b(a)}: ${y(z.get(module$js$graph$condition.Slot(a)),b)}`};b.reqs.check2=(a)=>b.reqs.check(a,b.whatFlag)}let w=isItem$$module$js$graph$world;c&&(w=function(a){return isItem$$module$js$graph$world(a)||b.shuffleBossElements()&&isBoss$$module$js$graph$world(a)?!0:!1});return new World$$module$js$graph$world(a,p,makeGraph$$module$js$graph$world(z,a,w))}
...
[...g].filter((a)=>!c(a)).sort();g=[...g].filter(c).sort();l=[...h].filter(c).sort();const n=k.length;h=k.map(d);g=g.map(e);m=l.map(e);g=[...h,...g];k=[...h,...m];const r=new Map(g.map((a,b)=>[a.condition,b])),p=new Map(k.map((a,b)=>[a.condition,b]));l=[];const q=[];for(var u of a){const [c,d]=u;a=p.get(c);if(null==a)MAYBE_MISSING_SLOTS$$module$js$graph$world.has(c)||console.error(`Nothing depended on $${c.toString(16)}: ${conditionName$$module$js$graph$world(c,b)}`);else for(const b of d){const c=
[...b].map(f);(l[a]||(l[a]=[])).push(Bits$$module$js$bits.from(c));for(const b of c)(q[b]||(q[b]=new Set)).add(a)}}for(var t of[...h,...m])l[t.index]&&l[t.index].length||(u=t.condition,console.error(`Nothing provided $${u.toString(16)}: ${conditionName$$module$js$graph$world(u,b)} (index ${t.index})`));DEBUG$$module$js$graph$world&&console.log(l);t=q.map((a)=>[...a]);return{fixed:n,slots:k,items:g,graph:l,unlocks:t,rom:b}}const MAYBE_MISSING_SLOTS$$module$js$graph$world=new Set([37,38,169,580]);
...
module$js$maze$types.Pos=Pos$$module$js$maze$types;module$js$maze$types.Scr=Scr$$module$js$maze$types;function Spec$$module$js$maze$spec(a,b,c,...d){const e=[],f=[],g=[];let h=!1,k=!1,l=void 0,m=!1;for(let a of d)"string"===typeof a?"fixed"===a?h=!0:"flag"===a?k=!0:"pit"===a?m=!0:assertNever$$module$js$util(a):"number"===typeof a?e.push(connection$$module$js$maze$spec(a)):a instanceof Stair$$module$js$maze$spec?g.push(a):a instanceof Wall$$module$js$maze$spec?l=a:a instanceof Poi$$module$js$maze$spec?f.push(a):assertNever$$module$js$util(a);return{edges:a,tile:b,icon:c,connections:e,fixed:h,flag:k,
wall:l,pit:m,poi:f,stairs:g}}class Stair$$module$js$maze$spec{constructor(a,b,c){this.dir=a;this.entrance=b;this.exit=c}static up(a,b){return new Stair$$module$js$maze$spec(module$js$maze$types.Dir.UP,a,b)}static down(a,b){return new Stair$$module$js$maze$spec(module$js$maze$types.Dir.DOWN,a,b)}}
...
60)),Spec$$module$js$maze$spec(131088,153,"\u250e",14,Stair$$module$js$maze$spec.down(45008,188)),Spec$$module$js$maze$spec(131073,154,"\u2579",2,Stair$$module$js$maze$spec.down(8064,39)),Spec$$module$js$maze$spec(131328,154,"\u257b",10,Stair$$module$js$maze$spec.up(53376,199)),Spec$$module$js$maze$spec(262401,155," ",2,10),Spec$$module$js$maze$spec(1,155,"\u2575",2,poi$$module$js$maze$spec(0,-48,120)),Spec$$module$js$maze$spec(256,155,"\u2577",10,poi$$module$js$maze$spec(0,272,120)),Spec$$module$js$maze$spec(266256,
156," ",6,14),Spec$$module$js$maze$spec(16,156,"\u2576",14,poi$$module$js$maze$spec(0,112,264)),Spec$$module$js$maze$spec(4096,156,"\u2574",6,poi$$module$js$maze$spec(0,112,-40)),Spec$$module$js$maze$spec(1537,158,"\u257d",42)],BOSS_CAVE_SCREENS$$module$js$maze$spec=[Spec$$module$js$maze$spec(29046,145,"\u2564","fixed",42,poi$$module$js$maze$spec(1,96,120)),Spec$$module$js$maze$spec(94582,146,"\u2564","fixed",wall$$module$js$maze$spec(39,[2,10]),poi$$module$js$maze$spec(1,96,120)),Spec$$module$js$maze$spec(112,
128,"\u2558"),Spec$$module$js$maze$spec(28672,128,"\u255b")],RIVER_SCREENS$$module$js$maze$spec=[Spec$$module$js$maze$spec(13107,211,"\u256c",21,61,bridge$$module$js$maze$spec(182,[121,191]),poi$$module$js$maze$spec(4,0,152)),Spec$$module$js$maze$spec(771,212,"\u2551",25,59),Spec$$module$js$maze$spec(12336,213,"\u2550",93,127),Spec$$module$js$maze$spec(66307,214,"\u2551",bridge$$module$js$maze$spec(135,[25,59])),Spec$$module$js$maze$spec(77872,215,"\u2550",bridge$$module$js$maze$spec(134,[93,127])),
Spec$$module$js$maze$spec(816,216,"\u2554",157,191),Spec$$module$js$maze$spec(13056,217,"\u2557",91,121),Spec$$module$js$maze$spec(51,218,"\u255a",31,61),Spec$$module$js$maze$spec(12291,219,"\u255d",21,55),Spec$$module$js$maze$spec(12337,220,"\u2567",605,127),Spec$$module$js$maze$spec(12592,221,"\u2564",93,1967),Spec$$module$js$maze$spec(4867,222,"\u2562",361,59),Spec$$module$js$maze$spec(787,223,"\u255f",25,958),Spec$$module$js$maze$spec(525059,240," ",1,3,9,11),Spec$$module$js$maze$spec(3,240," ",
1,3,poi$$module$js$maze$spec(1,-48,72),poi$$module$js$maze$spec(1,-48,152)),Spec$$module$js$maze$spec(768,240," ",9,11,poi$$module$js$maze$spec(1,272,72),poi$$module$js$maze$spec(1,272,152)),Spec$$module$js$maze$spec(536624,241," ",5,7,13,15),Spec$$module$js$maze$spec(48,241," ",13,15,poi$$module$js$maze$spec(1,96,264),poi$$module$js$maze$spec(1,160,264)),Spec$$module$js$maze$spec(12288,241," ",5,7,poi$$module$js$maze$spec(1,96,-40),poi$$module$js$maze$spec(1,160,-40)),Spec$$module$js$maze$spec(3,
242,"\u2568",bridge$$module$js$maze$spec(23,[1,3])),Spec$$module$js$maze$spec(768,242,"\u2565",bridge$$module$js$maze$spec(198,[9,11])),Spec$$module$js$maze$spec(13104,243,"\u2566",93,121,191),Spec$$module$js$maze$spec(12339,244,"\u2569",21,61,127),Spec$$module$js$maze$spec(131843,245,"\u2560",25,3,11,poi$$module$js$maze$spec(1,192,152),poi$$module$js$maze$spec(1,64,152)),Spec$$module$js$maze$spec(262915,246,"\u2563",1,9,59,poi$$module$js$maze$spec(1,176,72),poi$$module$js$maze$spec(1,48,72))],WIDE_SCREENS$$module$js$maze$spec=
[Spec$$module$js$maze$spec(2,113,"\u253b",2,Stair$$module$js$maze$spec.down(53120,215)),Spec$$module$js$maze$spec(514,114,"\u2503",42),Spec$$module$js$maze$spec(34,224,"\u2516",46),Spec$$module$js$maze$spec(8194,225,"\u251a",38),Spec$$module$js$maze$spec(544,226,"\u250e",174),Spec$$module$js$maze$spec(8704,227,"\u2512",106),Spec$$module$js$maze$spec(66050,229,"\u254f","fixed",2,10),Spec$$module$js$maze$spec(8738,230,"\u2542",9902),Spec$$module$js$maze$spec(8226,231,"\u2538",622),Spec$$module$js$maze$spec(8736,
232,"\u2530",1710),Spec$$module$js$maze$spec(513,233,"\u257d","fixed",wall$$module$js$maze$spec(55,[2,10])),Spec$$module$js$maze$spec(8224,234,"\u2500",110),Spec$$module$js$maze$spec(66049,253,"\u257d","fixed",42)],WIDE_SET$$module$js$maze$spec=new Set([128,...WIDE_SCREENS$$module$js$maze$spec.map((a)=>a.tile)]),PIT_SCREENS$$module$js$maze$spec=[Spec$$module$js$maze$spec(528400,235,"\u2508","pit",110),Spec$$module$js$maze$spec(524545,236,"\u250a","pit",42)],SPIKE_SCREENS$$module$js$maze$spec=[Spec$$module$js$maze$spec(260,
237,"\u257f",42),Spec$$module$js$maze$spec(1025,238,"\u257d",42),Spec$$module$js$maze$spec(5140,239,"\u2542",9902),Spec$$module$js$maze$spec(1028,247,"\u2503",42)],SWAMP_SCREENS$$module$js$maze$spec=[Spec$$module$js$maze$spec(0,127," "),Spec$$module$js$maze$spec(1,-1,"\u2575",1),Spec$$module$js$maze$spec(16,118,"\u2576",13),Spec$$module$js$maze$spec(17,121,"\u2514",29),Spec$$module$js$maze$spec(256,-2,"\u2577",9),Spec$$module$js$maze$spec(257,-3,"\u2502",25),Spec$$module$js$maze$spec(272,-4,"\u250c",
157),Spec$$module$js$maze$spec(273,-5,"\u251c",413),Spec$$module$js$maze$spec(4096,123,"\u2574",5),Spec$$module$js$maze$spec(4097,117,"\u2518",21),Spec$$module$js$maze$spec(4112,-6,"\u2500",93),Spec$$module$js$maze$spec(4113,125,"\u2534",349),Spec$$module$js$maze$spec(4352,126,"\u2510",89),Spec$$module$js$maze$spec(4353,120,"\u2524",345),Spec$$module$js$maze$spec(4368,122,"\u252c",1437),Spec$$module$js$maze$spec(4369,119,"\u253c",5533),Spec$$module$js$maze$spec(61936,124,"\u2564","fixed",9),Spec$$module$js$maze$spec(61440,
127,"\u255d","fixed"),Spec$$module$js$maze$spec(240,127,"\u255a","fixed"),Spec$$module$js$maze$spec(65552,118,"\u2576","fixed","flag",13),Spec$$module$js$maze$spec(65792,-2,"\u2577","fixed","flag",9),Spec$$module$js$maze$spec(65808,-4,"\u250c","fixed","flag",157),Spec$$module$js$maze$spec(69632,123,"\u2574","fixed","flag",5),Spec$$module$js$maze$spec(69648,-6,"\u2500","fixed","flag",93),Spec$$module$js$maze$spec(69888,126,"\u2510","fixed","flag",89),Spec$$module$js$maze$spec(69904,122,"\u252c","fixed",
"flag",1437)],GOA1_SCREENS$$module$js$maze$spec=[Spec$$module$js$maze$spec(0,128," "),Spec$$module$js$maze$spec(17,224,"\u2514","flag",31,46,61),Spec$$module$js$maze$spec(257,228,"\u2502","flag",1194411),Spec$$module$js$maze$spec(272,226,"\u250c","flag",157,174,191),Spec$$module$js$maze$spec(4097,225,"\u2518","flag",21,38,55),Spec$$module$js$maze$spec(4112,234,"\u2500",93,110,127),Spec$$module$js$maze$spec(4113,231,"\u2534","flag",21,622,61,127),Spec$$module$js$maze$spec(4352,227,"\u2510","flag",
91,106,121),Spec$$module$js$maze$spec(4368,232,"\u252c","flag",93,1710,121,191),Spec$$module$js$maze$spec(4369,230,"\u253c","flag",21,9902,61,121,191),Spec$$module$js$maze$spec(65553,224,"\u2514","fixed",46,61),Spec$$module$js$maze$spec(65793,228,"\u2502","fixed",4779),Spec$$module$js$maze$spec(65808,226,"\u250c","fixed",174,191),Spec$$module$js$maze$spec(69633,225,"\u2518","fixed",21,38),Spec$$module$js$maze$spec(69649,231,"\u2534","fixed",622,127),Spec$$module$js$maze$spec(69888,227,"\u2510","fixed",
106,121),Spec$$module$js$maze$spec(69904,232,"\u252c","fixed",93,1710),Spec$$module$js$maze$spec(69905,230,"\u253c","fixed",21,9902,191),Spec$$module$js$maze$spec(131329,229,"\u250a","fixed","flag",5019),Spec$$module$js$maze$spec(196865,229,"\u250a","fixed",57),Spec$$module$js$maze$spec(61681,113,"\u257d","fixed",42),Spec$$module$js$maze$spec(240,128,"\u2588","fixed"),Spec$$module$js$maze$spec(61440,128,"\u2588","fixed"),Spec$$module$js$maze$spec(65520,115,"\u2550","fixed"),Spec$$module$js$maze$spec(61951,
114,"\u2564","fixed"),Spec$$module$js$maze$spec(4080,128,"\u2554","fixed"),Spec$$module$js$maze$spec(65280,128,"\u2557","fixed"),Spec$$module$js$maze$spec(255,128,"\u255a","fixed"),Spec$$module$js$maze$spec(61455,128,"\u255d","fixed")],ALL_CAVE_SCREENS$$module$js$maze$spec=[BASIC_CAVE_SCREENS$$module$js$maze$spec,BOSS_CAVE_SCREENS$$module$js$maze$spec,RIVER_SCREENS$$module$js$maze$spec,WIDE_SCREENS$$module$js$maze$spec,PIT_SCREENS$$module$js$maze$spec,SPIKE_SCREENS$$module$js$maze$spec],BITCOUNT$$module$js$maze$spec=
[0,1,1,2,1,2,2,3,1,2,2,3,2,3,3,4],DEAD_ENDS$$module$js$maze$spec=new Set([155,156,240,241]);
class SpecSet$$module$js$maze$spec{constructor(a,b){this.specSets=a;this.empty=b;this.fixedTiles=new Map;this.edgesByTile=new Map;this.stairsByTile=new Map;this.stairScreens=new Map;this.walls=new Set;for(const b of module$js$util.iters.concat(...a)){for(const c of module$js$maze$types.Dir.ALL)(a=b.edges>>module$js$maze$types.Dir.shift(c)&15)&&7!=(a&7)&&this.edgesByTile.set(b.tile,(this.edgesByTile.get(b.tile)||0)|1<<c);for(const a of b.stairs)this.stairsByTile.set(b.tile<<8|(a.entrance&61440)>>8|
(a.entrance&240)>>4,a.dir),this.stairScreens.set(b.edges,[a.dir,{entrance:a.entrance,exits:[a.exit,a.exit+1]}]);b.wall&&this.walls.add(b.tile);128!=b.tile&&b.fixed&&this.fixedTiles.set(b.tile,b)}}survey(a){let b=0,c=0,d=0,e=0,f=!0,g=!1;const h=new Map,k=new Map,l=new Map,m=new Multiset$$module$js$util,n=[];this.empty&&n.push(this.empty);var r=new Set([].concat(...a.screens));for(var p of this.specSets)for(var q of p)if(128!==q.tile&&r.has(q.tile)){n.push(...p);break}r=new Set([...a.reachableTiles(!0).keys()].map((a)=>
a>>>8));p=new Map(a.entrances.map((b,c)=>{for(const d of a.exits)if(20>Math.abs(d.x-b.x)&&20>Math.abs(d.y-b.y))return[c,d.dest<<8|d.entrance];return null}).filter(isNonNull$$module$js$util));for(q=0;q<a.entrances.length;q++){var u=a.entrances[q],t=this.stairsByTile.get(a.screens[u.screen>>>4][u.screen&15]<<8|u.tile);if(null!=t){var z=p.get(q);if(null==z)throw Error("Could not find exit");h.set(u.screen,{entrance:q,exit:z,dir:t})}}for(q=0;q<a.height;q++)for(u=0,q||(u|=1),q===a.height-1&&(u|=4),t=0;t<
a.width;t++){z=q<<4|t;if(!r.has(z))continue;u&=-11;t||(u|=8);t===a.width-1&&(u|=2);var y=a.screens[q][t];m.add(y);if(128===y)continue;WIDE_SET$$module$js$maze$spec.has(y)?g=!0:f=!1;b++;let n=this.edgesByTile.get(y);if(null==n)throw Error(`Bad tile: ${hex$$module$js$rom$util(y)}`);var v=BITCOUNT$$module$js$maze$spec[n]+(h.has(z)?1:0);154===y&&(v=2);if(155===y||156==y||240==y||241==y)v=1;1===v&&c++;2<v&&(d+=v-2);this.walls.has(y)&&e++;v=this.fixedTiles.get(y);DEAD_ENDS$$module$js$maze$spec.has(y)&&
(n=0);for(const b of module$js$maze$types.Dir.ALL)if(n&u&1<<b){y=null;for(var w=0;w<a.entrances.length;w++)if(a.entrances[w].screen===z&&matchesDir$$module$js$maze$spec(a.entrances[w].tile,b)){y=w;break}if(null!=y){w=p.get(y);if(null==w)throw Error("Could not find exit");k.set(z,{entrance:y,exit:w,dir:b})}}null!=v&&l.set(z,v)}if(f!=g)throw Error("Found inconsistent use of wide tiles");return{size:b,deadEnds:c,branches:d,walls:e,stairs:h,edges:k,fixed:l,tiles:m,wide:f,specs:n,specSet:this}}}
SpecSet$$module$js$maze$spec.CAVE=new SpecSet$$module$js$maze$spec(ALL_CAVE_SCREENS$$module$js$maze$spec,EMPTY_CAVE_SCREEN$$module$js$maze$spec);function matchesDir$$module$js$maze$spec(a,b){return 0===b?4>a>>>4:1===b?13<(a&15):2===b?12<a>>>4:3===b?2>(a&15):!1}function readScreen$$module$js$maze$spec(a){const b=a.split(/ +/g).map((a)=>parseInt(a,16));for(const c of b)if("number"!=typeof c||isNaN(c))throw Error(`Bad screen: ${c} in ${a}`);return b}
function write2d$$module$js$maze$spec(a,b,c){for(let d=0;d<c.length;d++)for(let e=0;e<c[d].length;e++){const f=c[d][e];null!=f&&(a[b+(d<<4|e)]=f)}}var module$js$maze$spec={};module$js$maze$spec.Spec=Spec$$module$js$maze$spec;module$js$maze$spec.Stair=Stair$$module$js$maze$spec;module$js$maze$spec.Wall=Wall$$module$js$maze$spec;module$js$maze$spec.wall=wall$$module$js$maze$spec;module$js$maze$spec.bridge=bridge$$module$js$maze$spec;module$js$maze$spec.Poi=Poi$$module$js$maze$spec;
module$js$maze$spec.poi=poi$$module$js$maze$spec;module$js$maze$spec.EDGE_TYPES=EDGE_TYPES$$module$js$maze$spec;module$js$maze$spec.SWAMP_SCREENS=SWAMP_SCREENS$$module$js$maze$spec;module$js$maze$spec.GOA1_SCREENS=GOA1_SCREENS$$module$js$maze$spec;module$js$maze$spec.SpecSet=SpecSet$$module$js$maze$spec;module$js$maze$spec.readScreen=readScreen$$module$js$maze$spec;module$js$maze$spec.write2d=write2d$$module$js$maze$spec;class Location$$module$js$rom$location extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.mapDataPointer=82688+(b<<1);this.mapDataBase=readLittleEndian$$module$js$rom$util(a.prg,this.mapDataPointer)+49152;this.name=locationNames$$module$js$rom$location[this.id]||"";this.key=locationKeys$$module$js$rom$location[this.id]||"";this.used=49152<this.mapDataBase&&!!this.name;this.layoutBase=readLittleEndian$$module$js$rom$util(a.prg,this.mapDataBase)+49152;this.graphicsBase=readLittleEndian$$module$js$rom$util(a.prg,
...
h=[...concatIterables$$module$js$rom$util(b.exits),128|(b.pits.length?64:0)|b.entrances.length];var k=[...concatIterables$$module$js$rom$util(b.flags),255],l=concatIterables$$module$js$rom$util(b.pits),[m,n,r,p,q,u]=yield Promise.all([d(e,"Layout"),d(f,"Graphics"),d(g,"Entrances"),d(h,"Exits"),d(k,"Flags"),...l.length?[d(l,"Pits")]:[]]);e=[m&255,(m>>>8)-192,n&255,(n>>>8)-192,r&255,(r>>>8)-192,p&255,(p>>>8)-192,q&255,(q>>>8)-192,...u?[u&255,(u>>8)-192]:[]];d=yield d(e,"MapData");writeLittleEndian$$module$js$rom$util(a.rom,
...
module$js$maze$types.Scr.edge(c[1],c[2]);yield c}}*eligible(a,b){b=void 0===b?{}:b;const {skipAlternates:c,maxExits:d,edge:e,fuzzy:f,stair:g}=b;var h=null!=e?e|e<<4|e<<8|e<<12:void 0;let k=b=0,l=0;for(var m of module$js$maze$types.Dir.ALL){var n=module$js$maze$types.Dir.edgeMask(m),r=module$js$maze$types.Dir.edgeMask(module$js$maze$types.Dir.inv(m));let c=this.get(a,m);null==c&&(c=h);null!=c&&(l|=((c&r)>>>8|(c&r)<<8)&65535,b|=n,f&&this.isFixed(module$js$maze$types.Pos.plus(a,m))&&(k|=n))}f||(k=b);
a=l&k;m=[];h=Infinity;for(const e of this.screens){const [q,u]=e;if(!(u.fixed||c&&u.edges&-65536||null!=g&&!u.stairs.some((a)=>a.dir===g)||null==g&&u.stairs.length||(q&k)!==a||d&&module$js$maze$types.Scr.numExits(q)>d))if(f){n=0;r=q&b^l;for(const a of module$js$maze$types.Dir.ALL)r&15<<module$js$maze$types.Dir.shift(a)&&n++;n<h?(h=n,m=[q]):n===h&&m.push(q)}else yield q}f&&(yield*m)}fill(a,b){b=void 0===b?{}:b;if(b.force&&b.fuzzy)throw Error("invalid");const c=[...this.eligible(a,b)];if(!c.length){if(b.deleteNeighbors)for(const c of module$js$maze$types.Dir.ALL)b=
module$js$maze$types.Pos.plus(a,c),this.isFixed(b)||this.setInternal(b,null);return!1}if(b.fuzzy)return this.setAndUpdate(a,this.random.pick(c),b);this.set(a,this.random.pick(c),b);return!0}fillPath(a,b,c,d,e){e=void 0===e?{}:e;return this.saveExcursion(()=>{var f=[...c];for(const c of f){f=module$js$maze$types.Dir.turn(b,c);a=module$js$maze$types.Pos.plus(a,b);const g=module$js$maze$types.Scr.fromExits(module$js$maze$types.DirMask.of(module$js$maze$types.Dir.inv(b),f),d);if(!this.trySet(a,g,e))return!1;
b=f}return this.fill(module$js$maze$types.Pos.plus(a,b),Object.assign({},e,{maxExits:2}))})}fillAll(a){a=void 0===a?{}:a;const b=a.shuffleOrder?this.random.shuffle([...this.allPos]):this.allPos;for(const c of b)if(null==this.map[c]&&!this.fill(c,a)){if(a.fuzzy)return!1;throw Error(`Could not fill ${hex$$module$js$rom$util(c)}`);}return!0}randomPos(){return this.random.pick(this.allPosArray)}addScreen(a){for(const b of this.random.shuffle([...this.allPos]))if(null==this.map[b]&&this.trySet(b,a))return b}addDeadEnd(){return!1}addLoop(){var a=
new DefaultMap$$module$js$util(()=>[]);for(var b of this.extensions()){const [c,d,e,f]=b;a.get(f).push([c,d,e,f&15])}a=[...a.values()];this.random.shuffle(a);do if(b=a.pop(),!b)return!1;while(2>b.length);this.random.shuffle(b);const [[c,d,e,f],[g,h,k]]=b;return this.saveExcursion(()=>{this.replace(c,d);this.replace(g,h);var a=module$js$maze$types.Pos.plus(g,k);if(module$js$maze$types.Pos.plus(c,e)===a)return this.fill(a,{maxExits:2,replace:!0});const [b,n]=module$js$maze$types.Pos.relative(c,e,a);
a=0;for(const d of module$js$maze$types.Path.generate(this.random,b,n)){if(this.fillPath(c,e,d,f,{replace:!0}))break;if(20<++a)return!1}return!0})}connect(a,b,c,d){null==b&&(b=this.findEmptyDir(a));if(null==b)return!1;const e=module$js$maze$types.Scr.edge(this.map[a]||0,b);if(null==c){c=[];for(var f of this.extensions()){const [a,b,,d]=f;(d&15)===e&&c.push([a,b,0])}if(!c.length)return!1;f=this.random.pick(c);this.replace(c=f[0],f[1])}null==d&&(d=this.findEmptyDir(c));if(null==b||null==d)return!1;
if(e!==module$js$maze$types.Scr.edge(this.map[c]||0,d))throw Error("Incompatible exit types");c=module$js$maze$types.Pos.plus(c,d);const [g,h]=module$js$maze$types.Pos.relative(a,b,c);d=0;for(const c of module$js$maze$types.Path.generate(this.random,g,h)){if(this.fillPath(a,b,c,e))break;if(20<++d)return!1}return!0}findEmptyDir(a){const b=this.map[a];if(null==b)return null;const c=[];for(const d of module$js$maze$types.Dir.ALL)module$js$maze$types.Scr.edge(b,d)&&this.empty(module$js$maze$types.Pos.plus(a,
d))&&c.push(d);return 1===c.length?c[0]:null}inBounds(a){return 0<=a&&(a&15)<this.width&&a>>>4<this.height}isFixed(a){if(!this.inBounds(a))return!0;a=this.map[a];if(null==a)return!1;a=this.screens.get(a);return!(null==a||!a.fixed&&!a.stairs.length)}density(){return this.allPosArray.filter((a)=>this.map[a]).length/(this.width*this.height)}size(){return this.allPosArray.filter((a)=>this.map[a]).length}trim(){const a=new Set;for(var b of this.screens.values())b.edges||a.add(b.tile);b=(b)=>!this.map[b]||
a.has(this.screens.get(this.map[b]).tile);for(const a=0;seq$$module$js$rom$util(this.width,(b)=>a<<4|b).every(b);)this.map.splice(0,16),this.border.splice(0,16),this.height--;for(let a=this.height-1;0<=a&&seq$$module$js$rom$util(this.width,(b)=>a<<4|b).every(b);a--)this.map.splice(this.height-1<<4,16),this.border.splice(this.height-1<<4,16),this.height--;for(const a=0;seq$$module$js$rom$util(this.height,(b)=>b<<4|a).every(b);){for(var c=this.height-1;0<=c;c--)delete this.map[c<<4|a],this.border[c<<
4|a]=0;this.map.push(this.map.shift());this.width--}for(let a=this.width-1;0<=a&&seq$$module$js$rom$util(this.height,(b)=>b<<4|a).every(b);a--){for(c=this.height-1;0<=c;c--)delete this.map[c<<4|a],this.border[c<<4|a]=0;this.width--}}*[Symbol.iterator](){for(const a of this.allPos){const b=this.map[a];null!=b&&(yield[a,b])}}get(a,b){const c=null!=b?module$js$maze$types.Pos.plus(a,b):a;return this.inBounds(c)?this.map[c]:this.border[a]&15<<((b^2)<<2)}getEdge(a,b){a=this.map[a];if(null!=a)return a>>
module$js$maze$types.Dir.shift(b)&15}getSpec(a){a=this.map[a];return null!=a?this.screens.get(a):a}setBorder(a,b,c){if(!this.inBounds(a)||this.inBounds(module$js$maze$types.Pos.plus(a,b)))throw Error(`Not on border: ${hex$$module$js$rom$util(a)}, ${b}`);if(null!=this.map[a])throw Error("Must set border first.");b=(b^2)<<2;if(this.border[a]&15<<b)throw Error("Border already set");this.border[a]|=c<<b}replaceEdge(a,b,c){const d=module$js$maze$types.Pos.plus(a,b);if(!this.inBounds(a))throw Error(`Out of bounds ${hex$$module$js$rom$util(a)}`);
if(!this.inBounds(d))throw Error(`Out of bounds ${hex$$module$js$rom$util(d)}`);let e=this.map[a],f=this.map[d];if(null==e)throw Error(`No screen for ${hex$$module$js$rom$util(a)}`);if(null==f)throw Error(`No screen for ${hex$$module$js$rom$util(d)}`);const g=module$js$maze$types.Dir.edgeMask(b),h=c<<module$js$maze$types.Dir.shift(b),k=module$js$maze$types.Dir.edgeMask(module$js$maze$types.Dir.inv(b));b=c<<module$js$maze$types.Dir.shift(module$js$maze$types.Dir.inv(b));e=e&~g|h;f=f&~k|b;if(!this.screens.has(e)||
!this.screens.has(f))return!1;this.setInternal(a,e);this.setInternal(d,f);return!0}setAndUpdate(a,b,c){c=void 0===c?{}:c;return this.saveExcursion(()=>{const d=Object.assign({},c,{fuzzy:c.fuzzy&&c.fuzzy-1,replace:!0});this.setInternal(a,b);for(const b of module$js$maze$types.Dir.ALL)if(!this.checkFit(a,b)){const c=module$js$maze$types.Pos.plus(a,b);if(this.isFixed(c)||!this.fill(c,d))return!1}return!0})}set(a,b,c){c=void 0===c?{}:c;if(!(c.force||(c.replace?this.fits(a,b):this.fitsAndEmpty(a,b))))throw c=
this.map[a],c=null!=c?hex5$$module$js$rom$util(c):"empty",Error(`Cannot overwrite ${hex$$module$js$rom$util(a)} (${c}) with ${hex5$$module$js$rom$util(b)}`);if(!this.screens.has(b))throw Error(`No such screen ${hex5$$module$js$rom$util(b)}`);this.inBounds(a)&&this.setInternal(a,b)}trySet(a,b,c){c=void 0===c?{}:c;if(!(c.force||(c.replace?this.fits(a,b):this.fitsAndEmpty(a,b))))return!1;if(!this.screens.has(b))throw Error(`No such screen ${hex5$$module$js$rom$util(b)}`);this.setInternal(a,b);return!0}replace(a,
b){if(!this.fits(a,b)||!this.inBounds(a))throw Error(`Cannot place ${hex5$$module$js$rom$util(b)} at ${hex$$module$js$rom$util(a)}`);if(!this.screens.has(b))throw Error(`No such screen ${hex5$$module$js$rom$util(b)}`);this.setInternal(a,b)}setInternal(a,b){const c=this.map[a];null==b?(this.map[a]=void 0,this.counts&&null!=c&&this.counts.delete(c)):(this.map[a]=b,this.counts&&(null!=c&&this.counts.delete(c),this.counts.add(b)))}fitsAndEmpty(a,b){return this.empty(a)&&this.fits(a,b)}empty(a){return null==
this.map[a]&&this.inBounds(a)}fits(a,b){for(const c of module$js$maze$types.Dir.ALL){const d=this.get(a,c);if(null!=d&&module$js$maze$types.Scr.edge(b,c)!==module$js$maze$types.Scr.edge(d,module$js$maze$types.Dir.inv(c)))return!1}return!0}checkFit(a,b){const c=this.get(a);a=this.get(a,b);return null==c||null==a?!0:module$js$maze$types.Scr.edge(c,b)!==module$js$maze$types.Scr.edge(a,module$js$maze$types.Dir.inv(b))?!1:!0}traverse(a){a=void 0===a?{}:a;var b=new Set(a.without||[]);const c=!a.noFlagged;
a=new UnionFind$$module$js$unionfind;for(const g of this.allPos)if(!b.has(g)){var d=this.map[g];if(null!=d&&(d=this.screens.get(d),null!=d)){for(var e of d.connections)a.union(e.map((a)=>(g<<8)+a));if(d.wall)for(var f of d.wall.connections(c))a.union(f.map((a)=>(g<<8)+a))}}b=new Map;a=a.sets();for(e=0;e<a.length;e++){f=a[e];for(const a of f)b.set(a,f)}return b}consolidate(a,b,c){if(!this.counts||!this.extraTiles)throw Error("Cannot run consolidate without counts.");var d=new Set(a);const e=new Set;
for(var f of this.screens.values())f.fixed||(0>f.tile||d.has(f.tile))&&e.add(f.edges);d=new Set;for(var g of this.counts)[f]=g,e.has(f)||d.add(f);g=d.size+a.length;for(d=1E3;this.counts.unique()>g&&--d;){var h=[...this.counts].filter((a)=>e.has(a[0])).sort((a,b)=>b[1]-a[1]).map((a)=>a[0]);f=new Set(h.slice(0,a.length));h=new Set(h.slice(a.length));const c=this.random.shuffle([...this.allPos]);for(var k of c)if(h.has(this.map[k])&&this.tryConsolidate(k,f,h,b))break}if(!d)return!1;b=new Set([...this.counts].filter((a)=>
e.has(a[0])).map((a)=>a[0]));a=[];for(var l of e){k=this.screens.get(l);if(!k)throw Error("missing spec");0<=k.tile&&(b.has(l)?b.delete(l):a.push(k.tile))}for(const d of b){l=a.pop();b=this.screens.get(d);if(null==l||!b)throw Error("No available screen");c.screens[l].tiles.splice(0,240,...this.extraTiles[~b.tile]);this.extraTilesMap[~b.tile]=l}return!0}tryConsolidate(a,b,c,d){const e=this.map[a];if(null==e)throw Error("Expected defined");for(const g of this.random.shuffle([...b])){const h=e^g;for(const e of module$js$maze$types.Dir.ALL){var f=
module$js$maze$types.Dir.edgeMask(e);if(h&~f)continue;const k=module$js$maze$types.Pos.plus(a,e);f=this.map[k];if(null==f)break;if(!c.has(f)&&!b.has(f))break;const m=g>>>module$js$maze$types.Dir.shift(e)&15,n=module$js$maze$types.Dir.inv(e),r=module$js$maze$types.Dir.edgeMask(n),p=f&~r|m<<module$js$maze$types.Dir.shift(n);if(c.has(p)&&!c.has(f))break;if(this.saveExcursion(()=>{this.setInternal(a,g);this.setInternal(k,p);return d()}))return!0}}return!1}show(){const a=" "+seq$$module$js$rom$util(this.width).join("")+
"\n",b=seq$$module$js$rom$util(this.height,(a)=>a.toString(16)+seq$$module$js$rom$util(this.width,(b)=>{b=this.map[a<<4|b];if(null==b)return" ";var c=this.screens.get(b);if(c)return c.icon;c=0;for(const a of module$js$maze$types.Dir.ALL)b&15<<(a<<2)&&(c|=1<<(a<<2));return UNICODE_TILES$$module$js$maze$maze[c]||" "}).join("")).join("\n");return a+b}write(a,b){for(var c of a.flags)b.add(c.flag);c=0;const d={wall:[],bridge:[]};for(var e of a.spawns){var f=e.wallType();f&&d[f].push(e);"wall"===f&&(c=
e.wallElement())}a.flags=[];a.width=this.width;a.height=this.height;for(e=0;e<this.height;e++)for(a.screens[e]=[],f=0;f<this.width;f++){const h=e<<4|f;var g=this.map[h];if(null==g)throw Error(`Missing screen at pos ${hex$$module$js$rom$util(h)}`);const k=this.screens.get(g);if(!k)throw Error(`Missing spec for ${hex5$$module$js$rom$util(g)} at ${hex$$module$js$rom$util(h)}`);a.screens[e].push(0>k.tile?this.extraTilesMap[~k.tile]:k.tile);k.flag&&a.flags.push(Flag$$module$js$rom$location.of({screen:h,
flag:751}));k.wall&&(a.flags.push(Flag$$module$js$rom$location.of({screen:h,flag:pop$$module$js$maze$maze(b)})),(g=d[k.wall.type].pop())||(g=Spawn$$module$js$rom$location.of({screen:h,tile:k.wall.tile,type:3,id:"wall"===k.wall.type?c:2}),a.spawns.push(g)),g.screen=h,g.tile=k.wall.tile)}}finish(a,b){this.trim();this.write(b,new Set);a=new MazeFinisher$$module$js$maze$maze(this,b,a,this.random);a.shuffleFixed();a.placeExits();a.placeNpcs();b.rom.spoiler&&b.rom.spoiler.addMaze(b.id,b.name,this.show());
return!0}}
class MazeFinisher$$module$js$maze$maze{constructor(a,b,c,d){this.maze=a;this.loc=b;this.survey=c;this.random=d;this.poi=new DefaultMap$$module$js$util(()=>[]);this.fixedPos=new DefaultMap$$module$js$util(()=>[]);this.posMapping=new Map;this.allEdges=[[],[],[],[]];this.fixedEdges=[[],[],[],[]];this.allStairs=[[],[],[],[]];this.stairDisplacements=new Map;for(var e of a){const [a,b]=e;d=this.maze.getSpec(a);d.fixed&&this.fixedPos.get(b).push(a);for(const b of d.poi){const {priority:c,dy:d,dx:e}=b;this.poi.get(c).push([((a&
240)<<4)+d,((a&15)<<8)+e])}}for(const d of module$js$maze$types.Dir.ALL)for(const f of module$js$maze$types.Dir.allEdge(d,a.height,a.width))(e=a.get(f))&&(e=module$js$maze$types.Scr.edge(e,d))&&7!=e&&(c.specSet.fixedTiles.has(b.screens[f>>4][f&15])?this.fixedEdges[d].push(f):this.allEdges[d].push(f));for(const b of a){const [d,e]=b;a=c.specSet.stairScreens.get(e);null!=a&&this.allStairs[a[0]].push([d,a[1]])}}shuffleFixed(){for(var a of this.fixedPos.values())this.random.shuffle(a);for(const b of this.survey.fixed){const [c,
d]=b;a=this.fixedPos.get(d.edges).pop();if(null==a)throw Error("Unreplaced fixed screen");this.posMapping.set(c,a)}}placeExits(){this.loc.exits=[];for(var a of module$js$maze$types.Dir.ALL)this.random.shuffle(this.allEdges[a]),this.random.shuffle(this.fixedEdges[a]);this.random.shuffle(this.allStairs[module$js$maze$types.Dir.UP]);this.random.shuffle(this.allStairs[module$js$maze$types.Dir.DOWN]);for(var b of this.survey.edges){const [e,f]=b;a=(this.survey.fixed.has(e)?this.fixedEdges:this.allEdges)[f.dir].pop();
if(null==a)throw Error("missing edge");this.posMapping.set(e,a);var c=module$js$maze$types.Scr.edge(this.maze.get(a),f.dir);c=EDGE_TYPES$$module$js$maze$spec[c][f.dir];this.loc.entrances[f.entrance]=Entrance$$module$js$rom$location.of({screen:a,coord:c.entrance});for(var d of c.exits)this.loc.exits.push(Exit$$module$js$rom$location.of({screen:a,tile:d,dest:f.exit>>>8,entrance:f.exit&255}))}for(const e of this.survey.stairs){const [f,g]=e;b=this.allStairs[g.dir].pop();if(null==b)throw Error("missing stair");
this.posMapping.set(f,b[0]);d=this.loc.entrances[g.entrance];a=d.tile&15;c=d.tile>>>4;d.screen=b[0];d.coord=b[1].entrance;this.stairDisplacements.set(f,[(d.tile>>>4)-c,(d.tile&15)-a]);for(const a of b[1].exits)this.loc.exits.push(Exit$$module$js$rom$location.of({screen:b[0],tile:a,dest:g.exit>>>8,entrance:g.exit&255}))}}placeMonster(a,b){const c=this.loc.rom.objects[a.monsterId];c instanceof Monster$$module$js$rom$monster&&(b=b(c),null==b?(console.error(`no valid location for ${hex$$module$js$rom$util(c.id)} in ${hex$$module$js$rom$util(this.loc.id)}`),
...
const UNICODE_TILES$$module$js$maze$maze={4112:"\u2500",257:"\u2502",272:"\u250c",4352:"\u2510",17:"\u2514",4097:"\u2518",273:"\u251c",4353:"\u2524",4368:"\u252c",4113:"\u2534",4369:"\u253c",4096:"\u2574",1:"\u2575",16:"\u2576",256:"\u2577"};var module$js$maze$maze={};module$js$maze$maze.Maze=Maze$$module$js$maze$maze;function shuffleBridgeCave$$module$js$maze$cave(a,b,c,{attempts:d=100}={}){shuffleCave$$module$js$maze$cave(a,c,{attempts:d});shuffleCave$$module$js$maze$cave(b,c,{attempts:d})}function defaultCheck$$module$js$maze$cave(a){a=a.traverse();return 2<a.size&&a[Symbol.iterator]().next().value[1].size===a.size}
function shuffleCave$$module$js$maze$cave(a,b,c={}){function d(a,b){b=[...b];if(!a.connect(b[0],null,b[1],null))return!1;for(let c=2;c<b.length;c++)if(!a.connect(b[c]))return!1;console.log(a.show());a.fillAll({edge:0});return e(a)}function e(b){b.trim();b.write(a,new Set);return b.finish(k,a)}function f(a){const c=b.nextInt(a&1?m:l),d=a===module$js$maze$types.Dir.RIGHT?l-1:a===module$js$maze$types.Dir.DOWN?m-1:0;return a&1?c<<4|d:d<<4|c}let {attempts:g=50,check:h=defaultCheck$$module$js$maze$cave}=
c;39===a.id&&(h=cycleCaveCheck$$module$js$maze$cave);75===a.id&&(c.allowTightCycles=!0);if(75===a.id||84===a.id)h=cycleCaveCheck$$module$js$maze$cave;const k=SpecSet$$module$js$maze$spec.CAVE.survey(a),l=Math.min(a.width+1,8),m=Math.min(a.height+1,16),n=seq$$module$js$rom$util(l*m,(a)=>a%l|Math.floor(a/l)<<4),r=k.size/l/m;let p;p=function(a){let {walls:g}=k;var t=new Set;for(const [b,c]of k.edges)for(;;){var q=f(c.dir);if(!t.has(q)){t.add(q);var p=k.fixed.get(b);null==p?a.setBorder(q,c.dir,6):(a.setBorder(q,
c.dir,p.edges>>>module$js$maze$types.Dir.shift(c.dir)&15),fixBorders$$module$js$maze$cave(a,q,p.edges),a.set(q,p.edges),p.wall&&g--);break}}for(const [c,d]of k.fixed)if(!k.edges.has(c))for(const c of b.ishuffle(n))if(!t.has(c)&&a.saveExcursion(()=>{fixBorders$$module$js$maze$cave(a,c,d.edges);return a.trySet(c,d.edges)})){t.add(c);d.wall&&g--;break}q=[...k.stairs.values()];p=0;for(var v=0;10>p&&v<q.length;p++){const b=a.randomPos();!t.has(b)&&a.fill(b,{stair:q[v].dir})&&(t.add(b),p=0,v++)}if(10<=
p)return fail$$module$js$maze$cave("could not add all stairs");if(k.wide)return d(a,t);if(!a.fillAll({edge:1,fuzzy:1,shuffleOrder:!0,skipAlternates:!0}))return fail$$module$js$maze$cave("could not fill open");if(!h(a))return fail$$module$js$maze$cave("check failed after initial setup");const w={skipAlternates:!0};for(const [c]of b.shuffle([...a])){if(a.density()<=r)break;!a.isFixed(c)&&a.saveExcursion(()=>a.setAndUpdate(c,0,w)&&h(a))}if(!c.allowTightCycles)for(t=1;t<m;t++)for(q=1;q<l;q++)if(p=t<<
4|q,isTightCycle$$module$js$maze$cave(a,p)){v=!1;for(const c of b.ishuffle(module$js$maze$types.Dir.ALL)){const b=2>c?p-1:p-16;a.saveExcursion(()=>a.replaceEdge(b,c,0)&&h(a))&&(v=!0)}if(!v)return fail$$module$js$maze$cave("failed to remove tight cycle")}t=new Set;q=[...a.alternates()];for(const c of[140])if(k.tiles.count(c)){p=b.shuffle(q.filter((a)=>a[3].tile===c));if(p.length<k.tiles.count(c))return fail$$module$js$maze$cave("could not add stair hallway");for(v=k.tiles.count(c)-1;0<=v;v--)a.replace(p[v][0],
p[v][2]),t.add(p[v][0])}q=b.shuffle(q.filter((a)=>a[3].wall));for(p=0;p<g;p++){v=q.pop();if(null==v)return fail$$module$js$maze$cave(`could not add wall ${p}`);t.has(v[0])?p--:(a.replace(v[0],v[2]),t.add(v[0]))}return e(a)};for(let a=0;a<g;a++){const a=new Maze$$module$js$maze$maze(b,m,l,k.specs);if(p(a))return}throw Error("Could not shuffle");}function fail$$module$js$maze$cave(a){console.error(`Reroll: ${a}`);return!1}
...
function fixBorders$$module$js$maze$cave(a,b,c){try{for(const d of module$js$maze$types.Dir.ALL)a.inBounds(module$js$maze$types.Pos.plus(b,d))||7!==(c>>module$js$maze$types.Dir.shift(d)&7)||a.setBorder(b,d,7)}catch(d){}}var module$js$maze$cave={};module$js$maze$cave.shuffleBridgeCave=shuffleBridgeCave$$module$js$maze$cave;module$js$maze$cave.shuffleCave=shuffleCave$$module$js$maze$cave;function shuffleGoa1$$module$js$maze$goa(a,b,c=1500){extendGoaScreens$$module$js$maze$goa(a);const d=a.locations.goaFortressKelbesque;var e=d.width;const f=d.height;a:for(let l=0;l<c;l++){var g=function(a,b=65536){const c=l.get(a);if(null==c)throw Error(`Cannot flag empty screen ${hex$$module$js$rom$util(a)}`);l.replace(a,c|b);if(h())return!0;l.replace(a,c);return!1},h=function(){const a=l.traverse(),b=a.get(p);return!b||!q.filter((a)=>b.has(a)).length||b.size<.8*a.size?!1:!0},k=function(a,b){l.set(a,
b,{force:!0})};const l=new Maze$$module$js$maze$maze(b,f,e,GOA1_SCREENS$$module$js$maze$spec),n=f-1<<4|b.nextInt(e),r=b.nextInt(e),p=n<<8|2,q=[r+32<<8|1,r+32<<8|3];k(n,61681);k(n-1,240);k(n+1,61440);k(r,65520);k(r-1,4080);k(r+1,65280);k(r+16,61951);k(r+15,255);k(r+17,61455);if(!l.connect(n,module$js$maze$types.Dir.UP,r+16,module$js$maze$types.Dir.DOWN))continue a;if(257===l.get(r+32)||257===l.get(n-16))continue a;for(k=0;10>k&&.65>l.density();k++)l.addLoop()&&(k=0);if(.45>l.density())continue a;if(!h())continue a;
for(const [a,c]of l)if(257===c&&257===l.get(a+16)&&(k=b.shuffle([0,16]),!g(a+k[0],131072)&&!g(a+k[1],131072)))continue a;for(const [a,c]of b.shuffle([...l.alternates()]))g(a,c);l.fillAll({edge:0});d.moveScreen(6,r);d.moveScreen(131,n);l.write(d,new Set);b=d.monsterPlacer(b);for(const f of d.spawns)f.isMonster()&&(c=a.objects[f.monsterId],c instanceof Monster$$module$js$rom$monster&&(e=b(c),null==e?(console.error(`no valid location for ${hex$$module$js$rom$util(c.id)} in ${hex$$module$js$rom$util(d.id)}`),
...
function extendGoaScreens$$module$js$maze$goa(a){for(var b of[140,164,168]){const c=a.tileset(b);c.alternates[25]=25;c.alternates[27]=27}a.swapMetatiles([164,140],[43,[25,197],-199],[56,[27,197],-197]);a.swapMetatiles([168],[[23,84],-26],[[24,88],-28]);a.swapMetatiles([136],[25,-198],[27,-198]);b=[[25,25],[27,27]];write2d$$module$js$maze$spec(a.screens[224].tiles,97,b);write2d$$module$js$maze$spec(a.screens[225].tiles,109,b);write2d$$module$js$maze$spec(a.screens[226].tiles,145,b);write2d$$module$js$maze$spec(a.screens[227].tiles,
...
function tryShuffleSwamp$$module$js$maze$swamp(a,b,c,d,e){function f(){const a=d.traverse(),b=a.get(m);return b&&b.size===a.size||!1}const g=d.width,h=d.height,[k,l]=(()=>{let a,c;do a=b.nextInt(g),c=b.nextInt(h);while(2>a||2>c);return[a,c<<4]})();d.setBorder(l,module$js$maze$types.Dir.LEFT,1);d.set(k,61936,{force:!0});d.set(k-1,240,{force:!0});d.set(k+1,61440,{force:!0});d.fillAll({edge:1});const m=l<<8|16;var n=[...d].map((a)=>a[0]);for(var r=Math.floor(.6*g*h);r;r--){const a=b.pick(n),c=b.pick(module$js$maze$types.Dir.ALL),
...
17!==b&&272!==b&&4352!==b&&4097!==b||n.push(a));var u=a.screens[c.screens[p>>4][p&15]].tiles;r=0;for(let a=0;240>a;a++)if(3===u[a]){r=a;break}c.entrances[1].screen=p;c.entrances[1].tile=r+17;for(u=0;2>u;u++)c.exits[5+u].screen=p,c.exits[5+u].tile=r+u;e=b.pick(e.length?e:n);c.spawns[1].screen=e;e=c.monsterPlacer(b);for(const b of c.spawns)b.isMonster()&&(n=a.objects[b.monsterId],n instanceof Monster$$module$js$rom$monster&&(r=e(n),null==r?(console.error(`no valid location for ${hex$$module$js$rom$util(n.id)} in ${hex$$module$js$rom$util(c.id)}`),
...
0;g.length&&h<MAX_TABLE_LENGTH$$module$js$rom$messages;){e.has(g[0].str)&&(g.sort(f),e.clear());const {str:n,saving:r,missing:p,words:q,chains:u}=g.shift();if(0>=r)break;h+=n.length+3;k=a.length;l=new Set;for(const a of q){m=b[a];for(const a of[m.mid,...d.get(m.mid)||[]])l.add(a)}a.push({bytes:128>k?[k+128]:[5,k-128],mids:l,str:n});for(const a of q)for(k=0;k<=u;k++){l=b[a+k];m=l.bytes-(k?0:p);for(const a of l.suffixes)a.saving-=m-l.used,e.add(a.str);l.used=m}if(128===a.length){for(const a of c.values())a.saving-=
...
r.get(c.monsterClass);if(null!=d&&d!==a.id)return!1}d=FLYERS$$module$js$patch.has(a.id);var h=MOTHS_AND_BATS$$module$js$patch.has(a.id);if(d){if(!m)return!1;--m}const l=b.getMonsterConstraint(e.id,a.id);let q=n.tryMeet(l);!q&&Infinity>n.pal2.size&&Infinity>n.pal3.size&&this.flags.shuffleSpritePalettes()&&(q=n.tryMeet(l,!0));if(!q)return!1;if(p){var w=e.rom.objects[a.id];if(!(w instanceof Monster$$module$js$rom$monster))throw Error(`non-monster: ${w}`);w=p(w);if(null==w)return!1}g.push(`  Adding ${a.id.toString(16)}: ${q}`);
