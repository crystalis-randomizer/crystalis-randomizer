...
a.assumeGhettoFlight())),m=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),q=h(d("Assume teleport skip",a.assumeTeleportSkip())),p=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),t=h(d("Allow rabbit skip",!a.disableRabbitSkip())),u=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),A=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),J=h(d("Assume wild warp",a.assumeWildWarp())),
...
34,E,"Tunnel 2a (fork at start)")).cave().connect(Ea);(new Location$$module$js$nodes(c,34,E,"Tunnel 2b (left branch to dead end)")).cave().connect(dd,z).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,E,"Tunnel 2c (right branch to upper)")).cave().connect(dd,z),Hf=(new Location$$module$js$nodes(c,35,E,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(H,23,82),If=(new Location$$module$js$nodes(c,35,E,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,
z).connectTo(cd),ed=(new Location$$module$js$nodes(c,36,E,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,E,"Tunnel 4b (out to upper)")).cave().connect(ed,z).connectTo(cd);const Jf=(new Location$$module$js$nodes(c,37,E,"Tunnel 5 (tiny connector)")).cave().connect(ed),Kf=(new Location$$module$js$nodes(c,38,E,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);(new Location$$module$js$nodes(c,38,E,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,
z).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,E,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,E,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,z);(new Location$$module$js$nodes(c,39,E,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,z).chest(Ja,25);const hb=(new Location$$module$js$nodes(c,40,w,"Entrance")).overworld().connect(bd,Le,Ke),ib=(new Location$$module$js$nodes(c,40,w,"Upper")).overworld().from(hb,D).to(hb),
Ib=(new Location$$module$js$nodes(c,40,w,"Summit (boss)")).overworld().from(ib,D).to(ib).boss(bf),fd=(new Location$$module$js$nodes(c,41,w,"Connector")).overworld(),Jb=(new Location$$module$js$nodes(c,41,w,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,w,"Middle Right")).overworld().from(Jb,Pc).to(Jb),gd=(new Location$$module$js$nodes(c,42,w,"Tunnel 2a (from entrance to connector)")).cave().connectTo(fd);(new Location$$module$js$nodes(c,42,w,"Tunnel 2b (under bridge, to antidote)")).cave().connect(gd,
z).chest(N,23,94);const hd=(new Location$$module$js$nodes(c,43,w,"Tunnel 3a (branch after connector)")).cave().connect(fd),Of=(new Location$$module$js$nodes(c,43,w,"Tunnel 3b (right branch)")).cave().connect(hd,z),Pf=(new Location$$module$js$nodes(c,43,w,"Tunnel 3c (upper branch)")).cave().connect(hd,z);(new Location$$module$js$nodes(c,44,w,"Tunnel 4 (over bridge, to middle)")).cave().connect(Pf).connectTo(Jb);const id=(new Location$$module$js$nodes(c,45,w,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Of).connectTo(Nf);
(new Location$$module$js$nodes(c,45,w,"Tunnel 5b (dead-end with herb)")).cave().connect(id,z).chest(H,22,83);const Qf=(new Location$$module$js$nodes(c,46,w,"Tunne; 6a (S-shaped hall, right)")).cave().connect(id),Rf=(new Location$$module$js$nodes(c,46,w,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Qf,z),Sf=(new Location$$module$js$nodes(c,46,w,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Rf,z),jd=(new Location$$module$js$nodes(c,47,w,"Prison (hallway)")).cave().connect(ib),Tf=(new Location$$module$js$nodes(c,
48,w,"Left Cell (shopkeepers)")).cave().from(jd,z);(new Location$$module$js$nodes(c,49,w,"Left Cell 2 (back, with prison key)")).cave().from(Tf,z).chest(xb,13);const Uf=(new Location$$module$js$nodes(c,50,w,"Right Cell (villagers)")).cave().from(jd,z),Vf=(new Location$$module$js$nodes(c,51,w,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Uf,z);(new Location$$module$js$nodes(c,52,w,"Tunnel 9 (connector to summit)")).cave().connect(Vf).connectTo(Ib);const Wf=(new Location$$module$js$nodes(c,
53,w,"Summit Cave (front)")).cave().from(Ib,xb).to(Ib),Xf=(new Location$$module$js$nodes(c,53,w,"Summit Cave (behind ice)")).cave().connect(Wf,z).trigger(re);(new Location$$module$js$nodes(c,56,w,"Tunnel 1 (leads from main entrance)")).cave().connect(hb).connectTo(gd);(new Location$$module$js$nodes(c,57,w,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(ib);const Yf=(new Location$$module$js$nodes(c,60,db,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,db,"Tool Shop")).shop(H,N,P,U),$f=(new Location$$module$js$nodes(c,
...
if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return q[a.slotType?a.slotType[0]:"c"]===q[b.slotType?b.slotType[0]:"c"]};p=b.assumedFill(d,(a,b)=>t(a,n.get(b)));if(null==p){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const u=new Map;for(var A=0;A<p.length;A++){var J=p[A];if(null!=J){var x=n.get(b.item(J));J=l.get(x);l.delete(x);x=b.location(A);u.set(x,J);m.delete(x)}}A=(a,b,c)=>{c=void 0===c?"":c;for(const c of m)if(t(c,a))return u.set(c,b),m.delete(c),l.delete(a),!0;
g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var G of l){const [a,b]=G;if(a.isMimic()&&!A(a,b,"traps"))return!1}for(const a of l){const [b,c]=a;if(b.needsChest()&&!A(b,c,"chest"))return!1}for(const a of l){const [b,c]=a;if(!A(b,c))return!1}for(const a of u){const [b,c]=a;b.set(...c)}const {win:K,path:Qa}=a.traverse({wanted:k,dfs:!1});if(!K)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,p));e.items=
...
e.set(module$js$graph$geometry.ScreenId.from(b,a),a.id&3);for(let f=0,g=b.height;f<g;f++){const g=b.screens[f],h=b.id<<8|f<<4;for(let f=0,k=b.width;f<k;f++){var n=function(a,b){if(!q)throw Error("flag expected");return b?a?t(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(q.flag)},b):a};const k=a.screens[g[f]|r],l=module$js$graph$geometry.ScreenId(h|f),m=l&255,A=e.get(l),q=null!=A?c.wallCapability(A):b.flags.find((a)=>a.yx===m),t=memoize2$$module$js$graph$condition((a,
b)=>{if(!q)throw Error("flag expected");b=Object.assign({},b,{enter:meet$$module$js$graph$condition(b.enter||[[]],module$js$graph$condition.Condition(q.flag))});return module$js$graph$condition.Terrain.join(a,b)});for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(l<<8|a);let e=k.tiles[a];q&&751===q.flag&&32>e&&(e=p.alternates[e]);let f=c.makeTerrain(r?0:u.effects[e]&38,b);if(32>e&&p.alternates[e]!=e&&q&&751!==q.flag){const a=c.makeTerrain(u.effects[p.alternates[e]],b);f=n(f,a)}f&&d.set(b,
...
15]<<8|q.tile);null!=p&&g.set(q.screen,{entrance:n,exit:b(n),dir:p})}for(n=0;n<a.height;n++)for(q=0,n||(q|=1),n===a.height-1&&(q|=4),p=0;p<a.width;p++){const A=n<<4|p;if(!m.has(A))continue;q&=-11;p||(q|=8);p===a.width-1&&(q|=2);var r=a.screens[n][p];l.add(r);if(128===r)continue;c++;let J=EDGES_BY_TILE$$module$js$maze$cave.get(r);if(null==J)throw Error(`Bad tile: ${hex$$module$js$rom$util(r)}`);var t=BITCOUNT$$module$js$maze$cave[J]+(g.has(A)?1:0);154===r&&(t=2);if(155===r||156==r||240==r||241==r)t=
1;1===t&&d++;2<t&&(e+=t-2);WALLS$$module$js$maze$cave.has(r)&&f++;t=FIXED_TILES$$module$js$maze$cave.get(r);DEAD_ENDS$$module$js$maze$cave.has(r)&&(J=0);for(const c of module$js$maze$maze.Dir.ALL)if(J&q&1<<c){r=null;for(var u=0;u<a.entrances.length;u++)if(a.entrances[u].screen===A&&matchesDir$$module$js$maze$cave(a.entrances[u].tile,c)){r=u;break}null!=r&&(u=b(r),h.set(A,{entrance:r,exit:u,dir:c}))}null!=t&&k.set(A,t)}return{size:c,deadEnds:d,branches:e,walls:f,stairs:g,edges:h,fixed:k,tiles:l}}
...
function shuffleCave$$module$js$maze$cave(a,b,c={}){function d(c){c.trim();c.write(a,new Set);const d=new DefaultMap$$module$js$util(()=>[]),e=new Map;var f=new DefaultMap$$module$js$util(()=>[]);for(const [a,b]of c){var g=c.getSpec(a);g.fixed&&f.get(b).push(a);for(const {priority:b,dy:c,dx:e}of g.poi)d.get(b).push([((a&240)<<4)+c,((a&15)<<8)+e])}for(const [a,c]of n.fixed){g=b.shuffle(f.get(c.edges)).pop();if(null==g)throw Error("Unreplaced fixed screen");e.set(a,g)}a.exits=[];f=[[],[],[],[]];g=[[],
[],[],[]];for(var h of module$js$maze$maze.Dir.ALL){for(var k of module$js$maze$maze.Dir.allEdge(h,c.height,c.width)){var l=c.get(k);l&&(l=module$js$maze$maze.Scr.edge(l,h))&&7!=l&&(FIXED_TILES$$module$js$maze$cave.has(a.screens[k>>4][k&15])?g[h].push(k):f[h].push(k))}b.shuffle(f[h]);b.shuffle(g[h])}h=[[],[],[],[]];for(const [a,b]of c)k=STAIR_SCREENS$$module$js$maze$cave.get(b),null!=k&&h[k[0]].push([a,k[1]]);b.shuffle(h[module$js$maze$maze.Dir.UP]);b.shuffle(h[module$js$maze$maze.Dir.DOWN]);for(const [b,
d]of n.edges){k=(n.fixed.has(b)?g:f)[d.dir].pop();if(null==k)throw Error("missing edge");e.set(b,k);l=module$js$maze$maze.Scr.edge(c.get(k),d.dir);l=EDGE_TYPES$$module$js$maze$cave[l][d.dir];a.entrances[d.entrance]=Entrance$$module$js$rom$location.of({screen:k,coord:l.entrance});for(var m of l.exits)a.exits.push(Exit$$module$js$rom$location.of({screen:k,tile:m,dest:d.exit>>>8,entrance:d.exit&255}))}m=new Map;for(const [b,c]of n.stairs){f=h[c.dir].pop();if(null==f)throw Error("missing stair");e.set(b,
f[0]);g=a.entrances[c.entrance];k=g.tile&15;l=g.tile>>>4;g.screen=f[0];g.coord=f[1].entrance;m.set(b,[(g.tile>>>4)-l,(g.tile&15)-k]);for(var p of f[1].exits)a.exits.push(Exit$$module$js$rom$location.of({screen:f[0],tile:p,dest:c.exit>>>8,entrance:c.exit&255}))}p=new Map;h=a.monsterPlacer(b);for(const c of a.spawns)if(3!==c.type)if(c.isMonster())f=a.rom.objects[c.monsterId],f instanceof Monster$$module$js$rom$monster&&(g=h(f),null==g?(console.error(`no valid location for ${hex$$module$js$rom$util(f.id)} in ${hex$$module$js$rom$util(a.id)}`),
c.used=!1):(c.screen=g>>>8,c.tile=g&255));else if(f=c.screen,g=e.get(f),k=p.get(c.y<<12|c.x),null!=k)c.y=k>>>12,c.x=k&4095;else if(null!=g){if(c.screen=g,f=m.get(f),null!=f){const [a,b]=f;c.yt+=a;c.xt+=b}}else if(c.isTrigger())140===c.id?c.screen=e.get(33)-16:console.error(`unhandled trigger: ${c.id}`);else{f=[...d.keys()].sort((a,b)=>a-b);if(!f.length)throw Error("no poi");for(const a of f)if(f=d.get(a),f.length){g=c.y<<12|c.x;k=b.nextInt(f.length);[[c.y,c.x]]=f.splice(k,1);p.set(g,c.y<<12|c.x);
f.length||d.delete(a);break}}a.rom.spoiler&&a.rom.spoiler.addMaze(a.id,a.name,c.show());return!0}function e(a){const c=b.nextInt(a&1?l:k),d=a===module$js$maze$maze.Dir.RIGHT?k-1:a===module$js$maze$maze.Dir.DOWN?l-1:0;return a&1?c<<4|d:d<<4|c}let {attempts:f=50,check:g=defaultCheck$$module$js$maze$cave}=c;39===a.id&&(g=cycleCaveCheck$$module$js$maze$cave);75===a.id&&(c.allowTightCycles=!0);if(75===a.id||84===a.id)g=cycleCaveCheck$$module$js$maze$cave;const h=detectScreenSet$$module$js$maze$cave(a),
k=Math.min(a.width+1,8),l=Math.min(a.height+1,16),m=seq$$module$js$rom$util(k*l,(a)=>a%k|Math.floor(a/k)<<4),n=surveyMap$$module$js$maze$cave(a),q=n.size/k/l;let p;p=function(a){let {walls:f}=n;var h=new Set;for(const [b,c]of n.edges)for(;;){var p=e(c.dir);if(!h.has(p)){h.add(p);var r=n.fixed.get(b);null==r?a.setBorder(p,c.dir,6):(a.setBorder(p,c.dir,r.edges>>>module$js$maze$maze.Dir.shift(c.dir)&15),fixBorders$$module$js$maze$cave(a,p,r.edges),a.set(p,r.edges),r.wall&&f--);break}}for(const [c,d]of n.fixed)if(!n.edges.has(c))for(const c of b.ishuffle(m))if(!h.has(c)&&
a.saveExcursion(()=>{fixBorders$$module$js$maze$cave(a,c,d.edges);return a.trySet(c,d.edges)})){h.add(c);d.wall&&f--;break}p=[...n.stairs.values()];r=0;for(var x=0;10>r&&x<p.length;r++){const b=a.randomPos();!h.has(b)&&a.fill(b,{stair:p[x].dir})&&(h.add(b),r=0,x++)}if(10<=r)return fail$$module$js$maze$cave("could not add all stairs");if(!a.fillAll({edge:1,fuzzy:1,shuffleOrder:!0,skipAlternates:!0}))return fail$$module$js$maze$cave("could not fill open");if(!g(a))return fail$$module$js$maze$cave("check failed after initial setup");
const G={skipAlternates:!0};for(const [c]of b.shuffle([...a])){if(a.density()<=q)break;!a.isFixed(c)&&a.saveExcursion(()=>a.setAndUpdate(c,0,G)&&g(a))}if(!c.allowTightCycles)for(h=1;h<l;h++)for(p=1;p<k;p++)if(r=h<<4|p,isTightCycle$$module$js$maze$cave(a,r)){x=!1;for(const c of b.ishuffle(module$js$maze$maze.Dir.ALL)){const b=2>c?r-1:r-16;a.saveExcursion(()=>a.replaceEdge(b,c,0)&&g(a))&&(x=!0)}if(!x)return fail$$module$js$maze$cave("failed to remove tight cycle")}h=new Set;p=[...a.alternates()];for(const c of[140])if(n.tiles.count(c)){r=
b.shuffle(p.filter((a)=>a[3].tile===c));if(r.length<n.tiles.count(c))return fail$$module$js$maze$cave("could not add stair hallway");for(x=n.tiles.count(c)-1;0<=x;x--)a.replace(r[x][0],r[x][2]),h.add(r[x][0])}p=b.shuffle(p.filter((a)=>a[3].wall));for(r=0;r<f;r++){x=p.pop();if(null==x)return fail$$module$js$maze$cave(`could not add wall ${r}`);h.has(x[0])?r--:(a.replace(x[0],x[2]),h.add(x[0]))}return d(a)};for(let a=0;a<f;a++){const a=new Maze$$module$js$maze$maze(b,l,k,h);if(p(a))return}throw Error("Could not shuffle");
}function fail$$module$js$maze$cave(a){console.error(`Reroll: ${a}`);return!1}function cycleCaveCheck$$module$js$maze$cave(a){const b=[...a].filter((b)=>{b=[...a.traverse({without:[b[0]]})];return b[0][1].size===b.length});if(!b.length)return!1;for(let c=0;c<b.length;c++)for(let d=0;d<c;d++){const e=[...a.traverse({without:[b[c][0],b[d][0]]})];if(e[0][1].size!==e.length)return!0}return!1}
function isTightCycle$$module$js$maze$cave(a,b){const c=a.get(b-17)||0;a=a.get(b)||0;return!!(c&3840&&c&240&&a&61440&&a&15)}function fixBorders$$module$js$maze$cave(a,b,c){try{for(const d of module$js$maze$maze.Dir.ALL)a.inBounds(module$js$maze$maze.Pos.plus(b,d))||7!==(c>>module$js$maze$maze.Dir.shift(d)&7)||a.setBorder(b,d,7)}catch(d){}}var module$js$maze$cave={};module$js$maze$cave.shuffleBridgeCave=shuffleBridgeCave$$module$js$maze$cave;module$js$maze$cave.shuffleCave=shuffleCave$$module$js$maze$cave;function shuffleGoa1$$module$js$maze$goa(a,b,c=1500){extendGoaScreens$$module$js$maze$goa(a);const d=a.locations.goaFortressKelbesque;var e=d.width;const f=d.height,g=[Spec$$module$js$maze$maze(0,128," "),Spec$$module$js$maze$maze(17,224,"\u2514","flag",31,46,61),Spec$$module$js$maze$maze(257,228,"\u2502","flag",1194411),Spec$$module$js$maze$maze(272,226,"\u250c","flag",157,174,191),Spec$$module$js$maze$maze(4097,225,"\u2518","flag",21,38,55),Spec$$module$js$maze$maze(4112,234,"\u2500",93,110,127),
...
128,"\u2588","fixed"),Spec$$module$js$maze$maze(65520,115,"\u2550","fixed"),Spec$$module$js$maze$maze(61951,114,"\u2564","fixed"),Spec$$module$js$maze$maze(4080,128,"\u2554","fixed"),Spec$$module$js$maze$maze(65280,128,"\u2557","fixed"),Spec$$module$js$maze$maze(255,128,"\u255a","fixed"),Spec$$module$js$maze$maze(61455,128,"\u255d","fixed")];a:for(let m=0;m<c;m++){var h=function(a,b=65536){const c=m.get(a);if(null==c)throw Error(`Cannot flag empty screen ${hex$$module$js$rom$util(a)}`);m.replace(a,
c|b);if(k())return!0;m.replace(a,c);return!1},k=function(){const a=m.traverse(),b=a.get(r);return!b||!t.filter((a)=>b.has(a)).length||b.size<.8*a.size?!1:!0},l=function(a,b){m.set(a,b,{force:!0})};const m=new Maze$$module$js$maze$maze(b,f,e,g),q=f-1<<4|b.nextInt(e),p=b.nextInt(e),r=q<<8|2,t=[p+32<<8|1,p+32<<8|3];l(q,61681);l(q-1,240);l(q+1,61440);l(p,65520);l(p-1,4080);l(p+1,65280);l(p+16,61951);l(p+15,255);l(p+17,61455);if(!m.connect(q,0,p+16,2))continue a;if(257===m.get(p+32)||257===m.get(q-16))continue a;
console.log("first",m.show());for(l=0;10>l&&.65>m.density();l++)m.addLoop()&&(l=0);console.log(`loop\n${m.show()}`);if(.45>m.density())continue a;if(!k())continue a;for(const [a,c]of m)if(257===c&&257===m.get(a+16)&&(l=b.shuffle([0,16]),!h(a+l[0],131072)&&!h(a+l[1],131072)))continue a;for(const [a,c]of b.shuffle([...m.alternates()]))h(a,c);m.fillAll({edge:0});d.moveScreen(6,p);d.moveScreen(131,q);m.write(d,new Set);b=d.monsterPlacer(b);for(const f of d.spawns)f.isMonster()&&(c=a.objects[f.monsterId],
c instanceof Monster$$module$js$rom$monster&&(e=b(c),null==e?(console.error(`no valid location for ${hex$$module$js$rom$util(c.id)} in ${hex$$module$js$rom$util(d.id)}`),f.used=!1):(f.screen=e>>>8,f.tile=e&255)));a.spoiler&&a.spoiler.addMaze(d.id,d.name,m.show());return}throw Error(`unable to shuffle goa1 after ${c} attempts`);}
...
e=module$js$maze$maze.Pos.plus(a,c);!d.isFixed(a)&&!d.isFixed(e)&&d.get(a)&module$js$maze$maze.Dir.edgeMask(c)?d.saveExcursion(()=>d.replaceEdge(a,c,0)?!!(d.get(a)&&d.get(e)&&f()):!1):q++}if(!d.consolidate(e,f,a))return!1;const [p,r]=b.pick([...d.alternates()]);if(65536!=r)throw Error(`unexpected alt: ${hex$$module$js$rom$util(r)}`);d.replace(p,d.get(p)|r);c.moveScreen(48,l);c.moveScreen(4,k);d.write(c,new Set);e=[];n=[];for(const [a,b]of d)a!==k&&a!==p&&(1!==b&&16!==b&&256!==b&&4096!==b||e.push(a),
17!==b&&272!==b&&4352!==b&&4097!==b||n.push(a));var t=a.screens[c.screens[p>>4][p&15]].tiles;q=0;for(let a=0;240>a;a++)if(3===t[a]){q=a;break}c.entrances[1].screen=p;c.entrances[1].tile=q+17;for(t=0;2>t;t++)c.exits[5+t].screen=p,c.exits[5+t].tile=q+t;e=b.pick(e.length?e:n);c.spawns[1].screen=e;e=c.monsterPlacer(b);for(const b of c.spawns)b.isMonster()&&(n=a.objects[b.monsterId],n instanceof Monster$$module$js$rom$monster&&(q=e(n),null==q?(console.error(`no valid location for ${hex$$module$js$rom$util(n.id)} in ${hex$$module$js$rom$util(c.id)}`),
...
var m=Object.keys(k).filter((a)=>k[a]).map((a)=>`define ${a} 1\n`).join("");l.assemble(m,"flags.s");yield g("preshuffle.s");h=new Random$$module$js$random(h);m=new Rom$$module$js$rom(a);fixCoinSprites$$module$js$patch(m);"object"==typeof window&&(window.rom=m);m.spoiler=new Spoiler$$module$js$rom$spoiler(m);e&&(e.spoiler=m.spoiler);fixMimics$$module$js$patch(m);makeBraceletsProgressive$$module$js$patch(m);closeCaveEntrances$$module$js$patch(m,c);reversibleSwanGate$$module$js$patch(m);adjustGoaFortressTriggers$$module$js$patch(m);
preventNpcDespawns$$module$js$patch(m,c);c.requireHealedDolphinToRide()&&requireHealedDolphin$$module$js$patch(m);c.saharaRabbitsRequireTelepathy()&&requireTelepathyForDeo$$module$js$patch(m);adjustItemNames$$module$js$patch(m,c);yield g("postparse.s");alarmFluteIsKeyItem$$module$js$patch(m);c.teleportOnThunderSword()?teleportOnThunderSword$$module$js$patch(m):noTeleportOnThunderSword$$module$js$patch(m);m.scalingLevels=48;m.uniqueItemTableAddress=l.expand("KeyItemData");undergroundChannelLandBridge$$module$js$patch(m);
c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$patch(m);simplifyInvisibleChests$$module$js$patch(m);addCordelWestTriggers$$module$js$patch(m,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$js$patch(m);c.shuffleShops()&&shuffleShops$$module$js$patch(m,c,h);randomizeWalls$$module$js$patch(m,c,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(m,c,h);rescaleMonsters$$module$js$patch(m,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(m,c,h);shuffleTrades$$module$js$pass$shuffletrades(m,
c,h);c.randomizeMaps()&&shuffleMazes$$module$js$pass$shufflemazes(m,h);const n=World$$module$js$graph$world.build(m,c),q=yield(new AssumedFill$$module$js$graph$shuffle(m,c)).shuffle(n.graph,h,f);if(q)n.traverse(n.graph,q),update$$module$js$rom$slots(m,q.slots);else return-1;rescaleShops$$module$js$patch(m,l,c.bargainHunting()?h:void 0);normalizeSwords$$module$js$patch(m,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(m,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(m);c.doubleBuffMedicalHerb()?
(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(m);c.chargeShotsOnly()&&disableStabs$$module$js$patch(m);c.orbsOptional()&&orbsOptional$$module$js$patch(m);shuffleMusic$$module$js$patch(m,c,h);shufflePalettes$$module$js$pass$shufflepalettes(m,c,h);misc$$module$js$patch(m,c,h);fixDialog$$module$js$pass$fixdialog(m);fixReverseWalls$$module$js$pass$fixreversewalls(m);c.blackoutMode()&&blackoutMode$$module$js$patch(m);c.buffDyna()&&
buffDyna$$module$js$patch(m,c);yield m.writeData();buffDyna$$module$js$patch(m,c);return yield postParsedShuffle$$module$js$patch(a,h,b,c,l,g)})}function postParsedShuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){yield f("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(a,d,e);updateCoinDrops$$module$js$patch(a,d);shuffleRandomNumbers$$module$js$patch(a,b);return stampVersionSeedAndHash$$module$js$patch(a,c,d)})}
