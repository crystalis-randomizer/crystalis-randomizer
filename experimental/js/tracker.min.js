...
{var [c,d]=a;return`${b.whatFlag(c)}: ${D(d,b.whatFlag)}`}).join("\n"));b.reqs.check=(a,b)=>{b=void 0===b?E:b;return`${b(a)}: ${D(w.get(module$js$graph$condition.Slot(a)),b)}`};b.reqs.check2=(a)=>b.reqs.check(a,b.whatFlag)}let u=isItem$$module$js$graph$world;c&&(u=function(c){return isItem$$module$js$graph$world(c)||b.shuffleBossElements()&&a.bosses.isBossFlag(c)?!0:!1});return new World$$module$js$graph$world(a,q,makeGraph$$module$js$graph$world(w,a,u))}
...
t.tile&&r.has(t.tile)){q.push(...v);break}if(164===a.tileset)for(r=q.length-1;0<=r;r--)69648===q[r].edges&&q.splice(r,1);r=new Set([...a.reachableTiles(!0).keys()].map((a)=>a>>>8));if(!r.size)throw Error("No reachable tiles");v=new Map(a.entrances.map((b,c)=>{for(const d of a.exits)if(20>Math.abs(d.x-b.x)&&20>Math.abs(d.y-b.y))return[c,d.dest<<8|d.entrance];return null}).filter(isNonNull$$module$js$util));for(t=0;t<a.entrances.length;t++){var w=a.entrances[t],D=this.stairsByTile.get(a.screens[w.screen>>>
4][w.screen&15]<<8|w.tile);if(null!=D){var E=v.get(t);if(null==E)throw Error("Could not find exit");l.set(w.screen,{entrance:t,exit:E,dir:D})}}for(t=0;t<a.height;t++)for(w=0,t||(w|=1),t===a.height-1&&(w|=4),D=0;D<a.width;D++){E=t<<4|D;if(!r.has(E))continue;w&=-11;D||(w|=8);D===a.width-1&&(w|=2);var u=a.screens[t][D];p.add(u);if(128===u)continue;WIDE_SET$$module$js$maze$spec.has(u)?k=!0:h=!1;b++;RIVER_TILES$$module$js$maze$spec.has(u)&&g++;let q=this.edgesByTile.get(u);if(null==q)throw Error(`Bad tile: ${hex$$module$js$rom$util(u)}`);
var z=BITCOUNT$$module$js$maze$spec[q]+(l.has(E)?1:0);154===u&&(z=2);if(155===u||156==u||240==u||241==u)z=1;1===z&&c++;2<z&&(d+=z-2);z=this.walls.get(u);"wall"===z&&e++;"bridge"===z&&f++;z=this.fixedTiles.get(u);this.deadEndTiles.has(u)&&(q=0);for(var Y of module$js$maze$types.Dir.ALL)if(q&w&1<<Y){u=null;for(var Z=0;Z<a.entrances.length;Z++)if(a.entrances[Z].screen===E&&matchesDir$$module$js$maze$spec(a.entrances[Z].tile,Y)){u=Z;break}if(null!=u){Z=v.get(u);if(null==Z)throw Error("Could not find exit");
m.set(E,{entrance:u,exit:Z,dir:Y})}}null!=z&&n.set(E,z)}if(g)for(const [a,b]of n)29046===b.edges&&(Y=q.find((a)=>459009===a.edges))&&n.set(a,Y);if(h!=k)throw Error("Found inconsistent use of wide tiles");return{size:b,rivers:g,deadEnds:c,branches:d,walls:e,bridges:f,stairs:l,edges:m,fixed:n,tiles:p,wide:h,specs:q,specSet:this}}}SpecSet$$module$js$maze$spec.CAVE=new SpecSet$$module$js$maze$spec(ALL_CAVE_SCREENS$$module$js$maze$spec,EMPTY_CAVE_SCREEN$$module$js$maze$spec);
...
{area:(a)=>a.Crypt});this.Crypt_Hall1=$$$module$js$rom$location(161);this.Crypt_Branch=$$$module$js$rom$location(162);this.Crypt_DeadEndLeft=$$$module$js$rom$location(163);this.Crypt_DeadEndRight=$$$module$js$rom$location(164);this.Crypt_Hall2=$$$module$js$rom$location(165);this.Crypt_Draygon2=$$$module$js$rom$location(166);this.Crypt_Teleporter=$$$module$js$rom$location(167,{music:"Crypt-Teleporter"});this.GoaFortress_Entrance=$$$module$js$rom$location(168,{area:(a)=>a.GoaFortress,music:KELBESQUE$$module$js$rom$location.music});
this.GoaFortress_Kelbesque=$$$module$js$rom$location(169,Object.assign({},{bossScreen:115},KELBESQUE$$module$js$rom$location));this.GoaFortress_Zebu=$$$module$js$rom$location(170,Object.assign({},KELBESQUE$$module$js$rom$location,{palette:SABERA$$module$js$rom$location.palette}));this.GoaFortress_Sabera=$$$module$js$rom$location(171,SABERA$$module$js$rom$location);this.GoaFortress_Tornel=$$$module$js$rom$location(172,Object.assign({},{bossScreen:145},SABERA$$module$js$rom$location,{palette:MADO_LOWER$$module$js$rom$location.palette}));
this.GoaFortress_Mado1=$$$module$js$rom$location(173,MADO_LOWER$$module$js$rom$location);this.GoaFortress_Mado2=$$$module$js$rom$location(174,MADO_UPPER$$module$js$rom$location);this.GoaFortress_Mado3=$$$module$js$rom$location(175,MADO_UPPER$$module$js$rom$location);this.GoaFortress_Karmine1=$$$module$js$rom$location(176,KARMINE_UPPER$$module$js$rom$location);this.GoaFortress_Karmine2=$$$module$js$rom$location(177,KARMINE_UPPER$$module$js$rom$location);this.GoaFortress_Karmine3=$$$module$js$rom$location(178,
KARMINE_UPPER$$module$js$rom$location);this.GoaFortress_Karmine4=$$$module$js$rom$location(179,KARMINE_UPPER$$module$js$rom$location);this.GoaFortress_Karmine5=$$$module$js$rom$location(180,KARMINE_UPPER$$module$js$rom$location);this.GoaFortress_Karmine6=$$$module$js$rom$location(181,KARMINE_LOWER$$module$js$rom$location);this.GoaFortress_Karmine7=$$$module$js$rom$location(182,Object.assign({},{bossScreen:253},KARMINE_LOWER$$module$js$rom$location));this.GoaFortress_Exit=$$$module$js$rom$location(183,
{music:KARMINE_UPPER$$module$js$rom$location.music});this.OasisCave_Entrance=$$$module$js$rom$location(184,{area:(a)=>a.OasisEntrance,music:2});this.GoaFortress_Asina=$$$module$js$rom$location(185,Object.assign({},{area:(a)=>a.GoaFortress},MADO_UPPER$$module$js$rom$location,{bossScreen:145}));this.GoaFortress_Kensu=$$$module$js$rom$location(186,KARMINE_UPPER$$module$js$rom$location);this.Goa_House=$$$module$js$rom$location(187,Object.assign({},{area:(a)=>a.Goa},HOUSE$$module$js$rom$location));this.Goa_Inn=
$$$module$js$rom$location(188,HOUSE$$module$js$rom$location);this.Goa_ToolShop=$$$module$js$rom$location(190,HOUSE$$module$js$rom$location);this.Goa_Tavern=$$$module$js$rom$location(191,HOUSE$$module$js$rom$location);this.Leaf_ElderHouse=$$$module$js$rom$location(192,Object.assign({},{area:(a)=>a.Leaf},HOUSE$$module$js$rom$location));this.Leaf_RabbitHut=$$$module$js$rom$location(193,HOUSE$$module$js$rom$location);this.Leaf_Inn=$$$module$js$rom$location(194,HOUSE$$module$js$rom$location);this.Leaf_ToolShop=
$$$module$js$rom$location(195,HOUSE$$module$js$rom$location);this.Leaf_ArmorShop=$$$module$js$rom$location(196,HOUSE$$module$js$rom$location);this.Leaf_StudentHouse=$$$module$js$rom$location(197,HOUSE$$module$js$rom$location);this.Brynmaer_Tavern=$$$module$js$rom$location(198,Object.assign({},{area:(a)=>a.Brynmaer},HOUSE$$module$js$rom$location));this.Brynmaer_PawnShop=$$$module$js$rom$location(199,HOUSE$$module$js$rom$location);this.Brynmaer_Inn=$$$module$js$rom$location(200,HOUSE$$module$js$rom$location);
this.Brynmaer_ArmorShop=$$$module$js$rom$location(201,HOUSE$$module$js$rom$location);this.Brynmaer_ItemShop=$$$module$js$rom$location(203,HOUSE$$module$js$rom$location);this.Oak_ElderHouse=$$$module$js$rom$location(205,Object.assign({},{area:(a)=>a.Oak},HOUSE$$module$js$rom$location));this.Oak_MotherHouse=$$$module$js$rom$location(206,HOUSE$$module$js$rom$location);this.Oak_ToolShop=$$$module$js$rom$location(207,HOUSE$$module$js$rom$location);this.Oak_Inn=$$$module$js$rom$location(208,HOUSE$$module$js$rom$location);
this.Amazones_Inn=$$$module$js$rom$location(209,Object.assign({},{area:(a)=>a.Amazones},HOUSE$$module$js$rom$location));this.Amazones_ItemShop=$$$module$js$rom$location(210,HOUSE$$module$js$rom$location);this.Amazones_ArmorShop=$$$module$js$rom$location(211,HOUSE$$module$js$rom$location);this.Amazones_Elder=$$$module$js$rom$location(212,HOUSE$$module$js$rom$location);this.Nadare=$$$module$js$rom$location(213,{area:(a)=>a.Nadare});this.Portoa_FishermanHouse=$$$module$js$rom$location(214,Object.assign({},
{area:(a)=>a.FishermanHouse},HOUSE$$module$js$rom$location,{music:0}));this.Portoa_PalaceEntrance=$$$module$js$rom$location(215,{area:(a)=>a.PortoaPalace});this.Portoa_FortuneTeller=$$$module$js$rom$location(216,Object.assign({},{area:(a)=>a.Portoa},FORTUNE_TELLER$$module$js$rom$location));this.Portoa_PawnShop=$$$module$js$rom$location(217,HOUSE$$module$js$rom$location);this.Portoa_ArmorShop=$$$module$js$rom$location(218,HOUSE$$module$js$rom$location);this.Portoa_Inn=$$$module$js$rom$location(220,
HOUSE$$module$js$rom$location);this.Portoa_ToolShop=$$$module$js$rom$location(221,HOUSE$$module$js$rom$location);this.PortoaPalace_Left=$$$module$js$rom$location(222,Object.assign({},{area:(a)=>a.PortoaPalace},HOUSE$$module$js$rom$location));this.PortoaPalace_ThroneRoom=$$$module$js$rom$location(223,HOUSE$$module$js$rom$location);this.PortoaPalace_Right=$$$module$js$rom$location(224,HOUSE$$module$js$rom$location);this.Portoa_AsinaRoom=$$$module$js$rom$location(225,Object.assign({},{area:(a)=>a.UndergroundChannel},
HOUSE$$module$js$rom$location,{music:"asina"}));this.Amazones_ElderDownstairs=$$$module$js$rom$location(226,Object.assign({},{area:(a)=>a.Amazones},HOUSE$$module$js$rom$location));this.Joel_ElderHouse=$$$module$js$rom$location(227,Object.assign({},{area:(a)=>a.Joel},HOUSE$$module$js$rom$location));this.Joel_Shed=$$$module$js$rom$location(228,HOUSE$$module$js$rom$location);this.Joel_ToolShop=$$$module$js$rom$location(229,HOUSE$$module$js$rom$location);this.Joel_Inn=$$$module$js$rom$location(231,HOUSE$$module$js$rom$location);
this.ZombieTown_House=$$$module$js$rom$location(232,Object.assign({},{area:(a)=>a.ZombieTown},HOUSE$$module$js$rom$location));this.ZombieTown_HouseBasement=$$$module$js$rom$location(233,HOUSE$$module$js$rom$location);this.Swan_ToolShop=$$$module$js$rom$location(235,Object.assign({},{area:(a)=>a.Swan},HOUSE$$module$js$rom$location));this.Swan_StomHut=$$$module$js$rom$location(236,HOUSE$$module$js$rom$location);this.Swan_Inn=$$$module$js$rom$location(237,HOUSE$$module$js$rom$location);this.Swan_ArmorShop=
$$$module$js$rom$location(238,HOUSE$$module$js$rom$location);this.Swan_Tavern=$$$module$js$rom$location(239,HOUSE$$module$js$rom$location);this.Swan_PawnShop=$$$module$js$rom$location(240,HOUSE$$module$js$rom$location);this.Swan_DanceHall=$$$module$js$rom$location(241,HOUSE$$module$js$rom$location);this.Shyron_Temple=$$$module$js$rom$location(242,{area:(a)=>a.ShyronTemple,bossScreen:112});this.Shyron_TrainingHall=$$$module$js$rom$location(243,Object.assign({},{area:(a)=>a.Shyron},HOUSE$$module$js$rom$location));
this.Shyron_Hospital=$$$module$js$rom$location(244,HOUSE$$module$js$rom$location);this.Shyron_ArmorShop=$$$module$js$rom$location(245,HOUSE$$module$js$rom$location);this.Shyron_ToolShop=$$$module$js$rom$location(246,HOUSE$$module$js$rom$location);this.Shyron_Inn=$$$module$js$rom$location(247,HOUSE$$module$js$rom$location);this.Sahara_Inn=$$$module$js$rom$location(248,Object.assign({},{area:(a)=>a.Sahara},HOUSE$$module$js$rom$location));this.Sahara_ToolShop=$$$module$js$rom$location(249,HOUSE$$module$js$rom$location);
this.Sahara_ElderHouse=$$$module$js$rom$location(250,HOUSE$$module$js$rom$location);this.Sahara_PawnShop=$$$module$js$rom$location(251,HOUSE$$module$js$rom$location);this.EastCave1=$$$module$js$rom$location(-1,{area:(a)=>a.EastCave});this.EastCave2=$$$module$js$rom$location(-1);this.EastCave3=$$$module$js$rom$location(-1);this.FishermanBeach=$$$module$js$rom$location(-1,Object.assign({},{area:(a)=>a.FishermanHouse},HOUSE$$module$js$rom$location));$$$module$js$rom$location.commit(this);for(let b=0;256>
b;b++)this[b]||(this[b]=new Location$$module$js$rom$location(a,b,{area:a.areas.Empty,name:"",music:"",palette:""}))}allocate(a){for(const b of this)if(!b.used)return a.id=b.id,a.used=!0,this[b.id]=a;throw Error("No unused location");}}
...
b,c.ys+=a;for(const c of this.pits)c.fromXs+=b,c.fromYs+=a;for(const c of[...this.spawns,...this.exits])c.xt+=16*b,c.yt+=16*a;for(const c of this.entrances)c.used&&(c.x+=256*b,c.y+=256*a)}writeScreens2d(a,b){const c=a&15;a>>>=4;for(let d=0;d<b.length;d++){const e=b[d];for(let b=0;b<e.length;b++){const f=e[b];null!=f&&(this.screens[a+d][c+b]=f)}}}connect(a,b,c){var d=0>a?256:0,e=0>c?256:0;a=0>a?~a:a;c=0>c?~c:c;const f=a>>>4,g=a&15,h=c>>>4,k=c&15,[l,m]=screenExits$$module$js$rom$location[d|this.screens[f][g]],
[n,p]=screenExits$$module$js$rom$location[e|b.screens[h][k]];d=this.entrances.length;e=b.entrances.length;this.entrances.push(Entrance$$module$js$rom$location.of({y:f<<8|l>>>8,x:g<<8|l&255}));b.entrances.push(Entrance$$module$js$rom$location.of({y:h<<8|n>>>8,x:k<<8|n&255}));for(const c of m)this.exits.push(Exit$$module$js$rom$location.of({screen:a,tile:c,dest:b.id,entrance:e}));for(const a of p)b.exits.push(Exit$$module$js$rom$location.of({screen:c,tile:a,dest:this.id,entrance:d}))}neighborForEntrance(a){const b=
this.entrances[a];if(!b)throw Error(`no entrance ${hex$$module$js$rom$util(this.id)}:${a}`);for(const a of this.exits){if(a.screen!==b.screen)continue;const c=Math.abs(a.y-b.y);if(24>Math.abs(a.x-b.x)&&24>c)return this.rom.locations[a.dest]}throw Error(`no exit found near ${hex$$module$js$rom$util(this.id)}:${a}`);}}
...
function shuffleCave$$module$js$maze$cave(a,b){(new (STRATEGIES$$module$js$maze$cave.get(a.id)||BasicCaveShuffle$$module$js$maze$cave)(a,b)).shuffle()}var module$js$maze$cave={};module$js$maze$cave.shuffleCave=shuffleCave$$module$js$maze$cave;function shuffleGoa1$$module$js$maze$goa(a,b,c=1500){extendGoaScreens$$module$js$maze$goa(a);const d=a.locations.GoaFortress_Kelbesque;var e=d.width;const f=d.height;a:for(let l=0;l<c;l++){var g=function(a,b=65536){const c=m.get(a);if(null==c)throw Error(`Cannot flag empty screen ${hex$$module$js$rom$util(a)}`);m.replace(a,c|b);if(h())return!0;m.replace(a,c);return!1},h=function(){const a=m.traverse(),b=a.get(q);return!b||!r.filter((a)=>b.has(a)).length||b.size<.8*a.size?!1:!0},k=function(a,b){m.set(a,
b,{force:!0})};const m=new Maze$$module$js$maze$maze(b,f,e,GOA1_SCREENS$$module$js$maze$spec),l=f-1<<4|b.nextInt(e),p=b.nextInt(e),q=l<<8|2,r=[p+32<<8|1,p+32<<8|3];k(l,61681);k(l-1,240);k(l+1,61440);k(p,65520);k(p-1,4080);k(p+1,65280);k(p+16,61951);k(p+15,255);k(p+17,61455);if(!m.connect(l,module$js$maze$types.Dir.UP,p+16,module$js$maze$types.Dir.DOWN))continue a;if(257===m.get(p+32)||257===m.get(l-16))continue a;for(k=0;10>k&&.65>m.density();k++)m.addLoop()&&(k=0);if(.45>m.density())continue a;if(!h())continue a;
for(const [a,c]of m)if(257===c&&257===m.get(a+16)&&(k=b.shuffle([0,16]),!g(a+k[0],131072)&&!g(a+k[1],131072)))continue a;for(const [a,c]of b.shuffle([...m.alternates()]))g(a,c);m.fillAll({edge:0});d.moveScreen(6,p);d.moveScreen(131,l);m.write(d,new Set);b=d.monsterPlacer(b);for(const f of d.spawns)f.isMonster()&&(c=a.objects[f.monsterId],c instanceof Monster$$module$js$rom$monster&&(e=b(c),null==e?(console.error(`no valid location for ${hex$$module$js$rom$util(c.id)} in ${hex$$module$js$rom$util(d.id)}`),
f.used=!1):(f.screen=e>>>8,f.tile=e&255)));a.spoiler&&a.spoiler.addMaze(d.id,d.name,m.show());return}throw Error(`unable to shuffle goa1 after ${c} attempts`);}
...
function disableStabs$$module$js$pass$deterministic(a){for(const b of[8,9,39])a.objects[b].collisionPlane=0;a.npcs[84].data[0]=32}function orbsOptional$$module$js$pass$deterministic(a){for(const b of[16,20,24,29])a.objects[b].terrainSusceptibility&=-5,a.objects[b].level=2}var module$js$pass$deterministic={};module$js$pass$deterministic.deterministicPreParse=deterministicPreParse$$module$js$pass$deterministic;module$js$pass$deterministic.deterministic=deterministic$$module$js$pass$deterministic;function shuffleTrades$$module$js$pass$shuffletrades(a,b,c){if(b.randomizeTrades()){var {StatueOfOnyx:d,FogLamp:e,LovePendant:f,KirisaPlant:g,IvoryStatue:h}=a.items,k=new Map;b=[[d,0,"Akahana"],[e,0,"Fisherman"],[f,0,"Kensu"],[g,0,"Aryllis"],[h,0,"Slimed Kensu"]];var l=b.map(([a,b,c])=>{if(0>a.trades.indexOf(b)||b>=a.itemUseData.length)throw Error(`not a trade: ${a} ${b}`);return[a.itemUseData[b].want,a.id,c]});c.shuffle(l);for(const [c,d]of b){const [b,e,f]=l.pop();c.itemUseData[d].want=b;a.spoiler&&
a.spoiler.addTrade(c.id,c.messageName,f);291===b&&(a.prg[251061]=c.id-28);k.set(e,c.id)}a.itemGets.actionGrants=new Map([...a.itemGets.actionGrants].map(([a,b])=>{var c;return[(c=k.get(a),null!==c&&void 0!==c?c:a),b]}));b=a.items[c.nextInt(4)];a.npcs[195].localDialogs.get(-1)[0].condition=512|b.id;a.spoiler&&a.spoiler.addTrade(b.id,b.messageName,"Rage");a.npcs[56].localDialogs.get(-1)[3].condition=512|b.id;c=a.items[2*c.nextInt(4)+6];for(const d of a.npcs[95].localDialogs.values())for(b=2;b<d.length;b++)if(3===
d[b].message.action){d[b-2].condition=~(512|c.id-1);d[b-1].condition=~(512|c.id);a.spoiler&&a.spoiler.addTrade(c.id,c.messageName,"Tornel");break}}}function buildTradeInMap$$module$js$pass$shuffletrades(a){const b=new Map;for(const c of a.items)for(const a of c.trades)b.set(c.itemUseData[a].want&255,c.id);return b}var module$js$pass$shuffletrades={};module$js$pass$shuffletrades.shuffleTrades=shuffleTrades$$module$js$pass$shuffletrades;module$js$pass$shuffletrades.buildTradeInMap=buildTradeInMap$$module$js$pass$shuffletrades;function fixDialog$$module$js$pass$fixdialog(a){function b(a){d(a,/teach\s+you\s+the\s+magic\s+of/,"bestow upon you the")}function c(b){b=a.items[a.itemGets[b].itemId];return`[${hex$$module$js$rom$util(b.id)}:${b.messageName}]`}function d(b,c,d){const [e,f]=b.split(":").map((a)=>parseInt(a,16));b=a.messages.parts[e][f];b.text=b.text.replace(c,d)}function e(b){const c=a.itemGets.actionGrants.get(b);if(null==c)throw Error(`Missing actionGrant for ${hex$$module$js$rom$util(b)}`);return c}d("03:06",",",
...
d("0b:01","[46:Barrier]",c(g));d("1d:12","[46:Barrier]",c(g));g=function(...b){for(const c of b){b=a.locations[c];for(const c of b.spawns)if(c.isChest()&&72>c.id&&a.items[a.itemGets[c.id].itemId].unique)return c.id}return-1}(68,69,70,71,72,73,74,75,76,77,78,79);0<=g?d("0d:00","[35:Fog Lamp]",c(g)):d("0d:00","that a [35:Fog Lamp] was","there was treasure");g=a.npcs[195].localDialogs.get(-1)[0].condition&255;h=a.prg[250679];d("0e:03","[02:Sword of Water]",c(g));d("0e:03","[09:Ball of Water]",c(h));
d("10:0c","that's","is");d("10:0c",/, is in the\+lighthouse/,"");g=f.get(35);null!=g&&(d("12:05","[3c:Kirisa Plant]",c(g)),d("12:10","the plant",`the ${commonNoun$$module$js$pass$fixdialog(g)}`),d("12:10","[3c:Kirisa Plant]",c(g)),g=`Our illustrious chief seeks ${vague$$module$js$pass$fixdialog(g)}.`,d("12:09",/[^]*/,g),d("12:0a",/[^]*/,g));g=mustGet$$module$js$pass$fixdialog(f,116);d("13:02","[3b:Love Pendant]",c(g));g=e(g);65>g&&b("13:02");d("13:02","[47:Change]",c(g));f=f.get(117);null!=f&&(d("18:06",
"[3d:Ivory Statue]",c(f)),d("18:07","[3d:Ivory Statue]",c(f)));d("18:06","It's in a room","{0b:Karmine} is");f=a.prg[250255];65>f&&d("18:07","teach","give");d("18:07","[48:Flight]",c(f));f=e(178);65>f&&b("1c:10");d("1c:10","[42:Paralysis]",c(f));d("20:06","Statue of Gold",c(e(57)))}function findTornelTradeIn$$module$js$pass$fixdialog(a){for(const b of a.localDialogs.values())for(a=2;a<b.length;a++){const c=~b[a].condition;if(516<c&&524>=c&&!(c&1))return c&255}return 6}
...
module$js$rom$bosses.Boss=Boss$$module$js$rom$bosses;class Flags$$module$js$rom$flags{constructor(a){this.rom=a;this.available=new Set([624,625,626,627,628,629,630,631,632,633,634,635,636,637,638,639,640,641,648,649,650,651,652,679,683,692])}alloc(a){for(const b of this.available)if(null==a||(b&3840)===a)return this.available.delete(b),b;throw Error("No free flags.");}free(a){this.available.add(a)}}var module$js$rom$flags={};module$js$rom$flags.Flags=Flags$$module$js$rom$flags;class Hitbox$$module$js$rom$hitbox extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.base=218769+(b<<2);this.coordinates=tuple$$module$js$rom$util(a.prg,this.base,4)}get w(){return this.coordinates[1]}set w(a){this.coordinates[1]=a}get x0(){return signed$$module$js$rom$util(this.coordinates[0])}set x0(a){this.coordinates[0]=unsigned$$module$js$rom$util(a)}get x1(){return this.x0+this.w}get h(){return this.coordinates[3]}set h(a){this.coordinates[3]=a}get y0(){return signed$$module$js$rom$util(this.coordinates[2])}set y0(a){this.coordinates[2]=
...
_REQUIRE_HEALED_DOLPHIN_TO_RIDE:c.requireHealedDolphinToRide(),_REVERSIBLE_SWAN_GATE:!0,_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_SIMPLIFY_INVISIBLE_CHESTS:!0,_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword(),_TRAINER:c.trainer(),_TWELVTH_WARP_POINT:!0,_UNIDENTIFIED_ITEMS:c.unidentifiedItems(),_ZEBU_STUDENT_GIVES_ITEM:c.zebuStudentGivesItem()},l=new Assembler$$module$js$6502;deterministicPreParse$$module$js$pass$deterministic(a.subarray(16));var m=Object.keys(k).filter((a)=>
k[a]).map((a)=>`define ${a} 1\n`).join("");l.assemble(m,"flags.s");yield g("preshuffle.s");h=new Random$$module$js$random(h);m=new Rom$$module$js$rom(a);"object"==typeof window&&(window.rom=m);m.spoiler=new Spoiler$$module$js$rom$spoiler(m);e&&(e.spoiler=m.spoiler);deterministic$$module$js$pass$deterministic(m,c);toggleMaps$$module$js$pass$togglemaps(m,c,h);yield g("postparse.s");m.scalingLevels=48;m.uniqueItemTableAddress=l.expand("KeyItemData");c.shuffleShops()&&shuffleShops$$module$js$patch(m,
c,h);randomizeWalls$$module$js$patch(m,c,h);crumblingPlatforms$$module$js$pass$crumblingplatforms(m,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(m,c,h);c.randomizeThunderTeleport()&&randomizeThunderWarp$$module$js$pass$randomizethunderwarp(m,h);rescaleMonsters$$module$js$patch(m,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(m,c,h);shuffleTrades$$module$js$pass$shuffletrades(m,c,h);c.randomizeMaps()&&shuffleMazes$$module$js$pass$shufflemazes(m,c,h);const n=World$$module$js$graph$world.build(m,
c),p=yield(new AssumedFill$$module$js$graph$shuffle(m,c)).shuffle(n.graph,h,f);if(p)n.traverse(n.graph,p),update$$module$js$rom$slots(m,p.slots);else return[a,-1];rescaleShops$$module$js$patch(m,l,c.bargainHunting()?h:void 0);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(m,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(m);c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(m);shuffleMusic$$module$js$patch(m,
c,h);shufflePalettes$$module$js$pass$shufflepalettes(m,c,h);c.blackoutMode()&&blackoutMode$$module$js$patch(m);misc$$module$js$patch(m,c,h);fixDialog$$module$js$pass$fixdialog(m);c.buffDyna()&&buffDyna$$module$js$patch(m,c);c.trainer()&&(m.wildWarp.locations=[10,26,53,72,109,110,140,170,172,176,182,159,166,88,92,0]);yield m.writeData();buffDyna$$module$js$patch(m,c);h=yield postParsedShuffle$$module$js$patch(a,h,b,c,l,g);EXPAND_PRG$$module$js$patch&&(m=a.subarray(16),m.subarray(507904,524288).set(m.subarray(245760,
262144)));return[a,h]})}function postParsedShuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){yield f("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(a,d,e);updateCoinDrops$$module$js$patch(a,d);shuffleRandomNumbers$$module$js$patch(a,b);return stampVersionSeedAndHash$$module$js$patch(a,c,d)})}
