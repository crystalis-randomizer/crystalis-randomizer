...
function deterministicPreParse$$module$js$pass$deterministic(a){a[107924]=255;a[118213]=168;a[106870]=255;a[108620]=255;a[120899]=160;a[122987]&=7;a[122991]&=7;a[122995]&=7;a[122999]&=7;a[123003]&=7;a[123012]&=7;a[123035]&=7;a[123065]&=7;a[123141]=47;a[123511]=0;a[123750]=64;a[123761]=0;a[123783]=0;a[123793]=0;a[105393]=112;a[105397]=113;a[105079]=114;a[105963]=115;a[106565]=116;a[106721]=117;a[106725]=118;a[106729]=119;a[108037]=120;a[107457]=121;a[107461]=122;a[107465]=123;write$$module$js$pass$deterministic(a,
123063,192,0);write$$module$js$pass$deterministic(a,123690,192,0);write$$module$js$pass$deterministic(a,123696,192,0);write$$module$js$pass$deterministic(a,123702,192,0);write$$module$js$pass$deterministic(a,123104,192,0);write$$module$js$pass$deterministic(a,123110,192,0);a[116739]=0;write$$module$js$pass$deterministic(a,116749,162,179);a[109190]=254}
function deterministic$$module$js$pass$deterministic(a,b){addZombieWarp$$module$js$pass$deterministic(a);consolidateItemGrants$$module$js$pass$deterministic(a);addMezameTrigger$$module$js$pass$deterministic(a);normalizeSwords$$module$js$pass$deterministic(a,b);fixCoinSprites$$module$js$pass$deterministic(a);fixChests$$module$js$pass$deterministic(a);preventBossSoftlocks$$module$js$pass$deterministic(a);makeBraceletsProgressive$$module$js$pass$deterministic(a);addTowerExit$$module$js$pass$deterministic(a);
reversibleSwanGate$$module$js$pass$deterministic(a);adjustGoaFortressTriggers$$module$js$pass$deterministic(a);preventNpcDespawns$$module$js$pass$deterministic(a,b);leafElderInSabreHeals$$module$js$pass$deterministic(a);b.requireHealedDolphinToRide()&&requireHealedDolphin$$module$js$pass$deterministic(a);b.saharaRabbitsRequireTelepathy()&&requireTelepathyForDeo$$module$js$pass$deterministic(a);adjustItemNames$$module$js$pass$deterministic(a,b);alarmFluteIsKeyItem$$module$js$pass$deterministic(a,b);
brokahanaWantsMado1$$module$js$pass$deterministic(a);b.teleportOnThunderSword()?(teleportOnThunderSword$$module$js$pass$deterministic(a),a.townWarp.thunderSwordWarp=[a.locations.Shyron.id,65]):noTeleportOnThunderSword$$module$js$pass$deterministic(a);undergroundChannelLandBridge$$module$js$pass$deterministic(a);b.fogLampNotRequired()&&fogLampNotRequired$$module$js$pass$deterministic(a,b);b.addEastCave()?(eastCave$$module$js$pass$deterministic(a,b),b.connectGoaToLeaf()&&connectGoaToLeaf$$module$js$pass$deterministic(a)):
b.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$pass$deterministic(a);evilSpiritIslandRequiresDolphin$$module$js$pass$deterministic(a);simplifyInvisibleChests$$module$js$pass$deterministic(a);addCordelWestTriggers$$module$js$pass$deterministic(a,b);b.disableRabbitSkip()&&fixRabbitSkip$$module$js$pass$deterministic(a);patchLimeTreeLake$$module$js$pass$deterministic(a);closeCaveEntrances$$module$js$pass$deterministic(a,b);fixReverseWalls$$module$js$pass$deterministic(a);b.chargeShotsOnly()&&
disableStabs$$module$js$pass$deterministic(a);b.orbsOptional()&&orbsOptional$$module$js$pass$deterministic(a);b.noBowMode()&&noBowMode$$module$js$pass$deterministic(a);patchTooManyItemsMessage$$module$js$pass$deterministic(a)}function consolidateItemGrants$$module$js$pass$deterministic(a){a.items.GlowingLamp.itemUseData[0].message.action=11}
...
w.LeafVillagersRescued.id);a.trigger(140).conditions.push(~w.Kelbesque1.id);a.trigger(134).conditions.push(~w.Kelbesque1.id);c(O.itemUseData[0].flags,~w.LeafVillagersCurrentlyAbducted.id);replace$$module$js$pass$deterministic(a.trigger(187).conditions,~w.Rage.id,~w.MesiaRecording.id)}function disableStabs$$module$js$pass$deterministic(a){for(const b of[8,9,39])a.objects[b].collisionPlane=0;a.npcs.Brokahana.data[0]=a.items.FruitOfLime.id}
...
var module$js$rom$townwarp={};module$js$rom$townwarp.TownWarp=TownWarp$$module$js$rom$townwarp;const UNUSED_TRIGGERS$$module$js$rom$trigger=new Set([131,135,136,137,143,147,150,152,155,156,157,158,159,170,179,181,185,190,192]);
