...
module$js$logic$tileid.TileId.add(c,1,0),d++;6>d?b&=~module$js$logic$terrain.Terrain.SLOPE:9>d?b|=module$js$logic$terrain.Terrain.SLOPE8:10>d&&(b|=module$js$logic$terrain.Terrain.SLOPE9)}return this.terrainFactory.tile(b)};for(let l=0,v=a.height;l<v;l++){const v=a.screens[l],x=a.id<<8|l<<4;for(let l=0,y=a.width;l<y;l++){const y=this.rom.screens[v[l]|k],u=module$js$logic$screenid.ScreenId(x|l),C=f.has(u),B=u&255;var p=e.get(u);p=g?this.rom.flags.AlwaysTrue.id:null!=p?this.wallCapability(p):null===
(b=a.flags.find((a)=>a.yx===B))||void 0===b?void 0:b.flag;const U=(d=null===(c=this.rom.flags[p])||void 0===c?void 0:c.logic,null!==d&&void 0!==d?d:{});for(let b=0;240>b;b++){const c=module$js$logic$tileid.TileId(u<<8|b);var q=y.tiles[b];U.assumeTrue&&32>q&&(q=h.alternates[q]);var r=a.isShop()?0:m.effects[q]&38;r=n(r,c,C);32>q&&h.alternates[q]!==q&&null!=p&&!U.assumeTrue&&!U.assumeFalse&&(q=n(m.effects[h.alternates[q]],c,C))&&(r=this.terrainFactory.flag(r,U.track?p:-1,q));r&&this.terrains.set(c,r)}}}for(const f of a.exits){const {dest:g,
entrance:h}=f;b=module$js$logic$tileid.TileId.from(a,f);f.isSeamless()?(c=module$js$logic$tileid.TileId(b&65535|g<<16),d=module$js$logic$tileid.TileId.from(a,f),this.seamlessExits.add(d),(e=this.terrains.get(d))&&this.terrains.set(d,this.terrainFactory.seamless(e))):c=this.entrance(this.rom.locations[g],h&31);this.exits.set(b,c)}}processLocationSpawns(a){for(const b of a.spawns){b.isTrigger()?this.processTrigger(a,b):b.isNpc()?this.processNpc(a,b):b.isBoss()?this.processBoss(a,b):b.isChest()?this.processChest(a,
b):b.isMonster()?this.processMonster(a,b):3===b.type&&224===b.id&&this.processKeyUse(module$js$logic$hitbox.Hitbox.screen(module$js$logic$tileid.TileId.from(a,b)),this.rom.flags.UsedWindmillKey.r);for(const [c,d]of this.itemUses.get(b.type<<8|b.id))this.processItemUse([module$js$logic$tileid.TileId.from(a,b)],c,d)}}processTrigger(a,b){var c;const d=this.rom.trigger(b.id);if(!d)throw Error(`Missing trigger ${b.id.toString(16)}`);const e=this.filterRequirements(d.conditions);let f=this.filterAntiRequirements(d.conditions);
const g=module$js$logic$tileid.TileId.from(a,b);b=module$js$logic$hitbox.Hitbox.trigger(a,b);const h=[];for(const a of d.flags){const b=this.flag(a);(null===(c=b)||void 0===c?0:c.logic.track)&&h.push(b.id)}h.length&&this.addCheck(b,e,h);switch(d.message.action){case 25:134!==d.id||this.flagset.assumeRabbitSkip()?186!==d.id||this.flagset.assumeTeleportSkip()||this.flagset.disableTeleportSkip()||(b=module$js$logic$hitbox.Hitbox.atLocation(b,this.rom.locations.CordelPlainEast,this.rom.locations.CordelPlainWest)):
b=module$js$logic$hitbox.Hitbox.adjust(b,[0,-1],[0,1]);this.addTerrain(b,this.terrainFactory.statue(f));break;case 29:this.addBossCheck(b,this.rom.bosses.Mado1,e);break;case 8:case 11:case 12:case 13:case 15:this.addItemGrantChecks(b,e,d.id);break;case 24:a=this.flagset.chargeShotsOnly()?module$js$logic$requirement.Requirement.meet(e,and$$module$js$logic$world(this.rom.flags.WarpBoots)):e;this.addItemCheck(b,a,this.rom.flags.StomFightReward.id,{lossy:!0,unique:!0});break;case 30:this.addItemCheck(b,
e,this.rom.flags.MesiaInTower.id,{lossy:!0,unique:!0});break;case 31:this.handleBoat(g,a,e);break;case 27:a===this.rom.locations.PortoaPalace_Entrance&&(b=module$js$logic$hitbox.Hitbox.adjust(b,[-2,0]),f=this.rom.flags.TalkedToFortuneTeller.r),this.handleMovingGuard(b,a,f)}}processNpc(a,b){var c,d,e,f,g,h;const k=this.rom.npcs[b.id];if(!k||!k.used)throw Error(`Unknown npc: ${hex$$module$js$rom$util(b.id)}`);const m=k.spawnConditions.get(a.id)||[];var l=this.filterRequirements(m);b=module$js$logic$tileid.TileId.from(a,
b);b=[this.terrains.has(b)?b:(c=this.walkableNeighbor(b),null!==c&&void 0!==c?c:b)];k===this.rom.npcs.SaberaDisguisedAsMesia&&this.addBossCheck(b,this.rom.bosses.Sabera1,l);k.data[2]&4&&!this.flagset.assumeStatueGlitch()&&(c=this.filterAntiRequirements(m),k===this.rom.npcs.Rage?(b=module$js$logic$hitbox.Hitbox.adjust(b,[2,-1],[2,0],[2,1],[2,2]),b=module$js$logic$hitbox.Hitbox.adjust(b,[0,-6],[0,-2],[0,2],[0,6]),this.flagset.assumeRageSkip()&&(c=void 0)):k===this.rom.npcs.PortoaThroneRoomBackDoorGuard&&
(c=or$$module$js$logic$world(this.rom.flags.MesiaRecording,this.rom.flags.Paralysis)),c&&this.addTerrain(b,this.terrainFactory.statue(c)));k===this.rom.npcs.FortuneTeller&&(b=module$js$logic$hitbox.Hitbox.adjust(b,[0,0],[2,0]));if(!module$js$logic$requirement.Requirement.isClosed(l)){[[...l]]=l;for(const a of k.globalDialogs)c=this.flag(~a.condition),null!==(d=c)&&void 0!==d&&d.logic.track&&l.push(c.id);a=(f=(e=k.localDialogs.get(a.id),null!==e&&void 0!==e?e:k.localDialogs.get(-1)),null!==f&&void 0!==
f?f:[]);for(const c of a)e=[...l],f=this.flag(c.condition),(null===(g=f)||void 0===g?0:g.logic.track)&&e.push(f.id),this.processDialog(b,k,e,c),e=this.flag(~c.condition),(null===(h=e)||void 0===h?0:h.logic.track)&&l.push(e.id)}}processDialog(a,b,c,d){this.addCheckFromFlags(a,[c],d.flags);const e={lossy:!0,unique:!0};switch(d.message.action){case 8:this.processKeyUse(a,[c]);break;case 20:this.addItemCheck(a,[c],this.rom.flags.SlimedKensu.id,e);break;case 16:this.addItemCheck(a,[c],this.rom.flags.AsinaInBackRoom.id,
e);break;case 17:this.addItemCheck(a,[c],256|b.data[1],e);break;case 3:case 10:this.addItemCheck(a,[c],256|b.data[0],e);break;case 9:b=b.data[1];255!==b&&this.addItemCheck(a,[c],256|b,e);break;case 25:this.addItemCheck(a,[c],this.rom.flags.AkahanaFluteOfLimeTradein.id,e);break;case 26:this.addItemCheck(a,[c],this.rom.flags.Rage.id,e)}}processLocationItemUses(a){for(const [b,c]of this.itemUses.get(~a.id))this.processItemUse([this.entrance(a)],b,c)}handleMovingGuard(a,b,c){if(!this.flagset.assumeStatueGlitch()){var d=
[];for(const a of b.spawns.slice(0,2))if(a.isNpc()&&this.rom.npcs[a.id].isParalyzable()){d.push([this.rom.flags.Paralysis.id]);break}this.addTerrain(a,this.terrainFactory.statue([...c,...d].map(spread$$module$js$util)))}}handleBoat(a,b,c){const d=this.walkableNeighbor(a);if(null==d)throw Error("Could not find walkable neighbor.");const e=a>>8&240|a>>4&15;a=a>>4&240|a&15;var f;for(const c of b.exits)c.yt===e&&c.xt<a&&(f=c);if(!f)throw Error("Could not find boat exit");b=this.rom.locations[f.dest];
if(!b)throw Error("Bad destination");for(b=module$js$logic$tileid.TileId.from(b,b.entrances[f.entrance]);;)if(b=module$js$logic$tileid.TileId.add(b,0,-1),f=this.walkableNeighbor(b),null!=f){c={enter:module$js$logic$requirement.Requirement.freeze(c),exit:[[15,module$js$logic$requirement.Requirement.OPEN]]};this.addTerrain([d],c);this.exits.set(d,f);this.exitSet.add(module$js$logic$tilepair.TilePair.of(d,f));break}}addItemGrantChecks(a,b,c){const d=this.itemGrant(c),e=256|d;if(null==d)throw Error(`missing item grant for ${c.toString(16)}`);
this.addItemCheck(a,b,e,{lossy:!0,unique:!0,preventLoss:128<=c})}addTerrain(a,b){for(const c of a)a=this.terrains.get(c),null!=a&&this.terrains.set(c,this.terrainFactory.meet(a,b))}addCheck(a,b,c){if(!module$js$logic$requirement.Requirement.isClosed(b)){b={requirement:module$js$logic$requirement.Requirement.freeze(b),checks:c};for(const c of a)this.terrains.has(c)&&this.checks.get(c).add(b)}}addItemCheck(a,b,c,d){this.addCheck(a,b,[c]);this.slots.set(c,d);a=this.rom.itemGets[c&255];b=this.rom.items[a.itemId];
c=null===b||void 0===b?void 0:b.unique;d=a.isLosable();const e=c||b===this.rom.items.OpelStatue;let f=1;b===this.rom.items.SwordOfWind&&(f=5);b===this.rom.items.SwordOfFire&&(f=5);b===this.rom.items.SwordOfWater&&(f=10);b===this.rom.items.SwordOfThunder&&(f=15);b===this.rom.items.Flight&&(f=15);this.items.set(512|a.id,{unique:c,losable:d,preventLoss:e,weight:f})}addCheckFromFlags(a,b,c){var d;const e=[];for(const a of c)c=this.flag(a),(null===(d=c)||void 0===d?0:d.logic.track)&&e.push(c.id);e.length&&
this.addCheck(a,b,e)}walkableNeighbor(a){if(this.isWalkable(a))return a;for(let b of[-1,1]){const c=module$js$logic$tileid.TileId.add(a,b,0),d=module$js$logic$tileid.TileId.add(a,0,b);if(this.isWalkable(c))return c;if(this.isWalkable(d))return d}}isWalkable(a){return!(this.getEffects(a)&module$js$logic$terrain.Terrain.BITS)}ensurePassable(a){var b;return this.isWalkable(a)?a:(b=this.walkableNeighbor(a),null!==b&&void 0!==b?b:a)}getEffects(a){const b=this.rom.locations[a>>>16];return this.rom.tileEffects[b.tileEffects-
179].effects[this.rom.screens[b.screens[(a&61440)>>>12][(a&3840)>>>8]|b.screenPage].tiles[a&255]]}processBoss(a,b){if(201!==b.id&&202!==b.id){var c=195===b.id?this.rom.bosses.Rage:this.rom.bosses.fromLocation(a.id);b=module$js$logic$tileid.TileId.from(a,b);if(!c||!c.flag)throw Error(`Bad boss at ${a.name}`);var d=b&-256;a=this.terrainFactory.boss(c.flag.id);b=seq$$module$js$rom$util(240,(a)=>d|a);this.addTerrain(b,a);this.addBossCheck(b,c)}}addBossCheck(a,b,c=module$js$logic$requirement.Requirement.OPEN){if(null==
b.flag)throw Error(`Expected a flag: ${b}`);c=module$js$logic$requirement.Requirement.meet(c,this.bossRequirements(b));b===this.rom.bosses.Draygon2?this.addCheck(a,c,[b.flag.id]):this.addItemCheck(a,c,b.flag.id,{lossy:!1,unique:!0})}processChest(a,b){if(!(112<=this.rom.slots[b.id])){var c=256|b.id,d=this.rom.items[b.id];d=this.flagset.preserveUniqueChecks()?!(null===d||void 0===d||!d.unique):!0;this.addItemCheck([module$js$logic$tileid.TileId.from(a,b)],module$js$logic$requirement.Requirement.OPEN,
c,{lossy:!1,unique:d})}}processMonster(a,b){}processItemUse(a,b,c){a=new Set([...a].map((a)=>{var b;return b=this.walkableNeighbor(a),null!==b&&void 0!==b?b:a}));const d=[[512|b.id]];b.id===this.rom.prg[251061]+28&&d[0].push(this.rom.flags.Change.c);b===this.rom.items.MedicalHerb&&(d[0][0]=this.rom.flags.BuyHealing.c);this.addCheckFromFlags(a,d,c.flags);switch(c.message.action){case 16:this.processKeyUse(a,d);break;case 8:case 11:case 12:case 13:case 15:case 28:this.addItemGrantChecks(a,d,b.id);break;
case 2:this.addItemCheck(a,d,256|this.rom.npcs[c.want&255].data[1],{lossy:!0,unique:!0})}}processKeyUse(a,b){const [c,...d]=new Set([...a].map((a)=>module$js$logic$screenid.ScreenId.from(a)));if(null==c||d.length)throw Error("Expected one screen");const e=this.rom.locations[c>>>8].flags.find((a)=>a.screen===(c&255));if(null==e)throw Error("Expected flag on screen");this.addCheck(a,b,[e.flag])}bossRequirements(a){if(a===this.rom.bosses.Rage)return this.tracker&&this.flagset.randomizeTrades()?this.rom.flags.Sword.r:
[[this.rom.npcs.Rage.dialog()[0].condition]];var b=a.object;const c=new module$js$logic$requirement.Requirement.Builder;if(this.tracker&&this.flagset.shuffleBossElements()||!this.flagset.guaranteeMatchingSword())c.addAll(this.rom.flags.Sword.r);else{var d=this.flagset.guaranteeSwordMagic()?a.swordLevel:1;b=this.rom.objects[b];for(let a=0;4>a;a++)b.isVulnerable(a)&&c.addAll(this.swordRequirement(a,d))}d=[];null!=a.npc&&null!=a.location&&(b=a.npc.spawns(this.rom.locations[a.location]),d.push(...this.filterRequirements(b)[0]));
a===this.rom.bosses.Insect?d.push(this.rom.flags.InsectFlute.c,this.rom.flags.GasMask.c):a===this.rom.bosses.Draygon2&&d.push(this.rom.flags.BowOfTruth.c);this.flagset.guaranteeRefresh()&&d.push(this.rom.flags.Refresh.c);c.restrict([d]);return module$js$logic$requirement.Requirement.freeze(c)}swordRequirement(a,b){const c=[this.rom.flags.SwordOfWind,this.rom.flags.SwordOfFire,this.rom.flags.SwordOfWater,this.rom.flags.SwordOfThunder][a];if(1===b)return c.r;a=[[this.rom.flags.BallOfWind,this.rom.flags.TornadoBracelet],
[this.rom.flags.BallOfFire,this.rom.flags.FlameBracelet],[this.rom.flags.BallOfWater,this.rom.flags.BlizzardBracelet],[this.rom.flags.BallOfThunder,this.rom.flags.StormBracelet]][a];return 3===b?and$$module$js$logic$world(c,...a):a.map((a)=>[c.c,a.c])}itemGrant(a){for(const [b,c]of this.rom.itemGets.actionGrants)if(b===a)return c;throw Error(`Could not find item grant ${a.toString(16)}`);}filterRequirements(a){var b,c,d,e;const f=[];for(const g of a)if(0>g){if(null===(c=null===(b=this.flag(~g))||
void 0===b?void 0:b.logic)||void 0===c?0:c.assumeTrue)return module$js$logic$requirement.Requirement.CLOSED}else{a=this.flag(g);if(null===(d=a)||void 0===d?0:d.logic.assumeFalse)return module$js$logic$requirement.Requirement.CLOSED;(null===(e=a)||void 0===e?0:e.logic.track)&&f.push(a.id)}return[f]}filterAntiRequirements(a){var b,c,d,e;const f=[];for(const g of a)if(0<=g){if(null===(c=null===(b=this.flag(~g))||void 0===b?void 0:b.logic)||void 0===c?0:c.assumeFalse)return module$js$logic$requirement.Requirement.OPEN}else{a=
this.flag(~g);if(null===(d=a)||void 0===d?0:d.logic.assumeTrue)return module$js$logic$requirement.Requirement.OPEN;(null===(e=a)||void 0===e?0:e.logic.track)&&f.push([a.id])}return f}flag(a){var b;a=this.rom.flags[a];return b=this.aliases.get(a),null!==b&&void 0!==b?b:a}entrance(a,b=0){"number"===typeof a&&(a=this.rom.locations[a]);return this.tiles.find(module$js$logic$tileid.TileId.from(a,a.entrances[b]))}wallCapability(a){switch(a){case module$js$logic$walltype.WallType.WIND:return this.rom.flags.BreakStone.id;
case module$js$logic$walltype.WallType.FIRE:return this.rom.flags.BreakIce.id;case module$js$logic$walltype.WallType.WATER:return this.rom.flags.FormBridge.id;case module$js$logic$walltype.WallType.THUNDER:return this.rom.flags.BreakIron.id;default:throw Error(`bad wall type: ${a}`);}}}function and$$module$js$logic$world(...a){return[a.map((a)=>a.id)]}function or$$module$js$logic$world(...a){return a.map((a)=>[a.id])}const DEBUG$$module$js$logic$world=!1;var module$js$logic$world={};
module$js$logic$world.World=World$$module$js$logic$world;var Path$$module$js$maze$types;(function(a){a.generate=function*(a,c,d){for(;;)yield generatePath$$module$js$maze$types(a,c,d)}})(Path$$module$js$maze$types||(Path$$module$js$maze$types={}));
