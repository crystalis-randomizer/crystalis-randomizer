...
{title:"Advanced",descr:"A balanced randomization with quite a bit more difficulty.",flags:"Fsw Gfprt Hbdgw Mert Ps Roprst Tabmp Wmtuw Xcegw"},{title:"Ludicrous",descr:"Pulls out all the stops, may require superhuman feats.",flags:"Fs Gcfprtw Hbdgmswxz Mert Ps Roprst Tabmp Wmtuw Xcegw"},{title:"Mattrick",descr:"Not for the faint of heart. Good luck...",flags:"Fcprsw Gt Hbdhwx Mert Ps Ropst Tabmp Wmtuw"},{title:"The Full Stupid",descr:"Nobody has ever completed this.",flags:"Fcprsw Hbdhmwxz Mert Ps Ropst Sckmt Tab Wmtuw Xcegw"},
...
_DISABLE_TRIGGER_SKIP:!0,_DISABLE_WARP_BOOTS_REUSE:c.disableShopGlitch(),_DISABLE_WILD_WARP:!1,_DISPLAY_DIFFICULTY:!0,_EXTRA_PITY_MP:!0,_FIX_COIN_SPRITES:!0,_FIX_OPEL_STATUE:!0,_FIX_SHAKING:!0,_FIX_VAMPIRE:!0,_HARDCORE_MODE:c.hardcoreMode(),_HAZMAT_SUIT:c.changeGasMaskToHazmatSuit(),_LEATHER_BOOTS_GIVE_SPEED:c.leatherBootsGiveSpeed(),_NERF_FLIGHT:!0,_NERF_MADO:!0,_NERF_WILD_WARP:c.nerfWildWarp(),_NEVER_DIE:c.neverDie(),_NORMALIZE_SHOP_PRICES:!0,_PITY_HP_AND_MP:!0,_PROGRESSIVE_BRACELET:!0,_RABBIT_BOOTS_CHARGE_WHILE_WALKING:c.rabbitBootsChargeWhileWalking(),
_REQUIRE_HEALED_DOLPHIN_TO_RIDE:c.requireHealedDolphinToRide(),_REVERSIBLE_SWAN_GATE:!0,_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_SIMPLIFY_INVISIBLE_CHESTS:!0,_SOFT_RESET_SHORTCUT:!0,_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword(),_TRAINER:c.trainer(),_TWELVTH_WARP_POINT:!0,_UNIDENTIFIED_ITEMS:c.unidentifiedItems(),_ZEBU_STUDENT_GIVES_ITEM:c.zebuStudentGivesItem()},m=new Assembler$$module$js$6502;deterministicPreParse$$module$js$pass$deterministic(a.subarray(16));
var l=Object.keys(k).filter((a)=>k[a]).map((a)=>`define ${a} 1\n`).join("");m.assemble(l,"flags.s");yield g("preshuffle.s");h=new Random$$module$js$random(h);l=new Rom$$module$js$rom(a);l.flags.defrag();"object"==typeof window&&(window.rom=l);l.spoiler=new Spoiler$$module$js$rom$spoiler(l);e&&(e.spoiler=l.spoiler);deterministic$$module$js$pass$deterministic(l,c);toggleMaps$$module$js$pass$togglemaps(l,c,h);yield g("postparse.s");l.scalingLevels=48;l.uniqueItemTableAddress=m.expand("KeyItemData");
c.shuffleShops()&&shuffleShops$$module$js$patch(l,c,h);shuffleGoa$$module$js$pass$shufflegoa(l,h);randomizeWalls$$module$js$patch(l,c,h);crumblingPlatforms$$module$js$pass$crumblingplatforms(l,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(l,c,h);c.randomizeThunderTeleport()&&randomizeThunderWarp$$module$js$pass$randomizethunderwarp(l,h);rescaleMonsters$$module$js$pass$rescalemonsters(l,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(l,c,h);shuffleTrades$$module$js$pass$shuffletrades(l,
c,h);c.randomizeMaps()&&shuffleMazes$$module$js$pass$shufflemazes(l,c,h);c.shuffleMimics()&&shuffleMimics$$module$js$pass$shufflemimics(l,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$pass$shufflemonsters(l,c,h);var n=new World$$module$js$logic$world(l,c);if(n=yield(new Graph$$module$js$logic$graph([n.getLocationList()])).shuffle(c,h,void 0,f,l.spoiler))for(var p of n){const [a,b]=p;l.slots[a&255]=b&255}else return[a,-1];rescaleShops$$module$js$patch(l,m,c.bargainHunting()?h:void 0);identifyKeyItemsForDifficultyBuffs$$module$js$patch(l);
c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(l);shuffleMusic$$module$js$patch(l,c,h);shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);c.blackoutMode()&&blackoutMode$$module$js$patch(l);misc$$module$js$patch(l,c,h);fixDialog$$module$js$pass$fixdialog(l);c.buffDyna()&&buffDyna$$module$js$patch(l,c);c.trainer()&&(l.wildWarp.locations=[10,26,53,72,109,110,140,170,172,176,182,159,166,88,92,0]);yield l.writeData();
buffDyna$$module$js$patch(l,c);p=yield postParsedShuffle$$module$js$patch(a,h,b,c,m,g);EXPAND_PRG$$module$js$patch&&(h=a.subarray(16),h.subarray(507904,524288).set(h.subarray(245760,262144)));return[a,p]})}
