...
a.assumeGhettoFlight())),m=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),q=h(d("Assume teleport skip",a.assumeTeleportSkip())),p=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),t=h(d("Allow rabbit skip",!a.disableRabbitSkip())),u=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),B=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),J=h(d("Assume wild warp",a.assumeWildWarp())),
x=d("Allow wild warp",a.allowWildWarp()),y=d("Sword magic optional",!a.guaranteeSwordMagic()),K=d("Matching sword optional",!a.guaranteeMatchingSword()),Qa=d("Gas mask optional",!a.guaranteeGasMask()),Pd=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),Qd=d("Calm sea optional",!a.barrierRequiresCalmSea()),Rd=d("Prison key optional",!a.paralysisRequiresPrisonKey()),Sd=d("Windmill optional",!a.sealedCaveRequiresWindmill()),Td=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
...
68,"Teleport")).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),je=(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),tc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),qa=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),E=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=P.bossDrop("Vampire 2",
...
Nc=new Trigger$$module$js$nodes(c,"Shyron Massacre"),Ae=(new Trigger$$module$js$nodes(c,"Saved Kensu")).get(E),Be=(new Trigger$$module$js$nodes(c,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$js$nodes(c,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(c,"Get Bow of Truth")).get(rc),Ee=(new Trigger$$module$js$nodes(c,"Forged Crystalis")).get(pb),$a=(new Condition$$module$js$nodes(c,"Sword charge glitch")).option(u,B),Fe=(new Condition$$module$js$nodes(c,"Rabbit skip")).option(r,
...
"Destroy ice")).option(T,Ra).option(T,Sa).option(T,Ta).option($a,T,bb),v=(new Condition$$module$js$nodes(c,"Cross rivers")).option(O,Ra).option(O,Ua).option(O,Va).option(E).option($a,O,bb),xa=(new Condition$$module$js$nodes(c,"Destroy iron")).option(M,Ra).option(M,Wa).option(M,Xa).option($a,M,bb),V=(new Condition$$module$js$nodes(c,"Any sword")).option(S).option(T).option(O).option(M),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(T).option(O).option(M).option(Ya,
K.value?K:g,S),Je=(new Condition$$module$js$nodes(c,"Match vampire 2 sword (wind/water/thunder)")).option(S).option(O).option(M).option(K.value?K:g,T),Oc=(new Condition$$module$js$nodes(c,"Speed boots")).option(fc,k),Pc=(new Condition$$module$js$nodes(c,"Climb slopes")).option(vb).option(E).option(Oc),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Ac).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(sc).option(Ge,E),Qc=(new Condition$$module$js$nodes(c,
"Asina in her room")).option(Fc),Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(Ka).option(Qc).option(ab),Rc=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(yb,Ic),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(l,Rc,vb),da=(new Condition$$module$js$nodes(c,"Cross sea")).option(Rc).option(E),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Db).option(E).option(Ne),W=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(Xb.value?
Xb:g).option(Za),Sc=(new Condition$$module$js$nodes(c,"Wind magic")).option(y.value?y:g,W).option(Ia,Ja,W),Tc=(new Condition$$module$js$nodes(c,"Fire magic")).option(y.value?y:g,W).option(Sa,Ta,W),Uc=(new Condition$$module$js$nodes(c,"Water magic")).option(y.value?y:g,W).option(y,W).option(Ua,Va,W),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(y.value?y:g,W).option(y,W).option(Wa,W).option(Xa,W),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(ub).option(ab),
...
Aa=new Area$$module$js$nodes(c,"Amazones"),F=new Area$$module$js$nodes(c,"Mt Sabre West"),w=new Area$$module$js$nodes(c,"Mt Sabre North"),db=new Area$$module$js$nodes(c,"Nadare's"),Ma=new Area$$module$js$nodes(c,"Oak"),ja=new Area$$module$js$nodes(c,"Waterfall Valley"),D=new Area$$module$js$nodes(c,"Portoa"),ka=new Area$$module$js$nodes(c,"Waterfall Cave"),G=new Area$$module$js$nodes(c,"Fog Lamp Cave"),la=new Area$$module$js$nodes(c,"Kirisa Plant Cave"),sa=new Area$$module$js$nodes(c,"Angry Sea"),
ma=new Area$$module$js$nodes(c,"Joel"),L=new Area$$module$js$nodes(c,"Evil Spirit Island"),na=new Area$$module$js$nodes(c,"Sabera's Castle"),aa=new Area$$module$js$nodes(c,"Swan"),C=new Area$$module$js$nodes(c,"Mt Hydra"),oa=new Area$$module$js$nodes(c,"Shyron"),ta=new Area$$module$js$nodes(c,"Styx"),ua=new Area$$module$js$nodes(c,"Goa"),eb=new Area$$module$js$nodes(c,"Draygonia Fortress 1"),ba=new Area$$module$js$nodes(c,"Draygonia Fortress 2"),Ba=new Area$$module$js$nodes(c,"Draygonia Fortress 3"),
...
xc);const Ea=(new Location$$module$js$nodes(c,32,F,"Entrance")).overworld().connect(Da).connect(Af),Df=(new Location$$module$js$nodes(c,32,F,"Up Slope")).overworld().from(Ea,Pc).to(Ea),Ef=(new Location$$module$js$nodes(c,32,F,"Dead End (warp boots)")).overworld().chest(U,24,106),cd=(new Location$$module$js$nodes(c,33,F,"Upper")).overworld().from(Ea,E).to(Ea),Ff=(new Location$$module$js$nodes(c,33,F,"Tornel Dead End")).overworld().trigger(qe,Ia,Ja).chest(Y,23,105),dd=(new Location$$module$js$nodes(c,
34,F,"Tunnel 2a (fork at start)")).cave().connect(Ea);(new Location$$module$js$nodes(c,34,F,"Tunnel 2b (left branch to dead end)")).cave().connect(dd,A).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,F,"Tunnel 2c (right branch to upper)")).cave().connect(dd,A),Hf=(new Location$$module$js$nodes(c,35,F,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(H,23,82),If=(new Location$$module$js$nodes(c,35,F,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,
A).connectTo(cd),ed=(new Location$$module$js$nodes(c,36,F,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,F,"Tunnel 4b (out to upper)")).cave().connect(ed,A).connectTo(cd);const Jf=(new Location$$module$js$nodes(c,37,F,"Tunnel 5 (tiny connector)")).cave().connect(ed),Kf=(new Location$$module$js$nodes(c,38,F,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);(new Location$$module$js$nodes(c,38,F,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,
A).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,F,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,F,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,A);(new Location$$module$js$nodes(c,39,F,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,A).chest(Ja,25);const hb=(new Location$$module$js$nodes(c,40,w,"Entrance")).overworld().connect(bd,Le,Ke),ib=(new Location$$module$js$nodes(c,40,w,"Upper")).overworld().from(hb,E).to(hb),
Ib=(new Location$$module$js$nodes(c,40,w,"Summit (boss)")).overworld().from(ib,E).to(ib).boss(bf),fd=(new Location$$module$js$nodes(c,41,w,"Connector")).overworld(),Jb=(new Location$$module$js$nodes(c,41,w,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,w,"Middle Right")).overworld().from(Jb,Pc).to(Jb),gd=(new Location$$module$js$nodes(c,42,w,"Tunnel 2a (from entrance to connector)")).cave().connectTo(fd);(new Location$$module$js$nodes(c,42,w,"Tunnel 2b (under bridge, to antidote)")).cave().connect(gd,
A).chest(N,23,94);const hd=(new Location$$module$js$nodes(c,43,w,"Tunnel 3a (branch after connector)")).cave().connect(fd),Of=(new Location$$module$js$nodes(c,43,w,"Tunnel 3b (right branch)")).cave().connect(hd,A),Pf=(new Location$$module$js$nodes(c,43,w,"Tunnel 3c (upper branch)")).cave().connect(hd,A);(new Location$$module$js$nodes(c,44,w,"Tunnel 4 (over bridge, to middle)")).cave().connect(Pf).connectTo(Jb);const id=(new Location$$module$js$nodes(c,45,w,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Of).connectTo(Nf);
(new Location$$module$js$nodes(c,45,w,"Tunnel 5b (dead-end with herb)")).cave().connect(id,A).chest(H,22,83);const Qf=(new Location$$module$js$nodes(c,46,w,"Tunne; 6a (S-shaped hall, right)")).cave().connect(id),Rf=(new Location$$module$js$nodes(c,46,w,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Qf,A),Sf=(new Location$$module$js$nodes(c,46,w,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Rf,A),jd=(new Location$$module$js$nodes(c,47,w,"Prison (hallway)")).cave().connect(ib),Tf=(new Location$$module$js$nodes(c,
48,w,"Left Cell (shopkeepers)")).cave().from(jd,A);(new Location$$module$js$nodes(c,49,w,"Left Cell 2 (back, with prison key)")).cave().from(Tf,A).chest(xb,13);const Uf=(new Location$$module$js$nodes(c,50,w,"Right Cell (villagers)")).cave().from(jd,A),Vf=(new Location$$module$js$nodes(c,51,w,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Uf,A);(new Location$$module$js$nodes(c,52,w,"Tunnel 9 (connector to summit)")).cave().connect(Vf).connectTo(Ib);const Wf=(new Location$$module$js$nodes(c,
53,w,"Summit Cave (front)")).cave().from(Ib,xb).to(Ib),Xf=(new Location$$module$js$nodes(c,53,w,"Summit Cave (behind ice)")).cave().connect(Wf,A).trigger(re);(new Location$$module$js$nodes(c,56,w,"Tunnel 1 (leads from main entrance)")).cave().connect(hb).connectTo(gd);(new Location$$module$js$nodes(c,57,w,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(ib);const Yf=(new Location$$module$js$nodes(c,60,db,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,db,"Tool Shop")).shop(H,N,P,U),$f=(new Location$$module$js$nodes(c,
62,db,"Back Room")).house(),Kb=(new Location$$module$js$nodes(c,64,ja,"Summit")).overworld().connect(Xf,nf),jb=(new Location$$module$js$nodes(c,64,ja,"Northwest")).overworld().from(Kb).to(Kb,E),ag=(new Location$$module$js$nodes(c,64,ja,"Northeast")).overworld().connect(jb,v),kd=(new Location$$module$js$nodes(c,65,ja,"Southwest")).overworld().connect(jb),bg=(new Location$$module$js$nodes(c,65,ja,"Southeast")).overworld().connect(kd,v),ld=(new Location$$module$js$nodes(c,66,ja,"Lime Tree Valley")).overworld().connect(kd).connect(Na,
...
(new Location$$module$js$nodes(c,69,la,"Tunnel 2c (main path, after wall)")).cave().connect(md,z),gg=(new Location$$module$js$nodes(c,70,la,"Tunnel 3a (last room, before wall)")).cave().connect(fg),hg=(new Location$$module$js$nodes(c,70,la,"Tunnel 3b (last room, after wall)")).cave().connect(gg,z);(new Location$$module$js$nodes(c,71,la,"Meadow")).overworld().connect(hg).chest(oc,14);const ig=(new Location$$module$js$nodes(c,72,G,"Tunnel 1a (entrance)")).cave().connect(ag),nd=(new Location$$module$js$nodes(c,
72,G,"Tunnel 1b (past wall)")).cave().connect(ig,z);(new Location$$module$js$nodes(c,72,G,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(nd,z).chest(wa,24);const jg=(new Location$$module$js$nodes(c,73,G,"Tunnel 2 (tiny connector)")).cave().connect(nd),od=(new Location$$module$js$nodes(c,74,G,"Tunnel 3a (upper branch)")).cave().connect(jg);(new Location$$module$js$nodes(c,74,G,"Tunnel 3b (dead end, mimic)")).cave().connect(od,z).chest(Q,21,112);const pd=(new Location$$module$js$nodes(c,74,G,"Tunnel 3c (short passage with mimic)")).cave().connect(od,
z).chest(Q,22,113),kg=(new Location$$module$js$nodes(c,74,G,"Tunnel 3d (lower branch)")).cave().connect(pd,z);(new Location$$module$js$nodes(c,75,G,"Dead end loop")).cave().connect(kg);const qd=(new Location$$module$js$nodes(c,76,G,"Tunnel 4a (right branch over bridge)")).cave().connect(pd),lg=(new Location$$module$js$nodes(c,76,G,"Tunnel 4b (past wall over bridge)")).cave().connect(qd,z),mg=(new Location$$module$js$nodes(c,77,G,"Tunnel 5a (from left branch)")).cave().connect(qd),ng=(new Location$$module$js$nodes(c,
77,G,"Tunnel 5b (reconvergence)")).cave().connect(mg,z).connect(lg),og=(new Location$$module$js$nodes(c,77,G,"Tunnel 5c (between walls)")).cave().connect(ng,z),pg=(new Location$$module$js$nodes(c,77,G,"Tunnel 5d (under bridge)")).cave().connect(og,z),qg=(new Location$$module$js$nodes(c,78,G,"Tunnel 6a (over second bridge)")).cave().connect(pg),rg=(new Location$$module$js$nodes(c,78,G,"Tunnel 6b (past wall)")).cave().connect(qg,z),sg=(new Location$$module$js$nodes(c,79,G,"Tunnel 7a (under second bridge)")).cave().connect(rg);
(new Location$$module$js$nodes(c,79,G,"Tunnel 7b (fog lamp)")).cave().connect(sg,z).chest(jc,19);const va=(new Location$$module$js$nodes(c,80,D,"Town")).town().connect(jb),rd=(new Location$$module$js$nodes(c,81,D,"Fishherman Island")).town().connect(va);(new Location$$module$js$nodes(c,82,ja,"Mesia Shrine")).cave().trigger(Fc).connect(cg,v,Ec);const sd=(new Location$$module$js$nodes(c,84,ka,"Tunnel 1a (entrance)")).cave().connect(jb);(new Location$$module$js$nodes(c,84,ka,"Tunnel 1b (dead end, mimic)")).cave().connect(sd,
...
wb);const kb=(new Location$$module$js$nodes(c,100,D,"Underground Channel 1 (from throne room)")).sea().trigger(Dc),Eg=(new Location$$module$js$nodes(c,100,D,"Underground Channel 2 (to fortune teller)")).sea().connect(kb,v),wd=(new Location$$module$js$nodes(c,100,D,"Underground Channel 3 (from fortune teller)")).sea().connect(kb,E),xd=(new Location$$module$js$nodes(c,100,D,"Underground Channel 4 (asina)")).sea().connect(wd,v),Fg=(new Location$$module$js$nodes(c,100,D,"Underground Channel 5 (dolphin)")).sea().connect(xd,
v).trigger(Hc,H,Gc);(new Location$$module$js$nodes(c,100,D,"Underground Channel 6 (water)")).sea().connect(Fg,da).connectTo(Fa,da).chest(nc,17);const Nb=(new Location$$module$js$nodes(c,101,L,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,L,"Tunnel 1 (entrance)")).sea().connect(Fa,Jc,da),yd=(new Location$$module$js$nodes(c,105,L,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,L,"Tunnel 2b (dead end to left)")).cave().connect(yd,v);const Hg=(new Location$$module$js$nodes(c,
...
124,C,"Entrance")).overworld().connect(mb),Sg=(new Location$$module$js$nodes(c,124,C,"Over first river toward Shyron")).overworld().connect(Pb,v),Bd=(new Location$$module$js$nodes(c,124,C,"After first tunnel")).overworld(),Cd=(new Location$$module$js$nodes(c,124,C,"Door to Styx")).overworld().connect(Bd,v),Tg=(new Location$$module$js$nodes(c,124,C,"Dead end (no item)")).overworld(),Ug=(new Location$$module$js$nodes(c,124,C,"Dead end (fruit of lime)")).overworld().chest(rb,26),Vg=(new Location$$module$js$nodes(c,
124,C,"Dead end (magic ring)")).overworld().chest(Y,25,101),Dd=(new Location$$module$js$nodes(c,124,C,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(c,124,C,"Floating island (bow of sun)")).overworld().connect(Dd,E).chest(qc,24);const Wg=(new Location$$module$js$nodes(c,125,C,"Tunnel 1 (to Shyron)")).cave().connect(Sg),Xg=(new Location$$module$js$nodes(c,126,C,"Outside Shyron")).overworld().connect(Wg);(new Location$$module$js$nodes(c,127,C,"Tunnel 2 (fork)")).cave().connect(Pb).connectTo(Ug).connectTo(Bd);
const Ed=(new Location$$module$js$nodes(c,128,C,"Tunnel 3 (caves)")).cave().connect(Cd).connect(Tg),Fd=(new Location$$module$js$nodes(c,129,C,"Tunnel 4 (left branch of cave)")).cave().connect(Ed);(new Location$$module$js$nodes(c,130,C,"Tunnel 5 (dead end, medical herb)")).cave().connect(Fd).chest(H,15,86);const Yg=(new Location$$module$js$nodes(c,131,C,"Tunnel 6a (left-then-right)")).cave().connect(Fd),Zg=(new Location$$module$js$nodes(c,131,C,"Tunnel 6b (past wall)")).cave().connect(Yg,z),$g=(new Location$$module$js$nodes(c,
132,C,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,C,"Tunnel 8 (red slimes)")).cave().from($g,z).connectTo(Dd).chest(Q,23,116);const ah=(new Location$$module$js$nodes(c,134,C,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Ed),bh=(new Location$$module$js$nodes(c,135,C,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,135,C,"Tunnel 10b (past wall)")).cave().connect(bh,z).connectTo(Vg);const Gd=(new Location$$module$js$nodes(c,
...
E).chest(Q,20,118).chest(Q,21,119).chest(Zd,28);(new Location$$module$js$nodes(c,138,ta,"Upper floor")).fortress().connect(eh).chest(M,27);const Ga=(new Location$$module$js$nodes(c,140,oa,"Town")).town().connect(Xg,Re).trigger(Eb),Pa=(new Location$$module$js$nodes(c,142,ua,"Town")).town().connect(mb),Hd=(new Location$$module$js$nodes(c,143,I,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,I,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Hd,
...
Se).trigger(ye,qa,oc);(new Location$$module$js$nodes(c,213,db,"Nadare's")).house().connect(hb).connectTo(Yf).connectTo(Zf).connectTo($f);(new Location$$module$js$nodes(c,214,D,"Fisherman's House")).house().connect(rd).trigger(Cb,jc,yb,Te);const Vb=(new Location$$module$js$nodes(c,215,D,"Palace Entrance")).house().connect(va);(new Location$$module$js$nodes(c,216,D,"Fortune Teller Front")).house().connect(va).trigger(Cc,Bc);(new Location$$module$js$nodes(c,216,D,"Fortune Teller Back")).house().connect(Eg).connect(wd);
(new Location$$module$js$nodes(c,217,D,"Pawn Shop")).shop().connect(va);(new Location$$module$js$nodes(c,218,D,"Armor Shop")).shop(be,bc,Zb).connect(va);(new Location$$module$js$nodes(c,220,D,"Inn")).shop().connect(va);(new Location$$module$js$nodes(c,221,D,"Tool Shop")).shop(H,wa,rb,U).connect(va);(new Location$$module$js$nodes(c,222,D,"Palace Left")).house().connect(Vb);(new Location$$module$js$nodes(c,223,D,"Palace Throne Room")).house().connect(Vb).to(kb,Me).from(kb).trigger(Bc).trigger(se,Cc,
Dc);(new Location$$module$js$nodes(c,224,D,"Palace Right")).house().connect(Vb);(new Location$$module$js$nodes(c,225,D,"Asina's Room")).house().connect(xd).trigger(Gc,Qc);(new Location$$module$js$nodes(c,226,Aa,"Queen Downstairs")).house().connect(Qh).chest(Va,13);(new Location$$module$js$nodes(c,227,ma,"Elder's House")).house().connect(lb).trigger(Jc);(new Location$$module$js$nodes(c,228,ma,"Shed")).house().connect(lb).to(Pg,kc);(new Location$$module$js$nodes(c,229,ma,"Tool Shop")).shop(H,N,P,wa).connect(lb);
...
if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return q[a.slotType?a.slotType[0]:"c"]===q[b.slotType?b.slotType[0]:"c"]};p=b.assumedFill(d,(a,b)=>t(a,n.get(b)));if(null==p){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const u=new Map;for(var B=0;B<p.length;B++){var J=p[B];if(null!=J){var x=n.get(b.item(J));J=l.get(x);l.delete(x);x=b.location(B);u.set(x,J);m.delete(x)}}B=(a,b,c)=>{c=void 0===c?"":c;for(const c of m)if(t(c,a))return u.set(c,b),m.delete(c),l.delete(a),!0;
g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var y of l){const [a,b]=y;if(a.isMimic()&&!B(a,b,"traps"))return!1}for(const a of l){const [b,c]=a;if(b.needsChest()&&!B(b,c,"chest"))return!1}for(const a of l){const [b,c]=a;if(!B(b,c))return!1}for(const a of u){const [b,c]=a;b.set(...c)}const {win:K,path:Qa}=a.traverse({wanted:k,dfs:!1});if(!K)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,p));e.items=
[];e.route=[];for(const b of Qa){const [c,d]=b;e.route.push(d);k=a.nodes[c];k instanceof Slot$$module$js$nodes&&!k.isFixed()&&(y=k.slotName,0>y.indexOf(k.vanillaItemName)&&(y+=` (normally ${k.vanillaItemName})`),e.items.push({itemIndex:k.itemIndex,itemName:k.item.name,origName:k.vanillaItemName,slotIndex:k.slotIndex,slotName:k.slotName,text:`${k.item.name}: ${y}`}))}return!0})};var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;module$js$depgraph.shuffle=shuffle$$module$js$depgraph;
...
function build$$module$js$graph$world(a,b){b=void 0===b?new FlagSet$$module$js$flagset("@FullShuffle"):b;const c=new Overlay$$module$js$graph$overlay(a,b),d=new Map,e=new Map,f=new Map,g=new Map,h=new DefaultMap$$module$js$util(()=>new Set),k=new Map,l=new Set;for(const b of a.locations){var m=function(a,b){const c=d.get(a);c&&d.set(a,module$js$graph$condition.Terrain.meet(c,b))};if(!b.used)continue;const r=b.extended?256:0,u=a.tilesets[(b.tileset&127)>>2],B=a.tileEffects[b.tileEffects-179];for(const a of b.spawns)a.isWall()&&
e.set(module$js$graph$geometry.ScreenId.from(b,a),a.id&3);for(let f=0,g=b.height;f<g;f++){const g=b.screens[f],h=b.id<<8|f<<4;for(let f=0,k=b.width;f<k;f++){var n=function(a,b){if(!p)throw Error("flag expected");return b?a?t(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(p.flag)},b):a};const k=a.screens[g[f]|r],l=module$js$graph$geometry.ScreenId(h|f),m=l&255,q=e.get(l),p=null!=q?c.wallCapability(q):b.flags.find((a)=>a.yx===m),t=memoize2$$module$js$graph$condition((a,
b)=>{if(!p)throw Error("flag expected");b=Object.assign({},b,{enter:meet$$module$js$graph$condition(b.enter||[[]],module$js$graph$condition.Condition(p.flag))});return module$js$graph$condition.Terrain.join(a,b)});for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(l<<8|a);let e=k.tiles[a];p&&751===p.flag&&32>e&&(e=u.alternates[e]);let f=c.makeTerrain(r?0:B.effects[e]&38,b);if(32>e&&u.alternates[e]!=e&&p&&751!==p.flag){const a=c.makeTerrain(B.effects[u.alternates[e]],b);f=n(f,a)}f&&d.set(b,
...
b.reqs.check=(a,b)=>{b=void 0===b?J:b;return`${b(a)}: ${B(u.get(module$js$graph$condition.Slot(a)),b)}`};b.reqs.check2=(a)=>b.reqs.check(a,b.whatFlag)}return new World$$module$js$graph$world(a,q,makeGraph$$module$js$graph$world(u,a))}
...
15]<<8|q.tile);null!=p&&g.set(q.screen,{entrance:n,exit:b(n),dir:p})}for(n=0;n<a.height;n++)for(q=0,n||(q|=1),n===a.height-1&&(q|=4),p=0;p<a.width;p++){const B=n<<4|p;if(!m.has(B))continue;q&=-11;p||(q|=8);p===a.width-1&&(q|=2);var r=a.screens[n][p];l.add(r);if(128===r)continue;c++;let J=EDGES_BY_TILE$$module$js$maze$cave.get(r);if(null==J)throw Error(`Bad tile: ${hex$$module$js$rom$util(r)}`);var t=BITCOUNT$$module$js$maze$cave[J]+(g.has(B)?1:0);154===r&&(t=2);if(155===r||156==r||240==r||241==r)t=
1;1===t&&d++;2<t&&(e+=t-2);WALLS$$module$js$maze$cave.has(r)&&f++;t=FIXED_TILES$$module$js$maze$cave.get(r);DEAD_ENDS$$module$js$maze$cave.has(r)&&(J=0);for(const c of module$js$maze$maze.Dir.ALL)if(J&q&1<<c){r=null;for(var u=0;u<a.entrances.length;u++)if(a.entrances[u].screen===B&&matchesDir$$module$js$maze$cave(a.entrances[u].tile,c)){r=u;break}null!=r&&(u=b(r),h.set(B,{entrance:r,exit:u,dir:c}))}null!=t&&k.set(B,t)}return{size:c,deadEnds:d,branches:e,walls:f,stairs:g,edges:h,fixed:k,tiles:l}}
...
f[0]);g=a.entrances[c.entrance];k=g.tile&15;l=g.tile>>>4;g.screen=f[0];g.coord=f[1].entrance;m.set(b,[(g.tile>>>4)-l,(g.tile&15)-k]);for(var r of f[1].exits)a.exits.push(Exit$$module$js$rom$location.of({screen:f[0],tile:r,dest:c.exit>>>8,entrance:c.exit&255}))}r=new Map;h=a.monsterPlacer(b);for(const c of a.spawns)if(3!==c.type)if(c.isMonster())f=a.rom.objects[c.monsterId],f instanceof Monster$$module$js$rom$monster&&(g=h(f),null==g?(console.error(`no valid location for ${hex$$module$js$rom$util(f.id)} in ${hex$$module$js$rom$util(a.id)}`),
c.used=!1):(c.screen=g>>>8,c.tile=g&255));else if(f=c.screen,g=e.get(f),k=r.get(c.y<<12|c.x),null!=k)c.y=k>>>12,c.x=k&4095;else if(null!=g){if(c.screen=g,f=m.get(f),null!=f){const [a,b]=f;c.yt+=a;c.xt+=b}}else if(c.isTrigger())140===c.id?c.screen=e.get(33)-16:console.error(`unhandled trigger: ${c.id}`);else{f=[...d.keys()].sort((a,b)=>a-b);if(!f.length)throw Error("no poi");for(const a of f)if(f=d.get(a),f.length){g=c.y<<12|c.x;k=b.nextInt(f.length);[[c.y,c.x]]=f.splice(k,1);r.set(g,c.y<<12|c.x);
...
k=Math.min(a.width+1,8),l=Math.min(a.height+1,16),m=seq$$module$js$rom$util(k*l,(a)=>a%k|Math.floor(a/k)<<4),n=surveyMap$$module$js$maze$cave(a),q=n.size/k/l;let p;p=function(a){let {walls:f}=n;var h=new Set;for(const [b,c]of n.edges)for(;;){var r=e(c.dir);if(!h.has(r)){h.add(r);var p=n.fixed.get(b);null==p?a.setBorder(r,c.dir,6):(a.setBorder(r,c.dir,p.edges>>>module$js$maze$maze.Dir.shift(c.dir)&15),fixBorders$$module$js$maze$cave(a,r,p.edges),a.set(r,p.edges),p.wall&&f--);break}}for(const [c,d]of n.fixed)if(!n.edges.has(c))for(const c of b.ishuffle(m))if(!h.has(c)&&
a.saveExcursion(()=>{fixBorders$$module$js$maze$cave(a,c,d.edges);return a.trySet(c,d.edges)})){h.add(c);d.wall&&f--;break}r=[...n.stairs.values()];p=0;for(var x=0;10>p&&x<r.length;p++){const b=a.randomPos();!h.has(b)&&a.fill(b,{stair:r[x].dir})&&(h.add(b),p=0,x++)}if(10<=p)return fail$$module$js$maze$cave("could not add all stairs");if(!a.fillAll({edge:1,fuzzy:1,shuffleOrder:!0,skipAlternates:!0}))return fail$$module$js$maze$cave("could not fill open");if(!g(a))return fail$$module$js$maze$cave("check failed after initial setup");
const y={skipAlternates:!0};for(const [c]of b.shuffle([...a])){if(a.density()<=q)break;!a.isFixed(c)&&a.saveExcursion(()=>a.setAndUpdate(c,0,y)&&g(a))}if(!c.allowTightCycles)for(h=1;h<l;h++)for(r=1;r<k;r++)if(p=h<<4|r,isTightCycle$$module$js$maze$cave(a,p)){x=!1;for(const c of b.ishuffle(module$js$maze$maze.Dir.ALL)){const b=2>c?p-1:p-16;a.saveExcursion(()=>a.replaceEdge(b,c,0)&&g(a))&&(x=!0)}if(!x)return fail$$module$js$maze$cave("failed to remove tight cycle")}h=new Set;r=[...a.alternates()];for(const c of[140])if(n.tiles.count(c)){p=
b.shuffle(r.filter((a)=>a[3].tile===c));if(p.length<n.tiles.count(c))return fail$$module$js$maze$cave("could not add stair hallway");for(x=n.tiles.count(c)-1;0<=x;x--)a.replace(p[x][0],p[x][2]),h.add(p[x][0])}r=b.shuffle(r.filter((a)=>a[3].wall));for(p=0;p<f;p++){x=r.pop();if(null==x)return fail$$module$js$maze$cave(`could not add wall ${p}`);h.has(x[0])?p--:(a.replace(x[0],x[2]),h.add(x[0]))}return d(a)};for(let a=0;a<f;a++){const a=new Maze$$module$js$maze$maze(b,l,k,h);if(p(a))return}throw Error("Could not shuffle");
...
var h=MOTHS_AND_BATS$$module$js$patch.has(a.id);if(d){if(!m)return!1;--m}const l=b.getMonsterConstraint(e.id,a.id);let r=n.tryMeet(l);!r&&Infinity>n.pal2.size&&Infinity>n.pal3.size&&this.flags.shuffleSpritePalettes()&&(r=n.tryMeet(l,!0));if(!r)return!1;if(p){var y=e.rom.objects[a.id];if(!(y instanceof Monster$$module$js$rom$monster))throw Error(`non-monster: ${y}`);y=p(y);if(null==y)return!1}g.push(`  Adding ${a.id.toString(16)}: ${r}`);n=r;c.monsterClass&&q.set(c.monsterClass,a.id);c=0;if(d||h)for(d=
0;d<f.length;d++){if(f[d]in k){c=d;break}}else for(d=0;d<f.length;d++)if(!(f[d]in k)){c=d;break}(this.report[`mon-${a.id.toString(16)}`]=this.report[`mon-${a.id.toString(16)}`]||[]).push("$"+e.id.toString(16));d=f[c];h=e.spawns[d-13];p?(h.screen=y>>>8,h.tile=y&255):d in k&&(h.y+=16*k[d][0],h.x+=16*k[d][1]);h.monsterId=a.id;g.push(`    slot ${d.toString(16)}: ${h}`);f.splice(c,1);return!0};const p=f.length&&this.flags.randomizeMaps()?e.monsterPlacer(a):null;if(m&&f.length)for(var d=0;d<Math.min(40,
this.monsters.length);d++)FLYERS$$module$js$patch.has(this.monsters[d].id)&&c(this.monsters[d])&&this.monsters.splice(d,1);for(d=0;d<this.monsters.length&&f.length;d++)if(c(this.monsters[d])){const [a]=this.monsters.splice(d,1);FLYERS$$module$js$patch.has(a.id)||this.used.push(a);d--}for(d=0;d<this.used.length&&f.length;d++)c(this.used[d])&&(this.used.push(...this.used.splice(d,1)),d--);n.fix(e,a);if(f.length){console.error(`Failed to fill location ${e.id.toString(16)}: ${f.length} remaining`);for(const a of f)c=
