...
return d}function f(a){a.reverse();for(let b=0;b<a.length;b++){const c=a[b+1];a[b].condition=c?~c.condition:-1}}a.npcs[116].link(126);a.npcs[116].used=!0;a.npcs[116].data=[...a.npcs[126].data];a.locations.Swan_DanceHall.spawns.find((a)=>a.isNpc()&&126===a.id).id=116;a.items[59].tradeIn[0]=116;a.npcs[136].linkDialog(22);a.npcs[126].data[0]=57;a.npcs[130].used=!0;a.npcs[130].link(22);a.npcs[130].data=[...a.npcs[22].data];a.locations.Brynmaer.spawns.find((a)=>a.isNpc()&&22===a.id).id=130;a.items[37].tradeIn[0]=
130;d(19)[2].condition=71;d(19)[2].flags=[169];d(19)[3].flags=[169];e(20,14)[1]=-137;c(e(22,87),-82);c(e(136,87),-82);var g=d(29);g[0].message.action=3;g[1].message.action=3;g[2].message.action=3;g[3].message.action=3;const h=d(30);(()=>{const [b,c,d,e]=h;e.condition=-70;c.condition=-1;a.npcs[30].localDialogs.set(-1,[e,d,b,c])})();for(const a of[32,33,34,124,125])f(d(a));g=d(31);g.unshift(...g.splice(1,1));a.npcs[51].spawnConditions.set(223,[-33,-28]);d(52)[1].condition=27;d(56)[3].message.action=
3;d(56)[4].flags.push(156);e(56,223)[1]=-28;e(56,225)[0]=27;d(56)[1].condition=27;e(57,216)[1]=-28;a.npcs[68].spawnConditions.set(233,[-142]);a.npcs[68].spawnConditions.set(228,[141]);a.npcs[94].localDialogs.set(16,[LocalDialog$$module$js$rom$npc.of(-59,[0,26],[58]),LocalDialog$$module$js$rom$npc.of(13,[0,29]),LocalDialog$$module$js$rom$npc.of(56,[0,28]),LocalDialog$$module$js$rom$npc.of(57,[0,29]),LocalDialog$$module$js$rom$npc.of(10,[0,27,3]),LocalDialog$$module$js$rom$npc.of(-1,[0,29])]);c(e(94,
16),-82);a.npcs[95].spawnConditions.delete(33);a.npcs[96].spawnConditions.delete(30);g=a.npcs[98];g.data[1]=40;d(g.id,225)[0].message.action=17;d(g.id,225)[2].message.action=17;c(e(g.id,225),-144);a.npcs[104].spawnConditions.set(97,[-156,33]);d(104)[0].message.action=2;a.npcs[110].spawnConditions.get(242).push(-40);a.trigger(130).conditions.push(-40);d(195)[0].condition=514;a.npcs[196].spawnConditions.delete(242);a.npcs[203].spawnConditions.set(166,[-654]);g=a.npcs[94].localDialogs.get(242);g.unshift(...g.splice(1,
1));a.trigger(128).conditions=[-40,59,765];a.trigger(129).conditions=[];b.barrierRequiresCalmSea()&&a.trigger(132).conditions.push(643);a.trigger(140).conditions.push(58);a.trigger(141).used=!1;for(const b of a.locations.MtSabreNorth_SummitCave.spawns)b.isTrigger()&&141===b.id&&(b.id=178);(function(a,b){b=a.findIndex(b);if(0>b)throw Error(`Could not find element in ${a}`);a.splice(b,1)})(a.locations.WaterfallValleyNorth.spawns,(a)=>a.isTrigger()&&141===a.id);a.trigger(178).conditions.push(258);a.trigger(178).flags.push(-133,
...
c(f)),d("09:05","[35:Fog Lamp]",c(f)),d("09:06","lamp",commonNoun$$module$js$pass$fixdialog(f)));f=a.npcs[56];d("0a:0c","[28:Flute of Lime]",c(f.data[0]));d("0a:0d","[02:Sword of Water]",c(f.localDialogs.get(-1)[3].condition&255));f=a.prg[250361];65>f&&b("0b:01");d("0b:01","[45:Recover]",c(f));f=a.prg[251609];65>f&&(d("0b:01","teach you\n the magic of","give you\n "),b("1d:12"));d("0b:01","[46:Barrier]",c(f));d("1d:12","[46:Barrier]",c(f));f=function(...b){for(const c of b){b=a.locations[c];for(const c of b.spawns)if(c.isChest()&&
72>c.id&&a.items[a.itemGets[c.id].itemId].unique)return c.id}return-1}(68,69,70,71,72,73,74,75,76,77,78,79);0<=f?d("0d:00","[35:Fog Lamp]",c(f)):d("0d:00","that a [35:Fog Lamp] was","there was treasure");f=a.npcs[195].localDialogs.get(-1)[0].condition&255;g=a.prg[250679];d("0e:03","[02:Sword of Water]",c(f));d("0e:03","[09:Ball of Water]",c(g));d("10:0c","that's","is");d("10:0c",/, is in the\+lighthouse/,"");f=e.get(35);null!=f&&(d("12:05","[3c:Kirisa Plant]",c(f)),d("12:10","the plant",`the ${commonNoun$$module$js$pass$fixdialog(f)}`),
d("12:10","[3c:Kirisa Plant]",c(f)),f=`Our illustrious chief seeks ${vague$$module$js$pass$fixdialog(f)}.`,d("12:09",/[^]*/,f),d("12:0a",/[^]*/,f));f=e.get(116);null!=f&&d("13:02","[3b:Love Pendant]",c(f));f=a.prg[251614];65>f&&d("13:02","teachs+you the magic of","bestow\n upon you the");d("13:02","[47:Change]",c(f));e=e.get(117);null!=e&&(d("18:06","[3d:Ivory Statue]",c(e)),d("18:07","[3d:Ivory Statue]",c(e)));d("18:06","It's in a room","{0b:Karmine} is");e=a.prg[250255];65>e&&d("18:07","teach",
"give");d("18:07","[48:Flight]",c(e));e=a.prg[251477];65>e&&b("1c:10");d("1c:10","[42:Paralysis]",c(e));d("20:06","Statue of Gold",c(58))}function findTornelTradeIn$$module$js$pass$fixdialog(a){for(const b of a.localDialogs.values())for(a=2;a<b.length;a++){const c=~b[a].condition;if(516<c&&524>=c&&!(c&1))return c&255}return 6}
...
c.id,1));break;case 9:128>c.data[1]&&b(new PersonDataSlot$$module$js$rom$slots(c.data[1],c.id,1))}for(const c of a.bosses)3!==c.kill&&13!==c.kill&&null!=c.kill&&null!=c.drop&&b(new BossDropSlot$$module$js$rom$slots(c.drop,c.kill));for(const [a,c]of hardcodedItems$$module$js$rom$slots)b(new HardcodedSlot$$module$js$rom$slots(this.rom.prg[a],a,c));extraSlots$$module$js$rom$slots.forEach(b);this.slots=c}update(a){for(var b=0;b<a.length;b++)if(null!=a[b])for(var c of this.slots[b])c.set(this.rom,a[b]);
b=this.rom.itemGets.map(()=>[]);for(const d of this.rom.itemGets){({id:c}=d);for(const e of d.flags){if(-1===e)continue;const d=preservedItemGetFlags$$module$js$rom$slots.has(e)?c:a[c];(b[d]||[]).push(e)}}for(const a of this.rom.itemGets)a.flags=b[a.id]}}
const hardcodedItems$$module$js$rom$slots=[[223220,"Stom fight"],[250255,"Slimed Kensu"],[250361,"Asina"],[250543,"Stoned Akahana"],[250679,"Rage"],[251477,"Mt Sabre summit trigger"],[251609,"Whirlpool trigger"],[251614,"Swan Kensu"],[251624,"Aryllis"],[251665],[251902,"Akahana statue trade-in"]],extraSlots$$module$js$rom$slots=[new PersonDataSlot$$module$js$rom$slots(54,99,1)];function update$$module$js$rom$slots(a,b){(new Slots$$module$js$rom$slots(a)).update(b)}
const preservedItemGetFlags$$module$js$rom$slots=new Set([36,139,756,757,758,759,760,761,762,763,764,765,766,767]);var module$js$rom$slots={};module$js$rom$slots.update=update$$module$js$rom$slots;class Spoiler$$module$js$rom$spoiler{constructor(a){this.rom=a;this.slots=[];this.route=[];this.mazes=[];this.trades=[];this.walls=[];this.unidentifiedItems=[];this.wildWarps=[];this.slotNames=[];this.conditionNames={}}addCondition(a,b){this.conditionNames[a]=b}addCheck(a,b,c){this.route.push(new Check$$module$js$rom$spoiler(this,a,b,c))}addSlot(a,b,c){this.slots[a]=new Slot$$module$js$rom$spoiler(this.rom,a,b,c);b&&(this.slotNames[512|a]=b)}addMaze(a,b,c){this.mazes.push({id:a,name:b,maze:c})}addTrade(a,
