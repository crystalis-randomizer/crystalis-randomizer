...
c.push(...this.items.write());c.push(...this.shops.write());b(this.bossKills);b(this.patterns);c.push(...this.wildWarp.write());c.push(...this.townWarp.write());c.push(...this.coinDrops.write());c.push(...this.scaling.write());c.push(...this.bosses.write());c.push(...this.randomNumbers.write());c.push(...this.telepathy.write());c.push(...this.messages.write());b=new Linker$$module$js$asm$linker;b.base(this.prg,0);for(var d of c)b.read(d);b.link().apply(this.prg);b.report();d=b.exports();this.uniqueItemTableAddress=
...
function shuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){function g(a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){return new Tokenizer$$module$js$asm$tokenizer(yield d.read(a),a,{lineContinuations:!0})})}if(EXPAND_PRG$$module$js$patch&&524288>a.length){var h=new Uint8Array(a.length+262144);h.subarray(0,262160).set(a.subarray(0,262160));h.subarray(524304).set(a.subarray(262160));h[4]<<=1;a=h}if("number"!==typeof b)throw Error("Bad seed");
h=crc32$$module$js$crc32(b.toString(16).padStart(8,"0")+String(c.filterOptional()))>>>0;var k=new Random$$module$js$random(h);c=c.filterRandom(k);const m={_ALLOW_TELEPORT_OUT_OF_BOSS:c.hardcoreMode()&&c.shuffleBossElements(),_ALLOW_TELEPORT_OUT_OF_TOWER:!0,_AUTO_EQUIP_BRACELET:c.autoEquipBracelet(),_BARRIER_REQUIRES_CALM_SEA:!0,_BUFF_DEOS_PENDANT:c.buffDeosPendant(),_BUFF_DYNA:c.buffDyna(),_CHECK_FLAG0:!0,_CTRL1_SHORTCUTS:c.controllerShortcuts(),_CUSTOM_SHOOTING_WALLS:!0,_DISABLE_SHOP_GLITCH:c.disableShopGlitch(),
_DISABLE_STATUE_GLITCH:c.disableStatueGlitch(),_DISABLE_SWORD_CHARGE_GLITCH:c.disableSwordChargeGlitch(),_DISABLE_TRIGGER_SKIP:!0,_DISABLE_WARP_BOOTS_REUSE:c.disableShopGlitch(),_DISABLE_WILD_WARP:!1,_DISPLAY_DIFFICULTY:!0,_EXTRA_PITY_MP:!0,_FIX_COIN_SPRITES:!0,_FIX_OPEL_STATUE:!0,_FIX_SHAKING:!0,_FIX_VAMPIRE:!0,_HARDCORE_MODE:c.hardcoreMode(),_HAZMAT_SUIT:c.changeGasMaskToHazmatSuit(),_LEATHER_BOOTS_GIVE_SPEED:c.leatherBootsGiveSpeed(),_MAX_SCALING_IN_TOWER:c.maxScalingInTower(),_NERF_FLIGHT:!0,
_NERF_MADO:!0,_NEVER_DIE:c.neverDie(),_NORMALIZE_SHOP_PRICES:c.shuffleShops(),_PITY_HP_AND_MP:!0,_PROGRESSIVE_BRACELET:!0,_RABBIT_BOOTS_CHARGE_WHILE_WALKING:c.rabbitBootsChargeWhileWalking(),_REQUIRE_HEALED_DOLPHIN_TO_RIDE:c.requireHealedDolphinToRide(),_REVERSIBLE_SWAN_GATE:!0,_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_SIMPLIFY_INVISIBLE_CHESTS:!0,_SOFT_RESET_SHORTCUT:!0,_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword(),_TRAINER:c.trainer(),_TWELVTH_WARP_POINT:!0,_UNIDENTIFIED_ITEMS:c.unidentifiedItems(),
_ZEBU_STUDENT_GIVES_ITEM:!0};deterministicPreParse$$module$js$pass$deterministic(a.subarray(16));h=new Rom$$module$js$rom(a);h.flags.defrag();"object"==typeof window&&(window.rom=h);h.spoiler=new Spoiler$$module$js$rom$spoiler(h);e&&(e.spoiler=h.spoiler);deterministic$$module$js$pass$deterministic(h,c);module$js$pass$standardmapedits.standardMapEdits(h,module$js$pass$standardmapedits.standardMapEdits.generateOptions(c,k));toggleMaps$$module$js$pass$togglemaps(h,c,k);h.scalingLevels=48;c.shuffleShops()&&
shuffleShops$$module$js$patch(h,c,k);shuffleGoa$$module$js$pass$shufflegoa(h,k);randomizeWalls$$module$js$patch(h,c,k);crumblingPlatforms$$module$js$pass$crumblingplatforms(h,k);c.nerfWildWarp()&&h.wildWarp.locations.fill(0);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(h,c,k);c.randomizeThunderTeleport()&&randomizeThunderWarp$$module$js$pass$randomizethunderwarp(h,k);rescaleMonsters$$module$js$pass$rescalemonsters(h,c,k);unidentifiedItems$$module$js$pass$unidentifieditems(h,c,k);shuffleTrades$$module$js$pass$shuffletrades(h,
c,k);c.randomizeMaps()&&shuffleMazes$$module$js$pass$shufflemazes(h,c,k);c.shuffleMimics()&&shuffleMimics$$module$js$pass$shufflemimics(h,c,k);c.shuffleMonsters()&&shuffleMonsters$$module$js$pass$shufflemonsters(h,c,k);var l=new World$$module$js$logic$world(h,c);if(l=yield(new Graph$$module$js$logic$graph([l.getLocationList()])).shuffle(c,k,void 0,f,h.spoiler))for(var n of l){const [a,b]=n;h.slots[a&255]=b&255}else return[a,-1];c.shuffleShops()&&rescaleShops$$module$js$patch(h,c.bargainHunting()?
k:void 0);c.buffMedicalHerb()&&(h.items.MedicalHerb.value=80,h.items.FruitOfPower.value=56);c.storyMode()&&storyMode$$module$js$patch(h);c.blackoutMode()&&blackoutMode$$module$js$patch(h);misc$$module$js$patch(h,c,k);fixDialog$$module$js$pass$fixdialog(h);c.buffDyna()&&buffDyna$$module$js$patch(h,c);c.trainer()&&(h.wildWarp.locations=[10,26,53,72,109,110,140,170,172,176,182,159,166,88,92,0]);shuffleMusic$$module$js$patch(h,c,k);shufflePalettes$$module$js$pass$shufflepalettes(h,c,k);updateTablesPreCommit$$module$js$patch(h,
c);k.shuffle(h.randomNumbers.values);k=Object.keys(m).filter((a)=>m[a]).map((a)=>`.define ${a} 1\n`).join("");n=new Assembler$$module$js$asm$assembler(module$js$asm$cpu.Cpu.P02);l=new TokenStream$$module$js$asm$tokenstream;l.enter(module$js$asm$token.TokenSource.concat(new Tokenizer$$module$js$asm$tokenizer(k,"flags.s"),yield g("init.s"),yield g("preshuffle.s"),yield g("postparse.s"),yield g("postshuffle.s")));k=new Preprocessor$$module$js$asm$preprocessor(l,n);n.tokens(k);h.modules.push(n.module());
h.messages.compress();yield h.writeData();h=stampVersionSeedAndHash$$module$js$patch(a,b,c);EXPAND_PRG$$module$js$patch&&(n=a.subarray(16),n.subarray(507904,524288).set(n.subarray(245760,262144)));return[a,h]})}
