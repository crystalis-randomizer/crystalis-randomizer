...
!1:"num"===a.token||"str"===a.token?!0:a.str!==b.str?!1:!0};a.eq=b;a.name=c;a.at=d;a.nameAt=e;a.expectEol=function(b,c="end of line"){if(b)throw Error(`Expected ${c}: ${a.nameAt(b)}`);};a.expect=function(a,d,f){if(!d){if(!f)throw Error(`Expected ${c(a)}`);throw Error(`Expected ${c(a)} after ${e(d)}`);}if(!b(a,d))throw Error(`Expected ${c(a)}: ${e(d)}`);};a.expectIdentifier=f;a.expectString=function(a,b){return g("str","constant string",a,b)};a.identsFromCList=function(c){var d;if(!c.length)return[];
const f=[];for(let g=0;g<=c.length;g+=2){const h=c[g];if("ident"!==(null===(d=h)||void 0===d?void 0:d.token)){if(h)throw Error(`Expected identifier: ${e(h)}`);throw Error(`Expected identifier after ${e(c[c.length-1])}`);}if(g+1<c.length&&!b(c[g+1],a.COMMA))throw Error(`Expected comma: ${e(c[g+1])}`);f.push(h.str)}return f};a.findBalanced=function(a,b){const c=a[b++].token;if("lp"!==c&&"lb"!==c)throw Error("non-grouping token");const d="lp"===c?"rp":"rb";let e=1;for(;b<a.length;b++){const f=a[b].token;
e+=Number(f===c)-Number(f===d);if(!e)return b}return-1};a.parseArgList=function(c,e=0,f=c.length){let g=[];const h=[g];let k=0;for(;e<f;e++){const f=c[e];if(!k&&b(f,a.COMMA))h.push(g=[]);else if(g.push(f),b(f,a.LP)&&k++,b(f,a.RP)&&0>--k)throw Error(`Unbalanced paren${d(f)}`);}return h};a.parseAttrList=function(c,g){const h=new Map;let k,l=[];if(g>=c.length)return h;if(!b(c[g],a.COLON))throw Error(`Unexpected: ${e(c[g])}`);for(g+=1;g<c.length;g++){const e=c[g];if(b(e,a.COLON)){if(null==k)throw Error(`Missing key${d(e)}`);
...
return[g[0],k]}function e(a){if(null!=a)return{op:"num",num:a,meta:size$$module$js$asm$expr(a)}}function f(a,b){const c=a.args[0];if(!l(c))return a;a=b(c.num);return{op:"num",num:a,meta:size$$module$js$asm$expr(a)}}function g(a,b){const [c,d]=a.args;if(!l(c)||!l(d))return a;a=b(c.num,d.num);return{op:"num",num:a,meta:size$$module$js$asm$expr(a)}}function h(a){var b,c,d,e,f,g;const [h,k]=a.args;if("num"!==h.op||"num"!==k.op)return a;const l={op:"num",num:h.num+k.num};if(h.meta||k.meta){if((null===
...
void 0===b?0:b.rel)return(null===(c=g.meta)||void 0===c?0:c.rel)&&g.meta.chunk===h.meta.chunk?k:a;if(null===(d=g.meta)||void 0===d?0:d.rel)k.meta=g.meta;null!==(e=k.meta)&&void 0!==e&&e.rel||null!=(null===(f=k.meta)||void 0===f?void 0:f.size)||((k.meta||(k.meta={})).size=size$$module$js$asm$expr(k.num).size);return k}function l(a){var b;return"num"===a.op&&!(null===(b=a.meta)||void 0===b?0:b.rel)}a.traverse=b;a.traversePost=function(a,c){return b(a,(a,b)=>c(b(a)))};a.evaluate=function(a){var b,c,
d,l;switch(a.op){case ".move":case "im":case "sym":return a;case "num":return(null===(b=a.meta)||void 0===b?0:b.rel)&&null!=a.meta.org?(b=Object.assign({},a.meta),b=(delete b.rel,b),{op:"num",num:a.num+b.org,meta:b}):a;case ".max":throw Error();case ".min":throw Error();}if(1===(null===(c=a.args)||void 0===c?void 0:c.length))switch(a.op){case "+":return a.args[0];case "-":return f(a,(a)=>-a);case "~":return f(a,(a)=>~a);case "!":return f(a,(a)=>+!a);case "<":return f(a,(a)=>a&255);case ">":return f(a,
(a)=>a>>8&255);case "^":return l=e(null===(d=a.args[0].meta)||void 0===d?void 0:d.bank),null!==l&&void 0!==l?l:a;default:throw Error(`Unknown unary operator: ${a.op}`);}switch(a.op){case "+":return h(a);case "-":return k(a);case "*":return g(a,(a,b)=>a*b);case "/":return g(a,(a,b)=>Math.floor(a/b));case ".mod":return g(a,(a,b)=>a%b);case "&":return g(a,(a,b)=>a&b);case "|":return g(a,(a,b)=>a|b);case "^":return g(a,(a,b)=>a^b);case "<<":return g(a,(a,b)=>a<<b);case ">>":return g(a,(a,b)=>a>>>b);case "<":return g(a,
...
module$js$asm$token.Token.str(b=a),a.source&&(c.source=a.source);":"===d?(this.anonymousReverse.push(c),d=this.anonymousForward.shift(),null!=d&&(this.symbols[d].expr=c)):/^\++$/.test(d)?(a=this.relativeForward[d.length-1],delete this.relativeForward[d.length-1],null!=a&&(this.symbols[a].expr=c)):/^-+$/.test(d)?this.relativeReverse[d.length-1]=c:(d.startsWith("@")||(this.cheapLocals.clear(),this.chunk.name||this.chunk.data.length||(this.chunk.name=d)),this.assignSymbol(d,!1,c,b))}assign(a,b){a.startsWith("@")&&
this.fail(`Cheap locals may only be labels: ${a}`);"number"!==typeof b&&(b=this.resolve(b));this.assignSymbol(a,!1,b)}set(a,b){a.startsWith("@")&&this.fail(`Cheap locals may only be labels: ${a}`);"number"!==typeof b&&(b=this.resolve(b));this.assignSymbol(a,!0,b)}assignSymbol(a,b,c,d){"number"===typeof c&&(c={op:"num",num:c});const e=a.startsWith("@")?this.cheapLocals:this.currentScope;let f=e.resolve(a,!b);if(f&&b!==0>f.id)this.fail(`Cannot change mutability of ${a}`,d);else if(b&&"num"!=c.op)this.fail("Mutable set requires constant",
d);else if(!f){if(!b)throw Error("impossible");e.symbols.set(a,f={id:-1})}else if(!b&&f.expr)throw b=f.expr.source?`\nOriginally defined${module$js$asm$token.Token.at(f.expr)}`:"",a=d?module$js$asm$token.Token.nameAt(d):a+(this._source?module$js$asm$token.Token.at({source:this._source}):""),Error(`Redefining symbol ${a}${b}`);f.expr=c}instruction(...a){var b;let c;1===a.length&&Array.isArray(a[0])?(a=a[0],c=module$js$asm$token.Token.expectIdentifier(a[0]).toLowerCase(),a=this.parseArg(a)):"string"===
typeof a[1]?(c=a[0],a=new Tokenizer$$module$js$asm$tokenizer(a[1]),a=this.parseArg(a.next(),0)):(([c,a]=a)||(a=["imp"]),c=c.toLowerCase());const d=this.cpu.op(c),e=a[0];if("add"===e||"a,x"===e||"a,y"===e){const f=a[1],g=(null===(b=f.meta)||void 0===b?void 0:b.size)||2;if("add"===e&&1===g&&"zpg"in d)return this.opcode(d.zpg,1,f);if("add"===e&&"abs"in d)return this.opcode(d.abs,2,f);if("add"===e&&"rel"in d)return this.relative(d.rel,1,f);if("a,x"===e&&1===g&&"zpx"in d)return this.opcode(d.zpx,1,f);
if("a,x"===e&&"abx"in d)return this.opcode(d.abx,2,f);if("a,y"===e&&1===g&&"zpy"in d)return this.opcode(d.zpy,1,f);if("a,y"===e&&"aby"in d)return this.opcode(d.aby,2,f);this.fail(`Bad address mode ${e} for ${c}`)}if(e in d)return b=this.cpu.argLen(e),"rel"===e?this.relative(d[e],b,a[1]):this.opcode(d[e],b,a[1]);this.fail(`Bad address mode ${e} for ${c}`)}parseArg(a,b){b=void 0===b?1:b;if(a.length===b)return["imp"];const c=a[b];var d=a[b+1];if(a.length===b+1){if(module$js$asm$token.Token.isRegister(c,
"a"))return["acc"]}else if(module$js$asm$token.Token.eq(c,module$js$asm$token.Token.IMMEDIATE))return["imm",module$js$asm$expr.Expr.parseOnly(a,b+1)];if(module$js$asm$token.Token.eq(c,module$js$asm$token.Token.COLON)&&a.length===b+2&&"op"===d.token&&/^[-+]+$/.test(d.str))return["add",{op:"sym",sym:":"+d.str}];if(a.length===b+1&&"op"===c.token&&/^[-+]+$/.test(c.str))return["add",{op:"sym",sym:c.str}];if(module$js$asm$token.Token.eq(c,module$js$asm$token.Token.LP)||this.opts.allowBrackets&&module$js$asm$token.Token.eq(c,
module$js$asm$token.Token.LB)){d=module$js$asm$token.Token.findBalanced(a,b);0>d&&this.fail(`Unbalanced ${module$js$asm$token.Token.name(c)}`,c);const e=module$js$asm$token.Token.parseArgList(a,b+1,d);e.length||this.fail("Bad argument",c);const f=module$js$asm$expr.Expr.parseOnly(e[0]);if(1===e.length){if(module$js$asm$token.Token.eq(a[d+1],module$js$asm$token.Token.COMMA)&&module$js$asm$token.Token.isRegister(a[d+2],"y"))return module$js$asm$token.Token.expectEol(a[d+3]),["iny",f];module$js$asm$token.Token.expectEol(a[d+
...
this.segments.filter((a)=>{a=this.segmentData.get(a);return!a||null==a.memory||null==a.size||a.memory>this._org||a.memory+a.size<=this._org?!1:!0}):this.segments;1!==c.length?this.fail(`.free with non-unique segment: ${this.segments}`,b):0>a&&this.fail(`.free with negative size: ${a}`,b);this._chunk&&(this._org+=this._chunk.data.length);this._chunk=void 0;b=c[0];(c=this.segmentData.get(b))||this.segmentData.set(b,c={name:b});(c.free||(c.free=[])).push([this._org,this._org+a]);this._org+=a}segmentPrefix(a){this._segmentPrefix=
a}import(...a){for(const b of a)this.globals.set(b,"import")}export(...a){for(const b of a)this.globals.set(b,"export")}scope(a){this.enterScope(a,"scope")}proc(a){this.label(a);this.enterScope(a,"proc")}enterScope(a,b){const c=a?this.currentScope.children.get(a):void 0;if(c){if(this.opts.reentrantScopes){this.currentScope=c;return}this.fail(`Cannot re-enter scope ${a}`)}b=new Scope$$module$js$asm$assembler(this.currentScope,b);a?this.currentScope.children.set(a,b):this.currentScope.anonymousChildren.push(b);
this.currentScope=b}endScope(){this.exitScope("scope")}endProc(){this.exitScope("proc")}exitScope(a){this.currentScope.kind===a&&this.currentScope.parent||this.fail(`.end${a} without .${a}`);this.currentScope=this.currentScope.parent}pushSeg(...a){this.segmentStack.push([this.segments,this._chunk]);this.segment(...a)}popSeg(){this.segmentStack.length||this.fail(".popseg without .pushseg");[this.segments,this._chunk]=this.segmentStack.pop()}move(a,b){this.append({op:".move",args:[b],meta:{size:a}},
a)}parseConst(a,b){b=this.evaluate(module$js$asm$expr.Expr.parseOnly(a,void 0===b?1:b));if(null!=b)return b;this.fail("Expression is not constant",a[1])}parseNoArgs(a,b){module$js$asm$token.Token.expectEol(a[1])}parseExpr(a,b){return module$js$asm$expr.Expr.parseOnly(a,void 0===b?1:b)}parseStr(a,b){b=void 0===b?1:b;const c=module$js$asm$token.Token.expectString(a[b]);module$js$asm$token.Token.expectEol(a[b+1],"a single string");return c}parseSegmentList(a,b){b=void 0===b?1:b;a.length<b+1&&this.fail("Expected a segment list",
a[b-1]);return module$js$asm$token.Token.parseArgList(a,1).map((a)=>{var b=this._segmentPrefix+module$js$asm$token.Token.expectString(a[0]);if(1===a.length)return b;module$js$asm$token.Token.eq(a[1],module$js$asm$token.Token.COLON)||this.fail(`Expected comma or colon: ${module$js$asm$token.Token.name(a[1])}`,a[1]);b={name:b};a=module$js$asm$token.Token.parseAttrList(a,1);for(const c of a){const [a,d]=c;switch(a){case "bank":b.bank=this.parseConst(d,0);break;case "size":b.size=this.parseConst(d,0);
break;case "off":b.offset=this.parseConst(d,0);break;case "mem":b.memory=this.parseConst(d,0);break;default:this.fail(`Unknown segment attr: ${a}`)}}return b})}parseResArgs(a){a=this.parseDataList(a);2<a.length&&this.fail("Expected at most 2 args",a[2]);a.length||this.fail("Expected at least 1 arg");const b=this.evaluate(a[0]);null==b&&this.fail("Expected constant count");const c=a[1]&&this.evaluate(a[1]);a[1]&&null==c&&this.fail("Expected constant value");return[b,c]}parseDataList(a,b){b=void 0===
b?!1:b;2>a.length&&this.fail("Expected a data list",a[0]);const c=[];for(const d of module$js$asm$token.Token.parseArgList(a,1))b&&1===d.length&&"str"===d[0].token?c.push(d[0].str):c.push(this.resolve(module$js$asm$expr.Expr.parseOnly(d)));return c}parseIdentifierList(a){2>a.length&&this.fail("Expected identifier(s)",a[0]);const b=[];for(const c of module$js$asm$token.Token.parseArgList(a,1))1===c.length&&"ident"===c[0].token||this.fail(`Expected identifier: ${module$js$asm$token.Token.name(c[0])}`,
c[0]),b.push(module$js$asm$token.Token.str(c[0]));return b}parseOptionalIdentifier(a){var b=a[1];if(b)return b=module$js$asm$token.Token.expectIdentifier(b),module$js$asm$token.Token.expectEol(a[2]),b}parseRequiredIdentifier(a){const b=module$js$asm$token.Token.expectIdentifier(a[1]);module$js$asm$token.Token.expectEol(a[2]);return b}parseMoveArgs(a){var b;a=module$js$asm$token.Token.parseArgList(a,1);2!==a.length&&this.fail("Expected constant number, then identifier");const c=this.evaluate(module$js$asm$expr.Expr.parseOnly(a[0]));
null==c&&this.fail("Expected a constant number");const d=this.resolve(module$js$asm$expr.Expr.parseOnly(a[1]));if("num"===d.op&&null!=(null===(b=d.meta)||void 0===b?void 0:b.chunk))return[c,d];this.fail("Expected a constant offset",a[1][0])}fail(a,b){if(null===b||void 0===b?0:b.source)throw Error(a+module$js$asm$token.Token.at(b));throw Error(a+module$js$asm$token.Token.at({source:this._source}));}writeNumber(a,b,c){var d=b<<3;null!=c&&(c<-1<<d||c>=1<<d)&&this.fail(`Not a ${["byte","word","farword",
"dword"][b-1]}: $${c.toString(16)}`);for(d=0;d<b;d++)a.push(null!=c?c&255:255),null!=c&&(c>>=8)}}function writeString$$module$js$asm$assembler(a,b){for(let c=0;c<b.length;c++)a.push(b.charCodeAt(c))}var module$js$asm$assembler={};module$js$asm$assembler.Assembler=Assembler$$module$js$asm$assembler;const DEBUG$$module$js$asm$define=!1;
...
b;a=this._offset=a+b.delta;for(var d of this.linker.watches)if(d>=a&&d<a+this.size)debugger;binaryInsert$$module$js$asm$util(this.linker.placed,(a)=>a[0],[a,this]);d=this.linker.data;b=(c=this._data,null!==c&&void 0!==c?c:fail$$module$js$asm$linker("No data"));this._data=void 0;if(this.subs.size){d.splice(a,b.length);c=new SparseByteArray$$module$js$asm$util;c.set(0,b);for(const a of this.subs)c.splice(a.offset,a.size);for(const b of c.chunks()){const [c,e]=b;d.set(a+c,...e)}}else d.set(a,b);for(const a of this.follow){const [b,
...
new Set;for(var h of d)(c.has(h)?e:g).add(h);for(var k of c)d.has(k)||f.add(k);this.common=e.size;this.slots=new ArrayMap$$module$js$util([...e,...f]);this.items=new ArrayMap$$module$js$util([...e,...g]);c=[];d=[];for(h=0;h<a.length;h++){const b=h<<24;for(var l of a[h].requirements){const [a,f]=l;k=this.slots.index(b|a);if(null==k)throw Error(`Provided a non-slot? ${hex$$module$js$rom$util(a)}`);for(var m of f){e=[...m].map((a)=>{var c;return c=this.items.index(b|a),null!==c&&void 0!==c?c:die$$module$js$assert()});
(c[k]||(c[k]=[])).push(Bits$$module$js$bits.from(e));for(const a of e)(d[a]||(d[a]=new Set)).add(k)}}}for(a=0;a<this.slots.length;a++)c[a]&&c[a].length||(l=(b=this.slots.get(a),null!==b&&void 0!==b?b:NaN),m=this.checkName(l),console.error(`Nothing provided $${hex$$module$js$rom$util(l)}: ${m} (index ${a})`));this.graph=new Keyed$$module$js$util(c);this.unlocks=new Keyed$$module$js$util(d.map(spread$$module$js$util))}shuffle(a,b,c,d,e){c=void 0===c?20:c;const f=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){d&&
d.addTasks(Math.floor(c/100));for(var g=0;g<c;g++){d&&99===g%100&&(d.addCompleted(1),yield new Promise(requestAnimationFrame));var h=new MutableArrayBiMap$$module$js$util;f.prefill(h,b);const m=f.compressFill(h);var k=f.itemPool(m.values(),b),l=Bits$$module$js$bits.from(new Set(k));if(f.fillInternal(m,k,l,b,a,Math.floor(g/5))){l=e?[]:void 0;k=f.traverse((a)=>m.get(a),Bits$$module$js$bits.of(),l);if(e&&l)for(const a of l){const [b,...c]=a;(b<f.common||m.has(b))&&e.addCheck(f.slots.get(b),c.map((a)=>
f.items.get(a)))}if(k.size!==f.slots.length){h=new Set([...f.slots].map((a)=>a[0]));for(const a of k)h.delete(a);console.error(`Initial fill never filled slots:
  ${[...h].map((a)=>f.checkName(f.slots.get(a))).sort().join("\n  ")}`,k,f)}else if(f.expandFill(m,h),k=f.fillNonProgression(h,a,b),null!=k){d&&d.addCompleted(Math.floor((c-g)/100));if(e)for(const a of h){const [b,c]=a;g=f.checkName(b).replace(/^[0-9a-f]{3} /,"");e.addSlot(b,g,c)}return k}}}return null})}fillInternal(a,b,c,d,e,f){var g;const h=new Set(a.keys());for(var k=b.pop();null!=k;k=b.pop()){if(!Bits$$module$js$bits.has(c,k))continue;const m=this.itemInfoFromIndex(k);c=Bits$$module$js$bits.without(c,
k);var l=this.expandReachable(this.traverse((b)=>a.get(b),c),e);d.shuffle(l);let n=!1;const p=new Set(a.keys());for(const b of l){if(p.has(b))continue;p.add(b);const c=this.slotInfoFromIndex(b);if(c&&this.fits(c,m,e)){a.set(b,k);n=!0;break}}if(!n){p.clear();if(0<f--){for(const f of l)if(!p.has(f)&&a.has(f)&&!h.has(f)&&(p.add(f),(l=this.slotInfoFromIndex(f))&&this.fits(l,m,e))){k=(g=a.replace(f,k),null!==g&&void 0!==g?g:die$$module$js$assert());c=Bits$$module$js$bits.with(c,k);b.push(k);d.shuffle(b);
...
class MeetTerrain$$module$js$logic$terrain{constructor(a,b){this.left=a;this.right=b;const c=directionIndex$$module$js$logic$terrain(a),d=directionIndex$$module$js$logic$terrain(b),e=new Set,f=[];for(let a=0;4>a;a++)e.add(c[a]<<2|d[a]);for(const c of e){const [d,e]=a.exit[c>>2],[g,m]=b.exit[c&3];f.push([d&g,module$js$logic$requirement.Requirement.meet(e,m)])}this.enter=module$js$logic$requirement.Requirement.meet(a.enter,b.enter);this.exit=f}get kind(){return"Terrain"}label(a){if(1===this.exit.length)return SimpleTerrain$$module$js$logic$terrain.prototype.label.call(this,
...
0]<<6|k&127,f<<2)}}metasprite(a,b,c,d,e=0,f=0){d=this.rom.locations[d];var g=this.rom.metasprites[c];c=[64,66,...d.spritePatterns];d=[0,1,...d.spritePalettes];let h=!1;null!=g.mirrored&&(g=this.rom.metasprites[g.mirrored],h=!0);if(g&&g.used){f&=g.frameMask;for(let [k,l,m,n]of g.sprites[f]){if(128==k)break;k=signed$$module$js$spoiler$canvas(k);l=signed$$module$js$spoiler$canvas(l);n=n+e&255;f=d[m&3]+176&255;g=c[n>>6]<<6|n&63;h&&(k=-8-k,m^=64);this.tile(a+l,b+k,g,f<<2|m>>6)}}}text(a,b,c,d=18){for(let e=
...
"fe","ff");k.reloc("ShopData");l("ShopData");l("ArmorShopIdTable");for(const b of this.armorShops())for(var m=0;4>m;m++)k.byte((a=b.contents[m],null!==a&&void 0!==a?a:255));l("ToolShopIdTable");for(const a of this.toolShops())for(m=0;4>m;m++)k.byte((b=a.contents[m],null!==b&&void 0!==b?b:255));l("ArmorShopPriceTable");for(const a of this.armorShops())for(m=0;4>m;m++)k.byte(Math.round(32*(c=a.prices[m],null!==c&&void 0!==c?c:0)));l("ToolShopPriceTable");for(const a of this.toolShops())for(c=0;4>c;c++)k.byte(Math.round(32*
(d=a.prices[c],null!==d&&void 0!==d?d:0)));l("InnPrices");for(const a of this.inns())k.byte(Math.round(32*(e=a.prices[0],null!==e&&void 0!==e?e:0)));l("ShopLocations");for(const a of this)k.byte(a.location);l("ToolShopScaling");k.byte(...this.toolShopScaling);l("ArmorShopScaling");k.byte(...this.armorShopScaling);l("BasePrices");k.word(...this.basePrices.slice(13,39).map((a)=>null!==a&&void 0!==a?a:0));l("InnBasePrice");k.word(this.innBasePrice)}else{k.segment("10","fe","ff");k.org(40356,"ShopData");
for(const a of this.armorShops())for(d=0;4>d;d++)k.byte((f=a.contents[d],null!==f&&void 0!==f?f:255));for(const a of this.armorShops())for(d=0;4>d;d++)k.word((g=a.prices[d],null!==g&&void 0!==g?g:0));for(const a of this.toolShops())for(d=0;4>d;d++)k.byte((h=a.contents[d],null!==h&&void 0!==h?h:255));for(m of this.toolShops())for(d=0;4>d;d++)k.word((l=m.prices[d],null!==l&&void 0!==l?l:0))}return[k.module()]}}var ShopType$$module$js$rom$shop;
...
for(var Q of this.rom.shops)if(Q.location!==a.id&&Q.location!==d.id&&Q.used&&Q.type===module$js$rom$shop.ShopType.TOOL){U=[module$js$logic$tileid.TileId(Q.location<<16|136)];for(var oa of Q.contents)oa===u.id?this.addCheck(U,X.r,[A.id]):oa===rb.id&&this.addCheck(U,X.r,[D.id])}Q=ea.r;oa=la.r;U=na.r;let Pa=ma.r;if(!this.flagset.orbsOptional()){var Ea=or$$module$js$logic$world(k,Ca);const a=or$$module$js$logic$world(f,Na),b=or$$module$js$logic$world(h,m),c=or$$module$js$logic$world(g,xa);Q=module$js$logic$requirement.Requirement.meet(Q,
...
this.neighbors.get(b)|1<<c));this.seamlessExits.has(a)||(a=c^2,d=module$js$logic$tilepair.TilePair.of(d,e),this.neighbors.set(d,this.neighbors.get(d)|1<<a))}processLocationTiles(a){var b,c,d,e=new Map;const f=new Set,g=88===(a.id&248);for(var h of a.spawns)h.isWall()?e.set(module$js$logic$screenid.ScreenId.from(a,h),h.id&3):h.isMonster()&&63===h.id&&f.add(module$js$logic$screenid.ScreenId.from(a,h));const k=a.screenPage;h=this.rom.tileset(a.tileset);const l=this.rom.tileEffects[a.tileEffects-179],
m=(b)=>l.effects[this.rom.screens[a.screens[(b&61440)>>>12][(b&3840)>>>8]|k].tiles[b&255]],n=(b,c,d)=>{b&=module$js$logic$terrain.Terrain.BITS;26===a.id&&(b|=module$js$logic$terrain.Terrain.SWAMP);if(96===a.id||104===a.id)b|=module$js$logic$terrain.Terrain.DOLPHIN;100===a.id&&4144>(c&61680)&&(b|=module$js$logic$terrain.Terrain.DOLPHIN);d&&(b|=module$js$logic$terrain.Terrain.BARRIER);if(!(b&module$js$logic$terrain.Terrain.DOLPHIN)&&b&module$js$logic$terrain.Terrain.SLOPE){for(d=0;m(c)&module$js$logic$terrain.Terrain.SLOPE;)c=
module$js$logic$tileid.TileId.add(c,1,0),d++;6>d?b&=~module$js$logic$terrain.Terrain.SLOPE:9>d?b|=module$js$logic$terrain.Terrain.SLOPE8:10>d&&(b|=module$js$logic$terrain.Terrain.SLOPE9)}return this.terrainFactory.tile(b)};for(let m=0,w=a.height;m<w;m++){const w=a.screens[m],z=a.id<<8|m<<4;for(let m=0,A=a.width;m<A;m++){const A=this.rom.screens[w[m]|k],t=module$js$logic$screenid.ScreenId(z|m),G=f.has(t),Na=t&255;var p=e.get(t);p=g?this.rom.flags.AlwaysTrue.id:null!=p?this.wallCapability(p):null===
(b=a.flags.find((a)=>a.yx===Na))||void 0===b?void 0:b.flag;const D=(d=null===(c=this.rom.flags[p])||void 0===c?void 0:c.logic,null!==d&&void 0!==d?d:{});for(let b=0;240>b;b++){const c=module$js$logic$tileid.TileId(t<<8|b);var q=A.tiles[b];D.assumeTrue&&32>q&&(q=h.alternates[q]);var v=a.isShop()?0:l.effects[q]&38;v=n(v,c,G);32>q&&h.alternates[q]!==q&&null!=p&&!D.assumeTrue&&!D.assumeFalse&&(q=n(l.effects[h.alternates[q]],c,G))&&(v=this.terrainFactory.flag(v,D.track?p:-1,q));v&&this.terrains.set(c,
...
const l=k.spawnConditions.get(a.id)||[];var m=this.filterRequirements(l),n=module$js$logic$tileid.TileId.from(a,b);n=[this.terrains.has(n)?n:(c=this.walkableNeighbor(n),null!==c&&void 0!==c?c:n)];for(const [a,c]of this.itemUses.get(b.type<<8|b.id))this.processItemUse(n,m,a,c);k===this.rom.npcs.SaberaDisguisedAsMesia&&this.addBossCheck(n,this.rom.bosses.Sabera1,m);k.data[2]&4&&!this.flagset.assumeStatueGlitch()&&(b=this.filterAntiRequirements(l),k===this.rom.npcs.Rage?(n=module$js$logic$hitbox.Hitbox.adjust(n,
[2,-1],[2,0],[2,1],[2,2]),n=module$js$logic$hitbox.Hitbox.adjust(n,[0,-6],[0,-2],[0,2],[0,6]),this.flagset.assumeRageSkip()&&(b=void 0)):k===this.rom.npcs.PortoaThroneRoomBackDoorGuard&&(b=or$$module$js$logic$world(this.rom.flags.MesiaRecording,this.rom.flags.Paralysis)),b&&this.addTerrain(n,this.terrainFactory.statue(b)));k===this.rom.npcs.FortuneTeller&&(n=module$js$logic$hitbox.Hitbox.adjust(n,[0,0],[2,0]));if(!module$js$logic$requirement.Requirement.isClosed(m)){[[...m]]=m;for(const a of k.globalDialogs)b=
this.flag(~a.condition),null!==(d=b)&&void 0!==d&&d.logic.track&&m.push(b.id);a=(f=(e=k.localDialogs.get(a.id),null!==e&&void 0!==e?e:k.localDialogs.get(-1)),null!==f&&void 0!==f?f:[]);for(const b of a)e=[...m],f=this.flag(b.condition),(null===(g=f)||void 0===g?0:g.logic.track)&&e.push(f.id),this.processDialog(n,k,e,b),e=this.flag(~b.condition),(null===(h=e)||void 0===h?0:h.logic.track)&&m.push(e.id)}}processDialog(a,b,c,d){this.addCheckFromFlags(a,[c],d.flags);const e={lossy:!0,unique:!0};switch(d.message.action){case 8:this.processKeyUse(a,
...
44544,49152);for(const b of this)b.assemble(a);return[a.module()]}}
...
[a,0])),e=[],f=[],g=[],h=[],k=[],l=this.hasDolphin()?37:39;for(const a of d){const [k,m]=a;{const a=this.screens[k>>>12][k>>>8&15];if(a!==b){for(const a of neighbors$$module$js$rom$location(k,this.width,this.height))d.has(a)||d.set(a,m+1);m||c.get(k)&l||e.push(k);26===this.id?240===this.rom.screens[a].tiles[k&255]&&h.push(k):2<=m&&4>=m&&h.push(k);3<=m&&7>=m&&f.push(k);12<=m&&g.push(k)}}}return(b)=>{var c=b.placement();c=[..."normal"===c?e:"moth"===c?f:"bird"===c?g:"plant"===c?h:assertNever$$module$js$util(c)];
...
0;b<e.length;b++){let f=e[b];null!=f&&(0>f&&(f=~f,this.flags.push(Flag$$module$js$rom$location.of({screen:a+d<<4|c+b,flag:this.rom.flags.AlwaysTrue.id}))),this.screens[a+d][c+b]=f)}}}connect(a,b,c){var d=0>a?256:0,e=0>c?256:0;a=0>a?~a:a;c=0>c?~c:c;const f=a>>>4,g=a&15,h=c>>>4,k=c&15,[l,m]=screenExits$$module$js$rom$location[d|this.screens[f][g]],[n,p]=screenExits$$module$js$rom$location[e|b.screens[h][k]];d=this.entrances.length;e=b.entrances.length;this.entrances.push(Entrance$$module$js$rom$location.of({y:f<<
8|l>>>8,x:g<<8|l&255}));b.entrances.push(Entrance$$module$js$rom$location.of({y:h<<8|n>>>8,x:k<<8|n&255}));for(const c of m)this.exits.push(Exit$$module$js$rom$location.of({screen:a,tile:c,dest:b.id,entrance:e}));for(const a of p)b.exits.push(Exit$$module$js$rom$location.of({screen:c,tile:a,dest:this.id,entrance:d}))}neighborForEntrance(a){const b=this.entrances[a];if(!b)throw Error(`no entrance ${hex$$module$js$rom$util(this.id)}:${a}`);for(const a of this.exits){if(a.screen!==b.screen)continue;
...
b+d]&&(a[c]|=128>>>d,a.push(this.data[8*b+d]))}return a}write(){const a=this.rom.assembler();a.segment("0d");a.reloc(`Object_${this.id.toString(16).padStart(2,"0")}`);const b=a.pc();a.byte(...this.serialize());a.org(44032+(this.id<<1));a.word(b);return[a.module()]}get(a){return this.data[a-768>>>5]}parents(){return[]}locations(){return this.rom.locations.filter((a)=>a.used&&a.spawns.some((a)=>a.isMonster()&&a.monsterId===this.id))}palettes(a=!1){if(34===this.action)return[3];let b=this.data[0];42===
...
(l=b);a=m&l;n=[];k=Infinity;p=c?module$js$util.iters.map(c,(a)=>[a,this.screens.get(a)]):this.screens;for(const c of p){const [f,w]=c;if(!w)throw Error("Bad Scr in 'allowed'!");if(!(w.fixed||d&&w.edges&-65536||null!=h&&!w.stairs.some((a)=>a.dir===h)||null==h&&w.stairs.length||(f&l)!==a||e&&module$js$maze$types.Scr.numExits(f)>e))if(g){p=0;q=f&b^m;for(const a of module$js$maze$types.Dir.ALL)q&15<<module$js$maze$types.Dir.shift(a)&&p++;p<k?(k=p,n=[f]):p===k&&n.push(f)}else yield f}g&&(yield*n)}fill(a,
...
b,{force:!0})};const l=new Maze$$module$js$maze$maze(b,f,e,GOA1_SCREENS$$module$js$maze$spec),n=f-1<<4|b.nextInt(e),p=b.nextInt(e),q=n<<8|2,v=[p+32<<8|1,p+32<<8|3];k(n,61681);k(n-1,240);k(n+1,61440);k(p,65520);k(p-1,4080);k(p+1,65280);k(p+16,61951);k(p+15,255);k(p+17,61455);if(!l.connect(n,module$js$maze$types.Dir.UP,p+16,module$js$maze$types.Dir.DOWN))continue a;if(257===l.get(p+32)||257===l.get(n-16))continue a;for(k=0;10>k&&.65>l.density();k++)l.addLoop()&&(k=0);if(.45>l.density())continue a;if(!h())continue a;
...
e=module$js$maze$types.Pos.plus(a,c);!d.isFixed(a)&&!d.isFixed(e)&&d.get(a)&module$js$maze$types.Dir.edgeMask(c)?d.saveExcursion(()=>d.replaceEdge(a,c,0)?!!(d.get(a)&&d.get(e)&&f()):!1):p++}if(!d.consolidate(e,f,a))return!1;const [q,v]=b.pick([...d.alternates()]);if(65536!=v)throw Error(`unexpected alt: ${hex$$module$js$rom$util(v)}`);d.replace(q,d.get(q)|v);c.moveScreen(48,l);c.moveScreen(4,k);d.write(c,new Set);e=[];n=[];for(const [a,b]of d)a!==k&&a!==q&&(1!==b&&16!==b&&256!==b&&4096!==b||e.push(a),
...
function fogLampNotRequired$$module$js$pass$deterministic(a,b){const {flags:{AlwaysTrue:c,InjuredDolphin:d,FogLamp:e,KensuInCabin:f,ReturnedFogLamp:g},items:{ShellFlute:h},locations:{BoatHouse:k,Portoa_FishermanHouse:l},npcs:m}=a;b=b.requireHealedDolphinToRide();h.itemUseData[0].want=b?d.id:c.id;m.KensuInCabin.data[0]=103;m.KensuInCabin.localDialogs.get(-1)[0].message.action=10;m.KensuInCabin.localDialogs.get(-1)[0].flags=[];m.KensuInCabin.spawnConditions.set(k.id,[g.id,~f.id]);m.Fisherman.spawnConditions.set(l.id,
...
c(ua.spawns(D),~u.BehindWhirlpool.id);c(ea.spawns(D),~u.BehindWhirlpool.id);ka.dialog()[0].message.action=3;ka.dialog()[1].message.action=3;ka.dialog()[2].message.action=3;ka.dialog()[3].message.action=3;(()=>{const [a,b,c,d]=aa.dialog();d.condition=~u.RescuedChild.id;b.condition=-1;aa.dialog().splice(0,4,d,c,a,b)})();for(const b of[32,33,34,124,125])d(a.npcs[b].dialog());N.dialog().unshift(...N.dialog().splice(1,1));la.spawnConditions.set(m.id,[~u.QueenNotInThroneRoom.id,~u.MesiaRecording.id]);xa.dialog()[1].condition=
u.MesiaRecording.id;Y.dialog()[3].condition=u.SwordOfWater.id;Y.dialog()[3].message.action=3;Y.dialog()[4].flags.push(u.PortoaQueenGoingAway.id);Y.spawns(m)[1]=~u.MesiaRecording.id;Y.spawns(n)[0]=u.MesiaRecording.id;Y.dialog()[1].condition=u.MesiaRecording.id;kb.spawns(p)[1]=~u.MesiaRecording.id;Xa.spawnConditions.set(r.id,[~u.Clark.id]);Xa.spawnConditions.set(h.id,[u.Clark.id]);Da.localDialogs.set(t.id,[LocalDialog$$module$js$rom$npc.of(~u.TalkedToZebuInCave.id,[0,26],[u.TalkedToZebuInCave.id]),
LocalDialog$$module$js$rom$npc.of(u.LeafVillagersRescued.id,[0,29]),LocalDialog$$module$js$rom$npc.of(u.LeafAbduction.id,[0,28]),LocalDialog$$module$js$rom$npc.of(u.ZebuAtWindmill.id,[0,29]),LocalDialog$$module$js$rom$npc.of(u.UsedWindmillKey.id,[0,27,3]),LocalDialog$$module$js$rom$npc.of(-1,[0,29])]);c(Da.spawns(t),~u.BehindWhirlpool.id);Ca.spawnConditions.delete(l.id);na.spawnConditions.delete(v.id);wa.data[1]=a.items.FluteOfLime.id;wa.dialog(n)[0].message.action=17;wa.dialog(n)[2].message.action=
...
module$js$rom$item.Item=Item$$module$js$rom$item;module$js$rom$item.ItemUse=ItemUse$$module$js$rom$item;module$js$rom$item.Items=Items$$module$js$rom$item;function shuffleTrades$$module$js$pass$shuffletrades(a,b,c){if(b.randomizeTrades()){var {StatueOfOnyx:d,FogLamp:e,LovePendant:f,KirisaPlant:g,IvoryStatue:h}=a.items,k=new Map,l=[[d,0,"Akahana"],[e,0,"Fisherman"],[f,0,"Kensu"],[g,0,"Aryllis"],[h,0,"Slimed Kensu"]],m=l.map(([a,b,c])=>{if(0>a.trades.indexOf(b)||b>=a.itemUseData.length)throw Error(`not a trade: ${a} ${b}`);return[a.itemUseData[b],a.id,c]});c.shuffle(m);for(const [c,d]of l){const [e,f,g]=m.pop();c.itemUseData[d]=e;a.spoiler&&a.spoiler.addTrade(c.id,
...
e("12:09",/[^]*/,r);e("12:0a",/[^]*/,r);r=b(a.npcs.KensuInSwan);e("13:02","[3b:Love Pendant]",d(r));e("13:00","pendant",commonNoun$$module$js$pass$fixdialog(r));k.item.isMagic()||c("13:02");e("13:02","[47:Change]",d(k));r=b(a.npcs.SlimedKensu);e("18:06","[3d:Ivory Statue]",d(r));e("18:07","[3d:Ivory Statue]",d(r));e("18:06","It's in a room","{0b:Karmine} is");v.item.isMagic()||e("18:07","teach","give");e("18:07","[48:Flight]",d(v));l.item.isMagic()||c("1c:10");e("1c:10","[42:Paralysis]",d(l));e("20:06",
...
8;e=new Set([87,94,104,125,136,151,155,158]);d=new Set([80,83,95,105]);for(const [h,{sdef:k,swrd:l,hits:m,satk:n,dgld:p,sexp:q}]of SCALED_MONSTERS$$module$js$pass$rescalemonsters)f=a.objects[h].data,g=e.has(h)?1:0,f[2]|=128,f[6]=m,f[7]=n,f[8]=k|l<<4,f[16]=f[16]&15|p<<4,f[17]=q,(g?b.shuffleBossElements():b.shuffleMonsterElements())&&!d.has(h)&&(f=[...a.objects[h].elements.toString(2).padStart(4,"0")],c.shuffle(f),a.objects[h].elements=Number.parseInt(f.join(""),2));if(b.shuffleMonsterElements()){b=
...
!0));g.push(`Initial pass: ${n.fixed.map((a)=>Infinity>a.size?"["+[...a].join(", ")+"]":"all")}`);const p=new Map;c=(a)=>{var c=e.rom.objects[a.id];if(c.monsterClass){var d=p.get(c.monsterClass);if(null!=d&&d!==a.id)return!1}d=FLYERS$$module$js$pass$shufflemonsters.has(a.id);var h=MOTHS_AND_BATS$$module$js$pass$shufflemonsters.has(a.id);if(d){if(!m)return!1;--m}const l=b.getMonsterConstraint(e.id,a.id);let v=n.tryMeet(l);!v&&Infinity>n.pal2.size&&Infinity>n.pal3.size&&this.flags.shuffleSpritePalettes()&&
(v=n.tryMeet(l,!0));if(!v)return!1;if(q){var t=e.rom.objects[a.id];if(!(t instanceof Monster$$module$js$rom$monster))throw Error(`non-monster: ${t}`);t=q(t);if(null==t)return!1}g.push(`  Adding ${a.id.toString(16)}: ${v}`);n=v;c.monsterClass&&p.set(c.monsterClass,a.id);c=0;if(d||h)for(d=0;d<f.length;d++){if(f[d]in k){c=d;break}}else for(d=0;d<f.length;d++)if(!(f[d]in k)){c=d;break}(this.report[`mon-${a.id.toString(16)}`]=this.report[`mon-${a.id.toString(16)}`]||[]).push("$"+e.id.toString(16));d=f[c];
h=e.spawns[d-13];q?(h.screen=t>>>8,h.tile=t&255):d in k&&(h.y+=16*k[d][0],h.x+=16*k[d][1]);h.monsterId=a.id;g.push(`    slot ${d.toString(16)}: ${h}`);f.splice(c,1);return!0};const q=f.length&&this.flags.randomizeMaps()?e.monsterPlacer(a):null;if(m&&f.length)for(var d=0;d<Math.min(40,this.monsters.length);d++)FLYERS$$module$js$pass$shufflemonsters.has(this.monsters[d].id)&&c(this.monsters[d])&&this.monsters.splice(d,1);for(d=0;d<this.monsters.length&&f.length;d++)if(c(this.monsters[d])){const [a]=
...
a=[new Set,new Set];for(d=0;2>d;d++)a[d]=new Set([...b[d].get(c.tilePatterns[0]),...b[d].get(c.tilePatterns[1])]);c=this.random.pick([...a[0]]);a=this.random.pick([...a[1]]);for(const b of e)b.tilePalettes[0]=c,b.tilePalettes[1]=a}}shuffleBackgrounds2(){var a=[new Set,new Set];for(var b of this.rom.locations)if(b.used){var c=paletteTypes$$module$js$rom$tileset(this.rom.tilesets[(b.tileset&127)>>2].id,b.id);for(var d=0;3>d;d++)for(var e=0;e<c[e];e++)a[e].add(b.tilePalettes[e])}b=[];const f=a.map((a)=>
[...a]);for(const g of b){const h=g[1],k=paletteTypes$$module$js$rom$tileset(h.tileset,h.id);for(a=0;1E3>a;a++){b=seq$$module$js$rom$util(3,(a)=>k[a]?this.random.pick(f[k[a]-1]):h.tilePalettes[a]);c=b.map((a)=>this.rom.palettes[a].colors);d=!0;for(const a of g[0])if([,,,e]=paletteTypes$$module$js$rom$tileset(a.tileset,a.id),e&&!e(c[0],c[1],c[2])){d=!1;break}if(d)for(const a of g[0])a.tilePalettes=[b[0],b[1],b[2]]}}}}var module$js$pass$shufflepalettes={};
...
if(PUNCTUATION$$module$js$rom$messages[h]||k||c===d){var l=f[c+1];k&&(c=Math.max(c,f.indexOf(k,c)));if(g.length){k=" "!==h&&"'"!==h||!l||PUNCTUATION$$module$js$rom$messages[l]?"":h;l=g.join("");var m=b.length;h=l.length+(" "===h?1:0);g=[];b.push({str:l,id:m,chain:k,bytes:h,used:0,suffixes:new Set,mid:a})}}else g.push(h)}}}c=new Map;for(e=b.length-1;0<=e;e--)for(a=b[e],f=a.bytes-2;0<=f;f--)for(g=a.str.substring(f),h=0,k=a,l=a.bytes-f-1;;){(m=c.get(g))||c.set(g,m={chains:h,missing:f,saving:-g.length,
str:g,words:new Set});m.words.add(e);m.saving+=l;for(let a=h;0<=a;a--)b[e+a].suffixes.add(m);if(!k.chain)break;g+=k.chain;k=b[e+ ++h];g+=k.str;l+=k.bytes}e=new Set;a=[];f=({saving:a},{saving:b})=>b-a;g=[...c.values()].sort(f);for(h=0;g.length&&h<MAX_TABLE_LENGTH$$module$js$rom$messages;){e.has(g[0].str)&&(g.sort(f),e.clear());const {str:n,saving:p,missing:q,words:v,chains:z}=g.shift();if(0>=p)break;h+=n.length+3;k=a.length;l=new Set;for(const a of v){m=b[a];for(const a of[m.mid,...d.get(m.mid)||[]])l.add(a)}a.push({bytes:128>
k?[k+128]:[5,k-128],mids:l,str:n});for(const a of v)for(k=0;k<=z;k++){l=b[a+k];m=l.bytes-(k?0:q);for(const a of l.suffixes)a.saving-=m-l.used,e.add(a.str);l.used=m}if(128===a.length){for(const a of c.values())a.saving-=a.words.size;g.sort(f);e.clear()}}return a}compress(){var a=this.uses(),b=this.buildAbbreviationTable(a);const c=new Map;this.commonWords.splice(0,this.commonWords.length);this.uncommonWords.splice(0,this.uncommonWords.length);for(var d of b){1===d.bytes.length?this.commonWords[d.bytes[0]&
...
{};for(const b of this.locations){if(!b.used||!b.hasSpawns)continue;const c=a["$"+hex$$module$js$rom$util(b.id)]={};for(const a of b.spawns)if(!(a.data[2]&7)){const b=a.data[2]&128?1:0,d=a.data[3]+80;c[`${b}:${d.toString(16)}`]=(c[`${b}:${d.toString(16)}`]||0)+1}}return a}assembler(){return new Assembler$$module$js$asm$assembler}writeData(a){a=void 0===a?this.prg:a;var b,c=this.assembler();free$$module$js$rom$util(c,$0e$$module$js$rom,34682,35165);free$$module$js$rom$util(c,$0e$$module$js$rom,35557,
39156);free$$module$js$rom$util(c,$0e$$module$js$rom,40422,40960);free$$module$js$rom$util(c,$0f$$module$js$rom,40960,41222);free$$module$js$rom$util(c,$0f$$module$js$rom,41472,41920);free$$module$js$rom$util(c,$10$$module$js$rom,37146,37992);const d=[...this.modules,c.module()];c=(a)=>{for(const b of a)d.push(...b.write())};d.push(...this.locations.write());c(this.objects);c(this.hitboxes);c(this.triggers);c(this.npcs);c(this.tilesets);c(this.tileEffects);c(this.screens);c(this.adHocSpawns);d.push(...this.itemGets.write());
d.push(...this.slots.write());d.push(...this.items.write());d.push(...this.shops.write());c(this.bossKills);c(this.patterns);d.push(...this.wildWarp.write());d.push(...this.townWarp.write());d.push(...this.coinDrops.write());d.push(...this.scaling.write());d.push(...this.bosses.write());d.push(...this.randomNumbers.write());d.push(...this.telepathy.write());d.push(...this.messages.write());c=new Linker$$module$js$asm$linker;c.base(this.prg,0);for(const a of d)c.read(a);c.link().apply(a);a===this.prg&&
(a=c.exports(),this.uniqueItemTableAddress=a.get("KeyItemData").offset,this.shopCount=11,this.shopDataTablesAddress=(null===(b=a.get("ShopData"))||void 0===b?void 0:b.offset)||0,Rom$$module$js$rom.SHOP_COUNT.set(this.prg,this.shopCount),Rom$$module$js$rom.SCALING_LEVELS.set(this.prg,this.scalingLevels),Rom$$module$js$rom.UNIQUE_ITEM_TABLE.set(this.prg,this.uniqueItemTableAddress),Rom$$module$js$rom.SHOP_DATA_TABLES.set(this.prg,this.shopDataTablesAddress||0),Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX.set(this.prg,
this.omitItemGetDataSuffix),Rom$$module$js$rom.OMIT_LOCAL_DIALOG_SUFFIX.set(this.prg,this.omitLocalDialogSuffix),Rom$$module$js$rom.COMPRESSED_MAPDATA.set(this.prg,this.compressedMapData))}analyzeTiles(){}disjointTilesets(){var a=[];for(var b of this.locations){if(!b.used)continue;var c=b.tileset;const d=b.extended?256:0;for(const e of b.screens)for(const b of e)(a[b+d]||(a[b+d]=new Set)).add(c)}b=seq$$module$js$rom$util(256,()=>new UnionFind$$module$js$unionfind);for(c=0;c<a.length;c++)if(a[c])for(var d of this.screens[c].allTilesSet())b[d].union([...a[c]]);
...
for(var l of this.locations)if(l.used&&a.has(l.tileset)){c.add(l.tileEffects);for(var m of l.allScreens())g.add(m)}for(var n of g)for(let a=0,b=n.tiles.length;a<b;a++)n.tiles[a]=d[n.tiles[a]];for(var p of a){d=this.tilesets[(p&127)>>>2];for(var q of b)for(l=0;l<q.length-1;l++){m=f(q[l]);n=f(q[l+1]);for(a=0;4>a;a++)d.tiles[a][m]=d.tiles[a][n];d.attrs[m]=d.attrs[n];if(32>n&&d.alternates[n]!==n){if(32<=m)throw Error(`Cannot unflag: ${p} ${m} ${n} ${d.alternates[n]}`);d.alternates[m]=d.alternates[n]}}for(var v of e){const [a,
...
g.enter(module$js$asm$token.TokenSource.concat(new Tokenizer$$module$js$asm$tokenizer(e,"flags.s"),yield b("init.s"),yield b("preshuffle.s"),yield b("postparse.s"),yield b("postshuffle.s")));e=new Preprocessor$$module$js$asm$preprocessor(g,f);f.tokens(e);return f.module()})}if(EXPAND_PRG$$module$js$patch&&524288>a.length){var h=new Uint8Array(a.length+262144);h.subarray(0,262160).set(a.subarray(0,262160));h.subarray(524304).set(a.subarray(262160));h[4]<<=1;a=h}if("number"!==typeof b)throw Error("Bad seed");
h=crc32$$module$js$crc32(b.toString(16).padStart(8,"0")+String(c.filterOptional()))>>>0;h=new Random$$module$js$random(h);const k=String(c);c=c.filterRandom(h);deterministicPreParse$$module$js$pass$deterministic(a.subarray(16));const l=new Rom$$module$js$rom(a);l.flags.defrag();"object"==typeof window&&(window.rom=l);l.spoiler=new Spoiler$$module$js$rom$spoiler(l);e&&(e.spoiler=l.spoiler);deterministic$$module$js$pass$deterministic(l,c);module$js$pass$standardmapedits.standardMapEdits(l,module$js$pass$standardmapedits.standardMapEdits.generateOptions(c,
h));toggleMaps$$module$js$pass$togglemaps(l,c,h);l.scalingLevels=48;c.shuffleShops()&&shuffleShops$$module$js$patch(l,c,h);shuffleGoa$$module$js$pass$shufflegoa(l,h);randomizeWalls$$module$js$patch(l,c,h);crumblingPlatforms$$module$js$pass$crumblingplatforms(l,h);c.nerfWildWarp()&&l.wildWarp.locations.fill(0);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(l,c,h);c.randomizeThunderTeleport()&&randomizeThunderWarp$$module$js$pass$randomizethunderwarp(l,h);rescaleMonsters$$module$js$pass$rescalemonsters(l,
c,h);unidentifiedItems$$module$js$pass$unidentifieditems(l,c,h);shuffleTrades$$module$js$pass$shuffletrades(l,c,h);c.randomizeMaps()&&shuffleMazes$$module$js$pass$shufflemazes(l,c,h);c.shuffleMimics()&&shuffleMimics$$module$js$pass$shufflemimics(l,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$pass$shufflemonsters(l,c,h);var m=new World$$module$js$logic$world(l,c);if(m=yield(new Graph$$module$js$logic$graph([m.getLocationList()])).shuffle(c,h,void 0,f,l.spoiler))for(var n of m){const [a,b]=
n;l.slots[a&255]=b&255}else return[a,-1];c.shuffleShops()&&rescaleShops$$module$js$patch(l,c.bargainHunting()?h:void 0);c.buffMedicalHerb()&&(l.items.MedicalHerb.value=80,l.items.FruitOfPower.value=56);c.storyMode()&&storyMode$$module$js$patch(l);c.blackoutMode()&&blackoutMode$$module$js$patch(l);misc$$module$js$patch(l,c,h);fixDialog$$module$js$pass$fixdialog(l);c.buffDyna()&&buffDyna$$module$js$patch(l,c);c.trainer()&&(l.wildWarp.locations=[10,26,53,72,109,110,140,170,172,176,182,159,166,88,92,
0]);c.randomizeMusic("early")&&shuffleMusic$$module$js$patch(l,c,h);c.shuffleTilePalettes("early")&&shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);updateTablesPreCommit$$module$js$patch(l,c);h.shuffle(l.randomNumbers.values);l.messages.compress();n=a.slice(16);l.modules.push(yield g("early"));l.writeData(n);l.modules.pop();l.modules.push(yield g("late"));n=stampVersionSeedAndHash$$module$js$patch(a,b,k,n);c.randomizeMusic("late")&&shuffleMusic$$module$js$patch(l,c,h);c.noMusic("late")&&noMusic$$module$js$patch(l);
c.shuffleTilePalettes("late")&&shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);l.writeData();EXPAND_PRG$$module$js$patch&&(h=a.subarray(16),h.subarray(507904,524288).set(h.subarray(245760,262144)));return[a,n]})}
