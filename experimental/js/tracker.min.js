...
a.assumeGhettoFlight())),m=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),p=h(d("Assume teleport skip",a.assumeTeleportSkip())),q=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),t=h(d("Allow rabbit skip",!a.disableRabbitSkip())),u=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),y=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),F=h(d("Assume wild warp",a.assumeWildWarp())),
x=d("Allow wild warp",a.allowWildWarp()),v=d("Sword magic optional",!a.guaranteeSwordMagic()),C=d("Matching sword optional",!a.guaranteeMatchingSword()),Qa=d("Gas mask optional",!a.guaranteeGasMask()),Pd=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),Qd=d("Calm sea optional",!a.barrierRequiresCalmSea()),Rd=d("Prison key optional",!a.paralysisRequiresPrisonKey()),Sd=d("Windmill optional",!a.sealedCaveRequiresWindmill()),Td=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
...
27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),J=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),N=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),wa=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),rb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),P=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),Y=(new Item$$module$js$nodes(c,
...
68,"Teleport")).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),je=(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),tc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),qa=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),G=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=P.bossDrop("Vampire 2",
...
Nc=new Trigger$$module$js$nodes(c,"Shyron Massacre"),Ae=(new Trigger$$module$js$nodes(c,"Saved Kensu")).get(G),Be=(new Trigger$$module$js$nodes(c,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$js$nodes(c,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(c,"Get Bow of Truth")).get(rc),Ee=(new Trigger$$module$js$nodes(c,"Forged Crystalis")).get(pb),$a=(new Condition$$module$js$nodes(c,"Sword charge glitch")).option(u,y),Fe=(new Condition$$module$js$nodes(c,"Rabbit skip")).option(r,
t),Ge=(new Condition$$module$js$nodes(c,"Teleport skip")).option(p,q),ab=(new Condition$$module$js$nodes(c,"Statue glitch")).option(m,n),He=(new Condition$$module$js$nodes(c,"Wild warp")).option(F,x),bb=(new Condition$$module$js$nodes(c,"Any level 2 sword")).option(S,Ia).option(S,Ja).option(T,Sa).option(T,Ta).option(O,Ua).option(O,Va).option(M,Wa).option(M,Xa),A=(new Condition$$module$js$nodes(c,"Destroy stone")).option(S,Ra).option(S,Ia).option(S,Ja).option($a,S,bb),B=(new Condition$$module$js$nodes(c,
"Destroy ice")).option(T,Ra).option(T,Sa).option(T,Ta).option($a,T,bb),w=(new Condition$$module$js$nodes(c,"Cross rivers")).option(O,Ra).option(O,Ua).option(O,Va).option(G).option($a,O,bb),xa=(new Condition$$module$js$nodes(c,"Destroy iron")).option(M,Ra).option(M,Wa).option(M,Xa).option($a,M,bb),V=(new Condition$$module$js$nodes(c,"Any sword")).option(S).option(T).option(O).option(M),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(T).option(O).option(M).option(Ya,
C.value?C:g,S),Je=(new Condition$$module$js$nodes(c,"Match vampire 2 sword (wind/water/thunder)")).option(S).option(O).option(M).option(C.value?C:g,T),Oc=(new Condition$$module$js$nodes(c,"Speed boots")).option(fc,k),Pc=(new Condition$$module$js$nodes(c,"Climb slopes")).option(vb).option(G).option(Oc),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Ac).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(sc).option(Ge,G),Qc=(new Condition$$module$js$nodes(c,
"Asina in her room")).option(Fc),Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(Ka).option(Qc).option(ab),Rc=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(yb,Ic),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(l,Rc,vb),da=(new Condition$$module$js$nodes(c,"Cross sea")).option(Rc).option(G),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Db).option(G).option(Ne),W=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(Xb.value?
Xb:g).option(Za),Sc=(new Condition$$module$js$nodes(c,"Wind magic")).option(v.value?v:g,W).option(Ia,Ja,W),Tc=(new Condition$$module$js$nodes(c,"Fire magic")).option(v.value?v:g,W).option(Sa,Ta,W),Uc=(new Condition$$module$js$nodes(c,"Water magic")).option(v.value?v:g,W).option(v,W).option(Ua,Va,W),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(v.value?v:g,W).option(v,W).option(Wa,W).option(Xa,W),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(ub).option(ab),
Re=(new Condition$$module$js$nodes(c,"Change or glitch")).option(qa).option(ab),Se=(new Condition$$module$js$nodes(c,"Change or glitch or paralysis")).option(qa).option(ab).option(Ka),Fb=(new Condition$$module$js$nodes(c,"Pass shooting statues")).option(tc).option(V,Wb.value?Wb:g).option(Za,gc),Te=(new Condition$$module$js$nodes(c,"Healed dolphin if required")).option(Hc).option(Pd),Vc=(new Condition$$module$js$nodes(c,"Match sword of wind")).option(S).option(C.value?C:g,V),Wc=(new Condition$$module$js$nodes(c,
"Match sword of fire")).option(T).option(C.value?C:g,V),Xc=(new Condition$$module$js$nodes(c,"Match sword of water")).option(O).option(C.value?C:g,V),Ue=(new Condition$$module$js$nodes(c,"Match sword of thunder")).option(M).option(C.value?C:g,V),Ve=(new Condition$$module$js$nodes(c,"Swamp run possible")).option(V,Oc).option(V,Wd).option(V,Za),We=(new Condition$$module$js$nodes(c,"Insect possible to kill")).option(Ya),cb=(new Condition$$module$js$nodes(c,"Travel swamp")).option(Ya).option(Qa.value?
...
uc,vc).trigger(wc,La,Ab),zf=(new Location$$module$js$nodes(c,16,ya,"Zebu's Cave Back")).cave().trigger(zc).connect(yf,B),Af=(new Location$$module$js$nodes(c,17,H,"Tunnel 1 (to Zebu)")).cave().connect(zf),Da=(new Location$$module$js$nodes(c,20,ra,"West")).overworld().connect(xf,Ye),Bf=(new Location$$module$js$nodes(c,20,ra,"South")).overworld().connect(Da,w),bd=(new Location$$module$js$nodes(c,21,ra,"East")).overworld().connect(Da).chest(dc,24),Oa=(new Location$$module$js$nodes(c,24,za,"Town")).town().connect(Da).trigger(me,
...
xc);const Ea=(new Location$$module$js$nodes(c,32,H,"Entrance")).overworld().connect(Da).connect(Af),Df=(new Location$$module$js$nodes(c,32,H,"Up Slope")).overworld().from(Ea,Pc).to(Ea),Ef=(new Location$$module$js$nodes(c,32,H,"Dead End (warp boots)")).overworld().chest(U,24,106),cd=(new Location$$module$js$nodes(c,33,H,"Upper")).overworld().from(Ea,G).to(Ea),Ff=(new Location$$module$js$nodes(c,33,H,"Tornel Dead End")).overworld().trigger(qe,Ia,Ja).chest(Y,23,105),dd=(new Location$$module$js$nodes(c,
34,H,"Tunnel 2a (fork at start)")).cave().connect(Ea);(new Location$$module$js$nodes(c,34,H,"Tunnel 2b (left branch to dead end)")).cave().connect(dd,B).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,H,"Tunnel 2c (right branch to upper)")).cave().connect(dd,B),Hf=(new Location$$module$js$nodes(c,35,H,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(J,23,82),If=(new Location$$module$js$nodes(c,35,H,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,
B).connectTo(cd),ed=(new Location$$module$js$nodes(c,36,H,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,H,"Tunnel 4b (out to upper)")).cave().connect(ed,B).connectTo(cd);const Jf=(new Location$$module$js$nodes(c,37,H,"Tunnel 5 (tiny connector)")).cave().connect(ed),Kf=(new Location$$module$js$nodes(c,38,H,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);(new Location$$module$js$nodes(c,38,H,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,
B).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,H,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,H,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,B);(new Location$$module$js$nodes(c,39,H,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,B).chest(Ja,25);const hb=(new Location$$module$js$nodes(c,40,z,"Entrance")).overworld().connect(bd,Le,Ke),ib=(new Location$$module$js$nodes(c,40,z,"Upper")).overworld().from(hb,G).to(hb),
Ib=(new Location$$module$js$nodes(c,40,z,"Summit (boss)")).overworld().from(ib,G).to(ib).boss(bf),fd=(new Location$$module$js$nodes(c,41,z,"Connector")).overworld(),Jb=(new Location$$module$js$nodes(c,41,z,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,z,"Middle Right")).overworld().from(Jb,Pc).to(Jb),gd=(new Location$$module$js$nodes(c,42,z,"Tunnel 2a (from entrance to connector)")).cave().connectTo(fd);(new Location$$module$js$nodes(c,42,z,"Tunnel 2b (under bridge, to antidote)")).cave().connect(gd,
B).chest(N,23,94);const hd=(new Location$$module$js$nodes(c,43,z,"Tunnel 3a (branch after connector)")).cave().connect(fd),Of=(new Location$$module$js$nodes(c,43,z,"Tunnel 3b (right branch)")).cave().connect(hd,B),Pf=(new Location$$module$js$nodes(c,43,z,"Tunnel 3c (upper branch)")).cave().connect(hd,B);(new Location$$module$js$nodes(c,44,z,"Tunnel 4 (over bridge, to middle)")).cave().connect(Pf).connectTo(Jb);const id=(new Location$$module$js$nodes(c,45,z,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Of).connectTo(Nf);
(new Location$$module$js$nodes(c,45,z,"Tunnel 5b (dead-end with herb)")).cave().connect(id,B).chest(J,22,83);const Qf=(new Location$$module$js$nodes(c,46,z,"Tunne; 6a (S-shaped hall, right)")).cave().connect(id),Rf=(new Location$$module$js$nodes(c,46,z,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Qf,B),Sf=(new Location$$module$js$nodes(c,46,z,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Rf,B),jd=(new Location$$module$js$nodes(c,47,z,"Prison (hallway)")).cave().connect(ib),Tf=(new Location$$module$js$nodes(c,
48,z,"Left Cell (shopkeepers)")).cave().from(jd,B);(new Location$$module$js$nodes(c,49,z,"Left Cell 2 (back, with prison key)")).cave().from(Tf,B).chest(xb,13);const Uf=(new Location$$module$js$nodes(c,50,z,"Right Cell (villagers)")).cave().from(jd,B),Vf=(new Location$$module$js$nodes(c,51,z,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Uf,B);(new Location$$module$js$nodes(c,52,z,"Tunnel 9 (connector to summit)")).cave().connect(Vf).connectTo(Ib);const Wf=(new Location$$module$js$nodes(c,
53,z,"Summit Cave (front)")).cave().from(Ib,xb).to(Ib),Xf=(new Location$$module$js$nodes(c,53,z,"Summit Cave (behind ice)")).cave().connect(Wf,B).trigger(re);(new Location$$module$js$nodes(c,56,z,"Tunnel 1 (leads from main entrance)")).cave().connect(hb).connectTo(gd);(new Location$$module$js$nodes(c,57,z,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(ib);const Yf=(new Location$$module$js$nodes(c,60,db,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,db,"Tool Shop")).shop(J,N,P,U),$f=(new Location$$module$js$nodes(c,
62,db,"Back Room")).house(),Kb=(new Location$$module$js$nodes(c,64,ja,"Summit")).overworld().connect(Xf,nf),jb=(new Location$$module$js$nodes(c,64,ja,"Northwest")).overworld().from(Kb).to(Kb,G),ag=(new Location$$module$js$nodes(c,64,ja,"Northeast")).overworld().connect(jb,w),kd=(new Location$$module$js$nodes(c,65,ja,"Southwest")).overworld().connect(jb),bg=(new Location$$module$js$nodes(c,65,ja,"Southeast")).overworld().connect(kd,w),ld=(new Location$$module$js$nodes(c,66,ja,"Lime Tree Valley")).overworld().connect(kd).connect(Na,
...
(new Location$$module$js$nodes(c,79,I,"Tunnel 7b (fog lamp)")).cave().connect(sg,A).chest(jc,19);const va=(new Location$$module$js$nodes(c,80,E,"Town")).town().connect(jb),rd=(new Location$$module$js$nodes(c,81,E,"Fishherman Island")).town().connect(va);(new Location$$module$js$nodes(c,82,ja,"Mesia Shrine")).cave().trigger(Fc).connect(cg,w,Ec);const sd=(new Location$$module$js$nodes(c,84,ka,"Tunnel 1a (entrance)")).cave().connect(jb);(new Location$$module$js$nodes(c,84,ka,"Tunnel 1b (dead end, mimic)")).cave().connect(sd,
...
wb);const kb=(new Location$$module$js$nodes(c,100,E,"Underground Channel 1 (from throne room)")).sea().trigger(Dc),Eg=(new Location$$module$js$nodes(c,100,E,"Underground Channel 2 (to fortune teller)")).sea().connect(kb,w),wd=(new Location$$module$js$nodes(c,100,E,"Underground Channel 3 (from fortune teller)")).sea().connect(kb,G),xd=(new Location$$module$js$nodes(c,100,E,"Underground Channel 4 (asina)")).sea().connect(wd,w),Fg=(new Location$$module$js$nodes(c,100,E,"Underground Channel 5 (dolphin)")).sea().connect(xd,
w).trigger(Hc,J,Gc);(new Location$$module$js$nodes(c,100,E,"Underground Channel 6 (water)")).sea().connect(Fg,da).connectTo(Fa,da).chest(nc,17);const Nb=(new Location$$module$js$nodes(c,101,L,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,L,"Tunnel 1 (entrance)")).sea().connect(Fa,Jc,da),yd=(new Location$$module$js$nodes(c,105,L,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,L,"Tunnel 2b (dead end to left)")).cave().connect(yd,w);const Hg=(new Location$$module$js$nodes(c,
105,L,"Tunnel 2c (across first river)")).cave().connect(yd,w),zd=(new Location$$module$js$nodes(c,105,L,"Tunnel 2d (across second river)")).cave().connect(Hg,w);(new Location$$module$js$nodes(c,105,L,"Tunnel 2e (dead end, magic ring)")).cave().connect(zd,A).chest(Y,29);const Ig=(new Location$$module$js$nodes(c,105,L,"Tunnel 2f (stair down)")).cave().connect(zd,A),Jg=(new Location$$module$js$nodes(c,106,L,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(Nb).chest(wa,25,92),Kg=(new Location$$module$js$nodes(c,
106,L,"Tunnel 3b (left area toward items)")).cave().connect(Jg,A),Lg=(new Location$$module$js$nodes(c,107,L,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(Q,14,115);(new Location$$module$js$nodes(c,107,L,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,w).chest(he,15);const Ob=(new Location$$module$js$nodes(c,108,na,"Floor 1")).fortress().connect(Nb),Mg=(new Location$$module$js$nodes(c,108,na,"Miniboss")).fortress().boss(cf).connect(Ob);(new Location$$module$js$nodes(c,109,na,
"Floor 2a (left stair)")).fortress().connect(Ob).chest(P,19);const Ng=(new Location$$module$js$nodes(c,109,na,"Floor 2b (right stair)")).fortress().connect(Mg).chest(J,30,85),Og=(new Location$$module$js$nodes(c,110,na,"Floor 3a (toward boss)")).fortress().connect(Ng),Ad=(new Location$$module$js$nodes(c,110,na,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$js$nodes(c,110,na,"Boss")).fortress().boss(Yc).connect(Ad);(new Location$$module$js$nodes(c,110,na,"Floor 3c (back room trap)")).fortress().from(Ad).to(Ob);
...
124,D,"Entrance")).overworld().connect(mb),Sg=(new Location$$module$js$nodes(c,124,D,"Over first river toward Shyron")).overworld().connect(Pb,w),Bd=(new Location$$module$js$nodes(c,124,D,"After first tunnel")).overworld(),Cd=(new Location$$module$js$nodes(c,124,D,"Door to Styx")).overworld().connect(Bd,w),Tg=(new Location$$module$js$nodes(c,124,D,"Dead end (no item)")).overworld(),Ug=(new Location$$module$js$nodes(c,124,D,"Dead end (fruit of lime)")).overworld().chest(rb,26),Vg=(new Location$$module$js$nodes(c,
124,D,"Dead end (magic ring)")).overworld().chest(Y,25,101),Dd=(new Location$$module$js$nodes(c,124,D,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(c,124,D,"Floating island (bow of sun)")).overworld().connect(Dd,G).chest(qc,24);const Wg=(new Location$$module$js$nodes(c,125,D,"Tunnel 1 (to Shyron)")).cave().connect(Sg),Xg=(new Location$$module$js$nodes(c,126,D,"Outside Shyron")).overworld().connect(Wg);(new Location$$module$js$nodes(c,127,D,"Tunnel 2 (fork)")).cave().connect(Pb).connectTo(Ug).connectTo(Bd);
const Ed=(new Location$$module$js$nodes(c,128,D,"Tunnel 3 (caves)")).cave().connect(Cd).connect(Tg),Fd=(new Location$$module$js$nodes(c,129,D,"Tunnel 4 (left branch of cave)")).cave().connect(Ed);(new Location$$module$js$nodes(c,130,D,"Tunnel 5 (dead end, medical herb)")).cave().connect(Fd).chest(J,15,86);const Yg=(new Location$$module$js$nodes(c,131,D,"Tunnel 6a (left-then-right)")).cave().connect(Fd),Zg=(new Location$$module$js$nodes(c,131,D,"Tunnel 6b (past wall)")).cave().connect(Yg,A),$g=(new Location$$module$js$nodes(c,
132,D,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,D,"Tunnel 8 (red slimes)")).cave().from($g,A).connectTo(Dd).chest(Q,23,116);const ah=(new Location$$module$js$nodes(c,134,D,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Ed),bh=(new Location$$module$js$nodes(c,135,D,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,135,D,"Tunnel 10b (past wall)")).cave().connect(bh,A).connectTo(Vg);const Gd=(new Location$$module$js$nodes(c,
136,ta,"Entrance")).fortress().from(Cd,ic,Fb),ch=(new Location$$module$js$nodes(c,137,ta,"Left branch")).fortress().connect(Gd).chest(Q,19,117),dh=(new Location$$module$js$nodes(c,137,ta,"Left branch, past one bridge")).fortress().connect(ch,w),eh=(new Location$$module$js$nodes(c,137,ta,"Left branch, past two bridges")).fortress().connect(dh,w).chest(J,29,87),fh=(new Location$$module$js$nodes(c,137,ta,"Right branch")).fortress().connect(Gd);(new Location$$module$js$nodes(c,137,ta,"Right branch, across water")).fortress().connect(fh,
G).chest(Q,20,118).chest(Q,21,119).chest(Zd,28);(new Location$$module$js$nodes(c,138,ta,"Upper floor")).fortress().connect(eh).chest(M,27);const Ga=(new Location$$module$js$nodes(c,140,oa,"Town")).town().connect(Xg,Re).trigger(Eb),Pa=(new Location$$module$js$nodes(c,142,ua,"Town")).town().connect(mb),Hd=(new Location$$module$js$nodes(c,143,K,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,K,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Hd,
xa).chest(fe,15);const Qb=(new Location$$module$js$nodes(c,144,ua,"Desert 1")).overworld().connect(mb),nb=(new Location$$module$js$nodes(c,145,K,"Area 1 (from entrance)")).cave().chest(fc,26),Id=(new Location$$module$js$nodes(c,145,K,"Area 2 (across top bridge)")).cave().connect(nb,w);(new Location$$module$js$nodes(c,145,K,"Area 3 (dead-end across top-right bridge)")).cave().connect(Id,w);const gh=(new Location$$module$js$nodes(c,145,K,"Area 4 (left across middle-right bridge)")).cave().connect(Id,
w),hh=(new Location$$module$js$nodes(c,145,K,"Area 5 (bottom edge)")).cave().connect(gh,w),ih=(new Location$$module$js$nodes(c,145,K,"Area 6 (bottom island)")).cave().connect(hh,w),jh=(new Location$$module$js$nodes(c,145,K,"Area 7 (bottom inner ring)")).cave().connect(ih,w),kh=(new Location$$module$js$nodes(c,145,K,"Area 8 (left outer ring)")).cave().connect(jh,w).connect(nb,w).chest(P,27,100),lh=(new Location$$module$js$nodes(c,145,K,"Area 9 (top left inner ring)")).cave().connect(kh,w),mh=(new Location$$module$js$nodes(c,
145,K,"Area 10 (top right inner ring)")).cave().connect(lh,w);(new Location$$module$js$nodes(c,145,K,"Area 11 (center)")).cave().connect(mh,w).connectTo(Hd);(new Location$$module$js$nodes(c,145,K,"Area 12 (top center islands)")).cave().connect(nb,G).chest(de,28);const nh=(new Location$$module$js$nodes(c,146,ca,"Desert Cave 1")).cave().connect(Qb,G),Ha=(new Location$$module$js$nodes(c,147,ca,"Town")).town(),oh=(new Location$$module$js$nodes(c,148,ca,"Outside Cave")).overworld().connect(Ha),ph=(new Location$$module$js$nodes(c,
149,ca,"Desert Cave 2")).cave().connect(oh);(new Location$$module$js$nodes(c,150,ca,"Meadow")).overworld().connect(nh).connectTo(Ha).trigger(Be,qa,Ze);const Rb=(new Location$$module$js$nodes(c,152,ca,"Desert 2")).overworld().connect(ph),qh=(new Location$$module$js$nodes(c,156,Ca,"Entrance")).fortress().connect(Rb,G),rh=(new Location$$module$js$nodes(c,156,Ca,"Azteca")).fortress().trigger(De),sh=(new Location$$module$js$nodes(c,157,Ca,"Fork")).fortress().connect(qh),Jd=(new Location$$module$js$nodes(c,
158,Ca,"Main")).fortress().connect(sh);(new Location$$module$js$nodes(c,158,Ca,"Treasure Chest (magic ring)")).fortress().connect(Jd).chest(Y,27,108);(new Location$$module$js$nodes(c,159,Ca,"Draygon")).fortress().connect(Jd).to(rh).boss(jf);const th=(new Location$$module$js$nodes(c,160,ea,"Entrance")).fortress().connect(Rb,G),uh=(new Location$$module$js$nodes(c,160,ea,"Statues")).fortress().connect(th).boss(kf),vh=(new Location$$module$js$nodes(c,161,ea,"Hall 1")).fortress().connect(uh),Sb=(new Location$$module$js$nodes(c,
...
171,ba,"Dead End Loop Across Closer Bridges")).fortress().connect(ob,w).connect(ob,w);const Bh=(new Location$$module$js$nodes(c,171,ba,"Across First Bridge (fruit of repun)")).fortress().connect(ob,w).chest(sb,30,102),Tb=(new Location$$module$js$nodes(c,171,ba,"Across Second Bridge")).fortress().connect(Bh,w);(new Location$$module$js$nodes(c,171,ba,"Dead End Across Two Bridges ()")).fortress().connect(Tb,w).connect(Tb,w).chest(wa,29,93);const Ch=(new Location$$module$js$nodes(c,171,ba,"Across Third Bridge")).fortress().connect(Tb,
w),Dh=(new Location$$module$js$nodes(c,171,ba,"Exit Behind Iron Door")).fortress().connect(Ch,xa),Eh=(new Location$$module$js$nodes(c,172,ba,"Boss")).fortress().connect(Dh).boss(ff),Fh=(new Location$$module$js$nodes(c,172,ba,"Tornel")).fortress().connect(Eh),Ld=(new Location$$module$js$nodes(c,173,Ba,"Lower")).fortress().connect(Fh).chest(tb,26,99).chest(Y,27,111),Gh=(new Location$$module$js$nodes(c,174,Ba,"Upper Loop")).fortress().connect(Ld).chest(N,22,96);(new Location$$module$js$nodes(c,174,Ba,
...
Nh=(new Location$$module$js$nodes(c,182,R,"Boss")).fortress().connect(Mh,Fb).boss(hf);(new Location$$module$js$nodes(c,182,R,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(Xa,18);const Od=(new Location$$module$js$nodes(c,183,R,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,184,K,"Entrance Back (behind river)")).cave().connect(Od).chest(P,13,90);(new Location$$module$js$nodes(c,184,K,"Entrance Front")).cave().connect(Oh,G).connectTo(Qb).connectTo(nb);const Ph=(new Location$$module$js$nodes(c,
185,Ba,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$js$nodes(c,185,Ba,"Asina")).fortress().connect(Ph).connectTo(Ub);(new Location$$module$js$nodes(c,186,R,"Kensu")).fortress().connect(Nd).connectTo(Od).trigger(Ae,zb);(new Location$$module$js$nodes(c,187,ua,"House")).house().connect(Pa).trigger(Ce,qa,zb);(new Location$$module$js$nodes(c,188,ua,"Inn")).shop().connect(Pa,Eb);(new Location$$module$js$nodes(c,190,ua,"Tool Shop")).shop(J,N,U,P).connect(Pa,Eb);(new Location$$module$js$nodes(c,
191,ua,"Tavern")).shop().connect(Pa);(new Location$$module$js$nodes(c,192,Z,"Elder House")).house().connect(pa).trigger(uc);(new Location$$module$js$nodes(c,193,Z,"Rabbit Hut")).house().connect(pa).trigger(Ac,zc,ia);(new Location$$module$js$nodes(c,194,Z,"Inn")).shop().connect(pa);(new Location$$module$js$nodes(c,195,Z,"Tool Shop")).shop(J,N,U,P).connect(pa);(new Location$$module$js$nodes(c,196,Z,"Armor Shop")).shop($d,Yb).connect(pa);(new Location$$module$js$nodes(c,197,Z,"Student House")).house().connect(pa).trigger(vc);
(new Location$$module$js$nodes(c,198,za,"Tavern")).house().connect(Oa);(new Location$$module$js$nodes(c,199,za,"Pawn Shop")).shop().connect(Oa);(new Location$$module$js$nodes(c,200,za,"Inn")).shop().connect(Oa);(new Location$$module$js$nodes(c,201,za,"Armor Shop")).shop(ae,Yb,Xd).connect(Oa);(new Location$$module$js$nodes(c,203,za,"Tool Shop")).shop(J,N,U).connect(Oa);(new Location$$module$js$nodes(c,205,Ma,"Elder House")).house().from(gb,ia).trigger(pe,Bb);(new Location$$module$js$nodes(c,206,Ma,
"Mother's House")).house().from(gb,ia).trigger(yc,ia).trigger(oe,Bb);(new Location$$module$js$nodes(c,207,Ma,"Tool Shop")).shop(J,N,P).from(gb,ia);(new Location$$module$js$nodes(c,208,Ma,"Inn")).shop().from(gb,ia);(new Location$$module$js$nodes(c,209,Aa,"Inn")).shop().connect(fb);(new Location$$module$js$nodes(c,210,Aa,"Tool Shop")).shop(U,P,wa).connect(fb);(new Location$$module$js$nodes(c,211,Aa,"Armor Shop")).shop(bc,Zb,$b,qb).connect(fb);const Qh=(new Location$$module$js$nodes(c,212,Aa,"Queen's House")).house().from(fb,
...
(new Location$$module$js$nodes(c,217,E,"Pawn Shop")).shop().connect(va);(new Location$$module$js$nodes(c,218,E,"Armor Shop")).shop(be,bc,Zb).connect(va);(new Location$$module$js$nodes(c,220,E,"Inn")).shop().connect(va);(new Location$$module$js$nodes(c,221,E,"Tool Shop")).shop(J,wa,rb,U).connect(va);(new Location$$module$js$nodes(c,222,E,"Palace Left")).house().connect(Vb);(new Location$$module$js$nodes(c,223,E,"Palace Throne Room")).house().connect(Vb).to(kb,Me).from(kb).trigger(Bc).trigger(se,Cc,
Dc);(new Location$$module$js$nodes(c,224,E,"Palace Right")).house().connect(Vb);(new Location$$module$js$nodes(c,225,E,"Asina's Room")).house().connect(xd).trigger(Gc,Qc);(new Location$$module$js$nodes(c,226,Aa,"Queen Downstairs")).house().connect(Qh).chest(Va,13);(new Location$$module$js$nodes(c,227,ma,"Elder's House")).house().connect(lb).trigger(Jc);(new Location$$module$js$nodes(c,228,ma,"Shed")).house().connect(lb).to(Pg,kc);(new Location$$module$js$nodes(c,229,ma,"Tool Shop")).shop(J,N,P,wa).connect(lb);
(new Location$$module$js$nodes(c,231,ma,"Inn")).shop().connect(lb);const Rh=(new Location$$module$js$nodes(c,232,L,"Zombie Town House")).house().connect(Nb);(new Location$$module$js$nodes(c,233,L,"Zombie Town Basement")).house().connect(Rh).trigger(ue,Yc);(new Location$$module$js$nodes(c,235,aa,"Tool Shop")).shop(J,N,P,U).connect(ha);(new Location$$module$js$nodes(c,236,aa,"Stom's Hut")).house().connect(ha).trigger(Kc);(new Location$$module$js$nodes(c,237,aa,"Inn")).shop().connect(ha);(new Location$$module$js$nodes(c,
...
Nc).boss(df);(new Location$$module$js$nodes(c,243,oa,"Training Hall")).house().connect(Ga);(new Location$$module$js$nodes(c,244,oa,"Hospital")).house().connect(Ga);(new Location$$module$js$nodes(c,245,oa,"Armor Shop")).shop(cc,qb,ac).connect(Ga);(new Location$$module$js$nodes(c,246,oa,"Tool Shop")).shop(J,N,rb,Y).connect(Ga);(new Location$$module$js$nodes(c,247,oa,"Inn")).shop().connect(Ga);(new Location$$module$js$nodes(c,248,ca,"Inn")).shop().connect(Ha);(new Location$$module$js$nodes(c,249,ca,
...
f.shuffleShops(b);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&k.slots){var l=k.slotType[0];(h[l]=h[l]||[]).push(k)}k=[];l=[];var m={};for(var n of d.get("S")){var p=[];for(var q of n){m[q]=!0;for(var r of h[q])p.push(r),l.push([r,k.length])}k.push(p)}for(var t of"bc")if(m[t])for(n=h[t],q=n.map((a)=>[a.item,a.itemIndex]),b.shuffle(q),r=0;r<n.length;r++)n[r].set(q[r][0],q[r][1]);p=(a)=>g.find((b)=>
b.vanillaItemName===a);h=p("Sword of Wind");t=p("Sword of Fire");n=p("Ball of Wind");q=p("Ball of Fire");r=p("Statue of Onyx");p=p("Gas Mask");m.k&&b.nextInt(2)&&(t.swap(h),q.swap(n));m.k&&!b.nextInt(3)&&r.swap(p);m=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(t=0;1E3>t;t++){e&&0===t%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));b.shuffle(l);for(var u of k)b.shuffle(u);n=k.map(()=>-1);q=m[b.nextInt(m.length)];r=[];p=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||
...
a.slots&&!a.isFixed());const l=new Map(d.shuffle(k.map((a)=>[a,[a.item,a.itemIndex]]))),m=new Set(d.shuffle(k)),n=new Map,p={};g&&g.seeds++;f.get("S").forEach((a,b)=>{for(const c of a)p[c]=b});for(var q of m)n.set(q.item,q);const r=new Set,t=(a,b)=>{if(null==p[a.slotType?a.slotType[0]:"c"])return a===b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!==b.item.inventoryRow&&a.requiresUnique||"armor"===b.item.inventoryRow&&!a.isChest())return!1;if(f.guaranteeSword()){if(0===a.slotIndex)return 4>b.item.id;
if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return p[a.slotType?a.slotType[0]:"c"]===p[b.slotType?b.slotType[0]:"c"]};q=b.assumedFill(d,(a,b)=>t(a,n.get(b)));if(null==q){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const u=new Map;for(var y=0;y<q.length;y++){var F=q[y];if(null!=F){var x=n.get(b.item(F));F=l.get(x);l.delete(x);x=b.location(y);u.set(x,F);m.delete(x)}}y=(a,b,c)=>{c=void 0===c?"":c;for(const c of m)if(t(c,a))return u.set(c,b),m.delete(c),l.delete(a),!0;
g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var v of l){const [a,b]=v;if(a.isMimic()&&!y(a,b,"traps"))return!1}for(const a of l){const [b,c]=a;if(b.needsChest()&&!y(b,c,"chest"))return!1}for(const a of l){const [b,c]=a;if(!y(b,c))return!1}for(const a of u){const [b,c]=a;b.set(...c)}const {win:C,path:Qa}=a.traverse({wanted:k,dfs:!1});if(!C)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,q));e.items=
...
function build$$module$js$graph$world(a,b,c){b=void 0===b?new FlagSet$$module$js$flagset("@FullShuffle"):b;c=void 0===c?!1:c;const d=new Overlay$$module$js$graph$overlay(a,b,c),e=new Map,f=new Map,g=new Map,h=new Map,k=new DefaultMap$$module$js$util(()=>new Set),l=new Map,m=new Set;for(const b of a.locations){var n=function(a,b){const c=e.get(a);c&&e.set(a,module$js$graph$condition.Terrain.meet(c,b))};if(!b.used)continue;const c=b.extended?256:0,u=a.tilesets[(b.tileset&127)>>2],r=a.tileEffects[b.tileEffects-
179];for(const a of b.spawns)a.isWall()&&f.set(module$js$graph$geometry.ScreenId.from(b,a),a.id&3);for(let g=0,h=b.height;g<h;g++){const h=b.screens[g],k=b.id<<8|g<<4;for(let g=0,l=b.width;g<l;g++){var p=function(a,b){if(!t)throw Error("flag expected");return b?a?y(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(t.flag)},b):a};const l=a.screens[h[g]|c],m=module$js$graph$geometry.ScreenId(k|g),n=m&255,q=f.get(m),t=null!=q?d.wallCapability(q):b.flags.find((a)=>
a.yx===n),y=memoize2$$module$js$graph$condition((a,b)=>{if(!t)throw Error("flag expected");b=Object.assign({},b,{enter:meet$$module$js$graph$condition(b.enter||[[]],module$js$graph$condition.Condition(t.flag))});return module$js$graph$condition.Terrain.join(a,b)});for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(m<<8|a);let f=l.tiles[a];t&&751===t.flag&&32>f&&(f=u.alternates[f]);let g=d.makeTerrain(c?0:r.effects[f]&38,b);if(32>f&&u.alternates[f]!=f&&t&&751!==t.flag){const a=d.makeTerrain(r.effects[u.alternates[f]],
...
b);r.has(d)&&(q.union([b,c]),r.delete(a),r.delete(d))}const t=new Neighbors$$module$js$graph$geometry(q,m);for(const a of e){const [b,c]=a;{const a=module$js$graph$geometry.TileId.add(b,0,1),d=e.get(a);d&&d!==c&&t.addAdjacent(b,a,!1);const f=module$js$graph$geometry.TileId.add(b,1,0),g=e.get(f);g&&g!==c&&t.addAdjacent(b,f,!0)}}for(const a of r){const [b,c]=module$js$graph$geometry.TilePair.split(a);e.has(b)&&e.has(c)&&t.addExit(b,c)}const u=new Routes$$module$js$graph$routes;for(const a of d.extraRoutes())for(const b of a.condition||
[[]])u.addRoute(q.find(a.tile),b);for(const a of d.extraEdges()){const {from:b,to:c,condition:d}=a;for(const a of d||[[]])u.addEdge(q.find(c),q.find(b),a)}for(const a of t){const {from:b,to:c,south:d}=a;{const a=e.get(b),f=e.get(c);if(!a||!f)throw Error(`missing terrain ${a?c:b}`);for(const e of(d?a.exitSouth:a.exit)||[[]])for(const a of f.enter||[[]])u.addEdge(c,b,[...a,...e])}}const y=new DefaultMap$$module$js$util(()=>new MutableRequirement$$module$js$graph$condition);for(const a of d.capabilities()){const {condition:b=
[[]],capability:c}=a;y.get(module$js$graph$condition.Slot(c)).addAll(b)}for(const a of k){const [b,c]=a;{const a=q.find(b);if(b!==a){for(const b of c)k.get(a).add(b);k.delete(b)}}}for(const a of k){const [b,c]=a;for(const a of c){const {slot:c,condition:d=[[]]}=a;{const a=y.get(c);for(const c of d)for(const d of u.routes.get(b)||[])a.addList([...c,...d])}}}if(DEBUG$$module$js$graph$world&&"undefined"!==typeof window){var F=function(a,b){b=void 0===b?x:b;a=[...a];return a.length?"("+a.map((a)=>[...a].map(b).join(" & ")).join(") |\n     (")+
")":"no route"},x=function(a){return 0>a?"~"+(~a).toString(16).padStart(2,"0"):a.toString(16).padStart(3,"0")};const b=window;console.log(b.roots=(b.tiles=q).roots());console.log([...b.neighbors=t]);console.log(b.ll=u);b.area=(a,b)=>{b=void 0===b?x:b;const c=[...q.sets().filter((b)=>b.has(a))[0]].map((a)=>a.toString(16).padStart(6,"0")),d=F(u.routes.get(q.find(a)),b),e=[],f=q.find(a);for(const a of(u.edges.get(f)||new Map).values())e.push(`\nto ${a.target.toString(16)} if (${[...a.deps].map(b).join(" & ")})`);
for(const a of u.edges){const [c,d]=a;for(const a of d.values())a.target===f&&e.push(`\nfrom ${c.toString(16)} if (${[...a.deps].map(b).join(" & ")})`)}return`${hex$$module$js$rom$util(f)}\n${(function(a,b,c){const d=[];for(let e=0;e<a.length;e+=b)d.push(a.slice(e,e+b).join(c));return d})(c,16," ").join("\n")}\ncount = ${c.length}\nroutes = ${d}${e.join("")}`};b.whatFlag=(b)=>conditionName$$module$js$graph$world(b,a);b.reqs=y;console.log("reqs\n"+[...y].sort((a,b)=>{[a]=a;[b]=b;return a-b}).map((a)=>
{var [c,d]=a;return`${b.whatFlag(c)}: ${F(d,b.whatFlag)}`}).join("\n"));b.reqs.check=(a,b)=>{b=void 0===b?x:b;return`${b(a)}: ${F(y.get(module$js$graph$condition.Slot(a)),b)}`};b.reqs.check2=(a)=>b.reqs.check(a,b.whatFlag)}let v=isItem$$module$js$graph$world;c&&(v=function(a){return isItem$$module$js$graph$world(a)||b.shuffleBossElements()&&isBoss$$module$js$graph$world(a)?!0:!1});return new World$$module$js$graph$world(a,q,makeGraph$$module$js$graph$world(y,a,v))}
...
1,3,poi$$module$js$maze$spec(1,-48,72),poi$$module$js$maze$spec(1,-48,152)),Spec$$module$js$maze$spec(768,240," ",9,11,poi$$module$js$maze$spec(1,272,72),poi$$module$js$maze$spec(1,272,152)),Spec$$module$js$maze$spec(536624,241," ",5,7,13,15),Spec$$module$js$maze$spec(48,241," ",13,15,poi$$module$js$maze$spec(1,96,264),poi$$module$js$maze$spec(1,160,264)),Spec$$module$js$maze$spec(12288,241," ",5,7,poi$$module$js$maze$spec(1,96,-40),poi$$module$js$maze$spec(1,160,-40)),Spec$$module$js$maze$spec(65539,
242,"\u2568",bridge$$module$js$maze$spec(23,[1,3])),Spec$$module$js$maze$spec(66304,242,"\u2565",bridge$$module$js$maze$spec(198,[9,11])),Spec$$module$js$maze$spec(13104,243,"\u2566",93,121,191),Spec$$module$js$maze$spec(12339,244,"\u2569",21,61,127),Spec$$module$js$maze$spec(131843,245,"\u2560",25,3,11,poi$$module$js$maze$spec(1,192,152),poi$$module$js$maze$spec(1,64,152)),Spec$$module$js$maze$spec(262915,246,"\u2563",1,9,59,poi$$module$js$maze$spec(1,176,72),poi$$module$js$maze$spec(1,48,72))],
WIDE_SCREENS$$module$js$maze$spec=[Spec$$module$js$maze$spec(2,113,"\u253b",2,Stair$$module$js$maze$spec.down(53120,215)),Spec$$module$js$maze$spec(514,114,"\u2503",42),Spec$$module$js$maze$spec(34,224,"\u2516",46),Spec$$module$js$maze$spec(8194,225,"\u251a",38),Spec$$module$js$maze$spec(544,226,"\u250e",174),Spec$$module$js$maze$spec(8704,227,"\u2512",106),Spec$$module$js$maze$spec(66050,229,"\u254f","fixed",2,10),Spec$$module$js$maze$spec(8738,230,"\u2542",9902),Spec$$module$js$maze$spec(8226,231,
"\u2538",622),Spec$$module$js$maze$spec(8736,232,"\u2530",1710),Spec$$module$js$maze$spec(513,233,"\u257d","fixed",wall$$module$js$maze$spec(55,[2,10])),Spec$$module$js$maze$spec(8224,234,"\u2500",110),Spec$$module$js$maze$spec(66049,253,"\u257d","fixed",42)],WIDE_SET$$module$js$maze$spec=new Set([128,...WIDE_SCREENS$$module$js$maze$spec.map((a)=>a.tile)]),PIT_SCREENS$$module$js$maze$spec=[Spec$$module$js$maze$spec(528400,235,"\u2508","pit",110),Spec$$module$js$maze$spec(524545,236,"\u250a","pit",
42)],SPIKE_SCREENS$$module$js$maze$spec=[Spec$$module$js$maze$spec(260,237,"\u257f",42),Spec$$module$js$maze$spec(1025,238,"\u257d",42),Spec$$module$js$maze$spec(5140,239,"\u2542",9902),Spec$$module$js$maze$spec(1028,247,"\u2503",42)],SWAMP_SCREENS$$module$js$maze$spec=[Spec$$module$js$maze$spec(0,127," "),Spec$$module$js$maze$spec(1,-1,"\u2575",1),Spec$$module$js$maze$spec(16,118,"\u2576",13),Spec$$module$js$maze$spec(17,121,"\u2514",29),Spec$$module$js$maze$spec(256,-2,"\u2577",9),Spec$$module$js$maze$spec(257,
-3,"\u2502",25),Spec$$module$js$maze$spec(272,-4,"\u250c",157),Spec$$module$js$maze$spec(273,-5,"\u251c",413),Spec$$module$js$maze$spec(4096,123,"\u2574",5),Spec$$module$js$maze$spec(4097,117,"\u2518",21),Spec$$module$js$maze$spec(4112,-6,"\u2500",93),Spec$$module$js$maze$spec(4113,125,"\u2534",349),Spec$$module$js$maze$spec(4352,126,"\u2510",89),Spec$$module$js$maze$spec(4353,120,"\u2524",345),Spec$$module$js$maze$spec(4368,122,"\u252c",1437),Spec$$module$js$maze$spec(4369,119,"\u253c",5533),Spec$$module$js$maze$spec(61936,
124,"\u2564","fixed",9),Spec$$module$js$maze$spec(61440,127,"\u255d","fixed"),Spec$$module$js$maze$spec(240,127,"\u255a","fixed"),Spec$$module$js$maze$spec(65552,118,"\u2576","fixed","flag",13),Spec$$module$js$maze$spec(65792,-2,"\u2577","fixed","flag",9),Spec$$module$js$maze$spec(65808,-4,"\u250c","fixed","flag",157),Spec$$module$js$maze$spec(69632,123,"\u2574","fixed","flag",5),Spec$$module$js$maze$spec(69648,-6,"\u2500","fixed","flag",93),Spec$$module$js$maze$spec(69888,126,"\u2510","fixed","flag",
89),Spec$$module$js$maze$spec(69904,122,"\u252c","fixed","flag",1437)],GOA1_SCREENS$$module$js$maze$spec=[Spec$$module$js$maze$spec(0,128," "),Spec$$module$js$maze$spec(17,224,"\u2514","flag",31,46,61),Spec$$module$js$maze$spec(257,228,"\u2502","flag",1194411),Spec$$module$js$maze$spec(272,226,"\u250c","flag",157,174,191),Spec$$module$js$maze$spec(4097,225,"\u2518","flag",21,38,55),Spec$$module$js$maze$spec(4112,234,"\u2500",93,110,127),Spec$$module$js$maze$spec(4113,231,"\u2534","flag",21,622,61,
127),Spec$$module$js$maze$spec(4352,227,"\u2510","flag",91,106,121),Spec$$module$js$maze$spec(4368,232,"\u252c","flag",93,1710,121,191),Spec$$module$js$maze$spec(4369,230,"\u253c","flag",21,9902,61,121,191),Spec$$module$js$maze$spec(65553,224,"\u2514","fixed",46,61),Spec$$module$js$maze$spec(65793,228,"\u2502","fixed",4779),Spec$$module$js$maze$spec(65808,226,"\u250c","fixed",174,191),Spec$$module$js$maze$spec(69633,225,"\u2518","fixed",21,38),Spec$$module$js$maze$spec(69649,231,"\u2534","fixed",
622,127),Spec$$module$js$maze$spec(69888,227,"\u2510","fixed",106,121),Spec$$module$js$maze$spec(69904,232,"\u252c","fixed",93,1710),Spec$$module$js$maze$spec(69905,230,"\u253c","fixed",21,9902,191),Spec$$module$js$maze$spec(131329,229,"\u250a","fixed","flag",5019),Spec$$module$js$maze$spec(196865,229,"\u250a","fixed",57),Spec$$module$js$maze$spec(61681,113,"\u257d","fixed",42),Spec$$module$js$maze$spec(240,128,"\u2588","fixed"),Spec$$module$js$maze$spec(61440,128,"\u2588","fixed"),Spec$$module$js$maze$spec(65520,
115,"\u2550","fixed"),Spec$$module$js$maze$spec(61951,114,"\u2564","fixed"),Spec$$module$js$maze$spec(4080,128,"\u2554","fixed"),Spec$$module$js$maze$spec(65280,128,"\u2557","fixed"),Spec$$module$js$maze$spec(255,128,"\u255a","fixed"),Spec$$module$js$maze$spec(61455,128,"\u255d","fixed")],ALL_CAVE_SCREENS$$module$js$maze$spec=[BASIC_CAVE_SCREENS$$module$js$maze$spec,BOSS_CAVE_SCREENS$$module$js$maze$spec,RIVER_SCREENS$$module$js$maze$spec,WIDE_SCREENS$$module$js$maze$spec,PIT_SCREENS$$module$js$maze$spec,
SPIKE_SCREENS$$module$js$maze$spec],BITCOUNT$$module$js$maze$spec=[0,1,1,2,1,2,2,3,1,2,2,3,2,3,3,4],DEAD_ENDS$$module$js$maze$spec=new Set([155,156,240,241]);
class SpecSet$$module$js$maze$spec{constructor(a,b){this.specSets=a;this.empty=b;this.fixedTiles=new Map;this.edgesByTile=new Map;this.stairsByTile=new Map;this.stairScreens=new Map;this.walls=new Map;for(const b of module$js$util.iters.concat(...a)){for(const c of module$js$maze$types.Dir.ALL)(a=b.edges>>module$js$maze$types.Dir.shift(c)&15)&&7!=(a&7)&&this.edgesByTile.set(b.tile,(this.edgesByTile.get(b.tile)||0)|1<<c);for(const a of b.stairs)this.stairsByTile.set(b.tile<<8|(a.entrance&61440)>>8|
(a.entrance&240)>>4,a.dir),this.stairScreens.set(b.edges,[a.dir,{entrance:a.entrance,exits:[a.exit,a.exit+1]}]);b.wall&&this.walls.set(b.tile,b.wall.type);128!=b.tile&&b.fixed&&this.fixedTiles.set(b.tile,b)}}survey(a){let b=0,c=0,d=0,e=0,f=0,g=!0,h=!1;const k=new Map,l=new Map,m=new Map,n=new Multiset$$module$js$util,p=[];this.empty&&p.push(this.empty);var q=new Set([].concat(...a.screens));for(var r of this.specSets)for(var t of r)if(128!==t.tile&&q.has(t.tile)){p.push(...r);break}q=new Set([...a.reachableTiles(!0).keys()].map((a)=>
a>>>8));r=new Map(a.entrances.map((b,c)=>{for(const d of a.exits)if(20>Math.abs(d.x-b.x)&&20>Math.abs(d.y-b.y))return[c,d.dest<<8|d.entrance];return null}).filter(isNonNull$$module$js$util));for(t=0;t<a.entrances.length;t++){var u=a.entrances[t],y=this.stairsByTile.get(a.screens[u.screen>>>4][u.screen&15]<<8|u.tile);if(null!=y){var F=r.get(t);if(null==F)throw Error("Could not find exit");k.set(u.screen,{entrance:t,exit:F,dir:y})}}for(t=0;t<a.height;t++)for(u=0,t||(u|=1),t===a.height-1&&(u|=4),y=0;y<
a.width;y++){F=t<<4|y;if(!q.has(F))continue;u&=-11;y||(u|=8);y===a.width-1&&(u|=2);var x=a.screens[t][y];n.add(x);if(128===x)continue;WIDE_SET$$module$js$maze$spec.has(x)?h=!0:g=!1;b++;let p=this.edgesByTile.get(x);if(null==p)throw Error(`Bad tile: ${hex$$module$js$rom$util(x)}`);var v=BITCOUNT$$module$js$maze$spec[p]+(k.has(F)?1:0);154===x&&(v=2);if(155===x||156==x||240==x||241==x)v=1;1===v&&c++;2<v&&(d+=v-2);v=this.walls.get(x);"wall"===v&&e++;"bridge"===v&&f++;v=this.fixedTiles.get(x);DEAD_ENDS$$module$js$maze$spec.has(x)&&
(p=0);for(const b of module$js$maze$types.Dir.ALL)if(p&u&1<<b){x=null;for(var C=0;C<a.entrances.length;C++)if(a.entrances[C].screen===F&&matchesDir$$module$js$maze$spec(a.entrances[C].tile,b)){x=C;break}if(null!=x){C=r.get(x);if(null==C)throw Error("Could not find exit");l.set(F,{entrance:x,exit:C,dir:b})}}null!=v&&m.set(F,v)}if(g!=h)throw Error("Found inconsistent use of wide tiles");return{size:b,deadEnds:c,branches:d,walls:e,bridges:f,stairs:k,edges:l,fixed:m,tiles:n,wide:g,specs:p,specSet:this}}}
...
h=[...concatIterables$$module$js$rom$util(b.exits),128|(b.pits.length?64:0)|b.entrances.length];var k=[...concatIterables$$module$js$rom$util(b.flags),255],l=concatIterables$$module$js$rom$util(b.pits),[m,n,p,q,r,t]=yield Promise.all([d(e,"Layout"),d(f,"Graphics"),d(g,"Entrances"),d(h,"Exits"),d(k,"Flags"),...l.length?[d(l,"Pits")]:[]]);e=[m&255,(m>>>8)-192,n&255,(n>>>8)-192,p&255,(p>>>8)-192,q&255,(q>>>8)-192,r&255,(r>>>8)-192,...t?[t&255,(t>>8)-192]:[]];d=yield d(e,"MapData");writeLittleEndian$$module$js$rom$util(a.rom,
...
module$js$maze$types.Scr.edge(c[1],c[2]);yield c}}*eligible(a,b){b=void 0===b?{}:b;const {skipAlternates:c,maxExits:d,edge:e,fuzzy:f,stair:g}=b;var h=null!=e?e|e<<4|e<<8|e<<12:void 0;let k=b=0,l=0;for(var m of module$js$maze$types.Dir.ALL){var n=module$js$maze$types.Dir.edgeMask(m),p=module$js$maze$types.Dir.edgeMask(module$js$maze$types.Dir.inv(m));let c=this.get(a,m);null==c&&(c=h);null!=c&&(l|=((c&p)>>>8|(c&p)<<8)&65535,b|=n,f&&this.isFixed(module$js$maze$types.Pos.plus(a,m))&&(k|=n))}f||(k=b);
a=l&k;m=[];h=Infinity;for(const e of this.screens){const [r,t]=e;if(!(t.fixed||c&&t.edges&-65536||null!=g&&!t.stairs.some((a)=>a.dir===g)||null==g&&t.stairs.length||(r&k)!==a||d&&module$js$maze$types.Scr.numExits(r)>d))if(f){n=0;p=r&b^l;for(const a of module$js$maze$types.Dir.ALL)p&15<<module$js$maze$types.Dir.shift(a)&&n++;n<h?(h=n,m=[r]):n===h&&m.push(r)}else yield r}f&&(yield*m)}fill(a,b){b=void 0===b?{}:b;if(b.force&&b.fuzzy)throw Error("invalid");const c=[...this.eligible(a,b)];if(!c.length){if(b.deleteNeighbors)for(const c of module$js$maze$types.Dir.ALL)b=
...
b=f}return this.fill(module$js$maze$types.Pos.plus(a,b),Object.assign({},e,{maxExits:2}))})}fillAll(a){a=void 0===a?{}:a;const b=a.shuffleOrder?this.random.shuffle([...this.allPos]):this.allPos;for(const c of b)if(null==this.map[c]&&!this.fill(c,a)){a.print&&console.log(`Could not fill ${hex$$module$js$rom$util(c)}\n${this.show()}`);if(a.fuzzy)return!1;throw Error(`Could not fill ${hex$$module$js$rom$util(c)}`);}return!0}randomPos(){return this.random.pick(this.allPosArray)}addScreen(a){for(const b of this.random.shuffle([...this.allPos]))if(null==
...
this.h,this.w,this.survey.specs);if(this.tryShuffle(a))return}throw Error(`Could not shuffle ${hex$$module$js$rom$util(this.loc.id)} ${this.loc.name}`);}check(a){a=a.traverse();return 2<a.size&&a.values().next().value.size===a.size}pickWidth(){return this.loc.width+Math.floor(this.random.nextInt(5)/3)}pickHeight(){return this.loc.height+Math.floor(this.random.nextInt(5)/3)}tryShuffle(a){console.log(`Shuffle ${this.loc.name}`);if(!this.initializeFixedScreens(a))return!1;console.log(`Initialized\n${a.show()}`);
if(!this.initialFillMaze(a))return!1;console.log(`Initial fill\n${a.show()}`);if(!this.refineMaze(a))return!1;console.log(`Refined\n${a.show()}`);if(!this.addFeatures(a))return!1;console.log(`Features\n${a.show()}`);return this.finish(a)}initializeFixedScreens(a){for(const [d,e]of this.survey.edges)for(var b of this.random.ishuffle(this.edges(e.dir)))if(!this.fixed.has(b)){this.fixed.add(b);var c=this.survey.fixed.get(d);if(null==c)a.setBorder(b,e.dir,6);else{if(1===this.h)return!1;a.setBorder(b,
e.dir,c.edges>>>module$js$maze$types.Dir.shift(e.dir)&15);fixBorders$$module$js$maze$cave(a,b,c.edges);a.set(b,c.edges);c.wall&&this.walls--}break}for(const [b,c]of this.survey.fixed)if(!this.survey.edges.has(b))for(const b of this.random.ishuffle(this.allPos))if(!this.fixed.has(b)&&a.saveExcursion(()=>{fixBorders$$module$js$maze$cave(a,b,c.edges);return a.trySet(b,c.edges)})){this.fixed.add(b);c.wall&&this.walls--;break}b=[...this.survey.stairs.values()];c=0;for(let d=0;10>c&&d<b.length;c++){const e=
a.randomPos();!this.fixed.has(e)&&a.fill(e,{stair:b[d].dir})&&(this.fixed.add(e),c=0,d++)}return 10<=c?fail$$module$js$maze$cave("could not add all stairs"):!0}initialFillMaze(a){return a.fillAll({edge:1,fuzzy:1,shuffleOrder:!0,skipAlternates:!0})?!0:fail$$module$js$maze$cave("could not fill open")}refineMaze(a){if(!this.check(a))return fail$$module$js$maze$cave("check failed after initial setup",a);const b={skipAlternates:!0};for(const [c]of this.random.shuffle([...a])){if(a.density()<=this.density)break;
!a.isFixed(c)&&a.saveExcursion(()=>a.setAndUpdate(c,0,b)&&this.check(a))}return this.removeTightCycles(a)}removeTightCycles(a){for(let b=1;b<this.h;b++)for(let c=1;c<this.w;c++){const d=b<<4|c;if(!isTightCycle$$module$js$maze$cave(a,d))continue;let e=!1;for(const b of this.random.ishuffle(module$js$maze$types.Dir.ALL)){const c=2>b?d-1:d-16;a.saveExcursion(()=>a.replaceEdge(c,b,0)&&this.check(a))&&(e=!0)}if(!e)return fail$$module$js$maze$cave("failed to remove tight cycle")}return!0}addFeatures(a){const b=
new Set,c=[...a.alternates()];for(const f of[140])if(this.survey.tiles.count(f)){var d=this.random.shuffle(c.filter((a)=>a[3].tile===f));if(d.length<this.survey.tiles.count(f))return fail$$module$js$maze$cave("could not add stair hallway");for(var e=this.survey.tiles.count(f)-1;0<=e;e--)a.replace(d[e][0],d[e][2]),b.add(d[e][0])}for(const f of["wall","bridge"]){d=this.random.shuffle(c.filter((a)=>a[3].wall&&a[3].wall.type===f));e="wall"===f?this.walls:this.bridges;for(let c=0;c<e;c++){const e=d.pop();
if(null==e)return fail$$module$js$maze$cave(`could not add ${f} ${c}`);b.has(e[0])?c--:(a.replace(e[0],e[2]),b.add(e[0]))}}return!0}finish(a){a.trim();console.log(`final:\n${a.show()}`);a.write(this.loc,new Set);return a.finish(this.survey,this.loc)}edges(a){const b=a===module$js$maze$types.Dir.RIGHT?this.w-1:a===module$js$maze$types.Dir.DOWN?this.h-1:0;return a&1?seq$$module$js$rom$util(this.h,(a)=>a<<4|b):seq$$module$js$rom$util(this.w,(a)=>b<<4|a)}randomEdge(a){const b=this.random.nextInt(a&1?
this.h:this.w),c=a===module$js$maze$types.Dir.RIGHT?this.w-1:a===module$js$maze$types.Dir.DOWN?this.h-1:0;return a&1?b<<4|c:c<<4|b}}class WideCaveShuffle$$module$js$maze$cave extends BasicCaveShuffle$$module$js$maze$cave{initialFillMaze(a){const b=[...this.fixed];if(!a.connect(b[0],null,b[1],null))return!1;for(let c=2;c<b.length;c++)if(!a.connect(b[c]))return!1;a.fillAll({edge:0});return!0}refineMaze(){return!0}addFeatures(){return!0}}
class WaterfallRiverCaveShuffle$$module$js$maze$cave extends BasicCaveShuffle$$module$js$maze$cave{initializeFixedScreens(a){const b=(b,c)=>{this.fixed.add(b);a.set(b,c)},c=1+this.random.nextInt(this.w-2);var d=this.random.nextInt(c),e=this.w-1-this.random.nextInt(this.w-c-1);const f=this.h-1<<4;b(f+d,131073);b(f+e,131073);b(f+c,3);b(c,768);d=[];for(e=1;e<this.h-1;e+=2)d.push(4867),d.push(787);this.random.shuffle(d);for(e=1;e<this.h-1;e++)b((e<<4)+c,d.pop());console.log(a.show());return!0}check(a){a=
a.traverse();const b=[...new Set(a.values())].map((a)=>a.size);return 2===b.length&&b[0]+b[1]===a.size&&2<b[0]&&2<b[1]}}
class CycleCaveShuffle$$module$js$maze$cave extends BasicCaveShuffle$$module$js$maze$cave{check(a){const b=[...a].filter((b)=>{b=[...a.traverse({without:[b[0]]})];return b.length&&b[0][1].size===b.length});if(!b.length)return!1;for(let c=0;c<b.length;c++)for(let d=0;d<c;d++){const e=[...a.traverse({without:[b[c][0],b[d][0]]})];if(e.length&&e[0][1].size!==e.length)return!0}return!1}}
class TightCycleCaveShuffle$$module$js$maze$cave extends CycleCaveShuffle$$module$js$maze$cave{removeTightCycles(){return!0}}function fail$$module$js$maze$cave(a,b){console.error(`Reroll: ${a}`);b&&DEBUG$$module$js$maze$cave&&console.log(b.show());return!1}function isTightCycle$$module$js$maze$cave(a,b){const c=a.get(b-17)||0;a=a.get(b)||0;return!!(c&3840&&c&240&&a&61440&&a&15)}
function fixBorders$$module$js$maze$cave(a,b,c){try{for(const d of module$js$maze$types.Dir.ALL)a.inBounds(module$js$maze$types.Pos.plus(b,d))||7!==(c>>module$js$maze$types.Dir.shift(d)&7)||a.setBorder(b,d,7)}catch(d){}}const STRATEGIES$$module$js$maze$cave=new Map([[39,CycleCaveShuffle$$module$js$maze$cave],[75,TightCycleCaveShuffle$$module$js$maze$cave],[84,CycleCaveShuffle$$module$js$maze$cave],[86,WideCaveShuffle$$module$js$maze$cave],[87,WaterfallRiverCaveShuffle$$module$js$maze$cave],[132,WideCaveShuffle$$module$js$maze$cave]]);
...
17!==b&&272!==b&&4352!==b&&4097!==b||n.push(a));var t=a.screens[c.screens[q>>4][q&15]].tiles;p=0;for(let a=0;240>a;a++)if(3===t[a]){p=a;break}c.entrances[1].screen=q;c.entrances[1].tile=p+17;for(t=0;2>t;t++)c.exits[5+t].screen=q,c.exits[5+t].tile=p+t;e=b.pick(e.length?e:n);c.spawns[1].screen=e;e=c.monsterPlacer(b);for(const b of c.spawns)b.isMonster()&&(n=a.objects[b.monsterId],n instanceof Monster$$module$js$rom$monster&&(p=e(n),null==p?(console.error(`no valid location for ${hex$$module$js$rom$util(n.id)} in ${hex$$module$js$rom$util(c.id)}`),
...
0;g.length&&h<MAX_TABLE_LENGTH$$module$js$rom$messages;){e.has(g[0].str)&&(g.sort(f),e.clear());const {str:n,saving:p,missing:q,words:r,chains:t}=g.shift();if(0>=p)break;h+=n.length+3;k=a.length;l=new Set;for(const a of r){m=b[a];for(const a of[m.mid,...d.get(m.mid)||[]])l.add(a)}a.push({bytes:128>k?[k+128]:[5,k-128],mids:l,str:n});for(const a of r)for(k=0;k<=t;k++){l=b[a+k];m=l.bytes-(k?0:q);for(const a of l.suffixes)a.saving-=m-l.used,e.add(a.str);l.used=m}if(128===a.length){for(const a of c.values())a.saving-=
...
c,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(m,c,h);rescaleMonsters$$module$js$patch(m,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(m,c,h);shuffleTrades$$module$js$pass$shuffletrades(m,c,h);c.randomizeMaps()&&shuffleMazes$$module$js$pass$shufflemazes(m,h);const n=World$$module$js$graph$world.build(m,c),p=yield(new AssumedFill$$module$js$graph$shuffle(m,c)).shuffle(n.graph,h,f);if(p)n.traverse(n.graph,p),update$$module$js$rom$slots(m,p.slots);else return-1;rescaleShops$$module$js$patch(m,
...
new Set([80,83,95,105]);for(const h of SCALED_MONSTERS$$module$js$patch){const [k,{sdef:l,swrd:m,hits:n,satk:p,dgld:q,sexp:r}]=h;f=a.objects[k].data;g=e.has(k)?1:0;f[2]|=128;f[6]=n;f[7]=p;f[8]=l|m<<4;f[16]=f[16]&15|q<<4;f[17]=r;(g?b.shuffleBossElements():b.shuffleMonsterElements())&&!d.has(k)&&(f=[...a.objects[k].elements.toString(2).padStart(4,"0")],c.shuffle(f),a.objects[k].elements=Number.parseInt(f.join(""),2))}if(b.shuffleMonsterElements()){b=c.nextInt(4);a.prg[217645]=b+1;for(const c of d)a.objects[c].elements=
1<<b}}
