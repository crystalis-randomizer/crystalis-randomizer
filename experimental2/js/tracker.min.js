...
function commonNoun$$module$js$pass$fixdialog(a){switch(a){case 37:return"statue";case 40:return"instrument";case 53:return"lamp";case 59:return"pendant";case 60:return"plant";case 61:return"statue"}fail$$module$js$assert();return"item"}var module$js$pass$fixdialog={};module$js$pass$fixdialog.fixDialog=fixDialog$$module$js$pass$fixdialog;function fixReverseWalls$$module$js$pass$fixreversewalls(a){for(const b in[4,5,8,9])a.tileEffects[9].effects[b]=24,a.tileEffects[2].effects[b]=24}var module$js$pass$fixreversewalls={};module$js$pass$fixreversewalls.fixReverseWalls=fixReverseWalls$$module$js$pass$fixreversewalls;function shuffleMazes$$module$js$pass$shufflemazes(a,b){shufflePyramid$$module$js$maze$pyramid(a,b);shuffleSwamp$$module$js$maze$swamp(a,b);shuffleGoa1$$module$js$maze$goa(a,b);for(const c of SHUFFLED_CAVES$$module$js$pass$shufflemazes)shuffleCave$$module$js$maze$cave(a.locations[c],b)}
const SHUFFLED_CAVES$$module$js$pass$shufflemazes=[4,5,6,7,8,9,10,12,14,16,17,34,35,36,37,38,39,42,43,44,45,46,49,51,52,53,56,57,68,69,70,72,73,74,75,76,77,78,79,84,85,112,125,127,128,129,130,131,133,134,135,143,146,149,157,176,177,178,179];var module$js$pass$shufflemazes={};module$js$pass$shufflemazes.shuffleMazes=shuffleMazes$$module$js$pass$shufflemazes;class TileEffects$$module$js$rom$tileeffects extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.base=b<<8&8191|73728;this.effects=tuple$$module$js$rom$util(a.prg,this.base,256)}write(a){for(let b=0;256>b;b++)a.rom[this.base+b]=this.effects[b]}}TileEffects$$module$js$rom$tileeffects.PIT=1;TileEffects$$module$js$rom$tileeffects.NO_WALK=2;TileEffects$$module$js$rom$tileeffects.IMPASSIBLE=4;TileEffects$$module$js$rom$tileeffects.ALTERNATIVE=8;
