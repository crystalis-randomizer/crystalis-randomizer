...
{flag:"Di",name:"Player never dies"}]}],exclusiveFlags$$module$flagset=(a)=>a.startsWith("S")?new RegExp(`S.*[${a.substring(1)}]`):FLAG_CONFLICTS$$module$flagset[a],FLAG_CONFLICTS$$module$flagset={Hm:/Em/,Hx:/Ex/,Em:/Hm/,Ex:/Hx/,Fw:/Gw/,Gw:/Fw/,Ft:/Gt/,Gt:/Ft/,Fc:/Gc/,Gc:/Fc/,Fp:/Gp/,Gp:/Fp/,Fr:/Gr/,Gr:/Fr/};
...
"Paralysis or Asina revealed")).option(Ka).option(Qc).option(ab),Rc=(new Condition$$module$nodes(c,"Ride dolphin")).option(yb,Ic),Ne=(new Condition$$module$nodes(c,"Ghetto flight")).option(m,Rc,vb),ba=(new Condition$$module$nodes(c,"Cross sea")).option(Rc).option(B),Oe=(new Condition$$module$nodes(c,"Cross whirlpool")).option(Db).option(B).option(Ne),T=(new Condition$$module$nodes(c,"Refresh if needed")).option(Xb.value?Xb:g).option(Za),Sc=(new Condition$$module$nodes(c,"Wind magic")).option(F.value?
...
b.nextInt(2)&&(u.swap(h),q.swap(n));l.k&&!b.nextInt(3)&&r.swap(p);l=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(u=0;1E3>u;u++){e&&0===u%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));b.shuffle(m);for(var z of k)b.shuffle(z);n=k.map(()=>-1);q=l[b.nextInt(l.length)];r=[];p=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<q;a++){const [b,c]=
...
n.get(b)));if(null==q){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const z=new Map;for(var V=0;V<q.length;V++){var va=q[V];if(null!=va){var oa=n.get(b.item(va));va=m.get(oa);m.delete(oa);oa=b.location(V);z.set(oa,va);l.delete(oa)}}V=(a,b,c)=>{c=void 0===c?"":c;for(const c of l)if(u(c,a))return z.set(c,b),l.delete(c),m.delete(a),!0;g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var F of m){const [a,b]=F;if(a.isMimic()&&!V(a,b,"traps"))return!1}for(const a of m){const [b,
c]=a;if(b.needsChest()&&!V(b,c,"chest"))return!1}for(const a of m){const [b,c]=a;if(!V(b,c))return!1}for(const a of z){const [b,c]=a;b.set(...c)}const {win:H,path:Qa}=a.traverse({wanted:k,dfs:!1});if(!H)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,q));e.items=[];e.route=[];for(const b of Qa){const [c,d]=b;e.route.push(d);k=a.nodes[c];k instanceof Slot$$module$nodes&&!k.isFixed()&&(F=k.slotName,0>F.indexOf(k.vanillaItemName)&&(F+=` (normally ${k.vanillaItemName})`),
...
"Swan - Armor Shop");a(239,"Swan - Tavern");a(240,"Swan - Pawn Shop");a(241,"Swan - Dance Hall");a(242,"Shyron - Fortress");a(243,"Shyron - Training Hall");a(244,"Shyron - Hospital");a(245,"Shyron - Armor Shop");a(246,"Shyron - Tool Shop");a(247,"Shyron - Inn");a(248,"Sahara - Inn");a(249,"Sahara - Tool Shop");a(250,"Sahara - Elder House");a(251,"Sahara - Pawn Shop");return b})();var module$rom$location={};module$rom$location.Location=Location$$module$rom$location;module$rom$location.Entrance=Entrance$$module$rom$location;
module$rom$location.Exit=Exit$$module$rom$location;module$rom$location.Flag=Flag$$module$rom$location;module$rom$location.Pit=Pit$$module$rom$location;module$rom$location.Spawn=Spawn$$module$rom$location;module$rom$location.LOCATIONS=LOCATIONS$$module$rom$location;class LocationsClass$$module$rom$locations extends Array{constructor(a){super(256);this.rom=a;for(let b=0;256>b;b++)this[b]=new Location$$module$rom$location(a,b);for(const a of Object.keys(names$$module$rom$locations))this[a]=this[names$$module$rom$locations[a]]}static get [Symbol.species](){return Array}partition(a,b=(a,b)=>a===b){const c=new Set,d=[];for(let e of this){if(c.has(e)||!e.used)continue;c.add(e);const f=a(e),g=[],h=[e];for(;h.length;){const d=h.pop();g.push(d);for(const e of d.neighbors())!c.has(e)&&
b(a(e),f)&&(c.add(e),h.push(e),g.push(e))}d.push([[...g],f])}return d}}
const names$$module$rom$locations={mezameShrine:0,outsideStart:1,leaf:2,valleyOfWind:3,sealedCave1:4,sealedCave2:5,sealedCave6:6,sealedCave4:7,sealedCave5:8,sealedCave3:9,sealedCave7:10,sealedCave8:12,windmillCave:14,windmill:15,zebuCave:16,mtSabreWestTunnel1:17,cordelPlainWest:20,cordelPlainEast:21,brynmaer:24,outsideStomsHouse:25,swamp:26,amazones:27,oak:28,stomsHouse:30,mtSabreWestLower:32,mtSabreWestUpper:33,mtSabreWestTunnel2:34,mtSabreWestTunnel3:35,mtSabreWestTunnel4:36,mtSabreWestTunnel5:37,
mtSabreWestTunnel6:38,mtSabreWestTunnel7:39,mtSabreNorthMain:40,mtSabreNorthMiddle:41,mtSabreNorthTunnel2:42,mtSabreNorthTunnel3:43,mtSabreNorthTunnel4:44,mtSabreNorthTunnel5:45,mtSabreNorthTunnel6:46,mtSabreNorthPrison:47,mtSabreNorthLeftCell:48,mtSabreNorthLeftCell2:49,mtSabreNorthRightCell:50,mtSabreNorthTunnel8:51,mtSabreNorthTunnel9:52,mtSabreNorthTunnel10:53,mtSabreNorthTunnel1:56,mtSabreNorthTunnel7:57,nadareInn:60,nadareToolShop:61,nadareBackRoom:62,waterfallValleyNorth:64},namesTyped$$module$rom$locations=
names$$module$rom$locations,Locations$$module$rom$locations=LocationsClass$$module$rom$locations;var module$rom$locations={};module$rom$locations.Locations=LocationsClass$$module$rom$locations;class DataTable$$module$rom$messages extends Array{constructor(a,b,c,d,e){e=void 0===e?1<d?(...a)=>a:(a)=>a:e;super(c);this.rom=a;this.base=b;this.count=c;this.width=d;for(let f=0;f<c;f++)this[f]=e(...slice$$module$rom$util(a.prg,b+f*d,d))}}
...
4,(a)=>new Pattern$$module$rom$pattern(this,a));this.palettes=seq$$module$rom$util(256,(a)=>new Palette$$module$rom$palette(this,a));this.locations=new LocationsClass$$module$rom$locations(this);this.tileAnimations=seq$$module$rom$util(4,(a)=>new TileAnimation$$module$rom$tileanimation(this,a));this.hitboxes=seq$$module$rom$util(24,(a)=>new Hitbox$$module$rom$hitbox(this,a));this.objects=seq$$module$rom$util(256,(a)=>new ObjectData$$module$rom$objectdata(this,a));this.adHocSpawns=seq$$module$rom$util(96,
...
console.log(`Tile ${hex$$module$rom$util(a)}: ${e}`)}swapMetatiles(a,...b){var c=new Map,d=seq$$module$rom$util(256);const e=new Map,f=(a)=>Array.isArray(a)?a[0]:0>a?~a:a;for(var g of b){for(var h=0;h<g.length-1;h++)if(Array.isArray(g[h])){var k=g[h];e.set(k[0],k[1]);g[h]=k[0]}for(h=0;h<g.length-1;h++){k=g[h];const a=g[h+1];0>k||0>a||(c.set(a,k),d[a]=k)}}g=new Set;c=new Set;a=new Set(a);for(var m of this.locations)if(m.used&&a.has(m.tileset)){c.add(m.tileEffects);for(var l of m.allScreens())g.add(l)}for(var n of g)for(var p of n.tiles)for(m=
0;m<p.length;m++)p[m]=d[p[m]];for(var q of a){d=this.tilesets[(q&127)>>>2];for(var r of b)for(n=0;n<r.length-1;n++){p=f(r[n]);m=f(r[n+1]);for(l=0;4>l;l++)d.tiles[l][p]=d.tiles[l][m];d.attrs[p]=d.attrs[m];if(32>m&&d.alternates[m]!==m){if(32<=p)throw Error(`Cannot unflag: ${q} ${p} ${m} ${d.alternates[m]}`);d.alternates[p]=d.alternates[m]}}for(var u of e){const [a,b]=u;d.alternates[a]=b}}for(const a of c){q=this.tileEffects[a-179];for(const a of b)for(r=0;r<a.length-1;r++)u=f(a[r]),d=f(a[r+1]),q.effects[u]=
...
f);b.remove();a(c)});d.readAsArrayBuffer(c)})})}const EXPECTED_CRC32$$module$rom=466849842,ADJUSTMENTS$$module$rom=new Map([[85433,128],[87133,0],[91391,10],[96298,1],[96343,1],[118533,72],[119569,160],[119570,0],[118777,224],[182928,0],[193907,0],[195300,0]]);var module$rom={};module$rom.Rom=Rom$$module$rom;module$rom.EXPECTED_CRC32=EXPECTED_CRC32$$module$rom;const STATUS$$module$version="unstable",VERSION$$module$version="latest",LABEL$$module$version="latest 830f7ba",HASH$$module$version="830f7ba27e70791f200c83ae503b4a0d44438d2c",DATE$$module$version=new Date(156090731E4);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$flagset(String(b.flags)):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$patch(a,parseSeed$$module$patch(String(b.seed)),d,new FetchReader$$module$fetchreader(c))})}};
...
_RABBIT_BOOTS_CHARGE_WHILE_WALKING:c.rabbitBootsChargeWhileWalking(),_REQUIRE_HEALED_DOLPHIN_TO_RIDE:c.requireHealedDolphinToRide(),_REVERSIBLE_SWAN_GATE:!0,_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword()},k=new Assembler$$module$6502,m=(b)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){k.assemble(yield d.read(b),b);k.patchRom(a)});var l=Object.keys(h).filter((a)=>h[a]).map((a)=>`define ${a} 1\n`).join("");k.assemble(l,
"flags.s");yield m("preshuffle.s");g=new Random$$module$random(g);l=new Rom$$module$rom(a);makeBraceletsProgressive$$module$patch(l);c.blackoutMode()&&blackoutMode$$module$patch(l);closeCaveEntrances$$module$patch(l,c);reversibleSwanGate$$module$patch(l);adjustGoaFortressTriggers$$module$patch(l);preventNpcDespawns$$module$patch(l,c);c.requireHealedDolphinToRide()&&requireHealedDolphin$$module$patch(l);c.saharaRabbitsRequireTelepathy()&&requireTelepathyForDeo$$module$patch(l);adjustItemNames$$module$patch(l,
c);yield m("postparse.s");alarmFluteIsKeyItem$$module$patch(l);c.teleportOnThunderSword()?teleportOnThunderSword$$module$patch(l):noTeleportOnThunderSword$$module$patch(l);l.scalingLevels=48;l.uniqueItemTableAddress=k.expand("KeyItemData");yield shuffle2$$module$depgraph(l,g,e,c,f);rescaleShops$$module$patch(l,k,c.bargainHunting()?g:void 0);normalizeSwords$$module$patch(l,c,g);rescaleMonsters$$module$patch(l,c,g);c.shuffleMonsters()&&shuffleMonsters$$module$patch(l,c,g);identifyKeyItemsForDifficultyBuffs$$module$patch(l);
c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$patch(l);addCordelWestTriggers$$module$patch(l,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$patch(l);c.storyMode()&&storyMode$$module$patch(l);c.chargeShotsOnly()&&disableStabs$$module$patch(l);c.orbsOptional()&&orbsOptional$$module$patch(l);shuffleMusic$$module$patch(l,c,g);misc$$module$patch(l,c,g);c.buffDyna()&&buffDyna$$module$patch(l,
c);yield l.writeData();return yield postParsedShuffle$$module$patch(a,g,b,c,k,m)}),postParsedShuffle$$module$patch=(a,b,c,d,e,f)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){yield f("postshuffle.s");updateDifficultyScalingTables$$module$patch(a,d,e);updateCoinDrops$$module$patch(a,d);shuffleRandomNumbers$$module$patch(a,b);return stampVersionSeedAndHash$$module$patch(a,c,d)});
...
a.map((a)=>a[1]);b=[...new Set(b)];for(const d of a){[a]=d;{const d=b[c.nextInt(b.length)];for(const b of a)b.bgm=d}}})([...b,...e,...f])}}function buffDyna$$module$patch(a,b){a.objects[184].collisionPlane=1;a.objects[184].immobile=!0;a.objects[185].collisionPlane=1;a.objects[185].immobile=!0;a.objects[51].collisionPlane=2}
...
[];a.npcs[19].localDialogs.get(-1)[3].condition=71;a.npcs[19].localDialogs.get(-1)[3].flags=[169];a.npcs[20].spawnConditions.get(14)[1]=-563;a.npcs[20].localDialogs.get(14)[0].flags=[];a.npcs[22].localDialogs.get(87)[0].flags=[];a.npcs[136].localDialogs.get(87)[0].flags=[];a.npcs[22].spawnConditions.get(87).shift();a.npcs[136].spawnConditions.get(87).pop();var c=(a)=>{a.reverse();for(let b=0;b<a.length;b++){const c=a[b+1];a[b].condition=c?~c.condition:-1}},d=a.npcs[29].localDialogs.get(-1);d[4].flags=
[];d[0].message.action=3;d[1].message.action=3;d[2].message.action=3;d[3].message.action=3;const e=a.npcs[30].localDialogs.get(-1);(()=>{const [b,c,d,k]=e;k.condition=-70;d.condition=-552;d.flags=[];c.condition=-1;a.npcs[30].localDialogs.set(-1,[k,d,b,c])})();for(const b of[32,33,34,124,125])c(a.npcs[b].localDialogs.get(-1));c=a.npcs[31].localDialogs.get(-1);c.unshift(...c.splice(1,1));a.npcs[51].spawnConditions.set(223,[-33,-28]);a.npcs[52].localDialogs.get(-1)[1].condition=27;c=a.npcs[56];d=c.localDialogs.get(-1);
d[3].message.action=3;d[4].flags.push(156);c.spawnConditions.get(223)[1]=-28;c.spawnConditions.get(225)[0]=27;d[1].condition=27;a.npcs[57].spawnConditions.get(216)[1]=-28;a.npcs[68].spawnConditions.set(233,[-142]);a.npcs[68].spawnConditions.set(228,[141]);a.npcs[68].localDialogs.get(233)[1].flags.pop();a.npcs[84].localDialogs.get(-1)[2].flags=[];a.npcs[90].localDialogs.get(-1)[1].flags=[];a.npcs[94].localDialogs.set(16,[LocalDialog$$module$rom$npc.of(-59,[0,26],[58]),LocalDialog$$module$rom$npc.of(13,
[0,29]),LocalDialog$$module$rom$npc.of(56,[0,28]),LocalDialog$$module$rom$npc.of(577,[0,29]),LocalDialog$$module$rom$npc.of(10,[0,27,3]),LocalDialog$$module$rom$npc.of(-1,[0,29])]);a.npcs[94].spawnConditions.get(16).pop();a.npcs[95].localDialogs.get(33)[1].flags=[];a.npcs[95].spawnConditions.delete(33);a.npcs[96].spawnConditions.delete(30);c=a.npcs[98];c.data[1]=40;c.localDialogs.get(225)[0].message.action=17;c.localDialogs.get(225)[2].message.action=17;c.spawnConditions.get(225).pop();a.npcs[104].spawnConditions.set(97,
[-156,33]);a.npcs[104].localDialogs.get(-1)[0].message.action=2;a.npcs[116].localDialogs.get(98)[0].flags=[];a.npcs[126].localDialogs.get(98)[0].flags=[];a.npcs[131].localDialogs.get(-1)[0].condition=-577;a.npcs[131].localDialogs.get(-1)[0].flags=[];a.npcs[196].spawnConditions.delete(242);a.npcs[203].spawnConditions.set(166,[-654]);c=a.npcs[94].localDialogs.get(242);c.unshift(...c.splice(1,1));c[0].flags=[];a.trigger(128).conditions.push(564);a.trigger(129).conditions=[];b.barrierRequiresCalmSea()&&
a.trigger(132).conditions.push(643);a.trigger(132).flags=[];a.trigger(140).conditions.push(58);a.trigger(178).conditions[0]=-579;a.trigger(178).flags.shift();a.trigger(180).conditions[1]=-578;a.trigger(180).flags=[];a.trigger(187).conditions[1]=-28;b=a.locations[101];138===b.spawns[9].id&&b.spawns.splice(9,1)},requireHealedDolphin$$module$patch=(a)=>{a.npcs[100].spawnConditions.set(214,[566,37]);a=a.npcs[123].localDialogs.get(-1);a.unshift(a[0].clone());a[0].condition=-38;a[1].condition=-567},requireTelepathyForDeo$$module$patch=
(a)=>{a.npcs[89].globalDialogs.push(GlobalDialog$$module$rom$npc.of(-580,[26,18]));a.npcs[90].globalDialogs.push(GlobalDialog$$module$rom$npc.of(-580,[26,19]))},teleportOnThunderSword$$module$patch=(a)=>{a.itemGets[3].flags.push(765);for(const b of[0,1,3])for(const c of[242,244])a.npcs[98].localDialogs.get(c)[b].message.action=31},noTeleportOnThunderSword$$module$patch=(a)=>{a.itemGets[3].acquisitionAction.action=22},adjustItemNames$$module$patch=(a,b)=>{b.leatherBootsGiveSpeed()&&(b=a.items[47],
...
16)},storyMode$$module$patch=(a)=>{a.npcs[203].spawnConditions.set(166,[~a.npcs[194].spawnConditions.get(40)[0],~a.npcs[132].spawnConditions.get(110)[0],~a.triggers[26].conditions[1],~a.npcs[197].spawnConditions.get(169)[0],~a.npcs[198].spawnConditions.get(172)[0],~a.npcs[199].spawnConditions.get(185)[0],~a.npcs[200].spawnConditions.get(182)[0],~a.npcs[203].spawnConditions.get(159)[0],512,513,514,515])},disableStabs$$module$patch=(a)=>{for(const b of[8,9,39])a.objects[b].collisionPlane=0},orbsOptional$$module$patch=
(a)=>{for(const b of[16,20,24,29])a.objects[b].terrainSusceptibility&=-5,a.objects[b].level=2},connectLimeTreeToLeaf$$module$patch=(a)=>{const b=a.locations[3];a=a.locations[66];b.screens[5][4]=16;a.screens[1][0]=26;a.screens[2][0]=12;const c=b.entrances.push(Entrance$$module$rom$location.of({x:1263,y:1400}))-1,d=a.entrances.push(Entrance$$module$rom$location.of({x:16,y:448}))-1;b.exits.push(Exit$$module$rom$location.of({x:1264,y:1376,dest:66,entrance:d}),Exit$$module$rom$location.of({x:1264,y:1392,
dest:66,entrance:d}));a.exits.push(Exit$$module$rom$location.of({x:0,y:432,dest:3,entrance:c}),Exit$$module$rom$location.of({x:0,y:448,dest:3,entrance:c}))},stampVersionSeedAndHash$$module$patch=(a,b,c)=>{const d=crc32$$module$crc32(a),e=d.toString(16).padStart(8,"0").toUpperCase(),f="unstable"===STATUS$$module$version?HASH$$module$version.substring(0,7).padStart(7,"0").toUpperCase()+"     ":VERSION$$module$version.substring(0,12).padEnd(12," "),g=b.toString(16).padStart(8,"0").toUpperCase();b=(b,
c)=>{for(let d=0;d<c.length;d++)a[b+16+d]=c.charCodeAt(d)};const h=(a,b)=>{const c=[];for(let d=0;d<a.length||d<b.length;d++)c.push(a[d]||" "),c.push(b[d]||" ");return c.join("")};b(161743,h("  VERSION     SEED      ",`  ${f}${g}`));c=String(c);let k;if(46<c.length){if(92<c.length)throw Error("Flag string way too long!");k=c.substring(46,92).padEnd(46," ");c=c.substring(0,46)}c=c.padEnd(46," ");b(161791,h(c.substring(0,23),c.substring(23)));k&&b(161839,h(k.substring(0,23),k.substring(23)));b(161925,
h(e.substring(0,4),e.substring(4)));b(153366,"RANDOMIZER");"unstable"===STATUS$$module$version&&b(153404,"BETA");return d},patchBytes$$module$patch=(a,b,c)=>{for(let d=0;d<c.length;d++)a[b+d]=c[d]},patchWords$$module$patch=(a,b,c)=>{for(let d=0;d<2*c.length;d+=2)a[b+d]=c[d>>>1]&255,a[b+d+1]=c[d>>>1]>>>8},updateCoinDrops$$module$patch=(a,b)=>{a=a.subarray(16);b.disableShopGlitch()?patchWords$$module$patch(a,216030,[0,5,10,15,25,40,65,105,170,275,445,600,700,800,900,1E3]):patchWords$$module$patch(a,
216030,[0,1,2,4,8,16,30,50,100,200,300,400,500,600,700,800])},updateDifficultyScalingTables$$module$patch=(a,b,c)=>{a=a.subarray(16);const d=seq$$module$rom$util(48,(a)=>a);patchBytes$$module$patch(a,c.expand("DiffAtk"),d.map((a)=>Math.round(40+15*a/4)));patchBytes$$module$patch(a,c.expand("DiffDef"),d.map((a)=>4*a));const e=b.decreaseEnemyDamage()?16:48,f=b.decreaseEnemyDamage()?6:5.5;patchBytes$$module$patch(a,c.expand("DiffHP"),d.map((a)=>Math.min(255,e+Math.round(a*f))));const g=b.expScalingFactor();
patchBytes$$module$patch(a,c.expand("DiffExp"),d.map((a)=>{a=Math.floor(4*Math.pow(2,(16+9*a)/32)*g);return 128>a?a:Math.min(255,128+(a>>4))}));patchBytes$$module$patch(a,216E3,[0,2,6,10,14,18,32,24,20,0,2,6,10,14,18,16,32,20])},rescaleShops$$module$patch=(a,b,c)=>{a.shopCount=11;a.shopDataTablesAddress=b.expand("ShopData");writeLittleEndian$$module$rom$util(a.prg,b.expand("InnBasePrice"),20);for(const b of a.shops)if(b.type!==module$rom$shop.ShopType.PAWN)for(let a=0,d=b.prices.length;a<d;a++)b.prices[a]=
128>b.contents[a]?c?c.nextNormal(1,.3,.5,1.5):1:b.type!==module$rom$shop.ShopType.INN?0:c?c.nextNormal(1,.5,.375,1.625):1;c=seq$$module$rom$util(48,(a)=>a);patchBytes$$module$patch(a.prg,b.expand("ToolShopScaling"),c.map((a)=>Math.round(8*Math.pow(2,a/10))));patchBytes$$module$patch(a.prg,b.expand("ArmorShopScaling"),c.map((a)=>Math.round(8*Math.pow(2,(47-a)/12))));for(b=13;39>b;b++)a.items[b].basePrice=BASE_PRICES$$module$patch[b]},BASE_PRICES$$module$patch={13:4,14:16,15:50,16:325,17:1E3,18:2E3,
19:4E3,21:6,22:20,23:75,24:250,25:1E3,26:4800,29:25,30:30,31:45,32:40,33:36,34:200,35:150,36:80,38:300};function normalizeSwords$$module$patch(a,b,c){a.objects[16].atk=3;a.objects[17].atk=6;a.objects[18].atk=8;a.objects[24].atk=3;a.objects[19].atk=5;a.objects[25].atk=5;a.objects[23].atk=7;a.objects[26].atk=7;a.objects[20].atk=3;a.objects[21].atk=6;a.objects[22].atk=8;a.objects[28].atk=3;a.objects[30].atk=5;a.objects[27].atk=7;a.objects[31].atk=7}
