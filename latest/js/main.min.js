...
f);b.remove();a(c)});d.readAsArrayBuffer(c)})})}const EXPECTED_CRC32$$module$rom=466849842,ADJUSTMENTS$$module$rom=new Map([[118533,72],[119569,160],[119570,0],[118777,224],[182928,0],[193907,0],[195300,0]]);var module$rom={};module$rom.Rom=Rom$$module$rom;module$rom.EXPECTED_CRC32=EXPECTED_CRC32$$module$rom;const STATUS$$module$version="unstable",VERSION$$module$version="latest",LABEL$$module$version="latest f6a045a",HASH$$module$version="f6a045aff4fc75904c48ae1836f237764afd8b17",DATE$$module$version=new Date(1558471056E3);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$flagset(String(b.flags)):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$patch(a,parseSeed$$module$patch(String(b.seed)),d,new FetchReader$$module$fetchreader(c))})}};
...
36:80,38:300},rescaleMonsters$$module$patch=(a,b,c)=>{var d=new Set(Object.keys(a.objects).map(Number));for(var e of SCALED_MONSTERS$$module$patch){var [f]=e;d.delete(f)}for(var g of SCALED_MONSTERS$$module$patch){const [b,c]=g;for(const e of d)a.objects[b].base===a.objects[e].base&&(SCALED_MONSTERS$$module$patch.set(e,c),d.delete(b))}a.objects[125].elements|=8;e=new Set([87,94,104,125,136,151,155,158]);d=new Set([80,83,95,105]);for(const h of SCALED_MONSTERS$$module$patch){const [k,{sdef:l,swrd:m,
hits:n,satk:p,dgld:q,sexp:r}]=h;f=a.objects[k].data;g=e.has(k)?1:0;f[2]|=128;f[6]=n;f[7]=p;f[8]=l|m<<4;f[9]=f[9]&224|g;f[16]=f[16]&15|q<<4;f[17]=r;(g?b.shuffleBossElements():b.shuffleMonsterElements())&&!d.has(k)&&(f=[...a.objects[k].elements.toString(2).padStart(4,"0")],c.shuffle(f),a.objects[k].elements=Number.parseInt(f.join(""),2))}if(b.shuffleMonsterElements()){b=c.nextInt(4);a.prg[152109]=b+1;for(const c of d)a.objects[c].elements=1<<b}},shuffleMonsters$$module$patch=(a,b,c)=>{b=new MonsterPool$$module$patch(b,
