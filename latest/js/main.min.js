...
Ma=d(11,"Ball of Thunder").bossDrop("Mado 1",5).trigger(154,1).key(),Na=d(12,"Storm Bracelet").chest().key();d(13,"Carapace Shield").armor();d(14,"Bronze Shield").armor();d(15,"Platinum Shield").armor();d(16,"Mirrored Shield").armor();d(17,"Ceramic Shield").armor();const Jd=d(18,"Sacred Shield").armor().bossDrop("Mado 2",8).npcSpawn(199).bonus();d(19,"Battle Shield").armor();const Kd=d(20,"Psycho Shield").armor();d(21,"Tanned Hide").armor();d(22,"Leather Armor").armor();d(23,"Bronze Armor").armor();
d(24,"Platinmum Armor").armor();d(25,"Soldier Suit").armor();d(26,"Ceramic Suit").armor();const Ld=d(27,"Battle Suit").armor(),Md=d(28,"Psycho Armor").armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),W=d(29,"Medical Herb").consumable(),Oa=d(30,"Antidote").consumable(),ib=d(31,"Lysis Plant").consumable(),Nd=d(32,"Fruit of Lime").consumable(),Ba=d(33,"Fruit of Power").consumable(),X=d(34,"Magic Ring").consumable(),Pb=d(35,"Fruit of Repun").consumable().bossDrop("Sabera 2",
7).npcSpawn(198).key(),jb=d(36,"Warp Boots").consumable(),Qb=d(37,"Statue of Onyx").chest("Cordel grass").invisible(254882).key(),kb=d(38,"Opel Statue").consumable().bossDrop("Kelbesque 2",6).npcSpawn(197).key(),Rb=d(39,"Insect Flute").fromPerson("Oak mother",30).dialog(30,null,1).key(),Ca=d(40,"Flute of Lime").fromPerson("Portoa queen",56).direct(39161).dialog(56,null,4).dialog(56,null,5,0).key(),lb=d(41,"Gas Mask").direct("Akahana in Brynmaer",251902).npcSpawn(22,24).key(),Od=d(42,"Power Ring").chest().bonus(),
Pd=d(43,"Warrior Ring").fromPerson("Akahana's friend",84).dialog(84,null,2).bonus(),Qd=d(44,"Iron Necklace").chest().bonus(),Rd=d(45,"Deo's Pendant").fromPerson("Deo",90).dialog(90,null,0).bonus(),Sb=d(46,"Rabbit Boots").bossDrop("Vampire 1",0).npcSpawn(192).key(),Tb=d(47,f("Ts",!0)?"Speed Boots":"Leather Boots").chest().bonus(),Ub=d(48,"Shield Ring").direct("Akahana in waterfall cave",250543).npcSpawn(22,87,2).bonus(),mb=d(49,"Alarm Flute").consumable().fixed(),Vb=d(50,"Windmill Key").fromPerson("Windmill guard",
20).dialog(20,14,0).npcSpawn(20,14,1).key(),Wb=d(51,"Key to Prison").chest().key(),Xb=d(52,"Key to Styx").fromPerson("Zebu in Shyron",94,1).trigger(128,2).dialog(94,242,0).dialog(98,242,0).key(),Yb=d(53,"Fog Lamp").chest().key(),nb=d(54,"Shell Flute").fromPerson("Dolphin",99,1).npcSpawn(99).key(),Zb=d(55,"Eye Glasses").fromPerson("Clark",68).dialog(68,233,1).key(),$b=d(56,"Broken Statue").bossDrop("Sabera 1",4).npcSpawn(127,101).npcSpawn(70).npcSpawn(71).npcSpawn(106).npcSpawn(132).npcSpawn(142).dialog(61).dialog(62).dialog(63).dialog(64).dialog(65).dialog(66).dialog(67).dialog(68,
233).trigger(182).key(),ac=d(57,"Glowing Lamp").direct("Kensu in lighthouse",250638).npcSpawn(126,98,1).key(),bc=d(59,"Love Pendant").chest("Underground channel").invisible(254890).key(),cc=d(60,"Kirisa Plant").chest("Kirisa meadow").invisible(254886).key(),ob=d(61,"Ivory Statue").bossDrop("Karmine",9).npcSpawn(200).key(),dc=d(62,"Bow of Moon").fromPerson("Aryllis",35).direct(251624).dialog(35,null,1).key(),ec=d(63,"Bow of Sun").chest().key(),fc=d(64,"Bow of Truth").fromPerson("Azteca",131).npcSpawn(131,
156,1).dialog(131,null,0).key(),pb=(new Magic$$module$nodes(a,65,"Refresh",65,null)).fromPerson("Zebu at windmill",94).direct(251665).dialog(94,16,3).trigger(180,1),Pa=(new Magic$$module$nodes(a,66,"Paralysis",66,null)).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),Y=(new Magic$$module$nodes(a,67,"Telepathy",67,null)).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),gc=(new Magic$$module$nodes(a,68,"Teleport",68,null)).fromPerson("Tornel on Mt. Sabre",
95).dialog(95,33,0),Sd=(new Magic$$module$nodes(a,69,"Recover",69,null)).direct("Asina in Portoa",250361),hc=(new Magic$$module$nodes(a,70,"Barrier",70,null)).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),na=(new Magic$$module$nodes(a,71,"Change",71,null)).direct("Kensu in Swan",251614).npcSpawn(116,241,1),A=(new Magic$$module$nodes(a,72,"Flight",72,null)).weight(15).direct("Kensu in Draygonia Fortress",250255),Qa=d(40,"Flute of Lime").chest(void 0,91).key(),Td=Ba.bossDrop("Vampire 2",
12,97).npcSpawn(204).key(),G=d(112,"Mimic"),ic=(new Trigger$$module$nodes(a,"Talked to Leaf Elder")).get(Q),jc=new Trigger$$module$nodes(a,"Talked to Leaf Student"),kc=(new Trigger$$module$nodes(a,"Buy alarm flute")).get(mb),qb=new Trigger$$module$nodes(a,"Talked to Zebu in cave"),Ud=(new Trigger$$module$nodes(a,"Woke up Windmill Guard")).get(Vb),Ra=new Trigger$$module$nodes(a,"Started Windmill"),lc=(new Trigger$$module$nodes(a,"Learned Refresh")).get(pb),Vd=(new Trigger$$module$nodes(a,"Gave Statue to Akahana")).get(lb),
Wd=(new Trigger$$module$nodes(a,"Fought Stom")).get(Y),mc=new Trigger$$module$nodes(a,"Visited Oak"),nc=new Trigger$$module$nodes(a,"Talked to Oak Mother"),rb=new Trigger$$module$nodes(a,"Rescued Oak Child"),Xd=(new Trigger$$module$nodes(a,"Talked to Oak Mother Again")).get(Rb),Yd=(new Trigger$$module$nodes(a,"Talked to Oak Elder")).get(R),Zd=(new Trigger$$module$nodes(a,"Talked to Tornel on Mt Sabre")).get(gc),oc=new Trigger$$module$nodes(a,"Villagers Abducted"),pc=new Trigger$$module$nodes(a,"Talked to Rabbit in Leaf"),
$d=(new Trigger$$module$nodes(a,"Learned Paralysis")).get(Pa),qc=new Trigger$$module$nodes(a,"Talked to Portoa Queen"),rc=new Trigger$$module$nodes(a,"Talked to Fortune Teller"),sc=new Trigger$$module$nodes(a,"Visited Underground Channel"),ae=(new Trigger$$module$nodes(a,"Sent to Waterfall Cave")).get(Ca),be=(new Trigger$$module$nodes(a,"Cured Akahana")).get(Ub),tc=(new Trigger$$module$nodes(a,"Talked to Rage")).get(Aa),uc=new Trigger$$module$nodes(a,"Mesia recording played"),ce=(new Trigger$$module$nodes(a,
"Talked to Asina")).get(Sd),vc=(new Trigger$$module$nodes(a,"Healed Dolphin")).get(nb),sb=new Trigger$$module$nodes(a,"Returned Fog Lamp"),wc=new Trigger$$module$nodes(a,"Talked to Kensu in Cabin"),xc=new Trigger$$module$nodes(a,"Talked to Joel Elder"),de=(new Trigger$$module$nodes(a,"Talked to Clark")).get(Zb),ee=(new Trigger$$module$nodes(a,"Talked to Kensu in Lighthouse")).get(ac),tb=new Trigger$$module$nodes(a,"Calmed the Angry Sea"),fe=(new Trigger$$module$nodes(a,"Learned Barrier")).get(hc),
yc=new Trigger$$module$nodes(a,"Talked to Stom in Swan Hut"),zc=new Trigger$$module$nodes(a,"Talked to Kensu in Swan tavern"),Ac=new Trigger$$module$nodes(a,"Talked to Kensu at Swan dance"),ge=(new Trigger$$module$nodes(a,"Returned Kensu's love pendant")).get(na),he=(new Trigger$$module$nodes(a,"Talked to Amazones Queen")).get(dc),ub=new Trigger$$module$nodes(a,"Entered Shyron"),ie=(new Trigger$$module$nodes(a,"Talked to Zebu in Shyron")).get(Xb),Bc=new Trigger$$module$nodes(a,"Shyron Massacre"),
je=(new Trigger$$module$nodes(a,"Saved Kensu")).get(A),ke=(new Trigger$$module$nodes(a,"Talked to Deo")).get(Rd),le=(new Trigger$$module$nodes(a,"Talked to Akahana's Friend")).get(Pd),me=(new Trigger$$module$nodes(a,"Get Bow of Truth")).get(fc),ne=(new Trigger$$module$nodes(a,"Forged Crystalis")).get(hb),Sa=(new Condition$$module$nodes(a,"Sword charge glitch")).option(Id),oe=(new Condition$$module$nodes(a,"Rabbit skip")).option(p),pe=(new Condition$$module$nodes(a,"Teleport skip")).option(l),vb=(new Condition$$module$nodes(a,
"Statue glitch")).option(t),qe=(new Condition$$module$nodes(a,"Ghetto flight")).option(n),re=(new Condition$$module$nodes(a,"Wild warp")).option(Gd,Hd),Ta=(new Condition$$module$nodes(a,"Any level 2 sword")).option(Q,Ia).option(Q,za).option(R,Ja).option(R,Ka).option(L,Aa).option(L,La).option(I,Ma).option(I,Na),v=(new Condition$$module$nodes(a,"Destroy stone")).option(Q,Ia).option(Q,za).option(Sa,Q,Ta),w=(new Condition$$module$nodes(a,"Destroy ice")).option(R,Ja).option(R,Ka).option(Sa,R,Ta),q=(new Condition$$module$nodes(a,
"Cross rivers")).option(L,Aa).option(L,La).option(A).option(Sa,L,Ta),oa=(new Condition$$module$nodes(a,"Destroy iron")).option(I,Ma).option(I,Na).option(Sa,I,Ta),Z=(new Condition$$module$nodes(a,"Any sword")).option(Q).option(R).option(L).option(I),se=(new Condition$$module$nodes(a,"Match insect sword (fire/water/thunder)")).option(R).option(L).option(I).option(lb,D.value?D:h,Q),te=(new Condition$$module$nodes(a,"Speed boots")).option(Tb,r),Cc=(new Condition$$module$nodes(a,"Climb slopes")).option(Sb).option(A).option(te),
ue=(new Condition$$module$nodes(a,"Enter Mt Sabre North (rabbit)")).option(pc).option(oe),ve=(new Condition$$module$nodes(a,"Enter Mt Sabre North (Teleport)")).option(gc).option(pe,A),Dc=(new Condition$$module$nodes(a,"Asina in her room")).option(uc),we=(new Condition$$module$nodes(a,"Paralysis or Ball of Water")).option(Pa).option(Dc).option(vb),xe=(new Condition$$module$nodes(a,"Ride dolphin")).option(nb,wc),S=(new Condition$$module$nodes(a,"Cross sea")).option(xe).option(A),ye=(new Condition$$module$nodes(a,
"Cross whirlpool")).option(tb).option(A).option(qe),J=(new Condition$$module$nodes(a,"Refresh if needed")).option(Ob.value?Ob:h).option(pb),Ec=(new Condition$$module$nodes(a,"Wind magic")).option(y.value?y:h,J).option(Ia,za,J),Fc=(new Condition$$module$nodes(a,"Fire magic")).option(y.value?y:h,J).option(Ja,Ka,J),Gc=(new Condition$$module$nodes(a,"Water magic")).option(y.value?y:h,J).option(y,J).option(Aa,La,J),ze=(new Condition$$module$nodes(a,"Thunder magic")).option(y.value?y:h,J).option(y,J).option(Ma,
J).option(Na,J),Ae=(new Condition$$module$nodes(a,"Flute of lime or glitch")).option(Ca).option(vb).option(Qa.value?Qa:g),Be=(new Condition$$module$nodes(a,"Second flute of lime")).option(Qa).option(Ca.value?Ca:g),Hc=(new Condition$$module$nodes(a,"Change or glitch")).option(na).option(vb),wb=(new Condition$$module$nodes(a,"Pass shooting statues")).option(hc).option(Nb.value?Nb:h).option(pb,Ub),Ce=(new Condition$$module$nodes(a,"Healed dolphin if required")).option(vc).option(gb),Ic=(new Condition$$module$nodes(a,
"Match sword of wind")).option(Q).option(D.value?D:h,Z),Jc=(new Condition$$module$nodes(a,"Match sword of fire")).option(R).option(D.value?D:h,Z),Kc=(new Condition$$module$nodes(a,"Match sword of water")).option(L).option(D.value?D:h,Z),De=(new Condition$$module$nodes(a,"Match sword of thunder")).option(I).option(D.value?D:h,Z),Ua=(new Condition$$module$nodes(a,"Travel swamp")).option(lb).option(Ha.value?Ha:h),Ee=(new Condition$$module$nodes(a,"Calmed sea if required")).option(tb).option(Dd),Fe=e(0,
"Vampire 1",Z).get(Sb),Ge=e(1,"Insect",Rb,se).get(Ja),He=e(2,"Kelbesque 1",Ic,Ec).get(Ka),Ie=e(12,"Vampire 2",Z).get(Td),Lc=e(4,"Sabera 1",Jc,Fc).get($b),Je=e(5,"Mado 1",Kc,Gc).get(Ma),Ke=e(6,"Kelbesque 2",Ic,Ec).get(kb),Le=e(7,"Sabera 2",Jc,Fc).get(Pb),Me=e(8,"Mado 2",Kc,Gc).get(Jd),Ne=e(9,"Karmine",De,ze).get(ob),Oe=e(10,"Draygon 1",Z).get(Md),Pe=e(null,"Statues",ec,dc),Qe=e(11,"Draygon 2",Z,fc),Re=e(13,"Dyna",hb),M=new Area$$module$nodes(a,"Leaf"),pa=new Area$$module$nodes(a,"Valley of Wind"),
...
sa=new Area$$module$nodes(a,"Draygonia Fortress 3"),H=new Area$$module$nodes(a,"Draygonia Fortress 4"),E=new Area$$module$nodes(a,"Oasis Cave");new Area$$module$nodes(a,"Desert");const P=new Area$$module$nodes(a,"Sahara"),ta=new Area$$module$nodes(a,"Pyramid Front"),T=new Area$$module$nodes(a,"Pyramid Back"),U=new Area$$module$nodes(a,"Tower"),xb=(new Location$$module$nodes(a,0,M,"Start")).overworld().start(),Se=(new Location$$module$nodes(a,0,M,"Mezame Shrine")).overworld().from(xb),Te=(new Location$$module$nodes(a,
1,M,"Outside Start")).overworld().connect(Se),ha=(new Location$$module$nodes(a,2,M,"Town")).town().connect(Te),Ea=(new Location$$module$nodes(a,3,pa,"Main")).overworld().connect(ha).trigger(lc,Ra),Mc=(new Location$$module$nodes(a,3,pa,"Outside Windmill")).overworld(),Nc=(new Location$$module$nodes(a,4,K,"Tunnel 1 (entrance)")).cave().from(Ea,Ra),Ue=(new Location$$module$nodes(a,5,K,"Tunnel 2 (over bridge)")).cave().connect(Nc),Ve=(new Location$$module$nodes(a,6,K,"Tunnel 6 (herb dead end)")).cave().chest(W,
15),Oc=(new Location$$module$nodes(a,7,K,"Tunnel 4a (ball corridor)")).cave().chest(W,20,80).chest(Ia,21);(new Location$$module$nodes(a,7,K,"Tunnel 4b (antidote dead end)")).cave().connect(Oc,v).chest(Oa,19);const We=(new Location$$module$nodes(a,8,K,"Tunnel 5 (warp boots dead end)")).cave().chest(jb,14),Xe=(new Location$$module$nodes(a,9,K,"Tunnel 3a (branch, front)")).cave().connect(Ue).connectTo(Oc).connectTo(We),Ye=(new Location$$module$nodes(a,9,K,"Tunnel 3b (branch, back)")).cave().connect(Xe,
v).connectTo(Ve),Ze=(new Location$$module$nodes(a,10,K,"Tunnel 7 (boss)")).cave().connect(Ye).boss(Fe),$e=(new Location$$module$nodes(a,12,K,"Tunnel 8a (exit, above wall)")).cave().connect(Ze),af=(new Location$$module$nodes(a,12,K,"Tunnel 8b (exit, below wall")).cave().connect($e,v);(new Location$$module$nodes(a,14,pa,"Windmill Cave")).cave().connect(Ea).connectTo(Mc).trigger(Ud,mb,qb);(new Location$$module$nodes(a,15,pa,"Windmill")).misc().connect(Mc).trigger(Ra,Vb);const bf=(new Location$$module$nodes(a,
16,pa,"Zebu's Cave Front")).cave().connect(Ea).trigger(qb,ic,jc).trigger(lc,Ra,qb),cf=(new Location$$module$nodes(a,16,pa,"Zebu's Cave Back")).cave().trigger(oc).connect(bf,w),df=(new Location$$module$nodes(a,17,B,"Tunnel 1 (to Zebu)")).cave().connect(cf),ua=(new Location$$module$nodes(a,20,ia,"West")).overworld().connect(af),ef=(new Location$$module$nodes(a,20,ia,"South")).overworld().connect(ua,q),Pc=(new Location$$module$nodes(a,21,ia,"East")).overworld().connect(ua).chest(Qb,24),Fa=(new Location$$module$nodes(a,
24,qa,"Town")).town().connect(ua).trigger(Vd,Qb),ff=(new Location$$module$nodes(a,25,ia,"Outside Stom's House")).town().connect(ua),yb=(new Location$$module$nodes(a,26,ia,"Swamp")).overworld().connect(Pc,Ua).trigger(rb,nc,Ua);(new Location$$module$nodes(a,26,ia,"Swamp Insect Area")).overworld().connect(yb,Ua).boss(Ge);const Xa=(new Location$$module$nodes(a,27,ra,"Town")).town().connect(ef),Ya=(new Location$$module$nodes(a,28,Da,"Town")).town().connect(yb,Ua).trigger(mc);(new Location$$module$nodes(a,
30,ia,"Stom's House")).house().connect(ff).trigger(Wd,mc);const va=(new Location$$module$nodes(a,32,B,"Entrance")).overworld().connect(ua).connect(df),gf=(new Location$$module$nodes(a,32,B,"Up Slope")).overworld().from(va,Cc).to(va),hf=(new Location$$module$nodes(a,32,B,"Dead End (warp boots)")).overworld().chest(jb,24,106),Qc=(new Location$$module$nodes(a,33,B,"Upper")).overworld().from(va,A).to(va),jf=(new Location$$module$nodes(a,33,B,"Tornel Dead End")).overworld().trigger(Zd,za).chest(X,23,105),
Rc=(new Location$$module$nodes(a,34,B,"Tunnel 2a (fork at start)")).cave().connect(va);(new Location$$module$nodes(a,34,B,"Tunnel 2b (left branch to dead end)")).cave().connect(Rc,w).connectTo(hf);const kf=(new Location$$module$nodes(a,34,B,"Tunnel 2c (right branch to upper)")).cave().connect(Rc,w),lf=(new Location$$module$nodes(a,35,B,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(kf).chest(W,23,82),mf=(new Location$$module$nodes(a,35,B,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(lf,
w).connectTo(Qc),Sc=(new Location$$module$nodes(a,36,B,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(mf);(new Location$$module$nodes(a,36,B,"Tunnel 4b (out to upper)")).cave().connect(Sc,w).connectTo(Qc);const nf=(new Location$$module$nodes(a,37,B,"Tunnel 5 (tiny connector)")).cave().connect(Sc),of=(new Location$$module$nodes(a,38,B,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(nf);(new Location$$module$nodes(a,38,B,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(of,
w).connectTo(jf);const pf=(new Location$$module$nodes(a,39,B,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(gf),qf=(new Location$$module$nodes(a,39,B,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(pf,w);(new Location$$module$nodes(a,39,B,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(qf,w).chest(za,25);const Za=(new Location$$module$nodes(a,40,u,"Entrance")).overworld().connect(Pc,ve,ue),$a=(new Location$$module$nodes(a,40,u,"Upper")).overworld().from(Za,A).to(Za),zb=(new Location$$module$nodes(a,
40,u,"Summit (boss)")).overworld().from($a,A).to($a).boss(He),Tc=(new Location$$module$nodes(a,41,u,"Connector")).overworld(),Ab=(new Location$$module$nodes(a,41,u,"Middle Left")).overworld(),rf=(new Location$$module$nodes(a,41,u,"Middle Right")).overworld().from(Ab,Cc).to(Ab),Uc=(new Location$$module$nodes(a,42,u,"Tunnel 2a (from entrance to connector)")).cave().connectTo(Tc);(new Location$$module$nodes(a,42,u,"Tunnel 2b (under bridge, to antidote)")).cave().connect(Uc,w).chest(Oa,23,94);const Vc=
(new Location$$module$nodes(a,43,u,"Tunnel 3a (branch after connector)")).cave().connect(Tc),sf=(new Location$$module$nodes(a,43,u,"Tunnel 3b (right branch)")).cave().connect(Vc,w),tf=(new Location$$module$nodes(a,43,u,"Tunnel 3c (upper branch)")).cave().connect(Vc,w);(new Location$$module$nodes(a,44,u,"Tunnel 4 (over bridge, to middle)")).cave().connect(tf).connectTo(Ab);const Wc=(new Location$$module$nodes(a,45,u,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(sf).connectTo(rf);(new Location$$module$nodes(a,
45,u,"Tunnel 5b (dead-end with herb)")).cave().connect(Wc,w).chest(W,22,83);const uf=(new Location$$module$nodes(a,46,u,"Tunne; 6a (S-shaped hall, right)")).cave().connect(Wc),vf=(new Location$$module$nodes(a,46,u,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(uf,w),wf=(new Location$$module$nodes(a,46,u,"Tunnel 6c (S-shaped hall, left)")).cave().connect(vf,w),Xc=(new Location$$module$nodes(a,47,u,"Prison (hallway)")).cave().connect($a),xf=(new Location$$module$nodes(a,48,u,"Left Cell (shopkeepers)")).cave().from(Xc,
w);(new Location$$module$nodes(a,49,u,"Left Cell 2 (back, with prison key)")).cave().from(xf,w).chest(Wb,13);const yf=(new Location$$module$nodes(a,50,u,"Right Cell (villagers)")).cave().from(Xc,w),zf=(new Location$$module$nodes(a,51,u,"Tunnel 8 (behind right cell, toward summit)")).cave().from(yf,w);(new Location$$module$nodes(a,52,u,"Tunnel 9 (connector to summit)")).cave().connect(zf).connectTo(zb);const Af=(new Location$$module$nodes(a,53,u,"Tunnel 10a (summit cave, front)")).cave().from(zb,Wb).to(zb),
Bf=(new Location$$module$nodes(a,53,u,"Tunnel 10b (summit cave, behind ice)")).cave().connect(Af,w).trigger($d);(new Location$$module$nodes(a,56,u,"Tunnel 1 (leads from main entrance)")).cave().connect(Za).connectTo(Uc);(new Location$$module$nodes(a,57,u,"Tunnel 7 (to upper)")).cave().connect(wf).connectTo($a);const Cf=(new Location$$module$nodes(a,60,Va,"Inn")).town(),Df=(new Location$$module$nodes(a,61,Va,"Tool Shop")).house(),Ef=(new Location$$module$nodes(a,62,Va,"Back Room")).house(),Bb=(new Location$$module$nodes(a,
64,aa,"Summit")).overworld().connect(Bf),ab=(new Location$$module$nodes(a,64,aa,"Northwest")).overworld().from(Bb).to(Bb,A),Ff=(new Location$$module$nodes(a,64,aa,"Northeast")).overworld().connect(ab,q),Yc=(new Location$$module$nodes(a,65,aa,"Southwest")).overworld().connect(ab),Gf=(new Location$$module$nodes(a,65,aa,"Southeast")).overworld().connect(Yc,q),Zc=(new Location$$module$nodes(a,66,aa,"Lime Tree Valley")).overworld().connect(Yc).connect(Ea,Fd),Hf=(new Location$$module$nodes(a,67,aa,"Lime Tree Lake (Rage)")).cave().connect(Zc).trigger(tc,
L),If=(new Location$$module$nodes(a,68,ca,"Tunnel 1a (entrance)")).cave().connect(Gf),Jf=(new Location$$module$nodes(a,68,ca,"Tunnel 1b (behind wall)")).cave().connect(If,v),$c=(new Location$$module$nodes(a,69,ca,"Tunnel 2a (main path, before wall)")).cave().connect(Jf);(new Location$$module$nodes(a,69,ca,"Tunnel 2b (dead end, antidote)")).cave().connect($c,v).chest(Oa,25,95);const Kf=(new Location$$module$nodes(a,69,ca,"Tunnel 2c (main path, after wall)")).cave().connect($c,v),Lf=(new Location$$module$nodes(a,
70,ca,"Tunnel 3a (last room, before wall)")).cave().connect(Kf),Mf=(new Location$$module$nodes(a,70,ca,"Tunnel 3b (last room, after wall)")).cave().connect(Lf,v);(new Location$$module$nodes(a,71,ca,"Meadow")).overworld().connect(Mf).chest(cc,14);const Nf=(new Location$$module$nodes(a,72,C,"Tunnel 1a (entrance)")).cave().connect(Ff),ad=(new Location$$module$nodes(a,72,C,"Tunnel 1b (past wall)")).cave().connect(Nf,v);(new Location$$module$nodes(a,72,C,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(ad,
v).chest(ib,24);const Of=(new Location$$module$nodes(a,73,C,"Tunnel 2 (tiny connector)")).cave().connect(ad),bd=(new Location$$module$nodes(a,74,C,"Tunnel 3a (upper branch)")).cave().connect(Of);(new Location$$module$nodes(a,74,C,"Tunnel 3b (dead end, mimic)")).cave().connect(bd,v).chest(G,21,112);const cd=(new Location$$module$nodes(a,74,C,"Tunnel 3c (short passage with mimic)")).cave().connect(bd,v).chest(G,22,113),Pf=(new Location$$module$nodes(a,74,C,"Tunnel 3d (lower branch)")).cave().connect(cd,
v);(new Location$$module$nodes(a,75,C,"Tunnel 4 (dead end loop)")).cave().connect(Pf);const dd=(new Location$$module$nodes(a,76,C,"Tunnel 5a (right branch over bridge)")).cave().connect(cd),Qf=(new Location$$module$nodes(a,76,C,"Tunnel 5b (past wall over bridge)")).cave().connect(dd,v),Rf=(new Location$$module$nodes(a,77,C,"Tunnel 6a (from left branch)")).cave().connect(dd),Sf=(new Location$$module$nodes(a,77,C,"Tunnel 6b (reconvergence)")).cave().connect(Rf,v).connect(Qf),Tf=(new Location$$module$nodes(a,
...
19);const ma=(new Location$$module$nodes(a,80,z,"Town")).town().connect(ab),ed=(new Location$$module$nodes(a,81,z,"Fishherman Island")).town().connect(ma);(new Location$$module$nodes(a,82,aa,"Mesia Shrine")).cave().trigger(uc).connect(Hf,q,tc);const fd=(new Location$$module$nodes(a,84,ba,"Tunnel 1a (entrance)")).cave().connect(ab);(new Location$$module$nodes(a,84,ba,"Tunnel 1b (dead end, mimic)")).cave().connect(fd,w).chest(G,19,114);const Yf=(new Location$$module$nodes(a,84,ba,"Tunnel 1c (past ice)")).cave().connect(fd,
w),gd=(new Location$$module$nodes(a,85,ba,"Tunnel 2 (stoned pair)")).cave().connect(Yf),Cb=(new Location$$module$nodes(a,86,ba,"Tunnel 3 (wide medusa hallways)")).cave().from(gd,Ae).to(gd,Ca),Zf=(new Location$$module$nodes(a,87,ba,"Tunnel 4a (left entrance)")).cave().from(Cb,w).chest(Qa,25).trigger(be,Be);(new Location$$module$nodes(a,87,ba,"Tunnel 4b (right entrance)")).cave().from(Cb,w).connect(Zf,A);(new Location$$module$nodes(a,87,ba,"Tunnel 4c (sword of water)")).cave().connect(Cb,w).chest(L,
24);const hd=(new Location$$module$nodes(a,88,U,"Entrance")).misc(),$f=(new Location$$module$nodes(a,89,U,"Level 1")).misc().from(hd),ag=(new Location$$module$nodes(a,90,U,"Level 2")).misc().from($f),bg=(new Location$$module$nodes(a,91,U,"Level 3")).misc().from(ag),id=(new Location$$module$nodes(a,92,U,"Outside Mesia Room")).misc().from(bg),cg=(new Location$$module$nodes(a,93,U,"Outside Dyna Room")).misc().from(id,hb);(new Location$$module$nodes(a,94,U,"Mesia")).misc().connect(id).trigger(ne);const dg=
(new Location$$module$nodes(a,95,U,"Dyna")).misc().from(cg).boss(Re);(new Location$$module$nodes(a,95,U,"Win")).misc().from(dg).end();const Db=(new Location$$module$nodes(a,96,ja,"Cabin Beach")).sea().from(ed,sb),wa=(new Location$$module$nodes(a,96,ja,"South")).sea().connect(Db,S),eg=(new Location$$module$nodes(a,96,ja,"Joel Beach")).sea().connect(wa,S),jd=(new Location$$module$nodes(a,96,da,"Outside Lighthouse")).sea();(new Location$$module$nodes(a,96,ja,"Altar")).sea().connect(wa,S).trigger(tb,
ac,$b);const fg=(new Location$$module$nodes(a,96,ja,"North")).sea().to(wa,S).from(wa,S,ye).trigger(fe,Ee),gg=(new Location$$module$nodes(a,96,ja,"Swan Beach")).sea().connect(fg,S);(new Location$$module$nodes(a,97,ja,"Cabin")).misc().connect(Db).trigger(wc,sb);(new Location$$module$nodes(a,98,da,"Lighthouse")).misc().connect(jd).trigger(ee,mb);const bb=(new Location$$module$nodes(a,100,z,"Underground Channel 1 (from throne room)")).sea().trigger(sc),hg=(new Location$$module$nodes(a,100,z,"Underground Channel 2 (to fortune teller)")).sea().connect(bb,
q),kd=(new Location$$module$nodes(a,100,z,"Underground Channel 3 (from fortune teller)")).sea().connect(bb,A),ld=(new Location$$module$nodes(a,100,z,"Underground Channel 4 (asina)")).sea().connect(kd,q),ig=(new Location$$module$nodes(a,100,z,"Underground Channel 5 (dolphin)")).sea().connect(ld,q).trigger(vc,W,Aa);(new Location$$module$nodes(a,100,z,"Underground Channel 6 (water)")).sea().connect(ig,S).connectTo(wa,S).chest(bc,17);const Eb=(new Location$$module$nodes(a,101,F,"Zombie Town")).town(),
jg=(new Location$$module$nodes(a,104,F,"Tunnel 1 (entrance)")).sea().connect(wa,xc,S),md=(new Location$$module$nodes(a,105,F,"Tunnel 2a (start)")).cave().connect(jg);(new Location$$module$nodes(a,105,F,"Tunnel 2b (dead end to left)")).cave().connect(md,q);const kg=(new Location$$module$nodes(a,105,F,"Tunnel 2c (across first river)")).cave().connect(md,q),nd=(new Location$$module$nodes(a,105,F,"Tunnel 2d (across second river)")).cave().connect(kg,q);(new Location$$module$nodes(a,105,F,"Tunnel 2e (dead end, magic ring)")).cave().connect(nd,
v).chest(X,29);const lg=(new Location$$module$nodes(a,105,F,"Tunnel 2f (stair down)")).cave().connect(nd,v),mg=(new Location$$module$nodes(a,106,F,"Tunnel 3a (main area)")).cave().connect(lg).connectTo(Eb).chest(ib,25,92),ng=(new Location$$module$nodes(a,106,F,"Tunnel 3b (left area toward items)")).cave().connect(mg,v),og=(new Location$$module$nodes(a,107,F,"Tunnel 4a (right side, mimic)")).cave().connect(ng).chest(G,14,115);(new Location$$module$nodes(a,107,F,"Tunnel 4b (left side, iron necklace)")).cave().connect(og,
q).chest(Qd,15);const Fb=(new Location$$module$nodes(a,108,ea,"Floor 1")).fortress().connect(Eb),pg=(new Location$$module$nodes(a,108,ea,"Miniboss")).fortress().boss(Ie).connect(Fb);(new Location$$module$nodes(a,109,ea,"Floor 2a (left stair)")).fortress().connect(Fb).chest(Ba,19);const qg=(new Location$$module$nodes(a,109,ea,"Floor 2b (right stair)")).fortress().connect(pg).chest(W,30,85),rg=(new Location$$module$nodes(a,110,ea,"Floor 3a (toward boss)")).fortress().connect(qg),od=(new Location$$module$nodes(a,
110,ea,"Floor 3b (boss room)")).fortress().connect(rg);(new Location$$module$nodes(a,110,ea,"Boss")).fortress().boss(Lc).connect(od);(new Location$$module$nodes(a,110,ea,"Floor 3c (back room trap)")).fortress().from(od).to(Fb);const sg=(new Location$$module$nodes(a,112,da,"Secret Passage")).cave().connectTo(jd),cb=(new Location$$module$nodes(a,113,da,"Town")).town().connect(eg),V=(new Location$$module$nodes(a,114,N,"Town")).town().connect(gg),tg=(new Location$$module$nodes(a,115,N,"Inside Gate")).overworld().connect(V),
ug=(new Location$$module$nodes(a,115,N,"Outside Gate")).overworld().from(tg,na),db=(new Location$$module$nodes(a,120,la,"Valley")).overworld().connect(ug),Gb=(new Location$$module$nodes(a,124,x,"Entrance")).overworld().connect(db),vg=(new Location$$module$nodes(a,124,x,"Over first river toward Shyron")).overworld().connect(Gb,q),pd=(new Location$$module$nodes(a,124,x,"After first tunnel")).overworld(),qd=(new Location$$module$nodes(a,124,x,"Door to Styx")).overworld().connect(pd,q),wg=(new Location$$module$nodes(a,
124,x,"Dead end (no item)")).overworld(),xg=(new Location$$module$nodes(a,124,x,"Dead end (fruit of lime)")).overworld().chest(Nd,26),yg=(new Location$$module$nodes(a,124,x,"Dead end (magic ring)")).overworld().chest(X,25,101),rd=(new Location$$module$nodes(a,124,x,"Outside tunnel to bow")).overworld();(new Location$$module$nodes(a,124,x,"Floating island (bow of sun)")).overworld().connect(rd,A).chest(ec,24);const zg=(new Location$$module$nodes(a,125,x,"Tunnel 1 (to Shyron)")).cave().connect(vg),
Ag=(new Location$$module$nodes(a,126,x,"Outside Shyron")).overworld().connect(zg);(new Location$$module$nodes(a,127,x,"Tunnel 2 (fork)")).cave().connect(Gb).connectTo(xg).connectTo(pd);const sd=(new Location$$module$nodes(a,128,x,"Tunnel 3 (caves)")).cave().connect(qd).connect(wg),td=(new Location$$module$nodes(a,129,x,"Tunnel 4 (left branch of cave)")).cave().connect(sd);(new Location$$module$nodes(a,130,x,"Tunnel 5 (dead end, medical herb)")).cave().connect(td).chest(W,15,86);const Bg=(new Location$$module$nodes(a,
131,x,"Tunnel 6a (left-then-right)")).cave().connect(td),Cg=(new Location$$module$nodes(a,131,x,"Tunnel 6b (past wall)")).cave().connect(Bg,v),Dg=(new Location$$module$nodes(a,132,x,"Tunnel 7 (wide hall)")).cave().connect(Cg);(new Location$$module$nodes(a,133,x,"Tunnel 8 (red slimes)")).cave().from(Dg,v).connectTo(rd).chest(G,23,116);const Eg=(new Location$$module$nodes(a,134,x,"Tunnel 9 (right branch, infinite loop)")).cave().connect(sd),Fg=(new Location$$module$nodes(a,135,x,"Tunnel 10a (toward magic ring)")).cave().connect(Eg);
(new Location$$module$nodes(a,135,x,"Tunnel 10b (past wall)")).cave().connect(Fg,v).connectTo(yg);const ud=(new Location$$module$nodes(a,136,ka,"Entrance")).fortress().from(qd,Xb,wb),Gg=(new Location$$module$nodes(a,137,ka,"Left branch")).fortress().connect(ud).chest(G,19,117),Hg=(new Location$$module$nodes(a,137,ka,"Left branch, past one bridge")).fortress().connect(Gg,q),Ig=(new Location$$module$nodes(a,137,ka,"Left branch, past two bridges")).fortress().connect(Hg,q).chest(W,29,87),Jg=(new Location$$module$nodes(a,
137,ka,"Right branch")).fortress().connect(ud);(new Location$$module$nodes(a,137,ka,"Right branch, across water")).fortress().connect(Jg,A).chest(G,20,118).chest(G,21,119).chest(Kd,28);(new Location$$module$nodes(a,138,ka,"Upper floor")).fortress().connect(Ig).chest(I,27);const xa=(new Location$$module$nodes(a,140,fa,"Town")).town().connect(Ag,Hc).trigger(ub),Ga=(new Location$$module$nodes(a,142,la,"Town")).town().connect(db),vd=(new Location$$module$nodes(a,143,E,"Draygonia Fortress Basement 1 (front)")).fortress();
(new Location$$module$nodes(a,143,E,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(vd,oa).chest(Od,15);const Hb=(new Location$$module$nodes(a,144,la,"Desert 1")).overworld().connect(db),eb=(new Location$$module$nodes(a,145,E,"Area 1 (from entrance)")).cave().chest(Tb,26),wd=(new Location$$module$nodes(a,145,E,"Area 2 (across top bridge)")).cave().connect(eb,q);(new Location$$module$nodes(a,145,E,"Area 3 (dead-end across top-right bridge)")).cave().connect(wd,q);const Kg=(new Location$$module$nodes(a,
145,E,"Area 4 (left across middle-right bridge)")).cave().connect(wd,q),Lg=(new Location$$module$nodes(a,145,E,"Area 5 (bottom edge)")).cave().connect(Kg,q),Mg=(new Location$$module$nodes(a,145,E,"Area 6 (bottom island)")).cave().connect(Lg,q),Ng=(new Location$$module$nodes(a,145,E,"Area 7 (bottom inner ring)")).cave().connect(Mg,q),Og=(new Location$$module$nodes(a,145,E,"Area 8 (left outer ring)")).cave().connect(Ng,q).connect(eb,q).chest(Ba,27,100),Pg=(new Location$$module$nodes(a,145,E,"Area 9 (top left inner ring)")).cave().connect(Og,
q),Qg=(new Location$$module$nodes(a,145,E,"Area 10 (top right inner ring)")).cave().connect(Pg,q);(new Location$$module$nodes(a,145,E,"Area 11 (center)")).cave().connect(Qg,q).connectTo(vd);(new Location$$module$nodes(a,145,E,"Area 12 (top center islands)")).cave().connect(eb,A).chest(Ld,28);const Rg=(new Location$$module$nodes(a,146,P,"Desert Cave 1")).cave().connect(Hb,A),ya=(new Location$$module$nodes(a,147,P,"Town")).town(),Sg=(new Location$$module$nodes(a,148,P,"Outside Cave")).overworld().connect(ya),
Tg=(new Location$$module$nodes(a,149,P,"Desert Cave 2")).cave().connect(Sg);(new Location$$module$nodes(a,150,P,"Meadow")).overworld().connect(Rg).connectTo(ya).trigger(ke,na,Y);const Ib=(new Location$$module$nodes(a,152,P,"Desert 2")).overworld().connect(Tg),Ug=(new Location$$module$nodes(a,156,ta,"Entrance")).fortress().connect(Ib,A),Vg=(new Location$$module$nodes(a,156,ta,"Azteca")).fortress().trigger(me),Wg=(new Location$$module$nodes(a,157,ta,"Fork")).fortress().connect(Ug),xd=(new Location$$module$nodes(a,
158,ta,"Main")).fortress().connect(Wg);(new Location$$module$nodes(a,158,ta,"Treasure Chest (magic ring)")).fortress().connect(xd).chest(X,27,108);(new Location$$module$nodes(a,159,ta,"Draygon")).fortress().connect(xd).to(Vg).boss(Oe);const Xg=(new Location$$module$nodes(a,160,T,"Entrance")).fortress().connect(Ib,A),Yg=(new Location$$module$nodes(a,160,T,"Statues")).fortress().connect(Xg).boss(Pe),Zg=(new Location$$module$nodes(a,161,T,"Hall 1")).fortress().connect(Yg),Jb=(new Location$$module$nodes(a,
162,T,"Branch")).fortress().connect(Zg);(new Location$$module$nodes(a,163,T,"Left Dead End")).fortress().connect(Jb).chest(G,13,120);(new Location$$module$nodes(a,164,T,"Right Dead End")).fortress().connect(Jb);const $g=(new Location$$module$nodes(a,165,T,"Hall 2")).fortress().connect(Jb).chest(kb,26,109),ah=(new Location$$module$nodes(a,166,T,"Draygon 2")).fortress().connect($g).boss(Qe);(new Location$$module$nodes(a,167,T,"Teleporter")).fortress().from(ah).to(hd);const yd=(new Location$$module$nodes(a,
168,Wa,"Entrance")).fortress().connect(Ga,wb).trigger(Bc,I),bh=(new Location$$module$nodes(a,169,Wa,"Main")).fortress().from(yd,oa),ch=(new Location$$module$nodes(a,169,Wa,"Boss")).fortress().connect(bh).boss(Ke),dh=(new Location$$module$nodes(a,170,Wa,"Zebu")).fortress().connect(ch),fb=(new Location$$module$nodes(a,171,O,"Entrance")).fortress().connect(dh);(new Location$$module$nodes(a,171,O,"Dead End Behind Iron (fruit of power)")).fortress().connect(fb,oa).chest(Ba,28,98);(new Location$$module$nodes(a,
171,O,"Dead End Loop Across Closer Bridges")).fortress().connect(fb,q).connect(fb,q);const eh=(new Location$$module$nodes(a,171,O,"Across First Bridge (fruit of repun)")).fortress().connect(fb,q).chest(Pb,30,102),Kb=(new Location$$module$nodes(a,171,O,"Across Second Bridge")).fortress().connect(eh,q);(new Location$$module$nodes(a,171,O,"Dead End Across Two Bridges ()")).fortress().connect(Kb,q).connect(Kb,q).chest(ib,29,93);const fh=(new Location$$module$nodes(a,171,O,"Across Third Bridge")).fortress().connect(Kb,
q),gh=(new Location$$module$nodes(a,171,O,"Exit Behind Iron Door")).fortress().connect(fh,oa),hh=(new Location$$module$nodes(a,172,O,"Boss")).fortress().connect(gh).boss(Le),ih=(new Location$$module$nodes(a,172,O,"Tornel")).fortress().connect(hh),zd=(new Location$$module$nodes(a,173,sa,"Lower")).fortress().connect(ih).chest(kb,26,99).chest(X,27,111),jh=(new Location$$module$nodes(a,174,sa,"Upper Loop")).fortress().connect(zd).chest(Oa,22,96);(new Location$$module$nodes(a,174,sa,"Upper Loop Behind Wall (magic ring)")).fortress().connect(jh,
oa).chest(X,23,107);const kh=(new Location$$module$nodes(a,175,sa,"Upper Passage (toward Mado)")).fortress().connect(zd).chest(X,27,84),Lb=(new Location$$module$nodes(a,176,H,"Initial Fork")).fortress(),lh=(new Location$$module$nodes(a,177,H,"Left Branch")).fortress().connect(Lb),Ad=(new Location$$module$nodes(a,178,H,"Main Area (right branch, over bridges)")).fortress().connect(Lb),mh=(new Location$$module$nodes(a,179,H,"U-shaped Passage (between floors)")).fortress().connect(Ad),nh=(new Location$$module$nodes(a,
180,H,"Main Area Lower (under bridge)")).fortress().connect(lh).connect(Ad).connect(mh),Bd=(new Location$$module$nodes(a,180,H,"Behind Iron Wall")).fortress().connect(nh,oa),oh=(new Location$$module$nodes(a,181,H,"Lower")).fortress().connect(Bd).chest(G,13,121).chest(G,14,122).chest(G,15,123).chest(X,23,88).chest(jb,24,110),ph=(new Location$$module$nodes(a,182,H,"Boss Corridor")).fortress().connect(oh),qh=(new Location$$module$nodes(a,182,H,"Boss")).fortress().connect(ph,wb).boss(Ne);(new Location$$module$nodes(a,
182,H,"Behind Boss (stormBracelet)")).fortress().connect(qh).chest(Na,18);const Cd=(new Location$$module$nodes(a,183,H,"Exit Stairs")).fortress(),rh=(new Location$$module$nodes(a,184,E,"Entrance Back (behind river)")).cave().connect(Cd).chest(Ba,13,90);(new Location$$module$nodes(a,184,E,"Entrance Front")).cave().connect(rh,A).connectTo(Hb).connectTo(eb);const sh=(new Location$$module$nodes(a,185,sa,"Boss")).fortress().connect(kh).boss(Me);(new Location$$module$nodes(a,185,sa,"Asina")).fortress().connect(sh).connectTo(Lb);
(new Location$$module$nodes(a,186,H,"Kensu")).fortress().connect(Bd).connectTo(Cd).trigger(je,ob);(new Location$$module$nodes(a,187,la,"House")).house().connect(Ga).trigger(le,na,ob);(new Location$$module$nodes(a,188,la,"Inn")).shop().connect(Ga,ub);(new Location$$module$nodes(a,190,la,"Tool Shop")).shop().connect(Ga,ub);(new Location$$module$nodes(a,191,la,"Tavern")).shop().connect(Ga);(new Location$$module$nodes(a,192,M,"Elder House")).house().connect(ha).trigger(ic);(new Location$$module$nodes(a,
...
200,qa,"Inn")).shop().connect(Fa);(new Location$$module$nodes(a,201,qa,"Armor Shop")).shop().connect(Fa);(new Location$$module$nodes(a,203,qa,"Tool Shop")).shop().connect(Fa);(new Location$$module$nodes(a,205,Da,"Elder House")).house().from(Ya,Y).trigger(Yd,rb);(new Location$$module$nodes(a,206,Da,"Mother's House")).house().from(Ya,Y).trigger(nc,Y).trigger(Xd,rb);(new Location$$module$nodes(a,207,Da,"Tool Shop")).shop().from(Ya,Y);(new Location$$module$nodes(a,208,Da,"Inn")).shop().from(Ya,Y);(new Location$$module$nodes(a,
209,ra,"Inn")).shop().connect(Xa);(new Location$$module$nodes(a,210,ra,"Tool Shop")).shop().connect(Xa);(new Location$$module$nodes(a,211,ra,"Armor Shop")).shop().connect(Xa);const th=(new Location$$module$nodes(a,212,ra,"Queen's House")).house().from(Xa,Hc).trigger(he,na,cc);(new Location$$module$nodes(a,213,Va,"Nadare's")).house().connect(Za).connectTo(Cf).connectTo(Df).connectTo(Ef);(new Location$$module$nodes(a,214,z,"Fisherman's House")).house().connect(ed).trigger(sb,Yb,nb,Ce);const Mb=(new Location$$module$nodes(a,
215,z,"Palace Entrance")).house().connect(ma);(new Location$$module$nodes(a,216,z,"Fortune Teller Front")).house().connect(ma).trigger(rc,qc);(new Location$$module$nodes(a,216,z,"Fortune Teller Back")).house().connect(hg).connect(kd);(new Location$$module$nodes(a,217,z,"Pawn Shop")).shop().connect(ma);(new Location$$module$nodes(a,218,z,"Armor Shop")).shop().connect(ma);(new Location$$module$nodes(a,220,z,"Inn")).shop().connect(ma);(new Location$$module$nodes(a,221,z,"Tool Shop")).shop().connect(ma);
(new Location$$module$nodes(a,222,z,"Palace Left")).house().connect(Mb);(new Location$$module$nodes(a,223,z,"Palace Throne Room")).house().connect(Mb).to(bb,we).from(bb).trigger(qc).trigger(ae,rc,sc);(new Location$$module$nodes(a,224,z,"Palace Right")).house().connect(Mb);(new Location$$module$nodes(a,225,z,"Asina's Room")).house().connect(ld).trigger(ce,Dc);(new Location$$module$nodes(a,226,ra,"Queen Downstairs")).house().connect(th).chest(La,13);(new Location$$module$nodes(a,227,da,"Elder's House")).house().connect(cb).trigger(xc);
(new Location$$module$nodes(a,228,da,"Shed")).house().connect(cb).to(sg,Zb);(new Location$$module$nodes(a,229,da,"Tool Shop")).shop().connect(cb).trigger(kc);(new Location$$module$nodes(a,231,da,"Inn")).shop().connect(cb);const uh=(new Location$$module$nodes(a,232,F,"Zombie Town House")).house().connect(Eb);(new Location$$module$nodes(a,233,F,"Zombie Town Basement")).house().connect(uh).trigger(de,Lc);(new Location$$module$nodes(a,235,N,"Tool Shop")).shop().connect(V);(new Location$$module$nodes(a,
236,N,"Stom's Hut")).house().connect(V).trigger(yc);(new Location$$module$nodes(a,237,N,"Inn")).shop().connect(V);(new Location$$module$nodes(a,238,N,"Armor Shop")).shop().connect(V);(new Location$$module$nodes(a,239,N,"Tavern")).house().connect(V).trigger(zc,yc,Pa);(new Location$$module$nodes(a,240,N,"Pawn Shop")).shop().connect(V);(new Location$$module$nodes(a,241,N,"Dance Hall")).house().connect(V).trigger(Ac,zc,Pa).trigger(ge,Ac,bc);const vh=(new Location$$module$nodes(a,242,fa,"Temple (pre-massacre)")).fortress().connect(xa).from(xb,
I,Ed).trigger(ie);(new Location$$module$nodes(a,242,fa,"Temple (post-massacre)")).fortress().from(vh,Bc).boss(Je);(new Location$$module$nodes(a,243,fa,"Training Hall")).house().connect(xa);(new Location$$module$nodes(a,244,fa,"Hospital")).house().connect(xa);(new Location$$module$nodes(a,245,fa,"Armor Shop")).shop().connect(xa);(new Location$$module$nodes(a,246,fa,"Tool Shop")).shop().connect(xa);(new Location$$module$nodes(a,247,fa,"Inn")).shop().connect(xa);(new Location$$module$nodes(a,248,P,"Inn")).shop().connect(ya);
(new Location$$module$nodes(a,249,P,"Tool Shop")).shop().connect(ya);(new Location$$module$nodes(a,250,P,"Elder's House")).house().connect(ya);(new Location$$module$nodes(a,251,P,"Pawn Shop")).house().connect(ya);const wh=[ha,Ea,Nc,ua,yb,va,Bb,Zc,Db,V,db,Gb,Hb,yd,Ib];for(const a of wh)a.from(xb,re);return a},shuffle$$module$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$depgraph(d);f.nodes.filter((a)=>a instanceof Slot$$module$nodes);d||(d=
...
class FillStrategy$$module$nodes{shuffleSlots(b,a,c){}static shuffleSlots(b,a,c){c.shuffle(a)}shuffleItems(b,a){}static shuffleItems(b,a){const c=[];for(let a=0;a<b.length;a++){const {shufflePriority:d=1}=b[a];for(let b=0;b<d;b++)c.push(a)}a.shuffle(c);return c}}var module$nodes={};module$nodes.TrackerNode=TrackerNode$$module$nodes;module$nodes.Option=Option$$module$nodes;module$nodes.Slot=Slot$$module$nodes;module$nodes.BossDrop=BossDrop$$module$nodes;module$nodes.Chest=Chest$$module$nodes;
module$nodes.ItemGet=ItemGet$$module$nodes;module$nodes.Item=Item$$module$nodes;module$nodes.Magic=Magic$$module$nodes;module$nodes.Trigger=Trigger$$module$nodes;module$nodes.Condition=Condition$$module$nodes;module$nodes.Boss=Boss$$module$nodes;module$nodes.Area=Area$$module$nodes;module$nodes.Connection=Connection$$module$nodes;module$nodes.Location=Location$$module$nodes;module$nodes.WorldGraph=WorldGraph$$module$nodes;module$nodes.LocationList=LocationList$$module$nodes;
...
RNMX$$module$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$random={};module$random.Random=Random$$module$random;const STATUS$$module$version="unstable",VERSION$$module$version="latest",LABEL$$module$version="latest 5c06dc5",HASH$$module$version="5c06dc59043a6b88c6df19a8eaeec35c588c0079",DATE$$module$version=new Date(1551868277E3);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c;a.seed||(a.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+a.seed);c=a.flags?new FlagSet$$module$flagset(a.flags):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$patch(b,parseSeed$$module$patch(a.seed),c)})}};
