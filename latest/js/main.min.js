...
RNMX$$module$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$random={};module$random.Random=Random$$module$random;const STATUS$$module$version="unstable",VERSION$$module$version="latest",LABEL$$module$version="latest 43abd8c",HASH$$module$version="43abd8ce0c4969cec3d61b5d886132cd7f06df5c",DATE$$module$version=new Date(1552784202E3);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c;a.seed||(a.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+a.seed);c=a.flags?new FlagSet$$module$flagset(a.flags):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$patch(b,parseSeed$$module$patch(a.seed),c)})}};
...
allowTeleportOutOfTower$$module$patch.apply(b);c.check("Td")&&buffDeosPendant$$module$patch.apply(b);c.check("Rl")&&barrierRequiresCalmSea$$module$patch.apply(b);c.check("Fs")&&fixShopGlitch$$module$patch.apply(b);preventSoftlockFromZeroHpOrMp$$module$patch.apply(b);scaleDifficultyLib$$module$patch.apply(b);nerfArmors$$module$patch.apply(b);fixVampire$$module$patch.apply(b);displayDifficulty$$module$patch.apply(b);itemLib$$module$patch.apply(b);c.check("Em")?buffMedicalHerb3x$$module$patch.apply(b):
c.check("Hm")||buffMedicalHerb2x$$module$patch.apply(b);c.check("Rt")?asinaTeleportsToMezameShrine$$module$patch.apply(b):noTeleportOnThunderSword$$module$patch.apply(b);c.check("Ts")&&leatherBootsForSpeed$$module$patch.apply(b);c.check("Di")&&neverDie$$module$patch.apply(b);c.check("Ta")&&autoEquipBracelet$$module$patch.apply(b);c.check("Tw")&&nerfWildWarp$$module$patch.apply(b);return stampVersionSeedAndHash$$module$patch(b,a,c)}),stampVersionSeedAndHash$$module$patch=(b,a,c)=>{const d=crc32$$module$crc32(b),
e=d.toString(16).padStart(8,0).toUpperCase(),f="unstable"==STATUS$$module$version?HASH$$module$version.substring(0,7).padStart(7,0).toUpperCase()+"     ":VERSION$$module$version.substring(0,12).padEnd(12," ");a=a.toString(16).padStart(8,0).toUpperCase();const g=(a,c)=>{for(let d=0;d<c.length;d++)b[a+16+d]=c.charCodeAt(d)},k=(a,b)=>{const c=[];for(let d=0;d<a.length||d<b.length;d++)c.push(a[d]||" "),c.push(b[d]||" ");return c.join("")};g(161743,k("  VERSION     SEED      ",`  ${f}${a}`));a=String(c);
let h;if(46<a.length){if(92<a.length)throw Error("Flag string way too long!");h=a.substring(46,92).padEnd(46," ");a=a.substring(0,46)}a=a.padEnd(46," ");g(161791,k(a.substring(0,23),a.substring(23)));h&&g(161839,k(h.substring(0,23),h.substring(23)));g(161925,k(e.substring(0,4),e.substring(4)));g(153366,"RANDOMIZER");"unstable"==STATUS$$module$version&&g(153404,"BETA");return d},watchForFlag0$$module$patch=buildRomPatch$$module$6502(assemble$$module$6502("\n.bank $3c000 $c000:$4000\n\n;;;; TODO - REMOVE THIS ONCE IT'S SOLVED\n.org $3cb62 ; main game mode jump 08\n  jsr CheckFlag0\n.org $3fe80\nReadControllersWithDirections:\n.org $3d347\nInitiateDialog:\n\n.org $3fdd0 ; !!! - note itemLib (I think) uses this space, too\nCheckFlag0:\n  lda $6480\n  lsr\n  bcc +\n   asl\n   sta $6480\n   lda #$00\n   sta $20\n   sta $21\n   ldx #$0c\n-   lda $6140,x\n    eor #$ff\n    sta $6140,x\n    dex\n   bpl -\n   jsr InitiateDialog\n+ jmp ReadControllersWithDirections\n\n",
...
module$patch.fixShopGlitch=fixShopGlitch$$module$patch;module$patch.preventSoftlockFromZeroHpOrMp=preventSoftlockFromZeroHpOrMp$$module$patch;module$patch.openSwanFromEitherSide=openSwanFromEitherSide$$module$patch;module$patch.connectLeafToLimeTree=connectLeafToLimeTree$$module$patch;module$patch.rearrangeTriggersAndNpcs=rearrangeTriggersAndNpcs$$module$patch;module$patch.fixOpelStatue=fixOpelStatue$$module$patch;module$patch.requireHealedDolphinToRide=requireHealedDolphinToRide$$module$patch;
module$patch.buffDeosPendant=buffDeosPendant$$module$patch;module$patch.allowTeleportOutOfTower=allowTeleportOutOfTower$$module$patch;module$patch.preventNpcDespawns=preventNpcDespawns$$module$patch;module$patch.barrierRequiresCalmSea=barrierRequiresCalmSea$$module$patch;module$patch.noTeleportOnThunderSword=noTeleportOnThunderSword$$module$patch;module$patch.asinaTeleportsToMezameShrine=asinaTeleportsToMezameShrine$$module$patch;module$patch.saharaBunniesRequireTelepathy=saharaBunniesRequireTelepathy$$module$patch;
module$patch.fixShaking=fixShaking$$module$patch;module$patch.displayDifficulty=displayDifficulty$$module$patch;module$patch.buffMedicalHerb3x=buffMedicalHerb3x$$module$patch;module$patch.buffMedicalHerb2x=buffMedicalHerb2x$$module$patch;module$patch.removeWildWarp=removeWildWarp$$module$patch;module$patch.nerfWildWarp=nerfWildWarp$$module$patch;module$patch.preventSwordClobber=preventSwordClobber$$module$patch;module$patch.upgradeBallsToBracelets=upgradeBallsToBracelets$$module$patch;
module$patch.neverDie=neverDie$$module$patch;module$patch.fixVampire=fixVampire$$module$patch;module$patch.itemLib=itemLib$$module$patch;module$patch.quickChangeItems=quickChangeItems$$module$patch;module$patch.leatherBootsForSpeed=leatherBootsForSpeed$$module$patch;module$patch.autoEquipBracelet=autoEquipBracelet$$module$patch;module$patch.scaleDifficultyLib=scaleDifficultyLib$$module$patch;class ProgressTracker$$module$progress{constructor(){this.completed=this.tasks=0}addTasks(b){this.tasks+=b}addCompleted(b){this.completed+=b}value(){return this.tasks&&this.completed/this.tasks}}var module$progress={};module$progress.ProgressTracker=ProgressTracker$$module$progress;let flags$$module$main,seed$$module$main,rom$$module$main,romName$$module$main,race$$module$main=!1;
