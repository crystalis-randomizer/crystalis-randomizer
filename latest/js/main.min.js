...
f);b.remove();a(c)});d.readAsArrayBuffer(c)})})}const EXPECTED_CRC32$$module$rom=466849842,ADJUSTMENTS$$module$rom=new Map([[85433,128],[87133,0],[91391,10],[96298,1],[96343,1],[118533,72],[119569,160],[119570,0],[118777,224],[182928,0],[193907,0],[195300,0]]);var module$rom={};module$rom.Rom=Rom$$module$rom;module$rom.EXPECTED_CRC32=EXPECTED_CRC32$$module$rom;const STATUS$$module$version="unstable",VERSION$$module$version="latest",LABEL$$module$version="latest f46b6b3",HASH$$module$version="f46b6b3f36fa2b2be95a05cca5c6fbf32aea0e7d",DATE$$module$version=new Date(1558828332E3);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$flagset(String(b.flags)):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$patch(a,parseSeed$$module$patch(String(b.seed)),d,new FetchReader$$module$fetchreader(c))})}};
...
2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$patch(m);addCordelWestTriggers$$module$patch(m,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$patch(m);c.storyMode()&&storyMode$$module$patch(m);c.chargeShotsOnly()&&disableStabs$$module$patch(m);c.orbsOptional()&&orbsOptional$$module$patch(m);shuffleMusic$$module$patch(m,c,g);misc$$module$patch(m,c,g);yield m.writeData();return yield postParsedShuffle$$module$patch(a,g,b,c,
k,l)}),postParsedShuffle$$module$patch=(a,b,c,d,e,f)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){yield f("postshuffle.s");updateDifficultyScalingTables$$module$patch(a,d,e);updateCoinDrops$$module$patch(a,d);shuffleRandomNumbers$$module$patch(a,b);return stampVersionSeedAndHash$$module$patch(a,c,d)});
...
function shuffleMusic$$module$patch(a,b,c){class d{constructor(a){this.addr=a}get bgm(){return a.prg[this.addr]}set bgm(b){a.prg[this.addr]=b}partition(){return[[this],this.bgm]}}var e=a.locations.partition((a)=>95!==a.id?a.bgm:0).filter((a)=>a[1]);b=[];const f=[],g=[124088,124560,125339,126129,126479,126851,127367,127761,228400].map((a)=>(new d(a)).partition());for(const a of e){e=0;for(const b of a[0])for(const a of b.spawns)a.isMonster()&&e++;(e>=a[0].length?f:b).push(a)}(function(a){var b=a.map((a)=>
a[1]);b=[...new Set(b)];for(const d of a){[a]=d;{const d=b[c.nextInt(b.length)];for(const b of a)b.bgm=d}}})([...b,...f,...g])}function makeBraceletsProgressive$$module$patch(a){a=a.npcs[95];var b=a.localDialogs.get(33);b=[b[0],b[2],b[2],b[1]];b[1].condition=-519;b[2].condition=-518;b[3].condition=-1;a.localDialogs.set(33,b)}
