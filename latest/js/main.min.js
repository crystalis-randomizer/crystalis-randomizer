...
Lc=(new Condition$$module$nodes(a,"Match sword of wind")).option(Q).option(D.value?D:h,S),Mc=(new Condition$$module$nodes(a,"Match sword of fire")).option(R).option(D.value?D:h,S),Nc=(new Condition$$module$nodes(a,"Match sword of water")).option(L).option(D.value?D:h,S),Ee=(new Condition$$module$nodes(a,"Match sword of thunder")).option(I).option(D.value?D:h,S),Fe=(new Condition$$module$nodes(a,"Swamp run possible")).option(S).option(Dc).option(Md).option(Qa);(new Condition$$module$nodes(a,"Insect possible to kill")).option(Pa);
const Wa=(new Condition$$module$nodes(a,"Travel swamp")).option(Pa).option(Ga.value?Ga:h,Fe),Ge=(new Condition$$module$nodes(a,"Calmed sea if required")).option(ub).option(Gd),He=e(0,"Vampire 1",S).get(nb),Ie=e(1,"Insect",Sb,ue).get(Ia),Je=e(2,"Kelbesque 1",Lc,Hc).get(Ja),Ke=e(12,"Vampire 2",S).get(Xd),Oc=e(4,"Sabera 1",Mc,Ic).get($b),Le=e(5,"Mado 1",Nc,Jc).get(Ma),Me=e(6,"Kelbesque 2",Lc,Hc).get(mb),Ne=e(7,"Sabera 2",Mc,Ic).get(Qb),Oe=e(8,"Mado 2",Nc,Jc).get(Nd),Pe=e(9,"Karmine",Ee,Ae).get(qb),Qe=
e(10,"Draygon 1",S).get(Qd),Re=e(null,"Statues",ec,dc),Se=e(11,"Draygon 2",S,fc),Te=e(13,"Dyna",jb),M=new Area$$module$nodes(a,"Leaf"),pa=new Area$$module$nodes(a,"Valley of Wind"),K=new Area$$module$nodes(a,"Sealed Cave"),ia=new Area$$module$nodes(a,"Cordel Plain"),qa=new Area$$module$nodes(a,"Brynmaer"),ra=new Area$$module$nodes(a,"Amazones"),B=new Area$$module$nodes(a,"Mt Sabre West"),u=new Area$$module$nodes(a,"Mt Sabre North"),Xa=new Area$$module$nodes(a,"Nadare's"),Ca=new Area$$module$nodes(a,
...
"Tower"),yb=(new Location$$module$nodes(a,0,M,"Start")).overworld().start(),Ue=(new Location$$module$nodes(a,0,M,"Mezame Shrine")).overworld().from(yb),Ve=(new Location$$module$nodes(a,1,M,"Outside Start")).overworld().connect(Ue),ha=(new Location$$module$nodes(a,2,M,"Town")).town().connect(Ve),Da=(new Location$$module$nodes(a,3,pa,"Main")).overworld().connect(ha).trigger(lc,Ta),Pc=(new Location$$module$nodes(a,3,pa,"Outside Windmill")).overworld(),Qc=(new Location$$module$nodes(a,4,K,"Tunnel 1 (entrance)")).cave().from(Da,
Ta),We=(new Location$$module$nodes(a,5,K,"Tunnel 2 (over bridge)")).cave().connect(Qc),Xe=(new Location$$module$nodes(a,6,K,"Tunnel 6 (herb dead end)")).cave().chest(X,15),Rc=(new Location$$module$nodes(a,7,K,"Tunnel 4a (ball corridor)")).cave().chest(X,20,80).chest(Ha,21);(new Location$$module$nodes(a,7,K,"Tunnel 4b (antidote dead end)")).cave().connect(Rc,v).chest(Oa,19);const Ye=(new Location$$module$nodes(a,8,K,"Tunnel 5 (warp boots dead end)")).cave().chest(lb,14),Ze=(new Location$$module$nodes(a,
...
ob,rb);(new Location$$module$nodes(a,15,pa,"Windmill")).misc().connect(Pc).trigger(Ta,Vb);const df=(new Location$$module$nodes(a,16,pa,"Zebu's Cave Front")).cave().connect(Da).trigger(rb,ic,jc).trigger(lc,Ta,rb),ef=(new Location$$module$nodes(a,16,pa,"Zebu's Cave Back")).cave().trigger(oc).connect(df,w),ff=(new Location$$module$nodes(a,17,B,"Tunnel 1 (to Zebu)")).cave().connect(ef),ua=(new Location$$module$nodes(a,20,ia,"West")).overworld().connect(cf),gf=(new Location$$module$nodes(a,20,ia,"South")).overworld().connect(ua,
q),Sc=(new Location$$module$nodes(a,21,ia,"East")).overworld().connect(ua).chest(Rb,24),Ea=(new Location$$module$nodes(a,24,qa,"Town")).town().connect(ua).trigger(Zd,Rb),hf=(new Location$$module$nodes(a,25,ia,"Outside Stom's House")).town().connect(ua),zb=(new Location$$module$nodes(a,26,ia,"Swamp")).overworld().connect(Sc,Wa).trigger(sb,nc,Wa);(new Location$$module$nodes(a,26,ia,"Swamp Insect Area")).overworld().connect(zb,Wa).boss(Ie);const Za=(new Location$$module$nodes(a,27,ra,"Town")).town().connect(gf),
...
137,ka,"Left branch, past two bridges")).fortress().connect(Jg,q).chest(X,29,87),Lg=(new Location$$module$nodes(a,137,ka,"Right branch")).fortress().connect(xd);(new Location$$module$nodes(a,137,ka,"Right branch, across water")).fortress().connect(Lg,A).chest(G,20,118).chest(G,21,119).chest(Od,28);(new Location$$module$nodes(a,138,ka,"Upper floor")).fortress().connect(Kg).chest(I,27);const xa=(new Location$$module$nodes(a,140,fa,"Town")).town().connect(Cg,Kc).trigger(vb),Fa=(new Location$$module$nodes(a,
...
166,U,"Draygon 2")).fortress().connect(bh).boss(Se);(new Location$$module$nodes(a,167,U,"Teleporter")).fortress().from(ch).to(kd);const Bd=(new Location$$module$nodes(a,168,Ya,"Entrance")).fortress().connect(Fa,xb).trigger(Cc,I),dh=(new Location$$module$nodes(a,169,Ya,"Main")).fortress().from(Bd,oa),eh=(new Location$$module$nodes(a,169,Ya,"Boss")).fortress().connect(dh).boss(Me),fh=(new Location$$module$nodes(a,170,Ya,"Zebu")).fortress().connect(eh),hb=(new Location$$module$nodes(a,171,O,"Entrance")).fortress().connect(fh);
...
174,sa,"Upper Loop")).fortress().connect(Cd).chest(Oa,22,96);(new Location$$module$nodes(a,174,sa,"Upper Loop Behind Wall (magic ring)")).fortress().connect(lh,oa).chest(Y,23,107);const mh=(new Location$$module$nodes(a,175,sa,"Upper Passage (toward Mado)")).fortress().connect(Cd).chest(Y,27,84),Mb=(new Location$$module$nodes(a,176,H,"Initial Fork")).fortress(),nh=(new Location$$module$nodes(a,177,H,"Left Branch")).fortress().connect(Mb),Dd=(new Location$$module$nodes(a,178,H,"Main Area (right branch, over bridges)")).fortress().connect(Mb),
...
sh=(new Location$$module$nodes(a,182,H,"Boss")).fortress().connect(rh,xb).boss(Pe);(new Location$$module$nodes(a,182,H,"Behind Boss (stormBracelet)")).fortress().connect(sh).chest(Na,18);const Fd=(new Location$$module$nodes(a,183,H,"Exit Stairs")).fortress(),th=(new Location$$module$nodes(a,184,E,"Entrance Back (behind river)")).cave().connect(Fd).chest(Aa,13,90);(new Location$$module$nodes(a,184,E,"Entrance Front")).cave().connect(th,A).connectTo(Ib).connectTo(gb);const uh=(new Location$$module$nodes(a,
...
226,ra,"Queen Downstairs")).house().connect(vh).chest(La,13);(new Location$$module$nodes(a,227,da,"Elder's House")).house().connect(eb).trigger(yc);(new Location$$module$nodes(a,228,da,"Shed")).house().connect(eb).to(ug,Zb);(new Location$$module$nodes(a,229,da,"Tool Shop")).shop().connect(eb).trigger(kc);(new Location$$module$nodes(a,231,da,"Inn")).shop().connect(eb);const wh=(new Location$$module$nodes(a,232,F,"Zombie Town House")).house().connect(Fb);(new Location$$module$nodes(a,233,F,"Zombie Town Basement")).house().connect(wh).trigger(ge,
...
(new Location$$module$nodes(a,247,fa,"Inn")).shop().connect(xa);(new Location$$module$nodes(a,248,P,"Inn")).shop().connect(ya);(new Location$$module$nodes(a,249,P,"Tool Shop")).shop().connect(ya);(new Location$$module$nodes(a,250,P,"Elder's House")).house().connect(ya);(new Location$$module$nodes(a,251,P,"Pawn Shop")).house().connect(ya);const yh=[ha,Da,Qc,ua,zb,va,Cb,bd,Eb,W,fb,Hb,Ib,Bd,Jb];for(const a of yh)a.from(yb,te);return a},shuffle$$module$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=
...
RNMX$$module$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$random={};module$random.Random=Random$$module$random;const STATUS$$module$version="unstable",VERSION$$module$version="latest",LABEL$$module$version="latest c982835",HASH$$module$version="c98283583108200876297df0a3533e9c6e1f0885",DATE$$module$version=new Date(1552285762E3);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c;a.seed||(a.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+a.seed);c=a.flags?new FlagSet$$module$flagset(a.flags):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$patch(b,parseSeed$$module$patch(a.seed),c)})}};
