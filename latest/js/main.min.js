...
f);b.remove();a(c)});d.readAsArrayBuffer(c)})})}const EXPECTED_CRC32$$module$rom=466849842,ADJUSTMENTS$$module$rom=new Map([[118533,72],[119569,160],[119570,0],[118777,224],[182928,0],[193907,0],[195300,0]]);var module$rom={};module$rom.Rom=Rom$$module$rom;module$rom.EXPECTED_CRC32=EXPECTED_CRC32$$module$rom;const STATUS$$module$version="unstable",VERSION$$module$version="latest",LABEL$$module$version="latest a2cff03",HASH$$module$version="a2cff03f9e01a3ef64c238fa19bd55c7b024261b",DATE$$module$version=new Date(1558585977E3);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$flagset(String(b.flags)):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$patch(a,parseSeed$$module$patch(String(b.seed)),d,new FetchReader$$module$fetchreader(c))})}};
