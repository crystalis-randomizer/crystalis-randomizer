...
tsx:{Implied:186},txa:{Implied:138},txs:{Implied:154},tya:{Implied:152}};var module$6502={};module$6502.assemble=assemble$$module$6502;module$6502.buildRomPatch=buildRomPatch$$module$6502;let table$$module$crc32;const buildTable$$module$crc32=()=>{let b;const a=Array(256);for(let c=0;256>c;c++){b=c;for(let a=0;8>a;a++)b=b&1?3988292384^b>>>1:b>>>1;a[c]=b}return a},crc32$$module$crc32=(b)=>{table$$module$crc32||(table$$module$crc32=buildTable$$module$crc32());let a=-1;for(let c=0;c<b.length;c++)a=a>>>8^table$$module$crc32[(a^b[c])&255];return(a^-1)>>>0};var module$crc32={};module$crc32.crc32=crc32$$module$crc32;const REPEATABLE_FLAGS$$module$flagset=new Set(["S"]),exclusiveFlags$$module$flagset=(b)=>b.startsWith("S")?new RegExp(`S.*[${b.substring(1)}]`):FLAG_CONFLICTS$$module$flagset[b],FLAG_CONFLICTS$$module$flagset={Hm:/Em/,Hx:/Ex/,Em:/Hm/,Ex:/Hx/,Tw:/Gw/,Gw:/Tw/};
...
d(62,"Bow of Moon").fromPerson("Aryllis",35).direct(251624).dialog(35,null,1).key(),dc=d(63,"Bow of Sun").chest().key(),ec=d(64,"Bow of Truth").fromPerson("Azteca",131).npcSpawn(131,156,1).dialog(131,null,0).key(),pb=(new Magic$$module$graph2(a,65,"Refresh",65,null)).fromPerson("Zebu at windmill",94).direct(251665).dialog(94,16,3).trigger(180,1),Qa=(new Magic$$module$graph2(a,66,"Paralysis",66,null)).direct("Zebu at Mt. Sabre summit",251477).trigger(141).trigger(178),X=(new Magic$$module$graph2(a,
67,"Telepathy",67,null)).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),fc=(new Magic$$module$graph2(a,68,"Teleport",68,null)).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),Rd=(new Magic$$module$graph2(a,69,"Recover",69,null)).direct("Asina in Portoa",250361),gc=(new Magic$$module$graph2(a,70,"Barrier",70,null)).direct("Asina on Angry sea",251609).trigger(132,0),na=(new Magic$$module$graph2(a,71,"Change",71,null)).direct("Kensu in Swan",251614).npcSpawn(116,241,1),
A=(new Magic$$module$graph2(a,72,"Flight",72,null)).direct("Kensu in Draygonia Fortress",250255),qb=d(40,"Flute of Lime").chest(void 0,91).key(),Sd=Ba.bossDrop("Vampire 2",12,97).npcSpawn(204).key(),F=d(112,"Mimic"),hc=(new Trigger$$module$graph2(a,"Talked to Leaf Elder")).get(K),ic=new Trigger$$module$graph2(a,"Talked to Leaf Student"),jc=(new Trigger$$module$graph2(a,"Buy alarm flute")).get(mb),rb=new Trigger$$module$graph2(a,"Talked to Zebu in cave"),Td=(new Trigger$$module$graph2(a,"Woke up Windmill Guard")).get(Ub),
Ra=new Trigger$$module$graph2(a,"Started Windmill"),kc=(new Trigger$$module$graph2(a,"Learned Refresh")).get(pb),Ud=(new Trigger$$module$graph2(a,"Gave Statue to Akahana")).get(Pa),Vd=(new Trigger$$module$graph2(a,"Fought Stom")).get(X),lc=new Trigger$$module$graph2(a,"Visited Oak"),mc=new Trigger$$module$graph2(a,"Talked to Oak Mother"),sb=new Trigger$$module$graph2(a,"Rescued Oak Child"),Wd=(new Trigger$$module$graph2(a,"Talked to Oak Mother Again")).get(Qb),Xd=(new Trigger$$module$graph2(a,"Talked to Oak Elder")).get(Q),
Yd=(new Trigger$$module$graph2(a,"Talked to Tornel on Mt Sabre")).get(fc),nc=new Trigger$$module$graph2(a,"Villagers Abducted"),oc=new Trigger$$module$graph2(a,"Talked to Rabbit in Leaf"),Zd=(new Trigger$$module$graph2(a,"Learned Paralysis")).get(Qa),pc=new Trigger$$module$graph2(a,"Talked to Portoa Queen"),qc=new Trigger$$module$graph2(a,"Talked to Fortune Teller"),rc=new Trigger$$module$graph2(a,"Visited Underground Channel"),$d=(new Trigger$$module$graph2(a,"Sent to Waterfall Cave")).get(Oa),ae=
(new Trigger$$module$graph2(a,"Cured Akahana")).get(Tb),sc=(new Trigger$$module$graph2(a,"Talked to Rage")).get(Aa),tc=new Trigger$$module$graph2(a,"Mesia recording played"),be=(new Trigger$$module$graph2(a,"Talked to Asina")).get(Rd),uc=(new Trigger$$module$graph2(a,"Healed Dolphin")).get(nb),tb=new Trigger$$module$graph2(a,"Returned Fog Lamp"),vc=new Trigger$$module$graph2(a,"Talked to Kensu in Cabin"),wc=new Trigger$$module$graph2(a,"Talked to Joel Elder"),ce=(new Trigger$$module$graph2(a,"Talked to Clark")).get(Yb),
de=(new Trigger$$module$graph2(a,"Talked to Kensu in Lighthouse")).get($b),ub=new Trigger$$module$graph2(a,"Calmed the Angry Sea"),ee=(new Trigger$$module$graph2(a,"Learned Barrier")).get(gc),xc=new Trigger$$module$graph2(a,"Talked to Stom in Swan Hut"),yc=new Trigger$$module$graph2(a,"Talked to Kensu in Swan tavern"),zc=new Trigger$$module$graph2(a,"Talked to Kensu at Swan dance"),fe=(new Trigger$$module$graph2(a,"Returned Kensu's love pendant")).get(na),ge=(new Trigger$$module$graph2(a,"Talked to Amazones Queen")).get(cc),
vb=new Trigger$$module$graph2(a,"Entered Shyron"),he=(new Trigger$$module$graph2(a,"Talked to Zebu in Shyron")).get(Wb),Ac=new Trigger$$module$graph2(a,"Shyron Massacre"),ie=(new Trigger$$module$graph2(a,"Saved Kensu")).get(A),je=(new Trigger$$module$graph2(a,"Talked to Deo")).get(Qd),ke=(new Trigger$$module$graph2(a,"Talked to Akahana's Friend")).get(Od),le=(new Trigger$$module$graph2(a,"Get Bow of Truth")).get(ec),me=(new Trigger$$module$graph2(a,"Forged Crystalis")).get(ib),ne=new Trigger$$module$graph2(a,
"Win"),Sa=(new Condition$$module$graph2(a,"Early flight")).option(Ed).option(Ga),Ta=(new Condition$$module$graph2(a,"Sword charge glitch")).option(Hd).option(ma),oe=(new Condition$$module$graph2(a,"Rabbit skip")).option(n).option(ma),wb=(new Condition$$module$graph2(a,"Talk glitch")).option(p).option(ma),pe=(new Condition$$module$graph2(a,"Ghetto flight")).option(h).option(ma),qe=(new Condition$$module$graph2(a,"Wild warp")).option(Fd).option(ma,Gd),Ua=(new Condition$$module$graph2(a,"Any level 2 sword")).option(K,
Ha).option(K,za).option(Q,Ia).option(Q,Ja).option(L,Aa).option(L,Ka).option(I,La).option(I,Ma),q=(new Condition$$module$graph2(a,"Destroy stone")).option(K,Ha).option(K,za).option(Ta,K,Ua),r=(new Condition$$module$graph2(a,"Destroy ice")).option(Q,Ia).option(Q,Ja).option(Ta,Q,Ua),k=(new Condition$$module$graph2(a,"Cross rivers")).option(L,Aa).option(L,Ka).option(A,Sa).option(Ta,L,Ua),oa=(new Condition$$module$graph2(a,"Destroy iron")).option(I,La).option(I,Ma).option(Ta,I,Ua),G=(new Condition$$module$graph2(a,
"Any sword")).option(K).option(Q).option(L).option(I),re=(new Condition$$module$graph2(a,"Match insect sword (fire/water/thunder)")).option(Q).option(L).option(I).option(Pa,w,K).option(Pa,E,K),se=(new Condition$$module$graph2(a,"Speed boots")).option(Sb,g),Bc=(new Condition$$module$graph2(a,"Climb slopes")).option(Rb).option(A,Sa).option(se),te=(new Condition$$module$graph2(a,"Enter Mt Sabre North")).option(oc).option(oe),Cc=(new Condition$$module$graph2(a,"Asina in her room")).option(tc),ue=(new Condition$$module$graph2(a,
"Paralysis or Ball of Water")).option(Qa).option(Cc).option(wb),ve=(new Condition$$module$graph2(a,"Ride dolphin")).option(nb,vc),R=(new Condition$$module$graph2(a,"Cross sea")).option(ve).option(A,Sa),we=(new Condition$$module$graph2(a,"Cross whirlpool")).option(ub).option(A,Sa).option(pe),S=(new Condition$$module$graph2(a,"Refresh if needed")).option(E).option(Dd).option(pb),Dc=(new Condition$$module$graph2(a,"Wind magic")).option(E).option(l,S).option(Ha,za,S),Ec=(new Condition$$module$graph2(a,
"Fire magic")).option(E).option(l,S).option(Ia,Ja,S),Fc=(new Condition$$module$graph2(a,"Water magic")).option(E).option(l,S).option(Aa,Ka,S),xe=(new Condition$$module$graph2(a,"Thunder magic")).option(E).option(l,S).option(La,S).option(Ma,S),ye=(new Condition$$module$graph2(a,"Flute of lime or glitch")).option(Oa).option(wb).option(Ga,qb),ze=(new Condition$$module$graph2(a,"Second flute of lime")).option(qb).option(Ga,Oa),Gc=(new Condition$$module$graph2(a,"Change or glitch")).option(na).option(wb),
xb=(new Condition$$module$graph2(a,"Pass shooting statues")).option(gc).option(pb,Tb).option(Cd).option(E),Ae=(new Condition$$module$graph2(a,"Healed dolphin if required")).option(uc).option(u),Hc=(new Condition$$module$graph2(a,"Match sword of wind")).option(K).option(E,G).option(w,G),Ic=(new Condition$$module$graph2(a,"Match sword of fire")).option(Q).option(E,G).option(w,G),Jc=(new Condition$$module$graph2(a,"Match sword of water")).option(L).option(E,G).option(w,G),Be=(new Condition$$module$graph2(a,
"Match sword of thunder")).option(I).option(E,G).option(w,G),Va=(new Condition$$module$graph2(a,"Travel swamp")).option(Pa).option(z).option(E),Ce=e(0,"Vampire 1",G).get(Rb),De=e(1,"Insect",Qb,re).get(Ia),Ee=e(2,"Kelbesque 1",Hc,Dc).get(Ja),Fe=e(12,"Vampire 2",G).get(Sd),Kc=e(4,"Sabera 1",Ic,Ec).get(Zb),Ge=e(5,"Mado 1",Jc,Fc).get(La),He=e(6,"Kelbesque 2",Hc,Dc).get(lb),Ie=e(7,"Sabera 2",Ic,Ec).get(Ob),Je=e(8,"Mado 2",Jc,Fc).get(Id),Ke=e(9,"Karmine",Be,xe).get(ob),Le=e(10,"Draygon 1",G).get(Ld),Me=
e(null,"Statues",dc,cc),Ne=e(11,"Draygon 2",G,ec),Oe=e(13,"Dyna",ib),M=new Area$$module$graph2(a,"Leaf"),pa=new Area$$module$graph2(a,"Valley of Wind"),J=new Area$$module$graph2(a,"Sealed Cave"),ha=new Area$$module$graph2(a,"Cordel Plain"),qa=new Area$$module$graph2(a,"Brynmaer"),ra=new Area$$module$graph2(a,"Amazones"),x=new Area$$module$graph2(a,"Mt Sabre West"),m=new Area$$module$graph2(a,"Mt Sabre North"),Wa=new Area$$module$graph2(a,"Nadare's"),Ca=new Area$$module$graph2(a,"Oak"),Y=new Area$$module$graph2(a,
"Waterfall Valley"),v=new Area$$module$graph2(a,"Portoa"),Z=new Area$$module$graph2(a,"Waterfall Cave"),y=new Area$$module$graph2(a,"Fog Lamp Cave"),aa=new Area$$module$graph2(a,"Kirisa Plant Cave"),ia=new Area$$module$graph2(a,"Angry Sea"),ba=new Area$$module$graph2(a,"Joel"),D=new Area$$module$graph2(a,"Evil Spirit Island"),ca=new Area$$module$graph2(a,"Sabera's Castle"),N=new Area$$module$graph2(a,"Swan"),t=new Area$$module$graph2(a,"Mt Hydra"),da=new Area$$module$graph2(a,"Shyron"),ja=new Area$$module$graph2(a,
"Styx"),ka=new Area$$module$graph2(a,"Goa"),Xa=new Area$$module$graph2(a,"Draygonia Fortress 1"),O=new Area$$module$graph2(a,"Draygonia Fortress 2"),sa=new Area$$module$graph2(a,"Draygonia Fortress 3"),H=new Area$$module$graph2(a,"Draygonia Fortress 4"),B=new Area$$module$graph2(a,"Oasis Cave");new Area$$module$graph2(a,"Desert");const P=new Area$$module$graph2(a,"Sahara"),ta=new Area$$module$graph2(a,"Pyramid Front"),T=new Area$$module$graph2(a,"Pyramid Back"),ea=new Area$$module$graph2(a,"Tower"),
yb=(new Location$$module$graph2(a,0,M,"Start")).overworld(),Pe=(new Location$$module$graph2(a,0,M,"Mezame Shrine")).overworld().from(yb),Qe=(new Location$$module$graph2(a,1,M,"Outside Start")).overworld().connect(Pe),fa=(new Location$$module$graph2(a,2,M,"Town")).town().connect(Qe),Da=(new Location$$module$graph2(a,3,pa,"Main")).overworld().connect(fa).trigger(kc,Ra),Lc=(new Location$$module$graph2(a,3,pa,"Outside Windmill")).overworld(),Mc=(new Location$$module$graph2(a,4,J,"Tunnel 1 (entrance)")).cave().from(Da,
Ra),Re=(new Location$$module$graph2(a,5,J,"Tunnel 2 (over bridge)")).cave().connect(Mc),Se=(new Location$$module$graph2(a,6,J,"Tunnel 6 (herb dead end)")).cave().chest(V,15),Nc=(new Location$$module$graph2(a,7,J,"Tunnel 4a (ball corridor)")).cave().chest(V,20,80).chest(Ha,21);(new Location$$module$graph2(a,7,J,"Tunnel 4b (antidote dead end)")).cave().connect(Nc,q).chest(Na,19);const Te=(new Location$$module$graph2(a,8,J,"Tunnel 5 (warp boots dead end)")).cave().chest(kb,14),Ue=(new Location$$module$graph2(a,
9,J,"Tunnel 3a (branch, front)")).cave().connect(Re).connectTo(Nc).connectTo(Te),Ve=(new Location$$module$graph2(a,9,J,"Tunnel 3b (branch, back)")).cave().connect(Ue,q).connectTo(Se),We=(new Location$$module$graph2(a,10,J,"Tunnel 7 (boss)")).cave().connect(Ve).boss(Ce),Xe=(new Location$$module$graph2(a,12,J,"Tunnel 8a (exit, above wall)")).cave().connect(We),Ye=(new Location$$module$graph2(a,12,J,"Tunnel 8b (exit, below wall")).cave().connect(Xe,q);(new Location$$module$graph2(a,14,pa,"Windmill Cave")).cave().connect(Da).connectTo(Lc).trigger(Td,
mb,rb);(new Location$$module$graph2(a,15,pa,"Windmill")).misc().connect(Lc).trigger(Ra,Ub);const Ze=(new Location$$module$graph2(a,16,pa,"Zebu's Cave Front")).cave().connect(Da).trigger(rb,hc,ic).trigger(kc,Ra,rb),$e=(new Location$$module$graph2(a,16,pa,"Zebu's Cave Back")).cave().trigger(nc).connect(Ze,r),af=(new Location$$module$graph2(a,17,x,"Tunnel 1 (to Zebu)")).cave().connect($e),ua=(new Location$$module$graph2(a,20,ha,"West")).overworld().connect(Ye),bf=(new Location$$module$graph2(a,20,ha,
"South")).overworld().connect(ua,k),Oc=(new Location$$module$graph2(a,21,ha,"East")).overworld().connect(ua).chest(Pb,24),Ea=(new Location$$module$graph2(a,24,qa,"Town")).town().connect(ua).trigger(Ud,Pb),cf=(new Location$$module$graph2(a,25,ha,"Outside Stom's House")).town().connect(ua),zb=(new Location$$module$graph2(a,26,ha,"Swamp")).overworld().connect(Oc,Va).trigger(sb,mc,Va);(new Location$$module$graph2(a,26,ha,"Swamp Insect Area")).overworld().connect(zb,Va).boss(De);const Ya=(new Location$$module$graph2(a,
27,ra,"Town")).town().connect(bf),Za=(new Location$$module$graph2(a,28,Ca,"Town")).town().connect(zb,Va).trigger(lc);(new Location$$module$graph2(a,30,ha,"Stom's House")).house().connect(cf).trigger(Vd,lc);const va=(new Location$$module$graph2(a,32,x,"Entrance")).overworld().connect(ua).connect(af),df=(new Location$$module$graph2(a,32,x,"Up Slope")).overworld().from(va,Bc).to(va),ef=(new Location$$module$graph2(a,32,x,"Dead End (warp boots)")).overworld().chest(kb,24,106),Pc=(new Location$$module$graph2(a,
33,x,"Upper")).overworld().from(va,A).to(va),ff=(new Location$$module$graph2(a,33,x,"Tornel Dead End")).overworld().trigger(Yd,za).chest(W,23,105),Qc=(new Location$$module$graph2(a,34,x,"Tunnel 2a (fork at start)")).cave().connect(va);(new Location$$module$graph2(a,34,x,"Tunnel 2b (left branch to dead end)")).cave().connect(Qc,r).connectTo(ef);const gf=(new Location$$module$graph2(a,34,x,"Tunnel 2c (right branch to upper)")).cave().connect(Qc,r),hf=(new Location$$module$graph2(a,35,x,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(gf).chest(V,
23,82),jf=(new Location$$module$graph2(a,35,x,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(hf,r).connectTo(Pc),Rc=(new Location$$module$graph2(a,36,x,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(jf);(new Location$$module$graph2(a,36,x,"Tunnel 4b (out to upper)")).cave().connect(Rc,r).connectTo(Pc);const kf=(new Location$$module$graph2(a,37,x,"Tunnel 5 (tiny connector)")).cave().connect(Rc),lf=(new Location$$module$graph2(a,38,x,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(kf);
(new Location$$module$graph2(a,38,x,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(lf,r).connectTo(ff);const mf=(new Location$$module$graph2(a,39,x,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(df),nf=(new Location$$module$graph2(a,39,x,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(mf,r);(new Location$$module$graph2(a,39,x,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(nf,r).chest(za,25);const $a=(new Location$$module$graph2(a,40,m,"Entrance")).overworld().connect(Oc,
fc,te),ab=(new Location$$module$graph2(a,40,m,"Upper")).overworld().from($a,A).to($a),Ab=(new Location$$module$graph2(a,40,m,"Summit (boss)")).overworld().from(ab,A).to(ab).boss(Ee),Sc=(new Location$$module$graph2(a,41,m,"Connector")).overworld(),Bb=(new Location$$module$graph2(a,41,m,"Middle Left")).overworld(),of=(new Location$$module$graph2(a,41,m,"Middle Right")).overworld().from(Bb,Bc).to(Bb),Tc=(new Location$$module$graph2(a,42,m,"Tunnel 2a (from entrance to connector)")).cave().connectTo(Sc);
(new Location$$module$graph2(a,42,m,"Tunnel 2b (under bridge, to antidote)")).cave().connect(Tc,r).chest(Na,23,94);const Uc=(new Location$$module$graph2(a,43,m,"Tunnel 3a (branch after connector)")).cave().connect(Sc),pf=(new Location$$module$graph2(a,43,m,"Tunnel 3b (right branch)")).cave().connect(Uc,r),qf=(new Location$$module$graph2(a,43,m,"Tunnel 3c (upper branch)")).cave().connect(Uc,r);(new Location$$module$graph2(a,44,m,"Tunnel 4 (over bridge, to middle)")).cave().connect(qf).connectTo(Bb);
const Vc=(new Location$$module$graph2(a,45,m,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(pf).connectTo(of);(new Location$$module$graph2(a,45,m,"Tunnel 5b (dead-end with herb)")).cave().connect(Vc,r).chest(V,22,83);const rf=(new Location$$module$graph2(a,46,m,"Tunne; 6a (S-shaped hall, right)")).cave().connect(Vc),sf=(new Location$$module$graph2(a,46,m,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(rf,r),tf=(new Location$$module$graph2(a,46,m,"Tunnel 6c (S-shaped hall, left)")).cave().connect(sf,
r),Wc=(new Location$$module$graph2(a,47,m,"Prison (hallway)")).cave().connect(ab),uf=(new Location$$module$graph2(a,48,m,"Left Cell (shopkeepers)")).cave().from(Wc,r);(new Location$$module$graph2(a,49,m,"Left Cell 2 (back, with prison key)")).cave().from(uf,r).chest(Vb,13);const vf=(new Location$$module$graph2(a,50,m,"Right Cell (villagers)")).cave().from(Wc,r),wf=(new Location$$module$graph2(a,51,m,"Tunnel 8 (behind right cell, toward summit)")).cave().from(vf,r);(new Location$$module$graph2(a,52,
m,"Tunnel 9 (connector to summit)")).cave().connect(wf).connectTo(Ab);const xf=(new Location$$module$graph2(a,53,m,"Tunnel 10a (summit cave, front)")).cave().from(Ab,Vb).to(Ab),yf=(new Location$$module$graph2(a,53,m,"Tunnel 10b (summit cave, behind ice)")).cave().connect(xf,r).trigger(Zd);(new Location$$module$graph2(a,56,m,"Tunnel 1 (leads from main entrance)")).cave().connect($a).connectTo(Tc);(new Location$$module$graph2(a,57,m,"Tunnel 7 (to upper)")).cave().connect(tf).connectTo(ab);const zf=
(new Location$$module$graph2(a,60,Wa,"Inn")).town(),Af=(new Location$$module$graph2(a,61,Wa,"Tool Shop")).house(),Bf=(new Location$$module$graph2(a,62,Wa,"Back Room")).house(),Cb=(new Location$$module$graph2(a,64,Y,"Summit")).overworld().connect(yf),bb=(new Location$$module$graph2(a,64,Y,"Northwest")).overworld().from(Cb).to(Cb,A),Cf=(new Location$$module$graph2(a,64,Y,"Northeast")).overworld().connect(bb,k),Xc=(new Location$$module$graph2(a,65,Y,"Southwest")).overworld().connect(bb),Df=(new Location$$module$graph2(a,
65,Y,"Southeast")).overworld().connect(Xc,k),Yc=(new Location$$module$graph2(a,66,Y,"Lime Tree Valley")).overworld().connect(Xc).connect(Da,hb),Ef=(new Location$$module$graph2(a,67,Y,"Lime Tree Lake (Rage)")).cave().connect(Yc).trigger(sc,L),Ff=(new Location$$module$graph2(a,68,aa,"Tunnel 1a (entrance)")).cave().connect(Df),Gf=(new Location$$module$graph2(a,68,aa,"Tunnel 1b (behind wall)")).cave().connect(Ff,q),Zc=(new Location$$module$graph2(a,69,aa,"Tunnel 2a (main path, before wall)")).cave().connect(Gf);
(new Location$$module$graph2(a,69,aa,"Tunnel 2b (dead end, antidote)")).cave().connect(Zc,q).chest(Na,25,95);const Hf=(new Location$$module$graph2(a,69,aa,"Tunnel 2c (main path, after wall)")).cave().connect(Zc,q),If=(new Location$$module$graph2(a,70,aa,"Tunnel 3a (last room, before wall)")).cave().connect(Hf),Jf=(new Location$$module$graph2(a,70,aa,"Tunnel 3b (last room, after wall)")).cave().connect(If,q);(new Location$$module$graph2(a,71,aa,"Meadow")).overworld().connect(Jf).chest(bc,14);const Kf=
(new Location$$module$graph2(a,72,y,"Tunnel 1a (entrance)")).cave().connect(Cf),$c=(new Location$$module$graph2(a,72,y,"Tunnel 1b (past wall)")).cave().connect(Kf,q);(new Location$$module$graph2(a,72,y,"Tunnel 1c (dead end, lysisPlant)")).cave().connect($c,q).chest(jb,24);const Lf=(new Location$$module$graph2(a,73,y,"Tunnel 2 (tiny connector)")).cave().connect($c),ad=(new Location$$module$graph2(a,74,y,"Tunnel 3a (upper branch)")).cave().connect(Lf);(new Location$$module$graph2(a,74,y,"Tunnel 3b (dead end, mimic)")).cave().connect(ad,
q).chest(F,21);const bd=(new Location$$module$graph2(a,74,y,"Tunnel 3c (short passage with mimic)")).cave().connect(ad,q).chest(F,22),Mf=(new Location$$module$graph2(a,74,y,"Tunnel 3d (lower branch)")).cave().connect(bd,q);(new Location$$module$graph2(a,75,y,"Tunnel 4 (dead end loop)")).cave().connect(Mf);const cd=(new Location$$module$graph2(a,76,y,"Tunnel 5a (right branch over bridge)")).cave().connect(bd),Nf=(new Location$$module$graph2(a,76,y,"Tunnel 5b (past wall over bridge)")).cave().connect(cd,
q),Of=(new Location$$module$graph2(a,77,y,"Tunnel 6a (from left branch)")).cave().connect(cd),Pf=(new Location$$module$graph2(a,77,y,"Tunnel 6b (reconvergence)")).cave().connect(Of,q).connect(Nf),Qf=(new Location$$module$graph2(a,77,y,"Tunnel 6c (between walls)")).cave().connect(Pf,q),Rf=(new Location$$module$graph2(a,77,y,"Tunnel 6d (under bridge)")).cave().connect(Qf,q),Sf=(new Location$$module$graph2(a,78,y,"Tunnel 7a (over second bridge)")).cave().connect(Rf),Tf=(new Location$$module$graph2(a,
78,y,"Tunnel 7b (past wall)")).cave().connect(Sf,q),Uf=(new Location$$module$graph2(a,79,y,"Tunnel 8a (under second bridge)")).cave().connect(Tf);(new Location$$module$graph2(a,79,y,"Tunnel 8b (fog lamp)")).cave().connect(Uf,q).chest(Xb,19);const la=(new Location$$module$graph2(a,80,v,"Town")).town().connect(bb),dd=(new Location$$module$graph2(a,81,v,"Fishherman Island")).town().connect(la);(new Location$$module$graph2(a,82,Y,"Mesia Shrine")).cave().trigger(tc).connect(Ef,k,sc);const ed=(new Location$$module$graph2(a,
84,Z,"Tunnel 1a (entrance)")).cave().connect(bb);(new Location$$module$graph2(a,84,Z,"Tunnel 1b (dead end, mimic)")).cave().connect(ed,r).chest(F,19);const Vf=(new Location$$module$graph2(a,84,Z,"Tunnel 1c (past ice)")).cave().connect(ed,r),fd=(new Location$$module$graph2(a,85,Z,"Tunnel 2 (stoned pair)")).cave().connect(Vf),Db=(new Location$$module$graph2(a,86,Z,"Tunnel 3 (wide medusa hallways)")).cave().from(fd,ye).to(fd,Oa),Wf=(new Location$$module$graph2(a,87,Z,"Tunnel 4a (left entrance)")).cave().from(Db,
r).chest(qb,25).trigger(ae,ze);(new Location$$module$graph2(a,87,Z,"Tunnel 4b (right entrance)")).cave().from(Db,r).connect(Wf,A);(new Location$$module$graph2(a,87,Z,"Tunnel 4c (sword of water)")).cave().connect(Db,r).chest(L,24);const gd=(new Location$$module$graph2(a,88,ea,"Entrance")).misc(),Xf=(new Location$$module$graph2(a,89,ea,"Level 1")).misc().from(gd),Yf=(new Location$$module$graph2(a,90,ea,"Level 2")).misc().from(Xf),Zf=(new Location$$module$graph2(a,91,ea,"Level 3")).misc().from(Yf),hd=
(new Location$$module$graph2(a,92,ea,"Outside Mesia Room")).misc().from(Zf),$f=(new Location$$module$graph2(a,93,ea,"Outside Dyna Room")).misc().from(hd,ib);(new Location$$module$graph2(a,94,ea,"Mesia")).misc().connect(hd).trigger(me);(new Location$$module$graph2(a,95,ea,"Dyna")).misc().from($f).boss(Oe).trigger(ne);const Eb=(new Location$$module$graph2(a,96,ia,"Cabin Beach")).sea().from(dd,tb),wa=(new Location$$module$graph2(a,96,ia,"South")).sea().connect(Eb,R),ag=(new Location$$module$graph2(a,
96,ia,"Joel Beach")).sea().connect(wa,R),id=(new Location$$module$graph2(a,96,ba,"Outside Lighthouse")).sea();(new Location$$module$graph2(a,96,ia,"Altar")).sea().connect(wa,R).trigger(ub,$b,Zb);const bg=(new Location$$module$graph2(a,96,ia,"North")).sea().to(wa,R).from(wa,R,we).trigger(ee,ub),cg=(new Location$$module$graph2(a,96,ia,"Swan Beach")).sea().connect(bg,R);(new Location$$module$graph2(a,97,ia,"Cabin")).misc().connect(Eb).trigger(vc,tb);(new Location$$module$graph2(a,98,ba,"Lighthouse")).misc().connect(id).trigger(de,
mb);const cb=(new Location$$module$graph2(a,100,v,"Underground Channel 1 (from throne room)")).sea().trigger(rc),dg=(new Location$$module$graph2(a,100,v,"Underground Channel 2 (to fortune teller)")).sea().connect(cb,k),jd=(new Location$$module$graph2(a,100,v,"Underground Channel 3 (from fortune teller)")).sea().connect(cb,A),kd=(new Location$$module$graph2(a,100,v,"Underground Channel 4 (asina)")).sea().connect(jd,k),eg=(new Location$$module$graph2(a,100,v,"Underground Channel 5 (dolphin)")).sea().connect(kd,
k).trigger(uc,V,Aa);(new Location$$module$graph2(a,100,v,"Underground Channel 6 (water)")).sea().connect(eg,R).connectTo(wa,R).chest(ac,17);const Fb=(new Location$$module$graph2(a,101,D,"Zombie Town")).town(),fg=(new Location$$module$graph2(a,104,D,"Tunnel 1 (entrance)")).sea().connect(wa,wc,R),ld=(new Location$$module$graph2(a,105,D,"Tunnel 2a (start)")).cave().connect(fg);(new Location$$module$graph2(a,105,D,"Tunnel 2b (dead end to left)")).cave().connect(ld,k);const gg=(new Location$$module$graph2(a,
105,D,"Tunnel 2c (across first river)")).cave().connect(ld,k),md=(new Location$$module$graph2(a,105,D,"Tunnel 2d (across second river)")).cave().connect(gg,k);(new Location$$module$graph2(a,105,D,"Tunnel 2e (dead end, magic ring)")).cave().connect(md,q).chest(W,29);const hg=(new Location$$module$graph2(a,105,D,"Tunnel 2f (stair down)")).cave().connect(md,q),ig=(new Location$$module$graph2(a,106,D,"Tunnel 3a (main area)")).cave().connect(hg).connectTo(Fb).chest(jb,25,92),jg=(new Location$$module$graph2(a,
106,D,"Tunnel 3b (left area toward items)")).cave().connect(ig,q),kg=(new Location$$module$graph2(a,107,D,"Tunnel 4a (right side, mimic)")).cave().connect(jg).chest(F,14);(new Location$$module$graph2(a,107,D,"Tunnel 4b (left side, iron necklace)")).cave().connect(kg,k).chest(Pd,15);const Gb=(new Location$$module$graph2(a,108,ca,"Floor 1")).fortress().connect(Fb),lg=(new Location$$module$graph2(a,108,ca,"Miniboss")).fortress().boss(Fe).connect(Gb);(new Location$$module$graph2(a,109,ca,"Floor 2a (left stair)")).fortress().connect(Gb).chest(Ba,
19);const mg=(new Location$$module$graph2(a,109,ca,"Floor 2b (right stair)")).fortress().connect(lg).chest(V,30,85),ng=(new Location$$module$graph2(a,110,ca,"Floor 3a (toward boss)")).fortress().connect(mg),nd=(new Location$$module$graph2(a,110,ca,"Floor 3b (boss room)")).fortress().connect(ng);(new Location$$module$graph2(a,110,ca,"Boss")).fortress().boss(Kc).connect(nd);(new Location$$module$graph2(a,110,ca,"Floor 3c (back room trap)")).fortress().from(nd).to(Gb);const og=(new Location$$module$graph2(a,
112,ba,"Secret Passage")).cave().connectTo(id),db=(new Location$$module$graph2(a,113,ba,"Town")).town().connect(ag),U=(new Location$$module$graph2(a,114,N,"Town")).town().connect(cg),pg=(new Location$$module$graph2(a,115,N,"Inside Gate")).overworld().connect(U),qg=(new Location$$module$graph2(a,115,N,"Outside Gate")).overworld().from(pg,na),eb=(new Location$$module$graph2(a,120,ka,"Valley")).overworld().connect(qg),Hb=(new Location$$module$graph2(a,124,t,"Entrance")).overworld().connect(eb),rg=(new Location$$module$graph2(a,
124,t,"Over first river toward Shyron")).overworld().connect(Hb,k),od=(new Location$$module$graph2(a,124,t,"After first tunnel")).overworld(),pd=(new Location$$module$graph2(a,124,t,"Door to Styx")).overworld().connect(od,k),sg=(new Location$$module$graph2(a,124,t,"Dead end (no item)")).overworld(),tg=(new Location$$module$graph2(a,124,t,"Dead end (fruit of lime)")).overworld().chest(Md,26),ug=(new Location$$module$graph2(a,124,t,"Dead end (magic ring)")).overworld().chest(W,25,101),qd=(new Location$$module$graph2(a,
124,t,"Outside tunnel to bow")).overworld();(new Location$$module$graph2(a,124,t,"Floating island (bow of sun)")).overworld().connect(qd,A).chest(dc,24);const vg=(new Location$$module$graph2(a,125,t,"Tunnel 1 (to Shyron)")).cave().connect(rg),wg=(new Location$$module$graph2(a,126,t,"Outside Shyron")).overworld().connect(vg);(new Location$$module$graph2(a,127,t,"Tunnel 2 (fork)")).cave().connect(Hb).connectTo(tg).connectTo(od);const rd=(new Location$$module$graph2(a,128,t,"Tunnel 3 (caves)")).cave().connect(pd).connect(sg),
sd=(new Location$$module$graph2(a,129,t,"Tunnel 4 (left branch of cave)")).cave().connect(rd);(new Location$$module$graph2(a,130,t,"Tunnel 5 (dead end, medical herb)")).cave().connect(sd).chest(V,15,86);const xg=(new Location$$module$graph2(a,131,t,"Tunnel 6a (left-then-right)")).cave().connect(sd),yg=(new Location$$module$graph2(a,131,t,"Tunnel 6b (past wall)")).cave().connect(xg,q),zg=(new Location$$module$graph2(a,132,t,"Tunnel 7 (wide hall)")).cave().connect(yg);(new Location$$module$graph2(a,
133,t,"Tunnel 8 (red slimes)")).cave().from(zg,q).connectTo(qd).chest(F,23);const Ag=(new Location$$module$graph2(a,134,t,"Tunnel 9 (right branch, infinite loop)")).cave().connect(rd),Bg=(new Location$$module$graph2(a,135,t,"Tunnel 10a (toward magic ring)")).cave().connect(Ag);(new Location$$module$graph2(a,135,t,"Tunnel 10b (past wall)")).cave().connect(Bg,q).connectTo(ug);const td=(new Location$$module$graph2(a,136,ja,"Entrance")).fortress().from(pd,Wb,xb),Cg=(new Location$$module$graph2(a,137,
ja,"Left branch")).fortress().connect(td).chest(F,19),Dg=(new Location$$module$graph2(a,137,ja,"Left branch, past one bridge")).fortress().connect(Cg,k),Eg=(new Location$$module$graph2(a,137,ja,"Left branch, past two bridges")).fortress().connect(Dg,k).chest(V,29,87),Fg=(new Location$$module$graph2(a,137,ja,"Right branch")).fortress().connect(td);(new Location$$module$graph2(a,137,ja,"Right branch, across water")).fortress().connect(Fg,A).chest(F,20).chest(F,21).chest(Jd,28);(new Location$$module$graph2(a,
138,ja,"Upper floor")).fortress().connect(Eg).chest(I,27);const xa=(new Location$$module$graph2(a,140,da,"Town")).town().connect(wg,Gc).trigger(vb),Fa=(new Location$$module$graph2(a,142,ka,"Town")).town().connect(eb),ud=(new Location$$module$graph2(a,143,B,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$graph2(a,143,B,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(ud,oa).chest(Nd,15);const Ib=(new Location$$module$graph2(a,144,ka,"Desert 1")).overworld().connect(eb),
fb=(new Location$$module$graph2(a,145,B,"Area 1 (from entrance)")).cave().chest(Sb,26),vd=(new Location$$module$graph2(a,145,B,"Area 2 (across top bridge)")).cave().connect(fb,k);(new Location$$module$graph2(a,145,B,"Area 3 (dead-end across top-right bridge)")).cave().connect(vd,k);const Gg=(new Location$$module$graph2(a,145,B,"Area 4 (left across middle-right bridge)")).cave().connect(vd,k),Hg=(new Location$$module$graph2(a,145,B,"Area 5 (bottom edge)")).cave().connect(Gg,k),Ig=(new Location$$module$graph2(a,
145,B,"Area 6 (bottom island)")).cave().connect(Hg,k),Jg=(new Location$$module$graph2(a,145,B,"Area 7 (bottom inner ring)")).cave().connect(Ig,k),Kg=(new Location$$module$graph2(a,145,B,"Area 8 (left outer ring)")).cave().connect(Jg,k).connect(fb,k).chest(Ba,27,100),Lg=(new Location$$module$graph2(a,145,B,"Area 9 (top left inner ring)")).cave().connect(Kg,k),Mg=(new Location$$module$graph2(a,145,B,"Area 10 (top right inner ring)")).cave().connect(Lg,k);(new Location$$module$graph2(a,145,B,"Area 11 (center)")).cave().connect(Mg,
k).connectTo(ud);(new Location$$module$graph2(a,145,B,"Area 12 (top center islands)")).cave().connect(fb,A).chest(Kd,28);const Ng=(new Location$$module$graph2(a,146,P,"Desert Cave 1")).cave().connect(Ib,A),ya=(new Location$$module$graph2(a,147,P,"Town")).town(),Og=(new Location$$module$graph2(a,148,P,"Outside Cave")).overworld().connect(ya),Pg=(new Location$$module$graph2(a,149,P,"Desert Cave 2")).cave().connect(Og);(new Location$$module$graph2(a,150,P,"Meadow")).overworld().connect(Ng).connectTo(ya).trigger(je,
na,X);const Jb=(new Location$$module$graph2(a,152,P,"Desert 2")).overworld().connect(Pg),Qg=(new Location$$module$graph2(a,156,ta,"Entrance")).fortress().connect(Jb,A),Rg=(new Location$$module$graph2(a,156,ta,"Azteca")).fortress().trigger(le),Sg=(new Location$$module$graph2(a,157,ta,"Fork")).fortress().connect(Qg),wd=(new Location$$module$graph2(a,158,ta,"Main")).fortress().connect(Sg);(new Location$$module$graph2(a,158,ta,"Treasure Chest (magic ring)")).fortress().connect(wd).chest(W,27,108);(new Location$$module$graph2(a,
159,ta,"Draygon")).fortress().connect(wd).to(Rg).boss(Le);const Tg=(new Location$$module$graph2(a,160,T,"Entrance")).fortress().connect(Jb,A),Ug=(new Location$$module$graph2(a,160,T,"Statues")).fortress().connect(Tg).boss(Me),Vg=(new Location$$module$graph2(a,161,T,"Hall 1")).fortress().connect(Ug),Kb=(new Location$$module$graph2(a,162,T,"Branch")).fortress().connect(Vg);(new Location$$module$graph2(a,163,T,"Left Dead End")).fortress().connect(Kb).chest(F,13);(new Location$$module$graph2(a,164,T,
"Right Dead End")).fortress().connect(Kb);const Wg=(new Location$$module$graph2(a,165,T,"Hall 2")).fortress().connect(Kb).chest(lb,26,109),Xg=(new Location$$module$graph2(a,166,T,"Draygon 2")).fortress().connect(Wg).boss(Ne);(new Location$$module$graph2(a,167,T,"Teleporter")).fortress().from(Xg).to(gd);const xd=(new Location$$module$graph2(a,168,Xa,"Entrance")).fortress().connect(Fa,xb).trigger(Ac,I),Yg=(new Location$$module$graph2(a,169,Xa,"Main")).fortress().from(xd,oa),Zg=(new Location$$module$graph2(a,
169,Xa,"Boss")).fortress().connect(Yg).boss(He),$g=(new Location$$module$graph2(a,170,Xa,"Zebu")).fortress().connect(Zg),gb=(new Location$$module$graph2(a,171,O,"Entrance")).fortress().connect($g);(new Location$$module$graph2(a,171,O,"Dead End Behind Iron (fruit of power)")).fortress().connect(gb,oa).chest(Ba,28,98);(new Location$$module$graph2(a,171,O,"Dead End Loop Across Closer Bridges")).fortress().connect(gb,k).connect(gb,k);const ah=(new Location$$module$graph2(a,171,O,"Across First Bridge (fruit of repun)")).fortress().connect(gb,
k).chest(Ob,30,102),Lb=(new Location$$module$graph2(a,171,O,"Across Second Bridge")).fortress().connect(ah,k);(new Location$$module$graph2(a,171,O,"Dead End Across Two Bridges ()")).fortress().connect(Lb,k).connect(Lb,k).chest(jb,29,93);const bh=(new Location$$module$graph2(a,171,O,"Across Third Bridge")).fortress().connect(Lb,k),ch=(new Location$$module$graph2(a,171,O,"Exit Behind Iron Door")).fortress().connect(bh,oa),dh=(new Location$$module$graph2(a,172,O,"Boss")).fortress().connect(ch).boss(Ie),
eh=(new Location$$module$graph2(a,172,O,"Tornel")).fortress().connect(dh),yd=(new Location$$module$graph2(a,173,sa,"Lower")).fortress().connect(eh).chest(lb,26,99).chest(W,27,111),fh=(new Location$$module$graph2(a,174,sa,"Upper Loop")).fortress().connect(yd).chest(Na,22,96);(new Location$$module$graph2(a,174,sa,"Upper Loop Behind Wall (magic ring)")).fortress().connect(fh,oa).chest(W,23,107);const gh=(new Location$$module$graph2(a,175,sa,"Upper Passage (toward Mado)")).fortress().connect(yd).chest(W,
27,84),Mb=(new Location$$module$graph2(a,176,H,"Initial Fork")).fortress(),hh=(new Location$$module$graph2(a,177,H,"Left Branch")).fortress().connect(Mb),zd=(new Location$$module$graph2(a,178,H,"Main Area (right branch, over bridges)")).fortress().connect(Mb),ih=(new Location$$module$graph2(a,179,H,"U-shaped Passage (between floors)")).fortress().connect(zd),jh=(new Location$$module$graph2(a,180,H,"Main Area Lower (under bridge)")).fortress().connect(hh).connect(zd).connect(ih),Ad=(new Location$$module$graph2(a,
180,H,"Behind Iron Wall")).fortress().connect(jh,oa),kh=(new Location$$module$graph2(a,181,H,"Lower")).fortress().connect(Ad).chest(F,13).chest(F,14).chest(F,15).chest(W,23,88).chest(kb,24,110),lh=(new Location$$module$graph2(a,182,H,"Boss Corridor")).fortress().connect(kh),mh=(new Location$$module$graph2(a,182,H,"Boss")).fortress().connect(lh,xb).boss(Ke);(new Location$$module$graph2(a,182,H,"Behind Boss (stormBracelet)")).fortress().connect(mh).chest(Ma,18);const Bd=(new Location$$module$graph2(a,
183,H,"Exit Stairs")).fortress(),nh=(new Location$$module$graph2(a,184,B,"Entrance Back (behind river)")).cave().connect(Bd).chest(Ba,13,90);(new Location$$module$graph2(a,184,B,"Entrance Front")).cave().connect(nh,A).connectTo(Ib).connectTo(fb);const oh=(new Location$$module$graph2(a,185,sa,"Boss")).fortress().connect(gh).boss(Je);(new Location$$module$graph2(a,185,sa,"Asina")).fortress().connect(oh).connectTo(Mb);(new Location$$module$graph2(a,186,H,"Kensu")).fortress().connect(Ad).connectTo(Bd).trigger(ie,
ob);(new Location$$module$graph2(a,187,ka,"House")).house().connect(Fa).trigger(ke,na,ob);(new Location$$module$graph2(a,188,ka,"Inn")).shop().connect(Fa,vb);(new Location$$module$graph2(a,190,ka,"Tool Shop")).shop().connect(Fa,vb);(new Location$$module$graph2(a,191,ka,"Tavern")).shop().connect(Fa);(new Location$$module$graph2(a,192,M,"Elder House")).house().connect(fa).trigger(hc);(new Location$$module$graph2(a,193,M,"Rabbit Hut")).house().connect(fa).trigger(oc,nc,X);(new Location$$module$graph2(a,
194,M,"Inn")).shop().connect(fa);(new Location$$module$graph2(a,195,M,"Tool Shop")).shop().connect(fa).trigger(jc);(new Location$$module$graph2(a,196,M,"Armor Shop")).shop().connect(fa);(new Location$$module$graph2(a,197,M,"Student House")).house().connect(fa).trigger(ic);(new Location$$module$graph2(a,198,qa,"Tavern")).house().connect(Ea);(new Location$$module$graph2(a,199,qa,"Pawn Shop")).shop().connect(Ea);(new Location$$module$graph2(a,200,qa,"Inn")).shop().connect(Ea);(new Location$$module$graph2(a,
201,qa,"Armor Shop")).shop().connect(Ea);(new Location$$module$graph2(a,203,qa,"Tool Shop")).shop().connect(Ea);(new Location$$module$graph2(a,205,Ca,"Elder House")).house().from(Za,X).trigger(Xd,sb);(new Location$$module$graph2(a,206,Ca,"Mother's House")).house().from(Za,X).trigger(mc,X).trigger(Wd,sb);(new Location$$module$graph2(a,207,Ca,"Tool Shop")).shop().from(Za,X);(new Location$$module$graph2(a,208,Ca,"Inn")).shop().from(Za,X);(new Location$$module$graph2(a,209,ra,"Inn")).shop().connect(Ya);
(new Location$$module$graph2(a,210,ra,"Tool Shop")).shop().connect(Ya);(new Location$$module$graph2(a,211,ra,"Armor Shop")).shop().connect(Ya);const ph=(new Location$$module$graph2(a,212,ra,"Queen's House")).house().from(Ya,Gc).trigger(ge,na,bc);(new Location$$module$graph2(a,213,Wa,"Nadare's")).house().connect($a).connectTo(zf).connectTo(Af).connectTo(Bf);(new Location$$module$graph2(a,214,v,"Fisherman's House")).house().connect(dd).trigger(tb,Xb,nb,Ae);const Nb=(new Location$$module$graph2(a,215,
v,"Palace Entrance")).house().connect(la);(new Location$$module$graph2(a,216,v,"Fortune Teller Front")).house().connect(la).trigger(qc,pc);(new Location$$module$graph2(a,216,v,"Fortune Teller Back")).house().connect(dg).connect(jd);(new Location$$module$graph2(a,217,v,"Pawn Shop")).shop().connect(la);(new Location$$module$graph2(a,218,v,"Armor Shop")).shop().connect(la);(new Location$$module$graph2(a,220,v,"Inn")).shop().connect(la);(new Location$$module$graph2(a,221,v,"Tool Shop")).shop().connect(la);
(new Location$$module$graph2(a,222,v,"Palace Left")).house().connect(Nb);(new Location$$module$graph2(a,223,v,"Palace Throne Room")).house().connect(Nb).to(cb,ue).from(cb).trigger(pc).trigger($d,qc,rc);(new Location$$module$graph2(a,224,v,"Palace Right")).house().connect(Nb);(new Location$$module$graph2(a,225,v,"Asina's Room")).house().connect(kd).trigger(be,Cc);(new Location$$module$graph2(a,226,ra,"Queen Downstairs")).house().connect(ph).chest(Ka,13);(new Location$$module$graph2(a,227,ba,"Elder's House")).house().connect(db).trigger(wc);
(new Location$$module$graph2(a,228,ba,"Shed")).house().connect(db).to(og,Yb);(new Location$$module$graph2(a,229,ba,"Tool Shop")).shop().connect(db).trigger(jc);(new Location$$module$graph2(a,231,ba,"Inn")).shop().connect(db);const qh=(new Location$$module$graph2(a,232,D,"Zombie Town House")).house().connect(Fb);(new Location$$module$graph2(a,233,D,"Zombie Town Basement")).house().connect(qh).trigger(ce,Kc);(new Location$$module$graph2(a,235,N,"Tool Shop")).shop().connect(U);(new Location$$module$graph2(a,
236,N,"Stom's Hut")).house().connect(U).trigger(xc);(new Location$$module$graph2(a,237,N,"Inn")).shop().connect(U);(new Location$$module$graph2(a,238,N,"Armor Shop")).shop().connect(U);(new Location$$module$graph2(a,239,N,"Tavern")).house().connect(U).trigger(yc,xc,Qa);(new Location$$module$graph2(a,240,N,"Pawn Shop")).shop().connect(U);(new Location$$module$graph2(a,241,N,"Dance Hall")).house().connect(U).trigger(zc,yc,Qa).trigger(fe,zc,ac);const rh=(new Location$$module$graph2(a,242,da,"Temple (pre-massacre)")).fortress().connect(xa).from(yb,
I,C).trigger(he);(new Location$$module$graph2(a,242,da,"Temple (post-massacre)")).fortress().from(rh,Ac).boss(Ge);(new Location$$module$graph2(a,243,da,"Training Hall")).house().connect(xa);(new Location$$module$graph2(a,244,da,"Hospital")).house().connect(xa);(new Location$$module$graph2(a,245,da,"Armor Shop")).shop().connect(xa);(new Location$$module$graph2(a,246,da,"Tool Shop")).shop().connect(xa);(new Location$$module$graph2(a,247,da,"Inn")).shop().connect(xa);(new Location$$module$graph2(a,248,
P,"Inn")).shop().connect(ya);(new Location$$module$graph2(a,249,P,"Tool Shop")).shop().connect(ya);(new Location$$module$graph2(a,250,P,"Elder's House")).house().connect(ya);(new Location$$module$graph2(a,251,P,"Pawn Shop")).house().connect(ya);const sh=[fa,Da,Mc,ua,zb,va,Cb,Yc,Eb,U,eb,Hb,Ib,xd,Jb];for(const a of sh)a.from(yb,qe);return a},shuffle$$module$depgraph2=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){var f=generate$$module$depgraph2(d);f.slots();d||(d=new FlagSet$$module$flagset("Sbk Sct Sm"));
var g={};for(var h of f.slots())if(h.slots){var p=h.type?h.type[0]:"c";(g[p]=g[p]||[]).push(h)}h=[];p=[];var n={};for(var l of d.flags.S){var w=[];for(var z of l){n[z]=!0;for(var u of g[z])w.push(u),p.push([u,h.length])}h.push(w)}for(var C of"bc")if(n[C])for(l=g[C],z=l.map((a)=>[a.item,a.index]),a.shuffle(z),u=0;u<l.length;u++)l[u].set(...z[u]);g=f.findSlot("Sword of Wind");C=f.findSlot("Sword of Fire");l=f.findSlot("Ball of Wind");z=f.findSlot("Ball of Fire");u=f.findSlot("Statue of Onyx");w=f.findSlot("Gas Mask");
n.k&&a.nextInt(2)&&(C.swap(g),z.swap(l));n.k&&!a.nextInt(3)&&u.swap(w);n=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];g=[];e&&e.addTasks(10);for(C=0;1E3>C;C++){e&&0==C%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));a.shuffle(p);for(const b of h)a.shuffle(b);l=h.map(()=>-1);z=n[a.nextInt(n.length)];u=[];const b=(a)=>(a instanceof Chest$$module$graph2||a instanceof BossDrop$$module$graph2)&&9!==a.origIndex,c=(a)=>13<=a&&36>=a||38===a||40===a||49===a||72<a;w=(a,d)=>a.index===d.index||!(112!==a.index||
d instanceof Chest$$module$graph2&&!d.isInvisible)||!(112!==d.index||a instanceof Chest$$module$graph2&&!a.isInvisible)||c(a.index)&&!b(d)||c(d.index)&&!b(a)?!1:!0;for(let a=0;a<z;a++){const [b,c]=p[a],d=h[c][++l[c]];w(b,d)&&(b.swap(d),u.push([b,d]))}if(!u.length)continue;const {win:d,path:hb}=f.traverse();if(d)g=hb;else for(;u.length;){const [a,b]=u.pop();a.swap(b)}}for(const a of f.slots())a.write(b);if(c){c.items=[];c.route=[];for(const a of g){const [b,d]=a;c.route.push(d);null!=b.slotName&&(f=
b.slotName,0>f.indexOf(b.orig)&&(f+=` (normally ${b.orig})`),c.items.push({slotIndex:b.origIndex,itemIndex:b.item.index,origName:b.orig,slotName:b.slotName,itemName:b.item.name,text:`${b.item.name}: ${f}`}))}}});var module$depgraph2={};module$depgraph2.generate=generate$$module$depgraph2;module$depgraph2.shuffle=shuffle$$module$depgraph2;class Edge$$module$graph2{constructor(b,a,c,d){this.left=b;this.right=a;this.arrow=c;this.attrs=d}toDot(){const b=this.attrs.length?` [${this.attrs.join(", ")}]`:"";return`  ${this.left.uid} ${this.arrow} ${this.right.uid}${b};`}}class Node$$module$graph2{constructor(b){this.graph=b;this.hashCode_=b.nodes.length;this.uid="n"+b.nodes.length;b.nodes.push(this)}equals(b){return this.uid===b.uid}hashCode(){return this.hashCode_}toString(){return this.uid}}
class Graph$$module$graph2{constructor(){this.nodes=[]}node(b){return this.nodes[b.substring(1)]}findSlot(b){return this.nodes.find((a)=>a instanceof Slot$$module$graph2&&a.name==b)}toLocationGraph(){const b=[];b.push("digraph locations {","node [shape=record, style=filled, color=white];");const a={},c=new Set,d=[];for(const b of this.nodes)if(b instanceof Location$$module$graph2){let e=a[b.area.uid];b.area.uid in a||(d.push(b.area),e=a[b.area.uid]=[]);e.push(b.toDot());for(const a of b.edges())c.add(a)}for(const c of d)b.push(`  subgraph cluster_${c.uid} {`,
"    style=filled;",'    color="lightgrey";',`    label="${c.name}";`,...a[c.uid],"  }");for(const a of c)b.push(a.toDot());b.push("}");return b.join("\n")}locations(){return this.nodes.filter((b)=>b instanceof Location$$module$graph2)}gettables(){return this.nodes.filter((b)=>b instanceof Slot$$module$graph2||b instanceof Trigger$$module$graph2)}slots(){return this.nodes.filter((b)=>b instanceof Slot$$module$graph2)}traverse(b=this.locations()[0]){const a=[],c=new Map,d=new Map;var e=(a,...b)=>{for(const c of b){d.has(c)||
d.set(c,new Map);const e=[a,...b];d.get(c).set(e.map((a)=>a.uid).join(" "),e)}};for(const b of this.nodes)if(b instanceof Location$$module$graph2){for(const a of b.connections)e(a.to,a.from,...a.deps,...a.from.bossNode?[a.from.bossNode]:[]),a.bidi&&e(a.from,a.to,...a.deps,...a.to.bossNode?[a.to.bossNode]:[]);for(const {trigger:a,deps:c}of b.triggers)e(a,b,...c);for(const a of b.chests)e(a,b);b.bossNode&&e(b.bossNode,b,...b.bossNode.deps)}else if(b instanceof Condition$$module$graph2)for(const a of b.options)e(b,
...a);else b instanceof Option$$module$graph2?b.value&&a.push([b,[{name:"OPTION"}]]):b instanceof Slot$$module$graph2?e(b.item,b):b instanceof Trigger$$module$graph2&&b.slot&&e(b.slot,b);a.push([b,[{name:"START"}]]);b=new Set(this.gettables());for(e=new Map;b.size&&a.length;){const [f,g]=a.pop();if(!c.has(f)){c.set(f,g);b.delete(f);for(const [b,...g]of(d.get(f)||e).values())c.has(b)||g.every((a)=>c.has(a))&&a.push([b,g])}}return{win:!b.size,seen:c,path:[...c].map(([a,b])=>{const c=(a)=>[a instanceof
Location$$module$graph2?a.area.name+": ":"",a.name,a instanceof Slot$$module$graph2&&a.index!=a.id?" $"+a.index.toString(16):""];return[a,[...c(a)," [",b.map((a)=>c(a).join("").replace(/\s+\(.*\)/,"")).join(", "),"]"].join("")]})}}integrate(b={}){return integrateLocations$$module$graph2(this,b)}}
class Depgraph$$module$graph2{constructor(){this.graph=new Map;this.removed=new Set}addRoute(b,a){if(this.removed.has(b))throw Error(`Attempted to add a route for finalized node ${b}`);this.graph.has(b)||this.graph.set(b,new Map);for(a=new Set(a);;){var c=!1;for(var d of a){if(d===b)return[];if(this.removed.has(d)){c=this.graph.get(d)||new Map;if(!c.size)return[];a.delete(d);if(1==c.size){for(const b of c.values().next().value)a.add(b);c=!0;break}d=new Map;for(var e of c.values())for(var f of this.addRoute(b,
[...a,...e]))d.set(f.label,f);return[...d.values()]}}if(!c)break}e=[...a].sort();a=new Set(e);e=e.join(" ");f=this.graph.get(b);if(f.has(e))return[];for(const [b,c]of f){if(containsAll$$module$graph2(a,c))return[];containsAll$$module$graph2(c,a)&&f.delete(b)}f.set(e,a);return[new Depgraph$$module$graph2.Route(b,a,`${b}:${e}`)]}integrateOut(b){this.graph.get(b)||new Map;this.removed.add(b);for(const [a,c]of this.graph)for(const [d,e]of c)if(e.has(b)){const b=this.removed.has(a);b&&this.removed.delete(a);
c.delete(d);this.addRoute(a,e);b&&this.removed.add(a)}}}Depgraph$$module$graph2.Route=class{constructor(b,a,c){this.target=b;this.deps=a;this.label=c}};
const integrateLocations$$module$graph2=(b,{start:a=b.locations()[0],removeConditions:c=!0,removeTriggers:d=!0,removeOptions:e=!0}={})=>{const f={};var g=new Set;const h=new Depgraph$$module$graph2;for(const a of b.nodes)if(e&&a instanceof Option$$module$graph2&&(a.value&&h.addRoute(a.uid,[]),h.integrateOut(a.uid)),a instanceof Location$$module$graph2){f[a.uid]=[];for(const b of a.connections)g.has(b)||(g.add(b),b.bidi&&g.add(b.reverse()));if(d){for(const {trigger:b,deps:c}of a.triggers)h.addRoute(b.uid,
[a.uid,...c.map((a)=>a.uid)]);a.bossNode&&h.addRoute(a.bossNode.uid,[a.uid,...a.bossNode.deps.map((a)=>a.uid)])}for(const b of a.chests)h.addRoute(b.uid,[a.uid])}for(const a of g)f[a.from.uid].push(a);if(d)for(const a of b.nodes)a instanceof Trigger$$module$graph2&&(a.slot&&h.addRoute(a.slot.uid,[a.uid]),h.integrateOut(a.uid));a=h.addRoute(a.uid,[])[0];a=new Map([[a.label,a]]);for(d=a.values();!(e=d.next()).done;){e=e.value;for(const b of f[e.target]){g=[...e.deps,...b.deps.map((a)=>a.uid)];b.from.bossNode&&
g.push(b.from.bossNode.uid);for(const c of h.addRoute(b.to.uid,g))a.has(c.label)||a.set(c.label,c)}}if(c)for(const a of b.nodes)if(a instanceof Condition$$module$graph2){for(const b of a.options)h.addRoute(a.uid,b.map((a)=>a.uid));h.integrateOut(a.uid)}for(const a of h.graph.keys())h.integrateOut(a);return h},containsAll$$module$graph2=(b,a)=>{if(b.size<a.size)return!1;for(const c of a)if(!b.has(c))return!1;return!0};
class Option$$module$graph2 extends Node$$module$graph2{constructor(b,a,c){super(b);this.name=a;this.value=c}toString(){return`Option ${this.name}`}}
class Slot$$module$graph2 extends Node$$module$graph2{constructor(b,a,c,d,e=[]){super(b);this.slotName=a;this.item=c;this.index=d;this.slots=e;this.type=c instanceof Magic$$module$graph2?"magic":null;this.origIndex=d;this.orig=c.name}toString(){return`Slot ${this.orig}`}get name(){return this.item.name}get name2(){return this.name==this.orig?this.name:`${this.name} (${this.orig})`}set(b,a){this.item=b;this.index=a}write(b){if(this.slots)for(const a of this.slots)a(b.subarray(16),this)}swap(b){const a=
this.item,c=this.index;this.set(b.item,b.index);b.set(a,c)}key(){this.type="key";return this}bonus(){this.type="bonus";return this}direct(b){this.slots.push((a,c)=>{a[b]=c.index});return this}npcSpawn(b,a=null,c=0){this.slots.push((d,e)=>{let f=addr$$module$graph2(d,116192,81920,b);for(;null!=a&&d[f]!=a;){for(f++;!(d[f]&128);)f+=2,checkBounds$$module$graph2(f,d,this.name2,a);f+=2;checkBounds$$module$graph2(f,d,this.name2,a)}f+=2*c+1;d[f]&=-2;d[f]|=2;d[f+1]=e.index});return this}dialog(b,a=null,c=
0,d=null){this.slots.push((e,f)=>{let g=addr$$module$graph2(e,117085,81920,b);for(;e[g]&128;)g+=4,checkBounds$$module$graph2(g,e,this.name2);let h=0;for(;255!=e[g];)null!=a&&e[g]==a&&(h=e[g+1]),g+=2,checkBounds$$module$graph2(g,e,a);for(g+=h+1;c;){if(e[g]&64){for(g+=5;!(e[g]&64);)g+=2,checkBounds$$module$graph2(g,e,this.name2);g+=2}else g+=5;--c}if(null!=d)for(g+=5;d;)g+=2,--d;e[g]&=-2;e[g]|=2;e[g+1]=f.index});return this}trigger(b,a=0,c=null){this.slots.push((d,e)=>{let f=addr$$module$graph2(d,123258,
81920,b&127);if(null==c)f+=2*a;else{for(;!(d[f]&128);)f+=2,checkBounds$$module$graph2(f,d,this.name2);f=f+4+2*c}d[f]&=-2;d[f]|=2;d[f+1]=e.index});return this}}class BossDrop$$module$graph2 extends Slot$$module$graph2{}
class Chest$$module$graph2 extends Slot$$module$graph2{constructor(...b){super(...b);this.spawnSlot=null;this.isInvisible=!1}objectSlot(b,a){this.spawnSlot=a;this.slots.push((c,d)=>{const e=addr$$module$graph2(c,102913,65536,b)+4*(a-11);c[e-1]=112===d.index?c[e-1]|128:c[e-1]&127;c[e]=d.index});return this}invisible(b){this.isInvisible=!0;return this.direct(b)}}const addr$$module$graph2=(b,a,c,d)=>(b[a+2*d]|b[a+2*d+1]<<8)+c;
class ItemGet$$module$graph2 extends Node$$module$graph2{constructor(b,a,c,d,e){super(b);this.id=a;this.name=c}toString(){return`ItemGet ${this.name}`}chest(b=this.name+" chest",a=this.id){return new Chest$$module$graph2(this.graph,b,this,a)}fromPerson(b,a,c=0){return this.direct(b,33008|(a&-4)<<6|(a&3)<<2|c)}bossDrop(b,a,c=this.id){return new BossDrop$$module$graph2(this.graph,b,this,c,[(b,c)=>{const d=addr$$module$graph2(b,129387,81920,a)+4;b[d]=c.index}])}direct(b,a){return new Slot$$module$graph2(this.graph,
b,this,this.id,[(b,d)=>{b[a]=d.index}])}fixed(){return new Slot$$module$graph2(this.graph,null,this,this.id,null)}}class Item$$module$graph2 extends ItemGet$$module$graph2{}class Magic$$module$graph2 extends ItemGet$$module$graph2{}class Trigger$$module$graph2 extends Node$$module$graph2{constructor(b,a){super(b);this.name=a;this.slot=null}toString(){return`Trigger ${this.name}`}get(b){if(this.slot)throw Error("already have a slot");this.slot=b;return this}}
class Condition$$module$graph2 extends Node$$module$graph2{constructor(b,a){super(b);this.name=a;this.options=[]}toString(){return`Condition ${this.name}`}option(...b){this.options.push(b.map((a)=>a instanceof Slot$$module$graph2?a.item:a));return this}}class Boss$$module$graph2 extends Trigger$$module$graph2{constructor(b,a,c,...d){super(b,c);this.index=a;this.deps=d.map((a)=>a instanceof Slot$$module$graph2?a.item:a)}toString(){return`Boss ${this.name}`}}
class Area$$module$graph2 extends Node$$module$graph2{constructor(b,a){super(b);this.name=a}}
class Connection$$module$graph2{constructor(b,a,c=!1,d=[]){this.from=b;this.to=a;this.bidi=c;this.deps=d.map((a)=>a instanceof Slot$$module$graph2?a.item:a)}reverse(){return new Connection$$module$graph2(this.to,this.from,this.bidi,this.deps)}toDot(){var b=[];this.deps.length&&b.push(`label="${this.deps.map((a)=>a.name).join(", ")}"`);this.bidi&&b.push("dir=none");b=b.length?` [${b.join(", ")}]`:"";return`  ${this.from.uid} -> ${this.to.uid}${b};`}}
class Location$$module$graph2 extends Node$$module$graph2{constructor(b,a,c,d){super(b);this.id=a;this.area=c;this.name=d;this.connections=[];this.triggers=[];this.chests=[];this.type=this.bossNode=null}toString(){return`Location ${this.id.toString(16).padStart(2,0)} ${this.name}`}addConnection(b){b.from.connections.push(b);b.to.connections.push(b);return this}from(b,...a){return this.addConnection(new Connection$$module$graph2(b,this,!1,a))}to(b,...a){return this.addConnection(new Connection$$module$graph2(this,
b,!1,a))}connect(b,...a){return this.addConnection(new Connection$$module$graph2(b,this,!0,a))}connectTo(b,...a){return this.addConnection(new Connection$$module$graph2(this,b,!0,a))}chest(b,a,c=void 0){b instanceof Slot$$module$graph2&&!(b instanceof Chest$$module$graph2)&&null!=c&&(b=b.item);b instanceof ItemGet$$module$graph2&&(b=b.chest(void 0,c));a=b.objectSlot(this.id,a);this.chests.push(a);112==a.index&&(a.type="trap");if(!a.slotName||a.slotName.endsWith(" chest"))a.slotName=b.name+" chest in "+
this.area.name;return this}trigger(b,...a){this.triggers.push({trigger:b,deps:a.map((a)=>a instanceof Slot$$module$graph2?a.item:a)});return this}boss(b){this.bossNode=b;return this}overworld(){this.type="overworld";return this}town(){this.type="town";return this}cave(){this.type="cave";return this}sea(){this.type="sea";return this}fortress(){this.type="fortress";return this}house(){this.type="house";return this}shop(){this.type="house";return this}misc(){this.type="misc";return this}edges(){const b=
[...this.connections],a=(a)=>({uid:`${this.uid}_${a.uid}`});for(const c of this.chests)b.push(new Connection$$module$graph2(this,a(c),!1,[]));for(const {trigger:c,deps:d}of this.triggers)b.push(new Connection$$module$graph2(this,a(c),!1,d)),c.slot&&b.push(new Connection$$module$graph2(a(c),a(c.slot),!1,[]));this.bossNode&&this.bossNode.slot&&b.push(new Connection$$module$graph2(this,a(this.bossNode.slot),!1,this.bossNode.deps));return b}toDot(){const b=(a,b)=>`    ${this.uid}_${a.uid} [label="${a.name}", color="${b}", shape=oval];`;
...
this.bossNode&&b.push(this.bossNode.name);return b.join("\\n")}}const checkBounds$$module$graph2=(b,a,...c)=>{if(b>a.length)throw Error("never found: "+c.map((a)=>"number"==typeof a?a.toString(16):a).join(" "));};var module$graph2={};module$graph2.Node=Node$$module$graph2;module$graph2.Graph=Graph$$module$graph2;module$graph2.Option=Option$$module$graph2;module$graph2.Slot=Slot$$module$graph2;module$graph2.BossDrop=BossDrop$$module$graph2;module$graph2.Chest=Chest$$module$graph2;
module$graph2.ItemGet=ItemGet$$module$graph2;module$graph2.Item=Item$$module$graph2;module$graph2.Magic=Magic$$module$graph2;module$graph2.Trigger=Trigger$$module$graph2;module$graph2.Condition=Condition$$module$graph2;module$graph2.Boss=Boss$$module$graph2;module$graph2.Area=Area$$module$graph2;module$graph2.Location=Location$$module$graph2;const seq$$module$rom=(b,a)=>{a=void 0===a?(a)=>a:a;return Array(b).fill(0).map((b,d)=>a(d))},slice$$module$rom=(b,a,c)=>b.slice(a,a+c),signed$$module$rom=(b)=>128>b?b:b-256,varSlice$$module$rom=(b,a,c,d,e)=>{e=void 0===e?Infinity:e;const f=[];for(;a+c<=e&&b[a]!=d;)f.push(b.slice(a,a+c)),a+=c;return f},addr$$module$rom=(b,a,c)=>(b[a]|b[a+1]<<8)+(void 0===c?0:c),group$$module$rom=(b,a)=>seq$$module$rom(Math.max(0,Math.floor(a.length/b)),(c)=>slice$$module$rom(a,c*b,b)),reverseBits$$module$rom=(b)=>
...
RNMX$$module$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}}}var module$random={};module$random.Random=Random$$module$random;const STATUS$$module$version="unstable",VERSION$$module$version="latest",LABEL$$module$version="latest ()",HASH$$module$version="fb549d2c1f702557a713a3c344c62f31a8d53894",DATE$$module$version=new Date(1551087281E3);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c;a.seed||(a.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+a.seed);c=a.flags?new FlagSet$$module$flagset(a.flags):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$patch(b,parseSeed$$module$patch(a.seed),c)})}};
...
c.check("Ts")&&leatherBootsForSpeed$$module$patch.apply(b);c.check("Di")&&neverDie$$module$patch.apply(b);c.check("Ta")&&autoEquipBracelet$$module$patch.apply(b);return stampVersionSeedAndHash$$module$patch(b,a,c)}),stampVersionSeedAndHash$$module$patch=(b,a,c)=>{const d=crc32$$module$crc32(b).toString(16).padStart(8,0).toUpperCase(),e="unstable"==STATUS$$module$version?HASH$$module$version.substring(0,7).padStart(7,0).toUpperCase():VERSION$$module$version;a=a.toString(16).padStart(8,0).toUpperCase();
const f=(a,c)=>{for(let d=0;d<c.length;d++)b[a+16+d]=c.charCodeAt(d)},g=(a,b)=>{const c=[];for(let d=0;d<a.length||d<b.length;d++)c.push(a[d]||" "),c.push(b[d]||" ");return c.join("")};f(161743,g("  VERSION     SEED      ",`  ${e}     ${a}`));a=String(c);let h;if(46<a.length){if(92<a.length)throw Error("Flag string way too long!");h=a.substring(46,92).padEnd(46," ");a=a.substring(0,46)}a=a.padEnd(46," ");f(161791,g(a.substring(0,23),a.substring(23)));h&&f(161839,g(h.substring(0,23),h.substring(23)));
f(161925,g(d.substring(0,4),d.substring(4)));f(153366,"RANDOMIZER");f(153404,"BETA");return d},watchForFlag0$$module$patch=buildRomPatch$$module$6502(assemble$$module$6502("\n.bank $3c000 $c000:$4000\n\n;;;; TODO - REMOVE THIS ONCE IT'S SOLVED\n.org $3cb62 ; main game mode jump 08\n  jsr CheckFlag0\n.org $3fe80\nReadControllersWithDirections:\n.org $3d347\nInitiateDialog:\n\n.org $3fdd0 ; !!! - note itemLib (I think) uses this space, too\nCheckFlag0:\n  lda $6480\n  lsr\n  bcc +\n   asl\n   sta $6480\n   lda #$00\n   sta $20\n   sta $21\n   ldx #$0c\n-   lda $6140,x\n    eor #$ff\n    sta $6140,x\n    dex\n   bpl -\n   jsr InitiateDialog\n+ jmp ReadControllersWithDirections\n\n",
...
,,,8,,,],[247,"p","skeleton shot",,,,11,,,],[248,"p","lavaman shot",,,,14,,,],[249,"p","black knight flail",,,,18,,,],[250,"p","lizardman flail",,,,21,,,],[252,"p","mado shuriken",,,,36,,,],[253,"p","guardian statue missile",,,,23,,,],[254,"p","demon wall fire",,,,23,,,]].map((b)=>{var [a,c,d,e=0,f=0,g=0,h=0,p=0,n=0]=b;return[a,{id:a,type:c,name:d,sdef:e,swrd:f,hits:g,satk:h,dgld:p,sexp:n}]}));
...
this.report["$"+d.id.toString(16).padStart(2,0)]=[];const {maxFlyers:g,nonFlyers:h={},fixedSlots:p={}}=MONSTER_ADJUSTMENTS$$module$patch[d.id]||{};let n=p.pat0||null,l=p.pat1||null,w=p.pal2||null,z=p.pal3||null,u=g,C=!1;for(const b of d.objects||[])if(2==(b[2]&7)&&(C=!0),!(b[2]&7)){var a=b[3]+80;126==a||127==a||159==a?l=98:143==a&&(n=97)}if(21==d.id||71==d.id)C=!1;f.push(`Initial pass: ${[C,n,l,w,z].join(", ")}`);a=(a)=>{var b=FLYERS$$module$patch.has(a.id),c=MOTHS_AND_BATS$$module$patch.has(a.id);
if(b){if(!u)return!1;--u}if(null!=w&&null!=a.pal2&&w!=a.pal2||null!=z&&null!=a.pal3&&z!=a.pal3)return!1;var g=!C||TREASURE_CHEST_BANKS$$module$patch.has(a.pat);let p;if(d.rom.objects[a.id].child||RETAIN_SLOTS$$module$patch.has(a.id)){const b=(p=a.patSlot?128:0)?l:n;if(null!=b&&b!=a.pat)return!1;if(p)l=a.pat;else if(g)n=a.pat;else return!1;f.push(`  Adding ${a.id.toString(16)}: pat(${p}) <-  ${a.pat.toString(16)}`)}else if(null==n&&g||n==a.pat)n=a.pat,p=0,f.push(`  Adding ${a.id.toString(16)}: pat0 <-  ${a.pat.toString(16)}`);
...
module$patch.buffMedicalHerb2x=buffMedicalHerb2x$$module$patch;module$patch.disableWildWarp=disableWildWarp$$module$patch;module$patch.preventSwordClobber=preventSwordClobber$$module$patch;module$patch.upgradeBallsToBracelets=upgradeBallsToBracelets$$module$patch;module$patch.neverDie=neverDie$$module$patch;module$patch.fixVampire=fixVampire$$module$patch;module$patch.itemLib=itemLib$$module$patch;module$patch.quickChangeItems=quickChangeItems$$module$patch;module$patch.leatherBootsForSpeed=leatherBootsForSpeed$$module$patch;
module$patch.autoEquipBracelet=autoEquipBracelet$$module$patch;module$patch.scaleDifficultyLib=scaleDifficultyLib$$module$patch;class ProgressTracker$$module$progress{constructor(){this.completed=this.tasks=0}addTasks(b){this.tasks+=b}addCompleted(b){this.completed+=b}value(){return this.tasks&&this.completed/this.tasks}}var module$progress={};module$progress.ProgressTracker=ProgressTracker$$module$progress;let flags$$module$main,seed$$module$main,rom$$module$main,romName$$module$main;
const main$$module$main=()=>{loadRomFromStorage$$module$main();initializeStateFromHash$$module$main();document.getElementById("preset").addEventListener("change",setPresets$$module$main);setPresets$$module$main();flags$$module$main||(flags$$module$main=new FlagSet$$module$flagset(document.getElementById("flagstring").value));for(const b of[...document.getElementsByClassName("checkbox")])makeCheckbox$$module$main(b);updateDom$$module$main();addSeedListeners$$module$main();document.body.addEventListener("click",
click$$module$main);window.addEventListener("popstate",(b)=>{b.state?(flags$$module$main.flags=b.state.flags,seed$$module$main=b.state.seed):initializeStateFromHash$$module$main()});"latest"!==HASH$$module$version&&(document.getElementById("version").textContent=`Current version: ${VERSION$$module$version} (${DATE$$module$version.toDateString()})`);document.body.classList.add("js-works");document.body.classList.remove("js-broken");"rc"==STATUS$$module$version&&document.body.classList.add("release-candidate")},
addSeedListeners$$module$main=()=>{const b=document.getElementById("seed"),a=()=>{seed$$module$main=b.value;updateDom$$module$main()};b.addEventListener("keyup",a);b.addEventListener("change",a)},initializeStateFromHash$$module$main=()=>{for(const b of location.hash.substring(1).split("&")){let [a,c]=b.split("=");c=decodeURIComponent(c);"flags"===a&&(flags$$module$main=new FlagSet$$module$flagset(c),document.getElementById("preset").value="--",document.getElementById("flagstring").value=c);"seed"===
a&&(seed$$module$main=decodeURIComponent(c))}},click$$module$main=(b)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){let a=b.target;for(;a;){if("H1"===a.tagName&&a.parentElement.classList.contains("expandable")){a.parentElement.classList.toggle("expanded");break}else if("preset-apply"===a.id){flags$$module$main=new FlagSet$$module$flagset(document.getElementById("flagstring").value);updateDom$$module$main();break}else if("new-seed"===a.id)seed$$module$main=Math.floor(4294967296*Math.random()).toString(16),
updateDom$$module$main();else if("generate"===a.id){var c=parseSeed$$module$patch(seed$$module$main);const [a,b]=yield shuffleRom$$module$main(c);c=romName$$module$main.replace(/\.nes|$/,["_",c.toString(16).padStart(8,0),"_",b.toString(16).padStart(8,0),".nes"].join(""));download$$module$main(a,c)}else"spoiler"===a.id&&shuffleRom$$module$main(parseSeed$$module$patch(seed$$module$main));a=a.parentElement}}),read$$module$main=(b,a,c)=>{const d=[];for(let e=0;e<c;e++)d.push(String.fromCharCode(b[a+2*
e]));return d.join("")},shuffleRom$$module$main=(b)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const a=document.getElementById("progress"),c=new ProgressTracker$$module$progress,d=rom$$module$main.slice();let e=!1;var f=new FlagSet$$module$flagset(String(flags$$module$main));document.body.classList.add("shuffling");const g=flags$$module$main.check("Ds")?{}:void 0,h=()=>{e||(a.value=c.value(),setTimeout(h,120))};h();f=yield shuffle$$module$patch(d,b,f,g,c);e=!0;document.body.classList.remove("shuffling");
g&&(replaceSpoiler$$module$main("spoiler-items",g.items.map((a)=>a.text)),replaceSpoiler$$module$main("spoiler-route",g.route));document.getElementById("checksum").textContent=read$$module$main(d,161941,4)+read$$module$main(d,161942,4);return[d,f]}),replaceSpoiler$$module$main=(b,a)=>{for(b=document.getElementById(b);b.children.length;)b.lastChild.remove();for(const c of a)a=document.createElement("li"),a.textContent=c,b.appendChild(a)},setPresets$$module$main=()=>{const b=document.querySelector("#preset :checked");
document.getElementById("preset-explanation").textContent=b.dataset.text;document.getElementById("flagstring").value=b.dataset.flags},makeCheckbox$$module$main=(b)=>{const a=b.getElementsByClassName("flag-body")[0];a&&a.remove();const [c,d]=b.textContent.split(/:\s*/),e=document.createElement("input");e.type="checkbox";e.id=`flag-${c}`;e.dataset.flag=c;b.parentElement.insertBefore(e,b);const f=document.createElement("label");f.textContent=c;f.htmlFor=e.id;b.parentElement.insertBefore(f,b);const g=
document.createElement("div");b.parentElement.insertBefore(g,b);const h=document.createElement("label");h.textContent=d;h.htmlFor=e.id;g.appendChild(h);a&&g.appendChild(a);b.classList.contains("hard")&&(f.classList.add("hard"),h.classList.add("hard"),h.textContent+=" *");b.remove();e.addEventListener("change",()=>{window.FLAGS=flags$$module$main;flags$$module$main.set(c,e.checked);updateDom$$module$main()})},updateDom$$module$main=()=>{for(var b of document.querySelectorAll("input[data-flag]"))b.checked=
flags$$module$main.check(b.dataset.flag);document.getElementById("seed").value=seed$$module$main||"";b=["#flags=",String(flags$$module$main).replace(/ /g,"")];seed$$module$main&&b.push("&seed=",encodeURIComponent(seed$$module$main));history.replaceState({flags:flags$$module$main.flags,seed:seed$$module$main},"",String(window.location).replace(/#.*/,"")+b.join(""));document.body.classList.toggle("spoiled",flags$$module$main.check("Ds"));document.getElementById("flagstring-out").textContent=String(flags$$module$main);
document.getElementById("track-url").href=`track#flags=${String(flags$$module$main).replace(/ /g,"")}`},loadRomFromStorage$$module$main=()=>{const b=window.localStorage.getItem("name"),a=window.localStorage.getItem("rom"),c=document.getElementById("pick-file"),d=()=>{document.body.classList.add("rom-uploaded");document.body.classList.toggle("rom-broken",crc32$$module$crc32(rom$$module$main)!=EXPECTED_CRC32$$module$rom)};b&&a&&(romName$$module$main=b,rom$$module$main=Uint8Array.from(Array(a.length/
2).fill(0).map((b,c)=>Number.parseInt(a[2*c]+a[2*c+1],16))),d());c.addEventListener("change",()=>{const a=c.files[0],b=new FileReader;b.addEventListener("loadend",()=>{const c=new Uint8Array(b.result),e=Array.from(c,(a)=>a.toString(16).padStart(2,0)).join("");window.localStorage.setItem("rom",e);window.localStorage.setItem("name",a.name);rom$$module$main=c.slice(0,393232);d();romName$$module$main=a.name});b.readAsArrayBuffer(a)})},download$$module$main=(b,a)=>{const c=document.createElement("a");
document.body.appendChild(c);c.style="display: none";b=new Blob([b],{type:"octet/stream"});b=window.URL.createObjectURL(b);c.href=b;c.download=a;c.click();window.URL.revokeObjectURL(b);c.remove()};main$$module$main();var module$main={};
}).call(this)
