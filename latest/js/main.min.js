...
f);b.remove();a(c)});d.readAsArrayBuffer(c)})})}const EXPECTED_CRC32$$module$rom=466849842,ADJUSTMENTS$$module$rom=new Map([[85433,128],[87133,0],[91391,10],[96298,1],[96343,1],[118533,72],[119569,160],[119570,0],[118777,224],[182928,0],[193907,0],[195300,0]]);var module$rom={};module$rom.Rom=Rom$$module$rom;module$rom.EXPECTED_CRC32=EXPECTED_CRC32$$module$rom;const STATUS$$module$version="unstable",VERSION$$module$version="latest",LABEL$$module$version="latest 18636d0",HASH$$module$version="18636d033608898c2cbe85587b1babc4ebdb24f3",DATE$$module$version=new Date(1560507314E3);var module$version={};module$version.STATUS=STATUS$$module$version;module$version.VERSION=VERSION$$module$version;module$version.LABEL=LABEL$$module$version;module$version.HASH=HASH$$module$version;module$version.DATE=DATE$$module$version;var $jscompDefaultExport$$module$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$flagset(String(b.flags)):new FlagSet$$module$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$patch(a,parseSeed$$module$patch(String(b.seed)),d,new FetchReader$$module$fetchreader(c))})}};
const parseSeed$$module$patch=(a)=>a?/^[0-9a-f]{1,8}$/i.test(a)?Number.parseInt(a,16):crc32$$module$crc32(a):Random$$module$random.newSeed(),shuffle$$module$patch=(a,b,c,d,e,f)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){if("number"!==typeof b)throw Error("Bad seed");var g=crc32$$module$crc32(b.toString(16).padStart(8,"0")+String(c))>>>0,h=c.buffDyna();const k={_ALLOW_TELEPORT_OUT_OF_TOWER:!0,_AUTO_EQUIP_BRACELET:c.autoEquipBracelet(),_BARRIER_REQUIRES_CALM_SEA:c.barrierRequiresCalmSea(),
_BUFF_DEOS_PENDANT:c.buffDeosPendant(),_BUFF_DYNA:h,_CHECK_FLAG0:!0,_DEBUG_DIALOG:6076===b,_DISABLE_SHOP_GLITCH:c.disableShopGlitch(),_DISABLE_STATUE_GLITCH:c.disableStatueGlitch(),_DISABLE_SWORD_CHARGE_GLITCH:c.disableSwordChargeGlitch(),_DISABLE_WILD_WARP:!1,_DISPLAY_DIFFICULTY:!0,_EXTRA_PITY_MP:!0,_FIX_OPEL_STATUE:!0,_FIX_SHAKING:!0,_FIX_VAMPIRE:!0,_LEATHER_BOOTS_GIVE_SPEED:c.leatherBootsGiveSpeed(),_NERF_FLIGHT:!0,_NERF_WILD_WARP:c.nerfWildWarp(),_NEVER_DIE:c.neverDie(),_NORMALIZE_SHOP_PRICES:!0,
_PITY_HP_AND_MP:!0,_PROGRESSIVE_BRACELET:!0,_RABBIT_BOOTS_CHARGE_WHILE_WALKING:c.rabbitBootsChargeWhileWalking(),_REQUIRE_HEALED_DOLPHIN_TO_RIDE:c.requireHealedDolphinToRide(),_REVERSIBLE_SWAN_GATE:!0,_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword()},l=new Assembler$$module$6502;h=(b)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){l.assemble(yield d.read(b),b);l.patchRom(a)});var m=Object.keys(k).filter((a)=>k[a]).map((a)=>
`define ${a} 1\n`).join("");l.assemble(m,"flags.s");yield h("preshuffle.s");g=new Random$$module$random(g);m=new Rom$$module$rom(a);makeBraceletsProgressive$$module$patch(m);c.blackoutMode()&&blackoutMode$$module$patch(m);closeCaveEntrances$$module$patch(m,c);reversibleSwanGate$$module$patch(m);adjustGoaFortressTriggers$$module$patch(m);preventNpcDespawns$$module$patch(m,c);c.requireHealedDolphinToRide()&&requireHealedDolphin$$module$patch(m);c.saharaRabbitsRequireTelepathy()&&requireTelepathyForDeo$$module$patch(m);
adjustItemNames$$module$patch(m,c);yield h("postparse.s");alarmFluteIsKeyItem$$module$patch(m);c.teleportOnThunderSword()?teleportOnThunderSword$$module$patch(m):noTeleportOnThunderSword$$module$patch(m);m.scalingLevels=48;m.uniqueItemTableAddress=l.expand("KeyItemData");yield shuffle2$$module$depgraph(m,g,e,c,f);rescaleShops$$module$patch(m,l,c.bargainHunting()?g:void 0);normalizeSwords$$module$patch(m,c,g);rescaleMonsters$$module$patch(m,c,g);c.shuffleMonsters()&&shuffleMonsters$$module$patch(m,
c,g);identifyKeyItemsForDifficultyBuffs$$module$patch(m);c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$patch(m);addCordelWestTriggers$$module$patch(m,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$patch(m);c.storyMode()&&storyMode$$module$patch(m);c.chargeShotsOnly()&&disableStabs$$module$patch(m);c.orbsOptional()&&orbsOptional$$module$patch(m);shuffleMusic$$module$patch(m,c,g);misc$$module$patch(m,
c,g);c.buffDyna&&buffDyna$$module$patch(m,c);yield m.writeData();return yield postParsedShuffle$$module$patch(a,g,b,c,l,h)}),postParsedShuffle$$module$patch=(a,b,c,d,e,f)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){yield f("postshuffle.s");updateDifficultyScalingTables$$module$patch(a,d,e);updateCoinDrops$$module$patch(a,d);shuffleRandomNumbers$$module$patch(a,b);return stampVersionSeedAndHash$$module$patch(a,c,d)});
...
{sdef:l,swrd:m,hits:n,satk:p,dgld:q,sexp:r}]=h;f=a.objects[k].data;g=e.has(k)?1:0;f[2]|=128;f[6]=n;f[7]=p;f[8]=l|m<<4;f[16]=f[16]&15|q<<4;f[17]=r;(g?b.shuffleBossElements():b.shuffleMonsterElements())&&!d.has(k)&&(f=[...a.objects[k].elements.toString(2).padStart(4,"0")],c.shuffle(f),a.objects[k].elements=Number.parseInt(f.join(""),2))}if(b.shuffleMonsterElements()){b=c.nextInt(4);a.prg[152109]=b+1;for(const c of d)a.objects[c].elements=1<<b}},shuffleMonsters$$module$patch=(a,b,c)=>{b=new MonsterPool$$module$patch(b,
