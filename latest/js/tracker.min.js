...
D:h,S),Ee=(new Condition$$module$js$nodes(a,"Match sword of thunder")).option(I).option(D.value?D:h,S),Fe=(new Condition$$module$js$nodes(a,"Swamp run possible")).option(S).option(Dc).option(Md).option(Qa);(new Condition$$module$js$nodes(a,"Insect possible to kill")).option(Pa);const Wa=(new Condition$$module$js$nodes(a,"Travel swamp")).option(Pa).option(Ga.value?Ga:h,Fe),Ge=(new Condition$$module$js$nodes(a,"Calmed sea if required")).option(ub).option(Gd),He=e(0,"Vampire 1",S).get(nb),Ie=e(1,"Insect",
Sb,ue).get(Ia),Je=e(2,"Kelbesque 1",Lc,Hc).get(Ja),Ke=e(12,"Vampire 2",S).get(Xd),Oc=e(4,"Sabera 1",Mc,Ic).get($b),Le=e(5,"Mado 1",Nc,Jc).get(Ma),Me=e(6,"Kelbesque 2",Lc,Hc).get(mb),Ne=e(7,"Sabera 2",Mc,Ic).get(Qb),Oe=e(8,"Mado 2",Nc,Jc).get(Nd),Pe=e(9,"Karmine",Ee,Ae).get(qb),Qe=e(10,"Draygon 1",S).get(Qd),Re=e(null,"Statues",ec,dc),Se=e(11,"Draygon 2",S,fc),Te=e(13,"Dyna",jb),M=new Area$$module$js$nodes(a,"Leaf"),pa=new Area$$module$js$nodes(a,"Valley of Wind"),K=new Area$$module$js$nodes(a,"Sealed Cave"),
ia=new Area$$module$js$nodes(a,"Cordel Plain"),qa=new Area$$module$js$nodes(a,"Brynmaer"),ra=new Area$$module$js$nodes(a,"Amazones"),B=new Area$$module$js$nodes(a,"Mt Sabre West"),u=new Area$$module$js$nodes(a,"Mt Sabre North"),Xa=new Area$$module$js$nodes(a,"Nadare's"),Ca=new Area$$module$js$nodes(a,"Oak"),aa=new Area$$module$js$nodes(a,"Waterfall Valley"),z=new Area$$module$js$nodes(a,"Portoa"),ba=new Area$$module$js$nodes(a,"Waterfall Cave"),C=new Area$$module$js$nodes(a,"Fog Lamp Cave"),ca=new Area$$module$js$nodes(a,
"Kirisa Plant Cave"),ja=new Area$$module$js$nodes(a,"Angry Sea"),da=new Area$$module$js$nodes(a,"Joel"),F=new Area$$module$js$nodes(a,"Evil Spirit Island"),ea=new Area$$module$js$nodes(a,"Sabera's Castle"),N=new Area$$module$js$nodes(a,"Swan"),x=new Area$$module$js$nodes(a,"Mt Hydra"),fa=new Area$$module$js$nodes(a,"Shyron"),ka=new Area$$module$js$nodes(a,"Styx"),la=new Area$$module$js$nodes(a,"Goa"),Ya=new Area$$module$js$nodes(a,"Draygonia Fortress 1"),O=new Area$$module$js$nodes(a,"Draygonia Fortress 2"),
sa=new Area$$module$js$nodes(a,"Draygonia Fortress 3"),H=new Area$$module$js$nodes(a,"Draygonia Fortress 4"),E=new Area$$module$js$nodes(a,"Oasis Cave");new Area$$module$js$nodes(a,"Desert");const P=new Area$$module$js$nodes(a,"Sahara"),ta=new Area$$module$js$nodes(a,"Pyramid Front"),U=new Area$$module$js$nodes(a,"Pyramid Back"),V=new Area$$module$js$nodes(a,"Tower"),yb=(new Location$$module$js$nodes(a,0,M,"Start")).overworld().start(),Ue=(new Location$$module$js$nodes(a,0,M,"Mezame Shrine")).overworld().from(yb),
Ve=(new Location$$module$js$nodes(a,1,M,"Outside Start")).overworld().connect(Ue),ha=(new Location$$module$js$nodes(a,2,M,"Town")).town().connect(Ve),Da=(new Location$$module$js$nodes(a,3,pa,"Main")).overworld().connect(ha).trigger(lc,Ta),Pc=(new Location$$module$js$nodes(a,3,pa,"Outside Windmill")).overworld(),Qc=(new Location$$module$js$nodes(a,4,K,"Tunnel 1 (entrance)")).cave().from(Da,Ta),We=(new Location$$module$js$nodes(a,5,K,"Tunnel 2 (over bridge)")).cave().connect(Qc),Xe=(new Location$$module$js$nodes(a,
6,K,"Tunnel 6 (herb dead end)")).cave().chest(X,15),Rc=(new Location$$module$js$nodes(a,7,K,"Tunnel 4a (ball corridor)")).cave().chest(X,20,80).chest(Ha,21);(new Location$$module$js$nodes(a,7,K,"Tunnel 4b (antidote dead end)")).cave().connect(Rc,v).chest(Oa,19);const Ye=(new Location$$module$js$nodes(a,8,K,"Tunnel 5 (warp boots dead end)")).cave().chest(lb,14),Ze=(new Location$$module$js$nodes(a,9,K,"Tunnel 3a (branch, front)")).cave().connect(We).connectTo(Rc).connectTo(Ye),$e=(new Location$$module$js$nodes(a,
9,K,"Tunnel 3b (branch, back)")).cave().connect(Ze,v).connectTo(Xe),af=(new Location$$module$js$nodes(a,10,K,"Tunnel 7 (boss)")).cave().connect($e).boss(He),bf=(new Location$$module$js$nodes(a,12,K,"Tunnel 8a (exit, above wall)")).cave().connect(af),cf=(new Location$$module$js$nodes(a,12,K,"Tunnel 8b (exit, below wall")).cave().connect(bf,v);(new Location$$module$js$nodes(a,14,pa,"Windmill Cave")).cave().connect(Da).connectTo(Pc).trigger(Yd,ob,rb);(new Location$$module$js$nodes(a,15,pa,"Windmill")).misc().connect(Pc).trigger(Ta,
Vb);const df=(new Location$$module$js$nodes(a,16,pa,"Zebu's Cave Front")).cave().connect(Da).trigger(rb,ic,jc).trigger(lc,Ta,rb),ef=(new Location$$module$js$nodes(a,16,pa,"Zebu's Cave Back")).cave().trigger(oc).connect(df,w),ff=(new Location$$module$js$nodes(a,17,B,"Tunnel 1 (to Zebu)")).cave().connect(ef),ua=(new Location$$module$js$nodes(a,20,ia,"West")).overworld().connect(cf),gf=(new Location$$module$js$nodes(a,20,ia,"South")).overworld().connect(ua,q),Sc=(new Location$$module$js$nodes(a,21,ia,
"East")).overworld().connect(ua).chest(Rb,24),Ea=(new Location$$module$js$nodes(a,24,qa,"Town")).town().connect(ua).trigger(Zd,Rb),hf=(new Location$$module$js$nodes(a,25,ia,"Outside Stom's House")).town().connect(ua),zb=(new Location$$module$js$nodes(a,26,ia,"Swamp")).overworld().connect(Sc,Wa).trigger(sb,nc,Wa);(new Location$$module$js$nodes(a,26,ia,"Swamp Insect Area")).overworld().connect(zb,Wa).boss(Ie);const Za=(new Location$$module$js$nodes(a,27,ra,"Town")).town().connect(gf),$a=(new Location$$module$js$nodes(a,
28,Ca,"Town")).town().connect(zb,Wa).trigger(mc);(new Location$$module$js$nodes(a,30,ia,"Stom's House")).house().connect(hf).trigger($d,mc);const va=(new Location$$module$js$nodes(a,32,B,"Entrance")).overworld().connect(ua).connect(ff),jf=(new Location$$module$js$nodes(a,32,B,"Up Slope")).overworld().from(va,Ec).to(va),kf=(new Location$$module$js$nodes(a,32,B,"Dead End (warp boots)")).overworld().chest(lb,24,106),Tc=(new Location$$module$js$nodes(a,33,B,"Upper")).overworld().from(va,A).to(va),lf=
(new Location$$module$js$nodes(a,33,B,"Tornel Dead End")).overworld().trigger(ce,za).chest(Y,23,105),Uc=(new Location$$module$js$nodes(a,34,B,"Tunnel 2a (fork at start)")).cave().connect(va);(new Location$$module$js$nodes(a,34,B,"Tunnel 2b (left branch to dead end)")).cave().connect(Uc,w).connectTo(kf);const mf=(new Location$$module$js$nodes(a,34,B,"Tunnel 2c (right branch to upper)")).cave().connect(Uc,w),nf=(new Location$$module$js$nodes(a,35,B,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(mf).chest(X,
...
87),Lg=(new Location$$module$js$nodes(a,137,ka,"Right branch")).fortress().connect(xd);(new Location$$module$js$nodes(a,137,ka,"Right branch, across water")).fortress().connect(Lg,A).chest(G,20,118).chest(G,21,119).chest(Od,28);(new Location$$module$js$nodes(a,138,ka,"Upper floor")).fortress().connect(Kg).chest(I,27);const xa=(new Location$$module$js$nodes(a,140,fa,"Town")).town().connect(Cg,Kc).trigger(vb),Fa=(new Location$$module$js$nodes(a,142,la,"Town")).town().connect(fb),yd=(new Location$$module$js$nodes(a,
...
(new Location$$module$js$nodes(a,167,U,"Teleporter")).fortress().from(ch).to(kd);const Bd=(new Location$$module$js$nodes(a,168,Ya,"Entrance")).fortress().connect(Fa,xb).trigger(Cc,I),dh=(new Location$$module$js$nodes(a,169,Ya,"Main")).fortress().from(Bd,oa),eh=(new Location$$module$js$nodes(a,169,Ya,"Boss")).fortress().connect(dh).boss(Me),fh=(new Location$$module$js$nodes(a,170,Ya,"Zebu")).fortress().connect(eh),hb=(new Location$$module$js$nodes(a,171,O,"Entrance")).fortress().connect(fh);(new Location$$module$js$nodes(a,
...
174,sa,"Upper Loop")).fortress().connect(Cd).chest(Oa,22,96);(new Location$$module$js$nodes(a,174,sa,"Upper Loop Behind Wall (magic ring)")).fortress().connect(lh,oa).chest(Y,23,107);const mh=(new Location$$module$js$nodes(a,175,sa,"Upper Passage (toward Mado)")).fortress().connect(Cd).chest(Y,27,84),Mb=(new Location$$module$js$nodes(a,176,H,"Initial Fork")).fortress(),nh=(new Location$$module$js$nodes(a,177,H,"Left Branch")).fortress().connect(Mb),Dd=(new Location$$module$js$nodes(a,178,H,"Main Area (right branch, over bridges)")).fortress().connect(Mb),
...
182,H,"Boss Corridor")).fortress().connect(qh),sh=(new Location$$module$js$nodes(a,182,H,"Boss")).fortress().connect(rh,xb).boss(Pe);(new Location$$module$js$nodes(a,182,H,"Behind Boss (stormBracelet)")).fortress().connect(sh).chest(Na,18);const Fd=(new Location$$module$js$nodes(a,183,H,"Exit Stairs")).fortress(),th=(new Location$$module$js$nodes(a,184,E,"Entrance Back (behind river)")).cave().connect(Fd).chest(Aa,13,90);(new Location$$module$js$nodes(a,184,E,"Entrance Front")).cave().connect(th,
...
Z).trigger(be,sb);(new Location$$module$js$nodes(a,206,Ca,"Mother's House")).house().from($a,Z).trigger(nc,Z).trigger(ae,sb);(new Location$$module$js$nodes(a,207,Ca,"Tool Shop")).shop().from($a,Z);(new Location$$module$js$nodes(a,208,Ca,"Inn")).shop().from($a,Z);(new Location$$module$js$nodes(a,209,ra,"Inn")).shop().connect(Za);(new Location$$module$js$nodes(a,210,ra,"Tool Shop")).shop().connect(Za);(new Location$$module$js$nodes(a,211,ra,"Armor Shop")).shop().connect(Za);const vh=(new Location$$module$js$nodes(a,
...
249,P,"Tool Shop")).shop().connect(ya);(new Location$$module$js$nodes(a,250,P,"Elder's House")).house().connect(ya);(new Location$$module$js$nodes(a,251,P,"Pawn Shop")).house().connect(ya);const yh=[ha,Da,Qc,ua,zb,va,Cb,bd,Eb,W,fb,Hb,Ib,Bd,Jb];for(const a of yh)a.from(yb,te);return a},shuffle$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes);d||(d=new FlagSet$$module$js$flagset("Sbkm Sct"));
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="latest",LABEL$$module$js$version="latest c982835",HASH$$module$js$version="c98283583108200876297df0a3533e9c6e1f0885",DATE$$module$js$version=new Date(1552285762E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c;a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);c=a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$js$patch(b,parseSeed$$module$js$patch(a.seed),c)})}};
