...
af.HUD_CLOSE_RIGHT),a.writeMonsterNames=!0);b.shouldColorSwordElements()&&mf(a);if(b.hasStatTracking()&&40!==a.prg[143082]){a.prg[143082]=40;for(let b=0;4>b;b++)a.patterns.set(5376,41+b,af.BLANK_TILES[b]);for(let b=143364;144132>b;b++)41<=a.prg[b]&&45>=a.prg[b]&&(a.prg[b]+=127);for(let b=143364;144132>b;b+=192)a.prg[b+160]=42;var d=new Map([[66,160]]);for(let b=142469;142546>b;b++)d.has(a.prg[b])&&(a.prg[b]=d.get(a.prg[b]));for(let b=143364;144132>b;b+=192)for(let c=123;127>=c;c++)169==a.prg[b+c]&&
(a.prg[b+c]=42);for(let b=144376;144440>b;b++){let c=a.prg[b];for(let a=0;8>a;a+=2){const b=3<<a,d=2<<a;(c&b)==b&&(c=c&(255^3<<a)|d)}a.prg[b]=c}var e=[15,48,15,17];for(let b=0;b<e.length;b++)a.prg[144452+b]=e[b];a.prg[144451]=8;for(let b=145114;145222>b;b+=4)a.prg[b]+=128}}
