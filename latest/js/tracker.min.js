...
29).dialog(29,null,3).key(),L=d(2,"Sword of Water").weight(10).chest().key(),I=d(3,"Sword of Thunder").weight(15).chest().key(),jb=d(4,"Crystalis").fixed(),Ia=d(5,"Ball of Wind").chest().key(),za=d(6,"Tornado Bracelet").chest().key(),Ja=d(7,"Ball of Fire").bossDrop("Insect",1).dialog(30,null,0).dialog(32,null,0).dialog(33,null,0).dialog(34,null,0).dialog(96,30,0).dialog(29,null,2).dialog(31,null,0).npcSpawn(193).key(),Ka=d(8,"Flame Bracelet").bossDrop("Kelbesque 1",2).npcSpawn(194).key(),La=d(9,"Ball of Water").weight(5).direct("Rage",
250679).npcSpawn(195).key(),Ma=d(10,"Blizzard Bracelet").weight(5).chest().key(),Na=d(11,"Ball of Thunder").bossDrop("Mado 1",5).trigger(154,1).key(),Oa=d(12,"Storm Bracelet").chest().key();d(13,"Carapace Shield").armor();d(14,"Bronze Shield").armor();d(15,"Platinum Shield").armor();d(16,"Mirrored Shield").armor();d(17,"Ceramic Shield").armor();const Nd=d(18,"Sacred Shield").armor().bossDrop("Mado 2",8).npcSpawn(199).bonus();d(19,"Battle Shield").armor();const Od=d(20,"Psycho Shield").armor();d(21,
"Tanned Hide").armor();d(22,"Leather Armor").armor();d(23,"Bronze Armor").armor();d(24,"Platinmum Armor").armor();d(25,"Soldier Suit").armor();d(26,"Ceramic Suit").armor();const Pd=d(27,"Battle Suit").armor(),Qd=d(28,"Psycho Armor").armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),X=d(29,"Medical Herb").consumable(),Pa=d(30,"Antidote").consumable(),kb=d(31,"Lysis Plant").consumable(),Rd=d(32,"Fruit of Lime").consumable(),Aa=d(33,"Fruit of Power").consumable(),Y=d(34,
"Magic Ring").consumable(),Qb=d(35,"Fruit of Repun").consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),lb=d(36,"Warp Boots").consumable(),Rb=d(37,"Statue of Onyx").chest("Cordel grass").invisible(254882).key(),mb=d(38,"Opel Statue").consumable().bossDrop("Kelbesque 2",6).npcSpawn(197).key(),Sb=d(39,"Insect Flute").fromPerson("Oak mother",30).dialog(30,null,1).key(),Ba=d(40,"Flute of Lime").fromPerson("Portoa queen",56).direct(39161).dialog(56,null,4).key(),Qa=d(41,"Gas Mask").direct("Akahana in Brynmaer",
...
156,1).dialog(131,null,0).key(),Ca=(new Magic$$module$js$nodes(a,65,"Refresh",65,null)).fromPerson("Zebu at windmill",94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),Ra=(new Magic$$module$js$nodes(a,66,"Paralysis",66,null)).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),Z=(new Magic$$module$js$nodes(a,67,"Telepathy",67,null)).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),gc=(new Magic$$module$js$nodes(a,68,"Teleport",
...
(new Condition$$module$js$nodes(a,"Sword charge glitch")).option(Ld),re=(new Condition$$module$js$nodes(a,"Rabbit skip")).option(p),se=(new Condition$$module$js$nodes(a,"Teleport skip")).option(l),wb=(new Condition$$module$js$nodes(a,"Statue glitch")).option(t),te=(new Condition$$module$js$nodes(a,"Wild warp")).option(Jd,Kd),Va=(new Condition$$module$js$nodes(a,"Any level 2 sword")).option(Q,Ia).option(Q,za).option(R,Ja).option(R,Ka).option(L,La).option(L,Ma).option(I,Na).option(I,Oa),v=(new Condition$$module$js$nodes(a,
"Destroy stone")).option(Q,Ia).option(Q,za).option(Ua,Q,Va),w=(new Condition$$module$js$nodes(a,"Destroy ice")).option(R,Ja).option(R,Ka).option(Ua,R,Va),q=(new Condition$$module$js$nodes(a,"Cross rivers")).option(L,La).option(L,Ma).option(A).option(Ua,L,Va),oa=(new Condition$$module$js$nodes(a,"Destroy iron")).option(I,Na).option(I,Oa).option(Ua,I,Va),S=(new Condition$$module$js$nodes(a,"Any sword")).option(Q).option(R).option(L).option(I),ue=(new Condition$$module$js$nodes(a,"Match insect sword (fire/water/thunder)")).option(R).option(L).option(I).option(Qa,
...
Gc=(new Condition$$module$js$nodes(a,"Ride dolphin")).option(pb,xc),ye=(new Condition$$module$js$nodes(a,"Ghetto flight")).option(n,Gc,nb),T=(new Condition$$module$js$nodes(a,"Cross sea")).option(Gc).option(A),ze=(new Condition$$module$js$nodes(a,"Cross whirlpool")).option(ub).option(A).option(ye),J=(new Condition$$module$js$nodes(a,"Refresh if needed")).option(Pb.value?Pb:h).option(Ca),Hc=(new Condition$$module$js$nodes(a,"Wind magic")).option(y.value?y:h,J).option(Ia,za,J),Ic=(new Condition$$module$js$nodes(a,
"Fire magic")).option(y.value?y:h,J).option(Ja,Ka,J),Jc=(new Condition$$module$js$nodes(a,"Water magic")).option(y.value?y:h,J).option(y,J).option(La,Ma,J),Ae=(new Condition$$module$js$nodes(a,"Thunder magic")).option(y.value?y:h,J).option(y,J).option(Na,J).option(Oa,J),Be=(new Condition$$module$js$nodes(a,"Flute of lime or glitch")).option(Ba).option(wb).option(Sa.value?Sa:g),Ce=(new Condition$$module$js$nodes(a,"Second flute of lime")).option(Sa).option(Ba.value?Ba:g),Kc=(new Condition$$module$js$nodes(a,
"Change or glitch")).option(na).option(wb),xb=(new Condition$$module$js$nodes(a,"Pass shooting statues")).option(hc).option(Ob.value?Ob:h).option(Ca,Ub),De=(new Condition$$module$js$nodes(a,"Healed dolphin if required")).option(wc).option(ib),Lc=(new Condition$$module$js$nodes(a,"Match sword of wind")).option(Q).option(D.value?D:h,S),Mc=(new Condition$$module$js$nodes(a,"Match sword of fire")).option(R).option(D.value?D:h,S),Nc=(new Condition$$module$js$nodes(a,"Match sword of water")).option(L).option(D.value?
D:h,S),Ee=(new Condition$$module$js$nodes(a,"Match sword of thunder")).option(I).option(D.value?D:h,S),Fe=(new Condition$$module$js$nodes(a,"Swamp run possible")).option(S).option(Dc).option(Md).option(Ca);(new Condition$$module$js$nodes(a,"Insect possible to kill")).option(Qa).option(Ca);const Wa=(new Condition$$module$js$nodes(a,"Travel swamp")).option(Qa).option(Ha.value?Ha:h,Fe),Ge=(new Condition$$module$js$nodes(a,"Calmed sea if required")).option(ub).option(Gd),He=e(0,"Vampire 1",S).get(nb),
Ie=e(1,"Insect",Sb,ue).get(Ja),Je=e(2,"Kelbesque 1",Lc,Hc).get(Ka),Ke=e(12,"Vampire 2",S).get(Xd),Oc=e(4,"Sabera 1",Mc,Ic).get($b),Le=e(5,"Mado 1",Nc,Jc).get(Na),Me=e(6,"Kelbesque 2",Lc,Hc).get(mb),Ne=e(7,"Sabera 2",Mc,Ic).get(Qb),Oe=e(8,"Mado 2",Nc,Jc).get(Nd),Pe=e(9,"Karmine",Ee,Ae).get(qb),Qe=e(10,"Draygon 1",S).get(Qd),Re=e(null,"Statues",ec,dc),Se=e(11,"Draygon 2",S,fc),Te=e(13,"Dyna",jb),M=new Area$$module$js$nodes(a,"Leaf"),pa=new Area$$module$js$nodes(a,"Valley of Wind"),K=new Area$$module$js$nodes(a,
"Sealed Cave"),ia=new Area$$module$js$nodes(a,"Cordel Plain"),qa=new Area$$module$js$nodes(a,"Brynmaer"),ra=new Area$$module$js$nodes(a,"Amazones"),B=new Area$$module$js$nodes(a,"Mt Sabre West"),u=new Area$$module$js$nodes(a,"Mt Sabre North"),Xa=new Area$$module$js$nodes(a,"Nadare's"),Da=new Area$$module$js$nodes(a,"Oak"),aa=new Area$$module$js$nodes(a,"Waterfall Valley"),z=new Area$$module$js$nodes(a,"Portoa"),ba=new Area$$module$js$nodes(a,"Waterfall Cave"),C=new Area$$module$js$nodes(a,"Fog Lamp Cave"),
ca=new Area$$module$js$nodes(a,"Kirisa Plant Cave"),ja=new Area$$module$js$nodes(a,"Angry Sea"),da=new Area$$module$js$nodes(a,"Joel"),F=new Area$$module$js$nodes(a,"Evil Spirit Island"),ea=new Area$$module$js$nodes(a,"Sabera's Castle"),N=new Area$$module$js$nodes(a,"Swan"),x=new Area$$module$js$nodes(a,"Mt Hydra"),fa=new Area$$module$js$nodes(a,"Shyron"),ka=new Area$$module$js$nodes(a,"Styx"),la=new Area$$module$js$nodes(a,"Goa"),Ya=new Area$$module$js$nodes(a,"Draygonia Fortress 1"),O=new Area$$module$js$nodes(a,
"Draygonia Fortress 2"),sa=new Area$$module$js$nodes(a,"Draygonia Fortress 3"),H=new Area$$module$js$nodes(a,"Draygonia Fortress 4"),E=new Area$$module$js$nodes(a,"Oasis Cave");new Area$$module$js$nodes(a,"Desert");const P=new Area$$module$js$nodes(a,"Sahara"),ta=new Area$$module$js$nodes(a,"Pyramid Front"),U=new Area$$module$js$nodes(a,"Pyramid Back"),V=new Area$$module$js$nodes(a,"Tower"),yb=(new Location$$module$js$nodes(a,0,M,"Start")).overworld().start(),Ue=(new Location$$module$js$nodes(a,0,
M,"Mezame Shrine")).overworld().from(yb),Ve=(new Location$$module$js$nodes(a,1,M,"Outside Start")).overworld().connect(Ue),ha=(new Location$$module$js$nodes(a,2,M,"Town")).town().connect(Ve),Ea=(new Location$$module$js$nodes(a,3,pa,"Main")).overworld().connect(ha).trigger(lc,Ta),Pc=(new Location$$module$js$nodes(a,3,pa,"Outside Windmill")).overworld(),Qc=(new Location$$module$js$nodes(a,4,K,"Tunnel 1 (entrance)")).cave().from(Ea,Ta),We=(new Location$$module$js$nodes(a,5,K,"Tunnel 2 (over bridge)")).cave().connect(Qc),
Xe=(new Location$$module$js$nodes(a,6,K,"Tunnel 6 (herb dead end)")).cave().chest(X,15),Rc=(new Location$$module$js$nodes(a,7,K,"Tunnel 4a (ball corridor)")).cave().chest(X,20,80).chest(Ia,21);(new Location$$module$js$nodes(a,7,K,"Tunnel 4b (antidote dead end)")).cave().connect(Rc,v).chest(Pa,19);const Ye=(new Location$$module$js$nodes(a,8,K,"Tunnel 5 (warp boots dead end)")).cave().chest(lb,14),Ze=(new Location$$module$js$nodes(a,9,K,"Tunnel 3a (branch, front)")).cave().connect(We).connectTo(Rc).connectTo(Ye),
$e=(new Location$$module$js$nodes(a,9,K,"Tunnel 3b (branch, back)")).cave().connect(Ze,v).connectTo(Xe),af=(new Location$$module$js$nodes(a,10,K,"Tunnel 7 (boss)")).cave().connect($e).boss(He),bf=(new Location$$module$js$nodes(a,12,K,"Tunnel 8a (exit, above wall)")).cave().connect(af),cf=(new Location$$module$js$nodes(a,12,K,"Tunnel 8b (exit, below wall")).cave().connect(bf,v);(new Location$$module$js$nodes(a,14,pa,"Windmill Cave")).cave().connect(Ea).connectTo(Pc).trigger(Yd,ob,rb);(new Location$$module$js$nodes(a,
15,pa,"Windmill")).misc().connect(Pc).trigger(Ta,Vb);const df=(new Location$$module$js$nodes(a,16,pa,"Zebu's Cave Front")).cave().connect(Ea).trigger(rb,ic,jc).trigger(lc,Ta,rb),ef=(new Location$$module$js$nodes(a,16,pa,"Zebu's Cave Back")).cave().trigger(oc).connect(df,w),ff=(new Location$$module$js$nodes(a,17,B,"Tunnel 1 (to Zebu)")).cave().connect(ef),ua=(new Location$$module$js$nodes(a,20,ia,"West")).overworld().connect(cf),gf=(new Location$$module$js$nodes(a,20,ia,"South")).overworld().connect(ua,
q),Sc=(new Location$$module$js$nodes(a,21,ia,"East")).overworld().connect(ua).chest(Rb,24),Fa=(new Location$$module$js$nodes(a,24,qa,"Town")).town().connect(ua).trigger(Zd,Rb),hf=(new Location$$module$js$nodes(a,25,ia,"Outside Stom's House")).town().connect(ua),zb=(new Location$$module$js$nodes(a,26,ia,"Swamp")).overworld().connect(Sc,Wa).trigger(sb,nc,Wa);(new Location$$module$js$nodes(a,26,ia,"Swamp Insect Area")).overworld().connect(zb,Wa).boss(Ie);const Za=(new Location$$module$js$nodes(a,27,
ra,"Town")).town().connect(gf),$a=(new Location$$module$js$nodes(a,28,Da,"Town")).town().connect(zb,Wa).trigger(mc);(new Location$$module$js$nodes(a,30,ia,"Stom's House")).house().connect(hf).trigger($d,mc);const va=(new Location$$module$js$nodes(a,32,B,"Entrance")).overworld().connect(ua).connect(ff),jf=(new Location$$module$js$nodes(a,32,B,"Up Slope")).overworld().from(va,Ec).to(va),kf=(new Location$$module$js$nodes(a,32,B,"Dead End (warp boots)")).overworld().chest(lb,24,106),Tc=(new Location$$module$js$nodes(a,
33,B,"Upper")).overworld().from(va,A).to(va),lf=(new Location$$module$js$nodes(a,33,B,"Tornel Dead End")).overworld().trigger(ce,za).chest(Y,23,105),Uc=(new Location$$module$js$nodes(a,34,B,"Tunnel 2a (fork at start)")).cave().connect(va);(new Location$$module$js$nodes(a,34,B,"Tunnel 2b (left branch to dead end)")).cave().connect(Uc,w).connectTo(kf);const mf=(new Location$$module$js$nodes(a,34,B,"Tunnel 2c (right branch to upper)")).cave().connect(Uc,w),nf=(new Location$$module$js$nodes(a,35,B,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(mf).chest(X,
23,82),of=(new Location$$module$js$nodes(a,35,B,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(nf,w).connectTo(Tc),Vc=(new Location$$module$js$nodes(a,36,B,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(of);(new Location$$module$js$nodes(a,36,B,"Tunnel 4b (out to upper)")).cave().connect(Vc,w).connectTo(Tc);const pf=(new Location$$module$js$nodes(a,37,B,"Tunnel 5 (tiny connector)")).cave().connect(Vc),qf=(new Location$$module$js$nodes(a,38,B,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(pf);
(new Location$$module$js$nodes(a,38,B,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(qf,w).connectTo(lf);const rf=(new Location$$module$js$nodes(a,39,B,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(jf),sf=(new Location$$module$js$nodes(a,39,B,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(rf,w);(new Location$$module$js$nodes(a,39,B,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(sf,w).chest(za,25);const ab=(new Location$$module$js$nodes(a,40,u,"Entrance")).overworld().connect(Sc,
we,ve),bb=(new Location$$module$js$nodes(a,40,u,"Upper")).overworld().from(ab,A).to(ab),Ab=(new Location$$module$js$nodes(a,40,u,"Summit (boss)")).overworld().from(bb,A).to(bb).boss(Je),Wc=(new Location$$module$js$nodes(a,41,u,"Connector")).overworld(),Bb=(new Location$$module$js$nodes(a,41,u,"Middle Left")).overworld(),tf=(new Location$$module$js$nodes(a,41,u,"Middle Right")).overworld().from(Bb,Ec).to(Bb),Xc=(new Location$$module$js$nodes(a,42,u,"Tunnel 2a (from entrance to connector)")).cave().connectTo(Wc);
(new Location$$module$js$nodes(a,42,u,"Tunnel 2b (under bridge, to antidote)")).cave().connect(Xc,w).chest(Pa,23,94);const Yc=(new Location$$module$js$nodes(a,43,u,"Tunnel 3a (branch after connector)")).cave().connect(Wc),uf=(new Location$$module$js$nodes(a,43,u,"Tunnel 3b (right branch)")).cave().connect(Yc,w),vf=(new Location$$module$js$nodes(a,43,u,"Tunnel 3c (upper branch)")).cave().connect(Yc,w);(new Location$$module$js$nodes(a,44,u,"Tunnel 4 (over bridge, to middle)")).cave().connect(vf).connectTo(Bb);
const Zc=(new Location$$module$js$nodes(a,45,u,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(uf).connectTo(tf);(new Location$$module$js$nodes(a,45,u,"Tunnel 5b (dead-end with herb)")).cave().connect(Zc,w).chest(X,22,83);const wf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6a (S-shaped hall, right)")).cave().connect(Zc),xf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(wf,w),yf=(new Location$$module$js$nodes(a,46,u,"Tunnel 6c (S-shaped hall, left)")).cave().connect(xf,
w),$c=(new Location$$module$js$nodes(a,47,u,"Prison (hallway)")).cave().connect(bb),zf=(new Location$$module$js$nodes(a,48,u,"Left Cell (shopkeepers)")).cave().from($c,w);(new Location$$module$js$nodes(a,49,u,"Left Cell 2 (back, with prison key)")).cave().from(zf,w).chest(Wb,13);const Af=(new Location$$module$js$nodes(a,50,u,"Right Cell (villagers)")).cave().from($c,w),Bf=(new Location$$module$js$nodes(a,51,u,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Af,w);(new Location$$module$js$nodes(a,
52,u,"Tunnel 9 (connector to summit)")).cave().connect(Bf).connectTo(Ab);const Cf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10a (summit cave, front)")).cave().from(Ab,Wb).to(Ab),Df=(new Location$$module$js$nodes(a,53,u,"Tunnel 10b (summit cave, behind ice)")).cave().connect(Cf,w).trigger(de);(new Location$$module$js$nodes(a,56,u,"Tunnel 1 (leads from main entrance)")).cave().connect(ab).connectTo(Xc);(new Location$$module$js$nodes(a,57,u,"Tunnel 7 (to upper)")).cave().connect(yf).connectTo(bb);
const Ef=(new Location$$module$js$nodes(a,60,Xa,"Inn")).town(),Ff=(new Location$$module$js$nodes(a,61,Xa,"Tool Shop")).house(),Gf=(new Location$$module$js$nodes(a,62,Xa,"Back Room")).house(),Cb=(new Location$$module$js$nodes(a,64,aa,"Summit")).overworld().connect(Df),cb=(new Location$$module$js$nodes(a,64,aa,"Northwest")).overworld().from(Cb).to(Cb,A),Hf=(new Location$$module$js$nodes(a,64,aa,"Northeast")).overworld().connect(cb,q),ad=(new Location$$module$js$nodes(a,65,aa,"Southwest")).overworld().connect(cb),
If=(new Location$$module$js$nodes(a,65,aa,"Southeast")).overworld().connect(ad,q),bd=(new Location$$module$js$nodes(a,66,aa,"Lime Tree Valley")).overworld().connect(ad).connect(Ea,Id),Jf=(new Location$$module$js$nodes(a,67,aa,"Lime Tree Lake (Rage)")).cave().connect(bd).trigger(tc,L),Kf=(new Location$$module$js$nodes(a,68,ca,"Tunnel 1a (entrance)")).cave().connect(If),Lf=(new Location$$module$js$nodes(a,68,ca,"Tunnel 1b (behind wall)")).cave().connect(Kf,v),cd=(new Location$$module$js$nodes(a,69,
ca,"Tunnel 2a (main path, before wall)")).cave().connect(Lf);(new Location$$module$js$nodes(a,69,ca,"Tunnel 2b (dead end, antidote)")).cave().connect(cd,v).chest(Pa,25,95);const Mf=(new Location$$module$js$nodes(a,69,ca,"Tunnel 2c (main path, after wall)")).cave().connect(cd,v),Nf=(new Location$$module$js$nodes(a,70,ca,"Tunnel 3a (last room, before wall)")).cave().connect(Mf),Of=(new Location$$module$js$nodes(a,70,ca,"Tunnel 3b (last room, after wall)")).cave().connect(Nf,v);(new Location$$module$js$nodes(a,
71,ca,"Meadow")).overworld().connect(Of).chest(cc,14);const Pf=(new Location$$module$js$nodes(a,72,C,"Tunnel 1a (entrance)")).cave().connect(Hf),dd=(new Location$$module$js$nodes(a,72,C,"Tunnel 1b (past wall)")).cave().connect(Pf,v);(new Location$$module$js$nodes(a,72,C,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(dd,v).chest(kb,24);const Qf=(new Location$$module$js$nodes(a,73,C,"Tunnel 2 (tiny connector)")).cave().connect(dd),ed=(new Location$$module$js$nodes(a,74,C,"Tunnel 3a (upper branch)")).cave().connect(Qf);
(new Location$$module$js$nodes(a,74,C,"Tunnel 3b (dead end, mimic)")).cave().connect(ed,v).chest(G,21,112);const fd=(new Location$$module$js$nodes(a,74,C,"Tunnel 3c (short passage with mimic)")).cave().connect(ed,v).chest(G,22,113),Rf=(new Location$$module$js$nodes(a,74,C,"Tunnel 3d (lower branch)")).cave().connect(fd,v);(new Location$$module$js$nodes(a,75,C,"Tunnel 4 (dead end loop)")).cave().connect(Rf);const gd=(new Location$$module$js$nodes(a,76,C,"Tunnel 5a (right branch over bridge)")).cave().connect(fd),
Sf=(new Location$$module$js$nodes(a,76,C,"Tunnel 5b (past wall over bridge)")).cave().connect(gd,v),Tf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6a (from left branch)")).cave().connect(gd),Uf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6b (reconvergence)")).cave().connect(Tf,v).connect(Sf),Vf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6c (between walls)")).cave().connect(Uf,v),Wf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6d (under bridge)")).cave().connect(Vf,v),Xf=(new Location$$module$js$nodes(a,
78,C,"Tunnel 7a (over second bridge)")).cave().connect(Wf),Yf=(new Location$$module$js$nodes(a,78,C,"Tunnel 7b (past wall)")).cave().connect(Xf,v),Zf=(new Location$$module$js$nodes(a,79,C,"Tunnel 8a (under second bridge)")).cave().connect(Yf);(new Location$$module$js$nodes(a,79,C,"Tunnel 8b (fog lamp)")).cave().connect(Zf,v).chest(Yb,19);const ma=(new Location$$module$js$nodes(a,80,z,"Town")).town().connect(cb),hd=(new Location$$module$js$nodes(a,81,z,"Fishherman Island")).town().connect(ma);(new Location$$module$js$nodes(a,
82,aa,"Mesia Shrine")).cave().trigger(uc).connect(Jf,q,tc);const id=(new Location$$module$js$nodes(a,84,ba,"Tunnel 1a (entrance)")).cave().connect(cb);(new Location$$module$js$nodes(a,84,ba,"Tunnel 1b (dead end, mimic)")).cave().connect(id,w).chest(G,19,114);const $f=(new Location$$module$js$nodes(a,84,ba,"Tunnel 1c (past ice)")).cave().connect(id,w),jd=(new Location$$module$js$nodes(a,85,ba,"Tunnel 2 (stoned pair)")).cave().connect($f),Db=(new Location$$module$js$nodes(a,86,ba,"Tunnel 3 (wide medusa hallways)")).cave().from(jd,
Be).to(jd,Ba),ag=(new Location$$module$js$nodes(a,87,ba,"Tunnel 4a (left entrance)")).cave().from(Db,w).chest(Sa,25).trigger(fe,Ce);(new Location$$module$js$nodes(a,87,ba,"Tunnel 4b (right entrance)")).cave().from(Db,w).connect(ag,A);(new Location$$module$js$nodes(a,87,ba,"Tunnel 4c (sword of water)")).cave().connect(Db,w).chest(L,24);const kd=(new Location$$module$js$nodes(a,88,V,"Entrance")).misc(),bg=(new Location$$module$js$nodes(a,89,V,"Level 1")).misc().from(kd),cg=(new Location$$module$js$nodes(a,
90,V,"Level 2")).misc().from(bg),dg=(new Location$$module$js$nodes(a,91,V,"Level 3")).misc().from(cg),ld=(new Location$$module$js$nodes(a,92,V,"Outside Mesia Room")).misc().from(dg),eg=(new Location$$module$js$nodes(a,93,V,"Outside Dyna Room")).misc().from(ld,jb);(new Location$$module$js$nodes(a,94,V,"Mesia")).misc().connect(ld).trigger(qe);const fg=(new Location$$module$js$nodes(a,95,V,"Dyna")).misc().from(eg).boss(Te);(new Location$$module$js$nodes(a,95,V,"Win")).misc().from(fg).end();const Eb=
(new Location$$module$js$nodes(a,96,ja,"Cabin Beach")).sea().from(hd,tb),wa=(new Location$$module$js$nodes(a,96,ja,"South")).sea().connect(Eb,T),gg=(new Location$$module$js$nodes(a,96,ja,"Joel Beach")).sea().connect(wa,T),md=(new Location$$module$js$nodes(a,96,da,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(a,96,ja,"Altar")).sea().connect(wa,T).trigger(ub,ac,$b);const hg=(new Location$$module$js$nodes(a,96,ja,"North")).sea().to(wa,T).from(wa,T,ze).trigger(ie,Ge),ig=(new Location$$module$js$nodes(a,
96,ja,"Swan Beach")).sea().connect(hg,T);(new Location$$module$js$nodes(a,97,ja,"Cabin")).misc().connect(Eb).trigger(xc,tb);(new Location$$module$js$nodes(a,98,da,"Lighthouse")).misc().connect(md).trigger(he,ob);const db=(new Location$$module$js$nodes(a,100,z,"Underground Channel 1 (from throne room)")).sea().trigger(sc),jg=(new Location$$module$js$nodes(a,100,z,"Underground Channel 2 (to fortune teller)")).sea().connect(db,q),nd=(new Location$$module$js$nodes(a,100,z,"Underground Channel 3 (from fortune teller)")).sea().connect(db,
A),od=(new Location$$module$js$nodes(a,100,z,"Underground Channel 4 (asina)")).sea().connect(nd,q),kg=(new Location$$module$js$nodes(a,100,z,"Underground Channel 5 (dolphin)")).sea().connect(od,q).trigger(wc,X,vc);(new Location$$module$js$nodes(a,100,z,"Underground Channel 6 (water)")).sea().connect(kg,T).connectTo(wa,T).chest(bc,17);const Fb=(new Location$$module$js$nodes(a,101,F,"Zombie Town")).town(),lg=(new Location$$module$js$nodes(a,104,F,"Tunnel 1 (entrance)")).sea().connect(wa,yc,T),pd=(new Location$$module$js$nodes(a,
105,F,"Tunnel 2a (start)")).cave().connect(lg);(new Location$$module$js$nodes(a,105,F,"Tunnel 2b (dead end to left)")).cave().connect(pd,q);const mg=(new Location$$module$js$nodes(a,105,F,"Tunnel 2c (across first river)")).cave().connect(pd,q),qd=(new Location$$module$js$nodes(a,105,F,"Tunnel 2d (across second river)")).cave().connect(mg,q);(new Location$$module$js$nodes(a,105,F,"Tunnel 2e (dead end, magic ring)")).cave().connect(qd,v).chest(Y,29);const ng=(new Location$$module$js$nodes(a,105,F,"Tunnel 2f (stair down)")).cave().connect(qd,
v),og=(new Location$$module$js$nodes(a,106,F,"Tunnel 3a (main area)")).cave().connect(ng).connectTo(Fb).chest(kb,25,92),pg=(new Location$$module$js$nodes(a,106,F,"Tunnel 3b (left area toward items)")).cave().connect(og,v),qg=(new Location$$module$js$nodes(a,107,F,"Tunnel 4a (right side, mimic)")).cave().connect(pg).chest(G,14,115);(new Location$$module$js$nodes(a,107,F,"Tunnel 4b (left side, iron necklace)")).cave().connect(qg,q).chest(Ud,15);const Gb=(new Location$$module$js$nodes(a,108,ea,"Floor 1")).fortress().connect(Fb),
rg=(new Location$$module$js$nodes(a,108,ea,"Miniboss")).fortress().boss(Ke).connect(Gb);(new Location$$module$js$nodes(a,109,ea,"Floor 2a (left stair)")).fortress().connect(Gb).chest(Aa,19);const sg=(new Location$$module$js$nodes(a,109,ea,"Floor 2b (right stair)")).fortress().connect(rg).chest(X,30,85),tg=(new Location$$module$js$nodes(a,110,ea,"Floor 3a (toward boss)")).fortress().connect(sg),rd=(new Location$$module$js$nodes(a,110,ea,"Floor 3b (boss room)")).fortress().connect(tg);(new Location$$module$js$nodes(a,
110,ea,"Boss")).fortress().boss(Oc).connect(rd);(new Location$$module$js$nodes(a,110,ea,"Floor 3c (back room trap)")).fortress().from(rd).to(Gb);const ug=(new Location$$module$js$nodes(a,112,da,"Secret Passage")).cave().connectTo(md),eb=(new Location$$module$js$nodes(a,113,da,"Town")).town().connect(gg),W=(new Location$$module$js$nodes(a,114,N,"Town")).town().connect(ig),vg=(new Location$$module$js$nodes(a,115,N,"Inside Gate")).overworld().connect(W),wg=(new Location$$module$js$nodes(a,115,N,"Outside Gate")).overworld().from(vg,
na),fb=(new Location$$module$js$nodes(a,120,la,"Valley")).overworld().connect(wg),Hb=(new Location$$module$js$nodes(a,124,x,"Entrance")).overworld().connect(fb),xg=(new Location$$module$js$nodes(a,124,x,"Over first river toward Shyron")).overworld().connect(Hb,q),sd=(new Location$$module$js$nodes(a,124,x,"After first tunnel")).overworld(),td=(new Location$$module$js$nodes(a,124,x,"Door to Styx")).overworld().connect(sd,q),yg=(new Location$$module$js$nodes(a,124,x,"Dead end (no item)")).overworld(),
zg=(new Location$$module$js$nodes(a,124,x,"Dead end (fruit of lime)")).overworld().chest(Rd,26),Ag=(new Location$$module$js$nodes(a,124,x,"Dead end (magic ring)")).overworld().chest(Y,25,101),ud=(new Location$$module$js$nodes(a,124,x,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(a,124,x,"Floating island (bow of sun)")).overworld().connect(ud,A).chest(ec,24);const Bg=(new Location$$module$js$nodes(a,125,x,"Tunnel 1 (to Shyron)")).cave().connect(xg),Cg=(new Location$$module$js$nodes(a,
126,x,"Outside Shyron")).overworld().connect(Bg);(new Location$$module$js$nodes(a,127,x,"Tunnel 2 (fork)")).cave().connect(Hb).connectTo(zg).connectTo(sd);const vd=(new Location$$module$js$nodes(a,128,x,"Tunnel 3 (caves)")).cave().connect(td).connect(yg),wd=(new Location$$module$js$nodes(a,129,x,"Tunnel 4 (left branch of cave)")).cave().connect(vd);(new Location$$module$js$nodes(a,130,x,"Tunnel 5 (dead end, medical herb)")).cave().connect(wd).chest(X,15,86);const Dg=(new Location$$module$js$nodes(a,
131,x,"Tunnel 6a (left-then-right)")).cave().connect(wd),Eg=(new Location$$module$js$nodes(a,131,x,"Tunnel 6b (past wall)")).cave().connect(Dg,v),Fg=(new Location$$module$js$nodes(a,132,x,"Tunnel 7 (wide hall)")).cave().connect(Eg);(new Location$$module$js$nodes(a,133,x,"Tunnel 8 (red slimes)")).cave().from(Fg,v).connectTo(ud).chest(G,23,116);const Gg=(new Location$$module$js$nodes(a,134,x,"Tunnel 9 (right branch, infinite loop)")).cave().connect(vd),Hg=(new Location$$module$js$nodes(a,135,x,"Tunnel 10a (toward magic ring)")).cave().connect(Gg);
(new Location$$module$js$nodes(a,135,x,"Tunnel 10b (past wall)")).cave().connect(Hg,v).connectTo(Ag);const xd=(new Location$$module$js$nodes(a,136,ka,"Entrance")).fortress().from(td,Xb,xb),Ig=(new Location$$module$js$nodes(a,137,ka,"Left branch")).fortress().connect(xd).chest(G,19,117),Jg=(new Location$$module$js$nodes(a,137,ka,"Left branch, past one bridge")).fortress().connect(Ig,q),Kg=(new Location$$module$js$nodes(a,137,ka,"Left branch, past two bridges")).fortress().connect(Jg,q).chest(X,29,
87),Lg=(new Location$$module$js$nodes(a,137,ka,"Right branch")).fortress().connect(xd);(new Location$$module$js$nodes(a,137,ka,"Right branch, across water")).fortress().connect(Lg,A).chest(G,20,118).chest(G,21,119).chest(Od,28);(new Location$$module$js$nodes(a,138,ka,"Upper floor")).fortress().connect(Kg).chest(I,27);const xa=(new Location$$module$js$nodes(a,140,fa,"Town")).town().connect(Cg,Kc).trigger(vb),Ga=(new Location$$module$js$nodes(a,142,la,"Town")).town().connect(fb),yd=(new Location$$module$js$nodes(a,
...
q);const Mg=(new Location$$module$js$nodes(a,145,E,"Area 4 (left across middle-right bridge)")).cave().connect(zd,q),Ng=(new Location$$module$js$nodes(a,145,E,"Area 5 (bottom edge)")).cave().connect(Mg,q),Og=(new Location$$module$js$nodes(a,145,E,"Area 6 (bottom island)")).cave().connect(Ng,q),Pg=(new Location$$module$js$nodes(a,145,E,"Area 7 (bottom inner ring)")).cave().connect(Og,q),Qg=(new Location$$module$js$nodes(a,145,E,"Area 8 (left outer ring)")).cave().connect(Pg,q).connect(gb,q).chest(Aa,
27,100),Rg=(new Location$$module$js$nodes(a,145,E,"Area 9 (top left inner ring)")).cave().connect(Qg,q),Sg=(new Location$$module$js$nodes(a,145,E,"Area 10 (top right inner ring)")).cave().connect(Rg,q);(new Location$$module$js$nodes(a,145,E,"Area 11 (center)")).cave().connect(Sg,q).connectTo(yd);(new Location$$module$js$nodes(a,145,E,"Area 12 (top center islands)")).cave().connect(gb,A).chest(Pd,28);const Tg=(new Location$$module$js$nodes(a,146,P,"Desert Cave 1")).cave().connect(Ib,A),ya=(new Location$$module$js$nodes(a,
147,P,"Town")).town(),Ug=(new Location$$module$js$nodes(a,148,P,"Outside Cave")).overworld().connect(ya),Vg=(new Location$$module$js$nodes(a,149,P,"Desert Cave 2")).cave().connect(Ug);(new Location$$module$js$nodes(a,150,P,"Meadow")).overworld().connect(Tg).connectTo(ya).trigger(ne,na,Z);const Jb=(new Location$$module$js$nodes(a,152,P,"Desert 2")).overworld().connect(Vg),Wg=(new Location$$module$js$nodes(a,156,ta,"Entrance")).fortress().connect(Jb,A),Xg=(new Location$$module$js$nodes(a,156,ta,"Azteca")).fortress().trigger(pe),
Yg=(new Location$$module$js$nodes(a,157,ta,"Fork")).fortress().connect(Wg),Ad=(new Location$$module$js$nodes(a,158,ta,"Main")).fortress().connect(Yg);(new Location$$module$js$nodes(a,158,ta,"Treasure Chest (magic ring)")).fortress().connect(Ad).chest(Y,27,108);(new Location$$module$js$nodes(a,159,ta,"Draygon")).fortress().connect(Ad).to(Xg).boss(Qe);const Zg=(new Location$$module$js$nodes(a,160,U,"Entrance")).fortress().connect(Jb,A),$g=(new Location$$module$js$nodes(a,160,U,"Statues")).fortress().connect(Zg).boss(Re),
ah=(new Location$$module$js$nodes(a,161,U,"Hall 1")).fortress().connect($g),Kb=(new Location$$module$js$nodes(a,162,U,"Branch")).fortress().connect(ah);(new Location$$module$js$nodes(a,163,U,"Left Dead End")).fortress().connect(Kb).chest(G,13,120);(new Location$$module$js$nodes(a,164,U,"Right Dead End")).fortress().connect(Kb);const bh=(new Location$$module$js$nodes(a,165,U,"Hall 2")).fortress().connect(Kb).chest(mb,26,109),ch=(new Location$$module$js$nodes(a,166,U,"Draygon 2")).fortress().connect(bh).boss(Se);
(new Location$$module$js$nodes(a,167,U,"Teleporter")).fortress().from(ch).to(kd);const Bd=(new Location$$module$js$nodes(a,168,Ya,"Entrance")).fortress().connect(Ga,xb).trigger(Cc,I),dh=(new Location$$module$js$nodes(a,169,Ya,"Main")).fortress().from(Bd,oa),eh=(new Location$$module$js$nodes(a,169,Ya,"Boss")).fortress().connect(dh).boss(Me),fh=(new Location$$module$js$nodes(a,170,Ya,"Zebu")).fortress().connect(eh),hb=(new Location$$module$js$nodes(a,171,O,"Entrance")).fortress().connect(fh);(new Location$$module$js$nodes(a,
171,O,"Dead End Behind Iron (fruit of power)")).fortress().connect(hb,oa).chest(Aa,28,98);(new Location$$module$js$nodes(a,171,O,"Dead End Loop Across Closer Bridges")).fortress().connect(hb,q).connect(hb,q);const gh=(new Location$$module$js$nodes(a,171,O,"Across First Bridge (fruit of repun)")).fortress().connect(hb,q).chest(Qb,30,102),Lb=(new Location$$module$js$nodes(a,171,O,"Across Second Bridge")).fortress().connect(gh,q);(new Location$$module$js$nodes(a,171,O,"Dead End Across Two Bridges ()")).fortress().connect(Lb,
q).connect(Lb,q).chest(kb,29,93);const hh=(new Location$$module$js$nodes(a,171,O,"Across Third Bridge")).fortress().connect(Lb,q),ih=(new Location$$module$js$nodes(a,171,O,"Exit Behind Iron Door")).fortress().connect(hh,oa),jh=(new Location$$module$js$nodes(a,172,O,"Boss")).fortress().connect(ih).boss(Ne),kh=(new Location$$module$js$nodes(a,172,O,"Tornel")).fortress().connect(jh),Cd=(new Location$$module$js$nodes(a,173,sa,"Lower")).fortress().connect(kh).chest(mb,26,99).chest(Y,27,111),lh=(new Location$$module$js$nodes(a,
174,sa,"Upper Loop")).fortress().connect(Cd).chest(Pa,22,96);(new Location$$module$js$nodes(a,174,sa,"Upper Loop Behind Wall (magic ring)")).fortress().connect(lh,oa).chest(Y,23,107);const mh=(new Location$$module$js$nodes(a,175,sa,"Upper Passage (toward Mado)")).fortress().connect(Cd).chest(Y,27,84),Mb=(new Location$$module$js$nodes(a,176,H,"Initial Fork")).fortress(),nh=(new Location$$module$js$nodes(a,177,H,"Left Branch")).fortress().connect(Mb),Dd=(new Location$$module$js$nodes(a,178,H,"Main Area (right branch, over bridges)")).fortress().connect(Mb),
oh=(new Location$$module$js$nodes(a,179,H,"U-shaped Passage (between floors)")).fortress().connect(Dd),ph=(new Location$$module$js$nodes(a,180,H,"Main Area Lower (under bridge)")).fortress().connect(nh).connect(Dd).connect(oh),Ed=(new Location$$module$js$nodes(a,180,H,"Behind Iron Wall")).fortress().connect(ph,oa),qh=(new Location$$module$js$nodes(a,181,H,"Lower")).fortress().connect(Ed).chest(G,13,121).chest(G,14,122).chest(G,15,123).chest(Y,23,88).chest(lb,24,110),rh=(new Location$$module$js$nodes(a,
182,H,"Boss Corridor")).fortress().connect(qh),sh=(new Location$$module$js$nodes(a,182,H,"Boss")).fortress().connect(rh,xb).boss(Pe);(new Location$$module$js$nodes(a,182,H,"Behind Boss (stormBracelet)")).fortress().connect(sh).chest(Oa,18);const Fd=(new Location$$module$js$nodes(a,183,H,"Exit Stairs")).fortress(),th=(new Location$$module$js$nodes(a,184,E,"Entrance Back (behind river)")).cave().connect(Fd).chest(Aa,13,90);(new Location$$module$js$nodes(a,184,E,"Entrance Front")).cave().connect(th,
A).connectTo(Ib).connectTo(gb);const uh=(new Location$$module$js$nodes(a,185,sa,"Boss")).fortress().connect(mh).boss(Oe);(new Location$$module$js$nodes(a,185,sa,"Asina")).fortress().connect(uh).connectTo(Mb);(new Location$$module$js$nodes(a,186,H,"Kensu")).fortress().connect(Ed).connectTo(Fd).trigger(me,qb);(new Location$$module$js$nodes(a,187,la,"House")).house().connect(Ga).trigger(oe,na,qb);(new Location$$module$js$nodes(a,188,la,"Inn")).shop().connect(Ga,vb);(new Location$$module$js$nodes(a,190,
la,"Tool Shop")).shop().connect(Ga,vb);(new Location$$module$js$nodes(a,191,la,"Tavern")).shop().connect(Ga);(new Location$$module$js$nodes(a,192,M,"Elder House")).house().connect(ha).trigger(ic);(new Location$$module$js$nodes(a,193,M,"Rabbit Hut")).house().connect(ha).trigger(pc,oc,Z);(new Location$$module$js$nodes(a,194,M,"Inn")).shop().connect(ha);(new Location$$module$js$nodes(a,195,M,"Tool Shop")).shop().connect(ha).trigger(kc);(new Location$$module$js$nodes(a,196,M,"Armor Shop")).shop().connect(ha);
(new Location$$module$js$nodes(a,197,M,"Student House")).house().connect(ha).trigger(jc);(new Location$$module$js$nodes(a,198,qa,"Tavern")).house().connect(Fa);(new Location$$module$js$nodes(a,199,qa,"Pawn Shop")).shop().connect(Fa);(new Location$$module$js$nodes(a,200,qa,"Inn")).shop().connect(Fa);(new Location$$module$js$nodes(a,201,qa,"Armor Shop")).shop().connect(Fa);(new Location$$module$js$nodes(a,203,qa,"Tool Shop")).shop().connect(Fa);(new Location$$module$js$nodes(a,205,Da,"Elder House")).house().from($a,
Z).trigger(be,sb);(new Location$$module$js$nodes(a,206,Da,"Mother's House")).house().from($a,Z).trigger(nc,Z).trigger(ae,sb);(new Location$$module$js$nodes(a,207,Da,"Tool Shop")).shop().from($a,Z);(new Location$$module$js$nodes(a,208,Da,"Inn")).shop().from($a,Z);(new Location$$module$js$nodes(a,209,ra,"Inn")).shop().connect(Za);(new Location$$module$js$nodes(a,210,ra,"Tool Shop")).shop().connect(Za);(new Location$$module$js$nodes(a,211,ra,"Armor Shop")).shop().connect(Za);const vh=(new Location$$module$js$nodes(a,
212,ra,"Queen's House")).house().from(Za,Kc).trigger(ke,na,cc);(new Location$$module$js$nodes(a,213,Xa,"Nadare's")).house().connect(ab).connectTo(Ef).connectTo(Ff).connectTo(Gf);(new Location$$module$js$nodes(a,214,z,"Fisherman's House")).house().connect(hd).trigger(tb,Yb,pb,De);const Nb=(new Location$$module$js$nodes(a,215,z,"Palace Entrance")).house().connect(ma);(new Location$$module$js$nodes(a,216,z,"Fortune Teller Front")).house().connect(ma).trigger(rc,qc);(new Location$$module$js$nodes(a,216,
z,"Fortune Teller Back")).house().connect(jg).connect(nd);(new Location$$module$js$nodes(a,217,z,"Pawn Shop")).shop().connect(ma);(new Location$$module$js$nodes(a,218,z,"Armor Shop")).shop().connect(ma);(new Location$$module$js$nodes(a,220,z,"Inn")).shop().connect(ma);(new Location$$module$js$nodes(a,221,z,"Tool Shop")).shop().connect(ma);(new Location$$module$js$nodes(a,222,z,"Palace Left")).house().connect(Nb);(new Location$$module$js$nodes(a,223,z,"Palace Throne Room")).house().connect(Nb).to(db,
xe).from(db).trigger(qc).trigger(ee,rc,sc);(new Location$$module$js$nodes(a,224,z,"Palace Right")).house().connect(Nb);(new Location$$module$js$nodes(a,225,z,"Asina's Room")).house().connect(od).trigger(vc,Fc);(new Location$$module$js$nodes(a,226,ra,"Queen Downstairs")).house().connect(vh).chest(Ma,13);(new Location$$module$js$nodes(a,227,da,"Elder's House")).house().connect(eb).trigger(yc);(new Location$$module$js$nodes(a,228,da,"Shed")).house().connect(eb).to(ug,Zb);(new Location$$module$js$nodes(a,
229,da,"Tool Shop")).shop().connect(eb).trigger(kc);(new Location$$module$js$nodes(a,231,da,"Inn")).shop().connect(eb);const wh=(new Location$$module$js$nodes(a,232,F,"Zombie Town House")).house().connect(Fb);(new Location$$module$js$nodes(a,233,F,"Zombie Town Basement")).house().connect(wh).trigger(ge,Oc);(new Location$$module$js$nodes(a,235,N,"Tool Shop")).shop().connect(W);(new Location$$module$js$nodes(a,236,N,"Stom's Hut")).house().connect(W).trigger(zc);(new Location$$module$js$nodes(a,237,
N,"Inn")).shop().connect(W);(new Location$$module$js$nodes(a,238,N,"Armor Shop")).shop().connect(W);(new Location$$module$js$nodes(a,239,N,"Tavern")).house().connect(W).trigger(Ac,zc,Ra);(new Location$$module$js$nodes(a,240,N,"Pawn Shop")).shop().connect(W);(new Location$$module$js$nodes(a,241,N,"Dance Hall")).house().connect(W).trigger(Bc,Ac,Ra).trigger(je,Bc,bc);const xh=(new Location$$module$js$nodes(a,242,fa,"Temple (pre-massacre)")).fortress().connect(xa).from(yb,I,Hd).trigger(le);(new Location$$module$js$nodes(a,
242,fa,"Temple (post-massacre)")).fortress().from(xh,Cc).boss(Le);(new Location$$module$js$nodes(a,243,fa,"Training Hall")).house().connect(xa);(new Location$$module$js$nodes(a,244,fa,"Hospital")).house().connect(xa);(new Location$$module$js$nodes(a,245,fa,"Armor Shop")).shop().connect(xa);(new Location$$module$js$nodes(a,246,fa,"Tool Shop")).shop().connect(xa);(new Location$$module$js$nodes(a,247,fa,"Inn")).shop().connect(xa);(new Location$$module$js$nodes(a,248,P,"Inn")).shop().connect(ya);(new Location$$module$js$nodes(a,
249,P,"Tool Shop")).shop().connect(ya);(new Location$$module$js$nodes(a,250,P,"Elder's House")).house().connect(ya);(new Location$$module$js$nodes(a,251,P,"Pawn Shop")).house().connect(ya);const yh=[ha,Ea,Qc,ua,zb,va,Cb,bd,Eb,W,fb,Hb,Ib,Bd,Jb];for(const a of yh)a.from(yb,te);return a},shuffle$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes);d||(d=new FlagSet$$module$js$flagset("Sbkm Sct"));
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="latest",LABEL$$module$js$version="latest a7ff259",HASH$$module$js$version="a7ff25908fb4a7d4e0055c8eaabf868630028655",DATE$$module$js$version=new Date(1552198725E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c;a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);c=a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$js$patch(b,parseSeed$$module$js$patch(a.seed),c)})}};
