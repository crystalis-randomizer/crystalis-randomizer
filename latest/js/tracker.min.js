...
function eastCave$$module$js$pass$deterministic(a,b){const {valleyOfWind:c,limeTreeValley:d,sealedCave1:e}=a.locations,f=a.locations[11],g=a.locations[13];f.screens=[[156,132,128,131,156],[128,129,131,134,128],[131,136,137,128,128],[129,140,133,130,132],[158,133,156,152,134]];g.screens=[[156,132,155,128,155],[128,129,129,128,129],[128,135,139,138,134],[128,140,128,133,132],[156,134,128,128,154]];f.name="East Cave 1";g.name="East Cave 2";for(const a of[f,g])a.entrances=[],a.exits=[],a.pits=[],a.spawns=
[],a.flags=[],a.height=a.screens.length,a.width=a.screens[0].length,a.used=a.hasSpawns=!0,a.extended=0,a.tilePalettes=[26,27,5],a.tileset=136,a.tileEffects=181,a.tilePatterns=[20,2],a.spritePatterns=[...e.spritePatterns],a.spritePalettes=[...e.spritePalettes];c.writeScreens2d(35,[[17,13],[9,194]]);a.tileEffects[0].effects[192]=0;f.connect(67,g,68);f.connect(64,c,52);b.connectLimeTreeToLeaf()&&(d.resizeScreens(0,1,0,0),d.writeScreens2d(0,[[12,17],[21,54],[14,15]]),f.screens[0][4]=151,f.connect(4,d,
