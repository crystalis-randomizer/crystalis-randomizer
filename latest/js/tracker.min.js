...
class pb{constructor(){this.presets=new Map;this.Casual=new ob(this,"Casual","\n      Basic flags for a relatively easy playthrough.  This is a good\n      place to start.",[n.PreserveUniqueChecks,n.NoShuffleMimics,n.DecreaseEnemyDamage,n.GuaranteeRefresh,n.GuaranteeStartingSword,n.ExperienceScalesFaster,n.NoCommunityJokes,r.NoThunderSwordWarp,rb.Shops,rb.Dyna,[rb.Maps,"!"],[rb.WildWarp,"!"],sb.SpoilerLog]);this.Classic=new ob(this,"Classic","\n      Provides a relatively quick playthough with a reasonable amount of\n      challenge.  Similar to older versions.",
[n.GuaranteeStartingSword,n.NoCommunityJokes,t.StatueGlitch,[r.NoThunderSwordWarp,"!"],[rb.Maps,"!"],sb.SpoilerLog]);this.Standard=new ob(this,"Standard","\n      Well-balanced, standard race flags.",[tb.RandomizeWeaknesses,r.StoryMode,sb.SpoilerLog]);this.NoBowMode=new ob(this,"No Bow Mode","\n      The tower is open from the start, as soon as you're ready for it.",[tb.RandomizeWeaknesses,tb.TowerRobots,ub.MaxScalingInTower,r.NoBowMode,sb.SpoilerLog]);this.Advanced=new ob(this,"Advanced","\n      A balanced randomization with quite a bit more difficulty.",
[t.GhettoFlight,t.MtSabreRequirementSkip,t.StatueGlitch,[t.SwordChargeGlitch,"!"],vb.Barrier,vb.BattleMagic,vb.GasMask,ub.MaxScalingInTower,tb.RandomizeWeaknesses,tb.TowerRobots,r.OrbsNotRequired,r.StoryMode,v.RandomizeMaps,v.ShuffleAreas,v.ShuffleHouses,v.RandomizeTrades,v.RandomizeWallElements,v.UnidentifiedKeyItems,sb.SpoilerLog]);this.WildWarp=new ob(this,"Wild Warp","\n      Significantly opens up the game right from the start with wild\n      warp in logic.",[n.GuaranteeRefresh,v.RandomizeWildWarp,
tb.RandomizeWeaknesses,tb.TowerRobots,r.OrbsNotRequired,r.StoryMode,sb.SpoilerLog]);this.Mystery=new ob(this,"Mystery","\n      Even the options are random.",[[v.ShuffleAreas,"?"],[v.ShuffleHouses,"?"],[v.RandomizeMaps,"?"],[v.RandomizeTrades,"?"],[v.UnidentifiedKeyItems,"?"],[v.RandomizeWallElements,"?"],[v.ShuffleGoaFloors,"?"],[v.RandomizeSpriteColors,"?"],[v.RandomizeWildWarp,"?"],[r.OrbsNotRequired,"?"],[r.NoBowMode,"?"],[r.StoryMode,"?"],[r.VanillaDolphin,"?"],[r.NoThunderSwordWarp,"?"],[t.RageSkip,
"?"],[t.TriggerSkip,"?"],[t.StatueGlitch,"?"],[t.GhettoFlight,"?"],[t.SwordChargeGlitch,"?"],[t.MtSabreRequirementSkip,"?"],[wb.RandomizeMusic,"?"],[wb.RandomizeMapColors,"?"],[tb.RandomizeWeaknesses,"?"],[tb.TowerRobots,"?"],[n.NoShuffleMimics,"?"],[n.PreserveUniqueChecks,"?"],[vb.Barrier,"?"],[vb.BattleMagic,"?"],[vb.GasMask,"?"],[rb.Dyna,"?"],[rb.BonusItems,"?"],[rb.Maps,"?"],sb.SpoilerLog]);this.Hardcore=new ob(this,"Hardcore","\n      Not for the faint of heart.  Good luck.",[vb.Barrier,vb.BattleMagic,
ub.ExperienceScalesSlower,ub.MaxScalingInTower,ub.Permadeath,r.OrbsNotRequired,r.StoryMode,v.RandomizeMaps,v.ShuffleAreas,v.ShuffleHouses,v.RandomizeTrades,v.RandomizeWallElements,v.UnidentifiedKeyItems]);this.FullStupid=new ob(this,"The Full Stupid","\n      Only a few noble fools have ever completed this.  Be sure to record this\n      because pics or it didn't happen.",[vb.Barrier,vb.BattleMagic,ub.Blackout,ub.ExperienceScalesSlower,ub.MaxScalingInTower,ub.Permadeath,tb.RandomizeWeaknesses,tb.TowerRobots,
r.OrbsNotRequired,r.StoryMode,v.RandomizeMaps,v.ShuffleAreas,v.ShuffleHouses,v.RandomizeTrades,v.RandomizeWallElements,v.ShuffleGoaFloors,v.UnidentifiedKeyItems]);this.Tournament2022Early=new ob(this,"Tournament 2022 Early Rounds","\n      Lots of potential complexity, but within reason.  Requires all swords and\n      bosses, as well as a few glitches, but guarantees a starting sword.",[n.GuaranteeStartingSword,t.StatueGlitch,t.StatueGauntletSkip,[tb.RandomizeWeaknesses,"?"],r.OrbsNotRequired,r.StoryMode,
[r.VanillaDolphin,"?"],[r.NoThunderSwordWarp,"?"],[v.RandomizeWallElements,"?"],[v.ShuffleGoaFloors,"?"],[v.RandomizeSpriteColors,"?"],[v.RandomizeTrades,"?"],[v.UnidentifiedKeyItems,"?"]]);this.Tournament2022Mid=new ob(this,"Tournament 2022 Mid Rounds","\n      Some additional challenges compared to the early rounds: some additional\n      mystery flags and glitches, as well as max difficulty scaling in the\n      tower.",[[n.GuaranteeStartingSword,"?"],[t.GhettoFlight,"?"],[t.StatueGlitch,"?"],
[t.MtSabreRequirementSkip,"?"],[t.StatueGauntletSkip,"?"],ub.MaxScalingInTower,[ub.NoBuffMedicalHerb,"?"],[tb.RandomizeWeaknesses,"?"],[tb.TowerRobots,"?"],[vb.Barrier,"?"],[vb.BattleMagic,"?"],r.StoryMode,[r.VanillaDolphin,"?"],[r.OrbsNotRequired,"?"],[r.NoThunderSwordWarp,"?"],[v.RandomizeWallElements,"?"],[v.ShuffleGoaFloors,"?"],[v.RandomizeSpriteColors,"?"],[v.RandomizeTrades,"?"],[v.UnidentifiedKeyItems,"?"]]);this.Tournament2022Finals=new ob(this,"Tournament 2022 Finals Round","\n      Many of the more difficult mystery flags from the mid rounds are now\n      always on, plus entrance shuffle.",
[[n.GuaranteeStartingSword,"?"],t.GhettoFlight,t.StatueGlitch,t.MtSabreRequirementSkip,t.StatueGauntletSkip,ub.NoBuffMedicalHerb,ub.MaxScalingInTower,[tb.RandomizeWeaknesses,"?"],[tb.TowerRobots,"?"],vb.Barrier,vb.BattleMagic,r.StoryMode,[r.VanillaDolphin,"?"],[r.OrbsNotRequired,"?"],[r.NoThunderSwordWarp,"?"],v.ShuffleHouses,[v.RandomizeWallElements,"?"],[v.ShuffleGoaFloors,"?"],[v.RandomizeSpriteColors,"?"],[v.RandomizeTrades,"?"],[v.UnidentifiedKeyItems,"?"]])}static get(a){this.instance||(this.instance=
...
!1)}guaranteeMatchingSword(){return this.check(vb.MatchingSword,!1)}guaranteeGasMask(){return this.check(vb.GasMask,!1)}guaranteeBarrier(){return this.check(vb.Barrier,!1)}guaranteeRefresh(){return this.check(n.GuaranteeRefresh)}communityJokes(){return this.check(n.NoCommunityJokes,!1)}disableSwordChargeGlitch(){return this.check(t.SwordChargeGlitch,!1)}disableTeleportSkip(){return this.check(t.MtSabreRequirementSkip,!1)}disableRabbitSkip(){return this.check(t.MtSabreRequirementSkip,!1)}disableShopGlitch(){return this.check(rb.Shops,
!1)}disableStatueGlitch(){return this.check(t.StatueGlitch,!1)}disableRageSkip(){return this.check(t.RageSkip,!1)}disableTriggerGlitch(){return this.check(t.TriggerSkip,!1)}disableFlightStatueSkip(){return this.check(t.StatueGauntletSkip,!1)}assumeSwordChargeGlitch(){return this.check(t.SwordChargeGlitch)}assumeGhettoFlight(){return this.check(t.GhettoFlight)}assumeTeleportSkip(){return this.check(t.MtSabreRequirementSkip)}assumeRabbitSkip(){return this.check(t.MtSabreRequirementSkip)}assumeStatueGlitch(){return this.check(t.StatueGlitch)}assumeTriggerGlitch(){return this.check(t.TriggerSkip)}assumeFlightStatueSkip(){return this.check(t.StatueGauntletSkip)}assumeWildWarp(){return this.check(rb.WildWarp,
!0)||this.check(v.RandomizeWildWarp)}assumeRageSkip(){return this.check(t.RageSkip)}nerfWildWarp(){return this.check(rb.WildWarp,!1)&&this.check(v.RandomizeWildWarp,!1)}allowWildWarp(){return!this.nerfWildWarp()}randomizeWildWarp(){return this.check(v.RandomizeWildWarp,!0)}blackoutMode(){return this.check(ub.Blackout)}hardcoreMode(){return this.check(ub.Permadeath)}buffDyna(){return!this.check(rb.Dyna)}maxScalingInTower(){return this.check(ub.MaxScalingInTower)}expScalingFactor(){return this.check(ub.ExperienceScalesSlower)?
...
this.addExtraChecks();this.unionNeighbors();this.recordExits();this.buildNeighbors();this.addAllRoutes();this.consolidateChecks();this.buildRequirementMap()}addExtraChecks(){const {locations:{Leaf_ToolShop:a,MezameShrine:b,Oak:c,Shyron_ToolShop:d},flags:{AbleToRideDolphin:e,BallOfFire:f,BallOfThunder:g,BallOfWater:h,BallOfWind:k,Barrier:p,BlizzardBracelet:q,BowOfMoon:u,BowOfSun:B,BreakStone:D,BreakIce:x,BreakIron:G,BrokenStatue:R,BuyHealing:U,BuyWarp:X,ClimbWaterfall:S,ClimbSlope8:Wa,ClimbSlope9:va,
ClimbSlope10:Tb,CrossPain:nb,CurrentlyRidingDolphin:fb,Flight:Sa,FlameBracelet:Jb,FormBridge:xb,GasMask:gb,GlowingLamp:hb,InjuredDolphin:ac,LeadingChild:pc,LeatherBoots:qc,Money:ib,OpenedCrypt:jd,RabbitBoots:jb,Refresh:rc,RepairedStatue:Kb,RescuedChild:Nc,ShellFlute:sc,ShieldRing:Oc,ShootingStatue:tc,ShootingStatueSouth:uc,StormBracelet:kd,Sword:Pa,SwordOfFire:vc,SwordOfThunder:wc,SwordOfWater:xc,SwordOfWind:bc,TornadoBracelet:ld,TravelSwamp:Pc,TriggerSkip:Lb,WildWarp:L},items:{MedicalHerb:Ta,WarpBoots:yb}}=
this.rom,sa=this.entrance(b);var kb=this.entrance(c);this.addCheck([sa],Td(u,B),[jd.id]);this.addCheck([sa],Td(e,sc),[fb.id]);this.addCheck([kb],Td(pc),[Nc.id]);this.addItemCheck([sa],Td(hb,R),Kb.id,{lossy:!0,unique:!0});for(var Ha of this.rom.shops)if(Ha.location!==a.id&&Ha.location!==d.id&&Ha.used&&Ha.type===ad.TOOL){kb=[ic(Ha.location<<16|136)];for(var Ab of Ha.contents)Ab===Ta.id?this.addCheck(kb,ib.r,[U.id]):Ab===yb.id&&this.addCheck(kb,ib.r,[X.id])}Ha=bc.r;Ab=vc.r;kb=xc.r;let yc=wc.r;if(!this.flagset.orbsOptional()){var cc=
Ud(k,ld);const a=Ud(f,Jb),b=Ud(h,q),c=Ud(g,kd);Ha=C.meet(Ha,cc);Ab=C.meet(Ab,a);kb=C.meet(kb,b);yc=C.meet(yc,c);if(this.flagset.assumeSwordChargeGlitch()){cc=function(b){return a.map(a=>a[0]===b.c?a:[b.c,...a])};const a=C.or(Ha,Ab,kb,yc);Ha=cc(bc);Ab=cc(vc);kb=cc(xc);yc=cc(wc)}}this.addCheck([sa],Ha,[D.id]);this.addCheck([sa],Ab,[x.id]);this.addCheck([sa],kb,[xb.id]);this.addCheck([sa],yc,[G.id]);this.addCheck([sa],Ud(bc,vc,xc,wc),[Pa.id]);this.addCheck([sa],Sa.r,[S.id,Tb.id]);this.addCheck([sa],
Ud(Sa,jb),[Wa.id]);this.addCheck([sa],Ud(Sa,jb),[va.id]);this.addCheck([sa],p.r,[tc.id,uc.id]);this.addCheck([sa],gb.r,[Pc.id]);Ha=this.flagset.changeGasMaskToHazmatSuit()?gb:qc;this.addCheck([sa],Ud(Sa,jb,Ha),[nb.id]);this.flagset.leatherBootsGiveSpeed()&&this.addCheck([sa],qc.r,[Wa.id]);this.flagset.assumeGhettoFlight()&&this.addCheck([sa],Td(fb,jb),[S.id]);this.flagset.fogLampNotRequired()&&(Ha=this.flagset.requireHealedDolphinToRide(),this.addCheck([sa],Ha?ac.r:[[]],[e.id]));this.flagset.guaranteeBarrier()||
this.addCheck([sa],[[ib.c,U.c],[ib.c,Oc.c],[ib.c,rc.c]],[tc.id,uc.id]);this.flagset.assumeFlightStatueSkip()&&this.addCheck([sa],[[ib.c,Sa.c]],[tc.id]);this.flagset.guaranteeGasMask()||this.addCheck([sa],[[ib.c,U.c],[ib.c,rc.c]],[Pc.id,nb.id]);this.flagset.assumeWildWarp()&&this.addCheck([sa],C.OPEN,[L.id]);this.flagset.assumeTriggerGlitch()&&(this.addCheck([sa],C.OPEN,[Lb.id]),this.addCheck([sa],Lb.r,[nb.id,Wa.id,va.id]))}addExtraRoutes(){var a;const {flags:{BuyWarp:b,SwordOfThunder:c,Teleport:d,
...
WindmillCave:S,WaterfallCave4:Wa,WaterfallValleyNorth:va,ZebuCave:Tb,ZombieTown_HouseBasement:nb},items:{GlowingLamp:fb,KeyToPrison:Sa,LovePendant:Jb,StatueOfOnyx:xb},npcs:{Akahana:gb,AkahanaInBrynmaer:hb,Asina:ac,AztecaInShyron:pc,Clark:qc,Draygon:ib,FortuneTeller:jd,Kensu:jb,KensuInCabin:rc,KensuInSwan:Kb,LeafElder:Nc,LeafRabbit:sc,OakChild:Oc,OakElder:tc,OakMother:uc,PortoaPalaceFrontGuard:kd,PortoaQueen:Pa,PortoaThroneRoomBackDoorGuard:vc,Rage:wc,Stom:xc,StonedAkahana:bc,Tornel:ld,WindmillGuard:Pc,
Zebu:Lb},flags:L}=a;jb.localDialogs.delete(X.id);Kb.link(jb.id);Kb.used=!0;Kb.data=[...jb.data];jb.data[0]=fb.id;U.spawns.find(a=>a.isNpc()&&a.id===jb.id).id=Kb.id;Jb.itemUseData[0].want=256|Kb.id;bc.linkDialog(gb.id);hb.used=!0;hb.link(gb.id);hb.data=[...gb.data];f.spawns.find(a=>a.isNpc()&&a.id===gb.id).id=hb.id;xb.itemUseData[0].want=256|hb.id;Nc.dialog(k).splice(0,0,...Nc.dialog(k).splice(2,1));sc.dialog()[2].condition=L.RescuedLeafElder.id;sc.dialog()[2].flags.push(L.TalkedToLeafRabbit.id);sc.dialog()[3].flags.push(L.TalkedToLeafRabbit.id);
Pc.spawns(S)[1]=~L.WindmillGuardAlarmFluteTradein.id;c(gb.spawns(Wa),~L.BehindWhirlpool.id);c(bc.spawns(Wa),~L.BehindWhirlpool.id);for(var Ta=0;4>Ta;Ta++){var yb=tc.dialog()[Ta];yb.condition!==a.flags.OakElder.id&&(yb.message.action=3)}(()=>{const [a,b,c,d]=uc.dialog();d.condition=~L.RescuedChild.id;b.condition=-1;uc.dialog().splice(0,4,d,c,a,b)})();for(const b of[32,33,34,124,125])d(a.npcs[b].dialog());Oc.dialog().unshift(...Oc.dialog().splice(1,1));vc.spawnConditions.set(u.id,[~L.QueenNotInThroneRoom.id,
~L.MesiaRecording.id]);kd.dialog()[1].condition=L.MesiaRecording.id;Pa.dialog()[3].condition=L.SwordOfWater.id;Pa.dialog()[3].message.action=3;Pa.dialog()[4].flags.push(L.PortoaQueenGoingAway.id);Pa.spawns(u)[1]=~L.MesiaRecording.id;Pa.spawns(D)[0]=L.MesiaRecording.id;Pa.dialog()[1].condition=L.MesiaRecording.id;jd.spawns(x)[1]=~L.MesiaRecording.id;qc.spawnConditions.set(nb.id,[~L.Clark.id]);qc.spawnConditions.set(h.id,[L.Clark.id]);Lb.localDialogs.set(Tb.id,[Re.of(~L.TalkedToZebuInCave.id,[0,26],
[L.TalkedToZebuInCave.id]),Re.of(L.LeafVillagersRescued.id,[0,29]),Re.of(L.LeafAbduction.id,[0,28]),Re.of(L.ZebuAtWindmill.id,[0,29]),Re.of(L.UsedWindmillKey.id,[0,27,3]),Re.of(-1,[0,29])]);c(Lb.spawns(Tb),~L.BehindWhirlpool.id);ld.spawnConditions.delete(q.id);xc.spawnConditions.delete(R.id);c(ac.spawns(D),~L.CalmedAngrySea.id);Ta=a.npcs[52];Ta.spawnConditions.set(u.id,[L.MesiaRecording.id,~L.PortoaQueen.id]);Ta.localDialogs.set(B.id,Ta.localDialogs.get(-1));Ta.data[0]=a.items.FluteOfLime.id;yb=a.messages.alloc();
yb.text="The queen left this for you.";Ta.localDialogs.set(u.id,[Re.of(~L.PortoaQueen.id,[yb.part,yb.id,3]),Re.of(-1,[10,14])]);u.spawns.push(Zd.of({yt:3,xt:12,type:1,patternBank:1,id:Ta.id}));Pa.localDialogs.set(D.id,Pa.dialog().splice(0,2));Pa.localDialogs.set(u.id,Pa.dialog());Pa.localDialogs.delete(-1);rc.spawnConditions.set(e.id,[~L.AbleToRideDolphin.id,L.ReturnedFogLamp.id]);rc.dialog()[0].message.action=2;pc.spawns(G).push(~L.ShyronMassacre.id);a.trigger(130).conditions.push(~L.ShyronMassacre.id);
wc.dialog()[0].condition=L.SwordOfWater.id;ib.spawnConditions.set(g.id,[~L.Draygon2.id]);Lb.dialog(G).unshift(...Lb.dialog(G).splice(1,1));a.trigger(128).conditions=[~L.ShyronMassacre.id,L.TalkedToZebuInShyron.id,L.SwordOfThunder.id];a.trigger(129).conditions=[];b.barrierRequiresCalmSea()&&a.trigger(132).conditions.push(L.CalmedAngrySea.id);a.trigger(140).conditions.push(L.TalkedToZebuInCave.id);a.trigger(141).used=!1;for(const a of p.spawns)a.isTrigger()&&141===a.id&&(a.id=178);(function(a,b){b=
a.findIndex(b);if(0>b)throw Error(`Could not find element in ${a}`);a.splice(b,1)})(va.spawns,a=>a.isTrigger()&&141===a.id);a.trigger(178).conditions.push(L.Kelbesque1.id);a.trigger(178).flags.push(~L.LeafVillagersCurrentlyAbducted.id,~L.LeafElderCurrentlyAbducted.id,L.LeafVillagersRescued.id);a.trigger(140).conditions.push(~L.Kelbesque1.id);a.trigger(134).conditions.push(~L.Kelbesque1.id);c(Sa.itemUseData[0].flags,~L.LeafVillagersCurrentlyAbducted.id);jf(a.trigger(187).conditions,~L.Rage.id,~L.MesiaRecording.id)}
function jf(a,b,c){for(let d=0;d<a.length;d++)if(a[d]===b){a[d]=c;return}throw Error(`Could not find ${b} in ${a.join(",")}`);};const {$0e:mf,$0f:nf,$10:of,$1a:pf}=z,qf=A.of(mf,33689),rf=A.of(mf,39906),sf=A.of(of,36848),tf=A.of(of,36923),uf=A.of(of,36998),vf=A.of(pf,35776),wf=A.of(pf,35785),xf=[["Sword","\n\x0B\f"],[" of ","\\]"],["Bracelet","<=>["],["Shield","\r\u000e\u000f"],["Armor","{\u0011\u0012"],["Magic","#%("],["Power","\u0013\u0014\u0015"],["Item","\u0016\u0017^"]];
