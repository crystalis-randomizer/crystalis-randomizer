...
!0):n.meet(Constraint$$module$js$rom$constraint.MIMIC,!0);else if(a.isNpc()||a.isBoss()){var c=b.getNpcConstraint(e.id,a.id);n=n.meet(c,!0)}else a.isMonster()&&UNTOUCHED_MONSTERS$$module$js$patch[a.monsterId]&&(c=b.getMonsterConstraint(e.id,a.monsterId),n=n.meet(c,!0));g.push(`Initial pass: ${n.fixed.map((a)=>Infinity>a.size?"["+[...a].join(", ")+"]":"all")}`);const r=new Map;c=(a)=>{var c=e.rom.objects[a.id];if(c.monsterClass){var d=r.get(c.monsterClass);if(null!=d&&d!==a.id)return!1}d=FLYERS$$module$js$patch.has(a.id);
var h=MOTHS_AND_BATS$$module$js$patch.has(a.id);if(d){if(!m)return!1;--m}const l=b.getMonsterConstraint(e.id,a.id);let q=n.tryMeet(l);!q&&Infinity>n.pal2.size&&Infinity>n.pal3.size&&this.flags.shuffleSpritePalettes()&&(q=n.tryMeet(l,!0));if(!q)return!1;if(p){var x=e.rom.objects[a.id];if(!(x instanceof Monster$$module$js$rom$monster))throw Error(`non-monster: ${x}`);x=p(x);if(null==x)return!1}g.push(`  Adding ${a.id.toString(16)}: ${q}`);n=q;c.monsterClass&&r.set(c.monsterClass,a.id);c=0;if(d||h)for(d=
...
[95,345,225],[96,18,94],[97,234,96],[98,18,118],[99,36,54],[100,175,97],[101,139,40],[102,66,160],[105,131,201],[106,76,226],[107,18,100],[108,193,103],[120,199,103],[109,205,103],[115,256,67],[110,24,38],[111,44,97]],KEY$$module$js$tracker=new Set([16,18,35,38,97]),BOSSES$$module$js$tracker=new Map([[-257,46],[-258,7],[-259,8],[-260,9],[-261,56],[-262,11],[-263,38],[-264,35],[-265,18],[-266,61],[-267,28],[-269,97]]),TRADES$$module$js$tracker=new Set([41,62,71,72]);
