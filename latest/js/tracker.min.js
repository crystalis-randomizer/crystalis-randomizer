...
a)return`Location ${c.id.toString(16)} (${c.name}) Flag ${b.ys},${b.xs}`;return 0>a?`~${(~a).toString(16).padStart(2,"0")}`:a.toString(16).padStart(2,"0")}const DEBUG$$module$js$graph$world=!0;var module$js$graph$world={};module$js$graph$world.World=World$$module$js$graph$world;function fixDialog$$module$js$pass$fixdialog(a){function b(a){d(a,"teach you the magic of","bestow upon you the")}function c(b){b=a.items[a.itemGets[b].itemId];return`[${hex$$module$js$rom$util(b.id)}:${b.messageName}]`}function d(b,c,d){const [e,f]=b.split(":").map((a)=>parseInt(a,16));b=a.messages.parts[e][f];b.text=b.text.replace(c,d)}var e=buildTradeInMap$$module$js$pass$fixdialog(a),f=a.npcs[94];65>f.data[0]&&b("00:1b");d("00:1b","[41:Refresh]",c(f.data[0]));d("02:02","[29:Gas Mask]",c(a.prg[251902]));
f=a.prg[223220];65>f&&b("03:01");d("03:01","[43:Telepathy]",c(f));f=a.npcs[95];var g=findTornelTradeIn$$module$js$pass$fixdialog(f);d("03:01","[06:Tornado Bracelet]",c(g));d("05:0a","[06:Tornado Bracelet]",c(g));d("05:0a","[44:Teleport]",c(f.data[0]));f=e.get(100);null!=f&&(d("09:01","[35:Fog Lamp]",c(f)),d("09:04","[35:Fog Lamp]",c(f)),d("09:05","[35:Fog Lamp]",c(f)));d("0a:0c","[28:Flute of Lime]",c(a.npcs[56].data[0]));f=a.prg[250361];65>f&&b("0b:01");d("0b:01","[45:Recover]",c(f));f=a.prg[251609];
...
function buildTradeInMap$$module$js$pass$fixdialog(a){const b=new Map;for(const c of a.items)if(c.tradeIn)for(a=0;a<c.tradeIn.length;a+=6)b.set(c.tradeIn[a],c.id);return b}var module$js$pass$fixdialog={};module$js$pass$fixdialog.fixDialog=fixDialog$$module$js$pass$fixdialog;class Tileset$$module$js$rom$tileset extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);b&=63;this.tileBase=65536|b<<8;this.attrBase=77824|b<<4;this.alternatesBase=81408|b<<3;this.tiles=seq$$module$js$rom$util(4,(b)=>tuple$$module$js$rom$util(a.prg,this.tileBase|b<<8,256));this.attrs=seq$$module$js$rom$util(256,(b)=>a.prg[this.attrBase|b>>2]>>((b&3)<<1)&3);this.alternates=tuple$$module$js$rom$util(a.prg,this.alternatesBase,32)}write(a){for(var b=0;256>b;b++){32>b&&(a.rom[this.alternatesBase+
...
undergroundChannelLandBridge$$module$js$patch(l);c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$patch(l);simplifyInvisibleChests$$module$js$patch(l);addCordelWestTriggers$$module$js$patch(l,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$js$patch(l);c.shuffleShops()&&shuffleShops$$module$js$patch(l,c,h);randomizeWalls$$module$js$patch(l,c,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(l,c,h);rescaleMonsters$$module$js$patch(l,c,h);const n=World$$module$js$graph$world.build(l,
c),p=yield(new AssumedFill$$module$js$graph$shuffle(l,c)).shuffle(n.graph,h,f);if(p)n.traverse(n.graph,p),update$$module$js$rom$slots(l,p.slots);else return-1;rescaleShops$$module$js$patch(l,m,c.bargainHunting()?h:void 0);normalizeSwords$$module$js$patch(l,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(l,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(l);c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(l);
c.chargeShotsOnly()&&disableStabs$$module$js$patch(l);c.orbsOptional()&&orbsOptional$$module$js$patch(l);shuffleMusic$$module$js$patch(l,c,h);shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(l,c,h);misc$$module$js$patch(l,c,h);fixDialog$$module$js$pass$fixdialog(l);c.buffDyna()&&buffDyna$$module$js$patch(l,c);yield l.writeData();buffDyna$$module$js$patch(l,c);return yield postParsedShuffle$$module$js$patch(a,h,b,c,m,g)})}
