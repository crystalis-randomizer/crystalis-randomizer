...
a.assumeGhettoFlight())),l=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),p=h(d("Assume teleport skip",a.assumeTeleportSkip())),q=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),t=h(d("Allow rabbit skip",!a.disableRabbitSkip())),u=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),I=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),W=h(d("Assume wild warp",a.assumeWildWarp())),
pa=d("Allow wild warp",a.allowWildWarp()),B=d("Sword magic optional",!a.guaranteeSwordMagic()),G=d("Matching sword optional",!a.guaranteeMatchingSword()),Qa=d("Gas mask optional",!a.guaranteeGasMask()),Pd=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),Qd=d("Calm sea optional",!a.barrierRequiresCalmSea()),Rd=d("Prison key optional",!a.paralysisRequiresPrisonKey()),Sd=d("Windmill optional",!a.sealedCaveRequiresWindmill()),Td=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
...
G.value?G:g,Q),Je=(new Condition$$module$js$nodes(c,"Match vampire 2 sword (wind/water/thunder)")).option(Q).option(M).option(K).option(G.value?G:g,R),Oc=(new Condition$$module$js$nodes(c,"Speed boots")).option(fc,k),Pc=(new Condition$$module$js$nodes(c,"Climb slopes")).option(vb).option(C).option(Oc),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Ac).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(sc).option(Ge,C),Qc=(new Condition$$module$js$nodes(c,
...
Re=(new Condition$$module$js$nodes(c,"Change or glitch")).option(qa).option(ab),Se=(new Condition$$module$js$nodes(c,"Change or glitch or paralysis")).option(qa).option(ab).option(Ka),Fb=(new Condition$$module$js$nodes(c,"Pass shooting statues")).option(tc).option(T,Wb.value?Wb:g).option(Za,gc),Te=(new Condition$$module$js$nodes(c,"Healed dolphin if required")).option(Hc).option(Pd),Vc=(new Condition$$module$js$nodes(c,"Match sword of wind")).option(Q).option(G.value?G:g,T),Wc=(new Condition$$module$js$nodes(c,
"Match sword of fire")).option(R).option(G.value?G:g,T),Xc=(new Condition$$module$js$nodes(c,"Match sword of water")).option(M).option(G.value?G:g,T),Ue=(new Condition$$module$js$nodes(c,"Match sword of thunder")).option(K).option(G.value?G:g,T),Ve=(new Condition$$module$js$nodes(c,"Swamp run possible")).option(T,Oc).option(T,Wd).option(T,Za),We=(new Condition$$module$js$nodes(c,"Insect possible to kill")).option(Ya),cb=(new Condition$$module$js$nodes(c,"Travel swamp")).option(Ya).option(Qa.value?
...
if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return p[a.slotType?a.slotType[0]:"c"]===p[b.slotType?b.slotType[0]:"c"]};q=b.assumedFill(d,(a,b)=>t(a,n.get(b)));if(null==q){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const u=new Map;for(var I=0;I<q.length;I++){var W=q[I];if(null!=W){var pa=n.get(b.item(W));W=m.get(pa);m.delete(pa);pa=b.location(I);u.set(pa,W);l.delete(pa)}}I=(a,b,c)=>{c=void 0===c?"":c;for(const c of l)if(t(c,a))return u.set(c,b),l.delete(c),m.delete(a),
!0;g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var B of m){const [a,b]=B;if(a.isMimic()&&!I(a,b,"traps"))return!1}for(const a of m){const [b,c]=a;if(b.needsChest()&&!I(b,c,"chest"))return!1}for(const a of m){const [b,c]=a;if(!I(b,c))return!1}for(const a of u){const [b,c]=a;b.set(...c)}const {win:G,path:Qa}=a.traverse({wanted:k,dfs:!1});if(!G)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,q));
...
function build$$module$js$graph$world(a,b){b=void 0===b?new FlagSet$$module$js$flagset("@FullShuffle"):b;const c=new Overlay$$module$js$graph$overlay(a,b),d=new Map,e=new Map,f=new Map,g=new Map,h=new DefaultMap$$module$js$util(()=>new Set),k=new Map,m=new Set;for(const b of a.locations){var l=function(a,b){const c=d.get(a);c&&d.set(a,module$js$graph$condition.Terrain.meet(c,b))};if(!b.used)continue;const p=b.extended?256:0,q=a.tilesets[(b.tileset&127)>>2],r=a.tileEffects[b.tileEffects-179];for(const a of b.spawns)a.isWall()&&
e.set(module$js$graph$geometry.ScreenId.from(b,a),a.id);for(let f=0,g=b.height;f<g;f++){const g=b.screens[f],h=b.id<<8|f<<4;for(let f=0,k=b.width;f<k;f++){var n=function(a,b){if(!t)throw Error("flag expected");return b?a?G(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(t.flag)},b):a};const k=a.screens[g[f]|p],m=module$js$graph$geometry.ScreenId(h|f),l=m&255,B=e.get(m),t=null!=B?c.wallCapability(B):b.flags.find((a)=>a.yx===l),G=memoize2$$module$js$graph$condition((a,
b)=>{if(!t)throw Error("flag expected");b=Object.assign({},b,{enter:meet$$module$js$graph$condition(b.enter||[[]],module$js$graph$condition.Condition(t.flag))});return module$js$graph$condition.Terrain.join(a,b)});for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(m<<8|a);let e=k.tiles[a];t&&751===t.flag&&32>e&&(e=q.alternates[e]);let f=c.makeTerrain(p?0:r.effects[e]&38,b);if(32>e&&q.alternates[e]!=e&&t&&751!==t.flag){const a=c.makeTerrain(r.effects[q.alternates[e]],b);f=n(f,a)}f&&d.set(b,
...
b.reqs.check=(a,b)=>{b=void 0===b?W:b;return`${b(a)}: ${I(u.get(module$js$graph$condition.Slot(a)),b)}`};b.reqs.check2=(a)=>b.reqs.check(a,b.whatFlag)}return new World$$module$js$graph$world(a,p,makeGraph$$module$js$graph$world(u,a))}
...
128>this.id},isTrigger(){return 2===this.type&&128<=this.id},isNpc(){return 1===this.type&&192>this.id},isBoss(){return 1===this.type&&192<=this.id},isMonster(){return 0===this.type},isWall(){return 3===this.type&&4>this.id},toString(){return`Spawn ${this.hex()}: (${hex$$module$js$rom$util(this.x)}, ${hex$$module$js$rom$util(this.y)}) ${this.timed?"timed":"fixed"} ${this.type}:${hex$$module$js$rom$util(this.id)}`}}),LOCATIONS$$module$js$rom$location={mezameShrine:[0,"Mezame Shrine"],leafOutsideStart:[1,
"Leaf - Outside Start"],leaf:[2,"Leaf"],valleyOfWind:[3,"Valley of Wind"],sealedCave1:[4,"Sealed Cave 1"],sealedCave2:[5,"Sealed Cave 2"],sealedCave6:[6,"Sealed Cave 6"],sealedCave4:[7,"Sealed Cave 4"],sealedCave5:[8,"Sealed Cave 5"],sealedCave3:[9,"Sealed Cave 3"],sealedCave7:[10,"Sealed Cave 7"],sealedCave8:[12,"Sealed Cave 8"],windmillCave:[14,"Windmill Cave"],windmill:[15,"Windmill"],zebuCave:[16,"Zebu Cave"],mtSabreWestCave1:[17,"Mt Sabre West - Cave 1"],cordelPlainsWest:[20,"Cordel Plains West"],
cordelPlainsEast:[21,"Cordel Plains East"],brynmaer:[24,"Brynmaer"],outsideStomHouse:[25,"Outside Stom House"],swamp:[26,"Swamp"],amazones:[27,"Amazones"],oak:[28,"Oak"],stomHouse:[30,"Stom House"],mtSabreWestLower:[32,"Mt Sabre West - Lower"],mtSabreWestUpper:[33,"Mt Sabre West - Upper"],mtSabreWestCave2:[34,"Mt Sabre West - Cave 2"],mtSabreWestCave3:[35,"Mt Sabre West - Cave 3"],mtSabreWestCave4:[36,"Mt Sabre West - Cave 4"],mtSabreWestCave5:[37,"Mt Sabre West - Cave 5"],mtSabreWestCave6:[38,"Mt Sabre West - Cave 6"],
...
NONE$$module$js$rom$constraint,NONE$$module$js$rom$constraint,NONE$$module$js$rom$constraint],[],0)}static get MIMIC(){return new Constraint$$module$js$rom$constraint([ALL$$module$js$rom$constraint,bit$$module$js$rom$constraint(108),ALL$$module$js$rom$constraint,ALL$$module$js$rom$constraint],[],0)}static get TREASURE_CHEST(){return new Constraint$$module$js$rom$constraint([ALL$$module$js$rom$constraint,ALL$$module$js$rom$constraint,ALL$$module$js$rom$constraint,ALL$$module$js$rom$constraint],[new Set(TREASURE_CHEST_BANKS$$module$js$rom$constraint)],
0)}static forLocation(a){switch(a){case 3:return new Constraint$$module$js$rom$constraint([ALL$$module$js$rom$constraint,bit$$module$js$rom$constraint(96),ALL$$module$js$rom$constraint,ALL$$module$js$rom$constraint],[],0);case 96:case 100:case 104:return new Constraint$$module$js$rom$constraint([ALL$$module$js$rom$constraint,bit$$module$js$rom$constraint(82),ALL$$module$js$rom$constraint,bit$$module$js$rom$constraint(8)],[],0)}return Constraint$$module$js$rom$constraint.ALL}static fromSpawn(a,b,c,
d,e){const [f,...g]=b;(e=e&&2===f&&!g.length)&&d.patternBank&&(b=new Set([3]));const h=e||!b.has(2)?ALL$$module$js$rom$constraint:bit$$module$js$rom$constraint(c.spritePatterns[0]);b=e||!b.has(3)?ALL$$module$js$rom$constraint:bit$$module$js$rom$constraint(c.spritePatterns[1]);d=e?[bit$$module$js$rom$constraint(c.spritePatterns[d.patternBank])]:[];e=a.has(2)?bit$$module$js$rom$constraint(c.spritePalettes[0]):ALL$$module$js$rom$constraint;a=a.has(3)?bit$$module$js$rom$constraint(c.spritePalettes[1]):
ALL$$module$js$rom$constraint;return new Constraint$$module$js$rom$constraint([h,b,e,a],d,0)}ignorePalette(){return new Constraint$$module$js$rom$constraint([this.fixed[0],this.fixed[1],ALL$$module$js$rom$constraint,ALL$$module$js$rom$constraint],this.float,this.shift)}join(a){const b=seq$$module$js$rom$util(4,(b)=>CSet$$module$js$rom$constraint.union(this.fixed[b],a.fixed[b]));if(this.float.length!=a.float.length)throw console.dir(this),console.dir(a),Error(`incompatible float: ${this.float} ${a.float}`);
const c=seq$$module$js$rom$util(this.float.length,(b)=>CSet$$module$js$rom$constraint.union(this.float[b],a.float[b]));return new Constraint$$module$js$rom$constraint(b,c,this.shift|a.shift)}fix(a){const b=a?(b)=>a.nextInt(b):()=>0,c=[...this.fixed];if(this.float.length){const a=b(2),e=1-a;a<this.float.length&&(c[0]=CSet$$module$js$rom$constraint.intersect(c[0],this.float[a]));e<this.float.length&&(c[1]=CSet$$module$js$rom$constraint.intersect(c[1],this.float[e]))}return c.map((a)=>{if(a===ALL$$module$js$rom$constraint)return 255;
a=[...a];return a[b(a.length)]})}meet(a){const b=[];let c=this.shift;for(var d=0;4>d;d++){var e=CSet$$module$js$rom$constraint.intersect(this.fixed[d],a.fixed[d]);if(!e.size)return;b.push(e)}e=new Map;d=[];for(var f of module$js$util.iters.concat(this.float,a.float)){if(f===ALL$$module$js$rom$constraint)throw Error("Unexpected unconstrained float");a=!1;for(var g of f){const b=e.get(g);if(null!=b){for(var h of d[b])e.delete(h);d[b]=CSet$$module$js$rom$constraint.intersect(d[b],f);for(const a of d[b])e.set(a,
b);a=!0;break}}if(a)break;for(const a of f)e.set(a,d.length);d.push(f);if(2<d.length)return}for(f=0;f<d.length;f++)for(g=0;2>g;g++)if(!CSet$$module$js$rom$constraint.intersect(d[f],b[g]).size){h=b[1-g]=CSet$$module$js$rom$constraint.intersect(d[f],b[1-g]);c|=1<<1-g;if(!h.size)return;d.splice(f,1);f=-1;break}return new Constraint$$module$js$rom$constraint(b,d,c)}}const TREASURE_CHEST_BANKS$$module$js$rom$constraint=new Set([94,95,96,97,100,101,102,103,104,105,106,108,109,110,111,112,116,117,118,119]);
var module$js$rom$constraint={};module$js$rom$constraint.Constraint=Constraint$$module$js$rom$constraint;class ObjectData$$module$js$rom$objectdata extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.used=!0;this.name="";this.pointer=109568+(b<<1);this.base=readLittleEndian$$module$js$rom$util(a.prg,this.pointer)+65536;this.sfx=a.prg[this.base];this.data=[];b=this.base+1;let c=0;for(let d=0;32>d;d++)d&7||(c=a.prg[b++]),this.data.push(c&128?a.prg[b++]:0),c<<=1}serialize(){const a=[this.sfx];for(let b=0;4>b;b++){const c=a.length;a.push(0);for(let d=0;8>d;d++)this.data[8*b+d]&&(a[c]|=
...
const ACTION_SCRIPTS$$module$js$rom$monster=new Map([[16,{}],[17,{}],[22,{}],[23,{}],[27,{}],[30,{}],[31,{}],[32,{movement:1}],[33,{child:!0,large:!0,movement:2}],[34,{child:!0,movement:3}],[36,{movement:3}],[37,{movement:3}],[38,{child:!0,projectile:1,movement:3}],[39,{child:!0,projectile:1,movement:3}],[40,{child:!0,projectile:2,movement:3,metasprites:()=>[101,145]}],[41,{child:!0,movement:5,metasprites:()=>[107,104]}],[42,{child:!0,projectile:1,movement:4,metasprites:(a)=>[0,1,2,3].map((b)=>b+
a.data[31])}],[43,{movement:4}],[44,{child:!0}],[46,{child:!0,large:!0,projectile:2,movement:3}],[47,{}],[52,{child:!0}],[56,{}],[60,{}],[64,{child:!0,moth:!0,movement:4}],[65,{child:!0,movement:3}],[68,{movement:3}],[69,{child:!0,bird:!0,projectile:2,movement:5}],[76,{child:!0,stationary:!0,projectile:3}],[77,{child:!0,stationary:!0,projectile:3}],[78,{child:!0,stationary:!0}],[87,{}],[88,{}],[92,{child:!0,projectile:3,movement:1}],[93,{bird:!0,movement:6}],[94,{child:!0,projectile:1,movement:4,
...
whiteRobot:["White Robot",161,47],towerSentinel:["Tower Sentinel",162,47],helicopter:["Helicopter",163,47]},OBJECTS$$module$js$rom$objects={verticalPlatform:["Vertical Platform",126,28],horizotalPlatform:["Horizontal Platform",127,28],glitch1:["Glitch",141,41],glitch2:["Glitch",142,41],guardianStatue:["Guardian Statue",143,41],statueOfSun:["Statue of Sun",156,47],statueOfMoon:["Statue of Moon",157,47],crumblingVerticalPlatform:["Crumbling Vertical Platform",159,47],glitch3:["Glitch",166,41]},BOSSES$$module$js$rom$objects=
...
class Slot$$module$js$rom$spoiler{constructor(a,b,c,d){this.slot=b;this.slotName=c;this.item=d;this.itemName=slotToItem$$module$js$rom$spoiler(a,d);this.originalItem=slotToItem$$module$js$rom$spoiler(a,b)}toString(){return`${this.itemName}: ${this.slotName} (${this.originalItem})`}}function slotToItem$$module$js$rom$spoiler(a,b){return 112<=b?"Mimic":a.items[a.itemGets[b].itemId].messageName}var module$js$rom$spoiler={};module$js$rom$spoiler.Spoiler=Spoiler$$module$js$rom$spoiler;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="latest",LABEL$$module$js$version="latest b9f61b5",HASH$$module$js$version="b9f61b52edc0fa5d7aece528ddcca7a3d2236a46",DATE$$module$js$version=new Date(1563303204E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;class Graphics$$module$js$rom$graphics{constructor(a){this.rom=a;this.monsterConstraints=new Map;this.npcConstraints=new Map;var b=new DefaultMap$$module$js$util(()=>[]);for(var c of a.locations)if(c.used)for(var d=0;d<c.spawns.length;d++){const a=c.spawns[d];a.used&&(a.isMonster()?b.get(a.monsterId).push([c,d,a]):a.isNpc()&&b.get(~a.id).push([c,d,a]))}for(const [e,f]of b)if(0>e){if(!a.metasprites[a.npcs[~e].data[3]])throw Error(`bad NPC: ${~e}`);b=computeConstraint$$module$js$rom$graphics(a,[a.npcs[~e].data[3]],
f,!0);95===~e&&(b=b.ignorePalette());this.npcConstraints.set(~e,b)}else{b=Constraint$$module$js$rom$constraint.ALL;c=this.rom.objects[e];if(!(c instanceof Monster$$module$js$rom$monster))throw Error(`expected monster: ${c} from ${f}`);for(const g of allObjects$$module$js$rom$graphics(a,c)){d=ACTION_SCRIPTS$$module$js$rom$monster.get(g.action);d=computeConstraint$$module$js$rom$graphics(a,(d&&d.metasprites||(()=>[g.metasprite]))(g),f,g.id===e);d=b.meet(d);if(!d)throw Error(`Bad meet for ${e} with ${g.id}`);
d&&(b=d)}this.monsterConstraints.set(c.id,b);c.constraint=b}}configure(a,b){const c=b.isMonster()?this.monsterConstraints.get(b.monsterId):b.isNpc()?this.npcConstraints.get(b.id):b.isChest()?112>b.id?Constraint$$module$js$rom$constraint.TREASURE_CHEST:Constraint$$module$js$rom$constraint.MIMIC:void 0;if(c){if(3===c.shift||2<=c.float.length)throw Error("don't know what to do with two floats");if(!c.float.length)b.patternBank=Number(2===c.shift);else if(c.float[0].has(a.spritePatterns[0]))b.patternBank=
0;else if(c.float[0].has(a.spritePatterns[1]))b.patternBank=1;else if(b.isMonster())throw Error("no matching pattern bank");}}}function*allObjects$$module$js$rom$graphics(a,b){yield b;var c=b.spawnedReplacement();c&&(yield*allObjects$$module$js$rom$graphics(a,c));(c=b.spawnedChild())&&(yield*allObjects$$module$js$rom$graphics(a,c));80===b.id&&(yield a.objects[95]);83===b.id&&(yield a.objects[105])}
function computeConstraint$$module$js$rom$graphics(a,b,c,d){const e=new Set,f=new Set;for(const c of b.map((b)=>a.metasprites[b])){for(const a of c.palettes())f.add(a);for(const a of c.patternBanks())e.add(a)}d=d&&1==e.size&&2===[...e][0];b=new Map;for(const [a,,e]of c)b.set(e.patternBank&&d?~a.id:a.id,e);c=void 0;for(let [g,h]of b)b=Constraint$$module$js$rom$constraint.fromSpawn(f,e,a.locations[0>g?~g:g],h,d),c=c?c.join(b):b;if(!c)throw Error("Expected child to appear");return c}
var module$js$rom$graphics={};module$js$rom$graphics.Graphics=Graphics$$module$js$rom$graphics;var $jscompDefaultExport$$module$js$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$js$flagset(String(b.flags)):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$js$patch(a,parseSeed$$module$js$patch(String(b.seed)),d,new FetchReader$$module$js$fetchreader(c))})}};
...
simplifyInvisibleChests$$module$js$patch(l);addCordelWestTriggers$$module$js$patch(l,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$js$patch(l);c.shuffleShops()&&shuffleShops$$module$js$patch(l,c,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(l,c,h);const n=World$$module$js$graph$world.build(l,c),p=yield(new AssumedFill$$module$js$graph$shuffle(l,c)).shuffle(n.graph,h,f);if(p)n.traverse(n.graph,p),update$$module$js$rom$slots(l,p.slots);else return-1;rescaleShops$$module$js$patch(l,m,
c.bargainHunting()?h:void 0);normalizeSwords$$module$js$patch(l,c,h);rescaleMonsters$$module$js$patch(l,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(l,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(l);c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(l);c.chargeShotsOnly()&&disableStabs$$module$js$patch(l);c.orbsOptional()&&orbsOptional$$module$js$patch(l);shuffleMusic$$module$js$patch(l,
c,h);misc$$module$js$patch(l,c,h);c.buffDyna()&&buffDyna$$module$js$patch(l,c);yield l.writeData();buffDyna$$module$js$patch(l,c);return yield postParsedShuffle$$module$js$patch(a,h,b,c,m,g)})}
...
7,6,28,40,,,],[160,"m","Ground Sentry (1)",4,,6,26,,73],[161,"m","Tower Defense Mech (2)",5,,8,36,,85],[162,"m","Tower Sentinel",,,1,,,32],[163,"m","Air Sentry",3,,2,26,,65],[165,"b","Vampire 2",3,,12,27,,,],[164,"b","Dyna",6,5,32,,,,],[180,"b","dyna pod",6,5,48,26,,,],[184,"p","dyna counter",15,,,42,,,],[185,"p","dyna laser",15,,,42,,,],[186,"p","dyna bubble",,,,36,,,],[188,"m","vamp2 bat",,,,16,,15],[191,"p","draygon2 fireball",,,,26,,,],[193,"m","vamp1 bat",,,,16,,15],[195,"p","giant insect spit",
,,,35,,,],[196,"m","summoned insect",4,,2,42,,98],[197,"p","kelby1 rock",,,,22,,,],[198,"p","sabera1 balls",,,,19,,,],[199,"p","kelby2 fireballs",,,,11,,,],[200,"p","sabera2 fire",,,1,6,,,],[201,"p","sabera2 balls",,,,17,,,],[202,"p","karmine balls",,,,25,,,],[203,"p","sun/moon statue fireballs",,,,39,,,],[204,"p","draygon1 lightning",,,,37,,,],[205,"p","draygon2 laser",,,,36,,,],[206,"p","draygon2 breath",,,,36,,,],[224,"p","evil bomber bird bomb",,,,2,,,],[226,"p","summoned insect bomb",,,,47,,
,],[227,"p","paralysis beam",,,,23,,,],[228,"p","stone gaze",,,,33,,,],[229,"p","rock golem rock",,,,24,,,],[230,"p","curse beam",,,,10,,,],[231,"p","mp drain web",,,,11,,,],[232,"p","fishman trident",,,,15,,,],[233,"p","orc axe",,,,24,,,],[234,"p","Swamp Pollen",,,,37,,,],[235,"p","paralysis powder",,,,17,,,],[236,"p","draygonia solider sword",,,,28,,,],[237,"p","ice golem rock",,,,20,,,],[238,"p","troll axe",,,,27,,,],[239,"p","kraken ink",,,,24,,,],[240,"p","draygonia archer arrow",,,,12,,,],[241,
"p","??? unused",,,,16,,,],[242,"p","draygonia knight sword",,,,9,,,],[243,"p","moth residue",,,,19,,,],[244,"p","ground sentry laser",,,,13,,,],[245,"p","tower defense mech laser",,,,23,,,],[246,"p","tower sentinel laser",,,,8,,,],[247,"p","skeleton shot",,,,11,,,],[248,"p","lavaman shot",,,,14,,,],[249,"p","black knight flail",,,,18,,,],[250,"p","lizardman flail",,,,21,,,],[252,"p","mado shuriken",,,,36,,,],[253,"p","guardian statue missile",,,,23,,,],[254,"p","demon wall fire",,,,23,,,]].map((a)=>
{var [b,c,d,e=0,f=0,g=0,h=0,k=0,m=0]=a;return[b,{id:b,type:c,name:d,sdef:e,swrd:f,hits:g,satk:h,dgld:k,sexp:m}]}));
...
!b)&&a.spritePatterns&&a.spritePalettes){e=[];c=[];b=12;for(const d of a.spawns){++b;if(!d.used||!d.isMonster())continue;const h=d.monsterId;if(h in UNTOUCHED_MONSTERS$$module$js$patch||!SCALED_MONSTERS$$module$js$patch.has(h)||"m"!==SCALED_MONSTERS$$module$js$patch.get(h).type)continue;var f=a.rom.objects[h];if(!f)continue;const m=d.patternBank,l=a.spritePatterns[m];var g=f.palettes(!0);f=g.includes(2)?a.spritePalettes[0]:void 0;g=g.includes(3)?a.spritePalettes[1]:void 0;e.push({id:h,pat:l,pal2:f,
pal3:g,patBank:m});(this.report[`start-${h.toString(16)}`]=this.report[`start-${h.toString(16)}`]||[]).push("$"+a.id.toString(16));c.push(b)}e.length&&(d||this.locations.push({location:a,slots:c}),this.monsters.push(...e))}}shuffle(a,b){this.report["pre-shuffle locations"]=this.locations.map((a)=>a.location.id);this.report["pre-shuffle monsters"]=this.monsters.map((a)=>a.id);a.shuffle(this.locations);a.shuffle(this.monsters);this.report["post-shuffle locations"]=this.locations.map((a)=>a.location.id);
for(this.report["post-shuffle monsters"]=this.monsters.map((a)=>a.id);this.locations.length;){const {location:e,slots:f}=this.locations.pop(),g=this.report["$"+e.id.toString(16).padStart(2,"0")]=[],{maxFlyers:h=0,nonFlyers:k={},tower:m=!1}=MONSTER_ADJUSTMENTS$$module$js$patch[e.id]||{};if(m)continue;let l=h,n=Constraint$$module$js$rom$constraint.forLocation(e.id);null!=e.bossId()&&(n=n.meet(Constraint$$module$js$rom$constraint.TREASURE_CHEST)||n);for(const a of e.spawns)if(!a.isChest()||a.data[2]&
32)if(a.isNpc()){var c=b.npcConstraints.get(a.id);c&&(n=n.meet(c)||n)}else a.isMonster()&&UNTOUCHED_MONSTERS$$module$js$patch[a.monsterId]&&(c=b.monsterConstraints.get(a.monsterId))&&(n=n.meet(c)||n);else n=112>a.id?n.meet(Constraint$$module$js$rom$constraint.TREASURE_CHEST)||n:n.meet(Constraint$$module$js$rom$constraint.MIMIC)||n;g.push(`Initial pass: ${n.fixed.map((a)=>Infinity>a.size?"["+[...a].join(", ")+"]":"all")}`);c=(a)=>{var c=FLYERS$$module$js$patch.has(a.id),d=MOTHS_AND_BATS$$module$js$patch.has(a.id);
if(c){if(!l)return!1;--l}var h=b.monsterConstraints.get(a.id);h=h&&n.meet(h);if(!h)return!1;g.push(`  Adding ${a.id.toString(16)}: ${h}`);n=h;h=0;if(c||d)for(c=0;c<f.length;c++){if(f[c]in k){h=c;break}}else for(c=0;c<f.length;c++)if(!(f[c]in k)){h=c;break}(this.report[`mon-${a.id.toString(16)}`]=this.report[`mon-${a.id.toString(16)}`]||[]).push("$"+e.id.toString(16));c=f[h];d=e.spawns[c-13];c in k&&(d.y+=16*k[c][0],d.x+=16*k[c][1]);d.monsterId=a.id;g.push(`    slot ${c.toString(16)}: ${d}`);f.splice(h,
1);return!0};if(l)for(var d=0;d<Math.min(40,this.monsters.length);d++)FLYERS$$module$js$patch.has(this.monsters[d].id)&&c(this.monsters[d])&&this.monsters.splice(d,1);for(d=0;d<this.monsters.length&&f.length;d++)if(c(this.monsters[d])){const [a]=this.monsters.splice(d,1);FLYERS$$module$js$patch.has(a.id)||this.used.push(a);d--}for(d=0;d<this.used.length&&f.length;d++)c(this.used[d])&&(this.used.push(...this.used.splice(d,1)),d--);[e.spritePatterns[0],e.spritePatterns[1],e.spritePalettes[0],e.spritePalettes[1]]=
