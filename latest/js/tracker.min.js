...
a.assumeGhettoFlight())),l=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),p=h(d("Assume teleport skip",a.assumeTeleportSkip())),q=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),t=h(d("Allow rabbit skip",!a.disableRabbitSkip())),u=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),z=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),va=h(d("Assume wild warp",a.assumeWildWarp())),
ba=d("Allow wild warp",a.allowWildWarp()),G=d("Sword magic optional",!a.guaranteeSwordMagic()),I=d("Matching sword optional",!a.guaranteeMatchingSword()),Qa=d("Gas mask optional",!a.guaranteeGasMask()),Pd=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),Qd=d("Calm sea optional",!a.barrierRequiresCalmSea()),Rd=d("Prison key optional",!a.paralysisRequiresPrisonKey()),Sd=d("Windmill optional",!a.sealedCaveRequiresWindmill()),Td=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
...
27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),F=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),L=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),wa=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),rb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),N=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),W=(new Item$$module$js$nodes(c,
...
68,"Teleport")).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),je=(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),tc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),pa=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),C=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=N.bossDrop("Vampire 2",
...
Xb:g).option(Za),Sc=(new Condition$$module$js$nodes(c,"Wind magic")).option(G.value?G:g,U).option(Ia,Ja,U),Tc=(new Condition$$module$js$nodes(c,"Fire magic")).option(G.value?G:g,U).option(Sa,Ta,U),Uc=(new Condition$$module$js$nodes(c,"Water magic")).option(G.value?G:g,U).option(G,U).option(Ua,Va,U),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(G.value?G:g,U).option(G,U).option(Wa,U).option(Xa,U),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(ub).option(ab),
Re=(new Condition$$module$js$nodes(c,"Change or glitch")).option(pa).option(ab),Se=(new Condition$$module$js$nodes(c,"Change or glitch or paralysis")).option(pa).option(ab).option(Ka),Fb=(new Condition$$module$js$nodes(c,"Pass shooting statues")).option(tc).option(T,Wb.value?Wb:g).option(Za,gc),Te=(new Condition$$module$js$nodes(c,"Healed dolphin if required")).option(Hc).option(Pd),Vc=(new Condition$$module$js$nodes(c,"Match sword of wind")).option(Q).option(I.value?I:g,T),Wc=(new Condition$$module$js$nodes(c,
...
ff=e(7,"Sabera 2",Wc,Tc).get(sb),gf=e(8,"Mado 2",Xc,Uc).get(qb),hf=e(9,"Karmine",Ue,Pe).get(zb),jf=e(10,"Draygon 1",T).get(ee),kf=e(-1,"Statues",qc,pc),lf=e(11,"Draygon 2",T,rc),mf=e(13,"Dyna",pb),nf=(new Condition$$module$js$nodes(c,"Opened prison if required")).option(xb).option(Rd),X=new Area$$module$js$nodes(c,"Leaf"),ya=new Area$$module$js$nodes(c,"Valley of Wind"),V=new Area$$module$js$nodes(c,"Sealed Cave"),qa=new Area$$module$js$nodes(c,"Cordel Plain"),za=new Area$$module$js$nodes(c,"Brynmaer"),
Aa=new Area$$module$js$nodes(c,"Amazones"),D=new Area$$module$js$nodes(c,"Mt Sabre West"),w=new Area$$module$js$nodes(c,"Mt Sabre North"),db=new Area$$module$js$nodes(c,"Nadare's"),Ma=new Area$$module$js$nodes(c,"Oak"),ia=new Area$$module$js$nodes(c,"Waterfall Valley"),B=new Area$$module$js$nodes(c,"Portoa"),ja=new Area$$module$js$nodes(c,"Waterfall Cave"),E=new Area$$module$js$nodes(c,"Fog Lamp Cave"),ka=new Area$$module$js$nodes(c,"Kirisa Plant Cave"),ra=new Area$$module$js$nodes(c,"Angry Sea"),
la=new Area$$module$js$nodes(c,"Joel"),J=new Area$$module$js$nodes(c,"Evil Spirit Island"),ma=new Area$$module$js$nodes(c,"Sabera's Castle"),Y=new Area$$module$js$nodes(c,"Swan"),A=new Area$$module$js$nodes(c,"Mt Hydra"),na=new Area$$module$js$nodes(c,"Shyron"),sa=new Area$$module$js$nodes(c,"Styx"),ta=new Area$$module$js$nodes(c,"Goa"),eb=new Area$$module$js$nodes(c,"Draygonia Fortress 1"),Z=new Area$$module$js$nodes(c,"Draygonia Fortress 2"),Ba=new Area$$module$js$nodes(c,"Draygonia Fortress 3"),
P=new Area$$module$js$nodes(c,"Draygonia Fortress 4"),H=new Area$$module$js$nodes(c,"Oasis Cave"),aa=new Area$$module$js$nodes(c,"Sahara"),Ca=new Area$$module$js$nodes(c,"Pyramid Front"),da=new Area$$module$js$nodes(c,"Pyramid Back"),ea=new Area$$module$js$nodes(c,"Tower"),Gb=(new Location$$module$js$nodes(c,0,X,"Start")).overworld().start(),of=(new Location$$module$js$nodes(c,0,X,"Mezame Shrine")).overworld().from(Gb),pf=(new Location$$module$js$nodes(c,1,X,"Outside Start")).overworld().connect(of),
oa=(new Location$$module$js$nodes(c,2,X,"Town")).town().connect(pf),Na=(new Location$$module$js$nodes(c,3,ya,"Main")).overworld().connect(oa).trigger(wc,La),Zc=(new Location$$module$js$nodes(c,3,ya,"Outside Windmill")).overworld(),$c=(new Location$$module$js$nodes(c,4,V,"Tunnel 1 (entrance)")).cave().from(Na,La),qf=(new Location$$module$js$nodes(c,5,V,"Tunnel 2 (over bridge)")).cave().connect($c),rf=(new Location$$module$js$nodes(c,6,V,"Tunnel 6 (herb dead end)")).cave().chest(F,15),ad=(new Location$$module$js$nodes(c,
...
uc,vc).trigger(wc,La,Ab),zf=(new Location$$module$js$nodes(c,16,ya,"Zebu's Cave Back")).cave().trigger(zc).connect(yf,y),Af=(new Location$$module$js$nodes(c,17,D,"Tunnel 1 (to Zebu)")).cave().connect(zf),Da=(new Location$$module$js$nodes(c,20,qa,"West")).overworld().connect(xf,Ye),Bf=(new Location$$module$js$nodes(c,20,qa,"South")).overworld().connect(Da,v),bd=(new Location$$module$js$nodes(c,21,qa,"East")).overworld().connect(Da).chest(dc,24),Oa=(new Location$$module$js$nodes(c,24,za,"Town")).town().connect(Da).trigger(me,
dc),Cf=(new Location$$module$js$nodes(c,25,qa,"Outside Stom's House")).town().connect(Da),Hb=(new Location$$module$js$nodes(c,26,qa,"Swamp")).overworld().connect(bd,cb).trigger(Bb,yc,cb);(new Location$$module$js$nodes(c,26,qa,"Swamp Insect Area")).overworld().connect(Hb,cb).boss(af);const fb=(new Location$$module$js$nodes(c,27,Aa,"Town")).town().connect(Bf),gb=(new Location$$module$js$nodes(c,28,Ma,"Town")).town().connect(Hb,cb).trigger(xc);(new Location$$module$js$nodes(c,30,qa,"Stom's House")).house().connect(Cf).trigger(ne,
xc);const Ea=(new Location$$module$js$nodes(c,32,D,"Entrance")).overworld().connect(Da).connect(Af),Df=(new Location$$module$js$nodes(c,32,D,"Up Slope")).overworld().from(Ea,Pc).to(Ea),Ef=(new Location$$module$js$nodes(c,32,D,"Dead End (warp boots)")).overworld().chest(S,24,106),cd=(new Location$$module$js$nodes(c,33,D,"Upper")).overworld().from(Ea,C).to(Ea),Ff=(new Location$$module$js$nodes(c,33,D,"Tornel Dead End")).overworld().trigger(qe,Ia,Ja).chest(W,23,105),dd=(new Location$$module$js$nodes(c,
...
(new Location$$module$js$nodes(c,79,E,"Tunnel 7b (fog lamp)")).cave().connect(sg,x).chest(jc,19);const ua=(new Location$$module$js$nodes(c,80,B,"Town")).town().connect(jb),rd=(new Location$$module$js$nodes(c,81,B,"Fishherman Island")).town().connect(ua);(new Location$$module$js$nodes(c,82,ia,"Mesia Shrine")).cave().trigger(Fc).connect(cg,v,Ec);const sd=(new Location$$module$js$nodes(c,84,ja,"Tunnel 1a (entrance)")).cave().connect(jb);(new Location$$module$js$nodes(c,84,ja,"Tunnel 1b (dead end, mimic)")).cave().connect(sd,
...
93,ea,"Outside Dyna Room")).misc().from(ud,pb);(new Location$$module$js$nodes(c,94,ea,"Mesia")).misc().connect(ud).trigger(Ee);const Ag=(new Location$$module$js$nodes(c,95,ea,"Dyna")).misc().from(zg).boss(mf);(new Location$$module$js$nodes(c,95,ea,"Win")).misc().from(Ag).end();const Mb=(new Location$$module$js$nodes(c,96,ra,"Cabin Beach")).sea().from(rd,Cb),Fa=(new Location$$module$js$nodes(c,96,ra,"South")).sea().connect(Mb,ca),Bg=(new Location$$module$js$nodes(c,96,ra,"Joel Beach")).sea().connect(Fa,
ca),vd=(new Location$$module$js$nodes(c,96,la,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(c,96,ra,"Altar")).sea().connect(Fa,ca).trigger(Db,mc,lc);const Cg=(new Location$$module$js$nodes(c,96,ra,"North")).sea().to(Fa,ca).from(Fa,ca,Oe).trigger(we,Xe),Dg=(new Location$$module$js$nodes(c,96,ra,"Swan Beach")).sea().connect(Cg,ca);(new Location$$module$js$nodes(c,97,ra,"Cabin")).misc().connect(Mb).trigger(Ic,Cb);(new Location$$module$js$nodes(c,98,la,"Lighthouse")).misc().connect(vd).trigger(ve,
...
const Pg=(new Location$$module$js$nodes(c,112,la,"Secret Passage")).cave().connectTo(vd),lb=(new Location$$module$js$nodes(c,113,la,"Town")).town().connect(Bg),fa=(new Location$$module$js$nodes(c,114,Y,"Town")).town().connect(Dg),Qg=(new Location$$module$js$nodes(c,115,Y,"Inside Gate")).overworld().connect(fa),Rg=(new Location$$module$js$nodes(c,115,Y,"Outside Gate")).overworld().from(Qg,pa),mb=(new Location$$module$js$nodes(c,120,ta,"Valley")).overworld().connect(Rg),Pb=(new Location$$module$js$nodes(c,
...
132,A,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,A,"Tunnel 8 (red slimes)")).cave().from($g,x).connectTo(Dd).chest(O,23,116);const ah=(new Location$$module$js$nodes(c,134,A,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Ed),bh=(new Location$$module$js$nodes(c,135,A,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,135,A,"Tunnel 10b (past wall)")).cave().connect(bh,x).connectTo(Vg);const Gd=(new Location$$module$js$nodes(c,
136,sa,"Entrance")).fortress().from(Cd,ic,Fb),ch=(new Location$$module$js$nodes(c,137,sa,"Left branch")).fortress().connect(Gd).chest(O,19,117),dh=(new Location$$module$js$nodes(c,137,sa,"Left branch, past one bridge")).fortress().connect(ch,v),eh=(new Location$$module$js$nodes(c,137,sa,"Left branch, past two bridges")).fortress().connect(dh,v).chest(F,29,87),fh=(new Location$$module$js$nodes(c,137,sa,"Right branch")).fortress().connect(Gd);(new Location$$module$js$nodes(c,137,sa,"Right branch, across water")).fortress().connect(fh,
C).chest(O,20,118).chest(O,21,119).chest(Zd,28);(new Location$$module$js$nodes(c,138,sa,"Upper floor")).fortress().connect(eh).chest(K,27);const Ga=(new Location$$module$js$nodes(c,140,na,"Town")).town().connect(Xg,Re).trigger(Eb),Pa=(new Location$$module$js$nodes(c,142,ta,"Town")).town().connect(mb),Hd=(new Location$$module$js$nodes(c,143,H,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,H,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Hd,
xa).chest(fe,15);const Qb=(new Location$$module$js$nodes(c,144,ta,"Desert 1")).overworld().connect(mb),nb=(new Location$$module$js$nodes(c,145,H,"Area 1 (from entrance)")).cave().chest(fc,26),Id=(new Location$$module$js$nodes(c,145,H,"Area 2 (across top bridge)")).cave().connect(nb,v);(new Location$$module$js$nodes(c,145,H,"Area 3 (dead-end across top-right bridge)")).cave().connect(Id,v);const gh=(new Location$$module$js$nodes(c,145,H,"Area 4 (left across middle-right bridge)")).cave().connect(Id,
...
168,eb,"Entrance")).fortress().connect(Pa,Fb).trigger(Nc,K),yh=(new Location$$module$js$nodes(c,169,eb,"Main")).fortress().from(Kd,xa),zh=(new Location$$module$js$nodes(c,169,eb,"Boss")).fortress().connect(yh).boss(ef),Ah=(new Location$$module$js$nodes(c,170,eb,"Zebu")).fortress().connect(zh),ob=(new Location$$module$js$nodes(c,171,Z,"Entrance")).fortress().connect(Ah);(new Location$$module$js$nodes(c,171,Z,"Dead End Behind Iron (fruit of power)")).fortress().connect(ob,xa).chest(N,28,98);(new Location$$module$js$nodes(c,
171,Z,"Dead End Loop Across Closer Bridges")).fortress().connect(ob,v).connect(ob,v);const Bh=(new Location$$module$js$nodes(c,171,Z,"Across First Bridge (fruit of repun)")).fortress().connect(ob,v).chest(sb,30,102),Tb=(new Location$$module$js$nodes(c,171,Z,"Across Second Bridge")).fortress().connect(Bh,v);(new Location$$module$js$nodes(c,171,Z,"Dead End Across Two Bridges ()")).fortress().connect(Tb,v).connect(Tb,v).chest(wa,29,93);const Ch=(new Location$$module$js$nodes(c,171,Z,"Across Third Bridge")).fortress().connect(Tb,
v),Dh=(new Location$$module$js$nodes(c,171,Z,"Exit Behind Iron Door")).fortress().connect(Ch,xa),Eh=(new Location$$module$js$nodes(c,172,Z,"Boss")).fortress().connect(Dh).boss(ff),Fh=(new Location$$module$js$nodes(c,172,Z,"Tornel")).fortress().connect(Eh),Ld=(new Location$$module$js$nodes(c,173,Ba,"Lower")).fortress().connect(Fh).chest(tb,26,99).chest(W,27,111),Gh=(new Location$$module$js$nodes(c,174,Ba,"Upper Loop")).fortress().connect(Ld).chest(L,22,96);(new Location$$module$js$nodes(c,174,Ba,"Upper Loop Behind Wall (magic ring)")).fortress().connect(Gh,
xa).chest(W,23,107);const Hh=(new Location$$module$js$nodes(c,175,Ba,"Upper Passage (toward Mado)")).fortress().connect(Ld).chest(W,27,84),Ub=(new Location$$module$js$nodes(c,176,P,"Initial Fork")).fortress(),Ih=(new Location$$module$js$nodes(c,177,P,"Left Branch")).fortress().connect(Ub),Md=(new Location$$module$js$nodes(c,178,P,"Main Area (right branch, over bridges)")).fortress().connect(Ub),Jh=(new Location$$module$js$nodes(c,179,P,"U-shaped Passage (between floors)")).fortress().connect(Md),
Kh=(new Location$$module$js$nodes(c,180,P,"Main Area Lower (under bridge)")).fortress().connect(Ih).connect(Md).connect(Jh),Nd=(new Location$$module$js$nodes(c,180,P,"Behind Iron Wall")).fortress().connect(Kh,xa),Lh=(new Location$$module$js$nodes(c,181,P,"Lower")).fortress().connect(Nd).chest(O,13,121).chest(O,14,122).chest(O,15,123).chest(W,23,88).chest(S,24,110),Mh=(new Location$$module$js$nodes(c,182,P,"Boss Corridor")).fortress().connect(Lh),Nh=(new Location$$module$js$nodes(c,182,P,"Boss")).fortress().connect(Mh,
Fb).boss(hf);(new Location$$module$js$nodes(c,182,P,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(Xa,18);const Od=(new Location$$module$js$nodes(c,183,P,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,184,H,"Entrance Back (behind river)")).cave().connect(Od).chest(N,13,90);(new Location$$module$js$nodes(c,184,H,"Entrance Front")).cave().connect(Oh,C).connectTo(Qb).connectTo(nb);const Ph=(new Location$$module$js$nodes(c,185,Ba,"Boss")).fortress().connect(Hh).boss(gf);
(new Location$$module$js$nodes(c,185,Ba,"Asina")).fortress().connect(Ph).connectTo(Ub);(new Location$$module$js$nodes(c,186,P,"Kensu")).fortress().connect(Nd).connectTo(Od).trigger(Ae,zb);(new Location$$module$js$nodes(c,187,ta,"House")).house().connect(Pa).trigger(Ce,pa,zb);(new Location$$module$js$nodes(c,188,ta,"Inn")).shop().connect(Pa,Eb);(new Location$$module$js$nodes(c,190,ta,"Tool Shop")).shop(F,L,S,N).connect(Pa,Eb);(new Location$$module$js$nodes(c,191,ta,"Tavern")).shop().connect(Pa);(new Location$$module$js$nodes(c,
192,X,"Elder House")).house().connect(oa).trigger(uc);(new Location$$module$js$nodes(c,193,X,"Rabbit Hut")).house().connect(oa).trigger(Ac,zc,ha);(new Location$$module$js$nodes(c,194,X,"Inn")).shop().connect(oa);(new Location$$module$js$nodes(c,195,X,"Tool Shop")).shop(F,L,S,N).connect(oa);(new Location$$module$js$nodes(c,196,X,"Armor Shop")).shop($d,Yb).connect(oa);(new Location$$module$js$nodes(c,197,X,"Student House")).house().connect(oa).trigger(vc);(new Location$$module$js$nodes(c,198,za,"Tavern")).house().connect(Oa);
(new Location$$module$js$nodes(c,199,za,"Pawn Shop")).shop().connect(Oa);(new Location$$module$js$nodes(c,200,za,"Inn")).shop().connect(Oa);(new Location$$module$js$nodes(c,201,za,"Armor Shop")).shop(ae,Yb,Xd).connect(Oa);(new Location$$module$js$nodes(c,203,za,"Tool Shop")).shop(F,L,S).connect(Oa);(new Location$$module$js$nodes(c,205,Ma,"Elder House")).house().from(gb,ha).trigger(pe,Bb);(new Location$$module$js$nodes(c,206,Ma,"Mother's House")).house().from(gb,ha).trigger(yc,ha).trigger(oe,Bb);(new Location$$module$js$nodes(c,
207,Ma,"Tool Shop")).shop(F,L,N).from(gb,ha);(new Location$$module$js$nodes(c,208,Ma,"Inn")).shop().from(gb,ha);(new Location$$module$js$nodes(c,209,Aa,"Inn")).shop().connect(fb);(new Location$$module$js$nodes(c,210,Aa,"Tool Shop")).shop(S,N,wa).connect(fb);(new Location$$module$js$nodes(c,211,Aa,"Armor Shop")).shop(bc,Zb,$b,qb).connect(fb);const Qh=(new Location$$module$js$nodes(c,212,Aa,"Queen's House")).house().from(fb,Se).trigger(ye,pa,oc);(new Location$$module$js$nodes(c,213,db,"Nadare's")).house().connect(hb).connectTo(Yf).connectTo(Zf).connectTo($f);
(new Location$$module$js$nodes(c,214,B,"Fisherman's House")).house().connect(rd).trigger(Cb,jc,yb,Te);const Vb=(new Location$$module$js$nodes(c,215,B,"Palace Entrance")).house().connect(ua);(new Location$$module$js$nodes(c,216,B,"Fortune Teller Front")).house().connect(ua).trigger(Cc,Bc);(new Location$$module$js$nodes(c,216,B,"Fortune Teller Back")).house().connect(Eg).connect(wd);(new Location$$module$js$nodes(c,217,B,"Pawn Shop")).shop().connect(ua);(new Location$$module$js$nodes(c,218,B,"Armor Shop")).shop(be,
bc,Zb).connect(ua);(new Location$$module$js$nodes(c,220,B,"Inn")).shop().connect(ua);(new Location$$module$js$nodes(c,221,B,"Tool Shop")).shop(F,wa,rb,S).connect(ua);(new Location$$module$js$nodes(c,222,B,"Palace Left")).house().connect(Vb);(new Location$$module$js$nodes(c,223,B,"Palace Throne Room")).house().connect(Vb).to(kb,Me).from(kb).trigger(Bc).trigger(se,Cc,Dc);(new Location$$module$js$nodes(c,224,B,"Palace Right")).house().connect(Vb);(new Location$$module$js$nodes(c,225,B,"Asina's Room")).house().connect(xd).trigger(Gc,
Qc);(new Location$$module$js$nodes(c,226,Aa,"Queen Downstairs")).house().connect(Qh).chest(Va,13);(new Location$$module$js$nodes(c,227,la,"Elder's House")).house().connect(lb).trigger(Jc);(new Location$$module$js$nodes(c,228,la,"Shed")).house().connect(lb).to(Pg,kc);(new Location$$module$js$nodes(c,229,la,"Tool Shop")).shop(F,L,N,wa).connect(lb);(new Location$$module$js$nodes(c,231,la,"Inn")).shop().connect(lb);const Rh=(new Location$$module$js$nodes(c,232,J,"Zombie Town House")).house().connect(Nb);
(new Location$$module$js$nodes(c,233,J,"Zombie Town Basement")).house().connect(Rh).trigger(ue,Yc);(new Location$$module$js$nodes(c,235,Y,"Tool Shop")).shop(F,L,N,S).connect(fa);(new Location$$module$js$nodes(c,236,Y,"Stom's Hut")).house().connect(fa).trigger(Kc);(new Location$$module$js$nodes(c,237,Y,"Inn")).shop().connect(fa);(new Location$$module$js$nodes(c,238,Y,"Armor Shop")).shop(ce,cc,Yd,ac).connect(fa);(new Location$$module$js$nodes(c,239,Y,"Tavern")).house().connect(fa).trigger(Lc,Kc,Ka);
(new Location$$module$js$nodes(c,240,Y,"Pawn Shop")).shop().connect(fa);(new Location$$module$js$nodes(c,241,Y,"Dance Hall")).house().connect(fa).trigger(Mc,Lc,Ka).trigger(xe,Mc,nc);const Sh=(new Location$$module$js$nodes(c,242,na,"Temple (pre-massacre)")).fortress().connect(Ga).from(Gb,K,Td).trigger(ze);(new Location$$module$js$nodes(c,242,na,"Temple (post-massacre)")).fortress().from(Sh,Nc).boss(df);(new Location$$module$js$nodes(c,243,na,"Training Hall")).house().connect(Ga);(new Location$$module$js$nodes(c,
244,na,"Hospital")).house().connect(Ga);(new Location$$module$js$nodes(c,245,na,"Armor Shop")).shop(cc,qb,ac).connect(Ga);(new Location$$module$js$nodes(c,246,na,"Tool Shop")).shop(F,L,rb,W).connect(Ga);(new Location$$module$js$nodes(c,247,na,"Inn")).shop().connect(Ga);(new Location$$module$js$nodes(c,248,aa,"Inn")).shop().connect(Ha);(new Location$$module$js$nodes(c,249,aa,"Tool Shop")).shop(L,S,sb,W).connect(Ha);(new Location$$module$js$nodes(c,250,aa,"Elder's House")).house().connect(Ha);(new Location$$module$js$nodes(c,
251,aa,"Pawn Shop")).house().connect(Ha);const Th=[oa,Na,$c,Da,Hb,Ea,Kb,ld,Mb,fa,mb,Pb,Qb,Kd,Rb];for(const a of Th)a.from(Gb,He);return c},shuffle$$module$js$depgraph=(a,b,c,d,e)=>{d=void 0===d?new FlagSet$$module$js$flagset("Sbkm Sct"):d;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d,a);d.shuffleShops()&&f.shuffleShops(b);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);var h={};for(var k of g)if(k instanceof
Slot$$module$js$nodes&&k.slots){var m=k.slotType[0];(h[m]=h[m]||[]).push(k)}k=[];m=[];var l={};for(var n of d.get("S")){var p=[];for(var q of n){l[q]=!0;for(var r of h[q])p.push(r),m.push([r,k.length])}k.push(p)}for(var t of"bc")if(l[t])for(n=h[t],q=n.map((a)=>[a.item,a.itemIndex]),b.shuffle(q),r=0;r<n.length;r++)n[r].set(q[r][0],q[r][1]);p=(a)=>g.find((b)=>b.vanillaItemName===a);h=p("Sword of Wind");t=p("Sword of Fire");n=p("Ball of Wind");q=p("Ball of Fire");r=p("Statue of Onyx");p=p("Gas Mask");
l.k&&b.nextInt(2)&&(t.swap(h),q.swap(n));l.k&&!b.nextInt(3)&&r.swap(p);l=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(t=0;1E3>t;t++){e&&0===t%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));b.shuffle(m);for(var u of k)b.shuffle(u);n=k.map(()=>-1);q=l[b.nextInt(l.length)];r=[];p=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<q;a++){const [b,
...
this.map.clear();for(const c of b)for(const b of a)this.addList([...c,...b])}freeze(){return[...this].map((a)=>[...a])}}const containsAll$$module$js$graph$condition=(a,b)=>{if(a.size<b.size)return!1;for(const c of b)if(!a.has(c))return!1;return!0};function Condition$$module$js$graph$condition(a){return[[a]]}function and$$module$js$graph$condition(...a){return[[].concat(...a.map((a)=>[a]=a))]}function or$$module$js$graph$condition(...a){return[].concat(...a)}
function meet$$module$js$graph$condition(a,b){const c=new MutableRequirement$$module$js$graph$condition;for(const d of a)for(const a of b)c.addList([...d,...a]);return c.freeze()}const meetReq$$module$js$graph$condition=meet$$module$js$graph$condition;(function(a){a.OPEN=[[]]})(Condition$$module$js$graph$condition||(Condition$$module$js$graph$condition={}));function Slot$$module$js$graph$condition(a){return"number"===typeof a?a:a[0][0]}
(function(a){a.item=function(a){return a|512}})(Slot$$module$js$graph$condition||(Slot$$module$js$graph$condition={}));var Check$$module$js$graph$condition;(function(a){a.chest=function(a){return{slot:Slot$$module$js$graph$condition(512|a)}}})(Check$$module$js$graph$condition||(Check$$module$js$graph$condition={}));var Terrain$$module$js$graph$condition;
...
new Set;let b=!0;for(const c of concat$$module$js$graph$geometry(this.south,[-1],this.other)){if(-1===c){b=!1;continue}let [d,e]=TilePair$$module$js$graph$geometry.split(c);d=this.tiles.find(d);e=this.tiles.find(e);const f=TilePair$$module$js$graph$geometry.of(d,e);a.has(f)||(a.add(f),yield{from:d,to:e,south:b})}}}function*concat$$module$js$graph$geometry(...a){for(const b of a)yield*b}var module$js$graph$geometry={};module$js$graph$geometry.TileId=TileId$$module$js$graph$geometry;
module$js$graph$geometry.ScreenId=ScreenId$$module$js$graph$geometry;module$js$graph$geometry.TilePair=TilePair$$module$js$graph$geometry;module$js$graph$geometry.Neighbors=Neighbors$$module$js$graph$geometry;class Routes$$module$js$graph$routes{constructor(){this.routes=new DefaultMap$$module$js$util(()=>new MutableRequirement$$module$js$graph$condition);this.edges=new DefaultMap$$module$js$util(()=>new Map)}addEdge(a,b,c){const d=LabeledRoute$$module$js$graph$routes(a,c);this.edges.get(b).set(d.label,d);for(const d of this.routes.get(b))this.addRoute(a,[...d,...c])}addRoute(a,b){const c=new Map,d=new Set;a=LabeledRoute$$module$js$graph$routes(a,b);c.set(a.label,a);for(a=c.values();;){const {value:b,
...
function LabeledRoute$$module$js$graph$routes(a,b){var c=[...new Set(b)].sort();b=new Set(c);c=c.join(" ");return{target:a,deps:b,label:`${a}:${c}`,depsLabel:c}}var module$js$graph$routes={};module$js$graph$routes.Routes=Routes$$module$js$graph$routes;module$js$graph$routes.LabeledRoute=LabeledRoute$$module$js$graph$routes;class LocationListBuilder$$module$js$graph$locationlist{constructor(a){this.terrains=a;this.routes=new Routes$$module$js$graph$routes;this.reqs=new BiMap$$module$js$graph$locationlist;this.slots=new BiMap$$module$js$graph$locationlist;this.out=new DefaultMap$$module$js$util(()=>new MutableRequirement$$module$js$graph$condition)}addEdge(a,b,c){const d=this.terrains.get(a),e=this.terrains.get(b);if(!d||!e)throw Error(`missing terrain ${d?b:a}`);for(const f of(c?d.exitSouth:d.exit)||[[]])for(const c of e.enter||
[[]])this.routes.addEdge(b,a,[...c,...f])}addRequirement(a){for(const b of a)for(const a of b)this.reqs.add(a)}addSlot(a,b,c){this.slots.add(a);a=this.out.get(a);for(const d of this.routes.routes.get(b)){b=new Set([...d,...c].sort());const e=[...b].join(" ");a.add(e,b)}}build(){return new LocationList$$module$js$graph$locationlist}}class LocationList$$module$js$graph$locationlist{}
class BiMap$$module$js$graph$locationlist{constructor(){this.forward=[];this.reverse=new Map}add(a){let b=this.reverse.get(a);b||this.reverse.set(a,b=this.forward.push(a)-1);return b}get(a){return this.forward[a]}}var module$js$graph$locationlist={};module$js$graph$locationlist.LocationListBuilder=LocationListBuilder$$module$js$graph$locationlist;module$js$graph$locationlist.LocationList=LocationList$$module$js$graph$locationlist;class Entity$$module$js$rom$entity{constructor(a,b){this.rom=a;this.id=b}write(a){}toString(){return`${this.constructor.name} $${hex$$module$js$rom$util(this.id)}`}}var module$js$rom$entity={};module$js$rom$entity.Entity=Entity$$module$js$rom$entity;var ShopType$$module$js$rom$shop;(function(a){a[a.ARMOR=0]="ARMOR";a[a.TOOL=1]="TOOL";a[a.INN=2]="INN";a[a.PAWN=3]="PAWN"})(ShopType$$module$js$rom$shop||(ShopType$$module$js$rom$shop={}));
...
h<a.fixed?h:d[h];if(null!=g){c=Bits$$module$js$bits.with(c,g);for(const b of a.unlocks[g]||[])f.add(b)}break}}return b}var Type$$module$js$graph$shuffle;(function(a){a[a.EMPTY=0]="EMPTY";a[a.MIMIC=1]="MIMIC";a[a.CONSUMABLE=2]="CONSUMABLE";a[a.KEY=3]="KEY";a[a.BOSS_DROP=4]="BOSS_DROP";a[a.NPC=5]="NPC";a[a.TRIGGER=6]="TRIGGER"})(Type$$module$js$graph$shuffle||(Type$$module$js$graph$shuffle={}));
class AssumedFill$$module$js$graph$shuffle{constructor(a,b){this.rom=a;this.flags=b;this.shuffleFull=this.shuffleTraps=!1;const c=new Set([65,66,70]),d=new Set,e=new Set;for(const b of a.locations)if(b.used)for(const a of b.spawns)a.isChest()&&d.add(a.id);for(const b of a.bosses)null!=b.drop&&e.add(b.drop);this.slotTypes=seq$$module$js$rom$util(124,(b)=>{if(c.has(b))return Type$$module$js$graph$shuffle.TRIGGER;if(112<=b)return Type$$module$js$graph$shuffle.MIMIC;const f=a.items[b];return d.has(b)?
f&&f.unique?Type$$module$js$graph$shuffle.KEY:Type$$module$js$graph$shuffle.CONSUMABLE:e.has(b)?Type$$module$js$graph$shuffle.BOSS_DROP:f&&f.unique?Type$$module$js$graph$shuffle.NPC:Type$$module$js$graph$shuffle.EMPTY});for(const a of b.get("S")||[])/c.*k/.test(a)&&(this.shuffleFull=!0),/t/.test(a)&&(this.shuffleTraps=!0)}fits(a,b){a=this.slotTypes[a]||Type$$module$js$graph$shuffle.EMPTY;return 112<=b?this.shuffleTraps?this.shuffleFull?a<=Type$$module$js$graph$shuffle.KEY:a<=Type$$module$js$graph$shuffle.CONSUMABLE:
a===Type$$module$js$graph$shuffle.MIMIC:72>=b&&this.rom.items[b].unique?this.shuffleFull?this.shuffleTraps?!0:a!==Type$$module$js$graph$shuffle.MIMIC:a>=Type$$module$js$graph$shuffle.KEY:this.shuffleTraps?a!==Type$$module$js$graph$shuffle.TRIGGER:a!==Type$$module$js$graph$shuffle.MIMIC}items(a,b){const c=[];for(const b of a.items)if(null!=b.item){a=1;if(0===b.item||1===b.item)a=5;2===b.item&&(a=10);if(3===b.item||72===b.item)a=15;for(let d=0;d<a;d++)c.push(b.index)}b.shuffle(c);return c}shuffle(a,
b,c,d){d=void 0===d?1E3:d;const e=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){c&&c.addTasks(Math.floor(d/100));a:for(;0<d--;){c&&0===d%100&&(yield new Promise(requestAnimationFrame),c.addCompleted(1));var f=e.items(a,b);let h=Bits$$module$js$bits.from(new Set(f));const k=new GenericFill$$module$js$graph$shuffle;e.flags.guaranteeSword();for(let c=f.pop();null!=c;c=f.pop()){if(!Bits$$module$js$bits.has(h,c))continue;const d=a.items[c].item;if(null==d)throw Error(`bad item: ${Object.entries(a.items[c])}`);
h=Bits$$module$js$bits.without(h,c);var g=[...traverse$$module$js$graph$shuffle(a,k,h)];b.shuffle(g);let f=!1;for(const b of g)if(g=a.slots[b].item,null!=g&&!k.hasSlot(b)&&e.fits(g,d)){k.set(b,c);f=!0;break}if(!f)continue a}if(traverse$$module$js$graph$shuffle(a,k,h).size===a.slots.length&&(f=e.fill(a,expandFill$$module$js$graph$shuffle(a,k),b),null!=f))return c&&c.addCompleted(Math.floor(d/100)),f}return null})}fill(a,b,c){var d=new Set;for(var e of a.slots)null!=e.item&&d.add(e.item);const f=[],
g=[],h=[];a=[];e=[];for(let c=0;124>c;c++)112>c&&!d.has(c)?b.hasSlot(c)!==b.hasItem(c)&&console.error("MISMATCH",c):(b.hasSlot(c)||((this.slotTypes[c]||Type$$module$js$graph$shuffle.EMPTY)<=(this.shuffleFull?Type$$module$js$graph$shuffle.NPC:Type$$module$js$graph$shuffle.CONSUMABLE)?e.push(c):a.push(c)),b.hasItem(c)||(72>=c&&this.rom.items[c].unique?f.push(c):112>c?g.push(c):h.push(c)));c.shuffle(a);c.shuffle(e);c.shuffle(f);c.shuffle(g);for(const k of[...f,...h,...g]){c=!1;d=a.length?a:e;for(const a of d)if(this.fits(a,
k)){b.set(a,k);c=!0;d.splice(d.indexOf(a),1);break}if(!c)return null}return b}}var module$js$graph$shuffle={};module$js$graph$shuffle.traverse=traverse$$module$js$graph$shuffle;module$js$graph$shuffle.traverseFill=traverseFill$$module$js$graph$shuffle;module$js$graph$shuffle.AssumedFill=AssumedFill$$module$js$graph$shuffle;class UnionFind$$module$js$unionfind{constructor(){this.data=new Map;this.sizes=new Map}find(a){this.data.has(a)||(this.data.set(a,a),this.sizes.set(a,1));let b;for(;(b=this.data.get(a))!==a;)this.data.set(a,a=this.data.get(b));return a}union(a){this.find(a[0]);for(let b=1;b<a.length;b++)this.unionInternal(a[0],a[b])}unionInternal(a,b){a=this.find(a);b=this.find(b);if(a!==b){var c=this.sizes.get(a),d=this.sizes.get(b);c<d?(this.sizes.set(b,c+d),this.data.set(a,b)):(this.sizes.set(a,c+d),this.data.set(b,
a))}}sets(){const a=new Map;for(const b of this.data.keys()){const c=this.find(b);let d=a.get(c);d||a.set(c,d=new Set);d.add(b)}return[...a.values()]}map(){const a=new Map;for(const b of this.data.keys()){const c=this.find(b);let d=a.get(c);d||a.set(c,d=new Set);d.add(b)}return a}roots(){const a=new Set;for(const b of this.data.keys())a.add(this.find(b));return[...a]}}var module$js$unionfind={};module$js$unionfind.UnionFind=UnionFind$$module$js$unionfind;class World$$module$js$graph$world{constructor(a,b){b=void 0===b?new FlagSet$$module$js$flagset("@FullShuffle"):b;this.rom=a;this.tiles=new UnionFind$$module$js$unionfind;const c=new Overlay$$module$js$graph$overlay(a,b),d=new Map,e=new Map,f=new Map,g=new Map,h=new DefaultMap$$module$js$util(()=>new Set),k=new Map,m=new Set;for(const b of a.locations){var l=function(a,b){const c=d.get(a);c&&d.set(a,module$js$graph$condition.Terrain.meet(c,b))};if(!b.used)continue;const u=b.extended?256:0,q=a.tilesets[(b.tileset&
127)>>2],r=a.tileEffects[b.tileEffects-179];for(const a of b.spawns)a.isWall()&&e.set(module$js$graph$geometry.ScreenId.from(b,a),a.id);for(let f=0,g=b.height;f<g;f++){const g=b.screens[f],h=b.id<<8|f<<4;for(let f=0,k=b.width;f<k;f++){var n=function(a,b){if(!z)throw Error("flag expected");return b?a?ba(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(z.flag)},b):a};const k=a.screens[g[f]|u],m=module$js$graph$geometry.ScreenId(h|f),l=m&255,p=e.get(m),z=null!=p?
c.wallCapability(p):b.flags.find((a)=>a.yx===l),ba=memoize2$$module$js$graph$condition((a,b)=>{if(!z)throw Error("flag expected");b=Object.assign({},b,{enter:meet$$module$js$graph$condition(b.enter||[[]],module$js$graph$condition.Condition(z.flag))});return module$js$graph$condition.Terrain.join(a,b)});for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(m<<8|a);let e=k.tiles[a];z&&751===z.flag&&32>e&&(e=q.alternates[e]);let f=c.makeTerrain(u?0:r.effects[e]&38,b);if(32>e&&q.alternates[e]!=
e&&z&&751!==z.flag){const a=c.makeTerrain(r.effects[q.alternates[e]],b);f=n(f,a)}f&&d.set(b,f)}}}for(const a of b.exits)if(a.entrance&32){const c=module$js$graph$geometry.TileId.from(b,a);m.add(c);const e=d.get(c);e&&d.set(c,module$js$graph$condition.Terrain.seamless(e))}for(const d of b.spawns)if(d.isTrigger()){const a=c.trigger(d.id);if(a.terrain||a.check){let {x:c,y:e}=d;c+=8;for(const d of[-16,0])for(const f of[-16,0]){const g=module$js$graph$geometry.TileId.from(b,{x:c+d,y:e+f});a.terrain&&l(g,
a.terrain);for(const b of a.check||[])h.get(g).add(b)}}}else if(d.isNpc()){g.set(module$js$graph$geometry.TileId.from(b,d),d.id);const a=c.npc(d.id,b);if(a.terrain||a.check){let {x:c,y:e}=d,{x0:f,x1:g,y0:k,y1:m}=a.hitbox||{x0:0,y0:0,x1:1,y1:1};for(let d=f;d<g;d++)for(let f=k;f<m;f++){const g=module$js$graph$geometry.TileId.from(b,{x:c+16*d,y:e+16*f});a.terrain&&l(g,a.terrain);for(const b of a.check||[])h.get(g).add(b)}}}else if(d.isBoss())f.set(module$js$graph$geometry.TileId.from(b,d),d.id);else if(d.isChest())h.get(module$js$graph$geometry.TileId.from(b,
d)).add(module$js$graph$condition.Check.chest(d.id));else if(d.isMonster()){const c=a.objects[d.monsterId];c.goldDrop&&k.set(module$js$graph$geometry.TileId.from(b,d),c.elements)}}for(const b of f){const [e,f]=b;{const b=e>>16,g=195!==f?a.bosses.fromLocation(b):a.bosses.rage;if(160===b||95===b)continue;if(!g||null==g.kill)throw Error(`bad boss at loc ${b.toString(16)}`);const k=module$js$graph$condition.Boss(g.kill),m=memoize$$module$js$graph$condition((a)=>module$js$graph$condition.Terrain.meet(a,
{exit:k,exitSouth:k})),l=e&-256,n=c.bossRequirements(g),u={slot:module$js$graph$condition.Slot(k),condition:n};for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(l|a),c=d.get(b);c&&(d.set(b,m(c)),h.get(b).add(u))}}}for(const a of c.locations()||[])h.get(a.tile).add(a);for(const a of d){const [b,c]=a;{const a=module$js$graph$geometry.TileId.add(b,0,1);d.get(a)===c&&this.tiles.union([b,a]);const e=module$js$graph$geometry.TileId.add(b,1,0);d.get(e)===c&&this.tiles.union([b,e])}}const p=
new Set;for(const b of a.locations)if(b.used)for(const c of b.exits){const {dest:d,entrance:e}=c,f=module$js$graph$geometry.TileId.from(b,c),g=e&32?module$js$graph$geometry.TileId(f&65535|d<<16):module$js$graph$geometry.TileId.from({id:d},a.locations[d].entrances[e]);p.add(module$js$graph$geometry.TilePair.of(this.tiles.find(f),this.tiles.find(g)))}for(const a of p){const [b,c]=module$js$graph$geometry.TilePair.split(a);if(d.get(b)!==d.get(c))continue;const e=module$js$graph$geometry.TilePair.of(c,
b);p.has(e)&&(this.tiles.union([b,c]),p.delete(a),p.delete(e))}const q=new Neighbors$$module$js$graph$geometry(this.tiles,m);for(const a of d){const [b,c]=a;{const a=module$js$graph$geometry.TileId.add(b,0,1),e=d.get(a);e&&e!==c&&q.addAdjacent(b,a,!1);const f=module$js$graph$geometry.TileId.add(b,1,0),g=d.get(f);g&&g!==c&&q.addAdjacent(b,f,!0)}}for(const a of p){const [b,c]=module$js$graph$geometry.TilePair.split(a);d.has(b)&&d.has(c)&&q.addExit(b,c)}const r=new LocationListBuilder$$module$js$graph$locationlist(d);
for(const a of c.extraRoutes())for(const b of a.condition||[[]])r.routes.addRoute(this.tiles.find(a.tile),b);for(const a of c.extraEdges()){const {from:b,to:c,condition:d}=a;for(const a of d||[[]])r.routes.addEdge(this.tiles.find(c),this.tiles.find(b),a)}for(const a of q){const {from:b,to:c,south:d}=a;r.addEdge(b,c,d)}const t=new DefaultMap$$module$js$util(()=>new MutableRequirement$$module$js$graph$condition);for(const a of c.capabilities()){const {condition:b=[[]],capability:c}=a;t.get(module$js$graph$condition.Slot(c)).addAll(b)}for(const a of h){const [b,
c]=a;{const a=this.tiles.find(b);if(b!==a){for(const b of c)h.get(a).add(b);h.delete(b)}}}for(const a of h){const [b,c]=a;for(const a of c){const {slot:c,condition:d=[[]]}=a;{const a=t.get(c);for(const c of d)for(const d of r.routes.routes.get(b)||[])a.addList([...c,...d])}}}if(DEBUG$$module$js$graph$world){var u=function(a,b){b=void 0===b?z:b;a=[...a];return a.length?"("+a.map((a)=>[...a].map(b).join(" & ")).join(") |\n     (")+")":"no route"},z=function(a){return 0>a?"~"+(~a).toString(16).padStart(2,
"0"):a.toString(16).padStart(3,"0")};const b=window;console.log(b.roots=(b.tiles=this.tiles).roots());console.log([...b.neighbors=q]);console.log(b.ll=r);b.area=(a,b)=>{b=void 0===b?z:b;const c=[...this.tiles.sets().filter((b)=>b.has(a))[0]].map((a)=>a.toString(16).padStart(6,"0")),d=u(r.routes.routes.get(this.tiles.find(a)),b),e=[],f=this.tiles.find(a);for(const a of(r.routes.edges.get(f)||new Map).values())e.push(`\nto ${a.target.toString(16)} if (${[...a.deps].map(b).join(" & ")})`);for(const a of r.routes.edges){const [c,
d]=a;for(const a of d.values())a.target===f&&e.push(`\nfrom ${c.toString(16)} if (${[...a.deps].map(b).join(" & ")})`)}return`${hex$$module$js$rom$util(f)}\n${(function(a,b,c){const d=[];for(let e=0;e<a.length;e+=b)d.push(a.slice(e,e+b).join(c));return d})(c,16," ").join("\n")}\ncount = ${c.length}\nroutes = ${d}${e.join("")}`};b.whatFlag=(b)=>conditionName$$module$js$graph$world(b,a);b.reqs=t;console.log("reqs\n"+[...t].sort((a,b)=>{[a]=a;[b]=b;return a-b}).map((a)=>{var [c,d]=a;return`${b.whatFlag(c)}: ${u(d,
b.whatFlag)}`}).join("\n"));b.reqs.check=(a,b)=>{b=void 0===b?z:b;return`${b(a)}: ${u(t.get(module$js$graph$condition.Slot(a)),b)}`};b.reqs.check2=(a)=>b.reqs.check(a,b.whatFlag)}this.graph=makeGraph$$module$js$graph$world(t,a)}traverse(a,b){const {spoiler:c}=this.rom;if(c){for(var d=-512;768>d;d++)c.addCondition(d,conditionName$$module$js$graph$world(d,this.rom));for(const e of traverseFill$$module$js$graph$shuffle(a,b)){const [f,...g]=e;{d=a.slots[f].condition;const e=g.map((b)=>a.items[b].condition);
c.addCheck(d,e,b.slots[a.slots[f].item])}}}}}
function makeGraph$$module$js$graph$world(a,b){function c(a){return 512<=a&&640>a}function d(a,c){return{name:conditionName$$module$js$graph$world(a,b),condition:a,index:c}}function e(a,b){return Object.assign(d(a,b+n),{item:a&127})}function f(a){const c=p.get(a);if(null==c)throw Error(`Missing item $${a.toString(16)}: ${conditionName$$module$js$graph$world(a,b)}`);return c}var g=new Set,h=new Set;for(var k of a){const [a,b]=k;h.add(a);for(var m of b)for(var l of m)g.add(l)}g.add(module$js$graph$condition.Boss.DRAYGON2[0][0]);k=
[...g].filter((a)=>!c(a)).sort();g=[...g].filter(c).sort();m=[...h].filter(c).sort();const n=k.length;h=k.map(d);g=g.map(e);l=m.map(e);g=[...h,...g];k=[...h,...l];const p=new Map(g.map((a,b)=>[a.condition,b])),q=new Map(k.map((a,b)=>[a.condition,b]));m=[];const r=[];for(var t of a){const [c,d]=t;a=q.get(c);if(null==a)MAYBE_MISSING_SLOTS$$module$js$graph$world.has(c)||console.error(`Nothing depended on $${c.toString(16)}: ${conditionName$$module$js$graph$world(c,b)}`);else for(const b of d){const c=
...
a)return`Location ${c.id.toString(16)} (${c.name}) Flag ${b.ys},${b.xs}`;return 0>a?`~${(~a).toString(16).padStart(2,"0")}`:a.toString(16).padStart(2,"0")}const DEBUG$$module$js$graph$world=!1;var module$js$graph$world={};module$js$graph$world.World=World$$module$js$graph$world;const IM1$$module$js$random=2147483563,IM2$$module$js$random=2147483399,AM$$module$js$random=1/IM1$$module$js$random,IMM1$$module$js$random=IM1$$module$js$random-1,IA1$$module$js$random=40014,IA2$$module$js$random=40692,IQ1$$module$js$random=53668,IQ2$$module$js$random=52774,IR1$$module$js$random=12211,IR2$$module$js$random=3791,NTAB$$module$js$random=32,NDIV$$module$js$random=1+Math.floor(IMM1$$module$js$random/NTAB$$module$js$random),EPS$$module$js$random=1.2E-7,RNMX$$module$js$random=1-EPS$$module$js$random;
...
class Writer$$module$js$rom$writer{constructor(a){this.rom=a;this.chunks=[];this.writes=[];this.promises=[];this.free=[]}alloc(a,b){for(;page$$module$js$rom$writer(b-1)>page$$module$js$rom$writer(a);){const b=page$$module$js$rom$writer(a)+1<<13;this.addChunk(new Chunk$$module$js$rom$writer(a,b-1));a=b}this.addChunk(new Chunk$$module$js$rom$writer(a,b))}addChunk(a){this.chunks.push(a);this.free[a.page]=(this.free[a.page]||0)+a.free()}write(a,b,c,d){const e=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=
...
return this.triggers[a&127]}get monsters(){const a=new Set;for(const b of this.locations)if(b.used&&b.hasSpawns)for(const c of b.spawns)c.isMonster()&&a.add(this.objects[c.monsterId]);return[...a].sort((a,c)=>a.id-c.id)}get projectiles(){const a=new Set;for(const b of this.monsters)b.child&&a.add(this.objects[this.adHocSpawns[b.child].objectId]);return[...a].sort((a,c)=>a.id-c.id)}get monsterGraphics(){const a={};for(const b of this.locations)if(b.used&&b.hasSpawns)for(const c of b.spawns)if(!(c.data[2]&
7)){const d=c.data[2]&128?1:0,e=hex$$module$js$rom$util(c.data[3]+80);(a[e]=a[e]||{})[`${d}:${b.spritePatterns[d].toString(16)}:${b.spritePalettes[d].toString(16)}`]={pal:b.spritePalettes[d],pat:b.spritePatterns[d],slot:d}}return a}get locationMonsters(){const a={};for(const b of this.locations){if(!b.used||!b.hasSpawns)continue;const c=a["$"+hex$$module$js$rom$util(b.id)]={};for(const a of b.spawns)if(!(a.data[2]&7)){const b=a.data[2]&128?1:0,d=a.data[3]+80;c[`${b}:${d.toString(16)}`]=(c[`${b}:${d.toString(16)}`]||
0)+1}}return a}static load(a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const b=yield pickFile$$module$js$rom();a&&(yield a(b));return new Rom$$module$js$rom(b)})}writeData(){const a=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){Rom$$module$js$rom.SHOP_COUNT.set(a.prg,a.shopCount);Rom$$module$js$rom.SCALING_LEVELS.set(a.prg,a.scalingLevels);Rom$$module$js$rom.UNIQUE_ITEM_TABLE.set(a.prg,a.uniqueItemTableAddress);Rom$$module$js$rom.SHOP_DATA_TABLES.set(a.prg,
a.shopDataTablesAddress);Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX.set(a.prg,a.omitItemGetDataSuffix);Rom$$module$js$rom.OMIT_LOCAL_DIALOG_SUFFIX.set(a.prg,a.omitLocalDialogSuffix);const b=new Writer$$module$js$rom$writer(a.prg);b.alloc(83192,97792);b.alloc(103417,109568);b.alloc(110080,113920);b.alloc(116602,117085);b.alloc(117477,121076);b.alloc(122342,122981);b.alloc(123392,123840);b.alloc(135450,136296);b.alloc(172032,195584);a.telepathyTablesAddress?b.alloc(121076,121600):b.alloc(121420,121600);
const c=[],d=(a)=>{for(const d of a)c.push(d.write(b))};d(a.locations);d(a.objects);d(a.hitboxes);d(a.triggers);d(a.npcs);d(a.tilesets);d(a.tileEffects);d(a.screens);d(a.adHocSpawns);d(a.itemGets);d(a.items);d(a.shops);d(a.bossKills);a.wildWarp.write(b);c.push(a.telepathy.write(b));c.push(a.messages.write(b));c.push(b.commit());yield Promise.all(c).then(()=>{})})}analyzeTiles(){}disjointTilesets(){var a=[];for(var b of this.locations){if(!b.used)continue;var c=b.tileset;const d=b.extended?256:0;for(const e of b.screens)for(const b of e)(a[b+
...
0;h<g.length-1;h++)if(Array.isArray(g[h])){var k=g[h];e.set(k[0],k[1]);g[h]=k[0]}for(h=0;h<g.length-1;h++){k=g[h];const a=g[h+1];0>k||0>a||(c.set(a,k),d[a]=k)}}g=new Set;c=new Set;a=new Set(a);for(var m of this.locations)if(m.used&&a.has(m.tileset)){c.add(m.tileEffects);for(var l of m.allScreens())g.add(l)}for(var n of g)for(let a=0,b=n.tiles.length;a<b;a++)n.tiles[a]=d[n.tiles[a]];for(var p of a){d=this.tilesets[(p&127)>>>2];for(var q of b)for(m=0;m<q.length-1;m++){l=f(q[m]);n=f(q[m+1]);for(a=0;4>
a;a++)d.tiles[a][l]=d.tiles[a][n];d.attrs[l]=d.attrs[n];if(32>n&&d.alternates[n]!==n){if(32<=l)throw Error(`Cannot unflag: ${p} ${l} ${n} ${d.alternates[n]}`);d.alternates[l]=d.alternates[n]}}for(var r of e){const [a,b]=r;d.alternates[a]=b}}for(const a of c){p=this.tileEffects[a-179];for(const a of b)for(q=0;q<a.length-1;q++)r=f(a[q]),d=f(a[q+1]),p.effects[r]=p.effects[d];for(const a of e.keys())p.effects[a]|=8}}}
...
class Slot$$module$js$rom$spoiler{constructor(a,b,c,d){this.slot=b;this.slotName=c;this.item=d;this.itemName=slotToItem$$module$js$rom$spoiler(a,d);this.originalItem=slotToItem$$module$js$rom$spoiler(a,b)}toString(){return`${this.itemName}: ${this.slotName} (${this.originalItem})`}}function slotToItem$$module$js$rom$spoiler(a,b){return 112<=b?"Mimic":a.items[a.itemGets[b].itemId].messageName}var module$js$rom$spoiler={};module$js$rom$spoiler.Spoiler=Spoiler$$module$js$rom$spoiler;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="latest",LABEL$$module$js$version="latest 0944298",HASH$$module$js$version="094429895d82361c19040f517281eb66ddeea115",DATE$$module$js$version=new Date(1561092603E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$js$flagset(String(b.flags)):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$js$patch(a,parseSeed$$module$js$patch(String(b.seed)),d,new FetchReader$$module$js$fetchreader(c))})}};
...
function shuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){function f(b){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){m.assemble(yield d.read(b),b);m.patchRom(a)})}if("number"!==typeof b)throw Error("Bad seed");var h=crc32$$module$js$crc32(b.toString(16).padStart(8,"0")+String(c))>>>0;const k={_ALLOW_TELEPORT_OUT_OF_TOWER:!0,_AUTO_EQUIP_BRACELET:c.autoEquipBracelet(),_BARRIER_REQUIRES_CALM_SEA:c.barrierRequiresCalmSea(),_BUFF_DEOS_PENDANT:c.buffDeosPendant(),
...
_RABBIT_BOOTS_CHARGE_WHILE_WALKING:c.rabbitBootsChargeWhileWalking(),_REQUIRE_HEALED_DOLPHIN_TO_RIDE:c.requireHealedDolphinToRide(),_REVERSIBLE_SWAN_GATE:!0,_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword()},m=new Assembler$$module$js$6502;var l=Object.keys(k).filter((a)=>k[a]).map((a)=>`define ${a} 1\n`).join("");m.assemble(l,"flags.s");yield f("preshuffle.s");h=new Random$$module$js$random(h);l=new Rom$$module$js$rom(a);"object"==
typeof window&&(window.rom=l);l.spoiler=new Spoiler$$module$js$rom$spoiler(l);e&&(e.slots=l.spoiler.slots,e.route=l.spoiler.route);fixMimics$$module$js$patch(l);makeBraceletsProgressive$$module$js$patch(l);c.blackoutMode()&&blackoutMode$$module$js$patch(l);closeCaveEntrances$$module$js$patch(l,c);reversibleSwanGate$$module$js$patch(l);adjustGoaFortressTriggers$$module$js$patch(l);preventNpcDespawns$$module$js$patch(l,c);c.requireHealedDolphinToRide()&&requireHealedDolphin$$module$js$patch(l);c.saharaRabbitsRequireTelepathy()&&
requireTelepathyForDeo$$module$js$patch(l);adjustItemNames$$module$js$patch(l,c);yield f("postparse.s");alarmFluteIsKeyItem$$module$js$patch(l);c.teleportOnThunderSword()?teleportOnThunderSword$$module$js$patch(l):noTeleportOnThunderSword$$module$js$patch(l);l.scalingLevels=48;l.uniqueItemTableAddress=m.expand("KeyItemData");undergroundChannelLandBridge$$module$js$patch(l);c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$patch(l);addCordelWestTriggers$$module$js$patch(l,c);c.disableRabbitSkip()&&
fixRabbitSkip$$module$js$patch(l);c.shuffleShops()&&shuffleShops$$module$js$patch(l,c,h);const n=new World$$module$js$graph$world(l,c),p=yield(new AssumedFill$$module$js$graph$shuffle(l,c)).shuffle(n.graph,h);p&&(n.traverse(n.graph,p),update$$module$js$rom$slots(l,p.slots));rescaleShops$$module$js$patch(l,m,c.bargainHunting()?h:void 0);normalizeSwords$$module$js$patch(l,c,h);rescaleMonsters$$module$js$patch(l,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(l,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(l);
c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(l);c.chargeShotsOnly()&&disableStabs$$module$js$patch(l);c.orbsOptional()&&orbsOptional$$module$js$patch(l);shuffleMusic$$module$js$patch(l,c,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(l,c,h);misc$$module$js$patch(l,c,h);c.buffDyna()&&buffDyna$$module$js$patch(l,c);yield l.writeData();buffDyna$$module$js$patch(l,c);return yield postParsedShuffle$$module$js$patch(a,
h,b,c,m,f)})}function postParsedShuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){yield f("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(a,d,e);updateCoinDrops$$module$js$patch(a,d);shuffleRandomNumbers$$module$js$patch(a,b);return stampVersionSeedAndHash$$module$js$patch(a,c,d)})}
function undergroundChannelLandBridge$$module$js$patch(a){({tiles:a}=a.screens[161]);a[40]=159;a[55]=35;a[56]=35;a[57]=33;a[71]=141;a[72]=143;a[86]=153;a[87]=154;a[88]=140}
...
a.map((a)=>a[1]);b=[...new Set(b)];b.push(9,10,11,26,28,29);for(const d of a){[a]=d;{const d=b[c.nextInt(b.length)];for(const b of a)b.bgm=d}}})([...b,...e,...f])}}function shuffleWildWarp$$module$js$patch(a,b,c){b=[];for(const c of a.locations)c&&c.used&&c.id&&!c.extended&&88!==(c.id&248)&&b.push(c.id);c.shuffle(b);a.wildWarp.locations=[...b.slice(0,15).sort((a,b)=>a-b),0]}
function buffDyna$$module$js$patch(a,b){a.objects[184].collisionPlane=1;a.objects[184].immobile=!0;a.objects[185].collisionPlane=1;a.objects[185].immobile=!0;a.objects[51].collisionPlane=2}function makeBraceletsProgressive$$module$js$patch(a){a=a.npcs[95];var b=a.localDialogs.get(33);b=[b[0],b[2],b[2].clone(),b[1]];b[1].condition=-519;b[2].condition=-518;b[3].condition=-1;a.localDialogs.set(33,b)}
...
[-33,-28]);d(52)[1].condition=27;d(56)[3].message.action=3;d(56)[4].flags.push(156);e(56,223)[1]=-28;e(56,225)[0]=27;d(56)[1].condition=27;e(57,216)[1]=-28;a.npcs[68].spawnConditions.set(233,[-142]);a.npcs[68].spawnConditions.set(228,[141]);a.npcs[94].localDialogs.set(16,[LocalDialog$$module$js$rom$npc.of(-59,[0,26],[58]),LocalDialog$$module$js$rom$npc.of(13,[0,29]),LocalDialog$$module$js$rom$npc.of(56,[0,28]),LocalDialog$$module$js$rom$npc.of(57,[0,29]),LocalDialog$$module$js$rom$npc.of(10,[0,27,
3]),LocalDialog$$module$js$rom$npc.of(-1,[0,29])]);c(e(94,16),-82);a.npcs[95].spawnConditions.delete(33);a.npcs[96].spawnConditions.delete(30);g=a.npcs[98];g.data[1]=40;d(g.id,225)[0].message.action=17;d(g.id,225)[2].message.action=17;c(e(g.id,225),-144);a.npcs[104].spawnConditions.set(97,[-156,33]);d(104)[0].message.action=2;a.npcs[196].spawnConditions.delete(242);a.npcs[203].spawnConditions.set(166,[-654]);g=a.npcs[94].localDialogs.get(242);g.unshift(...g.splice(1,1));a.trigger(128).conditions=
