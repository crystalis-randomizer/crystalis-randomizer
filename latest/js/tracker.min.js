...
95).dialog(95,33,0),Ud=(new Magic$$module$js$nodes(a,69,"Recover",69,null)).direct("Asina in Portoa",250361),hc=(new Magic$$module$js$nodes(a,70,"Barrier",70,null)).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),na=(new Magic$$module$js$nodes(a,71,"Change",71,null)).direct("Kensu in Swan",251614).npcSpawn(116,241,1),A=(new Magic$$module$js$nodes(a,72,"Flight",72,null)).weight(15).direct("Kensu in Draygonia Fortress",250255),Qa=d(40,"Flute of Lime").chest(void 0,91).key(),Vd=Aa.bossDrop("Vampire 2",
12,97).npcSpawn(204).key(),G=d(112,"Mimic"),ic=(new Trigger$$module$js$nodes(a,"Talked to Leaf Elder")).get(Q),jc=new Trigger$$module$js$nodes(a,"Talked to Leaf Student"),kc=(new Trigger$$module$js$nodes(a,"Buy alarm flute")).get(nb),rb=new Trigger$$module$js$nodes(a,"Talked to Zebu in cave"),Wd=(new Trigger$$module$js$nodes(a,"Woke up Windmill Guard")).get(Vb),Ra=new Trigger$$module$js$nodes(a,"Started Windmill"),lc=(new Trigger$$module$js$nodes(a,"Learned Refresh")).get(qb),Xd=(new Trigger$$module$js$nodes(a,
"Gave Statue to Akahana")).get(lb),Yd=(new Trigger$$module$js$nodes(a,"Fought Stom")).get(Y),mc=new Trigger$$module$js$nodes(a,"Visited Oak"),nc=new Trigger$$module$js$nodes(a,"Talked to Oak Mother"),sb=new Trigger$$module$js$nodes(a,"Rescued Oak Child"),Zd=(new Trigger$$module$js$nodes(a,"Talked to Oak Mother Again")).get(Sb),$d=(new Trigger$$module$js$nodes(a,"Talked to Oak Elder")).get(R),ae=(new Trigger$$module$js$nodes(a,"Talked to Tornel on Mt Sabre")).get(gc),oc=new Trigger$$module$js$nodes(a,
"Villagers Abducted"),pc=new Trigger$$module$js$nodes(a,"Talked to Rabbit in Leaf"),be=(new Trigger$$module$js$nodes(a,"Learned Paralysis")).get(Pa),qc=new Trigger$$module$js$nodes(a,"Talked to Portoa Queen"),rc=new Trigger$$module$js$nodes(a,"Talked to Fortune Teller"),sc=new Trigger$$module$js$nodes(a,"Visited Underground Channel"),ce=(new Trigger$$module$js$nodes(a,"Sent to Waterfall Cave")).get(Ba),de=(new Trigger$$module$js$nodes(a,"Cured Akahana")).get(Ub),tc=(new Trigger$$module$js$nodes(a,
"Talked to Rage")).get(Ka),uc=new Trigger$$module$js$nodes(a,"Mesia recording played"),vc=(new Trigger$$module$js$nodes(a,"Talked to Asina")).get(Ud),wc=(new Trigger$$module$js$nodes(a,"Healed Dolphin")).get(ob),tb=new Trigger$$module$js$nodes(a,"Returned Fog Lamp"),xc=new Trigger$$module$js$nodes(a,"Talked to Kensu in Cabin"),yc=new Trigger$$module$js$nodes(a,"Talked to Joel Elder"),ee=(new Trigger$$module$js$nodes(a,"Talked to Clark")).get(Zb),fe=(new Trigger$$module$js$nodes(a,"Talked to Kensu in Lighthouse")).get(ac),
...
"Entered Shyron"),je=(new Trigger$$module$js$nodes(a,"Talked to Zebu in Shyron")).get(Xb),Cc=new Trigger$$module$js$nodes(a,"Shyron Massacre"),ke=(new Trigger$$module$js$nodes(a,"Saved Kensu")).get(A),le=(new Trigger$$module$js$nodes(a,"Talked to Deo")).get(Td),me=(new Trigger$$module$js$nodes(a,"Talked to Akahana's Friend")).get(Rd),ne=(new Trigger$$module$js$nodes(a,"Get Bow of Truth")).get(fc),oe=(new Trigger$$module$js$nodes(a,"Forged Crystalis")).get(hb),Sa=(new Condition$$module$js$nodes(a,
"Sword charge glitch")).option(Kd),pe=(new Condition$$module$js$nodes(a,"Rabbit skip")).option(p),qe=(new Condition$$module$js$nodes(a,"Teleport skip")).option(l),wb=(new Condition$$module$js$nodes(a,"Statue glitch")).option(t),re=(new Condition$$module$js$nodes(a,"Wild warp")).option(Id,Jd),Ta=(new Condition$$module$js$nodes(a,"Any level 2 sword")).option(Q,Ha).option(Q,za).option(R,Ia).option(R,Ja).option(L,Ka).option(L,La).option(I,Ma).option(I,Na),v=(new Condition$$module$js$nodes(a,"Destroy stone")).option(Q,
Ha).option(Q,za).option(Sa,Q,Ta),w=(new Condition$$module$js$nodes(a,"Destroy ice")).option(R,Ia).option(R,Ja).option(Sa,R,Ta),q=(new Condition$$module$js$nodes(a,"Cross rivers")).option(L,Ka).option(L,La).option(A).option(Sa,L,Ta),oa=(new Condition$$module$js$nodes(a,"Destroy iron")).option(I,Ma).option(I,Na).option(Sa,I,Ta),Z=(new Condition$$module$js$nodes(a,"Any sword")).option(Q).option(R).option(L).option(I),se=(new Condition$$module$js$nodes(a,"Match insect sword (fire/water/thunder)")).option(R).option(L).option(I).option(lb,
D.value?D:h,Q),te=(new Condition$$module$js$nodes(a,"Speed boots")).option(Tb,r),Dc=(new Condition$$module$js$nodes(a,"Climb slopes")).option(mb).option(A).option(te),ue=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (rabbit)")).option(pc).option(pe),ve=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (Teleport)")).option(gc).option(qe,A),Ec=(new Condition$$module$js$nodes(a,"Asina in her room")).option(uc),we=(new Condition$$module$js$nodes(a,"Paralysis or Ball of Water")).option(Pa).option(Ec).option(wb),
Fc=(new Condition$$module$js$nodes(a,"Ride dolphin")).option(ob,xc),xe=(new Condition$$module$js$nodes(a,"Ghetto flight")).option(n,Fc,mb),S=(new Condition$$module$js$nodes(a,"Cross sea")).option(Fc).option(A),ye=(new Condition$$module$js$nodes(a,"Cross whirlpool")).option(ub).option(A).option(xe),J=(new Condition$$module$js$nodes(a,"Refresh if needed")).option(Pb.value?Pb:h).option(qb),Gc=(new Condition$$module$js$nodes(a,"Wind magic")).option(y.value?y:h,J).option(Ha,za,J),Hc=(new Condition$$module$js$nodes(a,
"Fire magic")).option(y.value?y:h,J).option(Ia,Ja,J),Ic=(new Condition$$module$js$nodes(a,"Water magic")).option(y.value?y:h,J).option(y,J).option(Ka,La,J),ze=(new Condition$$module$js$nodes(a,"Thunder magic")).option(y.value?y:h,J).option(y,J).option(Ma,J).option(Na,J),Ae=(new Condition$$module$js$nodes(a,"Flute of lime or glitch")).option(Ba).option(wb).option(Qa.value?Qa:g),Be=(new Condition$$module$js$nodes(a,"Second flute of lime")).option(Qa).option(Ba.value?Ba:g),Jc=(new Condition$$module$js$nodes(a,
"Change or glitch")).option(na).option(wb),xb=(new Condition$$module$js$nodes(a,"Pass shooting statues")).option(hc).option(Ob.value?Ob:h).option(qb,Ub),Ce=(new Condition$$module$js$nodes(a,"Healed dolphin if required")).option(wc).option(gb),Kc=(new Condition$$module$js$nodes(a,"Match sword of wind")).option(Q).option(D.value?D:h,Z),Lc=(new Condition$$module$js$nodes(a,"Match sword of fire")).option(R).option(D.value?D:h,Z),Mc=(new Condition$$module$js$nodes(a,"Match sword of water")).option(L).option(D.value?
D:h,Z),De=(new Condition$$module$js$nodes(a,"Match sword of thunder")).option(I).option(D.value?D:h,Z),Ua=(new Condition$$module$js$nodes(a,"Travel swamp")).option(lb).option(Ga.value?Ga:h),Ee=(new Condition$$module$js$nodes(a,"Calmed sea if required")).option(ub).option(Fd),Fe=e(0,"Vampire 1",Z).get(mb),Ge=e(1,"Insect",Sb,se).get(Ia),He=e(2,"Kelbesque 1",Kc,Gc).get(Ja),Ie=e(12,"Vampire 2",Z).get(Vd),Nc=e(4,"Sabera 1",Lc,Hc).get($b),Je=e(5,"Mado 1",Mc,Ic).get(Ma),Ke=e(6,"Kelbesque 2",Kc,Gc).get(kb),
Le=e(7,"Sabera 2",Lc,Hc).get(Qb),Me=e(8,"Mado 2",Mc,Ic).get(Ld),Ne=e(9,"Karmine",De,ze).get(pb),Oe=e(10,"Draygon 1",Z).get(Od),Pe=e(null,"Statues",ec,dc),Qe=e(11,"Draygon 2",Z,fc),Re=e(13,"Dyna",hb),M=new Area$$module$js$nodes(a,"Leaf"),pa=new Area$$module$js$nodes(a,"Valley of Wind"),K=new Area$$module$js$nodes(a,"Sealed Cave"),ia=new Area$$module$js$nodes(a,"Cordel Plain"),qa=new Area$$module$js$nodes(a,"Brynmaer"),ra=new Area$$module$js$nodes(a,"Amazones"),B=new Area$$module$js$nodes(a,"Mt Sabre West"),
u=new Area$$module$js$nodes(a,"Mt Sabre North"),Va=new Area$$module$js$nodes(a,"Nadare's"),Ca=new Area$$module$js$nodes(a,"Oak"),aa=new Area$$module$js$nodes(a,"Waterfall Valley"),z=new Area$$module$js$nodes(a,"Portoa"),ba=new Area$$module$js$nodes(a,"Waterfall Cave"),C=new Area$$module$js$nodes(a,"Fog Lamp Cave"),ca=new Area$$module$js$nodes(a,"Kirisa Plant Cave"),ja=new Area$$module$js$nodes(a,"Angry Sea"),da=new Area$$module$js$nodes(a,"Joel"),F=new Area$$module$js$nodes(a,"Evil Spirit Island"),
...
Da=(new Location$$module$js$nodes(a,3,pa,"Main")).overworld().connect(ha).trigger(lc,Ra),Oc=(new Location$$module$js$nodes(a,3,pa,"Outside Windmill")).overworld(),Pc=(new Location$$module$js$nodes(a,4,K,"Tunnel 1 (entrance)")).cave().from(Da,Ra),Ue=(new Location$$module$js$nodes(a,5,K,"Tunnel 2 (over bridge)")).cave().connect(Pc),Ve=(new Location$$module$js$nodes(a,6,K,"Tunnel 6 (herb dead end)")).cave().chest(W,15),Qc=(new Location$$module$js$nodes(a,7,K,"Tunnel 4a (ball corridor)")).cave().chest(W,
20,80).chest(Ha,21);(new Location$$module$js$nodes(a,7,K,"Tunnel 4b (antidote dead end)")).cave().connect(Qc,v).chest(Oa,19);const We=(new Location$$module$js$nodes(a,8,K,"Tunnel 5 (warp boots dead end)")).cave().chest(jb,14),Xe=(new Location$$module$js$nodes(a,9,K,"Tunnel 3a (branch, front)")).cave().connect(Ue).connectTo(Qc).connectTo(We),Ye=(new Location$$module$js$nodes(a,9,K,"Tunnel 3b (branch, back)")).cave().connect(Xe,v).connectTo(Ve),Ze=(new Location$$module$js$nodes(a,10,K,"Tunnel 7 (boss)")).cave().connect(Ye).boss(Fe),
$e=(new Location$$module$js$nodes(a,12,K,"Tunnel 8a (exit, above wall)")).cave().connect(Ze),af=(new Location$$module$js$nodes(a,12,K,"Tunnel 8b (exit, below wall")).cave().connect($e,v);(new Location$$module$js$nodes(a,14,pa,"Windmill Cave")).cave().connect(Da).connectTo(Oc).trigger(Wd,nb,rb);(new Location$$module$js$nodes(a,15,pa,"Windmill")).misc().connect(Oc).trigger(Ra,Vb);const bf=(new Location$$module$js$nodes(a,16,pa,"Zebu's Cave Front")).cave().connect(Da).trigger(rb,ic,jc).trigger(lc,Ra,
rb),cf=(new Location$$module$js$nodes(a,16,pa,"Zebu's Cave Back")).cave().trigger(oc).connect(bf,w),df=(new Location$$module$js$nodes(a,17,B,"Tunnel 1 (to Zebu)")).cave().connect(cf),ua=(new Location$$module$js$nodes(a,20,ia,"West")).overworld().connect(af),ef=(new Location$$module$js$nodes(a,20,ia,"South")).overworld().connect(ua,q),Rc=(new Location$$module$js$nodes(a,21,ia,"East")).overworld().connect(ua).chest(Rb,24),Ea=(new Location$$module$js$nodes(a,24,qa,"Town")).town().connect(ua).trigger(Xd,
Rb),ff=(new Location$$module$js$nodes(a,25,ia,"Outside Stom's House")).town().connect(ua),zb=(new Location$$module$js$nodes(a,26,ia,"Swamp")).overworld().connect(Rc,Ua).trigger(sb,nc,Ua);(new Location$$module$js$nodes(a,26,ia,"Swamp Insect Area")).overworld().connect(zb,Ua).boss(Ge);const Xa=(new Location$$module$js$nodes(a,27,ra,"Town")).town().connect(ef),Ya=(new Location$$module$js$nodes(a,28,Ca,"Town")).town().connect(zb,Ua).trigger(mc);(new Location$$module$js$nodes(a,30,ia,"Stom's House")).house().connect(ff).trigger(Yd,
mc);const va=(new Location$$module$js$nodes(a,32,B,"Entrance")).overworld().connect(ua).connect(df),gf=(new Location$$module$js$nodes(a,32,B,"Up Slope")).overworld().from(va,Dc).to(va),hf=(new Location$$module$js$nodes(a,32,B,"Dead End (warp boots)")).overworld().chest(jb,24,106),Sc=(new Location$$module$js$nodes(a,33,B,"Upper")).overworld().from(va,A).to(va),jf=(new Location$$module$js$nodes(a,33,B,"Tornel Dead End")).overworld().trigger(ae,za).chest(X,23,105),Tc=(new Location$$module$js$nodes(a,
34,B,"Tunnel 2a (fork at start)")).cave().connect(va);(new Location$$module$js$nodes(a,34,B,"Tunnel 2b (left branch to dead end)")).cave().connect(Tc,w).connectTo(hf);const kf=(new Location$$module$js$nodes(a,34,B,"Tunnel 2c (right branch to upper)")).cave().connect(Tc,w),lf=(new Location$$module$js$nodes(a,35,B,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(kf).chest(W,23,82),mf=(new Location$$module$js$nodes(a,35,B,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(lf,
w).connectTo(Sc),Uc=(new Location$$module$js$nodes(a,36,B,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(mf);(new Location$$module$js$nodes(a,36,B,"Tunnel 4b (out to upper)")).cave().connect(Uc,w).connectTo(Sc);const nf=(new Location$$module$js$nodes(a,37,B,"Tunnel 5 (tiny connector)")).cave().connect(Uc),of=(new Location$$module$js$nodes(a,38,B,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(nf);(new Location$$module$js$nodes(a,38,B,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(of,
w).connectTo(jf);const pf=(new Location$$module$js$nodes(a,39,B,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(gf),qf=(new Location$$module$js$nodes(a,39,B,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(pf,w);(new Location$$module$js$nodes(a,39,B,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(qf,w).chest(za,25);const Za=(new Location$$module$js$nodes(a,40,u,"Entrance")).overworld().connect(Rc,ve,ue),$a=(new Location$$module$js$nodes(a,40,u,"Upper")).overworld().from(Za,A).to(Za),
Ab=(new Location$$module$js$nodes(a,40,u,"Summit (boss)")).overworld().from($a,A).to($a).boss(He),Vc=(new Location$$module$js$nodes(a,41,u,"Connector")).overworld(),Bb=(new Location$$module$js$nodes(a,41,u,"Middle Left")).overworld(),rf=(new Location$$module$js$nodes(a,41,u,"Middle Right")).overworld().from(Bb,Dc).to(Bb),Wc=(new Location$$module$js$nodes(a,42,u,"Tunnel 2a (from entrance to connector)")).cave().connectTo(Vc);(new Location$$module$js$nodes(a,42,u,"Tunnel 2b (under bridge, to antidote)")).cave().connect(Wc,
w).chest(Oa,23,94);const Xc=(new Location$$module$js$nodes(a,43,u,"Tunnel 3a (branch after connector)")).cave().connect(Vc),sf=(new Location$$module$js$nodes(a,43,u,"Tunnel 3b (right branch)")).cave().connect(Xc,w),tf=(new Location$$module$js$nodes(a,43,u,"Tunnel 3c (upper branch)")).cave().connect(Xc,w);(new Location$$module$js$nodes(a,44,u,"Tunnel 4 (over bridge, to middle)")).cave().connect(tf).connectTo(Bb);const Yc=(new Location$$module$js$nodes(a,45,u,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(sf).connectTo(rf);
(new Location$$module$js$nodes(a,45,u,"Tunnel 5b (dead-end with herb)")).cave().connect(Yc,w).chest(W,22,83);const uf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6a (S-shaped hall, right)")).cave().connect(Yc),vf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(uf,w),wf=(new Location$$module$js$nodes(a,46,u,"Tunnel 6c (S-shaped hall, left)")).cave().connect(vf,w),Zc=(new Location$$module$js$nodes(a,47,u,"Prison (hallway)")).cave().connect($a),xf=(new Location$$module$js$nodes(a,
48,u,"Left Cell (shopkeepers)")).cave().from(Zc,w);(new Location$$module$js$nodes(a,49,u,"Left Cell 2 (back, with prison key)")).cave().from(xf,w).chest(Wb,13);const yf=(new Location$$module$js$nodes(a,50,u,"Right Cell (villagers)")).cave().from(Zc,w),zf=(new Location$$module$js$nodes(a,51,u,"Tunnel 8 (behind right cell, toward summit)")).cave().from(yf,w);(new Location$$module$js$nodes(a,52,u,"Tunnel 9 (connector to summit)")).cave().connect(zf).connectTo(Ab);const Af=(new Location$$module$js$nodes(a,
53,u,"Tunnel 10a (summit cave, front)")).cave().from(Ab,Wb).to(Ab),Bf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10b (summit cave, behind ice)")).cave().connect(Af,w).trigger(be);(new Location$$module$js$nodes(a,56,u,"Tunnel 1 (leads from main entrance)")).cave().connect(Za).connectTo(Wc);(new Location$$module$js$nodes(a,57,u,"Tunnel 7 (to upper)")).cave().connect(wf).connectTo($a);const Cf=(new Location$$module$js$nodes(a,60,Va,"Inn")).town(),Df=(new Location$$module$js$nodes(a,61,Va,"Tool Shop")).house(),
Ef=(new Location$$module$js$nodes(a,62,Va,"Back Room")).house(),Cb=(new Location$$module$js$nodes(a,64,aa,"Summit")).overworld().connect(Bf),ab=(new Location$$module$js$nodes(a,64,aa,"Northwest")).overworld().from(Cb).to(Cb,A),Ff=(new Location$$module$js$nodes(a,64,aa,"Northeast")).overworld().connect(ab,q),$c=(new Location$$module$js$nodes(a,65,aa,"Southwest")).overworld().connect(ab),Gf=(new Location$$module$js$nodes(a,65,aa,"Southeast")).overworld().connect($c,q),ad=(new Location$$module$js$nodes(a,
66,aa,"Lime Tree Valley")).overworld().connect($c).connect(Da,Hd),Hf=(new Location$$module$js$nodes(a,67,aa,"Lime Tree Lake (Rage)")).cave().connect(ad).trigger(tc,L),If=(new Location$$module$js$nodes(a,68,ca,"Tunnel 1a (entrance)")).cave().connect(Gf),Jf=(new Location$$module$js$nodes(a,68,ca,"Tunnel 1b (behind wall)")).cave().connect(If,v),bd=(new Location$$module$js$nodes(a,69,ca,"Tunnel 2a (main path, before wall)")).cave().connect(Jf);(new Location$$module$js$nodes(a,69,ca,"Tunnel 2b (dead end, antidote)")).cave().connect(bd,
v).chest(Oa,25,95);const Kf=(new Location$$module$js$nodes(a,69,ca,"Tunnel 2c (main path, after wall)")).cave().connect(bd,v),Lf=(new Location$$module$js$nodes(a,70,ca,"Tunnel 3a (last room, before wall)")).cave().connect(Kf),Mf=(new Location$$module$js$nodes(a,70,ca,"Tunnel 3b (last room, after wall)")).cave().connect(Lf,v);(new Location$$module$js$nodes(a,71,ca,"Meadow")).overworld().connect(Mf).chest(cc,14);const Nf=(new Location$$module$js$nodes(a,72,C,"Tunnel 1a (entrance)")).cave().connect(Ff),
cd=(new Location$$module$js$nodes(a,72,C,"Tunnel 1b (past wall)")).cave().connect(Nf,v);(new Location$$module$js$nodes(a,72,C,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(cd,v).chest(ib,24);const Of=(new Location$$module$js$nodes(a,73,C,"Tunnel 2 (tiny connector)")).cave().connect(cd),dd=(new Location$$module$js$nodes(a,74,C,"Tunnel 3a (upper branch)")).cave().connect(Of);(new Location$$module$js$nodes(a,74,C,"Tunnel 3b (dead end, mimic)")).cave().connect(dd,v).chest(G,21,112);const ed=(new Location$$module$js$nodes(a,
74,C,"Tunnel 3c (short passage with mimic)")).cave().connect(dd,v).chest(G,22,113),Pf=(new Location$$module$js$nodes(a,74,C,"Tunnel 3d (lower branch)")).cave().connect(ed,v);(new Location$$module$js$nodes(a,75,C,"Tunnel 4 (dead end loop)")).cave().connect(Pf);const fd=(new Location$$module$js$nodes(a,76,C,"Tunnel 5a (right branch over bridge)")).cave().connect(ed),Qf=(new Location$$module$js$nodes(a,76,C,"Tunnel 5b (past wall over bridge)")).cave().connect(fd,v),Rf=(new Location$$module$js$nodes(a,
77,C,"Tunnel 6a (from left branch)")).cave().connect(fd),Sf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6b (reconvergence)")).cave().connect(Rf,v).connect(Qf),Tf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6c (between walls)")).cave().connect(Sf,v),Uf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6d (under bridge)")).cave().connect(Tf,v),Vf=(new Location$$module$js$nodes(a,78,C,"Tunnel 7a (over second bridge)")).cave().connect(Uf),Wf=(new Location$$module$js$nodes(a,78,C,"Tunnel 7b (past wall)")).cave().connect(Vf,
v),Xf=(new Location$$module$js$nodes(a,79,C,"Tunnel 8a (under second bridge)")).cave().connect(Wf);(new Location$$module$js$nodes(a,79,C,"Tunnel 8b (fog lamp)")).cave().connect(Xf,v).chest(Yb,19);const ma=(new Location$$module$js$nodes(a,80,z,"Town")).town().connect(ab),gd=(new Location$$module$js$nodes(a,81,z,"Fishherman Island")).town().connect(ma);(new Location$$module$js$nodes(a,82,aa,"Mesia Shrine")).cave().trigger(uc).connect(Hf,q,tc);const hd=(new Location$$module$js$nodes(a,84,ba,"Tunnel 1a (entrance)")).cave().connect(ab);
(new Location$$module$js$nodes(a,84,ba,"Tunnel 1b (dead end, mimic)")).cave().connect(hd,w).chest(G,19,114);const Yf=(new Location$$module$js$nodes(a,84,ba,"Tunnel 1c (past ice)")).cave().connect(hd,w),id=(new Location$$module$js$nodes(a,85,ba,"Tunnel 2 (stoned pair)")).cave().connect(Yf),Db=(new Location$$module$js$nodes(a,86,ba,"Tunnel 3 (wide medusa hallways)")).cave().from(id,Ae).to(id,Ba),Zf=(new Location$$module$js$nodes(a,87,ba,"Tunnel 4a (left entrance)")).cave().from(Db,w).chest(Qa,25).trigger(de,
Be);(new Location$$module$js$nodes(a,87,ba,"Tunnel 4b (right entrance)")).cave().from(Db,w).connect(Zf,A);(new Location$$module$js$nodes(a,87,ba,"Tunnel 4c (sword of water)")).cave().connect(Db,w).chest(L,24);const jd=(new Location$$module$js$nodes(a,88,U,"Entrance")).misc(),$f=(new Location$$module$js$nodes(a,89,U,"Level 1")).misc().from(jd),ag=(new Location$$module$js$nodes(a,90,U,"Level 2")).misc().from($f),bg=(new Location$$module$js$nodes(a,91,U,"Level 3")).misc().from(ag),kd=(new Location$$module$js$nodes(a,
92,U,"Outside Mesia Room")).misc().from(bg),cg=(new Location$$module$js$nodes(a,93,U,"Outside Dyna Room")).misc().from(kd,hb);(new Location$$module$js$nodes(a,94,U,"Mesia")).misc().connect(kd).trigger(oe);const dg=(new Location$$module$js$nodes(a,95,U,"Dyna")).misc().from(cg).boss(Re);(new Location$$module$js$nodes(a,95,U,"Win")).misc().from(dg).end();const Eb=(new Location$$module$js$nodes(a,96,ja,"Cabin Beach")).sea().from(gd,tb),wa=(new Location$$module$js$nodes(a,96,ja,"South")).sea().connect(Eb,
S),eg=(new Location$$module$js$nodes(a,96,ja,"Joel Beach")).sea().connect(wa,S),ld=(new Location$$module$js$nodes(a,96,da,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(a,96,ja,"Altar")).sea().connect(wa,S).trigger(ub,ac,$b);const fg=(new Location$$module$js$nodes(a,96,ja,"North")).sea().to(wa,S).from(wa,S,ye).trigger(ge,Ee),gg=(new Location$$module$js$nodes(a,96,ja,"Swan Beach")).sea().connect(fg,S);(new Location$$module$js$nodes(a,97,ja,"Cabin")).misc().connect(Eb).trigger(xc,tb);(new Location$$module$js$nodes(a,
98,da,"Lighthouse")).misc().connect(ld).trigger(fe,nb);const bb=(new Location$$module$js$nodes(a,100,z,"Underground Channel 1 (from throne room)")).sea().trigger(sc),hg=(new Location$$module$js$nodes(a,100,z,"Underground Channel 2 (to fortune teller)")).sea().connect(bb,q),md=(new Location$$module$js$nodes(a,100,z,"Underground Channel 3 (from fortune teller)")).sea().connect(bb,A),nd=(new Location$$module$js$nodes(a,100,z,"Underground Channel 4 (asina)")).sea().connect(md,q),ig=(new Location$$module$js$nodes(a,
100,z,"Underground Channel 5 (dolphin)")).sea().connect(nd,q).trigger(wc,W,vc);(new Location$$module$js$nodes(a,100,z,"Underground Channel 6 (water)")).sea().connect(ig,S).connectTo(wa,S).chest(bc,17);const Fb=(new Location$$module$js$nodes(a,101,F,"Zombie Town")).town(),jg=(new Location$$module$js$nodes(a,104,F,"Tunnel 1 (entrance)")).sea().connect(wa,yc,S),od=(new Location$$module$js$nodes(a,105,F,"Tunnel 2a (start)")).cave().connect(jg);(new Location$$module$js$nodes(a,105,F,"Tunnel 2b (dead end to left)")).cave().connect(od,
q);const kg=(new Location$$module$js$nodes(a,105,F,"Tunnel 2c (across first river)")).cave().connect(od,q),pd=(new Location$$module$js$nodes(a,105,F,"Tunnel 2d (across second river)")).cave().connect(kg,q);(new Location$$module$js$nodes(a,105,F,"Tunnel 2e (dead end, magic ring)")).cave().connect(pd,v).chest(X,29);const lg=(new Location$$module$js$nodes(a,105,F,"Tunnel 2f (stair down)")).cave().connect(pd,v),mg=(new Location$$module$js$nodes(a,106,F,"Tunnel 3a (main area)")).cave().connect(lg).connectTo(Fb).chest(ib,
25,92),ng=(new Location$$module$js$nodes(a,106,F,"Tunnel 3b (left area toward items)")).cave().connect(mg,v),og=(new Location$$module$js$nodes(a,107,F,"Tunnel 4a (right side, mimic)")).cave().connect(ng).chest(G,14,115);(new Location$$module$js$nodes(a,107,F,"Tunnel 4b (left side, iron necklace)")).cave().connect(og,q).chest(Sd,15);const Gb=(new Location$$module$js$nodes(a,108,ea,"Floor 1")).fortress().connect(Fb),pg=(new Location$$module$js$nodes(a,108,ea,"Miniboss")).fortress().boss(Ie).connect(Gb);
(new Location$$module$js$nodes(a,109,ea,"Floor 2a (left stair)")).fortress().connect(Gb).chest(Aa,19);const qg=(new Location$$module$js$nodes(a,109,ea,"Floor 2b (right stair)")).fortress().connect(pg).chest(W,30,85),rg=(new Location$$module$js$nodes(a,110,ea,"Floor 3a (toward boss)")).fortress().connect(qg),qd=(new Location$$module$js$nodes(a,110,ea,"Floor 3b (boss room)")).fortress().connect(rg);(new Location$$module$js$nodes(a,110,ea,"Boss")).fortress().boss(Nc).connect(qd);(new Location$$module$js$nodes(a,
110,ea,"Floor 3c (back room trap)")).fortress().from(qd).to(Gb);const sg=(new Location$$module$js$nodes(a,112,da,"Secret Passage")).cave().connectTo(ld),cb=(new Location$$module$js$nodes(a,113,da,"Town")).town().connect(eg),V=(new Location$$module$js$nodes(a,114,N,"Town")).town().connect(gg),tg=(new Location$$module$js$nodes(a,115,N,"Inside Gate")).overworld().connect(V),ug=(new Location$$module$js$nodes(a,115,N,"Outside Gate")).overworld().from(tg,na),db=(new Location$$module$js$nodes(a,120,la,"Valley")).overworld().connect(ug),
Hb=(new Location$$module$js$nodes(a,124,x,"Entrance")).overworld().connect(db),vg=(new Location$$module$js$nodes(a,124,x,"Over first river toward Shyron")).overworld().connect(Hb,q),rd=(new Location$$module$js$nodes(a,124,x,"After first tunnel")).overworld(),sd=(new Location$$module$js$nodes(a,124,x,"Door to Styx")).overworld().connect(rd,q),wg=(new Location$$module$js$nodes(a,124,x,"Dead end (no item)")).overworld(),xg=(new Location$$module$js$nodes(a,124,x,"Dead end (fruit of lime)")).overworld().chest(Pd,
26),yg=(new Location$$module$js$nodes(a,124,x,"Dead end (magic ring)")).overworld().chest(X,25,101),td=(new Location$$module$js$nodes(a,124,x,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(a,124,x,"Floating island (bow of sun)")).overworld().connect(td,A).chest(ec,24);const zg=(new Location$$module$js$nodes(a,125,x,"Tunnel 1 (to Shyron)")).cave().connect(vg),Ag=(new Location$$module$js$nodes(a,126,x,"Outside Shyron")).overworld().connect(zg);(new Location$$module$js$nodes(a,
127,x,"Tunnel 2 (fork)")).cave().connect(Hb).connectTo(xg).connectTo(rd);const ud=(new Location$$module$js$nodes(a,128,x,"Tunnel 3 (caves)")).cave().connect(sd).connect(wg),vd=(new Location$$module$js$nodes(a,129,x,"Tunnel 4 (left branch of cave)")).cave().connect(ud);(new Location$$module$js$nodes(a,130,x,"Tunnel 5 (dead end, medical herb)")).cave().connect(vd).chest(W,15,86);const Bg=(new Location$$module$js$nodes(a,131,x,"Tunnel 6a (left-then-right)")).cave().connect(vd),Cg=(new Location$$module$js$nodes(a,
131,x,"Tunnel 6b (past wall)")).cave().connect(Bg,v),Dg=(new Location$$module$js$nodes(a,132,x,"Tunnel 7 (wide hall)")).cave().connect(Cg);(new Location$$module$js$nodes(a,133,x,"Tunnel 8 (red slimes)")).cave().from(Dg,v).connectTo(td).chest(G,23,116);const Eg=(new Location$$module$js$nodes(a,134,x,"Tunnel 9 (right branch, infinite loop)")).cave().connect(ud),Fg=(new Location$$module$js$nodes(a,135,x,"Tunnel 10a (toward magic ring)")).cave().connect(Eg);(new Location$$module$js$nodes(a,135,x,"Tunnel 10b (past wall)")).cave().connect(Fg,
v).connectTo(yg);const wd=(new Location$$module$js$nodes(a,136,ka,"Entrance")).fortress().from(sd,Xb,xb),Gg=(new Location$$module$js$nodes(a,137,ka,"Left branch")).fortress().connect(wd).chest(G,19,117),Hg=(new Location$$module$js$nodes(a,137,ka,"Left branch, past one bridge")).fortress().connect(Gg,q),Ig=(new Location$$module$js$nodes(a,137,ka,"Left branch, past two bridges")).fortress().connect(Hg,q).chest(W,29,87),Jg=(new Location$$module$js$nodes(a,137,ka,"Right branch")).fortress().connect(wd);
(new Location$$module$js$nodes(a,137,ka,"Right branch, across water")).fortress().connect(Jg,A).chest(G,20,118).chest(G,21,119).chest(Md,28);(new Location$$module$js$nodes(a,138,ka,"Upper floor")).fortress().connect(Ig).chest(I,27);const xa=(new Location$$module$js$nodes(a,140,fa,"Town")).town().connect(Ag,Jc).trigger(vb),Fa=(new Location$$module$js$nodes(a,142,la,"Town")).town().connect(db),xd=(new Location$$module$js$nodes(a,143,E,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(a,
143,E,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(xd,oa).chest(Qd,15);const Ib=(new Location$$module$js$nodes(a,144,la,"Desert 1")).overworld().connect(db),eb=(new Location$$module$js$nodes(a,145,E,"Area 1 (from entrance)")).cave().chest(Tb,26),yd=(new Location$$module$js$nodes(a,145,E,"Area 2 (across top bridge)")).cave().connect(eb,q);(new Location$$module$js$nodes(a,145,E,"Area 3 (dead-end across top-right bridge)")).cave().connect(yd,q);const Kg=(new Location$$module$js$nodes(a,
145,E,"Area 4 (left across middle-right bridge)")).cave().connect(yd,q),Lg=(new Location$$module$js$nodes(a,145,E,"Area 5 (bottom edge)")).cave().connect(Kg,q),Mg=(new Location$$module$js$nodes(a,145,E,"Area 6 (bottom island)")).cave().connect(Lg,q),Ng=(new Location$$module$js$nodes(a,145,E,"Area 7 (bottom inner ring)")).cave().connect(Mg,q),Og=(new Location$$module$js$nodes(a,145,E,"Area 8 (left outer ring)")).cave().connect(Ng,q).connect(eb,q).chest(Aa,27,100),Pg=(new Location$$module$js$nodes(a,
145,E,"Area 9 (top left inner ring)")).cave().connect(Og,q),Qg=(new Location$$module$js$nodes(a,145,E,"Area 10 (top right inner ring)")).cave().connect(Pg,q);(new Location$$module$js$nodes(a,145,E,"Area 11 (center)")).cave().connect(Qg,q).connectTo(xd);(new Location$$module$js$nodes(a,145,E,"Area 12 (top center islands)")).cave().connect(eb,A).chest(Nd,28);const Rg=(new Location$$module$js$nodes(a,146,P,"Desert Cave 1")).cave().connect(Ib,A),ya=(new Location$$module$js$nodes(a,147,P,"Town")).town(),
...
Wg=(new Location$$module$js$nodes(a,157,ta,"Fork")).fortress().connect(Ug),zd=(new Location$$module$js$nodes(a,158,ta,"Main")).fortress().connect(Wg);(new Location$$module$js$nodes(a,158,ta,"Treasure Chest (magic ring)")).fortress().connect(zd).chest(X,27,108);(new Location$$module$js$nodes(a,159,ta,"Draygon")).fortress().connect(zd).to(Vg).boss(Oe);const Xg=(new Location$$module$js$nodes(a,160,T,"Entrance")).fortress().connect(Jb,A),Yg=(new Location$$module$js$nodes(a,160,T,"Statues")).fortress().connect(Xg).boss(Pe),
...
(new Location$$module$js$nodes(a,167,T,"Teleporter")).fortress().from(ah).to(jd);const Ad=(new Location$$module$js$nodes(a,168,Wa,"Entrance")).fortress().connect(Fa,xb).trigger(Cc,I),bh=(new Location$$module$js$nodes(a,169,Wa,"Main")).fortress().from(Ad,oa),ch=(new Location$$module$js$nodes(a,169,Wa,"Boss")).fortress().connect(bh).boss(Ke),dh=(new Location$$module$js$nodes(a,170,Wa,"Zebu")).fortress().connect(ch),fb=(new Location$$module$js$nodes(a,171,O,"Entrance")).fortress().connect(dh);(new Location$$module$js$nodes(a,
171,O,"Dead End Behind Iron (fruit of power)")).fortress().connect(fb,oa).chest(Aa,28,98);(new Location$$module$js$nodes(a,171,O,"Dead End Loop Across Closer Bridges")).fortress().connect(fb,q).connect(fb,q);const eh=(new Location$$module$js$nodes(a,171,O,"Across First Bridge (fruit of repun)")).fortress().connect(fb,q).chest(Qb,30,102),Lb=(new Location$$module$js$nodes(a,171,O,"Across Second Bridge")).fortress().connect(eh,q);(new Location$$module$js$nodes(a,171,O,"Dead End Across Two Bridges ()")).fortress().connect(Lb,
q).connect(Lb,q).chest(ib,29,93);const fh=(new Location$$module$js$nodes(a,171,O,"Across Third Bridge")).fortress().connect(Lb,q),gh=(new Location$$module$js$nodes(a,171,O,"Exit Behind Iron Door")).fortress().connect(fh,oa),hh=(new Location$$module$js$nodes(a,172,O,"Boss")).fortress().connect(gh).boss(Le),ih=(new Location$$module$js$nodes(a,172,O,"Tornel")).fortress().connect(hh),Bd=(new Location$$module$js$nodes(a,173,sa,"Lower")).fortress().connect(ih).chest(kb,26,99).chest(X,27,111),jh=(new Location$$module$js$nodes(a,
174,sa,"Upper Loop")).fortress().connect(Bd).chest(Oa,22,96);(new Location$$module$js$nodes(a,174,sa,"Upper Loop Behind Wall (magic ring)")).fortress().connect(jh,oa).chest(X,23,107);const kh=(new Location$$module$js$nodes(a,175,sa,"Upper Passage (toward Mado)")).fortress().connect(Bd).chest(X,27,84),Mb=(new Location$$module$js$nodes(a,176,H,"Initial Fork")).fortress(),lh=(new Location$$module$js$nodes(a,177,H,"Left Branch")).fortress().connect(Mb),Cd=(new Location$$module$js$nodes(a,178,H,"Main Area (right branch, over bridges)")).fortress().connect(Mb),
mh=(new Location$$module$js$nodes(a,179,H,"U-shaped Passage (between floors)")).fortress().connect(Cd),nh=(new Location$$module$js$nodes(a,180,H,"Main Area Lower (under bridge)")).fortress().connect(lh).connect(Cd).connect(mh),Dd=(new Location$$module$js$nodes(a,180,H,"Behind Iron Wall")).fortress().connect(nh,oa),oh=(new Location$$module$js$nodes(a,181,H,"Lower")).fortress().connect(Dd).chest(G,13,121).chest(G,14,122).chest(G,15,123).chest(X,23,88).chest(jb,24,110),ph=(new Location$$module$js$nodes(a,
182,H,"Boss Corridor")).fortress().connect(oh),qh=(new Location$$module$js$nodes(a,182,H,"Boss")).fortress().connect(ph,xb).boss(Ne);(new Location$$module$js$nodes(a,182,H,"Behind Boss (stormBracelet)")).fortress().connect(qh).chest(Na,18);const Ed=(new Location$$module$js$nodes(a,183,H,"Exit Stairs")).fortress(),rh=(new Location$$module$js$nodes(a,184,E,"Entrance Back (behind river)")).cave().connect(Ed).chest(Aa,13,90);(new Location$$module$js$nodes(a,184,E,"Entrance Front")).cave().connect(rh,
A).connectTo(Ib).connectTo(eb);const sh=(new Location$$module$js$nodes(a,185,sa,"Boss")).fortress().connect(kh).boss(Me);(new Location$$module$js$nodes(a,185,sa,"Asina")).fortress().connect(sh).connectTo(Mb);(new Location$$module$js$nodes(a,186,H,"Kensu")).fortress().connect(Dd).connectTo(Ed).trigger(ke,pb);(new Location$$module$js$nodes(a,187,la,"House")).house().connect(Fa).trigger(me,na,pb);(new Location$$module$js$nodes(a,188,la,"Inn")).shop().connect(Fa,vb);(new Location$$module$js$nodes(a,190,
la,"Tool Shop")).shop().connect(Fa,vb);(new Location$$module$js$nodes(a,191,la,"Tavern")).shop().connect(Fa);(new Location$$module$js$nodes(a,192,M,"Elder House")).house().connect(ha).trigger(ic);(new Location$$module$js$nodes(a,193,M,"Rabbit Hut")).house().connect(ha).trigger(pc,oc,Y);(new Location$$module$js$nodes(a,194,M,"Inn")).shop().connect(ha);(new Location$$module$js$nodes(a,195,M,"Tool Shop")).shop().connect(ha).trigger(kc);(new Location$$module$js$nodes(a,196,M,"Armor Shop")).shop().connect(ha);
(new Location$$module$js$nodes(a,197,M,"Student House")).house().connect(ha).trigger(jc);(new Location$$module$js$nodes(a,198,qa,"Tavern")).house().connect(Ea);(new Location$$module$js$nodes(a,199,qa,"Pawn Shop")).shop().connect(Ea);(new Location$$module$js$nodes(a,200,qa,"Inn")).shop().connect(Ea);(new Location$$module$js$nodes(a,201,qa,"Armor Shop")).shop().connect(Ea);(new Location$$module$js$nodes(a,203,qa,"Tool Shop")).shop().connect(Ea);(new Location$$module$js$nodes(a,205,Ca,"Elder House")).house().from(Ya,
Y).trigger($d,sb);(new Location$$module$js$nodes(a,206,Ca,"Mother's House")).house().from(Ya,Y).trigger(nc,Y).trigger(Zd,sb);(new Location$$module$js$nodes(a,207,Ca,"Tool Shop")).shop().from(Ya,Y);(new Location$$module$js$nodes(a,208,Ca,"Inn")).shop().from(Ya,Y);(new Location$$module$js$nodes(a,209,ra,"Inn")).shop().connect(Xa);(new Location$$module$js$nodes(a,210,ra,"Tool Shop")).shop().connect(Xa);(new Location$$module$js$nodes(a,211,ra,"Armor Shop")).shop().connect(Xa);const th=(new Location$$module$js$nodes(a,
212,ra,"Queen's House")).house().from(Xa,Jc).trigger(ie,na,cc);(new Location$$module$js$nodes(a,213,Va,"Nadare's")).house().connect(Za).connectTo(Cf).connectTo(Df).connectTo(Ef);(new Location$$module$js$nodes(a,214,z,"Fisherman's House")).house().connect(gd).trigger(tb,Yb,ob,Ce);const Nb=(new Location$$module$js$nodes(a,215,z,"Palace Entrance")).house().connect(ma);(new Location$$module$js$nodes(a,216,z,"Fortune Teller Front")).house().connect(ma).trigger(rc,qc);(new Location$$module$js$nodes(a,216,
z,"Fortune Teller Back")).house().connect(hg).connect(md);(new Location$$module$js$nodes(a,217,z,"Pawn Shop")).shop().connect(ma);(new Location$$module$js$nodes(a,218,z,"Armor Shop")).shop().connect(ma);(new Location$$module$js$nodes(a,220,z,"Inn")).shop().connect(ma);(new Location$$module$js$nodes(a,221,z,"Tool Shop")).shop().connect(ma);(new Location$$module$js$nodes(a,222,z,"Palace Left")).house().connect(Nb);(new Location$$module$js$nodes(a,223,z,"Palace Throne Room")).house().connect(Nb).to(bb,
we).from(bb).trigger(qc).trigger(ce,rc,sc);(new Location$$module$js$nodes(a,224,z,"Palace Right")).house().connect(Nb);(new Location$$module$js$nodes(a,225,z,"Asina's Room")).house().connect(nd).trigger(vc,Ec);(new Location$$module$js$nodes(a,226,ra,"Queen Downstairs")).house().connect(th).chest(La,13);(new Location$$module$js$nodes(a,227,da,"Elder's House")).house().connect(cb).trigger(yc);(new Location$$module$js$nodes(a,228,da,"Shed")).house().connect(cb).to(sg,Zb);(new Location$$module$js$nodes(a,
229,da,"Tool Shop")).shop().connect(cb).trigger(kc);(new Location$$module$js$nodes(a,231,da,"Inn")).shop().connect(cb);const uh=(new Location$$module$js$nodes(a,232,F,"Zombie Town House")).house().connect(Fb);(new Location$$module$js$nodes(a,233,F,"Zombie Town Basement")).house().connect(uh).trigger(ee,Nc);(new Location$$module$js$nodes(a,235,N,"Tool Shop")).shop().connect(V);(new Location$$module$js$nodes(a,236,N,"Stom's Hut")).house().connect(V).trigger(zc);(new Location$$module$js$nodes(a,237,
N,"Inn")).shop().connect(V);(new Location$$module$js$nodes(a,238,N,"Armor Shop")).shop().connect(V);(new Location$$module$js$nodes(a,239,N,"Tavern")).house().connect(V).trigger(Ac,zc,Pa);(new Location$$module$js$nodes(a,240,N,"Pawn Shop")).shop().connect(V);(new Location$$module$js$nodes(a,241,N,"Dance Hall")).house().connect(V).trigger(Bc,Ac,Pa).trigger(he,Bc,bc);const vh=(new Location$$module$js$nodes(a,242,fa,"Temple (pre-massacre)")).fortress().connect(xa).from(yb,I,Gd).trigger(je);(new Location$$module$js$nodes(a,
242,fa,"Temple (post-massacre)")).fortress().from(vh,Cc).boss(Je);(new Location$$module$js$nodes(a,243,fa,"Training Hall")).house().connect(xa);(new Location$$module$js$nodes(a,244,fa,"Hospital")).house().connect(xa);(new Location$$module$js$nodes(a,245,fa,"Armor Shop")).shop().connect(xa);(new Location$$module$js$nodes(a,246,fa,"Tool Shop")).shop().connect(xa);(new Location$$module$js$nodes(a,247,fa,"Inn")).shop().connect(xa);(new Location$$module$js$nodes(a,248,P,"Inn")).shop().connect(ya);(new Location$$module$js$nodes(a,
249,P,"Tool Shop")).shop().connect(ya);(new Location$$module$js$nodes(a,250,P,"Elder's House")).house().connect(ya);(new Location$$module$js$nodes(a,251,P,"Pawn Shop")).house().connect(ya);const wh=[ha,Da,Pc,ua,zb,va,Cb,ad,Eb,V,db,Hb,Ib,Ad,Jb];for(const a of wh)a.from(yb,re);return a},shuffle$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes);d||(d=new FlagSet$$module$js$flagset("Sbkm Sct"));
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="latest",LABEL$$module$js$version="latest 2a79f4c",HASH$$module$js$version="2a79f4c375c9c1ffac0b3b73d2ca063f63fa5887",DATE$$module$js$version=new Date(1552184554E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c;a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);c=a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$js$patch(b,parseSeed$$module$js$patch(a.seed),c)})}};
