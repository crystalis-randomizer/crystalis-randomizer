...
a.assumeGhettoFlight())),l=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),p=h(d("Assume teleport skip",a.assumeTeleportSkip())),q=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),w=h(d("Allow rabbit skip",!a.disableRabbitSkip())),u=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),G=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),O=h(d("Assume wild warp",a.assumeWildWarp())),
S=d("Allow wild warp",a.allowWildWarp()),y=d("Sword magic optional",!a.guaranteeSwordMagic()),t=d("Matching sword optional",!a.guaranteeMatchingSword()),v=d("Gas mask optional",!a.guaranteeGasMask()),L=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),wa=d("Calm sea optional",!a.barrierRequiresCalmSea()),C=d("Prison key optional",!a.paralysisRequiresPrisonKey()),xa=d("Windmill optional",!a.sealedCaveRequiresWindmill()),da=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
D=d("Barrier magic optional",!a.guaranteeBarrier()),F=d("Refresh magic optional",!a.guaranteeRefresh()),Ud=d("Telepathy optional for Deo",!a.saharaRabbitsRequireTelepathy()),Vd=d("Lime Tree connects to Leaf",a.connectLimeTreeToLeaf()),Wd=d("Buffed medical herb",a.buffMedicalHerb()),Ya=d("Orbs optional",a.orbsOptional()),X=(new Item$$module$js$nodes(c,0,"Sword of Wind")).weight(a.guaranteeSword()?10:5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),Y=(new Item$$module$js$nodes(c,
1,"Sword of Fire")).weight(a.guaranteeSword()?10:5).fromPerson("Oak elder",29).dialog(29,void 0,3).key(),T=(new Item$$module$js$nodes(c,2,"Sword of Water")).weight(10).chest().key(),Q=(new Item$$module$js$nodes(c,3,"Sword of Thunder")).weight(15).chest().key(),wb=(new Item$$module$js$nodes(c,4,"Crystalis")).fixed(),Qa=(new Item$$module$js$nodes(c,5,"Ball of Wind")).chest().key(),Ra=(new Item$$module$js$nodes(c,6,"Tornado Bracelet")).chest().key(),Za=(new Item$$module$js$nodes(c,7,"Ball of Fire")).bossDrop("Insect",
1).dialog(30,void 0,2).dialog(32,void 0,0).dialog(33,void 0,0).dialog(34,void 0,0).dialog(96,30,0).dialog(29,void 0,2).dialog(31,void 0,1).npcSpawn(193).key(),$a=(new Item$$module$js$nodes(c,8,"Flame Bracelet")).bossDrop("Kelbesque 1",2).npcSpawn(194).key(),ab=(new Item$$module$js$nodes(c,9,"Ball of Water")).weight(5).direct("Rage",250679).npcSpawn(195).key(),bb=(new Item$$module$js$nodes(c,10,"Blizzard Bracelet")).weight(5).chest().key(),cb=(new Item$$module$js$nodes(c,11,"Ball of Thunder")).bossDrop("Mado 1",
5).trigger(154,1).key(),db=(new Item$$module$js$nodes(c,12,"Storm Bracelet")).chest().key(),cc=(new Item$$module$js$nodes(c,13,"Carapace Shield")).armor(),Xd=(new Item$$module$js$nodes(c,14,"Bronze Shield")).armor(),dc=(new Item$$module$js$nodes(c,15,"Platinum Shield")).armor(),ec=(new Item$$module$js$nodes(c,16,"Mirrored Shield")).armor(),Yd=(new Item$$module$js$nodes(c,17,"Ceramic Shield")).armor(),xb=(new Item$$module$js$nodes(c,18,"Sacred Shield")).armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),
fc=(new Item$$module$js$nodes(c,19,"Battle Shield")).armor(),Zd=(new Item$$module$js$nodes(c,20,"Psycho Shield")).armor(),$d=(new Item$$module$js$nodes(c,21,"Tanned Hide")).armor(),ae=(new Item$$module$js$nodes(c,22,"Leather Armor")).armor(),be=(new Item$$module$js$nodes(c,23,"Bronze Armor")).armor(),gc=(new Item$$module$js$nodes(c,24,"Platinmum Armor")).armor(),ce=(new Item$$module$js$nodes(c,25,"Soldier Suit")).armor(),hc=(new Item$$module$js$nodes(c,26,"Ceramic Suit")).armor(),de=(new Item$$module$js$nodes(c,
27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),M=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),R=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),Ea=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),yb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),U=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),ea=(new Item$$module$js$nodes(c,
34,"Magic Ring")).consumable(),zb=(new Item$$module$js$nodes(c,35,"Fruit of Repun")).consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),Z=(new Item$$module$js$nodes(c,36,"Warp Boots")).consumable(),ic=(new Item$$module$js$nodes(c,37,"Statue of Onyx")).chest("Cordel grass").invisible(254882).key(),Ab=(new Item$$module$js$nodes(c,38,"Opel Statue")).consumable().bossDrop("Kelbesque 2",6).npcSpawn(197).key(),jc=(new Item$$module$js$nodes(c,39,"Insect Flute")).fromPerson("Oak mother",30).dialog(30,
void 0,1).key(),Bb=(new Item$$module$js$nodes(c,40,"Flute of Lime")).fromPerson("Portoa queen",56).fromPerson("Asina secondary",98,1).dialog(56,void 0,4).key(),eb=(new Item$$module$js$nodes(c,41,"Gas Mask")).direct("Akahana in Brynmaer",251902).npcSpawn(22,24).key(),fe=(new Item$$module$js$nodes(c,42,"Power Ring")).chest().bonus(),ge=(new Item$$module$js$nodes(c,43,"Warrior Ring")).fromPerson("Akahana's friend",84).dialog(84,void 0,2).bonus(),he=(new Item$$module$js$nodes(c,44,"Iron Necklace")).chest().bonus(),
ie=(new Item$$module$js$nodes(c,45,"Deo's Pendant")).fromPerson("Deo",90).dialog(90,void 0,0).bonus(),Cb=(new Item$$module$js$nodes(c,46,"Rabbit Boots")).bossDrop("Vampire 1",0).npcSpawn(192).key(),kc=((a,b)=>new Item$$module$js$nodes(c,a,b))(47,a.leatherBootsGiveSpeed()?"Speed Boots":"Leather Boots").chest().bonus(),lc=(new Item$$module$js$nodes(c,48,"Shield Ring")).direct("Akahana in waterfall cave",250543).bonus(),Db=(new Item$$module$js$nodes(c,49,"Alarm Flute")).fromPerson("Zebu's student",20,
1).key(),mc=(new Item$$module$js$nodes(c,50,"Windmill Key")).fromPerson("Windmill guard",20).dialog(20,14,0).npcSpawn(20,14,1).key(),Eb=(new Item$$module$js$nodes(c,51,"Key to Prison")).chest().key(),nc=(new Item$$module$js$nodes(c,52,"Key to Styx")).fromPerson("Zebu in Shyron",94,1).trigger(128,2).dialog(94,242,0).dialog(98,242,0).key(),oc=(new Item$$module$js$nodes(c,53,"Fog Lamp")).chest().key(),Fb=(new Item$$module$js$nodes(c,54,"Shell Flute")).fromPerson("Dolphin",99,1).npcSpawn(99).key(),pc=
(new Item$$module$js$nodes(c,55,"Eye Glasses")).fromPerson("Clark",68).dialog(68,233,1).key(),qc=(new Item$$module$js$nodes(c,56,"Broken Statue")).bossDrop("Sabera 1",4).npcSpawn(127,101).npcSpawn(9).npcSpawn(10).npcSpawn(69).npcSpawn(70).npcSpawn(71).npcSpawn(132).npcSpawn(142).dialog(61).dialog(62).dialog(63).dialog(64).dialog(65).dialog(66).dialog(67).dialog(68,233).trigger(182).key(),rc=(new Item$$module$js$nodes(c,57,"Glowing Lamp")).direct("Kensu in lighthouse",250638).npcSpawn(126,98,1).key(),
sc=(new Item$$module$js$nodes(c,59,"Love Pendant")).chest("Underground channel").invisible(254890).key(),tc=(new Item$$module$js$nodes(c,60,"Kirisa Plant")).chest("Kirisa meadow").invisible(254886).key(),Gb=(new Item$$module$js$nodes(c,61,"Ivory Statue")).bossDrop("Karmine",9).npcSpawn(200).key(),uc=(new Item$$module$js$nodes(c,62,"Bow of Moon")).fromPerson("Aryllis",35).direct(251624).dialog(35,void 0,1).key(),vc=(new Item$$module$js$nodes(c,63,"Bow of Sun")).chest().key(),wc=(new Item$$module$js$nodes(c,
64,"Bow of Truth")).fromPerson("Azteca",131).npcSpawn(131,156,1).dialog(131,void 0,0).key(),fb=(new Magic$$module$js$nodes(c,65,"Refresh")).fromPerson("Zebu at windmill",94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),Sa=(new Magic$$module$js$nodes(c,66,"Paralysis")).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),oa=(new Magic$$module$js$nodes(c,67,"Telepathy")).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),xc=(new Magic$$module$js$nodes(c,
68,"Teleport")).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),je=(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),yc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),ya=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),I=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=U.bossDrop("Vampire 2",
12,97).npcSpawn(204).key(),V=new Item$$module$js$nodes(c,112,"Mimic"),zc=(new Trigger$$module$js$nodes(c,"Talked to Leaf Elder")).get(X),Ac=(new Trigger$$module$js$nodes(c,"Talked to Leaf Student")).get(Db),Hb=new Trigger$$module$js$nodes(c,"Talked to Zebu in cave"),le=(new Trigger$$module$js$nodes(c,"Woke up Windmill Guard")).get(mc),Ta=new Trigger$$module$js$nodes(c,"Started Windmill"),Bc=(new Trigger$$module$js$nodes(c,"Learned Refresh")).get(fb),me=(new Trigger$$module$js$nodes(c,"Gave Statue to Akahana")).get(eb),
ne=(new Trigger$$module$js$nodes(c,"Fought Stom")).get(oa),Cc=new Trigger$$module$js$nodes(c,"Visited Oak"),Dc=new Trigger$$module$js$nodes(c,"Talked to Oak Mother"),Ib=new Trigger$$module$js$nodes(c,"Rescued Oak Child"),oe=(new Trigger$$module$js$nodes(c,"Talked to Oak Mother Again")).get(jc),pe=(new Trigger$$module$js$nodes(c,"Talked to Oak Elder")).get(Y),qe=(new Trigger$$module$js$nodes(c,"Talked to Tornel on Mt Sabre")).get(xc),Ec=new Trigger$$module$js$nodes(c,"Villagers Abducted"),Fc=new Trigger$$module$js$nodes(c,
"Talked to Rabbit in Leaf"),re=(new Trigger$$module$js$nodes(c,"Learned Paralysis")).get(Sa),Gc=new Trigger$$module$js$nodes(c,"Talked to Portoa Queen"),Hc=new Trigger$$module$js$nodes(c,"Talked to Fortune Teller"),Ic=new Trigger$$module$js$nodes(c,"Visited Underground Channel"),se=(new Trigger$$module$js$nodes(c,"Sent to Waterfall Cave")).get(Bb),te=(new Trigger$$module$js$nodes(c,"Cured Akahana")).get(lc),Jc=(new Trigger$$module$js$nodes(c,"Talked to Rage")).get(ab),Kc=new Trigger$$module$js$nodes(c,
"Mesia recording played"),Lc=(new Trigger$$module$js$nodes(c,"Talked to Asina")).get(je),Mc=(new Trigger$$module$js$nodes(c,"Healed Dolphin")).get(Fb),Jb=new Trigger$$module$js$nodes(c,"Returned Fog Lamp"),Nc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Cabin"),Oc=new Trigger$$module$js$nodes(c,"Talked to Joel Elder"),ue=(new Trigger$$module$js$nodes(c,"Talked to Clark")).get(pc),ve=(new Trigger$$module$js$nodes(c,"Talked to Kensu in Lighthouse")).get(rc),Kb=new Trigger$$module$js$nodes(c,"Calmed the Angry Sea"),
we=(new Trigger$$module$js$nodes(c,"Learned Barrier")).get(yc),Pc=new Trigger$$module$js$nodes(c,"Talked to Stom in Swan Hut"),Qc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Swan tavern"),Rc=new Trigger$$module$js$nodes(c,"Talked to Kensu at Swan dance"),xe=(new Trigger$$module$js$nodes(c,"Returned Kensu's love pendant")).get(ya),ye=(new Trigger$$module$js$nodes(c,"Talked to Amazones Queen")).get(uc),Lb=new Trigger$$module$js$nodes(c,"Entered Shyron"),ze=(new Trigger$$module$js$nodes(c,"Talked to Zebu in Shyron")).get(nc),
Sc=new Trigger$$module$js$nodes(c,"Shyron Massacre"),Ae=(new Trigger$$module$js$nodes(c,"Saved Kensu")).get(I),Be=(new Trigger$$module$js$nodes(c,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$js$nodes(c,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(c,"Get Bow of Truth")).get(wc),Ee=(new Trigger$$module$js$nodes(c,"Forged Crystalis")).get(wb),gb=(new Condition$$module$js$nodes(c,"Sword charge glitch")).option(u,G),Fe=(new Condition$$module$js$nodes(c,"Rabbit skip")).option(r,
w),Ge=(new Condition$$module$js$nodes(c,"Teleport skip")).option(p,q),hb=(new Condition$$module$js$nodes(c,"Statue glitch")).option(l,n),He=(new Condition$$module$js$nodes(c,"Wild warp")).option(O,S),ib=(new Condition$$module$js$nodes(c,"Any level 2 sword")).option(X,Qa).option(X,Ra).option(Y,Za).option(Y,$a).option(T,ab).option(T,bb).option(Q,cb).option(Q,db),A=(new Condition$$module$js$nodes(c,"Destroy stone")).option(X,Ya).option(X,Qa).option(X,Ra).option(gb,X,ib),B=(new Condition$$module$js$nodes(c,
"Destroy ice")).option(Y,Ya).option(Y,Za).option(Y,$a).option(gb,Y,ib),x=(new Condition$$module$js$nodes(c,"Cross rivers")).option(T,Ya).option(T,ab).option(T,bb).option(I).option(gb,T,ib),Fa=(new Condition$$module$js$nodes(c,"Destroy iron")).option(Q,Ya).option(Q,cb).option(Q,db).option(gb,Q,ib),aa=(new Condition$$module$js$nodes(c,"Any sword")).option(X).option(Y).option(T).option(Q),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(Y).option(T).option(Q).option(eb,
t.value?t:g,X),Je=(new Condition$$module$js$nodes(c,"Match vampire 2 sword (wind/water/thunder)")).option(X).option(T).option(Q).option(t.value?t:g,Y),Tc=(new Condition$$module$js$nodes(c,"Speed boots")).option(kc,k),Uc=(new Condition$$module$js$nodes(c,"Climb slopes")).option(Cb).option(I).option(Tc),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Fc).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(xc).option(Ge,I),Vc=(new Condition$$module$js$nodes(c,
"Asina in her room")).option(Kc),Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(Sa).option(Vc).option(hb),Wc=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(Fb,Nc),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(m,Wc,Cb),ka=(new Condition$$module$js$nodes(c,"Cross sea")).option(Wc).option(I),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Kb).option(I).option(Ne),ba=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(F.value?
F:g).option(fb),Xc=(new Condition$$module$js$nodes(c,"Wind magic")).option(y.value?y:g,ba).option(Qa,Ra,ba),Yc=(new Condition$$module$js$nodes(c,"Fire magic")).option(y.value?y:g,ba).option(Za,$a,ba),Zc=(new Condition$$module$js$nodes(c,"Water magic")).option(y.value?y:g,ba).option(y,ba).option(ab,bb,ba),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(y.value?y:g,ba).option(y,ba).option(cb,ba).option(db,ba),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(Bb).option(hb),
Re=(new Condition$$module$js$nodes(c,"Change or glitch")).option(ya).option(hb),Se=(new Condition$$module$js$nodes(c,"Change or glitch or paralysis")).option(ya).option(hb).option(Sa),Mb=(new Condition$$module$js$nodes(c,"Pass shooting statues")).option(yc).option(aa,D.value?D:g).option(fb,lc),Te=(new Condition$$module$js$nodes(c,"Healed dolphin if required")).option(Mc).option(L),$c=(new Condition$$module$js$nodes(c,"Match sword of wind")).option(X).option(t.value?t:g,aa),ad=(new Condition$$module$js$nodes(c,
"Match sword of fire")).option(Y).option(t.value?t:g,aa),bd=(new Condition$$module$js$nodes(c,"Match sword of water")).option(T).option(t.value?t:g,aa),Ue=(new Condition$$module$js$nodes(c,"Match sword of thunder")).option(Q).option(t.value?t:g,aa),Ve=(new Condition$$module$js$nodes(c,"Swamp run possible")).option(aa,Tc).option(aa,Wd).option(aa,fb),We=(new Condition$$module$js$nodes(c,"Insect possible to kill")).option(eb),jb=(new Condition$$module$js$nodes(c,"Travel swamp")).option(eb).option(v.value?
v:g,Ve),Xe=(new Condition$$module$js$nodes(c,"Calmed sea if required")).option(Kb).option(wa),Ye=(new Condition$$module$js$nodes(c,"Started windmill if required")).option(Ta).option(xa),Ze=(new Condition$$module$js$nodes(c,"Telepathy if required for Deo")).option(oa).option(Ud),$e=e(0,"Vampire 1",aa).get(Cb),af=e(1,"Insect",jc,Ie,We).get(Za),bf=e(2,"Kelbesque 1",$c,Xc).get($a),cf=e(12,"Vampire 2",Je).get(ke),cd=e(4,"Sabera 1",ad,Yc).get(qc),df=e(5,"Mado 1",bd,Zc).get(cb),ef=e(6,"Kelbesque 2",$c,Xc).get(Ab),
ff=e(7,"Sabera 2",ad,Yc).get(zb),gf=e(8,"Mado 2",bd,Zc).get(xb),hf=e(9,"Karmine",Ue,Pe).get(Gb),jf=e(10,"Draygon 1",aa).get(ee),kf=e(-1,"Statues",vc,uc),lf=e(11,"Draygon 2",aa,wc),mf=e(13,"Dyna",wb),nf=(new Condition$$module$js$nodes(c,"Opened prison if required")).option(Eb).option(C),fa=new Area$$module$js$nodes(c,"Leaf"),Ga=new Area$$module$js$nodes(c,"Valley of Wind"),ca=new Area$$module$js$nodes(c,"Sealed Cave"),za=new Area$$module$js$nodes(c,"Cordel Plain"),Ha=new Area$$module$js$nodes(c,"Brynmaer"),
Ia=new Area$$module$js$nodes(c,"Amazones"),J=new Area$$module$js$nodes(c,"Mt Sabre West"),z=new Area$$module$js$nodes(c,"Mt Sabre North"),kb=new Area$$module$js$nodes(c,"Nadare's"),Ua=new Area$$module$js$nodes(c,"Oak"),pa=new Area$$module$js$nodes(c,"Waterfall Valley"),H=new Area$$module$js$nodes(c,"Portoa"),qa=new Area$$module$js$nodes(c,"Waterfall Cave"),K=new Area$$module$js$nodes(c,"Fog Lamp Cave"),ra=new Area$$module$js$nodes(c,"Kirisa Plant Cave"),Aa=new Area$$module$js$nodes(c,"Angry Sea"),
sa=new Area$$module$js$nodes(c,"Joel"),P=new Area$$module$js$nodes(c,"Evil Spirit Island"),ta=new Area$$module$js$nodes(c,"Sabera's Castle"),ha=new Area$$module$js$nodes(c,"Swan"),E=new Area$$module$js$nodes(c,"Mt Hydra"),ua=new Area$$module$js$nodes(c,"Shyron"),Ba=new Area$$module$js$nodes(c,"Styx"),Ca=new Area$$module$js$nodes(c,"Goa"),lb=new Area$$module$js$nodes(c,"Draygonia Fortress 1"),ia=new Area$$module$js$nodes(c,"Draygonia Fortress 2"),Ja=new Area$$module$js$nodes(c,"Draygonia Fortress 3"),
W=new Area$$module$js$nodes(c,"Draygonia Fortress 4"),N=new Area$$module$js$nodes(c,"Oasis Cave"),ja=new Area$$module$js$nodes(c,"Sahara"),Ka=new Area$$module$js$nodes(c,"Pyramid Front"),la=new Area$$module$js$nodes(c,"Pyramid Back"),ma=new Area$$module$js$nodes(c,"Tower"),Nb=(new Location$$module$js$nodes(c,0,fa,"Start")).overworld().start(),of=(new Location$$module$js$nodes(c,0,fa,"Mezame Shrine")).overworld().from(Nb),pf=(new Location$$module$js$nodes(c,1,fa,"Outside Start")).overworld().connect(of),
va=(new Location$$module$js$nodes(c,2,fa,"Town")).town().connect(pf),Va=(new Location$$module$js$nodes(c,3,Ga,"Main")).overworld().connect(va).trigger(Bc,Ta),dd=(new Location$$module$js$nodes(c,3,Ga,"Outside Windmill")).overworld(),ed=(new Location$$module$js$nodes(c,4,ca,"Tunnel 1 (entrance)")).cave().from(Va,Ta),qf=(new Location$$module$js$nodes(c,5,ca,"Tunnel 2 (over bridge)")).cave().connect(ed),rf=(new Location$$module$js$nodes(c,6,ca,"Tunnel 6 (herb dead end)")).cave().chest(M,15),fd=(new Location$$module$js$nodes(c,
7,ca,"Tunnel 4a (ball corridor)")).cave().chest(M,20,80).chest(Qa,21);(new Location$$module$js$nodes(c,7,ca,"Tunnel 4b (antidote dead end)")).cave().connect(fd,A).chest(R,19);const sf=(new Location$$module$js$nodes(c,8,ca,"Tunnel 5 (warp boots dead end)")).cave().chest(Z,14),tf=(new Location$$module$js$nodes(c,9,ca,"Tunnel 3a (branch, front)")).cave().connect(qf).connectTo(fd).connectTo(sf),uf=(new Location$$module$js$nodes(c,9,ca,"Tunnel 3b (branch, back)")).cave().connect(tf,A).connectTo(rf),vf=
(new Location$$module$js$nodes(c,10,ca,"Tunnel 7 (boss)")).cave().connect(uf).boss($e),wf=(new Location$$module$js$nodes(c,12,ca,"Tunnel 8a (exit, above wall)")).cave().connect(vf),xf=(new Location$$module$js$nodes(c,12,ca,"Tunnel 8b (exit, below wall")).cave().connect(wf,A);(new Location$$module$js$nodes(c,14,Ga,"Windmill Cave")).cave().connect(Va).connectTo(dd).trigger(le,Db,Hb);(new Location$$module$js$nodes(c,15,Ga,"Windmill")).misc().connect(dd).trigger(Ta,mc);const yf=(new Location$$module$js$nodes(c,
16,Ga,"Zebu's Cave Front")).cave().connect(Va).trigger(Hb,zc,Ac).trigger(Bc,Ta,Hb),zf=(new Location$$module$js$nodes(c,16,Ga,"Zebu's Cave Back")).cave().trigger(Ec).connect(yf,B),Af=(new Location$$module$js$nodes(c,17,J,"Tunnel 1 (to Zebu)")).cave().connect(zf),La=(new Location$$module$js$nodes(c,20,za,"West")).overworld().connect(xf,Ye),Bf=(new Location$$module$js$nodes(c,20,za,"South")).overworld().connect(La,x),gd=(new Location$$module$js$nodes(c,21,za,"East")).overworld().connect(La).chest(ic,
24),Wa=(new Location$$module$js$nodes(c,24,Ha,"Town")).town().connect(La).trigger(me,ic),Cf=(new Location$$module$js$nodes(c,25,za,"Outside Stom's House")).town().connect(La),Ob=(new Location$$module$js$nodes(c,26,za,"Swamp")).overworld().connect(gd,jb).trigger(Ib,Dc,jb);(new Location$$module$js$nodes(c,26,za,"Swamp Insect Area")).overworld().connect(Ob,jb).boss(af);const mb=(new Location$$module$js$nodes(c,27,Ia,"Town")).town().connect(Bf),nb=(new Location$$module$js$nodes(c,28,Ua,"Town")).town().connect(Ob,
jb).trigger(Cc);(new Location$$module$js$nodes(c,30,za,"Stom's House")).house().connect(Cf).trigger(ne,Cc);const Ma=(new Location$$module$js$nodes(c,32,J,"Entrance")).overworld().connect(La).connect(Af),Df=(new Location$$module$js$nodes(c,32,J,"Up Slope")).overworld().from(Ma,Uc).to(Ma),Ef=(new Location$$module$js$nodes(c,32,J,"Dead End (warp boots)")).overworld().chest(Z,24,106),hd=(new Location$$module$js$nodes(c,33,J,"Upper")).overworld().from(Ma,I).to(Ma),Ff=(new Location$$module$js$nodes(c,33,
J,"Tornel Dead End")).overworld().trigger(qe,Qa,Ra).chest(ea,23,105),id=(new Location$$module$js$nodes(c,34,J,"Tunnel 2a (fork at start)")).cave().connect(Ma);(new Location$$module$js$nodes(c,34,J,"Tunnel 2b (left branch to dead end)")).cave().connect(id,B).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,J,"Tunnel 2c (right branch to upper)")).cave().connect(id,B),Hf=(new Location$$module$js$nodes(c,35,J,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(M,23,82),
If=(new Location$$module$js$nodes(c,35,J,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,B).connectTo(hd),jd=(new Location$$module$js$nodes(c,36,J,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,J,"Tunnel 4b (out to upper)")).cave().connect(jd,B).connectTo(hd);const Jf=(new Location$$module$js$nodes(c,37,J,"Tunnel 5 (tiny connector)")).cave().connect(jd),Kf=(new Location$$module$js$nodes(c,38,J,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);
(new Location$$module$js$nodes(c,38,J,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,B).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,J,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,J,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,B);(new Location$$module$js$nodes(c,39,J,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,B).chest(Ra,25);const ob=(new Location$$module$js$nodes(c,40,z,"Entrance")).overworld().connect(gd,
Le,Ke),pb=(new Location$$module$js$nodes(c,40,z,"Upper")).overworld().from(ob,I).to(ob),Pb=(new Location$$module$js$nodes(c,40,z,"Summit (boss)")).overworld().from(pb,I).to(pb).boss(bf),kd=(new Location$$module$js$nodes(c,41,z,"Connector")).overworld(),Qb=(new Location$$module$js$nodes(c,41,z,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,z,"Middle Right")).overworld().from(Qb,Uc).to(Qb),ld=(new Location$$module$js$nodes(c,42,z,"Tunnel 2a (from entrance to connector)")).cave().connectTo(kd);
(new Location$$module$js$nodes(c,42,z,"Tunnel 2b (under bridge, to antidote)")).cave().connect(ld,B).chest(R,23,94);const md=(new Location$$module$js$nodes(c,43,z,"Tunnel 3a (branch after connector)")).cave().connect(kd),Of=(new Location$$module$js$nodes(c,43,z,"Tunnel 3b (right branch)")).cave().connect(md,B),Pf=(new Location$$module$js$nodes(c,43,z,"Tunnel 3c (upper branch)")).cave().connect(md,B);(new Location$$module$js$nodes(c,44,z,"Tunnel 4 (over bridge, to middle)")).cave().connect(Pf).connectTo(Qb);
const nd=(new Location$$module$js$nodes(c,45,z,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Of).connectTo(Nf);(new Location$$module$js$nodes(c,45,z,"Tunnel 5b (dead-end with herb)")).cave().connect(nd,B).chest(M,22,83);const Qf=(new Location$$module$js$nodes(c,46,z,"Tunne; 6a (S-shaped hall, right)")).cave().connect(nd),Rf=(new Location$$module$js$nodes(c,46,z,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Qf,B),Sf=(new Location$$module$js$nodes(c,46,z,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Rf,
B),od=(new Location$$module$js$nodes(c,47,z,"Prison (hallway)")).cave().connect(pb),Tf=(new Location$$module$js$nodes(c,48,z,"Left Cell (shopkeepers)")).cave().from(od,B);(new Location$$module$js$nodes(c,49,z,"Left Cell 2 (back, with prison key)")).cave().from(Tf,B).chest(Eb,13);const Uf=(new Location$$module$js$nodes(c,50,z,"Right Cell (villagers)")).cave().from(od,B),Vf=(new Location$$module$js$nodes(c,51,z,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Uf,B);(new Location$$module$js$nodes(c,
52,z,"Tunnel 9 (connector to summit)")).cave().connect(Vf).connectTo(Pb);const Wf=(new Location$$module$js$nodes(c,53,z,"Summit Cave (front)")).cave().from(Pb,Eb).to(Pb),Xf=(new Location$$module$js$nodes(c,53,z,"Summit Cave (behind ice)")).cave().connect(Wf,B).trigger(re);(new Location$$module$js$nodes(c,56,z,"Tunnel 1 (leads from main entrance)")).cave().connect(ob).connectTo(ld);(new Location$$module$js$nodes(c,57,z,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(pb);const Yf=(new Location$$module$js$nodes(c,
60,kb,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,kb,"Tool Shop")).shop(M,R,U,Z),$f=(new Location$$module$js$nodes(c,62,kb,"Back Room")).house(),Rb=(new Location$$module$js$nodes(c,64,pa,"Summit")).overworld().connect(Xf,nf),qb=(new Location$$module$js$nodes(c,64,pa,"Northwest")).overworld().from(Rb).to(Rb,I),ag=(new Location$$module$js$nodes(c,64,pa,"Northeast")).overworld().connect(qb,x),pd=(new Location$$module$js$nodes(c,65,pa,"Southwest")).overworld().connect(qb),bg=(new Location$$module$js$nodes(c,
65,pa,"Southeast")).overworld().connect(pd,x),qd=(new Location$$module$js$nodes(c,66,pa,"Lime Tree Valley")).overworld().connect(pd).connect(Va,Vd),cg=(new Location$$module$js$nodes(c,67,pa,"Lime Tree Lake (Rage)")).cave().connect(qd).trigger(Jc,T),dg=(new Location$$module$js$nodes(c,68,ra,"Tunnel 1a (entrance)")).cave().connect(bg),eg=(new Location$$module$js$nodes(c,68,ra,"Tunnel 1b (behind wall)")).cave().connect(dg,A),rd=(new Location$$module$js$nodes(c,69,ra,"Tunnel 2a (main path, before wall)")).cave().connect(eg);
(new Location$$module$js$nodes(c,69,ra,"Tunnel 2b (dead end, antidote)")).cave().connect(rd,A).chest(R,25,95);const fg=(new Location$$module$js$nodes(c,69,ra,"Tunnel 2c (main path, after wall)")).cave().connect(rd,A),gg=(new Location$$module$js$nodes(c,70,ra,"Tunnel 3a (last room, before wall)")).cave().connect(fg),hg=(new Location$$module$js$nodes(c,70,ra,"Tunnel 3b (last room, after wall)")).cave().connect(gg,A);(new Location$$module$js$nodes(c,71,ra,"Meadow")).overworld().connect(hg).chest(tc,
14);const ig=(new Location$$module$js$nodes(c,72,K,"Tunnel 1a (entrance)")).cave().connect(ag),sd=(new Location$$module$js$nodes(c,72,K,"Tunnel 1b (past wall)")).cave().connect(ig,A);(new Location$$module$js$nodes(c,72,K,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(sd,A).chest(Ea,24);const jg=(new Location$$module$js$nodes(c,73,K,"Tunnel 2 (tiny connector)")).cave().connect(sd),td=(new Location$$module$js$nodes(c,74,K,"Tunnel 3a (upper branch)")).cave().connect(jg);(new Location$$module$js$nodes(c,
74,K,"Tunnel 3b (dead end, mimic)")).cave().connect(td,A).chest(V,21,112);const ud=(new Location$$module$js$nodes(c,74,K,"Tunnel 3c (short passage with mimic)")).cave().connect(td,A).chest(V,22,113),kg=(new Location$$module$js$nodes(c,74,K,"Tunnel 3d (lower branch)")).cave().connect(ud,A);(new Location$$module$js$nodes(c,75,K,"Dead end loop")).cave().connect(kg);const vd=(new Location$$module$js$nodes(c,76,K,"Tunnel 4a (right branch over bridge)")).cave().connect(ud),lg=(new Location$$module$js$nodes(c,
76,K,"Tunnel 4b (past wall over bridge)")).cave().connect(vd,A),mg=(new Location$$module$js$nodes(c,77,K,"Tunnel 5a (from left branch)")).cave().connect(vd),ng=(new Location$$module$js$nodes(c,77,K,"Tunnel 5b (reconvergence)")).cave().connect(mg,A).connect(lg),og=(new Location$$module$js$nodes(c,77,K,"Tunnel 5c (between walls)")).cave().connect(ng,A),pg=(new Location$$module$js$nodes(c,77,K,"Tunnel 5d (under bridge)")).cave().connect(og,A),qg=(new Location$$module$js$nodes(c,78,K,"Tunnel 6a (over second bridge)")).cave().connect(pg),
rg=(new Location$$module$js$nodes(c,78,K,"Tunnel 6b (past wall)")).cave().connect(qg,A),sg=(new Location$$module$js$nodes(c,79,K,"Tunnel 7a (under second bridge)")).cave().connect(rg);(new Location$$module$js$nodes(c,79,K,"Tunnel 7b (fog lamp)")).cave().connect(sg,A).chest(oc,19);const Da=(new Location$$module$js$nodes(c,80,H,"Town")).town().connect(qb),wd=(new Location$$module$js$nodes(c,81,H,"Fishherman Island")).town().connect(Da);(new Location$$module$js$nodes(c,82,pa,"Mesia Shrine")).cave().trigger(Kc).connect(cg,
x,Jc);const xd=(new Location$$module$js$nodes(c,84,qa,"Tunnel 1a (entrance)")).cave().connect(qb);(new Location$$module$js$nodes(c,84,qa,"Tunnel 1b (dead end, mimic)")).cave().connect(xd,B).chest(V,19,114);const tg=(new Location$$module$js$nodes(c,84,qa,"Tunnel 1c (past ice)")).cave().connect(xd,B),ug=(new Location$$module$js$nodes(c,85,qa,"Tunnel 2 (stoned pair)")).cave().connect(tg),Sb=(new Location$$module$js$nodes(c,86,qa,"Tunnel 3 (wide medusa hallways)")).cave().connect(ug,Qe),vg=(new Location$$module$js$nodes(c,
87,qa,"Tunnel 4a (left entrance)")).cave().from(Sb,B).chest(ec.chest().bonus(),25).trigger(te,Bb);(new Location$$module$js$nodes(c,87,qa,"Tunnel 4b (right entrance)")).cave().from(Sb,B).connect(vg,I);(new Location$$module$js$nodes(c,87,qa,"Tunnel 4c (sword of water)")).cave().connect(Sb,B).chest(T,24);const yd=(new Location$$module$js$nodes(c,88,ma,"Entrance")).misc(),wg=(new Location$$module$js$nodes(c,89,ma,"Level 1")).misc().from(yd),xg=(new Location$$module$js$nodes(c,90,ma,"Level 2")).misc().from(wg),
yg=(new Location$$module$js$nodes(c,91,ma,"Level 3")).misc().from(xg),zd=(new Location$$module$js$nodes(c,92,ma,"Outside Mesia Room")).misc().from(yg),zg=(new Location$$module$js$nodes(c,93,ma,"Outside Dyna Room")).misc().from(zd,wb);(new Location$$module$js$nodes(c,94,ma,"Mesia")).misc().connect(zd).trigger(Ee);const Ag=(new Location$$module$js$nodes(c,95,ma,"Dyna")).misc().from(zg).boss(mf);(new Location$$module$js$nodes(c,95,ma,"Win")).misc().from(Ag).end();const Tb=(new Location$$module$js$nodes(c,
96,Aa,"Cabin Beach")).sea().from(wd,Jb),Na=(new Location$$module$js$nodes(c,96,Aa,"South")).sea().connect(Tb,ka),Bg=(new Location$$module$js$nodes(c,96,Aa,"Joel Beach")).sea().connect(Na,ka),Ad=(new Location$$module$js$nodes(c,96,sa,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(c,96,Aa,"Altar")).sea().connect(Na,ka).trigger(Kb,rc,qc);const Cg=(new Location$$module$js$nodes(c,96,Aa,"North")).sea().to(Na,ka).from(Na,ka,Oe).trigger(we,Xe),Dg=(new Location$$module$js$nodes(c,96,Aa,"Swan Beach")).sea().connect(Cg,
ka);(new Location$$module$js$nodes(c,97,Aa,"Cabin")).misc().connect(Tb).trigger(Nc,Jb);(new Location$$module$js$nodes(c,98,sa,"Lighthouse")).misc().connect(Ad).trigger(ve,Db);const rb=(new Location$$module$js$nodes(c,100,H,"Underground Channel 1 (from throne room)")).sea().trigger(Ic),Eg=(new Location$$module$js$nodes(c,100,H,"Underground Channel 2 (to fortune teller)")).sea().connect(rb,x),Bd=(new Location$$module$js$nodes(c,100,H,"Underground Channel 3 (from fortune teller)")).sea().connect(rb,
I),Cd=(new Location$$module$js$nodes(c,100,H,"Underground Channel 4 (asina)")).sea().connect(Bd,x),Fg=(new Location$$module$js$nodes(c,100,H,"Underground Channel 5 (dolphin)")).sea().connect(Cd,x).trigger(Mc,M,Lc);(new Location$$module$js$nodes(c,100,H,"Underground Channel 6 (water)")).sea().connect(Fg,ka).connectTo(Na,ka).chest(sc,17);const Ub=(new Location$$module$js$nodes(c,101,P,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,P,"Tunnel 1 (entrance)")).sea().connect(Na,Oc,ka),Dd=
(new Location$$module$js$nodes(c,105,P,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,P,"Tunnel 2b (dead end to left)")).cave().connect(Dd,x);const Hg=(new Location$$module$js$nodes(c,105,P,"Tunnel 2c (across first river)")).cave().connect(Dd,x),Ed=(new Location$$module$js$nodes(c,105,P,"Tunnel 2d (across second river)")).cave().connect(Hg,x);(new Location$$module$js$nodes(c,105,P,"Tunnel 2e (dead end, magic ring)")).cave().connect(Ed,A).chest(ea,29);const Ig=(new Location$$module$js$nodes(c,
105,P,"Tunnel 2f (stair down)")).cave().connect(Ed,A),Jg=(new Location$$module$js$nodes(c,106,P,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(Ub).chest(Ea,25,92),Kg=(new Location$$module$js$nodes(c,106,P,"Tunnel 3b (left area toward items)")).cave().connect(Jg,A),Lg=(new Location$$module$js$nodes(c,107,P,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(V,14,115);(new Location$$module$js$nodes(c,107,P,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,x).chest(he,15);const Vb=
(new Location$$module$js$nodes(c,108,ta,"Floor 1")).fortress().connect(Ub),Mg=(new Location$$module$js$nodes(c,108,ta,"Miniboss")).fortress().boss(cf).connect(Vb);(new Location$$module$js$nodes(c,109,ta,"Floor 2a (left stair)")).fortress().connect(Vb).chest(U,19);const Ng=(new Location$$module$js$nodes(c,109,ta,"Floor 2b (right stair)")).fortress().connect(Mg).chest(M,30,85),Og=(new Location$$module$js$nodes(c,110,ta,"Floor 3a (toward boss)")).fortress().connect(Ng),Fd=(new Location$$module$js$nodes(c,
110,ta,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$js$nodes(c,110,ta,"Boss")).fortress().boss(cd).connect(Fd);(new Location$$module$js$nodes(c,110,ta,"Floor 3c (back room trap)")).fortress().from(Fd).to(Vb);const Pg=(new Location$$module$js$nodes(c,112,sa,"Secret Passage")).cave().connectTo(Ad),sb=(new Location$$module$js$nodes(c,113,sa,"Town")).town().connect(Bg),na=(new Location$$module$js$nodes(c,114,ha,"Town")).town().connect(Dg),Qg=(new Location$$module$js$nodes(c,115,
ha,"Inside Gate")).overworld().connect(na),Rg=(new Location$$module$js$nodes(c,115,ha,"Outside Gate")).overworld().from(Qg,ya),tb=(new Location$$module$js$nodes(c,120,Ca,"Valley")).overworld().connect(Rg),Wb=(new Location$$module$js$nodes(c,124,E,"Entrance")).overworld().connect(tb),Sg=(new Location$$module$js$nodes(c,124,E,"Over first river toward Shyron")).overworld().connect(Wb,x),Gd=(new Location$$module$js$nodes(c,124,E,"After first tunnel")).overworld(),Hd=(new Location$$module$js$nodes(c,124,
E,"Door to Styx")).overworld().connect(Gd,x),Tg=(new Location$$module$js$nodes(c,124,E,"Dead end (no item)")).overworld(),Ug=(new Location$$module$js$nodes(c,124,E,"Dead end (fruit of lime)")).overworld().chest(yb,26),Vg=(new Location$$module$js$nodes(c,124,E,"Dead end (magic ring)")).overworld().chest(ea,25,101),Id=(new Location$$module$js$nodes(c,124,E,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(c,124,E,"Floating island (bow of sun)")).overworld().connect(Id,I).chest(vc,
24);const Wg=(new Location$$module$js$nodes(c,125,E,"Tunnel 1 (to Shyron)")).cave().connect(Sg),Xg=(new Location$$module$js$nodes(c,126,E,"Outside Shyron")).overworld().connect(Wg);(new Location$$module$js$nodes(c,127,E,"Tunnel 2 (fork)")).cave().connect(Wb).connectTo(Ug).connectTo(Gd);const Jd=(new Location$$module$js$nodes(c,128,E,"Tunnel 3 (caves)")).cave().connect(Hd).connect(Tg),Kd=(new Location$$module$js$nodes(c,129,E,"Tunnel 4 (left branch of cave)")).cave().connect(Jd);(new Location$$module$js$nodes(c,
130,E,"Tunnel 5 (dead end, medical herb)")).cave().connect(Kd).chest(M,15,86);const Yg=(new Location$$module$js$nodes(c,131,E,"Tunnel 6a (left-then-right)")).cave().connect(Kd),Zg=(new Location$$module$js$nodes(c,131,E,"Tunnel 6b (past wall)")).cave().connect(Yg,A),$g=(new Location$$module$js$nodes(c,132,E,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,E,"Tunnel 8 (red slimes)")).cave().from($g,A).connectTo(Id).chest(V,23,116);const ah=(new Location$$module$js$nodes(c,
134,E,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Jd),bh=(new Location$$module$js$nodes(c,135,E,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,135,E,"Tunnel 10b (past wall)")).cave().connect(bh,A).connectTo(Vg);const Ld=(new Location$$module$js$nodes(c,136,Ba,"Entrance")).fortress().from(Hd,nc,Mb),ch=(new Location$$module$js$nodes(c,137,Ba,"Left branch")).fortress().connect(Ld).chest(V,19,117),dh=(new Location$$module$js$nodes(c,137,Ba,"Left branch, past one bridge")).fortress().connect(ch,
x),eh=(new Location$$module$js$nodes(c,137,Ba,"Left branch, past two bridges")).fortress().connect(dh,x).chest(M,29,87),fh=(new Location$$module$js$nodes(c,137,Ba,"Right branch")).fortress().connect(Ld);(new Location$$module$js$nodes(c,137,Ba,"Right branch, across water")).fortress().connect(fh,I).chest(V,20,118).chest(V,21,119).chest(Zd,28);(new Location$$module$js$nodes(c,138,Ba,"Upper floor")).fortress().connect(eh).chest(Q,27);const Oa=(new Location$$module$js$nodes(c,140,ua,"Town")).town().connect(Xg,
Re).trigger(Lb),Xa=(new Location$$module$js$nodes(c,142,Ca,"Town")).town().connect(tb),Md=(new Location$$module$js$nodes(c,143,N,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,N,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Md,Fa).chest(fe,15);const Xb=(new Location$$module$js$nodes(c,144,Ca,"Desert 1")).overworld().connect(tb),ub=(new Location$$module$js$nodes(c,145,N,"Area 1 (from entrance)")).cave().chest(kc,26),Nd=(new Location$$module$js$nodes(c,
145,N,"Area 2 (across top bridge)")).cave().connect(ub,x);(new Location$$module$js$nodes(c,145,N,"Area 3 (dead-end across top-right bridge)")).cave().connect(Nd,x);const gh=(new Location$$module$js$nodes(c,145,N,"Area 4 (left across middle-right bridge)")).cave().connect(Nd,x),hh=(new Location$$module$js$nodes(c,145,N,"Area 5 (bottom edge)")).cave().connect(gh,x),ih=(new Location$$module$js$nodes(c,145,N,"Area 6 (bottom island)")).cave().connect(hh,x),jh=(new Location$$module$js$nodes(c,145,N,"Area 7 (bottom inner ring)")).cave().connect(ih,
x),kh=(new Location$$module$js$nodes(c,145,N,"Area 8 (left outer ring)")).cave().connect(jh,x).connect(ub,x).chest(U,27,100),lh=(new Location$$module$js$nodes(c,145,N,"Area 9 (top left inner ring)")).cave().connect(kh,x),mh=(new Location$$module$js$nodes(c,145,N,"Area 10 (top right inner ring)")).cave().connect(lh,x);(new Location$$module$js$nodes(c,145,N,"Area 11 (center)")).cave().connect(mh,x).connectTo(Md);(new Location$$module$js$nodes(c,145,N,"Area 12 (top center islands)")).cave().connect(ub,
I).chest(de,28);const nh=(new Location$$module$js$nodes(c,146,ja,"Desert Cave 1")).cave().connect(Xb,I),Pa=(new Location$$module$js$nodes(c,147,ja,"Town")).town(),oh=(new Location$$module$js$nodes(c,148,ja,"Outside Cave")).overworld().connect(Pa),ph=(new Location$$module$js$nodes(c,149,ja,"Desert Cave 2")).cave().connect(oh);(new Location$$module$js$nodes(c,150,ja,"Meadow")).overworld().connect(nh).connectTo(Pa).trigger(Be,ya,Ze);const Yb=(new Location$$module$js$nodes(c,152,ja,"Desert 2")).overworld().connect(ph),
qh=(new Location$$module$js$nodes(c,156,Ka,"Entrance")).fortress().connect(Yb,I),rh=(new Location$$module$js$nodes(c,156,Ka,"Azteca")).fortress().trigger(De),sh=(new Location$$module$js$nodes(c,157,Ka,"Fork")).fortress().connect(qh),Od=(new Location$$module$js$nodes(c,158,Ka,"Main")).fortress().connect(sh);(new Location$$module$js$nodes(c,158,Ka,"Treasure Chest (magic ring)")).fortress().connect(Od).chest(ea,27,108);(new Location$$module$js$nodes(c,159,Ka,"Draygon")).fortress().connect(Od).to(rh).boss(jf);
const th=(new Location$$module$js$nodes(c,160,la,"Entrance")).fortress().connect(Yb,I),uh=(new Location$$module$js$nodes(c,160,la,"Statues")).fortress().connect(th).boss(kf),vh=(new Location$$module$js$nodes(c,161,la,"Hall 1")).fortress().connect(uh),Zb=(new Location$$module$js$nodes(c,162,la,"Branch")).fortress().connect(vh);(new Location$$module$js$nodes(c,163,la,"Left Dead End")).fortress().connect(Zb).chest(V,13,120);(new Location$$module$js$nodes(c,164,la,"Right Dead End")).fortress().connect(Zb);
const wh=(new Location$$module$js$nodes(c,165,la,"Hall 2")).fortress().connect(Zb).chest(Ab,26,109),xh=(new Location$$module$js$nodes(c,166,la,"Draygon 2")).fortress().connect(wh).boss(lf);(new Location$$module$js$nodes(c,167,la,"Teleporter")).fortress().from(xh).to(yd);const Pd=(new Location$$module$js$nodes(c,168,lb,"Entrance")).fortress().connect(Xa,Mb).trigger(Sc,Q),yh=(new Location$$module$js$nodes(c,169,lb,"Main")).fortress().from(Pd,Fa),zh=(new Location$$module$js$nodes(c,169,lb,"Boss")).fortress().connect(yh).boss(ef),
Ah=(new Location$$module$js$nodes(c,170,lb,"Zebu")).fortress().connect(zh),vb=(new Location$$module$js$nodes(c,171,ia,"Entrance")).fortress().connect(Ah);(new Location$$module$js$nodes(c,171,ia,"Dead End Behind Iron (fruit of power)")).fortress().connect(vb,Fa).chest(U,28,98);(new Location$$module$js$nodes(c,171,ia,"Dead End Loop Across Closer Bridges")).fortress().connect(vb,x).connect(vb,x);const Bh=(new Location$$module$js$nodes(c,171,ia,"Across First Bridge (fruit of repun)")).fortress().connect(vb,
x).chest(zb,30,102),$b=(new Location$$module$js$nodes(c,171,ia,"Across Second Bridge")).fortress().connect(Bh,x);(new Location$$module$js$nodes(c,171,ia,"Dead End Across Two Bridges ()")).fortress().connect($b,x).connect($b,x).chest(Ea,29,93);const Ch=(new Location$$module$js$nodes(c,171,ia,"Across Third Bridge")).fortress().connect($b,x),Dh=(new Location$$module$js$nodes(c,171,ia,"Exit Behind Iron Door")).fortress().connect(Ch,Fa),Eh=(new Location$$module$js$nodes(c,172,ia,"Boss")).fortress().connect(Dh).boss(ff),
Fh=(new Location$$module$js$nodes(c,172,ia,"Tornel")).fortress().connect(Eh),Qd=(new Location$$module$js$nodes(c,173,Ja,"Lower")).fortress().connect(Fh).chest(Ab,26,99).chest(ea,27,111),Gh=(new Location$$module$js$nodes(c,174,Ja,"Upper Loop")).fortress().connect(Qd).chest(R,22,96);(new Location$$module$js$nodes(c,174,Ja,"Upper Loop Behind Wall (magic ring)")).fortress().connect(Gh,Fa).chest(ea,23,107);const Hh=(new Location$$module$js$nodes(c,175,Ja,"Upper Passage (toward Mado)")).fortress().connect(Qd).chest(ea,
27,84),ac=(new Location$$module$js$nodes(c,176,W,"Initial Fork")).fortress(),Ih=(new Location$$module$js$nodes(c,177,W,"Left Branch")).fortress().connect(ac),Rd=(new Location$$module$js$nodes(c,178,W,"Main Area (right branch, over bridges)")).fortress().connect(ac),Jh=(new Location$$module$js$nodes(c,179,W,"U-shaped Passage (between floors)")).fortress().connect(Rd),Kh=(new Location$$module$js$nodes(c,180,W,"Main Area Lower (under bridge)")).fortress().connect(Ih).connect(Rd).connect(Jh),Sd=(new Location$$module$js$nodes(c,
180,W,"Behind Iron Wall")).fortress().connect(Kh,Fa),Lh=(new Location$$module$js$nodes(c,181,W,"Lower")).fortress().connect(Sd).chest(V,13,121).chest(V,14,122).chest(V,15,123).chest(ea,23,88).chest(Z,24,110),Mh=(new Location$$module$js$nodes(c,182,W,"Boss Corridor")).fortress().connect(Lh),Nh=(new Location$$module$js$nodes(c,182,W,"Boss")).fortress().connect(Mh,Mb).boss(hf);(new Location$$module$js$nodes(c,182,W,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(db,18);const Td=(new Location$$module$js$nodes(c,
183,W,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,184,N,"Entrance Back (behind river)")).cave().connect(Td).chest(U,13,90);(new Location$$module$js$nodes(c,184,N,"Entrance Front")).cave().connect(Oh,I).connectTo(Xb).connectTo(ub);const Ph=(new Location$$module$js$nodes(c,185,Ja,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$js$nodes(c,185,Ja,"Asina")).fortress().connect(Ph).connectTo(ac);(new Location$$module$js$nodes(c,186,W,"Kensu")).fortress().connect(Sd).connectTo(Td).trigger(Ae,
Gb);(new Location$$module$js$nodes(c,187,Ca,"House")).house().connect(Xa).trigger(Ce,ya,Gb);(new Location$$module$js$nodes(c,188,Ca,"Inn")).shop().connect(Xa,Lb);(new Location$$module$js$nodes(c,190,Ca,"Tool Shop")).shop(M,R,Z,U).connect(Xa,Lb);(new Location$$module$js$nodes(c,191,Ca,"Tavern")).shop().connect(Xa);(new Location$$module$js$nodes(c,192,fa,"Elder House")).house().connect(va).trigger(zc);(new Location$$module$js$nodes(c,193,fa,"Rabbit Hut")).house().connect(va).trigger(Fc,Ec,oa);(new Location$$module$js$nodes(c,
194,fa,"Inn")).shop().connect(va);(new Location$$module$js$nodes(c,195,fa,"Tool Shop")).shop(M,R,Z,U).connect(va);(new Location$$module$js$nodes(c,196,fa,"Armor Shop")).shop($d,cc).connect(va);(new Location$$module$js$nodes(c,197,fa,"Student House")).house().connect(va).trigger(Ac);(new Location$$module$js$nodes(c,198,Ha,"Tavern")).house().connect(Wa);(new Location$$module$js$nodes(c,199,Ha,"Pawn Shop")).shop().connect(Wa);(new Location$$module$js$nodes(c,200,Ha,"Inn")).shop().connect(Wa);(new Location$$module$js$nodes(c,
201,Ha,"Armor Shop")).shop(ae,cc,Xd).connect(Wa);(new Location$$module$js$nodes(c,203,Ha,"Tool Shop")).shop(M,R,Z).connect(Wa);(new Location$$module$js$nodes(c,205,Ua,"Elder House")).house().from(nb,oa).trigger(pe,Ib);(new Location$$module$js$nodes(c,206,Ua,"Mother's House")).house().from(nb,oa).trigger(Dc,oa).trigger(oe,Ib);(new Location$$module$js$nodes(c,207,Ua,"Tool Shop")).shop(M,R,U).from(nb,oa);(new Location$$module$js$nodes(c,208,Ua,"Inn")).shop().from(nb,oa);(new Location$$module$js$nodes(c,
209,Ia,"Inn")).shop().connect(mb);(new Location$$module$js$nodes(c,210,Ia,"Tool Shop")).shop(Z,U,Ea).connect(mb);(new Location$$module$js$nodes(c,211,Ia,"Armor Shop")).shop(gc,dc,ec,xb).connect(mb);const Qh=(new Location$$module$js$nodes(c,212,Ia,"Queen's House")).house().from(mb,Se).trigger(ye,ya,tc);(new Location$$module$js$nodes(c,213,kb,"Nadare's")).house().connect(ob).connectTo(Yf).connectTo(Zf).connectTo($f);(new Location$$module$js$nodes(c,214,H,"Fisherman's House")).house().connect(wd).trigger(Jb,
oc,Fb,Te);const bc=(new Location$$module$js$nodes(c,215,H,"Palace Entrance")).house().connect(Da);(new Location$$module$js$nodes(c,216,H,"Fortune Teller Front")).house().connect(Da).trigger(Hc,Gc);(new Location$$module$js$nodes(c,216,H,"Fortune Teller Back")).house().connect(Eg).connect(Bd);(new Location$$module$js$nodes(c,217,H,"Pawn Shop")).shop().connect(Da);(new Location$$module$js$nodes(c,218,H,"Armor Shop")).shop(be,gc,dc).connect(Da);(new Location$$module$js$nodes(c,220,H,"Inn")).shop().connect(Da);
(new Location$$module$js$nodes(c,221,H,"Tool Shop")).shop(M,Ea,yb,Z).connect(Da);(new Location$$module$js$nodes(c,222,H,"Palace Left")).house().connect(bc);(new Location$$module$js$nodes(c,223,H,"Palace Throne Room")).house().connect(bc).to(rb,Me).from(rb).trigger(Gc).trigger(se,Hc,Ic);(new Location$$module$js$nodes(c,224,H,"Palace Right")).house().connect(bc);(new Location$$module$js$nodes(c,225,H,"Asina's Room")).house().connect(Cd).trigger(Lc,Vc);(new Location$$module$js$nodes(c,226,Ia,"Queen Downstairs")).house().connect(Qh).chest(bb,
13);(new Location$$module$js$nodes(c,227,sa,"Elder's House")).house().connect(sb).trigger(Oc);(new Location$$module$js$nodes(c,228,sa,"Shed")).house().connect(sb).to(Pg,pc);(new Location$$module$js$nodes(c,229,sa,"Tool Shop")).shop(M,R,U,Ea).connect(sb);(new Location$$module$js$nodes(c,231,sa,"Inn")).shop().connect(sb);const Rh=(new Location$$module$js$nodes(c,232,P,"Zombie Town House")).house().connect(Ub);(new Location$$module$js$nodes(c,233,P,"Zombie Town Basement")).house().connect(Rh).trigger(ue,
cd);(new Location$$module$js$nodes(c,235,ha,"Tool Shop")).shop(M,R,U,Z).connect(na);(new Location$$module$js$nodes(c,236,ha,"Stom's Hut")).house().connect(na).trigger(Pc);(new Location$$module$js$nodes(c,237,ha,"Inn")).shop().connect(na);(new Location$$module$js$nodes(c,238,ha,"Armor Shop")).shop(ce,hc,Yd,fc).connect(na);(new Location$$module$js$nodes(c,239,ha,"Tavern")).house().connect(na).trigger(Qc,Pc,Sa);(new Location$$module$js$nodes(c,240,ha,"Pawn Shop")).shop().connect(na);(new Location$$module$js$nodes(c,
241,ha,"Dance Hall")).house().connect(na).trigger(Rc,Qc,Sa).trigger(xe,Rc,sc);const Sh=(new Location$$module$js$nodes(c,242,ua,"Temple (pre-massacre)")).fortress().connect(Oa).from(Nb,Q,da).trigger(ze);(new Location$$module$js$nodes(c,242,ua,"Temple (post-massacre)")).fortress().from(Sh,Sc).boss(df);(new Location$$module$js$nodes(c,243,ua,"Training Hall")).house().connect(Oa);(new Location$$module$js$nodes(c,244,ua,"Hospital")).house().connect(Oa);(new Location$$module$js$nodes(c,245,ua,"Armor Shop")).shop(hc,
xb,fc).connect(Oa);(new Location$$module$js$nodes(c,246,ua,"Tool Shop")).shop(M,R,yb,ea).connect(Oa);(new Location$$module$js$nodes(c,247,ua,"Inn")).shop().connect(Oa);(new Location$$module$js$nodes(c,248,ja,"Inn")).shop().connect(Pa);(new Location$$module$js$nodes(c,249,ja,"Tool Shop")).shop(R,Z,zb,ea).connect(Pa);(new Location$$module$js$nodes(c,250,ja,"Elder's House")).house().connect(Pa);(new Location$$module$js$nodes(c,251,ja,"Pawn Shop")).house().connect(Pa);const Th=[va,Va,ed,La,Ob,Ma,Rb,qd,
Tb,na,tb,Wb,Xb,Pd,Yb];for(const a of Th)a.from(Nb,He);return c},shuffle$$module$js$depgraph=(a,b,c,d,e)=>{d=void 0===d?new FlagSet$$module$js$flagset("Sbkm Sct"):d;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d,a);d.shuffleShops()&&f.shuffleShops(b);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&k.slots){var m=k.slotType[0];(h[m]=h[m]||[]).push(k)}k=
[];m=[];var l={};for(var n of d.get("S")){var p=[];for(var q of n){l[q]=!0;for(var r of h[q])p.push(r),m.push([r,k.length])}k.push(p)}for(var w of"bc")if(l[w])for(n=h[w],q=n.map((a)=>[a.item,a.itemIndex]),b.shuffle(q),r=0;r<n.length;r++)n[r].set(q[r][0],q[r][1]);p=(a)=>g.find((b)=>b.vanillaItemName===a);h=p("Sword of Wind");w=p("Sword of Fire");n=p("Ball of Wind");q=p("Ball of Fire");r=p("Statue of Onyx");p=p("Gas Mask");l.k&&b.nextInt(2)&&(w.swap(h),q.swap(n));l.k&&!b.nextInt(3)&&r.swap(p);l=[1,
1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(w=0;1E3>w;w++){e&&0===w%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));b.shuffle(m);for(var u of k)b.shuffle(u);n=k.map(()=>-1);q=l[b.nextInt(l.length)];r=[];p=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<q;a++){const [b,c]=m[a],d=k[c][++n[c]];p(b,d)&&(b.swap(d),r.push([b,d]))}if(!r.length)continue;
const {win:a,path:c}=f.traverse({wanted:g,dfs:!1});if(a)h=c;else for(;r.length;){const [a,b]=r.pop();a.swap(b)}}a&&f.write();if(c){c.items=[];c.route=[];for(const a of h){const [b,d]=a;c.route.push(d);u=f.nodes[b];u instanceof Slot$$module$js$nodes&&!u.isFixed()&&null!=u.slotName&&(k=u.slotName,0>k.indexOf(u.vanillaItemName)&&(k+=` (normally ${u.vanillaItemName})`),c.items.push({itemIndex:u.itemIndex,itemName:u.item.name,origName:u.vanillaItemName,slotIndex:u.slotIndex,slotName:u.slotName,text:`${u.item.name}: ${k}`}))}}})},
shuffle2$$module$js$depgraph=(a,b,c,d,e)=>{d=void 0===d?new FlagSet$$module$js$flagset("Sbkm Sct"):d;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d,a);d.shuffleShops()&&f.shuffleShops(b);const g=f.integrate();e&&e.addTasks(1E3);for(let h=0;1E3>h;h++){if(yield shuffle3$$module$js$depgraph(f,g,a,b,c,d,e)){console.log(`success after ${h} attempts`);return}e&&(e.addCompleted(1),0===h%50&&(yield new Promise(requestAnimationFrame)))}return shuffle$$module$js$depgraph(a,
b,c,d,e)})},shuffle3$$module$js$depgraph=(a,b,c,d,e,f,g)=>{f=void 0===f?new FlagSet$$module$js$flagset("Sbkm Sct"):f;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const g=e&&e.stats;var k=a.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&!a.isFixed());const m=new Map(d.shuffle(k.map((a)=>[a,[a.item,a.itemIndex]]))),l=new Set(d.shuffle(k)),n=new Map,p={};g&&g.seeds++;f.get("S").forEach((a,b)=>{for(const c of a)p[c]=b});for(var q of l)n.set(q.item,q);const r=new Set,
w=(a,b)=>{if(null==p[a.slotType?a.slotType[0]:"c"])return a===b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!==b.item.inventoryRow&&a.requiresUnique||"armor"===b.item.inventoryRow&&!a.isChest())return!1;if(f.guaranteeSword()){if(0===a.slotIndex)return 4>b.item.id;if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return p[a.slotType?a.slotType[0]:"c"]===p[b.slotType?b.slotType[0]:"c"]};q=b.assumedFill(d,(a,b)=>w(a,n.get(b)));if(null==q){g&&g.endState.key++;return!1;throw Error("Could not fill!");
}const u=new Map;for(var G=0;G<q.length;G++){var O=q[G];if(null!=O){var S=n.get(b.item(O));O=m.get(S);m.delete(S);S=b.location(G);u.set(S,O);l.delete(S)}}G=(a,b,c)=>{c=void 0===c?"":c;for(const c of l)if(w(c,a))return u.set(c,b),l.delete(c),m.delete(a),!0;g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var y of m){const [a,b]=y;if(a.isMimic()&&!G(a,b,"traps"))return!1}for(const a of m){const [b,c]=a;if(b.needsChest()&&!G(b,c,"chest"))return!1}for(const a of m){const [b,
c]=a;if(!G(b,c))return!1}for(const a of u){const [b,c]=a;b.set(...c)}const {win:t,path:v}=a.traverse({wanted:k,dfs:!1});if(!t)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,q));e.items=[];e.route=[];for(const b of v){const [c,d]=b;e.route.push(d);k=a.nodes[c];k instanceof Slot$$module$js$nodes&&!k.isFixed()&&(y=k.slotName,0>y.indexOf(k.vanillaItemName)&&(y+=` (normally ${k.vanillaItemName})`),e.items.push({itemIndex:k.itemIndex,itemName:k.item.name,
origName:k.vanillaItemName,slotIndex:k.slotIndex,slotName:k.slotName,text:`${k.item.name}: ${y}`}))}return!0})};var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;module$js$depgraph.shuffle=shuffle$$module$js$depgraph;module$js$depgraph.shuffle2=shuffle2$$module$js$depgraph;module$js$depgraph.shuffle3=shuffle3$$module$js$depgraph;class FetchReader$$module$js$fetchreader{constructor(a){this.path=void 0===a?"js/":a}read(a){const b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){return a in STATIC$$module$js$fetchreader?STATIC$$module$js$fetchreader[a]:yield(yield fetch(b.path+a)).text()})}}const STATIC$$module$js$fetchreader={};var module$js$fetchreader={};module$js$fetchreader.FetchReader=FetchReader$$module$js$fetchreader;var Event$$module$js$graph$condition;
...
function build$$module$js$graph$world(a,b){b=void 0===b?new FlagSet$$module$js$flagset("@FullShuffle"):b;const c=new Overlay$$module$js$graph$overlay(a,b),d=new Map,e=new Map,f=new Map,g=new Map,h=new DefaultMap$$module$js$util(()=>new Set),k=new Map,m=new Set;for(const b of a.locations){var l=function(a,b){const c=d.get(a);c&&d.set(a,module$js$graph$condition.Terrain.meet(c,b))};if(!b.used)continue;const q=b.extended?256:0,t=a.tilesets[(b.tileset&127)>>2],p=a.tileEffects[b.tileEffects-179];for(const a of b.spawns)a.isWall()&&
e.set(module$js$graph$geometry.ScreenId.from(b,a),a.id&3);for(let f=0,g=b.height;f<g;f++){const g=b.screens[f],h=b.id<<8|f<<4;for(let f=0,k=b.width;f<k;f++){var n=function(a,b){if(!y)throw Error("flag expected");return b?a?w(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(y.flag)},b):a};const k=a.screens[g[f]|q],m=module$js$graph$geometry.ScreenId(h|f),l=m&255,r=e.get(m),y=null!=r?c.wallCapability(r):b.flags.find((a)=>a.yx===l),w=memoize2$$module$js$graph$condition((a,
b)=>{if(!y)throw Error("flag expected");b=Object.assign({},b,{enter:meet$$module$js$graph$condition(b.enter||[[]],module$js$graph$condition.Condition(y.flag))});return module$js$graph$condition.Terrain.join(a,b)});for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(m<<8|a);let e=k.tiles[a];y&&751===y.flag&&32>e&&(e=t.alternates[e]);let f=c.makeTerrain(q?0:p.effects[e]&38,b);if(32>e&&t.alternates[e]!=e&&y&&751!==y.flag){const a=c.makeTerrain(p.effects[t.alternates[e]],b);f=n(f,a)}f&&d.set(b,
...
m);for(const a of d){const [b,c]=a;{const a=module$js$graph$geometry.TileId.add(b,0,1),e=d.get(a);e&&e!==c&&r.addAdjacent(b,a,!1);const f=module$js$graph$geometry.TileId.add(b,1,0),g=d.get(f);g&&g!==c&&r.addAdjacent(b,f,!0)}}for(const a of q){const [b,c]=module$js$graph$geometry.TilePair.split(a);d.has(b)&&d.has(c)&&r.addExit(b,c)}const w=new Routes$$module$js$graph$routes;for(const a of c.extraRoutes())for(const b of a.condition||[[]])w.addRoute(p.find(a.tile),b);for(const a of c.extraEdges()){const {from:b,
to:c,condition:d}=a;for(const a of d||[[]])w.addEdge(p.find(c),p.find(b),a)}for(const a of r){const {from:b,to:c,south:e}=a;{const a=d.get(b),f=d.get(c);if(!a||!f)throw Error(`missing terrain ${a?c:b}`);for(const d of(e?a.exitSouth:a.exit)||[[]])for(const a of f.enter||[[]])w.addEdge(c,b,[...a,...d])}}const u=new DefaultMap$$module$js$util(()=>new MutableRequirement$$module$js$graph$condition);for(const a of c.capabilities()){const {condition:b=[[]],capability:c}=a;u.get(module$js$graph$condition.Slot(c)).addAll(b)}for(const a of h){const [b,
c]=a;{const a=p.find(b);if(b!==a){for(const b of c)h.get(a).add(b);h.delete(b)}}}for(const a of h){const [b,c]=a;for(const a of c){const {slot:c,condition:d=[[]]}=a;{const a=u.get(c);for(const c of d)for(const d of w.routes.get(b)||[])a.addList([...c,...d])}}}if(DEBUG$$module$js$graph$world&&"undefined"!==typeof window){var G=function(a,b){b=void 0===b?O:b;a=[...a];return a.length?"("+a.map((a)=>[...a].map(b).join(" & ")).join(") |\n     (")+")":"no route"},O=function(a){return 0>a?"~"+(~a).toString(16).padStart(2,
"0"):a.toString(16).padStart(3,"0")};const b=window;console.log(b.roots=(b.tiles=p).roots());console.log([...b.neighbors=r]);console.log(b.ll=w);b.area=(a,b)=>{b=void 0===b?O:b;const c=[...p.sets().filter((b)=>b.has(a))[0]].map((a)=>a.toString(16).padStart(6,"0")),d=G(w.routes.get(p.find(a)),b),e=[],f=p.find(a);for(const a of(w.edges.get(f)||new Map).values())e.push(`\nto ${a.target.toString(16)} if (${[...a.deps].map(b).join(" & ")})`);for(const a of w.edges){const [c,d]=a;for(const a of d.values())a.target===
...
b.reqs.check=(a,b)=>{b=void 0===b?O:b;return`${b(a)}: ${G(u.get(module$js$graph$condition.Slot(a)),b)}`};b.reqs.check2=(a)=>b.reqs.check(a,b.whatFlag)}return new World$$module$js$graph$world(a,p,makeGraph$$module$js$graph$world(u,a))}
...
k=[...g].filter((a)=>!c(a)).sort();g=[...g].filter(c).sort();m=[...h].filter(c).sort();const n=k.length;h=k.map(d);g=g.map(e);l=m.map(e);g=[...h,...g];k=[...h,...l];const p=new Map(g.map((a,b)=>[a.condition,b])),q=new Map(k.map((a,b)=>[a.condition,b]));m=[];const r=[];for(var w of a){const [c,d]=w;a=q.get(c);if(null==a)MAYBE_MISSING_SLOTS$$module$js$graph$world.has(c)||console.error(`Nothing depended on $${c.toString(16)}: ${conditionName$$module$js$graph$world(c,b)}`);else for(const b of d){const c=
[...b].map(f);(m[a]||(m[a]=[])).push(Bits$$module$js$bits.from(c));for(const b of c)(r[b]||(r[b]=new Set)).add(a)}}for(var u of[...h,...l])m[u.index]&&m[u.index].length||(w=u.condition,console.error(`Nothing provided $${w.toString(16)}: ${conditionName$$module$js$graph$world(w,b)} (index ${u.index})`));DEBUG$$module$js$graph$world&&console.log(m);u=r.map((a)=>[...a]);return{fixed:n,slots:k,items:g,graph:m,unlocks:u}}const MAYBE_MISSING_SLOTS$$module$js$graph$world=new Set([37,38,169,580]);
...
64:0)|b.entrances.length],k=[...concatIterables$$module$js$rom$util(b.flags),255],m=concatIterables$$module$js$rom$util(b.pits),[l,n,p,q,r,w]=yield Promise.all([d(e,"Layout"),d(f,"Graphics"),d(g,"Entrances"),d(h,"Exits"),d(k,"Flags"),...m.length?[d(m,"Pits")]:[]]);e=[l&255,(l>>>8)-192,n&255,(n>>>8)-192,p&255,(p>>>8)-192,q&255,(q>>>8)-192,r&255,(r>>>8)-192,...w?[w&255,(w>>8)-192]:[]];d=yield d(e,"MapData");writeLittleEndian$$module$js$rom$util(a.rom,b.mapDataPointer,d-49152);yield Promise.all(c);c=
...
const Entrance$$module$js$rom$location=DataTuple$$module$js$rom$util.make(4,{x:DataTuple$$module$js$rom$util.prop([0],[1,255,-8]),y:DataTuple$$module$js$rom$util.prop([2],[3,255,-8]),screen:DataTuple$$module$js$rom$util.prop([3,15,-4],[1,15]),tile:DataTuple$$module$js$rom$util.prop([2,240],[0,240,4]),toString(){return`Entrance ${this.hex()}: (${hex$$module$js$rom$util(this.x)}, ${hex$$module$js$rom$util(this.y)})`}}),Exit$$module$js$rom$location=DataTuple$$module$js$rom$util.make(4,{x:DataTuple$$module$js$rom$util.prop([0,
255,-4]),xt:DataTuple$$module$js$rom$util.prop([0]),y:DataTuple$$module$js$rom$util.prop([1,255,-4]),yt:DataTuple$$module$js$rom$util.prop([1]),screen:DataTuple$$module$js$rom$util.prop([1,240],[0,240,4]),tile:DataTuple$$module$js$rom$util.prop([1,15,-4],[0,15]),dest:DataTuple$$module$js$rom$util.prop([2]),entrance:DataTuple$$module$js$rom$util.prop([3]),toString(){return`Exit ${this.hex()}: (${hex$$module$js$rom$util(this.x)}, ${hex$$module$js$rom$util(this.y)}) => ${this.dest}:${this.entrance}`}}),
...
type:DataTuple$$module$js$rom$util.prop([2,7]),id:DataTuple$$module$js$rom$util.prop([3]),used:{get(){return 254!==this.data[0]}},monsterId:{get(){return this.id+80&255},set(a){this.id=a-80&255}},isChest(){return 2===this.type&&128>this.id},isInvisible(){return this.isChest()&&!!(this.data[2]&32)},isTrigger(){return 2===this.type&&128<=this.id},isNpc(){return 1===this.type&&192>this.id},isBoss(){return 1===this.type&&192<=this.id},isMonster(){return 0===this.type},isWall(){return!(3!==this.type||
!(4>this.id||this.data[2]&32))},toString(){return`Spawn ${this.hex()}: (${hex$$module$js$rom$util(this.x)}, ${hex$$module$js$rom$util(this.y)}) ${this.timed?"timed":"fixed"} ${this.type}:${hex$$module$js$rom$util(this.id)}`}}),LOCATIONS$$module$js$rom$location={mezameShrine:[0,"Mezame Shrine"],leafOutsideStart:[1,"Leaf - Outside Start"],leaf:[2,"Leaf"],valleyOfWind:[3,"Valley of Wind"],sealedCave1:[4,"Sealed Cave 1"],sealedCave2:[5,"Sealed Cave 2"],sealedCave6:[6,"Sealed Cave 6"],sealedCave4:[7,"Sealed Cave 4"],
sealedCave5:[8,"Sealed Cave 5"],sealedCave3:[9,"Sealed Cave 3"],sealedCave7:[10,"Sealed Cave 7"],sealedCave8:[12,"Sealed Cave 8"],windmillCave:[14,"Windmill Cave"],windmill:[15,"Windmill"],zebuCave:[16,"Zebu Cave"],mtSabreWestCave1:[17,"Mt Sabre West - Cave 1"],cordelPlainsWest:[20,"Cordel Plains West"],cordelPlainsEast:[21,"Cordel Plains East"],brynmaer:[24,"Brynmaer"],outsideStomHouse:[25,"Outside Stom House"],swamp:[26,"Swamp"],amazones:[27,"Amazones"],oak:[28,"Oak"],stomHouse:[30,"Stom House"],
...
"Sahara - Tool Shop"],saharaElderHouse:[250,"Sahara - Elder House"],saharaPawnShop:[251,"Sahara - Pawn Shop"]},locationNames$$module$js$rom$location=(()=>{const a=[];for(const b of Object.keys(LOCATIONS$$module$js$rom$location)){const [c,d]=LOCATIONS$$module$js$rom$location[b];a[c]=d}return a})(),NEXUSES$$module$js$rom$location=new Set([LOCATIONS$$module$js$rom$location.mtSabreWestLower[0],LOCATIONS$$module$js$rom$location.mtSabreWestUpper[0],LOCATIONS$$module$js$rom$location.mtSabreNorthMain[0],
LOCATIONS$$module$js$rom$location.mtSabreNorthMiddle[0],LOCATIONS$$module$js$rom$location.mtSabreNorthCave1[0],LOCATIONS$$module$js$rom$location.mtSabreNorthCave2[0],LOCATIONS$$module$js$rom$location.mtHydra[0],LOCATIONS$$module$js$rom$location.mtHydraOutsideShyron[0],LOCATIONS$$module$js$rom$location.mtHydraCave1[0]]);var module$js$rom$location={};module$js$rom$location.Location=Location$$module$js$rom$location;module$js$rom$location.Entrance=Entrance$$module$js$rom$location;
module$js$rom$location.Exit=Exit$$module$js$rom$location;module$js$rom$location.Flag=Flag$$module$js$rom$location;module$js$rom$location.Pit=Pit$$module$js$rom$location;module$js$rom$location.Spawn=Spawn$$module$js$rom$location;module$js$rom$location.LOCATIONS=LOCATIONS$$module$js$rom$location;class TileEffects$$module$js$rom$tileeffects extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.base=b<<8&8191|73728;this.effects=tuple$$module$js$rom$util(a.prg,this.base,256)}write(a){for(let b=0;256>b;b++)a.rom[this.base+b]=this.effects[b]}}TileEffects$$module$js$rom$tileeffects.PIT=1;TileEffects$$module$js$rom$tileeffects.NO_WALK=2;TileEffects$$module$js$rom$tileeffects.IMPASSIBLE=4;TileEffects$$module$js$rom$tileeffects.ALTERNATIVE=8;
...
function extendSwampScreens$$module$js$pass$shufflemazes(a){a.swapMetatiles([160],[[3,172],-219],[[4,170],-229],[[5,170],-230],[[6,170],-231],[[7,170],-232],[[8,170],-241],[[9,170],-242],[[10,170],-243],[[11,170],-244],[[12,170],-221],[[13,170],-222]);write$$module$js$pass$shufflemazes(a.screens[127].tiles,0,[[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[210,204],[210,204],[210,204],[210,226],[226,200]]);write$$module$js$pass$shufflemazes(a.screens[118].tiles,
76,[[8,9],[12,11],[3,3]]);write$$module$js$pass$shufflemazes(a.screens[122].tiles,37,[[,,4],[8,9,5],[,10,6],[,11,7],[,3,3]]);write$$module$js$pass$shufflemazes(a.screens[123].tiles,36,[[4],[],[6],[7,13],[3,3]]);write$$module$js$pass$shufflemazes(a.screens[126].tiles,71,[[8,9],[12,11],[3,3]])}function write$$module$js$pass$shufflemazes(a,b,c){for(let d=0;d<c.length;d++)for(let e=0;e<c[d].length;e++)null!=c[d][e]&&(a[b+(d<<4|e)]=c[d][e])}
...
0;g.length&&h<MAX_TABLE_LENGTH$$module$js$rom$messages;){e.has(g[0].str)&&(g.sort(f),e.clear());const {str:n,saving:p,missing:q,words:r,chains:w}=g.shift();if(0>=p)break;h+=n.length+3;k=a.length;m=new Set;for(const a of r){l=b[a];for(const a of[l.mid,...d.get(l.mid)||[]])m.add(a)}a.push({bytes:128>k?[k+128]:[5,k-128],mids:m,str:n});for(const a of r)for(k=0;k<=w;k++){m=b[a+k];l=m.bytes-(k?0:q);for(const a of m.suffixes)a.saving-=l-m.used,e.add(a.str);m.used=l}if(128===a.length){for(const a of c.values())a.saving-=
...
(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(l);c.chargeShotsOnly()&&disableStabs$$module$js$patch(l);c.orbsOptional()&&orbsOptional$$module$js$patch(l);shuffleMusic$$module$js$patch(l,c,h);shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(l,c,h);misc$$module$js$patch(l,c,h);fixDialog$$module$js$pass$fixdialog(l);c.buffDyna()&&buffDyna$$module$js$patch(l,c);yield l.writeData();
buffDyna$$module$js$patch(l,c);return yield postParsedShuffle$$module$js$patch(a,h,b,c,m,g)})}function postParsedShuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){yield f("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(a,d,e);updateCoinDrops$$module$js$patch(a,d);shuffleRandomNumbers$$module$js$patch(a,b);return stampVersionSeedAndHash$$module$js$patch(a,c,d)})}
