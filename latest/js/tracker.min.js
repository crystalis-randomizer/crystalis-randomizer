...
156,1).dialog(131,null,0).key(),qb=(new Magic$$module$js$nodes(a,65,"Refresh",65,null)).fromPerson("Zebu at windmill",94).direct(251665).dialog(94,16,3).trigger(180,1),Pa=(new Magic$$module$js$nodes(a,66,"Paralysis",66,null)).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),Y=(new Magic$$module$js$nodes(a,67,"Telepathy",67,null)).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),gc=(new Magic$$module$js$nodes(a,68,"Teleport",68,null)).fromPerson("Tornel on Mt. Sabre",
95).dialog(95,33,0),Td=(new Magic$$module$js$nodes(a,69,"Recover",69,null)).direct("Asina in Portoa",250361),hc=(new Magic$$module$js$nodes(a,70,"Barrier",70,null)).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),na=(new Magic$$module$js$nodes(a,71,"Change",71,null)).direct("Kensu in Swan",251614).npcSpawn(116,241,1),A=(new Magic$$module$js$nodes(a,72,"Flight",72,null)).weight(15).direct("Kensu in Draygonia Fortress",250255),Qa=d(40,"Flute of Lime").chest(void 0,91).key(),Ud=Ba.bossDrop("Vampire 2",
12,97).npcSpawn(204).key(),G=d(112,"Mimic"),ic=(new Trigger$$module$js$nodes(a,"Talked to Leaf Elder")).get(Q),jc=new Trigger$$module$js$nodes(a,"Talked to Leaf Student"),kc=(new Trigger$$module$js$nodes(a,"Buy alarm flute")).get(nb),rb=new Trigger$$module$js$nodes(a,"Talked to Zebu in cave"),Vd=(new Trigger$$module$js$nodes(a,"Woke up Windmill Guard")).get(Vb),Ra=new Trigger$$module$js$nodes(a,"Started Windmill"),lc=(new Trigger$$module$js$nodes(a,"Learned Refresh")).get(qb),Wd=(new Trigger$$module$js$nodes(a,
"Gave Statue to Akahana")).get(lb),Xd=(new Trigger$$module$js$nodes(a,"Fought Stom")).get(Y),mc=new Trigger$$module$js$nodes(a,"Visited Oak"),nc=new Trigger$$module$js$nodes(a,"Talked to Oak Mother"),sb=new Trigger$$module$js$nodes(a,"Rescued Oak Child"),Yd=(new Trigger$$module$js$nodes(a,"Talked to Oak Mother Again")).get(Sb),Zd=(new Trigger$$module$js$nodes(a,"Talked to Oak Elder")).get(R),$d=(new Trigger$$module$js$nodes(a,"Talked to Tornel on Mt Sabre")).get(gc),oc=new Trigger$$module$js$nodes(a,
"Villagers Abducted"),pc=new Trigger$$module$js$nodes(a,"Talked to Rabbit in Leaf"),ae=(new Trigger$$module$js$nodes(a,"Learned Paralysis")).get(Pa),qc=new Trigger$$module$js$nodes(a,"Talked to Portoa Queen"),rc=new Trigger$$module$js$nodes(a,"Talked to Fortune Teller"),sc=new Trigger$$module$js$nodes(a,"Visited Underground Channel"),be=(new Trigger$$module$js$nodes(a,"Sent to Waterfall Cave")).get(Ca),ce=(new Trigger$$module$js$nodes(a,"Cured Akahana")).get(Ub),tc=(new Trigger$$module$js$nodes(a,
"Talked to Rage")).get(Aa),uc=new Trigger$$module$js$nodes(a,"Mesia recording played"),de=(new Trigger$$module$js$nodes(a,"Talked to Asina")).get(Td),vc=(new Trigger$$module$js$nodes(a,"Healed Dolphin")).get(ob),tb=new Trigger$$module$js$nodes(a,"Returned Fog Lamp"),wc=new Trigger$$module$js$nodes(a,"Talked to Kensu in Cabin"),xc=new Trigger$$module$js$nodes(a,"Talked to Joel Elder"),ee=(new Trigger$$module$js$nodes(a,"Talked to Clark")).get(Zb),fe=(new Trigger$$module$js$nodes(a,"Talked to Kensu in Lighthouse")).get(ac),
ub=new Trigger$$module$js$nodes(a,"Calmed the Angry Sea"),ge=(new Trigger$$module$js$nodes(a,"Learned Barrier")).get(hc),yc=new Trigger$$module$js$nodes(a,"Talked to Stom in Swan Hut"),zc=new Trigger$$module$js$nodes(a,"Talked to Kensu in Swan tavern"),Ac=new Trigger$$module$js$nodes(a,"Talked to Kensu at Swan dance"),he=(new Trigger$$module$js$nodes(a,"Returned Kensu's love pendant")).get(na),ie=(new Trigger$$module$js$nodes(a,"Talked to Amazones Queen")).get(dc),vb=new Trigger$$module$js$nodes(a,
"Entered Shyron"),je=(new Trigger$$module$js$nodes(a,"Talked to Zebu in Shyron")).get(Xb),Bc=new Trigger$$module$js$nodes(a,"Shyron Massacre"),ke=(new Trigger$$module$js$nodes(a,"Saved Kensu")).get(A),le=(new Trigger$$module$js$nodes(a,"Talked to Deo")).get(Sd),me=(new Trigger$$module$js$nodes(a,"Talked to Akahana's Friend")).get(Qd),ne=(new Trigger$$module$js$nodes(a,"Get Bow of Truth")).get(fc),oe=(new Trigger$$module$js$nodes(a,"Forged Crystalis")).get(hb),Sa=(new Condition$$module$js$nodes(a,
"Sword charge glitch")).option(Jd),pe=(new Condition$$module$js$nodes(a,"Rabbit skip")).option(p),qe=(new Condition$$module$js$nodes(a,"Teleport skip")).option(l),wb=(new Condition$$module$js$nodes(a,"Statue glitch")).option(t),re=(new Condition$$module$js$nodes(a,"Wild warp")).option(Hd,Id),Ta=(new Condition$$module$js$nodes(a,"Any level 2 sword")).option(Q,Ia).option(Q,za).option(R,Ja).option(R,Ka).option(L,Aa).option(L,La).option(I,Ma).option(I,Na),v=(new Condition$$module$js$nodes(a,"Destroy stone")).option(Q,
Ia).option(Q,za).option(Sa,Q,Ta),w=(new Condition$$module$js$nodes(a,"Destroy ice")).option(R,Ja).option(R,Ka).option(Sa,R,Ta),q=(new Condition$$module$js$nodes(a,"Cross rivers")).option(L,Aa).option(L,La).option(A).option(Sa,L,Ta),oa=(new Condition$$module$js$nodes(a,"Destroy iron")).option(I,Ma).option(I,Na).option(Sa,I,Ta),Z=(new Condition$$module$js$nodes(a,"Any sword")).option(Q).option(R).option(L).option(I),se=(new Condition$$module$js$nodes(a,"Match insect sword (fire/water/thunder)")).option(R).option(L).option(I).option(lb,
D.value?D:h,Q),te=(new Condition$$module$js$nodes(a,"Speed boots")).option(Tb,r),Cc=(new Condition$$module$js$nodes(a,"Climb slopes")).option(mb).option(A).option(te),ue=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (rabbit)")).option(pc).option(pe),ve=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (Teleport)")).option(gc).option(qe,A),Dc=(new Condition$$module$js$nodes(a,"Asina in her room")).option(uc),we=(new Condition$$module$js$nodes(a,"Paralysis or Ball of Water")).option(Pa).option(Dc).option(wb),
Ec=(new Condition$$module$js$nodes(a,"Ride dolphin")).option(ob,wc),xe=(new Condition$$module$js$nodes(a,"Ghetto flight")).option(n,Ec,mb),S=(new Condition$$module$js$nodes(a,"Cross sea")).option(Ec).option(A),ye=(new Condition$$module$js$nodes(a,"Cross whirlpool")).option(ub).option(A).option(xe),J=(new Condition$$module$js$nodes(a,"Refresh if needed")).option(Pb.value?Pb:h).option(qb),Fc=(new Condition$$module$js$nodes(a,"Wind magic")).option(y.value?y:h,J).option(Ia,za,J),Gc=(new Condition$$module$js$nodes(a,
"Fire magic")).option(y.value?y:h,J).option(Ja,Ka,J),Hc=(new Condition$$module$js$nodes(a,"Water magic")).option(y.value?y:h,J).option(y,J).option(Aa,La,J),ze=(new Condition$$module$js$nodes(a,"Thunder magic")).option(y.value?y:h,J).option(y,J).option(Ma,J).option(Na,J),Ae=(new Condition$$module$js$nodes(a,"Flute of lime or glitch")).option(Ca).option(wb).option(Qa.value?Qa:g),Be=(new Condition$$module$js$nodes(a,"Second flute of lime")).option(Qa).option(Ca.value?Ca:g),Ic=(new Condition$$module$js$nodes(a,
"Change or glitch")).option(na).option(wb),xb=(new Condition$$module$js$nodes(a,"Pass shooting statues")).option(hc).option(Ob.value?Ob:h).option(qb,Ub),Ce=(new Condition$$module$js$nodes(a,"Healed dolphin if required")).option(vc).option(gb),Jc=(new Condition$$module$js$nodes(a,"Match sword of wind")).option(Q).option(D.value?D:h,Z),Kc=(new Condition$$module$js$nodes(a,"Match sword of fire")).option(R).option(D.value?D:h,Z),Lc=(new Condition$$module$js$nodes(a,"Match sword of water")).option(L).option(D.value?
D:h,Z),De=(new Condition$$module$js$nodes(a,"Match sword of thunder")).option(I).option(D.value?D:h,Z),Ua=(new Condition$$module$js$nodes(a,"Travel swamp")).option(lb).option(Ha.value?Ha:h),Ee=(new Condition$$module$js$nodes(a,"Calmed sea if required")).option(ub).option(Ed),Fe=e(0,"Vampire 1",Z).get(mb),Ge=e(1,"Insect",Sb,se).get(Ja),He=e(2,"Kelbesque 1",Jc,Fc).get(Ka),Ie=e(12,"Vampire 2",Z).get(Ud),Mc=e(4,"Sabera 1",Kc,Gc).get($b),Je=e(5,"Mado 1",Lc,Hc).get(Ma),Ke=e(6,"Kelbesque 2",Jc,Fc).get(kb),
Le=e(7,"Sabera 2",Kc,Gc).get(Qb),Me=e(8,"Mado 2",Lc,Hc).get(Kd),Ne=e(9,"Karmine",De,ze).get(pb),Oe=e(10,"Draygon 1",Z).get(Nd),Pe=e(null,"Statues",ec,dc),Qe=e(11,"Draygon 2",Z,fc),Re=e(13,"Dyna",hb),M=new Area$$module$js$nodes(a,"Leaf"),pa=new Area$$module$js$nodes(a,"Valley of Wind"),K=new Area$$module$js$nodes(a,"Sealed Cave"),ia=new Area$$module$js$nodes(a,"Cordel Plain"),qa=new Area$$module$js$nodes(a,"Brynmaer"),ra=new Area$$module$js$nodes(a,"Amazones"),B=new Area$$module$js$nodes(a,"Mt Sabre West"),
u=new Area$$module$js$nodes(a,"Mt Sabre North"),Va=new Area$$module$js$nodes(a,"Nadare's"),Da=new Area$$module$js$nodes(a,"Oak"),aa=new Area$$module$js$nodes(a,"Waterfall Valley"),z=new Area$$module$js$nodes(a,"Portoa"),ba=new Area$$module$js$nodes(a,"Waterfall Cave"),C=new Area$$module$js$nodes(a,"Fog Lamp Cave"),ca=new Area$$module$js$nodes(a,"Kirisa Plant Cave"),ja=new Area$$module$js$nodes(a,"Angry Sea"),da=new Area$$module$js$nodes(a,"Joel"),F=new Area$$module$js$nodes(a,"Evil Spirit Island"),
ea=new Area$$module$js$nodes(a,"Sabera's Castle"),N=new Area$$module$js$nodes(a,"Swan"),x=new Area$$module$js$nodes(a,"Mt Hydra"),fa=new Area$$module$js$nodes(a,"Shyron"),ka=new Area$$module$js$nodes(a,"Styx"),la=new Area$$module$js$nodes(a,"Goa"),Wa=new Area$$module$js$nodes(a,"Draygonia Fortress 1"),O=new Area$$module$js$nodes(a,"Draygonia Fortress 2"),sa=new Area$$module$js$nodes(a,"Draygonia Fortress 3"),H=new Area$$module$js$nodes(a,"Draygonia Fortress 4"),E=new Area$$module$js$nodes(a,"Oasis Cave");
new Area$$module$js$nodes(a,"Desert");const P=new Area$$module$js$nodes(a,"Sahara"),ta=new Area$$module$js$nodes(a,"Pyramid Front"),T=new Area$$module$js$nodes(a,"Pyramid Back"),U=new Area$$module$js$nodes(a,"Tower"),yb=(new Location$$module$js$nodes(a,0,M,"Start")).overworld().start(),Se=(new Location$$module$js$nodes(a,0,M,"Mezame Shrine")).overworld().from(yb),Te=(new Location$$module$js$nodes(a,1,M,"Outside Start")).overworld().connect(Se),ha=(new Location$$module$js$nodes(a,2,M,"Town")).town().connect(Te),
Ea=(new Location$$module$js$nodes(a,3,pa,"Main")).overworld().connect(ha).trigger(lc,Ra),Nc=(new Location$$module$js$nodes(a,3,pa,"Outside Windmill")).overworld(),Oc=(new Location$$module$js$nodes(a,4,K,"Tunnel 1 (entrance)")).cave().from(Ea,Ra),Ue=(new Location$$module$js$nodes(a,5,K,"Tunnel 2 (over bridge)")).cave().connect(Oc),Ve=(new Location$$module$js$nodes(a,6,K,"Tunnel 6 (herb dead end)")).cave().chest(W,15),Pc=(new Location$$module$js$nodes(a,7,K,"Tunnel 4a (ball corridor)")).cave().chest(W,
20,80).chest(Ia,21);(new Location$$module$js$nodes(a,7,K,"Tunnel 4b (antidote dead end)")).cave().connect(Pc,v).chest(Oa,19);const We=(new Location$$module$js$nodes(a,8,K,"Tunnel 5 (warp boots dead end)")).cave().chest(jb,14),Xe=(new Location$$module$js$nodes(a,9,K,"Tunnel 3a (branch, front)")).cave().connect(Ue).connectTo(Pc).connectTo(We),Ye=(new Location$$module$js$nodes(a,9,K,"Tunnel 3b (branch, back)")).cave().connect(Xe,v).connectTo(Ve),Ze=(new Location$$module$js$nodes(a,10,K,"Tunnel 7 (boss)")).cave().connect(Ye).boss(Fe),
$e=(new Location$$module$js$nodes(a,12,K,"Tunnel 8a (exit, above wall)")).cave().connect(Ze),af=(new Location$$module$js$nodes(a,12,K,"Tunnel 8b (exit, below wall")).cave().connect($e,v);(new Location$$module$js$nodes(a,14,pa,"Windmill Cave")).cave().connect(Ea).connectTo(Nc).trigger(Vd,nb,rb);(new Location$$module$js$nodes(a,15,pa,"Windmill")).misc().connect(Nc).trigger(Ra,Vb);const bf=(new Location$$module$js$nodes(a,16,pa,"Zebu's Cave Front")).cave().connect(Ea).trigger(rb,ic,jc).trigger(lc,Ra,
rb),cf=(new Location$$module$js$nodes(a,16,pa,"Zebu's Cave Back")).cave().trigger(oc).connect(bf,w),df=(new Location$$module$js$nodes(a,17,B,"Tunnel 1 (to Zebu)")).cave().connect(cf),ua=(new Location$$module$js$nodes(a,20,ia,"West")).overworld().connect(af),ef=(new Location$$module$js$nodes(a,20,ia,"South")).overworld().connect(ua,q),Qc=(new Location$$module$js$nodes(a,21,ia,"East")).overworld().connect(ua).chest(Rb,24),Fa=(new Location$$module$js$nodes(a,24,qa,"Town")).town().connect(ua).trigger(Wd,
Rb),ff=(new Location$$module$js$nodes(a,25,ia,"Outside Stom's House")).town().connect(ua),zb=(new Location$$module$js$nodes(a,26,ia,"Swamp")).overworld().connect(Qc,Ua).trigger(sb,nc,Ua);(new Location$$module$js$nodes(a,26,ia,"Swamp Insect Area")).overworld().connect(zb,Ua).boss(Ge);const Xa=(new Location$$module$js$nodes(a,27,ra,"Town")).town().connect(ef),Ya=(new Location$$module$js$nodes(a,28,Da,"Town")).town().connect(zb,Ua).trigger(mc);(new Location$$module$js$nodes(a,30,ia,"Stom's House")).house().connect(ff).trigger(Xd,
mc);const va=(new Location$$module$js$nodes(a,32,B,"Entrance")).overworld().connect(ua).connect(df),gf=(new Location$$module$js$nodes(a,32,B,"Up Slope")).overworld().from(va,Cc).to(va),hf=(new Location$$module$js$nodes(a,32,B,"Dead End (warp boots)")).overworld().chest(jb,24,106),Rc=(new Location$$module$js$nodes(a,33,B,"Upper")).overworld().from(va,A).to(va),jf=(new Location$$module$js$nodes(a,33,B,"Tornel Dead End")).overworld().trigger($d,za).chest(X,23,105),Sc=(new Location$$module$js$nodes(a,
34,B,"Tunnel 2a (fork at start)")).cave().connect(va);(new Location$$module$js$nodes(a,34,B,"Tunnel 2b (left branch to dead end)")).cave().connect(Sc,w).connectTo(hf);const kf=(new Location$$module$js$nodes(a,34,B,"Tunnel 2c (right branch to upper)")).cave().connect(Sc,w),lf=(new Location$$module$js$nodes(a,35,B,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(kf).chest(W,23,82),mf=(new Location$$module$js$nodes(a,35,B,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(lf,
w).connectTo(Rc),Tc=(new Location$$module$js$nodes(a,36,B,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(mf);(new Location$$module$js$nodes(a,36,B,"Tunnel 4b (out to upper)")).cave().connect(Tc,w).connectTo(Rc);const nf=(new Location$$module$js$nodes(a,37,B,"Tunnel 5 (tiny connector)")).cave().connect(Tc),of=(new Location$$module$js$nodes(a,38,B,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(nf);(new Location$$module$js$nodes(a,38,B,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(of,
w).connectTo(jf);const pf=(new Location$$module$js$nodes(a,39,B,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(gf),qf=(new Location$$module$js$nodes(a,39,B,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(pf,w);(new Location$$module$js$nodes(a,39,B,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(qf,w).chest(za,25);const Za=(new Location$$module$js$nodes(a,40,u,"Entrance")).overworld().connect(Qc,ve,ue),$a=(new Location$$module$js$nodes(a,40,u,"Upper")).overworld().from(Za,A).to(Za),
Ab=(new Location$$module$js$nodes(a,40,u,"Summit (boss)")).overworld().from($a,A).to($a).boss(He),Uc=(new Location$$module$js$nodes(a,41,u,"Connector")).overworld(),Bb=(new Location$$module$js$nodes(a,41,u,"Middle Left")).overworld(),rf=(new Location$$module$js$nodes(a,41,u,"Middle Right")).overworld().from(Bb,Cc).to(Bb),Vc=(new Location$$module$js$nodes(a,42,u,"Tunnel 2a (from entrance to connector)")).cave().connectTo(Uc);(new Location$$module$js$nodes(a,42,u,"Tunnel 2b (under bridge, to antidote)")).cave().connect(Vc,
w).chest(Oa,23,94);const Wc=(new Location$$module$js$nodes(a,43,u,"Tunnel 3a (branch after connector)")).cave().connect(Uc),sf=(new Location$$module$js$nodes(a,43,u,"Tunnel 3b (right branch)")).cave().connect(Wc,w),tf=(new Location$$module$js$nodes(a,43,u,"Tunnel 3c (upper branch)")).cave().connect(Wc,w);(new Location$$module$js$nodes(a,44,u,"Tunnel 4 (over bridge, to middle)")).cave().connect(tf).connectTo(Bb);const Xc=(new Location$$module$js$nodes(a,45,u,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(sf).connectTo(rf);
(new Location$$module$js$nodes(a,45,u,"Tunnel 5b (dead-end with herb)")).cave().connect(Xc,w).chest(W,22,83);const uf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6a (S-shaped hall, right)")).cave().connect(Xc),vf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(uf,w),wf=(new Location$$module$js$nodes(a,46,u,"Tunnel 6c (S-shaped hall, left)")).cave().connect(vf,w),Yc=(new Location$$module$js$nodes(a,47,u,"Prison (hallway)")).cave().connect($a),xf=(new Location$$module$js$nodes(a,
48,u,"Left Cell (shopkeepers)")).cave().from(Yc,w);(new Location$$module$js$nodes(a,49,u,"Left Cell 2 (back, with prison key)")).cave().from(xf,w).chest(Wb,13);const yf=(new Location$$module$js$nodes(a,50,u,"Right Cell (villagers)")).cave().from(Yc,w),zf=(new Location$$module$js$nodes(a,51,u,"Tunnel 8 (behind right cell, toward summit)")).cave().from(yf,w);(new Location$$module$js$nodes(a,52,u,"Tunnel 9 (connector to summit)")).cave().connect(zf).connectTo(Ab);const Af=(new Location$$module$js$nodes(a,
53,u,"Tunnel 10a (summit cave, front)")).cave().from(Ab,Wb).to(Ab),Bf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10b (summit cave, behind ice)")).cave().connect(Af,w).trigger(ae);(new Location$$module$js$nodes(a,56,u,"Tunnel 1 (leads from main entrance)")).cave().connect(Za).connectTo(Vc);(new Location$$module$js$nodes(a,57,u,"Tunnel 7 (to upper)")).cave().connect(wf).connectTo($a);const Cf=(new Location$$module$js$nodes(a,60,Va,"Inn")).town(),Df=(new Location$$module$js$nodes(a,61,Va,"Tool Shop")).house(),
Ef=(new Location$$module$js$nodes(a,62,Va,"Back Room")).house(),Cb=(new Location$$module$js$nodes(a,64,aa,"Summit")).overworld().connect(Bf),ab=(new Location$$module$js$nodes(a,64,aa,"Northwest")).overworld().from(Cb).to(Cb,A),Ff=(new Location$$module$js$nodes(a,64,aa,"Northeast")).overworld().connect(ab,q),Zc=(new Location$$module$js$nodes(a,65,aa,"Southwest")).overworld().connect(ab),Gf=(new Location$$module$js$nodes(a,65,aa,"Southeast")).overworld().connect(Zc,q),$c=(new Location$$module$js$nodes(a,
66,aa,"Lime Tree Valley")).overworld().connect(Zc).connect(Ea,Gd),Hf=(new Location$$module$js$nodes(a,67,aa,"Lime Tree Lake (Rage)")).cave().connect($c).trigger(tc,L),If=(new Location$$module$js$nodes(a,68,ca,"Tunnel 1a (entrance)")).cave().connect(Gf),Jf=(new Location$$module$js$nodes(a,68,ca,"Tunnel 1b (behind wall)")).cave().connect(If,v),ad=(new Location$$module$js$nodes(a,69,ca,"Tunnel 2a (main path, before wall)")).cave().connect(Jf);(new Location$$module$js$nodes(a,69,ca,"Tunnel 2b (dead end, antidote)")).cave().connect(ad,
v).chest(Oa,25,95);const Kf=(new Location$$module$js$nodes(a,69,ca,"Tunnel 2c (main path, after wall)")).cave().connect(ad,v),Lf=(new Location$$module$js$nodes(a,70,ca,"Tunnel 3a (last room, before wall)")).cave().connect(Kf),Mf=(new Location$$module$js$nodes(a,70,ca,"Tunnel 3b (last room, after wall)")).cave().connect(Lf,v);(new Location$$module$js$nodes(a,71,ca,"Meadow")).overworld().connect(Mf).chest(cc,14);const Nf=(new Location$$module$js$nodes(a,72,C,"Tunnel 1a (entrance)")).cave().connect(Ff),
bd=(new Location$$module$js$nodes(a,72,C,"Tunnel 1b (past wall)")).cave().connect(Nf,v);(new Location$$module$js$nodes(a,72,C,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(bd,v).chest(ib,24);const Of=(new Location$$module$js$nodes(a,73,C,"Tunnel 2 (tiny connector)")).cave().connect(bd),cd=(new Location$$module$js$nodes(a,74,C,"Tunnel 3a (upper branch)")).cave().connect(Of);(new Location$$module$js$nodes(a,74,C,"Tunnel 3b (dead end, mimic)")).cave().connect(cd,v).chest(G,21,112);const dd=(new Location$$module$js$nodes(a,
74,C,"Tunnel 3c (short passage with mimic)")).cave().connect(cd,v).chest(G,22,113),Pf=(new Location$$module$js$nodes(a,74,C,"Tunnel 3d (lower branch)")).cave().connect(dd,v);(new Location$$module$js$nodes(a,75,C,"Tunnel 4 (dead end loop)")).cave().connect(Pf);const ed=(new Location$$module$js$nodes(a,76,C,"Tunnel 5a (right branch over bridge)")).cave().connect(dd),Qf=(new Location$$module$js$nodes(a,76,C,"Tunnel 5b (past wall over bridge)")).cave().connect(ed,v),Rf=(new Location$$module$js$nodes(a,
77,C,"Tunnel 6a (from left branch)")).cave().connect(ed),Sf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6b (reconvergence)")).cave().connect(Rf,v).connect(Qf),Tf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6c (between walls)")).cave().connect(Sf,v),Uf=(new Location$$module$js$nodes(a,77,C,"Tunnel 6d (under bridge)")).cave().connect(Tf,v),Vf=(new Location$$module$js$nodes(a,78,C,"Tunnel 7a (over second bridge)")).cave().connect(Uf),Wf=(new Location$$module$js$nodes(a,78,C,"Tunnel 7b (past wall)")).cave().connect(Vf,
v),Xf=(new Location$$module$js$nodes(a,79,C,"Tunnel 8a (under second bridge)")).cave().connect(Wf);(new Location$$module$js$nodes(a,79,C,"Tunnel 8b (fog lamp)")).cave().connect(Xf,v).chest(Yb,19);const ma=(new Location$$module$js$nodes(a,80,z,"Town")).town().connect(ab),fd=(new Location$$module$js$nodes(a,81,z,"Fishherman Island")).town().connect(ma);(new Location$$module$js$nodes(a,82,aa,"Mesia Shrine")).cave().trigger(uc).connect(Hf,q,tc);const gd=(new Location$$module$js$nodes(a,84,ba,"Tunnel 1a (entrance)")).cave().connect(ab);
(new Location$$module$js$nodes(a,84,ba,"Tunnel 1b (dead end, mimic)")).cave().connect(gd,w).chest(G,19,114);const Yf=(new Location$$module$js$nodes(a,84,ba,"Tunnel 1c (past ice)")).cave().connect(gd,w),hd=(new Location$$module$js$nodes(a,85,ba,"Tunnel 2 (stoned pair)")).cave().connect(Yf),Db=(new Location$$module$js$nodes(a,86,ba,"Tunnel 3 (wide medusa hallways)")).cave().from(hd,Ae).to(hd,Ca),Zf=(new Location$$module$js$nodes(a,87,ba,"Tunnel 4a (left entrance)")).cave().from(Db,w).chest(Qa,25).trigger(ce,
Be);(new Location$$module$js$nodes(a,87,ba,"Tunnel 4b (right entrance)")).cave().from(Db,w).connect(Zf,A);(new Location$$module$js$nodes(a,87,ba,"Tunnel 4c (sword of water)")).cave().connect(Db,w).chest(L,24);const id=(new Location$$module$js$nodes(a,88,U,"Entrance")).misc(),$f=(new Location$$module$js$nodes(a,89,U,"Level 1")).misc().from(id),ag=(new Location$$module$js$nodes(a,90,U,"Level 2")).misc().from($f),bg=(new Location$$module$js$nodes(a,91,U,"Level 3")).misc().from(ag),jd=(new Location$$module$js$nodes(a,
92,U,"Outside Mesia Room")).misc().from(bg),cg=(new Location$$module$js$nodes(a,93,U,"Outside Dyna Room")).misc().from(jd,hb);(new Location$$module$js$nodes(a,94,U,"Mesia")).misc().connect(jd).trigger(oe);const dg=(new Location$$module$js$nodes(a,95,U,"Dyna")).misc().from(cg).boss(Re);(new Location$$module$js$nodes(a,95,U,"Win")).misc().from(dg).end();const Eb=(new Location$$module$js$nodes(a,96,ja,"Cabin Beach")).sea().from(fd,tb),wa=(new Location$$module$js$nodes(a,96,ja,"South")).sea().connect(Eb,
S),eg=(new Location$$module$js$nodes(a,96,ja,"Joel Beach")).sea().connect(wa,S),kd=(new Location$$module$js$nodes(a,96,da,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(a,96,ja,"Altar")).sea().connect(wa,S).trigger(ub,ac,$b);const fg=(new Location$$module$js$nodes(a,96,ja,"North")).sea().to(wa,S).from(wa,S,ye).trigger(ge,Ee),gg=(new Location$$module$js$nodes(a,96,ja,"Swan Beach")).sea().connect(fg,S);(new Location$$module$js$nodes(a,97,ja,"Cabin")).misc().connect(Eb).trigger(wc,tb);(new Location$$module$js$nodes(a,
98,da,"Lighthouse")).misc().connect(kd).trigger(fe,nb);const bb=(new Location$$module$js$nodes(a,100,z,"Underground Channel 1 (from throne room)")).sea().trigger(sc),hg=(new Location$$module$js$nodes(a,100,z,"Underground Channel 2 (to fortune teller)")).sea().connect(bb,q),ld=(new Location$$module$js$nodes(a,100,z,"Underground Channel 3 (from fortune teller)")).sea().connect(bb,A),md=(new Location$$module$js$nodes(a,100,z,"Underground Channel 4 (asina)")).sea().connect(ld,q),ig=(new Location$$module$js$nodes(a,
100,z,"Underground Channel 5 (dolphin)")).sea().connect(md,q).trigger(vc,W,Aa);(new Location$$module$js$nodes(a,100,z,"Underground Channel 6 (water)")).sea().connect(ig,S).connectTo(wa,S).chest(bc,17);const Fb=(new Location$$module$js$nodes(a,101,F,"Zombie Town")).town(),jg=(new Location$$module$js$nodes(a,104,F,"Tunnel 1 (entrance)")).sea().connect(wa,xc,S),nd=(new Location$$module$js$nodes(a,105,F,"Tunnel 2a (start)")).cave().connect(jg);(new Location$$module$js$nodes(a,105,F,"Tunnel 2b (dead end to left)")).cave().connect(nd,
q);const kg=(new Location$$module$js$nodes(a,105,F,"Tunnel 2c (across first river)")).cave().connect(nd,q),od=(new Location$$module$js$nodes(a,105,F,"Tunnel 2d (across second river)")).cave().connect(kg,q);(new Location$$module$js$nodes(a,105,F,"Tunnel 2e (dead end, magic ring)")).cave().connect(od,v).chest(X,29);const lg=(new Location$$module$js$nodes(a,105,F,"Tunnel 2f (stair down)")).cave().connect(od,v),mg=(new Location$$module$js$nodes(a,106,F,"Tunnel 3a (main area)")).cave().connect(lg).connectTo(Fb).chest(ib,
25,92),ng=(new Location$$module$js$nodes(a,106,F,"Tunnel 3b (left area toward items)")).cave().connect(mg,v),og=(new Location$$module$js$nodes(a,107,F,"Tunnel 4a (right side, mimic)")).cave().connect(ng).chest(G,14,115);(new Location$$module$js$nodes(a,107,F,"Tunnel 4b (left side, iron necklace)")).cave().connect(og,q).chest(Rd,15);const Gb=(new Location$$module$js$nodes(a,108,ea,"Floor 1")).fortress().connect(Fb),pg=(new Location$$module$js$nodes(a,108,ea,"Miniboss")).fortress().boss(Ie).connect(Gb);
(new Location$$module$js$nodes(a,109,ea,"Floor 2a (left stair)")).fortress().connect(Gb).chest(Ba,19);const qg=(new Location$$module$js$nodes(a,109,ea,"Floor 2b (right stair)")).fortress().connect(pg).chest(W,30,85),rg=(new Location$$module$js$nodes(a,110,ea,"Floor 3a (toward boss)")).fortress().connect(qg),pd=(new Location$$module$js$nodes(a,110,ea,"Floor 3b (boss room)")).fortress().connect(rg);(new Location$$module$js$nodes(a,110,ea,"Boss")).fortress().boss(Mc).connect(pd);(new Location$$module$js$nodes(a,
110,ea,"Floor 3c (back room trap)")).fortress().from(pd).to(Gb);const sg=(new Location$$module$js$nodes(a,112,da,"Secret Passage")).cave().connectTo(kd),cb=(new Location$$module$js$nodes(a,113,da,"Town")).town().connect(eg),V=(new Location$$module$js$nodes(a,114,N,"Town")).town().connect(gg),tg=(new Location$$module$js$nodes(a,115,N,"Inside Gate")).overworld().connect(V),ug=(new Location$$module$js$nodes(a,115,N,"Outside Gate")).overworld().from(tg,na),db=(new Location$$module$js$nodes(a,120,la,"Valley")).overworld().connect(ug),
Hb=(new Location$$module$js$nodes(a,124,x,"Entrance")).overworld().connect(db),vg=(new Location$$module$js$nodes(a,124,x,"Over first river toward Shyron")).overworld().connect(Hb,q),qd=(new Location$$module$js$nodes(a,124,x,"After first tunnel")).overworld(),rd=(new Location$$module$js$nodes(a,124,x,"Door to Styx")).overworld().connect(qd,q),wg=(new Location$$module$js$nodes(a,124,x,"Dead end (no item)")).overworld(),xg=(new Location$$module$js$nodes(a,124,x,"Dead end (fruit of lime)")).overworld().chest(Od,
26),yg=(new Location$$module$js$nodes(a,124,x,"Dead end (magic ring)")).overworld().chest(X,25,101),sd=(new Location$$module$js$nodes(a,124,x,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(a,124,x,"Floating island (bow of sun)")).overworld().connect(sd,A).chest(ec,24);const zg=(new Location$$module$js$nodes(a,125,x,"Tunnel 1 (to Shyron)")).cave().connect(vg),Ag=(new Location$$module$js$nodes(a,126,x,"Outside Shyron")).overworld().connect(zg);(new Location$$module$js$nodes(a,
127,x,"Tunnel 2 (fork)")).cave().connect(Hb).connectTo(xg).connectTo(qd);const td=(new Location$$module$js$nodes(a,128,x,"Tunnel 3 (caves)")).cave().connect(rd).connect(wg),ud=(new Location$$module$js$nodes(a,129,x,"Tunnel 4 (left branch of cave)")).cave().connect(td);(new Location$$module$js$nodes(a,130,x,"Tunnel 5 (dead end, medical herb)")).cave().connect(ud).chest(W,15,86);const Bg=(new Location$$module$js$nodes(a,131,x,"Tunnel 6a (left-then-right)")).cave().connect(ud),Cg=(new Location$$module$js$nodes(a,
131,x,"Tunnel 6b (past wall)")).cave().connect(Bg,v),Dg=(new Location$$module$js$nodes(a,132,x,"Tunnel 7 (wide hall)")).cave().connect(Cg);(new Location$$module$js$nodes(a,133,x,"Tunnel 8 (red slimes)")).cave().from(Dg,v).connectTo(sd).chest(G,23,116);const Eg=(new Location$$module$js$nodes(a,134,x,"Tunnel 9 (right branch, infinite loop)")).cave().connect(td),Fg=(new Location$$module$js$nodes(a,135,x,"Tunnel 10a (toward magic ring)")).cave().connect(Eg);(new Location$$module$js$nodes(a,135,x,"Tunnel 10b (past wall)")).cave().connect(Fg,
v).connectTo(yg);const vd=(new Location$$module$js$nodes(a,136,ka,"Entrance")).fortress().from(rd,Xb,xb),Gg=(new Location$$module$js$nodes(a,137,ka,"Left branch")).fortress().connect(vd).chest(G,19,117),Hg=(new Location$$module$js$nodes(a,137,ka,"Left branch, past one bridge")).fortress().connect(Gg,q),Ig=(new Location$$module$js$nodes(a,137,ka,"Left branch, past two bridges")).fortress().connect(Hg,q).chest(W,29,87),Jg=(new Location$$module$js$nodes(a,137,ka,"Right branch")).fortress().connect(vd);
(new Location$$module$js$nodes(a,137,ka,"Right branch, across water")).fortress().connect(Jg,A).chest(G,20,118).chest(G,21,119).chest(Ld,28);(new Location$$module$js$nodes(a,138,ka,"Upper floor")).fortress().connect(Ig).chest(I,27);const xa=(new Location$$module$js$nodes(a,140,fa,"Town")).town().connect(Ag,Ic).trigger(vb),Ga=(new Location$$module$js$nodes(a,142,la,"Town")).town().connect(db),wd=(new Location$$module$js$nodes(a,143,E,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(a,
143,E,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(wd,oa).chest(Pd,15);const Ib=(new Location$$module$js$nodes(a,144,la,"Desert 1")).overworld().connect(db),eb=(new Location$$module$js$nodes(a,145,E,"Area 1 (from entrance)")).cave().chest(Tb,26),xd=(new Location$$module$js$nodes(a,145,E,"Area 2 (across top bridge)")).cave().connect(eb,q);(new Location$$module$js$nodes(a,145,E,"Area 3 (dead-end across top-right bridge)")).cave().connect(xd,q);const Kg=(new Location$$module$js$nodes(a,
145,E,"Area 4 (left across middle-right bridge)")).cave().connect(xd,q),Lg=(new Location$$module$js$nodes(a,145,E,"Area 5 (bottom edge)")).cave().connect(Kg,q),Mg=(new Location$$module$js$nodes(a,145,E,"Area 6 (bottom island)")).cave().connect(Lg,q),Ng=(new Location$$module$js$nodes(a,145,E,"Area 7 (bottom inner ring)")).cave().connect(Mg,q),Og=(new Location$$module$js$nodes(a,145,E,"Area 8 (left outer ring)")).cave().connect(Ng,q).connect(eb,q).chest(Ba,27,100),Pg=(new Location$$module$js$nodes(a,
145,E,"Area 9 (top left inner ring)")).cave().connect(Og,q),Qg=(new Location$$module$js$nodes(a,145,E,"Area 10 (top right inner ring)")).cave().connect(Pg,q);(new Location$$module$js$nodes(a,145,E,"Area 11 (center)")).cave().connect(Qg,q).connectTo(wd);(new Location$$module$js$nodes(a,145,E,"Area 12 (top center islands)")).cave().connect(eb,A).chest(Md,28);const Rg=(new Location$$module$js$nodes(a,146,P,"Desert Cave 1")).cave().connect(Ib,A),ya=(new Location$$module$js$nodes(a,147,P,"Town")).town(),
Sg=(new Location$$module$js$nodes(a,148,P,"Outside Cave")).overworld().connect(ya),Tg=(new Location$$module$js$nodes(a,149,P,"Desert Cave 2")).cave().connect(Sg);(new Location$$module$js$nodes(a,150,P,"Meadow")).overworld().connect(Rg).connectTo(ya).trigger(le,na,Y);const Jb=(new Location$$module$js$nodes(a,152,P,"Desert 2")).overworld().connect(Tg),Ug=(new Location$$module$js$nodes(a,156,ta,"Entrance")).fortress().connect(Jb,A),Vg=(new Location$$module$js$nodes(a,156,ta,"Azteca")).fortress().trigger(ne),
Wg=(new Location$$module$js$nodes(a,157,ta,"Fork")).fortress().connect(Ug),yd=(new Location$$module$js$nodes(a,158,ta,"Main")).fortress().connect(Wg);(new Location$$module$js$nodes(a,158,ta,"Treasure Chest (magic ring)")).fortress().connect(yd).chest(X,27,108);(new Location$$module$js$nodes(a,159,ta,"Draygon")).fortress().connect(yd).to(Vg).boss(Oe);const Xg=(new Location$$module$js$nodes(a,160,T,"Entrance")).fortress().connect(Jb,A),Yg=(new Location$$module$js$nodes(a,160,T,"Statues")).fortress().connect(Xg).boss(Pe),
Zg=(new Location$$module$js$nodes(a,161,T,"Hall 1")).fortress().connect(Yg),Kb=(new Location$$module$js$nodes(a,162,T,"Branch")).fortress().connect(Zg);(new Location$$module$js$nodes(a,163,T,"Left Dead End")).fortress().connect(Kb).chest(G,13,120);(new Location$$module$js$nodes(a,164,T,"Right Dead End")).fortress().connect(Kb);const $g=(new Location$$module$js$nodes(a,165,T,"Hall 2")).fortress().connect(Kb).chest(kb,26,109),ah=(new Location$$module$js$nodes(a,166,T,"Draygon 2")).fortress().connect($g).boss(Qe);
(new Location$$module$js$nodes(a,167,T,"Teleporter")).fortress().from(ah).to(id);const zd=(new Location$$module$js$nodes(a,168,Wa,"Entrance")).fortress().connect(Ga,xb).trigger(Bc,I),bh=(new Location$$module$js$nodes(a,169,Wa,"Main")).fortress().from(zd,oa),ch=(new Location$$module$js$nodes(a,169,Wa,"Boss")).fortress().connect(bh).boss(Ke),dh=(new Location$$module$js$nodes(a,170,Wa,"Zebu")).fortress().connect(ch),fb=(new Location$$module$js$nodes(a,171,O,"Entrance")).fortress().connect(dh);(new Location$$module$js$nodes(a,
171,O,"Dead End Behind Iron (fruit of power)")).fortress().connect(fb,oa).chest(Ba,28,98);(new Location$$module$js$nodes(a,171,O,"Dead End Loop Across Closer Bridges")).fortress().connect(fb,q).connect(fb,q);const eh=(new Location$$module$js$nodes(a,171,O,"Across First Bridge (fruit of repun)")).fortress().connect(fb,q).chest(Qb,30,102),Lb=(new Location$$module$js$nodes(a,171,O,"Across Second Bridge")).fortress().connect(eh,q);(new Location$$module$js$nodes(a,171,O,"Dead End Across Two Bridges ()")).fortress().connect(Lb,
q).connect(Lb,q).chest(ib,29,93);const fh=(new Location$$module$js$nodes(a,171,O,"Across Third Bridge")).fortress().connect(Lb,q),gh=(new Location$$module$js$nodes(a,171,O,"Exit Behind Iron Door")).fortress().connect(fh,oa),hh=(new Location$$module$js$nodes(a,172,O,"Boss")).fortress().connect(gh).boss(Le),ih=(new Location$$module$js$nodes(a,172,O,"Tornel")).fortress().connect(hh),Ad=(new Location$$module$js$nodes(a,173,sa,"Lower")).fortress().connect(ih).chest(kb,26,99).chest(X,27,111),jh=(new Location$$module$js$nodes(a,
174,sa,"Upper Loop")).fortress().connect(Ad).chest(Oa,22,96);(new Location$$module$js$nodes(a,174,sa,"Upper Loop Behind Wall (magic ring)")).fortress().connect(jh,oa).chest(X,23,107);const kh=(new Location$$module$js$nodes(a,175,sa,"Upper Passage (toward Mado)")).fortress().connect(Ad).chest(X,27,84),Mb=(new Location$$module$js$nodes(a,176,H,"Initial Fork")).fortress(),lh=(new Location$$module$js$nodes(a,177,H,"Left Branch")).fortress().connect(Mb),Bd=(new Location$$module$js$nodes(a,178,H,"Main Area (right branch, over bridges)")).fortress().connect(Mb),
mh=(new Location$$module$js$nodes(a,179,H,"U-shaped Passage (between floors)")).fortress().connect(Bd),nh=(new Location$$module$js$nodes(a,180,H,"Main Area Lower (under bridge)")).fortress().connect(lh).connect(Bd).connect(mh),Cd=(new Location$$module$js$nodes(a,180,H,"Behind Iron Wall")).fortress().connect(nh,oa),oh=(new Location$$module$js$nodes(a,181,H,"Lower")).fortress().connect(Cd).chest(G,13,121).chest(G,14,122).chest(G,15,123).chest(X,23,88).chest(jb,24,110),ph=(new Location$$module$js$nodes(a,
182,H,"Boss Corridor")).fortress().connect(oh),qh=(new Location$$module$js$nodes(a,182,H,"Boss")).fortress().connect(ph,xb).boss(Ne);(new Location$$module$js$nodes(a,182,H,"Behind Boss (stormBracelet)")).fortress().connect(qh).chest(Na,18);const Dd=(new Location$$module$js$nodes(a,183,H,"Exit Stairs")).fortress(),rh=(new Location$$module$js$nodes(a,184,E,"Entrance Back (behind river)")).cave().connect(Dd).chest(Ba,13,90);(new Location$$module$js$nodes(a,184,E,"Entrance Front")).cave().connect(rh,
A).connectTo(Ib).connectTo(eb);const sh=(new Location$$module$js$nodes(a,185,sa,"Boss")).fortress().connect(kh).boss(Me);(new Location$$module$js$nodes(a,185,sa,"Asina")).fortress().connect(sh).connectTo(Mb);(new Location$$module$js$nodes(a,186,H,"Kensu")).fortress().connect(Cd).connectTo(Dd).trigger(ke,pb);(new Location$$module$js$nodes(a,187,la,"House")).house().connect(Ga).trigger(me,na,pb);(new Location$$module$js$nodes(a,188,la,"Inn")).shop().connect(Ga,vb);(new Location$$module$js$nodes(a,190,
la,"Tool Shop")).shop().connect(Ga,vb);(new Location$$module$js$nodes(a,191,la,"Tavern")).shop().connect(Ga);(new Location$$module$js$nodes(a,192,M,"Elder House")).house().connect(ha).trigger(ic);(new Location$$module$js$nodes(a,193,M,"Rabbit Hut")).house().connect(ha).trigger(pc,oc,Y);(new Location$$module$js$nodes(a,194,M,"Inn")).shop().connect(ha);(new Location$$module$js$nodes(a,195,M,"Tool Shop")).shop().connect(ha).trigger(kc);(new Location$$module$js$nodes(a,196,M,"Armor Shop")).shop().connect(ha);
...
Y).trigger(Zd,sb);(new Location$$module$js$nodes(a,206,Da,"Mother's House")).house().from(Ya,Y).trigger(nc,Y).trigger(Yd,sb);(new Location$$module$js$nodes(a,207,Da,"Tool Shop")).shop().from(Ya,Y);(new Location$$module$js$nodes(a,208,Da,"Inn")).shop().from(Ya,Y);(new Location$$module$js$nodes(a,209,ra,"Inn")).shop().connect(Xa);(new Location$$module$js$nodes(a,210,ra,"Tool Shop")).shop().connect(Xa);(new Location$$module$js$nodes(a,211,ra,"Armor Shop")).shop().connect(Xa);const th=(new Location$$module$js$nodes(a,
212,ra,"Queen's House")).house().from(Xa,Ic).trigger(ie,na,cc);(new Location$$module$js$nodes(a,213,Va,"Nadare's")).house().connect(Za).connectTo(Cf).connectTo(Df).connectTo(Ef);(new Location$$module$js$nodes(a,214,z,"Fisherman's House")).house().connect(fd).trigger(tb,Yb,ob,Ce);const Nb=(new Location$$module$js$nodes(a,215,z,"Palace Entrance")).house().connect(ma);(new Location$$module$js$nodes(a,216,z,"Fortune Teller Front")).house().connect(ma).trigger(rc,qc);(new Location$$module$js$nodes(a,216,
z,"Fortune Teller Back")).house().connect(hg).connect(ld);(new Location$$module$js$nodes(a,217,z,"Pawn Shop")).shop().connect(ma);(new Location$$module$js$nodes(a,218,z,"Armor Shop")).shop().connect(ma);(new Location$$module$js$nodes(a,220,z,"Inn")).shop().connect(ma);(new Location$$module$js$nodes(a,221,z,"Tool Shop")).shop().connect(ma);(new Location$$module$js$nodes(a,222,z,"Palace Left")).house().connect(Nb);(new Location$$module$js$nodes(a,223,z,"Palace Throne Room")).house().connect(Nb).to(bb,
we).from(bb).trigger(qc).trigger(be,rc,sc);(new Location$$module$js$nodes(a,224,z,"Palace Right")).house().connect(Nb);(new Location$$module$js$nodes(a,225,z,"Asina's Room")).house().connect(md).trigger(de,Dc);(new Location$$module$js$nodes(a,226,ra,"Queen Downstairs")).house().connect(th).chest(La,13);(new Location$$module$js$nodes(a,227,da,"Elder's House")).house().connect(cb).trigger(xc);(new Location$$module$js$nodes(a,228,da,"Shed")).house().connect(cb).to(sg,Zb);(new Location$$module$js$nodes(a,
229,da,"Tool Shop")).shop().connect(cb).trigger(kc);(new Location$$module$js$nodes(a,231,da,"Inn")).shop().connect(cb);const uh=(new Location$$module$js$nodes(a,232,F,"Zombie Town House")).house().connect(Fb);(new Location$$module$js$nodes(a,233,F,"Zombie Town Basement")).house().connect(uh).trigger(ee,Mc);(new Location$$module$js$nodes(a,235,N,"Tool Shop")).shop().connect(V);(new Location$$module$js$nodes(a,236,N,"Stom's Hut")).house().connect(V).trigger(yc);(new Location$$module$js$nodes(a,237,
N,"Inn")).shop().connect(V);(new Location$$module$js$nodes(a,238,N,"Armor Shop")).shop().connect(V);(new Location$$module$js$nodes(a,239,N,"Tavern")).house().connect(V).trigger(zc,yc,Pa);(new Location$$module$js$nodes(a,240,N,"Pawn Shop")).shop().connect(V);(new Location$$module$js$nodes(a,241,N,"Dance Hall")).house().connect(V).trigger(Ac,zc,Pa).trigger(he,Ac,bc);const vh=(new Location$$module$js$nodes(a,242,fa,"Temple (pre-massacre)")).fortress().connect(xa).from(yb,I,Fd).trigger(je);(new Location$$module$js$nodes(a,
...
249,P,"Tool Shop")).shop().connect(ya);(new Location$$module$js$nodes(a,250,P,"Elder's House")).house().connect(ya);(new Location$$module$js$nodes(a,251,P,"Pawn Shop")).house().connect(ya);const wh=[ha,Ea,Oc,ua,zb,va,Cb,$c,Eb,V,db,Hb,Ib,zd,Jb];for(const a of wh)a.from(yb,re);return a},shuffle$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes);d||(d=new FlagSet$$module$js$flagset("Sbkm Sct"));
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="latest",LABEL$$module$js$version="latest 51fa6a9",HASH$$module$js$version="51fa6a9a8b5e298de5796d14f7284350d2f282f7",DATE$$module$js$version=new Date(1552043349E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c;a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);c=a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$js$patch(b,parseSeed$$module$js$patch(a.seed),c)})}};
...
preventNpcDespawns$$module$js$patch.apply(b);allowTeleportOutOfTower$$module$js$patch.apply(b);c.check("Td")&&buffDeosPendant$$module$js$patch.apply(b);c.check("Rl")&&barrierRequiresCalmSea$$module$js$patch.apply(b);scaleDifficultyLib$$module$js$patch.apply(b);nerfArmors$$module$js$patch.apply(b);fixVampire$$module$js$patch.apply(b);displayDifficulty$$module$js$patch.apply(b);itemLib$$module$js$patch.apply(b);c.check("Em")?buffMedicalHerb3x$$module$js$patch.apply(b):c.check("Hm")||buffMedicalHerb2x$$module$js$patch.apply(b);
c.check("Rt")?asinaTeleportsToMezameShrine$$module$js$patch.apply(b):noTeleportOnThunderSword$$module$js$patch.apply(b);c.check("Ts")&&leatherBootsForSpeed$$module$js$patch.apply(b);c.check("Di")&&neverDie$$module$js$patch.apply(b);c.check("Ta")&&autoEquipBracelet$$module$js$patch.apply(b);c.check("Tw")&&nerfWildWarp$$module$js$patch.apply(b);return stampVersionSeedAndHash$$module$js$patch(b,a,c)}),stampVersionSeedAndHash$$module$js$patch=(b,a,c)=>{const d=crc32$$module$js$crc32(b).toString(16).padStart(8,
0).toUpperCase(),e="unstable"==STATUS$$module$js$version?HASH$$module$js$version.substring(0,7).padStart(7,0).toUpperCase()+"     ":VERSION$$module$js$version.substring(0,12).padEnd(12," ");a=a.toString(16).padStart(8,0).toUpperCase();const f=(a,c)=>{for(let d=0;d<c.length;d++)b[a+16+d]=c.charCodeAt(d)},g=(a,b)=>{const c=[];for(let d=0;d<a.length||d<b.length;d++)c.push(a[d]||" "),c.push(b[d]||" ");return c.join("")};f(161743,g("  VERSION     SEED      ",`  ${e}${a}`));a=String(c);let k;if(46<a.length){if(92<
a.length)throw Error("Flag string way too long!");k=a.substring(46,92).padEnd(46," ");a=a.substring(0,46)}a=a.padEnd(46," ");f(161791,g(a.substring(0,23),a.substring(23)));k&&f(161839,g(k.substring(0,23),k.substring(23)));f(161925,g(d.substring(0,4),d.substring(4)));f(153366,"RANDOMIZER");"unstable"==STATUS$$module$js$version&&f(153404,"BETA");return d},watchForFlag0$$module$js$patch=buildRomPatch$$module$js$6502(assemble$$module$js$6502("\n.bank $3c000 $c000:$4000\n\n;;;; TODO - REMOVE THIS ONCE IT'S SOLVED\n.org $3cb62 ; main game mode jump 08\n  jsr CheckFlag0\n.org $3fe80\nReadControllersWithDirections:\n.org $3d347\nInitiateDialog:\n\n.org $3fdd0 ; !!! - note itemLib (I think) uses this space, too\nCheckFlag0:\n  lda $6480\n  lsr\n  bcc +\n   asl\n   sta $6480\n   lda #$00\n   sta $20\n   sta $21\n   ldx #$0c\n-   lda $6140,x\n    eor #$ff\n    sta $6140,x\n    dex\n   bpl -\n   jsr InitiateDialog\n+ jmp ReadControllersWithDirections\n\n",
...
module$js$patch.watchForFlag0=watchForFlag0$$module$js$patch;module$js$patch.openSwanFromEitherSide=openSwanFromEitherSide$$module$js$patch;module$js$patch.connectLeafToLimeTree=connectLeafToLimeTree$$module$js$patch;module$js$patch.rearrangeTriggersAndNpcs=rearrangeTriggersAndNpcs$$module$js$patch;module$js$patch.fixOpelStatue=fixOpelStatue$$module$js$patch;module$js$patch.requireHealedDolphinToRide=requireHealedDolphinToRide$$module$js$patch;module$js$patch.buffDeosPendant=buffDeosPendant$$module$js$patch;
module$js$patch.allowTeleportOutOfTower=allowTeleportOutOfTower$$module$js$patch;module$js$patch.preventNpcDespawns=preventNpcDespawns$$module$js$patch;module$js$patch.barrierRequiresCalmSea=barrierRequiresCalmSea$$module$js$patch;module$js$patch.noTeleportOnThunderSword=noTeleportOnThunderSword$$module$js$patch;module$js$patch.asinaTeleportsToMezameShrine=asinaTeleportsToMezameShrine$$module$js$patch;module$js$patch.saharaBunniesRequireTelepathy=saharaBunniesRequireTelepathy$$module$js$patch;
module$js$patch.fixShaking=fixShaking$$module$js$patch;module$js$patch.displayDifficulty=displayDifficulty$$module$js$patch;module$js$patch.buffMedicalHerb3x=buffMedicalHerb3x$$module$js$patch;module$js$patch.buffMedicalHerb2x=buffMedicalHerb2x$$module$js$patch;module$js$patch.removeWildWarp=removeWildWarp$$module$js$patch;module$js$patch.nerfWildWarp=nerfWildWarp$$module$js$patch;module$js$patch.preventSwordClobber=preventSwordClobber$$module$js$patch;module$js$patch.upgradeBallsToBracelets=upgradeBallsToBracelets$$module$js$patch;
