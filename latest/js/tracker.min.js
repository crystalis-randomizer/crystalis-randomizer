...
a.assumeGhettoFlight())),l=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),p=h(d("Assume teleport skip",a.assumeTeleportSkip())),q=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),u=h(d("Allow rabbit skip",!a.disableRabbitSkip())),t=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),z=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),W=h(d("Assume wild warp",a.assumeWildWarp())),
pa=d("Allow wild warp",a.allowWildWarp()),C=d("Sword magic optional",!a.guaranteeSwordMagic()),I=d("Matching sword optional",!a.guaranteeMatchingSword()),Qa=d("Gas mask optional",!a.guaranteeGasMask()),Pd=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),Qd=d("Calm sea optional",!a.barrierRequiresCalmSea()),Rd=d("Prison key optional",!a.paralysisRequiresPrisonKey()),Sd=d("Windmill optional",!a.sealedCaveRequiresWindmill()),Td=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
...
27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),G=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),L=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),wa=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),rb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),N=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),X=(new Item$$module$js$nodes(c,
...
"Destroy ice")).option(R,Ra).option(R,Sa).option(R,Ta).option($a,R,bb),v=(new Condition$$module$js$nodes(c,"Cross rivers")).option(M,Ra).option(M,Ua).option(M,Va).option(D).option($a,M,bb),xa=(new Condition$$module$js$nodes(c,"Destroy iron")).option(K,Ra).option(K,Wa).option(K,Xa).option($a,K,bb),T=(new Condition$$module$js$nodes(c,"Any sword")).option(Q).option(R).option(M).option(K),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(R).option(M).option(K).option(Ya,
I.value?I:g,Q),Je=(new Condition$$module$js$nodes(c,"Match vampire 2 sword (wind/water/thunder)")).option(Q).option(M).option(K).option(I.value?I:g,R),Oc=(new Condition$$module$js$nodes(c,"Speed boots")).option(fc,k),Pc=(new Condition$$module$js$nodes(c,"Climb slopes")).option(vb).option(D).option(Oc),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Ac).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(sc).option(Ge,D),Qc=(new Condition$$module$js$nodes(c,
"Asina in her room")).option(Fc),Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(Ka).option(Qc).option(ab),Rc=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(yb,Ic),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(m,Rc,vb),ca=(new Condition$$module$js$nodes(c,"Cross sea")).option(Rc).option(D),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Db).option(D).option(Ne),U=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(Xb.value?
Xb:g).option(Za),Sc=(new Condition$$module$js$nodes(c,"Wind magic")).option(C.value?C:g,U).option(Ia,Ja,U),Tc=(new Condition$$module$js$nodes(c,"Fire magic")).option(C.value?C:g,U).option(Sa,Ta,U),Uc=(new Condition$$module$js$nodes(c,"Water magic")).option(C.value?C:g,U).option(C,U).option(Ua,Va,U),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(C.value?C:g,U).option(C,U).option(Wa,U).option(Xa,U),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(ub).option(ab),
...
xc);const Ea=(new Location$$module$js$nodes(c,32,E,"Entrance")).overworld().connect(Da).connect(Af),Df=(new Location$$module$js$nodes(c,32,E,"Up Slope")).overworld().from(Ea,Pc).to(Ea),Ef=(new Location$$module$js$nodes(c,32,E,"Dead End (warp boots)")).overworld().chest(S,24,106),cd=(new Location$$module$js$nodes(c,33,E,"Upper")).overworld().from(Ea,D).to(Ea),Ff=(new Location$$module$js$nodes(c,33,E,"Tornel Dead End")).overworld().trigger(qe,Ia,Ja).chest(X,23,105),dd=(new Location$$module$js$nodes(c,
34,E,"Tunnel 2a (fork at start)")).cave().connect(Ea);(new Location$$module$js$nodes(c,34,E,"Tunnel 2b (left branch to dead end)")).cave().connect(dd,y).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,E,"Tunnel 2c (right branch to upper)")).cave().connect(dd,y),Hf=(new Location$$module$js$nodes(c,35,E,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(G,23,82),If=(new Location$$module$js$nodes(c,35,E,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,
y).connectTo(cd),ed=(new Location$$module$js$nodes(c,36,E,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,E,"Tunnel 4b (out to upper)")).cave().connect(ed,y).connectTo(cd);const Jf=(new Location$$module$js$nodes(c,37,E,"Tunnel 5 (tiny connector)")).cave().connect(ed),Kf=(new Location$$module$js$nodes(c,38,E,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);(new Location$$module$js$nodes(c,38,E,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,
y).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,E,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,E,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,y);(new Location$$module$js$nodes(c,39,E,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,y).chest(Ja,25);const hb=(new Location$$module$js$nodes(c,40,w,"Entrance")).overworld().connect(bd,Le,Ke),ib=(new Location$$module$js$nodes(c,40,w,"Upper")).overworld().from(hb,D).to(hb),
...
53,w,"Summit Cave (front)")).cave().from(Ib,xb).to(Ib),Xf=(new Location$$module$js$nodes(c,53,w,"Summit Cave (behind ice)")).cave().connect(Wf,y).trigger(re);(new Location$$module$js$nodes(c,56,w,"Tunnel 1 (leads from main entrance)")).cave().connect(hb).connectTo(gd);(new Location$$module$js$nodes(c,57,w,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(ib);const Yf=(new Location$$module$js$nodes(c,60,db,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,db,"Tool Shop")).shop(G,L,N,S),$f=(new Location$$module$js$nodes(c,
62,db,"Back Room")).house(),Kb=(new Location$$module$js$nodes(c,64,ia,"Summit")).overworld().connect(Xf,nf),jb=(new Location$$module$js$nodes(c,64,ia,"Northwest")).overworld().from(Kb).to(Kb,D),ag=(new Location$$module$js$nodes(c,64,ia,"Northeast")).overworld().connect(jb,v),kd=(new Location$$module$js$nodes(c,65,ia,"Southwest")).overworld().connect(jb),bg=(new Location$$module$js$nodes(c,65,ia,"Southeast")).overworld().connect(kd,v),ld=(new Location$$module$js$nodes(c,66,ia,"Lime Tree Valley")).overworld().connect(kd).connect(Na,
...
72,F,"Tunnel 1b (past wall)")).cave().connect(ig,x);(new Location$$module$js$nodes(c,72,F,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(nd,x).chest(wa,24);const jg=(new Location$$module$js$nodes(c,73,F,"Tunnel 2 (tiny connector)")).cave().connect(nd),od=(new Location$$module$js$nodes(c,74,F,"Tunnel 3a (upper branch)")).cave().connect(jg);(new Location$$module$js$nodes(c,74,F,"Tunnel 3b (dead end, mimic)")).cave().connect(od,x).chest(O,21,112);const pd=(new Location$$module$js$nodes(c,74,F,"Tunnel 3c (short passage with mimic)")).cave().connect(od,
x).chest(O,22,113),kg=(new Location$$module$js$nodes(c,74,F,"Tunnel 3d (lower branch)")).cave().connect(pd,x);(new Location$$module$js$nodes(c,75,F,"Dead end loop")).cave().connect(kg);const qd=(new Location$$module$js$nodes(c,76,F,"Tunnel 4a (right branch over bridge)")).cave().connect(pd),lg=(new Location$$module$js$nodes(c,76,F,"Tunnel 4b (past wall over bridge)")).cave().connect(qd,x),mg=(new Location$$module$js$nodes(c,77,F,"Tunnel 5a (from left branch)")).cave().connect(qd),ng=(new Location$$module$js$nodes(c,
77,F,"Tunnel 5b (reconvergence)")).cave().connect(mg,x).connect(lg),og=(new Location$$module$js$nodes(c,77,F,"Tunnel 5c (between walls)")).cave().connect(ng,x),pg=(new Location$$module$js$nodes(c,77,F,"Tunnel 5d (under bridge)")).cave().connect(og,x),qg=(new Location$$module$js$nodes(c,78,F,"Tunnel 6a (over second bridge)")).cave().connect(pg),rg=(new Location$$module$js$nodes(c,78,F,"Tunnel 6b (past wall)")).cave().connect(qg,x),sg=(new Location$$module$js$nodes(c,79,F,"Tunnel 7a (under second bridge)")).cave().connect(rg);
(new Location$$module$js$nodes(c,79,F,"Tunnel 7b (fog lamp)")).cave().connect(sg,x).chest(jc,19);const va=(new Location$$module$js$nodes(c,80,B,"Town")).town().connect(jb),rd=(new Location$$module$js$nodes(c,81,B,"Fishherman Island")).town().connect(va);(new Location$$module$js$nodes(c,82,ia,"Mesia Shrine")).cave().trigger(Fc).connect(cg,v,Ec);const sd=(new Location$$module$js$nodes(c,84,ja,"Tunnel 1a (entrance)")).cave().connect(jb);(new Location$$module$js$nodes(c,84,ja,"Tunnel 1b (dead end, mimic)")).cave().connect(sd,
...
wb);const kb=(new Location$$module$js$nodes(c,100,B,"Underground Channel 1 (from throne room)")).sea().trigger(Dc),Eg=(new Location$$module$js$nodes(c,100,B,"Underground Channel 2 (to fortune teller)")).sea().connect(kb,v),wd=(new Location$$module$js$nodes(c,100,B,"Underground Channel 3 (from fortune teller)")).sea().connect(kb,D),xd=(new Location$$module$js$nodes(c,100,B,"Underground Channel 4 (asina)")).sea().connect(wd,v),Fg=(new Location$$module$js$nodes(c,100,B,"Underground Channel 5 (dolphin)")).sea().connect(xd,
v).trigger(Hc,G,Gc);(new Location$$module$js$nodes(c,100,B,"Underground Channel 6 (water)")).sea().connect(Fg,ca).connectTo(Fa,ca).chest(nc,17);const Nb=(new Location$$module$js$nodes(c,101,J,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,J,"Tunnel 1 (entrance)")).sea().connect(Fa,Jc,ca),yd=(new Location$$module$js$nodes(c,105,J,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,J,"Tunnel 2b (dead end to left)")).cave().connect(yd,v);const Hg=(new Location$$module$js$nodes(c,
...
"Floor 2a (left stair)")).fortress().connect(Ob).chest(N,19);const Ng=(new Location$$module$js$nodes(c,109,ma,"Floor 2b (right stair)")).fortress().connect(Mg).chest(G,30,85),Og=(new Location$$module$js$nodes(c,110,ma,"Floor 3a (toward boss)")).fortress().connect(Ng),Ad=(new Location$$module$js$nodes(c,110,ma,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$js$nodes(c,110,ma,"Boss")).fortress().boss(Yc).connect(Ad);(new Location$$module$js$nodes(c,110,ma,"Floor 3c (back room trap)")).fortress().from(Ad).to(Ob);
...
136,ta,"Entrance")).fortress().from(Cd,ic,Fb),ch=(new Location$$module$js$nodes(c,137,ta,"Left branch")).fortress().connect(Gd).chest(O,19,117),dh=(new Location$$module$js$nodes(c,137,ta,"Left branch, past one bridge")).fortress().connect(ch,v),eh=(new Location$$module$js$nodes(c,137,ta,"Left branch, past two bridges")).fortress().connect(dh,v).chest(G,29,87),fh=(new Location$$module$js$nodes(c,137,ta,"Right branch")).fortress().connect(Gd);(new Location$$module$js$nodes(c,137,ta,"Right branch, across water")).fortress().connect(fh,
D).chest(O,20,118).chest(O,21,119).chest(Zd,28);(new Location$$module$js$nodes(c,138,ta,"Upper floor")).fortress().connect(eh).chest(K,27);const Ga=(new Location$$module$js$nodes(c,140,na,"Town")).town().connect(Xg,Re).trigger(Eb),Pa=(new Location$$module$js$nodes(c,142,ua,"Town")).town().connect(mb),Hd=(new Location$$module$js$nodes(c,143,H,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,H,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Hd,
...
185,Ba,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$js$nodes(c,185,Ba,"Asina")).fortress().connect(Ph).connectTo(Ub);(new Location$$module$js$nodes(c,186,P,"Kensu")).fortress().connect(Nd).connectTo(Od).trigger(Ae,zb);(new Location$$module$js$nodes(c,187,ua,"House")).house().connect(Pa).trigger(Ce,qa,zb);(new Location$$module$js$nodes(c,188,ua,"Inn")).shop().connect(Pa,Eb);(new Location$$module$js$nodes(c,190,ua,"Tool Shop")).shop(G,L,S,N).connect(Pa,Eb);(new Location$$module$js$nodes(c,
191,ua,"Tavern")).shop().connect(Pa);(new Location$$module$js$nodes(c,192,Y,"Elder House")).house().connect(oa).trigger(uc);(new Location$$module$js$nodes(c,193,Y,"Rabbit Hut")).house().connect(oa).trigger(Ac,zc,ha);(new Location$$module$js$nodes(c,194,Y,"Inn")).shop().connect(oa);(new Location$$module$js$nodes(c,195,Y,"Tool Shop")).shop(G,L,S,N).connect(oa);(new Location$$module$js$nodes(c,196,Y,"Armor Shop")).shop($d,Yb).connect(oa);(new Location$$module$js$nodes(c,197,Y,"Student House")).house().connect(oa).trigger(vc);
(new Location$$module$js$nodes(c,198,za,"Tavern")).house().connect(Oa);(new Location$$module$js$nodes(c,199,za,"Pawn Shop")).shop().connect(Oa);(new Location$$module$js$nodes(c,200,za,"Inn")).shop().connect(Oa);(new Location$$module$js$nodes(c,201,za,"Armor Shop")).shop(ae,Yb,Xd).connect(Oa);(new Location$$module$js$nodes(c,203,za,"Tool Shop")).shop(G,L,S).connect(Oa);(new Location$$module$js$nodes(c,205,Ma,"Elder House")).house().from(gb,ha).trigger(pe,Bb);(new Location$$module$js$nodes(c,206,Ma,
"Mother's House")).house().from(gb,ha).trigger(yc,ha).trigger(oe,Bb);(new Location$$module$js$nodes(c,207,Ma,"Tool Shop")).shop(G,L,N).from(gb,ha);(new Location$$module$js$nodes(c,208,Ma,"Inn")).shop().from(gb,ha);(new Location$$module$js$nodes(c,209,Aa,"Inn")).shop().connect(fb);(new Location$$module$js$nodes(c,210,Aa,"Tool Shop")).shop(S,N,wa).connect(fb);(new Location$$module$js$nodes(c,211,Aa,"Armor Shop")).shop(bc,Zb,$b,qb).connect(fb);const Qh=(new Location$$module$js$nodes(c,212,Aa,"Queen's House")).house().from(fb,
...
(new Location$$module$js$nodes(c,217,B,"Pawn Shop")).shop().connect(va);(new Location$$module$js$nodes(c,218,B,"Armor Shop")).shop(be,bc,Zb).connect(va);(new Location$$module$js$nodes(c,220,B,"Inn")).shop().connect(va);(new Location$$module$js$nodes(c,221,B,"Tool Shop")).shop(G,wa,rb,S).connect(va);(new Location$$module$js$nodes(c,222,B,"Palace Left")).house().connect(Vb);(new Location$$module$js$nodes(c,223,B,"Palace Throne Room")).house().connect(Vb).to(kb,Me).from(kb).trigger(Bc).trigger(se,Cc,
Dc);(new Location$$module$js$nodes(c,224,B,"Palace Right")).house().connect(Vb);(new Location$$module$js$nodes(c,225,B,"Asina's Room")).house().connect(xd).trigger(Gc,Qc);(new Location$$module$js$nodes(c,226,Aa,"Queen Downstairs")).house().connect(Qh).chest(Va,13);(new Location$$module$js$nodes(c,227,la,"Elder's House")).house().connect(lb).trigger(Jc);(new Location$$module$js$nodes(c,228,la,"Shed")).house().connect(lb).to(Pg,kc);(new Location$$module$js$nodes(c,229,la,"Tool Shop")).shop(G,L,N,wa).connect(lb);
(new Location$$module$js$nodes(c,231,la,"Inn")).shop().connect(lb);const Rh=(new Location$$module$js$nodes(c,232,J,"Zombie Town House")).house().connect(Nb);(new Location$$module$js$nodes(c,233,J,"Zombie Town Basement")).house().connect(Rh).trigger(ue,Yc);(new Location$$module$js$nodes(c,235,Z,"Tool Shop")).shop(G,L,N,S).connect(fa);(new Location$$module$js$nodes(c,236,Z,"Stom's Hut")).house().connect(fa).trigger(Kc);(new Location$$module$js$nodes(c,237,Z,"Inn")).shop().connect(fa);(new Location$$module$js$nodes(c,
...
Nc).boss(df);(new Location$$module$js$nodes(c,243,na,"Training Hall")).house().connect(Ga);(new Location$$module$js$nodes(c,244,na,"Hospital")).house().connect(Ga);(new Location$$module$js$nodes(c,245,na,"Armor Shop")).shop(cc,qb,ac).connect(Ga);(new Location$$module$js$nodes(c,246,na,"Tool Shop")).shop(G,L,rb,X).connect(Ga);(new Location$$module$js$nodes(c,247,na,"Inn")).shop().connect(Ga);(new Location$$module$js$nodes(c,248,ba,"Inn")).shop().connect(Ha);(new Location$$module$js$nodes(c,249,ba,
...
if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return p[a.slotType?a.slotType[0]:"c"]===p[b.slotType?b.slotType[0]:"c"]};q=b.assumedFill(d,(a,b)=>u(a,n.get(b)));if(null==q){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const t=new Map;for(var z=0;z<q.length;z++){var W=q[z];if(null!=W){var pa=n.get(b.item(W));W=m.get(pa);m.delete(pa);pa=b.location(z);t.set(pa,W);l.delete(pa)}}z=(a,b,c)=>{c=void 0===c?"":c;for(const c of l)if(u(c,a))return t.set(c,b),l.delete(c),m.delete(a),
!0;g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var C of m){const [a,b]=C;if(a.isMimic()&&!z(a,b,"traps"))return!1}for(const a of m){const [b,c]=a;if(b.needsChest()&&!z(b,c,"chest"))return!1}for(const a of m){const [b,c]=a;if(!z(b,c))return!1}for(const a of t){const [b,c]=a;b.set(...c)}const {win:I,path:Qa}=a.traverse({wanted:k,dfs:!1});if(!I)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,q));
e.items=[];e.route=[];for(const b of Qa){const [c,d]=b;e.route.push(d);k=a.nodes[c];k instanceof Slot$$module$js$nodes&&!k.isFixed()&&(C=k.slotName,0>C.indexOf(k.vanillaItemName)&&(C+=` (normally ${k.vanillaItemName})`),e.items.push({itemIndex:k.itemIndex,itemName:k.item.name,origName:k.vanillaItemName,slotIndex:k.slotIndex,slotName:k.slotName,text:`${k.item.name}: ${C}`}))}return!0})};var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;module$js$depgraph.shuffle=shuffle$$module$js$depgraph;
...
e.set(module$js$graph$geometry.ScreenId.from(b,a),a.id);for(let f=0,g=b.height;f<g;f++){const g=b.screens[f],h=b.id<<8|f<<4;for(let f=0,k=b.width;f<k;f++){var n=function(a,b){if(!z)throw Error("flag expected");return b?a?r(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(z.flag)},b):a};const k=a.screens[g[f]|t],m=module$js$graph$geometry.ScreenId(h|f),l=m&255,C=e.get(m),z=null!=C?c.wallCapability(C):b.flags.find((a)=>a.yx===l),r=memoize2$$module$js$graph$condition((a,
b)=>{if(!z)throw Error("flag expected");b=Object.assign({},b,{enter:meet$$module$js$graph$condition(b.enter||[[]],module$js$graph$condition.Condition(z.flag))});return module$js$graph$condition.Terrain.join(a,b)});for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(m<<8|a);let e=k.tiles[a];z&&751===z.flag&&32>e&&(e=p.alternates[e]);let f=c.makeTerrain(t?0:q.effects[e]&38,b);if(32>e&&p.alternates[e]!=e&&z&&751!==z.flag){const a=c.makeTerrain(q.effects[p.alternates[e]],b);f=n(f,a)}f&&d.set(b,
...
let b=0;for(const c of a)b+=STATUS_DIFFICULTY$$module$js$rom$monster[c];return b}immunities(){let a=0,b=this.elements;for(;b;)b&1&&a++,b>>>=1;return a&&1<<a-1}movement(){return this.collectDifficulty((a)=>{const b=ACTION_SCRIPTS$$module$js$rom$monster.get(a.action),c=a.spawnedChild();a=a.extraDifficulty;b&&(a+=b.movement||0,b.large&&a++,c&&!c.statusEffect&&(a+=b.projectile||0));167===this.metasprite&&(a+=2);return a},(a,b)=>a+b)}spawnedChild(){var a=ACTION_SCRIPTS$$module$js$rom$monster.get(this.action);
if(a&&a.child&&(a=(a=this.rom.adHocSpawns[this.child])&&a.objectId,null!=a))return a=this.rom.objects[a],a instanceof Monster$$module$js$rom$monster?a:void 0}spawnedReplacement(){if(this.replacement){var a=this.rom.objects[this.replacement];return a instanceof Monster$$module$js$rom$monster?a:void 0}}totalReward(){return this.totalDifficulty()/4}normalizedGold(){if(!this.wealth)return 0;const a=this.totalDifficulty()*this.wealth*.6;return Math.max(1,Math.min(15,Math.round(a)))}normalizedExp(){if(1===
this.wealth)return 0;const a=.488+this.totalDifficulty()*(1-this.wealth)*.256;return Math.max(1,Math.min(255,Math.round(32*a)))}}function processExpReward$$module$js$rom$monster(a){return 128>a?a:(a&127)<<4}function baselineExp$$module$js$rom$monster(a){return Math.pow(2,a/5-1)}const STATUS_DIFFICULTY$$module$js$rom$monster=[2,1,3,2,4],VANILLA_GOLD_DROPS$$module$js$rom$monster=[0,1,2,4,8,16,30,50,100,200,400,50,100,200,400,500];
function baselineGold$$module$js$rom$monster(a){return Math.pow(2,a/7-1)}
const ACTION_SCRIPTS$$module$js$rom$monster=new Map([[16,{}],[17,{}],[22,{}],[23,{}],[27,{}],[30,{}],[31,{}],[32,{movement:1}],[33,{child:!0,large:!0,movement:2}],[34,{child:!0,movement:3}],[36,{movement:3}],[37,{movement:3}],[38,{child:!0,projectile:1,movement:3}],[39,{child:!0,projectile:1,movement:3}],[40,{child:!0,projectile:2,movement:3}],[41,{child:!0,movement:5}],[42,{child:!0,projectile:1,movement:4}],[43,{movement:4}],[44,{child:!0}],[46,{child:!0,large:!0,projectile:2,movement:3}],[47,{}],
...
47,{difficulty:1}],whiteRobot:["White Robot",161,47],towerSentinel:["Tower Sentinel",162,47],helicopter:["Helicopter",163,47]},BOSSES$$module$js$rom$objects={vampire1:["Vampire 1",87,5],giantInsect:["Giant Insect",94,11],kelbesque1:["Kelbesque 1",104,15],sabera1:["Sabera 1",125,29],kelbesque2:["Kelbesque 2",139,41],sabera2:["Sabera 2",144,41],mado2:["Mado 2",147,41],karmine:["Karmine",151,41],draygon1:["Draygon 1",155,45],draygon2:["Draygon 2",158,47],dyna:["Dyna",164,47],vampire2:["Vampire 2",165,
...
127]}get monsters(){const a=new Set;for(const b of this.locations)if(b.used&&b.hasSpawns)for(const c of b.spawns)c.isMonster()&&a.add(this.objects[c.monsterId]);return[...a].sort((a,c)=>a.id-c.id)}get projectiles(){const a=new Set;for(const b of this.monsters)b.child&&a.add(this.objects[this.adHocSpawns[b.child].objectId]);return[...a].sort((a,c)=>a.id-c.id)}get monsterGraphics(){const a={};for(const b of this.locations)if(b.used&&b.hasSpawns)for(const c of b.spawns)if(!(c.data[2]&7)){const d=c.data[2]&
128?1:0,e=hex$$module$js$rom$util(c.data[3]+80);(a[e]=a[e]||{})[`${d}:${b.spritePatterns[d].toString(16)}:${b.spritePalettes[d].toString(16)}`]={pal:b.spritePalettes[d],pat:b.spritePatterns[d],slot:d}}return a}get locationMonsters(){const a={};for(const b of this.locations){if(!b.used||!b.hasSpawns)continue;const c=a["$"+hex$$module$js$rom$util(b.id)]={};for(const a of b.spawns)if(!(a.data[2]&7)){const b=a.data[2]&128?1:0,d=a.data[3]+80;c[`${b}:${d.toString(16)}`]=(c[`${b}:${d.toString(16)}`]||0)+
...
class Slot$$module$js$rom$spoiler{constructor(a,b,c,d){this.slot=b;this.slotName=c;this.item=d;this.itemName=slotToItem$$module$js$rom$spoiler(a,d);this.originalItem=slotToItem$$module$js$rom$spoiler(a,b)}toString(){return`${this.itemName}: ${this.slotName} (${this.originalItem})`}}function slotToItem$$module$js$rom$spoiler(a,b){return 112<=b?"Mimic":a.items[a.itemGets[b].itemId].messageName}var module$js$rom$spoiler={};module$js$rom$spoiler.Spoiler=Spoiler$$module$js$rom$spoiler;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="latest",LABEL$$module$js$version="latest 0aee459",HASH$$module$js$version="0aee459b325c48682cf1afc019ef7f74e85b593f",DATE$$module$js$version=new Date(1562750715E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$js$flagset(String(b.flags)):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$js$patch(a,parseSeed$$module$js$patch(String(b.seed)),d,new FetchReader$$module$js$fetchreader(c))})}};
...
fixRabbitSkip$$module$js$patch(l);c.shuffleShops()&&shuffleShops$$module$js$patch(l,c,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(l,c,h);const n=World$$module$js$graph$world.build(l,c),p=yield(new AssumedFill$$module$js$graph$shuffle(l,c)).shuffle(n.graph,h,f);if(p)n.traverse(n.graph,p),update$$module$js$rom$slots(l,p.slots);else return-1;rescaleShops$$module$js$patch(l,m,c.bargainHunting()?h:void 0);normalizeSwords$$module$js$patch(l,c,h);rescaleMonsters$$module$js$patch(l,c,h);c.shuffleMonsters()&&
shuffleMonsters$$module$js$patch(l,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(l);c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(l);c.chargeShotsOnly()&&disableStabs$$module$js$patch(l);c.orbsOptional()&&orbsOptional$$module$js$patch(l);shuffleMusic$$module$js$patch(l,c,h);misc$$module$js$patch(l,c,h);c.buffDyna()&&buffDyna$$module$js$patch(l,c);yield l.writeData();buffDyna$$module$js$patch(l,
c);return yield postParsedShuffle$$module$js$patch(a,h,b,c,m,g)})}function postParsedShuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){yield f("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(a,d,e);updateCoinDrops$$module$js$patch(a,d);shuffleRandomNumbers$$module$js$patch(a,b);return stampVersionSeedAndHash$$module$js$patch(a,c,d)})}
