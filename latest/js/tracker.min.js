...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="latest",LABEL$$module$js$version="latest 7439f24",HASH$$module$js$version="7439f241af84341d52dfc65c30bbcc41b11b4a6c",DATE$$module$js$version=new Date(1555230482E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);d=a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$js$patch(b,parseSeed$$module$js$patch(a.seed),d,new FetchReader$$module$js$fetchreader(c))})}};
...
storyMode$$module$js$patch(m);closeCaveEntrances$$module$js$patch(m,c);misc$$module$js$patch(m,c);yield n("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(b,c,h);updateCoinDrops$$module$js$patch(b,c);shuffleRandomNumbers$$module$js$patch(b,g);yield m.writeData();return stampVersionSeedAndHash$$module$js$patch(b,a,c)}),misc$$module$js$patch=(b,a)=>{},closeCaveEntrances$$module$js$patch=(b,a)=>{b.swapMetatiles([144],[7,[1,0],-194],[14,[2,0],-194],[32,[3,10],-216],[33,[4,10],-216]);b.swapMetatiles([148,
156],[104,[1,0],-194],[131,[2,0],-194],[136,[3,10],-216],[137,[4,10],-216]);b.screens[10].tiles[3][8]=1;b.screens[10].tiles[3][9]=2;b.screens[10].tiles[4][8]=3;b.screens[10].tiles[4][9]=4;b.screens[21].tiles[7][9]=1;b.screens[21].tiles[7][10]=2;b.screens[21].tiles[8][9]=3;b.screens[21].tiles[8][10]=4;b.screens[25].tiles[4][8]=1;b.screens[25].tiles[4][9]=2;b.screens[25].tiles[5][8]=3;b.screens[25].tiles[5][9]=4;b.screens[62].tiles[5][6]=1;b.screens[62].tiles[5][7]=2;b.screens[62].tiles[6][6]=3;b.screens[62].tiles[6][7]=
4;var c=[[3,48],[20,48],[21,48],[64,0],[64,20],[65,116],[71,16],[148,0],[152,65]];for(const a of c){const [c,d]=a;b.locations[c].flags.push([239,d])}c=(a,c,f)=>{for(const d of b.locations[a].flags)if(d[1]==c){d[0]=f;return}throw Error(`Could not find flag to replace at ${a}:${c}`);};a.paralysisRequiresPrisonKey()&&(c(20,48,238),c(21,48,238),c(64,0,216),b.locations[64].objects.splice(1,0,[6,6,4,44]),b.locations[64].objects.push([7,7,2,173]))},eastCave$$module$js$patch=(b)=>{},addCordelWestTriggers$$module$js$patch=
(b,a)=>{for(const c of b.locations[21].objects)2===c[2]&&(128>c[3]||a.disableTeleportSkip())&&b.locations[20].objects.push([...c])},fixRabbitSkip$$module$js$patch=(b)=>{for(const a of b.locations[40].objects)2===a[2]&&134===a[3]&&116===a[1]&&(a[0]++,a[1]++)},storyMode$$module$js$patch=(b)=>{const a=b.npcSpawns[203].conditions[166];a.push(~b.npcSpawns[194].conditions[40][0]);a.push(~b.npcSpawns[132].conditions[110][0]);a.push(~b.triggers[26].conditions[1]);a.push(~b.npcSpawns[197].conditions[169][0]);
a.push(~b.npcSpawns[198].conditions[172][0]);a.push(~b.npcSpawns[199].conditions[185][0]);a.push(~b.npcSpawns[200].conditions[182][0]);a.push(~b.npcSpawns[203].conditions[159][0]);a.push(512);a.push(513);a.push(514);a.push(515)},connectLimeTreeToLeaf$$module$js$patch=(b)=>{const a=b.locations[3];b=b.locations[66];a.screens[5][4]=16;b.screens[1][0]=26;b.screens[2][0]=12;const c=a.entrances.push([239,4,120,5])-1,d=b.entrances.push([16,0,192,1])-1;a.exits.push([79,86,66,d],[79,87,66,d]);b.exits.push([0,
27,3,c],[0,28,3,c])},stampVersionSeedAndHash$$module$js$patch=(b,a,c)=>{const d=crc32$$module$js$crc32(b),e=d.toString(16).padStart(8,0).toUpperCase(),f="unstable"==STATUS$$module$js$version?HASH$$module$js$version.substring(0,7).padStart(7,0).toUpperCase()+"     ":VERSION$$module$js$version.substring(0,12).padEnd(12," ");a=a.toString(16).padStart(8,0).toUpperCase();const g=(a,c)=>{for(let d=0;d<c.length;d++)b[a+16+d]=c.charCodeAt(d)},k=(a,b)=>{const c=[];for(let d=0;d<a.length||d<b.length;d++)c.push(a[d]||
" "),c.push(b[d]||" ");return c.join("")};g(161743,k("  VERSION     SEED      ",`  ${f}${a}`));a=String(c);let h;if(46<a.length){if(92<a.length)throw Error("Flag string way too long!");h=a.substring(46,92).padEnd(46," ");a=a.substring(0,46)}a=a.padEnd(46," ");g(161791,k(a.substring(0,23),a.substring(23)));h&&g(161839,k(h.substring(0,23),h.substring(23)));g(161925,k(e.substring(0,4),e.substring(4)));g(153366,"RANDOMIZER");"unstable"==STATUS$$module$js$version&&g(153404,"BETA");return d},patchBytes$$module$js$patch=
(b,a,c)=>{for(let d=0;d<c.length;d++)b[a+16+d]=c[d]},patchWords$$module$js$patch=(b,a,c)=>{for(let d=0;d<2*c.length;d+=2)b[a+16+d]=c[d>>>1]&255,b[a+17+d]=c[d>>>1]>>>8},updateCoinDrops$$module$js$patch=(b,a)=>{a.disableShopGlitch()?patchWords$$module$js$patch(b,216030,[0,5,10,15,25,40,65,105,170,275,445,600,700,800,900,1E3]):patchWords$$module$js$patch(b,216030,[0,1,2,4,8,16,30,50,100,200,300,400,500,600,700,800])},updateDifficultyScalingTables$$module$js$patch=(b,a,c)=>{const d=Array(48).fill(0).map((a,
b)=>b);patchBytes$$module$js$patch(b,c.expand("DiffAtk"),d.map((a)=>Math.round(40+15*a/4)));patchBytes$$module$js$patch(b,c.expand("DiffDef"),d.map((a)=>4*a));const e=a.decreaseEnemyDamage()?16:48,f=a.decreaseEnemyDamage()?6:5.5;patchBytes$$module$js$patch(b,c.expand("DiffHP"),d.map((a)=>Math.min(255,e+Math.round(a*f))));const g=a.expScalingFactor();patchBytes$$module$js$patch(b,c.expand("DiffExp"),d.map((a)=>{a=Math.floor(4*Math.pow(2,(16+9*a)/32)*g);return 128>a?a:Math.min(255,128+(a>>4))}));patchBytes$$module$js$patch(b,
216E3,[0,2,6,10,14,18,32,24,20,0,2,6,10,14,18,16,32,20])},rescaleShops$$module$js$patch=(b,a,c)=>{const d=a.expand("BasePrices");var e=a.expand("InnPrices");const f={prices:138836,items:138792},g={prices:138704,items:138660},k=Array(48).fill(0).map((a,b)=>b);patchBytes$$module$js$patch(b,a.expand("ToolShopScaling"),k.map((a)=>Math.round(8*Math.pow(2,a/10))));patchBytes$$module$js$patch(b,a.expand("ArmorShopScaling"),k.map((a)=>Math.round(8*Math.pow(2,(47-a)/12))));for(var h of[f,g]){const {prices:d,
items:e}=h;for(a=0;44>a;a++)b[d+a+16]=BASE_PRICES$$module$js$patch[b[e+a+16]]?c?c.nextInt(32)+17:32:0}for(h=0;11>h;h++)b[e+h+16]=c?c.nextInt(40)+13:32;c=(a,c)=>{b[d+2*(a-13)+16]=c&255;b[d+2*(a-13)+17]=c>>>8};for(e=13;39>e;e++)c(e,BASE_PRICES$$module$js$patch[e]);c(39,20)},BASE_PRICES$$module$js$patch={13:4,14:16,15:50,16:325,17:1E3,18:2E3,19:4E3,21:6,22:20,23:75,24:250,25:1E3,26:4800,29:25,30:30,31:45,32:40,33:36,34:200,35:150,36:80,38:300},rescaleMonsters$$module$js$patch=(b,a)=>{for(var c of SCALED_MONSTERS$$module$js$patch.keys())for(const b in a.objects){if(SCALED_MONSTERS$$module$js$patch.has(b))return;
