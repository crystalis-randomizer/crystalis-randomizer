...
Condition$$module$js$graph$condition(688);a.OPENED_SWAN=Condition$$module$js$graph$condition(691);a.OPENED_PRISON=Condition$$module$js$graph$condition(728);a.OPENED_SEALED_CAVE=Condition$$module$js$graph$condition(750);a.ALWAYS_TRUE=Condition$$module$js$graph$condition(752);a.WARP_OAK=Condition$$module$js$graph$condition(759);a.WARP_JOEL=Condition$$module$js$graph$condition(763)})(Event$$module$js$graph$condition||(Event$$module$js$graph$condition={}));var Capability$$module$js$graph$condition;
...
[[module$js$graph$condition.Event.ALWAYS_TRUE,and$$module$js$graph$condition()],[module$js$graph$condition.Capability.SWORD,module$js$graph$condition.Item.SWORD_OF_WIND,module$js$graph$condition.Item.SWORD_OF_FIRE,module$js$graph$condition.Item.SWORD_OF_WATER,module$js$graph$condition.Item.SWORD_OF_THUNDER],[module$js$graph$condition.Capability.BREAK_STONE,a],[module$js$graph$condition.Capability.BREAK_ICE,b],[module$js$graph$condition.Capability.FORM_BRIDGE,c],[module$js$graph$condition.Capability.BREAK_IRON,
...
function deterministic$$module$js$pass$deterministic(a,b){addMezameTrigger$$module$js$pass$deterministic(a);normalizeSwords$$module$js$pass$deterministic(a,b);fixCoinSprites$$module$js$pass$deterministic(a);fixMimics$$module$js$pass$deterministic(a);makeBraceletsProgressive$$module$js$pass$deterministic(a);addTowerExit$$module$js$pass$deterministic(a);reversibleSwanGate$$module$js$pass$deterministic(a);adjustGoaFortressTriggers$$module$js$pass$deterministic(a);preventNpcDespawns$$module$js$pass$deterministic(a,
b);b.requireHealedDolphinToRide()&&requireHealedDolphin$$module$js$pass$deterministic(a);b.saharaRabbitsRequireTelepathy()&&requireTelepathyForDeo$$module$js$pass$deterministic(a);adjustItemNames$$module$js$pass$deterministic(a,b);alarmFluteIsKeyItem$$module$js$pass$deterministic(a,b);b.teleportOnThunderSword()?teleportOnThunderSword$$module$js$pass$deterministic(a):noTeleportOnThunderSword$$module$js$pass$deterministic(a);undergroundChannelLandBridge$$module$js$pass$deterministic(a);b.addEastCave()?
eastCave$$module$js$pass$deterministic(a,b):b.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$pass$deterministic(a);closeCaveEntrances$$module$js$pass$deterministic(a,b);simplifyInvisibleChests$$module$js$pass$deterministic(a);addCordelWestTriggers$$module$js$pass$deterministic(a,b);b.disableRabbitSkip()&&fixRabbitSkip$$module$js$pass$deterministic(a);fixReverseWalls$$module$js$pass$deterministic(a);b.chargeShotsOnly()&&disableStabs$$module$js$pass$deterministic(a);b.orbsOptional()&&orbsOptional$$module$js$pass$deterministic(a)}
function addMezameTrigger$$module$js$pass$deterministic(a){const b=a.trigger(135);b.used=!0;b.conditions=[-753];b.message=MessageId$$module$js$rom$messageid.of({action:4});b.flags=[752];a.locations.mezameShrine.spawns.push(Spawn$$module$js$rom$location.of({tile:136,type:2,id:135}))}
...
function eastCave$$module$js$pass$deterministic(a,b){const {valleyOfWind:c,limeTreeValley:d,sealedCave1:e}=a.locations,f=a.locations[11],g=a.locations[13];f.screens=[[156,132,128,131,156],[128,129,131,134,128],[131,136,137,128,128],[129,140,133,130,132],[158,133,156,152,134]];g.screens=[[156,132,155,128,155],[128,129,129,128,129],[128,135,139,138,134],[128,140,128,133,132],[156,134,128,128,154]];for(const a of[f,g])a.entrances=[],a.exits=[],a.pits=[],a.spawns=[],a.flags=[],a.height=a.screens.length,
...
_REVERSIBLE_SWAN_GATE:!0,_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_SIMPLIFY_INVISIBLE_CHESTS:!0,_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword(),_TRAINER:c.trainer(),_UNIDENTIFIED_ITEMS:c.unidentifiedItems(),_ZEBU_STUDENT_GIVES_ITEM:c.zebuStudentGivesItem()},l=new Assembler$$module$js$6502;deterministicPreParse$$module$js$pass$deterministic(a.subarray(16));var m=Object.keys(k).filter((a)=>k[a]).map((a)=>`define ${a} 1\n`).join("");l.assemble(m,"flags.s");yield g("preshuffle.s");
h=new Random$$module$js$random(h);m=new Rom$$module$js$rom(a);"object"==typeof window&&(window.rom=m);m.spoiler=new Spoiler$$module$js$rom$spoiler(m);e&&(e.spoiler=m.spoiler);deterministic$$module$js$pass$deterministic(m,c);yield g("postparse.s");m.scalingLevels=48;m.uniqueItemTableAddress=l.expand("KeyItemData");c.shuffleShops()&&shuffleShops$$module$js$patch(m,c,h);randomizeWalls$$module$js$patch(m,c,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(m,c,h);rescaleMonsters$$module$js$patch(m,
c,h);unidentifiedItems$$module$js$pass$unidentifieditems(m,c,h);shuffleTrades$$module$js$pass$shuffletrades(m,c,h);c.randomizeMaps()&&shuffleMazes$$module$js$pass$shufflemazes(m,c,h);const n=World$$module$js$graph$world.build(m,c),p=yield(new AssumedFill$$module$js$graph$shuffle(m,c)).shuffle(n.graph,h,f);if(p)n.traverse(n.graph,p),update$$module$js$rom$slots(m,p.slots);else return[a,-1];rescaleShops$$module$js$patch(m,l,c.bargainHunting()?h:void 0);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(m,
c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(m);c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(m);shuffleMusic$$module$js$patch(m,c,h);shufflePalettes$$module$js$pass$shufflepalettes(m,c,h);c.blackoutMode()&&blackoutMode$$module$js$patch(m);misc$$module$js$patch(m,c,h);fixDialog$$module$js$pass$fixdialog(m);c.buffDyna()&&buffDyna$$module$js$patch(m,c);c.trainer()&&(m.wildWarp.locations=[10,
26,53,72,109,110,140,170,172,176,182,159,166,88,92,0]);yield m.writeData();buffDyna$$module$js$patch(m,c);h=yield postParsedShuffle$$module$js$patch(a,h,b,c,l,g);EXPAND_PRG$$module$js$patch&&(m=a.subarray(16),m.subarray(507904,524288).set(m.subarray(245760,262144)));return[a,h]})}
