...
{area:(a)=>a.Crypt});this.Crypt_Hall1=$$$module$js$rom$location(161);this.Crypt_Branch=$$$module$js$rom$location(162);this.Crypt_DeadEndLeft=$$$module$js$rom$location(163);this.Crypt_DeadEndRight=$$$module$js$rom$location(164);this.Crypt_Hall2=$$$module$js$rom$location(165);this.Crypt_Draygon2=$$$module$js$rom$location(166);this.Crypt_Teleporter=$$$module$js$rom$location(167);this.GoaFortress_Entrance=$$$module$js$rom$location(168,{area:(a)=>a.GoaFortress,music:KELBESQUE$$module$js$rom$location.music});
...
preventNpcDespawns$$module$js$pass$deterministic(a,b);b.requireHealedDolphinToRide()&&requireHealedDolphin$$module$js$pass$deterministic(a);b.saharaRabbitsRequireTelepathy()&&requireTelepathyForDeo$$module$js$pass$deterministic(a);adjustItemNames$$module$js$pass$deterministic(a,b);alarmFluteIsKeyItem$$module$js$pass$deterministic(a,b);brokahanaWantsMado1$$module$js$pass$deterministic(a);b.teleportOnThunderSword()?teleportOnThunderSword$$module$js$pass$deterministic(a):noTeleportOnThunderSword$$module$js$pass$deterministic(a);
undergroundChannelLandBridge$$module$js$pass$deterministic(a);b.addEastCave()?eastCave$$module$js$pass$deterministic(a,b):b.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$pass$deterministic(a);evilSpiritIslandRequiresDolphin$$module$js$pass$deterministic(a);closeCaveEntrances$$module$js$pass$deterministic(a,b);simplifyInvisibleChests$$module$js$pass$deterministic(a);addCordelWestTriggers$$module$js$pass$deterministic(a,b);b.disableRabbitSkip()&&fixRabbitSkip$$module$js$pass$deterministic(a);
fixReverseWalls$$module$js$pass$deterministic(a);b.chargeShotsOnly()&&disableStabs$$module$js$pass$deterministic(a);b.orbsOptional()&&orbsOptional$$module$js$pass$deterministic(a)}function addMezameTrigger$$module$js$pass$deterministic(a){const b=a.nextFreeTrigger();b.used=!0;b.conditions=[-753];b.message=MessageId$$module$js$rom$messageid.of({action:4});b.flags=[752];a.locations.MezameShrine.spawns.push(Spawn$$module$js$rom$location.of({tile:136,type:2,id:b.id}))}
...
a.npcs[96].spawnConditions.delete(30);g=a.npcs[98];g.data[1]=40;d(g.id,225)[0].message.action=17;d(g.id,225)[2].message.action=17;c(e(g.id,225),-144);a.npcs[104].spawnConditions.set(97,[-156,33]);d(104)[0].message.action=2;d(195)[0].condition=514;a.npcs[196].spawnConditions.delete(242);a.npcs[203].spawnConditions.set(166,[-654]);g=a.npcs[94].localDialogs.get(242);g.unshift(...g.splice(1,1));a.trigger(128).conditions=[-40,59,765];a.trigger(129).conditions=[];b.barrierRequiresCalmSea()&&a.trigger(132).conditions.push(643);
...
0;a.trigger(186).conditions[0]=-581;a.trigger(187).conditions[1]=-28;for(const b of a.npcs)for(const a of b.allDialogs())14===a.condition&&(a.condition=579),-15===a.condition&&(a.condition=-580)}function disableStabs$$module$js$pass$deterministic(a){for(const b of[8,9,39])a.objects[b].collisionPlane=0;a.npcs[84].data[0]=32}function orbsOptional$$module$js$pass$deterministic(a){for(const b of[16,20,24,29])a.objects[b].terrainSusceptibility&=-5,a.objects[b].level=2}
...
const EXPECTED_CRC32$$module$js$rom=466849842,ADJUSTMENTS$$module$js$rom=[[79430,2,6],[83306,0,255],[84715,9,255],[85433,8,128],[87133,255,0],[88093,0,255],[88142,219,255],[89007,240,128],[89014,223,128],[89015,150,128],[89920,2,255],[89953,141,255],[89957,141,255],[91391,11,10],[96298,16,1],[96343,16,1],[106242,64,128],[106243,51,50],[106977,61,52],[118533,71,72],[119569,32,160],[119570,48,0],[118777,96,224],[182928,2,0],[193907,2,0],[195300,95,0]];var module$js$rom={};module$js$rom.Rom=Rom$$module$js$rom;
