...
!0):n.meet(Constraint$$module$js$rom$constraint.MIMIC,!0);else if(a.isNpc()||a.isBoss()){var c=b.getNpcConstraint(e.id,a.id);n=n.meet(c,!0)}else a.isMonster()&&UNTOUCHED_MONSTERS$$module$js$patch[a.monsterId]&&(c=b.getMonsterConstraint(e.id,a.monsterId),n=n.meet(c,!0));g.push(`Initial pass: ${n.fixed.map((a)=>Infinity>a.size?"["+[...a].join(", ")+"]":"all")}`);const q=new Map;c=(a)=>{var c=e.rom.objects[a.id];if(c.monsterClass){var d=q.get(c.monsterClass);if(null!=d&&d!==a.id)return!1}d=FLYERS$$module$js$patch.has(a.id);
...
var module$js$rom$ints={};module$js$rom$ints.uint1=uint1$$module$js$rom$ints;module$js$rom$ints.uint2=uint2$$module$js$rom$ints;module$js$rom$ints.uint3=uint3$$module$js$rom$ints;module$js$rom$ints.uint4=uint4$$module$js$rom$ints;module$js$rom$ints.uint5=uint5$$module$js$rom$ints;module$js$rom$ints.uint6=uint6$$module$js$rom$ints;module$js$rom$ints.uint7=uint7$$module$js$rom$ints;module$js$rom$ints.uint8=uint8$$module$js$rom$ints;module$js$rom$ints.int8=int8$$module$js$rom$ints;class Speeds$$module$js$rom$speeds{constructor(a){this.rom=a}}const ADDRESS_TABLE$$module$js$rom$speeds=214204;var module$js$rom$speeds={};module$js$rom$speeds.Speeds=Speeds$$module$js$rom$speeds;const BOXES$$module$js$tracker="\nsword-of-wind $00\nsword-of-fire $01\nsword-of-water $02\nsword-of-thunder $03\nwindmill-key $32\nstatue-of-onyx $25\ninsect-flute $27\nkey-to-prison $33\nflute-of-lime $28\n\nball-of-wind $05 \nball-of-fire $07\nball-of-water $09\nball-of-thunder $0b\nkirisa-plant $3c\nalarm-flute $31\nfog-lamp $35\nshell-flute $36\nbroken-statue $38\neye-glasses $37\nglowing-lamp $39\n\ntornado-bracelet $06\nflame-bracelet $08\nblizzard-bracelet $0a\nstorm-bracelet $0c\nlove-pendant $3b\nkey-to-styx $34\nopel-statue $26\nsacred-shield $12\nivory-statue $3d\n\nrabbit-boots $2e\ngas-mask $29\nshield-ring $30\niron-necklace $2c\nleather-boots $2f\npower-ring $2a\nwarrior-ring $2b\ndeos-pendant $2d\nbow-of-moon $3e\nbow-of-sun $3f\n\nrefresh $41\nparalysis $42\ntelepathy $43\nteleport $44\nrecover $45\nbarrier $46\nchange $47\nflight $48\npsycho-armor $1c\nbow-of-truth $40\n",
