...
preventNpcDespawns$$module$js$pass$deterministic(a,b);b.requireHealedDolphinToRide()&&requireHealedDolphin$$module$js$pass$deterministic(a);b.saharaRabbitsRequireTelepathy()&&requireTelepathyForDeo$$module$js$pass$deterministic(a);adjustItemNames$$module$js$pass$deterministic(a,b);alarmFluteIsKeyItem$$module$js$pass$deterministic(a,b);b.teleportOnThunderSword()?teleportOnThunderSword$$module$js$pass$deterministic(a):noTeleportOnThunderSword$$module$js$pass$deterministic(a);undergroundChannelLandBridge$$module$js$pass$deterministic(a);
b.addEastCave()?eastCave$$module$js$pass$deterministic(a,b):b.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$pass$deterministic(a);closeCaveEntrances$$module$js$pass$deterministic(a,b);simplifyInvisibleChests$$module$js$pass$deterministic(a);addCordelWestTriggers$$module$js$pass$deterministic(a,b);b.disableRabbitSkip()&&fixRabbitSkip$$module$js$pass$deterministic(a);fixReverseWalls$$module$js$pass$deterministic(a);b.chargeShotsOnly()&&disableStabs$$module$js$pass$deterministic(a);b.orbsOptional()&&
...
g))}a.itemGets[91].itemId=29;c.spawn(25).id=16}function requireHealedDolphin$$module$js$pass$deterministic(a){a.npcs[100].spawnConditions.set(214,[566,37]);a=a.npcs[123].localDialogs.get(-1);a.unshift(a[0].clone());a[0].condition=-38;a[1].condition=-567}function requireTelepathyForDeo$$module$js$pass$deterministic(a){a.npcs[89].globalDialogs.push(GlobalDialog$$module$js$rom$npc.of(-580,[26,18]));a.npcs[90].globalDialogs.push(GlobalDialog$$module$js$rom$npc.of(-580,[26,19]))}
