...
Xb:g).option(Za),Sc=(new Condition$$module$js$nodes(c,"Wind magic")).option(w.value?w:g,W).option(Ia,Ja,W),Tc=(new Condition$$module$js$nodes(c,"Fire magic")).option(w.value?w:g,W).option(Sa,Ta,W),Uc=(new Condition$$module$js$nodes(c,"Water magic")).option(w.value?w:g,W).option(w,W).option(Ua,Va,W),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(w.value?w:g,W).option(w,W).option(Wa,W).option(Xa,W),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(ub).option(ab),
...
A).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,F,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,F,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,A);(new Location$$module$js$nodes(c,39,F,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,A).chest(Ja,25);const hb=(new Location$$module$js$nodes(c,40,x,"Entrance")).overworld().connect(bd,Le,Ke),ib=(new Location$$module$js$nodes(c,40,x,"Upper")).overworld().from(hb,E).to(hb),
Ib=(new Location$$module$js$nodes(c,40,x,"Summit (boss)")).overworld().from(ib,E).to(ib).boss(bf),fd=(new Location$$module$js$nodes(c,41,x,"Connector")).overworld(),Jb=(new Location$$module$js$nodes(c,41,x,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,x,"Middle Right")).overworld().from(Jb,Pc).to(Jb),gd=(new Location$$module$js$nodes(c,42,x,"Tunnel 2a (from entrance to connector)")).cave().connectTo(fd);(new Location$$module$js$nodes(c,42,x,"Tunnel 2b (under bridge, to antidote)")).cave().connect(gd,
A).chest(N,23,94);const hd=(new Location$$module$js$nodes(c,43,x,"Tunnel 3a (branch after connector)")).cave().connect(fd),Of=(new Location$$module$js$nodes(c,43,x,"Tunnel 3b (right branch)")).cave().connect(hd,A),Pf=(new Location$$module$js$nodes(c,43,x,"Tunnel 3c (upper branch)")).cave().connect(hd,A);(new Location$$module$js$nodes(c,44,x,"Tunnel 4 (over bridge, to middle)")).cave().connect(Pf).connectTo(Jb);const id=(new Location$$module$js$nodes(c,45,x,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Of).connectTo(Nf);
(new Location$$module$js$nodes(c,45,x,"Tunnel 5b (dead-end with herb)")).cave().connect(id,A).chest(H,22,83);const Qf=(new Location$$module$js$nodes(c,46,x,"Tunne; 6a (S-shaped hall, right)")).cave().connect(id),Rf=(new Location$$module$js$nodes(c,46,x,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Qf,A),Sf=(new Location$$module$js$nodes(c,46,x,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Rf,A),jd=(new Location$$module$js$nodes(c,47,x,"Prison (hallway)")).cave().connect(ib),Tf=(new Location$$module$js$nodes(c,
48,x,"Left Cell (shopkeepers)")).cave().from(jd,A);(new Location$$module$js$nodes(c,49,x,"Left Cell 2 (back, with prison key)")).cave().from(Tf,A).chest(xb,13);const Uf=(new Location$$module$js$nodes(c,50,x,"Right Cell (villagers)")).cave().from(jd,A),Vf=(new Location$$module$js$nodes(c,51,x,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Uf,A);(new Location$$module$js$nodes(c,52,x,"Tunnel 9 (connector to summit)")).cave().connect(Vf).connectTo(Ib);const Wf=(new Location$$module$js$nodes(c,
53,x,"Summit Cave (front)")).cave().from(Ib,xb).to(Ib),Xf=(new Location$$module$js$nodes(c,53,x,"Summit Cave (behind ice)")).cave().connect(Wf,A).trigger(re);(new Location$$module$js$nodes(c,56,x,"Tunnel 1 (leads from main entrance)")).cave().connect(hb).connectTo(gd);(new Location$$module$js$nodes(c,57,x,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(ib);const Yf=(new Location$$module$js$nodes(c,60,db,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,db,"Tool Shop")).shop(H,N,P,U),$f=(new Location$$module$js$nodes(c,
...
if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return q[a.slotType?a.slotType[0]:"c"]===q[b.slotType?b.slotType[0]:"c"]};p=b.assumedFill(d,(a,b)=>t(a,n.get(b)));if(null==p){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const u=new Map;for(var B=0;B<p.length;B++){var J=p[B];if(null!=J){var y=n.get(b.item(J));J=l.get(y);l.delete(y);y=b.location(B);u.set(y,J);m.delete(y)}}B=(a,b,c)=>{c=void 0===c?"":c;for(const c of m)if(t(c,a))return u.set(c,b),m.delete(c),l.delete(a),!0;
g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var w of l){const [a,b]=w;if(a.isMimic()&&!B(a,b,"traps"))return!1}for(const a of l){const [b,c]=a;if(b.needsChest()&&!B(b,c,"chest"))return!1}for(const a of l){const [b,c]=a;if(!B(b,c))return!1}for(const a of u){const [b,c]=a;b.set(...c)}const {win:K,path:Qa}=a.traverse({wanted:k,dfs:!1});if(!K)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,p));e.items=
...
e.set(module$js$graph$geometry.ScreenId.from(b,a),a.id&3);for(let f=0,g=b.height;f<g;f++){const g=b.screens[f],h=b.id<<8|f<<4;for(let f=0,k=b.width;f<k;f++){var n=function(a,b){if(!p)throw Error("flag expected");return b?a?w(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(p.flag)},b):a};const k=a.screens[g[f]|r],l=module$js$graph$geometry.ScreenId(h|f),m=l&255,q=e.get(l),p=null!=q?c.wallCapability(q):b.flags.find((a)=>a.yx===m),w=memoize2$$module$js$graph$condition((a,
...
a.saveExcursion(()=>{fixBorders$$module$js$maze$cave(a,c,d.edges);return a.trySet(c,d.edges)})){h.add(c);d.wall&&f--;break}r=[...n.stairs.values()];p=0;for(var y=0;10>p&&y<r.length;p++){const b=a.randomPos();!h.has(b)&&a.fill(b,{stair:r[y].dir})&&(h.add(b),p=0,y++)}if(10<=p)return fail$$module$js$maze$cave("could not add all stairs");if(!a.fillAll({edge:1,fuzzy:1,shuffleOrder:!0,skipAlternates:!0}))return fail$$module$js$maze$cave("could not fill open");if(!g(a))return fail$$module$js$maze$cave("check failed after initial setup");
const w={skipAlternates:!0};for(const [c]of b.shuffle([...a])){if(a.density()<=q)break;!a.isFixed(c)&&a.saveExcursion(()=>a.setAndUpdate(c,0,w)&&g(a))}if(!c.allowTightCycles)for(h=1;h<l;h++)for(r=1;r<k;r++)if(p=h<<4|r,isTightCycle$$module$js$maze$cave(a,p)){y=!1;for(const c of b.ishuffle(module$js$maze$maze.Dir.ALL)){const b=2>c?p-1:p-16;a.saveExcursion(()=>a.replaceEdge(b,c,0)&&g(a))&&(y=!0)}if(!y)return fail$$module$js$maze$cave("failed to remove tight cycle")}h=new Set;r=[...a.alternates()];for(const c of[140])if(n.tiles.count(c)){p=
b.shuffle(r.filter((a)=>a[3].tile===c));if(p.length<n.tiles.count(c))return fail$$module$js$maze$cave("could not add stair hallway");for(y=n.tiles.count(c)-1;0<=y;y--)a.replace(p[y][0],p[y][2]),h.add(p[y][0])}r=b.shuffle(r.filter((a)=>a[3].wall));for(p=0;p<f;p++){y=r.pop();if(null==y)return fail$$module$js$maze$cave(`could not add wall ${p}`);h.has(y[0])?p--:(a.replace(y[0],y[2]),h.add(y[0]))}return d(a)};for(let a=0;a<f;a++){const a=new Maze$$module$js$maze$maze(b,l,k,h);if(p(a))return}throw Error("Could not shuffle");
...
"Azteca"],fakeMesia:[132,"Fake Mesia"],akahanaStoned:[136,"Stoned Akahana"],mesia:[142,"Mesia"],rage:[195,"Rage"]};var module$js$rom$npc={};module$js$rom$npc.Npc=Npc$$module$js$rom$npc;module$js$rom$npc.GlobalDialog=GlobalDialog$$module$js$rom$npc;module$js$rom$npc.LocalDialog=LocalDialog$$module$js$rom$npc;module$js$rom$npc.NAMES=NAMES$$module$js$rom$npc;function deterministic$$module$js$pass$deterministic(a,b){fixCoinSprites$$module$js$pass$deterministic(a);fixMimics$$module$js$pass$deterministic(a);makeBraceletsProgressive$$module$js$pass$deterministic(a);closeCaveEntrances$$module$js$pass$deterministic(a,b);reversibleSwanGate$$module$js$pass$deterministic(a);adjustGoaFortressTriggers$$module$js$pass$deterministic(a);preventNpcDespawns$$module$js$pass$deterministic(a,b);b.requireHealedDolphinToRide()&&requireHealedDolphin$$module$js$pass$deterministic(a);
b.saharaRabbitsRequireTelepathy()&&requireTelepathyForDeo$$module$js$pass$deterministic(a);adjustItemNames$$module$js$pass$deterministic(a,b);alarmFluteIsKeyItem$$module$js$pass$deterministic(a);b.teleportOnThunderSword()?teleportOnThunderSword$$module$js$pass$deterministic(a):noTeleportOnThunderSword$$module$js$pass$deterministic(a);undergroundChannelLandBridge$$module$js$pass$deterministic(a);b.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$pass$deterministic(a);simplifyInvisibleChests$$module$js$pass$deterministic(a);
addCordelWestTriggers$$module$js$pass$deterministic(a,b);b.disableRabbitSkip()&&fixRabbitSkip$$module$js$pass$deterministic(a);fixReverseWalls$$module$js$pass$deterministic(a);b.chargeShotsOnly()&&disableStabs$$module$js$pass$deterministic(a);b.orbsOptional()&&orbsOptional$$module$js$pass$deterministic(a)}
...
var m=Object.keys(k).filter((a)=>k[a]).map((a)=>`define ${a} 1\n`).join("");l.assemble(m,"flags.s");yield g("preshuffle.s");h=new Random$$module$js$random(h);m=new Rom$$module$js$rom(a);"object"==typeof window&&(window.rom=m);m.spoiler=new Spoiler$$module$js$rom$spoiler(m);e&&(e.spoiler=m.spoiler);deterministic$$module$js$pass$deterministic(m,c);yield g("postparse.s");m.scalingLevels=48;m.uniqueItemTableAddress=l.expand("KeyItemData");c.shuffleShops()&&shuffleShops$$module$js$patch(m,c,h);randomizeWalls$$module$js$patch(m,
c,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(m,c,h);rescaleMonsters$$module$js$patch(m,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(m,c,h);shuffleTrades$$module$js$pass$shuffletrades(m,c,h);c.randomizeMaps()&&shuffleMazes$$module$js$pass$shufflemazes(m,h);const n=World$$module$js$graph$world.build(m,c),q=yield(new AssumedFill$$module$js$graph$shuffle(m,c)).shuffle(n.graph,h,f);if(q)n.traverse(n.graph,q),update$$module$js$rom$slots(m,q.slots);else return-1;rescaleShops$$module$js$patch(m,
l,c.bargainHunting()?h:void 0);normalizeSwords$$module$js$patch(m,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(m,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(m);c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(m);shuffleMusic$$module$js$patch(m,c,h);shufflePalettes$$module$js$pass$shufflepalettes(m,c,h);c.blackoutMode()&&blackoutMode$$module$js$patch(m);misc$$module$js$patch(m,
c,h);fixDialog$$module$js$pass$fixdialog(m);c.buffDyna()&&buffDyna$$module$js$patch(m,c);yield m.writeData();buffDyna$$module$js$patch(m,c);return yield postParsedShuffle$$module$js$patch(a,h,b,c,l,g)})}
...
const storyMode$$module$js$patch=(a)=>{a.npcs[203].spawnConditions.set(166,[~a.npcs[194].spawnConditions.get(40)[0],~a.npcs[132].spawnConditions.get(110)[0],~a.trigger(154).conditions[1],~a.npcs[197].spawnConditions.get(169)[0],~a.npcs[198].spawnConditions.get(172)[0],~a.npcs[199].spawnConditions.get(185)[0],~a.npcs[200].spawnConditions.get(182)[0],~a.npcs[203].spawnConditions.get(159)[0],512,513,514,515])};
...
[95,345,225],[96,18,94],[97,234,96],[98,18,118],[99,36,54],[100,175,97],[101,139,40],[102,66,160],[105,131,201],[106,76,226],[107,18,100],[108,193,103],[120,199,103],[109,205,103],[115,256,67],[110,24,38],[111,44,97]],KEY$$module$js$tracker=new Set([16,18,35,38,97]);
class Graph$$module$js$tracker{constructor(a,b){this.rom=a;this.world=b;this.slots=new Map;this.items=new Map;this.slotElts=new Map;this.checked=new Set;this.has=Bits$$module$js$bits.of();this.grid=document.getElementsByClassName("grid")[0];this.map=document.getElementsByClassName("map")[0];let c=Bits$$module$js$bits.of();for(const a of b.graph.slots){const {item:b,index:c}=a;null!=b&&this.slots.set(b,c)}for(const d of b.graph.items){const {item:e,index:g}=d;null!=e&&(this.items.set(e,g),(b=a.items[e])&&
b.unique||(c=Bits$$module$js$bits.with(c,g)))}this.has=this.always=c;const d=(a,b)=>{let c=a.target;for(var d=b?"slot":"item";c&&!c.dataset[d];)c=c.parentElement;c&&(d=Number(c.dataset[d]),b?this.checked.has(d)?this.checked.delete(d):this.checked.add(d):this.has=Bits$$module$js$bits.has(this.has,d)?Bits$$module$js$bits.without(this.has,d):Bits$$module$js$bits.with(this.has,d),b||c.classList.toggle("got",Bits$$module$js$bits.has(this.has,d)),this.update(),a.preventDefault())};this.grid.addEventListener("click",
(a)=>d(a,!1));this.map.addEventListener("click",(a)=>d(a,!0))}addSlot(a,b,c){const d=this.slots.get(a);if(null==d){debugger;throw Error();}const e=document.createElement("div"),f=this.rom.itemGets[a],g=f&&this.rom.items[f.itemId];if(g&&g.unique||KEY$$module$js$tracker.has(a))e.classList.add("key"),b--,c--;b--;c--;e.dataset.slot=String(d);e.style.left=b+"px";e.style.top=c+"px";b=document.createElement("div");e.appendChild(b);b.textContent=112<=a?"Mimic":this.rom.items[f.itemId].messageName.replace(" ",
"\u00a0");this.slotElts.set(d,e);this.map.appendChild(e)}addItem(a,b){b=Number.parseInt(b.substring(1),16);a=document.getElementsByClassName(a)[0];var c=document.createElement("div");a.appendChild(c);c=this.items.get(b);null==c&&this.items.set(b,c=this.items.size);a.dataset.item=String(c)}update(){for(var a of this.slotElts){const [b,c]=a;this.checked.has(b)?c.dataset.state="got":c.dataset.state="blocked"}for(const b of traverse$$module$js$graph$shuffle(this.world.graph,newFill$$module$js$graph$shuffle(),
this.has))(a=this.slotElts.get(b))&&"got"!==a.dataset.state&&(a.dataset.state="available")}}let flags$$module$js$tracker="Rlpt Ts";for(const a of location.hash.substring(1).split("&")){const [b,c]=a.split("=");"flags"===b&&(flags$$module$js$tracker=decodeURIComponent(c))}
function main$$module$js$tracker(){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const a=yield Rom$$module$js$rom.load();var b=new FlagSet$$module$js$flagset(flags$$module$js$tracker);deterministic$$module$js$pass$deterministic(a,b);b=World$$module$js$graph$world.build(a,b);const c=new Graph$$module$js$tracker(a,b);for(let a of ITEMS$$module$js$tracker.split("\n"))(a=a.replace(/#.*/,"").trim())&&c.addItem(...a.split(/ +/g));for(const a of SLOTS$$module$js$tracker)c.addSlot(...a);
c.update();document.getElementById("toggle-map").addEventListener("click",()=>{c.map.classList.toggle("hidden")});document.getElementById("clear-all").addEventListener("click",()=>{for(const a of c.grid.querySelectorAll(".got"))a.classList.remove("got");c.has=c.always;c.checked.clear();c.update()})})}main$$module$js$tracker();var module$js$tracker={};
}).call(this)
