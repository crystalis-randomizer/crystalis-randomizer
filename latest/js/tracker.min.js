...
module$js$flagset.PRESETS=PRESETS$$module$js$flagset;module$js$flagset.FLAGS=FLAGS$$module$js$flagset;module$js$flagset.FlagSet=FlagSet$$module$js$flagset;const generate$$module$js$depgraph=(b)=>{const a=new WorldGraph$$module$js$nodes,c=(b,c)=>new Option$$module$js$nodes(a,b,void 0===c?!0:c),d=(b,c)=>new Item$$module$js$nodes(a,b,c,b,null),e=(b,c,...d)=>new Boss$$module$js$nodes(a,b,c,...d),f=(a,c)=>{if(!b)return c;(c=a.startsWith("!"))&&(a=a.substring(1));return b.check(a)^c};new TrackerNode$$module$js$nodes(a,TrackerNode$$module$js$nodes.OFF_ROUTE,"Off-route");const g=new TrackerNode$$module$js$nodes(a,TrackerNode$$module$js$nodes.GLITCH,"Glitch"),
h=new TrackerNode$$module$js$nodes(a,TrackerNode$$module$js$nodes.HARD,"Hard"),k=(a)=>a.value?a:g,n=c("Leather Boots grant speed",f("Ts",!0)),m=k(c("Assume ghetto flight",f("Gf",!0))),q=k(c("Assume statue glitch",f("Gt",!0))),p=c("Allow statue glitch",f("!Ft",!0)),l=k(c("Assume teleport skip",f("Gp",!1))),r=c("Allow teleport skip",f("!Fp",!1)),H=k(c("Assume rabbit skip",f("Gr",!1))),C=k(c("Allow rabbit skip",f("!Fr",!1))),S=k(c("Assume sword charge glitch",f("Gc",!1))),wa=c("Allow sword charge glitch",
f("!Fc",!1)),na=k(c("Assume wild warp",f("Gw",!1))),oa=c("Allow wild warp",f("!Tw",!1)),J=c("Sword magic optional",f("Hw",!1)),F=c("Matching sword optional",f("Hs",!1)),Wb=c("Gas mask optional",f("Hg",!1)),Qd=c("Healed dolphin optional",f("!Rd",!0)),ob=c("Free lunch",f("!Rl",!1)),Rd=c("Sword of Thunder teleports to Shyron",f("Rt",!0)),Xb=c("Barrier magic optional",f("Hb",!0)),Yb=c("Refresh magic optional",f("!Er",!0)),Sd=c("Lime Tree connects to Leaf",f("Rp",!0)),Td=c("Buffed medical herb",f("!Hm",
!0)),T=d(0,"Sword of Wind").weight(b.check("Es")?10:5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),U=d(1,"Sword of Fire").weight(b.check("Es")?10:5).fromPerson("Oak elder",29).dialog(29,null,3).key(),O=d(2,"Sword of Water").weight(10).chest().key(),K=d(3,"Sword of Thunder").weight(15).chest().key(),pb=d(4,"Crystalis").fixed(),Qa=d(5,"Ball of Wind").chest().key(),Ja=d(6,"Tornado Bracelet").chest().key(),Ra=d(7,"Ball of Fire").bossDrop("Insect",1).dialog(30,null,0).dialog(32,
null,0).dialog(33,null,0).dialog(34,null,0).dialog(96,30,0).dialog(29,null,2).dialog(31,null,0).npcSpawn(193).key(),Sa=d(8,"Flame Bracelet").bossDrop("Kelbesque 1",2).npcSpawn(194).key(),Ta=d(9,"Ball of Water").weight(5).direct("Rage",250679).npcSpawn(195).key(),Ua=d(10,"Blizzard Bracelet").weight(5).chest().key(),Va=d(11,"Ball of Thunder").bossDrop("Mado 1",5).trigger(154,1).key(),Wa=d(12,"Storm Bracelet").chest().key(),Zb=d(13,"Carapace Shield").armor(),Ud=d(14,"Bronze Shield").armor(),$b=d(15,
"Platinum Shield").armor(),ac=d(16,"Mirrored Shield").armor(),Vd=d(17,"Ceramic Shield").armor(),qb=d(18,"Sacred Shield").armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),bc=d(19,"Battle Shield").armor(),Wd=d(20,"Psycho Shield").armor(),Xd=d(21,"Tanned Hide").armor(),Yd=d(22,"Leather Armor").armor(),Zd=d(23,"Bronze Armor").armor(),cc=d(24,"Platinmum Armor").armor(),$d=d(25,"Soldier Suit").armor(),dc=d(26,"Ceramic Suit").armor(),ae=d(27,"Battle Suit").armor(),be=d(28,"Psycho Armor").armor().bossDrop("Draygon 1",
10).npcSpawn(203).trigger(159).npcSpawn(131).key(),D=d(29,"Medical Herb").consumable(),I=d(30,"Antidote").consumable(),xa=d(31,"Lysis Plant").consumable(),rb=d(32,"Fruit of Lime").consumable(),L=d(33,"Fruit of Power").consumable(),V=d(34,"Magic Ring").consumable(),sb=d(35,"Fruit of Repun").consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),P=d(36,"Warp Boots").consumable(),ec=d(37,"Statue of Onyx").chest("Cordel grass").invisible(254882).key(),tb=d(38,"Opel Statue").consumable().bossDrop("Kelbesque 2",
6).npcSpawn(197).key(),fc=d(39,"Insect Flute").fromPerson("Oak mother",30).dialog(30,null,1).key(),ub=d(40,"Flute of Lime").fromPerson("Portoa queen",56).direct(39161).dialog(56,null,4).key(),Xa=d(41,"Gas Mask").direct("Akahana in Brynmaer",251902).npcSpawn(22,24).key(),ce=d(42,"Power Ring").chest().bonus(),de=d(43,"Warrior Ring").fromPerson("Akahana's friend",84).dialog(84,null,2).bonus(),ee=d(44,"Iron Necklace").chest().bonus(),fe=d(45,"Deo's Pendant").fromPerson("Deo",90).dialog(90,null,0).bonus(),
vb=d(46,"Rabbit Boots").bossDrop("Vampire 1",0).npcSpawn(192).key(),gc=d(47,f("Ts",!0)?"Speed Boots":"Leather Boots").chest().bonus(),hc=d(48,"Shield Ring").direct("Akahana in waterfall cave",250543).npcSpawn(22,87,2).bonus(),wb=d(49,"Alarm Flute").fromPerson("Zebu's student",20,1).key(),ic=d(50,"Windmill Key").fromPerson("Windmill guard",20).dialog(20,14,0).npcSpawn(20,14,1).key(),xb=d(51,"Key to Prison").chest().key(),jc=d(52,"Key to Styx").fromPerson("Zebu in Shyron",94,1).trigger(128,2).dialog(94,
242,0).dialog(98,242,0).key(),kc=d(53,"Fog Lamp").chest().key(),yb=d(54,"Shell Flute").fromPerson("Dolphin",99,1).npcSpawn(99).key(),lc=d(55,"Eye Glasses").fromPerson("Clark",68).dialog(68,233,1).key(),mc=d(56,"Broken Statue").bossDrop("Sabera 1",4).npcSpawn(127,101).npcSpawn(70).npcSpawn(71).npcSpawn(106).npcSpawn(132).npcSpawn(142).dialog(61).dialog(62).dialog(63).dialog(64).dialog(65).dialog(66).dialog(67).dialog(68,233).trigger(182).key(),nc=d(57,"Glowing Lamp").direct("Kensu in lighthouse",250638).npcSpawn(126,
98,1).key(),oc=d(59,"Love Pendant").chest("Underground channel").invisible(254890).key(),pc=d(60,"Kirisa Plant").chest("Kirisa meadow").invisible(254886).key(),zb=d(61,"Ivory Statue").bossDrop("Karmine",9).npcSpawn(200).key(),qc=d(62,"Bow of Moon").fromPerson("Aryllis",35).direct(251624).dialog(35,null,1).key(),rc=d(63,"Bow of Sun").chest().key(),sc=d(64,"Bow of Truth").fromPerson("Azteca",131).npcSpawn(131,156,1).dialog(131,null,0).key(),Ya=(new Magic$$module$js$nodes(a,65,"Refresh",65,null)).fromPerson("Zebu at windmill",
94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),Ka=(new Magic$$module$js$nodes(a,66,"Paralysis",66,null)).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),pa=(new Magic$$module$js$nodes(a,67,"Telepathy",67,null)).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),tc=(new Magic$$module$js$nodes(a,68,"Teleport",68,null)).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),ge=(new Magic$$module$js$nodes(a,69,"Recover",69,null)).direct("Asina in Portoa",
250361),uc=(new Magic$$module$js$nodes(a,70,"Barrier",70,null)).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),qa=(new Magic$$module$js$nodes(a,71,"Change",71,null)).direct("Kensu in Swan",251614).npcSpawn(116,241,1),z=(new Magic$$module$js$nodes(a,72,"Flight",72,null)).weight(15).direct("Kensu in Draygonia Fortress",250255),he=L.bossDrop("Vampire 2",12,97).npcSpawn(204).key(),M=d(112,"Mimic"),vc=(new Trigger$$module$js$nodes(a,"Talked to Leaf Elder")).get(T),wc=(new Trigger$$module$js$nodes(a,
"Talked to Leaf Student")).get(wb),Ab=new Trigger$$module$js$nodes(a,"Talked to Zebu in cave"),ie=(new Trigger$$module$js$nodes(a,"Woke up Windmill Guard")).get(ic),La=new Trigger$$module$js$nodes(a,"Started Windmill"),xc=(new Trigger$$module$js$nodes(a,"Learned Refresh")).get(Ya),je=(new Trigger$$module$js$nodes(a,"Gave Statue to Akahana")).get(Xa),ke=(new Trigger$$module$js$nodes(a,"Fought Stom")).get(pa),yc=new Trigger$$module$js$nodes(a,"Visited Oak"),zc=new Trigger$$module$js$nodes(a,"Talked to Oak Mother"),
Bb=new Trigger$$module$js$nodes(a,"Rescued Oak Child"),le=(new Trigger$$module$js$nodes(a,"Talked to Oak Mother Again")).get(fc),me=(new Trigger$$module$js$nodes(a,"Talked to Oak Elder")).get(U),ne=(new Trigger$$module$js$nodes(a,"Talked to Tornel on Mt Sabre")).get(tc),Ac=new Trigger$$module$js$nodes(a,"Villagers Abducted"),Bc=new Trigger$$module$js$nodes(a,"Talked to Rabbit in Leaf"),oe=(new Trigger$$module$js$nodes(a,"Learned Paralysis")).get(Ka),Cc=new Trigger$$module$js$nodes(a,"Talked to Portoa Queen"),
Dc=new Trigger$$module$js$nodes(a,"Talked to Fortune Teller"),Ec=new Trigger$$module$js$nodes(a,"Visited Underground Channel"),pe=(new Trigger$$module$js$nodes(a,"Sent to Waterfall Cave")).get(ub),qe=(new Trigger$$module$js$nodes(a,"Cured Akahana")).get(hc),Fc=(new Trigger$$module$js$nodes(a,"Talked to Rage")).get(Ta),Gc=new Trigger$$module$js$nodes(a,"Mesia recording played"),Hc=(new Trigger$$module$js$nodes(a,"Talked to Asina")).get(ge),Ic=(new Trigger$$module$js$nodes(a,"Healed Dolphin")).get(yb),
Cb=new Trigger$$module$js$nodes(a,"Returned Fog Lamp"),Jc=new Trigger$$module$js$nodes(a,"Talked to Kensu in Cabin"),Kc=new Trigger$$module$js$nodes(a,"Talked to Joel Elder"),re=(new Trigger$$module$js$nodes(a,"Talked to Clark")).get(lc),se=(new Trigger$$module$js$nodes(a,"Talked to Kensu in Lighthouse")).get(nc),Db=new Trigger$$module$js$nodes(a,"Calmed the Angry Sea"),te=(new Trigger$$module$js$nodes(a,"Learned Barrier")).get(uc),Lc=new Trigger$$module$js$nodes(a,"Talked to Stom in Swan Hut"),Mc=
new Trigger$$module$js$nodes(a,"Talked to Kensu in Swan tavern"),Nc=new Trigger$$module$js$nodes(a,"Talked to Kensu at Swan dance"),ue=(new Trigger$$module$js$nodes(a,"Returned Kensu's love pendant")).get(qa),ve=(new Trigger$$module$js$nodes(a,"Talked to Amazones Queen")).get(qc),Eb=new Trigger$$module$js$nodes(a,"Entered Shyron"),we=(new Trigger$$module$js$nodes(a,"Talked to Zebu in Shyron")).get(jc),Oc=new Trigger$$module$js$nodes(a,"Shyron Massacre"),xe=(new Trigger$$module$js$nodes(a,"Saved Kensu")).get(z),
ye=(new Trigger$$module$js$nodes(a,"Talked to Deo")).get(fe),ze=(new Trigger$$module$js$nodes(a,"Talked to Akahana's Friend")).get(de),Ae=(new Trigger$$module$js$nodes(a,"Get Bow of Truth")).get(sc),Be=(new Trigger$$module$js$nodes(a,"Forged Crystalis")).get(pb),Za=(new Condition$$module$js$nodes(a,"Sword charge glitch")).option(S,wa),Ce=(new Condition$$module$js$nodes(a,"Rabbit skip")).option(H,C),De=(new Condition$$module$js$nodes(a,"Teleport skip")).option(l,r),$a=(new Condition$$module$js$nodes(a,
"Statue glitch")).option(q,p),Ee=(new Condition$$module$js$nodes(a,"Wild warp")).option(na,oa),ab=(new Condition$$module$js$nodes(a,"Any level 2 sword")).option(T,Qa).option(T,Ja).option(U,Ra).option(U,Sa).option(O,Ta).option(O,Ua).option(K,Va).option(K,Wa),v=(new Condition$$module$js$nodes(a,"Destroy stone")).option(T,Qa).option(T,Ja).option(Za,T,ab),w=(new Condition$$module$js$nodes(a,"Destroy ice")).option(U,Ra).option(U,Sa).option(Za,U,ab),t=(new Condition$$module$js$nodes(a,"Cross rivers")).option(O,
Ta).option(O,Ua).option(z).option(Za,O,ab),ya=(new Condition$$module$js$nodes(a,"Destroy iron")).option(K,Va).option(K,Wa).option(Za,K,ab),aa=(new Condition$$module$js$nodes(a,"Any sword")).option(T).option(U).option(O).option(K),Fe=(new Condition$$module$js$nodes(a,"Match insect sword (fire/water/thunder)")).option(U).option(O).option(K).option(Xa,F.value?F:h,T),Ge=(new Condition$$module$js$nodes(a,"Match vampire 2 sword (wind/water/thunder)")).option(T).option(O).option(K).option(F.value?F:h,U),
Pc=(new Condition$$module$js$nodes(a,"Speed boots")).option(gc,n),Qc=(new Condition$$module$js$nodes(a,"Climb slopes")).option(vb).option(z).option(Pc),He=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (rabbit)")).option(Bc).option(Ce),Ie=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (Teleport)")).option(tc).option(De,z),Rc=(new Condition$$module$js$nodes(a,"Asina in her room")).option(Gc),Je=(new Condition$$module$js$nodes(a,"Paralysis or Asina revealed")).option(Ka).option(Rc).option($a),
Sc=(new Condition$$module$js$nodes(a,"Ride dolphin")).option(yb,Jc),Ke=(new Condition$$module$js$nodes(a,"Ghetto flight")).option(m,Sc,vb),ba=(new Condition$$module$js$nodes(a,"Cross sea")).option(Sc).option(z),Le=(new Condition$$module$js$nodes(a,"Cross whirlpool")).option(Db).option(z).option(Ke),Q=(new Condition$$module$js$nodes(a,"Refresh if needed")).option(Yb.value?Yb:h).option(Ya),Tc=(new Condition$$module$js$nodes(a,"Wind magic")).option(J.value?J:h,Q).option(Qa,Ja,Q),Uc=(new Condition$$module$js$nodes(a,
"Fire magic")).option(J.value?J:h,Q).option(Ra,Sa,Q),Vc=(new Condition$$module$js$nodes(a,"Water magic")).option(J.value?J:h,Q).option(J,Q).option(Ta,Ua,Q),Me=(new Condition$$module$js$nodes(a,"Thunder magic")).option(J.value?J:h,Q).option(J,Q).option(Va,Q).option(Wa,Q),Ne=(new Condition$$module$js$nodes(a,"Flute of lime or glitch")).option(ub).option($a),Oe=(new Condition$$module$js$nodes(a,"Change or glitch")).option(qa).option($a),Pe=(new Condition$$module$js$nodes(a,"Change or glitch or paralysis")).option(qa).option($a).option(Ka),
Fb=(new Condition$$module$js$nodes(a,"Pass shooting statues")).option(uc).option(aa,Xb.value?Xb:h).option(Ya,hc),Qe=(new Condition$$module$js$nodes(a,"Healed dolphin if required")).option(Ic).option(Qd),Wc=(new Condition$$module$js$nodes(a,"Match sword of wind")).option(T).option(F.value?F:h,aa),Xc=(new Condition$$module$js$nodes(a,"Match sword of fire")).option(U).option(F.value?F:h,aa),Yc=(new Condition$$module$js$nodes(a,"Match sword of water")).option(O).option(F.value?F:h,aa),Re=(new Condition$$module$js$nodes(a,
"Match sword of thunder")).option(K).option(F.value?F:h,aa),Se=(new Condition$$module$js$nodes(a,"Swamp run possible")).option(aa).option(Pc).option(Td).option(Ya),Te=(new Condition$$module$js$nodes(a,"Insect possible to kill")).option(Xa),bb=(new Condition$$module$js$nodes(a,"Travel swamp")).option(Xa).option(Wb.value?Wb:h,Se),Ue=(new Condition$$module$js$nodes(a,"Calmed sea if required")).option(Db).option(ob),Ve=(new Condition$$module$js$nodes(a,"Started windmill if required")).option(La).option(ob),
We=e(0,"Vampire 1",aa).get(vb),Xe=e(1,"Insect",fc,Fe,Te).get(Ra),Ye=e(2,"Kelbesque 1",Wc,Tc).get(Sa),Ze=e(12,"Vampire 2",Ge).get(he),Zc=e(4,"Sabera 1",Xc,Uc).get(mc),$e=e(5,"Mado 1",Yc,Vc).get(Va),af=e(6,"Kelbesque 2",Wc,Tc).get(tb),bf=e(7,"Sabera 2",Xc,Uc).get(sb),cf=e(8,"Mado 2",Yc,Vc).get(qb),df=e(9,"Karmine",Re,Me).get(zb),ef=e(10,"Draygon 1",aa).get(be),ff=e(null,"Statues",rc,qc),gf=e(11,"Draygon 2",aa,sc),hf=e(13,"Dyna",pb),jf=(new Condition$$module$js$nodes(a,"Opened prison if required")).option(xb).option(ob),
W=new Area$$module$js$nodes(a,"Leaf"),za=new Area$$module$js$nodes(a,"Valley of Wind"),R=new Area$$module$js$nodes(a,"Sealed Cave"),ra=new Area$$module$js$nodes(a,"Cordel Plain"),Aa=new Area$$module$js$nodes(a,"Brynmaer"),Ba=new Area$$module$js$nodes(a,"Amazones"),A=new Area$$module$js$nodes(a,"Mt Sabre West"),u=new Area$$module$js$nodes(a,"Mt Sabre North"),cb=new Area$$module$js$nodes(a,"Nadare's"),Ma=new Area$$module$js$nodes(a,"Oak"),fa=new Area$$module$js$nodes(a,"Waterfall Valley"),y=new Area$$module$js$nodes(a,
"Portoa"),ha=new Area$$module$js$nodes(a,"Waterfall Cave"),B=new Area$$module$js$nodes(a,"Fog Lamp Cave"),ia=new Area$$module$js$nodes(a,"Kirisa Plant Cave"),sa=new Area$$module$js$nodes(a,"Angry Sea"),ja=new Area$$module$js$nodes(a,"Joel"),G=new Area$$module$js$nodes(a,"Evil Spirit Island"),ka=new Area$$module$js$nodes(a,"Sabera's Castle"),X=new Area$$module$js$nodes(a,"Swan"),x=new Area$$module$js$nodes(a,"Mt Hydra"),la=new Area$$module$js$nodes(a,"Shyron"),ta=new Area$$module$js$nodes(a,"Styx"),
ua=new Area$$module$js$nodes(a,"Goa"),db=new Area$$module$js$nodes(a,"Draygonia Fortress 1"),Y=new Area$$module$js$nodes(a,"Draygonia Fortress 2"),Ca=new Area$$module$js$nodes(a,"Draygonia Fortress 3"),N=new Area$$module$js$nodes(a,"Draygonia Fortress 4"),E=new Area$$module$js$nodes(a,"Oasis Cave");new Area$$module$js$nodes(a,"Desert");const Z=new Area$$module$js$nodes(a,"Sahara"),Da=new Area$$module$js$nodes(a,"Pyramid Front"),ca=new Area$$module$js$nodes(a,"Pyramid Back"),da=new Area$$module$js$nodes(a,
"Tower"),Gb=(new Location$$module$js$nodes(a,0,W,"Start")).overworld().start(),kf=(new Location$$module$js$nodes(a,0,W,"Mezame Shrine")).overworld().from(Gb),lf=(new Location$$module$js$nodes(a,1,W,"Outside Start")).overworld().connect(kf),ma=(new Location$$module$js$nodes(a,2,W,"Town")).town().connect(lf),Na=(new Location$$module$js$nodes(a,3,za,"Main")).overworld().connect(ma).trigger(xc,La),$c=(new Location$$module$js$nodes(a,3,za,"Outside Windmill")).overworld(),ad=(new Location$$module$js$nodes(a,
4,R,"Tunnel 1 (entrance)")).cave().from(Na,La),mf=(new Location$$module$js$nodes(a,5,R,"Tunnel 2 (over bridge)")).cave().connect(ad),nf=(new Location$$module$js$nodes(a,6,R,"Tunnel 6 (herb dead end)")).cave().chest(D,15),bd=(new Location$$module$js$nodes(a,7,R,"Tunnel 4a (ball corridor)")).cave().chest(D,20,80).chest(Qa,21);(new Location$$module$js$nodes(a,7,R,"Tunnel 4b (antidote dead end)")).cave().connect(bd,v).chest(I,19);const of=(new Location$$module$js$nodes(a,8,R,"Tunnel 5 (warp boots dead end)")).cave().chest(P,
14),pf=(new Location$$module$js$nodes(a,9,R,"Tunnel 3a (branch, front)")).cave().connect(mf).connectTo(bd).connectTo(of),qf=(new Location$$module$js$nodes(a,9,R,"Tunnel 3b (branch, back)")).cave().connect(pf,v).connectTo(nf),rf=(new Location$$module$js$nodes(a,10,R,"Tunnel 7 (boss)")).cave().connect(qf).boss(We),sf=(new Location$$module$js$nodes(a,12,R,"Tunnel 8a (exit, above wall)")).cave().connect(rf),tf=(new Location$$module$js$nodes(a,12,R,"Tunnel 8b (exit, below wall")).cave().connect(sf,v);
(new Location$$module$js$nodes(a,14,za,"Windmill Cave")).cave().connect(Na).connectTo($c).trigger(ie,wb,Ab);(new Location$$module$js$nodes(a,15,za,"Windmill")).misc().connect($c).trigger(La,ic);const uf=(new Location$$module$js$nodes(a,16,za,"Zebu's Cave Front")).cave().connect(Na).trigger(Ab,vc,wc).trigger(xc,La,Ab),vf=(new Location$$module$js$nodes(a,16,za,"Zebu's Cave Back")).cave().trigger(Ac).connect(uf,w),wf=(new Location$$module$js$nodes(a,17,A,"Tunnel 1 (to Zebu)")).cave().connect(vf),Ea=
(new Location$$module$js$nodes(a,20,ra,"West")).overworld().connect(tf,Ve),xf=(new Location$$module$js$nodes(a,20,ra,"South")).overworld().connect(Ea,t),cd=(new Location$$module$js$nodes(a,21,ra,"East")).overworld().connect(Ea).chest(ec,24),Oa=(new Location$$module$js$nodes(a,24,Aa,"Town")).town().connect(Ea).trigger(je,ec),yf=(new Location$$module$js$nodes(a,25,ra,"Outside Stom's House")).town().connect(Ea),Hb=(new Location$$module$js$nodes(a,26,ra,"Swamp")).overworld().connect(cd,bb).trigger(Bb,
zc,bb);(new Location$$module$js$nodes(a,26,ra,"Swamp Insect Area")).overworld().connect(Hb,bb).boss(Xe);const eb=(new Location$$module$js$nodes(a,27,Ba,"Town")).town().connect(xf),fb=(new Location$$module$js$nodes(a,28,Ma,"Town")).town().connect(Hb,bb).trigger(yc);(new Location$$module$js$nodes(a,30,ra,"Stom's House")).house().connect(yf).trigger(ke,yc);const Fa=(new Location$$module$js$nodes(a,32,A,"Entrance")).overworld().connect(Ea).connect(wf),zf=(new Location$$module$js$nodes(a,32,A,"Up Slope")).overworld().from(Fa,
Qc).to(Fa),Af=(new Location$$module$js$nodes(a,32,A,"Dead End (warp boots)")).overworld().chest(P,24,106),dd=(new Location$$module$js$nodes(a,33,A,"Upper")).overworld().from(Fa,z).to(Fa),Bf=(new Location$$module$js$nodes(a,33,A,"Tornel Dead End")).overworld().trigger(ne,Ja).chest(V,23,105),ed=(new Location$$module$js$nodes(a,34,A,"Tunnel 2a (fork at start)")).cave().connect(Fa);(new Location$$module$js$nodes(a,34,A,"Tunnel 2b (left branch to dead end)")).cave().connect(ed,w).connectTo(Af);const Cf=
(new Location$$module$js$nodes(a,34,A,"Tunnel 2c (right branch to upper)")).cave().connect(ed,w),Df=(new Location$$module$js$nodes(a,35,A,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Cf).chest(D,23,82),Ef=(new Location$$module$js$nodes(a,35,A,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Df,w).connectTo(dd),fd=(new Location$$module$js$nodes(a,36,A,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(Ef);(new Location$$module$js$nodes(a,36,A,"Tunnel 4b (out to upper)")).cave().connect(fd,
w).connectTo(dd);const Ff=(new Location$$module$js$nodes(a,37,A,"Tunnel 5 (tiny connector)")).cave().connect(fd),Gf=(new Location$$module$js$nodes(a,38,A,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Ff);(new Location$$module$js$nodes(a,38,A,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Gf,w).connectTo(Bf);const Hf=(new Location$$module$js$nodes(a,39,A,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(zf),If=(new Location$$module$js$nodes(a,39,A,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Hf,
w);(new Location$$module$js$nodes(a,39,A,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(If,w).chest(Ja,25);const gb=(new Location$$module$js$nodes(a,40,u,"Entrance")).overworld().connect(cd,Ie,He),hb=(new Location$$module$js$nodes(a,40,u,"Upper")).overworld().from(gb,z).to(gb),Ib=(new Location$$module$js$nodes(a,40,u,"Summit (boss)")).overworld().from(hb,z).to(hb).boss(Ye),gd=(new Location$$module$js$nodes(a,41,u,"Connector")).overworld(),Jb=(new Location$$module$js$nodes(a,41,u,"Middle Left")).overworld(),
Jf=(new Location$$module$js$nodes(a,41,u,"Middle Right")).overworld().from(Jb,Qc).to(Jb),hd=(new Location$$module$js$nodes(a,42,u,"Tunnel 2a (from entrance to connector)")).cave().connectTo(gd);(new Location$$module$js$nodes(a,42,u,"Tunnel 2b (under bridge, to antidote)")).cave().connect(hd,w).chest(I,23,94);const id=(new Location$$module$js$nodes(a,43,u,"Tunnel 3a (branch after connector)")).cave().connect(gd),Kf=(new Location$$module$js$nodes(a,43,u,"Tunnel 3b (right branch)")).cave().connect(id,
w),Lf=(new Location$$module$js$nodes(a,43,u,"Tunnel 3c (upper branch)")).cave().connect(id,w);(new Location$$module$js$nodes(a,44,u,"Tunnel 4 (over bridge, to middle)")).cave().connect(Lf).connectTo(Jb);const jd=(new Location$$module$js$nodes(a,45,u,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Kf).connectTo(Jf);(new Location$$module$js$nodes(a,45,u,"Tunnel 5b (dead-end with herb)")).cave().connect(jd,w).chest(D,22,83);const Mf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6a (S-shaped hall, right)")).cave().connect(jd),
Nf=(new Location$$module$js$nodes(a,46,u,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Mf,w),Of=(new Location$$module$js$nodes(a,46,u,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Nf,w),kd=(new Location$$module$js$nodes(a,47,u,"Prison (hallway)")).cave().connect(hb),Pf=(new Location$$module$js$nodes(a,48,u,"Left Cell (shopkeepers)")).cave().from(kd,w);(new Location$$module$js$nodes(a,49,u,"Left Cell 2 (back, with prison key)")).cave().from(Pf,w).chest(xb,13);const Qf=(new Location$$module$js$nodes(a,
50,u,"Right Cell (villagers)")).cave().from(kd,w),Rf=(new Location$$module$js$nodes(a,51,u,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Qf,w);(new Location$$module$js$nodes(a,52,u,"Tunnel 9 (connector to summit)")).cave().connect(Rf).connectTo(Ib);const Sf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10a (summit cave, front)")).cave().from(Ib,xb).to(Ib),Tf=(new Location$$module$js$nodes(a,53,u,"Tunnel 10b (summit cave, behind ice)")).cave().connect(Sf,w).trigger(oe);(new Location$$module$js$nodes(a,
56,u,"Tunnel 1 (leads from main entrance)")).cave().connect(gb).connectTo(hd);(new Location$$module$js$nodes(a,57,u,"Tunnel 7 (to upper)")).cave().connect(Of).connectTo(hb);const Uf=(new Location$$module$js$nodes(a,60,cb,"Inn")).shop(),Vf=(new Location$$module$js$nodes(a,61,cb,"Tool Shop")).shop(D,I,L,P),Wf=(new Location$$module$js$nodes(a,62,cb,"Back Room")).house(),Kb=(new Location$$module$js$nodes(a,64,fa,"Summit")).overworld().connect(Tf,jf),ib=(new Location$$module$js$nodes(a,64,fa,"Northwest")).overworld().from(Kb).to(Kb,
z),Xf=(new Location$$module$js$nodes(a,64,fa,"Northeast")).overworld().connect(ib,t),ld=(new Location$$module$js$nodes(a,65,fa,"Southwest")).overworld().connect(ib),Yf=(new Location$$module$js$nodes(a,65,fa,"Southeast")).overworld().connect(ld,t),md=(new Location$$module$js$nodes(a,66,fa,"Lime Tree Valley")).overworld().connect(ld).connect(Na,Sd),Zf=(new Location$$module$js$nodes(a,67,fa,"Lime Tree Lake (Rage)")).cave().connect(md).trigger(Fc,O),$f=(new Location$$module$js$nodes(a,68,ia,"Tunnel 1a (entrance)")).cave().connect(Yf),
ag=(new Location$$module$js$nodes(a,68,ia,"Tunnel 1b (behind wall)")).cave().connect($f,v),nd=(new Location$$module$js$nodes(a,69,ia,"Tunnel 2a (main path, before wall)")).cave().connect(ag);(new Location$$module$js$nodes(a,69,ia,"Tunnel 2b (dead end, antidote)")).cave().connect(nd,v).chest(I,25,95);const bg=(new Location$$module$js$nodes(a,69,ia,"Tunnel 2c (main path, after wall)")).cave().connect(nd,v),cg=(new Location$$module$js$nodes(a,70,ia,"Tunnel 3a (last room, before wall)")).cave().connect(bg),
dg=(new Location$$module$js$nodes(a,70,ia,"Tunnel 3b (last room, after wall)")).cave().connect(cg,v);(new Location$$module$js$nodes(a,71,ia,"Meadow")).overworld().connect(dg).chest(pc,14);const eg=(new Location$$module$js$nodes(a,72,B,"Tunnel 1a (entrance)")).cave().connect(Xf),od=(new Location$$module$js$nodes(a,72,B,"Tunnel 1b (past wall)")).cave().connect(eg,v);(new Location$$module$js$nodes(a,72,B,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(od,v).chest(xa,24);const fg=(new Location$$module$js$nodes(a,
73,B,"Tunnel 2 (tiny connector)")).cave().connect(od),pd=(new Location$$module$js$nodes(a,74,B,"Tunnel 3a (upper branch)")).cave().connect(fg);(new Location$$module$js$nodes(a,74,B,"Tunnel 3b (dead end, mimic)")).cave().connect(pd,v).chest(M,21,112);const qd=(new Location$$module$js$nodes(a,74,B,"Tunnel 3c (short passage with mimic)")).cave().connect(pd,v).chest(M,22,113),gg=(new Location$$module$js$nodes(a,74,B,"Tunnel 3d (lower branch)")).cave().connect(qd,v);(new Location$$module$js$nodes(a,75,
B,"Tunnel 4 (dead end loop)")).cave().connect(gg);const rd=(new Location$$module$js$nodes(a,76,B,"Tunnel 5a (right branch over bridge)")).cave().connect(qd),hg=(new Location$$module$js$nodes(a,76,B,"Tunnel 5b (past wall over bridge)")).cave().connect(rd,v),ig=(new Location$$module$js$nodes(a,77,B,"Tunnel 6a (from left branch)")).cave().connect(rd),jg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6b (reconvergence)")).cave().connect(ig,v).connect(hg),kg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6c (between walls)")).cave().connect(jg,
v),lg=(new Location$$module$js$nodes(a,77,B,"Tunnel 6d (under bridge)")).cave().connect(kg,v),mg=(new Location$$module$js$nodes(a,78,B,"Tunnel 7a (over second bridge)")).cave().connect(lg),ng=(new Location$$module$js$nodes(a,78,B,"Tunnel 7b (past wall)")).cave().connect(mg,v),og=(new Location$$module$js$nodes(a,79,B,"Tunnel 8a (under second bridge)")).cave().connect(ng);(new Location$$module$js$nodes(a,79,B,"Tunnel 8b (fog lamp)")).cave().connect(og,v).chest(kc,19);const va=(new Location$$module$js$nodes(a,
80,y,"Town")).town().connect(ib),sd=(new Location$$module$js$nodes(a,81,y,"Fishherman Island")).town().connect(va);(new Location$$module$js$nodes(a,82,fa,"Mesia Shrine")).cave().trigger(Gc).connect(Zf,t,Fc);const td=(new Location$$module$js$nodes(a,84,ha,"Tunnel 1a (entrance)")).cave().connect(ib);(new Location$$module$js$nodes(a,84,ha,"Tunnel 1b (dead end, mimic)")).cave().connect(td,w).chest(M,19,114);const pg=(new Location$$module$js$nodes(a,84,ha,"Tunnel 1c (past ice)")).cave().connect(td,w),
qg=(new Location$$module$js$nodes(a,85,ha,"Tunnel 2 (stoned pair)")).cave().connect(pg),Lb=(new Location$$module$js$nodes(a,86,ha,"Tunnel 3 (wide medusa hallways)")).cave().connect(qg,Ne),rg=(new Location$$module$js$nodes(a,87,ha,"Tunnel 4a (left entrance)")).cave().from(Lb,w).chest(ac.chest().bonus(),25).trigger(qe,ub);(new Location$$module$js$nodes(a,87,ha,"Tunnel 4b (right entrance)")).cave().from(Lb,w).connect(rg,z);(new Location$$module$js$nodes(a,87,ha,"Tunnel 4c (sword of water)")).cave().connect(Lb,
w).chest(O,24);const ud=(new Location$$module$js$nodes(a,88,da,"Entrance")).misc(),sg=(new Location$$module$js$nodes(a,89,da,"Level 1")).misc().from(ud),tg=(new Location$$module$js$nodes(a,90,da,"Level 2")).misc().from(sg),ug=(new Location$$module$js$nodes(a,91,da,"Level 3")).misc().from(tg),vd=(new Location$$module$js$nodes(a,92,da,"Outside Mesia Room")).misc().from(ug),vg=(new Location$$module$js$nodes(a,93,da,"Outside Dyna Room")).misc().from(vd,pb);(new Location$$module$js$nodes(a,94,da,"Mesia")).misc().connect(vd).trigger(Be);
const wg=(new Location$$module$js$nodes(a,95,da,"Dyna")).misc().from(vg).boss(hf);(new Location$$module$js$nodes(a,95,da,"Win")).misc().from(wg).end();const Mb=(new Location$$module$js$nodes(a,96,sa,"Cabin Beach")).sea().from(sd,Cb),Ga=(new Location$$module$js$nodes(a,96,sa,"South")).sea().connect(Mb,ba),xg=(new Location$$module$js$nodes(a,96,sa,"Joel Beach")).sea().connect(Ga,ba),wd=(new Location$$module$js$nodes(a,96,ja,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(a,96,sa,"Altar")).sea().connect(Ga,
ba).trigger(Db,nc,mc);const yg=(new Location$$module$js$nodes(a,96,sa,"North")).sea().to(Ga,ba).from(Ga,ba,Le).trigger(te,Ue),zg=(new Location$$module$js$nodes(a,96,sa,"Swan Beach")).sea().connect(yg,ba);(new Location$$module$js$nodes(a,97,sa,"Cabin")).misc().connect(Mb).trigger(Jc,Cb);(new Location$$module$js$nodes(a,98,ja,"Lighthouse")).misc().connect(wd).trigger(se,wb);const jb=(new Location$$module$js$nodes(a,100,y,"Underground Channel 1 (from throne room)")).sea().trigger(Ec),Ag=(new Location$$module$js$nodes(a,
100,y,"Underground Channel 2 (to fortune teller)")).sea().connect(jb,t),xd=(new Location$$module$js$nodes(a,100,y,"Underground Channel 3 (from fortune teller)")).sea().connect(jb,z),yd=(new Location$$module$js$nodes(a,100,y,"Underground Channel 4 (asina)")).sea().connect(xd,t),Bg=(new Location$$module$js$nodes(a,100,y,"Underground Channel 5 (dolphin)")).sea().connect(yd,t).trigger(Ic,D,Hc);(new Location$$module$js$nodes(a,100,y,"Underground Channel 6 (water)")).sea().connect(Bg,ba).connectTo(Ga,ba).chest(oc,
17);const Nb=(new Location$$module$js$nodes(a,101,G,"Zombie Town")).town(),Cg=(new Location$$module$js$nodes(a,104,G,"Tunnel 1 (entrance)")).sea().connect(Ga,Kc,ba),zd=(new Location$$module$js$nodes(a,105,G,"Tunnel 2a (start)")).cave().connect(Cg);(new Location$$module$js$nodes(a,105,G,"Tunnel 2b (dead end to left)")).cave().connect(zd,t);const Dg=(new Location$$module$js$nodes(a,105,G,"Tunnel 2c (across first river)")).cave().connect(zd,t),Ad=(new Location$$module$js$nodes(a,105,G,"Tunnel 2d (across second river)")).cave().connect(Dg,
t);(new Location$$module$js$nodes(a,105,G,"Tunnel 2e (dead end, magic ring)")).cave().connect(Ad,v).chest(V,29);const Eg=(new Location$$module$js$nodes(a,105,G,"Tunnel 2f (stair down)")).cave().connect(Ad,v),Fg=(new Location$$module$js$nodes(a,106,G,"Tunnel 3a (main area)")).cave().connect(Eg).connectTo(Nb).chest(xa,25,92),Gg=(new Location$$module$js$nodes(a,106,G,"Tunnel 3b (left area toward items)")).cave().connect(Fg,v),Hg=(new Location$$module$js$nodes(a,107,G,"Tunnel 4a (right side, mimic)")).cave().connect(Gg).chest(M,
14,115);(new Location$$module$js$nodes(a,107,G,"Tunnel 4b (left side, iron necklace)")).cave().connect(Hg,t).chest(ee,15);const Ob=(new Location$$module$js$nodes(a,108,ka,"Floor 1")).fortress().connect(Nb),Ig=(new Location$$module$js$nodes(a,108,ka,"Miniboss")).fortress().boss(Ze).connect(Ob);(new Location$$module$js$nodes(a,109,ka,"Floor 2a (left stair)")).fortress().connect(Ob).chest(L,19);const Jg=(new Location$$module$js$nodes(a,109,ka,"Floor 2b (right stair)")).fortress().connect(Ig).chest(D,
30,85),Kg=(new Location$$module$js$nodes(a,110,ka,"Floor 3a (toward boss)")).fortress().connect(Jg),Bd=(new Location$$module$js$nodes(a,110,ka,"Floor 3b (boss room)")).fortress().connect(Kg);(new Location$$module$js$nodes(a,110,ka,"Boss")).fortress().boss(Zc).connect(Bd);(new Location$$module$js$nodes(a,110,ka,"Floor 3c (back room trap)")).fortress().from(Bd).to(Ob);const Lg=(new Location$$module$js$nodes(a,112,ja,"Secret Passage")).cave().connectTo(wd),kb=(new Location$$module$js$nodes(a,113,ja,
"Town")).town().connect(xg),ea=(new Location$$module$js$nodes(a,114,X,"Town")).town().connect(zg),Mg=(new Location$$module$js$nodes(a,115,X,"Inside Gate")).overworld().connect(ea),Ng=(new Location$$module$js$nodes(a,115,X,"Outside Gate")).overworld().from(Mg,qa),lb=(new Location$$module$js$nodes(a,120,ua,"Valley")).overworld().connect(Ng),Pb=(new Location$$module$js$nodes(a,124,x,"Entrance")).overworld().connect(lb),Og=(new Location$$module$js$nodes(a,124,x,"Over first river toward Shyron")).overworld().connect(Pb,
t),Cd=(new Location$$module$js$nodes(a,124,x,"After first tunnel")).overworld(),Dd=(new Location$$module$js$nodes(a,124,x,"Door to Styx")).overworld().connect(Cd,t),Pg=(new Location$$module$js$nodes(a,124,x,"Dead end (no item)")).overworld(),Qg=(new Location$$module$js$nodes(a,124,x,"Dead end (fruit of lime)")).overworld().chest(rb,26),Rg=(new Location$$module$js$nodes(a,124,x,"Dead end (magic ring)")).overworld().chest(V,25,101),Ed=(new Location$$module$js$nodes(a,124,x,"Outside tunnel to bow")).overworld();
(new Location$$module$js$nodes(a,124,x,"Floating island (bow of sun)")).overworld().connect(Ed,z).chest(rc,24);const Sg=(new Location$$module$js$nodes(a,125,x,"Tunnel 1 (to Shyron)")).cave().connect(Og),Tg=(new Location$$module$js$nodes(a,126,x,"Outside Shyron")).overworld().connect(Sg);(new Location$$module$js$nodes(a,127,x,"Tunnel 2 (fork)")).cave().connect(Pb).connectTo(Qg).connectTo(Cd);const Fd=(new Location$$module$js$nodes(a,128,x,"Tunnel 3 (caves)")).cave().connect(Dd).connect(Pg),Gd=(new Location$$module$js$nodes(a,
129,x,"Tunnel 4 (left branch of cave)")).cave().connect(Fd);(new Location$$module$js$nodes(a,130,x,"Tunnel 5 (dead end, medical herb)")).cave().connect(Gd).chest(D,15,86);const Ug=(new Location$$module$js$nodes(a,131,x,"Tunnel 6a (left-then-right)")).cave().connect(Gd),Vg=(new Location$$module$js$nodes(a,131,x,"Tunnel 6b (past wall)")).cave().connect(Ug,v),Wg=(new Location$$module$js$nodes(a,132,x,"Tunnel 7 (wide hall)")).cave().connect(Vg);(new Location$$module$js$nodes(a,133,x,"Tunnel 8 (red slimes)")).cave().from(Wg,
v).connectTo(Ed).chest(M,23,116);const Xg=(new Location$$module$js$nodes(a,134,x,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Fd),Yg=(new Location$$module$js$nodes(a,135,x,"Tunnel 10a (toward magic ring)")).cave().connect(Xg);(new Location$$module$js$nodes(a,135,x,"Tunnel 10b (past wall)")).cave().connect(Yg,v).connectTo(Rg);const Hd=(new Location$$module$js$nodes(a,136,ta,"Entrance")).fortress().from(Dd,jc,Fb),Zg=(new Location$$module$js$nodes(a,137,ta,"Left branch")).fortress().connect(Hd).chest(M,
19,117),$g=(new Location$$module$js$nodes(a,137,ta,"Left branch, past one bridge")).fortress().connect(Zg,t),ah=(new Location$$module$js$nodes(a,137,ta,"Left branch, past two bridges")).fortress().connect($g,t).chest(D,29,87),bh=(new Location$$module$js$nodes(a,137,ta,"Right branch")).fortress().connect(Hd);(new Location$$module$js$nodes(a,137,ta,"Right branch, across water")).fortress().connect(bh,z).chest(M,20,118).chest(M,21,119).chest(Wd,28);(new Location$$module$js$nodes(a,138,ta,"Upper floor")).fortress().connect(ah).chest(K,
27);const Ha=(new Location$$module$js$nodes(a,140,la,"Town")).town().connect(Tg,Oe).trigger(Eb),Pa=(new Location$$module$js$nodes(a,142,ua,"Town")).town().connect(lb),Id=(new Location$$module$js$nodes(a,143,E,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(a,143,E,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Id,ya).chest(ce,15);const Qb=(new Location$$module$js$nodes(a,144,ua,"Desert 1")).overworld().connect(lb),mb=(new Location$$module$js$nodes(a,
145,E,"Area 1 (from entrance)")).cave().chest(gc,26),Jd=(new Location$$module$js$nodes(a,145,E,"Area 2 (across top bridge)")).cave().connect(mb,t);(new Location$$module$js$nodes(a,145,E,"Area 3 (dead-end across top-right bridge)")).cave().connect(Jd,t);const ch=(new Location$$module$js$nodes(a,145,E,"Area 4 (left across middle-right bridge)")).cave().connect(Jd,t),dh=(new Location$$module$js$nodes(a,145,E,"Area 5 (bottom edge)")).cave().connect(ch,t),eh=(new Location$$module$js$nodes(a,145,E,"Area 6 (bottom island)")).cave().connect(dh,
t),fh=(new Location$$module$js$nodes(a,145,E,"Area 7 (bottom inner ring)")).cave().connect(eh,t),gh=(new Location$$module$js$nodes(a,145,E,"Area 8 (left outer ring)")).cave().connect(fh,t).connect(mb,t).chest(L,27,100),hh=(new Location$$module$js$nodes(a,145,E,"Area 9 (top left inner ring)")).cave().connect(gh,t),ih=(new Location$$module$js$nodes(a,145,E,"Area 10 (top right inner ring)")).cave().connect(hh,t);(new Location$$module$js$nodes(a,145,E,"Area 11 (center)")).cave().connect(ih,t).connectTo(Id);
(new Location$$module$js$nodes(a,145,E,"Area 12 (top center islands)")).cave().connect(mb,z).chest(ae,28);const jh=(new Location$$module$js$nodes(a,146,Z,"Desert Cave 1")).cave().connect(Qb,z),Ia=(new Location$$module$js$nodes(a,147,Z,"Town")).town(),kh=(new Location$$module$js$nodes(a,148,Z,"Outside Cave")).overworld().connect(Ia),lh=(new Location$$module$js$nodes(a,149,Z,"Desert Cave 2")).cave().connect(kh);(new Location$$module$js$nodes(a,150,Z,"Meadow")).overworld().connect(jh).connectTo(Ia).trigger(ye,
qa);const Rb=(new Location$$module$js$nodes(a,152,Z,"Desert 2")).overworld().connect(lh),mh=(new Location$$module$js$nodes(a,156,Da,"Entrance")).fortress().connect(Rb,z),nh=(new Location$$module$js$nodes(a,156,Da,"Azteca")).fortress().trigger(Ae),oh=(new Location$$module$js$nodes(a,157,Da,"Fork")).fortress().connect(mh),Kd=(new Location$$module$js$nodes(a,158,Da,"Main")).fortress().connect(oh);(new Location$$module$js$nodes(a,158,Da,"Treasure Chest (magic ring)")).fortress().connect(Kd).chest(V,27,
108);(new Location$$module$js$nodes(a,159,Da,"Draygon")).fortress().connect(Kd).to(nh).boss(ef);const ph=(new Location$$module$js$nodes(a,160,ca,"Entrance")).fortress().connect(Rb,z),qh=(new Location$$module$js$nodes(a,160,ca,"Statues")).fortress().connect(ph).boss(ff),rh=(new Location$$module$js$nodes(a,161,ca,"Hall 1")).fortress().connect(qh),Sb=(new Location$$module$js$nodes(a,162,ca,"Branch")).fortress().connect(rh);(new Location$$module$js$nodes(a,163,ca,"Left Dead End")).fortress().connect(Sb).chest(M,
13,120);(new Location$$module$js$nodes(a,164,ca,"Right Dead End")).fortress().connect(Sb);const sh=(new Location$$module$js$nodes(a,165,ca,"Hall 2")).fortress().connect(Sb).chest(tb,26,109),th=(new Location$$module$js$nodes(a,166,ca,"Draygon 2")).fortress().connect(sh).boss(gf);(new Location$$module$js$nodes(a,167,ca,"Teleporter")).fortress().from(th).to(ud);const Ld=(new Location$$module$js$nodes(a,168,db,"Entrance")).fortress().connect(Pa,Fb).trigger(Oc,K),uh=(new Location$$module$js$nodes(a,169,
db,"Main")).fortress().from(Ld,ya),vh=(new Location$$module$js$nodes(a,169,db,"Boss")).fortress().connect(uh).boss(af),wh=(new Location$$module$js$nodes(a,170,db,"Zebu")).fortress().connect(vh),nb=(new Location$$module$js$nodes(a,171,Y,"Entrance")).fortress().connect(wh);(new Location$$module$js$nodes(a,171,Y,"Dead End Behind Iron (fruit of power)")).fortress().connect(nb,ya).chest(L,28,98);(new Location$$module$js$nodes(a,171,Y,"Dead End Loop Across Closer Bridges")).fortress().connect(nb,t).connect(nb,
t);const xh=(new Location$$module$js$nodes(a,171,Y,"Across First Bridge (fruit of repun)")).fortress().connect(nb,t).chest(sb,30,102),Tb=(new Location$$module$js$nodes(a,171,Y,"Across Second Bridge")).fortress().connect(xh,t);(new Location$$module$js$nodes(a,171,Y,"Dead End Across Two Bridges ()")).fortress().connect(Tb,t).connect(Tb,t).chest(xa,29,93);const yh=(new Location$$module$js$nodes(a,171,Y,"Across Third Bridge")).fortress().connect(Tb,t),zh=(new Location$$module$js$nodes(a,171,Y,"Exit Behind Iron Door")).fortress().connect(yh,
ya),Ah=(new Location$$module$js$nodes(a,172,Y,"Boss")).fortress().connect(zh).boss(bf),Bh=(new Location$$module$js$nodes(a,172,Y,"Tornel")).fortress().connect(Ah),Md=(new Location$$module$js$nodes(a,173,Ca,"Lower")).fortress().connect(Bh).chest(tb,26,99).chest(V,27,111),Ch=(new Location$$module$js$nodes(a,174,Ca,"Upper Loop")).fortress().connect(Md).chest(I,22,96);(new Location$$module$js$nodes(a,174,Ca,"Upper Loop Behind Wall (magic ring)")).fortress().connect(Ch,ya).chest(V,23,107);const Dh=(new Location$$module$js$nodes(a,
175,Ca,"Upper Passage (toward Mado)")).fortress().connect(Md).chest(V,27,84),Ub=(new Location$$module$js$nodes(a,176,N,"Initial Fork")).fortress(),Eh=(new Location$$module$js$nodes(a,177,N,"Left Branch")).fortress().connect(Ub),Nd=(new Location$$module$js$nodes(a,178,N,"Main Area (right branch, over bridges)")).fortress().connect(Ub),Fh=(new Location$$module$js$nodes(a,179,N,"U-shaped Passage (between floors)")).fortress().connect(Nd),Gh=(new Location$$module$js$nodes(a,180,N,"Main Area Lower (under bridge)")).fortress().connect(Eh).connect(Nd).connect(Fh),
Od=(new Location$$module$js$nodes(a,180,N,"Behind Iron Wall")).fortress().connect(Gh,ya),Hh=(new Location$$module$js$nodes(a,181,N,"Lower")).fortress().connect(Od).chest(M,13,121).chest(M,14,122).chest(M,15,123).chest(V,23,88).chest(P,24,110),Ih=(new Location$$module$js$nodes(a,182,N,"Boss Corridor")).fortress().connect(Hh),Jh=(new Location$$module$js$nodes(a,182,N,"Boss")).fortress().connect(Ih,Fb).boss(df);(new Location$$module$js$nodes(a,182,N,"Behind Boss (stormBracelet)")).fortress().connect(Jh).chest(Wa,
18);const Pd=(new Location$$module$js$nodes(a,183,N,"Exit Stairs")).fortress(),Kh=(new Location$$module$js$nodes(a,184,E,"Entrance Back (behind river)")).cave().connect(Pd).chest(L,13,90);(new Location$$module$js$nodes(a,184,E,"Entrance Front")).cave().connect(Kh,z).connectTo(Qb).connectTo(mb);const Lh=(new Location$$module$js$nodes(a,185,Ca,"Boss")).fortress().connect(Dh).boss(cf);(new Location$$module$js$nodes(a,185,Ca,"Asina")).fortress().connect(Lh).connectTo(Ub);(new Location$$module$js$nodes(a,
186,N,"Kensu")).fortress().connect(Od).connectTo(Pd).trigger(xe,zb);(new Location$$module$js$nodes(a,187,ua,"House")).house().connect(Pa).trigger(ze,qa,zb);(new Location$$module$js$nodes(a,188,ua,"Inn")).shop().connect(Pa,Eb);(new Location$$module$js$nodes(a,190,ua,"Tool Shop")).shop(D,I,P,L).connect(Pa,Eb);(new Location$$module$js$nodes(a,191,ua,"Tavern")).shop().connect(Pa);(new Location$$module$js$nodes(a,192,W,"Elder House")).house().connect(ma).trigger(vc);(new Location$$module$js$nodes(a,193,
W,"Rabbit Hut")).house().connect(ma).trigger(Bc,Ac,pa);(new Location$$module$js$nodes(a,194,W,"Inn")).shop().connect(ma);(new Location$$module$js$nodes(a,195,W,"Tool Shop")).shop(D,I,P,L).connect(ma);(new Location$$module$js$nodes(a,196,W,"Armor Shop")).shop(Xd,Zb).connect(ma);(new Location$$module$js$nodes(a,197,W,"Student House")).house().connect(ma).trigger(wc);(new Location$$module$js$nodes(a,198,Aa,"Tavern")).house().connect(Oa);(new Location$$module$js$nodes(a,199,Aa,"Pawn Shop")).shop().connect(Oa);
(new Location$$module$js$nodes(a,200,Aa,"Inn")).shop().connect(Oa);(new Location$$module$js$nodes(a,201,Aa,"Armor Shop")).shop(Yd,Zb,Ud).connect(Oa);(new Location$$module$js$nodes(a,203,Aa,"Tool Shop")).shop(D,I,P).connect(Oa);(new Location$$module$js$nodes(a,205,Ma,"Elder House")).house().from(fb,pa).trigger(me,Bb);(new Location$$module$js$nodes(a,206,Ma,"Mother's House")).house().from(fb,pa).trigger(zc,pa).trigger(le,Bb);(new Location$$module$js$nodes(a,207,Ma,"Tool Shop")).shop(D,I,L).from(fb,
pa);(new Location$$module$js$nodes(a,208,Ma,"Inn")).shop().from(fb,pa);(new Location$$module$js$nodes(a,209,Ba,"Inn")).shop().connect(eb);(new Location$$module$js$nodes(a,210,Ba,"Tool Shop")).shop(P,L,xa).connect(eb);(new Location$$module$js$nodes(a,211,Ba,"Armor Shop")).shop(cc,$b,ac,qb).connect(eb);const Mh=(new Location$$module$js$nodes(a,212,Ba,"Queen's House")).house().from(eb,Pe).trigger(ve,qa,pc);(new Location$$module$js$nodes(a,213,cb,"Nadare's")).house().connect(gb).connectTo(Uf).connectTo(Vf).connectTo(Wf);
(new Location$$module$js$nodes(a,214,y,"Fisherman's House")).house().connect(sd).trigger(Cb,kc,yb,Qe);const Vb=(new Location$$module$js$nodes(a,215,y,"Palace Entrance")).house().connect(va);(new Location$$module$js$nodes(a,216,y,"Fortune Teller Front")).house().connect(va).trigger(Dc,Cc);(new Location$$module$js$nodes(a,216,y,"Fortune Teller Back")).house().connect(Ag).connect(xd);(new Location$$module$js$nodes(a,217,y,"Pawn Shop")).shop().connect(va);(new Location$$module$js$nodes(a,218,y,"Armor Shop")).shop(Zd,
cc,$b).connect(va);(new Location$$module$js$nodes(a,220,y,"Inn")).shop().connect(va);(new Location$$module$js$nodes(a,221,y,"Tool Shop")).shop(D,xa,rb,P).connect(va);(new Location$$module$js$nodes(a,222,y,"Palace Left")).house().connect(Vb);(new Location$$module$js$nodes(a,223,y,"Palace Throne Room")).house().connect(Vb).to(jb,Je).from(jb).trigger(Cc).trigger(pe,Dc,Ec);(new Location$$module$js$nodes(a,224,y,"Palace Right")).house().connect(Vb);(new Location$$module$js$nodes(a,225,y,"Asina's Room")).house().connect(yd).trigger(Hc,
Rc);(new Location$$module$js$nodes(a,226,Ba,"Queen Downstairs")).house().connect(Mh).chest(Ua,13);(new Location$$module$js$nodes(a,227,ja,"Elder's House")).house().connect(kb).trigger(Kc);(new Location$$module$js$nodes(a,228,ja,"Shed")).house().connect(kb).to(Lg,lc);(new Location$$module$js$nodes(a,229,ja,"Tool Shop")).shop(D,I,L,xa).connect(kb);(new Location$$module$js$nodes(a,231,ja,"Inn")).shop().connect(kb);const Nh=(new Location$$module$js$nodes(a,232,G,"Zombie Town House")).house().connect(Nb);
(new Location$$module$js$nodes(a,233,G,"Zombie Town Basement")).house().connect(Nh).trigger(re,Zc);(new Location$$module$js$nodes(a,235,X,"Tool Shop")).shop(D,I,L,P).connect(ea);(new Location$$module$js$nodes(a,236,X,"Stom's Hut")).house().connect(ea).trigger(Lc);(new Location$$module$js$nodes(a,237,X,"Inn")).shop().connect(ea);(new Location$$module$js$nodes(a,238,X,"Armor Shop")).shop($d,dc,Vd,bc).connect(ea);(new Location$$module$js$nodes(a,239,X,"Tavern")).house().connect(ea).trigger(Mc,Lc,Ka);
(new Location$$module$js$nodes(a,240,X,"Pawn Shop")).shop().connect(ea);(new Location$$module$js$nodes(a,241,X,"Dance Hall")).house().connect(ea).trigger(Nc,Mc,Ka).trigger(ue,Nc,oc);const Oh=(new Location$$module$js$nodes(a,242,la,"Temple (pre-massacre)")).fortress().connect(Ha).from(Gb,K,Rd).trigger(we);(new Location$$module$js$nodes(a,242,la,"Temple (post-massacre)")).fortress().from(Oh,Oc).boss($e);(new Location$$module$js$nodes(a,243,la,"Training Hall")).house().connect(Ha);(new Location$$module$js$nodes(a,
244,la,"Hospital")).house().connect(Ha);(new Location$$module$js$nodes(a,245,la,"Armor Shop")).shop(dc,qb,bc).connect(Ha);(new Location$$module$js$nodes(a,246,la,"Tool Shop")).shop(D,I,rb,V).connect(Ha);(new Location$$module$js$nodes(a,247,la,"Inn")).shop().connect(Ha);(new Location$$module$js$nodes(a,248,Z,"Inn")).shop().connect(Ia);(new Location$$module$js$nodes(a,249,Z,"Tool Shop")).shop(I,P,sb,V).connect(Ia);(new Location$$module$js$nodes(a,250,Z,"Elder's House")).house().connect(Ia);(new Location$$module$js$nodes(a,
251,Z,"Pawn Shop")).house().connect(Ia);const Ph=[ma,Na,ad,Ea,Hb,Fa,Kb,md,Mb,ea,lb,Pb,Qb,Ld,Rb];for(const a of Ph)a.from(Gb,Ee);return a},shuffle$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);d.check("Ps")&&f.shuffleShops(a);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);d||(d=new FlagSet$$module$js$flagset("Sbkm Sct"));var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&
k.slots){var n=k.slotType[0];(h[n]=h[n]||[]).push(k)}k=[];n=[];var m={};for(var q of d.flags.S||[]){var p=[];for(var l of q){m[l]=!0;for(var r of h[l])p.push(r),n.push([r,k.length])}k.push(p)}for(var H of"bc")if(m[H])for(q=h[H],l=q.map((a)=>[a.item,a.itemIndex]),a.shuffle(l),r=0;r<q.length;r++)q[r].set(...l[r]);p=(a)=>g.find((b)=>b.vanillaItemName===a);h=p("Sword of Wind");H=p("Sword of Fire");q=p("Ball of Wind");l=p("Ball of Fire");r=p("Statue of Onyx");p=p("Gas Mask");m.k&&a.nextInt(2)&&(H.swap(h),
l.swap(q));m.k&&!a.nextInt(3)&&r.swap(p);m=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(H=0;1E3>H;H++){e&&0==H%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));a.shuffle(n);for(var C of k)a.shuffle(C);q=k.map(()=>-1);l=m[a.nextInt(m.length)];r=[];p=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<l;a++){const [b,c]=n[a],d=k[c][++q[c]];p(b,d)&&
(b.swap(d),r.push([b,d]))}if(!r.length)continue;const {win:b,path:c}=f.traverse({wanted:g,dfs:!1});if(b)h=c;else for(;r.length;){const [a,b]=r.pop();a.swap(b)}}b&&f.write(b);if(c){c.items=[];c.route=[];for(const a of h){const [b,d]=a;c.route.push(d);C=f.nodes[b];null!=C.slotName&&(k=C.slotName,0>k.indexOf(C.orig)&&(k+=` (normally ${C.vanillaItemName})`),c.items.push({slotIndex:C.slotIndex,itemIndex:C.itemIndex,origName:C.vanillaItemName,slotName:C.slotName,itemName:C.item.name,text:`${C.item.name}: ${k}`}))}}}),
shuffle2$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);d.check("Ps")&&f.shuffleShops(a);const g=f.integrate();e&&e.addTasks(1E3);for(let h=0;1E3>h;h++){if(yield shuffle3$$module$js$depgraph(f,g,b,a,c,d,e)){console.log(`success after ${h} attempts`);return}e&&(e.addCompleted(1),0===h%50&&(yield new Promise(requestAnimationFrame)))}return shuffle$$module$js$depgraph(b,a,c,d,e)}),shuffle3$$module$js$depgraph=(b,a,c,d,
e,f,g)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const h=e&&e.stats;var g=b.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);const n=new Map(d.shuffle(g.map((a)=>[a,[a.item,a.itemIndex]]))),m=new Set(d.shuffle(g)),q=new Map,p={};h&&h.seeds++;f||(f=new FlagSet$$module$js$flagset("Sbkm Sct"));(f.flags.S||[]).forEach((a,b)=>{for(const c of a)p[c]=b});for(var l of m)q.set(l.item,l);let r=new Set;const H=(a,b)=>{if(null==p[a.slotType?a.slotType[0]:"c"])return a==
b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!=b.item.inventoryRow&&a.requiresUnique||"armor"==b.item.inventoryRow&&!a.isChest())return!1;if(f.check("Es")){if(0===a.slotIndex)return 4>b.item.id;if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return p[a.slotType?a.slotType[0]:"c"]==p[b.slotType?b.slotType[0]:"c"]};l=a.assumedFill(d,(a,b)=>H(a,q.get(b)));if(null==l){h&&h.endState.key++;return!1;throw Error("Could not fill!");}const C=new Map;for(var S=0;S<l.length;S++){var wa=l[S];if(null!=
wa){var na=q.get(a.item(wa));wa=n.get(na);n.delete(na);na=a.location(S);C.set(na,wa);m.delete(na)}}S=(a,b,c)=>{c=void 0===c?"":c;for(const c of m)if(H(c,a))return C.set(c,b),m.delete(c),n.delete(a),!0;h&&("traps"==c?h.endState.traps++:"chest"==c?h.endState.chest++:h.endState.misc++);return!1};for(var oa of n){const [a,b]=oa;if(a.isMimic()&&!S(a,b,"traps"))return!1}for(const a of n){const [b,c]=a;if(b.needsChest()&&!S(b,c,"chest"))return!1}for(const a of n){const [b,c]=a;if(!S(b,c))return!1}for(const a of C){const [b,
c]=a;b.set(...c)}const {win:J,path:F}=b.traverse({wanted:g,dfs:!1});if(!J)return h&&h.endState.no_win++,!1;c&&b.write(c);if(!e)return!0;h&&(h.endState.success++,h.analyze(b,a,l));e.items=[];e.route=[];for(const a of F){const [c,d]=a;e.route.push(d);g=b.nodes[c];null!=g.slotName&&(oa=g.slotName,0>oa.indexOf(g.orig)&&(oa+=` (normally ${g.vanillaItemName})`),e.items.push({slotIndex:g.slotIndex,itemIndex:g.itemIndex,origName:g.vanillaItemName,slotName:g.slotName,itemName:g.item.name,text:`${g.item.name}: ${oa}`}))}return!0});
var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;module$js$depgraph.shuffle=shuffle$$module$js$depgraph;module$js$depgraph.shuffle2=shuffle2$$module$js$depgraph;module$js$depgraph.shuffle3=shuffle3$$module$js$depgraph;class FetchReader$$module$js$fetchreader{constructor(b){this.path=void 0===b?"js/":b}read(b){const a=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){return yield(yield fetch(a.path+b)).text()})}}var module$js$fetchreader={};module$js$fetchreader.FetchReader=FetchReader$$module$js$fetchreader;class Deque$$module$js$util{constructor(){this.buffer=Array(16);this.mask=15;this.size=this.end=this.start=0}get length(){return this.size}upsize(b){for(;this.mask<b;)this.end<=this.start&&(this.start+=this.mask+1),this.mask=this.mask<<1|1,this.buffer=this.buffer.concat(this.buffer);this.size=b}push(...b){this.upsize(this.size+b.length);for(const a of b)this.buffer[this.end]=a,this.end=this.end+1&this.mask}pop(){if(this.size)return this.end=this.end-1&this.mask,this.size--,this.buffer[this.end]}peek(){if(this.size)return this.buffer[this.end-
...
4<=e.sells.length?g.push(d):e.sells.push(d));for(const {shops:b}of[a,c])for(const a of b)a.sells.sort((a,b)=>a.id-b.id)}integrate(b={}){const {tracker:a=!1}=b;var c=!a;const d=new SparseDependencyGraph$$module$js$graph(this.nodes.length),e=[],f=[],g=new Set,h=new Map;var k=[],n=[];const m=[];var q=[];const p=[];b=new Set;for(var l of this.nodes)if(l instanceof Location$$module$js$nodes){if(l.isStart){const [a]=d.addRoute([l.uid]);h.set(a.label,a)}e[l.uid]=[];f[l.uid]=[];for(const a of l.connections)g.has(a)||
(g.add(a),a.bidi&&g.add(a.reverse()));for(const a of l.chests)d.addRoute([a.uid,l.uid])}else if(l instanceof ItemGet$$module$js$nodes&&"Medical Herb"===l.name&&(d.addRoute([l.uid]),d.finalize(l.uid)),l instanceof Option$$module$js$nodes)k.push(l);else if(l instanceof TrackerNode$$module$js$nodes)n.push(l);else if(l instanceof Condition$$module$js$nodes)m.push(l);else if(l instanceof Trigger$$module$js$nodes)q.push(l);else if(l instanceof ItemGet$$module$js$nodes)p.push(l);else if(l instanceof Slot$$module$js$nodes)b.add(l);
else if(!(l instanceof Area$$module$js$nodes))throw Error(`Unknown node type: ${l.nodeType}`);for(const a of g)e[a.from.uid].push(a),f[a.to.uid].push(a);l=(b)=>{for(const c of b){for(const b of c.edges({tracker:a}))d.addRoute(b);d.finalize(c.uid)}};l(k);c&&l(n);l(q);for(c=h.values();!(k=c.next()).done;){k=k.value;n=k.target;for(var r of e[n]){n=[r.to.uid,...k.deps];for(q=r.deps.length-1;0<=q;q--)n.push(r.deps[q].uid);r.from.bossNode&&n.push(r.from.bossNode.uid);for(const a of d.addRoute(n))h.has(a.label)||
h.set(a.label,a)}}l(m);for(r=0;r<this.nodes.length;r++)this.nodes[r]instanceof ItemGet$$module$js$nodes||this.nodes[r]instanceof TrackerNode$$module$js$nodes||d.finalize(r);r=new LocationList$$module$js$nodes(this);for(const a of b)for(const b of d.nodes[a.uid].values())r.addRoute([a.uid,...b]);return r}}
...
const h=this.worldGraph.nodes[this.itemToUid[g]];e=Bits$$module$js$bits.without(e,g);const k=[...this.traverse(e,f)].filter((a)=>null==f[a]);c.shuffleSlots(h,k,b);let n=!1;for(const b of k)if(null==f[b]&&b!=this.win&&a(this.worldGraph.nodes[this.locationToUid[b]],h)){if(100<b)throw Error("WTF");f[b]=g;n=!0;break}if(!n)return null}return f}}
...
0)}: ${e}`)}swapMetatiles(b,...a){var c=new Map,d=seq$$module$js$rom(256);const e=new Map,f=(a)=>Array.isArray(a)?a[0]:0>a?~a:a;for(var g of a){for(var h=0;h<g.length-1;h++)Array.isArray(g[h])&&(e.set(g[h][0],g[h][1]),g[h]=g[h][0]);for(h=0;h<g.length-1;h++){let a=g[h],b=g[h+1];0>a||0>b||(c.set(b,a),d[b]=a)}}g=new Set;c=new Set;b=new Set(b);for(var k of this.locations)if(k&&b.has(k.tileset)){c.add(k.tileEffects);for(const a of k.allScreens())g.add(a)}for(var n of g)for(var m of n.tiles)for(k=0;k<m.length;k++)m[k]=
d[m[k]];for(var q of b){b=this.tilesets[(q&127)>>>2];for(var p of a)for(d=0;d<p.length-1;d++){n=f(p[d]);m=f(p[d+1]);for(k=0;4>k;k++)b.tiles[k][n]=b.tiles[k][m];b.attrs[n]=b.attrs[m];if(32>m&&b.alternates[m]!=m){if(32<=n)throw Error(`Cannot unflag: ${q} ${n} ${m} ${b.alternates[m]}`);b.alternates[n]=b.alternates[m]}}for(var l of e){const [a,c]=l;b.alternates[a]=c}}for(const d of c){q=this.tileEffects[d-179];for(const c of a)for(p=0;p<c.length-1;p++)l=f(c[p]),b=f(c[p+1]),q.effects[l]=q.effects[b];for(const a of e.keys())q.effects[a]|=
8}}}
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="latest",LABEL$$module$js$version="latest 27e4914",HASH$$module$js$version="27e4914337ecb2600e0bea941990b1dc75521777",DATE$$module$js$version=new Date(1555150366E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);d=a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$js$patch(b,parseSeed$$module$js$patch(a.seed),d,new FetchReader$$module$js$fetchreader(c))})}};
...
_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword()},k=new Assembler$$module$js$6502,n=(a)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){k.assemble(yield d.read(a),a);k.patchRom(b)});var m=Object.keys(h).filter((a)=>h[a]).map((a)=>`define ${a} 1\n`).join("");k.assemble(m,"flags.s");yield n("preshuffle.s");g=new Random$$module$js$random(g);yield shuffle2$$module$js$depgraph(b,g,e,c,f);rescaleShops$$module$js$patch(b,
k,c.bargainHunting()?g:null);m=new Rom$$module$js$rom(b);rescaleMonsters$$module$js$patch(b,m);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(b,m,g);identifyKeyItemsForDifficultyBuffs$$module$js$patch(m);c.doubleBuffMedicalHerb?(b[115996]*=2,b[115962]*=3):c.singleBuffMedicalHerb()&&(b[115996]+=16,b[115962]*=2);c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$patch(m);addCordelWestTriggers$$module$js$patch(m,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$js$patch(m);c.storyMode()&&
storyMode$$module$js$patch(m);closeCaveEntrances$$module$js$patch(m,c);misc$$module$js$patch(m,c);yield n("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(b,c,k);updateCoinDrops$$module$js$patch(b,c);shuffleRandomNumbers$$module$js$patch(b,g);yield m.writeData();return stampVersionSeedAndHash$$module$js$patch(b,a,c)}),misc$$module$js$patch=(b,a)=>{},closeCaveEntrances$$module$js$patch=(b,a)=>{b.swapMetatiles([144],[7,[1,0],-194],[14,[2,0],-194],[32,[3,10],-216],[33,[4,10],-216]);b.swapMetatiles([148,
...
27,3,c],[0,28,3,c])},stampVersionSeedAndHash$$module$js$patch=(b,a,c)=>{const d=crc32$$module$js$crc32(b),e=d.toString(16).padStart(8,0).toUpperCase(),f="unstable"==STATUS$$module$js$version?HASH$$module$js$version.substring(0,7).padStart(7,0).toUpperCase()+"     ":VERSION$$module$js$version.substring(0,12).padEnd(12," ");a=a.toString(16).padStart(8,0).toUpperCase();const g=(a,c)=>{for(let d=0;d<c.length;d++)b[a+16+d]=c.charCodeAt(d)},h=(a,b)=>{const c=[];for(let d=0;d<a.length||d<b.length;d++)c.push(a[d]||
" "),c.push(b[d]||" ");return c.join("")};g(161743,h("  VERSION     SEED      ",`  ${f}${a}`));a=String(c);let k;if(46<a.length){if(92<a.length)throw Error("Flag string way too long!");k=a.substring(46,92).padEnd(46," ");a=a.substring(0,46)}a=a.padEnd(46," ");g(161791,h(a.substring(0,23),a.substring(23)));k&&g(161839,h(k.substring(0,23),k.substring(23)));g(161925,h(e.substring(0,4),e.substring(4)));g(153366,"RANDOMIZER");"unstable"==STATUS$$module$js$version&&g(153404,"BETA");return d},patchBytes$$module$js$patch=
...
,,23,,,],[254,"p","demon wall fire",,,,23,,,]].map((b)=>{var [a,c,d,e=0,f=0,g=0,h=0,k=0,n=0]=b;return[a,{id:a,type:c,name:d,sdef:e,swrd:f,hits:g,satk:h,dgld:k,sexp:n}]}));
...
this.report["$"+d.id.toString(16).padStart(2,0)]=[];const {maxFlyers:g,nonFlyers:h={},fixedSlots:k={}}=MONSTER_ADJUSTMENTS$$module$js$patch[d.id]||{};let n=k.pat0||null,m=k.pat1||null,q=k.pal2||null,p=k.pal3||null,l=g,r=!1;for(const b of d.objects||[])if(2==(b[2]&7)&&(r=!0),!(b[2]&7)){var a=b[3]+80;126==a||127==a||159==a?m=98:143==a&&(n=97)}if(21==d.id||71==d.id)r=!1;f.push(`Initial pass: ${[r,n,m,q,p].join(", ")}`);a=(a)=>{var b=FLYERS$$module$js$patch.has(a.id),c=MOTHS_AND_BATS$$module$js$patch.has(a.id);
if(b){if(!l)return!1;--l}if(null!=q&&null!=a.pal2&&q!=a.pal2||null!=p&&null!=a.pal3&&p!=a.pal3)return!1;var g=!r||TREASURE_CHEST_BANKS$$module$js$patch.has(a.pat);let k;if(d.rom.objects[a.id].child||RETAIN_SLOTS$$module$js$patch.has(a.id)){const b=(k=a.patSlot?128:0)?m:n;if(null!=b&&b!=a.pat)return!1;if(k)m=a.pat;else if(g)n=a.pat;else return!1;f.push(`  Adding ${a.id.toString(16)}: pat(${k}) <-  ${a.pat.toString(16)}`)}else if(null==n&&g||n==a.pat)n=a.pat,k=0,f.push(`  Adding ${a.id.toString(16)}: pat0 <-  ${a.pat.toString(16)}`);
