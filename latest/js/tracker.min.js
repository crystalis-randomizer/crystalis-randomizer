...
48],[g,0],[g,20],[h,116],[k,16],[l,0],[m,65]];b.addEastCave()&&b.connectLimeTreeToLeaf()&&n.push([a.locations.LimeTreeValley,16]);for(const [a,b]of n)a.flags.push(Flag$$module$js$rom$location.of({yx:b,flag:752}));b.paralysisRequiresPrisonKey()&&(c(e,48,750),c(f,48,750),c(g,0,728),a=Spawn$$module$js$rom$location.of({y:96,x:96,type:4,id:44}),b=Spawn$$module$js$rom$location.of({y:112,x:112,type:2,id:173}),g.spawns.splice(1,0,a),g.spawns.push(b))}
function eastCave$$module$js$pass$deterministic(a,b){const {ValleyOfWind:c,LimeTreeValley:d,SealedCave1:e}=a.locations,f=a.locations.allocate(a.locations.EastCave1),g=a.locations.allocate(a.locations.EastCave2);f.screens=[[156,132,128,131,156],[128,129,131,134,128],[131,136,137,128,128],[129,140,133,130,132],[158,133,156,152,134]];g.screens=[[156,132,155,128,155],[128,129,129,128,129],[128,135,139,138,134],[128,140,128,133,132],[156,134,128,128,154]];for(const a of[f,g])a.bgm=23,a.entrances=[],a.exits=
[],a.pits=[],a.spawns=[],a.flags=[],a.height=a.screens.length,a.width=a.screens[0].length,a.extended=0,a.tilePalettes=[26,27,5],a.tileset=136,a.tileEffects=181,a.tilePatterns=[20,2],a.spritePatterns=[...e.spritePatterns],a.spritePalettes=[...e.spritePalettes];c.writeScreens2d(35,[[17,13],[9,194]]);a.tileEffects[0].effects[192]=0;f.connect(67,g,68);f.connect(64,c,52);b.connectLimeTreeToLeaf()&&(d.resizeScreens(0,1,0,0),d.writeScreens2d(0,[[12,17],[21,54],[14,15]]),f.screens[0][4]=151,f.connect(4,d,
16));f.spawns.push(Spawn$$module$js$rom$location.of({screen:33,tile:135,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:18,tile:136,timed:!1,id:2}),Spawn$$module$js$rom$location.of({screen:19,tile:137,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:50,tile:104,timed:!1,id:2}),Spawn$$module$js$rom$location.of({screen:65,tile:136,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:51,tile:152,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:3,tile:136,timed:!0,id:2}));
g.spawns.push(Spawn$$module$js$rom$location.of({screen:1,tile:136,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:17,tile:72,timed:!1,id:2}),Spawn$$module$js$rom$location.of({screen:18,tile:119,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:20,tile:40,timed:!1,id:2}),Spawn$$module$js$rom$location.of({screen:35,tile:133,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:49,tile:136,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:51,tile:138,timed:!1,id:2}),Spawn$$module$js$rom$location.of({screen:52,
tile:152,timed:!0,id:2}),Spawn$$module$js$rom$location.of({screen:65,tile:130,timed:!0,id:2}));b.zebuStudentGivesItem()||g.spawns.push(Spawn$$module$js$rom$location.of({y:272,x:1144,type:2,id:49}))}
