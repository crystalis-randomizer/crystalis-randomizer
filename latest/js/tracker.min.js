...
m.assemble(l,"flags.s");yield g("preshuffle.s");h=new Random$$module$js$random(h);l=new Rom$$module$js$rom(a);fixCoinSprites$$module$js$patch(l);"object"==typeof window&&(window.rom=l);l.spoiler=new Spoiler$$module$js$rom$spoiler(l);e&&(e.slots=l.spoiler.slots,e.route=l.spoiler.route);fixMimics$$module$js$patch(l);makeBraceletsProgressive$$module$js$patch(l);c.blackoutMode()&&blackoutMode$$module$js$patch(l);closeCaveEntrances$$module$js$patch(l,c);reversibleSwanGate$$module$js$patch(l);adjustGoaFortressTriggers$$module$js$patch(l);
preventNpcDespawns$$module$js$patch(l,c);c.requireHealedDolphinToRide()&&requireHealedDolphin$$module$js$patch(l);c.saharaRabbitsRequireTelepathy()&&requireTelepathyForDeo$$module$js$patch(l);adjustItemNames$$module$js$patch(l,c);yield g("postparse.s");alarmFluteIsKeyItem$$module$js$patch(l);c.teleportOnThunderSword()?teleportOnThunderSword$$module$js$patch(l):noTeleportOnThunderSword$$module$js$patch(l);l.scalingLevels=48;l.uniqueItemTableAddress=m.expand("KeyItemData");undergroundChannelLandBridge$$module$js$patch(l);
c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$patch(l);simplifyInvisibleChests$$module$js$patch(l);addCordelWestTriggers$$module$js$patch(l,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$js$patch(l);c.shuffleShops()&&shuffleShops$$module$js$patch(l,c,h);randomizeWalls$$module$js$patch(l,c,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(l,c,h);rescaleMonsters$$module$js$patch(l,c,h);const n=World$$module$js$graph$world.build(l,c),p=yield(new AssumedFill$$module$js$graph$shuffle(l,
c)).shuffle(n.graph,h,f);if(p)n.traverse(n.graph,p),update$$module$js$rom$slots(l,p.slots);else return-1;rescaleShops$$module$js$patch(l,m,c.bargainHunting()?h:void 0);normalizeSwords$$module$js$patch(l,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(l,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(l);c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(l);c.chargeShotsOnly()&&disableStabs$$module$js$patch(l);
c.orbsOptional()&&orbsOptional$$module$js$patch(l);shuffleMusic$$module$js$patch(l,c,h);shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(l,c,h);misc$$module$js$patch(l,c,h);c.buffDyna()&&buffDyna$$module$js$patch(l,c);yield l.writeData();buffDyna$$module$js$patch(l,c);return yield postParsedShuffle$$module$js$patch(a,h,b,c,m,g)})}
