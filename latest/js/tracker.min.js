...
b[a].get(d.tilePatterns[c]);e||b[a].set(d.tilePatterns[c],e=new Set);e.add(d.tilePalettes[a])}}for(const e of a){c=e[1];a=[new Set,new Set];for(d=0;2>d;d++)a[d]=new Set([...b[d].get(c.tilePatterns[0]),...b[d].get(c.tilePatterns[1])]);c=this.random.pick([...a[0]]);a=this.random.pick([...a[1]]);for(const b of e[0])b.tilePalettes[0]=c,b.tilePalettes[1]=a}}}}var module$js$pass$shufflepalettes={};module$js$pass$shufflepalettes.shufflePalettes=shufflePalettes$$module$js$pass$shufflepalettes;const IM1$$module$js$random=2147483563,IM2$$module$js$random=2147483399,AM$$module$js$random=1/IM1$$module$js$random,IMM1$$module$js$random=IM1$$module$js$random-1,IA1$$module$js$random=40014,IA2$$module$js$random=40692,IQ1$$module$js$random=53668,IQ2$$module$js$random=52774,IR1$$module$js$random=12211,IR2$$module$js$random=3791,NTAB$$module$js$random=32,NDIV$$module$js$random=1+Math.floor(IMM1$$module$js$random/NTAB$$module$js$random),EPS$$module$js$random=1.2E-7,RNMX$$module$js$random=1-EPS$$module$js$random;
...
128>this.id},isTrigger(){return 2===this.type&&128<=this.id},isNpc(){return 1===this.type&&192>this.id},isBoss(){return 1===this.type&&192<=this.id},isMonster(){return 0===this.type},isWall(){return!(3!==this.type||!(4>this.id||this.data[2]&32))},toString(){return`Spawn ${this.hex()}: (${hex$$module$js$rom$util(this.x)}, ${hex$$module$js$rom$util(this.y)}) ${this.timed?"timed":"fixed"} ${this.type}:${hex$$module$js$rom$util(this.id)}`}}),LOCATIONS$$module$js$rom$location={mezameShrine:[0,"Mezame Shrine"],
leafOutsideStart:[1,"Leaf - Outside Start"],leaf:[2,"Leaf"],valleyOfWind:[3,"Valley of Wind"],sealedCave1:[4,"Sealed Cave 1"],sealedCave2:[5,"Sealed Cave 2"],sealedCave6:[6,"Sealed Cave 6"],sealedCave4:[7,"Sealed Cave 4"],sealedCave5:[8,"Sealed Cave 5"],sealedCave3:[9,"Sealed Cave 3"],sealedCave7:[10,"Sealed Cave 7"],sealedCave8:[12,"Sealed Cave 8"],windmillCave:[14,"Windmill Cave"],windmill:[15,"Windmill"],zebuCave:[16,"Zebu Cave"],mtSabreWestCave1:[17,"Mt Sabre West - Cave 1"],cordelPlainsWest:[20,
"Cordel Plains West"],cordelPlainsEast:[21,"Cordel Plains East"],brynmaer:[24,"Brynmaer"],outsideStomHouse:[25,"Outside Stom House"],swamp:[26,"Swamp"],amazones:[27,"Amazones"],oak:[28,"Oak"],stomHouse:[30,"Stom House"],mtSabreWestLower:[32,"Mt Sabre West - Lower"],mtSabreWestUpper:[33,"Mt Sabre West - Upper"],mtSabreWestCave2:[34,"Mt Sabre West - Cave 2"],mtSabreWestCave3:[35,"Mt Sabre West - Cave 3"],mtSabreWestCave4:[36,"Mt Sabre West - Cave 4"],mtSabreWestCave5:[37,"Mt Sabre West - Cave 5"],mtSabreWestCave6:[38,
"Mt Sabre West - Cave 6"],mtSabreWestCave7:[39,"Mt Sabre West - Cave 7"],mtSabreNorthMain:[40,"Mt Sabre North - Main"],mtSabreNorthMiddle:[41,"Mt Sabre North - Middle"],mtSabreNorthCave2:[42,"Mt Sabre North - Cave 2"],mtSabreNorthCave3:[43,"Mt Sabre North - Cave 3"],mtSabreNorthCave4:[44,"Mt Sabre North - Cave 4"],mtSabreNorthCave5:[45,"Mt Sabre North - Cave 5"],mtSabreNorthCave6:[46,"Mt Sabre North - Cave 6"],mtSabreNorthPrisonHall:[47,"Mt Sabre North - Prison Hall"],mtSabreNorthLeftCell:[48,"Mt Sabre North - Left Cell"],
...
b]=this.alternates[b]);for(var c=0;4>c;c++)a.rom[this.tileBase+(c<<8)+b]=this.tiles[c][b]}for(b=0;64>b;b++)c=b<<2,a.rom[this.attrBase+b]=this.attrs[c]&3|(this.attrs[c+1]&3)<<2|(this.attrs[c+2]&3)<<4|(this.attrs[c+3]&3)<<6}effects(){let a=this.id>>>2&15;168===this.id&&(a=2);172===this.id&&a--;return this.rom.tileEffects[a]}}
function paletteTypes$$module$js$rom$tileset(a,b){switch(b){case 87:return["main","","out"];case 100:case 104:return["main","","out"]}switch(a){case 128:return["main","out","trim"];case 132:return["main","main","trim"];case 136:return["main","trim",""];case 140:return["main","trim","accept???"]}return["","",""]}
...
module$js$rom$tileset.Tileset=Tileset$$module$js$rom$tileset;const UNUSED_TRIGGERS$$module$js$rom$trigger=new Set([135,136,137,143,147,150,152,155,156,157,158,159,160,181,185,190,192]);
...
h=new Random$$module$js$random(h);l=new Rom$$module$js$rom(a);fixCoinSprites$$module$js$patch(l);"object"==typeof window&&(window.rom=l);l.spoiler=new Spoiler$$module$js$rom$spoiler(l);e&&(e.slots=l.spoiler.slots,e.route=l.spoiler.route);fixMimics$$module$js$patch(l);makeBraceletsProgressive$$module$js$patch(l);c.blackoutMode()&&blackoutMode$$module$js$patch(l);closeCaveEntrances$$module$js$patch(l,c);reversibleSwanGate$$module$js$patch(l);adjustGoaFortressTriggers$$module$js$patch(l);preventNpcDespawns$$module$js$patch(l,
c);c.requireHealedDolphinToRide()&&requireHealedDolphin$$module$js$patch(l);c.saharaRabbitsRequireTelepathy()&&requireTelepathyForDeo$$module$js$patch(l);adjustItemNames$$module$js$patch(l,c);yield g("postparse.s");alarmFluteIsKeyItem$$module$js$patch(l);c.teleportOnThunderSword()?teleportOnThunderSword$$module$js$patch(l):noTeleportOnThunderSword$$module$js$patch(l);l.scalingLevels=48;l.uniqueItemTableAddress=m.expand("KeyItemData");undergroundChannelLandBridge$$module$js$patch(l);c.connectLimeTreeToLeaf()&&
connectLimeTreeToLeaf$$module$js$patch(l);simplifyInvisibleChests$$module$js$patch(l);addCordelWestTriggers$$module$js$patch(l,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$js$patch(l);c.shuffleShops()&&shuffleShops$$module$js$patch(l,c,h);randomizeWalls$$module$js$patch(l,c,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(l,c,h);rescaleMonsters$$module$js$patch(l,c,h);const n=World$$module$js$graph$world.build(l,c),p=yield(new AssumedFill$$module$js$graph$shuffle(l,c)).shuffle(n.graph,
h,f);if(p)n.traverse(n.graph,p),update$$module$js$rom$slots(l,p.slots);else return-1;rescaleShops$$module$js$patch(l,m,c.bargainHunting()?h:void 0);normalizeSwords$$module$js$patch(l,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(l,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(l);c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(l);c.chargeShotsOnly()&&disableStabs$$module$js$patch(l);
c.orbsOptional()&&orbsOptional$$module$js$patch(l);shuffleMusic$$module$js$patch(l,c,h);shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);misc$$module$js$patch(l,c,h);c.buffDyna()&&buffDyna$$module$js$patch(l,c);yield l.writeData();buffDyna$$module$js$patch(l,c);return yield postParsedShuffle$$module$js$patch(a,h,b,c,m,g)})}
