...
a.assumeGhettoFlight())),l=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),p=h(d("Assume teleport skip",a.assumeTeleportSkip())),q=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),t=h(d("Allow rabbit skip",!a.disableRabbitSkip())),u=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),H=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),W=h(d("Assume wild warp",a.assumeWildWarp())),
pa=d("Allow wild warp",a.allowWildWarp()),x=d("Sword magic optional",!a.guaranteeSwordMagic()),I=d("Matching sword optional",!a.guaranteeMatchingSword()),Qa=d("Gas mask optional",!a.guaranteeGasMask()),Pd=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),Qd=d("Calm sea optional",!a.barrierRequiresCalmSea()),Rd=d("Prison key optional",!a.paralysisRequiresPrisonKey()),Sd=d("Windmill optional",!a.sealedCaveRequiresWindmill()),Td=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
...
Xb:g).option(Za),Sc=(new Condition$$module$js$nodes(c,"Wind magic")).option(x.value?x:g,U).option(Ia,Ja,U),Tc=(new Condition$$module$js$nodes(c,"Fire magic")).option(x.value?x:g,U).option(Sa,Ta,U),Uc=(new Condition$$module$js$nodes(c,"Water magic")).option(x.value?x:g,U).option(x,U).option(Ua,Va,U),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(x.value?x:g,U).option(x,U).option(Wa,U).option(Xa,U),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(ub).option(ab),
...
34,D,"Tunnel 2a (fork at start)")).cave().connect(Ea);(new Location$$module$js$nodes(c,34,D,"Tunnel 2b (left branch to dead end)")).cave().connect(dd,z).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,D,"Tunnel 2c (right branch to upper)")).cave().connect(dd,z),Hf=(new Location$$module$js$nodes(c,35,D,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(F,23,82),If=(new Location$$module$js$nodes(c,35,D,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,
z).connectTo(cd),ed=(new Location$$module$js$nodes(c,36,D,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,D,"Tunnel 4b (out to upper)")).cave().connect(ed,z).connectTo(cd);const Jf=(new Location$$module$js$nodes(c,37,D,"Tunnel 5 (tiny connector)")).cave().connect(ed),Kf=(new Location$$module$js$nodes(c,38,D,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);(new Location$$module$js$nodes(c,38,D,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,
z).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,D,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,D,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,z);(new Location$$module$js$nodes(c,39,D,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,z).chest(Ja,25);const hb=(new Location$$module$js$nodes(c,40,w,"Entrance")).overworld().connect(bd,Le,Ke),ib=(new Location$$module$js$nodes(c,40,w,"Upper")).overworld().from(hb,C).to(hb),
...
wb);const kb=(new Location$$module$js$nodes(c,100,B,"Underground Channel 1 (from throne room)")).sea().trigger(Dc),Eg=(new Location$$module$js$nodes(c,100,B,"Underground Channel 2 (to fortune teller)")).sea().connect(kb,v),wd=(new Location$$module$js$nodes(c,100,B,"Underground Channel 3 (from fortune teller)")).sea().connect(kb,C),xd=(new Location$$module$js$nodes(c,100,B,"Underground Channel 4 (asina)")).sea().connect(wd,v),Fg=(new Location$$module$js$nodes(c,100,B,"Underground Channel 5 (dolphin)")).sea().connect(xd,
v).trigger(Hc,F,Gc);(new Location$$module$js$nodes(c,100,B,"Underground Channel 6 (water)")).sea().connect(Fg,ca).connectTo(Fa,ca).chest(nc,17);const Nb=(new Location$$module$js$nodes(c,101,J,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,J,"Tunnel 1 (entrance)")).sea().connect(Fa,Jc,ca),yd=(new Location$$module$js$nodes(c,105,J,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,J,"Tunnel 2b (dead end to left)")).cave().connect(yd,v);const Hg=(new Location$$module$js$nodes(c,
105,J,"Tunnel 2c (across first river)")).cave().connect(yd,v),zd=(new Location$$module$js$nodes(c,105,J,"Tunnel 2d (across second river)")).cave().connect(Hg,v);(new Location$$module$js$nodes(c,105,J,"Tunnel 2e (dead end, magic ring)")).cave().connect(zd,y).chest(X,29);const Ig=(new Location$$module$js$nodes(c,105,J,"Tunnel 2f (stair down)")).cave().connect(zd,y),Jg=(new Location$$module$js$nodes(c,106,J,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(Nb).chest(wa,25,92),Kg=(new Location$$module$js$nodes(c,
106,J,"Tunnel 3b (left area toward items)")).cave().connect(Jg,y),Lg=(new Location$$module$js$nodes(c,107,J,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(O,14,115);(new Location$$module$js$nodes(c,107,J,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,v).chest(he,15);const Ob=(new Location$$module$js$nodes(c,108,ma,"Floor 1")).fortress().connect(Nb),Mg=(new Location$$module$js$nodes(c,108,ma,"Miniboss")).fortress().boss(cf).connect(Ob);(new Location$$module$js$nodes(c,109,ma,
...
124,A,"Entrance")).overworld().connect(mb),Sg=(new Location$$module$js$nodes(c,124,A,"Over first river toward Shyron")).overworld().connect(Pb,v),Bd=(new Location$$module$js$nodes(c,124,A,"After first tunnel")).overworld(),Cd=(new Location$$module$js$nodes(c,124,A,"Door to Styx")).overworld().connect(Bd,v),Tg=(new Location$$module$js$nodes(c,124,A,"Dead end (no item)")).overworld(),Ug=(new Location$$module$js$nodes(c,124,A,"Dead end (fruit of lime)")).overworld().chest(rb,26),Vg=(new Location$$module$js$nodes(c,
124,A,"Dead end (magic ring)")).overworld().chest(X,25,101),Dd=(new Location$$module$js$nodes(c,124,A,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(c,124,A,"Floating island (bow of sun)")).overworld().connect(Dd,C).chest(qc,24);const Wg=(new Location$$module$js$nodes(c,125,A,"Tunnel 1 (to Shyron)")).cave().connect(Sg),Xg=(new Location$$module$js$nodes(c,126,A,"Outside Shyron")).overworld().connect(Wg);(new Location$$module$js$nodes(c,127,A,"Tunnel 2 (fork)")).cave().connect(Pb).connectTo(Ug).connectTo(Bd);
const Ed=(new Location$$module$js$nodes(c,128,A,"Tunnel 3 (caves)")).cave().connect(Cd).connect(Tg),Fd=(new Location$$module$js$nodes(c,129,A,"Tunnel 4 (left branch of cave)")).cave().connect(Ed);(new Location$$module$js$nodes(c,130,A,"Tunnel 5 (dead end, medical herb)")).cave().connect(Fd).chest(F,15,86);const Yg=(new Location$$module$js$nodes(c,131,A,"Tunnel 6a (left-then-right)")).cave().connect(Fd),Zg=(new Location$$module$js$nodes(c,131,A,"Tunnel 6b (past wall)")).cave().connect(Yg,y),$g=(new Location$$module$js$nodes(c,
132,A,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,A,"Tunnel 8 (red slimes)")).cave().from($g,y).connectTo(Dd).chest(O,23,116);const ah=(new Location$$module$js$nodes(c,134,A,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Ed),bh=(new Location$$module$js$nodes(c,135,A,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,135,A,"Tunnel 10b (past wall)")).cave().connect(bh,y).connectTo(Vg);const Gd=(new Location$$module$js$nodes(c,
...
C).chest(O,20,118).chest(O,21,119).chest(Zd,28);(new Location$$module$js$nodes(c,138,ta,"Upper floor")).fortress().connect(eh).chest(K,27);const Ga=(new Location$$module$js$nodes(c,140,na,"Town")).town().connect(Xg,Re).trigger(Eb),Pa=(new Location$$module$js$nodes(c,142,ua,"Town")).town().connect(mb),Hd=(new Location$$module$js$nodes(c,143,G,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,G,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Hd,
xa).chest(fe,15);const Qb=(new Location$$module$js$nodes(c,144,ua,"Desert 1")).overworld().connect(mb),nb=(new Location$$module$js$nodes(c,145,G,"Area 1 (from entrance)")).cave().chest(fc,26),Id=(new Location$$module$js$nodes(c,145,G,"Area 2 (across top bridge)")).cave().connect(nb,v);(new Location$$module$js$nodes(c,145,G,"Area 3 (dead-end across top-right bridge)")).cave().connect(Id,v);const gh=(new Location$$module$js$nodes(c,145,G,"Area 4 (left across middle-right bridge)")).cave().connect(Id,
v),hh=(new Location$$module$js$nodes(c,145,G,"Area 5 (bottom edge)")).cave().connect(gh,v),ih=(new Location$$module$js$nodes(c,145,G,"Area 6 (bottom island)")).cave().connect(hh,v),jh=(new Location$$module$js$nodes(c,145,G,"Area 7 (bottom inner ring)")).cave().connect(ih,v),kh=(new Location$$module$js$nodes(c,145,G,"Area 8 (left outer ring)")).cave().connect(jh,v).connect(nb,v).chest(N,27,100),lh=(new Location$$module$js$nodes(c,145,G,"Area 9 (top left inner ring)")).cave().connect(kh,v),mh=(new Location$$module$js$nodes(c,
145,G,"Area 10 (top right inner ring)")).cave().connect(lh,v);(new Location$$module$js$nodes(c,145,G,"Area 11 (center)")).cave().connect(mh,v).connectTo(Hd);(new Location$$module$js$nodes(c,145,G,"Area 12 (top center islands)")).cave().connect(nb,C).chest(de,28);const nh=(new Location$$module$js$nodes(c,146,ba,"Desert Cave 1")).cave().connect(Qb,C),Ha=(new Location$$module$js$nodes(c,147,ba,"Town")).town(),oh=(new Location$$module$js$nodes(c,148,ba,"Outside Cave")).overworld().connect(Ha),ph=(new Location$$module$js$nodes(c,
...
Nh=(new Location$$module$js$nodes(c,182,P,"Boss")).fortress().connect(Mh,Fb).boss(hf);(new Location$$module$js$nodes(c,182,P,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(Xa,18);const Od=(new Location$$module$js$nodes(c,183,P,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,184,G,"Entrance Back (behind river)")).cave().connect(Od).chest(N,13,90);(new Location$$module$js$nodes(c,184,G,"Entrance Front")).cave().connect(Oh,C).connectTo(Qb).connectTo(nb);const Ph=(new Location$$module$js$nodes(c,
...
Se).trigger(ye,qa,oc);(new Location$$module$js$nodes(c,213,db,"Nadare's")).house().connect(hb).connectTo(Yf).connectTo(Zf).connectTo($f);(new Location$$module$js$nodes(c,214,B,"Fisherman's House")).house().connect(rd).trigger(Cb,jc,yb,Te);const Vb=(new Location$$module$js$nodes(c,215,B,"Palace Entrance")).house().connect(va);(new Location$$module$js$nodes(c,216,B,"Fortune Teller Front")).house().connect(va).trigger(Cc,Bc);(new Location$$module$js$nodes(c,216,B,"Fortune Teller Back")).house().connect(Eg).connect(wd);
(new Location$$module$js$nodes(c,217,B,"Pawn Shop")).shop().connect(va);(new Location$$module$js$nodes(c,218,B,"Armor Shop")).shop(be,bc,Zb).connect(va);(new Location$$module$js$nodes(c,220,B,"Inn")).shop().connect(va);(new Location$$module$js$nodes(c,221,B,"Tool Shop")).shop(F,wa,rb,S).connect(va);(new Location$$module$js$nodes(c,222,B,"Palace Left")).house().connect(Vb);(new Location$$module$js$nodes(c,223,B,"Palace Throne Room")).house().connect(Vb).to(kb,Me).from(kb).trigger(Bc).trigger(se,Cc,
Dc);(new Location$$module$js$nodes(c,224,B,"Palace Right")).house().connect(Vb);(new Location$$module$js$nodes(c,225,B,"Asina's Room")).house().connect(xd).trigger(Gc,Qc);(new Location$$module$js$nodes(c,226,Aa,"Queen Downstairs")).house().connect(Qh).chest(Va,13);(new Location$$module$js$nodes(c,227,la,"Elder's House")).house().connect(lb).trigger(Jc);(new Location$$module$js$nodes(c,228,la,"Shed")).house().connect(lb).to(Pg,kc);(new Location$$module$js$nodes(c,229,la,"Tool Shop")).shop(F,L,N,wa).connect(lb);
...
if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return p[a.slotType?a.slotType[0]:"c"]===p[b.slotType?b.slotType[0]:"c"]};q=b.assumedFill(d,(a,b)=>t(a,n.get(b)));if(null==q){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const u=new Map;for(var H=0;H<q.length;H++){var W=q[H];if(null!=W){var pa=n.get(b.item(W));W=m.get(pa);m.delete(pa);pa=b.location(H);u.set(pa,W);l.delete(pa)}}H=(a,b,c)=>{c=void 0===c?"":c;for(const c of l)if(t(c,a))return u.set(c,b),l.delete(c),m.delete(a),
!0;g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var x of m){const [a,b]=x;if(a.isMimic()&&!H(a,b,"traps"))return!1}for(const a of m){const [b,c]=a;if(b.needsChest()&&!H(b,c,"chest"))return!1}for(const a of m){const [b,c]=a;if(!H(b,c))return!1}for(const a of u){const [b,c]=a;b.set(...c)}const {win:I,path:Qa}=a.traverse({wanted:k,dfs:!1});if(!I)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,q));
e.items=[];e.route=[];for(const b of Qa){const [c,d]=b;e.route.push(d);k=a.nodes[c];k instanceof Slot$$module$js$nodes&&!k.isFixed()&&(x=k.slotName,0>x.indexOf(k.vanillaItemName)&&(x+=` (normally ${k.vanillaItemName})`),e.items.push({itemIndex:k.itemIndex,itemName:k.item.name,origName:k.vanillaItemName,slotIndex:k.slotIndex,slotName:k.slotName,text:`${k.item.name}: ${x}`}))}return!0})};var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;module$js$depgraph.shuffle=shuffle$$module$js$depgraph;
...
e.set(module$js$graph$geometry.ScreenId.from(b,a),a.id&3);for(let f=0,g=b.height;f<g;f++){const g=b.screens[f],h=b.id<<8|f<<4;for(let f=0,k=b.width;f<k;f++){var n=function(a,b){if(!x)throw Error("flag expected");return b?a?u(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(x.flag)},b):a};const k=a.screens[g[f]|q],m=module$js$graph$geometry.ScreenId(h|f),l=m&255,t=e.get(m),x=null!=t?c.wallCapability(t):b.flags.find((a)=>a.yx===l),u=memoize2$$module$js$graph$condition((a,
b)=>{if(!x)throw Error("flag expected");b=Object.assign({},b,{enter:meet$$module$js$graph$condition(b.enter||[[]],module$js$graph$condition.Condition(x.flag))});return module$js$graph$condition.Terrain.join(a,b)});for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(m<<8|a);let e=k.tiles[a];x&&751===x.flag&&32>e&&(e=p.alternates[e]);let f=c.makeTerrain(q?0:r.effects[e]&38,b);if(32>e&&p.alternates[e]!=e&&x&&751!==x.flag){const a=c.makeTerrain(r.effects[p.alternates[e]],b);f=n(f,a)}f&&d.set(b,
...
b.reqs.check=(a,b)=>{b=void 0===b?W:b;return`${b(a)}: ${H(u.get(module$js$graph$condition.Slot(a)),b)}`};b.reqs.check2=(a)=>b.reqs.check(a,b.whatFlag)}return new World$$module$js$graph$world(a,p,makeGraph$$module$js$graph$world(u,a))}
...
function commonNoun$$module$js$pass$fixdialog(a){switch(a){case 37:return"statue";case 40:return"instrument";case 53:return"lamp";case 59:return"pendant";case 60:return"plant";case 61:return"statue"}fail$$module$js$assert();return"item"}var module$js$pass$fixdialog={};module$js$pass$fixdialog.fixDialog=fixDialog$$module$js$pass$fixdialog;class Tileset$$module$js$rom$tileset extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);b&=63;this.tileBase=65536|b<<8;this.attrBase=77824|b<<4;this.alternatesBase=81408|b<<3;this.tiles=seq$$module$js$rom$util(4,(b)=>tuple$$module$js$rom$util(a.prg,this.tileBase|b<<8,256));this.attrs=seq$$module$js$rom$util(256,(b)=>a.prg[this.attrBase|b>>2]>>((b&3)<<1)&3);this.alternates=tuple$$module$js$rom$util(a.prg,this.alternatesBase,32)}write(a){for(var b=0;256>b;b++){32>b&&(a.rom[this.alternatesBase+
b]=this.alternates[b]);for(var c=0;4>c;c++)a.rom[this.tileBase+(c<<8)+b]=this.tiles[c][b]}for(b=0;64>b;b++)c=b<<2,a.rom[this.attrBase+b]=this.attrs[c]&3|(this.attrs[c+1]&3)<<2|(this.attrs[c+2]&3)<<4|(this.attrs[c+3]&3)<<6}effects(){let a=this.id>>>2&15;168===this.id&&(a=2);172===this.id&&a--;return this.rom.tileEffects[a]}}const NONE$$module$js$rom$tileset=0,TRIM$$module$js$rom$tileset=1,MAIN$$module$js$rom$tileset=2;
...
TileEffects$$module$js$rom$tileeffects.BEHIND=16;TileEffects$$module$js$rom$tileeffects.SLOPE=32;TileEffects$$module$js$rom$tileeffects.SLOW=64;TileEffects$$module$js$rom$tileeffects.PAIN=128;var module$js$rom$tileeffects={};module$js$rom$tileeffects.TileEffects=TileEffects$$module$js$rom$tileeffects;const UNUSED_TRIGGERS$$module$js$rom$trigger=new Set([135,136,137,143,147,150,152,155,156,157,158,159,160,181,185,190,192]);
