...
y:c}=a;if(Math.pow(l-(c>>4),2)+Math.pow(d-(b>>4),2)<Math.pow(e+1,2))continue a}k.push([b,d,l,e]);return(l&240|(d&240)>>>4)<<8|(l&15)<<4|d&15}}}resizeScreens(a,b,c,d){const e=this.width+b+d;c=this.height+a+c;d=Array.from({length:c},(c,d)=>{d-=a;return Array.from({length:e},(a,c)=>{c-=b;return 0>d||0>c||d>=this.height||c>=this.width?0:this.screens[d][c]})});this.width=e;this.height=c;this.screens=d;for(const c of this.flags)c.xs+=b,c.ys+=a;for(const c of this.pits)c.fromXs+=b,c.fromYs+=a;for(const c of[...this.spawns,
...this.exits])c.xt+=16*b,c.yt+=16*a;for(const c of this.entrances)c.x+=256*b,c.y+=256*a}writeScreens2d(a,b){const c=a&15;a>>>=4;for(let d=0;d<b.length;d++){const e=b[d];for(let b=0;b<e.length;b++){const f=e[b];null!=f&&(this.screens[a+d][c+b]=f)}}}connect(a,b,c){const d=a>>>4,e=a&15,f=c>>>4,g=c&15,[h,k]=screenExits$$module$js$rom$location[this.screens[d][e]],[l,m]=screenExits$$module$js$rom$location[b.screens[f][g]],n=this.entrances.length,p=b.entrances.length;this.entrances.push(Entrance$$module$js$rom$location.of({y:d<<
8|h>>>8,x:e<<8|h&255}));b.entrances.push(Entrance$$module$js$rom$location.of({y:f<<8|l>>>8,x:g<<8|l&255}));for(const c of k)this.exits.push(Exit$$module$js$rom$location.of({screen:a,tile:c,dest:b.id,entrance:p}));for(const a of m)b.exits.push(Exit$$module$js$rom$location.of({screen:c,tile:a,dest:this.id,entrance:n}))}}
...
d]=LOCATIONS$$module$js$rom$location[b];a[c]=d}return a})(),locationKeys$$module$js$rom$location=(()=>{const a=[];for(const b of Object.keys(LOCATIONS$$module$js$rom$location)){const [c]=LOCATIONS$$module$js$rom$location[b];a[c]=b}return a})(),screenExits$$module$js$rom$location={21:[37024,[137,138]],25:[24720,[88,89]],150:[16432,[50,51]],151:[44848,[178,179]],152:[16592,[60,61]],153:[45008,[188,189]],154:[8064,[39,40]],158:[57216,[231,232]],194:[24752,[90,91]]},NEXUSES$$module$js$rom$location={mtSabreWestLower:!0,
mtSabreWestUpper:!0,mtSabreNorthMain:!0,mtSabreNorthMiddle:!0,mtSabreNorthCave1:!0,mtSabreNorthCave2:!0,mtHydra:!0,mtHydraOutsideShyron:!0,mtHydraCave1:!0},BOSS_SCREENS$$module$js$rom$location={sealedCave7:145,swamp:124,mtSabreNorthMain:181,saberaPalace1:253,saberaPalace3:253,shyronFortress:112,goaFortressKelbesque:115,goaFortressTornel:145,goaFortressAsina:145,goaFortressKarmine7:253,pyramidDraygon:249,cryptDraygon2:250,towerDyna:92};var module$js$rom$location={};
module$js$rom$location.Location=Location$$module$js$rom$location;module$js$rom$location.Entrance=Entrance$$module$js$rom$location;module$js$rom$location.Exit=Exit$$module$js$rom$location;module$js$rom$location.Flag=Flag$$module$js$rom$location;module$js$rom$location.Pit=Pit$$module$js$rom$location;module$js$rom$location.Spawn=Spawn$$module$js$rom$location;module$js$rom$location.LOCATIONS=LOCATIONS$$module$js$rom$location;const EMPTY_ITERATOR$$module$js$rom$constraint={next(){return{done:!0}}},NONE$$module$js$rom$constraint={get size(){return 0},has(){return!1},[Symbol.iterator](){return EMPTY_ITERATOR$$module$js$rom$constraint}},ALL$$module$js$rom$constraint={get size(){return Infinity},has(){return!0},[Symbol.iterator](){throw Error("cannot iterate");}};
...
[f,48],[g,0],[g,20],[h,116],[k,16],[l,0],[m,65]];b.addEastCave()&&b.connectLimeTreeToLeaf()&&n.push([a.locations.limeTreeValley,16]);for(const [a,b]of n)a.flags.push(Flag$$module$js$rom$location.of({yx:b,flag:752}));b.paralysisRequiresPrisonKey()&&(c(e,48,750),c(f,48,750),c(g,0,728),a=Spawn$$module$js$rom$location.of({y:96,x:96,type:4,id:44}),b=Spawn$$module$js$rom$location.of({y:112,x:112,type:2,id:173}),g.spawns.splice(1,0,a),g.spawns.push(b))}
function eastCave$$module$js$pass$deterministic(a,b){const {valleyOfWind:c,limeTreeValley:d,sealedCave1:e}=a.locations,f=a.locations[11],g=a.locations[13];f.screens=[[156,132,128,131,156],[128,129,131,134,128],[131,136,137,128,128],[129,140,133,130,132],[158,133,156,152,134]];g.screens=[[156,132,155,128,155],[128,129,129,128,129],[128,135,139,138,134],[128,140,128,133,132],[156,134,128,128,154]];for(const a of[f,g])a.bgm=23,a.entrances=[],a.exits=[],a.pits=[],a.spawns=[],a.flags=[],a.height=a.screens.length,
a.width=a.screens[0].length,a.used=a.hasSpawns=!0,a.extended=0,a.tilePalettes=[26,27,5],a.tileset=136,a.tileEffects=181,a.tilePatterns=[20,2],a.spritePatterns=[...e.spritePatterns],a.spritePalettes=[...e.spritePalettes];c.writeScreens2d(35,[[17,13],[9,194]]);a.tileEffects[0].effects[192]=0;f.connect(67,g,68);f.connect(64,c,52);b.connectLimeTreeToLeaf()&&(d.resizeScreens(0,1,0,0),d.writeScreens2d(0,[[12,17],[21,54],[14,15]]),f.screens[0][4]=151,f.connect(4,d,16));f.spawns.push(Spawn$$module$js$rom$location.of({screen:33,
...
tile:130,timed:!0,id:2}));b.zebuStudentGivesItem()||g.spawns.push(Spawn$$module$js$rom$location.of({y:272,x:1144,type:2,id:49}))}
...
d.alternates[n]!==n){if(32<=m)throw Error(`Cannot unflag: ${p} ${m} ${n} ${d.alternates[n]}`);d.alternates[m]=d.alternates[n]}}for(var r of e){const [a,b]=r;d.alternates[a]=b}}for(const a of c){p=this.tileEffects[a-179];for(const a of b)for(q=0;q<a.length-1;q++)r=f(a[q]),d=f(a[q+1]),p.effects[r]=p.effects[d];for(const a of e.keys())p.effects[a]|=8}}moveFlag(a,b){function c(c){for(let d=0;d<c.length;d++)c[d]===a&&(c[d]=b),c[d]===~a&&(c[d]=~b)}for(const a of this.triggers)c(a.conditions),c(a.flags);
for(const d of this.npcs){for(const a of d.spawnConditions.values())c(a);for(const c of[d.globalDialogs,...d.localDialogs.values()])for(const d of c)d.condition===a&&(d.condition=b),d.condition===~a&&(d.condition=~b)}if(512===(a&-256)&&512===(b&-256))for(const c of this.locations)for(const d of c.flags)d.flag===a&&(d.flag=b)}nextFreeTrigger(){for(const a of this.triggers)if(!a.used)return a;throw Error("Could not find an unused trigger.");}static load(a,b){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const c=
yield pickFile$$module$js$rom(b);a&&(yield a(c));return new Rom$$module$js$rom(c)})}}Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX=module$js$rom$option.RomOption.bit(82624,0);Rom$$module$js$rom.OMIT_LOCAL_DIALOG_SUFFIX=module$js$rom$option.RomOption.bit(82624,1);Rom$$module$js$rom.COMPRESSED_MAPDATA=module$js$rom$option.RomOption.bit(82624,2);Rom$$module$js$rom.SHOP_COUNT=module$js$rom$option.RomOption.byte(82625);Rom$$module$js$rom.SCALING_LEVELS=module$js$rom$option.RomOption.byte(82626);
Rom$$module$js$rom.UNIQUE_ITEM_TABLE=module$js$rom$option.RomOption.address(82640);Rom$$module$js$rom.SHOP_DATA_TABLES=module$js$rom$option.RomOption.address(82643);Rom$$module$js$rom.TELEPATHY_TABLES=module$js$rom$option.RomOption.address(82646);
...
Array.from(c,hex$$module$js$rom$util).join("");localStorage.setItem("rom",d);b.remove();a(c)});e.readAsArrayBuffer(c)})})}const EXPECTED_CRC32$$module$js$rom=466849842,ADJUSTMENTS$$module$js$rom=[[79430,2,6],[83306,0,255],[84715,9,255],[85433,8,128],[87133,255,0],[89007,240,128],[89014,223,128],[89015,150,128],[91391,11,10],[96298,16,1],[96343,16,1],[106242,64,128],[106243,51,50],[106977,61,52],[118533,71,72],[119569,32,160],[119570,48,0],[118777,96,224],[182928,2,0],[193907,2,0],[195300,95,0]];
