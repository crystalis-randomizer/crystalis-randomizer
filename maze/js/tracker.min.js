...
a.assumeGhettoFlight())),l=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),p=h(d("Assume teleport skip",a.assumeTeleportSkip())),r=d("Allow teleport skip",!a.disableTeleportSkip()),q=h(d("Assume rabbit skip",a.assumeRabbitSkip())),t=h(d("Allow rabbit skip",!a.disableRabbitSkip())),u=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),v=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),y=h(d("Assume wild warp",a.assumeWildWarp())),
ea=d("Allow wild warp",a.allowWildWarp()),w=d("Sword magic optional",!a.guaranteeSwordMagic()),B=d("Matching sword optional",!a.guaranteeMatchingSword()),z=d("Gas mask optional",!a.guaranteeGasMask()),Ya=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),la=d("Calm sea optional",!a.barrierRequiresCalmSea()),ua=d("Prison key optional",!a.paralysisRequiresPrisonKey()),Ca=d("Windmill optional",!a.sealedCaveRequiresWindmill()),Da=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
fa=d("Barrier magic optional",!a.guaranteeBarrier()),J=d("Refresh magic optional",!a.guaranteeRefresh()),va=d("Telepathy optional for Deo",!a.saharaRabbitsRequireTelepathy()),Vd=d("Lime Tree connects to Leaf",a.connectLimeTreeToLeaf()),Wd=d("Buffed medical herb",a.buffMedicalHerb()),Za=d("Orbs optional",a.orbsOptional()),T=(new Item$$module$js$nodes(c,0,"Sword of Wind")).weight(a.guaranteeSword()?10:5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),U=(new Item$$module$js$nodes(c,
1,"Sword of Fire")).weight(a.guaranteeSword()?10:5).fromPerson("Oak elder",29).dialog(29,void 0,3).key(),P=(new Item$$module$js$nodes(c,2,"Sword of Water")).weight(10).chest().key(),N=(new Item$$module$js$nodes(c,3,"Sword of Thunder")).weight(15).chest().key(),xb=(new Item$$module$js$nodes(c,4,"Crystalis")).fixed(),Qa=(new Item$$module$js$nodes(c,5,"Ball of Wind")).chest().key(),Ra=(new Item$$module$js$nodes(c,6,"Tornado Bracelet")).chest().key(),$a=(new Item$$module$js$nodes(c,7,"Ball of Fire")).bossDrop("Insect",
1).dialog(30,void 0,2).dialog(32,void 0,0).dialog(33,void 0,0).dialog(34,void 0,0).dialog(96,30,0).dialog(29,void 0,2).dialog(31,void 0,1).npcSpawn(193).key(),ab=(new Item$$module$js$nodes(c,8,"Flame Bracelet")).bossDrop("Kelbesque 1",2).npcSpawn(194).key(),bb=(new Item$$module$js$nodes(c,9,"Ball of Water")).weight(5).direct("Rage",250679).npcSpawn(195).key(),cb=(new Item$$module$js$nodes(c,10,"Blizzard Bracelet")).weight(5).chest().key(),db=(new Item$$module$js$nodes(c,11,"Ball of Thunder")).bossDrop("Mado 1",
5).trigger(154,1).key(),eb=(new Item$$module$js$nodes(c,12,"Storm Bracelet")).chest().key(),dc=(new Item$$module$js$nodes(c,13,"Carapace Shield")).armor(),Xd=(new Item$$module$js$nodes(c,14,"Bronze Shield")).armor(),ec=(new Item$$module$js$nodes(c,15,"Platinum Shield")).armor(),fc=(new Item$$module$js$nodes(c,16,"Mirrored Shield")).armor(),Yd=(new Item$$module$js$nodes(c,17,"Ceramic Shield")).armor(),yb=(new Item$$module$js$nodes(c,18,"Sacred Shield")).armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),
gc=(new Item$$module$js$nodes(c,19,"Battle Shield")).armor(),Zd=(new Item$$module$js$nodes(c,20,"Psycho Shield")).armor(),$d=(new Item$$module$js$nodes(c,21,"Tanned Hide")).armor(),ae=(new Item$$module$js$nodes(c,22,"Leather Armor")).armor(),be=(new Item$$module$js$nodes(c,23,"Bronze Armor")).armor(),hc=(new Item$$module$js$nodes(c,24,"Platinmum Armor")).armor(),ce=(new Item$$module$js$nodes(c,25,"Soldier Suit")).armor(),ic=(new Item$$module$js$nodes(c,26,"Ceramic Suit")).armor(),de=(new Item$$module$js$nodes(c,
27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),K=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),O=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),Ea=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),zb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),Q=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),Z=(new Item$$module$js$nodes(c,
34,"Magic Ring")).consumable(),Ab=(new Item$$module$js$nodes(c,35,"Fruit of Repun")).consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),V=(new Item$$module$js$nodes(c,36,"Warp Boots")).consumable(),jc=(new Item$$module$js$nodes(c,37,"Statue of Onyx")).chest("Cordel grass").invisible(254882).key(),Bb=(new Item$$module$js$nodes(c,38,"Opel Statue")).consumable().bossDrop("Kelbesque 2",6).npcSpawn(197).key(),kc=(new Item$$module$js$nodes(c,39,"Insect Flute")).fromPerson("Oak mother",30).dialog(30,
void 0,1).key(),Cb=(new Item$$module$js$nodes(c,40,"Flute of Lime")).fromPerson("Portoa queen",56).fromPerson("Asina secondary",98,1).dialog(56,void 0,4).key(),fb=(new Item$$module$js$nodes(c,41,"Gas Mask")).direct("Akahana in Brynmaer",251902).npcSpawn(22,24).key(),fe=(new Item$$module$js$nodes(c,42,"Power Ring")).chest().bonus(),ge=(new Item$$module$js$nodes(c,43,"Warrior Ring")).fromPerson("Akahana's friend",84).dialog(84,void 0,2).bonus(),he=(new Item$$module$js$nodes(c,44,"Iron Necklace")).chest().bonus(),
ie=(new Item$$module$js$nodes(c,45,"Deo's Pendant")).fromPerson("Deo",90).dialog(90,void 0,0).bonus(),Db=(new Item$$module$js$nodes(c,46,"Rabbit Boots")).bossDrop("Vampire 1",0).npcSpawn(192).key(),lc=((a,b)=>new Item$$module$js$nodes(c,a,b))(47,a.leatherBootsGiveSpeed()?"Speed Boots":"Leather Boots").chest().bonus(),mc=(new Item$$module$js$nodes(c,48,"Shield Ring")).direct("Akahana in waterfall cave",250543).bonus(),Eb=(new Item$$module$js$nodes(c,49,"Alarm Flute")).fromPerson("Zebu's student",20,
1).key(),nc=(new Item$$module$js$nodes(c,50,"Windmill Key")).fromPerson("Windmill guard",20).dialog(20,14,0).npcSpawn(20,14,1).key(),Fb=(new Item$$module$js$nodes(c,51,"Key to Prison")).chest().key(),oc=(new Item$$module$js$nodes(c,52,"Key to Styx")).fromPerson("Zebu in Shyron",94,1).trigger(128,2).dialog(94,242,0).dialog(98,242,0).key(),pc=(new Item$$module$js$nodes(c,53,"Fog Lamp")).chest().key(),Gb=(new Item$$module$js$nodes(c,54,"Shell Flute")).fromPerson("Dolphin",99,1).npcSpawn(99).key(),qc=
(new Item$$module$js$nodes(c,55,"Eye Glasses")).fromPerson("Clark",68).dialog(68,233,1).key(),rc=(new Item$$module$js$nodes(c,56,"Broken Statue")).bossDrop("Sabera 1",4).npcSpawn(127,101).npcSpawn(9).npcSpawn(10).npcSpawn(69).npcSpawn(70).npcSpawn(71).npcSpawn(132).npcSpawn(142).dialog(61).dialog(62).dialog(63).dialog(64).dialog(65).dialog(66).dialog(67).dialog(68,233).trigger(182).key(),sc=(new Item$$module$js$nodes(c,57,"Glowing Lamp")).direct("Kensu in lighthouse",250638).npcSpawn(126,98,1).key(),
tc=(new Item$$module$js$nodes(c,59,"Love Pendant")).chest("Underground channel").invisible(254890).key(),uc=(new Item$$module$js$nodes(c,60,"Kirisa Plant")).chest("Kirisa meadow").invisible(254886).key(),Hb=(new Item$$module$js$nodes(c,61,"Ivory Statue")).bossDrop("Karmine",9).npcSpawn(200).key(),vc=(new Item$$module$js$nodes(c,62,"Bow of Moon")).fromPerson("Aryllis",35).direct(251624).dialog(35,void 0,1).key(),wc=(new Item$$module$js$nodes(c,63,"Bow of Sun")).chest().key(),xc=(new Item$$module$js$nodes(c,
64,"Bow of Truth")).fromPerson("Azteca",131).npcSpawn(131,156,1).dialog(131,void 0,0).key(),gb=(new Magic$$module$js$nodes(c,65,"Refresh")).fromPerson("Zebu at windmill",94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),Sa=(new Magic$$module$js$nodes(c,66,"Paralysis")).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),ma=(new Magic$$module$js$nodes(c,67,"Telepathy")).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),yc=(new Magic$$module$js$nodes(c,
68,"Teleport")).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),je=(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),zc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),wa=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),G=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=Q.bossDrop("Vampire 2",
12,97).npcSpawn(204).key(),R=new Item$$module$js$nodes(c,112,"Mimic"),Ac=(new Trigger$$module$js$nodes(c,"Talked to Leaf Elder")).get(T),Bc=(new Trigger$$module$js$nodes(c,"Talked to Leaf Student")).get(Eb),Ib=new Trigger$$module$js$nodes(c,"Talked to Zebu in cave"),le=(new Trigger$$module$js$nodes(c,"Woke up Windmill Guard")).get(nc),Ta=new Trigger$$module$js$nodes(c,"Started Windmill"),Cc=(new Trigger$$module$js$nodes(c,"Learned Refresh")).get(gb),me=(new Trigger$$module$js$nodes(c,"Gave Statue to Akahana")).get(fb),
ne=(new Trigger$$module$js$nodes(c,"Fought Stom")).get(ma),Dc=new Trigger$$module$js$nodes(c,"Visited Oak"),Ec=new Trigger$$module$js$nodes(c,"Talked to Oak Mother"),Jb=new Trigger$$module$js$nodes(c,"Rescued Oak Child"),oe=(new Trigger$$module$js$nodes(c,"Talked to Oak Mother Again")).get(kc),pe=(new Trigger$$module$js$nodes(c,"Talked to Oak Elder")).get(U),qe=(new Trigger$$module$js$nodes(c,"Talked to Tornel on Mt Sabre")).get(yc),Fc=new Trigger$$module$js$nodes(c,"Villagers Abducted"),Gc=new Trigger$$module$js$nodes(c,
"Talked to Rabbit in Leaf"),re=(new Trigger$$module$js$nodes(c,"Learned Paralysis")).get(Sa),Hc=new Trigger$$module$js$nodes(c,"Talked to Portoa Queen"),Ic=new Trigger$$module$js$nodes(c,"Talked to Fortune Teller"),Jc=new Trigger$$module$js$nodes(c,"Visited Underground Channel"),se=(new Trigger$$module$js$nodes(c,"Sent to Waterfall Cave")).get(Cb),te=(new Trigger$$module$js$nodes(c,"Cured Akahana")).get(mc),Kc=(new Trigger$$module$js$nodes(c,"Talked to Rage")).get(bb),Lc=new Trigger$$module$js$nodes(c,
"Mesia recording played"),Mc=(new Trigger$$module$js$nodes(c,"Talked to Asina")).get(je),Nc=(new Trigger$$module$js$nodes(c,"Healed Dolphin")).get(Gb),Kb=new Trigger$$module$js$nodes(c,"Returned Fog Lamp"),Oc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Cabin"),Pc=new Trigger$$module$js$nodes(c,"Talked to Joel Elder"),ue=(new Trigger$$module$js$nodes(c,"Talked to Clark")).get(qc),ve=(new Trigger$$module$js$nodes(c,"Talked to Kensu in Lighthouse")).get(sc),Lb=new Trigger$$module$js$nodes(c,"Calmed the Angry Sea"),
we=(new Trigger$$module$js$nodes(c,"Learned Barrier")).get(zc),Qc=new Trigger$$module$js$nodes(c,"Talked to Stom in Swan Hut"),Rc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Swan tavern"),Sc=new Trigger$$module$js$nodes(c,"Talked to Kensu at Swan dance"),xe=(new Trigger$$module$js$nodes(c,"Returned Kensu's love pendant")).get(wa),ye=(new Trigger$$module$js$nodes(c,"Talked to Amazones Queen")).get(vc),Mb=new Trigger$$module$js$nodes(c,"Entered Shyron"),ze=(new Trigger$$module$js$nodes(c,"Talked to Zebu in Shyron")).get(oc),
Tc=new Trigger$$module$js$nodes(c,"Shyron Massacre"),Ae=(new Trigger$$module$js$nodes(c,"Saved Kensu")).get(G),Be=(new Trigger$$module$js$nodes(c,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$js$nodes(c,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(c,"Get Bow of Truth")).get(xc),Ee=(new Trigger$$module$js$nodes(c,"Forged Crystalis")).get(xb),hb=(new Condition$$module$js$nodes(c,"Sword charge glitch")).option(u,v),Fe=(new Condition$$module$js$nodes(c,"Rabbit skip")).option(q,
t),Ge=(new Condition$$module$js$nodes(c,"Teleport skip")).option(p,r),ib=(new Condition$$module$js$nodes(c,"Statue glitch")).option(l,n),He=(new Condition$$module$js$nodes(c,"Wild warp")).option(y,ea),jb=(new Condition$$module$js$nodes(c,"Any level 2 sword")).option(T,Qa).option(T,Ra).option(U,$a).option(U,ab).option(P,bb).option(P,cb).option(N,db).option(N,eb),C=(new Condition$$module$js$nodes(c,"Destroy stone")).option(T,Za).option(T,Qa).option(T,Ra).option(hb,T,jb),D=(new Condition$$module$js$nodes(c,
"Destroy ice")).option(U,Za).option(U,$a).option(U,ab).option(hb,U,jb),x=(new Condition$$module$js$nodes(c,"Cross rivers")).option(P,Za).option(P,bb).option(P,cb).option(G).option(hb,P,jb),Fa=(new Condition$$module$js$nodes(c,"Destroy iron")).option(N,Za).option(N,db).option(N,eb).option(hb,N,jb),W=(new Condition$$module$js$nodes(c,"Any sword")).option(T).option(U).option(P).option(N),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(U).option(P).option(N).option(fb,
B.value?B:g,T),Je=(new Condition$$module$js$nodes(c,"Match vampire 2 sword (wind/water/thunder)")).option(T).option(P).option(N).option(B.value?B:g,U),Uc=(new Condition$$module$js$nodes(c,"Speed boots")).option(lc,k),Vc=(new Condition$$module$js$nodes(c,"Climb slopes")).option(Db).option(G).option(Uc),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Gc).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(yc).option(Ge,G),Wc=(new Condition$$module$js$nodes(c,
"Asina in her room")).option(Lc),Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(Sa).option(Wc).option(ib),Xc=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(Gb,Oc),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(m,Xc,Db),ha=(new Condition$$module$js$nodes(c,"Cross sea")).option(Xc).option(G),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Lb).option(G).option(Ne),X=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(J.value?
J:g).option(gb),Yc=(new Condition$$module$js$nodes(c,"Wind magic")).option(w.value?w:g,X).option(Qa,Ra,X),Zc=(new Condition$$module$js$nodes(c,"Fire magic")).option(w.value?w:g,X).option($a,ab,X),$c=(new Condition$$module$js$nodes(c,"Water magic")).option(w.value?w:g,X).option(w,X).option(bb,cb,X),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(w.value?w:g,X).option(w,X).option(db,X).option(eb,X),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(Cb).option(ib),
Re=(new Condition$$module$js$nodes(c,"Change or glitch")).option(wa).option(ib),Se=(new Condition$$module$js$nodes(c,"Change or glitch or paralysis")).option(wa).option(ib).option(Sa),Nb=(new Condition$$module$js$nodes(c,"Pass shooting statues")).option(zc).option(W,fa.value?fa:g).option(gb,mc),Te=(new Condition$$module$js$nodes(c,"Healed dolphin if required")).option(Nc).option(Ya),ad=(new Condition$$module$js$nodes(c,"Match sword of wind")).option(T).option(B.value?B:g,W),bd=(new Condition$$module$js$nodes(c,
"Match sword of fire")).option(U).option(B.value?B:g,W),cd=(new Condition$$module$js$nodes(c,"Match sword of water")).option(P).option(B.value?B:g,W),Ue=(new Condition$$module$js$nodes(c,"Match sword of thunder")).option(N).option(B.value?B:g,W),Ve=(new Condition$$module$js$nodes(c,"Swamp run possible")).option(W,Uc).option(W,Wd).option(W,gb),We=(new Condition$$module$js$nodes(c,"Insect possible to kill")).option(fb),kb=(new Condition$$module$js$nodes(c,"Travel swamp")).option(fb).option(z.value?
z:g,Ve),Xe=(new Condition$$module$js$nodes(c,"Calmed sea if required")).option(Lb).option(la),Ye=(new Condition$$module$js$nodes(c,"Started windmill if required")).option(Ta).option(Ca),Ze=(new Condition$$module$js$nodes(c,"Telepathy if required for Deo")).option(ma).option(va),$e=e(0,"Vampire 1",W).get(Db),af=e(1,"Insect",kc,Ie,We).get($a),bf=e(2,"Kelbesque 1",ad,Yc).get(ab),cf=e(12,"Vampire 2",Je).get(ke),dd=e(4,"Sabera 1",bd,Zc).get(rc),df=e(5,"Mado 1",cd,$c).get(db),ef=e(6,"Kelbesque 2",ad,Yc).get(Bb),
ff=e(7,"Sabera 2",bd,Zc).get(Ab),gf=e(8,"Mado 2",cd,$c).get(yb),hf=e(9,"Karmine",Ue,Pe).get(Hb),jf=e(10,"Draygon 1",W).get(ee),kf=e(-1,"Statues",wc,vc),lf=e(11,"Draygon 2",W,xc),mf=e(13,"Dyna",xb),nf=(new Condition$$module$js$nodes(c,"Opened prison if required")).option(Fb).option(ua),aa=new Area$$module$js$nodes(c,"Leaf"),Ga=new Area$$module$js$nodes(c,"Valley of Wind"),Y=new Area$$module$js$nodes(c,"Sealed Cave"),xa=new Area$$module$js$nodes(c,"Cordel Plain"),Ha=new Area$$module$js$nodes(c,"Brynmaer"),
Ia=new Area$$module$js$nodes(c,"Amazones"),H=new Area$$module$js$nodes(c,"Mt Sabre West"),A=new Area$$module$js$nodes(c,"Mt Sabre North"),lb=new Area$$module$js$nodes(c,"Nadare's"),Ua=new Area$$module$js$nodes(c,"Oak"),na=new Area$$module$js$nodes(c,"Waterfall Valley"),F=new Area$$module$js$nodes(c,"Portoa"),oa=new Area$$module$js$nodes(c,"Waterfall Cave"),I=new Area$$module$js$nodes(c,"Fog Lamp Cave"),pa=new Area$$module$js$nodes(c,"Kirisa Plant Cave"),ya=new Area$$module$js$nodes(c,"Angry Sea"),
qa=new Area$$module$js$nodes(c,"Joel"),M=new Area$$module$js$nodes(c,"Evil Spirit Island"),ra=new Area$$module$js$nodes(c,"Sabera's Castle"),ba=new Area$$module$js$nodes(c,"Swan"),E=new Area$$module$js$nodes(c,"Mt Hydra"),sa=new Area$$module$js$nodes(c,"Shyron"),za=new Area$$module$js$nodes(c,"Styx"),Aa=new Area$$module$js$nodes(c,"Goa"),mb=new Area$$module$js$nodes(c,"Draygonia Fortress 1"),ca=new Area$$module$js$nodes(c,"Draygonia Fortress 2"),Ja=new Area$$module$js$nodes(c,"Draygonia Fortress 3"),
S=new Area$$module$js$nodes(c,"Draygonia Fortress 4"),L=new Area$$module$js$nodes(c,"Oasis Cave"),da=new Area$$module$js$nodes(c,"Sahara"),Ka=new Area$$module$js$nodes(c,"Pyramid Front"),ia=new Area$$module$js$nodes(c,"Pyramid Back"),ja=new Area$$module$js$nodes(c,"Tower"),Ob=(new Location$$module$js$nodes(c,0,aa,"Start")).overworld().start(),of=(new Location$$module$js$nodes(c,0,aa,"Mezame Shrine")).overworld().from(Ob),pf=(new Location$$module$js$nodes(c,1,aa,"Outside Start")).overworld().connect(of),
ta=(new Location$$module$js$nodes(c,2,aa,"Town")).town().connect(pf),Va=(new Location$$module$js$nodes(c,3,Ga,"Main")).overworld().connect(ta).trigger(Cc,Ta),ed=(new Location$$module$js$nodes(c,3,Ga,"Outside Windmill")).overworld(),fd=(new Location$$module$js$nodes(c,4,Y,"Tunnel 1 (entrance)")).cave().from(Va,Ta),qf=(new Location$$module$js$nodes(c,5,Y,"Tunnel 2 (over bridge)")).cave().connect(fd),rf=(new Location$$module$js$nodes(c,6,Y,"Tunnel 6 (herb dead end)")).cave().chest(K,15),gd=(new Location$$module$js$nodes(c,
7,Y,"Tunnel 4a (ball corridor)")).cave().chest(K,20,80).chest(Qa,21);(new Location$$module$js$nodes(c,7,Y,"Tunnel 4b (antidote dead end)")).cave().connect(gd,C).chest(O,19);const sf=(new Location$$module$js$nodes(c,8,Y,"Tunnel 5 (warp boots dead end)")).cave().chest(V,14),tf=(new Location$$module$js$nodes(c,9,Y,"Tunnel 3a (branch, front)")).cave().connect(qf).connectTo(gd).connectTo(sf),uf=(new Location$$module$js$nodes(c,9,Y,"Tunnel 3b (branch, back)")).cave().connect(tf,C).connectTo(rf),vf=(new Location$$module$js$nodes(c,
10,Y,"Tunnel 7 (boss)")).cave().connect(uf).boss($e),wf=(new Location$$module$js$nodes(c,12,Y,"Tunnel 8a (exit, above wall)")).cave().connect(vf),xf=(new Location$$module$js$nodes(c,12,Y,"Tunnel 8b (exit, below wall")).cave().connect(wf,C);(new Location$$module$js$nodes(c,14,Ga,"Windmill Cave")).cave().connect(Va).connectTo(ed).trigger(le,Eb,Ib);(new Location$$module$js$nodes(c,15,Ga,"Windmill")).misc().connect(ed).trigger(Ta,nc);const yf=(new Location$$module$js$nodes(c,16,Ga,"Zebu's Cave Front")).cave().connect(Va).trigger(Ib,
Ac,Bc).trigger(Cc,Ta,Ib),zf=(new Location$$module$js$nodes(c,16,Ga,"Zebu's Cave Back")).cave().trigger(Fc).connect(yf,D),Af=(new Location$$module$js$nodes(c,17,H,"Tunnel 1 (to Zebu)")).cave().connect(zf),La=(new Location$$module$js$nodes(c,20,xa,"West")).overworld().connect(xf,Ye),Bf=(new Location$$module$js$nodes(c,20,xa,"South")).overworld().connect(La,x),hd=(new Location$$module$js$nodes(c,21,xa,"East")).overworld().connect(La).chest(jc,24),Wa=(new Location$$module$js$nodes(c,24,Ha,"Town")).town().connect(La).trigger(me,
jc),Cf=(new Location$$module$js$nodes(c,25,xa,"Outside Stom's House")).town().connect(La),Pb=(new Location$$module$js$nodes(c,26,xa,"Swamp")).overworld().connect(hd,kb).trigger(Jb,Ec,kb);(new Location$$module$js$nodes(c,26,xa,"Swamp Insect Area")).overworld().connect(Pb,kb).boss(af);const nb=(new Location$$module$js$nodes(c,27,Ia,"Town")).town().connect(Bf),ob=(new Location$$module$js$nodes(c,28,Ua,"Town")).town().connect(Pb,kb).trigger(Dc);(new Location$$module$js$nodes(c,30,xa,"Stom's House")).house().connect(Cf).trigger(ne,
Dc);const Ma=(new Location$$module$js$nodes(c,32,H,"Entrance")).overworld().connect(La).connect(Af),Df=(new Location$$module$js$nodes(c,32,H,"Up Slope")).overworld().from(Ma,Vc).to(Ma),Ef=(new Location$$module$js$nodes(c,32,H,"Dead End (warp boots)")).overworld().chest(V,24,106),id=(new Location$$module$js$nodes(c,33,H,"Upper")).overworld().from(Ma,G).to(Ma),Ff=(new Location$$module$js$nodes(c,33,H,"Tornel Dead End")).overworld().trigger(qe,Qa,Ra).chest(Z,23,105),jd=(new Location$$module$js$nodes(c,
34,H,"Tunnel 2a (fork at start)")).cave().connect(Ma);(new Location$$module$js$nodes(c,34,H,"Tunnel 2b (left branch to dead end)")).cave().connect(jd,D).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,H,"Tunnel 2c (right branch to upper)")).cave().connect(jd,D),Hf=(new Location$$module$js$nodes(c,35,H,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(K,23,82),If=(new Location$$module$js$nodes(c,35,H,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,
D).connectTo(id),kd=(new Location$$module$js$nodes(c,36,H,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,H,"Tunnel 4b (out to upper)")).cave().connect(kd,D).connectTo(id);const Jf=(new Location$$module$js$nodes(c,37,H,"Tunnel 5 (tiny connector)")).cave().connect(kd),Kf=(new Location$$module$js$nodes(c,38,H,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);(new Location$$module$js$nodes(c,38,H,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,
D).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,H,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,H,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,D);(new Location$$module$js$nodes(c,39,H,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,D).chest(Ra,25);const pb=(new Location$$module$js$nodes(c,40,A,"Entrance")).overworld().connect(hd,Le,Ke),qb=(new Location$$module$js$nodes(c,40,A,"Upper")).overworld().from(pb,G).to(pb),
Qb=(new Location$$module$js$nodes(c,40,A,"Summit (boss)")).overworld().from(qb,G).to(qb).boss(bf),ld=(new Location$$module$js$nodes(c,41,A,"Connector")).overworld(),Rb=(new Location$$module$js$nodes(c,41,A,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,A,"Middle Right")).overworld().from(Rb,Vc).to(Rb),md=(new Location$$module$js$nodes(c,42,A,"Tunnel 2a (from entrance to connector)")).cave().connectTo(ld);(new Location$$module$js$nodes(c,42,A,"Tunnel 2b (under bridge, to antidote)")).cave().connect(md,
D).chest(O,23,94);const nd=(new Location$$module$js$nodes(c,43,A,"Tunnel 3a (branch after connector)")).cave().connect(ld),Of=(new Location$$module$js$nodes(c,43,A,"Tunnel 3b (right branch)")).cave().connect(nd,D),Pf=(new Location$$module$js$nodes(c,43,A,"Tunnel 3c (upper branch)")).cave().connect(nd,D);(new Location$$module$js$nodes(c,44,A,"Tunnel 4 (over bridge, to middle)")).cave().connect(Pf).connectTo(Rb);const od=(new Location$$module$js$nodes(c,45,A,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Of).connectTo(Nf);
(new Location$$module$js$nodes(c,45,A,"Tunnel 5b (dead-end with herb)")).cave().connect(od,D).chest(K,22,83);const Qf=(new Location$$module$js$nodes(c,46,A,"Tunne; 6a (S-shaped hall, right)")).cave().connect(od),Rf=(new Location$$module$js$nodes(c,46,A,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Qf,D),Sf=(new Location$$module$js$nodes(c,46,A,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Rf,D),pd=(new Location$$module$js$nodes(c,47,A,"Prison (hallway)")).cave().connect(qb),Tf=(new Location$$module$js$nodes(c,
48,A,"Left Cell (shopkeepers)")).cave().from(pd,D);(new Location$$module$js$nodes(c,49,A,"Left Cell 2 (back, with prison key)")).cave().from(Tf,D).chest(Fb,13);const Uf=(new Location$$module$js$nodes(c,50,A,"Right Cell (villagers)")).cave().from(pd,D),Vf=(new Location$$module$js$nodes(c,51,A,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Uf,D);(new Location$$module$js$nodes(c,52,A,"Tunnel 9 (connector to summit)")).cave().connect(Vf).connectTo(Qb);const Wf=(new Location$$module$js$nodes(c,
53,A,"Summit Cave (front)")).cave().from(Qb,Fb).to(Qb),Xf=(new Location$$module$js$nodes(c,53,A,"Summit Cave (behind ice)")).cave().connect(Wf,D).trigger(re);(new Location$$module$js$nodes(c,56,A,"Tunnel 1 (leads from main entrance)")).cave().connect(pb).connectTo(md);(new Location$$module$js$nodes(c,57,A,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(qb);const Yf=(new Location$$module$js$nodes(c,60,lb,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,lb,"Tool Shop")).shop(K,O,Q,V),$f=(new Location$$module$js$nodes(c,
62,lb,"Back Room")).house(),Sb=(new Location$$module$js$nodes(c,64,na,"Summit")).overworld().connect(Xf,nf),rb=(new Location$$module$js$nodes(c,64,na,"Northwest")).overworld().from(Sb).to(Sb,G),ag=(new Location$$module$js$nodes(c,64,na,"Northeast")).overworld().connect(rb,x),qd=(new Location$$module$js$nodes(c,65,na,"Southwest")).overworld().connect(rb),bg=(new Location$$module$js$nodes(c,65,na,"Southeast")).overworld().connect(qd,x),rd=(new Location$$module$js$nodes(c,66,na,"Lime Tree Valley")).overworld().connect(qd).connect(Va,
Vd),cg=(new Location$$module$js$nodes(c,67,na,"Lime Tree Lake (Rage)")).cave().connect(rd).trigger(Kc,P),dg=(new Location$$module$js$nodes(c,68,pa,"Tunnel 1a (entrance)")).cave().connect(bg),eg=(new Location$$module$js$nodes(c,68,pa,"Tunnel 1b (behind wall)")).cave().connect(dg,C),sd=(new Location$$module$js$nodes(c,69,pa,"Tunnel 2a (main path, before wall)")).cave().connect(eg);(new Location$$module$js$nodes(c,69,pa,"Tunnel 2b (dead end, antidote)")).cave().connect(sd,C).chest(O,25,95);const fg=
(new Location$$module$js$nodes(c,69,pa,"Tunnel 2c (main path, after wall)")).cave().connect(sd,C),gg=(new Location$$module$js$nodes(c,70,pa,"Tunnel 3a (last room, before wall)")).cave().connect(fg),hg=(new Location$$module$js$nodes(c,70,pa,"Tunnel 3b (last room, after wall)")).cave().connect(gg,C);(new Location$$module$js$nodes(c,71,pa,"Meadow")).overworld().connect(hg).chest(uc,14);const ig=(new Location$$module$js$nodes(c,72,I,"Tunnel 1a (entrance)")).cave().connect(ag),td=(new Location$$module$js$nodes(c,
72,I,"Tunnel 1b (past wall)")).cave().connect(ig,C);(new Location$$module$js$nodes(c,72,I,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(td,C).chest(Ea,24);const jg=(new Location$$module$js$nodes(c,73,I,"Tunnel 2 (tiny connector)")).cave().connect(td),ud=(new Location$$module$js$nodes(c,74,I,"Tunnel 3a (upper branch)")).cave().connect(jg);(new Location$$module$js$nodes(c,74,I,"Tunnel 3b (dead end, mimic)")).cave().connect(ud,C).chest(R,21,112);const vd=(new Location$$module$js$nodes(c,74,I,"Tunnel 3c (short passage with mimic)")).cave().connect(ud,
C).chest(R,22,113),kg=(new Location$$module$js$nodes(c,74,I,"Tunnel 3d (lower branch)")).cave().connect(vd,C);(new Location$$module$js$nodes(c,75,I,"Dead end loop")).cave().connect(kg);const wd=(new Location$$module$js$nodes(c,76,I,"Tunnel 4a (right branch over bridge)")).cave().connect(vd),lg=(new Location$$module$js$nodes(c,76,I,"Tunnel 4b (past wall over bridge)")).cave().connect(wd,C),mg=(new Location$$module$js$nodes(c,77,I,"Tunnel 5a (from left branch)")).cave().connect(wd),ng=(new Location$$module$js$nodes(c,
77,I,"Tunnel 5b (reconvergence)")).cave().connect(mg,C).connect(lg),og=(new Location$$module$js$nodes(c,77,I,"Tunnel 5c (between walls)")).cave().connect(ng,C),pg=(new Location$$module$js$nodes(c,77,I,"Tunnel 5d (under bridge)")).cave().connect(og,C),qg=(new Location$$module$js$nodes(c,78,I,"Tunnel 6a (over second bridge)")).cave().connect(pg),rg=(new Location$$module$js$nodes(c,78,I,"Tunnel 6b (past wall)")).cave().connect(qg,C),sg=(new Location$$module$js$nodes(c,79,I,"Tunnel 7a (under second bridge)")).cave().connect(rg);
(new Location$$module$js$nodes(c,79,I,"Tunnel 7b (fog lamp)")).cave().connect(sg,C).chest(pc,19);const Ba=(new Location$$module$js$nodes(c,80,F,"Town")).town().connect(rb),xd=(new Location$$module$js$nodes(c,81,F,"Fishherman Island")).town().connect(Ba);(new Location$$module$js$nodes(c,82,na,"Mesia Shrine")).cave().trigger(Lc).connect(cg,x,Kc);const yd=(new Location$$module$js$nodes(c,84,oa,"Tunnel 1a (entrance)")).cave().connect(rb);(new Location$$module$js$nodes(c,84,oa,"Tunnel 1b (dead end, mimic)")).cave().connect(yd,
D).chest(R,19,114);const tg=(new Location$$module$js$nodes(c,84,oa,"Tunnel 1c (past ice)")).cave().connect(yd,D),ug=(new Location$$module$js$nodes(c,85,oa,"Tunnel 2 (stoned pair)")).cave().connect(tg),Tb=(new Location$$module$js$nodes(c,86,oa,"Tunnel 3 (wide medusa hallways)")).cave().connect(ug,Qe),vg=(new Location$$module$js$nodes(c,87,oa,"Tunnel 4a (left entrance)")).cave().from(Tb,D).chest(fc.chest().bonus(),25).trigger(te,Cb);(new Location$$module$js$nodes(c,87,oa,"Tunnel 4b (right entrance)")).cave().from(Tb,
D).connect(vg,G);(new Location$$module$js$nodes(c,87,oa,"Tunnel 4c (sword of water)")).cave().connect(Tb,D).chest(P,24);const zd=(new Location$$module$js$nodes(c,88,ja,"Entrance")).misc(),wg=(new Location$$module$js$nodes(c,89,ja,"Level 1")).misc().from(zd),xg=(new Location$$module$js$nodes(c,90,ja,"Level 2")).misc().from(wg),yg=(new Location$$module$js$nodes(c,91,ja,"Level 3")).misc().from(xg),Ad=(new Location$$module$js$nodes(c,92,ja,"Outside Mesia Room")).misc().from(yg),zg=(new Location$$module$js$nodes(c,
93,ja,"Outside Dyna Room")).misc().from(Ad,xb);(new Location$$module$js$nodes(c,94,ja,"Mesia")).misc().connect(Ad).trigger(Ee);const Ag=(new Location$$module$js$nodes(c,95,ja,"Dyna")).misc().from(zg).boss(mf);(new Location$$module$js$nodes(c,95,ja,"Win")).misc().from(Ag).end();const Ub=(new Location$$module$js$nodes(c,96,ya,"Cabin Beach")).sea().from(xd,Kb),Na=(new Location$$module$js$nodes(c,96,ya,"South")).sea().connect(Ub,ha),Bg=(new Location$$module$js$nodes(c,96,ya,"Joel Beach")).sea().connect(Na,
ha),Bd=(new Location$$module$js$nodes(c,96,qa,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(c,96,ya,"Altar")).sea().connect(Na,ha).trigger(Lb,sc,rc);const Cg=(new Location$$module$js$nodes(c,96,ya,"North")).sea().to(Na,ha).from(Na,ha,Oe).trigger(we,Xe),Dg=(new Location$$module$js$nodes(c,96,ya,"Swan Beach")).sea().connect(Cg,ha);(new Location$$module$js$nodes(c,97,ya,"Cabin")).misc().connect(Ub).trigger(Oc,Kb);(new Location$$module$js$nodes(c,98,qa,"Lighthouse")).misc().connect(Bd).trigger(ve,
Eb);const sb=(new Location$$module$js$nodes(c,100,F,"Underground Channel 1 (from throne room)")).sea().trigger(Jc),Eg=(new Location$$module$js$nodes(c,100,F,"Underground Channel 2 (to fortune teller)")).sea().connect(sb,x),Cd=(new Location$$module$js$nodes(c,100,F,"Underground Channel 3 (from fortune teller)")).sea().connect(sb,G),Dd=(new Location$$module$js$nodes(c,100,F,"Underground Channel 4 (asina)")).sea().connect(Cd,x),Fg=(new Location$$module$js$nodes(c,100,F,"Underground Channel 5 (dolphin)")).sea().connect(Dd,
x).trigger(Nc,K,Mc);(new Location$$module$js$nodes(c,100,F,"Underground Channel 6 (water)")).sea().connect(Fg,ha).connectTo(Na,ha).chest(tc,17);const Vb=(new Location$$module$js$nodes(c,101,M,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,M,"Tunnel 1 (entrance)")).sea().connect(Na,Pc,ha),Ed=(new Location$$module$js$nodes(c,105,M,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,M,"Tunnel 2b (dead end to left)")).cave().connect(Ed,x);const Hg=(new Location$$module$js$nodes(c,
105,M,"Tunnel 2c (across first river)")).cave().connect(Ed,x),Fd=(new Location$$module$js$nodes(c,105,M,"Tunnel 2d (across second river)")).cave().connect(Hg,x);(new Location$$module$js$nodes(c,105,M,"Tunnel 2e (dead end, magic ring)")).cave().connect(Fd,C).chest(Z,29);const Ig=(new Location$$module$js$nodes(c,105,M,"Tunnel 2f (stair down)")).cave().connect(Fd,C),Jg=(new Location$$module$js$nodes(c,106,M,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(Vb).chest(Ea,25,92),Kg=(new Location$$module$js$nodes(c,
106,M,"Tunnel 3b (left area toward items)")).cave().connect(Jg,C),Lg=(new Location$$module$js$nodes(c,107,M,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(R,14,115);(new Location$$module$js$nodes(c,107,M,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,x).chest(he,15);const Wb=(new Location$$module$js$nodes(c,108,ra,"Floor 1")).fortress().connect(Vb),Mg=(new Location$$module$js$nodes(c,108,ra,"Miniboss")).fortress().boss(cf).connect(Wb);(new Location$$module$js$nodes(c,109,ra,
"Floor 2a (left stair)")).fortress().connect(Wb).chest(Q,19);const Ng=(new Location$$module$js$nodes(c,109,ra,"Floor 2b (right stair)")).fortress().connect(Mg).chest(K,30,85),Og=(new Location$$module$js$nodes(c,110,ra,"Floor 3a (toward boss)")).fortress().connect(Ng),Gd=(new Location$$module$js$nodes(c,110,ra,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$js$nodes(c,110,ra,"Boss")).fortress().boss(dd).connect(Gd);(new Location$$module$js$nodes(c,110,ra,"Floor 3c (back room trap)")).fortress().from(Gd).to(Wb);
const Pg=(new Location$$module$js$nodes(c,112,qa,"Secret Passage")).cave().connectTo(Bd),tb=(new Location$$module$js$nodes(c,113,qa,"Town")).town().connect(Bg),ka=(new Location$$module$js$nodes(c,114,ba,"Town")).town().connect(Dg),Qg=(new Location$$module$js$nodes(c,115,ba,"Inside Gate")).overworld().connect(ka),Rg=(new Location$$module$js$nodes(c,115,ba,"Outside Gate")).overworld().from(Qg,wa),ub=(new Location$$module$js$nodes(c,120,Aa,"Valley")).overworld().connect(Rg),Xb=(new Location$$module$js$nodes(c,
124,E,"Entrance")).overworld().connect(ub),Sg=(new Location$$module$js$nodes(c,124,E,"Over first river toward Shyron")).overworld().connect(Xb,x),Hd=(new Location$$module$js$nodes(c,124,E,"After first tunnel")).overworld(),Id=(new Location$$module$js$nodes(c,124,E,"Door to Styx")).overworld().connect(Hd,x),Tg=(new Location$$module$js$nodes(c,124,E,"Dead end (no item)")).overworld(),Ug=(new Location$$module$js$nodes(c,124,E,"Dead end (fruit of lime)")).overworld().chest(zb,26),Vg=(new Location$$module$js$nodes(c,
124,E,"Dead end (magic ring)")).overworld().chest(Z,25,101),Jd=(new Location$$module$js$nodes(c,124,E,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(c,124,E,"Floating island (bow of sun)")).overworld().connect(Jd,G).chest(wc,24);const Wg=(new Location$$module$js$nodes(c,125,E,"Tunnel 1 (to Shyron)")).cave().connect(Sg),Xg=(new Location$$module$js$nodes(c,126,E,"Outside Shyron")).overworld().connect(Wg);(new Location$$module$js$nodes(c,127,E,"Tunnel 2 (fork)")).cave().connect(Xb).connectTo(Ug).connectTo(Hd);
const Kd=(new Location$$module$js$nodes(c,128,E,"Tunnel 3 (caves)")).cave().connect(Id).connect(Tg),Ld=(new Location$$module$js$nodes(c,129,E,"Tunnel 4 (left branch of cave)")).cave().connect(Kd);(new Location$$module$js$nodes(c,130,E,"Tunnel 5 (dead end, medical herb)")).cave().connect(Ld).chest(K,15,86);const Yg=(new Location$$module$js$nodes(c,131,E,"Tunnel 6a (left-then-right)")).cave().connect(Ld),Zg=(new Location$$module$js$nodes(c,131,E,"Tunnel 6b (past wall)")).cave().connect(Yg,C),$g=(new Location$$module$js$nodes(c,
132,E,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,E,"Tunnel 8 (red slimes)")).cave().from($g,C).connectTo(Jd).chest(R,23,116);const ah=(new Location$$module$js$nodes(c,134,E,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Kd),bh=(new Location$$module$js$nodes(c,135,E,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,135,E,"Tunnel 10b (past wall)")).cave().connect(bh,C).connectTo(Vg);const Md=(new Location$$module$js$nodes(c,
136,za,"Entrance")).fortress().from(Id,oc,Nb),ch=(new Location$$module$js$nodes(c,137,za,"Left branch")).fortress().connect(Md).chest(R,19,117),dh=(new Location$$module$js$nodes(c,137,za,"Left branch, past one bridge")).fortress().connect(ch,x),eh=(new Location$$module$js$nodes(c,137,za,"Left branch, past two bridges")).fortress().connect(dh,x).chest(K,29,87),fh=(new Location$$module$js$nodes(c,137,za,"Right branch")).fortress().connect(Md);(new Location$$module$js$nodes(c,137,za,"Right branch, across water")).fortress().connect(fh,
G).chest(R,20,118).chest(R,21,119).chest(Zd,28);(new Location$$module$js$nodes(c,138,za,"Upper floor")).fortress().connect(eh).chest(N,27);const Oa=(new Location$$module$js$nodes(c,140,sa,"Town")).town().connect(Xg,Re).trigger(Mb),Xa=(new Location$$module$js$nodes(c,142,Aa,"Town")).town().connect(ub),Nd=(new Location$$module$js$nodes(c,143,L,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,L,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Nd,
Fa).chest(fe,15);const Yb=(new Location$$module$js$nodes(c,144,Aa,"Desert 1")).overworld().connect(ub),vb=(new Location$$module$js$nodes(c,145,L,"Area 1 (from entrance)")).cave().chest(lc,26),Od=(new Location$$module$js$nodes(c,145,L,"Area 2 (across top bridge)")).cave().connect(vb,x);(new Location$$module$js$nodes(c,145,L,"Area 3 (dead-end across top-right bridge)")).cave().connect(Od,x);const gh=(new Location$$module$js$nodes(c,145,L,"Area 4 (left across middle-right bridge)")).cave().connect(Od,
x),hh=(new Location$$module$js$nodes(c,145,L,"Area 5 (bottom edge)")).cave().connect(gh,x),ih=(new Location$$module$js$nodes(c,145,L,"Area 6 (bottom island)")).cave().connect(hh,x),jh=(new Location$$module$js$nodes(c,145,L,"Area 7 (bottom inner ring)")).cave().connect(ih,x),kh=(new Location$$module$js$nodes(c,145,L,"Area 8 (left outer ring)")).cave().connect(jh,x).connect(vb,x).chest(Q,27,100),lh=(new Location$$module$js$nodes(c,145,L,"Area 9 (top left inner ring)")).cave().connect(kh,x),mh=(new Location$$module$js$nodes(c,
145,L,"Area 10 (top right inner ring)")).cave().connect(lh,x);(new Location$$module$js$nodes(c,145,L,"Area 11 (center)")).cave().connect(mh,x).connectTo(Nd);(new Location$$module$js$nodes(c,145,L,"Area 12 (top center islands)")).cave().connect(vb,G).chest(de,28);const nh=(new Location$$module$js$nodes(c,146,da,"Desert Cave 1")).cave().connect(Yb,G),Pa=(new Location$$module$js$nodes(c,147,da,"Town")).town(),oh=(new Location$$module$js$nodes(c,148,da,"Outside Cave")).overworld().connect(Pa),ph=(new Location$$module$js$nodes(c,
149,da,"Desert Cave 2")).cave().connect(oh);(new Location$$module$js$nodes(c,150,da,"Meadow")).overworld().connect(nh).connectTo(Pa).trigger(Be,wa,Ze);const Zb=(new Location$$module$js$nodes(c,152,da,"Desert 2")).overworld().connect(ph),qh=(new Location$$module$js$nodes(c,156,Ka,"Entrance")).fortress().connect(Zb,G),rh=(new Location$$module$js$nodes(c,156,Ka,"Azteca")).fortress().trigger(De),sh=(new Location$$module$js$nodes(c,157,Ka,"Fork")).fortress().connect(qh),Pd=(new Location$$module$js$nodes(c,
158,Ka,"Main")).fortress().connect(sh);(new Location$$module$js$nodes(c,158,Ka,"Treasure Chest (magic ring)")).fortress().connect(Pd).chest(Z,27,108);(new Location$$module$js$nodes(c,159,Ka,"Draygon")).fortress().connect(Pd).to(rh).boss(jf);const th=(new Location$$module$js$nodes(c,160,ia,"Entrance")).fortress().connect(Zb,G),uh=(new Location$$module$js$nodes(c,160,ia,"Statues")).fortress().connect(th).boss(kf),vh=(new Location$$module$js$nodes(c,161,ia,"Hall 1")).fortress().connect(uh),$b=(new Location$$module$js$nodes(c,
162,ia,"Branch")).fortress().connect(vh);(new Location$$module$js$nodes(c,163,ia,"Left Dead End")).fortress().connect($b).chest(R,13,120);(new Location$$module$js$nodes(c,164,ia,"Right Dead End")).fortress().connect($b);const wh=(new Location$$module$js$nodes(c,165,ia,"Hall 2")).fortress().connect($b).chest(Bb,26,109),xh=(new Location$$module$js$nodes(c,166,ia,"Draygon 2")).fortress().connect(wh).boss(lf);(new Location$$module$js$nodes(c,167,ia,"Teleporter")).fortress().from(xh).to(zd);const Qd=(new Location$$module$js$nodes(c,
168,mb,"Entrance")).fortress().connect(Xa,Nb).trigger(Tc,N),yh=(new Location$$module$js$nodes(c,169,mb,"Main")).fortress().from(Qd,Fa),zh=(new Location$$module$js$nodes(c,169,mb,"Boss")).fortress().connect(yh).boss(ef),Ah=(new Location$$module$js$nodes(c,170,mb,"Zebu")).fortress().connect(zh),wb=(new Location$$module$js$nodes(c,171,ca,"Entrance")).fortress().connect(Ah);(new Location$$module$js$nodes(c,171,ca,"Dead End Behind Iron (fruit of power)")).fortress().connect(wb,Fa).chest(Q,28,98);(new Location$$module$js$nodes(c,
171,ca,"Dead End Loop Across Closer Bridges")).fortress().connect(wb,x).connect(wb,x);const Bh=(new Location$$module$js$nodes(c,171,ca,"Across First Bridge (fruit of repun)")).fortress().connect(wb,x).chest(Ab,30,102),ac=(new Location$$module$js$nodes(c,171,ca,"Across Second Bridge")).fortress().connect(Bh,x);(new Location$$module$js$nodes(c,171,ca,"Dead End Across Two Bridges ()")).fortress().connect(ac,x).connect(ac,x).chest(Ea,29,93);const Ch=(new Location$$module$js$nodes(c,171,ca,"Across Third Bridge")).fortress().connect(ac,
x),Dh=(new Location$$module$js$nodes(c,171,ca,"Exit Behind Iron Door")).fortress().connect(Ch,Fa),Eh=(new Location$$module$js$nodes(c,172,ca,"Boss")).fortress().connect(Dh).boss(ff),Fh=(new Location$$module$js$nodes(c,172,ca,"Tornel")).fortress().connect(Eh),Rd=(new Location$$module$js$nodes(c,173,Ja,"Lower")).fortress().connect(Fh).chest(Bb,26,99).chest(Z,27,111),Gh=(new Location$$module$js$nodes(c,174,Ja,"Upper Loop")).fortress().connect(Rd).chest(O,22,96);(new Location$$module$js$nodes(c,174,Ja,
"Upper Loop Behind Wall (magic ring)")).fortress().connect(Gh,Fa).chest(Z,23,107);const Hh=(new Location$$module$js$nodes(c,175,Ja,"Upper Passage (toward Mado)")).fortress().connect(Rd).chest(Z,27,84),bc=(new Location$$module$js$nodes(c,176,S,"Initial Fork")).fortress(),Ih=(new Location$$module$js$nodes(c,177,S,"Left Branch")).fortress().connect(bc),Sd=(new Location$$module$js$nodes(c,178,S,"Main Area (right branch, over bridges)")).fortress().connect(bc),Jh=(new Location$$module$js$nodes(c,179,S,
"U-shaped Passage (between floors)")).fortress().connect(Sd),Kh=(new Location$$module$js$nodes(c,180,S,"Main Area Lower (under bridge)")).fortress().connect(Ih).connect(Sd).connect(Jh),Td=(new Location$$module$js$nodes(c,180,S,"Behind Iron Wall")).fortress().connect(Kh,Fa),Lh=(new Location$$module$js$nodes(c,181,S,"Lower")).fortress().connect(Td).chest(R,13,121).chest(R,14,122).chest(R,15,123).chest(Z,23,88).chest(V,24,110),Mh=(new Location$$module$js$nodes(c,182,S,"Boss Corridor")).fortress().connect(Lh),
Nh=(new Location$$module$js$nodes(c,182,S,"Boss")).fortress().connect(Mh,Nb).boss(hf);(new Location$$module$js$nodes(c,182,S,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(eb,18);const Ud=(new Location$$module$js$nodes(c,183,S,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,184,L,"Entrance Back (behind river)")).cave().connect(Ud).chest(Q,13,90);(new Location$$module$js$nodes(c,184,L,"Entrance Front")).cave().connect(Oh,G).connectTo(Yb).connectTo(vb);const Ph=(new Location$$module$js$nodes(c,
185,Ja,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$js$nodes(c,185,Ja,"Asina")).fortress().connect(Ph).connectTo(bc);(new Location$$module$js$nodes(c,186,S,"Kensu")).fortress().connect(Td).connectTo(Ud).trigger(Ae,Hb);(new Location$$module$js$nodes(c,187,Aa,"House")).house().connect(Xa).trigger(Ce,wa,Hb);(new Location$$module$js$nodes(c,188,Aa,"Inn")).shop().connect(Xa,Mb);(new Location$$module$js$nodes(c,190,Aa,"Tool Shop")).shop(K,O,V,Q).connect(Xa,Mb);(new Location$$module$js$nodes(c,
191,Aa,"Tavern")).shop().connect(Xa);(new Location$$module$js$nodes(c,192,aa,"Elder House")).house().connect(ta).trigger(Ac);(new Location$$module$js$nodes(c,193,aa,"Rabbit Hut")).house().connect(ta).trigger(Gc,Fc,ma);(new Location$$module$js$nodes(c,194,aa,"Inn")).shop().connect(ta);(new Location$$module$js$nodes(c,195,aa,"Tool Shop")).shop(K,O,V,Q).connect(ta);(new Location$$module$js$nodes(c,196,aa,"Armor Shop")).shop($d,dc).connect(ta);(new Location$$module$js$nodes(c,197,aa,"Student House")).house().connect(ta).trigger(Bc);
(new Location$$module$js$nodes(c,198,Ha,"Tavern")).house().connect(Wa);(new Location$$module$js$nodes(c,199,Ha,"Pawn Shop")).shop().connect(Wa);(new Location$$module$js$nodes(c,200,Ha,"Inn")).shop().connect(Wa);(new Location$$module$js$nodes(c,201,Ha,"Armor Shop")).shop(ae,dc,Xd).connect(Wa);(new Location$$module$js$nodes(c,203,Ha,"Tool Shop")).shop(K,O,V).connect(Wa);(new Location$$module$js$nodes(c,205,Ua,"Elder House")).house().from(ob,ma).trigger(pe,Jb);(new Location$$module$js$nodes(c,206,Ua,
"Mother's House")).house().from(ob,ma).trigger(Ec,ma).trigger(oe,Jb);(new Location$$module$js$nodes(c,207,Ua,"Tool Shop")).shop(K,O,Q).from(ob,ma);(new Location$$module$js$nodes(c,208,Ua,"Inn")).shop().from(ob,ma);(new Location$$module$js$nodes(c,209,Ia,"Inn")).shop().connect(nb);(new Location$$module$js$nodes(c,210,Ia,"Tool Shop")).shop(V,Q,Ea).connect(nb);(new Location$$module$js$nodes(c,211,Ia,"Armor Shop")).shop(hc,ec,fc,yb).connect(nb);const Qh=(new Location$$module$js$nodes(c,212,Ia,"Queen's House")).house().from(nb,
Se).trigger(ye,wa,uc);(new Location$$module$js$nodes(c,213,lb,"Nadare's")).house().connect(pb).connectTo(Yf).connectTo(Zf).connectTo($f);(new Location$$module$js$nodes(c,214,F,"Fisherman's House")).house().connect(xd).trigger(Kb,pc,Gb,Te);const cc=(new Location$$module$js$nodes(c,215,F,"Palace Entrance")).house().connect(Ba);(new Location$$module$js$nodes(c,216,F,"Fortune Teller Front")).house().connect(Ba).trigger(Ic,Hc);(new Location$$module$js$nodes(c,216,F,"Fortune Teller Back")).house().connect(Eg).connect(Cd);
(new Location$$module$js$nodes(c,217,F,"Pawn Shop")).shop().connect(Ba);(new Location$$module$js$nodes(c,218,F,"Armor Shop")).shop(be,hc,ec).connect(Ba);(new Location$$module$js$nodes(c,220,F,"Inn")).shop().connect(Ba);(new Location$$module$js$nodes(c,221,F,"Tool Shop")).shop(K,Ea,zb,V).connect(Ba);(new Location$$module$js$nodes(c,222,F,"Palace Left")).house().connect(cc);(new Location$$module$js$nodes(c,223,F,"Palace Throne Room")).house().connect(cc).to(sb,Me).from(sb).trigger(Hc).trigger(se,Ic,
Jc);(new Location$$module$js$nodes(c,224,F,"Palace Right")).house().connect(cc);(new Location$$module$js$nodes(c,225,F,"Asina's Room")).house().connect(Dd).trigger(Mc,Wc);(new Location$$module$js$nodes(c,226,Ia,"Queen Downstairs")).house().connect(Qh).chest(cb,13);(new Location$$module$js$nodes(c,227,qa,"Elder's House")).house().connect(tb).trigger(Pc);(new Location$$module$js$nodes(c,228,qa,"Shed")).house().connect(tb).to(Pg,qc);(new Location$$module$js$nodes(c,229,qa,"Tool Shop")).shop(K,O,Q,Ea).connect(tb);
(new Location$$module$js$nodes(c,231,qa,"Inn")).shop().connect(tb);const Rh=(new Location$$module$js$nodes(c,232,M,"Zombie Town House")).house().connect(Vb);(new Location$$module$js$nodes(c,233,M,"Zombie Town Basement")).house().connect(Rh).trigger(ue,dd);(new Location$$module$js$nodes(c,235,ba,"Tool Shop")).shop(K,O,Q,V).connect(ka);(new Location$$module$js$nodes(c,236,ba,"Stom's Hut")).house().connect(ka).trigger(Qc);(new Location$$module$js$nodes(c,237,ba,"Inn")).shop().connect(ka);(new Location$$module$js$nodes(c,
238,ba,"Armor Shop")).shop(ce,ic,Yd,gc).connect(ka);(new Location$$module$js$nodes(c,239,ba,"Tavern")).house().connect(ka).trigger(Rc,Qc,Sa);(new Location$$module$js$nodes(c,240,ba,"Pawn Shop")).shop().connect(ka);(new Location$$module$js$nodes(c,241,ba,"Dance Hall")).house().connect(ka).trigger(Sc,Rc,Sa).trigger(xe,Sc,tc);const Sh=(new Location$$module$js$nodes(c,242,sa,"Temple (pre-massacre)")).fortress().connect(Oa).from(Ob,N,Da).trigger(ze);(new Location$$module$js$nodes(c,242,sa,"Temple (post-massacre)")).fortress().from(Sh,
Tc).boss(df);(new Location$$module$js$nodes(c,243,sa,"Training Hall")).house().connect(Oa);(new Location$$module$js$nodes(c,244,sa,"Hospital")).house().connect(Oa);(new Location$$module$js$nodes(c,245,sa,"Armor Shop")).shop(ic,yb,gc).connect(Oa);(new Location$$module$js$nodes(c,246,sa,"Tool Shop")).shop(K,O,zb,Z).connect(Oa);(new Location$$module$js$nodes(c,247,sa,"Inn")).shop().connect(Oa);(new Location$$module$js$nodes(c,248,da,"Inn")).shop().connect(Pa);(new Location$$module$js$nodes(c,249,da,
"Tool Shop")).shop(O,V,Ab,Z).connect(Pa);(new Location$$module$js$nodes(c,250,da,"Elder's House")).house().connect(Pa);(new Location$$module$js$nodes(c,251,da,"Pawn Shop")).house().connect(Pa);const Th=[ta,Va,fd,La,Pb,Ma,Sb,rd,Ub,ka,ub,Xb,Yb,Qd,Zb];for(const a of Th)a.from(Ob,He);return c},shuffle$$module$js$depgraph=(a,b,c,d,e)=>{d=void 0===d?new FlagSet$$module$js$flagset("Sbkm Sct"):d;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d,a);d.shuffleShops()&&
f.shuffleShops(b);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&k.slots){var m=k.slotType[0];(h[m]=h[m]||[]).push(k)}k=[];m=[];var l={};for(var n of d.get("S")){var p=[];for(var r of n){l[r]=!0;for(var q of h[r])p.push(q),m.push([q,k.length])}k.push(p)}for(var t of"bc")if(l[t])for(n=h[t],r=n.map((a)=>[a.item,a.itemIndex]),b.shuffle(r),q=0;q<n.length;q++)n[q].set(r[q][0],r[q][1]);p=(a)=>g.find((b)=>
b.vanillaItemName===a);h=p("Sword of Wind");t=p("Sword of Fire");n=p("Ball of Wind");r=p("Ball of Fire");q=p("Statue of Onyx");p=p("Gas Mask");l.k&&b.nextInt(2)&&(t.swap(h),r.swap(n));l.k&&!b.nextInt(3)&&q.swap(p);l=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(t=0;1E3>t;t++){e&&0===t%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));b.shuffle(m);for(var u of k)b.shuffle(u);n=k.map(()=>-1);r=l[b.nextInt(l.length)];q=[];p=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||
b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<r;a++){const [b,c]=m[a],d=k[c][++n[c]];p(b,d)&&(b.swap(d),q.push([b,d]))}if(!q.length)continue;const {win:a,path:c}=f.traverse({wanted:g,dfs:!1});if(a)h=c;else for(;q.length;){const [a,b]=q.pop();a.swap(b)}}a&&f.write();if(c){c.items=[];c.route=[];for(const a of h){const [b,d]=a;c.route.push(d);u=f.nodes[b];u instanceof Slot$$module$js$nodes&&!u.isFixed()&&null!=u.slotName&&(k=u.slotName,
...
a.slots&&!a.isFixed());const m=new Map(d.shuffle(k.map((a)=>[a,[a.item,a.itemIndex]]))),l=new Set(d.shuffle(k)),n=new Map,p={};g&&g.seeds++;f.get("S").forEach((a,b)=>{for(const c of a)p[c]=b});for(var r of l)n.set(r.item,r);const q=new Set,t=(a,b)=>{if(null==p[a.slotType?a.slotType[0]:"c"])return a===b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!==b.item.inventoryRow&&a.requiresUnique||"armor"===b.item.inventoryRow&&!a.isChest())return!1;if(f.guaranteeSword()){if(0===a.slotIndex)return 4>b.item.id;
if(4>b.item.id&&(q.add(b),4===q.size))return 0===a.slotIndex}return p[a.slotType?a.slotType[0]:"c"]===p[b.slotType?b.slotType[0]:"c"]};r=b.assumedFill(d,(a,b)=>t(a,n.get(b)));if(null==r){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const u=new Map;for(var v=0;v<r.length;v++){var y=r[v];if(null!=y){var ea=n.get(b.item(y));y=m.get(ea);m.delete(ea);ea=b.location(v);u.set(ea,y);l.delete(ea)}}v=(a,b,c)=>{c=void 0===c?"":c;for(const c of l)if(t(c,a))return u.set(c,b),l.delete(c),m.delete(a),
!0;g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var w of m){const [a,b]=w;if(a.isMimic()&&!v(a,b,"traps"))return!1}for(const a of m){const [b,c]=a;if(b.needsChest()&&!v(b,c,"chest"))return!1}for(const a of m){const [b,c]=a;if(!v(b,c))return!1}for(const a of u){const [b,c]=a;b.set(...c)}const {win:B,path:z}=a.traverse({wanted:k,dfs:!1});if(!B)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,r));
e.items=[];e.route=[];for(const b of z){const [c,d]=b;e.route.push(d);k=a.nodes[c];k instanceof Slot$$module$js$nodes&&!k.isFixed()&&(w=k.slotName,0>w.indexOf(k.vanillaItemName)&&(w+=` (normally ${k.vanillaItemName})`),e.items.push({itemIndex:k.itemIndex,itemName:k.item.name,origName:k.vanillaItemName,slotIndex:k.slotIndex,slotName:k.slotName,text:`${k.item.name}: ${w}`}))}return!0})};var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;module$js$depgraph.shuffle=shuffle$$module$js$depgraph;
...
c.addTasks(Math.floor(d/100));for(let p=0;p<d;p++){c&&99===p%100&&(yield new Promise(requestAnimationFrame),c.addCompleted(1));var f=e.items(a,b);let r=Bits$$module$js$bits.from(new Set(f));var g=new GenericFill$$module$js$graph$shuffle,h=new Map,k=new Map,m=[];for(var l=a.fixed;l<a.items.length;l++){var n=a.items[l].item;null!=n&&(h.set(n,l),e.shuffleRules.shouldShuffle(n)||m.push(n))}for(l=a.fixed;l<a.slots.length;l++)n=a.slots[l].item,null!=n&&k.set(n,l);for(const a of m)m=h.get(a),l=k.get(a),
null!=l&&null!=m&&(g.set(l,m),r=Bits$$module$js$bits.without(r,m));e.flags.guaranteeSword()&&(m=b.nextInt(4),h=h.get(m),k=k.get(0),null==h||null==k||g.hasSlot(k)||g.hasItem(h)||(g.set(k,h),r=Bits$$module$js$bits.without(r,h)));if(e.fillInternal(a,b,g,f,r,Math.floor(p/5)))if(f=traverse$$module$js$graph$shuffle(a,g,Bits$$module$js$bits.of()),f.size!==a.slots.length)console.error("unexpected size mismatch!",f,a);else if(g=e.fill(a,expandFill$$module$js$graph$shuffle(a,g),b),null!=g)return c&&c.addCompleted(Math.floor((d-
...
e.set(module$js$graph$geometry.ScreenId.from(b,a),a.id&3);for(let f=0,g=b.height;f<g;f++){const g=b.screens[f],h=b.id<<8|f<<4;for(let f=0,k=b.width;f<k;f++){var n=function(a,b){if(!t)throw Error("flag expected");return b?a?v(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(t.flag)},b):a};const k=a.screens[g[f]|r],m=module$js$graph$geometry.ScreenId(h|f),l=m&255,w=e.get(m),t=null!=w?c.wallCapability(w):b.flags.find((a)=>a.yx===l),v=memoize2$$module$js$graph$condition((a,
b)=>{if(!t)throw Error("flag expected");b=Object.assign({},b,{enter:meet$$module$js$graph$condition(b.enter||[[]],module$js$graph$condition.Condition(t.flag))});return module$js$graph$condition.Terrain.join(a,b)});for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(m<<8|a);let e=k.tiles[a];t&&751===t.flag&&32>e&&(e=q.alternates[e]);let f=c.makeTerrain(r?0:p.effects[e]&38,b);if(32>e&&q.alternates[e]!=e&&t&&751!==t.flag){const a=c.makeTerrain(p.effects[q.alternates[e]],b);f=n(f,a)}f&&d.set(b,
...
entrance:e}=c,f=module$js$graph$geometry.TileId.from(b,c),g=e&32?module$js$graph$geometry.TileId(f&65535|d<<16):module$js$graph$geometry.TileId.from({id:d},a.locations[d].entrances[e]);r.add(module$js$graph$geometry.TilePair.of(p.find(f),p.find(g)))}for(const a of r){const [b,c]=module$js$graph$geometry.TilePair.split(a);if(d.get(b)!==d.get(c))continue;const e=module$js$graph$geometry.TilePair.of(c,b);r.has(e)&&(p.union([b,c]),r.delete(a),r.delete(e))}const q=new Neighbors$$module$js$graph$geometry(p,
m);for(const a of d){const [b,c]=a;{const a=module$js$graph$geometry.TileId.add(b,0,1),e=d.get(a);e&&e!==c&&q.addAdjacent(b,a,!1);const f=module$js$graph$geometry.TileId.add(b,1,0),g=d.get(f);g&&g!==c&&q.addAdjacent(b,f,!0)}}for(const a of r){const [b,c]=module$js$graph$geometry.TilePair.split(a);d.has(b)&&d.has(c)&&q.addExit(b,c)}const t=new Routes$$module$js$graph$routes;for(const a of c.extraRoutes())for(const b of a.condition||[[]])t.addRoute(p.find(a.tile),b);for(const a of c.extraEdges()){const {from:b,
to:c,condition:d}=a;for(const a of d||[[]])t.addEdge(p.find(c),p.find(b),a)}for(const a of q){const {from:b,to:c,south:e}=a;{const a=d.get(b),f=d.get(c);if(!a||!f)throw Error(`missing terrain ${a?c:b}`);for(const d of(e?a.exitSouth:a.exit)||[[]])for(const a of f.enter||[[]])t.addEdge(c,b,[...a,...d])}}const u=new DefaultMap$$module$js$util(()=>new MutableRequirement$$module$js$graph$condition);for(const a of c.capabilities()){const {condition:b=[[]],capability:c}=a;u.get(module$js$graph$condition.Slot(c)).addAll(b)}for(const a of h){const [b,
c]=a;{const a=p.find(b);if(b!==a){for(const b of c)h.get(a).add(b);h.delete(b)}}}for(const a of h){const [b,c]=a;for(const a of c){const {slot:c,condition:d=[[]]}=a;{const a=u.get(c);for(const c of d)for(const d of t.routes.get(b)||[])a.addList([...c,...d])}}}if(DEBUG$$module$js$graph$world&&"undefined"!==typeof window){var v=function(a,b){b=void 0===b?y:b;a=[...a];return a.length?"("+a.map((a)=>[...a].map(b).join(" & ")).join(") |\n     (")+")":"no route"},y=function(a){return 0>a?"~"+(~a).toString(16).padStart(2,
"0"):a.toString(16).padStart(3,"0")};const b=window;console.log(b.roots=(b.tiles=p).roots());console.log([...b.neighbors=q]);console.log(b.ll=t);b.area=(a,b)=>{b=void 0===b?y:b;const c=[...p.sets().filter((b)=>b.has(a))[0]].map((a)=>a.toString(16).padStart(6,"0")),d=v(t.routes.get(p.find(a)),b),e=[],f=p.find(a);for(const a of(t.edges.get(f)||new Map).values())e.push(`\nto ${a.target.toString(16)} if (${[...a.deps].map(b).join(" & ")})`);for(const a of t.edges){const [c,d]=a;for(const a of d.values())a.target===
...
b.reqs.check=(a,b)=>{b=void 0===b?y:b;return`${b(a)}: ${v(u.get(module$js$graph$condition.Slot(a)),b)}`};b.reqs.check2=(a)=>b.reqs.check(a,b.whatFlag)}return new World$$module$js$graph$world(a,p,makeGraph$$module$js$graph$world(u,a))}
...
k=[...g].filter((a)=>!c(a)).sort();g=[...g].filter(c).sort();m=[...h].filter(c).sort();const n=k.length;h=k.map(d);g=g.map(e);l=m.map(e);g=[...h,...g];k=[...h,...l];const p=new Map(g.map((a,b)=>[a.condition,b])),r=new Map(k.map((a,b)=>[a.condition,b]));m=[];const q=[];for(var t of a){const [c,d]=t;a=r.get(c);if(null==a)MAYBE_MISSING_SLOTS$$module$js$graph$world.has(c)||console.error(`Nothing depended on $${c.toString(16)}: ${conditionName$$module$js$graph$world(c,b)}`);else for(const b of d){const c=
[...b].map(f);(m[a]||(m[a]=[])).push(Bits$$module$js$bits.from(c));for(const b of c)(q[b]||(q[b]=new Set)).add(a)}}for(var u of[...h,...l])m[u.index]&&m[u.index].length||(t=u.condition,console.error(`Nothing provided $${t.toString(16)}: ${conditionName$$module$js$graph$world(t,b)} (index ${u.index})`));DEBUG$$module$js$graph$world&&console.log(m);u=q.map((a)=>[...a]);return{fixed:n,slots:k,items:g,graph:m,unlocks:u}}const MAYBE_MISSING_SLOTS$$module$js$graph$world=new Set([37,38,169,580]);
...
64:0)|b.entrances.length],k=[...concatIterables$$module$js$rom$util(b.flags),255],m=concatIterables$$module$js$rom$util(b.pits),[l,n,p,r,q,t]=yield Promise.all([d(e,"Layout"),d(f,"Graphics"),d(g,"Entrances"),d(h,"Exits"),d(k,"Flags"),...m.length?[d(m,"Pits")]:[]]);e=[l&255,(l>>>8)-192,n&255,(n>>>8)-192,p&255,(p>>>8)-192,r&255,(r>>>8)-192,q&255,(q>>>8)-192,...t?[t&255,(t>>8)-192]:[]];d=yield d(e,"MapData");writeLittleEndian$$module$js$rom$util(a.rom,b.mapDataPointer,d-49152);yield Promise.all(c);c=
...
function shuffleSwamp$$module$js$pass$shufflemazes(a,b,c=100){const d=a.locations.swamp;for(extendSwampScreens$$module$js$pass$shufflemazes(a);0<c--;){var e=function(){var a=k(ea);if(!a)return!1;var c=[];for(const d of fa)if(p(d)&&(!a.has(z[d])||!b.nextInt(w*B*2))){c.push(d);for(const c of b.shuffle([...Ya])){const b=d+la[c];if(p(b)&&!a.has(z[b])&&f(d,c))return!0}}a=b.pick(c);c=b.pick(Ya);p(a+la[c])&&f(a,c);return!0},f=function(a,b){const c=a+la[b];if(p(c))if(z[a]&1<<b){a=l(a,b);if(g())return!0;a()}else return n(a,
...
for(var m of this.locations)if(m.used&&a.has(m.tileset)){c.add(m.tileEffects);for(var l of m.allScreens())g.add(l)}for(var n of g)for(let a=0,b=n.tiles.length;a<b;a++)n.tiles[a]=d[n.tiles[a]];for(var p of a){d=this.tilesets[(p&127)>>>2];for(var r of b)for(m=0;m<r.length-1;m++){l=f(r[m]);n=f(r[m+1]);for(a=0;4>a;a++)d.tiles[a][l]=d.tiles[a][n];d.attrs[l]=d.attrs[n];if(32>n&&d.alternates[n]!==n){if(32<=l)throw Error(`Cannot unflag: ${p} ${l} ${n} ${d.alternates[n]}`);d.alternates[l]=d.alternates[n]}}for(var q of e){const [a,
b]=q;d.alternates[a]=b}}for(const a of c){p=this.tileEffects[a-179];for(const a of b)for(r=0;r<a.length-1;r++)q=f(a[r]),d=f(a[r+1]),p.effects[q]=p.effects[d];for(const a of e.keys())p.effects[a]|=8}}static load(a,b){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const c=yield pickFile$$module$js$rom(b);a&&(yield a(c));return new Rom$$module$js$rom(c)})}}Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX=module$js$rom$option.RomOption.bit(82624,0);
...
c,h);shuffleTrades$$module$js$pass$shuffletrades(l,c,h);c.randomizeMaps()&&shuffleSwamp$$module$js$pass$shufflemazes(l,h);const n=World$$module$js$graph$world.build(l,c),p=yield(new AssumedFill$$module$js$graph$shuffle(l,c)).shuffle(n.graph,h,f);if(p)n.traverse(n.graph,p),update$$module$js$rom$slots(l,p.slots);else return-1;rescaleShops$$module$js$patch(l,m,c.bargainHunting()?h:void 0);normalizeSwords$$module$js$patch(l,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(l,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(l);
c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(l);c.chargeShotsOnly()&&disableStabs$$module$js$patch(l);c.orbsOptional()&&orbsOptional$$module$js$patch(l);shuffleMusic$$module$js$patch(l,c,h);shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(l,c,h);misc$$module$js$patch(l,c,h);fixDialog$$module$js$pass$fixdialog(l);c.buffDyna()&&buffDyna$$module$js$patch(l,
...
new Set([80,83,95,105]);for(const h of SCALED_MONSTERS$$module$js$patch){const [k,{sdef:m,swrd:l,hits:n,satk:p,dgld:r,sexp:q}]=h;f=a.objects[k].data;g=e.has(k)?1:0;f[2]|=128;f[6]=n;f[7]=p;f[8]=m|l<<4;f[16]=f[16]&15|r<<4;f[17]=q;(g?b.shuffleBossElements():b.shuffleMonsterElements())&&!d.has(k)&&(f=[...a.objects[k].elements.toString(2).padStart(4,"0")],c.shuffle(f),a.objects[k].elements=Number.parseInt(f.join(""),2))}if(b.shuffleMonsterElements()){b=c.nextInt(4);a.prg[217645]=b+1;for(const c of d)a.objects[c].elements=
1<<b}}
