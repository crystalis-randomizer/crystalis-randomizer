...
(function(a){a.concat=function*(...a){for(const b of a)yield*b}})(iters$$module$js$util||(iters$$module$js$util={}));const INVALIDATED$$module$js$util=Symbol("Invalidated"),SIZE$$module$js$util=Symbol("Size");
...
for(const {title:a,flags:b}of PRESETS$$module$js$flagset)PRESETS_BY_KEY$$module$js$flagset[`@${a.replace(/ /g,"").toLowerCase()}`]=b;
...
d&&(0<=e.sells.indexOf(d)||4<=e.sells.length?g.push(d):e.sells.push(d));for(const {shops:a}of[b,c])for(const b of a)b.sells.sort((a,b)=>a.id-b.id)}integrate({tracker:a=!1}={}){var b=!a;const c=new SparseDependencyGraph$$module$js$graph(this.nodes.length);var d=[],e=[];const f=new Set,g=new Map;var h=[];const k=[],l=[],m=[],n=[],q=new Set;for(const a of this.nodes)if(a instanceof Location$$module$js$nodes){if(a.isStart){const [b]=c.addRoute([a.uid]);g.set(b.label,b)}d[a.uid]=[];e[a.uid]=[];for(const b of a.connections)f.has(b)||
(f.add(b),b.bidi&&f.add(b.reverse()));for(const b of a.chests)c.addRoute([b.uid,a.uid])}else if(a instanceof ItemGet$$module$js$nodes&&"Medical Herb"===a.name&&(c.addRoute([a.uid]),c.finalize(a.uid)),a instanceof Option$$module$js$nodes)h.push(a);else if(a instanceof TrackerNode$$module$js$nodes)k.push(a);else if(a instanceof Condition$$module$js$nodes)l.push(a);else if(a instanceof Trigger$$module$js$nodes)m.push(a);else if(a instanceof ItemGet$$module$js$nodes)n.push(a);else if(a instanceof Slot$$module$js$nodes)q.add(a);
...
a)}}e(l);for(d=0;d<this.nodes.length;d++)this.nodes[d]instanceof ItemGet$$module$js$nodes||this.nodes[d]instanceof TrackerNode$$module$js$nodes||c.finalize(d);d=new LocationList$$module$js$nodes(this);for(const a of q)for(const b of c.nodes[a.uid].values())d.addRoute([a.uid,...b]);return d}}
...
a.assumeGhettoFlight())),m=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),q=h(d("Assume teleport skip",a.assumeTeleportSkip())),p=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),t=h(d("Allow rabbit skip",!a.disableRabbitSkip())),u=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),w=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),J=h(d("Assume wild warp",a.assumeWildWarp())),
x=d("Allow wild warp",a.allowWildWarp()),G=d("Sword magic optional",!a.guaranteeSwordMagic()),K=d("Matching sword optional",!a.guaranteeMatchingSword()),Qa=d("Gas mask optional",!a.guaranteeGasMask()),Pd=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),Qd=d("Calm sea optional",!a.barrierRequiresCalmSea()),Rd=d("Prison key optional",!a.paralysisRequiresPrisonKey()),Sd=d("Windmill optional",!a.sealedCaveRequiresWindmill()),Td=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
...
1,"Sword of Fire")).weight(a.guaranteeSword()?10:5).fromPerson("Oak elder",29).dialog(29,void 0,3).key(),O=(new Item$$module$js$nodes(c,2,"Sword of Water")).weight(10).chest().key(),M=(new Item$$module$js$nodes(c,3,"Sword of Thunder")).weight(15).chest().key(),pb=(new Item$$module$js$nodes(c,4,"Crystalis")).fixed(),Ia=(new Item$$module$js$nodes(c,5,"Ball of Wind")).chest().key(),Ja=(new Item$$module$js$nodes(c,6,"Tornado Bracelet")).chest().key(),Sa=(new Item$$module$js$nodes(c,7,"Ball of Fire")).bossDrop("Insect",
1).dialog(30,void 0,2).dialog(32,void 0,0).dialog(33,void 0,0).dialog(34,void 0,0).dialog(96,30,0).dialog(29,void 0,2).dialog(31,void 0,1).npcSpawn(193).key(),Ta=(new Item$$module$js$nodes(c,8,"Flame Bracelet")).bossDrop("Kelbesque 1",2).npcSpawn(194).key(),Ua=(new Item$$module$js$nodes(c,9,"Ball of Water")).weight(5).direct("Rage",250679).npcSpawn(195).key(),Va=(new Item$$module$js$nodes(c,10,"Blizzard Bracelet")).weight(5).chest().key(),Wa=(new Item$$module$js$nodes(c,11,"Ball of Thunder")).bossDrop("Mado 1",
5).trigger(154,1).key(),Xa=(new Item$$module$js$nodes(c,12,"Storm Bracelet")).chest().key(),Yb=(new Item$$module$js$nodes(c,13,"Carapace Shield")).armor(),Xd=(new Item$$module$js$nodes(c,14,"Bronze Shield")).armor(),Zb=(new Item$$module$js$nodes(c,15,"Platinum Shield")).armor(),$b=(new Item$$module$js$nodes(c,16,"Mirrored Shield")).armor(),Yd=(new Item$$module$js$nodes(c,17,"Ceramic Shield")).armor(),qb=(new Item$$module$js$nodes(c,18,"Sacred Shield")).armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),
ac=(new Item$$module$js$nodes(c,19,"Battle Shield")).armor(),Zd=(new Item$$module$js$nodes(c,20,"Psycho Shield")).armor(),$d=(new Item$$module$js$nodes(c,21,"Tanned Hide")).armor(),ae=(new Item$$module$js$nodes(c,22,"Leather Armor")).armor(),be=(new Item$$module$js$nodes(c,23,"Bronze Armor")).armor(),bc=(new Item$$module$js$nodes(c,24,"Platinmum Armor")).armor(),ce=(new Item$$module$js$nodes(c,25,"Soldier Suit")).armor(),cc=(new Item$$module$js$nodes(c,26,"Ceramic Suit")).armor(),de=(new Item$$module$js$nodes(c,
27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),H=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),N=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),wa=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),rb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),P=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),Y=(new Item$$module$js$nodes(c,
34,"Magic Ring")).consumable(),sb=(new Item$$module$js$nodes(c,35,"Fruit of Repun")).consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),U=(new Item$$module$js$nodes(c,36,"Warp Boots")).consumable(),dc=(new Item$$module$js$nodes(c,37,"Statue of Onyx")).chest("Cordel grass").invisible(254882).key(),tb=(new Item$$module$js$nodes(c,38,"Opel Statue")).consumable().bossDrop("Kelbesque 2",6).npcSpawn(197).key(),ec=(new Item$$module$js$nodes(c,39,"Insect Flute")).fromPerson("Oak mother",30).dialog(30,
void 0,1).key(),ub=(new Item$$module$js$nodes(c,40,"Flute of Lime")).fromPerson("Portoa queen",56).fromPerson("Asina secondary",98,1).dialog(56,void 0,4).key(),Ya=(new Item$$module$js$nodes(c,41,"Gas Mask")).direct("Akahana in Brynmaer",251902).npcSpawn(22,24).key(),fe=(new Item$$module$js$nodes(c,42,"Power Ring")).chest().bonus(),ge=(new Item$$module$js$nodes(c,43,"Warrior Ring")).fromPerson("Akahana's friend",84).dialog(84,void 0,2).bonus(),he=(new Item$$module$js$nodes(c,44,"Iron Necklace")).chest().bonus(),
ie=(new Item$$module$js$nodes(c,45,"Deo's Pendant")).fromPerson("Deo",90).dialog(90,void 0,0).bonus(),vb=(new Item$$module$js$nodes(c,46,"Rabbit Boots")).bossDrop("Vampire 1",0).npcSpawn(192).key(),fc=((a,b)=>new Item$$module$js$nodes(c,a,b))(47,a.leatherBootsGiveSpeed()?"Speed Boots":"Leather Boots").chest().bonus(),gc=(new Item$$module$js$nodes(c,48,"Shield Ring")).direct("Akahana in waterfall cave",250543).bonus(),wb=(new Item$$module$js$nodes(c,49,"Alarm Flute")).fromPerson("Zebu's student",20,
1).key(),hc=(new Item$$module$js$nodes(c,50,"Windmill Key")).fromPerson("Windmill guard",20).dialog(20,14,0).npcSpawn(20,14,1).key(),xb=(new Item$$module$js$nodes(c,51,"Key to Prison")).chest().key(),ic=(new Item$$module$js$nodes(c,52,"Key to Styx")).fromPerson("Zebu in Shyron",94,1).trigger(128,2).dialog(94,242,0).dialog(98,242,0).key(),jc=(new Item$$module$js$nodes(c,53,"Fog Lamp")).chest().key(),yb=(new Item$$module$js$nodes(c,54,"Shell Flute")).fromPerson("Dolphin",99,1).npcSpawn(99).key(),kc=
(new Item$$module$js$nodes(c,55,"Eye Glasses")).fromPerson("Clark",68).dialog(68,233,1).key(),lc=(new Item$$module$js$nodes(c,56,"Broken Statue")).bossDrop("Sabera 1",4).npcSpawn(127,101).npcSpawn(9).npcSpawn(10).npcSpawn(69).npcSpawn(70).npcSpawn(71).npcSpawn(132).npcSpawn(142).dialog(61).dialog(62).dialog(63).dialog(64).dialog(65).dialog(66).dialog(67).dialog(68,233).trigger(182).key(),mc=(new Item$$module$js$nodes(c,57,"Glowing Lamp")).direct("Kensu in lighthouse",250638).npcSpawn(126,98,1).key(),
nc=(new Item$$module$js$nodes(c,59,"Love Pendant")).chest("Underground channel").invisible(254890).key(),oc=(new Item$$module$js$nodes(c,60,"Kirisa Plant")).chest("Kirisa meadow").invisible(254886).key(),zb=(new Item$$module$js$nodes(c,61,"Ivory Statue")).bossDrop("Karmine",9).npcSpawn(200).key(),pc=(new Item$$module$js$nodes(c,62,"Bow of Moon")).fromPerson("Aryllis",35).direct(251624).dialog(35,void 0,1).key(),qc=(new Item$$module$js$nodes(c,63,"Bow of Sun")).chest().key(),rc=(new Item$$module$js$nodes(c,
64,"Bow of Truth")).fromPerson("Azteca",131).npcSpawn(131,156,1).dialog(131,void 0,0).key(),Za=(new Magic$$module$js$nodes(c,65,"Refresh")).fromPerson("Zebu at windmill",94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),Ka=(new Magic$$module$js$nodes(c,66,"Paralysis")).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),ia=(new Magic$$module$js$nodes(c,67,"Telepathy")).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),sc=(new Magic$$module$js$nodes(c,
68,"Teleport")).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),je=(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),tc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),qa=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),D=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=P.bossDrop("Vampire 2",
12,97).npcSpawn(204).key(),Q=new Item$$module$js$nodes(c,112,"Mimic"),uc=(new Trigger$$module$js$nodes(c,"Talked to Leaf Elder")).get(S),vc=(new Trigger$$module$js$nodes(c,"Talked to Leaf Student")).get(wb),Ab=new Trigger$$module$js$nodes(c,"Talked to Zebu in cave"),le=(new Trigger$$module$js$nodes(c,"Woke up Windmill Guard")).get(hc),La=new Trigger$$module$js$nodes(c,"Started Windmill"),wc=(new Trigger$$module$js$nodes(c,"Learned Refresh")).get(Za),me=(new Trigger$$module$js$nodes(c,"Gave Statue to Akahana")).get(Ya),
ne=(new Trigger$$module$js$nodes(c,"Fought Stom")).get(ia),xc=new Trigger$$module$js$nodes(c,"Visited Oak"),yc=new Trigger$$module$js$nodes(c,"Talked to Oak Mother"),Bb=new Trigger$$module$js$nodes(c,"Rescued Oak Child"),oe=(new Trigger$$module$js$nodes(c,"Talked to Oak Mother Again")).get(ec),pe=(new Trigger$$module$js$nodes(c,"Talked to Oak Elder")).get(T),qe=(new Trigger$$module$js$nodes(c,"Talked to Tornel on Mt Sabre")).get(sc),zc=new Trigger$$module$js$nodes(c,"Villagers Abducted"),Ac=new Trigger$$module$js$nodes(c,
"Talked to Rabbit in Leaf"),re=(new Trigger$$module$js$nodes(c,"Learned Paralysis")).get(Ka),Bc=new Trigger$$module$js$nodes(c,"Talked to Portoa Queen"),Cc=new Trigger$$module$js$nodes(c,"Talked to Fortune Teller"),Dc=new Trigger$$module$js$nodes(c,"Visited Underground Channel"),se=(new Trigger$$module$js$nodes(c,"Sent to Waterfall Cave")).get(ub),te=(new Trigger$$module$js$nodes(c,"Cured Akahana")).get(gc),Ec=(new Trigger$$module$js$nodes(c,"Talked to Rage")).get(Ua),Fc=new Trigger$$module$js$nodes(c,
"Mesia recording played"),Gc=(new Trigger$$module$js$nodes(c,"Talked to Asina")).get(je),Hc=(new Trigger$$module$js$nodes(c,"Healed Dolphin")).get(yb),Cb=new Trigger$$module$js$nodes(c,"Returned Fog Lamp"),Ic=new Trigger$$module$js$nodes(c,"Talked to Kensu in Cabin"),Jc=new Trigger$$module$js$nodes(c,"Talked to Joel Elder"),ue=(new Trigger$$module$js$nodes(c,"Talked to Clark")).get(kc),ve=(new Trigger$$module$js$nodes(c,"Talked to Kensu in Lighthouse")).get(mc),Db=new Trigger$$module$js$nodes(c,"Calmed the Angry Sea"),
we=(new Trigger$$module$js$nodes(c,"Learned Barrier")).get(tc),Kc=new Trigger$$module$js$nodes(c,"Talked to Stom in Swan Hut"),Lc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Swan tavern"),Mc=new Trigger$$module$js$nodes(c,"Talked to Kensu at Swan dance"),xe=(new Trigger$$module$js$nodes(c,"Returned Kensu's love pendant")).get(qa),ye=(new Trigger$$module$js$nodes(c,"Talked to Amazones Queen")).get(pc),Eb=new Trigger$$module$js$nodes(c,"Entered Shyron"),ze=(new Trigger$$module$js$nodes(c,"Talked to Zebu in Shyron")).get(ic),
Nc=new Trigger$$module$js$nodes(c,"Shyron Massacre"),Ae=(new Trigger$$module$js$nodes(c,"Saved Kensu")).get(D),Be=(new Trigger$$module$js$nodes(c,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$js$nodes(c,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(c,"Get Bow of Truth")).get(rc),Ee=(new Trigger$$module$js$nodes(c,"Forged Crystalis")).get(pb),$a=(new Condition$$module$js$nodes(c,"Sword charge glitch")).option(u,w),Fe=(new Condition$$module$js$nodes(c,"Rabbit skip")).option(r,
t),Ge=(new Condition$$module$js$nodes(c,"Teleport skip")).option(q,p),ab=(new Condition$$module$js$nodes(c,"Statue glitch")).option(m,n),He=(new Condition$$module$js$nodes(c,"Wild warp")).option(J,x),bb=(new Condition$$module$js$nodes(c,"Any level 2 sword")).option(S,Ia).option(S,Ja).option(T,Sa).option(T,Ta).option(O,Ua).option(O,Va).option(M,Wa).option(M,Xa),z=(new Condition$$module$js$nodes(c,"Destroy stone")).option(S,Ra).option(S,Ia).option(S,Ja).option($a,S,bb),A=(new Condition$$module$js$nodes(c,
"Destroy ice")).option(T,Ra).option(T,Sa).option(T,Ta).option($a,T,bb),v=(new Condition$$module$js$nodes(c,"Cross rivers")).option(O,Ra).option(O,Ua).option(O,Va).option(D).option($a,O,bb),xa=(new Condition$$module$js$nodes(c,"Destroy iron")).option(M,Ra).option(M,Wa).option(M,Xa).option($a,M,bb),V=(new Condition$$module$js$nodes(c,"Any sword")).option(S).option(T).option(O).option(M),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(T).option(O).option(M).option(Ya,
K.value?K:g,S),Je=(new Condition$$module$js$nodes(c,"Match vampire 2 sword (wind/water/thunder)")).option(S).option(O).option(M).option(K.value?K:g,T),Oc=(new Condition$$module$js$nodes(c,"Speed boots")).option(fc,k),Pc=(new Condition$$module$js$nodes(c,"Climb slopes")).option(vb).option(D).option(Oc),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Ac).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(sc).option(Ge,D),Qc=(new Condition$$module$js$nodes(c,
"Asina in her room")).option(Fc),Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(Ka).option(Qc).option(ab),Rc=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(yb,Ic),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(l,Rc,vb),da=(new Condition$$module$js$nodes(c,"Cross sea")).option(Rc).option(D),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Db).option(D).option(Ne),W=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(Xb.value?
Xb:g).option(Za),Sc=(new Condition$$module$js$nodes(c,"Wind magic")).option(G.value?G:g,W).option(Ia,Ja,W),Tc=(new Condition$$module$js$nodes(c,"Fire magic")).option(G.value?G:g,W).option(Sa,Ta,W),Uc=(new Condition$$module$js$nodes(c,"Water magic")).option(G.value?G:g,W).option(G,W).option(Ua,Va,W),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(G.value?G:g,W).option(G,W).option(Wa,W).option(Xa,W),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(ub).option(ab),
Re=(new Condition$$module$js$nodes(c,"Change or glitch")).option(qa).option(ab),Se=(new Condition$$module$js$nodes(c,"Change or glitch or paralysis")).option(qa).option(ab).option(Ka),Fb=(new Condition$$module$js$nodes(c,"Pass shooting statues")).option(tc).option(V,Wb.value?Wb:g).option(Za,gc),Te=(new Condition$$module$js$nodes(c,"Healed dolphin if required")).option(Hc).option(Pd),Vc=(new Condition$$module$js$nodes(c,"Match sword of wind")).option(S).option(K.value?K:g,V),Wc=(new Condition$$module$js$nodes(c,
"Match sword of fire")).option(T).option(K.value?K:g,V),Xc=(new Condition$$module$js$nodes(c,"Match sword of water")).option(O).option(K.value?K:g,V),Ue=(new Condition$$module$js$nodes(c,"Match sword of thunder")).option(M).option(K.value?K:g,V),Ve=(new Condition$$module$js$nodes(c,"Swamp run possible")).option(V,Oc).option(V,Wd).option(V,Za),We=(new Condition$$module$js$nodes(c,"Insect possible to kill")).option(Ya),cb=(new Condition$$module$js$nodes(c,"Travel swamp")).option(Ya).option(Qa.value?
Qa:g,Ve),Xe=(new Condition$$module$js$nodes(c,"Calmed sea if required")).option(Db).option(Qd),Ye=(new Condition$$module$js$nodes(c,"Started windmill if required")).option(La).option(Sd),Ze=(new Condition$$module$js$nodes(c,"Telepathy if required for Deo")).option(ia).option(Ud),$e=e(0,"Vampire 1",V).get(vb),af=e(1,"Insect",ec,Ie,We).get(Sa),bf=e(2,"Kelbesque 1",Vc,Sc).get(Ta),cf=e(12,"Vampire 2",Je).get(ke),Yc=e(4,"Sabera 1",Wc,Tc).get(lc),df=e(5,"Mado 1",Xc,Uc).get(Wa),ef=e(6,"Kelbesque 2",Vc,Sc).get(tb),
ff=e(7,"Sabera 2",Wc,Tc).get(sb),gf=e(8,"Mado 2",Xc,Uc).get(qb),hf=e(9,"Karmine",Ue,Pe).get(zb),jf=e(10,"Draygon 1",V).get(ee),kf=e(-1,"Statues",qc,pc),lf=e(11,"Draygon 2",V,rc),mf=e(13,"Dyna",pb),nf=(new Condition$$module$js$nodes(c,"Opened prison if required")).option(xb).option(Rd),Z=new Area$$module$js$nodes(c,"Leaf"),ya=new Area$$module$js$nodes(c,"Valley of Wind"),X=new Area$$module$js$nodes(c,"Sealed Cave"),ra=new Area$$module$js$nodes(c,"Cordel Plain"),za=new Area$$module$js$nodes(c,"Brynmaer"),
Aa=new Area$$module$js$nodes(c,"Amazones"),E=new Area$$module$js$nodes(c,"Mt Sabre West"),y=new Area$$module$js$nodes(c,"Mt Sabre North"),db=new Area$$module$js$nodes(c,"Nadare's"),Ma=new Area$$module$js$nodes(c,"Oak"),ja=new Area$$module$js$nodes(c,"Waterfall Valley"),C=new Area$$module$js$nodes(c,"Portoa"),ka=new Area$$module$js$nodes(c,"Waterfall Cave"),F=new Area$$module$js$nodes(c,"Fog Lamp Cave"),la=new Area$$module$js$nodes(c,"Kirisa Plant Cave"),sa=new Area$$module$js$nodes(c,"Angry Sea"),
ma=new Area$$module$js$nodes(c,"Joel"),L=new Area$$module$js$nodes(c,"Evil Spirit Island"),na=new Area$$module$js$nodes(c,"Sabera's Castle"),aa=new Area$$module$js$nodes(c,"Swan"),B=new Area$$module$js$nodes(c,"Mt Hydra"),oa=new Area$$module$js$nodes(c,"Shyron"),ta=new Area$$module$js$nodes(c,"Styx"),ua=new Area$$module$js$nodes(c,"Goa"),eb=new Area$$module$js$nodes(c,"Draygonia Fortress 1"),ba=new Area$$module$js$nodes(c,"Draygonia Fortress 2"),Ba=new Area$$module$js$nodes(c,"Draygonia Fortress 3"),
R=new Area$$module$js$nodes(c,"Draygonia Fortress 4"),I=new Area$$module$js$nodes(c,"Oasis Cave"),ca=new Area$$module$js$nodes(c,"Sahara"),Ca=new Area$$module$js$nodes(c,"Pyramid Front"),ea=new Area$$module$js$nodes(c,"Pyramid Back"),fa=new Area$$module$js$nodes(c,"Tower"),Gb=(new Location$$module$js$nodes(c,0,Z,"Start")).overworld().start(),of=(new Location$$module$js$nodes(c,0,Z,"Mezame Shrine")).overworld().from(Gb),pf=(new Location$$module$js$nodes(c,1,Z,"Outside Start")).overworld().connect(of),
pa=(new Location$$module$js$nodes(c,2,Z,"Town")).town().connect(pf),Na=(new Location$$module$js$nodes(c,3,ya,"Main")).overworld().connect(pa).trigger(wc,La),Zc=(new Location$$module$js$nodes(c,3,ya,"Outside Windmill")).overworld(),$c=(new Location$$module$js$nodes(c,4,X,"Tunnel 1 (entrance)")).cave().from(Na,La),qf=(new Location$$module$js$nodes(c,5,X,"Tunnel 2 (over bridge)")).cave().connect($c),rf=(new Location$$module$js$nodes(c,6,X,"Tunnel 6 (herb dead end)")).cave().chest(H,15),ad=(new Location$$module$js$nodes(c,
7,X,"Tunnel 4a (ball corridor)")).cave().chest(H,20,80).chest(Ia,21);(new Location$$module$js$nodes(c,7,X,"Tunnel 4b (antidote dead end)")).cave().connect(ad,z).chest(N,19);const sf=(new Location$$module$js$nodes(c,8,X,"Tunnel 5 (warp boots dead end)")).cave().chest(U,14),tf=(new Location$$module$js$nodes(c,9,X,"Tunnel 3a (branch, front)")).cave().connect(qf).connectTo(ad).connectTo(sf),uf=(new Location$$module$js$nodes(c,9,X,"Tunnel 3b (branch, back)")).cave().connect(tf,z).connectTo(rf),vf=(new Location$$module$js$nodes(c,
10,X,"Tunnel 7 (boss)")).cave().connect(uf).boss($e),wf=(new Location$$module$js$nodes(c,12,X,"Tunnel 8a (exit, above wall)")).cave().connect(vf),xf=(new Location$$module$js$nodes(c,12,X,"Tunnel 8b (exit, below wall")).cave().connect(wf,z);(new Location$$module$js$nodes(c,14,ya,"Windmill Cave")).cave().connect(Na).connectTo(Zc).trigger(le,wb,Ab);(new Location$$module$js$nodes(c,15,ya,"Windmill")).misc().connect(Zc).trigger(La,hc);const yf=(new Location$$module$js$nodes(c,16,ya,"Zebu's Cave Front")).cave().connect(Na).trigger(Ab,
uc,vc).trigger(wc,La,Ab),zf=(new Location$$module$js$nodes(c,16,ya,"Zebu's Cave Back")).cave().trigger(zc).connect(yf,A),Af=(new Location$$module$js$nodes(c,17,E,"Tunnel 1 (to Zebu)")).cave().connect(zf),Da=(new Location$$module$js$nodes(c,20,ra,"West")).overworld().connect(xf,Ye),Bf=(new Location$$module$js$nodes(c,20,ra,"South")).overworld().connect(Da,v),bd=(new Location$$module$js$nodes(c,21,ra,"East")).overworld().connect(Da).chest(dc,24),Oa=(new Location$$module$js$nodes(c,24,za,"Town")).town().connect(Da).trigger(me,
dc),Cf=(new Location$$module$js$nodes(c,25,ra,"Outside Stom's House")).town().connect(Da),Hb=(new Location$$module$js$nodes(c,26,ra,"Swamp")).overworld().connect(bd,cb).trigger(Bb,yc,cb);(new Location$$module$js$nodes(c,26,ra,"Swamp Insect Area")).overworld().connect(Hb,cb).boss(af);const fb=(new Location$$module$js$nodes(c,27,Aa,"Town")).town().connect(Bf),gb=(new Location$$module$js$nodes(c,28,Ma,"Town")).town().connect(Hb,cb).trigger(xc);(new Location$$module$js$nodes(c,30,ra,"Stom's House")).house().connect(Cf).trigger(ne,
xc);const Ea=(new Location$$module$js$nodes(c,32,E,"Entrance")).overworld().connect(Da).connect(Af),Df=(new Location$$module$js$nodes(c,32,E,"Up Slope")).overworld().from(Ea,Pc).to(Ea),Ef=(new Location$$module$js$nodes(c,32,E,"Dead End (warp boots)")).overworld().chest(U,24,106),cd=(new Location$$module$js$nodes(c,33,E,"Upper")).overworld().from(Ea,D).to(Ea),Ff=(new Location$$module$js$nodes(c,33,E,"Tornel Dead End")).overworld().trigger(qe,Ia,Ja).chest(Y,23,105),dd=(new Location$$module$js$nodes(c,
34,E,"Tunnel 2a (fork at start)")).cave().connect(Ea);(new Location$$module$js$nodes(c,34,E,"Tunnel 2b (left branch to dead end)")).cave().connect(dd,A).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,E,"Tunnel 2c (right branch to upper)")).cave().connect(dd,A),Hf=(new Location$$module$js$nodes(c,35,E,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(H,23,82),If=(new Location$$module$js$nodes(c,35,E,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,
A).connectTo(cd),ed=(new Location$$module$js$nodes(c,36,E,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,E,"Tunnel 4b (out to upper)")).cave().connect(ed,A).connectTo(cd);const Jf=(new Location$$module$js$nodes(c,37,E,"Tunnel 5 (tiny connector)")).cave().connect(ed),Kf=(new Location$$module$js$nodes(c,38,E,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);(new Location$$module$js$nodes(c,38,E,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,
A).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,E,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,E,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,A);(new Location$$module$js$nodes(c,39,E,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,A).chest(Ja,25);const hb=(new Location$$module$js$nodes(c,40,y,"Entrance")).overworld().connect(bd,Le,Ke),ib=(new Location$$module$js$nodes(c,40,y,"Upper")).overworld().from(hb,D).to(hb),
Ib=(new Location$$module$js$nodes(c,40,y,"Summit (boss)")).overworld().from(ib,D).to(ib).boss(bf),fd=(new Location$$module$js$nodes(c,41,y,"Connector")).overworld(),Jb=(new Location$$module$js$nodes(c,41,y,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,y,"Middle Right")).overworld().from(Jb,Pc).to(Jb),gd=(new Location$$module$js$nodes(c,42,y,"Tunnel 2a (from entrance to connector)")).cave().connectTo(fd);(new Location$$module$js$nodes(c,42,y,"Tunnel 2b (under bridge, to antidote)")).cave().connect(gd,
A).chest(N,23,94);const hd=(new Location$$module$js$nodes(c,43,y,"Tunnel 3a (branch after connector)")).cave().connect(fd),Of=(new Location$$module$js$nodes(c,43,y,"Tunnel 3b (right branch)")).cave().connect(hd,A),Pf=(new Location$$module$js$nodes(c,43,y,"Tunnel 3c (upper branch)")).cave().connect(hd,A);(new Location$$module$js$nodes(c,44,y,"Tunnel 4 (over bridge, to middle)")).cave().connect(Pf).connectTo(Jb);const id=(new Location$$module$js$nodes(c,45,y,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Of).connectTo(Nf);
(new Location$$module$js$nodes(c,45,y,"Tunnel 5b (dead-end with herb)")).cave().connect(id,A).chest(H,22,83);const Qf=(new Location$$module$js$nodes(c,46,y,"Tunne; 6a (S-shaped hall, right)")).cave().connect(id),Rf=(new Location$$module$js$nodes(c,46,y,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Qf,A),Sf=(new Location$$module$js$nodes(c,46,y,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Rf,A),jd=(new Location$$module$js$nodes(c,47,y,"Prison (hallway)")).cave().connect(ib),Tf=(new Location$$module$js$nodes(c,
48,y,"Left Cell (shopkeepers)")).cave().from(jd,A);(new Location$$module$js$nodes(c,49,y,"Left Cell 2 (back, with prison key)")).cave().from(Tf,A).chest(xb,13);const Uf=(new Location$$module$js$nodes(c,50,y,"Right Cell (villagers)")).cave().from(jd,A),Vf=(new Location$$module$js$nodes(c,51,y,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Uf,A);(new Location$$module$js$nodes(c,52,y,"Tunnel 9 (connector to summit)")).cave().connect(Vf).connectTo(Ib);const Wf=(new Location$$module$js$nodes(c,
53,y,"Summit Cave (front)")).cave().from(Ib,xb).to(Ib),Xf=(new Location$$module$js$nodes(c,53,y,"Summit Cave (behind ice)")).cave().connect(Wf,A).trigger(re);(new Location$$module$js$nodes(c,56,y,"Tunnel 1 (leads from main entrance)")).cave().connect(hb).connectTo(gd);(new Location$$module$js$nodes(c,57,y,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(ib);const Yf=(new Location$$module$js$nodes(c,60,db,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,db,"Tool Shop")).shop(H,N,P,U),$f=(new Location$$module$js$nodes(c,
62,db,"Back Room")).house(),Kb=(new Location$$module$js$nodes(c,64,ja,"Summit")).overworld().connect(Xf,nf),jb=(new Location$$module$js$nodes(c,64,ja,"Northwest")).overworld().from(Kb).to(Kb,D),ag=(new Location$$module$js$nodes(c,64,ja,"Northeast")).overworld().connect(jb,v),kd=(new Location$$module$js$nodes(c,65,ja,"Southwest")).overworld().connect(jb),bg=(new Location$$module$js$nodes(c,65,ja,"Southeast")).overworld().connect(kd,v),ld=(new Location$$module$js$nodes(c,66,ja,"Lime Tree Valley")).overworld().connect(kd).connect(Na,
Vd),cg=(new Location$$module$js$nodes(c,67,ja,"Lime Tree Lake (Rage)")).cave().connect(ld).trigger(Ec,O),dg=(new Location$$module$js$nodes(c,68,la,"Tunnel 1a (entrance)")).cave().connect(bg),eg=(new Location$$module$js$nodes(c,68,la,"Tunnel 1b (behind wall)")).cave().connect(dg,z),md=(new Location$$module$js$nodes(c,69,la,"Tunnel 2a (main path, before wall)")).cave().connect(eg);(new Location$$module$js$nodes(c,69,la,"Tunnel 2b (dead end, antidote)")).cave().connect(md,z).chest(N,25,95);const fg=
(new Location$$module$js$nodes(c,69,la,"Tunnel 2c (main path, after wall)")).cave().connect(md,z),gg=(new Location$$module$js$nodes(c,70,la,"Tunnel 3a (last room, before wall)")).cave().connect(fg),hg=(new Location$$module$js$nodes(c,70,la,"Tunnel 3b (last room, after wall)")).cave().connect(gg,z);(new Location$$module$js$nodes(c,71,la,"Meadow")).overworld().connect(hg).chest(oc,14);const ig=(new Location$$module$js$nodes(c,72,F,"Tunnel 1a (entrance)")).cave().connect(ag),nd=(new Location$$module$js$nodes(c,
72,F,"Tunnel 1b (past wall)")).cave().connect(ig,z);(new Location$$module$js$nodes(c,72,F,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(nd,z).chest(wa,24);const jg=(new Location$$module$js$nodes(c,73,F,"Tunnel 2 (tiny connector)")).cave().connect(nd),od=(new Location$$module$js$nodes(c,74,F,"Tunnel 3a (upper branch)")).cave().connect(jg);(new Location$$module$js$nodes(c,74,F,"Tunnel 3b (dead end, mimic)")).cave().connect(od,z).chest(Q,21,112);const pd=(new Location$$module$js$nodes(c,74,F,"Tunnel 3c (short passage with mimic)")).cave().connect(od,
z).chest(Q,22,113),kg=(new Location$$module$js$nodes(c,74,F,"Tunnel 3d (lower branch)")).cave().connect(pd,z);(new Location$$module$js$nodes(c,75,F,"Dead end loop")).cave().connect(kg);const qd=(new Location$$module$js$nodes(c,76,F,"Tunnel 4a (right branch over bridge)")).cave().connect(pd),lg=(new Location$$module$js$nodes(c,76,F,"Tunnel 4b (past wall over bridge)")).cave().connect(qd,z),mg=(new Location$$module$js$nodes(c,77,F,"Tunnel 5a (from left branch)")).cave().connect(qd),ng=(new Location$$module$js$nodes(c,
77,F,"Tunnel 5b (reconvergence)")).cave().connect(mg,z).connect(lg),og=(new Location$$module$js$nodes(c,77,F,"Tunnel 5c (between walls)")).cave().connect(ng,z),pg=(new Location$$module$js$nodes(c,77,F,"Tunnel 5d (under bridge)")).cave().connect(og,z),qg=(new Location$$module$js$nodes(c,78,F,"Tunnel 6a (over second bridge)")).cave().connect(pg),rg=(new Location$$module$js$nodes(c,78,F,"Tunnel 6b (past wall)")).cave().connect(qg,z),sg=(new Location$$module$js$nodes(c,79,F,"Tunnel 7a (under second bridge)")).cave().connect(rg);
(new Location$$module$js$nodes(c,79,F,"Tunnel 7b (fog lamp)")).cave().connect(sg,z).chest(jc,19);const va=(new Location$$module$js$nodes(c,80,C,"Town")).town().connect(jb),rd=(new Location$$module$js$nodes(c,81,C,"Fishherman Island")).town().connect(va);(new Location$$module$js$nodes(c,82,ja,"Mesia Shrine")).cave().trigger(Fc).connect(cg,v,Ec);const sd=(new Location$$module$js$nodes(c,84,ka,"Tunnel 1a (entrance)")).cave().connect(jb);(new Location$$module$js$nodes(c,84,ka,"Tunnel 1b (dead end, mimic)")).cave().connect(sd,
A).chest(Q,19,114);const tg=(new Location$$module$js$nodes(c,84,ka,"Tunnel 1c (past ice)")).cave().connect(sd,A),ug=(new Location$$module$js$nodes(c,85,ka,"Tunnel 2 (stoned pair)")).cave().connect(tg),Lb=(new Location$$module$js$nodes(c,86,ka,"Tunnel 3 (wide medusa hallways)")).cave().connect(ug,Qe),vg=(new Location$$module$js$nodes(c,87,ka,"Tunnel 4a (left entrance)")).cave().from(Lb,A).chest($b.chest().bonus(),25).trigger(te,ub);(new Location$$module$js$nodes(c,87,ka,"Tunnel 4b (right entrance)")).cave().from(Lb,
A).connect(vg,D);(new Location$$module$js$nodes(c,87,ka,"Tunnel 4c (sword of water)")).cave().connect(Lb,A).chest(O,24);const td=(new Location$$module$js$nodes(c,88,fa,"Entrance")).misc(),wg=(new Location$$module$js$nodes(c,89,fa,"Level 1")).misc().from(td),xg=(new Location$$module$js$nodes(c,90,fa,"Level 2")).misc().from(wg),yg=(new Location$$module$js$nodes(c,91,fa,"Level 3")).misc().from(xg),ud=(new Location$$module$js$nodes(c,92,fa,"Outside Mesia Room")).misc().from(yg),zg=(new Location$$module$js$nodes(c,
93,fa,"Outside Dyna Room")).misc().from(ud,pb);(new Location$$module$js$nodes(c,94,fa,"Mesia")).misc().connect(ud).trigger(Ee);const Ag=(new Location$$module$js$nodes(c,95,fa,"Dyna")).misc().from(zg).boss(mf);(new Location$$module$js$nodes(c,95,fa,"Win")).misc().from(Ag).end();const Mb=(new Location$$module$js$nodes(c,96,sa,"Cabin Beach")).sea().from(rd,Cb),Fa=(new Location$$module$js$nodes(c,96,sa,"South")).sea().connect(Mb,da),Bg=(new Location$$module$js$nodes(c,96,sa,"Joel Beach")).sea().connect(Fa,
da),vd=(new Location$$module$js$nodes(c,96,ma,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(c,96,sa,"Altar")).sea().connect(Fa,da).trigger(Db,mc,lc);const Cg=(new Location$$module$js$nodes(c,96,sa,"North")).sea().to(Fa,da).from(Fa,da,Oe).trigger(we,Xe),Dg=(new Location$$module$js$nodes(c,96,sa,"Swan Beach")).sea().connect(Cg,da);(new Location$$module$js$nodes(c,97,sa,"Cabin")).misc().connect(Mb).trigger(Ic,Cb);(new Location$$module$js$nodes(c,98,ma,"Lighthouse")).misc().connect(vd).trigger(ve,
wb);const kb=(new Location$$module$js$nodes(c,100,C,"Underground Channel 1 (from throne room)")).sea().trigger(Dc),Eg=(new Location$$module$js$nodes(c,100,C,"Underground Channel 2 (to fortune teller)")).sea().connect(kb,v),wd=(new Location$$module$js$nodes(c,100,C,"Underground Channel 3 (from fortune teller)")).sea().connect(kb,D),xd=(new Location$$module$js$nodes(c,100,C,"Underground Channel 4 (asina)")).sea().connect(wd,v),Fg=(new Location$$module$js$nodes(c,100,C,"Underground Channel 5 (dolphin)")).sea().connect(xd,
v).trigger(Hc,H,Gc);(new Location$$module$js$nodes(c,100,C,"Underground Channel 6 (water)")).sea().connect(Fg,da).connectTo(Fa,da).chest(nc,17);const Nb=(new Location$$module$js$nodes(c,101,L,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,L,"Tunnel 1 (entrance)")).sea().connect(Fa,Jc,da),yd=(new Location$$module$js$nodes(c,105,L,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,L,"Tunnel 2b (dead end to left)")).cave().connect(yd,v);const Hg=(new Location$$module$js$nodes(c,
105,L,"Tunnel 2c (across first river)")).cave().connect(yd,v),zd=(new Location$$module$js$nodes(c,105,L,"Tunnel 2d (across second river)")).cave().connect(Hg,v);(new Location$$module$js$nodes(c,105,L,"Tunnel 2e (dead end, magic ring)")).cave().connect(zd,z).chest(Y,29);const Ig=(new Location$$module$js$nodes(c,105,L,"Tunnel 2f (stair down)")).cave().connect(zd,z),Jg=(new Location$$module$js$nodes(c,106,L,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(Nb).chest(wa,25,92),Kg=(new Location$$module$js$nodes(c,
106,L,"Tunnel 3b (left area toward items)")).cave().connect(Jg,z),Lg=(new Location$$module$js$nodes(c,107,L,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(Q,14,115);(new Location$$module$js$nodes(c,107,L,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,v).chest(he,15);const Ob=(new Location$$module$js$nodes(c,108,na,"Floor 1")).fortress().connect(Nb),Mg=(new Location$$module$js$nodes(c,108,na,"Miniboss")).fortress().boss(cf).connect(Ob);(new Location$$module$js$nodes(c,109,na,
"Floor 2a (left stair)")).fortress().connect(Ob).chest(P,19);const Ng=(new Location$$module$js$nodes(c,109,na,"Floor 2b (right stair)")).fortress().connect(Mg).chest(H,30,85),Og=(new Location$$module$js$nodes(c,110,na,"Floor 3a (toward boss)")).fortress().connect(Ng),Ad=(new Location$$module$js$nodes(c,110,na,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$js$nodes(c,110,na,"Boss")).fortress().boss(Yc).connect(Ad);(new Location$$module$js$nodes(c,110,na,"Floor 3c (back room trap)")).fortress().from(Ad).to(Ob);
const Pg=(new Location$$module$js$nodes(c,112,ma,"Secret Passage")).cave().connectTo(vd),lb=(new Location$$module$js$nodes(c,113,ma,"Town")).town().connect(Bg),ha=(new Location$$module$js$nodes(c,114,aa,"Town")).town().connect(Dg),Qg=(new Location$$module$js$nodes(c,115,aa,"Inside Gate")).overworld().connect(ha),Rg=(new Location$$module$js$nodes(c,115,aa,"Outside Gate")).overworld().from(Qg,qa),mb=(new Location$$module$js$nodes(c,120,ua,"Valley")).overworld().connect(Rg),Pb=(new Location$$module$js$nodes(c,
124,B,"Entrance")).overworld().connect(mb),Sg=(new Location$$module$js$nodes(c,124,B,"Over first river toward Shyron")).overworld().connect(Pb,v),Bd=(new Location$$module$js$nodes(c,124,B,"After first tunnel")).overworld(),Cd=(new Location$$module$js$nodes(c,124,B,"Door to Styx")).overworld().connect(Bd,v),Tg=(new Location$$module$js$nodes(c,124,B,"Dead end (no item)")).overworld(),Ug=(new Location$$module$js$nodes(c,124,B,"Dead end (fruit of lime)")).overworld().chest(rb,26),Vg=(new Location$$module$js$nodes(c,
124,B,"Dead end (magic ring)")).overworld().chest(Y,25,101),Dd=(new Location$$module$js$nodes(c,124,B,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(c,124,B,"Floating island (bow of sun)")).overworld().connect(Dd,D).chest(qc,24);const Wg=(new Location$$module$js$nodes(c,125,B,"Tunnel 1 (to Shyron)")).cave().connect(Sg),Xg=(new Location$$module$js$nodes(c,126,B,"Outside Shyron")).overworld().connect(Wg);(new Location$$module$js$nodes(c,127,B,"Tunnel 2 (fork)")).cave().connect(Pb).connectTo(Ug).connectTo(Bd);
const Ed=(new Location$$module$js$nodes(c,128,B,"Tunnel 3 (caves)")).cave().connect(Cd).connect(Tg),Fd=(new Location$$module$js$nodes(c,129,B,"Tunnel 4 (left branch of cave)")).cave().connect(Ed);(new Location$$module$js$nodes(c,130,B,"Tunnel 5 (dead end, medical herb)")).cave().connect(Fd).chest(H,15,86);const Yg=(new Location$$module$js$nodes(c,131,B,"Tunnel 6a (left-then-right)")).cave().connect(Fd),Zg=(new Location$$module$js$nodes(c,131,B,"Tunnel 6b (past wall)")).cave().connect(Yg,z),$g=(new Location$$module$js$nodes(c,
132,B,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,B,"Tunnel 8 (red slimes)")).cave().from($g,z).connectTo(Dd).chest(Q,23,116);const ah=(new Location$$module$js$nodes(c,134,B,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Ed),bh=(new Location$$module$js$nodes(c,135,B,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,135,B,"Tunnel 10b (past wall)")).cave().connect(bh,z).connectTo(Vg);const Gd=(new Location$$module$js$nodes(c,
136,ta,"Entrance")).fortress().from(Cd,ic,Fb),ch=(new Location$$module$js$nodes(c,137,ta,"Left branch")).fortress().connect(Gd).chest(Q,19,117),dh=(new Location$$module$js$nodes(c,137,ta,"Left branch, past one bridge")).fortress().connect(ch,v),eh=(new Location$$module$js$nodes(c,137,ta,"Left branch, past two bridges")).fortress().connect(dh,v).chest(H,29,87),fh=(new Location$$module$js$nodes(c,137,ta,"Right branch")).fortress().connect(Gd);(new Location$$module$js$nodes(c,137,ta,"Right branch, across water")).fortress().connect(fh,
D).chest(Q,20,118).chest(Q,21,119).chest(Zd,28);(new Location$$module$js$nodes(c,138,ta,"Upper floor")).fortress().connect(eh).chest(M,27);const Ga=(new Location$$module$js$nodes(c,140,oa,"Town")).town().connect(Xg,Re).trigger(Eb),Pa=(new Location$$module$js$nodes(c,142,ua,"Town")).town().connect(mb),Hd=(new Location$$module$js$nodes(c,143,I,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,I,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Hd,
xa).chest(fe,15);const Qb=(new Location$$module$js$nodes(c,144,ua,"Desert 1")).overworld().connect(mb),nb=(new Location$$module$js$nodes(c,145,I,"Area 1 (from entrance)")).cave().chest(fc,26),Id=(new Location$$module$js$nodes(c,145,I,"Area 2 (across top bridge)")).cave().connect(nb,v);(new Location$$module$js$nodes(c,145,I,"Area 3 (dead-end across top-right bridge)")).cave().connect(Id,v);const gh=(new Location$$module$js$nodes(c,145,I,"Area 4 (left across middle-right bridge)")).cave().connect(Id,
v),hh=(new Location$$module$js$nodes(c,145,I,"Area 5 (bottom edge)")).cave().connect(gh,v),ih=(new Location$$module$js$nodes(c,145,I,"Area 6 (bottom island)")).cave().connect(hh,v),jh=(new Location$$module$js$nodes(c,145,I,"Area 7 (bottom inner ring)")).cave().connect(ih,v),kh=(new Location$$module$js$nodes(c,145,I,"Area 8 (left outer ring)")).cave().connect(jh,v).connect(nb,v).chest(P,27,100),lh=(new Location$$module$js$nodes(c,145,I,"Area 9 (top left inner ring)")).cave().connect(kh,v),mh=(new Location$$module$js$nodes(c,
145,I,"Area 10 (top right inner ring)")).cave().connect(lh,v);(new Location$$module$js$nodes(c,145,I,"Area 11 (center)")).cave().connect(mh,v).connectTo(Hd);(new Location$$module$js$nodes(c,145,I,"Area 12 (top center islands)")).cave().connect(nb,D).chest(de,28);const nh=(new Location$$module$js$nodes(c,146,ca,"Desert Cave 1")).cave().connect(Qb,D),Ha=(new Location$$module$js$nodes(c,147,ca,"Town")).town(),oh=(new Location$$module$js$nodes(c,148,ca,"Outside Cave")).overworld().connect(Ha),ph=(new Location$$module$js$nodes(c,
149,ca,"Desert Cave 2")).cave().connect(oh);(new Location$$module$js$nodes(c,150,ca,"Meadow")).overworld().connect(nh).connectTo(Ha).trigger(Be,qa,Ze);const Rb=(new Location$$module$js$nodes(c,152,ca,"Desert 2")).overworld().connect(ph),qh=(new Location$$module$js$nodes(c,156,Ca,"Entrance")).fortress().connect(Rb,D),rh=(new Location$$module$js$nodes(c,156,Ca,"Azteca")).fortress().trigger(De),sh=(new Location$$module$js$nodes(c,157,Ca,"Fork")).fortress().connect(qh),Jd=(new Location$$module$js$nodes(c,
158,Ca,"Main")).fortress().connect(sh);(new Location$$module$js$nodes(c,158,Ca,"Treasure Chest (magic ring)")).fortress().connect(Jd).chest(Y,27,108);(new Location$$module$js$nodes(c,159,Ca,"Draygon")).fortress().connect(Jd).to(rh).boss(jf);const th=(new Location$$module$js$nodes(c,160,ea,"Entrance")).fortress().connect(Rb,D),uh=(new Location$$module$js$nodes(c,160,ea,"Statues")).fortress().connect(th).boss(kf),vh=(new Location$$module$js$nodes(c,161,ea,"Hall 1")).fortress().connect(uh),Sb=(new Location$$module$js$nodes(c,
162,ea,"Branch")).fortress().connect(vh);(new Location$$module$js$nodes(c,163,ea,"Left Dead End")).fortress().connect(Sb).chest(Q,13,120);(new Location$$module$js$nodes(c,164,ea,"Right Dead End")).fortress().connect(Sb);const wh=(new Location$$module$js$nodes(c,165,ea,"Hall 2")).fortress().connect(Sb).chest(tb,26,109),xh=(new Location$$module$js$nodes(c,166,ea,"Draygon 2")).fortress().connect(wh).boss(lf);(new Location$$module$js$nodes(c,167,ea,"Teleporter")).fortress().from(xh).to(td);const Kd=(new Location$$module$js$nodes(c,
168,eb,"Entrance")).fortress().connect(Pa,Fb).trigger(Nc,M),yh=(new Location$$module$js$nodes(c,169,eb,"Main")).fortress().from(Kd,xa),zh=(new Location$$module$js$nodes(c,169,eb,"Boss")).fortress().connect(yh).boss(ef),Ah=(new Location$$module$js$nodes(c,170,eb,"Zebu")).fortress().connect(zh),ob=(new Location$$module$js$nodes(c,171,ba,"Entrance")).fortress().connect(Ah);(new Location$$module$js$nodes(c,171,ba,"Dead End Behind Iron (fruit of power)")).fortress().connect(ob,xa).chest(P,28,98);(new Location$$module$js$nodes(c,
171,ba,"Dead End Loop Across Closer Bridges")).fortress().connect(ob,v).connect(ob,v);const Bh=(new Location$$module$js$nodes(c,171,ba,"Across First Bridge (fruit of repun)")).fortress().connect(ob,v).chest(sb,30,102),Tb=(new Location$$module$js$nodes(c,171,ba,"Across Second Bridge")).fortress().connect(Bh,v);(new Location$$module$js$nodes(c,171,ba,"Dead End Across Two Bridges ()")).fortress().connect(Tb,v).connect(Tb,v).chest(wa,29,93);const Ch=(new Location$$module$js$nodes(c,171,ba,"Across Third Bridge")).fortress().connect(Tb,
v),Dh=(new Location$$module$js$nodes(c,171,ba,"Exit Behind Iron Door")).fortress().connect(Ch,xa),Eh=(new Location$$module$js$nodes(c,172,ba,"Boss")).fortress().connect(Dh).boss(ff),Fh=(new Location$$module$js$nodes(c,172,ba,"Tornel")).fortress().connect(Eh),Ld=(new Location$$module$js$nodes(c,173,Ba,"Lower")).fortress().connect(Fh).chest(tb,26,99).chest(Y,27,111),Gh=(new Location$$module$js$nodes(c,174,Ba,"Upper Loop")).fortress().connect(Ld).chest(N,22,96);(new Location$$module$js$nodes(c,174,Ba,
"Upper Loop Behind Wall (magic ring)")).fortress().connect(Gh,xa).chest(Y,23,107);const Hh=(new Location$$module$js$nodes(c,175,Ba,"Upper Passage (toward Mado)")).fortress().connect(Ld).chest(Y,27,84),Ub=(new Location$$module$js$nodes(c,176,R,"Initial Fork")).fortress(),Ih=(new Location$$module$js$nodes(c,177,R,"Left Branch")).fortress().connect(Ub),Md=(new Location$$module$js$nodes(c,178,R,"Main Area (right branch, over bridges)")).fortress().connect(Ub),Jh=(new Location$$module$js$nodes(c,179,R,
"U-shaped Passage (between floors)")).fortress().connect(Md),Kh=(new Location$$module$js$nodes(c,180,R,"Main Area Lower (under bridge)")).fortress().connect(Ih).connect(Md).connect(Jh),Nd=(new Location$$module$js$nodes(c,180,R,"Behind Iron Wall")).fortress().connect(Kh,xa),Lh=(new Location$$module$js$nodes(c,181,R,"Lower")).fortress().connect(Nd).chest(Q,13,121).chest(Q,14,122).chest(Q,15,123).chest(Y,23,88).chest(U,24,110),Mh=(new Location$$module$js$nodes(c,182,R,"Boss Corridor")).fortress().connect(Lh),
Nh=(new Location$$module$js$nodes(c,182,R,"Boss")).fortress().connect(Mh,Fb).boss(hf);(new Location$$module$js$nodes(c,182,R,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(Xa,18);const Od=(new Location$$module$js$nodes(c,183,R,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,184,I,"Entrance Back (behind river)")).cave().connect(Od).chest(P,13,90);(new Location$$module$js$nodes(c,184,I,"Entrance Front")).cave().connect(Oh,D).connectTo(Qb).connectTo(nb);const Ph=(new Location$$module$js$nodes(c,
185,Ba,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$js$nodes(c,185,Ba,"Asina")).fortress().connect(Ph).connectTo(Ub);(new Location$$module$js$nodes(c,186,R,"Kensu")).fortress().connect(Nd).connectTo(Od).trigger(Ae,zb);(new Location$$module$js$nodes(c,187,ua,"House")).house().connect(Pa).trigger(Ce,qa,zb);(new Location$$module$js$nodes(c,188,ua,"Inn")).shop().connect(Pa,Eb);(new Location$$module$js$nodes(c,190,ua,"Tool Shop")).shop(H,N,U,P).connect(Pa,Eb);(new Location$$module$js$nodes(c,
191,ua,"Tavern")).shop().connect(Pa);(new Location$$module$js$nodes(c,192,Z,"Elder House")).house().connect(pa).trigger(uc);(new Location$$module$js$nodes(c,193,Z,"Rabbit Hut")).house().connect(pa).trigger(Ac,zc,ia);(new Location$$module$js$nodes(c,194,Z,"Inn")).shop().connect(pa);(new Location$$module$js$nodes(c,195,Z,"Tool Shop")).shop(H,N,U,P).connect(pa);(new Location$$module$js$nodes(c,196,Z,"Armor Shop")).shop($d,Yb).connect(pa);(new Location$$module$js$nodes(c,197,Z,"Student House")).house().connect(pa).trigger(vc);
(new Location$$module$js$nodes(c,198,za,"Tavern")).house().connect(Oa);(new Location$$module$js$nodes(c,199,za,"Pawn Shop")).shop().connect(Oa);(new Location$$module$js$nodes(c,200,za,"Inn")).shop().connect(Oa);(new Location$$module$js$nodes(c,201,za,"Armor Shop")).shop(ae,Yb,Xd).connect(Oa);(new Location$$module$js$nodes(c,203,za,"Tool Shop")).shop(H,N,U).connect(Oa);(new Location$$module$js$nodes(c,205,Ma,"Elder House")).house().from(gb,ia).trigger(pe,Bb);(new Location$$module$js$nodes(c,206,Ma,
"Mother's House")).house().from(gb,ia).trigger(yc,ia).trigger(oe,Bb);(new Location$$module$js$nodes(c,207,Ma,"Tool Shop")).shop(H,N,P).from(gb,ia);(new Location$$module$js$nodes(c,208,Ma,"Inn")).shop().from(gb,ia);(new Location$$module$js$nodes(c,209,Aa,"Inn")).shop().connect(fb);(new Location$$module$js$nodes(c,210,Aa,"Tool Shop")).shop(U,P,wa).connect(fb);(new Location$$module$js$nodes(c,211,Aa,"Armor Shop")).shop(bc,Zb,$b,qb).connect(fb);const Qh=(new Location$$module$js$nodes(c,212,Aa,"Queen's House")).house().from(fb,
Se).trigger(ye,qa,oc);(new Location$$module$js$nodes(c,213,db,"Nadare's")).house().connect(hb).connectTo(Yf).connectTo(Zf).connectTo($f);(new Location$$module$js$nodes(c,214,C,"Fisherman's House")).house().connect(rd).trigger(Cb,jc,yb,Te);const Vb=(new Location$$module$js$nodes(c,215,C,"Palace Entrance")).house().connect(va);(new Location$$module$js$nodes(c,216,C,"Fortune Teller Front")).house().connect(va).trigger(Cc,Bc);(new Location$$module$js$nodes(c,216,C,"Fortune Teller Back")).house().connect(Eg).connect(wd);
(new Location$$module$js$nodes(c,217,C,"Pawn Shop")).shop().connect(va);(new Location$$module$js$nodes(c,218,C,"Armor Shop")).shop(be,bc,Zb).connect(va);(new Location$$module$js$nodes(c,220,C,"Inn")).shop().connect(va);(new Location$$module$js$nodes(c,221,C,"Tool Shop")).shop(H,wa,rb,U).connect(va);(new Location$$module$js$nodes(c,222,C,"Palace Left")).house().connect(Vb);(new Location$$module$js$nodes(c,223,C,"Palace Throne Room")).house().connect(Vb).to(kb,Me).from(kb).trigger(Bc).trigger(se,Cc,
Dc);(new Location$$module$js$nodes(c,224,C,"Palace Right")).house().connect(Vb);(new Location$$module$js$nodes(c,225,C,"Asina's Room")).house().connect(xd).trigger(Gc,Qc);(new Location$$module$js$nodes(c,226,Aa,"Queen Downstairs")).house().connect(Qh).chest(Va,13);(new Location$$module$js$nodes(c,227,ma,"Elder's House")).house().connect(lb).trigger(Jc);(new Location$$module$js$nodes(c,228,ma,"Shed")).house().connect(lb).to(Pg,kc);(new Location$$module$js$nodes(c,229,ma,"Tool Shop")).shop(H,N,P,wa).connect(lb);
(new Location$$module$js$nodes(c,231,ma,"Inn")).shop().connect(lb);const Rh=(new Location$$module$js$nodes(c,232,L,"Zombie Town House")).house().connect(Nb);(new Location$$module$js$nodes(c,233,L,"Zombie Town Basement")).house().connect(Rh).trigger(ue,Yc);(new Location$$module$js$nodes(c,235,aa,"Tool Shop")).shop(H,N,P,U).connect(ha);(new Location$$module$js$nodes(c,236,aa,"Stom's Hut")).house().connect(ha).trigger(Kc);(new Location$$module$js$nodes(c,237,aa,"Inn")).shop().connect(ha);(new Location$$module$js$nodes(c,
238,aa,"Armor Shop")).shop(ce,cc,Yd,ac).connect(ha);(new Location$$module$js$nodes(c,239,aa,"Tavern")).house().connect(ha).trigger(Lc,Kc,Ka);(new Location$$module$js$nodes(c,240,aa,"Pawn Shop")).shop().connect(ha);(new Location$$module$js$nodes(c,241,aa,"Dance Hall")).house().connect(ha).trigger(Mc,Lc,Ka).trigger(xe,Mc,nc);const Sh=(new Location$$module$js$nodes(c,242,oa,"Temple (pre-massacre)")).fortress().connect(Ga).from(Gb,M,Td).trigger(ze);(new Location$$module$js$nodes(c,242,oa,"Temple (post-massacre)")).fortress().from(Sh,
Nc).boss(df);(new Location$$module$js$nodes(c,243,oa,"Training Hall")).house().connect(Ga);(new Location$$module$js$nodes(c,244,oa,"Hospital")).house().connect(Ga);(new Location$$module$js$nodes(c,245,oa,"Armor Shop")).shop(cc,qb,ac).connect(Ga);(new Location$$module$js$nodes(c,246,oa,"Tool Shop")).shop(H,N,rb,Y).connect(Ga);(new Location$$module$js$nodes(c,247,oa,"Inn")).shop().connect(Ga);(new Location$$module$js$nodes(c,248,ca,"Inn")).shop().connect(Ha);(new Location$$module$js$nodes(c,249,ca,
"Tool Shop")).shop(N,U,sb,Y).connect(Ha);(new Location$$module$js$nodes(c,250,ca,"Elder's House")).house().connect(Ha);(new Location$$module$js$nodes(c,251,ca,"Pawn Shop")).house().connect(Ha);const Th=[pa,Na,$c,Da,Hb,Ea,Kb,ld,Mb,ha,mb,Pb,Qb,Kd,Rb];for(const a of Th)a.from(Gb,He);return c},shuffle$$module$js$depgraph=(a,b,c,d,e)=>{d=void 0===d?new FlagSet$$module$js$flagset("Sbkm Sct"):d;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d,a);d.shuffleShops()&&
f.shuffleShops(b);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&k.slots){var l=k.slotType[0];(h[l]=h[l]||[]).push(k)}k=[];l=[];var m={};for(var n of d.get("S")){var q=[];for(var p of n){m[p]=!0;for(var r of h[p])q.push(r),l.push([r,k.length])}k.push(q)}for(var t of"bc")if(m[t])for(n=h[t],p=n.map((a)=>[a.item,a.itemIndex]),b.shuffle(p),r=0;r<n.length;r++)n[r].set(p[r][0],p[r][1]);q=(a)=>g.find((b)=>
b.vanillaItemName===a);h=q("Sword of Wind");t=q("Sword of Fire");n=q("Ball of Wind");p=q("Ball of Fire");r=q("Statue of Onyx");q=q("Gas Mask");m.k&&b.nextInt(2)&&(t.swap(h),p.swap(n));m.k&&!b.nextInt(3)&&r.swap(q);m=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(t=0;1E3>t;t++){e&&0===t%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));b.shuffle(l);for(var u of k)b.shuffle(u);n=k.map(()=>-1);p=m[b.nextInt(m.length)];r=[];q=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||
b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<p;a++){const [b,c]=l[a],d=k[c][++n[c]];q(b,d)&&(b.swap(d),r.push([b,d]))}if(!r.length)continue;const {win:a,path:c}=f.traverse({wanted:g,dfs:!1});if(a)h=c;else for(;r.length;){const [a,b]=r.pop();a.swap(b)}}a&&f.write();if(c){c.items=[];c.route=[];for(const a of h){const [b,d]=a;c.route.push(d);u=f.nodes[b];u instanceof Slot$$module$js$nodes&&!u.isFixed()&&null!=u.slotName&&(k=u.slotName,
0>k.indexOf(u.vanillaItemName)&&(k+=` (normally ${u.vanillaItemName})`),c.items.push({itemIndex:u.itemIndex,itemName:u.item.name,origName:u.vanillaItemName,slotIndex:u.slotIndex,slotName:u.slotName,text:`${u.item.name}: ${k}`}))}}})},shuffle2$$module$js$depgraph=(a,b,c,d,e)=>{d=void 0===d?new FlagSet$$module$js$flagset("Sbkm Sct"):d;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d,a);d.shuffleShops()&&f.shuffleShops(b);const g=f.integrate();e&&
...
a.slots&&!a.isFixed());const l=new Map(d.shuffle(k.map((a)=>[a,[a.item,a.itemIndex]]))),m=new Set(d.shuffle(k)),n=new Map,q={};g&&g.seeds++;f.get("S").forEach((a,b)=>{for(const c of a)q[c]=b});for(var p of m)n.set(p.item,p);const r=new Set,t=(a,b)=>{if(null==q[a.slotType?a.slotType[0]:"c"])return a===b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!==b.item.inventoryRow&&a.requiresUnique||"armor"===b.item.inventoryRow&&!a.isChest())return!1;if(f.guaranteeSword()){if(0===a.slotIndex)return 4>b.item.id;
if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return q[a.slotType?a.slotType[0]:"c"]===q[b.slotType?b.slotType[0]:"c"]};p=b.assumedFill(d,(a,b)=>t(a,n.get(b)));if(null==p){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const u=new Map;for(var w=0;w<p.length;w++){var J=p[w];if(null!=J){var x=n.get(b.item(J));J=l.get(x);l.delete(x);x=b.location(w);u.set(x,J);m.delete(x)}}w=(a,b,c)=>{c=void 0===c?"":c;for(const c of m)if(t(c,a))return u.set(c,b),m.delete(c),l.delete(a),!0;
g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var G of l){const [a,b]=G;if(a.isMimic()&&!w(a,b,"traps"))return!1}for(const a of l){const [b,c]=a;if(b.needsChest()&&!w(b,c,"chest"))return!1}for(const a of l){const [b,c]=a;if(!w(b,c))return!1}for(const a of u){const [b,c]=a;b.set(...c)}const {win:K,path:Qa}=a.traverse({wanted:k,dfs:!1});if(!K)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,p));e.items=
[];e.route=[];for(const b of Qa){const [c,d]=b;e.route.push(d);k=a.nodes[c];k instanceof Slot$$module$js$nodes&&!k.isFixed()&&(G=k.slotName,0>G.indexOf(k.vanillaItemName)&&(G+=` (normally ${k.vanillaItemName})`),e.items.push({itemIndex:k.itemIndex,itemName:k.item.name,origName:k.vanillaItemName,slotIndex:k.slotIndex,slotName:k.slotName,text:`${k.item.name}: ${G}`}))}return!0})};var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;module$js$depgraph.shuffle=shuffle$$module$js$depgraph;
...
const VANILLA_SHOP_LOCATIONS$$module$js$rom$shop=139092,VANILLA_SHOP_INDICES$$module$js$rom$shop=139125,VANILLA_ARMOR_SHOP_ITEMS$$module$js$rom$shop=138660,VANILLA_ARMOR_SHOP_PRICES$$module$js$rom$shop=138704,VANILLA_TOOL_SHOP_ITEMS$$module$js$rom$shop=138792,VANILLA_TOOL_SHOP_PRICES$$module$js$rom$shop=138836,VANILLA_INN_PRICES$$module$js$rom$shop=138924;var module$js$rom$shop={};module$js$rom$shop.ShopType=ShopType$$module$js$rom$shop;module$js$rom$shop.Shop=Shop$$module$js$rom$shop;const RELEVANT_FLAGS$$module$js$graph$overlay=[10,11,24,27,30,33,36,37,38,39,56,58,59,69,82,83,97,114,139,155,165,169,512,513,514,515,517,518,519,520,521,522,523,524,566,579,580,643,750,759,763],FLAG_MAP$$module$js$graph$overlay=new Map([[10,module$js$graph$condition.Event.STARTED_WINDMILL],[19,module$js$graph$condition.Boss.SABERA1],[23,module$js$graph$condition.Item.SWORD_OF_WATER],[40,module$js$graph$condition.Magic.CHANGE],[41,module$js$graph$condition.Magic.CHANGE],[42,module$js$graph$condition.Magic.CHANGE],
[43,module$js$graph$condition.Magic.CHANGE],[108,module$js$graph$condition.Boss.DRAYGON1],[139,module$js$graph$condition.Item.SHELL_FLUTE]]),TRIGGER_ACTION_ITEMS$$module$js$graph$overlay={8:module$js$graph$condition.Slot(module$js$graph$condition.Magic.PARALYSIS),11:module$js$graph$condition.Slot(module$js$graph$condition.Magic.BARRIER),15:module$js$graph$condition.Slot(module$js$graph$condition.Magic.REFRESH),24:module$js$graph$condition.Slot(module$js$graph$condition.Magic.TELEPATHY)},SWORDS$$module$js$graph$overlay=
...
class Overlay$$module$js$graph$overlay{constructor(a,b){this.rom=a;this.flags=b;this.relevantFlags=new Set;this.tradeIns=new Map;this.shootingStatues=new Set;for(var c of RELEVANT_FLAGS$$module$js$graph$overlay)this.relevantFlags.add(c);for(const d of a.items)if(d.tradeIn)for(b=29===d.id?module$js$graph$condition.Capability.BUY_HEALING:module$js$graph$condition.Item(d.id),c=0;c<d.tradeIn.length;c+=6)this.tradeIns.set(d.tradeIn[c],b);for(const b of a.locations)for(const a of b.spawns)a.isMonster()&&
63===a.id&&this.shootingStatues.add(module$js$graph$geometry.ScreenId.from(b,a))}bossRequirements(a){if(a===this.rom.bosses.rage)return module$js$graph$condition.Condition(this.rom.npcs[195].localDialogs.get(-1)[0].condition);var b=a.object;const c=new MutableRequirement$$module$js$graph$condition;if(this.flags.guaranteeMatchingSword()){var d=this.flags.guaranteeSwordMagic()?a.swordLevel:1;b=this.rom.objects[b];for(let a=0;4>a;a++)b.isVulnerable(a)&&c.addAll(swordRequirement$$module$js$graph$overlay(a,
d))}else c.addAll(module$js$graph$condition.Capability.SWORD);d=[];this.flags.guaranteeRefresh()&&d.push(module$js$graph$condition.Magic.REFRESH);a===this.rom.bosses.insect&&d.push(module$js$graph$condition.Item.INSECT_FLUTE,module$js$graph$condition.Item.GAS_MASK);a===this.rom.bosses.draygon2&&(d.push(module$js$graph$condition.Item.BOW_OF_TRUTH),this.flags.storyMode()&&d.push(module$js$graph$condition.Boss.KELBESQUE1,module$js$graph$condition.Boss.KELBESQUE2,module$js$graph$condition.Boss.SABERA1,
module$js$graph$condition.Boss.SABERA2,module$js$graph$condition.Boss.MADO1,module$js$graph$condition.Boss.MADO2,module$js$graph$condition.Boss.KARMINE,module$js$graph$condition.Boss.DRAYGON1,module$js$graph$condition.Item.SWORD_OF_WIND,module$js$graph$condition.Item.SWORD_OF_FIRE,module$js$graph$condition.Item.SWORD_OF_WATER,module$js$graph$condition.Item.SWORD_OF_THUNDER));d.length&&c.restrict(and$$module$js$graph$condition(...d));return c.freeze()}locations(){const a=[];a.push({tile:module$js$graph$geometry.TileId(983176),
slot:module$js$graph$condition.Slot(module$js$graph$condition.Event.STARTED_WINDMILL),condition:module$js$graph$condition.Item.WINDMILL_KEY},{tile:module$js$graph$geometry.TileId(14942344),slot:module$js$graph$condition.Slot(module$js$graph$condition.Event.OPENED_JOEL_SHED),condition:module$js$graph$condition.Item.EYE_GLASSES});for(const b of this.rom.shops){if(195===b.location||246===b.location)continue;if(!b.used)continue;if(b.type!==module$js$rom$shop.ShopType.TOOL)continue;const c={tile:module$js$graph$geometry.TileId(b.location<<
16|136),condition:module$js$graph$condition.Capability.MONEY};for(const d of b.contents)d===(module$js$graph$condition.Item.MEDICAL_HERB[0][0]&255)?a.push(Object.assign({},c,{slot:module$js$graph$condition.Slot(module$js$graph$condition.Capability.BUY_HEALING)})):d===(module$js$graph$condition.Item.WARP_BOOTS[0][0]&255)&&a.push(Object.assign({},c,{slot:module$js$graph$condition.Slot(module$js$graph$condition.Capability.BUY_WARP)}))}return a}makeTerrain(a,b){var c=b>>>16;a&=38;26===c&&(a|=8);if(96===
c||104===c)a|=16;100===c&&144>(b&61680)&&(a|=16);this.shootingStatues.has(module$js$graph$geometry.ScreenId.fromTile(b))&&(a|=1);if(a&32){c=(a)=>{const b=this.rom.locations[a>>>16];return this.rom.tileEffects[b.tileEffects-179].effects[this.rom.screens[b.screens[(a&61440)>>>12][(a&3840)>>>8]].tiles[a&255]]};let d=b,e=-1;for(;c(d)&32;)d=module$js$graph$geometry.TileId.add(d,1,0),e++;for(;c(b)&32;)b=module$js$graph$geometry.TileId.add(b,-1,0),e++;6>e?a&=-33:9>e&&(a|=64)}return TERRAINS$$module$js$graph$overlay[a]}extraRoutes(){const a=
[],b=(a,b)=>{a=this.rom.locations[a];return module$js$graph$geometry.TileId.from(a,a.entrances[void 0===b?0:b])};a.push({tile:b(0)});this.flags.teleportOnThunderSword()&&a.push({tile:b(242),condition:module$js$graph$condition.Item.SWORD_OF_THUNDER});if(this.flags.assumeWildWarp())for(const c of this.rom.wildWarp.locations)a.push({tile:b(c)});return a}extraEdges(){const a=[];a.push({from:module$js$graph$geometry.TileId(5308552),to:module$js$graph$geometry.TileId(6325896),condition:module$js$graph$condition.Event.RETURNED_FOG_LAMP});
return a}trigger(a){function b(a){if(0>a)return~b(~a);const c=FLAG_MAP$$module$js$graph$overlay.get(a);return null!=c?c[0][0]:a}switch(a){case 154:return{check:[{condition:meet$$module$js$graph$condition(module$js$graph$condition.Event.SHYRON_MASSACRE,this.bossRequirements(this.rom.bosses.mado1)),slot:module$js$graph$condition.Slot(module$js$graph$condition.Boss.MADO1)}]};case 170:return{check:[{condition:and$$module$js$graph$condition(module$js$graph$condition.Event.DWARF_CHILD,module$js$graph$condition.Capability.BUY_WARP),
slot:module$js$graph$condition.Slot(module$js$graph$condition.Event.RESCUED_CHILD)}]};case 173:return{check:[{condition:module$js$graph$condition.Item.KEY_TO_PRISON,slot:module$js$graph$condition.Slot(module$js$graph$condition.Event.OPENED_PRISON)}]};case 174:return{check:[{condition:module$js$graph$condition.Item.KEY_TO_STYX,slot:module$js$graph$condition.Slot(module$js$graph$condition.Event.OPENED_STYX)}]};case 175:return{check:[{condition:module$js$graph$condition.Item.STATUE_OF_GOLD,slot:module$js$graph$condition.Slot(module$js$graph$condition.Event.CALMED_SEA)}]};
case 177:return{check:[{condition:and$$module$js$graph$condition(module$js$graph$condition.Item.BOW_OF_SUN,module$js$graph$condition.Item.BOW_OF_MOON),slot:module$js$graph$condition.Slot(module$js$graph$condition.Event.OPENED_CRYPT)}]}}var c=this.rom.triggers[a&127];if(!c||!c.used)throw Error(`Unknown trigger: ${hex$$module$js$rom$util(a)}`);a=(a)=>this.relevantFlags.has(a);const d=(a)=>0<a&&this.relevantFlags.has(a);var e=TRIGGER_ACTION_ITEMS$$module$js$graph$overlay[c.message.action];const f=and$$module$js$graph$condition(...c.conditions.map(b).filter(d).map(module$js$graph$condition.Condition));
if(25===c.message.action){e={};134!==c.id||this.flags.disableRabbitSkip()||this.flags.assumeRabbitSkip()||(e.dx=[-32,-16,0,16]);186!==c.id||this.flags.disableTeleportSkip()||this.flags.assumeTeleportSkip()||(e.extraLocations=[this.rom.locations.cordelPlainsWest]);const [d,...f]=c.conditions;if(!f.length&&0>d&&a(~b(d)))return Object.assign({},e,{terrain:{exit:module$js$graph$condition.Condition(~b(d))}})}else if(null!=e)return{check:[{condition:f,slot:e}]};c=c.flags.filter(d);return c.length?{check:c.map((a)=>
({condition:f,slot:module$js$graph$condition.Slot(a)}))}:{}}npc(a,b){function c(...a){if(!f.terrain)throw Error("Missing terrain for guard");f.terrain.exit=or$$module$js$graph$condition(f.terrain.exit||[],...a)}const d=this.rom.npcs[a];if(!d||!d.used)throw Error(`Unknown trigger: ${hex$$module$js$rom$util(a)}`);const e=d.spawnConditions.get(b.id)||[],f={check:[]};d.data[2]&4&&(f.terrain={exit:this.flags.assumeStatueGlitch()?[[]]:or$$module$js$graph$condition(...e.map((a)=>FLAG_MAP$$module$js$graph$overlay.get(a)||
(this.relevantFlags.has(a)?module$js$graph$condition.Condition(a):[])))});switch(a){case 20:if(b.spawns.find((a)=>a.isNpc()&&21===a.id))return{};case 37:f.hitbox={x0:0,x1:2,y0:0,y1:1};c(module$js$graph$condition.Magic.CHANGE,module$js$graph$condition.Magic.PARALYSIS);break;case 45:delete f.terrain;break;case 51:c(module$js$graph$condition.Magic.PARALYSIS);break;case 56:223===b.id&&(f.hitbox={x0:0,x1:1,y0:2,y1:3});break;case 78:f.hitbox={x0:-1,x1:2,y0:0,y1:1};c(module$js$graph$condition.Magic.CHANGE,
module$js$graph$condition.Event.ENTERED_SHYRON);break;case 128:c(...e.map((a)=>module$js$graph$condition.Condition(~a)));break;case 133:c(module$js$graph$condition.Item.FLUTE_OF_LIME)}const g=[];var h=(a)=>{0>=a||(a=FLAG_MAP$$module$js$graph$overlay.get(a)||(this.relevantFlags.has(a)?module$js$graph$condition.Condition(a):null),null!=a&&g.push(a))};for(var k of e)h(k);k=this.tradeIns.get(a);if(null!=k){var l=function(a,...c){c=and$$module$js$graph$condition(...g,b,...c);f.check.push({slot:a,condition:c})};
const b=k;switch(a){case 21:l(module$js$graph$condition.Slot(module$js$graph$condition.Item.WINDMILL_KEY));break;case 35:f.hitbox={x0:-1,x1:2,y0:-1,y1:2};l(module$js$graph$condition.Slot(module$js$graph$condition.Item.BOW_OF_MOON),module$js$graph$condition.Magic.CHANGE);break;case 99:f.hitbox={x0:-1,x1:2,y0:-1,y1:2};l(module$js$graph$condition.Slot(module$js$graph$condition.Event.HEALED_DOLPHIN));l(module$js$graph$condition.Slot(module$js$graph$condition.Item.SHELL_FLUTE));break;case 100:l(module$js$graph$condition.Slot(module$js$graph$condition.Event.RETURNED_FOG_LAMP),
...this.flags.requireHealedDolphinToRide()?[module$js$graph$condition.Event.HEALED_DOLPHIN]:[]);break;case 107:l(module$js$graph$condition.Slot(module$js$graph$condition.Item.GLOWING_LAMP));break;case 117:l(module$js$graph$condition.Slot(module$js$graph$condition.Magic.FLIGHT));break;case 116:l(module$js$graph$condition.Slot(module$js$graph$condition.Magic.CHANGE),module$js$graph$condition.Magic.PARALYSIS,module$js$graph$condition.Event.FOUND_KENSU);break;case 130:l(module$js$graph$condition.Slot(module$js$graph$condition.Item.GAS_MASK));
break;case 136:l(module$js$graph$condition.Slot(module$js$graph$condition.Item.SHIELD_RING))}}if(132===a)return{check:[{condition:this.bossRequirements(this.rom.bosses.sabera1),slot:module$js$graph$condition.Slot(module$js$graph$condition.Boss.SABERA1)}]};if(29===a)return a=module$js$graph$condition.Slot(module$js$graph$condition.Item.SWORD_OF_FIRE),{check:[{condition:and$$module$js$graph$condition(module$js$graph$condition.Magic.TELEPATHY,module$js$graph$condition.Boss.INSECT),slot:a},{condition:module$js$graph$condition.Event.RESCUED_CHILD,
...
function expandFill$$module$js$graph$shuffle(a,b){const c=new GenericFill$$module$js$graph$shuffle;for(let d=a.fixed;d<a.items.length;d++)c.set(a.slots[b.items[d]].item,a.items[d].item);return c}
function traverse$$module$js$graph$shuffle(a,b,c){c=Bits$$module$js$bits.clone(c);const d=new Set,e=new Set;for(var f=0;f<a.slots.length;f++)e.add(f);for(const g of e)if(e.delete(g),!d.has(g)){f=a.graph[g];for(let h=0,k=f.length;h<k;h++)if(Bits$$module$js$bits.containsAll(c,f[h])){d.add(g);f=g<a.fixed?g:b.slots[g];if(null!=f){c=Bits$$module$js$bits.with(c,f);for(const b of a.unlocks[f]||[])e.add(b)}break}}return d}
...
c.addTasks(Math.floor(d/100));for(let q=0;q<d;q++){c&&99===q%100&&(yield new Promise(requestAnimationFrame),c.addCompleted(1));var f=e.items(a,b);let p=Bits$$module$js$bits.from(new Set(f));var g=new GenericFill$$module$js$graph$shuffle,h=new Map,k=new Map,l=[];for(var m=a.fixed;m<a.items.length;m++){var n=a.items[m].item;null!=n&&(h.set(n,m),e.shuffleRules.shouldShuffle(n)||l.push(n))}for(m=a.fixed;m<a.slots.length;m++)n=a.slots[m].item,null!=n&&k.set(n,m);for(const a of l)l=h.get(a),m=k.get(a),
null!=m&&null!=l&&(g.set(m,l),p=Bits$$module$js$bits.without(p,l));e.flags.guaranteeSword()&&(l=b.nextInt(4),h=h.get(l),k=k.get(0),null==h||null==k||g.hasSlot(k)||g.hasItem(h)||(g.set(k,h),p=Bits$$module$js$bits.without(p,h)));if(e.fillInternal(a,b,g,f,p,Math.floor(q/5)))if(f=traverse$$module$js$graph$shuffle(a,g,Bits$$module$js$bits.of()),f.size!==a.slots.length)console.error("unexpected size mismatch!",f,a);else if(g=e.fill(a,expandFill$$module$js$graph$shuffle(a,g),b),null!=g)return c&&c.addCompleted(Math.floor((d-
q)/100)),g}return null})}fillInternal(a,b,c,d,e,f){for(let k=d.pop();null!=k;k=d.pop()){if(!Bits$$module$js$bits.has(e,k))continue;const l=a.items[k].item;if(null==l)throw Error(`bad item: ${Object.entries(a.items[k])}`);e=Bits$$module$js$bits.without(e,k);const m=[...traverse$$module$js$graph$shuffle(a,c,e)];b.shuffle(m);var g=!1;for(const b of m){var h=a.slots[b].item;if(null!=h&&!c.hasSlot(b)&&this.fits(h,l)){c.set(b,k);g=!0;break}}if(!g){if(0<f--){for(const f of m)if(h=a.slots[f].item,null!=h&&
this.fits(h,l)){g=c.slots[f];c.slots[f]=c.items[g]=void 0;e=Bits$$module$js$bits.with(e,g);d.push(g);b.shuffle(d);c.set(f,k);g=!0;break}if(g)continue}console.error(`Failed to place key item ${l}: available ${m.map((b)=>a.slots[b].item)}`);return!1}}return!0}fill(a,b,c){const d=new Set;for(var e of a.slots)null!=e.item&&d.add(e.item);const f=[],g=[],h=[];a=[];e=[];for(let c=0;124>c;c++)112>c&&!d.has(c)?b.hasSlot(c)!==b.hasItem(c)&&console.error("MISMATCH",c):b.hasSlot(c)||b.hasItem(c)||this.shuffleRules.shouldShuffle(c)?
(b.hasSlot(c)||(this.shuffleRules.isEarly(c)?a.push(c):e.push(c)),b.hasItem(c)||(72>=c&&this.rom.items[c].unique?f.push(c):112>c?g.push(c):h.push(c))):b.set(c,c);c.shuffle(a);c.shuffle(e);c.shuffle(f);c.shuffle(g);for(const d of module$js$util.iters.concat(f,h,g)){c=!1;for(const f of[a,e]){if(c)break;for(const a of f)if(this.fits(a,d)){b.set(a,d);c=!0;f.splice(f.indexOf(a),1);break}}if(!c)return console.error(`Failed to fill extra item ${d}. Slots: ${a}, ${e}`),null}return b}}
var module$js$graph$shuffle={};module$js$graph$shuffle.traverse=traverse$$module$js$graph$shuffle;module$js$graph$shuffle.traverseFill=traverseFill$$module$js$graph$shuffle;module$js$graph$shuffle.ShuffleRules=ShuffleRules$$module$js$graph$shuffle;module$js$graph$shuffle.AssumedFill=AssumedFill$$module$js$graph$shuffle;class UnionFind$$module$js$unionfind{constructor(){this.data=new Map;this.sizes=new Map}find(a){if(a!==a)throw"nan";this.data.has(a)||(this.data.set(a,a),this.sizes.set(a,1));let b;for(;!Object.is(b=this.data.get(a),a);)this.data.set(a,a=this.data.get(b));return a}union(a){this.find(a[0]);for(let b=1;b<a.length;b++){if(a[b]!==a[b])throw"nan";this.unionInternal(a[0],a[b])}}unionInternal(a,b){a=this.find(a);b=this.find(b);if(a!==b){var c=this.sizes.get(a),d=this.sizes.get(b);c<d?(this.sizes.set(b,c+
d),this.data.set(a,b)):(this.sizes.set(a,c+d),this.data.set(b,a))}}sets(){const a=new Map;for(const b of this.data.keys()){const c=this.find(b);let d=a.get(c);d||a.set(c,d=new Set);d.add(b)}return[...a.values()]}map(){const a=new Map;for(const b of this.data.keys()){let c=a.get(this.find(b));a.set(b,c||(c=new Set));c.add(b)}return a}roots(){const a=new Set;for(const b of this.data.keys())a.add(this.find(b));return[...a]}}var module$js$unionfind={};module$js$unionfind.UnionFind=UnionFind$$module$js$unionfind;class World$$module$js$graph$world{constructor(a,b,c){this.rom=a;this.tiles=b;this.graph=c}traverse(a,b){const {spoiler:c}=this.rom;if(c){for(var d=-512;768>d;d++)c.addCondition(d,conditionName$$module$js$graph$world(d,this.rom));for(const e of traverseFill$$module$js$graph$shuffle(a,b)){const [f,...g]=e;{d=a.slots[f].condition;const e=g.map((b)=>a.items[b].condition);c.addCheck(d,e,b.slots[a.slots[f].item])}}}}static build(a,b){return build$$module$js$graph$world(a,b)}}
function build$$module$js$graph$world(a,b){b=void 0===b?new FlagSet$$module$js$flagset("@FullShuffle"):b;const c=new Overlay$$module$js$graph$overlay(a,b),d=new Map,e=new Map,f=new Map,g=new Map,h=new DefaultMap$$module$js$util(()=>new Set),k=new Map,l=new Set;for(const b of a.locations){var m=function(a,b){const c=d.get(a);c&&d.set(a,module$js$graph$condition.Terrain.meet(c,b))};if(!b.used)continue;const r=b.extended?256:0,p=a.tilesets[(b.tileset&127)>>2],u=a.tileEffects[b.tileEffects-179];for(const a of b.spawns)a.isWall()&&
e.set(module$js$graph$geometry.ScreenId.from(b,a),a.id&3);for(let f=0,g=b.height;f<g;f++){const g=b.screens[f],h=b.id<<8|f<<4;for(let f=0,k=b.width;f<k;f++){var n=function(a,b){if(!w)throw Error("flag expected");return b?a?t(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(w.flag)},b):a};const k=a.screens[g[f]|r],l=module$js$graph$geometry.ScreenId(h|f),m=l&255,q=e.get(l),w=null!=q?c.wallCapability(q):b.flags.find((a)=>a.yx===m),t=memoize2$$module$js$graph$condition((a,
b)=>{if(!w)throw Error("flag expected");b=Object.assign({},b,{enter:meet$$module$js$graph$condition(b.enter||[[]],module$js$graph$condition.Condition(w.flag))});return module$js$graph$condition.Terrain.join(a,b)});for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(l<<8|a);let e=k.tiles[a];w&&751===w.flag&&32>e&&(e=p.alternates[e]);let f=c.makeTerrain(r?0:u.effects[e]&38,b);if(32>e&&p.alternates[e]!=e&&w&&751!==w.flag){const a=c.makeTerrain(u.effects[p.alternates[e]],b);f=n(f,a)}f&&d.set(b,
f)}}}for(const a of b.exits)if(a.entrance&32){const c=module$js$graph$geometry.TileId.from(b,a);l.add(c);const e=d.get(c);e&&d.set(c,module$js$graph$condition.Terrain.seamless(e))}for(const d of b.spawns)if(d.isTrigger()){const a=c.trigger(d.id);if(a.terrain||a.check){let {x:c,y:e}=d;c+=8;for(const d of[b,...a.extraLocations||[]])for(const b of a.dx||[-16,0])for(const f of[-16,0]){const g=module$js$graph$geometry.TileId.from(d,{x:c+b,y:e+f});a.terrain&&m(g,a.terrain);for(const b of a.check||[])h.get(g).add(b)}}}else if(d.isNpc()){g.set(module$js$graph$geometry.TileId.from(b,
d),d.id);const a=c.npc(d.id,b);if(a.terrain||a.check){let {x:c,y:e}=d,{x0:f,x1:g,y0:k,y1:l}=a.hitbox||{x0:0,y0:0,x1:1,y1:1};for(let d=f;d<g;d++)for(let f=k;f<l;f++){const g=module$js$graph$geometry.TileId.from(b,{x:c+16*d,y:e+16*f});a.terrain&&m(g,a.terrain);for(const b of a.check||[])h.get(g).add(b)}}}else if(d.isBoss())f.set(module$js$graph$geometry.TileId.from(b,d),d.id);else if(d.isChest())h.get(module$js$graph$geometry.TileId.from(b,d)).add(module$js$graph$condition.Check.chest(d.id));else if(d.isMonster()){const c=
a.objects[d.monsterId];c.goldDrop&&k.set(module$js$graph$geometry.TileId.from(b,d),c.elements)}}for(const b of f){const [e,f]=b;{const b=e>>16,g=195!==f?a.bosses.fromLocation(b):a.bosses.rage;if(160===b||95===b)continue;if(!g||null==g.kill)throw Error(`bad boss at loc ${b.toString(16)}`);const k=module$js$graph$condition.Boss(g.kill),l=memoize$$module$js$graph$condition((a)=>module$js$graph$condition.Terrain.meet(a,{exit:k,exitSouth:k})),m=e&-256,n=c.bossRequirements(g),r={slot:module$js$graph$condition.Slot(k),
condition:n};for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(m|a),c=d.get(b);c&&(d.set(b,l(c)),h.get(b).add(r))}}}for(const a of c.locations()||[])h.get(a.tile).add(a);const q=new UnionFind$$module$js$unionfind;for(const a of d){const [b,c]=a;{const a=module$js$graph$geometry.TileId.add(b,0,1);d.get(a)===c&&q.union([b,a]);const e=module$js$graph$geometry.TileId.add(b,1,0);d.get(e)===c&&q.union([b,e])}}const p=new Set;for(const b of a.locations)if(b.used)for(const c of b.exits){const {dest:d,
entrance:e}=c,f=module$js$graph$geometry.TileId.from(b,c),g=e&32?module$js$graph$geometry.TileId(f&65535|d<<16):module$js$graph$geometry.TileId.from({id:d},a.locations[d].entrances[e]);p.add(module$js$graph$geometry.TilePair.of(q.find(f),q.find(g)))}for(const a of p){const [b,c]=module$js$graph$geometry.TilePair.split(a);if(d.get(b)!==d.get(c))continue;const e=module$js$graph$geometry.TilePair.of(c,b);p.has(e)&&(q.union([b,c]),p.delete(a),p.delete(e))}const r=new Neighbors$$module$js$graph$geometry(q,
l);for(const a of d){const [b,c]=a;{const a=module$js$graph$geometry.TileId.add(b,0,1),e=d.get(a);e&&e!==c&&r.addAdjacent(b,a,!1);const f=module$js$graph$geometry.TileId.add(b,1,0),g=d.get(f);g&&g!==c&&r.addAdjacent(b,f,!0)}}for(const a of p){const [b,c]=module$js$graph$geometry.TilePair.split(a);d.has(b)&&d.has(c)&&r.addExit(b,c)}const t=new Routes$$module$js$graph$routes;for(const a of c.extraRoutes())for(const b of a.condition||[[]])t.addRoute(q.find(a.tile),b);for(const a of c.extraEdges()){const {from:b,
to:c,condition:d}=a;for(const a of d||[[]])t.addEdge(q.find(c),q.find(b),a)}for(const a of r){const {from:b,to:c,south:e}=a;{const a=d.get(b),f=d.get(c);if(!a||!f)throw Error(`missing terrain ${a?c:b}`);for(const d of(e?a.exitSouth:a.exit)||[[]])for(const a of f.enter||[[]])t.addEdge(c,b,[...a,...d])}}const u=new DefaultMap$$module$js$util(()=>new MutableRequirement$$module$js$graph$condition);for(const a of c.capabilities()){const {condition:b=[[]],capability:c}=a;u.get(module$js$graph$condition.Slot(c)).addAll(b)}for(const a of h){const [b,
...
f&&e.push(`\nfrom ${c.toString(16)} if (${[...a.deps].map(b).join(" & ")})`)}return`${hex$$module$js$rom$util(f)}\n${(function(a,b,c){const d=[];for(let e=0;e<a.length;e+=b)d.push(a.slice(e,e+b).join(c));return d})(c,16," ").join("\n")}\ncount = ${c.length}\nroutes = ${d}${e.join("")}`};b.whatFlag=(b)=>conditionName$$module$js$graph$world(b,a);b.reqs=u;console.log("reqs\n"+[...u].sort((a,b)=>{[a]=a;[b]=b;return a-b}).map((a)=>{var [c,d]=a;return`${b.whatFlag(c)}: ${w(d,b.whatFlag)}`}).join("\n"));
b.reqs.check=(a,b)=>{b=void 0===b?J:b;return`${b(a)}: ${w(u.get(module$js$graph$condition.Slot(a)),b)}`};b.reqs.check2=(a)=>b.reqs.check(a,b.whatFlag)}return new World$$module$js$graph$world(a,q,makeGraph$$module$js$graph$world(u,a))}
function makeGraph$$module$js$graph$world(a,b){function c(a){return 512<=a&&640>a}function d(a,c){return{name:conditionName$$module$js$graph$world(a,b),condition:a,index:c}}function e(a,b){return Object.assign(d(a,b+n),{item:a&127})}function f(a){const c=q.get(a);if(null==c)throw Error(`Missing item $${a.toString(16)}: ${conditionName$$module$js$graph$world(a,b)}`);return c}var g=new Set,h=new Set;for(var k of a){const [a,b]=k;h.add(a);for(var l of b)for(var m of l)g.add(m)}g.add(module$js$graph$condition.Boss.DRAYGON2[0][0]);
k=[...g].filter((a)=>!c(a)).sort();g=[...g].filter(c).sort();l=[...h].filter(c).sort();const n=k.length;h=k.map(d);g=g.map(e);m=l.map(e);g=[...h,...g];k=[...h,...m];const q=new Map(g.map((a,b)=>[a.condition,b])),p=new Map(k.map((a,b)=>[a.condition,b]));l=[];const r=[];for(var t of a){const [c,d]=t;a=p.get(c);if(null==a)MAYBE_MISSING_SLOTS$$module$js$graph$world.has(c)||console.error(`Nothing depended on $${c.toString(16)}: ${conditionName$$module$js$graph$world(c,b)}`);else for(const b of d){const c=
[...b].map(f);(l[a]||(l[a]=[])).push(Bits$$module$js$bits.from(c));for(const b of c)(r[b]||(r[b]=new Set)).add(a)}}for(var u of[...h,...m])l[u.index]&&l[u.index].length||(t=u.condition,console.error(`Nothing provided $${t.toString(16)}: ${conditionName$$module$js$graph$world(t,b)} (index ${u.index})`));DEBUG$$module$js$graph$world&&console.log(l);u=r.map((a)=>[...a]);return{fixed:n,slots:k,items:g,graph:l,unlocks:u}}const MAYBE_MISSING_SLOTS$$module$js$graph$world=new Set([37,38,169,580]);
...
h=[...concatIterables$$module$js$rom$util(b.exits),128|(b.pits.length?64:0)|b.entrances.length];var k=[...concatIterables$$module$js$rom$util(b.flags),255],l=concatIterables$$module$js$rom$util(b.pits),[m,n,q,p,r,t]=yield Promise.all([d(e,"Layout"),d(f,"Graphics"),d(g,"Entrances"),d(h,"Exits"),d(k,"Flags"),...l.length?[d(l,"Pits")]:[]]);e=[m&255,(m>>>8)-192,n&255,(n>>>8)-192,q&255,(q>>>8)-192,p&255,(p>>>8)-192,r&255,(r>>>8)-192,...t?[t&255,(t>>8)-192]:[]];d=yield d(e,"MapData");writeLittleEndian$$module$js$rom$util(a.rom,
b.mapDataPointer,d-49152);yield Promise.all(c);c=b.bossId();if(null!=c&&95!==b.id){e=[b.spritePatterns[0],void 0];166===b.id&&(e=[83,80]);d=readLittleEndian$$module$js$rom$util(a.rom,129387+2*c)+81920;e=[,,,b.bgm,,...b.tilePalettes,,,,b.spritePalettes[0],,,,,,e[0],e[1],b.animation];for(f=0;f<e.length;f++)g=e[f],null!=g&&(a.rom[d+f]=g);a.rom[128961+5*c]=b.spritePalettes[1]}}})}allScreens(){const a=new Set,b=this.extended?256:0;for(const c of this.screens)for(const d of c)a.add(this.rom.screens[d+b]);
...
(b&15)?b+241:b+1,f.has(a)&&c.union([b,a]),a=224===(b&240)?b+3872:b+16,f.has(a)&&c.union([b,a]);f=c.map();c=new Set;for(var h of this.entrances)c.add(f.get(h.screen<<8|h.tile));h=new Map;for(const a of c)for(const b of a)h.set(b,e.effects[this.rom.screens[this.screens[b>>>12][b>>>8&15]|(this.extended?256:0)].tiles[b&255]]);return h}screenMover(){const a=new DefaultMap$$module$js$util(()=>[]),b=module$js$util.iters.concat(this.spawns,this.exits,this.entrances);for(const c of b)a.get(c.screen).push(c);
return(b,d)=>{for(const c of a.get(b))c.screen=d}}moveScreen(a,b){const c=module$js$util.iters.concat(this.spawns,this.exits,this.entrances);for(const d of c)d.screen===a&&(d.screen=b)}monsterPlacer(a){const b=BOSS_SCREENS$$module$js$rom$location[this.key],c=this.reachableTiles(!1),d=new Map([...c.keys()].map((a)=>[a,0])),e=[],f=[],g=[],h=[],k=[],l=this.hasDolphin()?37:39;for(const a of d){const [k,m]=a;{const a=this.screens[k>>>12][k>>>8&15];if(a!==b){for(const a of neighbors$$module$js$rom$location(k,
...
c,2)+Math.pow(d-b,2)<Math.pow(e+f,2))continue a}k.push([b,d,l,e]);return(l&240|(d&240)>>>4)<<8|(l&15)<<4|d&15}}}}function neighbors$$module$js$rom$location(a,b,c){const d=[],e=a&61680,f=a&3855;e<(c-1<<12|224)&&d.push(224===(a&240)?a+3872:a+16);e&&d.push(0===(a&240)?a-3872:a-16);f<(b-1<<8|15)&&d.push(15===(a&15)?a+241:a+1);f&&d.push(0===(a&15)?a-241:a-1);return d}
...
Spawn$$module$js$rom$location=DataTuple$$module$js$rom$util.make(4,{y:DataTuple$$module$js$rom$util.prop([0,255,-4]),yt:DataTuple$$module$js$rom$util.prop([0]),timed:DataTuple$$module$js$rom$util.booleanProp([1,128,7]),x:DataTuple$$module$js$rom$util.prop([1,127,-4],[2,64,3]),xt:DataTuple$$module$js$rom$util.prop([1,127]),screen:DataTuple$$module$js$rom$util.prop([0,240],[1,240,4]),tile:DataTuple$$module$js$rom$util.prop([0,15,-4],[1,15]),patternBank:DataTuple$$module$js$rom$util.prop([2,128,7]),
...
this.type||!(4>this.id||this.data[2]&32))},wallType(){if(3!==this.type)return"";const a=this.data[2]&32?this.id>>>4:this.id;return 4<=a?"":2===a?"bridge":"wall"},wallElement(){return this.isWall()?this.id&3:-1},toString(){return`Spawn ${this.hex()}: (${hex$$module$js$rom$util(this.x)}, ${hex$$module$js$rom$util(this.y)}) ${this.timed?"timed":"fixed"} ${this.type}:${hex$$module$js$rom$util(this.id)}`}}),LOCATIONS$$module$js$rom$location={mezameShrine:[0,"Mezame Shrine"],leafOutsideStart:[1,"Leaf - Outside Start"],
leaf:[2,"Leaf"],valleyOfWind:[3,"Valley of Wind"],sealedCave1:[4,"Sealed Cave 1"],sealedCave2:[5,"Sealed Cave 2"],sealedCave6:[6,"Sealed Cave 6"],sealedCave4:[7,"Sealed Cave 4"],sealedCave5:[8,"Sealed Cave 5"],sealedCave3:[9,"Sealed Cave 3"],sealedCave7:[10,"Sealed Cave 7"],sealedCave8:[12,"Sealed Cave 8"],windmillCave:[14,"Windmill Cave"],windmill:[15,"Windmill"],zebuCave:[16,"Zebu Cave"],mtSabreWestCave1:[17,"Mt Sabre West - Cave 1"],cordelPlainsWest:[20,"Cordel Plains West"],cordelPlainsEast:[21,
"Cordel Plains East"],brynmaer:[24,"Brynmaer"],outsideStomHouse:[25,"Outside Stom House"],swamp:[26,"Swamp"],amazones:[27,"Amazones"],oak:[28,"Oak"],stomHouse:[30,"Stom House"],mtSabreWestLower:[32,"Mt Sabre West - Lower"],mtSabreWestUpper:[33,"Mt Sabre West - Upper"],mtSabreWestCave2:[34,"Mt Sabre West - Cave 2"],mtSabreWestCave3:[35,"Mt Sabre West - Cave 3"],mtSabreWestCave4:[36,"Mt Sabre West - Cave 4"],mtSabreWestCave5:[37,"Mt Sabre West - Cave 5"],mtSabreWestCave6:[38,"Mt Sabre West - Cave 6"],
mtSabreWestCave7:[39,"Mt Sabre West - Cave 7"],mtSabreNorthMain:[40,"Mt Sabre North - Main"],mtSabreNorthMiddle:[41,"Mt Sabre North - Middle"],mtSabreNorthCave2:[42,"Mt Sabre North - Cave 2"],mtSabreNorthCave3:[43,"Mt Sabre North - Cave 3"],mtSabreNorthCave4:[44,"Mt Sabre North - Cave 4"],mtSabreNorthCave5:[45,"Mt Sabre North - Cave 5"],mtSabreNorthCave6:[46,"Mt Sabre North - Cave 6"],mtSabreNorthPrisonHall:[47,"Mt Sabre North - Prison Hall"],mtSabreNorthLeftCell:[48,"Mt Sabre North - Left Cell"],
mtSabreNorthLeftCell2:[49,"Mt Sabre North - Left Cell 2"],mtSabreNorthRightCell:[50,"Mt Sabre North - Right Cell"],mtSabreNorthCave8:[51,"Mt Sabre North - Cave 8"],mtSabreNorthCave9:[52,"Mt Sabre North - Cave 9"],mtSabreNorthSummitCave:[53,"Mt Sabre North - Summit Cave"],mtSabreNorthCave1:[56,"Mt Sabre North - Cave 1"],mtSabreNorthCave7:[57,"Mt Sabre North - Cave 7"],nadareInn:[60,"Nadare - Inn"],nadareToolShop:[61,"Nadare - Tool Shop"],nadareBackRoom:[62,"Nadare - Back Room"],waterfallValleyNorth:[64,
"Waterfall Valley North"],waterfallValleySouth:[65,"Waterfall Valley South"],limeTreeValley:[66,"Lime Tree Valley"],limeTreeLake:[67,"Lime Tree Lake"],kirisaPlantCave1:[68,"Kirisa Plant Cave 1"],kirisaPlantCave2:[69,"Kirisa Plant Cave 2"],kirisaPlantCave3:[70,"Kirisa Plant Cave 3"],kirisaMeadow:[71,"Kirisa Meadow"],fogLampCave1:[72,"Fog Lamp Cave 1"],fogLampCave2:[73,"Fog Lamp Cave 2"],fogLampCave3:[74,"Fog Lamp Cave 3"],fogLampCaveDeadEnd:[75,"Fog Lamp Cave Dead End"],fogLampCave4:[76,"Fog Lamp Cave 4"],
fogLampCave5:[77,"Fog Lamp Cave 5"],fogLampCave6:[78,"Fog Lamp Cave 6"],fogLampCave7:[79,"Fog Lamp Cave 7"],portoa:[80,"Portoa"],portoaFishermanIsland:[81,"Portoa - Fisherman Island"],mesiaShrine:[82,"Mesia Shrine"],waterfallCave1:[84,"Waterfall Cave 1"],waterfallCave2:[85,"Waterfall Cave 2"],waterfallCave3:[86,"Waterfall Cave 3"],waterfallCave4:[87,"Waterfall Cave 4"],towerEntrance:[88,"Tower - Entrance"],tower1:[89,"Tower 1"],tower2:[90,"Tower 2"],tower3:[91,"Tower 3"],towerOutsideMesia:[92,"Tower - Outside Mesia"],
towerOutsideDyna:[93,"Tower - Outside Dyna"],towerMesia:[94,"Tower - Mesia"],towerDyna:[95,"Tower - Dyna"],angrySea:[96,"Angry Sea"],boatHouse:[97,"Boat House"],joelLighthouse:[98,"Joel - Lighthouse"],undergroundChannel:[100,"Underground Channel"],zombieTown:[101,"Zombie Town"],evilSpiritIsland1:[104,"Evil Spirit Island 1"],evilSpiritIsland2:[105,"Evil Spirit Island 2"],evilSpiritIsland3:[106,"Evil Spirit Island 3"],evilSpiritIsland4:[107,"Evil Spirit Island 4"],saberaPalace1:[108,"Sabera Palace 1"],
saberaPalace2:[109,"Sabera Palace 2"],saberaPalace3:[110,"Sabera Palace 3"],joelSecretPassage:[112,"Joel - Secret Passage"],joel:[113,"Joel"],swan:[114,"Swan"],swanGate:[115,"Swan - Gate"],goaValley:[120,"Goa Valley"],mtHydra:[124,"Mt Hydra"],mtHydraCave1:[125,"Mt Hydra - Cave 1"],mtHydraOutsideShyron:[126,"Mt Hydra - Outside Shyron"],mtHydraCave2:[127,"Mt Hydra - Cave 2"],mtHydraCave3:[128,"Mt Hydra - Cave 3"],mtHydraCave4:[129,"Mt Hydra - Cave 4"],mtHydraCave5:[130,"Mt Hydra - Cave 5"],mtHydraCave6:[131,
"Mt Hydra - Cave 6"],mtHydraCave7:[132,"Mt Hydra - Cave 7"],mtHydraCave8:[133,"Mt Hydra - Cave 8"],mtHydraCave9:[134,"Mt Hydra - Cave 9"],mtHydraCave10:[135,"Mt Hydra - Cave 10"],styx1:[136,"Styx 1"],styx2:[137,"Styx 2"],styx3:[138,"Styx 3"],shyron:[140,"Shyron"],goa:[142,"Goa"],goaFortressOasisEntrance:[143,"Goa Fortress - Oasis Entrance"],desert1:[144,"Desert 1"],oasisCaveMain:[145,"Oasis Cave - Main"],desertCave1:[146,"Desert Cave 1"],sahara:[147,"Sahara"],saharaOutsideCave:[148,"Sahara - Outside Cave"],
desertCave2:[149,"Desert Cave 2"],saharaMeadow:[150,"Sahara Meadow"],desert2:[152,"Desert 2"],pyramidEntrance:[156,"Pyramid - Entrance"],pyramidBranch:[157,"Pyramid - Branch"],pyramidMain:[158,"Pyramid - Main"],pyramidDraygon:[159,"Pyramid - Draygon"],cryptEntrance:[160,"Crypt - Entrance"],cryptHall1:[161,"Crypt - Hall 1"],cryptBranch:[162,"Crypt - Branch"],cryptDeadEndLeft:[163,"Crypt - Dead End Left"],cryptDeadEndRight:[164,"Crypt - Dead End Right"],cryptHall2:[165,"Crypt - Hall 2"],cryptDraygon2:[166,
"Crypt - Draygon 2"],cryptTeleporter:[167,"Crypt - Teleporter"],goaFortressEntrance:[168,"Goa Fortress - Entrance"],goaFortressKelbesque:[169,"Goa Fortress - Kelbesque"],goaFortressZebu:[170,"Goa Fortress - Zebu"],goaFortressSabera:[171,"Goa Fortress - Sabera"],goaFortressTornel:[172,"Goa Fortress - Tornel"],goaFortressMado1:[173,"Goa Fortress - Mado 1"],goaFortressMado2:[174,"Goa Fortress - Mado 2"],goaFortressMado3:[175,"Goa Fortress - Mado 3"],goaFortressKarmine1:[176,"Goa Fortress - Karmine 1"],
...
e;}this.map=b;this.border=d;c&&(this.counts=new Multiset$$module$js$util(c));return!1}*extensions(){const a=new UnionFind$$module$js$unionfind,b=[];for(const d of this.allPos){var c=this.map[d];if(null==c)for(const b of[d-1,d-16])this.empty(b)&&a.union([d,b]);else for(const a of this.screenExtensions.get(c&65535)){const [e,g]=a;c=Pos$$module$js$maze$maze.plus(d,e);!this.map[c]&&this.inBounds(c)&&b.push([d,g,e,0])}}for(const c of b){const [b,,d]=c;c[3]=a.find(Pos$$module$js$maze$maze.plus(b,d))<<4|
Scr$$module$js$maze$maze.edge(c[1],c[2]);yield c}}*eligible(a,b){b=void 0===b?{}:b;const {skipAlternates:c,maxExits:d,edge:e,fuzzy:f,stair:g}=b;var h=null!=e?e|e<<4|e<<8|e<<12:void 0;let k=b=0,l=0;for(var m of Dir$$module$js$maze$maze.ALL){var n=Dir$$module$js$maze$maze.edgeMask(m),q=Dir$$module$js$maze$maze.edgeMask(Dir$$module$js$maze$maze.inv(m));let c=this.get(a,m);null==c&&(c=h);null!=c&&(l|=((c&q)>>>8|(c&q)<<8)&65535,b|=n,f&&this.isFixed(Pos$$module$js$maze$maze.plus(a,m))&&(k|=n))}f||(k=b);
a=l&k;m=[];h=Infinity;for(const e of this.screens){const [r,p]=e;if(!(p.fixed||c&&p.edges&-65536||null!=g&&!p.stairs.some((a)=>a.dir===g)||null==g&&p.stairs.length||(r&k)!==a||d&&Scr$$module$js$maze$maze.numExits(r)>d))if(f){n=0;q=r&b^l;for(const a of Dir$$module$js$maze$maze.ALL)q&15<<Dir$$module$js$maze$maze.shift(a)&&n++;n<h?(h=n,m=[r]):n===h&&m.push(r)}else yield r}f&&(yield*m)}fill(a,b){b=void 0===b?{}:b;if(b.force&&b.fuzzy)throw Error("invalid");const c=[...this.eligible(a,b)];if(!c.length)return!1;
if(b.fuzzy)return this.setAndUpdate(a,this.random.pick(c),b);this.set(a,this.random.pick(c),b);return!0}fillPath(a,b,c,d,e){e=void 0===e?{}:e;return this.saveExcursion(()=>{var f=[...c];for(const c of f){f=Dir$$module$js$maze$maze.turn(b,c);a=Pos$$module$js$maze$maze.plus(a,b);const g=Scr$$module$js$maze$maze.fromExits(DirMask$$module$js$maze$maze.of(Dir$$module$js$maze$maze.inv(b),f),d);if(!this.trySet(a,g,e))return!1;b=f}return this.fill(Pos$$module$js$maze$maze.plus(a,b),Object.assign({},e,{maxExits:2}))})}fillPathToDeadEnd(a,
b,c,d,e){d=void 0===d?{}:d;e=void 0===e?{}:e;return this.saveExcursion(()=>{var f=[...c];for(const c of f){f=Dir$$module$js$maze$maze.turn(b,c);a=Pos$$module$js$maze$maze.plus(a,b);const e=Scr$$module$js$maze$maze.fromExits(DirMask$$module$js$maze$maze.of(Dir$$module$js$maze$maze.inv(b),f),d.edge||1);if(!this.trySet(a,e,d))return!1;b=f}return this.fill(Pos$$module$js$maze$maze.plus(a,b),Object.assign({},e,{maxExits:1}))})}fillAll(a){a=void 0===a?{}:a;const b=a.shuffleOrder?this.random.shuffle([...this.allPos]):
this.allPos;for(const c of b)if(null==this.map[c]&&!this.fill(c,a)){if(a.fuzzy)return!1;throw Error(`Could not fill ${hex$$module$js$rom$util(c)}`);}return!0}randomPos(){return this.random.pick(this.allPosArray)}addScreen(a){for(const b of this.random.shuffle([...this.allPos]))if(null==this.map[b]&&this.trySet(b,a))return b}addDeadEnd(){return!1}addLoop(){var a=new DefaultMap$$module$js$util(()=>[]);for(var b of this.extensions()){const [c,d,e,f]=b;a.get(f).push([c,d,e,f&15])}a=[...a.values()];this.random.shuffle(a);
do if(b=a.pop(),!b)return!1;while(2>b.length);this.random.shuffle(b);const [[c,d,e,f],[g,h,k]]=b;return this.saveExcursion(()=>{this.replace(c,d);this.replace(g,h);var a=Pos$$module$js$maze$maze.plus(g,k);if(Pos$$module$js$maze$maze.plus(c,e)===a)return this.fill(a,{maxExits:2,replace:!0});const [b,n]=relative$$module$js$maze$maze(c,e,a);a=0;for(const d of generatePaths$$module$js$maze$maze(this.random,b,n)){if(this.fillPath(c,e,d,f,{replace:!0}))break;if(20<++a)return!1}return!0})}connect(a,b,c,
d){const e=Scr$$module$js$maze$maze.edge(this.map[a]||0,b);if(e!==Scr$$module$js$maze$maze.edge(this.map[c]||0,d))throw Error("Incompatible exit types");c=Pos$$module$js$maze$maze.plus(c,d);const [f,g]=relative$$module$js$maze$maze(a,b,c);c=0;for(const d of generatePaths$$module$js$maze$maze(this.random,f,g)){if(this.fillPath(a,b,d,e))break;if(20<++c)return!1}return!0}inBounds(a){return 0<=a&&(a&15)<this.width&&a>>>4<this.height}isFixed(a){if(!this.inBounds(a))return!0;a=this.map[a];if(null==a)return!1;
a=this.screens.get(a);return!(null==a||!a.fixed&&!a.stairs.length)}density(){return this.allPosArray.filter((a)=>this.map[a]).length/(this.width*this.height)}size(){return this.allPosArray.filter((a)=>this.map[a]).length}trim(){const a=new Set;for(var b of this.screens.values())b.edges||a.add(b.tile);b=(b)=>!this.map[b]||a.has(this.screens.get(this.map[b]).tile);for(const a=0;seq$$module$js$rom$util(this.width,(b)=>a<<4|b).every(b);)this.map.splice(0,16),this.border.splice(0,16),this.height--;for(let a=
this.height-1;0<=a&&seq$$module$js$rom$util(this.width,(b)=>a<<4|b).every(b);a--)this.map.splice(this.height-1<<4,16),this.border.splice(this.height-1<<4,16),this.height--;for(const a=0;seq$$module$js$rom$util(this.height,(b)=>b<<4|a).every(b);){for(var c=this.height-1;0<=c;c--)delete this.map[c<<4|a],this.border[c<<4|a]=0;this.map.push(this.map.shift());this.width--}for(let a=this.width-1;0<=a&&seq$$module$js$rom$util(this.height,(b)=>b<<4|a).every(b);a--){for(c=this.height-1;0<=c;c--)delete this.map[c<<
4|a],this.border[c<<4|a]=0;this.width--}}*[Symbol.iterator](){for(const a of this.allPos){const b=this.map[a];null!=b&&(yield[a,b])}}get(a,b){const c=null!=b?Pos$$module$js$maze$maze.plus(a,b):a;return this.inBounds(c)?this.map[c]:this.border[a]&15<<((b^2)<<2)}getEdge(a,b){a=this.map[a];if(null!=a)return a>>Dir$$module$js$maze$maze.shift(b)&15}getSpec(a){a=this.map[a];return null!=a?this.screens.get(a):a}setBorder(a,b,c){if(!this.inBounds(a)||this.inBounds(Pos$$module$js$maze$maze.plus(a,b)))throw Error(`Not on border: ${hex$$module$js$rom$util(a)}, ${b}`);
if(null!=this.map[a])throw Error("Must set border first.");b=(b^2)<<2;if(this.border[a]&15<<b)throw Error("Border already set");this.border[a]|=c<<b}replaceEdge(a,b,c){const d=Pos$$module$js$maze$maze.plus(a,b);if(!this.inBounds(a))throw Error(`Out of bounds ${hex$$module$js$rom$util(a)}`);if(!this.inBounds(d))throw Error(`Out of bounds ${hex$$module$js$rom$util(d)}`);let e=this.map[a],f=this.map[d];if(null==e)throw Error(`No screen for ${hex$$module$js$rom$util(a)}`);if(null==f)throw Error(`No screen for ${hex$$module$js$rom$util(d)}`);
const g=Dir$$module$js$maze$maze.edgeMask(b),h=c<<Dir$$module$js$maze$maze.shift(b),k=Dir$$module$js$maze$maze.edgeMask(Dir$$module$js$maze$maze.inv(b));b=c<<Dir$$module$js$maze$maze.shift(Dir$$module$js$maze$maze.inv(b));e=e&~g|h;f=f&~k|b;if(!this.screens.has(e)||!this.screens.has(f))return!1;this.setInternal(a,e);this.setInternal(d,f);return!0}setAndUpdate(a,b,c){c=void 0===c?{}:c;return this.saveExcursion(()=>{const d=Object.assign({},c,{fuzzy:c.fuzzy&&c.fuzzy-1,replace:!0});this.setInternal(a,
b);for(const b of Dir$$module$js$maze$maze.ALL)if(!this.checkFit(a,b)){const c=Pos$$module$js$maze$maze.plus(a,b);if(this.isFixed(c)||!this.fill(c,d))return!1}return!0})}set(a,b,c){c=void 0===c?{}:c;if(!(c.force||(c.replace?this.fits(a,b):this.fitsAndEmpty(a,b))))throw c=this.map[a],c=null!=c?hex5$$module$js$rom$util(c):"empty",Error(`Cannot overwrite ${hex$$module$js$rom$util(a)} (${c}) with ${hex5$$module$js$rom$util(b)}`);if(!this.screens.has(b))throw Error(`No such screen ${hex5$$module$js$rom$util(b)}`);
this.inBounds(a)&&this.setInternal(a,b)}trySet(a,b,c){c=void 0===c?{}:c;if(!(c.force||(c.replace?this.fits(a,b):this.fitsAndEmpty(a,b))))return!1;if(!this.screens.has(b))throw Error(`No such screen ${hex5$$module$js$rom$util(b)}`);this.setInternal(a,b);return!0}replace(a,b){if(!this.fits(a,b)||!this.inBounds(a))throw Error(`Cannot place ${hex5$$module$js$rom$util(b)} at ${hex$$module$js$rom$util(a)}`);if(!this.screens.has(b))throw Error(`No such screen ${hex5$$module$js$rom$util(b)}`);this.setInternal(a,
b)}setInternal(a,b){const c=this.map[a];this.map[a]=b;this.counts&&(null!=c&&this.counts.delete(c),this.counts.add(b))}fitsAndEmpty(a,b){return this.empty(a)&&this.fits(a,b)}empty(a){return null==this.map[a]&&this.inBounds(a)}fits(a,b){for(const c of Dir$$module$js$maze$maze.ALL){const d=this.get(a,c);if(null!=d&&Scr$$module$js$maze$maze.edge(b,c)!==Scr$$module$js$maze$maze.edge(d,Dir$$module$js$maze$maze.inv(c)))return!1}return!0}checkFit(a,b){const c=this.get(a);a=this.get(a,b);return null==c||
null==a?!0:Scr$$module$js$maze$maze.edge(c,b)!==Scr$$module$js$maze$maze.edge(a,Dir$$module$js$maze$maze.inv(b))?!1:!0}traverse(a){a=void 0===a?{}:a;var b=new Set(a.without||[]);const c=!a.noFlagged;a=new UnionFind$$module$js$unionfind;for(const g of this.allPos)if(!b.has(g)){var d=this.map[g];if(null!=d&&(d=this.screens.get(d),null!=d)){for(var e of d.connections)a.union(e.map((a)=>(g<<8)+a));if(d.wall)for(var f of d.wall.connections(c))a.union(f.map((a)=>(g<<8)+a))}}b=new Map;a=a.sets();for(e=0;e<
a.length;e++){f=a[e];for(const a of f)b.set(a,f)}return b}consolidate(a,b,c){if(!this.counts||!this.extraTiles)throw Error("Cannot run consolidate without counts.");var d=new Set(a);const e=new Set;for(var f of this.screens.values())f.fixed||(0>f.tile||d.has(f.tile))&&e.add(f.edges);d=new Set;for(var g of this.counts)[f]=g,e.has(f)||d.add(f);g=d.size+a.length;for(d=1E3;this.counts.unique()>g&&--d;){var h=[...this.counts].filter((a)=>e.has(a[0])).sort((a,b)=>b[1]-a[1]).map((a)=>a[0]);f=new Set(h.slice(0,
a.length));h=new Set(h.slice(a.length));const c=this.random.shuffle([...this.allPos]);for(var k of c)if(h.has(this.map[k])&&this.tryConsolidate(k,f,h,b))break}if(!d)return!1;b=new Set([...this.counts].filter((a)=>e.has(a[0])).map((a)=>a[0]));a=[];for(var l of e){k=this.screens.get(l);if(!k)throw Error("missing spec");0<=k.tile&&(b.has(l)?b.delete(l):a.push(k.tile))}for(const d of b){l=a.pop();b=this.screens.get(d);if(null==l||!b)throw Error("No available screen");c.screens[l].tiles.splice(0,240,...this.extraTiles[~b.tile]);
this.extraTilesMap[~b.tile]=l}return!0}tryConsolidate(a,b,c,d){const e=this.map[a];if(null==e)throw Error("Expected defined");for(const g of this.random.shuffle([...b])){const h=e^g;for(const e of Dir$$module$js$maze$maze.ALL){var f=Dir$$module$js$maze$maze.edgeMask(e);if(h&~f)continue;const k=Pos$$module$js$maze$maze.plus(a,e);f=this.map[k];if(null==f)break;if(!c.has(f)&&!b.has(f))break;const m=g>>>Dir$$module$js$maze$maze.shift(e)&15,n=Dir$$module$js$maze$maze.inv(e),q=Dir$$module$js$maze$maze.edgeMask(n),
p=f&~q|m<<Dir$$module$js$maze$maze.shift(n);if(c.has(p)&&!c.has(f))break;if(this.saveExcursion(()=>{this.setInternal(a,g);this.setInternal(k,p);return d()}))return!0}}return!1}show(){const a=" "+seq$$module$js$rom$util(this.width).join("")+"\n",b=seq$$module$js$rom$util(this.height,(a)=>a.toString(16)+seq$$module$js$rom$util(this.width,(b)=>{b=this.map[a<<4|b];if(null==b)return" ";var c=this.screens.get(b);if(c)return c.icon;c=0;for(const a of Dir$$module$js$maze$maze.ALL)b&15<<(a<<2)&&(c|=1<<(a<<
2));return UNICODE_TILES$$module$js$maze$maze[c]||" "}).join("")).join("\n");return a+b}write(a,b){for(var c of a.flags)b.add(c.flag);c=0;const d={wall:[],bridge:[]};for(var e of a.spawns){var f=e.wallType();f&&d[f].push(e);"wall"===f&&(c=e.wallElement())}a.flags=[];a.width=this.width;a.height=this.height;for(e=0;e<this.height;e++)for(a.screens[e]=[],f=0;f<this.width;f++){const h=e<<4|f;var g=this.map[h];if(null==g)throw Error(`Missing screen at pos ${hex$$module$js$rom$util(h)}`);const k=this.screens.get(g);
if(!k)throw Error(`Missing spec for ${hex5$$module$js$rom$util(g)} at ${hex$$module$js$rom$util(h)}`);a.screens[e].push(0>k.tile?this.extraTilesMap[~k.tile]:k.tile);k.flag&&a.flags.push(Flag$$module$js$rom$location.of({screen:h,flag:751}));k.wall&&(a.flags.push(Flag$$module$js$rom$location.of({screen:h,flag:pop$$module$js$maze$maze(b)})),(g=d[k.wall.type].pop())||(g=Spawn$$module$js$rom$location.of({screen:h,tile:k.wall.tile,type:3,id:"wall"===k.wall.type?c:2}),a.spawns.push(g)),g.screen=h,g.tile=
k.wall.tile)}}}function pop$$module$js$maze$maze(a){for(const b of a)return a.delete(b),b;throw Error("cannot pop from empty set");}class Stair$$module$js$maze$maze{constructor(a,b,c){this.dir=a;this.entrance=b;this.exit=c}static up(a,b){return new Stair$$module$js$maze$maze(Dir$$module$js$maze$maze.UP,a,b)}static down(a,b){return new Stair$$module$js$maze$maze(Dir$$module$js$maze$maze.DOWN,a,b)}}
class Wall$$module$js$maze$maze{constructor(a,b,c,d){this.type=a;this.tile=b;this.a=c;this.b=d}connections(a){if(!a)return[connection$$module$js$maze$maze(this.a),connection$$module$js$maze$maze(this.b)];a=this.b;let b=this.a;for(;a;)a>>=4,b<<=4;return[connection$$module$js$maze$maze(b|this.b)]}}function wall$$module$js$maze$maze(a,b){var [c,d]=b;return new Wall$$module$js$maze$maze("wall",a,c,d)}
function bridge$$module$js$maze$maze(a,b){var [c,d]=b;return new Wall$$module$js$maze$maze("bridge",a,c,d)}class Poi$$module$js$maze$maze{constructor(a,b,c){this.priority=a;this.dy=b;this.dx=c}}function poi$$module$js$maze$maze(a,b,c){return new Poi$$module$js$maze$maze(a,void 0===b?112:b,void 0===c?120:c)}function connection$$module$js$maze$maze(a){const b=[];for(;a;)b.push((a&3)<<(a&4)|(a&8?a&4?256:4096:0)),a>>>=4;return b}
function Spec$$module$js$maze$maze(a,b,c,...d){const e=[],f=[],g=[];let h=!1,k=!1,l=void 0,m=!1;for(let a of d)"string"===typeof a?"fixed"===a?h=!0:"flag"===a?k=!0:"pit"===a?m=!0:assertNever$$module$js$util(a):"number"===typeof a?e.push(connection$$module$js$maze$maze(a)):a instanceof Stair$$module$js$maze$maze?g.push(a):a instanceof Wall$$module$js$maze$maze?l=a:a instanceof Poi$$module$js$maze$maze?f.push(a):assertNever$$module$js$util(a);return{edges:a,tile:b,icon:c,connections:e,fixed:h,flag:k,
wall:l,pit:m,poi:f,stairs:g}}function relative$$module$js$maze$maze(a,b,c){const d=(c>>>4)-(a>>>4);a=(c&15)-(a&15);if(0===b)return[-d,a];if(1===b)return[a,d];if(2===b)return[d,-a];if(3===b)return[-a,-d];throw Error(`impossible: ${b}`);}function*generatePaths$$module$js$maze$maze(a,b,c){for(;;)yield generatePath$$module$js$maze$maze(a,b,c)}
function*generatePath$$module$js$maze$maze(a,b,c){function d(){b--;return 0}function e(){[b,c]=[-c,b-1];return-1}function f(){[b,c]=[c,1-b];return 1}for(;1!==b||0!==c;)0<b&&.5>a.next()?(yield d(),2<b&&.5>a.next()&&(yield d())):a.next()<(0>b?.1:.5)?yield d():0<c?yield f():0>c?yield e():yield.5>a.next()?e():f()}var DirMask$$module$js$maze$maze;(function(a){a.of=function(...a){let b=0;for(let c of a)b|=1<<c;return b}})(DirMask$$module$js$maze$maze||(DirMask$$module$js$maze$maze={}));var Dir$$module$js$maze$maze;
(function(a){a.ALL=[0,1,2,3];a.DELTA=[-16,1,16,-1];a.inv=function(a){return a^2};a.edgeMask=function(a){return 15<<(a<<2)};a.shift=function(a){return a<<2};a.turn=function(a,c){return a+c&3};a.allEdge=function*(b,c,d){const e=b?c<<4:d,f=b&1?16:1;for(b=b===a.RIGHT?d-1:b===a.DOWN?c-1<<4:0;b<e;b+=f)yield b};a.UP=0;a.RIGHT=1;a.DOWN=2;a.LEFT=3})(Dir$$module$js$maze$maze||(Dir$$module$js$maze$maze={}));var Pos$$module$js$maze$maze;
(function(a){a.plus=function(a,c){return a+Dir$$module$js$maze$maze.DELTA[c]}})(Pos$$module$js$maze$maze||(Pos$$module$js$maze$maze={}));var Scr$$module$js$maze$maze;(function(a){a.edge=function(a,c){return a>>>(c<<2)&15};a.numExits=function(a){let b=0;for(let c=0;4>c;c++)a&15&&b++,a>>>=4;return b};a.fromExits=function(a,c){let b=0;for(let d=0;4>d;d++)b<<=4,a&8&&(b|=c),a=(a&7)<<1;return b}})(Scr$$module$js$maze$maze||(Scr$$module$js$maze$maze={}));
const UNICODE_TILES$$module$js$maze$maze={4112:"\u2500",257:"\u2502",272:"\u250c",4352:"\u2510",17:"\u2514",4097:"\u2518",273:"\u251c",4353:"\u2524",4368:"\u252c",4113:"\u2534",4369:"\u253c",4096:"\u2574",1:"\u2575",16:"\u2576",256:"\u2577"};function write$$module$js$maze$maze(a,b,c){for(let d=0;d<c.length;d++)for(let e=0;e<c[d].length;e++){const f=c[d][e];null!=f&&(a[b+(d<<4|e)]=f)}}
function readScreen$$module$js$maze$maze(a){const b=a.split(/ +/g).map((a)=>parseInt(a,16));for(const c of b)if("number"!=typeof c||isNaN(c))throw Error(`Bad screen: ${c} in ${a}`);return b}var module$js$maze$maze={};module$js$maze$maze.Maze=Maze$$module$js$maze$maze;module$js$maze$maze.Stair=Stair$$module$js$maze$maze;module$js$maze$maze.Wall=Wall$$module$js$maze$maze;module$js$maze$maze.wall=wall$$module$js$maze$maze;module$js$maze$maze.bridge=bridge$$module$js$maze$maze;
module$js$maze$maze.Poi=Poi$$module$js$maze$maze;module$js$maze$maze.poi=poi$$module$js$maze$maze;module$js$maze$maze.Spec=Spec$$module$js$maze$maze;module$js$maze$maze.Dir=Dir$$module$js$maze$maze;module$js$maze$maze.Pos=Pos$$module$js$maze$maze;module$js$maze$maze.Scr=Scr$$module$js$maze$maze;module$js$maze$maze.write=write$$module$js$maze$maze;module$js$maze$maze.readScreen=readScreen$$module$js$maze$maze;const EMPTY_ITERATOR$$module$js$rom$constraint={next(){return{done:!0}}},NONE$$module$js$rom$constraint={get size(){return 0},has(){return!1},[Symbol.iterator](){return EMPTY_ITERATOR$$module$js$rom$constraint}},ALL$$module$js$rom$constraint={get size(){return Infinity},has(){return!0},[Symbol.iterator](){throw Error("cannot iterate");}};
...
0)}static get BOSS(){return new Constraint$$module$js$rom$constraint([TREASURE_CHEST_BANKS$$module$js$rom$constraint,ALL$$module$js$rom$constraint,ALL$$module$js$rom$constraint,ALL$$module$js$rom$constraint],[],0)}static get COIN(){return new Constraint$$module$js$rom$constraint([COIN_BANKS$$module$js$rom$constraint,ALL$$module$js$rom$constraint,ALL$$module$js$rom$constraint,ALL$$module$js$rom$constraint],[],0)}static forLocation(a){switch(a){case 3:return new Constraint$$module$js$rom$constraint([ALL$$module$js$rom$constraint,
bit$$module$js$rom$constraint(96),ALL$$module$js$rom$constraint,bit$$module$js$rom$constraint(32)],[],0);case 96:case 100:case 104:return new Constraint$$module$js$rom$constraint([ALL$$module$js$rom$constraint,bit$$module$js$rom$constraint(82),ALL$$module$js$rom$constraint,bit$$module$js$rom$constraint(8)],[],0)}return Constraint$$module$js$rom$constraint.ALL}static fromSpawn(a,b,c,d,e){const [f,...g]=b;(e=e&&2===f&&!g.length)&&d.patternBank&&(b=new Set([3]));const h=e||!b.has(2)?ALL$$module$js$rom$constraint:
bit$$module$js$rom$constraint(c.spritePatterns[0]);b=e||!b.has(3)?ALL$$module$js$rom$constraint:bit$$module$js$rom$constraint(c.spritePatterns[1]);d=e?[bit$$module$js$rom$constraint(c.spritePatterns[d.patternBank])]:[];e=a.has(2)?bit$$module$js$rom$constraint(c.spritePalettes[0]):ALL$$module$js$rom$constraint;a=a.has(3)?bit$$module$js$rom$constraint(c.spritePalettes[1]):ALL$$module$js$rom$constraint;return new Constraint$$module$js$rom$constraint([h,b,e,a],d,0)}ignorePalette(){return new Constraint$$module$js$rom$constraint([this.fixed[0],
this.fixed[1],ALL$$module$js$rom$constraint,ALL$$module$js$rom$constraint],this.float,this.shift)}shufflePalette(a,b){const c=[...this.fixed];for(let d=2;4>d;d++){if(c[d]===ALL$$module$js$rom$constraint)continue;const e=Math.floor(5-Math.log2(a.nextInt(15)+2)),f=c[d]=new Set;for(let c=0;c<e;c++)f.add(a.pick(b))}return new Constraint$$module$js$rom$constraint(c,this.float,this.shift)}shifted(){return new Constraint$$module$js$rom$constraint(this.fixed,this.float,this.shift|2)}join(a){const b=seq$$module$js$rom$util(4,
(b)=>CSet$$module$js$rom$constraint.union(this.fixed[b],a.fixed[b]));if(this.float.length!=a.float.length)throw console.dir(this),console.dir(a),Error(`incompatible float: ${this.float} ${a.float}`);const c=seq$$module$js$rom$util(this.float.length,(b)=>CSet$$module$js$rom$constraint.union(this.float[b],a.float[b]));return new Constraint$$module$js$rom$constraint(b,c,this.shift|a.shift)}fix(a,b){var c=b?(a)=>b.nextInt(a):()=>0;const d=b?(a)=>b.pick([...a]):(a)=>a[Symbol.iterator]().next().value,e=
[...this.fixed];if(this.float.length){c=c(2);const a=1-c;c<this.float.length&&(e[0]=CSet$$module$js$rom$constraint.intersect(e[0],this.float[c]));a<this.float.length&&(e[1]=CSet$$module$js$rom$constraint.intersect(e[1],this.float[a]))}e[0]!==ALL$$module$js$rom$constraint&&(a.spritePatterns[0]=d([...e[0]]));e[1]!==ALL$$module$js$rom$constraint&&(a.spritePatterns[1]=d([...e[1]]));e[2]!==ALL$$module$js$rom$constraint&&(a.spritePalettes[0]=d([...e[2]]));e[3]!==ALL$$module$js$rom$constraint&&(a.spritePalettes[1]=
d([...e[3]]))}meet(a){const b=[];let c=this.shift|a.shift;for(var d=0;4>d;d++){var e=CSet$$module$js$rom$constraint.intersect(this.fixed[d],a.fixed[d]);if(!e.size)return;b.push(e)}e=new Map;d=[];for(var f of module$js$util.iters.concat(this.float,a.float)){if(f===ALL$$module$js$rom$constraint)throw Error("Unexpected unconstrained float");a=!1;for(var g of f){const b=e.get(g);if(null!=b){for(var h of d[b])e.delete(h);d[b]=CSet$$module$js$rom$constraint.intersect(d[b],f);for(const a of d[b])e.set(a,
b);a=!0;break}}if(a)break;for(const a of f)e.set(a,d.length);d.push(f);if(2<d.length)return}for(f=0;f<d.length;f++)for(g=0;2>g;g++)if(!CSet$$module$js$rom$constraint.intersect(d[f],b[g]).size){h=b[1-g]=CSet$$module$js$rom$constraint.intersect(d[f],b[1-g]);c|=1<<1-g;if(!h.size)return;d.splice(f,1);f=-1;break}return new Constraint$$module$js$rom$constraint(b,d,c)}}
...
function playerArmor$$module$js$rom$monster(a,b){return b?lookup$$module$js$rom$monster(a,2,[6,6],[18,8],[25,12],[30,18],[37,24],[42,32]):lookup$$module$js$rom$monster(a,2,[6,6],[18,10],[25,14],[30,18],[40,24],[46,32])}function lookup$$module$js$rom$monster(a,b,...c){for(let b=c.length-1;0<=b;b--){const [d,f]=c[b];if(a>=d)return f}return b}var module$js$rom$monster={};module$js$rom$monster.Monster=Monster$$module$js$rom$monster;module$js$rom$monster.ACTION_SCRIPTS=ACTION_SCRIPTS$$module$js$rom$monster;const EDGE_TYPES$$module$js$maze$cave={1:{[module$js$maze$maze.Dir.DOWN]:{entrance:57216,exits:[230,231,232,233]},[module$js$maze$maze.Dir.UP]:{entrance:12416,exits:[38,39,40,41]}},6:{[module$js$maze$maze.Dir.DOWN]:{entrance:57216,exits:[231,232]},[module$js$maze$maze.Dir.UP]:{entrance:12416,exits:[39,40]}}},BASIC_SCREENS$$module$js$maze$cave=[Spec$$module$js$maze$maze(0,128," "),Spec$$module$js$maze$maze(257,129,"\u2502",42,poi$$module$js$maze$maze(4)),Spec$$module$js$maze$maze(4112,130,"\u2500",
110,poi$$module$js$maze$maze(4)),Spec$$module$js$maze$maze(272,131,"\u250c",174,poi$$module$js$maze$maze(2)),Spec$$module$js$maze$maze(4352,132,"\u2510",106,poi$$module$js$maze$maze(2)),Spec$$module$js$maze$maze(17,133,"\u2514",46,poi$$module$js$maze$maze(2)),Spec$$module$js$maze$maze(4097,134,"\u2518",38,poi$$module$js$maze$maze(2)),Spec$$module$js$maze$maze(273,135,"\u251c",686,poi$$module$js$maze$maze(3)),Spec$$module$js$maze$maze(4369,136,"\u253c",9902,poi$$module$js$maze$maze(3)),Spec$$module$js$maze$maze(4353,
137,"\u2524",618,poi$$module$js$maze$maze(3)),Spec$$module$js$maze$maze(4368,138,"\u252c",1710,poi$$module$js$maze$maze(3)),Spec$$module$js$maze$maze(4113,139,"\u2534",622,poi$$module$js$maze$maze(3)),Spec$$module$js$maze$maze(131329,140,"\u250b",42),Spec$$module$js$maze$maze(1048833,141,"\u256b","fixed",42),Spec$$module$js$maze$maze(1052688,142,"\u256b","fixed",110),Spec$$module$js$maze$maze(65793,143,"\u2506",wall$$module$js$maze$maze(135,[2,10])),Spec$$module$js$maze$maze(69648,144,"\u2504",wall$$module$js$maze$maze(103,
[2,10])),Spec$$module$js$maze$maze(69649,148,"\u2538",wall$$module$js$maze$maze(55,[2,110])),Spec$$module$js$maze$maze(135184,149,"\u2538",110,Stair$$module$js$maze$maze.up(16512,55)),Spec$$module$js$maze$maze(69632,150,"\u251a",6,Stair$$module$js$maze$maze.up(16432,50)),Spec$$module$js$maze$maze(135168,151,"\u2512",6,Stair$$module$js$maze$maze.down(44848,178)),Spec$$module$js$maze$maze(65552,152,"\u2516",14,Stair$$module$js$maze$maze.up(16592,60)),Spec$$module$js$maze$maze(131088,153,"\u250e",14,
Stair$$module$js$maze$maze.down(45008,188)),Spec$$module$js$maze$maze(131073,154,"\u2579",2,Stair$$module$js$maze$maze.down(8064,39)),Spec$$module$js$maze$maze(131328,154,"\u257b",10,Stair$$module$js$maze$maze.up(53376,199)),Spec$$module$js$maze$maze(262401,155," ",2,10),Spec$$module$js$maze$maze(1,155,"\u2575",2,poi$$module$js$maze$maze(0,-48,120)),Spec$$module$js$maze$maze(256,155,"\u2577",10,poi$$module$js$maze$maze(0,272,120)),Spec$$module$js$maze$maze(266256,156," ",6,14),Spec$$module$js$maze$maze(16,
156,"\u2576",14,poi$$module$js$maze$maze(0,112,264)),Spec$$module$js$maze$maze(4096,156,"\u2574",6,poi$$module$js$maze$maze(0,112,-40)),Spec$$module$js$maze$maze(1537,158,"\u257d",42)],BOSS_SCREENS$$module$js$maze$cave=[Spec$$module$js$maze$maze(29046,145,"\u2564","fixed",42,poi$$module$js$maze$maze(1,96,120)),Spec$$module$js$maze$maze(94582,146,"\u2564","fixed",wall$$module$js$maze$maze(39,[2,10]),poi$$module$js$maze$maze(1,96,120)),Spec$$module$js$maze$maze(112,128,"\u2558"),Spec$$module$js$maze$maze(28672,
128,"\u255b")],RIVER_SCREENS$$module$js$maze$cave=[Spec$$module$js$maze$maze(13107,211,"\u256c",21,61,bridge$$module$js$maze$maze(182,[121,191]),poi$$module$js$maze$maze(4,0,152)),Spec$$module$js$maze$maze(771,212,"\u2551",25,59),Spec$$module$js$maze$maze(12336,213,"\u2550",93,127),Spec$$module$js$maze$maze(66307,214,"\u2551",bridge$$module$js$maze$maze(135,[25,59])),Spec$$module$js$maze$maze(77872,215,"\u2550",bridge$$module$js$maze$maze(134,[93,127])),Spec$$module$js$maze$maze(816,216,"\u2554",
157,191),Spec$$module$js$maze$maze(13056,217,"\u2557",91,121),Spec$$module$js$maze$maze(51,218,"\u255a",31,61),Spec$$module$js$maze$maze(12291,219,"\u255d",21,55),Spec$$module$js$maze$maze(12337,220,"\u2567",605,127),Spec$$module$js$maze$maze(12592,221,"\u2564",93,1967),Spec$$module$js$maze$maze(4867,222,"\u2562",361,59),Spec$$module$js$maze$maze(787,223,"\u255f",25,958),Spec$$module$js$maze$maze(525059,240," ",1,3,9,11),Spec$$module$js$maze$maze(3,240," ",1,3,poi$$module$js$maze$maze(1,-48,72),poi$$module$js$maze$maze(1,
-48,152)),Spec$$module$js$maze$maze(768,240," ",9,11,poi$$module$js$maze$maze(1,272,72),poi$$module$js$maze$maze(1,272,152)),Spec$$module$js$maze$maze(536624,241," ",5,7,13,15),Spec$$module$js$maze$maze(48,241," ",13,15,poi$$module$js$maze$maze(1,96,264),poi$$module$js$maze$maze(1,160,264)),Spec$$module$js$maze$maze(12288,241," ",5,7,poi$$module$js$maze$maze(1,96,-40),poi$$module$js$maze$maze(1,160,-40)),Spec$$module$js$maze$maze(3,242,"\u2568",bridge$$module$js$maze$maze(23,[1,3])),Spec$$module$js$maze$maze(768,
242,"\u2565",bridge$$module$js$maze$maze(198,[9,11])),Spec$$module$js$maze$maze(13104,243,"\u2566",93,121,191),Spec$$module$js$maze$maze(12339,244,"\u2569",21,61,127),Spec$$module$js$maze$maze(131843,245,"\u2560",25,3,11,poi$$module$js$maze$maze(1,192,152),poi$$module$js$maze$maze(1,64,152)),Spec$$module$js$maze$maze(262915,246,"\u2563",1,9,59,poi$$module$js$maze$maze(1,176,72),poi$$module$js$maze$maze(1,48,72))],WIDE_SCREENS$$module$js$maze$cave=[Spec$$module$js$maze$maze(2,113,"\u253b",2,Stair$$module$js$maze$maze.down(53120,
215)),Spec$$module$js$maze$maze(514,114,"\u2503",42),Spec$$module$js$maze$maze(18,224,"\u2516",46),Spec$$module$js$maze$maze(4098,225,"\u251a",38),Spec$$module$js$maze$maze(4608,226,"\u2512",106),Spec$$module$js$maze$maze(528,227,"\u250e",174),Spec$$module$js$maze$maze(4626,230,"\u2542",9902),Spec$$module$js$maze$maze(4114,231,"\u2538",622),Spec$$module$js$maze$maze(4624,232,"\u2530",1710),Spec$$module$js$maze$maze(513,233,"\u257d",wall$$module$js$maze$maze(55,[2,10]))],PIT_SCREENS$$module$js$maze$cave=
[Spec$$module$js$maze$maze(528400,235,"\u2508","pit",110),Spec$$module$js$maze$maze(524545,236,"\u250a","pit",42)],SPIKE_SCREENS$$module$js$maze$cave=[Spec$$module$js$maze$maze(260,237,"\u257f",42),Spec$$module$js$maze$maze(1025,238,"\u257d",42),Spec$$module$js$maze$maze(5140,239,"\u2542",9902),Spec$$module$js$maze$maze(1028,247,"\u2503",42)],ALL_SCREENS$$module$js$maze$cave=[BASIC_SCREENS$$module$js$maze$cave,BOSS_SCREENS$$module$js$maze$cave,RIVER_SCREENS$$module$js$maze$cave,WIDE_SCREENS$$module$js$maze$cave,
PIT_SCREENS$$module$js$maze$cave,SPIKE_SCREENS$$module$js$maze$cave],BITCOUNT$$module$js$maze$cave=[0,1,1,2,1,2,2,3,1,2,2,3,2,3,3,4],EDGES_BY_TILE$$module$js$maze$cave=new Map,STAIRS_BY_TILE$$module$js$maze$cave=new Map,WALLS$$module$js$maze$cave=new Set,FIXED_TILES$$module$js$maze$cave=new Map,DEAD_ENDS$$module$js$maze$cave=new Set([155,156,240,241]),STAIR_SCREENS$$module$js$maze$cave=new Map;
for(const a of module$js$util.iters.concat(...ALL_SCREENS$$module$js$maze$cave)){for(const b of module$js$maze$maze.Dir.ALL){const c=a.edges>>module$js$maze$maze.Dir.shift(b)&15;c&&7!=(c&7)&&EDGES_BY_TILE$$module$js$maze$cave.set(a.tile,(EDGES_BY_TILE$$module$js$maze$cave.get(a.tile)||0)|1<<b)}for(const b of a.stairs)STAIRS_BY_TILE$$module$js$maze$cave.set(a.tile<<8|(b.entrance&61440)>>8|(b.entrance&240)>>4,b.dir),STAIR_SCREENS$$module$js$maze$cave.set(a.edges,[b.dir,{entrance:b.entrance,exits:[b.exit,
b.exit+1]}]);a.wall&&WALLS$$module$js$maze$cave.add(a.tile);128!=a.tile&&a.fixed&&FIXED_TILES$$module$js$maze$cave.set(a.tile,a)}function detectScreenSet$$module$js$maze$cave(a){const b=[];a=new Set([].concat(...a.screens));for(const c of ALL_SCREENS$$module$js$maze$cave)for(const d of c)if(128!==d.tile&&a.has(d.tile)){b.push(...c);break}return b}
function surveyMap$$module$js$maze$cave(a){function b(b){b=a.entrances[b];for(const c of a.exits)if(20>Math.abs(c.x-b.x)&&20>Math.abs(c.y-b.y))return c.dest<<8|c.entrance;throw Error("Could not find exit for given entrance");}let c=0,d=0,e=0,f=0;const g=new Map,h=new Map,k=new Map,l=new Multiset$$module$js$util,m=new Set([...a.reachableTiles(!0).keys()].map((a)=>a>>>8));for(var n=0;n<a.entrances.length;n++){var q=a.entrances[n],p=STAIRS_BY_TILE$$module$js$maze$cave.get(a.screens[q.screen>>>4][q.screen&
15]<<8|q.tile);null!=p&&g.set(q.screen,{entrance:n,exit:b(n),dir:p})}for(n=0;n<a.height;n++)for(q=0,n||(q|=1),n===a.height-1&&(q|=4),p=0;p<a.width;p++){const w=n<<4|p;if(!m.has(w))continue;q&=-11;p||(q|=8);p===a.width-1&&(q|=2);var r=a.screens[n][p];l.add(r);if(128===r)continue;c++;let J=EDGES_BY_TILE$$module$js$maze$cave.get(r);if(null==J)throw Error(`Bad tile: ${hex$$module$js$rom$util(r)}`);var t=BITCOUNT$$module$js$maze$cave[J]+(g.has(w)?1:0);154===r&&(t=2);if(155===r||156==r||240==r||241==r)t=
1;1===t&&d++;2<t&&(e+=t-2);WALLS$$module$js$maze$cave.has(r)&&f++;t=FIXED_TILES$$module$js$maze$cave.get(r);DEAD_ENDS$$module$js$maze$cave.has(r)&&(J=0);for(const c of module$js$maze$maze.Dir.ALL)if(J&q&1<<c){r=null;for(var u=0;u<a.entrances.length;u++)if(a.entrances[u].screen===w&&matchesDir$$module$js$maze$cave(a.entrances[u].tile,c)){r=u;break}null!=r&&(u=b(r),h.set(w,{entrance:r,exit:u,dir:c}))}null!=t&&k.set(w,t)}return{size:c,deadEnds:d,branches:e,walls:f,stairs:g,edges:h,fixed:k,tiles:l}}
function matchesDir$$module$js$maze$cave(a,b){return 0===b?4>a>>>4:1===b?13<(a&15):2===b?12<a>>>4:3===b?2>(a&15):!1}function shuffleBridgeCave$$module$js$maze$cave(a,b,c,{attempts:d=100}={}){shuffleCave$$module$js$maze$cave(a,c,{attempts:d});shuffleCave$$module$js$maze$cave(b,c,{attempts:d})}function defaultCheck$$module$js$maze$cave(a){a=a.traverse();return 2<a.size&&a[Symbol.iterator]().next().value[1].size===a.size}
function shuffleCave$$module$js$maze$cave(a,b,c={}){function d(c){c.trim();console.log(`final:\n${c.show()}`);c.write(a,new Set);const d=new DefaultMap$$module$js$util(()=>[]),e=new Map;var f=new DefaultMap$$module$js$util(()=>[]);for(const [a,b]of c){var g=c.getSpec(a);g.fixed&&f.get(b).push(a);for(const {priority:b,dy:c,dx:e}of g.poi)d.get(b).push([((a&240)<<4)+c,((a&15)<<8)+e])}for(const [a,c]of n.fixed){g=b.shuffle(f.get(c.edges)).pop();if(null==g)throw Error("Unreplaced fixed screen");e.set(a,
g)}a.exits=[];f=[[],[],[],[]];g=[[],[],[],[]];for(var h of module$js$maze$maze.Dir.ALL){for(var k of module$js$maze$maze.Dir.allEdge(h,c.height,c.width)){var l=c.get(k);l&&(l=module$js$maze$maze.Scr.edge(l,h))&&7!=l&&(FIXED_TILES$$module$js$maze$cave.has(a.screens[k>>4][k&15])?g[h].push(k):f[h].push(k))}b.shuffle(f[h]);b.shuffle(g[h])}h=[[],[],[],[]];for(const [a,b]of c)k=STAIR_SCREENS$$module$js$maze$cave.get(b),null!=k&&h[k[0]].push([a,k[1]]);b.shuffle(h[module$js$maze$maze.Dir.UP]);b.shuffle(h[module$js$maze$maze.Dir.DOWN]);
for(const [b,d]of n.edges){k=(n.fixed.has(b)?g:f)[d.dir].pop();if(null==k)throw Error("missing edge");e.set(b,k);l=module$js$maze$maze.Scr.edge(c.get(k),d.dir);l=EDGE_TYPES$$module$js$maze$cave[l][d.dir];a.entrances[d.entrance]=Entrance$$module$js$rom$location.of({screen:k,coord:l.entrance});for(var m of l.exits)a.exits.push(Exit$$module$js$rom$location.of({screen:k,tile:m,dest:d.exit>>>8,entrance:d.exit&255}))}c=new Map;for(const [b,d]of n.stairs){m=h[d.dir].pop();if(null==m)throw Error("missing stair");
e.set(b,m[0]);f=a.entrances[d.entrance];g=f.tile&15;k=f.tile>>>4;f.screen=m[0];f.coord=m[1].entrance;c.set(b,[(f.tile>>>4)-k,(f.tile&15)-g]);for(var p of m[1].exits)a.exits.push(Exit$$module$js$rom$location.of({screen:m[0],tile:p,dest:d.exit>>>8,entrance:d.exit&255}))}p=new Map;m=a.monsterPlacer(b);for(const k of a.spawns)if(3!==k.type)if(k.isMonster())h=a.rom.objects[k.monsterId],h instanceof Monster$$module$js$rom$monster&&(f=m(h),null==f?(console.error(`no valid location for ${hex$$module$js$rom$util(h.id)} in ${hex$$module$js$rom$util(a.id)}`),
...
h.length||d.delete(a);break}}return!0}function e(a){const c=b.nextInt(a&1?l:k),d=a===module$js$maze$maze.Dir.RIGHT?k-1:a===module$js$maze$maze.Dir.DOWN?l-1:0;return a&1?c<<4|d:d<<4|c}let {attempts:f=50,check:g=defaultCheck$$module$js$maze$cave}=c;39===a.id&&(g=cycleCaveCheck$$module$js$maze$cave);75===a.id&&(c.allowTightCycles=!0);if(75===a.id||84===a.id)g=cycleCaveCheck$$module$js$maze$cave;const h=detectScreenSet$$module$js$maze$cave(a),k=Math.min(a.width+1,8),l=Math.min(a.height+1,16),m=seq$$module$js$rom$util(k*
l,(a)=>a%k|Math.floor(a/k)<<4),n=surveyMap$$module$js$maze$cave(a),q=n.size/k/l;let p;p=function(a){let {walls:f}=n;var h=new Set;for(const [b,c]of n.edges)for(;;){var p=e(c.dir);if(!h.has(p)){h.add(p);var r=n.fixed.get(b);null==r?a.setBorder(p,c.dir,6):(a.setBorder(p,c.dir,r.edges>>>module$js$maze$maze.Dir.shift(c.dir)&15),fixBorders$$module$js$maze$cave(a,p,r.edges),a.set(p,r.edges),r.wall&&f--);break}}for(const [c,d]of n.fixed)if(!n.edges.has(c))for(const c of b.ishuffle(m))if(!h.has(c)&&a.saveExcursion(()=>
{fixBorders$$module$js$maze$cave(a,c,d.edges);return a.trySet(c,d.edges)})){h.add(c);d.wall&&f--;break}p=[...n.stairs.values()];r=0;for(var x=0;10>r&&x<p.length;r++){const b=a.randomPos();!h.has(b)&&a.fill(b,{stair:p[x].dir})&&(h.add(b),console.log(`Added ${p[x].dir} stair at ${hex$$module$js$rom$util(b)}`),r=0,x++)}if(10<=r)return fail$$module$js$maze$cave("could not add all stairs");if(!a.fillAll({edge:1,fuzzy:1,shuffleOrder:!0,skipAlternates:!0}))return fail$$module$js$maze$cave("could not fill open");
console.log(`initial:\n${a.show()}`);if(!g(a))return fail$$module$js$maze$cave("check failed after initial setup");const G={skipAlternates:!0};for(const [c]of b.shuffle([...a])){if(a.density()<=q)break;!a.isFixed(c)&&a.saveExcursion(()=>a.setAndUpdate(c,0,G)&&g(a))}console.log(`percolated:\n${a.show()}`);if(!c.allowTightCycles)for(h=1;h<l;h++)for(p=1;p<k;p++)if(r=h<<4|p,isTightCycle$$module$js$maze$cave(a,r)){x=!1;for(const c of b.ishuffle(module$js$maze$maze.Dir.ALL)){const b=2>c?r-1:r-16;a.saveExcursion(()=>
a.replaceEdge(b,c,0)&&g(a))&&(x=!0)}if(!x)return fail$$module$js$maze$cave("failed to remove tight cycle")}h=new Set;p=[...a.alternates()];for(const c of[140])if(n.tiles.count(c)){r=b.shuffle(p.filter((a)=>a[3].tile===c));if(r.length<n.tiles.count(c))return fail$$module$js$maze$cave("could not add stair hallway");for(x=n.tiles.count(c)-1;0<=x;x--)a.replace(r[x][0],r[x][2]),h.add(r[x][0])}p=b.shuffle(p.filter((a)=>a[3].wall));for(r=0;r<f;r++){x=p.pop();if(null==x)return fail$$module$js$maze$cave(`could not add wall ${r}`);
h.has(x[0])?r--:(a.replace(x[0],x[2]),h.add(x[0]))}return d(a)};for(let a=0;a<f;a++){const a=new Maze$$module$js$maze$maze(b,l,k,h);if(p(a))return}throw Error("Could not shuffle");}function fail$$module$js$maze$cave(a){console.error(`Reroll: ${a}`);return!1}
function cycleCaveCheck$$module$js$maze$cave(a){const b=[...a].filter((b)=>{b=[...a.traverse({without:[b[0]]})];return b[0][1].size===b.length});if(!b.length)return!1;for(let c=0;c<b.length;c++)for(let d=0;d<c;d++){const e=[...a.traverse({without:[b[c][0],b[d][0]]})];if(e[0][1].size!==e.length)return!0}return!1}function isTightCycle$$module$js$maze$cave(a,b){const c=a.get(b-17)||0;a=a.get(b)||0;return!!(c&3840&&c&240&&a&61440&&a&15)}
function fixBorders$$module$js$maze$cave(a,b,c){try{for(const d of module$js$maze$maze.Dir.ALL)a.inBounds(module$js$maze$maze.Pos.plus(b,d))||7!==(c>>module$js$maze$maze.Dir.shift(d)&7)||a.setBorder(b,d,7)}catch(d){}}var module$js$maze$cave={};module$js$maze$cave.shuffleBridgeCave=shuffleBridgeCave$$module$js$maze$cave;module$js$maze$cave.shuffleCave=shuffleCave$$module$js$maze$cave;function shuffleGoa1$$module$js$maze$goa(a,b,c=1500){extendGoaScreens$$module$js$maze$goa(a);const d=a.locations.goaFortressKelbesque;var e=d.width;const f=d.height,g=[Spec$$module$js$maze$maze(0,128," "),Spec$$module$js$maze$maze(17,224,"\u2514","flag",31,46,61),Spec$$module$js$maze$maze(257,228,"\u2502","flag",1194411),Spec$$module$js$maze$maze(272,226,"\u250c","flag",157,174,191),Spec$$module$js$maze$maze(4097,225,"\u2518","flag",21,38,55),Spec$$module$js$maze$maze(4112,234,"\u2500",93,110,127),
Spec$$module$js$maze$maze(4113,231,"\u2534","flag",21,622,61,127),Spec$$module$js$maze$maze(4352,227,"\u2510","flag",91,106,121),Spec$$module$js$maze$maze(4368,232,"\u252c","flag",93,1710,121,191),Spec$$module$js$maze$maze(4369,230,"\u253c","flag",21,9902,61,121,191),Spec$$module$js$maze$maze(65553,224,"\u2514","fixed",46,61),Spec$$module$js$maze$maze(65793,228,"\u2502","fixed",4779),Spec$$module$js$maze$maze(65808,226,"\u250c","fixed",174,191),Spec$$module$js$maze$maze(69633,225,"\u2518","fixed",
21,38),Spec$$module$js$maze$maze(69649,231,"\u2534","fixed",622,127),Spec$$module$js$maze$maze(69888,227,"\u2510","fixed",106,121),Spec$$module$js$maze$maze(69904,232,"\u252c","fixed",93,1710),Spec$$module$js$maze$maze(69905,230,"\u253c","fixed",21,9902,191),Spec$$module$js$maze$maze(131329,229,"\u250a","fixed","flag",5019),Spec$$module$js$maze$maze(196865,229,"\u250a","fixed",57),Spec$$module$js$maze$maze(61681,113,"\u257d","fixed",42),Spec$$module$js$maze$maze(240,128,"\u2588","fixed"),Spec$$module$js$maze$maze(61440,
128,"\u2588","fixed"),Spec$$module$js$maze$maze(65520,115,"\u2550","fixed"),Spec$$module$js$maze$maze(61951,114,"\u2564","fixed"),Spec$$module$js$maze$maze(4080,128,"\u2554","fixed"),Spec$$module$js$maze$maze(65280,128,"\u2557","fixed"),Spec$$module$js$maze$maze(255,128,"\u255a","fixed"),Spec$$module$js$maze$maze(61455,128,"\u255d","fixed")];a:for(let m=0;m<c;m++){var h=function(a,b=65536){const c=n.get(a);if(null==c)throw Error(`Cannot flag empty screen ${hex$$module$js$rom$util(a)}`);n.replace(a,
c|b);if(k())return!0;n.replace(a,c);return!1},k=function(){const a=n.traverse(),b=a.get(r);return!b||!t.filter((a)=>b.has(a)).length||b.size<.8*a.size?!1:!0},l=function(a,b){n.set(a,b,{force:!0})};const n=new Maze$$module$js$maze$maze(b,f,e,g),q=f-1<<4|b.nextInt(e),p=b.nextInt(e),r=q<<8|2,t=[p+32<<8|1,p+32<<8|3];l(q,61681);l(q-1,240);l(q+1,61440);l(p,65520);l(p-1,4080);l(p+1,65280);l(p+16,61951);l(p+15,255);l(p+17,61455);console.log(`initial\n${n.show()}`);if(!n.connect(q,0,p+16,2))continue a;if(257===
n.get(p+32)||257===n.get(q-16))continue a;console.log("first",n.show());for(l=0;10>l&&.65>n.density();l++)n.addLoop()&&(l=0);console.log(`loop\n${n.show()}`);if(.45>n.density())continue a;if(!k())continue a;for(const [a,c]of n)if(257===c&&257===n.get(a+16)&&(l=b.shuffle([0,16]),!h(a+l[0],131072)&&!h(a+l[1],131072)))continue a;for(const [a,c]of b.shuffle([...n.alternates()]))h(a,c);n.fillAll({edge:0});d.moveScreen(6,p);d.moveScreen(131,q);n.write(d,new Set);b=d.monsterPlacer(b);for(const f of d.spawns)f.isMonster()&&
(c=a.objects[f.monsterId],c instanceof Monster$$module$js$rom$monster&&(e=b(c),null==e?(console.error(`no valid location for ${hex$$module$js$rom$util(c.id)} in ${hex$$module$js$rom$util(d.id)}`),f.used=!1):(f.screen=e>>>8,f.tile=e&255)));console.log(`success after ${m} attempts`);console.log(n.show());return}throw Error(`unable to shuffle goa1 after ${c} attempts`);}
function extendGoaScreens$$module$js$maze$goa(a){for(var b of[140,164,168]){const c=a.tileset(b);c.alternates[25]=25;c.alternates[27]=27}a.swapMetatiles([164,140],[43,[25,197],-199],[56,[27,197],-197]);a.swapMetatiles([168],[[23,84],-26],[[24,88],-28]);a.swapMetatiles([136],[25,-198],[27,-198]);b=[[25,25],[27,27]];write$$module$js$maze$maze(a.screens[224].tiles,97,b);write$$module$js$maze$maze(a.screens[225].tiles,109,b);write$$module$js$maze$maze(a.screens[226].tiles,145,b);write$$module$js$maze$maze(a.screens[227].tiles,
157,b);write$$module$js$maze$maze(a.screens[228].tiles,65,b);write$$module$js$maze$maze(a.screens[228].tiles,141,b);write$$module$js$maze$maze(a.screens[229].tiles,97,b);write$$module$js$maze$maze(a.screens[229].tiles,173,b);write$$module$js$maze$maze(a.screens[230].tiles,13,b);write$$module$js$maze$maze(a.screens[230].tiles,209,b);write$$module$js$maze$maze(a.screens[231].tiles,1,b);write$$module$js$maze$maze(a.screens[231].tiles,13,b);write$$module$js$maze$maze(a.screens[232].tiles,209,b);write$$module$js$maze$maze(a.screens[232].tiles,
221,b);a.locations[169].flags.push(Flag$$module$js$rom$location.of({screen:16,flag:751}),Flag$$module$js$rom$location.of({screen:32,flag:751}),Flag$$module$js$rom$location.of({screen:33,flag:751}),Flag$$module$js$rom$location.of({screen:36,flag:751}),Flag$$module$js$rom$location.of({screen:37,flag:751}),Flag$$module$js$rom$location.of({screen:48,flag:751}),Flag$$module$js$rom$location.of({screen:49,flag:751}),Flag$$module$js$rom$location.of({screen:51,flag:751}),Flag$$module$js$rom$location.of({screen:52,
flag:751}),Flag$$module$js$rom$location.of({screen:65,flag:751}),Flag$$module$js$rom$location.of({screen:84,flag:751}),Flag$$module$js$rom$location.of({screen:98,flag:751}),Flag$$module$js$rom$location.of({screen:100,flag:751}),Flag$$module$js$rom$location.of({screen:114,flag:751}),Flag$$module$js$rom$location.of({screen:116,flag:512}))}var module$js$maze$goa={};module$js$maze$goa.shuffleGoa1=shuffleGoa1$$module$js$maze$goa;module$js$maze$goa.extendGoaScreens=extendGoaScreens$$module$js$maze$goa;function shuffleSwamp$$module$js$maze$swamp(a,b,c=100){extendSwampScreens$$module$js$maze$swamp(a);const d=a.locations.swamp,e=d.width,f=d.height,g=[SCR_U$$module$js$maze$swamp,SCR_D$$module$js$maze$swamp,SCR_UD$$module$js$maze$swamp,SCR_DR$$module$js$maze$swamp,SCR_URD$$module$js$maze$swamp,SCR_LR$$module$js$maze$swamp],h=[117,118,119,120,121,122,123,125,126],k=[Spec$$module$js$maze$maze(0,127," "),Spec$$module$js$maze$maze(1,-1,"\u2575",1),Spec$$module$js$maze$maze(16,118,"\u2576",13),Spec$$module$js$maze$maze(17,
121,"\u2514",29),Spec$$module$js$maze$maze(256,-2,"\u2577",9),Spec$$module$js$maze$maze(257,-3,"\u2502",25),Spec$$module$js$maze$maze(272,-4,"\u250c",157),Spec$$module$js$maze$maze(273,-5,"\u251c",413),Spec$$module$js$maze$maze(4096,123,"\u2574",5),Spec$$module$js$maze$maze(4097,117,"\u2518",21),Spec$$module$js$maze$maze(4112,-6,"\u2500",93),Spec$$module$js$maze$maze(4113,125,"\u2534",349),Spec$$module$js$maze$maze(4352,126,"\u2510",89),Spec$$module$js$maze$maze(4353,120,"\u2524",345),Spec$$module$js$maze$maze(4368,
122,"\u252c",1437),Spec$$module$js$maze$maze(4369,119,"\u253c",5533),Spec$$module$js$maze$maze(61936,124,"\u2564","fixed",9),Spec$$module$js$maze$maze(61440,127,"\u255d","fixed"),Spec$$module$js$maze$maze(240,127,"\u255a","fixed"),Spec$$module$js$maze$maze(65552,118,"\u2576","fixed","flag",13),Spec$$module$js$maze$maze(65792,-2,"\u2577","fixed","flag",9),Spec$$module$js$maze$maze(65808,-4,"\u250c","fixed","flag",157),Spec$$module$js$maze$maze(69632,123,"\u2574","fixed","flag",5),Spec$$module$js$maze$maze(69648,
-6,"\u2500","fixed","flag",93),Spec$$module$js$maze$maze(69888,126,"\u2510","fixed","flag",89),Spec$$module$js$maze$maze(69904,122,"\u252c","fixed","flag",1437)];for(let l=0;l<c;l){const c=new Maze$$module$js$maze$maze(b,f,e,k,g);if(tryShuffleSwamp$$module$js$maze$swamp(a,b,d,c,h))return}console.error(`Failed to shuhffle swamp after ${c} attempts.`)}
function tryShuffleSwamp$$module$js$maze$swamp(a,b,c,d,e){function f(){const a=d.traverse(),b=a.get(m);return b&&b.size===a.size||!1}const g=d.width,h=d.height,[k,l]=(()=>{let a,c;do a=b.nextInt(g),c=b.nextInt(h);while(2>a||2>c);return[a,c<<4]})();d.setBorder(l,module$js$maze$maze.Dir.LEFT,1);d.set(k,61936,{force:!0});d.set(k-1,240,{force:!0});d.set(k+1,61440,{force:!0});d.fillAll({edge:1});const m=l<<8|16;var n=[...d].map((a)=>a[0]);for(var q=Math.floor(.6*g*h);q;q--){const a=b.pick(n),c=b.pick(module$js$maze$maze.Dir.ALL),
e=module$js$maze$maze.Pos.plus(a,c);!d.isFixed(a)&&!d.isFixed(e)&&d.get(a)&module$js$maze$maze.Dir.edgeMask(c)?(d.saveExcursion(()=>{if(!d.replaceEdge(a,c,0))return!1;var b;(b=d.get(a)&&d.get(e)&&f())||(console.log(`failed\n${d.show()}`),b=!1);return b}),console.log(d.show())):q++}if(!d.consolidate(e,f,a))return!1;const [p,r]=b.pick([...d.alternates()]);if(65536!=r)throw Error(`unexpected alt: ${hex$$module$js$rom$util(r)}`);d.replace(p,d.get(p)|r);c.moveScreen(48,l);c.moveScreen(4,k);d.write(c,new Set);
console.log(d.show());e=[];n=[];for(const [a,b]of d)a!==k&&a!==p&&(1!==b&&16!==b&&256!==b&&4096!==b||e.push(a),17!==b&&272!==b&&4352!==b&&4097!==b||n.push(a));var t=a.screens[c.screens[p>>4][p&15]].tiles;q=0;for(let a=0;240>a;a++)if(3===t[a]){q=a;break}c.entrances[1].screen=p;c.entrances[1].tile=q+17;for(t=0;2>t;t++)c.exits[5+t].screen=p,c.exits[5+t].tile=q+t;e=b.pick(e.length?e:n);c.spawns[1].screen=e;e=c.monsterPlacer(b);for(const b of c.spawns)b.isMonster()&&(n=a.objects[b.monsterId],n instanceof
Monster$$module$js$rom$monster&&(q=e(n),null==q?(console.error(`no valid location for ${hex$$module$js$rom$util(n.id)} in ${hex$$module$js$rom$util(c.id)}`),b.used=!1):(b.screen=q>>>8,b.tile=q&255)));return!0}
const SCR_U$$module$js$maze$swamp=readScreen$$module$js$maze$maze("c8 c8 c8 c8 cf f6 c7 ad c4 b7 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f6 b8 b9 c3 b7 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f6 b7 b8 ad ad d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 c2 c3 b7 b8 d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 b6 c2 b7 b7 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 ad ad b9 b7 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 ad ad ad ad d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 b9 b8 ad ad d2 e2 c8 c8 c8 c8\n     c8 c8 c8 c8 e3 f6 c3 c3 b8 b6 d2 c8 c8 c8 c8 c8\n     c8 c8 c8 c8 c8 e3 fd ad ad fc e2 c8 c8 c8 c8 c8\n     c8 c8 c8 c8 c8 c8 ff fb fb fa c8 c8 c8 c8 c8 c8\n     c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n     c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n     c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n     c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8"),SCR_D$$module$js$maze$swamp=
readScreen$$module$js$maze$maze("c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n     c8 c8 c8 c8 c8 c8 cd c9 c9 ca c8 c8 c8 c8 c8 c8\n     c8 c8 c8 c8 c8 cd eb a0 a0 cb ca c8 c8 c8 c8 c8\n     c8 c8 c8 c8 cf a0 f9 f5 f7 f8 cb cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf a0 ed 08 09 a0 a0 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf db ee 0c 0b ef a0 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d0 d1 03 03 d8 db cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f6 c7 ad ad ae d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 ad b9 b7 b7 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 c2 c3 c3 b7 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f6 c5 c3 c3 b7 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 b6 c2 c3 c3 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f6 b8 b6 b6 b6 d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f6 b7 b7 b7 b7 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f6 b7 b7 b8 b6 d2 cc c8 c8 c8 c8"),
SCR_UD$$module$js$maze$swamp=readScreen$$module$js$maze$maze("c8 c8 c8 c8 cf d3 b6 b6 c6 b6 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 b6 c3 c7 b6 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f5 c3 c7 b6 b6 d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 b6 b6 c6 c5 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d9 b6 c6 c3 c7 d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f5 c3 c3 c3 c3 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d9 ad c2 c3 c3 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d9 c4 c5 c3 c3 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f5 b7 b7 b8 b6 d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d9 c2 b8 b6 b6 d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d9 b6 c2 b7 b7 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d9 b6 b6 b6 b6 d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f6 b7 b7 b8 b6 d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 b9 b7 b7 b7 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f6 b7 b7 c7 b6 d2 cc c8 c8 c8 c8"),
SCR_DR$$module$js$maze$swamp=readScreen$$module$js$maze$maze("c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n     c8 c8 c8 c8 c8 c8 cd c9 c9 c9 c9 c9 c9 c9 c9 c9\n     c8 c8 c8 c8 c8 cd a0 a0 a0 e8 04 a0 e8 a0 a0 e4\n     c8 c8 c8 c8 cf f8 a0 f0 f1 f5 f5 f7 e9 f4 f7 e5\n     c8 c8 c8 c8 cf f6 f7 f8 f2 ea 06 aa e9 f0 f1 e6\n     c8 c8 c8 c8 cf a0 dd e0 f3 e0 07 0c ea db f3 e7\n     c8 c8 c8 c8 cf db d5 d0 d1 d1 03 03 d0 d1 da da\n     c8 c8 c8 c8 cf d5 af c4 c4 ad ad ad ad ad c4 ad\n     c8 c8 c8 c8 cf d3 b9 c3 c3 b8 ad ad ad c2 b7 b8\n     c8 c8 c8 c8 cf f6 c3 c3 c3 c3 b8 ad ad ad ad ad\n     c8 c8 c8 c8 cf f6 c7 ad c2 c3 c7 fc fb fb fb fb\n     c8 c8 c8 c8 cf d3 ad ad ad ad d6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 b9 b8 ad b9 f6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf f6 c7 ad b9 c7 d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 b6 b9 c3 b8 d2 cc c8 c8 c8 c8"),
SCR_URD$$module$js$maze$swamp=readScreen$$module$js$maze$maze("c8 c8 c8 c8 cf d3 c4 c3 c3 c3 f7 f8 ca c8 c8 c8\n     c8 c8 c8 c8 cf f5 c3 c3 c3 c3 f7 f7 a0 ca c9 c9\n     c8 c8 c8 c8 cf f6 c3 c3 b8 b6 d2 cf cf e8 e4 a0\n     c8 c8 c8 c8 cf f5 b7 c3 b7 b8 d2 f0 f1 e9 e5 cf\n     c8 c8 c8 c8 cf d3 c2 b8 c2 b8 d8 db cf ea e6 cf\n     c8 c8 c8 c8 cf d3 ad ad ad ad ae d4 f3 dd e7 cf\n     c8 c8 c8 c8 cf d3 ad ad ad ad ad ae d0 d1 d0 d1\n     c8 c8 c8 c8 cf d3 c2 c3 c3 b7 b8 ad ad ad ad ad\n     c8 c8 c8 c8 cf d3 ad ad c2 b7 b7 b7 b8 c4 ad ad\n     c8 c8 c8 c8 cf d3 ad ad b6 b9 b7 b7 b7 b7 b8 ad\n     c8 c8 c8 c8 cf d3 ad c4 c3 b7 b8 fc fb fb fb fb\n     c8 c8 c8 c8 cf d3 b6 ad ad ad d6 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 ad ad ad ad d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 c4 c3 b7 b8 d2 cc c8 c8 c8 c8\n     c8 c8 c8 c8 cf d3 b6 b9 b7 b7 f6 cc c8 c8 c8 c8"),
SCR_LR$$module$js$maze$swamp=readScreen$$module$js$maze$maze("c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n     c9 c9 c9 c9 c9 c9 c9 c9 c9 c9 c9 c9 c9 c9 c9 c9\n     a0 e4 e8 eb e4 a0 a0 a0 eb eb e8 f0 f1 a0 e4 a0\n     a0 e5 e9 f9 f5 f6 f6 f7 ec f9 f7 f8 f2 a0 e5 a0\n     a0 e6 f0 f1 e6 e0 08 09 ed de ea de f2 a0 e6 a0\n     db e7 db f3 e7 e1 0c 0b dd df e0 df f3 db e7 e0\n     d0 d1 da da d0 d1 03 03 d0 d1 d0 d1 da da da da\n     ad c4 ad ad ad ad ad ad ad ad ad ad ad ad ad ad\n     c2 c5 b8 c6 c4 c4 b9 c7 c4 c5 c5 c7 ad ad ad ad\n     ad ad ad ad c2 c3 c3 c3 c3 c3 c7 ad ad ad ad ad\n     fb fb fb fb fb fb fb fb fb fb fb fb fb fb fb fb\n     c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n     c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n     c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n     c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8");
function extendSwampScreens$$module$js$maze$swamp(a){a.swapMetatiles([160],[[3,172],-219],[[4,170],-229],[[5,170],-230],[[6,170],-231],[[7,170],-232],[[8,170],-241],[[9,170],-242],[[10,170],-243],[[11,170],-244],[[12,170],-221],[[13,170],-222]);write$$module$js$maze$maze(a.screens[127].tiles,0,[[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[210,204],[210,204],[210,204],[210,226],[226,200]]);write$$module$js$maze$maze(a.screens[118].tiles,76,[[8,9],[12,11],
[3,3]]);write$$module$js$maze$maze(a.screens[122].tiles,37,[[,,4],[8,9,5],[,10,6],[,11,7],[,3,3]]);write$$module$js$maze$maze(a.screens[123].tiles,36,[[4],[],[6],[7,13],[3,3]]);write$$module$js$maze$maze(a.screens[126].tiles,71,[[8,9],[12,11],[3,3]])}var module$js$maze$swamp={};module$js$maze$swamp.shuffleSwamp=shuffleSwamp$$module$js$maze$swamp;module$js$maze$swamp.extendSwampScreens=extendSwampScreens$$module$js$maze$swamp;function shuffleTrades$$module$js$pass$shuffletrades(a,b,c){if(b.randomizeTrades()){var d=[[a.items[37],0],[a.items[40],18],[a.items[53],0],[a.items[59],0],[a.items[60],0],[a.items[61],0]];b=[];for(const [a,c]of d){if(!a.tradeIn)throw Error(`Expected trade-in for ${a.id}`);b.push(a.tradeIn.slice(c,c+6))}c.shuffle(b);for(const [c,f]of d)d=b.pop(),c.tradeIn.splice(f,6,...d),35===d[0]&&(a.prg[251061]=c.id-28);a.npcs[195].localDialogs.get(-1)[0].condition=512|c.nextInt(4);c=2*c.nextInt(4)+517;for(const b of a.npcs[95].localDialogs.values())for(a=
2;a<b.length;a++)if(3===b[a].message.action){b[a-2].condition=~(c+1);b[a-1].condition=~c;break}}}function buildTradeInMap$$module$js$pass$shuffletrades(a){const b=new Map;for(const c of a.items)if(c.tradeIn)for(a=0;a<c.tradeIn.length;a+=6)b.set(c.tradeIn[a],c.id);return b}var module$js$pass$shuffletrades={};module$js$pass$shuffletrades.shuffleTrades=shuffleTrades$$module$js$pass$shuffletrades;module$js$pass$shuffletrades.buildTradeInMap=buildTradeInMap$$module$js$pass$shuffletrades;function fixDialog$$module$js$pass$fixdialog(a){function b(a){d(a,"teach you the magic of","bestow upon you the")}function c(b){b=a.items[a.itemGets[b].itemId];return`[${hex$$module$js$rom$util(b.id)}:${b.messageName}]`}function d(b,c,d){const [e,f]=b.split(":").map((a)=>parseInt(a,16));b=a.messages.parts[e][f];b.text=b.text.replace(c,d)}var e=buildTradeInMap$$module$js$pass$shuffletrades(a),f=a.npcs[94];65>f.data[0]&&b("00:1b");d("00:1b","[41:Refresh]",c(f.data[0]));if(f=e.get(130))d("02:01","an unusual statue",
vague$$module$js$pass$fixdialog(f)),d("02:02","a statue",`the ${commonNoun$$module$js$pass$fixdialog(f)}`);d("02:02","[29:Gas Mask]",c(a.prg[251902]));f=a.prg[223220];65>f&&b("03:01");d("03:01","[43:Telepathy]",c(f));f=a.npcs[95];var g=findTornelTradeIn$$module$js$pass$fixdialog(f);d("03:01","[06:Tornado Bracelet]",c(g));d("05:0a","[06:Tornado Bracelet]",c(g));d("05:0a","[44:Teleport]",c(f.data[0]));f=e.get(100);null!=f&&(d("09:01","[35:Fog Lamp]",c(f)),d("09:04","[35:Fog Lamp]",c(f)),d("09:05","[35:Fog Lamp]",
c(f)),d("09:06","lamp",commonNoun$$module$js$pass$fixdialog(f)));d("0a:0c","[28:Flute of Lime]",c(a.npcs[56].data[0]));f=a.prg[250361];65>f&&b("0b:01");d("0b:01","[45:Recover]",c(f));f=a.prg[251609];65>f&&(d("0b:01","teach you\n the magic of","give you\n "),b("1d:12"));d("0b:01","[46:Barrier]",c(f));d("1d:12","[46:Barrier]",c(f));f=function(...b){for(const c of b){b=a.locations[c];for(const c of b.spawns)if(c.isChest()&&72>c.id&&a.items[a.itemGets[c.id].itemId].unique)return c.id}return-1}(68,69,
70,71,72,73,74,75,76,77,78,79);0<=f?d("0d:00","[35:Fog Lamp]",c(f)):d("0d:00","that a [35:Fog Lamp] was","there was treasure");f=a.npcs[195].localDialogs.get(-1)[0].condition&255;g=a.prg[250679];d("0e:03","[02:Sword of Water]",c(f));d("0e:03","[09:Ball of Water]",c(g));d("10:0c","that's","is");d("10:0c",/, is in the\+lighthouse/,"");f=e.get(35);null!=f&&(d("12:05","[3c:Kirisa Plant]",c(f)),d("12:10","the plant",`the ${commonNoun$$module$js$pass$fixdialog(f)}`),d("12:10","[3c:Kirisa Plant]",c(f)),
...
e=a.prg[251477];65>e&&b("1c:10");d("1c:10","[42:Paralysis]",c(e));d("20:06","Statue of Gold",c(58))}function findTornelTradeIn$$module$js$pass$fixdialog(a){for(const b of a.localDialogs.values())for(a=2;a<b.length;a++)if(3===b[a].message.action)return~b[a-2].condition&255;return 6}
...
function commonNoun$$module$js$pass$fixdialog(a){switch(a){case 37:return"statue";case 40:return"instrument";case 53:return"lamp";case 59:return"pendant";case 60:return"plant";case 61:return"statue"}fail$$module$js$assert();return"item"}var module$js$pass$fixdialog={};module$js$pass$fixdialog.fixDialog=fixDialog$$module$js$pass$fixdialog;function fixReverseWalls$$module$js$pass$fixreversewalls(a){for(const b in[4,5,8,9])a.tileEffects[9].effects[b]=24,a.tileEffects[2].effects[b]=24}var module$js$pass$fixreversewalls={};module$js$pass$fixreversewalls.fixReverseWalls=fixReverseWalls$$module$js$pass$fixreversewalls;function shuffleMazes$$module$js$pass$shufflemazes(a,b){shuffleSwamp$$module$js$maze$swamp(a,b);shuffleGoa1$$module$js$maze$goa(a,b);for(const c of SHUFFLED_CAVES$$module$js$pass$shufflemazes)shuffleCave$$module$js$maze$cave(a.locations[c],b)}const SHUFFLED_CAVES$$module$js$pass$shufflemazes=[4,5,6,7,8,9,10,12,14,16,17,34,35,36,37,38,39,42,43,44,45,46,49,51,52,53,56,57,68,69,70,72,73,74,75,76,77,78,79,84,85,112,125,127,128,129,130,131,133,134,135,143,146,149,176,177,178,179];
var module$js$pass$shufflemazes={};module$js$pass$shufflemazes.shuffleMazes=shuffleMazes$$module$js$pass$shufflemazes;class TileEffects$$module$js$rom$tileeffects extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.base=b<<8&8191|73728;this.effects=tuple$$module$js$rom$util(a.prg,this.base,256)}write(a){for(let b=0;256>b;b++)a.rom[this.base+b]=this.effects[b]}}TileEffects$$module$js$rom$tileeffects.PIT=1;TileEffects$$module$js$rom$tileeffects.NO_WALK=2;TileEffects$$module$js$rom$tileeffects.IMPASSIBLE=4;TileEffects$$module$js$rom$tileeffects.ALTERNATIVE=8;
...
16);return`[${"{"===b?6:7}][${a}]${d}`});for(var q of f.get(n.mid())||[]){const {str:a,bytes:b}=q;l=l.replace(new RegExp(a+"( [ &0-9]|.|$)","g"),(a,c)=>{if(c&&!PUNCTUATION$$module$js$rom$messages[c])return a;" "===c&&(c="");return b.map((a)=>`[${a}]`).join("")+c})}m=["[01]"];d=[];d.push(1);for(let a=0,b=l.length;a<b;a++)if(e=l[a],e===Messages$$module$js$rom$messages.CONTINUED)d.push(3,1),m.push("[03][01]"),"\n"===l[a+1]&&a++;else if("\n"===e)d.push(2)," "===l[a+1]&&a++,m.push("[02]");else if("["===
...
a-c)}n=yield Promise.all(k.map((a)=>Promise.all(a)));q=163840;for(f=0;f<n.length;f++){d=[];for(k=0;k<n[f].length;k++)writeLittleEndian$$module$js$rom$util(d,2*k,n[f][k]);a.rom.subarray(q,q+d.length).set(d);writeLittleEndian$$module$js$rom$util(a.rom,164898+2*f,q-131072);q+=d.length}for(n=0;n<b.banks.length;n++)a.rom[164862+n]=b.banks[n];yield Promise.all([])})}}Messages$$module$js$rom$messages.CONTINUED="#";
...
hex$$module$js$rom$util).join(" ")}`);a.reject(Error(`Could not find sufficient chunk in ${hex$$module$js$rom$util(a.startPage)}..${hex$$module$js$rom$util(a.endPage)} to write ${a.name}: ${a.data}`))}}var module$js$rom$writer={};module$js$rom$writer.Writer=Writer$$module$js$rom$writer;class Rom$$module$js$rom{constructor(a){this.prg=a.subarray(16,262160);this.chr=a.subarray(262160);this.shopCount=Rom$$module$js$rom.SHOP_COUNT.get(a);this.scalingLevels=Rom$$module$js$rom.SCALING_LEVELS.get(a);this.uniqueItemTableAddress=Rom$$module$js$rom.UNIQUE_ITEM_TABLE.get(a);this.shopDataTablesAddress=Rom$$module$js$rom.SHOP_DATA_TABLES.get(a);this.telepathyTablesAddress=Rom$$module$js$rom.TELEPATHY_TABLES.get(a);this.omitItemGetDataSuffix=Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX.get(a);
this.omitLocalDialogSuffix=Rom$$module$js$rom.OMIT_LOCAL_DIALOG_SUFFIX.get(a);for(const a of ADJUSTMENTS$$module$js$rom){const [b,d,e]=a;this.prg[b]===d&&(this.prg[b]=e)}this.screens=seq$$module$js$rom$util(259,(a)=>new Screen$$module$js$rom$screen(this,a));this.tilesets=seq$$module$js$rom$util(12,(a)=>new Tileset$$module$js$rom$tileset(this,a<<2|128));this.tileEffects=seq$$module$js$rom$util(11,(a)=>new TileEffects$$module$js$rom$tileeffects(this,a+179));this.triggers=seq$$module$js$rom$util(67,
(a)=>new Trigger$$module$js$rom$trigger(this,128|a));this.patterns=seq$$module$js$rom$util(this.chr.length>>4,(a)=>new Pattern$$module$js$rom$pattern(this,a));this.palettes=seq$$module$js$rom$util(256,(a)=>new Palette$$module$js$rom$palette(this,a));this.locations=new LocationsClass$$module$js$rom$locations(this);this.tileAnimations=seq$$module$js$rom$util(4,(a)=>new TileAnimation$$module$js$rom$tileanimation(this,a));this.hitboxes=seq$$module$js$rom$util(24,(a)=>new Hitbox$$module$js$rom$hitbox(this,
a));this.objects=new ObjectsClass$$module$js$rom$objects(this);this.adHocSpawns=seq$$module$js$rom$util(96,(a)=>new AdHocSpawn$$module$js$rom$adhocspawn(this,a));this.metasprites=seq$$module$js$rom$util(256,(a)=>new Metasprite$$module$js$rom$metasprite(this,a));this.messages=new Messages$$module$js$rom$messages(this);this.telepathy=new Telepathy$$module$js$rom$telepathy(this);this.itemGets=seq$$module$js$rom$util(113,(a)=>new ItemGet$$module$js$rom$itemget(this,a));this.items=seq$$module$js$rom$util(73,
(a)=>new Item$$module$js$rom$item(this,a));this.shops=seq$$module$js$rom$util(44,(a)=>new Shop$$module$js$rom$shop(this,a));this.npcs=seq$$module$js$rom$util(205,(a)=>new Npc$$module$js$rom$npc(this,a));this.bossKills=seq$$module$js$rom$util(14,(a)=>new BossKill$$module$js$rom$bosskill(this,a));this.bosses=new Bosses$$module$js$rom$bosses(this);this.wildWarp=new WildWarp$$module$js$rom$wildwarp(this)}trigger(a){if(128>a||255<a)throw Error(`Bad trigger id $${hex$$module$js$rom$util(a)}`);return this.triggers[a&
127]}tileset(a){if(128>a||172<a||a&3)throw Error(`Bad tileset id $${hex$$module$js$rom$util(a)}`);return this.tilesets[(a&127)>>>2]}get projectiles(){const a=new Set;for(const b of this.objects.filter((a)=>a instanceof Monster$$module$js$rom$monster))b.child&&a.add(this.objects[this.adHocSpawns[b.child].objectId]);return[...a].sort((a,c)=>a.id-c.id)}get monsterGraphics(){const a={};for(const b of this.locations)if(b.used&&b.hasSpawns)for(const c of b.spawns)if(!(c.data[2]&7)){const d=c.data[2]&128?
1:0,e=hex$$module$js$rom$util(c.data[3]+80);(a[e]=a[e]||{})[`${d}:${b.spritePatterns[d].toString(16)}:${b.spritePalettes[d].toString(16)}`]={pal:b.spritePalettes[d],pat:b.spritePatterns[d],slot:d}}return a}get locationMonsters(){const a={};for(const b of this.locations){if(!b.used||!b.hasSpawns)continue;const c=a["$"+hex$$module$js$rom$util(b.id)]={};for(const a of b.spawns)if(!(a.data[2]&7)){const b=a.data[2]&128?1:0,d=a.data[3]+80;c[`${b}:${d.toString(16)}`]=(c[`${b}:${d.toString(16)}`]||0)+1}}return a}writeData(){const a=
this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){Rom$$module$js$rom.SHOP_COUNT.set(a.prg,a.shopCount);Rom$$module$js$rom.SCALING_LEVELS.set(a.prg,a.scalingLevels);Rom$$module$js$rom.UNIQUE_ITEM_TABLE.set(a.prg,a.uniqueItemTableAddress);Rom$$module$js$rom.SHOP_DATA_TABLES.set(a.prg,a.shopDataTablesAddress);Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX.set(a.prg,a.omitItemGetDataSuffix);Rom$$module$js$rom.OMIT_LOCAL_DIALOG_SUFFIX.set(a.prg,a.omitLocalDialogSuffix);const b=new Writer$$module$js$rom$writer(a.prg,
a.chr);b.alloc(83192,97792);b.alloc(103417,109568);b.alloc(110080,113920);b.alloc(116602,117085);b.alloc(117477,121076);b.alloc(122342,122981);b.alloc(123392,123840);b.alloc(135450,136296);b.alloc(172032,195584);a.telepathyTablesAddress?b.alloc(121076,121600):b.alloc(121420,121600);const c=[],d=(a)=>{for(const d of a)c.push(d.write(b))};d(a.locations);d(a.objects);d(a.hitboxes);d(a.triggers);d(a.npcs);d(a.tilesets);d(a.tileEffects);d(a.screens);d(a.adHocSpawns);d(a.itemGets);d(a.items);d(a.shops);
d(a.bossKills);d(a.patterns);a.wildWarp.write(b);c.push(a.telepathy.write(b));c.push(a.messages.write(b));c.push(b.commit());yield Promise.all(c).then(()=>{})})}analyzeTiles(){}disjointTilesets(){var a=[];for(var b of this.locations){if(!b.used)continue;var c=b.tileset;const d=b.extended?256:0;for(const e of b.screens)for(const b of e)(a[b+d]||(a[b+d]=new Set)).add(c)}b=seq$$module$js$rom$util(256,()=>new UnionFind$$module$js$unionfind);for(c=0;c<a.length;c++)if(a[c])for(var d of this.screens[c].allTilesSet())b[d].union([...a[c]]);
...
for(var l of this.locations)if(l.used&&a.has(l.tileset)){c.add(l.tileEffects);for(var m of l.allScreens())g.add(m)}for(var n of g)for(let a=0,b=n.tiles.length;a<b;a++)n.tiles[a]=d[n.tiles[a]];for(var q of a){d=this.tilesets[(q&127)>>>2];for(var p of b)for(l=0;l<p.length-1;l++){m=f(p[l]);n=f(p[l+1]);for(a=0;4>a;a++)d.tiles[a][m]=d.tiles[a][n];d.attrs[m]=d.attrs[n];if(32>n&&d.alternates[n]!==n){if(32<=m)throw Error(`Cannot unflag: ${q} ${m} ${n} ${d.alternates[n]}`);d.alternates[m]=d.alternates[n]}}for(var r of e){const [a,
b]=r;d.alternates[a]=b}}for(const a of c){q=this.tileEffects[a-179];for(const a of b)for(p=0;p<a.length-1;p++)r=f(a[p]),d=f(a[p+1]),q.effects[r]=q.effects[d];for(const a of e.keys())q.effects[a]|=8}}static load(a,b){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const c=yield pickFile$$module$js$rom(b);a&&(yield a(c));return new Rom$$module$js$rom(c)})}}Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX=module$js$rom$option.RomOption.bit(82624,0);
...
c.id,1))}for(const c of a.bosses)3!==c.kill&&13!==c.kill&&null!=c.kill&&null!=c.drop&&b(new BossDropSlot$$module$js$rom$slots(c.drop,c.kill));for(const [a,c]of hardcodedItems$$module$js$rom$slots)b(new HardcodedSlot$$module$js$rom$slots(this.rom.prg[a],a,c));extraSlots$$module$js$rom$slots.forEach(b);console.log("slots",c);this.slots=c}update(a){for(var b=0;b<a.length;b++)if(null!=a[b])for(var c of this.slots[b])c.set(this.rom,a[b]);b=this.rom.itemGets.map(()=>[]);for(const d of this.rom.itemGets){({id:c}=
d);for(const e of d.flags){if(-1===e)continue;const d=preservedItemGetFlags$$module$js$rom$slots.has(e)?c:a[c];(b[d]||[]).push(e)}}for(const a of this.rom.itemGets)a.flags=b[a.id]}}
...
const preservedItemGetFlags$$module$js$rom$slots=new Set([36,139,765]);var module$js$rom$slots={};module$js$rom$slots.update=update$$module$js$rom$slots;class Spoiler$$module$js$rom$spoiler{constructor(a){this.rom=a;this.slots=[];this.route=[];this.slotNames=[];this.conditionNames={}}addCondition(a,b){this.conditionNames[a]=b}addCheck(a,b,c){this.route.push(new Check$$module$js$rom$spoiler(this,a,b,c))}addSlot(a,b,c){this.slots[a]=new Slot$$module$js$rom$spoiler(this.rom,a,b,c);b&&(this.slotNames[512|a]=b)}formatCondition(a,b){return 512>a||640<=a?this.conditionNames[a]||conditionHex$$module$js$rom$spoiler(a):null==b?slotToItem$$module$js$rom$spoiler(this.rom,
a&255):`${this.slotNames[a]||conditionHex$$module$js$rom$spoiler(a)} (${this.formatCondition(b|512)})`}}class Check$$module$js$rom$spoiler{constructor(a,b,c,d){this.spoiler=a;this.condition=b;this.deps=c;this.item=d}toString(){return`${this.spoiler.formatCondition(this.condition,this.item)}: [${this.deps.map((a)=>this.spoiler.formatCondition(a)).join(", ")}]`}}function conditionHex$$module$js$rom$spoiler(a){return 0>a?"~"+~a.toString(16).padStart(2,"0"):a.toString(16).padStart(3,"0")}
class Slot$$module$js$rom$spoiler{constructor(a,b,c,d){this.slot=b;this.slotName=c;this.item=d;this.itemName=slotToItem$$module$js$rom$spoiler(a,d);this.originalItem=slotToItem$$module$js$rom$spoiler(a,b)}toString(){return`${this.itemName}: ${this.slotName} (${this.originalItem})`}}function slotToItem$$module$js$rom$spoiler(a,b){return 112<=b?"Mimic":a.items[a.itemGets[b].itemId].messageName}var module$js$rom$spoiler={};module$js$rom$spoiler.Spoiler=Spoiler$$module$js$rom$spoiler;const STATUS$$module$js$version="unstable",VERSION$$module$js$version="maze",LABEL$$module$js$version="maze 1a95c0a",HASH$$module$js$version="1a95c0a1d159d184bc22b4c3a2535b351494f5e1",DATE$$module$js$version=new Date(1566213246E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;class Graphics$$module$js$rom$graphics{constructor(a){this.rom=a;this.monsterConstraints=new Map;this.npcConstraints=new Map;this.allSpritePalettes=new Set;var b=new DefaultMap$$module$js$util(()=>[]);for(var c of a.locations)if(c.used)for(var d=0;d<c.spawns.length;d++){const a=c.spawns[d];a.used&&(a.isMonster()?b.get(a.monsterId).push([c,d,a]):a.isNpc()&&b.get(~a.id).push([c,d,a]))}for(const [e,f]of b)if(0>e){if(!a.metasprites[a.npcs[~e].data[3]])throw Error(`bad NPC: ${~e}`);b=this.computeConstraint([a.npcs[~e].data[3]],
f,!0);95===~e&&(b=b.ignorePalette());this.npcConstraints.set(~e,b)}else{b=Constraint$$module$js$rom$constraint.ALL;c=this.rom.objects[e];if(!(c instanceof Monster$$module$js$rom$monster))throw Error(`expected monster: ${c} from ${f}`);for(const g of allObjects$$module$js$rom$graphics(a,c)){d=ACTION_SCRIPTS$$module$js$rom$monster.get(g.action);d=this.computeConstraint((d&&d.metasprites||(()=>[g.metasprite]))(g),f,g.id===e);d=b.meet(d);if(!d)throw Error(`Bad meet for ${e} with ${g.id}`);d&&(b=d)}this.monsterConstraints.set(c.id,
b);c.constraint=b}}getMonsterConstraint(a,b){const c=this.monsterConstraints.get(b)||Constraint$$module$js$rom$constraint.NONE;return 88!==(a&88)&&this.rom.objects[b].goldDrop?c.meet(Constraint$$module$js$rom$constraint.COIN)||Constraint$$module$js$rom$constraint.NONE:c}shufflePalettes(a){const b=[...this.allSpritePalettes];for(const [c,d]of this.monsterConstraints)this.monsterConstraints.set(c,d.shufflePalette(a,b));for(const [c,d]of this.npcConstraints)this.npcConstraints.set(c,d.shufflePalette(a,
b))}configure(a,b){if(b.used){var c=b.isMonster()?this.monsterConstraints.get(b.monsterId):b.isNpc()?this.npcConstraints.get(b.id):b.isChest()?112>b.id?Constraint$$module$js$rom$constraint.TREASURE_CHEST:Constraint$$module$js$rom$constraint.MIMIC:void 0;if(c){if(3===c.shift||2<=c.float.length)throw Error("don't know what to do with two floats");if(!c.float.length)b.patternBank=Number(2===c.shift);else if(c.float[0].has(a.spritePatterns[0]))b.patternBank=0;else if(c.float[0].has(a.spritePatterns[1]))b.patternBank=
1;else if(b.isMonster())throw Error("no matching pattern bank");}}}computeConstraint(a,b,c){const d=new Set,e=new Set;for(const b of a.map((a)=>this.rom.metasprites[a])){for(const a of b.palettes())e.add(a);for(const a of b.patternBanks())d.add(a)}c=c&&1==d.size&&2===[...d][0];a=new Map;for(const [d,,e]of b)a.set(e.patternBank&&c?~d.id:d.id,e);b=void 0;for(let [f,g]of a){a=this.rom.locations[0>f?~f:f];for(const b of e)1<b&&this.allSpritePalettes.add(a.spritePalettes[b-2]);a=Constraint$$module$js$rom$constraint.fromSpawn(e,
d,a,g,c);b=b?b.join(a):a;!c&&g.patternBank&&(b=b.shifted())}if(!b)throw Error("Expected child to appear");return b}}function*allObjects$$module$js$rom$graphics(a,b){yield b;var c=b.spawnedReplacement();c&&(yield*allObjects$$module$js$rom$graphics(a,c));(c=b.spawnedChild())&&(yield*allObjects$$module$js$rom$graphics(a,c));80===b.id&&(yield a.objects[95]);83===b.id&&(yield a.objects[105])}var module$js$rom$graphics={};module$js$rom$graphics.Graphics=Graphics$$module$js$rom$graphics;var $jscompDefaultExport$$module$js$patch={apply(a,b,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;b.seed||(b.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+b.seed);d=b.flags?new FlagSet$$module$js$flagset(String(b.flags)):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const a in b)"false"===b[a]&&(b[a]=!1);yield shuffle$$module$js$patch(a,parseSeed$$module$js$patch(String(b.seed)),d,new FetchReader$$module$js$fetchreader(c))})}};
...
_NERF_FLIGHT:!0,_NERF_WILD_WARP:c.nerfWildWarp(),_NEVER_DIE:c.neverDie(),_NORMALIZE_SHOP_PRICES:!0,_PITY_HP_AND_MP:!0,_PROGRESSIVE_BRACELET:!0,_RABBIT_BOOTS_CHARGE_WHILE_WALKING:c.rabbitBootsChargeWhileWalking(),_REQUIRE_HEALED_DOLPHIN_TO_RIDE:c.requireHealedDolphinToRide(),_REVERSIBLE_SWAN_GATE:!0,_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_SIMPLIFY_INVISIBLE_CHESTS:!0,_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword(),_UNIDENTIFIED_ITEMS:c.unidentifiedItems()},l=new Assembler$$module$js$6502;
var m=Object.keys(k).filter((a)=>k[a]).map((a)=>`define ${a} 1\n`).join("");l.assemble(m,"flags.s");yield g("preshuffle.s");h=new Random$$module$js$random(h);m=new Rom$$module$js$rom(a);fixCoinSprites$$module$js$patch(m);"object"==typeof window&&(window.rom=m);m.spoiler=new Spoiler$$module$js$rom$spoiler(m);e&&(e.slots=m.spoiler.slots,e.route=m.spoiler.route);fixMimics$$module$js$patch(m);makeBraceletsProgressive$$module$js$patch(m);c.blackoutMode()&&blackoutMode$$module$js$patch(m);closeCaveEntrances$$module$js$patch(m,
c);reversibleSwanGate$$module$js$patch(m);adjustGoaFortressTriggers$$module$js$patch(m);preventNpcDespawns$$module$js$patch(m,c);c.requireHealedDolphinToRide()&&requireHealedDolphin$$module$js$patch(m);c.saharaRabbitsRequireTelepathy()&&requireTelepathyForDeo$$module$js$patch(m);adjustItemNames$$module$js$patch(m,c);yield g("postparse.s");alarmFluteIsKeyItem$$module$js$patch(m);c.teleportOnThunderSword()?teleportOnThunderSword$$module$js$patch(m):noTeleportOnThunderSword$$module$js$patch(m);m.scalingLevels=
48;m.uniqueItemTableAddress=l.expand("KeyItemData");undergroundChannelLandBridge$$module$js$patch(m);c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$patch(m);simplifyInvisibleChests$$module$js$patch(m);addCordelWestTriggers$$module$js$patch(m,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$js$patch(m);c.shuffleShops()&&shuffleShops$$module$js$patch(m,c,h);randomizeWalls$$module$js$patch(m,c,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(m,c,h);rescaleMonsters$$module$js$patch(m,
c,h);shuffleTrades$$module$js$pass$shuffletrades(m,c,h);c.randomizeMaps()&&shuffleMazes$$module$js$pass$shufflemazes(m,h);const n=World$$module$js$graph$world.build(m,c),q=yield(new AssumedFill$$module$js$graph$shuffle(m,c)).shuffle(n.graph,h,f);if(q)n.traverse(n.graph,q),update$$module$js$rom$slots(m,q.slots);else return-1;rescaleShops$$module$js$patch(m,l,c.bargainHunting()?h:void 0);normalizeSwords$$module$js$patch(m,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(m,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(m);
c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(m);c.chargeShotsOnly()&&disableStabs$$module$js$patch(m);c.orbsOptional()&&orbsOptional$$module$js$patch(m);shuffleMusic$$module$js$patch(m,c,h);shufflePalettes$$module$js$pass$shufflepalettes(m,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(m,c,h);misc$$module$js$patch(m,c,h);fixDialog$$module$js$pass$fixdialog(m);fixReverseWalls$$module$js$pass$fixreversewalls(m);
c.buffDyna()&&buffDyna$$module$js$patch(m,c);yield m.writeData();buffDyna$$module$js$patch(m,c);return yield postParsedShuffle$$module$js$patch(a,h,b,c,l,g)})}function postParsedShuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){yield f("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(a,d,e);updateCoinDrops$$module$js$patch(a,d);shuffleRandomNumbers$$module$js$patch(a,b);return stampVersionSeedAndHash$$module$js$patch(a,c,d)})}
function fixCoinSprites$$module$js$patch(a){for(const b of[96,100,101,102,103,104,105,106,107,108,109,111])for(const c of[0,1,2])a.patterns[b<<6|c].pixels=a.patterns[6016|c].pixels}function undergroundChannelLandBridge$$module$js$patch(a){({tiles:a}=a.screens[161]);a[40]=159;a[55]=35;a[56]=35;a[57]=33;a[71]=141;a[72]=143;a[86]=153;a[87]=154;a[88]=140}
...
a.map((a)=>a[1]);b=[...new Set(b)];for(const d of a){[a]=d;{const d=b[c.nextInt(b.length)];for(const b of a)b.bgm=d}}})([...b,...e,...f])}}function shuffleWildWarp$$module$js$patch(a,b,c){b=[];for(const c of a.locations)c&&c.used&&c.id&&!c.extended&&88!==(c.id&248)&&b.push(c.id);c.shuffle(b);a.wildWarp.locations=[...b.slice(0,15).sort((a,b)=>a-b),0]}
...
function makeBraceletsProgressive$$module$js$patch(a){a=a.npcs[95];var b=a.localDialogs.get(33);b=[b[0],b[2],b[2].clone(),b[1]];b[1].condition=-519;b[2].condition=-518;b[3].condition=-1;a.localDialogs.set(33,b)}function blackoutMode$$module$js$patch(a){var b=generate$$module$js$depgraph();for(const c of b.nodes)b=c.type,"Location"!==c.nodeType||"cave"!==b&&"fortress"!==b||a.locations[c.id].tilePalettes.fill(154)}
function closeCaveEntrances$$module$js$patch(a,b){function c(a,b,c){for(const d of a.flags)if(d.yx===b){d.flag=c;return}throw Error(`Could not find flag to replace at ${a}:${b}`);}a.locations.valleyOfWind.entrances[1].y+=16;a.swapMetatiles([144],[7,[1,0],-194],[14,[2,0],-194],[32,[3,10],-216],[33,[4,10],-216]);a.swapMetatiles([148,156],[104,[1,0],-194],[131,[2,0],-194],[136,[3,10],-216],[137,[4,10],-216]);a.screens[10].tiles[56]=1;a.screens[10].tiles[57]=2;a.screens[10].tiles[72]=3;a.screens[10].tiles[73]=
...
[f,48],[g,0],[g,20],[h,116],[k,16],[l,0],[m,65]];for(var n of a){const [a,b]=n;a.flags.push(Flag$$module$js$rom$location.of({yx:b,flag:751}))}b.paralysisRequiresPrisonKey()&&(c(e,48,750),c(f,48,750),c(g,0,728),b=Spawn$$module$js$rom$location.of({y:96,x:96,type:4,id:44}),n=Spawn$$module$js$rom$location.of({y:112,x:112,type:2,id:173}),g.spawns.splice(1,0,b),g.spawns.push(n))}
const eastCave$$module$js$patch=(a)=>{console.log(a,[[156,132,128,131,156],[128,129,131,134,128],[131,136,137,128,128],[129,140,133,130,132],[154,133,156,152,134]],[[156,132,155,128,155],[128,129,129,128,129],[128,135,139,138,134],[128,140,128,133,132],[156,134,128,128,154]])},adjustGoaFortressTriggers$$module$js$patch=(a)=>{a=a.locations;a.goaFortressKelbesque.spawns[0].x-=8;a.goaFortressZebu.spawns.splice(1,1);a.goaFortressTornel.spawns.splice(2,1);a.goaFortressAsina.spawns.splice(2,1)},alarmFluteIsKeyItem$$module$js$patch=
(a)=>{const {waterfallCave4:b}=a.locations;a.npcs[20].data[1]=49;a.itemGets[49].inventoryRowStart=32;a.items[49].unique=!0;a.items[49].basePrice=0;const c=[[33,.72],[31,.9]];let d=0;for(const b of a.shops)if(b.type===module$js$rom$shop.ShopType.TOOL)for(let e=0,g=b.contents.length;e<g;e++){if(49!==b.contents[e])continue;const [f,g]=c[d++%c.length];b.contents[e]=f;a.shopDataTablesAddress&&(b.prices[e]=Math.round(b.prices[e]*g))}a.itemGets[91].itemId=29;b.spawn(25).id=16},reversibleSwanGate$$module$js$patch=
(a)=>{a.locations[115].spawns.push(Spawn$$module$js$rom$location.of({xt:10,yt:2,type:1,id:45}),Spawn$$module$js$rom$location.of({xt:11,yt:2,type:1,id:45}),Spawn$$module$js$rom$location.of({xt:14,yt:10,type:2,id:179}));a.npcs[45].localDialogs.get(115)[0].flags.push(269);a.trigger(179).conditions.push(269)};
function preventNpcDespawns$$module$js$patch(a,b){function c(a,b){const c=a.indexOf(b);if(0>c)throw Error(`Could not find element ${b} in ${a}`);a.splice(c,1)}function d(b,c){c=void 0===c?-1:c;const d=a.npcs[b].localDialogs.get(c);if(!d)throw Error(`Missing dialog $${hex$$module$js$rom$util(b)} at $${hex$$module$js$rom$util(c)}`);return d}function e(b,c){const d=a.npcs[b].spawnConditions.get(c);if(!d)throw Error(`Missing spawn condition $${hex$$module$js$rom$util(b)} at $${hex$$module$js$rom$util(c)}`);
...
a.trigger(140).conditions.push(58);a.trigger(186).conditions[0]=-581;a.trigger(187).conditions[1]=-28;({zombieTown:b}=a.locations);b.spawns=b.spawns.filter((a)=>!a.isTrigger()||138!=a.id);for(const b of a.npcs)for(const a of b.allDialogs())14===a.condition&&(a.condition=579),-15===a.condition&&(a.condition=-580)}function fixMimics$$module$js$patch(a){let b=112;for(const c of a.locations)for(const a of c.spawns)a.isChest()&&(a.timed=!1,112<=a.id&&(a.id=b++))}
const requireHealedDolphin$$module$js$patch=(a)=>{a.npcs[100].spawnConditions.set(214,[566,37]);a=a.npcs[123].localDialogs.get(-1);a.unshift(a[0].clone());a[0].condition=-38;a[1].condition=-567},requireTelepathyForDeo$$module$js$patch=(a)=>{a.npcs[89].globalDialogs.push(GlobalDialog$$module$js$rom$npc.of(-580,[26,18]));a.npcs[90].globalDialogs.push(GlobalDialog$$module$js$rom$npc.of(-580,[26,19]))},teleportOnThunderSword$$module$js$patch=(a)=>{a.itemGets[3].flags.push(765);for(const b of[0,1,3])for(const c of[242,
244])a.npcs[98].localDialogs.get(c)[b].message.action=31},noTeleportOnThunderSword$$module$js$patch=(a)=>{a.itemGets[3].acquisitionAction.action=22},adjustItemNames$$module$js$patch=(a,b)=>{b.leatherBootsGiveSpeed()&&(b=a.items[47],b.menuName="Speed Boots",b.messageName="Speed Boots");for(b=5;12>b;b+=2)a.items[b].menuName=a.items[b].menuName.replace("Ball","Orb"),a.items[b].messageName=a.items[b].messageName.replace("Ball","Orb")};
function simplifyInvisibleChests$$module$js$patch(a){for(const b of[a.locations.cordelPlainsEast,a.locations.undergroundChannel,a.locations.kirisaMeadow])for(const a of b.spawns)a.isChest()&&(a.data[2]|=32)}
const addCordelWestTriggers$$module$js$patch=(a,b)=>{const {cordelPlainsEast:c,cordelPlainsWest:d}=a.locations;for(const a of c.spawns)(a.isChest()||b.disableTeleportSkip()&&a.isTrigger())&&d.spawns.push(a.clone())},fixRabbitSkip$$module$js$patch=(a)=>{for(const b of a.locations.mtSabreNorthMain.spawns)b.isTrigger()&&134===b.id&&1856===b.x&&(b.x+=16,b.y+=16)},storyMode$$module$js$patch=(a)=>{a.npcs[203].spawnConditions.set(166,[~a.npcs[194].spawnConditions.get(40)[0],~a.npcs[132].spawnConditions.get(110)[0],
~a.trigger(154).conditions[1],~a.npcs[197].spawnConditions.get(169)[0],~a.npcs[198].spawnConditions.get(172)[0],~a.npcs[199].spawnConditions.get(185)[0],~a.npcs[200].spawnConditions.get(182)[0],~a.npcs[203].spawnConditions.get(159)[0],512,513,514,515])},disableStabs$$module$js$patch=(a)=>{for(const b of[8,9,39])a.objects[b].collisionPlane=0},orbsOptional$$module$js$patch=(a)=>{for(const b of[16,20,24,29])a.objects[b].terrainSusceptibility&=-5,a.objects[b].level=2},connectLimeTreeToLeaf$$module$js$patch=
(a)=>{const {valleyOfWind:b,limeTreeValley:c}=a.locations;b.screens[5][4]=16;c.screens[1][0]=26;c.screens[2][0]=12;a=b.entrances.push(Entrance$$module$js$rom$location.of({x:1263,y:1400}))-1;const d=c.entrances.push(Entrance$$module$js$rom$location.of({x:16,y:448}))-1;b.exits.push(Exit$$module$js$rom$location.of({x:1264,y:1376,dest:66,entrance:d}),Exit$$module$js$rom$location.of({x:1264,y:1392,dest:66,entrance:d}));c.exits.push(Exit$$module$js$rom$location.of({x:0,y:432,dest:3,entrance:a}),Exit$$module$js$rom$location.of({x:0,
...
for(this.report["post-shuffle monsters"]=this.monsters.map((a)=>a.id);this.locations.length;){const {location:e,slots:f}=this.locations.pop(),g=this.report["$"+e.id.toString(16).padStart(2,"0")]=[],{maxFlyers:h=0,nonFlyers:k={},tower:l=!1}=MONSTER_ADJUSTMENTS$$module$js$patch[e.id]||{};if(l)continue;let m=h,n=Constraint$$module$js$rom$constraint.forLocation(e.id);null!=e.bossId()&&(n=n.meet(Constraint$$module$js$rom$constraint.BOSS)||n);for(const a of e.spawns)if(a.isChest()&&!a.isInvisible())n=112>
a.id?n.meet(Constraint$$module$js$rom$constraint.TREASURE_CHEST)||n:n.meet(Constraint$$module$js$rom$constraint.MIMIC)||n;else if(a.isNpc()){var c=b.npcConstraints.get(a.id);c&&(n=n.meet(c)||n)}else a.isMonster()&&UNTOUCHED_MONSTERS$$module$js$patch[a.monsterId]&&(c=b.monsterConstraints.get(a.monsterId))&&(n=n.meet(c)||n);g.push(`Initial pass: ${n.fixed.map((a)=>Infinity>a.size?"["+[...a].join(", ")+"]":"all")}`);const q=new Map;c=(a)=>{var c=e.rom.objects[a.id];if(c.monsterClass){var d=q.get(c.monsterClass);
if(null!=d&&d!==a.id)return!1}d=FLYERS$$module$js$patch.has(a.id);var h=MOTHS_AND_BATS$$module$js$patch.has(a.id);if(d){if(!m)return!1;--m}const l=b.getMonsterConstraint(e.id,a.id);let p=n.meet(l);!p&&Infinity>n.pal2.size&&Infinity>n.pal3.size&&this.flags.shuffleSpritePalettes()&&(p=n.meet(l.ignorePalette()));if(!p)return!1;g.push(`  Adding ${a.id.toString(16)}: ${p}`);n=p;c.monsterClass&&q.set(c.monsterClass,a.id);c=0;if(d||h)for(d=0;d<f.length;d++){if(f[d]in k){c=d;break}}else for(d=0;d<f.length;d++)if(!(f[d]in
k)){c=d;break}(this.report[`mon-${a.id.toString(16)}`]=this.report[`mon-${a.id.toString(16)}`]||[]).push("$"+e.id.toString(16));d=f[c];h=e.spawns[d-13];d in k&&(h.y+=16*k[d][0],h.x+=16*k[d][1]);h.monsterId=a.id;g.push(`    slot ${d.toString(16)}: ${h}`);f.splice(c,1);return!0};if(m&&f.length)for(var d=0;d<Math.min(40,this.monsters.length);d++)FLYERS$$module$js$patch.has(this.monsters[d].id)&&c(this.monsters[d])&&this.monsters.splice(d,1);for(d=0;d<this.monsters.length&&f.length;d++)if(c(this.monsters[d])){const [a]=
this.monsters.splice(d,1);FLYERS$$module$js$patch.has(a.id)||this.used.push(a);d--}for(d=0;d<this.used.length&&f.length;d++)c(this.used[d])&&(this.used.push(...this.used.splice(d,1)),d--);n.fix(e,a);if(f.length){console.error(`Failed to fill location ${e.id.toString(16)}: ${f.length} remaining`);for(const a of f)c=e.spawns[a-13],c.x=c.y=0,c.id=176,c.data[0]=254}for(const a of e.spawns)b.configure(e,a)}}}
...
e.push(this.nodes.get(b))}c.textContent=e.join(" AND ");c.classList.add(["available","off-route","glitched","hard","blocked"][a]);d.push([c,a])}d.sort((a,b)=>a[1]-b[1]||a[0].textContent.length-b[0].textContent.length);for(const a of d)b.appendChild(a[0])}}}addSlot(a,b,c,d,e){const f=112<=a;a=f?this.mimicSlots.get(d<<8|e):this.nodeFromSlot.get(a);if(!a)debugger;d=document.createElement("div");if("key"==a.slotType||"magic"==a.slotType||"bonus"==a.slotType)d.classList.add("key"),b--,c--;b--;c--;d.dataset.slot=
a.uid;d.style.left=b+"px";d.style.top=c+"px";b=document.createElement("div");d.appendChild(b);b.textContent=f?"Mimic":a.name.replace(" ","\u00a0");this.slotElts.set(a.uid,d);this.map.appendChild(d)}addBox(a,b){b=Number.parseInt(b.substring(1),16);a=document.getElementsByClassName(a)[0];const c=document.createElement("div");a.appendChild(c);b=this.nodeFromSlot.get(b);a.dataset.slot=b.uid;a.dataset.item=b.item.uid;this.itemElts.set(b.item.uid,a)}update(){for(const [a,b]of this.slotElts)if(b.classList.remove("checked"),
b.classList.remove("blocked"),b.classList.remove("available"),b.classList.remove("glitched"),b.classList.remove("off-route"),b.classList.remove("hard"),this.checked.has(a))b.classList.add("checked");else{let c=4;for(const b of this.depgraph.routes[this.depgraph.uidToLocation[a]]){let a=0;for(const c of Bits$$module$js$bits.bits(b))if(a=Math.max(a,this.route[this.depgraph.itemToUid[c]]),!(4>a))break;c=Math.min(c,a);if(!c)break}b.classList.add(["available","off-route","glitched","hard","blocked"][c])}}}
let flags$$module$js$tracker="Rlpt Ts";for(const a of location.hash.substring(1).split("&")){const [b,c]=a.split("=");"flags"===b&&(flags$$module$js$tracker=decodeURIComponent(c))}const graph$$module$js$tracker=new Graph$$module$js$tracker(generate$$module$js$depgraph(new FlagSet$$module$js$flagset(flags$$module$js$tracker+" Dt")));for(let a of BOXES$$module$js$tracker.split("\n"))(a=a.replace(/#.*/,"").trim())&&graph$$module$js$tracker.addBox(...a.split(/ +/g));for(const a of SLOTS$$module$js$tracker)graph$$module$js$tracker.addSlot(...a);
