...
(a=strToBytes$$module$js$crc32(a));let b=-1;for(let c=0,d=a.length;c<d;c++)b=b>>>8^table$$module$js$crc32[(b^a[c])&255];return(b^-1)>>>0};var module$js$crc32={};module$js$crc32.crc32=crc32$$module$js$crc32;class Deque$$module$js$util{constructor(){this.buffer=Array(16);this.mask=15;this.size=this.end=this.start=0}get length(){return this.size}upsize(a){for(;this.mask<a;)this.end<=this.start&&(this.start+=this.mask+1),this.mask=this.mask<<1|1,this.buffer=this.buffer.concat(this.buffer);this.size=a}push(...a){this.upsize(this.size+a.length);for(const b of a)this.buffer[this.end]=b,this.end=this.end+1&this.mask}pop(){if(this.size)return this.end=this.end-1&this.mask,this.size--,this.buffer[this.end]}peek(){if(this.size)return this.buffer[this.end-
...
.25:this.check("Ex")?2.5:1}removeConflicts(a){const b=exclusiveFlags$$module$js$flagset(a);if(b)for(const c in this.flags)this.flags.hasOwnProperty(c)&&(a=this.flags[c].filter((a)=>!b.test(c+a)),a.length?this.flags[c]=a:delete this.flags[c])}toStringKey(a){return REPEATABLE_FLAGS$$module$js$flagset.has(a)?[...this.flags[a]].sort().map((b)=>a+b).join(" "):a+[...this.flags[a]].sort().join("")}toString(){const a=Object.keys(this.flags);a.sort();return a.map((a)=>this.toStringKey(a)).join(" ")}}
...
function hex$$module$js$rom$util(a){return null!=a?a.toString(16).padStart(2,"0"):String(a)}function hex4$$module$js$rom$util(a){return a.toString(16).padStart(4,"0")}function concatIterables$$module$js$rom$util(a){const b=[];for(const c of a)for(const a of c)b.push(a);return b}function readBigEndian$$module$js$rom$util(a,b){return a[b]<<8|a[b+1]}function readLittleEndian$$module$js$rom$util(a,b){return a[b+1]<<8|a[b]}
...
a.assumeGhettoFlight())),l=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),p=h(d("Assume teleport skip",a.assumeTeleportSkip())),q=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),t=h(d("Allow rabbit skip",!a.disableRabbitSkip())),u=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),B=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),L=h(d("Assume wild warp",a.assumeWildWarp())),
C=d("Allow wild warp",a.allowWildWarp()),E=d("Sword magic optional",!a.guaranteeSwordMagic()),v=d("Matching sword optional",!a.guaranteeMatchingSword()),I=d("Gas mask optional",!a.guaranteeGasMask()),P=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),aa=d("Calm sea optional",!a.barrierRequiresCalmSea()),Rd=d("Prison key optional",!a.paralysisRequiresPrisonKey()),Sd=d("Windmill optional",!a.sealedCaveRequiresWindmill()),Td=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),
Yb=d("Barrier magic optional",!a.guaranteeBarrier()),Zb=d("Refresh magic optional",!a.guaranteeRefresh()),Ud=d("Telepathy optional for Deo",!a.saharaRabbitsRequireTelepathy()),Vd=d("Lime Tree connects to Leaf",a.connectLimeTreeToLeaf()),Wd=d("Buffed medical herb",a.buffMedicalHerb()),Ta=d("Orbs optional",a.orbsOptional()),U=(new Item$$module$js$nodes(c,0,"Sword of Wind")).weight(a.guaranteeSword()?10:5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),V=(new Item$$module$js$nodes(c,
1,"Sword of Fire")).weight(a.guaranteeSword()?10:5).fromPerson("Oak elder",29).dialog(29,void 0,3).key(),Q=(new Item$$module$js$nodes(c,2,"Sword of Water")).weight(10).chest().key(),N=(new Item$$module$js$nodes(c,3,"Sword of Thunder")).weight(15).chest().key(),rb=(new Item$$module$js$nodes(c,4,"Crystalis")).fixed(),La=(new Item$$module$js$nodes(c,5,"Ball of Wind")).chest().key(),Ma=(new Item$$module$js$nodes(c,6,"Tornado Bracelet")).chest().key(),Ua=(new Item$$module$js$nodes(c,7,"Ball of Fire")).bossDrop("Insect",
1).dialog(30,void 0,2).dialog(32,void 0,0).dialog(33,void 0,0).dialog(34,void 0,0).dialog(96,30,0).dialog(29,void 0,2).dialog(31,void 0,1).npcSpawn(193).key(),Va=(new Item$$module$js$nodes(c,8,"Flame Bracelet")).bossDrop("Kelbesque 1",2).npcSpawn(194).key(),Wa=(new Item$$module$js$nodes(c,9,"Ball of Water")).weight(5).direct("Rage",250679).npcSpawn(195).key(),Xa=(new Item$$module$js$nodes(c,10,"Blizzard Bracelet")).weight(5).chest().key(),Ya=(new Item$$module$js$nodes(c,11,"Ball of Thunder")).bossDrop("Mado 1",
5).trigger(154,1).key(),Za=(new Item$$module$js$nodes(c,12,"Storm Bracelet")).chest().key(),$b=(new Item$$module$js$nodes(c,13,"Carapace Shield")).armor(),Xd=(new Item$$module$js$nodes(c,14,"Bronze Shield")).armor(),ac=(new Item$$module$js$nodes(c,15,"Platinum Shield")).armor(),bc=(new Item$$module$js$nodes(c,16,"Mirrored Shield")).armor(),Yd=(new Item$$module$js$nodes(c,17,"Ceramic Shield")).armor(),sb=(new Item$$module$js$nodes(c,18,"Sacred Shield")).armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),
cc=(new Item$$module$js$nodes(c,19,"Battle Shield")).armor(),Zd=(new Item$$module$js$nodes(c,20,"Psycho Shield")).armor(),$d=(new Item$$module$js$nodes(c,21,"Tanned Hide")).armor(),ae=(new Item$$module$js$nodes(c,22,"Leather Armor")).armor(),be=(new Item$$module$js$nodes(c,23,"Bronze Armor")).armor(),dc=(new Item$$module$js$nodes(c,24,"Platinmum Armor")).armor(),ce=(new Item$$module$js$nodes(c,25,"Soldier Suit")).armor(),ec=(new Item$$module$js$nodes(c,26,"Ceramic Suit")).armor(),de=(new Item$$module$js$nodes(c,
27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),J=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),O=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),za=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),tb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),R=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),ba=(new Item$$module$js$nodes(c,
34,"Magic Ring")).consumable(),ub=(new Item$$module$js$nodes(c,35,"Fruit of Repun")).consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),W=(new Item$$module$js$nodes(c,36,"Warp Boots")).consumable(),fc=(new Item$$module$js$nodes(c,37,"Statue of Onyx")).chest("Cordel grass").invisible(254882).key(),vb=(new Item$$module$js$nodes(c,38,"Opel Statue")).consumable().bossDrop("Kelbesque 2",6).npcSpawn(197).key(),gc=(new Item$$module$js$nodes(c,39,"Insect Flute")).fromPerson("Oak mother",30).dialog(30,
void 0,1).key(),wb=(new Item$$module$js$nodes(c,40,"Flute of Lime")).fromPerson("Portoa queen",56).fromPerson("Asina secondary",98,1).dialog(56,void 0,4).key(),$a=(new Item$$module$js$nodes(c,41,"Gas Mask")).direct("Akahana in Brynmaer",251902).npcSpawn(22,24).key(),fe=(new Item$$module$js$nodes(c,42,"Power Ring")).chest().bonus(),ge=(new Item$$module$js$nodes(c,43,"Warrior Ring")).fromPerson("Akahana's friend",84).dialog(84,void 0,2).bonus(),he=(new Item$$module$js$nodes(c,44,"Iron Necklace")).chest().bonus(),
ie=(new Item$$module$js$nodes(c,45,"Deo's Pendant")).fromPerson("Deo",90).dialog(90,void 0,0).bonus(),xb=(new Item$$module$js$nodes(c,46,"Rabbit Boots")).bossDrop("Vampire 1",0).npcSpawn(192).key(),hc=((a,b)=>new Item$$module$js$nodes(c,a,b))(47,a.leatherBootsGiveSpeed()?"Speed Boots":"Leather Boots").chest().bonus(),ic=(new Item$$module$js$nodes(c,48,"Shield Ring")).direct("Akahana in waterfall cave",250543).bonus(),yb=(new Item$$module$js$nodes(c,49,"Alarm Flute")).fromPerson("Zebu's student",20,
1).key(),jc=(new Item$$module$js$nodes(c,50,"Windmill Key")).fromPerson("Windmill guard",20).dialog(20,14,0).npcSpawn(20,14,1).key(),zb=(new Item$$module$js$nodes(c,51,"Key to Prison")).chest().key(),kc=(new Item$$module$js$nodes(c,52,"Key to Styx")).fromPerson("Zebu in Shyron",94,1).trigger(128,2).dialog(94,242,0).dialog(98,242,0).key(),lc=(new Item$$module$js$nodes(c,53,"Fog Lamp")).chest().key(),Ab=(new Item$$module$js$nodes(c,54,"Shell Flute")).fromPerson("Dolphin",99,1).npcSpawn(99).key(),mc=
(new Item$$module$js$nodes(c,55,"Eye Glasses")).fromPerson("Clark",68).dialog(68,233,1).key(),nc=(new Item$$module$js$nodes(c,56,"Broken Statue")).bossDrop("Sabera 1",4).npcSpawn(127,101).npcSpawn(9).npcSpawn(10).npcSpawn(69).npcSpawn(70).npcSpawn(71).npcSpawn(132).npcSpawn(142).dialog(61).dialog(62).dialog(63).dialog(64).dialog(65).dialog(66).dialog(67).dialog(68,233).trigger(182).key(),oc=(new Item$$module$js$nodes(c,57,"Glowing Lamp")).direct("Kensu in lighthouse",250638).npcSpawn(126,98,1).key(),
pc=(new Item$$module$js$nodes(c,59,"Love Pendant")).chest("Underground channel").invisible(254890).key(),qc=(new Item$$module$js$nodes(c,60,"Kirisa Plant")).chest("Kirisa meadow").invisible(254886).key(),Bb=(new Item$$module$js$nodes(c,61,"Ivory Statue")).bossDrop("Karmine",9).npcSpawn(200).key(),rc=(new Item$$module$js$nodes(c,62,"Bow of Moon")).fromPerson("Aryllis",35).direct(251624).dialog(35,void 0,1).key(),sc=(new Item$$module$js$nodes(c,63,"Bow of Sun")).chest().key(),tc=(new Item$$module$js$nodes(c,
64,"Bow of Truth")).fromPerson("Azteca",131).npcSpawn(131,156,1).dialog(131,void 0,0).key(),ab=(new Magic$$module$js$nodes(c,65,"Refresh")).fromPerson("Zebu at windmill",94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),Na=(new Magic$$module$js$nodes(c,66,"Paralysis")).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),la=(new Magic$$module$js$nodes(c,67,"Telepathy")).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),uc=(new Magic$$module$js$nodes(c,
68,"Teleport")).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),je=(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),vc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),ta=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),F=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=R.bossDrop("Vampire 2",
12,97).npcSpawn(204).key(),S=new Item$$module$js$nodes(c,112,"Mimic"),wc=(new Trigger$$module$js$nodes(c,"Talked to Leaf Elder")).get(U),xc=(new Trigger$$module$js$nodes(c,"Talked to Leaf Student")).get(yb),Cb=new Trigger$$module$js$nodes(c,"Talked to Zebu in cave"),le=(new Trigger$$module$js$nodes(c,"Woke up Windmill Guard")).get(jc),Oa=new Trigger$$module$js$nodes(c,"Started Windmill"),yc=(new Trigger$$module$js$nodes(c,"Learned Refresh")).get(ab),me=(new Trigger$$module$js$nodes(c,"Gave Statue to Akahana")).get($a),
ne=(new Trigger$$module$js$nodes(c,"Fought Stom")).get(la),zc=new Trigger$$module$js$nodes(c,"Visited Oak"),Ac=new Trigger$$module$js$nodes(c,"Talked to Oak Mother"),Db=new Trigger$$module$js$nodes(c,"Rescued Oak Child"),oe=(new Trigger$$module$js$nodes(c,"Talked to Oak Mother Again")).get(gc),pe=(new Trigger$$module$js$nodes(c,"Talked to Oak Elder")).get(V),qe=(new Trigger$$module$js$nodes(c,"Talked to Tornel on Mt Sabre")).get(uc),Bc=new Trigger$$module$js$nodes(c,"Villagers Abducted"),Cc=new Trigger$$module$js$nodes(c,
"Talked to Rabbit in Leaf"),re=(new Trigger$$module$js$nodes(c,"Learned Paralysis")).get(Na),Dc=new Trigger$$module$js$nodes(c,"Talked to Portoa Queen"),Ec=new Trigger$$module$js$nodes(c,"Talked to Fortune Teller"),Fc=new Trigger$$module$js$nodes(c,"Visited Underground Channel"),se=(new Trigger$$module$js$nodes(c,"Sent to Waterfall Cave")).get(wb),te=(new Trigger$$module$js$nodes(c,"Cured Akahana")).get(ic),Gc=(new Trigger$$module$js$nodes(c,"Talked to Rage")).get(Wa),Hc=new Trigger$$module$js$nodes(c,
"Mesia recording played"),Ic=(new Trigger$$module$js$nodes(c,"Talked to Asina")).get(je),Jc=(new Trigger$$module$js$nodes(c,"Healed Dolphin")).get(Ab),Eb=new Trigger$$module$js$nodes(c,"Returned Fog Lamp"),Kc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Cabin"),Lc=new Trigger$$module$js$nodes(c,"Talked to Joel Elder"),ue=(new Trigger$$module$js$nodes(c,"Talked to Clark")).get(mc),ve=(new Trigger$$module$js$nodes(c,"Talked to Kensu in Lighthouse")).get(oc),Fb=new Trigger$$module$js$nodes(c,"Calmed the Angry Sea"),
we=(new Trigger$$module$js$nodes(c,"Learned Barrier")).get(vc),Mc=new Trigger$$module$js$nodes(c,"Talked to Stom in Swan Hut"),Nc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Swan tavern"),Oc=new Trigger$$module$js$nodes(c,"Talked to Kensu at Swan dance"),xe=(new Trigger$$module$js$nodes(c,"Returned Kensu's love pendant")).get(ta),ye=(new Trigger$$module$js$nodes(c,"Talked to Amazones Queen")).get(rc),Gb=new Trigger$$module$js$nodes(c,"Entered Shyron"),ze=(new Trigger$$module$js$nodes(c,"Talked to Zebu in Shyron")).get(kc),
Pc=new Trigger$$module$js$nodes(c,"Shyron Massacre"),Ae=(new Trigger$$module$js$nodes(c,"Saved Kensu")).get(F),Be=(new Trigger$$module$js$nodes(c,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$js$nodes(c,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(c,"Get Bow of Truth")).get(tc),Ee=(new Trigger$$module$js$nodes(c,"Forged Crystalis")).get(rb),bb=(new Condition$$module$js$nodes(c,"Sword charge glitch")).option(u,B),Fe=(new Condition$$module$js$nodes(c,"Rabbit skip")).option(r,
t),Ge=(new Condition$$module$js$nodes(c,"Teleport skip")).option(p,q),cb=(new Condition$$module$js$nodes(c,"Statue glitch")).option(l,n),He=(new Condition$$module$js$nodes(c,"Wild warp")).option(L,C),db=(new Condition$$module$js$nodes(c,"Any level 2 sword")).option(U,La).option(U,Ma).option(V,Ua).option(V,Va).option(Q,Wa).option(Q,Xa).option(N,Ya).option(N,Za),y=(new Condition$$module$js$nodes(c,"Destroy stone")).option(U,Ta).option(U,La).option(U,Ma).option(bb,U,db),z=(new Condition$$module$js$nodes(c,
"Destroy ice")).option(V,Ta).option(V,Ua).option(V,Va).option(bb,V,db),w=(new Condition$$module$js$nodes(c,"Cross rivers")).option(Q,Ta).option(Q,Wa).option(Q,Xa).option(F).option(bb,Q,db),Aa=(new Condition$$module$js$nodes(c,"Destroy iron")).option(N,Ta).option(N,Ya).option(N,Za).option(bb,N,db),X=(new Condition$$module$js$nodes(c,"Any sword")).option(U).option(V).option(Q).option(N),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(V).option(Q).option(N).option($a,
v.value?v:g,U),Je=(new Condition$$module$js$nodes(c,"Match vampire 2 sword (wind/water/thunder)")).option(U).option(Q).option(N).option(v.value?v:g,V),Qc=(new Condition$$module$js$nodes(c,"Speed boots")).option(hc,k),Rc=(new Condition$$module$js$nodes(c,"Climb slopes")).option(xb).option(F).option(Qc),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Cc).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(uc).option(Ge,F),Sc=(new Condition$$module$js$nodes(c,
"Asina in her room")).option(Hc),Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(Na).option(Sc).option(cb),Tc=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(Ab,Kc),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(m,Tc,xb),ha=(new Condition$$module$js$nodes(c,"Cross sea")).option(Tc).option(F),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Fb).option(F).option(Ne),Y=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(Zb.value?
Zb:g).option(ab),Uc=(new Condition$$module$js$nodes(c,"Wind magic")).option(E.value?E:g,Y).option(La,Ma,Y),Vc=(new Condition$$module$js$nodes(c,"Fire magic")).option(E.value?E:g,Y).option(Ua,Va,Y),Wc=(new Condition$$module$js$nodes(c,"Water magic")).option(E.value?E:g,Y).option(E,Y).option(Wa,Xa,Y),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(E.value?E:g,Y).option(E,Y).option(Ya,Y).option(Za,Y),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(wb).option(cb),
Re=(new Condition$$module$js$nodes(c,"Change or glitch")).option(ta).option(cb),Se=(new Condition$$module$js$nodes(c,"Change or glitch or paralysis")).option(ta).option(cb).option(Na),Hb=(new Condition$$module$js$nodes(c,"Pass shooting statues")).option(vc).option(X,Yb.value?Yb:g).option(ab,ic),Te=(new Condition$$module$js$nodes(c,"Healed dolphin if required")).option(Jc).option(P),Xc=(new Condition$$module$js$nodes(c,"Match sword of wind")).option(U).option(v.value?v:g,X),Yc=(new Condition$$module$js$nodes(c,
"Match sword of fire")).option(V).option(v.value?v:g,X),Zc=(new Condition$$module$js$nodes(c,"Match sword of water")).option(Q).option(v.value?v:g,X),Ue=(new Condition$$module$js$nodes(c,"Match sword of thunder")).option(N).option(v.value?v:g,X),Ve=(new Condition$$module$js$nodes(c,"Swamp run possible")).option(X,Qc).option(X,Wd).option(X,ab),We=(new Condition$$module$js$nodes(c,"Insect possible to kill")).option($a),eb=(new Condition$$module$js$nodes(c,"Travel swamp")).option($a).option(I.value?
I:g,Ve),Xe=(new Condition$$module$js$nodes(c,"Calmed sea if required")).option(Fb).option(aa),Ye=(new Condition$$module$js$nodes(c,"Started windmill if required")).option(Oa).option(Sd),Ze=(new Condition$$module$js$nodes(c,"Telepathy if required for Deo")).option(la).option(Ud),$e=e(0,"Vampire 1",X).get(xb),af=e(1,"Insect",gc,Ie,We).get(Ua),bf=e(2,"Kelbesque 1",Xc,Uc).get(Va),cf=e(12,"Vampire 2",Je).get(ke),$c=e(4,"Sabera 1",Yc,Vc).get(nc),df=e(5,"Mado 1",Zc,Wc).get(Ya),ef=e(6,"Kelbesque 2",Xc,Uc).get(vb),
ff=e(7,"Sabera 2",Yc,Vc).get(ub),gf=e(8,"Mado 2",Zc,Wc).get(sb),hf=e(9,"Karmine",Ue,Pe).get(Bb),jf=e(10,"Draygon 1",X).get(ee),kf=e(-1,"Statues",sc,rc),lf=e(11,"Draygon 2",X,tc),mf=e(13,"Dyna",rb),nf=(new Condition$$module$js$nodes(c,"Opened prison if required")).option(zb).option(Rd),ca=new Area$$module$js$nodes(c,"Leaf"),Ba=new Area$$module$js$nodes(c,"Valley of Wind"),Z=new Area$$module$js$nodes(c,"Sealed Cave"),ua=new Area$$module$js$nodes(c,"Cordel Plain"),Ca=new Area$$module$js$nodes(c,"Brynmaer"),
Da=new Area$$module$js$nodes(c,"Amazones"),G=new Area$$module$js$nodes(c,"Mt Sabre West"),x=new Area$$module$js$nodes(c,"Mt Sabre North"),fb=new Area$$module$js$nodes(c,"Nadare's"),Pa=new Area$$module$js$nodes(c,"Oak"),ma=new Area$$module$js$nodes(c,"Waterfall Valley"),D=new Area$$module$js$nodes(c,"Portoa"),na=new Area$$module$js$nodes(c,"Waterfall Cave"),H=new Area$$module$js$nodes(c,"Fog Lamp Cave"),oa=new Area$$module$js$nodes(c,"Kirisa Plant Cave"),va=new Area$$module$js$nodes(c,"Angry Sea"),
pa=new Area$$module$js$nodes(c,"Joel"),M=new Area$$module$js$nodes(c,"Evil Spirit Island"),qa=new Area$$module$js$nodes(c,"Sabera's Castle"),da=new Area$$module$js$nodes(c,"Swan"),A=new Area$$module$js$nodes(c,"Mt Hydra"),ra=new Area$$module$js$nodes(c,"Shyron"),wa=new Area$$module$js$nodes(c,"Styx"),xa=new Area$$module$js$nodes(c,"Goa"),gb=new Area$$module$js$nodes(c,"Draygonia Fortress 1"),ea=new Area$$module$js$nodes(c,"Draygonia Fortress 2"),Ea=new Area$$module$js$nodes(c,"Draygonia Fortress 3"),
T=new Area$$module$js$nodes(c,"Draygonia Fortress 4"),K=new Area$$module$js$nodes(c,"Oasis Cave"),fa=new Area$$module$js$nodes(c,"Sahara"),Fa=new Area$$module$js$nodes(c,"Pyramid Front"),ia=new Area$$module$js$nodes(c,"Pyramid Back"),ja=new Area$$module$js$nodes(c,"Tower"),Ib=(new Location$$module$js$nodes(c,0,ca,"Start")).overworld().start(),of=(new Location$$module$js$nodes(c,0,ca,"Mezame Shrine")).overworld().from(Ib),pf=(new Location$$module$js$nodes(c,1,ca,"Outside Start")).overworld().connect(of),
sa=(new Location$$module$js$nodes(c,2,ca,"Town")).town().connect(pf),Qa=(new Location$$module$js$nodes(c,3,Ba,"Main")).overworld().connect(sa).trigger(yc,Oa),ad=(new Location$$module$js$nodes(c,3,Ba,"Outside Windmill")).overworld(),bd=(new Location$$module$js$nodes(c,4,Z,"Tunnel 1 (entrance)")).cave().from(Qa,Oa),qf=(new Location$$module$js$nodes(c,5,Z,"Tunnel 2 (over bridge)")).cave().connect(bd),rf=(new Location$$module$js$nodes(c,6,Z,"Tunnel 6 (herb dead end)")).cave().chest(J,15),cd=(new Location$$module$js$nodes(c,
7,Z,"Tunnel 4a (ball corridor)")).cave().chest(J,20,80).chest(La,21);(new Location$$module$js$nodes(c,7,Z,"Tunnel 4b (antidote dead end)")).cave().connect(cd,y).chest(O,19);const sf=(new Location$$module$js$nodes(c,8,Z,"Tunnel 5 (warp boots dead end)")).cave().chest(W,14),tf=(new Location$$module$js$nodes(c,9,Z,"Tunnel 3a (branch, front)")).cave().connect(qf).connectTo(cd).connectTo(sf),uf=(new Location$$module$js$nodes(c,9,Z,"Tunnel 3b (branch, back)")).cave().connect(tf,y).connectTo(rf),vf=(new Location$$module$js$nodes(c,
10,Z,"Tunnel 7 (boss)")).cave().connect(uf).boss($e),wf=(new Location$$module$js$nodes(c,12,Z,"Tunnel 8a (exit, above wall)")).cave().connect(vf),xf=(new Location$$module$js$nodes(c,12,Z,"Tunnel 8b (exit, below wall")).cave().connect(wf,y);(new Location$$module$js$nodes(c,14,Ba,"Windmill Cave")).cave().connect(Qa).connectTo(ad).trigger(le,yb,Cb);(new Location$$module$js$nodes(c,15,Ba,"Windmill")).misc().connect(ad).trigger(Oa,jc);const yf=(new Location$$module$js$nodes(c,16,Ba,"Zebu's Cave Front")).cave().connect(Qa).trigger(Cb,
wc,xc).trigger(yc,Oa,Cb),zf=(new Location$$module$js$nodes(c,16,Ba,"Zebu's Cave Back")).cave().trigger(Bc).connect(yf,z),Af=(new Location$$module$js$nodes(c,17,G,"Tunnel 1 (to Zebu)")).cave().connect(zf),Ga=(new Location$$module$js$nodes(c,20,ua,"West")).overworld().connect(xf,Ye),Bf=(new Location$$module$js$nodes(c,20,ua,"South")).overworld().connect(Ga,w),dd=(new Location$$module$js$nodes(c,21,ua,"East")).overworld().connect(Ga).chest(fc,24),Ra=(new Location$$module$js$nodes(c,24,Ca,"Town")).town().connect(Ga).trigger(me,
fc),Cf=(new Location$$module$js$nodes(c,25,ua,"Outside Stom's House")).town().connect(Ga),Jb=(new Location$$module$js$nodes(c,26,ua,"Swamp")).overworld().connect(dd,eb).trigger(Db,Ac,eb);(new Location$$module$js$nodes(c,26,ua,"Swamp Insect Area")).overworld().connect(Jb,eb).boss(af);const hb=(new Location$$module$js$nodes(c,27,Da,"Town")).town().connect(Bf),ib=(new Location$$module$js$nodes(c,28,Pa,"Town")).town().connect(Jb,eb).trigger(zc);(new Location$$module$js$nodes(c,30,ua,"Stom's House")).house().connect(Cf).trigger(ne,
zc);const Ha=(new Location$$module$js$nodes(c,32,G,"Entrance")).overworld().connect(Ga).connect(Af),Df=(new Location$$module$js$nodes(c,32,G,"Up Slope")).overworld().from(Ha,Rc).to(Ha),Ef=(new Location$$module$js$nodes(c,32,G,"Dead End (warp boots)")).overworld().chest(W,24,106),ed=(new Location$$module$js$nodes(c,33,G,"Upper")).overworld().from(Ha,F).to(Ha),Ff=(new Location$$module$js$nodes(c,33,G,"Tornel Dead End")).overworld().trigger(qe,La,Ma).chest(ba,23,105),fd=(new Location$$module$js$nodes(c,
34,G,"Tunnel 2a (fork at start)")).cave().connect(Ha);(new Location$$module$js$nodes(c,34,G,"Tunnel 2b (left branch to dead end)")).cave().connect(fd,z).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,G,"Tunnel 2c (right branch to upper)")).cave().connect(fd,z),Hf=(new Location$$module$js$nodes(c,35,G,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(J,23,82),If=(new Location$$module$js$nodes(c,35,G,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,
z).connectTo(ed),gd=(new Location$$module$js$nodes(c,36,G,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,G,"Tunnel 4b (out to upper)")).cave().connect(gd,z).connectTo(ed);const Jf=(new Location$$module$js$nodes(c,37,G,"Tunnel 5 (tiny connector)")).cave().connect(gd),Kf=(new Location$$module$js$nodes(c,38,G,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);(new Location$$module$js$nodes(c,38,G,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,
z).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,39,G,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,G,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,z);(new Location$$module$js$nodes(c,39,G,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,z).chest(Ma,25);const jb=(new Location$$module$js$nodes(c,40,x,"Entrance")).overworld().connect(dd,Le,Ke),kb=(new Location$$module$js$nodes(c,40,x,"Upper")).overworld().from(jb,F).to(jb),
Kb=(new Location$$module$js$nodes(c,40,x,"Summit (boss)")).overworld().from(kb,F).to(kb).boss(bf),hd=(new Location$$module$js$nodes(c,41,x,"Connector")).overworld(),Lb=(new Location$$module$js$nodes(c,41,x,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,x,"Middle Right")).overworld().from(Lb,Rc).to(Lb),id=(new Location$$module$js$nodes(c,42,x,"Tunnel 2a (from entrance to connector)")).cave().connectTo(hd);(new Location$$module$js$nodes(c,42,x,"Tunnel 2b (under bridge, to antidote)")).cave().connect(id,
z).chest(O,23,94);const jd=(new Location$$module$js$nodes(c,43,x,"Tunnel 3a (branch after connector)")).cave().connect(hd),Of=(new Location$$module$js$nodes(c,43,x,"Tunnel 3b (right branch)")).cave().connect(jd,z),Pf=(new Location$$module$js$nodes(c,43,x,"Tunnel 3c (upper branch)")).cave().connect(jd,z);(new Location$$module$js$nodes(c,44,x,"Tunnel 4 (over bridge, to middle)")).cave().connect(Pf).connectTo(Lb);const kd=(new Location$$module$js$nodes(c,45,x,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Of).connectTo(Nf);
(new Location$$module$js$nodes(c,45,x,"Tunnel 5b (dead-end with herb)")).cave().connect(kd,z).chest(J,22,83);const Qf=(new Location$$module$js$nodes(c,46,x,"Tunne; 6a (S-shaped hall, right)")).cave().connect(kd),Rf=(new Location$$module$js$nodes(c,46,x,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Qf,z),Sf=(new Location$$module$js$nodes(c,46,x,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Rf,z),ld=(new Location$$module$js$nodes(c,47,x,"Prison (hallway)")).cave().connect(kb),Tf=(new Location$$module$js$nodes(c,
48,x,"Left Cell (shopkeepers)")).cave().from(ld,z);(new Location$$module$js$nodes(c,49,x,"Left Cell 2 (back, with prison key)")).cave().from(Tf,z).chest(zb,13);const Uf=(new Location$$module$js$nodes(c,50,x,"Right Cell (villagers)")).cave().from(ld,z),Vf=(new Location$$module$js$nodes(c,51,x,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Uf,z);(new Location$$module$js$nodes(c,52,x,"Tunnel 9 (connector to summit)")).cave().connect(Vf).connectTo(Kb);const Wf=(new Location$$module$js$nodes(c,
53,x,"Summit Cave (front)")).cave().from(Kb,zb).to(Kb),Xf=(new Location$$module$js$nodes(c,53,x,"Summit Cave (behind ice)")).cave().connect(Wf,z).trigger(re);(new Location$$module$js$nodes(c,56,x,"Tunnel 1 (leads from main entrance)")).cave().connect(jb).connectTo(id);(new Location$$module$js$nodes(c,57,x,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(kb);const Yf=(new Location$$module$js$nodes(c,60,fb,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,fb,"Tool Shop")).shop(J,O,R,W),$f=(new Location$$module$js$nodes(c,
62,fb,"Back Room")).house(),Mb=(new Location$$module$js$nodes(c,64,ma,"Summit")).overworld().connect(Xf,nf),lb=(new Location$$module$js$nodes(c,64,ma,"Northwest")).overworld().from(Mb).to(Mb,F),ag=(new Location$$module$js$nodes(c,64,ma,"Northeast")).overworld().connect(lb,w),md=(new Location$$module$js$nodes(c,65,ma,"Southwest")).overworld().connect(lb),bg=(new Location$$module$js$nodes(c,65,ma,"Southeast")).overworld().connect(md,w),nd=(new Location$$module$js$nodes(c,66,ma,"Lime Tree Valley")).overworld().connect(md).connect(Qa,
Vd),cg=(new Location$$module$js$nodes(c,67,ma,"Lime Tree Lake (Rage)")).cave().connect(nd).trigger(Gc,Q),dg=(new Location$$module$js$nodes(c,68,oa,"Tunnel 1a (entrance)")).cave().connect(bg),eg=(new Location$$module$js$nodes(c,68,oa,"Tunnel 1b (behind wall)")).cave().connect(dg,y),od=(new Location$$module$js$nodes(c,69,oa,"Tunnel 2a (main path, before wall)")).cave().connect(eg);(new Location$$module$js$nodes(c,69,oa,"Tunnel 2b (dead end, antidote)")).cave().connect(od,y).chest(O,25,95);const fg=
(new Location$$module$js$nodes(c,69,oa,"Tunnel 2c (main path, after wall)")).cave().connect(od,y),gg=(new Location$$module$js$nodes(c,70,oa,"Tunnel 3a (last room, before wall)")).cave().connect(fg),hg=(new Location$$module$js$nodes(c,70,oa,"Tunnel 3b (last room, after wall)")).cave().connect(gg,y);(new Location$$module$js$nodes(c,71,oa,"Meadow")).overworld().connect(hg).chest(qc,14);const ig=(new Location$$module$js$nodes(c,72,H,"Tunnel 1a (entrance)")).cave().connect(ag),pd=(new Location$$module$js$nodes(c,
72,H,"Tunnel 1b (past wall)")).cave().connect(ig,y);(new Location$$module$js$nodes(c,72,H,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(pd,y).chest(za,24);const jg=(new Location$$module$js$nodes(c,73,H,"Tunnel 2 (tiny connector)")).cave().connect(pd),qd=(new Location$$module$js$nodes(c,74,H,"Tunnel 3a (upper branch)")).cave().connect(jg);(new Location$$module$js$nodes(c,74,H,"Tunnel 3b (dead end, mimic)")).cave().connect(qd,y).chest(S,21,112);const rd=(new Location$$module$js$nodes(c,74,H,"Tunnel 3c (short passage with mimic)")).cave().connect(qd,
y).chest(S,22,113),kg=(new Location$$module$js$nodes(c,74,H,"Tunnel 3d (lower branch)")).cave().connect(rd,y);(new Location$$module$js$nodes(c,75,H,"Dead end loop")).cave().connect(kg);const sd=(new Location$$module$js$nodes(c,76,H,"Tunnel 4a (right branch over bridge)")).cave().connect(rd),lg=(new Location$$module$js$nodes(c,76,H,"Tunnel 4b (past wall over bridge)")).cave().connect(sd,y),mg=(new Location$$module$js$nodes(c,77,H,"Tunnel 5a (from left branch)")).cave().connect(sd),ng=(new Location$$module$js$nodes(c,
77,H,"Tunnel 5b (reconvergence)")).cave().connect(mg,y).connect(lg),og=(new Location$$module$js$nodes(c,77,H,"Tunnel 5c (between walls)")).cave().connect(ng,y),pg=(new Location$$module$js$nodes(c,77,H,"Tunnel 5d (under bridge)")).cave().connect(og,y),qg=(new Location$$module$js$nodes(c,78,H,"Tunnel 6a (over second bridge)")).cave().connect(pg),rg=(new Location$$module$js$nodes(c,78,H,"Tunnel 6b (past wall)")).cave().connect(qg,y),sg=(new Location$$module$js$nodes(c,79,H,"Tunnel 7a (under second bridge)")).cave().connect(rg);
(new Location$$module$js$nodes(c,79,H,"Tunnel 7b (fog lamp)")).cave().connect(sg,y).chest(lc,19);const ya=(new Location$$module$js$nodes(c,80,D,"Town")).town().connect(lb),td=(new Location$$module$js$nodes(c,81,D,"Fishherman Island")).town().connect(ya);(new Location$$module$js$nodes(c,82,ma,"Mesia Shrine")).cave().trigger(Hc).connect(cg,w,Gc);const ud=(new Location$$module$js$nodes(c,84,na,"Tunnel 1a (entrance)")).cave().connect(lb);(new Location$$module$js$nodes(c,84,na,"Tunnel 1b (dead end, mimic)")).cave().connect(ud,
z).chest(S,19,114);const tg=(new Location$$module$js$nodes(c,84,na,"Tunnel 1c (past ice)")).cave().connect(ud,z),ug=(new Location$$module$js$nodes(c,85,na,"Tunnel 2 (stoned pair)")).cave().connect(tg),Nb=(new Location$$module$js$nodes(c,86,na,"Tunnel 3 (wide medusa hallways)")).cave().connect(ug,Qe),vg=(new Location$$module$js$nodes(c,87,na,"Tunnel 4a (left entrance)")).cave().from(Nb,z).chest(bc.chest().bonus(),25).trigger(te,wb);(new Location$$module$js$nodes(c,87,na,"Tunnel 4b (right entrance)")).cave().from(Nb,
z).connect(vg,F);(new Location$$module$js$nodes(c,87,na,"Tunnel 4c (sword of water)")).cave().connect(Nb,z).chest(Q,24);const vd=(new Location$$module$js$nodes(c,88,ja,"Entrance")).misc(),wg=(new Location$$module$js$nodes(c,89,ja,"Level 1")).misc().from(vd),xg=(new Location$$module$js$nodes(c,90,ja,"Level 2")).misc().from(wg),yg=(new Location$$module$js$nodes(c,91,ja,"Level 3")).misc().from(xg),wd=(new Location$$module$js$nodes(c,92,ja,"Outside Mesia Room")).misc().from(yg),zg=(new Location$$module$js$nodes(c,
93,ja,"Outside Dyna Room")).misc().from(wd,rb);(new Location$$module$js$nodes(c,94,ja,"Mesia")).misc().connect(wd).trigger(Ee);const Ag=(new Location$$module$js$nodes(c,95,ja,"Dyna")).misc().from(zg).boss(mf);(new Location$$module$js$nodes(c,95,ja,"Win")).misc().from(Ag).end();const Ob=(new Location$$module$js$nodes(c,96,va,"Cabin Beach")).sea().from(td,Eb),Ia=(new Location$$module$js$nodes(c,96,va,"South")).sea().connect(Ob,ha),Bg=(new Location$$module$js$nodes(c,96,va,"Joel Beach")).sea().connect(Ia,
ha),xd=(new Location$$module$js$nodes(c,96,pa,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(c,96,va,"Altar")).sea().connect(Ia,ha).trigger(Fb,oc,nc);const Cg=(new Location$$module$js$nodes(c,96,va,"North")).sea().to(Ia,ha).from(Ia,ha,Oe).trigger(we,Xe),Dg=(new Location$$module$js$nodes(c,96,va,"Swan Beach")).sea().connect(Cg,ha);(new Location$$module$js$nodes(c,97,va,"Cabin")).misc().connect(Ob).trigger(Kc,Eb);(new Location$$module$js$nodes(c,98,pa,"Lighthouse")).misc().connect(xd).trigger(ve,
yb);const mb=(new Location$$module$js$nodes(c,100,D,"Underground Channel 1 (from throne room)")).sea().trigger(Fc),Eg=(new Location$$module$js$nodes(c,100,D,"Underground Channel 2 (to fortune teller)")).sea().connect(mb,w),yd=(new Location$$module$js$nodes(c,100,D,"Underground Channel 3 (from fortune teller)")).sea().connect(mb,F),zd=(new Location$$module$js$nodes(c,100,D,"Underground Channel 4 (asina)")).sea().connect(yd,w),Fg=(new Location$$module$js$nodes(c,100,D,"Underground Channel 5 (dolphin)")).sea().connect(zd,
w).trigger(Jc,J,Ic);(new Location$$module$js$nodes(c,100,D,"Underground Channel 6 (water)")).sea().connect(Fg,ha).connectTo(Ia,ha).chest(pc,17);const Pb=(new Location$$module$js$nodes(c,101,M,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,M,"Tunnel 1 (entrance)")).sea().connect(Ia,Lc,ha),Ad=(new Location$$module$js$nodes(c,105,M,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,M,"Tunnel 2b (dead end to left)")).cave().connect(Ad,w);const Hg=(new Location$$module$js$nodes(c,
105,M,"Tunnel 2c (across first river)")).cave().connect(Ad,w),Bd=(new Location$$module$js$nodes(c,105,M,"Tunnel 2d (across second river)")).cave().connect(Hg,w);(new Location$$module$js$nodes(c,105,M,"Tunnel 2e (dead end, magic ring)")).cave().connect(Bd,y).chest(ba,29);const Ig=(new Location$$module$js$nodes(c,105,M,"Tunnel 2f (stair down)")).cave().connect(Bd,y),Jg=(new Location$$module$js$nodes(c,106,M,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(Pb).chest(za,25,92),Kg=(new Location$$module$js$nodes(c,
106,M,"Tunnel 3b (left area toward items)")).cave().connect(Jg,y),Lg=(new Location$$module$js$nodes(c,107,M,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(S,14,115);(new Location$$module$js$nodes(c,107,M,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,w).chest(he,15);const Qb=(new Location$$module$js$nodes(c,108,qa,"Floor 1")).fortress().connect(Pb),Mg=(new Location$$module$js$nodes(c,108,qa,"Miniboss")).fortress().boss(cf).connect(Qb);(new Location$$module$js$nodes(c,109,qa,
"Floor 2a (left stair)")).fortress().connect(Qb).chest(R,19);const Ng=(new Location$$module$js$nodes(c,109,qa,"Floor 2b (right stair)")).fortress().connect(Mg).chest(J,30,85),Og=(new Location$$module$js$nodes(c,110,qa,"Floor 3a (toward boss)")).fortress().connect(Ng),Cd=(new Location$$module$js$nodes(c,110,qa,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$js$nodes(c,110,qa,"Boss")).fortress().boss($c).connect(Cd);(new Location$$module$js$nodes(c,110,qa,"Floor 3c (back room trap)")).fortress().from(Cd).to(Qb);
const Pg=(new Location$$module$js$nodes(c,112,pa,"Secret Passage")).cave().connectTo(xd),nb=(new Location$$module$js$nodes(c,113,pa,"Town")).town().connect(Bg),ka=(new Location$$module$js$nodes(c,114,da,"Town")).town().connect(Dg),Qg=(new Location$$module$js$nodes(c,115,da,"Inside Gate")).overworld().connect(ka),Rg=(new Location$$module$js$nodes(c,115,da,"Outside Gate")).overworld().from(Qg,ta),ob=(new Location$$module$js$nodes(c,120,xa,"Valley")).overworld().connect(Rg),Rb=(new Location$$module$js$nodes(c,
124,A,"Entrance")).overworld().connect(ob),Sg=(new Location$$module$js$nodes(c,124,A,"Over first river toward Shyron")).overworld().connect(Rb,w),Dd=(new Location$$module$js$nodes(c,124,A,"After first tunnel")).overworld(),Ed=(new Location$$module$js$nodes(c,124,A,"Door to Styx")).overworld().connect(Dd,w),Tg=(new Location$$module$js$nodes(c,124,A,"Dead end (no item)")).overworld(),Ug=(new Location$$module$js$nodes(c,124,A,"Dead end (fruit of lime)")).overworld().chest(tb,26),Vg=(new Location$$module$js$nodes(c,
124,A,"Dead end (magic ring)")).overworld().chest(ba,25,101),Fd=(new Location$$module$js$nodes(c,124,A,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(c,124,A,"Floating island (bow of sun)")).overworld().connect(Fd,F).chest(sc,24);const Wg=(new Location$$module$js$nodes(c,125,A,"Tunnel 1 (to Shyron)")).cave().connect(Sg),Xg=(new Location$$module$js$nodes(c,126,A,"Outside Shyron")).overworld().connect(Wg);(new Location$$module$js$nodes(c,127,A,"Tunnel 2 (fork)")).cave().connect(Rb).connectTo(Ug).connectTo(Dd);
const Gd=(new Location$$module$js$nodes(c,128,A,"Tunnel 3 (caves)")).cave().connect(Ed).connect(Tg),Hd=(new Location$$module$js$nodes(c,129,A,"Tunnel 4 (left branch of cave)")).cave().connect(Gd);(new Location$$module$js$nodes(c,130,A,"Tunnel 5 (dead end, medical herb)")).cave().connect(Hd).chest(J,15,86);const Yg=(new Location$$module$js$nodes(c,131,A,"Tunnel 6a (left-then-right)")).cave().connect(Hd),Zg=(new Location$$module$js$nodes(c,131,A,"Tunnel 6b (past wall)")).cave().connect(Yg,y),$g=(new Location$$module$js$nodes(c,
132,A,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,A,"Tunnel 8 (red slimes)")).cave().from($g,y).connectTo(Fd).chest(S,23,116);const ah=(new Location$$module$js$nodes(c,134,A,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Gd),bh=(new Location$$module$js$nodes(c,135,A,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,135,A,"Tunnel 10b (past wall)")).cave().connect(bh,y).connectTo(Vg);const Id=(new Location$$module$js$nodes(c,
136,wa,"Entrance")).fortress().from(Ed,kc,Hb),ch=(new Location$$module$js$nodes(c,137,wa,"Left branch")).fortress().connect(Id).chest(S,19,117),dh=(new Location$$module$js$nodes(c,137,wa,"Left branch, past one bridge")).fortress().connect(ch,w),eh=(new Location$$module$js$nodes(c,137,wa,"Left branch, past two bridges")).fortress().connect(dh,w).chest(J,29,87),fh=(new Location$$module$js$nodes(c,137,wa,"Right branch")).fortress().connect(Id);(new Location$$module$js$nodes(c,137,wa,"Right branch, across water")).fortress().connect(fh,
F).chest(S,20,118).chest(S,21,119).chest(Zd,28);(new Location$$module$js$nodes(c,138,wa,"Upper floor")).fortress().connect(eh).chest(N,27);const Ja=(new Location$$module$js$nodes(c,140,ra,"Town")).town().connect(Xg,Re).trigger(Gb),Sa=(new Location$$module$js$nodes(c,142,xa,"Town")).town().connect(ob),Jd=(new Location$$module$js$nodes(c,143,K,"Draygonia Fortress Basement 1 (front)")).fortress();(new Location$$module$js$nodes(c,143,K,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Jd,
Aa).chest(fe,15);const Sb=(new Location$$module$js$nodes(c,144,xa,"Desert 1")).overworld().connect(ob),pb=(new Location$$module$js$nodes(c,145,K,"Area 1 (from entrance)")).cave().chest(hc,26),Kd=(new Location$$module$js$nodes(c,145,K,"Area 2 (across top bridge)")).cave().connect(pb,w);(new Location$$module$js$nodes(c,145,K,"Area 3 (dead-end across top-right bridge)")).cave().connect(Kd,w);const gh=(new Location$$module$js$nodes(c,145,K,"Area 4 (left across middle-right bridge)")).cave().connect(Kd,
w),hh=(new Location$$module$js$nodes(c,145,K,"Area 5 (bottom edge)")).cave().connect(gh,w),ih=(new Location$$module$js$nodes(c,145,K,"Area 6 (bottom island)")).cave().connect(hh,w),jh=(new Location$$module$js$nodes(c,145,K,"Area 7 (bottom inner ring)")).cave().connect(ih,w),kh=(new Location$$module$js$nodes(c,145,K,"Area 8 (left outer ring)")).cave().connect(jh,w).connect(pb,w).chest(R,27,100),lh=(new Location$$module$js$nodes(c,145,K,"Area 9 (top left inner ring)")).cave().connect(kh,w),mh=(new Location$$module$js$nodes(c,
145,K,"Area 10 (top right inner ring)")).cave().connect(lh,w);(new Location$$module$js$nodes(c,145,K,"Area 11 (center)")).cave().connect(mh,w).connectTo(Jd);(new Location$$module$js$nodes(c,145,K,"Area 12 (top center islands)")).cave().connect(pb,F).chest(de,28);const nh=(new Location$$module$js$nodes(c,146,fa,"Desert Cave 1")).cave().connect(Sb,F),Ka=(new Location$$module$js$nodes(c,147,fa,"Town")).town(),oh=(new Location$$module$js$nodes(c,148,fa,"Outside Cave")).overworld().connect(Ka),ph=(new Location$$module$js$nodes(c,
149,fa,"Desert Cave 2")).cave().connect(oh);(new Location$$module$js$nodes(c,150,fa,"Meadow")).overworld().connect(nh).connectTo(Ka).trigger(Be,ta,Ze);const Tb=(new Location$$module$js$nodes(c,152,fa,"Desert 2")).overworld().connect(ph),qh=(new Location$$module$js$nodes(c,156,Fa,"Entrance")).fortress().connect(Tb,F),rh=(new Location$$module$js$nodes(c,156,Fa,"Azteca")).fortress().trigger(De),sh=(new Location$$module$js$nodes(c,157,Fa,"Fork")).fortress().connect(qh),Ld=(new Location$$module$js$nodes(c,
158,Fa,"Main")).fortress().connect(sh);(new Location$$module$js$nodes(c,158,Fa,"Treasure Chest (magic ring)")).fortress().connect(Ld).chest(ba,27,108);(new Location$$module$js$nodes(c,159,Fa,"Draygon")).fortress().connect(Ld).to(rh).boss(jf);const th=(new Location$$module$js$nodes(c,160,ia,"Entrance")).fortress().connect(Tb,F),uh=(new Location$$module$js$nodes(c,160,ia,"Statues")).fortress().connect(th).boss(kf),vh=(new Location$$module$js$nodes(c,161,ia,"Hall 1")).fortress().connect(uh),Ub=(new Location$$module$js$nodes(c,
162,ia,"Branch")).fortress().connect(vh);(new Location$$module$js$nodes(c,163,ia,"Left Dead End")).fortress().connect(Ub).chest(S,13,120);(new Location$$module$js$nodes(c,164,ia,"Right Dead End")).fortress().connect(Ub);const wh=(new Location$$module$js$nodes(c,165,ia,"Hall 2")).fortress().connect(Ub).chest(vb,26,109),xh=(new Location$$module$js$nodes(c,166,ia,"Draygon 2")).fortress().connect(wh).boss(lf);(new Location$$module$js$nodes(c,167,ia,"Teleporter")).fortress().from(xh).to(vd);const Md=(new Location$$module$js$nodes(c,
168,gb,"Entrance")).fortress().connect(Sa,Hb).trigger(Pc,N),yh=(new Location$$module$js$nodes(c,169,gb,"Main")).fortress().from(Md,Aa),zh=(new Location$$module$js$nodes(c,169,gb,"Boss")).fortress().connect(yh).boss(ef),Ah=(new Location$$module$js$nodes(c,170,gb,"Zebu")).fortress().connect(zh),qb=(new Location$$module$js$nodes(c,171,ea,"Entrance")).fortress().connect(Ah);(new Location$$module$js$nodes(c,171,ea,"Dead End Behind Iron (fruit of power)")).fortress().connect(qb,Aa).chest(R,28,98);(new Location$$module$js$nodes(c,
171,ea,"Dead End Loop Across Closer Bridges")).fortress().connect(qb,w).connect(qb,w);const Bh=(new Location$$module$js$nodes(c,171,ea,"Across First Bridge (fruit of repun)")).fortress().connect(qb,w).chest(ub,30,102),Vb=(new Location$$module$js$nodes(c,171,ea,"Across Second Bridge")).fortress().connect(Bh,w);(new Location$$module$js$nodes(c,171,ea,"Dead End Across Two Bridges ()")).fortress().connect(Vb,w).connect(Vb,w).chest(za,29,93);const Ch=(new Location$$module$js$nodes(c,171,ea,"Across Third Bridge")).fortress().connect(Vb,
w),Dh=(new Location$$module$js$nodes(c,171,ea,"Exit Behind Iron Door")).fortress().connect(Ch,Aa),Eh=(new Location$$module$js$nodes(c,172,ea,"Boss")).fortress().connect(Dh).boss(ff),Fh=(new Location$$module$js$nodes(c,172,ea,"Tornel")).fortress().connect(Eh),Nd=(new Location$$module$js$nodes(c,173,Ea,"Lower")).fortress().connect(Fh).chest(vb,26,99).chest(ba,27,111),Gh=(new Location$$module$js$nodes(c,174,Ea,"Upper Loop")).fortress().connect(Nd).chest(O,22,96);(new Location$$module$js$nodes(c,174,
Ea,"Upper Loop Behind Wall (magic ring)")).fortress().connect(Gh,Aa).chest(ba,23,107);const Hh=(new Location$$module$js$nodes(c,175,Ea,"Upper Passage (toward Mado)")).fortress().connect(Nd).chest(ba,27,84),Wb=(new Location$$module$js$nodes(c,176,T,"Initial Fork")).fortress(),Ih=(new Location$$module$js$nodes(c,177,T,"Left Branch")).fortress().connect(Wb),Od=(new Location$$module$js$nodes(c,178,T,"Main Area (right branch, over bridges)")).fortress().connect(Wb),Jh=(new Location$$module$js$nodes(c,
179,T,"U-shaped Passage (between floors)")).fortress().connect(Od),Kh=(new Location$$module$js$nodes(c,180,T,"Main Area Lower (under bridge)")).fortress().connect(Ih).connect(Od).connect(Jh),Pd=(new Location$$module$js$nodes(c,180,T,"Behind Iron Wall")).fortress().connect(Kh,Aa),Lh=(new Location$$module$js$nodes(c,181,T,"Lower")).fortress().connect(Pd).chest(S,13,121).chest(S,14,122).chest(S,15,123).chest(ba,23,88).chest(W,24,110),Mh=(new Location$$module$js$nodes(c,182,T,"Boss Corridor")).fortress().connect(Lh),
Nh=(new Location$$module$js$nodes(c,182,T,"Boss")).fortress().connect(Mh,Hb).boss(hf);(new Location$$module$js$nodes(c,182,T,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(Za,18);const Qd=(new Location$$module$js$nodes(c,183,T,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,184,K,"Entrance Back (behind river)")).cave().connect(Qd).chest(R,13,90);(new Location$$module$js$nodes(c,184,K,"Entrance Front")).cave().connect(Oh,F).connectTo(Sb).connectTo(pb);const Ph=(new Location$$module$js$nodes(c,
185,Ea,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$js$nodes(c,185,Ea,"Asina")).fortress().connect(Ph).connectTo(Wb);(new Location$$module$js$nodes(c,186,T,"Kensu")).fortress().connect(Pd).connectTo(Qd).trigger(Ae,Bb);(new Location$$module$js$nodes(c,187,xa,"House")).house().connect(Sa).trigger(Ce,ta,Bb);(new Location$$module$js$nodes(c,188,xa,"Inn")).shop().connect(Sa,Gb);(new Location$$module$js$nodes(c,190,xa,"Tool Shop")).shop(J,O,W,R).connect(Sa,Gb);(new Location$$module$js$nodes(c,
191,xa,"Tavern")).shop().connect(Sa);(new Location$$module$js$nodes(c,192,ca,"Elder House")).house().connect(sa).trigger(wc);(new Location$$module$js$nodes(c,193,ca,"Rabbit Hut")).house().connect(sa).trigger(Cc,Bc,la);(new Location$$module$js$nodes(c,194,ca,"Inn")).shop().connect(sa);(new Location$$module$js$nodes(c,195,ca,"Tool Shop")).shop(J,O,W,R).connect(sa);(new Location$$module$js$nodes(c,196,ca,"Armor Shop")).shop($d,$b).connect(sa);(new Location$$module$js$nodes(c,197,ca,"Student House")).house().connect(sa).trigger(xc);
(new Location$$module$js$nodes(c,198,Ca,"Tavern")).house().connect(Ra);(new Location$$module$js$nodes(c,199,Ca,"Pawn Shop")).shop().connect(Ra);(new Location$$module$js$nodes(c,200,Ca,"Inn")).shop().connect(Ra);(new Location$$module$js$nodes(c,201,Ca,"Armor Shop")).shop(ae,$b,Xd).connect(Ra);(new Location$$module$js$nodes(c,203,Ca,"Tool Shop")).shop(J,O,W).connect(Ra);(new Location$$module$js$nodes(c,205,Pa,"Elder House")).house().from(ib,la).trigger(pe,Db);(new Location$$module$js$nodes(c,206,Pa,
"Mother's House")).house().from(ib,la).trigger(Ac,la).trigger(oe,Db);(new Location$$module$js$nodes(c,207,Pa,"Tool Shop")).shop(J,O,R).from(ib,la);(new Location$$module$js$nodes(c,208,Pa,"Inn")).shop().from(ib,la);(new Location$$module$js$nodes(c,209,Da,"Inn")).shop().connect(hb);(new Location$$module$js$nodes(c,210,Da,"Tool Shop")).shop(W,R,za).connect(hb);(new Location$$module$js$nodes(c,211,Da,"Armor Shop")).shop(dc,ac,bc,sb).connect(hb);const Qh=(new Location$$module$js$nodes(c,212,Da,"Queen's House")).house().from(hb,
Se).trigger(ye,ta,qc);(new Location$$module$js$nodes(c,213,fb,"Nadare's")).house().connect(jb).connectTo(Yf).connectTo(Zf).connectTo($f);(new Location$$module$js$nodes(c,214,D,"Fisherman's House")).house().connect(td).trigger(Eb,lc,Ab,Te);const Xb=(new Location$$module$js$nodes(c,215,D,"Palace Entrance")).house().connect(ya);(new Location$$module$js$nodes(c,216,D,"Fortune Teller Front")).house().connect(ya).trigger(Ec,Dc);(new Location$$module$js$nodes(c,216,D,"Fortune Teller Back")).house().connect(Eg).connect(yd);
(new Location$$module$js$nodes(c,217,D,"Pawn Shop")).shop().connect(ya);(new Location$$module$js$nodes(c,218,D,"Armor Shop")).shop(be,dc,ac).connect(ya);(new Location$$module$js$nodes(c,220,D,"Inn")).shop().connect(ya);(new Location$$module$js$nodes(c,221,D,"Tool Shop")).shop(J,za,tb,W).connect(ya);(new Location$$module$js$nodes(c,222,D,"Palace Left")).house().connect(Xb);(new Location$$module$js$nodes(c,223,D,"Palace Throne Room")).house().connect(Xb).to(mb,Me).from(mb).trigger(Dc).trigger(se,Ec,
Fc);(new Location$$module$js$nodes(c,224,D,"Palace Right")).house().connect(Xb);(new Location$$module$js$nodes(c,225,D,"Asina's Room")).house().connect(zd).trigger(Ic,Sc);(new Location$$module$js$nodes(c,226,Da,"Queen Downstairs")).house().connect(Qh).chest(Xa,13);(new Location$$module$js$nodes(c,227,pa,"Elder's House")).house().connect(nb).trigger(Lc);(new Location$$module$js$nodes(c,228,pa,"Shed")).house().connect(nb).to(Pg,mc);(new Location$$module$js$nodes(c,229,pa,"Tool Shop")).shop(J,O,R,za).connect(nb);
(new Location$$module$js$nodes(c,231,pa,"Inn")).shop().connect(nb);const Rh=(new Location$$module$js$nodes(c,232,M,"Zombie Town House")).house().connect(Pb);(new Location$$module$js$nodes(c,233,M,"Zombie Town Basement")).house().connect(Rh).trigger(ue,$c);(new Location$$module$js$nodes(c,235,da,"Tool Shop")).shop(J,O,R,W).connect(ka);(new Location$$module$js$nodes(c,236,da,"Stom's Hut")).house().connect(ka).trigger(Mc);(new Location$$module$js$nodes(c,237,da,"Inn")).shop().connect(ka);(new Location$$module$js$nodes(c,
238,da,"Armor Shop")).shop(ce,ec,Yd,cc).connect(ka);(new Location$$module$js$nodes(c,239,da,"Tavern")).house().connect(ka).trigger(Nc,Mc,Na);(new Location$$module$js$nodes(c,240,da,"Pawn Shop")).shop().connect(ka);(new Location$$module$js$nodes(c,241,da,"Dance Hall")).house().connect(ka).trigger(Oc,Nc,Na).trigger(xe,Oc,pc);const Sh=(new Location$$module$js$nodes(c,242,ra,"Temple (pre-massacre)")).fortress().connect(Ja).from(Ib,N,Td).trigger(ze);(new Location$$module$js$nodes(c,242,ra,"Temple (post-massacre)")).fortress().from(Sh,
Pc).boss(df);(new Location$$module$js$nodes(c,243,ra,"Training Hall")).house().connect(Ja);(new Location$$module$js$nodes(c,244,ra,"Hospital")).house().connect(Ja);(new Location$$module$js$nodes(c,245,ra,"Armor Shop")).shop(ec,sb,cc).connect(Ja);(new Location$$module$js$nodes(c,246,ra,"Tool Shop")).shop(J,O,tb,ba).connect(Ja);(new Location$$module$js$nodes(c,247,ra,"Inn")).shop().connect(Ja);(new Location$$module$js$nodes(c,248,fa,"Inn")).shop().connect(Ka);(new Location$$module$js$nodes(c,249,fa,
"Tool Shop")).shop(O,W,ub,ba).connect(Ka);(new Location$$module$js$nodes(c,250,fa,"Elder's House")).house().connect(Ka);(new Location$$module$js$nodes(c,251,fa,"Pawn Shop")).house().connect(Ka);const Th=[sa,Qa,bd,Ga,Jb,Ha,Mb,nd,Ob,ka,ob,Rb,Sb,Md,Tb];for(const a of Th)a.from(Ib,He);return c},shuffle$$module$js$depgraph=(a,b,c,d,e)=>{d=void 0===d?new FlagSet$$module$js$flagset("Sbkm Sct"):d;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d,a);d.shuffleShops()&&
f.shuffleShops(b);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&k.slots){var m=k.slotType[0];(h[m]=h[m]||[]).push(k)}k=[];m=[];var l={};for(var n of d.get("S")){var p=[];for(var q of n){l[q]=!0;for(var r of h[q])p.push(r),m.push([r,k.length])}k.push(p)}for(var t of"bc")if(l[t])for(n=h[t],q=n.map((a)=>[a.item,a.itemIndex]),b.shuffle(q),r=0;r<n.length;r++)n[r].set(q[r][0],q[r][1]);p=(a)=>g.find((b)=>
b.vanillaItemName===a);h=p("Sword of Wind");t=p("Sword of Fire");n=p("Ball of Wind");q=p("Ball of Fire");r=p("Statue of Onyx");p=p("Gas Mask");l.k&&b.nextInt(2)&&(t.swap(h),q.swap(n));l.k&&!b.nextInt(3)&&r.swap(p);l=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(t=0;1E3>t;t++){e&&0===t%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));b.shuffle(m);for(var u of k)b.shuffle(u);n=k.map(()=>-1);q=l[b.nextInt(l.length)];r=[];p=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||
...
a.slots&&!a.isFixed());const m=new Map(d.shuffle(k.map((a)=>[a,[a.item,a.itemIndex]]))),l=new Set(d.shuffle(k)),n=new Map,p={};g&&g.seeds++;f.get("S").forEach((a,b)=>{for(const c of a)p[c]=b});for(var q of l)n.set(q.item,q);const r=new Set,t=(a,b)=>{if(null==p[a.slotType?a.slotType[0]:"c"])return a===b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!==b.item.inventoryRow&&a.requiresUnique||"armor"===b.item.inventoryRow&&!a.isChest())return!1;if(f.guaranteeSword()){if(0===a.slotIndex)return 4>b.item.id;
if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return p[a.slotType?a.slotType[0]:"c"]===p[b.slotType?b.slotType[0]:"c"]};q=b.assumedFill(d,(a,b)=>t(a,n.get(b)));if(null==q){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const u=new Map;for(var B=0;B<q.length;B++){var L=q[B];if(null!=L){var C=n.get(b.item(L));L=m.get(C);m.delete(C);C=b.location(B);u.set(C,L);l.delete(C)}}B=(a,b,c)=>{c=void 0===c?"":c;for(const c of l)if(t(c,a))return u.set(c,b),l.delete(c),m.delete(a),!0;
g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var E of m){const [a,b]=E;if(a.isMimic()&&!B(a,b,"traps"))return!1}for(const a of m){const [b,c]=a;if(b.needsChest()&&!B(b,c,"chest"))return!1}for(const a of m){const [b,c]=a;if(!B(b,c))return!1}for(const a of u){const [b,c]=a;b.set(...c)}const {win:v,path:I}=a.traverse({wanted:k,dfs:!1});if(!v)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,q));e.items=
[];e.route=[];for(const b of I){const [c,d]=b;e.route.push(d);k=a.nodes[c];k instanceof Slot$$module$js$nodes&&!k.isFixed()&&(E=k.slotName,0>E.indexOf(k.vanillaItemName)&&(E+=` (normally ${k.vanillaItemName})`),e.items.push({itemIndex:k.itemIndex,itemName:k.item.name,origName:k.vanillaItemName,slotIndex:k.slotIndex,slotName:k.slotName,text:`${k.item.name}: ${E}`}))}return!0})};var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;module$js$depgraph.shuffle=shuffle$$module$js$depgraph;
...
case 177:return{check:[{condition:and$$module$js$graph$condition(module$js$graph$condition.Item.BOW_OF_SUN,module$js$graph$condition.Item.BOW_OF_MOON),slot:module$js$graph$condition.Slot(module$js$graph$condition.Event.OPENED_CRYPT)}]}}var c=this.rom.triggers[a&127];if(!c||!c.used)throw Error(`Unknown trigger: ${hex$$module$js$rom$util(a)}`);a=(a)=>this.relevantFlags.has(a);const d=(a)=>0<a&&this.relevantFlags.has(a),e=TRIGGER_ACTION_ITEMS$$module$js$graph$overlay[c.message.action],f=and$$module$js$graph$condition(...c.conditions.map(b).filter(d).map(module$js$graph$condition.Condition));
if(25===c.message.action){const [d,...e]=c.conditions;if(!e.length&&0>d&&a(~b(d)))return{terrain:{exit:module$js$graph$condition.Condition(~b(d))}}}else if(null!=e)return{check:[{condition:f,slot:e}]};c=c.flags.filter(d);return c.length?{check:c.map((a)=>({condition:f,slot:module$js$graph$condition.Slot(a)}))}:{}}npc(a,b){function c(...a){if(!f.terrain)throw Error("Missing terrain for guard");f.terrain.exit=or$$module$js$graph$condition(f.terrain.exit||[],...a)}const d=this.rom.npcs[a];if(!d||!d.used)throw Error(`Unknown trigger: ${hex$$module$js$rom$util(a)}`);
const e=d.spawnConditions.get(b.id)||[],f={check:[]};d.data[2]&4&&(f.terrain={exit:this.flags.assumeStatueGlitch()?[[]]:or$$module$js$graph$condition(...e.map((a)=>FLAG_MAP$$module$js$graph$overlay.get(a)||(this.relevantFlags.has(a)?module$js$graph$condition.Condition(a):[])))});switch(a){case 20:if(b.spawns.find((a)=>a.isNpc()&&21===a.id))return{};case 37:f.hitbox={x0:0,x1:2,y0:0,y1:1};c(module$js$graph$condition.Magic.CHANGE,module$js$graph$condition.Magic.PARALYSIS);break;case 45:delete f.terrain;
break;case 51:c(module$js$graph$condition.Magic.PARALYSIS);break;case 56:223===b.id&&(f.hitbox={x0:0,x1:1,y0:2,y1:3});break;case 78:f.hitbox={x0:-1,x1:2,y0:0,y1:1};c(module$js$graph$condition.Magic.CHANGE,module$js$graph$condition.Event.ENTERED_SHYRON);break;case 128:c(...e.map((a)=>module$js$graph$condition.Condition(~a)));break;case 133:c(module$js$graph$condition.Item.FLUTE_OF_LIME)}const g=[];var h=(a)=>{0>=a||(a=FLAG_MAP$$module$js$graph$overlay.get(a)||(this.relevantFlags.has(a)?module$js$graph$condition.Condition(a):
null),null!=a&&g.push(a))};for(var k of e)h(k);k=this.tradeIns.get(a);if(null!=k){var m=function(a,...c){c=and$$module$js$graph$condition(...g,b,...c);f.check.push({slot:a,condition:c})};const b=k;switch(a){case 21:m(module$js$graph$condition.Slot(module$js$graph$condition.Item.WINDMILL_KEY));break;case 35:f.hitbox={x0:-1,x1:2,y0:-1,y1:2};m(module$js$graph$condition.Slot(module$js$graph$condition.Item.BOW_OF_MOON),module$js$graph$condition.Magic.CHANGE);break;case 99:f.hitbox={x0:-1,x1:2,y0:-1,y1:2};
m(module$js$graph$condition.Slot(module$js$graph$condition.Event.HEALED_DOLPHIN));m(module$js$graph$condition.Slot(module$js$graph$condition.Item.SHELL_FLUTE));break;case 100:m(module$js$graph$condition.Slot(module$js$graph$condition.Event.RETURNED_FOG_LAMP),...this.flags.requireHealedDolphinToRide()?[module$js$graph$condition.Event.HEALED_DOLPHIN]:[]);break;case 107:m(module$js$graph$condition.Slot(module$js$graph$condition.Item.GLOWING_LAMP));break;case 117:m(module$js$graph$condition.Slot(module$js$graph$condition.Magic.FLIGHT));
break;case 116:m(module$js$graph$condition.Slot(module$js$graph$condition.Magic.CHANGE),module$js$graph$condition.Magic.PARALYSIS,module$js$graph$condition.Event.FOUND_KENSU);break;case 130:m(module$js$graph$condition.Slot(module$js$graph$condition.Item.GAS_MASK));break;case 136:m(module$js$graph$condition.Slot(module$js$graph$condition.Item.SHIELD_RING))}}if(132===a)return{check:[{condition:this.bossRequirements(this.rom.bosses.sabera1),slot:module$js$graph$condition.Slot(module$js$graph$condition.Boss.SABERA1)}]};
if(29===a)return a=module$js$graph$condition.Slot(module$js$graph$condition.Item.SWORD_OF_FIRE),{check:[{condition:and$$module$js$graph$condition(module$js$graph$condition.Magic.TELEPATHY,module$js$graph$condition.Boss.INSECT),slot:a},{condition:module$js$graph$condition.Event.RESCUED_CHILD,slot:a}]};if(31===a)return(a=this.rom.npcs[a].spawnConditions.get(b.id))&&a.includes(69)?{}:{check:[{condition:module$js$graph$condition.Event.DWARF_MOTHER,slot:module$js$graph$condition.Slot(module$js$graph$condition.Event.DWARF_CHILD)}]};
for(var l of d.globalDialogs)h(~l.condition);for(const c of d.localDialogs.get(b.id)||d.localDialogs.get(-1)||[])if(!e.includes(~c.condition)){b=(b=FLAG_MAP$$module$js$graph$overlay.get(c.condition))?[b]:this.relevantFlags.has(c.condition)?[module$js$graph$condition.Condition(c.condition)]:[];h=and$$module$js$graph$condition(...b,...g);l=FLAG_MAP$$module$js$graph$overlay.get(~c.condition)||(this.relevantFlags.has(~c.condition)?module$js$graph$condition.Condition(~c.condition):null);null!=l&&g.push(l);
l=c.message.action;3===l?f.check.push({slot:module$js$graph$condition.Slot.item(d.data[0]),condition:h}):17===l||9===l?f.check.push({slot:module$js$graph$condition.Slot.item(d.data[1]),condition:h}):16===l?f.check.push({slot:module$js$graph$condition.Slot(module$js$graph$condition.Magic.RECOVER),condition:h}):8===l&&45===a&&f.check.push({slot:module$js$graph$condition.Slot(module$js$graph$condition.Event.OPENED_SWAN),condition:h});for(const a of c.flags)(l=(l=FLAG_MAP$$module$js$graph$overlay.get(a))?
l:this.relevantFlags.has(a)?module$js$graph$condition.Condition(a):null)&&f.check.push({slot:module$js$graph$condition.Slot(l),condition:h});if(b.length&&e.includes(c.condition))break}return f}capabilities(){var a=module$js$graph$condition.Item.SWORD_OF_WIND;let b=module$js$graph$condition.Item.SWORD_OF_FIRE,c=module$js$graph$condition.Item.SWORD_OF_WATER,d=module$js$graph$condition.Item.SWORD_OF_THUNDER;if(!this.flags.orbsOptional()&&(a=or$$module$js$graph$condition(and$$module$js$graph$condition(module$js$graph$condition.Item.SWORD_OF_WIND,
module$js$graph$condition.Item.ORB_OF_WIND),and$$module$js$graph$condition(module$js$graph$condition.Item.SWORD_OF_WIND,module$js$graph$condition.Item.TORNADO_BRACELET)),b=or$$module$js$graph$condition(and$$module$js$graph$condition(module$js$graph$condition.Item.SWORD_OF_FIRE,module$js$graph$condition.Item.ORB_OF_FIRE),and$$module$js$graph$condition(module$js$graph$condition.Item.SWORD_OF_FIRE,module$js$graph$condition.Item.FLAME_BRACELET)),c=or$$module$js$graph$condition(and$$module$js$graph$condition(module$js$graph$condition.Item.SWORD_OF_WATER,
module$js$graph$condition.Item.ORB_OF_WATER),and$$module$js$graph$condition(module$js$graph$condition.Item.SWORD_OF_WATER,module$js$graph$condition.Item.BLIZZARD_BRACELET)),d=or$$module$js$graph$condition(and$$module$js$graph$condition(module$js$graph$condition.Item.SWORD_OF_THUNDER,module$js$graph$condition.Item.ORB_OF_THUNDER),and$$module$js$graph$condition(module$js$graph$condition.Item.SWORD_OF_THUNDER,module$js$graph$condition.Item.STORM_BRACELET)),this.flags.assumeSwordChargeGlitch())){var e=
function(a){const b=a[0][0];return f.map((a)=>a[0]===b?a:[b,...a])};const f=or$$module$js$graph$condition(a,b,c,d);a=e(module$js$graph$condition.Item.SWORD_OF_WIND);b=e(module$js$graph$condition.Item.SWORD_OF_FIRE);c=e(module$js$graph$condition.Item.SWORD_OF_WATER);d=e(module$js$graph$condition.Item.SWORD_OF_THUNDER)}a=[[module$js$graph$condition.Capability.SWORD,module$js$graph$condition.Item.SWORD_OF_WIND,module$js$graph$condition.Item.SWORD_OF_FIRE,module$js$graph$condition.Item.SWORD_OF_WATER,
module$js$graph$condition.Item.SWORD_OF_THUNDER],[module$js$graph$condition.Capability.BREAK_STONE,a],[module$js$graph$condition.Capability.BREAK_ICE,b],[module$js$graph$condition.Capability.FORM_BRIDGE,c],[module$js$graph$condition.Capability.BREAK_IRON,d],[module$js$graph$condition.Capability.MONEY,module$js$graph$condition.Capability.SWORD],[module$js$graph$condition.Capability.CLIMB_WATERFALL,module$js$graph$condition.Magic.FLIGHT],[module$js$graph$condition.Capability.SHOOTING_STATUE,module$js$graph$condition.Magic.BARRIER],
[module$js$graph$condition.Capability.CLIMB_SLOPE,module$js$graph$condition.Item.RABBIT_BOOTS,module$js$graph$condition.Magic.FLIGHT],[module$js$graph$condition.Event.GENERALS_DEFEATED,module$js$graph$condition.Item.IVORY_STATUE],[module$js$graph$condition.Event.OPENED_SEALED_CAVE,module$js$graph$condition.Event.STARTED_WINDMILL]];this.flags.assumeGhettoFlight()&&a.push([module$js$graph$condition.Capability.CLIMB_WATERFALL,and$$module$js$graph$condition(module$js$graph$condition.Event.RIDE_DOLPHIN,
module$js$graph$condition.Item.RABBIT_BOOTS)]);this.flags.guaranteeBarrier()||a.push([module$js$graph$condition.Capability.SHOOTING_STATUE,and$$module$js$graph$condition(module$js$graph$condition.Capability.MONEY,module$js$graph$condition.Capability.BUY_HEALING),and$$module$js$graph$condition(module$js$graph$condition.Capability.MONEY,module$js$graph$condition.Item.SHIELD_RING),and$$module$js$graph$condition(module$js$graph$condition.Capability.MONEY,module$js$graph$condition.Magic.REFRESH)]);this.flags.leatherBootsGiveSpeed()&&
a.push([module$js$graph$condition.Capability.CLIMB_SLOPE,module$js$graph$condition.Item.LEATHER_BOOTS]);for(const b of this.rom.bosses)null!=b.kill&&null!=b.drop&&a.push([module$js$graph$condition.Item(b.drop),module$js$graph$condition.Boss(b.kill)]);a.push([module$js$graph$condition.Item.ORB_OF_WATER,module$js$graph$condition.Boss.RAGE]);this.flags.guaranteeGasMask()?a.push([module$js$graph$condition.Capability.TRAVEL_SWAMP,module$js$graph$condition.Item.GAS_MASK]):a.push([module$js$graph$condition.Capability.TRAVEL_SWAMP,
or$$module$js$graph$condition(module$js$graph$condition.Item.GAS_MASK,and$$module$js$graph$condition(module$js$graph$condition.Capability.MONEY,module$js$graph$condition.Item.MEDICAL_HERB),and$$module$js$graph$condition(module$js$graph$condition.Capability.MONEY,module$js$graph$condition.Magic.REFRESH))]);return a.map((a)=>{var [b,...c]=a;return{capability:b,condition:or$$module$js$graph$condition(...c)}})}wallCapability(a){return{flag:[module$js$graph$condition.Capability.BREAK_STONE,module$js$graph$condition.Capability.BREAK_ICE,
module$js$graph$condition.Capability.FORM_BRIDGE,module$js$graph$condition.Capability.BREAK_IRON][a][0][0]}}}
...
function traverseFill$$module$js$graph$shuffle(a,b){var c=[];for(var d of a.items)null!=d.item&&(c[d.item]=d.index);d=[];for(var e of a.slots)null!=e.item&&null!=b.slots[e.item]&&(d[e.index]=c[b.slots[e.item]]);b=[];c=Bits$$module$js$bits.of();e=new Set;const f=new Set;for(var g=0;g<a.slots.length;g++)f.add(g);for(const h of f)if(f.delete(h),!e.has(h)){g=a.graph[h];for(let k=0,m=g.length;k<m;k++)if(Bits$$module$js$bits.containsAll(c,g[k])){b.push([h,...Bits$$module$js$bits.bits(g[k])]);e.add(h);g=
...
var module$js$graph$shuffle={};module$js$graph$shuffle.traverse=traverse$$module$js$graph$shuffle;module$js$graph$shuffle.traverseFill=traverseFill$$module$js$graph$shuffle;module$js$graph$shuffle.ShuffleRules=ShuffleRules$$module$js$graph$shuffle;module$js$graph$shuffle.AssumedFill=AssumedFill$$module$js$graph$shuffle;class UnionFind$$module$js$unionfind{constructor(){this.data=new Map;this.sizes=new Map}find(a){this.data.has(a)||(this.data.set(a,a),this.sizes.set(a,1));let b;for(;(b=this.data.get(a))!==a;)this.data.set(a,a=this.data.get(b));return a}union(a){this.find(a[0]);for(let b=1;b<a.length;b++)this.unionInternal(a[0],a[b])}unionInternal(a,b){a=this.find(a);b=this.find(b);if(a!==b){var c=this.sizes.get(a),d=this.sizes.get(b);c<d?(this.sizes.set(b,c+d),this.data.set(a,b)):(this.sizes.set(a,c+d),this.data.set(b,
a))}}sets(){const a=new Map;for(const b of this.data.keys()){const c=this.find(b);let d=a.get(c);d||a.set(c,d=new Set);d.add(b)}return[...a.values()]}map(){const a=new Map;for(const b of this.data.keys()){const c=this.find(b);let d=a.get(c);d||a.set(c,d=new Set);d.add(b)}return a}roots(){const a=new Set;for(const b of this.data.keys())a.add(this.find(b));return[...a]}}var module$js$unionfind={};module$js$unionfind.UnionFind=UnionFind$$module$js$unionfind;class World$$module$js$graph$world{constructor(a,b,c){this.rom=a;this.tiles=b;this.graph=c}traverse(a,b){const {spoiler:c}=this.rom;if(c){for(var d=-512;768>d;d++)c.addCondition(d,conditionName$$module$js$graph$world(d,this.rom));for(const e of traverseFill$$module$js$graph$shuffle(a,b)){const [f,...g]=e;{d=a.slots[f].condition;const e=g.map((b)=>a.items[b].condition);c.addCheck(d,e,b.slots[a.slots[f].item])}}}}static build(a,b){return build$$module$js$graph$world(a,b)}}
function build$$module$js$graph$world(a,b){b=void 0===b?new FlagSet$$module$js$flagset("@FullShuffle"):b;const c=new Overlay$$module$js$graph$overlay(a,b),d=new Map,e=new Map,f=new Map,g=new Map,h=new DefaultMap$$module$js$util(()=>new Set),k=new Map,m=new Set;for(const b of a.locations){var l=function(a,b){const c=d.get(a);c&&d.set(a,module$js$graph$condition.Terrain.meet(c,b))};if(!b.used)continue;const q=b.extended?256:0,p=a.tilesets[(b.tileset&127)>>2],t=a.tileEffects[b.tileEffects-179];for(const a of b.spawns)a.isWall()&&
e.set(module$js$graph$geometry.ScreenId.from(b,a),a.id&3);for(let f=0,g=b.height;f<g;f++){const g=b.screens[f],h=b.id<<8|f<<4;for(let f=0,k=b.width;f<k;f++){var n=function(a,b){if(!aa)throw Error("flag expected");return b?a?r(a,b):module$js$graph$condition.Terrain.meet({enter:module$js$graph$condition.Condition(aa.flag)},b):a};const k=a.screens[g[f]|q],m=module$js$graph$geometry.ScreenId(h|f),l=m&255,v=e.get(m),aa=null!=v?c.wallCapability(v):b.flags.find((a)=>a.yx===l),r=memoize2$$module$js$graph$condition((a,
b)=>{if(!aa)throw Error("flag expected");b=Object.assign({},b,{enter:meet$$module$js$graph$condition(b.enter||[[]],module$js$graph$condition.Condition(aa.flag))});return module$js$graph$condition.Terrain.join(a,b)});for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(m<<8|a);let e=k.tiles[a];aa&&751===aa.flag&&32>e&&(e=p.alternates[e]);let f=c.makeTerrain(q?0:t.effects[e]&38,b);if(32>e&&p.alternates[e]!=e&&aa&&751!==aa.flag){const a=c.makeTerrain(t.effects[p.alternates[e]],b);f=n(f,a)}f&&
d.set(b,f)}}}for(const a of b.exits)if(a.entrance&32){const c=module$js$graph$geometry.TileId.from(b,a);m.add(c);const e=d.get(c);e&&d.set(c,module$js$graph$condition.Terrain.seamless(e))}for(const d of b.spawns)if(d.isTrigger()){const a=c.trigger(d.id);if(a.terrain||a.check){let {x:c,y:e}=d;c+=8;for(const d of[-16,0])for(const f of[-16,0]){const g=module$js$graph$geometry.TileId.from(b,{x:c+d,y:e+f});a.terrain&&l(g,a.terrain);for(const b of a.check||[])h.get(g).add(b)}}}else if(d.isNpc()){g.set(module$js$graph$geometry.TileId.from(b,
d),d.id);const a=c.npc(d.id,b);if(a.terrain||a.check){let {x:c,y:e}=d,{x0:f,x1:g,y0:k,y1:m}=a.hitbox||{x0:0,y0:0,x1:1,y1:1};for(let d=f;d<g;d++)for(let f=k;f<m;f++){const g=module$js$graph$geometry.TileId.from(b,{x:c+16*d,y:e+16*f});a.terrain&&l(g,a.terrain);for(const b of a.check||[])h.get(g).add(b)}}}else if(d.isBoss())f.set(module$js$graph$geometry.TileId.from(b,d),d.id);else if(d.isChest())h.get(module$js$graph$geometry.TileId.from(b,d)).add(module$js$graph$condition.Check.chest(d.id));else if(d.isMonster()){const c=
a.objects[d.monsterId];c.goldDrop&&k.set(module$js$graph$geometry.TileId.from(b,d),c.elements)}}for(const b of f){const [e,f]=b;{const b=e>>16,g=195!==f?a.bosses.fromLocation(b):a.bosses.rage;if(160===b||95===b)continue;if(!g||null==g.kill)throw Error(`bad boss at loc ${b.toString(16)}`);const k=module$js$graph$condition.Boss(g.kill),m=memoize$$module$js$graph$condition((a)=>module$js$graph$condition.Terrain.meet(a,{exit:k,exitSouth:k})),l=e&-256,n=c.bossRequirements(g),q={slot:module$js$graph$condition.Slot(k),
condition:n};for(let a=0;240>a;a++){const b=module$js$graph$geometry.TileId(l|a),c=d.get(b);c&&(d.set(b,m(c)),h.get(b).add(q))}}}for(const a of c.locations()||[])h.get(a.tile).add(a);const p=new UnionFind$$module$js$unionfind;for(const a of d){const [b,c]=a;{const a=module$js$graph$geometry.TileId.add(b,0,1);d.get(a)===c&&p.union([b,a]);const e=module$js$graph$geometry.TileId.add(b,1,0);d.get(e)===c&&p.union([b,e])}}const q=new Set;for(const b of a.locations)if(b.used)for(const c of b.exits){const {dest:d,
entrance:e}=c,f=module$js$graph$geometry.TileId.from(b,c),g=e&32?module$js$graph$geometry.TileId(f&65535|d<<16):module$js$graph$geometry.TileId.from({id:d},a.locations[d].entrances[e]);q.add(module$js$graph$geometry.TilePair.of(p.find(f),p.find(g)))}for(const a of q){const [b,c]=module$js$graph$geometry.TilePair.split(a);if(d.get(b)!==d.get(c))continue;const e=module$js$graph$geometry.TilePair.of(c,b);q.has(e)&&(p.union([b,c]),q.delete(a),q.delete(e))}const r=new Neighbors$$module$js$graph$geometry(p,
m);for(const a of d){const [b,c]=a;{const a=module$js$graph$geometry.TileId.add(b,0,1),e=d.get(a);e&&e!==c&&r.addAdjacent(b,a,!1);const f=module$js$graph$geometry.TileId.add(b,1,0),g=d.get(f);g&&g!==c&&r.addAdjacent(b,f,!0)}}for(const a of q){const [b,c]=module$js$graph$geometry.TilePair.split(a);d.has(b)&&d.has(c)&&r.addExit(b,c)}const t=new Routes$$module$js$graph$routes;for(const a of c.extraRoutes())for(const b of a.condition||[[]])t.addRoute(p.find(a.tile),b);for(const a of c.extraEdges()){const {from:b,
to:c,condition:d}=a;for(const a of d||[[]])t.addEdge(p.find(c),p.find(b),a)}for(const a of r){const {from:b,to:c,south:e}=a;{const a=d.get(b),f=d.get(c);if(!a||!f)throw Error(`missing terrain ${a?c:b}`);for(const d of(e?a.exitSouth:a.exit)||[[]])for(const a of f.enter||[[]])t.addEdge(c,b,[...a,...d])}}const u=new DefaultMap$$module$js$util(()=>new MutableRequirement$$module$js$graph$condition);for(const a of c.capabilities()){const {condition:b=[[]],capability:c}=a;u.get(module$js$graph$condition.Slot(c)).addAll(b)}for(const a of h){const [b,
c]=a;{const a=p.find(b);if(b!==a){for(const b of c)h.get(a).add(b);h.delete(b)}}}for(const a of h){const [b,c]=a;for(const a of c){const {slot:c,condition:d=[[]]}=a;{const a=u.get(c);for(const c of d)for(const d of t.routes.get(b)||[])a.addList([...c,...d])}}}if(DEBUG$$module$js$graph$world&&"undefined"!==typeof window){var B=function(a,b){b=void 0===b?L:b;a=[...a];return a.length?"("+a.map((a)=>[...a].map(b).join(" & ")).join(") |\n     (")+")":"no route"},L=function(a){return 0>a?"~"+(~a).toString(16).padStart(2,
"0"):a.toString(16).padStart(3,"0")};const b=window;console.log(b.roots=(b.tiles=p).roots());console.log([...b.neighbors=r]);console.log(b.ll=t);b.area=(a,b)=>{b=void 0===b?L:b;const c=[...p.sets().filter((b)=>b.has(a))[0]].map((a)=>a.toString(16).padStart(6,"0")),d=B(t.routes.get(p.find(a)),b),e=[],f=p.find(a);for(const a of(t.edges.get(f)||new Map).values())e.push(`\nto ${a.target.toString(16)} if (${[...a.deps].map(b).join(" & ")})`);for(const a of t.edges){const [c,d]=a;for(const a of d.values())a.target===
...
b.reqs.check=(a,b)=>{b=void 0===b?L:b;return`${b(a)}: ${B(u.get(module$js$graph$condition.Slot(a)),b)}`};b.reqs.check2=(a)=>b.reqs.check(a,b.whatFlag)}return new World$$module$js$graph$world(a,p,makeGraph$$module$js$graph$world(u,a))}
function makeGraph$$module$js$graph$world(a,b){function c(a){return 512<=a&&640>a}function d(a,c){return{name:conditionName$$module$js$graph$world(a,b),condition:a,index:c}}function e(a,b){return Object.assign(d(a,b+n),{item:a&127})}function f(a){const c=p.get(a);if(null==c)throw Error(`Missing item $${a.toString(16)}: ${conditionName$$module$js$graph$world(a,b)}`);return c}var g=new Set,h=new Set;for(var k of a){const [a,b]=k;h.add(a);for(var m of b)for(var l of m)g.add(l)}g.add(module$js$graph$condition.Boss.DRAYGON2[0][0]);
k=[...g].filter((a)=>!c(a)).sort();g=[...g].filter(c).sort();m=[...h].filter(c).sort();const n=k.length;h=k.map(d);g=g.map(e);l=m.map(e);g=[...h,...g];k=[...h,...l];const p=new Map(g.map((a,b)=>[a.condition,b])),q=new Map(k.map((a,b)=>[a.condition,b]));m=[];const r=[];for(var t of a){const [c,d]=t;a=q.get(c);if(null==a)MAYBE_MISSING_SLOTS$$module$js$graph$world.has(c)||console.error(`Nothing depended on $${c.toString(16)}: ${conditionName$$module$js$graph$world(c,b)}`);else for(const b of d){const c=
[...b].map(f);(m[a]||(m[a]=[])).push(Bits$$module$js$bits.from(c));for(const b of c)(r[b]||(r[b]=new Set)).add(a)}}for(var u of[...h,...l])m[u.index]&&m[u.index].length||(t=u.condition,console.error(`Nothing provided $${t.toString(16)}: ${conditionName$$module$js$graph$world(t,b)} (index ${u.index})`));DEBUG$$module$js$graph$world&&console.log(m);u=r.map((a)=>[...a]);return{fixed:n,slots:k,items:g,graph:m,unlocks:u}}const MAYBE_MISSING_SLOTS$$module$js$graph$world=new Set([37,38,169,580]);
...
function commonNoun$$module$js$pass$fixdialog(a){switch(a){case 37:return"statue";case 40:return"instrument";case 53:return"lamp";case 59:return"pendant";case 60:return"plant";case 61:return"statue"}fail$$module$js$assert();return"item"}var module$js$pass$fixdialog={};module$js$pass$fixdialog.fixDialog=fixDialog$$module$js$pass$fixdialog;class Location$$module$js$rom$location extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.mapDataPointer=82688+(b<<1);this.mapDataBase=readLittleEndian$$module$js$rom$util(a.prg,this.mapDataPointer)+49152;this.name=locationNames$$module$js$rom$location[this.id]||"";this.used=49152<this.mapDataBase&&!!this.name;this.layoutBase=readLittleEndian$$module$js$rom$util(a.prg,this.mapDataBase)+49152;this.graphicsBase=readLittleEndian$$module$js$rom$util(a.prg,this.mapDataBase+2)+49152;
this.entrancesBase=readLittleEndian$$module$js$rom$util(a.prg,this.mapDataBase+4)+49152;this.exitsBase=readLittleEndian$$module$js$rom$util(a.prg,this.mapDataBase+6)+49152;this.flagsBase=readLittleEndian$$module$js$rom$util(a.prg,this.mapDataBase+8)+49152;let c=this.layoutBase!==this.mapDataBase+10,d=this.exitsBase-this.entrancesBase;this.exits=(()=>{const b=[];let f=this.exitsBase;for(;!(a.prg[f]&128);)b.push(new Exit$$module$js$rom$location(a.prg.slice(f,f+4))),f+=4;255!==a.prg[f]&&(c=!!(a.prg[f]&
64),d=(a.prg[f]&31)<<2);return b})();this.pitsBase=c?readLittleEndian$$module$js$rom$util(a.prg,this.mapDataBase+10)+49152:0;this.bgm=a.prg[this.layoutBase];this.layoutWidth=a.prg[this.layoutBase+1];this.layoutHeight=a.prg[this.layoutBase+2];this.animation=a.prg[this.layoutBase+3];this.extended=a.prg[this.layoutBase+4];this.screens=seq$$module$js$rom$util(this.height,(b)=>tuple$$module$js$rom$util(a.prg,this.layoutBase+5+b*this.width,this.width));this.tilePalettes=tuple$$module$js$rom$util(a.prg,
...
98304,114687,`NpcData ${hex$$module$js$rom$util(b.id)}`).then((c)=>writeLittleEndian$$module$js$rom$util(a.rom,b.npcDataPointer,c-65536)))}d=(c,d)=>a.write(c,81920,98303,`${d} ${hex$$module$js$rom$util(b.id)}`);var e=[b.bgm,b.layoutWidth,b.layoutHeight,b.animation,b.extended,...concatIterables$$module$js$rom$util(b.screens)],f=[...b.tilePalettes,b.tileset,b.tileEffects,...b.tilePatterns],g=concatIterables$$module$js$rom$util(b.entrances),h=[...concatIterables$$module$js$rom$util(b.exits),128|(b.pits.length?
64:0)|b.entrances.length],k=[...concatIterables$$module$js$rom$util(b.flags),255],m=concatIterables$$module$js$rom$util(b.pits),[l,n,p,q,r,t]=yield Promise.all([d(e,"Layout"),d(f,"Graphics"),d(g,"Entrances"),d(h,"Exits"),d(k,"Flags"),...m.length?[d(m,"Pits")]:[]]);e=[l&255,(l>>>8)-192,n&255,(n>>>8)-192,p&255,(p>>>8)-192,q&255,(q>>>8)-192,r&255,(r>>>8)-192,...t?[t&255,(t>>8)-192]:[]];d=yield d(e,"MapData");writeLittleEndian$$module$js$rom$util(a.rom,b.mapDataPointer,d-49152);yield Promise.all(c);c=
b.bossId();if(null!=c&&95!==b.id){e=[b.spritePatterns[0],void 0];166===b.id&&(e=[83,80]);d=readLittleEndian$$module$js$rom$util(a.rom,129387+2*c)+81920;e=[,,,b.bgm,,...b.tilePalettes,,,,b.spritePalettes[0],,,,,,e[0],e[1],b.animation];for(f=0;f<e.length;f++)g=e[f],null!=g&&(a.rom[d+f]=g);a.rom[128961+5*c]=b.spritePalettes[1]}}})}allScreens(){const a=new Set,b=this.extended?256:0;for(const c of this.screens)for(const d of c)a.add(this.rom.screens[d+b]);return a}bossId(){for(let a=0;14>a;a++)if(this.rom.prg[129373+
a]===this.id)return a}neighbors(a){a=void 0===a?!1:a;const b=new Set,c=(d)=>{for(const e of d.exits){d=e.dest;const f=this.rom.locations[d];f&&f.used&&f!==this&&!b.has(f)&&(b.add(f),a&&NEXUSES$$module$js$rom$location.has(d)&&c(f))}};c(this);return b}}
...
255,-4]),yt:DataTuple$$module$js$rom$util.prop([0]),timed:DataTuple$$module$js$rom$util.booleanProp([1,128,7]),x:DataTuple$$module$js$rom$util.prop([1,127,-4],[2,64,3]),xt:DataTuple$$module$js$rom$util.prop([1,127]),patternBank:DataTuple$$module$js$rom$util.prop([2,128,7]),type:DataTuple$$module$js$rom$util.prop([2,7]),id:DataTuple$$module$js$rom$util.prop([3]),used:{get(){return 254!==this.data[0]}},monsterId:{get(){return this.id+80&255},set(a){this.id=a-80&255}},isChest(){return 2===this.type&&
128>this.id},isInvisible(){return this.isChest()&&!!(this.data[2]&32)},isTrigger(){return 2===this.type&&128<=this.id},isNpc(){return 1===this.type&&192>this.id},isBoss(){return 1===this.type&&192<=this.id},isMonster(){return 0===this.type},isWall(){return!(3!==this.type||!(4>this.id||this.data[2]&32))},toString(){return`Spawn ${this.hex()}: (${hex$$module$js$rom$util(this.x)}, ${hex$$module$js$rom$util(this.y)}) ${this.timed?"timed":"fixed"} ${this.type}:${hex$$module$js$rom$util(this.id)}`}}),LOCATIONS$$module$js$rom$location=
{mezameShrine:[0,"Mezame Shrine"],leafOutsideStart:[1,"Leaf - Outside Start"],leaf:[2,"Leaf"],valleyOfWind:[3,"Valley of Wind"],sealedCave1:[4,"Sealed Cave 1"],sealedCave2:[5,"Sealed Cave 2"],sealedCave6:[6,"Sealed Cave 6"],sealedCave4:[7,"Sealed Cave 4"],sealedCave5:[8,"Sealed Cave 5"],sealedCave3:[9,"Sealed Cave 3"],sealedCave7:[10,"Sealed Cave 7"],sealedCave8:[12,"Sealed Cave 8"],windmillCave:[14,"Windmill Cave"],windmill:[15,"Windmill"],zebuCave:[16,"Zebu Cave"],mtSabreWestCave1:[17,"Mt Sabre West - Cave 1"],
...
NEXUSES$$module$js$rom$location=new Set([LOCATIONS$$module$js$rom$location.mtSabreWestLower[0],LOCATIONS$$module$js$rom$location.mtSabreWestUpper[0],LOCATIONS$$module$js$rom$location.mtSabreNorthMain[0],LOCATIONS$$module$js$rom$location.mtSabreNorthMiddle[0],LOCATIONS$$module$js$rom$location.mtSabreNorthCave1[0],LOCATIONS$$module$js$rom$location.mtSabreNorthCave2[0],LOCATIONS$$module$js$rom$location.mtHydra[0],LOCATIONS$$module$js$rom$location.mtHydraOutsideShyron[0],LOCATIONS$$module$js$rom$location.mtHydraCave1[0]]);
var module$js$rom$location={};module$js$rom$location.Location=Location$$module$js$rom$location;module$js$rom$location.Entrance=Entrance$$module$js$rom$location;module$js$rom$location.Exit=Exit$$module$js$rom$location;module$js$rom$location.Flag=Flag$$module$js$rom$location;module$js$rom$location.Pit=Pit$$module$js$rom$location;module$js$rom$location.Spawn=Spawn$$module$js$rom$location;module$js$rom$location.LOCATIONS=LOCATIONS$$module$js$rom$location;class TileEffects$$module$js$rom$tileeffects extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.base=b<<8&8191|73728;this.effects=tuple$$module$js$rom$util(a.prg,this.base,256)}write(a){for(let b=0;256>b;b++)a.rom[this.base+b]=this.effects[b]}}TileEffects$$module$js$rom$tileeffects.PIT=1;TileEffects$$module$js$rom$tileeffects.NO_WALK=2;TileEffects$$module$js$rom$tileeffects.IMPASSIBLE=4;TileEffects$$module$js$rom$tileeffects.ALTERNATIVE=8;
...
module$js$rom$mapscreen.MapBuilder=MapBuilder$$module$js$rom$mapscreen;const GOA1$$module$js$pass$shufflemazes=[[114,[0,6],[1,7],[2,8]],[224,[0,11],[1,10],[2,9]],[225,[0,3],[1,4],[2,5]],[226,[6,9],[7,10],[8,11]],[227,[3],[4,7],[5,6],[11]]];function shuffleGoa1$$module$js$pass$shufflemazes(a,b){}
function shuffleSwamp1$$module$js$pass$shufflemazes(a,b){const c=a.locations.swamp,d=new MapBuilder$$module$js$rom$mapscreen(a.tileset(c.tileset),[117,118,119,120,121,122,123,125,126,127],b,c.height,c.width);do{a=b.nextInt(c.width);var e=1+b.nextInt(c.height-2)<<4}while(2>a&&32>e);d.screens[e]=~b.pick([122,126]);d.screens[a]=-125;b=[e<<8|136,a<<8|4104];d.reset();for(a=0;100>a;a++){if(!d.fill(100))throw Error("failed to fill");const a=d.traverse();e=b.map((b)=>a.get(b));allSame$$module$js$pass$shufflemazes(e)||
d.deleteSomeScreens()}c.screens=seq$$module$js$rom$util(c.height,(a)=>seq$$module$js$rom$util(c.width,(b)=>{b=d.screens[a<<4|b];return 0>b?~b:b||0}));return!0}
function shuffleSwamp$$module$js$pass$shufflemazes(a,b){function c(a){const b=[];a&1&&b.push(0);a&2&&b.push(1);a&4&&b.push(2);a&8&&b.push(3);return b}function d(a){return 0<=a&&5>(a&15)&&5>a>>4&&!L.has(a)}function e(a,b){a!==C&&u[q[a]]--;q[a]=b;a!==C&&u[b]++}function f(a,b){const c=1<<b,f=a+t[b];b=1<<(b^2);const g=B,h=q[a],k=d(f),m=k?q[f]:0;h===c&&B++;e(a,q[a]&~c);k&&(m===b&&B++,e(f,q[f]&~b));return()=>{e(a,h);k&&e(f,m);B=g}}function g(a){for(const b of c(q[a]))f(a,b)}function h(a){const b=u.flatMap((a,
b)=>a?[[a,b]]:[]).sort(([a],[b])=>b-a);return b.length<=a?null:new Set(b.map((a)=>a[1]).slice(0,a))}function k(){const a=b.nextInt(25);return Math.floor(a/5)<<4|a%5}function m(){const a=[q.findIndex((a)=>a)],b=new Set;for(;a.length;){const e=a.pop();if(null!=e&&(d(e)||e===C)&&!b.has(e)){b.add(e);for(const b of c(q[e]))a.push(e+t[b])}}return b.size===25-B}function l(a,b){const c=a+t[b];if(d(c))if(q[a]&1<<b){a=f(a,b);if(m())return!0;a()}else return e(a,q[a]|1<<b),e(c,q[c]|1<<(b^2)),!0;return!1}function n(){var a=
h(9);if(!a)return!1;var c=[];for(let e=0;5>e;e++)for(let f=0;5>f;f++){const g=e<<4|f;if(d(g)&&!a.has(q[g])){c.push(g);for(const c of b.shuffle([...r])){const b=g+t[c];if(d(b)&&!a.has(q[b])&&l(g,c))return!0}}}a=b.pick(c);c=b.pick(r);d(a+t[c])&&l(a,c);return!0}a=a.locations.swamp;const p=[127,154,118,121,155,143,131,135,123,117,144,125,126,120,122,119],q=Array(256).fill(15),r=[0,1,2,3],t=[-16,1,16,-1],u=Array(16).fill(0);u[15]=24;let B=0;const L=new Set,[C,E]=(()=>{let a,c;do a=b.nextInt(5),c=b.nextInt(5);
while(2>a||2>c);return[a,c<<4]})();for(var v=0;5>v;v++)f(v,0),f(v|64,2);for(v=0;5>v;v++)f(v<<4,3),f(v<<4|4,1);0<C&&g(C-1);4>C&&g(C+1);e(E,q[E]|8);e(C,4);L.add(C);L.add(C-1);L.add(C+1);for(v=18;v;v--){var I=k(),P=q[I];P&&(P=c(P),P=b.pick(P),d(I)&&d(I+t[P])&&(I=f(I,P),m()||I()))}for(v=1E3;--v&&n(););if(!v)throw Error("Failed to converge");for(v=0;5>v;v++)for(I=0;5>I;I++)P=v<<4|I,P===C?a.screens[v][I]=124:(a.width=5,a.height=5,a.screens[v][I]=p[q[P]])}
const SWAMP_SCREENS$$module$js$pass$shufflemazes={1:"c8 c8 c8 c8 cf d3 c2 c3 c3 c3 d2 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf d3 c4 c5 c3 b7 f6 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf f6 b7 b8 c4 c5 f6 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf d3 c2 c3 b7 b8 d2 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf d3 b6 b6 b6 b6 d2 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf d3 ad ad ad ad d2 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf d3 ad b9 b7 b7 f6 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf d3 ad b6 b9 b7 f6 e2 c8 c8 c8 c8\n        c8 c8 c8 c8 e3 d3 ad ad b6 fc e2 c8 c8 c8 c8 c8\n        c8 c8 c8 c8 c8 e3 fd ad fc fe c8 c8 c8 c8 c8 c8\n        c8 c8 c8 c8 c8 c8 ff fb fe fa c8 c8 c8 c8 c8 c8\n        c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n        c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n        c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n        c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8",
4:"c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8 c8\n        c8 c8 c8 c8 c8 c8 cd c9 c9 ca c8 c8 c8 c8 c8 c8\n        c8 c8 c8 c8 c8 cd eb a0 a0 cb ca c8 c8 c8 c8 c8\n        c8 c8 c8 c8 cf a0 f9 f5 f7 f8 cb cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf a0 ed 08 09 a0 a0 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf db ee 0c 0b ef a0 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf d0 d1 03 03 d8 db cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf f6 c7 ad ad ae d2 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf d3 ad b9 b7 b7 f6 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf d3 c2 c3 c3 b7 f6 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf f6 c5 c3 c3 b7 f6 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf d3 b6 c2 c3 c3 f6 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf f6 b8 b6 b6 b6 d2 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf f6 b7 b7 b7 b7 f6 cc c8 c8 c8 c8\n        c8 c8 c8 c8 cf f6 b7 b7 b8 b6 d2 cc c8 c8 c8 c8",
...
7:"",10:""};
function extendSwampScreens$$module$js$pass$shufflemazes(a){a.swapMetatiles([160],[[3,172],-219],[[4,170],-229],[[5,170],-230],[[6,170],-231],[[7,170],-232],[[8,170],-241],[[9,170],-242],[[10,170],-243],[[11,170],-244],[[12,170],-221],[[13,170],-222]);write$$module$js$pass$shufflemazes(a.screens[127].tiles,0,[[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[210,204],[210,204],[210,204],[210,226],[226,200]]);write$$module$js$pass$shufflemazes(a.screens[118].tiles,76,
[[8,9],[12,11],[3,3]]);write$$module$js$pass$shufflemazes(a.screens[122].tiles,37,[[,,4],[8,9,5],[,10,6],[,11,7],[,3,3]]);write$$module$js$pass$shufflemazes(a.screens[123].tiles,36,[[4],[],[6],[7,13],[3,3]]);write$$module$js$pass$shufflemazes(a.screens[126].tiles,71,[[8,9],[12,11],[3,3]])}function write$$module$js$pass$shufflemazes(a,b,c){for(let d=0;d<c.length;d++)for(let e=0;e<c[d].length;e++)null!=c[d][e]&&(a[b+(d<<4|e)]=c[d][e])}
function allSame$$module$js$pass$shufflemazes(a,b=(a,b)=>a===b){for(const c of a)if(!b(c,a[0]))return!1;return!0}var module$js$pass$shufflemazes={};module$js$pass$shufflemazes.shuffleSwamp1=shuffleSwamp1$$module$js$pass$shufflemazes;module$js$pass$shufflemazes.shuffleSwamp=shuffleSwamp$$module$js$pass$shufflemazes;module$js$pass$shufflemazes.extendSwampScreens=extendSwampScreens$$module$js$pass$shufflemazes;class Tileset$$module$js$rom$tileset extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);b&=63;this.tileBase=65536|b<<8;this.attrBase=77824|b<<4;this.alternatesBase=81408|b<<3;this.tiles=seq$$module$js$rom$util(4,(b)=>tuple$$module$js$rom$util(a.prg,this.tileBase|b<<8,256));this.attrs=seq$$module$js$rom$util(256,(b)=>a.prg[this.attrBase|b>>2]>>((b&3)<<1)&3);this.alternates=tuple$$module$js$rom$util(a.prg,this.alternatesBase,32)}get screens(){return this.lazyScreens?this.lazyScreens:this.lazyScreens=
...
0;g.length&&h<MAX_TABLE_LENGTH$$module$js$rom$messages;){e.has(g[0].str)&&(g.sort(f),e.clear());const {str:n,saving:p,missing:q,words:r,chains:t}=g.shift();if(0>=p)break;h+=n.length+3;k=a.length;m=new Set;for(const a of r){l=b[a];for(const a of[l.mid,...d.get(l.mid)||[]])m.add(a)}a.push({bytes:128>k?[k+128]:[5,k-128],mids:m,str:n});for(const a of r)for(k=0;k<=t;k++){m=b[a+k];l=m.bytes-(k?0:q);for(const a of m.suffixes)a.saving-=l-m.used,e.add(a.str);m.used=l}if(128===a.length){for(const a of c.values())a.saving-=
...
f.difficulty||0;this.monsterClass=f.monsterClass;a=processExpReward$$module$js$rom$monster(this.expReward)/baselineExp$$module$js$rom$monster(e);this.wealth=(b=VANILLA_GOLD_DROPS$$module$js$rom$monster[this.goldDrop]/baselineGold$$module$js$rom$monster(e))&&b/(a+b)}totalDifficulty(){return this.toughness()+this.attack()+this.statusDifficulty()+this.immunities()+this.movement()}collectDifficulty(a,b){let c=a(this);var d=this.spawnedChild();d&&(c=b(c,d.collectDifficulty(a,b)));(d=this.spawnedReplacement())&&
(c=b(c,d.collectDifficulty(a,b)));return c}toughness(){return this.collectDifficulty((a)=>lookup$$module$js$rom$monster(a.hits,0,[2,1],[3,2],[5,3],[7,4],[10,5],[13,6]),Math.max)}attack(){return this.collectDifficulty((a)=>a.attackType&&a.statusEffect?0:lookup$$module$js$rom$monster(a.satk,0,[.04,1],[.08,2],[.13,3],[.18,4],[.25,5],[.33,6]),Math.max)}addStatusEffects(a){this.attackType&&this.statusEffect?a.add(this.statusEffect):!this.attackType&&this.poison&&a.add(0);var b=this.spawnedReplacement();
b&&b.addStatusEffects(a);(b=this.spawnedChild())&&b.addStatusEffects(a)}statusDifficulty(){const a=new Set;this.addStatusEffects(a);let b=0;for(const c of a)b+=STATUS_DIFFICULTY$$module$js$rom$monster[c];return b}immunities(){let a=0,b=this.elements;for(;b;)b&1&&a++,b>>>=1;return a&&1<<a-1}movement(){return this.collectDifficulty((a)=>{const b=ACTION_SCRIPTS$$module$js$rom$monster.get(a.action),c=a.spawnedChild();a=a.extraDifficulty;b&&(a+=b.movement||0,b.large&&a++,c&&!c.statusEffect&&(a+=b.projectile||
0));167===this.metasprite&&(a+=2);return a},(a,b)=>a+b)}spawnedChild(){var a=ACTION_SCRIPTS$$module$js$rom$monster.get(this.action);if(a&&a.child&&(a=(a=this.rom.adHocSpawns[this.child])&&a.objectId,null!=a))return a=this.rom.objects[a],a instanceof Monster$$module$js$rom$monster?a:void 0}spawnedReplacement(){if(this.replacement){var a=this.rom.objects[this.replacement];return a instanceof Monster$$module$js$rom$monster?a:void 0}}totalReward(){return this.totalDifficulty()/4}normalizedGold(){if(!this.wealth)return 0;
const a=this.totalDifficulty()*this.wealth*.6;return Math.max(1,Math.min(15,Math.round(a)))}normalizedExp(){if(1===this.wealth)return 0;const a=.488+this.totalDifficulty()*(1-this.wealth)*.256;return Math.max(1,Math.min(255,Math.round(32*a)))}}function processExpReward$$module$js$rom$monster(a){return 128>a?a:(a&127)<<4}function baselineExp$$module$js$rom$monster(a){return Math.pow(2,a/5-1)}
const STATUS_DIFFICULTY$$module$js$rom$monster=[2,1,3,2,4],VANILLA_GOLD_DROPS$$module$js$rom$monster=[0,1,2,4,8,16,30,50,100,200,400,50,100,200,400,500];function baselineGold$$module$js$rom$monster(a){return Math.pow(2,a/7-1)}
...
2,3].map((b)=>b+a.data[31])}],[43,{movement:4}],[44,{child:!0}],[46,{child:!0,large:!0,projectile:2,movement:3}],[47,{}],[52,{child:!0}],[56,{}],[60,{}],[64,{child:!0,moth:!0,movement:4}],[65,{child:!0,movement:3}],[68,{movement:3}],[69,{child:!0,bird:!0,projectile:2,movement:5}],[76,{child:!0,stationary:!0,projectile:3}],[77,{child:!0,stationary:!0,projectile:3}],[78,{child:!0,stationary:!0}],[87,{}],[88,{}],[92,{child:!0,projectile:3,movement:1}],[93,{bird:!0,movement:6}],[94,{child:!0,projectile:1,
movement:4,metasprites:(a)=>[0,1,2,3].map((b)=>b+a.data[31])}],[96,{boss:!0}],[97,{}],[99,{boss:!0}],[100,{boss:!0}],[102,{boss:!0}],[103,{boss:!0}],[104,{boss:!0}],[106,{boss:!0}],[107,{boss:!0}],[112,{boss:!0}],[127,{boss:!0}]]);function level$$module$js$rom$monster(a){return 24>a?1+a/3:(a+12)/4}function playerSword$$module$js$rom$monster(a,b){b=void 0===b?0:b;a=10>a?1:18>a?2:38>a?4:8;for(let c=a;c;c>>>=1)if(!(c&b))return c<<1;return a<<1}
function expectedPlayerDefense$$module$js$rom$monster(a,b){return level$$module$js$rom$monster(a)+playerArmor$$module$js$rom$monster(a,b)}function playerArmor$$module$js$rom$monster(a,b){return b?lookup$$module$js$rom$monster(a,2,[6,6],[18,8],[25,12],[30,18],[37,24],[42,32]):lookup$$module$js$rom$monster(a,2,[6,6],[18,10],[25,14],[30,18],[40,24],[46,32])}function lookup$$module$js$rom$monster(a,b,...c){for(let b=c.length-1;0<=b;b--){const [d,f]=c[b];if(a>=d)return f}return b}
var module$js$rom$monster={};module$js$rom$monster.Monster=Monster$$module$js$rom$monster;module$js$rom$monster.ACTION_SCRIPTS=ACTION_SCRIPTS$$module$js$rom$monster;class Npc$$module$js$rom$npc extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.spawnConditions=new Map;this.localDialogs=new Map;this.used=!UNUSED_NPCS$$module$js$rom$npc.has(b)&&(143>b||192<=b);var c=195>=b;this.dataBase=33008|(b&252)<<6|(b&3)<<2;this.data=tuple$$module$js$rom$util(a.prg,this.dataBase,4);this.spawnPointer=116192+(b<<1);for(var d=this.spawnBase=readLittleEndian$$module$js$rom$util(a.prg,this.spawnPointer)+81920,e;this.used&&255!==(e=a.prg[d++]);){const b=SPAWN_CONDITION_FLAGS$$module$js$rom$util.read(a.prg,
...
for(var m of this.locations)if(m.used&&a.has(m.tileset)){c.add(m.tileEffects);for(var l of m.allScreens())g.add(l)}for(var n of g)for(let a=0,b=n.tiles.length;a<b;a++)n.tiles[a]=d[n.tiles[a]];for(var p of a){d=this.tilesets[(p&127)>>>2];for(var q of b)for(m=0;m<q.length-1;m++){l=f(q[m]);n=f(q[m+1]);for(a=0;4>a;a++)d.tiles[a][l]=d.tiles[a][n];d.attrs[l]=d.attrs[n];if(32>n&&d.alternates[n]!==n){if(32<=l)throw Error(`Cannot unflag: ${p} ${l} ${n} ${d.alternates[n]}`);d.alternates[l]=d.alternates[n]}}for(var r of e){const [a,
b]=r;d.alternates[a]=b}}for(const a of c){p=this.tileEffects[a-179];for(const a of b)for(q=0;q<a.length-1;q++)r=f(a[q]),d=f(a[q+1]),p.effects[r]=p.effects[d];for(const a of e.keys())p.effects[a]|=8}}static load(a,b){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const c=yield pickFile$$module$js$rom(b);a&&(yield a(c));return new Rom$$module$js$rom(c)})}}Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX=module$js$rom$option.RomOption.bit(82624,0);
...
function shuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){function g(b){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){m.assemble(yield d.read(b),b);m.patchRom(a)})}if("number"!==typeof b)throw Error("Bad seed");var h=crc32$$module$js$crc32(b.toString(16).padStart(8,"0")+String(c))>>>0;const k={_ALLOW_TELEPORT_OUT_OF_BOSS:c.hardcoreMode()&&c.shuffleBossElements(),_ALLOW_TELEPORT_OUT_OF_TOWER:!0,_AUTO_EQUIP_BRACELET:c.autoEquipBracelet(),
...
_NERF_FLIGHT:!0,_NERF_WILD_WARP:c.nerfWildWarp(),_NEVER_DIE:c.neverDie(),_NORMALIZE_SHOP_PRICES:!0,_PITY_HP_AND_MP:!0,_PROGRESSIVE_BRACELET:!0,_RABBIT_BOOTS_CHARGE_WHILE_WALKING:c.rabbitBootsChargeWhileWalking(),_REQUIRE_HEALED_DOLPHIN_TO_RIDE:c.requireHealedDolphinToRide(),_REVERSIBLE_SWAN_GATE:!0,_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_SIMPLIFY_INVISIBLE_CHESTS:!0,_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword(),_UNIDENTIFIED_ITEMS:c.unidentifiedItems()},m=new Assembler$$module$js$6502;
var l=Object.keys(k).filter((a)=>k[a]).map((a)=>`define ${a} 1\n`).join("");m.assemble(l,"flags.s");yield g("preshuffle.s");h=new Random$$module$js$random(h);l=new Rom$$module$js$rom(a);fixCoinSprites$$module$js$patch(l);"object"==typeof window&&(window.rom=l);l.spoiler=new Spoiler$$module$js$rom$spoiler(l);e&&(e.slots=l.spoiler.slots,e.route=l.spoiler.route);fixMimics$$module$js$patch(l);makeBraceletsProgressive$$module$js$patch(l);c.blackoutMode()&&blackoutMode$$module$js$patch(l);closeCaveEntrances$$module$js$patch(l,
c);reversibleSwanGate$$module$js$patch(l);adjustGoaFortressTriggers$$module$js$patch(l);preventNpcDespawns$$module$js$patch(l,c);c.requireHealedDolphinToRide()&&requireHealedDolphin$$module$js$patch(l);c.saharaRabbitsRequireTelepathy()&&requireTelepathyForDeo$$module$js$patch(l);adjustItemNames$$module$js$patch(l,c);yield g("postparse.s");alarmFluteIsKeyItem$$module$js$patch(l);c.teleportOnThunderSword()?teleportOnThunderSword$$module$js$patch(l):noTeleportOnThunderSword$$module$js$patch(l);l.scalingLevels=
48;l.uniqueItemTableAddress=m.expand("KeyItemData");undergroundChannelLandBridge$$module$js$patch(l);c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$patch(l);simplifyInvisibleChests$$module$js$patch(l);addCordelWestTriggers$$module$js$patch(l,c);c.disableRabbitSkip()&&fixRabbitSkip$$module$js$patch(l);c.shuffleShops()&&shuffleShops$$module$js$patch(l,c,h);randomizeWalls$$module$js$patch(l,c,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(l,c,h);rescaleMonsters$$module$js$patch(l,
c,h);shuffleTrades$$module$js$pass$shuffletrades(l,c,h);const n=World$$module$js$graph$world.build(l,c),p=yield(new AssumedFill$$module$js$graph$shuffle(l,c)).shuffle(n.graph,h,f);if(p)n.traverse(n.graph,p),update$$module$js$rom$slots(l,p.slots);else return-1;rescaleShops$$module$js$patch(l,m,c.bargainHunting()?h:void 0);normalizeSwords$$module$js$patch(l,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(l,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(l);c.doubleBuffMedicalHerb()?
(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(l);c.chargeShotsOnly()&&disableStabs$$module$js$patch(l);c.orbsOptional()&&orbsOptional$$module$js$patch(l);shuffleMusic$$module$js$patch(l,c,h);shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(l,c,h);extendSwampScreens$$module$js$pass$shufflemazes(l);misc$$module$js$patch(l,c,h);fixDialog$$module$js$pass$fixdialog(l);c.buffDyna()&&
buffDyna$$module$js$patch(l,c);yield l.writeData();buffDyna$$module$js$patch(l,c);return yield postParsedShuffle$$module$js$patch(a,h,b,c,m,g)})}function postParsedShuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){yield f("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(a,d,e);updateCoinDrops$$module$js$patch(a,d);shuffleRandomNumbers$$module$js$patch(a,b);return stampVersionSeedAndHash$$module$js$patch(a,c,d)})}
...
new Set([80,83,95,105]);for(const h of SCALED_MONSTERS$$module$js$patch){const [k,{sdef:m,swrd:l,hits:n,satk:p,dgld:q,sexp:r}]=h;f=a.objects[k].data;g=e.has(k)?1:0;f[2]|=128;f[6]=n;f[7]=p;f[8]=m|l<<4;f[16]=f[16]&15|q<<4;f[17]=r;(g?b.shuffleBossElements():b.shuffleMonsterElements())&&!d.has(k)&&(f=[...a.objects[k].elements.toString(2).padStart(4,"0")],c.shuffle(f),a.objects[k].elements=Number.parseInt(f.join(""),2))}if(b.shuffleMonsterElements()){b=c.nextInt(4);a.prg[217645]=b+1;for(const c of d)a.objects[c].elements=
1<<b}}
...
for(this.report["post-shuffle monsters"]=this.monsters.map((a)=>a.id);this.locations.length;){const {location:e,slots:f}=this.locations.pop(),g=this.report["$"+e.id.toString(16).padStart(2,"0")]=[],{maxFlyers:h=0,nonFlyers:k={},tower:m=!1}=MONSTER_ADJUSTMENTS$$module$js$patch[e.id]||{};if(m)continue;let l=h,n=Constraint$$module$js$rom$constraint.forLocation(e.id);null!=e.bossId()&&(n=n.meet(Constraint$$module$js$rom$constraint.BOSS)||n);for(const a of e.spawns)if(a.isChest()&&!a.isInvisible())n=112>
a.id?n.meet(Constraint$$module$js$rom$constraint.TREASURE_CHEST)||n:n.meet(Constraint$$module$js$rom$constraint.MIMIC)||n;else if(a.isNpc()){var c=b.npcConstraints.get(a.id);c&&(n=n.meet(c)||n)}else a.isMonster()&&UNTOUCHED_MONSTERS$$module$js$patch[a.monsterId]&&(c=b.monsterConstraints.get(a.monsterId))&&(n=n.meet(c)||n);g.push(`Initial pass: ${n.fixed.map((a)=>Infinity>a.size?"["+[...a].join(", ")+"]":"all")}`);const p=new Map;c=(a)=>{var c=e.rom.objects[a.id];if(c.monsterClass){var d=p.get(c.monsterClass);
if(null!=d&&d!==a.id)return!1}d=FLYERS$$module$js$patch.has(a.id);var h=MOTHS_AND_BATS$$module$js$patch.has(a.id);if(d){if(!l)return!1;--l}const m=b.getMonsterConstraint(e.id,a.id);let q=n.meet(m);!q&&Infinity>n.pal2.size&&Infinity>n.pal3.size&&this.flags.shuffleSpritePalettes()&&(q=n.meet(m.ignorePalette()));if(!q)return!1;g.push(`  Adding ${a.id.toString(16)}: ${q}`);n=q;c.monsterClass&&p.set(c.monsterClass,a.id);c=0;if(d||h)for(d=0;d<f.length;d++){if(f[d]in k){c=d;break}}else for(d=0;d<f.length;d++)if(!(f[d]in
k)){c=d;break}(this.report[`mon-${a.id.toString(16)}`]=this.report[`mon-${a.id.toString(16)}`]||[]).push("$"+e.id.toString(16));d=f[c];h=e.spawns[d-13];d in k&&(h.y+=16*k[d][0],h.x+=16*k[d][1]);h.monsterId=a.id;g.push(`    slot ${d.toString(16)}: ${h}`);f.splice(c,1);return!0};if(l&&f.length)for(var d=0;d<Math.min(40,this.monsters.length);d++)FLYERS$$module$js$patch.has(this.monsters[d].id)&&c(this.monsters[d])&&this.monsters.splice(d,1);for(d=0;d<this.monsters.length&&f.length;d++)if(c(this.monsters[d])){const [a]=
