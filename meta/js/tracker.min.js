...
d&&(0<=e.sells.indexOf(d)||4<=e.sells.length?g.push(d):e.sells.push(d));for(const {shops:a}of[b,c])for(const b of a)b.sells.sort((a,b)=>a.id-b.id)}integrate({tracker:a=!1}={}){var b=!a;const c=new SparseDependencyGraph$$module$js$graph(this.nodes.length);var d=[],e=[];const f=new Set,g=new Map;var h=[];const k=[],m=[],l=[],n=[],q=new Set;for(const a of this.nodes)if(a instanceof Location$$module$js$nodes){if(a.isStart){const [b]=c.addRoute([a.uid]);g.set(b.label,b)}d[a.uid]=[];e[a.uid]=[];for(const b of a.connections)f.has(b)||
(f.add(b),b.bidi&&f.add(b.reverse()));for(const b of a.chests)c.addRoute([b.uid,a.uid])}else if(a instanceof ItemGet$$module$js$nodes&&"Medical Herb"===a.name&&(c.addRoute([a.uid]),c.finalize(a.uid)),a instanceof Option$$module$js$nodes)h.push(a);else if(a instanceof TrackerNode$$module$js$nodes)k.push(a);else if(a instanceof Condition$$module$js$nodes)m.push(a);else if(a instanceof Trigger$$module$js$nodes)l.push(a);else if(a instanceof ItemGet$$module$js$nodes)n.push(a);else if(a instanceof Slot$$module$js$nodes)q.add(a);
...
a)}}e(m);for(d=0;d<this.nodes.length;d++)this.nodes[d]instanceof ItemGet$$module$js$nodes||this.nodes[d]instanceof TrackerNode$$module$js$nodes||c.finalize(d);d=new LocationList$$module$js$nodes(this);for(const a of q)for(const b of c.nodes[a.uid].values())d.addRoute([a.uid,...b]);return d}}
...
l=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),q=h(d("Assume teleport skip",a.assumeTeleportSkip())),p=d("Allow teleport skip",!a.disableTeleportSkip()),r=h(d("Assume rabbit skip",a.assumeRabbitSkip())),x=h(d("Allow rabbit skip",!a.disableRabbitSkip())),w=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),y=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),z=h(d("Assume wild warp",a.assumeWildWarp())),E=d("Allow wild warp",
a.allowWildWarp()),v=d("Sword magic optional",!a.guaranteeSwordMagic()),t=d("Matching sword optional",!a.guaranteeMatchingSword()),S=d("Gas mask optional",!a.guaranteeGasMask()),H=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),T=d("Calm sea optional",!a.barrierRequiresCalmSea()),oa=d("Prison key optional",!1),aa=d("Windmill optional",!1),W=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),ia=d("Barrier magic optional",!a.guaranteeBarrier()),za=d("Refresh magic optional",
!a.guaranteeRefresh()),Aa=d("Telepathy optional for Deo",!a.saharaRabbitsRequireTelepathy()),V=d("Lime Tree connects to Leaf",a.connectLimeTreeToLeaf()),kb=d("Buffed medical herb",a.buffMedicalHerb()),X=d("Orbs optional",a.orbsOptional()),P=(new Item$$module$js$nodes(c,0,"Sword of Wind")).weight(a.guaranteeSword()?10:5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),J=(new Item$$module$js$nodes(c,1,"Sword of Fire")).weight(a.guaranteeSword()?10:5).fromPerson("Oak elder",29).dialog(29,
void 0,3).key(),N=(new Item$$module$js$nodes(c,2,"Sword of Water")).weight(10).chest().key(),O=(new Item$$module$js$nodes(c,3,"Sword of Thunder")).weight(15).chest().key(),pa=(new Item$$module$js$nodes(c,4,"Crystalis")).fixed(),da=(new Item$$module$js$nodes(c,5,"Ball of Wind")).chest().key(),Ba=(new Item$$module$js$nodes(c,6,"Tornado Bracelet")).chest().key(),ba=(new Item$$module$js$nodes(c,7,"Ball of Fire")).bossDrop("Insect",1).dialog(30,void 0,2).dialog(32,void 0,0).dialog(33,void 0,0).dialog(34,
void 0,0).dialog(96,30,0).dialog(29,void 0,2).dialog(31,void 0,1).npcSpawn(193).key(),qa=(new Item$$module$js$nodes(c,8,"Flame Bracelet")).bossDrop("Kelbesque 1",2).npcSpawn(194).key(),ra=(new Item$$module$js$nodes(c,9,"Ball of Water")).weight(5).direct("Rage",250679).npcSpawn(195).key(),sa=(new Item$$module$js$nodes(c,10,"Blizzard Bracelet")).weight(5).chest().key(),ja=(new Item$$module$js$nodes(c,11,"Ball of Thunder")).bossDrop("Mado 1",5).trigger(154,1).key(),Ga=(new Item$$module$js$nodes(c,12,
"Storm Bracelet")).chest().key(),Ra=(new Item$$module$js$nodes(c,13,"Carapace Shield")).armor(),Ha=(new Item$$module$js$nodes(c,14,"Bronze Shield")).armor(),u=(new Item$$module$js$nodes(c,15,"Platinum Shield")).armor(),rb=(new Item$$module$js$nodes(c,16,"Mirrored Shield")).armor(),F=(new Item$$module$js$nodes(c,17,"Ceramic Shield")).armor(),Y=(new Item$$module$js$nodes(c,18,"Sacred Shield")).armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),Q=(new Item$$module$js$nodes(c,19,"Battle Shield")).armor(),
ta=(new Item$$module$js$nodes(c,20,"Psycho Shield")).armor(),Sa=(new Item$$module$js$nodes(c,21,"Tanned Hide")).armor(),Ia=(new Item$$module$js$nodes(c,22,"Leather Armor")).armor(),be=(new Item$$module$js$nodes(c,23,"Bronze Armor")).armor(),oc=(new Item$$module$js$nodes(c,24,"Platinmum Armor")).armor(),ce=(new Item$$module$js$nodes(c,25,"Soldier Suit")).armor(),pc=(new Item$$module$js$nodes(c,26,"Ceramic Suit")).armor(),de=(new Item$$module$js$nodes(c,27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,
28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),R=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),ca=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),Za=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),Kb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),ea=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),ua=(new Item$$module$js$nodes(c,34,"Magic Ring")).consumable(),Lb=(new Item$$module$js$nodes(c,
35,"Fruit of Repun")).consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),ka=(new Item$$module$js$nodes(c,36,"Warp Boots")).consumable(),qc=(new Item$$module$js$nodes(c,37,"Statue of Onyx")).chest("Cordel grass").invisible(254882).key(),Mb=(new Item$$module$js$nodes(c,38,"Opel Statue")).consumable().bossDrop("Kelbesque 2",6).npcSpawn(197).key(),rc=(new Item$$module$js$nodes(c,39,"Insect Flute")).fromPerson("Oak mother",30).dialog(30,void 0,1).key(),Nb=(new Item$$module$js$nodes(c,40,"Flute of Lime")).fromPerson("Portoa queen",
...
(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),Gc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),Ta=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),K=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=ea.bossDrop("Vampire 2",12,97).npcSpawn(204).key(),fa=new Item$$module$js$nodes(c,112,
...
Xc=new Trigger$$module$js$nodes(c,"Talked to Stom in Swan Hut"),Yc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Swan tavern"),Zc=new Trigger$$module$js$nodes(c,"Talked to Kensu at Swan dance"),xe=(new Trigger$$module$js$nodes(c,"Returned Kensu's love pendant")).get(Ta),ye=(new Trigger$$module$js$nodes(c,"Talked to Amazones Queen")).get(Cc),Xb=new Trigger$$module$js$nodes(c,"Entered Shyron"),ze=(new Trigger$$module$js$nodes(c,"Talked to Zebu in Shyron")).get(vc),$c=new Trigger$$module$js$nodes(c,
"Shyron Massacre"),Ae=(new Trigger$$module$js$nodes(c,"Saved Kensu")).get(K),Be=(new Trigger$$module$js$nodes(c,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$js$nodes(c,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(c,"Get Bow of Truth")).get(Ec),Ee=(new Trigger$$module$js$nodes(c,"Forged Crystalis")).get(pa),ub=(new Condition$$module$js$nodes(c,"Sword charge glitch")).option(w,y),Fe=(new Condition$$module$js$nodes(c,"Rabbit skip")).option(r,x),Ge=(new Condition$$module$js$nodes(c,
"Teleport skip")).option(q,p),vb=(new Condition$$module$js$nodes(c,"Statue glitch")).option(l,n),He=(new Condition$$module$js$nodes(c,"Wild warp")).option(z,E),wb=(new Condition$$module$js$nodes(c,"Any level 2 sword")).option(P,da).option(P,Ba).option(J,ba).option(J,qa).option(N,ra).option(N,sa).option(O,ja).option(O,Ga),C=(new Condition$$module$js$nodes(c,"Destroy stone")).option(P,X).option(P,da).option(P,Ba).option(ub,P,wb),D=(new Condition$$module$js$nodes(c,"Destroy ice")).option(J,X).option(J,
ba).option(J,qa).option(ub,J,wb),A=(new Condition$$module$js$nodes(c,"Cross rivers")).option(N,X).option(N,ra).option(N,sa).option(K).option(ub,N,wb),$a=(new Condition$$module$js$nodes(c,"Destroy iron")).option(O,X).option(O,ja).option(O,Ga).option(ub,O,wb),la=(new Condition$$module$js$nodes(c,"Any sword")).option(P).option(J).option(N).option(O),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(J).option(N).option(O).option(sb,t.value?t:g,P),Je=(new Condition$$module$js$nodes(c,
"Match vampire 2 sword (wind/water/thunder)")).option(P).option(N).option(O).option(t.value?t:g,J),ad=(new Condition$$module$js$nodes(c,"Speed boots")).option(sc,k),bd=(new Condition$$module$js$nodes(c,"Climb slopes")).option(Ob).option(K).option(ad),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Nc).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(Fc).option(Ge,K),cd=(new Condition$$module$js$nodes(c,"Asina in her room")).option(Sc),
Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(lb).option(cd).option(vb),dd=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(Rb,Vc),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(m,dd,Ob),Ca=(new Condition$$module$js$nodes(c,"Cross sea")).option(dd).option(K),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Wb).option(K).option(Ne),ma=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(za.value?za:g).option(tb),ed=(new Condition$$module$js$nodes(c,
"Wind magic")).option(v.value?v:g,ma).option(da,Ba,ma),fd=(new Condition$$module$js$nodes(c,"Fire magic")).option(v.value?v:g,ma).option(ba,qa,ma),gd=(new Condition$$module$js$nodes(c,"Water magic")).option(v.value?v:g,ma).option(v,ma).option(ra,sa,ma),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(v.value?v:g,ma).option(v,ma).option(ja,ma).option(Ga,ma),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(Nb).option(vb),Re=(new Condition$$module$js$nodes(c,"Change or glitch")).option(Ta).option(vb),
Se=(new Condition$$module$js$nodes(c,"Change or glitch or paralysis")).option(Ta).option(vb).option(lb),Yb=(new Condition$$module$js$nodes(c,"Pass shooting statues")).option(Gc).option(la,ia.value?ia:g).option(tb,tc),Te=(new Condition$$module$js$nodes(c,"Healed dolphin if required")).option(Uc).option(H),hd=(new Condition$$module$js$nodes(c,"Match sword of wind")).option(P).option(t.value?t:g,la),id=(new Condition$$module$js$nodes(c,"Match sword of fire")).option(J).option(t.value?t:g,la),jd=(new Condition$$module$js$nodes(c,
"Match sword of water")).option(N).option(t.value?t:g,la),Ue=(new Condition$$module$js$nodes(c,"Match sword of thunder")).option(O).option(t.value?t:g,la),Ve=(new Condition$$module$js$nodes(c,"Swamp run possible")).option(la,ad).option(la,kb).option(la,tb),We=(new Condition$$module$js$nodes(c,"Insect possible to kill")).option(sb),xb=(new Condition$$module$js$nodes(c,"Travel swamp")).option(sb).option(S.value?S:g,Ve),Xe=(new Condition$$module$js$nodes(c,"Calmed sea if required")).option(Wb).option(T),
Ye=(new Condition$$module$js$nodes(c,"Started windmill if required")).option(mb).option(aa),Ze=(new Condition$$module$js$nodes(c,"Telepathy if required for Deo")).option(Ja).option(Aa),$e=e(0,"Vampire 1",la).get(Ob),af=e(1,"Insect",rc,Ie,We).get(ba),bf=e(2,"Kelbesque 1",hd,ed).get(qa),cf=e(12,"Vampire 2",Je).get(ke),kd=e(4,"Sabera 1",id,fd).get(yc),df=e(5,"Mado 1",jd,gd).get(ja),ef=e(6,"Kelbesque 2",hd,ed).get(Mb),ff=e(7,"Sabera 2",id,fd).get(Lb),gf=e(8,"Mado 2",jd,gd).get(Y),hf=e(9,"Karmine",Ue,
Pe).get(Sb),jf=e(10,"Draygon 1",la).get(ee),kf=e(-1,"Statues",Dc,Cc),lf=e(11,"Draygon 2",la,Ec),mf=e(13,"Dyna",pa),nf=(new Condition$$module$js$nodes(c,"Opened prison if required")).option(Qb).option(oa),va=new Area$$module$js$nodes(c,"Leaf"),ab=new Area$$module$js$nodes(c,"Valley of Wind"),na=new Area$$module$js$nodes(c,"Sealed Cave"),Ua=new Area$$module$js$nodes(c,"Cordel Plain"),bb=new Area$$module$js$nodes(c,"Brynmaer"),cb=new Area$$module$js$nodes(c,"Amazones"),L=new Area$$module$js$nodes(c,
"Mt Sabre West"),B=new Area$$module$js$nodes(c,"Mt Sabre North"),yb=new Area$$module$js$nodes(c,"Nadare's"),nb=new Area$$module$js$nodes(c,"Oak"),Ka=new Area$$module$js$nodes(c,"Waterfall Valley"),I=new Area$$module$js$nodes(c,"Portoa"),La=new Area$$module$js$nodes(c,"Waterfall Cave"),M=new Area$$module$js$nodes(c,"Fog Lamp Cave"),Ma=new Area$$module$js$nodes(c,"Kirisa Plant Cave"),Va=new Area$$module$js$nodes(c,"Angry Sea"),Na=new Area$$module$js$nodes(c,"Joel"),Z=new Area$$module$js$nodes(c,"Evil Spirit Island"),
Oa=new Area$$module$js$nodes(c,"Sabera's Castle"),wa=new Area$$module$js$nodes(c,"Swan"),G=new Area$$module$js$nodes(c,"Mt Hydra"),Pa=new Area$$module$js$nodes(c,"Shyron"),Wa=new Area$$module$js$nodes(c,"Styx"),Xa=new Area$$module$js$nodes(c,"Goa"),zb=new Area$$module$js$nodes(c,"Draygonia Fortress 1"),xa=new Area$$module$js$nodes(c,"Draygonia Fortress 2"),db=new Area$$module$js$nodes(c,"Draygonia Fortress 3"),ha=new Area$$module$js$nodes(c,"Draygonia Fortress 4"),U=new Area$$module$js$nodes(c,"Oasis Cave"),
ya=new Area$$module$js$nodes(c,"Sahara"),eb=new Area$$module$js$nodes(c,"Pyramid Front"),Da=new Area$$module$js$nodes(c,"Pyramid Back"),Ea=new Area$$module$js$nodes(c,"Tower"),Zb=(new Location$$module$js$nodes(c,0,va,"Start")).overworld().start(),of=(new Location$$module$js$nodes(c,0,va,"Mezame Shrine")).overworld().from(Zb),pf=(new Location$$module$js$nodes(c,1,va,"Outside Start")).overworld().connect(of),Qa=(new Location$$module$js$nodes(c,2,va,"Town")).town().connect(pf),ob=(new Location$$module$js$nodes(c,
3,ab,"Main")).overworld().connect(Qa).trigger(Jc,mb),ld=(new Location$$module$js$nodes(c,3,ab,"Outside Windmill")).overworld(),md=(new Location$$module$js$nodes(c,4,na,"Tunnel 1 (entrance)")).cave().from(ob,mb),qf=(new Location$$module$js$nodes(c,5,na,"Tunnel 2 (over bridge)")).cave().connect(md),rf=(new Location$$module$js$nodes(c,6,na,"Tunnel 6 (herb dead end)")).cave().chest(R,15),nd=(new Location$$module$js$nodes(c,7,na,"Tunnel 4a (ball corridor)")).cave().chest(R,20,80).chest(da,21);(new Location$$module$js$nodes(c,
7,na,"Tunnel 4b (antidote dead end)")).cave().connect(nd,C).chest(ca,19);const sf=(new Location$$module$js$nodes(c,8,na,"Tunnel 5 (warp boots dead end)")).cave().chest(ka,14),tf=(new Location$$module$js$nodes(c,9,na,"Tunnel 3a (branch, front)")).cave().connect(qf).connectTo(nd).connectTo(sf),uf=(new Location$$module$js$nodes(c,9,na,"Tunnel 3b (branch, back)")).cave().connect(tf,C).connectTo(rf),vf=(new Location$$module$js$nodes(c,10,na,"Tunnel 7 (boss)")).cave().connect(uf).boss($e),wf=(new Location$$module$js$nodes(c,
12,na,"Tunnel 8a (exit, above wall)")).cave().connect(vf),xf=(new Location$$module$js$nodes(c,12,na,"Tunnel 8b (exit, below wall")).cave().connect(wf,C);(new Location$$module$js$nodes(c,14,ab,"Windmill Cave")).cave().connect(ob).connectTo(ld).trigger(le,Pb,Tb);(new Location$$module$js$nodes(c,15,ab,"Windmill")).misc().connect(ld).trigger(mb,uc);const yf=(new Location$$module$js$nodes(c,16,ab,"Zebu's Cave Front")).cave().connect(ob).trigger(Tb,Hc,Ic).trigger(Jc,mb,Tb),zf=(new Location$$module$js$nodes(c,
16,ab,"Zebu's Cave Back")).cave().trigger(Mc).connect(yf,D),Af=(new Location$$module$js$nodes(c,17,L,"Tunnel 1 (to Zebu)")).cave().connect(zf),fb=(new Location$$module$js$nodes(c,20,Ua,"West")).overworld().connect(xf,Ye),Bf=(new Location$$module$js$nodes(c,20,Ua,"South")).overworld().connect(fb,A),od=(new Location$$module$js$nodes(c,21,Ua,"East")).overworld().connect(fb).chest(qc,24),pb=(new Location$$module$js$nodes(c,24,bb,"Town")).town().connect(fb).trigger(me,qc),Cf=(new Location$$module$js$nodes(c,
25,Ua,"Outside Stom's House")).town().connect(fb),$b=(new Location$$module$js$nodes(c,26,Ua,"Swamp")).overworld().connect(od,xb).trigger(Ub,Lc,xb);(new Location$$module$js$nodes(c,26,Ua,"Swamp Insect Area")).overworld().connect($b,xb).boss(af);const Ab=(new Location$$module$js$nodes(c,27,cb,"Town")).town().connect(Bf),Bb=(new Location$$module$js$nodes(c,28,nb,"Town")).town().connect($b,xb).trigger(Kc);(new Location$$module$js$nodes(c,30,Ua,"Stom's House")).house().connect(Cf).trigger(ne,Kc);const gb=
(new Location$$module$js$nodes(c,32,L,"Entrance")).overworld().connect(fb).connect(Af),Df=(new Location$$module$js$nodes(c,32,L,"Up Slope")).overworld().from(gb,bd).to(gb),Ef=(new Location$$module$js$nodes(c,32,L,"Dead End (warp boots)")).overworld().chest(ka,24,106),pd=(new Location$$module$js$nodes(c,33,L,"Upper")).overworld().from(gb,K).to(gb),Ff=(new Location$$module$js$nodes(c,33,L,"Tornel Dead End")).overworld().trigger(qe,da,Ba).chest(ua,23,105),qd=(new Location$$module$js$nodes(c,34,L,"Tunnel 2a (fork at start)")).cave().connect(gb);
(new Location$$module$js$nodes(c,34,L,"Tunnel 2b (left branch to dead end)")).cave().connect(qd,D).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,L,"Tunnel 2c (right branch to upper)")).cave().connect(qd,D),Hf=(new Location$$module$js$nodes(c,35,L,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(R,23,82),If=(new Location$$module$js$nodes(c,35,L,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,D).connectTo(pd),rd=(new Location$$module$js$nodes(c,
...
79,M,"Tunnel 7a (under second bridge)")).cave().connect(rg);(new Location$$module$js$nodes(c,79,M,"Tunnel 7b (fog lamp)")).cave().connect(sg,C).chest(wc,19);const Ya=(new Location$$module$js$nodes(c,80,I,"Town")).town().connect(Eb),Ed=(new Location$$module$js$nodes(c,81,I,"Fishherman Island")).town().connect(Ya);(new Location$$module$js$nodes(c,82,Ka,"Mesia Shrine")).cave().trigger(Sc).connect(cg,A,Rc);const Fd=(new Location$$module$js$nodes(c,84,La,"Tunnel 1a (entrance)")).cave().connect(Eb);(new Location$$module$js$nodes(c,
84,La,"Tunnel 1b (dead end, mimic)")).cave().connect(Fd,D).chest(fa,19,114);const tg=(new Location$$module$js$nodes(c,84,La,"Tunnel 1c (past ice)")).cave().connect(Fd,D),ug=(new Location$$module$js$nodes(c,85,La,"Tunnel 2 (stoned pair)")).cave().connect(tg),dc=(new Location$$module$js$nodes(c,86,La,"Tunnel 3 (wide medusa hallways)")).cave().connect(ug,Qe),vg=(new Location$$module$js$nodes(c,87,La,"Tunnel 4a (left entrance)")).cave().from(dc,D).chest(rb.chest().bonus(),25).trigger(te,Nb);(new Location$$module$js$nodes(c,
87,La,"Tunnel 4b (right entrance)")).cave().from(dc,D).connect(vg,K);(new Location$$module$js$nodes(c,87,La,"Tunnel 4c (sword of water)")).cave().connect(dc,D).chest(N,24);const Gd=(new Location$$module$js$nodes(c,88,Ea,"Entrance")).misc(),wg=(new Location$$module$js$nodes(c,89,Ea,"Level 1")).misc().from(Gd),xg=(new Location$$module$js$nodes(c,90,Ea,"Level 2")).misc().from(wg),yg=(new Location$$module$js$nodes(c,91,Ea,"Level 3")).misc().from(xg),Hd=(new Location$$module$js$nodes(c,92,Ea,"Outside Mesia Room")).misc().from(yg),
zg=(new Location$$module$js$nodes(c,93,Ea,"Outside Dyna Room")).misc().from(Hd,pa);(new Location$$module$js$nodes(c,94,Ea,"Mesia")).misc().connect(Hd).trigger(Ee);const Ag=(new Location$$module$js$nodes(c,95,Ea,"Dyna")).misc().from(zg).boss(mf);(new Location$$module$js$nodes(c,95,Ea,"Win")).misc().from(Ag).end();const ec=(new Location$$module$js$nodes(c,96,Va,"Cabin Beach")).sea().from(Ed,Vb),hb=(new Location$$module$js$nodes(c,96,Va,"South")).sea().connect(ec,Ca),Bg=(new Location$$module$js$nodes(c,
96,Va,"Joel Beach")).sea().connect(hb,Ca),Id=(new Location$$module$js$nodes(c,96,Na,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(c,96,Va,"Altar")).sea().connect(hb,Ca).trigger(Wb,zc,yc);const Cg=(new Location$$module$js$nodes(c,96,Va,"North")).sea().to(hb,Ca).from(hb,Ca,Oe).trigger(we,Xe),Dg=(new Location$$module$js$nodes(c,96,Va,"Swan Beach")).sea().connect(Cg,Ca);(new Location$$module$js$nodes(c,97,Va,"Cabin")).misc().connect(ec).trigger(Vc,Vb);(new Location$$module$js$nodes(c,98,
...
100,I,"Underground Channel 5 (dolphin)")).sea().connect(Kd,A).trigger(Uc,R,Tc);(new Location$$module$js$nodes(c,100,I,"Underground Channel 6 (water)")).sea().connect(Fg,Ca).connectTo(hb,Ca).chest(Ac,17);const fc=(new Location$$module$js$nodes(c,101,Z,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,Z,"Tunnel 1 (entrance)")).sea().connect(hb,Wc,Ca),Ld=(new Location$$module$js$nodes(c,105,Z,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,Z,"Tunnel 2b (dead end to left)")).cave().connect(Ld,
A);const Hg=(new Location$$module$js$nodes(c,105,Z,"Tunnel 2c (across first river)")).cave().connect(Ld,A),Md=(new Location$$module$js$nodes(c,105,Z,"Tunnel 2d (across second river)")).cave().connect(Hg,A);(new Location$$module$js$nodes(c,105,Z,"Tunnel 2e (dead end, magic ring)")).cave().connect(Md,C).chest(ua,29);const Ig=(new Location$$module$js$nodes(c,105,Z,"Tunnel 2f (stair down)")).cave().connect(Md,C),Jg=(new Location$$module$js$nodes(c,106,Z,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(fc).chest(Za,
25,92),Kg=(new Location$$module$js$nodes(c,106,Z,"Tunnel 3b (left area toward items)")).cave().connect(Jg,C),Lg=(new Location$$module$js$nodes(c,107,Z,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(fa,14,115);(new Location$$module$js$nodes(c,107,Z,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,A).chest(he,15);const gc=(new Location$$module$js$nodes(c,108,Oa,"Floor 1")).fortress().connect(fc),Mg=(new Location$$module$js$nodes(c,108,Oa,"Miniboss")).fortress().boss(cf).connect(gc);
(new Location$$module$js$nodes(c,109,Oa,"Floor 2a (left stair)")).fortress().connect(gc).chest(ea,19);const Ng=(new Location$$module$js$nodes(c,109,Oa,"Floor 2b (right stair)")).fortress().connect(Mg).chest(R,30,85),Og=(new Location$$module$js$nodes(c,110,Oa,"Floor 3a (toward boss)")).fortress().connect(Ng),Nd=(new Location$$module$js$nodes(c,110,Oa,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$js$nodes(c,110,Oa,"Boss")).fortress().boss(kd).connect(Nd);(new Location$$module$js$nodes(c,
110,Oa,"Floor 3c (back room trap)")).fortress().from(Nd).to(gc);const Pg=(new Location$$module$js$nodes(c,112,Na,"Secret Passage")).cave().connectTo(Id),Gb=(new Location$$module$js$nodes(c,113,Na,"Town")).town().connect(Bg),Fa=(new Location$$module$js$nodes(c,114,wa,"Town")).town().connect(Dg),Qg=(new Location$$module$js$nodes(c,115,wa,"Inside Gate")).overworld().connect(Fa),Rg=(new Location$$module$js$nodes(c,115,wa,"Outside Gate")).overworld().from(Qg,Ta),Hb=(new Location$$module$js$nodes(c,120,
...
(new Location$$module$js$nodes(c,127,G,"Tunnel 2 (fork)")).cave().connect(hc).connectTo(Ug).connectTo(Od);const Rd=(new Location$$module$js$nodes(c,128,G,"Tunnel 3 (caves)")).cave().connect(Pd).connect(Tg),Sd=(new Location$$module$js$nodes(c,129,G,"Tunnel 4 (left branch of cave)")).cave().connect(Rd);(new Location$$module$js$nodes(c,130,G,"Tunnel 5 (dead end, medical herb)")).cave().connect(Sd).chest(R,15,86);const Yg=(new Location$$module$js$nodes(c,131,G,"Tunnel 6a (left-then-right)")).cave().connect(Sd),
Zg=(new Location$$module$js$nodes(c,131,G,"Tunnel 6b (past wall)")).cave().connect(Yg,C),$g=(new Location$$module$js$nodes(c,132,G,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,G,"Tunnel 8 (red slimes)")).cave().from($g,C).connectTo(Qd).chest(fa,23,116);const ah=(new Location$$module$js$nodes(c,134,G,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Rd),bh=(new Location$$module$js$nodes(c,135,G,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,
135,G,"Tunnel 10b (past wall)")).cave().connect(bh,C).connectTo(Vg);const Td=(new Location$$module$js$nodes(c,136,Wa,"Entrance")).fortress().from(Pd,vc,Yb),ch=(new Location$$module$js$nodes(c,137,Wa,"Left branch")).fortress().connect(Td).chest(fa,19,117),dh=(new Location$$module$js$nodes(c,137,Wa,"Left branch, past one bridge")).fortress().connect(ch,A),eh=(new Location$$module$js$nodes(c,137,Wa,"Left branch, past two bridges")).fortress().connect(dh,A).chest(R,29,87),fh=(new Location$$module$js$nodes(c,
137,Wa,"Right branch")).fortress().connect(Td);(new Location$$module$js$nodes(c,137,Wa,"Right branch, across water")).fortress().connect(fh,K).chest(fa,20,118).chest(fa,21,119).chest(ta,28);(new Location$$module$js$nodes(c,138,Wa,"Upper floor")).fortress().connect(eh).chest(O,27);const ib=(new Location$$module$js$nodes(c,140,Pa,"Town")).town().connect(Xg,Re).trigger(Xb),qb=(new Location$$module$js$nodes(c,142,Xa,"Town")).town().connect(Hb),Ud=(new Location$$module$js$nodes(c,143,U,"Draygonia Fortress Basement 1 (front)")).fortress();
(new Location$$module$js$nodes(c,143,U,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Ud,$a).chest(fe,15);const ic=(new Location$$module$js$nodes(c,144,Xa,"Desert 1")).overworld().connect(Hb),Ib=(new Location$$module$js$nodes(c,145,U,"Area 1 (from entrance)")).cave().chest(sc,26),Vd=(new Location$$module$js$nodes(c,145,U,"Area 2 (across top bridge)")).cave().connect(Ib,A);(new Location$$module$js$nodes(c,145,U,"Area 3 (dead-end across top-right bridge)")).cave().connect(Vd,A);const gh=
(new Location$$module$js$nodes(c,145,U,"Area 4 (left across middle-right bridge)")).cave().connect(Vd,A),hh=(new Location$$module$js$nodes(c,145,U,"Area 5 (bottom edge)")).cave().connect(gh,A),ih=(new Location$$module$js$nodes(c,145,U,"Area 6 (bottom island)")).cave().connect(hh,A),jh=(new Location$$module$js$nodes(c,145,U,"Area 7 (bottom inner ring)")).cave().connect(ih,A),kh=(new Location$$module$js$nodes(c,145,U,"Area 8 (left outer ring)")).cave().connect(jh,A).connect(Ib,A).chest(ea,27,100),lh=
(new Location$$module$js$nodes(c,145,U,"Area 9 (top left inner ring)")).cave().connect(kh,A),mh=(new Location$$module$js$nodes(c,145,U,"Area 10 (top right inner ring)")).cave().connect(lh,A);(new Location$$module$js$nodes(c,145,U,"Area 11 (center)")).cave().connect(mh,A).connectTo(Ud);(new Location$$module$js$nodes(c,145,U,"Area 12 (top center islands)")).cave().connect(Ib,K).chest(de,28);const nh=(new Location$$module$js$nodes(c,146,ya,"Desert Cave 1")).cave().connect(ic,K),jb=(new Location$$module$js$nodes(c,
147,ya,"Town")).town(),oh=(new Location$$module$js$nodes(c,148,ya,"Outside Cave")).overworld().connect(jb),ph=(new Location$$module$js$nodes(c,149,ya,"Desert Cave 2")).cave().connect(oh);(new Location$$module$js$nodes(c,150,ya,"Meadow")).overworld().connect(nh).connectTo(jb).trigger(Be,Ta,Ze);const jc=(new Location$$module$js$nodes(c,152,ya,"Desert 2")).overworld().connect(ph),qh=(new Location$$module$js$nodes(c,156,eb,"Entrance")).fortress().connect(jc,K),rh=(new Location$$module$js$nodes(c,156,
eb,"Azteca")).fortress().trigger(De),sh=(new Location$$module$js$nodes(c,157,eb,"Fork")).fortress().connect(qh),Wd=(new Location$$module$js$nodes(c,158,eb,"Main")).fortress().connect(sh);(new Location$$module$js$nodes(c,158,eb,"Treasure Chest (magic ring)")).fortress().connect(Wd).chest(ua,27,108);(new Location$$module$js$nodes(c,159,eb,"Draygon")).fortress().connect(Wd).to(rh).boss(jf);const th=(new Location$$module$js$nodes(c,160,Da,"Entrance")).fortress().connect(jc,K),uh=(new Location$$module$js$nodes(c,
160,Da,"Statues")).fortress().connect(th).boss(kf),vh=(new Location$$module$js$nodes(c,161,Da,"Hall 1")).fortress().connect(uh),kc=(new Location$$module$js$nodes(c,162,Da,"Branch")).fortress().connect(vh);(new Location$$module$js$nodes(c,163,Da,"Left Dead End")).fortress().connect(kc).chest(fa,13,120);(new Location$$module$js$nodes(c,164,Da,"Right Dead End")).fortress().connect(kc);const wh=(new Location$$module$js$nodes(c,165,Da,"Hall 2")).fortress().connect(kc).chest(Mb,26,109),xh=(new Location$$module$js$nodes(c,
166,Da,"Draygon 2")).fortress().connect(wh).boss(lf);(new Location$$module$js$nodes(c,167,Da,"Teleporter")).fortress().from(xh).to(Gd);const Xd=(new Location$$module$js$nodes(c,168,zb,"Entrance")).fortress().connect(qb,Yb).trigger($c,O),yh=(new Location$$module$js$nodes(c,169,zb,"Main")).fortress().from(Xd,$a),zh=(new Location$$module$js$nodes(c,169,zb,"Boss")).fortress().connect(yh).boss(ef),Ah=(new Location$$module$js$nodes(c,170,zb,"Zebu")).fortress().connect(zh),Jb=(new Location$$module$js$nodes(c,
171,xa,"Entrance")).fortress().connect(Ah);(new Location$$module$js$nodes(c,171,xa,"Dead End Behind Iron (fruit of power)")).fortress().connect(Jb,$a).chest(ea,28,98);(new Location$$module$js$nodes(c,171,xa,"Dead End Loop Across Closer Bridges")).fortress().connect(Jb,A).connect(Jb,A);const Bh=(new Location$$module$js$nodes(c,171,xa,"Across First Bridge (fruit of repun)")).fortress().connect(Jb,A).chest(Lb,30,102),lc=(new Location$$module$js$nodes(c,171,xa,"Across Second Bridge")).fortress().connect(Bh,
A);(new Location$$module$js$nodes(c,171,xa,"Dead End Across Two Bridges ()")).fortress().connect(lc,A).connect(lc,A).chest(Za,29,93);const Ch=(new Location$$module$js$nodes(c,171,xa,"Across Third Bridge")).fortress().connect(lc,A),Dh=(new Location$$module$js$nodes(c,171,xa,"Exit Behind Iron Door")).fortress().connect(Ch,$a),Eh=(new Location$$module$js$nodes(c,172,xa,"Boss")).fortress().connect(Dh).boss(ff),Fh=(new Location$$module$js$nodes(c,172,xa,"Tornel")).fortress().connect(Eh),Yd=(new Location$$module$js$nodes(c,
173,db,"Lower")).fortress().connect(Fh).chest(Mb,26,99).chest(ua,27,111),Gh=(new Location$$module$js$nodes(c,174,db,"Upper Loop")).fortress().connect(Yd).chest(ca,22,96);(new Location$$module$js$nodes(c,174,db,"Upper Loop Behind Wall (magic ring)")).fortress().connect(Gh,$a).chest(ua,23,107);const Hh=(new Location$$module$js$nodes(c,175,db,"Upper Passage (toward Mado)")).fortress().connect(Yd).chest(ua,27,84),mc=(new Location$$module$js$nodes(c,176,ha,"Initial Fork")).fortress(),Ih=(new Location$$module$js$nodes(c,
177,ha,"Left Branch")).fortress().connect(mc),Zd=(new Location$$module$js$nodes(c,178,ha,"Main Area (right branch, over bridges)")).fortress().connect(mc),Jh=(new Location$$module$js$nodes(c,179,ha,"U-shaped Passage (between floors)")).fortress().connect(Zd),Kh=(new Location$$module$js$nodes(c,180,ha,"Main Area Lower (under bridge)")).fortress().connect(Ih).connect(Zd).connect(Jh),$d=(new Location$$module$js$nodes(c,180,ha,"Behind Iron Wall")).fortress().connect(Kh,$a),Lh=(new Location$$module$js$nodes(c,
181,ha,"Lower")).fortress().connect($d).chest(fa,13,121).chest(fa,14,122).chest(fa,15,123).chest(ua,23,88).chest(ka,24,110),Mh=(new Location$$module$js$nodes(c,182,ha,"Boss Corridor")).fortress().connect(Lh),Nh=(new Location$$module$js$nodes(c,182,ha,"Boss")).fortress().connect(Mh,Yb).boss(hf);(new Location$$module$js$nodes(c,182,ha,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(Ga,18);const ae=(new Location$$module$js$nodes(c,183,ha,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,
184,U,"Entrance Back (behind river)")).cave().connect(ae).chest(ea,13,90);(new Location$$module$js$nodes(c,184,U,"Entrance Front")).cave().connect(Oh,K).connectTo(ic).connectTo(Ib);const Ph=(new Location$$module$js$nodes(c,185,db,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$js$nodes(c,185,db,"Asina")).fortress().connect(Ph).connectTo(mc);(new Location$$module$js$nodes(c,186,ha,"Kensu")).fortress().connect($d).connectTo(ae).trigger(Ae,Sb);(new Location$$module$js$nodes(c,187,Xa,"House")).house().connect(qb).trigger(Ce,
Ta,Sb);(new Location$$module$js$nodes(c,188,Xa,"Inn")).shop().connect(qb,Xb);(new Location$$module$js$nodes(c,190,Xa,"Tool Shop")).shop(R,ca,ka,ea).connect(qb,Xb);(new Location$$module$js$nodes(c,191,Xa,"Tavern")).shop().connect(qb);(new Location$$module$js$nodes(c,192,va,"Elder House")).house().connect(Qa).trigger(Hc);(new Location$$module$js$nodes(c,193,va,"Rabbit Hut")).house().connect(Qa).trigger(Nc,Mc,Ja);(new Location$$module$js$nodes(c,194,va,"Inn")).shop().connect(Qa);(new Location$$module$js$nodes(c,
195,va,"Tool Shop")).shop(R,ca,ka,ea).connect(Qa);(new Location$$module$js$nodes(c,196,va,"Armor Shop")).shop(Sa,Ra).connect(Qa);(new Location$$module$js$nodes(c,197,va,"Student House")).house().connect(Qa).trigger(Ic);(new Location$$module$js$nodes(c,198,bb,"Tavern")).house().connect(pb);(new Location$$module$js$nodes(c,199,bb,"Pawn Shop")).shop().connect(pb);(new Location$$module$js$nodes(c,200,bb,"Inn")).shop().connect(pb);(new Location$$module$js$nodes(c,201,bb,"Armor Shop")).shop(Ia,Ra,Ha).connect(pb);
(new Location$$module$js$nodes(c,203,bb,"Tool Shop")).shop(R,ca,ka).connect(pb);(new Location$$module$js$nodes(c,205,nb,"Elder House")).house().from(Bb,Ja).trigger(pe,Ub);(new Location$$module$js$nodes(c,206,nb,"Mother's House")).house().from(Bb,Ja).trigger(Lc,Ja).trigger(oe,Ub);(new Location$$module$js$nodes(c,207,nb,"Tool Shop")).shop(R,ca,ea).from(Bb,Ja);(new Location$$module$js$nodes(c,208,nb,"Inn")).shop().from(Bb,Ja);(new Location$$module$js$nodes(c,209,cb,"Inn")).shop().connect(Ab);(new Location$$module$js$nodes(c,
210,cb,"Tool Shop")).shop(ka,ea,Za).connect(Ab);(new Location$$module$js$nodes(c,211,cb,"Armor Shop")).shop(oc,u,rb,Y).connect(Ab);const Qh=(new Location$$module$js$nodes(c,212,cb,"Queen's House")).house().from(Ab,Se).trigger(ye,Ta,Bc);(new Location$$module$js$nodes(c,213,yb,"Nadare's")).house().connect(Cb).connectTo(Yf).connectTo(Zf).connectTo($f);(new Location$$module$js$nodes(c,214,I,"Fisherman's House")).house().connect(Ed).trigger(Vb,wc,Rb,Te);const nc=(new Location$$module$js$nodes(c,215,I,
"Palace Entrance")).house().connect(Ya);(new Location$$module$js$nodes(c,216,I,"Fortune Teller Front")).house().connect(Ya).trigger(Pc,Oc);(new Location$$module$js$nodes(c,216,I,"Fortune Teller Back")).house().connect(Eg).connect(Jd);(new Location$$module$js$nodes(c,217,I,"Pawn Shop")).shop().connect(Ya);(new Location$$module$js$nodes(c,218,I,"Armor Shop")).shop(be,oc,u).connect(Ya);(new Location$$module$js$nodes(c,220,I,"Inn")).shop().connect(Ya);(new Location$$module$js$nodes(c,221,I,"Tool Shop")).shop(R,
Za,Kb,ka).connect(Ya);(new Location$$module$js$nodes(c,222,I,"Palace Left")).house().connect(nc);(new Location$$module$js$nodes(c,223,I,"Palace Throne Room")).house().connect(nc).to(Fb,Me).from(Fb).trigger(Oc).trigger(se,Pc,Qc);(new Location$$module$js$nodes(c,224,I,"Palace Right")).house().connect(nc);(new Location$$module$js$nodes(c,225,I,"Asina's Room")).house().connect(Kd).trigger(Tc,cd);(new Location$$module$js$nodes(c,226,cb,"Queen Downstairs")).house().connect(Qh).chest(sa,13);(new Location$$module$js$nodes(c,
227,Na,"Elder's House")).house().connect(Gb).trigger(Wc);(new Location$$module$js$nodes(c,228,Na,"Shed")).house().connect(Gb).to(Pg,xc);(new Location$$module$js$nodes(c,229,Na,"Tool Shop")).shop(R,ca,ea,Za).connect(Gb);(new Location$$module$js$nodes(c,231,Na,"Inn")).shop().connect(Gb);const Rh=(new Location$$module$js$nodes(c,232,Z,"Zombie Town House")).house().connect(fc);(new Location$$module$js$nodes(c,233,Z,"Zombie Town Basement")).house().connect(Rh).trigger(ue,kd);(new Location$$module$js$nodes(c,
235,wa,"Tool Shop")).shop(R,ca,ea,ka).connect(Fa);(new Location$$module$js$nodes(c,236,wa,"Stom's Hut")).house().connect(Fa).trigger(Xc);(new Location$$module$js$nodes(c,237,wa,"Inn")).shop().connect(Fa);(new Location$$module$js$nodes(c,238,wa,"Armor Shop")).shop(ce,pc,F,Q).connect(Fa);(new Location$$module$js$nodes(c,239,wa,"Tavern")).house().connect(Fa).trigger(Yc,Xc,lb);(new Location$$module$js$nodes(c,240,wa,"Pawn Shop")).shop().connect(Fa);(new Location$$module$js$nodes(c,241,wa,"Dance Hall")).house().connect(Fa).trigger(Zc,
Yc,lb).trigger(xe,Zc,Ac);const Sh=(new Location$$module$js$nodes(c,242,Pa,"Temple (pre-massacre)")).fortress().connect(ib).from(Zb,O,W).trigger(ze);(new Location$$module$js$nodes(c,242,Pa,"Temple (post-massacre)")).fortress().from(Sh,$c).boss(df);(new Location$$module$js$nodes(c,243,Pa,"Training Hall")).house().connect(ib);(new Location$$module$js$nodes(c,244,Pa,"Hospital")).house().connect(ib);(new Location$$module$js$nodes(c,245,Pa,"Armor Shop")).shop(pc,Y,Q).connect(ib);(new Location$$module$js$nodes(c,
246,Pa,"Tool Shop")).shop(R,ca,Kb,ua).connect(ib);(new Location$$module$js$nodes(c,247,Pa,"Inn")).shop().connect(ib);(new Location$$module$js$nodes(c,248,ya,"Inn")).shop().connect(jb);(new Location$$module$js$nodes(c,249,ya,"Tool Shop")).shop(ca,ka,Lb,ua).connect(jb);(new Location$$module$js$nodes(c,250,ya,"Elder's House")).house().connect(jb);(new Location$$module$js$nodes(c,251,ya,"Pawn Shop")).house().connect(jb);const Th=[Qa,ob,md,fb,$b,gb,cc,yd,ec,Fa,Hb,hc,ic,Xd,jc];for(const a of Th)a.from(Zb,
...
k);var m=this.expandReachable(this.traverse((b)=>a.get(b),c),e);d.shuffle(m);let n=!1;const q=new Set(a.keys());for(const b of m){if(q.has(b))continue;q.add(b);const c=this.slotInfoFromIndex(b);if(c&&this.fits(c,l,e)){a.set(b,k);n=!0;break}}if(!n){q.clear();if(0<f--){for(const f of m)if(!q.has(f)&&a.has(f)&&!h.has(f)&&(q.add(f),(m=this.slotInfoFromIndex(f))&&this.fits(m,l,e))){k=null!==(g=a.replace(f,k))&&void 0!==g?g:die$$module$js$assert();c=Bits$$module$js$bits.with(c,k);b.push(k);d.shuffle(b);
...
Oak:c,Shyron_ToolShop:d},flags:{AbleToRideDolphin:e,BallOfFire:f,BallOfThunder:g,BallOfWater:h,BallOfWind:k,Barrier:m,BlizzardBracelet:l,BowOfMoon:n,BowOfSun:q,BreakStone:p,BreakIce:r,BreakIron:x,BrokenStatue:w,BuyHealing:y,BuyWarp:z,ClimbWaterfall:E,ClimbSlope8:v,ClimbSlope9:t,CurrentlyRidingDolphin:S,Flight:H,FlameBracelet:T,FormBridge:oa,GasMask:aa,GlowingLamp:W,InjuredDolphin:ia,LeadingChild:za,LeatherBoots:Aa,Money:V,OpenedCrypt:kb,RabbitBoots:X,Refresh:P,RepairedStatue:J,RescuedChild:N,ShellFlute:O,
ShieldRing:pa,ShootingStatue:da,StormBracelet:Ba,Sword:ba,SwordOfFire:qa,SwordOfThunder:ra,SwordOfWater:sa,SwordOfWind:ja,TornadoBracelet:Ga,TravelSwamp:Ra,WildWarp:Ha},items:{MedicalHerb:u,WarpBoots:rb}}=this.rom,F=this.entrance(b);var Y=this.entrance(c);this.addCheck([F],and$$module$js$logic$world(n,q),[kb.id]);this.addCheck([F],and$$module$js$logic$world(e,O),[S.id]);this.addCheck([Y],and$$module$js$logic$world(za),[N.id]);this.addItemCheck([F],and$$module$js$logic$world(W,w),J.id,{lossy:!0,unique:!0});
for(var Q of this.rom.shops)if(Q.location!==a.id&&Q.location!==d.id&&Q.used&&Q.type===module$js$rom$shop.ShopType.TOOL){Y=[module$js$logic$tileid.TileId(Q.location<<16|136)];for(var ta of Q.contents)ta===u.id?this.addCheck(Y,V.r,[y.id]):ta===rb.id&&this.addCheck(Y,V.r,[z.id])}Q=ja.r;ta=qa.r;Y=sa.r;let Sa=ra.r;if(!this.flagset.orbsOptional()){var Ia=or$$module$js$logic$world(k,Ga);const a=or$$module$js$logic$world(f,T),b=or$$module$js$logic$world(h,l),c=or$$module$js$logic$world(g,Ba);Q=module$js$logic$requirement.Requirement.meet(Q,
Ia);ta=module$js$logic$requirement.Requirement.meet(ta,a);Y=module$js$logic$requirement.Requirement.meet(Y,b);Sa=module$js$logic$requirement.Requirement.meet(Sa,c);if(this.flagset.assumeSwordChargeGlitch()){Ia=function(b){return a.map((a)=>a[0]===b.c?a:[b.c,...a])};const a=module$js$logic$requirement.Requirement.or(Q,ta,Y,Sa);Q=Ia(ja);ta=Ia(qa);Y=Ia(sa);Sa=Ia(ra)}}this.addCheck([F],Q,[p.id]);this.addCheck([F],ta,[r.id]);this.addCheck([F],Y,[oa.id]);this.addCheck([F],Sa,[x.id]);this.addCheck([F],or$$module$js$logic$world(ja,
qa,sa,ra),[ba.id,V.id]);this.addCheck([F],H.r,[E.id]);this.addCheck([F],or$$module$js$logic$world(H,X),[v.id]);this.addCheck([F],or$$module$js$logic$world(H,X),[t.id]);this.addCheck([F],m.r,[da.id]);this.addCheck([F],aa.r,[Ra.id]);this.flagset.leatherBootsGiveSpeed()&&this.addCheck([F],Aa.r,[v.id]);this.flagset.assumeGhettoFlight()&&this.addCheck([F],and$$module$js$logic$world(S,X),[E.id]);this.flagset.fogLampNotRequired()&&(Q=this.flagset.requireHealedDolphinToRide(),this.addCheck([F],Q?ia.r:[[]],
[e.id]));this.flagset.guaranteeBarrier()||this.addCheck([F],[[V.c,y.c],[V.c,pa.c],[V.c,P.c]],[da.id]);this.flagset.assumeFlightStatueSkip()||this.addCheck([F],[[V.c,H.c]],[da.id]);this.flagset.guaranteeGasMask()||this.addCheck([F],[[V.c,y.c],[V.c,P.c]],[Ra.id]);this.flagset.assumeWildWarp()&&this.addCheck([F],module$js$logic$requirement.Requirement.OPEN,[Ha.id])}addExtraRoutes(){var a;const {flags:{BuyWarp:b,SwordOfThunder:c,Teleport:d,WildWarp:e},locations:{MezameShrine:f}}=this.rom;this.addRoute(new Route$$module$js$logic$requirement(this.entrance(f),
...
1,0),d++;6>d?b&=~module$js$logic$terrain.Terrain.SLOPE:9>d?b|=module$js$logic$terrain.Terrain.SLOPE8:10>d&&(b|=module$js$logic$terrain.Terrain.SLOPE9)}return this.terrainFactory.tile(b)};for(let m=0,x=a.height;m<x;m++){const r=a.screens[m],x=a.id<<8|m<<4;for(let m=0,w=a.width;m<w;m++){const w=this.rom.screens[r[m]],y=module$js$logic$screenid.ScreenId(x|m),E=f.has(y),z=y&255;var n=e.get(y);n=g?this.rom.flags.AlwaysTrue.id:null!=n?this.wallCapability(n):null===(b=a.flags.find((a)=>a.screen===z))||void 0===
b?void 0:b.flag;const T=null!==(d=null===(c=this.rom.flags[n])||void 0===c?void 0:c.logic)&&void 0!==d?d:{};for(let b=0;240>b;b++){const c=module$js$logic$tileid.TileId(y<<8|b);var q=w.tiles[b];T.assumeTrue&&32>q&&(q=h.alternates[q]);var p=a.isShop()?0:k.effects[q]&38;p=l(p,c,E);32>q&&h.alternates[q]!==q&&null!=n&&!T.assumeTrue&&!T.assumeFalse&&(q=l(k.effects[h.alternates[q]],c,E))&&(p=this.terrainFactory.flag(p,T.track?n:-1,q));p&&this.terrains.set(c,p)}}}for(const f of a.exits){const {dest:g,entrance:h}=
...
8|(a.entrance&61440)>>8|(a.entrance&240)>>4,a.dir),this.stairScreens.set(b.edges,[a.dir,{entrance:a.entrance,exits:[a.exit,a.exit+1]}]);b.wall&&this.walls.set(b.tile,b.wall.type);128!=b.tile&&b.fixed&&(this.fixedTiles.has(b.tile)||this.fixedTiles.set(b.tile,b));b.deadEnd&&this.deadEndTiles.add(b.tile)}}survey(a){let b=0,c=0,d=0,e=0,f=0,g=0,h=!0,k=!1;const m=new Map,l=new Map,n=new Map,q=new Multiset$$module$js$util,p=[];this.empty&&p.push(this.empty);var r=new Set([].concat(...a.screens));for(var x of this.specSets)for(var w of x)if(128!==
w.tile&&r.has(w.tile)){p.push(...x);break}if(164===a.tileset)for(r=p.length-1;0<=r;r--)69648===p[r].edges&&p.splice(r,1);r=new Set([...a.reachableTiles(!0).keys()].map((a)=>a>>>8));if(!r.size)throw Error("No reachable tiles");x=new Map(a.entrances.map((b,c)=>{for(const d of a.exits)if(20>Math.abs(d.x-b.x)&&20>Math.abs(d.y-b.y))return[c,d.dest<<8|d.entrance];return null}).filter(isNonNull$$module$js$util));for(w=0;w<a.entrances.length;w++){var y=a.entrances[w],z=this.stairsByTile.get(a.screens[y.screen>>>
4][y.screen&15]<<8|y.tile);if(null!=z){var E=x.get(w);if(null==E)throw Error("Could not find exit");m.set(y.screen,{entrance:w,exit:E,dir:z})}}for(w=0;w<a.height;w++)for(y=0,w||(y|=1),w===a.height-1&&(y|=4),z=0;z<a.width;z++){E=w<<4|z;if(!r.has(E))continue;y&=-11;z||(y|=8);z===a.width-1&&(y|=2);var v=a.screens[w][z];q.add(v);if(128===v)continue;WIDE_SET$$module$js$maze$spec.has(v)?k=!0:h=!1;b++;RIVER_TILES$$module$js$maze$spec.has(v)&&g++;let p=this.edgesByTile.get(v);if(null==p)throw Error(`Bad tile: ${hex$$module$js$rom$util(v)}`);
var t=BITCOUNT$$module$js$maze$spec[p]+(m.has(E)?1:0);154===v&&(t=2);if(155===v||156==v||240==v||241==v)t=1;1===t&&c++;2<t&&(d+=t-2);t=this.walls.get(v);"wall"===t&&e++;"bridge"===t&&f++;t=this.fixedTiles.get(v);this.deadEndTiles.has(v)&&(p=0);for(var S of module$js$maze$types.Dir.ALL)if(p&y&1<<S){v=null;for(var H=0;H<a.entrances.length;H++)if(a.entrances[H].screen===E&&matchesDir$$module$js$maze$spec(a.entrances[H].tile,S)){v=H;break}if(null!=v){H=x.get(v);if(null==H)throw Error("Could not find exit");
l.set(E,{entrance:v,exit:H,dir:S})}}null!=t&&n.set(E,t)}if(g)for(const [a,b]of n)29046===b.edges&&(S=p.find((a)=>459009===a.edges))&&n.set(a,S);if(h!=k)throw Error("Found inconsistent use of wide tiles");return{size:b,rivers:g,deadEnds:c,branches:d,walls:e,bridges:f,stairs:m,edges:l,fixed:n,tiles:q,wide:h,specs:p,specSet:this}}}SpecSet$$module$js$maze$spec.CAVE=new SpecSet$$module$js$maze$spec(ALL_CAVE_SCREENS$$module$js$maze$spec,EMPTY_CAVE_SCREEN$$module$js$maze$spec);
...
function downStair$$module$js$rom$metascreendata(a,b){b=void 0===b?2:b;const c=a>>>4,d=a&15;return 1===b?{type:"stair:down",dir:2,entrance:(c<<12)-2048|(d<<4)+8,exits:[a]}:{type:"stair:down",dir:2,entrance:c<<12|3840|(d<<4)+(b<<3),exits:seq$$module$js$rom$util(b,(b)=>a+16+b)}}function cave$$module$js$rom$metascreendata(a,b){b=void 0===b?"cave":b;return Object.assign({},upStair$$module$js$rom$metascreendata(a+16),{type:b})}
function door$$module$js$rom$metascreendata(a,b){b=void 0===b?"door":b;return Object.assign({},upStair$$module$js$rom$metascreendata(a,1),{type:b})}function waterfallCave$$module$js$rom$metascreendata(a){return{type:"cave",dir:0,entrance:a>>>4<<12|(a&15)<<4|15,exits:[a-15,a+1]}}
...
if(1!==b.size)throw Error(`Non-unique tileset for ${a}: [${Array.from(b,(a)=>a.name).join(", ")}]`);b=[...b][0]}const q=a.reachableTiles(!0);l=b.exit.uid;m=Array(k+2<<4).fill(b.empty.uid);for(let c=0;c<k;c++)for(let d=0;d<h;d++){var p=b.getMetascreens(a.screens[c][d]);n=void 0;if(1===p.size)[n]=p;else if(p.size){var r=a.flags.find((a)=>a.screen===(c<<4|d)),x=[],w=[];for(var y of p)y.data.match?x.push(y):"always"===y.flag&&766===(null===r||void 0===r?void 0:r.flag)||!y.flag&&!y.data.wall&&!r?w.unshift(y):
w.push(y);if(x.length){p=function(a,b){b=(d<<8)+b;a=(c<<8)+a;return q.has(a<<4&61440|b&3840|a&240|b>>4&15)};for(var z of x)if(z.data.match(p,null!=r)){n=z;break}}n||(n=w[0])}else throw Error("impossible");if(!n)throw Error("impossible");r=c+1<<4|d;m[r]=n.uid;n=n.edgeExits();0===c&&n&1&&(m[r-16]=l);0===d&&n&2&&(m[r-1]=l);c===k&&n&4&&(m[r+16]=l);d===h&&n&8&&(m[r+1]=l)}y=new Table$$module$js$util;for(const b of a.exits)if(z=b.screen,n=g.metascreens[m[z+16]],r=n.findExitType(b.tile,1===k,!!(b.entrance&
32)),l=null===r||void 0===r?void 0:r.type,!l)unknownExitWhitelist$$module$js$rom$metalocation.has(a.id<<16|z<<8|b.tile)||(l=null===(d=n.data.exits)||void 0===d?void 0:d.map((a)=>a.type+": "+a.exits.map(hex$$module$js$rom$util).join(", ")).join("\n  "),console.warn(`Unknown exit ${hex$$module$js$rom$util(b.tile)}: ${n.name} in ${a} @ ${hex$$module$js$rom$util(z)}:\n  ${l}`));else if(!y.has(z,l))if(n=g.locations[b.dest],l.startsWith("seamless"))x="seamless:down"===l,r=r.exits[0]+(x?-16:16),y.set(z,
l,[n.id<<8|z+(0>r?-16:240<=r?16:-0),x?"seamless:up":"seamless:down"]);else if(w=n.entrances[b.entrance&31],r=w.screen,x=w.coord,"door"===l&&0===(w.y&240)&&(r-=16,x+=65536),w=n.screens[r>>4][r&15],p=c(n,w,x))y.set(z,l,[n.id<<8|r,p]);else{z=[];for(const a of g.metascreens.getById(w,n.tileset))for(const b of null!==(e=a.data.exits)&&void 0!==e?e:[])b.type.startsWith("seamless")||z.push(`  ${a.name} ${b.type}: ${hex$$module$js$rom$util(b.entrance)}`);console.warn(`Bad entrance ${hex$$module$js$rom$util(x)}: raw ${hex$$module$js$rom$util(w)} in ${n} @ ${hex$$module$js$rom$util(r)}\n${z.join("\n")}`)}d=
new Metalocation$$module$js$rom$metalocation(a.id,b,k,h);for(e=0;e<m.length;e++)d.setInternal(e,m[e]);d._screens=m;d._exits=y;for(const b of a.flags)a=g.metascreens[d._screens[b.screen+16]],(null===(f=a.flag)||void 0===f?0:f.startsWith("custom"))?d.customFlags.set(b.screen,g.flags[b.flag]):a.flag||d.freeFlags.add(g.flags[b.flag]);return d}getUid(a){return this._screens[a+16]}get size(){return this._filled}get width(){return this._width}set width(a){this._width=a;this._pos=void 0}get height(){return this._height}set height(a){this._height>
a?this._screens.splice(a+2<<4,this._height-a<<4):this._height<a&&(this._screens.length=a+2<<4,this._screens.fill(this._empty,this.height+2<<4,this._screens.length));this._height=a;this._pos=void 0}allPos(){if(this._pos)return this._pos;const a=this._pos=[];for(let b=0;b<this._height;b++)for(let c=0;c<this._width;c++)a.push(b<<4|c);return a}setInternal(a,b){var c=this.inBounds(a);a+=16;c&&this._screens[a]!==this._empty&&this._filled--;c&&b!==this._empty&&this._filled++;c=this._counted.get(this._screens[a]);
null==b&&(b=this._empty);this._screens[a]=b;this._counts&&(null!=c&&this._counts.delete(c),b=this._counted.get(b),null!=b&&this._counts.add(b))}invalidateMonsters(){this._monstersInvalidated=!0}inBounds(a){return(a&15)<this.width&&0<=a&&a>>>4<this.height}setFeature(a,b){this._features.set(a,this._features.get(a)|featureMask$$module$js$rom$metascreendata[b])}set2d(a,b){this.saveExcursion(()=>{const c=a;for(const c of b){let b=0;for(const d of c)d&&this.setInternal(a+b++,d.uid);a+=16}this.verify(c,
b.length,Math.max(...b.map((a)=>a.length)));return!0})}verify(a,b,c){const d=this.height+1<<4;for(let e=0;e<=b;e++){const b=a+16+(e<<4);for(let a=0;a<=c;a++){const c=b+a,e=this._screens[c];if(null==e)break;const f=this._screens[c-16],g=this._screens[c-1];if((c&15)<this.width&&!this.tileset.check(f,e,16))throw Error(`bad neighbor ${this.rom.metascreens[f].name} above ${this.rom.metascreens[e].name} at ${this.rom.locations[this.id]} @ ${hex$$module$js$rom$util(c-32)}`);if(c<d&&!this.tileset.check(g,
e,1))throw Error(`bad neighbor ${this.rom.metascreens[g].name} left of ${this.rom.metascreens[e].name} at ${this.rom.locations[this.id]} @ ${hex$$module$js$rom$util(c-17)}`);}}}bookkeep(){this._pos=void 0;this._filled=0;this._counts&&(this._counts=new Multiset$$module$js$util);for(const a of this.allPos()){const b=this._screens[a+16];if(this._counts){const a=this._counted.get(b);null!=a&&this._counts.add(a)}b!=this.tileset.empty.id&&this._filled++}}spliceColumns(a,b,c,d){if(this._features.size)throw Error("bad features");
this.saveExcursion(()=>{for(let e=0;e<this._screens.length;e+=16)this._screens.copyWithin(e+a+c,e+a+b,e+10),this._screens.splice(e+a,c,...d[e>>4].map((a)=>a.uid));return!0});const e=c-b;this.width+=e;this._pos=void 0;this.bookkeep();var f=[];for(const [c,d]of this._exits){var g=c&15;g<a+b?g>=a&&this._exits.delete(c,d):f.push([c,d,c+e,d])}this.moveExits(...f);f=this.rom.locations[this.id];g=a+b<<4;for(const a of f.spawns)a.xt<g||(a.xt-=e<<4);for(const c of f.flags)c.xs<a+b?c.xs>=a&&(c.screen=255):
c.xs-=e;f.flags=f.flags.filter((a)=>255!==a.screen)}set(a,b){var c=this.rom.metascreens[b],d=this._features.get(a);if(null!=d&&!c.hasFeatures(d))return!1;for(c=0;4>c;c++)if(d=DPOS$$module$js$rom$metalocation[c],!this.tileset.check(b,this._screens[a+d],d))return!1;this.setInternal(a,b);return!0}setExit(a,b,c){const d=this.rom.locations[c[0]>>>8].meta;if(!d)throw Error("Cannot set two-way exit without meta");this.setExitOneWay(a,b,c);d.setExitOneWay(c[0]&255,c[1],[this.id<<8|a,b])}setExitOneWay(a,b,
c){this._exits.set(a,b,c)}exitCandidates(a){var b;const c=[];for(const d of this.tileset)(null===(b=d.data.exits)||void 0===b?0:b.some((b)=>b.type===a))&&c.push(d.id);return c}tryAddOneOf(a,b){for(const c of b)if(this.set(a,c))return!0;return!1}show(){var a,b;const c=[];let d=[];for(var e=0;e<this.width;e++)d.push(e.toString(16));c.push("   "+d.join("  "));for(e=0;e<this.height;e++)for(let f=0;3>f;f++){d=[1===f?e.toString(16):" "," "];for(let c=0;c<this.width;c++){const g=this.rom.metascreens[this._screens[e+
1<<4|c]];d.push(null!==(b=null===(a=null===g||void 0===g?void 0:g.data.icon)||void 0===a?void 0:a.full[f])&&void 0!==b?b:1===f?" ? ":"   ")}c.push(d.join(""))}return c.join("\n")}screenNames(){const a=[];for(let b=0;b<this.height;b++){let c=[];for(let a=0;a<this.width;a++){const d=this.rom.metascreens[this._screens[b+1<<4|a]];c.push(null===d||void 0===d?void 0:d.name)}a.push(c.join(" "))}return a.join("\n")}saveExcursion(a){let b=[...this._screens],c=this._counts&&[...this._counts],d=this._filled,
e=[...this._features],f=!1;try{f=a()}finally{if(f)return!0;this._screens=b;c&&(this._counts=new Multiset$$module$js$util(c));this._filled=d;this._features=new Map(e)}return!1}traverse(a={}){var b=new Set(a.without||[]),c=new UnionFind$$module$js$unionfind;a=(a.flight?2:0)|(a.noFlagged?1:0);for(const e of this.allPos()){if(b.has(e))continue;const f=this.rom.metascreens[this._screens[e+16]];for(var d of f.connections[a])c.union(d.map((a)=>(e<<8)+a))}b=new Map;c=c.sets();for(d=0;d<c.length;d++){a=c[d];
for(const c of a)b.set(c,a)}return b}*borders(){const a=this.tileset.exit.uid;for(var b=0;b<this.width;b++){var c=b,d=this.height<<4|b;yield[c,module$js$rom$metatileset.Dir.N,this._screens[c+16],this._screens[c]===a];yield[d,module$js$rom$metatileset.Dir.S,this._screens[d+16],this._screens[d+32]===a]}for(b=1;b<=this.height;b++)c=b<<4,d=c|this.width-1,yield[c,module$js$rom$metatileset.Dir.W,this._screens[c+16],this._screens[c+15]===a],yield[d,module$js$rom$metatileset.Dir.E,this._screens[d+16],this._screens[d+
17]===a]}attach(a,b,c,d,e){d||(d=this.pickTypeFromExits(a));e||(e=b.pickTypeFromExits(c));const f=b.id<<8|c,g=this._exits.get(a,d);if(g){const [a,b]=g;if(a===f&&b===e)return}const h=b._exits.get(c,e);this._exits.set(a,d,[f,e]);b._exits.set(c,e,[this.id<<8|a,d]);if(h&&g){const [b,c]=g,[d,e]=h;a=this.rom.locations[b>>8].meta;this.rom.locations[d>>8].meta._exits.set(d&255,e,g);a._exits.set(b&255,c,h)}else if(h||g){const [a,b]=h||g;this.rom.locations[a>>8].meta._exits.delete(a&255,b)}}pickTypeFromExits(a){const b=
[...this._exits.row(a).keys()];if(!b.length)return this.pickTypeFromScreens(a);if(1<b.length)throw Error(`No single type for ${hex$$module$js$rom$util(a)}: [${b.join(", ")}]`);return b[0]}moveExits(...a){const b=[];for(const [c,d,e,f]of a){a=this._exits.get(c,d);const [g,h]=a;this.rom.locations[g>>8].meta._exits.set(g&255,h,[this.id<<8|e,f]);b.push([e,f,a]);this._exits.delete(c,d)}for(const [a,d,e]of b)this._exits.set(a,d,e)}moveExit(a,b,c,d){c||(c=this.pickTypeFromExits(a));d||(d=this.pickTypeFromScreens(b));
const e=this._exits.get(a,c),[f,g]=e;this.rom.locations[f>>8].meta._exits.set(f&255,g,[this.id<<8|b,d]);this._exits.set(b,d,e);this._exits.delete(a,c)}pickTypeFromScreens(a){var b=this.rom.metascreens[this._screens[a+16]].data.exits;b=(null!==b&&void 0!==b?b:[]).map((a)=>a.type);if(1!==b.length)throw Error(`No single type for ${hex$$module$js$rom$util(a)}: [${b.join(", ")}]`);return b[0]}reconcileExits(a){const b=[];for(const c of[this,a])for(const [a,e,[f,g]]of c._exits){const d=this.rom.locations[f>>>
8].meta._exits.get(f&255,g);if(!d)continue;const [k,m]=d;k>>>8===c.id&&(k&255)===a&&m===e&&b.push([a,e,[f,g]])}this._exits=new Table$$module$js$util(b);a._exits=new Table$$module$js$util(b)}write(){var a,b,c,d,e,f,g;const h=this.rom.locations[this.id];for(const [c,d,[e,f]]of this._exits){var k=this.rom.metascreens[this._screens[c+16]],m=e>>8;let g=e&255;const n=this.rom.locations[m],q=this.rom.metascreens[n.meta._screens[(e&255)+16]],p=null===(a=k.data.exits)||void 0===a?void 0:a.find((a)=>a.type===
d);var l=null===(b=q.data.exits)||void 0===b?void 0:b.find((a)=>a.type===f);if(!p||!l)throw Error(`Missing exit:
  From: ${h} @ ${hex$$module$js$rom$util(c)}:${d} ${k.name}
  To:   ${n} @ ${hex$$module$js$rom$util(g)}:${f} ${q.name}`);k=32;l.type.startsWith("seamless")||(l=l.entrance,61439<l&&(g+=16,l-=65536),k=n.findOrAddEntrance(g,l));for(let a of p.exits)"edge:bottom"===p.type&&1===this.height&&(a-=32),h.exits.push(Exit$$module$js$rom$locationtables.of({screen:c,tile:a,dest:m,entrance:k}))}h.width=this._width;h.height=this._height;h.screens=[];for(a=0;a<this._height;a++)for(b=[],h.screens.push(b),m=0;m<this._width;m++)b.push(this.rom.metascreens[this._screens[a+1<<
4|m]].id);h.tileset=this.tileset.tilesetId;h.tileEffects=this.tileset.effects().id;h.flags=[];a=[...this.freeFlags];for(const k of this.allPos()){b=this.rom.metascreens[this._screens[k+16]];let l;b.hasFeature("wall")||b.hasFeature("bridge")?l=null!==(d=null===(c=a.pop())||void 0===c?void 0:c.id)&&void 0!==d?d:this.rom.flags.alloc(512):"always"===b.flag?l=this.rom.flags.AlwaysTrue.id:"calm"===b.flag?l=this.rom.flags.CalmedAngrySea.id:"custom:false"===b.flag?l=null===(e=this.customFlags.get(k))||void 0===
e?void 0:e.id:"custom:true"===b.flag&&(l=null!==(g=null===(f=this.customFlags.get(k))||void 0===f?void 0:f.id)&&void 0!==g?g:this.rom.flags.AlwaysTrue.id);null!=l&&h.flags.push(Flag$$module$js$rom$locationtables.of({screen:k,flag:l}))}}}const unknownExitWhitelist$$module$js$rom$metalocation=new Set([65594,65595,65648,135519,1327264,1392800,1716320,1716384,4202496,4202544,4292816,6326207,10552102,10552105,11077158,11077161]),DPOS$$module$js$rom$metalocation=[-16,-1,16,1];
var module$js$rom$metalocation={};module$js$rom$metalocation.Metalocation=Metalocation$$module$js$rom$metalocation;const {$0a:$0a$$module$js$rom$location,$0b:$0b$$module$js$rom$location,$0c:$0c$$module$js$rom$location,$0d:$0d$$module$js$rom$location}=Segment$$module$js$rom$util,CAVE$$module$js$rom$location={subArea:"cave",music:(a)=>`${a.name}-Cave`,palette:(a)=>`${a.name}-Cave`},HOUSE$$module$js$rom$location={subArea:"house",palette:()=>Symbol()},FORTUNE_TELLER$$module$js$rom$location={subArea:"house",palette:()=>Symbol(),music:(a)=>`${a.name}-FortuneTeller`},MESIA$$module$js$rom$location={name:"mesia",music:(a)=>
...
this.bgm=this.originalBgm=0,this.screens=[[0]],this.tilePalettes=[36,1,38],this.originalTilePalettes=[36,1,38],this.tileset=128,this.tileEffects=179,this.tilePatterns=[2,4],this.exits=[],this.entrances=[],this.flags=[],this.pits=[],this.spawns=[],this.spritePalettes=[0,0],this.spritePatterns=[0,0]}set meta(a){this._meta=a}get meta(){this._meta||(this._meta=Metalocation$$module$js$rom$metalocation.of(this));return this._meta}get name(){return this.data.name}get mapDataPointer(){if(0>this.id)throw Error(`no mapdata pointer for ${this.name}`);
return 82688+(this.id<<1)}get npcDataPointer(){if(0>this.id)throw Error(`no npcdata pointer for ${this.name}`);return 102913+(this.id<<1)}get hasSpawns(){return 0<this.spawns.length}mapPlane(){const a=new Set;for(const b of this.screens)for(const c of b)a.add(c>>>8);if(1!==a.size)throw Error(`Non-unique screen page: ${[...a].join(", ")}`);return a[Symbol.iterator]().next().value}isShop(){null==this._isShop&&(this._isShop=0<=this.rom.shops.findIndex((a)=>a.location===this.id));return this._isShop}spawn(a){const b=
this.spawns[a-13];if(!b)throw Error(`Expected spawn $${hex$$module$js$rom$util(a)}`);return b}get width(){return this.layoutWidth+1}set width(a){this.layoutWidth=a-1}get height(){return this.layoutHeight+1}set height(a){this.layoutHeight=a-1}findOrAddEntrance(a,b){for(let c=0;c<this.entrances.length;c++){const d=this.entrances[c];if(d.screen===a&&d.coord===b)return c}this.entrances.push(Entrance$$module$js$rom$locationtables.of({screen:a,coord:b}));return this.entrances.length-1}assemble(a){if(this.used){var b=
this.id.toString(16).padStart(2,"0"),c=this.spawns.length?this.spritePalettes:[255,255],d=[],e=[0,...c,...this.spawns.length?this.spritePatterns:[255,255],...concatIterables$$module$js$rom$util(this.spawns),255];a.segment("0c","0d");a.reloc(`NpcData_${b}`);var f=a.pc();a.byte(...e);a.org(37377+(this.id<<1),`NpcData_${b}_Ptr`);a.word(f);a.segment("0a","0b");e=[];for(var g of concatIterables$$module$js$rom$util(this.screens))e.push(g&255);g=this.rom.compressedMapData?[this.bgm,this.layoutHeight<<4|
this.layoutWidth,this.mapPlane()<<2|this.animation,...e]:[this.bgm,this.layoutWidth,this.layoutHeight,this.animation,this.mapPlane()?128:0,...e];a.reloc(`MapData_${b}_Layout`);e=a.pc();a.byte(...g);d.push(e);a.reloc(`MapData_${b}_Graphics`);g=a.pc();a.byte(...this.tilePalettes,this.tileset,this.tileEffects,...this.tilePatterns);d.push(g);if(1===this.height){for(var h of this.entrances)h.used&&191<h.y&&(h.y=191);for(var k of this.exits)12<k.yt&&(k.yt=12)}a.reloc(`MapData_${b}_Entrances`);h=a.pc();
a.byte(...concatIterables$$module$js$rom$util(this.entrances));d.push(h);a.reloc(`MapData_${b}_Exits`);h=a.pc();a.byte(...concatIterables$$module$js$rom$util(this.exits),128|(this.pits.length?64:0)|this.entrances.length);d.push(h);a.reloc(`MapData_${b}_Flags`);h=a.pc();a.byte(...concatIterables$$module$js$rom$util(this.flags),255);d.push(h);h=concatIterables$$module$js$rom$util(this.pits);h.length&&(a.reloc(`MapData_${b}_Pits`),k=a.pc(),a.byte(...h),d.push(k));a.reloc(`MapData_${b}`);h=a.pc();a.word(...d);
a.org(33536+(this.id<<1),`MapData_${b}_Ptr`);a.word(h);b=this.bossId();if(null!=b&&95!==this.id){d=this.rom.bossKills[b].base;h=[,,,166===this.id?0:this.bgm,,...this.tilePalettes,,,,this.spritePalettes[0],,,,,,,,this.animation];a.segment("0f");for(k=0;k<h.length;k++)g=h[k],null!=g&&(a.org(d+k,`Boss_${b}_${k}`),a.byte(g));a.org(47041+5*b,`Boss_${b}_Post`);a.byte(c[1])}}}allScreens(){const a=new Set;for(const b of this.screens)for(const c of b)a.add(this.rom.screens[c]);return a}bossId(){for(let a=
0;14>a;a++)if(this.rom.prg[129373+a]===this.id)return a}hasDolphin(){return 96===this.id||100===this.id||104===this.id}reachableTiles(a){a=void 0===a?!1:a;this.hasDolphin()&&(a=!0);const b=new Set(this.exits.map((a)=>a.screen<<8|a.tile));var c=new UnionFind$$module$js$unionfind;const d=this.rom.tilesets[this.tileset],e=this.rom.tileEffects[this.tileEffects-179];var f=new Set;for(let c=0;c<this.height;c++){const h=this.screens[c];for(let k=0;k<this.width;k++){const l=this.rom.screens[h[k]],m=c<<4|
k,p=this.flags.find((a)=>a.screen===m);for(let c=0;240>c;c++){const h=m<<8|c;if(b.has(h))continue;let k=l.tiles[c];var g=e.effects[k];g=a?g&4:g&6;p&&g&&32>k&&d.alternates[k]!=k&&(k=d.alternates[k],g=e.effects[k],g=a?g&4:g&6);g||f.add(h)}}}for(let b of f)a=15===(b&15)?b+241:b+1,f.has(a)&&c.union([b,a]),a=224===(b&240)?b+3872:b+16,f.has(a)&&c.union([b,a]);f=c.map();c=new Set;for(var h of this.entrances)h.used&&c.add(f.get(h.screen<<8|h.tile)||new Set);h=new Map;for(const a of c)for(const b of a)h.set(b,
...
module$js$maze$types.Scr.edge(c[1],c[2]);yield c}}*eligible(a,b){b=void 0===b?{}:b;const {allowed:c,skipAlternates:d,maxExits:e,edge:f,fuzzy:g,stair:h}=b;var k=null!=f?f|f<<4|f<<8|f<<12:void 0;let m=b=0,l=0;for(var n of module$js$maze$types.Dir.ALL){var q=module$js$maze$types.Dir.edgeMask(n),p=module$js$maze$types.Dir.edgeMask(module$js$maze$types.Dir.inv(n));let c=this.get(a,n);null==c&&(c=k);null!=c&&(l|=((c&p)>>>8|(c&p)<<8)&65535,b|=q,g&&this.isFixed(module$js$maze$types.Pos.plus(a,n))&&(m|=q))}g||
(m=b);a=l&m;n=[];k=Infinity;q=c?module$js$util.iters.map(c,(a)=>[a,this.screens.get(a)]):this.screens;for(const c of q){const [f,w]=c;if(!w)throw Error("Bad Scr in 'allowed'!");if(!(w.fixed||d&&w.edges&-65536||null!=h&&!w.stairs.some((a)=>a.dir===h)||null==h&&w.stairs.length||(f&m)!==a||e&&module$js$maze$types.Scr.numExits(f)>e))if(g){q=0;p=f&b^l;for(const a of module$js$maze$types.Dir.ALL)p&15<<module$js$maze$types.Dir.shift(a)&&q++;q<k?(k=q,n=[f]):q===k&&n.push(f)}else yield f}g&&(yield*n)}fill(a,
...
module$js$maze$types.Dir.edgeMask(e);if(h&~f)continue;const k=module$js$maze$types.Pos.plus(a,e);f=this.map[k];if(null==f)break;if(!c.has(f)&&!b.has(f))break;const l=g>>>module$js$maze$types.Dir.shift(e)&15,n=module$js$maze$types.Dir.inv(e),q=module$js$maze$types.Dir.edgeMask(n),p=f&~q|l<<module$js$maze$types.Dir.shift(n);if(c.has(p)&&!c.has(f))break;if(this.saveExcursion(()=>{this.setInternal(a,g);this.setInternal(k,p);return d()}))return!0}}return!1}show(a){a=void 0===a?!1:a;const b=" "+seq$$module$js$rom$util(this.width).join("")+
...
function shuffleCave$$module$js$maze$cave(a,b){(new (STRATEGIES$$module$js$maze$cave.get(a.id)||BasicCaveShuffle$$module$js$maze$cave)(a,b)).shuffle()}var module$js$maze$cave={};module$js$maze$cave.shuffleCave=shuffleCave$$module$js$maze$cave;function shuffleGoa1$$module$js$maze$goa(a,b,c=1500){extendGoaScreens$$module$js$maze$goa(a);const d=a.locations.GoaFortress_Kelbesque;var e=d.width;const f=d.height;a:for(let m=0;m<c;m++){var g=function(a,b=65536){const c=l.get(a);if(null==c)throw Error(`Cannot flag empty screen ${hex$$module$js$rom$util(a)}`);l.replace(a,c|b);if(h())return!0;l.replace(a,c);return!1},h=function(){const a=l.traverse(),b=a.get(p);return!b||!r.filter((a)=>b.has(a)).length||b.size<.8*a.size?!1:!0},k=function(a,b){l.set(a,
b,{force:!0})};const l=new Maze$$module$js$maze$maze(b,f,e,GOA1_SCREENS$$module$js$maze$spec),m=f-1<<4|b.nextInt(e),q=b.nextInt(e),p=m<<8|2,r=[q+32<<8|1,q+32<<8|3];k(m,61681);k(m-1,240);k(m+1,61440);k(q,65520);k(q-1,4080);k(q+1,65280);k(q+16,61951);k(q+15,255);k(q+17,61455);if(!l.connect(m,module$js$maze$types.Dir.UP,q+16,module$js$maze$types.Dir.DOWN))continue a;if(257===l.get(q+32)||257===l.get(m-16))continue a;for(k=0;10>k&&.65>l.density();k++)l.addLoop()&&(k=0);if(.45>l.density())continue a;if(!h())continue a;
for(const [a,c]of l)if(257===c&&257===l.get(a+16)&&(k=b.shuffle([0,16]),!g(a+k[0],131072)&&!g(a+k[1],131072)))continue a;for(const [a,c]of b.shuffle([...l.alternates()]))g(a,c);l.fillAll({edge:0});d.moveScreen(6,q);d.moveScreen(131,m);l.write(d,new Set);b=d.monsterPlacer(b);for(const f of d.spawns)f.isMonster()&&(c=a.objects[f.monsterId],c instanceof Monster$$module$js$rom$monster&&(e=b(c),null==e?(console.error(`no valid location for ${hex$$module$js$rom$util(c.id)} in ${hex$$module$js$rom$util(d.id)}`),
...
function tryShuffleSwamp$$module$js$maze$swamp(a,b,c,d,e){function f(){const a=d.traverse(),b=a.get(l);return b&&b.size===a.size||!1}const g=d.width,h=d.height,[k,m]=(()=>{let a,c;do a=b.nextInt(g),c=b.nextInt(h);while(2>a||2>c);return[a,c<<4]})();d.setBorder(m,module$js$maze$types.Dir.LEFT,1);d.set(k,61936,{force:!0});d.set(k-1,240,{force:!0});d.set(k+1,61440,{force:!0});d.fillAll({edge:1});const l=m<<8|16;var n=[...d].map((a)=>a[0]);for(var q=Math.floor(.6*g*h);q;q--){const a=b.pick(n),c=b.pick(module$js$maze$types.Dir.ALL),
e=module$js$maze$types.Pos.plus(a,c);!d.isFixed(a)&&!d.isFixed(e)&&d.get(a)&module$js$maze$types.Dir.edgeMask(c)?d.saveExcursion(()=>d.replaceEdge(a,c,0)?!!(d.get(a)&&d.get(e)&&f()):!1):q++}if(!d.consolidate(e,f,a))return!1;const [p,r]=b.pick([...d.alternates()]);if(65536!=r)throw Error(`unexpected alt: ${hex$$module$js$rom$util(r)}`);d.replace(p,d.get(p)|r);c.moveScreen(48,m);c.moveScreen(4,k);d.write(c,new Set);e=[];n=[];for(const [a,b]of d)a!==k&&a!==p&&(1!==b&&16!==b&&256!==b&&4096!==b||e.push(a),
17!==b&&272!==b&&4352!==b&&4097!==b||n.push(a));var x=a.screens[c.screens[p>>4][p&15]].tiles;q=0;for(let a=0;240>a;a++)if(3===x[a]){q=a;break}c.entrances[1].screen=p;c.entrances[1].tile=q+17;for(x=0;2>x;x++)c.exits[5+x].screen=p,c.exits[5+x].tile=q+x;e=b.pick(e.length?e:n);c.spawns[1].screen=e;e=c.monsterPlacer(b);for(const b of c.spawns)b.isMonster()&&(n=a.objects[b.monsterId],n instanceof Monster$$module$js$rom$monster&&(q=e(n),null==q?(console.error(`no valid location for ${hex$$module$js$rom$util(n.id)} in ${hex$$module$js$rom$util(c.id)}`),
b.used=!1):(b.screen=q>>>8,b.tile=q&255)));a.spoiler&&a.spoiler.addMaze(c.id,c.name,d.show());return!0}
...
return c[b]}isParalyzable(){for(let a=217176;217196>a;a++)if(this.rom.prg[a]===this.id)return!1;return!0}write(){if(!this.used)return[];const a=hex$$module$js$rom$util(this.id),b=this.rom.assembler();this.dataBase.loc(b,"PersonData_${id}");b.byte(...this.data);b.segment("0e","fe","ff");b.reloc(`SpawnCondition_${a}`);var c=b.pc();b.byte(...this.spawnConditionsBytes());this.spawnPointer.loc(b,`SpawnCondition_${a}_Pointer`);b.word(c);this.hasDialog()&&(b.segment("0e","fe","ff"),b.reloc(`Dialog_${a}`),
c=b.pc(),b.byte(...this.dialogBytes()),this.dialogPointer.loc(b,`Dialog_${a}_Pointer`),b.word(c));return[b.module()]}}
...
function patchLimeTreeLake$$module$js$pass$deterministic(a){a.screens[116].set2d(144,[[124,127,124,127,124,127,124,125,126,124,127,124,127,124,127,124],[48,48,48,48,48,48,48,null,null,48,48,48,48,48,48,48],[48,48,48,48,48,48,48,null,null,48,48,48,48,48,48,48]])}
function preventNpcDespawns$$module$js$pass$deterministic(a,b){function c(a,b){const c=a.indexOf(b);if(0>c)throw Error(`Could not find element ${b} in ${a}`);a.splice(c,1)}function d(a){a.reverse();for(let b=0;b<a.length;b++){const c=a[b+1];a[b].condition=c?~c.condition:-1}}const {locations:{BoatHouse:e,Brynmaer:f,Crypt_Draygon2:g,Joel_Shed:h,MtSabreNorth_SummitCave:k,MtSabreWest_Upper:m,PortoaPalace_ThroneRoom:l,Portoa_AsinaRoom:n,Portoa_FortuneTeller:q,Shyron_Temple:p,StomHouse:r,Swan_DanceHall:x,
Swan_Tavern:w,WindmillCave:y,WaterfallCave4:z,WaterfallValleyNorth:E,ZebuCave:v,ZombieTown_HouseBasement:t},items:{GlowingLamp:S,KeyToPrison:H,LovePendant:T,StatueOfOnyx:oa},npcs:{Akahana:aa,AkahanaInBrynmaer:W,Asina:ia,AztecaInShyron:za,Clark:Aa,Draygon:V,FortuneTeller:kb,Kensu:X,KensuInCabin:P,KensuInSwan:J,LeafRabbit:N,OakChild:O,OakElder:pa,OakMother:da,PortoaPalaceFrontGuard:Ba,PortoaQueen:ba,PortoaThroneRoomBackDoorGuard:qa,Rage:ra,Stom:sa,StonedAkahana:ja,Tornel:Ga,WindmillGuard:Ra,Zebu:Ha},
flags:u}=a;X.localDialogs.delete(w.id);J.link(X.id);J.used=!0;J.data=[...X.data];X.data[0]=S.id;x.spawns.find((a)=>a.isNpc()&&a.id===X.id).id=J.id;T.itemUseData[0].want=256|J.id;ja.linkDialog(aa.id);W.used=!0;W.link(aa.id);W.data=[...aa.data];f.spawns.find((a)=>a.isNpc()&&a.id===aa.id).id=W.id;oa.itemUseData[0].want=256|W.id;N.dialog()[2].condition=u.RescuedLeafElder.id;N.dialog()[2].flags.push(u.TalkedToLeafRabbit.id);N.dialog()[3].flags.push(u.TalkedToLeafRabbit.id);Ra.spawns(y)[1]=~u.WindmillGuardAlarmFluteTradein.id;
c(aa.spawns(z),~u.BehindWhirlpool.id);c(ja.spawns(z),~u.BehindWhirlpool.id);pa.dialog()[0].message.action=3;pa.dialog()[1].message.action=3;pa.dialog()[2].message.action=3;pa.dialog()[3].message.action=3;(()=>{const [a,b,c,d]=da.dialog();d.condition=~u.RescuedChild.id;b.condition=-1;da.dialog().splice(0,4,d,c,a,b)})();for(const b of[32,33,34,124,125])d(a.npcs[b].dialog());O.dialog().unshift(...O.dialog().splice(1,1));qa.spawnConditions.set(l.id,[~u.QueenNotInThroneRoom.id,~u.MesiaRecording.id]);Ba.dialog()[1].condition=
u.MesiaRecording.id;ba.dialog()[3].condition=u.SwordOfWater.id;ba.dialog()[3].message.action=3;ba.dialog()[4].flags.push(u.PortoaQueenGoingAway.id);ba.spawns(l)[1]=~u.MesiaRecording.id;ba.spawns(n)[0]=u.MesiaRecording.id;ba.dialog()[1].condition=u.MesiaRecording.id;kb.spawns(q)[1]=~u.MesiaRecording.id;Aa.spawnConditions.set(t.id,[~u.Clark.id]);Aa.spawnConditions.set(h.id,[u.Clark.id]);Ha.localDialogs.set(v.id,[LocalDialog$$module$js$rom$npc.of(~u.TalkedToZebuInCave.id,[0,26],[u.TalkedToZebuInCave.id]),
LocalDialog$$module$js$rom$npc.of(u.LeafVillagersRescued.id,[0,29]),LocalDialog$$module$js$rom$npc.of(u.LeafAbduction.id,[0,28]),LocalDialog$$module$js$rom$npc.of(u.ZebuAtWindmill.id,[0,29]),LocalDialog$$module$js$rom$npc.of(u.UsedWindmillKey.id,[0,27,3]),LocalDialog$$module$js$rom$npc.of(-1,[0,29])]);c(Ha.spawns(v),~u.BehindWhirlpool.id);Ga.spawnConditions.delete(m.id);sa.spawnConditions.delete(r.id);ia.data[1]=a.items.FluteOfLime.id;ia.dialog(n)[0].message.action=17;ia.dialog(n)[2].message.action=
17;c(ia.spawns(n),~u.CalmedAngrySea.id);P.spawnConditions.set(e.id,[~u.AbleToRideDolphin.id,u.ReturnedFogLamp.id]);P.dialog()[0].message.action=2;za.spawns(p).push(~u.ShyronMassacre.id);a.trigger(130).conditions.push(~u.ShyronMassacre.id);ra.dialog()[0].condition=u.SwordOfWater.id;V.spawnConditions.set(g.id,[~u.Draygon2.id]);Ha.dialog(p).unshift(...Ha.dialog(p).splice(1,1));a.trigger(128).conditions=[~u.ShyronMassacre.id,u.TalkedToZebuInShyron.id,u.SwordOfThunder.id];a.trigger(129).conditions=[];
...
b.text.replace(c,d)}const {flags:{AkahanaStatueOfOnyxTradein:f,AsinaInBackRoom:g,BehindWhirlpool:h,KensuInSwan:k,MtSabreNorthSummit:m,MtSabreWestTornel:l,PortoaQueen:n,Rage:q,RepairedStatue:p,SlimedKensu:r,StomFightReward:x,ZebuAtWindmill:w},npcs:{AkahanaInBrynmaer:y,Aryllis:z,Fisherman:E}}=a;e("03:06",",","");const v=buildTradeInMap$$module$js$pass$shuffletrades(a);w.item.isMagic()||c("00:1b");e("00:1b","[41:Refresh]",d(w.item));var t=b(y);e("02:01","an unusual statue",vague$$module$js$pass$fixdialog(t));
e("02:02","a statue",`the ${commonNoun$$module$js$pass$fixdialog(t)}`);e("02:02","[29:Gas Mask]",d(f));x.item.isMagic()||c("03:01");e("03:01","[43:Telepathy]",d(x));t=findTornelTradeIn$$module$js$pass$fixdialog(a);e("03:01","[06:Tornado Bracelet]",d(t));e("05:0a","[06:Tornado Bracelet]",d(t));e("05:0a","[44:Teleport]",d(l));t=b(E);e("09:01","[35:Fog Lamp]",d(t));e("09:04","[35:Fog Lamp]",d(t));e("09:05","[35:Fog Lamp]",d(t));e("09:06","lamp",commonNoun$$module$js$pass$fixdialog(t));t=a.npcs.PortoaQueen.dialog()[3].condition;
...
72>=c&&d(c)))return a.items[c]}}(79,78,77,76,71,70,69,68,75,74,73,72))?e("0d:00","[35:Fog Lamp]",d(t)):e("0d:00","that a [35:Fog Lamp] was","there was treasure");t=a.npcs.Rage.dialog()[0].condition;e("0e:03","[02:Sword of Water]",d(t));e("0e:03","[09:Ball of Water]",d(q));e("10:0c","that's","is");e("10:0c",/, is in the\+lighthouse/,"");t=b(z);e("12:05","[3c:Kirisa Plant]",d(t));e("12:10","the plant",`the ${commonNoun$$module$js$pass$fixdialog(t)}`);e("12:10","[3c:Kirisa Plant]",d(t));t=`Our illustrious chief seeks ${vague$$module$js$pass$fixdialog(t)}.`;
e("12:09",/[^]*/,t);e("12:0a",/[^]*/,t);t=b(a.npcs.KensuInSwan);e("13:02","[3b:Love Pendant]",d(t));e("13:00","pendant",commonNoun$$module$js$pass$fixdialog(t));k.item.isMagic()||c("13:02");e("13:02","[47:Change]",d(k));t=b(a.npcs.SlimedKensu);e("18:06","[3d:Ivory Statue]",d(t));e("18:07","[3d:Ivory Statue]",d(t));e("18:06","It's in a room","{0b:Karmine} is");r.item.isMagic()||e("18:07","teach","give");e("18:07","[48:Flight]",d(r));m.item.isMagic()||c("1c:10");e("1c:10","[42:Paralysis]",d(m));e("20:06",
"Statue of Gold",d(p))}const BOWS$$module$js$pass$fixdialog=new Set([62,63,64]),SWORD_OR_MAGIC$$module$js$pass$fixdialog=new Set([0,1,2,3,65,66,67,68,69,70,71,72]);function findTornelTradeIn$$module$js$pass$fixdialog(a){var {Tornel:b}=a.npcs;for(const c of b.localDialogs.values())for(b=2;b<c.length;b++){const d=~c[b].condition;if(516<d&&524>=d&&!(d&1))return a.items[d&255]}return a.items.TornadoBracelet}
...
8;e=new Set([87,94,104,125,136,151,155,158]);d=new Set([80,83,95,105]);for(const [h,{sdef:k,swrd:m,hits:l,satk:n,dgld:q,sexp:p}]of SCALED_MONSTERS$$module$js$pass$rescalemonsters)f=a.objects[h].data,g=e.has(h)?1:0,f[2]|=128,f[6]=l,f[7]=n,f[8]=k|m<<4,f[16]=f[16]&15|q<<4,f[17]=p,(g?b.shuffleBossElements():b.shuffleMonsterElements())&&!d.has(h)&&(f=[...a.objects[h].elements.toString(2).padStart(4,"0")],c.shuffle(f),a.objects[h].elements=Number.parseInt(f.join(""),2));if(b.shuffleMonsterElements()){b=
...
!0));g.push(`Initial pass: ${n.fixed.map((a)=>Infinity>a.size?"["+[...a].join(", ")+"]":"all")}`);const q=new Map;c=(a)=>{var c=e.rom.objects[a.id];if(c.monsterClass){var d=q.get(c.monsterClass);if(null!=d&&d!==a.id)return!1}d=FLYERS$$module$js$pass$shufflemonsters.has(a.id);var h=MOTHS_AND_BATS$$module$js$pass$shufflemonsters.has(a.id);if(d){if(!l)return!1;--l}const m=b.getMonsterConstraint(e.id,a.id);let r=n.tryMeet(m);!r&&Infinity>n.pal2.size&&Infinity>n.pal3.size&&this.flags.shuffleSpritePalettes()&&
(r=n.tryMeet(m,!0));if(!r)return!1;if(p){var v=e.rom.objects[a.id];if(!(v instanceof Monster$$module$js$rom$monster))throw Error(`non-monster: ${v}`);v=p(v);if(null==v)return!1}g.push(`  Adding ${a.id.toString(16)}: ${r}`);n=r;c.monsterClass&&q.set(c.monsterClass,a.id);c=0;if(d||h)for(d=0;d<f.length;d++){if(f[d]in k){c=d;break}}else for(d=0;d<f.length;d++)if(!(f[d]in k)){c=d;break}(this.report[`mon-${a.id.toString(16)}`]=this.report[`mon-${a.id.toString(16)}`]||[]).push("$"+e.id.toString(16));d=f[c];
h=e.spawns[d-13];p?(h.screen=v>>>8,h.tile=v&255):d in k&&(h.y+=16*k[d][0],h.x+=16*k[d][1]);h.monsterId=a.id;g.push(`    slot ${d.toString(16)}: ${h}`);f.splice(c,1);return!0};const p=f.length&&this.flags.randomizeMaps()?e.monsterPlacer(a):null;if(l&&f.length)for(var d=0;d<Math.min(40,this.monsters.length);d++)FLYERS$$module$js$pass$shufflemonsters.has(this.monsters[d].id)&&c(this.monsters[d])&&this.monsters.splice(d,1);for(d=0;d<this.monsters.length&&f.length;d++)if(c(this.monsters[d])){const [a]=
...
a=[new Set,new Set];for(d=0;2>d;d++)a[d]=new Set([...b[d].get(c.tilePatterns[0]),...b[d].get(c.tilePatterns[1])]);c=this.random.pick([...a[0]]);a=this.random.pick([...a[1]]);for(const b of e)b.tilePalettes[0]=c,b.tilePalettes[1]=a}}}var module$js$pass$shufflepalettes={};module$js$pass$shufflepalettes.shufflePalettes=shufflePalettes$$module$js$pass$shufflepalettes;function standardMapEdits$$module$js$pass$standardmapedits(a,b){b.eastCave?eastCave$$module$js$pass$standardmapedits(a,b.eastCave):b.classicLimeTreeToLeaf&&connectLimeTreeToLeaf$$module$js$pass$standardmapedits(a);addTowerExit$$module$js$pass$standardmapedits(a);reversibleSwanGate$$module$js$pass$standardmapedits(a);shrinkMado2$$module$js$pass$standardmapedits(a)}
...
function eastCave$$module$js$pass$standardmapedits(a,b){const {locations:{EastCave1:c,EastCave2:d,EastCave3:e,SealedCave1:f,ValleyOfWind:g},metascreens:{boundaryE_cave:h,branchNSE:k,branchNWE:m,branchNWSE:l,branchNWS:n,branchWSE:q,caveEmpty:p,deadEndE:r,deadEndE_downStair:x,deadEndE_upStair:w,deadEndN_stairs:y,deadEndS:z,deadEndS_stairs:E,deadEndW:v,deadEndW_downStair:t,exit:S,hallNE:H,hallNS:T,hallNW:oa,hallSE:aa,hallWS:W,hallWE:ia,hallNS_entrance:za,hallNS_stairs:Aa,hallNS_wall:V}}=a;a.locations.allocate(a.locations.EastCave1);
a.locations.allocate(a.locations.EastCave2);b.exit2&&a.locations.allocate(a.locations.EastCave3);for(const a of[c,d,e])a.bgm=a.originalBgm=23,a.entrances=[],a.exits=[],a.pits=[],a.spawns=[],a.flags=[],a.width=a.height=1,a.screens=[[128]],a.tilePalettes=[26,27,5],a.originalTilePalettes=[26,27,5],a.tileset=136,a.tileEffects=181,a.tilePatterns=[20,2],a.spritePatterns=[...f.spritePatterns],a.spritePalettes=[...f.spritePalettes];c.meta=new Metalocation$$module$js$rom$metalocation(c.id,a.metatilesets.cave,
5,5);c.meta.set2d(0,[[r,W,p,aa,v],[p,T,aa,oa,p],[aa,l,n,p,p],[T,Aa,H,ia,W],[za,H,v,w,oa],[S,p,p,p,p]]);d.meta=new Metalocation$$module$js$rom$metalocation(d.id,a.metatilesets.cave,5,5);d.meta.set2d(0,[[r,W,z,p,z],[p,T,T,p,T],[p,k,m,q,oa],[p,Aa,p,H,W],[r,oa,p,p,y]]);g.meta.set2d(51,[[h]]);a.tileEffects[0].effects[192]=0;c.meta.attach(67,d.meta,68);c.meta.attach(64,g.meta,51);b.exit1&&(c.meta.set2d(4,[[t]]),connectEastCaveExit$$module$js$pass$standardmapedits(c,4,b.exit1));b.exit2&&(a.locations.allocate(e),
e.meta=new Metalocation$$module$js$rom$metalocation(e.id,a.metatilesets.cave,3,1),e.meta.set2d(0,[[E],[V],[za],[S]]),e.spawns.push(Spawn$$module$js$rom$locationtables.from([24,7,35,0])),e.flags.push(Flag$$module$js$rom$locationtables.of({screen:16,flag:a.flags.alloc(512)})),d.meta.set2d(64,[[x]]),d.meta.attach(64,e.meta,0),connectEastCaveExit$$module$js$pass$standardmapedits(e,32,b.exit2));c.spawns.push(Spawn$$module$js$rom$locationtables.of({screen:33,tile:135,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:18,
tile:136,timed:!1,id:2}),Spawn$$module$js$rom$locationtables.of({screen:19,tile:137,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:50,tile:104,timed:!1,id:2}),Spawn$$module$js$rom$locationtables.of({screen:65,tile:136,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:51,tile:152,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:3,tile:136,timed:!0,id:2}));d.spawns.push(Spawn$$module$js$rom$locationtables.of({screen:1,tile:136,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:17,
tile:72,timed:!1,id:2}),Spawn$$module$js$rom$locationtables.of({screen:18,tile:119,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:20,tile:40,timed:!1,id:2}),Spawn$$module$js$rom$locationtables.of({screen:35,tile:133,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:49,tile:136,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:51,tile:138,timed:!1,id:2}),Spawn$$module$js$rom$locationtables.of({screen:52,tile:152,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:65,
tile:130,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({y:272,x:1144,type:2,id:49}),Spawn$$module$js$rom$locationtables.of({y:112,x:264,type:2,id:112}));a.npcs.WindmillGuard.data[1]=89}
function connectEastCaveExit$$module$js$pass$standardmapedits(a,b,c){const {metascreens:{bendNE:d,bendSE:e,boundaryN_trees:f,boundaryW_cave:g,cornerNE:h,cornerNW:k,cornerSE:m,cornerSE_cave:l,cornerSW:n,overworldEmpty:q}}=a.rom;let p,r;switch(c){case "lime":p=a.rom.locations.LimeTreeValley;r=16;p.resizeScreens(0,1,0,0);p.meta.spliceColumns(0,1,2,[[q,q],[k,f],[g,e],[n,m],[q,q]]);break;case "cordel":c=[[g,e],[n,m]];p=a.rom.locations.CordelPlainEast;r=85;p.meta.set2d(85,c);a.rom.locations.CordelPlainWest.meta.set2d(85,
c);break;case "goa":p=a.rom.locations.GoaValley;r=17;p.meta.set2d(1,[[k,h],[g,d]]);break;case "desert":p=a.rom.locations.Desert2,r=83,p.meta.set2d(83,[[l]])}a.meta.attach(b,p.meta,r)}function connectLimeTreeToLeaf$$module$js$pass$standardmapedits(a){const {locations:{ValleyOfWind:b,LimeTreeValley:c},metascreens:{exitE:d,exitW_southwest:e,overworldEmpty_alt:f}}=a;b.meta.set2d(84,[[d]]);c.meta.set2d(16,[[e],[f]]);b.meta.attach(84,c.meta,16)}
...
a&&this.rom.metascreens.renumber(this.id,a)}get screen(){const {id:a,rom:{screens:b}}=this;return 0>a?b.unallocated[~a]:b[a]}unsafeSetId(a){this.data.id=a;for(const a of this._tilesets)a.invalidate()}unsafeAddTileset(a){this._tilesets.add(a)}unsafeRemoveTileset(a){this._tilesets.delete(a)}edgeExits(){var a;let b=0;for(const c of null!==(a=this.data.exits)&&void 0!==a?a:[])a=edgeTypeMap$$module$js$rom$metascreen[c.type],null!=a&&(b|=1<<a);return b}findExitType(a,b,c){var d;for(const e of null!==(d=
this.data.exits)&&void 0!==d?d:[])if(e.type.startsWith("seamless")===c&&e.exits.includes(b&&"edge:bottom"===e.type&&192<=a?a+32:a))return e}findEntranceType(a,b){var c;for(const d of null!==(c=this.data.exits)&&void 0!==c?c:[])if(!d.type.startsWith("seamless")&&d.entrance===(b&&"edge:bottom"===d.type&&48896<=a?a+8192:a))return d.type}addCustomFlag(a){this.flag=a?"custom:true":"custom:false"}_checkNeighbor(a,b){return!1}}
...
function fixTilesets$$module$js$rom$screenfix(a){const {desert:b,grass:c,mountain:d,mountainRiver:e,river:f,sea:g}=a.metatilesets;var h=a.metascreens;h.registerFix(ScreenFix$$module$js$rom$screenfix.DesertRocks);b.getTile(95).copyFrom(91).replaceIn(h.oasisCave,h.oasisLake);b.getTile(90).copyFrom(152).setTiles([,,26,24]);b.getTile(91).copyFrom(128).setTiles([52,50,,]);b.getTile(92).copyFrom(128).setTiles([,,55,53]);b.getTile(93).copyFrom(128).setTiles([,55,,52]);b.getTile(94).copyFrom(128).setTiles([53,
,50]);h.registerFix(ScreenFix$$module$js$rom$screenfix.DesertTrees);b.getTile(99).copyFrom(113);b.getTile(104).copyFrom(112);b.getTile(105).copyFrom(96);b.getTile(106).copyFrom(101);b.getTile(108).copyFrom(112);b.getTile(110).copyFrom(118);b.getTile(111).copyFrom(120);h.registerFix(ScreenFix$$module$js$rom$screenfix.GrassLongGrass);c.getTile(64).copyFrom(81);c.getTile(65).copyFrom(82);c.getTile(66).copyFrom(83);c.getTile(67).copyFrom(84);c.getTile(68).copyFrom(85);c.getTile(69).copyFrom(86);c.getTile(70).copyFrom(88);
c.getTile(71).copyFrom(89);h.registerFix(ScreenFix$$module$js$rom$screenfix.SeaCaveEntrance);g.getTile(173).copyFrom(10).replaceIn(h.beachExitN,h.lighthouseEntrance,h.oceanShrine);g.getTile(10).copyFrom(162);h.boundaryN_cave.screen.set2d(57,[[0,0],[10,10]]);h.cornerSE_cave.screen.set2d(74,[[0,0],[10,10]]);h.registerFix(ScreenFix$$module$js$rom$screenfix.CloseCaves);f.getTile(7).copyFrom(1).replaceIn(...f);f.getTile(14).copyFrom(2).replaceIn(...f);f.getTile(32).copyFrom(3).replaceIn(...f);f.getTile(33).copyFrom(4).replaceIn(...f);
for(const a of[b,g,d,e])a.getTile(104).copyFrom(1).replaceIn(...a),a.getTile(131).copyFrom(2).replaceIn(...a),a.getTile(136).copyFrom(3).replaceIn(...a),a.getTile(137).copyFrom(4).replaceIn(...a);for(const a of[f,b,g])a.getTile(1).copyFrom(193).setAlternative(0),a.getTile(2).copyFrom(193).setAlternative(0),a.getTile(3).copyFrom(215).setAlternative(10),a.getTile(4).copyFrom(215).setAlternative(10);h=[[h.boundaryE_cave,72],[h.boundaryW_cave,121],[h.exitW_cave,56],[h.caveAbovePortoa,86]];for(const [a,
b]of h)a.screen.set2d(b,[[1,2],[3,4]]),a.addCustomFlag(!0);{const {locations:{CordelPlainEast:b,CordelPlainWest:c,WaterfallValleyNorth:d},flags:{OpenedSealedCave:e}}=a;b.meta.customFlags.set(48,e);c.meta.customFlags.set(48,e);d.meta.customFlags.set(48,e);a=Spawn$$module$js$rom$locationtables.of({y:96,x:96,type:4,id:44});h=Spawn$$module$js$rom$locationtables.of({y:112,x:112,type:2,id:173});d.spawns.splice(1,0,a);d.spawns.push(h)}}var module$js$rom$screenfix={};module$js$rom$screenfix.ScreenFix=ScreenFix$$module$js$rom$screenfix;
module$js$rom$screenfix.withRequire=withRequire$$module$js$rom$screenfix;module$js$rom$screenfix.fixTilesets=fixTilesets$$module$js$rom$screenfix;function labyrinthVariant$$module$js$rom$metascreens(a,b,c,d,e){return(f,g,h)=>{if((g>>>b&1)!==c)return!1;g=a(h.metascreens);for(const a of"number"===typeof d?[d]:d)h.screens[f.data.id].set2d(a,[[25,25],[27,27]]);for(const a of"number"===typeof e?[e]:e||[])h.screens[f.data.id].set2d(a,[[197,197],[208,197]]);"always"!==f.flag?g.flag="always":null!=e&&g.remove();return!0}}
...
this.townExitW=this.metascreen({id:28,icon:icon$$module$js$rom$metascreendata`\u2574
      |\u2588\u258c |
      |\u2580 ^|
      |\u2588\u258c |`,tilesets:{grass:{},river:{}},edges:">n>o",exits:[leftEdge$$module$js$rom$metascreendata({top:8})]});this.shortGrassS=this.metascreen({id:29,icon:icon$$module$js$rom$metascreendata` |
      |;;;|
      | v |
      ...
      |\u2588\u2229\u2588|
      |\u2584\u2584\u2588|
      |\u2588\u2588\u2588|`,tilesets:{grass:{}},edges:" n  ",exits:[cave$$module$js$rom$metascreendata(74),leftEdge$$module$js$rom$metascreendata({top:5})],flag:"custom:true"});this.riverNS=this.metascreen({id:46,icon:icon$$module$js$rom$metascreendata`
      | \u2551 |
      | \u2551 |
...
shift:.5}),door$$module$js$rom$metascreendata(151)]});this.temple=this.metascreen({id:112,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata()]});this.wideDeadEndN=this.metascreen({id:113,icon:icon$$module$js$rom$metascreendata`
      ...
      | \u2506 |
      | \u2503 |
      | \u2503 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"c w",connect:"2a",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4})]});this.goaWideHallNS_wallTop=this.metascreen({id:233,icon:icon$$module$js$rom$metascreendata`
      | \u2506 |
      |\u2577\u2503\u2577|
      |\u2502\u2503\u2502|`,tilesets:{labyrinth:{}},edges:"c w ",connect:"2a|9|b",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4})]});this.wideHallWE=this.metascreen({id:234,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2501\u2501\u2501|
...
0,b=n.tiles.length;a<b;a++)n.tiles[a]=d[n.tiles[a]];for(var q of a){d=this.tilesets[q];for(var p of b)for(m=0;m<p.length-1;m++){l=f(p[m]);n=f(p[m+1]);for(a=0;4>a;a++)d.tiles[a][l]=d.tiles[a][n];d.attrs[l]=d.attrs[n];if(32>n&&d.alternates[n]!==n){if(32<=l)throw Error(`Cannot unflag: ${q} ${l} ${n} ${d.alternates[n]}`);d.alternates[l]=d.alternates[n]}}for(var r of e){const [a,b]=r;d.alternates[a]=b}}for(const a of c){q=this.tileEffects[a-179];for(const a of b)for(p=0;p<a.length-1;p++)r=f(a[p]),d=f(a[p+
1]),q.effects[r]=q.effects[d];for(const a of e.keys())q.effects[a]|=8}}moveFlag(a,b){function c(c){for(let d=0;d<c.length;d++)c[d]===a&&(c[d]=b),c[d]===~a&&(c[d]=~b)}for(const a of this.triggers)c(a.conditions),c(a.flags);for(const d of this.npcs){for(const a of d.spawnConditions.values())c(a);for(const c of[d.globalDialogs,...d.localDialogs.values()])for(const d of c)d.condition===a&&(d.condition=b),d.condition===~a&&(d.condition=~b)}if(512===(a&-256)&&512===(b&-256))for(const c of this.locations)for(const d of c.flags)d.flag===
...
c.storyMode()&&storyMode$$module$js$patch(l);c.blackoutMode()&&blackoutMode$$module$js$patch(l);misc$$module$js$patch(l,c,h);fixDialog$$module$js$pass$fixdialog(l);c.buffDyna()&&buffDyna$$module$js$patch(l,c);c.trainer()&&(l.wildWarp.locations=[10,26,53,72,109,110,140,170,172,176,182,159,166,88,92,0]);c.randomizeMusic("early")&&shuffleMusic$$module$js$patch(l,c,h);c.shuffleTilePalettes("early")&&shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);updateTablesPreCommit$$module$js$patch(l,c);h.shuffle(l.randomNumbers.values);
l.messages.compress();n=a.slice(16);l.modules.push(yield g("early"));l.writeData(n);l.modules.pop();l.modules.push(yield g("late"));n=stampVersionSeedAndHash$$module$js$patch(a,b,k,n);c.randomizeMusic("late")&&shuffleMusic$$module$js$patch(l,c,h);c.noMusic("late")&&noMusic$$module$js$patch(l);c.shuffleTilePalettes("late")&&shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);l.writeData();EXPAND_PRG$$module$js$patch&&(h=a.subarray(16),h.subarray(507904,524288).set(h.subarray(245760,262144)));return[a,
n]})}function misc$$module$js$patch(a,b,c){Object.getPrototypeOf(a.locations[0]).show=function(a){console.log(Maze$$module$js$maze$maze2.from(this,c,a).show())};a.messages.parts[2][2].text="\n{01:Akahana} is handed a statue.#\nThanks for finding that.\nI was totally gonna sell\nit for tons of cash.#\nHere, have this lame\n[29:Gas Mask] or something.";a.messages.parts[0][14].text="It's dangerous to go alone! Take this.";a.messages.parts[0][14].fixText()}
