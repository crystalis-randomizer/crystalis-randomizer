...
return b}set(a,b){if(this._fwd[a])throw Error(`already has key ${a}`);if(this._rev[b])throw Error(`already has value ${b}`);this._fwd[a]=b;this._rev[b]=a}replace(a,b){var c=this._rev[b];null!=c&&delete this._fwd[c];c=this._fwd[a];null!=c&&delete this._rev[c];this._fwd[a]=b;this._rev[b]=a;return c}}
class Table$$module$js$util{constructor(a){this._map=new Map;if(a)for(const [b,c,d]of a)this.set(b,c,d)}*[Symbol.iterator](){for(const [a,b]of this._map)for(const [c,d]of b)yield[a,c,d]}set(a,b,c){let d=this._map.get(a);d||this._map.set(a,d=new Map);d.set(b,c)}get(a,b){var c;return null===(c=this._map.get(a))||void 0===c?void 0:c.get(b)}has(a,b){var c;return(null===(c=this._map.get(a))||void 0===c?void 0:c.has(b))||!1}delete(a,b){const c=this._map.get(a);c&&(c.delete(b),c.size||this._map.delete(a))}row(a){var b;
return null!==(b=this._map.get(a))&&void 0!==b?b:new Map}}class CancelTokenReg$$module$js$util{constructor(a,b){this.callback=a;this.source=b}unregister(){this.source.unregister(this)}}
...
(function(a){function b(a,b){function c(a){return a.args?Object.assign({},a,{args:a.args.map((b)=>d(b,a))}):a}function d(a,d){const e=a.source;a=b(a,c,d);e&&!a.source&&(a.source=e);return a}return d(a)}function c(a,b){const [c,e]=d(a,void 0===b?0:b);if(e<a.length)throw Error(`Garbage after expression: ${module$js$asm$token.Token.nameAt(a[e])}`);if(!c)throw Error("No expression?");return c}function d(a,b){function d(){const [a,[,,b]]=e.pop(),c=f.splice(f.length-b,b);if(c.length!==b)throw Error("shunting parse failed?");
f.push(fixSize$$module$js$asm$expr({op:a,args:c}))}b=void 0===b?0:b;const e=[],f=[];for(var g=!0,h=b;h<a.length;h++){var k=a[h];if(g)if("cs"===k.token||"op"===k.token){var l=NAME_MAP$$module$js$asm$expr.get(k.str);if(l=PREFIXOPS$$module$js$asm$expr.get(null!==l&&void 0!==l?l:k.str))e.push([k.str,l]);else if("cs"===k.token){g=k.str;if(!FUNCTIONS$$module$js$asm$expr.has(g))throw Error(`No such function: ${module$js$asm$token.Token.nameAt(k)}`);l=a[h+1];if("lp"!==(null===l||void 0===l?void 0:l.token))throw Error(`Bad funcall: ${module$js$asm$token.Token.nameAt(null!==
l&&void 0!==l?l:k)}`);k=module$js$asm$token.Token.findBalanced(a,h+1);if(0>k)throw Error(`Never closed: ${module$js$asm$token.Token.nameAt(l)}`);l=[];for(const b of module$js$asm$token.Token.parseArgList(a,h+2,k))l.push(c(b));h=k;f.push(fixSize$$module$js$asm$expr({op:g,args:l}));g=!1}else if(module$js$asm$token.Token.eq(k,module$js$asm$token.Token.STAR))f.push({op:"sym",sym:"*"}),g=!1;else throw Error(`Unknown prefix operator: ${module$js$asm$token.Token.nameAt(k)}`);}else if("lp"===k.token){g=module$js$asm$token.Token.findBalanced(a,
h);if(0>g)throw Error(`No close paren: ${module$js$asm$token.Token.nameAt(k)}`);h=c(a.slice(h+1,g));f.push(h);h=g;g=!1}else if("ident"===k.token)f.push({op:"sym",sym:k.str}),g=!1;else if("num"===k.token)k=k.num,f.push({op:"num",num:k,meta:size$$module$js$asm$expr(k)}),g=!1;else throw Error(`Bad expression token: ${module$js$asm$token.Token.nameAt(k)}`);else{if(module$js$asm$token.Token.eq(k,module$js$asm$token.Token.COMMA))break;if("cs"===k.token||"op"===k.token){g=NAME_MAP$$module$js$asm$expr.get(k.str);
g=BINOPS$$module$js$asm$expr.get(null!==g&&void 0!==g?g:k.str);if(!g)break;for(;e.length;){l=e[e.length-1];const a=compareOp$$module$js$asm$expr(l[1],g);if(0>a)break;if(0===a)throw Error(`Mixing ${l[0]} and ${k.str} needs explicit parens.${module$js$asm$token.Token.at(k)}`);d()}e.push([k.str,g]);g=!0}else break}}for(;e.length;)d();if(1!==f.length)throw Error("shunting parse failed?");a[b].source&&(f[0].source=a[b].source);return[f[0],h]}function e(a){if(null!=a)return{op:"num",num:a,meta:size$$module$js$asm$expr(a)}}
function f(a,b){const c=a.args[0];if(!m(c))return a;a=b(c.num);return{op:"num",num:a,meta:size$$module$js$asm$expr(a)}}function g(a,b){const [c,d]=a.args;if(!m(c)||!m(d))return a;a=b(c.num,d.num);return{op:"num",num:a,meta:size$$module$js$asm$expr(a)}}function h(a){var b,c,d,e,f,g;const [h,k]=a.args;if("num"!==h.op||"num"!==k.op)return a;const l={op:"num",num:h.num+k.num};if(h.meta||k.meta){if((null===(b=h.meta)||void 0===b?0:b.rel)&&(null===(c=k.meta)||void 0===c?0:c.rel))return a;if(null===(d=h.meta)||
void 0===d?0:d.rel)l.meta=h.meta;else if(null===(e=k.meta)||void 0===e?0:e.rel)l.meta=k.meta}null!==(f=l.meta)&&void 0!==f&&f.rel||null!=(null===(g=l.meta)||void 0===g?void 0:g.size)||((l.meta||(l.meta={})).size=size$$module$js$asm$expr(l.num).size);return l}function k(a){var b,c,d,e,f;const [g,h]=a.args;if("num"!==g.op||"num"!==h.op)return a;const k={op:"num",num:g.num-h.num};if(null===(b=h.meta)||void 0===b?0:b.rel)return(null===(c=g.meta)||void 0===c?0:c.rel)&&g.meta.chunk===h.meta.chunk?k:a;if(null===
(d=g.meta)||void 0===d?0:d.rel)k.meta=g.meta;null!==(e=k.meta)&&void 0!==e&&e.rel||null!=(null===(f=k.meta)||void 0===f?void 0:f.size)||((k.meta||(k.meta={})).size=size$$module$js$asm$expr(k.num).size);return k}function m(a){var b;return"num"===a.op&&!(null===(b=a.meta)||void 0===b?0:b.rel)}a.traverse=b;a.traversePost=function(a,c){return b(a,(a,b)=>c(b(a)))};a.evaluate=function(a){var b,c,d,l;switch(a.op){case ".move":case "im":case "sym":return a;case "num":return(null===(b=a.meta)||void 0===b?
0:b.rel)&&null!=a.meta.org?(b=Object.assign({},a.meta),b=(delete b.rel,b),{op:"num",num:a.num+b.org,meta:b}):a;case ".max":throw Error();case ".min":throw Error();}if(1===(null===(c=a.args)||void 0===c?void 0:c.length))switch(a.op){case "+":return a.args[0];case "-":return f(a,(a)=>-a);case "~":return f(a,(a)=>~a);case "!":return f(a,(a)=>+!a);case "<":return f(a,(a)=>a&255);case ">":return f(a,(a)=>a>>8&255);case "^":return null!==(l=e(null===(d=a.args[0].meta)||void 0===d?void 0:d.bank))&&void 0!==
l?l:a;default:throw Error(`Unknown unary operator: ${a.op}`);}switch(a.op){case "+":return h(a);case "-":return k(a);case "*":return g(a,(a,b)=>a*b);case "/":return g(a,(a,b)=>Math.floor(a/b));case ".mod":return g(a,(a,b)=>a%b);case "&":return g(a,(a,b)=>a&b);case "|":return g(a,(a,b)=>a|b);case "^":return g(a,(a,b)=>a^b);case "<<":return g(a,(a,b)=>a<<b);case ">>":return g(a,(a,b)=>a>>>b);case "<":return g(a,(a,b)=>+(a<b));case "<=":return g(a,(a,b)=>+(a<=b));case ">":return g(a,(a,b)=>+(a>b));case ">=":return g(a,
(a,b)=>+(a>=b));case "=":return g(a,(a,b)=>+(a==b));case "<>":return g(a,(a,b)=>+(a!=b));case "&&":return g(a,(a,b)=>a&&b);case "||":return g(a,(a,b)=>a||b);case ".xor":return g(a,(a,b)=>!a&&b||!b&&a||0);default:throw Error(`Unknown operator: ${a.op}`);}};a.identifier=function(a){if("sym"===a.op&&a.sym)return a.sym;throw Error(`Expected identifier but got op: ${a.op}`);};a.parseOnly=c;a.parse=d})(Expr$$module$js$asm$expr||(Expr$$module$js$asm$expr={}));
function compareOp$$module$js$asm$expr(a,b){return a[0]>b[0]?1:a[0]<b[0]?-1:a[1]!==b[1]?0:a[1]}
...
module$js$asm$tokenizer.Tokenizer=Tokenizer$$module$js$asm$tokenizer;class Symbol$$module$js$asm$assembler{}class BaseScope$$module$js$asm$assembler{constructor(){this.symbols=new Map}pickScope(a){return[a,this]}resolve(a,b){const [c,d]=this.pickScope(a);let e=d.symbols.get(c);if(e)return c!==a&&(e.scoped=!0),e;if(b)return b={},d.symbols.set(c,b),c!==a&&(b.scoped=!0),b}}
...
f]=a;if(!f.expr&&null!=f.id&&b.parent){if(f.scoped)throw Error(`Symbol '${d}' undefined`);if(c=b.parent.symbols.get(d))if(null!=c.id)f.expr={op:"sym",num:c.id};else if(c.expr)f.expr=c.expr;else throw Error(`Impossible: ${d}`);else b.parent.symbols.set(d,f)}}}this.cheapLocals.clear();if(this.currentScope.parent)throw Error("Scope never closed");a(this.currentScope);for(const a of this.globals){const [b,d]=a;{const a=this.currentScope.symbols.get(b);if("export"===d){if(null===a||void 0===a||!a.expr)throw Error(`Symbol '${b}' undefined`);
null==a.id&&(a.id=this.symbols.length,this.symbols.push(a));a.export=b}else if("import"===d){if(a){if(a.expr)throw Error(`Already defined: ${b}`);a.expr={op:"im",sym:b}}}else assertNever$$module$js$util(d)}}for(const a of this.currentScope.symbols){const [b,d]=a;if(!d.expr)throw Error(`Symbol '${b}' undefined`);}}module(){this.closeScopes();const a=[];for(var b of this.chunks)a.push(Object.assign({},b,{data:Uint8Array.from(b.data)}));b=[];for(var c of this.symbols){if(null==c.expr)throw Error("Symbol undefined");
const a={expr:c.expr};null!=c.export&&(a.export=c.export);b.push(a)}c=[...this.segmentData.values()];return{chunks:a,symbols:b,segments:c}}line(a){this._source=a[0].source;3>a.length&&module$js$asm$token.Token.eq(a[a.length-1],module$js$asm$token.Token.COLON)?this.label(a[0]):module$js$asm$token.Token.eq(a[1],module$js$asm$token.Token.ASSIGN)?this.assign(module$js$asm$token.Token.str(a[0]),this.parseExpr(a,2)):module$js$asm$token.Token.eq(a[1],module$js$asm$token.Token.SET)?this.set(module$js$asm$token.Token.str(a[0]),
this.parseExpr(a,2)):"cs"===a[0].token?this.directive(a):this.instruction(a)}tokens(a){let b;for(;b=a.next();)this.line(b)}tokensAsync(a){const b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c;for(;c=yield a.nextAsync();)b.line(c)})}directive(a){switch(module$js$asm$token.Token.str(a[0])){case ".org":return this.org(this.parseConst(a));case ".reloc":return this.parseNoArgs(a),this.reloc();case ".assert":return this.assert(this.parseExpr(a));case ".segment":return this.segment(...this.parseSegmentList(a));
case ".byte":return this.byte(...this.parseDataList(a,!0));case ".res":return this.res(...this.parseResArgs(a));case ".word":return this.word(...this.parseDataList(a));case ".free":return this.free(this.parseConst(a),a[0]);case ".segmentprefix":return this.segmentPrefix(this.parseStr(a));case ".import":return this.import(...this.parseIdentifierList(a));case ".export":return this.export(...this.parseIdentifierList(a));case ".scope":return this.scope(this.parseOptionalIdentifier(a));case ".endscope":return this.parseNoArgs(a),
this.endScope();case ".proc":return this.proc(this.parseRequiredIdentifier(a));case ".endproc":return this.parseNoArgs(a),this.endProc();case ".pushseg":return this.pushSeg(...this.parseSegmentList(a));case ".popseg":return this.parseNoArgs(a),this.popSeg();case ".move":return this.move(...this.parseMoveArgs(a))}this.fail(`Unknown directive: ${module$js$asm$token.Token.nameAt(a[0])}`)}label(a){let b;const c=this.pc();if("string"===typeof a)var d=a;else d=module$js$asm$token.Token.str(b=a),a.source&&
(c.source=a.source);":"===d?(this.anonymousReverse.push(c),d=this.anonymousForward.shift(),null!=d&&(this.symbols[d].expr=c)):/^\++$/.test(d)?(a=this.relativeForward[d.length-1],delete this.relativeForward[d.length-1],null!=a&&(this.symbols[a].expr=c)):/^-+$/.test(d)?this.relativeReverse[d.length-1]=c:(d.startsWith("@")||(this.cheapLocals.clear(),this.chunk.name||this.chunk.data.length||(this.chunk.name=d)),this.assignSymbol(d,!1,c,b))}assign(a,b){a.startsWith("@")&&this.fail(`Cheap locals may only be labels: ${a}`);
...
a[1])}parseNoArgs(a,b){module$js$asm$token.Token.expectEol(a[1])}parseExpr(a,b){return module$js$asm$expr.Expr.parseOnly(a,void 0===b?1:b)}parseStr(a,b){b=void 0===b?1:b;const c=module$js$asm$token.Token.expectString(a[b]);module$js$asm$token.Token.expectEol(a[b+1],"a single string");return c}parseSegmentList(a,b){b=void 0===b?1:b;a.length<b+1&&this.fail("Expected a segment list",a[b-1]);return module$js$asm$token.Token.parseArgList(a,1).map((a)=>{var b=this._segmentPrefix+module$js$asm$token.Token.expectString(a[0]);
if(1===a.length)return b;module$js$asm$token.Token.eq(a[1],module$js$asm$token.Token.COLON)||this.fail(`Expected comma or colon: ${module$js$asm$token.Token.name(a[1])}`,a[1]);b={name:b};a=module$js$asm$token.Token.parseAttrList(a,1);for(const c of a){const [a,d]=c;switch(a){case "bank":b.bank=this.parseConst(d,0);break;case "size":b.size=this.parseConst(d,0);break;case "off":b.offset=this.parseConst(d,0);break;case "mem":b.memory=this.parseConst(d,0);break;default:this.fail(`Unknown segment attr: ${a}`)}}return b})}parseResArgs(a){a=
this.parseDataList(a);2<a.length&&this.fail("Expected at most 2 args",a[2]);a.length||this.fail("Expected at least 1 arg");const b=this.evaluate(a[0]);null==b&&this.fail("Expected constant count");const c=a[1]&&this.evaluate(a[1]);a[1]&&null==c&&this.fail("Expected constant value");return[b,c]}parseDataList(a,b){b=void 0===b?!1:b;2>a.length&&this.fail("Expected a data list",a[0]);const c=[];for(const d of module$js$asm$token.Token.parseArgList(a,1))b&&1===d.length&&"str"===d[0].token?c.push(d[0].str):
c.push(this.resolve(module$js$asm$expr.Expr.parseOnly(d)));return c}parseIdentifierList(a){2>a.length&&this.fail("Expected identifier(s)",a[0]);const b=[];for(const c of module$js$asm$token.Token.parseArgList(a,1))1===c.length&&"ident"===c[0].token||this.fail(`Expected identifier: ${module$js$asm$token.Token.name(c[0])}`,c[0]),b.push(module$js$asm$token.Token.str(c[0]));return b}parseOptionalIdentifier(a){var b=a[1];if(b)return b=module$js$asm$token.Token.expectIdentifier(b),module$js$asm$token.Token.expectEol(a[2]),
b}parseRequiredIdentifier(a){const b=module$js$asm$token.Token.expectIdentifier(a[1]);module$js$asm$token.Token.expectEol(a[2]);return b}parseMoveArgs(a){var b;a=module$js$asm$token.Token.parseArgList(a,1);2!==a.length&&this.fail("Expected constant number, then identifier");const c=this.evaluate(module$js$asm$expr.Expr.parseOnly(a[0]));null==c&&this.fail("Expected a constant number");const d=this.resolve(module$js$asm$expr.Expr.parseOnly(a[1]));if("num"===d.op&&null!=(null===(b=d.meta)||void 0===
b?void 0:b.chunk))return[c,d];this.fail("Expected a constant offset",a[1][0])}fail(a,b){var c;if(null===b||void 0===b?0:b.source)throw Error(a+module$js$asm$token.Token.at(b));if(!this._source&&(null===(c=this._chunk)||void 0===c?0:c.name))throw Error(a+`\n  in ${this._chunk.name}`);throw Error(a+module$js$asm$token.Token.at({source:this._source}));}writeNumber(a,b,c){var d=b<<3;null!=c&&(c<-1<<d||c>=1<<d)&&this.fail(`Not a ${["byte","word","farword","dword"][b-1]}: $${c.toString(16)}`);for(d=0;d<
b;d++)a.push(null!=c?c&255:255),null!=c&&(c>>=8)}}function writeString$$module$js$asm$assembler(a,b){for(let c=0;c<b.length;c++)a.push(b.charCodeAt(c))}var module$js$asm$assembler={};module$js$asm$assembler.Assembler=Assembler$$module$js$asm$assembler;const DEBUG$$module$js$asm$define=!1;
...
function produce$$module$js$asm$define(a,b,c,d,e){const f=[];let g=[],h=f;for(const b of e){if("ident"===b.token){if(e=d.get(b.str)){h.push(...e);continue}}else if(module$js$asm$token.Token.eq(b,module$js$asm$token.Token.DOT_EOL)){g.push(h=[]);continue}e=b.source&&a[0].source?Object.assign({},b.source,{parent:a[0].source}):b.source||a[0].source;h.push(e?Object.assign({},b,{source:e}):b)}g=g.filter((a)=>a.length);if(g.length&&c<a.length)return"cannot expand .eol without consuming to end of line";a.splice(b,
c-b,...f);return g}
...
class TexStyleDefine$$module$js$asm$define{constructor(a,b,c){this.pattern=a;this.production=b;this.definition=c}expand(a,b){let c=b+1;const d=new Map;for(let b=0;b<this.pattern.length;b++){const f=this.pattern[b];if("ident"===f.token){var e=this.pattern[b+1];if(e&&"ident"!==(null===e||void 0===e?void 0:e.token)){const b=module$js$asm$token.Token.eq(e,module$js$asm$token.Token.DOT_EOL)?a.length:module$js$asm$token.Token.find(a,e,c);if(0>b)return`could not find delimiter ${module$js$asm$token.Token.name(e)}`;
d.set(f.str,a.slice(c,b));c=b}else{e=a[c++];if(!e)return`missing undelimited argument ${module$js$asm$token.Token.name(f)}`;d.set(f.str,"grp"===e.token?e.inner:[e])}}else if(module$js$asm$token.Token.eq(f,module$js$asm$token.Token.DOT_EOL)){if(c<a.length)return"could not match .eol"}else if(!module$js$asm$token.Token.eq(a[c++],f))return`could not match: ${module$js$asm$token.Token.name(f)}`}return produce$$module$js$asm$define(a,b,c,d,this.production)}canOverload(){return!!this.pattern.length}}
...
this.simplify(c[e]),"num"===c[e].op&&d?d[e]=c[e].num:d=void 0;return(e=null!==(b=this.functions.get(a.op))&&void 0!==b?b:1===c.length?this.prefix.get(a.op):this.infix.get(a.op))&&d?{op:"num",num:e(...d)}:{op:a.op,args:c}}byteAt(a){throw Error("not implemented");}}var module$js$asm$evaluator={};module$js$asm$evaluator.Evaluator=Evaluator$$module$js$asm$evaluator;class IdGenerator$$module$js$asm$idgenerator{constructor(){this.id=1}next(){return this.id++}}var module$js$asm$idgenerator={};module$js$asm$idgenerator.IdGenerator=IdGenerator$$module$js$asm$idgenerator;class IncludeWrapper$$module$js$asm$io{constructor(a,b,c,d){this.readFile=a;this.source=b;this.stream=c;this.opts=d}nextAsync(){const a=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){for(;;){var b=a.source.next();if("cs"!==(null===b||void 0===b?void 0:b[0].token)||".include"!==b[0].str)return b;b=str$$module$js$asm$io(b);const c=yield a.readFile(b);a.stream.enter(new Tokenizer$$module$js$asm$tokenizer(c,b,a.opts))}})}}
class ConsoleWrapper$$module$js$asm$io{constructor(a){this.source=a}next(){for(;;){const a=this.source.next();if("cs"!==(null===a||void 0===a?void 0:a[0].token))return a;switch(a[0].str){case ".out":console.log(str$$module$js$asm$io(a));break;case ".warning":console.warn(str$$module$js$asm$io(a));break;case ".error":err$$module$js$asm$io(a);break;default:return a}}}}function err$$module$js$asm$io(a){const b=str$$module$js$asm$io(a);throw Error(b+module$js$asm$token.Token.at(a[0]));}
...
c.length)return{value:void 0,done:!0};const d=c[b++];return{value:[Math.max(a,d[0]),d[1]],done:!1}}}}}var module$js$asm$util={};module$js$asm$util.binarySearch=binarySearch$$module$js$asm$util;module$js$asm$util.binaryInsert=binaryInsert$$module$js$asm$util;module$js$asm$util.SparseArray=SparseArray$$module$js$asm$util;module$js$asm$util.SparseByteArray=SparseByteArray$$module$js$asm$util;module$js$asm$util.BitSet=BitSet$$module$js$asm$util;module$js$asm$util.IntervalSet=IntervalSet$$module$js$asm$util;class Linker$$module$js$asm$linker{constructor(){this._link=new Link$$module$js$asm$linker}static link(...a){const b=new Linker$$module$js$asm$linker;for(const c of a)b.read(c);return b.link()}read(a){this._link.readFile(a);return this}base(a,b){this._link.base(a,void 0===b?0:b);return this}link(){return this._link.link()}report(a){console.log(this._link.report(void 0===a?!1:a))}exports(){return this._exports?this._exports:this._exports=this._link.buildExports()}watch(...a){this._link.watches.push(...a)}}
function fail$$module$js$asm$linker(a){throw Error(a);}
class LinkSegment$$module$js$asm$linker{constructor(a){var b,c,d,e,f;const g=this.name=a.name;this.bank=null!==(b=a.bank)&&void 0!==b?b:0;this.addressing=null!==(c=a.addressing)&&void 0!==c?c:2;this.size=null!==(d=a.size)&&void 0!==d?d:fail$$module$js$asm$linker(`Size must be specified: ${g}`);this.offset=null!==(e=a.offset)&&void 0!==e?e:fail$$module$js$asm$linker(`OFfset must be specified: ${g}`);this.memory=null!==(f=a.memory)&&void 0!==f?f:fail$$module$js$asm$linker(`OFfset must be specified: ${g}`)}get delta(){return this.offset-
this.memory}}
class LinkChunk$$module$js$asm$linker{constructor(a,b,c,d,e){this.linker=a;this.index=b;this.subs=new Set;this.selfSubs=new Set;this.deps=new Set;this.imports=new Set;this.follow=new Map;this.overlaps=!1;this.name=c.name;this.size=c.data.length;this.segments=c.segments;this._data=c.data;for(const a of c.subs||[])this.subs.add(translateSub$$module$js$asm$linker(a,d,e));this.asserts=(c.asserts||[]).map((a)=>translateExpr$$module$js$asm$linker(a,d,e));c.org&&(this._org=c.org)}get org(){return this._org}get offset(){return this._offset}get segment(){return this._segment}get data(){var a;return null!==
(a=this._data)&&void 0!==a?a:fail$$module$js$asm$linker("no data")}initialPlacement(){if(null!=this._org){var a=[];for(const b of this.segments){const c=this.linker.segments.get(b);if(!c)throw Error(`Unknown segment: ${b}`);this._org>=c.memory&&this._org<c.memory+c.size&&a.push(c)}if(1!==a.length)throw Error(`Non-unique segment: ${a}`);a=a[0];if(this._org>=a.memory+a.size)throw Error(`Chunk does not fit in segment ${a.name}`);this.place(this._org,a)}}place(a,b){var c;this._org=a;this._segment=b;a=
this._offset=a+b.delta;for(var d of this.linker.watches)if(d>=a&&d<a+this.size)debugger;binaryInsert$$module$js$asm$util(this.linker.placed,(a)=>a[0],[a,this]);d=this.linker.data;b=null!==(c=this._data)&&void 0!==c?c:fail$$module$js$asm$linker("No data");this._data=void 0;if(this.subs.size){d.splice(a,b.length);c=new SparseByteArray$$module$js$asm$util;c.set(0,b);for(const a of this.subs)c.splice(a.offset,a.size);for(const b of c.chunks()){const [c,e]=b;d.set(a+c,...e)}}else d.set(a,b);for(const a of this.follow){const [b,
c]=a;c.resolveSub(b,!1)}this.linker.free.delete(this.offset,this.offset+this.size)}resolveSubs(a){a=void 0===a?!1:a;for(const b of this.selfSubs)this.resolveSub(b,a);for(const b of this.subs)this.resolveSub(b,a)}addDep(a,b){b===this.index&&this.subs.delete(a)&&this.selfSubs.add(a);this.linker.chunks[b].follow.set(a,this);this.deps.add(b)}resolveSub(a,b){var c,d;if(this.subs.has(a)||this.selfSubs.has(a)){a.expr=module$js$asm$expr.Expr.traverse(a.expr,(c,d,e)=>{var f;if(b&&"^"===(null===e||void 0===
e?void 0:e.op)&&1===e.args.length&&c.meta)return null==c.meta.bank&&this.addDep(a,c.meta.chunk),c;c=this.linker.resolveLink(module$js$asm$expr.Expr.evaluate(d(c)));b&&(null===(f=c.meta)||void 0===f?0:f.rel)&&this.addDep(a,c.meta.chunk);return c});var e=!1;if("num"===a.expr.op&&(null===(c=a.expr.meta)||void 0===c||!c.rel))this.writeValue(a.offset,a.expr.num,a.size),e=!0;else if(".move"===a.expr.op){if(1!==a.expr.args.length)throw Error("bad .move");c=a.expr.args[0];"num"===c.op&&null!=(null===(d=c.meta)||
void 0===d?void 0:d.offset)&&(d=c.meta.offset+c.num,d=this.linker.orig.slice(d,d+a.size),this.writeBytes(a.offset,Uint8Array.from(d)),e=!0)}e&&(this.subs.delete(a)||this.selfSubs.delete(a),this.subs.size||this.linker.unresolvedChunks.delete(this)&&this.linker.insertResolved(this))}}writeBytes(a,b){if(this._data)this._data.subarray(a,a+b.length).set(b);else if(null!=this._offset)this.linker.data.set(this._offset+a,b);else throw Error("Impossible");}writeValue(a,b,c){var d=c<<3;if(null!=b&&(b<-1<<d||
b>=1<<d))throw Error(`Not a ${["byte","word","farword","dword"][c-1]}: $${b.toString(16)}`);d=new Uint8Array(c);for(let a=0;a<c;a++)d[a]=b&255,b>>=8;this.writeBytes(a,d)}}function translateSub$$module$js$asm$linker(a,b,c){a=Object.assign({},a);a.expr=translateExpr$$module$js$asm$linker(a.expr,b,c);return a}
...
class Link$$module$js$asm$linker{constructor(){this.data=new SparseByteArray$$module$js$asm$util;this.orig=new SparseByteArray$$module$js$asm$util;this.exports=new Map;this.chunks=[];this.symbols=[];this.free=new IntervalSet$$module$js$asm$util;this.rawSegments=new Map;this.segments=new Map;this.resolvedChunks=[];this.unresolvedChunks=new Set;this.watches=[];this.placed=[];this.initialReport=""}insertResolved(a){binaryInsert$$module$js$asm$util(this.resolvedChunks,(a)=>a.size,a)}base(a,b){b=void 0===
b?0:b;this.data.set(b,a);this.orig.set(b,a)}readFile(a){const b=this.chunks.length,c=this.symbols.length;for(var d of a.segments||[])this.addRawSegment(d);for(const e of a.chunks||[])d=new LinkChunk$$module$js$asm$linker(this,this.chunks.length,e,b,c),this.chunks.push(d);for(const d of a.symbols||[])this.symbols.push(translateSymbol$$module$js$asm$linker(d,b,c))}resolveLink(a){var b,c,d;if(".orig"===a.op&&1===(null===(b=a.args)||void 0===b?void 0:b.length)){var e=a.args[0];var f=null===(c=e.meta)||
void 0===c?void 0:c.offset;if(null!=f&&(e=this.orig.get(f+e.num),null!=e))return{op:"num",num:e}}else"num"===a.op&&null!=(null===(d=a.meta)||void 0===d?void 0:d.chunk)&&(c=a.meta,b=this.chunks[c.chunk],b.org!==c.org||(null===(f=b.segment)||void 0===f?void 0:f.bank)!==c.bank||b.offset!==c.offset)&&(f={org:b.org,offset:b.offset,bank:null===(e=b.segment)||void 0===e?void 0:e.bank},a=module$js$asm$expr.Expr.evaluate(Object.assign({},a,{meta:Object.assign({},c,f)})));return a}resolveExpr(a){var b;a=module$js$asm$expr.Expr.traverse(a,
(a,b)=>this.resolveLink(module$js$asm$expr.Expr.evaluate(b(a))));if("num"===a.op&&(null===(b=a.meta)||void 0===b||!b.rel))return a.num;a=module$js$asm$token.Token.at(a);throw Error(`Unable to fully resolve expr${a}`);}link(){for(var a of this.rawSegments){const [c,d]=a;var b=d[0];for(let a=1;a<d.length;a++)b=module$js$asm$module.Segment.merge(b,d[a]);this.segments.set(c,new LinkSegment$$module$js$asm$linker(b))}for(var c of this.rawSegments){const [e,f]=c;a=this.segments.get(e);for(var d of f){b=
d.free;for(const c of b||[]){const [b,d]=c;this.free.add(b+a.delta,d+a.delta);this.data.splice(b+a.delta,d-b)}}}for(const a of this.chunks)a.initialPlacement();DEBUG$$module$js$asm$linker&&(this.initialReport=`Initial:\n${this.report(!0)}`);for(c=0;c<this.symbols.length;c++){d=this.symbols[c];if(!d.expr)throw Error(`Symbol ${c} never resolved`);null!=d.export&&this.exports.set(d.export,c)}for(var e of this.symbols)e.expr=this.resolveSymbols(e.expr);for(var f of this.chunks){for(const a of[...f.subs,
...f.selfSubs])a.expr=this.resolveSymbols(a.expr);for(e=0;e<f.asserts.length;e++)f.asserts[e]=this.resolveSymbols(f.asserts[e])}for(const a of this.chunks)a.resolveSubs(!0);f=[...this.chunks];f.sort((a,b)=>b.size-a.size);for(var g of f)g.resolveSubs(),g.subs.size?this.unresolvedChunks.add(g):this.insertResolved(g);for(g=this.resolvedChunks.length+2*this.unresolvedChunks.size;g;){if(f=this.resolvedChunks.pop())this.placeChunk(f);else{[f]=this.unresolvedChunks;for(var h of f.deps)f=this.chunks[h],null==
f.org&&this.placeChunk(f)}f=this.resolvedChunks.length+2*this.unresolvedChunks.size;if(f===g)throw console.error(this.resolvedChunks,this.unresolvedChunks),Error("Not making progress");g=f}h=new SparseByteArray$$module$js$asm$util;for(var k of this.chunks){for(const a of k.asserts)if(!this.resolveExpr(a))throw k=module$js$asm$token.Token.at(a),Error(`Assertion failed${k}`);k.overlaps||h.set(k.offset,...this.data.slice(k.offset,k.offset+k.size))}DEBUG$$module$js$asm$linker&&console.log(this.report(!0));
return h}placeChunk(a){if(null==a.org){var b=a.size;if(!a.subs.size&&!a.selfSubs.size){var c=this.data.pattern(a.data);for(var d of a.segments){var e=this.segments.get(d),f=e.offset;f=c.search(f,f+e.size);if(!(0>f)){a.place(f-e.delta,e);a.overlaps=!0;return}}}for(var g of a.segments){c=this.segments.get(g);f=c.offset;d=f+c.size;let h;e=Infinity;for(const a of this.free.tail(f)){const [c,g]=a;if(c>=d)break;f=Math.min(g,d)-c;!(f<b)&&f<e&&(h=c,e=f)}if(null!=h){a.place(h-c.delta,c);return}}DEBUG$$module$js$asm$linker&&
console.log(`Initial:\n${this.initialReport}`);console.log(`After filling:\n${this.report(!0)}`);g=a.name?`${a.name} `:"";console.log(this.segments.get(a.segments[0]));throw Error(`Could not find space for ${b}-byte chunk ${g}in ${a.segments.join(", ")}`);}}resolveSymbols(a){return module$js$asm$expr.Expr.traverse(a,(b,c)=>{for(;"im"===b.op||"sym"===b.op;)if("im"===b.op){b=b.sym;const d=this.exports.get(b);if(null==d)throw c=module$js$asm$token.Token.at(a),Error(`Symbol never exported ${b}${c}`);
b=this.symbols[d].expr}else{if(null==b.num)throw Error("Symbol not global");b=this.symbols[b.num].expr}return module$js$asm$expr.Expr.evaluate(c(b))})}addRawSegment(a){let b=this.rawSegments.get(a.name);b||this.rawSegments.set(a.name,b=[]);b.push(a)}buildExports(){var a,b;const c=new Map;for(const d of this.symbols){if(!d.export)continue;const e=module$js$asm$expr.Expr.traverse(d.expr,(a,b)=>this.resolveLink(module$js$asm$expr.Expr.evaluate(b(a))));if("num"!==e.op)throw Error(`never resolved: ${d.export}`);
const f=e.num,g={value:f};null!=(null===(a=e.meta)||void 0===a?void 0:a.offset)&&null!=e.meta.org&&(g.offset=e.meta.offset+f-e.meta.org);null!=(null===(b=e.meta)||void 0===b?void 0:b.bank)&&(g.bank=e.meta.bank);c.set(d.export,g)}return c}report(a){a=void 0===a?!1:a;var b;let c="";for(var d of this.free){const [a,b]=d;c+=`Free: ${a.toString(16)}..${b.toString(16)}: ${b-a} bytes\n`}if(a)for(const e of this.placed){const [f,g]=e;a=null!==(b=g.name)&&void 0!==b?b:`Chunk ${g.index}`;d=g.offset+g.size;
c+=`${f.toString(16).padStart(5,"0")} .. ${d.toString(16).padStart(5,"0")}: ${a} (${d-f} bytes)\n`}return c}}const DEBUG$$module$js$asm$linker=!0;var module$js$asm$linker={};module$js$asm$linker.Linker=Linker$$module$js$asm$linker;class Macro$$module$js$asm$macro{constructor(a,b){this.params=a;this.production=b}static from(a,b){var c;if(!module$js$asm$token.Token.eq(a[0],module$js$asm$token.Token.MACRO))throw Error("invalid");if("ident"!==(null===(c=a[1])||void 0===c?void 0:c.token))throw Error("invalid");c=module$js$asm$token.Token.identsFromCList(a.slice(2));const d=[];let e;for(;e=b.next();){if(module$js$asm$token.Token.eq(e[0],module$js$asm$token.Token.ENDMACRO)||module$js$asm$token.Token.eq(e[0],module$js$asm$token.Token.ENDMAC))return new Macro$$module$js$asm$macro(c,
d);d.push(e)}throw Error(`EOF looking for .endmacro: ${module$js$asm$token.Token.nameAt(a[1])}`);}expand(a,b){let c=1;const d=new Map,e=[];for(const b of this.params){const e=module$js$asm$token.Token.findComma(a,c);let f=a.slice(c,e);c=e+1;1===f.length&&"grp"===f[0].token&&(f=f[0].inner);d.set(b,f)}if(c<a.length)throw Error(`Too many macro parameters: ${module$js$asm$token.Token.nameAt(a[c])}`);const f=new Map;for(const c of this.production){var g=function(b){const c=[];for(const e of b){if("ident"===
e.token){if(b=d.get(e.str)){c.push(...b);continue}if(b=f.get(e.str)){c.push({token:"ident",str:b});continue}}else if("grp"===e.token){c.push({token:"grp",inner:g(e.inner)});continue}b=e.source&&a[0].source?Object.assign({},e.source,{parent:a[0].source}):e.source||a[0].source;c.push(b?Object.assign({},e,{source:b}):e)}return c};if(module$js$asm$token.Token.eq(c[0],module$js$asm$token.Token.LOCAL))for(const a of module$js$asm$token.Token.identsFromCList(c.slice(1)))f.set(a,`${a}@${b.next()}`);e.push(g(c))}return e}}
var module$js$asm$macro={};module$js$asm$macro.Macro=Macro$$module$js$asm$macro;const MAX_STACK_DEPTH$$module$js$asm$preprocessor=100,ID_MAP$$module$js$asm$preprocessor=new WeakMap;function idGen$$module$js$asm$preprocessor(a){let b=ID_MAP$$module$js$asm$preprocessor.get(a);b||ID_MAP$$module$js$asm$preprocessor.set(a,b=((a)=>({next:()=>a++}))(0));return b}
...
Monsters$$module$js$flagset.TowerRobots,Routing$$module$js$flagset.OrbsNotRequired,Routing$$module$js$flagset.StoryMode,World$$module$js$flagset.RandomizeMaps,World$$module$js$flagset.RandomizeTrades,World$$module$js$flagset.RandomizeWallElements,World$$module$js$flagset.ShuffleGoaFloors,World$$module$js$flagset.UnidentifiedKeyItems]);this.Random=new Preset$$module$js$flagset(this,"Truly Random","\n      Even the options are random.",[[World$$module$js$flagset.RandomizeMaps,"?"],[World$$module$js$flagset.RandomizeTrades,
"?"],[World$$module$js$flagset.UnidentifiedKeyItems,"?"],[World$$module$js$flagset.RandomizeWallElements,"?"],[World$$module$js$flagset.ShuffleGoaFloors,"?"],[World$$module$js$flagset.RandomizeSpriteColors,"?"],[World$$module$js$flagset.RandomizeWildWarp,"?"],[Routing$$module$js$flagset.OrbsNotRequired,"?"],[Routing$$module$js$flagset.NoBowMode,"?"],[Routing$$module$js$flagset.StoryMode,"?"],[Routing$$module$js$flagset.VanillaDolphin,"?"],[Routing$$module$js$flagset.NoThunderSwordWarp,"?"],[Glitches$$module$js$flagset.RageSkip,
"?"],[Glitches$$module$js$flagset.TriggerSkip,"?"],[Glitches$$module$js$flagset.StatueGlitch,"?"],[Glitches$$module$js$flagset.GhettoFlight,"?"],[Glitches$$module$js$flagset.SwordChargeGlitch,"?"],[Glitches$$module$js$flagset.MtSabreRequirementSkip,"?"],[Aesthetics$$module$js$flagset.RandomizeMusic,"?"],[Aesthetics$$module$js$flagset.RandomizeMapColors,"?"],[Monsters$$module$js$flagset.RandomizeWeaknesses,"?"],[Monsters$$module$js$flagset.TowerRobots,"?"],[EasyMode$$module$js$flagset.NoShuffleMimics,
"?"],[EasyMode$$module$js$flagset.PreserveUniqueChecks,"?"],[NoGuarantees$$module$js$flagset.Barrier,"?"],[NoGuarantees$$module$js$flagset.BattleMagic,"?"],[NoGuarantees$$module$js$flagset.GasMask,"?"],[Vanilla$$module$js$flagset.Dyna,"?"],[Vanilla$$module$js$flagset.BonusItems,"?"],[Vanilla$$module$js$flagset.Maps,"?"],DebugMode$$module$js$flagset.SpoilerLog])}static get(a){this.instance||(this.instance=new Presets$$module$js$flagset);return this.instance.presets.get(mapPresetName$$module$js$flagset(a))}}
...
Aesthetics$$module$js$flagset.RandomizeMusic=Aesthetics$$module$js$flagset.flag("Am",{name:"Randomize background music",modes:"!",optional:NO_BANG$$module$js$flagset});Aesthetics$$module$js$flagset.NoMusic=Aesthetics$$module$js$flagset.flag("As",{name:"No background music",optional:OPTIONAL$$module$js$flagset});Aesthetics$$module$js$flagset.RandomizeMapColors=Aesthetics$$module$js$flagset.flag("Ac",{name:"Randomize map colors",modes:"!",optional:NO_BANG$$module$js$flagset});
class Monsters$$module$js$flagset extends FlagSection$$module$js$flagset{constructor(){super(...arguments);this.prefix="M";this.name="Monsters"}}Monsters$$module$js$flagset.RandomizeWeaknesses=Monsters$$module$js$flagset.flag("Me",{name:"Randomize monster weaknesses",text:"Monster and boss elemental weaknesses are shuffled."});
Monsters$$module$js$flagset.TowerRobots=Monsters$$module$js$flagset.flag("Mt",{name:"Shuffle tower robots",text:"Tower robots will be shuffled into the normal pool.  At some\n           point, normal monsters may be shuffled into the tower as well.",hard:!0});class EasyMode$$module$js$flagset extends FlagSection$$module$js$flagset{constructor(){super(...arguments);this.prefix="E";this.name="Easy Mode";this.description="\n      The following options make parts of the game easier."}}
EasyMode$$module$js$flagset.NoShuffleMimics=EasyMode$$module$js$flagset.flag("Et",{name:"Don't shuffle mimics.",text:"Mimics will be in their vanilla locations."});EasyMode$$module$js$flagset.PreserveUniqueChecks=EasyMode$$module$js$flagset.flag("Eu",{name:"Keep unique items and consumables separate",text:"Normally all items and mimics are shuffled into a single pool and\n           distributed from there.  If this flag is set, unique items\n           (specifically, anything that cannot be sold) will only be found in\n           either (a) checks that held unique items in vanilla, or (b) boss\n           drops.  Chests containing consumables in vanilla may be safely\n           ignored, but chests containing unique items in vanilla may still\n           end up with non-unique items because of bosses like Vampire 2 that\n           drop consumables.  If mimics are shuffled, they will only be in\n           consumable locations."});
...
a:Flag$$module$js$flagset.flags.get(a))&&this.flags.get(a)||!1}preserveUniqueChecks(){return this.check(EasyMode$$module$js$flagset.PreserveUniqueChecks)}shuffleMimics(){return this.check(EasyMode$$module$js$flagset.NoShuffleMimics,!1)}buffDeosPendant(){return this.check(Vanilla$$module$js$flagset.BonusItems,!1)}changeGasMaskToHazmatSuit(){return this.check(Vanilla$$module$js$flagset.BonusItems,!1)}slowDownTornado(){return this.check(Vanilla$$module$js$flagset.BonusItems,!1)}leatherBootsGiveSpeed(){return this.check(Vanilla$$module$js$flagset.BonusItems,
!1)}rabbitBootsChargeWhileWalking(){return this.check(Vanilla$$module$js$flagset.BonusItems,!1)}shuffleSpritePalettes(){return this.check(World$$module$js$flagset.RandomizeSpriteColors)}shuffleMonsters(){return!0}shuffleShops(){return this.check(Vanilla$$module$js$flagset.Shops,!1)}bargainHunting(){return this.shuffleShops()}shuffleTowerMonsters(){return this.check(Monsters$$module$js$flagset.TowerRobots)}shuffleMonsterElements(){return this.check(Monsters$$module$js$flagset.RandomizeWeaknesses)}shuffleBossElements(){return this.shuffleMonsterElements()}buffMedicalHerb(){return this.check(HardMode$$module$js$flagset.NoBuffMedicalHerb,
!1)}decreaseEnemyDamage(){return this.check(EasyMode$$module$js$flagset.DecreaseEnemyDamage)}trainer(){return this.check(DebugMode$$module$js$flagset.TrainerMode)}neverDie(){return this.check(DebugMode$$module$js$flagset.NeverDie)}chargeShotsOnly(){return this.check(HardMode$$module$js$flagset.ChargeShotsOnly)}barrierRequiresCalmSea(){return!0}connectLimeTreeToLeaf(){return this.check(Vanilla$$module$js$flagset.Maps,"!")}addEastCave(){return this.check(Vanilla$$module$js$flagset.Maps,!1)}fogLampNotRequired(){return this.check(Routing$$module$js$flagset.VanillaDolphin,
!1)}storyMode(){return this.check(Routing$$module$js$flagset.StoryMode)}noBowMode(){return this.check(Routing$$module$js$flagset.NoBowMode)}requireHealedDolphinToRide(){return this.check(Routing$$module$js$flagset.VanillaDolphin)}saharaRabbitsRequireTelepathy(){return!0}teleportOnThunderSword(){return this.check(Routing$$module$js$flagset.NoThunderSwordWarp,!1,"!")}randomizeThunderTeleport(){return this.check(Routing$$module$js$flagset.NoThunderSwordWarp,!1)}orbsOptional(){return this.check(Routing$$module$js$flagset.OrbsNotRequired)}shuffleGoaFloors(){return this.check(World$$module$js$flagset.ShuffleGoaFloors)}randomizeMaps(){return this.check(World$$module$js$flagset.RandomizeMaps)}randomizeTrades(){return this.check(World$$module$js$flagset.RandomizeTrades)}unidentifiedItems(){return this.check(World$$module$js$flagset.UnidentifiedKeyItems)}randomizeWalls(){return this.check(World$$module$js$flagset.RandomizeWallElements)}guaranteeSword(){return this.check(EasyMode$$module$js$flagset.GuaranteeStartingSword)}guaranteeSwordMagic(){return this.check(NoGuarantees$$module$js$flagset.BattleMagic,
...
!0)||this.check(World$$module$js$flagset.RandomizeWildWarp)}assumeRageSkip(){return!1}nerfWildWarp(){return this.check(Vanilla$$module$js$flagset.WildWarp,!1)&&this.check(World$$module$js$flagset.RandomizeWildWarp,!1)}allowWildWarp(){return!this.nerfWildWarp()}randomizeWildWarp(){return this.check(World$$module$js$flagset.RandomizeWildWarp,!0)}blackoutMode(){return this.check(HardMode$$module$js$flagset.Blackout)}hardcoreMode(){return this.check(HardMode$$module$js$flagset.Permadeath)}buffDyna(){return!this.check(Vanilla$$module$js$flagset.Dyna)}maxScalingInTower(){return this.check(HardMode$$module$js$flagset.MaxScalingInTower)}expScalingFactor(){return this.check(HardMode$$module$js$flagset.ExperienceScalesSlower)?
.25:this.check(EasyMode$$module$js$flagset.ExperienceScalesFaster)?2.5:1}autoEquipBracelet(a){return"early"===a||this.check(Quality$$module$js$flagset.NoAutoEquip,!1)}controllerShortcuts(a){return"early"===a||this.check(Quality$$module$js$flagset.NoControllerShortcuts,!1)}randomizeMusic(a){return this.check(Aesthetics$$module$js$flagset.RandomizeMusic,"early"===a?"!":!0)}shuffleTilePalettes(a){return this.check(Aesthetics$$module$js$flagset.RandomizeMapColors,"early"===a?"!":!0)}noMusic(a){return"late"===
a&&this.check(Aesthetics$$module$js$flagset.NoMusic)}}var module$js$flagset={};module$js$flagset.Flag=Flag$$module$js$flagset;module$js$flagset.Preset=Preset$$module$js$flagset;module$js$flagset.FlagSection=FlagSection$$module$js$flagset;module$js$flagset.FlagSet=FlagSet$$module$js$flagset;const Edge$$module$js$graph={of:(...a)=>a.map((a)=>a.uid)};class Node$$module$js$graph{constructor(a,b){this.graph=a;this.name=b;this.uid=a.nodes.length;a.nodes.push(this)}get nodeType(){return"Node"}toString(){return`${this.nodeType} ${this.name}`}edges(a){return[]}write(){}}
...
function initializer$$module$js$rom$util(){function a(...a){return{tag:b,args:a}}const b=Symbol();a.commit=(a,d)=>{for(const c of Object.getOwnPropertyNames(a)){const e=a[c];e.tag===b&&(a[c]=d(c,...e.args))}};return a}const PROP_TAG$$module$js$rom$util=Symbol("PROP_TAG"),dataTupleMap$$module$js$rom$util=new WeakMap;
function dataTupleActualClass$$module$js$rom$util(a){let b=dataTupleMap$$module$js$rom$util.get(a);if(!b){b=class extends DataTuple$$module$js$rom$util{};Object.defineProperties(b,{name:{value:a.name}});Object.assign(b,a);Reflect.setPrototypeOf(b.prototype,a.prototype);const c=new a,d={};for(const [a,b]of Object.entries(c))b&&b[PROP_TAG$$module$js$rom$util]&&(d[a]=b);Object.defineProperties(b.prototype,d);dataTupleMap$$module$js$rom$util.set(a,b);dataTupleMap$$module$js$rom$util.set(b,b)}return b}
class DataTuple$$module$js$rom$util{constructor(a){this.data=a}static of(a){return Object.assign(new (dataTupleActualClass$$module$js$rom$util(this))(Array(this.size).fill(0)),a)}static from(a,b=0){const c=dataTupleActualClass$$module$js$rom$util(this);a=b||a.length!==this.size?tuple$$module$js$rom$util(a,b,this.size):a;return new c(a)}[Symbol.iterator](){return this.data[Symbol.iterator]()}hex(){return Array.from(this.data,hex$$module$js$rom$util).join(" ")}clone(){return new this.constructor(this.data)}prop(...a){return{get(){let b=
0;for(const [c,d=255,e=0]of a)b|=(this.data[c]&d)>>>(0>e?0:e)<<(0>e?-e:0);return b},set(b){for(const [c,d=255,e=0]of a)this.data[c]=this.data[c]&~d|b>>>(0>e?-e:0)<<(0>e?0:e)&d},[PROP_TAG$$module$js$rom$util]:!0}}booleanProp(a,b){return{get(){return!!(this.data[a]&1<<b)},set(c){const d=1<<b;this.data[a]=c?this.data[a]|d:this.data[a]&~d},[PROP_TAG$$module$js$rom$util]:!0}}}
...
function free$$module$js$rom$util(a,b,c,d){a.segment(b.name);a.org(c);a.free(d-c)}function relocExportLabel$$module$js$rom$util(a,b,c){a.segment(...b.map((a)=>a.name));a.reloc(c);a.label(c);a.export(c)}var module$js$rom$util={};module$js$rom$util.upperCamelToSpaces=upperCamelToSpaces$$module$js$rom$util;module$js$rom$util.seq=seq$$module$js$rom$util;module$js$rom$util.slice=slice$$module$js$rom$util;module$js$rom$util.tuple=tuple$$module$js$rom$util;module$js$rom$util.signed=signed$$module$js$rom$util;
module$js$rom$util.unsigned=unsigned$$module$js$rom$util;module$js$rom$util.varSlice=varSlice$$module$js$rom$util;module$js$rom$util.addr=addr$$module$js$rom$util;module$js$rom$util.group=group$$module$js$rom$util;module$js$rom$util.reverseBits=reverseBits$$module$js$rom$util;module$js$rom$util.countBits=countBits$$module$js$rom$util;module$js$rom$util.hex=hex$$module$js$rom$util;module$js$rom$util.hex3=hex3$$module$js$rom$util;module$js$rom$util.hex4=hex4$$module$js$rom$util;
module$js$rom$util.hex5=hex5$$module$js$rom$util;module$js$rom$util.concatIterables=concatIterables$$module$js$rom$util;module$js$rom$util.readBigEndian=readBigEndian$$module$js$rom$util;module$js$rom$util.readLittleEndian=readLittleEndian$$module$js$rom$util;module$js$rom$util.readString=readString$$module$js$rom$util;module$js$rom$util.writeLittleEndian=writeLittleEndian$$module$js$rom$util;module$js$rom$util.writeString=writeString$$module$js$rom$util;module$js$rom$util.write=write$$module$js$rom$util;
module$js$rom$util.FlagListType=FlagListType$$module$js$rom$util;module$js$rom$util.DIALOG_FLAGS=DIALOG_FLAGS$$module$js$rom$util;module$js$rom$util.ITEM_GET_FLAGS=ITEM_GET_FLAGS$$module$js$rom$util;module$js$rom$util.ITEM_USE_FLAGS=ITEM_USE_FLAGS$$module$js$rom$util;module$js$rom$util.ITEM_CONDITION_FLAGS=ITEM_CONDITION_FLAGS$$module$js$rom$util;module$js$rom$util.SPAWN_CONDITION_FLAGS=SPAWN_CONDITION_FLAGS$$module$js$rom$util;module$js$rom$util.initializer=initializer$$module$js$rom$util;
module$js$rom$util.DataTuple=DataTuple$$module$js$rom$util;module$js$rom$util.watchArray=watchArray$$module$js$rom$util;module$js$rom$util.Segment=Segment$$module$js$rom$util;module$js$rom$util.Address=Address$$module$js$rom$util;module$js$rom$util.free=free$$module$js$rom$util;module$js$rom$util.relocExportLabel=relocExportLabel$$module$js$rom$util;class TrackerNode$$module$js$nodes extends Node$$module$js$graph{constructor(a,b,c){super(a,c);this.type=b}get nodeType(){return"Tracker"}edges({}={}){return[]}}TrackerNode$$module$js$nodes.OFF_ROUTE=1;TrackerNode$$module$js$nodes.GLITCH=2;TrackerNode$$module$js$nodes.HARD=3;class Option$$module$js$nodes extends Node$$module$js$graph{constructor(a,b,c){super(a,b);this.value=c}get nodeType(){return"Option"}edges(){return this.value?[Edge$$module$js$graph.of(this)]:[]}}
...
l=h(d("Assume statue glitch",a.assumeStatueGlitch())),n=d("Allow statue glitch",!a.disableStatueGlitch()),p=h(d("Assume teleport skip",a.assumeTeleportSkip())),r=d("Allow teleport skip",!a.disableTeleportSkip()),q=h(d("Assume rabbit skip",a.assumeRabbitSkip())),w=h(d("Allow rabbit skip",!a.disableRabbitSkip())),x=h(d("Assume sword charge glitch",a.assumeSwordChargeGlitch())),y=d("Allow sword charge glitch",!a.disableSwordChargeGlitch()),z=h(d("Assume wild warp",a.assumeWildWarp())),E=d("Allow wild warp",
a.allowWildWarp()),v=d("Sword magic optional",!a.guaranteeSwordMagic()),t=d("Matching sword optional",!a.guaranteeMatchingSword()),V=d("Gas mask optional",!a.guaranteeGasMask()),H=d("Healed dolphin optional",!a.requireHealedDolphinToRide()),W=d("Calm sea optional",!a.barrierRequiresCalmSea()),ja=d("Prison key optional",!1),X=d("Windmill optional",!1),ba=d("Sword of Thunder teleports to Shyron",a.teleportOnThunderSword()),Y=d("Barrier magic optional",!a.guaranteeBarrier()),Fa=d("Refresh magic optional",
!a.guaranteeRefresh()),za=d("Telepathy optional for Deo",!a.saharaRabbitsRequireTelepathy()),T=d("Lime Tree connects to Leaf",a.connectLimeTreeToLeaf()),Ra=d("Buffed medical herb",a.buffMedicalHerb()),P=d("Orbs optional",a.orbsOptional()),Q=(new Item$$module$js$nodes(c,0,"Sword of Wind")).weight(a.guaranteeSword()?10:5).fromPerson("Leaf elder",13).npcSpawn(94,16,1).dialog(13,192,2).key(),J=(new Item$$module$js$nodes(c,1,"Sword of Fire")).weight(a.guaranteeSword()?10:5).fromPerson("Oak elder",29).dialog(29,
void 0,3).key(),N=(new Item$$module$js$nodes(c,2,"Sword of Water")).weight(10).chest().key(),O=(new Item$$module$js$nodes(c,3,"Sword of Thunder")).weight(15).chest().key(),pa=(new Item$$module$js$nodes(c,4,"Crystalis")).fixed(),ea=(new Item$$module$js$nodes(c,5,"Ball of Wind")).chest().key(),Aa=(new Item$$module$js$nodes(c,6,"Tornado Bracelet")).chest().key(),ca=(new Item$$module$js$nodes(c,7,"Ball of Fire")).bossDrop("Insect",1).dialog(30,void 0,2).dialog(32,void 0,0).dialog(33,void 0,0).dialog(34,
void 0,0).dialog(96,30,0).dialog(29,void 0,2).dialog(31,void 0,1).npcSpawn(193).key(),qa=(new Item$$module$js$nodes(c,8,"Flame Bracelet")).bossDrop("Kelbesque 1",2).npcSpawn(194).key(),ra=(new Item$$module$js$nodes(c,9,"Ball of Water")).weight(5).direct("Rage",250679).npcSpawn(195).key(),sa=(new Item$$module$js$nodes(c,10,"Blizzard Bracelet")).weight(5).chest().key(),ka=(new Item$$module$js$nodes(c,11,"Ball of Thunder")).bossDrop("Mado 1",5).trigger(154,1).key(),Ga=(new Item$$module$js$nodes(c,12,
"Storm Bracelet")).chest().key(),Sa=(new Item$$module$js$nodes(c,13,"Carapace Shield")).armor(),Ha=(new Item$$module$js$nodes(c,14,"Bronze Shield")).armor(),u=(new Item$$module$js$nodes(c,15,"Platinum Shield")).armor(),rb=(new Item$$module$js$nodes(c,16,"Mirrored Shield")).armor(),F=(new Item$$module$js$nodes(c,17,"Ceramic Shield")).armor(),Z=(new Item$$module$js$nodes(c,18,"Sacred Shield")).armor().bossDrop("Mado 2",8).npcSpawn(199).bonus(),R=(new Item$$module$js$nodes(c,19,"Battle Shield")).armor(),
ta=(new Item$$module$js$nodes(c,20,"Psycho Shield")).armor(),Ta=(new Item$$module$js$nodes(c,21,"Tanned Hide")).armor(),Ia=(new Item$$module$js$nodes(c,22,"Leather Armor")).armor(),be=(new Item$$module$js$nodes(c,23,"Bronze Armor")).armor(),oc=(new Item$$module$js$nodes(c,24,"Platinmum Armor")).armor(),ce=(new Item$$module$js$nodes(c,25,"Soldier Suit")).armor(),pc=(new Item$$module$js$nodes(c,26,"Ceramic Suit")).armor(),de=(new Item$$module$js$nodes(c,27,"Battle Suit")).armor(),ee=(new Item$$module$js$nodes(c,
28,"Psycho Armor")).armor().bossDrop("Draygon 1",10).npcSpawn(203).trigger(159).npcSpawn(131).key(),S=(new Item$$module$js$nodes(c,29,"Medical Herb")).consumable(),da=(new Item$$module$js$nodes(c,30,"Antidote")).consumable(),$a=(new Item$$module$js$nodes(c,31,"Lysis Plant")).consumable(),Kb=(new Item$$module$js$nodes(c,32,"Fruit of Lime")).consumable(),fa=(new Item$$module$js$nodes(c,33,"Fruit of Power")).consumable(),ua=(new Item$$module$js$nodes(c,34,"Magic Ring")).consumable(),Lb=(new Item$$module$js$nodes(c,
35,"Fruit of Repun")).consumable().bossDrop("Sabera 2",7).npcSpawn(198).key(),la=(new Item$$module$js$nodes(c,36,"Warp Boots")).consumable(),qc=(new Item$$module$js$nodes(c,37,"Statue of Onyx")).chest("Cordel grass").invisible(254882).key(),Mb=(new Item$$module$js$nodes(c,38,"Opel Statue")).consumable().bossDrop("Kelbesque 2",6).npcSpawn(197).key(),rc=(new Item$$module$js$nodes(c,39,"Insect Flute")).fromPerson("Oak mother",30).dialog(30,void 0,1).key(),Nb=(new Item$$module$js$nodes(c,40,"Flute of Lime")).fromPerson("Portoa queen",
...
(new Magic$$module$js$nodes(c,65,"Refresh")).fromPerson("Zebu at windmill",94).requireUnique().direct(251665).dialog(94,16,3).trigger(180,1),lb=(new Magic$$module$js$nodes(c,66,"Paralysis")).direct("Zebu at Mt. Sabre summit",251477).requireUnique().trigger(141).trigger(178),Ja=(new Magic$$module$js$nodes(c,67,"Telepathy")).direct("Tornel at Stom's house",223220).npcSpawn(95,30,1).trigger(133,1),Fc=(new Magic$$module$js$nodes(c,68,"Teleport")).fromPerson("Tornel on Mt. Sabre",95).dialog(95,33,0),je=
(new Magic$$module$js$nodes(c,69,"Recover")).direct("Asina in Portoa",250361),Gc=(new Magic$$module$js$nodes(c,70,"Barrier")).direct("Asina on Angry sea",251609).requireUnique().trigger(132,0),Ua=(new Magic$$module$js$nodes(c,71,"Change")).direct("Kensu in Swan",251614).npcSpawn(116,241,1).npcSpawn(126,241,1),K=(new Magic$$module$js$nodes(c,72,"Flight")).weight(15).direct("Kensu in Draygonia Fortress",250255),ke=fa.bossDrop("Vampire 2",12,97).npcSpawn(204).key(),ha=new Item$$module$js$nodes(c,112,
"Mimic"),Hc=(new Trigger$$module$js$nodes(c,"Talked to Leaf Elder")).get(Q),Ic=(new Trigger$$module$js$nodes(c,"Talked to Leaf Student")).get(Pb),Tb=new Trigger$$module$js$nodes(c,"Talked to Zebu in cave"),le=(new Trigger$$module$js$nodes(c,"Woke up Windmill Guard")).get(uc),mb=new Trigger$$module$js$nodes(c,"Started Windmill"),Jc=(new Trigger$$module$js$nodes(c,"Learned Refresh")).get(tb),me=(new Trigger$$module$js$nodes(c,"Gave Statue to Akahana")).get(sb),ne=(new Trigger$$module$js$nodes(c,"Fought Stom")).get(Ja),
Kc=new Trigger$$module$js$nodes(c,"Visited Oak"),Lc=new Trigger$$module$js$nodes(c,"Talked to Oak Mother"),Ub=new Trigger$$module$js$nodes(c,"Rescued Oak Child"),oe=(new Trigger$$module$js$nodes(c,"Talked to Oak Mother Again")).get(rc),pe=(new Trigger$$module$js$nodes(c,"Talked to Oak Elder")).get(J),qe=(new Trigger$$module$js$nodes(c,"Talked to Tornel on Mt Sabre")).get(Fc),Mc=new Trigger$$module$js$nodes(c,"Villagers Abducted"),Nc=new Trigger$$module$js$nodes(c,"Talked to Rabbit in Leaf"),re=(new Trigger$$module$js$nodes(c,
"Learned Paralysis")).get(lb),Oc=new Trigger$$module$js$nodes(c,"Talked to Portoa Queen"),Pc=new Trigger$$module$js$nodes(c,"Talked to Fortune Teller"),Qc=new Trigger$$module$js$nodes(c,"Visited Underground Channel"),se=(new Trigger$$module$js$nodes(c,"Sent to Waterfall Cave")).get(Nb),te=(new Trigger$$module$js$nodes(c,"Cured Akahana")).get(tc),Rc=(new Trigger$$module$js$nodes(c,"Talked to Rage")).get(ra),Sc=new Trigger$$module$js$nodes(c,"Mesia recording played"),Tc=(new Trigger$$module$js$nodes(c,
...
Xc=new Trigger$$module$js$nodes(c,"Talked to Stom in Swan Hut"),Yc=new Trigger$$module$js$nodes(c,"Talked to Kensu in Swan tavern"),Zc=new Trigger$$module$js$nodes(c,"Talked to Kensu at Swan dance"),xe=(new Trigger$$module$js$nodes(c,"Returned Kensu's love pendant")).get(Ua),ye=(new Trigger$$module$js$nodes(c,"Talked to Amazones Queen")).get(Cc),Xb=new Trigger$$module$js$nodes(c,"Entered Shyron"),ze=(new Trigger$$module$js$nodes(c,"Talked to Zebu in Shyron")).get(vc),$c=new Trigger$$module$js$nodes(c,
"Shyron Massacre"),Ae=(new Trigger$$module$js$nodes(c,"Saved Kensu")).get(K),Be=(new Trigger$$module$js$nodes(c,"Talked to Deo")).get(ie),Ce=(new Trigger$$module$js$nodes(c,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(c,"Get Bow of Truth")).get(Ec),Ee=(new Trigger$$module$js$nodes(c,"Forged Crystalis")).get(pa),ub=(new Condition$$module$js$nodes(c,"Sword charge glitch")).option(x,y),Fe=(new Condition$$module$js$nodes(c,"Rabbit skip")).option(q,w),Ge=(new Condition$$module$js$nodes(c,
"Teleport skip")).option(p,r),vb=(new Condition$$module$js$nodes(c,"Statue glitch")).option(l,n),He=(new Condition$$module$js$nodes(c,"Wild warp")).option(z,E),wb=(new Condition$$module$js$nodes(c,"Any level 2 sword")).option(Q,ea).option(Q,Aa).option(J,ca).option(J,qa).option(N,ra).option(N,sa).option(O,ka).option(O,Ga),C=(new Condition$$module$js$nodes(c,"Destroy stone")).option(Q,P).option(Q,ea).option(Q,Aa).option(ub,Q,wb),D=(new Condition$$module$js$nodes(c,"Destroy ice")).option(J,P).option(J,
ca).option(J,qa).option(ub,J,wb),A=(new Condition$$module$js$nodes(c,"Cross rivers")).option(N,P).option(N,ra).option(N,sa).option(K).option(ub,N,wb),ab=(new Condition$$module$js$nodes(c,"Destroy iron")).option(O,P).option(O,ka).option(O,Ga).option(ub,O,wb),ma=(new Condition$$module$js$nodes(c,"Any sword")).option(Q).option(J).option(N).option(O),Ie=(new Condition$$module$js$nodes(c,"Match insect sword (fire/water/thunder)")).option(J).option(N).option(O).option(sb,t.value?t:g,Q),Je=(new Condition$$module$js$nodes(c,
"Match vampire 2 sword (wind/water/thunder)")).option(Q).option(N).option(O).option(t.value?t:g,J),ad=(new Condition$$module$js$nodes(c,"Speed boots")).option(sc,k),bd=(new Condition$$module$js$nodes(c,"Climb slopes")).option(Ob).option(K).option(ad),Ke=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (rabbit)")).option(Nc).option(Fe),Le=(new Condition$$module$js$nodes(c,"Enter Mt Sabre North (Teleport)")).option(Fc).option(Ge,K),cd=(new Condition$$module$js$nodes(c,"Asina in her room")).option(Sc),
Me=(new Condition$$module$js$nodes(c,"Paralysis or Asina revealed")).option(lb).option(cd).option(vb),dd=(new Condition$$module$js$nodes(c,"Ride dolphin")).option(Rb,Vc),Ne=(new Condition$$module$js$nodes(c,"Ghetto flight")).option(m,dd,Ob),Ba=(new Condition$$module$js$nodes(c,"Cross sea")).option(dd).option(K),Oe=(new Condition$$module$js$nodes(c,"Cross whirlpool")).option(Wb).option(K).option(Ne),na=(new Condition$$module$js$nodes(c,"Refresh if needed")).option(Fa.value?Fa:g).option(tb),ed=(new Condition$$module$js$nodes(c,
"Wind magic")).option(v.value?v:g,na).option(ea,Aa,na),fd=(new Condition$$module$js$nodes(c,"Fire magic")).option(v.value?v:g,na).option(ca,qa,na),gd=(new Condition$$module$js$nodes(c,"Water magic")).option(v.value?v:g,na).option(v,na).option(ra,sa,na),Pe=(new Condition$$module$js$nodes(c,"Thunder magic")).option(v.value?v:g,na).option(v,na).option(ka,na).option(Ga,na),Qe=(new Condition$$module$js$nodes(c,"Flute of lime or glitch")).option(Nb).option(vb),Re=(new Condition$$module$js$nodes(c,"Change or glitch")).option(Ua).option(vb),
Se=(new Condition$$module$js$nodes(c,"Change or glitch or paralysis")).option(Ua).option(vb).option(lb),Yb=(new Condition$$module$js$nodes(c,"Pass shooting statues")).option(Gc).option(ma,Y.value?Y:g).option(tb,tc),Te=(new Condition$$module$js$nodes(c,"Healed dolphin if required")).option(Uc).option(H),hd=(new Condition$$module$js$nodes(c,"Match sword of wind")).option(Q).option(t.value?t:g,ma),id=(new Condition$$module$js$nodes(c,"Match sword of fire")).option(J).option(t.value?t:g,ma),jd=(new Condition$$module$js$nodes(c,
"Match sword of water")).option(N).option(t.value?t:g,ma),Ue=(new Condition$$module$js$nodes(c,"Match sword of thunder")).option(O).option(t.value?t:g,ma),Ve=(new Condition$$module$js$nodes(c,"Swamp run possible")).option(ma,ad).option(ma,Ra).option(ma,tb),We=(new Condition$$module$js$nodes(c,"Insect possible to kill")).option(sb),xb=(new Condition$$module$js$nodes(c,"Travel swamp")).option(sb).option(V.value?V:g,Ve),Xe=(new Condition$$module$js$nodes(c,"Calmed sea if required")).option(Wb).option(W),
Ye=(new Condition$$module$js$nodes(c,"Started windmill if required")).option(mb).option(X),Ze=(new Condition$$module$js$nodes(c,"Telepathy if required for Deo")).option(Ja).option(za),$e=e(0,"Vampire 1",ma).get(Ob),af=e(1,"Insect",rc,Ie,We).get(ca),bf=e(2,"Kelbesque 1",hd,ed).get(qa),cf=e(12,"Vampire 2",Je).get(ke),kd=e(4,"Sabera 1",id,fd).get(yc),df=e(5,"Mado 1",jd,gd).get(ka),ef=e(6,"Kelbesque 2",hd,ed).get(Mb),ff=e(7,"Sabera 2",id,fd).get(Lb),gf=e(8,"Mado 2",jd,gd).get(Z),hf=e(9,"Karmine",Ue,Pe).get(Sb),
jf=e(10,"Draygon 1",ma).get(ee),kf=e(-1,"Statues",Dc,Cc),lf=e(11,"Draygon 2",ma,Ec),mf=e(13,"Dyna",pa),nf=(new Condition$$module$js$nodes(c,"Opened prison if required")).option(Qb).option(ja),va=new Area$$module$js$nodes(c,"Leaf"),bb=new Area$$module$js$nodes(c,"Valley of Wind"),oa=new Area$$module$js$nodes(c,"Sealed Cave"),Va=new Area$$module$js$nodes(c,"Cordel Plain"),cb=new Area$$module$js$nodes(c,"Brynmaer"),db=new Area$$module$js$nodes(c,"Amazones"),L=new Area$$module$js$nodes(c,"Mt Sabre West"),
B=new Area$$module$js$nodes(c,"Mt Sabre North"),yb=new Area$$module$js$nodes(c,"Nadare's"),nb=new Area$$module$js$nodes(c,"Oak"),Ka=new Area$$module$js$nodes(c,"Waterfall Valley"),I=new Area$$module$js$nodes(c,"Portoa"),La=new Area$$module$js$nodes(c,"Waterfall Cave"),M=new Area$$module$js$nodes(c,"Fog Lamp Cave"),Ma=new Area$$module$js$nodes(c,"Kirisa Plant Cave"),Wa=new Area$$module$js$nodes(c,"Angry Sea"),Na=new Area$$module$js$nodes(c,"Joel"),aa=new Area$$module$js$nodes(c,"Evil Spirit Island"),
Oa=new Area$$module$js$nodes(c,"Sabera's Castle"),wa=new Area$$module$js$nodes(c,"Swan"),G=new Area$$module$js$nodes(c,"Mt Hydra"),Pa=new Area$$module$js$nodes(c,"Shyron"),Xa=new Area$$module$js$nodes(c,"Styx"),Ya=new Area$$module$js$nodes(c,"Goa"),zb=new Area$$module$js$nodes(c,"Draygonia Fortress 1"),xa=new Area$$module$js$nodes(c,"Draygonia Fortress 2"),eb=new Area$$module$js$nodes(c,"Draygonia Fortress 3"),ia=new Area$$module$js$nodes(c,"Draygonia Fortress 4"),U=new Area$$module$js$nodes(c,"Oasis Cave"),
ya=new Area$$module$js$nodes(c,"Sahara"),fb=new Area$$module$js$nodes(c,"Pyramid Front"),Ca=new Area$$module$js$nodes(c,"Pyramid Back"),Da=new Area$$module$js$nodes(c,"Tower"),Zb=(new Location$$module$js$nodes(c,0,va,"Start")).overworld().start(),of=(new Location$$module$js$nodes(c,0,va,"Mezame Shrine")).overworld().from(Zb),pf=(new Location$$module$js$nodes(c,1,va,"Outside Start")).overworld().connect(of),Qa=(new Location$$module$js$nodes(c,2,va,"Town")).town().connect(pf),ob=(new Location$$module$js$nodes(c,
3,bb,"Main")).overworld().connect(Qa).trigger(Jc,mb),ld=(new Location$$module$js$nodes(c,3,bb,"Outside Windmill")).overworld(),md=(new Location$$module$js$nodes(c,4,oa,"Tunnel 1 (entrance)")).cave().from(ob,mb),qf=(new Location$$module$js$nodes(c,5,oa,"Tunnel 2 (over bridge)")).cave().connect(md),rf=(new Location$$module$js$nodes(c,6,oa,"Tunnel 6 (herb dead end)")).cave().chest(S,15),nd=(new Location$$module$js$nodes(c,7,oa,"Tunnel 4a (ball corridor)")).cave().chest(S,20,80).chest(ea,21);(new Location$$module$js$nodes(c,
7,oa,"Tunnel 4b (antidote dead end)")).cave().connect(nd,C).chest(da,19);const sf=(new Location$$module$js$nodes(c,8,oa,"Tunnel 5 (warp boots dead end)")).cave().chest(la,14),tf=(new Location$$module$js$nodes(c,9,oa,"Tunnel 3a (branch, front)")).cave().connect(qf).connectTo(nd).connectTo(sf),uf=(new Location$$module$js$nodes(c,9,oa,"Tunnel 3b (branch, back)")).cave().connect(tf,C).connectTo(rf),vf=(new Location$$module$js$nodes(c,10,oa,"Tunnel 7 (boss)")).cave().connect(uf).boss($e),wf=(new Location$$module$js$nodes(c,
12,oa,"Tunnel 8a (exit, above wall)")).cave().connect(vf),xf=(new Location$$module$js$nodes(c,12,oa,"Tunnel 8b (exit, below wall")).cave().connect(wf,C);(new Location$$module$js$nodes(c,14,bb,"Windmill Cave")).cave().connect(ob).connectTo(ld).trigger(le,Pb,Tb);(new Location$$module$js$nodes(c,15,bb,"Windmill")).misc().connect(ld).trigger(mb,uc);const yf=(new Location$$module$js$nodes(c,16,bb,"Zebu's Cave Front")).cave().connect(ob).trigger(Tb,Hc,Ic).trigger(Jc,mb,Tb),zf=(new Location$$module$js$nodes(c,
16,bb,"Zebu's Cave Back")).cave().trigger(Mc).connect(yf,D),Af=(new Location$$module$js$nodes(c,17,L,"Tunnel 1 (to Zebu)")).cave().connect(zf),gb=(new Location$$module$js$nodes(c,20,Va,"West")).overworld().connect(xf,Ye),Bf=(new Location$$module$js$nodes(c,20,Va,"South")).overworld().connect(gb,A),od=(new Location$$module$js$nodes(c,21,Va,"East")).overworld().connect(gb).chest(qc,24),pb=(new Location$$module$js$nodes(c,24,cb,"Town")).town().connect(gb).trigger(me,qc),Cf=(new Location$$module$js$nodes(c,
25,Va,"Outside Stom's House")).town().connect(gb),$b=(new Location$$module$js$nodes(c,26,Va,"Swamp")).overworld().connect(od,xb).trigger(Ub,Lc,xb);(new Location$$module$js$nodes(c,26,Va,"Swamp Insect Area")).overworld().connect($b,xb).boss(af);const Ab=(new Location$$module$js$nodes(c,27,db,"Town")).town().connect(Bf),Bb=(new Location$$module$js$nodes(c,28,nb,"Town")).town().connect($b,xb).trigger(Kc);(new Location$$module$js$nodes(c,30,Va,"Stom's House")).house().connect(Cf).trigger(ne,Kc);const hb=
(new Location$$module$js$nodes(c,32,L,"Entrance")).overworld().connect(gb).connect(Af),Df=(new Location$$module$js$nodes(c,32,L,"Up Slope")).overworld().from(hb,bd).to(hb),Ef=(new Location$$module$js$nodes(c,32,L,"Dead End (warp boots)")).overworld().chest(la,24,106),pd=(new Location$$module$js$nodes(c,33,L,"Upper")).overworld().from(hb,K).to(hb),Ff=(new Location$$module$js$nodes(c,33,L,"Tornel Dead End")).overworld().trigger(qe,ea,Aa).chest(ua,23,105),qd=(new Location$$module$js$nodes(c,34,L,"Tunnel 2a (fork at start)")).cave().connect(hb);
(new Location$$module$js$nodes(c,34,L,"Tunnel 2b (left branch to dead end)")).cave().connect(qd,D).connectTo(Ef);const Gf=(new Location$$module$js$nodes(c,34,L,"Tunnel 2c (right branch to upper)")).cave().connect(qd,D),Hf=(new Location$$module$js$nodes(c,35,L,"Tunnel 3a (tunnel to upper, with herb chest)")).cave().connect(Gf).chest(S,23,82),If=(new Location$$module$js$nodes(c,35,L,"Tunnel 3b (tunnel to upper, branch below ice)")).cave().connect(Hf,D).connectTo(pd),rd=(new Location$$module$js$nodes(c,
36,L,"Tunnel 4a (branch to upper or Tornel)")).cave().connect(If);(new Location$$module$js$nodes(c,36,L,"Tunnel 4b (out to upper)")).cave().connect(rd,D).connectTo(pd);const Jf=(new Location$$module$js$nodes(c,37,L,"Tunnel 5 (tiny connector)")).cave().connect(rd),Kf=(new Location$$module$js$nodes(c,38,L,"Tunnel 6a (exit to Tornel, above ice)")).cave().connect(Jf);(new Location$$module$js$nodes(c,38,L,"Tunnel 6b (exit to Tornel, below ice)")).cave().connect(Kf,D).connectTo(Ff);const Lf=(new Location$$module$js$nodes(c,
39,L,"Tunnel 7a (tornado bracelet, lower)")).cave().connect(Df),Mf=(new Location$$module$js$nodes(c,39,L,"Tunnel 7b (tornado bracelet, middle)")).cave().connect(Lf,D);(new Location$$module$js$nodes(c,39,L,"Tunnel 7c (tornado bracelet, upper)")).cave().connect(Mf,D).chest(Aa,25);const Cb=(new Location$$module$js$nodes(c,40,B,"Entrance")).overworld().connect(od,Le,Ke),Db=(new Location$$module$js$nodes(c,40,B,"Upper")).overworld().from(Cb,K).to(Cb),ac=(new Location$$module$js$nodes(c,40,B,"Summit (boss)")).overworld().from(Db,
K).to(Db).boss(bf),sd=(new Location$$module$js$nodes(c,41,B,"Connector")).overworld(),bc=(new Location$$module$js$nodes(c,41,B,"Middle Left")).overworld(),Nf=(new Location$$module$js$nodes(c,41,B,"Middle Right")).overworld().from(bc,bd).to(bc),td=(new Location$$module$js$nodes(c,42,B,"Tunnel 2a (from entrance to connector)")).cave().connectTo(sd);(new Location$$module$js$nodes(c,42,B,"Tunnel 2b (under bridge, to antidote)")).cave().connect(td,D).chest(da,23,94);const ud=(new Location$$module$js$nodes(c,
43,B,"Tunnel 3a (branch after connector)")).cave().connect(sd),Of=(new Location$$module$js$nodes(c,43,B,"Tunnel 3b (right branch)")).cave().connect(ud,D),Pf=(new Location$$module$js$nodes(c,43,B,"Tunnel 3c (upper branch)")).cave().connect(ud,D);(new Location$$module$js$nodes(c,44,B,"Tunnel 4 (over bridge, to middle)")).cave().connect(Pf).connectTo(bc);const vd=(new Location$$module$js$nodes(c,45,B,"Tunnel 5a (E-shaped, from right branch)")).cave().connect(Of).connectTo(Nf);(new Location$$module$js$nodes(c,
45,B,"Tunnel 5b (dead-end with herb)")).cave().connect(vd,D).chest(S,22,83);const Qf=(new Location$$module$js$nodes(c,46,B,"Tunne; 6a (S-shaped hall, right)")).cave().connect(vd),Rf=(new Location$$module$js$nodes(c,46,B,"Tunne; 6b (S-shaped hall, middle)")).cave().connect(Qf,D),Sf=(new Location$$module$js$nodes(c,46,B,"Tunnel 6c (S-shaped hall, left)")).cave().connect(Rf,D),wd=(new Location$$module$js$nodes(c,47,B,"Prison (hallway)")).cave().connect(Db),Tf=(new Location$$module$js$nodes(c,48,B,"Left Cell (shopkeepers)")).cave().from(wd,
D);(new Location$$module$js$nodes(c,49,B,"Left Cell 2 (back, with prison key)")).cave().from(Tf,D).chest(Qb,13);const Uf=(new Location$$module$js$nodes(c,50,B,"Right Cell (villagers)")).cave().from(wd,D),Vf=(new Location$$module$js$nodes(c,51,B,"Tunnel 8 (behind right cell, toward summit)")).cave().from(Uf,D);(new Location$$module$js$nodes(c,52,B,"Tunnel 9 (connector to summit)")).cave().connect(Vf).connectTo(ac);const Wf=(new Location$$module$js$nodes(c,53,B,"Summit Cave (front)")).cave().from(ac,
Qb).to(ac),Xf=(new Location$$module$js$nodes(c,53,B,"Summit Cave (behind ice)")).cave().connect(Wf,D).trigger(re);(new Location$$module$js$nodes(c,56,B,"Tunnel 1 (leads from main entrance)")).cave().connect(Cb).connectTo(td);(new Location$$module$js$nodes(c,57,B,"Tunnel 7 (to upper)")).cave().connect(Sf).connectTo(Db);const Yf=(new Location$$module$js$nodes(c,60,yb,"Inn")).shop(),Zf=(new Location$$module$js$nodes(c,61,yb,"Tool Shop")).shop(S,da,fa,la),$f=(new Location$$module$js$nodes(c,62,yb,"Back Room")).house(),
cc=(new Location$$module$js$nodes(c,64,Ka,"Summit")).overworld().connect(Xf,nf),Eb=(new Location$$module$js$nodes(c,64,Ka,"Northwest")).overworld().from(cc).to(cc,K),ag=(new Location$$module$js$nodes(c,64,Ka,"Northeast")).overworld().connect(Eb,A),xd=(new Location$$module$js$nodes(c,65,Ka,"Southwest")).overworld().connect(Eb),bg=(new Location$$module$js$nodes(c,65,Ka,"Southeast")).overworld().connect(xd,A),yd=(new Location$$module$js$nodes(c,66,Ka,"Lime Tree Valley")).overworld().connect(xd).connect(ob,
T),cg=(new Location$$module$js$nodes(c,67,Ka,"Lime Tree Lake (Rage)")).cave().connect(yd).trigger(Rc,N),dg=(new Location$$module$js$nodes(c,68,Ma,"Tunnel 1a (entrance)")).cave().connect(bg),eg=(new Location$$module$js$nodes(c,68,Ma,"Tunnel 1b (behind wall)")).cave().connect(dg,C),zd=(new Location$$module$js$nodes(c,69,Ma,"Tunnel 2a (main path, before wall)")).cave().connect(eg);(new Location$$module$js$nodes(c,69,Ma,"Tunnel 2b (dead end, antidote)")).cave().connect(zd,C).chest(da,25,95);const fg=
(new Location$$module$js$nodes(c,69,Ma,"Tunnel 2c (main path, after wall)")).cave().connect(zd,C),gg=(new Location$$module$js$nodes(c,70,Ma,"Tunnel 3a (last room, before wall)")).cave().connect(fg),hg=(new Location$$module$js$nodes(c,70,Ma,"Tunnel 3b (last room, after wall)")).cave().connect(gg,C);(new Location$$module$js$nodes(c,71,Ma,"Meadow")).overworld().connect(hg).chest(Bc,14);const ig=(new Location$$module$js$nodes(c,72,M,"Tunnel 1a (entrance)")).cave().connect(ag),Ad=(new Location$$module$js$nodes(c,
72,M,"Tunnel 1b (past wall)")).cave().connect(ig,C);(new Location$$module$js$nodes(c,72,M,"Tunnel 1c (dead end, lysisPlant)")).cave().connect(Ad,C).chest($a,24);const jg=(new Location$$module$js$nodes(c,73,M,"Tunnel 2 (tiny connector)")).cave().connect(Ad),Bd=(new Location$$module$js$nodes(c,74,M,"Tunnel 3a (upper branch)")).cave().connect(jg);(new Location$$module$js$nodes(c,74,M,"Tunnel 3b (dead end, mimic)")).cave().connect(Bd,C).chest(ha,21,112);const Cd=(new Location$$module$js$nodes(c,74,M,
"Tunnel 3c (short passage with mimic)")).cave().connect(Bd,C).chest(ha,22,113),kg=(new Location$$module$js$nodes(c,74,M,"Tunnel 3d (lower branch)")).cave().connect(Cd,C);(new Location$$module$js$nodes(c,75,M,"Dead end loop")).cave().connect(kg);const Dd=(new Location$$module$js$nodes(c,76,M,"Tunnel 4a (right branch over bridge)")).cave().connect(Cd),lg=(new Location$$module$js$nodes(c,76,M,"Tunnel 4b (past wall over bridge)")).cave().connect(Dd,C),mg=(new Location$$module$js$nodes(c,77,M,"Tunnel 5a (from left branch)")).cave().connect(Dd),
ng=(new Location$$module$js$nodes(c,77,M,"Tunnel 5b (reconvergence)")).cave().connect(mg,C).connect(lg),og=(new Location$$module$js$nodes(c,77,M,"Tunnel 5c (between walls)")).cave().connect(ng,C),pg=(new Location$$module$js$nodes(c,77,M,"Tunnel 5d (under bridge)")).cave().connect(og,C),qg=(new Location$$module$js$nodes(c,78,M,"Tunnel 6a (over second bridge)")).cave().connect(pg),rg=(new Location$$module$js$nodes(c,78,M,"Tunnel 6b (past wall)")).cave().connect(qg,C),sg=(new Location$$module$js$nodes(c,
79,M,"Tunnel 7a (under second bridge)")).cave().connect(rg);(new Location$$module$js$nodes(c,79,M,"Tunnel 7b (fog lamp)")).cave().connect(sg,C).chest(wc,19);const Za=(new Location$$module$js$nodes(c,80,I,"Town")).town().connect(Eb),Ed=(new Location$$module$js$nodes(c,81,I,"Fishherman Island")).town().connect(Za);(new Location$$module$js$nodes(c,82,Ka,"Mesia Shrine")).cave().trigger(Sc).connect(cg,A,Rc);const Fd=(new Location$$module$js$nodes(c,84,La,"Tunnel 1a (entrance)")).cave().connect(Eb);(new Location$$module$js$nodes(c,
84,La,"Tunnel 1b (dead end, mimic)")).cave().connect(Fd,D).chest(ha,19,114);const tg=(new Location$$module$js$nodes(c,84,La,"Tunnel 1c (past ice)")).cave().connect(Fd,D),ug=(new Location$$module$js$nodes(c,85,La,"Tunnel 2 (stoned pair)")).cave().connect(tg),dc=(new Location$$module$js$nodes(c,86,La,"Tunnel 3 (wide medusa hallways)")).cave().connect(ug,Qe),vg=(new Location$$module$js$nodes(c,87,La,"Tunnel 4a (left entrance)")).cave().from(dc,D).chest(rb.chest().bonus(),25).trigger(te,Nb);(new Location$$module$js$nodes(c,
87,La,"Tunnel 4b (right entrance)")).cave().from(dc,D).connect(vg,K);(new Location$$module$js$nodes(c,87,La,"Tunnel 4c (sword of water)")).cave().connect(dc,D).chest(N,24);const Gd=(new Location$$module$js$nodes(c,88,Da,"Entrance")).misc(),wg=(new Location$$module$js$nodes(c,89,Da,"Level 1")).misc().from(Gd),xg=(new Location$$module$js$nodes(c,90,Da,"Level 2")).misc().from(wg),yg=(new Location$$module$js$nodes(c,91,Da,"Level 3")).misc().from(xg),Hd=(new Location$$module$js$nodes(c,92,Da,"Outside Mesia Room")).misc().from(yg),
zg=(new Location$$module$js$nodes(c,93,Da,"Outside Dyna Room")).misc().from(Hd,pa);(new Location$$module$js$nodes(c,94,Da,"Mesia")).misc().connect(Hd).trigger(Ee);const Ag=(new Location$$module$js$nodes(c,95,Da,"Dyna")).misc().from(zg).boss(mf);(new Location$$module$js$nodes(c,95,Da,"Win")).misc().from(Ag).end();const ec=(new Location$$module$js$nodes(c,96,Wa,"Cabin Beach")).sea().from(Ed,Vb),ib=(new Location$$module$js$nodes(c,96,Wa,"South")).sea().connect(ec,Ba),Bg=(new Location$$module$js$nodes(c,
96,Wa,"Joel Beach")).sea().connect(ib,Ba),Id=(new Location$$module$js$nodes(c,96,Na,"Outside Lighthouse")).sea();(new Location$$module$js$nodes(c,96,Wa,"Altar")).sea().connect(ib,Ba).trigger(Wb,zc,yc);const Cg=(new Location$$module$js$nodes(c,96,Wa,"North")).sea().to(ib,Ba).from(ib,Ba,Oe).trigger(we,Xe),Dg=(new Location$$module$js$nodes(c,96,Wa,"Swan Beach")).sea().connect(Cg,Ba);(new Location$$module$js$nodes(c,97,Wa,"Cabin")).misc().connect(ec).trigger(Vc,Vb);(new Location$$module$js$nodes(c,98,
Na,"Lighthouse")).misc().connect(Id).trigger(ve,Pb);const Fb=(new Location$$module$js$nodes(c,100,I,"Underground Channel 1 (from throne room)")).sea().trigger(Qc),Eg=(new Location$$module$js$nodes(c,100,I,"Underground Channel 2 (to fortune teller)")).sea().connect(Fb,A),Jd=(new Location$$module$js$nodes(c,100,I,"Underground Channel 3 (from fortune teller)")).sea().connect(Fb,K),Kd=(new Location$$module$js$nodes(c,100,I,"Underground Channel 4 (asina)")).sea().connect(Jd,A),Fg=(new Location$$module$js$nodes(c,
100,I,"Underground Channel 5 (dolphin)")).sea().connect(Kd,A).trigger(Uc,S,Tc);(new Location$$module$js$nodes(c,100,I,"Underground Channel 6 (water)")).sea().connect(Fg,Ba).connectTo(ib,Ba).chest(Ac,17);const fc=(new Location$$module$js$nodes(c,101,aa,"Zombie Town")).town(),Gg=(new Location$$module$js$nodes(c,104,aa,"Tunnel 1 (entrance)")).sea().connect(ib,Wc,Ba),Ld=(new Location$$module$js$nodes(c,105,aa,"Tunnel 2a (start)")).cave().connect(Gg);(new Location$$module$js$nodes(c,105,aa,"Tunnel 2b (dead end to left)")).cave().connect(Ld,
A);const Hg=(new Location$$module$js$nodes(c,105,aa,"Tunnel 2c (across first river)")).cave().connect(Ld,A),Md=(new Location$$module$js$nodes(c,105,aa,"Tunnel 2d (across second river)")).cave().connect(Hg,A);(new Location$$module$js$nodes(c,105,aa,"Tunnel 2e (dead end, magic ring)")).cave().connect(Md,C).chest(ua,29);const Ig=(new Location$$module$js$nodes(c,105,aa,"Tunnel 2f (stair down)")).cave().connect(Md,C),Jg=(new Location$$module$js$nodes(c,106,aa,"Tunnel 3a (main area)")).cave().connect(Ig).connectTo(fc).chest($a,
25,92),Kg=(new Location$$module$js$nodes(c,106,aa,"Tunnel 3b (left area toward items)")).cave().connect(Jg,C),Lg=(new Location$$module$js$nodes(c,107,aa,"Tunnel 4a (right side, mimic)")).cave().connect(Kg).chest(ha,14,115);(new Location$$module$js$nodes(c,107,aa,"Tunnel 4b (left side, iron necklace)")).cave().connect(Lg,A).chest(he,15);const gc=(new Location$$module$js$nodes(c,108,Oa,"Floor 1")).fortress().connect(fc),Mg=(new Location$$module$js$nodes(c,108,Oa,"Miniboss")).fortress().boss(cf).connect(gc);
(new Location$$module$js$nodes(c,109,Oa,"Floor 2a (left stair)")).fortress().connect(gc).chest(fa,19);const Ng=(new Location$$module$js$nodes(c,109,Oa,"Floor 2b (right stair)")).fortress().connect(Mg).chest(S,30,85),Og=(new Location$$module$js$nodes(c,110,Oa,"Floor 3a (toward boss)")).fortress().connect(Ng),Nd=(new Location$$module$js$nodes(c,110,Oa,"Floor 3b (boss room)")).fortress().connect(Og);(new Location$$module$js$nodes(c,110,Oa,"Boss")).fortress().boss(kd).connect(Nd);(new Location$$module$js$nodes(c,
110,Oa,"Floor 3c (back room trap)")).fortress().from(Nd).to(gc);const Pg=(new Location$$module$js$nodes(c,112,Na,"Secret Passage")).cave().connectTo(Id),Gb=(new Location$$module$js$nodes(c,113,Na,"Town")).town().connect(Bg),Ea=(new Location$$module$js$nodes(c,114,wa,"Town")).town().connect(Dg),Qg=(new Location$$module$js$nodes(c,115,wa,"Inside Gate")).overworld().connect(Ea),Rg=(new Location$$module$js$nodes(c,115,wa,"Outside Gate")).overworld().from(Qg,Ua),Hb=(new Location$$module$js$nodes(c,120,
Ya,"Valley")).overworld().connect(Rg),hc=(new Location$$module$js$nodes(c,124,G,"Entrance")).overworld().connect(Hb),Sg=(new Location$$module$js$nodes(c,124,G,"Over first river toward Shyron")).overworld().connect(hc,A),Od=(new Location$$module$js$nodes(c,124,G,"After first tunnel")).overworld(),Pd=(new Location$$module$js$nodes(c,124,G,"Door to Styx")).overworld().connect(Od,A),Tg=(new Location$$module$js$nodes(c,124,G,"Dead end (no item)")).overworld(),Ug=(new Location$$module$js$nodes(c,124,G,
"Dead end (fruit of lime)")).overworld().chest(Kb,26),Vg=(new Location$$module$js$nodes(c,124,G,"Dead end (magic ring)")).overworld().chest(ua,25,101),Qd=(new Location$$module$js$nodes(c,124,G,"Outside tunnel to bow")).overworld();(new Location$$module$js$nodes(c,124,G,"Floating island (bow of sun)")).overworld().connect(Qd,K).chest(Dc,24);const Wg=(new Location$$module$js$nodes(c,125,G,"Tunnel 1 (to Shyron)")).cave().connect(Sg),Xg=(new Location$$module$js$nodes(c,126,G,"Outside Shyron")).overworld().connect(Wg);
(new Location$$module$js$nodes(c,127,G,"Tunnel 2 (fork)")).cave().connect(hc).connectTo(Ug).connectTo(Od);const Rd=(new Location$$module$js$nodes(c,128,G,"Tunnel 3 (caves)")).cave().connect(Pd).connect(Tg),Sd=(new Location$$module$js$nodes(c,129,G,"Tunnel 4 (left branch of cave)")).cave().connect(Rd);(new Location$$module$js$nodes(c,130,G,"Tunnel 5 (dead end, medical herb)")).cave().connect(Sd).chest(S,15,86);const Yg=(new Location$$module$js$nodes(c,131,G,"Tunnel 6a (left-then-right)")).cave().connect(Sd),
Zg=(new Location$$module$js$nodes(c,131,G,"Tunnel 6b (past wall)")).cave().connect(Yg,C),$g=(new Location$$module$js$nodes(c,132,G,"Tunnel 7 (wide hall)")).cave().connect(Zg);(new Location$$module$js$nodes(c,133,G,"Tunnel 8 (red slimes)")).cave().from($g,C).connectTo(Qd).chest(ha,23,116);const ah=(new Location$$module$js$nodes(c,134,G,"Tunnel 9 (right branch, infinite loop)")).cave().connect(Rd),bh=(new Location$$module$js$nodes(c,135,G,"Tunnel 10a (toward magic ring)")).cave().connect(ah);(new Location$$module$js$nodes(c,
135,G,"Tunnel 10b (past wall)")).cave().connect(bh,C).connectTo(Vg);const Td=(new Location$$module$js$nodes(c,136,Xa,"Entrance")).fortress().from(Pd,vc,Yb),ch=(new Location$$module$js$nodes(c,137,Xa,"Left branch")).fortress().connect(Td).chest(ha,19,117),dh=(new Location$$module$js$nodes(c,137,Xa,"Left branch, past one bridge")).fortress().connect(ch,A),eh=(new Location$$module$js$nodes(c,137,Xa,"Left branch, past two bridges")).fortress().connect(dh,A).chest(S,29,87),fh=(new Location$$module$js$nodes(c,
137,Xa,"Right branch")).fortress().connect(Td);(new Location$$module$js$nodes(c,137,Xa,"Right branch, across water")).fortress().connect(fh,K).chest(ha,20,118).chest(ha,21,119).chest(ta,28);(new Location$$module$js$nodes(c,138,Xa,"Upper floor")).fortress().connect(eh).chest(O,27);const jb=(new Location$$module$js$nodes(c,140,Pa,"Town")).town().connect(Xg,Re).trigger(Xb),qb=(new Location$$module$js$nodes(c,142,Ya,"Town")).town().connect(Hb),Ud=(new Location$$module$js$nodes(c,143,U,"Draygonia Fortress Basement 1 (front)")).fortress();
(new Location$$module$js$nodes(c,143,U,"Draygonia Fortress Basement 2 (power ring)")).fortress().connect(Ud,ab).chest(fe,15);const ic=(new Location$$module$js$nodes(c,144,Ya,"Desert 1")).overworld().connect(Hb),Ib=(new Location$$module$js$nodes(c,145,U,"Area 1 (from entrance)")).cave().chest(sc,26),Vd=(new Location$$module$js$nodes(c,145,U,"Area 2 (across top bridge)")).cave().connect(Ib,A);(new Location$$module$js$nodes(c,145,U,"Area 3 (dead-end across top-right bridge)")).cave().connect(Vd,A);const gh=
(new Location$$module$js$nodes(c,145,U,"Area 4 (left across middle-right bridge)")).cave().connect(Vd,A),hh=(new Location$$module$js$nodes(c,145,U,"Area 5 (bottom edge)")).cave().connect(gh,A),ih=(new Location$$module$js$nodes(c,145,U,"Area 6 (bottom island)")).cave().connect(hh,A),jh=(new Location$$module$js$nodes(c,145,U,"Area 7 (bottom inner ring)")).cave().connect(ih,A),kh=(new Location$$module$js$nodes(c,145,U,"Area 8 (left outer ring)")).cave().connect(jh,A).connect(Ib,A).chest(fa,27,100),lh=
(new Location$$module$js$nodes(c,145,U,"Area 9 (top left inner ring)")).cave().connect(kh,A),mh=(new Location$$module$js$nodes(c,145,U,"Area 10 (top right inner ring)")).cave().connect(lh,A);(new Location$$module$js$nodes(c,145,U,"Area 11 (center)")).cave().connect(mh,A).connectTo(Ud);(new Location$$module$js$nodes(c,145,U,"Area 12 (top center islands)")).cave().connect(Ib,K).chest(de,28);const nh=(new Location$$module$js$nodes(c,146,ya,"Desert Cave 1")).cave().connect(ic,K),kb=(new Location$$module$js$nodes(c,
147,ya,"Town")).town(),oh=(new Location$$module$js$nodes(c,148,ya,"Outside Cave")).overworld().connect(kb),ph=(new Location$$module$js$nodes(c,149,ya,"Desert Cave 2")).cave().connect(oh);(new Location$$module$js$nodes(c,150,ya,"Meadow")).overworld().connect(nh).connectTo(kb).trigger(Be,Ua,Ze);const jc=(new Location$$module$js$nodes(c,152,ya,"Desert 2")).overworld().connect(ph),qh=(new Location$$module$js$nodes(c,156,fb,"Entrance")).fortress().connect(jc,K),rh=(new Location$$module$js$nodes(c,156,
fb,"Azteca")).fortress().trigger(De),sh=(new Location$$module$js$nodes(c,157,fb,"Fork")).fortress().connect(qh),Wd=(new Location$$module$js$nodes(c,158,fb,"Main")).fortress().connect(sh);(new Location$$module$js$nodes(c,158,fb,"Treasure Chest (magic ring)")).fortress().connect(Wd).chest(ua,27,108);(new Location$$module$js$nodes(c,159,fb,"Draygon")).fortress().connect(Wd).to(rh).boss(jf);const th=(new Location$$module$js$nodes(c,160,Ca,"Entrance")).fortress().connect(jc,K),uh=(new Location$$module$js$nodes(c,
160,Ca,"Statues")).fortress().connect(th).boss(kf),vh=(new Location$$module$js$nodes(c,161,Ca,"Hall 1")).fortress().connect(uh),kc=(new Location$$module$js$nodes(c,162,Ca,"Branch")).fortress().connect(vh);(new Location$$module$js$nodes(c,163,Ca,"Left Dead End")).fortress().connect(kc).chest(ha,13,120);(new Location$$module$js$nodes(c,164,Ca,"Right Dead End")).fortress().connect(kc);const wh=(new Location$$module$js$nodes(c,165,Ca,"Hall 2")).fortress().connect(kc).chest(Mb,26,109),xh=(new Location$$module$js$nodes(c,
166,Ca,"Draygon 2")).fortress().connect(wh).boss(lf);(new Location$$module$js$nodes(c,167,Ca,"Teleporter")).fortress().from(xh).to(Gd);const Xd=(new Location$$module$js$nodes(c,168,zb,"Entrance")).fortress().connect(qb,Yb).trigger($c,O),yh=(new Location$$module$js$nodes(c,169,zb,"Main")).fortress().from(Xd,ab),zh=(new Location$$module$js$nodes(c,169,zb,"Boss")).fortress().connect(yh).boss(ef),Ah=(new Location$$module$js$nodes(c,170,zb,"Zebu")).fortress().connect(zh),Jb=(new Location$$module$js$nodes(c,
171,xa,"Entrance")).fortress().connect(Ah);(new Location$$module$js$nodes(c,171,xa,"Dead End Behind Iron (fruit of power)")).fortress().connect(Jb,ab).chest(fa,28,98);(new Location$$module$js$nodes(c,171,xa,"Dead End Loop Across Closer Bridges")).fortress().connect(Jb,A).connect(Jb,A);const Bh=(new Location$$module$js$nodes(c,171,xa,"Across First Bridge (fruit of repun)")).fortress().connect(Jb,A).chest(Lb,30,102),lc=(new Location$$module$js$nodes(c,171,xa,"Across Second Bridge")).fortress().connect(Bh,
A);(new Location$$module$js$nodes(c,171,xa,"Dead End Across Two Bridges ()")).fortress().connect(lc,A).connect(lc,A).chest($a,29,93);const Ch=(new Location$$module$js$nodes(c,171,xa,"Across Third Bridge")).fortress().connect(lc,A),Dh=(new Location$$module$js$nodes(c,171,xa,"Exit Behind Iron Door")).fortress().connect(Ch,ab),Eh=(new Location$$module$js$nodes(c,172,xa,"Boss")).fortress().connect(Dh).boss(ff),Fh=(new Location$$module$js$nodes(c,172,xa,"Tornel")).fortress().connect(Eh),Yd=(new Location$$module$js$nodes(c,
173,eb,"Lower")).fortress().connect(Fh).chest(Mb,26,99).chest(ua,27,111),Gh=(new Location$$module$js$nodes(c,174,eb,"Upper Loop")).fortress().connect(Yd).chest(da,22,96);(new Location$$module$js$nodes(c,174,eb,"Upper Loop Behind Wall (magic ring)")).fortress().connect(Gh,ab).chest(ua,23,107);const Hh=(new Location$$module$js$nodes(c,175,eb,"Upper Passage (toward Mado)")).fortress().connect(Yd).chest(ua,27,84),mc=(new Location$$module$js$nodes(c,176,ia,"Initial Fork")).fortress(),Ih=(new Location$$module$js$nodes(c,
177,ia,"Left Branch")).fortress().connect(mc),Zd=(new Location$$module$js$nodes(c,178,ia,"Main Area (right branch, over bridges)")).fortress().connect(mc),Jh=(new Location$$module$js$nodes(c,179,ia,"U-shaped Passage (between floors)")).fortress().connect(Zd),Kh=(new Location$$module$js$nodes(c,180,ia,"Main Area Lower (under bridge)")).fortress().connect(Ih).connect(Zd).connect(Jh),$d=(new Location$$module$js$nodes(c,180,ia,"Behind Iron Wall")).fortress().connect(Kh,ab),Lh=(new Location$$module$js$nodes(c,
181,ia,"Lower")).fortress().connect($d).chest(ha,13,121).chest(ha,14,122).chest(ha,15,123).chest(ua,23,88).chest(la,24,110),Mh=(new Location$$module$js$nodes(c,182,ia,"Boss Corridor")).fortress().connect(Lh),Nh=(new Location$$module$js$nodes(c,182,ia,"Boss")).fortress().connect(Mh,Yb).boss(hf);(new Location$$module$js$nodes(c,182,ia,"Behind Boss (stormBracelet)")).fortress().connect(Nh).chest(Ga,18);const ae=(new Location$$module$js$nodes(c,183,ia,"Exit Stairs")).fortress(),Oh=(new Location$$module$js$nodes(c,
184,U,"Entrance Back (behind river)")).cave().connect(ae).chest(fa,13,90);(new Location$$module$js$nodes(c,184,U,"Entrance Front")).cave().connect(Oh,K).connectTo(ic).connectTo(Ib);const Ph=(new Location$$module$js$nodes(c,185,eb,"Boss")).fortress().connect(Hh).boss(gf);(new Location$$module$js$nodes(c,185,eb,"Asina")).fortress().connect(Ph).connectTo(mc);(new Location$$module$js$nodes(c,186,ia,"Kensu")).fortress().connect($d).connectTo(ae).trigger(Ae,Sb);(new Location$$module$js$nodes(c,187,Ya,"House")).house().connect(qb).trigger(Ce,
Ua,Sb);(new Location$$module$js$nodes(c,188,Ya,"Inn")).shop().connect(qb,Xb);(new Location$$module$js$nodes(c,190,Ya,"Tool Shop")).shop(S,da,la,fa).connect(qb,Xb);(new Location$$module$js$nodes(c,191,Ya,"Tavern")).shop().connect(qb);(new Location$$module$js$nodes(c,192,va,"Elder House")).house().connect(Qa).trigger(Hc);(new Location$$module$js$nodes(c,193,va,"Rabbit Hut")).house().connect(Qa).trigger(Nc,Mc,Ja);(new Location$$module$js$nodes(c,194,va,"Inn")).shop().connect(Qa);(new Location$$module$js$nodes(c,
195,va,"Tool Shop")).shop(S,da,la,fa).connect(Qa);(new Location$$module$js$nodes(c,196,va,"Armor Shop")).shop(Ta,Sa).connect(Qa);(new Location$$module$js$nodes(c,197,va,"Student House")).house().connect(Qa).trigger(Ic);(new Location$$module$js$nodes(c,198,cb,"Tavern")).house().connect(pb);(new Location$$module$js$nodes(c,199,cb,"Pawn Shop")).shop().connect(pb);(new Location$$module$js$nodes(c,200,cb,"Inn")).shop().connect(pb);(new Location$$module$js$nodes(c,201,cb,"Armor Shop")).shop(Ia,Sa,Ha).connect(pb);
(new Location$$module$js$nodes(c,203,cb,"Tool Shop")).shop(S,da,la).connect(pb);(new Location$$module$js$nodes(c,205,nb,"Elder House")).house().from(Bb,Ja).trigger(pe,Ub);(new Location$$module$js$nodes(c,206,nb,"Mother's House")).house().from(Bb,Ja).trigger(Lc,Ja).trigger(oe,Ub);(new Location$$module$js$nodes(c,207,nb,"Tool Shop")).shop(S,da,fa).from(Bb,Ja);(new Location$$module$js$nodes(c,208,nb,"Inn")).shop().from(Bb,Ja);(new Location$$module$js$nodes(c,209,db,"Inn")).shop().connect(Ab);(new Location$$module$js$nodes(c,
210,db,"Tool Shop")).shop(la,fa,$a).connect(Ab);(new Location$$module$js$nodes(c,211,db,"Armor Shop")).shop(oc,u,rb,Z).connect(Ab);const Qh=(new Location$$module$js$nodes(c,212,db,"Queen's House")).house().from(Ab,Se).trigger(ye,Ua,Bc);(new Location$$module$js$nodes(c,213,yb,"Nadare's")).house().connect(Cb).connectTo(Yf).connectTo(Zf).connectTo($f);(new Location$$module$js$nodes(c,214,I,"Fisherman's House")).house().connect(Ed).trigger(Vb,wc,Rb,Te);const nc=(new Location$$module$js$nodes(c,215,I,
"Palace Entrance")).house().connect(Za);(new Location$$module$js$nodes(c,216,I,"Fortune Teller Front")).house().connect(Za).trigger(Pc,Oc);(new Location$$module$js$nodes(c,216,I,"Fortune Teller Back")).house().connect(Eg).connect(Jd);(new Location$$module$js$nodes(c,217,I,"Pawn Shop")).shop().connect(Za);(new Location$$module$js$nodes(c,218,I,"Armor Shop")).shop(be,oc,u).connect(Za);(new Location$$module$js$nodes(c,220,I,"Inn")).shop().connect(Za);(new Location$$module$js$nodes(c,221,I,"Tool Shop")).shop(S,
$a,Kb,la).connect(Za);(new Location$$module$js$nodes(c,222,I,"Palace Left")).house().connect(nc);(new Location$$module$js$nodes(c,223,I,"Palace Throne Room")).house().connect(nc).to(Fb,Me).from(Fb).trigger(Oc).trigger(se,Pc,Qc);(new Location$$module$js$nodes(c,224,I,"Palace Right")).house().connect(nc);(new Location$$module$js$nodes(c,225,I,"Asina's Room")).house().connect(Kd).trigger(Tc,cd);(new Location$$module$js$nodes(c,226,db,"Queen Downstairs")).house().connect(Qh).chest(sa,13);(new Location$$module$js$nodes(c,
227,Na,"Elder's House")).house().connect(Gb).trigger(Wc);(new Location$$module$js$nodes(c,228,Na,"Shed")).house().connect(Gb).to(Pg,xc);(new Location$$module$js$nodes(c,229,Na,"Tool Shop")).shop(S,da,fa,$a).connect(Gb);(new Location$$module$js$nodes(c,231,Na,"Inn")).shop().connect(Gb);const Rh=(new Location$$module$js$nodes(c,232,aa,"Zombie Town House")).house().connect(fc);(new Location$$module$js$nodes(c,233,aa,"Zombie Town Basement")).house().connect(Rh).trigger(ue,kd);(new Location$$module$js$nodes(c,
235,wa,"Tool Shop")).shop(S,da,fa,la).connect(Ea);(new Location$$module$js$nodes(c,236,wa,"Stom's Hut")).house().connect(Ea).trigger(Xc);(new Location$$module$js$nodes(c,237,wa,"Inn")).shop().connect(Ea);(new Location$$module$js$nodes(c,238,wa,"Armor Shop")).shop(ce,pc,F,R).connect(Ea);(new Location$$module$js$nodes(c,239,wa,"Tavern")).house().connect(Ea).trigger(Yc,Xc,lb);(new Location$$module$js$nodes(c,240,wa,"Pawn Shop")).shop().connect(Ea);(new Location$$module$js$nodes(c,241,wa,"Dance Hall")).house().connect(Ea).trigger(Zc,
Yc,lb).trigger(xe,Zc,Ac);const Sh=(new Location$$module$js$nodes(c,242,Pa,"Temple (pre-massacre)")).fortress().connect(jb).from(Zb,O,ba).trigger(ze);(new Location$$module$js$nodes(c,242,Pa,"Temple (post-massacre)")).fortress().from(Sh,$c).boss(df);(new Location$$module$js$nodes(c,243,Pa,"Training Hall")).house().connect(jb);(new Location$$module$js$nodes(c,244,Pa,"Hospital")).house().connect(jb);(new Location$$module$js$nodes(c,245,Pa,"Armor Shop")).shop(pc,Z,R).connect(jb);(new Location$$module$js$nodes(c,
246,Pa,"Tool Shop")).shop(S,da,Kb,ua).connect(jb);(new Location$$module$js$nodes(c,247,Pa,"Inn")).shop().connect(jb);(new Location$$module$js$nodes(c,248,ya,"Inn")).shop().connect(kb);(new Location$$module$js$nodes(c,249,ya,"Tool Shop")).shop(da,la,Lb,ua).connect(kb);(new Location$$module$js$nodes(c,250,ya,"Elder's House")).house().connect(kb);(new Location$$module$js$nodes(c,251,ya,"Pawn Shop")).house().connect(kb);const Th=[Qa,ob,md,gb,$b,hb,cc,yd,ec,Ea,Hb,hc,ic,Xd,jc];for(const a of Th)a.from(Zb,
He);return c};var module$js$depgraph={};module$js$depgraph.generate=generate$$module$js$depgraph;class FetchReader$$module$js$fetchreader{constructor(a){this.path=void 0===a?"js/":a}read(a){const b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){return a in STATIC$$module$js$fetchreader?STATIC$$module$js$fetchreader[a]:yield(yield fetch(b.path+a)).text()})}}const STATIC$$module$js$fetchreader={};var module$js$fetchreader={};module$js$fetchreader.FetchReader=FetchReader$$module$js$fetchreader;var Dir$$module$js$logic$dir;(function(a){a.name=function(a){switch(a){case 0:return"N";case 1:return"W";case 2:return"S";case 3:return"E"}throw Error(`Bad direction: ${a}`);};a.all=function(){return[0,1,2,3]};a.North=0;a.West=1;a.South=2;a.East=3})(Dir$$module$js$logic$dir||(Dir$$module$js$logic$dir={}));var module$js$logic$dir={};module$js$logic$dir.Dir=Dir$$module$js$logic$dir;class Graph$$module$js$logic$graph{constructor(a){var b;this.worlds=a;var c=new Set,d=new Set,e=new Map,f=new Map;for(var g=0;g<a.length;g++){const b=a[g],h=g<<24;for(const a of b.requirements){const [b,e]=a;c.add(h|b);for(const a of e)for(const b of a)d.add(h|b)}for(const a of b.items){const [b,c]=a;f.set(h|b,c)}for(const a of b.slots){const [b,c]=a;e.set(h|b,c)}}this.itemInfos=new Map(f);this.slotInfos=new Map(e);this.progression=new Set(d);for(const a of f.keys())d.add(a);e=new Set;f=new Set;g=
new Set;for(var h of d)(c.has(h)?e:g).add(h);for(var k of c)d.has(k)||f.add(k);this.common=e.size;this.slots=new ArrayMap$$module$js$util([...e,...f]);this.items=new ArrayMap$$module$js$util([...e,...g]);c=[];d=[];for(h=0;h<a.length;h++){const b=h<<24;for(var m of a[h].requirements){const [a,f]=m;k=this.slots.index(b|a);if(null==k)throw Error(`Provided a non-slot? ${hex$$module$js$rom$util(a)}`);for(var l of f){e=[...l].map((a)=>{var c;return null!==(c=this.items.index(b|a))&&void 0!==c?c:die$$module$js$assert()});
(c[k]||(c[k]=[])).push(Bits$$module$js$bits.from(e));for(const a of e)(d[a]||(d[a]=new Set)).add(k)}}}for(a=0;a<this.slots.length;a++)c[a]&&c[a].length||(m=null!==(b=this.slots.get(a))&&void 0!==b?b:NaN,l=this.checkName(m),console.error(`Nothing provided $${hex$$module$js$rom$util(m)}: ${l} (index ${a})`));this.graph=new Keyed$$module$js$util(c);this.unlocks=new Keyed$$module$js$util(d.map(spread$$module$js$util))}shuffle(a,b,c,d,e){c=void 0===c?20:c;const f=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){d&&
...
k);var m=this.expandReachable(this.traverse((b)=>a.get(b),c),e);d.shuffle(m);let n=!1;const p=new Set(a.keys());for(const b of m){if(p.has(b))continue;p.add(b);const c=this.slotInfoFromIndex(b);if(c&&this.fits(c,l,e)){a.set(b,k);n=!0;break}}if(!n){p.clear();if(0<f--){for(const f of m)if(!p.has(f)&&a.has(f)&&!h.has(f)&&(p.add(f),(m=this.slotInfoFromIndex(f))&&this.fits(m,l,e))){k=null!==(g=a.replace(f,k))&&void 0!==g?g:die$$module$js$assert();c=Bits$$module$js$bits.with(c,k);b.push(k);d.shuffle(b);
...
console.error(`REROLL: Could not place item ${c(g)}`),null}return new Map(a)}traverse(a,b,c){b=Bits$$module$js$bits.clone(b);const d=new Set,e=new Set;for(var f=0;f<this.slots.length;f++){if(null==this.graph.get(f))throw console.dir(this),a=this.slots.get(f),Error(`Unreachable slot ${null===a||void 0===a?void 0:a.toString(16)}`);e.add(f)}for(const g of e)if(e.delete(g),!d.has(g)){f=this.graph.get(g);if(null==f)throw Error(`Not in graph: ${g}`);for(let h=0,k=f.length;h<k;h++){if(!Bits$$module$js$bits.containsAll(b,
f[h]))continue;c&&c.push([g,...Bits$$module$js$bits.bits(f[h])]);d.add(g);f=[];g<this.common&&f.push(g);const k=a(g);null!=k&&f.push(k);for(const a of f){b=Bits$$module$js$bits.with(b,a);for(const b of this.unlocks.get(a)||[]){if(null==this.graph.get(b))throw console.dir(this),Error(`Adding bad node ${b} from unlock ${a}`);e.add(b)}}break}}return d}expandFill(a,b){for(const c of a){const [d,e]=c;{a=this.slots.get(d);const c=this.items.get(e);if(null==a||null==c)throw Error("missing");b.replace(a,
c)}}}compressFill(a){const b=new MutableArrayBiMap$$module$js$util;for(const c of a){const [d,e]=c;{a=this.slots.index(d);const c=this.items.index(e);if(null==a||null==c)throw Error(`Bad slot/item: ${d} ${a} ${e} ${c}`);b.set(a,c)}}return b}checkName(a){return this.worlds[a>>>24].checkName(a&16777215)}prefill(a,b){for(let c=0;c<this.worlds.length;c++){const d=c<<24,e=this.worlds[c].prefill(b);for(const b of e){const [c,e]=b;a.set(d|c,d|e)}}}itemInfoFromIndex(a){const b=this.items.get(a);if(null==
b)throw Error(`Bad item: ${a}`);return this.itemInfoFromId(b)}itemInfoFromId(a){const b=this.itemInfos.get(a);if(null==b)throw Error(`Missing info: ${hex$$module$js$rom$util(a)}`);return b}slotInfoFromIndex(a){const b=this.slots.get(a);if(null==b)throw Error(`Bad slot: ${a}`);return this.slotInfoFromId(b)}slotInfoFromId(a){a=this.slotInfos.get(a);if(null!=a)return a}}function addCopies$$module$js$logic$graph(a,b,c){for(let d=0;d<c;d++)a.push(b)}var module$js$logic$graph={};
module$js$logic$graph.Graph=Graph$$module$js$logic$graph;function TileId$$module$js$logic$tileid(a){return a}
...
b){return a.label?a.label(b):"Terrain"}}var Terrain$$module$js$logic$terrain;(function(a){a.FLY=2;a.BLOCKED=4;a.SLOPE=32;a.BITS=38;a.SWAMP=256;a.BARRIER=512;a.SLOPE8=1024;a.SLOPE9=2048;a.DOLPHIN=4096;a.label=function(a,c){var b,e;return null!==(e=null===(b=a.label)||void 0===b?void 0:b.call(a,c))&&void 0!==e?e:"Terrain"}})(Terrain$$module$js$logic$terrain||(Terrain$$module$js$logic$terrain={}));
...
"fe","ff");k.reloc("ShopData");m("ShopData");m("ArmorShopIdTable");for(const b of this.armorShops())for(var l=0;4>l;l++)k.byte(null!==(a=b.contents[l])&&void 0!==a?a:255);m("ToolShopIdTable");for(const a of this.toolShops())for(l=0;4>l;l++)k.byte(null!==(b=a.contents[l])&&void 0!==b?b:255);m("ArmorShopPriceTable");for(const a of this.armorShops())for(l=0;4>l;l++)k.byte(Math.round(32*(null!==(c=a.prices[l])&&void 0!==c?c:0)));m("ToolShopPriceTable");for(const a of this.toolShops())for(c=0;4>c;c++)k.byte(Math.round(32*
(null!==(d=a.prices[c])&&void 0!==d?d:0)));m("InnPrices");for(const a of this.inns())k.byte(Math.round(32*(null!==(e=a.prices[0])&&void 0!==e?e:0)));m("ShopLocations");for(const a of this)k.byte(a.location);m("ToolShopScaling");k.byte(...this.toolShopScaling);m("ArmorShopScaling");k.byte(...this.armorShopScaling);m("BasePrices");k.word(...this.basePrices.slice(13,39).map((a)=>null!==a&&void 0!==a?a:0));m("InnBasePrice");k.word(this.innBasePrice)}else{k.segment("10","fe","ff");k.org(40356,"ShopData");
for(const a of this.armorShops())for(d=0;4>d;d++)k.byte(null!==(f=a.contents[d])&&void 0!==f?f:255);for(const a of this.armorShops())for(d=0;4>d;d++)k.word(null!==(g=a.prices[d])&&void 0!==g?g:0);for(const a of this.toolShops())for(d=0;4>d;d++)k.byte(null!==(h=a.contents[d])&&void 0!==h?h:255);for(l of this.toolShops())for(d=0;4>d;d++)k.word(null!==(m=l.prices[d])&&void 0!==m?m:0)}return[k.module()]}}var ShopType$$module$js$rom$shop;
...
Oak:c,Shyron_ToolShop:d},flags:{AbleToRideDolphin:e,BallOfFire:f,BallOfThunder:g,BallOfWater:h,BallOfWind:k,Barrier:m,BlizzardBracelet:l,BowOfMoon:n,BowOfSun:p,BreakStone:r,BreakIce:q,BreakIron:w,BrokenStatue:x,BuyHealing:y,BuyWarp:z,ClimbWaterfall:E,ClimbSlope8:v,ClimbSlope9:t,CurrentlyRidingDolphin:V,Flight:H,FlameBracelet:W,FormBridge:ja,GasMask:X,GlowingLamp:ba,InjuredDolphin:Y,LeadingChild:Fa,LeatherBoots:za,Money:T,OpenedCrypt:Ra,RabbitBoots:P,Refresh:Q,RepairedStatue:J,RescuedChild:N,ShellFlute:O,
ShieldRing:pa,ShootingStatue:ea,StormBracelet:Aa,Sword:ca,SwordOfFire:qa,SwordOfThunder:ra,SwordOfWater:sa,SwordOfWind:ka,TornadoBracelet:Ga,TravelSwamp:Sa,WildWarp:Ha},items:{MedicalHerb:u,WarpBoots:rb}}=this.rom,F=this.entrance(b);var Z=this.entrance(c);this.addCheck([F],and$$module$js$logic$world(n,p),[Ra.id]);this.addCheck([F],and$$module$js$logic$world(e,O),[V.id]);this.addCheck([Z],and$$module$js$logic$world(Fa),[N.id]);this.addItemCheck([F],and$$module$js$logic$world(ba,x),J.id,{lossy:!0,unique:!0});
for(var R of this.rom.shops)if(R.location!==a.id&&R.location!==d.id&&R.used&&R.type===module$js$rom$shop.ShopType.TOOL){Z=[module$js$logic$tileid.TileId(R.location<<16|136)];for(var ta of R.contents)ta===u.id?this.addCheck(Z,T.r,[y.id]):ta===rb.id&&this.addCheck(Z,T.r,[z.id])}R=ka.r;ta=qa.r;Z=sa.r;let Ta=ra.r;if(!this.flagset.orbsOptional()){var Ia=or$$module$js$logic$world(k,Ga);const a=or$$module$js$logic$world(f,W),b=or$$module$js$logic$world(h,l),c=or$$module$js$logic$world(g,Aa);R=module$js$logic$requirement.Requirement.meet(R,
Ia);ta=module$js$logic$requirement.Requirement.meet(ta,a);Z=module$js$logic$requirement.Requirement.meet(Z,b);Ta=module$js$logic$requirement.Requirement.meet(Ta,c);if(this.flagset.assumeSwordChargeGlitch()){Ia=function(b){return a.map((a)=>a[0]===b.c?a:[b.c,...a])};const a=module$js$logic$requirement.Requirement.or(R,ta,Z,Ta);R=Ia(ka);ta=Ia(qa);Z=Ia(sa);Ta=Ia(ra)}}this.addCheck([F],R,[r.id]);this.addCheck([F],ta,[q.id]);this.addCheck([F],Z,[ja.id]);this.addCheck([F],Ta,[w.id]);this.addCheck([F],or$$module$js$logic$world(ka,
qa,sa,ra),[ca.id,T.id]);this.addCheck([F],H.r,[E.id]);this.addCheck([F],or$$module$js$logic$world(H,P),[v.id]);this.addCheck([F],or$$module$js$logic$world(H,P),[t.id]);this.addCheck([F],m.r,[ea.id]);this.addCheck([F],X.r,[Sa.id]);this.flagset.leatherBootsGiveSpeed()&&this.addCheck([F],za.r,[v.id]);this.flagset.assumeGhettoFlight()&&this.addCheck([F],and$$module$js$logic$world(V,P),[E.id]);this.flagset.fogLampNotRequired()&&(R=this.flagset.requireHealedDolphinToRide(),this.addCheck([F],R?Y.r:[[]],
[e.id]));this.flagset.guaranteeBarrier()||this.addCheck([F],[[T.c,y.c],[T.c,pa.c],[T.c,Q.c]],[ea.id]);this.flagset.assumeFlightStatueSkip()||this.addCheck([F],[[T.c,H.c]],[ea.id]);this.flagset.guaranteeGasMask()||this.addCheck([F],[[T.c,y.c],[T.c,Q.c]],[Sa.id]);this.flagset.assumeWildWarp()&&this.addCheck([F],module$js$logic$requirement.Requirement.OPEN,[Ha.id])}addExtraRoutes(){var a;const {flags:{BuyWarp:b,SwordOfThunder:c,Teleport:d,WildWarp:e},locations:{MezameShrine:f}}=this.rom;this.addRoute(new Route$$module$js$logic$requirement(this.entrance(f),
...
this.neighbors.get(b)|1<<c));this.seamlessExits.has(a)||(a=c^2,d=module$js$logic$tilepair.TilePair.of(d,e),this.neighbors.set(d,this.neighbors.get(d)|1<<a))}processLocationTiles(a){var b,c,d,e=new Map;const f=new Set,g=88===(a.id&248);for(var h of a.spawns)h.isWall()?e.set(module$js$logic$screenid.ScreenId.from(a,h),h.id&3):h.isMonster()&&63===h.id&&f.add(module$js$logic$screenid.ScreenId.from(a,h));h=this.rom.tilesets[a.tileset];const k=this.rom.tileEffects[a.tileEffects-179],m=(b)=>k.effects[this.rom.screens[a.screens[(b&
61440)>>>12][(b&3840)>>>8]].tiles[b&255]],l=(b,c,d)=>{b&=module$js$logic$terrain.Terrain.BITS;26===a.id&&(b|=module$js$logic$terrain.Terrain.SWAMP);if(96===a.id||104===a.id)b|=module$js$logic$terrain.Terrain.DOLPHIN;100===a.id&&4144>(c&61680)&&(b|=module$js$logic$terrain.Terrain.DOLPHIN);d&&(b|=module$js$logic$terrain.Terrain.BARRIER);if(!(b&module$js$logic$terrain.Terrain.DOLPHIN)&&b&module$js$logic$terrain.Terrain.SLOPE){for(d=0;m(c)&module$js$logic$terrain.Terrain.SLOPE;)c=module$js$logic$tileid.TileId.add(c,
1,0),d++;6>d?b&=~module$js$logic$terrain.Terrain.SLOPE:9>d?b|=module$js$logic$terrain.Terrain.SLOPE8:10>d&&(b|=module$js$logic$terrain.Terrain.SLOPE9)}return this.terrainFactory.tile(b)};for(let m=0,w=a.height;m<w;m++){const q=a.screens[m],w=a.id<<8|m<<4;for(let m=0,x=a.width;m<x;m++){const x=this.rom.screens[q[m]],y=module$js$logic$screenid.ScreenId(w|m),E=f.has(y),z=y&255;var n=e.get(y);n=g?this.rom.flags.AlwaysTrue.id:null!=n?this.wallCapability(n):null===(b=a.flags.find((a)=>a.screen===z))||void 0===
b?void 0:b.flag;const W=null!==(d=null===(c=this.rom.flags[n])||void 0===c?void 0:c.logic)&&void 0!==d?d:{};for(let b=0;240>b;b++){const c=module$js$logic$tileid.TileId(y<<8|b);var p=x.tiles[b];W.assumeTrue&&32>p&&(p=h.alternates[p]);var r=a.isShop()?0:k.effects[p]&38;r=l(r,c,E);32>p&&h.alternates[p]!==p&&null!=n&&!W.assumeTrue&&!W.assumeFalse&&(p=l(k.effects[h.alternates[p]],c,E))&&(r=this.terrainFactory.flag(r,W.track?n:-1,p));r&&this.terrains.set(c,r)}}}for(const f of a.exits){const {dest:g,entrance:h}=
f;b=module$js$logic$tileid.TileId.from(a,f);f.isSeamless()?(c=module$js$logic$tileid.TileId(b&65535|g<<16),d=module$js$logic$tileid.TileId.from(a,f),this.seamlessExits.add(d),(e=this.terrains.get(d))&&this.terrains.set(d,this.terrainFactory.seamless(e))):c=this.entrance(this.rom.locations[g],h&31);this.exits.set(b,c)}}processLocationSpawns(a){for(const b of a.spawns)b.isTrigger()?this.processTrigger(a,b):b.isNpc()?this.processNpc(a,b):b.isBoss()?this.processBoss(a,b):b.isChest()?this.processChest(a,
b):b.isMonster()?this.processMonster(a,b):3===b.type&&224===b.id&&this.processKeyUse(module$js$logic$hitbox.Hitbox.screen(module$js$logic$tileid.TileId.from(a,b)),this.rom.flags.UsedWindmillKey.r)}processTrigger(a,b){var c=this.rom.trigger(b.id);if(!c)throw Error(`Missing trigger ${b.id.toString(16)}`);const d=this.filterRequirements(c.conditions);let e=this.filterAntiRequirements(c.conditions);const f=module$js$logic$tileid.TileId.from(a,b);let g=module$js$logic$hitbox.Hitbox.trigger(a,b);const h=
[];for(const a of c.flags){const b=this.flag(a);(null===b||void 0===b?0:b.logic.track)&&h.push(b.id)}h.length&&this.addCheck(g,d,h);switch(c.message.action){case 25:134!==c.id||this.flagset.assumeRabbitSkip()?186!==c.id||this.flagset.assumeTeleportSkip()||this.flagset.disableTeleportSkip()||(g=module$js$logic$hitbox.Hitbox.atLocation(g,this.rom.locations.CordelPlainEast,this.rom.locations.CordelPlainWest)):g=module$js$logic$hitbox.Hitbox.adjust(g,[0,-1],[0,1]);this.addTerrain(g,this.terrainFactory.statue(e));
break;case 29:this.addBossCheck(g,this.rom.bosses.Mado1,d);break;case 8:case 11:case 12:case 13:case 15:this.addItemGrantChecks(g,d,c.id);break;case 24:c=this.flagset.chargeShotsOnly()?module$js$logic$requirement.Requirement.meet(d,and$$module$js$logic$world(this.rom.flags.WarpBoots)):d;this.addItemCheck(g,c,this.rom.flags.StomFightReward.id,{lossy:!0,unique:!0});break;case 30:this.addItemCheck(g,d,this.rom.flags.MesiaInTower.id,{lossy:!0,unique:!0});break;case 31:this.handleBoat(f,a,d);break;case 27:a===
this.rom.locations.Portoa_PalaceEntrance&&(g=module$js$logic$hitbox.Hitbox.adjust(g,[-2,0]),e=this.rom.flags.TalkedToFortuneTeller.r),this.handleMovingGuard(g,a,e)}for(const [c,d]of this.itemUses.get(b.type<<8|b.id))this.processItemUse([module$js$logic$tileid.TileId.from(a,b)],module$js$logic$requirement.Requirement.OPEN,c,d)}processNpc(a,b){var c,d,e;const f=this.rom.npcs[b.id];if(!f||!f.used)throw Error(`Unknown npc: ${hex$$module$js$rom$util(b.id)}`);const g=f.spawnConditions.get(a.id)||[];var h=
this.filterRequirements(g),k=module$js$logic$tileid.TileId.from(a,b);k=[this.terrains.has(k)?k:null!==(c=this.walkableNeighbor(k))&&void 0!==c?c:k];for(const [a,c]of this.itemUses.get(b.type<<8|b.id))this.processItemUse(k,h,a,c);f===this.rom.npcs.SaberaDisguisedAsMesia&&this.addBossCheck(k,this.rom.bosses.Sabera1,h);f.data[2]&4&&!this.flagset.assumeStatueGlitch()&&(b=this.filterAntiRequirements(g),f===this.rom.npcs.Rage?(k=module$js$logic$hitbox.Hitbox.adjust(k,[2,-1],[2,0],[2,1],[2,2]),k=module$js$logic$hitbox.Hitbox.adjust(k,
[0,-6],[0,-2],[0,2],[0,6]),this.flagset.assumeRageSkip()&&(b=void 0)):f===this.rom.npcs.PortoaThroneRoomBackDoorGuard&&(b=or$$module$js$logic$world(this.rom.flags.MesiaRecording,this.rom.flags.Paralysis)),b&&this.addTerrain(k,this.terrainFactory.statue(b)));f===this.rom.npcs.FortuneTeller&&(k=module$js$logic$hitbox.Hitbox.adjust(k,[0,0],[2,0]));if(!module$js$logic$requirement.Requirement.isClosed(h)){[[...h]]=h;for(const a of f.globalDialogs)b=this.flag(~a.condition),null!==b&&void 0!==b&&b.logic.track&&
h.push(b.id);a=null!==(e=null!==(d=f.localDialogs.get(a.id))&&void 0!==d?d:f.localDialogs.get(-1))&&void 0!==e?e:[];for(const b of a)d=[...h],e=this.flag(b.condition),(null===e||void 0===e?0:e.logic.track)&&d.push(e.id),this.processDialog(k,f,d,b),d=this.flag(~b.condition),(null===d||void 0===d?0:d.logic.track)&&h.push(d.id)}}processDialog(a,b,c,d){this.addCheckFromFlags(a,[c],d.flags);const e={lossy:!0,unique:!0};switch(d.message.action){case 8:this.processKeyUse(a,[c]);break;case 20:this.addItemCheck(a,
[c],this.rom.flags.SlimedKensu.id,e);break;case 16:this.addItemCheck(a,[c],this.rom.flags.AsinaInBackRoom.id,e);break;case 17:this.addItemCheck(a,[c],256|b.data[1],e);break;case 3:case 10:this.addItemCheck(a,[c],256|b.data[0],e);break;case 9:b=b.data[1];255!==b&&this.addItemCheck(a,[c],256|b,e);break;case 25:this.addItemCheck(a,[c],this.rom.flags.AkahanaFluteOfLimeTradein.id,e);break;case 26:this.addItemCheck(a,[c],this.rom.flags.Rage.id,e)}}processLocationItemUses(a){for(const [b,c]of this.itemUses.get(~a.id))this.processItemUse([this.entrance(a)],
module$js$logic$requirement.Requirement.OPEN,b,c)}handleMovingGuard(a,b,c){if(!this.flagset.assumeStatueGlitch()){var d=[];for(const a of b.spawns.slice(0,2))if(a.isNpc()&&this.rom.npcs[a.id].isParalyzable()){d.push([this.rom.flags.Paralysis.id]);break}this.addTerrain(a,this.terrainFactory.statue([...c,...d].map(spread$$module$js$util)))}}handleBoat(a,b,c){const d=this.walkableNeighbor(a);if(null==d)throw Error("Could not find walkable neighbor.");var e=a>>8&240|a>>4&15;a=a>>4&240|a&15;var f;for(const c of b.exits)c.yt===
e&&c.xt<a&&(f=c);if(!f)throw Error("Could not find boat exit");b=this.rom.locations[f.dest];if(!b)throw Error("Bad destination");for(e=f=module$js$logic$tileid.TileId.from(b,b.entrances[f.entrance]);;)if(e=module$js$logic$tileid.TileId.add(e,0,-1),b=this.walkableNeighbor(e),null!=b){c={enter:module$js$logic$requirement.Requirement.freeze(c),exit:[[15,module$js$logic$requirement.Requirement.OPEN]]};this.addTerrain([d],c);this.exits.set(d,b);this.exitSet.add(module$js$logic$tilepair.TilePair.of(d,b));
this.exits.set(f,b);this.exitSet.add(module$js$logic$tilepair.TilePair.of(f,b));this.terrains.set(f,this.terrainFactory.tile(0));break}}addItemGrantChecks(a,b,c){const d=this.itemGrant(c),e=256|d;if(null==d)throw Error(`missing item grant for ${c.toString(16)}`);this.addItemCheck(a,b,e,{lossy:!0,unique:!0,preventLoss:128<=c})}addTerrain(a,b){for(const c of a)a=this.terrains.get(c),null!=a&&this.terrains.set(c,this.terrainFactory.meet(a,b))}addCheck(a,b,c){if(!module$js$logic$requirement.Requirement.isClosed(b)){b=
{requirement:module$js$logic$requirement.Requirement.freeze(b),checks:c};for(const c of a)this.terrains.has(c)&&this.checks.get(c).add(b)}}addItemCheck(a,b,c,d){this.addCheck(a,b,[c]);this.slots.set(c,d);a=this.rom.itemGets[this.rom.slots[c&255]];b=this.rom.items[a.itemId];c=null===b||void 0===b?void 0:b.unique;d=a.isLosable();const e=c||b===this.rom.items.OpelStatue;let f=1;b===this.rom.items.SwordOfWind&&(f=5);b===this.rom.items.SwordOfFire&&(f=5);b===this.rom.items.SwordOfWater&&(f=10);b===this.rom.items.SwordOfThunder&&
(f=15);b===this.rom.items.Flight&&(f=15);this.items.set(512|a.id,{unique:c,losable:d,preventLoss:e,weight:f})}addCheckFromFlags(a,b,c){const d=[];for(const a of c)c=this.flag(a),(null===c||void 0===c?0:c.logic.track)&&d.push(c.id);d.length&&this.addCheck(a,b,d)}walkableNeighbor(a){if(this.isWalkable(a))return a;for(let b of[-1,1]){const c=module$js$logic$tileid.TileId.add(a,b,0),d=module$js$logic$tileid.TileId.add(a,0,b);if(this.isWalkable(c))return c;if(this.isWalkable(d))return d}}isWalkable(a){return!(this.getEffects(a)&
module$js$logic$terrain.Terrain.BITS)}ensurePassable(a){var b;return this.isWalkable(a)?a:null!==(b=this.walkableNeighbor(a))&&void 0!==b?b:a}getEffects(a){const b=this.rom.locations[a>>>16];return this.rom.tileEffects[b.tileEffects-179].effects[this.rom.screens[b.screens[(a&61440)>>>12][(a&3840)>>>8]].tiles[a&255]]}processBoss(a,b){if(201!==b.id&&202!==b.id){var c=195===b.id?this.rom.bosses.Rage:this.rom.bosses.fromLocation(a.id);b=module$js$logic$tileid.TileId.from(a,b);if(!c||!c.flag)throw Error(`Bad boss at ${a.name}`);
var d=b&-256;a=this.terrainFactory.boss(c.flag.id);b=seq$$module$js$rom$util(240,(a)=>d|a);this.addTerrain(b,a);this.addBossCheck(b,c)}}addBossCheck(a,b,c=module$js$logic$requirement.Requirement.OPEN){if(null==b.flag)throw Error(`Expected a flag: ${b}`);c=module$js$logic$requirement.Requirement.meet(c,this.bossRequirements(b));b===this.rom.bosses.Draygon2?this.addCheck(a,c,[b.flag.id]):this.addItemCheck(a,c,b.flag.id,{lossy:!1,unique:!0})}processChest(a,b){if(!(112<=this.rom.slots[b.id])){var c=256|
...
c.restrict([d]);return module$js$logic$requirement.Requirement.freeze(c)}swordRequirement(a,b){const c=[this.rom.flags.SwordOfWind,this.rom.flags.SwordOfFire,this.rom.flags.SwordOfWater,this.rom.flags.SwordOfThunder][a];if(1===b)return c.r;a=[[this.rom.flags.BallOfWind,this.rom.flags.TornadoBracelet],[this.rom.flags.BallOfFire,this.rom.flags.FlameBracelet],[this.rom.flags.BallOfWater,this.rom.flags.BlizzardBracelet],[this.rom.flags.BallOfThunder,this.rom.flags.StormBracelet]][a];return 3===b?and$$module$js$logic$world(c,
...a):a.map((a)=>[c.c,a.c])}itemGrant(a){for(const [b,c]of this.rom.itemGets.actionGrants)if(b===a)return c;throw Error(`Could not find item grant ${a.toString(16)}`);}filterRequirements(a){var b;const c=[];for(const d of a)if(0>d){if(a=null===(b=this.flag(~d))||void 0===b?void 0:b.logic,null===a||void 0===a?0:a.assumeTrue)return module$js$logic$requirement.Requirement.CLOSED}else{a=this.flag(d);if(null===a||void 0===a?0:a.logic.assumeFalse)return module$js$logic$requirement.Requirement.CLOSED;(null===
a||void 0===a?0:a.logic.track)&&c.push(a.id)}return[c]}filterAntiRequirements(a){var b;const c=[];for(const d of a)if(0<=d){if(a=null===(b=this.flag(~d))||void 0===b?void 0:b.logic,null===a||void 0===a?0:a.assumeFalse)return module$js$logic$requirement.Requirement.OPEN}else{a=this.flag(~d);if(null===a||void 0===a?0:a.logic.assumeTrue)return module$js$logic$requirement.Requirement.OPEN;(null===a||void 0===a?0:a.logic.track)&&c.push([a.id])}return c}flag(a){var b;a=this.rom.flags[a];return null!==(b=
this.aliases.get(a))&&void 0!==b?b:a}entrance(a,b=0){"number"===typeof a&&(a=this.rom.locations[a]);return this.tiles.find(module$js$logic$tileid.TileId.from(a,a.entrances[b]))}wallCapability(a){switch(a){case module$js$logic$walltype.WallType.WIND:return this.rom.flags.BreakStone.id;case module$js$logic$walltype.WallType.FIRE:return this.rom.flags.BreakIce.id;case module$js$logic$walltype.WallType.WATER:return this.rom.flags.FormBridge.id;case module$js$logic$walltype.WallType.THUNDER:return this.rom.flags.BreakIron.id;
default:throw Error(`bad wall type: ${a}`);}}}function and$$module$js$logic$world(...a){return[a.map((a)=>a.id)]}function or$$module$js$logic$world(...a){return a.map((a)=>[a.id])}const DEBUG$$module$js$logic$world=!1;var module$js$logic$world={};module$js$logic$world.World=World$$module$js$logic$world;var Path$$module$js$maze$types;(function(a){a.generate=function*(a,c,d){for(;;)yield generatePath$$module$js$maze$types(a,c,d)}})(Path$$module$js$maze$types||(Path$$module$js$maze$types={}));
...
8|(a.entrance&61440)>>8|(a.entrance&240)>>4,a.dir),this.stairScreens.set(b.edges,[a.dir,{entrance:a.entrance,exits:[a.exit,a.exit+1]}]);b.wall&&this.walls.set(b.tile,b.wall.type);128!=b.tile&&b.fixed&&(this.fixedTiles.has(b.tile)||this.fixedTiles.set(b.tile,b));b.deadEnd&&this.deadEndTiles.add(b.tile)}}survey(a){let b=0,c=0,d=0,e=0,f=0,g=0,h=!0,k=!1;const m=new Map,l=new Map,n=new Map,p=new Multiset$$module$js$util,r=[];this.empty&&r.push(this.empty);var q=new Set([].concat(...a.screens));for(var w of this.specSets)for(var x of w)if(128!==
x.tile&&q.has(x.tile)){r.push(...w);break}if(164===a.tileset)for(q=r.length-1;0<=q;q--)69648===r[q].edges&&r.splice(q,1);q=new Set([...a.reachableTiles(!0).keys()].map((a)=>a>>>8));if(!q.size)throw Error("No reachable tiles");w=new Map(a.entrances.map((b,c)=>{for(const d of a.exits)if(20>Math.abs(d.x-b.x)&&20>Math.abs(d.y-b.y))return[c,d.dest<<8|d.entrance];return null}).filter(isNonNull$$module$js$util));for(x=0;x<a.entrances.length;x++){var y=a.entrances[x],z=this.stairsByTile.get(a.screens[y.screen>>>
4][y.screen&15]<<8|y.tile);if(null!=z){var E=w.get(x);if(null==E)throw Error("Could not find exit");m.set(y.screen,{entrance:x,exit:E,dir:z})}}for(x=0;x<a.height;x++)for(y=0,x||(y|=1),x===a.height-1&&(y|=4),z=0;z<a.width;z++){E=x<<4|z;if(!q.has(E))continue;y&=-11;z||(y|=8);z===a.width-1&&(y|=2);var v=a.screens[x][z];p.add(v);if(128===v)continue;WIDE_SET$$module$js$maze$spec.has(v)?k=!0:h=!1;b++;RIVER_TILES$$module$js$maze$spec.has(v)&&g++;let r=this.edgesByTile.get(v);if(null==r)throw Error(`Bad tile: ${hex$$module$js$rom$util(v)}`);
var t=BITCOUNT$$module$js$maze$spec[r]+(m.has(E)?1:0);154===v&&(t=2);if(155===v||156==v||240==v||241==v)t=1;1===t&&c++;2<t&&(d+=t-2);t=this.walls.get(v);"wall"===t&&e++;"bridge"===t&&f++;t=this.fixedTiles.get(v);this.deadEndTiles.has(v)&&(r=0);for(var V of module$js$maze$types.Dir.ALL)if(r&y&1<<V){v=null;for(var H=0;H<a.entrances.length;H++)if(a.entrances[H].screen===E&&matchesDir$$module$js$maze$spec(a.entrances[H].tile,V)){v=H;break}if(null!=v){H=w.get(v);if(null==H)throw Error("Could not find exit");
l.set(E,{entrance:v,exit:H,dir:V})}}null!=t&&n.set(E,t)}if(g)for(const [a,b]of n)29046===b.edges&&(V=r.find((a)=>459009===a.edges))&&n.set(a,V);if(h!=k)throw Error("Found inconsistent use of wide tiles");return{size:b,rivers:g,deadEnds:c,branches:d,walls:e,bridges:f,stairs:m,edges:l,fixed:n,tiles:p,wide:h,specs:r,specSet:this}}}SpecSet$$module$js$maze$spec.CAVE=new SpecSet$$module$js$maze$spec(ALL_CAVE_SCREENS$$module$js$maze$spec,EMPTY_CAVE_SCREEN$$module$js$maze$spec);
...
module$js$maze$spec.GOA1_SCREENS=GOA1_SCREENS$$module$js$maze$spec;module$js$maze$spec.SpecSet=SpecSet$$module$js$maze$spec;module$js$maze$spec.readScreen=readScreen$$module$js$maze$spec;module$js$maze$spec.write2d=write2d$$module$js$maze$spec;let count$$module$js$rom$area=0;class Area$$module$js$rom$area{constructor(){this.name=`Area ${++count$$module$js$rom$area}`}}class Overworld$$module$js$rom$area extends Area$$module$js$rom$area{constructor(){super(...arguments);this.type="overworld"}}class Town$$module$js$rom$area extends Area$$module$js$rom$area{constructor(){super(...arguments);this.type="town"}}
class Connector$$module$js$rom$area extends Area$$module$js$rom$area{constructor(){super(...arguments);this.type="connector";this.exits=[2,2]}}class Terminal$$module$js$rom$area extends Area$$module$js$rom$area{constructor(){super(...arguments);this.type="terminal";this.exits=[1,1]}}var Areas$$module$js$rom$area;
(function(a){a.Unused=new Terminal$$module$js$rom$area;a.ValleyOfWind=new class extends Overworld$$module$js$rom$area{constructor(){super(...arguments);this.exits=[3,6]}};a.CordelPlain=new class extends Overworld$$module$js$rom$area{constructor(){super(...arguments);this.exits=[5,8]}};a.WaterfallValley=new class extends Overworld$$module$js$rom$area{constructor(){super(...arguments);this.exits=[6,6]}};a.AngrySea=new class extends Overworld$$module$js$rom$area{constructor(){super(...arguments);this.exits=
[0,0]}};a.GoaValley=new class extends Overworld$$module$js$rom$area{constructor(){super(...arguments);this.exits=[0,0]}};a.Desert1=new class extends Overworld$$module$js$rom$area{constructor(){super(...arguments);this.exits=[0,0]}};a.Desert2=new class extends Overworld$$module$js$rom$area{constructor(){super(...arguments);this.exits=[0,0]}};a.Leaf=new class extends Town$$module$js$rom$area{constructor(){super(...arguments);this.exits=[0,0]}};a.Brynmaer=new class extends Town$$module$js$rom$area{constructor(){super(...arguments);
this.exits=[0,0]}};a.Oak=new class extends Town$$module$js$rom$area{constructor(){super(...arguments);this.exits=[0,0]}};a.Amazones=new class extends Town$$module$js$rom$area{constructor(){super(...arguments);this.exits=[0,0]}};a.Nadare=new class extends Town$$module$js$rom$area{constructor(){super(...arguments);this.exits=[0,0]}};a.Portoa=new class extends Town$$module$js$rom$area{constructor(){super(...arguments);this.exits=[0,0]}};a.Joel=new class extends Town$$module$js$rom$area{constructor(){super(...arguments);
this.exits=[0,0]}};a.ZombieTown=new class extends Town$$module$js$rom$area{constructor(){super(...arguments);this.exits=[0,0]}};a.Swan=new class extends Town$$module$js$rom$area{constructor(){super(...arguments);this.exits=[0,0]}};a.Shyron=new class extends Town$$module$js$rom$area{constructor(){super(...arguments);this.exits=[0,0]}};a.Goa=new class extends Town$$module$js$rom$area{constructor(){super(...arguments);this.exits=[0,0]}};a.Sahara=new class extends Town$$module$js$rom$area{constructor(){super(...arguments);
this.exits=[0,0]}};a.WindmillCave=new class extends Connector$$module$js$rom$area{};a.SealedCave=new class extends Connector$$module$js$rom$area{};a.ZebuCave=new class extends Connector$$module$js$rom$area{};a.MtSabreWest=new class extends Connector$$module$js$rom$area{};a.MtSabreNorth=new class extends Connector$$module$js$rom$area{};a.LimeTreeValley=new class extends Connector$$module$js$rom$area{};a.PortoaPalace=new class extends Connector$$module$js$rom$area{};a.FishermanHouse=new class extends Connector$$module$js$rom$area{};
a.UndergroundChannel=new class extends Connector$$module$js$rom$area{};a.JoelPassage=new class extends Connector$$module$js$rom$area{};a.EvilSpiritIslandEntrance=new class extends Connector$$module$js$rom$area{};a.EvilSpiritIsland=new class extends Connector$$module$js$rom$area{};a.KirisaPlantCave=new class extends Connector$$module$js$rom$area{};a.SwanGate=new class extends Connector$$module$js$rom$area{};a.MtHydra=new class extends Connector$$module$js$rom$area{};a.GoaFortress=new class extends Connector$$module$js$rom$area{};
a.OasisEntrance=new class extends Connector$$module$js$rom$area{};a.OasisCave=new class extends Connector$$module$js$rom$area{};a.DesertCave1=new class extends Connector$$module$js$rom$area{};a.SaharaMeadow=new class extends Connector$$module$js$rom$area{};a.DesertCave2=new class extends Connector$$module$js$rom$area{};a.EastCave=new class extends Connector$$module$js$rom$area{};a.Swamp=new class extends Connector$$module$js$rom$area{};a.Mezame=new class extends Terminal$$module$js$rom$area{};a.Windmill=
new class extends Terminal$$module$js$rom$area{};a.StomHouse=new class extends Terminal$$module$js$rom$area{};a.WaterfallCave=new class extends Terminal$$module$js$rom$area{};a.KirisaMeadow=new class extends Terminal$$module$js$rom$area{};a.FogLampCave=new class extends Terminal$$module$js$rom$area{};a.LimeTreeLake=new class extends Terminal$$module$js$rom$area{};a.Lighthouse=new class extends Terminal$$module$js$rom$area{};a.SaberaFortress=new class extends Terminal$$module$js$rom$area{};a.ShyronTemple=
new class extends Terminal$$module$js$rom$area{};a.Styx=new class extends Terminal$$module$js$rom$area{};a.FortressBasement=new class extends Terminal$$module$js$rom$area{};a.Pyramid=new class extends Terminal$$module$js$rom$area{};a.Crypt=new Terminal$$module$js$rom$area;a.Tower=new Terminal$$module$js$rom$area})(Areas$$module$js$rom$area||(Areas$$module$js$rom$area={}));function capitalize$$module$js$rom$area(a){return a.replace(/([a-z])([A-Z0-9])/g,"$1 $2").replace("Of","of")}
for(const [a,b]of Object.entries(Areas$$module$js$rom$area))b.name=capitalize$$module$js$rom$area(a);var module$js$rom$area={};module$js$rom$area.Area=Area$$module$js$rom$area;module$js$rom$area.Overworld=Overworld$$module$js$rom$area;module$js$rom$area.Town=Town$$module$js$rom$area;module$js$rom$area.Connector=Connector$$module$js$rom$area;module$js$rom$area.Terminal=Terminal$$module$js$rom$area;module$js$rom$area.Areas=Areas$$module$js$rom$area;class Entrance$$module$js$rom$locationtables extends DataTuple$$module$js$rom$util{constructor(){super(...arguments);this.x=this.prop([0],[1,255,-8]);this.y=this.prop([2],[3,255,-8]);this.screen=this.prop([3,15,-4],[1,15]);this.tile=this.prop([2,240],[0,240,4]);this.coord=this.prop([2,255,-8],[0,255])}get used(){return 8>this.data[1]}toString(){return`Entrance ${this.hex()}: (${hex$$module$js$rom$util(this.y)}, ${hex$$module$js$rom$util(this.x)})`}}Entrance$$module$js$rom$locationtables.size=4;
class Exit$$module$js$rom$locationtables extends DataTuple$$module$js$rom$util{constructor(){super(...arguments);this.x=this.prop([0,255,-4]);this.xt=this.prop([0]);this.y=this.prop([1,255,-4]);this.yt=this.prop([1]);this.screen=this.prop([1,240],[0,240,4]);this.tile=this.prop([1,15,-4],[0,15]);this.coord=this.prop([1,15,-12],[0,15,-4]);this.dest=this.prop([2]);this.entrance=this.prop([3])}isSeamless(){return!!(this.entrance&32)}toString(){return`Exit ${this.hex()}: (${hex$$module$js$rom$util(this.y)}, ${hex$$module$js$rom$util(this.x)}) => ${this.dest}:${this.entrance}`}}
Exit$$module$js$rom$locationtables.size=4;
class Flag$$module$js$rom$locationtables extends DataTuple$$module$js$rom$util{constructor(){super(...arguments);this.x=this.prop([1,7,-8]);this.xs=this.prop([1,7]);this.y=this.prop([1,240,-4]);this.ys=this.prop([1,240,4]);this.screen=this.prop([1])}get flag(){return this.data[0]|512}set flag(a){if(512!==(a&-256))throw Error(`bad flag: ${hex$$module$js$rom$util(a)}`);this.data[0]=a&255}toString(){return`Flag ${this.hex()}: ${hex$$module$js$rom$util(this.screen)} @ ${hex$$module$js$rom$util(this.flag)}`}}
Flag$$module$js$rom$locationtables.size=2;
class Pit$$module$js$rom$locationtables extends DataTuple$$module$js$rom$util{constructor(){super(...arguments);this.fromXs=this.prop([1,112,4]);this.toXs=this.prop([1,7]);this.fromYs=this.prop([3,240,4]);this.toYs=this.prop([3,15]);this.fromScreen=this.prop([3,240],[1,112,4]);this.toScreen=this.prop([3,15,-4],[1,7]);this.dest=this.prop([0])}toString(){return`Pit ${this.hex()}: (${hex$$module$js$rom$util(this.fromXs)}, ${hex$$module$js$rom$util(this.fromYs)}) => ${hex$$module$js$rom$util(this.dest)}:(${hex$$module$js$rom$util(this.toXs)}, ${hex$$module$js$rom$util(this.toYs)})`}}
Pit$$module$js$rom$locationtables.size=4;
class Spawn$$module$js$rom$locationtables extends DataTuple$$module$js$rom$util{constructor(){super(...arguments);this.y=this.prop([0,255,-4]);this.yt=this.prop([0]);this.x=this.prop([1,127,-4],[2,64,3]);this.xt=this.prop([1,127]);this.timed=this.booleanProp(1,7);this.screen=this.prop([0,240],[1,112,4]);this.tile=this.prop([0,15,-4],[1,15]);this.coord=this.prop([0,255,-8],[1,127,-4],[2,64,3]);this.type=this.prop([2,7]);this.id=this.prop([3]);this.patternBank=this.prop([2,128,7])}get used(){return 254!==
this.data[0]}set used(a){this.data[0]=a?0:254}get monsterId(){return this.id+80&255}set monsterId(a){this.id=a-80&255}isChest(){return 2===this.type&&128>this.id}isInvisible(){return this.isChest()&&!!(this.data[2]&32)}isTrigger(){return 2===this.type&&128<=this.id}isNpc(){return 1===this.type&&192>this.id}isBoss(){return 1===this.type&&192<=this.id}isMonster(){return 0===this.type}isWall(){return!(3!==this.type||!(4>this.id||this.data[2]&32))}isShootingWall(a){return this.isWall()&&!!(this.data[2]&
32?this.data[2]&16:143===a.id||168===a.id)}wallType(){if(3!==this.type)return"";const a=this.data[2]&32?this.id>>>4:this.id;return 4<=a?"":2===a?"bridge":"wall"}wallElement(){return this.isWall()?this.id&3:-1}toString(){return`Spawn ${this.hex()}: (${hex$$module$js$rom$util(this.x)}, ${hex$$module$js$rom$util(this.y)}) ${this.timed?"timed":"fixed"} ${this.type}:${hex$$module$js$rom$util(this.id)}`}}Spawn$$module$js$rom$locationtables.size=4;var module$js$rom$locationtables={};
module$js$rom$locationtables.Entrance=Entrance$$module$js$rom$locationtables;module$js$rom$locationtables.Exit=Exit$$module$js$rom$locationtables;module$js$rom$locationtables.Flag=Flag$$module$js$rom$locationtables;module$js$rom$locationtables.Pit=Pit$$module$js$rom$locationtables;module$js$rom$locationtables.Spawn=Spawn$$module$js$rom$locationtables;class Metatilesets$$module$js$rom$metatileset{constructor(a){this.rom=a;this._all=[];this.grass=this.tileset(128,{patterns:[0,12]});this.town=this.tileset(132,{});this.cave=this.tileset(136,{});this.dolphinCave=this.tileset(136,{});this.pyramid=this.tileset(140,{});this.river=this.tileset(144,{animated:[0,1],patterns:[20,0]});this.sea=this.tileset(148,{});this.lime=this.tileset(148,{});this.mountain=this.tileset(148,{});this.shrine=this.tileset(152,{});this.desert=this.tileset(156,{});this.mountainRiver=
this.tileset(156,{});this.swamp=this.tileset(160,{consolidated:!0});this.house=this.tileset(160,{});this.fortress=this.tileset(164,{});this.labyrinth=this.tileset(164,{});this.iceCave=this.tileset(168,{});this.tower=this.tileset(172,{});for(const b in this)a=this[b],a instanceof Metatileset$$module$js$rom$metatileset&&(a.name=b)}tileset(a,b){a=new Metatileset$$module$js$rom$metatileset(this.rom,a,b);this._all.push(a);return a}[Symbol.iterator](){return this._all[Symbol.iterator]()}}
class Metatileset$$module$js$rom$metatileset{constructor(a,b,c){this.rom=a;this.tilesetId=b;this.data=c;this._screens=new Set;this._cache=void 0}[Symbol.iterator](){return this._screens[Symbol.iterator]()}get cache(){this._cache||(this._cache=new NeighborCache$$module$js$rom$metatileset(this));return this._cache}get tileset(){return this.rom.tilesets[this.tilesetId]}get empty(){const a=this.cache.empty;if(!a)throw Error(`No empty screen for ${this.name}`);return a}get exit(){return this.rom.metascreens.exit}effects(){return this.tileset.effects()}getTile(a){return this.tileset.getTile(a)}addScreen(a){this._screens.add(a);
a.unsafeAddTileset(this);this.invalidate()}deleteScreen(a){this._screens.delete(a);a.unsafeRemoveTileset(this);this.invalidate()}getMetascreens(a){var b;return null!==(b=this.cache.fromId.get(a))&&void 0!==b?b:EMPTY_SET$$module$js$rom$metatileset}invalidate(){this._cache=void 0}check(a,b,c){return this.cache.allowed[c&1].has(0<c?a<<16|b:b<<16|a)}}const EMPTY_SET$$module$js$rom$metatileset=new class extends Set{add(){throw Error();}};var Dir$$module$js$rom$metatileset;
(function(a){a.N=0;a.W=1;a.S=2;a.E=3})(Dir$$module$js$rom$metatileset||(Dir$$module$js$rom$metatileset={}));
class NeighborCache$$module$js$rom$metatileset{constructor(a){var b;this.tileset=a;this.allowed=[new Set,new Set];this.neighbors=new DefaultMap$$module$js$util(()=>new Set);this.fromId=new DefaultMap$$module$js$util(()=>new Set);let c=void 0;for(const d of module$js$util.iters.concat(a,[a.exit])){0<=d.id&&this.fromId.get(d.id).add(d);c||"    "!==d.data.edges||!d.hasFeature("empty")||(null===(b=d.data.exits)||void 0===b?0:b.length)||(c=d);const e=d.data.edges||"****";for(const b of module$js$util.iters.concat(a,
[a.exit])){const a=b.data.edges||"****";"*"!==e[2]&&e[2]===a[0]&&this.add(Dir$$module$js$rom$metatileset.S,d,b);"*"!==e[3]&&e[3]===a[1]&&this.add(Dir$$module$js$rom$metatileset.E,d,b);for(const a of d.data.allowed?d.data.allowed(b):[])this.add(a,d,b)}}this.empty=null!==c&&void 0!==c?c:a.rom.metascreens.caveEmpty}add(a,b,c){b=b.uid;c=c.uid;this.allowed[a&1].add(a&2?b<<16|c:c<<16|b);this.neighbors.get(b<<2|a).add(c);this.neighbors.get(c<<2|a^2).add(b)}}var module$js$rom$metatileset={};
module$js$rom$metatileset.Metatilesets=Metatilesets$$module$js$rom$metatileset;module$js$rom$metatileset.Metatileset=Metatileset$$module$js$rom$metatileset;module$js$rom$metatileset.Dir=Dir$$module$js$rom$metatileset;const featureMask$$module$js$rom$metascreendata={pit:1,arena:2,spikes:4,bridge:8,wall:16,stairs:32,"stair:up":64,"stair:down":128,empty:256,portoa1:512,portoa2:1024,portoa3:2048,lake:4096,overBridge:8192,underBridge:16384,whirlpool:32768,lighthouse:65536,cabin:131072,windmill:262144,altar:524288,pyramid:1048576,crypt:2097152,consolidate:4194304};
function icon$$module$js$rom$metascreendata(a){if(1!=a.length)throw Error("Bad icon input");a=a[0].split("\n");const b=a.slice(1).map((a)=>a.replace(/^\s*\||\|\s*$/g,""));return{short:/\S/.test(a[0])?a[0][0]:b[1][1],full:[b[0],b[1],b[2]]}}
function upStair$$module$js$rom$metascreendata(a,b){b=void 0===b?2:b;const c=a>>>4,d=a&15;return 1===b?{type:"stair:up",dir:2,entrance:(c<<12)+(14===c?10240:6144)|(d<<4)+8,exits:[a]}:{type:"stair:up",dir:0,entrance:c<<12|(d<<4)+(b<<3),exits:seq$$module$js$rom$util(b,(b)=>a-16+b)}}
function downStair$$module$js$rom$metascreendata(a,b){b=void 0===b?2:b;const c=a>>>4,d=a&15;return 1===b?{type:"stair:down",dir:2,entrance:(c<<12)-2048|(d<<4)+8,exits:[a],allowedExits:[a+16,a-16]}:{type:"stair:down",dir:2,entrance:c<<12|3840|(d<<4)+(b<<3),exits:seq$$module$js$rom$util(b,(b)=>a+16+b),allowedExits:[...seq$$module$js$rom$util(b,(b)=>a+32+b),...seq$$module$js$rom$util(b,(b)=>a+b)]}}
function cave$$module$js$rom$metascreendata(a,b){b=void 0===b?"cave":b;return Object.assign({},upStair$$module$js$rom$metascreendata(a+16),{type:b})}function door$$module$js$rom$metascreendata(a,b){b=void 0===b?"door":b;return Object.assign({},upStair$$module$js$rom$metascreendata(a,1),{type:b})}function waterfallCave$$module$js$rom$metascreendata(a){return{type:"cave",dir:0,entrance:a>>>4<<12|(a&15)<<4|15,exits:[a-15,a+1]}}
function topEdge$$module$js$rom$metascreendata(a){var {left:b=7,width:c=2,top:d=2,manual:e=!1}=void 0===a?{}:a;return{type:"edge:top",manual:e,dir:0,entrance:d+1<<12|(b<<4)+(c<<3),exits:seq$$module$js$rom$util(c,(a)=>d<<4|a+b)}}function bottomEdge$$module$js$rom$metascreendata(a){var {left:b=7,width:c=2,shift:d=0,type:e="edge:bottom",manual:f=!1}=void 0===a?{}:a;return{type:e,manual:f,dir:2,entrance:57088|(b<<4)+(c<<3)+16*d,exits:seq$$module$js$rom$util(c,(a)=>224|a+b)}}
function bottomEdgeHouse$$module$js$rom$metascreendata(a){var {left:b=7,width:c=2,shift:d=0}=void 0===a?{}:a;return{type:"edge:bottom",dir:2,entrance:44800|(b<<4)+(c<<3)+16*d,exits:seq$$module$js$rom$util(c,(a)=>176|a+b)}}function leftEdge$$module$js$rom$metascreendata(a){var {top:b=7,height:c=2,shift:d=0}=void 0===a?{}:a;return{type:"edge:left",dir:1,entrance:(b<<12)+(16*d<<8)+(c<<11)|16,exits:seq$$module$js$rom$util(c,(a)=>a+b<<4)}}
function rightEdge$$module$js$rom$metascreendata(a){var {top:b=7,height:c=2,shift:d=0}=void 0===a?{}:a;return{type:"edge:right",dir:3,entrance:(b<<12)+(16*d<<8)+(c<<11)|239,exits:seq$$module$js$rom$util(c,(a)=>a+b<<4|15)}}function seamlessUp$$module$js$rom$metascreendata(a,b){return{type:"seamless:up",dir:0,get entrance(){throw Error("does not make sense");},exits:seq$$module$js$rom$util(void 0===b?2:b,(b)=>a+b)}}
function seamlessDown$$module$js$rom$metascreendata(a,b){return{type:"seamless:down",dir:2,get entrance(){throw Error("does not make sense");},exits:seq$$module$js$rom$util(void 0===b?2:b,(b)=>a+b)}}var module$js$rom$metascreendata={};module$js$rom$metascreendata.featureMask=featureMask$$module$js$rom$metascreendata;module$js$rom$metascreendata.icon=icon$$module$js$rom$metascreendata;module$js$rom$metascreendata.upStair=upStair$$module$js$rom$metascreendata;
module$js$rom$metascreendata.downStair=downStair$$module$js$rom$metascreendata;module$js$rom$metascreendata.cave=cave$$module$js$rom$metascreendata;module$js$rom$metascreendata.door=door$$module$js$rom$metascreendata;module$js$rom$metascreendata.waterfallCave=waterfallCave$$module$js$rom$metascreendata;module$js$rom$metascreendata.topEdge=topEdge$$module$js$rom$metascreendata;module$js$rom$metascreendata.bottomEdge=bottomEdge$$module$js$rom$metascreendata;
module$js$rom$metascreendata.bottomEdgeHouse=bottomEdgeHouse$$module$js$rom$metascreendata;module$js$rom$metascreendata.leftEdge=leftEdge$$module$js$rom$metascreendata;module$js$rom$metascreendata.rightEdge=rightEdge$$module$js$rom$metascreendata;module$js$rom$metascreendata.seamlessUp=seamlessUp$$module$js$rom$metascreendata;module$js$rom$metascreendata.seamlessDown=seamlessDown$$module$js$rom$metascreendata;class Metalocation$$module$js$rom$metalocation{constructor(a,b,c,d){this.id=a;this.tileset=b;this.customFlags=new Map;this.freeFlags=new Set;this._pos=void 0;this._counted=new Map;this._filled=0;this._features=new Map;this._exits=new Table$$module$js$util;this._monstersInvalidated=!1;this.rom=b.rom;this._empty=b.empty.uid;this._height=c;this._width=d;this._screens=Array(c+2<<4).fill(this._empty);if(this._counts=b.data.consolidated?new Multiset$$module$js$util:void 0)for(const a of b)a.hasFeature("consolidate")&&
this._counted.set(a.uid,a.id)}static of(a,b){function c(a,b,c){for(const d of g.metascreens.getById(b,a.tileset))if(b=d.findEntranceType(c,1===a.height),null!=b)return b}var d,e,f;const {rom:g,width:h,height:k}=a;if(!b){const {fortress:c,labyrinth:d}=g.metatilesets;b=new Set;for(var m of g.metatilesets)a.tileset===m.tileset.id&&b.add(m);b.delete(169===a.id?c:d);for(var l of new Set(module$js$util.iters.concat(...a.screens)))for(var n of b)if(n.getMetascreens(l).size||b.delete(n),!b.size)throw Error(`No tileset for ${hex$$module$js$rom$util(l)} in ${a}`);
if(1!==b.size)throw Error(`Non-unique tileset for ${a}: [${Array.from(b,(a)=>a.name).join(", ")}]`);b=[...b][0]}const p=a.reachableTiles(!0);l=b.exit.uid;m=Array(k+2<<4).fill(b.empty.uid);for(let c=0;c<k;c++)for(let d=0;d<h;d++){var r=b.getMetascreens(a.screens[c][d]);n=void 0;if(1===r.size)[n]=r;else if(r.size){var q=a.flags.find((a)=>a.screen===(c<<4|d)),w=[],x=[];for(var y of r)y.data.match?w.push(y):"always"===y.flag&&766===(null===q||void 0===q?void 0:q.flag)||!y.flag&&!y.data.wall&&!q?x.unshift(y):
x.push(y);if(w.length){r=function(a,b){b=(d<<8)+b;a=(c<<8)+a;return p.has(a<<4&61440|b&3840|a&240|b>>4&15)};for(var z of w)if(z.data.match(r,null!=q)){n=z;break}}n||(n=x[0])}else throw Error("impossible");if(!n)throw Error("impossible");q=c+1<<4|d;m[q]=n.uid;n=n.edgeExits();0===c&&n&1&&(m[q-16]=l);0===d&&n&2&&(m[q-1]=l);c===k&&n&4&&(m[q+16]=l);d===h&&n&8&&(m[q+1]=l)}y=new Table$$module$js$util;for(const b of a.exits)if(z=b.screen,n=g.metascreens[m[z+16]],q=n.findExitType(b.tile,1===k,!!(b.entrance&
32)),l=null===q||void 0===q?void 0:q.type,!l)unknownExitWhitelist$$module$js$rom$metalocation.has(a.id<<16|z<<8|b.tile)||(l=null===(d=n.data.exits)||void 0===d?void 0:d.map((a)=>a.type+": "+a.exits.map(hex$$module$js$rom$util).join(", ")).join("\n  "),console.warn(`Unknown exit ${hex$$module$js$rom$util(b.tile)}: ${n.name} in ${a} @ ${hex$$module$js$rom$util(z)}:\n  ${l}`));else if(!y.has(z,l))if(n=g.locations[b.dest],l.startsWith("seamless"))w="seamless:down"===l,q=q.exits[0]+(w?-16:16),y.set(z,
l,[n.id<<8|z+(0>q?-16:240<=q?16:-0),w?"seamless:up":"seamless:down"]);else if(x=n.entrances[b.entrance&31],q=x.screen,w=x.coord,"door"===l&&0===(x.y&240)&&(q-=16,w+=65536),x=n.screens[q>>4][q&15],r=c(n,x,w))y.set(z,l,[n.id<<8|q,r]);else{z=[];for(const a of g.metascreens.getById(x,n.tileset))for(const b of null!==(e=a.data.exits)&&void 0!==e?e:[])b.type.startsWith("seamless")||z.push(`  ${a.name} ${b.type}: ${hex$$module$js$rom$util(b.entrance)}`);console.warn(`Bad entrance ${hex$$module$js$rom$util(w)}: raw ${hex$$module$js$rom$util(x)} in ${n} @ ${hex$$module$js$rom$util(q)}\n${z.join("\n")}`)}d=
new Metalocation$$module$js$rom$metalocation(a.id,b,k,h);for(e=0;e<m.length;e++)d.setInternal(e,m[e]);d._screens=m;d._exits=y;for(const b of a.flags)a=g.metascreens[d._screens[b.screen+16]],(null===(f=a.flag)||void 0===f?0:f.startsWith("custom"))?d.customFlags.set(b.screen,g.flags[b.flag]):a.flag||d.freeFlags.add(g.flags[b.flag]);return d}getUid(a){return this._screens[a+16]}get(a){return this.rom.metascreens[this._screens[a+16]]}get size(){return this._filled}get width(){return this._width}set width(a){this._width=
a;this._pos=void 0}get height(){return this._height}set height(a){this._height>a?this._screens.splice(a+2<<4,this._height-a<<4):this._height<a&&(this._screens.length=a+2<<4,this._screens.fill(this._empty,this.height+2<<4,this._screens.length));this._height=a;this._pos=void 0}allPos(){if(this._pos)return this._pos;const a=this._pos=[];for(let b=0;b<this._height;b++)for(let c=0;c<this._width;c++)a.push(b<<4|c);return a}setInternal(a,b){var c=this.inBounds(a);a+=16;c&&this._screens[a]!==this._empty&&
this._filled--;c&&b!==this._empty&&this._filled++;c=this._counted.get(this._screens[a]);null==b&&(b=this._empty);this._screens[a]=b;this._counts&&(null!=c&&this._counts.delete(c),b=this._counted.get(b),null!=b&&this._counts.add(b))}invalidateMonsters(){this._monstersInvalidated=!0}inBounds(a){return(a&15)<this.width&&0<=a&&a>>>4<this.height}setFeature(a,b){this._features.set(a,this._features.get(a)|featureMask$$module$js$rom$metascreendata[b])}set2d(a,b){this.saveExcursion(()=>{const c=a;for(const c of b){let b=
0;for(const d of c)d&&this.setInternal(a+b++,d.uid);a+=16}this.verify(c,b.length,Math.max(...b.map((a)=>a.length)));return!0})}verify(a,b,c){const d=this.height+1<<4;for(let e=0;e<=b;e++){const b=a+16+(e<<4);for(let a=0;a<=c;a++){const c=b+a,e=this._screens[c];if(null==e)break;const f=this._screens[c-16],g=this._screens[c-1];if((c&15)<this.width&&!this.tileset.check(f,e,16))throw Error(`bad neighbor ${this.rom.metascreens[f].name} above ${this.rom.metascreens[e].name} at ${this.rom.locations[this.id]} @ ${hex$$module$js$rom$util(c-
32)}`);if(c<d&&!this.tileset.check(g,e,1))throw Error(`bad neighbor ${this.rom.metascreens[g].name} left of ${this.rom.metascreens[e].name} at ${this.rom.locations[this.id]} @ ${hex$$module$js$rom$util(c-17)}`);}}}bookkeep(){this._pos=void 0;this._filled=0;this._counts&&(this._counts=new Multiset$$module$js$util);for(const a of this.allPos()){const b=this._screens[a+16];if(this._counts){const a=this._counted.get(b);null!=a&&this._counts.add(a)}b!=this.tileset.empty.id&&this._filled++}}spliceColumns(a,
b,c,d){if(this._features.size)throw Error("bad features");this.saveExcursion(()=>{for(let e=0;e<this._screens.length;e+=16)this._screens.copyWithin(e+a+c,e+a+b,e+10),this._screens.splice(e+a,c,...d[e>>4].map((a)=>a.uid));return!0});const e=c-b;this.width+=e;this._pos=void 0;this.bookkeep();var f=[];for(const [c,d]of this._exits){var g=c&15;g<a+b?g>=a&&this._exits.delete(c,d):f.push([c,d,c+e,d])}this.moveExits(...f);f=this.rom.locations[this.id];g=a+b<<4;for(const a of f.spawns)a.xt<g||(a.xt-=e<<4);
for(const c of f.flags)c.xs<a+b?c.xs>=a&&(c.screen=255):c.xs-=e;f.flags=f.flags.filter((a)=>255!==a.screen)}set(a,b){var c=this.rom.metascreens[b],d=this._features.get(a);if(null!=d&&!c.hasFeatures(d))return!1;for(c=0;4>c;c++)if(d=DPOS$$module$js$rom$metalocation[c],!this.tileset.check(b,this._screens[a+d],d))return!1;this.setInternal(a,b);return!0}setExit(a,b,c){const d=this.rom.locations[c[0]>>>8].meta;if(!d)throw Error("Cannot set two-way exit without meta");this.setExitOneWay(a,b,c);d.setExitOneWay(c[0]&
255,c[1],[this.id<<8|a,b])}setExitOneWay(a,b,c){this._exits.set(a,b,c)}exitCandidates(a){var b;const c=[];for(const d of this.tileset)(null===(b=d.data.exits)||void 0===b?0:b.some((b)=>b.type===a))&&c.push(d.id);return c}tryAddOneOf(a,b){for(const c of b)if(this.set(a,c))return!0;return!1}show(){var a,b;const c=[];let d=[];for(var e=0;e<this.width;e++)d.push(e.toString(16));c.push("   "+d.join("  "));for(e=0;e<this.height;e++)for(let f=0;3>f;f++){d=[1===f?e.toString(16):" "," "];for(let c=0;c<this.width;c++){const g=
this.rom.metascreens[this._screens[e+1<<4|c]];d.push(null!==(b=null===(a=null===g||void 0===g?void 0:g.data.icon)||void 0===a?void 0:a.full[f])&&void 0!==b?b:1===f?" ? ":"   ")}c.push(d.join(""))}return c.join("\n")}screenNames(){const a=[];for(let b=0;b<this.height;b++){let c=[];for(let a=0;a<this.width;a++){const d=this.rom.metascreens[this._screens[b+1<<4|a]];c.push(null===d||void 0===d?void 0:d.name)}a.push(c.join(" "))}return a.join("\n")}saveExcursion(a){let b=[...this._screens],c=this._counts&&
[...this._counts],d=this._filled,e=[...this._features],f=!1;try{f=a()}finally{if(f)return!0;this._screens=b;c&&(this._counts=new Multiset$$module$js$util(c));this._filled=d;this._features=new Map(e)}return!1}traverse(a={}){var b=new Set(a.without||[]),c=new UnionFind$$module$js$unionfind;a=(a.flight?2:0)|(a.noFlagged?1:0);for(const e of this.allPos()){if(b.has(e))continue;const f=this.rom.metascreens[this._screens[e+16]];for(var d of f.connections[a])c.union(d.map((a)=>(e<<8)+a))}b=new Map;c=c.sets();
for(d=0;d<c.length;d++){a=c[d];for(const c of a)b.set(c,a)}return b}*borders(){const a=this.tileset.exit.uid;for(var b=0;b<this.width;b++){var c=b,d=this.height<<4|b;yield[c,module$js$rom$metatileset.Dir.N,this._screens[c+16],this._screens[c]===a];yield[d,module$js$rom$metatileset.Dir.S,this._screens[d+16],this._screens[d+32]===a]}for(b=1;b<=this.height;b++)c=b<<4,d=c|this.width-1,yield[c,module$js$rom$metatileset.Dir.W,this._screens[c+16],this._screens[c+15]===a],yield[d,module$js$rom$metatileset.Dir.E,
this._screens[d+16],this._screens[d+17]===a]}attach(a,b,c,d,e){d||(d=this.pickTypeFromExits(a));e||(e=b.pickTypeFromExits(c));const f=b.id<<8|c,g=this._exits.get(a,d);if(g){const [a,b]=g;if(a===f&&b===e)return}const h=b._exits.get(c,e);this._exits.set(a,d,[f,e]);b._exits.set(c,e,[this.id<<8|a,d]);if(h&&g){const [b,c]=g,[d,e]=h;a=this.rom.locations[b>>8].meta;this.rom.locations[d>>8].meta._exits.set(d&255,e,g);a._exits.set(b&255,c,h)}else if(h||g){const [a,b]=h||g;this.rom.locations[a>>8].meta._exits.delete(a&
255,b)}}pickTypeFromExits(a){const b=[...this._exits.row(a).keys()];if(!b.length)return this.pickTypeFromScreens(a);if(1<b.length)throw Error(`No single type for ${hex$$module$js$rom$util(a)}: [${b.join(", ")}]`);return b[0]}moveExits(...a){const b=[];for(const [c,d,e,f]of a){a=this._exits.get(c,d);const [g,h]=a;this.rom.locations[g>>8].meta._exits.set(g&255,h,[this.id<<8|e,f]);b.push([e,f,a]);this._exits.delete(c,d)}for(const [a,d,e]of b)this._exits.set(a,d,e)}moveExit(a,b,c,d){c||(c=this.pickTypeFromExits(a));
d||(d=this.pickTypeFromScreens(b));const e=this._exits.get(a,c),[f,g]=e;this.rom.locations[f>>8].meta._exits.set(f&255,g,[this.id<<8|b,d]);this._exits.set(b,d,e);this._exits.delete(a,c)}pickTypeFromScreens(a){var b=this.rom.metascreens[this._screens[a+16]].data.exits;b=(null!==b&&void 0!==b?b:[]).map((a)=>a.type);if(1!==b.length)throw Error(`No single type for ${hex$$module$js$rom$util(a)}: [${b.join(", ")}]`);return b[0]}reconcileExits(a){const b=[],c=[];for(const d of[this,a])for(const [e,f,[g,
h]]of d._exits){if(h.startsWith("seamless"))continue;const k=this.rom.locations[g>>>8].meta._exits.get(g&255,h);if(k){const [c,l]=k;if(c>>>8===d.id&&(c&255)===e&&l===f){b.push([d===this?a:this,e,f,[g,h]]);continue}}c.push([d,e,f])}for(const [a,b,f]of c)a._exits.delete(b,f);for(const [a,c,f,g]of b)a._exits.set(c,f,g)}write(){var a,b,c,d,e,f,g;const h=this.rom.locations[this.id];for(const [c,d,[e,f]]of this._exits){var k=this.rom.metascreens[this._screens[c+16]],m=e>>8;let g=e&255;const n=this.rom.locations[m],
p=this.rom.metascreens[n.meta._screens[(e&255)+16]],q=null===(a=k.data.exits)||void 0===a?void 0:a.find((a)=>a.type===d);var l=null===(b=p.data.exits)||void 0===b?void 0:b.find((a)=>a.type===f);if(!q||!l)throw Error(`Missing exit:
  From: ${h} @ ${hex$$module$js$rom$util(c)}:${d} ${k.name}
  To:   ${n} @ ${hex$$module$js$rom$util(g)}:${f} ${p.name}`);k=32;l.type.startsWith("seamless")||(l=l.entrance,61439<l&&(g+=16,l-=65536),k=n.findOrAddEntrance(g,l));for(let a of q.exits)h.exits.push(Exit$$module$js$rom$locationtables.of({screen:c,tile:a,dest:m,entrance:k}))}h.width=this._width;h.height=this._height;h.screens=[];for(a=0;a<this._height;a++)for(b=[],h.screens.push(b),m=0;m<this._width;m++)b.push(this.rom.metascreens[this._screens[a+1<<4|m]].id);h.tileset=this.tileset.tilesetId;h.tileEffects=
this.tileset.effects().id;h.flags=[];a=[...this.freeFlags];for(const k of this.allPos()){b=this.rom.metascreens[this._screens[k+16]];let l;null!=b.data.wall?l=null!==(d=null===(c=a.pop())||void 0===c?void 0:c.id)&&void 0!==d?d:this.rom.flags.alloc(512):"always"===b.flag?l=this.rom.flags.AlwaysTrue.id:"calm"===b.flag?l=this.rom.flags.CalmedAngrySea.id:"custom:false"===b.flag?l=null===(e=this.customFlags.get(k))||void 0===e?void 0:e.id:"custom:true"===b.flag&&(l=null!==(g=null===(f=this.customFlags.get(k))||
void 0===f?void 0:f.id)&&void 0!==g?g:this.rom.flags.AlwaysTrue.id);null!=l&&h.flags.push(Flag$$module$js$rom$locationtables.of({screen:k,flag:l}))}}}const unknownExitWhitelist$$module$js$rom$metalocation=new Set([65594,65595,1327264,1392800,1716320,1716384,4202496,4202544,4292816,6326207,10552102,10552105,11077158,11077161]),DPOS$$module$js$rom$metalocation=[-16,-1,16,1];var module$js$rom$metalocation={};module$js$rom$metalocation.Metalocation=Metalocation$$module$js$rom$metalocation;const {$0a:$0a$$module$js$rom$location,$0b:$0b$$module$js$rom$location,$0c:$0c$$module$js$rom$location,$0d:$0d$$module$js$rom$location}=Segment$$module$js$rom$util,CAVE$$module$js$rom$location={subArea:"cave",music:(a)=>`${a.name}-Cave`,palette:(a)=>`${a.name}-Cave`},HOUSE$$module$js$rom$location={subArea:"house",palette:()=>Symbol()},FORTUNE_TELLER$$module$js$rom$location={subArea:"house",palette:()=>Symbol(),music:(a)=>`${a.name}-FortuneTeller`},MESIA$$module$js$rom$location={name:"mesia",music:(a)=>
...
KARMINE_UPPER$$module$js$rom$location={name:"goa 4",music:"goa 4",palette:"goa 4"},KARMINE_LOWER$$module$js$rom$location=Object.assign({},KARMINE_UPPER$$module$js$rom$location,{palette:"goa 4 lower"}),$$$module$js$rom$location=(()=>{function a(a,e){e=void 0===e?{}:e;e=Object.assign({},e);c=e.area=e.area||c;return b(a,e)}const b=initializer$$module$js$rom$util();let c;a.commit=(a)=>{b.commit(a,(b,c,d)=>{b=upperCamelToSpaces$$module$js$rom$util(b);const e=d.area,f="function"===typeof d.music?d.music(e):
null!=d.music?d.music:e.name,g="function"===typeof d.palette?d.palette(e):d.palette||e.name;b={area:e,name:b,music:f,palette:g};null!=d.subArea&&(b.subArea=d.subArea);null!=d.bossScreen&&(b.bossScreen=d.bossScreen);d=new Location$$module$js$rom$location(a.rom,c,b);0<=c&&(a[c]=d);return d})};return a})();
class Locations$$module$js$rom$location extends Array{constructor(a){super(256);this.rom=a;this.MezameShrine=$$$module$js$rom$location(0,{area:module$js$rom$area.Areas.Mezame});this.Leaf_OutsideStart=$$$module$js$rom$location(1,{music:1});this.Leaf=$$$module$js$rom$location(2,{area:module$js$rom$area.Areas.Leaf});this.ValleyOfWind=$$$module$js$rom$location(3,{area:module$js$rom$area.Areas.ValleyOfWind});this.SealedCave1=$$$module$js$rom$location(4,{area:module$js$rom$area.Areas.SealedCave});this.SealedCave2=
$$$module$js$rom$location(5);this.SealedCave6=$$$module$js$rom$location(6);this.SealedCave4=$$$module$js$rom$location(7);this.SealedCave5=$$$module$js$rom$location(8);this.SealedCave3=$$$module$js$rom$location(9);this.SealedCave7=$$$module$js$rom$location(10,{bossScreen:145});this.SealedCave8=$$$module$js$rom$location(12);this.WindmillCave=$$$module$js$rom$location(14,{area:module$js$rom$area.Areas.WindmillCave});this.Windmill=$$$module$js$rom$location(15,{area:module$js$rom$area.Areas.Windmill,music:0});
this.ZebuCave=$$$module$js$rom$location(16,{area:module$js$rom$area.Areas.ZebuCave});this.MtSabreWest_Cave1=$$$module$js$rom$location(17,Object.assign({},{area:module$js$rom$area.Areas.MtSabreWest},CAVE$$module$js$rom$location));this.CordelPlainWest=$$$module$js$rom$location(20,{area:module$js$rom$area.Areas.CordelPlain});this.CordelPlainEast=$$$module$js$rom$location(21);this.Brynmaer=$$$module$js$rom$location(24,{area:module$js$rom$area.Areas.Brynmaer});this.OutsideStomHouse=$$$module$js$rom$location(25,
{area:module$js$rom$area.Areas.StomHouse,music:0});this.Swamp=$$$module$js$rom$location(26,{area:module$js$rom$area.Areas.Swamp,bossScreen:124});this.Amazones=$$$module$js$rom$location(27,{area:module$js$rom$area.Areas.Amazones,fixed:[13,14]});this.Oak=$$$module$js$rom$location(28,{area:module$js$rom$area.Areas.Oak});this.StomHouse=$$$module$js$rom$location(30,{area:module$js$rom$area.Areas.StomHouse});this.MtSabreWest_Lower=$$$module$js$rom$location(32,{area:module$js$rom$area.Areas.MtSabreWest});
this.MtSabreWest_Upper=$$$module$js$rom$location(33);this.MtSabreWest_Cave2=$$$module$js$rom$location(34,CAVE$$module$js$rom$location);this.MtSabreWest_Cave3=$$$module$js$rom$location(35,CAVE$$module$js$rom$location);this.MtSabreWest_Cave4=$$$module$js$rom$location(36,CAVE$$module$js$rom$location);this.MtSabreWest_Cave5=$$$module$js$rom$location(37,CAVE$$module$js$rom$location);this.MtSabreWest_Cave6=$$$module$js$rom$location(38,CAVE$$module$js$rom$location);this.MtSabreWest_Cave7=$$$module$js$rom$location(39,
CAVE$$module$js$rom$location);this.MtSabreNorth_Main=$$$module$js$rom$location(40,{area:module$js$rom$area.Areas.MtSabreNorth,bossScreen:181});this.MtSabreNorth_Middle=$$$module$js$rom$location(41);this.MtSabreNorth_Cave2=$$$module$js$rom$location(42,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave3=$$$module$js$rom$location(43,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave4=$$$module$js$rom$location(44,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave5=$$$module$js$rom$location(45,CAVE$$module$js$rom$location);
this.MtSabreNorth_Cave6=$$$module$js$rom$location(46,CAVE$$module$js$rom$location);this.MtSabreNorth_PrisonHall=$$$module$js$rom$location(47,CAVE$$module$js$rom$location);this.MtSabreNorth_LeftCell=$$$module$js$rom$location(48,CAVE$$module$js$rom$location);this.MtSabreNorth_LeftCell2=$$$module$js$rom$location(49,CAVE$$module$js$rom$location);this.MtSabreNorth_RightCell=$$$module$js$rom$location(50,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave8=$$$module$js$rom$location(51,CAVE$$module$js$rom$location);
this.MtSabreNorth_Cave9=$$$module$js$rom$location(52,CAVE$$module$js$rom$location);this.MtSabreNorth_SummitCave=$$$module$js$rom$location(53,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave1=$$$module$js$rom$location(56,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave7=$$$module$js$rom$location(57,CAVE$$module$js$rom$location);this.Nadare_Inn=$$$module$js$rom$location(60,Object.assign({},{area:module$js$rom$area.Areas.Nadare},HOUSE$$module$js$rom$location));this.Nadare_ToolShop=$$$module$js$rom$location(61,
HOUSE$$module$js$rom$location);this.Nadare_BackRoom=$$$module$js$rom$location(62,HOUSE$$module$js$rom$location);this.WaterfallValleyNorth=$$$module$js$rom$location(64,{area:module$js$rom$area.Areas.WaterfallValley});this.WaterfallValleySouth=$$$module$js$rom$location(65);this.LimeTreeValley=$$$module$js$rom$location(66,{area:module$js$rom$area.Areas.LimeTreeValley,music:0});this.LimeTreeLake=$$$module$js$rom$location(67,{area:module$js$rom$area.Areas.LimeTreeLake,music:0});this.KirisaPlantCave1=$$$module$js$rom$location(68,
{area:module$js$rom$area.Areas.KirisaPlantCave});this.KirisaPlantCave2=$$$module$js$rom$location(69);this.KirisaPlantCave3=$$$module$js$rom$location(70);this.KirisaMeadow=$$$module$js$rom$location(71,{area:module$js$rom$area.Areas.KirisaMeadow});this.FogLampCave1=$$$module$js$rom$location(72,{area:module$js$rom$area.Areas.FogLampCave});this.FogLampCave2=$$$module$js$rom$location(73);this.FogLampCave3=$$$module$js$rom$location(74);this.FogLampCaveDeadEnd=$$$module$js$rom$location(75);this.FogLampCave4=
$$$module$js$rom$location(76);this.FogLampCave5=$$$module$js$rom$location(77);this.FogLampCave6=$$$module$js$rom$location(78);this.FogLampCave7=$$$module$js$rom$location(79);this.Portoa=$$$module$js$rom$location(80,{area:module$js$rom$area.Areas.Portoa});this.Portoa_FishermanIsland=$$$module$js$rom$location(81,{area:module$js$rom$area.Areas.FishermanHouse,music:0});this.MesiaShrine=$$$module$js$rom$location(82,Object.assign({},{area:module$js$rom$area.Areas.LimeTreeLake},MESIA$$module$js$rom$location));
this.WaterfallCave1=$$$module$js$rom$location(84,{area:module$js$rom$area.Areas.WaterfallCave});this.WaterfallCave2=$$$module$js$rom$location(85);this.WaterfallCave3=$$$module$js$rom$location(86);this.WaterfallCave4=$$$module$js$rom$location(87);this.TowerEntrance=$$$module$js$rom$location(88,{area:module$js$rom$area.Areas.Tower});this.Tower1=$$$module$js$rom$location(89);this.Tower2=$$$module$js$rom$location(90);this.Tower3=$$$module$js$rom$location(91);this.TowerOutsideMesia=$$$module$js$rom$location(92);
this.TowerOutsideDyna=$$$module$js$rom$location(93);this.TowerMesia=$$$module$js$rom$location(94,MESIA$$module$js$rom$location);this.TowerDyna=$$$module$js$rom$location(95,DYNA$$module$js$rom$location);this.AngrySea=$$$module$js$rom$location(96,{area:module$js$rom$area.Areas.AngrySea});this.BoatHouse=$$$module$js$rom$location(97);this.JoelLighthouse=$$$module$js$rom$location(98,{area:module$js$rom$area.Areas.Lighthouse,music:0});this.UndergroundChannel=$$$module$js$rom$location(100,{area:module$js$rom$area.Areas.UndergroundChannel});
this.ZombieTown=$$$module$js$rom$location(101,{area:module$js$rom$area.Areas.ZombieTown});this.EvilSpiritIsland1=$$$module$js$rom$location(104,{area:module$js$rom$area.Areas.EvilSpiritIslandEntrance,music:1});this.EvilSpiritIsland2=$$$module$js$rom$location(105,{area:module$js$rom$area.Areas.EvilSpiritIsland});this.EvilSpiritIsland3=$$$module$js$rom$location(106);this.EvilSpiritIsland4=$$$module$js$rom$location(107);this.SaberaPalace1=$$$module$js$rom$location(108,{area:module$js$rom$area.Areas.SaberaFortress,
bossScreen:253});this.SaberaPalace2=$$$module$js$rom$location(109);this.SaberaPalace3=$$$module$js$rom$location(110,{bossScreen:253});this.JoelSecretPassage=$$$module$js$rom$location(112,{area:module$js$rom$area.Areas.JoelPassage});this.Joel=$$$module$js$rom$location(113,{area:module$js$rom$area.Areas.Joel});this.Swan=$$$module$js$rom$location(114,{area:module$js$rom$area.Areas.Swan,music:1});this.SwanGate=$$$module$js$rom$location(115,{area:module$js$rom$area.Areas.SwanGate,music:1});this.GoaValley=
$$$module$js$rom$location(120,{area:module$js$rom$area.Areas.GoaValley});this.MtHydra=$$$module$js$rom$location(124,{area:module$js$rom$area.Areas.MtHydra});this.MtHydra_Cave1=$$$module$js$rom$location(125,CAVE$$module$js$rom$location);this.MtHydra_OutsideShyron=$$$module$js$rom$location(126,{fixed:[13,14]});this.MtHydra_Cave2=$$$module$js$rom$location(127,CAVE$$module$js$rom$location);this.MtHydra_Cave3=$$$module$js$rom$location(128,CAVE$$module$js$rom$location);this.MtHydra_Cave4=$$$module$js$rom$location(129,
CAVE$$module$js$rom$location);this.MtHydra_Cave5=$$$module$js$rom$location(130,CAVE$$module$js$rom$location);this.MtHydra_Cave6=$$$module$js$rom$location(131,CAVE$$module$js$rom$location);this.MtHydra_Cave7=$$$module$js$rom$location(132,CAVE$$module$js$rom$location);this.MtHydra_Cave8=$$$module$js$rom$location(133,CAVE$$module$js$rom$location);this.MtHydra_Cave9=$$$module$js$rom$location(134,CAVE$$module$js$rom$location);this.MtHydra_Cave10=$$$module$js$rom$location(135,CAVE$$module$js$rom$location);
this.Styx1=$$$module$js$rom$location(136,{area:module$js$rom$area.Areas.Styx});this.Styx2=$$$module$js$rom$location(137);this.Styx3=$$$module$js$rom$location(138);this.Shyron=$$$module$js$rom$location(140,{area:module$js$rom$area.Areas.Shyron});this.Goa=$$$module$js$rom$location(142,{area:module$js$rom$area.Areas.Goa});this.GoaFortressBasement=$$$module$js$rom$location(143,{area:module$js$rom$area.Areas.FortressBasement,music:0});this.Desert1=$$$module$js$rom$location(144,{area:module$js$rom$area.Areas.Desert1});
this.OasisCaveMain=$$$module$js$rom$location(145,{area:module$js$rom$area.Areas.OasisCave});this.DesertCave1=$$$module$js$rom$location(146,{area:module$js$rom$area.Areas.DesertCave1,music:0});this.Sahara=$$$module$js$rom$location(147,{area:module$js$rom$area.Areas.Sahara});this.SaharaOutsideCave=$$$module$js$rom$location(148,{music:0});this.DesertCave2=$$$module$js$rom$location(149,{area:module$js$rom$area.Areas.DesertCave2,music:1});this.SaharaMeadow=$$$module$js$rom$location(150,{area:module$js$rom$area.Areas.SaharaMeadow,
music:0});this.Desert2=$$$module$js$rom$location(152,{area:module$js$rom$area.Areas.Desert2});this.Pyramid_Entrance=$$$module$js$rom$location(156,{area:module$js$rom$area.Areas.Pyramid});this.Pyramid_Branch=$$$module$js$rom$location(157);this.Pyramid_Main=$$$module$js$rom$location(158);this.Pyramid_Draygon=$$$module$js$rom$location(159);this.Crypt_Entrance=$$$module$js$rom$location(160,{area:module$js$rom$area.Areas.Crypt});this.Crypt_Hall1=$$$module$js$rom$location(161);this.Crypt_Branch=$$$module$js$rom$location(162);
this.Crypt_DeadEndLeft=$$$module$js$rom$location(163);this.Crypt_DeadEndRight=$$$module$js$rom$location(164);this.Crypt_Hall2=$$$module$js$rom$location(165);this.Crypt_Draygon2=$$$module$js$rom$location(166);this.Crypt_Teleporter=$$$module$js$rom$location(167,{music:"Crypt-Teleporter"});this.GoaFortress_Entrance=$$$module$js$rom$location(168,{area:module$js$rom$area.Areas.GoaFortress,music:1});this.GoaFortress_Kelbesque=$$$module$js$rom$location(169,Object.assign({},{bossScreen:115},KELBESQUE$$module$js$rom$location));
this.GoaFortress_Zebu=$$$module$js$rom$location(170,Object.assign({},KELBESQUE$$module$js$rom$location,{palette:1}));this.GoaFortress_Sabera=$$$module$js$rom$location(171,SABERA$$module$js$rom$location);this.GoaFortress_Tornel=$$$module$js$rom$location(172,Object.assign({},{bossScreen:145},SABERA$$module$js$rom$location,{palette:1}));this.GoaFortress_Mado1=$$$module$js$rom$location(173,MADO_LOWER$$module$js$rom$location);this.GoaFortress_Mado2=$$$module$js$rom$location(174,MADO_UPPER$$module$js$rom$location);
this.GoaFortress_Mado3=$$$module$js$rom$location(175,MADO_UPPER$$module$js$rom$location);this.GoaFortress_Karmine1=$$$module$js$rom$location(176,KARMINE_UPPER$$module$js$rom$location);this.GoaFortress_Karmine2=$$$module$js$rom$location(177,KARMINE_UPPER$$module$js$rom$location);this.GoaFortress_Karmine3=$$$module$js$rom$location(178,KARMINE_UPPER$$module$js$rom$location);this.GoaFortress_Karmine4=$$$module$js$rom$location(179,KARMINE_UPPER$$module$js$rom$location);this.GoaFortress_Karmine5=$$$module$js$rom$location(180,
KARMINE_UPPER$$module$js$rom$location);this.GoaFortress_Karmine6=$$$module$js$rom$location(181,KARMINE_LOWER$$module$js$rom$location);this.GoaFortress_Karmine7=$$$module$js$rom$location(182,Object.assign({},{bossScreen:253},KARMINE_LOWER$$module$js$rom$location));this.GoaFortress_Exit=$$$module$js$rom$location(183,{music:0});this.OasisCave_Entrance=$$$module$js$rom$location(184,{area:module$js$rom$area.Areas.OasisEntrance,music:2});this.GoaFortress_Asina=$$$module$js$rom$location(185,Object.assign({},
{area:module$js$rom$area.Areas.GoaFortress},MADO_UPPER$$module$js$rom$location,{bossScreen:145}));this.GoaFortress_Kensu=$$$module$js$rom$location(186,KARMINE_UPPER$$module$js$rom$location);this.Goa_House=$$$module$js$rom$location(187,Object.assign({},{area:module$js$rom$area.Areas.Goa},HOUSE$$module$js$rom$location));this.Goa_Inn=$$$module$js$rom$location(188,HOUSE$$module$js$rom$location);this.Goa_ToolShop=$$$module$js$rom$location(190,HOUSE$$module$js$rom$location);this.Goa_Tavern=$$$module$js$rom$location(191,
HOUSE$$module$js$rom$location);this.Leaf_ElderHouse=$$$module$js$rom$location(192,Object.assign({},{area:module$js$rom$area.Areas.Leaf},HOUSE$$module$js$rom$location));this.Leaf_RabbitHut=$$$module$js$rom$location(193,HOUSE$$module$js$rom$location);this.Leaf_Inn=$$$module$js$rom$location(194,HOUSE$$module$js$rom$location);this.Leaf_ToolShop=$$$module$js$rom$location(195,HOUSE$$module$js$rom$location);this.Leaf_ArmorShop=$$$module$js$rom$location(196,HOUSE$$module$js$rom$location);this.Leaf_StudentHouse=
$$$module$js$rom$location(197,HOUSE$$module$js$rom$location);this.Brynmaer_Tavern=$$$module$js$rom$location(198,Object.assign({},{area:module$js$rom$area.Areas.Brynmaer},HOUSE$$module$js$rom$location));this.Brynmaer_PawnShop=$$$module$js$rom$location(199,HOUSE$$module$js$rom$location);this.Brynmaer_Inn=$$$module$js$rom$location(200,HOUSE$$module$js$rom$location);this.Brynmaer_ArmorShop=$$$module$js$rom$location(201,HOUSE$$module$js$rom$location);this.Brynmaer_ItemShop=$$$module$js$rom$location(203,
HOUSE$$module$js$rom$location);this.Oak_ElderHouse=$$$module$js$rom$location(205,Object.assign({},{area:module$js$rom$area.Areas.Oak},HOUSE$$module$js$rom$location));this.Oak_MotherHouse=$$$module$js$rom$location(206,HOUSE$$module$js$rom$location);this.Oak_ToolShop=$$$module$js$rom$location(207,HOUSE$$module$js$rom$location);this.Oak_Inn=$$$module$js$rom$location(208,HOUSE$$module$js$rom$location);this.Amazones_Inn=$$$module$js$rom$location(209,Object.assign({},{area:module$js$rom$area.Areas.Amazones},
HOUSE$$module$js$rom$location));this.Amazones_ItemShop=$$$module$js$rom$location(210,HOUSE$$module$js$rom$location);this.Amazones_ArmorShop=$$$module$js$rom$location(211,HOUSE$$module$js$rom$location);this.Amazones_Elder=$$$module$js$rom$location(212,HOUSE$$module$js$rom$location);this.Nadare=$$$module$js$rom$location(213,{area:module$js$rom$area.Areas.Nadare});this.Portoa_FishermanHouse=$$$module$js$rom$location(214,Object.assign({},{area:module$js$rom$area.Areas.FishermanHouse},HOUSE$$module$js$rom$location,
{music:0}));this.Portoa_PalaceEntrance=$$$module$js$rom$location(215,{area:module$js$rom$area.Areas.PortoaPalace});this.Portoa_FortuneTeller=$$$module$js$rom$location(216,Object.assign({},{area:module$js$rom$area.Areas.Portoa,fixed:[13,14]},FORTUNE_TELLER$$module$js$rom$location));this.Portoa_PawnShop=$$$module$js$rom$location(217,HOUSE$$module$js$rom$location);this.Portoa_ArmorShop=$$$module$js$rom$location(218,HOUSE$$module$js$rom$location);this.Portoa_Inn=$$$module$js$rom$location(220,HOUSE$$module$js$rom$location);
this.Portoa_ToolShop=$$$module$js$rom$location(221,HOUSE$$module$js$rom$location);this.PortoaPalace_Left=$$$module$js$rom$location(222,Object.assign({},{area:module$js$rom$area.Areas.PortoaPalace},HOUSE$$module$js$rom$location));this.PortoaPalace_ThroneRoom=$$$module$js$rom$location(223,HOUSE$$module$js$rom$location);this.PortoaPalace_Right=$$$module$js$rom$location(224,HOUSE$$module$js$rom$location);this.Portoa_AsinaRoom=$$$module$js$rom$location(225,Object.assign({},{area:module$js$rom$area.Areas.UndergroundChannel},
HOUSE$$module$js$rom$location,{music:"asina"}));this.Amazones_ElderDownstairs=$$$module$js$rom$location(226,Object.assign({},{area:module$js$rom$area.Areas.Amazones},HOUSE$$module$js$rom$location));this.Joel_ElderHouse=$$$module$js$rom$location(227,Object.assign({},{area:module$js$rom$area.Areas.Joel},HOUSE$$module$js$rom$location));this.Joel_Shed=$$$module$js$rom$location(228,HOUSE$$module$js$rom$location);this.Joel_ToolShop=$$$module$js$rom$location(229,HOUSE$$module$js$rom$location);this.Joel_Inn=
$$$module$js$rom$location(231,HOUSE$$module$js$rom$location);this.ZombieTown_House=$$$module$js$rom$location(232,Object.assign({},{area:module$js$rom$area.Areas.ZombieTown},HOUSE$$module$js$rom$location));this.ZombieTown_HouseBasement=$$$module$js$rom$location(233,HOUSE$$module$js$rom$location);this.Swan_ToolShop=$$$module$js$rom$location(235,Object.assign({},{area:module$js$rom$area.Areas.Swan},HOUSE$$module$js$rom$location));this.Swan_StomHut=$$$module$js$rom$location(236,HOUSE$$module$js$rom$location);
this.Swan_Inn=$$$module$js$rom$location(237,HOUSE$$module$js$rom$location);this.Swan_ArmorShop=$$$module$js$rom$location(238,HOUSE$$module$js$rom$location);this.Swan_Tavern=$$$module$js$rom$location(239,HOUSE$$module$js$rom$location);this.Swan_PawnShop=$$$module$js$rom$location(240,HOUSE$$module$js$rom$location);this.Swan_DanceHall=$$$module$js$rom$location(241,HOUSE$$module$js$rom$location);this.Shyron_Temple=$$$module$js$rom$location(242,{area:module$js$rom$area.Areas.ShyronTemple,bossScreen:112});
this.Shyron_TrainingHall=$$$module$js$rom$location(243,Object.assign({},{area:module$js$rom$area.Areas.Shyron},HOUSE$$module$js$rom$location));this.Shyron_Hospital=$$$module$js$rom$location(244,HOUSE$$module$js$rom$location);this.Shyron_ArmorShop=$$$module$js$rom$location(245,HOUSE$$module$js$rom$location);this.Shyron_ToolShop=$$$module$js$rom$location(246,HOUSE$$module$js$rom$location);this.Shyron_Inn=$$$module$js$rom$location(247,HOUSE$$module$js$rom$location);this.Sahara_Inn=$$$module$js$rom$location(248,
Object.assign({},{area:module$js$rom$area.Areas.Sahara},HOUSE$$module$js$rom$location));this.Sahara_ToolShop=$$$module$js$rom$location(249,HOUSE$$module$js$rom$location);this.Sahara_ElderHouse=$$$module$js$rom$location(250,HOUSE$$module$js$rom$location);this.Sahara_PawnShop=$$$module$js$rom$location(251,HOUSE$$module$js$rom$location);this.EastCave1=$$$module$js$rom$location(-1,{area:module$js$rom$area.Areas.EastCave});this.EastCave2=$$$module$js$rom$location(-1);this.EastCave3=$$$module$js$rom$location(-1);
this.FishermanBeach=$$$module$js$rom$location(-1,Object.assign({},{area:module$js$rom$area.Areas.FishermanHouse},HOUSE$$module$js$rom$location));this.locsByScreen=new DefaultMap$$module$js$util(()=>[]);$$$module$js$rom$location.commit(this);for(let b=0;256>b;b++)this[b]?this.indexScreens(this[b]):this[b]=new Location$$module$js$rom$location(a,b,{area:module$js$rom$area.Areas.Unused,name:"",music:"",palette:""})}indexScreens(a){for(const b of a.screens)for(const c of b)this.locsByScreen.get(c).push(a)}renumberScreen(a,
b){var c=this.locsByScreen.get(a);this.locsByScreen.set(b,c);this.locsByScreen.delete(a);for(const d of c)for(const e of d.screens)for(c=0;c<e.length;c++)e[c]===a&&(e[c]=b)}allocate(a){for(const b of this)if(!b.used)return a.id=b.id,a.used=!0,this.indexScreens(a),this[b.id]=a;throw Error("No unused location");}write(){const a=this.rom.assembler();free$$module$js$rom$util(a,$0a$$module$js$rom$location,34040,40960);free$$module$js$rom$util(a,$0b$$module$js$rom$location,40960,48640);free$$module$js$rom$util(a,
$0c$$module$js$rom$location,37881,40960);free$$module$js$rom$util(a,$0d$$module$js$rom$location,40960,44032);free$$module$js$rom$util(a,$0d$$module$js$rom$location,44544,49152);for(const b of this)b.assemble(a);return[a.module()]}copyFromMeta(){this.CordelPlainEast.meta.reconcileExits(this.CordelPlainWest.meta);for(const a of this)a.used&&(a.exits=[],a.entrances=[]);for(const a of this)a.used&&a.meta.write()}}
class Location$$module$js$rom$location extends Entity$$module$js$rom$entity{constructor(a,b,c){super(a,b);this.data=c;this._meta=this._isShop=void 0;var d=0<=b?readLittleEndian$$module$js$rom$util(a.prg,this.mapDataPointer)+49152:0;if(this.used=49152<d&&!!this.name){var e=readLittleEndian$$module$js$rom$util(a.prg,d)+49152;b=readLittleEndian$$module$js$rom$util(a.prg,d+2)+49152;c=readLittleEndian$$module$js$rom$util(a.prg,d+4)+49152;var f=readLittleEndian$$module$js$rom$util(a.prg,d+6)+49152,g=readLittleEndian$$module$js$rom$util(a.prg,
d+8)+49152,h=this.used&&e!==d+10,k=f-c;this.exits=(()=>{const b=[];let c=f;for(;!(a.prg[c]&128);)255!=a.prg[c+2]&&b.push(Exit$$module$js$rom$locationtables.from(a.prg,c)),c+=4;255!==a.prg[c]&&(h=!!(a.prg[c]&64),k=(a.prg[c]&31)<<2);return b})();d=h?readLittleEndian$$module$js$rom$util(a.prg,d+10)+49152:0;this.bgm=this.originalBgm=a.prg[e];this.layoutWidth=a.prg[e+1];this.layoutHeight=a.prg[e+2];this.animation=a.prg[e+3];var m=a.prg[e+4]?256:0;this.screens=seq$$module$js$rom$util(this.height,(b)=>tuple$$module$js$rom$util(a.prg,
e+5+b*this.width,this.width).map((a)=>m|a));this.tilePalettes=tuple$$module$js$rom$util(a.prg,b,3);this.originalTilePalettes=tuple$$module$js$rom$util(this.tilePalettes,0,3);this.tileset=a.prg[b+3];this.tileEffects=a.prg[b+4];this.tilePatterns=tuple$$module$js$rom$util(a.prg,b+5,2);this.entrances=group$$module$js$rom$util(4,a.prg.slice(c,c+k),(a)=>Entrance$$module$js$rom$locationtables.from(a));this.flags=varSlice$$module$js$rom$util(a.prg,g,2,255,Infinity,(a)=>Flag$$module$js$rom$locationtables.from(a));
this.pits=d?varSlice$$module$js$rom$util(a.prg,d,4,255,Infinity,(a)=>Pit$$module$js$rom$locationtables.from(a)):[];b=readLittleEndian$$module$js$rom$util(a.prg,this.npcDataPointer)+65536;this.spritePalettes=(c=65536!==b)?tuple$$module$js$rom$util(a.prg,b+1,2):[0,0];this.spritePatterns=c?tuple$$module$js$rom$util(a.prg,b+3,2):[0,0];this.spawns=c?varSlice$$module$js$rom$util(a.prg,b+5,4,255,Infinity,(a)=>Spawn$$module$js$rom$locationtables.from(a)):[]}else this.animation=this.layoutHeight=this.layoutWidth=
this.bgm=this.originalBgm=0,this.screens=[[0]],this.tilePalettes=[36,1,38],this.originalTilePalettes=[36,1,38],this.tileset=128,this.tileEffects=179,this.tilePatterns=[2,4],this.exits=[],this.entrances=[],this.flags=[],this.pits=[],this.spawns=[],this.spritePalettes=[0,0],this.spritePatterns=[0,0]}set meta(a){this._meta=a}get meta(){this.ensureMeta();return this._meta}ensureMeta(){this._meta||(this._meta=Metalocation$$module$js$rom$metalocation.of(this))}set musicGroup(a){this._musicGroup=a}get musicGroup(){this.ensureMusicGroup();
return this._musicGroup}ensureMusicGroup(){if(null==this._musicGroup){const a=this.data.music;this._musicGroup="number"!==typeof a?a:this.rom.locations[this.exits[a].dest].musicGroup}}set colorGroup(a){this._colorGroup=a}get colorGroup(){this.ensureColorGroup();return this._colorGroup}ensureColorGroup(){if(null==this._colorGroup){const a=this.data.music;this._colorGroup="number"!==typeof a?a:this.rom.locations[this.exits[a].dest].colorGroup}}lazyInitialization(){this.ensureMeta();this.ensureMusicGroup();
this.ensureColorGroup()}get name(){return this.data.name}get mapDataPointer(){if(0>this.id)throw Error(`no mapdata pointer for ${this.name}`);return 82688+(this.id<<1)}get npcDataPointer(){if(0>this.id)throw Error(`no npcdata pointer for ${this.name}`);return 102913+(this.id<<1)}get hasSpawns(){return 0<this.spawns.length}mapPlane(){const a=new Set;for(const b of this.screens)for(const c of b)a.add(c>>>8);if(1!==a.size)throw Error(`Non-unique screen page: ${[...a].join(", ")}`);return a[Symbol.iterator]().next().value}isShop(){null==
this._isShop&&(this._isShop=0<=this.rom.shops.findIndex((a)=>a.location===this.id));return this._isShop}spawn(a){const b=this.spawns[a-13];if(!b)throw Error(`Expected spawn $${hex$$module$js$rom$util(a)}`);return b}get width(){return this.layoutWidth+1}set width(a){this.layoutWidth=a-1}get height(){return this.layoutHeight+1}set height(a){this.layoutHeight=a-1}findOrAddEntrance(a,b){for(let c=0;c<this.entrances.length;c++){const d=this.entrances[c];if(d.screen===a&&d.coord===b)return c}this.entrances.push(Entrance$$module$js$rom$locationtables.of({screen:a,
coord:b}));return this.entrances.length-1}assemble(a){if(this.used){var b=this.id.toString(16).padStart(2,"0"),c=this.spawns.length?this.spritePalettes:[255,255],d=[],e=[0,...c,...this.spawns.length?this.spritePatterns:[255,255],...concatIterables$$module$js$rom$util(this.spawns),255];a.segment("0c","0d");a.reloc(`NpcData_${b}`);var f=a.pc();a.byte(...e);a.org(37377+(this.id<<1),`NpcData_${b}_Ptr`);a.word(f);a.segment("0a","0b");e=[];for(var g of concatIterables$$module$js$rom$util(this.screens))e.push(g&
255);g=this.rom.compressedMapData?[this.bgm,this.layoutHeight<<4|this.layoutWidth,this.mapPlane()<<2|this.animation,...e]:[this.bgm,this.layoutWidth,this.layoutHeight,this.animation,this.mapPlane()?128:0,...e];a.reloc(`MapData_${b}_Layout`);e=a.pc();a.byte(...g);d.push(e);a.reloc(`MapData_${b}_Graphics`);g=a.pc();a.byte(...this.tilePalettes,this.tileset,this.tileEffects,...this.tilePatterns);d.push(g);if(1===this.height){for(var h of this.entrances)h.used&&191<h.y&&(h.y=191);for(var k of this.exits)12<
k.yt&&(k.yt=12)}a.reloc(`MapData_${b}_Entrances`);h=a.pc();a.byte(...concatIterables$$module$js$rom$util(this.entrances));d.push(h);a.reloc(`MapData_${b}_Exits`);h=a.pc();a.byte(...concatIterables$$module$js$rom$util(this.exits),128|(this.pits.length?64:0)|this.entrances.length);d.push(h);a.reloc(`MapData_${b}_Flags`);h=a.pc();a.byte(...concatIterables$$module$js$rom$util(this.flags),255);d.push(h);h=concatIterables$$module$js$rom$util(this.pits);h.length&&(a.reloc(`MapData_${b}_Pits`),k=a.pc(),a.byte(...h),
d.push(k));a.reloc(`MapData_${b}`);h=a.pc();a.word(...d);a.org(33536+(this.id<<1),`MapData_${b}_Ptr`);a.word(h);b=this.bossId();if(null!=b&&95!==this.id){d=this.rom.bossKills[b].base;h=[,,,166===this.id?0:this.bgm,,...this.tilePalettes,,,,this.spritePalettes[0],,,,,,,,this.animation];a.segment("0f");for(k=0;k<h.length;k++)g=h[k],null!=g&&(a.org(d+k,`Boss_${b}_${k}`),a.byte(g));a.org(47041+5*b,`Boss_${b}_Post`);a.byte(c[1])}}}allScreens(){const a=new Set;for(const b of this.screens)for(const c of b)a.add(this.rom.screens[c]);
return a}bossId(){for(let a=0;14>a;a++)if(this.rom.prg[129373+a]===this.id)return a}hasDolphin(){return 96===this.id||100===this.id||104===this.id}reachableTiles(a){a=void 0===a?!1:a;this.hasDolphin()&&(a=!0);const b=new Set(this.exits.map((a)=>a.screen<<8|a.tile));var c=new UnionFind$$module$js$unionfind;const d=this.rom.tilesets[this.tileset],e=this.rom.tileEffects[this.tileEffects-179];var f=new Set;for(let c=0;c<this.height;c++){const h=this.screens[c];for(let k=0;k<this.width;k++){const l=this.rom.screens[h[k]],
m=c<<4|k,r=this.flags.find((a)=>a.screen===m);for(let c=0;240>c;c++){const h=m<<8|c;if(b.has(h))continue;let k=l.tiles[c];var g=e.effects[k];g=a?g&4:g&6;r&&g&&32>k&&d.alternates[k]!=k&&(k=d.alternates[k],g=e.effects[k],g=a?g&4:g&6);g||f.add(h)}}}for(let b of f)a=15===(b&15)?b+241:b+1,f.has(a)&&c.union([b,a]),a=224===(b&240)?b+3872:b+16,f.has(a)&&c.union([b,a]);f=c.map();c=new Set;for(var h of this.entrances)h.used&&c.add(f.get(h.screen<<8|h.tile)||new Set);h=new Map;for(const a of c)for(const b of a)h.set(b,
e.effects[this.rom.screens[this.screens[b>>>12][b>>>8&15]].tiles[b&255]]);return h}screenMover(){const a=new DefaultMap$$module$js$util(()=>[]),b=module$js$util.iters.concat(this.spawns,this.exits,this.entrances);for(const c of b)a.get(c.screen).push(c);return(b,d)=>{for(const c of a.get(b))c.screen=d}}moveScreen(a,b){const c=module$js$util.iters.concat(this.spawns,this.exits,this.entrances);for(const d of c)d.screen===a&&(d.screen=b)}monsterPlacer(a){const b=this.data.bossScreen,c=this.reachableTiles(!1),
d=new Map([...c.keys()].map((a)=>[a,0])),e=[],f=[],g=[],h=[],k=[],m=this.hasDolphin()?37:39;for(const a of d){const [k,l]=a;{const a=this.screens[k>>>12][k>>>8&15];if(a!==b){for(const a of neighbors$$module$js$rom$location(k,this.width,this.height))d.has(a)||d.set(a,l+1);l||c.get(k)&m||e.push(k);26===this.id?240===this.rom.screens[a].tiles[k&255]&&h.push(k):2<=l&&4>=l&&h.push(k);3<=l&&7>=l&&f.push(k);12<=l&&g.push(k)}}}return(b)=>{var c=b.placement();c=[..."normal"===c?e:"moth"===c?f:"bird"===c?g:
"plant"===c?h:assertNever$$module$js$util(c)];a:for(;c.length;){var d=a.nextInt(c.length),[l]=c.splice(d,1);d=(l&3840)>>>4|l&15;l=(l&61440)>>>8|(l&240)>>>4;const e=b.clearance();for(const a of k){const [,b,c,f]=a;if(Math.pow(l-c,2)+Math.pow(d-b,2)<Math.pow(e+f,2))continue a}for(const a of this.entrances){const {x:b,y:c,used:f}=a;if(f&&Math.pow(l-(c>>4),2)+Math.pow(d-(b>>4),2)<Math.pow(e+1,2))continue a}k.push([b,d,l,e]);return(l&240|(d&240)>>>4)<<8|(l&15)<<4|d&15}}}resizeScreens(a,b,c,d,e){e=void 0===
e?0:e;const f=this.width+b+d;c=this.height+a+c;d=Array.from({length:c},(c,d)=>{d-=a;return Array.from({length:f},(a,c)=>{c-=b;return 0>d||0>c||d>=this.height||c>=this.width?e:this.screens[d][c]})});this.width=f;this.height=c;this.screens=d;for(const c of this.flags)c.xs+=b,c.ys+=a;for(const c of this.pits)c.fromXs+=b,c.fromYs+=a;for(const c of[...this.spawns,...this.exits])c.xt+=16*b,c.yt+=16*a;for(const c of this.entrances)c.used&&(c.x+=256*b,c.y+=256*a)}writeScreens2d(a,b){const c=a&15;a>>>=4;for(let d=
0;d<b.length;d++){const e=b[d];for(let b=0;b<e.length;b++){let f=e[b];null!=f&&(0>f&&(f=~f,this.flags.push(Flag$$module$js$rom$locationtables.of({screen:a+d<<4|c+b,flag:this.rom.flags.AlwaysTrue.id}))),this.screens[a+d][c+b]=f)}}}connect(a,b,c){var d=0>a?256:0,e=0>c?256:0;a=0>a?~a:a;c=0>c?~c:c;const f=a>>>4,g=a&15,h=c>>>4,k=c&15,[m,l]=screenExits$$module$js$rom$location[d|this.screens[f][g]],[n,p]=screenExits$$module$js$rom$location[e|b.screens[h][k]];d=this.entrances.length;e=b.entrances.length;
this.entrances.push(Entrance$$module$js$rom$locationtables.of({y:f<<8|m>>>8,x:g<<8|m&255}));b.entrances.push(Entrance$$module$js$rom$locationtables.of({y:h<<8|n>>>8,x:k<<8|n&255}));for(const c of l)this.exits.push(Exit$$module$js$rom$locationtables.of({screen:a,tile:c,dest:b.id,entrance:e}));for(const a of p)b.exits.push(Exit$$module$js$rom$locationtables.of({screen:c,tile:a,dest:this.id,entrance:d}))}neighborForEntrance(a){const b=this.entrances[a];if(!b)throw Error(`no entrance ${hex$$module$js$rom$util(this.id)}:${a}`);
for(const a of this.exits){if(a.screen!==b.screen)continue;const c=Math.abs(a.y-b.y);if(24>Math.abs(a.x-b.x)&&24>c)return this.rom.locations[a.dest]}throw Error(`no exit found near ${hex$$module$js$rom$util(this.id)}:${a}`);}toString(){return`${super.toString()} ${this.name}`}}
function neighbors$$module$js$rom$location(a,b,c){const d=[],e=a&61680,f=a&3855;e<(c-1<<12|224)&&d.push(224===(a&240)?a+3872:a+16);e&&d.push(0===(a&240)?a-3872:a-16);f<(b-1<<8|15)&&d.push(15===(a&15)?a+241:a+1);f&&d.push(0===(a&15)?a-241:a-1);return d}
const screenExits$$module$js$rom$location={21:[37024,[137,138]],25:[24720,[88,89]],150:[16432,[50,51]],151:[44848,[178,179]],152:[16592,[60,61]],153:[45008,[188,189]],154:[8064,[39,40]],158:[57216,[231,232]],193:[20640,[73,74]],194:[24752,[90,91]],410:[53376,[199,200]]};
var module$js$rom$location={get Entrance(){return Entrance$$module$js$rom$locationtables},get Exit(){return Exit$$module$js$rom$locationtables},get Flag(){return Flag$$module$js$rom$locationtables},get Pit(){return Pit$$module$js$rom$locationtables},get Spawn(){return Spawn$$module$js$rom$locationtables}};module$js$rom$location.Locations=Locations$$module$js$rom$location;module$js$rom$location.Location=Location$$module$js$rom$location;const EMPTY_ITERATOR$$module$js$rom$constraint={next(){return{done:!0}}},NONE$$module$js$rom$constraint={get size(){return 0},has(){return!1},[Symbol.iterator](){return EMPTY_ITERATOR$$module$js$rom$constraint}},ALL$$module$js$rom$constraint={get size(){return Infinity},has(){return!0},[Symbol.iterator](){throw Error("cannot iterate");}};
...
module$js$maze$types.Scr.edge(c[1],c[2]);yield c}}*eligible(a,b){b=void 0===b?{}:b;const {allowed:c,skipAlternates:d,maxExits:e,edge:f,fuzzy:g,stair:h}=b;var k=null!=f?f|f<<4|f<<8|f<<12:void 0;let m=b=0,l=0;for(var n of module$js$maze$types.Dir.ALL){var p=module$js$maze$types.Dir.edgeMask(n),r=module$js$maze$types.Dir.edgeMask(module$js$maze$types.Dir.inv(n));let c=this.get(a,n);null==c&&(c=k);null!=c&&(l|=((c&r)>>>8|(c&r)<<8)&65535,b|=p,g&&this.isFixed(module$js$maze$types.Pos.plus(a,n))&&(m|=p))}g||
(m=b);a=l&m;n=[];k=Infinity;p=c?module$js$util.iters.map(c,(a)=>[a,this.screens.get(a)]):this.screens;for(const c of p){const [f,q]=c;if(!q)throw Error("Bad Scr in 'allowed'!");if(!(q.fixed||d&&q.edges&-65536||null!=h&&!q.stairs.some((a)=>a.dir===h)||null==h&&q.stairs.length||(f&m)!==a||e&&module$js$maze$types.Scr.numExits(f)>e))if(g){p=0;r=f&b^l;for(const a of module$js$maze$types.Dir.ALL)r&15<<module$js$maze$types.Dir.shift(a)&&p++;p<k?(k=p,n=[f]):p===k&&n.push(f)}else yield f}g&&(yield*n)}fill(a,
...
module$js$maze$types.Dir.edgeMask(e);if(h&~f)continue;const k=module$js$maze$types.Pos.plus(a,e);f=this.map[k];if(null==f)break;if(!c.has(f)&&!b.has(f))break;const l=g>>>module$js$maze$types.Dir.shift(e)&15,n=module$js$maze$types.Dir.inv(e),p=module$js$maze$types.Dir.edgeMask(n),r=f&~p|l<<module$js$maze$types.Dir.shift(n);if(c.has(r)&&!c.has(f))break;if(this.saveExcursion(()=>{this.setInternal(a,g);this.setInternal(k,r);return d()}))return!0}}return!1}show(a){a=void 0===a?!1:a;const b=" "+seq$$module$js$rom$util(this.width).join("")+
...
function extendGoaScreens$$module$js$maze$goa(a){for(var b of[140,164,168]){const c=a.tilesets[b];c.alternates[25]=25;c.alternates[27]=27}a.swapMetatiles([164,140],[43,[25,197],-199],[186,[27,197],-197]);a.swapMetatiles([168],[[23,84],-26],[[24,88],-28]);a.swapMetatiles([136],[25,-198],[27,-198]);b=[[25,25],[27,27]];write2d$$module$js$maze$spec(a.screens[224].tiles,97,b);write2d$$module$js$maze$spec(a.screens[225].tiles,109,b);write2d$$module$js$maze$spec(a.screens[226].tiles,145,b);write2d$$module$js$maze$spec(a.screens[227].tiles,
...
209,b);write2d$$module$js$maze$spec(a.screens[232].tiles,221,b);a.locations[169].flags.push(module$js$rom$location.Flag.of({screen:16,flag:751}),module$js$rom$location.Flag.of({screen:32,flag:751}),module$js$rom$location.Flag.of({screen:33,flag:751}),module$js$rom$location.Flag.of({screen:36,flag:751}),module$js$rom$location.Flag.of({screen:37,flag:751}),module$js$rom$location.Flag.of({screen:48,flag:751}),module$js$rom$location.Flag.of({screen:49,flag:751}),module$js$rom$location.Flag.of({screen:51,
flag:751}),module$js$rom$location.Flag.of({screen:52,flag:751}),module$js$rom$location.Flag.of({screen:65,flag:751}),module$js$rom$location.Flag.of({screen:84,flag:751}),module$js$rom$location.Flag.of({screen:98,flag:751}),module$js$rom$location.Flag.of({screen:100,flag:751}),module$js$rom$location.Flag.of({screen:114,flag:751}),module$js$rom$location.Flag.of({screen:116,flag:512}));a.locations.WaterfallCave3.tileset=136}var module$js$maze$goa={};module$js$maze$goa.shuffleGoa1=shuffleGoa1$$module$js$maze$goa;
module$js$maze$goa.extendGoaScreens=extendGoaScreens$$module$js$maze$goa;const MapTypes$$module$js$maze$maze2={Overworld:{" ":"blocked","*":"unmatched",1:"waterfall valley slope",2:"waterfall valley bridge to portoa ",3:"desert oasis ",">":"open right","<":"open left","^":"open top",v:"open bottom",o:"open",l:"long grass",s:"short grass",r:"river",n:"narrow edge exit, centered",b:"boat"},Tower:{" ":"blocked",s:"stairs",t:"corridor"},Cave:{" ":"blocked",w:"wide",c:"corridor",n:"narrow",r:"river",b:"wrong side of bridge",s:"spikes"},Swamp:{" ":"blocked",s:"passage"},Mountain:{" ":"blocked",
p:"path",s:"slope",w:"waterfall",l:"ladder"}},BORDER$$module$js$maze$maze2={uid:65535},EDGE_EXIT$$module$js$maze$maze2={uid:65534};
class NeighborCache$$module$js$maze$maze2{constructor(a){this.allowed=[new Set,new Set];this.neighbors=new DefaultMap$$module$js$util(()=>new Set);for(const d of a){const e=d.data.edges||"****";for(const c of a){var b=c.data.edges||"****";"*"!==e[2]&&e[2]===b[0]&&this.add(2,d,c);"*"!==e[3]&&e[3]===b[1]&&this.add(3,d,c);for(const a of d.data.allowed?d.data.allowed(c):[])this.add(a,d,c)}b=[];for(const {type:a}of d.data.exits||[]){var c=edgeTypeMap$$module$js$maze$maze2[a];null!=c&&(b[c]=EDGE_EXIT$$module$js$maze$maze2)}for(c=
0;4>c;c++){let a=b[c];null==a&&(a=borderMap$$module$js$maze$maze2[e[c]]);null!=a&&this.add(c,d,a)}}}add(a,b,c){b=b.uid;c=c.uid;this.allowed[a&1].add(a&2?b<<16|c:c<<16|b);this.neighbors.get(b<<2|a).add(c);this.neighbors.get(c<<2|a^2).add(b)}check(a,b,c){return this.allowed[c&1].has(0<c?a<<16|b:b<<16|a)}}
const borderMap$$module$js$maze$maze2={"*":BORDER$$module$js$maze$maze2," ":BORDER$$module$js$maze$maze2},edgeTypeMap$$module$js$maze$maze2={"edge:top":0,"edge:left":1,"edge:bottom":2,"edge:right":3},caches$$module$js$maze$maze2=new DefaultMap$$module$js$util((a)=>new NeighborCache$$module$js$maze$maze2(a));function inBounds$$module$js$maze$maze2(a,b,c){return(a&15)<c&&15<a&&a>>>4<=b}
class Maze$$module$js$maze$maze2{constructor(a,b,c,d){this.random=a;this.height=b;this.width=c;this.tileset=d;this.neighbors=caches$$module$js$maze$maze2.get(this.tileset);this.rom=d.rom;this.map=Array(b+2<<4).fill(-1);for(a=0;a<c;a++)this.map[ind$$module$js$maze$maze2(-1,a)]=this.map[ind$$module$js$maze$maze2(b,a)]=BORDER$$module$js$maze$maze2.uid;for(b=0;b<c;b++)this.map[ind$$module$js$maze$maze2(b,-1)]=this.map[ind$$module$js$maze$maze2(b,c)]=BORDER$$module$js$maze$maze2.uid}inBounds(a){return(a&
15)<this.width&&15<a&&a>>>4<=this.height}static from(a,b,c){function d(a,b){a=ind$$module$js$maze$maze2(a,b);l[a]=[65535,65534];n.add(a)}const {rom:e,width:f,height:g}=a;if(!c){c=new Set(e.metatilesets);for(var h of a.allScreens())for(var k of c)k.getMetascreens(h.id).size||c.delete(k);169===a.id?c.delete(e.metatilesets.fortress):c.delete(e.metatilesets.labyrinth);if(!c.size)throw Error("No tileset had all screens.");if(1<c.size)throw Error("Nonunique tileset.");c=[...c][0]}const m=caches$$module$js$maze$maze2.get(c),
l=Array(g+2<<4).fill(void 0),n=new Set;for(h=0;h<g;h++){for(k=0;k<f;k++){const b=ind$$module$js$maze$maze2(h,k),d=[...c.getMetascreens(a.screens[h][k])].map((a)=>a.uid);1<d.length&&n.add(b);l[b]=d}d(h,-1);d(h,f)}for(a=0;a<f;a++)d(-1,a),d(g,a);for(;n.size;){a=!1;h=[...n];n.clear();for(const b of h){h=new Set(l[b]);for(const c of h)[-1,1,-16,16].every((a)=>inBounds$$module$js$maze$maze2(b,g,f)||inBounds$$module$js$maze$maze2(b+a,g,f)?l[b+a].some((b)=>m.check(c,b,a)):!0)||(h.delete(c),a=!0);l[b]=[...h]}if(!a)throw Error("divergence");
}b=new Maze$$module$js$maze$maze2(b,g,f,c);b.map=l.map((a)=>a?a[0]:-1);return b}show(){var a,b;const c=[];let d=[];for(var e=0;e<this.width;e++)d.push(e.toString(16));c.push("   "+d.join("  "));for(e=0;e<this.height;e++)for(let f=0;3>f;f++){d=[1===f?e.toString(16):" "," "];for(let c=0;c<this.width;c++){const g=this.rom.metascreens[this.map[ind$$module$js$maze$maze2(e,c)]];d.push(null!==(b=null===(a=null===g||void 0===g?void 0:g.data.icon)||void 0===a?void 0:a.full[f])&&void 0!==b?b:1===f?" ? ":"   ")}c.push(d.join(""))}return c.join("\n")}}
function ind$$module$js$maze$maze2(a,b){return(a+1<<4)+b}var module$js$maze$maze2={};module$js$maze$maze2.Maze=Maze$$module$js$maze$maze2;function shufflePyramid$$module$js$maze$pyramid(a,b){function c(a,b,c){d.exits[2*a].dest=d.exits[2*a+1].dest=b;d.exits[2*a].entrance=d.exits[2*a+1].entrance=c}const d=a.locations.Pyramid_Main,e="dudududuudududduu".split("");let f="u";.5>b.next()&&(d.screens[0][3]=132,d.screens[0][2]=153,e[16]=f="d",d.entrances[12].screen=d.entrances[16].screen,d.entrances[12].coord=d.entrances[16].coord,d.exits[24].screen=d.exits[32].screen,d.exits[24].tile=d.exits[32].tile,d.exits[25].screen=d.exits[33].screen,d.exits[25].tile=
...
e=module$js$maze$types.Pos.plus(a,c);!d.isFixed(a)&&!d.isFixed(e)&&d.get(a)&module$js$maze$types.Dir.edgeMask(c)?d.saveExcursion(()=>d.replaceEdge(a,c,0)?!!(d.get(a)&&d.get(e)&&f()):!1):p++}if(!d.consolidate(e,f,a))return!1;const [r,q]=b.pick([...d.alternates()]);if(65536!=q)throw Error(`unexpected alt: ${hex$$module$js$rom$util(q)}`);d.replace(r,d.get(r)|q);c.moveScreen(48,m);c.moveScreen(4,k);d.write(c,new Set);e=[];n=[];for(const [a,b]of d)a!==k&&a!==r&&(1!==b&&16!==b&&256!==b&&4096!==b||e.push(a),
17!==b&&272!==b&&4352!==b&&4097!==b||n.push(a));var w=a.screens[c.screens[r>>4][r&15]].tiles;p=0;for(let a=0;240>a;a++)if(3===w[a]){p=a;break}c.entrances[1].screen=r;c.entrances[1].tile=p+17;for(w=0;2>w;w++)c.exits[5+w].screen=r,c.exits[5+w].tile=p+w;e=b.pick(e.length?e:n);c.spawns[1].screen=e;e=c.monsterPlacer(b);for(const b of c.spawns)b.isMonster()&&(n=a.objects[b.monsterId],n instanceof Monster$$module$js$rom$monster&&(p=e(n),null==p?(console.error(`no valid location for ${hex$$module$js$rom$util(n.id)} in ${hex$$module$js$rom$util(c.id)}`),
...
function extendSwampScreens$$module$js$maze$swamp(a){const b=a.metatilesets.swamp;b.getTile(3).copyFrom(218).setAlternative(172);b.getTile(4).copyFrom(228).setAlternative(170);b.getTile(5).copyFrom(229).setAlternative(170);b.getTile(6).copyFrom(230).setAlternative(170);b.getTile(7).copyFrom(231).setAlternative(170);b.getTile(8).copyFrom(240).setAlternative(170);b.getTile(9).copyFrom(241).setAlternative(170);b.getTile(10).copyFrom(242).setAlternative(170);b.getTile(11).copyFrom(243).setAlternative(170);
b.getTile(12).copyFrom(220).setAlternative(170);b.getTile(13).copyFrom(221).setAlternative(170);a.swapMetatiles([160],[[3,172],-219],[[4,170],-229],[[5,170],-230],[[6,170],-231],[[7,170],-232],[[8,170],-241],[[9,170],-242],[[10,170],-243],[[11,170],-244],[[12,170],-221],[[13,170],-222]);write2d$$module$js$maze$spec(a.screens[127].tiles,0,[[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[168,204],[210,204],[210,204],[210,204],[210,226],[226,200]]);write2d$$module$js$maze$spec(a.screens[118].tiles,
76,[[8,9],[12,11],[3,3]]);write2d$$module$js$maze$spec(a.screens[122].tiles,37,[[,,4],[8,9,5],[,10,6],[,11,7],[,3,3]]);write2d$$module$js$maze$spec(a.screens[123].tiles,36,[[4],[],[6],[7,13],[3,3]]);write2d$$module$js$maze$spec(a.screens[126].tiles,71,[[8,9],[12,11],[3,3]])}var module$js$maze$swamp={};module$js$maze$swamp.shuffleSwamp=shuffleSwamp$$module$js$maze$swamp;module$js$maze$swamp.extendSwampScreens=extendSwampScreens$$module$js$maze$swamp;function compressMapData$$module$js$pass$compressmapdata(a){if(!a.compressedMapData){a.compressedMapData=!0;for(let b=0;3>b;b++)a.metascreens.renumber(256|b,320|b),delete a.screens[256|b]}}var module$js$pass$compressmapdata={};module$js$pass$compressmapdata.compressMapData=compressMapData$$module$js$pass$compressmapdata;function crumblingPlatforms$$module$js$pass$crumblingplatforms(a,b){var c=a.objects[159],d=a.objects[127];const e=a.objects[141];e.used=!0;e.name="Crumbling Horizontal Platform";e.sfx=c.sfx;c.data.forEach((a,b)=>e.data[b]=a);e.data[3]=d.data[3];c=new Set([47,61]);d=new Set([46,79]);for(const e of a.locations)if(e.pits.length){a=1>b.nextInt(3);for(const b of e.spawns)b.isMonster()&&(d.has(b.id)&&(b.id=(a?159:126)-80),c.has(b.id)&&(b.id=(a?141:127)-80))}}var module$js$pass$crumblingplatforms={};
module$js$pass$crumblingplatforms.crumblingPlatforms=crumblingPlatforms$$module$js$pass$crumblingplatforms;class MessageId$$module$js$rom$messageid extends DataTuple$$module$js$rom$util{constructor(){super(...arguments);this.action=this.prop([0,248,3]);this.part=this.prop([0,7,-3],[1,224,5]);this.index=this.prop([1,31])}toString(){const a=this.action?` (action ${hex$$module$js$rom$util(this.action)})`:"";return`MessageId ${this.hex()}: (${hex$$module$js$rom$util(this.part)}:${hex$$module$js$rom$util(this.index)}${a}`}get mid(){return`${hex$$module$js$rom$util(this.part)}:${hex$$module$js$rom$util(this.index)}`}set mid(a){const b=
a.split(":");if(2!==b.length)throw Error(`oops: ${a}`);this.part=Number.parseInt(b[0],16);this.index=Number.parseInt(b[1],16);if(isNaN(this.part)||isNaN(this.index))throw Error(`oops: ${a}`);}nonzero(){return!(!this.part&&!this.index)}}MessageId$$module$js$rom$messageid.size=2;var module$js$rom$messageid={};module$js$rom$messageid.MessageId=MessageId$$module$js$rom$messageid;const {$04:$04$$module$js$rom$npc,$05:$05$$module$js$rom$npc,$0e:$0e$$module$js$rom$npc,$1b:$1b$$module$js$rom$npc,$fe:$fe$$module$js$rom$npc}=Segment$$module$js$rom$util;
...
new Npc$$module$js$rom$npc(this,51);this.PortoaPalaceFrontGuard=new Npc$$module$js$rom$npc(this,52);this.PortoaQueen=new PortoaQueen$$module$js$rom$npc(this,56);this.FortuneTeller=new Npc$$module$js$rom$npc(this,57);this.WaterfallCaveAdventurers=new Npc$$module$js$rom$npc(this,58);this.JoelElder=new Npc$$module$js$rom$npc(this,61);this.Clark=new Npc$$module$js$rom$npc(this,68);this.ShyronGuard=new Npc$$module$js$rom$npc(this,78);this.Brokahana=new Npc$$module$js$rom$npc(this,84);this.SaharaBunny=
new Npc$$module$js$rom$npc(this,89);this.Deo=new Npc$$module$js$rom$npc(this,90);this.SaharaElder=new Npc$$module$js$rom$npc(this,91);this.SaharaElderDaughter=new Npc$$module$js$rom$npc(this,92);this.Zebu=new Npc$$module$js$rom$npc(this,94);this.Tornel=new Npc$$module$js$rom$npc(this,95);this.Stom=new Npc$$module$js$rom$npc(this,96);this.MesiaRecording=new Npc$$module$js$rom$npc(this,97);this.Asina=new Npc$$module$js$rom$npc(this,98);this.HurtDolphin=new Npc$$module$js$rom$npc(this,99);this.Fisherman=
new Npc$$module$js$rom$npc(this,100);this.KensuInCabin=new Npc$$module$js$rom$npc(this,104);this.Dolphin=new Dolphin$$module$js$rom$npc(this,105);this.SleepingKensu=new Npc$$module$js$rom$npc(this,107);this.KensuDisguisedAsDancer=new Npc$$module$js$rom$npc(this,108);this.KensuDisguisedAsSoldier=new Npc$$module$js$rom$npc(this,109);this.AztecaInShyron=new Npc$$module$js$rom$npc(this,110);this.DeadAkahana=new Npc$$module$js$rom$npc(this,112);this.DeadStomsGirlfriend=new Npc$$module$js$rom$npc(this,
113);this.DeadStom=new Npc$$module$js$rom$npc(this,114);this.KensuInSwan=new Npc$$module$js$rom$npc(this,116);this.SlimedKensu=new Npc$$module$js$rom$npc(this,117);this.FishermanDaughter=new Npc$$module$js$rom$npc(this,123);this.Kensu=new Npc$$module$js$rom$npc(this,126);this.AkahanaInBrynmaer=new Npc$$module$js$rom$npc(this,130);this.AztecaInPyramid=new Npc$$module$js$rom$npc(this,131);this.SaberaDisguisedAsMesia=new Npc$$module$js$rom$npc(this,132);this.StonedWaterfallCaveAdventurers=new Npc$$module$js$rom$npc(this,
133);this.StonedAkahana=new Npc$$module$js$rom$npc(this,136);this.Mesia=new Npc$$module$js$rom$npc(this,142);this.Vampire1=new Npc$$module$js$rom$npc(this,192);this.Insect=new Npc$$module$js$rom$npc(this,193);this.Kelbesque1=new Npc$$module$js$rom$npc(this,194);this.Rage=new Npc$$module$js$rom$npc(this,195);this.Kelbesque2=new Npc$$module$js$rom$npc(this,197);this.Sabera2=new Npc$$module$js$rom$npc(this,198);this.Mado2=new Npc$$module$js$rom$npc(this,199);this.Karmine=new Npc$$module$js$rom$npc(this,
200);this.StatueOfMoon=new Npc$$module$js$rom$npc(this,201);this.StatueOfSun=new Npc$$module$js$rom$npc(this,202);this.Draygon=new Npc$$module$js$rom$npc(this,203);this.Vampire2=new Npc$$module$js$rom$npc(this,204);for(var b in this){const a=this[b];this.hasOwnProperty(b)&&a instanceof Npc$$module$js$rom$npc&&(this[a.id]=a,a.name=upperCamelToSpaces$$module$js$rom$util(b))}for(b=0;205>b;b++)this[b]||(this[b]=new Npc$$module$js$rom$npc(this,b));const c=MOVEMENT_SCRIPT_TABLE_POINTER$$module$js$rom$npc.readAddress(a.prg);
this.movementScripts=seq$$module$js$rom$util(16,(b)=>{b=c.plus(2*b).readAddress(a.prg).offset;const d=[];for(;128>a.prg[b];)d.push(a.prg[b++]);return{steps:d,terminate:a.prg[b]}})}write(){const a=this.rom.assembler();for(var b of this)b&&b.used&&b.assemble(a);free$$module$js$rom$util(a,$1b$$module$js$rom$npc,44804,44969);b=[];a.segment("1b","fe","ff");let c=0;for(var d of this.movementScripts){const e=(a.reloc(`MovementScript_${hex$$module$js$rom$util(c++)}`),a.pc());a.byte(...d.steps,d.terminate);
b.push(e)}d=(a.reloc("MovementScriptTable"),a.pc());a.word(...b);MOVEMENT_SCRIPT_TABLE_POINTER$$module$js$rom$npc.loc(a,"MovementScriptTablePtr");a.word(d);MOVEMENT_SCRIPT_TABLE_POINTER$$module$js$rom$npc.plus(5).loc(a,"MovementScriptTablePlus1Ptr");a.word({op:"+",args:[d,{op:"num",num:1}]});return[a.module()]}}
...
return c[b]}isParalyzable(){for(let a=217176;217196>a;a++)if(this.rom.prg[a]===this.id)return!1;return!0}assemble(a){if(this.used){var b=hex$$module$js$rom$util(this.id);this.dataBase.loc(a,"PersonData_${id}");a.byte(...this.data);a.segment("0e","fe","ff");a.reloc(`SpawnCondition_${b}`);var c=a.pc();a.byte(...this.spawnConditionsBytes());this.spawnPointer.loc(a,`SpawnCondition_${b}_Pointer`);a.word(c);this.hasDialog()&&(a.segment("0e","fe","ff"),a.reloc(`Dialog_${b}`),c=a.pc(),a.byte(...this.dialogBytes()),
this.dialogPointer.loc(a,`Dialog_${b}_Pointer`),a.word(c))}}}
...
class PortoaQueen$$module$js$rom$npc extends Npc$$module$js$rom$npc{get expectedSword(){return this.localDialog(3).condition&255}set expectedSword(a){this.localDialog(3).condition=512|a}}
class Dolphin$$module$js$rom$npc extends Npc$$module$js$rom$npc{constructor(a,b){super(a,b);const c=a.rom.prg,d=DOLPHIN_SPAWN_TABLE_POINTER$$module$js$rom$npc.readAddress(c).offset;this.spawnScripts=seq$$module$js$rom$util(9,(a)=>({entrance:Entrance$$module$js$rom$locationtables.from(c,d+5*a),movement:c[d+5*a+4]}));this.channelSpawn=mustBeInt$$module$js$rom$npc(DOLPHIN_CHANNEL_SPAWN$$module$js$rom$npc.read(c)/5);this.evilSpiritIslandSpawn=mustBeInt$$module$js$rom$npc(DOLPHIN_EVIL_SPIRIT_ISLAND_SPAWN$$module$js$rom$npc.read(c)/
5)}assemble(a){super.assemble(a);a.segment("fe");a.org(54952);a.free(45);a.segment("fe","ff");a.reloc("DolphinSpawnTable");const b=a.pc();for(;!this.spawnScripts[this.spawnScripts.length-1].entrance.used;)this.spawnScripts.pop();for(var c=0;c<this.rom.locations.AngrySea.entrances.length;c++){const b=this.spawnScripts[c];b?a.byte(...b.entrance.data,b.movement):a.byte(255,15,255,15,15)}DOLPHIN_CHANNEL_SPAWN$$module$js$rom$npc.loc(a,"DolphinChannelSpawn");a.byte(5*this.channelSpawn);DOLPHIN_EVIL_SPIRIT_ISLAND_SPAWN$$module$js$rom$npc.loc(a,
"DolphinEvilSpiritIslandSpawn");a.byte(5*this.evilSpiritIslandSpawn);DOLPHIN_SPAWN_TABLE_POINTER$$module$js$rom$npc.loc(a,"DolphinSpawnTablePtr");a.word(b);for(c=0;4>c;c++)DOLPHIN_SPAWN_TABLE_POINTER_1$$module$js$rom$npc.plus(5*c).loc(a,`DolphinSpawnTablePlus${c+1}Ptr`),a.word({op:"+",args:[b,{op:"num",num:c+1}]})}}var MovementScript$$module$js$rom$npc;
(function(a){a.UP=0;a.RIGHT=2;a.DOWN=4;a.LEFT=6;a.DOLPHIN=255;a.DESPAWN=254})(MovementScript$$module$js$rom$npc||(MovementScript$$module$js$rom$npc={}));
const DOLPHIN_CHANNEL_SPAWN$$module$js$rom$npc=Address$$module$js$rom$util.of($fe$$module$js$rom$npc,54884),DOLPHIN_EVIL_SPIRIT_ISLAND_SPAWN$$module$js$rom$npc=Address$$module$js$rom$util.of($fe$$module$js$rom$npc,54892),DOLPHIN_SPAWN_TABLE_POINTER$$module$js$rom$npc=Address$$module$js$rom$util.of($fe$$module$js$rom$npc,54906),DOLPHIN_SPAWN_TABLE_POINTER_1$$module$js$rom$npc=Address$$module$js$rom$util.of($fe$$module$js$rom$npc,54926),MOVEMENT_SCRIPT_TABLE_POINTER$$module$js$rom$npc=Address$$module$js$rom$util.of($1b$$module$js$rom$npc,
44627);function mustBeInt$$module$js$rom$npc(a){if(a!==Math.floor(a))throw Error(`Expected integer: ${a}`);return a}var module$js$rom$npc={};module$js$rom$npc.Npcs=Npcs$$module$js$rom$npc;module$js$rom$npc.Npc=Npc$$module$js$rom$npc;module$js$rom$npc.GlobalDialog=GlobalDialog$$module$js$rom$npc;module$js$rom$npc.LocalDialog=LocalDialog$$module$js$rom$npc;module$js$rom$npc.PortoaQueen=PortoaQueen$$module$js$rom$npc;module$js$rom$npc.Dolphin=Dolphin$$module$js$rom$npc;
module$js$rom$npc.MovementScript=MovementScript$$module$js$rom$npc;function write$$module$js$pass$deterministic(a,b,...c){for(let d=0;d<c.length;d++)a[b+d]=c[d]}
...
function patchLimeTreeLake$$module$js$pass$deterministic(a){a.metatilesets.lime.getTile(124).setEffects(6);a.metatilesets.lime.getTile(127).setEffects(6);a.metatilesets.lime.getTile(123).setTiles([127,127,127,127]).setAttrs(0).setEffects(6);a.screens[116].set2d(144,[[123,123,123,123,123,123,123,null,null,123,123,123,123,123,123,123],[123,123,123,123,123,123,123,null,null,123,123,123,123,123,123,123]])}
function preventNpcDespawns$$module$js$pass$deterministic(a,b){function c(a,b){const c=a.indexOf(b);if(0>c)throw Error(`Could not find element ${b} in ${a}`);a.splice(c,1)}function d(a){a.reverse();for(let b=0;b<a.length;b++){const c=a[b+1];a[b].condition=c?~c.condition:-1}}const {locations:{BoatHouse:e,Brynmaer:f,Crypt_Draygon2:g,Joel_Shed:h,MtSabreNorth_SummitCave:k,MtSabreWest_Upper:m,PortoaPalace_ThroneRoom:l,Portoa_AsinaRoom:n,Portoa_FortuneTeller:p,Shyron_Temple:r,StomHouse:q,Swan_DanceHall:w,
Swan_Tavern:x,WindmillCave:y,WaterfallCave4:z,WaterfallValleyNorth:E,ZebuCave:v,ZombieTown_HouseBasement:t},items:{GlowingLamp:V,KeyToPrison:H,LovePendant:W,StatueOfOnyx:ja},npcs:{Akahana:X,AkahanaInBrynmaer:ba,Asina:Y,AztecaInShyron:Fa,Clark:za,Draygon:T,FortuneTeller:Ra,Kensu:P,KensuInCabin:Q,KensuInSwan:J,LeafRabbit:N,OakChild:O,OakElder:pa,OakMother:ea,PortoaPalaceFrontGuard:Aa,PortoaQueen:ca,PortoaThroneRoomBackDoorGuard:qa,Rage:ra,Stom:sa,StonedAkahana:ka,Tornel:Ga,WindmillGuard:Sa,Zebu:Ha},
flags:u}=a;P.localDialogs.delete(x.id);J.link(P.id);J.used=!0;J.data=[...P.data];P.data[0]=V.id;w.spawns.find((a)=>a.isNpc()&&a.id===P.id).id=J.id;W.itemUseData[0].want=256|J.id;ka.linkDialog(X.id);ba.used=!0;ba.link(X.id);ba.data=[...X.data];f.spawns.find((a)=>a.isNpc()&&a.id===X.id).id=ba.id;ja.itemUseData[0].want=256|ba.id;N.dialog()[2].condition=u.RescuedLeafElder.id;N.dialog()[2].flags.push(u.TalkedToLeafRabbit.id);N.dialog()[3].flags.push(u.TalkedToLeafRabbit.id);Sa.spawns(y)[1]=~u.WindmillGuardAlarmFluteTradein.id;
c(X.spawns(z),~u.BehindWhirlpool.id);c(ka.spawns(z),~u.BehindWhirlpool.id);pa.dialog()[0].message.action=3;pa.dialog()[1].message.action=3;pa.dialog()[2].message.action=3;pa.dialog()[3].message.action=3;(()=>{const [a,b,c,d]=ea.dialog();d.condition=~u.RescuedChild.id;b.condition=-1;ea.dialog().splice(0,4,d,c,a,b)})();for(const b of[32,33,34,124,125])d(a.npcs[b].dialog());O.dialog().unshift(...O.dialog().splice(1,1));qa.spawnConditions.set(l.id,[~u.QueenNotInThroneRoom.id,~u.MesiaRecording.id]);Aa.dialog()[1].condition=
u.MesiaRecording.id;ca.dialog()[3].condition=u.SwordOfWater.id;ca.dialog()[3].message.action=3;ca.dialog()[4].flags.push(u.PortoaQueenGoingAway.id);ca.spawns(l)[1]=~u.MesiaRecording.id;ca.spawns(n)[0]=u.MesiaRecording.id;ca.dialog()[1].condition=u.MesiaRecording.id;Ra.spawns(p)[1]=~u.MesiaRecording.id;za.spawnConditions.set(t.id,[~u.Clark.id]);za.spawnConditions.set(h.id,[u.Clark.id]);Ha.localDialogs.set(v.id,[LocalDialog$$module$js$rom$npc.of(~u.TalkedToZebuInCave.id,[0,26],[u.TalkedToZebuInCave.id]),
LocalDialog$$module$js$rom$npc.of(u.LeafVillagersRescued.id,[0,29]),LocalDialog$$module$js$rom$npc.of(u.LeafAbduction.id,[0,28]),LocalDialog$$module$js$rom$npc.of(u.ZebuAtWindmill.id,[0,29]),LocalDialog$$module$js$rom$npc.of(u.UsedWindmillKey.id,[0,27,3]),LocalDialog$$module$js$rom$npc.of(-1,[0,29])]);c(Ha.spawns(v),~u.BehindWhirlpool.id);Ga.spawnConditions.delete(m.id);sa.spawnConditions.delete(q.id);Y.data[1]=a.items.FluteOfLime.id;Y.dialog(n)[0].message.action=17;Y.dialog(n)[2].message.action=
17;c(Y.spawns(n),~u.CalmedAngrySea.id);Q.spawnConditions.set(e.id,[~u.AbleToRideDolphin.id,u.ReturnedFogLamp.id]);Q.dialog()[0].message.action=2;Fa.spawns(r).push(~u.ShyronMassacre.id);a.trigger(130).conditions.push(~u.ShyronMassacre.id);ra.dialog()[0].condition=u.SwordOfWater.id;T.spawnConditions.set(g.id,[~u.Draygon2.id]);Ha.dialog(r).unshift(...Ha.dialog(r).splice(1,1));a.trigger(128).conditions=[~u.ShyronMassacre.id,u.TalkedToZebuInShyron.id,u.SwordOfThunder.id];a.trigger(129).conditions=[];b.barrierRequiresCalmSea()&&
a.trigger(132).conditions.push(u.CalmedAngrySea.id);a.trigger(140).conditions.push(u.TalkedToZebuInCave.id);a.trigger(141).used=!1;for(const a of k.spawns)a.isTrigger()&&141===a.id&&(a.id=178);(function(a,b){b=a.findIndex(b);if(0>b)throw Error(`Could not find element in ${a}`);a.splice(b,1)})(E.spawns,(a)=>a.isTrigger()&&141===a.id);a.trigger(178).conditions.push(u.Kelbesque1.id);a.trigger(178).flags.push(~u.LeafVillagersCurrentlyAbducted.id,~u.LeafElderCurrentlyAbducted.id,u.LeafVillagersRescued.id);
a.trigger(140).conditions.push(~u.Kelbesque1.id);a.trigger(134).conditions.push(~u.Kelbesque1.id);c(H.itemUseData[0].flags,~u.LeafVillagersCurrentlyAbducted.id);replace$$module$js$pass$deterministic(a.trigger(187).conditions,~u.Rage.id,~u.MesiaRecording.id)}function disableStabs$$module$js$pass$deterministic(a){for(const b of[8,9,39])a.objects[b].collisionPlane=0;a.npcs.Brokahana.data[0]=a.items.FruitOfLime.id}
...
128)}set solid(a){this.itemDataValue=this.itemDataValue&-129|(a?128:0)}assemble(a){const b=hex$$module$js$rom$util(this.id);this.itemDataPointer.loc(a,`ItemData_${b}`);a.byte(this.itemDataValue);this.selectedItemPointer.loc(a,`ItemSelectedValue_${b}`);a.byte(this.selectedItemValue);var c=MENU_NAME_ENCODE$$module$js$rom$item.reduce((a,[b,c])=>a.replace(b,c),this.menuName);a.segment($10$$module$js$rom$item);a.reloc(`ItemMenuName_${hex$$module$js$rom$util(this.id)}`);const d=a.pc();a.byte(c,255);this.menuNamePointer.loc(a,
`ItemMenuName_${b}`);a.word(d);if(this.itemUseJump){this.itemUseJumpPointer.loc(a,`ItemUseJump_${b}_Ptr`);a.word(this.itemUseJump.org);c=[];for(var e of this.itemUseData)c.push(...e.bytes());a.segment($0e$$module$js$rom$item.name,$0f$$module$js$rom$item.name);a.reloc(`ItemUseData_${b}`);e=a.pc();a.byte(...c);this.itemUseDataPointer.loc(a,`ItemUseData_${b}_Ptr`);a.word(e)}this.valueAddr&&(this.valueAddr.loc(a,`ItemValue_${b}`),a.byte(this.value))}isMagic(){return 65<=this.id&&72>=this.id}}
...
ARMOR_DEFENSE_TABLE$$module$js$rom$item.offset,9);this.shieldDefense=tuple$$module$js$rom$util(a.prg,SHIELD_DEFENSE_TABLE$$module$js$rom$item.offset,9)}write(){const a=this.rom.assembler();ARMOR_DEFENSE_TABLE$$module$js$rom$item.loc(a);a.byte(...this.armorDefense);SHIELD_DEFENSE_TABLE$$module$js$rom$item.loc(a);a.byte(...this.shieldDefense);const b=Array(10).fill(0);for(const c of this)c.assemble(a),c.unique&&(b[c.id>>>3]|=1<<(c.id&7));relocExportLabel$$module$js$rom$util(a,[$0e$$module$js$rom$item,
$0f$$module$js$rom$item],"KeyItemData");a.byte(...b);return[a.module()]}}
const DEFAULT_ITEM_USE_JUMPS$$module$js$rom$item={33849:["expect"],33858:["screen"],33872:["empty"],33873:["screen"],33887:["location"],33937:["expect"],33961:["expect","expect"],33971:["location"],34E3:["expect"],34011:[],34016:["expect","empty"],34055:["empty"],34077:["empty"],34084:["empty"],34095:["empty"],34106:["empty"],34122:["empty"],34148:["empty"],34149:["expect"],34155:["flag"],34181:["empty"],34206:["expect","expect","expect","expect"]};var module$js$rom$item={};
module$js$rom$item.Item=Item$$module$js$rom$item;module$js$rom$item.ItemUse=ItemUse$$module$js$rom$item;module$js$rom$item.Items=Items$$module$js$rom$item;function shuffleTrades$$module$js$pass$shuffletrades(a,b,c){if(b.randomizeTrades()){var {items:{StatueOfOnyx:d,FogLamp:e,LovePendant:f,KirisaPlant:g,IvoryStatue:h},locations:{Swan_DanceHall:k},npcs:{KensuInSwan:m}}=a,l=new Map,n=[[d,0,"Akahana"],[e,0,"Fisherman"],[f,0,"Kensu"],[g,0,"Aryllis"],[h,0,"Slimed Kensu"]],p=n.map(([a,b,c])=>{if(0>a.trades.indexOf(b)||b>=a.itemUseData.length)throw Error(`not a trade: ${a} ${b}`);return[a.itemUseData[b],a.id,c]});c.shuffle(p);for(const [c,d]of n){const [e,
f,g]=p.pop();c.itemUseData[d]=e;a.spoiler&&a.spoiler.addTrade(c.id,c.messageName,g);291===e.want?a.prg[251061]=c.id-28:356===e.want&&b.fogLampNotRequired()&&([...a.npcs[100].spawnConditions.values()][0][0]=512|c.id);l.set(f,c.id)}a.itemGets.actionGrants=new Map([...a.itemGets.actionGrants].map(([a,b])=>{var c;return[null!==(c=l.get(a))&&void 0!==c?c:a,b]}));b=a.items[c.nextInt(4)];a.npcs[195].localDialogs.get(-1)[0].condition=512|b.id;a.spoiler&&a.spoiler.addTrade(b.id,b.messageName,"Rage");a.npcs[56].localDialogs.get(-1)[3].condition=
512|b.id;c=a.items[2*c.nextInt(4)+6];for(const d of a.npcs[95].localDialogs.values())for(b=2;b<d.length;b++)if(3===d[b].message.action){d[b-2].condition=~(512|c.id-1);d[b-1].condition=~(512|c.id);a.spoiler&&a.spoiler.addTrade(c.id,c.messageName,"Tornel");break}m.dialog(k)[0].message.mid="13:00"}}function buildTradeInMap$$module$js$pass$shuffletrades(a){const b=new Map;for(const c of a.items)for(const a of c.trades)b.set(c.itemUseData[a].want&255,c.id);return b}var module$js$pass$shuffletrades={};
module$js$pass$shuffletrades.shuffleTrades=shuffleTrades$$module$js$pass$shuffletrades;module$js$pass$shuffletrades.buildTradeInMap=buildTradeInMap$$module$js$pass$shuffletrades;function fixDialog$$module$js$pass$fixdialog(a){function b(b){const c=v.get(b.id);if(!c)throw Error(`No trade-in for ${b.name}`);return a.items[c]}function c(a){e(a,/teach\s+you\s+the\s+magic\s+of/,"bestow upon you the")}function d(b){"number"===typeof b?b=a.items[a.itemGets[b&255].itemId]:b instanceof Item$$module$js$rom$item||(b=b.item);return`[${hex$$module$js$rom$util(b.id)}:${b.messageName}]`}function e(b,c,d){const [e,f]=b.split(":").map((a)=>parseInt(a,16));b=a.messages.parts[e][f];b.text=
b.text.replace(c,d)}const {flags:{AkahanaStatueOfOnyxTradein:f,AsinaInBackRoom:g,BehindWhirlpool:h,KensuInSwan:k,MtSabreNorthSummit:m,MtSabreWestTornel:l,PortoaQueen:n,Rage:p,RepairedStatue:r,SlimedKensu:q,StomFightReward:w,ZebuAtWindmill:x},npcs:{AkahanaInBrynmaer:y,Aryllis:z,Fisherman:E}}=a;e("03:06",",","");const v=buildTradeInMap$$module$js$pass$shuffletrades(a);x.item.isMagic()||c("00:1b");e("00:1b","[41:Refresh]",d(x.item));var t=b(y);e("02:01","an unusual statue",vague$$module$js$pass$fixdialog(t));
e("02:02","a statue",`the ${commonNoun$$module$js$pass$fixdialog(t)}`);e("02:02","[29:Gas Mask]",d(f));w.item.isMagic()||c("03:01");e("03:01","[43:Telepathy]",d(w));t=findTornelTradeIn$$module$js$pass$fixdialog(a);e("03:01","[06:Tornado Bracelet]",d(t));e("05:0a","[06:Tornado Bracelet]",d(t));e("05:0a","[44:Teleport]",d(l));t=b(E);e("09:01","[35:Fog Lamp]",d(t));e("09:04","[35:Fog Lamp]",d(t));e("09:05","[35:Fog Lamp]",d(t));e("09:06","lamp",commonNoun$$module$js$pass$fixdialog(t));t=a.npcs.PortoaQueen.dialog()[3].condition;
e("0a:0c","[28:Flute of Lime]",d(n));e("0a:0d","[02:Sword of Water]",d(t));g.item.isMagic()||c("0b:01");e("0b:01","[45:Recover]",d(g));h.item.isMagic()||(c("0b:01"),c("1d:12"));e("0b:01","[46:Barrier]",d(h));e("1d:12","[46:Barrier]",d(h));(t=function(...b){var c=[(a)=>BOWS$$module$js$pass$fixdialog.has(a),(a)=>SWORD_OR_MAGIC$$module$js$pass$fixdialog.has(a),(b)=>a.items[a.itemGets[b].itemId].unique];for(const d of c)for(const e of b){c=a.locations[e];for(const b of c.spawns)if(b.isChest()&&(c=a.slots[b.id],
72>=c&&d(c)))return a.items[c]}}(79,78,77,76,71,70,69,68,75,74,73,72))?e("0d:00","[35:Fog Lamp]",d(t)):e("0d:00","that a [35:Fog Lamp] was","there was treasure");t=a.npcs.Rage.dialog()[0].condition;e("0e:03","[02:Sword of Water]",d(t));e("0e:03","[09:Ball of Water]",d(p));e("10:0c","that's","is");e("10:0c",/, is in the\+lighthouse/,"");t=b(z);e("12:05","[3c:Kirisa Plant]",d(t));e("12:10","the plant",`the ${commonNoun$$module$js$pass$fixdialog(t)}`);e("12:10","[3c:Kirisa Plant]",d(t));t=`Our illustrious chief seeks ${vague$$module$js$pass$fixdialog(t)}.`;
e("12:09",/[^]*/,t);e("12:0a",/[^]*/,t);t=b(a.npcs.KensuInSwan);e("13:02","[3b:Love Pendant]",d(t));e("13:00","pendant",commonNoun$$module$js$pass$fixdialog(t));k.item.isMagic()||c("13:02");e("13:02","[47:Change]",d(k));t=b(a.npcs.SlimedKensu);e("18:06","[3d:Ivory Statue]",d(t));e("18:07","[3d:Ivory Statue]",d(t));e("18:06","It's in a room","{0b:Karmine} is");q.item.isMagic()||e("18:07","teach","give");e("18:07","[48:Flight]",d(q));m.item.isMagic()||c("1c:10");e("1c:10","[42:Paralysis]",d(m));e("20:06",
"Statue of Gold",d(r))}const BOWS$$module$js$pass$fixdialog=new Set([62,63,64]),SWORD_OR_MAGIC$$module$js$pass$fixdialog=new Set([0,1,2,3,65,66,67,68,69,70,71,72]);function findTornelTradeIn$$module$js$pass$fixdialog(a){var {Tornel:b}=a.npcs;for(const c of b.localDialogs.values())for(b=2;b<c.length;b++){const d=~c[b].condition;if(516<d&&524>=d&&!(d&1))return a.items[d&255]}return a.items.TornadoBracelet}
...
function commonNoun$$module$js$pass$fixdialog(a){const b=a.rom.items;switch(a){case b.StatueOfOnyx:return"statue";case b.FluteOfLime:return"instrument";case b.FogLamp:return"lamp";case b.LovePendant:return"pendant";case b.KirisaPlant:return"plant";case b.IvoryStatue:return"statue"}fail$$module$js$assert();return"item"}var module$js$pass$fixdialog={};module$js$pass$fixdialog.fixDialog=fixDialog$$module$js$pass$fixdialog;function fixMovementScripts$$module$js$pass$fixmovementscripts(a){fixAkahanaExits$$module$js$pass$fixmovementscripts(a);fixDolphinSpawns$$module$js$pass$fixmovementscripts(a)}function fixAkahanaExits$$module$js$pass$fixmovementscripts(a){}
function fixDolphinSpawns$$module$js$pass$fixmovementscripts(a){const {locations:{AngrySea:b},npcs:{Dolphin:c},metascreens:{beachCabinEntrance:d,beachCave:e,beachExitN:f,boatChannel:g}}=a;c.spawnScripts=[];a=new Set(seq$$module$js$rom$util(16,(a)=>a));for(let h=0;h<b.entrances.length;h++){let k=b.entrances[h],m=b.meta.get(k.screen),l;if(m===g){if(b.meta.get(k.screen-1)!==d)throw Error(`Bad boatChannel entrance ${k}`);k=module$js$rom$location.Entrance.of({screen:k.screen-1,tile:0});m=d}m===d?l={entrance:module$js$rom$location.Entrance.of({screen:k.screen-
17,coord:47336}),movement:5}:m===e?l={entrance:module$js$rom$location.Entrance.of({screen:k.screen,coord:59400}),movement:8}:m===f&&(l={entrance:module$js$rom$location.Entrance.of({screen:k.screen,coord:55544}),movement:9});l&&(a.delete(h),c.spawnScripts[h]=l)}[c.channelSpawn,c.evilSpiritIslandSpawn]=a;c.spawnScripts[c.channelSpawn]={entrance:module$js$rom$location.Entrance.of({x:424,y:120}),movement:6};c.spawnScripts[c.evilSpiritIslandSpawn]={entrance:module$js$rom$location.Entrance.of({x:424,y:120}),
movement:7}}var module$js$pass$fixmovementscripts={};module$js$pass$fixmovementscripts.fixMovementScripts=fixMovementScripts$$module$js$pass$fixmovementscripts;function fixSkippableExits$$module$js$pass$fixskippableexits(a){var b,c=new Set;for(var d of a.locations)for(var e of null!==(b=d.pits)&&void 0!==b?b:[])c.add(e.dest<<8|e.toScreen);for(const f of c){b=a.locations[f>>8];const g=f&255;c=b.exits.filter((a)=>a.screen===g);e=b.entrances.filter((a)=>a.screen===g);c=new Map(c.map((a)=>[a.tile,a]));d=new UnionFind$$module$js$unionfind;for(const a of c.keys())for(const b of DIRS$$module$js$pass$fixskippableexits)c.has(a+b)&&d.union([a,a+b]);d=d.map();for(const a of e)for(const g of DIRS$$module$js$pass$fixskippableexits){e=
d.get(a.tile+g);for(const a of null!==e&&void 0!==e?e:[])e=c.get(a),e=module$js$rom$location.Exit.of({screen:f&255,tile:a+g,dest:e.dest,entrance:e.entrance}),b.exits.push(e)}}}const DIRS$$module$js$pass$fixskippableexits=[1,-1,16,-16];var module$js$pass$fixskippableexits={};module$js$pass$fixskippableexits.fixSkippableExits=fixSkippableExits$$module$js$pass$fixskippableexits;function randomizeThunderWarp$$module$js$pass$randomizethunderwarp(a,b){var c=[...a.townWarp.locations].filter((a)=>255!==a);b=b.nextInt(c.length);const d=c[b];let e=64;if(d===a.locations.Shyron.id||d===a.locations.Shyron_Temple.id)e=65;a.townWarp.thunderSwordWarp=[d,e];c=768-c.length+b;a=a.itemGets[3].flags;for(b=0;b<a.length;b++)if(765===a[b]){a[b]=c;return}a.push(c)}var module$js$pass$randomizethunderwarp={};module$js$pass$randomizethunderwarp.randomizeThunderWarp=randomizeThunderWarp$$module$js$pass$randomizethunderwarp;function rescaleMonsters$$module$js$pass$rescalemonsters(a,b,c){var d=new Set(seq$$module$js$rom$util(256,(a)=>a).filter((b)=>b in a.objects));for(var [e]of SCALED_MONSTERS$$module$js$pass$rescalemonsters)d.delete(e);for(const [b,c]of SCALED_MONSTERS$$module$js$pass$rescalemonsters)for(var f of d)a.objects[b].base===a.objects[f].base&&(SCALED_MONSTERS$$module$js$pass$rescalemonsters.set(f,c),d.delete(b));for(var g of[200,249,250])a.objects[g].attackType=240<g?254:255,a.objects[g].statusEffect=0;a.objects[125].elements|=
8;e=new Set([87,94,104,125,136,151,155,158]);d=new Set([80,83,95,105]);for(const [h,{sdef:k,swrd:m,hits:l,satk:n,dgld:p,sexp:r}]of SCALED_MONSTERS$$module$js$pass$rescalemonsters)f=a.objects[h].data,g=e.has(h)?1:0,f[2]|=128,f[6]=l,f[7]=n,f[8]=k|m<<4,f[16]=f[16]&15|p<<4,f[17]=r,(g?b.shuffleBossElements():b.shuffleMonsterElements())&&!d.has(h)&&(f=[...a.objects[h].elements.toString(2).padStart(4,"0")],c.shuffle(f),a.objects[h].elements=Number.parseInt(f.join(""),2));if(b.shuffleMonsterElements()){b=
...
"p","lizardman flail",,,,21,,,],[252,"p","mado shuriken",,,,36,,,],[253,"p","guardian statue missile",,,,23,,,],[254,"p","demon wall fire",,,,23,,,]].map(([a,b,c,d=0,e=0,f=0,g=0,h=0,k=0])=>[a,{id:a,type:b,name:c,sdef:d,swrd:e,hits:f,satk:g,dgld:h,sexp:k}]));var module$js$pass$rescalemonsters={};module$js$pass$rescalemonsters.rescaleMonsters=rescaleMonsters$$module$js$pass$rescalemonsters;module$js$pass$rescalemonsters.SCALED_MONSTERS=SCALED_MONSTERS$$module$js$pass$rescalemonsters;function flipSaberaEntrance$$module$js$pass$shufflegoa(a){console.log("flip sabera entrance");const b=a[0];b.set2d(113,[[b.rom.metascreens.deadEndE_upStair],[b.rom.metascreens.caveEmpty]]);b.moveExits([129,"stair:down",113,"stair:up"]);a[1]=113;a[2]="stair:up"}
function flipKarmineEntrance$$module$js$pass$shufflegoa(a){console.log("flip karmine entrance");const b=a[0],c=b.rom.metascreens;b.invalidateMonsters();b.set2d(32,[[c.caveEmpty,c.hallNS],[c.deadEndE_upStair,c.hallNW]]);b.moveExits([48,"stair:down",48,"stair:up"]);a[2]="stair:up"}
function flipKarmineExit$$module$js$pass$shufflegoa(a){console.log("flip karmine exit");const b=a[0],c=b.rom.metascreens;b.set2d(1,[[c.deadEndS_stairs,c.caveEmpty]]);b.moveExits([2,"stair:down",1,"stair:up"]);a[1]=1;a[2]="stair:up"}function flipExit$$module$js$pass$shufflegoa(a){console.log("flip generic exit");const b=a[0],c=b.rom.metascreens;2>b.width&&(b.width=2);b.set2d(0,[[c.hallSE,c.deadEndW_downStair]]);b.moveExits([0,"stair:up",1,"stair:down"]);a[1]=1;a[2]="stair:down"}
function flip$$module$js$pass$shufflegoa(a){a[3](a);a[3]=void 0}
function shuffleGoa$$module$js$pass$shufflegoa(a,b){const c=a.locations;var d=[0,1,2,3];b.shuffle(d);const e=[[c.GoaFortress_Kelbesque.meta,131,"stair:down"],[c.GoaFortress_Sabera.meta,129,"stair:down",flipSaberaEntrance$$module$js$pass$shufflegoa],[c.GoaFortress_Mado1.meta,114,"stair:down"],[c.GoaFortress_Karmine1.meta,48,"stair:down",flipKarmineEntrance$$module$js$pass$shufflegoa]],f=[[c.GoaFortress_Zebu.meta,0,"stair:up",flipExit$$module$js$pass$shufflegoa],[c.GoaFortress_Tornel.meta,0,"stair:up",
flipExit$$module$js$pass$shufflegoa],[c.GoaFortress_Asina.meta,0,"stair:up",flipExit$$module$js$pass$shufflegoa],[c.GoaFortress_Kensu.meta,2,"stair:down",flipKarmineExit$$module$js$pass$shufflegoa]],g=[[c.GoaFortress_Entrance.meta,0,"edge:top"]],h=[];let k=!0,m=g[0];for(const c of d){var l=k||e[c][3]||g[g.length-1][3];d=l?b.pick([!1,!0]):!0;console.log(`FLOOR ${c}: up ${k} flexible ${!!l} reverse ${d}`);l=d?f[c]:e[c];console.log(`push b ${a.locations[l[0].id].name}`);h.push(l);k!==("stair:down"===
l[2])&&(l[3]?flip$$module$js$pass$shufflegoa(l):flip$$module$js$pass$shufflegoa(m));g.push(m=d?e[c]:f[c]);console.log(`push a ${a.locations[m[0].id].name}`);k="stair:up"===m[2]}k&&flip$$module$js$pass$shufflegoa(m);h.push([c.GoaFortress_Exit.meta,1,"stair:up"]);for(a=0;a<g.length;a++)g[a][0].attach(g[a][1],h[a][0],h[a][1],g[a][2],h[a][2])}var module$js$pass$shufflegoa={};module$js$pass$shufflegoa.shuffleGoa=shuffleGoa$$module$js$pass$shufflegoa;function shuffleMazes$$module$js$pass$shufflemazes(a,b,c){shufflePyramid$$module$js$maze$pyramid(a,c);shuffleSwamp$$module$js$maze$swamp(a,c);shuffleGoa1$$module$js$maze$goa(a,c);for(const b of SHUFFLED_CAVES$$module$js$pass$shufflemazes)shuffleCave$$module$js$maze$cave(a.locations[b],c);b.addEastCave()&&(shuffleCave$$module$js$maze$cave(a.locations.EastCave1,c),shuffleCave$$module$js$maze$cave(a.locations.EastCave2,c),a.locations.EastCave3.used&&shuffleCave$$module$js$maze$cave(a.locations.EastCave3,
...
!0));g.push(`Initial pass: ${n.fixed.map((a)=>Infinity>a.size?"["+[...a].join(", ")+"]":"all")}`);const p=new Map;c=(a)=>{var c=e.rom.objects[a.id];if(c.monsterClass){var d=p.get(c.monsterClass);if(null!=d&&d!==a.id)return!1}d=FLYERS$$module$js$pass$shufflemonsters.has(a.id);var h=MOTHS_AND_BATS$$module$js$pass$shufflemonsters.has(a.id);if(d){if(!l)return!1;--l}const m=b.getMonsterConstraint(e.id,a.id);let q=n.tryMeet(m);!q&&Infinity>n.pal2.size&&Infinity>n.pal3.size&&this.flags.shuffleSpritePalettes()&&
(q=n.tryMeet(m,!0));if(!q)return!1;if(r){var v=e.rom.objects[a.id];if(!(v instanceof Monster$$module$js$rom$monster))throw Error(`non-monster: ${v}`);v=r(v);if(null==v)return!1}g.push(`  Adding ${a.id.toString(16)}: ${q}`);n=q;c.monsterClass&&p.set(c.monsterClass,a.id);c=0;if(d||h)for(d=0;d<f.length;d++){if(f[d]in k){c=d;break}}else for(d=0;d<f.length;d++)if(!(f[d]in k)){c=d;break}(this.report[`mon-${a.id.toString(16)}`]=this.report[`mon-${a.id.toString(16)}`]||[]).push("$"+e.id.toString(16));d=f[c];
h=e.spawns[d-13];r?(h.screen=v>>>8,h.tile=v&255):d in k&&(h.y+=16*k[d][0],h.x+=16*k[d][1]);h.monsterId=a.id;g.push(`    slot ${d.toString(16)}: ${h}`);f.splice(c,1);return!0};const r=f.length&&this.flags.randomizeMaps()?e.monsterPlacer(a):null;if(l&&f.length)for(var d=0;d<Math.min(40,this.monsters.length);d++)FLYERS$$module$js$pass$shufflemonsters.has(this.monsters[d].id)&&c(this.monsters[d])&&this.monsters.splice(d,1);for(d=0;d<this.monsters.length&&f.length;d++)if(c(this.monsters[d])){const [a]=
...
nonFlyers:{[22]:[26,-16],[23]:[0,32]}},[171]:{maxFlyers:2,nonFlyers:{[13]:[1,0],[14]:[2,-2]}},[173]:{maxFlyers:2,nonFlyers:{[24]:[0,8],[25]:[0,-8]}},[175]:{nonFlyers:{[13]:[0,0],[14]:[0,0],[19]:[59,-38]}},[180]:{maxFlyers:2,nonFlyers:{[17]:[6,0],[18]:[0,6]}},[215]:{skip:!0}},UNTOUCHED_MONSTERS$$module$js$pass$shufflemonsters={[126]:!0,[127]:!0,[131]:!0,[141]:!0,[142]:!0,[143]:!0,[159]:!0,[166]:!0};var module$js$pass$shufflemonsters={};module$js$pass$shufflemonsters.shuffleMonsters=shuffleMonsters$$module$js$pass$shufflemonsters;function shufflePalettes$$module$js$pass$shufflepalettes(a,b,c){(new Shuffle$$module$js$pass$shufflepalettes(a,b,c)).shuffle()}
class Shuffle$$module$js$pass$shufflepalettes{constructor(a,b,c){this.rom=a;this.flags=b;this.random=c}shuffle(){this.shuffleBackgrounds()}shuffleBackgrounds(){var a=new DefaultMap$$module$js$util(()=>[]);for(var b of this.rom.locations)a.get(b.colorGroup).push(b);b=[new Map,new Map];for(var c of a.values())for(var d of c)for(let a=0;2>a;a++)for(let c=0;2>c;c++){let e=b[a].get(d.tilePatterns[c]);e||b[a].set(d.tilePatterns[c],e=new Set);e.add(d.tilePalettes[a])}for(const e of a.values()){c=e[0];a=
[new Set,new Set];for(d=0;2>d;d++)a[d]=new Set([...b[d].get(c.tilePatterns[0]),...b[d].get(c.tilePatterns[1])]);c=this.random.pick([...a[0]]);a=this.random.pick([...a[1]]);for(const b of e)b.tilePalettes[0]=c,b.tilePalettes[1]=a}}}var module$js$pass$shufflepalettes={};module$js$pass$shufflepalettes.shufflePalettes=shufflePalettes$$module$js$pass$shufflepalettes;function standardMapEdits$$module$js$pass$standardmapedits(a,b){b.eastCave?eastCave$$module$js$pass$standardmapedits(a,b.eastCave):b.classicLimeTreeToLeaf&&connectLimeTreeToLeaf$$module$js$pass$standardmapedits(a);addTowerExit$$module$js$pass$standardmapedits(a);reversibleSwanGate$$module$js$pass$standardmapedits(a);shrinkMado2$$module$js$pass$standardmapedits(a)}
...
function eastCave$$module$js$pass$standardmapedits(a,b){const {locations:{EastCave1:c,EastCave2:d,EastCave3:e,Leaf_StudentHouse:f,SealedCave1:g,ValleyOfWind:h},metascreens:{boundaryE_cave:k,branchNSE:m,branchNWE:l,branchNWSE:n,branchNWS:p,branchWSE:r,caveEmpty:q,deadEndE:w,deadEndE_downStair:x,deadEndE_upStair:y,deadEndN_stairs:z,deadEndS:E,deadEndS_stairs:v,deadEndW:t,deadEndW_downStair:V,exit:H,hallNE:W,hallNS:ja,hallNW:X,hallSE:ba,hallWS:Y,hallWE:Fa,hallNS_entrance:za,hallNS_stairs:T,hallNS_wall:Ra},
npcs:{WindmillGuard:P}}=a;a.locations.allocate(c);a.locations.allocate(d);b.exit2&&a.locations.allocate(a.locations.EastCave3);for(const a of[c,d,e])a.bgm=a.originalBgm=23,a.entrances=[],a.exits=[],a.pits=[],a.spawns=[],a.flags=[],a.width=a.height=1,a.screens=[[128]],a.tilePalettes=[26,27,5],a.originalTilePalettes=[26,27,5],a.tileset=136,a.tileEffects=181,a.tilePatterns=[20,2],a.spritePatterns=[...g.spritePatterns],a.spritePalettes=[...g.spritePalettes];c.meta=new Metalocation$$module$js$rom$metalocation(c.id,
a.metatilesets.cave,5,5);c.meta.set2d(0,[[w,Y,q,ba,t],[q,ja,ba,X,q],[ba,n,p,q,q],[ja,T,W,Fa,Y],[za,W,t,y,X],[H,q,q,q,q]]);d.meta=new Metalocation$$module$js$rom$metalocation(d.id,a.metatilesets.cave,5,5);d.meta.set2d(0,[[w,Y,E,q,E],[q,ja,ja,q,ja],[q,m,l,r,X],[q,T,q,W,Y],[w,X,q,q,z]]);h.meta.set2d(51,[[k]]);a.tileEffects[0].effects[192]=0;c.meta.attach(67,d.meta,68);c.meta.attach(64,h.meta,51);b.exit1&&(c.meta.set2d(4,[[V]]),connectEastCaveExit$$module$js$pass$standardmapedits(c,4,b.exit1));b.exit2&&
(a.locations.allocate(e),e.meta=new Metalocation$$module$js$rom$metalocation(e.id,a.metatilesets.cave,3,1),e.meta.set2d(0,[[v],[Ra],[za],[H]]),e.spawns.push(Spawn$$module$js$rom$locationtables.from([24,7,35,0])),e.flags.push(Flag$$module$js$rom$locationtables.of({screen:16,flag:a.flags.alloc(512)})),d.meta.set2d(64,[[x]]),d.meta.attach(64,e.meta,0),connectEastCaveExit$$module$js$pass$standardmapedits(e,32,b.exit2));c.spawns.push(Spawn$$module$js$rom$locationtables.of({screen:33,tile:135,timed:!0,
id:2}),Spawn$$module$js$rom$locationtables.of({screen:18,tile:136,timed:!1,id:2}),Spawn$$module$js$rom$locationtables.of({screen:19,tile:137,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:50,tile:104,timed:!1,id:2}),Spawn$$module$js$rom$locationtables.of({screen:65,tile:136,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:51,tile:152,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:3,tile:136,timed:!0,id:2}));d.spawns.push(Spawn$$module$js$rom$locationtables.of({screen:1,
tile:136,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:17,tile:72,timed:!1,id:2}),Spawn$$module$js$rom$locationtables.of({screen:18,tile:119,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:20,tile:40,timed:!1,id:2}),Spawn$$module$js$rom$locationtables.of({screen:35,tile:133,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:49,tile:136,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:51,tile:138,timed:!1,id:2}),Spawn$$module$js$rom$locationtables.of({screen:52,
tile:152,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({screen:65,tile:130,timed:!0,id:2}),Spawn$$module$js$rom$locationtables.of({y:272,x:1144,type:2,id:49}),Spawn$$module$js$rom$locationtables.of({y:112,x:264,type:2,id:124}));P.data[1]=89;P.dialog(f)[0].condition=-346}
function connectEastCaveExit$$module$js$pass$standardmapedits(a,b,c){const {metascreens:{bendNE:d,bendSE:e,boundaryN_trees:f,boundaryW_cave:g,cornerNE:h,cornerNW:k,cornerSE:m,cornerSE_cave:l,cornerSW:n,overworldEmpty:p}}=a.rom;let r,q;switch(c){case "lime":r=a.rom.locations.LimeTreeValley;q=16;r.resizeScreens(0,1,0,0);r.meta.spliceColumns(0,1,2,[[p,p],[k,f],[g,e],[n,m],[p,p]]);break;case "cordel":c=[[g,e],[n,m]];r=a.rom.locations.CordelPlainEast;q=85;r.meta.set2d(85,c);a.rom.locations.CordelPlainWest.meta.set2d(85,
c);break;case "goa":r=a.rom.locations.GoaValley;q=17;r.meta.set2d(1,[[k,h],[g,d]]);break;case "desert":r=a.rom.locations.Desert2,q=83,r.meta.set2d(83,[[l]])}a.meta.attach(b,r.meta,q)}function connectLimeTreeToLeaf$$module$js$pass$standardmapedits(a){const {locations:{ValleyOfWind:b,LimeTreeValley:c},metascreens:{exitE:d,exitW_southwest:e,overworldEmpty_alt:f}}=a;b.meta.set2d(84,[[d]]);c.meta.set2d(16,[[e],[f]]);b.meta.attach(84,c.meta,16)}
function addTowerExit$$module$js$pass$standardmapedits(a){const {TowerEntrance:b,Crypt_Teleporter:c}=a.locations;c.meta.attach(0,b.meta,0,"teleporter","teleporter")}
function reversibleSwanGate$$module$js$pass$standardmapedits(a){const {flags:{OpenedSwanGate:b},locations:{SwanGate:c},npcs:{SoldierGuard:d}}=a;c.spawns.push(Spawn$$module$js$rom$locationtables.of({xt:10,yt:2,type:1,id:45}),Spawn$$module$js$rom$locationtables.of({xt:11,yt:2,type:1,id:45}));d.localDialogs.get(c.id)[0].flags.push(b.id)}function shrinkMado2$$module$js$pass$standardmapedits(a){}var module$js$pass$standardmapedits={};module$js$pass$standardmapedits.standardMapEdits=standardMapEdits$$module$js$pass$standardmapedits;function toggleMaps$$module$js$pass$togglemaps(a,b,c){}var module$js$pass$togglemaps={};module$js$pass$togglemaps.toggleMaps=toggleMaps$$module$js$pass$togglemaps;const KEY_NAMES$$module$js$pass$unidentifieditems="Curious Key;Bronze Key;Silver Key;Ancient Key;Small Key;Shiny Key;Mysterious Key;Magic Key;Piano Key".split(";"),FLUTE_NAMES$$module$js$pass$unidentifieditems="Wooden Flute;Metal Flute;Horn of Plenty;Ocarina;Pan Pipes;Bugle;Bagpipes;Kazoo;Magic Whistle;Dog Whistle;Recorder;Accordion;Harmonica;Sousaphone;Trombone;Violin;Cello".split(";"),LAMP_NAMES$$module$js$pass$unidentifieditems="Bronze Lamp;Magic Lamp;Dull Lamp;Shimmering Lamp;Oil Lamp;Broken Lamp;Frog Lamp;Smog Lamp".split(";"),
...
a=Number.parseInt(c[1],16);return`[${"{"===b?6:7}][${a}]${d}`});for(const {str:b,bytes:d}of c.get(g.mid)||[])a=a.replace(new RegExp(b+"( [ &0-9]|.|$)","g"),(a,b)=>{if(b&&!PUNCTUATION$$module$js$rom$messages[b])return a;" "===b&&(b="");return d.map((a)=>`[${a}]`).join("")+b});d=["[01]"];e=[];e.push(1);for(let c=0,g=a.length;c<g;c++)if(f=a[c],f===Messages$$module$js$rom$messages.CONTINUED)e.push(3,1),d.push("[03][01]"),"\n"===a[c+1]&&c++;else if("\n"===f)e.push(2)," "===a[c+1]&&c++,d.push("[02]");else if("["===
f){f=a.indexOf("]",c);if(0>=f)throw Error(`bad text: ${a}`);b=Number(a.substring(c+1,f));if(isNaN(b))throw Error(`bad text: ${a}`);e.push(b);d.push(`[${hex$$module$js$rom$util(b)}]`);c=f}else if(" "===f&&" "===a[c+1]){for(f=c+2;" "===a[f];)f++;e.push(9,f-c);d.push(`[09][${hex$$module$js$rom$util(f-c)}]`);c=f-1}else e.push(f.charCodeAt(0)),d.push(f);e.push(0);d.push("[0]");g.bytes=e;g.hex=d.join("")}}write(){function a(a,c,...d){a.loc(b);b.word(c);let e=0;for(const f of d)a.plus(f).loc(b),b.word({op:"+",
args:[c,{op:"num",num:++e}]})}const b=this.rom.assembler();free$$module$js$rom$util(b,$14$$module$js$rom$messages,32768,34048);free$$module$js$rom$util(b,$14$$module$js$rom$messages,34080,34088);free$$module$js$rom$util(b,$14$$module$js$rom$messages,34182,34195);free$$module$js$rom$util(b,$14$$module$js$rom$messages,35072,37888);free$$module$js$rom$util(b,$14$$module$js$rom$messages,38533,38662);free$$module$js$rom$util(b,$14$$module$js$rom$messages,40576,40960);free$$module$js$rom$util(b,$15$$module$js$rom$messages,
40960,49152);free$$module$js$rom$util(b,$16_a$$module$js$rom$messages,40960,49152);free$$module$js$rom$util(b,$17$$module$js$rom$messages,40960,48128);var c=seq$$module$js$rom$util(this.partCount,()=>[]);for(var d=0;d<this.partCount;d++){var e=c[d];const a=this.parts[d];b.segment(SEGMENTS$$module$js$rom$messages[this.banks[d]].name);for(const c of a)b.reloc(`Message_${c.mid}`),e.push(b.pc()),b.byte(...c.bytes,0)}d=[];b.segment($14$$module$js$rom$messages.name);b.reloc("MessagesTable");for(e=0;e<this.partCount;e++)d.push(b.pc()),
b.word(...c[e]);c=b.pc();b.byte(...this.banks);b.reloc("MessageParts");e=b.pc();b.word(...d);a(BANKS_PTR$$module$js$rom$messages,c);a(BANKS_PTR2$$module$js$rom$messages,c);a(PARTS_PTR$$module$js$rom$messages,e,5);c=[["CommonWords",this.commonWords,[COMMON_WORDS_BASE_PTR$$module$js$rom$messages]],["UncommonWords",this.uncommonWords,[UNCOMMON_WORDS_BASE_PTR$$module$js$rom$messages]],["PersonNames",this.personNames,[PERSON_NAMES_BASE_PTR$$module$js$rom$messages]],["ItemNames",this.itemNames,[ITEM_NAMES_BASE_PTR$$module$js$rom$messages,
ITEM_NAMES_BASE_PTR2$$module$js$rom$messages]]];for(const [e,g,h]of c){c=[];d=0;for(const a of g)a?(b.reloc(`${e}_${hex$$module$js$rom$util(d++)}`),c.push(b.pc()),b.byte(a,0)):c.push(0);b.reloc(e);d=b.pc();b.word(...c);for(const b of h)a(b,d,5)}return[b.module()]}}Messages$$module$js$rom$messages.CONTINUED="#";const MAX_TABLE_LENGTH$$module$js$rom$messages=1250,CLOSERS$$module$js$rom$messages={"{":"}","[":"]"},HARDCODED_MESSAGES$$module$js$rom$messages=new Set("20:1d 1b:0f 1b:10 1b:11 1b:12 1b:05 1b:06 1b:07 1f:00 13:00 0b:01 20:0c 20:0f 1c:11 0e:05 16:00 16:02 16:04 16:06 20:11 21:00 21:02 21:01 06:00 18:00 18:02 18:04 18:08 1b:03 1b:00 1b:00 1b:04 06:01 10:13 19:05 20:14 20:15 20:17 20:02 20:0d 20:19 20:1a 20:1b 03:01 03:02 10:10 10:11 10:12 0c:04 0c:05 03:03 20:0e 20:13".split(" "));
var module$js$rom$messages={};module$js$rom$messages.Messages=Messages$$module$js$rom$messages;module$js$rom$messages.HARDCODED_MESSAGES=HARDCODED_MESSAGES$$module$js$rom$messages;class Metascreen$$module$js$rom$metascreen{constructor(a,b,c){var d,e,f;this.rom=a;this.uid=b;this.data=c;this._tilesets=new Set;this.used=!1;this.neighbors=[new DefaultMap$$module$js$util((a)=>this._checkNeighbor(a,0)),new DefaultMap$$module$js$util((a)=>this._checkNeighbor(a,1))];for(const a of Object.values(c.tilesets))a.requires||(this.used=!0);a=0;for(var g of null!==(d=c.feature)&&void 0!==d?d:[])d=featureMask$$module$js$rom$metascreendata[g],null!=d&&(a|=d);for(const b of null!==(e=c.exits)&&
void 0!==e?e:[])if("stair:down"===b.type||"stair:up"===b.type)a|=featureMask$$module$js$rom$metascreendata[b.type];this._features=a;this.flag=c.flag;this.connections=c=[[[]],[[]],[[]],[[]]];for(e=0;3>e;e++)for(const a of null!==(f=this.data.connect)&&void 0!==f?f:"")connectionBlocks$$module$js$rom$metascreen.includes(a)?c[e].push([]):(g=parseInt(a,16))&&c[e][c[e].length-1].push((g&3)<<(g&4)|(g&8?g&4?256:4096:0))}get manual(){return!!(this._features&manualFeatureMask$$module$js$rom$metascreen)}get counted(){return!!(this._features&
countedFeatureMask$$module$js$rom$metascreen)}hasFeature(a){return!!(this._features&featureMask$$module$js$rom$metascreendata[a])}hasFeatures(a){return(this._features&a)===a}withFeature(a){throw Error();}withObstruction(){throw Error();}isCompatibleWithTileset(a){for(const b of this._tilesets)if(b.tilesetId===a)return!0;return!1}replace(a,b){const {tiles:c}=this.screen;for(let d=0;d<c.length;d++)c[d]===a&&(c[d]=b);return this}remove(){for(const a in this.data.tilesets)this.rom.metatilesets[a].deleteScreen(this)}get id(){return this.data.id}set id(a){this.id!==
a&&this.rom.metascreens.renumber(this.id,a)}get screen(){const {id:a,rom:{screens:b}}=this;return 0>a?b.unallocated[~a]:b[a]}unsafeSetId(a){this.data.id=a;for(const a of this._tilesets)a.invalidate()}unsafeAddTileset(a){this._tilesets.add(a)}unsafeRemoveTileset(a){this._tilesets.delete(a)}edgeExits(){var a;let b=0;for(const c of null!==(a=this.data.exits)&&void 0!==a?a:[])a=edgeTypeMap$$module$js$rom$metascreen[c.type],null!=a&&(b|=1<<a);return b}findExitType(a,b,c){var d,e;for(const f of null!==
(d=this.data.exits)&&void 0!==d?d:[])if(f.type.startsWith("seamless")===c&&(d=b&&"edge:bottom"===f.type&&192<=a?a+32:a,f.exits.includes(d)||(null!==(e=f.allowedExits)&&void 0!==e?e:[]).includes(d)))return f}findEntranceType(a,b){var c,d;for(const e of null!==(c=this.data.exits)&&void 0!==c?c:[]){if(e.type.startsWith("seamless"))continue;c=b&&"edge:bottom"===e.type&&48896<=a?a+8192:a;const f=(c&240)>>4|(c&61440)>>8;if(e.entrance===c||e.exits.includes(f)||(null!==(d=e.allowedExits)&&void 0!==d?d:[]).includes(f))return e.type}}addCustomFlag(a){this.flag=
a?"custom:true":"custom:false"}_checkNeighbor(a,b){return!1}}
const edgeTypeMap$$module$js$rom$metascreen={"edge:top":0,"edge:left":1,"edge:bottom":2,"edge:right":3},connectionBlocks$$module$js$rom$metascreen=["|:","|:=-","|","|="],manualFeatures$$module$js$rom$metascreen=new Set("arena portoa1 portoa2 portoa3 lake overBridge underBridge lighthouse cabin windmill altar pyramid crypt".split(" ")),countedFeatures$$module$js$rom$metascreen=new Set("pit spikes bridge wall stairs whirlpool".split(" ")),manualFeatureMask$$module$js$rom$metascreen=[...manualFeatures$$module$js$rom$metascreen].map((a)=>
featureMask$$module$js$rom$metascreendata[a]).reduce((a,b)=>a|b),countedFeatureMask$$module$js$rom$metascreen=[...countedFeatures$$module$js$rom$metascreen].map((a)=>featureMask$$module$js$rom$metascreendata[a]).reduce((a,b)=>a|b);var module$js$rom$metascreen={};module$js$rom$metascreen.Metascreen=Metascreen$$module$js$rom$metascreen;var ScreenFix$$module$js$rom$screenfix;
(function(a){a[a.Unknown=0]="Unknown";a[a.GrassLongGrass=1]="GrassLongGrass";a[a.GrassLongGrassRemapping=2]="GrassLongGrassRemapping";a[a.RiverShortGrass=3]="RiverShortGrass";a[a.SeaCaveEntrance=4]="SeaCaveEntrance";a[a.SeaRocks=5]="SeaRocks";a[a.SeaMarsh=6]="SeaMarsh";a[a.SeaTrees=7]="SeaTrees";a[a.DesertShortGrass=8]="DesertShortGrass";a[a.DesertLongGrass=9]="DesertLongGrass";a[a.DesertMarsh=10]="DesertMarsh";a[a.DesertRocks=11]="DesertRocks";a[a.DesertTrees=12]="DesertTrees";a[a.DesertTownEntrance=
13]="DesertTownEntrance";a[a.LabyrinthParapets=14]="LabyrinthParapets";a[a.SwampDoors=15]="SwampDoors";a[a.ExtraSpikes=16]="ExtraSpikes";a[a.CloseCaves=17]="CloseCaves"})(ScreenFix$$module$js$rom$screenfix||(ScreenFix$$module$js$rom$screenfix={}));function withRequire$$module$js$rom$screenfix(a,b){for(const c in b)b[c].requires=[a];return b}
function fixTilesets$$module$js$rom$screenfix(a){const {desert:b,grass:c,lime:d,mountain:e,mountainRiver:f,river:g,sea:h}=a.metatilesets;var k=a.metascreens;k.registerFix(ScreenFix$$module$js$rom$screenfix.DesertRocks);b.getTile(95).copyFrom(91).replaceIn(k.oasisCave,k.oasisLake);b.getTile(90).copyFrom(152).setTiles([,,26,24]);b.getTile(91).copyFrom(128).setTiles([52,50,,]);b.getTile(92).copyFrom(128).setTiles([,,55,53]);b.getTile(93).copyFrom(128).setTiles([,55,,52]);b.getTile(94).copyFrom(128).setTiles([53,
,50]);k.registerFix(ScreenFix$$module$js$rom$screenfix.DesertTrees);b.getTile(99).copyFrom(113);b.getTile(104).copyFrom(112);b.getTile(105).copyFrom(96);b.getTile(106).copyFrom(101);b.getTile(108).copyFrom(112);b.getTile(110).copyFrom(118);b.getTile(111).copyFrom(120);k.registerFix(ScreenFix$$module$js$rom$screenfix.GrassLongGrass);c.getTile(64).copyFrom(81);c.getTile(65).copyFrom(82);c.getTile(66).copyFrom(83);c.getTile(67).copyFrom(84);c.getTile(68).copyFrom(85);c.getTile(69).copyFrom(86);c.getTile(70).copyFrom(88);
c.getTile(71).copyFrom(89);k.registerFix(ScreenFix$$module$js$rom$screenfix.SeaCaveEntrance);h.getTile(173).copyFrom(10).replaceIn(k.beachExitN,k.lighthouseEntrance,k.oceanShrine);h.getTile(10).copyFrom(162);k.boundaryN_cave.screen.set2d(56,[[null,0,0,null],[null,10,10,null],[null,144,144,null],[248,248,248,248]]);k.cornerSE_cave.screen.set2d(73,[[null,0,0],[null,10,10],[null,144,144],[248,247,247],[null,253,247]]);k.cornerSE_cave.screen.set2d(74,[[0,0],[10,10],[144,144],[248,247],[128,253],[128,
255],[250,null]]);h.getTile(144).setTiles([145,145,125,125]).setAttrs(2).setEffects(2);g.getTile(144).copyFrom(247);c.getTile(144).copyFrom(247);b.getTile(144).copyFrom(247);k.registerFix(ScreenFix$$module$js$rom$screenfix.CloseCaves);g.getTile(7).copyFrom(1).replaceIn(...g);g.getTile(14).copyFrom(2).replaceIn(...g);g.getTile(32).copyFrom(3).replaceIn(...g);g.getTile(33).copyFrom(4).replaceIn(...g);for(const a of[b,h,e,f,d])a.getTile(104).copyFrom(1).replaceIn(...a),a.getTile(131).copyFrom(2).replaceIn(...a),
a.getTile(136).copyFrom(3).replaceIn(...a),a.getTile(137).copyFrom(4).replaceIn(...a);for(const a of[g,b,h])a.getTile(1).copyFrom(193).setAlternative(0),a.getTile(2).copyFrom(193).setAlternative(0),a.getTile(3).copyFrom(215).setAlternative(10),a.getTile(4).copyFrom(215).setAlternative(10);k=[[k.boundaryE_cave,72],[k.boundaryW_cave,121],[k.exitW_cave,56],[k.caveAbovePortoa,86]];for(const [a,b]of k)a.screen.set2d(b,[[1,2],[3,4]]),a.addCustomFlag(!0);{const {locations:{CordelPlainEast:b,CordelPlainWest:c,
WaterfallValleyNorth:d},flags:{OpenedSealedCave:e}}=a;b.meta.customFlags.set(48,e);c.meta.customFlags.set(48,e);d.meta.customFlags.set(48,e);a=Spawn$$module$js$rom$locationtables.of({y:96,x:96,type:4,id:44});k=Spawn$$module$js$rom$locationtables.of({y:112,x:112,type:2,id:173});d.spawns.splice(1,0,a);d.spawns.push(k)}}var module$js$rom$screenfix={};module$js$rom$screenfix.ScreenFix=ScreenFix$$module$js$rom$screenfix;module$js$rom$screenfix.withRequire=withRequire$$module$js$rom$screenfix;
module$js$rom$screenfix.fixTilesets=fixTilesets$$module$js$rom$screenfix;function labyrinthVariant$$module$js$rom$metascreens(a,b,c,d,e){return(f,g,h)=>{if((g>>>b&1)!==c)return!1;g=a(h.metascreens);for(const a of"number"===typeof d?[d]:d)h.screens[f.data.id].set2d(a,[[25,25],[27,27]]);for(const a of"number"===typeof e?[e]:e||[])h.screens[f.data.id].set2d(a,[[197,197],[208,197]]);"always"!==f.flag?g.flag="always":null!=e&&g.remove();return!0}}
class Metascreens$$module$js$rom$metascreens{constructor(a){this.rom=a;this.length=0;this.screensByFix=new DefaultMap$$module$js$util(()=>[]);this.screensById=new DefaultMap$$module$js$util(()=>[]);this.overworldEmpty=this.metascreen({id:0,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u2588\u2588|
      |\u2588\u2588\u2588|
      |\u2588\u2588\u2588|`,tilesets:{grass:{},river:{},sea:{},desert:{}},feature:["empty"],edges:"    "});this.boundaryW_trees=this.metascreen({id:1,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u258c |
      |\u2588\u258c^|
      |\u2588\u258c |`,tilesets:{grass:{},river:{},desert:{requires:[module$js$rom$screenfix.ScreenFix.DesertRocks]},sea:{requires:[module$js$rom$screenfix.ScreenFix.SeaTrees]}},edges:"> >o"});this.boundaryW=this.metascreen({id:2,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u258c |
      |\u2588\u258c |
      |\u2588\u258c |`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"> >o"});this.boundaryE_rocks=this.metascreen({id:3,icon:icon$$module$js$rom$metascreendata`
      |.\u2590\u2588|
      | \u2590\u2588|
      |.\u2590\u2588|`,tilesets:{grass:{},river:{},desert:{requires:[module$js$rom$screenfix.ScreenFix.DesertRocks]},sea:{requires:[module$js$rom$screenfix.ScreenFix.SeaRocks]}},edges:"<o< "});this.boundaryE=this.metascreen({id:4,icon:icon$$module$js$rom$metascreendata`
      | \u2590\u2588|
      | \u2590\u2588|
      | \u2590\u2588|`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"<o< "});this.longGrassS=this.metascreen({id:5,icon:icon$$module$js$rom$metascreendata`
      |vv |
      | vv|
      |   |`,tilesets:{river:{},grass:{requires:[module$js$rom$screenfix.ScreenFix.GrassLongGrass]}},edges:"looo"});this.longGrassN=this.metascreen({id:6,icon:icon$$module$js$rom$metascreendata`
      |   |
      | vv|
      |vv |`,tilesets:{river:{},grass:{requires:[module$js$rom$screenfix.ScreenFix.GrassLongGrass]}},edges:"oolo"});this.boundaryS_rocks=this.metascreen({id:7,icon:icon$$module$js$rom$metascreendata`
      | . |
      |\u2584\u2584\u2584|
      |\u2588\u2588\u2588|`,tilesets:{grass:{},river:{},desert:{requires:[module$js$rom$screenfix.ScreenFix.DesertRocks]},sea:{requires:[module$js$rom$screenfix.ScreenFix.SeaRocks]}},edges:"o^ ^"});this.fortressTownEntrance=this.metascreen({id:8,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u2588\u2588|
      |\u2588\u2229\u2588|
      |   |`,tilesets:{grass:{}},edges:" vov",exits:[Object.assign({},upStair$$module$js$rom$metascreendata(166,3),{type:"fortress"})]});this.bendSE_longGrass=this.metascreen({id:9,icon:icon$$module$js$rom$metascreendata`\u2597
      | v |
      |vv\u2584|
      | \u2590\u2588|`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"oo<^"});this.exitW_cave=this.metascreen({id:10,icon:icon$$module$js$rom$metascreendata`\u2229
      |\u2588\u2229\u2588|
      |  \u2588|
      |\u2588\u2588\u2588|`,tilesets:{grass:{},river:{},desert:{},sea:{requires:[module$js$rom$screenfix.ScreenFix.SeaCaveEntrance]}},edges:" n  ",exits:[cave$$module$js$rom$metascreendata(72),leftEdge$$module$js$rom$metascreendata({top:6})]});this.bendNE_grassRocks=this.metascreen({id:11,icon:icon$$module$js$rom$metascreendata`\u259d
      |.\u2590\u2588|
      |  \u2580|
      |;;;|`,tilesets:{grass:{},river:{requires:[module$js$rom$screenfix.ScreenFix.RiverShortGrass]},desert:{requires:[module$js$rom$screenfix.ScreenFix.DesertShortGrass,module$js$rom$screenfix.ScreenFix.DesertRocks]}},edges:"<osv"});this.cornerNW=this.metascreen({id:12,icon:icon$$module$js$rom$metascreendata`\u259b
      |\u2588\u2588\u2588|
      |\u2588 \u2580|
      |\u2588\u258c |`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"  >v"});this.overworldEmpty_alt=this.metascreen({id:12,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u2588\u2588|
      |\u2588\u2588\u2588|
      |\u2588\u2588\u2588|`,tilesets:{grass:{},river:{},sea:{},desert:{}},feature:["empty"],edges:"    ",match:()=>!1});this.cornerNE=this.metascreen({id:13,icon:icon$$module$js$rom$metascreendata`\u259c
      |\u2588\u2588\u2588|
      |\u2580\u2588\u2588|
      | \u2590\u2588|`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:" v< "});this.cornerSW=this.metascreen({id:14,icon:icon$$module$js$rom$metascreendata`\u2599
      |\u2588\u258c |
      |\u2588\u2588\u2584|
      |\u2588\u2588\u2588|`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:">  ^"});this.cornerSE=this.metascreen({id:15,icon:icon$$module$js$rom$metascreendata`\u259f
      | \u2590\u2588|
      |\u2584\u2588\u2588|
      |\u2588\u2588\u2588|`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"<^  "});this.exitE=this.metascreen({id:16,icon:icon$$module$js$rom$metascreendata`\u2576
      | \u2590\u2588|
      |   |
      | \u2590\u2588|`,tilesets:{grass:{},river:{},desert:{requires:[module$js$rom$screenfix.ScreenFix.DesertRocks]}},edges:"<o<n",exits:[rightEdge$$module$js$rom$metascreendata({top:6})]});this.boundaryN_trees=this.metascreen({id:17,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u2588\u2588|
      |\u2580\u2580\u2580|
      | ^ |`,tilesets:{grass:{},river:{},desert:{},sea:{requires:[module$js$rom$screenfix.ScreenFix.SeaTrees]}},edges:" vov"});this.bridgeToPortoa=this.metascreen({id:18,icon:icon$$module$js$rom$metascreendata`\u2574
      |\u2550  |
      |\u255e\u2550\u2550|
      |\u2502  |`,tilesets:{river:{}},feature:["portoa3"],edges:"2*>r",exits:[leftEdge$$module$js$rom$metascreendata({top:1})]});this.slopeAbovePortoa=this.metascreen({id:19,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u2193\u2588|
      |\u2588\u2193\u2580|
      |\u2502  |`,tilesets:{river:{}},feature:["portoa2"],edges:"1*2v"});this.riverBendSE=this.metascreen({id:20,icon:icon$$module$js$rom$metascreendata`
      |w  |
      | \u2554\u2550|
      | \u2551 |`,tilesets:{river:{}},edges:"oorr"});this.boundaryW_cave=this.metascreen({id:21,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u258c |
      |\u2588\u2229 |
      |\u2588\u258c |`,tilesets:{grass:{},river:{},desert:{},sea:{requires:[module$js$rom$screenfix.ScreenFix.SeaCaveEntrance]}},edges:"> >o",exits:[cave$$module$js$rom$metascreendata(137)]});this.exitN=this.metascreen({id:22,icon:icon$$module$js$rom$metascreendata`\u2575
      |\u2588 \u2588|
      |\u2580 \u2580|
      | ^ |`,tilesets:{grass:{},river:{},desert:{}},edges:"nvov",exits:[topEdge$$module$js$rom$metascreendata()]});this.riverWE_woodenBridge=this.metascreen({id:23,icon:icon$$module$js$rom$metascreendata`\u2550
      |   |
      |\u2550\u2551\u2550|
      |   |`,tilesets:{river:{}},edges:"oror",exits:[seamlessUp$$module$js$rom$metascreendata(119),seamlessDown$$module$js$rom$metascreendata(135)]});this.riverBoundaryE_waterfall=this.metascreen({id:24,icon:icon$$module$js$rom$metascreendata`\u2561
      | \u2590\u2588|
      |\u2550\u2550/|
      | \u2590\u2588|`,tilesets:{river:{}},edges:"<r< "});this.boundaryE_cave=this.metascreen({id:25,icon:icon$$module$js$rom$metascreendata`
      | \u2590\u2588|
      |v\u2229\u2588|
      |v\u2590\u2588|`,tilesets:{river:{},grass:{requires:[module$js$rom$screenfix.ScreenFix.GrassLongGrass]},desert:{requires:[module$js$rom$screenfix.ScreenFix.DesertLongGrass]}},edges:"<o< ",exits:[cave$$module$js$rom$metascreendata(88)]});this.exitW_southwest=this.metascreen({id:26,icon:icon$$module$js$rom$metascreendata`\u2574
      |\u2588\u258c |
      |\u2580 \u2584|
      |\u2584\u2588\u2588|`,tilesets:{grass:{},river:{},desert:{requires:[module$js$rom$screenfix.ScreenFix.DesertRocks]},sea:{requires:[module$js$rom$screenfix.ScreenFix.SeaRocks]}},edges:">* ^",exits:[leftEdge$$module$js$rom$metascreendata({top:11})]});this.nadare=this.metascreen({id:27,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata(),door$$module$js$rom$metascreendata(35),door$$module$js$rom$metascreendata(37,"door2"),door$$module$js$rom$metascreendata(42,"door3")]});
this.townExitW=this.metascreen({id:28,icon:icon$$module$js$rom$metascreendata`\u2574
      |\u2588\u258c |
      |\u2580 ^|
      |\u2588\u258c |`,tilesets:{grass:{},river:{}},edges:">n>o",exits:[leftEdge$$module$js$rom$metascreendata({top:8,height:3,shift:-.5})]});this.shortGrassS=this.metascreen({id:29,icon:icon$$module$js$rom$metascreendata` |
      |;;;|
      | v |
      |   |`,tilesets:{grass:{},river:{requires:[module$js$rom$screenfix.ScreenFix.RiverShortGrass,module$js$rom$screenfix.ScreenFix.GrassLongGrassRemapping]}},edges:"sooo"});this.townExitS=this.metascreen({id:30,icon:icon$$module$js$rom$metascreendata`\u2577
      | ^ |
      |\u2584 \u2584|
      |\u2588 \u2588|`,tilesets:{grass:{},river:{},desert:{requires:[module$js$rom$screenfix.ScreenFix.DesertRocks,module$js$rom$screenfix.ScreenFix.DesertTownEntrance]}},edges:"o^n^",exits:[bottomEdge$$module$js$rom$metascreendata()]});this.swanGate=this.metascreen({id:31,tilesets:{town:{}},exits:[leftEdge$$module$js$rom$metascreendata({top:3}),rightEdge$$module$js$rom$metascreendata({top:9})],flag:"custom:false"});this.riverBranchNSE=this.metascreen({id:32,icon:icon$$module$js$rom$metascreendata`
      | \u2551 |
      | \u2560\u2550|
      | \u2551 |`,tilesets:{river:{}},edges:"rorr"});this.riverWE=this.metascreen({id:33,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2550\u2550\u2550|
      |   |`,tilesets:{river:{}},edges:"oror"});this.riverBoundaryS_waterfall=this.metascreen({id:34,icon:icon$$module$js$rom$metascreendata`\u2568
      | \u2551 |
      |\u2584\u2551\u2584|
      |\u2588/\u2588|`,tilesets:{river:{}},edges:"r^ ^"});this.shortGrassSE=this.metascreen({id:35,icon:icon$$module$js$rom$metascreendata`
      |;;;|
      |;  |
      |; ^|`,tilesets:{grass:{}},edges:"ssoo"});this.shortGrassNE=this.metascreen({id:36,icon:icon$$module$js$rom$metascreendata` |
      |;  |
      |;v |
      |;;;|`,tilesets:{grass:{}},edges:"osso"});this.stomHouseOutside=this.metascreen({id:37,icon:icon$$module$js$rom$metascreendata`\u2229
      |\u2588\u2588\u2588|
      |\u258c\u2229\u2590|
      |\u2588 \u2588|`,tilesets:{grass:{}},exits:[door$$module$js$rom$metascreendata(104),bottomEdge$$module$js$rom$metascreendata({shift:.5})]});this.bendNW_trees=this.metascreen({id:38,icon:icon$$module$js$rom$metascreendata`\u2598
      |\u2588\u258c |
      |\u2580 ^|
      | ^^|`,tilesets:{grass:{},river:{},desert:{requires:[module$js$rom$screenfix.ScreenFix.DesertRocks,module$js$rom$screenfix.ScreenFix.DesertTrees]},sea:{requires:[module$js$rom$screenfix.ScreenFix.SeaRocks,module$js$rom$screenfix.ScreenFix.SeaTrees]}},edges:">voo"});this.shortGrassSW=this.metascreen({id:39,icon:icon$$module$js$rom$metascreendata`
      |;;;|
      |  ;|
      |^ ;|`,tilesets:{grass:{},river:{requires:[module$js$rom$screenfix.ScreenFix.RiverShortGrass]}},edges:"soos"});this.riverBranchNWS=this.metascreen({id:40,icon:icon$$module$js$rom$metascreendata`
      | \u2551 |
      |\u2550\u2563 |
      | \u2551 |`,tilesets:{river:{}},edges:"rrro"});this.shortGrassNW=this.metascreen({id:41,icon:icon$$module$js$rom$metascreendata`
      |  ;|
      | v;|
      |;;;|`,tilesets:{grass:{},river:{requires:[module$js$rom$screenfix.ScreenFix.RiverShortGrass,module$js$rom$screenfix.ScreenFix.GrassLongGrassRemapping]}},edges:"ooss"});this.valleyBridge=this.metascreen({id:42,icon:icon$$module$js$rom$metascreendata` |
      |\u259b\u2551\u259c|
      | \u2551 |
      |\u2599\u2551\u259f|`,tilesets:{grass:{},river:{}},edges:"n n ",exits:[seamlessUp$$module$js$rom$metascreendata(119),seamlessDown$$module$js$rom$metascreendata(135),topEdge$$module$js$rom$metascreendata(),bottomEdge$$module$js$rom$metascreendata()]});this.exitS_cave=this.metascreen({id:43,icon:icon$$module$js$rom$metascreendata`\u2229
      |\u2588\u2229\u2588|
      |\u258c \u2590|
      |\u2588 \u2588|`,tilesets:{grass:{},river:{},desert:{},sea:{requires:[module$js$rom$screenfix.ScreenFix.SeaCaveEntrance]}},edges:"  n ",exits:[cave$$module$js$rom$metascreendata(103),bottomEdge$$module$js$rom$metascreendata()]});this.outsideWindmill=this.metascreen({id:44,icon:icon$$module$js$rom$metascreendata`\u2573
      |\u2588\u2588\u2573|
      |\u2588\u2229\u2588|
      |\u2588 \u2588|`,tilesets:{grass:{}},flag:"custom:false",feature:["windmill"],edges:"  n ",exits:[cave$$module$js$rom$metascreendata(99),bottomEdge$$module$js$rom$metascreendata(),door$$module$js$rom$metascreendata(137,"windmill"),door$$module$js$rom$metascreendata(140)]});this.townExitW_cave=this.metascreen({id:45,icon:icon$$module$js$rom$metascreendata`\u2229
      |\u2588\u2229\u2588|
      |\u2584\u2584\u2588|
      |\u2588\u2588\u2588|`,tilesets:{grass:{}},edges:" n  ",exits:[cave$$module$js$rom$metascreendata(74),leftEdge$$module$js$rom$metascreendata({top:5,height:3,shift:-.5})],flag:"custom:true"});this.riverNS=this.metascreen({id:46,icon:icon$$module$js$rom$metascreendata`
      | \u2551 |
      | \u2551 |
      | \u2551 |`,tilesets:{river:{}},edges:"roro"});this.riverNS_bridge=this.metascreen({id:47,icon:icon$$module$js$rom$metascreendata`
      | \u2551 |
      |w\u254fw|
      | \u2551 |`,tilesets:{river:{}},feature:["bridge"],edges:"roro",wall:119});this.riverBendWS=this.metascreen({id:48,icon:icon$$module$js$rom$metascreendata`
      | w\u259c|
      |\u2550\u2557w|
      | \u2551 |`,tilesets:{river:{}},edges:"<rrv"});this.boundaryN_waterfallCave=this.metascreen({id:49,icon:icon$$module$js$rom$metascreendata`
      |\u259b/\u2588|
      |\u2598\u2551\u2580|
      | \u2551 |`,tilesets:{river:{}},edges:" vrv",exits:[waterfallCave$$module$js$rom$metascreendata(117)]});this.open_trees=this.metascreen({id:50,icon:icon$$module$js$rom$metascreendata`
      | ^ |
      |^ ^|
      | ^ |`,tilesets:{grass:{},river:{},desert:{requires:[module$js$rom$screenfix.ScreenFix.DesertTrees,module$js$rom$screenfix.ScreenFix.DesertRocks]}},edges:"oooo"});this.exitS=this.metascreen({id:51,icon:icon$$module$js$rom$metascreendata`\u2577
      | w |
      |\u2584 \u2584|
      |\u2588 \u2588|`,tilesets:{grass:{},river:{},desert:{requires:[module$js$rom$screenfix.ScreenFix.DesertMarsh]},sea:{requires:[module$js$rom$screenfix.ScreenFix.SeaMarsh]}},edges:"o^n^",exits:[bottomEdge$$module$js$rom$metascreendata()]});this.bendNW=this.metascreen({id:52,icon:icon$$module$js$rom$metascreendata`\u2598
      |\u2588\u258c |
      |\u2580\u2580 |
      |   |`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:">voo"});this.bendNE=this.metascreen({id:53,icon:icon$$module$js$rom$metascreendata`\u259d
      | \u2590\u2588|
      |  \u2580|
      |   |`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"<oov"});this.bendSE=this.metascreen({id:54,icon:icon$$module$js$rom$metascreendata`\u2597
      |   |
      | \u2584\u2584|
      | \u2590\u2588|`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"oo<^"});this.bendWS=this.metascreen({id:55,icon:icon$$module$js$rom$metascreendata`\u2596
      |   |
      |\u2584\u2584 |
      |\u2588\u258c |`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"o^>o"});this.towerPlain_upStair=this.metascreen({id:56,icon:icon$$module$js$rom$metascreendata`\u2534
      | \u250a |
      |\u2500\u2534\u2500|
      |   |`,tilesets:{tower:{}},edges:"st t",exits:[seamlessDown$$module$js$rom$metascreendata(8,2),topEdge$$module$js$rom$metascreendata({left:8})]});this.towerRobotDoor_downStair=this.metascreen({id:57,icon:icon$$module$js$rom$metascreendata`\u252c
      | \u2229 |
      |\u2500\u252c\u2500|
      | \u250a |`,tilesets:{tower:{}},edges:" tst",exits:[seamlessUp$$module$js$rom$metascreendata(232,2)]});this.towerDynaDoor=this.metascreen({id:58,icon:icon$$module$js$rom$metascreendata`\u2229
      | \u2229 |
      |\u2514\u252c\u2518|
      | \u250a |`,tilesets:{tower:{}},edges:"  s ",exits:[cave$$module$js$rom$metascreendata(103,"door")]});this.towerLongStairs=this.metascreen({id:59,icon:icon$$module$js$rom$metascreendata`
      | \u250a |
      | \u250a |
      | \u250a |`,tilesets:{tower:{}},edges:"s s ",exits:[bottomEdge$$module$js$rom$metascreendata()]});this.towerMesiaRoom=this.metascreen({id:60,tilesets:{tower:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata()]});this.towerTeleporter=this.metascreen({id:61,tilesets:{tower:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata(),cave$$module$js$rom$metascreendata(87,"teleporter")]});this.caveAbovePortoa=this.metascreen({id:62,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u2588\u2588|
      |\u2588\u2229\u2588|
      |\u2588\u2193\u2588|`,tilesets:{river:{}},edges:"  1 ",exits:[cave$$module$js$rom$metascreendata(102)]});this.cornerNE_flowers=this.metascreen({id:63,icon:icon$$module$js$rom$metascreendata`\u259c
      |\u2588\u2588\u2588|
      |\u2580*\u2588|
      | \u2590\u2588|`,tilesets:{grass:{}},edges:" v< "});this.towerEdge=this.metascreen({id:64,icon:icon$$module$js$rom$metascreendata` |
      |   |
      |\u2524 \u251c|
      |   |`,tilesets:{tower:{}},edges:" t t"});this.towerEdgeW=this.metascreen({id:64,icon:icon$$module$js$rom$metascreendata` |
      |   |
      |\u2524  |
      |   |`,tilesets:{tower:{}},edges:" t  "});this.towerEdgeE=this.metascreen({id:64,icon:icon$$module$js$rom$metascreendata` |
      |   |
      |  \u251c|
      |   |`,tilesets:{tower:{}},edges:"   t"});this.towerRobotDoor=this.metascreen({id:65,icon:icon$$module$js$rom$metascreendata`\u2500
      | O |
      |\u2500\u2500\u2500|
      |   |`,tilesets:{tower:{}},edges:" t t"});this.towerDoor=this.metascreen({id:66,icon:icon$$module$js$rom$metascreendata`\u2229
      | \u2229 |
      |\u2500\u2534\u2500|
      |   |`,tilesets:{tower:{}},edges:" t t",exits:[cave$$module$js$rom$metascreendata(88)]});this.house_bedroom=this.metascreen({id:67,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata()]});this.shed=this.metascreen({id:68,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata(),cave$$module$js$rom$metascreendata(73)],flag:"custom:false"});this.tavern=this.metascreen({id:69,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata()]});this.house_twoBeds=
this.metascreen({id:70,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata()]});this.throneRoom_amazones=this.metascreen({id:71,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata({width:3}),downStair$$module$js$rom$metascreendata(76,1)]});this.house_ruinedUpstairs=this.metascreen({id:72,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata(),downStair$$module$js$rom$metascreendata(156,1)]});this.house_ruinedDownstairs=this.metascreen({id:73,
tilesets:{house:{}},exits:[upStair$$module$js$rom$metascreendata(86,1)]});this.foyer=this.metascreen({id:74,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata({shift:.5}),door$$module$js$rom$metascreendata(40),door$$module$js$rom$metascreendata(83,"door2"),door$$module$js$rom$metascreendata(92,"door3")]});this.throneRoom_portoa=this.metascreen({id:75,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata(),door$$module$js$rom$metascreendata(43)]});this.fortuneTeller=
this.metascreen({id:76,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata(),door$$module$js$rom$metascreendata(86),door$$module$js$rom$metascreendata(89,"door2")]});this.backRoom=this.metascreen({id:77,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata()]});this.dojo=this.metascreen({id:78,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata({shift:-.5})]});this.windmillInside=this.metascreen({id:79,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata({left:9,
width:1})]});this.horizontalTownMiddle=this.metascreen({id:80,tilesets:{town:{}},exits:[door$$module$js$rom$metascreendata(76),door$$module$js$rom$metascreendata(85,"door2")]});this.brynmaerRight_exitE=this.metascreen({id:81,tilesets:{town:{type:"horizontal"}},exits:[rightEdge$$module$js$rom$metascreendata({top:8}),door$$module$js$rom$metascreendata(65)]});this.brynmaerLeft_deadEnd=this.metascreen({id:82,tilesets:{town:{type:"horizontal"}},exits:[door$$module$js$rom$metascreendata(73),door$$module$js$rom$metascreendata(76,
"door2")]});this.swanLeft_exitW=this.metascreen({id:83,tilesets:{town:{type:"horizontal"}},exits:[leftEdge$$module$js$rom$metascreendata({top:9}),door$$module$js$rom$metascreendata(73),door$$module$js$rom$metascreendata(94,"door2")]});this.swanRight_exitS=this.metascreen({id:84,tilesets:{town:{type:"horizontal"}},exits:[bottomEdge$$module$js$rom$metascreendata({left:3}),door$$module$js$rom$metascreendata(65),door$$module$js$rom$metascreendata(67,"door2"),door$$module$js$rom$metascreendata(87,"door3")]});
this.horizontalTownLeft_exitN=this.metascreen({id:85,tilesets:{town:{type:"horizontal"}},exits:[topEdge$$module$js$rom$metascreendata({left:13}),door$$module$js$rom$metascreendata(70),door$$module$js$rom$metascreendata(75,"door2")]});this.amazonesRight_deadEnd=this.metascreen({id:86,tilesets:{town:{type:"horizontal"}},exits:[door$$module$js$rom$metascreendata(64),door$$module$js$rom$metascreendata(88,"door2")]});this.saharaRight_exitE=this.metascreen({id:87,tilesets:{town:{type:"horizontal"}},exits:[rightEdge$$module$js$rom$metascreendata({top:7}),
door$$module$js$rom$metascreendata(64),door$$module$js$rom$metascreendata(102,"door2")]});this.portoaNW=this.metascreen({id:88,tilesets:{town:{type:"square"}},exits:[cave$$module$js$rom$metascreendata(71,"fortress"),bottomEdge$$module$js$rom$metascreendata()]});this.portoaNE=this.metascreen({id:89,tilesets:{town:{type:"square"}},exits:[door$$module$js$rom$metascreendata(99),door$$module$js$rom$metascreendata(138,"door2"),bottomEdge$$module$js$rom$metascreendata({left:3,width:4})]});this.portoaSW_exitW=
this.metascreen({id:90,tilesets:{town:{type:"square"}},exits:[leftEdge$$module$js$rom$metascreendata({top:9}),door$$module$js$rom$metascreendata(134),topEdge$$module$js$rom$metascreendata()]});this.portoaSE_exitE=this.metascreen({id:91,tilesets:{town:{type:"square"}},exits:[rightEdge$$module$js$rom$metascreendata({top:9}),door$$module$js$rom$metascreendata(122),door$$module$js$rom$metascreendata(135,"door2")]});this.dyna=this.metascreen({id:92,tilesets:{tower:{}},exits:[{type:"stair:down",manual:!0,
dir:2,entrance:49024,exits:[]}]});this.portoaFisherman=this.metascreen({id:93,tilesets:{town:{type:"square"}},exits:[rightEdge$$module$js$rom$metascreendata({top:6}),leftEdge$$module$js$rom$metascreendata({top:4,height:6,shift:.5}),door$$module$js$rom$metascreendata(104)]});this.verticalTownTop_fortress=this.metascreen({id:94,tilesets:{town:{type:"vertical"}},exits:[cave$$module$js$rom$metascreendata(71),bottomEdge$$module$js$rom$metascreendata()]});this.shyronMiddle=this.metascreen({id:95,tilesets:{town:{type:"vertical"}},
exits:[door$$module$js$rom$metascreendata(84),door$$module$js$rom$metascreendata(91,"door2"),topEdge$$module$js$rom$metascreendata()]});this.shyronBottom_exitS=this.metascreen({id:96,tilesets:{town:{type:"vertical"}},exits:[bottomEdge$$module$js$rom$metascreendata({left:3}),door$$module$js$rom$metascreendata(4),door$$module$js$rom$metascreendata(6,"door2"),door$$module$js$rom$metascreendata(153,"door3")]});this.zombieTownMiddle=this.metascreen({id:97,tilesets:{town:{type:"vertical"}},exits:[door$$module$js$rom$metascreendata(153),
topEdge$$module$js$rom$metascreendata()]});this.zombieTownBottom_caveExit=this.metascreen({id:98,tilesets:{town:{type:"vertical"}},exits:[cave$$module$js$rom$metascreendata(146),door$$module$js$rom$metascreendata(35),door$$module$js$rom$metascreendata(77,"door2")]});this.leafNW_houseShed=this.metascreen({id:99,tilesets:{town:{type:"square"}},exits:[door$$module$js$rom$metascreendata(140),door$$module$js$rom$metascreendata(149,"door2")]});this.squareTownNE_house=this.metascreen({id:100,tilesets:{town:{type:"square"}},
exits:[topEdge$$module$js$rom$metascreendata({left:1}),door$$module$js$rom$metascreendata(183)]});this.leafSW_shops=this.metascreen({id:101,tilesets:{town:{type:"square"}},exits:[door$$module$js$rom$metascreendata(119),door$$module$js$rom$metascreendata(138,"door2")]});this.leafSE_exitE=this.metascreen({id:102,tilesets:{town:{type:"square"}},exits:[rightEdge$$module$js$rom$metascreendata({top:3,height:3,shift:-.5}),door$$module$js$rom$metascreendata(132)]});this.goaNW_tavern=this.metascreen({id:103,
tilesets:{town:{type:"square"}},exits:[door$$module$js$rom$metascreendata(186)]});this.squareTownSW_exitS=this.metascreen({id:104,tilesets:{town:{type:"square"}},exits:[bottomEdge$$module$js$rom$metascreendata({left:8}),door$$module$js$rom$metascreendata(132)]});this.goaSE_shop=this.metascreen({id:105,tilesets:{town:{type:"square"}},exits:[door$$module$js$rom$metascreendata(130)]});this.joelNE_shop=this.metascreen({id:106,tilesets:{town:{type:"square"}},exits:[door$$module$js$rom$metascreendata(167)]});
this.joelSE_lake=this.metascreen({id:107,tilesets:{town:{type:"square"}}});this.oakNW=this.metascreen({id:108,tilesets:{town:{type:"square"}},exits:[door$$module$js$rom$metascreendata(231)]});this.oakNE=this.metascreen({id:109,tilesets:{town:{type:"square"}},exits:[door$$module$js$rom$metascreendata(96)]});this.oakSW=this.metascreen({id:110,tilesets:{town:{type:"square"}},exits:[door$$module$js$rom$metascreendata(124)]});this.oakSE=this.metascreen({id:111,tilesets:{town:{type:"square"}},exits:[bottomEdge$$module$js$rom$metascreendata({left:0,
shift:.5}),door$$module$js$rom$metascreendata(151)]});this.temple=this.metascreen({id:112,tilesets:{house:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata()]});this.wideDeadEndN=this.metascreen({id:113,icon:icon$$module$js$rom$metascreendata`
      | \u2503 |
      | > |
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"w   ",connect:"2",exits:[downStair$$module$js$rom$metascreendata(199)]});this.goaWideDeadEndN=this.metascreen({id:113,icon:icon$$module$js$rom$metascreendata`
      |\u2575\u2503\u2575|
      | > |
      |   |`,tilesets:{labyrinth:{}},edges:"w   ",connect:"1|2|3",exits:[downStair$$module$js$rom$metascreendata(199)]});this.wideHallNS=this.metascreen({id:114,icon:icon$$module$js$rom$metascreendata`
      | \u2503 |
      | \u2503 |
      | \u2503 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"w w ",connect:"2a"});this.goaWideHallNS=this.metascreen({id:114,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2503\u2502|
      |\u2502\u2503\u2502|
      |\u2502\u2503\u2502|`,tilesets:{labyrinth:{}},edges:"w w ",connect:"19|2a|3b"});this.goaWideHallNS_blockedRight=this.metascreen({id:114,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2503\u2502|
      |\u2502\u2503 |
      |\u2502\u2503\u2502|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNS,0,0,157)]],edges:"w w ",connect:"19|2a|3|b"});this.goaWideHallNS_blockedLeft=this.metascreen({id:114,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2503\u2502|
      | \u2503\u2502|
      |\u2502\u2503\u2502|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNS,0,1,81)]],edges:"w w ",connect:"1|9|2a|3b"});this.goaWideArena=this.metascreen({id:115,icon:icon$$module$js$rom$metascreendata`<
      |\u257b<\u257b|
      |\u2521\u2501\u2529|
      |\u2502\u257b\u2502|`,tilesets:{labyrinth:{}},feature:["arena"],edges:"w*w*",allowed:(a)=>a.hasFeature("empty")?[1,3]:[],connect:"9b|a",exits:[upStair$$module$js$rom$metascreendata(55)]});this.limeTreeLake=this.metascreen({id:116,tilesets:{lime:{}},exits:[bottomEdgeHouse$$module$js$rom$metascreendata(),cave$$module$js$rom$metascreendata(71)]});this.swampNW=this.metascreen({id:117,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      |\u2500\u2518 |
      |   |`,tilesets:{swamp:{}},feature:["consolidate"],edges:"ss  ",connect:"26",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4}),leftEdge$$module$js$rom$metascreendata({top:7,height:3})]});this.swampE=this.metascreen({id:118,icon:icon$$module$js$rom$metascreendata`
      |   |
      | \u2576\u2500|
      |   |`,tilesets:{swamp:{}},feature:["consolidate"],edges:"   s",connect:"e",exits:[]});this.swampE_door=this.metascreen({id:118,icon:icon$$module$js$rom$metascreendata`\u2229
      | \u2229 |
      | \u2576\u2500|
      |   |`,tilesets:{swamp:{requires:[module$js$rom$screenfix.ScreenFix.SwampDoors]}},feature:["consolidate"],flag:"always",edges:"   s",connect:"e",exits:[cave$$module$js$rom$metascreendata(92,"swamp")]});this.swampNWSE=this.metascreen({id:119,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      |\u2500\u253c\u2500|
      | \u2502 |`,tilesets:{swamp:{}},feature:["consolidate"],edges:"ssss",connect:"26ae",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4}),leftEdge$$module$js$rom$metascreendata({top:7,height:3}),bottomEdge$$module$js$rom$metascreendata({left:6,width:4}),rightEdge$$module$js$rom$metascreendata({top:7,height:3})]});this.swampNWS=this.metascreen({id:120,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      |\u2500\u2524 |
      | \u2502 |`,tilesets:{swamp:{}},feature:["consolidate"],edges:"sss ",connect:"26a",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4}),leftEdge$$module$js$rom$metascreendata({top:7,height:3}),bottomEdge$$module$js$rom$metascreendata({left:6,width:4})]});this.swampNE=this.metascreen({id:121,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      | \u2514\u2500|
      |   |`,tilesets:{swamp:{}},feature:["consolidate"],edges:"s  s",connect:"2e",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4}),rightEdge$$module$js$rom$metascreendata({top:7,height:3})]});this.swampWSE=this.metascreen({id:122,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2500\u252c\u2500|
      | \u2502 |`,tilesets:{swamp:{}},feature:["consolidate"],edges:" sss",connect:"6ae",exits:[leftEdge$$module$js$rom$metascreendata({top:7,height:3}),bottomEdge$$module$js$rom$metascreendata({left:6,width:4}),rightEdge$$module$js$rom$metascreendata({top:7,height:3})]});this.swampWSE_door=this.metascreen({id:122,icon:icon$$module$js$rom$metascreendata`\u2229
      | \u2229  |
      |\u2500\u252c\u2500|
      | \u2502 |`,tilesets:{swamp:{requires:[module$js$rom$screenfix.ScreenFix.SwampDoors]}},feature:["consolidate"],flag:"always",edges:" sss",connect:"6ae",exits:[cave$$module$js$rom$metascreendata(86,"swamp")]});this.swampW=this.metascreen({id:123,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2500\u2574 |
      |   |`,tilesets:{swamp:{}},feature:["consolidate"],edges:" s  ",connect:"6"});this.swampW_door=this.metascreen({id:123,icon:icon$$module$js$rom$metascreendata`\u2229
      | \u2229 |
      |\u2500\u2574 |
      |   |`,tilesets:{swamp:{requires:[module$js$rom$screenfix.ScreenFix.SwampDoors]}},feature:["consolidate"],flag:"always",edges:" s  ",connect:"6",exits:[cave$$module$js$rom$metascreendata(84,"swamp")]});this.swampArena=this.metascreen({id:124,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2517\u252f\u251b|
      | \u2502 |`,tilesets:{swamp:{}},feature:["arena"],edges:" *s*",connect:"a",allowed:(a)=>a.hasFeature("empty")?[1,3]:[]});this.swampNWE=this.metascreen({id:125,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      |\u2500\u2534\u2500|
      |   |`,tilesets:{swamp:{}},feature:["consolidate"],edges:"ss s",connect:"26e",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4}),leftEdge$$module$js$rom$metascreendata({top:7,height:3}),rightEdge$$module$js$rom$metascreendata({top:7,height:3})]});this.swampWS=this.metascreen({id:126,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2500\u2510 |
      | \u2502 |`,tilesets:{swamp:{requires:[module$js$rom$screenfix.ScreenFix.SwampDoors]}},feature:["consolidate"],update:[[module$js$rom$screenfix.ScreenFix.SwampDoors,(a,c,d)=>{d.metascreens.swampWS_door.flag="always";return!0}]],edges:" ss ",connect:"6a",exits:[leftEdge$$module$js$rom$metascreendata({top:7,height:3}),bottomEdge$$module$js$rom$metascreendata({left:6,width:4})]});this.swampWS_door=this.metascreen({id:126,icon:icon$$module$js$rom$metascreendata`\u2229
      | \u2229 |
      |\u2500\u2510 |
      | \u2502 |`,tilesets:{swamp:{}},feature:["consolidate"],edges:" ss ",connect:"6a",exits:[cave$$module$js$rom$metascreendata(87,"swamp")]});this.swampEmpty=this.metascreen({id:127,icon:icon$$module$js$rom$metascreendata`
      |   |
      |   |
      |   |`,tilesets:{swamp:{}},feature:["empty"],edges:"    ",connect:""});this.swampN=this.metascreen({id:-113,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      | \u2575 |
      |   |`,tilesets:{swamp:{}},feature:["consolidate"],edges:"s   ",connect:"2"});this.swampS=this.metascreen({id:-114,icon:icon$$module$js$rom$metascreendata`
      |   |
      | \u2577 |
      | \u2502 |`,tilesets:{swamp:{}},feature:["consolidate"],edges:"  s ",connect:"a"});this.swampNS=this.metascreen({id:-115,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      | \u2502 |
      | \u2502 |`,tilesets:{swamp:{}},feature:["consolidate"],edges:"s s ",connect:"2a",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4}),bottomEdge$$module$js$rom$metascreendata({left:6,width:4})]});this.swampWE=this.metascreen({id:-115,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2500\u2500\u2500|
      |   |`,tilesets:{swamp:{}},feature:["consolidate"],edges:" s s",connect:"6e",exits:[leftEdge$$module$js$rom$metascreendata({top:7,height:3}),rightEdge$$module$js$rom$metascreendata({top:7,height:3})]});this.swampWE_door=this.metascreen({id:-115,icon:icon$$module$js$rom$metascreendata`\u2229
      | \u2229 |
      |\u2500\u2500\u2500|
      |   |`,tilesets:{swamp:{requires:[module$js$rom$screenfix.ScreenFix.SwampDoors]}},feature:["consolidate"],flag:"always",edges:" s s",connect:"6e",exits:[upStair$$module$js$rom$metascreendata(86)]});this.swampSE=this.metascreen({id:-116,icon:icon$$module$js$rom$metascreendata`
      |   |
      | \u250c\u2500|
      | \u2502 |`,tilesets:{swamp:{}},feature:["consolidate"],edges:"  ss",connect:"ae",exits:[leftEdge$$module$js$rom$metascreendata({top:7,height:3}),bottomEdge$$module$js$rom$metascreendata({left:6,width:4})]});this.swampSE_door=this.metascreen({id:-116,icon:icon$$module$js$rom$metascreendata`\u2229
      | \u2229 |
      | \u250c\u2500|
      | \u2502 |`,tilesets:{swamp:{requires:[module$js$rom$screenfix.ScreenFix.SwampDoors]}},feature:["consolidate"],flag:"always",edges:"  ss",connect:"ae",exits:[cave$$module$js$rom$metascreendata(90,"swamp")]});this.swampNSE=this.metascreen({id:-117,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      | \u251c\u2500|
      | \u2502 |`,tilesets:{swamp:{}},feature:["consolidate"],edges:"s ss",connect:"2ae",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4}),bottomEdge$$module$js$rom$metascreendata({left:6,width:4}),rightEdge$$module$js$rom$metascreendata({top:7,height:3})]});this.caveEmpty=this.metascreen({id:128,icon:icon$$module$js$rom$metascreendata`
      |   |
      |   |
      |   |`,tilesets:{cave:{},fortress:{},labyrinth:{},pyramid:{},iceCave:{},dolphinCave:{}},feature:["empty"],edges:"    "});this.open=this.metascreen({id:128,icon:icon$$module$js$rom$metascreendata`
      |   |
      |   |
      |   |`,tilesets:{desert:{},sea:{}},edges:"oooo"});this.hallNS=this.metascreen({id:129,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      | \u2502 |
      | \u2502 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"c c ",connect:"2a",poi:[[4]],exits:[bottomEdge$$module$js$rom$metascreendata({left:6,width:4,manual:!0})]});this.hallWE=this.metascreen({id:130,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2500\u2500\u2500|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:" c c",connect:"6e",poi:[[4]]});this.hallSE=this.metascreen({id:131,icon:icon$$module$js$rom$metascreendata`
      |   |
      | \u250c\u2500|
      | \u2502 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"  cc",connect:"ae",poi:[[2]]});this.hallWS=this.metascreen({id:132,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2500\u2510 |
      | \u2502 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:" cc ",connect:"6a",poi:[[2]]});this.hallNE=this.metascreen({id:133,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      | \u2514\u2500|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"c  c",connect:"2e",poi:[[2]]});this.hallNW=this.metascreen({id:134,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      |\u2500\u2518 |
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"cc  ",connect:"26",poi:[[2]]});this.branchNSE=this.metascreen({id:135,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      | \u251c\u2500|
      | \u2502 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"c cc",connect:"2ae",poi:[[3]]});this.branchNWSE=this.metascreen({id:136,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      |\u2500\u253c\u2500|
      | \u2502 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"cccc",connect:"26ae",poi:[[3]]});this.branchNWS=this.metascreen({id:137,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      |\u2500\u2524 |
      | \u2502 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"ccc ",connect:"26a",poi:[[3]]});this.branchWSE=this.metascreen({id:138,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2500\u252c\u2500|
      | \u2502 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:" ccc",connect:"6ae",poi:[[3]]});this.branchNWE=this.metascreen({id:139,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      |\u2500\u2534\u2500|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"cc c",connect:"26e",poi:[[3]],exits:[seamlessDown$$module$js$rom$metascreendata(6,4)]});this.hallNS_stairs=this.metascreen({id:140,icon:icon$$module$js$rom$metascreendata`
      | \u250b |
      | \u250b |
      | \u250b |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["stairs"],edges:"c c ",connect:"2a"});this.hallNS_overBridge=this.metascreen({id:141,icon:icon$$module$js$rom$metascreendata`
      | \u257d |
      |\u2500\u2503\u2500|
      | \u257f |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["overBridge"],edges:"cbcb",connect:"2a"});this.hallWE_underBridge=this.metascreen({id:142,icon:icon$$module$js$rom$metascreendata`
      | \u257d |
      |\u2500\u2500\u2500|
      | \u257f |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["underBridge"],edges:"bcbc",connect:"6e"});this.hallNS_wall=this.metascreen({id:143,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      | \u2506 |
      | \u2502 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"c c ",feature:["wall"],connect:"2=a",wall:135});this.hallWE_wall=this.metascreen({id:144,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2500\u2504\u2500|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["wall"],edges:" c c",connect:"6=e",wall:103});this.hallNS_arena=this.metascreen({id:145,icon:icon$$module$js$rom$metascreendata`
      |\u250c\u2538\u2510|
      |\u2502&\u2502|
      |\u2514\u252c\u2518|`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["arena"],edges:"n*c*",allowed:(a)=>a.hasFeature("empty")?[1,3]:[],connect:"2a",poi:[[1,96,120]],exits:[topEdge$$module$js$rom$metascreendata(),bottomEdge$$module$js$rom$metascreendata({left:6,width:4,manual:!0}),seamlessUp$$module$js$rom$metascreendata(230,4)]});this.hallNS_arenaWall=this.metascreen({id:146,icon:icon$$module$js$rom$metascreendata`
      |\u250c\u2504\u2510|
      |\u2502&\u2502|
      |\u2514\u252c\u2518|`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["arena","wall"],edges:"n*c*",allowed:(a)=>a.hasFeature("empty")?[1,3]:[],connect:"2=a",wall:39,poi:[[1,96,120]],exits:[bottomEdge$$module$js$rom$metascreendata({left:6,width:4,manual:!0}),topEdge$$module$js$rom$metascreendata({top:1})]});this.branchNWE_wall=this.metascreen({id:148,icon:icon$$module$js$rom$metascreendata`
      | \u2506 |
      |\u2500\u2534\u2500|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"cc c",connect:"2=6e",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4})]});this.branchNWE_upStair=this.metascreen({id:149,icon:icon$$module$js$rom$metascreendata`<
      | < |
      |\u2500\u2534\u2500|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:" c c",connect:"6e",exits:[upStair$$module$js$rom$metascreendata(71)]});this.deadEndW_upStair=this.metascreen({id:150,icon:icon$$module$js$rom$metascreendata`<
      | < |
      |\u2500\u2518 |
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:" c  ",connect:"6",exits:[upStair$$module$js$rom$metascreendata(66)]});this.deadEndW_downStair=this.metascreen({id:151,icon:icon$$module$js$rom$metascreendata`>
      |   |
      |\u2500\u2510 |
      | > |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:" c  ",connect:"6",exits:[downStair$$module$js$rom$metascreendata(162)]});this.deadEndE_upStair=this.metascreen({id:152,icon:icon$$module$js$rom$metascreendata`<
      | < |
      | \u2514\u2500|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"   c",connect:"e",exits:[upStair$$module$js$rom$metascreendata(76)]});this.deadEndE_downStair=this.metascreen({id:153,icon:icon$$module$js$rom$metascreendata`>
      |   |
      | \u250c\u2500|
      | > |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"   c",connect:"e",exits:[downStair$$module$js$rom$metascreendata(172)]});this.deadEndNS_stairs=this.metascreen({id:154,icon:icon$$module$js$rom$metascreendata`
      | > |
      |   |
      | < |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],edges:"c c ",connect:"2|a",exits:[downStair$$module$js$rom$metascreendata(23),upStair$$module$js$rom$metascreendata(215)]});this.deadEndN_stairs=this.metascreen({id:154,icon:icon$$module$js$rom$metascreendata`
      | > |
      |   |
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],edges:"c   ",connect:"2",exits:[downStair$$module$js$rom$metascreendata(23)],match:(a)=>!a(264,120)});this.deadEndS_stairs=this.metascreen({id:154,icon:icon$$module$js$rom$metascreendata`
      |   |
      |   |
      | < |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],edges:"  c ",connect:"a",exits:[upStair$$module$js$rom$metascreendata(215)],match:(a)=>!a(-48,120)});this.deadEndNS=this.metascreen({id:155,icon:icon$$module$js$rom$metascreendata`
      | \u2575 |
      |   |
      | \u2577 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],edges:"c c ",connect:"2|a",poi:[[0,272,120],[0,-48,120]]});this.deadEndN=this.metascreen({id:155,icon:icon$$module$js$rom$metascreendata`
      | \u2575 |
      |   |
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],edges:"c   ",connect:"2",poi:[[0,-48,120]],match:(a)=>!a(272,120)});this.deadEndS=this.metascreen({id:155,icon:icon$$module$js$rom$metascreendata`
      |   |
      |   |
      | \u2577 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],edges:"  c ",connect:"a",poi:[[0,272,120]],match:(a)=>!a(-48,120)});this.deadEndWE=this.metascreen({id:156,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2574 \u2576|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],edges:" c c",connect:"6|e",poi:[[0,112,264],[0,112,-40]]});this.deadEndW=this.metascreen({id:156,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2574  |
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],edges:" c  ",connect:"6",poi:[[0,112,-40]],match:(a)=>!a(112,264)});this.deadEndE=this.metascreen({id:156,icon:icon$$module$js$rom$metascreendata`
      |   |
      |  \u2576|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],edges:"   c",connect:"e",poi:[[0,112,264]],match:(a)=>!a(112,-40)});this.hallNS_entrance=this.metascreen({id:158,icon:icon$$module$js$rom$metascreendata`\u257d
      | \u2502 |
      | \u2502 |
      | \u257d |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"c n ",connect:"2a",exits:[bottomEdge$$module$js$rom$metascreendata()]});this.channelExitSE=this.metascreen({id:159,icon:icon$$module$js$rom$metascreendata`
      |   |
      | \u2554\u2550|
      | \u2551 |`,tilesets:{dolphinCave:{}},exits:[bottomEdge$$module$js$rom$metascreendata({left:5})]});this.channelBendWS=this.metascreen({id:160,icon:icon$$module$js$rom$metascreendata`
      |\u2588  |
      |\u2550\u2557 |
      |\u2588\u2551 |`,tilesets:{dolphinCave:{}}});this.channelHallNS=this.metascreen({id:161,icon:icon$$module$js$rom$metascreendata`
      | \u2551 |
      | \u2560\u2508|
      | \u2551 |`,tilesets:{dolphinCave:{}}});this.channelEntranceSE=this.metascreen({id:162,icon:icon$$module$js$rom$metascreendata`
      |   |
      | \u2554\u2508|
      |\u2577\u2551 |`,tilesets:{dolphinCave:{}},exits:[bottomEdge$$module$js$rom$metascreendata({left:2})]});this.channelCross=this.metascreen({id:163,icon:icon$$module$js$rom$metascreendata`
      | \u2551 |
      |\u2550\u256c\u2550|
      |\u2577\u2551\u2577|`,tilesets:{dolphinCave:{}},exits:[bottomEdge$$module$js$rom$metascreendata({left:3}),bottomEdge$$module$js$rom$metascreendata({left:11,type:"door"})]});this.channelDoor=this.metascreen({id:164,icon:icon$$module$js$rom$metascreendata`\u2229
      | \u2229\u2588|
      |\u2508\u2550\u2550|
      |  \u2588|`,tilesets:{dolphinCave:{}},exits:[door$$module$js$rom$metascreendata(56)]});this.mountainFloatingIsland=this.metascreen({id:165,icon:icon$$module$js$rom$metascreendata`*
      |\u2550\u2557\u2588|
      |*\u2551 |
      |\u2550\u2563\u2588|`,tilesets:{mountainRiver:{}},edges:"  wp",connect:"e"});this.mountainPathNE_stair=this.metascreen({id:166,icon:icon$$module$js$rom$metascreendata`\u2514
      |\u2588\u250b\u2588|
      |\u2588  |
      |\u2588\u2588\u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:"l  p",connect:"2e",exits:[topEdge$$module$js$rom$metascreendata()]});this.mountainBranchNWE=this.metascreen({id:167,icon:icon$$module$js$rom$metascreendata`\u2534
      |\u2588 \u2588|
      |   |
      |\u2588\u2588\u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:"pp p",connect:"26e"});this.mountainPathWE_iceBridge=this.metascreen({id:168,icon:icon$$module$js$rom$metascreendata`\u256b
      |\u2588\u2551\u2588|
      | \u2506 |
      |\u2588\u2551\u2588|`,tilesets:{mountainRiver:{}},feature:["bridge"],edges:"wpwp",allowed:(a)=>a.hasFeature("empty")?[2]:[],connect:"6-e:2a",wall:135});this.mountainPathSE=this.metascreen({id:169,icon:icon$$module$js$rom$metascreendata`\u250c
      |\u2588\u2588\u2588|
      |\u2588  |
      |\u2588 \u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:"  pp",connect:"ae",exits:[rightEdge$$module$js$rom$metascreendata({top:6,height:4}),bottomEdge$$module$js$rom$metascreendata({left:6,width:4})]});this.mountainDeadEndW_caveEmpty=this.metascreen({id:170,icon:icon$$module$js$rom$metascreendata`\u2229
      |\u2588\u2229\u2588|
      |\u2590 \u2590|
      |\u2588\u2588\u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:" p  ",connect:"6",exits:[cave$$module$js$rom$metascreendata(56)]});this.mountainPathNE=this.metascreen({id:171,icon:icon$$module$js$rom$metascreendata`\u2514
      |\u2588 \u2588|
      |\u2588  |
      |\u2588\u2588\u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:"p  p",connect:"2e",exits:[rightEdge$$module$js$rom$metascreendata({top:6,height:4}),topEdge$$module$js$rom$metascreendata({left:6,width:4})]});this.mountainBranchWSE=this.metascreen({id:172,icon:icon$$module$js$rom$metascreendata`\u252c
      |\u2588\u2588\u2588|
      |   |
      |\u2588 \u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:" ppp",connect:"6ae"});this.mountainPathW_cave=this.metascreen({id:173,icon:icon$$module$js$rom$metascreendata`\u2229
      |\u2588\u2229\u2588|
      |  \u2590|
      |\u2588\u2588\u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:" p  ",connect:"6",exits:[cave$$module$js$rom$metascreendata(85)]});this.mountainPathE_slopeS=this.metascreen({id:174,icon:icon$$module$js$rom$metascreendata`\u2553
      |\u2588\u2588\u2588|
      |\u2588  |
      |\u2588\u2193\u2588|`,tilesets:{mountain:{}},edges:"  sp",connect:"ae"});this.mountainPathNW=this.metascreen({id:175,icon:icon$$module$js$rom$metascreendata`\u2518
      |\u2588 \u2588|
      |  \u2588|
      |\u2588\u2588\u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:"pp  ",connect:"26",exits:[leftEdge$$module$js$rom$metascreendata({top:6,height:4}),topEdge$$module$js$rom$metascreendata({left:6,width:4})]});this.mountainCave_empty=this.metascreen({id:176,icon:icon$$module$js$rom$metascreendata`\u2229
      |\u2588\u2229\u2588|
      |\u258c \u2590|
      |\u2588\u2588\u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:"    ",connect:"",exits:[cave$$module$js$rom$metascreendata(88)]});this.mountainPathE_cave=this.metascreen({id:177,icon:icon$$module$js$rom$metascreendata`\u2229
      |\u2588\u2229\u2588|
      |\u2588  |
      |\u2588\u2588\u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:"   p",connect:"e",exits:[cave$$module$js$rom$metascreendata(87)]});this.mountainPathWE_slopeN=this.metascreen({id:178,icon:icon$$module$js$rom$metascreendata`\u2568
      |\u2588\u2193\u2588|
      |   |
      |\u2588\u2588\u2588|`,tilesets:{mountain:{}},edges:"sp p",connect:"26e"});this.mountainDeadEndW=this.metascreen({id:179,icon:icon$$module$js$rom$metascreendata`\u2574
      |\u2588\u2588\u2588|
      |  \u2588|
      |\u2588\u2588\u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:" p  ",connect:"6"});this.mountainPathWE=this.metascreen({id:180,icon:icon$$module$js$rom$metascreendata`\u2500
      |\u2588\u2588\u2588|
      |   |
      |\u2588\u2588\u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:" p p",connect:"6e",exits:[leftEdge$$module$js$rom$metascreendata({top:6,height:4}),rightEdge$$module$js$rom$metascreendata({top:6,height:4})]});this.mountainArena_gate=this.metascreen({id:181,icon:icon$$module$js$rom$metascreendata`#
      |\u2588#\u2588|
      |\u258c \u2590|
      |\u2588\u250b\u2588|`,tilesets:{mountain:{},mountainRiver:{}},feature:["arena"],edges:" *l*",allowed:(a)=>a.hasFeature("empty")?[1,3]:[],connect:"a",exits:[Object.assign({},upStair$$module$js$rom$metascreendata(71,3),{type:"cave"})],flag:"custom:false"});this.mountainPathN_slopeS_cave=this.metascreen({id:182,icon:icon$$module$js$rom$metascreendata`\u2229
      |\u2588\u250b\u2229|
      |\u258c \u2590|
      |\u2588\u2193\u2588|`,tilesets:{mountain:{}},edges:"l s ",connect:"2a",exits:[cave$$module$js$rom$metascreendata(90),topEdge$$module$js$rom$metascreendata()]});this.mountainPathWE_slopeNS=this.metascreen({id:183,icon:icon$$module$js$rom$metascreendata`\u256b
      |\u2588\u2193\u2588|
      |   |
      |\u2588\u2193\u2588|`,tilesets:{mountain:{}},edges:"spsp",connect:"26ae"});this.mountainPathWE_slopeN_cave=this.metascreen({id:184,icon:icon$$module$js$rom$metascreendata`\u2229
      |\u2588\u2193\u2229|
      |   |
      |\u2588\u2588\u2588|`,tilesets:{mountain:{}},edges:"sp p",connect:"26e",exits:[cave$$module$js$rom$metascreendata(92)]});this.mountainPathWS=this.metascreen({id:185,icon:icon$$module$js$rom$metascreendata`\u2510
      |\u2588\u2588\u2588|
      |  \u2588|
      |\u2588 \u2588|`,tilesets:{mountain:{},mountainRiver:{}},edges:" pp ",connect:"6a",exits:[leftEdge$$module$js$rom$metascreendata({top:6,height:4}),bottomEdge$$module$js$rom$metascreendata({left:6,width:4})]});this.mountainSlope=this.metascreen({id:186,icon:icon$$module$js$rom$metascreendata`\u2193
      |\u2588\u2193\u2588|
      |\u2588\u2193\u2588|
      |\u2588\u2193\u2588|`,tilesets:{mountain:{}},edges:"s s ",connect:"2a"});this.mountainRiver=this.metascreen({id:186,icon:icon$$module$js$rom$metascreendata`\u2551
      |\u2588\u2551\u2588|
      |\u2588\u2551\u2588|
      |\u2588\u2551\u2588|`,tilesets:{mountainRiver:{}},edges:"w w ",allowed:(a)=>a.hasFeature("empty")?[2]:[],connect:"2:e"});this.mountainPathE_gate=this.metascreen({id:187,icon:icon$$module$js$rom$metascreendata`\u2229
      |\u2588\u2229\u2588|
      |\u2588  |
      |\u2588\u2588\u2588|`,tilesets:{mountain:{}},edges:"   p",connect:"e",exits:[cave$$module$js$rom$metascreendata(87,"gate")]});this.mountainPathWE_inn=this.metascreen({id:188,icon:icon$$module$js$rom$metascreendata`\u2229
      |\u2588\u2229\u2588|
      |   |
      |\u2588\u2588\u2588|`,tilesets:{mountain:{}},edges:" p p",connect:"6e",exits:[door$$module$js$rom$metascreendata(118)]});this.mountainPathWE_bridgeOverSlope=this.metascreen({id:189,icon:icon$$module$js$rom$metascreendata`\u2550
      |\u2588\u2193\u2588|
      | \u2550 |
      |\u2588\u2193\u2588|`,tilesets:{mountain:{}},edges:"spsp",connect:"6e",exits:[seamlessUp$$module$js$rom$metascreendata(182,4)]});this.mountainPathWE_bridgeOverRiver=this.metascreen({id:189,icon:icon$$module$js$rom$metascreendata`\u2550
      |\u2588\u2551\u2588|
      | \u2550 |
      |\u2588\u2551\u2588|`,tilesets:{mountainRiver:{}},edges:"wpwp",allowed:(a)=>a.hasFeature("empty")?[2]:[],connect:"6e|2|a"});this.mountainSlope_underBridge=this.metascreen({id:190,icon:icon$$module$js$rom$metascreendata`\u2193
      |\u2588\u2193\u2588|
      | \u2550 |
      |\u2588\u2193\u2588|`,tilesets:{mountain:{}},edges:"spsp",connect:"2a",exits:[seamlessDown$$module$js$rom$metascreendata(198,4)]});this.mountainEmpty=this.metascreen({id:191,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u2588\u2588|
      |\u2588\u2588\u2588|
      |\u2588\u2588\u2588|`,tilesets:{mountain:{},mountainRiver:{}},feature:["empty"],edges:"    "});this.boundaryS=this.metascreen({id:192,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2584\u2584\u2584|
      |\u2588\u2588\u2588|`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"o^ ^"});this.boundaryN_cave=this.metascreen({id:193,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u2588\u2588|
      |\u2580\u2229\u2580|
      |   |`,tilesets:{grass:{},sea:{},desert:{},river:{requires:[module$js$rom$screenfix.ScreenFix.SeaCaveEntrance]}},edges:" vov",exits:[cave$$module$js$rom$metascreendata(73)]});this.cornerSE_cave=this.metascreen({id:194,icon:icon$$module$js$rom$metascreendata`
      | \u2590\u2588|
      |\u2584\u2229\u2588|
      |\u2588\u2588\u2588|`,tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"<^  ",exits:[cave$$module$js$rom$metascreendata(90)]});this.waterfall=this.metascreen({id:195,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2193\u2193\u2193|
      |   |`,tilesets:{sea:{}},edges:"oooo"});this.whirlpoolBlocker=this.metascreen({id:196,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2588\u2573\u2588|
      |   |`,tilesets:{sea:{}},feature:["whirlpool"],flag:"calm",edges:"oooo"});this.beachExitN=this.metascreen({id:197,icon:icon$$module$js$rom$metascreendata`
      |\u2588 \u2588|
      |\u2588\u2571\u2580|
      |\u2588\u258c |`,tilesets:{sea:{}},edges:"n >v",exits:[topEdge$$module$js$rom$metascreendata({left:9})]});this.whirlpoolOpen=this.metascreen({id:198,icon:icon$$module$js$rom$metascreendata`
      |   |
      | \u2573 |
      |   |`,tilesets:{sea:{}},feature:["whirlpool"],edges:"oooo",flag:"calm"});this.quicksandOpen=this.metascreen({id:198,icon:icon$$module$js$rom$metascreendata`
      |   |
      | \u2573 |
      |   |`,tilesets:{desert:{}},feature:["whirlpool"],edges:"oooo"});this.lighthouseEntrance=this.metascreen({id:199,icon:icon$$module$js$rom$metascreendata`
      |\u2597\u259f\u2588|
      |\u2590\u2229\u259b|
      |\u259d\u2580\u2598|`,tilesets:{sea:{}},feature:["lighthouse"],edges:"<oov",exits:[cave$$module$js$rom$metascreendata(42),door$$module$js$rom$metascreendata(117)]});this.beachCave=this.metascreen({id:200,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u2229\u2588|
      |\u2580\u2572\u2588|
      |   |`,tilesets:{sea:{}},edges:" vov",exits:[cave$$module$js$rom$metascreendata(40)]});this.beachCabinEntrance=this.metascreen({id:201,icon:icon$$module$js$rom$metascreendata`
      | \u2229\u2588|
      | \u2572\u2580|
      |\u2588\u2584\u2584|`,tilesets:{sea:{}},feature:["cabin"],edges:"<^ b",exits:[door$$module$js$rom$metascreendata(85),rightEdge$$module$js$rom$metascreendata({top:8,height:3})]});this.oceanShrine=this.metascreen({id:202,icon:icon$$module$js$rom$metascreendata`
      |\u2597\u2584\u2596|
      |\u2590*\u258c|
      |\u259d \u2598|`,tilesets:{sea:{}},feature:["altar"],edges:"oooo"});this.pyramidEntrance=this.metascreen({id:203,icon:icon$$module$js$rom$metascreendata`
      | \u2584 |
      |\u259f\u2229\u2599|
      | \u2573 |`,tilesets:{desert:{}},feature:["pyramid"],edges:"oooo",exits:[cave$$module$js$rom$metascreendata(167)]});this.cryptEntrance=this.metascreen({id:204,icon:icon$$module$js$rom$metascreendata`
      | \u2573 |
      |\u2590>\u258c|
      |\u259d\u2580\u2598|`,tilesets:{desert:{}},feature:["crypt"],edges:"oooo",exits:[downStair$$module$js$rom$metascreendata(103)]});this.oasisLake=this.metascreen({id:205,icon:icon$$module$js$rom$metascreendata`
      | ^ |
      |vOv|
      | vv|`,tilesets:{desert:{}},feature:["lake"],edges:"oo3o"});this.desertCaveEntrance=this.metascreen({id:206,icon:icon$$module$js$rom$metascreendata`
      |\u2597\u2584\u2596|
      |\u259c\u2229\u259b|
      | \u2573 |`,tilesets:{desert:{},sea:{requires:[module$js$rom$screenfix.ScreenFix.SeaCaveEntrance]}},edges:"oooo",exits:[cave$$module$js$rom$metascreendata(167)]});this.oasisCave=this.metascreen({id:207,icon:icon$$module$js$rom$metascreendata`
      | vv|
      |\u2584\u2229v|
      |\u2588\u258c |`,tilesets:{desert:{}},edges:"3^>o",exits:[upStair$$module$js$rom$metascreendata(55)]});this.channelEndW_cave=this.metascreen({id:208,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u2588\u2229|
      |\u2550\u2550 |
      |\u2588\u2588\u2588|`,tilesets:{dolphinCave:{}},exits:[upStair$$module$js$rom$metascreendata(87)]});this.boatChannel=this.metascreen({id:209,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u2588\u2588|
      |\u2580\u2580\u2580|
      |\u2584\u2584\u2584|`,tilesets:{sea:{}},edges:" b b",exits:[Object.assign({},rightEdge$$module$js$rom$metascreendata({top:8,height:3}),{entrance:40168}),leftEdge$$module$js$rom$metascreendata({top:8,height:3})]});this.channelWE=this.metascreen({id:210,icon:icon$$module$js$rom$metascreendata`
      |\u2588\u2588\u2588|
      |\u2550\u2550\u2550|
      |\u2588\u2588\u2588|`,tilesets:{dolphinCave:{}}});this.riverCaveNWSE=this.metascreen({id:211,icon:icon$$module$js$rom$metascreendata`
      |\u2518\u2551\u2514|
      |\u2550\u256c\u2550|
      |\u252c\u2507\u252c|`,tilesets:{cave:{},fortress:{}},feature:["bridge"],edges:"rrrr",connect:"15:3d:79-af",wall:182,poi:[[4,0,152]]});this.riverCaveNS=this.metascreen({id:212,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2551\u2502|
      |\u2502\u2551\u2502|
      |\u2502\u2551\u2502|`,tilesets:{cave:{},fortress:{}},edges:"r r ",connect:"19:3a"});this.riverCaveWE=this.metascreen({id:213,icon:icon$$module$js$rom$metascreendata`
      |\u2500\u2500\u2500|
      |\u2550\u2550\u2550|
      |\u2500\u2500\u2500|`,tilesets:{cave:{},fortress:{}},edges:" r r",connect:"5d:7f"});this.riverCaveNS_bridge=this.metascreen({id:214,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2551\u2502|
      |\u251c\u2507\u2524|
      |\u2502\u2551\u2502|`,tilesets:{cave:{},fortress:{}},feature:["bridge"],edges:"r r ",connect:"19-3a",wall:135});this.riverCaveWE_bridge=this.metascreen({id:215,icon:icon$$module$js$rom$metascreendata`
      |\u2500\u252c\u2500|
      |\u2550\u2505\u2550|
      |\u2500\u2534\u2500|`,tilesets:{cave:{},fortress:{}},feature:["bridge"],edges:" r r",connect:"5d-7f",wall:134});this.riverCaveSE=this.metascreen({id:216,icon:icon$$module$js$rom$metascreendata`
      |\u250c\u2500\u2500|
      |\u2502\u2554\u2550|
      |\u2502\u2551\u250c|`,tilesets:{cave:{},fortress:{}},edges:"  rr",connect:"9d:af"});this.riverCaveWS=this.metascreen({id:217,icon:icon$$module$js$rom$metascreendata`
      |\u2500\u2500\u2510|
      |\u2550\u2557\u2502|
      |\u2510\u2551\u2502|`,tilesets:{cave:{},fortress:{}},edges:" rr ",connect:"5a:79"});this.riverCaveNE=this.metascreen({id:218,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2551\u2514|
      |\u2502\u255a\u2550|
      |\u2514\u2500\u2500|`,tilesets:{cave:{},fortress:{}},edges:"r  r",connect:"1f:3d"});this.riverCaveNW=this.metascreen({id:219,icon:icon$$module$js$rom$metascreendata`
      |\u2518\u2551\u2502|
      |\u2550\u255d\u2502|
      |\u2500\u2500\u2518|`,tilesets:{cave:{},fortress:{}},edges:"rr  ",connect:"15:37"});this.riverCaveWE_passageN=this.metascreen({id:220,icon:icon$$module$js$rom$metascreendata`\u2567
      |\u2500\u2534\u2500|
      |\u2550\u2550\u2550|
      |\u2500\u2500\u2500|`,tilesets:{cave:{},fortress:{}},edges:"cr r",connect:"25d:7f"});this.riverCaveWE_passageS=this.metascreen({id:221,icon:icon$$module$js$rom$metascreendata`\u2564
      |\u2500\u2500\u2500|
      |\u2550\u2550\u2550|
      |\u2500\u252c\u2500|`,tilesets:{cave:{},fortress:{}},edges:" rcr",connect:"5d:7af"});this.riverCaveNS_passageW=this.metascreen({id:222,icon:icon$$module$js$rom$metascreendata`\u2562
      |\u2502\u2551\u2502|
      |\u2524\u2551\u2502|
      |\u2502\u2551\u2502|`,tilesets:{cave:{},fortress:{}},edges:"rcr ",connect:"169:3b"});this.riverCaveNS_passageE=this.metascreen({id:223,icon:icon$$module$js$rom$metascreendata`\u255f
      |\u2502\u2551\u2502|
      |\u2502\u2551\u251c|
      |\u2502\u2551\u2502|`,tilesets:{cave:{},fortress:{}},edges:"r rc",connect:"19:3be"});this.wideHallNE=this.metascreen({id:224,icon:icon$$module$js$rom$metascreendata`
      | \u2503 |
      | \u2517\u2501|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"w  w",connect:"2e"});this.goaWideHallNE=this.metascreen({id:224,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2503\u2514|
      |\u2502\u2517\u2501|
      |\u2514\u2500\u2500|`,tilesets:{labyrinth:{}},edges:"w  w",connect:"1f|2e|3d"});this.goaWideHallNE_blockedLeft=this.metascreen({id:224,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2503\u2514|
      | \u2517\u2501|
      |\u2514\u2500\u2500|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNE,1,0,97)]],edges:"w  w",connect:"1|f|2e|3d"});this.goaWideHallNE_blockedRight=this.metascreen({id:224,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2503 |
      |\u2502\u2517\u2501|
      |\u2514\u2500\u2500|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNE,1,1,13)]],edges:"w  w",connect:"1f|2e|3|d"});this.wideHallNW=this.metascreen({id:225,icon:icon$$module$js$rom$metascreendata`
      | \u2503 |
      |\u2501\u251b |
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"ww  ",connect:"26"});this.goaWideHallNW=this.metascreen({id:225,icon:icon$$module$js$rom$metascreendata`
      |\u2518\u2503\u2502|
      |\u2501\u251b\u2502|
      |\u2500\u2500\u2518|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNW_blockedRight,-1,0,109)]],flag:"always",edges:"ww  ",connect:"15|26|37"});this.goaWideHallNW_blockedRight=this.metascreen({id:225,icon:icon$$module$js$rom$metascreendata`
      |\u2518\u2503\u2502|
      |\u2501\u251b |
      |\u2500\u2500\u2518|`,tilesets:{labyrinth:{}},edges:"ww  ",connect:"15|26|3|7"});this.goaWideHallNW_blockedLeft=this.metascreen({id:225,icon:icon$$module$js$rom$metascreendata`
      | \u2503\u2502|
      |\u2501\u251b\u2502|
      |\u2500\u2500\u2518|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNW_blockedRight,2,1,1,109)]],edges:"ww  ",connect:"1|5|26|37"});this.wideHallSE=this.metascreen({id:226,icon:icon$$module$js$rom$metascreendata`
      |   |
      | \u250f\u2501|
      | \u2503 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"  ww",connect:"ae"});this.goaWideHallSE=this.metascreen({id:226,icon:icon$$module$js$rom$metascreendata`
      |\u250c\u2500\u2500|
      |\u2502\u250f\u2501|
      |\u2502\u2503\u250c|`,tilesets:{labyrinth:{}},edges:"  ww",connect:"9d|ae|bf"});this.goaWideHallSE_blockedLeft=this.metascreen({id:226,icon:icon$$module$js$rom$metascreendata`
      |\u250c\u2500\u2500|
      | \u250f\u2501|
      |\u2502\u2503\u250c|`,tilesets:{labyrinth:{}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallSE,3,0,97)]],edges:"  ww",connect:"9|d|ae|bf"});this.goaWideHallSE_blockedRight=this.metascreen({id:226,icon:icon$$module$js$rom$metascreendata`
      |\u250c\u2500\u2500|
      |\u2502\u250f\u2501|
      |\u2502\u2503 |`,tilesets:{labyrinth:{}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallSE,3,1,221)]],edges:"  ww",connect:"9d|ae|b|f"});this.wideHallWS=this.metascreen({id:227,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2501\u2513 |
      | \u2503 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:" ww ",connect:"6a"});this.goaWideHallWS=this.metascreen({id:227,icon:icon$$module$js$rom$metascreendata`
      |\u2500\u2500\u2510|
      |\u2501\u2513\u2502|
      |\u2510\u2503\u2502|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallWS_blockedRight,-1,0,157)]],flag:"always",edges:" ww ",connect:"5b|6a|79"});this.goaWideHallWS_blockedRight=this.metascreen({id:227,icon:icon$$module$js$rom$metascreendata`
      |\u2500\u2500\u2510|
      |\u2501\u2513 |
      |\u2510\u2503\u2502|`,tilesets:{labyrinth:{}},edges:" ww ",connect:"5|b|6a|79"});this.goaWideHallWS_blockedLeft=this.metascreen({id:227,icon:icon$$module$js$rom$metascreendata`
      |\u2500\u2500\u2510|
      |\u2501\u2513\u2502|
      | \u2503\u2502|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallWS_blockedRight,4,0,209,157)]],edges:" ww ",connect:"5b|6a|7|9"});this.goaWideHallNS_stairs=this.metascreen({id:228,icon:icon$$module$js$rom$metascreendata`
      |\u251c\u2528\u2502|
      |\u2502\u2503\u2502|
      |\u2502\u2520\u2524|`,tilesets:{labyrinth:{}},edges:"w w ",connect:"1239ab"});this.goaWideHallNS_stairsBlocked13=this.metascreen({id:228,icon:icon$$module$js$rom$metascreendata`
      |\u2514\u2528\u2502|
      |\u2577\u2503\u2575|
      |\u2502\u2520\u2510|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNS_stairs,5,0,[65,141])]],edges:"w w ",connect:"12ab|3|9"});this.goaWideHallNS_stairsBlocked24=this.metascreen({id:228,icon:icon$$module$js$rom$metascreendata`
      |\u250c\u2528\u2502|
      |\u2502\u2503\u2502|
      |\u2502\u2520\u2518|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNS_stairs,5,1,[1,205])]],edges:"w w ",connect:"1|239a|b"});this.wideHallNS_deadEnds=this.metascreen({id:229,icon:icon$$module$js$rom$metascreendata`
      | \u2579 |
      |   |
      | \u257b |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"w w ",connect:"2|a"});this.goaWideHallNS_deadEnd=this.metascreen({id:229,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2579\u2502|
      |\u251c\u2500\u2524|
      |\u2502\u257b\u2502|`,tilesets:{labyrinth:{}},edges:"w w ",connect:"139b|2|a"});this.goaWideHallNS_deadEndBlocked24=this.metascreen({id:229,icon:icon$$module$js$rom$metascreendata`
      |\u2575\u2579\u2502|
      |\u250c\u2500\u2518|
      |\u2502\u257b\u2577|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNS_deadEnd,6,0,[97,173])]],edges:"w w ",connect:"1|2|39|a|b"});this.goaWideHallNS_deadEndBlocked13=this.metascreen({id:229,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2579\u2575|
      |\u2514\u2500\u2510|
      |\u2577\u257b\u2502|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNS_deadEnd,6,1,[109,161])]],edges:"w w ",connect:"1b|2|3|9|a"});this.wideHallNWSE=this.metascreen({id:230,icon:icon$$module$js$rom$metascreendata`
      | \u2503 |
      |\u2501\u254b\u2501|
      | \u2503 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"wwww",connect:"26ae"});this.goaWideHallNWSE=this.metascreen({id:230,icon:icon$$module$js$rom$metascreendata`
      |\u2518\u2503\u2514|
      |\u2501\u254b\u2501|
      |\u2510\u2503\u250c|`,tilesets:{labyrinth:{}},edges:"wwww",connect:"26ae|15|3d|79|bf"});this.goaWideHallNWSE_blocked13=this.metascreen({id:230,icon:icon$$module$js$rom$metascreendata`
      |\u2518\u2503 |
      |\u2501\u254b\u2501|
      | \u2503\u250c|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNWSE,7,0,[13,209])]],edges:"wwww",connect:"26ae|15|3|d|7|9|bf"});this.goaWideHallNWSE_blocked24=this.metascreen({id:230,icon:icon$$module$js$rom$metascreendata`
      | \u2503\u2514|
      |\u2501\u254b\u2501|
      |\u2510\u2503 |`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNWSE,7,1,[1,221])]],edges:"wwww",connect:"26ae|1|5|3d|79|b|f"});this.wideHallNWE=this.metascreen({id:231,icon:icon$$module$js$rom$metascreendata`
      | \u2503 |
      |\u2501\u253b\u2501|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"ww w",connect:"26e"});this.goaWideHallNWE=this.metascreen({id:231,icon:icon$$module$js$rom$metascreendata`
      |\u2518\u2503\u2514|
      |\u2501\u253b\u2501|
      |\u2500\u2500\u2500|`,tilesets:{labyrinth:{}},edges:"ww w",connect:"26e|15|3d|7f"});this.goaWideHallNWE_blockedTop=this.metascreen({id:231,icon:icon$$module$js$rom$metascreendata`
      | \u2503 |
      |\u2501\u253b\u2501|
      |\u2500\u2500\u2500|`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallNWE,-1,0,[1,13])]],edges:"ww w",connect:"26e|1|5|3|d|7f"});this.wideHallWSE=this.metascreen({id:232,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2501\u2533\u2501|
      | \u2503 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:" www",connect:"6ae"});this.goaWideHallWSE=this.metascreen({id:232,icon:icon$$module$js$rom$metascreendata`
      |\u2500\u2500\u2500|
      |\u2501\u2533\u2501|
      |\u2510\u2503\u250c|`,tilesets:{labyrinth:{}},edges:" www",connect:"6ae|5d|79|bf"});this.goaWideHallWSE_blockedBottom=this.metascreen({id:232,icon:icon$$module$js$rom$metascreendata`
      |\u2500\u2500\u2500|
      |\u2501\u2533\u2501|
      | \u2503 |`,tilesets:{labyrinth:{requires:[module$js$rom$screenfix.ScreenFix.LabyrinthParapets]}},update:[[module$js$rom$screenfix.ScreenFix.LabyrinthParapets,labyrinthVariant$$module$js$rom$metascreens((a)=>a.goaWideHallWSE,-1,0,[209,221])]],edges:" www",connect:"6ae|5d|7|9|b|f"});this.wideHallNS_wallTop=this.metascreen({id:233,icon:icon$$module$js$rom$metascreendata`
      | \u2506 |
      | \u2503 |
      | \u2503 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["wall"],edges:"c w",connect:"2a",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4})],wall:55});this.goaWideHallNS_wallTop=this.metascreen({id:233,icon:icon$$module$js$rom$metascreendata`
      | \u2506 |
      |\u2577\u2503\u2577|
      |\u2502\u2503\u2502|`,tilesets:{labyrinth:{}},feature:["wall"],edges:"c w ",connect:"2a|9|b",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4})],wall:55});this.wideHallWE=this.metascreen({id:234,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2501\u2501\u2501|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:" w w",connect:"6e"});this.goaWideHallWE=this.metascreen({id:234,icon:icon$$module$js$rom$metascreendata`
      |\u2500\u2500\u2500|
      |\u2501\u2501\u2501|
      |\u2500\u2500\u2500|`,tilesets:{labyrinth:{}},edges:" w w",connect:"5d|6e|7f"});this.pitWE=this.metascreen({id:235,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2500\u2573\u2500|
      |   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["pit"],edges:" c c",connect:"6e",platform:{type:"horizontal",coord:28728}});this.pitNS=this.metascreen({id:236,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      | \u2573 |
      | \u2502 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["pit"],edges:"c c ",connect:"2a",platform:{type:"vertical",coord:16504}});this.spikesNS_hallS=this.metascreen({id:237,icon:icon$$module$js$rom$metascreendata`
      | \u2591 |
      | \u2591 |
      | \u2502 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["spikes"],edges:"s c ",connect:"2a"});this.spikesNS_hallN=this.metascreen({id:238,icon:icon$$module$js$rom$metascreendata`
      | \u2502 |
      | \u2591 |
      | \u2591 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["spikes"],edges:"c s ",connect:"2a"});this.spikesNS_hallWE=this.metascreen({id:239,icon:icon$$module$js$rom$metascreendata`
      | \u2591 |
      |\u2500\u2591\u2500|
      | \u2591 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["spikes"],edges:"scsc",connect:"26ae"});this.spikesNS_hallW=this.metascreen({id:-225,icon:icon$$module$js$rom$metascreendata`
      | \u2591 |
      |\u2500\u2591 |
      | \u2591 |`,tilesets:withRequire$$module$js$rom$screenfix(module$js$rom$screenfix.ScreenFix.ExtraSpikes,{cave:{},fortress:{},pyramid:{},iceCave:{}}),feature:["spikes"],edges:"scs ",connect:"26a"});this.spikesNS_hallE=this.metascreen({id:-226,icon:icon$$module$js$rom$metascreendata`
      | \u2591 |
      | \u2591\u2500|
      | \u2591 |`,tilesets:withRequire$$module$js$rom$screenfix(module$js$rom$screenfix.ScreenFix.ExtraSpikes,{cave:{},fortress:{},pyramid:{},iceCave:{}}),feature:["spikes"],edges:"s sc",connect:"2ae"});this.riverCave_deadEndsNS=this.metascreen({id:240,icon:icon$$module$js$rom$metascreendata`
      | \u2568 |
      |   |
      | \u2565 |`,tilesets:{cave:{},fortress:{}},feature:["empty"],edges:"r r ",connect:"1:3|9:b",poi:[[1,-48,72],[1,-48,152],[1,272,72],[1,272,152]]});this.riverCave_deadEndsN=this.metascreen({id:240,icon:icon$$module$js$rom$metascreendata`
      | \u2568 |
      |   |
      |   |`,tilesets:{cave:{},fortress:{}},feature:["empty"],edges:"r   ",connect:"1:3",poi:[[1,-48,72],[1,-48,152]],match:(a)=>!a(-48,72)&&!a(-48,152)});this.riverCave_deadEndsS=this.metascreen({id:240,icon:icon$$module$js$rom$metascreendata`
      |   |
      |   |
      | \u2565 |`,tilesets:{cave:{},fortress:{}},feature:["empty"],edges:"  r ",connect:"9:b",poi:[[1,272,72],[1,272,152]],match:(a)=>!a(-48,72)&&!a(-48,152)});this.riverCave_deadEndsWE=this.metascreen({id:241,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2561 \u255e|
      |   |`,tilesets:{cave:{},fortress:{}},feature:["empty"],edges:" r r",connect:"5:7|d:f",poi:[[1,96,264],[1,160,264],[1,96,-40],[1,160,-40]]});this.riverCave_deadEndsW=this.metascreen({id:241,icon:icon$$module$js$rom$metascreendata`
      |   |
      |\u2561  |
      |   |`,tilesets:{cave:{},fortress:{}},feature:["empty"],edges:" r  ",connect:"5:7",poi:[[1,96,-40],[1,160,-40]],match:(a)=>!a(96,264)&&!a(160,264)});this.riverCave_deadEndsE=this.metascreen({id:241,icon:icon$$module$js$rom$metascreendata`
      |   |
      |  \u255e|
      |   |`,tilesets:{cave:{},fortress:{}},feature:["empty"],edges:"   r",connect:"d:f",poi:[[1,96,264],[1,160,264]],match:(a)=>!a(96,-40)&&!a(160,-40)});this.riverCaveN_bridge=this.metascreen({id:242,icon:icon$$module$js$rom$metascreendata`
      | \u2507 |
      | \u2568 |
      |   |`,tilesets:{cave:{},fortress:{}},feature:["bridge"],edges:"r   ",connect:"1-3",wall:23});this.riverCaveS_bridge=this.metascreen({id:242,icon:icon$$module$js$rom$metascreendata`
      |   |
      | \u2565 |
      | \u2507 |`,tilesets:{cave:{},fortress:{}},feature:["bridge"],edges:"  r ",connect:"9-b",wall:198});this.riverCaveWSE=this.metascreen({id:243,icon:icon$$module$js$rom$metascreendata`
      |\u2500\u2500\u2500|
      |\u2550\u2566\u2550|
      |\u2510\u2551\u250c|`,tilesets:{cave:{},fortress:{}},edges:" rrr",connect:"5d:79:bf"});this.riverCaveNWE=this.metascreen({id:244,icon:icon$$module$js$rom$metascreendata`
      |\u2518\u2551\u2514|
      |\u2550\u2569\u2550|
      |\u2500\u2500\u2500|`,tilesets:{cave:{},fortress:{}},edges:"rr r",connect:"15:3d:7f"});this.riverCaveNS_blockedRight=this.metascreen({id:245,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2551\u2502|
      |\u2502\u2551 |
      |\u2502\u2551\u2502|`,tilesets:{cave:{},fortress:{}},edges:"r r ",connect:"19:3:b",poi:[[1,192,152],[1,64,152]]});this.riverCaveNS_blockedLeft=this.metascreen({id:246,icon:icon$$module$js$rom$metascreendata`
      |\u2502\u2551\u2502|
      | \u2551\u2502|
      |\u2502\u2551\u2502|`,tilesets:{cave:{},fortress:{}},edges:"r r ",connect:"1:3b:9",poi:[[1,176,72],[1,48,72]]});this.spikesNS=this.metascreen({id:247,icon:icon$$module$js$rom$metascreendata`
      | \u2591 |
      | \u2591 |
      | \u2591 |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["spikes"],edges:"s s ",connect:"2a"});this.cryptArena_statues=this.metascreen({id:248,icon:icon$$module$js$rom$metascreendata`<
      |&<&|
      |\u2502 \u2502|
      |\u2514\u252c\u2518|`,tilesets:{pyramid:{}},feature:["arena"],edges:" *c*",allowed:(a)=>a.hasFeature("empty")?[1,3]:[],connect:"a",exits:[upStair$$module$js$rom$metascreendata(87)],flag:"custom:false"});this.pyramidArena_draygon=this.metascreen({id:249,icon:icon$$module$js$rom$metascreendata`
      |\u250c\u2500\u2510|
      |\u2502\u2573\u2502|
      |\u2514\u252c\u2518|`,tilesets:{pyramid:{}},feature:["arena","pit"],edges:" *w*",allowed:(a)=>a.hasFeature("empty")?[1,3]:[],connect:"a"});this.cryptArena_draygon2=this.metascreen({id:250,icon:icon$$module$js$rom$metascreendata`
      |\u250f\u2537\u2513|
      |\u2503&\u2503|
      |\u2517\u2533\u251b|`,tilesets:{pyramid:{}},feature:["arena"],edges:"c*w*",allowed:(a)=>a.hasFeature("empty")?[1,3]:[],connect:"2a",exits:[topEdge$$module$js$rom$metascreendata({left:6,width:4})],flag:"custom:false"});this.cryptArena_entrance=this.metascreen({id:251,icon:icon$$module$js$rom$metascreendata`
      | \u2503 |
      | \u2503 |
      | \u257f |`,tilesets:{pyramid:{}},edges:"w n ",connect:"2a",exits:[bottomEdge$$module$js$rom$metascreendata()]});this.cryptTeleporter=this.metascreen({id:252,tilesets:{pyramid:{},tower:{}},exits:[bottomEdge$$module$js$rom$metascreendata({left:6,width:4}),cave$$module$js$rom$metascreendata(87,"teleporter")]});this.fortressArena_through=this.metascreen({id:253,icon:icon$$module$js$rom$metascreendata`\u257d
      |\u250c\u2534\u2510|
      |\u2502 \u2502|
      |\u2515\u2533\u2519|`,tilesets:{fortress:{},pyramid:{}},feature:["arena"],edges:"n*w*",allowed:(a)=>a.hasFeature("empty")?[1,3]:[],connect:"2a",exits:[topEdge$$module$js$rom$metascreendata()]});this.fortressTrap=this.metascreen({id:254,icon:icon$$module$js$rom$metascreendata`
      |\u2514\u2500\u2518|
      | \u2573 |
      |\u2576\u252c\u2574|`,tilesets:{fortress:{},pyramid:{}},feature:["pit"],edges:"  n ",connect:"a",exits:[bottomEdge$$module$js$rom$metascreendata()]});this.shrine=this.metascreen({id:255,tilesets:{shrine:{}},exits:[bottomEdge$$module$js$rom$metascreendata({left:6,width:5})]});this.inn=this.metascreen({id:256,tilesets:{house:{}},exits:[Object.assign({},door$$module$js$rom$metascreendata(134),{entrance:37992})]});this.toolShop=this.metascreen({id:257,tilesets:{house:{}},exits:[Object.assign({},
door$$module$js$rom$metascreendata(134),{entrance:37992})]});this.armorShop=this.metascreen({id:258,tilesets:{house:{}},exits:[Object.assign({},door$$module$js$rom$metascreendata(134),{entrance:37992})]});this.exit=this.metascreen({id:-32768,tilesets:{},allowed:(a)=>(a.data.exits||[]).map((a)=>edgeTypeMap$$module$js$rom$metascreens[a.type]^2).filter((a)=>null!=a)});for(const b in this)a=this[b],a instanceof Metascreen$$module$js$rom$metascreen&&(a.name=b)}metascreen(a){const b=new Metascreen$$module$js$rom$metascreen(this.rom,
this.length,a);this[this.length++]=b;this.screensById.get(b.id).push(b);for(const c in a.tilesets){const d=c,e=a.tilesets[d];if(e.requires)for(const a of e.requires)this.screensByFix.get(a).push(b);else this.rom.metatilesets[d].addScreen(b)}return b}getById(a,b){a=this.screensById.has(a)?[...this.screensById.get(a)]:[];null!=b&&(a=a.filter((a)=>a.isCompatibleWithTileset(b)));return a}registerFix(a,b){for(const d of this.screensByFix.get(a)){var c=(d.data.update||[]).find((b)=>b[0]===a);if(c){if(null==
b)throw Error("Seed required for update");if(!c[1](d,b,this.rom))continue}for(const b in d.data.tilesets){c=b;const e=d.data.tilesets[c];if(!e.requires)continue;const g=e.requires.indexOf(a);0>g||(e.requires.splice(g,1),e.requires.length||this.rom.metatilesets[c].addScreen(d))}}}renumber(a,b){var c=this.screensById.get(b);if(c.length)throw Error(`ID already used: ${b}: ${c}`);for(var d of this.getById(a))d.unsafeSetId(b),c.push(d);this.screensById.delete(a);c=this.rom.screens.getScreen(a);d=c.clone(b);
this.rom.screens.setScreen(b,d);c.used=!1;0>a&&this.rom.screens.deleteScreen(a);this.rom.locations.renumberScreen(a,b)}checkExitTypes(){var a;for(const b in this){const c=this[b],d=new Set;for(const e of(null===(a=null===c||void 0===c?void 0:c.data)||void 0===a?void 0:a.exits)||[])d.has(e.type)&&console.log(`duplicate: ${b} ${e.type}`),d.add(e.type)}}}const edgeTypeMap$$module$js$rom$metascreens={"edge:top":0,"edge:left":1,"edge:bottom":2,"edge:right":3};var module$js$rom$metascreens={};
module$js$rom$metascreens.Metascreens=Metascreens$$module$js$rom$metascreens;const METASPRITE_TABLE$$module$js$rom$metasprite=230492;
...
var module$js$rom$randomnumbers={};module$js$rom$randomnumbers.RandomNumbers=RandomNumbers$$module$js$rom$randomnumbers;const {$0d:$0d$$module$js$rom$scaling,$fe:$fe$$module$js$rom$scaling,$ff:$ff$$module$js$rom$scaling}=Segment$$module$js$rom$util;
class Scaling$$module$js$rom$scaling{constructor(a){this.rom=a;this.patk=Array(48).fill(0);this.pdef=Array(48).fill(0);this.php=Array(48).fill(0);this.exp=Array(48).fill(0);this.setPAtkFormula((a)=>5+15*a/32);this.setPDefFormula((a)=>a);this.setPhpFormula((a)=>48+5.5*a);this.setExpScalingFactor(1)}setExpScalingFactor(a){this.setExpFormula((b)=>Math.floor(4*Math.pow(2,(16+9*b)/32)*a))}setPAtkFormula(a){this.patk=this.patk.map((b,c)=>Math.round(8*a(c)))}setPDefFormula(a){this.pdef=this.pdef.map((b,
c)=>Math.round(4*a(c)))}setPhpFormula(a){this.php=this.php.map((b,c)=>Math.min(255,Math.max(5,Math.round(a(c)))))}setExpFormula(a){this.exp=this.exp.map((b,c)=>{b=a(c);return 128>b?b:Math.min(255,128+(b>>4))})}write(){const a=this.rom.assembler();relocExportLabel$$module$js$rom$util(a,[$0d$$module$js$rom$scaling,$fe$$module$js$rom$scaling,$ff$$module$js$rom$scaling],"DiffAtk");a.byte(...this.patk);relocExportLabel$$module$js$rom$util(a,[$0d$$module$js$rom$scaling,$fe$$module$js$rom$scaling,$ff$$module$js$rom$scaling],
"DiffDef");a.byte(...this.pdef);relocExportLabel$$module$js$rom$util(a,[$0d$$module$js$rom$scaling,$fe$$module$js$rom$scaling,$ff$$module$js$rom$scaling],"DiffHP");a.byte(...this.php);relocExportLabel$$module$js$rom$util(a,[$0d$$module$js$rom$scaling,$fe$$module$js$rom$scaling,$ff$$module$js$rom$scaling],"DiffExp");a.byte(...this.exp);return[a.module()]}}var module$js$rom$scaling={};module$js$rom$scaling.Scaling=Scaling$$module$js$rom$scaling;class Screen$$module$js$rom$screen extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.used=!0;this.tiles=tuple$$module$js$rom$util(a.prg,(255<b?64+b:b)<<8,240)}clone(a){a=new Screen$$module$js$rom$screen(this.rom,a);a.used=this.used;a.tiles=[...this.tiles];return a}allTilesSet(){return new Set(this.tiles)}set2d(a,b){const c=a&15;a>>>=4;for(let d=0;d<b.length;d++){const e=b[d];for(let b=0;b<e.length;b++){const f=e[b];null!=f&&(this.tiles[a+d<<4|c+b]=f)}}}assemble(a){const b=this.id.toString(16).padStart(2,
"0");let c=this.tiles;if(this.rom.compressedMapData||256>this.id){const b=(this.id>>5).toString(16).padStart(2,"0");a.segment(b);"0a"===b&&(c=c.slice(192))}else a.segment("0a"),c=c.slice(0,192);a.org(32768|(this.id&63)<<8,`Screen_${b}`);a.byte(...c)}}
class Screens$$module$js$rom$screen extends Array{constructor(a){super(259);this.rom=a;this.unallocated=[];for(let b=0;259>b;b++)this[b]=new Screen$$module$js$rom$screen(a,b)}getScreen(a){const b=0>a?this.unallocated:this,c=0>a?~a:a;return b[c]||(b[c]=new Screen$$module$js$rom$screen(this.rom,a))}setScreen(a,b){(0>a?this.unallocated:this)[0>a?~a:a]=b}deleteScreen(a){delete (0>a?this.unallocated:this)[0>a?~a:a]}write(){const a=this.rom.assembler();for(const b of this)(null===b||void 0===b?0:b.used)&&
b.assemble(a);return[a.module()]}}var module$js$rom$screen={};module$js$rom$screen.Screen=Screen$$module$js$rom$screen;module$js$rom$screen.Screens=Screens$$module$js$rom$screen;const {$0e:$0e$$module$js$rom$slots}=Segment$$module$js$rom$util;class Slots$$module$js$rom$slots extends Array{constructor(a){super(128);this.rom=a;for(a=0;128>a;a++)this[a]=a}swap(a,b){if(a!==b){var c=this[a];this[a]=this[b];this[b]=c}}write(){const a=this.rom.assembler();relocExportLabel$$module$js$rom$util(a,[$0e$$module$js$rom$slots],"CheckToItemGetMap");a.byte(...this);return[a.module()]}}var module$js$rom$slots={};module$js$rom$slots.Slots=Slots$$module$js$rom$slots;const {$0e:$0e$$module$js$rom$telepathy,$fe:$fe$$module$js$rom$telepathy,$ff:$ff$$module$js$rom$telepathy}=Segment$$module$js$rom$util;var Sage$$module$js$rom$telepathy;(function(a){a[a.TORNEL=0]="TORNEL";a[a.ZEBU=1]="ZEBU";a[a.ASINA=2]="ASINA";a[a.KENSU=3]="KENSU"})(Sage$$module$js$rom$telepathy||(Sage$$module$js$rom$telepathy={}));var DefaultMessage$$module$js$rom$telepathy;
...
module$js$rom$telepathy.TelepathyMessageGroup=TelepathyMessageGroup$$module$js$rom$telepathy;class TileAnimation$$module$js$rom$tileanimation extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.base=255865+(b<<3);this.pages=tuple$$module$js$rom$util(a.prg,this.base,8)}}var module$js$rom$tileanimation={};module$js$rom$tileanimation.TileAnimation=TileAnimation$$module$js$rom$tileanimation;class TileEffects$$module$js$rom$tileeffects extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.effects=tuple$$module$js$rom$util(a.prg,this.base,256)}get base(){return this.id<<8&8191|73728}get org(){return this.id<<8&8191|40960}write(){const a=this.rom.assembler();a.segment("09","fe","ff");a.org(this.org,`TileEffects_${this.id.toString(16)}_Tiles`);a.byte(...this.effects);return[a.module()]}}TileEffects$$module$js$rom$tileeffects.PIT=1;
TileEffects$$module$js$rom$tileeffects.NO_WALK=2;TileEffects$$module$js$rom$tileeffects.IMPASSIBLE=4;TileEffects$$module$js$rom$tileeffects.ALTERNATIVE=8;TileEffects$$module$js$rom$tileeffects.BEHIND=16;TileEffects$$module$js$rom$tileeffects.SLOPE=32;TileEffects$$module$js$rom$tileeffects.SLOW=64;TileEffects$$module$js$rom$tileeffects.PAIN=128;var module$js$rom$tileeffects={};module$js$rom$tileeffects.TileEffects=TileEffects$$module$js$rom$tileeffects;class Metatile$$module$js$rom$metatile{constructor(a,b){this.tileset=a;this.id=b;this.copiedFrom=-1}get tiles(){return[0,1,2,3].map((a)=>this.tileset.tiles[a][this.id])}setTiles(a){for(let b=0;4>b;b++){const c=a[b];null!=c&&(this.tileset.tiles[b][this.id]=c)}return this}get alternative(){const a=32>this.id?this.tileset.alternates[this.id]:this.id;return a!==this.id?a:null}setAlternative(a){if(32<=this.id)return this;this.tileset.alternates[this.id]=null!=a?a:this.id;this.tileset.effects().effects[this.id]|=
8;return this}get attrs(){return this.tileset.attrs[this.id]}setAttrs(a){this.tileset.attrs[this.id]=a;return this}get effects(){return this.tileset.effects().effects[this.id]}setEffects(a){this.tileset.effects().effects[this.id]=a;return this}copyFrom(a,...b){b=new Metatile$$module$js$rom$metatile(this.tileset,a);this.copiedFrom=a;this.setTiles(b.tiles);32>(this.id|b.id)&&this.setAlternative(b.alternative);this.setAttrs(b.attrs);this.setEffects(b.effects);return this}replaceIn(...a){if(0>this.copiedFrom)throw Error("Must copyFrom first.");
for(const b of a)b.replace(this.copiedFrom,this.id);return this}}var module$js$rom$metatile={};module$js$rom$metatile.Metatile=Metatile$$module$js$rom$metatile;class Tilesets$$module$js$rom$tileset{constructor(a){this.rom=a;this.tilesets=[];for(let b=128;176>b;b+=4)this.tilesets.push(this[b]=new Tileset$$module$js$rom$tileset(a,b))}[Symbol.iterator](){return this.tilesets[Symbol.iterator]()}}
class Tileset$$module$js$rom$tileset extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.tiles=seq$$module$js$rom$util(4,(b)=>tuple$$module$js$rom$util(a.prg,this.tileBase|b<<8,256));this.attrs=seq$$module$js$rom$util(256,(b)=>a.prg[this.attrBase|b>>2]>>((b&3)<<1)&3);this.alternates=tuple$$module$js$rom$util(a.prg,this.alternatesBase,32)}get map(){return this.id&63}get tileBase(){return 65536|this.map<<8}get attrBase(){return 77824|this.map<<4}get alternatesBase(){return 81408|this.map<<
3}getTile(a){return new Metatile$$module$js$rom$metatile(this,a)}write(){const a=seq$$module$js$rom$util(64,(a)=>{a<<=2;return this.attrs[a]&3|(this.attrs[a+1]&3)<<2|(this.attrs[a+2]&3)<<4|(this.attrs[a+3]&3)<<6}),b=this.rom.assembler(),c=`Tileset_${this.id.toString(16).padStart(2,"0")}`;b.segment("08","09");b.org(32768|this.map<<8,`${c}_Tiles`);b.byte(...[].concat(...this.tiles));b.org(45056|this.map<<4,`${c}_Attrs`);b.byte(...a);b.org(48640|this.map<<3,`${c}_Alternates`);b.byte(...this.alternates);
return[b.module()]}effects(){let a=this.id>>>2&15;168===this.id&&(a=2);172===this.id&&a--;return this.rom.tileEffects[a]}}var module$js$rom$tileset={};module$js$rom$tileset.Tilesets=Tilesets$$module$js$rom$tileset;module$js$rom$tileset.Tileset=Tileset$$module$js$rom$tileset;class TownWarp$$module$js$rom$townwarp{constructor(a){this.rom=a;this.locations=tuple$$module$js$rom$util(a.prg,ADDRESS$$module$js$rom$townwarp.offset,COUNT$$module$js$rom$townwarp);this.thunderSwordWarp=[a.prg[251338],a.prg[251342]]}write(){const a=this.rom.assembler();ADDRESS$$module$js$rom$townwarp.loc(a);a.label("TownWarpTable");a.byte(...this.locations);a.org(56460);a.instruction("lda","TownWarpTable,y");a.org(54729);a.instruction("lda","#"+this.thunderSwordWarp[0]);a.org(54733);a.instruction("lda",
...
class Trigger$$module$js$rom$trigger extends Entity$$module$js$rom$entity{constructor(a,b){super(a,b);this.used=!UNUSED_TRIGGERS$$module$js$rom$trigger.has(b);this.pointer=123258+((b&127)<<1);this.base=addr$$module$js$rom$util(a.prg,this.pointer,81920);this.conditions=[];this.message=MessageId$$module$js$rom$messageid.of({});this.flags=[];let c=this.base;do{b=readBigEndian$$module$js$rom$util(a.prg,c);var d=b&4095;this.conditions.push(b&8192?~d:d);c+=2}while(!(b&32768));this.message=MessageId$$module$js$rom$messageid.from(a.prg,
...
this.omitLocalDialogSuffix=Rom$$module$js$rom.OMIT_LOCAL_DIALOG_SUFFIX.get(a);this.compressedMapData=Rom$$module$js$rom.COMPRESSED_MAPDATA.get(a);for(const a of ADJUSTMENTS$$module$js$rom){const [b,c,d]=a;this.prg[b]===c&&(this.prg[b]=d)}this.tilesets=new Tilesets$$module$js$rom$tileset(this);this.tileEffects=seq$$module$js$rom$util(11,(a)=>new TileEffects$$module$js$rom$tileeffects(this,a+179));this.screens=new Screens$$module$js$rom$screen(this);this.metatilesets=new Metatilesets$$module$js$rom$metatileset(this);
this.metascreens=new Metascreens$$module$js$rom$metascreens(this);this.triggers=seq$$module$js$rom$util(67,(a)=>new Trigger$$module$js$rom$trigger(this,128|a));this.patterns=seq$$module$js$rom$util(this.chr.length>>4,(a)=>new Pattern$$module$js$rom$pattern(this,a));this.palettes=seq$$module$js$rom$util(256,(a)=>new Palette$$module$js$rom$palette(this,a));this.locations=new Locations$$module$js$rom$location(this);this.tileAnimations=seq$$module$js$rom$util(4,(a)=>new TileAnimation$$module$js$rom$tileanimation(this,
...
this.bosses=new Bosses$$module$js$rom$bosses(this);this.scaling=new Scaling$$module$js$rom$scaling(this);this.randomNumbers=new RandomNumbers$$module$js$rom$randomnumbers(this);for(const a of this.locations)a.used&&a.lazyInitialization()}trigger(a){if(128>a||255<a)throw Error(`Bad trigger id $${hex$$module$js$rom$util(a)}`);return this.triggers[a&127]}get projectiles(){const a=new Set;for(const b of this.objects.filter((a)=>a instanceof Monster$$module$js$rom$monster))b.child&&a.add(this.objects[this.adHocSpawns[b.child].objectId]);
return[...a].sort((a,c)=>a.id-c.id)}get monsterGraphics(){const a={};for(const b of this.locations)if(b.used&&b.hasSpawns)for(const c of b.spawns)if(!(c.data[2]&7)){const d=c.data[2]&128?1:0,e=hex$$module$js$rom$util(c.data[3]+80);(a[e]=a[e]||{})[`${d}:${b.spritePatterns[d].toString(16)}:${b.spritePalettes[d].toString(16)}`]={pal:b.spritePalettes[d],pat:b.spritePatterns[d],slot:d}}return a}get locationMonsters(){const a={};for(const b of this.locations){if(!b.used||!b.hasSpawns)continue;const c=a["$"+
hex$$module$js$rom$util(b.id)]={};for(const a of b.spawns)if(!(a.data[2]&7)){const b=a.data[2]&128?1:0,d=a.data[3]+80;c[`${b}:${d.toString(16)}`]=(c[`${b}:${d.toString(16)}`]||0)+1}}return a}assembler(){return new Assembler$$module$js$asm$assembler}writeData(a){a=void 0===a?this.prg:a;var b,c=this.assembler();free$$module$js$rom$util(c,$0e$$module$js$rom,34682,35165);free$$module$js$rom$util(c,$0e$$module$js$rom,35557,39156);free$$module$js$rom$util(c,$0e$$module$js$rom,40422,40960);free$$module$js$rom$util(c,
$0f$$module$js$rom,40960,41222);free$$module$js$rom$util(c,$0f$$module$js$rom,41472,41920);free$$module$js$rom$util(c,$10$$module$js$rom,37146,37992);const d=[...this.modules,c.module()];c=(a)=>{for(const b of a)d.push(...b.write())};d.push(...this.locations.write());c(this.objects);c(this.hitboxes);c(this.triggers);d.push(...this.npcs.write());c(this.tilesets);c(this.tileEffects);c(this.adHocSpawns);d.push(...this.itemGets.write());d.push(...this.slots.write());d.push(...this.items.write());d.push(...this.shops.write());
c(this.bossKills);c(this.patterns);d.push(...this.wildWarp.write());d.push(...this.townWarp.write());d.push(...this.coinDrops.write());d.push(...this.scaling.write());d.push(...this.bosses.write());d.push(...this.randomNumbers.write());d.push(...this.telepathy.write());d.push(...this.messages.write());d.push(...this.screens.write());c=new Linker$$module$js$asm$linker;c.base(this.prg,0);for(const a of d)c.read(a);c.link().apply(a);a===this.prg&&(a=c.exports(),this.uniqueItemTableAddress=a.get("KeyItemData").offset,
this.shopCount=11,this.shopDataTablesAddress=(null===(b=a.get("ShopData"))||void 0===b?void 0:b.offset)||0,Rom$$module$js$rom.SHOP_COUNT.set(this.prg,this.shopCount),Rom$$module$js$rom.SCALING_LEVELS.set(this.prg,this.scalingLevels),Rom$$module$js$rom.UNIQUE_ITEM_TABLE.set(this.prg,this.uniqueItemTableAddress),Rom$$module$js$rom.SHOP_DATA_TABLES.set(this.prg,this.shopDataTablesAddress||0),Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX.set(this.prg,this.omitItemGetDataSuffix),Rom$$module$js$rom.OMIT_LOCAL_DIALOG_SUFFIX.set(this.prg,
this.omitLocalDialogSuffix),Rom$$module$js$rom.COMPRESSED_MAPDATA.set(this.prg,this.compressedMapData))}analyzeTiles(){}disjointTilesets(){var a=[];for(var b of this.locations)if(b.used){var c=b.tileset;for(const d of b.screens)for(const b of d)(a[b]||(a[b]=new Set)).add(c)}b=seq$$module$js$rom$util(256,()=>new UnionFind$$module$js$unionfind);for(c=0;c<a.length;c++)if(a[c])for(var d of this.screens[c].allTilesSet())b[d].union([...a[c]]);for(a=0;a<b.length;a++)d=b[a].sets().map((a)=>[...a].map(hex$$module$js$rom$util).join(" ")).join(" | "),
console.log(`Tile ${hex$$module$js$rom$util(a)}: ${d}`)}swapMetatiles(a,...b){var c=new Map,d=seq$$module$js$rom$util(256);const e=new Map,f=(a)=>Array.isArray(a)?a[0]:0>a?~a:a;for(var g of b){for(var h=0;h<g.length-1;h++)if(Array.isArray(g[h])){var k=g[h];e.set(k[0],k[1]);g[h]=k[0]}for(h=0;h<g.length-1;h++){k=g[h];const a=g[h+1];0>k||0>a||(c.set(a,k),d[a]=k)}}g=new Set;c=new Set;a=new Set(a);for(var m of this.locations)if(m.used&&a.has(m.tileset)){c.add(m.tileEffects);for(var l of m.allScreens())g.add(l)}for(var n of g)for(let a=
0,b=n.tiles.length;a<b;a++)n.tiles[a]=d[n.tiles[a]];for(var p of a){d=this.tilesets[p];for(var r of b)for(m=0;m<r.length-1;m++){l=f(r[m]);n=f(r[m+1]);for(a=0;4>a;a++)d.tiles[a][l]=d.tiles[a][n];d.attrs[l]=d.attrs[n];if(32>n&&d.alternates[n]!==n){if(32<=l)throw Error(`Cannot unflag: ${p} ${l} ${n} ${d.alternates[n]}`);d.alternates[l]=d.alternates[n]}}for(var q of e){const [a,b]=q;d.alternates[a]=b}}for(const a of c){p=this.tileEffects[a-179];for(const a of b)for(r=0;r<a.length-1;r++)q=f(a[r]),d=f(a[r+
1]),p.effects[q]=p.effects[d];for(const a of e.keys())p.effects[a]|=8}}moveFlag(a,b){function c(c){for(let d=0;d<c.length;d++)c[d]===a&&(c[d]=b),c[d]===~a&&(c[d]=~b)}for(const a of this.triggers)c(a.conditions),c(a.flags);for(const d of this.npcs){for(const a of d.spawnConditions.values())c(a);for(const c of[d.globalDialogs,...d.localDialogs.values()])for(const d of c)d.condition===a&&(d.condition=b),d.condition===~a&&(d.condition=~b)}if(512===(a&-256)&&512===(b&-256))for(const c of this.locations)for(const d of c.flags)d.flag===
a&&(d.flag=b)}nextFreeTrigger(){for(const a of this.triggers)if(!a.used)return a;throw Error("Could not find an unused trigger.");}moveScreens(a,b){if(!this.compressedMapData)throw Error("Must compress maps first.");const c=new Map;for(b<<=8;this.screens[b];)b++;for(var d of a)if(!(256<=d.id)){var e=d.id;if(!c.has(e)){var f=d.id=b++;c.set(e,f);c.set(f,f)}}for(const g of this.locations)if(g.tileset==a.tilesetId){d=!1;b=!0;for(const a of g.screens)for(e=0;e<a.length;e++)f=c.get(a[e]),null!=f?(a[e]=
f,d=!0):b=!1;if(d&&!b)throw Error("Inconsistent move");}}static load(a,b){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const c=yield pickFile$$module$js$rom(b);a&&(yield a(c));return new Rom$$module$js$rom(c)})}}Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX=module$js$rom$option.RomOption.bit(82624,0);Rom$$module$js$rom.OMIT_LOCAL_DIALOG_SUFFIX=module$js$rom$option.RomOption.bit(82624,1);Rom$$module$js$rom.COMPRESSED_MAPDATA=module$js$rom$option.RomOption.bit(82624,2);
Rom$$module$js$rom.SHOP_COUNT=module$js$rom$option.RomOption.byte(82625);Rom$$module$js$rom.SCALING_LEVELS=module$js$rom$option.RomOption.byte(82626);Rom$$module$js$rom.UNIQUE_ITEM_TABLE=module$js$rom$option.RomOption.address(82640);Rom$$module$js$rom.SHOP_DATA_TABLES=module$js$rom$option.RomOption.address(82643);Rom$$module$js$rom.TELEPATHY_TABLES=module$js$rom$option.RomOption.address(82646);
...
function defines$$module$js$patch(a,b){const c={_ALLOW_TELEPORT_OUT_OF_BOSS:a.hardcoreMode()&&a.shuffleBossElements(),_ALLOW_TELEPORT_OUT_OF_TOWER:!0,_AUTO_EQUIP_BRACELET:a.autoEquipBracelet(b),_BARRIER_REQUIRES_CALM_SEA:!0,_BUFF_DEOS_PENDANT:a.buffDeosPendant(),_BUFF_DYNA:a.buffDyna(),_CHECK_FLAG0:!0,_CTRL1_SHORTCUTS:a.controllerShortcuts(b),_CUSTOM_SHOOTING_WALLS:!0,_DISABLE_SHOP_GLITCH:a.disableShopGlitch(),_DISABLE_STATUE_GLITCH:a.disableStatueGlitch(),_DISABLE_SWORD_CHARGE_GLITCH:a.disableSwordChargeGlitch(),
_DISABLE_TRIGGER_SKIP:!0,_DISABLE_WARP_BOOTS_REUSE:a.disableShopGlitch(),_DISABLE_WILD_WARP:!1,_DISPLAY_DIFFICULTY:!0,_EXTRA_EXTENDED_SCREENS:!0,_EXTRA_PITY_MP:!0,_FIX_COIN_SPRITES:!0,_FIX_OPEL_STATUE:!0,_FIX_SHAKING:!0,_FIX_VAMPIRE:!0,_HARDCORE_MODE:a.hardcoreMode(),_HAZMAT_SUIT:a.changeGasMaskToHazmatSuit(),_LEATHER_BOOTS_GIVE_SPEED:a.leatherBootsGiveSpeed(),_MAX_SCALING_IN_TOWER:a.maxScalingInTower(),_NERF_FLIGHT:!0,_NERF_MADO:!0,_NEVER_DIE:a.neverDie(),_NORMALIZE_SHOP_PRICES:a.shuffleShops(),
_PITY_HP_AND_MP:!0,_PROGRESSIVE_BRACELET:!0,_RABBIT_BOOTS_CHARGE_WHILE_WALKING:a.rabbitBootsChargeWhileWalking(),_REQUIRE_HEALED_DOLPHIN_TO_RIDE:a.requireHealedDolphinToRide(),_REVERSIBLE_SWAN_GATE:!0,_SAHARA_RABBITS_REQUIRE_TELEPATHY:a.saharaRabbitsRequireTelepathy(),_SIMPLIFY_INVISIBLE_CHESTS:!0,_SOFT_RESET_SHORTCUT:!0,_TELEPORT_ON_THUNDER_SWORD:a.teleportOnThunderSword(),_TRAINER:a.trainer(),_TWELVTH_WARP_POINT:!0,_UNIDENTIFIED_ITEMS:a.unidentifiedItems(),_ZEBU_STUDENT_GIVES_ITEM:!0};return Object.keys(c).filter((a)=>
c[a]).map((a)=>`.define ${a} 1\n`).join("")}
function shuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){function g(a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){function b(a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){return new Tokenizer$$module$js$asm$tokenizer(yield d.read(a),a,{lineContinuations:!0})})}var e=defines$$module$js$patch(c,a);const f=new Assembler$$module$js$asm$assembler(module$js$asm$cpu.Cpu.P02),g=new TokenStream$$module$js$asm$tokenstream;
g.enter(module$js$asm$token.TokenSource.concat(new Tokenizer$$module$js$asm$tokenizer(e,"flags.s"),yield b("init.s"),yield b("preshuffle.s"),yield b("postparse.s"),yield b("postshuffle.s")));e=new Preprocessor$$module$js$asm$preprocessor(g,f);f.tokens(e);return f.module()})}var h=16+(a[6]&4?512:0)+(a[4]<<14)+(a[5]<<13);a.length>h&&(a=a.slice(0,h));EXPAND_PRG$$module$js$patch&&524288>a.length&&(h=new Uint8Array(a.length+262144),h.subarray(0,262160).set(a.subarray(0,262160)),h.subarray(524304).set(a.subarray(262160)),
h[4]<<=1,a=h);if("number"!==typeof b)throw Error("Bad seed");h=crc32$$module$js$crc32(b.toString(16).padStart(8,"0")+String(c.filterOptional()))>>>0;h=new Random$$module$js$random(h);const k=String(c);c=c.filterRandom(h);var m=String(c);deterministicPreParse$$module$js$pass$deterministic(a.subarray(16));const l=new Rom$$module$js$rom(a);l.flags.defrag();"object"==typeof window&&(window.rom=l);l.spoiler=new Spoiler$$module$js$rom$spoiler(l);e&&(e.spoiler=l.spoiler);m!==k&&(l.spoiler.flags=m);deterministic$$module$js$pass$deterministic(l,
c);fixTilesets$$module$js$rom$screenfix(l);module$js$pass$standardmapedits.standardMapEdits(l,module$js$pass$standardmapedits.standardMapEdits.generateOptions(c,h));toggleMaps$$module$js$pass$togglemaps(l,c,h);l.scalingLevels=48;c.shuffleShops()&&shuffleShops$$module$js$patch(l,c,h);c.shuffleGoaFloors()&&shuffleGoa$$module$js$pass$shufflegoa(l,h);randomizeWalls$$module$js$patch(l,c,h);crumblingPlatforms$$module$js$pass$crumblingplatforms(l,h);c.nerfWildWarp()&&l.wildWarp.locations.fill(0);c.randomizeWildWarp()&&
shuffleWildWarp$$module$js$patch(l,c,h);c.randomizeThunderTeleport()&&randomizeThunderWarp$$module$js$pass$randomizethunderwarp(l,h);rescaleMonsters$$module$js$pass$rescalemonsters(l,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(l,c,h);shuffleTrades$$module$js$pass$shuffletrades(l,c,h);l.locations.copyFromMeta();c.randomizeMaps()&&shuffleMazes$$module$js$pass$shufflemazes(l,c,h);c.shuffleMimics()&&shuffleMimics$$module$js$pass$shufflemimics(l,c,h);c.shuffleMonsters()&&shuffleMonsters$$module$js$pass$shufflemonsters(l,
c,h);compressMapData$$module$js$pass$compressmapdata(l);l.moveScreens(l.metatilesets.swamp,4);l.moveScreens(l.metatilesets.house,4);m=new World$$module$js$logic$world(l,c);if(m=yield(new Graph$$module$js$logic$graph([m.getLocationList()])).shuffle(c,h,void 0,f,l.spoiler))for(var n of m){const [a,b]=n;l.slots[a&255]=b&255}else return[a,-1];c.shuffleShops()&&rescaleShops$$module$js$patch(l,c.bargainHunting()?h:void 0);c.buffMedicalHerb()&&(l.items.MedicalHerb.value=80,l.items.FruitOfPower.value=56);
c.storyMode()&&storyMode$$module$js$patch(l);c.blackoutMode()&&blackoutMode$$module$js$patch(l);misc$$module$js$patch(l,c,h);fixDialog$$module$js$pass$fixdialog(l);fixMovementScripts$$module$js$pass$fixmovementscripts(l);c.buffDyna()&&buffDyna$$module$js$patch(l,c);c.trainer()&&(l.wildWarp.locations=[10,26,53,72,109,110,140,170,172,176,182,159,166,88,92,0]);c.randomizeMusic("early")&&shuffleMusic$$module$js$patch(l,c,h);c.shuffleTilePalettes("early")&&shufflePalettes$$module$js$pass$shufflepalettes(l,
c,h);updateTablesPreCommit$$module$js$patch(l,c);h.shuffle(l.randomNumbers.values);l.messages.compress();n=a.slice(16);l.modules.push(yield g("early"));l.writeData(n);l.modules.pop();l.modules.push(yield g("late"));n=stampVersionSeedAndHash$$module$js$patch(a,b,k,n);c.randomizeMusic("late")&&shuffleMusic$$module$js$patch(l,c,h);c.noMusic("late")&&noMusic$$module$js$patch(l);c.shuffleTilePalettes("late")&&shufflePalettes$$module$js$pass$shufflepalettes(l,c,h);fixSkippableExits$$module$js$pass$fixskippableexits(l);
l.writeData();EXPAND_PRG$$module$js$patch&&(h=a.subarray(16),h.subarray(507904,524288).set(h.subarray(245760,262144)));return[a,n]})}
function misc$$module$js$patch(a,b,c){Object.getPrototypeOf(a.locations[0]).show=function(a){console.log(Maze$$module$js$maze$maze2.from(this,c,a).show())};a.messages.parts[2][2].text="\n{01:Akahana} is handed a statue.#\nThanks for finding that.\nI was totally gonna sell\nit for tons of cash.#\nHere, have this lame\n[29:Gas Mask] or something.";a.messages.parts[0][14].text="It's dangerous to go alone! Take this.";a.messages.parts[0][14].fixText()}
...
function stampVersionSeedAndHash$$module$js$patch(a,b,c,d){d=crc32$$module$js$crc32(d);const e=d.toString(16).padStart(8,"0").toUpperCase(),f="unstable"===STATUS$$module$js$version?HASH$$module$js$version.substring(0,7).padStart(7,"0").toUpperCase()+"     ":VERSION$$module$js$version.substring(0,12).padEnd(12," ");b=b.toString(16).padStart(8,"0").toUpperCase();const g=(b,c)=>{for(let d=0;d<c.length;d++)a[b+16+d]=c.charCodeAt(d)},h=(a,b)=>{const c=[];for(let d=0;d<a.length||d<b.length;d++)c.push(a[d]||
" "),c.push(b[d]||" ");return c.join("")};g(161743,h("  VERSION     SEED      ",`  ${f}${b}`));let k;if(46<c.length){if(92<c.length)throw Error("Flag string way too long!");k=c.substring(46,92).padEnd(46," ");c=c.substring(0,46)}c=c.padEnd(46," ");g(161791,h(c.substring(0,23),c.substring(23)));k&&g(161839,h(k.substring(0,23),k.substring(23)));g(161925,h(e.substring(0,4),e.substring(4)));g(153366,"RANDOMIZER");"unstable"===STATUS$$module$js$version&&g(153404,"BETA");return d}
