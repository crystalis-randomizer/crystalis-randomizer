...
function jf(a,b,c){for(let d=0;d<a.length;d++)if(a[d]===b){a[d]=c;return}throw Error(`Could not find ${b} in ${a.join(",")}`);};const {$0e:mf,$0f:nf,$10:of,$1a:pf,$fe:qf,$ff:rf}=y,sf=B.of(mf,33689),tf=B.of(mf,39906),uf=B.of(of,36848),vf=B.of(of,36923),wf=B.of(of,36998),xf=B.of(pf,35776),yf=B.of(pf,35785),zf=[["Sword","\n\x0B\f"],[" of ","\\]"],["Bracelet","<=>["],["Shield","\r\u000e\u000f"],["Armor","{\u0011\u0012"],["Magic","#%("],["Power","\u0013\u0014\u0015"],["Item","\u0016\u0017^"]];
...
var c=zf.reduce((a,[b,c])=>a.replace(b,c),this.menuName);a.segment(of,qf,rf);a.reloc(`ItemMenuName_${x(this.id)}`);const d=a.pc();a.byte(c,255);this.menuNamePointer.loc(a,`ItemMenuName_${b}`);a.word(d);if(this.itemUseJump){this.itemUseJumpPointer.loc(a,`ItemUseJump_${b}_Ptr`);a.word(this.itemUseJump.org);c=[];for(var e of this.itemUseData)c.push(...e.bytes());a.segment(mf.name,nf.name);a.reloc(`ItemUseData_${b}`);e=a.pc();a.byte(...c);this.itemUseDataPointer.loc(a,`ItemUseData_${b}_Ptr`);a.word(e)}this.valueAddr&&
...
"p","mado shuriken",,,,36,,,],[253,"p","guardian statue missile",,,,23,,,],[254,"p","demon wall fire",,,,23,,,]].map(([a,b,c,d=0,e=0,f=0,g=0,h=0,k=0])=>[a,{id:a,type:b,name:c,sdef:d,swrd:e,hits:f,satk:g,dgld:h,sexp:k}]));new Map([["stair:up","C"],["edge:top","N"],["edge:left","W"],["edge:right","E"],["cave","C"],["door","C"],["door2","C"],["door3","C"],["fortress","F"]]);new Map([["N","S"],["S","N"],["E","W"],["W","E"],["C","X"],["X","C"],["F","O"],["O","F"]]);new Map([["pawn",54],["inn",55],["armor",56],["tool",57],["tavern",59]]);const Ff=new Set(["inn","armor","tool","pawn"]);new Set([...Ff,"house","tavern"]);new Set([182]);new Set([89,92,110,111,129,138,163,196]);new Set([85,93,124,188,193]);function Gf(a,b){if(b.eastCave){{b=b.eastCave;const {locations:{EastCave1:d,EastCave2:e,EastCave3:f,SealedCave1:g,ValleyOfWind:h},metascreens:{boundaryE_cave:k,branchNSE:p,branchNWE:q,branchNWSE:t,branchNWS:A,branchWSE:D,caveEmpty:z,deadEndE:I,deadEndE_downStair:X,deadEndE_upStair:T,deadEndN_stairs:R,deadEndS:U,deadEndS_stairs:Xa,deadEndW:wa,deadEndW_downStair:Tb,hallNE:ob,hallNS:gb,hallNW:Ta,hallSE:Jb,hallWS:xb,hallWE:hb,hallNS_entrance:ib,hallNS_ramp:ac,hallNS_wall:pc}}=a;a.locations.allocate(d);
...
function Hf(a,b,c){const {locations:{CordelPlainEast:d,CordelPlainWest:e,Desert2:f,GoaValley:g,LimeTreeValley:h},metascreens:{bendNE:k,bendSE:p,boundaryN_trees:q,boundaryW_cave:t,cornerNE:A,cornerNW:D,cornerSE:z,cornerSE_cave:I,cornerSW:X}}=a.rom;let T,R;switch(c){case "lime":T=h;R=16;T.resizeScreens(0,1,0,0);T.meta.spliceColumns(0,1,2,[[D,q],[t,p],[X,z]]);break;case "cordel":c=[[t,p],[X,z]];T=d;R=85;T.meta.set2d(85,c);e.meta.set2d(85,c);break;case "goa":T=g;R=17;T.meta.set2d(1,[[D,A],[t,k]]);break;
...
a}get restoreAnimation(){return this.data[19]}set restoreAnimation(a){this.data[19]=a}get explode(){return!!this.data[20]}set explode(a){this.data[20]=a?1:0}write(){if(!this.base)return[];const a=this.rom.assembler();a.segment("0f");a.org(this.base);a.byte(this.data[0],this.data[1]);a.org(this.base+4);a.byte(this.data[4]);return[a.module()]}};const {$0f:Mf,$1b:Nf}=y;
...
const c=a.pc();a.byte(...b);this.tablePointer.loc(a);a.word(c)}}const pg=new Set([4,8,16]);const {$14:qg,$15:rg,$16_a:sg,$17:tg}=y,ug=new Map([[6,"{}"],[7,"[]"]]);
...
ug.get(f);h&&(b.push(h[0]),b.push(d.toString(16).padStart(2,"0")),b.push(":"));b.push(e(d,f));h&&b.push(h[1]);xg[String.fromCharCode(a[c+1])]||b.push(" ")}else if(128<=f)b.push(e(f,0)),xg[String.fromCharCode(a[c+1])]||b.push(" ");else if(32<=f)b.push(String.fromCharCode(f));else throw Error(`Non-exhaustive switch: ${f} at ${c.toString(16)}`);}this.text=b.join("")}get mid(){return`${x(this.part)}:${x(this.id)}`}fixText(){function a(a,b=a.length){28<f+b&&c();" "===a?(d.push(...h," "),h=[]):/^[[{]:/.test(a)?
...
const Zg={"edge:top":0,"edge:left":1,"edge:bottom":2,"edge:right":3},Vg=["|:","|:=-","|","|="],Wg=new Set(["|",":","-","="]),$g=new Set("arena portoa1 portoa2 portoa3 lake overpass underpass lighthouse cabin windmill altar pyramid crypt".split(" ")),ah=new Set("pit spikes bridge wall ramp whirlpool".split(" ")),Xg=[...$g].map(a=>Jg[a]).reduce((a,b)=>a|b),Yg=[...ah].map(a=>Jg[a]).reduce((a,b)=>a|b);class bh{constructor(a){this.rom=a;this.length=0;this.screensByFix=new ba(()=>[]);this.screensById=new ba(()=>[]);this.registeredFixes=new Set;this.overworldEmpty=this.metascreen({id:0,icon:V`
      ...
      |\u2588\u2588\u2588|
      |\u2588\u2229\u2588|
      |   |`,placement:"manual",tile:["   |oFo|ooo","oo |oFo|ooo"],tilesets:{grass:{}},edges:" vov",exits:[Object.assign({},Lg(166,3),{type:"fortress"})]});this.bendSE_longGrass=this.metascreen({id:9,icon:V`\u2597
      | v |
      |vv\u2584|
      | \u2590\u2588|`,tile:"ooo|ooo|oo ",tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"oo<^"});this.exitW_cave=this.metascreen({id:10,icon:V`\u2229
      |\u2588\u2229\u2588|
      |  \u2588|
      |\u2588\u2588\u2588|`,tile:["   |o< |   ","   |x< |   "],tilesets:{grass:{},river:{},desert:{},sea:{requires:[G.SeaCaveEntrance]}},edges:" n  ",exits:[Ng(72),Qg({top:6})]});this.bendNE_grassRocks=this.metascreen({id:11,icon:V`\u259d
      |.\u2590\u2588|
      |  \u2580|
      ...
      | \u2590\u2588|
      |   |
      | \u2590\u2588|`,tile:["oo |ooo|oo ","oo |oox|oo "],tilesets:{grass:{},river:{},desert:{requires:[G.DesertRocks]}},edges:"<o<n",exits:[Rg({top:6})]});this.boundaryN_trees=this.metascreen({id:17,icon:V`
      |\u2588\u2588\u2588|
      |\u2580\u2580\u2580|
      ...
      |\u2550  |
      |\u255e\u2550\u2550|
      |\u2502  |`,placement:"manual",tile:"roo|1rr| oo",tilesets:{river:{}},feature:["portoa3"],edges:"2*>r",exits:[Qg({top:1})]});this.slopeAbovePortoa=this.metascreen({id:19,icon:V`
      |\u2588\u2193\u2588|
      |\u2588\u2193\u2580|
      ...
      |\u2588\u258c |
      |\u2588\u2229 |
      |\u2588\u258c |`,tile:" oo| <o| oo",tilesets:{grass:{},river:{},desert:{},sea:{requires:[G.SeaCaveEntrance]}},edges:"> >o",exits:[Ng(137)]});this.exitN=this.metascreen({id:22,icon:V`\u2575
      |\u2588 \u2588|
      |\u2580 \u2580|
      ...
      |   |
      |\u2550\u2551\u2550|
      |   |`,tile:"ooo|ror|ooo",tilesets:{river:{}},edges:"oror",exits:[Sg(119),Tg(135)]});this.riverBoundaryE_waterfall=this.metascreen({id:24,icon:V`\u2561
      | \u2590\u2588|
      |\u2550\u2550/|
      | \u2590\u2588|`,tile:"oo |rr |oo ",tilesets:{river:{}},edges:"<r< "});this.boundaryE_cave=this.metascreen({id:25,icon:V`
      | \u2590\u2588|
      |v\u2229\u2588|
      |v\u2590\u2588|`,tile:"oo |o< |oo ",tilesets:{river:{},grass:{requires:[G.GrassLongGrass]},desert:{requires:[G.DesertLongGrass]}},edges:"<o< ",exits:[Ng(88)]});this.exitW_southwest=this.metascreen({id:26,icon:V`\u2574
      |\u2588\u258c |
      |\u2580 \u2584|
      |\u2584\u2588\u2588|`,tile:" oo|Boo|   ",tilesets:{grass:{},river:{},desert:{requires:[G.DesertRocks]},sea:{requires:[G.SeaRocks]}},edges:">* ^",exits:[Qg({top:11})]});this.nadare=this.metascreen({id:27,tilesets:{house:{}},exits:[Pg(),W(35),W(37,"door2"),W(42,"door3")]});this.townExitW=this.metascreen({id:28,icon:V`\u2574
      |\u2588\u258c |
      |\u2580 ^|
      |\u2588\u258c |`,tile:" oo|8oo| oo",tilesets:{grass:{},river:{}},edges:">n>o",exits:[Qg({top:8,height:3,shift:-.5})]});this.shortGrassS=this.metascreen({id:29,icon:V` |
      |;;;|
      | v |
      ...
      | ^ |
      |\u2584 \u2584|
      |\u2588 \u2588|`,tile:["ooo|ooo| o ","ooo|ooo| x "],tilesets:{grass:{},river:{},desert:{requires:[G.DesertRocks,G.DesertTownEntrance]}},edges:"o^n^",exits:[Og()]});this.swanGate=this.metascreen({id:31,tilesets:{town:{}},exits:[Qg({top:3}),Rg({top:9})],flag:"custom:false"});this.riverBranchNSE=this.metascreen({id:32,icon:V`
      | \u2551 |
      | \u2560\u2550|
      ...
      |\u2588\u2588\u2588|
      |\u258c\u2229\u2590|
      |\u2588 \u2588|`,placement:"manual",tile:["   | H | o ","   | H | x "],tilesets:{grass:{}},exits:[W(104),Og({shift:.5})]});this.bendNW_trees=this.metascreen({id:38,icon:V`\u2598
      |\u2588\u258c |
      |\u2580 ^|
      ...
      |\u259b\u2551\u259c|
      | \u2551 |
      |\u2599\u2551\u259f|`,tile:[" o | o | o "," x | o | o "," o | o | x "],tilesets:{grass:{},river:{}},edges:"n n ",exits:[Sg(119),Tg(135),Y(),Og()]});this.exitS_cave=this.metascreen({id:43,icon:V`\u2229
      |\u2588\u2229\u2588|
      |\u258c \u2590|
      |\u2588 \u2588|`,tile:["   | < | o ","   | < | x "],tilesets:{grass:{},river:{},desert:{},sea:{requires:[G.SeaCaveEntrance]}},edges:"  n ",exits:[Ng(103),Og()]});this.outsideWindmill=this.metascreen({id:44,icon:V`\u2573
      |\u2588\u2588\u2573|
      |\u2588\u2229\u2588|
      |\u2588 \u2588|`,placement:"manual",tile:["   | W | o ","   | W | x "],tilesets:{grass:{}},flag:"custom:false",feature:["windmill"],edges:"  n ",exits:[Ng(99),Og(),W(137,"windmill"),W(140)]});this.townExitW_cave=this.metascreen({id:45,icon:V`\u2229
      |\u2588\u2229\u2588|
      |\u2584\u2584\u2588|
      |\u2588\u2588\u2588|`,tile:"   |x< |   ",tilesets:{grass:{}},edges:" n  ",exits:[Ng(74),Qg({top:5,height:3,shift:-.5})],flag:"custom:true"});this.riverNS=this.metascreen({id:46,icon:V`
      | \u2551 |
      | \u2551 |
      ...
      | w |
      |\u2584 \u2584|
      |\u2588 \u2588|`,tile:["ooo|ooo| o ","ooo|ooo| x |"],tilesets:{grass:{},river:{},desert:{requires:[G.DesertMarsh]},sea:{requires:[G.SeaMarsh]}},edges:"o^n^",exits:[Og()]});this.bendNW=this.metascreen({id:52,icon:V`\u2598
      |\u2588\u258c |
      |\u2580\u2580 |
      ...
      | \u250a |
      |\u2500\u2534\u2500|
      |   |`,tile:" t |ttt|   ",tilesets:{tower:{}},edges:"st t",exits:[Y({left:8}),Tg(8,2)]});this.towerRobotDoor_downStair=this.metascreen({id:57,icon:V`\u252c
      | \u2229 |
      |\u2500\u252c\u2500|
      | \u250a |`,tile:"   |ttt| t ",tilesets:{tower:{}},edges:" tst",exits:[Sg(232,2),Tg(248,2)]});this.towerDynaDoor=this.metascreen({id:58,icon:V`\u2229
      | \u2229 |
      |\u2514\u252c\u2518|
      | \u250a |`,tile:"   | < | t ",tilesets:{tower:{}},edges:"  s ",exits:[Ng(103,"door")]});this.towerLongStairs=this.metascreen({id:59,icon:V`
      | \u250a |
      | \u250a |
      | \u250a |`,tile:" t | t | t ",tilesets:{tower:{}},edges:"s s ",exits:[Og()]});this.towerMesiaRoom=this.metascreen({id:60,tilesets:{tower:{}},exits:[Pg()]});this.towerTeleporter=this.metascreen({id:61,tilesets:{tower:{}},exits:[Pg(),Ng(87,"teleporter")]});this.caveAbovePortoa=this.metascreen({id:62,icon:V`
      |\u2588\u2588\u2588|
      |\u2588\u2229\u2588|
      |\u2588\u2193\u2588|`,placement:"manual",tile:"   | < | \u2193 ",tilesets:{river:{}},edges:"  1 ",feature:["portoa1"],exits:[Ng(102)]});this.cornerNE_flowers=this.metascreen({id:63,icon:V`\u259c
      |\u2588\u2588\u2588|
      |\u2580*\u2588|
...
this.house_ruinedUpstairs=this.metascreen({id:72,tilesets:{house:{}},exits:[Pg(),Mg(156,1)]});this.house_ruinedDownstairs=this.metascreen({id:73,tilesets:{house:{}},exits:[Lg(86,1)]});this.foyer=this.metascreen({id:74,tilesets:{house:{}},exits:[Pg({shift:.5}),W(40),W(83,"door2"),W(92,"door3")]});this.throneRoom_portoa=this.metascreen({id:75,tilesets:{house:{}},exits:[Pg(),W(43)]});this.fortuneTeller=this.metascreen({id:76,tilesets:{house:{}},exits:[Pg(),W(86),W(89,"door2")]});this.backRoom=this.metascreen({id:77,
tilesets:{house:{}},exits:[Pg()]});this.dojo=this.metascreen({id:78,tilesets:{house:{}},exits:[Pg({shift:-.5})]});this.windmillInside=this.metascreen({id:79,tilesets:{house:{}},exits:[Pg({left:9,width:1})]});this.horizontalTownMiddle=this.metascreen({id:80,tilesets:{town:{}},exits:[W(76),W(85,"door2")],tallHouses:[53]});this.brynmaerRight_exitE=this.metascreen({id:81,tilesets:{town:{type:"horizontal"}},exits:[Rg({top:8}),W(65)]});this.brynmaerLeft_deadEnd=this.metascreen({id:82,tilesets:{town:{type:"horizontal"}},
exits:[W(73),W(76,"door2")]});this.swanLeft_exitW=this.metascreen({id:83,tilesets:{town:{type:"horizontal"}},exits:[Qg({top:9}),W(73),W(94,"door2")]});this.swanRight_exitS=this.metascreen({id:84,tilesets:{town:{type:"horizontal"}},exits:[Og({left:3}),W(65),W(67,"door2"),W(87,"door3")]});this.horizontalTownLeft_exitN=this.metascreen({id:85,tilesets:{town:{type:"horizontal"}},exits:[Y({left:13}),W(70),W(75,"door2")]});this.amazonesRight_deadEnd=this.metascreen({id:86,tilesets:{town:{type:"horizontal"}},
exits:[W(64),W(88,"door2")]});this.saharaRight_exitE=this.metascreen({id:87,tilesets:{town:{type:"horizontal"}},exits:[Rg({top:7}),W(64),W(102,"door2")]});this.portoaNW=this.metascreen({id:88,tilesets:{town:{type:"square"}},exits:[Ng(71,"fortress"),Og()]});this.portoaNE=this.metascreen({id:89,tilesets:{town:{type:"square"}},exits:[W(99),W(138,"door2"),Og({left:3,width:4})]});this.portoaSW_exitW=this.metascreen({id:90,tilesets:{town:{type:"square"}},exits:[Qg({top:9}),W(134),Y()]});this.portoaSE_exitE=
this.metascreen({id:91,tilesets:{town:{type:"square"}},exits:[Rg({top:9}),W(122),W(135,"door2")],tallHouses:[90]});this.dyna=this.metascreen({id:92,tilesets:{tower:{}},exits:[{type:"stair:down",manual:!0,dir:2,entrance:49024,exits:[]}]});this.portoaFisherman=this.metascreen({id:93,tilesets:{town:{type:"square"}},exits:[Rg({top:6}),Qg({top:4,height:6,shift:.5}),W(104)]});this.verticalTownTop_fortress=this.metascreen({id:94,tilesets:{town:{type:"vertical"}},exits:[Ng(71,"fortress"),Og()]});this.shyronMiddle=
this.metascreen({id:95,tilesets:{town:{type:"vertical"}},exits:[W(84),W(91,"door2"),Y()]});this.shyronBottom_exitS=this.metascreen({id:96,tilesets:{town:{type:"vertical"}},exits:[Og({left:3}),W(4),W(6,"door2"),W(153,"door3")]});this.zombieTownMiddle=this.metascreen({id:97,tilesets:{town:{type:"vertical"}},exits:[W(153),Y()]});this.zombieTownBottom_caveExit=this.metascreen({id:98,tilesets:{town:{type:"vertical"}},exits:[Ng(146),W(35),W(77,"door2")]});this.leafNW_houseShed=this.metascreen({id:99,tilesets:{town:{type:"square"}},
exits:[W(140),W(149,"door2")]});this.squareTownNE_house=this.metascreen({id:100,tilesets:{town:{type:"square"}},exits:[Y({left:1}),W(183)]});this.leafSW_shops=this.metascreen({id:101,tilesets:{town:{type:"square"}},exits:[W(119),W(138,"door2")],tallHouses:[106]});this.leafSE_exitE=this.metascreen({id:102,tilesets:{town:{type:"square"}},exits:[Rg({top:3,height:3,shift:-.5}),W(132)]});this.goaNW_tavern=this.metascreen({id:103,tilesets:{town:{type:"square"}},exits:[W(186)]});this.squareTownSW_exitS=
this.metascreen({id:104,tilesets:{town:{type:"square"}},exits:[Og({left:8}),W(132)]});this.goaSE_shop=this.metascreen({id:105,tilesets:{town:{type:"square"}},exits:[W(130)]});this.joelNE_shop=this.metascreen({id:106,tilesets:{town:{type:"square"}},exits:[W(167)]});this.joelSE_lake=this.metascreen({id:107,tilesets:{town:{type:"square"}}});this.oakNW=this.metascreen({id:108,tilesets:{town:{type:"square"}},exits:[W(231)]});this.oakNE=this.metascreen({id:109,tilesets:{town:{type:"square"}},exits:[W(96)]});
this.oakSW=this.metascreen({id:110,tilesets:{town:{type:"square"}},exits:[W(124)]});this.oakSE=this.metascreen({id:111,tilesets:{town:{type:"square"}},exits:[Og({left:0,shift:.5}),W(151)]});this.temple=this.metascreen({id:112,tilesets:{house:{}},exits:[Pg()]});this.wideDeadEndN=this.metascreen({id:113,icon:V`
      | \u2503 |
      | > |
      |   |`,tile:" w | > |   ",tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["wide"],edges:"w   ",connect:"2",exits:[Mg(199)],statues:[4]});this.goaWideDeadEndN=this.metascreen({id:113,icon:V`
      |\u2575\u2503\u2575|
      | > |
      |   |`,tile:" w | > |   ",tilesets:{labyrinth:{}},edges:"w   ",connect:"1|2x|3",exits:[Mg(199)],statues:[4]});this.wideHallNS=this.metascreen({id:114,icon:V`
      | \u2503 |
      | \u2503 |
      ...
      |\u257b<\u257b|
      |\u2521\u2501\u2529|
      |\u2502\u257b\u2502|`,placement:"manual",tile:"   | < | w ",tilesets:{labyrinth:{}},feature:["arena"],edges:"w w ",connect:"9b|a",exits:[Lg(55)]});this.limeTreeLake=this.metascreen({id:116,tilesets:{lime:{}},exits:[Pg(),Ng(71)],feature:["bridge"],wall:103});this.swampNW=this.metascreen({id:117,icon:V`
      | \u2502 |
      |\u2500\u2518 |
      |   |`,tile:" c |cc |   ",tilesets:{swamp:{}},feature:["consolidate"],edges:"ss  ",connect:"26",exits:[Y({left:6,width:4}),Qg({top:7,height:4,shift:-.5})],poi:[[2]]});this.swampE=this.metascreen({id:118,icon:V`
      |   |
      | \u2576\u2500|
      |   |`,tile:"   | cc|   ",tilesets:{swamp:{}},feature:["consolidate"],edges:"   s",connect:"e",exits:[],poi:[[0]]});this.swampE_door=this.metascreen({id:118,icon:V`\u2229
      | \u2229 |
      | \u2576\u2500|
      |   |`,tile:"   | <c|   ",tilesets:{swamp:{requires:[G.SwampDoors]}},feature:["consolidate"],flag:"always",edges:"   s",connect:"e",exits:[Ng(92,"swamp")]});this.swampNWSE=this.metascreen({id:119,icon:V`
      | \u2502 |
      |\u2500\u253c\u2500|
      | \u2502 |`,tile:" c |ccc| c ",tilesets:{swamp:{}},feature:["consolidate"],edges:"ssss",connect:"26ae",exits:[Y({left:6,width:4}),Qg({top:7,height:4,shift:-.5}),Og({left:6,width:4}),Rg({top:7,height:4,shift:-.5})]});this.swampNWS=this.metascreen({id:120,icon:V`
      | \u2502 |
      |\u2500\u2524 |
      | \u2502 |`,tile:" c |cc | c ",tilesets:{swamp:{}},feature:["consolidate"],edges:"sss ",connect:"26a",exits:[Y({left:6,width:4}),Qg({top:7,height:4,shift:-.5}),Og({left:6,width:4})]});this.swampNE=this.metascreen({id:121,icon:V`
      | \u2502 |
      | \u2514\u2500|
      |   |`,tile:" c | cc|   ",tilesets:{swamp:{}},feature:["consolidate"],edges:"s  s",connect:"2e",exits:[Y({left:6,width:4}),Rg({top:7,height:4,shift:-.5})],poi:[[2]]});this.swampWSE=this.metascreen({id:122,icon:V`
      |   |
      |\u2500\u252c\u2500|
      | \u2502 |`,tile:"   |ccc| c ",tilesets:{swamp:{}},feature:["consolidate"],edges:" sss",connect:"6ae",exits:[Qg({top:7,height:4,shift:-.5}),Og({left:6,width:4}),Rg({top:7,height:4,shift:-.5})]});this.swampWSE_door=this.metascreen({id:122,icon:V`\u2229
      | \u2229 |
      |\u2500\u252c\u2500|
      | \u2502 |`,tile:"   |c<c| c ",tilesets:{swamp:{requires:[G.SwampDoors]}},feature:["consolidate"],flag:"always",edges:" sss",connect:"6ae",exits:[Ng(86,"swamp")]});this.swampW=this.metascreen({id:123,icon:V`
      |   |
      |\u2500\u2574 |
      |   |`,tile:"   |cc |   ",tilesets:{swamp:{}},feature:["consolidate"],edges:" s  ",connect:"6",poi:[[0]]});this.swampW_door=this.metascreen({id:123,icon:V`\u2229
      | \u2229 |
      |\u2500\u2574 |
      |   |`,tile:"   |c< |   ",tilesets:{swamp:{requires:[G.SwampDoors]}},feature:["consolidate"],flag:"always",edges:" s  ",connect:"6",exits:[Ng(84,"swamp")]});this.swampArena=this.metascreen({id:124,icon:V`
      |   |
      |\u2517\u252f\u251b|
      | \u2502 |`,tile:"   | a | c ",tilesets:{swamp:{}},feature:["arena"],edges:"  s ",connect:"a"});this.swampNWE=this.metascreen({id:125,icon:V`
      | \u2502 |
      |\u2500\u2534\u2500|
      |   |`,tile:" c |ccc|   ",tilesets:{swamp:{}},feature:["consolidate"],edges:"ss s",connect:"26e",exits:[Y({left:6,width:4}),Qg({top:7,height:4}),Rg({top:7,height:4})]});this.swampWS=this.metascreen({id:126,icon:V`
      |   |
      |\u2500\u2510 |
      | \u2502 |`,tile:"   |cc | c ",tilesets:{swamp:{requires:[G.SwampDoors]}},feature:["consolidate"],update:[[G.SwampDoors,(a,c,d)=>{d.metascreens.swampWS_door.flag="always";return!0}]],edges:" ss ",connect:"6a",exits:[Qg({top:7,height:4}),Og({left:6,width:4})],poi:[[2]]});this.swampWS_door=this.metascreen({id:126,icon:V`\u2229
      | \u2229 |
      |\u2500\u2510 |
      | \u2502 |`,tile:"   |c< | c ",tilesets:{swamp:{}},feature:["consolidate"],edges:" ss ",connect:"6a",exits:[Ng(87,"swamp")]});this.swampEmpty=this.metascreen({id:127,icon:V`
      |   |
      |   |
...
[".",200]))});this.swampWE_door=this.metascreen({id:-116,icon:V`\u2229
      | \u2229 |
      |\u2500\u2500\u2500|
      |   |`,tile:"   |c<c|   ",tilesets:{swamp:{requires:[G.SwampDoors]}},feature:["consolidate"],flag:"always",edges:" s s",connect:"6e",exits:[Ng(86,"swamp")]});this.swampSE=this.metascreen({id:-117,icon:V`
      |   |
      | \u250c\u2500|
...
[".",200]))});this.swampSE_door=this.metascreen({id:-117,icon:V`\u2229
      | \u2229 |
      | \u250c\u2500|
      | \u2502 |`,tile:"   | <c| c ",tilesets:{swamp:{requires:[G.SwampDoors]}},feature:["consolidate"],flag:"always",edges:"  ss",connect:"ae",exits:[Ng(90,"swamp")]});this.swampNSE=this.metascreen({id:-118,icon:V`
      | \u2502 |
      | \u251c\u2500|
...
[".",200]))});this.caveEmpty=this.metascreen({id:128,icon:V`
      ...
      | \u2502 |
      | \u2502 |
      | \u2502 |`,tile:" c | c | c ",tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"c c ",connect:"2a",poi:[[4]],exits:[Og({left:6,width:4,manual:!0}),Y({left:6,width:4,manual:!0})]});this.hallNS_unreachable=this.metascreen({id:129,icon:V`\n|   |\n|   |\n|   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],placement:"manual",match:a=>!a(128,128),delete:!0});this.hallWE=this.metascreen({id:130,icon:V`
      |   |
      |\u2500\u2500\u2500|
      ...
      |\u250c\u2538\u2510|
      |\u2502&\u2502|
      |\u2514\u252c\u2518|`,tile:[" n | a | c "],tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["arena"],edges:"c c ",connect:"2a",poi:[[1,96,120]],exits:[Y(),Og({left:6,width:4,manual:!0}),Sg(230,4),Tg(246,4)],arena:1});this.hallNS_arena_unreachable=this.metascreen({id:145,icon:V`\n|   |\n|   |\n|   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],placement:"manual",match:a=>!a(128,128),delete:!0});this.hallNS_arenaWall=this.metascreen({id:146,icon:V`
      |\u250c\u2504\u2510|
      |\u2502&\u2502|
      |\u2514\u252c\u2518|`,placement:"manual",tile:[" n | a | c "],tilesets:{cave:{},iceCave:{}},feature:["arena","wall"],edges:"n c ",connect:"2x=apx",wall:39,mod:"wall",poi:[[1,96,120]],exits:[Y({top:1}),Og({left:6,width:4,manual:!0})],arena:1});this.branchNWE_wall=this.metascreen({id:148,icon:V`
      | \u2506 |
      |\u2500\u2534\u2500|
      ...
      | < |
      |\u2500\u2534\u2500|
      |   |`,tile:"   |c<c|   ",tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:" c c",connect:"6e",exits:[Lg(71)]});this.branchNWE_upStair_unreachable=this.metascreen({id:149,icon:V`\n|   |\n|   |\n|   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],placement:"manual",match:a=>!a(128,128),delete:!0});this.deadEndW_upStair=this.metascreen({id:150,icon:V`<
      | < |
      |\u2500\u2518 |
      |   |`,tile:"   |c< |   ",tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:" c  ",connect:"6",exits:[Lg(66)]});this.deadEndW_upStair_unreachable=this.metascreen({id:150,icon:V`\n|   |\n|   |\n|   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],placement:"manual",match:a=>!a(128,32),delete:!0});this.deadEndW_downStair=this.metascreen({id:151,icon:V`>
      |   |
      |\u2500\u2510 |
      | > |`,tile:"   |c> |   ",tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:" c  ",connect:"6",exits:[Mg(162)]});this.deadEndW_downStair_unreachable=this.metascreen({id:151,icon:V`\n|   |\n|   |\n|   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],placement:"manual",match:a=>!a(128,32),delete:!0});this.deadEndE_upStair=this.metascreen({id:152,icon:V`<
      | < |
      | \u2514\u2500|
      |   |`,tile:"   | <c|   ",tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"   c",connect:"e",exits:[Lg(76)]});this.deadEndE_upStair_unreachable=this.metascreen({id:152,icon:V`\n|   |\n|   |\n|   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],placement:"manual",match:a=>!a(128,208),delete:!0});this.deadEndE_downStair=this.metascreen({id:153,icon:V`>
      |   |
      | \u250c\u2500|
      | > |`,tile:"   | >c|   ",tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"   c",connect:"e",exits:[Mg(172)]});this.deadEndE_downStair_unreachable=this.metascreen({id:153,icon:V`\n|   |\n|   |\n|   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],placement:"manual",match:a=>!a(128,208),delete:!0});this.deadEndNS_stairs=this.metascreen({id:154,icon:V`
      | > |
      |   |
      | < |`,placement:"manual",tile:" > |   | < ",tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],edges:"c c ",connect:"2x|ax",exits:[Mg(23),Lg(215)],match:a=>a(264,120)&&a(-48,120)});this.deadEndNS_stairs_unreachable=this.metascreen({id:154,icon:V`\n|   |\n|   |\n|   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],placement:"manual",match:a=>!a(264,120)&&!a(-48,120),delete:!0});this.deadEndN_stairs=this.metascreen({id:154,icon:V`
      | > |
      |   |
      |   |`,tile:[" c | > |   "," > |   |   "],tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],edges:"c   ",connect:"2",exits:[Mg(23)],match:a=>!a(264,120)&&a(-48,120)});this.deadEndS_stairs=this.metascreen({id:154,icon:V`
      |   |
      |   |
      | < |`,tile:["   | < | c ","   |   | < "],tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],edges:"  c ",connect:"a",exits:[Lg(215)],match:a=>!a(-48,120)&&a(264,120)});this.deadEndNS=this.metascreen({id:155,icon:V`
      | \u2575 |
      |   |
      ...
      | \u2502 |
      | \u2502 |
      | \u257d |`,tile:" c | c | n ",tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},edges:"c n ",connect:"2a",exits:[Og()]});this.hallNS_entrance_unreachable=this.metascreen({id:158,icon:V`\n|   |\n|   |\n|   |`,tilesets:{cave:{},fortress:{},pyramid:{},iceCave:{}},feature:["empty"],placement:"manual",match:a=>!a(128,128),delete:!0});this.channelExitSE=this.metascreen({id:159,icon:V`
      |   |
      | \u2554\u2550|
      | \u2551 |`,tilesets:{dolphinCave:{}},feature:["river"],edges:"  rr",exits:[Og({left:5})]});this.channelBendWS=this.metascreen({id:160,icon:V`
      |\u2588  |
      |\u2550\u2557 |
      ...
      |   |
      | \u2554\u2508|
      |\u2577\u2551 |`,tilesets:{dolphinCave:{}},feature:["river","bridge"],exits:[Og({left:2})],wall:124,edges:"  rr"});this.channelCross=this.metascreen({id:163,icon:V`
      | \u2551 |
      |\u2550\u256c\u2550|
      |\u2577\u2551\u2577|`,tilesets:{dolphinCave:{}},feature:["river"],exits:[Og({left:3}),Og({left:11,type:"door"})],edges:"  rr"});this.channelDoor=this.metascreen({id:164,icon:V`\u2229
      | \u2229\u2588|
      |\u2508\u2550\u2550|
      ...
      |\u2588\u2588\u2588|
      |\u2588  |
      |\u2588 \u2588|`,tile:"   | pp| p ",tilesets:{mountain:{},mountainRiver:{}},edges:"  pp",connect:"ae",exits:[Rg({top:6,height:4}),Og({left:6,width:4})]});this.mountainDeadEndW_caveEmpty=this.metascreen({id:170,icon:V`\u2229
      |\u2588\u2229\u2588|
      |\u2590 \u2590|
      |\u2588\u2588\u2588|`,tile:"   |p< |   ",tilesets:{mountain:{},mountainRiver:{}},edges:" p  ",connect:"6",exits:[Ng(56)]});this.mountainPathNE=this.metascreen({id:171,icon:V`\u2514
      |\u2588 \u2588|
      |\u2588  |
      |\u2588\u2588\u2588|`,tile:" p | pp|   ",tilesets:{mountain:{},mountainRiver:{}},edges:"p  p",connect:"2e",exits:[Rg({top:6,height:4}),Y({left:6,width:4})]});this.mountainBranchWSE=this.metascreen({id:172,icon:V`\u252c
      |\u2588\u2588\u2588|
      |   |
      |\u2588 \u2588|`,tile:"   |ppp| p ",tilesets:{mountain:{},mountainRiver:{}},edges:" ppp",connect:"6ae"});this.mountainPathW_cave=this.metascreen({id:173,icon:V`\u2229
      |\u2588\u2229\u2588|
      |  \u2590|
      |\u2588\u2588\u2588|`,tile:"   |p< |   ",tilesets:{mountain:{},mountainRiver:{}},edges:" p  ",connect:"6",exits:[Ng(85)]});this.mountainPathE_slopeS=this.metascreen({id:174,icon:V`\u2553
      |\u2588\u2588\u2588|
      |\u2588  |
      |\u2588\u2193\u2588|`,tile:"   | pp| \u2193 ",tilesets:{mountain:{}},edges:"  sp",connect:"ae"});this.mountainPathNW=this.metascreen({id:175,icon:V`\u2518
      |\u2588 \u2588|
      |  \u2588|
      |\u2588\u2588\u2588|`,tile:" p |pp |   ",tilesets:{mountain:{},mountainRiver:{}},edges:"pp  ",connect:"26",exits:[Qg({top:6,height:4}),Y({left:6,width:4})]});this.mountainCave_empty=this.metascreen({id:176,icon:V`\u2229
      |\u2588\u2229\u2588|
      |\u258c \u2590|
      |\u2588\u2588\u2588|`,tile:"   | < |   ",tilesets:{mountain:{},mountainRiver:{}},edges:"    ",connect:"",exits:[Ng(88)]});this.mountainPathE_cave=this.metascreen({id:177,icon:V`\u2229
      |\u2588\u2229\u2588|
      |\u2588  |
      |\u2588\u2588\u2588|`,tile:"   | <p|   ",tilesets:{mountain:{},mountainRiver:{}},edges:"   p",connect:"e",exits:[Ng(87)]});this.mountainPathWE_slopeN=this.metascreen({id:178,icon:V`\u2568
      |\u2588\u2193\u2588|
      |   |
      ...
      |\u2588\u2588\u2588|
      |   |
      |\u2588\u2588\u2588|`,tile:"   |ppp|   ",tilesets:{mountain:{},mountainRiver:{}},edges:" p p",connect:"6e",exits:[Qg({top:6,height:4}),Rg({top:6,height:4})]});this.mountainArena_gate=this.metascreen({id:181,icon:V`#
      |\u2588#\u2588|
      |\u258c \u2590|
      |\u2588\u250b\u2588|`,tile:"   | < | / ",tilesets:{mountain:{},mountainRiver:{}},feature:["arena"],edges:"  l ",connect:"a",exits:[Object.assign({},Lg(71,3),{type:"gate"})],flag:"custom:false"});this.mountainPathN_slopeS_cave=this.metascreen({id:182,icon:V`\u2229
      |\u2588\u250b\u2229|
      |\u258c \u2590|
      |\u2588\u2193\u2588|`,tile:" / | < | \u2193 ",tilesets:{mountain:{}},edges:"l s ",connect:"2a",exits:[Ng(90),Y()]});this.mountainPathWE_slopeNS=this.metascreen({id:183,icon:V`\u256b
      |\u2588\u2193\u2588|
      |   |
      |\u2588\u2193\u2588|`,tile:" \u2193 |ppp| \u2193 ",tilesets:{mountain:{}},edges:"spsp",connect:"26ae"});this.mountainPathWE_slopeN_cave=this.metascreen({id:184,icon:V`\u2229
      |\u2588\u2193\u2229|
      |   |
      |\u2588\u2588\u2588|`,tile:" \u2193 |p<p|   ",tilesets:{mountain:{}},edges:"sp p",connect:"26e",exits:[Ng(92)]});this.mountainPathWS=this.metascreen({id:185,icon:V`\u2510
      |\u2588\u2588\u2588|
      |  \u2588|
      |\u2588 \u2588|`,tile:"   |pp | p ",tilesets:{mountain:{},mountainRiver:{}},edges:" pp ",connect:"6a",exits:[Qg({top:6,height:4}),Og({left:6,width:4})]});this.mountainSlope=this.metascreen({id:186,icon:V`\u2193
      |\u2588\u2193\u2588|
      |\u2588\u2193\u2588|
      ...
      |\u2588\u2229\u2588|
      |\u2588  |
      |\u2588\u2588\u2588|`,tile:"   | <p|   ",tilesets:{mountain:{}},edges:"   p",connect:"e",exits:[Ng(87,"gate")]});this.mountainPathWE_inn=this.metascreen({id:188,icon:V`\u2229
      |\u2588\u2229\u2588|
      |   |
      ...
      |\u2588\u2193\u2588|
      | \u2550 |
      |\u2588\u2193\u2588|`,tile:" \u2193 |ppp| \u2193 ",tilesets:{mountain:{}},edges:"spsp",connect:"6e",exits:[Sg(182,4)]});this.mountainPathWE_bridgeOverRiver=this.metascreen({id:189,icon:V`\u2550
      |\u2588\u2551\u2588|
      | \u2550 |
      ...
      |\u2588\u2193\u2588|
      | \u2550 |
      |\u2588\u2193\u2588|`,tile:" \u2193 |p\u2193p| \u2193 ",placement:"manual",tilesets:{mountain:{}},edges:"spsp",connect:"2a",exits:[Tg(198,4)]});this.mountainEmpty=this.metascreen({id:191,icon:V`
      |\u2588\u2588\u2588|
      |\u2588\u2588\u2588|
      ...
      |\u2588\u2588\u2588|
      |\u2580\u2229\u2580|
      |   |`,tile:"   |o<o|ooo",tilesets:{grass:{},sea:{},desert:{},river:{requires:[G.SeaCaveEntrance]}},edges:" vov",exits:[Ng(73)]});this.cornerSE_cave=this.metascreen({id:194,icon:V`
      | \u2590\u2588|
      |\u2584\u2229\u2588|
      |\u2588\u2588\u2588|`,tile:"oo |o< |   ",tilesets:{grass:{},river:{},sea:{},desert:{}},edges:"<^  ",exits:[Ng(90)]});this.waterfall=this.metascreen({id:195,icon:V`
      |   |
      |\u2193\u2193\u2193|
      ...
      |\u2597\u259f\u2588|
      |\u2590\u2229\u259b|
      |\u259d\u2580\u2598|`,placement:"manual",tile:"oo |oLo|ooo",tilesets:{sea:{}},feature:["lighthouse"],edges:"<oov",exits:[Ng(42),W(117)]});this.beachCave=this.metascreen({id:200,icon:V`
      |\u2588\u2229\u2588|
      |\u2580\u2572\u2588|
      |   |`,placement:"manual",tile:"   |o<o|ooo",tilesets:{sea:{}},edges:" vov",exits:[Ng(40)]});this.beachCabinEntrance=this.metascreen({id:201,icon:V`
      | \u2229\u2588|
      | \u2572\u2580|
      |\u2588\u2584\u2584|`,placement:"manual",tile:"oo |oC8|   ",tilesets:{sea:{}},feature:["cabin"],edges:"<^ b",exits:[W(85),Rg({top:8,height:3})]});this.oceanShrine=this.metascreen({id:202,icon:V`
      |\u2597\u2584\u2596|
      |\u2590*\u258c|
      ...
      | \u2584 |
      |\u259f\u2229\u2599|
      | \u2573 |`,placement:"manual",tile:"ooo|oPo|ooo",tilesets:{desert:{}},feature:["pyramid"],edges:"oooo",exits:[Ng(167,"fortress")]});this.cryptEntrance=this.metascreen({id:204,icon:V`
      | \u2573 |
      |\u2590>\u258c|
      |\u259d\u2580\u2598|`,placement:"manual",tile:"ooo|oYo|ooo",tilesets:{desert:{}},feature:["crypt"],edges:"oooo",exits:[Mg(103)]});this.oasisLake=this.metascreen({id:205,icon:V`
      | ^ |
      |vOv|
      ...
      |\u2597\u2584\u2596|
      |\u259c\u2229\u259b|
      | \u2573 |`,tile:"ooo|o<o|ooo",tilesets:{desert:{},sea:{requires:[G.SeaCaveEntrance]}},edges:"oooo",exits:[Ng(167)]});this.oasisCave=this.metascreen({id:207,icon:V`
      | vv|
      |\u2584\u2229v|
      |\u2588\u258c |`,placement:"manual",tile:"oro|o<o| oo",tilesets:{desert:{}},edges:"3^>o",exits:[Lg(55)]});this.channelEndW_cave=this.metascreen({id:208,icon:V`
      |\u2588\u2588\u2229|
      |\u2550\u2550 |
      |\u2588\u2588\u2588|`,tile:"   |r< |   ",tilesets:{dolphinCave:{}},feature:["river"],exits:[Lg(87)]});this.boatChannel=this.metascreen({id:209,icon:V`
      |\u2588\u2588\u2588|
      |\u2580\u2580\u2580|
      |\u2584\u2584\u2584|`,tile:["   |888|   ","   |88x|   "],tilesets:{sea:{}},edges:" b b",exits:[Object.assign({},Rg({top:8,height:3}),{entrance:40168}),Qg({top:8,height:3})]});this.channelWE=this.metascreen({id:210,icon:V`
      |\u2588\u2588\u2588|
      |\u2550\u2550\u2550|
...
["A",a.metascreens.riverCaveNWE],["B",a.metascreens.riverCaveWSE],["L",a.metascreens.riverCaveNS])});this.riverCaveNS_blockedRight=this.metascreen({id:245,icon:V`
      ...
      |&<&|
      |\u2502 \u2502|
      |\u2514\u252c\u2518|`,tile:"   | a | c ",tilesets:{pyramid:{}},feature:["arena"],edges:"  c ",connect:"a",exits:[Object.assign({},Lg(87),{type:"crypt"})],flag:"custom:false",arena:2});this.pyramidArena_draygon=this.metascreen({id:249,icon:V`
      |\u250c\u2500\u2510|
      |\u2502\u2573\u2502|
      ...
      | \u2503 |
      | \u2503 |
      | \u257f |`,tile:" w | w | x ",tilesets:{pyramid:{}},edges:"w n ",connect:"2a",exits:[Og()]});this.cryptTeleporter=this.metascreen({id:252,tilesets:{pyramid:{},tower:{}},exits:[Og({left:6,width:4}),Ng(87,"teleporter")]});this.fortressArena_through=this.metascreen({id:253,icon:V`\u257d
      |\u250c\u2534\u2510|
      |\u2502 \u2502|
...
gc(a,[yh],"CheckToItemGetMap");this.exportDigits(a,"CHECK_COUNT",this.checkCount);this.exportDigits(a,"MIMIC_COUNT",this.mimicCount);a.byte(...this);return[a.module()]}};const {$0e:Ah,$fe:Bh,$ff:Ch}=y;var Dh,Eh=Dh||(Dh={});Eh[Eh.TORNEL=0]="TORNEL";Eh[Eh.ZEBU=1]="ZEBU";Eh[Eh.ASINA=2]="ASINA";Eh[Eh.KENSU=3]="KENSU";var Fh,Gh=Fh||(Fh={});Gh[Gh.INSUFFICIENT_MAGIC=0]="INSUFFICIENT_MAGIC";Gh[Gh.FREE_MAGIC=1]="FREE_MAGIC";Gh[Gh.IGNORED=2]="IGNORED";Gh[Gh.DEFAULT=3]="DEFAULT";
...
;class Th{constructor(a){this.rom=a;this.locations=Eb(a.prg,Uh.offset,16)}write(){const a=this.rom.assembler();Uh.loc(a);a.label("WildWarpLocations");a.byte(...this.locations);a.org(52185);a.instruction("lda","WildWarpLocations,y");return[a.module()]}}const Uh=B.of(y.$fe,52204);const {$0e:Vh,$0f:Wh,$10:Xh}=y;
