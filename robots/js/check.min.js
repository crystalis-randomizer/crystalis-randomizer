...
161840,23));document.getElementById("flags").textContent=f;a=(read(a,161925,4)+read(a,161926,4)).toLowerCase();document.getElementById("checksum").textContent=a;b=`flags=${f.replace(/ /g,"")}&seed=${b}&crc=${a}`;document.getElementById("query").textContent=b;d=`https://crystalisrandomizer.com/${/\./.test(d)?d:`sha/${d}`}/#${b}`;b=document.getElementById("permalink");b.href=d;b.textContent=d});e.readAsArrayBuffer(c)});
