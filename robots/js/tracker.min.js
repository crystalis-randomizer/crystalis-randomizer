...
function assert$$module$js$util(a){if(!a)throw Error(`asserted but falsy: ${a}`);return a}function isNonNull$$module$js$util(a){return null!=a}var module$js$util={};module$js$util.Deque=Deque$$module$js$util;module$js$util.breakLines=breakLines$$module$js$util;module$js$util.UsageError=UsageError$$module$js$util;module$js$util.SuffixTrie=SuffixTrie$$module$js$util;module$js$util.DefaultMap=DefaultMap$$module$js$util;module$js$util.IndexedSet=IndexedSet$$module$js$util;module$js$util.iters=iters$$module$js$util;
module$js$util.SetMultimap=SetMultimap$$module$js$util;module$js$util.Multiset=Multiset$$module$js$util;module$js$util.assertNever=assertNever$$module$js$util;module$js$util.assert=assert$$module$js$util;module$js$util.isNonNull=isNonNull$$module$js$util;const REPEATABLE_FLAGS$$module$js$flagset=new Set(["S"]),PRESETS$$module$js$flagset=[{title:"Casual",descr:"Basic flags for a relatively easy playthrough.",flags:"Ds Edmrsx Fw Mr Rp Sc Sk Sm Tab"},{title:"Intermediate",descr:"Slightly more challenge than Casual but still approachable.",flags:"Ds Edms Fsw Gt Mr Ps Rpt Sct Skm Tab",default:!0},{title:"Full Shuffle",descr:"Slightly harder than intermediate, with full shuffle and no spoiler log.",flags:"Em Fsw Gt Mert Ps Rprt Sckmt Tabmp Wmtuw Xegw"},
{title:"Glitchless",descr:"Full shuffle but with no glitches.",flags:"Em Fcpstw Mert Ps Rprt Sckmt Tab Wmtuw Xcegw"},{title:"Advanced",descr:"A balanced randomization with quite a bit more difficulty.",flags:"Fsw Gfprt Hbdgw Mert Ps Roprst Sckt Sm Tabmp Wmtuw Xcegw"},{title:"Ludicrous",descr:"Pulls out all the stops, may require superhuman feats.",flags:"Fs Gcfprtw Hbdgmswxz Mert Ps Roprst Sckmt Tabmp Wmtuw Xcegw"},{title:"Mattrick",descr:"Not for the faint of heart. Good luck...",flags:"Fcprsw Gt Hbdhwx Mert Ps Ropst Sckmt Tabmp Wmtuw"},
{title:"Tournament: Swiss Round",descr:"Quick-paced full-shuffle flags for Swiss round of 2019 Tournament",flags:"Es Fcprsw Gt Hd Mr Ps Rpt Sckmt Tab"},{title:"Tournament: Elimination Round",descr:"More thorough flags for the first elimination rounds of the 2019 Tournament",flags:"Em Fprsw Gft Hbd Mer Ps Rprst Sckmt Tab Wt"},{title:"Tournament: Semifinals",descr:"Advanced flags for semifinal round of the 2019 Tournament",flags:"Em Fsw Gft Hbd Mert Ps Roprst Sckmt Tab Wt"},{title:"Tournament: Finals",
descr:"Expert flags for finals round of the 2019 Tournament",flags:"Fsw Gfprt Hbdw Mert Ps Roprst Sckmt Tab Wmtw"}],PRESETS_BY_KEY$$module$js$flagset={};for(const {title:a,flags:b}of PRESETS$$module$js$flagset)PRESETS_BY_KEY$$module$js$flagset[`@${a.replace(/ /g,"").toLowerCase()}`]=b;
const FLAGS$$module$js$flagset=[ITEM_FLAGS$$module$js$flags$items,WORLD_FLAGS$$module$js$flags$world,MONSTER_FLAGS$$module$js$flags$monsters,SHOP_FLAGS$$module$js$flags$shops,HARD_MODE_FLAGS$$module$js$flags$hard_mode,TWEAK_FLAGS$$module$js$flags$tweaks,ROUTING_FLAGS$$module$js$flags$routing,GLITCH_FLAGS$$module$js$flags$glitches,GLITCH_FIX_FLAGS$$module$js$flags$glitch_fixes,EASY_MODE_FLAGS$$module$js$flags$easy_mode,EXPERIMENTAL_FLAGS$$module$js$flags$experimental,DEBUG_MODE_FLAGS$$module$js$flags$debug_mode];
...
const DIALOG_FLAGS$$module$js$rom$util=new FlagListType$$module$js$rom$util(64,128),ITEM_GET_FLAGS$$module$js$rom$util=new FlagListType$$module$js$rom$util(64,128),ITEM_USE_FLAGS$$module$js$rom$util=new FlagListType$$module$js$rom$util(64,128),SPAWN_CONDITION_FLAGS$$module$js$rom$util=new FlagListType$$module$js$rom$util(128,32);
...
module$js$rom$util.writeLittleEndian=writeLittleEndian$$module$js$rom$util;module$js$rom$util.writeString=writeString$$module$js$rom$util;module$js$rom$util.write=write$$module$js$rom$util;module$js$rom$util.FlagListType=FlagListType$$module$js$rom$util;module$js$rom$util.DIALOG_FLAGS=DIALOG_FLAGS$$module$js$rom$util;module$js$rom$util.ITEM_GET_FLAGS=ITEM_GET_FLAGS$$module$js$rom$util;module$js$rom$util.ITEM_USE_FLAGS=ITEM_USE_FLAGS$$module$js$rom$util;module$js$rom$util.SPAWN_CONDITION_FLAGS=SPAWN_CONDITION_FLAGS$$module$js$rom$util;
...
g&&("traps"===c?g.endState.traps++:"chest"===c?g.endState.chest++:g.endState.misc++);return!1};for(var v of l){const [a,b]=v;if(a.isMimic()&&!x(a,b,"traps"))return!1}for(const a of l){const [b,c]=a;if(b.needsChest()&&!x(b,c,"chest"))return!1}for(const a of l){const [b,c]=a;if(!x(b,c))return!1}for(const a of t){const [b,c]=a;b.set(...c)}const {win:z,path:Y}=a.traverse({wanted:k,dfs:!1});if(!z)return g&&g.endState.no_win++,!1;c&&a.write();if(!e)return!0;g&&(g.endState.success++,g.analyze(a,b,q));e.items=
...
a(46);a.LEATHER_BOOTS=a(47);a.SHIELD_RING=a(48);a.ALARM_FLUTE=a(49);a.WINDMILL_KEY=a(50);a.KEY_TO_PRISON=a(51);a.KEY_TO_STYX=a(52);a.FOG_LAMP=a(53);a.SHELL_FLUTE=a(54);a.EYE_GLASSES=a(55);a.BROKEN_STATUE=a(56);a.GLOWING_LAMP=a(57);a.STATUE_OF_GOLD=a(58);a.LOVE_PENDANT=a(59);a.KIRISA_PLANT=a(60);a.IVORY_STATUE=a(61);a.BOW_OF_MOON=a(62);a.BOW_OF_SUN=a(63);a.BOW_OF_TRUTH=a(64)})(Item$$module$js$graph$condition||(Item$$module$js$graph$condition={}));var Magic$$module$js$graph$condition;
(function(a){a.REFRESH=Item$$module$js$graph$condition(65);a.PARALYSIS=Item$$module$js$graph$condition(66);a.TELEPATHY=Item$$module$js$graph$condition(67);a.TELEPORT=Item$$module$js$graph$condition(68);a.RECOVER=Item$$module$js$graph$condition(69);a.BARRIER=Item$$module$js$graph$condition(70);a.CHANGE=Item$$module$js$graph$condition(71);a.FLIGHT=Item$$module$js$graph$condition(72)})(Magic$$module$js$graph$condition||(Magic$$module$js$graph$condition={}));var WallType$$module$js$graph$condition;
(function(a){a[a.WIND=0]="WIND";a[a.FIRE=1]="FIRE";a[a.WATER=2]="WATER";a[a.THUNDER=3]="THUNDER"})(WallType$$module$js$graph$condition||(WallType$$module$js$graph$condition={}));
...
1,0),e++;for(;c(b)&32;)b=module$js$graph$geometry.TileId.add(b,-1,0),e++;6>e?a&=-33:9>e&&(a|=64)}return TERRAINS$$module$js$graph$overlay[a]}extraRoutes(){const a=[],b=(a,b)=>{a=this.rom.locations[a];return module$js$graph$geometry.TileId.from(a,a.entrances[void 0===b?0:b])};a.push({tile:b(0)});if(this.flags.teleportOnThunderSword()){const c=this.rom.townWarp.thunderSwordWarp;a.push({tile:b(c[0],c[1]&31),condition:or$$module$js$graph$condition(and$$module$js$graph$condition(module$js$graph$condition.Item.SWORD_OF_THUNDER,
module$js$graph$condition.Capability.BUY_WARP),and$$module$js$graph$condition(module$js$graph$condition.Item.SWORD_OF_THUNDER,module$js$graph$condition.Magic.TELEPORT))})}if(this.flags.assumeWildWarp())for(const c of this.rom.wildWarp.locations)a.push({tile:b(c)});return a}extraEdges(){const a=[];a.push({from:module$js$graph$geometry.TileId(5308552),to:module$js$graph$geometry.TileId(6325896),condition:module$js$graph$condition.Event.RETURNED_FOG_LAMP});return a}trigger(a){function b(a){if(0>a)return~b(~a);
const c=FLAG_MAP$$module$js$graph$overlay.get(a);return null!=c?c[0][0]:a}switch(a){case 154:return{check:[{condition:meet$$module$js$graph$condition(module$js$graph$condition.Event.SHYRON_MASSACRE,this.bossRequirements(this.rom.bosses.mado1)),slot:module$js$graph$condition.Slot(module$js$graph$condition.Boss.MADO1)}]};case 170:return{check:[{condition:and$$module$js$graph$condition(module$js$graph$condition.Event.DWARF_CHILD,module$js$graph$condition.Capability.BUY_WARP),slot:module$js$graph$condition.Slot(module$js$graph$condition.Event.RESCUED_CHILD)}]};
...
FLAG_MAP$$module$js$graph$overlay.get(a)||(this.relevantFlags.has(a)?module$js$graph$condition.Condition(a):[])))});switch(a){case 20:if(b.spawns.find((a)=>a.isNpc()&&21===a.id))return{};case 126:if(b.spawns.find((a)=>a.isNpc()&&107===a.id))return{}}switch(a){case 37:f.hitbox={x0:0,x1:2,y0:0,y1:1};c(module$js$graph$condition.Magic.CHANGE,module$js$graph$condition.Magic.PARALYSIS);break;case 45:delete f.terrain;break;case 51:c(module$js$graph$condition.Magic.PARALYSIS);break;case 56:223===b.id&&(f.hitbox=
{x0:0,x1:1,y0:2,y1:3});break;case 78:f.hitbox={x0:-1,x1:2,y0:0,y1:1};c(module$js$graph$condition.Magic.CHANGE,module$js$graph$condition.Event.ENTERED_SHYRON);break;case 104:f.hitbox={x0:-1,x1:2,y0:-1,y1:2};break;case 128:c(...e.map((a)=>module$js$graph$condition.Condition(~a)));break;case 133:c(module$js$graph$condition.Item.FLUTE_OF_LIME)}const g=[];var h=(a)=>{0>=a||(a=FLAG_MAP$$module$js$graph$overlay.get(a)||(this.relevantFlags.has(a)?module$js$graph$condition.Condition(a):null),null!=a&&g.push(a))};
for(var k of e)h(k);var l=this.tradeIns.get(a);if(null!=l){k=function(a,...c){c=and$$module$js$graph$condition(...g,b,...c);f.check.push({slot:a,condition:c})};const b=l;l=k;this.tracker&&this.flags.randomizeTrades()&&(l=(a,...b)=>{const c=or$$module$js$graph$condition(...[module$js$graph$condition.Item.STATUE_OF_ONYX,module$js$graph$condition.Item.FOG_LAMP,module$js$graph$condition.Item.LOVE_PENDANT,module$js$graph$condition.Item.KIRISA_PLANT,module$js$graph$condition.Item.IVORY_STATUE].map((a)=>
...
[b]:this.relevantFlags.has(c.condition)?[module$js$graph$condition.Condition(c.condition)]:[];h=and$$module$js$graph$condition(...b,...g);m=FLAG_MAP$$module$js$graph$overlay.get(~c.condition)||(this.relevantFlags.has(~c.condition)?module$js$graph$condition.Condition(~c.condition):null);null!=m&&g.push(m);m=c.message.action;3===m||10===m?f.check.push({slot:module$js$graph$condition.Slot.item(d.data[0]),condition:h}):17===m||this.flags.zebuStudentGivesItem()&&9===m?f.check.push({slot:module$js$graph$condition.Slot.item(d.data[1]),
condition:h}):16===m?f.check.push({slot:module$js$graph$condition.Slot(module$js$graph$condition.Magic.RECOVER),condition:h}):8===m&&45===a&&f.check.push({slot:module$js$graph$condition.Slot(module$js$graph$condition.Event.OPENED_SWAN),condition:h});for(const a of c.flags)(m=(m=FLAG_MAP$$module$js$graph$overlay.get(a))?m:this.relevantFlags.has(a)?module$js$graph$condition.Condition(a):null)&&f.check.push({slot:module$js$graph$condition.Slot(m),condition:h});if(b.length&&e.includes(c.condition))break}return f}capabilities(){var a=
...
b=e(module$js$graph$condition.Item.SWORD_OF_FIRE);c=e(module$js$graph$condition.Item.SWORD_OF_WATER);d=e(module$js$graph$condition.Item.SWORD_OF_THUNDER)}a=[[module$js$graph$condition.Event.START,and$$module$js$graph$condition()],[module$js$graph$condition.Capability.SWORD,module$js$graph$condition.Item.SWORD_OF_WIND,module$js$graph$condition.Item.SWORD_OF_FIRE,module$js$graph$condition.Item.SWORD_OF_WATER,module$js$graph$condition.Item.SWORD_OF_THUNDER],[module$js$graph$condition.Capability.BREAK_STONE,
a],[module$js$graph$condition.Capability.BREAK_ICE,b],[module$js$graph$condition.Capability.FORM_BRIDGE,c],[module$js$graph$condition.Capability.BREAK_IRON,d],[module$js$graph$condition.Capability.MONEY,module$js$graph$condition.Capability.SWORD],[module$js$graph$condition.Capability.CLIMB_WATERFALL,module$js$graph$condition.Magic.FLIGHT],[module$js$graph$condition.Capability.SHOOTING_STATUE,module$js$graph$condition.Magic.BARRIER],[module$js$graph$condition.Capability.CLIMB_SLOPE,module$js$graph$condition.Item.RABBIT_BOOTS,
module$js$graph$condition.Magic.FLIGHT],[module$js$graph$condition.Item.STATUE_OF_GOLD,and$$module$js$graph$condition(module$js$graph$condition.Item.BROKEN_STATUE,module$js$graph$condition.Item.GLOWING_LAMP)],[module$js$graph$condition.Event.OPENED_SEALED_CAVE,module$js$graph$condition.Event.STARTED_WINDMILL]];this.flags.assumeGhettoFlight()&&a.push([module$js$graph$condition.Capability.CLIMB_WATERFALL,and$$module$js$graph$condition(module$js$graph$condition.Event.RIDE_DOLPHIN,module$js$graph$condition.Item.RABBIT_BOOTS)]);
this.flags.fogLampNotRequired()&&a.push([module$js$graph$condition.Event.RIDE_DOLPHIN,module$js$graph$condition.Item.SHELL_FLUTE]);this.flags.guaranteeBarrier()||a.push([module$js$graph$condition.Capability.SHOOTING_STATUE,and$$module$js$graph$condition(module$js$graph$condition.Capability.MONEY,module$js$graph$condition.Capability.BUY_HEALING),and$$module$js$graph$condition(module$js$graph$condition.Capability.MONEY,module$js$graph$condition.Item.SHIELD_RING),and$$module$js$graph$condition(module$js$graph$condition.Capability.MONEY,
module$js$graph$condition.Magic.REFRESH)]);this.flags.leatherBootsGiveSpeed()&&a.push([module$js$graph$condition.Capability.CLIMB_SLOPE,module$js$graph$condition.Item.LEATHER_BOOTS]);for(const b of this.rom.bosses)null!=b.kill&&null!=b.drop&&a.push([module$js$graph$condition.Item(b.drop),module$js$graph$condition.Boss(b.flag)]);a.push([module$js$graph$condition.Item.ORB_OF_WATER,module$js$graph$condition.Boss.RAGE]);this.flags.guaranteeGasMask()?a.push([module$js$graph$condition.Capability.TRAVEL_SWAMP,
...
65<=b)return Type$$module$js$graph$shuffle.MAGIC;const f=a.items[b];return d.has(b)?f&&f.unique?Type$$module$js$graph$shuffle.KEY:Type$$module$js$graph$shuffle.CONSUMABLE:e.has(b)?Type$$module$js$graph$shuffle.BOSS_DROP:103===b?Type$$module$js$graph$shuffle.NPC:f&&f.unique?Type$$module$js$graph$shuffle.NPC:Type$$module$js$graph$shuffle.EMPTY});b=b.get("S")||[];for(f=0;f<b.length;f++)g=b[f],/c/.test(g)&&this.pools.set(Type$$module$js$graph$shuffle.CONSUMABLE,f+1),/t/.test(g)&&this.pools.set(Type$$module$js$graph$shuffle.MIMIC,
f+1),/k/.test(g)&&(this.pools.set(Type$$module$js$graph$shuffle.KEY,f+1),this.pools.set(Type$$module$js$graph$shuffle.BOSS_DROP,f+1),this.pools.set(Type$$module$js$graph$shuffle.NPC,f+1)),/m/.test(g)&&(this.pools.set(Type$$module$js$graph$shuffle.MAGIC,f+1),this.pools.set(Type$$module$js$graph$shuffle.TRIGGER,f+1))}fits(a,b){if(a===b)return!0;const c=this.slotTypes[a]||Type$$module$js$graph$shuffle.EMPTY;a=this.pools.get(c);if(null==a||requiresChest$$module$js$graph$shuffle(b)&&c>=Type$$module$js$graph$shuffle.BOSS_DROP)return!1;
if(112<=b){if(c>Type$$module$js$graph$shuffle.KEY)return!1;b=this.pools.get(Type$$module$js$graph$shuffle.MIMIC)}else if(72>=b&&65<=b)b=this.pools.get(Type$$module$js$graph$shuffle.MAGIC);else if(65>b&&this.rom.items[b].unique)b=this.pools.get(Type$$module$js$graph$shuffle.KEY);else if(null==this.pools.get(Type$$module$js$graph$shuffle.CONSUMABLE)&&this.slotTypes[b]===Type$$module$js$graph$shuffle.BOSS_DROP)b=this.pools.get(Type$$module$js$graph$shuffle.BOSS_DROP);else{if(c===Type$$module$js$graph$shuffle.TRIGGER)return!1;
b=this.pools.get(Type$$module$js$graph$shuffle.CONSUMABLE)}return null==b?!1:a===b?!0:b===this.pools.get(Type$$module$js$graph$shuffle.CONSUMABLE)}shouldShuffle(a){return null!=this.pools.get(this.slotTypes[a]||0)}isEarly(a){a=this.slotTypes[a]||Type$$module$js$graph$shuffle.EMPTY;if(a>=Type$$module$js$graph$shuffle.TRIGGER)return!0;a=this.pools.get(a);const b=this.pools.get(Type$$module$js$graph$shuffle.CONSUMABLE),c=this.pools.get(Type$$module$js$graph$shuffle.MIMIC);return a!==b&&a!==c}}
...
var z=BITCOUNT$$module$js$maze$spec[q]+(l.has(E)?1:0);154===v&&(z=2);if(155===v||156==v||240==v||241==v)z=1;1===z&&c++;2<z&&(d+=z-2);z=this.walls.get(v);"wall"===z&&e++;"bridge"===z&&f++;z=this.fixedTiles.get(v);this.deadEndTiles.has(v)&&(q=0);for(var Y of module$js$maze$types.Dir.ALL)if(q&x&1<<Y){v=null;for(var Z=0;Z<a.entrances.length;Z++)if(a.entrances[Z].screen===E&&matchesDir$$module$js$maze$spec(a.entrances[Z].tile,Y)){v=Z;break}if(null!=v){Z=u.get(v);if(null==Z)throw Error("Could not find exit");
m.set(E,{entrance:v,exit:Z,dir:Y})}}null!=z&&n.set(E,z)}if(g)for(const [a,b]of n)29046===b.edges&&(Y=q.find((a)=>459009===a.edges))&&n.set(a,Y);if(h!=k)throw Error("Found inconsistent use of wide tiles");return{size:b,rivers:g,deadEnds:c,branches:d,walls:e,bridges:f,stairs:l,edges:m,fixed:n,tiles:p,wide:h,specs:q,specSet:this}}}SpecSet$$module$js$maze$spec.CAVE=new SpecSet$$module$js$maze$spec(ALL_CAVE_SCREENS$$module$js$maze$spec,EMPTY_CAVE_SCREEN$$module$js$maze$spec);
...
Object.assign({},{area:(a)=>a.MtSabreWest},CAVE$$module$js$rom$location));this.CordelPlainWest=$$$module$js$rom$location(20,{area:(a)=>a.CordelPlain});this.CordelPlainEast=$$$module$js$rom$location(21);this.Brynmaer=$$$module$js$rom$location(24,{area:(a)=>a.Brynmaer});this.OutsideStomHouse=$$$module$js$rom$location(25,{area:(a)=>a.StomHouse,music:0});this.Swamp=$$$module$js$rom$location(26,{area:(a)=>a.Swamp,bossScreen:124});this.Amazones=$$$module$js$rom$location(27,{area:(a)=>a.Amazones});this.Oak=
$$$module$js$rom$location(28,{area:(a)=>a.Oak});this.StomHouse=$$$module$js$rom$location(30,{area:(a)=>a.StomHouse});this.MtSabreWest_Lower=$$$module$js$rom$location(32,{area:(a)=>a.MtSabreWest});this.MtSabreWest_Upper=$$$module$js$rom$location(33);this.MtSabreWest_Cave2=$$$module$js$rom$location(34,CAVE$$module$js$rom$location);this.MtSabreWest_Cave3=$$$module$js$rom$location(35,CAVE$$module$js$rom$location);this.MtSabreWest_Cave4=$$$module$js$rom$location(36,CAVE$$module$js$rom$location);this.MtSabreWest_Cave5=
$$$module$js$rom$location(37,CAVE$$module$js$rom$location);this.MtSabreWest_Cave6=$$$module$js$rom$location(38,CAVE$$module$js$rom$location);this.MtSabreWest_Cave7=$$$module$js$rom$location(39,CAVE$$module$js$rom$location);this.MtSabreNorth_Main=$$$module$js$rom$location(40,{area:(a)=>a.MtSabreNorth,bossScreen:181});this.MtSabreNorth_Middle=$$$module$js$rom$location(41);this.MtSabreNorth_Cave2=$$$module$js$rom$location(42,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave3=$$$module$js$rom$location(43,
CAVE$$module$js$rom$location);this.MtSabreNorth_Cave4=$$$module$js$rom$location(44,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave5=$$$module$js$rom$location(45,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave6=$$$module$js$rom$location(46,CAVE$$module$js$rom$location);this.MtSabreNorth_PrisonHall=$$$module$js$rom$location(47,CAVE$$module$js$rom$location);this.MtSabreNorth_LeftCell=$$$module$js$rom$location(48,CAVE$$module$js$rom$location);this.MtSabreNorth_LeftCell2=$$$module$js$rom$location(49,
CAVE$$module$js$rom$location);this.MtSabreNorth_RightCell=$$$module$js$rom$location(50,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave8=$$$module$js$rom$location(51,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave9=$$$module$js$rom$location(52,CAVE$$module$js$rom$location);this.MtSabreNorth_SummitCave=$$$module$js$rom$location(53,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave1=$$$module$js$rom$location(56,CAVE$$module$js$rom$location);this.MtSabreNorth_Cave7=$$$module$js$rom$location(57,
CAVE$$module$js$rom$location);this.Nadare_Inn=$$$module$js$rom$location(60,Object.assign({},{area:(a)=>a.Nadare},HOUSE$$module$js$rom$location));this.Nadare_ToolShop=$$$module$js$rom$location(61,HOUSE$$module$js$rom$location);this.Nadare_BackRoom=$$$module$js$rom$location(62,HOUSE$$module$js$rom$location);this.WaterfallValleyNorth=$$$module$js$rom$location(64,{area:(a)=>a.WaterfallValley});this.WaterfallValleySouth=$$$module$js$rom$location(65);this.LimeTreeValley=$$$module$js$rom$location(66,{area:(a)=>
a.LimeTreeValley,music:0});this.LimeTreeLake=$$$module$js$rom$location(67,{area:(a)=>a.LimeTreeLake,music:0});this.KirisaPlantCave1=$$$module$js$rom$location(68,{area:(a)=>a.KirisaPlantCave});this.KirisaPlantCave2=$$$module$js$rom$location(69);this.KirisaPlantCave3=$$$module$js$rom$location(70);this.KirisaMeadow=$$$module$js$rom$location(71,{area:(a)=>a.KirisaMeadow});this.FogLampCave1=$$$module$js$rom$location(72,{area:(a)=>a.FogLampCave});this.FogLampCave2=$$$module$js$rom$location(73);this.FogLampCave3=
$$$module$js$rom$location(74);this.FogLampCaveDeadEnd=$$$module$js$rom$location(75);this.FogLampCave4=$$$module$js$rom$location(76);this.FogLampCave5=$$$module$js$rom$location(77);this.FogLampCave6=$$$module$js$rom$location(78);this.FogLampCave7=$$$module$js$rom$location(79);this.Portoa=$$$module$js$rom$location(80,{area:(a)=>a.Portoa});this.Portoa_FishermanIsland=$$$module$js$rom$location(81,{area:(a)=>a.FishermanHouse,music:0});this.MesiaShrine=$$$module$js$rom$location(82,Object.assign({},{area:(a)=>
a.LimeTreeLake},MESIA$$module$js$rom$location));this.WaterfallCave1=$$$module$js$rom$location(84,{area:(a)=>a.WaterfallCave});this.WaterfallCave2=$$$module$js$rom$location(85);this.WaterfallCave3=$$$module$js$rom$location(86);this.WaterfallCave4=$$$module$js$rom$location(87);this.TowerEntrance=$$$module$js$rom$location(88,{area:(a)=>a.Tower});this.Tower1=$$$module$js$rom$location(89);this.Tower2=$$$module$js$rom$location(90);this.Tower3=$$$module$js$rom$location(91);this.TowerOutsideMesia=$$$module$js$rom$location(92);
this.TowerOutsideDyna=$$$module$js$rom$location(93);this.TowerMesia=$$$module$js$rom$location(94,MESIA$$module$js$rom$location);this.TowerDyna=$$$module$js$rom$location(95,DYNA$$module$js$rom$location);this.AngrySea=$$$module$js$rom$location(96,{area:(a)=>a.AngrySea});this.BoatHouse=$$$module$js$rom$location(97);this.JoelLighthouse=$$$module$js$rom$location(98,{area:(a)=>a.Lighthouse,music:0});this.UndergroundChannel=$$$module$js$rom$location(100,{area:(a)=>a.UndergroundChannel});this.ZombieTown=
$$$module$js$rom$location(101,{area:(a)=>a.ZombieTown});this.EvilSpiritIsland1=$$$module$js$rom$location(104,{area:(a)=>a.EvilSpiritIslandEntrance,music:1});this.EvilSpiritIsland2=$$$module$js$rom$location(105,{area:(a)=>a.EvilSpiritIsland});this.EvilSpiritIsland3=$$$module$js$rom$location(106);this.EvilSpiritIsland4=$$$module$js$rom$location(107);this.SaberaPalace1=$$$module$js$rom$location(108,{area:(a)=>a.SaberaFortress,bossScreen:253});this.SaberaPalace2=$$$module$js$rom$location(109);this.SaberaPalace3=
$$$module$js$rom$location(110,{bossScreen:253});this.JoelSecretPassage=$$$module$js$rom$location(112,{area:(a)=>a.JoelPassage});this.Joel=$$$module$js$rom$location(113,{area:(a)=>a.Joel});this.Swan=$$$module$js$rom$location(114,{area:(a)=>a.Swan,music:1});this.SwanGate=$$$module$js$rom$location(115,{area:(a)=>a.SwanGate,music:1});this.GoaValley=$$$module$js$rom$location(120,{area:(a)=>a.GoaValley});this.MtHydra=$$$module$js$rom$location(124,{area:(a)=>a.MtHydra});this.MtHydra_Cave1=$$$module$js$rom$location(125,
CAVE$$module$js$rom$location);this.MtHydra_OutsideShyron=$$$module$js$rom$location(126);this.MtHydra_Cave2=$$$module$js$rom$location(127,CAVE$$module$js$rom$location);this.MtHydra_Cave3=$$$module$js$rom$location(128,CAVE$$module$js$rom$location);this.MtHydra_Cave4=$$$module$js$rom$location(129,CAVE$$module$js$rom$location);this.MtHydra_Cave5=$$$module$js$rom$location(130,CAVE$$module$js$rom$location);this.MtHydra_Cave6=$$$module$js$rom$location(131,CAVE$$module$js$rom$location);this.MtHydra_Cave7=
$$$module$js$rom$location(132,CAVE$$module$js$rom$location);this.MtHydra_Cave8=$$$module$js$rom$location(133,CAVE$$module$js$rom$location);this.MtHydra_Cave9=$$$module$js$rom$location(134,CAVE$$module$js$rom$location);this.MtHydra_Cave10=$$$module$js$rom$location(135,CAVE$$module$js$rom$location);this.Styx1=$$$module$js$rom$location(136,{area:(a)=>a.Styx});this.Styx2=$$$module$js$rom$location(137);this.Styx3=$$$module$js$rom$location(138);this.Shyron=$$$module$js$rom$location(140,{area:(a)=>a.Shyron});
this.Goa=$$$module$js$rom$location(142,{area:(a)=>a.Goa});this.GoaFortressBasement=$$$module$js$rom$location(143,{area:(a)=>a.FortressBasement,music:0});this.Desert1=$$$module$js$rom$location(144,{area:(a)=>a.Desert1});this.OasisCaveMain=$$$module$js$rom$location(145,{area:(a)=>a.OasisCave});this.DesertCave1=$$$module$js$rom$location(146,{area:(a)=>a.DesertCave1,music:0});this.Sahara=$$$module$js$rom$location(147,{area:(a)=>a.Sahara});this.SaharaOutsideCave=$$$module$js$rom$location(148,{music:0});
this.DesertCave2=$$$module$js$rom$location(149,{area:(a)=>a.DesertCave2,music:1});this.SaharaMeadow=$$$module$js$rom$location(150,{area:(a)=>a.SaharaMeadow,music:0});this.Desert2=$$$module$js$rom$location(152,{area:(a)=>a.Desert2});this.Pyramid_Entrance=$$$module$js$rom$location(156,{area:(a)=>a.Pyramid});this.Pyramid_Branch=$$$module$js$rom$location(157);this.Pyramid_Main=$$$module$js$rom$location(158);this.Pyramid_Draygon=$$$module$js$rom$location(159);this.Crypt_Entrance=$$$module$js$rom$location(160,
...
c;this.screens=d;for(const c of this.flags)c.xs+=b,c.ys+=a;for(const c of this.pits)c.fromXs+=b,c.fromYs+=a;for(const c of[...this.spawns,...this.exits])c.xt+=16*b,c.yt+=16*a;for(const c of this.entrances)c.used&&(c.x+=256*b,c.y+=256*a)}writeScreens2d(a,b){const c=a&15;a>>>=4;for(let d=0;d<b.length;d++){const e=b[d];for(let b=0;b<e.length;b++){const f=e[b];null!=f&&(this.screens[a+d][c+b]=f)}}}connect(a,b,c){var d=0>a?256:0,e=0>c?256:0;a=0>a?~a:a;c=0>c?~c:c;const f=a>>>4,g=a&15,h=c>>>4,k=c&15,[l,
m]=screenExits$$module$js$rom$location[d|this.screens[f][g]],[n,p]=screenExits$$module$js$rom$location[e|b.screens[h][k]];d=this.entrances.length;e=b.entrances.length;this.entrances.push(Entrance$$module$js$rom$location.of({y:f<<8|l>>>8,x:g<<8|l&255}));b.entrances.push(Entrance$$module$js$rom$location.of({y:h<<8|n>>>8,x:k<<8|n&255}));for(const c of m)this.exits.push(Exit$$module$js$rom$location.of({screen:a,tile:c,dest:b.id,entrance:e}));for(const a of p)b.exits.push(Exit$$module$js$rom$location.of({screen:c,
...
"Azteca"],fakeMesia:[132,"Fake Mesia"],akahanaStoned:[136,"Stoned Akahana"],mesia:[142,"Mesia"],rage:[195,"Rage"]};class PortoaQueen$$module$js$rom$npc extends Npc$$module$js$rom$npc{constructor(){super(...arguments);this.id=56;this.name="Portoa Queen"}get expectedSword(){return this.localDialog(3).condition&255}set expectedSword(a){this.localDialog(3).condition=512|a}}var module$js$rom$npc={};module$js$rom$npc.Npc=Npc$$module$js$rom$npc;module$js$rom$npc.GlobalDialog=GlobalDialog$$module$js$rom$npc;
module$js$rom$npc.LocalDialog=LocalDialog$$module$js$rom$npc;module$js$rom$npc.NAMES=NAMES$$module$js$rom$npc;module$js$rom$npc.PortoaQueen=PortoaQueen$$module$js$rom$npc;function deterministicPreParse$$module$js$pass$deterministic(a){a[122987]&=7;a[122991]&=7;a[122995]&=7;a[122999]&=7;a[123003]&=7;a[123012]&=7;a[123035]&=7;a[123065]&=7}
function deterministic$$module$js$pass$deterministic(a,b){addZombieWarp$$module$js$pass$deterministic(a);consolidateItemGrants$$module$js$pass$deterministic(a);addMezameTrigger$$module$js$pass$deterministic(a);normalizeSwords$$module$js$pass$deterministic(a,b);fixCoinSprites$$module$js$pass$deterministic(a);makeBraceletsProgressive$$module$js$pass$deterministic(a);addTowerExit$$module$js$pass$deterministic(a);reversibleSwanGate$$module$js$pass$deterministic(a);adjustGoaFortressTriggers$$module$js$pass$deterministic(a);
...
function fogLampNotRequired$$module$js$pass$deterministic(a,b){b=b.requireHealedDolphinToRide();a.items[54].itemUseData[0].want=b?37:-1;a.npcs[104].data[0]=103;a.npcs[104].localDialogs.get(-1)[0].message.action=10;a.npcs[104].localDialogs.get(-1)[0].flags=[];a.npcs[104].spawnConditions.set(97,[33,-194]);a.npcs[100].spawnConditions.set(214,[565]);a.itemGets[100].flags=[];a.itemGets[103].copyFrom(a.itemGets[100]);a.itemGets[103].flags=[193]}
function fixMimics$$module$js$pass$deterministic(a){let b=112;for(const c of a.locations)for(const a of c.spawns)a.isChest()&&(a.timed=!1,112<=a.id&&(a.id=b++))}function adjustGoaFortressTriggers$$module$js$pass$deterministic(a){a=a.locations;a.GoaFortress_Kelbesque.spawns[0].x-=16;a.GoaFortress_Zebu.spawns.splice(1,1);a.GoaFortress_Tornel.spawns.splice(2,1);a.GoaFortress_Asina.spawns.splice(2,1);a.GoaFortress_Kensu.spawns.splice(3,1);a.GoaFortress_Kensu.spawns.splice(1,1)}
function alarmFluteIsKeyItem$$module$js$pass$deterministic(a,b){const {WaterfallCave4:c}=a.locations;a.itemGets[49].inventoryRowStart=32;a.items[49].unique=!0;a.items[49].basePrice=0;b.zebuStudentGivesItem()?a.npcs[20].data[1]=49:a.npcs[20].data[1]=255;b=[[33,.72],[31,.9]];let d=0;for(const c of a.shops)if(c.type===module$js$rom$shop.ShopType.TOOL)for(let e=0,g=c.contents.length;e<g;e++){if(49!==c.contents[e])continue;const [f,g]=b[d++%b.length];c.contents[e]=f;a.shopDataTablesAddress&&(c.prices[e]=
Math.round(c.prices[e]*g))}a.itemGets[91].itemId=29;c.spawn(25).id=16}function brokahanaWantsMado1$$module$js$pass$deterministic(a){a=assert$$module$js$util(a.npcs[84].localDialogs.get(-1))[0];if(-37!==a.condition)throw Error(`Bad brokahana condition: ${a.condition}`);a.condition=-104}function requireHealedDolphin$$module$js$pass$deterministic(a){a.npcs[100].spawnConditions.set(214,[566,37]);a=a.npcs[123].localDialogs.get(-1);a.unshift(a[0].clone());a[0].condition=-38;a[1].condition=-567}
...
4;a.screens[21].tiles[121]=1;a.screens[21].tiles[122]=2;a.screens[21].tiles[137]=3;a.screens[21].tiles[138]=4;a.screens[25].tiles[72]=1;a.screens[25].tiles[73]=2;a.screens[25].tiles[88]=3;a.screens[25].tiles[89]=4;a.screens[62].tiles[86]=1;a.screens[62].tiles[87]=2;a.screens[62].tiles[102]=3;a.screens[62].tiles[103]=4;const {CordelPlainWest:d,CordelPlainEast:e,Desert2:f,GoaValley:g,LimeTreeValley:h,KirisaMeadow:k,SaharaOutsideCave:l,ValleyOfWind:m,WaterfallValleyNorth:n,WaterfallValleySouth:p}=a.locations;
a=[[m,48],[d,48],[e,48],[n,0],[n,20],[p,116],[k,16],[l,0],[f,65]];b.addEastCave()&&b.connectLimeTreeToLeaf()&&a.push([h,16]);b.connectGoaToLeaf()&&a.push([g,1]);for(const [b,c]of a)b.flags.push(Flag$$module$js$rom$location.of({yx:c,flag:752}));b.paralysisRequiresPrisonKey()&&(c(d,48,750),c(e,48,750),c(n,0,728),b=Spawn$$module$js$rom$location.of({y:96,x:96,type:4,id:44}),a=Spawn$$module$js$rom$location.of({y:112,x:112,type:2,id:173}),n.spawns.splice(1,0,b),n.spawns.push(a))}
...
function connectGoaToLeaf$$module$js$pass$deterministic(a){const {GoaValley:b,EastCave2:c,EastCave3:d}=a.locations;b.writeScreens2d(0,[[12,193,13],[14,55,53]]);a.locations.allocate(d);d.screens=[[154],[143],[158]];d.height=3;d.width=1;d.spawns.push(Spawn$$module$js$rom$location.from([24,7,35,0]));d.flags.push(Flag$$module$js$rom$location.of({screen:16,flag:a.flags.allocMapFlag()}));c.screens[4][0]=153;c.connect(64,d,-1);d.connect(32,b,1)}
function addZombieWarp$$module$js$pass$deterministic(a){for(var b=757;764>b;b++)a.moveFlag(b,b-1);a.messages.parts[33][0].text=" {1a:Leaf}      {16:Brynmaer} {1d:Oak} \n{0c:Nadare}'s  {1e:Portoa}   {14:Amazones} \n{19:Joel}      Zombie   {20:Swan} \n{23:Shyron}    {18:Goa}      {21:Sahara}";b=a.nextFreeTrigger();b.used=!0;b.conditions=[];b.message=MessageId$$module$js$rom$messageid.of({});b.flags=[763];for(const c of a.locations.ZombieTown.spawns)c.isTrigger()&&138===c.id&&(c.id=b.id);a.townWarp.locations.splice(7,
0,a.locations.ZombieTown.id);if(255!==a.townWarp.locations.pop())throw Error("unexpected");}function evilSpiritIslandRequiresDolphin$$module$js$pass$deterministic(a){a.trigger(138).conditions=[-239];a.messages.parts[29][16].text="The cave entrance appears\nto be underwater. You'll\nneed to swim."}
...
return d}function f(a){a.reverse();for(let b=0;b<a.length;b++){const c=a[b+1];a[b].condition=c?~c.condition:-1}}a.npcs[116].link(126);a.npcs[116].used=!0;a.npcs[116].data=[...a.npcs[126].data];a.locations.Swan_DanceHall.spawns.find((a)=>a.isNpc()&&126===a.id).id=116;a.items.LovePendant.itemUseData[0].want=372;a.npcs[136].linkDialog(22);a.npcs[126].data[0]=57;a.npcs[130].used=!0;a.npcs[130].link(22);a.npcs[130].data=[...a.npcs[22].data];a.locations.Brynmaer.spawns.find((a)=>a.isNpc()&&22===a.id).id=
130;a.items.StatueOfOnyx.itemUseData[0].want=386;d(19)[2].condition=71;d(19)[2].flags=[169];d(19)[3].flags=[169];e(20,14)[1]=-137;c(e(22,87),-82);c(e(136,87),-82);var g=d(29);g[0].message.action=3;g[1].message.action=3;g[2].message.action=3;g[3].message.action=3;const h=d(30);(()=>{const [b,c,d,e]=h;e.condition=-70;c.condition=-1;a.npcs[30].localDialogs.set(-1,[e,d,b,c])})();for(const a of[32,33,34,124,125])f(d(a));g=d(31);g.unshift(...g.splice(1,1));a.npcs[51].spawnConditions.set(223,[-33,-28]);
d(52)[1].condition=27;d(56)[3].condition=514;d(56)[3].message.action=3;d(56)[4].flags.push(156);e(56,223)[1]=-28;e(56,225)[0]=27;d(56)[1].condition=27;e(57,216)[1]=-28;a.npcs[68].spawnConditions.set(233,[-142]);a.npcs[68].spawnConditions.set(228,[141]);a.npcs[94].localDialogs.set(16,[LocalDialog$$module$js$rom$npc.of(-59,[0,26],[58]),LocalDialog$$module$js$rom$npc.of(13,[0,29]),LocalDialog$$module$js$rom$npc.of(56,[0,28]),LocalDialog$$module$js$rom$npc.of(57,[0,29]),LocalDialog$$module$js$rom$npc.of(10,
[0,27,3]),LocalDialog$$module$js$rom$npc.of(-1,[0,29])]);c(e(94,16),-82);a.npcs[95].spawnConditions.delete(33);a.npcs[96].spawnConditions.delete(30);g=a.npcs[98];g.data[1]=40;d(g.id,225)[0].message.action=17;d(g.id,225)[2].message.action=17;c(e(g.id,225),-144);a.npcs[104].spawnConditions.set(97,[-156,33]);d(104)[0].message.action=2;a.npcs[110].spawnConditions.get(242).push(-40);a.trigger(130).conditions.push(-40);d(195)[0].condition=514;a.npcs[196].spawnConditions.delete(242);a.npcs[203].spawnConditions.set(166,
[-654]);g=a.npcs[94].localDialogs.get(242);g.unshift(...g.splice(1,1));a.trigger(128).conditions=[-40,59,765];a.trigger(129).conditions=[];b.barrierRequiresCalmSea()&&a.trigger(132).conditions.push(643);a.trigger(140).conditions.push(58);a.trigger(141).used=!1;for(const b of a.locations.MtSabreNorth_SummitCave.spawns)b.isTrigger()&&141===b.id&&(b.id=178);(function(a,b){b=a.findIndex(b);if(0>b)throw Error(`Could not find element in ${a}`);a.splice(b,1)})(a.locations.WaterfallValleyNorth.spawns,(a)=>
a.isTrigger()&&141===a.id);a.trigger(178).conditions.push(258);a.trigger(178).flags.push(-133,-134,13);a.trigger(140).conditions.push(-259);a.trigger(134).conditions.push(-259);a.prg[123043]=192;a.prg[123044]=0;a.trigger(186).conditions[0]=-581;a.trigger(187).conditions[1]=-28;for(const b of a.npcs)for(const a of b.allDialogs())14===a.condition&&(a.condition=579),-15===a.condition&&(a.condition=-580)}
function disableStabs$$module$js$pass$deterministic(a){for(const b of[8,9,39])a.objects[b].collisionPlane=0;a.npcs[84].data[0]=32}function orbsOptional$$module$js$pass$deterministic(a){for(const b of[16,20,24,29])a.objects[b].terrainSusceptibility&=-5,a.objects[b].level=2}var module$js$pass$deterministic={};module$js$pass$deterministic.deterministicPreParse=deterministicPreParse$$module$js$pass$deterministic;module$js$pass$deterministic.deterministic=deterministic$$module$js$pass$deterministic;function shuffleTrades$$module$js$pass$shuffletrades(a,b,c){if(b.randomizeTrades()){var {StatueOfOnyx:d,FogLamp:e,LovePendant:f,KirisaPlant:g,IvoryStatue:h}=a.items,k=new Map,l=[[d,0,"Akahana"],[e,0,"Fisherman"],[f,0,"Kensu"],[g,0,"Aryllis"],[h,0,"Slimed Kensu"]],m=l.map(([a,b,c])=>{if(0>a.trades.indexOf(b)||b>=a.itemUseData.length)throw Error(`not a trade: ${a} ${b}`);return[a.itemUseData[b],a.id,c]});c.shuffle(m);for(const [c,d]of l){const [e,f,g]=m.pop();c.itemUseData[d]=e;a.spoiler&&a.spoiler.addTrade(c.id,
...
module$js$pass$shuffletrades.buildTradeInMap=buildTradeInMap$$module$js$pass$shuffletrades;function fixDialog$$module$js$pass$fixdialog(a){function b(a){d(a,/teach\s+you\s+the\s+magic\s+of/,"bestow upon you the")}function c(b){b=a.items[a.itemGets[b].itemId];return`[${hex$$module$js$rom$util(b.id)}:${b.messageName}]`}function d(b,c,d){const [e,f]=b.split(":").map((a)=>parseInt(a,16));b=a.messages.parts[e][f];b.text=b.text.replace(c,d)}function e(b){const c=a.itemGets.actionGrants.get(b);if(null==c)throw Error(`Missing actionGrant for ${hex$$module$js$rom$util(b)}`);return c}d("03:06",",",
"");var f=buildTradeInMap$$module$js$pass$shuffletrades(a),g=a.npcs[94];65>g.data[0]&&b("00:1b");d("00:1b","[41:Refresh]",c(g.data[0]));g=mustGet$$module$js$pass$fixdialog(f,130);d("02:01","an unusual statue",vague$$module$js$pass$fixdialog(g));d("02:02","a statue",`the ${commonNoun$$module$js$pass$fixdialog(g)}`);g=e(g);d("02:02","[29:Gas Mask]",c(g));g=a.prg[223220];65>g&&b("03:01");d("03:01","[43:Telepathy]",c(g));g=a.npcs[95];var h=findTornelTradeIn$$module$js$pass$fixdialog(g);d("03:01","[06:Tornado Bracelet]",
c(h));d("05:0a","[06:Tornado Bracelet]",c(h));d("05:0a","[44:Teleport]",c(g.data[0]));g=f.get(100);null!=g&&(d("09:01","[35:Fog Lamp]",c(g)),d("09:04","[35:Fog Lamp]",c(g)),d("09:05","[35:Fog Lamp]",c(g)),d("09:06","lamp",commonNoun$$module$js$pass$fixdialog(g)));g=a.npcs[56];d("0a:0c","[28:Flute of Lime]",c(g.data[0]));d("0a:0d","[02:Sword of Water]",c(g.localDialogs.get(-1)[3].condition&255));g=a.prg[250361];65>g&&b("0b:01");d("0b:01","[45:Recover]",c(g));g=e(132);65>g&&(b("0b:01"),b("1d:12"));
d("0b:01","[46:Barrier]",c(g));d("1d:12","[46:Barrier]",c(g));g=function(...b){var c=[(a)=>BOWS$$module$js$pass$fixdialog.has(a),(a)=>SWORD_OR_MAGIC$$module$js$pass$fixdialog.has(a),(b)=>a.items[a.itemGets[b].itemId].unique];for(const d of c)for(const e of b){c=a.locations[e];for(const a of c.spawns)if(a.isChest()&&72>=a.id&&d(a.id))return a.id}return-1}(79,78,77,76,71,70,69,68,75,74,73,72);0<=g?d("0d:00","[35:Fog Lamp]",c(g)):d("0d:00","that a [35:Fog Lamp] was","there was treasure");g=a.npcs[195].localDialogs.get(-1)[0].condition&
255;h=a.prg[250679];d("0e:03","[02:Sword of Water]",c(g));d("0e:03","[09:Ball of Water]",c(h));d("10:0c","that's","is");d("10:0c",/, is in the\+lighthouse/,"");g=f.get(35);null!=g&&(d("12:05","[3c:Kirisa Plant]",c(g)),d("12:10","the plant",`the ${commonNoun$$module$js$pass$fixdialog(g)}`),d("12:10","[3c:Kirisa Plant]",c(g)),g=`Our illustrious chief seeks ${vague$$module$js$pass$fixdialog(g)}.`,d("12:09",/[^]*/,g),d("12:0a",/[^]*/,g));g=mustGet$$module$js$pass$fixdialog(f,116);d("13:02","[3b:Love Pendant]",
c(g));d("13:00","pendant",commonNoun$$module$js$pass$fixdialog(g));g=e(g);65>g&&b("13:02");d("13:02","[47:Change]",c(g));f=f.get(117);null!=f&&(d("18:06","[3d:Ivory Statue]",c(f)),d("18:07","[3d:Ivory Statue]",c(f)));d("18:06","It's in a room","{0b:Karmine} is");f=a.prg[250255];65>f&&d("18:07","teach","give");d("18:07","[48:Flight]",c(f));f=e(178);65>f&&b("1c:10");d("1c:10","[42:Paralysis]",c(f));d("20:06","Statue of Gold",c(e(57)))}
const BOWS$$module$js$pass$fixdialog=new Set([62,63,64]),SWORD_OR_MAGIC$$module$js$pass$fixdialog=new Set([0,1,2,3,65,66,67,68,69,70,71,72]);function findTornelTradeIn$$module$js$pass$fixdialog(a){for(const b of a.localDialogs.values())for(a=2;a<b.length;a++){const c=~b[a].condition;if(516<c&&524>=c&&!(c&1))return c&255}return 6}
...
function commonNoun$$module$js$pass$fixdialog(a){switch(a){case 37:return"statue";case 40:return"instrument";case 53:return"lamp";case 59:return"pendant";case 60:return"plant";case 61:return"statue"}fail$$module$js$assert();return"item"}function mustGet$$module$js$pass$fixdialog(a,b){a=a.get(b);if(null==a)throw Error(`Expected value for ${b}`);return a}var module$js$pass$fixdialog={};module$js$pass$fixdialog.fixDialog=fixDialog$$module$js$pass$fixdialog;function randomizeThunderWarp$$module$js$pass$randomizethunderwarp(a,b){var c=[...a.townWarp.locations].filter((a)=>255!==a);b=b.nextInt(c.length);const d=c[b];let e=64;if(d===a.locations.Shyron.id||d===a.locations.Shyron_Temple.id)e=65;a.townWarp.thunderSwordWarp=[d,e];c=768-c.length+b;a=a.itemGets[3].flags;for(b=0;b<a.length;b++)if(765===a[b]){a[b]=c;return}a.push(c)}var module$js$pass$randomizethunderwarp={};module$js$pass$randomizethunderwarp.randomizeThunderWarp=randomizeThunderWarp$$module$js$pass$randomizethunderwarp;function shuffleGoa$$module$js$pass$shufflegoa(a,b){function c(a,b,c,d){b=a.exits[b];const e=[];for(const c of a.exits)c.dest===b.dest&&c.entrance===b.entrance&&e.push(c);for(const a of e)a.dest=c.id,a.entrance=d}var d=a.locations;a=[1,2,3,4];b.shuffle(a);b=[[d.GoaFortress_Exit,0,0],[d.GoaFortress_Kelbesque,0,0],[d.GoaFortress_Sabera,0,0],[d.GoaFortress_Mado1,0,0],[d.GoaFortress_Karmine1,0,0]];d=[[d.GoaFortress_Entrance,1,2],[d.GoaFortress_Zebu,1,4],[d.GoaFortress_Tornel,1,2],[d.GoaFortress_Asina,
1,2],[d.GoaFortress_Kensu,5,10]];var e=a[3];4!==e&&(flipKarmineExit$$module$js$pass$shufflegoa(...d[4]),flipNonKarmineExit$$module$js$pass$shufflegoa(...d[e]));for(e=0;4>=e;e++){const [f,g,h]=d[0===e?0:a[e-1]],[k,l,m]=b[4===e?0:a[e]];c(k,m,f,g);c(f,h,k,l)}for(const [b]of d)"number"===typeof b.data.music&&(b.bgm=b.neighborForEntrance(b.data.music).bgm),"number"===typeof b.data.palette&&(a=b.neighborForEntrance(b.data.palette).tilePalettes,b.tilePalettes=[a[0],a[1],a[2]])}
...
var module$js$rom$item={};module$js$rom$item.Item=Item$$module$js$rom$item;module$js$rom$item.ItemUse=ItemUse$$module$js$rom$item;module$js$rom$item.Items=Items$$module$js$rom$item;const GRANT_ITEM_TABLE$$module$js$rom$itemget=251605;
...
a.writeOne(c);yield Promise.all(c);yield 0;yield 0;yield 0}})}find(a){var {data:b,startPage:c,endPage:d}=a;for(const e of this.chunks)if(!(e.page<c||e.page>d)&&(a=e.find(b,this.rom),0<=a))return a;return-1}writeOne(a){for(const b of this.chunks)if(!(b.page<a.startPage||b.page>a.endPage||b.free()<a.data.length)){this.rom.subarray(b.pos,b.pos+a.data.length).set(a.data);a.resolve(b.pos);this.free[b.page]-=a.data.length;DEBUG$$module$js$rom$writer&&DEBUG_PAGE$$module$js$rom$writer.has(b.page)&&console.log(`${a.name}: writing ${a.data.length} bytes at ${hex$$module$js$rom$util(b.pos)}: ${Array.from(a.data,
hex$$module$js$rom$util).join(" ")} | FREE ${this.free.map((a,b)=>`${hex$$module$js$rom$util(2*b)}:${a}`).join("/")}`);b.pos+=a.data.length;return}if(DEBUG$$module$js$rom$writer){console.log(`LOOKING FOR CHUNK: ${a.data.length} bytes in ${hex$$module$js$rom$util(a.startPage)}..${hex$$module$js$rom$util(a.endPage)}`);for(const b of this.chunks)b.page<a.startPage||b.page>a.endPage?console.log(`wrong page: ${hex$$module$js$rom$util(b.pos)}..${hex$$module$js$rom$util(b.end)} -> ${hex$$module$js$rom$util(b.page)}`):
b.free()<a.data.length&&console.log(`not enough free: ${hex$$module$js$rom$util(b.pos)}..${hex$$module$js$rom$util(b.end)} -> ${b.free()}`);console.log(this.chunks)}console.log(`${a.name}: WRITE FAILED ${a.data.length} bytes: ${Array.from(a.data,hex$$module$js$rom$util).join(" ")}`);a.reject(Error(`Could not find sufficient chunk in ${hex$$module$js$rom$util(a.startPage)}..${hex$$module$js$rom$util(a.endPage)} to write ${a.name}: ${a.data}`))}}
...
this.items=new Items$$module$js$rom$item(this);this.shops=seq$$module$js$rom$util(44,(a)=>new Shop$$module$js$rom$shop(this,a));this.npcs=seq$$module$js$rom$util(205,(a)=>new Npc$$module$js$rom$npc(this,a));this.bossKills=seq$$module$js$rom$util(14,(a)=>new BossKill$$module$js$rom$bosskill(this,a));this.bosses=new Bosses$$module$js$rom$bosses(this);this.wildWarp=new WildWarp$$module$js$rom$wildwarp(this);this.townWarp=new TownWarp$$module$js$rom$townwarp(this);this.flags=new Flags$$module$js$rom$flags(this)}trigger(a){if(128>
...
d(a.locations);d(a.objects);d(a.hitboxes);d(a.triggers);d(a.npcs);d(a.tilesets);d(a.tileEffects);d(a.screens);d(a.adHocSpawns);a.itemGets.write(b);a.items.write(b);d(a.shops);d(a.bossKills);d(a.patterns);a.wildWarp.write(b);a.townWarp.write(b);c.push(a.telepathy.write(b));c.push(a.messages.write(b));c.push(b.commit());yield Promise.all(c).then(()=>{})})}analyzeTiles(){}disjointTilesets(){var a=[];for(var b of this.locations){if(!b.used)continue;var c=b.tileset;const d=b.extended?256:0;for(const e of b.screens)for(const b of e)(a[b+
...
}static load(a,b){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){const c=yield pickFile$$module$js$rom(b);a&&(yield a(c));return new Rom$$module$js$rom(c)})}}Rom$$module$js$rom.OMIT_ITEM_GET_DATA_SUFFIX=module$js$rom$option.RomOption.bit(82624,0);Rom$$module$js$rom.OMIT_LOCAL_DIALOG_SUFFIX=module$js$rom$option.RomOption.bit(82624,1);Rom$$module$js$rom.COMPRESSED_MAPDATA=module$js$rom$option.RomOption.bit(82624,2);Rom$$module$js$rom.SHOP_COUNT=module$js$rom$option.RomOption.byte(82625);
...
class ActionGrantSlot$$module$js$rom$slots{constructor(a,b){this.slot=a;this.key=b}set(a,b){if(112<=b)throw Error("no mimics on action grants");a.itemGets.actionGrants.set(this.key,b);if(a.spoiler){var c={132:"Whirlpool trigger",178:"Mt Sabre summit trigger",180:""};(c=128>this.key?a.items[this.key].messageName+" trade-in":c[this.key])&&a.spoiler.addSlot(this.slot,c,b)}}}
...
class Slots$$module$js$rom$slots{constructor(a){function b(a){c[a.slot].push(a)}this.rom=a;const c=seq$$module$js$rom$util(128,()=>[]);for(const c of a.locations)if(c.used)for(let a=0;a<c.spawns.length;a++){const d=c.spawns[a];d.isChest()&&b(new ChestSlot$$module$js$rom$slots(d.id,c.id,a))}for(const c of a.npcs)if(c.used&&c.hasDialog)for(const a of c.localDialogs.values())for(const d of a)switch(d.message.action){case 3:case 10:b(new PersonDataSlot$$module$js$rom$slots(c.data[0],c.id,0));break;case 17:b(new PersonDataSlot$$module$js$rom$slots(c.data[1],
c.id,1));break;case 9:128>c.data[1]&&b(new PersonDataSlot$$module$js$rom$slots(c.data[1],c.id,1))}for(const c of a.bosses)3!==c.kill&&13!==c.kill&&null!=c.kill&&null!=c.drop&&b(new BossDropSlot$$module$js$rom$slots(c.drop,c.kill));for(const [c,e]of a.itemGets.actionGrants)b(new ActionGrantSlot$$module$js$rom$slots(e,c));for(const [a,c]of hardcodedItems$$module$js$rom$slots)b(new HardcodedSlot$$module$js$rom$slots(this.rom.prg[a],a,c));extraSlots$$module$js$rom$slots.forEach(b);this.slots=c}update(a){for(var b=
0;b<a.length;b++)if(null!=a[b])for(var c of this.slots[b])c.set(this.rom,a[b]);b=this.rom.itemGets.map(()=>[]);for(const d of this.rom.itemGets){({id:c}=d);for(const e of d.flags){if(-1===e)continue;const d=preservedItemGetFlags$$module$js$rom$slots.has(e)?c:a[c];(b[d]||[]).push(e)}}for(const a of this.rom.itemGets)a.flags=b[a.id]}}
const hardcodedItems$$module$js$rom$slots=[[223220,"Stom fight"],[250255,"Slimed Kensu"],[250361,"Asina"],[250543,"Stoned Akahana"],[250679,"Rage"]],extraSlots$$module$js$rom$slots=[new PersonDataSlot$$module$js$rom$slots(54,99,1)];function update$$module$js$rom$slots(a,b){(new Slots$$module$js$rom$slots(a)).update(b)}const preservedItemGetFlags$$module$js$rom$slots=new Set([36,139,756,757,758,759,760,761,762,763,764,765,766,767]);var module$js$rom$slots={};module$js$rom$slots.update=update$$module$js$rom$slots;class Spoiler$$module$js$rom$spoiler{constructor(a){this.rom=a;this.slots=[];this.route=[];this.mazes=[];this.trades=[];this.walls=[];this.unidentifiedItems=[];this.wildWarps=[];this.slotNames=[];this.conditionNames={}}addCondition(a,b){this.conditionNames[a]=b}addCheck(a,b,c){this.route.push(new Check$$module$js$rom$spoiler(this,a,b,c))}addSlot(a,b,c){this.slots[a]=new Slot$$module$js$rom$spoiler(this.rom,a,b,c);b&&(this.slotNames[512|a]=b)}addMaze(a,b,c){this.mazes.push({id:a,name:b,maze:c})}addTrade(a,
...
_REQUIRE_HEALED_DOLPHIN_TO_RIDE:c.requireHealedDolphinToRide(),_REVERSIBLE_SWAN_GATE:!0,_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_SIMPLIFY_INVISIBLE_CHESTS:!0,_SOFT_RESET_SHORTCUT:!0,_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword(),_TRAINER:c.trainer(),_TWELVTH_WARP_POINT:!0,_UNIDENTIFIED_ITEMS:c.unidentifiedItems(),_ZEBU_STUDENT_GIVES_ITEM:c.zebuStudentGivesItem()},l=new Assembler$$module$js$6502;deterministicPreParse$$module$js$pass$deterministic(a.subarray(16));
var m=Object.keys(k).filter((a)=>k[a]).map((a)=>`define ${a} 1\n`).join("");l.assemble(m,"flags.s");yield g("preshuffle.s");h=new Random$$module$js$random(h);m=new Rom$$module$js$rom(a);"object"==typeof window&&(window.rom=m);m.spoiler=new Spoiler$$module$js$rom$spoiler(m);e&&(e.spoiler=m.spoiler);deterministic$$module$js$pass$deterministic(m,c);toggleMaps$$module$js$pass$togglemaps(m,c,h);yield g("postparse.s");m.scalingLevels=48;m.uniqueItemTableAddress=l.expand("KeyItemData");c.shuffleShops()&&
shuffleShops$$module$js$patch(m,c,h);shuffleGoa$$module$js$pass$shufflegoa(m,h);randomizeWalls$$module$js$patch(m,c,h);crumblingPlatforms$$module$js$pass$crumblingplatforms(m,h);c.randomizeWildWarp()&&shuffleWildWarp$$module$js$patch(m,c,h);c.randomizeThunderTeleport()&&randomizeThunderWarp$$module$js$pass$randomizethunderwarp(m,h);rescaleMonsters$$module$js$patch(m,c,h);unidentifiedItems$$module$js$pass$unidentifieditems(m,c,h);shuffleTrades$$module$js$pass$shuffletrades(m,c,h);c.randomizeMaps()&&
shuffleMazes$$module$js$pass$shufflemazes(m,c,h);const n=World$$module$js$graph$world.build(m,c),p=yield(new AssumedFill$$module$js$graph$shuffle(m,c)).shuffle(n.graph,h,f);if(p)n.traverse(n.graph,p),update$$module$js$rom$slots(m,p.slots);else return[a,-1];rescaleShops$$module$js$patch(m,l,c.bargainHunting()?h:void 0);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(m,c,h);identifyKeyItemsForDifficultyBuffs$$module$js$patch(m);c.doubleBuffMedicalHerb()?(a[115996]*=2,a[115962]*=3):c.buffMedicalHerb()&&
(a[115996]+=16,a[115962]*=2);c.storyMode()&&storyMode$$module$js$patch(m);shuffleMusic$$module$js$patch(m,c,h);shufflePalettes$$module$js$pass$shufflepalettes(m,c,h);c.blackoutMode()&&blackoutMode$$module$js$patch(m);misc$$module$js$patch(m,c,h);fixDialog$$module$js$pass$fixdialog(m);c.buffDyna()&&buffDyna$$module$js$patch(m,c);c.trainer()&&(m.wildWarp.locations=[10,26,53,72,109,110,140,170,172,176,182,159,166,88,92,0]);yield m.writeData();buffDyna$$module$js$patch(m,c);h=yield postParsedShuffle$$module$js$patch(a,
h,b,c,l,g);EXPAND_PRG$$module$js$patch&&(m=a.subarray(16),m.subarray(507904,524288).set(m.subarray(245760,262144)));return[a,h]})}function postParsedShuffle$$module$js$patch(a,b,c,d,e,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){yield f("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(a,d,e);updateCoinDrops$$module$js$patch(a,d);shuffleRandomNumbers$$module$js$patch(a,b);return stampVersionSeedAndHash$$module$js$patch(a,c,d)})}
...
60,37,6,106],[155,"b","Draygon",5,6,16,41,,110],[158,"b","Draygon 2",7,6,28,40,,,],[160,"m","Ground Sentry (1)",4,,6,26,7,73],[161,"m","Tower Defense Mech (2)",5,,8,36,8,85],[162,"m","Tower Sentinel",,,1,,5,32],[163,"m","Air Sentry",3,,2,26,6,65],[165,"b","Vampire 2",3,,12,27,,100],[164,"b","Dyna",6,5,32,,,,],[180,"b","dyna pod",6,5,48,26,,,],[184,"p","dyna counter",15,,,42,,,],[185,"p","dyna laser",15,,,42,,,],[186,"p","dyna bubble",,,,36,,,],[188,"m","vamp2 bat",,,,16,,15],[191,"p","draygon2 fireball",
...
b||!a.spritePatterns||!a.spritePalettes;e=[];c=[];let g=12;for(const b of f?[]:a.spawns){++g;if(!b.used||!b.isMonster())continue;f=b.monsterId;if(f in UNTOUCHED_MONSTERS$$module$js$patch||!SCALED_MONSTERS$$module$js$patch.has(f)||"m"!==SCALED_MONSTERS$$module$js$patch.get(f).type)continue;var h=a.rom.objects[f];if(!h)continue;const d=b.patternBank,l=a.spritePatterns[d];var k=h.palettes(!0);h=k.includes(2)?a.spritePalettes[0]:void 0;k=k.includes(3)?a.spritePalettes[1]:void 0;e.push({id:f,pat:l,pal2:h,
pal3:k,patBank:d});(this.report[`start-${f.toString(16)}`]=this.report[`start-${f.toString(16)}`]||[]).push("$"+a.id.toString(16));c.push(g)}if(!e.length||d)c=[];this.locations.push({location:a,slots:c});this.flags.shuffleTowerMonsters()===b&&this.monsters.push(...e)}shuffle(a,b){this.report["pre-shuffle locations"]=this.locations.map((a)=>a.location.id);this.report["pre-shuffle monsters"]=this.monsters.map((a)=>a.id);a.shuffle(this.locations);a.shuffle(this.monsters);this.report["post-shuffle locations"]=
...
!0):n.meet(Constraint$$module$js$rom$constraint.MIMIC,!0);else if(a.isNpc()||a.isBoss()){var c=b.getNpcConstraint(e.id,a.id);n=n.meet(c,!0);!a.isNpc()||107!==a.id&&104!==a.id||(n=n.meet(Constraint$$module$js$rom$constraint.KENSU_CHEST,!0))}else a.isMonster()&&UNTOUCHED_MONSTERS$$module$js$patch[a.monsterId]?(c=b.getMonsterConstraint(e.id,a.monsterId),n=n.meet(c,!0)):a.isShootingWall(e)&&(n=n.meet(Constraint$$module$js$rom$constraint.SHOOTING_WALL,!0));g.push(`Initial pass: ${n.fixed.map((a)=>Infinity>
a.size?"["+[...a].join(", ")+"]":"all")}`);const p=new Map;c=(a)=>{var c=e.rom.objects[a.id];if(c.monsterClass){var d=p.get(c.monsterClass);if(null!=d&&d!==a.id)return!1}d=FLYERS$$module$js$patch.has(a.id);var h=MOTHS_AND_BATS$$module$js$patch.has(a.id);if(d){if(!m)return!1;--m}const l=b.getMonsterConstraint(e.id,a.id);let r=n.tryMeet(l);!r&&Infinity>n.pal2.size&&Infinity>n.pal3.size&&this.flags.shuffleSpritePalettes()&&(r=n.tryMeet(l,!0));if(!r)return!1;if(q){var v=e.rom.objects[a.id];if(!(v instanceof
Monster$$module$js$rom$monster))throw Error(`non-monster: ${v}`);v=q(v);if(null==v)return!1}g.push(`  Adding ${a.id.toString(16)}: ${r}`);n=r;c.monsterClass&&p.set(c.monsterClass,a.id);c=0;if(d||h)for(d=0;d<f.length;d++){if(f[d]in k){c=d;break}}else for(d=0;d<f.length;d++)if(!(f[d]in k)){c=d;break}(this.report[`mon-${a.id.toString(16)}`]=this.report[`mon-${a.id.toString(16)}`]||[]).push("$"+e.id.toString(16));d=f[c];h=e.spawns[d-13];q?(h.screen=v>>>8,h.tile=v&255):d in k&&(h.y+=16*k[d][0],h.x+=16*
k[d][1]);h.monsterId=a.id;g.push(`    slot ${d.toString(16)}: ${h}`);f.splice(c,1);return!0};const q=f.length&&this.flags.randomizeMaps()?e.monsterPlacer(a):null;if(m&&f.length)for(var d=0;d<Math.min(40,this.monsters.length);d++)FLYERS$$module$js$patch.has(this.monsters[d].id)&&c(this.monsters[d])&&this.monsters.splice(d,1);for(d=0;d<this.monsters.length&&f.length;d++)if(c(this.monsters[d])){const [a]=this.monsters.splice(d,1);FLYERS$$module$js$patch.has(a.id)||this.used.push(a);d--}for(d=0;d<this.used.length&&
