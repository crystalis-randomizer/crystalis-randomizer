...
"Hard"),h=(a)=>a.value?a:f,k=c("Leather Boots grant speed",b.leatherBootsGiveSpeed()),m=h(c("Assume ghetto flight",b.assumeGhettoFlight())),p=h(c("Assume statue glitch",b.assumeStatueGlitch())),n=c("Allow statue glitch",!b.disableStatueGlitch()),q=h(c("Assume teleport skip",b.assumeTeleportSkip())),l=c("Allow teleport skip",!b.disableTeleportSkip()),r=h(c("Assume rabbit skip",b.assumeRabbitSkip())),I=h(c("Allow rabbit skip",!b.disableRabbitSkip())),C=h(c("Assume sword charge glitch",b.assumeSwordChargeGlitch())),
...
Ce=(new Trigger$$module$js$nodes(a,"Talked to Akahana's Friend")).get(ge),De=(new Trigger$$module$js$nodes(a,"Get Bow of Truth")).get(rc),Ee=(new Trigger$$module$js$nodes(a,"Forged Crystalis")).get(pb),$a=(new Condition$$module$js$nodes(a,"Sword charge glitch")).option(C,V),Fe=(new Condition$$module$js$nodes(a,"Rabbit skip")).option(r,I),Ge=(new Condition$$module$js$nodes(a,"Teleport skip")).option(q,l),ab=(new Condition$$module$js$nodes(a,"Statue glitch")).option(p,n),He=(new Condition$$module$js$nodes(a,
...
"Speed boots")).option(fc,k),Pc=(new Condition$$module$js$nodes(a,"Climb slopes")).option(vb).option(z).option(Oc),Ke=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (rabbit)")).option(Ac).option(Fe),Le=(new Condition$$module$js$nodes(a,"Enter Mt Sabre North (Teleport)")).option(sc).option(Ge,z),Qc=(new Condition$$module$js$nodes(a,"Asina in her room")).option(Fc),Me=(new Condition$$module$js$nodes(a,"Paralysis or Asina revealed")).option(Ja).option(Qc).option(ab),Rc=(new Condition$$module$js$nodes(a,
"Ride dolphin")).option(yb,Ic),Ne=(new Condition$$module$js$nodes(a,"Ghetto flight")).option(m,Rc,vb),ba=(new Condition$$module$js$nodes(a,"Cross sea")).option(Rc).option(z),Oe=(new Condition$$module$js$nodes(a,"Cross whirlpool")).option(Db).option(z).option(Ne),T=(new Condition$$module$js$nodes(a,"Refresh if needed")).option(Xb.value?Xb:g).option(Za),Sc=(new Condition$$module$js$nodes(a,"Wind magic")).option(E.value?E:g,T).option(Ra,Ia,T),Tc=(new Condition$$module$js$nodes(a,"Fire magic")).option(E.value?
...
251,aa,"Pawn Shop")).house().connect(Ha);const Th=[na,Ma,$c,Da,Hb,Ea,Kb,ld,Mb,ea,mb,Pb,Qb,Kd,Rb];for(const a of Th)a.from(Gb,He);return a},shuffle$$module$js$depgraph=(b,a,c,d,e)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const f=generate$$module$js$depgraph(d);d.shuffleShops()&&f.shuffleShops(a);const g=f.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);d||(d=new FlagSet$$module$js$flagset("Sbkm Sct"));var h={};for(var k of g)if(k instanceof Slot$$module$js$nodes&&
k.slots){var m=k.slotType[0];(h[m]=h[m]||[]).push(k)}k=[];m=[];var p={};for(var n of d.flags.S||[]){var q=[];for(var l of n){p[l]=!0;for(var r of h[l])q.push(r),m.push([r,k.length])}k.push(q)}for(var I of"bc")if(p[I])for(n=h[I],l=n.map((a)=>[a.item,a.itemIndex]),a.shuffle(l),r=0;r<n.length;r++)n[r].set(...l[r]);q=(a)=>g.find((b)=>b.vanillaItemName===a);h=q("Sword of Wind");I=q("Sword of Fire");n=q("Ball of Wind");l=q("Ball of Fire");r=q("Statue of Onyx");q=q("Gas Mask");p.k&&a.nextInt(2)&&(I.swap(h),
l.swap(n));p.k&&!a.nextInt(3)&&r.swap(q);p=[1,1,1,1,2,2,2,3,3,3,5,5,8,13];h=[];e&&e.addTasks(10);for(I=0;1E3>I;I++){e&&0==I%100&&(yield new Promise(requestAnimationFrame),e.addCompleted(1));a.shuffle(m);for(var C of k)a.shuffle(C);n=k.map(()=>-1);l=p[a.nextInt(p.length)];r=[];q=(a,b)=>a.itemIndex===b.itemIndex||a.isMimic()&&!b.canHoldMimic()||b.isMimic()&&!a.canHoldMimic()||a.needsChest()&&!b.isChest()||b.needsChest()&&!a.isChest()?!1:!0;for(let a=0;a<l;a++){const [b,c]=m[a],d=k[c][++n[c]];q(b,d)&&
...
c,d,e,f,g)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){const g=e&&e.stats;var k=b.nodes.filter((a)=>a instanceof Slot$$module$js$nodes&&a.slots&&a.slotName);const m=new Map(d.shuffle(k.map((a)=>[a,[a.item,a.itemIndex]]))),p=new Set(d.shuffle(k)),n=new Map,q={};g&&g.seeds++;f||(f=new FlagSet$$module$js$flagset("Sbkm Sct"));(f.flags.S||[]).forEach((a,b)=>{for(const c of a)q[c]=b});for(var l of p)n.set(l.item,l);let r=new Set;const I=(a,b)=>{if(null==q[a.slotType?a.slotType[0]:"c"])return a==
b;if(b.isMimic()&&!a.canHoldMimic()||"unique"!=b.item.inventoryRow&&a.requiresUnique||"armor"==b.item.inventoryRow&&!a.isChest())return!1;if(f.guaranteeSword()){if(0===a.slotIndex)return 4>b.item.id;if(4>b.item.id&&(r.add(b),4===r.size))return 0===a.slotIndex}return q[a.slotType?a.slotType[0]:"c"]==q[b.slotType?b.slotType[0]:"c"]};l=a.assumedFill(d,(a,b)=>I(a,n.get(b)));if(null==l){g&&g.endState.key++;return!1;throw Error("Could not fill!");}const C=new Map;for(var V=0;V<l.length;V++){var va=l[V];
if(null!=va){var oa=n.get(a.item(va));va=m.get(oa);m.delete(oa);oa=a.location(V);C.set(oa,va);p.delete(oa)}}V=(a,b,c)=>{c=void 0===c?"":c;for(const c of p)if(I(c,a))return C.set(c,b),p.delete(c),m.delete(a),!0;g&&("traps"==c?g.endState.traps++:"chest"==c?g.endState.chest++:g.endState.misc++);return!1};for(var E of m){const [a,b]=E;if(a.isMimic()&&!V(a,b,"traps"))return!1}for(const a of m){const [b,c]=a;if(b.needsChest()&&!V(b,c,"chest"))return!1}for(const a of m){const [b,c]=a;if(!V(b,c))return!1}for(const a of C){const [b,
c]=a;b.set(...c)}const {win:G,path:Pa}=b.traverse({wanted:k,dfs:!1});if(!G)return g&&g.endState.no_win++,!1;c&&b.write(c);if(!e)return!0;g&&(g.endState.success++,g.analyze(b,a,l));e.items=[];e.route=[];for(const a of Pa){const [c,d]=a;e.route.push(d);k=b.nodes[c];null!=k.slotName&&(E=k.slotName,0>E.indexOf(k.orig)&&(E+=` (normally ${k.vanillaItemName})`),e.items.push({slotIndex:k.slotIndex,itemIndex:k.itemIndex,origName:k.vanillaItemName,slotName:k.slotName,itemName:k.item.name,text:`${k.item.name}: ${E}`}))}return!0});
...
4<=e.sells.length?g.push(d):e.sells.push(d));for(const {shops:b}of[a,c])for(const a of b)a.sells.sort((a,b)=>a.id-b.id)}integrate(b={}){const {tracker:a=!1}=b;var c=!a;const d=new SparseDependencyGraph$$module$js$graph(this.nodes.length),e=[],f=[],g=new Set,h=new Map;var k=[],m=[];const p=[];var n=[];const q=[];b=new Set;for(var l of this.nodes)if(l instanceof Location$$module$js$nodes){if(l.isStart){const [a]=d.addRoute([l.uid]);h.set(a.label,a)}e[l.uid]=[];f[l.uid]=[];for(const a of l.connections)g.has(a)||
(g.add(a),a.bidi&&g.add(a.reverse()));for(const a of l.chests)d.addRoute([a.uid,l.uid])}else if(l instanceof ItemGet$$module$js$nodes&&"Medical Herb"===l.name&&(d.addRoute([l.uid]),d.finalize(l.uid)),l instanceof Option$$module$js$nodes)k.push(l);else if(l instanceof TrackerNode$$module$js$nodes)m.push(l);else if(l instanceof Condition$$module$js$nodes)p.push(l);else if(l instanceof Trigger$$module$js$nodes)n.push(l);else if(l instanceof ItemGet$$module$js$nodes)q.push(l);else if(l instanceof Slot$$module$js$nodes)b.add(l);
else if(!(l instanceof Area$$module$js$nodes))throw Error(`Unknown node type: ${l.nodeType}`);for(const a of g)e[a.from.uid].push(a),f[a.to.uid].push(a);l=(b)=>{for(const c of b){for(const b of c.edges({tracker:a}))d.addRoute(b);d.finalize(c.uid)}};l(k);c&&l(m);l(n);for(c=h.values();!(k=c.next()).done;){k=k.value;m=k.target;for(var r of e[m]){m=[r.to.uid,...k.deps];for(n=r.deps.length-1;0<=n;n--)m.push(r.deps[n].uid);r.from.bossNode&&m.push(r.from.bossNode.uid);for(const a of d.addRoute(m))h.has(a.label)||
h.set(a.label,a)}}l(p);for(r=0;r<this.nodes.length;r++)this.nodes[r]instanceof ItemGet$$module$js$nodes||this.nodes[r]instanceof TrackerNode$$module$js$nodes||d.finalize(r);r=new LocationList$$module$js$nodes(this);for(const a of b)for(const b of d.nodes[a.uid].values())r.addRoute([a.uid,...b]);return r}}
...
0>a?~a:a;for(var g of a){for(var h=0;h<g.length-1;h++)Array.isArray(g[h])&&(e.set(g[h][0],g[h][1]),g[h]=g[h][0]);for(h=0;h<g.length-1;h++){let a=g[h],b=g[h+1];0>a||0>b||(c.set(b,a),d[b]=a)}}g=new Set;c=new Set;b=new Set(b);for(var k of this.locations)if(k&&b.has(k.tileset)){c.add(k.tileEffects);for(const a of k.allScreens())g.add(a)}for(var m of g)for(var p of m.tiles)for(k=0;k<p.length;k++)p[k]=d[p[k]];for(var n of b){b=this.tilesets[(n&127)>>>2];for(var q of a)for(d=0;d<q.length-1;d++){m=f(q[d]);
p=f(q[d+1]);for(k=0;4>k;k++)b.tiles[k][m]=b.tiles[k][p];b.attrs[m]=b.attrs[p];if(32>p&&b.alternates[p]!=p){if(32<=m)throw Error(`Cannot unflag: ${n} ${m} ${p} ${b.alternates[p]}`);b.alternates[m]=b.alternates[p]}}for(var l of e){const [a,c]=l;b.alternates[a]=c}}for(const d of c){n=this.tileEffects[d-179];for(const c of a)for(q=0;q<c.length-1;q++)l=f(c[q]),b=f(c[q+1]),n.effects[l]=n.effects[b];for(const a of e.keys())n.effects[a]|=8}}}
...
return Math.min(AM$$module$js$random*this.iy,RNMX$$module$js$random)}nextInt(b){return Math.floor(this.next()*b)}shuffle(b){for(let a=b.length;a;){const c=this.nextInt(a--);[b[a],b[c]]=[b[c],b[a]]}return b}}var module$js$random={};module$js$random.Random=Random$$module$js$random;const STATUS$$module$js$version="rc",VERSION$$module$js$version="sg",LABEL$$module$js$version="sg a0d332e",HASH$$module$js$version="a0d332e27d66e9fe935ba047d8482810b27946c6",DATE$$module$js$version=new Date(1558693178E3);var module$js$version={};module$js$version.STATUS=STATUS$$module$js$version;module$js$version.VERSION=VERSION$$module$js$version;module$js$version.LABEL=LABEL$$module$js$version;module$js$version.HASH=HASH$$module$js$version;module$js$version.DATE=DATE$$module$js$version;var $jscompDefaultExport$$module$js$patch={apply(b,a,c){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;a.seed||(a.seed=parseSeed$$module$js$patch("").toString(16),window.location.hash+="&seed="+a.seed);d=a.flags?new FlagSet$$module$js$flagset(a.flags):new FlagSet$$module$js$flagset("Em Gt Mr Rlpt Sbk Sct Sm Tasd");for(const b in a)"false"===a[b]&&(a[b]=!1);yield shuffle$$module$js$patch(b,parseSeed$$module$js$patch(a.seed),d,new FetchReader$$module$js$fetchreader(c))})}};
...
const shuffle$$module$js$patch=(b,a,c,d,e,f)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){if("number"!==typeof a)throw Error("Bad seed");var g=crc32$$module$js$crc32(a.toString(16).padStart(8,0)+String(c))>>>0;const h=a.toString(16).toLowerCase().startsWith("17bc"),k={_ALLOW_TELEPORT_OUT_OF_TOWER:!0,_AUTO_EQUIP_BRACELET:c.autoEquipBracelet(),_BARRIER_REQUIRES_CALM_SEA:c.barrierRequiresCalmSea(),_BUFF_DEOS_PENDANT:c.buffDeosPendant(),_BUFF_DYNA:h,_CHECK_FLAG0:!0,_DEBUG_DIALOG:6076===a,
_DISABLE_SHOP_GLITCH:c.disableShopGlitch(),_DISABLE_STATUE_GLITCH:c.disableStatueGlitch(),_DISABLE_SWORD_CHARGE_GLITCH:c.disableSwordChargeGlitch(),_DISABLE_WILD_WARP:!1,_DISPLAY_DIFFICULTY:!0,_EXTRA_PITY_MP:!0,_FIX_OPEL_STATUE:!0,_FIX_SHAKING:!0,_FIX_VAMPIRE:!0,_LEATHER_BOOTS_GIVE_SPEED:c.leatherBootsGiveSpeed(),_NERF_WILD_WARP:c.nerfWildWarp(),_NERF_FLIGHT:!0,_NEVER_DIE:c.neverDie(),_NORMALIZE_SHOP_PRICES:!0,_PITY_HP_AND_MP:!0,_PROGRESSIVE_BRACELET:!0,_RABBIT_BOOTS_CHARGE_WHILE_WALKING:c.rabbitBootsChargeWhileWalking(),
_REVERSIBLE_SWAN_GATE:!0,_REQUIRE_HEALED_DOLPHIN_TO_RIDE:c.requireHealedDolphinToRide(),_SAHARA_RABBITS_REQUIRE_TELEPATHY:c.saharaRabbitsRequireTelepathy(),_TELEPORT_ON_THUNDER_SWORD:c.teleportOnThunderSword()},m=new Assembler$$module$js$6502,p=(a)=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){m.assemble(yield d.read(a),a);m.patchRom(b)});var n=Object.keys(k).filter((a)=>k[a]).map((a)=>`define ${a} 1\n`).join("");m.assemble(n,"flags.s");yield p("preshuffle.s");g=new Random$$module$js$random(g);
yield shuffle2$$module$js$depgraph(b,g,e,c,f);rescaleShops$$module$js$patch(b,m,c.bargainHunting()?g:null);n=new Rom$$module$js$rom(b);rescaleMonsters$$module$js$patch(b,n);c.shuffleMonsters()&&shuffleMonsters$$module$js$patch(b,n,g);identifyKeyItemsForDifficultyBuffs$$module$js$patch(n);c.doubleBuffMedicalHerb()?(b[115996]*=2,b[115962]*=3):c.buffMedicalHerb()&&(b[115996]+=16,b[115962]*=2);c.connectLimeTreeToLeaf()&&connectLimeTreeToLeaf$$module$js$patch(n);addCordelWestTriggers$$module$js$patch(n,
c);c.disableRabbitSkip()&&fixRabbitSkip$$module$js$patch(n);c.storyMode()&&storyMode$$module$js$patch(n);c.chargeShotsOnly()&&disableStabs$$module$js$patch(n);c.orbsOptional()&&orbsOptional$$module$js$patch(n);closeCaveEntrances$$module$js$patch(n,c);misc$$module$js$patch(n,c);h&&buffDyna$$module$js$patch(n,c);yield p("postshuffle.s");updateDifficultyScalingTables$$module$js$patch(b,c,m);updateCoinDrops$$module$js$patch(b,c);shuffleRandomNumbers$$module$js$patch(b,g);yield n.writeData();return stampVersionSeedAndHash$$module$js$patch(b,
a,c)}),misc$$module$js$patch=(b,a)=>{},buffDyna$$module$js$patch=(b,a)=>{b.objects[184].collisionPlane=1;b.objects[184].immobile=1;b.objects[185].collisionPlane=1;b.objects[185].immobile=1;b.objects[51].collisionPlane=2},closeCaveEntrances$$module$js$patch=(b,a)=>{b.swapMetatiles([144],[7,[1,0],-194],[14,[2,0],-194],[32,[3,10],-216],[33,[4,10],-216]);b.swapMetatiles([148,156],[104,[1,0],-194],[131,[2,0],-194],[136,[3,10],-216],[137,[4,10],-216]);b.screens[10].tiles[3][8]=1;b.screens[10].tiles[3][9]=
...
this.report["$"+d.id.toString(16).padStart(2,0)]=[];const {maxFlyers:g,nonFlyers:h={},fixedSlots:k={}}=MONSTER_ADJUSTMENTS$$module$js$patch[d.id]||{};let m=k.pat0||null,p=k.pat1||null,n=k.pal2||null,q=k.pal3||null,l=g,r=!1;for(const b of d.objects||[])if(2==(b[2]&7)&&(r=!0),!(b[2]&7)){var a=b[3]+80;126==a||127==a||159==a?p=98:143==a&&(m=97)}if(21==d.id||71==d.id)r=!1;f.push(`Initial pass: ${[r,m,p,n,q].join(", ")}`);a=(a)=>{var b=FLYERS$$module$js$patch.has(a.id),c=MOTHS_AND_BATS$$module$js$patch.has(a.id);
