...
.org $cb79
        ...
        ;; 8k swap to 3d (the second swap to 1b will happen later).
        ;; This precedes the call to CheckAllObjectCollisions so that
        ;; we can call into segmentd 3d.
        lda #$3d
        jsr BankSwitch8k_8000
.popseg
...
PlayerHit_CheckStone:
        ...
        <@3532b@>
        <@3532d@>
        <@35330 LoadPalettesForLocation_3d@>
        <@35333 PlayerStatus@>
        <@35336@>
        <@35338 STATUS_STONE@>
        <@3533a PlayerStatus@>
...
-         <@35589 ObjectKnockback@>
    ...
    .endif
            ...
            <@3559f MoveObjectWithSpeedAndDirection@>
           <@355a2@>
