...
; these imports will be set in messages.ts
.import LevelDownMessagePart, LevelDownMessageId

;;; Add handler to clear out crowd control data on cold boot
...
HandleCrowdControl:
  ...
  beq @continue
    ...
    ; check each bit one at a time for cc effects
@loop:
      dex
      bmi @finalize
      asl
