...
;;; This looks safe and recovers over 300 bytes from the
;;; static page.
.segment "fe"
.org $ce12
  tay 
...
;; ;;; NOTE: This one works, except it's in danger of
;; ;;; swapping out the page from under ourself...

;; ;;; Recovers all but 13 bytes from the given block.
;; .macro MOVE_TO_SEG38 end, bank
;;   @s:
;;   lda #$38
;;   jsr $c418
;;   jsr @moved
...
;; .segment "13"
;; .org $aa16
;; MOVE_TO_SEG38 $aa30, #$12



;;; PROBLEM - we might swap out the page from under ourself
;; .segment "fe", "ff"
;; Call38:
;;   lda $6e
;;   pha
...
;; .org $aa16
;; TitleLoopSceneJump_0c:
;;   lda #$38
;;   jsr $c418 ; BankSwitch8k_8000
;;   jsr TitleLoopSceneJump_0c_seg38
;;   lda #$12
;;   jsr $c418 ; restore 8000 bank
;;   FREE_UNTIL $aa30 ; TitleLoopSceneJump_0c_end
;; .org $aa30
;; TitleLoopSceneJump_0c_end:

;; .segment "38"
;; .reloc
;; TitleLoopSceneJump_0c_seg38:
;; ;;   ldx #$cf
;; ;; -  nop
;; ;;    nop
;; ;;    nop
;; ;;    dex
;; ;;   bne -
;;   .move (TitleLoopSceneJump_0c_end - TitleLoopSceneJump_0c), TitleLoopSceneJump_0c



;; .define CROSS_PAGE_JUMP(Dest) \
;;   jsr JmpCrossPage \
;;   .word (Dest) \
;;   .byte ^Dest

;; .define MOVE_TO_38(from, bytes) \
;; .org from \
;; @src: \
;; .pushseg "38" \
;;   .move bytes, @src \
...
;; ;;;   .word (Dest)
;; ;;;   .byte ^Dest
;; ;;; We simplify this with a macro:
;; ;;;   CROSS_PAGE_JMP(Dest)
;; ;;; NOTE: This should only be used OUTSIDE of interrupts.
;; .reloc
;; JmpCrossPage:
;;   ;; Basic idea: stash A and X on the stack, but then look
;;   ;; at the address on the stack to find the destination.
;;   pha
;;   txa
;;   pha
;;   ;; Point $0100,x to the destination
;;   tsa
;;   tax
;;   inx
;;   inx
;;   ;; Store the address in $38$39
;;   lda $0100,x
;;   sta $38
;;   lda $0101,x
;;   and #$df ; we always run from the low (8000) bank
;;   sta $39
;;   ;; Load the page into 8000
;;   lda $6e
;;   sta $010
;;    lda $0102,x
;;    jsr $c418  ; BankSwitch8k_8000
;;    ;; Now we need to get the stack situated
;;    jmp (($0038))
