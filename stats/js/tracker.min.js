...
d[0]),d[1]],done:!1}}}}};class Ra{constructor(){this._link=new Ua}static link(...a){const b=new Ra;for(const c of a)b.read(c);return b.link()}read(a){this._link.readFile(a);return this}base(a,b){this._link.base(a,void 0===b?0:b);return this}link(){return this._link.link()}report(a){console.log(this._link.report(void 0===a?!1:a))}exports(){return this._exports?this._exports:this._exports=this._link.buildExports()}watch(...a){this._link.watches.push(...a)}}function Va(a){throw Error(a);}
class Xa{constructor(a){var b,c,d,e,f;const g=this.name=a.name;this.bank=null!==(b=a.bank)&&void 0!==b?b:0;this.addressing=null!==(c=a.addressing)&&void 0!==c?c:2;this.size=null!==(d=a.size)&&void 0!==d?d:Va(`Size must be specified: ${g}`);this.offset=null!==(e=a.offset)&&void 0!==e?e:Va(`OFfset must be specified: ${g}`);this.memory=null!==(f=a.memory)&&void 0!==f?f:Va(`OFfset must be specified: ${g}`)}get delta(){return this.offset-this.memory}}
...
class ob{constructor(){this.presets=new Map;this.Casual=new mb(this,"Casual","\n      Basic flags for a relatively easy playthrough.  This is a good\n      place to start.",[n.PreserveUniqueChecks,n.NoShuffleMimics,n.DecreaseEnemyDamage,n.GuaranteeRefresh,n.GuaranteeStartingSword,n.ExperienceScalesFaster,n.NoCommunityJokes,r.NoThunderSwordWarp,qb.Shops,qb.Dyna,[qb.Maps,"!"],[qb.WildWarp,"!"],rb.SpoilerLog]);this.Classic=new mb(this,"Classic","\n      Provides a relatively quick playthough with a reasonable amount of\n      challenge.  Similar to older versions.",
[n.GuaranteeStartingSword,n.NoCommunityJokes,u.StatueGlitch,[r.NoThunderSwordWarp,"!"],[qb.Maps,"!"],rb.SpoilerLog]);this.Standard=new mb(this,"Standard","\n      Well-balanced, standard race flags.",[sb.RandomizeWeaknesses,r.StoryMode,rb.SpoilerLog]);this.NoBowMode=new mb(this,"No Bow Mode","\n      The tower is open from the start, as soon as you're ready for it.",[sb.RandomizeWeaknesses,sb.TowerRobots,tb.MaxScalingInTower,r.NoBowMode,rb.SpoilerLog]);this.Advanced=new mb(this,"Advanced","\n      A balanced randomization with quite a bit more difficulty.",
[u.GhettoFlight,u.MtSabreRequirementSkip,u.StatueGlitch,[u.SwordChargeGlitch,"!"],ub.Barrier,ub.BattleMagic,ub.GasMask,tb.MaxScalingInTower,sb.RandomizeWeaknesses,sb.TowerRobots,r.OrbsNotRequired,r.StoryMode,v.RandomizeMaps,v.ShuffleAreas,v.ShuffleHouses,v.RandomizeTrades,v.RandomizeWallElements,v.UnidentifiedKeyItems,rb.SpoilerLog]);this.WildWarp=new mb(this,"Wild Warp","\n      Significantly opens up the game right from the start with wild\n      warp in logic.",[n.GuaranteeRefresh,v.RandomizeWildWarp,
sb.RandomizeWeaknesses,sb.TowerRobots,r.OrbsNotRequired,r.StoryMode,rb.SpoilerLog]);this.Mystery=new mb(this,"Mystery","\n      Even the options are random.",[[v.ShuffleAreas,"?"],[v.ShuffleHouses,"?"],[v.RandomizeMaps,"?"],[v.RandomizeTrades,"?"],[v.UnidentifiedKeyItems,"?"],[v.RandomizeWallElements,"?"],[v.ShuffleGoaFloors,"?"],[v.RandomizeSpriteColors,"?"],[v.RandomizeWildWarp,"?"],[r.OrbsNotRequired,"?"],[r.NoBowMode,"?"],[r.StoryMode,"?"],[r.VanillaDolphin,"?"],[r.NoThunderSwordWarp,"?"],[u.RageSkip,
"?"],[u.TriggerSkip,"?"],[u.StatueGlitch,"?"],[u.GhettoFlight,"?"],[u.SwordChargeGlitch,"?"],[u.MtSabreRequirementSkip,"?"],[vb.RandomizeMusic,"?"],[vb.RandomizeMapColors,"?"],[sb.RandomizeWeaknesses,"?"],[sb.TowerRobots,"?"],[n.NoShuffleMimics,"?"],[n.PreserveUniqueChecks,"?"],[ub.Barrier,"?"],[ub.BattleMagic,"?"],[ub.GasMask,"?"],[qb.Dyna,"?"],[qb.BonusItems,"?"],[qb.Maps,"?"],rb.SpoilerLog]);this.Hardcore=new mb(this,"Hardcore","\n      Not for the faint of heart.  Good luck.",[ub.Barrier,ub.BattleMagic,
tb.ExperienceScalesSlower,tb.MaxScalingInTower,tb.Permadeath,r.OrbsNotRequired,r.StoryMode,v.RandomizeMaps,v.ShuffleAreas,v.ShuffleHouses,v.RandomizeTrades,v.RandomizeWallElements,v.UnidentifiedKeyItems]);this.FullStupid=new mb(this,"The Full Stupid","\n      Only a few noble fools have ever completed this.  Be sure to record this\n      because pics or it didn't happen.",[ub.Barrier,ub.BattleMagic,tb.Blackout,tb.ExperienceScalesSlower,tb.MaxScalingInTower,tb.Permadeath,sb.RandomizeWeaknesses,sb.TowerRobots,
r.OrbsNotRequired,r.StoryMode,v.RandomizeMaps,v.ShuffleAreas,v.ShuffleHouses,v.RandomizeTrades,v.RandomizeWallElements,v.ShuffleGoaFloors,v.UnidentifiedKeyItems]);this.Tournament2022Early=new mb(this,"Tournament 2022 Early Rounds","\n      Lots of potential complexity, but within reason.  Requires all swords and\n      bosses, as well as a few glitches, but guarantees a starting sword.",[n.GuaranteeStartingSword,u.StatueGlitch,u.StatueGauntletSkip,[sb.RandomizeWeaknesses,"?"],r.OrbsNotRequired,r.StoryMode,
[r.VanillaDolphin,"?"],[r.NoThunderSwordWarp,"?"],[v.RandomizeWallElements,"?"],[v.ShuffleGoaFloors,"?"],[v.RandomizeSpriteColors,"?"],[v.RandomizeTrades,"?"],[v.UnidentifiedKeyItems,"?"]]);this.Tournament2022Mid=new mb(this,"Tournament 2022 Mid Rounds","\n      Some additional challenges compared to the early rounds: some additional\n      mystery flags and glitches, as well as max difficulty scaling in the\n      tower.",[[n.GuaranteeStartingSword,"?"],[u.GhettoFlight,"?"],[u.StatueGlitch,"?"],
[u.MtSabreRequirementSkip,"?"],[u.StatueGauntletSkip,"?"],tb.MaxScalingInTower,[tb.NoBuffMedicalHerb,"?"],[sb.RandomizeWeaknesses,"?"],[sb.TowerRobots,"?"],[ub.Barrier,"?"],[ub.BattleMagic,"?"],r.StoryMode,[r.VanillaDolphin,"?"],[r.OrbsNotRequired,"?"],[r.NoThunderSwordWarp,"?"],[v.RandomizeWallElements,"?"],[v.ShuffleGoaFloors,"?"],[v.RandomizeSpriteColors,"?"],[v.RandomizeTrades,"?"],[v.UnidentifiedKeyItems,"?"]]);this.Tournament2022Finals=new mb(this,"Tournament 2022 Finals Round","\n      Many of the more difficult mystery flags from the mid rounds are now\n      always on, plus entrance shuffle.",
[[n.GuaranteeStartingSword,"?"],u.GhettoFlight,u.StatueGlitch,u.MtSabreRequirementSkip,u.StatueGauntletSkip,tb.NoBuffMedicalHerb,tb.MaxScalingInTower,[sb.RandomizeWeaknesses,"?"],[sb.TowerRobots,"?"],ub.Barrier,ub.BattleMagic,r.StoryMode,[r.VanillaDolphin,"?"],[r.OrbsNotRequired,"?"],[r.NoThunderSwordWarp,"?"],v.ShuffleHouses,[v.RandomizeWallElements,"?"],[v.ShuffleGoaFloors,"?"],[v.RandomizeSpriteColors,"?"],[v.RandomizeTrades,"?"],[v.UnidentifiedKeyItems,"?"]])}static get(a){this.instance||(this.instance=
...
vb.RandomizeMusic=vb.flag("Am",{name:"Randomize background music",modes:"!",optional:eb});vb.NoMusic=vb.flag("As",{name:"No background music",optional:db});vb.RandomizeMapColors=vb.flag("Ac",{name:"Randomize map colors",modes:"!",optional:eb});class sb extends zb{constructor(){super(...arguments);this.prefix="M";this.name="Monsters"}}sb.RandomizeWeaknesses=sb.flag("Me",{name:"Randomize monster weaknesses",text:"Monster and boss elemental weaknesses are shuffled."});
...
this.addExtraChecks();this.unionNeighbors();this.recordExits();this.buildNeighbors();this.addAllRoutes();this.consolidateChecks();this.buildRequirementMap()}addExtraChecks(){const {locations:{Leaf_ToolShop:a,MezameShrine:b,Oak:c,Shyron_ToolShop:d},flags:{AbleToRideDolphin:e,BallOfFire:f,BallOfThunder:g,BallOfWater:h,BallOfWind:k,Barrier:p,BlizzardBracelet:q,BowOfMoon:t,BowOfSun:A,BreakStone:D,BreakIce:z,BreakIron:I,BrokenStatue:X,BuyHealing:T,BuyWarp:R,ClimbWaterfall:U,ClimbSlope8:Wa,ClimbSlope9:wa,
ClimbSlope10:Tb,CrossPain:nb,CurrentlyRidingDolphin:fb,Flight:Sa,FlameBracelet:Jb,FormBridge:wb,GasMask:gb,GlowingLamp:hb,InjuredDolphin:ac,LeadingChild:pc,LeatherBoots:qc,Money:ib,OpenedCrypt:jd,RabbitBoots:jb,Refresh:rc,RepairedStatue:Kb,RescuedChild:Nc,ShellFlute:sc,ShieldRing:Oc,ShootingStatue:tc,ShootingStatueSouth:uc,StormBracelet:kd,Sword:xb,SwordOfFire:vc,SwordOfThunder:wc,SwordOfWater:xc,SwordOfWind:bc,TornadoBracelet:ld,TravelSwamp:Pc,TriggerSkip:Lb,WildWarp:L},items:{MedicalHerb:Ta,WarpBoots:yb}}=
this.rom,ta=this.entrance(b);var kb=this.entrance(c);this.addCheck([ta],Td(t,A),[jd.id]);this.addCheck([ta],Td(e,sc),[fb.id]);this.addCheck([kb],Td(pc),[Nc.id]);this.addItemCheck([ta],Td(hb,X),Kb.id,{lossy:!0,unique:!0});for(var Ha of this.rom.shops)if(Ha.location!==a.id&&Ha.location!==d.id&&Ha.used&&Ha.type===ad.TOOL){kb=[ic(Ha.location<<16|136)];for(var Ab of Ha.contents)Ab===Ta.id?this.addCheck(kb,ib.r,[T.id]):Ab===yb.id&&this.addCheck(kb,ib.r,[R.id])}Ha=bc.r;Ab=vc.r;kb=xc.r;let yc=wc.r;if(!this.flagset.orbsOptional()){var cc=
Ud(k,ld);const a=Ud(f,Jb),b=Ud(h,q),c=Ud(g,kd);Ha=C.meet(Ha,cc);Ab=C.meet(Ab,a);kb=C.meet(kb,b);yc=C.meet(yc,c);if(this.flagset.assumeSwordChargeGlitch()){cc=function(b){return a.map(a=>a[0]===b.c?a:[b.c,...a])};const a=C.or(Ha,Ab,kb,yc);Ha=cc(bc);Ab=cc(vc);kb=cc(xc);yc=cc(wc)}}this.addCheck([ta],Ha,[D.id]);this.addCheck([ta],Ab,[z.id]);this.addCheck([ta],kb,[wb.id]);this.addCheck([ta],yc,[I.id]);this.addCheck([ta],Ud(bc,vc,xc,wc),[xb.id]);this.addCheck([ta],Sa.r,[U.id,Tb.id]);this.addCheck([ta],
Ud(Sa,jb),[Wa.id]);this.addCheck([ta],Ud(Sa,jb),[wa.id]);this.addCheck([ta],p.r,[tc.id,uc.id]);this.addCheck([ta],gb.r,[Pc.id]);Ha=this.flagset.changeGasMaskToHazmatSuit()?gb:qc;this.addCheck([ta],Ud(Sa,jb,Ha),[nb.id]);this.flagset.leatherBootsGiveSpeed()&&this.addCheck([ta],qc.r,[Wa.id]);this.flagset.assumeGhettoFlight()&&this.addCheck([ta],Td(fb,jb),[U.id]);this.flagset.fogLampNotRequired()&&(Ha=this.flagset.requireHealedDolphinToRide(),this.addCheck([ta],Ha?ac.r:[[]],[e.id]));this.flagset.guaranteeBarrier()||
this.addCheck([ta],[[ib.c,T.c],[ib.c,Oc.c],[ib.c,rc.c]],[tc.id,uc.id]);this.flagset.assumeFlightStatueSkip()&&this.addCheck([ta],[[ib.c,Sa.c]],[tc.id]);this.flagset.guaranteeGasMask()||this.addCheck([ta],[[ib.c,T.c],[ib.c,rc.c]],[Pc.id,nb.id]);this.flagset.assumeWildWarp()&&this.addCheck([ta],C.OPEN,[L.id]);this.flagset.assumeTriggerGlitch()&&(this.addCheck([ta],C.OPEN,[Lb.id]),this.addCheck([ta],Lb.r,[nb.id,Wa.id,wa.id]))}addExtraRoutes(){var a;const {flags:{BuyWarp:b,SwordOfThunder:c,Teleport:d,
...
WindmillCave:U,WaterfallCave4:Wa,WaterfallValleyNorth:wa,ZebuCave:Tb,ZombieTown_HouseBasement:nb},items:{GlowingLamp:fb,KeyToPrison:Sa,LovePendant:Jb,StatueOfOnyx:wb},npcs:{Akahana:gb,AkahanaInBrynmaer:hb,Asina:ac,AztecaInShyron:pc,Clark:qc,Draygon:ib,FortuneTeller:jd,Kensu:jb,KensuInCabin:rc,KensuInSwan:Kb,LeafElder:Nc,LeafRabbit:sc,OakChild:Oc,OakElder:tc,OakMother:uc,PortoaPalaceFrontGuard:kd,PortoaQueen:xb,PortoaThroneRoomBackDoorGuard:vc,Rage:wc,Stom:xc,StonedAkahana:bc,Tornel:ld,WindmillGuard:Pc,
Zebu:Lb},flags:L}=a;jb.localDialogs.delete(R.id);Kb.link(jb.id);Kb.used=!0;Kb.data=[...jb.data];jb.data[0]=fb.id;T.spawns.find(a=>a.isNpc()&&a.id===jb.id).id=Kb.id;Jb.itemUseData[0].want=256|Kb.id;bc.linkDialog(gb.id);hb.used=!0;hb.link(gb.id);hb.data=[...gb.data];f.spawns.find(a=>a.isNpc()&&a.id===gb.id).id=hb.id;wb.itemUseData[0].want=256|hb.id;Nc.dialog(k).splice(0,0,...Nc.dialog(k).splice(2,1));sc.dialog()[2].condition=L.RescuedLeafElder.id;sc.dialog()[2].flags.push(L.TalkedToLeafRabbit.id);sc.dialog()[3].flags.push(L.TalkedToLeafRabbit.id);
Pc.spawns(U)[1]=~L.WindmillGuardAlarmFluteTradein.id;c(gb.spawns(Wa),~L.BehindWhirlpool.id);c(bc.spawns(Wa),~L.BehindWhirlpool.id);for(var Ta=0;4>Ta;Ta++){var yb=tc.dialog()[Ta];yb.condition!==a.flags.OakElder.id&&(yb.message.action=3)}(()=>{const [a,b,c,d]=uc.dialog();d.condition=~L.RescuedChild.id;b.condition=-1;uc.dialog().splice(0,4,d,c,a,b)})();for(const b of[32,33,34,124,125])d(a.npcs[b].dialog());Oc.dialog().unshift(...Oc.dialog().splice(1,1));vc.spawnConditions.set(t.id,[~L.QueenNotInThroneRoom.id,
~L.MesiaRecording.id]);kd.dialog()[1].condition=L.MesiaRecording.id;xb.dialog()[3].condition=L.SwordOfWater.id;xb.dialog()[3].message.action=3;xb.dialog()[4].flags.push(L.PortoaQueenGoingAway.id);xb.spawns(t)[1]=~L.MesiaRecording.id;xb.spawns(D)[0]=L.MesiaRecording.id;xb.dialog()[1].condition=L.MesiaRecording.id;jd.spawns(z)[1]=~L.MesiaRecording.id;qc.spawnConditions.set(nb.id,[~L.Clark.id]);qc.spawnConditions.set(h.id,[L.Clark.id]);Lb.localDialogs.set(Tb.id,[Re.of(~L.TalkedToZebuInCave.id,[0,26],
[L.TalkedToZebuInCave.id]),Re.of(L.LeafVillagersRescued.id,[0,29]),Re.of(L.LeafAbduction.id,[0,28]),Re.of(L.ZebuAtWindmill.id,[0,29]),Re.of(L.UsedWindmillKey.id,[0,27,3]),Re.of(-1,[0,29])]);c(Lb.spawns(Tb),~L.BehindWhirlpool.id);ld.spawnConditions.delete(q.id);xc.spawnConditions.delete(X.id);c(ac.spawns(D),~L.CalmedAngrySea.id);Ta=a.npcs[52];Ta.spawnConditions.set(t.id,[L.MesiaRecording.id,~L.PortoaQueen.id]);Ta.localDialogs.set(A.id,Ta.localDialogs.get(-1));Ta.data[0]=a.items.FluteOfLime.id;yb=a.messages.alloc();
yb.text="The queen left this for you.";Ta.localDialogs.set(t.id,[Re.of(~L.PortoaQueen.id,[yb.part,yb.id,3]),Re.of(-1,[10,14])]);t.spawns.push(Zd.of({yt:3,xt:12,type:1,patternBank:1,id:Ta.id}));rc.spawnConditions.set(e.id,[~L.AbleToRideDolphin.id,L.ReturnedFogLamp.id]);rc.dialog()[0].message.action=2;pc.spawns(I).push(~L.ShyronMassacre.id);a.trigger(130).conditions.push(~L.ShyronMassacre.id);wc.dialog()[0].condition=L.SwordOfWater.id;ib.spawnConditions.set(g.id,[~L.Draygon2.id]);Lb.dialog(I).unshift(...Lb.dialog(I).splice(1,
1));a.trigger(128).conditions=[~L.ShyronMassacre.id,L.TalkedToZebuInShyron.id,L.SwordOfThunder.id];a.trigger(129).conditions=[];b.barrierRequiresCalmSea()&&a.trigger(132).conditions.push(L.CalmedAngrySea.id);a.trigger(140).conditions.push(L.TalkedToZebuInCave.id);a.trigger(141).used=!1;for(const a of p.spawns)a.isTrigger()&&141===a.id&&(a.id=178);(function(a,b){b=a.findIndex(b);if(0>b)throw Error(`Could not find element in ${a}`);a.splice(b,1)})(wa.spawns,a=>a.isTrigger()&&141===a.id);a.trigger(178).conditions.push(L.Kelbesque1.id);
a.trigger(178).flags.push(~L.LeafVillagersCurrentlyAbducted.id,~L.LeafElderCurrentlyAbducted.id,L.LeafVillagersRescued.id);a.trigger(140).conditions.push(~L.Kelbesque1.id);a.trigger(134).conditions.push(~L.Kelbesque1.id);c(Sa.itemUseData[0].flags,~L.LeafVillagersCurrentlyAbducted.id);jf(a.trigger(187).conditions,~L.Rage.id,~L.MesiaRecording.id)}function jf(a,b,c){for(let d=0;d<a.length;d++)if(a[d]===b){a[d]=c;return}throw Error(`Could not find ${b} in ${a.join(",")}`);};const {$0e:mf,$0f:nf,$10:of,$1a:pf}=y,qf=B.of(mf,33689),rf=B.of(mf,39906),sf=B.of(of,36848),tf=B.of(of,36923),uf=B.of(of,36998),vf=B.of(pf,35776),wf=B.of(pf,35785),xf=[["Sword","\n\x0B\f"],[" of ","\\]"],["Bracelet","<=>["],["Shield","\r\u000e\u000f"],["Armor","{\u0011\u0012"],["Magic","#%("],["Power","\u0013\u0014\u0015"],["Item","\u0016\u0017^"]];
...
"p","mado shuriken",,,,36,,,],[253,"p","guardian statue missile",,,,23,,,],[254,"p","demon wall fire",,,,23,,,]].map(([a,b,c,d=0,e=0,f=0,g=0,h=0,k=0])=>[a,{id:a,type:b,name:c,sdef:d,swrd:e,hits:f,satk:g,dgld:h,sexp:k}]));new Map([["stair:up","C"],["edge:top","N"],["edge:left","W"],["edge:right","E"],["cave","C"],["door","C"],["door2","C"],["door3","C"],["fortress","F"]]);new Map([["N","S"],["S","N"],["E","W"],["W","E"],["C","X"],["X","C"],["F","O"],["O","F"]]);new Map([["pawn",54],["inn",55],["armor",56],["tool",57],["tavern",59]]);const Df=new Set(["inn","armor","tool","pawn"]);new Set([...Df,"house","tavern"]);new Set([182]);new Set([89,92,110,111,129,138,163,196]);new Set([85,93,124,188,193]);function Ef(a,b){if(b.eastCave){{b=b.eastCave;const {locations:{EastCave1:d,EastCave2:e,EastCave3:f,SealedCave1:g,ValleyOfWind:h},metascreens:{boundaryE_cave:k,branchNSE:p,branchNWE:q,branchNWSE:t,branchNWS:A,branchWSE:D,caveEmpty:z,deadEndE:I,deadEndE_downStair:X,deadEndE_upStair:T,deadEndN_stairs:R,deadEndS:U,deadEndS_stairs:Wa,deadEndW:wa,deadEndW_downStair:Tb,hallNE:nb,hallNS:fb,hallNW:Sa,hallSE:Jb,hallWS:wb,hallWE:gb,hallNS_entrance:hb,hallNS_ramp:ac,hallNS_wall:pc}}=a;a.locations.allocate(d);
a.locations.allocate(e);b.exit2&&a.locations.allocate(f);for(var c of[d,e,f])c.bgm=c.originalBgm=23,c.entrances=[],c.exits=[],c.pits=[],c.spawns=[],c.flags=[],c.width=c.height=1,c.screens=[[128]],c.tilePalettes=[26,27,5],c.originalTilePalettes=[26,27,5],c.tileset=136,c.tileEffects=181,c.tilePatterns=[20,2],c.spritePatterns=[...g.spritePatterns],c.spritePalettes=[...g.spritePalettes];d.meta=new be(d.id,a.metatilesets.cave,5,5);d.meta.set2d(0,[[I,wb,z,Jb,wa],[z,fb,Jb,Sa,z],[Jb,t,A,z,z],[fb,ac,nb,gb,
wb],[hb,nb,wa,T,Sa]]);e.meta=new be(e.id,a.metatilesets.cave,5,5);e.meta.set2d(0,[[I,wb,U,z,U],[z,fb,fb,z,fb],[z,p,q,D,Sa],[z,ac,z,nb,wb],[I,Sa,z,z,R]]);h.meta.set2d(51,[[k]]);a.tileEffects[0].effects[192]=0;d.meta.attach(67,e.meta,68);d.meta.attach(64,h.meta,51);b.exit1&&(d.meta.set2d(4,[[Tb]]),Ff(d,4,b.exit1));b.exit2&&(f.meta=new be(f.id,a.metatilesets.cave,3,1),f.meta.set2d(0,[[Wa],[pc],[hb]]),f.spawns.push(Zd.from([24,7,35,0])),f.flags.push(Xd.of({screen:16,flag:a.flags.alloc(512)})),e.meta.set2d(64,
...
d.push(...this.itemGets.write());d.push(...this.slots.write());d.push(...this.items.write());d.push(...this.shops.write());c(this.bossKills);c(this.patterns);d.push(...this.wildWarp.write());d.push(...this.townWarp.write());d.push(...this.coinDrops.write());d.push(...this.scaling.write());d.push(...this.bosses.write());d.push(...this.randomNumbers.write());d.push(...this.telepathy.write());d.push(...this.messages.write());d.push(...this.screens.write());c=new Ra;c.base(this.prg,0);for(const a of d)c.read(a);
